...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.DeleteMessageRequest();
  });
  ...
  describe('DeleteMessageRequest', function() {
    it('should create an instance of DeleteMessageRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.DeleteMessageRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.DeleteMessageRequest);
    });
