...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationResponse();
  });
  ...
  describe('CreateLoggingConfigurationResponse', function() {
    it('should create an instance of CreateLoggingConfigurationResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationResponse);
    });
