...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.ListRoomsResponse();
  });
  ...
  describe('ListRoomsResponse', function() {
    it('should create an instance of ListRoomsResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.ListRoomsResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.ListRoomsResponse);
    });
