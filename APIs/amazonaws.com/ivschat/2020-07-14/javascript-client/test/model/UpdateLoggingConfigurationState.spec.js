...
(function(root, factory) {
  ...
  describe('UpdateLoggingConfigurationState', function() {
    it('should create an instance of UpdateLoggingConfigurationState', function() {
      // uncomment below and update the code to test UpdateLoggingConfigurationState
      //var instance = new AmazonInteractiveVideoServiceChat.UpdateLoggingConfigurationState();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.UpdateLoggingConfigurationState);
    });
