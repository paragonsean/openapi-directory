...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.MessageReviewHandler();
  });
  ...
  describe('MessageReviewHandler', function() {
    it('should create an instance of MessageReviewHandler', function() {
      // uncomment below and update the code to test MessageReviewHandler
      //var instance = new AmazonInteractiveVideoServiceChat.MessageReviewHandler();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.MessageReviewHandler);
    });
