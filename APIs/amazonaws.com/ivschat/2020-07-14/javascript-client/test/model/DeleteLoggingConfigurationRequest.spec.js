...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.DeleteLoggingConfigurationRequest();
  });
  ...
  describe('DeleteLoggingConfigurationRequest', function() {
    it('should create an instance of DeleteLoggingConfigurationRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.DeleteLoggingConfigurationRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.DeleteLoggingConfigurationRequest);
    });
