...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.LoggingConfigurationSummary();
  });
  ...
  describe('LoggingConfigurationSummary', function() {
    it('should create an instance of LoggingConfigurationSummary', function() {
      // uncomment below and update the code to test LoggingConfigurationSummary
      //var instance = new AmazonInteractiveVideoServiceChat.LoggingConfigurationSummary();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.LoggingConfigurationSummary);
    });
