...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.AmazonInteractiveVideoServiceChat);
  }
}(this, function(expect, AmazonInteractiveVideoServiceChat) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs();
  });
  ...
  describe('CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs', function() {
    it('should create an instance of CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs', function() {
      // uncomment below and update the code to test CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs
      //var instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs);
    });

    it('should have the property logGroupName (base name: "logGroupName")', function() {
      // uncomment below and update the code to test the property logGroupName
      //var instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs();
