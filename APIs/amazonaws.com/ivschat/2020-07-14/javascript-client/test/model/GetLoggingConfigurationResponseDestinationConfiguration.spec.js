...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.GetLoggingConfigurationResponseDestinationConfiguration();
  });
  ...
  describe('GetLoggingConfigurationResponseDestinationConfiguration', function() {
    it('should create an instance of GetLoggingConfigurationResponseDestinationConfiguration', function() {
      // uncomment below and update the code to test GetLoggingConfigurationResponseDestinationConfiguration
      //var instance = new AmazonInteractiveVideoServiceChat.GetLoggingConfigurationResponseDestinationConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.GetLoggingConfigurationResponseDestinationConfiguration);
    });
