...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateRoomRequest();
  });
  ...
  describe('CreateRoomRequest', function() {
    it('should create an instance of CreateRoomRequest', function() {
      // uncomment below and update the code to test CreateRoomRequest
      //var instance = new AmazonInteractiveVideoServiceChat.CreateRoomRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateRoomRequest);
    });
