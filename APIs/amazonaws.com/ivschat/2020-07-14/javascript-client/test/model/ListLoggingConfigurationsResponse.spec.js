...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.ListLoggingConfigurationsResponse();
  });
  ...
  describe('ListLoggingConfigurationsResponse', function() {
    it('should create an instance of ListLoggingConfigurationsResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.ListLoggingConfigurationsResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.ListLoggingConfigurationsResponse);
    });
