...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationResponseDestinationConfiguration();
  });
  ...
  describe('CreateLoggingConfigurationResponseDestinationConfiguration', function() {
    it('should create an instance of CreateLoggingConfigurationResponseDestinationConfiguration', function() {
      // uncomment below and update the code to test CreateLoggingConfigurationResponseDestinationConfiguration
      //var instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationResponseDestinationConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationResponseDestinationConfiguration);
    });
