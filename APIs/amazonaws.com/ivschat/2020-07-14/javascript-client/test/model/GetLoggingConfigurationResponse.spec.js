...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.GetLoggingConfigurationResponse();
  });
  ...
  describe('GetLoggingConfigurationResponse', function() {
    it('should create an instance of GetLoggingConfigurationResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.GetLoggingConfigurationResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.GetLoggingConfigurationResponse);
    });
