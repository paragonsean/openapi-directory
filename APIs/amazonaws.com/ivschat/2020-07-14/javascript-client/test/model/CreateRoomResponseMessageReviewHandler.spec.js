...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateRoomResponseMessageReviewHandler();
  });
  ...
  describe('CreateRoomResponseMessageReviewHandler', function() {
    it('should create an instance of CreateRoomResponseMessageReviewHandler', function() {
      // uncomment below and update the code to test CreateRoomResponseMessageReviewHandler
      //var instance = new AmazonInteractiveVideoServiceChat.CreateRoomResponseMessageReviewHandler();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateRoomResponseMessageReviewHandler);
    });

    it('should have the property fallbackResult (base name: "fallbackResult")', function() {
      // uncomment below and update the code to test the property fallbackResult
      //var instance = new AmazonInteractiveVideoServiceChat.CreateRoomResponseMessageReviewHandler();
