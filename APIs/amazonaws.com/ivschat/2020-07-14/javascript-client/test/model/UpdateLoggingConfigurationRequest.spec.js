...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.UpdateLoggingConfigurationRequest();
  });
  ...
  describe('UpdateLoggingConfigurationRequest', function() {
    it('should create an instance of UpdateLoggingConfigurationRequest', function() {
      // uncomment below and update the code to test UpdateLoggingConfigurationRequest
      //var instance = new AmazonInteractiveVideoServiceChat.UpdateLoggingConfigurationRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.UpdateLoggingConfigurationRequest);
    });
