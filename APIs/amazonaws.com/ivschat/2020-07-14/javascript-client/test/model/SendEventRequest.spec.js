...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.SendEventRequest();
  });
  ...
  describe('SendEventRequest', function() {
    it('should create an instance of SendEventRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.SendEventRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.SendEventRequest);
    });
