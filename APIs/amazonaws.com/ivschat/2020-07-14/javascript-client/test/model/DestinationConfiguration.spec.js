...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.DestinationConfiguration();
  });
  ...
  describe('DestinationConfiguration', function() {
    it('should create an instance of DestinationConfiguration', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.DestinationConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.DestinationConfiguration);
    });
