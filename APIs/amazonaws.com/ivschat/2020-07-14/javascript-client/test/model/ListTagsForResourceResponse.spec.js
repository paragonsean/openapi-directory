...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.ListTagsForResourceResponse);
    });
