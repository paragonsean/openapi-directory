...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.GetLoggingConfigurationRequest();
  });
  ...
  describe('GetLoggingConfigurationRequest', function() {
    it('should create an instance of GetLoggingConfigurationRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.GetLoggingConfigurationRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.GetLoggingConfigurationRequest);
    });
