...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.UpdateRoomRequestMessageReviewHandler();
  });
  ...
  describe('UpdateRoomRequestMessageReviewHandler', function() {
    it('should create an instance of UpdateRoomRequestMessageReviewHandler', function() {
      // uncomment below and update the code to test UpdateRoomRequestMessageReviewHandler
      //var instance = new AmazonInteractiveVideoServiceChat.UpdateRoomRequestMessageReviewHandler();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.UpdateRoomRequestMessageReviewHandler);
    });
