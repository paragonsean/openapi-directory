...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfigurationFirehose();
  });
  ...
  describe('CreateLoggingConfigurationRequestDestinationConfigurationFirehose', function() {
    it('should create an instance of CreateLoggingConfigurationRequestDestinationConfigurationFirehose', function() {
      // uncomment below and update the code to test CreateLoggingConfigurationRequestDestinationConfigurationFirehose
      //var instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfigurationFirehose();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfigurationFirehose);
    });
