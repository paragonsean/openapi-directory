...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.DisconnectUserRequest();
  });
  ...
  describe('DisconnectUserRequest', function() {
    it('should create an instance of DisconnectUserRequest', function() {
      // uncomment below and update the code to test DisconnectUserRequest
      //var instance = new AmazonInteractiveVideoServiceChat.DisconnectUserRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.DisconnectUserRequest);
    });
    ...
    it('should have the property roomIdentifier (base name: "roomIdentifier")', function() {
      // uncomment below and update the code to test the property roomIdentifier
      //var instance = new AmazonInteractiveVideoServiceChat.DisconnectUserRequest();
      //expect(instance).to.be();
    });
