...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateChatTokenResponse();
  });
  ...
  describe('CreateChatTokenResponse', function() {
    it('should create an instance of CreateChatTokenResponse', function() {
      // uncomment below and update the code to test CreateChatTokenResponse
      //var instance = new AmazonInteractiveVideoServiceChat.CreateChatTokenResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateChatTokenResponse);
    });

    it('should have the property sessionExpirationTime (base name: "sessionExpirationTime")', function() {
      // uncomment below and update the code to test the property sessionExpirationTime
      //var instance = new AmazonInteractiveVideoServiceChat.CreateChatTokenResponse();
