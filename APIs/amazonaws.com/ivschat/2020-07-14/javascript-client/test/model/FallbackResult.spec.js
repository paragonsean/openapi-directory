...
(function(root, factory) {
  ...
  describe('FallbackResult', function() {
    it('should create an instance of FallbackResult', function() {
      // uncomment below and update the code to test FallbackResult
      //var instance = new AmazonInteractiveVideoServiceChat.FallbackResult();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.FallbackResult);
    });
