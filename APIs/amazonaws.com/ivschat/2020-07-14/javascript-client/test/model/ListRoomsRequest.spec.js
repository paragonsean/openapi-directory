...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.ListRoomsRequest();
  });
  ...
  describe('ListRoomsRequest', function() {
    it('should create an instance of ListRoomsRequest', function() {
      // uncomment below and update the code to test ListRoomsRequest
      //var instance = new AmazonInteractiveVideoServiceChat.ListRoomsRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.ListRoomsRequest);
    });

    it('should have the property loggingConfigurationIdentifier (base name: "loggingConfigurationIdentifier")', function() {
      // uncomment below and update the code to test the property loggingConfigurationIdentifier
      //var instance = new AmazonInteractiveVideoServiceChat.ListRoomsRequest();
    ...
    it('should have the property messageReviewHandlerUri (base name: "messageReviewHandlerUri")', function() {
      // uncomment below and update the code to test the property messageReviewHandlerUri
      //var instance = new AmazonInteractiveVideoServiceChat.ListRoomsRequest();
      //expect(instance).to.be();
    });
