...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.S3DestinationConfiguration();
  });
  ...
  describe('S3DestinationConfiguration', function() {
    it('should create an instance of S3DestinationConfiguration', function() {
      // uncomment below and update the code to test S3DestinationConfiguration
      //var instance = new AmazonInteractiveVideoServiceChat.S3DestinationConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.S3DestinationConfiguration);
    });
