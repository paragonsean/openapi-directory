...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.ListLoggingConfigurationsRequest();
  });
  ...
  describe('ListLoggingConfigurationsRequest', function() {
    it('should create an instance of ListLoggingConfigurationsRequest', function() {
      // uncomment below and update the code to test ListLoggingConfigurationsRequest
      //var instance = new AmazonInteractiveVideoServiceChat.ListLoggingConfigurationsRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.ListLoggingConfigurationsRequest);
    });
