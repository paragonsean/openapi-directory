...
/**
 * The UpdateRoomRequestMessageReviewHandler model module.
 * @module model/UpdateRoomRequestMessageReviewHandler
 * @version 2020-07-14
 */
class UpdateRoomRequestMessageReviewHandler {
    /**
     * Constructs a new <code>UpdateRoomRequestMessageReviewHandler</code>.
     * @alias module:model/UpdateRoomRequestMessageReviewHandler
     * @implements module:model/MessageReviewHandler
     */
    constructor() { 
        MessageReviewHandler.initialize(this);
        UpdateRoomRequestMessageReviewHandler.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateRoomRequestMessageReviewHandler</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRoomRequestMessageReviewHandler} obj Optional instance to populate.
     * @return {module:model/UpdateRoomRequestMessageReviewHandler} The populated <code>UpdateRoomRequestMessageReviewHandler</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRoomRequestMessageReviewHandler();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRoomRequestMessageReviewHandler</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRoomRequestMessageReviewHandler</code>.
     */
 ...
 */
UpdateRoomRequestMessageReviewHandler.prototype['fallbackResult'] = undefined;

/**
 * @member {String} uri
 */
UpdateRoomRequestMessageReviewHandler.prototype['uri'] = undefined;
...
export default UpdateRoomRequestMessageReviewHandler;
