...
class GetLoggingConfigurationRequest {
     ...
     * @param identifier {String} Identifier of the logging configuration to be retrieved.
     */
    constructor(identifier) { 
        
        GetLoggingConfigurationRequest.initialize(this, identifier);
    }
...
GetLoggingConfigurationRequest.RequiredProperties = ["identifier"];

/**
 * Identifier of the logging configuration to be retrieved.
 * @member {String} identifier
 */
GetLoggingConfigurationRequest.prototype['identifier'] = undefined;
