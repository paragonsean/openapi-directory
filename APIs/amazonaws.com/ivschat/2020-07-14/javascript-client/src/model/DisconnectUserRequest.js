...
/**
 * The DisconnectUserRequest model module.
 * @module model/DisconnectUserRequest
 * @version 2020-07-14
 */
class DisconnectUserRequest {
    /**
     * Constructs a new <code>DisconnectUserRequest</code>.
     * @alias module:model/DisconnectUserRequest
     * @param roomIdentifier {String} Identifier of the room from which the user's clients should be disconnected. Currently this must be an ARN.
     * @param userId {String} ID of the user (connection) to disconnect from the room.
     */
    constructor(roomIdentifier, userId) { 
        
        DisconnectUserRequest.initialize(this, roomIdentifier, userId);
    }
    ...
    /**
     * Constructs a <code>DisconnectUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisconnectUserRequest} obj Optional instance to populate.
     * @return {module:model/DisconnectUserRequest} The populated <code>DisconnectUserRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisconnectUserRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisconnectUserRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisconnectUserRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisconnectUserRequest.RequiredProperties) {
...
DisconnectUserRequest.RequiredProperties = ["roomIdentifier", "userId"];

/**
 * Reason for disconnecting the user.
 * @member {String} reason
 */
DisconnectUserRequest.prototype['reason'] = undefined;
 ...
 */
DisconnectUserRequest.prototype['roomIdentifier'] = undefined;

/**
 * ID of the user (connection) to disconnect from the room.
 * @member {String} userId
 */
DisconnectUserRequest.prototype['userId'] = undefined;
...
export default DisconnectUserRequest;
