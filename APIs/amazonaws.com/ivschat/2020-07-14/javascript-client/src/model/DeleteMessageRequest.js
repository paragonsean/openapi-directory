...
class DeleteMessageRequest {
     ...
     * @param id {String} ID of the message to be deleted. This is the <code>Id</code> field in the received message (see <a href=\"https://docs.aws.amazon.com/ivs/latest/chatmsgapireference/actions-message-subscribe.html\"> Message (Subscribe)</a> in the Chat Messaging API).
     * @param roomIdentifier {String} Identifier of the room where the message should be deleted. Currently this must be an ARN. 
     */
    constructor(id, roomIdentifier) { 
        
        DeleteMessageRequest.initialize(this, id, roomIdentifier);
    }
     ...
     */
    static initialize(obj, id, roomIdentifier) { 
        obj['id'] = id;
...
DeleteMessageRequest.RequiredProperties = ["id", "roomIdentifier"];
 ...
 * @member {String} id
 */
DeleteMessageRequest.prototype['id'] = undefined;

/**
 * Reason for deleting the message.
 * @member {String} reason
 */
DeleteMessageRequest.prototype['reason'] = undefined;

/**
 * Identifier of the room where the message should be deleted. Currently this must be an ARN. 
 * @member {String} roomIdentifier
 */
DeleteMessageRequest.prototype['roomIdentifier'] = undefined;
