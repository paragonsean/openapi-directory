 ...
 * @module model/DeleteRoomRequest
 * @version 2020-07-14
 */
class DeleteRoomRequest {
    /**
     * Constructs a new <code>DeleteRoomRequest</code>.
     * @alias module:model/DeleteRoomRequest
     * @param identifier {String} Identifier of the room to be deleted. Currently this must be an ARN.
     */
    constructor(identifier) { 
        
        DeleteRoomRequest.initialize(this, identifier);
    }
     ...
     * @param {module:model/DeleteRoomRequest} obj Optional instance to populate.
     * @return {module:model/DeleteRoomRequest} The populated <code>DeleteRoomRequest</code> instance.
     */
    ...
    static validateJSON(data) {
        ...
        for (const property of DeleteRoomRequest.RequiredProperties) {
...
DeleteRoomRequest.RequiredProperties = ["identifier"];

/**
 * Identifier of the room to be deleted. Currently this must be an ARN.
 * @member {String} identifier
 */
DeleteRoomRequest.prototype['identifier'] = undefined;
