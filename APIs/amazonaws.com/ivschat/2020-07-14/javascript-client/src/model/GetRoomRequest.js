...
/**
 * The GetRoomRequest model module.
 * @module model/GetRoomRequest
 * @version 2020-07-14
 */
class GetRoomRequest {
    /**
     * Constructs a new <code>GetRoomRequest</code>.
     * @alias module:model/GetRoomRequest
     * @param identifier {String} Identifier of the room for which the configuration is to be retrieved. Currently this must be an ARN.
     */
    constructor(identifier) { 
        
        GetRoomRequest.initialize(this, identifier);
    }
    ...
    /**
     * Constructs a <code>GetRoomRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRoomRequest} obj Optional instance to populate.
     * @return {module:model/GetRoomRequest} The populated <code>GetRoomRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRoomRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRoomRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRoomRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetRoomRequest.RequiredProperties) {
