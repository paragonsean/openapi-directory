...
class SendEventRequest {
     ...
     * @param eventName {String} Application-defined name of the event to send to clients.
     * @param roomIdentifier {String} Identifier of the room to which the event will be sent. Currently this must be an ARN.
     */
    constructor(eventName, roomIdentifier) { 
        
        SendEventRequest.initialize(this, eventName, roomIdentifier);
    }
     ...
     */
    static initialize(obj, eventName, roomIdentifier) { 
        obj['eventName'] = eventName;
        obj['roomIdentifier'] = roomIdentifier;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('roomIdentifier')) {
                obj['roomIdentifier'] = ApiClient.convertToType(data['roomIdentifier'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['roomIdentifier'] && !(typeof data['roomIdentifier'] === 'string' || data['roomIdentifier'] instanceof String)) {
            throw new Error("Expected the field `roomIdentifier` to be a primitive type in the JSON string but got " + data['roomIdentifier']);
        }
...
SendEventRequest.RequiredProperties = ["eventName", "roomIdentifier"];

/**
 * Application-defined metadata to attach to the event sent to clients. The maximum length of the metadata is 1 KB total.
 * @member {Object.<String, String>} attributes
 */
SendEventRequest.prototype['attributes'] = undefined;

/**
 * Application-defined name of the event to send to clients.
 * @member {String} eventName
 */
SendEventRequest.prototype['eventName'] = undefined;

/**
 * Identifier of the room to which the event will be sent. Currently this must be an ARN.
 * @member {String} roomIdentifier
 */
SendEventRequest.prototype['roomIdentifier'] = undefined;
