...
/**
 * The CreateLoggingConfigurationRequestDestinationConfiguration model module.
 * @module model/CreateLoggingConfigurationRequestDestinationConfiguration
 * @version 2020-07-14
 */
class CreateLoggingConfigurationRequestDestinationConfiguration {
    /**
     * Constructs a new <code>CreateLoggingConfigurationRequestDestinationConfiguration</code>.
     * @alias module:model/CreateLoggingConfigurationRequestDestinationConfiguration
     * @implements module:model/DestinationConfiguration
     */
    constructor() { 
        DestinationConfiguration.initialize(this);
        CreateLoggingConfigurationRequestDestinationConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateLoggingConfigurationRequestDestinationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLoggingConfigurationRequestDestinationConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateLoggingConfigurationRequestDestinationConfiguration} The populated <code>CreateLoggingConfigurationRequestDestinationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLoggingConfigurationRequestDestinationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLoggingConfigurationRequestDestinationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLoggingConfigurationRequestDestinationConfiguration</code>.
     */
 ...
 */
CreateLoggingConfigurationRequestDestinationConfiguration.prototype['cloudWatchLogs'] = undefined;

/**
 * @member {module:model/CreateLoggingConfigurationRequestDestinationConfigurationFirehose} firehose
 */
CreateLoggingConfigurationRequestDestinationConfiguration.prototype['firehose'] = undefined;

/**
 * @member {module:model/CreateLoggingConfigurationRequestDestinationConfigurationS3} s3
 */
CreateLoggingConfigurationRequestDestinationConfiguration.prototype['s3'] = undefined;
...
export default CreateLoggingConfigurationRequestDestinationConfiguration;
