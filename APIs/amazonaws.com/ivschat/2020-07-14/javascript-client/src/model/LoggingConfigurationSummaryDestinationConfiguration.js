...
/**
 * The LoggingConfigurationSummaryDestinationConfiguration model module.
 * @module model/LoggingConfigurationSummaryDestinationConfiguration
 * @version 2020-07-14
 */
class LoggingConfigurationSummaryDestinationConfiguration {
    /**
     * Constructs a new <code>LoggingConfigurationSummaryDestinationConfiguration</code>.
     * @alias module:model/LoggingConfigurationSummaryDestinationConfiguration
     * @implements module:model/DestinationConfiguration
     */
    constructor() { 
        DestinationConfiguration.initialize(this);
        LoggingConfigurationSummaryDestinationConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoggingConfigurationSummaryDestinationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoggingConfigurationSummaryDestinationConfiguration} obj Optional instance to populate.
     * @return {module:model/LoggingConfigurationSummaryDestinationConfiguration} The populated <code>LoggingConfigurationSummaryDestinationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoggingConfigurationSummaryDestinationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>LoggingConfigurationSummaryDestinationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoggingConfigurationSummaryDestinationConfiguration</code>.
     */
 ...
 */
LoggingConfigurationSummaryDestinationConfiguration.prototype['cloudWatchLogs'] = undefined;

/**
 * @member {module:model/CreateLoggingConfigurationRequestDestinationConfigurationFirehose} firehose
 */
LoggingConfigurationSummaryDestinationConfiguration.prototype['firehose'] = undefined;

/**
 * @member {module:model/CreateLoggingConfigurationRequestDestinationConfigurationS3} s3
 */
LoggingConfigurationSummaryDestinationConfiguration.prototype['s3'] = undefined;
...
export default LoggingConfigurationSummaryDestinationConfiguration;
