...
/**
 * The CloudWatchLogsDestinationConfiguration model module.
 * @module model/CloudWatchLogsDestinationConfiguration
 * @version 2020-07-14
 */
class CloudWatchLogsDestinationConfiguration {
    /**
     * Constructs a new <code>CloudWatchLogsDestinationConfiguration</code>.
     * Specifies a CloudWatch Logs location where chat logs will be stored.
     * @alias module:model/CloudWatchLogsDestinationConfiguration
     * @param logGroupName {String} 
     */
    constructor(logGroupName) { 
        
        CloudWatchLogsDestinationConfiguration.initialize(this, logGroupName);
    }
    ...
    /**
     * Constructs a <code>CloudWatchLogsDestinationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CloudWatchLogsDestinationConfiguration} obj Optional instance to populate.
     * @return {module:model/CloudWatchLogsDestinationConfiguration} The populated <code>CloudWatchLogsDestinationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CloudWatchLogsDestinationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CloudWatchLogsDestinationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CloudWatchLogsDestinationConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CloudWatchLogsDestinationConfiguration.RequiredProperties) {
...
CloudWatchLogsDestinationConfiguration.RequiredProperties = ["logGroupName"];

/**
 * @member {String} logGroupName
 */
CloudWatchLogsDestinationConfiguration.prototype['logGroupName'] = undefined;
...
export default CloudWatchLogsDestinationConfiguration;
