...
import UpdateLoggingConfigurationState from './UpdateLoggingConfigurationState';
...
class UpdateLoggingConfigurationResponse {
    ...
    constructor() { 
        ...
        UpdateLoggingConfigurationResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('state')) {
                obj['state'] = ApiClient.convertToType(data['state'], UpdateLoggingConfigurationState);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['state']) { // data not null
          UpdateLoggingConfigurationState.validateJSON(data['state']);
        }
 ...
 * @member {String} arn
 */
UpdateLoggingConfigurationResponse.prototype['arn'] = undefined;

/**
 * @member {Date} createTime
 */
UpdateLoggingConfigurationResponse.prototype['createTime'] = undefined;

/**
 * @member {module:model/CreateLoggingConfigurationResponseDestinationConfiguration} destinationConfiguration
 */
UpdateLoggingConfigurationResponse.prototype['destinationConfiguration'] = undefined;

/**
 * @member {String} id
 */
UpdateLoggingConfigurationResponse.prototype['id'] = undefined;

/**
 * @member {String} name
 */
UpdateLoggingConfigurationResponse.prototype['name'] = undefined;

/**
 * @member {module:model/UpdateLoggingConfigurationState} state
 */
UpdateLoggingConfigurationResponse.prototype['state'] = undefined;

/**
 * @member {Object} tags
 */
UpdateLoggingConfigurationResponse.prototype['tags'] = undefined;

/**
 * @member {Date} updateTime
 */
UpdateLoggingConfigurationResponse.prototype['updateTime'] = undefined;
