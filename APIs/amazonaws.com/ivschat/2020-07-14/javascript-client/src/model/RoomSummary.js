...
class RoomSummary {
    ...
    /**
     * Validates the JSON data with respect to <code>RoomSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RoomSummary</code>.
     */
 ...
 * @member {String} arn
 */
RoomSummary.prototype['arn'] = undefined;

/**
 * @member {Date} createTime
 */
RoomSummary.prototype['createTime'] = undefined;

/**
 * @member {String} id
 */
RoomSummary.prototype['id'] = undefined;

/**
 * @member {Array} loggingConfigurationIdentifiers
 */
RoomSummary.prototype['loggingConfigurationIdentifiers'] = undefined;

/**
 * @member {module:model/CreateRoomResponseMessageReviewHandler} messageReviewHandler
 */
RoomSummary.prototype['messageReviewHandler'] = undefined;

/**
 * @member {String} name
 */
RoomSummary.prototype['name'] = undefined;

/**
 * @member {Object} tags
 */
RoomSummary.prototype['tags'] = undefined;

/**
 * @member {Date} updateTime
 */
RoomSummary.prototype['updateTime'] = undefined;
