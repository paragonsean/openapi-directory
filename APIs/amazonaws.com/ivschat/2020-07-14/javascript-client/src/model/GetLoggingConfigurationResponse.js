...
import GetLoggingConfigurationResponseDestinationConfiguration from './GetLoggingConfigurationResponseDestinationConfiguration';
import LoggingConfigurationState from './LoggingConfigurationState';

/**
 * The GetLoggingConfigurationResponse model module.
 * @module model/GetLoggingConfigurationResponse
 * @version 2020-07-14
 */
class GetLoggingConfigurationResponse {
    /**
     * Constructs a new <code>GetLoggingConfigurationResponse</code>.
     * @alias module:model/GetLoggingConfigurationResponse
     */
    constructor() { 
        
        GetLoggingConfigurationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLoggingConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLoggingConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/GetLoggingConfigurationResponse} The populated <code>GetLoggingConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLoggingConfigurationResponse();
            ...
            if (data.hasOwnProperty('destinationConfiguration')) {
                obj['destinationConfiguration'] = GetLoggingConfigurationResponseDestinationConfiguration.constructFromObject(data['destinationConfiguration']);
            }
            ...
            if (data.hasOwnProperty('state')) {
                obj['state'] = ApiClient.convertToType(data['state'], LoggingConfigurationState);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetLoggingConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLoggingConfigurationResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['destinationConfiguration']) { // data not null
          GetLoggingConfigurationResponseDestinationConfiguration.validateJSON(data['destinationConfiguration']);
        }
        ...
        if (data['state']) { // data not null
          LoggingConfigurationState.validateJSON(data['state']);
        }
 ...
 * @member {String} arn
 */
GetLoggingConfigurationResponse.prototype['arn'] = undefined;

/**
 * @member {Date} createTime
 */
GetLoggingConfigurationResponse.prototype['createTime'] = undefined;

/**
 * @member {module:model/GetLoggingConfigurationResponseDestinationConfiguration} destinationConfiguration
 */
GetLoggingConfigurationResponse.prototype['destinationConfiguration'] = undefined;

/**
 * @member {String} id
 */
GetLoggingConfigurationResponse.prototype['id'] = undefined;

/**
 * @member {String} name
 */
GetLoggingConfigurationResponse.prototype['name'] = undefined;

/**
 * @member {module:model/LoggingConfigurationState} state
 */
GetLoggingConfigurationResponse.prototype['state'] = undefined;

/**
 * @member {Object} tags
 */
GetLoggingConfigurationResponse.prototype['tags'] = undefined;

/**
 * @member {Date} updateTime
 */
GetLoggingConfigurationResponse.prototype['updateTime'] = undefined;
...
export default GetLoggingConfigurationResponse;
