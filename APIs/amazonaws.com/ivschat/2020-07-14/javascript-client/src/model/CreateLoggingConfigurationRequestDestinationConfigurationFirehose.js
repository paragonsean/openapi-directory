...
/**
 * The CreateLoggingConfigurationRequestDestinationConfigurationFirehose model module.
 * @module model/CreateLoggingConfigurationRequestDestinationConfigurationFirehose
 * @version 2020-07-14
 */
class CreateLoggingConfigurationRequestDestinationConfigurationFirehose {
    /**
     * Constructs a new <code>CreateLoggingConfigurationRequestDestinationConfigurationFirehose</code>.
     * @alias module:model/CreateLoggingConfigurationRequestDestinationConfigurationFirehose
     * @implements module:model/FirehoseDestinationConfiguration
    ...
    constructor(deliveryStreamName) { 
        ...
        CreateLoggingConfigurationRequestDestinationConfigurationFirehose.initialize(this, deliveryStreamName);
    }
    ...
    /**
     * Constructs a <code>CreateLoggingConfigurationRequestDestinationConfigurationFirehose</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLoggingConfigurationRequestDestinationConfigurationFirehose} obj Optional instance to populate.
     * @return {module:model/CreateLoggingConfigurationRequestDestinationConfigurationFirehose} The populated <code>CreateLoggingConfigurationRequestDestinationConfigurationFirehose</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLoggingConfigurationRequestDestinationConfigurationFirehose();
            FirehoseDestinationConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLoggingConfigurationRequestDestinationConfigurationFirehose</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLoggingConfigurationRequestDestinationConfigurationFirehose</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLoggingConfigurationRequestDestinationConfigurationFirehose.RequiredProperties) {
...
CreateLoggingConfigurationRequestDestinationConfigurationFirehose.RequiredProperties = ["deliveryStreamName"];

/**
 * @member {String} deliveryStreamName
 */
CreateLoggingConfigurationRequestDestinationConfigurationFirehose.prototype['deliveryStreamName'] = undefined;


// Implement FirehoseDestinationConfiguration interface:
/**
 * @member {String} deliveryStreamName
 */
...
export default CreateLoggingConfigurationRequestDestinationConfigurationFirehose;
