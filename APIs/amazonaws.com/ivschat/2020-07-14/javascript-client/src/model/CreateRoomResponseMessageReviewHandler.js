...
/**
 * The CreateRoomResponseMessageReviewHandler model module.
 * @module model/CreateRoomResponseMessageReviewHandler
 * @version 2020-07-14
 */
class CreateRoomResponseMessageReviewHandler {
    /**
     * Constructs a new <code>CreateRoomResponseMessageReviewHandler</code>.
     * @alias module:model/CreateRoomResponseMessageReviewHandler
     * @implements module:model/MessageReviewHandler
     */
    constructor() { 
        MessageReviewHandler.initialize(this);
        CreateRoomResponseMessageReviewHandler.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRoomResponseMessageReviewHandler</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRoomResponseMessageReviewHandler} obj Optional instance to populate.
     * @return {module:model/CreateRoomResponseMessageReviewHandler} The populated <code>CreateRoomResponseMessageReviewHandler</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRoomResponseMessageReviewHandler();
            MessageReviewHandler.constructFromObject(data, obj);

            if (data.hasOwnProperty('fallbackResult')) {
                obj['fallbackResult'] = ApiClient.convertToType(data['fallbackResult'], FallbackResult);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRoomResponseMessageReviewHandler</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRoomResponseMessageReviewHandler</code>.
     */
    static validateJSON(data) {
        // validate the optional field `fallbackResult`
        if (data['fallbackResult']) { // data not null
          FallbackResult.validateJSON(data['fallbackResult']);
        }
...
/**
 * @member {module:model/FallbackResult} fallbackResult
 */
CreateRoomResponseMessageReviewHandler.prototype['fallbackResult'] = undefined;

/**
 * @member {String} uri
 */
CreateRoomResponseMessageReviewHandler.prototype['uri'] = undefined;


// Implement MessageReviewHandler interface:
/**
 * @member {module:model/FallbackResult} fallbackResult
 */
MessageReviewHandler.prototype['fallbackResult'] = undefined;
/**
 * @member {String} uri
 */
MessageReviewHandler.prototype['uri'] = undefined;




export default CreateRoomResponseMessageReviewHandler;
