...
class DeleteLoggingConfigurationRequest {
     ...
     * @param identifier {String} Identifier of the logging configuration to be deleted.
     */
    constructor(identifier) { 
        
        DeleteLoggingConfigurationRequest.initialize(this, identifier);
    }
...
DeleteLoggingConfigurationRequest.RequiredProperties = ["identifier"];

/**
 * Identifier of the logging configuration to be deleted.
 * @member {String} identifier
 */
DeleteLoggingConfigurationRequest.prototype['identifier'] = undefined;
