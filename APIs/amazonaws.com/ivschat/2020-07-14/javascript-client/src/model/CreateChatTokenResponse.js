...
/**
 * The CreateChatTokenResponse model module.
 * @module model/CreateChatTokenResponse
 * @version 2020-07-14
 */
class CreateChatTokenResponse {
    /**
     * Constructs a new <code>CreateChatTokenResponse</code>.
     * @alias module:model/CreateChatTokenResponse
     */
    constructor() { 
        
        CreateChatTokenResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateChatTokenResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateChatTokenResponse} obj Optional instance to populate.
     * @return {module:model/CreateChatTokenResponse} The populated <code>CreateChatTokenResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateChatTokenResponse();

            if (data.hasOwnProperty('sessionExpirationTime')) {
                obj['sessionExpirationTime'] = ApiClient.convertToType(data['sessionExpirationTime'], 'Date');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateChatTokenResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateChatTokenResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `sessionExpirationTime`
        if (data['sessionExpirationTime']) { // data not null
          Date.validateJSON(data['sessionExpirationTime']);
        }
        ...
        if (data['tokenExpirationTime']) { // data not null
          Date.validateJSON(data['tokenExpirationTime']);
        }
...
/**
 * @member {Date} sessionExpirationTime
 */
CreateChatTokenResponse.prototype['sessionExpirationTime'] = undefined;

/**
 * @member {String} token
 */
CreateChatTokenResponse.prototype['token'] = undefined;

/**
 * @member {Date} tokenExpirationTime
 */
CreateChatTokenResponse.prototype['tokenExpirationTime'] = undefined;
...
export default CreateChatTokenResponse;
