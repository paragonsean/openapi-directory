...
import ChatTokenCapability from './ChatTokenCapability';

/**
 * The CreateChatTokenRequest model module.
 * @module model/CreateChatTokenRequest
 * @version 2020-07-14
 */
class CreateChatTokenRequest {
    /**
     * Constructs a new <code>CreateChatTokenRequest</code>.
     * @alias module:model/CreateChatTokenRequest
     * @param roomIdentifier {String} Identifier of the room that the client is trying to access. Currently this must be an ARN. 
     * @param userId {String} Application-provided ID that uniquely identifies the user associated with this token. This can be any UTF-8 encoded text.
     */
    constructor(roomIdentifier, userId) { 
        
        CreateChatTokenRequest.initialize(this, roomIdentifier, userId);
    }
     ...
     */
    static initialize(obj, roomIdentifier, userId) { 
        obj['roomIdentifier'] = roomIdentifier;
        obj['userId'] = userId;
    }

    /**
     * Constructs a <code>CreateChatTokenRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateChatTokenRequest} obj Optional instance to populate.
     * @return {module:model/CreateChatTokenRequest} The populated <code>CreateChatTokenRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateChatTokenRequest();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = ApiClient.convertToType(data['attributes'], {'String': 'String'});
            }
            if (data.hasOwnProperty('capabilities')) {
                obj['capabilities'] = ApiClient.convertToType(data['capabilities'], [ChatTokenCapability]);
            }
            if (data.hasOwnProperty('roomIdentifier')) {
                obj['roomIdentifier'] = ApiClient.convertToType(data['roomIdentifier'], 'String');
            }
            if (data.hasOwnProperty('sessionDurationInMinutes')) {
                obj['sessionDurationInMinutes'] = ApiClient.convertToType(data['sessionDurationInMinutes'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateChatTokenRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateChatTokenRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateChatTokenRequest.RequiredProperties) {
...
CreateChatTokenRequest.RequiredProperties = ["roomIdentifier", "userId"];

/**
 * Application-provided attributes to encode into the token and attach to a chat session. Map keys and values can contain UTF-8 encoded text. The maximum length of this field is 1 KB total.
 * @member {Object.<String, String>} attributes
 */
CreateChatTokenRequest.prototype['attributes'] = undefined;

/**
 * Set of capabilities that the user is allowed to perform in the room. Default: None (the capability to view messages is implicitly included in all requests).
 * @member {Array.<module:model/ChatTokenCapability>} capabilities
 */
CreateChatTokenRequest.prototype['capabilities'] = undefined;

/**
 * Identifier of the room that the client is trying to access. Currently this must be an ARN. 
 * @member {String} roomIdentifier
 */
CreateChatTokenRequest.prototype['roomIdentifier'] = undefined;

/**
 * Session duration (in minutes), after which the session expires. Default: 60 (1 hour).
 * @member {Number} sessionDurationInMinutes
 */
CreateChatTokenRequest.prototype['sessionDurationInMinutes'] = undefined;

/**
 * Application-provided ID that uniquely identifies the user associated with this token. This can be any UTF-8 encoded text.
 * @member {String} userId
 */
CreateChatTokenRequest.prototype['userId'] = undefined;
...
export default CreateChatTokenRequest;
