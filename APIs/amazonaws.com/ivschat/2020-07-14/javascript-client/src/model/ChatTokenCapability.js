...
* @readonly
*/
export default class ChatTokenCapability {
    ...
    /**
    * Returns a <code>ChatTokenCapability</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ChatTokenCapability} The enum <code>ChatTokenCapability</code> value.
    */
