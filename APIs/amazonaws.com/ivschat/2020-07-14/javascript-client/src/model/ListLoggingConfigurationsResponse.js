...
class ListLoggingConfigurationsResponse {
     ...
     * @param loggingConfigurations {Array} 
     */
    constructor(loggingConfigurations) { 
        
        ListLoggingConfigurationsResponse.initialize(this, loggingConfigurations);
    }
     ...
     */
    static initialize(obj, loggingConfigurations) { 
        obj['loggingConfigurations'] = loggingConfigurations;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListLoggingConfigurationsResponse.RequiredProperties) {
...
ListLoggingConfigurationsResponse.RequiredProperties = ["loggingConfigurations"];
 ...
 */
ListLoggingConfigurationsResponse.prototype['nextToken'] = undefined;
