...
* @readonly
*/
export default class LoggingConfigurationState {
    ...
    /**
    * Returns a <code>LoggingConfigurationState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/LoggingConfigurationState} The enum <code>LoggingConfigurationState</code> value.
    */
