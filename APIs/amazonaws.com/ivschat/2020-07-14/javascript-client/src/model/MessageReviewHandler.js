...
/**
 * The MessageReviewHandler model module.
 * @module model/MessageReviewHandler
 * @version 2020-07-14
 */
class MessageReviewHandler {
    /**
     * Constructs a new <code>MessageReviewHandler</code>.
     * Configuration information for optional message review.
     * @alias module:model/MessageReviewHandler
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MessageReviewHandler</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageReviewHandler} obj Optional instance to populate.
     * @return {module:model/MessageReviewHandler} The populated <code>MessageReviewHandler</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageReviewHandler();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageReviewHandler</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageReviewHandler</code>.
     */
...
export default MessageReviewHandler;
