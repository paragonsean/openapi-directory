...
import CreateLoggingConfigurationResponseDestinationConfiguration from './CreateLoggingConfigurationResponseDestinationConfiguration';
import CreateLoggingConfigurationState from './CreateLoggingConfigurationState';
...
class CreateLoggingConfigurationResponse {
    ...
    constructor() { 
        ...
        CreateLoggingConfigurationResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('destinationConfiguration')) {
                obj['destinationConfiguration'] = CreateLoggingConfigurationResponseDestinationConfiguration.constructFromObject(data['destinationConfiguration']);
            }
            ...
            if (data.hasOwnProperty('state')) {
                obj['state'] = ApiClient.convertToType(data['state'], CreateLoggingConfigurationState);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['destinationConfiguration']) { // data not null
          CreateLoggingConfigurationResponseDestinationConfiguration.validateJSON(data['destinationConfiguration']);
        }
        ...
        if (data['state']) { // data not null
          CreateLoggingConfigurationState.validateJSON(data['state']);
        }
 ...
 * @member {String} arn
 */
CreateLoggingConfigurationResponse.prototype['arn'] = undefined;

/**
 * @member {Date} createTime
 */
CreateLoggingConfigurationResponse.prototype['createTime'] = undefined;

/**
 * @member {module:model/CreateLoggingConfigurationResponseDestinationConfiguration} destinationConfiguration
 */
CreateLoggingConfigurationResponse.prototype['destinationConfiguration'] = undefined;

/**
 * @member {String} id
 */
CreateLoggingConfigurationResponse.prototype['id'] = undefined;

/**
 * @member {String} name
 */
CreateLoggingConfigurationResponse.prototype['name'] = undefined;

/**
 * @member {module:model/CreateLoggingConfigurationState} state
 */
CreateLoggingConfigurationResponse.prototype['state'] = undefined;

/**
 * @member {Object} tags
 */
CreateLoggingConfigurationResponse.prototype['tags'] = undefined;

/**
 * @member {Date} updateTime
 */
CreateLoggingConfigurationResponse.prototype['updateTime'] = undefined;
