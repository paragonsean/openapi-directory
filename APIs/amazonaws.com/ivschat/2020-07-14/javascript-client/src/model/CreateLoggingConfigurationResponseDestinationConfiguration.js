...
/**
 * The CreateLoggingConfigurationResponseDestinationConfiguration model module.
 * @module model/CreateLoggingConfigurationResponseDestinationConfiguration
 * @version 2020-07-14
 */
class CreateLoggingConfigurationResponseDestinationConfiguration {
    /**
     * Constructs a new <code>CreateLoggingConfigurationResponseDestinationConfiguration</code>.
     * @alias module:model/CreateLoggingConfigurationResponseDestinationConfiguration
     * @implements module:model/DestinationConfiguration
     */
    constructor() { 
        DestinationConfiguration.initialize(this);
        CreateLoggingConfigurationResponseDestinationConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateLoggingConfigurationResponseDestinationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLoggingConfigurationResponseDestinationConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateLoggingConfigurationResponseDestinationConfiguration} The populated <code>CreateLoggingConfigurationResponseDestinationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLoggingConfigurationResponseDestinationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLoggingConfigurationResponseDestinationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLoggingConfigurationResponseDestinationConfiguration</code>.
     */
 ...
 */
CreateLoggingConfigurationResponseDestinationConfiguration.prototype['cloudWatchLogs'] = undefined;

/**
 * @member {module:model/CreateLoggingConfigurationRequestDestinationConfigurationFirehose} firehose
 */
CreateLoggingConfigurationResponseDestinationConfiguration.prototype['firehose'] = undefined;

/**
 * @member {module:model/CreateLoggingConfigurationRequestDestinationConfigurationS3} s3
 */
CreateLoggingConfigurationResponseDestinationConfiguration.prototype['s3'] = undefined;
...
export default CreateLoggingConfigurationResponseDestinationConfiguration;
