...
/**
 * The CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs model module.
 * @module model/CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs
 * @version 2020-07-14
 */
class CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs {
    /**
     * Constructs a new <code>CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs</code>.
     * @alias module:model/CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs
     * @implements module:model/CloudWatchLogsDestinationConfiguration
     * @param logGroupName {String} 
     */
    constructor(logGroupName) { 
        CloudWatchLogsDestinationConfiguration.initialize(this, logGroupName);
        CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs.initialize(this, logGroupName);
    }
    ...
    /**
     * Constructs a <code>CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs} obj Optional instance to populate.
     * @return {module:model/CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs} The populated <code>CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs();
            CloudWatchLogsDestinationConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs.RequiredProperties) {
...
CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs.RequiredProperties = ["logGroupName"];

/**
 * @member {String} logGroupName
 */
CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs.prototype['logGroupName'] = undefined;


// Implement CloudWatchLogsDestinationConfiguration interface:
/**
 * @member {String} logGroupName
 */
...
export default CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs;
