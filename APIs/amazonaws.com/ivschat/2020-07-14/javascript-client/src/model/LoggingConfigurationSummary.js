...
import LoggingConfigurationSummaryDestinationConfiguration from './LoggingConfigurationSummaryDestinationConfiguration';

/**
 * The LoggingConfigurationSummary model module.
 * @module model/LoggingConfigurationSummary
 * @version 2020-07-14
 */
class LoggingConfigurationSummary {
    /**
     * Constructs a new <code>LoggingConfigurationSummary</code>.
     * Summary information about a logging configuration.
     * @alias module:model/LoggingConfigurationSummary
     */
    constructor() { 
        
        LoggingConfigurationSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoggingConfigurationSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoggingConfigurationSummary} obj Optional instance to populate.
     * @return {module:model/LoggingConfigurationSummary} The populated <code>LoggingConfigurationSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoggingConfigurationSummary();
            ...
            if (data.hasOwnProperty('destinationConfiguration')) {
                obj['destinationConfiguration'] = LoggingConfigurationSummaryDestinationConfiguration.constructFromObject(data['destinationConfiguration']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LoggingConfigurationSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoggingConfigurationSummary</code>.
     */
    static validateJSON(data) {
        ...
        if (data['destinationConfiguration']) { // data not null
          LoggingConfigurationSummaryDestinationConfiguration.validateJSON(data['destinationConfiguration']);
        }
 ...
 * @member {String} arn
 */
LoggingConfigurationSummary.prototype['arn'] = undefined;

/**
 * @member {Date} createTime
 */
LoggingConfigurationSummary.prototype['createTime'] = undefined;

/**
 * @member {module:model/LoggingConfigurationSummaryDestinationConfiguration} destinationConfiguration
 */
LoggingConfigurationSummary.prototype['destinationConfiguration'] = undefined;

/**
 * @member {String} id
 */
LoggingConfigurationSummary.prototype['id'] = undefined;

/**
 * @member {String} name
 */
LoggingConfigurationSummary.prototype['name'] = undefined;

/**
 * @member {module:model/LoggingConfigurationState} state
 */
LoggingConfigurationSummary.prototype['state'] = undefined;

/**
 * @member {Object} tags
 */
LoggingConfigurationSummary.prototype['tags'] = undefined;

/**
 * @member {Date} updateTime
 */
LoggingConfigurationSummary.prototype['updateTime'] = undefined;
...
export default LoggingConfigurationSummary;
