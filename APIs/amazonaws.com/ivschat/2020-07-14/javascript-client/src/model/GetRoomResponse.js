...
/**
 * The GetRoomResponse model module.
 * @module model/GetRoomResponse
 * @version 2020-07-14
 */
class GetRoomResponse {
    /**
     * Constructs a new <code>GetRoomResponse</code>.
     * @alias module:model/GetRoomResponse
     */
    constructor() { 
        
        GetRoomResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetRoomResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRoomResponse} obj Optional instance to populate.
     * @return {module:model/GetRoomResponse} The populated <code>GetRoomResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRoomResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRoomResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRoomResponse</code>.
     */
 ...
 * @member {String} arn
 */
GetRoomResponse.prototype['arn'] = undefined;

/**
 * @member {Date} createTime
 */
GetRoomResponse.prototype['createTime'] = undefined;

/**
 * @member {String} id
 */
GetRoomResponse.prototype['id'] = undefined;

/**
 * @member {Array} loggingConfigurationIdentifiers
 */
GetRoomResponse.prototype['loggingConfigurationIdentifiers'] = undefined;

/**
 * @member {Number} maximumMessageLength
 */
GetRoomResponse.prototype['maximumMessageLength'] = undefined;

/**
 * @member {Number} maximumMessageRatePerSecond
 */
GetRoomResponse.prototype['maximumMessageRatePerSecond'] = undefined;

/**
 * @member {module:model/CreateRoomResponseMessageReviewHandler} messageReviewHandler
 */
GetRoomResponse.prototype['messageReviewHandler'] = undefined;

/**
 * @member {String} name
 */
GetRoomResponse.prototype['name'] = undefined;

/**
 * @member {Object} tags
 */
GetRoomResponse.prototype['tags'] = undefined;

/**
 * @member {Date} updateTime
 */
GetRoomResponse.prototype['updateTime'] = undefined;
...
export default GetRoomResponse;
