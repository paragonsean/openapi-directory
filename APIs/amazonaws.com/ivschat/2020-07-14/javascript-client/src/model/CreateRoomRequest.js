...
class CreateRoomRequest {
    ...
    constructor() { 
        ...
        CreateRoomRequest.initialize(this);
    }
 ...
 */
CreateRoomRequest.prototype['loggingConfigurationIdentifiers'] = undefined;

/**
 * Maximum number of characters in a single message. Messages are expected to be UTF-8 encoded and this limit applies specifically to rune/code-point count, not number of bytes. Default: 500.
 * @member {Number} maximumMessageLength
 */
CreateRoomRequest.prototype['maximumMessageLength'] = undefined;

/**
 * Maximum number of messages per second that can be sent to the room (by all clients). Default: 10. 
 * @member {Number} maximumMessageRatePerSecond
 */
CreateRoomRequest.prototype['maximumMessageRatePerSecond'] = undefined;

/**
 * @member {module:model/CreateRoomRequestMessageReviewHandler} messageReviewHandler
 */
CreateRoomRequest.prototype['messageReviewHandler'] = undefined;
 ...
 */
CreateRoomRequest.prototype['tags'] = undefined;
