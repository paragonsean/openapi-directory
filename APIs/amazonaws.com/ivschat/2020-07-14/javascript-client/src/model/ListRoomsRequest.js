...
/**
 * The ListRoomsRequest model module.
 * @module model/ListRoomsRequest
 * @version 2020-07-14
 */
class ListRoomsRequest {
    /**
     * Constructs a new <code>ListRoomsRequest</code>.
     * @alias module:model/ListRoomsRequest
     */
    constructor() { 
        
        ListRoomsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRoomsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRoomsRequest} obj Optional instance to populate.
     * @return {module:model/ListRoomsRequest} The populated <code>ListRoomsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRoomsRequest();

            if (data.hasOwnProperty('loggingConfigurationIdentifier')) {
                obj['loggingConfigurationIdentifier'] = ApiClient.convertToType(data['loggingConfigurationIdentifier'], 'String');
            }
            if (data.hasOwnProperty('maxResults')) {
                obj['maxResults'] = ApiClient.convertToType(data['maxResults'], 'Number');
            }
            if (data.hasOwnProperty('messageReviewHandlerUri')) {
                obj['messageReviewHandlerUri'] = ApiClient.convertToType(data['messageReviewHandlerUri'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListRoomsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRoomsRequest</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['loggingConfigurationIdentifier'] && !(typeof data['loggingConfigurationIdentifier'] === 'string' || data['loggingConfigurationIdentifier'] instanceof String)) {
            throw new Error("Expected the field `loggingConfigurationIdentifier` to be a primitive type in the JSON string but got " + data['loggingConfigurationIdentifier']);
        }
        // ensure the json data is a string
        if (data['messageReviewHandlerUri'] && !(typeof data['messageReviewHandlerUri'] === 'string' || data['messageReviewHandlerUri'] instanceof String)) {
            throw new Error("Expected the field `messageReviewHandlerUri` to be a primitive type in the JSON string but got " + data['messageReviewHandlerUri']);
        }
        // ensure the json data is a string
 ...
 * @member {String} loggingConfigurationIdentifier
 */
ListRoomsRequest.prototype['loggingConfigurationIdentifier'] = undefined;

/**
 * Maximum number of rooms to return. Default: 50.
 * @member {Number} maxResults
 */
ListRoomsRequest.prototype['maxResults'] = undefined;

/**
 * Filters the list to match the specified message review handler URI.
 * @member {String} messageReviewHandlerUri
 */
ListRoomsRequest.prototype['messageReviewHandlerUri'] = undefined;

/**
 * Filters the list to match the specified room name.
 * @member {String} name
 */
ListRoomsRequest.prototype['name'] = undefined;

/**
 * The first room to retrieve. This is used for pagination; see the <code>nextToken</code> response field.
 * @member {String} nextToken
 */
ListRoomsRequest.prototype['nextToken'] = undefined;
...
export default ListRoomsRequest;
