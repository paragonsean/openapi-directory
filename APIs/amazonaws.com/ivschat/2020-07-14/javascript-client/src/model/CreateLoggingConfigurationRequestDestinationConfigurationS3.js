...
/**
 * The CreateLoggingConfigurationRequestDestinationConfigurationS3 model module.
 * @module model/CreateLoggingConfigurationRequestDestinationConfigurationS3
 * @version 2020-07-14
 */
class CreateLoggingConfigurationRequestDestinationConfigurationS3 {
    /**
     * Constructs a new <code>CreateLoggingConfigurationRequestDestinationConfigurationS3</code>.
     * @alias module:model/CreateLoggingConfigurationRequestDestinationConfigurationS3
     * @implements module:model/S3DestinationConfiguration
     * @param bucketName {String} 
     */
    constructor(bucketName) { 
        S3DestinationConfiguration.initialize(this, bucketName);
        CreateLoggingConfigurationRequestDestinationConfigurationS3.initialize(this, bucketName);
    }
    ...
    /**
     * Constructs a <code>CreateLoggingConfigurationRequestDestinationConfigurationS3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLoggingConfigurationRequestDestinationConfigurationS3} obj Optional instance to populate.
     * @return {module:model/CreateLoggingConfigurationRequestDestinationConfigurationS3} The populated <code>CreateLoggingConfigurationRequestDestinationConfigurationS3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLoggingConfigurationRequestDestinationConfigurationS3();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLoggingConfigurationRequestDestinationConfigurationS3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLoggingConfigurationRequestDestinationConfigurationS3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLoggingConfigurationRequestDestinationConfigurationS3.RequiredProperties) {
...
CreateLoggingConfigurationRequestDestinationConfigurationS3.RequiredProperties = ["bucketName"];

/**
 * @member {String} bucketName
 */
CreateLoggingConfigurationRequestDestinationConfigurationS3.prototype['bucketName'] = undefined;
 ...
 * @member {String} bucketName
 */
S3DestinationConfiguration.prototype['bucketName'] = undefined;




export default CreateLoggingConfigurationRequestDestinationConfigurationS3;
