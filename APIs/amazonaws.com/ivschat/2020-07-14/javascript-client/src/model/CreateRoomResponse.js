...
import CreateRoomResponseMessageReviewHandler from './CreateRoomResponseMessageReviewHandler';

/**
 * The CreateRoomResponse model module.
 * @module model/CreateRoomResponse
 * @version 2020-07-14
 */
class CreateRoomResponse {
    /**
     * Constructs a new <code>CreateRoomResponse</code>.
     * @alias module:model/CreateRoomResponse
     */
    constructor() { 
        
        CreateRoomResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRoomResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRoomResponse} obj Optional instance to populate.
     * @return {module:model/CreateRoomResponse} The populated <code>CreateRoomResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRoomResponse();
            ...
            if (data.hasOwnProperty('loggingConfigurationIdentifiers')) {
                obj['loggingConfigurationIdentifiers'] = ApiClient.convertToType(data['loggingConfigurationIdentifiers'], Array);
            }
            if (data.hasOwnProperty('maximumMessageLength')) {
                obj['maximumMessageLength'] = ApiClient.convertToType(data['maximumMessageLength'], 'Number');
            }
            if (data.hasOwnProperty('maximumMessageRatePerSecond')) {
                obj['maximumMessageRatePerSecond'] = ApiClient.convertToType(data['maximumMessageRatePerSecond'], 'Number');
            }
            if (data.hasOwnProperty('messageReviewHandler')) {
                obj['messageReviewHandler'] = CreateRoomResponseMessageReviewHandler.constructFromObject(data['messageReviewHandler']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRoomResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRoomResponse</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `loggingConfigurationIdentifiers`
        if (data['loggingConfigurationIdentifiers']) { // data not null
          Array.validateJSON(data['loggingConfigurationIdentifiers']);
        }
        // validate the optional field `maximumMessageLength`
        if (data['maximumMessageLength']) { // data not null
          Number.validateJSON(data['maximumMessageLength']);
        }
        // validate the optional field `maximumMessageRatePerSecond`
        if (data['maximumMessageRatePerSecond']) { // data not null
          Number.validateJSON(data['maximumMessageRatePerSecond']);
        }
        // validate the optional field `messageReviewHandler`
        if (data['messageReviewHandler']) { // data not null
          CreateRoomResponseMessageReviewHandler.validateJSON(data['messageReviewHandler']);
        }
 ...
 * @member {String} arn
 */
CreateRoomResponse.prototype['arn'] = undefined;

/**
 * @member {Date} createTime
 */
CreateRoomResponse.prototype['createTime'] = undefined;

/**
 * @member {String} id
 */
CreateRoomResponse.prototype['id'] = undefined;

/**
 * @member {Array} loggingConfigurationIdentifiers
 */
CreateRoomResponse.prototype['loggingConfigurationIdentifiers'] = undefined;

/**
 * @member {Number} maximumMessageLength
 */
CreateRoomResponse.prototype['maximumMessageLength'] = undefined;

/**
 * @member {Number} maximumMessageRatePerSecond
 */
CreateRoomResponse.prototype['maximumMessageRatePerSecond'] = undefined;

/**
 * @member {module:model/CreateRoomResponseMessageReviewHandler} messageReviewHandler
 */
CreateRoomResponse.prototype['messageReviewHandler'] = undefined;

/**
 * @member {String} name
 */
CreateRoomResponse.prototype['name'] = undefined;

/**
 * @member {Object} tags
 */
CreateRoomResponse.prototype['tags'] = undefined;

/**
 * @member {Date} updateTime
 */
CreateRoomResponse.prototype['updateTime'] = undefined;
