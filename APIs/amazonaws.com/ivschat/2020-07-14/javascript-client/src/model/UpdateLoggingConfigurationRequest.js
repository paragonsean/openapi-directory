...
import CreateLoggingConfigurationRequestDestinationConfiguration from './CreateLoggingConfigurationRequestDestinationConfiguration';
...
class UpdateLoggingConfigurationRequest {
     ...
     * @param identifier {String} Identifier of the logging configuration to be updated.
     */
    constructor(identifier) { 
        
        UpdateLoggingConfigurationRequest.initialize(this, identifier);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('destinationConfiguration')) {
                obj['destinationConfiguration'] = CreateLoggingConfigurationRequestDestinationConfiguration.constructFromObject(data['destinationConfiguration']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['destinationConfiguration']) { // data not null
          CreateLoggingConfigurationRequestDestinationConfiguration.validateJSON(data['destinationConfiguration']);
        }
...
UpdateLoggingConfigurationRequest.RequiredProperties = ["identifier"];

/**
 * @member {module:model/CreateLoggingConfigurationRequestDestinationConfiguration} destinationConfiguration
 */
UpdateLoggingConfigurationRequest.prototype['destinationConfiguration'] = undefined;

/**
 * Identifier of the logging configuration to be updated.
 * @member {String} identifier
 */
UpdateLoggingConfigurationRequest.prototype['identifier'] = undefined;

/**
 * Logging-configuration name. The value does not need to be unique.
 * @member {String} name
 */
UpdateLoggingConfigurationRequest.prototype['name'] = undefined;
