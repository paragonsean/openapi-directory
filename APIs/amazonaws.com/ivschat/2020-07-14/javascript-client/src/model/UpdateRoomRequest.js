...
import CreateRoomRequestMessageReviewHandler from './CreateRoomRequestMessageReviewHandler';
...
class UpdateRoomRequest {
     ...
     * @param identifier {String} Identifier of the room to be updated. Currently this must be an ARN.
     */
    constructor(identifier) { 
        
        UpdateRoomRequest.initialize(this, identifier);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('loggingConfigurationIdentifiers')) {
                obj['loggingConfigurationIdentifiers'] = ApiClient.convertToType(data['loggingConfigurationIdentifiers'], ['String']);
            }
            ...
            if (data.hasOwnProperty('messageReviewHandler')) {
                obj['messageReviewHandler'] = CreateRoomRequestMessageReviewHandler.constructFromObject(data['messageReviewHandler']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of UpdateRoomRequest.RequiredProperties) {
        ...
        if (!Array.isArray(data['loggingConfigurationIdentifiers'])) {
            throw new Error("Expected the field `loggingConfigurationIdentifiers` to be an array in the JSON data but got " + data['loggingConfigurationIdentifiers']);
        }
        // validate the optional field `messageReviewHandler`
        if (data['messageReviewHandler']) { // data not null
          CreateRoomRequestMessageReviewHandler.validateJSON(data['messageReviewHandler']);
        }
        // ensure the json data is a string
...
UpdateRoomRequest.RequiredProperties = ["identifier"];

/**
 * Identifier of the room to be updated. Currently this must be an ARN.
 * @member {String} identifier
 */
UpdateRoomRequest.prototype['identifier'] = undefined;

/**
 * Array of logging-configuration identifiers attached to the room.
 * @member {Array.<String>} loggingConfigurationIdentifiers
 */
UpdateRoomRequest.prototype['loggingConfigurationIdentifiers'] = undefined;

/**
 * The maximum number of characters in a single message. Messages are expected to be UTF-8 encoded and this limit applies specifically to rune/code-point count, not number of bytes. Default: 500.
 * @member {Number} maximumMessageLength
 */
UpdateRoomRequest.prototype['maximumMessageLength'] = undefined;

/**
 * Maximum number of messages per second that can be sent to the room (by all clients). Default: 10.
 * @member {Number} maximumMessageRatePerSecond
 */
UpdateRoomRequest.prototype['maximumMessageRatePerSecond'] = undefined;

/**
 * @member {module:model/CreateRoomRequestMessageReviewHandler} messageReviewHandler
 */
UpdateRoomRequest.prototype['messageReviewHandler'] = undefined;
