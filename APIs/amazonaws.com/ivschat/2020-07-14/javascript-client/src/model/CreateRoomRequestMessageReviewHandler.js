...
/**
 * The CreateRoomRequestMessageReviewHandler model module.
 * @module model/CreateRoomRequestMessageReviewHandler
 * @version 2020-07-14
 */
class CreateRoomRequestMessageReviewHandler {
    /**
     * Constructs a new <code>CreateRoomRequestMessageReviewHandler</code>.
     * Configuration information for optional message review.
     * @alias module:model/CreateRoomRequestMessageReviewHandler
     */
    constructor() { 
        
        CreateRoomRequestMessageReviewHandler.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRoomRequestMessageReviewHandler</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRoomRequestMessageReviewHandler} obj Optional instance to populate.
     * @return {module:model/CreateRoomRequestMessageReviewHandler} The populated <code>CreateRoomRequestMessageReviewHandler</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRoomRequestMessageReviewHandler();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRoomRequestMessageReviewHandler</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRoomRequestMessageReviewHandler</code>.
     */
 ...
 */
CreateRoomRequestMessageReviewHandler.prototype['fallbackResult'] = undefined;

/**
 * @member {String} uri
 */
CreateRoomRequestMessageReviewHandler.prototype['uri'] = undefined;
...
export default CreateRoomRequestMessageReviewHandler;
