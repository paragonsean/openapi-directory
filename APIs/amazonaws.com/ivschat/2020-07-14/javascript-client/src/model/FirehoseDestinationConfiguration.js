...
/**
 * The FirehoseDestinationConfiguration model module.
 * @module model/FirehoseDestinationConfiguration
 * @version 2020-07-14
 */
class FirehoseDestinationConfiguration {
    /**
     * Constructs a new <code>FirehoseDestinationConfiguration</code>.
     * Specifies a Kinesis Firehose location where chat logs will be stored.
     * @alias module:model/FirehoseDestinationConfiguration
     * @param deliveryStreamName {String} 
     */
    constructor(deliveryStreamName) { 
        
        FirehoseDestinationConfiguration.initialize(this, deliveryStreamName);
    }
    ...
    /**
     * Constructs a <code>FirehoseDestinationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirehoseDestinationConfiguration} obj Optional instance to populate.
     * @return {module:model/FirehoseDestinationConfiguration} The populated <code>FirehoseDestinationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirehoseDestinationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>FirehoseDestinationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirehoseDestinationConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirehoseDestinationConfiguration.RequiredProperties) {
...
FirehoseDestinationConfiguration.RequiredProperties = ["deliveryStreamName"];

/**
 * @member {String} deliveryStreamName
 */
FirehoseDestinationConfiguration.prototype['deliveryStreamName'] = undefined;
...
export default FirehoseDestinationConfiguration;
