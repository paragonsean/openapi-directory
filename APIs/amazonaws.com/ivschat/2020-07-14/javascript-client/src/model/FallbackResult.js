...
* @readonly
*/
export default class FallbackResult {
    ...
    /**
    * Returns a <code>FallbackResult</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FallbackResult} The enum <code>FallbackResult</code> value.
    */
