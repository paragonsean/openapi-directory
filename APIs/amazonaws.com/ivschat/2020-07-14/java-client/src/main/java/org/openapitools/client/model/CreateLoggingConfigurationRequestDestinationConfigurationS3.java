...
public class CreateLoggingConfigurationRequestDestinationConfigurationS3 {
  public static final String SERIALIZED_NAME_BUCKET_NAME = "bucketName";
  @SerializedName(SERIALIZED_NAME_BUCKET_NAME)
  private String bucketName;

  public CreateLoggingConfigurationRequestDestinationConfigurationS3() {
  }

  public CreateLoggingConfigurationRequestDestinationConfigurationS3 bucketName(String bucketName) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLoggingConfigurationRequestDestinationConfigurationS3 createLoggingConfigurationRequestDestinationConfigurationS3 = (CreateLoggingConfigurationRequestDestinationConfigurationS3) o;
    return Objects.equals(this.bucketName, createLoggingConfigurationRequestDestinationConfigurationS3.bucketName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateLoggingConfigurationRequestDestinationConfigurationS3 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLoggingConfigurationRequestDestinationConfigurationS3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLoggingConfigurationRequestDestinationConfigurationS3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLoggingConfigurationRequestDestinationConfigurationS3 is not found in the empty JSON string", CreateLoggingConfigurationRequestDestinationConfigurationS3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLoggingConfigurationRequestDestinationConfigurationS3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLoggingConfigurationRequestDestinationConfigurationS3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateLoggingConfigurationRequestDestinationConfigurationS3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLoggingConfigurationRequestDestinationConfigurationS3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLoggingConfigurationRequestDestinationConfigurationS3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLoggingConfigurationRequestDestinationConfigurationS3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLoggingConfigurationRequestDestinationConfigurationS3.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLoggingConfigurationRequestDestinationConfigurationS3>() {
           @Override
           public void write(JsonWriter out, CreateLoggingConfigurationRequestDestinationConfigurationS3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLoggingConfigurationRequestDestinationConfigurationS3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLoggingConfigurationRequestDestinationConfigurationS3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLoggingConfigurationRequestDestinationConfigurationS3
   * @throws IOException if the JSON string is invalid with respect to CreateLoggingConfigurationRequestDestinationConfigurationS3
   */
  public static CreateLoggingConfigurationRequestDestinationConfigurationS3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLoggingConfigurationRequestDestinationConfigurationS3.class);
  }

  /**
   * Convert an instance of CreateLoggingConfigurationRequestDestinationConfigurationS3 to an JSON string
   *
   * @return JSON string
   */
