...
public class CreateLoggingConfigurationResponseDestinationConfiguration {
  ...
  public CreateLoggingConfigurationResponseDestinationConfiguration() {
  }

  public CreateLoggingConfigurationResponseDestinationConfiguration cloudWatchLogs(CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs cloudWatchLogs) {
  ...
  public CreateLoggingConfigurationResponseDestinationConfiguration firehose(CreateLoggingConfigurationRequestDestinationConfigurationFirehose firehose) {
  ...
  public CreateLoggingConfigurationResponseDestinationConfiguration s3(CreateLoggingConfigurationRequestDestinationConfigurationS3 s3) {
    this.s3 = s3;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateLoggingConfigurationResponseDestinationConfiguration createLoggingConfigurationResponseDestinationConfiguration = (CreateLoggingConfigurationResponseDestinationConfiguration) o;
    return Objects.equals(this.cloudWatchLogs, createLoggingConfigurationResponseDestinationConfiguration.cloudWatchLogs) &&
        Objects.equals(this.firehose, createLoggingConfigurationResponseDestinationConfiguration.firehose) &&
        Objects.equals(this.s3, createLoggingConfigurationResponseDestinationConfiguration.s3);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateLoggingConfigurationResponseDestinationConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLoggingConfigurationResponseDestinationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLoggingConfigurationResponseDestinationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLoggingConfigurationResponseDestinationConfiguration is not found in the empty JSON string", CreateLoggingConfigurationResponseDestinationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLoggingConfigurationResponseDestinationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLoggingConfigurationResponseDestinationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLoggingConfigurationResponseDestinationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLoggingConfigurationResponseDestinationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLoggingConfigurationResponseDestinationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLoggingConfigurationResponseDestinationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLoggingConfigurationResponseDestinationConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateLoggingConfigurationResponseDestinationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLoggingConfigurationResponseDestinationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLoggingConfigurationResponseDestinationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLoggingConfigurationResponseDestinationConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateLoggingConfigurationResponseDestinationConfiguration
   */
  public static CreateLoggingConfigurationResponseDestinationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLoggingConfigurationResponseDestinationConfiguration.class);
  }

  /**
   * Convert an instance of CreateLoggingConfigurationResponseDestinationConfiguration to an JSON string
   *
   * @return JSON string
   */
