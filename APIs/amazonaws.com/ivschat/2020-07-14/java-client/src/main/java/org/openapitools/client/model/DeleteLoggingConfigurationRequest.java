...
public class DeleteLoggingConfigurationRequest {
  ...
  public DeleteLoggingConfigurationRequest() {
  }

  public DeleteLoggingConfigurationRequest identifier(String identifier) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteLoggingConfigurationRequest deleteLoggingConfigurationRequest = (DeleteLoggingConfigurationRequest) o;
    return Objects.equals(this.identifier, deleteLoggingConfigurationRequest.identifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteLoggingConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteLoggingConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteLoggingConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteLoggingConfigurationRequest is not found in the empty JSON string", DeleteLoggingConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteLoggingConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteLoggingConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteLoggingConfigurationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteLoggingConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteLoggingConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteLoggingConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteLoggingConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteLoggingConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, DeleteLoggingConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteLoggingConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteLoggingConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteLoggingConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteLoggingConfigurationRequest
   */
  public static DeleteLoggingConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteLoggingConfigurationRequest.class);
  }

  /**
   * Convert an instance of DeleteLoggingConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
