...
public class RoomSummary {
  ...
  public RoomSummary arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public RoomSummary createTime(OffsetDateTime createTime) {
  ...
  public RoomSummary id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RoomSummary loggingConfigurationIdentifiers(List loggingConfigurationIdentifiers) {
  ...
  public RoomSummary messageReviewHandler(CreateRoomResponseMessageReviewHandler messageReviewHandler) {
  ...
  public RoomSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RoomSummary tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public RoomSummary updateTime(OffsetDateTime updateTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.arn, roomSummary.arn) &&
        Objects.equals(this.createTime, roomSummary.createTime) &&
        Objects.equals(this.id, roomSummary.id) &&
        Objects.equals(this.loggingConfigurationIdentifiers, roomSummary.loggingConfigurationIdentifiers) &&
        Objects.equals(this.messageReviewHandler, roomSummary.messageReviewHandler) &&
        Objects.equals(this.name, roomSummary.name) &&
        Objects.equals(this.tags, roomSummary.tags) &&
        Objects.equals(this.updateTime, roomSummary.updateTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, createTime, id, loggingConfigurationIdentifiers, messageReviewHandler, name, tags, updateTime);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RoomSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RoomSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RoomSummary is not found in the empty JSON string", RoomSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RoomSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RoomSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RoomSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RoomSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RoomSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RoomSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<RoomSummary>() {
           @Override
           public void write(JsonWriter out, RoomSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RoomSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RoomSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RoomSummary
   * @throws IOException if the JSON string is invalid with respect to RoomSummary
   */
  public static RoomSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RoomSummary.class);
  }

  /**
   * Convert an instance of RoomSummary to an JSON string
   *
   * @return JSON string
   */
