...
public class LoggingConfigurationSummaryDestinationConfiguration {
  ...
  public LoggingConfigurationSummaryDestinationConfiguration() {
  }

  public LoggingConfigurationSummaryDestinationConfiguration cloudWatchLogs(CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs cloudWatchLogs) {
  ...
  public LoggingConfigurationSummaryDestinationConfiguration firehose(CreateLoggingConfigurationRequestDestinationConfigurationFirehose firehose) {
  ...
  public LoggingConfigurationSummaryDestinationConfiguration s3(CreateLoggingConfigurationRequestDestinationConfigurationS3 s3) {
    this.s3 = s3;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoggingConfigurationSummaryDestinationConfiguration loggingConfigurationSummaryDestinationConfiguration = (LoggingConfigurationSummaryDestinationConfiguration) o;
    return Objects.equals(this.cloudWatchLogs, loggingConfigurationSummaryDestinationConfiguration.cloudWatchLogs) &&
        Objects.equals(this.firehose, loggingConfigurationSummaryDestinationConfiguration.firehose) &&
        Objects.equals(this.s3, loggingConfigurationSummaryDestinationConfiguration.s3);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoggingConfigurationSummaryDestinationConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoggingConfigurationSummaryDestinationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoggingConfigurationSummaryDestinationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoggingConfigurationSummaryDestinationConfiguration is not found in the empty JSON string", LoggingConfigurationSummaryDestinationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoggingConfigurationSummaryDestinationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoggingConfigurationSummaryDestinationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoggingConfigurationSummaryDestinationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoggingConfigurationSummaryDestinationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoggingConfigurationSummaryDestinationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoggingConfigurationSummaryDestinationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<LoggingConfigurationSummaryDestinationConfiguration>() {
           @Override
           public void write(JsonWriter out, LoggingConfigurationSummaryDestinationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoggingConfigurationSummaryDestinationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoggingConfigurationSummaryDestinationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoggingConfigurationSummaryDestinationConfiguration
   * @throws IOException if the JSON string is invalid with respect to LoggingConfigurationSummaryDestinationConfiguration
   */
  public static LoggingConfigurationSummaryDestinationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoggingConfigurationSummaryDestinationConfiguration.class);
  }

  /**
   * Convert an instance of LoggingConfigurationSummaryDestinationConfiguration to an JSON string
   *
   * @return JSON string
   */
