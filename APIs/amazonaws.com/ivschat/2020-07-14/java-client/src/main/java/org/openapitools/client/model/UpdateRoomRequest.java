...
import org.openapitools.client.model.CreateRoomRequestMessageReviewHandler;
...
public class UpdateRoomRequest {
  ...
  public static final String SERIALIZED_NAME_LOGGING_CONFIGURATION_IDENTIFIERS = "loggingConfigurationIdentifiers";
  @SerializedName(SERIALIZED_NAME_LOGGING_CONFIGURATION_IDENTIFIERS)
  private List<String> loggingConfigurationIdentifiers = new ArrayList<>();

  public static final String SERIALIZED_NAME_MAXIMUM_MESSAGE_LENGTH = "maximumMessageLength";
  @SerializedName(SERIALIZED_NAME_MAXIMUM_MESSAGE_LENGTH)
  private Integer maximumMessageLength;

  public static final String SERIALIZED_NAME_MAXIMUM_MESSAGE_RATE_PER_SECOND = "maximumMessageRatePerSecond";
  @SerializedName(SERIALIZED_NAME_MAXIMUM_MESSAGE_RATE_PER_SECOND)
  private Integer maximumMessageRatePerSecond;

  public static final String SERIALIZED_NAME_MESSAGE_REVIEW_HANDLER = "messageReviewHandler";
  @SerializedName(SERIALIZED_NAME_MESSAGE_REVIEW_HANDLER)
  private CreateRoomRequestMessageReviewHandler messageReviewHandler;
  ...
  public UpdateRoomRequest identifier(String identifier) {
  ...
  public UpdateRoomRequest loggingConfigurationIdentifiers(List<String> loggingConfigurationIdentifiers) {
    this.loggingConfigurationIdentifiers = loggingConfigurationIdentifiers;
    return this;
  }

  public UpdateRoomRequest addLoggingConfigurationIdentifiersItem(String loggingConfigurationIdentifiersItem) {
    if (this.loggingConfigurationIdentifiers == null) {
      this.loggingConfigurationIdentifiers = new ArrayList<>();
    }
    this.loggingConfigurationIdentifiers.add(loggingConfigurationIdentifiersItem);
    return this;
  }
  ...
  public UpdateRoomRequest maximumMessageLength(Integer maximumMessageLength) {
  ...
  public UpdateRoomRequest maximumMessageRatePerSecond(Integer maximumMessageRatePerSecond) {
  ...
  public UpdateRoomRequest messageReviewHandler(CreateRoomRequestMessageReviewHandler messageReviewHandler) {
    this.messageReviewHandler = messageReviewHandler;
    return this;
  }

  /**
   * Get messageReviewHandler
   * @return messageReviewHandler
   */
  @javax.annotation.Nullable
  public CreateRoomRequestMessageReviewHandler getMessageReviewHandler() {
    return messageReviewHandler;
  }

  public void setMessageReviewHandler(CreateRoomRequestMessageReviewHandler messageReviewHandler) {
    this.messageReviewHandler = messageReviewHandler;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, updateRoomRequest.identifier) &&
        Objects.equals(this.loggingConfigurationIdentifiers, updateRoomRequest.loggingConfigurationIdentifiers) &&
        Objects.equals(this.maximumMessageLength, updateRoomRequest.maximumMessageLength) &&
        Objects.equals(this.maximumMessageRatePerSecond, updateRoomRequest.maximumMessageRatePerSecond) &&
        Objects.equals(this.messageReviewHandler, updateRoomRequest.messageReviewHandler) &&
        Objects.equals(this.name, updateRoomRequest.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifier, loggingConfigurationIdentifiers, maximumMessageLength, maximumMessageRatePerSecond, messageReviewHandler, name);
  }
  ...
  public String toString() {
    ...
    sb.append("    loggingConfigurationIdentifiers: ").append(toIndentedString(loggingConfigurationIdentifiers)).append("\n");
    sb.append("    maximumMessageLength: ").append(toIndentedString(maximumMessageLength)).append("\n");
    sb.append("    maximumMessageRatePerSecond: ").append(toIndentedString(maximumMessageRatePerSecond)).append("\n");
    sb.append("    messageReviewHandler: ").append(toIndentedString(messageReviewHandler)).append("\n");
  ...
  static {
    ...
    openapiFields.add("loggingConfigurationIdentifiers");
    openapiFields.add("maximumMessageLength");
    openapiFields.add("maximumMessageRatePerSecond");
    openapiFields.add("messageReviewHandler");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : UpdateRoomRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("loggingConfigurationIdentifiers") != null && !jsonObj.get("loggingConfigurationIdentifiers").isJsonNull() && !jsonObj.get("loggingConfigurationIdentifiers").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `loggingConfigurationIdentifiers` to be an array in the JSON string but got `%s`", jsonObj.get("loggingConfigurationIdentifiers").toString()));
      }
      // validate the optional field `messageReviewHandler`
      if (jsonObj.get("messageReviewHandler") != null && !jsonObj.get("messageReviewHandler").isJsonNull()) {
        CreateRoomRequestMessageReviewHandler.validateJsonElement(jsonObj.get("messageReviewHandler"));
      }
