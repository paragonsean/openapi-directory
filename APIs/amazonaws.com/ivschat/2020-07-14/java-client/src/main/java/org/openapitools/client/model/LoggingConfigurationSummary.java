...
public class LoggingConfigurationSummary {
  ...
  private LoggingConfigurationSummaryDestinationConfiguration destinationConfiguration;
  ...
  public LoggingConfigurationSummary() {
  }

  public LoggingConfigurationSummary arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public LoggingConfigurationSummary createTime(OffsetDateTime createTime) {
  ...
  public LoggingConfigurationSummary destinationConfiguration(LoggingConfigurationSummaryDestinationConfiguration destinationConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public LoggingConfigurationSummaryDestinationConfiguration getDestinationConfiguration() {
    return destinationConfiguration;
  }

  public void setDestinationConfiguration(LoggingConfigurationSummaryDestinationConfiguration destinationConfiguration) {
    this.destinationConfiguration = destinationConfiguration;
  }


  public LoggingConfigurationSummary id(String id) {
    this.id = id;
    return this;
  }
  ...
  public LoggingConfigurationSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public LoggingConfigurationSummary state(LoggingConfigurationState state) {
    this.state = state;
    return this;
  }
  ...
  public LoggingConfigurationSummary tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public LoggingConfigurationSummary updateTime(OffsetDateTime updateTime) {
  ...
  public boolean equals(Object o) {
    ...
    LoggingConfigurationSummary loggingConfigurationSummary = (LoggingConfigurationSummary) o;
    return Objects.equals(this.arn, loggingConfigurationSummary.arn) &&
        Objects.equals(this.createTime, loggingConfigurationSummary.createTime) &&
        Objects.equals(this.destinationConfiguration, loggingConfigurationSummary.destinationConfiguration) &&
        Objects.equals(this.id, loggingConfigurationSummary.id) &&
        Objects.equals(this.name, loggingConfigurationSummary.name) &&
        Objects.equals(this.state, loggingConfigurationSummary.state) &&
        Objects.equals(this.tags, loggingConfigurationSummary.tags) &&
        Objects.equals(this.updateTime, loggingConfigurationSummary.updateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoggingConfigurationSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoggingConfigurationSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoggingConfigurationSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoggingConfigurationSummary is not found in the empty JSON string", LoggingConfigurationSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoggingConfigurationSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoggingConfigurationSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("destinationConfiguration") != null && !jsonObj.get("destinationConfiguration").isJsonNull()) {
        LoggingConfigurationSummaryDestinationConfiguration.validateJsonElement(jsonObj.get("destinationConfiguration"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoggingConfigurationSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoggingConfigurationSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoggingConfigurationSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoggingConfigurationSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<LoggingConfigurationSummary>() {
           @Override
           public void write(JsonWriter out, LoggingConfigurationSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoggingConfigurationSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoggingConfigurationSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoggingConfigurationSummary
   * @throws IOException if the JSON string is invalid with respect to LoggingConfigurationSummary
   */
  public static LoggingConfigurationSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoggingConfigurationSummary.class);
  }

  /**
   * Convert an instance of LoggingConfigurationSummary to an JSON string
   *
   * @return JSON string
   */
