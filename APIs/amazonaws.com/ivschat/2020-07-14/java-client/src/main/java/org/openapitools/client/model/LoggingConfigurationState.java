...
/**
 * Gets or Sets LoggingConfigurationState
 */
@JsonAdapter(LoggingConfigurationState.Adapter.class)
public enum LoggingConfigurationState {
  ...
  LoggingConfigurationState(String value) {
    this.value = value;
  }
  ...
  public static LoggingConfigurationState fromValue(String value) {
    for (LoggingConfigurationState b : LoggingConfigurationState.values()) {
  ...
  public static class Adapter extends TypeAdapter<LoggingConfigurationState> {
    @Override
    public void write(final JsonWriter jsonWriter, final LoggingConfigurationState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LoggingConfigurationState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LoggingConfigurationState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LoggingConfigurationState.fromValue(value);
  }
}
