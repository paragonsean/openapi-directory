...
import org.openapitools.client.model.CreateRoomResponseMessageReviewHandler;
...
public class CreateRoomResponse {
  ...
  private List loggingConfigurationIdentifiers;
  ...
  private CreateRoomResponseMessageReviewHandler messageReviewHandler;
  ...
  public CreateRoomResponse arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateRoomResponse createTime(OffsetDateTime createTime) {
  ...
  public CreateRoomResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CreateRoomResponse loggingConfigurationIdentifiers(List loggingConfigurationIdentifiers) {
   ...
   */
  @javax.annotation.Nullable
  public List getLoggingConfigurationIdentifiers() {
    return loggingConfigurationIdentifiers;
  }

  public void setLoggingConfigurationIdentifiers(List loggingConfigurationIdentifiers) {
    this.loggingConfigurationIdentifiers = loggingConfigurationIdentifiers;
  }


  public CreateRoomResponse maximumMessageLength(Integer maximumMessageLength) {
  ...
  public CreateRoomResponse maximumMessageRatePerSecond(Integer maximumMessageRatePerSecond) {
    this.maximumMessageRatePerSecond = maximumMessageRatePerSecond;
    return this;
  }

  /**
   * Get maximumMessageRatePerSecond
  ...
  public CreateRoomResponse messageReviewHandler(CreateRoomResponseMessageReviewHandler messageReviewHandler) {
   ...
   */
  @javax.annotation.Nullable
  public CreateRoomResponseMessageReviewHandler getMessageReviewHandler() {
    return messageReviewHandler;
  }

  public void setMessageReviewHandler(CreateRoomResponseMessageReviewHandler messageReviewHandler) {
    this.messageReviewHandler = messageReviewHandler;
  }


  public CreateRoomResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateRoomResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateRoomResponse updateTime(OffsetDateTime updateTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.arn, createRoomResponse.arn) &&
        Objects.equals(this.createTime, createRoomResponse.createTime) &&
        Objects.equals(this.id, createRoomResponse.id) &&
        Objects.equals(this.loggingConfigurationIdentifiers, createRoomResponse.loggingConfigurationIdentifiers) &&
        Objects.equals(this.maximumMessageLength, createRoomResponse.maximumMessageLength) &&
        Objects.equals(this.maximumMessageRatePerSecond, createRoomResponse.maximumMessageRatePerSecond) &&
        Objects.equals(this.messageReviewHandler, createRoomResponse.messageReviewHandler) &&
        Objects.equals(this.name, createRoomResponse.name) &&
        Objects.equals(this.tags, createRoomResponse.tags) &&
        Objects.equals(this.updateTime, createRoomResponse.updateTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, createTime, id, loggingConfigurationIdentifiers, maximumMessageLength, maximumMessageRatePerSecond, messageReviewHandler, name, tags, updateTime);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("loggingConfigurationIdentifiers") != null && !jsonObj.get("loggingConfigurationIdentifiers").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("loggingConfigurationIdentifiers"));
      }
      // validate the optional field `maximumMessageLength`
      if (jsonObj.get("maximumMessageLength") != null && !jsonObj.get("maximumMessageLength").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("maximumMessageLength"));
      }
      // validate the optional field `maximumMessageRatePerSecond`
      if (jsonObj.get("maximumMessageRatePerSecond") != null && !jsonObj.get("maximumMessageRatePerSecond").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("maximumMessageRatePerSecond"));
      }
      ...
      if (jsonObj.get("messageReviewHandler") != null && !jsonObj.get("messageReviewHandler").isJsonNull()) {
        CreateRoomResponseMessageReviewHandler.validateJsonElement(jsonObj.get("messageReviewHandler"));
      }
