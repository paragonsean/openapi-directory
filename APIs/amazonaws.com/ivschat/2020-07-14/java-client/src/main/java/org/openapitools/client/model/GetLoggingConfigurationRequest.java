...
public class GetLoggingConfigurationRequest {
  ...
  public GetLoggingConfigurationRequest identifier(String identifier) {
  ...
  public boolean equals(Object o) {
    ...
    GetLoggingConfigurationRequest getLoggingConfigurationRequest = (GetLoggingConfigurationRequest) o;
    return Objects.equals(this.identifier, getLoggingConfigurationRequest.identifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLoggingConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLoggingConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLoggingConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLoggingConfigurationRequest is not found in the empty JSON string", GetLoggingConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLoggingConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLoggingConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetLoggingConfigurationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLoggingConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLoggingConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLoggingConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLoggingConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLoggingConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, GetLoggingConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLoggingConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLoggingConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLoggingConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to GetLoggingConfigurationRequest
   */
  public static GetLoggingConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLoggingConfigurationRequest.class);
  }

  /**
   * Convert an instance of GetLoggingConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
