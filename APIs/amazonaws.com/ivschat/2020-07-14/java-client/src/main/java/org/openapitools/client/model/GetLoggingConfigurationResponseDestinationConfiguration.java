...
public class GetLoggingConfigurationResponseDestinationConfiguration {
  ...
  public GetLoggingConfigurationResponseDestinationConfiguration() {
  }

  public GetLoggingConfigurationResponseDestinationConfiguration cloudWatchLogs(CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs cloudWatchLogs) {
  ...
  public GetLoggingConfigurationResponseDestinationConfiguration firehose(CreateLoggingConfigurationRequestDestinationConfigurationFirehose firehose) {
  ...
  public GetLoggingConfigurationResponseDestinationConfiguration s3(CreateLoggingConfigurationRequestDestinationConfigurationS3 s3) {
    this.s3 = s3;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLoggingConfigurationResponseDestinationConfiguration getLoggingConfigurationResponseDestinationConfiguration = (GetLoggingConfigurationResponseDestinationConfiguration) o;
    return Objects.equals(this.cloudWatchLogs, getLoggingConfigurationResponseDestinationConfiguration.cloudWatchLogs) &&
        Objects.equals(this.firehose, getLoggingConfigurationResponseDestinationConfiguration.firehose) &&
        Objects.equals(this.s3, getLoggingConfigurationResponseDestinationConfiguration.s3);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLoggingConfigurationResponseDestinationConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLoggingConfigurationResponseDestinationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLoggingConfigurationResponseDestinationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLoggingConfigurationResponseDestinationConfiguration is not found in the empty JSON string", GetLoggingConfigurationResponseDestinationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLoggingConfigurationResponseDestinationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLoggingConfigurationResponseDestinationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLoggingConfigurationResponseDestinationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLoggingConfigurationResponseDestinationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLoggingConfigurationResponseDestinationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLoggingConfigurationResponseDestinationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLoggingConfigurationResponseDestinationConfiguration>() {
           @Override
           public void write(JsonWriter out, GetLoggingConfigurationResponseDestinationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLoggingConfigurationResponseDestinationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLoggingConfigurationResponseDestinationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLoggingConfigurationResponseDestinationConfiguration
   * @throws IOException if the JSON string is invalid with respect to GetLoggingConfigurationResponseDestinationConfiguration
   */
  public static GetLoggingConfigurationResponseDestinationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLoggingConfigurationResponseDestinationConfiguration.class);
  }

  /**
   * Convert an instance of GetLoggingConfigurationResponseDestinationConfiguration to an JSON string
   *
   * @return JSON string
   */
