...
public class CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs {
  public static final String SERIALIZED_NAME_LOG_GROUP_NAME = "logGroupName";
  @SerializedName(SERIALIZED_NAME_LOG_GROUP_NAME)
  private String logGroupName;

  public CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs() {
  }

  public CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs logGroupName(String logGroupName) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs createLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs = (CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs) o;
    return Objects.equals(this.logGroupName, createLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs.logGroupName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs is not found in the empty JSON string", CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs>() {
           @Override
           public void write(JsonWriter out, CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs
   * @throws IOException if the JSON string is invalid with respect to CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs
   */
  public static CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs.class);
  }

  /**
   * Convert an instance of CreateLoggingConfigurationRequestDestinationConfigurationCloudWatchLogs to an JSON string
   *
   * @return JSON string
   */
