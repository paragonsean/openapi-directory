...
public class UpdateRoomRequestMessageReviewHandler {
  ...
  public UpdateRoomRequestMessageReviewHandler() {
  }

  public UpdateRoomRequestMessageReviewHandler fallbackResult(FallbackResult fallbackResult) {
  ...
  public UpdateRoomRequestMessageReviewHandler uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateRoomRequestMessageReviewHandler updateRoomRequestMessageReviewHandler = (UpdateRoomRequestMessageReviewHandler) o;
    return Objects.equals(this.fallbackResult, updateRoomRequestMessageReviewHandler.fallbackResult) &&
        Objects.equals(this.uri, updateRoomRequestMessageReviewHandler.uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateRoomRequestMessageReviewHandler {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateRoomRequestMessageReviewHandler
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRoomRequestMessageReviewHandler.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateRoomRequestMessageReviewHandler is not found in the empty JSON string", UpdateRoomRequestMessageReviewHandler.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRoomRequestMessageReviewHandler.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateRoomRequestMessageReviewHandler` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateRoomRequestMessageReviewHandler.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateRoomRequestMessageReviewHandler' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateRoomRequestMessageReviewHandler> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateRoomRequestMessageReviewHandler.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateRoomRequestMessageReviewHandler>() {
           @Override
           public void write(JsonWriter out, UpdateRoomRequestMessageReviewHandler value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateRoomRequestMessageReviewHandler read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateRoomRequestMessageReviewHandler given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateRoomRequestMessageReviewHandler
   * @throws IOException if the JSON string is invalid with respect to UpdateRoomRequestMessageReviewHandler
   */
  public static UpdateRoomRequestMessageReviewHandler fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateRoomRequestMessageReviewHandler.class);
  }

  /**
   * Convert an instance of UpdateRoomRequestMessageReviewHandler to an JSON string
   *
   * @return JSON string
   */
