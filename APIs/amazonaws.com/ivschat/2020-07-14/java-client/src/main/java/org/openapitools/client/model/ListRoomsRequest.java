...
public class ListRoomsRequest {
  public static final String SERIALIZED_NAME_LOGGING_CONFIGURATION_IDENTIFIER = "loggingConfigurationIdentifier";
  @SerializedName(SERIALIZED_NAME_LOGGING_CONFIGURATION_IDENTIFIER)
  ...
  public static final String SERIALIZED_NAME_MESSAGE_REVIEW_HANDLER_URI = "messageReviewHandlerUri";
  @SerializedName(SERIALIZED_NAME_MESSAGE_REVIEW_HANDLER_URI)
  ...
  public ListRoomsRequest loggingConfigurationIdentifier(String loggingConfigurationIdentifier) {
  ...
  public ListRoomsRequest maxResults(Integer maxResults) {
  ...
  public ListRoomsRequest messageReviewHandlerUri(String messageReviewHandlerUri) {
  ...
  public ListRoomsRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ListRoomsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListRoomsRequest listRoomsRequest = (ListRoomsRequest) o;
    return Objects.equals(this.loggingConfigurationIdentifier, listRoomsRequest.loggingConfigurationIdentifier) &&
        Objects.equals(this.maxResults, listRoomsRequest.maxResults) &&
        Objects.equals(this.messageReviewHandlerUri, listRoomsRequest.messageReviewHandlerUri) &&
        Objects.equals(this.name, listRoomsRequest.name) &&
        Objects.equals(this.nextToken, listRoomsRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loggingConfigurationIdentifier, maxResults, messageReviewHandlerUri, name, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListRoomsRequest {\n");
    sb.append("    loggingConfigurationIdentifier: ").append(toIndentedString(loggingConfigurationIdentifier)).append("\n");
    sb.append("    maxResults: ").append(toIndentedString(maxResults)).append("\n");
    sb.append("    messageReviewHandlerUri: ").append(toIndentedString(messageReviewHandlerUri)).append("\n");
  ...
  static {
    ...
    openapiFields.add("loggingConfigurationIdentifier");
    openapiFields.add("maxResults");
    openapiFields.add("messageReviewHandlerUri");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRoomsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRoomsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRoomsRequest is not found in the empty JSON string", ListRoomsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRoomsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRoomsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("loggingConfigurationIdentifier") != null && !jsonObj.get("loggingConfigurationIdentifier").isJsonNull()) && !jsonObj.get("loggingConfigurationIdentifier").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `loggingConfigurationIdentifier` to be a primitive type in the JSON string but got `%s`", jsonObj.get("loggingConfigurationIdentifier").toString()));
      }
      if ((jsonObj.get("messageReviewHandlerUri") != null && !jsonObj.get("messageReviewHandlerUri").isJsonNull()) && !jsonObj.get("messageReviewHandlerUri").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `messageReviewHandlerUri` to be a primitive type in the JSON string but got `%s`", jsonObj.get("messageReviewHandlerUri").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRoomsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRoomsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRoomsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRoomsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRoomsRequest>() {
           @Override
           public void write(JsonWriter out, ListRoomsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRoomsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRoomsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRoomsRequest
   * @throws IOException if the JSON string is invalid with respect to ListRoomsRequest
   */
  public static ListRoomsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRoomsRequest.class);
  }

  /**
   * Convert an instance of ListRoomsRequest to an JSON string
   *
   * @return JSON string
   */
