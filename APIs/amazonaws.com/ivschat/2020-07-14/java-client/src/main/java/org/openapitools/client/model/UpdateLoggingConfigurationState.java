...
/**
 * Gets or Sets UpdateLoggingConfigurationState
 */
@JsonAdapter(UpdateLoggingConfigurationState.Adapter.class)
public enum UpdateLoggingConfigurationState {
  ...
  UpdateLoggingConfigurationState(String value) {
    this.value = value;
  }
  ...
  public static UpdateLoggingConfigurationState fromValue(String value) {
    for (UpdateLoggingConfigurationState b : UpdateLoggingConfigurationState.values()) {
  ...
  public static class Adapter extends TypeAdapter<UpdateLoggingConfigurationState> {
    @Override
    public void write(final JsonWriter jsonWriter, final UpdateLoggingConfigurationState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UpdateLoggingConfigurationState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UpdateLoggingConfigurationState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UpdateLoggingConfigurationState.fromValue(value);
  }
}
