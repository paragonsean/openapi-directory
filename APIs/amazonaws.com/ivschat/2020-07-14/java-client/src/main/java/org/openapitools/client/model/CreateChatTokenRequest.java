...
public class CreateChatTokenRequest {
  ...
  private List<ChatTokenCapability> capabilities = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_SESSION_DURATION_IN_MINUTES = "sessionDurationInMinutes";
  @SerializedName(SERIALIZED_NAME_SESSION_DURATION_IN_MINUTES)
  ...
  public CreateChatTokenRequest attributes(Map<String, String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public CreateChatTokenRequest putAttributesItem(String key, String attributesItem) {
  ...
  public CreateChatTokenRequest capabilities(List<ChatTokenCapability> capabilities) {
    this.capabilities = capabilities;
    return this;
  }

  public CreateChatTokenRequest addCapabilitiesItem(ChatTokenCapability capabilitiesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ChatTokenCapability> getCapabilities() {
    return capabilities;
  }

  public void setCapabilities(List<ChatTokenCapability> capabilities) {
    this.capabilities = capabilities;
  }


  public CreateChatTokenRequest roomIdentifier(String roomIdentifier) {
  ...
  public CreateChatTokenRequest sessionDurationInMinutes(Integer sessionDurationInMinutes) {
  ...
  public CreateChatTokenRequest userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateChatTokenRequest createChatTokenRequest = (CreateChatTokenRequest) o;
    return Objects.equals(this.attributes, createChatTokenRequest.attributes) &&
        Objects.equals(this.capabilities, createChatTokenRequest.capabilities) &&
        Objects.equals(this.roomIdentifier, createChatTokenRequest.roomIdentifier) &&
        Objects.equals(this.sessionDurationInMinutes, createChatTokenRequest.sessionDurationInMinutes) &&
        Objects.equals(this.userId, createChatTokenRequest.userId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributes, capabilities, roomIdentifier, sessionDurationInMinutes, userId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateChatTokenRequest {\n");
    sb.append("    attributes: ").append(toIndentedString(attributes)).append("\n");
    sb.append("    capabilities: ").append(toIndentedString(capabilities)).append("\n");
    sb.append("    roomIdentifier: ").append(toIndentedString(roomIdentifier)).append("\n");
    sb.append("    sessionDurationInMinutes: ").append(toIndentedString(sessionDurationInMinutes)).append("\n");
  ...
  static {
    ...
    openapiFields.add("sessionDurationInMinutes");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateChatTokenRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateChatTokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateChatTokenRequest is not found in the empty JSON string", CreateChatTokenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateChatTokenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateChatTokenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateChatTokenRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateChatTokenRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateChatTokenRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateChatTokenRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateChatTokenRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateChatTokenRequest>() {
           @Override
           public void write(JsonWriter out, CreateChatTokenRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateChatTokenRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateChatTokenRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateChatTokenRequest
   * @throws IOException if the JSON string is invalid with respect to CreateChatTokenRequest
   */
  public static CreateChatTokenRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateChatTokenRequest.class);
  }

  /**
   * Convert an instance of CreateChatTokenRequest to an JSON string
   *
   * @return JSON string
   */
