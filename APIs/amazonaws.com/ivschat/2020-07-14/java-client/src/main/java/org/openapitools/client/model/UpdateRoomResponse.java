...
public class UpdateRoomResponse {
  ...
  public UpdateRoomResponse arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateRoomResponse createTime(OffsetDateTime createTime) {
  ...
  public UpdateRoomResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public UpdateRoomResponse loggingConfigurationIdentifiers(List loggingConfigurationIdentifiers) {
  ...
  public UpdateRoomResponse maximumMessageLength(Integer maximumMessageLength) {
  ...
  public UpdateRoomResponse maximumMessageRatePerSecond(Integer maximumMessageRatePerSecond) {
  ...
  public UpdateRoomResponse messageReviewHandler(CreateRoomResponseMessageReviewHandler messageReviewHandler) {
  ...
  public UpdateRoomResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateRoomResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public UpdateRoomResponse updateTime(OffsetDateTime updateTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.arn, updateRoomResponse.arn) &&
        Objects.equals(this.createTime, updateRoomResponse.createTime) &&
        Objects.equals(this.id, updateRoomResponse.id) &&
        Objects.equals(this.loggingConfigurationIdentifiers, updateRoomResponse.loggingConfigurationIdentifiers) &&
        Objects.equals(this.maximumMessageLength, updateRoomResponse.maximumMessageLength) &&
        Objects.equals(this.maximumMessageRatePerSecond, updateRoomResponse.maximumMessageRatePerSecond) &&
        Objects.equals(this.messageReviewHandler, updateRoomResponse.messageReviewHandler) &&
        Objects.equals(this.name, updateRoomResponse.name) &&
        Objects.equals(this.tags, updateRoomResponse.tags) &&
        Objects.equals(this.updateTime, updateRoomResponse.updateTime);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateRoomResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRoomResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateRoomResponse is not found in the empty JSON string", UpdateRoomResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRoomResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateRoomResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateRoomResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateRoomResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateRoomResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateRoomResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateRoomResponse>() {
           @Override
           public void write(JsonWriter out, UpdateRoomResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateRoomResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateRoomResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateRoomResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateRoomResponse
   */
  public static UpdateRoomResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateRoomResponse.class);
  }

  /**
   * Convert an instance of UpdateRoomResponse to an JSON string
   *
   * @return JSON string
   */
