...
/**
 * Gets or Sets ChatTokenCapability
 */
@JsonAdapter(ChatTokenCapability.Adapter.class)
public enum ChatTokenCapability {
  ...
  ChatTokenCapability(String value) {
    this.value = value;
  }
  ...
  public static ChatTokenCapability fromValue(String value) {
    for (ChatTokenCapability b : ChatTokenCapability.values()) {
  ...
  public static class Adapter extends TypeAdapter<ChatTokenCapability> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChatTokenCapability enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ChatTokenCapability read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ChatTokenCapability.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ChatTokenCapability.fromValue(value);
  }
}
