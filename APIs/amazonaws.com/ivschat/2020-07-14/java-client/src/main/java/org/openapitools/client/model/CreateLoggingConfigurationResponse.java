...
import org.openapitools.client.model.CreateLoggingConfigurationResponseDestinationConfiguration;
import org.openapitools.client.model.CreateLoggingConfigurationState;
...
public class CreateLoggingConfigurationResponse {
  ...
  private CreateLoggingConfigurationResponseDestinationConfiguration destinationConfiguration;
  ...
  private CreateLoggingConfigurationState state;
  ...
  public CreateLoggingConfigurationResponse arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateLoggingConfigurationResponse createTime(OffsetDateTime createTime) {
  ...
  public CreateLoggingConfigurationResponse destinationConfiguration(CreateLoggingConfigurationResponseDestinationConfiguration destinationConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public CreateLoggingConfigurationResponseDestinationConfiguration getDestinationConfiguration() {
    return destinationConfiguration;
  }

  public void setDestinationConfiguration(CreateLoggingConfigurationResponseDestinationConfiguration destinationConfiguration) {
    this.destinationConfiguration = destinationConfiguration;
  }


  public CreateLoggingConfigurationResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CreateLoggingConfigurationResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateLoggingConfigurationResponse state(CreateLoggingConfigurationState state) {
    this.state = state;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CreateLoggingConfigurationState getState() {
    return state;
  }

  public void setState(CreateLoggingConfigurationState state) {
    this.state = state;
  }


  public CreateLoggingConfigurationResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateLoggingConfigurationResponse updateTime(OffsetDateTime updateTime) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLoggingConfigurationResponse createLoggingConfigurationResponse = (CreateLoggingConfigurationResponse) o;
    return Objects.equals(this.arn, createLoggingConfigurationResponse.arn) &&
        Objects.equals(this.createTime, createLoggingConfigurationResponse.createTime) &&
        Objects.equals(this.destinationConfiguration, createLoggingConfigurationResponse.destinationConfiguration) &&
        Objects.equals(this.id, createLoggingConfigurationResponse.id) &&
        Objects.equals(this.name, createLoggingConfigurationResponse.name) &&
        Objects.equals(this.state, createLoggingConfigurationResponse.state) &&
        Objects.equals(this.tags, createLoggingConfigurationResponse.tags) &&
        Objects.equals(this.updateTime, createLoggingConfigurationResponse.updateTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, createTime, destinationConfiguration, id, name, state, tags, updateTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateLoggingConfigurationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLoggingConfigurationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLoggingConfigurationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLoggingConfigurationResponse is not found in the empty JSON string", CreateLoggingConfigurationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLoggingConfigurationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLoggingConfigurationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("destinationConfiguration") != null && !jsonObj.get("destinationConfiguration").isJsonNull()) {
        CreateLoggingConfigurationResponseDestinationConfiguration.validateJsonElement(jsonObj.get("destinationConfiguration"));
      }
      ...
      if (jsonObj.get("state") != null && !jsonObj.get("state").isJsonNull()) {
        CreateLoggingConfigurationState.validateJsonElement(jsonObj.get("state"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLoggingConfigurationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLoggingConfigurationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLoggingConfigurationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLoggingConfigurationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLoggingConfigurationResponse>() {
           @Override
           public void write(JsonWriter out, CreateLoggingConfigurationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLoggingConfigurationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLoggingConfigurationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLoggingConfigurationResponse
   * @throws IOException if the JSON string is invalid with respect to CreateLoggingConfigurationResponse
   */
  public static CreateLoggingConfigurationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLoggingConfigurationResponse.class);
  }

  /**
   * Convert an instance of CreateLoggingConfigurationResponse to an JSON string
   *
   * @return JSON string
   */
