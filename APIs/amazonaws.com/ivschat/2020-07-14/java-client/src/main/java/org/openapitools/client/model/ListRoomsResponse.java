...
public class ListRoomsResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listRoomsResponse.nextToken) &&
        Objects.equals(this.rooms, listRoomsResponse.rooms);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, rooms);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ListRoomsResponse.openapiRequiredFields) {
      ...
      // validate the required field `rooms`
