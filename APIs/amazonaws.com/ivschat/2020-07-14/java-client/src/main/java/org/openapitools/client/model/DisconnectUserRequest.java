...
public class DisconnectUserRequest {
  ...
  public DisconnectUserRequest() {
  }

  public DisconnectUserRequest reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public DisconnectUserRequest roomIdentifier(String roomIdentifier) {
  ...
  public DisconnectUserRequest userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DisconnectUserRequest disconnectUserRequest = (DisconnectUserRequest) o;
    return Objects.equals(this.reason, disconnectUserRequest.reason) &&
        Objects.equals(this.roomIdentifier, disconnectUserRequest.roomIdentifier) &&
        Objects.equals(this.userId, disconnectUserRequest.userId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(reason, roomIdentifier, userId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DisconnectUserRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisconnectUserRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisconnectUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisconnectUserRequest is not found in the empty JSON string", DisconnectUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisconnectUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisconnectUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisconnectUserRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisconnectUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisconnectUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisconnectUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisconnectUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DisconnectUserRequest>() {
           @Override
           public void write(JsonWriter out, DisconnectUserRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisconnectUserRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisconnectUserRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisconnectUserRequest
   * @throws IOException if the JSON string is invalid with respect to DisconnectUserRequest
   */
  public static DisconnectUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisconnectUserRequest.class);
  }

  /**
   * Convert an instance of DisconnectUserRequest to an JSON string
   *
   * @return JSON string
   */
