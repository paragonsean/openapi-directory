...
/**
 * Gets or Sets FallbackResult
 */
@JsonAdapter(FallbackResult.Adapter.class)
public enum FallbackResult {
  ...
  public static FallbackResult fromValue(String value) {
    for (FallbackResult b : FallbackResult.values()) {
  ...
  public static class Adapter extends TypeAdapter<FallbackResult> {
    @Override
    public void write(final JsonWriter jsonWriter, final FallbackResult enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FallbackResult read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FallbackResult.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FallbackResult.fromValue(value);
  }
}
