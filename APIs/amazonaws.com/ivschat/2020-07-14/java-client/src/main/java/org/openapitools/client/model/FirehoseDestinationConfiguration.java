...
public class FirehoseDestinationConfiguration {
  ...
  public FirehoseDestinationConfiguration() {
  }

  public FirehoseDestinationConfiguration deliveryStreamName(String deliveryStreamName) {
  ...
  public boolean equals(Object o) {
    ...
    FirehoseDestinationConfiguration firehoseDestinationConfiguration = (FirehoseDestinationConfiguration) o;
    return Objects.equals(this.deliveryStreamName, firehoseDestinationConfiguration.deliveryStreamName);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirehoseDestinationConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirehoseDestinationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirehoseDestinationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirehoseDestinationConfiguration is not found in the empty JSON string", FirehoseDestinationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirehoseDestinationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirehoseDestinationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirehoseDestinationConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirehoseDestinationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirehoseDestinationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirehoseDestinationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirehoseDestinationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<FirehoseDestinationConfiguration>() {
           @Override
           public void write(JsonWriter out, FirehoseDestinationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirehoseDestinationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirehoseDestinationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirehoseDestinationConfiguration
   * @throws IOException if the JSON string is invalid with respect to FirehoseDestinationConfiguration
   */
  public static FirehoseDestinationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirehoseDestinationConfiguration.class);
  }

  /**
   * Convert an instance of FirehoseDestinationConfiguration to an JSON string
   *
   * @return JSON string
   */
