...
public class CloudWatchLogsDestinationConfiguration {
  ...
  public CloudWatchLogsDestinationConfiguration logGroupName(String logGroupName) {
  ...
  public boolean equals(Object o) {
    ...
    CloudWatchLogsDestinationConfiguration cloudWatchLogsDestinationConfiguration = (CloudWatchLogsDestinationConfiguration) o;
    return Objects.equals(this.logGroupName, cloudWatchLogsDestinationConfiguration.logGroupName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudWatchLogsDestinationConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudWatchLogsDestinationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudWatchLogsDestinationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudWatchLogsDestinationConfiguration is not found in the empty JSON string", CloudWatchLogsDestinationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudWatchLogsDestinationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudWatchLogsDestinationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloudWatchLogsDestinationConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudWatchLogsDestinationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudWatchLogsDestinationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudWatchLogsDestinationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudWatchLogsDestinationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudWatchLogsDestinationConfiguration>() {
           @Override
           public void write(JsonWriter out, CloudWatchLogsDestinationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudWatchLogsDestinationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudWatchLogsDestinationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudWatchLogsDestinationConfiguration
   * @throws IOException if the JSON string is invalid with respect to CloudWatchLogsDestinationConfiguration
   */
  public static CloudWatchLogsDestinationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudWatchLogsDestinationConfiguration.class);
  }

  /**
   * Convert an instance of CloudWatchLogsDestinationConfiguration to an JSON string
   *
   * @return JSON string
   */
