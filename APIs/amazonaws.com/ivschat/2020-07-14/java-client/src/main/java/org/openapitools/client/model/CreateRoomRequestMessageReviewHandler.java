...
public class CreateRoomRequestMessageReviewHandler {
  ...
  public CreateRoomRequestMessageReviewHandler() {
  }

  public CreateRoomRequestMessageReviewHandler fallbackResult(FallbackResult fallbackResult) {
  ...
  public CreateRoomRequestMessageReviewHandler uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateRoomRequestMessageReviewHandler createRoomRequestMessageReviewHandler = (CreateRoomRequestMessageReviewHandler) o;
    return Objects.equals(this.fallbackResult, createRoomRequestMessageReviewHandler.fallbackResult) &&
        Objects.equals(this.uri, createRoomRequestMessageReviewHandler.uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRoomRequestMessageReviewHandler {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRoomRequestMessageReviewHandler
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRoomRequestMessageReviewHandler.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRoomRequestMessageReviewHandler is not found in the empty JSON string", CreateRoomRequestMessageReviewHandler.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRoomRequestMessageReviewHandler.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRoomRequestMessageReviewHandler` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRoomRequestMessageReviewHandler.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRoomRequestMessageReviewHandler' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRoomRequestMessageReviewHandler> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRoomRequestMessageReviewHandler.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRoomRequestMessageReviewHandler>() {
           @Override
           public void write(JsonWriter out, CreateRoomRequestMessageReviewHandler value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRoomRequestMessageReviewHandler read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRoomRequestMessageReviewHandler given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRoomRequestMessageReviewHandler
   * @throws IOException if the JSON string is invalid with respect to CreateRoomRequestMessageReviewHandler
   */
  public static CreateRoomRequestMessageReviewHandler fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRoomRequestMessageReviewHandler.class);
  }

  /**
   * Convert an instance of CreateRoomRequestMessageReviewHandler to an JSON string
   *
   * @return JSON string
   */
