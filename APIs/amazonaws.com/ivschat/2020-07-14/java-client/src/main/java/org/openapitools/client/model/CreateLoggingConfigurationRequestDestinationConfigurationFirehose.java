...
public class CreateLoggingConfigurationRequestDestinationConfigurationFirehose {
  ...
  public CreateLoggingConfigurationRequestDestinationConfigurationFirehose() {
  }

  public CreateLoggingConfigurationRequestDestinationConfigurationFirehose deliveryStreamName(String deliveryStreamName) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLoggingConfigurationRequestDestinationConfigurationFirehose createLoggingConfigurationRequestDestinationConfigurationFirehose = (CreateLoggingConfigurationRequestDestinationConfigurationFirehose) o;
    return Objects.equals(this.deliveryStreamName, createLoggingConfigurationRequestDestinationConfigurationFirehose.deliveryStreamName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateLoggingConfigurationRequestDestinationConfigurationFirehose {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLoggingConfigurationRequestDestinationConfigurationFirehose
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLoggingConfigurationRequestDestinationConfigurationFirehose.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLoggingConfigurationRequestDestinationConfigurationFirehose is not found in the empty JSON string", CreateLoggingConfigurationRequestDestinationConfigurationFirehose.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLoggingConfigurationRequestDestinationConfigurationFirehose.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLoggingConfigurationRequestDestinationConfigurationFirehose` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateLoggingConfigurationRequestDestinationConfigurationFirehose.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLoggingConfigurationRequestDestinationConfigurationFirehose.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLoggingConfigurationRequestDestinationConfigurationFirehose' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLoggingConfigurationRequestDestinationConfigurationFirehose> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLoggingConfigurationRequestDestinationConfigurationFirehose.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLoggingConfigurationRequestDestinationConfigurationFirehose>() {
           @Override
           public void write(JsonWriter out, CreateLoggingConfigurationRequestDestinationConfigurationFirehose value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLoggingConfigurationRequestDestinationConfigurationFirehose read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLoggingConfigurationRequestDestinationConfigurationFirehose given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLoggingConfigurationRequestDestinationConfigurationFirehose
   * @throws IOException if the JSON string is invalid with respect to CreateLoggingConfigurationRequestDestinationConfigurationFirehose
   */
  public static CreateLoggingConfigurationRequestDestinationConfigurationFirehose fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLoggingConfigurationRequestDestinationConfigurationFirehose.class);
  }

  /**
   * Convert an instance of CreateLoggingConfigurationRequestDestinationConfigurationFirehose to an JSON string
   *
   * @return JSON string
   */
