...
/**
 * Gets or Sets CreateLoggingConfigurationState
 */
@JsonAdapter(CreateLoggingConfigurationState.Adapter.class)
public enum CreateLoggingConfigurationState {
  ...
  CreateLoggingConfigurationState(String value) {
    this.value = value;
  }
  ...
  public static CreateLoggingConfigurationState fromValue(String value) {
    for (CreateLoggingConfigurationState b : CreateLoggingConfigurationState.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreateLoggingConfigurationState> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreateLoggingConfigurationState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreateLoggingConfigurationState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreateLoggingConfigurationState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CreateLoggingConfigurationState.fromValue(value);
  }
}
