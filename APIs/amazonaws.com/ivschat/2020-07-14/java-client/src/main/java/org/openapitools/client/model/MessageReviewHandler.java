...
public class MessageReviewHandler {
  ...
  public MessageReviewHandler fallbackResult(FallbackResult fallbackResult) {
  ...
  public MessageReviewHandler uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MessageReviewHandler messageReviewHandler = (MessageReviewHandler) o;
    return Objects.equals(this.fallbackResult, messageReviewHandler.fallbackResult) &&
        Objects.equals(this.uri, messageReviewHandler.uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class MessageReviewHandler {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessageReviewHandler
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageReviewHandler.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessageReviewHandler is not found in the empty JSON string", MessageReviewHandler.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageReviewHandler.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessageReviewHandler` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageReviewHandler.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageReviewHandler' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageReviewHandler> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageReviewHandler.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageReviewHandler>() {
           @Override
           public void write(JsonWriter out, MessageReviewHandler value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessageReviewHandler read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessageReviewHandler given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessageReviewHandler
   * @throws IOException if the JSON string is invalid with respect to MessageReviewHandler
   */
  public static MessageReviewHandler fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageReviewHandler.class);
  }

  /**
   * Convert an instance of MessageReviewHandler to an JSON string
   *
   * @return JSON string
   */
