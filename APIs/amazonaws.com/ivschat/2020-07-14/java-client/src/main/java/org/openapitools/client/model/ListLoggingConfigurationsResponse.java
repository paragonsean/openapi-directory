...
public class ListLoggingConfigurationsResponse {
  ...
  public ListLoggingConfigurationsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.loggingConfigurations, listLoggingConfigurationsResponse.loggingConfigurations) &&
        Objects.equals(this.nextToken, listLoggingConfigurationsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loggingConfigurations, nextToken);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("loggingConfigurations");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ListLoggingConfigurationsResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `loggingConfigurations`
