...
public class DeleteMessageRequest {
  ...
  public DeleteMessageRequest id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DeleteMessageRequest reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public DeleteMessageRequest roomIdentifier(String roomIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, deleteMessageRequest.id) &&
        Objects.equals(this.reason, deleteMessageRequest.reason) &&
        Objects.equals(this.roomIdentifier, deleteMessageRequest.roomIdentifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, reason, roomIdentifier);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteMessageRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteMessageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteMessageRequest is not found in the empty JSON string", DeleteMessageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteMessageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteMessageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteMessageRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteMessageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteMessageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteMessageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteMessageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteMessageRequest>() {
           @Override
           public void write(JsonWriter out, DeleteMessageRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteMessageRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteMessageRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteMessageRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteMessageRequest
   */
  public static DeleteMessageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteMessageRequest.class);
  }

  /**
   * Convert an instance of DeleteMessageRequest to an JSON string
   *
   * @return JSON string
   */
