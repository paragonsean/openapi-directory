...
import org.openapitools.client.model.FallbackResult;
...
public class CreateRoomResponseMessageReviewHandler {
  public static final String SERIALIZED_NAME_FALLBACK_RESULT = "fallbackResult";
  @SerializedName(SERIALIZED_NAME_FALLBACK_RESULT)
  ...
  public CreateRoomResponseMessageReviewHandler() {
  }

  public CreateRoomResponseMessageReviewHandler fallbackResult(FallbackResult fallbackResult) {
  ...
  public CreateRoomResponseMessageReviewHandler uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateRoomResponseMessageReviewHandler createRoomResponseMessageReviewHandler = (CreateRoomResponseMessageReviewHandler) o;
    return Objects.equals(this.fallbackResult, createRoomResponseMessageReviewHandler.fallbackResult) &&
        Objects.equals(this.uri, createRoomResponseMessageReviewHandler.uri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fallbackResult, uri);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateRoomResponseMessageReviewHandler {\n");
    sb.append("    fallbackResult: ").append(toIndentedString(fallbackResult)).append("\n");
  ...
  static {
    ...
    openapiFields.add("fallbackResult");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRoomResponseMessageReviewHandler
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRoomResponseMessageReviewHandler.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRoomResponseMessageReviewHandler is not found in the empty JSON string", CreateRoomResponseMessageReviewHandler.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRoomResponseMessageReviewHandler.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRoomResponseMessageReviewHandler` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `fallbackResult`
      if (jsonObj.get("fallbackResult") != null && !jsonObj.get("fallbackResult").isJsonNull()) {
        FallbackResult.validateJsonElement(jsonObj.get("fallbackResult"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRoomResponseMessageReviewHandler.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRoomResponseMessageReviewHandler' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRoomResponseMessageReviewHandler> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRoomResponseMessageReviewHandler.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRoomResponseMessageReviewHandler>() {
           @Override
           public void write(JsonWriter out, CreateRoomResponseMessageReviewHandler value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRoomResponseMessageReviewHandler read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRoomResponseMessageReviewHandler given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRoomResponseMessageReviewHandler
   * @throws IOException if the JSON string is invalid with respect to CreateRoomResponseMessageReviewHandler
   */
  public static CreateRoomResponseMessageReviewHandler fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRoomResponseMessageReviewHandler.class);
  }

  /**
   * Convert an instance of CreateRoomResponseMessageReviewHandler to an JSON string
   *
   * @return JSON string
   */
