...
OAIUpdateRoom_request::OAIUpdateRoom_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRoom_request::OAIUpdateRoom_request() {
    this->initializeModel();
}

OAIUpdateRoom_request::~OAIUpdateRoom_request() {}

void OAIUpdateRoom_request::initializeModel() {
...
void OAIUpdateRoom_request::fromJson(QString jsonString) {
...
void OAIUpdateRoom_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRoom_request::asJson() const {
...
QJsonObject OAIUpdateRoom_request::asJsonObject() const {
    QJsonObject obj;
    if (m_identifier_isSet) {
        obj.insert(QString("identifier"), ::OpenAPI::toJsonValue(m_identifier));
    }
    if (m_logging_configuration_identifiers.size() > 0) {
...
QString OAIUpdateRoom_request::getIdentifier() const {
    return m_identifier;
}
void OAIUpdateRoom_request::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIUpdateRoom_request::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIUpdateRoom_request::is_identifier_Valid() const{
    return m_identifier_isValid;
}

QList<QString> OAIUpdateRoom_request::getLoggingConfigurationIdentifiers() const {
    return m_logging_configuration_identifiers;
}
void OAIUpdateRoom_request::setLoggingConfigurationIdentifiers(const QList<QString> &logging_configuration_identifiers) {
    m_logging_configuration_identifiers = logging_configuration_identifiers;
    m_logging_configuration_identifiers_isSet = true;
}

bool OAIUpdateRoom_request::is_logging_configuration_identifiers_Set() const{
    return m_logging_configuration_identifiers_isSet;
}

bool OAIUpdateRoom_request::is_logging_configuration_identifiers_Valid() const{
    return m_logging_configuration_identifiers_isValid;
}

qint32 OAIUpdateRoom_request::getMaximumMessageLength() const {
    return m_maximum_message_length;
}
void OAIUpdateRoom_request::setMaximumMessageLength(const qint32 &maximum_message_length) {
    m_maximum_message_length = maximum_message_length;
    m_maximum_message_length_isSet = true;
}

bool OAIUpdateRoom_request::is_maximum_message_length_Set() const{
    return m_maximum_message_length_isSet;
}

bool OAIUpdateRoom_request::is_maximum_message_length_Valid() const{
    return m_maximum_message_length_isValid;
}

qint32 OAIUpdateRoom_request::getMaximumMessageRatePerSecond() const {
    return m_maximum_message_rate_per_second;
}
void OAIUpdateRoom_request::setMaximumMessageRatePerSecond(const qint32 &maximum_message_rate_per_second) {
    m_maximum_message_rate_per_second = maximum_message_rate_per_second;
    m_maximum_message_rate_per_second_isSet = true;
}

bool OAIUpdateRoom_request::is_maximum_message_rate_per_second_Set() const{
    return m_maximum_message_rate_per_second_isSet;
}

bool OAIUpdateRoom_request::is_maximum_message_rate_per_second_Valid() const{
    return m_maximum_message_rate_per_second_isValid;
}

OAICreateRoom_request_messageReviewHandler OAIUpdateRoom_request::getMessageReviewHandler() const {
    return m_message_review_handler;
}
void OAIUpdateRoom_request::setMessageReviewHandler(const OAICreateRoom_request_messageReviewHandler &message_review_handler) {
    m_message_review_handler = message_review_handler;
    m_message_review_handler_isSet = true;
}

bool OAIUpdateRoom_request::is_message_review_handler_Set() const{
    return m_message_review_handler_isSet;
}

bool OAIUpdateRoom_request::is_message_review_handler_Valid() const{
    return m_message_review_handler_isValid;
}

QString OAIUpdateRoom_request::getName() const {
    return m_name;
}
void OAIUpdateRoom_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateRoom_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateRoom_request::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIUpdateRoom_request::isSet() const {
...
bool OAIUpdateRoom_request::isValid() const {
