...
OAIFallbackResult::OAIFallbackResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFallbackResult::OAIFallbackResult() {
    this->initializeModel();
}

OAIFallbackResult::~OAIFallbackResult() {}

void OAIFallbackResult::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFallbackResult::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFallbackResult::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ALLOW", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFallbackResult::ALLOW;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DENY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFallbackResult::DENY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFallbackResult::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFallbackResult::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFallbackResult::ALLOW:
            val = "ALLOW";
            break;
        case eOAIFallbackResult::DENY:
            val = "DENY";
            break;
        default:
            break;
...
QJsonValue OAIFallbackResult::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFallbackResult::eOAIFallbackResult OAIFallbackResult::getValue() const {
    return m_value;
}

void OAIFallbackResult::setValue(const OAIFallbackResult::eOAIFallbackResult& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFallbackResult::isSet() const {
    
    return m_value_isSet;
}

bool OAIFallbackResult::isValid() const {
