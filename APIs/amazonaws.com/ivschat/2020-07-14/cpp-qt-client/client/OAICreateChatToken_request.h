...
/*
 * OAICreateChatToken_request.h
 *
 * 
 */

#ifndef OAICreateChatToken_request_H
#define OAICreateChatToken_request_H
...
class OAICreateChatToken_request : public OAIObject {
public:
    OAICreateChatToken_request();
    OAICreateChatToken_request(QString json);
    ~OAICreateChatToken_request() override;
    ...
    QList<OAIChatTokenCapability> getCapabilities() const;
    void setCapabilities(const QList<OAIChatTokenCapability> &capabilities);
    ...
    qint32 getSessionDurationInMinutes() const;
    void setSessionDurationInMinutes(const qint32 &session_duration_in_minutes);
    bool is_session_duration_in_minutes_Set() const;
    bool is_session_duration_in_minutes_Valid() const;
...
private:
    ...
    QList<OAIChatTokenCapability> m_capabilities;
    ...
    qint32 m_session_duration_in_minutes;
    bool m_session_duration_in_minutes_isSet;
    bool m_session_duration_in_minutes_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChatToken_request)

#endif // OAICreateChatToken_request_H
