...
OAIGetRoomRequest::OAIGetRoomRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRoomRequest::OAIGetRoomRequest() {
    this->initializeModel();
}

OAIGetRoomRequest::~OAIGetRoomRequest() {}

void OAIGetRoomRequest::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIGetRoomRequest::fromJson(QString jsonString) {
...
void OAIGetRoomRequest::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("identifier")]);
    m_identifier_isSet = !json[QString("identifier")].isNull() && m_identifier_isValid;
}

QString OAIGetRoomRequest::asJson() const {
...
QJsonObject OAIGetRoomRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetRoomRequest::getIdentifier() const {
    return m_identifier;
}
void OAIGetRoomRequest::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIGetRoomRequest::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIGetRoomRequest::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIGetRoomRequest::isSet() const {
...
bool OAIGetRoomRequest::isValid() const {
