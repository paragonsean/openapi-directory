...
#include "OAILoggingConfigurationSummary.h"
...
OAILoggingConfigurationSummary::OAILoggingConfigurationSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoggingConfigurationSummary::OAILoggingConfigurationSummary() {
    this->initializeModel();
}

OAILoggingConfigurationSummary::~OAILoggingConfigurationSummary() {}

void OAILoggingConfigurationSummary::initializeModel() {
...
void OAILoggingConfigurationSummary::fromJson(QString jsonString) {
...
void OAILoggingConfigurationSummary::fromJsonObject(QJsonObject json) {
...
QString OAILoggingConfigurationSummary::asJson() const {
...
QJsonObject OAILoggingConfigurationSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAILoggingConfigurationSummary::getArn() const {
    return m_arn;
}
void OAILoggingConfigurationSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAILoggingConfigurationSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAILoggingConfigurationSummary::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAILoggingConfigurationSummary::getCreateTime() const {
    return m_create_time;
}
void OAILoggingConfigurationSummary::setCreateTime(const QDateTime &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAILoggingConfigurationSummary::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAILoggingConfigurationSummary::is_create_time_Valid() const{
    return m_create_time_isValid;
}

OAILoggingConfigurationSummary_destinationConfiguration OAILoggingConfigurationSummary::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAILoggingConfigurationSummary::setDestinationConfiguration(const OAILoggingConfigurationSummary_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAILoggingConfigurationSummary::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAILoggingConfigurationSummary::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAILoggingConfigurationSummary::getId() const {
    return m_id;
}
void OAILoggingConfigurationSummary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILoggingConfigurationSummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAILoggingConfigurationSummary::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILoggingConfigurationSummary::getName() const {
    return m_name;
}
void OAILoggingConfigurationSummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILoggingConfigurationSummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAILoggingConfigurationSummary::is_name_Valid() const{
    return m_name_isValid;
}

OAILoggingConfigurationState OAILoggingConfigurationSummary::getState() const {
    return m_state;
}
void OAILoggingConfigurationSummary::setState(const OAILoggingConfigurationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAILoggingConfigurationSummary::is_state_Set() const{
    return m_state_isSet;
}

bool OAILoggingConfigurationSummary::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAILoggingConfigurationSummary::getTags() const {
    return m_tags;
}
void OAILoggingConfigurationSummary::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAILoggingConfigurationSummary::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAILoggingConfigurationSummary::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAILoggingConfigurationSummary::getUpdateTime() const {
    return m_update_time;
}
void OAILoggingConfigurationSummary::setUpdateTime(const QDateTime &update_time) {
    m_update_time = update_time;
    m_update_time_isSet = true;
}

bool OAILoggingConfigurationSummary::is_update_time_Set() const{
    return m_update_time_isSet;
}

bool OAILoggingConfigurationSummary::is_update_time_Valid() const{
    return m_update_time_isValid;
}

bool OAILoggingConfigurationSummary::isSet() const {
...
bool OAILoggingConfigurationSummary::isValid() const {
