...
OAIListRooms_request::OAIListRooms_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRooms_request::OAIListRooms_request() {
    this->initializeModel();
}

OAIListRooms_request::~OAIListRooms_request() {}

void OAIListRooms_request::initializeModel() {
...
void OAIListRooms_request::fromJson(QString jsonString) {
...
void OAIListRooms_request::fromJsonObject(QJsonObject json) {
...
QString OAIListRooms_request::asJson() const {
...
QJsonObject OAIListRooms_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListRooms_request::getLoggingConfigurationIdentifier() const {
    return m_logging_configuration_identifier;
}
void OAIListRooms_request::setLoggingConfigurationIdentifier(const QString &logging_configuration_identifier) {
    m_logging_configuration_identifier = logging_configuration_identifier;
    m_logging_configuration_identifier_isSet = true;
}

bool OAIListRooms_request::is_logging_configuration_identifier_Set() const{
    return m_logging_configuration_identifier_isSet;
}

bool OAIListRooms_request::is_logging_configuration_identifier_Valid() const{
    return m_logging_configuration_identifier_isValid;
}

qint32 OAIListRooms_request::getMaxResults() const {
    return m_max_results;
}
void OAIListRooms_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListRooms_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListRooms_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListRooms_request::getMessageReviewHandlerUri() const {
    return m_message_review_handler_uri;
}
void OAIListRooms_request::setMessageReviewHandlerUri(const QString &message_review_handler_uri) {
    m_message_review_handler_uri = message_review_handler_uri;
    m_message_review_handler_uri_isSet = true;
}

bool OAIListRooms_request::is_message_review_handler_uri_Set() const{
    return m_message_review_handler_uri_isSet;
}

bool OAIListRooms_request::is_message_review_handler_uri_Valid() const{
    return m_message_review_handler_uri_isValid;
}

QString OAIListRooms_request::getName() const {
    return m_name;
}
void OAIListRooms_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIListRooms_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIListRooms_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIListRooms_request::getNextToken() const {
    return m_next_token;
}
void OAIListRooms_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListRooms_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListRooms_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListRooms_request::isSet() const {
...
bool OAIListRooms_request::isValid() const {
