...
OAIGetRoom_request::OAIGetRoom_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRoom_request::OAIGetRoom_request() {
    this->initializeModel();
}

OAIGetRoom_request::~OAIGetRoom_request() {}

void OAIGetRoom_request::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIGetRoom_request::fromJson(QString jsonString) {
...
void OAIGetRoom_request::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("identifier")]);
    m_identifier_isSet = !json[QString("identifier")].isNull() && m_identifier_isValid;
}

QString OAIGetRoom_request::asJson() const {
...
QJsonObject OAIGetRoom_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetRoom_request::getIdentifier() const {
    return m_identifier;
}
void OAIGetRoom_request::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIGetRoom_request::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIGetRoom_request::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIGetRoom_request::isSet() const {
...
bool OAIGetRoom_request::isValid() const {
