...
/*
 * OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs.h
 *
 * 
 */

#ifndef OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs_H
#define OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs_H
...
class OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs : public OAIObject {
public:
    OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs();
    OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs(QString json);
    ~OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs)

#endif // OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs_H
