...
OAIDeleteRoom_request::OAIDeleteRoom_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRoom_request::OAIDeleteRoom_request() {
    this->initializeModel();
}

OAIDeleteRoom_request::~OAIDeleteRoom_request() {}

void OAIDeleteRoom_request::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIDeleteRoom_request::fromJson(QString jsonString) {
...
void OAIDeleteRoom_request::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("identifier")]);
    m_identifier_isSet = !json[QString("identifier")].isNull() && m_identifier_isValid;
}

QString OAIDeleteRoom_request::asJson() const {
...
QJsonObject OAIDeleteRoom_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteRoom_request::getIdentifier() const {
    return m_identifier;
}
void OAIDeleteRoom_request::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIDeleteRoom_request::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIDeleteRoom_request::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIDeleteRoom_request::isSet() const {
...
bool OAIDeleteRoom_request::isValid() const {
