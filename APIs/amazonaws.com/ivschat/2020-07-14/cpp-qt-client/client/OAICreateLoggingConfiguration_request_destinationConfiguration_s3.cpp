...
OAICreateLoggingConfiguration_request_destinationConfiguration_s3::OAICreateLoggingConfiguration_request_destinationConfiguration_s3(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLoggingConfiguration_request_destinationConfiguration_s3::OAICreateLoggingConfiguration_request_destinationConfiguration_s3() {
    this->initializeModel();
}

OAICreateLoggingConfiguration_request_destinationConfiguration_s3::~OAICreateLoggingConfiguration_request_destinationConfiguration_s3() {}

void OAICreateLoggingConfiguration_request_destinationConfiguration_s3::initializeModel() {

    m_bucket_name_isSet = false;
    m_bucket_name_isValid = false;
}

void OAICreateLoggingConfiguration_request_destinationConfiguration_s3::fromJson(QString jsonString) {
...
void OAICreateLoggingConfiguration_request_destinationConfiguration_s3::fromJsonObject(QJsonObject json) {
...
QString OAICreateLoggingConfiguration_request_destinationConfiguration_s3::asJson() const {
...
QJsonObject OAICreateLoggingConfiguration_request_destinationConfiguration_s3::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateLoggingConfiguration_request_destinationConfiguration_s3::getBucketName() const {
    return m_bucket_name;
}
void OAICreateLoggingConfiguration_request_destinationConfiguration_s3::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration_s3::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration_s3::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration_s3::isSet() const {
...
bool OAICreateLoggingConfiguration_request_destinationConfiguration_s3::isValid() const {
