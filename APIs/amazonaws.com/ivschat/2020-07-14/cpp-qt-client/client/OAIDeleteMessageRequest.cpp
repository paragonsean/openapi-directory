...
QString OAIDeleteMessageRequest::getId() const {
    return m_id;
}
void OAIDeleteMessageRequest::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDeleteMessageRequest::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDeleteMessageRequest::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDeleteMessageRequest::getReason() const {
    return m_reason;
}
void OAIDeleteMessageRequest::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIDeleteMessageRequest::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIDeleteMessageRequest::is_reason_Valid() const{
    return m_reason_isValid;
}

QString OAIDeleteMessageRequest::getRoomIdentifier() const {
    return m_room_identifier;
}
void OAIDeleteMessageRequest::setRoomIdentifier(const QString &room_identifier) {
    m_room_identifier = room_identifier;
    m_room_identifier_isSet = true;
}

bool OAIDeleteMessageRequest::is_room_identifier_Set() const{
    return m_room_identifier_isSet;
}

bool OAIDeleteMessageRequest::is_room_identifier_Valid() const{
