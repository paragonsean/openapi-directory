...
/*
 * OAISendEvent_request.h
 *
 * 
 */

#ifndef OAISendEvent_request_H
#define OAISendEvent_request_H
...
class OAISendEvent_request : public OAIObject {
public:
    OAISendEvent_request();
    OAISendEvent_request(QString json);
    ~OAISendEvent_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendEvent_request)

#endif // OAISendEvent_request_H
