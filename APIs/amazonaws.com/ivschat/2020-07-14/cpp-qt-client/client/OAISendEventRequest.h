...
public:
    ...
    QString getRoomIdentifier() const;
    void setRoomIdentifier(const QString &room_identifier);
    bool is_room_identifier_Set() const;
    bool is_room_identifier_Valid() const;
...
private:
    ...
    QString m_room_identifier;
    bool m_room_identifier_isSet;
    bool m_room_identifier_isValid;
};
