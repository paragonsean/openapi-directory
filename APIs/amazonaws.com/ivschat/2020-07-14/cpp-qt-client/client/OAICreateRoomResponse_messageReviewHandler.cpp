...
#include "OAICreateRoomResponse_messageReviewHandler.h"
...
OAICreateRoomResponse_messageReviewHandler::OAICreateRoomResponse_messageReviewHandler(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRoomResponse_messageReviewHandler::OAICreateRoomResponse_messageReviewHandler() {
    this->initializeModel();
}

OAICreateRoomResponse_messageReviewHandler::~OAICreateRoomResponse_messageReviewHandler() {}

void OAICreateRoomResponse_messageReviewHandler::initializeModel() {

    m_fallback_result_isSet = false;
    m_fallback_result_isValid = false;

    m_uri_isSet = false;
    m_uri_isValid = false;
}

void OAICreateRoomResponse_messageReviewHandler::fromJson(QString jsonString) {
...
void OAICreateRoomResponse_messageReviewHandler::fromJsonObject(QJsonObject json) {

    m_fallback_result_isValid = ::OpenAPI::fromJsonValue(m_fallback_result, json[QString("fallbackResult")]);
    m_fallback_result_isSet = !json[QString("fallbackResult")].isNull() && m_fallback_result_isValid;

    m_uri_isValid = ::OpenAPI::fromJsonValue(m_uri, json[QString("uri")]);
    m_uri_isSet = !json[QString("uri")].isNull() && m_uri_isValid;
}

QString OAICreateRoomResponse_messageReviewHandler::asJson() const {
...
QJsonObject OAICreateRoomResponse_messageReviewHandler::asJsonObject() const {
    QJsonObject obj;
    if (m_fallback_result.isSet()) {
        obj.insert(QString("fallbackResult"), ::OpenAPI::toJsonValue(m_fallback_result));
    }
    if (m_uri_isSet) {
...
OAIFallbackResult OAICreateRoomResponse_messageReviewHandler::getFallbackResult() const {
    return m_fallback_result;
}
void OAICreateRoomResponse_messageReviewHandler::setFallbackResult(const OAIFallbackResult &fallback_result) {
    m_fallback_result = fallback_result;
    m_fallback_result_isSet = true;
}

bool OAICreateRoomResponse_messageReviewHandler::is_fallback_result_Set() const{
    return m_fallback_result_isSet;
}

bool OAICreateRoomResponse_messageReviewHandler::is_fallback_result_Valid() const{
    return m_fallback_result_isValid;
}

QString OAICreateRoomResponse_messageReviewHandler::getUri() const {
    return m_uri;
}
void OAICreateRoomResponse_messageReviewHandler::setUri(const QString &uri) {
    m_uri = uri;
    m_uri_isSet = true;
}

bool OAICreateRoomResponse_messageReviewHandler::is_uri_Set() const{
    return m_uri_isSet;
}

bool OAICreateRoomResponse_messageReviewHandler::is_uri_Valid() const{
    return m_uri_isValid;
}

bool OAICreateRoomResponse_messageReviewHandler::isSet() const {
...
bool OAICreateRoomResponse_messageReviewHandler::isValid() const {
