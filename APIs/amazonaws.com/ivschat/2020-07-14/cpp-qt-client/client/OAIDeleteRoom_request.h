...
/*
 * OAIDeleteRoom_request.h
 *
 * 
 */

#ifndef OAIDeleteRoom_request_H
#define OAIDeleteRoom_request_H
...
class OAIDeleteRoom_request : public OAIObject {
public:
    OAIDeleteRoom_request();
    OAIDeleteRoom_request(QString json);
    ~OAIDeleteRoom_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRoom_request)

#endif // OAIDeleteRoom_request_H
