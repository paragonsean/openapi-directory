...
/*
 * OAIGetLoggingConfiguration_request.h
 *
 * 
 */

#ifndef OAIGetLoggingConfiguration_request_H
#define OAIGetLoggingConfiguration_request_H
...
class OAIGetLoggingConfiguration_request : public OAIObject {
public:
    OAIGetLoggingConfiguration_request();
    OAIGetLoggingConfiguration_request(QString json);
    ~OAIGetLoggingConfiguration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLoggingConfiguration_request)

#endif // OAIGetLoggingConfiguration_request_H
