...
OAICreateLoggingConfiguration_request_destinationConfiguration OAIUpdateLoggingConfiguration_request::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAIUpdateLoggingConfiguration_request::setDestinationConfiguration(const OAICreateLoggingConfiguration_request_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAIUpdateLoggingConfiguration_request::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAIUpdateLoggingConfiguration_request::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAIUpdateLoggingConfiguration_request::getIdentifier() const {
    return m_identifier;
}
void OAIUpdateLoggingConfiguration_request::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIUpdateLoggingConfiguration_request::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIUpdateLoggingConfiguration_request::is_identifier_Valid() const{
    return m_identifier_isValid;
}

QString OAIUpdateLoggingConfiguration_request::getName() const {
    return m_name;
}
void OAIUpdateLoggingConfiguration_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateLoggingConfiguration_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateLoggingConfiguration_request::is_name_Valid() const{
