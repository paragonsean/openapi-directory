...
/*
 * OAIDeleteLoggingConfiguration_request.h
 *
 * 
 */

#ifndef OAIDeleteLoggingConfiguration_request_H
#define OAIDeleteLoggingConfiguration_request_H
...
class OAIDeleteLoggingConfiguration_request : public OAIObject {
public:
    OAIDeleteLoggingConfiguration_request();
    OAIDeleteLoggingConfiguration_request(QString json);
    ~OAIDeleteLoggingConfiguration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLoggingConfiguration_request)

#endif // OAIDeleteLoggingConfiguration_request_H
