...
#include "OAIChatTokenCapability.h"
...
OAIChatTokenCapability::OAIChatTokenCapability(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChatTokenCapability::OAIChatTokenCapability() {
    this->initializeModel();
}

OAIChatTokenCapability::~OAIChatTokenCapability() {}

void OAIChatTokenCapability::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIChatTokenCapability::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIChatTokenCapability::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SEND_MESSAGE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChatTokenCapability::SEND_MESSAGE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DISCONNECT_USER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChatTokenCapability::DISCONNECT_USER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETE_MESSAGE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChatTokenCapability::DELETE_MESSAGE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIChatTokenCapability::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIChatTokenCapability::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIChatTokenCapability::SEND_MESSAGE:
            val = "SEND_MESSAGE";
            break;
        case eOAIChatTokenCapability::DISCONNECT_USER:
            val = "DISCONNECT_USER";
            break;
        case eOAIChatTokenCapability::DELETE_MESSAGE:
            val = "DELETE_MESSAGE";
            break;
        default:
            break;
...
QJsonValue OAIChatTokenCapability::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIChatTokenCapability::eOAIChatTokenCapability OAIChatTokenCapability::getValue() const {
    return m_value;
}

void OAIChatTokenCapability::setValue(const OAIChatTokenCapability::eOAIChatTokenCapability& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIChatTokenCapability::isSet() const {
    
    return m_value_isSet;
}

bool OAIChatTokenCapability::isValid() const {
