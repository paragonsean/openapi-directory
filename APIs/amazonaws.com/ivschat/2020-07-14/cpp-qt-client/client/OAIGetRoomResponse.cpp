...
OAIGetRoomResponse::OAIGetRoomResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRoomResponse::OAIGetRoomResponse() {
    this->initializeModel();
}

OAIGetRoomResponse::~OAIGetRoomResponse() {}

void OAIGetRoomResponse::initializeModel() {
...
void OAIGetRoomResponse::fromJson(QString jsonString) {
...
void OAIGetRoomResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetRoomResponse::asJson() const {
...
QJsonObject OAIGetRoomResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetRoomResponse::getArn() const {
    return m_arn;
}
void OAIGetRoomResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetRoomResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetRoomResponse::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIGetRoomResponse::getCreateTime() const {
    return m_create_time;
}
void OAIGetRoomResponse::setCreateTime(const QDateTime &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAIGetRoomResponse::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAIGetRoomResponse::is_create_time_Valid() const{
    return m_create_time_isValid;
}

QString OAIGetRoomResponse::getId() const {
    return m_id;
}
void OAIGetRoomResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetRoomResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetRoomResponse::is_id_Valid() const{
    return m_id_isValid;
}

QList OAIGetRoomResponse::getLoggingConfigurationIdentifiers() const {
    return m_logging_configuration_identifiers;
}
void OAIGetRoomResponse::setLoggingConfigurationIdentifiers(const QList &logging_configuration_identifiers) {
    m_logging_configuration_identifiers = logging_configuration_identifiers;
    m_logging_configuration_identifiers_isSet = true;
}

bool OAIGetRoomResponse::is_logging_configuration_identifiers_Set() const{
    return m_logging_configuration_identifiers_isSet;
}

bool OAIGetRoomResponse::is_logging_configuration_identifiers_Valid() const{
    return m_logging_configuration_identifiers_isValid;
}

qint32 OAIGetRoomResponse::getMaximumMessageLength() const {
    return m_maximum_message_length;
}
void OAIGetRoomResponse::setMaximumMessageLength(const qint32 &maximum_message_length) {
    m_maximum_message_length = maximum_message_length;
    m_maximum_message_length_isSet = true;
}

bool OAIGetRoomResponse::is_maximum_message_length_Set() const{
    return m_maximum_message_length_isSet;
}

bool OAIGetRoomResponse::is_maximum_message_length_Valid() const{
    return m_maximum_message_length_isValid;
}

qint32 OAIGetRoomResponse::getMaximumMessageRatePerSecond() const {
    return m_maximum_message_rate_per_second;
}
void OAIGetRoomResponse::setMaximumMessageRatePerSecond(const qint32 &maximum_message_rate_per_second) {
    m_maximum_message_rate_per_second = maximum_message_rate_per_second;
    m_maximum_message_rate_per_second_isSet = true;
}

bool OAIGetRoomResponse::is_maximum_message_rate_per_second_Set() const{
    return m_maximum_message_rate_per_second_isSet;
}

bool OAIGetRoomResponse::is_maximum_message_rate_per_second_Valid() const{
    return m_maximum_message_rate_per_second_isValid;
}

OAICreateRoomResponse_messageReviewHandler OAIGetRoomResponse::getMessageReviewHandler() const {
    return m_message_review_handler;
}
void OAIGetRoomResponse::setMessageReviewHandler(const OAICreateRoomResponse_messageReviewHandler &message_review_handler) {
    m_message_review_handler = message_review_handler;
    m_message_review_handler_isSet = true;
}

bool OAIGetRoomResponse::is_message_review_handler_Set() const{
    return m_message_review_handler_isSet;
}

bool OAIGetRoomResponse::is_message_review_handler_Valid() const{
    return m_message_review_handler_isValid;
}

QString OAIGetRoomResponse::getName() const {
    return m_name;
}
void OAIGetRoomResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetRoomResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetRoomResponse::is_name_Valid() const{
    return m_name_isValid;
}

QMap OAIGetRoomResponse::getTags() const {
    return m_tags;
}
void OAIGetRoomResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetRoomResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetRoomResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAIGetRoomResponse::getUpdateTime() const {
    return m_update_time;
}
void OAIGetRoomResponse::setUpdateTime(const QDateTime &update_time) {
    m_update_time = update_time;
    m_update_time_isSet = true;
}

bool OAIGetRoomResponse::is_update_time_Set() const{
    return m_update_time_isSet;
}

bool OAIGetRoomResponse::is_update_time_Valid() const{
    return m_update_time_isValid;
}

bool OAIGetRoomResponse::isSet() const {
...
bool OAIGetRoomResponse::isValid() const {
