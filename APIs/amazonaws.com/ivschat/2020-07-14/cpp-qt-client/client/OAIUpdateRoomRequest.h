...
#include "OAIUpdateRoomRequest_messageReviewHandler.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIUpdateRoomRequest_messageReviewHandler;
...
public:
    ...
    OAIUpdateRoomRequest_messageReviewHandler getMessageReviewHandler() const;
    void setMessageReviewHandler(const OAIUpdateRoomRequest_messageReviewHandler &message_review_handler);
...
private:
    ...
    OAIUpdateRoomRequest_messageReviewHandler m_message_review_handler;
