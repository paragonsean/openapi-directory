...
/*
 * OAIListRoomsResponse.h
 *
 * 
 */

#ifndef OAIListRoomsResponse_H
#define OAIListRoomsResponse_H
...
class OAIListRoomsResponse : public OAIObject {
public:
    OAIListRoomsResponse();
    OAIListRoomsResponse(QString json);
    ~OAIListRoomsResponse() override;
    ...
    QList getRooms() const;
    void setRooms(const QList &rooms);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRoomsResponse)

#endif // OAIListRoomsResponse_H
