...
/*
 * OAICreateChatTokenResponse.h
 *
 * 
 */

#ifndef OAICreateChatTokenResponse_H
#define OAICreateChatTokenResponse_H
...
class OAICreateChatTokenResponse : public OAIObject {
public:
    OAICreateChatTokenResponse();
    OAICreateChatTokenResponse(QString json);
    ~OAICreateChatTokenResponse() override;
    ...
    QDateTime getSessionExpirationTime() const;
    void setSessionExpirationTime(const QDateTime &session_expiration_time);
    bool is_session_expiration_time_Set() const;
    bool is_session_expiration_time_Valid() const;
    ...
    QDateTime getTokenExpirationTime() const;
    void setTokenExpirationTime(const QDateTime &token_expiration_time);
    bool is_token_expiration_time_Set() const;
    bool is_token_expiration_time_Valid() const;
...
private:
    ...
    QDateTime m_session_expiration_time;
    bool m_session_expiration_time_isSet;
    bool m_session_expiration_time_isValid;

    QString m_token;
    bool m_token_isSet;
    bool m_token_isValid;

    QDateTime m_token_expiration_time;
    bool m_token_expiration_time_isSet;
    bool m_token_expiration_time_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateChatTokenResponse)

#endif // OAICreateChatTokenResponse_H
