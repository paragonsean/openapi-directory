...
OAIListLoggingConfigurationsRequest::OAIListLoggingConfigurationsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListLoggingConfigurationsRequest::OAIListLoggingConfigurationsRequest() {
    this->initializeModel();
}

OAIListLoggingConfigurationsRequest::~OAIListLoggingConfigurationsRequest() {}

void OAIListLoggingConfigurationsRequest::initializeModel() {
...
void OAIListLoggingConfigurationsRequest::fromJson(QString jsonString) {
...
void OAIListLoggingConfigurationsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListLoggingConfigurationsRequest::asJson() const {
...
QJsonObject OAIListLoggingConfigurationsRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListLoggingConfigurationsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListLoggingConfigurationsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListLoggingConfigurationsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListLoggingConfigurationsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListLoggingConfigurationsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListLoggingConfigurationsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListLoggingConfigurationsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListLoggingConfigurationsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListLoggingConfigurationsRequest::isSet() const {
...
bool OAIListLoggingConfigurationsRequest::isValid() const {
