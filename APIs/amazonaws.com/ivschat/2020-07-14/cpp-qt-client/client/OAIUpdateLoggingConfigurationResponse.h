...
#include "OAIUpdateLoggingConfigurationState.h"
#include <QDateTime>
#include <QMap>
#include <QString>
...
public:
    ...
    OAIUpdateLoggingConfigurationState getState() const;
    void setState(const OAIUpdateLoggingConfigurationState &state);
...
private:
    ...
    OAIUpdateLoggingConfigurationState m_state;
    bool m_state_isSet;
