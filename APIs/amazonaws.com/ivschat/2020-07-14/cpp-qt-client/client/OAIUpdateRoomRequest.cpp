...
QString OAIUpdateRoomRequest::getIdentifier() const {
    return m_identifier;
}
void OAIUpdateRoomRequest::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIUpdateRoomRequest::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIUpdateRoomRequest::is_identifier_Valid() const{
    return m_identifier_isValid;
}

QList OAIUpdateRoomRequest::getLoggingConfigurationIdentifiers() const {
    return m_logging_configuration_identifiers;
}
void OAIUpdateRoomRequest::setLoggingConfigurationIdentifiers(const QList &logging_configuration_identifiers) {
    m_logging_configuration_identifiers = logging_configuration_identifiers;
    m_logging_configuration_identifiers_isSet = true;
}

bool OAIUpdateRoomRequest::is_logging_configuration_identifiers_Set() const{
    return m_logging_configuration_identifiers_isSet;
}

bool OAIUpdateRoomRequest::is_logging_configuration_identifiers_Valid() const{
    return m_logging_configuration_identifiers_isValid;
}

qint32 OAIUpdateRoomRequest::getMaximumMessageLength() const {
    return m_maximum_message_length;
}
void OAIUpdateRoomRequest::setMaximumMessageLength(const qint32 &maximum_message_length) {
    m_maximum_message_length = maximum_message_length;
    m_maximum_message_length_isSet = true;
}

bool OAIUpdateRoomRequest::is_maximum_message_length_Set() const{
    return m_maximum_message_length_isSet;
}

bool OAIUpdateRoomRequest::is_maximum_message_length_Valid() const{
    return m_maximum_message_length_isValid;
}

qint32 OAIUpdateRoomRequest::getMaximumMessageRatePerSecond() const {
    return m_maximum_message_rate_per_second;
}
void OAIUpdateRoomRequest::setMaximumMessageRatePerSecond(const qint32 &maximum_message_rate_per_second) {
    m_maximum_message_rate_per_second = maximum_message_rate_per_second;
    m_maximum_message_rate_per_second_isSet = true;
}

bool OAIUpdateRoomRequest::is_maximum_message_rate_per_second_Set() const{
    return m_maximum_message_rate_per_second_isSet;
}

bool OAIUpdateRoomRequest::is_maximum_message_rate_per_second_Valid() const{
    return m_maximum_message_rate_per_second_isValid;
}

OAIUpdateRoomRequest_messageReviewHandler OAIUpdateRoomRequest::getMessageReviewHandler() const {
    return m_message_review_handler;
}
void OAIUpdateRoomRequest::setMessageReviewHandler(const OAIUpdateRoomRequest_messageReviewHandler &message_review_handler) {
    m_message_review_handler = message_review_handler;
    m_message_review_handler_isSet = true;
}

bool OAIUpdateRoomRequest::is_message_review_handler_Set() const{
    return m_message_review_handler_isSet;
}

bool OAIUpdateRoomRequest::is_message_review_handler_Valid() const{
