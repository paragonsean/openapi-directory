...
/*
 * OAICreateChatTokenRequest.h
 *
 * 
 */

#ifndef OAICreateChatTokenRequest_H
#define OAICreateChatTokenRequest_H
...
class OAICreateChatTokenRequest : public OAIObject {
public:
    OAICreateChatTokenRequest();
    OAICreateChatTokenRequest(QString json);
    ~OAICreateChatTokenRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChatTokenRequest)

#endif // OAICreateChatTokenRequest_H
