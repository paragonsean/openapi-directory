...
OAICreateRoom_request::OAICreateRoom_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRoom_request::OAICreateRoom_request() {
    this->initializeModel();
}

OAICreateRoom_request::~OAICreateRoom_request() {}

void OAICreateRoom_request::initializeModel() {
...
void OAICreateRoom_request::fromJson(QString jsonString) {
...
void OAICreateRoom_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateRoom_request::asJson() const {
...
QJsonObject OAICreateRoom_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAICreateRoom_request::getLoggingConfigurationIdentifiers() const {
    return m_logging_configuration_identifiers;
}
void OAICreateRoom_request::setLoggingConfigurationIdentifiers(const QList<QString> &logging_configuration_identifiers) {
    m_logging_configuration_identifiers = logging_configuration_identifiers;
    m_logging_configuration_identifiers_isSet = true;
}

bool OAICreateRoom_request::is_logging_configuration_identifiers_Set() const{
    return m_logging_configuration_identifiers_isSet;
}

bool OAICreateRoom_request::is_logging_configuration_identifiers_Valid() const{
    return m_logging_configuration_identifiers_isValid;
}

qint32 OAICreateRoom_request::getMaximumMessageLength() const {
    return m_maximum_message_length;
}
void OAICreateRoom_request::setMaximumMessageLength(const qint32 &maximum_message_length) {
    m_maximum_message_length = maximum_message_length;
    m_maximum_message_length_isSet = true;
}

bool OAICreateRoom_request::is_maximum_message_length_Set() const{
    return m_maximum_message_length_isSet;
}

bool OAICreateRoom_request::is_maximum_message_length_Valid() const{
    return m_maximum_message_length_isValid;
}

qint32 OAICreateRoom_request::getMaximumMessageRatePerSecond() const {
    return m_maximum_message_rate_per_second;
}
void OAICreateRoom_request::setMaximumMessageRatePerSecond(const qint32 &maximum_message_rate_per_second) {
    m_maximum_message_rate_per_second = maximum_message_rate_per_second;
    m_maximum_message_rate_per_second_isSet = true;
}

bool OAICreateRoom_request::is_maximum_message_rate_per_second_Set() const{
    return m_maximum_message_rate_per_second_isSet;
}

bool OAICreateRoom_request::is_maximum_message_rate_per_second_Valid() const{
    return m_maximum_message_rate_per_second_isValid;
}

OAICreateRoom_request_messageReviewHandler OAICreateRoom_request::getMessageReviewHandler() const {
    return m_message_review_handler;
}
void OAICreateRoom_request::setMessageReviewHandler(const OAICreateRoom_request_messageReviewHandler &message_review_handler) {
    m_message_review_handler = message_review_handler;
    m_message_review_handler_isSet = true;
}

bool OAICreateRoom_request::is_message_review_handler_Set() const{
    return m_message_review_handler_isSet;
}

bool OAICreateRoom_request::is_message_review_handler_Valid() const{
    return m_message_review_handler_isValid;
}

QString OAICreateRoom_request::getName() const {
    return m_name;
}
void OAICreateRoom_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateRoom_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateRoom_request::is_name_Valid() const{
    return m_name_isValid;
}

QMap<QString, QString> OAICreateRoom_request::getTags() const {
    return m_tags;
}
void OAICreateRoom_request::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateRoom_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateRoom_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateRoom_request::isSet() const {
...
bool OAICreateRoom_request::isValid() const {
