...
/*
 * OAIGetRoom_request.h
 *
 * 
 */

#ifndef OAIGetRoom_request_H
#define OAIGetRoom_request_H
...
class OAIGetRoom_request : public OAIObject {
public:
    OAIGetRoom_request();
    OAIGetRoom_request(QString json);
    ~OAIGetRoom_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRoom_request)

#endif // OAIGetRoom_request_H
