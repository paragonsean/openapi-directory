...
OAIGetLoggingConfiguration_request::OAIGetLoggingConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLoggingConfiguration_request::OAIGetLoggingConfiguration_request() {
    this->initializeModel();
}

OAIGetLoggingConfiguration_request::~OAIGetLoggingConfiguration_request() {}

void OAIGetLoggingConfiguration_request::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIGetLoggingConfiguration_request::fromJson(QString jsonString) {
...
void OAIGetLoggingConfiguration_request::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("identifier")]);
    m_identifier_isSet = !json[QString("identifier")].isNull() && m_identifier_isValid;
}

QString OAIGetLoggingConfiguration_request::asJson() const {
...
QJsonObject OAIGetLoggingConfiguration_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetLoggingConfiguration_request::getIdentifier() const {
    return m_identifier;
}
void OAIGetLoggingConfiguration_request::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIGetLoggingConfiguration_request::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIGetLoggingConfiguration_request::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIGetLoggingConfiguration_request::isSet() const {
...
bool OAIGetLoggingConfiguration_request::isValid() const {
