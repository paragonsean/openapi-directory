...
/*
 * OAIFirehoseDestinationConfiguration.h
 *
 * Specifies a Kinesis Firehose location where chat logs will be stored.
 */

#ifndef OAIFirehoseDestinationConfiguration_H
#define OAIFirehoseDestinationConfiguration_H
...
class OAIFirehoseDestinationConfiguration : public OAIObject {
public:
    OAIFirehoseDestinationConfiguration();
    OAIFirehoseDestinationConfiguration(QString json);
    ~OAIFirehoseDestinationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirehoseDestinationConfiguration)

#endif // OAIFirehoseDestinationConfiguration_H
