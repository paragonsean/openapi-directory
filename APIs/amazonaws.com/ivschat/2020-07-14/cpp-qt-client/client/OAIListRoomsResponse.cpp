...
OAIListRoomsResponse::OAIListRoomsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRoomsResponse::OAIListRoomsResponse() {
    this->initializeModel();
}

OAIListRoomsResponse::~OAIListRoomsResponse() {}

void OAIListRoomsResponse::initializeModel() {
...
void OAIListRoomsResponse::fromJson(QString jsonString) {
...
void OAIListRoomsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListRoomsResponse::asJson() const {
...
QJsonObject OAIListRoomsResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListRoomsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListRoomsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListRoomsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListRoomsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListRoomsResponse::getRooms() const {
    return m_rooms;
}
void OAIListRoomsResponse::setRooms(const QList &rooms) {
    m_rooms = rooms;
    m_rooms_isSet = true;
}

bool OAIListRoomsResponse::is_rooms_Set() const{
    return m_rooms_isSet;
}

bool OAIListRoomsResponse::is_rooms_Valid() const{
    return m_rooms_isValid;
}

bool OAIListRoomsResponse::isSet() const {
...
bool OAIListRoomsResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_rooms_isValid && true;
}
