...
/*
 * OAIListLoggingConfigurations_request.h
 *
 * 
 */

#ifndef OAIListLoggingConfigurations_request_H
#define OAIListLoggingConfigurations_request_H
...
class OAIListLoggingConfigurations_request : public OAIObject {
public:
    OAIListLoggingConfigurations_request();
    OAIListLoggingConfigurations_request(QString json);
    ~OAIListLoggingConfigurations_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLoggingConfigurations_request)

#endif // OAIListLoggingConfigurations_request_H
