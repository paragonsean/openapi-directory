...
#include "OAICreateRoom_request_messageReviewHandler.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICreateRoom_request_messageReviewHandler;
...
public:
    ...
    QList<QString> getLoggingConfigurationIdentifiers() const;
    void setLoggingConfigurationIdentifiers(const QList<QString> &logging_configuration_identifiers);
    ...
    OAICreateRoom_request_messageReviewHandler getMessageReviewHandler() const;
    void setMessageReviewHandler(const OAICreateRoom_request_messageReviewHandler &message_review_handler);
...
private:
    ...
    QList<QString> m_logging_configuration_identifiers;
    ...
    OAICreateRoom_request_messageReviewHandler m_message_review_handler;
