...
/*
 * OAILoggingConfigurationSummary_destinationConfiguration.h
 *
 * 
 */

#ifndef OAILoggingConfigurationSummary_destinationConfiguration_H
#define OAILoggingConfigurationSummary_destinationConfiguration_H

#include <QJsonObject>

#include "OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs.h"
#include "OAICreateLoggingConfiguration_request_destinationConfiguration_firehose.h"
#include "OAICreateLoggingConfiguration_request_destinationConfiguration_s3.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs;
class OAICreateLoggingConfiguration_request_destinationConfiguration_firehose;
class OAICreateLoggingConfiguration_request_destinationConfiguration_s3;

class OAILoggingConfigurationSummary_destinationConfiguration : public OAIObject {
public:
    OAILoggingConfigurationSummary_destinationConfiguration();
    OAILoggingConfigurationSummary_destinationConfiguration(QString json);
    ~OAILoggingConfigurationSummary_destinationConfiguration() override;
    ...
    OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs getCloudWatchLogs() const;
    void setCloudWatchLogs(const OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs &cloud_watch_logs);
    bool is_cloud_watch_logs_Set() const;
    bool is_cloud_watch_logs_Valid() const;

    OAICreateLoggingConfiguration_request_destinationConfiguration_firehose getFirehose() const;
    void setFirehose(const OAICreateLoggingConfiguration_request_destinationConfiguration_firehose &firehose);
    bool is_firehose_Set() const;
    bool is_firehose_Valid() const;

    OAICreateLoggingConfiguration_request_destinationConfiguration_s3 getS3() const;
    void setS3(const OAICreateLoggingConfiguration_request_destinationConfiguration_s3 &s3);
...
private:
    ...
    OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs m_cloud_watch_logs;
    bool m_cloud_watch_logs_isSet;
    bool m_cloud_watch_logs_isValid;

    OAICreateLoggingConfiguration_request_destinationConfiguration_firehose m_firehose;
    bool m_firehose_isSet;
    bool m_firehose_isValid;

    OAICreateLoggingConfiguration_request_destinationConfiguration_s3 m_s3;
    bool m_s3_isSet;
    bool m_s3_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAILoggingConfigurationSummary_destinationConfiguration)

#endif // OAILoggingConfigurationSummary_destinationConfiguration_H
