...
/*
 * OAICreateRoomResponse_messageReviewHandler.h
 *
 * 
 */

#ifndef OAICreateRoomResponse_messageReviewHandler_H
#define OAICreateRoomResponse_messageReviewHandler_H
...
class OAICreateRoomResponse_messageReviewHandler : public OAIObject {
public:
    OAICreateRoomResponse_messageReviewHandler();
    OAICreateRoomResponse_messageReviewHandler(QString json);
    ~OAICreateRoomResponse_messageReviewHandler() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRoomResponse_messageReviewHandler)

#endif // OAICreateRoomResponse_messageReviewHandler_H
