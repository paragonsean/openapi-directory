...
OAICreateRoom_request_messageReviewHandler::OAICreateRoom_request_messageReviewHandler(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRoom_request_messageReviewHandler::OAICreateRoom_request_messageReviewHandler() {
    this->initializeModel();
}

OAICreateRoom_request_messageReviewHandler::~OAICreateRoom_request_messageReviewHandler() {}

void OAICreateRoom_request_messageReviewHandler::initializeModel() {
...
void OAICreateRoom_request_messageReviewHandler::fromJson(QString jsonString) {
...
void OAICreateRoom_request_messageReviewHandler::fromJsonObject(QJsonObject json) {
...
QString OAICreateRoom_request_messageReviewHandler::asJson() const {
...
QJsonObject OAICreateRoom_request_messageReviewHandler::asJsonObject() const {
    QJsonObject obj;
...
OAIFallbackResult OAICreateRoom_request_messageReviewHandler::getFallbackResult() const {
    return m_fallback_result;
}
void OAICreateRoom_request_messageReviewHandler::setFallbackResult(const OAIFallbackResult &fallback_result) {
    m_fallback_result = fallback_result;
    m_fallback_result_isSet = true;
}

bool OAICreateRoom_request_messageReviewHandler::is_fallback_result_Set() const{
    return m_fallback_result_isSet;
}

bool OAICreateRoom_request_messageReviewHandler::is_fallback_result_Valid() const{
    return m_fallback_result_isValid;
}

QString OAICreateRoom_request_messageReviewHandler::getUri() const {
    return m_uri;
}
void OAICreateRoom_request_messageReviewHandler::setUri(const QString &uri) {
    m_uri = uri;
    m_uri_isSet = true;
}

bool OAICreateRoom_request_messageReviewHandler::is_uri_Set() const{
    return m_uri_isSet;
}

bool OAICreateRoom_request_messageReviewHandler::is_uri_Valid() const{
    return m_uri_isValid;
}

bool OAICreateRoom_request_messageReviewHandler::isSet() const {
...
bool OAICreateRoom_request_messageReviewHandler::isValid() const {
