...
#include "OAICreateLoggingConfigurationRequest_destinationConfiguration.h"
...
OAICreateLoggingConfigurationRequest_destinationConfiguration::OAICreateLoggingConfigurationRequest_destinationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLoggingConfigurationRequest_destinationConfiguration::OAICreateLoggingConfigurationRequest_destinationConfiguration() {
    this->initializeModel();
}

OAICreateLoggingConfigurationRequest_destinationConfiguration::~OAICreateLoggingConfigurationRequest_destinationConfiguration() {}

void OAICreateLoggingConfigurationRequest_destinationConfiguration::initializeModel() {
...
void OAICreateLoggingConfigurationRequest_destinationConfiguration::fromJson(QString jsonString) {
...
void OAICreateLoggingConfigurationRequest_destinationConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateLoggingConfigurationRequest_destinationConfiguration::asJson() const {
...
QJsonObject OAICreateLoggingConfigurationRequest_destinationConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs OAICreateLoggingConfigurationRequest_destinationConfiguration::getCloudWatchLogs() const {
    return m_cloud_watch_logs;
}
void OAICreateLoggingConfigurationRequest_destinationConfiguration::setCloudWatchLogs(const OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs &cloud_watch_logs) {
    m_cloud_watch_logs = cloud_watch_logs;
    m_cloud_watch_logs_isSet = true;
}

bool OAICreateLoggingConfigurationRequest_destinationConfiguration::is_cloud_watch_logs_Set() const{
    return m_cloud_watch_logs_isSet;
}

bool OAICreateLoggingConfigurationRequest_destinationConfiguration::is_cloud_watch_logs_Valid() const{
    return m_cloud_watch_logs_isValid;
}

OAICreateLoggingConfiguration_request_destinationConfiguration_firehose OAICreateLoggingConfigurationRequest_destinationConfiguration::getFirehose() const {
    return m_firehose;
}
void OAICreateLoggingConfigurationRequest_destinationConfiguration::setFirehose(const OAICreateLoggingConfiguration_request_destinationConfiguration_firehose &firehose) {
    m_firehose = firehose;
    m_firehose_isSet = true;
}

bool OAICreateLoggingConfigurationRequest_destinationConfiguration::is_firehose_Set() const{
    return m_firehose_isSet;
}

bool OAICreateLoggingConfigurationRequest_destinationConfiguration::is_firehose_Valid() const{
    return m_firehose_isValid;
}

OAICreateLoggingConfiguration_request_destinationConfiguration_s3 OAICreateLoggingConfigurationRequest_destinationConfiguration::getS3() const {
    return m_s3;
}
void OAICreateLoggingConfigurationRequest_destinationConfiguration::setS3(const OAICreateLoggingConfiguration_request_destinationConfiguration_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAICreateLoggingConfigurationRequest_destinationConfiguration::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAICreateLoggingConfigurationRequest_destinationConfiguration::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAICreateLoggingConfigurationRequest_destinationConfiguration::isSet() const {
...
bool OAICreateLoggingConfigurationRequest_destinationConfiguration::isValid() const {
