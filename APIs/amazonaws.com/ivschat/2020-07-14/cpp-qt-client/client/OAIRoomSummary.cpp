...
OAIRoomSummary::OAIRoomSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRoomSummary::OAIRoomSummary() {
    this->initializeModel();
}

OAIRoomSummary::~OAIRoomSummary() {}

void OAIRoomSummary::initializeModel() {
...
void OAIRoomSummary::fromJson(QString jsonString) {
...
void OAIRoomSummary::fromJsonObject(QJsonObject json) {
...
QString OAIRoomSummary::asJson() const {
...
QJsonObject OAIRoomSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIRoomSummary::getArn() const {
    return m_arn;
}
void OAIRoomSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIRoomSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIRoomSummary::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIRoomSummary::getCreateTime() const {
    return m_create_time;
}
void OAIRoomSummary::setCreateTime(const QDateTime &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAIRoomSummary::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAIRoomSummary::is_create_time_Valid() const{
    return m_create_time_isValid;
}

QString OAIRoomSummary::getId() const {
    return m_id;
}
void OAIRoomSummary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRoomSummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRoomSummary::is_id_Valid() const{
    return m_id_isValid;
}

QList OAIRoomSummary::getLoggingConfigurationIdentifiers() const {
    return m_logging_configuration_identifiers;
}
void OAIRoomSummary::setLoggingConfigurationIdentifiers(const QList &logging_configuration_identifiers) {
    m_logging_configuration_identifiers = logging_configuration_identifiers;
    m_logging_configuration_identifiers_isSet = true;
}

bool OAIRoomSummary::is_logging_configuration_identifiers_Set() const{
    return m_logging_configuration_identifiers_isSet;
}

bool OAIRoomSummary::is_logging_configuration_identifiers_Valid() const{
    return m_logging_configuration_identifiers_isValid;
}

OAICreateRoomResponse_messageReviewHandler OAIRoomSummary::getMessageReviewHandler() const {
    return m_message_review_handler;
}
void OAIRoomSummary::setMessageReviewHandler(const OAICreateRoomResponse_messageReviewHandler &message_review_handler) {
    m_message_review_handler = message_review_handler;
    m_message_review_handler_isSet = true;
}

bool OAIRoomSummary::is_message_review_handler_Set() const{
    return m_message_review_handler_isSet;
}

bool OAIRoomSummary::is_message_review_handler_Valid() const{
    return m_message_review_handler_isValid;
}

QString OAIRoomSummary::getName() const {
    return m_name;
}
void OAIRoomSummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRoomSummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRoomSummary::is_name_Valid() const{
    return m_name_isValid;
}

QMap OAIRoomSummary::getTags() const {
    return m_tags;
}
void OAIRoomSummary::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIRoomSummary::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIRoomSummary::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAIRoomSummary::getUpdateTime() const {
    return m_update_time;
}
void OAIRoomSummary::setUpdateTime(const QDateTime &update_time) {
    m_update_time = update_time;
    m_update_time_isSet = true;
}

bool OAIRoomSummary::is_update_time_Set() const{
    return m_update_time_isSet;
}

bool OAIRoomSummary::is_update_time_Valid() const{
    return m_update_time_isValid;
}

bool OAIRoomSummary::isSet() const {
...
bool OAIRoomSummary::isValid() const {
