...
/*
 * OAIUpdateRoomRequest_messageReviewHandler.h
 *
 * 
 */

#ifndef OAIUpdateRoomRequest_messageReviewHandler_H
#define OAIUpdateRoomRequest_messageReviewHandler_H
...
class OAIUpdateRoomRequest_messageReviewHandler : public OAIObject {
public:
    OAIUpdateRoomRequest_messageReviewHandler();
    OAIUpdateRoomRequest_messageReviewHandler(QString json);
    ~OAIUpdateRoomRequest_messageReviewHandler() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRoomRequest_messageReviewHandler)

#endif // OAIUpdateRoomRequest_messageReviewHandler_H
