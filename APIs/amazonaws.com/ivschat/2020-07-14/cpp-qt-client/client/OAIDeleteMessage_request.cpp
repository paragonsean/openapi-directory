...
OAIDeleteMessage_request::OAIDeleteMessage_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteMessage_request::OAIDeleteMessage_request() {
    this->initializeModel();
}

OAIDeleteMessage_request::~OAIDeleteMessage_request() {}

void OAIDeleteMessage_request::initializeModel() {
    ...
    m_room_identifier_isSet = false;
    m_room_identifier_isValid = false;
}

void OAIDeleteMessage_request::fromJson(QString jsonString) {
...
void OAIDeleteMessage_request::fromJsonObject(QJsonObject json) {
    ...
    m_room_identifier_isValid = ::OpenAPI::fromJsonValue(m_room_identifier, json[QString("roomIdentifier")]);
    m_room_identifier_isSet = !json[QString("roomIdentifier")].isNull() && m_room_identifier_isValid;
}

QString OAIDeleteMessage_request::asJson() const {
...
QJsonObject OAIDeleteMessage_request::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
    ...
    if (m_room_identifier_isSet) {
        obj.insert(QString("roomIdentifier"), ::OpenAPI::toJsonValue(m_room_identifier));
    }
    return obj;
}

QString OAIDeleteMessage_request::getId() const {
    return m_id;
}
void OAIDeleteMessage_request::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDeleteMessage_request::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDeleteMessage_request::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDeleteMessage_request::getReason() const {
    return m_reason;
}
void OAIDeleteMessage_request::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIDeleteMessage_request::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIDeleteMessage_request::is_reason_Valid() const{
    return m_reason_isValid;
}

QString OAIDeleteMessage_request::getRoomIdentifier() const {
    return m_room_identifier;
}
void OAIDeleteMessage_request::setRoomIdentifier(const QString &room_identifier) {
    m_room_identifier = room_identifier;
    m_room_identifier_isSet = true;
}

bool OAIDeleteMessage_request::is_room_identifier_Set() const{
    return m_room_identifier_isSet;
}

bool OAIDeleteMessage_request::is_room_identifier_Valid() const{
    return m_room_identifier_isValid;
}

bool OAIDeleteMessage_request::isSet() const {
...
bool OAIDeleteMessage_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_id_isValid && m_room_identifier_isValid && true;
}
