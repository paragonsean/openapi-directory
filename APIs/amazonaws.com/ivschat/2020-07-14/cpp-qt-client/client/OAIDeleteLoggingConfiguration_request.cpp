...
OAIDeleteLoggingConfiguration_request::OAIDeleteLoggingConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteLoggingConfiguration_request::OAIDeleteLoggingConfiguration_request() {
    this->initializeModel();
}

OAIDeleteLoggingConfiguration_request::~OAIDeleteLoggingConfiguration_request() {}

void OAIDeleteLoggingConfiguration_request::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIDeleteLoggingConfiguration_request::fromJson(QString jsonString) {
...
void OAIDeleteLoggingConfiguration_request::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("identifier")]);
    m_identifier_isSet = !json[QString("identifier")].isNull() && m_identifier_isValid;
}

QString OAIDeleteLoggingConfiguration_request::asJson() const {
...
QJsonObject OAIDeleteLoggingConfiguration_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteLoggingConfiguration_request::getIdentifier() const {
    return m_identifier;
}
void OAIDeleteLoggingConfiguration_request::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIDeleteLoggingConfiguration_request::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIDeleteLoggingConfiguration_request::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIDeleteLoggingConfiguration_request::isSet() const {
...
bool OAIDeleteLoggingConfiguration_request::isValid() const {
