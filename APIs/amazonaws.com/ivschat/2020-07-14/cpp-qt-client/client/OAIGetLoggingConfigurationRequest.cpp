...
OAIGetLoggingConfigurationRequest::OAIGetLoggingConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLoggingConfigurationRequest::OAIGetLoggingConfigurationRequest() {
    this->initializeModel();
}

OAIGetLoggingConfigurationRequest::~OAIGetLoggingConfigurationRequest() {}

void OAIGetLoggingConfigurationRequest::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIGetLoggingConfigurationRequest::fromJson(QString jsonString) {
...
void OAIGetLoggingConfigurationRequest::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("identifier")]);
    m_identifier_isSet = !json[QString("identifier")].isNull() && m_identifier_isValid;
}

QString OAIGetLoggingConfigurationRequest::asJson() const {
...
QJsonObject OAIGetLoggingConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetLoggingConfigurationRequest::getIdentifier() const {
    return m_identifier;
}
void OAIGetLoggingConfigurationRequest::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIGetLoggingConfigurationRequest::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIGetLoggingConfigurationRequest::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIGetLoggingConfigurationRequest::isSet() const {
...
bool OAIGetLoggingConfigurationRequest::isValid() const {
