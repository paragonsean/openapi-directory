...
QMap<QString, QString> OAISendEvent_request::getAttributes() const {
    return m_attributes;
}
void OAISendEvent_request::setAttributes(const QMap<QString, QString> &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAISendEvent_request::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAISendEvent_request::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAISendEvent_request::getEventName() const {
    return m_event_name;
}
void OAISendEvent_request::setEventName(const QString &event_name) {
    m_event_name = event_name;
    m_event_name_isSet = true;
}

bool OAISendEvent_request::is_event_name_Set() const{
    return m_event_name_isSet;
}

bool OAISendEvent_request::is_event_name_Valid() const{
    return m_event_name_isValid;
}

QString OAISendEvent_request::getRoomIdentifier() const {
    return m_room_identifier;
}
void OAISendEvent_request::setRoomIdentifier(const QString &room_identifier) {
    m_room_identifier = room_identifier;
    m_room_identifier_isSet = true;
}

bool OAISendEvent_request::is_room_identifier_Set() const{
    return m_room_identifier_isSet;
}

bool OAISendEvent_request::is_room_identifier_Valid() const{
