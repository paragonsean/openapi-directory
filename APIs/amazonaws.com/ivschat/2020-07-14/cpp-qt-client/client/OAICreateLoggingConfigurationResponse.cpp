...
QString OAICreateLoggingConfigurationResponse::getArn() const {
    return m_arn;
}
void OAICreateLoggingConfigurationResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateLoggingConfigurationResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateLoggingConfigurationResponse::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAICreateLoggingConfigurationResponse::getCreateTime() const {
    return m_create_time;
}
void OAICreateLoggingConfigurationResponse::setCreateTime(const QDateTime &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAICreateLoggingConfigurationResponse::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAICreateLoggingConfigurationResponse::is_create_time_Valid() const{
    return m_create_time_isValid;
}

OAICreateLoggingConfigurationResponse_destinationConfiguration OAICreateLoggingConfigurationResponse::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAICreateLoggingConfigurationResponse::setDestinationConfiguration(const OAICreateLoggingConfigurationResponse_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAICreateLoggingConfigurationResponse::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAICreateLoggingConfigurationResponse::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAICreateLoggingConfigurationResponse::getId() const {
    return m_id;
}
void OAICreateLoggingConfigurationResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreateLoggingConfigurationResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreateLoggingConfigurationResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICreateLoggingConfigurationResponse::getName() const {
    return m_name;
}
void OAICreateLoggingConfigurationResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateLoggingConfigurationResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateLoggingConfigurationResponse::is_name_Valid() const{
    return m_name_isValid;
}

OAICreateLoggingConfigurationState OAICreateLoggingConfigurationResponse::getState() const {
    return m_state;
}
void OAICreateLoggingConfigurationResponse::setState(const OAICreateLoggingConfigurationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAICreateLoggingConfigurationResponse::is_state_Set() const{
    return m_state_isSet;
}

bool OAICreateLoggingConfigurationResponse::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAICreateLoggingConfigurationResponse::getTags() const {
    return m_tags;
}
void OAICreateLoggingConfigurationResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateLoggingConfigurationResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateLoggingConfigurationResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAICreateLoggingConfigurationResponse::getUpdateTime() const {
    return m_update_time;
}
void OAICreateLoggingConfigurationResponse::setUpdateTime(const QDateTime &update_time) {
    m_update_time = update_time;
    m_update_time_isSet = true;
}

bool OAICreateLoggingConfigurationResponse::is_update_time_Set() const{
    return m_update_time_isSet;
}

bool OAICreateLoggingConfigurationResponse::is_update_time_Valid() const{
