...
/*
 * OAICreateRoom_request_messageReviewHandler.h
 *
 * Configuration information for optional message review.
 */

#ifndef OAICreateRoom_request_messageReviewHandler_H
#define OAICreateRoom_request_messageReviewHandler_H
...
class OAICreateRoom_request_messageReviewHandler : public OAIObject {
public:
    OAICreateRoom_request_messageReviewHandler();
    OAICreateRoom_request_messageReviewHandler(QString json);
    ~OAICreateRoom_request_messageReviewHandler() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRoom_request_messageReviewHandler)

#endif // OAICreateRoom_request_messageReviewHandler_H
