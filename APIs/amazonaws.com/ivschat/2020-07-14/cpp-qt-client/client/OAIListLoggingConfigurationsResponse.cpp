...
QString OAIListLoggingConfigurationsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListLoggingConfigurationsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListLoggingConfigurationsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListLoggingConfigurationsResponse::is_next_token_Valid() const{
...
bool OAIListLoggingConfigurationsResponse::isValid() const {
    ...
    return m_logging_configurations_isValid && true;
}
