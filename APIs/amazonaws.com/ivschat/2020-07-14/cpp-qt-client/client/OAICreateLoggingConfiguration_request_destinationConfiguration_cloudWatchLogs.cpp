...
OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs() {
    this->initializeModel();
}

OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::~OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs() {}

void OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::initializeModel() {

    m_log_group_name_isSet = false;
    m_log_group_name_isValid = false;
}

void OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::fromJson(QString jsonString) {
...
void OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::fromJsonObject(QJsonObject json) {
...
QString OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::asJson() const {
...
QJsonObject OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::getLogGroupName() const {
    return m_log_group_name;
}
void OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::setLogGroupName(const QString &log_group_name) {
    m_log_group_name = log_group_name;
    m_log_group_name_isSet = true;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::is_log_group_name_Set() const{
    return m_log_group_name_isSet;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::is_log_group_name_Valid() const{
    return m_log_group_name_isValid;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::isSet() const {
...
bool OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs::isValid() const {
