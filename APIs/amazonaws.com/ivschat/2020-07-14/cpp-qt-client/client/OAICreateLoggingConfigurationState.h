...
/*
 * OAICreateLoggingConfigurationState.h
 *
 * 
 */

#ifndef OAICreateLoggingConfigurationState_H
#define OAICreateLoggingConfigurationState_H
...
class OAICreateLoggingConfigurationState : public OAIEnum {
public:
    OAICreateLoggingConfigurationState();
    OAICreateLoggingConfigurationState(QString json);
    ~OAICreateLoggingConfigurationState() override;
    ...
    enum class eOAICreateLoggingConfigurationState {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE
    };
    OAICreateLoggingConfigurationState::eOAICreateLoggingConfigurationState getValue() const;
    void setValue(const OAICreateLoggingConfigurationState::eOAICreateLoggingConfigurationState& value);
...
private:
    ...
    eOAICreateLoggingConfigurationState m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLoggingConfigurationState)

#endif // OAICreateLoggingConfigurationState_H
