...
/*
 * OAIDisconnectUser_request.h
 *
 * 
 */

#ifndef OAIDisconnectUser_request_H
#define OAIDisconnectUser_request_H
...
class OAIDisconnectUser_request : public OAIObject {
public:
    OAIDisconnectUser_request();
    OAIDisconnectUser_request(QString json);
    ~OAIDisconnectUser_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisconnectUser_request)

#endif // OAIDisconnectUser_request_H
