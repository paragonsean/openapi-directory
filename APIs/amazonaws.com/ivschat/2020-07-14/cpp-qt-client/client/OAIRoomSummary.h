...
#ifndef OAIRoomSummary_H
#define OAIRoomSummary_H
...
class OAIRoomSummary : public OAIObject {
public:
    OAIRoomSummary();
    OAIRoomSummary(QString json);
    ~OAIRoomSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoomSummary)

#endif // OAIRoomSummary_H
