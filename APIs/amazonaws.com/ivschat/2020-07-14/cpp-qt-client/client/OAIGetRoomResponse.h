...
/*
 * OAIGetRoomResponse.h
 *
 * 
 */

#ifndef OAIGetRoomResponse_H
#define OAIGetRoomResponse_H
...
class OAIGetRoomResponse : public OAIObject {
public:
    OAIGetRoomResponse();
    OAIGetRoomResponse(QString json);
    ~OAIGetRoomResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRoomResponse)

#endif // OAIGetRoomResponse_H
