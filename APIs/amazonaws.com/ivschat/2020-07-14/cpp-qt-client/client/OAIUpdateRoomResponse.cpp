...
OAIUpdateRoomResponse::OAIUpdateRoomResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRoomResponse::OAIUpdateRoomResponse() {
    this->initializeModel();
}

OAIUpdateRoomResponse::~OAIUpdateRoomResponse() {}

void OAIUpdateRoomResponse::initializeModel() {
...
void OAIUpdateRoomResponse::fromJson(QString jsonString) {
...
void OAIUpdateRoomResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRoomResponse::asJson() const {
...
QJsonObject OAIUpdateRoomResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIUpdateRoomResponse::getArn() const {
    return m_arn;
}
void OAIUpdateRoomResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateRoomResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateRoomResponse::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIUpdateRoomResponse::getCreateTime() const {
    return m_create_time;
}
void OAIUpdateRoomResponse::setCreateTime(const QDateTime &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAIUpdateRoomResponse::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAIUpdateRoomResponse::is_create_time_Valid() const{
    return m_create_time_isValid;
}

QString OAIUpdateRoomResponse::getId() const {
    return m_id;
}
void OAIUpdateRoomResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUpdateRoomResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUpdateRoomResponse::is_id_Valid() const{
    return m_id_isValid;
}

QList OAIUpdateRoomResponse::getLoggingConfigurationIdentifiers() const {
    return m_logging_configuration_identifiers;
}
void OAIUpdateRoomResponse::setLoggingConfigurationIdentifiers(const QList &logging_configuration_identifiers) {
    m_logging_configuration_identifiers = logging_configuration_identifiers;
    m_logging_configuration_identifiers_isSet = true;
}

bool OAIUpdateRoomResponse::is_logging_configuration_identifiers_Set() const{
    return m_logging_configuration_identifiers_isSet;
}

bool OAIUpdateRoomResponse::is_logging_configuration_identifiers_Valid() const{
    return m_logging_configuration_identifiers_isValid;
}

qint32 OAIUpdateRoomResponse::getMaximumMessageLength() const {
    return m_maximum_message_length;
}
void OAIUpdateRoomResponse::setMaximumMessageLength(const qint32 &maximum_message_length) {
    m_maximum_message_length = maximum_message_length;
    m_maximum_message_length_isSet = true;
}

bool OAIUpdateRoomResponse::is_maximum_message_length_Set() const{
    return m_maximum_message_length_isSet;
}

bool OAIUpdateRoomResponse::is_maximum_message_length_Valid() const{
    return m_maximum_message_length_isValid;
}

qint32 OAIUpdateRoomResponse::getMaximumMessageRatePerSecond() const {
    return m_maximum_message_rate_per_second;
}
void OAIUpdateRoomResponse::setMaximumMessageRatePerSecond(const qint32 &maximum_message_rate_per_second) {
    m_maximum_message_rate_per_second = maximum_message_rate_per_second;
    m_maximum_message_rate_per_second_isSet = true;
}

bool OAIUpdateRoomResponse::is_maximum_message_rate_per_second_Set() const{
    return m_maximum_message_rate_per_second_isSet;
}

bool OAIUpdateRoomResponse::is_maximum_message_rate_per_second_Valid() const{
    return m_maximum_message_rate_per_second_isValid;
}

OAICreateRoomResponse_messageReviewHandler OAIUpdateRoomResponse::getMessageReviewHandler() const {
    return m_message_review_handler;
}
void OAIUpdateRoomResponse::setMessageReviewHandler(const OAICreateRoomResponse_messageReviewHandler &message_review_handler) {
    m_message_review_handler = message_review_handler;
    m_message_review_handler_isSet = true;
}

bool OAIUpdateRoomResponse::is_message_review_handler_Set() const{
    return m_message_review_handler_isSet;
}

bool OAIUpdateRoomResponse::is_message_review_handler_Valid() const{
    return m_message_review_handler_isValid;
}

QString OAIUpdateRoomResponse::getName() const {
    return m_name;
}
void OAIUpdateRoomResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateRoomResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateRoomResponse::is_name_Valid() const{
    return m_name_isValid;
}

QMap OAIUpdateRoomResponse::getTags() const {
    return m_tags;
}
void OAIUpdateRoomResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUpdateRoomResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUpdateRoomResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAIUpdateRoomResponse::getUpdateTime() const {
    return m_update_time;
}
void OAIUpdateRoomResponse::setUpdateTime(const QDateTime &update_time) {
    m_update_time = update_time;
    m_update_time_isSet = true;
}

bool OAIUpdateRoomResponse::is_update_time_Set() const{
    return m_update_time_isSet;
}

bool OAIUpdateRoomResponse::is_update_time_Valid() const{
    return m_update_time_isValid;
}

bool OAIUpdateRoomResponse::isSet() const {
...
bool OAIUpdateRoomResponse::isValid() const {
