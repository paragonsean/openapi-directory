...
OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs OAIDestinationConfiguration::getCloudWatchLogs() const {
    return m_cloud_watch_logs;
}
void OAIDestinationConfiguration::setCloudWatchLogs(const OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs &cloud_watch_logs) {
    m_cloud_watch_logs = cloud_watch_logs;
    m_cloud_watch_logs_isSet = true;
}

bool OAIDestinationConfiguration::is_cloud_watch_logs_Set() const{
    return m_cloud_watch_logs_isSet;
}

bool OAIDestinationConfiguration::is_cloud_watch_logs_Valid() const{
    return m_cloud_watch_logs_isValid;
}

OAICreateLoggingConfiguration_request_destinationConfiguration_firehose OAIDestinationConfiguration::getFirehose() const {
    return m_firehose;
}
void OAIDestinationConfiguration::setFirehose(const OAICreateLoggingConfiguration_request_destinationConfiguration_firehose &firehose) {
    m_firehose = firehose;
    m_firehose_isSet = true;
}

bool OAIDestinationConfiguration::is_firehose_Set() const{
    return m_firehose_isSet;
}

bool OAIDestinationConfiguration::is_firehose_Valid() const{
    return m_firehose_isValid;
}

OAICreateLoggingConfiguration_request_destinationConfiguration_s3 OAIDestinationConfiguration::getS3() const {
    return m_s3;
}
void OAIDestinationConfiguration::setS3(const OAICreateLoggingConfiguration_request_destinationConfiguration_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}
