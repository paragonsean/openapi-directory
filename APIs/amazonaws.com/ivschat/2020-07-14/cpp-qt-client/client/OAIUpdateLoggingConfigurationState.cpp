...
OAIUpdateLoggingConfigurationState::OAIUpdateLoggingConfigurationState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateLoggingConfigurationState::OAIUpdateLoggingConfigurationState() {
    this->initializeModel();
}

OAIUpdateLoggingConfigurationState::~OAIUpdateLoggingConfigurationState() {}

void OAIUpdateLoggingConfigurationState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIUpdateLoggingConfigurationState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIUpdateLoggingConfigurationState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUpdateLoggingConfigurationState::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIUpdateLoggingConfigurationState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIUpdateLoggingConfigurationState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIUpdateLoggingConfigurationState::ACTIVE:
            val = "ACTIVE";
            break;
        default:
            break;
...
QJsonValue OAIUpdateLoggingConfigurationState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIUpdateLoggingConfigurationState::eOAIUpdateLoggingConfigurationState OAIUpdateLoggingConfigurationState::getValue() const {
    return m_value;
}

void OAIUpdateLoggingConfigurationState::setValue(const OAIUpdateLoggingConfigurationState::eOAIUpdateLoggingConfigurationState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIUpdateLoggingConfigurationState::isSet() const {
    
    return m_value_isSet;
}

bool OAIUpdateLoggingConfigurationState::isValid() const {
