...
/*
 * OAICreateLoggingConfiguration_request_destinationConfiguration.h
 *
...
#ifndef OAICreateLoggingConfiguration_request_destinationConfiguration_H
#define OAICreateLoggingConfiguration_request_destinationConfiguration_H
...
class OAICreateLoggingConfiguration_request_destinationConfiguration : public OAIObject {
public:
    OAICreateLoggingConfiguration_request_destinationConfiguration();
    OAICreateLoggingConfiguration_request_destinationConfiguration(QString json);
    ~OAICreateLoggingConfiguration_request_destinationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLoggingConfiguration_request_destinationConfiguration)

#endif // OAICreateLoggingConfiguration_request_destinationConfiguration_H
