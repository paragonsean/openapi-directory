...
QList OAICreateRoomRequest::getLoggingConfigurationIdentifiers() const {
    return m_logging_configuration_identifiers;
}
void OAICreateRoomRequest::setLoggingConfigurationIdentifiers(const QList &logging_configuration_identifiers) {
    m_logging_configuration_identifiers = logging_configuration_identifiers;
    m_logging_configuration_identifiers_isSet = true;
}

bool OAICreateRoomRequest::is_logging_configuration_identifiers_Set() const{
    return m_logging_configuration_identifiers_isSet;
}

bool OAICreateRoomRequest::is_logging_configuration_identifiers_Valid() const{
    return m_logging_configuration_identifiers_isValid;
}

qint32 OAICreateRoomRequest::getMaximumMessageLength() const {
    return m_maximum_message_length;
}
void OAICreateRoomRequest::setMaximumMessageLength(const qint32 &maximum_message_length) {
    m_maximum_message_length = maximum_message_length;
    m_maximum_message_length_isSet = true;
}

bool OAICreateRoomRequest::is_maximum_message_length_Set() const{
    return m_maximum_message_length_isSet;
}

bool OAICreateRoomRequest::is_maximum_message_length_Valid() const{
    return m_maximum_message_length_isValid;
}

qint32 OAICreateRoomRequest::getMaximumMessageRatePerSecond() const {
    return m_maximum_message_rate_per_second;
}
void OAICreateRoomRequest::setMaximumMessageRatePerSecond(const qint32 &maximum_message_rate_per_second) {
    m_maximum_message_rate_per_second = maximum_message_rate_per_second;
    m_maximum_message_rate_per_second_isSet = true;
}

bool OAICreateRoomRequest::is_maximum_message_rate_per_second_Set() const{
    return m_maximum_message_rate_per_second_isSet;
}

bool OAICreateRoomRequest::is_maximum_message_rate_per_second_Valid() const{
    return m_maximum_message_rate_per_second_isValid;
}

OAICreateRoomResponse_messageReviewHandler OAICreateRoomRequest::getMessageReviewHandler() const {
    return m_message_review_handler;
}
void OAICreateRoomRequest::setMessageReviewHandler(const OAICreateRoomResponse_messageReviewHandler &message_review_handler) {
    m_message_review_handler = message_review_handler;
    m_message_review_handler_isSet = true;
}

bool OAICreateRoomRequest::is_message_review_handler_Set() const{
    return m_message_review_handler_isSet;
}

bool OAICreateRoomRequest::is_message_review_handler_Valid() const{
...
QMap OAICreateRoomRequest::getTags() const {
    return m_tags;
}
void OAICreateRoomRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateRoomRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateRoomRequest::is_tags_Valid() const{
