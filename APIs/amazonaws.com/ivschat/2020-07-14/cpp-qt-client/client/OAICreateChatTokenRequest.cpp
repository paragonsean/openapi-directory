...
#include "OAICreateChatTokenRequest.h"
...
OAICreateChatTokenRequest::OAICreateChatTokenRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateChatTokenRequest::OAICreateChatTokenRequest() {
    this->initializeModel();
}

OAICreateChatTokenRequest::~OAICreateChatTokenRequest() {}

void OAICreateChatTokenRequest::initializeModel() {
...
void OAICreateChatTokenRequest::fromJson(QString jsonString) {
...
void OAICreateChatTokenRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateChatTokenRequest::asJson() const {
...
QJsonObject OAICreateChatTokenRequest::asJsonObject() const {
    QJsonObject obj;
...
QMap OAICreateChatTokenRequest::getAttributes() const {
    return m_attributes;
}
void OAICreateChatTokenRequest::setAttributes(const QMap &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAICreateChatTokenRequest::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAICreateChatTokenRequest::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QList OAICreateChatTokenRequest::getCapabilities() const {
    return m_capabilities;
}
void OAICreateChatTokenRequest::setCapabilities(const QList &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAICreateChatTokenRequest::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAICreateChatTokenRequest::is_capabilities_Valid() const{
    return m_capabilities_isValid;
}

QString OAICreateChatTokenRequest::getRoomIdentifier() const {
    return m_room_identifier;
}
void OAICreateChatTokenRequest::setRoomIdentifier(const QString &room_identifier) {
    m_room_identifier = room_identifier;
    m_room_identifier_isSet = true;
}

bool OAICreateChatTokenRequest::is_room_identifier_Set() const{
    return m_room_identifier_isSet;
}

bool OAICreateChatTokenRequest::is_room_identifier_Valid() const{
    return m_room_identifier_isValid;
}

qint32 OAICreateChatTokenRequest::getSessionDurationInMinutes() const {
    return m_session_duration_in_minutes;
}
void OAICreateChatTokenRequest::setSessionDurationInMinutes(const qint32 &session_duration_in_minutes) {
    m_session_duration_in_minutes = session_duration_in_minutes;
    m_session_duration_in_minutes_isSet = true;
}

bool OAICreateChatTokenRequest::is_session_duration_in_minutes_Set() const{
    return m_session_duration_in_minutes_isSet;
}

bool OAICreateChatTokenRequest::is_session_duration_in_minutes_Valid() const{
    return m_session_duration_in_minutes_isValid;
}

QString OAICreateChatTokenRequest::getUserId() const {
    return m_user_id;
}
void OAICreateChatTokenRequest::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAICreateChatTokenRequest::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAICreateChatTokenRequest::is_user_id_Valid() const{
    return m_user_id_isValid;
}

bool OAICreateChatTokenRequest::isSet() const {
...
bool OAICreateChatTokenRequest::isValid() const {
