...
/*
 * OAIGetLoggingConfigurationResponse_destinationConfiguration.h
 *
 * 
 */

#ifndef OAIGetLoggingConfigurationResponse_destinationConfiguration_H
#define OAIGetLoggingConfigurationResponse_destinationConfiguration_H
...
class OAIGetLoggingConfigurationResponse_destinationConfiguration : public OAIObject {
public:
    OAIGetLoggingConfigurationResponse_destinationConfiguration();
    OAIGetLoggingConfigurationResponse_destinationConfiguration(QString json);
    ~OAIGetLoggingConfigurationResponse_destinationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLoggingConfigurationResponse_destinationConfiguration)

#endif // OAIGetLoggingConfigurationResponse_destinationConfiguration_H
