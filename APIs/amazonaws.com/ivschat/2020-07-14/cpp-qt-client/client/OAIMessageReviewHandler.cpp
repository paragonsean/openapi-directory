...
#include "OAIMessageReviewHandler.h"
...
OAIMessageReviewHandler::OAIMessageReviewHandler(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMessageReviewHandler::OAIMessageReviewHandler() {
    this->initializeModel();
}

OAIMessageReviewHandler::~OAIMessageReviewHandler() {}

void OAIMessageReviewHandler::initializeModel() {
...
void OAIMessageReviewHandler::fromJson(QString jsonString) {
...
void OAIMessageReviewHandler::fromJsonObject(QJsonObject json) {
...
QString OAIMessageReviewHandler::asJson() const {
...
QJsonObject OAIMessageReviewHandler::asJsonObject() const {
    QJsonObject obj;
...
OAIFallbackResult OAIMessageReviewHandler::getFallbackResult() const {
    return m_fallback_result;
}
void OAIMessageReviewHandler::setFallbackResult(const OAIFallbackResult &fallback_result) {
    m_fallback_result = fallback_result;
    m_fallback_result_isSet = true;
}

bool OAIMessageReviewHandler::is_fallback_result_Set() const{
    return m_fallback_result_isSet;
}

bool OAIMessageReviewHandler::is_fallback_result_Valid() const{
    return m_fallback_result_isValid;
}

QString OAIMessageReviewHandler::getUri() const {
    return m_uri;
}
void OAIMessageReviewHandler::setUri(const QString &uri) {
    m_uri = uri;
    m_uri_isSet = true;
}

bool OAIMessageReviewHandler::is_uri_Set() const{
    return m_uri_isSet;
}

bool OAIMessageReviewHandler::is_uri_Valid() const{
    return m_uri_isValid;
}

bool OAIMessageReviewHandler::isSet() const {
...
bool OAIMessageReviewHandler::isValid() const {
