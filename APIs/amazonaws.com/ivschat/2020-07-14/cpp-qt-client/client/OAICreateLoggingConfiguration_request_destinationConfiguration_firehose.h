...
/*
 * OAICreateLoggingConfiguration_request_destinationConfiguration_firehose.h
 *
 * 
 */

#ifndef OAICreateLoggingConfiguration_request_destinationConfiguration_firehose_H
#define OAICreateLoggingConfiguration_request_destinationConfiguration_firehose_H
...
class OAICreateLoggingConfiguration_request_destinationConfiguration_firehose : public OAIObject {
public:
    OAICreateLoggingConfiguration_request_destinationConfiguration_firehose();
    OAICreateLoggingConfiguration_request_destinationConfiguration_firehose(QString json);
    ~OAICreateLoggingConfiguration_request_destinationConfiguration_firehose() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLoggingConfiguration_request_destinationConfiguration_firehose)

#endif // OAICreateLoggingConfiguration_request_destinationConfiguration_firehose_H
