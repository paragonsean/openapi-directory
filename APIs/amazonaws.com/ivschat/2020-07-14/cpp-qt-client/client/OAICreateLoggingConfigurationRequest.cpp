...
OAICreateLoggingConfigurationRequest_destinationConfiguration OAICreateLoggingConfigurationRequest::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAICreateLoggingConfigurationRequest::setDestinationConfiguration(const OAICreateLoggingConfigurationRequest_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAICreateLoggingConfigurationRequest::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAICreateLoggingConfigurationRequest::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAICreateLoggingConfigurationRequest::getName() const {
    return m_name;
}
void OAICreateLoggingConfigurationRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateLoggingConfigurationRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateLoggingConfigurationRequest::is_name_Valid() const{
    return m_name_isValid;
}

QMap OAICreateLoggingConfigurationRequest::getTags() const {
    return m_tags;
}
void OAICreateLoggingConfigurationRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateLoggingConfigurationRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateLoggingConfigurationRequest::is_tags_Valid() const{
