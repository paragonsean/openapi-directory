...
QMap OAISendEventRequest::getAttributes() const {
    return m_attributes;
}
void OAISendEventRequest::setAttributes(const QMap &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAISendEventRequest::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAISendEventRequest::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAISendEventRequest::getEventName() const {
    return m_event_name;
}
void OAISendEventRequest::setEventName(const QString &event_name) {
    m_event_name = event_name;
    m_event_name_isSet = true;
}

bool OAISendEventRequest::is_event_name_Set() const{
    return m_event_name_isSet;
}

bool OAISendEventRequest::is_event_name_Valid() const{
    return m_event_name_isValid;
}

QString OAISendEventRequest::getRoomIdentifier() const {
    return m_room_identifier;
}
void OAISendEventRequest::setRoomIdentifier(const QString &room_identifier) {
    m_room_identifier = room_identifier;
    m_room_identifier_isSet = true;
}

bool OAISendEventRequest::is_room_identifier_Set() const{
    return m_room_identifier_isSet;
}

bool OAISendEventRequest::is_room_identifier_Valid() const{
...
bool OAISendEventRequest::isValid() const {
    ...
    return m_event_name_isValid && m_room_identifier_isValid && true;
}
