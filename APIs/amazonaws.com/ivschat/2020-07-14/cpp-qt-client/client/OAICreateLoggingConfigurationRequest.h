...
namespace OpenAPI {
class OAICreateLoggingConfigurationRequest_destinationConfiguration;
...
public:
    ...
    OAICreateLoggingConfigurationRequest_destinationConfiguration getDestinationConfiguration() const;
    void setDestinationConfiguration(const OAICreateLoggingConfigurationRequest_destinationConfiguration &destination_configuration);
...
private:
    ...
    OAICreateLoggingConfigurationRequest_destinationConfiguration m_destination_configuration;
