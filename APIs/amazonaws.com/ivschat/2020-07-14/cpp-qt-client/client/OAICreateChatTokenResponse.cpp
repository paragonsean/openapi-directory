...
OAICreateChatTokenResponse::OAICreateChatTokenResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateChatTokenResponse::OAICreateChatTokenResponse() {
    this->initializeModel();
}

OAICreateChatTokenResponse::~OAICreateChatTokenResponse() {}

void OAICreateChatTokenResponse::initializeModel() {

    m_session_expiration_time_isSet = false;
    m_session_expiration_time_isValid = false;

    m_token_isSet = false;
    m_token_isValid = false;

    m_token_expiration_time_isSet = false;
    m_token_expiration_time_isValid = false;
}

void OAICreateChatTokenResponse::fromJson(QString jsonString) {
...
void OAICreateChatTokenResponse::fromJsonObject(QJsonObject json) {

    m_session_expiration_time_isValid = ::OpenAPI::fromJsonValue(m_session_expiration_time, json[QString("sessionExpirationTime")]);
    m_session_expiration_time_isSet = !json[QString("sessionExpirationTime")].isNull() && m_session_expiration_time_isValid;

    m_token_isValid = ::OpenAPI::fromJsonValue(m_token, json[QString("token")]);
    m_token_isSet = !json[QString("token")].isNull() && m_token_isValid;

    m_token_expiration_time_isValid = ::OpenAPI::fromJsonValue(m_token_expiration_time, json[QString("tokenExpirationTime")]);
    m_token_expiration_time_isSet = !json[QString("tokenExpirationTime")].isNull() && m_token_expiration_time_isValid;
}

QString OAICreateChatTokenResponse::asJson() const {
...
QJsonObject OAICreateChatTokenResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_session_expiration_time_isSet) {
        obj.insert(QString("sessionExpirationTime"), ::OpenAPI::toJsonValue(m_session_expiration_time));
    }
    if (m_token_isSet) {
        obj.insert(QString("token"), ::OpenAPI::toJsonValue(m_token));
    }
    if (m_token_expiration_time_isSet) {
        obj.insert(QString("tokenExpirationTime"), ::OpenAPI::toJsonValue(m_token_expiration_time));
    }
    return obj;
}

QDateTime OAICreateChatTokenResponse::getSessionExpirationTime() const {
    return m_session_expiration_time;
}
void OAICreateChatTokenResponse::setSessionExpirationTime(const QDateTime &session_expiration_time) {
    m_session_expiration_time = session_expiration_time;
    m_session_expiration_time_isSet = true;
}

bool OAICreateChatTokenResponse::is_session_expiration_time_Set() const{
    return m_session_expiration_time_isSet;
}

bool OAICreateChatTokenResponse::is_session_expiration_time_Valid() const{
    return m_session_expiration_time_isValid;
}

QString OAICreateChatTokenResponse::getToken() const {
    return m_token;
}
void OAICreateChatTokenResponse::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICreateChatTokenResponse::is_token_Set() const{
    return m_token_isSet;
}

bool OAICreateChatTokenResponse::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAICreateChatTokenResponse::getTokenExpirationTime() const {
    return m_token_expiration_time;
}
void OAICreateChatTokenResponse::setTokenExpirationTime(const QDateTime &token_expiration_time) {
    m_token_expiration_time = token_expiration_time;
    m_token_expiration_time_isSet = true;
}

bool OAICreateChatTokenResponse::is_token_expiration_time_Set() const{
    return m_token_expiration_time_isSet;
}

bool OAICreateChatTokenResponse::is_token_expiration_time_Valid() const{
    return m_token_expiration_time_isValid;
}

bool OAICreateChatTokenResponse::isSet() const {
...
bool OAICreateChatTokenResponse::isValid() const {
