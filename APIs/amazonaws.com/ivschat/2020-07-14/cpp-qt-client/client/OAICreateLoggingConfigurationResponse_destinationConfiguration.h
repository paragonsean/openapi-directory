...
/*
 * OAICreateLoggingConfigurationResponse_destinationConfiguration.h
 *
 * 
 */

#ifndef OAICreateLoggingConfigurationResponse_destinationConfiguration_H
#define OAICreateLoggingConfigurationResponse_destinationConfiguration_H
...
class OAICreateLoggingConfigurationResponse_destinationConfiguration : public OAIObject {
public:
    OAICreateLoggingConfigurationResponse_destinationConfiguration();
    OAICreateLoggingConfigurationResponse_destinationConfiguration(QString json);
    ~OAICreateLoggingConfigurationResponse_destinationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLoggingConfigurationResponse_destinationConfiguration)

#endif // OAICreateLoggingConfigurationResponse_destinationConfiguration_H
