...
#include "OAICreateLoggingConfiguration_request_destinationConfiguration.h"
...
OAICreateLoggingConfiguration_request_destinationConfiguration::OAICreateLoggingConfiguration_request_destinationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLoggingConfiguration_request_destinationConfiguration::OAICreateLoggingConfiguration_request_destinationConfiguration() {
    this->initializeModel();
}

OAICreateLoggingConfiguration_request_destinationConfiguration::~OAICreateLoggingConfiguration_request_destinationConfiguration() {}

void OAICreateLoggingConfiguration_request_destinationConfiguration::initializeModel() {
...
void OAICreateLoggingConfiguration_request_destinationConfiguration::fromJson(QString jsonString) {
...
void OAICreateLoggingConfiguration_request_destinationConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateLoggingConfiguration_request_destinationConfiguration::asJson() const {
...
QJsonObject OAICreateLoggingConfiguration_request_destinationConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs OAICreateLoggingConfiguration_request_destinationConfiguration::getCloudWatchLogs() const {
    return m_cloud_watch_logs;
}
void OAICreateLoggingConfiguration_request_destinationConfiguration::setCloudWatchLogs(const OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs &cloud_watch_logs) {
    m_cloud_watch_logs = cloud_watch_logs;
    m_cloud_watch_logs_isSet = true;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration::is_cloud_watch_logs_Set() const{
    return m_cloud_watch_logs_isSet;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration::is_cloud_watch_logs_Valid() const{
    return m_cloud_watch_logs_isValid;
}

OAICreateLoggingConfiguration_request_destinationConfiguration_firehose OAICreateLoggingConfiguration_request_destinationConfiguration::getFirehose() const {
    return m_firehose;
}
void OAICreateLoggingConfiguration_request_destinationConfiguration::setFirehose(const OAICreateLoggingConfiguration_request_destinationConfiguration_firehose &firehose) {
    m_firehose = firehose;
    m_firehose_isSet = true;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration::is_firehose_Set() const{
    return m_firehose_isSet;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration::is_firehose_Valid() const{
    return m_firehose_isValid;
}

OAICreateLoggingConfiguration_request_destinationConfiguration_s3 OAICreateLoggingConfiguration_request_destinationConfiguration::getS3() const {
    return m_s3;
}
void OAICreateLoggingConfiguration_request_destinationConfiguration::setS3(const OAICreateLoggingConfiguration_request_destinationConfiguration_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration::isSet() const {
...
bool OAICreateLoggingConfiguration_request_destinationConfiguration::isValid() const {
