...
OAICreateLoggingConfigurationRequest_destinationConfiguration OAIUpdateLoggingConfigurationRequest::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAIUpdateLoggingConfigurationRequest::setDestinationConfiguration(const OAICreateLoggingConfigurationRequest_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAIUpdateLoggingConfigurationRequest::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAIUpdateLoggingConfigurationRequest::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAIUpdateLoggingConfigurationRequest::getIdentifier() const {
    return m_identifier;
}
void OAIUpdateLoggingConfigurationRequest::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIUpdateLoggingConfigurationRequest::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIUpdateLoggingConfigurationRequest::is_identifier_Valid() const{
    return m_identifier_isValid;
}

QString OAIUpdateLoggingConfigurationRequest::getName() const {
    return m_name;
}
void OAIUpdateLoggingConfigurationRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateLoggingConfigurationRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateLoggingConfigurationRequest::is_name_Valid() const{
