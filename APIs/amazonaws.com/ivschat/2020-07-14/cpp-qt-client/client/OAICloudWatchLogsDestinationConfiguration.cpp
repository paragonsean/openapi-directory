...
#include "OAICloudWatchLogsDestinationConfiguration.h"
...
OAICloudWatchLogsDestinationConfiguration::OAICloudWatchLogsDestinationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICloudWatchLogsDestinationConfiguration::OAICloudWatchLogsDestinationConfiguration() {
    this->initializeModel();
}

OAICloudWatchLogsDestinationConfiguration::~OAICloudWatchLogsDestinationConfiguration() {}

void OAICloudWatchLogsDestinationConfiguration::initializeModel() {

    m_log_group_name_isSet = false;
    m_log_group_name_isValid = false;
}

void OAICloudWatchLogsDestinationConfiguration::fromJson(QString jsonString) {
...
void OAICloudWatchLogsDestinationConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICloudWatchLogsDestinationConfiguration::asJson() const {
...
QJsonObject OAICloudWatchLogsDestinationConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAICloudWatchLogsDestinationConfiguration::getLogGroupName() const {
    return m_log_group_name;
}
void OAICloudWatchLogsDestinationConfiguration::setLogGroupName(const QString &log_group_name) {
    m_log_group_name = log_group_name;
    m_log_group_name_isSet = true;
}

bool OAICloudWatchLogsDestinationConfiguration::is_log_group_name_Set() const{
    return m_log_group_name_isSet;
}

bool OAICloudWatchLogsDestinationConfiguration::is_log_group_name_Valid() const{
    return m_log_group_name_isValid;
}

bool OAICloudWatchLogsDestinationConfiguration::isSet() const {
...
bool OAICloudWatchLogsDestinationConfiguration::isValid() const {
