...
OAIGetLoggingConfigurationResponse::OAIGetLoggingConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLoggingConfigurationResponse::OAIGetLoggingConfigurationResponse() {
    this->initializeModel();
}

OAIGetLoggingConfigurationResponse::~OAIGetLoggingConfigurationResponse() {}

void OAIGetLoggingConfigurationResponse::initializeModel() {
...
void OAIGetLoggingConfigurationResponse::fromJson(QString jsonString) {
...
void OAIGetLoggingConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetLoggingConfigurationResponse::asJson() const {
...
QJsonObject OAIGetLoggingConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetLoggingConfigurationResponse::getArn() const {
    return m_arn;
}
void OAIGetLoggingConfigurationResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetLoggingConfigurationResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetLoggingConfigurationResponse::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIGetLoggingConfigurationResponse::getCreateTime() const {
    return m_create_time;
}
void OAIGetLoggingConfigurationResponse::setCreateTime(const QDateTime &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAIGetLoggingConfigurationResponse::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAIGetLoggingConfigurationResponse::is_create_time_Valid() const{
    return m_create_time_isValid;
}

OAIGetLoggingConfigurationResponse_destinationConfiguration OAIGetLoggingConfigurationResponse::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAIGetLoggingConfigurationResponse::setDestinationConfiguration(const OAIGetLoggingConfigurationResponse_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAIGetLoggingConfigurationResponse::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAIGetLoggingConfigurationResponse::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAIGetLoggingConfigurationResponse::getId() const {
    return m_id;
}
void OAIGetLoggingConfigurationResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetLoggingConfigurationResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetLoggingConfigurationResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGetLoggingConfigurationResponse::getName() const {
    return m_name;
}
void OAIGetLoggingConfigurationResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetLoggingConfigurationResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetLoggingConfigurationResponse::is_name_Valid() const{
    return m_name_isValid;
}

OAILoggingConfigurationState OAIGetLoggingConfigurationResponse::getState() const {
    return m_state;
}
void OAIGetLoggingConfigurationResponse::setState(const OAILoggingConfigurationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIGetLoggingConfigurationResponse::is_state_Set() const{
    return m_state_isSet;
}

bool OAIGetLoggingConfigurationResponse::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIGetLoggingConfigurationResponse::getTags() const {
    return m_tags;
}
void OAIGetLoggingConfigurationResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetLoggingConfigurationResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetLoggingConfigurationResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAIGetLoggingConfigurationResponse::getUpdateTime() const {
    return m_update_time;
}
void OAIGetLoggingConfigurationResponse::setUpdateTime(const QDateTime &update_time) {
    m_update_time = update_time;
    m_update_time_isSet = true;
}

bool OAIGetLoggingConfigurationResponse::is_update_time_Set() const{
    return m_update_time_isSet;
}

bool OAIGetLoggingConfigurationResponse::is_update_time_Valid() const{
    return m_update_time_isValid;
}

bool OAIGetLoggingConfigurationResponse::isSet() const {
...
bool OAIGetLoggingConfigurationResponse::isValid() const {
