...
OAICreateLoggingConfiguration_request::OAICreateLoggingConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLoggingConfiguration_request::OAICreateLoggingConfiguration_request() {
    this->initializeModel();
}

OAICreateLoggingConfiguration_request::~OAICreateLoggingConfiguration_request() {}

void OAICreateLoggingConfiguration_request::initializeModel() {
...
void OAICreateLoggingConfiguration_request::fromJson(QString jsonString) {
...
void OAICreateLoggingConfiguration_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateLoggingConfiguration_request::asJson() const {
...
QJsonObject OAICreateLoggingConfiguration_request::asJsonObject() const {
    QJsonObject obj;
...
OAICreateLoggingConfiguration_request_destinationConfiguration OAICreateLoggingConfiguration_request::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAICreateLoggingConfiguration_request::setDestinationConfiguration(const OAICreateLoggingConfiguration_request_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAICreateLoggingConfiguration_request::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAICreateLoggingConfiguration_request::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAICreateLoggingConfiguration_request::getName() const {
    return m_name;
}
void OAICreateLoggingConfiguration_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateLoggingConfiguration_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateLoggingConfiguration_request::is_name_Valid() const{
    return m_name_isValid;
}

QMap<QString, QString> OAICreateLoggingConfiguration_request::getTags() const {
    return m_tags;
}
void OAICreateLoggingConfiguration_request::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateLoggingConfiguration_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateLoggingConfiguration_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateLoggingConfiguration_request::isSet() const {
...
bool OAICreateLoggingConfiguration_request::isValid() const {
