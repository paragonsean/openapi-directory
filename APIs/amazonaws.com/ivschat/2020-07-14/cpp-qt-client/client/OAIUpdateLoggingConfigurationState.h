...
/*
 * OAIUpdateLoggingConfigurationState.h
 *
 * 
 */

#ifndef OAIUpdateLoggingConfigurationState_H
#define OAIUpdateLoggingConfigurationState_H
...
class OAIUpdateLoggingConfigurationState : public OAIEnum {
public:
    OAIUpdateLoggingConfigurationState();
    OAIUpdateLoggingConfigurationState(QString json);
    ~OAIUpdateLoggingConfigurationState() override;
    ...
    enum class eOAIUpdateLoggingConfigurationState {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE
    };
    OAIUpdateLoggingConfigurationState::eOAIUpdateLoggingConfigurationState getValue() const;
    void setValue(const OAIUpdateLoggingConfigurationState::eOAIUpdateLoggingConfigurationState& value);
...
private:
    ...
    eOAIUpdateLoggingConfigurationState m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLoggingConfigurationState)

#endif // OAIUpdateLoggingConfigurationState_H
