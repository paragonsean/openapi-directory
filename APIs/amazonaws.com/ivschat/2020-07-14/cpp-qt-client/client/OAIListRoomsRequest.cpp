...
OAIListRoomsRequest::OAIListRoomsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRoomsRequest::OAIListRoomsRequest() {
    this->initializeModel();
}

OAIListRoomsRequest::~OAIListRoomsRequest() {}

void OAIListRoomsRequest::initializeModel() {

    m_logging_configuration_identifier_isSet = false;
    m_logging_configuration_identifier_isValid = false;

    m_max_results_isSet = false;
    m_max_results_isValid = false;

    m_message_review_handler_uri_isSet = false;
    m_message_review_handler_uri_isValid = false;
...
void OAIListRoomsRequest::fromJson(QString jsonString) {
...
void OAIListRoomsRequest::fromJsonObject(QJsonObject json) {

    m_logging_configuration_identifier_isValid = ::OpenAPI::fromJsonValue(m_logging_configuration_identifier, json[QString("loggingConfigurationIdentifier")]);
    m_logging_configuration_identifier_isSet = !json[QString("loggingConfigurationIdentifier")].isNull() && m_logging_configuration_identifier_isValid;

    m_max_results_isValid = ::OpenAPI::fromJsonValue(m_max_results, json[QString("maxResults")]);
    m_max_results_isSet = !json[QString("maxResults")].isNull() && m_max_results_isValid;

    m_message_review_handler_uri_isValid = ::OpenAPI::fromJsonValue(m_message_review_handler_uri, json[QString("messageReviewHandlerUri")]);
    m_message_review_handler_uri_isSet = !json[QString("messageReviewHandlerUri")].isNull() && m_message_review_handler_uri_isValid;
...
QString OAIListRoomsRequest::asJson() const {
...
QJsonObject OAIListRoomsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_logging_configuration_identifier_isSet) {
        obj.insert(QString("loggingConfigurationIdentifier"), ::OpenAPI::toJsonValue(m_logging_configuration_identifier));
    }
    if (m_max_results_isSet) {
        obj.insert(QString("maxResults"), ::OpenAPI::toJsonValue(m_max_results));
    }
    if (m_message_review_handler_uri_isSet) {
        obj.insert(QString("messageReviewHandlerUri"), ::OpenAPI::toJsonValue(m_message_review_handler_uri));
    }
    if (m_name_isSet) {
...
QString OAIListRoomsRequest::getLoggingConfigurationIdentifier() const {
    return m_logging_configuration_identifier;
}
void OAIListRoomsRequest::setLoggingConfigurationIdentifier(const QString &logging_configuration_identifier) {
    m_logging_configuration_identifier = logging_configuration_identifier;
    m_logging_configuration_identifier_isSet = true;
}

bool OAIListRoomsRequest::is_logging_configuration_identifier_Set() const{
    return m_logging_configuration_identifier_isSet;
}

bool OAIListRoomsRequest::is_logging_configuration_identifier_Valid() const{
    return m_logging_configuration_identifier_isValid;
}

qint32 OAIListRoomsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListRoomsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListRoomsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListRoomsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListRoomsRequest::getMessageReviewHandlerUri() const {
    return m_message_review_handler_uri;
}
void OAIListRoomsRequest::setMessageReviewHandlerUri(const QString &message_review_handler_uri) {
    m_message_review_handler_uri = message_review_handler_uri;
    m_message_review_handler_uri_isSet = true;
}

bool OAIListRoomsRequest::is_message_review_handler_uri_Set() const{
    return m_message_review_handler_uri_isSet;
}

bool OAIListRoomsRequest::is_message_review_handler_uri_Valid() const{
    return m_message_review_handler_uri_isValid;
}

QString OAIListRoomsRequest::getName() const {
    return m_name;
}
void OAIListRoomsRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIListRoomsRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIListRoomsRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIListRoomsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListRoomsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListRoomsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListRoomsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListRoomsRequest::isSet() const {
...
bool OAIListRoomsRequest::isValid() const {
