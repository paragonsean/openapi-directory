...
/*
 * OAICreateLoggingConfigurationRequest_destinationConfiguration.h
 *
 * 
 */

#ifndef OAICreateLoggingConfigurationRequest_destinationConfiguration_H
#define OAICreateLoggingConfigurationRequest_destinationConfiguration_H
...
class OAICreateLoggingConfigurationRequest_destinationConfiguration : public OAIObject {
public:
    OAICreateLoggingConfigurationRequest_destinationConfiguration();
    OAICreateLoggingConfigurationRequest_destinationConfiguration(QString json);
    ~OAICreateLoggingConfigurationRequest_destinationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLoggingConfigurationRequest_destinationConfiguration)

#endif // OAICreateLoggingConfigurationRequest_destinationConfiguration_H
