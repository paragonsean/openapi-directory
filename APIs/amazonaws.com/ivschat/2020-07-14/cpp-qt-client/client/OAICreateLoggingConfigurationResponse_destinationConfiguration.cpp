...
OAICreateLoggingConfigurationResponse_destinationConfiguration::OAICreateLoggingConfigurationResponse_destinationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLoggingConfigurationResponse_destinationConfiguration::OAICreateLoggingConfigurationResponse_destinationConfiguration() {
    this->initializeModel();
}

OAICreateLoggingConfigurationResponse_destinationConfiguration::~OAICreateLoggingConfigurationResponse_destinationConfiguration() {}

void OAICreateLoggingConfigurationResponse_destinationConfiguration::initializeModel() {
...
void OAICreateLoggingConfigurationResponse_destinationConfiguration::fromJson(QString jsonString) {
...
void OAICreateLoggingConfigurationResponse_destinationConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateLoggingConfigurationResponse_destinationConfiguration::asJson() const {
...
QJsonObject OAICreateLoggingConfigurationResponse_destinationConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs OAICreateLoggingConfigurationResponse_destinationConfiguration::getCloudWatchLogs() const {
    return m_cloud_watch_logs;
}
void OAICreateLoggingConfigurationResponse_destinationConfiguration::setCloudWatchLogs(const OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs &cloud_watch_logs) {
    m_cloud_watch_logs = cloud_watch_logs;
    m_cloud_watch_logs_isSet = true;
}

bool OAICreateLoggingConfigurationResponse_destinationConfiguration::is_cloud_watch_logs_Set() const{
    return m_cloud_watch_logs_isSet;
}

bool OAICreateLoggingConfigurationResponse_destinationConfiguration::is_cloud_watch_logs_Valid() const{
    return m_cloud_watch_logs_isValid;
}

OAICreateLoggingConfiguration_request_destinationConfiguration_firehose OAICreateLoggingConfigurationResponse_destinationConfiguration::getFirehose() const {
    return m_firehose;
}
void OAICreateLoggingConfigurationResponse_destinationConfiguration::setFirehose(const OAICreateLoggingConfiguration_request_destinationConfiguration_firehose &firehose) {
    m_firehose = firehose;
    m_firehose_isSet = true;
}

bool OAICreateLoggingConfigurationResponse_destinationConfiguration::is_firehose_Set() const{
    return m_firehose_isSet;
}

bool OAICreateLoggingConfigurationResponse_destinationConfiguration::is_firehose_Valid() const{
    return m_firehose_isValid;
}

OAICreateLoggingConfiguration_request_destinationConfiguration_s3 OAICreateLoggingConfigurationResponse_destinationConfiguration::getS3() const {
    return m_s3;
}
void OAICreateLoggingConfigurationResponse_destinationConfiguration::setS3(const OAICreateLoggingConfiguration_request_destinationConfiguration_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAICreateLoggingConfigurationResponse_destinationConfiguration::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAICreateLoggingConfigurationResponse_destinationConfiguration::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAICreateLoggingConfigurationResponse_destinationConfiguration::isSet() const {
...
bool OAICreateLoggingConfigurationResponse_destinationConfiguration::isValid() const {
