...
/*
 * OAIDeleteRoomRequest.h
 *
 * 
 */

#ifndef OAIDeleteRoomRequest_H
#define OAIDeleteRoomRequest_H
...
class OAIDeleteRoomRequest : public OAIObject {
public:
    OAIDeleteRoomRequest();
    OAIDeleteRoomRequest(QString json);
    ~OAIDeleteRoomRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRoomRequest)

#endif // OAIDeleteRoomRequest_H
