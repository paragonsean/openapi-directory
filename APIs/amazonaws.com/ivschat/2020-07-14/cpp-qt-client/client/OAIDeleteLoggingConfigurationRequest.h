...
/*
 * OAIDeleteLoggingConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDeleteLoggingConfigurationRequest_H
#define OAIDeleteLoggingConfigurationRequest_H
...
class OAIDeleteLoggingConfigurationRequest : public OAIObject {
public:
    OAIDeleteLoggingConfigurationRequest();
    OAIDeleteLoggingConfigurationRequest(QString json);
    ~OAIDeleteLoggingConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLoggingConfigurationRequest)

#endif // OAIDeleteLoggingConfigurationRequest_H
