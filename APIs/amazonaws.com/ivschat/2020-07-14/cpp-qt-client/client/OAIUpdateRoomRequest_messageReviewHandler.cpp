...
OAIUpdateRoomRequest_messageReviewHandler::OAIUpdateRoomRequest_messageReviewHandler(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRoomRequest_messageReviewHandler::OAIUpdateRoomRequest_messageReviewHandler() {
    this->initializeModel();
}

OAIUpdateRoomRequest_messageReviewHandler::~OAIUpdateRoomRequest_messageReviewHandler() {}

void OAIUpdateRoomRequest_messageReviewHandler::initializeModel() {
...
void OAIUpdateRoomRequest_messageReviewHandler::fromJson(QString jsonString) {
...
void OAIUpdateRoomRequest_messageReviewHandler::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRoomRequest_messageReviewHandler::asJson() const {
...
QJsonObject OAIUpdateRoomRequest_messageReviewHandler::asJsonObject() const {
    QJsonObject obj;
...
OAIFallbackResult OAIUpdateRoomRequest_messageReviewHandler::getFallbackResult() const {
    return m_fallback_result;
}
void OAIUpdateRoomRequest_messageReviewHandler::setFallbackResult(const OAIFallbackResult &fallback_result) {
    m_fallback_result = fallback_result;
    m_fallback_result_isSet = true;
}

bool OAIUpdateRoomRequest_messageReviewHandler::is_fallback_result_Set() const{
    return m_fallback_result_isSet;
}

bool OAIUpdateRoomRequest_messageReviewHandler::is_fallback_result_Valid() const{
    return m_fallback_result_isValid;
}

QString OAIUpdateRoomRequest_messageReviewHandler::getUri() const {
    return m_uri;
}
void OAIUpdateRoomRequest_messageReviewHandler::setUri(const QString &uri) {
    m_uri = uri;
    m_uri_isSet = true;
}

bool OAIUpdateRoomRequest_messageReviewHandler::is_uri_Set() const{
    return m_uri_isSet;
}

bool OAIUpdateRoomRequest_messageReviewHandler::is_uri_Valid() const{
    return m_uri_isValid;
}

bool OAIUpdateRoomRequest_messageReviewHandler::isSet() const {
...
bool OAIUpdateRoomRequest_messageReviewHandler::isValid() const {
