...
OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::OAICreateLoggingConfiguration_request_destinationConfiguration_firehose(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::OAICreateLoggingConfiguration_request_destinationConfiguration_firehose() {
    this->initializeModel();
}

OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::~OAICreateLoggingConfiguration_request_destinationConfiguration_firehose() {}

void OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::initializeModel() {

    m_delivery_stream_name_isSet = false;
    m_delivery_stream_name_isValid = false;
}

void OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::fromJson(QString jsonString) {
...
void OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::fromJsonObject(QJsonObject json) {
...
QString OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::asJson() const {
...
QJsonObject OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::getDeliveryStreamName() const {
    return m_delivery_stream_name;
}
void OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::setDeliveryStreamName(const QString &delivery_stream_name) {
    m_delivery_stream_name = delivery_stream_name;
    m_delivery_stream_name_isSet = true;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::is_delivery_stream_name_Set() const{
    return m_delivery_stream_name_isSet;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::is_delivery_stream_name_Valid() const{
    return m_delivery_stream_name_isValid;
}

bool OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::isSet() const {
...
bool OAICreateLoggingConfiguration_request_destinationConfiguration_firehose::isValid() const {
