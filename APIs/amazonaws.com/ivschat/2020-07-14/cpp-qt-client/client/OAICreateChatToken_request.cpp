...
OAICreateChatToken_request::OAICreateChatToken_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateChatToken_request::OAICreateChatToken_request() {
    this->initializeModel();
}

OAICreateChatToken_request::~OAICreateChatToken_request() {}

void OAICreateChatToken_request::initializeModel() {
    ...
    m_session_duration_in_minutes_isSet = false;
    m_session_duration_in_minutes_isValid = false;

    m_user_id_isSet = false;
    m_user_id_isValid = false;
}

void OAICreateChatToken_request::fromJson(QString jsonString) {
...
void OAICreateChatToken_request::fromJsonObject(QJsonObject json) {
    ...
    m_session_duration_in_minutes_isValid = ::OpenAPI::fromJsonValue(m_session_duration_in_minutes, json[QString("sessionDurationInMinutes")]);
    m_session_duration_in_minutes_isSet = !json[QString("sessionDurationInMinutes")].isNull() && m_session_duration_in_minutes_isValid;

    m_user_id_isValid = ::OpenAPI::fromJsonValue(m_user_id, json[QString("userId")]);
    m_user_id_isSet = !json[QString("userId")].isNull() && m_user_id_isValid;
}

QString OAICreateChatToken_request::asJson() const {
...
QJsonObject OAICreateChatToken_request::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_session_duration_in_minutes_isSet) {
        obj.insert(QString("sessionDurationInMinutes"), ::OpenAPI::toJsonValue(m_session_duration_in_minutes));
    }
    if (m_user_id_isSet) {
...
QMap<QString, QString> OAICreateChatToken_request::getAttributes() const {
    return m_attributes;
}
void OAICreateChatToken_request::setAttributes(const QMap<QString, QString> &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAICreateChatToken_request::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAICreateChatToken_request::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QList<OAIChatTokenCapability> OAICreateChatToken_request::getCapabilities() const {
    return m_capabilities;
}
void OAICreateChatToken_request::setCapabilities(const QList<OAIChatTokenCapability> &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAICreateChatToken_request::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAICreateChatToken_request::is_capabilities_Valid() const{
    return m_capabilities_isValid;
}

QString OAICreateChatToken_request::getRoomIdentifier() const {
    return m_room_identifier;
}
void OAICreateChatToken_request::setRoomIdentifier(const QString &room_identifier) {
    m_room_identifier = room_identifier;
    m_room_identifier_isSet = true;
}

bool OAICreateChatToken_request::is_room_identifier_Set() const{
    return m_room_identifier_isSet;
}

bool OAICreateChatToken_request::is_room_identifier_Valid() const{
    return m_room_identifier_isValid;
}

qint32 OAICreateChatToken_request::getSessionDurationInMinutes() const {
    return m_session_duration_in_minutes;
}
void OAICreateChatToken_request::setSessionDurationInMinutes(const qint32 &session_duration_in_minutes) {
    m_session_duration_in_minutes = session_duration_in_minutes;
    m_session_duration_in_minutes_isSet = true;
}

bool OAICreateChatToken_request::is_session_duration_in_minutes_Set() const{
    return m_session_duration_in_minutes_isSet;
}

bool OAICreateChatToken_request::is_session_duration_in_minutes_Valid() const{
    return m_session_duration_in_minutes_isValid;
}

QString OAICreateChatToken_request::getUserId() const {
    return m_user_id;
}
void OAICreateChatToken_request::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAICreateChatToken_request::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAICreateChatToken_request::is_user_id_Valid() const{
    return m_user_id_isValid;
}

bool OAICreateChatToken_request::isSet() const {
...
bool OAICreateChatToken_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_room_identifier_isValid && m_user_id_isValid && true;
}
