...
#ifndef OAIFallbackResult_H
#define OAIFallbackResult_H
...
class OAIFallbackResult : public OAIEnum {
public:
    OAIFallbackResult();
    OAIFallbackResult(QString json);
    ~OAIFallbackResult() override;
    ...
    enum class eOAIFallbackResult {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ALLOW, 
        DENY
    };
    OAIFallbackResult::eOAIFallbackResult getValue() const;
    void setValue(const OAIFallbackResult::eOAIFallbackResult& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFallbackResult)

#endif // OAIFallbackResult_H
