...
/*
 * OAIChatTokenCapability.h
 *
 * 
 */

#ifndef OAIChatTokenCapability_H
#define OAIChatTokenCapability_H
...
class OAIChatTokenCapability : public OAIEnum {
public:
    OAIChatTokenCapability();
    OAIChatTokenCapability(QString json);
    ~OAIChatTokenCapability() override;
    ...
    enum class eOAIChatTokenCapability {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SEND_MESSAGE, 
        DISCONNECT_USER, 
        DELETE_MESSAGE
    };
    OAIChatTokenCapability::eOAIChatTokenCapability getValue() const;
    void setValue(const OAIChatTokenCapability::eOAIChatTokenCapability& value);
...
private:
    ...
    eOAIChatTokenCapability m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChatTokenCapability)

#endif // OAIChatTokenCapability_H
