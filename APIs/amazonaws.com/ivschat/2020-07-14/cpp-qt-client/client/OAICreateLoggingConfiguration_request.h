...
/*
 * OAICreateLoggingConfiguration_request.h
 *
 * 
 */

#ifndef OAICreateLoggingConfiguration_request_H
#define OAICreateLoggingConfiguration_request_H
...
namespace OpenAPI {
class OAICreateLoggingConfiguration_request_destinationConfiguration;

class OAICreateLoggingConfiguration_request : public OAIObject {
public:
    OAICreateLoggingConfiguration_request();
    OAICreateLoggingConfiguration_request(QString json);
    ~OAICreateLoggingConfiguration_request() override;
    ...
    OAICreateLoggingConfiguration_request_destinationConfiguration getDestinationConfiguration() const;
    void setDestinationConfiguration(const OAICreateLoggingConfiguration_request_destinationConfiguration &destination_configuration);
...
private:
    ...
    OAICreateLoggingConfiguration_request_destinationConfiguration m_destination_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLoggingConfiguration_request)

#endif // OAICreateLoggingConfiguration_request_H
