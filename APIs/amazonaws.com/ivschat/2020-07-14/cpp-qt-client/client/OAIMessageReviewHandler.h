...
/*
 * OAIMessageReviewHandler.h
 *
 * Configuration information for optional message review.
 */

#ifndef OAIMessageReviewHandler_H
#define OAIMessageReviewHandler_H
...
class OAIMessageReviewHandler : public OAIObject {
public:
    OAIMessageReviewHandler();
    OAIMessageReviewHandler(QString json);
    ~OAIMessageReviewHandler() override;
    ...
    OAIFallbackResult getFallbackResult() const;
    void setFallbackResult(const OAIFallbackResult &fallback_result);
    bool is_fallback_result_Set() const;
    bool is_fallback_result_Valid() const;
...
private:
    ...
    OAIFallbackResult m_fallback_result;
    bool m_fallback_result_isSet;
    bool m_fallback_result_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageReviewHandler)

#endif // OAIMessageReviewHandler_H
