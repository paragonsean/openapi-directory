...
/*
 * OAIListRoomsRequest.h
 *
 * 
 */

#ifndef OAIListRoomsRequest_H
#define OAIListRoomsRequest_H
...
class OAIListRoomsRequest : public OAIObject {
public:
    OAIListRoomsRequest();
    OAIListRoomsRequest(QString json);
    ~OAIListRoomsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRoomsRequest)

#endif // OAIListRoomsRequest_H
