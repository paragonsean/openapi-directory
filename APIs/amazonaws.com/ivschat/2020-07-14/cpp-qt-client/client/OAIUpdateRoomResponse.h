...
/*
 * OAIUpdateRoomResponse.h
 *
 * 
 */

#ifndef OAIUpdateRoomResponse_H
#define OAIUpdateRoomResponse_H
...
namespace OpenAPI {
class OAICreateRoomResponse_messageReviewHandler;

class OAIUpdateRoomResponse : public OAIObject {
public:
    OAIUpdateRoomResponse();
    OAIUpdateRoomResponse(QString json);
    ~OAIUpdateRoomResponse() override;
    ...
    QList getLoggingConfigurationIdentifiers() const;
    void setLoggingConfigurationIdentifiers(const QList &logging_configuration_identifiers);
    bool is_logging_configuration_identifiers_Set() const;
    bool is_logging_configuration_identifiers_Valid() const;

    qint32 getMaximumMessageLength() const;
    void setMaximumMessageLength(const qint32 &maximum_message_length);
    bool is_maximum_message_length_Set() const;
    bool is_maximum_message_length_Valid() const;

    qint32 getMaximumMessageRatePerSecond() const;
    void setMaximumMessageRatePerSecond(const qint32 &maximum_message_rate_per_second);
    bool is_maximum_message_rate_per_second_Set() const;
    bool is_maximum_message_rate_per_second_Valid() const;

    OAICreateRoomResponse_messageReviewHandler getMessageReviewHandler() const;
    void setMessageReviewHandler(const OAICreateRoomResponse_messageReviewHandler &message_review_handler);
    bool is_message_review_handler_Set() const;
    bool is_message_review_handler_Valid() const;
...
private:
    ...
    QList m_logging_configuration_identifiers;
    bool m_logging_configuration_identifiers_isSet;
    bool m_logging_configuration_identifiers_isValid;

    qint32 m_maximum_message_length;
    bool m_maximum_message_length_isSet;
    bool m_maximum_message_length_isValid;

    qint32 m_maximum_message_rate_per_second;
    bool m_maximum_message_rate_per_second_isSet;
    bool m_maximum_message_rate_per_second_isValid;

    OAICreateRoomResponse_messageReviewHandler m_message_review_handler;
    bool m_message_review_handler_isSet;
    bool m_message_review_handler_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRoomResponse)

#endif // OAIUpdateRoomResponse_H
