...
OAILoggingConfigurationState::OAILoggingConfigurationState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoggingConfigurationState::OAILoggingConfigurationState() {
    this->initializeModel();
}

OAILoggingConfigurationState::~OAILoggingConfigurationState() {}

void OAILoggingConfigurationState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAILoggingConfigurationState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAILoggingConfigurationState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("CREATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAILoggingConfigurationState::CREATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CREATE_FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAILoggingConfigurationState::CREATE_FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETING", Qt::CaseInsensitive) == 0) {
        m_value = eOAILoggingConfigurationState::DELETING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETE_FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAILoggingConfigurationState::DELETE_FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UPDATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAILoggingConfigurationState::UPDATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UPDATE_FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAILoggingConfigurationState::UPDATE_FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAILoggingConfigurationState::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAILoggingConfigurationState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAILoggingConfigurationState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAILoggingConfigurationState::CREATING:
            val = "CREATING";
            break;
        case eOAILoggingConfigurationState::CREATE_FAILED:
            val = "CREATE_FAILED";
            break;
        case eOAILoggingConfigurationState::DELETING:
            val = "DELETING";
            break;
        case eOAILoggingConfigurationState::DELETE_FAILED:
            val = "DELETE_FAILED";
            break;
        case eOAILoggingConfigurationState::UPDATING:
            val = "UPDATING";
            break;
        case eOAILoggingConfigurationState::UPDATE_FAILED:
            val = "UPDATE_FAILED";
            break;
        case eOAILoggingConfigurationState::ACTIVE:
            val = "ACTIVE";
            break;
        default:
            break;
...
QJsonValue OAILoggingConfigurationState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAILoggingConfigurationState::eOAILoggingConfigurationState OAILoggingConfigurationState::getValue() const {
    return m_value;
}

void OAILoggingConfigurationState::setValue(const OAILoggingConfigurationState::eOAILoggingConfigurationState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAILoggingConfigurationState::isSet() const {
    
    return m_value_isSet;
}

bool OAILoggingConfigurationState::isValid() const {
