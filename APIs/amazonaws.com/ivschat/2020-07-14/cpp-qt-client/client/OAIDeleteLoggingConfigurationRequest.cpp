...
OAIDeleteLoggingConfigurationRequest::OAIDeleteLoggingConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteLoggingConfigurationRequest::OAIDeleteLoggingConfigurationRequest() {
    this->initializeModel();
}

OAIDeleteLoggingConfigurationRequest::~OAIDeleteLoggingConfigurationRequest() {}

void OAIDeleteLoggingConfigurationRequest::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIDeleteLoggingConfigurationRequest::fromJson(QString jsonString) {
...
void OAIDeleteLoggingConfigurationRequest::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("identifier")]);
    m_identifier_isSet = !json[QString("identifier")].isNull() && m_identifier_isValid;
}

QString OAIDeleteLoggingConfigurationRequest::asJson() const {
...
QJsonObject OAIDeleteLoggingConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteLoggingConfigurationRequest::getIdentifier() const {
    return m_identifier;
}
void OAIDeleteLoggingConfigurationRequest::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIDeleteLoggingConfigurationRequest::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIDeleteLoggingConfigurationRequest::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIDeleteLoggingConfigurationRequest::isSet() const {
...
bool OAIDeleteLoggingConfigurationRequest::isValid() const {
