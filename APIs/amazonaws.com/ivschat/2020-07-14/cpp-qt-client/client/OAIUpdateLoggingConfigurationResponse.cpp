...
QString OAIUpdateLoggingConfigurationResponse::getArn() const {
    return m_arn;
}
void OAIUpdateLoggingConfigurationResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateLoggingConfigurationResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateLoggingConfigurationResponse::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIUpdateLoggingConfigurationResponse::getCreateTime() const {
    return m_create_time;
}
void OAIUpdateLoggingConfigurationResponse::setCreateTime(const QDateTime &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAIUpdateLoggingConfigurationResponse::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAIUpdateLoggingConfigurationResponse::is_create_time_Valid() const{
    return m_create_time_isValid;
}

OAICreateLoggingConfigurationResponse_destinationConfiguration OAIUpdateLoggingConfigurationResponse::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAIUpdateLoggingConfigurationResponse::setDestinationConfiguration(const OAICreateLoggingConfigurationResponse_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAIUpdateLoggingConfigurationResponse::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAIUpdateLoggingConfigurationResponse::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAIUpdateLoggingConfigurationResponse::getId() const {
    return m_id;
}
void OAIUpdateLoggingConfigurationResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUpdateLoggingConfigurationResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUpdateLoggingConfigurationResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIUpdateLoggingConfigurationResponse::getName() const {
    return m_name;
}
void OAIUpdateLoggingConfigurationResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateLoggingConfigurationResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateLoggingConfigurationResponse::is_name_Valid() const{
    return m_name_isValid;
}

OAIUpdateLoggingConfigurationState OAIUpdateLoggingConfigurationResponse::getState() const {
    return m_state;
}
void OAIUpdateLoggingConfigurationResponse::setState(const OAIUpdateLoggingConfigurationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIUpdateLoggingConfigurationResponse::is_state_Set() const{
    return m_state_isSet;
}

bool OAIUpdateLoggingConfigurationResponse::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIUpdateLoggingConfigurationResponse::getTags() const {
    return m_tags;
}
void OAIUpdateLoggingConfigurationResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUpdateLoggingConfigurationResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUpdateLoggingConfigurationResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAIUpdateLoggingConfigurationResponse::getUpdateTime() const {
    return m_update_time;
}
void OAIUpdateLoggingConfigurationResponse::setUpdateTime(const QDateTime &update_time) {
    m_update_time = update_time;
    m_update_time_isSet = true;
}

bool OAIUpdateLoggingConfigurationResponse::is_update_time_Set() const{
    return m_update_time_isSet;
}

bool OAIUpdateLoggingConfigurationResponse::is_update_time_Valid() const{
