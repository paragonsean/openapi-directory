...
#include "OAIGetLoggingConfigurationResponse_destinationConfiguration.h"
...
OAIGetLoggingConfigurationResponse_destinationConfiguration::OAIGetLoggingConfigurationResponse_destinationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLoggingConfigurationResponse_destinationConfiguration::OAIGetLoggingConfigurationResponse_destinationConfiguration() {
    this->initializeModel();
}

OAIGetLoggingConfigurationResponse_destinationConfiguration::~OAIGetLoggingConfigurationResponse_destinationConfiguration() {}

void OAIGetLoggingConfigurationResponse_destinationConfiguration::initializeModel() {
...
void OAIGetLoggingConfigurationResponse_destinationConfiguration::fromJson(QString jsonString) {
...
void OAIGetLoggingConfigurationResponse_destinationConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIGetLoggingConfigurationResponse_destinationConfiguration::asJson() const {
...
QJsonObject OAIGetLoggingConfigurationResponse_destinationConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs OAIGetLoggingConfigurationResponse_destinationConfiguration::getCloudWatchLogs() const {
    return m_cloud_watch_logs;
}
void OAIGetLoggingConfigurationResponse_destinationConfiguration::setCloudWatchLogs(const OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs &cloud_watch_logs) {
    m_cloud_watch_logs = cloud_watch_logs;
    m_cloud_watch_logs_isSet = true;
}

bool OAIGetLoggingConfigurationResponse_destinationConfiguration::is_cloud_watch_logs_Set() const{
    return m_cloud_watch_logs_isSet;
}

bool OAIGetLoggingConfigurationResponse_destinationConfiguration::is_cloud_watch_logs_Valid() const{
    return m_cloud_watch_logs_isValid;
}

OAICreateLoggingConfiguration_request_destinationConfiguration_firehose OAIGetLoggingConfigurationResponse_destinationConfiguration::getFirehose() const {
    return m_firehose;
}
void OAIGetLoggingConfigurationResponse_destinationConfiguration::setFirehose(const OAICreateLoggingConfiguration_request_destinationConfiguration_firehose &firehose) {
    m_firehose = firehose;
    m_firehose_isSet = true;
}

bool OAIGetLoggingConfigurationResponse_destinationConfiguration::is_firehose_Set() const{
    return m_firehose_isSet;
}

bool OAIGetLoggingConfigurationResponse_destinationConfiguration::is_firehose_Valid() const{
    return m_firehose_isValid;
}

OAICreateLoggingConfiguration_request_destinationConfiguration_s3 OAIGetLoggingConfigurationResponse_destinationConfiguration::getS3() const {
    return m_s3;
}
void OAIGetLoggingConfigurationResponse_destinationConfiguration::setS3(const OAICreateLoggingConfiguration_request_destinationConfiguration_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAIGetLoggingConfigurationResponse_destinationConfiguration::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAIGetLoggingConfigurationResponse_destinationConfiguration::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAIGetLoggingConfigurationResponse_destinationConfiguration::isSet() const {
...
bool OAIGetLoggingConfigurationResponse_destinationConfiguration::isValid() const {
