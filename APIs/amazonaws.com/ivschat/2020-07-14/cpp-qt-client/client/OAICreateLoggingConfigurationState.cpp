...
#include "OAICreateLoggingConfigurationState.h"
...
OAICreateLoggingConfigurationState::OAICreateLoggingConfigurationState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLoggingConfigurationState::OAICreateLoggingConfigurationState() {
    this->initializeModel();
}

OAICreateLoggingConfigurationState::~OAICreateLoggingConfigurationState() {}

void OAICreateLoggingConfigurationState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAICreateLoggingConfigurationState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAICreateLoggingConfigurationState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAICreateLoggingConfigurationState::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAICreateLoggingConfigurationState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAICreateLoggingConfigurationState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAICreateLoggingConfigurationState::ACTIVE:
            val = "ACTIVE";
            break;
        default:
            break;
...
QJsonValue OAICreateLoggingConfigurationState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAICreateLoggingConfigurationState::eOAICreateLoggingConfigurationState OAICreateLoggingConfigurationState::getValue() const {
    return m_value;
}

void OAICreateLoggingConfigurationState::setValue(const OAICreateLoggingConfigurationState::eOAICreateLoggingConfigurationState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAICreateLoggingConfigurationState::isSet() const {
    
    return m_value_isSet;
}

bool OAICreateLoggingConfigurationState::isValid() const {
