...
#ifndef OAIGetRoomRequest_H
#define OAIGetRoomRequest_H
...
class OAIGetRoomRequest : public OAIObject {
public:
    OAIGetRoomRequest();
    OAIGetRoomRequest(QString json);
    ~OAIGetRoomRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRoomRequest)

#endif // OAIGetRoomRequest_H
