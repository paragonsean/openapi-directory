...
/*
 * OAILoggingConfigurationState.h
 *
 * 
 */

#ifndef OAILoggingConfigurationState_H
#define OAILoggingConfigurationState_H
...
class OAILoggingConfigurationState : public OAIEnum {
public:
    OAILoggingConfigurationState();
    OAILoggingConfigurationState(QString json);
    ~OAILoggingConfigurationState() override;
    ...
    enum class eOAILoggingConfigurationState {
    ...
    OAILoggingConfigurationState::eOAILoggingConfigurationState getValue() const;
    void setValue(const OAILoggingConfigurationState::eOAILoggingConfigurationState& value);
...
private:
    ...
    eOAILoggingConfigurationState m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoggingConfigurationState)

#endif // OAILoggingConfigurationState_H
