...
/*
 * OAIDisconnectUserRequest.h
 *
 * 
 */

#ifndef OAIDisconnectUserRequest_H
#define OAIDisconnectUserRequest_H
...
class OAIDisconnectUserRequest : public OAIObject {
public:
    OAIDisconnectUserRequest();
    OAIDisconnectUserRequest(QString json);
    ~OAIDisconnectUserRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisconnectUserRequest)

#endif // OAIDisconnectUserRequest_H
