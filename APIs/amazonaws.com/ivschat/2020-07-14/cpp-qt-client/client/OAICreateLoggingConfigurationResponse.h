...
#include "OAICreateLoggingConfigurationResponse_destinationConfiguration.h"
...
namespace OpenAPI {
class OAICreateLoggingConfigurationResponse_destinationConfiguration;
...
public:
    ...
    OAICreateLoggingConfigurationResponse_destinationConfiguration getDestinationConfiguration() const;
    void setDestinationConfiguration(const OAICreateLoggingConfigurationResponse_destinationConfiguration &destination_configuration);
    ...
    OAICreateLoggingConfigurationState getState() const;
    void setState(const OAICreateLoggingConfigurationState &state);
...
private:
    ...
    OAICreateLoggingConfigurationResponse_destinationConfiguration m_destination_configuration;
    ...
    OAICreateLoggingConfigurationState m_state;
    bool m_state_isSet;
