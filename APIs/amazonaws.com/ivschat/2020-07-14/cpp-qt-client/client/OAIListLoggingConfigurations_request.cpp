...
OAIListLoggingConfigurations_request::OAIListLoggingConfigurations_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListLoggingConfigurations_request::OAIListLoggingConfigurations_request() {
    this->initializeModel();
}

OAIListLoggingConfigurations_request::~OAIListLoggingConfigurations_request() {}

void OAIListLoggingConfigurations_request::initializeModel() {
...
void OAIListLoggingConfigurations_request::fromJson(QString jsonString) {
...
void OAIListLoggingConfigurations_request::fromJsonObject(QJsonObject json) {
...
QString OAIListLoggingConfigurations_request::asJson() const {
...
QJsonObject OAIListLoggingConfigurations_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListLoggingConfigurations_request::getMaxResults() const {
    return m_max_results;
}
void OAIListLoggingConfigurations_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListLoggingConfigurations_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListLoggingConfigurations_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListLoggingConfigurations_request::getNextToken() const {
    return m_next_token;
}
void OAIListLoggingConfigurations_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListLoggingConfigurations_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListLoggingConfigurations_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListLoggingConfigurations_request::isSet() const {
...
bool OAIListLoggingConfigurations_request::isValid() const {
