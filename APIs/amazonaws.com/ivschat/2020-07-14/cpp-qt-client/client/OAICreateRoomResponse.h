...
/*
 * OAICreateRoomResponse.h
 *
 * 
 */

#ifndef OAICreateRoomResponse_H
#define OAICreateRoomResponse_H
...
class OAICreateRoomResponse : public OAIObject {
public:
    OAICreateRoomResponse();
    OAICreateRoomResponse(QString json);
    ~OAICreateRoomResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRoomResponse)

#endif // OAICreateRoomResponse_H
