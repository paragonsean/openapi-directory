...
/*
 * OAICloudWatchLogsDestinationConfiguration.h
 *
 * Specifies a CloudWatch Logs location where chat logs will be stored.
 */

#ifndef OAICloudWatchLogsDestinationConfiguration_H
#define OAICloudWatchLogsDestinationConfiguration_H
...
class OAICloudWatchLogsDestinationConfiguration : public OAIObject {
public:
    OAICloudWatchLogsDestinationConfiguration();
    OAICloudWatchLogsDestinationConfiguration(QString json);
    ~OAICloudWatchLogsDestinationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudWatchLogsDestinationConfiguration)

#endif // OAICloudWatchLogsDestinationConfiguration_H
