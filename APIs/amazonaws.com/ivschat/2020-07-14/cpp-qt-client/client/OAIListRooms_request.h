...
/*
 * OAIListRooms_request.h
 *
 * 
 */

#ifndef OAIListRooms_request_H
#define OAIListRooms_request_H
...
class OAIListRooms_request : public OAIObject {
public:
    OAIListRooms_request();
    OAIListRooms_request(QString json);
    ~OAIListRooms_request() override;
    ...
    QString getLoggingConfigurationIdentifier() const;
    void setLoggingConfigurationIdentifier(const QString &logging_configuration_identifier);
    bool is_logging_configuration_identifier_Set() const;
    bool is_logging_configuration_identifier_Valid() const;
    ...
    QString getMessageReviewHandlerUri() const;
    void setMessageReviewHandlerUri(const QString &message_review_handler_uri);
    bool is_message_review_handler_uri_Set() const;
    bool is_message_review_handler_uri_Valid() const;
...
private:
    ...
    QString m_logging_configuration_identifier;
    bool m_logging_configuration_identifier_isSet;
    bool m_logging_configuration_identifier_isValid;

    qint32 m_max_results;
    bool m_max_results_isSet;
    bool m_max_results_isValid;

    QString m_message_review_handler_uri;
    bool m_message_review_handler_uri_isSet;
    bool m_message_review_handler_uri_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRooms_request)

#endif // OAIListRooms_request_H
