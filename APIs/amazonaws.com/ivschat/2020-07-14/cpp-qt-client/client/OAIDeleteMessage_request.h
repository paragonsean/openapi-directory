...
/*
 * OAIDeleteMessage_request.h
 *
 * 
 */

#ifndef OAIDeleteMessage_request_H
#define OAIDeleteMessage_request_H
...
class OAIDeleteMessage_request : public OAIObject {
public:
    OAIDeleteMessage_request();
    OAIDeleteMessage_request(QString json);
    ~OAIDeleteMessage_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMessage_request)

#endif // OAIDeleteMessage_request_H
