...
/*
 * OAIGetLoggingConfigurationResponse.h
 *
 * 
 */

#ifndef OAIGetLoggingConfigurationResponse_H
#define OAIGetLoggingConfigurationResponse_H

#include <QJsonObject>

#include "OAIGetLoggingConfigurationResponse_destinationConfiguration.h"
#include "OAILoggingConfigurationState.h"
#include <QDateTime>
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIGetLoggingConfigurationResponse_destinationConfiguration;

class OAIGetLoggingConfigurationResponse : public OAIObject {
public:
    OAIGetLoggingConfigurationResponse();
    OAIGetLoggingConfigurationResponse(QString json);
    ~OAIGetLoggingConfigurationResponse() override;
    ...
    OAIGetLoggingConfigurationResponse_destinationConfiguration getDestinationConfiguration() const;
    void setDestinationConfiguration(const OAIGetLoggingConfigurationResponse_destinationConfiguration &destination_configuration);
    ...
    OAILoggingConfigurationState getState() const;
    void setState(const OAILoggingConfigurationState &state);
...
private:
    ...
    OAIGetLoggingConfigurationResponse_destinationConfiguration m_destination_configuration;
    ...
    OAILoggingConfigurationState m_state;
    bool m_state_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLoggingConfigurationResponse)

#endif // OAIGetLoggingConfigurationResponse_H
