...
#include "OAILoggingConfigurationSummary_destinationConfiguration.h"
...
OAILoggingConfigurationSummary_destinationConfiguration::OAILoggingConfigurationSummary_destinationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoggingConfigurationSummary_destinationConfiguration::OAILoggingConfigurationSummary_destinationConfiguration() {
    this->initializeModel();
}

OAILoggingConfigurationSummary_destinationConfiguration::~OAILoggingConfigurationSummary_destinationConfiguration() {}

void OAILoggingConfigurationSummary_destinationConfiguration::initializeModel() {
...
void OAILoggingConfigurationSummary_destinationConfiguration::fromJson(QString jsonString) {
...
void OAILoggingConfigurationSummary_destinationConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAILoggingConfigurationSummary_destinationConfiguration::asJson() const {
...
QJsonObject OAILoggingConfigurationSummary_destinationConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs OAILoggingConfigurationSummary_destinationConfiguration::getCloudWatchLogs() const {
    return m_cloud_watch_logs;
}
void OAILoggingConfigurationSummary_destinationConfiguration::setCloudWatchLogs(const OAICreateLoggingConfiguration_request_destinationConfiguration_cloudWatchLogs &cloud_watch_logs) {
    m_cloud_watch_logs = cloud_watch_logs;
    m_cloud_watch_logs_isSet = true;
}

bool OAILoggingConfigurationSummary_destinationConfiguration::is_cloud_watch_logs_Set() const{
    return m_cloud_watch_logs_isSet;
}

bool OAILoggingConfigurationSummary_destinationConfiguration::is_cloud_watch_logs_Valid() const{
    return m_cloud_watch_logs_isValid;
}

OAICreateLoggingConfiguration_request_destinationConfiguration_firehose OAILoggingConfigurationSummary_destinationConfiguration::getFirehose() const {
    return m_firehose;
}
void OAILoggingConfigurationSummary_destinationConfiguration::setFirehose(const OAICreateLoggingConfiguration_request_destinationConfiguration_firehose &firehose) {
    m_firehose = firehose;
    m_firehose_isSet = true;
}

bool OAILoggingConfigurationSummary_destinationConfiguration::is_firehose_Set() const{
    return m_firehose_isSet;
}

bool OAILoggingConfigurationSummary_destinationConfiguration::is_firehose_Valid() const{
    return m_firehose_isValid;
}

OAICreateLoggingConfiguration_request_destinationConfiguration_s3 OAILoggingConfigurationSummary_destinationConfiguration::getS3() const {
    return m_s3;
}
void OAILoggingConfigurationSummary_destinationConfiguration::setS3(const OAICreateLoggingConfiguration_request_destinationConfiguration_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAILoggingConfigurationSummary_destinationConfiguration::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAILoggingConfigurationSummary_destinationConfiguration::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAILoggingConfigurationSummary_destinationConfiguration::isSet() const {
...
bool OAILoggingConfigurationSummary_destinationConfiguration::isValid() const {
