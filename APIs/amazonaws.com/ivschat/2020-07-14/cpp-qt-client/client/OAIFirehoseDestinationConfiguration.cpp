...
#include "OAIFirehoseDestinationConfiguration.h"
...
OAIFirehoseDestinationConfiguration::OAIFirehoseDestinationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirehoseDestinationConfiguration::OAIFirehoseDestinationConfiguration() {
    this->initializeModel();
}

OAIFirehoseDestinationConfiguration::~OAIFirehoseDestinationConfiguration() {}

void OAIFirehoseDestinationConfiguration::initializeModel() {

    m_delivery_stream_name_isSet = false;
    m_delivery_stream_name_isValid = false;
}

void OAIFirehoseDestinationConfiguration::fromJson(QString jsonString) {
...
void OAIFirehoseDestinationConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIFirehoseDestinationConfiguration::asJson() const {
...
QJsonObject OAIFirehoseDestinationConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFirehoseDestinationConfiguration::getDeliveryStreamName() const {
    return m_delivery_stream_name;
}
void OAIFirehoseDestinationConfiguration::setDeliveryStreamName(const QString &delivery_stream_name) {
    m_delivery_stream_name = delivery_stream_name;
    m_delivery_stream_name_isSet = true;
}

bool OAIFirehoseDestinationConfiguration::is_delivery_stream_name_Set() const{
    return m_delivery_stream_name_isSet;
}

bool OAIFirehoseDestinationConfiguration::is_delivery_stream_name_Valid() const{
    return m_delivery_stream_name_isValid;
}

bool OAIFirehoseDestinationConfiguration::isSet() const {
...
bool OAIFirehoseDestinationConfiguration::isValid() const {
