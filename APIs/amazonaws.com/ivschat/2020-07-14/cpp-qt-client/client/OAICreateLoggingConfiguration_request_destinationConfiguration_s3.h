...
/*
 * OAICreateLoggingConfiguration_request_destinationConfiguration_s3.h
 *
 * 
 */

#ifndef OAICreateLoggingConfiguration_request_destinationConfiguration_s3_H
#define OAICreateLoggingConfiguration_request_destinationConfiguration_s3_H
...
class OAICreateLoggingConfiguration_request_destinationConfiguration_s3 : public OAIObject {
public:
    OAICreateLoggingConfiguration_request_destinationConfiguration_s3();
    OAICreateLoggingConfiguration_request_destinationConfiguration_s3(QString json);
    ~OAICreateLoggingConfiguration_request_destinationConfiguration_s3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLoggingConfiguration_request_destinationConfiguration_s3)

#endif // OAICreateLoggingConfiguration_request_destinationConfiguration_s3_H
