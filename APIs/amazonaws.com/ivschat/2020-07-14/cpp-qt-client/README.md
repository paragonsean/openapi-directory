...
class Example : public QObject {
    Q_OBJECT
    OAICreateChatToken_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAICreateChatToken_request Example::create(){
    OAICreateChatToken_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createChatTokenSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createChatTokenSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateChatToken_request oai_create_chat_token_request = create(); // OAICreateChatToken_request | 
      ...
      apiInstance.createChatToken(oai_create_chat_token_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
