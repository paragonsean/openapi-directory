...
class DeleteLoggingConfigurationRequest(Model):
    ...
    def __init__(self, identifier: str=None):
        ...
        :param identifier: The identifier of this DeleteLoggingConfigurationRequest.
        """
        self.openapi_types = {
            'identifier': str
        }
    ...
    def from_dict(cls, dikt: dict) -> 'DeleteLoggingConfigurationRequest':
        ...
        :param dikt: A dict.
        :return: The DeleteLoggingConfiguration_request of this DeleteLoggingConfigurationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def identifier(self):
        """Gets the identifier of this DeleteLoggingConfigurationRequest.

        Identifier of the logging configuration to be deleted.

        :return: The identifier of this DeleteLoggingConfigurationRequest.
        :rtype: str
        """
    ...
    def identifier(self, identifier):
        """Sets the identifier of this DeleteLoggingConfigurationRequest.
