...
class DeleteRoomRequest(Model):
    ...
    def __init__(self, identifier: str=None):
        """DeleteRoomRequest - a model defined in OpenAPI

        :param identifier: The identifier of this DeleteRoomRequest.
        """
        self.openapi_types = {
            'identifier': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteRoomRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteRoom_request of this DeleteRoomRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def identifier(self):
        """Gets the identifier of this DeleteRoomRequest.

        Identifier of the room to be deleted. Currently this must be an ARN.

        :return: The identifier of this DeleteRoomRequest.
        :rtype: str
        """
    ...
    def identifier(self, identifier):
        """Sets the identifier of this DeleteRoomRequest.
