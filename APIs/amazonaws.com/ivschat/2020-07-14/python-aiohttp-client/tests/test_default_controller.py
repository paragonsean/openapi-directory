...
async def test_create_chat_token(client):
    """Test case for create_chat_token

    
    """
    body = {"roomIdentifier":"","sessionDurationInMinutes":"","capabilities":"","attributes":"","userId":""}
    headers = { 
...
async def test_create_logging_configuration(client):
    """Test case for create_logging_configuration

    
    """
    body = {"destinationConfiguration":{"s3":{"bucketName":""},"firehose":{"deliveryStreamName":""},"cloudWatchLogs":{"logGroupName":""}},"name":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_room(client):
    ...
    """
    body = {"maximumMessageRatePerSecond":"","messageReviewHandler":{"fallbackResult":"","uri":""},"name":"","loggingConfigurationIdentifiers":"","maximumMessageLength":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_disconnect_user(client):
    """Test case for disconnect_user

    
    """
    body = {"roomIdentifier":"","reason":"","userId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_rooms(client):
    """Test case for list_rooms

    
    """
    body = {"loggingConfigurationIdentifier":"","maxResults":"","nextToken":"","name":"","messageReviewHandlerUri":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_send_event(client):
    ...
    """
    body = {"roomIdentifier":"","eventName":"","attributes":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_logging_configuration(client):
    """Test case for update_logging_configuration

    
    """
    body = {"identifier":"","destinationConfiguration":{"s3":{"bucketName":""},"firehose":{"deliveryStreamName":""},"cloudWatchLogs":{"logGroupName":""}},"name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_room(client):
    ...
    """
    body = {"identifier":"","maximumMessageRatePerSecond":"","messageReviewHandler":{"fallbackResult":"","uri":""},"name":"","loggingConfigurationIdentifiers":"","maximumMessageLength":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
