...
class ListComponentsRequest(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, application_id: str=None, next_token: str=None, max_results: int=None):
        """ListComponentsRequest - a model defined in OpenAPI

        :param application_id: The application_id of this ListComponentsRequest.
        :param next_token: The next_token of this ListComponentsRequest.
        :param max_results: The max_results of this ListComponentsRequest.
        """
        self.openapi_types = {
            'application_id': str,
            'next_token': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListComponentsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListComponents_request of this ListComponentsRequest.
        """
    ...
    @property
    def next_token(self):
        """Gets the next_token of this ListComponentsRequest.

        The token for the next page of results.

        :return: The next_token of this ListComponentsRequest.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this ListComponentsRequest.
    ...
    def max_results(self):
        """Gets the max_results of this ListComponentsRequest.
        ...
        :return: The max_results of this ListComponentsRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this ListComponentsRequest.
