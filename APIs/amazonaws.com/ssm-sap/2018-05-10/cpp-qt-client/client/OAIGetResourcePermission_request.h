...
/*
 * OAIGetResourcePermission_request.h
 *
 * 
 */

#ifndef OAIGetResourcePermission_request_H
#define OAIGetResourcePermission_request_H
...
class OAIGetResourcePermission_request : public OAIObject {
public:
    OAIGetResourcePermission_request();
    OAIGetResourcePermission_request(QString json);
    ~OAIGetResourcePermission_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetResourcePermission_request)

#endif // OAIGetResourcePermission_request_H
