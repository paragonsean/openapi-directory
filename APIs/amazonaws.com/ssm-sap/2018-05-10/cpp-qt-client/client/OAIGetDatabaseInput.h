...
/*
 * OAIGetDatabaseInput.h
 *
 * 
 */

#ifndef OAIGetDatabaseInput_H
#define OAIGetDatabaseInput_H
...
class OAIGetDatabaseInput : public OAIObject {
public:
    OAIGetDatabaseInput();
    OAIGetDatabaseInput(QString json);
    ~OAIGetDatabaseInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDatabaseInput)

#endif // OAIGetDatabaseInput_H
