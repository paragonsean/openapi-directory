...
#ifndef OAIAssociatedHost_H
#define OAIAssociatedHost_H
...
class OAIAssociatedHost : public OAIObject {
public:
    OAIAssociatedHost();
    OAIAssociatedHost(QString json);
    ~OAIAssociatedHost() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociatedHost)

#endif // OAIAssociatedHost_H
