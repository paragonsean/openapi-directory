...
QString OAIComponent::getComponentId() const {
    return m_component_id;
}
void OAIComponent::setComponentId(const QString &component_id) {
    m_component_id = component_id;
    m_component_id_isSet = true;
}

bool OAIComponent::is_component_id_Set() const{
    return m_component_id_isSet;
}

bool OAIComponent::is_component_id_Valid() const{
    return m_component_id_isValid;
}

QString OAIComponent::getParentComponent() const {
    return m_parent_component;
}
void OAIComponent::setParentComponent(const QString &parent_component) {
    m_parent_component = parent_component;
    m_parent_component_isSet = true;
}

bool OAIComponent::is_parent_component_Set() const{
    return m_parent_component_isSet;
}

bool OAIComponent::is_parent_component_Valid() const{
    return m_parent_component_isValid;
}

QList OAIComponent::getChildComponents() const {
    return m_child_components;
}
void OAIComponent::setChildComponents(const QList &child_components) {
    m_child_components = child_components;
    m_child_components_isSet = true;
}

bool OAIComponent::is_child_components_Set() const{
    return m_child_components_isSet;
}

bool OAIComponent::is_child_components_Valid() const{
    return m_child_components_isValid;
}

QString OAIComponent::getApplicationId() const {
    return m_application_id;
}
void OAIComponent::setApplicationId(const QString &application_id) {
    m_application_id = application_id;
    m_application_id_isSet = true;
}

bool OAIComponent::is_application_id_Set() const{
    return m_application_id_isSet;
}

bool OAIComponent::is_application_id_Valid() const{
    return m_application_id_isValid;
}

OAIComponentType OAIComponent::getComponentType() const {
    return m_component_type;
}
void OAIComponent::setComponentType(const OAIComponentType &component_type) {
...
OAIComponentStatus OAIComponent::getStatus() const {
    return m_status;
}
void OAIComponent::setStatus(const OAIComponentStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIComponent::is_status_Set() const{
    return m_status_isSet;
}

bool OAIComponent::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIComponent::getSapHostname() const {
    return m_sap_hostname;
}
void OAIComponent::setSapHostname(const QString &sap_hostname) {
    m_sap_hostname = sap_hostname;
    m_sap_hostname_isSet = true;
}

bool OAIComponent::is_sap_hostname_Set() const{
    return m_sap_hostname_isSet;
}

bool OAIComponent::is_sap_hostname_Valid() const{
    return m_sap_hostname_isValid;
}

QString OAIComponent::getSapKernelVersion() const {
    return m_sap_kernel_version;
}
void OAIComponent::setSapKernelVersion(const QString &sap_kernel_version) {
    m_sap_kernel_version = sap_kernel_version;
    m_sap_kernel_version_isSet = true;
}

bool OAIComponent::is_sap_kernel_version_Set() const{
    return m_sap_kernel_version_isSet;
}

bool OAIComponent::is_sap_kernel_version_Valid() const{
    return m_sap_kernel_version_isValid;
}

QString OAIComponent::getHdbVersion() const {
    return m_hdb_version;
}
void OAIComponent::setHdbVersion(const QString &hdb_version) {
    m_hdb_version = hdb_version;
    m_hdb_version_isSet = true;
}

bool OAIComponent::is_hdb_version_Set() const{
    return m_hdb_version_isSet;
}

bool OAIComponent::is_hdb_version_Valid() const{
    return m_hdb_version_isValid;
}

OAIComponent_Resilience OAIComponent::getResilience() const {
    return m_resilience;
}
void OAIComponent::setResilience(const OAIComponent_Resilience &resilience) {
    m_resilience = resilience;
    m_resilience_isSet = true;
}

bool OAIComponent::is_resilience_Set() const{
    return m_resilience_isSet;
}

bool OAIComponent::is_resilience_Valid() const{
    return m_resilience_isValid;
}

OAIComponent_AssociatedHost OAIComponent::getAssociatedHost() const {
    return m_associated_host;
}
void OAIComponent::setAssociatedHost(const OAIComponent_AssociatedHost &associated_host) {
    m_associated_host = associated_host;
    m_associated_host_isSet = true;
}

bool OAIComponent::is_associated_host_Set() const{
    return m_associated_host_isSet;
}

bool OAIComponent::is_associated_host_Valid() const{
    return m_associated_host_isValid;
}

QList OAIComponent::getDatabases() const {
    return m_databases;
}
void OAIComponent::setDatabases(const QList &databases) {
    m_databases = databases;
    m_databases_isSet = true;
}

bool OAIComponent::is_databases_Set() const{
    return m_databases_isSet;
}

bool OAIComponent::is_databases_Valid() const{
    return m_databases_isValid;
}

QList OAIComponent::getHosts() const {
    return m_hosts;
}
void OAIComponent::setHosts(const QList &hosts) {
    m_hosts = hosts;
    m_hosts_isSet = true;
}

bool OAIComponent::is_hosts_Set() const{
    return m_hosts_isSet;
}

bool OAIComponent::is_hosts_Valid() const{
    return m_hosts_isValid;
}

QString OAIComponent::getPrimaryHost() const {
    return m_primary_host;
}
void OAIComponent::setPrimaryHost(const QString &primary_host) {
    m_primary_host = primary_host;
    m_primary_host_isSet = true;
}

bool OAIComponent::is_primary_host_Set() const{
    return m_primary_host_isSet;
}

bool OAIComponent::is_primary_host_Valid() const{
    return m_primary_host_isValid;
}

QDateTime OAIComponent::getLastUpdated() const {
    return m_last_updated;
}
void OAIComponent::setLastUpdated(const QDateTime &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAIComponent::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAIComponent::is_last_updated_Valid() const{
