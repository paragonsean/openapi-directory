...
/*
 * OAIListDatabasesInput.h
 *
 * 
 */

#ifndef OAIListDatabasesInput_H
#define OAIListDatabasesInput_H
...
class OAIListDatabasesInput : public OAIObject {
public:
    OAIListDatabasesInput();
    OAIListDatabasesInput(QString json);
    ~OAIListDatabasesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDatabasesInput)

#endif // OAIListDatabasesInput_H
