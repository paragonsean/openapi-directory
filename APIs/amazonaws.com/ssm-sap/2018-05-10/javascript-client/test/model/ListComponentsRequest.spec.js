...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.ListComponentsRequest();
  });
  ...
  describe('ListComponentsRequest', function() {
    it('should create an instance of ListComponentsRequest', function() {
      // uncomment below and update the code to test ListComponentsRequest
      //var instance = new AwsSystemsManagerForSap.ListComponentsRequest();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.ListComponentsRequest);
    });
