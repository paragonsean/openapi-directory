...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.ListOperationsRequest();
  });
  ...
  describe('ListOperationsRequest', function() {
    it('should create an instance of ListOperationsRequest', function() {
      ...
      //var instance = new AwsSystemsManagerForSap.ListOperationsRequest();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.ListOperationsRequest);
    });
