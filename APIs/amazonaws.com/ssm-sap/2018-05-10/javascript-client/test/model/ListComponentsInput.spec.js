...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.ListComponentsInput();
  });
  ...
  describe('ListComponentsInput', function() {
    it('should create an instance of ListComponentsInput', function() {
      ...
      //var instance = new AwsSystemsManagerForSap.ListComponentsInput();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.ListComponentsInput);
    });
