...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.DatabaseSummary();
  });
  ...
  describe('DatabaseSummary', function() {
    it('should create an instance of DatabaseSummary', function() {
      // uncomment below and update the code to test DatabaseSummary
      //var instance = new AwsSystemsManagerForSap.DatabaseSummary();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.DatabaseSummary);
    });
