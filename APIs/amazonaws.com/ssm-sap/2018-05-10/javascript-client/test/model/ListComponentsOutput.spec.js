...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.ListComponentsOutput();
  });
  ...
  describe('ListComponentsOutput', function() {
    it('should create an instance of ListComponentsOutput', function() {
      ...
      //var instance = new AwsSystemsManagerForSap.ListComponentsOutput();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.ListComponentsOutput);
    });
