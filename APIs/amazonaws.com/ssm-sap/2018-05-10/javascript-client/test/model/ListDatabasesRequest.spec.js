...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.ListDatabasesRequest();
  });
  ...
  describe('ListDatabasesRequest', function() {
    it('should create an instance of ListDatabasesRequest', function() {
      // uncomment below and update the code to test ListDatabasesRequest
      //var instance = new AwsSystemsManagerForSap.ListDatabasesRequest();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.ListDatabasesRequest);
    });
