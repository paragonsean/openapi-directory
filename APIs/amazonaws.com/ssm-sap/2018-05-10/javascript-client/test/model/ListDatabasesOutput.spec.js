...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.ListDatabasesOutput();
  });
  ...
  describe('ListDatabasesOutput', function() {
    it('should create an instance of ListDatabasesOutput', function() {
      // uncomment below and update the code to test ListDatabasesOutput
      //var instance = new AwsSystemsManagerForSap.ListDatabasesOutput();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.ListDatabasesOutput);
    });
