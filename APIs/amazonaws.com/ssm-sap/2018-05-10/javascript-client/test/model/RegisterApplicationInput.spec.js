...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.RegisterApplicationInput();
  });
  ...
  describe('RegisterApplicationInput', function() {
    it('should create an instance of RegisterApplicationInput', function() {
      // uncomment below and update the code to test RegisterApplicationInput
      //var instance = new AwsSystemsManagerForSap.RegisterApplicationInput();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.RegisterApplicationInput);
    });
