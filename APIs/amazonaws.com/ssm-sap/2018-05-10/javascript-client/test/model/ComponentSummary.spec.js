...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.ComponentSummary();
  });
  ...
  describe('ComponentSummary', function() {
    it('should create an instance of ComponentSummary', function() {
      ...
      //var instance = new AwsSystemsManagerForSap.ComponentSummary();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.ComponentSummary);
    });
