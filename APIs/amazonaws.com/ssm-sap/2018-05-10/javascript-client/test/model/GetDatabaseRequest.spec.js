...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.GetDatabaseRequest();
  });
  ...
  describe('GetDatabaseRequest', function() {
    it('should create an instance of GetDatabaseRequest', function() {
      // uncomment below and update the code to test GetDatabaseRequest
      //var instance = new AwsSystemsManagerForSap.GetDatabaseRequest();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.GetDatabaseRequest);
    });
