...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.GetComponentInput();
  });
  ...
  describe('GetComponentInput', function() {
    it('should create an instance of GetComponentInput', function() {
      // uncomment below and update the code to test GetComponentInput
      //var instance = new AwsSystemsManagerForSap.GetComponentInput();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.GetComponentInput);
    });
