...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.ListApplicationsOutput();
  });
  ...
  describe('ListApplicationsOutput', function() {
    it('should create an instance of ListApplicationsOutput', function() {
      // uncomment below and update the code to test ListApplicationsOutput
      //var instance = new AwsSystemsManagerForSap.ListApplicationsOutput();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.ListApplicationsOutput);
    });
