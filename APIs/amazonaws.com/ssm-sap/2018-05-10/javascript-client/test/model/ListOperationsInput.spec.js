...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.ListOperationsInput();
  });
  ...
  describe('ListOperationsInput', function() {
    it('should create an instance of ListOperationsInput', function() {
      // uncomment below and update the code to test ListOperationsInput
      //var instance = new AwsSystemsManagerForSap.ListOperationsInput();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.ListOperationsInput);
    });
