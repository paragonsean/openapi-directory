...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.GetApplicationOutputApplication();
  });
  ...
  describe('GetApplicationOutputApplication', function() {
    it('should create an instance of GetApplicationOutputApplication', function() {
      // uncomment below and update the code to test GetApplicationOutputApplication
      //var instance = new AwsSystemsManagerForSap.GetApplicationOutputApplication();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.GetApplicationOutputApplication);
    });
