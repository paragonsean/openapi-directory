...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new AwsSystemsManagerForSap.Operation();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.Operation);
    });
