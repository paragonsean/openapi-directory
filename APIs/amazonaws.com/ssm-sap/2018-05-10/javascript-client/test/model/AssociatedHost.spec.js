...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.AssociatedHost();
  });
  ...
  describe('AssociatedHost', function() {
    it('should create an instance of AssociatedHost', function() {
      // uncomment below and update the code to test AssociatedHost
      //var instance = new AwsSystemsManagerForSap.AssociatedHost();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.AssociatedHost);
    });
