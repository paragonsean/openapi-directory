...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.ComponentAssociatedHost();
  });
  ...
  describe('ComponentAssociatedHost', function() {
    it('should create an instance of ComponentAssociatedHost', function() {
      // uncomment below and update the code to test ComponentAssociatedHost
      //var instance = new AwsSystemsManagerForSap.ComponentAssociatedHost();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.ComponentAssociatedHost);
    });
