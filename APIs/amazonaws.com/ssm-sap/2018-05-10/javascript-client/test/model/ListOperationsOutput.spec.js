...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.ListOperationsOutput();
  });
  ...
  describe('ListOperationsOutput', function() {
    it('should create an instance of ListOperationsOutput', function() {
      // uncomment below and update the code to test ListOperationsOutput
      //var instance = new AwsSystemsManagerForSap.ListOperationsOutput();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.ListOperationsOutput);
    });
