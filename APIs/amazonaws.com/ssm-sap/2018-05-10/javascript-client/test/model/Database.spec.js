...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.Database();
  });
  ...
  describe('Database', function() {
    it('should create an instance of Database', function() {
      ...
      //var instance = new AwsSystemsManagerForSap.Database();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.Database);
    });
