...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerForSap.ListDatabasesInput();
  });
  ...
  describe('ListDatabasesInput', function() {
    it('should create an instance of ListDatabasesInput', function() {
      // uncomment below and update the code to test ListDatabasesInput
      //var instance = new AwsSystemsManagerForSap.ListDatabasesInput();
      //expect(instance).to.be.a(AwsSystemsManagerForSap.ListDatabasesInput);
    });
