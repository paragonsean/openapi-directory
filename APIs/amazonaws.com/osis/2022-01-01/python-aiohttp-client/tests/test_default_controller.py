...
async def test_create_pipeline(client):
    ...
    """
    body = {"PipelineConfigurationBody":"","MinUnits":"","PipelineName":"","VpcOptions":{"SubnetIds":"","SecurityGroupIds":""},"MaxUnits":"","LogPublishingOptions":{"CloudWatchLogDestination":{"LogGroup":""},"IsLoggingEnabled":""},"Tags":""}
    headers = { 
...
async def test_delete_pipeline(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/2022-01-01/osis/deletePipeline/{pipeline_name}'.format(pipeline_name='pipeline_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_pipeline(client):
    ...
    response = await client.request(
        method='GET',
        path='/2022-01-01/osis/getPipeline/{pipeline_name}'.format(pipeline_name='pipeline_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_pipeline_blueprint(client):
    """Test case for get_pipeline_blueprint
    ...
    response = await client.request(
        method='GET',
        path='/2022-01-01/osis/getPipelineBlueprint/{blueprint_name}'.format(blueprint_name='blueprint_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_pipeline_change_progress(client):
    """Test case for get_pipeline_change_progress
    ...
    response = await client.request(
        method='GET',
        path='/2022-01-01/osis/getPipelineChangeProgress/{pipeline_name}'.format(pipeline_name='pipeline_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_pipeline_blueprints(client):
    """Test case for list_pipeline_blueprints
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='GET',
        path='/2022-01-01/osis/listTagsForResource/#arn',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_pipeline(client):
    ...
    response = await client.request(
        method='PUT',
        path='/2022-01-01/osis/startPipeline/{pipeline_name}'.format(pipeline_name='pipeline_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_stop_pipeline(client):
    ...
    response = await client.request(
        method='PUT',
        path='/2022-01-01/osis/stopPipeline/{pipeline_name}'.format(pipeline_name='pipeline_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/2022-01-01/osis/tagResource/#arn',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/2022-01-01/osis/untagResource/#arn',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_update_pipeline(client):
    ...
    """
    body = {"PipelineConfigurationBody":"","MinUnits":"","MaxUnits":"","LogPublishingOptions":{"CloudWatchLogDestination":{"LogGroup":""},"IsLoggingEnabled":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='PUT',
        path='/2022-01-01/osis/updatePipeline/{pipeline_name}'.format(pipeline_name='pipeline_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_validate_pipeline(client):
    """Test case for validate_pipeline

    
    """
    body = {"PipelineConfigurationBody":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
