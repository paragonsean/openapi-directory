...
public class CreatePipelineResponsePipeline {
  ...
  public CreatePipelineResponsePipeline() {
  }

  public CreatePipelineResponsePipeline pipelineName(String pipelineName) {
  ...
  public CreatePipelineResponsePipeline pipelineArn(String pipelineArn) {
  ...
  public CreatePipelineResponsePipeline minUnits(Integer minUnits) {
  ...
  public CreatePipelineResponsePipeline maxUnits(Integer maxUnits) {
  ...
  public CreatePipelineResponsePipeline status(PipelineStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreatePipelineResponsePipeline statusReason(PipelineStatusReason statusReason) {
  ...
  public CreatePipelineResponsePipeline pipelineConfigurationBody(String pipelineConfigurationBody) {
  ...
  public CreatePipelineResponsePipeline createdAt(OffsetDateTime createdAt) {
  ...
  public CreatePipelineResponsePipeline lastUpdatedAt(OffsetDateTime lastUpdatedAt) {
  ...
  public CreatePipelineResponsePipeline ingestEndpointUrls(List ingestEndpointUrls) {
  ...
  public CreatePipelineResponsePipeline logPublishingOptions(PipelineLogPublishingOptions logPublishingOptions) {
  ...
  public CreatePipelineResponsePipeline vpcEndpoints(List vpcEndpoints) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePipelineResponsePipeline createPipelineResponsePipeline = (CreatePipelineResponsePipeline) o;
    return Objects.equals(this.pipelineName, createPipelineResponsePipeline.pipelineName) &&
        Objects.equals(this.pipelineArn, createPipelineResponsePipeline.pipelineArn) &&
        Objects.equals(this.minUnits, createPipelineResponsePipeline.minUnits) &&
        Objects.equals(this.maxUnits, createPipelineResponsePipeline.maxUnits) &&
        Objects.equals(this.status, createPipelineResponsePipeline.status) &&
        Objects.equals(this.statusReason, createPipelineResponsePipeline.statusReason) &&
        Objects.equals(this.pipelineConfigurationBody, createPipelineResponsePipeline.pipelineConfigurationBody) &&
        Objects.equals(this.createdAt, createPipelineResponsePipeline.createdAt) &&
        Objects.equals(this.lastUpdatedAt, createPipelineResponsePipeline.lastUpdatedAt) &&
        Objects.equals(this.ingestEndpointUrls, createPipelineResponsePipeline.ingestEndpointUrls) &&
        Objects.equals(this.logPublishingOptions, createPipelineResponsePipeline.logPublishingOptions) &&
        Objects.equals(this.vpcEndpoints, createPipelineResponsePipeline.vpcEndpoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePipelineResponsePipeline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePipelineResponsePipeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePipelineResponsePipeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePipelineResponsePipeline is not found in the empty JSON string", CreatePipelineResponsePipeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePipelineResponsePipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePipelineResponsePipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePipelineResponsePipeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePipelineResponsePipeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePipelineResponsePipeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePipelineResponsePipeline.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePipelineResponsePipeline>() {
           @Override
           public void write(JsonWriter out, CreatePipelineResponsePipeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePipelineResponsePipeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePipelineResponsePipeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePipelineResponsePipeline
   * @throws IOException if the JSON string is invalid with respect to CreatePipelineResponsePipeline
   */
  public static CreatePipelineResponsePipeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePipelineResponsePipeline.class);
  }

  /**
   * Convert an instance of CreatePipelineResponsePipeline to an JSON string
   *
   * @return JSON string
   */
