...
public class ApiClient {
    ...
    private String basePath = "http://osis.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://osis.{region}.amazonaws.com",
      "The Amazon OpenSearch Ingestion multi-region endpoint",
    ...
    new ServerConfiguration(
      "https://osis.{region}.amazonaws.com",
      "The Amazon OpenSearch Ingestion multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://osis.{region}.amazonaws.com.cn",
      "The Amazon OpenSearch Ingestion endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
          "cn-north-1",
    ...
    new ServerConfiguration(
      "https://osis.{region}.amazonaws.com.cn",
      "The Amazon OpenSearch Ingestion endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2022-01-01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://osis.us-east-1.amazonaws.com
