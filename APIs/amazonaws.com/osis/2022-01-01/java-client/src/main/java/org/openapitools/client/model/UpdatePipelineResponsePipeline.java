...
public class UpdatePipelineResponsePipeline {
  ...
  public UpdatePipelineResponsePipeline() {
  }

  public UpdatePipelineResponsePipeline pipelineName(String pipelineName) {
  ...
  public UpdatePipelineResponsePipeline pipelineArn(String pipelineArn) {
  ...
  public UpdatePipelineResponsePipeline minUnits(Integer minUnits) {
  ...
  public UpdatePipelineResponsePipeline maxUnits(Integer maxUnits) {
  ...
  public UpdatePipelineResponsePipeline status(PipelineStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdatePipelineResponsePipeline statusReason(PipelineStatusReason statusReason) {
  ...
  public UpdatePipelineResponsePipeline pipelineConfigurationBody(String pipelineConfigurationBody) {
  ...
  public UpdatePipelineResponsePipeline createdAt(OffsetDateTime createdAt) {
  ...
  public UpdatePipelineResponsePipeline lastUpdatedAt(OffsetDateTime lastUpdatedAt) {
  ...
  public UpdatePipelineResponsePipeline ingestEndpointUrls(List ingestEndpointUrls) {
  ...
  public UpdatePipelineResponsePipeline logPublishingOptions(PipelineLogPublishingOptions logPublishingOptions) {
  ...
  public UpdatePipelineResponsePipeline vpcEndpoints(List vpcEndpoints) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePipelineResponsePipeline updatePipelineResponsePipeline = (UpdatePipelineResponsePipeline) o;
    return Objects.equals(this.pipelineName, updatePipelineResponsePipeline.pipelineName) &&
        Objects.equals(this.pipelineArn, updatePipelineResponsePipeline.pipelineArn) &&
        Objects.equals(this.minUnits, updatePipelineResponsePipeline.minUnits) &&
        Objects.equals(this.maxUnits, updatePipelineResponsePipeline.maxUnits) &&
        Objects.equals(this.status, updatePipelineResponsePipeline.status) &&
        Objects.equals(this.statusReason, updatePipelineResponsePipeline.statusReason) &&
        Objects.equals(this.pipelineConfigurationBody, updatePipelineResponsePipeline.pipelineConfigurationBody) &&
        Objects.equals(this.createdAt, updatePipelineResponsePipeline.createdAt) &&
        Objects.equals(this.lastUpdatedAt, updatePipelineResponsePipeline.lastUpdatedAt) &&
        Objects.equals(this.ingestEndpointUrls, updatePipelineResponsePipeline.ingestEndpointUrls) &&
        Objects.equals(this.logPublishingOptions, updatePipelineResponsePipeline.logPublishingOptions) &&
        Objects.equals(this.vpcEndpoints, updatePipelineResponsePipeline.vpcEndpoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePipelineResponsePipeline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePipelineResponsePipeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePipelineResponsePipeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePipelineResponsePipeline is not found in the empty JSON string", UpdatePipelineResponsePipeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePipelineResponsePipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePipelineResponsePipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePipelineResponsePipeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePipelineResponsePipeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePipelineResponsePipeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePipelineResponsePipeline.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePipelineResponsePipeline>() {
           @Override
           public void write(JsonWriter out, UpdatePipelineResponsePipeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePipelineResponsePipeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePipelineResponsePipeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePipelineResponsePipeline
   * @throws IOException if the JSON string is invalid with respect to UpdatePipelineResponsePipeline
   */
  public static UpdatePipelineResponsePipeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePipelineResponsePipeline.class);
  }

  /**
   * Convert an instance of UpdatePipelineResponsePipeline to an JSON string
   *
   * @return JSON string
   */
