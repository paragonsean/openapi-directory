...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.PipelineBlueprint();
  });
  ...
  describe('PipelineBlueprint', function() {
    it('should create an instance of PipelineBlueprint', function() {
      // uncomment below and update the code to test PipelineBlueprint
      //var instance = new AmazonOpenSearchIngestion.PipelineBlueprint();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.PipelineBlueprint);
    });
