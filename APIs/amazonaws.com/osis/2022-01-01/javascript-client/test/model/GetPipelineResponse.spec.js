...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.GetPipelineResponse();
  });
  ...
  describe('GetPipelineResponse', function() {
    it('should create an instance of GetPipelineResponse', function() {
      // uncomment below and update the code to test GetPipelineResponse
      //var instance = new AmazonOpenSearchIngestion.GetPipelineResponse();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.GetPipelineResponse);
    });
