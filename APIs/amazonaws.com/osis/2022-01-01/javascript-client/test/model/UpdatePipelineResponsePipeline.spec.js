...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.UpdatePipelineResponsePipeline();
  });
  ...
  describe('UpdatePipelineResponsePipeline', function() {
    it('should create an instance of UpdatePipelineResponsePipeline', function() {
      // uncomment below and update the code to test UpdatePipelineResponsePipeline
      //var instance = new AmazonOpenSearchIngestion.UpdatePipelineResponsePipeline();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.UpdatePipelineResponsePipeline);
    });
