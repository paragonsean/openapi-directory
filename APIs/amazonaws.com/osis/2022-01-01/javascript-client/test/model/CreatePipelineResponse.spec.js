...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.CreatePipelineResponse();
  });
  ...
  describe('CreatePipelineResponse', function() {
    it('should create an instance of CreatePipelineResponse', function() {
      // uncomment below and update the code to test CreatePipelineResponse
      //var instance = new AmazonOpenSearchIngestion.CreatePipelineResponse();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.CreatePipelineResponse);
    });
