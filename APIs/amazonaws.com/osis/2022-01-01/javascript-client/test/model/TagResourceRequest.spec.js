...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonOpenSearchIngestion.TagResourceRequest();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.TagResourceRequest);
    });
