...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.ListPipelinesResponse();
  });
  ...
  describe('ListPipelinesResponse', function() {
    it('should create an instance of ListPipelinesResponse', function() {
      // uncomment below and update the code to test ListPipelinesResponse
      //var instance = new AmazonOpenSearchIngestion.ListPipelinesResponse();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.ListPipelinesResponse);
    });
    ...
    it('should have the property pipelines (base name: "Pipelines")', function() {
      // uncomment below and update the code to test the property pipelines
      //var instance = new AmazonOpenSearchIngestion.ListPipelinesResponse();
      //expect(instance).to.be();
    });
