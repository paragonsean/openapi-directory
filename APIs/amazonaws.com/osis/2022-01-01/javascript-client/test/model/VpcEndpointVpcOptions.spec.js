...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.VpcEndpointVpcOptions();
  });
  ...
  describe('VpcEndpointVpcOptions', function() {
    it('should create an instance of VpcEndpointVpcOptions', function() {
      ...
      //var instance = new AmazonOpenSearchIngestion.VpcEndpointVpcOptions();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.VpcEndpointVpcOptions);
    });
