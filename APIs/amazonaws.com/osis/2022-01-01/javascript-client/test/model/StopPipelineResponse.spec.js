...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.StopPipelineResponse();
  });
  ...
  describe('StopPipelineResponse', function() {
    it('should create an instance of StopPipelineResponse', function() {
      // uncomment below and update the code to test StopPipelineResponse
      //var instance = new AmazonOpenSearchIngestion.StopPipelineResponse();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.StopPipelineResponse);
    });
