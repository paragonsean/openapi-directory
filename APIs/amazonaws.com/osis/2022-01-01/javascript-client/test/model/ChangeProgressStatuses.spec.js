...
(function(root, factory) {
  ...
  describe('ChangeProgressStatuses', function() {
    it('should create an instance of ChangeProgressStatuses', function() {
      // uncomment below and update the code to test ChangeProgressStatuses
      //var instance = new AmazonOpenSearchIngestion.ChangeProgressStatuses();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.ChangeProgressStatuses);
    });
