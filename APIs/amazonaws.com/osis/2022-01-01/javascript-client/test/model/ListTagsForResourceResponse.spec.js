...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AmazonOpenSearchIngestion.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.ListTagsForResourceResponse);
    });
