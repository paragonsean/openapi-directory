...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.UpdatePipelineResponse();
  });
  ...
  describe('UpdatePipelineResponse', function() {
    it('should create an instance of UpdatePipelineResponse', function() {
      ...
      //var instance = new AmazonOpenSearchIngestion.UpdatePipelineResponse();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.UpdatePipelineResponse);
    });
