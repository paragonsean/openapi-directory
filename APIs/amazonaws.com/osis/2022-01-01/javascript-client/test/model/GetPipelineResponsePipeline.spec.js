...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.GetPipelineResponsePipeline();
  });
  ...
  describe('GetPipelineResponsePipeline', function() {
    it('should create an instance of GetPipelineResponsePipeline', function() {
      // uncomment below and update the code to test GetPipelineResponsePipeline
      //var instance = new AmazonOpenSearchIngestion.GetPipelineResponsePipeline();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.GetPipelineResponsePipeline);
    });
