...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.ChangeProgressStage();
  });
  ...
  describe('ChangeProgressStage', function() {
    it('should create an instance of ChangeProgressStage', function() {
      ...
      //var instance = new AmazonOpenSearchIngestion.ChangeProgressStage();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.ChangeProgressStage);
    });
