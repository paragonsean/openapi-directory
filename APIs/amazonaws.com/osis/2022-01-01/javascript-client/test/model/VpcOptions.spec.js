...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.VpcOptions();
  });
  ...
  describe('VpcOptions', function() {
    it('should create an instance of VpcOptions', function() {
      // uncomment below and update the code to test VpcOptions
      //var instance = new AmazonOpenSearchIngestion.VpcOptions();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.VpcOptions);
    });
