...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.VpcEndpoint();
  });
  ...
  describe('VpcEndpoint', function() {
    it('should create an instance of VpcEndpoint', function() {
      ...
      //var instance = new AmazonOpenSearchIngestion.VpcEndpoint();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.VpcEndpoint);
    });
