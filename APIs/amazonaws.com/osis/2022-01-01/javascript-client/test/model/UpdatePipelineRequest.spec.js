...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.UpdatePipelineRequest();
  });
  ...
  describe('UpdatePipelineRequest', function() {
    it('should create an instance of UpdatePipelineRequest', function() {
      // uncomment below and update the code to test UpdatePipelineRequest
      //var instance = new AmazonOpenSearchIngestion.UpdatePipelineRequest();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.UpdatePipelineRequest);
    });
