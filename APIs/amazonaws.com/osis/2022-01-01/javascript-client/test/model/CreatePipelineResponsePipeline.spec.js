...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.CreatePipelineResponsePipeline();
  });
  ...
  describe('CreatePipelineResponsePipeline', function() {
    it('should create an instance of CreatePipelineResponsePipeline', function() {
      // uncomment below and update the code to test CreatePipelineResponsePipeline
      //var instance = new AmazonOpenSearchIngestion.CreatePipelineResponsePipeline();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.CreatePipelineResponsePipeline);
    });
