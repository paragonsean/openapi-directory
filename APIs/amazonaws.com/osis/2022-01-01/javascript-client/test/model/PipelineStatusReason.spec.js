...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.PipelineStatusReason();
  });
  ...
  describe('PipelineStatusReason', function() {
    it('should create an instance of PipelineStatusReason', function() {
      // uncomment below and update the code to test PipelineStatusReason
      //var instance = new AmazonOpenSearchIngestion.PipelineStatusReason();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.PipelineStatusReason);
    });
