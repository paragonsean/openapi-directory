...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.GetPipelineBlueprintResponse();
  });
  ...
  describe('GetPipelineBlueprintResponse', function() {
    it('should create an instance of GetPipelineBlueprintResponse', function() {
      // uncomment below and update the code to test GetPipelineBlueprintResponse
      //var instance = new AmazonOpenSearchIngestion.GetPipelineBlueprintResponse();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.GetPipelineBlueprintResponse);
    });
