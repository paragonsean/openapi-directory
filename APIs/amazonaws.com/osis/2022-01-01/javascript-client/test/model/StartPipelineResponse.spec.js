...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.StartPipelineResponse();
  });
  ...
  describe('StartPipelineResponse', function() {
    it('should create an instance of StartPipelineResponse', function() {
      // uncomment below and update the code to test StartPipelineResponse
      //var instance = new AmazonOpenSearchIngestion.StartPipelineResponse();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.StartPipelineResponse);
    });
