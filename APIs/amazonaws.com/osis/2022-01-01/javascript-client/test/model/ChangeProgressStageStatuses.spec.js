...
(function(root, factory) {
  ...
  describe('ChangeProgressStageStatuses', function() {
    it('should create an instance of ChangeProgressStageStatuses', function() {
      // uncomment below and update the code to test ChangeProgressStageStatuses
      //var instance = new AmazonOpenSearchIngestion.ChangeProgressStageStatuses();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.ChangeProgressStageStatuses);
    });
