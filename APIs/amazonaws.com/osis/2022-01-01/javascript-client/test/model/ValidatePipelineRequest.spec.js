...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.ValidatePipelineRequest();
  });
  ...
  describe('ValidatePipelineRequest', function() {
    it('should create an instance of ValidatePipelineRequest', function() {
      // uncomment below and update the code to test ValidatePipelineRequest
      //var instance = new AmazonOpenSearchIngestion.ValidatePipelineRequest();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.ValidatePipelineRequest);
    });
