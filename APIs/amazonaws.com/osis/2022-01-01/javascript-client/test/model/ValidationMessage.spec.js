...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.ValidationMessage();
  });
  ...
  describe('ValidationMessage', function() {
    it('should create an instance of ValidationMessage', function() {
      ...
      //var instance = new AmazonOpenSearchIngestion.ValidationMessage();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.ValidationMessage);
    });
