...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.GetPipelineBlueprintResponseBlueprint();
  });
  ...
  describe('GetPipelineBlueprintResponseBlueprint', function() {
    it('should create an instance of GetPipelineBlueprintResponseBlueprint', function() {
      // uncomment below and update the code to test GetPipelineBlueprintResponseBlueprint
      //var instance = new AmazonOpenSearchIngestion.GetPipelineBlueprintResponseBlueprint();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.GetPipelineBlueprintResponseBlueprint);
    });
