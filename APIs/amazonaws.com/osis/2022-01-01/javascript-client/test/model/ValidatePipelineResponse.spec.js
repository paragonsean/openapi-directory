...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchIngestion.ValidatePipelineResponse();
  });
  ...
  describe('ValidatePipelineResponse', function() {
    it('should create an instance of ValidatePipelineResponse', function() {
      // uncomment below and update the code to test ValidatePipelineResponse
      //var instance = new AmazonOpenSearchIngestion.ValidatePipelineResponse();
      //expect(instance).to.be.a(AmazonOpenSearchIngestion.ValidatePipelineResponse);
    });
