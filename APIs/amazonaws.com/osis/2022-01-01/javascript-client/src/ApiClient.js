...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://osis.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://osis.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2022-01-01/Javascript'
        };
    ...
    hostSettings() {
        return [
            ...
            },
            {
              ...
              'description': "The Amazon OpenSearch Ingestion endpoint for China (Beijing) and China (Ningxia)",
              'variables': {
                region: {
                    'description': "The AWS region",
