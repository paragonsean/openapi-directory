...
class Example : public QObject {
    Q_OBJECT
    OAICreatePipeline_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAICreatePipeline_request Example::create(){
    OAICreatePipeline_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createPipelineSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createPipelineSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreatePipeline_request oai_create_pipeline_request = create(); // OAICreatePipeline_request | 
      ...
      apiInstance.createPipeline(oai_create_pipeline_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
