...
OAICreatePipelineRequest_LogPublishingOptions::OAICreatePipelineRequest_LogPublishingOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePipelineRequest_LogPublishingOptions::OAICreatePipelineRequest_LogPublishingOptions() {
    this->initializeModel();
}

OAICreatePipelineRequest_LogPublishingOptions::~OAICreatePipelineRequest_LogPublishingOptions() {}

void OAICreatePipelineRequest_LogPublishingOptions::initializeModel() {
...
void OAICreatePipelineRequest_LogPublishingOptions::fromJson(QString jsonString) {
...
void OAICreatePipelineRequest_LogPublishingOptions::fromJsonObject(QJsonObject json) {
...
QString OAICreatePipelineRequest_LogPublishingOptions::asJson() const {
...
QJsonObject OAICreatePipelineRequest_LogPublishingOptions::asJsonObject() const {
    QJsonObject obj;
...
bool OAICreatePipelineRequest_LogPublishingOptions::getIsLoggingEnabled() const {
    return m_is_logging_enabled;
}
void OAICreatePipelineRequest_LogPublishingOptions::setIsLoggingEnabled(const bool &is_logging_enabled) {
    m_is_logging_enabled = is_logging_enabled;
    m_is_logging_enabled_isSet = true;
}

bool OAICreatePipelineRequest_LogPublishingOptions::is_is_logging_enabled_Set() const{
    return m_is_logging_enabled_isSet;
}

bool OAICreatePipelineRequest_LogPublishingOptions::is_is_logging_enabled_Valid() const{
    return m_is_logging_enabled_isValid;
}

OAICreatePipeline_request_LogPublishingOptions_CloudWatchLogDestination OAICreatePipelineRequest_LogPublishingOptions::getCloudWatchLogDestination() const {
    return m_cloud_watch_log_destination;
}
void OAICreatePipelineRequest_LogPublishingOptions::setCloudWatchLogDestination(const OAICreatePipeline_request_LogPublishingOptions_CloudWatchLogDestination &cloud_watch_log_destination) {
    m_cloud_watch_log_destination = cloud_watch_log_destination;
    m_cloud_watch_log_destination_isSet = true;
}

bool OAICreatePipelineRequest_LogPublishingOptions::is_cloud_watch_log_destination_Set() const{
    return m_cloud_watch_log_destination_isSet;
}

bool OAICreatePipelineRequest_LogPublishingOptions::is_cloud_watch_log_destination_Valid() const{
    return m_cloud_watch_log_destination_isValid;
}

bool OAICreatePipelineRequest_LogPublishingOptions::isSet() const {
...
bool OAICreatePipelineRequest_LogPublishingOptions::isValid() const {
