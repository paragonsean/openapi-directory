...
qint32 OAIPipeline::getMinUnits() const {
    return m_min_units;
}
void OAIPipeline::setMinUnits(const qint32 &min_units) {
    m_min_units = min_units;
    m_min_units_isSet = true;
}

bool OAIPipeline::is_min_units_Set() const{
    return m_min_units_isSet;
}

bool OAIPipeline::is_min_units_Valid() const{
    return m_min_units_isValid;
}

qint32 OAIPipeline::getMaxUnits() const {
    return m_max_units;
}
void OAIPipeline::setMaxUnits(const qint32 &max_units) {
    m_max_units = max_units;
    m_max_units_isSet = true;
}

bool OAIPipeline::is_max_units_Set() const{
    return m_max_units_isSet;
}

bool OAIPipeline::is_max_units_Valid() const{
    return m_max_units_isValid;
}

OAIPipelineStatus OAIPipeline::getStatus() const {
    return m_status;
}
void OAIPipeline::setStatus(const OAIPipelineStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
OAIPipeline_StatusReason OAIPipeline::getStatusReason() const {
    return m_status_reason;
}
void OAIPipeline::setStatusReason(const OAIPipeline_StatusReason &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAIPipeline::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAIPipeline::is_status_reason_Valid() const{
    return m_status_reason_isValid;
}

QString OAIPipeline::getPipelineConfigurationBody() const {
    return m_pipeline_configuration_body;
}
void OAIPipeline::setPipelineConfigurationBody(const QString &pipeline_configuration_body) {
    m_pipeline_configuration_body = pipeline_configuration_body;
    m_pipeline_configuration_body_isSet = true;
}

bool OAIPipeline::is_pipeline_configuration_body_Set() const{
    return m_pipeline_configuration_body_isSet;
}

bool OAIPipeline::is_pipeline_configuration_body_Valid() const{
...
QDateTime OAIPipeline::getLastUpdatedAt() const {
    return m_last_updated_at;
}
void OAIPipeline::setLastUpdatedAt(const QDateTime &last_updated_at) {
    m_last_updated_at = last_updated_at;
    m_last_updated_at_isSet = true;
}

bool OAIPipeline::is_last_updated_at_Set() const{
    return m_last_updated_at_isSet;
}

bool OAIPipeline::is_last_updated_at_Valid() const{
    return m_last_updated_at_isValid;
}

QList OAIPipeline::getIngestEndpointUrls() const {
    return m_ingest_endpoint_urls;
}
void OAIPipeline::setIngestEndpointUrls(const QList &ingest_endpoint_urls) {
    m_ingest_endpoint_urls = ingest_endpoint_urls;
    m_ingest_endpoint_urls_isSet = true;
}

bool OAIPipeline::is_ingest_endpoint_urls_Set() const{
    return m_ingest_endpoint_urls_isSet;
}

bool OAIPipeline::is_ingest_endpoint_urls_Valid() const{
    return m_ingest_endpoint_urls_isValid;
}

OAIPipeline_LogPublishingOptions OAIPipeline::getLogPublishingOptions() const {
    return m_log_publishing_options;
}
void OAIPipeline::setLogPublishingOptions(const OAIPipeline_LogPublishingOptions &log_publishing_options) {
    m_log_publishing_options = log_publishing_options;
    m_log_publishing_options_isSet = true;
}

bool OAIPipeline::is_log_publishing_options_Set() const{
    return m_log_publishing_options_isSet;
}

bool OAIPipeline::is_log_publishing_options_Valid() const{
    return m_log_publishing_options_isValid;
}

QList OAIPipeline::getVpcEndpoints() const {
    return m_vpc_endpoints;
}
void OAIPipeline::setVpcEndpoints(const QList &vpc_endpoints) {
    m_vpc_endpoints = vpc_endpoints;
    m_vpc_endpoints_isSet = true;
}

bool OAIPipeline::is_vpc_endpoints_Set() const{
    return m_vpc_endpoints_isSet;
}

bool OAIPipeline::is_vpc_endpoints_Valid() const{
