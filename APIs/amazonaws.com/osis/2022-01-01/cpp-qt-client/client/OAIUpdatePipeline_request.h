...
/*
 * OAIUpdatePipeline_request.h
 *
 * 
 */

#ifndef OAIUpdatePipeline_request_H
#define OAIUpdatePipeline_request_H
...
class OAIUpdatePipeline_request : public OAIObject {
public:
    OAIUpdatePipeline_request();
    OAIUpdatePipeline_request(QString json);
    ~OAIUpdatePipeline_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipeline_request)

#endif // OAIUpdatePipeline_request_H
