...
OAIUpdatePipelineResponse_Pipeline::OAIUpdatePipelineResponse_Pipeline(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePipelineResponse_Pipeline::OAIUpdatePipelineResponse_Pipeline() {
    this->initializeModel();
}

OAIUpdatePipelineResponse_Pipeline::~OAIUpdatePipelineResponse_Pipeline() {}

void OAIUpdatePipelineResponse_Pipeline::initializeModel() {
...
void OAIUpdatePipelineResponse_Pipeline::fromJson(QString jsonString) {
...
void OAIUpdatePipelineResponse_Pipeline::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePipelineResponse_Pipeline::asJson() const {
...
QJsonObject OAIUpdatePipelineResponse_Pipeline::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdatePipelineResponse_Pipeline::getPipelineName() const {
    return m_pipeline_name;
}
void OAIUpdatePipelineResponse_Pipeline::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIUpdatePipelineResponse_Pipeline::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIUpdatePipelineResponse_Pipeline::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

QString OAIUpdatePipelineResponse_Pipeline::getPipelineArn() const {
    return m_pipeline_arn;
}
void OAIUpdatePipelineResponse_Pipeline::setPipelineArn(const QString &pipeline_arn) {
    m_pipeline_arn = pipeline_arn;
    m_pipeline_arn_isSet = true;
}

bool OAIUpdatePipelineResponse_Pipeline::is_pipeline_arn_Set() const{
    return m_pipeline_arn_isSet;
}

bool OAIUpdatePipelineResponse_Pipeline::is_pipeline_arn_Valid() const{
    return m_pipeline_arn_isValid;
}

qint32 OAIUpdatePipelineResponse_Pipeline::getMinUnits() const {
    return m_min_units;
}
void OAIUpdatePipelineResponse_Pipeline::setMinUnits(const qint32 &min_units) {
    m_min_units = min_units;
    m_min_units_isSet = true;
}

bool OAIUpdatePipelineResponse_Pipeline::is_min_units_Set() const{
    return m_min_units_isSet;
}

bool OAIUpdatePipelineResponse_Pipeline::is_min_units_Valid() const{
    return m_min_units_isValid;
}

qint32 OAIUpdatePipelineResponse_Pipeline::getMaxUnits() const {
    return m_max_units;
}
void OAIUpdatePipelineResponse_Pipeline::setMaxUnits(const qint32 &max_units) {
    m_max_units = max_units;
    m_max_units_isSet = true;
}

bool OAIUpdatePipelineResponse_Pipeline::is_max_units_Set() const{
    return m_max_units_isSet;
}

bool OAIUpdatePipelineResponse_Pipeline::is_max_units_Valid() const{
    return m_max_units_isValid;
}

OAIPipelineStatus OAIUpdatePipelineResponse_Pipeline::getStatus() const {
    return m_status;
}
void OAIUpdatePipelineResponse_Pipeline::setStatus(const OAIPipelineStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdatePipelineResponse_Pipeline::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdatePipelineResponse_Pipeline::is_status_Valid() const{
    return m_status_isValid;
}

OAIPipeline_StatusReason OAIUpdatePipelineResponse_Pipeline::getStatusReason() const {
    return m_status_reason;
}
void OAIUpdatePipelineResponse_Pipeline::setStatusReason(const OAIPipeline_StatusReason &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAIUpdatePipelineResponse_Pipeline::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAIUpdatePipelineResponse_Pipeline::is_status_reason_Valid() const{
    return m_status_reason_isValid;
}

QString OAIUpdatePipelineResponse_Pipeline::getPipelineConfigurationBody() const {
    return m_pipeline_configuration_body;
}
void OAIUpdatePipelineResponse_Pipeline::setPipelineConfigurationBody(const QString &pipeline_configuration_body) {
    m_pipeline_configuration_body = pipeline_configuration_body;
    m_pipeline_configuration_body_isSet = true;
}

bool OAIUpdatePipelineResponse_Pipeline::is_pipeline_configuration_body_Set() const{
    return m_pipeline_configuration_body_isSet;
}

bool OAIUpdatePipelineResponse_Pipeline::is_pipeline_configuration_body_Valid() const{
    return m_pipeline_configuration_body_isValid;
}

QDateTime OAIUpdatePipelineResponse_Pipeline::getCreatedAt() const {
    return m_created_at;
}
void OAIUpdatePipelineResponse_Pipeline::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIUpdatePipelineResponse_Pipeline::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIUpdatePipelineResponse_Pipeline::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIUpdatePipelineResponse_Pipeline::getLastUpdatedAt() const {
    return m_last_updated_at;
}
void OAIUpdatePipelineResponse_Pipeline::setLastUpdatedAt(const QDateTime &last_updated_at) {
    m_last_updated_at = last_updated_at;
    m_last_updated_at_isSet = true;
}

bool OAIUpdatePipelineResponse_Pipeline::is_last_updated_at_Set() const{
    return m_last_updated_at_isSet;
}

bool OAIUpdatePipelineResponse_Pipeline::is_last_updated_at_Valid() const{
    return m_last_updated_at_isValid;
}

QList OAIUpdatePipelineResponse_Pipeline::getIngestEndpointUrls() const {
    return m_ingest_endpoint_urls;
}
void OAIUpdatePipelineResponse_Pipeline::setIngestEndpointUrls(const QList &ingest_endpoint_urls) {
    m_ingest_endpoint_urls = ingest_endpoint_urls;
    m_ingest_endpoint_urls_isSet = true;
}

bool OAIUpdatePipelineResponse_Pipeline::is_ingest_endpoint_urls_Set() const{
    return m_ingest_endpoint_urls_isSet;
}

bool OAIUpdatePipelineResponse_Pipeline::is_ingest_endpoint_urls_Valid() const{
    return m_ingest_endpoint_urls_isValid;
}

OAIPipeline_LogPublishingOptions OAIUpdatePipelineResponse_Pipeline::getLogPublishingOptions() const {
    return m_log_publishing_options;
}
void OAIUpdatePipelineResponse_Pipeline::setLogPublishingOptions(const OAIPipeline_LogPublishingOptions &log_publishing_options) {
    m_log_publishing_options = log_publishing_options;
    m_log_publishing_options_isSet = true;
}

bool OAIUpdatePipelineResponse_Pipeline::is_log_publishing_options_Set() const{
    return m_log_publishing_options_isSet;
}

bool OAIUpdatePipelineResponse_Pipeline::is_log_publishing_options_Valid() const{
    return m_log_publishing_options_isValid;
}

QList OAIUpdatePipelineResponse_Pipeline::getVpcEndpoints() const {
    return m_vpc_endpoints;
}
void OAIUpdatePipelineResponse_Pipeline::setVpcEndpoints(const QList &vpc_endpoints) {
    m_vpc_endpoints = vpc_endpoints;
    m_vpc_endpoints_isSet = true;
}

bool OAIUpdatePipelineResponse_Pipeline::is_vpc_endpoints_Set() const{
    return m_vpc_endpoints_isSet;
}

bool OAIUpdatePipelineResponse_Pipeline::is_vpc_endpoints_Valid() const{
    return m_vpc_endpoints_isValid;
}

bool OAIUpdatePipelineResponse_Pipeline::isSet() const {
...
bool OAIUpdatePipelineResponse_Pipeline::isValid() const {
