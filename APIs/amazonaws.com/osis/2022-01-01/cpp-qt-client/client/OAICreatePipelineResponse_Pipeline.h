...
/*
 * OAICreatePipelineResponse_Pipeline.h
 *
 * 
 */

#ifndef OAICreatePipelineResponse_Pipeline_H
#define OAICreatePipelineResponse_Pipeline_H
...
class OAICreatePipelineResponse_Pipeline : public OAIObject {
public:
    OAICreatePipelineResponse_Pipeline();
    OAICreatePipelineResponse_Pipeline(QString json);
    ~OAICreatePipelineResponse_Pipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePipelineResponse_Pipeline)

#endif // OAICreatePipelineResponse_Pipeline_H
