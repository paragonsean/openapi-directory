...
/*
 * OAIPipelineBlueprint.h
 *
 * Container for information about an OpenSearch Ingestion blueprint.
 */

#ifndef OAIPipelineBlueprint_H
#define OAIPipelineBlueprint_H
...
class OAIPipelineBlueprint : public OAIObject {
public:
    OAIPipelineBlueprint();
    OAIPipelineBlueprint(QString json);
    ~OAIPipelineBlueprint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipelineBlueprint)

#endif // OAIPipelineBlueprint_H
