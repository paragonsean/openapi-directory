...
/*
 * OAIValidatePipelineRequest.h
 *
 * 
 */

#ifndef OAIValidatePipelineRequest_H
#define OAIValidatePipelineRequest_H
...
class OAIValidatePipelineRequest : public OAIObject {
public:
    OAIValidatePipelineRequest();
    OAIValidatePipelineRequest(QString json);
    ~OAIValidatePipelineRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidatePipelineRequest)

#endif // OAIValidatePipelineRequest_H
