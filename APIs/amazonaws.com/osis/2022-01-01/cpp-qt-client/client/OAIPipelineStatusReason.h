...
/*
 * OAIPipelineStatusReason.h
 *
 * Information about a pipeline&#39;s current status.
 */

#ifndef OAIPipelineStatusReason_H
#define OAIPipelineStatusReason_H
...
class OAIPipelineStatusReason : public OAIObject {
public:
    OAIPipelineStatusReason();
    OAIPipelineStatusReason(QString json);
    ~OAIPipelineStatusReason() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipelineStatusReason)

#endif // OAIPipelineStatusReason_H
