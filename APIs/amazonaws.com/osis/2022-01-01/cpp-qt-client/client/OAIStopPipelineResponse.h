...
/*
 * OAIStopPipelineResponse.h
 *
 * 
 */

#ifndef OAIStopPipelineResponse_H
#define OAIStopPipelineResponse_H
...
class OAIStopPipelineResponse : public OAIObject {
public:
    OAIStopPipelineResponse();
    OAIStopPipelineResponse(QString json);
    ~OAIStopPipelineResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopPipelineResponse)

#endif // OAIStopPipelineResponse_H
