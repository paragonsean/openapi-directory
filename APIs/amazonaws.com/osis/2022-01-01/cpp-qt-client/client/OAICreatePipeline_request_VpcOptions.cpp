...
OAICreatePipeline_request_VpcOptions::OAICreatePipeline_request_VpcOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePipeline_request_VpcOptions::OAICreatePipeline_request_VpcOptions() {
    this->initializeModel();
}

OAICreatePipeline_request_VpcOptions::~OAICreatePipeline_request_VpcOptions() {}

void OAICreatePipeline_request_VpcOptions::initializeModel() {
...
void OAICreatePipeline_request_VpcOptions::fromJson(QString jsonString) {
...
void OAICreatePipeline_request_VpcOptions::fromJsonObject(QJsonObject json) {
...
QString OAICreatePipeline_request_VpcOptions::asJson() const {
...
QJsonObject OAICreatePipeline_request_VpcOptions::asJsonObject() const {
    QJsonObject obj;
...
QList OAICreatePipeline_request_VpcOptions::getSubnetIds() const {
    return m_subnet_ids;
}
void OAICreatePipeline_request_VpcOptions::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAICreatePipeline_request_VpcOptions::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAICreatePipeline_request_VpcOptions::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAICreatePipeline_request_VpcOptions::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAICreatePipeline_request_VpcOptions::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAICreatePipeline_request_VpcOptions::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAICreatePipeline_request_VpcOptions::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

bool OAICreatePipeline_request_VpcOptions::isSet() const {
...
bool OAICreatePipeline_request_VpcOptions::isValid() const {
