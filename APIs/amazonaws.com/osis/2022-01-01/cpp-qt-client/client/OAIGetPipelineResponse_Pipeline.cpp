...
#include "OAIGetPipelineResponse_Pipeline.h"
...
OAIGetPipelineResponse_Pipeline::OAIGetPipelineResponse_Pipeline(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPipelineResponse_Pipeline::OAIGetPipelineResponse_Pipeline() {
    this->initializeModel();
}

OAIGetPipelineResponse_Pipeline::~OAIGetPipelineResponse_Pipeline() {}

void OAIGetPipelineResponse_Pipeline::initializeModel() {
...
void OAIGetPipelineResponse_Pipeline::fromJson(QString jsonString) {
...
void OAIGetPipelineResponse_Pipeline::fromJsonObject(QJsonObject json) {
...
QString OAIGetPipelineResponse_Pipeline::asJson() const {
...
QJsonObject OAIGetPipelineResponse_Pipeline::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPipelineResponse_Pipeline::getPipelineName() const {
    return m_pipeline_name;
}
void OAIGetPipelineResponse_Pipeline::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIGetPipelineResponse_Pipeline::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIGetPipelineResponse_Pipeline::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

QString OAIGetPipelineResponse_Pipeline::getPipelineArn() const {
    return m_pipeline_arn;
}
void OAIGetPipelineResponse_Pipeline::setPipelineArn(const QString &pipeline_arn) {
    m_pipeline_arn = pipeline_arn;
    m_pipeline_arn_isSet = true;
}

bool OAIGetPipelineResponse_Pipeline::is_pipeline_arn_Set() const{
    return m_pipeline_arn_isSet;
}

bool OAIGetPipelineResponse_Pipeline::is_pipeline_arn_Valid() const{
    return m_pipeline_arn_isValid;
}

qint32 OAIGetPipelineResponse_Pipeline::getMinUnits() const {
    return m_min_units;
}
void OAIGetPipelineResponse_Pipeline::setMinUnits(const qint32 &min_units) {
    m_min_units = min_units;
    m_min_units_isSet = true;
}

bool OAIGetPipelineResponse_Pipeline::is_min_units_Set() const{
    return m_min_units_isSet;
}

bool OAIGetPipelineResponse_Pipeline::is_min_units_Valid() const{
    return m_min_units_isValid;
}

qint32 OAIGetPipelineResponse_Pipeline::getMaxUnits() const {
    return m_max_units;
}
void OAIGetPipelineResponse_Pipeline::setMaxUnits(const qint32 &max_units) {
    m_max_units = max_units;
    m_max_units_isSet = true;
}

bool OAIGetPipelineResponse_Pipeline::is_max_units_Set() const{
    return m_max_units_isSet;
}

bool OAIGetPipelineResponse_Pipeline::is_max_units_Valid() const{
    return m_max_units_isValid;
}

OAIPipelineStatus OAIGetPipelineResponse_Pipeline::getStatus() const {
    return m_status;
}
void OAIGetPipelineResponse_Pipeline::setStatus(const OAIPipelineStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetPipelineResponse_Pipeline::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetPipelineResponse_Pipeline::is_status_Valid() const{
    return m_status_isValid;
}

OAIPipeline_StatusReason OAIGetPipelineResponse_Pipeline::getStatusReason() const {
    return m_status_reason;
}
void OAIGetPipelineResponse_Pipeline::setStatusReason(const OAIPipeline_StatusReason &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAIGetPipelineResponse_Pipeline::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAIGetPipelineResponse_Pipeline::is_status_reason_Valid() const{
    return m_status_reason_isValid;
}

QString OAIGetPipelineResponse_Pipeline::getPipelineConfigurationBody() const {
    return m_pipeline_configuration_body;
}
void OAIGetPipelineResponse_Pipeline::setPipelineConfigurationBody(const QString &pipeline_configuration_body) {
    m_pipeline_configuration_body = pipeline_configuration_body;
    m_pipeline_configuration_body_isSet = true;
}

bool OAIGetPipelineResponse_Pipeline::is_pipeline_configuration_body_Set() const{
    return m_pipeline_configuration_body_isSet;
}

bool OAIGetPipelineResponse_Pipeline::is_pipeline_configuration_body_Valid() const{
    return m_pipeline_configuration_body_isValid;
}

QDateTime OAIGetPipelineResponse_Pipeline::getCreatedAt() const {
    return m_created_at;
}
void OAIGetPipelineResponse_Pipeline::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGetPipelineResponse_Pipeline::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGetPipelineResponse_Pipeline::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIGetPipelineResponse_Pipeline::getLastUpdatedAt() const {
    return m_last_updated_at;
}
void OAIGetPipelineResponse_Pipeline::setLastUpdatedAt(const QDateTime &last_updated_at) {
    m_last_updated_at = last_updated_at;
    m_last_updated_at_isSet = true;
}

bool OAIGetPipelineResponse_Pipeline::is_last_updated_at_Set() const{
    return m_last_updated_at_isSet;
}

bool OAIGetPipelineResponse_Pipeline::is_last_updated_at_Valid() const{
    return m_last_updated_at_isValid;
}

QList OAIGetPipelineResponse_Pipeline::getIngestEndpointUrls() const {
    return m_ingest_endpoint_urls;
}
void OAIGetPipelineResponse_Pipeline::setIngestEndpointUrls(const QList &ingest_endpoint_urls) {
    m_ingest_endpoint_urls = ingest_endpoint_urls;
    m_ingest_endpoint_urls_isSet = true;
}

bool OAIGetPipelineResponse_Pipeline::is_ingest_endpoint_urls_Set() const{
    return m_ingest_endpoint_urls_isSet;
}

bool OAIGetPipelineResponse_Pipeline::is_ingest_endpoint_urls_Valid() const{
    return m_ingest_endpoint_urls_isValid;
}

OAIPipeline_LogPublishingOptions OAIGetPipelineResponse_Pipeline::getLogPublishingOptions() const {
    return m_log_publishing_options;
}
void OAIGetPipelineResponse_Pipeline::setLogPublishingOptions(const OAIPipeline_LogPublishingOptions &log_publishing_options) {
    m_log_publishing_options = log_publishing_options;
    m_log_publishing_options_isSet = true;
}

bool OAIGetPipelineResponse_Pipeline::is_log_publishing_options_Set() const{
    return m_log_publishing_options_isSet;
}

bool OAIGetPipelineResponse_Pipeline::is_log_publishing_options_Valid() const{
    return m_log_publishing_options_isValid;
}

QList OAIGetPipelineResponse_Pipeline::getVpcEndpoints() const {
    return m_vpc_endpoints;
}
void OAIGetPipelineResponse_Pipeline::setVpcEndpoints(const QList &vpc_endpoints) {
    m_vpc_endpoints = vpc_endpoints;
    m_vpc_endpoints_isSet = true;
}

bool OAIGetPipelineResponse_Pipeline::is_vpc_endpoints_Set() const{
    return m_vpc_endpoints_isSet;
}

bool OAIGetPipelineResponse_Pipeline::is_vpc_endpoints_Valid() const{
    return m_vpc_endpoints_isValid;
}

bool OAIGetPipelineResponse_Pipeline::isSet() const {
...
bool OAIGetPipelineResponse_Pipeline::isValid() const {
