...
/*
 * OAIUpdatePipelineResponse_Pipeline.h
 *
 * 
 */

#ifndef OAIUpdatePipelineResponse_Pipeline_H
#define OAIUpdatePipelineResponse_Pipeline_H
...
class OAIUpdatePipelineResponse_Pipeline : public OAIObject {
public:
    OAIUpdatePipelineResponse_Pipeline();
    OAIUpdatePipelineResponse_Pipeline(QString json);
    ~OAIUpdatePipelineResponse_Pipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipelineResponse_Pipeline)

#endif // OAIUpdatePipelineResponse_Pipeline_H
