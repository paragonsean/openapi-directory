...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://data.jobs.iot.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://data.jobs.iot.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2017-09-29/Javascript'
        };
