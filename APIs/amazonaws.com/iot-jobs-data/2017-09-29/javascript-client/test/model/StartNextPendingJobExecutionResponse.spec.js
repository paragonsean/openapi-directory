...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTJobsDataPlane.StartNextPendingJobExecutionResponse();
  });
  ...
  describe('StartNextPendingJobExecutionResponse', function() {
    it('should create an instance of StartNextPendingJobExecutionResponse', function() {
      // uncomment below and update the code to test StartNextPendingJobExecutionResponse
      //var instance = new AwsIoTJobsDataPlane.StartNextPendingJobExecutionResponse();
      //expect(instance).to.be.a(AwsIoTJobsDataPlane.StartNextPendingJobExecutionResponse);
    });
