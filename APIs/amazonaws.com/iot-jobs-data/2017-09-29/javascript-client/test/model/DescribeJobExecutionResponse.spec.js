...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTJobsDataPlane.DescribeJobExecutionResponse();
  });
  ...
  describe('DescribeJobExecutionResponse', function() {
    it('should create an instance of DescribeJobExecutionResponse', function() {
      // uncomment below and update the code to test DescribeJobExecutionResponse
      //var instance = new AwsIoTJobsDataPlane.DescribeJobExecutionResponse();
      //expect(instance).to.be.a(AwsIoTJobsDataPlane.DescribeJobExecutionResponse);
    });
