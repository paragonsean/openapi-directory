...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTJobsDataPlane.UpdateJobExecutionResponseExecutionState();
  });
  ...
  describe('UpdateJobExecutionResponseExecutionState', function() {
    it('should create an instance of UpdateJobExecutionResponseExecutionState', function() {
      // uncomment below and update the code to test UpdateJobExecutionResponseExecutionState
      //var instance = new AwsIoTJobsDataPlane.UpdateJobExecutionResponseExecutionState();
      //expect(instance).to.be.a(AwsIoTJobsDataPlane.UpdateJobExecutionResponseExecutionState);
    });
