...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTJobsDataPlane.JobExecutionState();
  });
  ...
  describe('JobExecutionState', function() {
    it('should create an instance of JobExecutionState', function() {
      // uncomment below and update the code to test JobExecutionState
      //var instance = new AwsIoTJobsDataPlane.JobExecutionState();
      //expect(instance).to.be.a(AwsIoTJobsDataPlane.JobExecutionState);
    });
