...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTJobsDataPlane.DescribeJobExecutionResponseExecution();
  });
  ...
  describe('DescribeJobExecutionResponseExecution', function() {
    it('should create an instance of DescribeJobExecutionResponseExecution', function() {
      // uncomment below and update the code to test DescribeJobExecutionResponseExecution
      //var instance = new AwsIoTJobsDataPlane.DescribeJobExecutionResponseExecution();
      //expect(instance).to.be.a(AwsIoTJobsDataPlane.DescribeJobExecutionResponseExecution);
    });
