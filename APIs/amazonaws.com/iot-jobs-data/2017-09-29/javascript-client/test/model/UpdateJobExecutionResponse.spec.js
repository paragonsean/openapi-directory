...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTJobsDataPlane.UpdateJobExecutionResponse();
  });
  ...
  describe('UpdateJobExecutionResponse', function() {
    it('should create an instance of UpdateJobExecutionResponse', function() {
      // uncomment below and update the code to test UpdateJobExecutionResponse
      //var instance = new AwsIoTJobsDataPlane.UpdateJobExecutionResponse();
      //expect(instance).to.be.a(AwsIoTJobsDataPlane.UpdateJobExecutionResponse);
    });
