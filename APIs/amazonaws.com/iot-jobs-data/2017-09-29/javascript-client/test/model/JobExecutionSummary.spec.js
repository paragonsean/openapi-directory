...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTJobsDataPlane.JobExecutionSummary();
  });
  ...
  describe('JobExecutionSummary', function() {
    it('should create an instance of JobExecutionSummary', function() {
      // uncomment below and update the code to test JobExecutionSummary
      //var instance = new AwsIoTJobsDataPlane.JobExecutionSummary();
      //expect(instance).to.be.a(AwsIoTJobsDataPlane.JobExecutionSummary);
    });
