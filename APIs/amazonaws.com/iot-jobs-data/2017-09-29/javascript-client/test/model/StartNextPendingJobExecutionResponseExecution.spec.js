...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTJobsDataPlane.StartNextPendingJobExecutionResponseExecution();
  });
  ...
  describe('StartNextPendingJobExecutionResponseExecution', function() {
    it('should create an instance of StartNextPendingJobExecutionResponseExecution', function() {
      // uncomment below and update the code to test StartNextPendingJobExecutionResponseExecution
      //var instance = new AwsIoTJobsDataPlane.StartNextPendingJobExecutionResponseExecution();
      //expect(instance).to.be.a(AwsIoTJobsDataPlane.StartNextPendingJobExecutionResponseExecution);
    });
