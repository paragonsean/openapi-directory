...
QString OAIJobExecution::getJobId() const {
    return m_job_id;
}
void OAIJobExecution::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIJobExecution::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIJobExecution::is_job_id_Valid() const{
    return m_job_id_isValid;
}

QString OAIJobExecution::getThingName() const {
    return m_thing_name;
}
void OAIJobExecution::setThingName(const QString &thing_name) {
    m_thing_name = thing_name;
    m_thing_name_isSet = true;
}

bool OAIJobExecution::is_thing_name_Set() const{
    return m_thing_name_isSet;
}

bool OAIJobExecution::is_thing_name_Valid() const{
    return m_thing_name_isValid;
}

OAIJobExecutionStatus OAIJobExecution::getStatus() const {
    return m_status;
}
void OAIJobExecution::setStatus(const OAIJobExecutionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIJobExecution::is_status_Set() const{
    return m_status_isSet;
}

bool OAIJobExecution::is_status_Valid() const{
    return m_status_isValid;
}

QMap OAIJobExecution::getStatusDetails() const {
    return m_status_details;
}
void OAIJobExecution::setStatusDetails(const QMap &status_details) {
    m_status_details = status_details;
    m_status_details_isSet = true;
}

bool OAIJobExecution::is_status_details_Set() const{
    return m_status_details_isSet;
}

bool OAIJobExecution::is_status_details_Valid() const{
    return m_status_details_isValid;
}

qint32 OAIJobExecution::getQueuedAt() const {
    return m_queued_at;
}
void OAIJobExecution::setQueuedAt(const qint32 &queued_at) {
    m_queued_at = queued_at;
    m_queued_at_isSet = true;
}

bool OAIJobExecution::is_queued_at_Set() const{
    return m_queued_at_isSet;
}

bool OAIJobExecution::is_queued_at_Valid() const{
    return m_queued_at_isValid;
}

qint32 OAIJobExecution::getStartedAt() const {
    return m_started_at;
}
void OAIJobExecution::setStartedAt(const qint32 &started_at) {
    m_started_at = started_at;
    m_started_at_isSet = true;
}

bool OAIJobExecution::is_started_at_Set() const{
    return m_started_at_isSet;
}

bool OAIJobExecution::is_started_at_Valid() const{
    return m_started_at_isValid;
}

qint32 OAIJobExecution::getLastUpdatedAt() const {
    return m_last_updated_at;
}
void OAIJobExecution::setLastUpdatedAt(const qint32 &last_updated_at) {
    m_last_updated_at = last_updated_at;
    m_last_updated_at_isSet = true;
}

bool OAIJobExecution::is_last_updated_at_Set() const{
    return m_last_updated_at_isSet;
}

bool OAIJobExecution::is_last_updated_at_Valid() const{
    return m_last_updated_at_isValid;
}

qint32 OAIJobExecution::getApproximateSecondsBeforeTimedOut() const {
    return m_approximate_seconds_before_timed_out;
}
void OAIJobExecution::setApproximateSecondsBeforeTimedOut(const qint32 &approximate_seconds_before_timed_out) {
...
bool OAIJobExecution::is_approximate_seconds_before_timed_out_Set() const{
    return m_approximate_seconds_before_timed_out_isSet;
}

bool OAIJobExecution::is_approximate_seconds_before_timed_out_Valid() const{
    return m_approximate_seconds_before_timed_out_isValid;
}

qint32 OAIJobExecution::getVersionNumber() const {
    return m_version_number;
}
void OAIJobExecution::setVersionNumber(const qint32 &version_number) {
    m_version_number = version_number;
    m_version_number_isSet = true;
}

bool OAIJobExecution::is_version_number_Set() const{
    return m_version_number_isSet;
}

bool OAIJobExecution::is_version_number_Valid() const{
    return m_version_number_isValid;
}

qint32 OAIJobExecution::getExecutionNumber() const {
    return m_execution_number;
}
void OAIJobExecution::setExecutionNumber(const qint32 &execution_number) {
    m_execution_number = execution_number;
    m_execution_number_isSet = true;
}

bool OAIJobExecution::is_execution_number_Set() const{
    return m_execution_number_isSet;
}

bool OAIJobExecution::is_execution_number_Valid() const{
    return m_execution_number_isValid;
}

QString OAIJobExecution::getJobDocument() const {
    return m_job_document;
}
void OAIJobExecution::setJobDocument(const QString &job_document) {
    m_job_document = job_document;
    m_job_document_isSet = true;
}

bool OAIJobExecution::is_job_document_Set() const{
    return m_job_document_isSet;
}

bool OAIJobExecution::is_job_document_Valid() const{
