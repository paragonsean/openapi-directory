...
/*
 * OAIJobExecutionState.h
 *
 * Contains data about the state of a job execution.
 */

#ifndef OAIJobExecutionState_H
#define OAIJobExecutionState_H
...
class OAIJobExecutionState : public OAIObject {
public:
    OAIJobExecutionState();
    OAIJobExecutionState(QString json);
    ~OAIJobExecutionState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobExecutionState)

#endif // OAIJobExecutionState_H
