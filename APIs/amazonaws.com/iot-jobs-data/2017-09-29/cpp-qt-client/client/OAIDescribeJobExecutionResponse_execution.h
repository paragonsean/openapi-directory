...
/*
 * OAIDescribeJobExecutionResponse_execution.h
 *
 * 
 */

#ifndef OAIDescribeJobExecutionResponse_execution_H
#define OAIDescribeJobExecutionResponse_execution_H
...
class OAIDescribeJobExecutionResponse_execution : public OAIObject {
public:
    OAIDescribeJobExecutionResponse_execution();
    OAIDescribeJobExecutionResponse_execution(QString json);
    ~OAIDescribeJobExecutionResponse_execution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeJobExecutionResponse_execution)

#endif // OAIDescribeJobExecutionResponse_execution_H
