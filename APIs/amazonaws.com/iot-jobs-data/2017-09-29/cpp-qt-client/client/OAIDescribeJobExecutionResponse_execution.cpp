...
OAIDescribeJobExecutionResponse_execution::OAIDescribeJobExecutionResponse_execution(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeJobExecutionResponse_execution::OAIDescribeJobExecutionResponse_execution() {
    this->initializeModel();
}

OAIDescribeJobExecutionResponse_execution::~OAIDescribeJobExecutionResponse_execution() {}

void OAIDescribeJobExecutionResponse_execution::initializeModel() {
...
void OAIDescribeJobExecutionResponse_execution::fromJson(QString jsonString) {
...
void OAIDescribeJobExecutionResponse_execution::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeJobExecutionResponse_execution::asJson() const {
...
QJsonObject OAIDescribeJobExecutionResponse_execution::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIDescribeJobExecutionResponse_execution::getJobId() const {
    return m_job_id;
}
void OAIDescribeJobExecutionResponse_execution::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIDescribeJobExecutionResponse_execution::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIDescribeJobExecutionResponse_execution::is_job_id_Valid() const{
    return m_job_id_isValid;
}

QString OAIDescribeJobExecutionResponse_execution::getThingName() const {
    return m_thing_name;
}
void OAIDescribeJobExecutionResponse_execution::setThingName(const QString &thing_name) {
    m_thing_name = thing_name;
    m_thing_name_isSet = true;
}

bool OAIDescribeJobExecutionResponse_execution::is_thing_name_Set() const{
    return m_thing_name_isSet;
}

bool OAIDescribeJobExecutionResponse_execution::is_thing_name_Valid() const{
    return m_thing_name_isValid;
}

OAIJobExecutionStatus OAIDescribeJobExecutionResponse_execution::getStatus() const {
    return m_status;
}
void OAIDescribeJobExecutionResponse_execution::setStatus(const OAIJobExecutionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDescribeJobExecutionResponse_execution::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDescribeJobExecutionResponse_execution::is_status_Valid() const{
    return m_status_isValid;
}

QMap OAIDescribeJobExecutionResponse_execution::getStatusDetails() const {
    return m_status_details;
}
void OAIDescribeJobExecutionResponse_execution::setStatusDetails(const QMap &status_details) {
    m_status_details = status_details;
    m_status_details_isSet = true;
}

bool OAIDescribeJobExecutionResponse_execution::is_status_details_Set() const{
    return m_status_details_isSet;
}

bool OAIDescribeJobExecutionResponse_execution::is_status_details_Valid() const{
    return m_status_details_isValid;
}

qint32 OAIDescribeJobExecutionResponse_execution::getQueuedAt() const {
    return m_queued_at;
}
void OAIDescribeJobExecutionResponse_execution::setQueuedAt(const qint32 &queued_at) {
    m_queued_at = queued_at;
    m_queued_at_isSet = true;
}

bool OAIDescribeJobExecutionResponse_execution::is_queued_at_Set() const{
    return m_queued_at_isSet;
}

bool OAIDescribeJobExecutionResponse_execution::is_queued_at_Valid() const{
    return m_queued_at_isValid;
}

qint32 OAIDescribeJobExecutionResponse_execution::getStartedAt() const {
    return m_started_at;
}
void OAIDescribeJobExecutionResponse_execution::setStartedAt(const qint32 &started_at) {
    m_started_at = started_at;
    m_started_at_isSet = true;
}

bool OAIDescribeJobExecutionResponse_execution::is_started_at_Set() const{
    return m_started_at_isSet;
}

bool OAIDescribeJobExecutionResponse_execution::is_started_at_Valid() const{
    return m_started_at_isValid;
}

qint32 OAIDescribeJobExecutionResponse_execution::getLastUpdatedAt() const {
    return m_last_updated_at;
}
void OAIDescribeJobExecutionResponse_execution::setLastUpdatedAt(const qint32 &last_updated_at) {
    m_last_updated_at = last_updated_at;
    m_last_updated_at_isSet = true;
}

bool OAIDescribeJobExecutionResponse_execution::is_last_updated_at_Set() const{
    return m_last_updated_at_isSet;
}

bool OAIDescribeJobExecutionResponse_execution::is_last_updated_at_Valid() const{
    return m_last_updated_at_isValid;
}

qint32 OAIDescribeJobExecutionResponse_execution::getApproximateSecondsBeforeTimedOut() const {
    return m_approximate_seconds_before_timed_out;
}
void OAIDescribeJobExecutionResponse_execution::setApproximateSecondsBeforeTimedOut(const qint32 &approximate_seconds_before_timed_out) {
...
bool OAIDescribeJobExecutionResponse_execution::is_approximate_seconds_before_timed_out_Set() const{
    return m_approximate_seconds_before_timed_out_isSet;
}

bool OAIDescribeJobExecutionResponse_execution::is_approximate_seconds_before_timed_out_Valid() const{
    return m_approximate_seconds_before_timed_out_isValid;
}

qint32 OAIDescribeJobExecutionResponse_execution::getVersionNumber() const {
    return m_version_number;
}
void OAIDescribeJobExecutionResponse_execution::setVersionNumber(const qint32 &version_number) {
    m_version_number = version_number;
    m_version_number_isSet = true;
}

bool OAIDescribeJobExecutionResponse_execution::is_version_number_Set() const{
    return m_version_number_isSet;
}

bool OAIDescribeJobExecutionResponse_execution::is_version_number_Valid() const{
    return m_version_number_isValid;
}

qint32 OAIDescribeJobExecutionResponse_execution::getExecutionNumber() const {
    return m_execution_number;
}
void OAIDescribeJobExecutionResponse_execution::setExecutionNumber(const qint32 &execution_number) {
    m_execution_number = execution_number;
    m_execution_number_isSet = true;
}

bool OAIDescribeJobExecutionResponse_execution::is_execution_number_Set() const{
    return m_execution_number_isSet;
}

bool OAIDescribeJobExecutionResponse_execution::is_execution_number_Valid() const{
    return m_execution_number_isValid;
}

QString OAIDescribeJobExecutionResponse_execution::getJobDocument() const {
    return m_job_document;
}
void OAIDescribeJobExecutionResponse_execution::setJobDocument(const QString &job_document) {
    m_job_document = job_document;
    m_job_document_isSet = true;
}

bool OAIDescribeJobExecutionResponse_execution::is_job_document_Set() const{
    return m_job_document_isSet;
}

bool OAIDescribeJobExecutionResponse_execution::is_job_document_Valid() const{
    return m_job_document_isValid;
}

bool OAIDescribeJobExecutionResponse_execution::isSet() const {
...
bool OAIDescribeJobExecutionResponse_execution::isValid() const {
