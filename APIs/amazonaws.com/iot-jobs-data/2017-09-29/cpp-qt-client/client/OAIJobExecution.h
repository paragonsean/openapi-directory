...
#ifndef OAIJobExecution_H
#define OAIJobExecution_H
...
class OAIJobExecution : public OAIObject {
public:
    OAIJobExecution();
    OAIJobExecution(QString json);
    ~OAIJobExecution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobExecution)

#endif // OAIJobExecution_H
