...
|------------ | ------------- | ------------- | -------------|
|**status** | [**StatusEnum**](#StatusEnum) | The new status for the job execution (IN_PROGRESS, FAILED, SUCCESS, or REJECTED). This must be specified on every update. |  |
|**statusDetails** | **Map&lt;String, String&gt;** |  Optional. A collection of name/value pairs that describe the status of the job execution. If not specified, the statusDetails are unchanged. |  [optional] |
...
|**executionNumber** | **Integer** | Optional. A number that identifies a particular job execution on a particular device. |  [optional] |
