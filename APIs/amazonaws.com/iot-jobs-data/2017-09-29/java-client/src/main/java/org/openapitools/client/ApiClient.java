...
public class ApiClient {
    ...
    private String basePath = "http://data.jobs.iot.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-09-29/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://data.jobs.iot.us-east-1.amazonaws.com
