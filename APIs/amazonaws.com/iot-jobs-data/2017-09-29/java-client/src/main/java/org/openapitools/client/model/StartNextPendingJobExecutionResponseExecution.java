...
public class StartNextPendingJobExecutionResponseExecution {
  ...
  public StartNextPendingJobExecutionResponseExecution() {
  }

  public StartNextPendingJobExecutionResponseExecution jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public StartNextPendingJobExecutionResponseExecution thingName(String thingName) {
  ...
  public StartNextPendingJobExecutionResponseExecution status(JobExecutionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public StartNextPendingJobExecutionResponseExecution statusDetails(Map statusDetails) {
  ...
  public StartNextPendingJobExecutionResponseExecution queuedAt(Integer queuedAt) {
  ...
  public StartNextPendingJobExecutionResponseExecution startedAt(Integer startedAt) {
  ...
  public StartNextPendingJobExecutionResponseExecution lastUpdatedAt(Integer lastUpdatedAt) {
  ...
  public StartNextPendingJobExecutionResponseExecution approximateSecondsBeforeTimedOut(Integer approximateSecondsBeforeTimedOut) {
  ...
  public StartNextPendingJobExecutionResponseExecution versionNumber(Integer versionNumber) {
  ...
  public StartNextPendingJobExecutionResponseExecution executionNumber(Integer executionNumber) {
  ...
  public StartNextPendingJobExecutionResponseExecution jobDocument(String jobDocument) {
  ...
  public boolean equals(Object o) {
    ...
    StartNextPendingJobExecutionResponseExecution startNextPendingJobExecutionResponseExecution = (StartNextPendingJobExecutionResponseExecution) o;
    return Objects.equals(this.jobId, startNextPendingJobExecutionResponseExecution.jobId) &&
        Objects.equals(this.thingName, startNextPendingJobExecutionResponseExecution.thingName) &&
        Objects.equals(this.status, startNextPendingJobExecutionResponseExecution.status) &&
        Objects.equals(this.statusDetails, startNextPendingJobExecutionResponseExecution.statusDetails) &&
        Objects.equals(this.queuedAt, startNextPendingJobExecutionResponseExecution.queuedAt) &&
        Objects.equals(this.startedAt, startNextPendingJobExecutionResponseExecution.startedAt) &&
        Objects.equals(this.lastUpdatedAt, startNextPendingJobExecutionResponseExecution.lastUpdatedAt) &&
        Objects.equals(this.approximateSecondsBeforeTimedOut, startNextPendingJobExecutionResponseExecution.approximateSecondsBeforeTimedOut) &&
        Objects.equals(this.versionNumber, startNextPendingJobExecutionResponseExecution.versionNumber) &&
        Objects.equals(this.executionNumber, startNextPendingJobExecutionResponseExecution.executionNumber) &&
        Objects.equals(this.jobDocument, startNextPendingJobExecutionResponseExecution.jobDocument);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartNextPendingJobExecutionResponseExecution {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartNextPendingJobExecutionResponseExecution
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartNextPendingJobExecutionResponseExecution.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartNextPendingJobExecutionResponseExecution is not found in the empty JSON string", StartNextPendingJobExecutionResponseExecution.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartNextPendingJobExecutionResponseExecution.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartNextPendingJobExecutionResponseExecution` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartNextPendingJobExecutionResponseExecution.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartNextPendingJobExecutionResponseExecution' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartNextPendingJobExecutionResponseExecution> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartNextPendingJobExecutionResponseExecution.class));

       return (TypeAdapter<T>) new TypeAdapter<StartNextPendingJobExecutionResponseExecution>() {
           @Override
           public void write(JsonWriter out, StartNextPendingJobExecutionResponseExecution value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartNextPendingJobExecutionResponseExecution read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartNextPendingJobExecutionResponseExecution given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartNextPendingJobExecutionResponseExecution
   * @throws IOException if the JSON string is invalid with respect to StartNextPendingJobExecutionResponseExecution
   */
  public static StartNextPendingJobExecutionResponseExecution fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartNextPendingJobExecutionResponseExecution.class);
  }

  /**
   * Convert an instance of StartNextPendingJobExecutionResponseExecution to an JSON string
   *
   * @return JSON string
   */
