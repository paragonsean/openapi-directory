...
/*
 * OAIDescribeProjectResponse_ProjectDescription.h
 *
 * 
 */

#ifndef OAIDescribeProjectResponse_ProjectDescription_H
#define OAIDescribeProjectResponse_ProjectDescription_H
...
class OAIDescribeProjectResponse_ProjectDescription : public OAIObject {
public:
    OAIDescribeProjectResponse_ProjectDescription();
    OAIDescribeProjectResponse_ProjectDescription(QString json);
    ~OAIDescribeProjectResponse_ProjectDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProjectResponse_ProjectDescription)

#endif // OAIDescribeProjectResponse_ProjectDescription_H
