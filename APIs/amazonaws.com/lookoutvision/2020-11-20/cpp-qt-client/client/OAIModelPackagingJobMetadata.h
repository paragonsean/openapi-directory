...
/*
 * OAIModelPackagingJobMetadata.h
 *
 *  Metadata for a model packaging job. For more information, see &lt;a&gt;ListModelPackagingJobs&lt;/a&gt;. 
 */

#ifndef OAIModelPackagingJobMetadata_H
#define OAIModelPackagingJobMetadata_H
...
class OAIModelPackagingJobMetadata : public OAIObject {
public:
    OAIModelPackagingJobMetadata();
    OAIModelPackagingJobMetadata(QString json);
    ~OAIModelPackagingJobMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelPackagingJobMetadata)

#endif // OAIModelPackagingJobMetadata_H
