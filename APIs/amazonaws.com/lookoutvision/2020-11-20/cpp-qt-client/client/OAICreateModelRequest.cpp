...
OAICreateModelRequest_OutputConfig OAICreateModelRequest::getOutputConfig() const {
    return m_output_config;
}
void OAICreateModelRequest::setOutputConfig(const OAICreateModelRequest_OutputConfig &output_config) {
    m_output_config = output_config;
    m_output_config_isSet = true;
}

bool OAICreateModelRequest::is_output_config_Set() const{
    return m_output_config_isSet;
}

bool OAICreateModelRequest::is_output_config_Valid() const{
    return m_output_config_isValid;
}

QString OAICreateModelRequest::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAICreateModelRequest::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAICreateModelRequest::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAICreateModelRequest::is_kms_key_id_Valid() const{
