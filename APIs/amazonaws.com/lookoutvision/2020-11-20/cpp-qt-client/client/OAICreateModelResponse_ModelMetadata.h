...
/*
 * OAICreateModelResponse_ModelMetadata.h
 *
 * 
 */

#ifndef OAICreateModelResponse_ModelMetadata_H
#define OAICreateModelResponse_ModelMetadata_H
...
class OAICreateModelResponse_ModelMetadata : public OAIObject {
public:
    OAICreateModelResponse_ModelMetadata();
    OAICreateModelResponse_ModelMetadata(QString json);
    ~OAICreateModelResponse_ModelMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateModelResponse_ModelMetadata)

#endif // OAICreateModelResponse_ModelMetadata_H
