...
/*
 * OAICreateProjectResponse_ProjectMetadata.h
 *
 * 
 */

#ifndef OAICreateProjectResponse_ProjectMetadata_H
#define OAICreateProjectResponse_ProjectMetadata_H
...
class OAICreateProjectResponse_ProjectMetadata : public OAIObject {
public:
    OAICreateProjectResponse_ProjectMetadata();
    OAICreateProjectResponse_ProjectMetadata(QString json);
    ~OAICreateProjectResponse_ProjectMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectResponse_ProjectMetadata)

#endif // OAICreateProjectResponse_ProjectMetadata_H
