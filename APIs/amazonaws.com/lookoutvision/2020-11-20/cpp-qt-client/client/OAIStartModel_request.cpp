...
OAIStartModel_request::OAIStartModel_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartModel_request::OAIStartModel_request() {
    this->initializeModel();
}

OAIStartModel_request::~OAIStartModel_request() {}

void OAIStartModel_request::initializeModel() {
...
void OAIStartModel_request::fromJson(QString jsonString) {
...
void OAIStartModel_request::fromJsonObject(QJsonObject json) {
...
QString OAIStartModel_request::asJson() const {
...
QJsonObject OAIStartModel_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIStartModel_request::getMinInferenceUnits() const {
    return m_min_inference_units;
}
void OAIStartModel_request::setMinInferenceUnits(const qint32 &min_inference_units) {
    m_min_inference_units = min_inference_units;
    m_min_inference_units_isSet = true;
}

bool OAIStartModel_request::is_min_inference_units_Set() const{
    return m_min_inference_units_isSet;
}

bool OAIStartModel_request::is_min_inference_units_Valid() const{
    return m_min_inference_units_isValid;
}

qint32 OAIStartModel_request::getMaxInferenceUnits() const {
    return m_max_inference_units;
}
void OAIStartModel_request::setMaxInferenceUnits(const qint32 &max_inference_units) {
    m_max_inference_units = max_inference_units;
    m_max_inference_units_isSet = true;
}

bool OAIStartModel_request::is_max_inference_units_Set() const{
    return m_max_inference_units_isSet;
}

bool OAIStartModel_request::is_max_inference_units_Valid() const{
    return m_max_inference_units_isValid;
}

bool OAIStartModel_request::isSet() const {
...
bool OAIStartModel_request::isValid() const {
