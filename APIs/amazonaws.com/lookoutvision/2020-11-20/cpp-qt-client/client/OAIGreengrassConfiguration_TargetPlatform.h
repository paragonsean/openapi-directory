...
/*
 * OAIGreengrassConfiguration_TargetPlatform.h
 *
 * 
 */

#ifndef OAIGreengrassConfiguration_TargetPlatform_H
#define OAIGreengrassConfiguration_TargetPlatform_H
...
class OAIGreengrassConfiguration_TargetPlatform : public OAIObject {
public:
    OAIGreengrassConfiguration_TargetPlatform();
    OAIGreengrassConfiguration_TargetPlatform(QString json);
    ~OAIGreengrassConfiguration_TargetPlatform() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGreengrassConfiguration_TargetPlatform)

#endif // OAIGreengrassConfiguration_TargetPlatform_H
