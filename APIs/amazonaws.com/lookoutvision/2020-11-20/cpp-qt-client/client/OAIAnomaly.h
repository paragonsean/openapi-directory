...
public:
    ...
    OAIAnomaly_PixelAnomaly getPixelAnomaly() const;
    void setPixelAnomaly(const OAIAnomaly_PixelAnomaly &pixel_anomaly);
    bool is_pixel_anomaly_Set() const;
    bool is_pixel_anomaly_Valid() const;
...
private:
    ...
    OAIAnomaly_PixelAnomaly m_pixel_anomaly;
    bool m_pixel_anomaly_isSet;
    bool m_pixel_anomaly_isValid;
};
