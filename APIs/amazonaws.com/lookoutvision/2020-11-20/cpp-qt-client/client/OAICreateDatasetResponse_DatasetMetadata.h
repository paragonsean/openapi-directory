...
/*
 * OAICreateDatasetResponse_DatasetMetadata.h
 *
 * 
 */

#ifndef OAICreateDatasetResponse_DatasetMetadata_H
#define OAICreateDatasetResponse_DatasetMetadata_H
...
class OAICreateDatasetResponse_DatasetMetadata : public OAIObject {
public:
    OAICreateDatasetResponse_DatasetMetadata();
    OAICreateDatasetResponse_DatasetMetadata(QString json);
    ~OAICreateDatasetResponse_DatasetMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDatasetResponse_DatasetMetadata)

#endif // OAICreateDatasetResponse_DatasetMetadata_H
