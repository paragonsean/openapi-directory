...
QString OAIModelDescription::getModelVersion() const {
    return m_model_version;
}
void OAIModelDescription::setModelVersion(const QString &model_version) {
    m_model_version = model_version;
    m_model_version_isSet = true;
}

bool OAIModelDescription::is_model_version_Set() const{
    return m_model_version_isSet;
}

bool OAIModelDescription::is_model_version_Valid() const{
    return m_model_version_isValid;
}

QString OAIModelDescription::getModelArn() const {
    return m_model_arn;
}
void OAIModelDescription::setModelArn(const QString &model_arn) {
    m_model_arn = model_arn;
    m_model_arn_isSet = true;
}

bool OAIModelDescription::is_model_arn_Set() const{
    return m_model_arn_isSet;
}

bool OAIModelDescription::is_model_arn_Valid() const{
    return m_model_arn_isValid;
}

QDateTime OAIModelDescription::getCreationTimestamp() const {
    return m_creation_timestamp;
}
void OAIModelDescription::setCreationTimestamp(const QDateTime &creation_timestamp) {
    m_creation_timestamp = creation_timestamp;
    m_creation_timestamp_isSet = true;
}

bool OAIModelDescription::is_creation_timestamp_Set() const{
    return m_creation_timestamp_isSet;
}

bool OAIModelDescription::is_creation_timestamp_Valid() const{
    return m_creation_timestamp_isValid;
}

QString OAIModelDescription::getDescription() const {
    return m_description;
}
void OAIModelDescription::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIModelDescription::is_description_Set() const{
    return m_description_isSet;
}

bool OAIModelDescription::is_description_Valid() const{
    return m_description_isValid;
}

OAIModelStatus OAIModelDescription::getStatus() const {
    return m_status;
}
void OAIModelDescription::setStatus(const OAIModelStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIModelDescription::is_status_Set() const{
    return m_status_isSet;
}

bool OAIModelDescription::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIModelDescription::getStatusMessage() const {
    return m_status_message;
}
void OAIModelDescription::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIModelDescription::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIModelDescription::is_status_message_Valid() const{
    return m_status_message_isValid;
}

OAIModelDescription_Performance OAIModelDescription::getPerformance() const {
    return m_performance;
}
void OAIModelDescription::setPerformance(const OAIModelDescription_Performance &performance) {
    m_performance = performance;
    m_performance_isSet = true;
}

bool OAIModelDescription::is_performance_Set() const{
    return m_performance_isSet;
}

bool OAIModelDescription::is_performance_Valid() const{
    return m_performance_isValid;
}

OAIModelDescription_OutputConfig OAIModelDescription::getOutputConfig() const {
    return m_output_config;
}
void OAIModelDescription::setOutputConfig(const OAIModelDescription_OutputConfig &output_config) {
    m_output_config = output_config;
    m_output_config_isSet = true;
}

bool OAIModelDescription::is_output_config_Set() const{
    return m_output_config_isSet;
}

bool OAIModelDescription::is_output_config_Valid() const{
    return m_output_config_isValid;
}

OAIModelDescription_EvaluationManifest OAIModelDescription::getEvaluationManifest() const {
    return m_evaluation_manifest;
}
void OAIModelDescription::setEvaluationManifest(const OAIModelDescription_EvaluationManifest &evaluation_manifest) {
    m_evaluation_manifest = evaluation_manifest;
    m_evaluation_manifest_isSet = true;
}

bool OAIModelDescription::is_evaluation_manifest_Set() const{
    return m_evaluation_manifest_isSet;
}

bool OAIModelDescription::is_evaluation_manifest_Valid() const{
    return m_evaluation_manifest_isValid;
}

OAIModelDescription_EvaluationResult OAIModelDescription::getEvaluationResult() const {
    return m_evaluation_result;
}
void OAIModelDescription::setEvaluationResult(const OAIModelDescription_EvaluationResult &evaluation_result) {
    m_evaluation_result = evaluation_result;
    m_evaluation_result_isSet = true;
}

bool OAIModelDescription::is_evaluation_result_Set() const{
    return m_evaluation_result_isSet;
}

bool OAIModelDescription::is_evaluation_result_Valid() const{
    return m_evaluation_result_isValid;
}

QDateTime OAIModelDescription::getEvaluationEndTimestamp() const {
    return m_evaluation_end_timestamp;
}
void OAIModelDescription::setEvaluationEndTimestamp(const QDateTime &evaluation_end_timestamp) {
    m_evaluation_end_timestamp = evaluation_end_timestamp;
    m_evaluation_end_timestamp_isSet = true;
}

bool OAIModelDescription::is_evaluation_end_timestamp_Set() const{
    return m_evaluation_end_timestamp_isSet;
}

bool OAIModelDescription::is_evaluation_end_timestamp_Valid() const{
    return m_evaluation_end_timestamp_isValid;
}

QString OAIModelDescription::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIModelDescription::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIModelDescription::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIModelDescription::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

qint32 OAIModelDescription::getMinInferenceUnits() const {
    return m_min_inference_units;
}
void OAIModelDescription::setMinInferenceUnits(const qint32 &min_inference_units) {
    m_min_inference_units = min_inference_units;
    m_min_inference_units_isSet = true;
}

bool OAIModelDescription::is_min_inference_units_Set() const{
    return m_min_inference_units_isSet;
}

bool OAIModelDescription::is_min_inference_units_Valid() const{
    return m_min_inference_units_isValid;
}

qint32 OAIModelDescription::getMaxInferenceUnits() const {
    return m_max_inference_units;
}
void OAIModelDescription::setMaxInferenceUnits(const qint32 &max_inference_units) {
    m_max_inference_units = max_inference_units;
    m_max_inference_units_isSet = true;
}

bool OAIModelDescription::is_max_inference_units_Set() const{
    return m_max_inference_units_isSet;
}

bool OAIModelDescription::is_max_inference_units_Valid() const{
