...
/*
 * OAIDescribeDatasetResponse_DatasetDescription.h
 *
 * 
 */

#ifndef OAIDescribeDatasetResponse_DatasetDescription_H
#define OAIDescribeDatasetResponse_DatasetDescription_H
...
class OAIDescribeDatasetResponse_DatasetDescription : public OAIObject {
public:
    OAIDescribeDatasetResponse_DatasetDescription();
    OAIDescribeDatasetResponse_DatasetDescription(QString json);
    ~OAIDescribeDatasetResponse_DatasetDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDatasetResponse_DatasetDescription)

#endif // OAIDescribeDatasetResponse_DatasetDescription_H
