...
/*
 * OAICreateDataset_request_DatasetSource.h
 *
 * Information about the location of a manifest file that Amazon Lookout for Vision uses to to create a dataset.
 */

#ifndef OAICreateDataset_request_DatasetSource_H
#define OAICreateDataset_request_DatasetSource_H
...
class OAICreateDataset_request_DatasetSource : public OAIObject {
public:
    OAICreateDataset_request_DatasetSource();
    OAICreateDataset_request_DatasetSource(QString json);
    ~OAICreateDataset_request_DatasetSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDataset_request_DatasetSource)

#endif // OAICreateDataset_request_DatasetSource_H
