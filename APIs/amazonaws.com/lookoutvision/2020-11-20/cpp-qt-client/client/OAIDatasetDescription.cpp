...
QString OAIDatasetDescription::getProjectName() const {
    return m_project_name;
}
void OAIDatasetDescription::setProjectName(const QString &project_name) {
    m_project_name = project_name;
    m_project_name_isSet = true;
}

bool OAIDatasetDescription::is_project_name_Set() const{
    return m_project_name_isSet;
}

bool OAIDatasetDescription::is_project_name_Valid() const{
    return m_project_name_isValid;
}

QString OAIDatasetDescription::getDatasetType() const {
    return m_dataset_type;
}
void OAIDatasetDescription::setDatasetType(const QString &dataset_type) {
    m_dataset_type = dataset_type;
    m_dataset_type_isSet = true;
}

bool OAIDatasetDescription::is_dataset_type_Set() const{
    return m_dataset_type_isSet;
}

bool OAIDatasetDescription::is_dataset_type_Valid() const{
...
OAIDatasetDescription_ImageStats OAIDatasetDescription::getImageStats() const {
    return m_image_stats;
}
void OAIDatasetDescription::setImageStats(const OAIDatasetDescription_ImageStats &image_stats) {
    m_image_stats = image_stats;
    m_image_stats_isSet = true;
}

bool OAIDatasetDescription::is_image_stats_Set() const{
    return m_image_stats_isSet;
}

bool OAIDatasetDescription::is_image_stats_Valid() const{
