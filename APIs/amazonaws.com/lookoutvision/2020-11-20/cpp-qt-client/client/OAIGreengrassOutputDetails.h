...
/*
 * OAIGreengrassOutputDetails.h
 *
 * Information about the AWS IoT Greengrass component created by a model packaging job. 
 */

#ifndef OAIGreengrassOutputDetails_H
#define OAIGreengrassOutputDetails_H
...
class OAIGreengrassOutputDetails : public OAIObject {
public:
    OAIGreengrassOutputDetails();
    OAIGreengrassOutputDetails(QString json);
    ~OAIGreengrassOutputDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGreengrassOutputDetails)

#endif // OAIGreengrassOutputDetails_H
