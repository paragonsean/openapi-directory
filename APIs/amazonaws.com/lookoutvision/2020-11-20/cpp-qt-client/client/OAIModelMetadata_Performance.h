...
/*
 * OAIModelMetadata_Performance.h
 *
 * 
 */

#ifndef OAIModelMetadata_Performance_H
#define OAIModelMetadata_Performance_H
...
class OAIModelMetadata_Performance : public OAIObject {
public:
    OAIModelMetadata_Performance();
    OAIModelMetadata_Performance(QString json);
    ~OAIModelMetadata_Performance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelMetadata_Performance)

#endif // OAIModelMetadata_Performance_H
