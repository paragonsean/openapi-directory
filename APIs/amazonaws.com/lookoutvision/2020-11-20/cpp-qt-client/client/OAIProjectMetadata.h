...
/*
 * OAIProjectMetadata.h
 *
 * Metadata about an Amazon Lookout for Vision project.
 */

#ifndef OAIProjectMetadata_H
#define OAIProjectMetadata_H
...
class OAIProjectMetadata : public OAIObject {
public:
    OAIProjectMetadata();
    OAIProjectMetadata(QString json);
    ~OAIProjectMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectMetadata)

#endif // OAIProjectMetadata_H
