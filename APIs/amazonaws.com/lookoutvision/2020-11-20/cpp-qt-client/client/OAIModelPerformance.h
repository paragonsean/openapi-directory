...
/*
 * OAIModelPerformance.h
 *
 * Information about the evaluation performance of a trained model. 
 */

#ifndef OAIModelPerformance_H
#define OAIModelPerformance_H
...
class OAIModelPerformance : public OAIObject {
public:
    OAIModelPerformance();
    OAIModelPerformance(QString json);
    ~OAIModelPerformance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelPerformance)

#endif // OAIModelPerformance_H
