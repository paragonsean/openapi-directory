...
/*
 * OAIDatasetImageStats.h
 *
 * Statistics about the images in a dataset.
 */

#ifndef OAIDatasetImageStats_H
#define OAIDatasetImageStats_H
...
class OAIDatasetImageStats : public OAIObject {
public:
    OAIDatasetImageStats();
    OAIDatasetImageStats(QString json);
    ~OAIDatasetImageStats() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatasetImageStats)

#endif // OAIDatasetImageStats_H
