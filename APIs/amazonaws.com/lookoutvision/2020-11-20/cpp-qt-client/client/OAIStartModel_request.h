...
/*
 * OAIStartModel_request.h
 *
 * 
 */

#ifndef OAIStartModel_request_H
#define OAIStartModel_request_H
...
class OAIStartModel_request : public OAIObject {
public:
    OAIStartModel_request();
    OAIStartModel_request(QString json);
    ~OAIStartModel_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartModel_request)

#endif // OAIStartModel_request_H
