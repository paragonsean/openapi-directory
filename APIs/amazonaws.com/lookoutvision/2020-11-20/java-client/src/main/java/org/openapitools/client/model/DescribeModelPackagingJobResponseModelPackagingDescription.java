...
public class DescribeModelPackagingJobResponseModelPackagingDescription {
  ...
  public DescribeModelPackagingJobResponseModelPackagingDescription() {
  }

  public DescribeModelPackagingJobResponseModelPackagingDescription jobName(String jobName) {
  ...
  public DescribeModelPackagingJobResponseModelPackagingDescription projectName(String projectName) {
  ...
  public DescribeModelPackagingJobResponseModelPackagingDescription modelVersion(String modelVersion) {
  ...
  public DescribeModelPackagingJobResponseModelPackagingDescription modelPackagingConfiguration(ModelPackagingDescriptionModelPackagingConfiguration modelPackagingConfiguration) {
  ...
  public DescribeModelPackagingJobResponseModelPackagingDescription modelPackagingJobDescription(String modelPackagingJobDescription) {
  ...
  public DescribeModelPackagingJobResponseModelPackagingDescription modelPackagingMethod(String modelPackagingMethod) {
  ...
  public DescribeModelPackagingJobResponseModelPackagingDescription modelPackagingOutputDetails(ModelPackagingDescriptionModelPackagingOutputDetails modelPackagingOutputDetails) {
  ...
  public DescribeModelPackagingJobResponseModelPackagingDescription status(ModelPackagingJobStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DescribeModelPackagingJobResponseModelPackagingDescription statusMessage(String statusMessage) {
  ...
  public DescribeModelPackagingJobResponseModelPackagingDescription creationTimestamp(OffsetDateTime creationTimestamp) {
  ...
  public DescribeModelPackagingJobResponseModelPackagingDescription lastUpdatedTimestamp(OffsetDateTime lastUpdatedTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeModelPackagingJobResponseModelPackagingDescription describeModelPackagingJobResponseModelPackagingDescription = (DescribeModelPackagingJobResponseModelPackagingDescription) o;
    return Objects.equals(this.jobName, describeModelPackagingJobResponseModelPackagingDescription.jobName) &&
        Objects.equals(this.projectName, describeModelPackagingJobResponseModelPackagingDescription.projectName) &&
        Objects.equals(this.modelVersion, describeModelPackagingJobResponseModelPackagingDescription.modelVersion) &&
        Objects.equals(this.modelPackagingConfiguration, describeModelPackagingJobResponseModelPackagingDescription.modelPackagingConfiguration) &&
        Objects.equals(this.modelPackagingJobDescription, describeModelPackagingJobResponseModelPackagingDescription.modelPackagingJobDescription) &&
        Objects.equals(this.modelPackagingMethod, describeModelPackagingJobResponseModelPackagingDescription.modelPackagingMethod) &&
        Objects.equals(this.modelPackagingOutputDetails, describeModelPackagingJobResponseModelPackagingDescription.modelPackagingOutputDetails) &&
        Objects.equals(this.status, describeModelPackagingJobResponseModelPackagingDescription.status) &&
        Objects.equals(this.statusMessage, describeModelPackagingJobResponseModelPackagingDescription.statusMessage) &&
        Objects.equals(this.creationTimestamp, describeModelPackagingJobResponseModelPackagingDescription.creationTimestamp) &&
        Objects.equals(this.lastUpdatedTimestamp, describeModelPackagingJobResponseModelPackagingDescription.lastUpdatedTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeModelPackagingJobResponseModelPackagingDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeModelPackagingJobResponseModelPackagingDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeModelPackagingJobResponseModelPackagingDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeModelPackagingJobResponseModelPackagingDescription is not found in the empty JSON string", DescribeModelPackagingJobResponseModelPackagingDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeModelPackagingJobResponseModelPackagingDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeModelPackagingJobResponseModelPackagingDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeModelPackagingJobResponseModelPackagingDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeModelPackagingJobResponseModelPackagingDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeModelPackagingJobResponseModelPackagingDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeModelPackagingJobResponseModelPackagingDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeModelPackagingJobResponseModelPackagingDescription>() {
           @Override
           public void write(JsonWriter out, DescribeModelPackagingJobResponseModelPackagingDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeModelPackagingJobResponseModelPackagingDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeModelPackagingJobResponseModelPackagingDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeModelPackagingJobResponseModelPackagingDescription
   * @throws IOException if the JSON string is invalid with respect to DescribeModelPackagingJobResponseModelPackagingDescription
   */
  public static DescribeModelPackagingJobResponseModelPackagingDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeModelPackagingJobResponseModelPackagingDescription.class);
  }

  /**
   * Convert an instance of DescribeModelPackagingJobResponseModelPackagingDescription to an JSON string
   *
   * @return JSON string
   */
