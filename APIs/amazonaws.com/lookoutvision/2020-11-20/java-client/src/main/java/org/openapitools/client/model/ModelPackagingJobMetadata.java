...
public class ModelPackagingJobMetadata {
  ...
  public ModelPackagingJobMetadata() {
  }

  public ModelPackagingJobMetadata jobName(String jobName) {
  ...
  public ModelPackagingJobMetadata projectName(String projectName) {
  ...
  public ModelPackagingJobMetadata modelVersion(String modelVersion) {
  ...
  public ModelPackagingJobMetadata modelPackagingJobDescription(String modelPackagingJobDescription) {
  ...
  public ModelPackagingJobMetadata modelPackagingMethod(String modelPackagingMethod) {
  ...
  public ModelPackagingJobMetadata status(ModelPackagingJobStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ModelPackagingJobMetadata statusMessage(String statusMessage) {
  ...
  public ModelPackagingJobMetadata creationTimestamp(OffsetDateTime creationTimestamp) {
  ...
  public ModelPackagingJobMetadata lastUpdatedTimestamp(OffsetDateTime lastUpdatedTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    ModelPackagingJobMetadata modelPackagingJobMetadata = (ModelPackagingJobMetadata) o;
    return Objects.equals(this.jobName, modelPackagingJobMetadata.jobName) &&
        Objects.equals(this.projectName, modelPackagingJobMetadata.projectName) &&
        Objects.equals(this.modelVersion, modelPackagingJobMetadata.modelVersion) &&
        Objects.equals(this.modelPackagingJobDescription, modelPackagingJobMetadata.modelPackagingJobDescription) &&
        Objects.equals(this.modelPackagingMethod, modelPackagingJobMetadata.modelPackagingMethod) &&
        Objects.equals(this.status, modelPackagingJobMetadata.status) &&
        Objects.equals(this.statusMessage, modelPackagingJobMetadata.statusMessage) &&
        Objects.equals(this.creationTimestamp, modelPackagingJobMetadata.creationTimestamp) &&
        Objects.equals(this.lastUpdatedTimestamp, modelPackagingJobMetadata.lastUpdatedTimestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobName, projectName, modelVersion, modelPackagingJobDescription, modelPackagingMethod, status, statusMessage, creationTimestamp, lastUpdatedTimestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ModelPackagingJobMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModelPackagingJobMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelPackagingJobMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelPackagingJobMetadata is not found in the empty JSON string", ModelPackagingJobMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelPackagingJobMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelPackagingJobMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelPackagingJobMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelPackagingJobMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelPackagingJobMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelPackagingJobMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelPackagingJobMetadata>() {
           @Override
           public void write(JsonWriter out, ModelPackagingJobMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelPackagingJobMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModelPackagingJobMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModelPackagingJobMetadata
   * @throws IOException if the JSON string is invalid with respect to ModelPackagingJobMetadata
   */
  public static ModelPackagingJobMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelPackagingJobMetadata.class);
  }

  /**
   * Convert an instance of ModelPackagingJobMetadata to an JSON string
   *
   * @return JSON string
   */
