...
public class ApiClient {
    ...
    private String basePath = "http://lookoutvision.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://lookoutvision.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://lookoutvision.{region}.amazonaws.com",
      "The Amazon Lookout for Vision multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://lookoutvision.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://lookoutvision.{region}.amazonaws.com.cn",
      "The Amazon Lookout for Vision endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2020-11-20/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://lookoutvision.us-east-1.amazonaws.com
