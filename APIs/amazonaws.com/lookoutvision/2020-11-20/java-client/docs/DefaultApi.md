...
# **createDataset**
> CreateDatasetResponse createDataset(projectName, createDatasetRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken)
...
<a id="createModel"></a>
# **createModel**
> CreateModelResponse createModel(projectName, createModelRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project in which you want to create a model version.
    ...
    try {
      CreateModelResponse result = apiInstance.createModel(projectName, createModelRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken);
      System.out.println(result);
    } catch (ApiException e) {
...
# **createProject**
> CreateProjectResponse createProject(createProjectRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CreateProjectResponse result = apiInstance.createProject(createProjectRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken);
      System.out.println(result);
    } catch (ApiException e) {
...
# **deleteDataset**
> Object deleteDataset(projectName, datasetType, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project that contains the dataset that you want to delete.
    String datasetType = "datasetType_example"; // String | The type of the dataset to delete. Specify <code>train</code> to delete the training dataset. Specify <code>test</code> to delete the test dataset. To delete the dataset in a single dataset project, specify <code>train</code>.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    try {
      Object result = apiInstance.deleteDataset(projectName, datasetType, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="deleteModel"></a>
# **deleteModel**
> DeleteModelResponse deleteModel(projectName, modelVersion, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project that contains the model that you want to delete.
    String modelVersion = "modelVersion_example"; // String | The version of the model that you want to delete.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    try {
      DeleteModelResponse result = apiInstance.deleteModel(projectName, modelVersion, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken);
      System.out.println(result);
    } catch (ApiException e) {
...
# **deleteProject**
> DeleteProjectResponse deleteProject(projectName, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project to delete.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    try {
      DeleteProjectResponse result = apiInstance.deleteProject(projectName, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="describeDataset"></a>
# **describeDataset**
> DescribeDatasetResponse describeDataset(projectName, datasetType, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project that contains the dataset that you want to describe.
    String datasetType = "datasetType_example"; // String | The type of the dataset to describe. Specify <code>train</code> to describe the training dataset. Specify <code>test</code> to describe the test dataset. If you have a single dataset project, specify <code>train</code> 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      DescribeDatasetResponse result = apiInstance.describeDataset(projectName, datasetType, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#describeDataset");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="describeModel"></a>
# **describeModel**
> DescribeModelResponse describeModel(projectName, modelVersion, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The project that contains the version of a model that you want to describe.
    String modelVersion = "modelVersion_example"; // String | The version of the model that you want to describe.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      DescribeModelResponse result = apiInstance.describeModel(projectName, modelVersion, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#describeModel");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="describeModelPackagingJob"></a>
# **describeModelPackagingJob**
> DescribeModelPackagingJobResponse describeModelPackagingJob(projectName, jobName, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project that contains the model packaging job that you want to describe. 
    String jobName = "jobName_example"; // String | The job name for the model packaging job. 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      DescribeModelPackagingJobResponse result = apiInstance.describeModelPackagingJob(projectName, jobName, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#describeModelPackagingJob");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **describeProject**
> DescribeProjectResponse describeProject(projectName, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project that you want to describe.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      DescribeProjectResponse result = apiInstance.describeProject(projectName, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="detectAnomalies"></a>
# **detectAnomalies**
> DetectAnomaliesResponse detectAnomalies(projectName, modelVersion, contentType, detectAnomaliesRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project that contains the model version that you want to use.
    String modelVersion = "modelVersion_example"; // String | The version of the model that you want to use.
    String contentType = "contentType_example"; // String | The type of the image passed in <code>Body</code>. Valid values are <code>image/png</code> (PNG format images) and <code>image/jpeg</code> (JPG format images). 
    DetectAnomaliesRequest detectAnomaliesRequest = new DetectAnomaliesRequest(); // DetectAnomaliesRequest | 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      DetectAnomaliesResponse result = apiInstance.detectAnomalies(projectName, modelVersion, contentType, detectAnomaliesRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#detectAnomalies");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="listDatasetEntries"></a>
# **listDatasetEntries**
> ListDatasetEntriesResponse listDatasetEntries(projectName, datasetType, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, labeled, anomalyClass, createdBefore, createdAfter, nextToken, maxResults, sourceRefContains, maxResults2, nextToken2)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project that contains the dataset that you want to list.
    String datasetType = "datasetType_example"; // String | The type of the dataset that you want to list. Specify <code>train</code> to list the training dataset. Specify <code>test</code> to list the test dataset. If you have a single dataset project, specify <code>train</code>.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    String xAmzSignature = "xAmzSignature_example"; // String | 
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    Boolean labeled = true; // Boolean | Specify <code>true</code> to include labeled entries, otherwise specify <code>false</code>. If you don't specify a value, Lookout for Vision returns all entries.
    String anomalyClass = "anomalyClass_example"; // String | Specify <code>normal</code> to include only normal images. Specify <code>anomaly</code> to only include anomalous entries. If you don't specify a value, Amazon Lookout for Vision returns normal and anomalous images.
    OffsetDateTime createdBefore = OffsetDateTime.now(); // OffsetDateTime | Only includes entries before the specified date in the response. For example, <code>2020-06-23T00:00:00</code>.
    OffsetDateTime createdAfter = OffsetDateTime.now(); // OffsetDateTime | Only includes entries after the specified date in the response. For example, <code>2020-06-23T00:00:00</code>.
    String nextToken = "nextToken_example"; // String | If the previous response was incomplete (because there is more data to retrieve), Amazon Lookout for Vision returns a pagination token in the response. You can use this pagination token to retrieve the next set of dataset entries.
    Integer maxResults = 56; // Integer | The maximum number of results to return per paginated call. The largest value you can specify is 100. If you specify a value greater than 100, a ValidationException error occurs. The default value is 100.
    String sourceRefContains = "sourceRefContains_example"; // String | Perform a \"contains\" search on the values of the <code>source-ref</code> key within the dataset. For example a value of \"IMG_17\" returns all JSON Lines where the <code>source-ref</code> key value matches <i>*IMG_17*</i>.
    String maxResults2 = "maxResults_example"; // String | Pagination limit
    String nextToken2 = "nextToken_example"; // String | Pagination token
    try {
      ListDatasetEntriesResponse result = apiInstance.listDatasetEntries(projectName, datasetType, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, labeled, anomalyClass, createdBefore, createdAfter, nextToken, maxResults, sourceRefContains, maxResults2, nextToken2);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#listDatasetEntries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **createdBefore** | **OffsetDateTime**| Only includes entries before the specified date in the response. For example, &lt;code&gt;2020-06-23T00:00:00&lt;/code&gt;. | [optional] |
| **createdAfter** | **OffsetDateTime**| Only includes entries after the specified date in the response. For example, &lt;code&gt;2020-06-23T00:00:00&lt;/code&gt;. | [optional] |
...
| **maxResults** | **Integer**| The maximum number of results to return per paginated call. The largest value you can specify is 100. If you specify a value greater than 100, a ValidationException error occurs. The default value is 100. | [optional] |
...
<a id="listModelPackagingJobs"></a>
# **listModelPackagingJobs**
> ListModelPackagingJobsResponse listModelPackagingJobs(projectName, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, nextToken, maxResults, maxResults2, nextToken2)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String |  The name of the project for which you want to list the model packaging jobs. 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    String xAmzSignature = "xAmzSignature_example"; // String | 
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    String nextToken = "nextToken_example"; // String | If the previous response was incomplete (because there is more results to retrieve), Amazon Lookout for Vision returns a pagination token in the response. You can use this pagination token to retrieve the next set of results. 
    Integer maxResults = 56; // Integer | The maximum number of results to return per paginated call. The largest value you can specify is 100. If you specify a value greater than 100, a ValidationException error occurs. The default value is 100. 
    String maxResults2 = "maxResults_example"; // String | Pagination limit
    String nextToken2 = "nextToken_example"; // String | Pagination token
    try {
      ListModelPackagingJobsResponse result = apiInstance.listModelPackagingJobs(projectName, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, nextToken, maxResults, maxResults2, nextToken2);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#listModelPackagingJobs");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="listModels"></a>
# **listModels**
> ListModelsResponse listModels(projectName, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, nextToken, maxResults, maxResults2, nextToken2)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project that contains the model versions that you want to list.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    String xAmzSignature = "xAmzSignature_example"; // String | 
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    String nextToken = "nextToken_example"; // String | If the previous response was incomplete (because there is more data to retrieve), Amazon Lookout for Vision returns a pagination token in the response. You can use this pagination token to retrieve the next set of models.
    Integer maxResults = 56; // Integer | The maximum number of results to return per paginated call. The largest value you can specify is 100. If you specify a value greater than 100, a ValidationException error occurs. The default value is 100.
    String maxResults2 = "maxResults_example"; // String | Pagination limit
    String nextToken2 = "nextToken_example"; // String | Pagination token
    try {
      ListModelsResponse result = apiInstance.listModels(projectName, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, nextToken, maxResults, maxResults2, nextToken2);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="listProjects"></a>
# **listProjects**
> ListProjectsResponse listProjects(xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, nextToken, maxResults, maxResults2, nextToken2)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xAmzSignature = "xAmzSignature_example"; // String | 
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    String nextToken = "nextToken_example"; // String | If the previous response was incomplete (because there is more data to retrieve), Amazon Lookout for Vision returns a pagination token in the response. You can use this pagination token to retrieve the next set of projects.
    Integer maxResults = 56; // Integer | The maximum number of results to return per paginated call. The largest value you can specify is 100. If you specify a value greater than 100, a ValidationException error occurs. The default value is 100.
    String maxResults2 = "maxResults_example"; // String | Pagination limit
    String nextToken2 = "nextToken_example"; // String | Pagination token
    try {
      ListProjectsResponse result = apiInstance.listProjects(xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, nextToken, maxResults, maxResults2, nextToken2);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String resourceArn = "resourceArn_example"; // String | The Amazon Resource Name (ARN) of the model for which you want to list tags. 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
...
<a id="startModel"></a>
# **startModel**
> StartModelResponse startModel(projectName, modelVersion, startModelRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project that contains the model that you want to start.
    String modelVersion = "modelVersion_example"; // String | The version of the model that you want to start.
    StartModelRequest startModelRequest = new StartModelRequest(); // StartModelRequest | 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    try {
      StartModelResponse result = apiInstance.startModel(projectName, modelVersion, startModelRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#startModel");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="startModelPackagingJob"></a>
# **startModelPackagingJob**
> StartModelPackagingJobResponse startModelPackagingJob(projectName, startModelPackagingJobRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String |  The name of the project which contains the version of the model that you want to package. 
    StartModelPackagingJobRequest startModelPackagingJobRequest = new StartModelPackagingJobRequest(); // StartModelPackagingJobRequest | 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    try {
      StartModelPackagingJobResponse result = apiInstance.startModelPackagingJob(projectName, startModelPackagingJobRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#startModelPackagingJob");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="stopModel"></a>
# **stopModel**
> StopModelResponse stopModel(projectName, modelVersion, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project that contains the model that you want to stop.
    String modelVersion = "modelVersion_example"; // String | The version of the model that you want to stop.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    try {
      StopModelResponse result = apiInstance.stopModel(projectName, modelVersion, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#stopModel");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String resourceArn = "resourceArn_example"; // String | The Amazon Resource Name (ARN) of the model to assign the tags.
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String resourceArn = "resourceArn_example"; // String | The Amazon Resource Name (ARN) of the model from which you want to remove tags. 
    List<String> tagKeys = Arrays.asList(); // List<String> | A list of the keys of the tags that you want to remove.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
...
| **tagKeys** | [**List&lt;String&gt;**](String.md)| A list of the keys of the tags that you want to remove. | |
| **xAmzContentSha256** | **String**|  | [optional] |
| **xAmzDate** | **String**|  | [optional] |
| **xAmzAlgorithm** | **String**|  | [optional] |
| **xAmzCredential** | **String**|  | [optional] |
...
<a id="updateDatasetEntries"></a>
# **updateDatasetEntries**
> UpdateDatasetEntriesResponse updateDatasetEntries(projectName, datasetType, updateDatasetEntriesRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String projectName = "projectName_example"; // String | The name of the project that contains the dataset that you want to update.
    String datasetType = "datasetType_example"; // String | The type of the dataset that you want to update. Specify <code>train</code> to update the training dataset. Specify <code>test</code> to update the test dataset. If you have a single dataset project, specify <code>train</code>.
    UpdateDatasetEntriesRequest updateDatasetEntriesRequest = new UpdateDatasetEntriesRequest(); // UpdateDatasetEntriesRequest | 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    try {
      UpdateDatasetEntriesResponse result = apiInstance.updateDatasetEntries(projectName, datasetType, updateDatasetEntriesRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmznClientToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#updateDatasetEntries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
