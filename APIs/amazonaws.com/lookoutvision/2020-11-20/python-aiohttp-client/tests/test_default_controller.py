...
async def test_create_dataset(client):
    ...
    """
    body = {"DatasetType":"","DatasetSource":{"GroundTruthManifest":{"S3Object":{"VersionId":"","Bucket":"","Key":""}}}}
    headers = { 
        ...
        'x_amzn_client_token': 'x_amzn_client_token_example',
        'hmac': 'special-key',
    }
    response = await client.request(
        method='POST',
        path='/2020-11-20/projects/{project_name}/datasets'.format(project_name='project_name_example'),
        headers=headers,
        json=body,
        )
...
async def test_create_model(client):
    ...
    """
    body = {"Description":"","OutputConfig":{"S3Location":{"Bucket":"","Prefix":""}},"KmsKeyId":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/2020-11-20/projects/{project_name}/models'.format(project_name='project_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_dataset(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/2020-11-20/projects/{project_name}/datasets/{dataset_type}'.format(project_name='project_name_example', dataset_type='dataset_type_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_model(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/2020-11-20/projects/{project_name}/models/{model_version}'.format(project_name='project_name_example', model_version='model_version_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_project(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/2020-11-20/projects/{project_name}'.format(project_name='project_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_model_packaging_job(client):
    """Test case for describe_model_packaging_job
    ...
    response = await client.request(
        method='GET',
        path='/2020-11-20/projects/{project_name}/modelpackagingjobs/{job_name}'.format(project_name='project_name_example', job_name='job_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_detect_anomalies(client):
    ...
    response = await client.request(
        method='POST',
        path='/2020-11-20/projects/{project_name}/models/{model_version}/detect#Content-Type'.format(project_name='project_name_example', model_version='model_version_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_dataset_entries(client):
    """Test case for list_dataset_entries

    
    """
    params = [('labeled', True),
                    ('anomalyClass', 'anomaly_class_example'),
                    ('createdBefore', '2013-10-20T19:20:30+01:00'),
                    ('createdAfter', '2013-10-20T19:20:30+01:00'),
                    ('nextToken', 'next_token_example'),
                    ('maxResults', 56),
                    ('sourceRefContains', 'source_ref_contains_example'),
    ...
    response = await client.request(
        method='GET',
        path='/2020-11-20/projects/{project_name}/datasets/{dataset_type}/entries'.format(project_name='project_name_example', dataset_type='dataset_type_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_model_packaging_jobs(client):
    """Test case for list_model_packaging_jobs
    ...
    response = await client.request(
        method='GET',
        path='/2020-11-20/projects/{project_name}/modelpackagingjobs'.format(project_name='project_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='GET',
        path='/2020-11-20/tags/{resource_arn}'.format(resource_arn='resource_arn_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_model(client):
    """Test case for start_model

    
    """
    body = {"MinInferenceUnits":"","MaxInferenceUnits":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/2020-11-20/projects/{project_name}/models/{model_version}/start'.format(project_name='project_name_example', model_version='model_version_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_model_packaging_job(client):
    """Test case for start_model_packaging_job

    
    """
    body = {"Description":"","Configuration":{"Greengrass":{"ComponentDescription":"","CompilerOptions":"","S3OutputLocation":{"Bucket":"","Prefix":""},"TargetPlatform":{"Os":"","Arch":"","Accelerator":""},"ComponentName":"","Tags":"","TargetDevice":"","ComponentVersion":""}},"JobName":"","ModelVersion":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_stop_model(client):
    ...
    response = await client.request(
        method='POST',
        path='/2020-11-20/projects/{project_name}/models/{model_version}/stop'.format(project_name='project_name_example', model_version='model_version_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/2020-11-20/tags/{resource_arntag_key}'.format(resource_arn='resource_arn_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_dataset_entries(client):
    """Test case for update_dataset_entries
