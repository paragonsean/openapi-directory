...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.DatasetMetadata();
  });
  ...
  describe('DatasetMetadata', function() {
    it('should create an instance of DatasetMetadata', function() {
      ...
      //var instance = new AmazonLookoutForVision.DatasetMetadata();
      //expect(instance).to.be.a(AmazonLookoutForVision.DatasetMetadata);
    });
