...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.TargetPlatform();
  });
  ...
  describe('TargetPlatform', function() {
    it('should create an instance of TargetPlatform', function() {
      // uncomment below and update the code to test TargetPlatform
      //var instance = new AmazonLookoutForVision.TargetPlatform();
      //expect(instance).to.be.a(AmazonLookoutForVision.TargetPlatform);
    });
