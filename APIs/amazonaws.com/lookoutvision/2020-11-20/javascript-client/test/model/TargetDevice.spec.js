...
(function(root, factory) {
  ...
  describe('TargetDevice', function() {
    it('should create an instance of TargetDevice', function() {
      // uncomment below and update the code to test TargetDevice
      //var instance = new AmazonLookoutForVision.TargetDevice();
      //expect(instance).to.be.a(AmazonLookoutForVision.TargetDevice);
    });
