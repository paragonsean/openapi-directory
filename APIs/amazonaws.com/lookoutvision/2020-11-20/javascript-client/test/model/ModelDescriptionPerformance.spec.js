...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.ModelDescriptionPerformance();
  });
  ...
  describe('ModelDescriptionPerformance', function() {
    it('should create an instance of ModelDescriptionPerformance', function() {
      // uncomment below and update the code to test ModelDescriptionPerformance
      //var instance = new AmazonLookoutForVision.ModelDescriptionPerformance();
      //expect(instance).to.be.a(AmazonLookoutForVision.ModelDescriptionPerformance);
    });
