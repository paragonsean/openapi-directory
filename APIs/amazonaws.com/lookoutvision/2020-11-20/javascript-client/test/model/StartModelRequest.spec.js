...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.StartModelRequest();
  });
  ...
  describe('StartModelRequest', function() {
    it('should create an instance of StartModelRequest', function() {
      // uncomment below and update the code to test StartModelRequest
      //var instance = new AmazonLookoutForVision.StartModelRequest();
      //expect(instance).to.be.a(AmazonLookoutForVision.StartModelRequest);
    });
