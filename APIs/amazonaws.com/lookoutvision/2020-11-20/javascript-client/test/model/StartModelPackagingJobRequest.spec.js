...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.StartModelPackagingJobRequest();
  });
  ...
  describe('StartModelPackagingJobRequest', function() {
    it('should create an instance of StartModelPackagingJobRequest', function() {
      // uncomment below and update the code to test StartModelPackagingJobRequest
      //var instance = new AmazonLookoutForVision.StartModelPackagingJobRequest();
      //expect(instance).to.be.a(AmazonLookoutForVision.StartModelPackagingJobRequest);
    });
