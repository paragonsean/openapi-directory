...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.ImageSource();
  });
  ...
  describe('ImageSource', function() {
    it('should create an instance of ImageSource', function() {
      ...
      //var instance = new AmazonLookoutForVision.ImageSource();
      //expect(instance).to.be.a(AmazonLookoutForVision.ImageSource);
    });
