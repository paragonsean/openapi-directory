...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.ModelPerformance();
  });
  ...
  describe('ModelPerformance', function() {
    it('should create an instance of ModelPerformance', function() {
      // uncomment below and update the code to test ModelPerformance
      //var instance = new AmazonLookoutForVision.ModelPerformance();
      //expect(instance).to.be.a(AmazonLookoutForVision.ModelPerformance);
    });
