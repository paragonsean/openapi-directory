...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.CreateModelRequestOutputConfigS3Location();
  });
  ...
  describe('CreateModelRequestOutputConfigS3Location', function() {
    it('should create an instance of CreateModelRequestOutputConfigS3Location', function() {
      // uncomment below and update the code to test CreateModelRequestOutputConfigS3Location
      //var instance = new AmazonLookoutForVision.CreateModelRequestOutputConfigS3Location();
      //expect(instance).to.be.a(AmazonLookoutForVision.CreateModelRequestOutputConfigS3Location);
    });
