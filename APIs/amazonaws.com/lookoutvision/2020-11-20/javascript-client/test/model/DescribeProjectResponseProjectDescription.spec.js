...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.DescribeProjectResponseProjectDescription();
  });
  ...
  describe('DescribeProjectResponseProjectDescription', function() {
    it('should create an instance of DescribeProjectResponseProjectDescription', function() {
      // uncomment below and update the code to test DescribeProjectResponseProjectDescription
      //var instance = new AmazonLookoutForVision.DescribeProjectResponseProjectDescription();
      //expect(instance).to.be.a(AmazonLookoutForVision.DescribeProjectResponseProjectDescription);
    });
