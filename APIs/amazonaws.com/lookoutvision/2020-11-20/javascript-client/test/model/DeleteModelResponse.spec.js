...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.DeleteModelResponse();
  });
  ...
  describe('DeleteModelResponse', function() {
    it('should create an instance of DeleteModelResponse', function() {
      ...
      //var instance = new AmazonLookoutForVision.DeleteModelResponse();
      //expect(instance).to.be.a(AmazonLookoutForVision.DeleteModelResponse);
    });
