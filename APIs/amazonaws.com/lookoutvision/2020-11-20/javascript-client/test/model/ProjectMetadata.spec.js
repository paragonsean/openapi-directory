...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.ProjectMetadata();
  });
  ...
  describe('ProjectMetadata', function() {
    it('should create an instance of ProjectMetadata', function() {
      ...
      //var instance = new AmazonLookoutForVision.ProjectMetadata();
      //expect(instance).to.be.a(AmazonLookoutForVision.ProjectMetadata);
    });
