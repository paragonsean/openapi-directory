...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.CreateDatasetResponseDatasetMetadata();
  });
  ...
  describe('CreateDatasetResponseDatasetMetadata', function() {
    it('should create an instance of CreateDatasetResponseDatasetMetadata', function() {
      // uncomment below and update the code to test CreateDatasetResponseDatasetMetadata
      //var instance = new AmazonLookoutForVision.CreateDatasetResponseDatasetMetadata();
      //expect(instance).to.be.a(AmazonLookoutForVision.CreateDatasetResponseDatasetMetadata);
    });
