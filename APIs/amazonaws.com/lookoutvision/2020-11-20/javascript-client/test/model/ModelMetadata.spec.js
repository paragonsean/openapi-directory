...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.ModelMetadata();
  });
  ...
  describe('ModelMetadata', function() {
    it('should create an instance of ModelMetadata', function() {
      // uncomment below and update the code to test ModelMetadata
      //var instance = new AmazonLookoutForVision.ModelMetadata();
      //expect(instance).to.be.a(AmazonLookoutForVision.ModelMetadata);
    });
