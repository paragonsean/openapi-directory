...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.S3Location();
  });
  ...
  describe('S3Location', function() {
    it('should create an instance of S3Location', function() {
      ...
      //var instance = new AmazonLookoutForVision.S3Location();
      //expect(instance).to.be.a(AmazonLookoutForVision.S3Location);
    });
