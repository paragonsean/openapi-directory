...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.CreateModelRequest();
  });
  ...
  describe('CreateModelRequest', function() {
    it('should create an instance of CreateModelRequest', function() {
      ...
      //var instance = new AmazonLookoutForVision.CreateModelRequest();
      //expect(instance).to.be.a(AmazonLookoutForVision.CreateModelRequest);
    });
