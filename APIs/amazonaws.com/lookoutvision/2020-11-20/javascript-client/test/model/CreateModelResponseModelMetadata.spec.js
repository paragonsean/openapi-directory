...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.CreateModelResponseModelMetadata();
  });
  ...
  describe('CreateModelResponseModelMetadata', function() {
    it('should create an instance of CreateModelResponseModelMetadata', function() {
      // uncomment below and update the code to test CreateModelResponseModelMetadata
      //var instance = new AmazonLookoutForVision.CreateModelResponseModelMetadata();
      //expect(instance).to.be.a(AmazonLookoutForVision.CreateModelResponseModelMetadata);
    });
