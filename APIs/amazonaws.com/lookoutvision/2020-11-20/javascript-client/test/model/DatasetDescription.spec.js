...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.DatasetDescription();
  });
  ...
  describe('DatasetDescription', function() {
    it('should create an instance of DatasetDescription', function() {
      ...
      //var instance = new AmazonLookoutForVision.DatasetDescription();
      //expect(instance).to.be.a(AmazonLookoutForVision.DatasetDescription);
    });
    ...
    it('should have the property imageStats (base name: "ImageStats")', function() {
      // uncomment below and update the code to test the property imageStats
      //var instance = new AmazonLookoutForVision.DatasetDescription();
      //expect(instance).to.be();
    });
