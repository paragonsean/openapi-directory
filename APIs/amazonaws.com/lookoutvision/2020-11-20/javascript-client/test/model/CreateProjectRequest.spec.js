...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.CreateProjectRequest();
  });
  ...
  describe('CreateProjectRequest', function() {
    it('should create an instance of CreateProjectRequest', function() {
      ...
      //var instance = new AmazonLookoutForVision.CreateProjectRequest();
      //expect(instance).to.be.a(AmazonLookoutForVision.CreateProjectRequest);
    });
