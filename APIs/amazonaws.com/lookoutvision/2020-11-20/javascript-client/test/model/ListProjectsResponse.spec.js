...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.ListProjectsResponse();
  });
  ...
  describe('ListProjectsResponse', function() {
    it('should create an instance of ListProjectsResponse', function() {
      ...
      //var instance = new AmazonLookoutForVision.ListProjectsResponse();
      //expect(instance).to.be.a(AmazonLookoutForVision.ListProjectsResponse);
    });
