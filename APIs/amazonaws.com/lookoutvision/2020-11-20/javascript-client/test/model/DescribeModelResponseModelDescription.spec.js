...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.DescribeModelResponseModelDescription();
  });
  ...
  describe('DescribeModelResponseModelDescription', function() {
    it('should create an instance of DescribeModelResponseModelDescription', function() {
      // uncomment below and update the code to test DescribeModelResponseModelDescription
      //var instance = new AmazonLookoutForVision.DescribeModelResponseModelDescription();
      //expect(instance).to.be.a(AmazonLookoutForVision.DescribeModelResponseModelDescription);
    });
