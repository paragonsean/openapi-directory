...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.GreengrassConfigurationS3OutputLocation();
  });
  ...
  describe('GreengrassConfigurationS3OutputLocation', function() {
    it('should create an instance of GreengrassConfigurationS3OutputLocation', function() {
      // uncomment below and update the code to test GreengrassConfigurationS3OutputLocation
      //var instance = new AmazonLookoutForVision.GreengrassConfigurationS3OutputLocation();
      //expect(instance).to.be.a(AmazonLookoutForVision.GreengrassConfigurationS3OutputLocation);
    });
