...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.ModelMetadataPerformance();
  });
  ...
  describe('ModelMetadataPerformance', function() {
    it('should create an instance of ModelMetadataPerformance', function() {
      // uncomment below and update the code to test ModelMetadataPerformance
      //var instance = new AmazonLookoutForVision.ModelMetadataPerformance();
      //expect(instance).to.be.a(AmazonLookoutForVision.ModelMetadataPerformance);
    });
