...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForVision.ModelPackagingJobMetadata();
  });
  ...
  describe('ModelPackagingJobMetadata', function() {
    it('should create an instance of ModelPackagingJobMetadata', function() {
      // uncomment below and update the code to test ModelPackagingJobMetadata
      //var instance = new AmazonLookoutForVision.ModelPackagingJobMetadata();
      //expect(instance).to.be.a(AmazonLookoutForVision.ModelPackagingJobMetadata);
    });
