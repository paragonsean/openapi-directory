...
|------------ | ------------- | ------------- | -------------|
|**distance** | [**Double**](Double.md) |  |  |
|**durationSeconds** | [**Double**](Double.md) |  |  |
|**endPosition** | [**List**](List.md) |  |  |
|**geometry** | [**LegGeometry**](LegGeometry.md) |  |  [optional] |
|**startPosition** | [**List**](List.md) |  |  |
|**steps** | [**List**](List.md) |  |  |
