...
public class Example {
  public static void main(String[] args) {
    ...
    String fontUnicodeRange = "fontUnicodeRange_example"; // String | A Unicode range of characters to download glyphs for. Each response will contain 256 characters. For example, 0–255 includes all characters from range <code>U+0000</code> to <code>00FF</code>. Must be aligned to multiples of 256.
    String mapName = "mapName_example"; // String | The map resource associated with the glyph ﬁle.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
...
public class Example {
  public static void main(String[] args) {
    ...
    String mapName = "mapName_example"; // String | The map resource associated with the sprite ﬁle.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
