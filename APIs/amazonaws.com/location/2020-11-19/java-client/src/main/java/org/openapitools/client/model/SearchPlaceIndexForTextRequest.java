...
public class SearchPlaceIndexForTextRequest {
  ...
  public SearchPlaceIndexForTextRequest() {
  }

  public SearchPlaceIndexForTextRequest biasPosition(List<Double> biasPosition) {
    this.biasPosition = biasPosition;
    return this;
  }

  public SearchPlaceIndexForTextRequest addBiasPositionItem(Double biasPositionItem) {
  ...
  public SearchPlaceIndexForTextRequest filterBBox(List<Double> filterBBox) {
    this.filterBBox = filterBBox;
    return this;
  }

  public SearchPlaceIndexForTextRequest addFilterBBoxItem(Double filterBBoxItem) {
  ...
  public SearchPlaceIndexForTextRequest filterCategories(List<String> filterCategories) {
    this.filterCategories = filterCategories;
    return this;
  }

  public SearchPlaceIndexForTextRequest addFilterCategoriesItem(String filterCategoriesItem) {
  ...
  public SearchPlaceIndexForTextRequest filterCountries(List<String> filterCountries) {
    this.filterCountries = filterCountries;
    return this;
  }

  public SearchPlaceIndexForTextRequest addFilterCountriesItem(String filterCountriesItem) {
  ...
  public SearchPlaceIndexForTextRequest language(String language) {
  ...
  public SearchPlaceIndexForTextRequest maxResults(Integer maxResults) {
  ...
  public SearchPlaceIndexForTextRequest text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchPlaceIndexForTextRequest searchPlaceIndexForTextRequest = (SearchPlaceIndexForTextRequest) o;
    return Objects.equals(this.biasPosition, searchPlaceIndexForTextRequest.biasPosition) &&
        Objects.equals(this.filterBBox, searchPlaceIndexForTextRequest.filterBBox) &&
        Objects.equals(this.filterCategories, searchPlaceIndexForTextRequest.filterCategories) &&
        Objects.equals(this.filterCountries, searchPlaceIndexForTextRequest.filterCountries) &&
        Objects.equals(this.language, searchPlaceIndexForTextRequest.language) &&
        Objects.equals(this.maxResults, searchPlaceIndexForTextRequest.maxResults) &&
        Objects.equals(this.text, searchPlaceIndexForTextRequest.text);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchPlaceIndexForTextRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchPlaceIndexForTextRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchPlaceIndexForTextRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchPlaceIndexForTextRequest is not found in the empty JSON string", SearchPlaceIndexForTextRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchPlaceIndexForTextRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchPlaceIndexForTextRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchPlaceIndexForTextRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchPlaceIndexForTextRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchPlaceIndexForTextRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchPlaceIndexForTextRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchPlaceIndexForTextRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchPlaceIndexForTextRequest>() {
           @Override
           public void write(JsonWriter out, SearchPlaceIndexForTextRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchPlaceIndexForTextRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchPlaceIndexForTextRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchPlaceIndexForTextRequest
   * @throws IOException if the JSON string is invalid with respect to SearchPlaceIndexForTextRequest
   */
  public static SearchPlaceIndexForTextRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchPlaceIndexForTextRequest.class);
  }

  /**
   * Convert an instance of SearchPlaceIndexForTextRequest to an JSON string
   *
   * @return JSON string
   */
