...
public class SearchPlaceIndexForTextSummary {
  ...
  public SearchPlaceIndexForTextSummary() {
  }

  public SearchPlaceIndexForTextSummary biasPosition(List biasPosition) {
  ...
  public SearchPlaceIndexForTextSummary dataSource(String dataSource) {
  ...
  public SearchPlaceIndexForTextSummary filterBBox(List filterBBox) {
  ...
  public SearchPlaceIndexForTextSummary filterCategories(List filterCategories) {
  ...
  public SearchPlaceIndexForTextSummary filterCountries(List filterCountries) {
  ...
  public SearchPlaceIndexForTextSummary language(String language) {
  ...
  public SearchPlaceIndexForTextSummary maxResults(Integer maxResults) {
  ...
  public SearchPlaceIndexForTextSummary resultBBox(List resultBBox) {
  ...
  public SearchPlaceIndexForTextSummary text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchPlaceIndexForTextSummary searchPlaceIndexForTextSummary = (SearchPlaceIndexForTextSummary) o;
    return Objects.equals(this.biasPosition, searchPlaceIndexForTextSummary.biasPosition) &&
        Objects.equals(this.dataSource, searchPlaceIndexForTextSummary.dataSource) &&
        Objects.equals(this.filterBBox, searchPlaceIndexForTextSummary.filterBBox) &&
        Objects.equals(this.filterCategories, searchPlaceIndexForTextSummary.filterCategories) &&
        Objects.equals(this.filterCountries, searchPlaceIndexForTextSummary.filterCountries) &&
        Objects.equals(this.language, searchPlaceIndexForTextSummary.language) &&
        Objects.equals(this.maxResults, searchPlaceIndexForTextSummary.maxResults) &&
        Objects.equals(this.resultBBox, searchPlaceIndexForTextSummary.resultBBox) &&
        Objects.equals(this.text, searchPlaceIndexForTextSummary.text);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchPlaceIndexForTextSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchPlaceIndexForTextSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchPlaceIndexForTextSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchPlaceIndexForTextSummary is not found in the empty JSON string", SearchPlaceIndexForTextSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchPlaceIndexForTextSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchPlaceIndexForTextSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchPlaceIndexForTextSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchPlaceIndexForTextSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchPlaceIndexForTextSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchPlaceIndexForTextSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchPlaceIndexForTextSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchPlaceIndexForTextSummary>() {
           @Override
           public void write(JsonWriter out, SearchPlaceIndexForTextSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchPlaceIndexForTextSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchPlaceIndexForTextSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchPlaceIndexForTextSummary
   * @throws IOException if the JSON string is invalid with respect to SearchPlaceIndexForTextSummary
   */
  public static SearchPlaceIndexForTextSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchPlaceIndexForTextSummary.class);
  }

  /**
   * Convert an instance of SearchPlaceIndexForTextSummary to an JSON string
   *
   * @return JSON string
   */
