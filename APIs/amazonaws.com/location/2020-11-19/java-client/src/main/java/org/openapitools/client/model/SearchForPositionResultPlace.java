...
public class SearchForPositionResultPlace {
  ...
  public SearchForPositionResultPlace() {
  }

  public SearchForPositionResultPlace addressNumber(String addressNumber) {
  ...
  public SearchForPositionResultPlace categories(List categories) {
  ...
  public SearchForPositionResultPlace country(String country) {
  ...
  public SearchForPositionResultPlace geometry(PlaceGeometry geometry) {
  ...
  public SearchForPositionResultPlace interpolated(Boolean interpolated) {
  ...
  public SearchForPositionResultPlace label(String label) {
    this.label = label;
    return this;
  }
  ...
  public SearchForPositionResultPlace municipality(String municipality) {
  ...
  public SearchForPositionResultPlace neighborhood(String neighborhood) {
  ...
  public SearchForPositionResultPlace postalCode(String postalCode) {
  ...
  public SearchForPositionResultPlace region(String region) {
    this.region = region;
    return this;
  }
  ...
  public SearchForPositionResultPlace street(String street) {
    this.street = street;
    return this;
  }
  ...
  public SearchForPositionResultPlace subRegion(String subRegion) {
  ...
  public SearchForPositionResultPlace supplementalCategories(List supplementalCategories) {
  ...
  public SearchForPositionResultPlace timeZone(PlaceTimeZone timeZone) {
  ...
  public SearchForPositionResultPlace unitNumber(String unitNumber) {
  ...
  public SearchForPositionResultPlace unitType(String unitType) {
  ...
  public boolean equals(Object o) {
    ...
    SearchForPositionResultPlace searchForPositionResultPlace = (SearchForPositionResultPlace) o;
    return Objects.equals(this.addressNumber, searchForPositionResultPlace.addressNumber) &&
        Objects.equals(this.categories, searchForPositionResultPlace.categories) &&
        Objects.equals(this.country, searchForPositionResultPlace.country) &&
        Objects.equals(this.geometry, searchForPositionResultPlace.geometry) &&
        Objects.equals(this.interpolated, searchForPositionResultPlace.interpolated) &&
        Objects.equals(this.label, searchForPositionResultPlace.label) &&
        Objects.equals(this.municipality, searchForPositionResultPlace.municipality) &&
        Objects.equals(this.neighborhood, searchForPositionResultPlace.neighborhood) &&
        Objects.equals(this.postalCode, searchForPositionResultPlace.postalCode) &&
        Objects.equals(this.region, searchForPositionResultPlace.region) &&
        Objects.equals(this.street, searchForPositionResultPlace.street) &&
        Objects.equals(this.subRegion, searchForPositionResultPlace.subRegion) &&
        Objects.equals(this.supplementalCategories, searchForPositionResultPlace.supplementalCategories) &&
        Objects.equals(this.timeZone, searchForPositionResultPlace.timeZone) &&
        Objects.equals(this.unitNumber, searchForPositionResultPlace.unitNumber) &&
        Objects.equals(this.unitType, searchForPositionResultPlace.unitType);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchForPositionResultPlace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchForPositionResultPlace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchForPositionResultPlace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchForPositionResultPlace is not found in the empty JSON string", SearchForPositionResultPlace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchForPositionResultPlace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchForPositionResultPlace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchForPositionResultPlace.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchForPositionResultPlace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchForPositionResultPlace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchForPositionResultPlace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchForPositionResultPlace.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchForPositionResultPlace>() {
           @Override
           public void write(JsonWriter out, SearchForPositionResultPlace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchForPositionResultPlace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchForPositionResultPlace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchForPositionResultPlace
   * @throws IOException if the JSON string is invalid with respect to SearchForPositionResultPlace
   */
  public static SearchForPositionResultPlace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchForPositionResultPlace.class);
  }

  /**
   * Convert an instance of SearchForPositionResultPlace to an JSON string
   *
   * @return JSON string
   */
