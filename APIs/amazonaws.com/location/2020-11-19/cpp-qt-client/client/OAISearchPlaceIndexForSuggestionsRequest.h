...
/*
 * OAISearchPlaceIndexForSuggestionsRequest.h
 *
 * 
 */

#ifndef OAISearchPlaceIndexForSuggestionsRequest_H
#define OAISearchPlaceIndexForSuggestionsRequest_H
...
class OAISearchPlaceIndexForSuggestionsRequest : public OAIObject {
public:
    OAISearchPlaceIndexForSuggestionsRequest();
    OAISearchPlaceIndexForSuggestionsRequest(QString json);
    ~OAISearchPlaceIndexForSuggestionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchPlaceIndexForSuggestionsRequest)

#endif // OAISearchPlaceIndexForSuggestionsRequest_H
