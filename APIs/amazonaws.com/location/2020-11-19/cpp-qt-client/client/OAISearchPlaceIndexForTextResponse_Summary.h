...
/*
 * OAISearchPlaceIndexForTextResponse_Summary.h
 *
 * 
 */

#ifndef OAISearchPlaceIndexForTextResponse_Summary_H
#define OAISearchPlaceIndexForTextResponse_Summary_H
...
class OAISearchPlaceIndexForTextResponse_Summary : public OAIObject {
public:
    OAISearchPlaceIndexForTextResponse_Summary();
    OAISearchPlaceIndexForTextResponse_Summary(QString json);
    ~OAISearchPlaceIndexForTextResponse_Summary() override;
    ...
    QList getResultBBox() const;
    void setResultBBox(const QList &result_b_box);
    bool is_result_b_box_Set() const;
    bool is_result_b_box_Valid() const;
...
private:
    ...
    QList m_result_b_box;
    bool m_result_b_box_isSet;
    bool m_result_b_box_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchPlaceIndexForTextResponse_Summary)

#endif // OAISearchPlaceIndexForTextResponse_Summary_H
