...
/*
 * OAIGetDevicePositionHistory_request.h
 *
 * 
 */

#ifndef OAIGetDevicePositionHistory_request_H
#define OAIGetDevicePositionHistory_request_H
...
class OAIGetDevicePositionHistory_request : public OAIObject {
public:
    OAIGetDevicePositionHistory_request();
    OAIGetDevicePositionHistory_request(QString json);
    ~OAIGetDevicePositionHistory_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDevicePositionHistory_request)

#endif // OAIGetDevicePositionHistory_request_H
