...
namespace OpenAPI {
class OAICreateKeyRequest_Restrictions;
...
public:
    ...
    OAICreateKeyRequest_Restrictions getRestrictions() const;
    void setRestrictions(const OAICreateKeyRequest_Restrictions &restrictions);
...
private:
    ...
    OAICreateKeyRequest_Restrictions m_restrictions;
