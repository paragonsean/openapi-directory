...
#ifndef OAIGeofenceGeometry_H
#define OAIGeofenceGeometry_H
...
class OAIGeofenceGeometry : public OAIObject {
public:
    OAIGeofenceGeometry();
    OAIGeofenceGeometry(QString json);
    ~OAIGeofenceGeometry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeofenceGeometry)

#endif // OAIGeofenceGeometry_H
