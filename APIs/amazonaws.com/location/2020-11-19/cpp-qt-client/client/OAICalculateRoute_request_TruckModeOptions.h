...
/*
 * OAICalculateRoute_request_TruckModeOptions.h
 *
 * Contains details about additional route preferences for requests that specify &lt;code&gt;TravelMode&lt;/code&gt; as &lt;code&gt;Truck&lt;/code&gt;.
 */

#ifndef OAICalculateRoute_request_TruckModeOptions_H
#define OAICalculateRoute_request_TruckModeOptions_H
...
class OAICalculateRoute_request_TruckModeOptions : public OAIObject {
public:
    OAICalculateRoute_request_TruckModeOptions();
    OAICalculateRoute_request_TruckModeOptions(QString json);
    ~OAICalculateRoute_request_TruckModeOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalculateRoute_request_TruckModeOptions)

#endif // OAICalculateRoute_request_TruckModeOptions_H
