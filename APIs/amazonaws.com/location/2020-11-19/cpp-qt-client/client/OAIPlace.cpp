...
QString OAIPlace::getAddressNumber() const {
    return m_address_number;
}
void OAIPlace::setAddressNumber(const QString &address_number) {
    m_address_number = address_number;
    m_address_number_isSet = true;
}

bool OAIPlace::is_address_number_Set() const{
    return m_address_number_isSet;
}

bool OAIPlace::is_address_number_Valid() const{
    return m_address_number_isValid;
}

QList OAIPlace::getCategories() const {
    return m_categories;
}
void OAIPlace::setCategories(const QList &categories) {
    m_categories = categories;
    m_categories_isSet = true;
}

bool OAIPlace::is_categories_Set() const{
    return m_categories_isSet;
}

bool OAIPlace::is_categories_Valid() const{
...
OAIPlaceGeometry OAIPlace::getGeometry() const {
    return m_geometry;
}
void OAIPlace::setGeometry(const OAIPlaceGeometry &geometry) {
    m_geometry = geometry;
    m_geometry_isSet = true;
}

bool OAIPlace::is_geometry_Set() const{
    return m_geometry_isSet;
}

bool OAIPlace::is_geometry_Valid() const{
    return m_geometry_isValid;
}

bool OAIPlace::getInterpolated() const {
    return m_interpolated;
}
void OAIPlace::setInterpolated(const bool &interpolated) {
    m_interpolated = interpolated;
    m_interpolated_isSet = true;
}

bool OAIPlace::is_interpolated_Set() const{
    return m_interpolated_isSet;
}

bool OAIPlace::is_interpolated_Valid() const{
    return m_interpolated_isValid;
}

QString OAIPlace::getLabel() const {
    return m_label;
}
void OAIPlace::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPlace::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPlace::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIPlace::getMunicipality() const {
    return m_municipality;
}
void OAIPlace::setMunicipality(const QString &municipality) {
    m_municipality = municipality;
    m_municipality_isSet = true;
}

bool OAIPlace::is_municipality_Set() const{
    return m_municipality_isSet;
}

bool OAIPlace::is_municipality_Valid() const{
    return m_municipality_isValid;
}

QString OAIPlace::getNeighborhood() const {
    return m_neighborhood;
}
void OAIPlace::setNeighborhood(const QString &neighborhood) {
    m_neighborhood = neighborhood;
    m_neighborhood_isSet = true;
}

bool OAIPlace::is_neighborhood_Set() const{
    return m_neighborhood_isSet;
}

bool OAIPlace::is_neighborhood_Valid() const{
...
QString OAIPlace::getRegion() const {
    return m_region;
}
void OAIPlace::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIPlace::is_region_Set() const{
    return m_region_isSet;
}

bool OAIPlace::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIPlace::getStreet() const {
    return m_street;
}
void OAIPlace::setStreet(const QString &street) {
    m_street = street;
    m_street_isSet = true;
}

bool OAIPlace::is_street_Set() const{
    return m_street_isSet;
}

bool OAIPlace::is_street_Valid() const{
    return m_street_isValid;
}

QString OAIPlace::getSubRegion() const {
    return m_sub_region;
}
void OAIPlace::setSubRegion(const QString &sub_region) {
    m_sub_region = sub_region;
    m_sub_region_isSet = true;
}

bool OAIPlace::is_sub_region_Set() const{
    return m_sub_region_isSet;
}

bool OAIPlace::is_sub_region_Valid() const{
    return m_sub_region_isValid;
}

QList OAIPlace::getSupplementalCategories() const {
    return m_supplemental_categories;
}
void OAIPlace::setSupplementalCategories(const QList &supplemental_categories) {
    m_supplemental_categories = supplemental_categories;
    m_supplemental_categories_isSet = true;
}

bool OAIPlace::is_supplemental_categories_Set() const{
    return m_supplemental_categories_isSet;
}

bool OAIPlace::is_supplemental_categories_Valid() const{
    return m_supplemental_categories_isValid;
}

OAIPlace_TimeZone OAIPlace::getTimeZone() const {
    return m_time_zone;
}
void OAIPlace::setTimeZone(const OAIPlace_TimeZone &time_zone) {
...
QString OAIPlace::getUnitNumber() const {
    return m_unit_number;
}
void OAIPlace::setUnitNumber(const QString &unit_number) {
    m_unit_number = unit_number;
    m_unit_number_isSet = true;
}

bool OAIPlace::is_unit_number_Set() const{
    return m_unit_number_isSet;
}

bool OAIPlace::is_unit_number_Valid() const{
    return m_unit_number_isValid;
}

QString OAIPlace::getUnitType() const {
    return m_unit_type;
}
void OAIPlace::setUnitType(const QString &unit_type) {
    m_unit_type = unit_type;
    m_unit_type_isSet = true;
}

bool OAIPlace::is_unit_type_Set() const{
    return m_unit_type_isSet;
}

bool OAIPlace::is_unit_type_Valid() const{
