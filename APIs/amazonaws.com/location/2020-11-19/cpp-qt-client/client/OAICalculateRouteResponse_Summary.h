...
/*
 * OAICalculateRouteResponse_Summary.h
 *
 * 
 */

#ifndef OAICalculateRouteResponse_Summary_H
#define OAICalculateRouteResponse_Summary_H
...
class OAICalculateRouteResponse_Summary : public OAIObject {
public:
    OAICalculateRouteResponse_Summary();
    OAICalculateRouteResponse_Summary(QString json);
    ~OAICalculateRouteResponse_Summary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalculateRouteResponse_Summary)

#endif // OAICalculateRouteResponse_Summary_H
