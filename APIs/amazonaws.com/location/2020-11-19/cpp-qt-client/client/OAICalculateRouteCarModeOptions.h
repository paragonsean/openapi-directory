...
class OAICalculateRouteCarModeOptions : public OAIObject {
public:
    OAICalculateRouteCarModeOptions();
    OAICalculateRouteCarModeOptions(QString json);
    ~OAICalculateRouteCarModeOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalculateRouteCarModeOptions)

#endif // OAICalculateRouteCarModeOptions_H
