...
/*
 * OAIDevicePositionUpdate.h
 *
 * Contains the position update details for a device.
 */

#ifndef OAIDevicePositionUpdate_H
#define OAIDevicePositionUpdate_H
...
class OAIDevicePositionUpdate : public OAIObject {
public:
    OAIDevicePositionUpdate();
    OAIDevicePositionUpdate(QString json);
    ~OAIDevicePositionUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDevicePositionUpdate)

#endif // OAIDevicePositionUpdate_H
