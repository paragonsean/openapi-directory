...
/*
 * OAIListDevicePositionsResponseEntry.h
 *
 * Contains the tracker resource details.
 */

#ifndef OAIListDevicePositionsResponseEntry_H
#define OAIListDevicePositionsResponseEntry_H
...
class OAIListDevicePositionsResponseEntry : public OAIObject {
public:
    OAIListDevicePositionsResponseEntry();
    OAIListDevicePositionsResponseEntry(QString json);
    ~OAIListDevicePositionsResponseEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDevicePositionsResponseEntry)

#endif // OAIListDevicePositionsResponseEntry_H
