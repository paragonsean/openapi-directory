...
/*
 * OAIGetDevicePositionResponse.h
 *
 * 
 */

#ifndef OAIGetDevicePositionResponse_H
#define OAIGetDevicePositionResponse_H
...
class OAIGetDevicePositionResponse : public OAIObject {
public:
    OAIGetDevicePositionResponse();
    OAIGetDevicePositionResponse(QString json);
    ~OAIGetDevicePositionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDevicePositionResponse)

#endif // OAIGetDevicePositionResponse_H
