...
/*
 * OAICalculateRouteTruckModeOptions.h
 *
 * Contains details about additional route preferences for requests that specify &lt;code&gt;TravelMode&lt;/code&gt; as &lt;code&gt;Truck&lt;/code&gt;.
 */

#ifndef OAICalculateRouteTruckModeOptions_H
#define OAICalculateRouteTruckModeOptions_H
...
class OAICalculateRouteTruckModeOptions : public OAIObject {
public:
    OAICalculateRouteTruckModeOptions();
    OAICalculateRouteTruckModeOptions(QString json);
    ~OAICalculateRouteTruckModeOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalculateRouteTruckModeOptions)

#endif // OAICalculateRouteTruckModeOptions_H
