...
/*
 * OAISearchForPositionResult_Place.h
 *
 * 
 */

#ifndef OAISearchForPositionResult_Place_H
#define OAISearchForPositionResult_Place_H
...
class OAISearchForPositionResult_Place : public OAIObject {
public:
    OAISearchForPositionResult_Place();
    OAISearchForPositionResult_Place(QString json);
    ~OAISearchForPositionResult_Place() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchForPositionResult_Place)

#endif // OAISearchForPositionResult_Place_H
