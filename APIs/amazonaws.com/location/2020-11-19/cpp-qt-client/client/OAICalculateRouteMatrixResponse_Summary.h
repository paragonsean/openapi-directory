...
/*
 * OAICalculateRouteMatrixResponse_Summary.h
 *
 * 
 */

#ifndef OAICalculateRouteMatrixResponse_Summary_H
#define OAICalculateRouteMatrixResponse_Summary_H
...
class OAICalculateRouteMatrixResponse_Summary : public OAIObject {
public:
    OAICalculateRouteMatrixResponse_Summary();
    OAICalculateRouteMatrixResponse_Summary(QString json);
    ~OAICalculateRouteMatrixResponse_Summary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalculateRouteMatrixResponse_Summary)

#endif // OAICalculateRouteMatrixResponse_Summary_H
