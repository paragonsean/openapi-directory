...
/*
 * OAIBatchPutGeofenceRequestEntry_Geometry.h
 *
 * 
 */

#ifndef OAIBatchPutGeofenceRequestEntry_Geometry_H
#define OAIBatchPutGeofenceRequestEntry_Geometry_H
...
class OAIBatchPutGeofenceRequestEntry_Geometry : public OAIObject {
public:
    OAIBatchPutGeofenceRequestEntry_Geometry();
    OAIBatchPutGeofenceRequestEntry_Geometry(QString json);
    ~OAIBatchPutGeofenceRequestEntry_Geometry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchPutGeofenceRequestEntry_Geometry)

#endif // OAIBatchPutGeofenceRequestEntry_Geometry_H
