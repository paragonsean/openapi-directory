...
/*
 * OAISearchPlaceIndexForTextSummary.h
 *
 * A summary of the request sent by using &lt;code&gt;SearchPlaceIndexForText&lt;/code&gt;.
 */

#ifndef OAISearchPlaceIndexForTextSummary_H
#define OAISearchPlaceIndexForTextSummary_H
...
class OAISearchPlaceIndexForTextSummary : public OAIObject {
public:
    OAISearchPlaceIndexForTextSummary();
    OAISearchPlaceIndexForTextSummary(QString json);
    ~OAISearchPlaceIndexForTextSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchPlaceIndexForTextSummary)

#endif // OAISearchPlaceIndexForTextSummary_H
