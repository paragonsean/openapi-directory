...
/*
 * OAIGetPlaceResponse_Place.h
 *
 * 
 */

#ifndef OAIGetPlaceResponse_Place_H
#define OAIGetPlaceResponse_Place_H
...
class OAIGetPlaceResponse_Place : public OAIObject {
public:
    OAIGetPlaceResponse_Place();
    OAIGetPlaceResponse_Place(QString json);
    ~OAIGetPlaceResponse_Place() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPlaceResponse_Place)

#endif // OAIGetPlaceResponse_Place_H
