...
/*
 * OAISearchPlaceIndexForSuggestionsSummary.h
 *
 * A summary of the request sent by using &lt;code&gt;SearchPlaceIndexForSuggestions&lt;/code&gt;.
 */

#ifndef OAISearchPlaceIndexForSuggestionsSummary_H
#define OAISearchPlaceIndexForSuggestionsSummary_H
...
class OAISearchPlaceIndexForSuggestionsSummary : public OAIObject {
public:
    OAISearchPlaceIndexForSuggestionsSummary();
    OAISearchPlaceIndexForSuggestionsSummary(QString json);
    ~OAISearchPlaceIndexForSuggestionsSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchPlaceIndexForSuggestionsSummary)

#endif // OAISearchPlaceIndexForSuggestionsSummary_H
