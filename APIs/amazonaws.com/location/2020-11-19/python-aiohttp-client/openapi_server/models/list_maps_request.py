...
class ListMapsRequest(Model):
    ...
    def __init__(self, max_results: int=None, next_token: str=None):
        """ListMapsRequest - a model defined in OpenAPI

        :param max_results: The max_results of this ListMapsRequest.
        :param next_token: The next_token of this ListMapsRequest.
        """
        self.openapi_types = {
            'max_results': int,
            'next_token': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListMapsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListMaps_request of this ListMapsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_results(self):
        """Gets the max_results of this ListMapsRequest.

        <p>An optional limit for the number of resources returned in a single call. </p> <p>Default value: <code>100</code> </p>

        :return: The max_results of this ListMapsRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this ListMapsRequest.
    ...
    @property
    def next_token(self):
        """Gets the next_token of this ListMapsRequest.
        ...
        :return: The next_token of this ListMapsRequest.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this ListMapsRequest.
