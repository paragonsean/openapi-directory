...
class SearchPlaceIndexForSuggestionsRequest(Model):
    ...
    def __init__(self, bias_position: List[float]=None, filter_b_box: List[float]=None, filter_categories: List[str]=None, filter_countries: List[str]=None, language: str=None, max_results: int=None, text: str=None):
        """SearchPlaceIndexForSuggestionsRequest - a model defined in OpenAPI

        :param bias_position: The bias_position of this SearchPlaceIndexForSuggestionsRequest.
        :param filter_b_box: The filter_b_box of this SearchPlaceIndexForSuggestionsRequest.
        :param filter_categories: The filter_categories of this SearchPlaceIndexForSuggestionsRequest.
        :param filter_countries: The filter_countries of this SearchPlaceIndexForSuggestionsRequest.
        :param language: The language of this SearchPlaceIndexForSuggestionsRequest.
        :param max_results: The max_results of this SearchPlaceIndexForSuggestionsRequest.
        :param text: The text of this SearchPlaceIndexForSuggestionsRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SearchPlaceIndexForSuggestionsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SearchPlaceIndexForSuggestions_request of this SearchPlaceIndexForSuggestionsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def bias_position(self):
        """Gets the bias_position of this SearchPlaceIndexForSuggestionsRequest.
        ...
        :return: The bias_position of this SearchPlaceIndexForSuggestionsRequest.
        :rtype: List[float]
        """
    ...
    def bias_position(self, bias_position):
        """Sets the bias_position of this SearchPlaceIndexForSuggestionsRequest.
    ...
    def filter_b_box(self):
        """Gets the filter_b_box of this SearchPlaceIndexForSuggestionsRequest.
        ...
        :return: The filter_b_box of this SearchPlaceIndexForSuggestionsRequest.
        :rtype: List[float]
        """
    ...
    def filter_b_box(self, filter_b_box):
        """Sets the filter_b_box of this SearchPlaceIndexForSuggestionsRequest.
    ...
    def filter_categories(self):
        """Gets the filter_categories of this SearchPlaceIndexForSuggestionsRequest.
        ...
        :return: The filter_categories of this SearchPlaceIndexForSuggestionsRequest.
        :rtype: List[str]
        """
    ...
    def filter_categories(self, filter_categories):
        """Sets the filter_categories of this SearchPlaceIndexForSuggestionsRequest.
    ...
    def filter_countries(self):
        """Gets the filter_countries of this SearchPlaceIndexForSuggestionsRequest.
        ...
        :return: The filter_countries of this SearchPlaceIndexForSuggestionsRequest.
        :rtype: List[str]
        """
    ...
    def filter_countries(self, filter_countries):
        """Sets the filter_countries of this SearchPlaceIndexForSuggestionsRequest.
    ...
    @property
    def language(self):
        """Gets the language of this SearchPlaceIndexForSuggestionsRequest.
        ...
        :return: The language of this SearchPlaceIndexForSuggestionsRequest.
        :rtype: str
        """
    ...
    def language(self, language):
        """Sets the language of this SearchPlaceIndexForSuggestionsRequest.
    ...
    def max_results(self):
        """Gets the max_results of this SearchPlaceIndexForSuggestionsRequest.

        <p>An optional parameter. The maximum number of results returned per request. </p> <p>The default: <code>5</code> </p>

        :return: The max_results of this SearchPlaceIndexForSuggestionsRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this SearchPlaceIndexForSuggestionsRequest.
        ...
        """
        if max_results is not None and max_results > 15:
            raise ValueError("Invalid value for `max_results`, must be a value less than or equal to `15`")
    ...
    @property
    def text(self):
        """Gets the text of this SearchPlaceIndexForSuggestionsRequest.

        The free-form partial text to use to generate place suggestions. For example, <code>eiffel tow</code>.

        :return: The text of this SearchPlaceIndexForSuggestionsRequest.
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this SearchPlaceIndexForSuggestionsRequest.
