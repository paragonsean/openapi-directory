...
class ListPlaceIndexesRequest(Model):
    ...
    def __init__(self, max_results: int=None, next_token: str=None):
        """ListPlaceIndexesRequest - a model defined in OpenAPI

        :param max_results: The max_results of this ListPlaceIndexesRequest.
        :param next_token: The next_token of this ListPlaceIndexesRequest.
        """
        self.openapi_types = {
            'max_results': int,
            'next_token': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListPlaceIndexesRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListPlaceIndexes_request of this ListPlaceIndexesRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_results(self):
        """Gets the max_results of this ListPlaceIndexesRequest.

        <p>An optional limit for the maximum number of results returned in a single call.</p> <p>Default value: <code>100</code> </p>

        :return: The max_results of this ListPlaceIndexesRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this ListPlaceIndexesRequest.
    ...
    @property
    def next_token(self):
        """Gets the next_token of this ListPlaceIndexesRequest.
        ...
        :return: The next_token of this ListPlaceIndexesRequest.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this ListPlaceIndexesRequest.
