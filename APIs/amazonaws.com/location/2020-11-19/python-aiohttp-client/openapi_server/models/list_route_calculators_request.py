...
class ListRouteCalculatorsRequest(Model):
    ...
    def __init__(self, max_results: int=None, next_token: str=None):
        """ListRouteCalculatorsRequest - a model defined in OpenAPI

        :param max_results: The max_results of this ListRouteCalculatorsRequest.
        :param next_token: The next_token of this ListRouteCalculatorsRequest.
        """
        self.openapi_types = {
            'max_results': int,
            'next_token': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListRouteCalculatorsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListRouteCalculators_request of this ListRouteCalculatorsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_results(self):
        """Gets the max_results of this ListRouteCalculatorsRequest.

        <p>An optional maximum number of results returned in a single call.</p> <p>Default Value: <code>100</code> </p>

        :return: The max_results of this ListRouteCalculatorsRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this ListRouteCalculatorsRequest.
    ...
    @property
    def next_token(self):
        """Gets the next_token of this ListRouteCalculatorsRequest.
        ...
        :return: The next_token of this ListRouteCalculatorsRequest.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this ListRouteCalculatorsRequest.
