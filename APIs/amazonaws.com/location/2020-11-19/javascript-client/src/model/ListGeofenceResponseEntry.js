...
/**
 * The ListGeofenceResponseEntry model module.
 * @module model/ListGeofenceResponseEntry
 * @version 2020-11-19
 */
class ListGeofenceResponseEntry {
    /**
     * Constructs a new <code>ListGeofenceResponseEntry</code>.
     * Contains a list of geofences stored in a given geofence collection.
     * @alias module:model/ListGeofenceResponseEntry
    ...
    constructor(createTime, geofenceId, geometry, status, updateTime) { 
        ...
        ListGeofenceResponseEntry.initialize(this, createTime, geofenceId, geometry, status, updateTime);
    }
    ...
    /**
     * Constructs a <code>ListGeofenceResponseEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGeofenceResponseEntry} obj Optional instance to populate.
     * @return {module:model/ListGeofenceResponseEntry} The populated <code>ListGeofenceResponseEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGeofenceResponseEntry();
    ...
    /**
     * Validates the JSON data with respect to <code>ListGeofenceResponseEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGeofenceResponseEntry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListGeofenceResponseEntry.RequiredProperties) {
...
ListGeofenceResponseEntry.RequiredProperties = ["CreateTime", "GeofenceId", "Geometry", "Status", "UpdateTime"];

/**
 * @member {Date} CreateTime
 */
ListGeofenceResponseEntry.prototype['CreateTime'] = undefined;

/**
 * @member {String} GeofenceId
 */
ListGeofenceResponseEntry.prototype['GeofenceId'] = undefined;

/**
 * @member {Object} GeofenceProperties
 */
ListGeofenceResponseEntry.prototype['GeofenceProperties'] = undefined;

/**
 * @member {module:model/GetGeofenceResponseGeometry} Geometry
 */
ListGeofenceResponseEntry.prototype['Geometry'] = undefined;

/**
 * @member {String} Status
 */
ListGeofenceResponseEntry.prototype['Status'] = undefined;

/**
 * @member {Date} UpdateTime
 */
ListGeofenceResponseEntry.prototype['UpdateTime'] = undefined;
...
export default ListGeofenceResponseEntry;
