...
/**
 * The SearchForPositionResultPlace model module.
 * @module model/SearchForPositionResultPlace
 * @version 2020-11-19
 */
class SearchForPositionResultPlace {
    /**
     * Constructs a new <code>SearchForPositionResultPlace</code>.
     * @alias module:model/SearchForPositionResultPlace
     * @implements module:model/Place
     * @param geometry {module:model/PlaceGeometry} 
     */
    constructor(geometry) { 
        Place.initialize(this, geometry);
        SearchForPositionResultPlace.initialize(this, geometry);
    }
    ...
    /**
     * Constructs a <code>SearchForPositionResultPlace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchForPositionResultPlace} obj Optional instance to populate.
     * @return {module:model/SearchForPositionResultPlace} The populated <code>SearchForPositionResultPlace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchForPositionResultPlace();
    ...
    /**
     * Validates the JSON data with respect to <code>SearchForPositionResultPlace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchForPositionResultPlace</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SearchForPositionResultPlace.RequiredProperties) {
...
SearchForPositionResultPlace.RequiredProperties = ["Geometry"];

/**
 * @member {String} AddressNumber
 */
SearchForPositionResultPlace.prototype['AddressNumber'] = undefined;

/**
 * @member {Array} Categories
 */
SearchForPositionResultPlace.prototype['Categories'] = undefined;

/**
 * @member {String} Country
 */
SearchForPositionResultPlace.prototype['Country'] = undefined;

/**
 * @member {module:model/PlaceGeometry} Geometry
 */
SearchForPositionResultPlace.prototype['Geometry'] = undefined;

/**
 * @member {Boolean} Interpolated
 */
SearchForPositionResultPlace.prototype['Interpolated'] = undefined;

/**
 * @member {String} Label
 */
SearchForPositionResultPlace.prototype['Label'] = undefined;

/**
 * @member {String} Municipality
 */
SearchForPositionResultPlace.prototype['Municipality'] = undefined;

/**
 * @member {String} Neighborhood
 */
SearchForPositionResultPlace.prototype['Neighborhood'] = undefined;

/**
 * @member {String} PostalCode
 */
SearchForPositionResultPlace.prototype['PostalCode'] = undefined;

/**
 * @member {String} Region
 */
SearchForPositionResultPlace.prototype['Region'] = undefined;

/**
 * @member {String} Street
 */
SearchForPositionResultPlace.prototype['Street'] = undefined;

/**
 * @member {String} SubRegion
 */
SearchForPositionResultPlace.prototype['SubRegion'] = undefined;

/**
 * @member {Array} SupplementalCategories
 */
SearchForPositionResultPlace.prototype['SupplementalCategories'] = undefined;

/**
 * @member {module:model/PlaceTimeZone} TimeZone
 */
SearchForPositionResultPlace.prototype['TimeZone'] = undefined;

/**
 * @member {String} UnitNumber
 */
SearchForPositionResultPlace.prototype['UnitNumber'] = undefined;

/**
 * @member {String} UnitType
 */
SearchForPositionResultPlace.prototype['UnitType'] = undefined;
...
export default SearchForPositionResultPlace;
