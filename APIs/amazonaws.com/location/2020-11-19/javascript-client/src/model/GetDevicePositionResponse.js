...
/**
 * The GetDevicePositionResponse model module.
 * @module model/GetDevicePositionResponse
 * @version 2020-11-19
 */
class GetDevicePositionResponse {
    /**
     * Constructs a new <code>GetDevicePositionResponse</code>.
     * @alias module:model/GetDevicePositionResponse
    ...
    constructor(position, receivedTime, sampleTime) { 
        ...
        GetDevicePositionResponse.initialize(this, position, receivedTime, sampleTime);
    }
    ...
    /**
     * Constructs a <code>GetDevicePositionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDevicePositionResponse} obj Optional instance to populate.
     * @return {module:model/GetDevicePositionResponse} The populated <code>GetDevicePositionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDevicePositionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDevicePositionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDevicePositionResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetDevicePositionResponse.RequiredProperties) {
...
GetDevicePositionResponse.RequiredProperties = ["Position", "ReceivedTime", "SampleTime"];

/**
 * @member {module:model/DevicePositionUpdateAccuracy} Accuracy
 */
GetDevicePositionResponse.prototype['Accuracy'] = undefined;

/**
 * @member {String} DeviceId
 */
GetDevicePositionResponse.prototype['DeviceId'] = undefined;

/**
 * @member {Array} Position
 */
GetDevicePositionResponse.prototype['Position'] = undefined;

/**
 * @member {Object} PositionProperties
 */
GetDevicePositionResponse.prototype['PositionProperties'] = undefined;

/**
 * @member {Date} ReceivedTime
 */
GetDevicePositionResponse.prototype['ReceivedTime'] = undefined;

/**
 * @member {Date} SampleTime
 */
GetDevicePositionResponse.prototype['SampleTime'] = undefined;
...
export default GetDevicePositionResponse;
