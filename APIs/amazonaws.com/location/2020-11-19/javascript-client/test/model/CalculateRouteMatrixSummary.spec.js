...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.CalculateRouteMatrixSummary();
  });
  ...
  describe('CalculateRouteMatrixSummary', function() {
    it('should create an instance of CalculateRouteMatrixSummary', function() {
      // uncomment below and update the code to test CalculateRouteMatrixSummary
      //var instance = new AmazonLocationService.CalculateRouteMatrixSummary();
      //expect(instance).to.be.a(AmazonLocationService.CalculateRouteMatrixSummary);
    });
