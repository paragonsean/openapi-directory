...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.ListMapsResponseEntry();
  });
  ...
  describe('ListMapsResponseEntry', function() {
    it('should create an instance of ListMapsResponseEntry', function() {
      // uncomment below and update the code to test ListMapsResponseEntry
      //var instance = new AmazonLocationService.ListMapsResponseEntry();
      //expect(instance).to.be.a(AmazonLocationService.ListMapsResponseEntry);
    });
