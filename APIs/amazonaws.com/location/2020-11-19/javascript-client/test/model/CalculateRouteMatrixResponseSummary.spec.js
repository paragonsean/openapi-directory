...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.CalculateRouteMatrixResponseSummary();
  });
  ...
  describe('CalculateRouteMatrixResponseSummary', function() {
    it('should create an instance of CalculateRouteMatrixResponseSummary', function() {
      // uncomment below and update the code to test CalculateRouteMatrixResponseSummary
      //var instance = new AmazonLocationService.CalculateRouteMatrixResponseSummary();
      //expect(instance).to.be.a(AmazonLocationService.CalculateRouteMatrixResponseSummary);
    });
    ...
    it('should have the property routeCount (base name: "RouteCount")', function() {
