...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.ListPlaceIndexesResponseEntry();
  });
  ...
  describe('ListPlaceIndexesResponseEntry', function() {
    it('should create an instance of ListPlaceIndexesResponseEntry', function() {
      // uncomment below and update the code to test ListPlaceIndexesResponseEntry
      //var instance = new AmazonLocationService.ListPlaceIndexesResponseEntry();
      //expect(instance).to.be.a(AmazonLocationService.ListPlaceIndexesResponseEntry);
    });
