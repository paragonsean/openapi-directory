...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.DescribeMapResponse();
  });
  ...
  describe('DescribeMapResponse', function() {
    it('should create an instance of DescribeMapResponse', function() {
      // uncomment below and update the code to test DescribeMapResponse
      //var instance = new AmazonLocationService.DescribeMapResponse();
      //expect(instance).to.be.a(AmazonLocationService.DescribeMapResponse);
    });
