...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.ListKeysResponse();
  });
  ...
  describe('ListKeysResponse', function() {
    it('should create an instance of ListKeysResponse', function() {
      ...
      //var instance = new AmazonLocationService.ListKeysResponse();
      //expect(instance).to.be.a(AmazonLocationService.ListKeysResponse);
    });
