...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.ListTrackersResponse();
  });
  ...
  describe('ListTrackersResponse', function() {
    it('should create an instance of ListTrackersResponse', function() {
      // uncomment below and update the code to test ListTrackersResponse
      //var instance = new AmazonLocationService.ListTrackersResponse();
      //expect(instance).to.be.a(AmazonLocationService.ListTrackersResponse);
    });
