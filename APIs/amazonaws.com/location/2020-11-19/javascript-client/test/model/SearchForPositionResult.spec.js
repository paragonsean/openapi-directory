...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.SearchForPositionResult();
  });
  ...
  describe('SearchForPositionResult', function() {
    it('should create an instance of SearchForPositionResult', function() {
      // uncomment below and update the code to test SearchForPositionResult
      //var instance = new AmazonLocationService.SearchForPositionResult();
      //expect(instance).to.be.a(AmazonLocationService.SearchForPositionResult);
    });
