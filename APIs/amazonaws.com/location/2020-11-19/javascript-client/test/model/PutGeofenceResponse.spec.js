...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.PutGeofenceResponse();
  });
  ...
  describe('PutGeofenceResponse', function() {
    it('should create an instance of PutGeofenceResponse', function() {
      // uncomment below and update the code to test PutGeofenceResponse
      //var instance = new AmazonLocationService.PutGeofenceResponse();
      //expect(instance).to.be.a(AmazonLocationService.PutGeofenceResponse);
    });
