...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.ListKeysResponseEntry();
  });
  ...
  describe('ListKeysResponseEntry', function() {
    it('should create an instance of ListKeysResponseEntry', function() {
      // uncomment below and update the code to test ListKeysResponseEntry
      //var instance = new AmazonLocationService.ListKeysResponseEntry();
      //expect(instance).to.be.a(AmazonLocationService.ListKeysResponseEntry);
    });
