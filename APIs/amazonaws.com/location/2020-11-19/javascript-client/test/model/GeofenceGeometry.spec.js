...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.GeofenceGeometry();
  });
  ...
  describe('GeofenceGeometry', function() {
    it('should create an instance of GeofenceGeometry', function() {
      // uncomment below and update the code to test GeofenceGeometry
      //var instance = new AmazonLocationService.GeofenceGeometry();
      //expect(instance).to.be.a(AmazonLocationService.GeofenceGeometry);
    });
