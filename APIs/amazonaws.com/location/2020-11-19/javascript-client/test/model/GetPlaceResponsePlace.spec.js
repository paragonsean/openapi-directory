...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.GetPlaceResponsePlace();
  });
  ...
  describe('GetPlaceResponsePlace', function() {
    it('should create an instance of GetPlaceResponsePlace', function() {
      // uncomment below and update the code to test GetPlaceResponsePlace
      //var instance = new AmazonLocationService.GetPlaceResponsePlace();
      //expect(instance).to.be.a(AmazonLocationService.GetPlaceResponsePlace);
    });
