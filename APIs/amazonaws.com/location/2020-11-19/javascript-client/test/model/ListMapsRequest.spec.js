...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.ListMapsRequest();
  });
  ...
  describe('ListMapsRequest', function() {
    it('should create an instance of ListMapsRequest', function() {
      // uncomment below and update the code to test ListMapsRequest
      //var instance = new AmazonLocationService.ListMapsRequest();
      //expect(instance).to.be.a(AmazonLocationService.ListMapsRequest);
    });
