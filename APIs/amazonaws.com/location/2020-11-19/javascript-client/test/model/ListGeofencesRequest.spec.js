...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.ListGeofencesRequest();
  });
  ...
  describe('ListGeofencesRequest', function() {
    it('should create an instance of ListGeofencesRequest', function() {
      // uncomment below and update the code to test ListGeofencesRequest
      //var instance = new AmazonLocationService.ListGeofencesRequest();
      //expect(instance).to.be.a(AmazonLocationService.ListGeofencesRequest);
    });
