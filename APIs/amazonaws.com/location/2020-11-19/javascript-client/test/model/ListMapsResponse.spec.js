...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.ListMapsResponse();
  });
  ...
  describe('ListMapsResponse', function() {
    it('should create an instance of ListMapsResponse', function() {
      // uncomment below and update the code to test ListMapsResponse
      //var instance = new AmazonLocationService.ListMapsResponse();
      //expect(instance).to.be.a(AmazonLocationService.ListMapsResponse);
    });
