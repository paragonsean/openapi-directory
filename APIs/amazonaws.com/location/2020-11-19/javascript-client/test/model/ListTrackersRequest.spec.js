...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLocationService.ListTrackersRequest();
  });
  ...
  describe('ListTrackersRequest', function() {
    it('should create an instance of ListTrackersRequest', function() {
      // uncomment below and update the code to test ListTrackersRequest
      //var instance = new AmazonLocationService.ListTrackersRequest();
      //expect(instance).to.be.a(AmazonLocationService.ListTrackersRequest);
    });
