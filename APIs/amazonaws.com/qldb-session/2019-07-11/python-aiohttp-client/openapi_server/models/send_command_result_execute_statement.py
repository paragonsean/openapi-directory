...
class SendCommandResultExecuteStatement(Model):
    ...
    def __init__(self, first_page: ExecuteStatementResultFirstPage=None, timing_information: AbortTransactionResultTimingInformation=None, consumed_ios: CommitTransactionResultConsumedIOs=None):
        """SendCommandResultExecuteStatement - a model defined in OpenAPI

        :param first_page: The first_page of this SendCommandResultExecuteStatement.
        :param timing_information: The timing_information of this SendCommandResultExecuteStatement.
        :param consumed_ios: The consumed_ios of this SendCommandResultExecuteStatement.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SendCommandResultExecuteStatement':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SendCommandResult_ExecuteStatement of this SendCommandResultExecuteStatement.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def first_page(self):
        """Gets the first_page of this SendCommandResultExecuteStatement.


        :return: The first_page of this SendCommandResultExecuteStatement.
    ...
    def first_page(self, first_page):
        """Sets the first_page of this SendCommandResultExecuteStatement.
    ...
    def timing_information(self):
        """Gets the timing_information of this SendCommandResultExecuteStatement.


        :return: The timing_information of this SendCommandResultExecuteStatement.
    ...
    def timing_information(self, timing_information):
        """Sets the timing_information of this SendCommandResultExecuteStatement.
    ...
    def consumed_ios(self):
        """Gets the consumed_ios of this SendCommandResultExecuteStatement.


        :return: The consumed_ios of this SendCommandResultExecuteStatement.
    ...
    def consumed_ios(self, consumed_ios):
        """Sets the consumed_ios of this SendCommandResultExecuteStatement.
