...
/*
 * OAISendCommandResult_StartTransaction.h
 *
 * 
 */

#ifndef OAISendCommandResult_StartTransaction_H
#define OAISendCommandResult_StartTransaction_H
...
class OAISendCommandResult_StartTransaction : public OAIObject {
public:
    OAISendCommandResult_StartTransaction();
    OAISendCommandResult_StartTransaction(QString json);
    ~OAISendCommandResult_StartTransaction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendCommandResult_StartTransaction)

#endif // OAISendCommandResult_StartTransaction_H
