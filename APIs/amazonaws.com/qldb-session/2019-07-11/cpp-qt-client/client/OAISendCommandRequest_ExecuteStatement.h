...
/*
 * OAISendCommandRequest_ExecuteStatement.h
 *
 * 
 */

#ifndef OAISendCommandRequest_ExecuteStatement_H
#define OAISendCommandRequest_ExecuteStatement_H
...
class OAISendCommandRequest_ExecuteStatement : public OAIObject {
public:
    OAISendCommandRequest_ExecuteStatement();
    OAISendCommandRequest_ExecuteStatement(QString json);
    ~OAISendCommandRequest_ExecuteStatement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendCommandRequest_ExecuteStatement)

#endif // OAISendCommandRequest_ExecuteStatement_H
