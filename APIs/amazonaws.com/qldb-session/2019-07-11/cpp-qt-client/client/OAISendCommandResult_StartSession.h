...
/*
 * OAISendCommandResult_StartSession.h
 *
 * 
 */

#ifndef OAISendCommandResult_StartSession_H
#define OAISendCommandResult_StartSession_H
...
class OAISendCommandResult_StartSession : public OAIObject {
public:
    OAISendCommandResult_StartSession();
    OAISendCommandResult_StartSession(QString json);
    ~OAISendCommandResult_StartSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendCommandResult_StartSession)

#endif // OAISendCommandResult_StartSession_H
