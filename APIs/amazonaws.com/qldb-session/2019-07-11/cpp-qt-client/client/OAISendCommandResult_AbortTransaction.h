...
/*
 * OAISendCommandResult_AbortTransaction.h
 *
 * 
 */

#ifndef OAISendCommandResult_AbortTransaction_H
#define OAISendCommandResult_AbortTransaction_H
...
class OAISendCommandResult_AbortTransaction : public OAIObject {
public:
    OAISendCommandResult_AbortTransaction();
    OAISendCommandResult_AbortTransaction(QString json);
    ~OAISendCommandResult_AbortTransaction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendCommandResult_AbortTransaction)

#endif // OAISendCommandResult_AbortTransaction_H
