...
/*
 * OAIEndSessionResult.h
 *
 * Contains the details of the ended session.
 */

#ifndef OAIEndSessionResult_H
#define OAIEndSessionResult_H
...
class OAIEndSessionResult : public OAIObject {
public:
    OAIEndSessionResult();
    OAIEndSessionResult(QString json);
    ~OAIEndSessionResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndSessionResult)

#endif // OAIEndSessionResult_H
