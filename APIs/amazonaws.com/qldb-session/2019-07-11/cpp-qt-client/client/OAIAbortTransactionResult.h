...
/*
 * OAIAbortTransactionResult.h
 *
 * Contains the details of the aborted transaction.
 */

#ifndef OAIAbortTransactionResult_H
#define OAIAbortTransactionResult_H
...
class OAIAbortTransactionResult : public OAIObject {
public:
    OAIAbortTransactionResult();
    OAIAbortTransactionResult(QString json);
    ~OAIAbortTransactionResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAbortTransactionResult)

#endif // OAIAbortTransactionResult_H
