...
/*
 * OAIExecuteStatementResult_FirstPage.h
 *
 * 
 */

#ifndef OAIExecuteStatementResult_FirstPage_H
#define OAIExecuteStatementResult_FirstPage_H
...
class OAIExecuteStatementResult_FirstPage : public OAIObject {
public:
    OAIExecuteStatementResult_FirstPage();
    OAIExecuteStatementResult_FirstPage(QString json);
    ~OAIExecuteStatementResult_FirstPage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecuteStatementResult_FirstPage)

#endif // OAIExecuteStatementResult_FirstPage_H
