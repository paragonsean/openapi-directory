...
/*
 * OAIFetchPageResult_Page.h
 *
 * 
 */

#ifndef OAIFetchPageResult_Page_H
#define OAIFetchPageResult_Page_H
...
class OAIFetchPageResult_Page : public OAIObject {
public:
    OAIFetchPageResult_Page();
    OAIFetchPageResult_Page(QString json);
    ~OAIFetchPageResult_Page() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFetchPageResult_Page)

#endif // OAIFetchPageResult_Page_H
