...
/*
 * OAIFetchPageRequest.h
 *
 * Specifies the details of the page to be fetched.
 */

#ifndef OAIFetchPageRequest_H
#define OAIFetchPageRequest_H
...
class OAIFetchPageRequest : public OAIObject {
public:
    OAIFetchPageRequest();
    OAIFetchPageRequest(QString json);
    ~OAIFetchPageRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFetchPageRequest)

#endif // OAIFetchPageRequest_H
