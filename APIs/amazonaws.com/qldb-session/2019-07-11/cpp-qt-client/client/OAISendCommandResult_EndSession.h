...
/*
 * OAISendCommandResult_EndSession.h
 *
 * 
 */

#ifndef OAISendCommandResult_EndSession_H
#define OAISendCommandResult_EndSession_H
...
class OAISendCommandResult_EndSession : public OAIObject {
public:
    OAISendCommandResult_EndSession();
    OAISendCommandResult_EndSession(QString json);
    ~OAISendCommandResult_EndSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendCommandResult_EndSession)

#endif // OAISendCommandResult_EndSession_H
