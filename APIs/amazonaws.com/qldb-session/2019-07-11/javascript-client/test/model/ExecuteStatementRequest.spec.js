...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonQldbSession.ExecuteStatementRequest();
  });
  ...
  describe('ExecuteStatementRequest', function() {
    it('should create an instance of ExecuteStatementRequest', function() {
      // uncomment below and update the code to test ExecuteStatementRequest
      //var instance = new AmazonQldbSession.ExecuteStatementRequest();
      //expect(instance).to.be.a(AmazonQldbSession.ExecuteStatementRequest);
    });
