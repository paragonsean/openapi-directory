...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonQldbSession.SendCommandRequestFetchPage();
  });
  ...
  describe('SendCommandRequestFetchPage', function() {
    it('should create an instance of SendCommandRequestFetchPage', function() {
      // uncomment below and update the code to test SendCommandRequestFetchPage
      //var instance = new AmazonQldbSession.SendCommandRequestFetchPage();
      //expect(instance).to.be.a(AmazonQldbSession.SendCommandRequestFetchPage);
    });
