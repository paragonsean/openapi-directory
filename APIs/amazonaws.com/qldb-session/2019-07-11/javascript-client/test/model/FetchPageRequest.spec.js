...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonQldbSession.FetchPageRequest();
  });
  ...
  describe('FetchPageRequest', function() {
    it('should create an instance of FetchPageRequest', function() {
      // uncomment below and update the code to test FetchPageRequest
      //var instance = new AmazonQldbSession.FetchPageRequest();
      //expect(instance).to.be.a(AmazonQldbSession.FetchPageRequest);
    });
