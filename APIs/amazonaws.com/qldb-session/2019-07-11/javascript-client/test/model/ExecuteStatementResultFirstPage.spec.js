...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonQldbSession.ExecuteStatementResultFirstPage();
  });
  ...
  describe('ExecuteStatementResultFirstPage', function() {
    it('should create an instance of ExecuteStatementResultFirstPage', function() {
      // uncomment below and update the code to test ExecuteStatementResultFirstPage
      //var instance = new AmazonQldbSession.ExecuteStatementResultFirstPage();
      //expect(instance).to.be.a(AmazonQldbSession.ExecuteStatementResultFirstPage);
    });
