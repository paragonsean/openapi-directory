...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://session.qldb.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://session.qldb.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2019-07-11/Javascript'
        };
