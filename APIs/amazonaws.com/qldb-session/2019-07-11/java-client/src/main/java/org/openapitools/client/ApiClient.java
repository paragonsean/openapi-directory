...
public class ApiClient {
    ...
    private String basePath = "http://session.qldb.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2019-07-11/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://session.qldb.us-east-1.amazonaws.com
