...
class GetAnalysisTemplateOutput(Model):
    ...
    def __init__(self, analysis_template: CreateAnalysisTemplateOutputAnalysisTemplate=None):
        """GetAnalysisTemplateOutput - a model defined in OpenAPI

        :param analysis_template: The analysis_template of this GetAnalysisTemplateOutput.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetAnalysisTemplateOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetAnalysisTemplateOutput of this GetAnalysisTemplateOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def analysis_template(self):
        """Gets the analysis_template of this GetAnalysisTemplateOutput.


        :return: The analysis_template of this GetAnalysisTemplateOutput.
    ...
    def analysis_template(self, analysis_template):
        """Sets the analysis_template of this GetAnalysisTemplateOutput.
