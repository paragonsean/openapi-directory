...
/*
 * OAICollaborationAnalysisTemplate.h
 *
 * The analysis template within a collaboration.
 */

#ifndef OAICollaborationAnalysisTemplate_H
#define OAICollaborationAnalysisTemplate_H
...
class OAICollaborationAnalysisTemplate : public OAIObject {
public:
    OAICollaborationAnalysisTemplate();
    OAICollaborationAnalysisTemplate(QString json);
    ~OAICollaborationAnalysisTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICollaborationAnalysisTemplate)

#endif // OAICollaborationAnalysisTemplate_H
