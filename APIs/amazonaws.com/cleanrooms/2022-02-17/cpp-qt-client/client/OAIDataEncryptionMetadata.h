...
/*
 * OAIDataEncryptionMetadata.h
 *
 * The settings for client-side encryption for cryptographic computing.
 */

#ifndef OAIDataEncryptionMetadata_H
#define OAIDataEncryptionMetadata_H
...
class OAIDataEncryptionMetadata : public OAIObject {
public:
    OAIDataEncryptionMetadata();
    OAIDataEncryptionMetadata(QString json);
    ~OAIDataEncryptionMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataEncryptionMetadata)

#endif // OAIDataEncryptionMetadata_H
