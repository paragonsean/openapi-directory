...
/*
 * OAIGetSchemaOutput_schema.h
 *
 * 
 */

#ifndef OAIGetSchemaOutput_schema_H
#define OAIGetSchemaOutput_schema_H
...
class OAIGetSchemaOutput_schema : public OAIObject {
public:
    OAIGetSchemaOutput_schema();
    OAIGetSchemaOutput_schema(QString json);
    ~OAIGetSchemaOutput_schema() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSchemaOutput_schema)

#endif // OAIGetSchemaOutput_schema_H
