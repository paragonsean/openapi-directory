...
#include "OAIMembershipSummary.h"
...
OAIMembershipSummary::OAIMembershipSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMembershipSummary::OAIMembershipSummary() {
    this->initializeModel();
}

OAIMembershipSummary::~OAIMembershipSummary() {}

void OAIMembershipSummary::initializeModel() {
...
void OAIMembershipSummary::fromJson(QString jsonString) {
...
void OAIMembershipSummary::fromJsonObject(QJsonObject json) {
...
QString OAIMembershipSummary::asJson() const {
...
QJsonObject OAIMembershipSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIMembershipSummary::getId() const {
    return m_id;
}
void OAIMembershipSummary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMembershipSummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMembershipSummary::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIMembershipSummary::getArn() const {
    return m_arn;
}
void OAIMembershipSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIMembershipSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIMembershipSummary::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIMembershipSummary::getCollaborationArn() const {
    return m_collaboration_arn;
}
void OAIMembershipSummary::setCollaborationArn(const QString &collaboration_arn) {
    m_collaboration_arn = collaboration_arn;
    m_collaboration_arn_isSet = true;
}

bool OAIMembershipSummary::is_collaboration_arn_Set() const{
    return m_collaboration_arn_isSet;
}

bool OAIMembershipSummary::is_collaboration_arn_Valid() const{
    return m_collaboration_arn_isValid;
}

QString OAIMembershipSummary::getCollaborationId() const {
    return m_collaboration_id;
}
void OAIMembershipSummary::setCollaborationId(const QString &collaboration_id) {
    m_collaboration_id = collaboration_id;
    m_collaboration_id_isSet = true;
}

bool OAIMembershipSummary::is_collaboration_id_Set() const{
    return m_collaboration_id_isSet;
}

bool OAIMembershipSummary::is_collaboration_id_Valid() const{
    return m_collaboration_id_isValid;
}

QString OAIMembershipSummary::getCollaborationCreatorAccountId() const {
    return m_collaboration_creator_account_id;
}
void OAIMembershipSummary::setCollaborationCreatorAccountId(const QString &collaboration_creator_account_id) {
    m_collaboration_creator_account_id = collaboration_creator_account_id;
    m_collaboration_creator_account_id_isSet = true;
}

bool OAIMembershipSummary::is_collaboration_creator_account_id_Set() const{
    return m_collaboration_creator_account_id_isSet;
}

bool OAIMembershipSummary::is_collaboration_creator_account_id_Valid() const{
    return m_collaboration_creator_account_id_isValid;
}

QString OAIMembershipSummary::getCollaborationCreatorDisplayName() const {
    return m_collaboration_creator_display_name;
}
void OAIMembershipSummary::setCollaborationCreatorDisplayName(const QString &collaboration_creator_display_name) {
    m_collaboration_creator_display_name = collaboration_creator_display_name;
    m_collaboration_creator_display_name_isSet = true;
}

bool OAIMembershipSummary::is_collaboration_creator_display_name_Set() const{
    return m_collaboration_creator_display_name_isSet;
}

bool OAIMembershipSummary::is_collaboration_creator_display_name_Valid() const{
    return m_collaboration_creator_display_name_isValid;
}

QString OAIMembershipSummary::getCollaborationName() const {
    return m_collaboration_name;
}
void OAIMembershipSummary::setCollaborationName(const QString &collaboration_name) {
    m_collaboration_name = collaboration_name;
    m_collaboration_name_isSet = true;
}

bool OAIMembershipSummary::is_collaboration_name_Set() const{
    return m_collaboration_name_isSet;
}

bool OAIMembershipSummary::is_collaboration_name_Valid() const{
    return m_collaboration_name_isValid;
}

QDateTime OAIMembershipSummary::getCreateTime() const {
    return m_create_time;
}
void OAIMembershipSummary::setCreateTime(const QDateTime &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAIMembershipSummary::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAIMembershipSummary::is_create_time_Valid() const{
    return m_create_time_isValid;
}

QDateTime OAIMembershipSummary::getUpdateTime() const {
    return m_update_time;
}
void OAIMembershipSummary::setUpdateTime(const QDateTime &update_time) {
    m_update_time = update_time;
    m_update_time_isSet = true;
}

bool OAIMembershipSummary::is_update_time_Set() const{
    return m_update_time_isSet;
}

bool OAIMembershipSummary::is_update_time_Valid() const{
    return m_update_time_isValid;
}

OAIMembershipStatus OAIMembershipSummary::getStatus() const {
    return m_status;
}
void OAIMembershipSummary::setStatus(const OAIMembershipStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIMembershipSummary::is_status_Set() const{
    return m_status_isSet;
}

bool OAIMembershipSummary::is_status_Valid() const{
    return m_status_isValid;
}

QList OAIMembershipSummary::getMemberAbilities() const {
    return m_member_abilities;
}
void OAIMembershipSummary::setMemberAbilities(const QList &member_abilities) {
    m_member_abilities = member_abilities;
    m_member_abilities_isSet = true;
}

bool OAIMembershipSummary::is_member_abilities_Set() const{
    return m_member_abilities_isSet;
}

bool OAIMembershipSummary::is_member_abilities_Valid() const{
    return m_member_abilities_isValid;
}

bool OAIMembershipSummary::isSet() const {
...
bool OAIMembershipSummary::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_id_isValid && m_arn_isValid && m_collaboration_arn_isValid && m_collaboration_id_isValid && m_collaboration_creator_account_id_isValid && m_collaboration_creator_display_name_isValid && m_collaboration_name_isValid && m_create_time_isValid && m_update_time_isValid && m_status_isValid && m_member_abilities_isValid && true;
}
