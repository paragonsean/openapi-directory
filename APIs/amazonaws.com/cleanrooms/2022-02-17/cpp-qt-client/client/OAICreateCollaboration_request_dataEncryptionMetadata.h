...
/*
 * OAICreateCollaboration_request_dataEncryptionMetadata.h
 *
 * The settings for client-side encryption for cryptographic computing.
 */

#ifndef OAICreateCollaboration_request_dataEncryptionMetadata_H
#define OAICreateCollaboration_request_dataEncryptionMetadata_H
...
class OAICreateCollaboration_request_dataEncryptionMetadata : public OAIObject {
public:
    OAICreateCollaboration_request_dataEncryptionMetadata();
    OAICreateCollaboration_request_dataEncryptionMetadata(QString json);
    ~OAICreateCollaboration_request_dataEncryptionMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCollaboration_request_dataEncryptionMetadata)

#endif // OAICreateCollaboration_request_dataEncryptionMetadata_H
