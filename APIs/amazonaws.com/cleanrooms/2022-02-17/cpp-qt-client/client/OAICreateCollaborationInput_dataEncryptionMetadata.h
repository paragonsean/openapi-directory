...
/*
 * OAICreateCollaborationInput_dataEncryptionMetadata.h
 *
 * 
 */

#ifndef OAICreateCollaborationInput_dataEncryptionMetadata_H
#define OAICreateCollaborationInput_dataEncryptionMetadata_H
...
class OAICreateCollaborationInput_dataEncryptionMetadata : public OAIObject {
public:
    OAICreateCollaborationInput_dataEncryptionMetadata();
    OAICreateCollaborationInput_dataEncryptionMetadata(QString json);
    ~OAICreateCollaborationInput_dataEncryptionMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCollaborationInput_dataEncryptionMetadata)

#endif // OAICreateCollaborationInput_dataEncryptionMetadata_H
