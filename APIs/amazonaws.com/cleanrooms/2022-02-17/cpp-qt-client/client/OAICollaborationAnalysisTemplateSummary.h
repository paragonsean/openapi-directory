...
/*
 * OAICollaborationAnalysisTemplateSummary.h
 *
 * The metadata of the analysis template within a collaboration.
 */

#ifndef OAICollaborationAnalysisTemplateSummary_H
#define OAICollaborationAnalysisTemplateSummary_H
...
class OAICollaborationAnalysisTemplateSummary : public OAIObject {
public:
    OAICollaborationAnalysisTemplateSummary();
    OAICollaborationAnalysisTemplateSummary(QString json);
    ~OAICollaborationAnalysisTemplateSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICollaborationAnalysisTemplateSummary)

#endif // OAICollaborationAnalysisTemplateSummary_H
