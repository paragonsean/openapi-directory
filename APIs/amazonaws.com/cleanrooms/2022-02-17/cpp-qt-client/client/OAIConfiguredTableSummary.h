...
/*
 * OAIConfiguredTableSummary.h
 *
 * The configured table summary for the objects listed by the request.
 */

#ifndef OAIConfiguredTableSummary_H
#define OAIConfiguredTableSummary_H
...
class OAIConfiguredTableSummary : public OAIObject {
public:
    OAIConfiguredTableSummary();
    OAIConfiguredTableSummary(QString json);
    ~OAIConfiguredTableSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfiguredTableSummary)

#endif // OAIConfiguredTableSummary_H
