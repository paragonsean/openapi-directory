...
/*
 * OAIConfiguredTable.h
 *
 * A table that has been configured for use in a collaboration.
 */

#ifndef OAIConfiguredTable_H
#define OAIConfiguredTable_H
...
class OAIConfiguredTable : public OAIObject {
public:
    OAIConfiguredTable();
    OAIConfiguredTable(QString json);
    ~OAIConfiguredTable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfiguredTable)

#endif // OAIConfiguredTable_H
