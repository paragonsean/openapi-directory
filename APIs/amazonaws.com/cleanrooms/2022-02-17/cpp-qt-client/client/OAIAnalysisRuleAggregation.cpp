...
#include "OAIAnalysisRuleAggregation.h"
...
OAIAnalysisRuleAggregation::OAIAnalysisRuleAggregation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAnalysisRuleAggregation::OAIAnalysisRuleAggregation() {
    this->initializeModel();
}

OAIAnalysisRuleAggregation::~OAIAnalysisRuleAggregation() {}

void OAIAnalysisRuleAggregation::initializeModel() {
...
void OAIAnalysisRuleAggregation::fromJson(QString jsonString) {
...
void OAIAnalysisRuleAggregation::fromJsonObject(QJsonObject json) {
...
QString OAIAnalysisRuleAggregation::asJson() const {
...
QJsonObject OAIAnalysisRuleAggregation::asJsonObject() const {
    QJsonObject obj;
...
QList OAIAnalysisRuleAggregation::getAggregateColumns() const {
    return m_aggregate_columns;
}
void OAIAnalysisRuleAggregation::setAggregateColumns(const QList &aggregate_columns) {
    m_aggregate_columns = aggregate_columns;
    m_aggregate_columns_isSet = true;
}

bool OAIAnalysisRuleAggregation::is_aggregate_columns_Set() const{
    return m_aggregate_columns_isSet;
}

bool OAIAnalysisRuleAggregation::is_aggregate_columns_Valid() const{
    return m_aggregate_columns_isValid;
}

QList OAIAnalysisRuleAggregation::getJoinColumns() const {
    return m_join_columns;
}
void OAIAnalysisRuleAggregation::setJoinColumns(const QList &join_columns) {
    m_join_columns = join_columns;
    m_join_columns_isSet = true;
}

bool OAIAnalysisRuleAggregation::is_join_columns_Set() const{
    return m_join_columns_isSet;
}

bool OAIAnalysisRuleAggregation::is_join_columns_Valid() const{
    return m_join_columns_isValid;
}

OAIJoinRequiredOption OAIAnalysisRuleAggregation::getJoinRequired() const {
    return m_join_required;
}
void OAIAnalysisRuleAggregation::setJoinRequired(const OAIJoinRequiredOption &join_required) {
    m_join_required = join_required;
    m_join_required_isSet = true;
}

bool OAIAnalysisRuleAggregation::is_join_required_Set() const{
    return m_join_required_isSet;
}

bool OAIAnalysisRuleAggregation::is_join_required_Valid() const{
    return m_join_required_isValid;
}

QList OAIAnalysisRuleAggregation::getAllowedJoinOperators() const {
    return m_allowed_join_operators;
}
void OAIAnalysisRuleAggregation::setAllowedJoinOperators(const QList &allowed_join_operators) {
    m_allowed_join_operators = allowed_join_operators;
    m_allowed_join_operators_isSet = true;
}

bool OAIAnalysisRuleAggregation::is_allowed_join_operators_Set() const{
    return m_allowed_join_operators_isSet;
}

bool OAIAnalysisRuleAggregation::is_allowed_join_operators_Valid() const{
    return m_allowed_join_operators_isValid;
}

QList OAIAnalysisRuleAggregation::getDimensionColumns() const {
    return m_dimension_columns;
}
void OAIAnalysisRuleAggregation::setDimensionColumns(const QList &dimension_columns) {
    m_dimension_columns = dimension_columns;
    m_dimension_columns_isSet = true;
}

bool OAIAnalysisRuleAggregation::is_dimension_columns_Set() const{
    return m_dimension_columns_isSet;
}

bool OAIAnalysisRuleAggregation::is_dimension_columns_Valid() const{
    return m_dimension_columns_isValid;
}

QList OAIAnalysisRuleAggregation::getScalarFunctions() const {
    return m_scalar_functions;
}
void OAIAnalysisRuleAggregation::setScalarFunctions(const QList &scalar_functions) {
    m_scalar_functions = scalar_functions;
    m_scalar_functions_isSet = true;
}

bool OAIAnalysisRuleAggregation::is_scalar_functions_Set() const{
    return m_scalar_functions_isSet;
}

bool OAIAnalysisRuleAggregation::is_scalar_functions_Valid() const{
    return m_scalar_functions_isValid;
}

QList OAIAnalysisRuleAggregation::getOutputConstraints() const {
    return m_output_constraints;
}
void OAIAnalysisRuleAggregation::setOutputConstraints(const QList &output_constraints) {
    m_output_constraints = output_constraints;
    m_output_constraints_isSet = true;
}

bool OAIAnalysisRuleAggregation::is_output_constraints_Set() const{
    return m_output_constraints_isSet;
}

bool OAIAnalysisRuleAggregation::is_output_constraints_Valid() const{
    return m_output_constraints_isValid;
}

bool OAIAnalysisRuleAggregation::isSet() const {
...
bool OAIAnalysisRuleAggregation::isValid() const {
