...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCleanRoomsService.AnalysisParameter();
  });
  ...
  describe('AnalysisParameter', function() {
    it('should create an instance of AnalysisParameter', function() {
      ...
      //var instance = new AwsCleanRoomsService.AnalysisParameter();
      //expect(instance).to.be.a(AwsCleanRoomsService.AnalysisParameter);
    });
