...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCleanRoomsService.AnalysisRulePolicyV1();
  });
  ...
  describe('AnalysisRulePolicyV1', function() {
    it('should create an instance of AnalysisRulePolicyV1', function() {
      // uncomment below and update the code to test AnalysisRulePolicyV1
      //var instance = new AwsCleanRoomsService.AnalysisRulePolicyV1();
      //expect(instance).to.be.a(AwsCleanRoomsService.AnalysisRulePolicyV1);
    });
