...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCleanRoomsService.AggregationConstraint();
  });
  ...
  describe('AggregationConstraint', function() {
    it('should create an instance of AggregationConstraint', function() {
      // uncomment below and update the code to test AggregationConstraint
      //var instance = new AwsCleanRoomsService.AggregationConstraint();
      //expect(instance).to.be.a(AwsCleanRoomsService.AggregationConstraint);
    });
