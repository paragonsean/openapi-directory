...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCleanRoomsService.GlueTableReference();
  });
  ...
  describe('GlueTableReference', function() {
    it('should create an instance of GlueTableReference', function() {
      // uncomment below and update the code to test GlueTableReference
      //var instance = new AwsCleanRoomsService.GlueTableReference();
      //expect(instance).to.be.a(AwsCleanRoomsService.GlueTableReference);
    });
