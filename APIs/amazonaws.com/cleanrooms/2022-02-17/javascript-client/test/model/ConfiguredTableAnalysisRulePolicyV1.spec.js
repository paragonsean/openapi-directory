...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCleanRoomsService.ConfiguredTableAnalysisRulePolicyV1();
  });
  ...
  describe('ConfiguredTableAnalysisRulePolicyV1', function() {
    it('should create an instance of ConfiguredTableAnalysisRulePolicyV1', function() {
      // uncomment below and update the code to test ConfiguredTableAnalysisRulePolicyV1
      //var instance = new AwsCleanRoomsService.ConfiguredTableAnalysisRulePolicyV1();
      //expect(instance).to.be.a(AwsCleanRoomsService.ConfiguredTableAnalysisRulePolicyV1);
    });
