...
/**
 * The UpdateConfiguredTableOutputConfiguredTable model module.
 * @module model/UpdateConfiguredTableOutputConfiguredTable
 * @version 2022-02-17
 */
class UpdateConfiguredTableOutputConfiguredTable {
    /**
     * Constructs a new <code>UpdateConfiguredTableOutputConfiguredTable</code>.
     * @alias module:model/UpdateConfiguredTableOutputConfiguredTable
     * @implements module:model/ConfiguredTable
     * @param id {String} 
     * @param arn {String} 
     * @param name {String} 
    ...
    constructor(id, arn, name, tableReference, createTime, updateTime, analysisRuleTypes, analysisMethod, allowedColumns) { 
        ...
        UpdateConfiguredTableOutputConfiguredTable.initialize(this, id, arn, name, tableReference, createTime, updateTime, analysisRuleTypes, analysisMethod, allowedColumns);
    }
    ...
    /**
     * Constructs a <code>UpdateConfiguredTableOutputConfiguredTable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateConfiguredTableOutputConfiguredTable} obj Optional instance to populate.
     * @return {module:model/UpdateConfiguredTableOutputConfiguredTable} The populated <code>UpdateConfiguredTableOutputConfiguredTable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateConfiguredTableOutputConfiguredTable();
            ConfiguredTable.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateConfiguredTableOutputConfiguredTable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateConfiguredTableOutputConfiguredTable</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateConfiguredTableOutputConfiguredTable.RequiredProperties) {
...
UpdateConfiguredTableOutputConfiguredTable.RequiredProperties = ["id", "arn", "name", "tableReference", "createTime", "updateTime", "analysisRuleTypes", "analysisMethod", "allowedColumns"];

/**
 * @member {String} id
 */
UpdateConfiguredTableOutputConfiguredTable.prototype['id'] = undefined;

/**
 * @member {String} arn
 */
UpdateConfiguredTableOutputConfiguredTable.prototype['arn'] = undefined;

/**
 * @member {String} name
 */
UpdateConfiguredTableOutputConfiguredTable.prototype['name'] = undefined;

/**
 * @member {String} description
 */
UpdateConfiguredTableOutputConfiguredTable.prototype['description'] = undefined;

/**
 * @member {module:model/ConfiguredTableTableReference} tableReference
 */
UpdateConfiguredTableOutputConfiguredTable.prototype['tableReference'] = undefined;

/**
 * @member {Date} createTime
 */
UpdateConfiguredTableOutputConfiguredTable.prototype['createTime'] = undefined;

/**
 * @member {Date} updateTime
 */
UpdateConfiguredTableOutputConfiguredTable.prototype['updateTime'] = undefined;

/**
 * @member {Array} analysisRuleTypes
 */
UpdateConfiguredTableOutputConfiguredTable.prototype['analysisRuleTypes'] = undefined;

/**
 * @member {module:model/AnalysisMethod} analysisMethod
 */
UpdateConfiguredTableOutputConfiguredTable.prototype['analysisMethod'] = undefined;

/**
 * @member {Array} allowedColumns
 */
UpdateConfiguredTableOutputConfiguredTable.prototype['allowedColumns'] = undefined;


// Implement ConfiguredTable interface:
/**
 * @member {String} id
 */
...
export default UpdateConfiguredTableOutputConfiguredTable;
