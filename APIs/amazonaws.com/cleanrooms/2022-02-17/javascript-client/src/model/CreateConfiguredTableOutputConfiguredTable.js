...
/**
 * The CreateConfiguredTableOutputConfiguredTable model module.
 * @module model/CreateConfiguredTableOutputConfiguredTable
 * @version 2022-02-17
 */
class CreateConfiguredTableOutputConfiguredTable {
    /**
     * Constructs a new <code>CreateConfiguredTableOutputConfiguredTable</code>.
     * @alias module:model/CreateConfiguredTableOutputConfiguredTable
    ...
    constructor(id, arn, name, tableReference, createTime, updateTime, analysisRuleTypes, analysisMethod, allowedColumns) { 
        ...
        CreateConfiguredTableOutputConfiguredTable.initialize(this, id, arn, name, tableReference, createTime, updateTime, analysisRuleTypes, analysisMethod, allowedColumns);
    }
    ...
    /**
     * Constructs a <code>CreateConfiguredTableOutputConfiguredTable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateConfiguredTableOutputConfiguredTable} obj Optional instance to populate.
     * @return {module:model/CreateConfiguredTableOutputConfiguredTable} The populated <code>CreateConfiguredTableOutputConfiguredTable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateConfiguredTableOutputConfiguredTable();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateConfiguredTableOutputConfiguredTable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateConfiguredTableOutputConfiguredTable</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateConfiguredTableOutputConfiguredTable.RequiredProperties) {
...
CreateConfiguredTableOutputConfiguredTable.RequiredProperties = ["id", "arn", "name", "tableReference", "createTime", "updateTime", "analysisRuleTypes", "analysisMethod", "allowedColumns"];

/**
 * @member {String} id
 */
CreateConfiguredTableOutputConfiguredTable.prototype['id'] = undefined;

/**
 * @member {String} arn
 */
CreateConfiguredTableOutputConfiguredTable.prototype['arn'] = undefined;

/**
 * @member {String} name
 */
CreateConfiguredTableOutputConfiguredTable.prototype['name'] = undefined;

/**
 * @member {String} description
 */
CreateConfiguredTableOutputConfiguredTable.prototype['description'] = undefined;

/**
 * @member {module:model/ConfiguredTableTableReference} tableReference
 */
CreateConfiguredTableOutputConfiguredTable.prototype['tableReference'] = undefined;

/**
 * @member {Date} createTime
 */
CreateConfiguredTableOutputConfiguredTable.prototype['createTime'] = undefined;

/**
 * @member {Date} updateTime
 */
CreateConfiguredTableOutputConfiguredTable.prototype['updateTime'] = undefined;

/**
 * @member {Array} analysisRuleTypes
 */
CreateConfiguredTableOutputConfiguredTable.prototype['analysisRuleTypes'] = undefined;

/**
 * @member {module:model/AnalysisMethod} analysisMethod
 */
CreateConfiguredTableOutputConfiguredTable.prototype['analysisMethod'] = undefined;

/**
 * @member {Array} allowedColumns
 */
CreateConfiguredTableOutputConfiguredTable.prototype['allowedColumns'] = undefined;
...
export default CreateConfiguredTableOutputConfiguredTable;
