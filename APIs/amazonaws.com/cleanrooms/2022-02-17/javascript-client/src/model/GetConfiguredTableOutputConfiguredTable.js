...
/**
 * The GetConfiguredTableOutputConfiguredTable model module.
 * @module model/GetConfiguredTableOutputConfiguredTable
 * @version 2022-02-17
 */
class GetConfiguredTableOutputConfiguredTable {
    /**
     * Constructs a new <code>GetConfiguredTableOutputConfiguredTable</code>.
     * @alias module:model/GetConfiguredTableOutputConfiguredTable
    ...
    constructor(id, arn, name, tableReference, createTime, updateTime, analysisRuleTypes, analysisMethod, allowedColumns) { 
        ...
        GetConfiguredTableOutputConfiguredTable.initialize(this, id, arn, name, tableReference, createTime, updateTime, analysisRuleTypes, analysisMethod, allowedColumns);
    }
    ...
    /**
     * Constructs a <code>GetConfiguredTableOutputConfiguredTable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetConfiguredTableOutputConfiguredTable} obj Optional instance to populate.
     * @return {module:model/GetConfiguredTableOutputConfiguredTable} The populated <code>GetConfiguredTableOutputConfiguredTable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetConfiguredTableOutputConfiguredTable();
    ...
    /**
     * Validates the JSON data with respect to <code>GetConfiguredTableOutputConfiguredTable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetConfiguredTableOutputConfiguredTable</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetConfiguredTableOutputConfiguredTable.RequiredProperties) {
...
GetConfiguredTableOutputConfiguredTable.RequiredProperties = ["id", "arn", "name", "tableReference", "createTime", "updateTime", "analysisRuleTypes", "analysisMethod", "allowedColumns"];

/**
 * @member {String} id
 */
GetConfiguredTableOutputConfiguredTable.prototype['id'] = undefined;

/**
 * @member {String} arn
 */
GetConfiguredTableOutputConfiguredTable.prototype['arn'] = undefined;

/**
 * @member {String} name
 */
GetConfiguredTableOutputConfiguredTable.prototype['name'] = undefined;

/**
 * @member {String} description
 */
GetConfiguredTableOutputConfiguredTable.prototype['description'] = undefined;

/**
 * @member {module:model/ConfiguredTableTableReference} tableReference
 */
GetConfiguredTableOutputConfiguredTable.prototype['tableReference'] = undefined;

/**
 * @member {Date} createTime
 */
GetConfiguredTableOutputConfiguredTable.prototype['createTime'] = undefined;

/**
 * @member {Date} updateTime
 */
GetConfiguredTableOutputConfiguredTable.prototype['updateTime'] = undefined;

/**
 * @member {Array} analysisRuleTypes
 */
GetConfiguredTableOutputConfiguredTable.prototype['analysisRuleTypes'] = undefined;

/**
 * @member {module:model/AnalysisMethod} analysisMethod
 */
GetConfiguredTableOutputConfiguredTable.prototype['analysisMethod'] = undefined;

/**
 * @member {Array} allowedColumns
 */
GetConfiguredTableOutputConfiguredTable.prototype['allowedColumns'] = undefined;
...
export default GetConfiguredTableOutputConfiguredTable;
