...
public class CreateMembershipOutputMembership {
  ...
  public CreateMembershipOutputMembership() {
  }

  public CreateMembershipOutputMembership id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CreateMembershipOutputMembership arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateMembershipOutputMembership collaborationArn(String collaborationArn) {
  ...
  public CreateMembershipOutputMembership collaborationId(String collaborationId) {
  ...
  public CreateMembershipOutputMembership collaborationCreatorAccountId(String collaborationCreatorAccountId) {
  ...
  public CreateMembershipOutputMembership collaborationCreatorDisplayName(String collaborationCreatorDisplayName) {
  ...
  public CreateMembershipOutputMembership collaborationName(String collaborationName) {
  ...
  public CreateMembershipOutputMembership createTime(OffsetDateTime createTime) {
  ...
  public CreateMembershipOutputMembership updateTime(OffsetDateTime updateTime) {
  ...
  public CreateMembershipOutputMembership status(MembershipStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreateMembershipOutputMembership memberAbilities(List memberAbilities) {
  ...
  public CreateMembershipOutputMembership queryLogStatus(MembershipQueryLogStatus queryLogStatus) {
  ...
  public boolean equals(Object o) {
    ...
    CreateMembershipOutputMembership createMembershipOutputMembership = (CreateMembershipOutputMembership) o;
    return Objects.equals(this.id, createMembershipOutputMembership.id) &&
        Objects.equals(this.arn, createMembershipOutputMembership.arn) &&
        Objects.equals(this.collaborationArn, createMembershipOutputMembership.collaborationArn) &&
        Objects.equals(this.collaborationId, createMembershipOutputMembership.collaborationId) &&
        Objects.equals(this.collaborationCreatorAccountId, createMembershipOutputMembership.collaborationCreatorAccountId) &&
        Objects.equals(this.collaborationCreatorDisplayName, createMembershipOutputMembership.collaborationCreatorDisplayName) &&
        Objects.equals(this.collaborationName, createMembershipOutputMembership.collaborationName) &&
        Objects.equals(this.createTime, createMembershipOutputMembership.createTime) &&
        Objects.equals(this.updateTime, createMembershipOutputMembership.updateTime) &&
        Objects.equals(this.status, createMembershipOutputMembership.status) &&
        Objects.equals(this.memberAbilities, createMembershipOutputMembership.memberAbilities) &&
        Objects.equals(this.queryLogStatus, createMembershipOutputMembership.queryLogStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateMembershipOutputMembership {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMembershipOutputMembership
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMembershipOutputMembership.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMembershipOutputMembership is not found in the empty JSON string", CreateMembershipOutputMembership.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMembershipOutputMembership.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMembershipOutputMembership` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateMembershipOutputMembership.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMembershipOutputMembership.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMembershipOutputMembership' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMembershipOutputMembership> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMembershipOutputMembership.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMembershipOutputMembership>() {
           @Override
           public void write(JsonWriter out, CreateMembershipOutputMembership value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMembershipOutputMembership read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMembershipOutputMembership given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMembershipOutputMembership
   * @throws IOException if the JSON string is invalid with respect to CreateMembershipOutputMembership
   */
  public static CreateMembershipOutputMembership fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMembershipOutputMembership.class);
  }

  /**
   * Convert an instance of CreateMembershipOutputMembership to an JSON string
   *
   * @return JSON string
   */
