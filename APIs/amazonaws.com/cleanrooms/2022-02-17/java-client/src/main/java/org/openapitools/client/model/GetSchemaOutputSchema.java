...
public class GetSchemaOutputSchema {
  ...
  public GetSchemaOutputSchema() {
  }

  public GetSchemaOutputSchema columns(List columns) {
  ...
  public GetSchemaOutputSchema partitionKeys(List partitionKeys) {
  ...
  public GetSchemaOutputSchema analysisRuleTypes(List analysisRuleTypes) {
  ...
  public GetSchemaOutputSchema analysisMethod(AnalysisMethod analysisMethod) {
  ...
  public GetSchemaOutputSchema creatorAccountId(String creatorAccountId) {
  ...
  public GetSchemaOutputSchema name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetSchemaOutputSchema collaborationId(String collaborationId) {
  ...
  public GetSchemaOutputSchema collaborationArn(String collaborationArn) {
  ...
  public GetSchemaOutputSchema description(String description) {
  ...
  public GetSchemaOutputSchema createTime(OffsetDateTime createTime) {
  ...
  public GetSchemaOutputSchema updateTime(OffsetDateTime updateTime) {
  ...
  public GetSchemaOutputSchema type(SchemaType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetSchemaOutputSchema getSchemaOutputSchema = (GetSchemaOutputSchema) o;
    return Objects.equals(this.columns, getSchemaOutputSchema.columns) &&
        Objects.equals(this.partitionKeys, getSchemaOutputSchema.partitionKeys) &&
        Objects.equals(this.analysisRuleTypes, getSchemaOutputSchema.analysisRuleTypes) &&
        Objects.equals(this.analysisMethod, getSchemaOutputSchema.analysisMethod) &&
        Objects.equals(this.creatorAccountId, getSchemaOutputSchema.creatorAccountId) &&
        Objects.equals(this.name, getSchemaOutputSchema.name) &&
        Objects.equals(this.collaborationId, getSchemaOutputSchema.collaborationId) &&
        Objects.equals(this.collaborationArn, getSchemaOutputSchema.collaborationArn) &&
        Objects.equals(this.description, getSchemaOutputSchema.description) &&
        Objects.equals(this.createTime, getSchemaOutputSchema.createTime) &&
        Objects.equals(this.updateTime, getSchemaOutputSchema.updateTime) &&
        Objects.equals(this.type, getSchemaOutputSchema.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSchemaOutputSchema {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSchemaOutputSchema
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSchemaOutputSchema.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSchemaOutputSchema is not found in the empty JSON string", GetSchemaOutputSchema.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSchemaOutputSchema.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSchemaOutputSchema` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetSchemaOutputSchema.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSchemaOutputSchema.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSchemaOutputSchema' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSchemaOutputSchema> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSchemaOutputSchema.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSchemaOutputSchema>() {
           @Override
           public void write(JsonWriter out, GetSchemaOutputSchema value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSchemaOutputSchema read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSchemaOutputSchema given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSchemaOutputSchema
   * @throws IOException if the JSON string is invalid with respect to GetSchemaOutputSchema
   */
  public static GetSchemaOutputSchema fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSchemaOutputSchema.class);
  }

  /**
   * Convert an instance of GetSchemaOutputSchema to an JSON string
   *
   * @return JSON string
   */
