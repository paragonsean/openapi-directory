...
public class GetMembershipOutputMembership {
  ...
  public GetMembershipOutputMembership() {
  }

  public GetMembershipOutputMembership id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetMembershipOutputMembership arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetMembershipOutputMembership collaborationArn(String collaborationArn) {
  ...
  public GetMembershipOutputMembership collaborationId(String collaborationId) {
  ...
  public GetMembershipOutputMembership collaborationCreatorAccountId(String collaborationCreatorAccountId) {
  ...
  public GetMembershipOutputMembership collaborationCreatorDisplayName(String collaborationCreatorDisplayName) {
  ...
  public GetMembershipOutputMembership collaborationName(String collaborationName) {
  ...
  public GetMembershipOutputMembership createTime(OffsetDateTime createTime) {
  ...
  public GetMembershipOutputMembership updateTime(OffsetDateTime updateTime) {
  ...
  public GetMembershipOutputMembership status(MembershipStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetMembershipOutputMembership memberAbilities(List memberAbilities) {
  ...
  public GetMembershipOutputMembership queryLogStatus(MembershipQueryLogStatus queryLogStatus) {
  ...
  public boolean equals(Object o) {
    ...
    GetMembershipOutputMembership getMembershipOutputMembership = (GetMembershipOutputMembership) o;
    return Objects.equals(this.id, getMembershipOutputMembership.id) &&
        Objects.equals(this.arn, getMembershipOutputMembership.arn) &&
        Objects.equals(this.collaborationArn, getMembershipOutputMembership.collaborationArn) &&
        Objects.equals(this.collaborationId, getMembershipOutputMembership.collaborationId) &&
        Objects.equals(this.collaborationCreatorAccountId, getMembershipOutputMembership.collaborationCreatorAccountId) &&
        Objects.equals(this.collaborationCreatorDisplayName, getMembershipOutputMembership.collaborationCreatorDisplayName) &&
        Objects.equals(this.collaborationName, getMembershipOutputMembership.collaborationName) &&
        Objects.equals(this.createTime, getMembershipOutputMembership.createTime) &&
        Objects.equals(this.updateTime, getMembershipOutputMembership.updateTime) &&
        Objects.equals(this.status, getMembershipOutputMembership.status) &&
        Objects.equals(this.memberAbilities, getMembershipOutputMembership.memberAbilities) &&
        Objects.equals(this.queryLogStatus, getMembershipOutputMembership.queryLogStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetMembershipOutputMembership {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMembershipOutputMembership
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMembershipOutputMembership.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMembershipOutputMembership is not found in the empty JSON string", GetMembershipOutputMembership.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMembershipOutputMembership.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMembershipOutputMembership` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetMembershipOutputMembership.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMembershipOutputMembership.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMembershipOutputMembership' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMembershipOutputMembership> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMembershipOutputMembership.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMembershipOutputMembership>() {
           @Override
           public void write(JsonWriter out, GetMembershipOutputMembership value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMembershipOutputMembership read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMembershipOutputMembership given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMembershipOutputMembership
   * @throws IOException if the JSON string is invalid with respect to GetMembershipOutputMembership
   */
  public static GetMembershipOutputMembership fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMembershipOutputMembership.class);
  }

  /**
   * Convert an instance of GetMembershipOutputMembership to an JSON string
   *
   * @return JSON string
   */
