...
|------------- | ------------- | -------------|
| [**describeAcceleratorOfferings**](DefaultApi.md#describeAcceleratorOfferings) | **POST** /describe-accelerator-offerings |  |
| [**describeAcceleratorTypes**](DefaultApi.md#describeAcceleratorTypes) | **GET** /describe-accelerator-types |  |
| [**describeAccelerators**](DefaultApi.md#describeAccelerators) | **POST** /describe-accelerators |  |
| [**listTagsForResource**](DefaultApi.md#listTagsForResource) | **GET** /tags/{resourceArn} |  |
| [**tagResource**](DefaultApi.md#tagResource) | **POST** /tags/{resourceArn} |  |
| [**untagResource**](DefaultApi.md#untagResource) | **DELETE** /tags/{resourceArn}#tagKeys |  |


<a id="describeAcceleratorOfferings"></a>
# **describeAcceleratorOfferings**
> DescribeAcceleratorOfferingsResponse describeAcceleratorOfferings(describeAcceleratorOfferingsRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
|------------- | ------------- | ------------- | -------------|
| **describeAcceleratorOfferingsRequest** | [**DescribeAcceleratorOfferingsRequest**](DescribeAcceleratorOfferingsRequest.md)|  | |
...
[**DescribeAcceleratorOfferingsResponse**](DescribeAcceleratorOfferingsResponse.md)
...
<a id="describeAcceleratorTypes"></a>
# **describeAcceleratorTypes**
> DescribeAcceleratorTypesResponse describeAcceleratorTypes(xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      DescribeAcceleratorTypesResponse result = apiInstance.describeAcceleratorTypes(xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#describeAcceleratorTypes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**DescribeAcceleratorTypesResponse**](DescribeAcceleratorTypesResponse.md)
...
<a id="describeAccelerators"></a>
# **describeAccelerators**
> DescribeAcceleratorsResponse describeAccelerators(describeAcceleratorsRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, maxResults, nextToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    DescribeAcceleratorsRequest describeAcceleratorsRequest = new DescribeAcceleratorsRequest(); // DescribeAcceleratorsRequest | 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    try {
      DescribeAcceleratorsResponse result = apiInstance.describeAccelerators(describeAcceleratorsRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, maxResults, nextToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#describeAccelerators");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **describeAcceleratorsRequest** | [**DescribeAcceleratorsRequest**](DescribeAcceleratorsRequest.md)|  | |
| **xAmzContentSha256** | **String**|  | [optional] |
| **xAmzDate** | **String**|  | [optional] |
| **xAmzAlgorithm** | **String**|  | [optional] |
| **xAmzCredential** | **String**|  | [optional] |
...
[**DescribeAcceleratorsResponse**](DescribeAcceleratorsResponse.md)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String resourceArn = "resourceArn_example"; // String |  The ARN of the Elastic Inference Accelerator to list the tags for. 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **resourceArn** | **String**|  The ARN of the Elastic Inference Accelerator to list the tags for.  | |
| **xAmzContentSha256** | **String**|  | [optional] |
| **xAmzDate** | **String**|  | [optional] |
| **xAmzAlgorithm** | **String**|  | [optional] |
| **xAmzCredential** | **String**|  | [optional] |
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String resourceArn = "resourceArn_example"; // String |  The ARN of the Elastic Inference Accelerator to tag. 
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **resourceArn** | **String**|  The ARN of the Elastic Inference Accelerator to tag.  | |
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String resourceArn = "resourceArn_example"; // String |  The ARN of the Elastic Inference Accelerator to untag. 
    List<String> tagKeys = Arrays.asList(); // List<String> |  The list of tags to remove from the Elastic Inference Accelerator. 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **resourceArn** | **String**|  The ARN of the Elastic Inference Accelerator to untag.  | |
| **tagKeys** | [**List&lt;String&gt;**](String.md)|  The list of tags to remove from the Elastic Inference Accelerator.  | |
| **xAmzContentSha256** | **String**|  | [optional] |
| **xAmzDate** | **String**|  | [optional] |
| **xAmzAlgorithm** | **String**|  | [optional] |
| **xAmzCredential** | **String**|  | [optional] |
