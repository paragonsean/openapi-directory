...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticInference.ElasticInferenceAcceleratorAcceleratorHealth();
  });
  ...
  describe('ElasticInferenceAcceleratorAcceleratorHealth', function() {
    it('should create an instance of ElasticInferenceAcceleratorAcceleratorHealth', function() {
      // uncomment below and update the code to test ElasticInferenceAcceleratorAcceleratorHealth
      //var instance = new AmazonElasticInference.ElasticInferenceAcceleratorAcceleratorHealth();
      //expect(instance).to.be.a(AmazonElasticInference.ElasticInferenceAcceleratorAcceleratorHealth);
    });
