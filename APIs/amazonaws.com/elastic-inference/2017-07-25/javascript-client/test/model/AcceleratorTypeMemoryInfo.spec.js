...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticInference.AcceleratorTypeMemoryInfo();
  });
  ...
  describe('AcceleratorTypeMemoryInfo', function() {
    it('should create an instance of AcceleratorTypeMemoryInfo', function() {
      // uncomment below and update the code to test AcceleratorTypeMemoryInfo
      //var instance = new AmazonElasticInference.AcceleratorTypeMemoryInfo();
      //expect(instance).to.be.a(AmazonElasticInference.AcceleratorTypeMemoryInfo);
    });

    it('should have the property sizeInMiB (base name: "sizeInMiB")', function() {
      // uncomment below and update the code to test the property sizeInMiB
      //var instance = new AmazonElasticInference.AcceleratorTypeMemoryInfo();
