...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticInference.DescribeAcceleratorsResponse();
  });
  ...
  describe('DescribeAcceleratorsResponse', function() {
    it('should create an instance of DescribeAcceleratorsResponse', function() {
      // uncomment below and update the code to test DescribeAcceleratorsResponse
      //var instance = new AmazonElasticInference.DescribeAcceleratorsResponse();
      //expect(instance).to.be.a(AmazonElasticInference.DescribeAcceleratorsResponse);
    });

    it('should have the property acceleratorSet (base name: "acceleratorSet")', function() {
      // uncomment below and update the code to test the property acceleratorSet
      //var instance = new AmazonElasticInference.DescribeAcceleratorsResponse();
