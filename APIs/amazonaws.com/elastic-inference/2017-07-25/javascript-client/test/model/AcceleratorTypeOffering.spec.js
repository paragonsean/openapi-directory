...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticInference.AcceleratorTypeOffering();
  });
  ...
  describe('AcceleratorTypeOffering', function() {
    it('should create an instance of AcceleratorTypeOffering', function() {
      // uncomment below and update the code to test AcceleratorTypeOffering
      //var instance = new AmazonElasticInference.AcceleratorTypeOffering();
      //expect(instance).to.be.a(AmazonElasticInference.AcceleratorTypeOffering);
    });
