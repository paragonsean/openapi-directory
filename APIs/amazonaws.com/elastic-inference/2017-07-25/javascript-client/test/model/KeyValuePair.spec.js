...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticInference.KeyValuePair();
  });
  ...
  describe('KeyValuePair', function() {
    it('should create an instance of KeyValuePair', function() {
      ...
      //var instance = new AmazonElasticInference.KeyValuePair();
      //expect(instance).to.be.a(AmazonElasticInference.KeyValuePair);
    });
