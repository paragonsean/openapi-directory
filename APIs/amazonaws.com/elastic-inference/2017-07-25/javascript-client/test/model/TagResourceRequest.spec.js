...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticInference.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonElasticInference.TagResourceRequest();
      //expect(instance).to.be.a(AmazonElasticInference.TagResourceRequest);
    });
