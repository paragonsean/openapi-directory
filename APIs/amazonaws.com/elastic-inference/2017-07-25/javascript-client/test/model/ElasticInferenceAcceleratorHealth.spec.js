...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticInference.ElasticInferenceAcceleratorHealth();
  });
  ...
  describe('ElasticInferenceAcceleratorHealth', function() {
    it('should create an instance of ElasticInferenceAcceleratorHealth', function() {
      // uncomment below and update the code to test ElasticInferenceAcceleratorHealth
      //var instance = new AmazonElasticInference.ElasticInferenceAcceleratorHealth();
      //expect(instance).to.be.a(AmazonElasticInference.ElasticInferenceAcceleratorHealth);
    });
