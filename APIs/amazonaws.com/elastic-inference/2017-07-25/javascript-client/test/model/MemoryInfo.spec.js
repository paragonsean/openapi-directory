...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticInference.MemoryInfo();
  });
  ...
  describe('MemoryInfo', function() {
    it('should create an instance of MemoryInfo', function() {
      // uncomment below and update the code to test MemoryInfo
      //var instance = new AmazonElasticInference.MemoryInfo();
      //expect(instance).to.be.a(AmazonElasticInference.MemoryInfo);
    });
