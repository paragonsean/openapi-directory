...
/*
 * OAIDescribeAcceleratorTypesResponse.h
 *
 * 
 */

#ifndef OAIDescribeAcceleratorTypesResponse_H
#define OAIDescribeAcceleratorTypesResponse_H
...
class OAIDescribeAcceleratorTypesResponse : public OAIObject {
public:
    OAIDescribeAcceleratorTypesResponse();
    OAIDescribeAcceleratorTypesResponse(QString json);
    ~OAIDescribeAcceleratorTypesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAcceleratorTypesResponse)

#endif // OAIDescribeAcceleratorTypesResponse_H
