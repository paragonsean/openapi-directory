...
/*
 * OAIDescribeAcceleratorOfferingsRequest.h
 *
 * 
 */

#ifndef OAIDescribeAcceleratorOfferingsRequest_H
#define OAIDescribeAcceleratorOfferingsRequest_H
...
class OAIDescribeAcceleratorOfferingsRequest : public OAIObject {
public:
    OAIDescribeAcceleratorOfferingsRequest();
    OAIDescribeAcceleratorOfferingsRequest(QString json);
    ~OAIDescribeAcceleratorOfferingsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAcceleratorOfferingsRequest)

#endif // OAIDescribeAcceleratorOfferingsRequest_H
