...
#ifndef OAIMemoryInfo_H
#define OAIMemoryInfo_H
...
class OAIMemoryInfo : public OAIObject {
public:
    OAIMemoryInfo();
    OAIMemoryInfo(QString json);
    ~OAIMemoryInfo() override;
    ...
    qint32 getSizeInMiB() const;
    void setSizeInMiB(const qint32 &size_in_mi_b);
    bool is_size_in_mi_b_Set() const;
    bool is_size_in_mi_b_Valid() const;
...
private:
    ...
    qint32 m_size_in_mi_b;
    bool m_size_in_mi_b_isSet;
    bool m_size_in_mi_b_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIMemoryInfo)

#endif // OAIMemoryInfo_H
