...
class Example : public QObject {
    Q_OBJECT
    OAIDescribeAcceleratorOfferings_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAIDescribeAcceleratorOfferings_request Example::create(){
    OAIDescribeAcceleratorOfferings_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::describeAcceleratorOfferingsSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::describeAcceleratorOfferingsSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIDescribeAcceleratorOfferings_request oai_describe_accelerator_offerings_request = create(); // OAIDescribeAcceleratorOfferings_request | 
      ...
      apiInstance.describeAcceleratorOfferings(oai_describe_accelerator_offerings_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
