...
async def test_describe_accelerator_offerings(client):
    """Test case for describe_accelerator_offerings

    
    """
    body = {"locationType":"","acceleratorTypes":""}
    headers = { 
...
async def test_describe_accelerator_types(client):
    """Test case for describe_accelerator_types
...
async def test_describe_accelerators(client):
    """Test case for describe_accelerators

    
    """
    body = {"maxResults":"","nextToken":"","filters":"","acceleratorIds":""}
