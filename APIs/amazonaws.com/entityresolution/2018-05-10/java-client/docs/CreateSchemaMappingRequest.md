...
|**mappedInputFields** | [**List&lt;SchemaInputAttribute&gt;**](SchemaInputAttribute.md) | A list of &lt;code&gt;MappedInputFields&lt;/code&gt;. Each &lt;code&gt;MappedInputField&lt;/code&gt; corresponds to a column the source data table, and contains column name plus additional information that Entity Resolution uses for matching. |  [optional] |
