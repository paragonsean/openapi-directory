...
public class UpdateMatchingWorkflowInput {
  ...
  public UpdateMatchingWorkflowInput() {
  }

  public UpdateMatchingWorkflowInput description(String description) {
  ...
  public UpdateMatchingWorkflowInput incrementalRunConfig(CreateMatchingWorkflowOutputIncrementalRunConfig incrementalRunConfig) {
  ...
  public UpdateMatchingWorkflowInput inputSourceConfig(List inputSourceConfig) {
  ...
  public UpdateMatchingWorkflowInput outputSourceConfig(List outputSourceConfig) {
  ...
  public UpdateMatchingWorkflowInput resolutionTechniques(CreateMatchingWorkflowOutputResolutionTechniques resolutionTechniques) {
  ...
  public UpdateMatchingWorkflowInput roleArn(String roleArn) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateMatchingWorkflowInput updateMatchingWorkflowInput = (UpdateMatchingWorkflowInput) o;
    return Objects.equals(this.description, updateMatchingWorkflowInput.description) &&
        Objects.equals(this.incrementalRunConfig, updateMatchingWorkflowInput.incrementalRunConfig) &&
        Objects.equals(this.inputSourceConfig, updateMatchingWorkflowInput.inputSourceConfig) &&
        Objects.equals(this.outputSourceConfig, updateMatchingWorkflowInput.outputSourceConfig) &&
        Objects.equals(this.resolutionTechniques, updateMatchingWorkflowInput.resolutionTechniques) &&
        Objects.equals(this.roleArn, updateMatchingWorkflowInput.roleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateMatchingWorkflowInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMatchingWorkflowInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMatchingWorkflowInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMatchingWorkflowInput is not found in the empty JSON string", UpdateMatchingWorkflowInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMatchingWorkflowInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMatchingWorkflowInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateMatchingWorkflowInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMatchingWorkflowInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMatchingWorkflowInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMatchingWorkflowInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMatchingWorkflowInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMatchingWorkflowInput>() {
           @Override
           public void write(JsonWriter out, UpdateMatchingWorkflowInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMatchingWorkflowInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMatchingWorkflowInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMatchingWorkflowInput
   * @throws IOException if the JSON string is invalid with respect to UpdateMatchingWorkflowInput
   */
  public static UpdateMatchingWorkflowInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMatchingWorkflowInput.class);
  }

  /**
   * Convert an instance of UpdateMatchingWorkflowInput to an JSON string
   *
   * @return JSON string
   */
