...
public class ApiClient {
    ...
    private String basePath = "http://entityresolution.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://entityresolution.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://entityresolution.{region}.amazonaws.com",
      "The AWSEntityResolution multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://entityresolution.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://entityresolution.{region}.amazonaws.com.cn",
      "The AWSEntityResolution endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://entityresolution.us-east-1.amazonaws.com
