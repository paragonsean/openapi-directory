...
public class GetMatchingJobOutputMetrics {
  ...
  public GetMatchingJobOutputMetrics() {
  }

  public GetMatchingJobOutputMetrics inputRecords(Integer inputRecords) {
  ...
  public GetMatchingJobOutputMetrics matchIDs(Integer matchIDs) {
  ...
  public GetMatchingJobOutputMetrics recordsNotProcessed(Integer recordsNotProcessed) {
  ...
  public GetMatchingJobOutputMetrics totalRecordsProcessed(Integer totalRecordsProcessed) {
  ...
  public boolean equals(Object o) {
    ...
    GetMatchingJobOutputMetrics getMatchingJobOutputMetrics = (GetMatchingJobOutputMetrics) o;
    return Objects.equals(this.inputRecords, getMatchingJobOutputMetrics.inputRecords) &&
        Objects.equals(this.matchIDs, getMatchingJobOutputMetrics.matchIDs) &&
        Objects.equals(this.recordsNotProcessed, getMatchingJobOutputMetrics.recordsNotProcessed) &&
        Objects.equals(this.totalRecordsProcessed, getMatchingJobOutputMetrics.totalRecordsProcessed);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetMatchingJobOutputMetrics {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMatchingJobOutputMetrics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMatchingJobOutputMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMatchingJobOutputMetrics is not found in the empty JSON string", GetMatchingJobOutputMetrics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMatchingJobOutputMetrics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMatchingJobOutputMetrics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMatchingJobOutputMetrics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMatchingJobOutputMetrics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMatchingJobOutputMetrics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMatchingJobOutputMetrics.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMatchingJobOutputMetrics>() {
           @Override
           public void write(JsonWriter out, GetMatchingJobOutputMetrics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMatchingJobOutputMetrics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMatchingJobOutputMetrics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMatchingJobOutputMetrics
   * @throws IOException if the JSON string is invalid with respect to GetMatchingJobOutputMetrics
   */
  public static GetMatchingJobOutputMetrics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMatchingJobOutputMetrics.class);
  }

  /**
   * Convert an instance of GetMatchingJobOutputMetrics to an JSON string
   *
   * @return JSON string
   */
