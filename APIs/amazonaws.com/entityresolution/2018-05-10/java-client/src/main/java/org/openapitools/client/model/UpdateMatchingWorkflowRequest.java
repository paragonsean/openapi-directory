...
public class UpdateMatchingWorkflowRequest {
  ...
  public UpdateMatchingWorkflowRequest() {
  }

  public UpdateMatchingWorkflowRequest description(String description) {
  ...
  public UpdateMatchingWorkflowRequest incrementalRunConfig(CreateMatchingWorkflowRequestIncrementalRunConfig incrementalRunConfig) {
  ...
  public UpdateMatchingWorkflowRequest inputSourceConfig(List<InputSource> inputSourceConfig) {
    this.inputSourceConfig = inputSourceConfig;
    return this;
  }

  public UpdateMatchingWorkflowRequest addInputSourceConfigItem(InputSource inputSourceConfigItem) {
  ...
  public UpdateMatchingWorkflowRequest outputSourceConfig(List<OutputSource> outputSourceConfig) {
    this.outputSourceConfig = outputSourceConfig;
    return this;
  }

  public UpdateMatchingWorkflowRequest addOutputSourceConfigItem(OutputSource outputSourceConfigItem) {
  ...
  public UpdateMatchingWorkflowRequest resolutionTechniques(CreateMatchingWorkflowRequestResolutionTechniques resolutionTechniques) {
  ...
  public UpdateMatchingWorkflowRequest roleArn(String roleArn) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateMatchingWorkflowRequest updateMatchingWorkflowRequest = (UpdateMatchingWorkflowRequest) o;
    return Objects.equals(this.description, updateMatchingWorkflowRequest.description) &&
        Objects.equals(this.incrementalRunConfig, updateMatchingWorkflowRequest.incrementalRunConfig) &&
        Objects.equals(this.inputSourceConfig, updateMatchingWorkflowRequest.inputSourceConfig) &&
        Objects.equals(this.outputSourceConfig, updateMatchingWorkflowRequest.outputSourceConfig) &&
        Objects.equals(this.resolutionTechniques, updateMatchingWorkflowRequest.resolutionTechniques) &&
        Objects.equals(this.roleArn, updateMatchingWorkflowRequest.roleArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, incrementalRunConfig, inputSourceConfig, outputSourceConfig, resolutionTechniques, roleArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateMatchingWorkflowRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMatchingWorkflowRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMatchingWorkflowRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMatchingWorkflowRequest is not found in the empty JSON string", UpdateMatchingWorkflowRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMatchingWorkflowRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMatchingWorkflowRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateMatchingWorkflowRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMatchingWorkflowRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMatchingWorkflowRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMatchingWorkflowRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMatchingWorkflowRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMatchingWorkflowRequest>() {
           @Override
           public void write(JsonWriter out, UpdateMatchingWorkflowRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMatchingWorkflowRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMatchingWorkflowRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMatchingWorkflowRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateMatchingWorkflowRequest
   */
  public static UpdateMatchingWorkflowRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMatchingWorkflowRequest.class);
  }

  /**
   * Convert an instance of UpdateMatchingWorkflowRequest to an JSON string
   *
   * @return JSON string
   */
