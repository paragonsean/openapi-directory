...
public class CreateMatchingWorkflowInput {
  ...
  public CreateMatchingWorkflowInput() {
  }

  public CreateMatchingWorkflowInput description(String description) {
  ...
  public CreateMatchingWorkflowInput incrementalRunConfig(CreateMatchingWorkflowOutputIncrementalRunConfig incrementalRunConfig) {
  ...
  public CreateMatchingWorkflowInput inputSourceConfig(List inputSourceConfig) {
  ...
  public CreateMatchingWorkflowInput outputSourceConfig(List outputSourceConfig) {
  ...
  public CreateMatchingWorkflowInput resolutionTechniques(CreateMatchingWorkflowOutputResolutionTechniques resolutionTechniques) {
  ...
  public CreateMatchingWorkflowInput roleArn(String roleArn) {
  ...
  public CreateMatchingWorkflowInput tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateMatchingWorkflowInput workflowName(String workflowName) {
  ...
  public boolean equals(Object o) {
    ...
    CreateMatchingWorkflowInput createMatchingWorkflowInput = (CreateMatchingWorkflowInput) o;
    return Objects.equals(this.description, createMatchingWorkflowInput.description) &&
        Objects.equals(this.incrementalRunConfig, createMatchingWorkflowInput.incrementalRunConfig) &&
        Objects.equals(this.inputSourceConfig, createMatchingWorkflowInput.inputSourceConfig) &&
        Objects.equals(this.outputSourceConfig, createMatchingWorkflowInput.outputSourceConfig) &&
        Objects.equals(this.resolutionTechniques, createMatchingWorkflowInput.resolutionTechniques) &&
        Objects.equals(this.roleArn, createMatchingWorkflowInput.roleArn) &&
        Objects.equals(this.tags, createMatchingWorkflowInput.tags) &&
        Objects.equals(this.workflowName, createMatchingWorkflowInput.workflowName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateMatchingWorkflowInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMatchingWorkflowInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMatchingWorkflowInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMatchingWorkflowInput is not found in the empty JSON string", CreateMatchingWorkflowInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMatchingWorkflowInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMatchingWorkflowInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateMatchingWorkflowInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMatchingWorkflowInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMatchingWorkflowInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMatchingWorkflowInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMatchingWorkflowInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMatchingWorkflowInput>() {
           @Override
           public void write(JsonWriter out, CreateMatchingWorkflowInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMatchingWorkflowInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMatchingWorkflowInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMatchingWorkflowInput
   * @throws IOException if the JSON string is invalid with respect to CreateMatchingWorkflowInput
   */
  public static CreateMatchingWorkflowInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMatchingWorkflowInput.class);
  }

  /**
   * Convert an instance of CreateMatchingWorkflowInput to an JSON string
   *
   * @return JSON string
   */
