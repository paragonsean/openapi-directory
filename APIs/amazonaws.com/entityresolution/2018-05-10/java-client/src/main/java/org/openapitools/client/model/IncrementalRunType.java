...
/**
 * Gets or Sets IncrementalRunType
 */
@JsonAdapter(IncrementalRunType.Adapter.class)
public enum IncrementalRunType {
  ...
  IncrementalRunType(String value) {
    this.value = value;
  }
  ...
  public static IncrementalRunType fromValue(String value) {
    for (IncrementalRunType b : IncrementalRunType.values()) {
  ...
  public static class Adapter extends TypeAdapter<IncrementalRunType> {
    @Override
    public void write(final JsonWriter jsonWriter, final IncrementalRunType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public IncrementalRunType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return IncrementalRunType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    IncrementalRunType.fromValue(value);
  }
}
