...
public class UpdateMatchingWorkflowOutput {
  ...
  public UpdateMatchingWorkflowOutput() {
  }

  public UpdateMatchingWorkflowOutput description(String description) {
  ...
  public UpdateMatchingWorkflowOutput incrementalRunConfig(CreateMatchingWorkflowOutputIncrementalRunConfig incrementalRunConfig) {
  ...
  public UpdateMatchingWorkflowOutput inputSourceConfig(List inputSourceConfig) {
  ...
  public UpdateMatchingWorkflowOutput outputSourceConfig(List outputSourceConfig) {
  ...
  public UpdateMatchingWorkflowOutput resolutionTechniques(CreateMatchingWorkflowOutputResolutionTechniques resolutionTechniques) {
  ...
  public UpdateMatchingWorkflowOutput roleArn(String roleArn) {
  ...
  public UpdateMatchingWorkflowOutput workflowName(String workflowName) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateMatchingWorkflowOutput updateMatchingWorkflowOutput = (UpdateMatchingWorkflowOutput) o;
    return Objects.equals(this.description, updateMatchingWorkflowOutput.description) &&
        Objects.equals(this.incrementalRunConfig, updateMatchingWorkflowOutput.incrementalRunConfig) &&
        Objects.equals(this.inputSourceConfig, updateMatchingWorkflowOutput.inputSourceConfig) &&
        Objects.equals(this.outputSourceConfig, updateMatchingWorkflowOutput.outputSourceConfig) &&
        Objects.equals(this.resolutionTechniques, updateMatchingWorkflowOutput.resolutionTechniques) &&
        Objects.equals(this.roleArn, updateMatchingWorkflowOutput.roleArn) &&
        Objects.equals(this.workflowName, updateMatchingWorkflowOutput.workflowName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, incrementalRunConfig, inputSourceConfig, outputSourceConfig, resolutionTechniques, roleArn, workflowName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateMatchingWorkflowOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMatchingWorkflowOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMatchingWorkflowOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMatchingWorkflowOutput is not found in the empty JSON string", UpdateMatchingWorkflowOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMatchingWorkflowOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMatchingWorkflowOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateMatchingWorkflowOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMatchingWorkflowOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMatchingWorkflowOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMatchingWorkflowOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMatchingWorkflowOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMatchingWorkflowOutput>() {
           @Override
           public void write(JsonWriter out, UpdateMatchingWorkflowOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMatchingWorkflowOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMatchingWorkflowOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMatchingWorkflowOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateMatchingWorkflowOutput
   */
  public static UpdateMatchingWorkflowOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMatchingWorkflowOutput.class);
  }

  /**
   * Convert an instance of UpdateMatchingWorkflowOutput to an JSON string
   *
   * @return JSON string
   */
