...
class Example : public QObject {
    Q_OBJECT
    OAICreateMatchingWorkflow_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAICreateMatchingWorkflow_request Example::create(){
    OAICreateMatchingWorkflow_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createMatchingWorkflowSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createMatchingWorkflowSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateMatchingWorkflow_request oai_create_matching_workflow_request = create(); // OAICreateMatchingWorkflow_request | 
      ...
      apiInstance.createMatchingWorkflow(oai_create_matching_workflow_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
