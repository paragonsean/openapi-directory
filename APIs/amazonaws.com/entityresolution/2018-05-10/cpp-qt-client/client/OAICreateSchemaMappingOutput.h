...
/*
 * OAICreateSchemaMappingOutput.h
 *
 * 
 */

#ifndef OAICreateSchemaMappingOutput_H
#define OAICreateSchemaMappingOutput_H
...
class OAICreateSchemaMappingOutput : public OAIObject {
public:
    OAICreateSchemaMappingOutput();
    OAICreateSchemaMappingOutput(QString json);
    ~OAICreateSchemaMappingOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSchemaMappingOutput)

#endif // OAICreateSchemaMappingOutput_H
