...
/*
 * OAIGetMatchIdInput.h
 *
 * 
 */

#ifndef OAIGetMatchIdInput_H
#define OAIGetMatchIdInput_H
...
class OAIGetMatchIdInput : public OAIObject {
public:
    OAIGetMatchIdInput();
    OAIGetMatchIdInput(QString json);
    ~OAIGetMatchIdInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMatchIdInput)

#endif // OAIGetMatchIdInput_H
