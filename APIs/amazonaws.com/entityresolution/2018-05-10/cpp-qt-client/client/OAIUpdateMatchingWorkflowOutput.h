...
/*
 * OAIUpdateMatchingWorkflowOutput.h
 *
 * 
 */

#ifndef OAIUpdateMatchingWorkflowOutput_H
#define OAIUpdateMatchingWorkflowOutput_H
...
class OAIUpdateMatchingWorkflowOutput : public OAIObject {
public:
    OAIUpdateMatchingWorkflowOutput();
    OAIUpdateMatchingWorkflowOutput(QString json);
    ~OAIUpdateMatchingWorkflowOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMatchingWorkflowOutput)

#endif // OAIUpdateMatchingWorkflowOutput_H
