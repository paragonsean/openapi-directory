...
/*
 * OAIGetMatchingWorkflowOutput.h
 *
 * 
 */

#ifndef OAIGetMatchingWorkflowOutput_H
#define OAIGetMatchingWorkflowOutput_H
...
class OAIGetMatchingWorkflowOutput : public OAIObject {
public:
    OAIGetMatchingWorkflowOutput();
    OAIGetMatchingWorkflowOutput(QString json);
    ~OAIGetMatchingWorkflowOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMatchingWorkflowOutput)

#endif // OAIGetMatchingWorkflowOutput_H
