...
OAICreateMatchingWorkflowOutput::OAICreateMatchingWorkflowOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMatchingWorkflowOutput::OAICreateMatchingWorkflowOutput() {
    this->initializeModel();
}

OAICreateMatchingWorkflowOutput::~OAICreateMatchingWorkflowOutput() {}

void OAICreateMatchingWorkflowOutput::initializeModel() {
...
void OAICreateMatchingWorkflowOutput::fromJson(QString jsonString) {
...
void OAICreateMatchingWorkflowOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateMatchingWorkflowOutput::asJson() const {
...
QJsonObject OAICreateMatchingWorkflowOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateMatchingWorkflowOutput::getDescription() const {
    return m_description;
}
void OAICreateMatchingWorkflowOutput::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateMatchingWorkflowOutput::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateMatchingWorkflowOutput::is_description_Valid() const{
    return m_description_isValid;
}

OAICreateMatchingWorkflowOutput_incrementalRunConfig OAICreateMatchingWorkflowOutput::getIncrementalRunConfig() const {
    return m_incremental_run_config;
}
void OAICreateMatchingWorkflowOutput::setIncrementalRunConfig(const OAICreateMatchingWorkflowOutput_incrementalRunConfig &incremental_run_config) {
    m_incremental_run_config = incremental_run_config;
    m_incremental_run_config_isSet = true;
}

bool OAICreateMatchingWorkflowOutput::is_incremental_run_config_Set() const{
    return m_incremental_run_config_isSet;
}

bool OAICreateMatchingWorkflowOutput::is_incremental_run_config_Valid() const{
    return m_incremental_run_config_isValid;
}

QList OAICreateMatchingWorkflowOutput::getInputSourceConfig() const {
    return m_input_source_config;
}
void OAICreateMatchingWorkflowOutput::setInputSourceConfig(const QList &input_source_config) {
    m_input_source_config = input_source_config;
    m_input_source_config_isSet = true;
}

bool OAICreateMatchingWorkflowOutput::is_input_source_config_Set() const{
    return m_input_source_config_isSet;
}

bool OAICreateMatchingWorkflowOutput::is_input_source_config_Valid() const{
    return m_input_source_config_isValid;
}

QList OAICreateMatchingWorkflowOutput::getOutputSourceConfig() const {
    return m_output_source_config;
}
void OAICreateMatchingWorkflowOutput::setOutputSourceConfig(const QList &output_source_config) {
    m_output_source_config = output_source_config;
    m_output_source_config_isSet = true;
}

bool OAICreateMatchingWorkflowOutput::is_output_source_config_Set() const{
    return m_output_source_config_isSet;
}

bool OAICreateMatchingWorkflowOutput::is_output_source_config_Valid() const{
    return m_output_source_config_isValid;
}

OAICreateMatchingWorkflowOutput_resolutionTechniques OAICreateMatchingWorkflowOutput::getResolutionTechniques() const {
    return m_resolution_techniques;
}
void OAICreateMatchingWorkflowOutput::setResolutionTechniques(const OAICreateMatchingWorkflowOutput_resolutionTechniques &resolution_techniques) {
    m_resolution_techniques = resolution_techniques;
    m_resolution_techniques_isSet = true;
}

bool OAICreateMatchingWorkflowOutput::is_resolution_techniques_Set() const{
    return m_resolution_techniques_isSet;
}

bool OAICreateMatchingWorkflowOutput::is_resolution_techniques_Valid() const{
    return m_resolution_techniques_isValid;
}

QString OAICreateMatchingWorkflowOutput::getRoleArn() const {
    return m_role_arn;
}
void OAICreateMatchingWorkflowOutput::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAICreateMatchingWorkflowOutput::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAICreateMatchingWorkflowOutput::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAICreateMatchingWorkflowOutput::getWorkflowArn() const {
    return m_workflow_arn;
}
void OAICreateMatchingWorkflowOutput::setWorkflowArn(const QString &workflow_arn) {
    m_workflow_arn = workflow_arn;
    m_workflow_arn_isSet = true;
}

bool OAICreateMatchingWorkflowOutput::is_workflow_arn_Set() const{
    return m_workflow_arn_isSet;
}

bool OAICreateMatchingWorkflowOutput::is_workflow_arn_Valid() const{
    return m_workflow_arn_isValid;
}

QString OAICreateMatchingWorkflowOutput::getWorkflowName() const {
    return m_workflow_name;
}
void OAICreateMatchingWorkflowOutput::setWorkflowName(const QString &workflow_name) {
    m_workflow_name = workflow_name;
    m_workflow_name_isSet = true;
}

bool OAICreateMatchingWorkflowOutput::is_workflow_name_Set() const{
    return m_workflow_name_isSet;
}

bool OAICreateMatchingWorkflowOutput::is_workflow_name_Valid() const{
    return m_workflow_name_isValid;
}

bool OAICreateMatchingWorkflowOutput::isSet() const {
...
bool OAICreateMatchingWorkflowOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_input_source_config_isValid && m_output_source_config_isValid && m_resolution_techniques_isValid && m_role_arn_isValid && m_workflow_arn_isValid && m_workflow_name_isValid && true;
}
