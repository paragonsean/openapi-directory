...
/*
 * OAICreateMatchingWorkflowOutput.h
 *
 * 
 */

#ifndef OAICreateMatchingWorkflowOutput_H
#define OAICreateMatchingWorkflowOutput_H
...
class OAICreateMatchingWorkflowOutput : public OAIObject {
public:
    OAICreateMatchingWorkflowOutput();
    OAICreateMatchingWorkflowOutput(QString json);
    ~OAICreateMatchingWorkflowOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMatchingWorkflowOutput)

#endif // OAICreateMatchingWorkflowOutput_H
