...
/*
 * OAIGetMatchingJobOutput_errorDetails.h
 *
 * 
 */

#ifndef OAIGetMatchingJobOutput_errorDetails_H
#define OAIGetMatchingJobOutput_errorDetails_H
...
class OAIGetMatchingJobOutput_errorDetails : public OAIObject {
public:
    OAIGetMatchingJobOutput_errorDetails();
    OAIGetMatchingJobOutput_errorDetails(QString json);
    ~OAIGetMatchingJobOutput_errorDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMatchingJobOutput_errorDetails)

#endif // OAIGetMatchingJobOutput_errorDetails_H
