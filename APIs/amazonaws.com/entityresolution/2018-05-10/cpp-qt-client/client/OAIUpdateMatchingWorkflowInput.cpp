...
#include "OAIUpdateMatchingWorkflowInput.h"
...
OAIUpdateMatchingWorkflowInput::OAIUpdateMatchingWorkflowInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateMatchingWorkflowInput::OAIUpdateMatchingWorkflowInput() {
    this->initializeModel();
}

OAIUpdateMatchingWorkflowInput::~OAIUpdateMatchingWorkflowInput() {}

void OAIUpdateMatchingWorkflowInput::initializeModel() {
...
void OAIUpdateMatchingWorkflowInput::fromJson(QString jsonString) {
...
void OAIUpdateMatchingWorkflowInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateMatchingWorkflowInput::asJson() const {
...
QJsonObject OAIUpdateMatchingWorkflowInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateMatchingWorkflowInput::getDescription() const {
    return m_description;
}
void OAIUpdateMatchingWorkflowInput::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateMatchingWorkflowInput::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateMatchingWorkflowInput::is_description_Valid() const{
    return m_description_isValid;
}

OAICreateMatchingWorkflowOutput_incrementalRunConfig OAIUpdateMatchingWorkflowInput::getIncrementalRunConfig() const {
    return m_incremental_run_config;
}
void OAIUpdateMatchingWorkflowInput::setIncrementalRunConfig(const OAICreateMatchingWorkflowOutput_incrementalRunConfig &incremental_run_config) {
    m_incremental_run_config = incremental_run_config;
    m_incremental_run_config_isSet = true;
}

bool OAIUpdateMatchingWorkflowInput::is_incremental_run_config_Set() const{
    return m_incremental_run_config_isSet;
}

bool OAIUpdateMatchingWorkflowInput::is_incremental_run_config_Valid() const{
    return m_incremental_run_config_isValid;
}

QList OAIUpdateMatchingWorkflowInput::getInputSourceConfig() const {
    return m_input_source_config;
}
void OAIUpdateMatchingWorkflowInput::setInputSourceConfig(const QList &input_source_config) {
    m_input_source_config = input_source_config;
    m_input_source_config_isSet = true;
}

bool OAIUpdateMatchingWorkflowInput::is_input_source_config_Set() const{
    return m_input_source_config_isSet;
}

bool OAIUpdateMatchingWorkflowInput::is_input_source_config_Valid() const{
    return m_input_source_config_isValid;
}

QList OAIUpdateMatchingWorkflowInput::getOutputSourceConfig() const {
    return m_output_source_config;
}
void OAIUpdateMatchingWorkflowInput::setOutputSourceConfig(const QList &output_source_config) {
    m_output_source_config = output_source_config;
    m_output_source_config_isSet = true;
}

bool OAIUpdateMatchingWorkflowInput::is_output_source_config_Set() const{
    return m_output_source_config_isSet;
}

bool OAIUpdateMatchingWorkflowInput::is_output_source_config_Valid() const{
    return m_output_source_config_isValid;
}

OAICreateMatchingWorkflowOutput_resolutionTechniques OAIUpdateMatchingWorkflowInput::getResolutionTechniques() const {
    return m_resolution_techniques;
}
void OAIUpdateMatchingWorkflowInput::setResolutionTechniques(const OAICreateMatchingWorkflowOutput_resolutionTechniques &resolution_techniques) {
    m_resolution_techniques = resolution_techniques;
    m_resolution_techniques_isSet = true;
}

bool OAIUpdateMatchingWorkflowInput::is_resolution_techniques_Set() const{
    return m_resolution_techniques_isSet;
}

bool OAIUpdateMatchingWorkflowInput::is_resolution_techniques_Valid() const{
    return m_resolution_techniques_isValid;
}

QString OAIUpdateMatchingWorkflowInput::getRoleArn() const {
    return m_role_arn;
}
void OAIUpdateMatchingWorkflowInput::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIUpdateMatchingWorkflowInput::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIUpdateMatchingWorkflowInput::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

bool OAIUpdateMatchingWorkflowInput::isSet() const {
...
bool OAIUpdateMatchingWorkflowInput::isValid() const {
