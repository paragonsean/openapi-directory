...
/*
 * OAIDeleteSchemaMappingOutput.h
 *
 * 
 */

#ifndef OAIDeleteSchemaMappingOutput_H
#define OAIDeleteSchemaMappingOutput_H
...
class OAIDeleteSchemaMappingOutput : public OAIObject {
public:
    OAIDeleteSchemaMappingOutput();
    OAIDeleteSchemaMappingOutput(QString json);
    ~OAIDeleteSchemaMappingOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSchemaMappingOutput)

#endif // OAIDeleteSchemaMappingOutput_H
