...
#include "OAICreateMatchingWorkflowInput.h"
...
OAICreateMatchingWorkflowInput::OAICreateMatchingWorkflowInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMatchingWorkflowInput::OAICreateMatchingWorkflowInput() {
    this->initializeModel();
}

OAICreateMatchingWorkflowInput::~OAICreateMatchingWorkflowInput() {}

void OAICreateMatchingWorkflowInput::initializeModel() {
...
void OAICreateMatchingWorkflowInput::fromJson(QString jsonString) {
...
void OAICreateMatchingWorkflowInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateMatchingWorkflowInput::asJson() const {
...
QJsonObject OAICreateMatchingWorkflowInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateMatchingWorkflowInput::getDescription() const {
    return m_description;
}
void OAICreateMatchingWorkflowInput::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateMatchingWorkflowInput::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateMatchingWorkflowInput::is_description_Valid() const{
    return m_description_isValid;
}

OAICreateMatchingWorkflowOutput_incrementalRunConfig OAICreateMatchingWorkflowInput::getIncrementalRunConfig() const {
    return m_incremental_run_config;
}
void OAICreateMatchingWorkflowInput::setIncrementalRunConfig(const OAICreateMatchingWorkflowOutput_incrementalRunConfig &incremental_run_config) {
    m_incremental_run_config = incremental_run_config;
    m_incremental_run_config_isSet = true;
}

bool OAICreateMatchingWorkflowInput::is_incremental_run_config_Set() const{
    return m_incremental_run_config_isSet;
}

bool OAICreateMatchingWorkflowInput::is_incremental_run_config_Valid() const{
    return m_incremental_run_config_isValid;
}

QList OAICreateMatchingWorkflowInput::getInputSourceConfig() const {
    return m_input_source_config;
}
void OAICreateMatchingWorkflowInput::setInputSourceConfig(const QList &input_source_config) {
    m_input_source_config = input_source_config;
    m_input_source_config_isSet = true;
}

bool OAICreateMatchingWorkflowInput::is_input_source_config_Set() const{
    return m_input_source_config_isSet;
}

bool OAICreateMatchingWorkflowInput::is_input_source_config_Valid() const{
    return m_input_source_config_isValid;
}

QList OAICreateMatchingWorkflowInput::getOutputSourceConfig() const {
    return m_output_source_config;
}
void OAICreateMatchingWorkflowInput::setOutputSourceConfig(const QList &output_source_config) {
    m_output_source_config = output_source_config;
    m_output_source_config_isSet = true;
}

bool OAICreateMatchingWorkflowInput::is_output_source_config_Set() const{
    return m_output_source_config_isSet;
}

bool OAICreateMatchingWorkflowInput::is_output_source_config_Valid() const{
    return m_output_source_config_isValid;
}

OAICreateMatchingWorkflowOutput_resolutionTechniques OAICreateMatchingWorkflowInput::getResolutionTechniques() const {
    return m_resolution_techniques;
}
void OAICreateMatchingWorkflowInput::setResolutionTechniques(const OAICreateMatchingWorkflowOutput_resolutionTechniques &resolution_techniques) {
    m_resolution_techniques = resolution_techniques;
    m_resolution_techniques_isSet = true;
}

bool OAICreateMatchingWorkflowInput::is_resolution_techniques_Set() const{
    return m_resolution_techniques_isSet;
}

bool OAICreateMatchingWorkflowInput::is_resolution_techniques_Valid() const{
    return m_resolution_techniques_isValid;
}

QString OAICreateMatchingWorkflowInput::getRoleArn() const {
    return m_role_arn;
}
void OAICreateMatchingWorkflowInput::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAICreateMatchingWorkflowInput::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAICreateMatchingWorkflowInput::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QMap OAICreateMatchingWorkflowInput::getTags() const {
    return m_tags;
}
void OAICreateMatchingWorkflowInput::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateMatchingWorkflowInput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateMatchingWorkflowInput::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAICreateMatchingWorkflowInput::getWorkflowName() const {
    return m_workflow_name;
}
void OAICreateMatchingWorkflowInput::setWorkflowName(const QString &workflow_name) {
    m_workflow_name = workflow_name;
    m_workflow_name_isSet = true;
}

bool OAICreateMatchingWorkflowInput::is_workflow_name_Set() const{
    return m_workflow_name_isSet;
}

bool OAICreateMatchingWorkflowInput::is_workflow_name_Valid() const{
    return m_workflow_name_isValid;
}

bool OAICreateMatchingWorkflowInput::isSet() const {
...
bool OAICreateMatchingWorkflowInput::isValid() const {
