...
OAIUpdateMatchingWorkflowOutput::OAIUpdateMatchingWorkflowOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateMatchingWorkflowOutput::OAIUpdateMatchingWorkflowOutput() {
    this->initializeModel();
}

OAIUpdateMatchingWorkflowOutput::~OAIUpdateMatchingWorkflowOutput() {}

void OAIUpdateMatchingWorkflowOutput::initializeModel() {
...
void OAIUpdateMatchingWorkflowOutput::fromJson(QString jsonString) {
...
void OAIUpdateMatchingWorkflowOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateMatchingWorkflowOutput::asJson() const {
...
QJsonObject OAIUpdateMatchingWorkflowOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateMatchingWorkflowOutput::getDescription() const {
    return m_description;
}
void OAIUpdateMatchingWorkflowOutput::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateMatchingWorkflowOutput::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateMatchingWorkflowOutput::is_description_Valid() const{
    return m_description_isValid;
}

OAICreateMatchingWorkflowOutput_incrementalRunConfig OAIUpdateMatchingWorkflowOutput::getIncrementalRunConfig() const {
    return m_incremental_run_config;
}
void OAIUpdateMatchingWorkflowOutput::setIncrementalRunConfig(const OAICreateMatchingWorkflowOutput_incrementalRunConfig &incremental_run_config) {
    m_incremental_run_config = incremental_run_config;
    m_incremental_run_config_isSet = true;
}

bool OAIUpdateMatchingWorkflowOutput::is_incremental_run_config_Set() const{
    return m_incremental_run_config_isSet;
}

bool OAIUpdateMatchingWorkflowOutput::is_incremental_run_config_Valid() const{
    return m_incremental_run_config_isValid;
}

QList OAIUpdateMatchingWorkflowOutput::getInputSourceConfig() const {
    return m_input_source_config;
}
void OAIUpdateMatchingWorkflowOutput::setInputSourceConfig(const QList &input_source_config) {
    m_input_source_config = input_source_config;
    m_input_source_config_isSet = true;
}

bool OAIUpdateMatchingWorkflowOutput::is_input_source_config_Set() const{
    return m_input_source_config_isSet;
}

bool OAIUpdateMatchingWorkflowOutput::is_input_source_config_Valid() const{
    return m_input_source_config_isValid;
}

QList OAIUpdateMatchingWorkflowOutput::getOutputSourceConfig() const {
    return m_output_source_config;
}
void OAIUpdateMatchingWorkflowOutput::setOutputSourceConfig(const QList &output_source_config) {
    m_output_source_config = output_source_config;
    m_output_source_config_isSet = true;
}

bool OAIUpdateMatchingWorkflowOutput::is_output_source_config_Set() const{
    return m_output_source_config_isSet;
}

bool OAIUpdateMatchingWorkflowOutput::is_output_source_config_Valid() const{
    return m_output_source_config_isValid;
}

OAICreateMatchingWorkflowOutput_resolutionTechniques OAIUpdateMatchingWorkflowOutput::getResolutionTechniques() const {
    return m_resolution_techniques;
}
void OAIUpdateMatchingWorkflowOutput::setResolutionTechniques(const OAICreateMatchingWorkflowOutput_resolutionTechniques &resolution_techniques) {
    m_resolution_techniques = resolution_techniques;
    m_resolution_techniques_isSet = true;
}

bool OAIUpdateMatchingWorkflowOutput::is_resolution_techniques_Set() const{
    return m_resolution_techniques_isSet;
}

bool OAIUpdateMatchingWorkflowOutput::is_resolution_techniques_Valid() const{
    return m_resolution_techniques_isValid;
}

QString OAIUpdateMatchingWorkflowOutput::getRoleArn() const {
    return m_role_arn;
}
void OAIUpdateMatchingWorkflowOutput::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIUpdateMatchingWorkflowOutput::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIUpdateMatchingWorkflowOutput::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAIUpdateMatchingWorkflowOutput::getWorkflowName() const {
    return m_workflow_name;
}
void OAIUpdateMatchingWorkflowOutput::setWorkflowName(const QString &workflow_name) {
    m_workflow_name = workflow_name;
    m_workflow_name_isSet = true;
}

bool OAIUpdateMatchingWorkflowOutput::is_workflow_name_Set() const{
    return m_workflow_name_isSet;
}

bool OAIUpdateMatchingWorkflowOutput::is_workflow_name_Valid() const{
    return m_workflow_name_isValid;
}

bool OAIUpdateMatchingWorkflowOutput::isSet() const {
...
bool OAIUpdateMatchingWorkflowOutput::isValid() const {
