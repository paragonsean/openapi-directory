...
/*
 * OAICreateMatchingWorkflowInput.h
 *
 * 
 */

#ifndef OAICreateMatchingWorkflowInput_H
#define OAICreateMatchingWorkflowInput_H
...
class OAICreateMatchingWorkflowInput : public OAIObject {
public:
    OAICreateMatchingWorkflowInput();
    OAICreateMatchingWorkflowInput(QString json);
    ~OAICreateMatchingWorkflowInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMatchingWorkflowInput)

#endif // OAICreateMatchingWorkflowInput_H
