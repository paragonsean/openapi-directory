...
#include "OAIResolutionTechniques.h"
...
OAIResolutionTechniques::OAIResolutionTechniques(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResolutionTechniques::OAIResolutionTechniques() {
    this->initializeModel();
}

OAIResolutionTechniques::~OAIResolutionTechniques() {}

void OAIResolutionTechniques::initializeModel() {
...
void OAIResolutionTechniques::fromJson(QString jsonString) {
...
void OAIResolutionTechniques::fromJsonObject(QJsonObject json) {
...
QString OAIResolutionTechniques::asJson() const {
...
QJsonObject OAIResolutionTechniques::asJsonObject() const {
    QJsonObject obj;
...
OAIResolutionType OAIResolutionTechniques::getResolutionType() const {
    return m_resolution_type;
}
void OAIResolutionTechniques::setResolutionType(const OAIResolutionType &resolution_type) {
    m_resolution_type = resolution_type;
    m_resolution_type_isSet = true;
}

bool OAIResolutionTechniques::is_resolution_type_Set() const{
    return m_resolution_type_isSet;
}

bool OAIResolutionTechniques::is_resolution_type_Valid() const{
    return m_resolution_type_isValid;
}

OAICreateMatchingWorkflow_request_resolutionTechniques_ruleBasedProperties OAIResolutionTechniques::getRuleBasedProperties() const {
    return m_rule_based_properties;
}
void OAIResolutionTechniques::setRuleBasedProperties(const OAICreateMatchingWorkflow_request_resolutionTechniques_ruleBasedProperties &rule_based_properties) {
    m_rule_based_properties = rule_based_properties;
    m_rule_based_properties_isSet = true;
}

bool OAIResolutionTechniques::is_rule_based_properties_Set() const{
    return m_rule_based_properties_isSet;
}

bool OAIResolutionTechniques::is_rule_based_properties_Valid() const{
    return m_rule_based_properties_isValid;
}

bool OAIResolutionTechniques::isSet() const {
...
bool OAIResolutionTechniques::isValid() const {
