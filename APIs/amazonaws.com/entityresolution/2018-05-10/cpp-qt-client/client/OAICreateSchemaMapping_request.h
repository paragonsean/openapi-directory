...
/*
 * OAICreateSchemaMapping_request.h
 *
 * 
 */

#ifndef OAICreateSchemaMapping_request_H
#define OAICreateSchemaMapping_request_H
...
namespace OpenAPI {
class OAISchemaInputAttribute;

class OAICreateSchemaMapping_request : public OAIObject {
public:
    OAICreateSchemaMapping_request();
    OAICreateSchemaMapping_request(QString json);
    ~OAICreateSchemaMapping_request() override;
    ...
    QList<OAISchemaInputAttribute> getMappedInputFields() const;
    void setMappedInputFields(const QList<OAISchemaInputAttribute> &mapped_input_fields);
...
private:
    ...
    QList<OAISchemaInputAttribute> m_mapped_input_fields;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSchemaMapping_request)

#endif // OAICreateSchemaMapping_request_H
