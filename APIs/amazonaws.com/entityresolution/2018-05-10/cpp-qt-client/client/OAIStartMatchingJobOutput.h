...
/*
 * OAIStartMatchingJobOutput.h
 *
 * 
 */

#ifndef OAIStartMatchingJobOutput_H
#define OAIStartMatchingJobOutput_H
...
class OAIStartMatchingJobOutput : public OAIObject {
public:
    OAIStartMatchingJobOutput();
    OAIStartMatchingJobOutput(QString json);
    ~OAIStartMatchingJobOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMatchingJobOutput)

#endif // OAIStartMatchingJobOutput_H
