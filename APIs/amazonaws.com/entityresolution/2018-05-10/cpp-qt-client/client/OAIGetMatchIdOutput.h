...
/*
 * OAIGetMatchIdOutput.h
 *
 * 
 */

#ifndef OAIGetMatchIdOutput_H
#define OAIGetMatchIdOutput_H
...
class OAIGetMatchIdOutput : public OAIObject {
public:
    OAIGetMatchIdOutput();
    OAIGetMatchIdOutput(QString json);
    ~OAIGetMatchIdOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMatchIdOutput)

#endif // OAIGetMatchIdOutput_H
