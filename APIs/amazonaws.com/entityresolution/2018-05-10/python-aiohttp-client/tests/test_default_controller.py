...
async def test_create_matching_workflow(client):
    """Test case for create_matching_workflow

    
    """
    body = openapi_server.CreateMatchingWorkflowRequest()
    headers = { 
...
async def test_create_schema_mapping(client):
    """Test case for create_schema_mapping

    
    """
    body = openapi_server.CreateSchemaMappingRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_matching_workflow(client):
    """Test case for delete_matching_workflow
    ...
    response = await client.request(
        method='DELETE',
        path='/matchingworkflows/{workflow_name}'.format(workflow_name='workflow_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_schema_mapping(client):
    """Test case for delete_schema_mapping
    ...
    response = await client.request(
        method='DELETE',
        path='/schemas/{schema_name}'.format(schema_name='schema_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_match_id(client):
    """Test case for get_match_id

    
    """
    body = openapi_server.GetMatchIdRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/matchingworkflows/{workflow_name}/matches'.format(workflow_name='workflow_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_matching_job(client):
    """Test case for get_matching_job
    ...
    response = await client.request(
        method='GET',
        path='/matchingworkflows/{workflow_name}/jobs/{job_id}'.format(job_id='job_id_example', workflow_name='workflow_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_matching_workflow(client):
    """Test case for get_matching_workflow
...
async def test_get_schema_mapping(client):
    """Test case for get_schema_mapping
...
async def test_list_matching_jobs(client):
    """Test case for list_matching_jobs
    ...
    response = await client.request(
        method='GET',
        path='/matchingworkflows/{workflow_name}/jobs'.format(workflow_name='workflow_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_matching_workflows(client):
    """Test case for list_matching_workflows
...
async def test_list_schema_mappings(client):
    """Test case for list_schema_mappings
...
async def test_start_matching_job(client):
    """Test case for start_matching_job
...
async def test_update_matching_workflow(client):
    """Test case for update_matching_workflow

    
    """
    body = openapi_server.UpdateMatchingWorkflowRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
