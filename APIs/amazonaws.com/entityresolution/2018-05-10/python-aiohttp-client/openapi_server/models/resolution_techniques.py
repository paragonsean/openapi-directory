...
class ResolutionTechniques(Model):
    ...
    def __init__(self, resolution_type: ResolutionType=None, rule_based_properties: CreateMatchingWorkflowRequestResolutionTechniquesRuleBasedProperties=None):
        """ResolutionTechniques - a model defined in OpenAPI

        :param resolution_type: The resolution_type of this ResolutionTechniques.
        :param rule_based_properties: The rule_based_properties of this ResolutionTechniques.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ResolutionTechniques':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ResolutionTechniques of this ResolutionTechniques.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def resolution_type(self):
        """Gets the resolution_type of this ResolutionTechniques.


        :return: The resolution_type of this ResolutionTechniques.
    ...
    def resolution_type(self, resolution_type):
        """Sets the resolution_type of this ResolutionTechniques.
    ...
    def rule_based_properties(self):
        """Gets the rule_based_properties of this ResolutionTechniques.


        :return: The rule_based_properties of this ResolutionTechniques.
    ...
    def rule_based_properties(self, rule_based_properties):
        """Sets the rule_based_properties of this ResolutionTechniques.
