...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.CreateSchemaMappingInput();
  });
  ...
  describe('CreateSchemaMappingInput', function() {
    it('should create an instance of CreateSchemaMappingInput', function() {
      // uncomment below and update the code to test CreateSchemaMappingInput
      //var instance = new AwsEntityResolution.CreateSchemaMappingInput();
      //expect(instance).to.be.a(AwsEntityResolution.CreateSchemaMappingInput);
    });
