...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.ListMatchingJobsOutput();
  });
  ...
  describe('ListMatchingJobsOutput', function() {
    it('should create an instance of ListMatchingJobsOutput', function() {
      // uncomment below and update the code to test ListMatchingJobsOutput
      //var instance = new AwsEntityResolution.ListMatchingJobsOutput();
      //expect(instance).to.be.a(AwsEntityResolution.ListMatchingJobsOutput);
    });
