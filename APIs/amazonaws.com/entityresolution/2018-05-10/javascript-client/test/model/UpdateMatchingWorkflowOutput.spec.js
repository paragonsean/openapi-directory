...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.UpdateMatchingWorkflowOutput();
  });
  ...
  describe('UpdateMatchingWorkflowOutput', function() {
    it('should create an instance of UpdateMatchingWorkflowOutput', function() {
      // uncomment below and update the code to test UpdateMatchingWorkflowOutput
      //var instance = new AwsEntityResolution.UpdateMatchingWorkflowOutput();
      //expect(instance).to.be.a(AwsEntityResolution.UpdateMatchingWorkflowOutput);
    });
