...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.GetMatchIdOutput();
  });
  ...
  describe('GetMatchIdOutput', function() {
    it('should create an instance of GetMatchIdOutput', function() {
      // uncomment below and update the code to test GetMatchIdOutput
      //var instance = new AwsEntityResolution.GetMatchIdOutput();
      //expect(instance).to.be.a(AwsEntityResolution.GetMatchIdOutput);
    });
