...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.OutputAttribute();
  });
  ...
  describe('OutputAttribute', function() {
    it('should create an instance of OutputAttribute', function() {
      // uncomment below and update the code to test OutputAttribute
      //var instance = new AwsEntityResolution.OutputAttribute();
      //expect(instance).to.be.a(AwsEntityResolution.OutputAttribute);
    });
