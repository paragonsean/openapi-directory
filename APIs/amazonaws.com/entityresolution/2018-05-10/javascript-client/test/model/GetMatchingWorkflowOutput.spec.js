...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.GetMatchingWorkflowOutput();
  });
  ...
  describe('GetMatchingWorkflowOutput', function() {
    it('should create an instance of GetMatchingWorkflowOutput', function() {
      // uncomment below and update the code to test GetMatchingWorkflowOutput
      //var instance = new AwsEntityResolution.GetMatchingWorkflowOutput();
      //expect(instance).to.be.a(AwsEntityResolution.GetMatchingWorkflowOutput);
    });
