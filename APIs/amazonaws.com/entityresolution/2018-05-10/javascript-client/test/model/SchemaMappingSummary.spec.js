...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.SchemaMappingSummary();
  });
  ...
  describe('SchemaMappingSummary', function() {
    it('should create an instance of SchemaMappingSummary', function() {
      // uncomment below and update the code to test SchemaMappingSummary
      //var instance = new AwsEntityResolution.SchemaMappingSummary();
      //expect(instance).to.be.a(AwsEntityResolution.SchemaMappingSummary);
    });
