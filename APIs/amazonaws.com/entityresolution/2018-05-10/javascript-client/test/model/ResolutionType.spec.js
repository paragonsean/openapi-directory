...
(function(root, factory) {
  ...
  describe('ResolutionType', function() {
    it('should create an instance of ResolutionType', function() {
      // uncomment below and update the code to test ResolutionType
      //var instance = new AwsEntityResolution.ResolutionType();
      //expect(instance).to.be.a(AwsEntityResolution.ResolutionType);
    });
