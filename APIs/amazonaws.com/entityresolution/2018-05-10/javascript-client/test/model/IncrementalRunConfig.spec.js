...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.IncrementalRunConfig();
  });
  ...
  describe('IncrementalRunConfig', function() {
    it('should create an instance of IncrementalRunConfig', function() {
      // uncomment below and update the code to test IncrementalRunConfig
      //var instance = new AwsEntityResolution.IncrementalRunConfig();
      //expect(instance).to.be.a(AwsEntityResolution.IncrementalRunConfig);
    });
