...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.GetSchemaMappingOutput();
  });
  ...
  describe('GetSchemaMappingOutput', function() {
    it('should create an instance of GetSchemaMappingOutput', function() {
      // uncomment below and update the code to test GetSchemaMappingOutput
      //var instance = new AwsEntityResolution.GetSchemaMappingOutput();
      //expect(instance).to.be.a(AwsEntityResolution.GetSchemaMappingOutput);
    });
