...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.ErrorDetails();
  });
  ...
  describe('ErrorDetails', function() {
    it('should create an instance of ErrorDetails', function() {
      ...
      //var instance = new AwsEntityResolution.ErrorDetails();
      //expect(instance).to.be.a(AwsEntityResolution.ErrorDetails);
    });
