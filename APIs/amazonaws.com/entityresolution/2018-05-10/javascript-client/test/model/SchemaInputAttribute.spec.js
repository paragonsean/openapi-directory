...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.SchemaInputAttribute();
  });
  ...
  describe('SchemaInputAttribute', function() {
    it('should create an instance of SchemaInputAttribute', function() {
      // uncomment below and update the code to test SchemaInputAttribute
      //var instance = new AwsEntityResolution.SchemaInputAttribute();
      //expect(instance).to.be.a(AwsEntityResolution.SchemaInputAttribute);
    });
    ...
    it('should have the property matchKey (base name: "matchKey")', function() {
      // uncomment below and update the code to test the property matchKey
      //var instance = new AwsEntityResolution.SchemaInputAttribute();
      //expect(instance).to.be();
    });
