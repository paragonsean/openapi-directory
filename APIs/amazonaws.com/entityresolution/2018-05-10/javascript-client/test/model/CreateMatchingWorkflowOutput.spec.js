...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.CreateMatchingWorkflowOutput();
  });
  ...
  describe('CreateMatchingWorkflowOutput', function() {
    it('should create an instance of CreateMatchingWorkflowOutput', function() {
      // uncomment below and update the code to test CreateMatchingWorkflowOutput
      //var instance = new AwsEntityResolution.CreateMatchingWorkflowOutput();
      //expect(instance).to.be.a(AwsEntityResolution.CreateMatchingWorkflowOutput);
    });
