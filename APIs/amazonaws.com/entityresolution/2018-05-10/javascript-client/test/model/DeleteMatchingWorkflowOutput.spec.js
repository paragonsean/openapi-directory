...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.DeleteMatchingWorkflowOutput();
  });
  ...
  describe('DeleteMatchingWorkflowOutput', function() {
    it('should create an instance of DeleteMatchingWorkflowOutput', function() {
      // uncomment below and update the code to test DeleteMatchingWorkflowOutput
      //var instance = new AwsEntityResolution.DeleteMatchingWorkflowOutput();
      //expect(instance).to.be.a(AwsEntityResolution.DeleteMatchingWorkflowOutput);
    });
