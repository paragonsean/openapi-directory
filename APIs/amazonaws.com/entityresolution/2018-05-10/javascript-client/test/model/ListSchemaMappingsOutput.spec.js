...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.ListSchemaMappingsOutput();
  });
  ...
  describe('ListSchemaMappingsOutput', function() {
    it('should create an instance of ListSchemaMappingsOutput', function() {
      // uncomment below and update the code to test ListSchemaMappingsOutput
      //var instance = new AwsEntityResolution.ListSchemaMappingsOutput();
      //expect(instance).to.be.a(AwsEntityResolution.ListSchemaMappingsOutput);
    });
    ...
    it('should have the property schemaList (base name: "schemaList")', function() {
      // uncomment below and update the code to test the property schemaList
      //var instance = new AwsEntityResolution.ListSchemaMappingsOutput();
      //expect(instance).to.be();
    });
