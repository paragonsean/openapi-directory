...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.UpdateMatchingWorkflowInput();
  });
  ...
  describe('UpdateMatchingWorkflowInput', function() {
    it('should create an instance of UpdateMatchingWorkflowInput', function() {
      // uncomment below and update the code to test UpdateMatchingWorkflowInput
      //var instance = new AwsEntityResolution.UpdateMatchingWorkflowInput();
      //expect(instance).to.be.a(AwsEntityResolution.UpdateMatchingWorkflowInput);
    });
