...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.TagResourceInput();
  });
  ...
  describe('TagResourceInput', function() {
    it('should create an instance of TagResourceInput', function() {
      ...
      //var instance = new AwsEntityResolution.TagResourceInput();
      //expect(instance).to.be.a(AwsEntityResolution.TagResourceInput);
    });
