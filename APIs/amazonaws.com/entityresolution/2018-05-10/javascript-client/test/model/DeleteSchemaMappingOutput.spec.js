...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.DeleteSchemaMappingOutput();
  });
  ...
  describe('DeleteSchemaMappingOutput', function() {
    it('should create an instance of DeleteSchemaMappingOutput', function() {
      // uncomment below and update the code to test DeleteSchemaMappingOutput
      //var instance = new AwsEntityResolution.DeleteSchemaMappingOutput();
      //expect(instance).to.be.a(AwsEntityResolution.DeleteSchemaMappingOutput);
    });
