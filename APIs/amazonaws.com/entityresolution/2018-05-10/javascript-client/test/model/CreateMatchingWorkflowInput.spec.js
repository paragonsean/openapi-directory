...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.CreateMatchingWorkflowInput();
  });
  ...
  describe('CreateMatchingWorkflowInput', function() {
    it('should create an instance of CreateMatchingWorkflowInput', function() {
      // uncomment below and update the code to test CreateMatchingWorkflowInput
      //var instance = new AwsEntityResolution.CreateMatchingWorkflowInput();
      //expect(instance).to.be.a(AwsEntityResolution.CreateMatchingWorkflowInput);
    });
