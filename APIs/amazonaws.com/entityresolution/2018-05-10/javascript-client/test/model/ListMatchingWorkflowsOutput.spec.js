...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.ListMatchingWorkflowsOutput();
  });
  ...
  describe('ListMatchingWorkflowsOutput', function() {
    it('should create an instance of ListMatchingWorkflowsOutput', function() {
      // uncomment below and update the code to test ListMatchingWorkflowsOutput
      //var instance = new AwsEntityResolution.ListMatchingWorkflowsOutput();
      //expect(instance).to.be.a(AwsEntityResolution.ListMatchingWorkflowsOutput);
    });
    ...
    it('should have the property workflowSummaries (base name: "workflowSummaries")', function() {
      // uncomment below and update the code to test the property workflowSummaries
      //var instance = new AwsEntityResolution.ListMatchingWorkflowsOutput();
      //expect(instance).to.be();
    });
