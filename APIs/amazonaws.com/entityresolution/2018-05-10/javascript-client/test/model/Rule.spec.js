...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.Rule();
  });
  ...
  describe('Rule', function() {
    it('should create an instance of Rule', function() {
      ...
      //var instance = new AwsEntityResolution.Rule();
      //expect(instance).to.be.a(AwsEntityResolution.Rule);
    });

    it('should have the property matchingKeys (base name: "matchingKeys")', function() {
      // uncomment below and update the code to test the property matchingKeys
      //var instance = new AwsEntityResolution.Rule();
