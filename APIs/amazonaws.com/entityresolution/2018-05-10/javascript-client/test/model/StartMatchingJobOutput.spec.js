...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.StartMatchingJobOutput();
  });
  ...
  describe('StartMatchingJobOutput', function() {
    it('should create an instance of StartMatchingJobOutput', function() {
      // uncomment below and update the code to test StartMatchingJobOutput
      //var instance = new AwsEntityResolution.StartMatchingJobOutput();
      //expect(instance).to.be.a(AwsEntityResolution.StartMatchingJobOutput);
    });
