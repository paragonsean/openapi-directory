...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.GetMatchIdInput();
  });
  ...
  describe('GetMatchIdInput', function() {
    it('should create an instance of GetMatchIdInput', function() {
      // uncomment below and update the code to test GetMatchIdInput
      //var instance = new AwsEntityResolution.GetMatchIdInput();
      //expect(instance).to.be.a(AwsEntityResolution.GetMatchIdInput);
    });
