...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.CreateMatchingWorkflowRequest();
  });
  ...
  describe('CreateMatchingWorkflowRequest', function() {
    it('should create an instance of CreateMatchingWorkflowRequest', function() {
      // uncomment below and update the code to test CreateMatchingWorkflowRequest
      //var instance = new AwsEntityResolution.CreateMatchingWorkflowRequest();
      //expect(instance).to.be.a(AwsEntityResolution.CreateMatchingWorkflowRequest);
    });
