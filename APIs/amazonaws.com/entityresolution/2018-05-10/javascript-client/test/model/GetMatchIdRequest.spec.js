...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.GetMatchIdRequest();
  });
  ...
  describe('GetMatchIdRequest', function() {
    it('should create an instance of GetMatchIdRequest', function() {
      // uncomment below and update the code to test GetMatchIdRequest
      //var instance = new AwsEntityResolution.GetMatchIdRequest();
      //expect(instance).to.be.a(AwsEntityResolution.GetMatchIdRequest);
    });
