...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.RuleBasedProperties();
  });
  ...
  describe('RuleBasedProperties', function() {
    it('should create an instance of RuleBasedProperties', function() {
      // uncomment below and update the code to test RuleBasedProperties
      //var instance = new AwsEntityResolution.RuleBasedProperties();
      //expect(instance).to.be.a(AwsEntityResolution.RuleBasedProperties);
    });
