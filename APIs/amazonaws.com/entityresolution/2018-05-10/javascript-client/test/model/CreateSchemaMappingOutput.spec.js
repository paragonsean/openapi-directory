...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.CreateSchemaMappingOutput();
  });
  ...
  describe('CreateSchemaMappingOutput', function() {
    it('should create an instance of CreateSchemaMappingOutput', function() {
      // uncomment below and update the code to test CreateSchemaMappingOutput
      //var instance = new AwsEntityResolution.CreateSchemaMappingOutput();
      //expect(instance).to.be.a(AwsEntityResolution.CreateSchemaMappingOutput);
    });
