...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.InputSource();
  });
  ...
  describe('InputSource', function() {
    it('should create an instance of InputSource', function() {
      // uncomment below and update the code to test InputSource
      //var instance = new AwsEntityResolution.InputSource();
      //expect(instance).to.be.a(AwsEntityResolution.InputSource);
    });
    ...
    it('should have the property inputSourceARN (base name: "inputSourceARN")', function() {
      // uncomment below and update the code to test the property inputSourceARN
      //var instance = new AwsEntityResolution.InputSource();
      //expect(instance).to.be();
    });
