...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.GetMatchingJobOutput();
  });
  ...
  describe('GetMatchingJobOutput', function() {
    it('should create an instance of GetMatchingJobOutput', function() {
      // uncomment below and update the code to test GetMatchingJobOutput
      //var instance = new AwsEntityResolution.GetMatchingJobOutput();
      //expect(instance).to.be.a(AwsEntityResolution.GetMatchingJobOutput);
    });
