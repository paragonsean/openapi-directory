...
(function(root, factory) {
  ...
  describe('IncrementalRunType', function() {
    it('should create an instance of IncrementalRunType', function() {
      // uncomment below and update the code to test IncrementalRunType
      //var instance = new AwsEntityResolution.IncrementalRunType();
      //expect(instance).to.be.a(AwsEntityResolution.IncrementalRunType);
    });
