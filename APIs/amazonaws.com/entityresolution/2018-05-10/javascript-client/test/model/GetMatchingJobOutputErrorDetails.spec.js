...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.GetMatchingJobOutputErrorDetails();
  });
  ...
  describe('GetMatchingJobOutputErrorDetails', function() {
    it('should create an instance of GetMatchingJobOutputErrorDetails', function() {
      // uncomment below and update the code to test GetMatchingJobOutputErrorDetails
      //var instance = new AwsEntityResolution.GetMatchingJobOutputErrorDetails();
      //expect(instance).to.be.a(AwsEntityResolution.GetMatchingJobOutputErrorDetails);
    });
