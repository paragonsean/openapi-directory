...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsEntityResolution.CreateSchemaMappingRequest();
  });
  ...
  describe('CreateSchemaMappingRequest', function() {
    it('should create an instance of CreateSchemaMappingRequest', function() {
      // uncomment below and update the code to test CreateSchemaMappingRequest
      //var instance = new AwsEntityResolution.CreateSchemaMappingRequest();
      //expect(instance).to.be.a(AwsEntityResolution.CreateSchemaMappingRequest);
    });
    ...
    it('should have the property mappedInputFields (base name: "mappedInputFields")', function() {
      // uncomment below and update the code to test the property mappedInputFields
      //var instance = new AwsEntityResolution.CreateSchemaMappingRequest();
      //expect(instance).to.be();
    });
