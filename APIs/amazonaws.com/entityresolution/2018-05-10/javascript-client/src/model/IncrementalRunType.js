...
* @readonly
*/
export default class IncrementalRunType {
    ...
    /**
    * Returns a <code>IncrementalRunType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/IncrementalRunType} The enum <code>IncrementalRunType</code> value.
    */
