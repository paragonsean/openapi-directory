...
void OAIErrorCode::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("InternalServiceException", Qt::CaseInsensitive) == 0) {
        m_value = eOAIErrorCode::INTERNALSERVICEEXCEPTION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("InvalidParameterException", Qt::CaseInsensitive) == 0) {
        m_value = eOAIErrorCode::INVALIDPARAMETEREXCEPTION;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIErrorCode::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIErrorCode::INTERNALSERVICEEXCEPTION:
            val = "InternalServiceException";
            break;
        case eOAIErrorCode::INVALIDPARAMETEREXCEPTION:
            val = "InvalidParameterException";
            break;
        default:
            break;
    }
