...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::describeReportCreationSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::describeReportCreationSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      apiInstance.describeReportCreation(x_amz_targetbodyx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
