...
public class ApiClient {
    ...
    private String basePath = "http://tagging.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-01-26/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://tagging.us-east-1.amazonaws.com
