...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIAssociateConnectionAliasRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIAssociateConnectionAliasRequest Example::create(){
    OAIAssociateConnectionAliasRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::associateConnectionAliasSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::associateConnectionAliasSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIAssociateConnectionAliasRequest oai_associate_connection_alias_request = create(); // OAIAssociateConnectionAliasRequest | 
      ...
      apiInstance.associateConnectionAlias(x_amz_targetoai_associate_connection_alias_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
