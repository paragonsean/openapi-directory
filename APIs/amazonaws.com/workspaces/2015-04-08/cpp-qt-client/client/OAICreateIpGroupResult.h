...
/*
 * OAICreateIpGroupResult.h
 *
 * 
 */

#ifndef OAICreateIpGroupResult_H
#define OAICreateIpGroupResult_H
...
class OAICreateIpGroupResult : public OAIObject {
public:
    OAICreateIpGroupResult();
    OAICreateIpGroupResult(QString json);
    ~OAICreateIpGroupResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIpGroupResult)

#endif // OAICreateIpGroupResult_H
