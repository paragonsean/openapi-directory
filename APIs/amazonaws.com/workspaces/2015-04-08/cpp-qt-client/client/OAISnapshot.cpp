...
QDateTime OAISnapshot::getSnapshotTime() const {
    return m_snapshot_time;
}
void OAISnapshot::setSnapshotTime(const QDateTime &snapshot_time) {
    m_snapshot_time = snapshot_time;
    m_snapshot_time_isSet = true;
}

bool OAISnapshot::is_snapshot_time_Set() const{
    return m_snapshot_time_isSet;
}

bool OAISnapshot::is_snapshot_time_Valid() const{
