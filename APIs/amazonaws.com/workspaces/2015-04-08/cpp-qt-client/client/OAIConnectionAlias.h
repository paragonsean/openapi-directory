...
#ifndef OAIConnectionAlias_H
#define OAIConnectionAlias_H
...
class OAIConnectionAlias : public OAIObject {
public:
    OAIConnectionAlias();
    OAIConnectionAlias(QString json);
    ~OAIConnectionAlias() override;
    ...
    OAIConnectionAliasState getState() const;
    void setState(const OAIConnectionAliasState &state);
...
private:
    ...
    OAIConnectionAliasState m_state;
    bool m_state_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionAlias)

#endif // OAIConnectionAlias_H
