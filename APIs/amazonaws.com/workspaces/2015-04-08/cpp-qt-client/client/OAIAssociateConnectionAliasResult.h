...
/*
 * OAIAssociateConnectionAliasResult.h
 *
 * 
 */

#ifndef OAIAssociateConnectionAliasResult_H
#define OAIAssociateConnectionAliasResult_H
...
class OAIAssociateConnectionAliasResult : public OAIObject {
public:
    OAIAssociateConnectionAliasResult();
    OAIAssociateConnectionAliasResult(QString json);
    ~OAIAssociateConnectionAliasResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateConnectionAliasResult)

#endif // OAIAssociateConnectionAliasResult_H
