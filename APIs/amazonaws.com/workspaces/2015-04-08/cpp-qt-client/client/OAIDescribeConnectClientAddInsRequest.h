...
/*
 * OAIDescribeConnectClientAddInsRequest.h
 *
 * 
 */

#ifndef OAIDescribeConnectClientAddInsRequest_H
#define OAIDescribeConnectClientAddInsRequest_H
...
class OAIDescribeConnectClientAddInsRequest : public OAIObject {
public:
    OAIDescribeConnectClientAddInsRequest();
    OAIDescribeConnectClientAddInsRequest(QString json);
    ~OAIDescribeConnectClientAddInsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeConnectClientAddInsRequest)

#endif // OAIDescribeConnectClientAddInsRequest_H
