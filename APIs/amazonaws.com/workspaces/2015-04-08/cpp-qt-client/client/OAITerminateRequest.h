...
/*
 * OAITerminateRequest.h
 *
 * Describes the information used to terminate a WorkSpace.
 */

#ifndef OAITerminateRequest_H
#define OAITerminateRequest_H
...
class OAITerminateRequest : public OAIObject {
public:
    OAITerminateRequest();
    OAITerminateRequest(QString json);
    ~OAITerminateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITerminateRequest)

#endif // OAITerminateRequest_H
