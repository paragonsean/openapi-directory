...
OAIModifyAccountRequest::OAIModifyAccountRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIModifyAccountRequest::OAIModifyAccountRequest() {
    this->initializeModel();
}

OAIModifyAccountRequest::~OAIModifyAccountRequest() {}

void OAIModifyAccountRequest::initializeModel() {
...
void OAIModifyAccountRequest::fromJson(QString jsonString) {
...
void OAIModifyAccountRequest::fromJsonObject(QJsonObject json) {
...
QString OAIModifyAccountRequest::asJson() const {
...
QJsonObject OAIModifyAccountRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIDedicatedTenancySupportEnum OAIModifyAccountRequest::getDedicatedTenancySupport() const {
    return m_dedicated_tenancy_support;
}
void OAIModifyAccountRequest::setDedicatedTenancySupport(const OAIDedicatedTenancySupportEnum &dedicated_tenancy_support) {
    m_dedicated_tenancy_support = dedicated_tenancy_support;
    m_dedicated_tenancy_support_isSet = true;
}

bool OAIModifyAccountRequest::is_dedicated_tenancy_support_Set() const{
    return m_dedicated_tenancy_support_isSet;
}

bool OAIModifyAccountRequest::is_dedicated_tenancy_support_Valid() const{
    return m_dedicated_tenancy_support_isValid;
}

QString OAIModifyAccountRequest::getDedicatedTenancyManagementCidrRange() const {
    return m_dedicated_tenancy_management_cidr_range;
}
void OAIModifyAccountRequest::setDedicatedTenancyManagementCidrRange(const QString &dedicated_tenancy_management_cidr_range) {
...
bool OAIModifyAccountRequest::is_dedicated_tenancy_management_cidr_range_Set() const{
    return m_dedicated_tenancy_management_cidr_range_isSet;
}

bool OAIModifyAccountRequest::is_dedicated_tenancy_management_cidr_range_Valid() const{
    return m_dedicated_tenancy_management_cidr_range_isValid;
}

bool OAIModifyAccountRequest::isSet() const {
...
bool OAIModifyAccountRequest::isValid() const {
