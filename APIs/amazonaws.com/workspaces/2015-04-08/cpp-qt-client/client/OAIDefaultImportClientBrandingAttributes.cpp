...
#include "OAIDefaultImportClientBrandingAttributes.h"
...
OAIDefaultImportClientBrandingAttributes::OAIDefaultImportClientBrandingAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDefaultImportClientBrandingAttributes::OAIDefaultImportClientBrandingAttributes() {
    this->initializeModel();
}

OAIDefaultImportClientBrandingAttributes::~OAIDefaultImportClientBrandingAttributes() {}

void OAIDefaultImportClientBrandingAttributes::initializeModel() {
...
void OAIDefaultImportClientBrandingAttributes::fromJson(QString jsonString) {
...
void OAIDefaultImportClientBrandingAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIDefaultImportClientBrandingAttributes::asJson() const {
...
QJsonObject OAIDefaultImportClientBrandingAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_isSet) {
...
QString OAIDefaultImportClientBrandingAttributes::getLogo() const {
    return m_logo;
}
void OAIDefaultImportClientBrandingAttributes::setLogo(const QString &logo) {
    m_logo = logo;
    m_logo_isSet = true;
}

bool OAIDefaultImportClientBrandingAttributes::is_logo_Set() const{
    return m_logo_isSet;
}

bool OAIDefaultImportClientBrandingAttributes::is_logo_Valid() const{
    return m_logo_isValid;
}

QString OAIDefaultImportClientBrandingAttributes::getSupportEmail() const {
    return m_support_email;
}
void OAIDefaultImportClientBrandingAttributes::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIDefaultImportClientBrandingAttributes::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIDefaultImportClientBrandingAttributes::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIDefaultImportClientBrandingAttributes::getSupportLink() const {
    return m_support_link;
}
void OAIDefaultImportClientBrandingAttributes::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIDefaultImportClientBrandingAttributes::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIDefaultImportClientBrandingAttributes::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIDefaultImportClientBrandingAttributes::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIDefaultImportClientBrandingAttributes::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIDefaultImportClientBrandingAttributes::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIDefaultImportClientBrandingAttributes::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIDefaultImportClientBrandingAttributes::getLoginMessage() const {
    return m_login_message;
}
void OAIDefaultImportClientBrandingAttributes::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIDefaultImportClientBrandingAttributes::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIDefaultImportClientBrandingAttributes::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIDefaultImportClientBrandingAttributes::isSet() const {
...
bool OAIDefaultImportClientBrandingAttributes::isValid() const {
