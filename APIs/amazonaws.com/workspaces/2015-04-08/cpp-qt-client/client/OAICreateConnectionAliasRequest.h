...
/*
 * OAICreateConnectionAliasRequest.h
 *
 * 
 */

#ifndef OAICreateConnectionAliasRequest_H
#define OAICreateConnectionAliasRequest_H
...
class OAICreateConnectionAliasRequest : public OAIObject {
public:
    OAICreateConnectionAliasRequest();
    OAICreateConnectionAliasRequest(QString json);
    ~OAICreateConnectionAliasRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateConnectionAliasRequest)

#endif // OAICreateConnectionAliasRequest_H
