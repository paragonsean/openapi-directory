...
OAIImagePermission::OAIImagePermission(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImagePermission::OAIImagePermission() {
    this->initializeModel();
}

OAIImagePermission::~OAIImagePermission() {}

void OAIImagePermission::initializeModel() {

    m_shared_account_id_isSet = false;
    m_shared_account_id_isValid = false;
}

void OAIImagePermission::fromJson(QString jsonString) {
...
void OAIImagePermission::fromJsonObject(QJsonObject json) {
...
QString OAIImagePermission::asJson() const {
...
QJsonObject OAIImagePermission::asJsonObject() const {
    QJsonObject obj;
...
QString OAIImagePermission::getSharedAccountId() const {
    return m_shared_account_id;
}
void OAIImagePermission::setSharedAccountId(const QString &shared_account_id) {
    m_shared_account_id = shared_account_id;
    m_shared_account_id_isSet = true;
}

bool OAIImagePermission::is_shared_account_id_Set() const{
    return m_shared_account_id_isSet;
}

bool OAIImagePermission::is_shared_account_id_Valid() const{
    return m_shared_account_id_isValid;
}

bool OAIImagePermission::isSet() const {
...
bool OAIImagePermission::isValid() const {
