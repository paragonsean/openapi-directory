...
#include "OAICertificateBasedAuthStatusEnum.h"
#include <QString>
...
public:
    ...
    OAICertificateBasedAuthStatusEnum getStatus() const;
    void setStatus(const OAICertificateBasedAuthStatusEnum &status);
...
private:
    ...
    OAICertificateBasedAuthStatusEnum m_status;
    bool m_status_isSet;
