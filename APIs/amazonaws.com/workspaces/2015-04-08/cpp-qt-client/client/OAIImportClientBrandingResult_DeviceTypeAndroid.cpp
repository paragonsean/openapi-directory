...
OAIImportClientBrandingResult_DeviceTypeAndroid::OAIImportClientBrandingResult_DeviceTypeAndroid(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportClientBrandingResult_DeviceTypeAndroid::OAIImportClientBrandingResult_DeviceTypeAndroid() {
    this->initializeModel();
}

OAIImportClientBrandingResult_DeviceTypeAndroid::~OAIImportClientBrandingResult_DeviceTypeAndroid() {}

void OAIImportClientBrandingResult_DeviceTypeAndroid::initializeModel() {
...
void OAIImportClientBrandingResult_DeviceTypeAndroid::fromJson(QString jsonString) {
...
void OAIImportClientBrandingResult_DeviceTypeAndroid::fromJsonObject(QJsonObject json) {
...
QString OAIImportClientBrandingResult_DeviceTypeAndroid::asJson() const {
...
QJsonObject OAIImportClientBrandingResult_DeviceTypeAndroid::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_url_isSet) {
...
QString OAIImportClientBrandingResult_DeviceTypeAndroid::getLogoUrl() const {
    return m_logo_url;
}
void OAIImportClientBrandingResult_DeviceTypeAndroid::setLogoUrl(const QString &logo_url) {
    m_logo_url = logo_url;
    m_logo_url_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeAndroid::is_logo_url_Set() const{
    return m_logo_url_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeAndroid::is_logo_url_Valid() const{
    return m_logo_url_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeAndroid::getSupportEmail() const {
    return m_support_email;
}
void OAIImportClientBrandingResult_DeviceTypeAndroid::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeAndroid::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeAndroid::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeAndroid::getSupportLink() const {
    return m_support_link;
}
void OAIImportClientBrandingResult_DeviceTypeAndroid::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeAndroid::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeAndroid::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeAndroid::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIImportClientBrandingResult_DeviceTypeAndroid::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeAndroid::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeAndroid::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIImportClientBrandingResult_DeviceTypeAndroid::getLoginMessage() const {
    return m_login_message;
}
void OAIImportClientBrandingResult_DeviceTypeAndroid::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeAndroid::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeAndroid::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIImportClientBrandingResult_DeviceTypeAndroid::isSet() const {
...
bool OAIImportClientBrandingResult_DeviceTypeAndroid::isValid() const {
