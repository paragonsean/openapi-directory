...
OAIAssociateIpGroupsRequest::OAIAssociateIpGroupsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateIpGroupsRequest::OAIAssociateIpGroupsRequest() {
    this->initializeModel();
}

OAIAssociateIpGroupsRequest::~OAIAssociateIpGroupsRequest() {}

void OAIAssociateIpGroupsRequest::initializeModel() {
...
void OAIAssociateIpGroupsRequest::fromJson(QString jsonString) {
...
void OAIAssociateIpGroupsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateIpGroupsRequest::asJson() const {
...
QJsonObject OAIAssociateIpGroupsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateIpGroupsRequest::getDirectoryId() const {
    return m_directory_id;
}
void OAIAssociateIpGroupsRequest::setDirectoryId(const QString &directory_id) {
    m_directory_id = directory_id;
    m_directory_id_isSet = true;
}

bool OAIAssociateIpGroupsRequest::is_directory_id_Set() const{
    return m_directory_id_isSet;
}

bool OAIAssociateIpGroupsRequest::is_directory_id_Valid() const{
    return m_directory_id_isValid;
}

QList OAIAssociateIpGroupsRequest::getGroupIds() const {
    return m_group_ids;
}
void OAIAssociateIpGroupsRequest::setGroupIds(const QList &group_ids) {
    m_group_ids = group_ids;
    m_group_ids_isSet = true;
}

bool OAIAssociateIpGroupsRequest::is_group_ids_Set() const{
    return m_group_ids_isSet;
}

bool OAIAssociateIpGroupsRequest::is_group_ids_Valid() const{
    return m_group_ids_isValid;
}

bool OAIAssociateIpGroupsRequest::isSet() const {
...
bool OAIAssociateIpGroupsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_directory_id_isValid && m_group_ids_isValid && true;
}
