...
/*
 * OAIFailedWorkspaceChangeRequest.h
 *
...
#ifndef OAIFailedWorkspaceChangeRequest_H
#define OAIFailedWorkspaceChangeRequest_H
...
class OAIFailedWorkspaceChangeRequest : public OAIObject {
public:
    OAIFailedWorkspaceChangeRequest();
    OAIFailedWorkspaceChangeRequest(QString json);
    ~OAIFailedWorkspaceChangeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFailedWorkspaceChangeRequest)

#endif // OAIFailedWorkspaceChangeRequest_H
