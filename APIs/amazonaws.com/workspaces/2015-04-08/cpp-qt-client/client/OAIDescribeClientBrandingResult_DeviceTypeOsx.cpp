...
OAIDescribeClientBrandingResult_DeviceTypeOsx::OAIDescribeClientBrandingResult_DeviceTypeOsx(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeClientBrandingResult_DeviceTypeOsx::OAIDescribeClientBrandingResult_DeviceTypeOsx() {
    this->initializeModel();
}

OAIDescribeClientBrandingResult_DeviceTypeOsx::~OAIDescribeClientBrandingResult_DeviceTypeOsx() {}

void OAIDescribeClientBrandingResult_DeviceTypeOsx::initializeModel() {
...
void OAIDescribeClientBrandingResult_DeviceTypeOsx::fromJson(QString jsonString) {
...
void OAIDescribeClientBrandingResult_DeviceTypeOsx::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeClientBrandingResult_DeviceTypeOsx::asJson() const {
...
QJsonObject OAIDescribeClientBrandingResult_DeviceTypeOsx::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_url_isSet) {
...
QString OAIDescribeClientBrandingResult_DeviceTypeOsx::getLogoUrl() const {
    return m_logo_url;
}
void OAIDescribeClientBrandingResult_DeviceTypeOsx::setLogoUrl(const QString &logo_url) {
    m_logo_url = logo_url;
    m_logo_url_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeOsx::is_logo_url_Set() const{
    return m_logo_url_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeOsx::is_logo_url_Valid() const{
    return m_logo_url_isValid;
}

QString OAIDescribeClientBrandingResult_DeviceTypeOsx::getSupportEmail() const {
    return m_support_email;
}
void OAIDescribeClientBrandingResult_DeviceTypeOsx::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeOsx::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeOsx::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIDescribeClientBrandingResult_DeviceTypeOsx::getSupportLink() const {
    return m_support_link;
}
void OAIDescribeClientBrandingResult_DeviceTypeOsx::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeOsx::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeOsx::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIDescribeClientBrandingResult_DeviceTypeOsx::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIDescribeClientBrandingResult_DeviceTypeOsx::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeOsx::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeOsx::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIDescribeClientBrandingResult_DeviceTypeOsx::getLoginMessage() const {
    return m_login_message;
}
void OAIDescribeClientBrandingResult_DeviceTypeOsx::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeOsx::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeOsx::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIDescribeClientBrandingResult_DeviceTypeOsx::isSet() const {
...
bool OAIDescribeClientBrandingResult_DeviceTypeOsx::isValid() const {
