...
OAIDescribeClientBrandingResult_DeviceTypeWindows::OAIDescribeClientBrandingResult_DeviceTypeWindows(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeClientBrandingResult_DeviceTypeWindows::OAIDescribeClientBrandingResult_DeviceTypeWindows() {
    this->initializeModel();
}

OAIDescribeClientBrandingResult_DeviceTypeWindows::~OAIDescribeClientBrandingResult_DeviceTypeWindows() {}

void OAIDescribeClientBrandingResult_DeviceTypeWindows::initializeModel() {
...
void OAIDescribeClientBrandingResult_DeviceTypeWindows::fromJson(QString jsonString) {
...
void OAIDescribeClientBrandingResult_DeviceTypeWindows::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeClientBrandingResult_DeviceTypeWindows::asJson() const {
...
QJsonObject OAIDescribeClientBrandingResult_DeviceTypeWindows::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_url_isSet) {
...
QString OAIDescribeClientBrandingResult_DeviceTypeWindows::getLogoUrl() const {
    return m_logo_url;
}
void OAIDescribeClientBrandingResult_DeviceTypeWindows::setLogoUrl(const QString &logo_url) {
    m_logo_url = logo_url;
    m_logo_url_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeWindows::is_logo_url_Set() const{
    return m_logo_url_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeWindows::is_logo_url_Valid() const{
    return m_logo_url_isValid;
}

QString OAIDescribeClientBrandingResult_DeviceTypeWindows::getSupportEmail() const {
    return m_support_email;
}
void OAIDescribeClientBrandingResult_DeviceTypeWindows::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeWindows::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeWindows::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIDescribeClientBrandingResult_DeviceTypeWindows::getSupportLink() const {
    return m_support_link;
}
void OAIDescribeClientBrandingResult_DeviceTypeWindows::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeWindows::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeWindows::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIDescribeClientBrandingResult_DeviceTypeWindows::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIDescribeClientBrandingResult_DeviceTypeWindows::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeWindows::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeWindows::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIDescribeClientBrandingResult_DeviceTypeWindows::getLoginMessage() const {
    return m_login_message;
}
void OAIDescribeClientBrandingResult_DeviceTypeWindows::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeWindows::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeWindows::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIDescribeClientBrandingResult_DeviceTypeWindows::isSet() const {
...
bool OAIDescribeClientBrandingResult_DeviceTypeWindows::isValid() const {
