...
void OAIComputeType::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIComputeType::asJsonObject() const {
    QJsonObject obj;
    if (m_name.isSet()) {
...
OAICompute OAIComputeType::getName() const {
    return m_name;
}
void OAIComputeType::setName(const OAICompute &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIComputeType::is_name_Set() const{
    return m_name_isSet;
}

bool OAIComputeType::is_name_Valid() const{
