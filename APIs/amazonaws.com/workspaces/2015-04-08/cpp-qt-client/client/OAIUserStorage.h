...
#ifndef OAIUserStorage_H
#define OAIUserStorage_H
...
class OAIUserStorage : public OAIObject {
public:
    OAIUserStorage();
    OAIUserStorage(QString json);
    ~OAIUserStorage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserStorage)

#endif // OAIUserStorage_H
