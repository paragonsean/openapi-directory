...
/*
 * OAIImportClientBrandingRequest_DeviceTypeIos.h
 *
 * 
 */

#ifndef OAIImportClientBrandingRequest_DeviceTypeIos_H
#define OAIImportClientBrandingRequest_DeviceTypeIos_H
...
class OAIImportClientBrandingRequest_DeviceTypeIos : public OAIObject {
public:
    OAIImportClientBrandingRequest_DeviceTypeIos();
    OAIImportClientBrandingRequest_DeviceTypeIos(QString json);
    ~OAIImportClientBrandingRequest_DeviceTypeIos() override;
    ...
    QString getLogo2x() const;
    void setLogo2x(const QString &logo2x);
    bool is_logo2x_Set() const;
    bool is_logo2x_Valid() const;

    QString getLogo3x() const;
    void setLogo3x(const QString &logo3x);
    bool is_logo3x_Set() const;
    bool is_logo3x_Valid() const;
...
private:
    ...
    QString m_logo2x;
    bool m_logo2x_isSet;
    bool m_logo2x_isValid;

    QString m_logo3x;
    bool m_logo3x_isSet;
    bool m_logo3x_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportClientBrandingRequest_DeviceTypeIos)

#endif // OAIImportClientBrandingRequest_DeviceTypeIos_H
