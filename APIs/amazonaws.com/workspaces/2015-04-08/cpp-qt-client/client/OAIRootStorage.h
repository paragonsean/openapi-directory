...
#ifndef OAIRootStorage_H
#define OAIRootStorage_H
...
class OAIRootStorage : public OAIObject {
public:
    OAIRootStorage();
    OAIRootStorage(QString json);
    ~OAIRootStorage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRootStorage)

#endif // OAIRootStorage_H
