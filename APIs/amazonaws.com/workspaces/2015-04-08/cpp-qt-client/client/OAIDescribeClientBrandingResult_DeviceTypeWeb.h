...
/*
 * OAIDescribeClientBrandingResult_DeviceTypeWeb.h
 *
 * 
 */

#ifndef OAIDescribeClientBrandingResult_DeviceTypeWeb_H
#define OAIDescribeClientBrandingResult_DeviceTypeWeb_H
...
class OAIDescribeClientBrandingResult_DeviceTypeWeb : public OAIObject {
public:
    OAIDescribeClientBrandingResult_DeviceTypeWeb();
    OAIDescribeClientBrandingResult_DeviceTypeWeb(QString json);
    ~OAIDescribeClientBrandingResult_DeviceTypeWeb() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeClientBrandingResult_DeviceTypeWeb)

#endif // OAIDescribeClientBrandingResult_DeviceTypeWeb_H
