...
OAIImportClientBrandingRequest_DeviceTypeOsx::OAIImportClientBrandingRequest_DeviceTypeOsx(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportClientBrandingRequest_DeviceTypeOsx::OAIImportClientBrandingRequest_DeviceTypeOsx() {
    this->initializeModel();
}

OAIImportClientBrandingRequest_DeviceTypeOsx::~OAIImportClientBrandingRequest_DeviceTypeOsx() {}

void OAIImportClientBrandingRequest_DeviceTypeOsx::initializeModel() {
...
void OAIImportClientBrandingRequest_DeviceTypeOsx::fromJson(QString jsonString) {
...
void OAIImportClientBrandingRequest_DeviceTypeOsx::fromJsonObject(QJsonObject json) {
...
QString OAIImportClientBrandingRequest_DeviceTypeOsx::asJson() const {
...
QJsonObject OAIImportClientBrandingRequest_DeviceTypeOsx::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_isSet) {
...
QString OAIImportClientBrandingRequest_DeviceTypeOsx::getLogo() const {
    return m_logo;
}
void OAIImportClientBrandingRequest_DeviceTypeOsx::setLogo(const QString &logo) {
    m_logo = logo;
    m_logo_isSet = true;
}

bool OAIImportClientBrandingRequest_DeviceTypeOsx::is_logo_Set() const{
    return m_logo_isSet;
}

bool OAIImportClientBrandingRequest_DeviceTypeOsx::is_logo_Valid() const{
    return m_logo_isValid;
}

QString OAIImportClientBrandingRequest_DeviceTypeOsx::getSupportEmail() const {
    return m_support_email;
}
void OAIImportClientBrandingRequest_DeviceTypeOsx::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIImportClientBrandingRequest_DeviceTypeOsx::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIImportClientBrandingRequest_DeviceTypeOsx::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIImportClientBrandingRequest_DeviceTypeOsx::getSupportLink() const {
    return m_support_link;
}
void OAIImportClientBrandingRequest_DeviceTypeOsx::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIImportClientBrandingRequest_DeviceTypeOsx::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIImportClientBrandingRequest_DeviceTypeOsx::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIImportClientBrandingRequest_DeviceTypeOsx::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIImportClientBrandingRequest_DeviceTypeOsx::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIImportClientBrandingRequest_DeviceTypeOsx::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIImportClientBrandingRequest_DeviceTypeOsx::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIImportClientBrandingRequest_DeviceTypeOsx::getLoginMessage() const {
    return m_login_message;
}
void OAIImportClientBrandingRequest_DeviceTypeOsx::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIImportClientBrandingRequest_DeviceTypeOsx::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIImportClientBrandingRequest_DeviceTypeOsx::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIImportClientBrandingRequest_DeviceTypeOsx::isSet() const {
...
bool OAIImportClientBrandingRequest_DeviceTypeOsx::isValid() const {
