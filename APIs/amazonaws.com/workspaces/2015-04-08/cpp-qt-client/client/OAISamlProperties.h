...
#ifndef OAISamlProperties_H
#define OAISamlProperties_H
...
class OAISamlProperties : public OAIObject {
public:
    OAISamlProperties();
    OAISamlProperties(QString json);
    ~OAISamlProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISamlProperties)

#endif // OAISamlProperties_H
