...
/*
 * OAIModifyWorkspacePropertiesRequest.h
 *
 * 
 */

#ifndef OAIModifyWorkspacePropertiesRequest_H
#define OAIModifyWorkspacePropertiesRequest_H
...
class OAIModifyWorkspacePropertiesRequest : public OAIObject {
public:
    OAIModifyWorkspacePropertiesRequest();
    OAIModifyWorkspacePropertiesRequest(QString json);
    ~OAIModifyWorkspacePropertiesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyWorkspacePropertiesRequest)

#endif // OAIModifyWorkspacePropertiesRequest_H
