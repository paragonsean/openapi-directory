...
/*
 * OAIDescribeTagsRequest.h
 *
 * 
 */

#ifndef OAIDescribeTagsRequest_H
#define OAIDescribeTagsRequest_H
...
class OAIDescribeTagsRequest : public OAIObject {
public:
    OAIDescribeTagsRequest();
    OAIDescribeTagsRequest(QString json);
    ~OAIDescribeTagsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTagsRequest)

#endif // OAIDescribeTagsRequest_H
