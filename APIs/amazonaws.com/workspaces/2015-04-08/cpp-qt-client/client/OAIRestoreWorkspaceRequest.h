...
/*
 * OAIRestoreWorkspaceRequest.h
 *
 * 
 */

#ifndef OAIRestoreWorkspaceRequest_H
#define OAIRestoreWorkspaceRequest_H
...
class OAIRestoreWorkspaceRequest : public OAIObject {
public:
    OAIRestoreWorkspaceRequest();
    OAIRestoreWorkspaceRequest(QString json);
    ~OAIRestoreWorkspaceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRestoreWorkspaceRequest)

#endif // OAIRestoreWorkspaceRequest_H
