...
/*
 * OAIImportClientBrandingRequest_DeviceTypeOsx.h
 *
 * 
 */

#ifndef OAIImportClientBrandingRequest_DeviceTypeOsx_H
#define OAIImportClientBrandingRequest_DeviceTypeOsx_H
...
class OAIImportClientBrandingRequest_DeviceTypeOsx : public OAIObject {
public:
    OAIImportClientBrandingRequest_DeviceTypeOsx();
    OAIImportClientBrandingRequest_DeviceTypeOsx(QString json);
    ~OAIImportClientBrandingRequest_DeviceTypeOsx() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportClientBrandingRequest_DeviceTypeOsx)

#endif // OAIImportClientBrandingRequest_DeviceTypeOsx_H
