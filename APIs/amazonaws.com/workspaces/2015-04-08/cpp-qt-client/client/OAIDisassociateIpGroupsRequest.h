...
/*
 * OAIDisassociateIpGroupsRequest.h
 *
 * 
 */

#ifndef OAIDisassociateIpGroupsRequest_H
#define OAIDisassociateIpGroupsRequest_H
...
class OAIDisassociateIpGroupsRequest : public OAIObject {
public:
    OAIDisassociateIpGroupsRequest();
    OAIDisassociateIpGroupsRequest(QString json);
    ~OAIDisassociateIpGroupsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateIpGroupsRequest)

#endif // OAIDisassociateIpGroupsRequest_H
