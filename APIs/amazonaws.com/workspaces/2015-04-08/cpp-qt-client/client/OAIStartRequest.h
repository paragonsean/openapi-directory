...
#ifndef OAIStartRequest_H
#define OAIStartRequest_H
...
class OAIStartRequest : public OAIObject {
public:
    OAIStartRequest();
    OAIStartRequest(QString json);
    ~OAIStartRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartRequest)

#endif // OAIStartRequest_H
