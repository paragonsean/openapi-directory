...
/*
 * OAIWorkspaceAccessProperties.h
 *
...
#ifndef OAIWorkspaceAccessProperties_H
#define OAIWorkspaceAccessProperties_H
...
class OAIWorkspaceAccessProperties : public OAIObject {
public:
    OAIWorkspaceAccessProperties();
    OAIWorkspaceAccessProperties(QString json);
    ~OAIWorkspaceAccessProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkspaceAccessProperties)

#endif // OAIWorkspaceAccessProperties_H
