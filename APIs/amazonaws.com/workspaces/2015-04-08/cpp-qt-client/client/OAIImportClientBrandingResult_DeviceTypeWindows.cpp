...
OAIImportClientBrandingResult_DeviceTypeWindows::OAIImportClientBrandingResult_DeviceTypeWindows(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportClientBrandingResult_DeviceTypeWindows::OAIImportClientBrandingResult_DeviceTypeWindows() {
    this->initializeModel();
}

OAIImportClientBrandingResult_DeviceTypeWindows::~OAIImportClientBrandingResult_DeviceTypeWindows() {}

void OAIImportClientBrandingResult_DeviceTypeWindows::initializeModel() {
...
void OAIImportClientBrandingResult_DeviceTypeWindows::fromJson(QString jsonString) {
...
void OAIImportClientBrandingResult_DeviceTypeWindows::fromJsonObject(QJsonObject json) {
...
QString OAIImportClientBrandingResult_DeviceTypeWindows::asJson() const {
...
QJsonObject OAIImportClientBrandingResult_DeviceTypeWindows::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_url_isSet) {
...
QString OAIImportClientBrandingResult_DeviceTypeWindows::getLogoUrl() const {
    return m_logo_url;
}
void OAIImportClientBrandingResult_DeviceTypeWindows::setLogoUrl(const QString &logo_url) {
    m_logo_url = logo_url;
    m_logo_url_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeWindows::is_logo_url_Set() const{
    return m_logo_url_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeWindows::is_logo_url_Valid() const{
    return m_logo_url_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeWindows::getSupportEmail() const {
    return m_support_email;
}
void OAIImportClientBrandingResult_DeviceTypeWindows::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeWindows::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeWindows::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeWindows::getSupportLink() const {
    return m_support_link;
}
void OAIImportClientBrandingResult_DeviceTypeWindows::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeWindows::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeWindows::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeWindows::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIImportClientBrandingResult_DeviceTypeWindows::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeWindows::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeWindows::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIImportClientBrandingResult_DeviceTypeWindows::getLoginMessage() const {
    return m_login_message;
}
void OAIImportClientBrandingResult_DeviceTypeWindows::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeWindows::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeWindows::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIImportClientBrandingResult_DeviceTypeWindows::isSet() const {
...
bool OAIImportClientBrandingResult_DeviceTypeWindows::isValid() const {
