...
#ifndef OAIStopRequest_H
#define OAIStopRequest_H
...
class OAIStopRequest : public OAIObject {
public:
    OAIStopRequest();
    OAIStopRequest(QString json);
    ~OAIStopRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopRequest)

#endif // OAIStopRequest_H
