...
OAIStopRequest::OAIStopRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopRequest::OAIStopRequest() {
    this->initializeModel();
}

OAIStopRequest::~OAIStopRequest() {}

void OAIStopRequest::initializeModel() {

    m_workspace_id_isSet = false;
    m_workspace_id_isValid = false;
}

void OAIStopRequest::fromJson(QString jsonString) {
...
void OAIStopRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStopRequest::asJson() const {
...
QJsonObject OAIStopRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStopRequest::getWorkspaceId() const {
    return m_workspace_id;
}
void OAIStopRequest::setWorkspaceId(const QString &workspace_id) {
    m_workspace_id = workspace_id;
    m_workspace_id_isSet = true;
}

bool OAIStopRequest::is_workspace_id_Set() const{
    return m_workspace_id_isSet;
}

bool OAIStopRequest::is_workspace_id_Valid() const{
    return m_workspace_id_isValid;
}

bool OAIStopRequest::isSet() const {
...
bool OAIStopRequest::isValid() const {
