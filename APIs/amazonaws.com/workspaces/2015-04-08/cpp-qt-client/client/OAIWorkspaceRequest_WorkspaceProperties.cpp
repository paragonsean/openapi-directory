...
OAIWorkspaceRequest_WorkspaceProperties::OAIWorkspaceRequest_WorkspaceProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWorkspaceRequest_WorkspaceProperties::OAIWorkspaceRequest_WorkspaceProperties() {
    this->initializeModel();
}

OAIWorkspaceRequest_WorkspaceProperties::~OAIWorkspaceRequest_WorkspaceProperties() {}

void OAIWorkspaceRequest_WorkspaceProperties::initializeModel() {
...
void OAIWorkspaceRequest_WorkspaceProperties::fromJson(QString jsonString) {
...
void OAIWorkspaceRequest_WorkspaceProperties::fromJsonObject(QJsonObject json) {
...
QString OAIWorkspaceRequest_WorkspaceProperties::asJson() const {
...
QJsonObject OAIWorkspaceRequest_WorkspaceProperties::asJsonObject() const {
    QJsonObject obj;
...
OAIRunningMode OAIWorkspaceRequest_WorkspaceProperties::getRunningMode() const {
    return m_running_mode;
}
void OAIWorkspaceRequest_WorkspaceProperties::setRunningMode(const OAIRunningMode &running_mode) {
    m_running_mode = running_mode;
    m_running_mode_isSet = true;
}

bool OAIWorkspaceRequest_WorkspaceProperties::is_running_mode_Set() const{
    return m_running_mode_isSet;
}

bool OAIWorkspaceRequest_WorkspaceProperties::is_running_mode_Valid() const{
    return m_running_mode_isValid;
}

qint32 OAIWorkspaceRequest_WorkspaceProperties::getRunningModeAutoStopTimeoutInMinutes() const {
    return m_running_mode_auto_stop_timeout_in_minutes;
}
void OAIWorkspaceRequest_WorkspaceProperties::setRunningModeAutoStopTimeoutInMinutes(const qint32 &running_mode_auto_stop_timeout_in_minutes) {
...
bool OAIWorkspaceRequest_WorkspaceProperties::is_running_mode_auto_stop_timeout_in_minutes_Set() const{
    return m_running_mode_auto_stop_timeout_in_minutes_isSet;
}

bool OAIWorkspaceRequest_WorkspaceProperties::is_running_mode_auto_stop_timeout_in_minutes_Valid() const{
    return m_running_mode_auto_stop_timeout_in_minutes_isValid;
}

qint32 OAIWorkspaceRequest_WorkspaceProperties::getRootVolumeSizeGib() const {
    return m_root_volume_size_gib;
}
void OAIWorkspaceRequest_WorkspaceProperties::setRootVolumeSizeGib(const qint32 &root_volume_size_gib) {
    m_root_volume_size_gib = root_volume_size_gib;
    m_root_volume_size_gib_isSet = true;
}

bool OAIWorkspaceRequest_WorkspaceProperties::is_root_volume_size_gib_Set() const{
    return m_root_volume_size_gib_isSet;
}

bool OAIWorkspaceRequest_WorkspaceProperties::is_root_volume_size_gib_Valid() const{
    return m_root_volume_size_gib_isValid;
}

qint32 OAIWorkspaceRequest_WorkspaceProperties::getUserVolumeSizeGib() const {
    return m_user_volume_size_gib;
}
void OAIWorkspaceRequest_WorkspaceProperties::setUserVolumeSizeGib(const qint32 &user_volume_size_gib) {
    m_user_volume_size_gib = user_volume_size_gib;
    m_user_volume_size_gib_isSet = true;
}

bool OAIWorkspaceRequest_WorkspaceProperties::is_user_volume_size_gib_Set() const{
    return m_user_volume_size_gib_isSet;
}

bool OAIWorkspaceRequest_WorkspaceProperties::is_user_volume_size_gib_Valid() const{
    return m_user_volume_size_gib_isValid;
}

OAICompute OAIWorkspaceRequest_WorkspaceProperties::getComputeTypeName() const {
    return m_compute_type_name;
}
void OAIWorkspaceRequest_WorkspaceProperties::setComputeTypeName(const OAICompute &compute_type_name) {
    m_compute_type_name = compute_type_name;
    m_compute_type_name_isSet = true;
}

bool OAIWorkspaceRequest_WorkspaceProperties::is_compute_type_name_Set() const{
    return m_compute_type_name_isSet;
}

bool OAIWorkspaceRequest_WorkspaceProperties::is_compute_type_name_Valid() const{
    return m_compute_type_name_isValid;
}

QList OAIWorkspaceRequest_WorkspaceProperties::getProtocols() const {
    return m_protocols;
}
void OAIWorkspaceRequest_WorkspaceProperties::setProtocols(const QList &protocols) {
    m_protocols = protocols;
    m_protocols_isSet = true;
}

bool OAIWorkspaceRequest_WorkspaceProperties::is_protocols_Set() const{
    return m_protocols_isSet;
}

bool OAIWorkspaceRequest_WorkspaceProperties::is_protocols_Valid() const{
    return m_protocols_isValid;
}

bool OAIWorkspaceRequest_WorkspaceProperties::isSet() const {
...
bool OAIWorkspaceRequest_WorkspaceProperties::isValid() const {
