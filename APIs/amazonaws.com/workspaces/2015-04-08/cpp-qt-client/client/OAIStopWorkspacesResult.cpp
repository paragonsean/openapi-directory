...
OAIStopWorkspacesResult::OAIStopWorkspacesResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopWorkspacesResult::OAIStopWorkspacesResult() {
    this->initializeModel();
}

OAIStopWorkspacesResult::~OAIStopWorkspacesResult() {}

void OAIStopWorkspacesResult::initializeModel() {

    m_failed_requests_isSet = false;
    m_failed_requests_isValid = false;
}

void OAIStopWorkspacesResult::fromJson(QString jsonString) {
...
void OAIStopWorkspacesResult::fromJsonObject(QJsonObject json) {
...
QString OAIStopWorkspacesResult::asJson() const {
...
QJsonObject OAIStopWorkspacesResult::asJsonObject() const {
    QJsonObject obj;
...
QList OAIStopWorkspacesResult::getFailedRequests() const {
    return m_failed_requests;
}
void OAIStopWorkspacesResult::setFailedRequests(const QList &failed_requests) {
    m_failed_requests = failed_requests;
    m_failed_requests_isSet = true;
}

bool OAIStopWorkspacesResult::is_failed_requests_Set() const{
    return m_failed_requests_isSet;
}

bool OAIStopWorkspacesResult::is_failed_requests_Valid() const{
    return m_failed_requests_isValid;
}

bool OAIStopWorkspacesResult::isSet() const {
...
bool OAIStopWorkspacesResult::isValid() const {
