...
OAIImportClientBrandingRequest_DeviceTypeWeb::OAIImportClientBrandingRequest_DeviceTypeWeb(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportClientBrandingRequest_DeviceTypeWeb::OAIImportClientBrandingRequest_DeviceTypeWeb() {
    this->initializeModel();
}

OAIImportClientBrandingRequest_DeviceTypeWeb::~OAIImportClientBrandingRequest_DeviceTypeWeb() {}

void OAIImportClientBrandingRequest_DeviceTypeWeb::initializeModel() {
...
void OAIImportClientBrandingRequest_DeviceTypeWeb::fromJson(QString jsonString) {
...
void OAIImportClientBrandingRequest_DeviceTypeWeb::fromJsonObject(QJsonObject json) {
...
QString OAIImportClientBrandingRequest_DeviceTypeWeb::asJson() const {
...
QJsonObject OAIImportClientBrandingRequest_DeviceTypeWeb::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_isSet) {
...
QString OAIImportClientBrandingRequest_DeviceTypeWeb::getLogo() const {
    return m_logo;
}
void OAIImportClientBrandingRequest_DeviceTypeWeb::setLogo(const QString &logo) {
    m_logo = logo;
    m_logo_isSet = true;
}

bool OAIImportClientBrandingRequest_DeviceTypeWeb::is_logo_Set() const{
    return m_logo_isSet;
}

bool OAIImportClientBrandingRequest_DeviceTypeWeb::is_logo_Valid() const{
    return m_logo_isValid;
}

QString OAIImportClientBrandingRequest_DeviceTypeWeb::getSupportEmail() const {
    return m_support_email;
}
void OAIImportClientBrandingRequest_DeviceTypeWeb::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIImportClientBrandingRequest_DeviceTypeWeb::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIImportClientBrandingRequest_DeviceTypeWeb::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIImportClientBrandingRequest_DeviceTypeWeb::getSupportLink() const {
    return m_support_link;
}
void OAIImportClientBrandingRequest_DeviceTypeWeb::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIImportClientBrandingRequest_DeviceTypeWeb::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIImportClientBrandingRequest_DeviceTypeWeb::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIImportClientBrandingRequest_DeviceTypeWeb::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIImportClientBrandingRequest_DeviceTypeWeb::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIImportClientBrandingRequest_DeviceTypeWeb::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIImportClientBrandingRequest_DeviceTypeWeb::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIImportClientBrandingRequest_DeviceTypeWeb::getLoginMessage() const {
    return m_login_message;
}
void OAIImportClientBrandingRequest_DeviceTypeWeb::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIImportClientBrandingRequest_DeviceTypeWeb::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIImportClientBrandingRequest_DeviceTypeWeb::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIImportClientBrandingRequest_DeviceTypeWeb::isSet() const {
...
bool OAIImportClientBrandingRequest_DeviceTypeWeb::isValid() const {
