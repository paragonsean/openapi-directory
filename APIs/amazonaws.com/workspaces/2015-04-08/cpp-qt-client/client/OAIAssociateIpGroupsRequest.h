...
/*
 * OAIAssociateIpGroupsRequest.h
 *
 * 
 */

#ifndef OAIAssociateIpGroupsRequest_H
#define OAIAssociateIpGroupsRequest_H
...
class OAIAssociateIpGroupsRequest : public OAIObject {
public:
    OAIAssociateIpGroupsRequest();
    OAIAssociateIpGroupsRequest(QString json);
    ~OAIAssociateIpGroupsRequest() override;
    ...
    QList getGroupIds() const;
    void setGroupIds(const QList &group_ids);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateIpGroupsRequest)

#endif // OAIAssociateIpGroupsRequest_H
