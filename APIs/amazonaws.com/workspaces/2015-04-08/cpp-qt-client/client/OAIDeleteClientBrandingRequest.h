...
/*
 * OAIDeleteClientBrandingRequest.h
 *
 * 
 */

#ifndef OAIDeleteClientBrandingRequest_H
#define OAIDeleteClientBrandingRequest_H
...
class OAIDeleteClientBrandingRequest : public OAIObject {
public:
    OAIDeleteClientBrandingRequest();
    OAIDeleteClientBrandingRequest(QString json);
    ~OAIDeleteClientBrandingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteClientBrandingRequest)

#endif // OAIDeleteClientBrandingRequest_H
