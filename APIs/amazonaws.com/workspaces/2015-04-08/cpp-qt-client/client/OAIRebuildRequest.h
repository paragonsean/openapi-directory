...
#ifndef OAIRebuildRequest_H
#define OAIRebuildRequest_H
...
class OAIRebuildRequest : public OAIObject {
public:
    OAIRebuildRequest();
    OAIRebuildRequest(QString json);
    ~OAIRebuildRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRebuildRequest)

#endif // OAIRebuildRequest_H
