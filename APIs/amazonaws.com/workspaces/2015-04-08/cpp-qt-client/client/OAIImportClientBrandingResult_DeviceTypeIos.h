...
/*
 * OAIImportClientBrandingResult_DeviceTypeIos.h
 *
 * 
 */

#ifndef OAIImportClientBrandingResult_DeviceTypeIos_H
#define OAIImportClientBrandingResult_DeviceTypeIos_H
...
class OAIImportClientBrandingResult_DeviceTypeIos : public OAIObject {
public:
    OAIImportClientBrandingResult_DeviceTypeIos();
    OAIImportClientBrandingResult_DeviceTypeIos(QString json);
    ~OAIImportClientBrandingResult_DeviceTypeIos() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportClientBrandingResult_DeviceTypeIos)

#endif // OAIImportClientBrandingResult_DeviceTypeIos_H
