...
/*
 * OAIImportClientBrandingResult_DeviceTypeOsx.h
 *
 * 
 */

#ifndef OAIImportClientBrandingResult_DeviceTypeOsx_H
#define OAIImportClientBrandingResult_DeviceTypeOsx_H
...
class OAIImportClientBrandingResult_DeviceTypeOsx : public OAIObject {
public:
    OAIImportClientBrandingResult_DeviceTypeOsx();
    OAIImportClientBrandingResult_DeviceTypeOsx(QString json);
    ~OAIImportClientBrandingResult_DeviceTypeOsx() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportClientBrandingResult_DeviceTypeOsx)

#endif // OAIImportClientBrandingResult_DeviceTypeOsx_H
