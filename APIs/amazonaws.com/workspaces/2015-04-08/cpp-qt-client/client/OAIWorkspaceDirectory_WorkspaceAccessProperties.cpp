...
OAIWorkspaceDirectory_WorkspaceAccessProperties::OAIWorkspaceDirectory_WorkspaceAccessProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWorkspaceDirectory_WorkspaceAccessProperties::OAIWorkspaceDirectory_WorkspaceAccessProperties() {
    this->initializeModel();
}

OAIWorkspaceDirectory_WorkspaceAccessProperties::~OAIWorkspaceDirectory_WorkspaceAccessProperties() {}

void OAIWorkspaceDirectory_WorkspaceAccessProperties::initializeModel() {
...
void OAIWorkspaceDirectory_WorkspaceAccessProperties::fromJson(QString jsonString) {
...
void OAIWorkspaceDirectory_WorkspaceAccessProperties::fromJsonObject(QJsonObject json) {
...
QString OAIWorkspaceDirectory_WorkspaceAccessProperties::asJson() const {
...
QJsonObject OAIWorkspaceDirectory_WorkspaceAccessProperties::asJsonObject() const {
    QJsonObject obj;
...
OAIAccessPropertyValue OAIWorkspaceDirectory_WorkspaceAccessProperties::getDeviceTypeWindows() const {
    return m_device_type_windows;
}
void OAIWorkspaceDirectory_WorkspaceAccessProperties::setDeviceTypeWindows(const OAIAccessPropertyValue &device_type_windows) {
    m_device_type_windows = device_type_windows;
    m_device_type_windows_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_windows_Set() const{
    return m_device_type_windows_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_windows_Valid() const{
    return m_device_type_windows_isValid;
}

OAIAccessPropertyValue OAIWorkspaceDirectory_WorkspaceAccessProperties::getDeviceTypeOsx() const {
    return m_device_type_osx;
}
void OAIWorkspaceDirectory_WorkspaceAccessProperties::setDeviceTypeOsx(const OAIAccessPropertyValue &device_type_osx) {
    m_device_type_osx = device_type_osx;
    m_device_type_osx_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_osx_Set() const{
    return m_device_type_osx_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_osx_Valid() const{
    return m_device_type_osx_isValid;
}

OAIAccessPropertyValue OAIWorkspaceDirectory_WorkspaceAccessProperties::getDeviceTypeWeb() const {
    return m_device_type_web;
}
void OAIWorkspaceDirectory_WorkspaceAccessProperties::setDeviceTypeWeb(const OAIAccessPropertyValue &device_type_web) {
    m_device_type_web = device_type_web;
    m_device_type_web_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_web_Set() const{
    return m_device_type_web_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_web_Valid() const{
    return m_device_type_web_isValid;
}

OAIAccessPropertyValue OAIWorkspaceDirectory_WorkspaceAccessProperties::getDeviceTypeIos() const {
    return m_device_type_ios;
}
void OAIWorkspaceDirectory_WorkspaceAccessProperties::setDeviceTypeIos(const OAIAccessPropertyValue &device_type_ios) {
    m_device_type_ios = device_type_ios;
    m_device_type_ios_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_ios_Set() const{
    return m_device_type_ios_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_ios_Valid() const{
    return m_device_type_ios_isValid;
}

OAIAccessPropertyValue OAIWorkspaceDirectory_WorkspaceAccessProperties::getDeviceTypeAndroid() const {
    return m_device_type_android;
}
void OAIWorkspaceDirectory_WorkspaceAccessProperties::setDeviceTypeAndroid(const OAIAccessPropertyValue &device_type_android) {
    m_device_type_android = device_type_android;
    m_device_type_android_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_android_Set() const{
    return m_device_type_android_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_android_Valid() const{
    return m_device_type_android_isValid;
}

OAIAccessPropertyValue OAIWorkspaceDirectory_WorkspaceAccessProperties::getDeviceTypeChromeOs() const {
    return m_device_type_chrome_os;
}
void OAIWorkspaceDirectory_WorkspaceAccessProperties::setDeviceTypeChromeOs(const OAIAccessPropertyValue &device_type_chrome_os) {
    m_device_type_chrome_os = device_type_chrome_os;
    m_device_type_chrome_os_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_chrome_os_Set() const{
    return m_device_type_chrome_os_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_chrome_os_Valid() const{
    return m_device_type_chrome_os_isValid;
}

OAIAccessPropertyValue OAIWorkspaceDirectory_WorkspaceAccessProperties::getDeviceTypeZeroClient() const {
    return m_device_type_zero_client;
}
void OAIWorkspaceDirectory_WorkspaceAccessProperties::setDeviceTypeZeroClient(const OAIAccessPropertyValue &device_type_zero_client) {
    m_device_type_zero_client = device_type_zero_client;
    m_device_type_zero_client_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_zero_client_Set() const{
    return m_device_type_zero_client_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_zero_client_Valid() const{
    return m_device_type_zero_client_isValid;
}

OAIAccessPropertyValue OAIWorkspaceDirectory_WorkspaceAccessProperties::getDeviceTypeLinux() const {
    return m_device_type_linux;
}
void OAIWorkspaceDirectory_WorkspaceAccessProperties::setDeviceTypeLinux(const OAIAccessPropertyValue &device_type_linux) {
    m_device_type_linux = device_type_linux;
    m_device_type_linux_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_linux_Set() const{
    return m_device_type_linux_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::is_device_type_linux_Valid() const{
    return m_device_type_linux_isValid;
}

bool OAIWorkspaceDirectory_WorkspaceAccessProperties::isSet() const {
...
bool OAIWorkspaceDirectory_WorkspaceAccessProperties::isValid() const {
