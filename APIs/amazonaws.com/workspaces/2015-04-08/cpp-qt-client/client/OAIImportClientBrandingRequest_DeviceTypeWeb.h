...
/*
 * OAIImportClientBrandingRequest_DeviceTypeWeb.h
 *
 * 
 */

#ifndef OAIImportClientBrandingRequest_DeviceTypeWeb_H
#define OAIImportClientBrandingRequest_DeviceTypeWeb_H
...
class OAIImportClientBrandingRequest_DeviceTypeWeb : public OAIObject {
public:
    OAIImportClientBrandingRequest_DeviceTypeWeb();
    OAIImportClientBrandingRequest_DeviceTypeWeb(QString json);
    ~OAIImportClientBrandingRequest_DeviceTypeWeb() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportClientBrandingRequest_DeviceTypeWeb)

#endif // OAIImportClientBrandingRequest_DeviceTypeWeb_H
