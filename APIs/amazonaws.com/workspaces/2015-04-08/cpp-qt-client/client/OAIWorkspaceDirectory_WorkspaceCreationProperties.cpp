...
OAIWorkspaceDirectory_WorkspaceCreationProperties::OAIWorkspaceDirectory_WorkspaceCreationProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWorkspaceDirectory_WorkspaceCreationProperties::OAIWorkspaceDirectory_WorkspaceCreationProperties() {
    this->initializeModel();
}

OAIWorkspaceDirectory_WorkspaceCreationProperties::~OAIWorkspaceDirectory_WorkspaceCreationProperties() {}

void OAIWorkspaceDirectory_WorkspaceCreationProperties::initializeModel() {
...
void OAIWorkspaceDirectory_WorkspaceCreationProperties::fromJson(QString jsonString) {
...
void OAIWorkspaceDirectory_WorkspaceCreationProperties::fromJsonObject(QJsonObject json) {
...
QString OAIWorkspaceDirectory_WorkspaceCreationProperties::asJson() const {
...
QJsonObject OAIWorkspaceDirectory_WorkspaceCreationProperties::asJsonObject() const {
    QJsonObject obj;
...
bool OAIWorkspaceDirectory_WorkspaceCreationProperties::getEnableWorkDocs() const {
    return m_enable_work_docs;
}
void OAIWorkspaceDirectory_WorkspaceCreationProperties::setEnableWorkDocs(const bool &enable_work_docs) {
    m_enable_work_docs = enable_work_docs;
    m_enable_work_docs_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::is_enable_work_docs_Set() const{
    return m_enable_work_docs_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::is_enable_work_docs_Valid() const{
    return m_enable_work_docs_isValid;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::getEnableInternetAccess() const {
    return m_enable_internet_access;
}
void OAIWorkspaceDirectory_WorkspaceCreationProperties::setEnableInternetAccess(const bool &enable_internet_access) {
    m_enable_internet_access = enable_internet_access;
    m_enable_internet_access_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::is_enable_internet_access_Set() const{
    return m_enable_internet_access_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::is_enable_internet_access_Valid() const{
    return m_enable_internet_access_isValid;
}

QString OAIWorkspaceDirectory_WorkspaceCreationProperties::getDefaultOu() const {
    return m_default_ou;
}
void OAIWorkspaceDirectory_WorkspaceCreationProperties::setDefaultOu(const QString &default_ou) {
    m_default_ou = default_ou;
    m_default_ou_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::is_default_ou_Set() const{
    return m_default_ou_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::is_default_ou_Valid() const{
    return m_default_ou_isValid;
}

QString OAIWorkspaceDirectory_WorkspaceCreationProperties::getCustomSecurityGroupId() const {
    return m_custom_security_group_id;
}
void OAIWorkspaceDirectory_WorkspaceCreationProperties::setCustomSecurityGroupId(const QString &custom_security_group_id) {
    m_custom_security_group_id = custom_security_group_id;
    m_custom_security_group_id_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::is_custom_security_group_id_Set() const{
    return m_custom_security_group_id_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::is_custom_security_group_id_Valid() const{
    return m_custom_security_group_id_isValid;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::getUserEnabledAsLocalAdministrator() const {
    return m_user_enabled_as_local_administrator;
}
void OAIWorkspaceDirectory_WorkspaceCreationProperties::setUserEnabledAsLocalAdministrator(const bool &user_enabled_as_local_administrator) {
...
bool OAIWorkspaceDirectory_WorkspaceCreationProperties::is_user_enabled_as_local_administrator_Set() const{
    return m_user_enabled_as_local_administrator_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::is_user_enabled_as_local_administrator_Valid() const{
    return m_user_enabled_as_local_administrator_isValid;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::getEnableMaintenanceMode() const {
    return m_enable_maintenance_mode;
}
void OAIWorkspaceDirectory_WorkspaceCreationProperties::setEnableMaintenanceMode(const bool &enable_maintenance_mode) {
    m_enable_maintenance_mode = enable_maintenance_mode;
    m_enable_maintenance_mode_isSet = true;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::is_enable_maintenance_mode_Set() const{
    return m_enable_maintenance_mode_isSet;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::is_enable_maintenance_mode_Valid() const{
    return m_enable_maintenance_mode_isValid;
}

bool OAIWorkspaceDirectory_WorkspaceCreationProperties::isSet() const {
...
bool OAIWorkspaceDirectory_WorkspaceCreationProperties::isValid() const {
