...
/*
 * OAICreateWorkspaceImageRequest.h
 *
 * 
 */

#ifndef OAICreateWorkspaceImageRequest_H
#define OAICreateWorkspaceImageRequest_H
...
class OAICreateWorkspaceImageRequest : public OAIObject {
public:
    OAICreateWorkspaceImageRequest();
    OAICreateWorkspaceImageRequest(QString json);
    ~OAICreateWorkspaceImageRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWorkspaceImageRequest)

#endif // OAICreateWorkspaceImageRequest_H
