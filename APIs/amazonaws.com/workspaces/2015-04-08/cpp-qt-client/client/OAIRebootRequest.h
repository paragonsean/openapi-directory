...
#ifndef OAIRebootRequest_H
#define OAIRebootRequest_H
...
class OAIRebootRequest : public OAIObject {
public:
    OAIRebootRequest();
    OAIRebootRequest(QString json);
    ~OAIRebootRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRebootRequest)

#endif // OAIRebootRequest_H
