...
#ifndef OAIUpdateResult_H
#define OAIUpdateResult_H
...
class OAIUpdateResult : public OAIObject {
public:
    OAIUpdateResult();
    OAIUpdateResult(QString json);
    ~OAIUpdateResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateResult)

#endif // OAIUpdateResult_H
