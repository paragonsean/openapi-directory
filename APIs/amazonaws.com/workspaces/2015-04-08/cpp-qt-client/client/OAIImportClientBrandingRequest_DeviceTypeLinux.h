...
/*
 * OAIImportClientBrandingRequest_DeviceTypeLinux.h
 *
 * 
 */

#ifndef OAIImportClientBrandingRequest_DeviceTypeLinux_H
#define OAIImportClientBrandingRequest_DeviceTypeLinux_H
...
class OAIImportClientBrandingRequest_DeviceTypeLinux : public OAIObject {
public:
    OAIImportClientBrandingRequest_DeviceTypeLinux();
    OAIImportClientBrandingRequest_DeviceTypeLinux(QString json);
    ~OAIImportClientBrandingRequest_DeviceTypeLinux() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportClientBrandingRequest_DeviceTypeLinux)

#endif // OAIImportClientBrandingRequest_DeviceTypeLinux_H
