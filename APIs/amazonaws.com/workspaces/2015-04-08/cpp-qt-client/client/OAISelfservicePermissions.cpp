...
#include "OAISelfservicePermissions.h"
...
OAISelfservicePermissions::OAISelfservicePermissions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISelfservicePermissions::OAISelfservicePermissions() {
    this->initializeModel();
}

OAISelfservicePermissions::~OAISelfservicePermissions() {}

void OAISelfservicePermissions::initializeModel() {
...
void OAISelfservicePermissions::fromJson(QString jsonString) {
...
void OAISelfservicePermissions::fromJsonObject(QJsonObject json) {
...
QString OAISelfservicePermissions::asJson() const {
...
QJsonObject OAISelfservicePermissions::asJsonObject() const {
    QJsonObject obj;
...
OAIReconnectEnum OAISelfservicePermissions::getRestartWorkspace() const {
    return m_restart_workspace;
}
void OAISelfservicePermissions::setRestartWorkspace(const OAIReconnectEnum &restart_workspace) {
    m_restart_workspace = restart_workspace;
    m_restart_workspace_isSet = true;
}

bool OAISelfservicePermissions::is_restart_workspace_Set() const{
    return m_restart_workspace_isSet;
}

bool OAISelfservicePermissions::is_restart_workspace_Valid() const{
    return m_restart_workspace_isValid;
}

OAIReconnectEnum OAISelfservicePermissions::getIncreaseVolumeSize() const {
    return m_increase_volume_size;
}
void OAISelfservicePermissions::setIncreaseVolumeSize(const OAIReconnectEnum &increase_volume_size) {
    m_increase_volume_size = increase_volume_size;
    m_increase_volume_size_isSet = true;
}

bool OAISelfservicePermissions::is_increase_volume_size_Set() const{
    return m_increase_volume_size_isSet;
}

bool OAISelfservicePermissions::is_increase_volume_size_Valid() const{
    return m_increase_volume_size_isValid;
}

OAIReconnectEnum OAISelfservicePermissions::getChangeComputeType() const {
    return m_change_compute_type;
}
void OAISelfservicePermissions::setChangeComputeType(const OAIReconnectEnum &change_compute_type) {
    m_change_compute_type = change_compute_type;
    m_change_compute_type_isSet = true;
}

bool OAISelfservicePermissions::is_change_compute_type_Set() const{
    return m_change_compute_type_isSet;
}

bool OAISelfservicePermissions::is_change_compute_type_Valid() const{
    return m_change_compute_type_isValid;
}

OAIReconnectEnum OAISelfservicePermissions::getSwitchRunningMode() const {
    return m_switch_running_mode;
}
void OAISelfservicePermissions::setSwitchRunningMode(const OAIReconnectEnum &switch_running_mode) {
    m_switch_running_mode = switch_running_mode;
    m_switch_running_mode_isSet = true;
}

bool OAISelfservicePermissions::is_switch_running_mode_Set() const{
    return m_switch_running_mode_isSet;
}

bool OAISelfservicePermissions::is_switch_running_mode_Valid() const{
    return m_switch_running_mode_isValid;
}

OAIReconnectEnum OAISelfservicePermissions::getRebuildWorkspace() const {
    return m_rebuild_workspace;
}
void OAISelfservicePermissions::setRebuildWorkspace(const OAIReconnectEnum &rebuild_workspace) {
    m_rebuild_workspace = rebuild_workspace;
    m_rebuild_workspace_isSet = true;
}

bool OAISelfservicePermissions::is_rebuild_workspace_Set() const{
    return m_rebuild_workspace_isSet;
}

bool OAISelfservicePermissions::is_rebuild_workspace_Valid() const{
    return m_rebuild_workspace_isValid;
}

bool OAISelfservicePermissions::isSet() const {
...
bool OAISelfservicePermissions::isValid() const {
