...
/*
 * OAIImportClientBrandingResult_DeviceTypeLinux.h
 *
 * 
 */

#ifndef OAIImportClientBrandingResult_DeviceTypeLinux_H
#define OAIImportClientBrandingResult_DeviceTypeLinux_H
...
class OAIImportClientBrandingResult_DeviceTypeLinux : public OAIObject {
public:
    OAIImportClientBrandingResult_DeviceTypeLinux();
    OAIImportClientBrandingResult_DeviceTypeLinux(QString json);
    ~OAIImportClientBrandingResult_DeviceTypeLinux() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportClientBrandingResult_DeviceTypeLinux)

#endif // OAIImportClientBrandingResult_DeviceTypeLinux_H
