...
/*
 * OAIWorkspaceRequest_WorkspaceProperties.h
 *
 * 
 */

#ifndef OAIWorkspaceRequest_WorkspaceProperties_H
#define OAIWorkspaceRequest_WorkspaceProperties_H
...
class OAIWorkspaceRequest_WorkspaceProperties : public OAIObject {
public:
    OAIWorkspaceRequest_WorkspaceProperties();
    OAIWorkspaceRequest_WorkspaceProperties(QString json);
    ~OAIWorkspaceRequest_WorkspaceProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkspaceRequest_WorkspaceProperties)

#endif // OAIWorkspaceRequest_WorkspaceProperties_H
