...
OAIImportClientBrandingResult_DeviceTypeLinux::OAIImportClientBrandingResult_DeviceTypeLinux(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportClientBrandingResult_DeviceTypeLinux::OAIImportClientBrandingResult_DeviceTypeLinux() {
    this->initializeModel();
}

OAIImportClientBrandingResult_DeviceTypeLinux::~OAIImportClientBrandingResult_DeviceTypeLinux() {}

void OAIImportClientBrandingResult_DeviceTypeLinux::initializeModel() {
...
void OAIImportClientBrandingResult_DeviceTypeLinux::fromJson(QString jsonString) {
...
void OAIImportClientBrandingResult_DeviceTypeLinux::fromJsonObject(QJsonObject json) {
...
QString OAIImportClientBrandingResult_DeviceTypeLinux::asJson() const {
...
QJsonObject OAIImportClientBrandingResult_DeviceTypeLinux::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_url_isSet) {
...
QString OAIImportClientBrandingResult_DeviceTypeLinux::getLogoUrl() const {
    return m_logo_url;
}
void OAIImportClientBrandingResult_DeviceTypeLinux::setLogoUrl(const QString &logo_url) {
    m_logo_url = logo_url;
    m_logo_url_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeLinux::is_logo_url_Set() const{
    return m_logo_url_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeLinux::is_logo_url_Valid() const{
    return m_logo_url_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeLinux::getSupportEmail() const {
    return m_support_email;
}
void OAIImportClientBrandingResult_DeviceTypeLinux::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeLinux::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeLinux::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeLinux::getSupportLink() const {
    return m_support_link;
}
void OAIImportClientBrandingResult_DeviceTypeLinux::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeLinux::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeLinux::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeLinux::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIImportClientBrandingResult_DeviceTypeLinux::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeLinux::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeLinux::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIImportClientBrandingResult_DeviceTypeLinux::getLoginMessage() const {
    return m_login_message;
}
void OAIImportClientBrandingResult_DeviceTypeLinux::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeLinux::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeLinux::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIImportClientBrandingResult_DeviceTypeLinux::isSet() const {
...
bool OAIImportClientBrandingResult_DeviceTypeLinux::isValid() const {
