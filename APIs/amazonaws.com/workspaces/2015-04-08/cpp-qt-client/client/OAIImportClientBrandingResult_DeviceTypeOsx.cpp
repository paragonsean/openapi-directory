...
OAIImportClientBrandingResult_DeviceTypeOsx::OAIImportClientBrandingResult_DeviceTypeOsx(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportClientBrandingResult_DeviceTypeOsx::OAIImportClientBrandingResult_DeviceTypeOsx() {
    this->initializeModel();
}

OAIImportClientBrandingResult_DeviceTypeOsx::~OAIImportClientBrandingResult_DeviceTypeOsx() {}

void OAIImportClientBrandingResult_DeviceTypeOsx::initializeModel() {
...
void OAIImportClientBrandingResult_DeviceTypeOsx::fromJson(QString jsonString) {
...
void OAIImportClientBrandingResult_DeviceTypeOsx::fromJsonObject(QJsonObject json) {
...
QString OAIImportClientBrandingResult_DeviceTypeOsx::asJson() const {
...
QJsonObject OAIImportClientBrandingResult_DeviceTypeOsx::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_url_isSet) {
...
QString OAIImportClientBrandingResult_DeviceTypeOsx::getLogoUrl() const {
    return m_logo_url;
}
void OAIImportClientBrandingResult_DeviceTypeOsx::setLogoUrl(const QString &logo_url) {
    m_logo_url = logo_url;
    m_logo_url_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeOsx::is_logo_url_Set() const{
    return m_logo_url_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeOsx::is_logo_url_Valid() const{
    return m_logo_url_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeOsx::getSupportEmail() const {
    return m_support_email;
}
void OAIImportClientBrandingResult_DeviceTypeOsx::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeOsx::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeOsx::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeOsx::getSupportLink() const {
    return m_support_link;
}
void OAIImportClientBrandingResult_DeviceTypeOsx::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeOsx::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeOsx::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeOsx::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIImportClientBrandingResult_DeviceTypeOsx::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeOsx::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeOsx::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIImportClientBrandingResult_DeviceTypeOsx::getLoginMessage() const {
    return m_login_message;
}
void OAIImportClientBrandingResult_DeviceTypeOsx::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeOsx::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeOsx::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIImportClientBrandingResult_DeviceTypeOsx::isSet() const {
...
bool OAIImportClientBrandingResult_DeviceTypeOsx::isValid() const {
