...
OAIDescribeClientBrandingResult_DeviceTypeAndroid::OAIDescribeClientBrandingResult_DeviceTypeAndroid(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeClientBrandingResult_DeviceTypeAndroid::OAIDescribeClientBrandingResult_DeviceTypeAndroid() {
    this->initializeModel();
}

OAIDescribeClientBrandingResult_DeviceTypeAndroid::~OAIDescribeClientBrandingResult_DeviceTypeAndroid() {}

void OAIDescribeClientBrandingResult_DeviceTypeAndroid::initializeModel() {
...
void OAIDescribeClientBrandingResult_DeviceTypeAndroid::fromJson(QString jsonString) {
...
void OAIDescribeClientBrandingResult_DeviceTypeAndroid::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeClientBrandingResult_DeviceTypeAndroid::asJson() const {
...
QJsonObject OAIDescribeClientBrandingResult_DeviceTypeAndroid::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_url_isSet) {
...
QString OAIDescribeClientBrandingResult_DeviceTypeAndroid::getLogoUrl() const {
    return m_logo_url;
}
void OAIDescribeClientBrandingResult_DeviceTypeAndroid::setLogoUrl(const QString &logo_url) {
    m_logo_url = logo_url;
    m_logo_url_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeAndroid::is_logo_url_Set() const{
    return m_logo_url_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeAndroid::is_logo_url_Valid() const{
    return m_logo_url_isValid;
}

QString OAIDescribeClientBrandingResult_DeviceTypeAndroid::getSupportEmail() const {
    return m_support_email;
}
void OAIDescribeClientBrandingResult_DeviceTypeAndroid::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeAndroid::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeAndroid::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIDescribeClientBrandingResult_DeviceTypeAndroid::getSupportLink() const {
    return m_support_link;
}
void OAIDescribeClientBrandingResult_DeviceTypeAndroid::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeAndroid::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeAndroid::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIDescribeClientBrandingResult_DeviceTypeAndroid::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIDescribeClientBrandingResult_DeviceTypeAndroid::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeAndroid::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeAndroid::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIDescribeClientBrandingResult_DeviceTypeAndroid::getLoginMessage() const {
    return m_login_message;
}
void OAIDescribeClientBrandingResult_DeviceTypeAndroid::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeAndroid::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeAndroid::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIDescribeClientBrandingResult_DeviceTypeAndroid::isSet() const {
...
bool OAIDescribeClientBrandingResult_DeviceTypeAndroid::isValid() const {
