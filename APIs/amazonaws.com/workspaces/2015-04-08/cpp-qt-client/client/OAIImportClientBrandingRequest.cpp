...
OAIImportClientBrandingRequest::OAIImportClientBrandingRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportClientBrandingRequest::OAIImportClientBrandingRequest() {
    this->initializeModel();
}

OAIImportClientBrandingRequest::~OAIImportClientBrandingRequest() {}

void OAIImportClientBrandingRequest::initializeModel() {
...
void OAIImportClientBrandingRequest::fromJson(QString jsonString) {
...
void OAIImportClientBrandingRequest::fromJsonObject(QJsonObject json) {
...
QString OAIImportClientBrandingRequest::asJson() const {
...
QJsonObject OAIImportClientBrandingRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIImportClientBrandingRequest::getResourceId() const {
    return m_resource_id;
}
void OAIImportClientBrandingRequest::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIImportClientBrandingRequest::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIImportClientBrandingRequest::is_resource_id_Valid() const{
    return m_resource_id_isValid;
}

OAIImportClientBrandingRequest_DeviceTypeWindows OAIImportClientBrandingRequest::getDeviceTypeWindows() const {
    return m_device_type_windows;
}
void OAIImportClientBrandingRequest::setDeviceTypeWindows(const OAIImportClientBrandingRequest_DeviceTypeWindows &device_type_windows) {
    m_device_type_windows = device_type_windows;
    m_device_type_windows_isSet = true;
}

bool OAIImportClientBrandingRequest::is_device_type_windows_Set() const{
    return m_device_type_windows_isSet;
}

bool OAIImportClientBrandingRequest::is_device_type_windows_Valid() const{
    return m_device_type_windows_isValid;
}

OAIImportClientBrandingRequest_DeviceTypeOsx OAIImportClientBrandingRequest::getDeviceTypeOsx() const {
    return m_device_type_osx;
}
void OAIImportClientBrandingRequest::setDeviceTypeOsx(const OAIImportClientBrandingRequest_DeviceTypeOsx &device_type_osx) {
    m_device_type_osx = device_type_osx;
    m_device_type_osx_isSet = true;
}

bool OAIImportClientBrandingRequest::is_device_type_osx_Set() const{
    return m_device_type_osx_isSet;
}

bool OAIImportClientBrandingRequest::is_device_type_osx_Valid() const{
    return m_device_type_osx_isValid;
}

OAIImportClientBrandingRequest_DeviceTypeAndroid OAIImportClientBrandingRequest::getDeviceTypeAndroid() const {
    return m_device_type_android;
}
void OAIImportClientBrandingRequest::setDeviceTypeAndroid(const OAIImportClientBrandingRequest_DeviceTypeAndroid &device_type_android) {
    m_device_type_android = device_type_android;
    m_device_type_android_isSet = true;
}

bool OAIImportClientBrandingRequest::is_device_type_android_Set() const{
    return m_device_type_android_isSet;
}

bool OAIImportClientBrandingRequest::is_device_type_android_Valid() const{
    return m_device_type_android_isValid;
}

OAIImportClientBrandingRequest_DeviceTypeIos OAIImportClientBrandingRequest::getDeviceTypeIos() const {
    return m_device_type_ios;
}
void OAIImportClientBrandingRequest::setDeviceTypeIos(const OAIImportClientBrandingRequest_DeviceTypeIos &device_type_ios) {
    m_device_type_ios = device_type_ios;
    m_device_type_ios_isSet = true;
}

bool OAIImportClientBrandingRequest::is_device_type_ios_Set() const{
    return m_device_type_ios_isSet;
}

bool OAIImportClientBrandingRequest::is_device_type_ios_Valid() const{
    return m_device_type_ios_isValid;
}

OAIImportClientBrandingRequest_DeviceTypeLinux OAIImportClientBrandingRequest::getDeviceTypeLinux() const {
    return m_device_type_linux;
}
void OAIImportClientBrandingRequest::setDeviceTypeLinux(const OAIImportClientBrandingRequest_DeviceTypeLinux &device_type_linux) {
    m_device_type_linux = device_type_linux;
    m_device_type_linux_isSet = true;
}

bool OAIImportClientBrandingRequest::is_device_type_linux_Set() const{
    return m_device_type_linux_isSet;
}

bool OAIImportClientBrandingRequest::is_device_type_linux_Valid() const{
    return m_device_type_linux_isValid;
}

OAIImportClientBrandingRequest_DeviceTypeWeb OAIImportClientBrandingRequest::getDeviceTypeWeb() const {
    return m_device_type_web;
}
void OAIImportClientBrandingRequest::setDeviceTypeWeb(const OAIImportClientBrandingRequest_DeviceTypeWeb &device_type_web) {
    m_device_type_web = device_type_web;
    m_device_type_web_isSet = true;
}

bool OAIImportClientBrandingRequest::is_device_type_web_Set() const{
    return m_device_type_web_isSet;
}

bool OAIImportClientBrandingRequest::is_device_type_web_Valid() const{
    return m_device_type_web_isValid;
}

bool OAIImportClientBrandingRequest::isSet() const {
...
bool OAIImportClientBrandingRequest::isValid() const {
