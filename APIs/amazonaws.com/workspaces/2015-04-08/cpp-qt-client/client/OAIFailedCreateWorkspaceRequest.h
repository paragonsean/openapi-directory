...
/*
 * OAIFailedCreateWorkspaceRequest.h
 *
 * Describes a WorkSpace that cannot be created.
 */

#ifndef OAIFailedCreateWorkspaceRequest_H
#define OAIFailedCreateWorkspaceRequest_H
...
namespace OpenAPI {
class OAIFailedCreateWorkspaceRequest_WorkspaceRequest;

class OAIFailedCreateWorkspaceRequest : public OAIObject {
public:
    OAIFailedCreateWorkspaceRequest();
    OAIFailedCreateWorkspaceRequest(QString json);
    ~OAIFailedCreateWorkspaceRequest() override;
    ...
    OAIFailedCreateWorkspaceRequest_WorkspaceRequest getWorkspaceRequest() const;
    void setWorkspaceRequest(const OAIFailedCreateWorkspaceRequest_WorkspaceRequest &workspace_request);
...
private:
    ...
    OAIFailedCreateWorkspaceRequest_WorkspaceRequest m_workspace_request;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFailedCreateWorkspaceRequest)

#endif // OAIFailedCreateWorkspaceRequest_H
