...
OAIDescribeClientBrandingResult_DeviceTypeLinux::OAIDescribeClientBrandingResult_DeviceTypeLinux(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeClientBrandingResult_DeviceTypeLinux::OAIDescribeClientBrandingResult_DeviceTypeLinux() {
    this->initializeModel();
}

OAIDescribeClientBrandingResult_DeviceTypeLinux::~OAIDescribeClientBrandingResult_DeviceTypeLinux() {}

void OAIDescribeClientBrandingResult_DeviceTypeLinux::initializeModel() {
...
void OAIDescribeClientBrandingResult_DeviceTypeLinux::fromJson(QString jsonString) {
...
void OAIDescribeClientBrandingResult_DeviceTypeLinux::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeClientBrandingResult_DeviceTypeLinux::asJson() const {
...
QJsonObject OAIDescribeClientBrandingResult_DeviceTypeLinux::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_url_isSet) {
...
QString OAIDescribeClientBrandingResult_DeviceTypeLinux::getLogoUrl() const {
    return m_logo_url;
}
void OAIDescribeClientBrandingResult_DeviceTypeLinux::setLogoUrl(const QString &logo_url) {
    m_logo_url = logo_url;
    m_logo_url_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeLinux::is_logo_url_Set() const{
    return m_logo_url_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeLinux::is_logo_url_Valid() const{
    return m_logo_url_isValid;
}

QString OAIDescribeClientBrandingResult_DeviceTypeLinux::getSupportEmail() const {
    return m_support_email;
}
void OAIDescribeClientBrandingResult_DeviceTypeLinux::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeLinux::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeLinux::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIDescribeClientBrandingResult_DeviceTypeLinux::getSupportLink() const {
    return m_support_link;
}
void OAIDescribeClientBrandingResult_DeviceTypeLinux::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeLinux::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeLinux::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIDescribeClientBrandingResult_DeviceTypeLinux::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIDescribeClientBrandingResult_DeviceTypeLinux::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeLinux::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeLinux::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIDescribeClientBrandingResult_DeviceTypeLinux::getLoginMessage() const {
    return m_login_message;
}
void OAIDescribeClientBrandingResult_DeviceTypeLinux::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIDescribeClientBrandingResult_DeviceTypeLinux::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIDescribeClientBrandingResult_DeviceTypeLinux::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIDescribeClientBrandingResult_DeviceTypeLinux::isSet() const {
...
bool OAIDescribeClientBrandingResult_DeviceTypeLinux::isValid() const {
