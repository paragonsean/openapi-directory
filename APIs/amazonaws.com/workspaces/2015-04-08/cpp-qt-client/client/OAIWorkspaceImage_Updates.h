...
/*
 * OAIWorkspaceImage_Updates.h
 *
 * 
 */

#ifndef OAIWorkspaceImage_Updates_H
#define OAIWorkspaceImage_Updates_H
...
class OAIWorkspaceImage_Updates : public OAIObject {
public:
    OAIWorkspaceImage_Updates();
    OAIWorkspaceImage_Updates(QString json);
    ~OAIWorkspaceImage_Updates() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkspaceImage_Updates)

#endif // OAIWorkspaceImage_Updates_H
