...
/*
 * OAIWorkspaceRequest.h
 *
 * Describes the information used to create a WorkSpace.
 */

#ifndef OAIWorkspaceRequest_H
#define OAIWorkspaceRequest_H

#include <QJsonObject>

#include "OAIWorkspaceRequest_WorkspaceProperties.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIWorkspaceRequest_WorkspaceProperties;

class OAIWorkspaceRequest : public OAIObject {
public:
    OAIWorkspaceRequest();
    OAIWorkspaceRequest(QString json);
    ~OAIWorkspaceRequest() override;
    ...
    OAIWorkspaceRequest_WorkspaceProperties getWorkspaceProperties() const;
    void setWorkspaceProperties(const OAIWorkspaceRequest_WorkspaceProperties &workspace_properties);
...
private:
    ...
    OAIWorkspaceRequest_WorkspaceProperties m_workspace_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkspaceRequest)

#endif // OAIWorkspaceRequest_H
