...
/*
 * OAIDescribeClientBrandingResult_DeviceTypeOsx.h
 *
 * 
 */

#ifndef OAIDescribeClientBrandingResult_DeviceTypeOsx_H
#define OAIDescribeClientBrandingResult_DeviceTypeOsx_H
...
class OAIDescribeClientBrandingResult_DeviceTypeOsx : public OAIObject {
public:
    OAIDescribeClientBrandingResult_DeviceTypeOsx();
    OAIDescribeClientBrandingResult_DeviceTypeOsx(QString json);
    ~OAIDescribeClientBrandingResult_DeviceTypeOsx() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeClientBrandingResult_DeviceTypeOsx)

#endif // OAIDescribeClientBrandingResult_DeviceTypeOsx_H
