...
OAIStartWorkspacesResult::OAIStartWorkspacesResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartWorkspacesResult::OAIStartWorkspacesResult() {
    this->initializeModel();
}

OAIStartWorkspacesResult::~OAIStartWorkspacesResult() {}

void OAIStartWorkspacesResult::initializeModel() {

    m_failed_requests_isSet = false;
    m_failed_requests_isValid = false;
}

void OAIStartWorkspacesResult::fromJson(QString jsonString) {
...
void OAIStartWorkspacesResult::fromJsonObject(QJsonObject json) {
...
QString OAIStartWorkspacesResult::asJson() const {
...
QJsonObject OAIStartWorkspacesResult::asJsonObject() const {
    QJsonObject obj;
...
QList OAIStartWorkspacesResult::getFailedRequests() const {
    return m_failed_requests;
}
void OAIStartWorkspacesResult::setFailedRequests(const QList &failed_requests) {
    m_failed_requests = failed_requests;
    m_failed_requests_isSet = true;
}

bool OAIStartWorkspacesResult::is_failed_requests_Set() const{
    return m_failed_requests_isSet;
}

bool OAIStartWorkspacesResult::is_failed_requests_Valid() const{
    return m_failed_requests_isValid;
}

bool OAIStartWorkspacesResult::isSet() const {
...
bool OAIStartWorkspacesResult::isValid() const {
