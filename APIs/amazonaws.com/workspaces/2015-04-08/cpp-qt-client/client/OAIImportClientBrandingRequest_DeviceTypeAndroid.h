...
/*
 * OAIImportClientBrandingRequest_DeviceTypeAndroid.h
 *
 * 
 */

#ifndef OAIImportClientBrandingRequest_DeviceTypeAndroid_H
#define OAIImportClientBrandingRequest_DeviceTypeAndroid_H
...
class OAIImportClientBrandingRequest_DeviceTypeAndroid : public OAIObject {
public:
    OAIImportClientBrandingRequest_DeviceTypeAndroid();
    OAIImportClientBrandingRequest_DeviceTypeAndroid(QString json);
    ~OAIImportClientBrandingRequest_DeviceTypeAndroid() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportClientBrandingRequest_DeviceTypeAndroid)

#endif // OAIImportClientBrandingRequest_DeviceTypeAndroid_H
