...
class OAIApplication : public OAIEnum {
public:
    OAIApplication();
    ...
    enum class eOAIApplication {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        _2016, 
        _2019
    };
    OAIApplication::eOAIApplication getValue() const;
    void setValue(const OAIApplication::eOAIApplication& value);
