...
/*
 * OAIDeleteIpGroupRequest.h
 *
 * 
 */

#ifndef OAIDeleteIpGroupRequest_H
#define OAIDeleteIpGroupRequest_H
...
class OAIDeleteIpGroupRequest : public OAIObject {
public:
    OAIDeleteIpGroupRequest();
    OAIDeleteIpGroupRequest(QString json);
    ~OAIDeleteIpGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteIpGroupRequest)

#endif // OAIDeleteIpGroupRequest_H
