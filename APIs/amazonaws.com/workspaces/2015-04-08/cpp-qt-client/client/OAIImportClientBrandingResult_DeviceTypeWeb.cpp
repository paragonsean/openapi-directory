...
OAIImportClientBrandingResult_DeviceTypeWeb::OAIImportClientBrandingResult_DeviceTypeWeb(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportClientBrandingResult_DeviceTypeWeb::OAIImportClientBrandingResult_DeviceTypeWeb() {
    this->initializeModel();
}

OAIImportClientBrandingResult_DeviceTypeWeb::~OAIImportClientBrandingResult_DeviceTypeWeb() {}

void OAIImportClientBrandingResult_DeviceTypeWeb::initializeModel() {
...
void OAIImportClientBrandingResult_DeviceTypeWeb::fromJson(QString jsonString) {
...
void OAIImportClientBrandingResult_DeviceTypeWeb::fromJsonObject(QJsonObject json) {
...
QString OAIImportClientBrandingResult_DeviceTypeWeb::asJson() const {
...
QJsonObject OAIImportClientBrandingResult_DeviceTypeWeb::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_url_isSet) {
...
QString OAIImportClientBrandingResult_DeviceTypeWeb::getLogoUrl() const {
    return m_logo_url;
}
void OAIImportClientBrandingResult_DeviceTypeWeb::setLogoUrl(const QString &logo_url) {
    m_logo_url = logo_url;
    m_logo_url_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeWeb::is_logo_url_Set() const{
    return m_logo_url_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeWeb::is_logo_url_Valid() const{
    return m_logo_url_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeWeb::getSupportEmail() const {
    return m_support_email;
}
void OAIImportClientBrandingResult_DeviceTypeWeb::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeWeb::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeWeb::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeWeb::getSupportLink() const {
    return m_support_link;
}
void OAIImportClientBrandingResult_DeviceTypeWeb::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeWeb::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeWeb::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIImportClientBrandingResult_DeviceTypeWeb::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIImportClientBrandingResult_DeviceTypeWeb::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeWeb::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeWeb::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIImportClientBrandingResult_DeviceTypeWeb::getLoginMessage() const {
    return m_login_message;
}
void OAIImportClientBrandingResult_DeviceTypeWeb::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIImportClientBrandingResult_DeviceTypeWeb::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIImportClientBrandingResult_DeviceTypeWeb::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIImportClientBrandingResult_DeviceTypeWeb::isSet() const {
...
bool OAIImportClientBrandingResult_DeviceTypeWeb::isValid() const {
