...
OAIRootStorage::OAIRootStorage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRootStorage::OAIRootStorage() {
    this->initializeModel();
}

OAIRootStorage::~OAIRootStorage() {}

void OAIRootStorage::initializeModel() {

    m_capacity_isSet = false;
    m_capacity_isValid = false;
}

void OAIRootStorage::fromJson(QString jsonString) {
...
void OAIRootStorage::fromJsonObject(QJsonObject json) {
...
QString OAIRootStorage::asJson() const {
...
QJsonObject OAIRootStorage::asJsonObject() const {
    QJsonObject obj;
    if (m_capacity_isSet) {
...
QString OAIRootStorage::getCapacity() const {
    return m_capacity;
}
void OAIRootStorage::setCapacity(const QString &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAIRootStorage::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAIRootStorage::is_capacity_Valid() const{
    return m_capacity_isValid;
}

bool OAIRootStorage::isSet() const {
...
bool OAIRootStorage::isValid() const {
