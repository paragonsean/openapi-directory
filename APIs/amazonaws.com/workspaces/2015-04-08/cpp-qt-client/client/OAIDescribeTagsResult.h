...
/*
 * OAIDescribeTagsResult.h
 *
 * 
 */

#ifndef OAIDescribeTagsResult_H
#define OAIDescribeTagsResult_H
...
class OAIDescribeTagsResult : public OAIObject {
public:
    OAIDescribeTagsResult();
    OAIDescribeTagsResult(QString json);
    ~OAIDescribeTagsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTagsResult)

#endif // OAIDescribeTagsResult_H
