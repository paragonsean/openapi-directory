...
/*
 * OAIDescribeClientBrandingResult_DeviceTypeIos.h
 *
 * 
 */

#ifndef OAIDescribeClientBrandingResult_DeviceTypeIos_H
#define OAIDescribeClientBrandingResult_DeviceTypeIos_H
...
class OAIDescribeClientBrandingResult_DeviceTypeIos : public OAIObject {
public:
    OAIDescribeClientBrandingResult_DeviceTypeIos();
    OAIDescribeClientBrandingResult_DeviceTypeIos(QString json);
    ~OAIDescribeClientBrandingResult_DeviceTypeIos() override;
    ...
    QString getLogo2xUrl() const;
    void setLogo2xUrl(const QString &logo2x_url);
    bool is_logo2x_url_Set() const;
    bool is_logo2x_url_Valid() const;

    QString getLogo3xUrl() const;
    void setLogo3xUrl(const QString &logo3x_url);
    bool is_logo3x_url_Set() const;
    bool is_logo3x_url_Valid() const;
...
private:
    ...
    QString m_logo2x_url;
    bool m_logo2x_url_isSet;
    bool m_logo2x_url_isValid;

    QString m_logo3x_url;
    bool m_logo3x_url_isSet;
    bool m_logo3x_url_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeClientBrandingResult_DeviceTypeIos)

#endif // OAIDescribeClientBrandingResult_DeviceTypeIos_H
