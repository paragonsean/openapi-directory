...
/*
 * OAIUpdateWorkspaceBundleRequest.h
 *
 * 
 */

#ifndef OAIUpdateWorkspaceBundleRequest_H
#define OAIUpdateWorkspaceBundleRequest_H
...
class OAIUpdateWorkspaceBundleRequest : public OAIObject {
public:
    OAIUpdateWorkspaceBundleRequest();
    OAIUpdateWorkspaceBundleRequest(QString json);
    ~OAIUpdateWorkspaceBundleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateWorkspaceBundleRequest)

#endif // OAIUpdateWorkspaceBundleRequest_H
