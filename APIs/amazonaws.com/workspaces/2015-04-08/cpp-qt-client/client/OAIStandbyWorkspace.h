...
/*
 * OAIStandbyWorkspace.h
 *
 * Describes a standby WorkSpace.
 */

#ifndef OAIStandbyWorkspace_H
#define OAIStandbyWorkspace_H
...
class OAIStandbyWorkspace : public OAIObject {
public:
    OAIStandbyWorkspace();
    OAIStandbyWorkspace(QString json);
    ~OAIStandbyWorkspace() override;
    ...
    QString getPrimaryWorkspaceId() const;
    void setPrimaryWorkspaceId(const QString &primary_workspace_id);
    bool is_primary_workspace_id_Set() const;
    bool is_primary_workspace_id_Valid() const;
...
private:
    ...
    QString m_primary_workspace_id;
    bool m_primary_workspace_id_isSet;
    bool m_primary_workspace_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStandbyWorkspace)

#endif // OAIStandbyWorkspace_H
