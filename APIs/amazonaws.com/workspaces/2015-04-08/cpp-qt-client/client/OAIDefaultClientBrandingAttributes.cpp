...
#include "OAIDefaultClientBrandingAttributes.h"
...
OAIDefaultClientBrandingAttributes::OAIDefaultClientBrandingAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDefaultClientBrandingAttributes::OAIDefaultClientBrandingAttributes() {
    this->initializeModel();
}

OAIDefaultClientBrandingAttributes::~OAIDefaultClientBrandingAttributes() {}

void OAIDefaultClientBrandingAttributes::initializeModel() {
...
void OAIDefaultClientBrandingAttributes::fromJson(QString jsonString) {
...
void OAIDefaultClientBrandingAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIDefaultClientBrandingAttributes::asJson() const {
...
QJsonObject OAIDefaultClientBrandingAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_logo_url_isSet) {
...
QString OAIDefaultClientBrandingAttributes::getLogoUrl() const {
    return m_logo_url;
}
void OAIDefaultClientBrandingAttributes::setLogoUrl(const QString &logo_url) {
    m_logo_url = logo_url;
    m_logo_url_isSet = true;
}

bool OAIDefaultClientBrandingAttributes::is_logo_url_Set() const{
    return m_logo_url_isSet;
}

bool OAIDefaultClientBrandingAttributes::is_logo_url_Valid() const{
    return m_logo_url_isValid;
}

QString OAIDefaultClientBrandingAttributes::getSupportEmail() const {
    return m_support_email;
}
void OAIDefaultClientBrandingAttributes::setSupportEmail(const QString &support_email) {
    m_support_email = support_email;
    m_support_email_isSet = true;
}

bool OAIDefaultClientBrandingAttributes::is_support_email_Set() const{
    return m_support_email_isSet;
}

bool OAIDefaultClientBrandingAttributes::is_support_email_Valid() const{
    return m_support_email_isValid;
}

QString OAIDefaultClientBrandingAttributes::getSupportLink() const {
    return m_support_link;
}
void OAIDefaultClientBrandingAttributes::setSupportLink(const QString &support_link) {
    m_support_link = support_link;
    m_support_link_isSet = true;
}

bool OAIDefaultClientBrandingAttributes::is_support_link_Set() const{
    return m_support_link_isSet;
}

bool OAIDefaultClientBrandingAttributes::is_support_link_Valid() const{
    return m_support_link_isValid;
}

QString OAIDefaultClientBrandingAttributes::getForgotPasswordLink() const {
    return m_forgot_password_link;
}
void OAIDefaultClientBrandingAttributes::setForgotPasswordLink(const QString &forgot_password_link) {
    m_forgot_password_link = forgot_password_link;
    m_forgot_password_link_isSet = true;
}

bool OAIDefaultClientBrandingAttributes::is_forgot_password_link_Set() const{
    return m_forgot_password_link_isSet;
}

bool OAIDefaultClientBrandingAttributes::is_forgot_password_link_Valid() const{
    return m_forgot_password_link_isValid;
}

QMap OAIDefaultClientBrandingAttributes::getLoginMessage() const {
    return m_login_message;
}
void OAIDefaultClientBrandingAttributes::setLoginMessage(const QMap &login_message) {
    m_login_message = login_message;
    m_login_message_isSet = true;
}

bool OAIDefaultClientBrandingAttributes::is_login_message_Set() const{
    return m_login_message_isSet;
}

bool OAIDefaultClientBrandingAttributes::is_login_message_Valid() const{
    return m_login_message_isValid;
}

bool OAIDefaultClientBrandingAttributes::isSet() const {
...
bool OAIDefaultClientBrandingAttributes::isValid() const {
