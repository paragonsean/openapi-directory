...
/*
 * OAIAssociateConnectionAliasRequest.h
 *
 * 
 */

#ifndef OAIAssociateConnectionAliasRequest_H
#define OAIAssociateConnectionAliasRequest_H
...
class OAIAssociateConnectionAliasRequest : public OAIObject {
public:
    OAIAssociateConnectionAliasRequest();
    OAIAssociateConnectionAliasRequest(QString json);
    ~OAIAssociateConnectionAliasRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateConnectionAliasRequest)

#endif // OAIAssociateConnectionAliasRequest_H
