...
/*
 * OAIImportClientBrandingResult_DeviceTypeWeb.h
 *
 * 
 */

#ifndef OAIImportClientBrandingResult_DeviceTypeWeb_H
#define OAIImportClientBrandingResult_DeviceTypeWeb_H
...
class OAIImportClientBrandingResult_DeviceTypeWeb : public OAIObject {
public:
    OAIImportClientBrandingResult_DeviceTypeWeb();
    OAIImportClientBrandingResult_DeviceTypeWeb(QString json);
    ~OAIImportClientBrandingResult_DeviceTypeWeb() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportClientBrandingResult_DeviceTypeWeb)

#endif // OAIImportClientBrandingResult_DeviceTypeWeb_H
