...
/**
 * Gets or Sets ClientDeviceType
 */
@JsonAdapter(ClientDeviceType.Adapter.class)
public enum ClientDeviceType {
  ...
  public static ClientDeviceType fromValue(String value) {
    for (ClientDeviceType b : ClientDeviceType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ClientDeviceType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ClientDeviceType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ClientDeviceType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ClientDeviceType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ClientDeviceType.fromValue(value);
  }
}
