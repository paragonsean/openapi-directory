...
import org.openapitools.client.model.CertificateBasedAuthStatusEnum;
...
public class CertificateBasedAuthProperties {
  ...
  private CertificateBasedAuthStatusEnum status;
  ...
  public CertificateBasedAuthProperties status(CertificateBasedAuthStatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public CertificateBasedAuthStatusEnum getStatus() {
    return status;
  }

  public void setStatus(CertificateBasedAuthStatusEnum status) {
    this.status = status;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Status") != null && !jsonObj.get("Status").isJsonNull()) {
        CertificateBasedAuthStatusEnum.validateJsonElement(jsonObj.get("Status"));
      }
