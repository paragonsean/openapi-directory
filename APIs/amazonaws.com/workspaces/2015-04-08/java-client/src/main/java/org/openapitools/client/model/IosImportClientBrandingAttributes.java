...
public class IosImportClientBrandingAttributes {
  ...
  public IosImportClientBrandingAttributes logo(String logo) {
    this.logo = logo;
    return this;
  }
  ...
  public IosImportClientBrandingAttributes logo2x(String logo2x) {
    this.logo2x = logo2x;
    return this;
  }
  ...
  public IosImportClientBrandingAttributes logo3x(String logo3x) {
    this.logo3x = logo3x;
    return this;
  }
  ...
  public IosImportClientBrandingAttributes supportEmail(String supportEmail) {
  ...
  public IosImportClientBrandingAttributes supportLink(String supportLink) {
  ...
  public IosImportClientBrandingAttributes forgotPasswordLink(String forgotPasswordLink) {
  ...
  public IosImportClientBrandingAttributes loginMessage(Map loginMessage) {
  ...
  public boolean equals(Object o) {
    ...
    IosImportClientBrandingAttributes iosImportClientBrandingAttributes = (IosImportClientBrandingAttributes) o;
    return Objects.equals(this.logo, iosImportClientBrandingAttributes.logo) &&
        Objects.equals(this.logo2x, iosImportClientBrandingAttributes.logo2x) &&
        Objects.equals(this.logo3x, iosImportClientBrandingAttributes.logo3x) &&
        Objects.equals(this.supportEmail, iosImportClientBrandingAttributes.supportEmail) &&
        Objects.equals(this.supportLink, iosImportClientBrandingAttributes.supportLink) &&
        Objects.equals(this.forgotPasswordLink, iosImportClientBrandingAttributes.forgotPasswordLink) &&
        Objects.equals(this.loginMessage, iosImportClientBrandingAttributes.loginMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class IosImportClientBrandingAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IosImportClientBrandingAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IosImportClientBrandingAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IosImportClientBrandingAttributes is not found in the empty JSON string", IosImportClientBrandingAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IosImportClientBrandingAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IosImportClientBrandingAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IosImportClientBrandingAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IosImportClientBrandingAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IosImportClientBrandingAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IosImportClientBrandingAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<IosImportClientBrandingAttributes>() {
           @Override
           public void write(JsonWriter out, IosImportClientBrandingAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IosImportClientBrandingAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IosImportClientBrandingAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IosImportClientBrandingAttributes
   * @throws IOException if the JSON string is invalid with respect to IosImportClientBrandingAttributes
   */
  public static IosImportClientBrandingAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IosImportClientBrandingAttributes.class);
  }

  /**
   * Convert an instance of IosImportClientBrandingAttributes to an JSON string
   *
   * @return JSON string
   */
