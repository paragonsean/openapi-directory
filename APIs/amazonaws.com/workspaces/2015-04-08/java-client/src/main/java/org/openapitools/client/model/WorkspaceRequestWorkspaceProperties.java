...
public class WorkspaceRequestWorkspaceProperties {
  ...
  public WorkspaceRequestWorkspaceProperties() {
  }

  public WorkspaceRequestWorkspaceProperties runningMode(RunningMode runningMode) {
  ...
  public WorkspaceRequestWorkspaceProperties runningModeAutoStopTimeoutInMinutes(Integer runningModeAutoStopTimeoutInMinutes) {
  ...
  public WorkspaceRequestWorkspaceProperties rootVolumeSizeGib(Integer rootVolumeSizeGib) {
  ...
  public WorkspaceRequestWorkspaceProperties userVolumeSizeGib(Integer userVolumeSizeGib) {
  ...
  public WorkspaceRequestWorkspaceProperties computeTypeName(Compute computeTypeName) {
  ...
  public WorkspaceRequestWorkspaceProperties protocols(List protocols) {
  ...
  public boolean equals(Object o) {
    ...
    WorkspaceRequestWorkspaceProperties workspaceRequestWorkspaceProperties = (WorkspaceRequestWorkspaceProperties) o;
    return Objects.equals(this.runningMode, workspaceRequestWorkspaceProperties.runningMode) &&
        Objects.equals(this.runningModeAutoStopTimeoutInMinutes, workspaceRequestWorkspaceProperties.runningModeAutoStopTimeoutInMinutes) &&
        Objects.equals(this.rootVolumeSizeGib, workspaceRequestWorkspaceProperties.rootVolumeSizeGib) &&
        Objects.equals(this.userVolumeSizeGib, workspaceRequestWorkspaceProperties.userVolumeSizeGib) &&
        Objects.equals(this.computeTypeName, workspaceRequestWorkspaceProperties.computeTypeName) &&
        Objects.equals(this.protocols, workspaceRequestWorkspaceProperties.protocols);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkspaceRequestWorkspaceProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WorkspaceRequestWorkspaceProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkspaceRequestWorkspaceProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkspaceRequestWorkspaceProperties is not found in the empty JSON string", WorkspaceRequestWorkspaceProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkspaceRequestWorkspaceProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkspaceRequestWorkspaceProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkspaceRequestWorkspaceProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkspaceRequestWorkspaceProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkspaceRequestWorkspaceProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkspaceRequestWorkspaceProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkspaceRequestWorkspaceProperties>() {
           @Override
           public void write(JsonWriter out, WorkspaceRequestWorkspaceProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkspaceRequestWorkspaceProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WorkspaceRequestWorkspaceProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WorkspaceRequestWorkspaceProperties
   * @throws IOException if the JSON string is invalid with respect to WorkspaceRequestWorkspaceProperties
   */
  public static WorkspaceRequestWorkspaceProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkspaceRequestWorkspaceProperties.class);
  }

  /**
   * Convert an instance of WorkspaceRequestWorkspaceProperties to an JSON string
   *
   * @return JSON string
   */
