 ...
 */
@JsonAdapter(Compute.Adapter.class)
public enum Compute {
  ...
  public static class Adapter extends TypeAdapter<Compute> {
    @Override
    public void write(final JsonWriter jsonWriter, final Compute enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public Compute read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return Compute.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    Compute.fromValue(value);
  }
}
