...
public class ModifyWorkspacePropertiesRequestWorkspaceProperties {
  ...
  public ModifyWorkspacePropertiesRequestWorkspaceProperties() {
  }

  public ModifyWorkspacePropertiesRequestWorkspaceProperties runningMode(RunningMode runningMode) {
  ...
  public ModifyWorkspacePropertiesRequestWorkspaceProperties runningModeAutoStopTimeoutInMinutes(Integer runningModeAutoStopTimeoutInMinutes) {
  ...
  public ModifyWorkspacePropertiesRequestWorkspaceProperties rootVolumeSizeGib(Integer rootVolumeSizeGib) {
  ...
  public ModifyWorkspacePropertiesRequestWorkspaceProperties userVolumeSizeGib(Integer userVolumeSizeGib) {
  ...
  public ModifyWorkspacePropertiesRequestWorkspaceProperties computeTypeName(Compute computeTypeName) {
  ...
  public ModifyWorkspacePropertiesRequestWorkspaceProperties protocols(List protocols) {
  ...
  public boolean equals(Object o) {
    ...
    ModifyWorkspacePropertiesRequestWorkspaceProperties modifyWorkspacePropertiesRequestWorkspaceProperties = (ModifyWorkspacePropertiesRequestWorkspaceProperties) o;
    return Objects.equals(this.runningMode, modifyWorkspacePropertiesRequestWorkspaceProperties.runningMode) &&
        Objects.equals(this.runningModeAutoStopTimeoutInMinutes, modifyWorkspacePropertiesRequestWorkspaceProperties.runningModeAutoStopTimeoutInMinutes) &&
        Objects.equals(this.rootVolumeSizeGib, modifyWorkspacePropertiesRequestWorkspaceProperties.rootVolumeSizeGib) &&
        Objects.equals(this.userVolumeSizeGib, modifyWorkspacePropertiesRequestWorkspaceProperties.userVolumeSizeGib) &&
        Objects.equals(this.computeTypeName, modifyWorkspacePropertiesRequestWorkspaceProperties.computeTypeName) &&
        Objects.equals(this.protocols, modifyWorkspacePropertiesRequestWorkspaceProperties.protocols);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModifyWorkspacePropertiesRequestWorkspaceProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModifyWorkspacePropertiesRequestWorkspaceProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModifyWorkspacePropertiesRequestWorkspaceProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModifyWorkspacePropertiesRequestWorkspaceProperties is not found in the empty JSON string", ModifyWorkspacePropertiesRequestWorkspaceProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifyWorkspacePropertiesRequestWorkspaceProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModifyWorkspacePropertiesRequestWorkspaceProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModifyWorkspacePropertiesRequestWorkspaceProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModifyWorkspacePropertiesRequestWorkspaceProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModifyWorkspacePropertiesRequestWorkspaceProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModifyWorkspacePropertiesRequestWorkspaceProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ModifyWorkspacePropertiesRequestWorkspaceProperties>() {
           @Override
           public void write(JsonWriter out, ModifyWorkspacePropertiesRequestWorkspaceProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModifyWorkspacePropertiesRequestWorkspaceProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModifyWorkspacePropertiesRequestWorkspaceProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModifyWorkspacePropertiesRequestWorkspaceProperties
   * @throws IOException if the JSON string is invalid with respect to ModifyWorkspacePropertiesRequestWorkspaceProperties
   */
  public static ModifyWorkspacePropertiesRequestWorkspaceProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModifyWorkspacePropertiesRequestWorkspaceProperties.class);
  }

  /**
   * Convert an instance of ModifyWorkspacePropertiesRequestWorkspaceProperties to an JSON string
   *
   * @return JSON string
   */
