...
public class WorkspaceDirectoryWorkspaceAccessProperties {
  ...
  public WorkspaceDirectoryWorkspaceAccessProperties() {
  }

  public WorkspaceDirectoryWorkspaceAccessProperties deviceTypeWindows(AccessPropertyValue deviceTypeWindows) {
  ...
  public WorkspaceDirectoryWorkspaceAccessProperties deviceTypeOsx(AccessPropertyValue deviceTypeOsx) {
  ...
  public WorkspaceDirectoryWorkspaceAccessProperties deviceTypeWeb(AccessPropertyValue deviceTypeWeb) {
  ...
  public WorkspaceDirectoryWorkspaceAccessProperties deviceTypeIos(AccessPropertyValue deviceTypeIos) {
  ...
  public WorkspaceDirectoryWorkspaceAccessProperties deviceTypeAndroid(AccessPropertyValue deviceTypeAndroid) {
  ...
  public WorkspaceDirectoryWorkspaceAccessProperties deviceTypeChromeOs(AccessPropertyValue deviceTypeChromeOs) {
  ...
  public WorkspaceDirectoryWorkspaceAccessProperties deviceTypeZeroClient(AccessPropertyValue deviceTypeZeroClient) {
  ...
  public WorkspaceDirectoryWorkspaceAccessProperties deviceTypeLinux(AccessPropertyValue deviceTypeLinux) {
  ...
  public boolean equals(Object o) {
    ...
    WorkspaceDirectoryWorkspaceAccessProperties workspaceDirectoryWorkspaceAccessProperties = (WorkspaceDirectoryWorkspaceAccessProperties) o;
    return Objects.equals(this.deviceTypeWindows, workspaceDirectoryWorkspaceAccessProperties.deviceTypeWindows) &&
        Objects.equals(this.deviceTypeOsx, workspaceDirectoryWorkspaceAccessProperties.deviceTypeOsx) &&
        Objects.equals(this.deviceTypeWeb, workspaceDirectoryWorkspaceAccessProperties.deviceTypeWeb) &&
        Objects.equals(this.deviceTypeIos, workspaceDirectoryWorkspaceAccessProperties.deviceTypeIos) &&
        Objects.equals(this.deviceTypeAndroid, workspaceDirectoryWorkspaceAccessProperties.deviceTypeAndroid) &&
        Objects.equals(this.deviceTypeChromeOs, workspaceDirectoryWorkspaceAccessProperties.deviceTypeChromeOs) &&
        Objects.equals(this.deviceTypeZeroClient, workspaceDirectoryWorkspaceAccessProperties.deviceTypeZeroClient) &&
        Objects.equals(this.deviceTypeLinux, workspaceDirectoryWorkspaceAccessProperties.deviceTypeLinux);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkspaceDirectoryWorkspaceAccessProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WorkspaceDirectoryWorkspaceAccessProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkspaceDirectoryWorkspaceAccessProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkspaceDirectoryWorkspaceAccessProperties is not found in the empty JSON string", WorkspaceDirectoryWorkspaceAccessProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkspaceDirectoryWorkspaceAccessProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkspaceDirectoryWorkspaceAccessProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkspaceDirectoryWorkspaceAccessProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkspaceDirectoryWorkspaceAccessProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkspaceDirectoryWorkspaceAccessProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkspaceDirectoryWorkspaceAccessProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkspaceDirectoryWorkspaceAccessProperties>() {
           @Override
           public void write(JsonWriter out, WorkspaceDirectoryWorkspaceAccessProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkspaceDirectoryWorkspaceAccessProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WorkspaceDirectoryWorkspaceAccessProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WorkspaceDirectoryWorkspaceAccessProperties
   * @throws IOException if the JSON string is invalid with respect to WorkspaceDirectoryWorkspaceAccessProperties
   */
  public static WorkspaceDirectoryWorkspaceAccessProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkspaceDirectoryWorkspaceAccessProperties.class);
  }

  /**
   * Convert an instance of WorkspaceDirectoryWorkspaceAccessProperties to an JSON string
   *
   * @return JSON string
   */
