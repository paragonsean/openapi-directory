...
public class WorkspaceRequest {
  ...
  public WorkspaceRequest directoryId(String directoryId) {
  ...
  public WorkspaceRequest userName(String userName) {
  ...
  public WorkspaceRequest bundleId(String bundleId) {
  ...
  public WorkspaceRequest volumeEncryptionKey(String volumeEncryptionKey) {
  ...
  public WorkspaceRequest userVolumeEncryptionEnabled(Boolean userVolumeEncryptionEnabled) {
  ...
  public WorkspaceRequest rootVolumeEncryptionEnabled(Boolean rootVolumeEncryptionEnabled) {
  ...
  public WorkspaceRequest workspaceProperties(WorkspaceRequestWorkspaceProperties workspaceProperties) {
  ...
  public WorkspaceRequest tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.directoryId, workspaceRequest.directoryId) &&
        Objects.equals(this.userName, workspaceRequest.userName) &&
        Objects.equals(this.bundleId, workspaceRequest.bundleId) &&
        Objects.equals(this.volumeEncryptionKey, workspaceRequest.volumeEncryptionKey) &&
        Objects.equals(this.userVolumeEncryptionEnabled, workspaceRequest.userVolumeEncryptionEnabled) &&
        Objects.equals(this.rootVolumeEncryptionEnabled, workspaceRequest.rootVolumeEncryptionEnabled) &&
        Objects.equals(this.workspaceProperties, workspaceRequest.workspaceProperties) &&
        Objects.equals(this.tags, workspaceRequest.tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WorkspaceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkspaceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkspaceRequest is not found in the empty JSON string", WorkspaceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkspaceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkspaceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkspaceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkspaceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkspaceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkspaceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkspaceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkspaceRequest>() {
           @Override
           public void write(JsonWriter out, WorkspaceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkspaceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WorkspaceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WorkspaceRequest
   * @throws IOException if the JSON string is invalid with respect to WorkspaceRequest
   */
  public static WorkspaceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkspaceRequest.class);
  }

  /**
   * Convert an instance of WorkspaceRequest to an JSON string
   *
   * @return JSON string
   */
