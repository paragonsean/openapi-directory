 ...
 */
@JsonAdapter(RunningMode.Adapter.class)
public enum RunningMode {
  ...
  public static class Adapter extends TypeAdapter<RunningMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final RunningMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RunningMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RunningMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RunningMode.fromValue(value);
  }
}
