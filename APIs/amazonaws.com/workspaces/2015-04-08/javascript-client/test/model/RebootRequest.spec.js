...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.RebootRequest();
  });
  ...
  describe('RebootRequest', function() {
    it('should create an instance of RebootRequest', function() {
      // uncomment below and update the code to test RebootRequest
      //var instance = new AmazonWorkSpaces.RebootRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.RebootRequest);
    });
