...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DeleteClientBrandingRequest();
  });
  ...
  describe('DeleteClientBrandingRequest', function() {
    it('should create an instance of DeleteClientBrandingRequest', function() {
      // uncomment below and update the code to test DeleteClientBrandingRequest
      //var instance = new AmazonWorkSpaces.DeleteClientBrandingRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DeleteClientBrandingRequest);
    });
