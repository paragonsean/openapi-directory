...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.CopyWorkspaceImageResult();
  });
  ...
  describe('CopyWorkspaceImageResult', function() {
    it('should create an instance of CopyWorkspaceImageResult', function() {
      // uncomment below and update the code to test CopyWorkspaceImageResult
      //var instance = new AmazonWorkSpaces.CopyWorkspaceImageResult();
      //expect(instance).to.be.a(AmazonWorkSpaces.CopyWorkspaceImageResult);
    });
