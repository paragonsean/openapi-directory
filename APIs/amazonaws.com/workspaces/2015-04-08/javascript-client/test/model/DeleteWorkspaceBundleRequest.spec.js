...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DeleteWorkspaceBundleRequest();
  });
  ...
  describe('DeleteWorkspaceBundleRequest', function() {
    it('should create an instance of DeleteWorkspaceBundleRequest', function() {
      // uncomment below and update the code to test DeleteWorkspaceBundleRequest
      //var instance = new AmazonWorkSpaces.DeleteWorkspaceBundleRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DeleteWorkspaceBundleRequest);
    });
