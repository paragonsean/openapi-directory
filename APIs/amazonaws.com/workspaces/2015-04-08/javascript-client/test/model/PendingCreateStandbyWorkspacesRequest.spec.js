...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.PendingCreateStandbyWorkspacesRequest();
  });
  ...
  describe('PendingCreateStandbyWorkspacesRequest', function() {
    it('should create an instance of PendingCreateStandbyWorkspacesRequest', function() {
      // uncomment below and update the code to test PendingCreateStandbyWorkspacesRequest
      //var instance = new AmazonWorkSpaces.PendingCreateStandbyWorkspacesRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.PendingCreateStandbyWorkspacesRequest);
    });
