...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeClientBrandingResult();
  });
  ...
  describe('DescribeClientBrandingResult', function() {
    it('should create an instance of DescribeClientBrandingResult', function() {
      // uncomment below and update the code to test DescribeClientBrandingResult
      //var instance = new AmazonWorkSpaces.DescribeClientBrandingResult();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeClientBrandingResult);
    });
