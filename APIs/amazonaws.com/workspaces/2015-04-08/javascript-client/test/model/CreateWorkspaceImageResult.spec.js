...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.CreateWorkspaceImageResult();
  });
  ...
  describe('CreateWorkspaceImageResult', function() {
    it('should create an instance of CreateWorkspaceImageResult', function() {
      // uncomment below and update the code to test CreateWorkspaceImageResult
      //var instance = new AmazonWorkSpaces.CreateWorkspaceImageResult();
      //expect(instance).to.be.a(AmazonWorkSpaces.CreateWorkspaceImageResult);
    });
    ...
    it('should have the property requiredTenancy (base name: "RequiredTenancy")', function() {
      // uncomment below and update the code to test the property requiredTenancy
      //var instance = new AmazonWorkSpaces.CreateWorkspaceImageResult();
      //expect(instance).to.be();
    });
