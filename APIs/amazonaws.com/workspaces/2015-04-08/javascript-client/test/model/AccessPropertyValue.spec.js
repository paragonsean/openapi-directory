...
(function(root, factory) {
  ...
  describe('AccessPropertyValue', function() {
    it('should create an instance of AccessPropertyValue', function() {
      // uncomment below and update the code to test AccessPropertyValue
      //var instance = new AmazonWorkSpaces.AccessPropertyValue();
      //expect(instance).to.be.a(AmazonWorkSpaces.AccessPropertyValue);
    });
