...
(function(root, factory) {
  ...
  describe('WorkspaceState', function() {
    it('should create an instance of WorkspaceState', function() {
      // uncomment below and update the code to test WorkspaceState
      //var instance = new AmazonWorkSpaces.WorkspaceState();
      //expect(instance).to.be.a(AmazonWorkSpaces.WorkspaceState);
    });
