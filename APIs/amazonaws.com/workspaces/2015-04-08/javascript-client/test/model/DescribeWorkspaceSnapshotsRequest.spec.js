...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeWorkspaceSnapshotsRequest();
  });
  ...
  describe('DescribeWorkspaceSnapshotsRequest', function() {
    it('should create an instance of DescribeWorkspaceSnapshotsRequest', function() {
      // uncomment below and update the code to test DescribeWorkspaceSnapshotsRequest
      //var instance = new AmazonWorkSpaces.DescribeWorkspaceSnapshotsRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeWorkspaceSnapshotsRequest);
    });
