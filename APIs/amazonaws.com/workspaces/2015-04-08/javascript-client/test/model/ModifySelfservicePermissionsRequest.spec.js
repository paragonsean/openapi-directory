...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.ModifySelfservicePermissionsRequest();
  });
  ...
  describe('ModifySelfservicePermissionsRequest', function() {
    it('should create an instance of ModifySelfservicePermissionsRequest', function() {
      // uncomment below and update the code to test ModifySelfservicePermissionsRequest
      //var instance = new AmazonWorkSpaces.ModifySelfservicePermissionsRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.ModifySelfservicePermissionsRequest);
    });
