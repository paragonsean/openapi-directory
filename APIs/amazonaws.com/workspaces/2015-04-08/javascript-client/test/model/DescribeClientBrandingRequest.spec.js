...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeClientBrandingRequest();
  });
  ...
  describe('DescribeClientBrandingRequest', function() {
    it('should create an instance of DescribeClientBrandingRequest', function() {
      // uncomment below and update the code to test DescribeClientBrandingRequest
      //var instance = new AmazonWorkSpaces.DescribeClientBrandingRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeClientBrandingRequest);
    });
