...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.WorkspaceBundleUserStorage();
  });
  ...
  describe('WorkspaceBundleUserStorage', function() {
    it('should create an instance of WorkspaceBundleUserStorage', function() {
      // uncomment below and update the code to test WorkspaceBundleUserStorage
      //var instance = new AmazonWorkSpaces.WorkspaceBundleUserStorage();
      //expect(instance).to.be.a(AmazonWorkSpaces.WorkspaceBundleUserStorage);
    });
