...
(function(root, factory) {
  ...
  describe('LogUploadEnum', function() {
    it('should create an instance of LogUploadEnum', function() {
      // uncomment below and update the code to test LogUploadEnum
      //var instance = new AmazonWorkSpaces.LogUploadEnum();
      //expect(instance).to.be.a(AmazonWorkSpaces.LogUploadEnum);
    });
