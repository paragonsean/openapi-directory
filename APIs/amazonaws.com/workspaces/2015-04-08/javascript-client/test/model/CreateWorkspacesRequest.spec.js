...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.CreateWorkspacesRequest();
  });
  ...
  describe('CreateWorkspacesRequest', function() {
    it('should create an instance of CreateWorkspacesRequest', function() {
      // uncomment below and update the code to test CreateWorkspacesRequest
      //var instance = new AmazonWorkSpaces.CreateWorkspacesRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.CreateWorkspacesRequest);
    });
