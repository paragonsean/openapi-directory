...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.FailedWorkspaceChangeRequest();
  });
  ...
  describe('FailedWorkspaceChangeRequest', function() {
    it('should create an instance of FailedWorkspaceChangeRequest', function() {
      // uncomment below and update the code to test FailedWorkspaceChangeRequest
      //var instance = new AmazonWorkSpaces.FailedWorkspaceChangeRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.FailedWorkspaceChangeRequest);
    });
