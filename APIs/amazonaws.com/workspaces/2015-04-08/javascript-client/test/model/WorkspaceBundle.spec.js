...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.WorkspaceBundle();
  });
  ...
  describe('WorkspaceBundle', function() {
    it('should create an instance of WorkspaceBundle', function() {
      // uncomment below and update the code to test WorkspaceBundle
      //var instance = new AmazonWorkSpaces.WorkspaceBundle();
      //expect(instance).to.be.a(AmazonWorkSpaces.WorkspaceBundle);
    });
    ...
    it('should have the property rootStorage (base name: "RootStorage")', function() {
      // uncomment below and update the code to test the property rootStorage
      //var instance = new AmazonWorkSpaces.WorkspaceBundle();
      //expect(instance).to.be();
    });

    it('should have the property userStorage (base name: "UserStorage")', function() {
      // uncomment below and update the code to test the property userStorage
      //var instance = new AmazonWorkSpaces.WorkspaceBundle();
      //expect(instance).to.be();
    });
