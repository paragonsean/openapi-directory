...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.CreateConnectClientAddInRequest();
  });
  ...
  describe('CreateConnectClientAddInRequest', function() {
    it('should create an instance of CreateConnectClientAddInRequest', function() {
      // uncomment below and update the code to test CreateConnectClientAddInRequest
      //var instance = new AmazonWorkSpaces.CreateConnectClientAddInRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.CreateConnectClientAddInRequest);
    });
