...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.CreateTagsRequest();
  });
  ...
  describe('CreateTagsRequest', function() {
    it('should create an instance of CreateTagsRequest', function() {
      ...
      //var instance = new AmazonWorkSpaces.CreateTagsRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.CreateTagsRequest);
    });
