...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeWorkspaceImagesResult();
  });
  ...
  describe('DescribeWorkspaceImagesResult', function() {
    it('should create an instance of DescribeWorkspaceImagesResult', function() {
      // uncomment below and update the code to test DescribeWorkspaceImagesResult
      //var instance = new AmazonWorkSpaces.DescribeWorkspaceImagesResult();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeWorkspaceImagesResult);
    });
