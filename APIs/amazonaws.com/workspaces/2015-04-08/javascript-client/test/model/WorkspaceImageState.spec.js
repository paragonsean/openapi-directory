...
(function(root, factory) {
  ...
  describe('WorkspaceImageState', function() {
    it('should create an instance of WorkspaceImageState', function() {
      // uncomment below and update the code to test WorkspaceImageState
      //var instance = new AmazonWorkSpaces.WorkspaceImageState();
      //expect(instance).to.be.a(AmazonWorkSpaces.WorkspaceImageState);
    });
