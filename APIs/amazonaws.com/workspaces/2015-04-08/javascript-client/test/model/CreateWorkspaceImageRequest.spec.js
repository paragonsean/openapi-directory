...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.CreateWorkspaceImageRequest();
  });
  ...
  describe('CreateWorkspaceImageRequest', function() {
    it('should create an instance of CreateWorkspaceImageRequest', function() {
      // uncomment below and update the code to test CreateWorkspaceImageRequest
      //var instance = new AmazonWorkSpaces.CreateWorkspaceImageRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.CreateWorkspaceImageRequest);
    });
