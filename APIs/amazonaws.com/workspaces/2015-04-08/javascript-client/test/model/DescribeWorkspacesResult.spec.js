...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeWorkspacesResult();
  });
  ...
  describe('DescribeWorkspacesResult', function() {
    it('should create an instance of DescribeWorkspacesResult', function() {
      // uncomment below and update the code to test DescribeWorkspacesResult
      //var instance = new AmazonWorkSpaces.DescribeWorkspacesResult();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeWorkspacesResult);
    });
