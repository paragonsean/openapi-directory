...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeWorkspacesRequest();
  });
  ...
  describe('DescribeWorkspacesRequest', function() {
    it('should create an instance of DescribeWorkspacesRequest', function() {
      // uncomment below and update the code to test DescribeWorkspacesRequest
      //var instance = new AmazonWorkSpaces.DescribeWorkspacesRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeWorkspacesRequest);
    });
