...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeTagsRequest();
  });
  ...
  describe('DescribeTagsRequest', function() {
    it('should create an instance of DescribeTagsRequest', function() {
      // uncomment below and update the code to test DescribeTagsRequest
      //var instance = new AmazonWorkSpaces.DescribeTagsRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeTagsRequest);
    });
