...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.UserStorage();
  });
  ...
  describe('UserStorage', function() {
    it('should create an instance of UserStorage', function() {
      // uncomment below and update the code to test UserStorage
      //var instance = new AmazonWorkSpaces.UserStorage();
      //expect(instance).to.be.a(AmazonWorkSpaces.UserStorage);
    });
