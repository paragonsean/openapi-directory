...
(function(root, factory) {
  ...
  describe('ReconnectEnum', function() {
    it('should create an instance of ReconnectEnum', function() {
      // uncomment below and update the code to test ReconnectEnum
      //var instance = new AmazonWorkSpaces.ReconnectEnum();
      //expect(instance).to.be.a(AmazonWorkSpaces.ReconnectEnum);
    });
