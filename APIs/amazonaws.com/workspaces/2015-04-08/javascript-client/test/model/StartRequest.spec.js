...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.StartRequest();
  });
  ...
  describe('StartRequest', function() {
    it('should create an instance of StartRequest', function() {
      // uncomment below and update the code to test StartRequest
      //var instance = new AmazonWorkSpaces.StartRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.StartRequest);
    });
