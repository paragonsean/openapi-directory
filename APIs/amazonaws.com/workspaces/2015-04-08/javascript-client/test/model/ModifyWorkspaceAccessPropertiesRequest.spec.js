...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.ModifyWorkspaceAccessPropertiesRequest();
  });
  ...
  describe('ModifyWorkspaceAccessPropertiesRequest', function() {
    it('should create an instance of ModifyWorkspaceAccessPropertiesRequest', function() {
      // uncomment below and update the code to test ModifyWorkspaceAccessPropertiesRequest
      //var instance = new AmazonWorkSpaces.ModifyWorkspaceAccessPropertiesRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.ModifyWorkspaceAccessPropertiesRequest);
    });
