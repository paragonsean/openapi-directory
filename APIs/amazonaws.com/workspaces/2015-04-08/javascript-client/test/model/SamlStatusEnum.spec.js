...
(function(root, factory) {
  ...
  describe('SamlStatusEnum', function() {
    it('should create an instance of SamlStatusEnum', function() {
      // uncomment below and update the code to test SamlStatusEnum
      //var instance = new AmazonWorkSpaces.SamlStatusEnum();
      //expect(instance).to.be.a(AmazonWorkSpaces.SamlStatusEnum);
    });
