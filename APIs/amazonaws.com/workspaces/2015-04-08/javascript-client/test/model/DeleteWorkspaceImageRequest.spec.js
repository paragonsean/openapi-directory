...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DeleteWorkspaceImageRequest();
  });
  ...
  describe('DeleteWorkspaceImageRequest', function() {
    it('should create an instance of DeleteWorkspaceImageRequest', function() {
      // uncomment below and update the code to test DeleteWorkspaceImageRequest
      //var instance = new AmazonWorkSpaces.DeleteWorkspaceImageRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DeleteWorkspaceImageRequest);
    });
