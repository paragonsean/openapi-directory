...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeWorkspaceBundlesResult();
  });
  ...
  describe('DescribeWorkspaceBundlesResult', function() {
    it('should create an instance of DescribeWorkspaceBundlesResult', function() {
      // uncomment below and update the code to test DescribeWorkspaceBundlesResult
      //var instance = new AmazonWorkSpaces.DescribeWorkspaceBundlesResult();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeWorkspaceBundlesResult);
    });
