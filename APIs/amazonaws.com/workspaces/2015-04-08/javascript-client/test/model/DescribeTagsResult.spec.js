...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeTagsResult();
  });
  ...
  describe('DescribeTagsResult', function() {
    it('should create an instance of DescribeTagsResult', function() {
      ...
      //var instance = new AmazonWorkSpaces.DescribeTagsResult();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeTagsResult);
    });
