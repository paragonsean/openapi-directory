...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.WorkspaceDirectoryWorkspaceAccessProperties();
  });
  ...
  describe('WorkspaceDirectoryWorkspaceAccessProperties', function() {
    it('should create an instance of WorkspaceDirectoryWorkspaceAccessProperties', function() {
      // uncomment below and update the code to test WorkspaceDirectoryWorkspaceAccessProperties
      //var instance = new AmazonWorkSpaces.WorkspaceDirectoryWorkspaceAccessProperties();
      //expect(instance).to.be.a(AmazonWorkSpaces.WorkspaceDirectoryWorkspaceAccessProperties);
    });
