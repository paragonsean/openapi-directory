...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.WorkspaceAccessProperties();
  });
  ...
  describe('WorkspaceAccessProperties', function() {
    it('should create an instance of WorkspaceAccessProperties', function() {
      // uncomment below and update the code to test WorkspaceAccessProperties
      //var instance = new AmazonWorkSpaces.WorkspaceAccessProperties();
      //expect(instance).to.be.a(AmazonWorkSpaces.WorkspaceAccessProperties);
    });
