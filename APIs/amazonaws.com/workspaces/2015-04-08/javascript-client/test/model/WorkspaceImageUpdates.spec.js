...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.WorkspaceImageUpdates();
  });
  ...
  describe('WorkspaceImageUpdates', function() {
    it('should create an instance of WorkspaceImageUpdates', function() {
      // uncomment below and update the code to test WorkspaceImageUpdates
      //var instance = new AmazonWorkSpaces.WorkspaceImageUpdates();
      //expect(instance).to.be.a(AmazonWorkSpaces.WorkspaceImageUpdates);
    });
