...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.RelatedWorkspaceProperties();
  });
  ...
  describe('RelatedWorkspaceProperties', function() {
    it('should create an instance of RelatedWorkspaceProperties', function() {
      // uncomment below and update the code to test RelatedWorkspaceProperties
      //var instance = new AmazonWorkSpaces.RelatedWorkspaceProperties();
      //expect(instance).to.be.a(AmazonWorkSpaces.RelatedWorkspaceProperties);
    });
