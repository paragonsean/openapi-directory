...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeWorkspaceImagePermissionsRequest();
  });
  ...
  describe('DescribeWorkspaceImagePermissionsRequest', function() {
    it('should create an instance of DescribeWorkspaceImagePermissionsRequest', function() {
      // uncomment below and update the code to test DescribeWorkspaceImagePermissionsRequest
      //var instance = new AmazonWorkSpaces.DescribeWorkspaceImagePermissionsRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeWorkspaceImagePermissionsRequest);
    });
