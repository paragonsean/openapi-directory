...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DisassociateIpGroupsRequest();
  });
  ...
  describe('DisassociateIpGroupsRequest', function() {
    it('should create an instance of DisassociateIpGroupsRequest', function() {
      // uncomment below and update the code to test DisassociateIpGroupsRequest
      //var instance = new AmazonWorkSpaces.DisassociateIpGroupsRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DisassociateIpGroupsRequest);
    });
