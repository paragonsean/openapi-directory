...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.AssociateIpGroupsRequest();
  });
  ...
  describe('AssociateIpGroupsRequest', function() {
    it('should create an instance of AssociateIpGroupsRequest', function() {
      // uncomment below and update the code to test AssociateIpGroupsRequest
      //var instance = new AmazonWorkSpaces.AssociateIpGroupsRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.AssociateIpGroupsRequest);
    });
