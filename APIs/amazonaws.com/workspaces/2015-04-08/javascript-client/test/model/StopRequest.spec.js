...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.StopRequest();
  });
  ...
  describe('StopRequest', function() {
    it('should create an instance of StopRequest', function() {
      // uncomment below and update the code to test StopRequest
      //var instance = new AmazonWorkSpaces.StopRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.StopRequest);
    });
