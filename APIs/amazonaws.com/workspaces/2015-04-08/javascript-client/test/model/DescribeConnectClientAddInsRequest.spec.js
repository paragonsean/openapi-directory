...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeConnectClientAddInsRequest();
  });
  ...
  describe('DescribeConnectClientAddInsRequest', function() {
    it('should create an instance of DescribeConnectClientAddInsRequest', function() {
      // uncomment below and update the code to test DescribeConnectClientAddInsRequest
      //var instance = new AmazonWorkSpaces.DescribeConnectClientAddInsRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeConnectClientAddInsRequest);
    });
