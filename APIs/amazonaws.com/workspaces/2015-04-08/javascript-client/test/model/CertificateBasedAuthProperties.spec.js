...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.CertificateBasedAuthProperties();
  });
  ...
  describe('CertificateBasedAuthProperties', function() {
    it('should create an instance of CertificateBasedAuthProperties', function() {
      // uncomment below and update the code to test CertificateBasedAuthProperties
      //var instance = new AmazonWorkSpaces.CertificateBasedAuthProperties();
      //expect(instance).to.be.a(AmazonWorkSpaces.CertificateBasedAuthProperties);
    });
