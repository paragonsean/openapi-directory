...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.ModifySamlPropertiesRequest();
  });
  ...
  describe('ModifySamlPropertiesRequest', function() {
    it('should create an instance of ModifySamlPropertiesRequest', function() {
      // uncomment below and update the code to test ModifySamlPropertiesRequest
      //var instance = new AmazonWorkSpaces.ModifySamlPropertiesRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.ModifySamlPropertiesRequest);
    });
    ...
    it('should have the property propertiesToDelete (base name: "PropertiesToDelete")', function() {
      // uncomment below and update the code to test the property propertiesToDelete
      //var instance = new AmazonWorkSpaces.ModifySamlPropertiesRequest();
      //expect(instance).to.be();
    });
