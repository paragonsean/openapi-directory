...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.ImportClientBrandingResult();
  });
  ...
  describe('ImportClientBrandingResult', function() {
    it('should create an instance of ImportClientBrandingResult', function() {
      // uncomment below and update the code to test ImportClientBrandingResult
      //var instance = new AmazonWorkSpaces.ImportClientBrandingResult();
      //expect(instance).to.be.a(AmazonWorkSpaces.ImportClientBrandingResult);
    });
