...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.RebuildRequest();
  });
  ...
  describe('RebuildRequest', function() {
    it('should create an instance of RebuildRequest', function() {
      // uncomment below and update the code to test RebuildRequest
      //var instance = new AmazonWorkSpaces.RebuildRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.RebuildRequest);
    });
