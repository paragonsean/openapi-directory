...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.UpdateWorkspaceBundleRequest();
  });
  ...
  describe('UpdateWorkspaceBundleRequest', function() {
    it('should create an instance of UpdateWorkspaceBundleRequest', function() {
      // uncomment below and update the code to test UpdateWorkspaceBundleRequest
      //var instance = new AmazonWorkSpaces.UpdateWorkspaceBundleRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.UpdateWorkspaceBundleRequest);
    });
