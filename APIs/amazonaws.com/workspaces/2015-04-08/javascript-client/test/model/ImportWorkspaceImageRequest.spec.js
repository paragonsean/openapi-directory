...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.ImportWorkspaceImageRequest();
  });
  ...
  describe('ImportWorkspaceImageRequest', function() {
    it('should create an instance of ImportWorkspaceImageRequest', function() {
      // uncomment below and update the code to test ImportWorkspaceImageRequest
      //var instance = new AmazonWorkSpaces.ImportWorkspaceImageRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.ImportWorkspaceImageRequest);
    });
    ...
    it('should have the property ingestionProcess (base name: "IngestionProcess")', function() {
      // uncomment below and update the code to test the property ingestionProcess
      //var instance = new AmazonWorkSpaces.ImportWorkspaceImageRequest();
      //expect(instance).to.be();
    });
