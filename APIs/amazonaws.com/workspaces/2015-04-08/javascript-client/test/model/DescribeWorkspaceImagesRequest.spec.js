...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeWorkspaceImagesRequest();
  });
  ...
  describe('DescribeWorkspaceImagesRequest', function() {
    it('should create an instance of DescribeWorkspaceImagesRequest', function() {
      // uncomment below and update the code to test DescribeWorkspaceImagesRequest
      //var instance = new AmazonWorkSpaces.DescribeWorkspaceImagesRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeWorkspaceImagesRequest);
    });
