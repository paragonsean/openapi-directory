...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.ModifyWorkspaceCreationPropertiesRequest();
  });
  ...
  describe('ModifyWorkspaceCreationPropertiesRequest', function() {
    it('should create an instance of ModifyWorkspaceCreationPropertiesRequest', function() {
      // uncomment below and update the code to test ModifyWorkspaceCreationPropertiesRequest
      //var instance = new AmazonWorkSpaces.ModifyWorkspaceCreationPropertiesRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.ModifyWorkspaceCreationPropertiesRequest);
    });
