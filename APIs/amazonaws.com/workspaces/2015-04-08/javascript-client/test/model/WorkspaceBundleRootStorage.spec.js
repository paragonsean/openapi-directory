...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.WorkspaceBundleRootStorage();
  });
  ...
  describe('WorkspaceBundleRootStorage', function() {
    it('should create an instance of WorkspaceBundleRootStorage', function() {
      // uncomment below and update the code to test WorkspaceBundleRootStorage
      //var instance = new AmazonWorkSpaces.WorkspaceBundleRootStorage();
      //expect(instance).to.be.a(AmazonWorkSpaces.WorkspaceBundleRootStorage);
    });
