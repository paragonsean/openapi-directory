...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeConnectionAliasesRequest();
  });
  ...
  describe('DescribeConnectionAliasesRequest', function() {
    it('should create an instance of DescribeConnectionAliasesRequest', function() {
      // uncomment below and update the code to test DescribeConnectionAliasesRequest
      //var instance = new AmazonWorkSpaces.DescribeConnectionAliasesRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeConnectionAliasesRequest);
    });

    it('should have the property aliasIds (base name: "AliasIds")', function() {
      // uncomment below and update the code to test the property aliasIds
      //var instance = new AmazonWorkSpaces.DescribeConnectionAliasesRequest();
