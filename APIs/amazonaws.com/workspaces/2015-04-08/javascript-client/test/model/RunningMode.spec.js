...
(function(root, factory) {
  ...
  describe('RunningMode', function() {
    it('should create an instance of RunningMode', function() {
      // uncomment below and update the code to test RunningMode
      //var instance = new AmazonWorkSpaces.RunningMode();
      //expect(instance).to.be.a(AmazonWorkSpaces.RunningMode);
    });
