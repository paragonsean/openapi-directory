...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeIpGroupsResult();
  });
  ...
  describe('DescribeIpGroupsResult', function() {
    it('should create an instance of DescribeIpGroupsResult', function() {
      // uncomment below and update the code to test DescribeIpGroupsResult
      //var instance = new AmazonWorkSpaces.DescribeIpGroupsResult();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeIpGroupsResult);
    });
