...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.RestoreWorkspaceRequest();
  });
  ...
  describe('RestoreWorkspaceRequest', function() {
    it('should create an instance of RestoreWorkspaceRequest', function() {
      // uncomment below and update the code to test RestoreWorkspaceRequest
      //var instance = new AmazonWorkSpaces.RestoreWorkspaceRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.RestoreWorkspaceRequest);
    });
