...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.TerminateRequest();
  });
  ...
  describe('TerminateRequest', function() {
    it('should create an instance of TerminateRequest', function() {
      // uncomment below and update the code to test TerminateRequest
      //var instance = new AmazonWorkSpaces.TerminateRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.TerminateRequest);
    });
