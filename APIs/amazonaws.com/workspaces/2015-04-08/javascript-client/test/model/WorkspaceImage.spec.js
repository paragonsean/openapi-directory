...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.WorkspaceImage();
  });
  ...
  describe('WorkspaceImage', function() {
    it('should create an instance of WorkspaceImage', function() {
      // uncomment below and update the code to test WorkspaceImage
      //var instance = new AmazonWorkSpaces.WorkspaceImage();
      //expect(instance).to.be.a(AmazonWorkSpaces.WorkspaceImage);
    });
