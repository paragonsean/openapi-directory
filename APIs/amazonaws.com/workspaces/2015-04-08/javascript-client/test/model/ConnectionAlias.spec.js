...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.ConnectionAlias();
  });
  ...
  describe('ConnectionAlias', function() {
    it('should create an instance of ConnectionAlias', function() {
      // uncomment below and update the code to test ConnectionAlias
      //var instance = new AmazonWorkSpaces.ConnectionAlias();
      //expect(instance).to.be.a(AmazonWorkSpaces.ConnectionAlias);
    });
