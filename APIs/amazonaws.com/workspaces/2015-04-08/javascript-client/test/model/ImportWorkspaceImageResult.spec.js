...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.ImportWorkspaceImageResult();
  });
  ...
  describe('ImportWorkspaceImageResult', function() {
    it('should create an instance of ImportWorkspaceImageResult', function() {
      // uncomment below and update the code to test ImportWorkspaceImageResult
      //var instance = new AmazonWorkSpaces.ImportWorkspaceImageResult();
      //expect(instance).to.be.a(AmazonWorkSpaces.ImportWorkspaceImageResult);
    });
