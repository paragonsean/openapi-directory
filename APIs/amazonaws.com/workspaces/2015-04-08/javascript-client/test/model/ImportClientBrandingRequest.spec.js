...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.ImportClientBrandingRequest();
  });
  ...
  describe('ImportClientBrandingRequest', function() {
    it('should create an instance of ImportClientBrandingRequest', function() {
      // uncomment below and update the code to test ImportClientBrandingRequest
      //var instance = new AmazonWorkSpaces.ImportClientBrandingRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.ImportClientBrandingRequest);
    });
