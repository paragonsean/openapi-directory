...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.CreateConnectionAliasRequest();
  });
  ...
  describe('CreateConnectionAliasRequest', function() {
    it('should create an instance of CreateConnectionAliasRequest', function() {
      // uncomment below and update the code to test CreateConnectionAliasRequest
      //var instance = new AmazonWorkSpaces.CreateConnectionAliasRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.CreateConnectionAliasRequest);
    });
