...
(function(root, factory) {
  ...
  describe('BundleType', function() {
    it('should create an instance of BundleType', function() {
      // uncomment below and update the code to test BundleType
      //var instance = new AmazonWorkSpaces.BundleType();
      //expect(instance).to.be.a(AmazonWorkSpaces.BundleType);
    });
