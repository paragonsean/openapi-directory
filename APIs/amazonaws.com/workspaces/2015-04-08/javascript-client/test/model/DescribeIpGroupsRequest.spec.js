...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.DescribeIpGroupsRequest();
  });
  ...
  describe('DescribeIpGroupsRequest', function() {
    it('should create an instance of DescribeIpGroupsRequest', function() {
      // uncomment below and update the code to test DescribeIpGroupsRequest
      //var instance = new AmazonWorkSpaces.DescribeIpGroupsRequest();
      //expect(instance).to.be.a(AmazonWorkSpaces.DescribeIpGroupsRequest);
    });
