...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.OperatingSystem();
  });
  ...
  describe('OperatingSystem', function() {
    it('should create an instance of OperatingSystem', function() {
      ...
      //var instance = new AmazonWorkSpaces.OperatingSystem();
      //expect(instance).to.be.a(AmazonWorkSpaces.OperatingSystem);
    });
