...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonWorkSpaces.ModificationState();
  });
  ...
  describe('ModificationState', function() {
    it('should create an instance of ModificationState', function() {
      // uncomment below and update the code to test ModificationState
      //var instance = new AmazonWorkSpaces.ModificationState();
      //expect(instance).to.be.a(AmazonWorkSpaces.ModificationState);
    });
