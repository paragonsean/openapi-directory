...
* @readonly
*/
export default class WorkspaceImageState {
    ...
    /**
    * Returns a <code>WorkspaceImageState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/WorkspaceImageState} The enum <code>WorkspaceImageState</code> value.
    */
