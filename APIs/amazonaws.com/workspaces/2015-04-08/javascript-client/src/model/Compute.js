...
export default class Compute {
    ...
    /**
    * Returns a <code>Compute</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/Compute} The enum <code>Compute</code> value.
    */
