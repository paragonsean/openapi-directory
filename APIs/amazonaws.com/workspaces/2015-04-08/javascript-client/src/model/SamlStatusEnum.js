...
* @readonly
*/
export default class SamlStatusEnum {
        ...
        /**
         * value: "ENABLED_WITH_DIRECTORY_LOGIN_FALLBACK"
         * @const
         */
    ...
    /**
    * Returns a <code>SamlStatusEnum</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SamlStatusEnum} The enum <code>SamlStatusEnum</code> value.
    */
