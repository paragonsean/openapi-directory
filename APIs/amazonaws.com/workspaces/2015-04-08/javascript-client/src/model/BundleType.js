...
* @readonly
*/
export default class BundleType {
    ...
    /**
    * Returns a <code>BundleType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/BundleType} The enum <code>BundleType</code> value.
    */
