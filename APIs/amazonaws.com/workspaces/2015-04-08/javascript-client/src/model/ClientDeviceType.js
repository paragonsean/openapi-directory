...
export default class ClientDeviceType {
    ...
    /**
    * Returns a <code>ClientDeviceType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ClientDeviceType} The enum <code>ClientDeviceType</code> value.
    */
