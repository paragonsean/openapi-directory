...
* @readonly
*/
export default class ModificationResourceEnum {
    ...
    /**
    * Returns a <code>ModificationResourceEnum</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ModificationResourceEnum} The enum <code>ModificationResourceEnum</code> value.
    */
