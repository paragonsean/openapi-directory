...
export default class AssociationStatus {
    ...
    /**
    * Returns a <code>AssociationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AssociationStatus} The enum <code>AssociationStatus</code> value.
    */
