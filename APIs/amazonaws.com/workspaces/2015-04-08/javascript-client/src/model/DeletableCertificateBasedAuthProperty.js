...
* @readonly
*/
export default class DeletableCertificateBasedAuthProperty {
    
        /**
         * value: "CERTIFICATE_BASED_AUTH_PROPERTIES_CERTIFICATE_AUTHORITY_ARN"
         * @const
         */
    ...
    /**
    * Returns a <code>DeletableCertificateBasedAuthProperty</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DeletableCertificateBasedAuthProperty} The enum <code>DeletableCertificateBasedAuthProperty</code> value.
    */
