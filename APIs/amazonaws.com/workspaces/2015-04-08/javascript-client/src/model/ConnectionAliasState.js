...
* @readonly
*/
export default class ConnectionAliasState {
    ...
    /**
    * Returns a <code>ConnectionAliasState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ConnectionAliasState} The enum <code>ConnectionAliasState</code> value.
    */
