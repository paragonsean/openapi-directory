...
* @readonly
*/
export default class AccessPropertyValue {
    ...
    /**
    * Returns a <code>AccessPropertyValue</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AccessPropertyValue} The enum <code>AccessPropertyValue</code> value.
    */
