...
* @readonly
*/
export default class DedicatedTenancySupportEnum {
    ...
    /**
    * Returns a <code>DedicatedTenancySupportEnum</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DedicatedTenancySupportEnum} The enum <code>DedicatedTenancySupportEnum</code> value.
    */
