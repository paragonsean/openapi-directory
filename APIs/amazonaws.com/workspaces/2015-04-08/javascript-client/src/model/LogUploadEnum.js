...
* @readonly
*/
export default class LogUploadEnum {
    ...
    /**
    * Returns a <code>LogUploadEnum</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/LogUploadEnum} The enum <code>LogUploadEnum</code> value.
    */
