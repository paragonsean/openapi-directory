...
* @readonly
*/
export default class WorkspaceDirectoryState {
    ...
    /**
    * Returns a <code>WorkspaceDirectoryState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/WorkspaceDirectoryState} The enum <code>WorkspaceDirectoryState</code> value.
    */
