...
* @readonly
*/
export default class ReconnectEnum {
    ...
    /**
    * Returns a <code>ReconnectEnum</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ReconnectEnum} The enum <code>ReconnectEnum</code> value.
    */
