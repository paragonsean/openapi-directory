...
* @readonly
*/
export default class ModificationStateEnum {
    
        /**
         * value: "UPDATE_INITIATED"
         * @const
         */
    ...
    /**
    * Returns a <code>ModificationStateEnum</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ModificationStateEnum} The enum <code>ModificationStateEnum</code> value.
    */
