...
* @readonly
*/
export default class WorkspaceBundleState {
    ...
    /**
    * Returns a <code>WorkspaceBundleState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/WorkspaceBundleState} The enum <code>WorkspaceBundleState</code> value.
    */
