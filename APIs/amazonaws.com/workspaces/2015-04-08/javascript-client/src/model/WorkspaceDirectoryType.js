...
* @readonly
*/
export default class WorkspaceDirectoryType {
    ...
    /**
    * Returns a <code>WorkspaceDirectoryType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/WorkspaceDirectoryType} The enum <code>WorkspaceDirectoryType</code> value.
    */
