...
/*
 * OAIUpdateSolNetworkPackageOutput.h
 *
 * 
 */

#ifndef OAIUpdateSolNetworkPackageOutput_H
#define OAIUpdateSolNetworkPackageOutput_H
...
class OAIUpdateSolNetworkPackageOutput : public OAIObject {
public:
    OAIUpdateSolNetworkPackageOutput();
    OAIUpdateSolNetworkPackageOutput(QString json);
    ~OAIUpdateSolNetworkPackageOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSolNetworkPackageOutput)

#endif // OAIUpdateSolNetworkPackageOutput_H
