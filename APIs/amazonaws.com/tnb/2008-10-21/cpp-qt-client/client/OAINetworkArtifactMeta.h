...
#ifndef OAINetworkArtifactMeta_H
#define OAINetworkArtifactMeta_H
...
class OAINetworkArtifactMeta : public OAIObject {
public:
    OAINetworkArtifactMeta();
    OAINetworkArtifactMeta(QString json);
    ~OAINetworkArtifactMeta() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkArtifactMeta)

#endif // OAINetworkArtifactMeta_H
