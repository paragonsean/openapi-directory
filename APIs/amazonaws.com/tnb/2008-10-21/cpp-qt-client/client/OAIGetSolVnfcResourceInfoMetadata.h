...
/*
 * OAIGetSolVnfcResourceInfoMetadata.h
 *
...
#ifndef OAIGetSolVnfcResourceInfoMetadata_H
#define OAIGetSolVnfcResourceInfoMetadata_H
...
class OAIGetSolVnfcResourceInfoMetadata : public OAIObject {
public:
    OAIGetSolVnfcResourceInfoMetadata();
    OAIGetSolVnfcResourceInfoMetadata(QString json);
    ~OAIGetSolVnfcResourceInfoMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSolVnfcResourceInfoMetadata)

#endif // OAIGetSolVnfcResourceInfoMetadata_H
