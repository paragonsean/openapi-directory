...
public class ApiClient {
    ...
    private String basePath = "http://tnb.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://tnb.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://tnb.{region}.amazonaws.com",
      "The AWS Telco Network Builder multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://tnb.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://tnb.{region}.amazonaws.com.cn",
      "The AWS Telco Network Builder endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2008-10-21/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://tnb.us-east-1.amazonaws.com
