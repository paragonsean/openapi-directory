...
class UpdateSolNetworkPackageOutput(Model):
    ...
    def __init__(self, nsd_operational_state: NsdOperationalState=None):
        """UpdateSolNetworkPackageOutput - a model defined in OpenAPI

        :param nsd_operational_state: The nsd_operational_state of this UpdateSolNetworkPackageOutput.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateSolNetworkPackageOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateSolNetworkPackageOutput of this UpdateSolNetworkPackageOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def nsd_operational_state(self):
        """Gets the nsd_operational_state of this UpdateSolNetworkPackageOutput.


        :return: The nsd_operational_state of this UpdateSolNetworkPackageOutput.
    ...
    def nsd_operational_state(self, nsd_operational_state):
        """Sets the nsd_operational_state of this UpdateSolNetworkPackageOutput.
