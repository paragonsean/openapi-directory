...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTelcoNetworkBuilder.ProblemDetails();
  });
  ...
  describe('ProblemDetails', function() {
    it('should create an instance of ProblemDetails', function() {
      ...
      //var instance = new AwsTelcoNetworkBuilder.ProblemDetails();
      //expect(instance).to.be.a(AwsTelcoNetworkBuilder.ProblemDetails);
    });
