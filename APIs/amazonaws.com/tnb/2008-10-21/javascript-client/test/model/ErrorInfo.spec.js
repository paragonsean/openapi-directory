...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTelcoNetworkBuilder.ErrorInfo();
  });
  ...
  describe('ErrorInfo', function() {
    it('should create an instance of ErrorInfo', function() {
      ...
      //var instance = new AwsTelcoNetworkBuilder.ErrorInfo();
      //expect(instance).to.be.a(AwsTelcoNetworkBuilder.ErrorInfo);
    });
