...
public class ListGatewaysInput {
  ...
  public ListGatewaysInput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public ListGatewaysInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListGatewaysInput listGatewaysInput = (ListGatewaysInput) o;
    return Objects.equals(this.marker, listGatewaysInput.marker) &&
        Objects.equals(this.limit, listGatewaysInput.limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListGatewaysInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListGatewaysInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListGatewaysInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListGatewaysInput is not found in the empty JSON string", ListGatewaysInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListGatewaysInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListGatewaysInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListGatewaysInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListGatewaysInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListGatewaysInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListGatewaysInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListGatewaysInput>() {
           @Override
           public void write(JsonWriter out, ListGatewaysInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListGatewaysInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListGatewaysInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListGatewaysInput
   * @throws IOException if the JSON string is invalid with respect to ListGatewaysInput
   */
  public static ListGatewaysInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListGatewaysInput.class);
  }

  /**
   * Convert an instance of ListGatewaysInput to an JSON string
   *
   * @return JSON string
   */
