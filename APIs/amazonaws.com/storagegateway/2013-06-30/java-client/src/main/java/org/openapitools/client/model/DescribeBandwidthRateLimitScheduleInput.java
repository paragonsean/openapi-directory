...
public class DescribeBandwidthRateLimitScheduleInput {
  ...
  public DescribeBandwidthRateLimitScheduleInput() {
  }

  public DescribeBandwidthRateLimitScheduleInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeBandwidthRateLimitScheduleInput describeBandwidthRateLimitScheduleInput = (DescribeBandwidthRateLimitScheduleInput) o;
    return Objects.equals(this.gatewayARN, describeBandwidthRateLimitScheduleInput.gatewayARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeBandwidthRateLimitScheduleInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeBandwidthRateLimitScheduleInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeBandwidthRateLimitScheduleInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeBandwidthRateLimitScheduleInput is not found in the empty JSON string", DescribeBandwidthRateLimitScheduleInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeBandwidthRateLimitScheduleInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeBandwidthRateLimitScheduleInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeBandwidthRateLimitScheduleInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeBandwidthRateLimitScheduleInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeBandwidthRateLimitScheduleInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeBandwidthRateLimitScheduleInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeBandwidthRateLimitScheduleInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeBandwidthRateLimitScheduleInput>() {
           @Override
           public void write(JsonWriter out, DescribeBandwidthRateLimitScheduleInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeBandwidthRateLimitScheduleInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeBandwidthRateLimitScheduleInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeBandwidthRateLimitScheduleInput
   * @throws IOException if the JSON string is invalid with respect to DescribeBandwidthRateLimitScheduleInput
   */
  public static DescribeBandwidthRateLimitScheduleInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeBandwidthRateLimitScheduleInput.class);
  }

  /**
   * Convert an instance of DescribeBandwidthRateLimitScheduleInput to an JSON string
   *
   * @return JSON string
   */
