...
public class DeleteVolumeInput {
  ...
  public DeleteVolumeInput() {
  }

  public DeleteVolumeInput volumeARN(String volumeARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteVolumeInput deleteVolumeInput = (DeleteVolumeInput) o;
    return Objects.equals(this.volumeARN, deleteVolumeInput.volumeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteVolumeInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteVolumeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteVolumeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteVolumeInput is not found in the empty JSON string", DeleteVolumeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteVolumeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteVolumeInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteVolumeInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteVolumeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteVolumeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteVolumeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteVolumeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteVolumeInput>() {
           @Override
           public void write(JsonWriter out, DeleteVolumeInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteVolumeInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteVolumeInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteVolumeInput
   * @throws IOException if the JSON string is invalid with respect to DeleteVolumeInput
   */
  public static DeleteVolumeInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteVolumeInput.class);
  }

  /**
   * Convert an instance of DeleteVolumeInput to an JSON string
   *
   * @return JSON string
   */
