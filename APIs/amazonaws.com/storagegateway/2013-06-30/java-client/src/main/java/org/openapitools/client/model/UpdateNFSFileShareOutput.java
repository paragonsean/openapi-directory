...
public class UpdateNFSFileShareOutput {
  ...
  public UpdateNFSFileShareOutput() {
  }

  public UpdateNFSFileShareOutput fileShareARN(String fileShareARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateNFSFileShareOutput updateNFSFileShareOutput = (UpdateNFSFileShareOutput) o;
    return Objects.equals(this.fileShareARN, updateNFSFileShareOutput.fileShareARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateNFSFileShareOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNFSFileShareOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNFSFileShareOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNFSFileShareOutput is not found in the empty JSON string", UpdateNFSFileShareOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNFSFileShareOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNFSFileShareOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNFSFileShareOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNFSFileShareOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNFSFileShareOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNFSFileShareOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNFSFileShareOutput>() {
           @Override
           public void write(JsonWriter out, UpdateNFSFileShareOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNFSFileShareOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNFSFileShareOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNFSFileShareOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateNFSFileShareOutput
   */
  public static UpdateNFSFileShareOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNFSFileShareOutput.class);
  }

  /**
   * Convert an instance of UpdateNFSFileShareOutput to an JSON string
   *
   * @return JSON string
   */
