...
public class ListTapePoolsInput {
  public static final String SERIALIZED_NAME_POOL_A_R_NS = "PoolARNs";
  @SerializedName(SERIALIZED_NAME_POOL_A_R_NS)
  private List poolARNs;
  ...
  public ListTapePoolsInput() {
  }

  public ListTapePoolsInput poolARNs(List poolARNs) {
    this.poolARNs = poolARNs;
    return this;
  }
  ...
  public List getPoolARNs() {
    return poolARNs;
  }

  public void setPoolARNs(List poolARNs) {
    this.poolARNs = poolARNs;
  }


  public ListTapePoolsInput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public ListTapePoolsInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListTapePoolsInput listTapePoolsInput = (ListTapePoolsInput) o;
    return Objects.equals(this.poolARNs, listTapePoolsInput.poolARNs) &&
        Objects.equals(this.marker, listTapePoolsInput.marker) &&
        Objects.equals(this.limit, listTapePoolsInput.limit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(poolARNs, marker, limit);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListTapePoolsInput {\n");
    sb.append("    poolARNs: ").append(toIndentedString(poolARNs)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListTapePoolsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListTapePoolsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListTapePoolsInput is not found in the empty JSON string", ListTapePoolsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListTapePoolsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListTapePoolsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `PoolARNs`
      if (jsonObj.get("PoolARNs") != null && !jsonObj.get("PoolARNs").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("PoolARNs"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListTapePoolsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListTapePoolsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListTapePoolsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListTapePoolsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListTapePoolsInput>() {
           @Override
           public void write(JsonWriter out, ListTapePoolsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListTapePoolsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListTapePoolsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListTapePoolsInput
   * @throws IOException if the JSON string is invalid with respect to ListTapePoolsInput
   */
  public static ListTapePoolsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTapePoolsInput.class);
  }

  /**
   * Convert an instance of ListTapePoolsInput to an JSON string
   *
   * @return JSON string
   */
