...
public class DeleteSnapshotScheduleOutput {
  ...
  public DeleteSnapshotScheduleOutput() {
  }

  public DeleteSnapshotScheduleOutput volumeARN(String volumeARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteSnapshotScheduleOutput deleteSnapshotScheduleOutput = (DeleteSnapshotScheduleOutput) o;
    return Objects.equals(this.volumeARN, deleteSnapshotScheduleOutput.volumeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteSnapshotScheduleOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSnapshotScheduleOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSnapshotScheduleOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteSnapshotScheduleOutput is not found in the empty JSON string", DeleteSnapshotScheduleOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSnapshotScheduleOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteSnapshotScheduleOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSnapshotScheduleOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSnapshotScheduleOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSnapshotScheduleOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSnapshotScheduleOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSnapshotScheduleOutput>() {
           @Override
           public void write(JsonWriter out, DeleteSnapshotScheduleOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSnapshotScheduleOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteSnapshotScheduleOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteSnapshotScheduleOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteSnapshotScheduleOutput
   */
  public static DeleteSnapshotScheduleOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteSnapshotScheduleOutput.class);
  }

  /**
   * Convert an instance of DeleteSnapshotScheduleOutput to an JSON string
   *
   * @return JSON string
   */
