...
public class DeleteBandwidthRateLimitOutput {
  ...
  public DeleteBandwidthRateLimitOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteBandwidthRateLimitOutput deleteBandwidthRateLimitOutput = (DeleteBandwidthRateLimitOutput) o;
    return Objects.equals(this.gatewayARN, deleteBandwidthRateLimitOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteBandwidthRateLimitOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteBandwidthRateLimitOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteBandwidthRateLimitOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteBandwidthRateLimitOutput is not found in the empty JSON string", DeleteBandwidthRateLimitOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteBandwidthRateLimitOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteBandwidthRateLimitOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteBandwidthRateLimitOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteBandwidthRateLimitOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteBandwidthRateLimitOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteBandwidthRateLimitOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteBandwidthRateLimitOutput>() {
           @Override
           public void write(JsonWriter out, DeleteBandwidthRateLimitOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteBandwidthRateLimitOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteBandwidthRateLimitOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteBandwidthRateLimitOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteBandwidthRateLimitOutput
   */
  public static DeleteBandwidthRateLimitOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteBandwidthRateLimitOutput.class);
  }

  /**
   * Convert an instance of DeleteBandwidthRateLimitOutput to an JSON string
   *
   * @return JSON string
   */
