...
/**
 * Gets or Sets AvailabilityMonitorTestStatus
 */
@JsonAdapter(AvailabilityMonitorTestStatus.Adapter.class)
public enum AvailabilityMonitorTestStatus {
  ...
  AvailabilityMonitorTestStatus(String value) {
    this.value = value;
  }
  ...
  public static AvailabilityMonitorTestStatus fromValue(String value) {
    for (AvailabilityMonitorTestStatus b : AvailabilityMonitorTestStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<AvailabilityMonitorTestStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AvailabilityMonitorTestStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AvailabilityMonitorTestStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AvailabilityMonitorTestStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AvailabilityMonitorTestStatus.fromValue(value);
  }
}
