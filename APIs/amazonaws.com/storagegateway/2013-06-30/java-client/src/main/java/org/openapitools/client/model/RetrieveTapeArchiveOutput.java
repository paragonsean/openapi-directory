...
public class RetrieveTapeArchiveOutput {
  ...
  public RetrieveTapeArchiveOutput() {
  }

  public RetrieveTapeArchiveOutput tapeARN(String tapeARN) {
  ...
  public boolean equals(Object o) {
    ...
    RetrieveTapeArchiveOutput retrieveTapeArchiveOutput = (RetrieveTapeArchiveOutput) o;
    return Objects.equals(this.tapeARN, retrieveTapeArchiveOutput.tapeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetrieveTapeArchiveOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetrieveTapeArchiveOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetrieveTapeArchiveOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetrieveTapeArchiveOutput is not found in the empty JSON string", RetrieveTapeArchiveOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetrieveTapeArchiveOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetrieveTapeArchiveOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetrieveTapeArchiveOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetrieveTapeArchiveOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetrieveTapeArchiveOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetrieveTapeArchiveOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<RetrieveTapeArchiveOutput>() {
           @Override
           public void write(JsonWriter out, RetrieveTapeArchiveOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetrieveTapeArchiveOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetrieveTapeArchiveOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetrieveTapeArchiveOutput
   * @throws IOException if the JSON string is invalid with respect to RetrieveTapeArchiveOutput
   */
  public static RetrieveTapeArchiveOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetrieveTapeArchiveOutput.class);
  }

  /**
   * Convert an instance of RetrieveTapeArchiveOutput to an JSON string
   *
   * @return JSON string
   */
