 ...
 */
@JsonAdapter(FileShareType.Adapter.class)
public enum FileShareType {
  ...
  public static FileShareType fromValue(String value) {
    for (FileShareType b : FileShareType.values()) {
  ...
  public static class Adapter extends TypeAdapter<FileShareType> {
    @Override
    public void write(final JsonWriter jsonWriter, final FileShareType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FileShareType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FileShareType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FileShareType.fromValue(value);
  }
}
