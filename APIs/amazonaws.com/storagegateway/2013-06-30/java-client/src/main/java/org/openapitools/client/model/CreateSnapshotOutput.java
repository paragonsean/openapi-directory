...
public class CreateSnapshotOutput {
  ...
  public CreateSnapshotOutput() {
  }

  public CreateSnapshotOutput volumeARN(String volumeARN) {
  ...
  public CreateSnapshotOutput snapshotId(String snapshotId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSnapshotOutput createSnapshotOutput = (CreateSnapshotOutput) o;
    return Objects.equals(this.volumeARN, createSnapshotOutput.volumeARN) &&
        Objects.equals(this.snapshotId, createSnapshotOutput.snapshotId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(volumeARN, snapshotId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateSnapshotOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSnapshotOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSnapshotOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSnapshotOutput is not found in the empty JSON string", CreateSnapshotOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSnapshotOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSnapshotOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSnapshotOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSnapshotOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSnapshotOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSnapshotOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSnapshotOutput>() {
           @Override
           public void write(JsonWriter out, CreateSnapshotOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSnapshotOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSnapshotOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSnapshotOutput
   * @throws IOException if the JSON string is invalid with respect to CreateSnapshotOutput
   */
  public static CreateSnapshotOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSnapshotOutput.class);
  }

  /**
   * Convert an instance of CreateSnapshotOutput to an JSON string
   *
   * @return JSON string
   */
