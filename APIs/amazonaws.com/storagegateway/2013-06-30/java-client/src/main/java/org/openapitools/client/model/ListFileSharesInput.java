...
public class ListFileSharesInput {
  ...
  public ListFileSharesInput() {
  }

  public ListFileSharesInput gatewayARN(String gatewayARN) {
  ...
  public ListFileSharesInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ListFileSharesInput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListFileSharesInput listFileSharesInput = (ListFileSharesInput) o;
    return Objects.equals(this.gatewayARN, listFileSharesInput.gatewayARN) &&
        Objects.equals(this.limit, listFileSharesInput.limit) &&
        Objects.equals(this.marker, listFileSharesInput.marker);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, limit, marker);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListFileSharesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFileSharesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFileSharesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFileSharesInput is not found in the empty JSON string", ListFileSharesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFileSharesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFileSharesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFileSharesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFileSharesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFileSharesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFileSharesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFileSharesInput>() {
           @Override
           public void write(JsonWriter out, ListFileSharesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFileSharesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListFileSharesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListFileSharesInput
   * @throws IOException if the JSON string is invalid with respect to ListFileSharesInput
   */
  public static ListFileSharesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListFileSharesInput.class);
  }

  /**
   * Convert an instance of ListFileSharesInput to an JSON string
   *
   * @return JSON string
   */
