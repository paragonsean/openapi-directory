...
public class DetachVolumeOutput {
  ...
  public DetachVolumeOutput() {
  }

  public DetachVolumeOutput volumeARN(String volumeARN) {
  ...
  public boolean equals(Object o) {
    ...
    DetachVolumeOutput detachVolumeOutput = (DetachVolumeOutput) o;
    return Objects.equals(this.volumeARN, detachVolumeOutput.volumeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetachVolumeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetachVolumeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetachVolumeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetachVolumeOutput is not found in the empty JSON string", DetachVolumeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetachVolumeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetachVolumeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetachVolumeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetachVolumeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetachVolumeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetachVolumeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DetachVolumeOutput>() {
           @Override
           public void write(JsonWriter out, DetachVolumeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetachVolumeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetachVolumeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetachVolumeOutput
   * @throws IOException if the JSON string is invalid with respect to DetachVolumeOutput
   */
  public static DetachVolumeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetachVolumeOutput.class);
  }

  /**
   * Convert an instance of DetachVolumeOutput to an JSON string
   *
   * @return JSON string
   */
