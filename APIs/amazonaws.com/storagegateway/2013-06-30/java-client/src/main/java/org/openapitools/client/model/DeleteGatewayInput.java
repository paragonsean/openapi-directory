...
public class DeleteGatewayInput {
  ...
  public DeleteGatewayInput() {
  }

  public DeleteGatewayInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteGatewayInput deleteGatewayInput = (DeleteGatewayInput) o;
    return Objects.equals(this.gatewayARN, deleteGatewayInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteGatewayInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteGatewayInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteGatewayInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteGatewayInput is not found in the empty JSON string", DeleteGatewayInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteGatewayInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteGatewayInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteGatewayInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteGatewayInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteGatewayInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteGatewayInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteGatewayInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteGatewayInput>() {
           @Override
           public void write(JsonWriter out, DeleteGatewayInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteGatewayInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteGatewayInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteGatewayInput
   * @throws IOException if the JSON string is invalid with respect to DeleteGatewayInput
   */
  public static DeleteGatewayInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteGatewayInput.class);
  }

  /**
   * Convert an instance of DeleteGatewayInput to an JSON string
   *
   * @return JSON string
   */
