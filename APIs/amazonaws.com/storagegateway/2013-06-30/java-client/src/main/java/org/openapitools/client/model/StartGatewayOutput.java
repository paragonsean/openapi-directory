...
public class StartGatewayOutput {
  ...
  public StartGatewayOutput() {
  }

  public StartGatewayOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    StartGatewayOutput startGatewayOutput = (StartGatewayOutput) o;
    return Objects.equals(this.gatewayARN, startGatewayOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartGatewayOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartGatewayOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartGatewayOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartGatewayOutput is not found in the empty JSON string", StartGatewayOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartGatewayOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartGatewayOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartGatewayOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartGatewayOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartGatewayOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartGatewayOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<StartGatewayOutput>() {
           @Override
           public void write(JsonWriter out, StartGatewayOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartGatewayOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartGatewayOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartGatewayOutput
   * @throws IOException if the JSON string is invalid with respect to StartGatewayOutput
   */
  public static StartGatewayOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartGatewayOutput.class);
  }

  /**
   * Convert an instance of StartGatewayOutput to an JSON string
   *
   * @return JSON string
   */
