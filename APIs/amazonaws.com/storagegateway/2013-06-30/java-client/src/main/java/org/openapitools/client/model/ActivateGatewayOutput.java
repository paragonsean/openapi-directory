...
public class ActivateGatewayOutput {
  ...
  public ActivateGatewayOutput() {
  }

  public ActivateGatewayOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    ActivateGatewayOutput activateGatewayOutput = (ActivateGatewayOutput) o;
    return Objects.equals(this.gatewayARN, activateGatewayOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActivateGatewayOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActivateGatewayOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActivateGatewayOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActivateGatewayOutput is not found in the empty JSON string", ActivateGatewayOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActivateGatewayOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActivateGatewayOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActivateGatewayOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActivateGatewayOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActivateGatewayOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActivateGatewayOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ActivateGatewayOutput>() {
           @Override
           public void write(JsonWriter out, ActivateGatewayOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActivateGatewayOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActivateGatewayOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActivateGatewayOutput
   * @throws IOException if the JSON string is invalid with respect to ActivateGatewayOutput
   */
  public static ActivateGatewayOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActivateGatewayOutput.class);
  }

  /**
   * Convert an instance of ActivateGatewayOutput to an JSON string
   *
   * @return JSON string
   */
