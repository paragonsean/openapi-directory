...
public class DeleteVolumeOutput {
  ...
  public DeleteVolumeOutput() {
  }

  public DeleteVolumeOutput volumeARN(String volumeARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteVolumeOutput deleteVolumeOutput = (DeleteVolumeOutput) o;
    return Objects.equals(this.volumeARN, deleteVolumeOutput.volumeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteVolumeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteVolumeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteVolumeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteVolumeOutput is not found in the empty JSON string", DeleteVolumeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteVolumeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteVolumeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteVolumeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteVolumeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteVolumeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteVolumeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteVolumeOutput>() {
           @Override
           public void write(JsonWriter out, DeleteVolumeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteVolumeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteVolumeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteVolumeOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteVolumeOutput
   */
  public static DeleteVolumeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteVolumeOutput.class);
  }

  /**
   * Convert an instance of DeleteVolumeOutput to an JSON string
   *
   * @return JSON string
   */
