 ...
 */
@JsonAdapter(CaseSensitivity.Adapter.class)
public enum CaseSensitivity {
  ...
  public static class Adapter extends TypeAdapter<CaseSensitivity> {
    @Override
    public void write(final JsonWriter jsonWriter, final CaseSensitivity enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CaseSensitivity read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CaseSensitivity.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CaseSensitivity.fromValue(value);
  }
}
