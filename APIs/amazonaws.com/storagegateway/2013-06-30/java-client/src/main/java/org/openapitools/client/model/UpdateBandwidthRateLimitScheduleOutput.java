...
public class UpdateBandwidthRateLimitScheduleOutput {
  ...
  public UpdateBandwidthRateLimitScheduleOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateBandwidthRateLimitScheduleOutput updateBandwidthRateLimitScheduleOutput = (UpdateBandwidthRateLimitScheduleOutput) o;
    return Objects.equals(this.gatewayARN, updateBandwidthRateLimitScheduleOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateBandwidthRateLimitScheduleOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateBandwidthRateLimitScheduleOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateBandwidthRateLimitScheduleOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateBandwidthRateLimitScheduleOutput is not found in the empty JSON string", UpdateBandwidthRateLimitScheduleOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateBandwidthRateLimitScheduleOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateBandwidthRateLimitScheduleOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateBandwidthRateLimitScheduleOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateBandwidthRateLimitScheduleOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateBandwidthRateLimitScheduleOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateBandwidthRateLimitScheduleOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateBandwidthRateLimitScheduleOutput>() {
           @Override
           public void write(JsonWriter out, UpdateBandwidthRateLimitScheduleOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateBandwidthRateLimitScheduleOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateBandwidthRateLimitScheduleOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateBandwidthRateLimitScheduleOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateBandwidthRateLimitScheduleOutput
   */
  public static UpdateBandwidthRateLimitScheduleOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateBandwidthRateLimitScheduleOutput.class);
  }

  /**
   * Convert an instance of UpdateBandwidthRateLimitScheduleOutput to an JSON string
   *
   * @return JSON string
   */
