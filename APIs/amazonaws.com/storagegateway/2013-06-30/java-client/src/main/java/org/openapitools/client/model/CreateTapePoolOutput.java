...
public class CreateTapePoolOutput {
  ...
  public CreateTapePoolOutput() {
  }

  public CreateTapePoolOutput poolARN(String poolARN) {
  ...
  public boolean equals(Object o) {
    ...
    CreateTapePoolOutput createTapePoolOutput = (CreateTapePoolOutput) o;
    return Objects.equals(this.poolARN, createTapePoolOutput.poolARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateTapePoolOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateTapePoolOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTapePoolOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateTapePoolOutput is not found in the empty JSON string", CreateTapePoolOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTapePoolOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTapePoolOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTapePoolOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTapePoolOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTapePoolOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTapePoolOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTapePoolOutput>() {
           @Override
           public void write(JsonWriter out, CreateTapePoolOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTapePoolOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateTapePoolOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateTapePoolOutput
   * @throws IOException if the JSON string is invalid with respect to CreateTapePoolOutput
   */
  public static CreateTapePoolOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTapePoolOutput.class);
  }

  /**
   * Convert an instance of CreateTapePoolOutput to an JSON string
   *
   * @return JSON string
   */
