...
public class UpdateGatewaySoftwareNowInput {
  ...
  public UpdateGatewaySoftwareNowInput() {
  }

  public UpdateGatewaySoftwareNowInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateGatewaySoftwareNowInput updateGatewaySoftwareNowInput = (UpdateGatewaySoftwareNowInput) o;
    return Objects.equals(this.gatewayARN, updateGatewaySoftwareNowInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateGatewaySoftwareNowInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGatewaySoftwareNowInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGatewaySoftwareNowInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGatewaySoftwareNowInput is not found in the empty JSON string", UpdateGatewaySoftwareNowInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGatewaySoftwareNowInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGatewaySoftwareNowInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateGatewaySoftwareNowInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGatewaySoftwareNowInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGatewaySoftwareNowInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGatewaySoftwareNowInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGatewaySoftwareNowInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGatewaySoftwareNowInput>() {
           @Override
           public void write(JsonWriter out, UpdateGatewaySoftwareNowInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGatewaySoftwareNowInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGatewaySoftwareNowInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGatewaySoftwareNowInput
   * @throws IOException if the JSON string is invalid with respect to UpdateGatewaySoftwareNowInput
   */
  public static UpdateGatewaySoftwareNowInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGatewaySoftwareNowInput.class);
  }

  /**
   * Convert an instance of UpdateGatewaySoftwareNowInput to an JSON string
   *
   * @return JSON string
   */
