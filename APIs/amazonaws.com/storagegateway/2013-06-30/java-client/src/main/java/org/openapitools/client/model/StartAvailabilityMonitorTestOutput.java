...
public class StartAvailabilityMonitorTestOutput {
  ...
  public StartAvailabilityMonitorTestOutput() {
  }

  public StartAvailabilityMonitorTestOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    StartAvailabilityMonitorTestOutput startAvailabilityMonitorTestOutput = (StartAvailabilityMonitorTestOutput) o;
    return Objects.equals(this.gatewayARN, startAvailabilityMonitorTestOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartAvailabilityMonitorTestOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartAvailabilityMonitorTestOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartAvailabilityMonitorTestOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartAvailabilityMonitorTestOutput is not found in the empty JSON string", StartAvailabilityMonitorTestOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartAvailabilityMonitorTestOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartAvailabilityMonitorTestOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartAvailabilityMonitorTestOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartAvailabilityMonitorTestOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartAvailabilityMonitorTestOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartAvailabilityMonitorTestOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<StartAvailabilityMonitorTestOutput>() {
           @Override
           public void write(JsonWriter out, StartAvailabilityMonitorTestOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartAvailabilityMonitorTestOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartAvailabilityMonitorTestOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartAvailabilityMonitorTestOutput
   * @throws IOException if the JSON string is invalid with respect to StartAvailabilityMonitorTestOutput
   */
  public static StartAvailabilityMonitorTestOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartAvailabilityMonitorTestOutput.class);
  }

  /**
   * Convert an instance of StartAvailabilityMonitorTestOutput to an JSON string
   *
   * @return JSON string
   */
