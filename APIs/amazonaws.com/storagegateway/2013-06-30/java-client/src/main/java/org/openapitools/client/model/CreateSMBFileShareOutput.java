...
public class CreateSMBFileShareOutput {
  ...
  public CreateSMBFileShareOutput() {
  }

  public CreateSMBFileShareOutput fileShareARN(String fileShareARN) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSMBFileShareOutput createSMBFileShareOutput = (CreateSMBFileShareOutput) o;
    return Objects.equals(this.fileShareARN, createSMBFileShareOutput.fileShareARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileShareARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateSMBFileShareOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSMBFileShareOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSMBFileShareOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSMBFileShareOutput is not found in the empty JSON string", CreateSMBFileShareOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSMBFileShareOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSMBFileShareOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `FileShareARN`
      if (jsonObj.get("FileShareARN") != null && !jsonObj.get("FileShareARN").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSMBFileShareOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSMBFileShareOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSMBFileShareOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSMBFileShareOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSMBFileShareOutput>() {
           @Override
           public void write(JsonWriter out, CreateSMBFileShareOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSMBFileShareOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSMBFileShareOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSMBFileShareOutput
   * @throws IOException if the JSON string is invalid with respect to CreateSMBFileShareOutput
   */
  public static CreateSMBFileShareOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSMBFileShareOutput.class);
  }

  /**
   * Convert an instance of CreateSMBFileShareOutput to an JSON string
   *
   * @return JSON string
   */
