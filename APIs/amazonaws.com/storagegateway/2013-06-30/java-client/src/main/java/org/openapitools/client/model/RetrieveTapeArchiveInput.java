...
public class RetrieveTapeArchiveInput {
  ...
  public RetrieveTapeArchiveInput() {
  }

  public RetrieveTapeArchiveInput tapeARN(String tapeARN) {
  ...
  public RetrieveTapeArchiveInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    RetrieveTapeArchiveInput retrieveTapeArchiveInput = (RetrieveTapeArchiveInput) o;
    return Objects.equals(this.tapeARN, retrieveTapeArchiveInput.tapeARN) &&
        Objects.equals(this.gatewayARN, retrieveTapeArchiveInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetrieveTapeArchiveInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetrieveTapeArchiveInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetrieveTapeArchiveInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetrieveTapeArchiveInput is not found in the empty JSON string", RetrieveTapeArchiveInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetrieveTapeArchiveInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetrieveTapeArchiveInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RetrieveTapeArchiveInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetrieveTapeArchiveInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetrieveTapeArchiveInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetrieveTapeArchiveInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetrieveTapeArchiveInput.class));

       return (TypeAdapter<T>) new TypeAdapter<RetrieveTapeArchiveInput>() {
           @Override
           public void write(JsonWriter out, RetrieveTapeArchiveInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetrieveTapeArchiveInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetrieveTapeArchiveInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetrieveTapeArchiveInput
   * @throws IOException if the JSON string is invalid with respect to RetrieveTapeArchiveInput
   */
  public static RetrieveTapeArchiveInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetrieveTapeArchiveInput.class);
  }

  /**
   * Convert an instance of RetrieveTapeArchiveInput to an JSON string
   *
   * @return JSON string
   */
