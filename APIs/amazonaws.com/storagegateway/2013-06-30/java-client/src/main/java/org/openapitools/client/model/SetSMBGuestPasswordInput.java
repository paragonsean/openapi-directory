...
public class SetSMBGuestPasswordInput {
  ...
  public SetSMBGuestPasswordInput() {
  }

  public SetSMBGuestPasswordInput gatewayARN(String gatewayARN) {
  ...
  public SetSMBGuestPasswordInput password(String password) {
  ...
  public boolean equals(Object o) {
    ...
    SetSMBGuestPasswordInput setSMBGuestPasswordInput = (SetSMBGuestPasswordInput) o;
    return Objects.equals(this.gatewayARN, setSMBGuestPasswordInput.gatewayARN) &&
        Objects.equals(this.password, setSMBGuestPasswordInput.password);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, password);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetSMBGuestPasswordInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetSMBGuestPasswordInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetSMBGuestPasswordInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetSMBGuestPasswordInput is not found in the empty JSON string", SetSMBGuestPasswordInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetSMBGuestPasswordInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetSMBGuestPasswordInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetSMBGuestPasswordInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetSMBGuestPasswordInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetSMBGuestPasswordInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetSMBGuestPasswordInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetSMBGuestPasswordInput.class));

       return (TypeAdapter<T>) new TypeAdapter<SetSMBGuestPasswordInput>() {
           @Override
           public void write(JsonWriter out, SetSMBGuestPasswordInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetSMBGuestPasswordInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetSMBGuestPasswordInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetSMBGuestPasswordInput
   * @throws IOException if the JSON string is invalid with respect to SetSMBGuestPasswordInput
   */
  public static SetSMBGuestPasswordInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetSMBGuestPasswordInput.class);
  }

  /**
   * Convert an instance of SetSMBGuestPasswordInput to an JSON string
   *
   * @return JSON string
   */
