...
/**
 * Gets or Sets RetentionLockType
 */
@JsonAdapter(RetentionLockType.Adapter.class)
public enum RetentionLockType {
  ...
  RetentionLockType(String value) {
    this.value = value;
  }
  ...
  public static RetentionLockType fromValue(String value) {
    for (RetentionLockType b : RetentionLockType.values()) {
  ...
  public static class Adapter extends TypeAdapter<RetentionLockType> {
    @Override
    public void write(final JsonWriter jsonWriter, final RetentionLockType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RetentionLockType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RetentionLockType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RetentionLockType.fromValue(value);
  }
}
