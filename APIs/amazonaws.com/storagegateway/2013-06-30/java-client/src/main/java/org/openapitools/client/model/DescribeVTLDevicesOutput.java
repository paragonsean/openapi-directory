...
public class DescribeVTLDevicesOutput {
  ...
  public static final String SERIALIZED_NAME_VT_L_DEVICES = "VTLDevices";
  @SerializedName(SERIALIZED_NAME_VT_L_DEVICES)
  private List vtLDevices;
  ...
  public DescribeVTLDevicesOutput gatewayARN(String gatewayARN) {
  ...
  public DescribeVTLDevicesOutput vtLDevices(List vtLDevices) {
   ...
   */
  @javax.annotation.Nullable
  public List getVtLDevices() {
    return vtLDevices;
  }

  public void setVtLDevices(List vtLDevices) {
    this.vtLDevices = vtLDevices;
  }


  public DescribeVTLDevicesOutput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeVTLDevicesOutput describeVTLDevicesOutput = (DescribeVTLDevicesOutput) o;
    return Objects.equals(this.gatewayARN, describeVTLDevicesOutput.gatewayARN) &&
        Objects.equals(this.vtLDevices, describeVTLDevicesOutput.vtLDevices) &&
        Objects.equals(this.marker, describeVTLDevicesOutput.marker);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, vtLDevices, marker);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeVTLDevicesOutput {\n");
    sb.append("    gatewayARN: ").append(toIndentedString(gatewayARN)).append("\n");
    sb.append("    vtLDevices: ").append(toIndentedString(vtLDevices)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeVTLDevicesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeVTLDevicesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeVTLDevicesOutput is not found in the empty JSON string", DescribeVTLDevicesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeVTLDevicesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeVTLDevicesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("VTLDevices") != null && !jsonObj.get("VTLDevices").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("VTLDevices"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeVTLDevicesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeVTLDevicesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeVTLDevicesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeVTLDevicesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeVTLDevicesOutput>() {
           @Override
           public void write(JsonWriter out, DescribeVTLDevicesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeVTLDevicesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeVTLDevicesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeVTLDevicesOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeVTLDevicesOutput
   */
  public static DescribeVTLDevicesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeVTLDevicesOutput.class);
  }

  /**
   * Convert an instance of DescribeVTLDevicesOutput to an JSON string
   *
   * @return JSON string
   */
