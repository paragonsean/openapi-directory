...
public class CreateTapeWithBarcodeOutput {
  ...
  public CreateTapeWithBarcodeOutput() {
  }

  public CreateTapeWithBarcodeOutput tapeARN(String tapeARN) {
  ...
  public boolean equals(Object o) {
    ...
    CreateTapeWithBarcodeOutput createTapeWithBarcodeOutput = (CreateTapeWithBarcodeOutput) o;
    return Objects.equals(this.tapeARN, createTapeWithBarcodeOutput.tapeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateTapeWithBarcodeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateTapeWithBarcodeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTapeWithBarcodeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateTapeWithBarcodeOutput is not found in the empty JSON string", CreateTapeWithBarcodeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTapeWithBarcodeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTapeWithBarcodeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTapeWithBarcodeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTapeWithBarcodeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTapeWithBarcodeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTapeWithBarcodeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTapeWithBarcodeOutput>() {
           @Override
           public void write(JsonWriter out, CreateTapeWithBarcodeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTapeWithBarcodeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateTapeWithBarcodeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateTapeWithBarcodeOutput
   * @throws IOException if the JSON string is invalid with respect to CreateTapeWithBarcodeOutput
   */
  public static CreateTapeWithBarcodeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTapeWithBarcodeOutput.class);
  }

  /**
   * Convert an instance of CreateTapeWithBarcodeOutput to an JSON string
   *
   * @return JSON string
   */
