...
public class CancelRetrievalOutput {
  ...
  public CancelRetrievalOutput() {
  }

  public CancelRetrievalOutput tapeARN(String tapeARN) {
  ...
  public boolean equals(Object o) {
    ...
    CancelRetrievalOutput cancelRetrievalOutput = (CancelRetrievalOutput) o;
    return Objects.equals(this.tapeARN, cancelRetrievalOutput.tapeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelRetrievalOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelRetrievalOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelRetrievalOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelRetrievalOutput is not found in the empty JSON string", CancelRetrievalOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelRetrievalOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelRetrievalOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelRetrievalOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelRetrievalOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelRetrievalOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelRetrievalOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelRetrievalOutput>() {
           @Override
           public void write(JsonWriter out, CancelRetrievalOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelRetrievalOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelRetrievalOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelRetrievalOutput
   * @throws IOException if the JSON string is invalid with respect to CancelRetrievalOutput
   */
  public static CancelRetrievalOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelRetrievalOutput.class);
  }

  /**
   * Convert an instance of CancelRetrievalOutput to an JSON string
   *
   * @return JSON string
   */
