...
public class UpdateSMBLocalGroupsOutput {
  ...
  public UpdateSMBLocalGroupsOutput() {
  }

  public UpdateSMBLocalGroupsOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSMBLocalGroupsOutput updateSMBLocalGroupsOutput = (UpdateSMBLocalGroupsOutput) o;
    return Objects.equals(this.gatewayARN, updateSMBLocalGroupsOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSMBLocalGroupsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSMBLocalGroupsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSMBLocalGroupsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSMBLocalGroupsOutput is not found in the empty JSON string", UpdateSMBLocalGroupsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSMBLocalGroupsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSMBLocalGroupsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSMBLocalGroupsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSMBLocalGroupsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSMBLocalGroupsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSMBLocalGroupsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSMBLocalGroupsOutput>() {
           @Override
           public void write(JsonWriter out, UpdateSMBLocalGroupsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSMBLocalGroupsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSMBLocalGroupsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSMBLocalGroupsOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateSMBLocalGroupsOutput
   */
  public static UpdateSMBLocalGroupsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSMBLocalGroupsOutput.class);
  }

  /**
   * Convert an instance of UpdateSMBLocalGroupsOutput to an JSON string
   *
   * @return JSON string
   */
