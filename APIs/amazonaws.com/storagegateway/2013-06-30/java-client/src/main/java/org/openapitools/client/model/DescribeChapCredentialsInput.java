...
public class DescribeChapCredentialsInput {
  ...
  public DescribeChapCredentialsInput() {
  }

  public DescribeChapCredentialsInput targetARN(String targetARN) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeChapCredentialsInput describeChapCredentialsInput = (DescribeChapCredentialsInput) o;
    return Objects.equals(this.targetARN, describeChapCredentialsInput.targetARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeChapCredentialsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeChapCredentialsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeChapCredentialsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeChapCredentialsInput is not found in the empty JSON string", DescribeChapCredentialsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeChapCredentialsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeChapCredentialsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeChapCredentialsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeChapCredentialsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeChapCredentialsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeChapCredentialsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeChapCredentialsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeChapCredentialsInput>() {
           @Override
           public void write(JsonWriter out, DescribeChapCredentialsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeChapCredentialsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeChapCredentialsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeChapCredentialsInput
   * @throws IOException if the JSON string is invalid with respect to DescribeChapCredentialsInput
   */
  public static DescribeChapCredentialsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeChapCredentialsInput.class);
  }

  /**
   * Convert an instance of DescribeChapCredentialsInput to an JSON string
   *
   * @return JSON string
   */
