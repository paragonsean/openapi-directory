...
public class DeleteAutomaticTapeCreationPolicyInput {
  ...
  public DeleteAutomaticTapeCreationPolicyInput() {
  }

  public DeleteAutomaticTapeCreationPolicyInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteAutomaticTapeCreationPolicyInput deleteAutomaticTapeCreationPolicyInput = (DeleteAutomaticTapeCreationPolicyInput) o;
    return Objects.equals(this.gatewayARN, deleteAutomaticTapeCreationPolicyInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteAutomaticTapeCreationPolicyInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAutomaticTapeCreationPolicyInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAutomaticTapeCreationPolicyInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAutomaticTapeCreationPolicyInput is not found in the empty JSON string", DeleteAutomaticTapeCreationPolicyInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAutomaticTapeCreationPolicyInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAutomaticTapeCreationPolicyInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteAutomaticTapeCreationPolicyInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAutomaticTapeCreationPolicyInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAutomaticTapeCreationPolicyInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAutomaticTapeCreationPolicyInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAutomaticTapeCreationPolicyInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAutomaticTapeCreationPolicyInput>() {
           @Override
           public void write(JsonWriter out, DeleteAutomaticTapeCreationPolicyInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAutomaticTapeCreationPolicyInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAutomaticTapeCreationPolicyInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAutomaticTapeCreationPolicyInput
   * @throws IOException if the JSON string is invalid with respect to DeleteAutomaticTapeCreationPolicyInput
   */
  public static DeleteAutomaticTapeCreationPolicyInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAutomaticTapeCreationPolicyInput.class);
  }

  /**
   * Convert an instance of DeleteAutomaticTapeCreationPolicyInput to an JSON string
   *
   * @return JSON string
   */
