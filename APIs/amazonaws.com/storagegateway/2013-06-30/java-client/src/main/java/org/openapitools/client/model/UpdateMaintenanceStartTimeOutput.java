...
public class UpdateMaintenanceStartTimeOutput {
  ...
  public UpdateMaintenanceStartTimeOutput() {
  }

  public UpdateMaintenanceStartTimeOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateMaintenanceStartTimeOutput updateMaintenanceStartTimeOutput = (UpdateMaintenanceStartTimeOutput) o;
    return Objects.equals(this.gatewayARN, updateMaintenanceStartTimeOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateMaintenanceStartTimeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMaintenanceStartTimeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMaintenanceStartTimeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMaintenanceStartTimeOutput is not found in the empty JSON string", UpdateMaintenanceStartTimeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMaintenanceStartTimeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMaintenanceStartTimeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMaintenanceStartTimeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMaintenanceStartTimeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMaintenanceStartTimeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMaintenanceStartTimeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMaintenanceStartTimeOutput>() {
           @Override
           public void write(JsonWriter out, UpdateMaintenanceStartTimeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMaintenanceStartTimeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMaintenanceStartTimeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMaintenanceStartTimeOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateMaintenanceStartTimeOutput
   */
  public static UpdateMaintenanceStartTimeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMaintenanceStartTimeOutput.class);
  }

  /**
   * Convert an instance of UpdateMaintenanceStartTimeOutput to an JSON string
   *
   * @return JSON string
   */
