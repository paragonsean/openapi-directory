...
public class UpdateVTLDeviceTypeOutput {
  ...
  public UpdateVTLDeviceTypeOutput() {
  }

  public UpdateVTLDeviceTypeOutput vtLDeviceARN(String vtLDeviceARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateVTLDeviceTypeOutput updateVTLDeviceTypeOutput = (UpdateVTLDeviceTypeOutput) o;
    return Objects.equals(this.vtLDeviceARN, updateVTLDeviceTypeOutput.vtLDeviceARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vtLDeviceARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateVTLDeviceTypeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateVTLDeviceTypeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateVTLDeviceTypeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateVTLDeviceTypeOutput is not found in the empty JSON string", UpdateVTLDeviceTypeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateVTLDeviceTypeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateVTLDeviceTypeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateVTLDeviceTypeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateVTLDeviceTypeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateVTLDeviceTypeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateVTLDeviceTypeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateVTLDeviceTypeOutput>() {
           @Override
           public void write(JsonWriter out, UpdateVTLDeviceTypeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateVTLDeviceTypeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateVTLDeviceTypeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateVTLDeviceTypeOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateVTLDeviceTypeOutput
   */
  public static UpdateVTLDeviceTypeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateVTLDeviceTypeOutput.class);
  }

  /**
   * Convert an instance of UpdateVTLDeviceTypeOutput to an JSON string
   *
   * @return JSON string
   */
