...
public class CreateCachediSCSIVolumeOutput {
  ...
  public CreateCachediSCSIVolumeOutput() {
  }

  public CreateCachediSCSIVolumeOutput volumeARN(String volumeARN) {
  ...
  public CreateCachediSCSIVolumeOutput targetARN(String targetARN) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCachediSCSIVolumeOutput createCachediSCSIVolumeOutput = (CreateCachediSCSIVolumeOutput) o;
    return Objects.equals(this.volumeARN, createCachediSCSIVolumeOutput.volumeARN) &&
        Objects.equals(this.targetARN, createCachediSCSIVolumeOutput.targetARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(volumeARN, targetARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateCachediSCSIVolumeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCachediSCSIVolumeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCachediSCSIVolumeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCachediSCSIVolumeOutput is not found in the empty JSON string", CreateCachediSCSIVolumeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCachediSCSIVolumeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCachediSCSIVolumeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCachediSCSIVolumeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCachediSCSIVolumeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCachediSCSIVolumeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCachediSCSIVolumeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCachediSCSIVolumeOutput>() {
           @Override
           public void write(JsonWriter out, CreateCachediSCSIVolumeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCachediSCSIVolumeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCachediSCSIVolumeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCachediSCSIVolumeOutput
   * @throws IOException if the JSON string is invalid with respect to CreateCachediSCSIVolumeOutput
   */
  public static CreateCachediSCSIVolumeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCachediSCSIVolumeOutput.class);
  }

  /**
   * Convert an instance of CreateCachediSCSIVolumeOutput to an JSON string
   *
   * @return JSON string
   */
