...
public class UpdateBandwidthRateLimitScheduleInput {
  ...
  public static final String SERIALIZED_NAME_BANDWIDTH_RATE_LIMIT_INTERVALS = "BandwidthRateLimitIntervals";
  @SerializedName(SERIALIZED_NAME_BANDWIDTH_RATE_LIMIT_INTERVALS)
  private List bandwidthRateLimitIntervals;

  public UpdateBandwidthRateLimitScheduleInput() {
  }

  public UpdateBandwidthRateLimitScheduleInput gatewayARN(String gatewayARN) {
  ...
  public UpdateBandwidthRateLimitScheduleInput bandwidthRateLimitIntervals(List bandwidthRateLimitIntervals) {
    this.bandwidthRateLimitIntervals = bandwidthRateLimitIntervals;
    return this;
  }

  /**
   * Get bandwidthRateLimitIntervals
   * @return bandwidthRateLimitIntervals
   */
  @javax.annotation.Nonnull
  public List getBandwidthRateLimitIntervals() {
    return bandwidthRateLimitIntervals;
  }

  public void setBandwidthRateLimitIntervals(List bandwidthRateLimitIntervals) {
    this.bandwidthRateLimitIntervals = bandwidthRateLimitIntervals;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateBandwidthRateLimitScheduleInput updateBandwidthRateLimitScheduleInput = (UpdateBandwidthRateLimitScheduleInput) o;
    return Objects.equals(this.gatewayARN, updateBandwidthRateLimitScheduleInput.gatewayARN) &&
        Objects.equals(this.bandwidthRateLimitIntervals, updateBandwidthRateLimitScheduleInput.bandwidthRateLimitIntervals);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, bandwidthRateLimitIntervals);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateBandwidthRateLimitScheduleInput {\n");
    sb.append("    gatewayARN: ").append(toIndentedString(gatewayARN)).append("\n");
    sb.append("    bandwidthRateLimitIntervals: ").append(toIndentedString(bandwidthRateLimitIntervals)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("BandwidthRateLimitIntervals");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("GatewayARN");
    openapiRequiredFields.add("BandwidthRateLimitIntervals");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateBandwidthRateLimitScheduleInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateBandwidthRateLimitScheduleInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateBandwidthRateLimitScheduleInput is not found in the empty JSON string", UpdateBandwidthRateLimitScheduleInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateBandwidthRateLimitScheduleInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateBandwidthRateLimitScheduleInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateBandwidthRateLimitScheduleInput.openapiRequiredFields) {
      ...
      // validate the required field `BandwidthRateLimitIntervals`
      List.validateJsonElement(jsonObj.get("BandwidthRateLimitIntervals"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateBandwidthRateLimitScheduleInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateBandwidthRateLimitScheduleInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateBandwidthRateLimitScheduleInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateBandwidthRateLimitScheduleInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateBandwidthRateLimitScheduleInput>() {
           @Override
           public void write(JsonWriter out, UpdateBandwidthRateLimitScheduleInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateBandwidthRateLimitScheduleInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateBandwidthRateLimitScheduleInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateBandwidthRateLimitScheduleInput
   * @throws IOException if the JSON string is invalid with respect to UpdateBandwidthRateLimitScheduleInput
   */
  public static UpdateBandwidthRateLimitScheduleInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateBandwidthRateLimitScheduleInput.class);
  }

  /**
   * Convert an instance of UpdateBandwidthRateLimitScheduleInput to an JSON string
   *
   * @return JSON string
   */
