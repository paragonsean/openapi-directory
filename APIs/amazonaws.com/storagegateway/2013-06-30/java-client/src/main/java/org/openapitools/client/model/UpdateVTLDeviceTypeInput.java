...
public class UpdateVTLDeviceTypeInput {
  ...
  public UpdateVTLDeviceTypeInput() {
  }

  public UpdateVTLDeviceTypeInput vtLDeviceARN(String vtLDeviceARN) {
  ...
  public UpdateVTLDeviceTypeInput deviceType(String deviceType) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateVTLDeviceTypeInput updateVTLDeviceTypeInput = (UpdateVTLDeviceTypeInput) o;
    return Objects.equals(this.vtLDeviceARN, updateVTLDeviceTypeInput.vtLDeviceARN) &&
        Objects.equals(this.deviceType, updateVTLDeviceTypeInput.deviceType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vtLDeviceARN, deviceType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateVTLDeviceTypeInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("VTLDeviceARN");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateVTLDeviceTypeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateVTLDeviceTypeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateVTLDeviceTypeInput is not found in the empty JSON string", UpdateVTLDeviceTypeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateVTLDeviceTypeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateVTLDeviceTypeInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateVTLDeviceTypeInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `VTLDeviceARN`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateVTLDeviceTypeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateVTLDeviceTypeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateVTLDeviceTypeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateVTLDeviceTypeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateVTLDeviceTypeInput>() {
           @Override
           public void write(JsonWriter out, UpdateVTLDeviceTypeInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateVTLDeviceTypeInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateVTLDeviceTypeInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateVTLDeviceTypeInput
   * @throws IOException if the JSON string is invalid with respect to UpdateVTLDeviceTypeInput
   */
  public static UpdateVTLDeviceTypeInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateVTLDeviceTypeInput.class);
  }

  /**
   * Convert an instance of UpdateVTLDeviceTypeInput to an JSON string
   *
   * @return JSON string
   */
