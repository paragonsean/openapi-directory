...
public class CreateStorediSCSIVolumeOutput {
  ...
  public CreateStorediSCSIVolumeOutput() {
  }

  public CreateStorediSCSIVolumeOutput volumeARN(String volumeARN) {
  ...
  public CreateStorediSCSIVolumeOutput volumeSizeInBytes(Integer volumeSizeInBytes) {
  ...
  public CreateStorediSCSIVolumeOutput targetARN(String targetARN) {
  ...
  public boolean equals(Object o) {
    ...
    CreateStorediSCSIVolumeOutput createStorediSCSIVolumeOutput = (CreateStorediSCSIVolumeOutput) o;
    return Objects.equals(this.volumeARN, createStorediSCSIVolumeOutput.volumeARN) &&
        Objects.equals(this.volumeSizeInBytes, createStorediSCSIVolumeOutput.volumeSizeInBytes) &&
        Objects.equals(this.targetARN, createStorediSCSIVolumeOutput.targetARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(volumeARN, volumeSizeInBytes, targetARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateStorediSCSIVolumeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStorediSCSIVolumeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStorediSCSIVolumeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStorediSCSIVolumeOutput is not found in the empty JSON string", CreateStorediSCSIVolumeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStorediSCSIVolumeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStorediSCSIVolumeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStorediSCSIVolumeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStorediSCSIVolumeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStorediSCSIVolumeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStorediSCSIVolumeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStorediSCSIVolumeOutput>() {
           @Override
           public void write(JsonWriter out, CreateStorediSCSIVolumeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStorediSCSIVolumeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStorediSCSIVolumeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStorediSCSIVolumeOutput
   * @throws IOException if the JSON string is invalid with respect to CreateStorediSCSIVolumeOutput
   */
  public static CreateStorediSCSIVolumeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStorediSCSIVolumeOutput.class);
  }

  /**
   * Convert an instance of CreateStorediSCSIVolumeOutput to an JSON string
   *
   * @return JSON string
   */
