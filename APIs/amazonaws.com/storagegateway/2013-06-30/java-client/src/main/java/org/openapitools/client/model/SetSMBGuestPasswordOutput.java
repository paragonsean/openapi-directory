...
public class SetSMBGuestPasswordOutput {
  ...
  public SetSMBGuestPasswordOutput() {
  }

  public SetSMBGuestPasswordOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    SetSMBGuestPasswordOutput setSMBGuestPasswordOutput = (SetSMBGuestPasswordOutput) o;
    return Objects.equals(this.gatewayARN, setSMBGuestPasswordOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetSMBGuestPasswordOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetSMBGuestPasswordOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetSMBGuestPasswordOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetSMBGuestPasswordOutput is not found in the empty JSON string", SetSMBGuestPasswordOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetSMBGuestPasswordOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetSMBGuestPasswordOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetSMBGuestPasswordOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetSMBGuestPasswordOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetSMBGuestPasswordOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetSMBGuestPasswordOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<SetSMBGuestPasswordOutput>() {
           @Override
           public void write(JsonWriter out, SetSMBGuestPasswordOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetSMBGuestPasswordOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetSMBGuestPasswordOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetSMBGuestPasswordOutput
   * @throws IOException if the JSON string is invalid with respect to SetSMBGuestPasswordOutput
   */
  public static SetSMBGuestPasswordOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetSMBGuestPasswordOutput.class);
  }

  /**
   * Convert an instance of SetSMBGuestPasswordOutput to an JSON string
   *
   * @return JSON string
   */
