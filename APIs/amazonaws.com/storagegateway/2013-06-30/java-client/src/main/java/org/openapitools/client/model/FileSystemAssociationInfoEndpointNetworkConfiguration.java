...
public class FileSystemAssociationInfoEndpointNetworkConfiguration {
  public static final String SERIALIZED_NAME_IP_ADDRESSES = "IpAddresses";
  @SerializedName(SERIALIZED_NAME_IP_ADDRESSES)
  private List ipAddresses;

  public FileSystemAssociationInfoEndpointNetworkConfiguration() {
  }

  public FileSystemAssociationInfoEndpointNetworkConfiguration ipAddresses(List ipAddresses) {
  ...
  public boolean equals(Object o) {
    ...
    FileSystemAssociationInfoEndpointNetworkConfiguration fileSystemAssociationInfoEndpointNetworkConfiguration = (FileSystemAssociationInfoEndpointNetworkConfiguration) o;
    return Objects.equals(this.ipAddresses, fileSystemAssociationInfoEndpointNetworkConfiguration.ipAddresses);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileSystemAssociationInfoEndpointNetworkConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FileSystemAssociationInfoEndpointNetworkConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FileSystemAssociationInfoEndpointNetworkConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileSystemAssociationInfoEndpointNetworkConfiguration is not found in the empty JSON string", FileSystemAssociationInfoEndpointNetworkConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FileSystemAssociationInfoEndpointNetworkConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FileSystemAssociationInfoEndpointNetworkConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileSystemAssociationInfoEndpointNetworkConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileSystemAssociationInfoEndpointNetworkConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileSystemAssociationInfoEndpointNetworkConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileSystemAssociationInfoEndpointNetworkConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<FileSystemAssociationInfoEndpointNetworkConfiguration>() {
           @Override
           public void write(JsonWriter out, FileSystemAssociationInfoEndpointNetworkConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FileSystemAssociationInfoEndpointNetworkConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FileSystemAssociationInfoEndpointNetworkConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FileSystemAssociationInfoEndpointNetworkConfiguration
   * @throws IOException if the JSON string is invalid with respect to FileSystemAssociationInfoEndpointNetworkConfiguration
   */
  public static FileSystemAssociationInfoEndpointNetworkConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileSystemAssociationInfoEndpointNetworkConfiguration.class);
  }

  /**
   * Convert an instance of FileSystemAssociationInfoEndpointNetworkConfiguration to an JSON string
   *
   * @return JSON string
   */
