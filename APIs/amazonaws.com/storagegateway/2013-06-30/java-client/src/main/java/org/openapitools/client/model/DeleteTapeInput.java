...
public class DeleteTapeInput {
  ...
  public DeleteTapeInput() {
  }

  public DeleteTapeInput gatewayARN(String gatewayARN) {
  ...
  public DeleteTapeInput tapeARN(String tapeARN) {
  ...
  public DeleteTapeInput bypassGovernanceRetention(Boolean bypassGovernanceRetention) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteTapeInput deleteTapeInput = (DeleteTapeInput) o;
    return Objects.equals(this.gatewayARN, deleteTapeInput.gatewayARN) &&
        Objects.equals(this.tapeARN, deleteTapeInput.tapeARN) &&
        Objects.equals(this.bypassGovernanceRetention, deleteTapeInput.bypassGovernanceRetention);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, tapeARN, bypassGovernanceRetention);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteTapeInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTapeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTapeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTapeInput is not found in the empty JSON string", DeleteTapeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTapeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTapeInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteTapeInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTapeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTapeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTapeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTapeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTapeInput>() {
           @Override
           public void write(JsonWriter out, DeleteTapeInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTapeInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTapeInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTapeInput
   * @throws IOException if the JSON string is invalid with respect to DeleteTapeInput
   */
  public static DeleteTapeInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTapeInput.class);
  }

  /**
   * Convert an instance of DeleteTapeInput to an JSON string
   *
   * @return JSON string
   */
