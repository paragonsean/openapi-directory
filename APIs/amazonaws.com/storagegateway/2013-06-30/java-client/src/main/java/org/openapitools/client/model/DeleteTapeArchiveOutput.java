...
public class DeleteTapeArchiveOutput {
  ...
  public DeleteTapeArchiveOutput() {
  }

  public DeleteTapeArchiveOutput tapeARN(String tapeARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteTapeArchiveOutput deleteTapeArchiveOutput = (DeleteTapeArchiveOutput) o;
    return Objects.equals(this.tapeARN, deleteTapeArchiveOutput.tapeARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tapeARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteTapeArchiveOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTapeArchiveOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTapeArchiveOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTapeArchiveOutput is not found in the empty JSON string", DeleteTapeArchiveOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTapeArchiveOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTapeArchiveOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTapeArchiveOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTapeArchiveOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTapeArchiveOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTapeArchiveOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTapeArchiveOutput>() {
           @Override
           public void write(JsonWriter out, DeleteTapeArchiveOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTapeArchiveOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTapeArchiveOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTapeArchiveOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteTapeArchiveOutput
   */
  public static DeleteTapeArchiveOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTapeArchiveOutput.class);
  }

  /**
   * Convert an instance of DeleteTapeArchiveOutput to an JSON string
   *
   * @return JSON string
   */
