...
public class RefreshCacheInput {
  ...
  public RefreshCacheInput() {
  }

  public RefreshCacheInput fileShareARN(String fileShareARN) {
  ...
  public RefreshCacheInput folderList(List folderList) {
  ...
  public RefreshCacheInput recursive(Boolean recursive) {
  ...
  public boolean equals(Object o) {
    ...
    RefreshCacheInput refreshCacheInput = (RefreshCacheInput) o;
    return Objects.equals(this.fileShareARN, refreshCacheInput.fileShareARN) &&
        Objects.equals(this.folderList, refreshCacheInput.folderList) &&
        Objects.equals(this.recursive, refreshCacheInput.recursive);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileShareARN, folderList, recursive);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RefreshCacheInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RefreshCacheInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RefreshCacheInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RefreshCacheInput is not found in the empty JSON string", RefreshCacheInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RefreshCacheInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RefreshCacheInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RefreshCacheInput.openapiRequiredFields) {
      ...
      // validate the optional field `FolderList`
      if (jsonObj.get("FolderList") != null && !jsonObj.get("FolderList").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("FolderList"));
      }
      // validate the optional field `Recursive`
      if (jsonObj.get("Recursive") != null && !jsonObj.get("Recursive").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("Recursive"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RefreshCacheInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RefreshCacheInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RefreshCacheInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RefreshCacheInput.class));

       return (TypeAdapter<T>) new TypeAdapter<RefreshCacheInput>() {
           @Override
           public void write(JsonWriter out, RefreshCacheInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RefreshCacheInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RefreshCacheInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RefreshCacheInput
   * @throws IOException if the JSON string is invalid with respect to RefreshCacheInput
   */
  public static RefreshCacheInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RefreshCacheInput.class);
  }

  /**
   * Convert an instance of RefreshCacheInput to an JSON string
   *
   * @return JSON string
   */
