...
public class UpdateSnapshotScheduleOutput {
  ...
  public UpdateSnapshotScheduleOutput volumeARN(String volumeARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSnapshotScheduleOutput updateSnapshotScheduleOutput = (UpdateSnapshotScheduleOutput) o;
    return Objects.equals(this.volumeARN, updateSnapshotScheduleOutput.volumeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSnapshotScheduleOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSnapshotScheduleOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSnapshotScheduleOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSnapshotScheduleOutput is not found in the empty JSON string", UpdateSnapshotScheduleOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSnapshotScheduleOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSnapshotScheduleOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSnapshotScheduleOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSnapshotScheduleOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSnapshotScheduleOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSnapshotScheduleOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSnapshotScheduleOutput>() {
           @Override
           public void write(JsonWriter out, UpdateSnapshotScheduleOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSnapshotScheduleOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSnapshotScheduleOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSnapshotScheduleOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateSnapshotScheduleOutput
   */
  public static UpdateSnapshotScheduleOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSnapshotScheduleOutput.class);
  }

  /**
   * Convert an instance of UpdateSnapshotScheduleOutput to an JSON string
   *
   * @return JSON string
   */
