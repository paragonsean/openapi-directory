...
public class RemoveTagsFromResourceOutput {
  ...
  public RemoveTagsFromResourceOutput() {
  }

  public RemoveTagsFromResourceOutput resourceARN(String resourceARN) {
  ...
  public boolean equals(Object o) {
    ...
    RemoveTagsFromResourceOutput removeTagsFromResourceOutput = (RemoveTagsFromResourceOutput) o;
    return Objects.equals(this.resourceARN, removeTagsFromResourceOutput.resourceARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoveTagsFromResourceOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveTagsFromResourceOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveTagsFromResourceOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveTagsFromResourceOutput is not found in the empty JSON string", RemoveTagsFromResourceOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveTagsFromResourceOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveTagsFromResourceOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveTagsFromResourceOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveTagsFromResourceOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveTagsFromResourceOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveTagsFromResourceOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveTagsFromResourceOutput>() {
           @Override
           public void write(JsonWriter out, RemoveTagsFromResourceOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveTagsFromResourceOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveTagsFromResourceOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveTagsFromResourceOutput
   * @throws IOException if the JSON string is invalid with respect to RemoveTagsFromResourceOutput
   */
  public static RemoveTagsFromResourceOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveTagsFromResourceOutput.class);
  }

  /**
   * Convert an instance of RemoveTagsFromResourceOutput to an JSON string
   *
   * @return JSON string
   */
