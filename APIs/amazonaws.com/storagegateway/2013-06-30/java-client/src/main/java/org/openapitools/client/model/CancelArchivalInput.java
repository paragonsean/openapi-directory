...
public class CancelArchivalInput {
  ...
  public CancelArchivalInput() {
  }

  public CancelArchivalInput gatewayARN(String gatewayARN) {
  ...
  public CancelArchivalInput tapeARN(String tapeARN) {
  ...
  public boolean equals(Object o) {
    ...
    CancelArchivalInput cancelArchivalInput = (CancelArchivalInput) o;
    return Objects.equals(this.gatewayARN, cancelArchivalInput.gatewayARN) &&
        Objects.equals(this.tapeARN, cancelArchivalInput.tapeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelArchivalInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelArchivalInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelArchivalInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelArchivalInput is not found in the empty JSON string", CancelArchivalInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelArchivalInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelArchivalInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CancelArchivalInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelArchivalInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelArchivalInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelArchivalInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelArchivalInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelArchivalInput>() {
           @Override
           public void write(JsonWriter out, CancelArchivalInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelArchivalInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelArchivalInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelArchivalInput
   * @throws IOException if the JSON string is invalid with respect to CancelArchivalInput
   */
  public static CancelArchivalInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelArchivalInput.class);
  }

  /**
   * Convert an instance of CancelArchivalInput to an JSON string
   *
   * @return JSON string
   */
