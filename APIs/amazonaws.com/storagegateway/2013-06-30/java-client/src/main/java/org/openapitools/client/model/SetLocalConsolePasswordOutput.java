...
public class SetLocalConsolePasswordOutput {
  ...
  public SetLocalConsolePasswordOutput() {
  }

  public SetLocalConsolePasswordOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    SetLocalConsolePasswordOutput setLocalConsolePasswordOutput = (SetLocalConsolePasswordOutput) o;
    return Objects.equals(this.gatewayARN, setLocalConsolePasswordOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetLocalConsolePasswordOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetLocalConsolePasswordOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetLocalConsolePasswordOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetLocalConsolePasswordOutput is not found in the empty JSON string", SetLocalConsolePasswordOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetLocalConsolePasswordOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetLocalConsolePasswordOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetLocalConsolePasswordOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetLocalConsolePasswordOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetLocalConsolePasswordOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetLocalConsolePasswordOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<SetLocalConsolePasswordOutput>() {
           @Override
           public void write(JsonWriter out, SetLocalConsolePasswordOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetLocalConsolePasswordOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetLocalConsolePasswordOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetLocalConsolePasswordOutput
   * @throws IOException if the JSON string is invalid with respect to SetLocalConsolePasswordOutput
   */
  public static SetLocalConsolePasswordOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetLocalConsolePasswordOutput.class);
  }

  /**
   * Convert an instance of SetLocalConsolePasswordOutput to an JSON string
   *
   * @return JSON string
   */
