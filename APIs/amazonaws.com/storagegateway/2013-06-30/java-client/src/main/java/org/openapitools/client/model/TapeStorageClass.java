...
/**
 * Gets or Sets TapeStorageClass
 */
@JsonAdapter(TapeStorageClass.Adapter.class)
public enum TapeStorageClass {
  ...
  public static TapeStorageClass fromValue(String value) {
    for (TapeStorageClass b : TapeStorageClass.values()) {
  ...
  public static class Adapter extends TypeAdapter<TapeStorageClass> {
    @Override
    public void write(final JsonWriter jsonWriter, final TapeStorageClass enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TapeStorageClass read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TapeStorageClass.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TapeStorageClass.fromValue(value);
  }
}
