...
public class ListVolumeInitiatorsOutput {
  ...
  public ListVolumeInitiatorsOutput() {
  }

  public ListVolumeInitiatorsOutput initiators(List initiators) {
  ...
  public boolean equals(Object o) {
    ...
    ListVolumeInitiatorsOutput listVolumeInitiatorsOutput = (ListVolumeInitiatorsOutput) o;
    return Objects.equals(this.initiators, listVolumeInitiatorsOutput.initiators);
  }

  @Override
  public int hashCode() {
    return Objects.hash(initiators);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListVolumeInitiatorsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListVolumeInitiatorsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListVolumeInitiatorsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListVolumeInitiatorsOutput is not found in the empty JSON string", ListVolumeInitiatorsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListVolumeInitiatorsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListVolumeInitiatorsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Initiators`
      if (jsonObj.get("Initiators") != null && !jsonObj.get("Initiators").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Initiators"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListVolumeInitiatorsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListVolumeInitiatorsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListVolumeInitiatorsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListVolumeInitiatorsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListVolumeInitiatorsOutput>() {
           @Override
           public void write(JsonWriter out, ListVolumeInitiatorsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListVolumeInitiatorsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListVolumeInitiatorsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListVolumeInitiatorsOutput
   * @throws IOException if the JSON string is invalid with respect to ListVolumeInitiatorsOutput
   */
  public static ListVolumeInitiatorsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListVolumeInitiatorsOutput.class);
  }

  /**
   * Convert an instance of ListVolumeInitiatorsOutput to an JSON string
   *
   * @return JSON string
   */
