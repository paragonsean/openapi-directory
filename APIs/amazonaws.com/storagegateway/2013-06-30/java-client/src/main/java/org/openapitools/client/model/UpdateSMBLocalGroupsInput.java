...
import org.openapitools.client.model.UpdateSMBLocalGroupsInputSMBLocalGroups;
...
public class UpdateSMBLocalGroupsInput {
  ...
  private UpdateSMBLocalGroupsInputSMBLocalGroups smBLocalGroups;

  public UpdateSMBLocalGroupsInput() {
  }

  public UpdateSMBLocalGroupsInput gatewayARN(String gatewayARN) {
  ...
  public UpdateSMBLocalGroupsInput smBLocalGroups(UpdateSMBLocalGroupsInputSMBLocalGroups smBLocalGroups) {
   ...
   */
  @javax.annotation.Nonnull
  public UpdateSMBLocalGroupsInputSMBLocalGroups getSmBLocalGroups() {
    return smBLocalGroups;
  }

  public void setSmBLocalGroups(UpdateSMBLocalGroupsInputSMBLocalGroups smBLocalGroups) {
    this.smBLocalGroups = smBLocalGroups;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateSMBLocalGroupsInput updateSMBLocalGroupsInput = (UpdateSMBLocalGroupsInput) o;
    return Objects.equals(this.gatewayARN, updateSMBLocalGroupsInput.gatewayARN) &&
        Objects.equals(this.smBLocalGroups, updateSMBLocalGroupsInput.smBLocalGroups);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, smBLocalGroups);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateSMBLocalGroupsInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("SMBLocalGroups");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSMBLocalGroupsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSMBLocalGroupsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSMBLocalGroupsInput is not found in the empty JSON string", UpdateSMBLocalGroupsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSMBLocalGroupsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSMBLocalGroupsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateSMBLocalGroupsInput.openapiRequiredFields) {
      ...
      // validate the required field `SMBLocalGroups`
      UpdateSMBLocalGroupsInputSMBLocalGroups.validateJsonElement(jsonObj.get("SMBLocalGroups"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSMBLocalGroupsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSMBLocalGroupsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSMBLocalGroupsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSMBLocalGroupsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSMBLocalGroupsInput>() {
           @Override
           public void write(JsonWriter out, UpdateSMBLocalGroupsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSMBLocalGroupsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSMBLocalGroupsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSMBLocalGroupsInput
   * @throws IOException if the JSON string is invalid with respect to UpdateSMBLocalGroupsInput
   */
  public static UpdateSMBLocalGroupsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSMBLocalGroupsInput.class);
  }

  /**
   * Convert an instance of UpdateSMBLocalGroupsInput to an JSON string
   *
   * @return JSON string
   */
