...
public class VolumeiSCSIAttributes {
  ...
  public VolumeiSCSIAttributes targetARN(String targetARN) {
  ...
  public VolumeiSCSIAttributes networkInterfaceId(String networkInterfaceId) {
  ...
  public VolumeiSCSIAttributes networkInterfacePort(Integer networkInterfacePort) {
  ...
  public VolumeiSCSIAttributes lunNumber(Integer lunNumber) {
  ...
  public VolumeiSCSIAttributes chapEnabled(Boolean chapEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    VolumeiSCSIAttributes volumeiSCSIAttributes = (VolumeiSCSIAttributes) o;
    return Objects.equals(this.targetARN, volumeiSCSIAttributes.targetARN) &&
        Objects.equals(this.networkInterfaceId, volumeiSCSIAttributes.networkInterfaceId) &&
        Objects.equals(this.networkInterfacePort, volumeiSCSIAttributes.networkInterfacePort) &&
        Objects.equals(this.lunNumber, volumeiSCSIAttributes.lunNumber) &&
        Objects.equals(this.chapEnabled, volumeiSCSIAttributes.chapEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumeiSCSIAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VolumeiSCSIAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VolumeiSCSIAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeiSCSIAttributes is not found in the empty JSON string", VolumeiSCSIAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VolumeiSCSIAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VolumeiSCSIAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeiSCSIAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeiSCSIAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeiSCSIAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeiSCSIAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeiSCSIAttributes>() {
           @Override
           public void write(JsonWriter out, VolumeiSCSIAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VolumeiSCSIAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VolumeiSCSIAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VolumeiSCSIAttributes
   * @throws IOException if the JSON string is invalid with respect to VolumeiSCSIAttributes
   */
  public static VolumeiSCSIAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeiSCSIAttributes.class);
  }

  /**
   * Convert an instance of VolumeiSCSIAttributes to an JSON string
   *
   * @return JSON string
   */
