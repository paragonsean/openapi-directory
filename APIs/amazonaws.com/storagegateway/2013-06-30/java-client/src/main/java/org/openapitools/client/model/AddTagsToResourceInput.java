...
public class AddTagsToResourceInput {
  ...
  public AddTagsToResourceInput() {
  }

  public AddTagsToResourceInput resourceARN(String resourceARN) {
  ...
  public AddTagsToResourceInput tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddTagsToResourceInput addTagsToResourceInput = (AddTagsToResourceInput) o;
    return Objects.equals(this.resourceARN, addTagsToResourceInput.resourceARN) &&
        Objects.equals(this.tags, addTagsToResourceInput.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddTagsToResourceInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddTagsToResourceInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddTagsToResourceInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddTagsToResourceInput is not found in the empty JSON string", AddTagsToResourceInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddTagsToResourceInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddTagsToResourceInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddTagsToResourceInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddTagsToResourceInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddTagsToResourceInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddTagsToResourceInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddTagsToResourceInput.class));

       return (TypeAdapter<T>) new TypeAdapter<AddTagsToResourceInput>() {
           @Override
           public void write(JsonWriter out, AddTagsToResourceInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddTagsToResourceInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddTagsToResourceInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddTagsToResourceInput
   * @throws IOException if the JSON string is invalid with respect to AddTagsToResourceInput
   */
  public static AddTagsToResourceInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddTagsToResourceInput.class);
  }

  /**
   * Convert an instance of AddTagsToResourceInput to an JSON string
   *
   * @return JSON string
   */
