...
/**
 * Gets or Sets ActiveDirectoryStatus
 */
@JsonAdapter(ActiveDirectoryStatus.Adapter.class)
public enum ActiveDirectoryStatus {
  ...
  ActiveDirectoryStatus(String value) {
    this.value = value;
  }
  ...
  public static ActiveDirectoryStatus fromValue(String value) {
    for (ActiveDirectoryStatus b : ActiveDirectoryStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ActiveDirectoryStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ActiveDirectoryStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ActiveDirectoryStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ActiveDirectoryStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ActiveDirectoryStatus.fromValue(value);
  }
}
