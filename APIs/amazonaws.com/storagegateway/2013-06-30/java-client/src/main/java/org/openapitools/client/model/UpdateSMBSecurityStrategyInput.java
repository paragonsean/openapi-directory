...
public class UpdateSMBSecurityStrategyInput {
  ...
  public UpdateSMBSecurityStrategyInput() {
  }

  public UpdateSMBSecurityStrategyInput gatewayARN(String gatewayARN) {
  ...
  public UpdateSMBSecurityStrategyInput smBSecurityStrategy(SMBSecurityStrategy smBSecurityStrategy) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSMBSecurityStrategyInput updateSMBSecurityStrategyInput = (UpdateSMBSecurityStrategyInput) o;
    return Objects.equals(this.gatewayARN, updateSMBSecurityStrategyInput.gatewayARN) &&
        Objects.equals(this.smBSecurityStrategy, updateSMBSecurityStrategyInput.smBSecurityStrategy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, smBSecurityStrategy);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateSMBSecurityStrategyInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("SMBSecurityStrategy");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSMBSecurityStrategyInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSMBSecurityStrategyInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSMBSecurityStrategyInput is not found in the empty JSON string", UpdateSMBSecurityStrategyInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSMBSecurityStrategyInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSMBSecurityStrategyInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateSMBSecurityStrategyInput.openapiRequiredFields) {
      ...
      // validate the required field `SMBSecurityStrategy`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSMBSecurityStrategyInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSMBSecurityStrategyInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSMBSecurityStrategyInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSMBSecurityStrategyInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSMBSecurityStrategyInput>() {
           @Override
           public void write(JsonWriter out, UpdateSMBSecurityStrategyInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSMBSecurityStrategyInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSMBSecurityStrategyInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSMBSecurityStrategyInput
   * @throws IOException if the JSON string is invalid with respect to UpdateSMBSecurityStrategyInput
   */
  public static UpdateSMBSecurityStrategyInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSMBSecurityStrategyInput.class);
  }

  /**
   * Convert an instance of UpdateSMBSecurityStrategyInput to an JSON string
   *
   * @return JSON string
   */
