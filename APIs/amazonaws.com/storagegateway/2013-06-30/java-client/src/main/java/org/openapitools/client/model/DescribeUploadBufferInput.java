...
public class DescribeUploadBufferInput {
  ...
  public DescribeUploadBufferInput() {
  }

  public DescribeUploadBufferInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeUploadBufferInput describeUploadBufferInput = (DescribeUploadBufferInput) o;
    return Objects.equals(this.gatewayARN, describeUploadBufferInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeUploadBufferInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUploadBufferInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUploadBufferInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUploadBufferInput is not found in the empty JSON string", DescribeUploadBufferInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUploadBufferInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUploadBufferInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeUploadBufferInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUploadBufferInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUploadBufferInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUploadBufferInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUploadBufferInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUploadBufferInput>() {
           @Override
           public void write(JsonWriter out, DescribeUploadBufferInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUploadBufferInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUploadBufferInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUploadBufferInput
   * @throws IOException if the JSON string is invalid with respect to DescribeUploadBufferInput
   */
  public static DescribeUploadBufferInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUploadBufferInput.class);
  }

  /**
   * Convert an instance of DescribeUploadBufferInput to an JSON string
   *
   * @return JSON string
   */
