...
public class PoolInfo {
  ...
  public static final String SERIALIZED_NAME_POOL_STATUS = "PoolStatus";
  @SerializedName(SERIALIZED_NAME_POOL_STATUS)
  private PoolStatus poolStatus;

  public PoolInfo() {
  }

  public PoolInfo poolARN(String poolARN) {
  ...
  public PoolInfo poolName(String poolName) {
  ...
  public PoolInfo storageClass(TapeStorageClass storageClass) {
  ...
  public PoolInfo retentionLockType(RetentionLockType retentionLockType) {
  ...
  public PoolInfo retentionLockTimeInDays(Integer retentionLockTimeInDays) {
  ...
  public PoolInfo poolStatus(PoolStatus poolStatus) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.poolARN, poolInfo.poolARN) &&
        Objects.equals(this.poolName, poolInfo.poolName) &&
        Objects.equals(this.storageClass, poolInfo.storageClass) &&
        Objects.equals(this.retentionLockType, poolInfo.retentionLockType) &&
        Objects.equals(this.retentionLockTimeInDays, poolInfo.retentionLockTimeInDays) &&
        Objects.equals(this.poolStatus, poolInfo.poolStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(poolARN, poolName, storageClass, retentionLockType, retentionLockTimeInDays, poolStatus);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PoolInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PoolInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PoolInfo is not found in the empty JSON string", PoolInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PoolInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PoolInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("PoolStatus") != null && !jsonObj.get("PoolStatus").isJsonNull()) {
        PoolStatus.validateJsonElement(jsonObj.get("PoolStatus"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PoolInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PoolInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PoolInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PoolInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<PoolInfo>() {
           @Override
           public void write(JsonWriter out, PoolInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PoolInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PoolInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PoolInfo
   * @throws IOException if the JSON string is invalid with respect to PoolInfo
   */
  public static PoolInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PoolInfo.class);
  }

  /**
   * Convert an instance of PoolInfo to an JSON string
   *
   * @return JSON string
   */
