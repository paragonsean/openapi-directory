...
public class AssignTapePoolOutput {
  ...
  public AssignTapePoolOutput() {
  }

  public AssignTapePoolOutput tapeARN(String tapeARN) {
  ...
  public boolean equals(Object o) {
    ...
    AssignTapePoolOutput assignTapePoolOutput = (AssignTapePoolOutput) o;
    return Objects.equals(this.tapeARN, assignTapePoolOutput.tapeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssignTapePoolOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssignTapePoolOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssignTapePoolOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssignTapePoolOutput is not found in the empty JSON string", AssignTapePoolOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssignTapePoolOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssignTapePoolOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssignTapePoolOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssignTapePoolOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssignTapePoolOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssignTapePoolOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<AssignTapePoolOutput>() {
           @Override
           public void write(JsonWriter out, AssignTapePoolOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssignTapePoolOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssignTapePoolOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssignTapePoolOutput
   * @throws IOException if the JSON string is invalid with respect to AssignTapePoolOutput
   */
  public static AssignTapePoolOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssignTapePoolOutput.class);
  }

  /**
   * Convert an instance of AssignTapePoolOutput to an JSON string
   *
   * @return JSON string
   */
