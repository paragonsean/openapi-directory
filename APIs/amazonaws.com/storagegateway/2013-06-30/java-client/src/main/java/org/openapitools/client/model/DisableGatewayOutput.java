...
public class DisableGatewayOutput {
  ...
  public DisableGatewayOutput() {
  }

  public DisableGatewayOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DisableGatewayOutput disableGatewayOutput = (DisableGatewayOutput) o;
    return Objects.equals(this.gatewayARN, disableGatewayOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisableGatewayOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisableGatewayOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisableGatewayOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisableGatewayOutput is not found in the empty JSON string", DisableGatewayOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisableGatewayOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisableGatewayOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisableGatewayOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisableGatewayOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisableGatewayOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisableGatewayOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DisableGatewayOutput>() {
           @Override
           public void write(JsonWriter out, DisableGatewayOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisableGatewayOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisableGatewayOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisableGatewayOutput
   * @throws IOException if the JSON string is invalid with respect to DisableGatewayOutput
   */
  public static DisableGatewayOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisableGatewayOutput.class);
  }

  /**
   * Convert an instance of DisableGatewayOutput to an JSON string
   *
   * @return JSON string
   */
