...
public class AttachVolumeInput {
  ...
  public AttachVolumeInput() {
  }

  public AttachVolumeInput gatewayARN(String gatewayARN) {
  ...
  public AttachVolumeInput targetName(String targetName) {
  ...
  public AttachVolumeInput volumeARN(String volumeARN) {
  ...
  public AttachVolumeInput networkInterfaceId(String networkInterfaceId) {
  ...
  public AttachVolumeInput diskId(String diskId) {
    this.diskId = diskId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AttachVolumeInput attachVolumeInput = (AttachVolumeInput) o;
    return Objects.equals(this.gatewayARN, attachVolumeInput.gatewayARN) &&
        Objects.equals(this.targetName, attachVolumeInput.targetName) &&
        Objects.equals(this.volumeARN, attachVolumeInput.volumeARN) &&
        Objects.equals(this.networkInterfaceId, attachVolumeInput.networkInterfaceId) &&
        Objects.equals(this.diskId, attachVolumeInput.diskId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, targetName, volumeARN, networkInterfaceId, diskId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AttachVolumeInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttachVolumeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachVolumeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttachVolumeInput is not found in the empty JSON string", AttachVolumeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttachVolumeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttachVolumeInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AttachVolumeInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttachVolumeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttachVolumeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttachVolumeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttachVolumeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<AttachVolumeInput>() {
           @Override
           public void write(JsonWriter out, AttachVolumeInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttachVolumeInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AttachVolumeInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AttachVolumeInput
   * @throws IOException if the JSON string is invalid with respect to AttachVolumeInput
   */
  public static AttachVolumeInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttachVolumeInput.class);
  }

  /**
   * Convert an instance of AttachVolumeInput to an JSON string
   *
   * @return JSON string
   */
