...
public class FileSystemAssociationStatusDetail {
  ...
  public FileSystemAssociationStatusDetail() {
  }

  public FileSystemAssociationStatusDetail errorCode(String errorCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileSystemAssociationStatusDetail fileSystemAssociationStatusDetail = (FileSystemAssociationStatusDetail) o;
    return Objects.equals(this.errorCode, fileSystemAssociationStatusDetail.errorCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileSystemAssociationStatusDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FileSystemAssociationStatusDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FileSystemAssociationStatusDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileSystemAssociationStatusDetail is not found in the empty JSON string", FileSystemAssociationStatusDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FileSystemAssociationStatusDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FileSystemAssociationStatusDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileSystemAssociationStatusDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileSystemAssociationStatusDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileSystemAssociationStatusDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileSystemAssociationStatusDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<FileSystemAssociationStatusDetail>() {
           @Override
           public void write(JsonWriter out, FileSystemAssociationStatusDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FileSystemAssociationStatusDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FileSystemAssociationStatusDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FileSystemAssociationStatusDetail
   * @throws IOException if the JSON string is invalid with respect to FileSystemAssociationStatusDetail
   */
  public static FileSystemAssociationStatusDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileSystemAssociationStatusDetail.class);
  }

  /**
   * Convert an instance of FileSystemAssociationStatusDetail to an JSON string
   *
   * @return JSON string
   */
