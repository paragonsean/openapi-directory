...
public class VTLDeviceDeviceiSCSIAttributes {
  ...
  public VTLDeviceDeviceiSCSIAttributes() {
  }

  public VTLDeviceDeviceiSCSIAttributes targetARN(String targetARN) {
  ...
  public VTLDeviceDeviceiSCSIAttributes networkInterfaceId(String networkInterfaceId) {
  ...
  public VTLDeviceDeviceiSCSIAttributes networkInterfacePort(Integer networkInterfacePort) {
  ...
  public VTLDeviceDeviceiSCSIAttributes chapEnabled(Boolean chapEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    VTLDeviceDeviceiSCSIAttributes vtLDeviceDeviceiSCSIAttributes = (VTLDeviceDeviceiSCSIAttributes) o;
    return Objects.equals(this.targetARN, vtLDeviceDeviceiSCSIAttributes.targetARN) &&
        Objects.equals(this.networkInterfaceId, vtLDeviceDeviceiSCSIAttributes.networkInterfaceId) &&
        Objects.equals(this.networkInterfacePort, vtLDeviceDeviceiSCSIAttributes.networkInterfacePort) &&
        Objects.equals(this.chapEnabled, vtLDeviceDeviceiSCSIAttributes.chapEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(targetARN, networkInterfaceId, networkInterfacePort, chapEnabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VTLDeviceDeviceiSCSIAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VTLDeviceDeviceiSCSIAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VTLDeviceDeviceiSCSIAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VTLDeviceDeviceiSCSIAttributes is not found in the empty JSON string", VTLDeviceDeviceiSCSIAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VTLDeviceDeviceiSCSIAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VTLDeviceDeviceiSCSIAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VTLDeviceDeviceiSCSIAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VTLDeviceDeviceiSCSIAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VTLDeviceDeviceiSCSIAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VTLDeviceDeviceiSCSIAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<VTLDeviceDeviceiSCSIAttributes>() {
           @Override
           public void write(JsonWriter out, VTLDeviceDeviceiSCSIAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VTLDeviceDeviceiSCSIAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VTLDeviceDeviceiSCSIAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VTLDeviceDeviceiSCSIAttributes
   * @throws IOException if the JSON string is invalid with respect to VTLDeviceDeviceiSCSIAttributes
   */
  public static VTLDeviceDeviceiSCSIAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VTLDeviceDeviceiSCSIAttributes.class);
  }

  /**
   * Convert an instance of VTLDeviceDeviceiSCSIAttributes to an JSON string
   *
   * @return JSON string
   */
