...
public class AddCacheInput {
  ...
  public AddCacheInput() {
  }

  public AddCacheInput gatewayARN(String gatewayARN) {
  ...
  public AddCacheInput diskIds(List diskIds) {
  ...
  public boolean equals(Object o) {
    ...
    AddCacheInput addCacheInput = (AddCacheInput) o;
    return Objects.equals(this.gatewayARN, addCacheInput.gatewayARN) &&
        Objects.equals(this.diskIds, addCacheInput.diskIds);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddCacheInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddCacheInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCacheInput is not found in the empty JSON string", AddCacheInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddCacheInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddCacheInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddCacheInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCacheInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCacheInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCacheInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCacheInput.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCacheInput>() {
           @Override
           public void write(JsonWriter out, AddCacheInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddCacheInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddCacheInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddCacheInput
   * @throws IOException if the JSON string is invalid with respect to AddCacheInput
   */
  public static AddCacheInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCacheInput.class);
  }

  /**
   * Convert an instance of AddCacheInput to an JSON string
   *
   * @return JSON string
   */
