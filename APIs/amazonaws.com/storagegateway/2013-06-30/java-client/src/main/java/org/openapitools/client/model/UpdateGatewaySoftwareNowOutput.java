...
public class UpdateGatewaySoftwareNowOutput {
  ...
  public UpdateGatewaySoftwareNowOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateGatewaySoftwareNowOutput updateGatewaySoftwareNowOutput = (UpdateGatewaySoftwareNowOutput) o;
    return Objects.equals(this.gatewayARN, updateGatewaySoftwareNowOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateGatewaySoftwareNowOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGatewaySoftwareNowOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGatewaySoftwareNowOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGatewaySoftwareNowOutput is not found in the empty JSON string", UpdateGatewaySoftwareNowOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGatewaySoftwareNowOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGatewaySoftwareNowOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGatewaySoftwareNowOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGatewaySoftwareNowOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGatewaySoftwareNowOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGatewaySoftwareNowOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGatewaySoftwareNowOutput>() {
           @Override
           public void write(JsonWriter out, UpdateGatewaySoftwareNowOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGatewaySoftwareNowOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGatewaySoftwareNowOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGatewaySoftwareNowOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateGatewaySoftwareNowOutput
   */
  public static UpdateGatewaySoftwareNowOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGatewaySoftwareNowOutput.class);
  }

  /**
   * Convert an instance of UpdateGatewaySoftwareNowOutput to an JSON string
   *
   * @return JSON string
   */
