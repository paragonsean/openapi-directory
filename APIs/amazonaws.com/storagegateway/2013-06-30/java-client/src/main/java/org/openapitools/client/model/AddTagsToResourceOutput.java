...
public class AddTagsToResourceOutput {
  ...
  public AddTagsToResourceOutput() {
  }

  public AddTagsToResourceOutput resourceARN(String resourceARN) {
  ...
  public boolean equals(Object o) {
    ...
    AddTagsToResourceOutput addTagsToResourceOutput = (AddTagsToResourceOutput) o;
    return Objects.equals(this.resourceARN, addTagsToResourceOutput.resourceARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddTagsToResourceOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddTagsToResourceOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddTagsToResourceOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddTagsToResourceOutput is not found in the empty JSON string", AddTagsToResourceOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddTagsToResourceOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddTagsToResourceOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddTagsToResourceOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddTagsToResourceOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddTagsToResourceOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddTagsToResourceOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<AddTagsToResourceOutput>() {
           @Override
           public void write(JsonWriter out, AddTagsToResourceOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddTagsToResourceOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddTagsToResourceOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddTagsToResourceOutput
   * @throws IOException if the JSON string is invalid with respect to AddTagsToResourceOutput
   */
  public static AddTagsToResourceOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddTagsToResourceOutput.class);
  }

  /**
   * Convert an instance of AddTagsToResourceOutput to an JSON string
   *
   * @return JSON string
   */
