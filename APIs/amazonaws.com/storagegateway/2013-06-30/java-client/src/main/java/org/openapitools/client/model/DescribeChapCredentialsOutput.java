...
public class DescribeChapCredentialsOutput {
  public static final String SERIALIZED_NAME_CHAP_CREDENTIALS = "ChapCredentials";
  @SerializedName(SERIALIZED_NAME_CHAP_CREDENTIALS)
  private List chapCredentials;

  public DescribeChapCredentialsOutput() {
  }

  public DescribeChapCredentialsOutput chapCredentials(List chapCredentials) {
    this.chapCredentials = chapCredentials;
    return this;
  }
  ...
  public List getChapCredentials() {
    return chapCredentials;
  }

  public void setChapCredentials(List chapCredentials) {
    this.chapCredentials = chapCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeChapCredentialsOutput describeChapCredentialsOutput = (DescribeChapCredentialsOutput) o;
    return Objects.equals(this.chapCredentials, describeChapCredentialsOutput.chapCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chapCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeChapCredentialsOutput {\n");
    sb.append("    chapCredentials: ").append(toIndentedString(chapCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("ChapCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeChapCredentialsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeChapCredentialsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeChapCredentialsOutput is not found in the empty JSON string", DescribeChapCredentialsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeChapCredentialsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeChapCredentialsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ChapCredentials`
      if (jsonObj.get("ChapCredentials") != null && !jsonObj.get("ChapCredentials").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("ChapCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeChapCredentialsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeChapCredentialsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeChapCredentialsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeChapCredentialsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeChapCredentialsOutput>() {
           @Override
           public void write(JsonWriter out, DescribeChapCredentialsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeChapCredentialsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeChapCredentialsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeChapCredentialsOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeChapCredentialsOutput
   */
  public static DescribeChapCredentialsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeChapCredentialsOutput.class);
  }

  /**
   * Convert an instance of DescribeChapCredentialsOutput to an JSON string
   *
   * @return JSON string
   */
