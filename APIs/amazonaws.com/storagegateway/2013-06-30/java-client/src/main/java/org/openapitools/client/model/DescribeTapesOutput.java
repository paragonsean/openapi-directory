...
public class DescribeTapesOutput {
  public static final String SERIALIZED_NAME_TAPES = "Tapes";
  @SerializedName(SERIALIZED_NAME_TAPES)
  private List tapes;
  ...
  public DescribeTapesOutput() {
  }

  public DescribeTapesOutput tapes(List tapes) {
    this.tapes = tapes;
    return this;
  }
  ...
  public List getTapes() {
    return tapes;
  }

  public void setTapes(List tapes) {
    this.tapes = tapes;
  }


  public DescribeTapesOutput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeTapesOutput describeTapesOutput = (DescribeTapesOutput) o;
    return Objects.equals(this.tapes, describeTapesOutput.tapes) &&
        Objects.equals(this.marker, describeTapesOutput.marker);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tapes, marker);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeTapesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTapesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTapesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTapesOutput is not found in the empty JSON string", DescribeTapesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTapesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTapesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Tapes`
      if (jsonObj.get("Tapes") != null && !jsonObj.get("Tapes").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Tapes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTapesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTapesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTapesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTapesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTapesOutput>() {
           @Override
           public void write(JsonWriter out, DescribeTapesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTapesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTapesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTapesOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeTapesOutput
   */
  public static DescribeTapesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTapesOutput.class);
  }

  /**
   * Convert an instance of DescribeTapesOutput to an JSON string
   *
   * @return JSON string
   */
