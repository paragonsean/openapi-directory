...
public class DescribeTapeArchivesInput {
  ...
  public DescribeTapeArchivesInput() {
  }

  public DescribeTapeArchivesInput tapeARNs(List tapeARNs) {
  ...
  public DescribeTapeArchivesInput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public DescribeTapeArchivesInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeTapeArchivesInput describeTapeArchivesInput = (DescribeTapeArchivesInput) o;
    return Objects.equals(this.tapeARNs, describeTapeArchivesInput.tapeARNs) &&
        Objects.equals(this.marker, describeTapeArchivesInput.marker) &&
        Objects.equals(this.limit, describeTapeArchivesInput.limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTapeArchivesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTapeArchivesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTapeArchivesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTapeArchivesInput is not found in the empty JSON string", DescribeTapeArchivesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTapeArchivesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTapeArchivesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTapeArchivesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTapeArchivesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTapeArchivesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTapeArchivesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTapeArchivesInput>() {
           @Override
           public void write(JsonWriter out, DescribeTapeArchivesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTapeArchivesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTapeArchivesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTapeArchivesInput
   * @throws IOException if the JSON string is invalid with respect to DescribeTapeArchivesInput
   */
  public static DescribeTapeArchivesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTapeArchivesInput.class);
  }

  /**
   * Convert an instance of DescribeTapeArchivesInput to an JSON string
   *
   * @return JSON string
   */
