...
public class DeleteChapCredentialsInput {
  ...
  public DeleteChapCredentialsInput() {
  }

  public DeleteChapCredentialsInput targetARN(String targetARN) {
  ...
  public DeleteChapCredentialsInput initiatorName(String initiatorName) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteChapCredentialsInput deleteChapCredentialsInput = (DeleteChapCredentialsInput) o;
    return Objects.equals(this.targetARN, deleteChapCredentialsInput.targetARN) &&
        Objects.equals(this.initiatorName, deleteChapCredentialsInput.initiatorName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteChapCredentialsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteChapCredentialsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteChapCredentialsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteChapCredentialsInput is not found in the empty JSON string", DeleteChapCredentialsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteChapCredentialsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteChapCredentialsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteChapCredentialsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteChapCredentialsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteChapCredentialsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteChapCredentialsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteChapCredentialsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteChapCredentialsInput>() {
           @Override
           public void write(JsonWriter out, DeleteChapCredentialsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteChapCredentialsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteChapCredentialsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteChapCredentialsInput
   * @throws IOException if the JSON string is invalid with respect to DeleteChapCredentialsInput
   */
  public static DeleteChapCredentialsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteChapCredentialsInput.class);
  }

  /**
   * Convert an instance of DeleteChapCredentialsInput to an JSON string
   *
   * @return JSON string
   */
