...
public class ChapInfo {
  ...
  public ChapInfo targetARN(String targetARN) {
  ...
  public ChapInfo secretToAuthenticateInitiator(String secretToAuthenticateInitiator) {
  ...
  public ChapInfo initiatorName(String initiatorName) {
  ...
  public ChapInfo secretToAuthenticateTarget(String secretToAuthenticateTarget) {
  ...
  public boolean equals(Object o) {
    ...
    ChapInfo chapInfo = (ChapInfo) o;
    return Objects.equals(this.targetARN, chapInfo.targetARN) &&
        Objects.equals(this.secretToAuthenticateInitiator, chapInfo.secretToAuthenticateInitiator) &&
        Objects.equals(this.initiatorName, chapInfo.initiatorName) &&
        Objects.equals(this.secretToAuthenticateTarget, chapInfo.secretToAuthenticateTarget);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChapInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChapInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChapInfo is not found in the empty JSON string", ChapInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChapInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChapInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("SecretToAuthenticateInitiator") != null && !jsonObj.get("SecretToAuthenticateInitiator").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChapInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChapInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChapInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChapInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<ChapInfo>() {
           @Override
           public void write(JsonWriter out, ChapInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChapInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChapInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChapInfo
   * @throws IOException if the JSON string is invalid with respect to ChapInfo
   */
  public static ChapInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChapInfo.class);
  }

  /**
   * Convert an instance of ChapInfo to an JSON string
   *
   * @return JSON string
   */
