...
public class DeleteTapePoolInput {
  public static final String SERIALIZED_NAME_POOL_A_R_N = "PoolARN";
  @SerializedName(SERIALIZED_NAME_POOL_A_R_N)
  private String poolARN;

  public DeleteTapePoolInput() {
  }

  public DeleteTapePoolInput poolARN(String poolARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteTapePoolInput deleteTapePoolInput = (DeleteTapePoolInput) o;
    return Objects.equals(this.poolARN, deleteTapePoolInput.poolARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(poolARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteTapePoolInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTapePoolInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTapePoolInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTapePoolInput is not found in the empty JSON string", DeleteTapePoolInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTapePoolInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTapePoolInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteTapePoolInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTapePoolInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTapePoolInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTapePoolInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTapePoolInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTapePoolInput>() {
           @Override
           public void write(JsonWriter out, DeleteTapePoolInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTapePoolInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTapePoolInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTapePoolInput
   * @throws IOException if the JSON string is invalid with respect to DeleteTapePoolInput
   */
  public static DeleteTapePoolInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTapePoolInput.class);
  }

  /**
   * Convert an instance of DeleteTapePoolInput to an JSON string
   *
   * @return JSON string
   */
