...
public class DescribeNFSFileSharesInput {
  ...
  public DescribeNFSFileSharesInput() {
  }

  public DescribeNFSFileSharesInput fileShareARNList(List fileShareARNList) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeNFSFileSharesInput describeNFSFileSharesInput = (DescribeNFSFileSharesInput) o;
    return Objects.equals(this.fileShareARNList, describeNFSFileSharesInput.fileShareARNList);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeNFSFileSharesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeNFSFileSharesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeNFSFileSharesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeNFSFileSharesInput is not found in the empty JSON string", DescribeNFSFileSharesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeNFSFileSharesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeNFSFileSharesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeNFSFileSharesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeNFSFileSharesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeNFSFileSharesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeNFSFileSharesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeNFSFileSharesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeNFSFileSharesInput>() {
           @Override
           public void write(JsonWriter out, DescribeNFSFileSharesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeNFSFileSharesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeNFSFileSharesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeNFSFileSharesInput
   * @throws IOException if the JSON string is invalid with respect to DescribeNFSFileSharesInput
   */
  public static DescribeNFSFileSharesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeNFSFileSharesInput.class);
  }

  /**
   * Convert an instance of DescribeNFSFileSharesInput to an JSON string
   *
   * @return JSON string
   */
