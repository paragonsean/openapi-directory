...
public class DescribeBandwidthRateLimitInput {
  ...
  public DescribeBandwidthRateLimitInput() {
  }

  public DescribeBandwidthRateLimitInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeBandwidthRateLimitInput describeBandwidthRateLimitInput = (DescribeBandwidthRateLimitInput) o;
    return Objects.equals(this.gatewayARN, describeBandwidthRateLimitInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeBandwidthRateLimitInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeBandwidthRateLimitInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeBandwidthRateLimitInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeBandwidthRateLimitInput is not found in the empty JSON string", DescribeBandwidthRateLimitInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeBandwidthRateLimitInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeBandwidthRateLimitInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeBandwidthRateLimitInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeBandwidthRateLimitInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeBandwidthRateLimitInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeBandwidthRateLimitInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeBandwidthRateLimitInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeBandwidthRateLimitInput>() {
           @Override
           public void write(JsonWriter out, DescribeBandwidthRateLimitInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeBandwidthRateLimitInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeBandwidthRateLimitInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeBandwidthRateLimitInput
   * @throws IOException if the JSON string is invalid with respect to DescribeBandwidthRateLimitInput
   */
  public static DescribeBandwidthRateLimitInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeBandwidthRateLimitInput.class);
  }

  /**
   * Convert an instance of DescribeBandwidthRateLimitInput to an JSON string
   *
   * @return JSON string
   */
