...
public class CancelArchivalOutput {
  ...
  public CancelArchivalOutput() {
  }

  public CancelArchivalOutput tapeARN(String tapeARN) {
  ...
  public boolean equals(Object o) {
    ...
    CancelArchivalOutput cancelArchivalOutput = (CancelArchivalOutput) o;
    return Objects.equals(this.tapeARN, cancelArchivalOutput.tapeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelArchivalOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelArchivalOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelArchivalOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelArchivalOutput is not found in the empty JSON string", CancelArchivalOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelArchivalOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelArchivalOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelArchivalOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelArchivalOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelArchivalOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelArchivalOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelArchivalOutput>() {
           @Override
           public void write(JsonWriter out, CancelArchivalOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelArchivalOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelArchivalOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelArchivalOutput
   * @throws IOException if the JSON string is invalid with respect to CancelArchivalOutput
   */
  public static CancelArchivalOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelArchivalOutput.class);
  }

  /**
   * Convert an instance of CancelArchivalOutput to an JSON string
   *
   * @return JSON string
   */
