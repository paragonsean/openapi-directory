...
public class UpdateSMBFileShareVisibilityInput {
  ...
  public UpdateSMBFileShareVisibilityInput() {
  }

  public UpdateSMBFileShareVisibilityInput gatewayARN(String gatewayARN) {
  ...
  public UpdateSMBFileShareVisibilityInput fileSharesVisible(Boolean fileSharesVisible) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSMBFileShareVisibilityInput updateSMBFileShareVisibilityInput = (UpdateSMBFileShareVisibilityInput) o;
    return Objects.equals(this.gatewayARN, updateSMBFileShareVisibilityInput.gatewayARN) &&
        Objects.equals(this.fileSharesVisible, updateSMBFileShareVisibilityInput.fileSharesVisible);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, fileSharesVisible);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateSMBFileShareVisibilityInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("FileSharesVisible");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSMBFileShareVisibilityInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSMBFileShareVisibilityInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSMBFileShareVisibilityInput is not found in the empty JSON string", UpdateSMBFileShareVisibilityInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSMBFileShareVisibilityInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSMBFileShareVisibilityInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateSMBFileShareVisibilityInput.openapiRequiredFields) {
      ...
      // validate the required field `FileSharesVisible`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSMBFileShareVisibilityInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSMBFileShareVisibilityInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSMBFileShareVisibilityInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSMBFileShareVisibilityInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSMBFileShareVisibilityInput>() {
           @Override
           public void write(JsonWriter out, UpdateSMBFileShareVisibilityInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSMBFileShareVisibilityInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSMBFileShareVisibilityInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSMBFileShareVisibilityInput
   * @throws IOException if the JSON string is invalid with respect to UpdateSMBFileShareVisibilityInput
   */
  public static UpdateSMBFileShareVisibilityInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSMBFileShareVisibilityInput.class);
  }

  /**
   * Convert an instance of UpdateSMBFileShareVisibilityInput to an JSON string
   *
   * @return JSON string
   */
