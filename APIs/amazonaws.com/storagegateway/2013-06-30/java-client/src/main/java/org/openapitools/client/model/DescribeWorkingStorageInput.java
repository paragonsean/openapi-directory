...
public class DescribeWorkingStorageInput {
  ...
  public DescribeWorkingStorageInput() {
  }

  public DescribeWorkingStorageInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeWorkingStorageInput describeWorkingStorageInput = (DescribeWorkingStorageInput) o;
    return Objects.equals(this.gatewayARN, describeWorkingStorageInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeWorkingStorageInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeWorkingStorageInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeWorkingStorageInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeWorkingStorageInput is not found in the empty JSON string", DescribeWorkingStorageInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeWorkingStorageInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeWorkingStorageInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeWorkingStorageInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeWorkingStorageInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeWorkingStorageInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeWorkingStorageInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeWorkingStorageInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeWorkingStorageInput>() {
           @Override
           public void write(JsonWriter out, DescribeWorkingStorageInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeWorkingStorageInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeWorkingStorageInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeWorkingStorageInput
   * @throws IOException if the JSON string is invalid with respect to DescribeWorkingStorageInput
   */
  public static DescribeWorkingStorageInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeWorkingStorageInput.class);
  }

  /**
   * Convert an instance of DescribeWorkingStorageInput to an JSON string
   *
   * @return JSON string
   */
