...
public class AttachVolumeOutput {
  ...
  public AttachVolumeOutput() {
  }

  public AttachVolumeOutput volumeARN(String volumeARN) {
  ...
  public AttachVolumeOutput targetARN(String targetARN) {
  ...
  public boolean equals(Object o) {
    ...
    AttachVolumeOutput attachVolumeOutput = (AttachVolumeOutput) o;
    return Objects.equals(this.volumeARN, attachVolumeOutput.volumeARN) &&
        Objects.equals(this.targetARN, attachVolumeOutput.targetARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttachVolumeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttachVolumeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachVolumeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttachVolumeOutput is not found in the empty JSON string", AttachVolumeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttachVolumeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttachVolumeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttachVolumeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttachVolumeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttachVolumeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttachVolumeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<AttachVolumeOutput>() {
           @Override
           public void write(JsonWriter out, AttachVolumeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttachVolumeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AttachVolumeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AttachVolumeOutput
   * @throws IOException if the JSON string is invalid with respect to AttachVolumeOutput
   */
  public static AttachVolumeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttachVolumeOutput.class);
  }

  /**
   * Convert an instance of AttachVolumeOutput to an JSON string
   *
   * @return JSON string
   */
