...
public class AddUploadBufferOutput {
  ...
  public AddUploadBufferOutput() {
  }

  public AddUploadBufferOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    AddUploadBufferOutput addUploadBufferOutput = (AddUploadBufferOutput) o;
    return Objects.equals(this.gatewayARN, addUploadBufferOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddUploadBufferOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddUploadBufferOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddUploadBufferOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddUploadBufferOutput is not found in the empty JSON string", AddUploadBufferOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddUploadBufferOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddUploadBufferOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddUploadBufferOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddUploadBufferOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddUploadBufferOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddUploadBufferOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<AddUploadBufferOutput>() {
           @Override
           public void write(JsonWriter out, AddUploadBufferOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddUploadBufferOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddUploadBufferOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddUploadBufferOutput
   * @throws IOException if the JSON string is invalid with respect to AddUploadBufferOutput
   */
  public static AddUploadBufferOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddUploadBufferOutput.class);
  }

  /**
   * Convert an instance of AddUploadBufferOutput to an JSON string
   *
   * @return JSON string
   */
