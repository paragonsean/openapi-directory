...
public class DescribeSMBFileSharesInput {
  public static final String SERIALIZED_NAME_FILE_SHARE_A_R_N_LIST = "FileShareARNList";
  @SerializedName(SERIALIZED_NAME_FILE_SHARE_A_R_N_LIST)
  private List fileShareARNList;

  public DescribeSMBFileSharesInput() {
  }

  public DescribeSMBFileSharesInput fileShareARNList(List fileShareARNList) {
    this.fileShareARNList = fileShareARNList;
    return this;
  }

  /**
   * Get fileShareARNList
   * @return fileShareARNList
   */
  @javax.annotation.Nonnull
  public List getFileShareARNList() {
    return fileShareARNList;
  }

  public void setFileShareARNList(List fileShareARNList) {
    this.fileShareARNList = fileShareARNList;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeSMBFileSharesInput describeSMBFileSharesInput = (DescribeSMBFileSharesInput) o;
    return Objects.equals(this.fileShareARNList, describeSMBFileSharesInput.fileShareARNList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileShareARNList);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeSMBFileSharesInput {\n");
    sb.append("    fileShareARNList: ").append(toIndentedString(fileShareARNList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("FileShareARNList");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("FileShareARNList");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeSMBFileSharesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeSMBFileSharesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeSMBFileSharesInput is not found in the empty JSON string", DescribeSMBFileSharesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeSMBFileSharesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeSMBFileSharesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeSMBFileSharesInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `FileShareARNList`
      List.validateJsonElement(jsonObj.get("FileShareARNList"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeSMBFileSharesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeSMBFileSharesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeSMBFileSharesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeSMBFileSharesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeSMBFileSharesInput>() {
           @Override
           public void write(JsonWriter out, DescribeSMBFileSharesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeSMBFileSharesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeSMBFileSharesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeSMBFileSharesInput
   * @throws IOException if the JSON string is invalid with respect to DescribeSMBFileSharesInput
   */
  public static DescribeSMBFileSharesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeSMBFileSharesInput.class);
  }

  /**
   * Convert an instance of DescribeSMBFileSharesInput to an JSON string
   *
   * @return JSON string
   */
