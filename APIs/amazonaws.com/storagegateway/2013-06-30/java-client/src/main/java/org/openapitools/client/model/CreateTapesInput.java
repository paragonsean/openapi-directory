...
public class CreateTapesInput {
  ...
  public static final String SERIALIZED_NAME_NUM_TAPES_TO_CREATE = "NumTapesToCreate";
  @SerializedName(SERIALIZED_NAME_NUM_TAPES_TO_CREATE)
  ...
  public CreateTapesInput() {
  }

  public CreateTapesInput gatewayARN(String gatewayARN) {
  ...
  public CreateTapesInput tapeSizeInBytes(Integer tapeSizeInBytes) {
  ...
  public CreateTapesInput clientToken(String clientToken) {
  ...
  public CreateTapesInput numTapesToCreate(Integer numTapesToCreate) {
    this.numTapesToCreate = numTapesToCreate;
    return this;
  }

  /**
   * Get numTapesToCreate
  ...
  public CreateTapesInput tapeBarcodePrefix(String tapeBarcodePrefix) {
  ...
  public CreateTapesInput kmSEncrypted(Boolean kmSEncrypted) {
  ...
  public CreateTapesInput kmSKey(String kmSKey) {
    this.kmSKey = kmSKey;
    return this;
  }
  ...
  public CreateTapesInput poolId(String poolId) {
    this.poolId = poolId;
    return this;
  }
  ...
  public CreateTapesInput worm(Boolean worm) {
    this.worm = worm;
    return this;
  }
  ...
  public CreateTapesInput tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateTapesInput createTapesInput = (CreateTapesInput) o;
    return Objects.equals(this.gatewayARN, createTapesInput.gatewayARN) &&
        Objects.equals(this.tapeSizeInBytes, createTapesInput.tapeSizeInBytes) &&
        Objects.equals(this.clientToken, createTapesInput.clientToken) &&
        Objects.equals(this.numTapesToCreate, createTapesInput.numTapesToCreate) &&
        Objects.equals(this.tapeBarcodePrefix, createTapesInput.tapeBarcodePrefix) &&
        Objects.equals(this.kmSEncrypted, createTapesInput.kmSEncrypted) &&
        Objects.equals(this.kmSKey, createTapesInput.kmSKey) &&
        Objects.equals(this.poolId, createTapesInput.poolId) &&
        Objects.equals(this.worm, createTapesInput.worm) &&
        Objects.equals(this.tags, createTapesInput.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, tapeSizeInBytes, clientToken, numTapesToCreate, tapeBarcodePrefix, kmSEncrypted, kmSKey, poolId, worm, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateTapesInput {\n");
    ...
    sb.append("    numTapesToCreate: ").append(toIndentedString(numTapesToCreate)).append("\n");
  ...
  static {
    ...
    openapiFields.add("NumTapesToCreate");
    ...
    openapiRequiredFields.add("NumTapesToCreate");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateTapesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTapesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateTapesInput is not found in the empty JSON string", CreateTapesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTapesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTapesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateTapesInput.openapiRequiredFields) {
      ...
      // validate the required field `NumTapesToCreate`
      Integer.validateJsonElement(jsonObj.get("NumTapesToCreate"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTapesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTapesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTapesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTapesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTapesInput>() {
           @Override
           public void write(JsonWriter out, CreateTapesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTapesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateTapesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateTapesInput
   * @throws IOException if the JSON string is invalid with respect to CreateTapesInput
   */
  public static CreateTapesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTapesInput.class);
  }

  /**
   * Convert an instance of CreateTapesInput to an JSON string
   *
   * @return JSON string
   */
