...
import org.openapitools.client.model.FileShareType;
...
public class FileShareInfo {
  public static final String SERIALIZED_NAME_FILE_SHARE_TYPE = "FileShareType";
  @SerializedName(SERIALIZED_NAME_FILE_SHARE_TYPE)
  private FileShareType fileShareType;
  ...
  public FileShareInfo fileShareType(FileShareType fileShareType) {
  ...
  public FileShareType getFileShareType() {
    return fileShareType;
  }
  ...
  public FileShareInfo fileShareARN(String fileShareARN) {
  ...
  public FileShareInfo fileShareId(String fileShareId) {
  ...
  public FileShareInfo fileShareStatus(String fileShareStatus) {
  ...
  public FileShareInfo gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    FileShareInfo fileShareInfo = (FileShareInfo) o;
    return Objects.equals(this.fileShareType, fileShareInfo.fileShareType) &&
        Objects.equals(this.fileShareARN, fileShareInfo.fileShareARN) &&
        Objects.equals(this.fileShareId, fileShareInfo.fileShareId) &&
        Objects.equals(this.fileShareStatus, fileShareInfo.fileShareStatus) &&
        Objects.equals(this.gatewayARN, fileShareInfo.gatewayARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileShareType, fileShareARN, fileShareId, fileShareStatus, gatewayARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileShareInfo {\n");
    sb.append("    fileShareType: ").append(toIndentedString(fileShareType)).append("\n");
  ...
  static {
    ...
    openapiFields.add("FileShareType");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FileShareInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FileShareInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileShareInfo is not found in the empty JSON string", FileShareInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FileShareInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FileShareInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `FileShareType`
      if (jsonObj.get("FileShareType") != null && !jsonObj.get("FileShareType").isJsonNull()) {
        FileShareType.validateJsonElement(jsonObj.get("FileShareType"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileShareInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileShareInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileShareInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileShareInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<FileShareInfo>() {
           @Override
           public void write(JsonWriter out, FileShareInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FileShareInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FileShareInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FileShareInfo
   * @throws IOException if the JSON string is invalid with respect to FileShareInfo
   */
  public static FileShareInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileShareInfo.class);
  }

  /**
   * Convert an instance of FileShareInfo to an JSON string
   *
   * @return JSON string
   */
