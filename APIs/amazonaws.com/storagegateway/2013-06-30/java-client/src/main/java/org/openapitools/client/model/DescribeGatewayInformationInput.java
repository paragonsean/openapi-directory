...
public class DescribeGatewayInformationInput {
  ...
  public DescribeGatewayInformationInput() {
  }

  public DescribeGatewayInformationInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeGatewayInformationInput describeGatewayInformationInput = (DescribeGatewayInformationInput) o;
    return Objects.equals(this.gatewayARN, describeGatewayInformationInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeGatewayInformationInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeGatewayInformationInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeGatewayInformationInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeGatewayInformationInput is not found in the empty JSON string", DescribeGatewayInformationInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeGatewayInformationInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeGatewayInformationInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeGatewayInformationInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeGatewayInformationInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeGatewayInformationInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeGatewayInformationInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeGatewayInformationInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeGatewayInformationInput>() {
           @Override
           public void write(JsonWriter out, DescribeGatewayInformationInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeGatewayInformationInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeGatewayInformationInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeGatewayInformationInput
   * @throws IOException if the JSON string is invalid with respect to DescribeGatewayInformationInput
   */
  public static DescribeGatewayInformationInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeGatewayInformationInput.class);
  }

  /**
   * Convert an instance of DescribeGatewayInformationInput to an JSON string
   *
   * @return JSON string
   */
