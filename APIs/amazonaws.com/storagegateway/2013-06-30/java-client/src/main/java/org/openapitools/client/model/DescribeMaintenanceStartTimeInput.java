...
public class DescribeMaintenanceStartTimeInput {
  ...
  public DescribeMaintenanceStartTimeInput() {
  }

  public DescribeMaintenanceStartTimeInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeMaintenanceStartTimeInput describeMaintenanceStartTimeInput = (DescribeMaintenanceStartTimeInput) o;
    return Objects.equals(this.gatewayARN, describeMaintenanceStartTimeInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeMaintenanceStartTimeInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeMaintenanceStartTimeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeMaintenanceStartTimeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeMaintenanceStartTimeInput is not found in the empty JSON string", DescribeMaintenanceStartTimeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeMaintenanceStartTimeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeMaintenanceStartTimeInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeMaintenanceStartTimeInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeMaintenanceStartTimeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeMaintenanceStartTimeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeMaintenanceStartTimeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeMaintenanceStartTimeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeMaintenanceStartTimeInput>() {
           @Override
           public void write(JsonWriter out, DescribeMaintenanceStartTimeInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeMaintenanceStartTimeInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeMaintenanceStartTimeInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeMaintenanceStartTimeInput
   * @throws IOException if the JSON string is invalid with respect to DescribeMaintenanceStartTimeInput
   */
  public static DescribeMaintenanceStartTimeInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeMaintenanceStartTimeInput.class);
  }

  /**
   * Convert an instance of DescribeMaintenanceStartTimeInput to an JSON string
   *
   * @return JSON string
   */
