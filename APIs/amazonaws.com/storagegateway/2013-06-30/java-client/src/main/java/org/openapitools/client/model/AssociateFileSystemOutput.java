...
public class AssociateFileSystemOutput {
  ...
  public AssociateFileSystemOutput() {
  }

  public AssociateFileSystemOutput fileSystemAssociationARN(String fileSystemAssociationARN) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateFileSystemOutput associateFileSystemOutput = (AssociateFileSystemOutput) o;
    return Objects.equals(this.fileSystemAssociationARN, associateFileSystemOutput.fileSystemAssociationARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssociateFileSystemOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateFileSystemOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateFileSystemOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateFileSystemOutput is not found in the empty JSON string", AssociateFileSystemOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateFileSystemOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateFileSystemOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateFileSystemOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateFileSystemOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateFileSystemOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateFileSystemOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateFileSystemOutput>() {
           @Override
           public void write(JsonWriter out, AssociateFileSystemOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateFileSystemOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateFileSystemOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateFileSystemOutput
   * @throws IOException if the JSON string is invalid with respect to AssociateFileSystemOutput
   */
  public static AssociateFileSystemOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateFileSystemOutput.class);
  }

  /**
   * Convert an instance of AssociateFileSystemOutput to an JSON string
   *
   * @return JSON string
   */
