...
public class StartAvailabilityMonitorTestInput {
  ...
  public StartAvailabilityMonitorTestInput() {
  }

  public StartAvailabilityMonitorTestInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    StartAvailabilityMonitorTestInput startAvailabilityMonitorTestInput = (StartAvailabilityMonitorTestInput) o;
    return Objects.equals(this.gatewayARN, startAvailabilityMonitorTestInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartAvailabilityMonitorTestInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartAvailabilityMonitorTestInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartAvailabilityMonitorTestInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartAvailabilityMonitorTestInput is not found in the empty JSON string", StartAvailabilityMonitorTestInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartAvailabilityMonitorTestInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartAvailabilityMonitorTestInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartAvailabilityMonitorTestInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartAvailabilityMonitorTestInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartAvailabilityMonitorTestInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartAvailabilityMonitorTestInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartAvailabilityMonitorTestInput.class));

       return (TypeAdapter<T>) new TypeAdapter<StartAvailabilityMonitorTestInput>() {
           @Override
           public void write(JsonWriter out, StartAvailabilityMonitorTestInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartAvailabilityMonitorTestInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartAvailabilityMonitorTestInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartAvailabilityMonitorTestInput
   * @throws IOException if the JSON string is invalid with respect to StartAvailabilityMonitorTestInput
   */
  public static StartAvailabilityMonitorTestInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartAvailabilityMonitorTestInput.class);
  }

  /**
   * Convert an instance of StartAvailabilityMonitorTestInput to an JSON string
   *
   * @return JSON string
   */
