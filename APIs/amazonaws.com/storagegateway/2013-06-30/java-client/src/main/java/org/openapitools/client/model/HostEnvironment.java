...
/**
 * Gets or Sets HostEnvironment
 */
@JsonAdapter(HostEnvironment.Adapter.class)
public enum HostEnvironment {
  ...
  public static HostEnvironment fromValue(String value) {
    for (HostEnvironment b : HostEnvironment.values()) {
  ...
  public static class Adapter extends TypeAdapter<HostEnvironment> {
    @Override
    public void write(final JsonWriter jsonWriter, final HostEnvironment enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public HostEnvironment read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return HostEnvironment.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    HostEnvironment.fromValue(value);
  }
}
