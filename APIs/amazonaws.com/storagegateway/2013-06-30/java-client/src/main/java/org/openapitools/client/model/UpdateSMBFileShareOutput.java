...
public class UpdateSMBFileShareOutput {
  ...
  public UpdateSMBFileShareOutput() {
  }

  public UpdateSMBFileShareOutput fileShareARN(String fileShareARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSMBFileShareOutput updateSMBFileShareOutput = (UpdateSMBFileShareOutput) o;
    return Objects.equals(this.fileShareARN, updateSMBFileShareOutput.fileShareARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSMBFileShareOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSMBFileShareOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSMBFileShareOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSMBFileShareOutput is not found in the empty JSON string", UpdateSMBFileShareOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSMBFileShareOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSMBFileShareOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSMBFileShareOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSMBFileShareOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSMBFileShareOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSMBFileShareOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSMBFileShareOutput>() {
           @Override
           public void write(JsonWriter out, UpdateSMBFileShareOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSMBFileShareOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSMBFileShareOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSMBFileShareOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateSMBFileShareOutput
   */
  public static UpdateSMBFileShareOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSMBFileShareOutput.class);
  }

  /**
   * Convert an instance of UpdateSMBFileShareOutput to an JSON string
   *
   * @return JSON string
   */
