...
public class DescribeCacheInput {
  ...
  public DescribeCacheInput() {
  }

  public DescribeCacheInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeCacheInput describeCacheInput = (DescribeCacheInput) o;
    return Objects.equals(this.gatewayARN, describeCacheInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeCacheInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCacheInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCacheInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCacheInput is not found in the empty JSON string", DescribeCacheInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCacheInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCacheInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeCacheInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCacheInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCacheInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCacheInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCacheInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCacheInput>() {
           @Override
           public void write(JsonWriter out, DescribeCacheInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCacheInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCacheInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCacheInput
   * @throws IOException if the JSON string is invalid with respect to DescribeCacheInput
   */
  public static DescribeCacheInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCacheInput.class);
  }

  /**
   * Convert an instance of DescribeCacheInput to an JSON string
   *
   * @return JSON string
   */
