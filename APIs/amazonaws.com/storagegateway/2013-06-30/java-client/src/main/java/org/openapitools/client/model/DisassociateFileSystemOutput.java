...
public class DisassociateFileSystemOutput {
  ...
  public DisassociateFileSystemOutput() {
  }

  public DisassociateFileSystemOutput fileSystemAssociationARN(String fileSystemAssociationARN) {
  ...
  public boolean equals(Object o) {
    ...
    DisassociateFileSystemOutput disassociateFileSystemOutput = (DisassociateFileSystemOutput) o;
    return Objects.equals(this.fileSystemAssociationARN, disassociateFileSystemOutput.fileSystemAssociationARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisassociateFileSystemOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateFileSystemOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateFileSystemOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateFileSystemOutput is not found in the empty JSON string", DisassociateFileSystemOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateFileSystemOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateFileSystemOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateFileSystemOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateFileSystemOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateFileSystemOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateFileSystemOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateFileSystemOutput>() {
           @Override
           public void write(JsonWriter out, DisassociateFileSystemOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateFileSystemOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateFileSystemOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateFileSystemOutput
   * @throws IOException if the JSON string is invalid with respect to DisassociateFileSystemOutput
   */
  public static DisassociateFileSystemOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateFileSystemOutput.class);
  }

  /**
   * Convert an instance of DisassociateFileSystemOutput to an JSON string
   *
   * @return JSON string
   */
