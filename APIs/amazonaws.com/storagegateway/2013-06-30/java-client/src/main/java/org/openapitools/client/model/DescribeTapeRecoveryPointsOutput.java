...
public class DescribeTapeRecoveryPointsOutput {
  ...
  public static final String SERIALIZED_NAME_TAPE_RECOVERY_POINT_INFOS = "TapeRecoveryPointInfos";
  @SerializedName(SERIALIZED_NAME_TAPE_RECOVERY_POINT_INFOS)
  private List tapeRecoveryPointInfos;

  public static final String SERIALIZED_NAME_MARKER = "Marker";
  @SerializedName(SERIALIZED_NAME_MARKER)
  private String marker;

  public DescribeTapeRecoveryPointsOutput() {
  }

  public DescribeTapeRecoveryPointsOutput gatewayARN(String gatewayARN) {
  ...
  public DescribeTapeRecoveryPointsOutput tapeRecoveryPointInfos(List tapeRecoveryPointInfos) {
    this.tapeRecoveryPointInfos = tapeRecoveryPointInfos;
    return this;
  }

  /**
   * Get tapeRecoveryPointInfos
   * @return tapeRecoveryPointInfos
   */
  @javax.annotation.Nullable
  public List getTapeRecoveryPointInfos() {
    return tapeRecoveryPointInfos;
  }

  public void setTapeRecoveryPointInfos(List tapeRecoveryPointInfos) {
    this.tapeRecoveryPointInfos = tapeRecoveryPointInfos;
  }


  public DescribeTapeRecoveryPointsOutput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeTapeRecoveryPointsOutput describeTapeRecoveryPointsOutput = (DescribeTapeRecoveryPointsOutput) o;
    return Objects.equals(this.gatewayARN, describeTapeRecoveryPointsOutput.gatewayARN) &&
        Objects.equals(this.tapeRecoveryPointInfos, describeTapeRecoveryPointsOutput.tapeRecoveryPointInfos) &&
        Objects.equals(this.marker, describeTapeRecoveryPointsOutput.marker);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, tapeRecoveryPointInfos, marker);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeTapeRecoveryPointsOutput {\n");
    sb.append("    gatewayARN: ").append(toIndentedString(gatewayARN)).append("\n");
    sb.append("    tapeRecoveryPointInfos: ").append(toIndentedString(tapeRecoveryPointInfos)).append("\n");
  ...
  static {
    ...
    openapiFields.add("TapeRecoveryPointInfos");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTapeRecoveryPointsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTapeRecoveryPointsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTapeRecoveryPointsOutput is not found in the empty JSON string", DescribeTapeRecoveryPointsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTapeRecoveryPointsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTapeRecoveryPointsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `TapeRecoveryPointInfos`
      if (jsonObj.get("TapeRecoveryPointInfos") != null && !jsonObj.get("TapeRecoveryPointInfos").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("TapeRecoveryPointInfos"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTapeRecoveryPointsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTapeRecoveryPointsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTapeRecoveryPointsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTapeRecoveryPointsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTapeRecoveryPointsOutput>() {
           @Override
           public void write(JsonWriter out, DescribeTapeRecoveryPointsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTapeRecoveryPointsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTapeRecoveryPointsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTapeRecoveryPointsOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeTapeRecoveryPointsOutput
   */
  public static DescribeTapeRecoveryPointsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTapeRecoveryPointsOutput.class);
  }

  /**
   * Convert an instance of DescribeTapeRecoveryPointsOutput to an JSON string
   *
   * @return JSON string
   */
