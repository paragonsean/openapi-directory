...
public class ListAutomaticTapeCreationPoliciesInput {
  ...
  public ListAutomaticTapeCreationPoliciesInput() {
  }

  public ListAutomaticTapeCreationPoliciesInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    ListAutomaticTapeCreationPoliciesInput listAutomaticTapeCreationPoliciesInput = (ListAutomaticTapeCreationPoliciesInput) o;
    return Objects.equals(this.gatewayARN, listAutomaticTapeCreationPoliciesInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAutomaticTapeCreationPoliciesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAutomaticTapeCreationPoliciesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAutomaticTapeCreationPoliciesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAutomaticTapeCreationPoliciesInput is not found in the empty JSON string", ListAutomaticTapeCreationPoliciesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAutomaticTapeCreationPoliciesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAutomaticTapeCreationPoliciesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAutomaticTapeCreationPoliciesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAutomaticTapeCreationPoliciesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAutomaticTapeCreationPoliciesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAutomaticTapeCreationPoliciesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAutomaticTapeCreationPoliciesInput>() {
           @Override
           public void write(JsonWriter out, ListAutomaticTapeCreationPoliciesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAutomaticTapeCreationPoliciesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAutomaticTapeCreationPoliciesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAutomaticTapeCreationPoliciesInput
   * @throws IOException if the JSON string is invalid with respect to ListAutomaticTapeCreationPoliciesInput
   */
  public static ListAutomaticTapeCreationPoliciesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAutomaticTapeCreationPoliciesInput.class);
  }

  /**
   * Convert an instance of ListAutomaticTapeCreationPoliciesInput to an JSON string
   *
   * @return JSON string
   */
