...
public class ResetCacheInput {
  ...
  public ResetCacheInput() {
  }

  public ResetCacheInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    ResetCacheInput resetCacheInput = (ResetCacheInput) o;
    return Objects.equals(this.gatewayARN, resetCacheInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResetCacheInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResetCacheInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResetCacheInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResetCacheInput is not found in the empty JSON string", ResetCacheInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResetCacheInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResetCacheInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResetCacheInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResetCacheInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResetCacheInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResetCacheInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResetCacheInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ResetCacheInput>() {
           @Override
           public void write(JsonWriter out, ResetCacheInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResetCacheInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResetCacheInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResetCacheInput
   * @throws IOException if the JSON string is invalid with respect to ResetCacheInput
   */
  public static ResetCacheInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResetCacheInput.class);
  }

  /**
   * Convert an instance of ResetCacheInput to an JSON string
   *
   * @return JSON string
   */
