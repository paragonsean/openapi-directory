...
public class UpdateSMBSecurityStrategyOutput {
  ...
  public UpdateSMBSecurityStrategyOutput() {
  }

  public UpdateSMBSecurityStrategyOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSMBSecurityStrategyOutput updateSMBSecurityStrategyOutput = (UpdateSMBSecurityStrategyOutput) o;
    return Objects.equals(this.gatewayARN, updateSMBSecurityStrategyOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSMBSecurityStrategyOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSMBSecurityStrategyOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSMBSecurityStrategyOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSMBSecurityStrategyOutput is not found in the empty JSON string", UpdateSMBSecurityStrategyOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSMBSecurityStrategyOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSMBSecurityStrategyOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSMBSecurityStrategyOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSMBSecurityStrategyOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSMBSecurityStrategyOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSMBSecurityStrategyOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSMBSecurityStrategyOutput>() {
           @Override
           public void write(JsonWriter out, UpdateSMBSecurityStrategyOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSMBSecurityStrategyOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSMBSecurityStrategyOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSMBSecurityStrategyOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateSMBSecurityStrategyOutput
   */
  public static UpdateSMBSecurityStrategyOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSMBSecurityStrategyOutput.class);
  }

  /**
   * Convert an instance of UpdateSMBSecurityStrategyOutput to an JSON string
   *
   * @return JSON string
   */
