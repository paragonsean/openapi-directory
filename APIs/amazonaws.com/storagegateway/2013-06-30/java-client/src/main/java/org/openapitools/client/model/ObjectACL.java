 ...
 */
@JsonAdapter(ObjectACL.Adapter.class)
public enum ObjectACL {
  ...
  public static ObjectACL fromValue(String value) {
    for (ObjectACL b : ObjectACL.values()) {
  ...
  public static class Adapter extends TypeAdapter<ObjectACL> {
    @Override
    public void write(final JsonWriter jsonWriter, final ObjectACL enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ObjectACL read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ObjectACL.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ObjectACL.fromValue(value);
  }
}
