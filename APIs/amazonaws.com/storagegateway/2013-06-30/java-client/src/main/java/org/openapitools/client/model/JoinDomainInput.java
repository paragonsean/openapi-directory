...
public class JoinDomainInput {
  ...
  public static final String SERIALIZED_NAME_DOMAIN_CONTROLLERS = "DomainControllers";
  @SerializedName(SERIALIZED_NAME_DOMAIN_CONTROLLERS)
  private List domainControllers;
  ...
  public JoinDomainInput() {
  }

  public JoinDomainInput gatewayARN(String gatewayARN) {
  ...
  public JoinDomainInput domainName(String domainName) {
  ...
  public JoinDomainInput organizationalUnit(String organizationalUnit) {
  ...
  public JoinDomainInput domainControllers(List domainControllers) {
   ...
   */
  @javax.annotation.Nullable
  public List getDomainControllers() {
    return domainControllers;
  }

  public void setDomainControllers(List domainControllers) {
    this.domainControllers = domainControllers;
  }


  public JoinDomainInput timeoutInSeconds(Integer timeoutInSeconds) {
  ...
  public JoinDomainInput userName(String userName) {
  ...
  public JoinDomainInput password(String password) {
  ...
  public boolean equals(Object o) {
    ...
    JoinDomainInput joinDomainInput = (JoinDomainInput) o;
    return Objects.equals(this.gatewayARN, joinDomainInput.gatewayARN) &&
        Objects.equals(this.domainName, joinDomainInput.domainName) &&
        Objects.equals(this.organizationalUnit, joinDomainInput.organizationalUnit) &&
        Objects.equals(this.domainControllers, joinDomainInput.domainControllers) &&
        Objects.equals(this.timeoutInSeconds, joinDomainInput.timeoutInSeconds) &&
        Objects.equals(this.userName, joinDomainInput.userName) &&
        Objects.equals(this.password, joinDomainInput.password);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, domainName, organizationalUnit, domainControllers, timeoutInSeconds, userName, password);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JoinDomainInput {\n");
  ...
  static {
    ...
    openapiFields.add("DomainControllers");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JoinDomainInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JoinDomainInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JoinDomainInput is not found in the empty JSON string", JoinDomainInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JoinDomainInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JoinDomainInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JoinDomainInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("DomainControllers") != null && !jsonObj.get("DomainControllers").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("DomainControllers"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JoinDomainInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JoinDomainInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JoinDomainInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JoinDomainInput.class));

       return (TypeAdapter<T>) new TypeAdapter<JoinDomainInput>() {
           @Override
           public void write(JsonWriter out, JoinDomainInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JoinDomainInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JoinDomainInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JoinDomainInput
   * @throws IOException if the JSON string is invalid with respect to JoinDomainInput
   */
  public static JoinDomainInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JoinDomainInput.class);
  }

  /**
   * Convert an instance of JoinDomainInput to an JSON string
   *
   * @return JSON string
   */
