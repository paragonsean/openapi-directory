...
public class NotifyWhenUploadedInput {
  ...
  public NotifyWhenUploadedInput() {
  }

  public NotifyWhenUploadedInput fileShareARN(String fileShareARN) {
  ...
  public boolean equals(Object o) {
    ...
    NotifyWhenUploadedInput notifyWhenUploadedInput = (NotifyWhenUploadedInput) o;
    return Objects.equals(this.fileShareARN, notifyWhenUploadedInput.fileShareARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotifyWhenUploadedInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NotifyWhenUploadedInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotifyWhenUploadedInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotifyWhenUploadedInput is not found in the empty JSON string", NotifyWhenUploadedInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotifyWhenUploadedInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotifyWhenUploadedInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NotifyWhenUploadedInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("FileShareARN").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotifyWhenUploadedInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotifyWhenUploadedInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotifyWhenUploadedInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotifyWhenUploadedInput.class));

       return (TypeAdapter<T>) new TypeAdapter<NotifyWhenUploadedInput>() {
           @Override
           public void write(JsonWriter out, NotifyWhenUploadedInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NotifyWhenUploadedInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NotifyWhenUploadedInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NotifyWhenUploadedInput
   * @throws IOException if the JSON string is invalid with respect to NotifyWhenUploadedInput
   */
  public static NotifyWhenUploadedInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NotifyWhenUploadedInput.class);
  }

  /**
   * Convert an instance of NotifyWhenUploadedInput to an JSON string
   *
   * @return JSON string
   */
