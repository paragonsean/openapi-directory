...
public class DescribeAvailabilityMonitorTestInput {
  ...
  public DescribeAvailabilityMonitorTestInput() {
  }

  public DescribeAvailabilityMonitorTestInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAvailabilityMonitorTestInput describeAvailabilityMonitorTestInput = (DescribeAvailabilityMonitorTestInput) o;
    return Objects.equals(this.gatewayARN, describeAvailabilityMonitorTestInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeAvailabilityMonitorTestInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAvailabilityMonitorTestInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAvailabilityMonitorTestInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAvailabilityMonitorTestInput is not found in the empty JSON string", DescribeAvailabilityMonitorTestInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAvailabilityMonitorTestInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAvailabilityMonitorTestInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeAvailabilityMonitorTestInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAvailabilityMonitorTestInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAvailabilityMonitorTestInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAvailabilityMonitorTestInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAvailabilityMonitorTestInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAvailabilityMonitorTestInput>() {
           @Override
           public void write(JsonWriter out, DescribeAvailabilityMonitorTestInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAvailabilityMonitorTestInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAvailabilityMonitorTestInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAvailabilityMonitorTestInput
   * @throws IOException if the JSON string is invalid with respect to DescribeAvailabilityMonitorTestInput
   */
  public static DescribeAvailabilityMonitorTestInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAvailabilityMonitorTestInput.class);
  }

  /**
   * Convert an instance of DescribeAvailabilityMonitorTestInput to an JSON string
   *
   * @return JSON string
   */
