...
public class DescribeBandwidthRateLimitScheduleOutput {
  ...
  public DescribeBandwidthRateLimitScheduleOutput() {
  }

  public DescribeBandwidthRateLimitScheduleOutput gatewayARN(String gatewayARN) {
  ...
  public DescribeBandwidthRateLimitScheduleOutput bandwidthRateLimitIntervals(List bandwidthRateLimitIntervals) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeBandwidthRateLimitScheduleOutput describeBandwidthRateLimitScheduleOutput = (DescribeBandwidthRateLimitScheduleOutput) o;
    return Objects.equals(this.gatewayARN, describeBandwidthRateLimitScheduleOutput.gatewayARN) &&
        Objects.equals(this.bandwidthRateLimitIntervals, describeBandwidthRateLimitScheduleOutput.bandwidthRateLimitIntervals);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeBandwidthRateLimitScheduleOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeBandwidthRateLimitScheduleOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeBandwidthRateLimitScheduleOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeBandwidthRateLimitScheduleOutput is not found in the empty JSON string", DescribeBandwidthRateLimitScheduleOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeBandwidthRateLimitScheduleOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeBandwidthRateLimitScheduleOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `BandwidthRateLimitIntervals`
      if (jsonObj.get("BandwidthRateLimitIntervals") != null && !jsonObj.get("BandwidthRateLimitIntervals").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeBandwidthRateLimitScheduleOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeBandwidthRateLimitScheduleOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeBandwidthRateLimitScheduleOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeBandwidthRateLimitScheduleOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeBandwidthRateLimitScheduleOutput>() {
           @Override
           public void write(JsonWriter out, DescribeBandwidthRateLimitScheduleOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeBandwidthRateLimitScheduleOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeBandwidthRateLimitScheduleOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeBandwidthRateLimitScheduleOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeBandwidthRateLimitScheduleOutput
   */
  public static DescribeBandwidthRateLimitScheduleOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeBandwidthRateLimitScheduleOutput.class);
  }

  /**
   * Convert an instance of DescribeBandwidthRateLimitScheduleOutput to an JSON string
   *
   * @return JSON string
   */
