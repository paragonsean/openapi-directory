...
public class DescribeTapesInput {
  ...
  public DescribeTapesInput() {
  }

  public DescribeTapesInput gatewayARN(String gatewayARN) {
  ...
  public DescribeTapesInput tapeARNs(List tapeARNs) {
  ...
  public DescribeTapesInput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public DescribeTapesInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeTapesInput describeTapesInput = (DescribeTapesInput) o;
    return Objects.equals(this.gatewayARN, describeTapesInput.gatewayARN) &&
        Objects.equals(this.tapeARNs, describeTapesInput.tapeARNs) &&
        Objects.equals(this.marker, describeTapesInput.marker) &&
        Objects.equals(this.limit, describeTapesInput.limit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, tapeARNs, marker, limit);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeTapesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTapesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTapesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTapesInput is not found in the empty JSON string", DescribeTapesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTapesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTapesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeTapesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTapesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTapesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTapesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTapesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTapesInput>() {
           @Override
           public void write(JsonWriter out, DescribeTapesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTapesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTapesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTapesInput
   * @throws IOException if the JSON string is invalid with respect to DescribeTapesInput
   */
  public static DescribeTapesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTapesInput.class);
  }

  /**
   * Convert an instance of DescribeTapesInput to an JSON string
   *
   * @return JSON string
   */
