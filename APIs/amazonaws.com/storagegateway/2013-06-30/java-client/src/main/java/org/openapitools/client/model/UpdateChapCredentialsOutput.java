...
public class UpdateChapCredentialsOutput {
  ...
  public UpdateChapCredentialsOutput() {
  }

  public UpdateChapCredentialsOutput targetARN(String targetARN) {
  ...
  public UpdateChapCredentialsOutput initiatorName(String initiatorName) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateChapCredentialsOutput updateChapCredentialsOutput = (UpdateChapCredentialsOutput) o;
    return Objects.equals(this.targetARN, updateChapCredentialsOutput.targetARN) &&
        Objects.equals(this.initiatorName, updateChapCredentialsOutput.initiatorName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(targetARN, initiatorName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateChapCredentialsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateChapCredentialsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateChapCredentialsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateChapCredentialsOutput is not found in the empty JSON string", UpdateChapCredentialsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateChapCredentialsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateChapCredentialsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `InitiatorName`
      if (jsonObj.get("InitiatorName") != null && !jsonObj.get("InitiatorName").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateChapCredentialsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateChapCredentialsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateChapCredentialsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateChapCredentialsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateChapCredentialsOutput>() {
           @Override
           public void write(JsonWriter out, UpdateChapCredentialsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateChapCredentialsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateChapCredentialsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateChapCredentialsOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateChapCredentialsOutput
   */
  public static UpdateChapCredentialsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateChapCredentialsOutput.class);
  }

  /**
   * Convert an instance of UpdateChapCredentialsOutput to an JSON string
   *
   * @return JSON string
   */
