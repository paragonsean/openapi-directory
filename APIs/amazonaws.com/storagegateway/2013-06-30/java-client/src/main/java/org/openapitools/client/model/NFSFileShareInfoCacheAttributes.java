...
public class NFSFileShareInfoCacheAttributes {
  public static final String SERIALIZED_NAME_CACHE_STALE_TIMEOUT_IN_SECONDS = "CacheStaleTimeoutInSeconds";
  @SerializedName(SERIALIZED_NAME_CACHE_STALE_TIMEOUT_IN_SECONDS)
  private Integer cacheStaleTimeoutInSeconds;

  public NFSFileShareInfoCacheAttributes() {
  }

  public NFSFileShareInfoCacheAttributes cacheStaleTimeoutInSeconds(Integer cacheStaleTimeoutInSeconds) {
   ...
   * @return cacheStaleTimeoutInSeconds
   */
  ...
  public boolean equals(Object o) {
    ...
    NFSFileShareInfoCacheAttributes nfSFileShareInfoCacheAttributes = (NFSFileShareInfoCacheAttributes) o;
    return Objects.equals(this.cacheStaleTimeoutInSeconds, nfSFileShareInfoCacheAttributes.cacheStaleTimeoutInSeconds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cacheStaleTimeoutInSeconds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NFSFileShareInfoCacheAttributes {\n");
    sb.append("    cacheStaleTimeoutInSeconds: ").append(toIndentedString(cacheStaleTimeoutInSeconds)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("CacheStaleTimeoutInSeconds");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NFSFileShareInfoCacheAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NFSFileShareInfoCacheAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NFSFileShareInfoCacheAttributes is not found in the empty JSON string", NFSFileShareInfoCacheAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NFSFileShareInfoCacheAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NFSFileShareInfoCacheAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `CacheStaleTimeoutInSeconds`
      if (jsonObj.get("CacheStaleTimeoutInSeconds") != null && !jsonObj.get("CacheStaleTimeoutInSeconds").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("CacheStaleTimeoutInSeconds"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NFSFileShareInfoCacheAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NFSFileShareInfoCacheAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NFSFileShareInfoCacheAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NFSFileShareInfoCacheAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<NFSFileShareInfoCacheAttributes>() {
           @Override
           public void write(JsonWriter out, NFSFileShareInfoCacheAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NFSFileShareInfoCacheAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NFSFileShareInfoCacheAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NFSFileShareInfoCacheAttributes
   * @throws IOException if the JSON string is invalid with respect to NFSFileShareInfoCacheAttributes
   */
  public static NFSFileShareInfoCacheAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NFSFileShareInfoCacheAttributes.class);
  }

  /**
   * Convert an instance of NFSFileShareInfoCacheAttributes to an JSON string
   *
   * @return JSON string
   */
