...
public class StartGatewayInput {
  ...
  public StartGatewayInput() {
  }

  public StartGatewayInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    StartGatewayInput startGatewayInput = (StartGatewayInput) o;
    return Objects.equals(this.gatewayARN, startGatewayInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartGatewayInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartGatewayInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartGatewayInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartGatewayInput is not found in the empty JSON string", StartGatewayInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartGatewayInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartGatewayInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartGatewayInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartGatewayInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartGatewayInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartGatewayInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartGatewayInput.class));

       return (TypeAdapter<T>) new TypeAdapter<StartGatewayInput>() {
           @Override
           public void write(JsonWriter out, StartGatewayInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartGatewayInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartGatewayInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartGatewayInput
   * @throws IOException if the JSON string is invalid with respect to StartGatewayInput
   */
  public static StartGatewayInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartGatewayInput.class);
  }

  /**
   * Convert an instance of StartGatewayInput to an JSON string
   *
   * @return JSON string
   */
