...
public class SetLocalConsolePasswordInput {
  ...
  public static final String SERIALIZED_NAME_LOCAL_CONSOLE_PASSWORD = "LocalConsolePassword";
  @SerializedName(SERIALIZED_NAME_LOCAL_CONSOLE_PASSWORD)
  private String localConsolePassword;

  public SetLocalConsolePasswordInput() {
  }

  public SetLocalConsolePasswordInput gatewayARN(String gatewayARN) {
  ...
  public SetLocalConsolePasswordInput localConsolePassword(String localConsolePassword) {
    this.localConsolePassword = localConsolePassword;
    return this;
  }

  /**
   * Get localConsolePassword
  ...
  public boolean equals(Object o) {
    ...
    SetLocalConsolePasswordInput setLocalConsolePasswordInput = (SetLocalConsolePasswordInput) o;
    return Objects.equals(this.gatewayARN, setLocalConsolePasswordInput.gatewayARN) &&
        Objects.equals(this.localConsolePassword, setLocalConsolePasswordInput.localConsolePassword);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, localConsolePassword);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetLocalConsolePasswordInput {\n");
    sb.append("    gatewayARN: ").append(toIndentedString(gatewayARN)).append("\n");
    sb.append("    localConsolePassword: ").append(toIndentedString(localConsolePassword)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("LocalConsolePassword");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("GatewayARN");
    openapiRequiredFields.add("LocalConsolePassword");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetLocalConsolePasswordInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetLocalConsolePasswordInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetLocalConsolePasswordInput is not found in the empty JSON string", SetLocalConsolePasswordInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetLocalConsolePasswordInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetLocalConsolePasswordInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetLocalConsolePasswordInput.openapiRequiredFields) {
      ...
      // validate the required field `LocalConsolePassword`
      String.validateJsonElement(jsonObj.get("LocalConsolePassword"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetLocalConsolePasswordInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetLocalConsolePasswordInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetLocalConsolePasswordInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetLocalConsolePasswordInput.class));

       return (TypeAdapter<T>) new TypeAdapter<SetLocalConsolePasswordInput>() {
           @Override
           public void write(JsonWriter out, SetLocalConsolePasswordInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetLocalConsolePasswordInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetLocalConsolePasswordInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetLocalConsolePasswordInput
   * @throws IOException if the JSON string is invalid with respect to SetLocalConsolePasswordInput
   */
  public static SetLocalConsolePasswordInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetLocalConsolePasswordInput.class);
  }

  /**
   * Convert an instance of SetLocalConsolePasswordInput to an JSON string
   *
   * @return JSON string
   */
