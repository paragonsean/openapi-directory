...
public class ListLocalDisksInput {
  ...
  public ListLocalDisksInput() {
  }

  public ListLocalDisksInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    ListLocalDisksInput listLocalDisksInput = (ListLocalDisksInput) o;
    return Objects.equals(this.gatewayARN, listLocalDisksInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListLocalDisksInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListLocalDisksInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListLocalDisksInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListLocalDisksInput is not found in the empty JSON string", ListLocalDisksInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListLocalDisksInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListLocalDisksInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListLocalDisksInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListLocalDisksInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListLocalDisksInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListLocalDisksInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListLocalDisksInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListLocalDisksInput>() {
           @Override
           public void write(JsonWriter out, ListLocalDisksInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListLocalDisksInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListLocalDisksInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListLocalDisksInput
   * @throws IOException if the JSON string is invalid with respect to ListLocalDisksInput
   */
  public static ListLocalDisksInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListLocalDisksInput.class);
  }

  /**
   * Convert an instance of ListLocalDisksInput to an JSON string
   *
   * @return JSON string
   */
