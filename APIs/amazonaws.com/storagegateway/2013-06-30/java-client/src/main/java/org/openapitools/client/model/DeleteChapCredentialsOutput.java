...
public class DeleteChapCredentialsOutput {
  ...
  public DeleteChapCredentialsOutput() {
  }

  public DeleteChapCredentialsOutput targetARN(String targetARN) {
  ...
  public DeleteChapCredentialsOutput initiatorName(String initiatorName) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteChapCredentialsOutput deleteChapCredentialsOutput = (DeleteChapCredentialsOutput) o;
    return Objects.equals(this.targetARN, deleteChapCredentialsOutput.targetARN) &&
        Objects.equals(this.initiatorName, deleteChapCredentialsOutput.initiatorName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteChapCredentialsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteChapCredentialsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteChapCredentialsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteChapCredentialsOutput is not found in the empty JSON string", DeleteChapCredentialsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteChapCredentialsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteChapCredentialsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteChapCredentialsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteChapCredentialsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteChapCredentialsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteChapCredentialsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteChapCredentialsOutput>() {
           @Override
           public void write(JsonWriter out, DeleteChapCredentialsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteChapCredentialsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteChapCredentialsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteChapCredentialsOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteChapCredentialsOutput
   */
  public static DeleteChapCredentialsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteChapCredentialsOutput.class);
  }

  /**
   * Convert an instance of DeleteChapCredentialsOutput to an JSON string
   *
   * @return JSON string
   */
