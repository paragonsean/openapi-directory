...
public class UpdateBandwidthRateLimitOutput {
  ...
  public UpdateBandwidthRateLimitOutput() {
  }

  public UpdateBandwidthRateLimitOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateBandwidthRateLimitOutput updateBandwidthRateLimitOutput = (UpdateBandwidthRateLimitOutput) o;
    return Objects.equals(this.gatewayARN, updateBandwidthRateLimitOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateBandwidthRateLimitOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateBandwidthRateLimitOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateBandwidthRateLimitOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateBandwidthRateLimitOutput is not found in the empty JSON string", UpdateBandwidthRateLimitOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateBandwidthRateLimitOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateBandwidthRateLimitOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateBandwidthRateLimitOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateBandwidthRateLimitOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateBandwidthRateLimitOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateBandwidthRateLimitOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateBandwidthRateLimitOutput>() {
           @Override
           public void write(JsonWriter out, UpdateBandwidthRateLimitOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateBandwidthRateLimitOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateBandwidthRateLimitOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateBandwidthRateLimitOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateBandwidthRateLimitOutput
   */
  public static UpdateBandwidthRateLimitOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateBandwidthRateLimitOutput.class);
  }

  /**
   * Convert an instance of UpdateBandwidthRateLimitOutput to an JSON string
   *
   * @return JSON string
   */
