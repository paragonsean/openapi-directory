...
public class UpdateSMBFileShareVisibilityOutput {
  ...
  public UpdateSMBFileShareVisibilityOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSMBFileShareVisibilityOutput updateSMBFileShareVisibilityOutput = (UpdateSMBFileShareVisibilityOutput) o;
    return Objects.equals(this.gatewayARN, updateSMBFileShareVisibilityOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSMBFileShareVisibilityOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSMBFileShareVisibilityOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSMBFileShareVisibilityOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSMBFileShareVisibilityOutput is not found in the empty JSON string", UpdateSMBFileShareVisibilityOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSMBFileShareVisibilityOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSMBFileShareVisibilityOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSMBFileShareVisibilityOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSMBFileShareVisibilityOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSMBFileShareVisibilityOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSMBFileShareVisibilityOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSMBFileShareVisibilityOutput>() {
           @Override
           public void write(JsonWriter out, UpdateSMBFileShareVisibilityOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSMBFileShareVisibilityOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSMBFileShareVisibilityOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSMBFileShareVisibilityOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateSMBFileShareVisibilityOutput
   */
  public static UpdateSMBFileShareVisibilityOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSMBFileShareVisibilityOutput.class);
  }

  /**
   * Convert an instance of UpdateSMBFileShareVisibilityOutput to an JSON string
   *
   * @return JSON string
   */
