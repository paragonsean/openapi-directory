...
public class ShutdownGatewayOutput {
  ...
  public ShutdownGatewayOutput() {
  }

  public ShutdownGatewayOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    ShutdownGatewayOutput shutdownGatewayOutput = (ShutdownGatewayOutput) o;
    return Objects.equals(this.gatewayARN, shutdownGatewayOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShutdownGatewayOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ShutdownGatewayOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShutdownGatewayOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShutdownGatewayOutput is not found in the empty JSON string", ShutdownGatewayOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ShutdownGatewayOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShutdownGatewayOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShutdownGatewayOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShutdownGatewayOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShutdownGatewayOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShutdownGatewayOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ShutdownGatewayOutput>() {
           @Override
           public void write(JsonWriter out, ShutdownGatewayOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShutdownGatewayOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ShutdownGatewayOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ShutdownGatewayOutput
   * @throws IOException if the JSON string is invalid with respect to ShutdownGatewayOutput
   */
  public static ShutdownGatewayOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShutdownGatewayOutput.class);
  }

  /**
   * Convert an instance of ShutdownGatewayOutput to an JSON string
   *
   * @return JSON string
   */
