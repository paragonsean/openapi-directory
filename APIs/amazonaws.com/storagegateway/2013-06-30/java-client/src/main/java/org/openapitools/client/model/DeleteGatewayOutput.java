...
public class DeleteGatewayOutput {
  ...
  public DeleteGatewayOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteGatewayOutput deleteGatewayOutput = (DeleteGatewayOutput) o;
    return Objects.equals(this.gatewayARN, deleteGatewayOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteGatewayOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteGatewayOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteGatewayOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteGatewayOutput is not found in the empty JSON string", DeleteGatewayOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteGatewayOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteGatewayOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteGatewayOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteGatewayOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteGatewayOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteGatewayOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteGatewayOutput>() {
           @Override
           public void write(JsonWriter out, DeleteGatewayOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteGatewayOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteGatewayOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteGatewayOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteGatewayOutput
   */
  public static DeleteGatewayOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteGatewayOutput.class);
  }

  /**
   * Convert an instance of DeleteGatewayOutput to an JSON string
   *
   * @return JSON string
   */
