...
public class DescribeVTLDevicesInput {
  ...
  public static final String SERIALIZED_NAME_VT_L_DEVICE_A_R_NS = "VTLDeviceARNs";
  @SerializedName(SERIALIZED_NAME_VT_L_DEVICE_A_R_NS)
  private List vtLDeviceARNs;
  ...
  public DescribeVTLDevicesInput() {
  }

  public DescribeVTLDevicesInput gatewayARN(String gatewayARN) {
  ...
  public DescribeVTLDevicesInput vtLDeviceARNs(List vtLDeviceARNs) {
    this.vtLDeviceARNs = vtLDeviceARNs;
    return this;
  }
  ...
  public List getVtLDeviceARNs() {
    return vtLDeviceARNs;
  }

  public void setVtLDeviceARNs(List vtLDeviceARNs) {
    this.vtLDeviceARNs = vtLDeviceARNs;
  }


  public DescribeVTLDevicesInput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public DescribeVTLDevicesInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeVTLDevicesInput describeVTLDevicesInput = (DescribeVTLDevicesInput) o;
    return Objects.equals(this.gatewayARN, describeVTLDevicesInput.gatewayARN) &&
        Objects.equals(this.vtLDeviceARNs, describeVTLDevicesInput.vtLDeviceARNs) &&
        Objects.equals(this.marker, describeVTLDevicesInput.marker) &&
        Objects.equals(this.limit, describeVTLDevicesInput.limit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, vtLDeviceARNs, marker, limit);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeVTLDevicesInput {\n");
    sb.append("    gatewayARN: ").append(toIndentedString(gatewayARN)).append("\n");
    sb.append("    vtLDeviceARNs: ").append(toIndentedString(vtLDeviceARNs)).append("\n");
  ...
  static {
    ...
    openapiFields.add("VTLDeviceARNs");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeVTLDevicesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeVTLDevicesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeVTLDevicesInput is not found in the empty JSON string", DescribeVTLDevicesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeVTLDevicesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeVTLDevicesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeVTLDevicesInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("VTLDeviceARNs") != null && !jsonObj.get("VTLDeviceARNs").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("VTLDeviceARNs"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeVTLDevicesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeVTLDevicesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeVTLDevicesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeVTLDevicesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeVTLDevicesInput>() {
           @Override
           public void write(JsonWriter out, DescribeVTLDevicesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeVTLDevicesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeVTLDevicesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeVTLDevicesInput
   * @throws IOException if the JSON string is invalid with respect to DescribeVTLDevicesInput
   */
  public static DescribeVTLDevicesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeVTLDevicesInput.class);
  }

  /**
   * Convert an instance of DescribeVTLDevicesInput to an JSON string
   *
   * @return JSON string
   */
