...
public class EndpointNetworkConfiguration {
  ...
  public EndpointNetworkConfiguration() {
  }

  public EndpointNetworkConfiguration ipAddresses(List ipAddresses) {
  ...
  public boolean equals(Object o) {
    ...
    EndpointNetworkConfiguration endpointNetworkConfiguration = (EndpointNetworkConfiguration) o;
    return Objects.equals(this.ipAddresses, endpointNetworkConfiguration.ipAddresses);
  }
  ...
  public String toString() {
    ...
    sb.append("class EndpointNetworkConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EndpointNetworkConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EndpointNetworkConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EndpointNetworkConfiguration is not found in the empty JSON string", EndpointNetworkConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EndpointNetworkConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EndpointNetworkConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EndpointNetworkConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EndpointNetworkConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EndpointNetworkConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EndpointNetworkConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<EndpointNetworkConfiguration>() {
           @Override
           public void write(JsonWriter out, EndpointNetworkConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EndpointNetworkConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EndpointNetworkConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EndpointNetworkConfiguration
   * @throws IOException if the JSON string is invalid with respect to EndpointNetworkConfiguration
   */
  public static EndpointNetworkConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EndpointNetworkConfiguration.class);
  }

  /**
   * Convert an instance of EndpointNetworkConfiguration to an JSON string
   *
   * @return JSON string
   */
