...
public class DeleteSnapshotScheduleInput {
  ...
  public DeleteSnapshotScheduleInput() {
  }

  public DeleteSnapshotScheduleInput volumeARN(String volumeARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteSnapshotScheduleInput deleteSnapshotScheduleInput = (DeleteSnapshotScheduleInput) o;
    return Objects.equals(this.volumeARN, deleteSnapshotScheduleInput.volumeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteSnapshotScheduleInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSnapshotScheduleInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSnapshotScheduleInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteSnapshotScheduleInput is not found in the empty JSON string", DeleteSnapshotScheduleInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSnapshotScheduleInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteSnapshotScheduleInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteSnapshotScheduleInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSnapshotScheduleInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSnapshotScheduleInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSnapshotScheduleInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSnapshotScheduleInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSnapshotScheduleInput>() {
           @Override
           public void write(JsonWriter out, DeleteSnapshotScheduleInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSnapshotScheduleInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteSnapshotScheduleInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteSnapshotScheduleInput
   * @throws IOException if the JSON string is invalid with respect to DeleteSnapshotScheduleInput
   */
  public static DeleteSnapshotScheduleInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteSnapshotScheduleInput.class);
  }

  /**
   * Convert an instance of DeleteSnapshotScheduleInput to an JSON string
   *
   * @return JSON string
   */
