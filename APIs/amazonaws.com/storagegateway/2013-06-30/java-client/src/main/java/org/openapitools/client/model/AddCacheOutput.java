...
public class AddCacheOutput {
  ...
  public AddCacheOutput() {
  }

  public AddCacheOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    AddCacheOutput addCacheOutput = (AddCacheOutput) o;
    return Objects.equals(this.gatewayARN, addCacheOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddCacheOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddCacheOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddCacheOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCacheOutput is not found in the empty JSON string", AddCacheOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddCacheOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddCacheOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCacheOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCacheOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCacheOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCacheOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCacheOutput>() {
           @Override
           public void write(JsonWriter out, AddCacheOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddCacheOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddCacheOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddCacheOutput
   * @throws IOException if the JSON string is invalid with respect to AddCacheOutput
   */
  public static AddCacheOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCacheOutput.class);
  }

  /**
   * Convert an instance of AddCacheOutput to an JSON string
   *
   * @return JSON string
   */
