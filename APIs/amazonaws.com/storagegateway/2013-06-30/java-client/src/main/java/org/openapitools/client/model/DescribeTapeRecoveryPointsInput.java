...
public class DescribeTapeRecoveryPointsInput {
  ...
  public DescribeTapeRecoveryPointsInput() {
  }

  public DescribeTapeRecoveryPointsInput gatewayARN(String gatewayARN) {
  ...
  public DescribeTapeRecoveryPointsInput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public DescribeTapeRecoveryPointsInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeTapeRecoveryPointsInput describeTapeRecoveryPointsInput = (DescribeTapeRecoveryPointsInput) o;
    return Objects.equals(this.gatewayARN, describeTapeRecoveryPointsInput.gatewayARN) &&
        Objects.equals(this.marker, describeTapeRecoveryPointsInput.marker) &&
        Objects.equals(this.limit, describeTapeRecoveryPointsInput.limit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, marker, limit);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeTapeRecoveryPointsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTapeRecoveryPointsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTapeRecoveryPointsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTapeRecoveryPointsInput is not found in the empty JSON string", DescribeTapeRecoveryPointsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTapeRecoveryPointsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTapeRecoveryPointsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeTapeRecoveryPointsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTapeRecoveryPointsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTapeRecoveryPointsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTapeRecoveryPointsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTapeRecoveryPointsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTapeRecoveryPointsInput>() {
           @Override
           public void write(JsonWriter out, DescribeTapeRecoveryPointsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTapeRecoveryPointsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTapeRecoveryPointsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTapeRecoveryPointsInput
   * @throws IOException if the JSON string is invalid with respect to DescribeTapeRecoveryPointsInput
   */
  public static DescribeTapeRecoveryPointsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTapeRecoveryPointsInput.class);
  }

  /**
   * Convert an instance of DescribeTapeRecoveryPointsInput to an JSON string
   *
   * @return JSON string
   */
