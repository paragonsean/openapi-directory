...
public class AssignTapePoolInput {
  ...
  public AssignTapePoolInput() {
  }

  public AssignTapePoolInput tapeARN(String tapeARN) {
  ...
  public AssignTapePoolInput poolId(String poolId) {
    this.poolId = poolId;
    return this;
  }
  ...
  public AssignTapePoolInput bypassGovernanceRetention(Boolean bypassGovernanceRetention) {
  ...
  public boolean equals(Object o) {
    ...
    AssignTapePoolInput assignTapePoolInput = (AssignTapePoolInput) o;
    return Objects.equals(this.tapeARN, assignTapePoolInput.tapeARN) &&
        Objects.equals(this.poolId, assignTapePoolInput.poolId) &&
        Objects.equals(this.bypassGovernanceRetention, assignTapePoolInput.bypassGovernanceRetention);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tapeARN, poolId, bypassGovernanceRetention);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssignTapePoolInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("TapeARN");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssignTapePoolInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssignTapePoolInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssignTapePoolInput is not found in the empty JSON string", AssignTapePoolInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssignTapePoolInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssignTapePoolInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssignTapePoolInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `TapeARN`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssignTapePoolInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssignTapePoolInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssignTapePoolInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssignTapePoolInput.class));

       return (TypeAdapter<T>) new TypeAdapter<AssignTapePoolInput>() {
           @Override
           public void write(JsonWriter out, AssignTapePoolInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssignTapePoolInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssignTapePoolInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssignTapePoolInput
   * @throws IOException if the JSON string is invalid with respect to AssignTapePoolInput
   */
  public static AssignTapePoolInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssignTapePoolInput.class);
  }

  /**
   * Convert an instance of AssignTapePoolInput to an JSON string
   *
   * @return JSON string
   */
