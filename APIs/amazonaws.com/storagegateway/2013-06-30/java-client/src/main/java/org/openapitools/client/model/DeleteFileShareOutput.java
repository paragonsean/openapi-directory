...
public class DeleteFileShareOutput {
  ...
  public DeleteFileShareOutput() {
  }

  public DeleteFileShareOutput fileShareARN(String fileShareARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteFileShareOutput deleteFileShareOutput = (DeleteFileShareOutput) o;
    return Objects.equals(this.fileShareARN, deleteFileShareOutput.fileShareARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteFileShareOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFileShareOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFileShareOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteFileShareOutput is not found in the empty JSON string", DeleteFileShareOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFileShareOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFileShareOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFileShareOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFileShareOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFileShareOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFileShareOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFileShareOutput>() {
           @Override
           public void write(JsonWriter out, DeleteFileShareOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFileShareOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFileShareOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFileShareOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteFileShareOutput
   */
  public static DeleteFileShareOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFileShareOutput.class);
  }

  /**
   * Convert an instance of DeleteFileShareOutput to an JSON string
   *
   * @return JSON string
   */
