...
public class AddWorkingStorageOutput {
  ...
  public AddWorkingStorageOutput() {
  }

  public AddWorkingStorageOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    AddWorkingStorageOutput addWorkingStorageOutput = (AddWorkingStorageOutput) o;
    return Objects.equals(this.gatewayARN, addWorkingStorageOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddWorkingStorageOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddWorkingStorageOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWorkingStorageOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddWorkingStorageOutput is not found in the empty JSON string", AddWorkingStorageOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWorkingStorageOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddWorkingStorageOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddWorkingStorageOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddWorkingStorageOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddWorkingStorageOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddWorkingStorageOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<AddWorkingStorageOutput>() {
           @Override
           public void write(JsonWriter out, AddWorkingStorageOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddWorkingStorageOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddWorkingStorageOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddWorkingStorageOutput
   * @throws IOException if the JSON string is invalid with respect to AddWorkingStorageOutput
   */
  public static AddWorkingStorageOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddWorkingStorageOutput.class);
  }

  /**
   * Convert an instance of AddWorkingStorageOutput to an JSON string
   *
   * @return JSON string
   */
