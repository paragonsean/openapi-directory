...
public class GatewayInfo {
  ...
  public static final String SERIALIZED_NAME_GATEWAY_OPERATIONAL_STATE = "GatewayOperationalState";
  @SerializedName(SERIALIZED_NAME_GATEWAY_OPERATIONAL_STATE)
  ...
  public GatewayInfo gatewayId(String gatewayId) {
  ...
  public GatewayInfo gatewayARN(String gatewayARN) {
  ...
  public GatewayInfo gatewayType(String gatewayType) {
  ...
  public GatewayInfo gatewayOperationalState(String gatewayOperationalState) {
  ...
  public GatewayInfo gatewayName(String gatewayName) {
  ...
  public GatewayInfo ec2InstanceId(String ec2InstanceId) {
  ...
  public GatewayInfo ec2InstanceRegion(String ec2InstanceRegion) {
  ...
  public GatewayInfo hostEnvironment(HostEnvironment hostEnvironment) {
  ...
  public GatewayInfo hostEnvironmentId(String hostEnvironmentId) {
  ...
  public boolean equals(Object o) {
    ...
    GatewayInfo gatewayInfo = (GatewayInfo) o;
    return Objects.equals(this.gatewayId, gatewayInfo.gatewayId) &&
        Objects.equals(this.gatewayARN, gatewayInfo.gatewayARN) &&
        Objects.equals(this.gatewayType, gatewayInfo.gatewayType) &&
        Objects.equals(this.gatewayOperationalState, gatewayInfo.gatewayOperationalState) &&
        Objects.equals(this.gatewayName, gatewayInfo.gatewayName) &&
        Objects.equals(this.ec2InstanceId, gatewayInfo.ec2InstanceId) &&
        Objects.equals(this.ec2InstanceRegion, gatewayInfo.ec2InstanceRegion) &&
        Objects.equals(this.hostEnvironment, gatewayInfo.hostEnvironment) &&
        Objects.equals(this.hostEnvironmentId, gatewayInfo.hostEnvironmentId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayId, gatewayARN, gatewayType, gatewayOperationalState, gatewayName, ec2InstanceId, ec2InstanceRegion, hostEnvironment, hostEnvironmentId);
  }
  ...
  public String toString() {
    ...
    sb.append("    gatewayOperationalState: ").append(toIndentedString(gatewayOperationalState)).append("\n");
  ...
  static {
    ...
    openapiFields.add("GatewayOperationalState");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GatewayInfo is not found in the empty JSON string", GatewayInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GatewayInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("GatewayOperationalState") != null && !jsonObj.get("GatewayOperationalState").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("GatewayOperationalState"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayInfo>() {
           @Override
           public void write(JsonWriter out, GatewayInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayInfo
   * @throws IOException if the JSON string is invalid with respect to GatewayInfo
   */
  public static GatewayInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayInfo.class);
  }

  /**
   * Convert an instance of GatewayInfo to an JSON string
   *
   * @return JSON string
   */
