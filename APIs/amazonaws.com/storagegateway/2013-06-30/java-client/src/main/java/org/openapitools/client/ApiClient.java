...
public class ApiClient {
    ...
    private String basePath = "http://storagegateway.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://storagegateway.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://storagegateway.{region}.amazonaws.com",
      "The AWS Storage Gateway multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://storagegateway.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://storagegateway.{region}.amazonaws.com.cn",
      "The AWS Storage Gateway endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2013-06-30/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://storagegateway.us-east-1.amazonaws.com
