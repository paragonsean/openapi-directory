...
public class RetrieveTapeRecoveryPointOutput {
  ...
  public RetrieveTapeRecoveryPointOutput() {
  }

  public RetrieveTapeRecoveryPointOutput tapeARN(String tapeARN) {
  ...
  public boolean equals(Object o) {
    ...
    RetrieveTapeRecoveryPointOutput retrieveTapeRecoveryPointOutput = (RetrieveTapeRecoveryPointOutput) o;
    return Objects.equals(this.tapeARN, retrieveTapeRecoveryPointOutput.tapeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetrieveTapeRecoveryPointOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetrieveTapeRecoveryPointOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetrieveTapeRecoveryPointOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetrieveTapeRecoveryPointOutput is not found in the empty JSON string", RetrieveTapeRecoveryPointOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetrieveTapeRecoveryPointOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetrieveTapeRecoveryPointOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetrieveTapeRecoveryPointOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetrieveTapeRecoveryPointOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetrieveTapeRecoveryPointOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetrieveTapeRecoveryPointOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<RetrieveTapeRecoveryPointOutput>() {
           @Override
           public void write(JsonWriter out, RetrieveTapeRecoveryPointOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetrieveTapeRecoveryPointOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetrieveTapeRecoveryPointOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetrieveTapeRecoveryPointOutput
   * @throws IOException if the JSON string is invalid with respect to RetrieveTapeRecoveryPointOutput
   */
  public static RetrieveTapeRecoveryPointOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetrieveTapeRecoveryPointOutput.class);
  }

  /**
   * Convert an instance of RetrieveTapeRecoveryPointOutput to an JSON string
   *
   * @return JSON string
   */
