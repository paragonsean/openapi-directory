...
public class UpdateGatewayInformationOutput {
  ...
  public UpdateGatewayInformationOutput gatewayARN(String gatewayARN) {
  ...
  public UpdateGatewayInformationOutput gatewayName(String gatewayName) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateGatewayInformationOutput updateGatewayInformationOutput = (UpdateGatewayInformationOutput) o;
    return Objects.equals(this.gatewayARN, updateGatewayInformationOutput.gatewayARN) &&
        Objects.equals(this.gatewayName, updateGatewayInformationOutput.gatewayName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, gatewayName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateGatewayInformationOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGatewayInformationOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGatewayInformationOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGatewayInformationOutput is not found in the empty JSON string", UpdateGatewayInformationOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGatewayInformationOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGatewayInformationOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGatewayInformationOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGatewayInformationOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGatewayInformationOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGatewayInformationOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGatewayInformationOutput>() {
           @Override
           public void write(JsonWriter out, UpdateGatewayInformationOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGatewayInformationOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGatewayInformationOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGatewayInformationOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateGatewayInformationOutput
   */
  public static UpdateGatewayInformationOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGatewayInformationOutput.class);
  }

  /**
   * Convert an instance of UpdateGatewayInformationOutput to an JSON string
   *
   * @return JSON string
   */
