...
public class JoinDomainOutput {
  ...
  public JoinDomainOutput() {
  }

  public JoinDomainOutput gatewayARN(String gatewayARN) {
  ...
  public JoinDomainOutput activeDirectoryStatus(ActiveDirectoryStatus activeDirectoryStatus) {
  ...
  public boolean equals(Object o) {
    ...
    JoinDomainOutput joinDomainOutput = (JoinDomainOutput) o;
    return Objects.equals(this.gatewayARN, joinDomainOutput.gatewayARN) &&
        Objects.equals(this.activeDirectoryStatus, joinDomainOutput.activeDirectoryStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, activeDirectoryStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JoinDomainOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JoinDomainOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JoinDomainOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JoinDomainOutput is not found in the empty JSON string", JoinDomainOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JoinDomainOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JoinDomainOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JoinDomainOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JoinDomainOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JoinDomainOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JoinDomainOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<JoinDomainOutput>() {
           @Override
           public void write(JsonWriter out, JoinDomainOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JoinDomainOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JoinDomainOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JoinDomainOutput
   * @throws IOException if the JSON string is invalid with respect to JoinDomainOutput
   */
  public static JoinDomainOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JoinDomainOutput.class);
  }

  /**
   * Convert an instance of JoinDomainOutput to an JSON string
   *
   * @return JSON string
   */
