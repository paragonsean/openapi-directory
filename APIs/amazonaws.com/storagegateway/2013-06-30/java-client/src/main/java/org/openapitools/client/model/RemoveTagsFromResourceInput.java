...
public class RemoveTagsFromResourceInput {
  ...
  public RemoveTagsFromResourceInput() {
  }

  public RemoveTagsFromResourceInput resourceARN(String resourceARN) {
  ...
  public RemoveTagsFromResourceInput tagKeys(List tagKeys) {
  ...
  public boolean equals(Object o) {
    ...
    RemoveTagsFromResourceInput removeTagsFromResourceInput = (RemoveTagsFromResourceInput) o;
    return Objects.equals(this.resourceARN, removeTagsFromResourceInput.resourceARN) &&
        Objects.equals(this.tagKeys, removeTagsFromResourceInput.tagKeys);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoveTagsFromResourceInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveTagsFromResourceInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveTagsFromResourceInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveTagsFromResourceInput is not found in the empty JSON string", RemoveTagsFromResourceInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveTagsFromResourceInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveTagsFromResourceInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RemoveTagsFromResourceInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveTagsFromResourceInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveTagsFromResourceInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveTagsFromResourceInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveTagsFromResourceInput.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveTagsFromResourceInput>() {
           @Override
           public void write(JsonWriter out, RemoveTagsFromResourceInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveTagsFromResourceInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveTagsFromResourceInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveTagsFromResourceInput
   * @throws IOException if the JSON string is invalid with respect to RemoveTagsFromResourceInput
   */
  public static RemoveTagsFromResourceInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveTagsFromResourceInput.class);
  }

  /**
   * Convert an instance of RemoveTagsFromResourceInput to an JSON string
   *
   * @return JSON string
   */
