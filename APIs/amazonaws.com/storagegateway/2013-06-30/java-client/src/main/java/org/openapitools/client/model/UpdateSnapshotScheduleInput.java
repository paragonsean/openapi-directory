...
public class UpdateSnapshotScheduleInput {
  ...
  public UpdateSnapshotScheduleInput() {
  }

  public UpdateSnapshotScheduleInput volumeARN(String volumeARN) {
  ...
  public UpdateSnapshotScheduleInput startAt(Integer startAt) {
  ...
  public UpdateSnapshotScheduleInput recurrenceInHours(Integer recurrenceInHours) {
  ...
  public UpdateSnapshotScheduleInput description(String description) {
  ...
  public UpdateSnapshotScheduleInput tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateSnapshotScheduleInput updateSnapshotScheduleInput = (UpdateSnapshotScheduleInput) o;
    return Objects.equals(this.volumeARN, updateSnapshotScheduleInput.volumeARN) &&
        Objects.equals(this.startAt, updateSnapshotScheduleInput.startAt) &&
        Objects.equals(this.recurrenceInHours, updateSnapshotScheduleInput.recurrenceInHours) &&
        Objects.equals(this.description, updateSnapshotScheduleInput.description) &&
        Objects.equals(this.tags, updateSnapshotScheduleInput.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(volumeARN, startAt, recurrenceInHours, description, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateSnapshotScheduleInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("RecurrenceInHours");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSnapshotScheduleInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSnapshotScheduleInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSnapshotScheduleInput is not found in the empty JSON string", UpdateSnapshotScheduleInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSnapshotScheduleInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSnapshotScheduleInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateSnapshotScheduleInput.openapiRequiredFields) {
      ...
      // validate the required field `StartAt`
      Integer.validateJsonElement(jsonObj.get("StartAt"));
      // validate the required field `RecurrenceInHours`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSnapshotScheduleInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSnapshotScheduleInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSnapshotScheduleInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSnapshotScheduleInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSnapshotScheduleInput>() {
           @Override
           public void write(JsonWriter out, UpdateSnapshotScheduleInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSnapshotScheduleInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSnapshotScheduleInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSnapshotScheduleInput
   * @throws IOException if the JSON string is invalid with respect to UpdateSnapshotScheduleInput
   */
  public static UpdateSnapshotScheduleInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSnapshotScheduleInput.class);
  }

  /**
   * Convert an instance of UpdateSnapshotScheduleInput to an JSON string
   *
   * @return JSON string
   */
