...
public class UpdateAutomaticTapeCreationPolicyInput {
  public static final String SERIALIZED_NAME_AUTOMATIC_TAPE_CREATION_RULES = "AutomaticTapeCreationRules";
  @SerializedName(SERIALIZED_NAME_AUTOMATIC_TAPE_CREATION_RULES)
  private List automaticTapeCreationRules;

  public static final String SERIALIZED_NAME_GATEWAY_A_R_N = "GatewayARN";
  @SerializedName(SERIALIZED_NAME_GATEWAY_A_R_N)
  private String gatewayARN;

  public UpdateAutomaticTapeCreationPolicyInput() {
  }

  public UpdateAutomaticTapeCreationPolicyInput automaticTapeCreationRules(List automaticTapeCreationRules) {
    this.automaticTapeCreationRules = automaticTapeCreationRules;
    return this;
  }

  /**
   * Get automaticTapeCreationRules
   * @return automaticTapeCreationRules
   */
  @javax.annotation.Nonnull
  public List getAutomaticTapeCreationRules() {
    return automaticTapeCreationRules;
  }

  public void setAutomaticTapeCreationRules(List automaticTapeCreationRules) {
    this.automaticTapeCreationRules = automaticTapeCreationRules;
  }


  public UpdateAutomaticTapeCreationPolicyInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateAutomaticTapeCreationPolicyInput updateAutomaticTapeCreationPolicyInput = (UpdateAutomaticTapeCreationPolicyInput) o;
    return Objects.equals(this.automaticTapeCreationRules, updateAutomaticTapeCreationPolicyInput.automaticTapeCreationRules) &&
        Objects.equals(this.gatewayARN, updateAutomaticTapeCreationPolicyInput.gatewayARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(automaticTapeCreationRules, gatewayARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateAutomaticTapeCreationPolicyInput {\n");
    sb.append("    automaticTapeCreationRules: ").append(toIndentedString(automaticTapeCreationRules)).append("\n");
  ...
  static {
    ...
    openapiFields.add("AutomaticTapeCreationRules");
    openapiFields.add("GatewayARN");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("AutomaticTapeCreationRules");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAutomaticTapeCreationPolicyInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAutomaticTapeCreationPolicyInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAutomaticTapeCreationPolicyInput is not found in the empty JSON string", UpdateAutomaticTapeCreationPolicyInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAutomaticTapeCreationPolicyInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAutomaticTapeCreationPolicyInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateAutomaticTapeCreationPolicyInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `AutomaticTapeCreationRules`
      List.validateJsonElement(jsonObj.get("AutomaticTapeCreationRules"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAutomaticTapeCreationPolicyInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAutomaticTapeCreationPolicyInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAutomaticTapeCreationPolicyInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAutomaticTapeCreationPolicyInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAutomaticTapeCreationPolicyInput>() {
           @Override
           public void write(JsonWriter out, UpdateAutomaticTapeCreationPolicyInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAutomaticTapeCreationPolicyInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAutomaticTapeCreationPolicyInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAutomaticTapeCreationPolicyInput
   * @throws IOException if the JSON string is invalid with respect to UpdateAutomaticTapeCreationPolicyInput
   */
  public static UpdateAutomaticTapeCreationPolicyInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAutomaticTapeCreationPolicyInput.class);
  }

  /**
   * Convert an instance of UpdateAutomaticTapeCreationPolicyInput to an JSON string
   *
   * @return JSON string
   */
