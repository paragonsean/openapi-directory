...
public class ListVolumeInitiatorsInput {
  ...
  public ListVolumeInitiatorsInput() {
  }

  public ListVolumeInitiatorsInput volumeARN(String volumeARN) {
  ...
  public boolean equals(Object o) {
    ...
    ListVolumeInitiatorsInput listVolumeInitiatorsInput = (ListVolumeInitiatorsInput) o;
    return Objects.equals(this.volumeARN, listVolumeInitiatorsInput.volumeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListVolumeInitiatorsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListVolumeInitiatorsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListVolumeInitiatorsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListVolumeInitiatorsInput is not found in the empty JSON string", ListVolumeInitiatorsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListVolumeInitiatorsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListVolumeInitiatorsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListVolumeInitiatorsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListVolumeInitiatorsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListVolumeInitiatorsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListVolumeInitiatorsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListVolumeInitiatorsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListVolumeInitiatorsInput>() {
           @Override
           public void write(JsonWriter out, ListVolumeInitiatorsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListVolumeInitiatorsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListVolumeInitiatorsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListVolumeInitiatorsInput
   * @throws IOException if the JSON string is invalid with respect to ListVolumeInitiatorsInput
   */
  public static ListVolumeInitiatorsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListVolumeInitiatorsInput.class);
  }

  /**
   * Convert an instance of ListVolumeInitiatorsInput to an JSON string
   *
   * @return JSON string
   */
