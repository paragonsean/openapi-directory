...
public class RetrieveTapeRecoveryPointInput {
  ...
  public RetrieveTapeRecoveryPointInput() {
  }

  public RetrieveTapeRecoveryPointInput tapeARN(String tapeARN) {
  ...
  public RetrieveTapeRecoveryPointInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    RetrieveTapeRecoveryPointInput retrieveTapeRecoveryPointInput = (RetrieveTapeRecoveryPointInput) o;
    return Objects.equals(this.tapeARN, retrieveTapeRecoveryPointInput.tapeARN) &&
        Objects.equals(this.gatewayARN, retrieveTapeRecoveryPointInput.gatewayARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tapeARN, gatewayARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RetrieveTapeRecoveryPointInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetrieveTapeRecoveryPointInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetrieveTapeRecoveryPointInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetrieveTapeRecoveryPointInput is not found in the empty JSON string", RetrieveTapeRecoveryPointInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetrieveTapeRecoveryPointInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetrieveTapeRecoveryPointInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RetrieveTapeRecoveryPointInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetrieveTapeRecoveryPointInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetrieveTapeRecoveryPointInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetrieveTapeRecoveryPointInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetrieveTapeRecoveryPointInput.class));

       return (TypeAdapter<T>) new TypeAdapter<RetrieveTapeRecoveryPointInput>() {
           @Override
           public void write(JsonWriter out, RetrieveTapeRecoveryPointInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetrieveTapeRecoveryPointInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetrieveTapeRecoveryPointInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetrieveTapeRecoveryPointInput
   * @throws IOException if the JSON string is invalid with respect to RetrieveTapeRecoveryPointInput
   */
  public static RetrieveTapeRecoveryPointInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetrieveTapeRecoveryPointInput.class);
  }

  /**
   * Convert an instance of RetrieveTapeRecoveryPointInput to an JSON string
   *
   * @return JSON string
   */
