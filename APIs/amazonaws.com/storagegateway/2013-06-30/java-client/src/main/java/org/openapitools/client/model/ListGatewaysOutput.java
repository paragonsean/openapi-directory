...
public class ListGatewaysOutput {
  ...
  public ListGatewaysOutput gateways(List gateways) {
  ...
  public ListGatewaysOutput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListGatewaysOutput listGatewaysOutput = (ListGatewaysOutput) o;
    return Objects.equals(this.gateways, listGatewaysOutput.gateways) &&
        Objects.equals(this.marker, listGatewaysOutput.marker);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gateways, marker);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListGatewaysOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListGatewaysOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListGatewaysOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListGatewaysOutput is not found in the empty JSON string", ListGatewaysOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListGatewaysOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListGatewaysOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListGatewaysOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListGatewaysOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListGatewaysOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListGatewaysOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListGatewaysOutput>() {
           @Override
           public void write(JsonWriter out, ListGatewaysOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListGatewaysOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListGatewaysOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListGatewaysOutput
   * @throws IOException if the JSON string is invalid with respect to ListGatewaysOutput
   */
  public static ListGatewaysOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListGatewaysOutput.class);
  }

  /**
   * Convert an instance of ListGatewaysOutput to an JSON string
   *
   * @return JSON string
   */
