...
public class DescribeCachediSCSIVolumesInput {
  public static final String SERIALIZED_NAME_VOLUME_A_R_NS = "VolumeARNs";
  @SerializedName(SERIALIZED_NAME_VOLUME_A_R_NS)
  private List volumeARNs;

  public DescribeCachediSCSIVolumesInput() {
  }

  public DescribeCachediSCSIVolumesInput volumeARNs(List volumeARNs) {
  ...
  public List getVolumeARNs() {
    return volumeARNs;
  }

  public void setVolumeARNs(List volumeARNs) {
    this.volumeARNs = volumeARNs;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeCachediSCSIVolumesInput describeCachediSCSIVolumesInput = (DescribeCachediSCSIVolumesInput) o;
    return Objects.equals(this.volumeARNs, describeCachediSCSIVolumesInput.volumeARNs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(volumeARNs);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeCachediSCSIVolumesInput {\n");
    sb.append("    volumeARNs: ").append(toIndentedString(volumeARNs)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("VolumeARNs");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("VolumeARNs");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCachediSCSIVolumesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCachediSCSIVolumesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCachediSCSIVolumesInput is not found in the empty JSON string", DescribeCachediSCSIVolumesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCachediSCSIVolumesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCachediSCSIVolumesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeCachediSCSIVolumesInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `VolumeARNs`
      List.validateJsonElement(jsonObj.get("VolumeARNs"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCachediSCSIVolumesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCachediSCSIVolumesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCachediSCSIVolumesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCachediSCSIVolumesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCachediSCSIVolumesInput>() {
           @Override
           public void write(JsonWriter out, DescribeCachediSCSIVolumesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCachediSCSIVolumesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCachediSCSIVolumesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCachediSCSIVolumesInput
   * @throws IOException if the JSON string is invalid with respect to DescribeCachediSCSIVolumesInput
   */
  public static DescribeCachediSCSIVolumesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCachediSCSIVolumesInput.class);
  }

  /**
   * Convert an instance of DescribeCachediSCSIVolumesInput to an JSON string
   *
   * @return JSON string
   */
