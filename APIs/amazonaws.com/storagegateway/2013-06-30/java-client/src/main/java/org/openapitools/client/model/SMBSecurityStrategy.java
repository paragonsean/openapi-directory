...
/**
 * Gets or Sets SMBSecurityStrategy
 */
@JsonAdapter(SMBSecurityStrategy.Adapter.class)
public enum SMBSecurityStrategy {
  ...
  SMBSecurityStrategy(String value) {
    this.value = value;
  }
  ...
  public static SMBSecurityStrategy fromValue(String value) {
    for (SMBSecurityStrategy b : SMBSecurityStrategy.values()) {
  ...
  public static class Adapter extends TypeAdapter<SMBSecurityStrategy> {
    @Override
    public void write(final JsonWriter jsonWriter, final SMBSecurityStrategy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SMBSecurityStrategy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SMBSecurityStrategy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SMBSecurityStrategy.fromValue(value);
  }
}
