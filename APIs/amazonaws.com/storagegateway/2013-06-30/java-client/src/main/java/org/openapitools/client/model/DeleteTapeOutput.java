...
public class DeleteTapeOutput {
  ...
  public DeleteTapeOutput() {
  }

  public DeleteTapeOutput tapeARN(String tapeARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteTapeOutput deleteTapeOutput = (DeleteTapeOutput) o;
    return Objects.equals(this.tapeARN, deleteTapeOutput.tapeARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteTapeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTapeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTapeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTapeOutput is not found in the empty JSON string", DeleteTapeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTapeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTapeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTapeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTapeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTapeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTapeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTapeOutput>() {
           @Override
           public void write(JsonWriter out, DeleteTapeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTapeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTapeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTapeOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteTapeOutput
   */
  public static DeleteTapeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTapeOutput.class);
  }

  /**
   * Convert an instance of DeleteTapeOutput to an JSON string
   *
   * @return JSON string
   */
