...
public class AutomaticTapeCreationPolicyInfo {
  ...
  public AutomaticTapeCreationPolicyInfo() {
  }

  public AutomaticTapeCreationPolicyInfo automaticTapeCreationRules(List automaticTapeCreationRules) {
  ...
  public AutomaticTapeCreationPolicyInfo gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    AutomaticTapeCreationPolicyInfo automaticTapeCreationPolicyInfo = (AutomaticTapeCreationPolicyInfo) o;
    return Objects.equals(this.automaticTapeCreationRules, automaticTapeCreationPolicyInfo.automaticTapeCreationRules) &&
        Objects.equals(this.gatewayARN, automaticTapeCreationPolicyInfo.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomaticTapeCreationPolicyInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AutomaticTapeCreationPolicyInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AutomaticTapeCreationPolicyInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomaticTapeCreationPolicyInfo is not found in the empty JSON string", AutomaticTapeCreationPolicyInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AutomaticTapeCreationPolicyInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AutomaticTapeCreationPolicyInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `AutomaticTapeCreationRules`
      if (jsonObj.get("AutomaticTapeCreationRules") != null && !jsonObj.get("AutomaticTapeCreationRules").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomaticTapeCreationPolicyInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomaticTapeCreationPolicyInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomaticTapeCreationPolicyInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomaticTapeCreationPolicyInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomaticTapeCreationPolicyInfo>() {
           @Override
           public void write(JsonWriter out, AutomaticTapeCreationPolicyInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AutomaticTapeCreationPolicyInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AutomaticTapeCreationPolicyInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AutomaticTapeCreationPolicyInfo
   * @throws IOException if the JSON string is invalid with respect to AutomaticTapeCreationPolicyInfo
   */
  public static AutomaticTapeCreationPolicyInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomaticTapeCreationPolicyInfo.class);
  }

  /**
   * Convert an instance of AutomaticTapeCreationPolicyInfo to an JSON string
   *
   * @return JSON string
   */
