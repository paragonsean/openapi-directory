...
public class ResetCacheOutput {
  ...
  public ResetCacheOutput() {
  }

  public ResetCacheOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    ResetCacheOutput resetCacheOutput = (ResetCacheOutput) o;
    return Objects.equals(this.gatewayARN, resetCacheOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResetCacheOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResetCacheOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResetCacheOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResetCacheOutput is not found in the empty JSON string", ResetCacheOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResetCacheOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResetCacheOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResetCacheOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResetCacheOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResetCacheOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResetCacheOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ResetCacheOutput>() {
           @Override
           public void write(JsonWriter out, ResetCacheOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResetCacheOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResetCacheOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResetCacheOutput
   * @throws IOException if the JSON string is invalid with respect to ResetCacheOutput
   */
  public static ResetCacheOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResetCacheOutput.class);
  }

  /**
   * Convert an instance of ResetCacheOutput to an JSON string
   *
   * @return JSON string
   */
