...
public class AssociateFileSystemInputEndpointNetworkConfiguration {
  public static final String SERIALIZED_NAME_IP_ADDRESSES = "IpAddresses";
  @SerializedName(SERIALIZED_NAME_IP_ADDRESSES)
  private List ipAddresses;

  public AssociateFileSystemInputEndpointNetworkConfiguration() {
  }

  public AssociateFileSystemInputEndpointNetworkConfiguration ipAddresses(List ipAddresses) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateFileSystemInputEndpointNetworkConfiguration associateFileSystemInputEndpointNetworkConfiguration = (AssociateFileSystemInputEndpointNetworkConfiguration) o;
    return Objects.equals(this.ipAddresses, associateFileSystemInputEndpointNetworkConfiguration.ipAddresses);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssociateFileSystemInputEndpointNetworkConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateFileSystemInputEndpointNetworkConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateFileSystemInputEndpointNetworkConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateFileSystemInputEndpointNetworkConfiguration is not found in the empty JSON string", AssociateFileSystemInputEndpointNetworkConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateFileSystemInputEndpointNetworkConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateFileSystemInputEndpointNetworkConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateFileSystemInputEndpointNetworkConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateFileSystemInputEndpointNetworkConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateFileSystemInputEndpointNetworkConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateFileSystemInputEndpointNetworkConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateFileSystemInputEndpointNetworkConfiguration>() {
           @Override
           public void write(JsonWriter out, AssociateFileSystemInputEndpointNetworkConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateFileSystemInputEndpointNetworkConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateFileSystemInputEndpointNetworkConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateFileSystemInputEndpointNetworkConfiguration
   * @throws IOException if the JSON string is invalid with respect to AssociateFileSystemInputEndpointNetworkConfiguration
   */
  public static AssociateFileSystemInputEndpointNetworkConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateFileSystemInputEndpointNetworkConfiguration.class);
  }

  /**
   * Convert an instance of AssociateFileSystemInputEndpointNetworkConfiguration to an JSON string
   *
   * @return JSON string
   */
