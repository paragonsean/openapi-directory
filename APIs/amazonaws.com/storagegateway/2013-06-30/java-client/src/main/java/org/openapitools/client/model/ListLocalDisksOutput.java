...
public class ListLocalDisksOutput {
  ...
  public ListLocalDisksOutput() {
  }

  public ListLocalDisksOutput gatewayARN(String gatewayARN) {
  ...
  public ListLocalDisksOutput disks(List disks) {
    this.disks = disks;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListLocalDisksOutput listLocalDisksOutput = (ListLocalDisksOutput) o;
    return Objects.equals(this.gatewayARN, listLocalDisksOutput.gatewayARN) &&
        Objects.equals(this.disks, listLocalDisksOutput.disks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, disks);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListLocalDisksOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListLocalDisksOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListLocalDisksOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListLocalDisksOutput is not found in the empty JSON string", ListLocalDisksOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListLocalDisksOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListLocalDisksOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListLocalDisksOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListLocalDisksOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListLocalDisksOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListLocalDisksOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListLocalDisksOutput>() {
           @Override
           public void write(JsonWriter out, ListLocalDisksOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListLocalDisksOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListLocalDisksOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListLocalDisksOutput
   * @throws IOException if the JSON string is invalid with respect to ListLocalDisksOutput
   */
  public static ListLocalDisksOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListLocalDisksOutput.class);
  }

  /**
   * Convert an instance of ListLocalDisksOutput to an JSON string
   *
   * @return JSON string
   */
