...
public class DeviceiSCSIAttributes {
  ...
  public DeviceiSCSIAttributes targetARN(String targetARN) {
  ...
  public DeviceiSCSIAttributes networkInterfaceId(String networkInterfaceId) {
  ...
  public DeviceiSCSIAttributes networkInterfacePort(Integer networkInterfacePort) {
  ...
  public DeviceiSCSIAttributes chapEnabled(Boolean chapEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    DeviceiSCSIAttributes deviceiSCSIAttributes = (DeviceiSCSIAttributes) o;
    return Objects.equals(this.targetARN, deviceiSCSIAttributes.targetARN) &&
        Objects.equals(this.networkInterfaceId, deviceiSCSIAttributes.networkInterfaceId) &&
        Objects.equals(this.networkInterfacePort, deviceiSCSIAttributes.networkInterfacePort) &&
        Objects.equals(this.chapEnabled, deviceiSCSIAttributes.chapEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceiSCSIAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeviceiSCSIAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceiSCSIAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeviceiSCSIAttributes is not found in the empty JSON string", DeviceiSCSIAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeviceiSCSIAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeviceiSCSIAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeviceiSCSIAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeviceiSCSIAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeviceiSCSIAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeviceiSCSIAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<DeviceiSCSIAttributes>() {
           @Override
           public void write(JsonWriter out, DeviceiSCSIAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeviceiSCSIAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeviceiSCSIAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeviceiSCSIAttributes
   * @throws IOException if the JSON string is invalid with respect to DeviceiSCSIAttributes
   */
  public static DeviceiSCSIAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeviceiSCSIAttributes.class);
  }

  /**
   * Convert an instance of DeviceiSCSIAttributes to an JSON string
   *
   * @return JSON string
   */
