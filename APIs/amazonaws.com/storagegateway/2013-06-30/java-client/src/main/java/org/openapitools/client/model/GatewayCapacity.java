...
/**
 * Gets or Sets GatewayCapacity
 */
@JsonAdapter(GatewayCapacity.Adapter.class)
public enum GatewayCapacity {
  ...
  public static GatewayCapacity fromValue(String value) {
    for (GatewayCapacity b : GatewayCapacity.values()) {
  ...
  public static class Adapter extends TypeAdapter<GatewayCapacity> {
    @Override
    public void write(final JsonWriter jsonWriter, final GatewayCapacity enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GatewayCapacity read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GatewayCapacity.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GatewayCapacity.fromValue(value);
  }
}
