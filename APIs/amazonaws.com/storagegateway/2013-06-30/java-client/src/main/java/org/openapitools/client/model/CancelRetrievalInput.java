...
public class CancelRetrievalInput {
  ...
  public CancelRetrievalInput() {
  }

  public CancelRetrievalInput gatewayARN(String gatewayARN) {
  ...
  public CancelRetrievalInput tapeARN(String tapeARN) {
  ...
  public boolean equals(Object o) {
    ...
    CancelRetrievalInput cancelRetrievalInput = (CancelRetrievalInput) o;
    return Objects.equals(this.gatewayARN, cancelRetrievalInput.gatewayARN) &&
        Objects.equals(this.tapeARN, cancelRetrievalInput.tapeARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, tapeARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CancelRetrievalInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelRetrievalInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelRetrievalInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelRetrievalInput is not found in the empty JSON string", CancelRetrievalInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelRetrievalInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelRetrievalInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CancelRetrievalInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelRetrievalInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelRetrievalInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelRetrievalInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelRetrievalInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelRetrievalInput>() {
           @Override
           public void write(JsonWriter out, CancelRetrievalInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelRetrievalInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelRetrievalInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelRetrievalInput
   * @throws IOException if the JSON string is invalid with respect to CancelRetrievalInput
   */
  public static CancelRetrievalInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelRetrievalInput.class);
  }

  /**
   * Convert an instance of CancelRetrievalInput to an JSON string
   *
   * @return JSON string
   */
