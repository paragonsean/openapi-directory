...
public class AddUploadBufferInput {
  ...
  public AddUploadBufferInput() {
  }

  public AddUploadBufferInput gatewayARN(String gatewayARN) {
  ...
  public AddUploadBufferInput diskIds(List diskIds) {
  ...
  public boolean equals(Object o) {
    ...
    AddUploadBufferInput addUploadBufferInput = (AddUploadBufferInput) o;
    return Objects.equals(this.gatewayARN, addUploadBufferInput.gatewayARN) &&
        Objects.equals(this.diskIds, addUploadBufferInput.diskIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddUploadBufferInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddUploadBufferInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddUploadBufferInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddUploadBufferInput is not found in the empty JSON string", AddUploadBufferInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddUploadBufferInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddUploadBufferInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddUploadBufferInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddUploadBufferInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddUploadBufferInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddUploadBufferInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddUploadBufferInput.class));

       return (TypeAdapter<T>) new TypeAdapter<AddUploadBufferInput>() {
           @Override
           public void write(JsonWriter out, AddUploadBufferInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddUploadBufferInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddUploadBufferInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddUploadBufferInput
   * @throws IOException if the JSON string is invalid with respect to AddUploadBufferInput
   */
  public static AddUploadBufferInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddUploadBufferInput.class);
  }

  /**
   * Convert an instance of AddUploadBufferInput to an JSON string
   *
   * @return JSON string
   */
