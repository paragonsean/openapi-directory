...
public class DeleteBandwidthRateLimitInput {
  ...
  public static final String SERIALIZED_NAME_BANDWIDTH_TYPE = "BandwidthType";
  @SerializedName(SERIALIZED_NAME_BANDWIDTH_TYPE)
  private String bandwidthType;

  public DeleteBandwidthRateLimitInput() {
  }

  public DeleteBandwidthRateLimitInput gatewayARN(String gatewayARN) {
  ...
  public DeleteBandwidthRateLimitInput bandwidthType(String bandwidthType) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteBandwidthRateLimitInput deleteBandwidthRateLimitInput = (DeleteBandwidthRateLimitInput) o;
    return Objects.equals(this.gatewayARN, deleteBandwidthRateLimitInput.gatewayARN) &&
        Objects.equals(this.bandwidthType, deleteBandwidthRateLimitInput.bandwidthType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, bandwidthType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteBandwidthRateLimitInput {\n");
  ...
  static {
    ...
    openapiFields.add("BandwidthType");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("GatewayARN");
    openapiRequiredFields.add("BandwidthType");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteBandwidthRateLimitInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteBandwidthRateLimitInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteBandwidthRateLimitInput is not found in the empty JSON string", DeleteBandwidthRateLimitInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteBandwidthRateLimitInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteBandwidthRateLimitInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteBandwidthRateLimitInput.openapiRequiredFields) {
      ...
      // validate the required field `BandwidthType`
      String.validateJsonElement(jsonObj.get("BandwidthType"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteBandwidthRateLimitInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteBandwidthRateLimitInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteBandwidthRateLimitInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteBandwidthRateLimitInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteBandwidthRateLimitInput>() {
           @Override
           public void write(JsonWriter out, DeleteBandwidthRateLimitInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteBandwidthRateLimitInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteBandwidthRateLimitInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteBandwidthRateLimitInput
   * @throws IOException if the JSON string is invalid with respect to DeleteBandwidthRateLimitInput
   */
  public static DeleteBandwidthRateLimitInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteBandwidthRateLimitInput.class);
  }

  /**
   * Convert an instance of DeleteBandwidthRateLimitInput to an JSON string
   *
   * @return JSON string
   */
