...
public class DeleteFileShareInput {
  ...
  public DeleteFileShareInput() {
  }

  public DeleteFileShareInput fileShareARN(String fileShareARN) {
  ...
  public DeleteFileShareInput forceDelete(Boolean forceDelete) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteFileShareInput deleteFileShareInput = (DeleteFileShareInput) o;
    return Objects.equals(this.fileShareARN, deleteFileShareInput.fileShareARN) &&
        Objects.equals(this.forceDelete, deleteFileShareInput.forceDelete);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileShareARN, forceDelete);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteFileShareInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFileShareInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFileShareInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteFileShareInput is not found in the empty JSON string", DeleteFileShareInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFileShareInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFileShareInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteFileShareInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFileShareInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFileShareInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFileShareInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFileShareInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFileShareInput>() {
           @Override
           public void write(JsonWriter out, DeleteFileShareInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFileShareInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFileShareInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFileShareInput
   * @throws IOException if the JSON string is invalid with respect to DeleteFileShareInput
   */
  public static DeleteFileShareInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFileShareInput.class);
  }

  /**
   * Convert an instance of DeleteFileShareInput to an JSON string
   *
   * @return JSON string
   */
