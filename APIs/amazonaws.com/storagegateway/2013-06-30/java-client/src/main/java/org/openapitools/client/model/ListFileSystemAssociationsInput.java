...
public class ListFileSystemAssociationsInput {
  ...
  public ListFileSystemAssociationsInput() {
  }

  public ListFileSystemAssociationsInput gatewayARN(String gatewayARN) {
  ...
  public ListFileSystemAssociationsInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ListFileSystemAssociationsInput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListFileSystemAssociationsInput listFileSystemAssociationsInput = (ListFileSystemAssociationsInput) o;
    return Objects.equals(this.gatewayARN, listFileSystemAssociationsInput.gatewayARN) &&
        Objects.equals(this.limit, listFileSystemAssociationsInput.limit) &&
        Objects.equals(this.marker, listFileSystemAssociationsInput.marker);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListFileSystemAssociationsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFileSystemAssociationsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFileSystemAssociationsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFileSystemAssociationsInput is not found in the empty JSON string", ListFileSystemAssociationsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFileSystemAssociationsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFileSystemAssociationsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFileSystemAssociationsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFileSystemAssociationsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFileSystemAssociationsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFileSystemAssociationsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFileSystemAssociationsInput>() {
           @Override
           public void write(JsonWriter out, ListFileSystemAssociationsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFileSystemAssociationsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListFileSystemAssociationsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListFileSystemAssociationsInput
   * @throws IOException if the JSON string is invalid with respect to ListFileSystemAssociationsInput
   */
  public static ListFileSystemAssociationsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListFileSystemAssociationsInput.class);
  }

  /**
   * Convert an instance of ListFileSystemAssociationsInput to an JSON string
   *
   * @return JSON string
   */
