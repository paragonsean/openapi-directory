...
/**
 * Gets or Sets PoolStatus
 */
@JsonAdapter(PoolStatus.Adapter.class)
public enum PoolStatus {
  ...
  public static PoolStatus fromValue(String value) {
    for (PoolStatus b : PoolStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PoolStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PoolStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PoolStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PoolStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PoolStatus.fromValue(value);
  }
}
