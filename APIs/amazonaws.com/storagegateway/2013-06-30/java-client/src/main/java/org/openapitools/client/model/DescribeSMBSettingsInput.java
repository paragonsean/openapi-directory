...
public class DescribeSMBSettingsInput {
  ...
  public DescribeSMBSettingsInput() {
  }

  public DescribeSMBSettingsInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeSMBSettingsInput describeSMBSettingsInput = (DescribeSMBSettingsInput) o;
    return Objects.equals(this.gatewayARN, describeSMBSettingsInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeSMBSettingsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeSMBSettingsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeSMBSettingsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeSMBSettingsInput is not found in the empty JSON string", DescribeSMBSettingsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeSMBSettingsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeSMBSettingsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeSMBSettingsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeSMBSettingsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeSMBSettingsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeSMBSettingsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeSMBSettingsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeSMBSettingsInput>() {
           @Override
           public void write(JsonWriter out, DescribeSMBSettingsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeSMBSettingsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeSMBSettingsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeSMBSettingsInput
   * @throws IOException if the JSON string is invalid with respect to DescribeSMBSettingsInput
   */
  public static DescribeSMBSettingsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeSMBSettingsInput.class);
  }

  /**
   * Convert an instance of DescribeSMBSettingsInput to an JSON string
   *
   * @return JSON string
   */
