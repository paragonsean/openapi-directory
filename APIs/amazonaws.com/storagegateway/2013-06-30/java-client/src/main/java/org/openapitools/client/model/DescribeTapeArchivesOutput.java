...
public class DescribeTapeArchivesOutput {
  public static final String SERIALIZED_NAME_TAPE_ARCHIVES = "TapeArchives";
  @SerializedName(SERIALIZED_NAME_TAPE_ARCHIVES)
  private List tapeArchives;

  public static final String SERIALIZED_NAME_MARKER = "Marker";
  @SerializedName(SERIALIZED_NAME_MARKER)
  private String marker;

  public DescribeTapeArchivesOutput() {
  }

  public DescribeTapeArchivesOutput tapeArchives(List tapeArchives) {
  ...
  public List getTapeArchives() {
    return tapeArchives;
  }

  public void setTapeArchives(List tapeArchives) {
    this.tapeArchives = tapeArchives;
  }


  public DescribeTapeArchivesOutput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeTapeArchivesOutput describeTapeArchivesOutput = (DescribeTapeArchivesOutput) o;
    return Objects.equals(this.tapeArchives, describeTapeArchivesOutput.tapeArchives) &&
        Objects.equals(this.marker, describeTapeArchivesOutput.marker);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tapeArchives, marker);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeTapeArchivesOutput {\n");
    sb.append("    tapeArchives: ").append(toIndentedString(tapeArchives)).append("\n");
  ...
  static {
    ...
    openapiFields.add("TapeArchives");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTapeArchivesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTapeArchivesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTapeArchivesOutput is not found in the empty JSON string", DescribeTapeArchivesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTapeArchivesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTapeArchivesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `TapeArchives`
      if (jsonObj.get("TapeArchives") != null && !jsonObj.get("TapeArchives").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("TapeArchives"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTapeArchivesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTapeArchivesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTapeArchivesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTapeArchivesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTapeArchivesOutput>() {
           @Override
           public void write(JsonWriter out, DescribeTapeArchivesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTapeArchivesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTapeArchivesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTapeArchivesOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeTapeArchivesOutput
   */
  public static DescribeTapeArchivesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTapeArchivesOutput.class);
  }

  /**
   * Convert an instance of DescribeTapeArchivesOutput to an JSON string
   *
   * @return JSON string
   */
