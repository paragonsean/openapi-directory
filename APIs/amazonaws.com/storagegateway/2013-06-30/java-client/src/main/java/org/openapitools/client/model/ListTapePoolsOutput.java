...
public class ListTapePoolsOutput {
  public static final String SERIALIZED_NAME_POOL_INFOS = "PoolInfos";
  @SerializedName(SERIALIZED_NAME_POOL_INFOS)
  ...
  public ListTapePoolsOutput() {
  }

  public ListTapePoolsOutput poolInfos(List poolInfos) {
  ...
  public void setPoolInfos(List poolInfos) {
    this.poolInfos = poolInfos;
  }


  public ListTapePoolsOutput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListTapePoolsOutput listTapePoolsOutput = (ListTapePoolsOutput) o;
    return Objects.equals(this.poolInfos, listTapePoolsOutput.poolInfos) &&
        Objects.equals(this.marker, listTapePoolsOutput.marker);
  }

  @Override
  public int hashCode() {
    return Objects.hash(poolInfos, marker);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListTapePoolsOutput {\n");
    sb.append("    poolInfos: ").append(toIndentedString(poolInfos)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListTapePoolsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListTapePoolsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListTapePoolsOutput is not found in the empty JSON string", ListTapePoolsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListTapePoolsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListTapePoolsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `PoolInfos`
      if (jsonObj.get("PoolInfos") != null && !jsonObj.get("PoolInfos").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("PoolInfos"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListTapePoolsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListTapePoolsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListTapePoolsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListTapePoolsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListTapePoolsOutput>() {
           @Override
           public void write(JsonWriter out, ListTapePoolsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListTapePoolsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListTapePoolsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListTapePoolsOutput
   * @throws IOException if the JSON string is invalid with respect to ListTapePoolsOutput
   */
  public static ListTapePoolsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTapePoolsOutput.class);
  }

  /**
   * Convert an instance of ListTapePoolsOutput to an JSON string
   *
   * @return JSON string
   */
