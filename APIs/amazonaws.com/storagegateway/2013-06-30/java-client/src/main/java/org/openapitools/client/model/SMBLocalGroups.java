...
public class SMBLocalGroups {
  ...
  public SMBLocalGroups() {
  }

  public SMBLocalGroups gatewayAdmins(List gatewayAdmins) {
  ...
  public boolean equals(Object o) {
    ...
    SMBLocalGroups smBLocalGroups = (SMBLocalGroups) o;
    return Objects.equals(this.gatewayAdmins, smBLocalGroups.gatewayAdmins);
  }
  ...
  public String toString() {
    ...
    sb.append("class SMBLocalGroups {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SMBLocalGroups
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SMBLocalGroups.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SMBLocalGroups is not found in the empty JSON string", SMBLocalGroups.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SMBLocalGroups.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SMBLocalGroups` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SMBLocalGroups.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SMBLocalGroups' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SMBLocalGroups> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SMBLocalGroups.class));

       return (TypeAdapter<T>) new TypeAdapter<SMBLocalGroups>() {
           @Override
           public void write(JsonWriter out, SMBLocalGroups value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SMBLocalGroups read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SMBLocalGroups given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SMBLocalGroups
   * @throws IOException if the JSON string is invalid with respect to SMBLocalGroups
   */
  public static SMBLocalGroups fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SMBLocalGroups.class);
  }

  /**
   * Convert an instance of SMBLocalGroups to an JSON string
   *
   * @return JSON string
   */
