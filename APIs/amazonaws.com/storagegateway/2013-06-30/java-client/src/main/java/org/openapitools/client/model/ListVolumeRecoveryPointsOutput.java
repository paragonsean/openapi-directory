...
public class ListVolumeRecoveryPointsOutput {
  ...
  public static final String SERIALIZED_NAME_VOLUME_RECOVERY_POINT_INFOS = "VolumeRecoveryPointInfos";
  @SerializedName(SERIALIZED_NAME_VOLUME_RECOVERY_POINT_INFOS)
  private List volumeRecoveryPointInfos;

  public ListVolumeRecoveryPointsOutput() {
  }

  public ListVolumeRecoveryPointsOutput gatewayARN(String gatewayARN) {
  ...
  public ListVolumeRecoveryPointsOutput volumeRecoveryPointInfos(List volumeRecoveryPointInfos) {
    this.volumeRecoveryPointInfos = volumeRecoveryPointInfos;
    return this;
  }

  /**
   * Get volumeRecoveryPointInfos
   * @return volumeRecoveryPointInfos
   */
  @javax.annotation.Nullable
  public List getVolumeRecoveryPointInfos() {
    return volumeRecoveryPointInfos;
  }

  public void setVolumeRecoveryPointInfos(List volumeRecoveryPointInfos) {
    this.volumeRecoveryPointInfos = volumeRecoveryPointInfos;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListVolumeRecoveryPointsOutput listVolumeRecoveryPointsOutput = (ListVolumeRecoveryPointsOutput) o;
    return Objects.equals(this.gatewayARN, listVolumeRecoveryPointsOutput.gatewayARN) &&
        Objects.equals(this.volumeRecoveryPointInfos, listVolumeRecoveryPointsOutput.volumeRecoveryPointInfos);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, volumeRecoveryPointInfos);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListVolumeRecoveryPointsOutput {\n");
    sb.append("    gatewayARN: ").append(toIndentedString(gatewayARN)).append("\n");
    sb.append("    volumeRecoveryPointInfos: ").append(toIndentedString(volumeRecoveryPointInfos)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("VolumeRecoveryPointInfos");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListVolumeRecoveryPointsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListVolumeRecoveryPointsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListVolumeRecoveryPointsOutput is not found in the empty JSON string", ListVolumeRecoveryPointsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListVolumeRecoveryPointsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListVolumeRecoveryPointsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `VolumeRecoveryPointInfos`
      if (jsonObj.get("VolumeRecoveryPointInfos") != null && !jsonObj.get("VolumeRecoveryPointInfos").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("VolumeRecoveryPointInfos"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListVolumeRecoveryPointsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListVolumeRecoveryPointsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListVolumeRecoveryPointsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListVolumeRecoveryPointsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListVolumeRecoveryPointsOutput>() {
           @Override
           public void write(JsonWriter out, ListVolumeRecoveryPointsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListVolumeRecoveryPointsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListVolumeRecoveryPointsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListVolumeRecoveryPointsOutput
   * @throws IOException if the JSON string is invalid with respect to ListVolumeRecoveryPointsOutput
   */
  public static ListVolumeRecoveryPointsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListVolumeRecoveryPointsOutput.class);
  }

  /**
   * Convert an instance of ListVolumeRecoveryPointsOutput to an JSON string
   *
   * @return JSON string
   */
