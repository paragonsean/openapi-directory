...
public class DescribeSnapshotScheduleInput {
  ...
  public DescribeSnapshotScheduleInput() {
  }

  public DescribeSnapshotScheduleInput volumeARN(String volumeARN) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeSnapshotScheduleInput describeSnapshotScheduleInput = (DescribeSnapshotScheduleInput) o;
    return Objects.equals(this.volumeARN, describeSnapshotScheduleInput.volumeARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(volumeARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeSnapshotScheduleInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("VolumeARN");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeSnapshotScheduleInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeSnapshotScheduleInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeSnapshotScheduleInput is not found in the empty JSON string", DescribeSnapshotScheduleInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeSnapshotScheduleInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeSnapshotScheduleInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeSnapshotScheduleInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `VolumeARN`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeSnapshotScheduleInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeSnapshotScheduleInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeSnapshotScheduleInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeSnapshotScheduleInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeSnapshotScheduleInput>() {
           @Override
           public void write(JsonWriter out, DescribeSnapshotScheduleInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeSnapshotScheduleInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeSnapshotScheduleInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeSnapshotScheduleInput
   * @throws IOException if the JSON string is invalid with respect to DescribeSnapshotScheduleInput
   */
  public static DescribeSnapshotScheduleInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeSnapshotScheduleInput.class);
  }

  /**
   * Convert an instance of DescribeSnapshotScheduleInput to an JSON string
   *
   * @return JSON string
   */
