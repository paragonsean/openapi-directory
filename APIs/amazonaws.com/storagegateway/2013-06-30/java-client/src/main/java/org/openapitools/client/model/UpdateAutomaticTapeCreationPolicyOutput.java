...
public class UpdateAutomaticTapeCreationPolicyOutput {
  ...
  public UpdateAutomaticTapeCreationPolicyOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateAutomaticTapeCreationPolicyOutput updateAutomaticTapeCreationPolicyOutput = (UpdateAutomaticTapeCreationPolicyOutput) o;
    return Objects.equals(this.gatewayARN, updateAutomaticTapeCreationPolicyOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAutomaticTapeCreationPolicyOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAutomaticTapeCreationPolicyOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAutomaticTapeCreationPolicyOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAutomaticTapeCreationPolicyOutput is not found in the empty JSON string", UpdateAutomaticTapeCreationPolicyOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAutomaticTapeCreationPolicyOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAutomaticTapeCreationPolicyOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAutomaticTapeCreationPolicyOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAutomaticTapeCreationPolicyOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAutomaticTapeCreationPolicyOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAutomaticTapeCreationPolicyOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAutomaticTapeCreationPolicyOutput>() {
           @Override
           public void write(JsonWriter out, UpdateAutomaticTapeCreationPolicyOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAutomaticTapeCreationPolicyOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAutomaticTapeCreationPolicyOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAutomaticTapeCreationPolicyOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateAutomaticTapeCreationPolicyOutput
   */
  public static UpdateAutomaticTapeCreationPolicyOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAutomaticTapeCreationPolicyOutput.class);
  }

  /**
   * Convert an instance of UpdateAutomaticTapeCreationPolicyOutput to an JSON string
   *
   * @return JSON string
   */
