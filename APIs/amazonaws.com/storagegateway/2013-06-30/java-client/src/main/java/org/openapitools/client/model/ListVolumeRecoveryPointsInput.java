...
public class ListVolumeRecoveryPointsInput {
  ...
  public ListVolumeRecoveryPointsInput() {
  }

  public ListVolumeRecoveryPointsInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    ListVolumeRecoveryPointsInput listVolumeRecoveryPointsInput = (ListVolumeRecoveryPointsInput) o;
    return Objects.equals(this.gatewayARN, listVolumeRecoveryPointsInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListVolumeRecoveryPointsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListVolumeRecoveryPointsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListVolumeRecoveryPointsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListVolumeRecoveryPointsInput is not found in the empty JSON string", ListVolumeRecoveryPointsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListVolumeRecoveryPointsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListVolumeRecoveryPointsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListVolumeRecoveryPointsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListVolumeRecoveryPointsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListVolumeRecoveryPointsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListVolumeRecoveryPointsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListVolumeRecoveryPointsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListVolumeRecoveryPointsInput>() {
           @Override
           public void write(JsonWriter out, ListVolumeRecoveryPointsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListVolumeRecoveryPointsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListVolumeRecoveryPointsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListVolumeRecoveryPointsInput
   * @throws IOException if the JSON string is invalid with respect to ListVolumeRecoveryPointsInput
   */
  public static ListVolumeRecoveryPointsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListVolumeRecoveryPointsInput.class);
  }

  /**
   * Convert an instance of ListVolumeRecoveryPointsInput to an JSON string
   *
   * @return JSON string
   */
