...
public class DisableGatewayInput {
  ...
  public DisableGatewayInput() {
  }

  public DisableGatewayInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DisableGatewayInput disableGatewayInput = (DisableGatewayInput) o;
    return Objects.equals(this.gatewayARN, disableGatewayInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisableGatewayInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisableGatewayInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisableGatewayInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisableGatewayInput is not found in the empty JSON string", DisableGatewayInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisableGatewayInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisableGatewayInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisableGatewayInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisableGatewayInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisableGatewayInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisableGatewayInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisableGatewayInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DisableGatewayInput>() {
           @Override
           public void write(JsonWriter out, DisableGatewayInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisableGatewayInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisableGatewayInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisableGatewayInput
   * @throws IOException if the JSON string is invalid with respect to DisableGatewayInput
   */
  public static DisableGatewayInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisableGatewayInput.class);
  }

  /**
   * Convert an instance of DisableGatewayInput to an JSON string
   *
   * @return JSON string
   */
