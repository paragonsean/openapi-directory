...
public class CacheAttributes {
  ...
  public CacheAttributes cacheStaleTimeoutInSeconds(Integer cacheStaleTimeoutInSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    CacheAttributes cacheAttributes = (CacheAttributes) o;
    return Objects.equals(this.cacheStaleTimeoutInSeconds, cacheAttributes.cacheStaleTimeoutInSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class CacheAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CacheAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CacheAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CacheAttributes is not found in the empty JSON string", CacheAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CacheAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CacheAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CacheAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CacheAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CacheAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CacheAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<CacheAttributes>() {
           @Override
           public void write(JsonWriter out, CacheAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CacheAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CacheAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CacheAttributes
   * @throws IOException if the JSON string is invalid with respect to CacheAttributes
   */
  public static CacheAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CacheAttributes.class);
  }

  /**
   * Convert an instance of CacheAttributes to an JSON string
   *
   * @return JSON string
   */
