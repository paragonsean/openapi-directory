...
public class UpdateFileSystemAssociationOutput {
  ...
  public UpdateFileSystemAssociationOutput fileSystemAssociationARN(String fileSystemAssociationARN) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFileSystemAssociationOutput updateFileSystemAssociationOutput = (UpdateFileSystemAssociationOutput) o;
    return Objects.equals(this.fileSystemAssociationARN, updateFileSystemAssociationOutput.fileSystemAssociationARN);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileSystemAssociationARN);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateFileSystemAssociationOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFileSystemAssociationOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFileSystemAssociationOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFileSystemAssociationOutput is not found in the empty JSON string", UpdateFileSystemAssociationOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFileSystemAssociationOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFileSystemAssociationOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFileSystemAssociationOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFileSystemAssociationOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFileSystemAssociationOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFileSystemAssociationOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFileSystemAssociationOutput>() {
           @Override
           public void write(JsonWriter out, UpdateFileSystemAssociationOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFileSystemAssociationOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFileSystemAssociationOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFileSystemAssociationOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateFileSystemAssociationOutput
   */
  public static UpdateFileSystemAssociationOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFileSystemAssociationOutput.class);
  }

  /**
   * Convert an instance of UpdateFileSystemAssociationOutput to an JSON string
   *
   * @return JSON string
   */
