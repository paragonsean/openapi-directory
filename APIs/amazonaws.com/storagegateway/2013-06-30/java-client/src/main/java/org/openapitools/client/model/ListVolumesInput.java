...
public class ListVolumesInput {
  ...
  public ListVolumesInput() {
  }

  public ListVolumesInput gatewayARN(String gatewayARN) {
  ...
  public ListVolumesInput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public ListVolumesInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListVolumesInput listVolumesInput = (ListVolumesInput) o;
    return Objects.equals(this.gatewayARN, listVolumesInput.gatewayARN) &&
        Objects.equals(this.marker, listVolumesInput.marker) &&
        Objects.equals(this.limit, listVolumesInput.limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListVolumesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListVolumesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListVolumesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListVolumesInput is not found in the empty JSON string", ListVolumesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListVolumesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListVolumesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListVolumesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListVolumesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListVolumesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListVolumesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListVolumesInput>() {
           @Override
           public void write(JsonWriter out, ListVolumesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListVolumesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListVolumesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListVolumesInput
   * @throws IOException if the JSON string is invalid with respect to ListVolumesInput
   */
  public static ListVolumesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListVolumesInput.class);
  }

  /**
   * Convert an instance of ListVolumesInput to an JSON string
   *
   * @return JSON string
   */
