...
public class CachediSCSIVolume {
  ...
  public CachediSCSIVolume volumeARN(String volumeARN) {
  ...
  public CachediSCSIVolume volumeId(String volumeId) {
  ...
  public CachediSCSIVolume volumeType(String volumeType) {
  ...
  public CachediSCSIVolume volumeStatus(String volumeStatus) {
  ...
  public CachediSCSIVolume volumeAttachmentStatus(String volumeAttachmentStatus) {
  ...
  public CachediSCSIVolume volumeSizeInBytes(Integer volumeSizeInBytes) {
  ...
  public CachediSCSIVolume volumeProgress(Double volumeProgress) {
  ...
  public CachediSCSIVolume sourceSnapshotId(String sourceSnapshotId) {
  ...
  public CachediSCSIVolume volumeiSCSIAttributes(CachediSCSIVolumeVolumeiSCSIAttributes volumeiSCSIAttributes) {
  ...
  public CachediSCSIVolume createdDate(OffsetDateTime createdDate) {
  ...
  public CachediSCSIVolume volumeUsedInBytes(Integer volumeUsedInBytes) {
  ...
  public CachediSCSIVolume kmSKey(String kmSKey) {
    this.kmSKey = kmSKey;
    return this;
  }
  ...
  public CachediSCSIVolume targetName(String targetName) {
  ...
  public boolean equals(Object o) {
    ...
    CachediSCSIVolume cachediSCSIVolume = (CachediSCSIVolume) o;
    return Objects.equals(this.volumeARN, cachediSCSIVolume.volumeARN) &&
        Objects.equals(this.volumeId, cachediSCSIVolume.volumeId) &&
        Objects.equals(this.volumeType, cachediSCSIVolume.volumeType) &&
        Objects.equals(this.volumeStatus, cachediSCSIVolume.volumeStatus) &&
        Objects.equals(this.volumeAttachmentStatus, cachediSCSIVolume.volumeAttachmentStatus) &&
        Objects.equals(this.volumeSizeInBytes, cachediSCSIVolume.volumeSizeInBytes) &&
        Objects.equals(this.volumeProgress, cachediSCSIVolume.volumeProgress) &&
        Objects.equals(this.sourceSnapshotId, cachediSCSIVolume.sourceSnapshotId) &&
        Objects.equals(this.volumeiSCSIAttributes, cachediSCSIVolume.volumeiSCSIAttributes) &&
        Objects.equals(this.createdDate, cachediSCSIVolume.createdDate) &&
        Objects.equals(this.volumeUsedInBytes, cachediSCSIVolume.volumeUsedInBytes) &&
        Objects.equals(this.kmSKey, cachediSCSIVolume.kmSKey) &&
        Objects.equals(this.targetName, cachediSCSIVolume.targetName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(volumeARN, volumeId, volumeType, volumeStatus, volumeAttachmentStatus, volumeSizeInBytes, volumeProgress, sourceSnapshotId, volumeiSCSIAttributes, createdDate, volumeUsedInBytes, kmSKey, targetName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CachediSCSIVolume {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CachediSCSIVolume
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CachediSCSIVolume.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CachediSCSIVolume is not found in the empty JSON string", CachediSCSIVolume.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CachediSCSIVolume.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CachediSCSIVolume` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CachediSCSIVolume.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CachediSCSIVolume' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CachediSCSIVolume> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CachediSCSIVolume.class));

       return (TypeAdapter<T>) new TypeAdapter<CachediSCSIVolume>() {
           @Override
           public void write(JsonWriter out, CachediSCSIVolume value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CachediSCSIVolume read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CachediSCSIVolume given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CachediSCSIVolume
   * @throws IOException if the JSON string is invalid with respect to CachediSCSIVolume
   */
  public static CachediSCSIVolume fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CachediSCSIVolume.class);
  }

  /**
   * Convert an instance of CachediSCSIVolume to an JSON string
   *
   * @return JSON string
   */
