...
public class DescribeAvailabilityMonitorTestOutput {
  ...
  private AvailabilityMonitorTestStatus status;

  public static final String SERIALIZED_NAME_START_TIME = "StartTime";
  @SerializedName(SERIALIZED_NAME_START_TIME)
  private OffsetDateTime startTime;

  public DescribeAvailabilityMonitorTestOutput() {
  }

  public DescribeAvailabilityMonitorTestOutput gatewayARN(String gatewayARN) {
  ...
  public DescribeAvailabilityMonitorTestOutput status(AvailabilityMonitorTestStatus status) {
    this.status = status;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AvailabilityMonitorTestStatus getStatus() {
    return status;
  }
  ...
  public DescribeAvailabilityMonitorTestOutput startTime(OffsetDateTime startTime) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAvailabilityMonitorTestOutput describeAvailabilityMonitorTestOutput = (DescribeAvailabilityMonitorTestOutput) o;
    return Objects.equals(this.gatewayARN, describeAvailabilityMonitorTestOutput.gatewayARN) &&
        Objects.equals(this.status, describeAvailabilityMonitorTestOutput.status) &&
        Objects.equals(this.startTime, describeAvailabilityMonitorTestOutput.startTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, status, startTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeAvailabilityMonitorTestOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAvailabilityMonitorTestOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAvailabilityMonitorTestOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAvailabilityMonitorTestOutput is not found in the empty JSON string", DescribeAvailabilityMonitorTestOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAvailabilityMonitorTestOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAvailabilityMonitorTestOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Status") != null && !jsonObj.get("Status").isJsonNull()) {
        AvailabilityMonitorTestStatus.validateJsonElement(jsonObj.get("Status"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAvailabilityMonitorTestOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAvailabilityMonitorTestOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAvailabilityMonitorTestOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAvailabilityMonitorTestOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAvailabilityMonitorTestOutput>() {
           @Override
           public void write(JsonWriter out, DescribeAvailabilityMonitorTestOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAvailabilityMonitorTestOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAvailabilityMonitorTestOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAvailabilityMonitorTestOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeAvailabilityMonitorTestOutput
   */
  public static DescribeAvailabilityMonitorTestOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAvailabilityMonitorTestOutput.class);
  }

  /**
   * Convert an instance of DescribeAvailabilityMonitorTestOutput to an JSON string
   *
   * @return JSON string
   */
