...
public class RefreshCacheOutput {
  ...
  public RefreshCacheOutput() {
  }

  public RefreshCacheOutput fileShareARN(String fileShareARN) {
  ...
  public RefreshCacheOutput notificationId(String notificationId) {
  ...
  public boolean equals(Object o) {
    ...
    RefreshCacheOutput refreshCacheOutput = (RefreshCacheOutput) o;
    return Objects.equals(this.fileShareARN, refreshCacheOutput.fileShareARN) &&
        Objects.equals(this.notificationId, refreshCacheOutput.notificationId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RefreshCacheOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RefreshCacheOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RefreshCacheOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RefreshCacheOutput is not found in the empty JSON string", RefreshCacheOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RefreshCacheOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RefreshCacheOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RefreshCacheOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RefreshCacheOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RefreshCacheOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RefreshCacheOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<RefreshCacheOutput>() {
           @Override
           public void write(JsonWriter out, RefreshCacheOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RefreshCacheOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RefreshCacheOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RefreshCacheOutput
   * @throws IOException if the JSON string is invalid with respect to RefreshCacheOutput
   */
  public static RefreshCacheOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RefreshCacheOutput.class);
  }

  /**
   * Convert an instance of RefreshCacheOutput to an JSON string
   *
   * @return JSON string
   */
