...
public class CreateTapesOutput {
  ...
  private List tapeARNs;

  public CreateTapesOutput() {
  }

  public CreateTapesOutput tapeARNs(List tapeARNs) {
  ...
  public List getTapeARNs() {
    return tapeARNs;
  }

  public void setTapeARNs(List tapeARNs) {
    this.tapeARNs = tapeARNs;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateTapesOutput createTapesOutput = (CreateTapesOutput) o;
    return Objects.equals(this.tapeARNs, createTapesOutput.tapeARNs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tapeARNs);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateTapesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateTapesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTapesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateTapesOutput is not found in the empty JSON string", CreateTapesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTapesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTapesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `TapeARNs`
      if (jsonObj.get("TapeARNs") != null && !jsonObj.get("TapeARNs").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("TapeARNs"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTapesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTapesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTapesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTapesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTapesOutput>() {
           @Override
           public void write(JsonWriter out, CreateTapesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTapesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateTapesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateTapesOutput
   * @throws IOException if the JSON string is invalid with respect to CreateTapesOutput
   */
  public static CreateTapesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTapesOutput.class);
  }

  /**
   * Convert an instance of CreateTapesOutput to an JSON string
   *
   * @return JSON string
   */
