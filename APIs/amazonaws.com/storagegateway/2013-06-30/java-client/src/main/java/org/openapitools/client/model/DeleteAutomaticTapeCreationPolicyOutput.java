...
public class DeleteAutomaticTapeCreationPolicyOutput {
  ...
  public DeleteAutomaticTapeCreationPolicyOutput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteAutomaticTapeCreationPolicyOutput deleteAutomaticTapeCreationPolicyOutput = (DeleteAutomaticTapeCreationPolicyOutput) o;
    return Objects.equals(this.gatewayARN, deleteAutomaticTapeCreationPolicyOutput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteAutomaticTapeCreationPolicyOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAutomaticTapeCreationPolicyOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAutomaticTapeCreationPolicyOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAutomaticTapeCreationPolicyOutput is not found in the empty JSON string", DeleteAutomaticTapeCreationPolicyOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAutomaticTapeCreationPolicyOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAutomaticTapeCreationPolicyOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAutomaticTapeCreationPolicyOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAutomaticTapeCreationPolicyOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAutomaticTapeCreationPolicyOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAutomaticTapeCreationPolicyOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAutomaticTapeCreationPolicyOutput>() {
           @Override
           public void write(JsonWriter out, DeleteAutomaticTapeCreationPolicyOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAutomaticTapeCreationPolicyOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAutomaticTapeCreationPolicyOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAutomaticTapeCreationPolicyOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteAutomaticTapeCreationPolicyOutput
   */
  public static DeleteAutomaticTapeCreationPolicyOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAutomaticTapeCreationPolicyOutput.class);
  }

  /**
   * Convert an instance of DeleteAutomaticTapeCreationPolicyOutput to an JSON string
   *
   * @return JSON string
   */
