...
public class DescribeStorediSCSIVolumesInput {
  ...
  public DescribeStorediSCSIVolumesInput() {
  }

  public DescribeStorediSCSIVolumesInput volumeARNs(List volumeARNs) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeStorediSCSIVolumesInput describeStorediSCSIVolumesInput = (DescribeStorediSCSIVolumesInput) o;
    return Objects.equals(this.volumeARNs, describeStorediSCSIVolumesInput.volumeARNs);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeStorediSCSIVolumesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeStorediSCSIVolumesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeStorediSCSIVolumesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeStorediSCSIVolumesInput is not found in the empty JSON string", DescribeStorediSCSIVolumesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeStorediSCSIVolumesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeStorediSCSIVolumesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeStorediSCSIVolumesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeStorediSCSIVolumesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeStorediSCSIVolumesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeStorediSCSIVolumesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeStorediSCSIVolumesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeStorediSCSIVolumesInput>() {
           @Override
           public void write(JsonWriter out, DescribeStorediSCSIVolumesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeStorediSCSIVolumesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeStorediSCSIVolumesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeStorediSCSIVolumesInput
   * @throws IOException if the JSON string is invalid with respect to DescribeStorediSCSIVolumesInput
   */
  public static DescribeStorediSCSIVolumesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeStorediSCSIVolumesInput.class);
  }

  /**
   * Convert an instance of DescribeStorediSCSIVolumesInput to an JSON string
   *
   * @return JSON string
   */
