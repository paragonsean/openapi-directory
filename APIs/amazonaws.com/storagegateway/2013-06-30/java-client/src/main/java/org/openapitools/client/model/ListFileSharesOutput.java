...
public class ListFileSharesOutput {
  ...
  public static final String SERIALIZED_NAME_FILE_SHARE_INFO_LIST = "FileShareInfoList";
  @SerializedName(SERIALIZED_NAME_FILE_SHARE_INFO_LIST)
  private List fileShareInfoList;

  public ListFileSharesOutput() {
  }

  public ListFileSharesOutput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public ListFileSharesOutput nextMarker(String nextMarker) {
  ...
  public ListFileSharesOutput fileShareInfoList(List fileShareInfoList) {
    this.fileShareInfoList = fileShareInfoList;
    return this;
  }

  /**
   * Get fileShareInfoList
   * @return fileShareInfoList
   */
  @javax.annotation.Nullable
  public List getFileShareInfoList() {
    return fileShareInfoList;
  }

  public void setFileShareInfoList(List fileShareInfoList) {
    this.fileShareInfoList = fileShareInfoList;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListFileSharesOutput listFileSharesOutput = (ListFileSharesOutput) o;
    return Objects.equals(this.marker, listFileSharesOutput.marker) &&
        Objects.equals(this.nextMarker, listFileSharesOutput.nextMarker) &&
        Objects.equals(this.fileShareInfoList, listFileSharesOutput.fileShareInfoList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(marker, nextMarker, fileShareInfoList);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListFileSharesOutput {\n");
    sb.append("    marker: ").append(toIndentedString(marker)).append("\n");
    sb.append("    nextMarker: ").append(toIndentedString(nextMarker)).append("\n");
    sb.append("    fileShareInfoList: ").append(toIndentedString(fileShareInfoList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("FileShareInfoList");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFileSharesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFileSharesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFileSharesOutput is not found in the empty JSON string", ListFileSharesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFileSharesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFileSharesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `FileShareInfoList`
      if (jsonObj.get("FileShareInfoList") != null && !jsonObj.get("FileShareInfoList").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("FileShareInfoList"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFileSharesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFileSharesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFileSharesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFileSharesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFileSharesOutput>() {
           @Override
           public void write(JsonWriter out, ListFileSharesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFileSharesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListFileSharesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListFileSharesOutput
   * @throws IOException if the JSON string is invalid with respect to ListFileSharesOutput
   */
  public static ListFileSharesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListFileSharesOutput.class);
  }

  /**
   * Convert an instance of ListFileSharesOutput to an JSON string
   *
   * @return JSON string
   */
