...
public class DisassociateFileSystemInput {
  ...
  public DisassociateFileSystemInput() {
  }

  public DisassociateFileSystemInput fileSystemAssociationARN(String fileSystemAssociationARN) {
  ...
  public DisassociateFileSystemInput forceDelete(Boolean forceDelete) {
  ...
  public boolean equals(Object o) {
    ...
    DisassociateFileSystemInput disassociateFileSystemInput = (DisassociateFileSystemInput) o;
    return Objects.equals(this.fileSystemAssociationARN, disassociateFileSystemInput.fileSystemAssociationARN) &&
        Objects.equals(this.forceDelete, disassociateFileSystemInput.forceDelete);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileSystemAssociationARN, forceDelete);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DisassociateFileSystemInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateFileSystemInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateFileSystemInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateFileSystemInput is not found in the empty JSON string", DisassociateFileSystemInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateFileSystemInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateFileSystemInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisassociateFileSystemInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateFileSystemInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateFileSystemInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateFileSystemInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateFileSystemInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateFileSystemInput>() {
           @Override
           public void write(JsonWriter out, DisassociateFileSystemInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateFileSystemInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateFileSystemInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateFileSystemInput
   * @throws IOException if the JSON string is invalid with respect to DisassociateFileSystemInput
   */
  public static DisassociateFileSystemInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateFileSystemInput.class);
  }

  /**
   * Convert an instance of DisassociateFileSystemInput to an JSON string
   *
   * @return JSON string
   */
