...
public class VolumeInfo {
  ...
  public VolumeInfo volumeARN(String volumeARN) {
  ...
  public VolumeInfo gatewayARN(String gatewayARN) {
  ...
  public VolumeInfo gatewayId(String gatewayId) {
  ...
  public VolumeInfo volumeType(String volumeType) {
  ...
  public VolumeInfo volumeSizeInBytes(Integer volumeSizeInBytes) {
  ...
  public VolumeInfo volumeAttachmentStatus(String volumeAttachmentStatus) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.volumeARN, volumeInfo.volumeARN) &&
        Objects.equals(this.volumeId, volumeInfo.volumeId) &&
        Objects.equals(this.gatewayARN, volumeInfo.gatewayARN) &&
        Objects.equals(this.gatewayId, volumeInfo.gatewayId) &&
        Objects.equals(this.volumeType, volumeInfo.volumeType) &&
        Objects.equals(this.volumeSizeInBytes, volumeInfo.volumeSizeInBytes) &&
        Objects.equals(this.volumeAttachmentStatus, volumeInfo.volumeAttachmentStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(volumeARN, volumeId, gatewayARN, gatewayId, volumeType, volumeSizeInBytes, volumeAttachmentStatus);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to VolumeInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VolumeInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeInfo is not found in the empty JSON string", VolumeInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VolumeInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VolumeInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeInfo>() {
           @Override
           public void write(JsonWriter out, VolumeInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VolumeInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VolumeInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VolumeInfo
   * @throws IOException if the JSON string is invalid with respect to VolumeInfo
   */
  public static VolumeInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeInfo.class);
  }

  /**
   * Convert an instance of VolumeInfo to an JSON string
   *
   * @return JSON string
   */
