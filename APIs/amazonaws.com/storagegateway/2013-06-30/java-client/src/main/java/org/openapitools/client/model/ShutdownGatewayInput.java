...
public class ShutdownGatewayInput {
  ...
  public ShutdownGatewayInput() {
  }

  public ShutdownGatewayInput gatewayARN(String gatewayARN) {
  ...
  public boolean equals(Object o) {
    ...
    ShutdownGatewayInput shutdownGatewayInput = (ShutdownGatewayInput) o;
    return Objects.equals(this.gatewayARN, shutdownGatewayInput.gatewayARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShutdownGatewayInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ShutdownGatewayInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShutdownGatewayInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShutdownGatewayInput is not found in the empty JSON string", ShutdownGatewayInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ShutdownGatewayInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShutdownGatewayInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShutdownGatewayInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShutdownGatewayInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShutdownGatewayInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShutdownGatewayInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShutdownGatewayInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ShutdownGatewayInput>() {
           @Override
           public void write(JsonWriter out, ShutdownGatewayInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShutdownGatewayInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ShutdownGatewayInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ShutdownGatewayInput
   * @throws IOException if the JSON string is invalid with respect to ShutdownGatewayInput
   */
  public static ShutdownGatewayInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShutdownGatewayInput.class);
  }

  /**
   * Convert an instance of ShutdownGatewayInput to an JSON string
   *
   * @return JSON string
   */
