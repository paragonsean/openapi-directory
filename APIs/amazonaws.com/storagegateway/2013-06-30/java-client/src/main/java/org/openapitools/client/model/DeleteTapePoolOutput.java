...
public class DeleteTapePoolOutput {
  ...
  public DeleteTapePoolOutput() {
  }

  public DeleteTapePoolOutput poolARN(String poolARN) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteTapePoolOutput deleteTapePoolOutput = (DeleteTapePoolOutput) o;
    return Objects.equals(this.poolARN, deleteTapePoolOutput.poolARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteTapePoolOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTapePoolOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTapePoolOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTapePoolOutput is not found in the empty JSON string", DeleteTapePoolOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTapePoolOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTapePoolOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTapePoolOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTapePoolOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTapePoolOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTapePoolOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTapePoolOutput>() {
           @Override
           public void write(JsonWriter out, DeleteTapePoolOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTapePoolOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTapePoolOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTapePoolOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteTapePoolOutput
   */
  public static DeleteTapePoolOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTapePoolOutput.class);
  }

  /**
   * Convert an instance of DeleteTapePoolOutput to an JSON string
   *
   * @return JSON string
   */
