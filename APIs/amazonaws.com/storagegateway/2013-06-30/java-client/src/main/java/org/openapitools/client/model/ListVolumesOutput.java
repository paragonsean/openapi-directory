...
public class ListVolumesOutput {
  ...
  public static final String SERIALIZED_NAME_VOLUME_INFOS = "VolumeInfos";
  @SerializedName(SERIALIZED_NAME_VOLUME_INFOS)
  private List volumeInfos;

  public ListVolumesOutput() {
  }

  public ListVolumesOutput gatewayARN(String gatewayARN) {
  ...
  public ListVolumesOutput marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public ListVolumesOutput volumeInfos(List volumeInfos) {
  ...
  public boolean equals(Object o) {
    ...
    ListVolumesOutput listVolumesOutput = (ListVolumesOutput) o;
    return Objects.equals(this.gatewayARN, listVolumesOutput.gatewayARN) &&
        Objects.equals(this.marker, listVolumesOutput.marker) &&
        Objects.equals(this.volumeInfos, listVolumesOutput.volumeInfos);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayARN, marker, volumeInfos);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListVolumesOutput {\n");
    sb.append("    gatewayARN: ").append(toIndentedString(gatewayARN)).append("\n");
    sb.append("    marker: ").append(toIndentedString(marker)).append("\n");
    sb.append("    volumeInfos: ").append(toIndentedString(volumeInfos)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListVolumesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListVolumesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListVolumesOutput is not found in the empty JSON string", ListVolumesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListVolumesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListVolumesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `VolumeInfos`
      if (jsonObj.get("VolumeInfos") != null && !jsonObj.get("VolumeInfos").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("VolumeInfos"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListVolumesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListVolumesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListVolumesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListVolumesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListVolumesOutput>() {
           @Override
           public void write(JsonWriter out, ListVolumesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListVolumesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListVolumesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListVolumesOutput
   * @throws IOException if the JSON string is invalid with respect to ListVolumesOutput
   */
  public static ListVolumesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListVolumesOutput.class);
  }

  /**
   * Convert an instance of ListVolumesOutput to an JSON string
   *
   * @return JSON string
   */
