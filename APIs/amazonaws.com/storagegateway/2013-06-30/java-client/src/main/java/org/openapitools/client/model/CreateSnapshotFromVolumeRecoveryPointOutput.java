...
public class CreateSnapshotFromVolumeRecoveryPointOutput {
  ...
  public CreateSnapshotFromVolumeRecoveryPointOutput() {
  }

  public CreateSnapshotFromVolumeRecoveryPointOutput snapshotId(String snapshotId) {
  ...
  public CreateSnapshotFromVolumeRecoveryPointOutput volumeARN(String volumeARN) {
  ...
  public CreateSnapshotFromVolumeRecoveryPointOutput volumeRecoveryPointTime(String volumeRecoveryPointTime) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSnapshotFromVolumeRecoveryPointOutput createSnapshotFromVolumeRecoveryPointOutput = (CreateSnapshotFromVolumeRecoveryPointOutput) o;
    return Objects.equals(this.snapshotId, createSnapshotFromVolumeRecoveryPointOutput.snapshotId) &&
        Objects.equals(this.volumeARN, createSnapshotFromVolumeRecoveryPointOutput.volumeARN) &&
        Objects.equals(this.volumeRecoveryPointTime, createSnapshotFromVolumeRecoveryPointOutput.volumeRecoveryPointTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(snapshotId, volumeARN, volumeRecoveryPointTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateSnapshotFromVolumeRecoveryPointOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSnapshotFromVolumeRecoveryPointOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSnapshotFromVolumeRecoveryPointOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSnapshotFromVolumeRecoveryPointOutput is not found in the empty JSON string", CreateSnapshotFromVolumeRecoveryPointOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSnapshotFromVolumeRecoveryPointOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSnapshotFromVolumeRecoveryPointOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSnapshotFromVolumeRecoveryPointOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSnapshotFromVolumeRecoveryPointOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSnapshotFromVolumeRecoveryPointOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSnapshotFromVolumeRecoveryPointOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSnapshotFromVolumeRecoveryPointOutput>() {
           @Override
           public void write(JsonWriter out, CreateSnapshotFromVolumeRecoveryPointOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSnapshotFromVolumeRecoveryPointOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSnapshotFromVolumeRecoveryPointOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSnapshotFromVolumeRecoveryPointOutput
   * @throws IOException if the JSON string is invalid with respect to CreateSnapshotFromVolumeRecoveryPointOutput
   */
  public static CreateSnapshotFromVolumeRecoveryPointOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSnapshotFromVolumeRecoveryPointOutput.class);
  }

  /**
   * Convert an instance of CreateSnapshotFromVolumeRecoveryPointOutput to an JSON string
   *
   * @return JSON string
   */
