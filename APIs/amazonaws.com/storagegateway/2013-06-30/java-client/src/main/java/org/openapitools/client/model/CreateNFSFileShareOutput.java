...
public class CreateNFSFileShareOutput {
  ...
  public CreateNFSFileShareOutput() {
  }

  public CreateNFSFileShareOutput fileShareARN(String fileShareARN) {
  ...
  public boolean equals(Object o) {
    ...
    CreateNFSFileShareOutput createNFSFileShareOutput = (CreateNFSFileShareOutput) o;
    return Objects.equals(this.fileShareARN, createNFSFileShareOutput.fileShareARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateNFSFileShareOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateNFSFileShareOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateNFSFileShareOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateNFSFileShareOutput is not found in the empty JSON string", CreateNFSFileShareOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateNFSFileShareOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateNFSFileShareOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateNFSFileShareOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateNFSFileShareOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateNFSFileShareOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateNFSFileShareOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateNFSFileShareOutput>() {
           @Override
           public void write(JsonWriter out, CreateNFSFileShareOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateNFSFileShareOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateNFSFileShareOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateNFSFileShareOutput
   * @throws IOException if the JSON string is invalid with respect to CreateNFSFileShareOutput
   */
  public static CreateNFSFileShareOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateNFSFileShareOutput.class);
  }

  /**
   * Convert an instance of CreateNFSFileShareOutput to an JSON string
   *
   * @return JSON string
   */
