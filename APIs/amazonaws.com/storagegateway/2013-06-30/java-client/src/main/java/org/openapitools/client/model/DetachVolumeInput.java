...
public class DetachVolumeInput {
  ...
  public static final String SERIALIZED_NAME_FORCE_DETACH = "ForceDetach";
  @SerializedName(SERIALIZED_NAME_FORCE_DETACH)
  private Boolean forceDetach;

  public DetachVolumeInput() {
  }

  public DetachVolumeInput volumeARN(String volumeARN) {
  ...
  public DetachVolumeInput forceDetach(Boolean forceDetach) {
  ...
  public boolean equals(Object o) {
    ...
    DetachVolumeInput detachVolumeInput = (DetachVolumeInput) o;
    return Objects.equals(this.volumeARN, detachVolumeInput.volumeARN) &&
        Objects.equals(this.forceDetach, detachVolumeInput.forceDetach);
  }

  @Override
  public int hashCode() {
    return Objects.hash(volumeARN, forceDetach);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetachVolumeInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetachVolumeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetachVolumeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetachVolumeInput is not found in the empty JSON string", DetachVolumeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetachVolumeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetachVolumeInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DetachVolumeInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("ForceDetach") != null && !jsonObj.get("ForceDetach").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("ForceDetach"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetachVolumeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetachVolumeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetachVolumeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetachVolumeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DetachVolumeInput>() {
           @Override
           public void write(JsonWriter out, DetachVolumeInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetachVolumeInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetachVolumeInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetachVolumeInput
   * @throws IOException if the JSON string is invalid with respect to DetachVolumeInput
   */
  public static DetachVolumeInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetachVolumeInput.class);
  }

  /**
   * Convert an instance of DetachVolumeInput to an JSON string
   *
   * @return JSON string
   */
