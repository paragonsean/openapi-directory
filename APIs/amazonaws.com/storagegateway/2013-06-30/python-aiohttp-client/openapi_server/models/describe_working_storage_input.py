...
class DescribeWorkingStorageInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DescribeWorkingStorageInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DescribeWorkingStorageInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeWorkingStorageInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeWorkingStorageInput of this DescribeWorkingStorageInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DescribeWorkingStorageInput.
        ...
        :return: The gateway_arn of this DescribeWorkingStorageInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DescribeWorkingStorageInput.
