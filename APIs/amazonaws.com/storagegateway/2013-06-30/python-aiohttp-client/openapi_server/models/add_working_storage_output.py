...
class AddWorkingStorageOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """AddWorkingStorageOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this AddWorkingStorageOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AddWorkingStorageOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AddWorkingStorageOutput of this AddWorkingStorageOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this AddWorkingStorageOutput.
        ...
        :return: The gateway_arn of this AddWorkingStorageOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this AddWorkingStorageOutput.
