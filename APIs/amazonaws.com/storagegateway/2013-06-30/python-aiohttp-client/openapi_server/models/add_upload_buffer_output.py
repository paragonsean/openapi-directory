...
class AddUploadBufferOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """AddUploadBufferOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this AddUploadBufferOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AddUploadBufferOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AddUploadBufferOutput of this AddUploadBufferOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this AddUploadBufferOutput.
        ...
        :return: The gateway_arn of this AddUploadBufferOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this AddUploadBufferOutput.
