...
class ListLocalDisksInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """ListLocalDisksInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this ListLocalDisksInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListLocalDisksInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListLocalDisksInput of this ListLocalDisksInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this ListLocalDisksInput.
        ...
        :return: The gateway_arn of this ListLocalDisksInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this ListLocalDisksInput.
