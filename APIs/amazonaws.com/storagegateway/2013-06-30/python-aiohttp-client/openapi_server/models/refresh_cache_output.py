...
class RefreshCacheOutput(Model):
    ...
    def __init__(self, file_share_arn: str=None, notification_id: str=None):
        """RefreshCacheOutput - a model defined in OpenAPI

        :param file_share_arn: The file_share_arn of this RefreshCacheOutput.
        :param notification_id: The notification_id of this RefreshCacheOutput.
        """
        self.openapi_types = {
            'file_share_arn': str,
            'notification_id': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RefreshCacheOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RefreshCacheOutput of this RefreshCacheOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def file_share_arn(self):
        """Gets the file_share_arn of this RefreshCacheOutput.

        The Amazon Resource Name (ARN) of the file share.

        :return: The file_share_arn of this RefreshCacheOutput.
        :rtype: str
        """
    ...
    def file_share_arn(self, file_share_arn):
        """Sets the file_share_arn of this RefreshCacheOutput.
    ...
    def notification_id(self):
        """Gets the notification_id of this RefreshCacheOutput.

        The randomly generated ID of the notification that was sent. This ID is in UUID format.

        :return: The notification_id of this RefreshCacheOutput.
        :rtype: str
        """
    ...
    def notification_id(self, notification_id):
        """Sets the notification_id of this RefreshCacheOutput.
