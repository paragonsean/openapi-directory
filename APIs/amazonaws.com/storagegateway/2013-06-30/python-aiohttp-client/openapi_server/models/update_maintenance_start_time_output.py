...
class UpdateMaintenanceStartTimeOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """UpdateMaintenanceStartTimeOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this UpdateMaintenanceStartTimeOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateMaintenanceStartTimeOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateMaintenanceStartTimeOutput of this UpdateMaintenanceStartTimeOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this UpdateMaintenanceStartTimeOutput.
        ...
        :return: The gateway_arn of this UpdateMaintenanceStartTimeOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this UpdateMaintenanceStartTimeOutput.
