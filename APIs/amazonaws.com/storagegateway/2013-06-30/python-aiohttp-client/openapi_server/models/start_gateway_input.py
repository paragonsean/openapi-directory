...
class StartGatewayInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """StartGatewayInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this StartGatewayInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StartGatewayInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StartGatewayInput of this StartGatewayInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this StartGatewayInput.
        ...
        :return: The gateway_arn of this StartGatewayInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this StartGatewayInput.
