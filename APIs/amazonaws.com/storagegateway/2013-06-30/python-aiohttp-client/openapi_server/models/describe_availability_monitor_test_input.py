...
class DescribeAvailabilityMonitorTestInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DescribeAvailabilityMonitorTestInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DescribeAvailabilityMonitorTestInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeAvailabilityMonitorTestInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeAvailabilityMonitorTestInput of this DescribeAvailabilityMonitorTestInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DescribeAvailabilityMonitorTestInput.
        ...
        :return: The gateway_arn of this DescribeAvailabilityMonitorTestInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DescribeAvailabilityMonitorTestInput.
