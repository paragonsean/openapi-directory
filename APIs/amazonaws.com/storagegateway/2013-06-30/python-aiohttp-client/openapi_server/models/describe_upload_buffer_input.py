...
class DescribeUploadBufferInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DescribeUploadBufferInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DescribeUploadBufferInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeUploadBufferInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeUploadBufferInput of this DescribeUploadBufferInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DescribeUploadBufferInput.
        ...
        :return: The gateway_arn of this DescribeUploadBufferInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DescribeUploadBufferInput.
