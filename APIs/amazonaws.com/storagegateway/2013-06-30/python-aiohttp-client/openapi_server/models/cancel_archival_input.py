...
class CancelArchivalInput(Model):
    ...
    def __init__(self, gateway_arn: str=None, tape_arn: str=None):
        """CancelArchivalInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this CancelArchivalInput.
        :param tape_arn: The tape_arn of this CancelArchivalInput.
        """
        self.openapi_types = {
            'gateway_arn': str,
            'tape_arn': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CancelArchivalInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CancelArchivalInput of this CancelArchivalInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this CancelArchivalInput.
        ...
        :return: The gateway_arn of this CancelArchivalInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this CancelArchivalInput.
    ...
    @property
    def tape_arn(self):
        """Gets the tape_arn of this CancelArchivalInput.


        :return: The tape_arn of this CancelArchivalInput.
        :rtype: str
        """
    ...
    def tape_arn(self, tape_arn):
        """Sets the tape_arn of this CancelArchivalInput.
