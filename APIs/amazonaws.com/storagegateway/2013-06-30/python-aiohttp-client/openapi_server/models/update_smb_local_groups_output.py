...
class UpdateSMBLocalGroupsOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """UpdateSMBLocalGroupsOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this UpdateSMBLocalGroupsOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateSMBLocalGroupsOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateSMBLocalGroupsOutput of this UpdateSMBLocalGroupsOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this UpdateSMBLocalGroupsOutput.
        ...
        :return: The gateway_arn of this UpdateSMBLocalGroupsOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this UpdateSMBLocalGroupsOutput.
