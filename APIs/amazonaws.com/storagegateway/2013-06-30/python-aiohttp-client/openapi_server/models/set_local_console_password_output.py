...
class SetLocalConsolePasswordOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """SetLocalConsolePasswordOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this SetLocalConsolePasswordOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SetLocalConsolePasswordOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SetLocalConsolePasswordOutput of this SetLocalConsolePasswordOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this SetLocalConsolePasswordOutput.
        ...
        :return: The gateway_arn of this SetLocalConsolePasswordOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this SetLocalConsolePasswordOutput.
