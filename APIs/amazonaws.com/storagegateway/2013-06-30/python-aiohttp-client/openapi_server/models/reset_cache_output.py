...
class ResetCacheOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """ResetCacheOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this ResetCacheOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ResetCacheOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ResetCacheOutput of this ResetCacheOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this ResetCacheOutput.
        ...
        :return: The gateway_arn of this ResetCacheOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this ResetCacheOutput.
