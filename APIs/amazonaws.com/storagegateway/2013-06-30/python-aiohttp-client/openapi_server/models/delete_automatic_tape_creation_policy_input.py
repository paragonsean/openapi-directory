...
class DeleteAutomaticTapeCreationPolicyInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DeleteAutomaticTapeCreationPolicyInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DeleteAutomaticTapeCreationPolicyInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteAutomaticTapeCreationPolicyInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteAutomaticTapeCreationPolicyInput of this DeleteAutomaticTapeCreationPolicyInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DeleteAutomaticTapeCreationPolicyInput.
        ...
        :return: The gateway_arn of this DeleteAutomaticTapeCreationPolicyInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DeleteAutomaticTapeCreationPolicyInput.
