...
class DescribeMaintenanceStartTimeInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DescribeMaintenanceStartTimeInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DescribeMaintenanceStartTimeInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeMaintenanceStartTimeInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeMaintenanceStartTimeInput of this DescribeMaintenanceStartTimeInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DescribeMaintenanceStartTimeInput.
        ...
        :return: The gateway_arn of this DescribeMaintenanceStartTimeInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DescribeMaintenanceStartTimeInput.
