...
class UpdateGatewaySoftwareNowInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """UpdateGatewaySoftwareNowInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this UpdateGatewaySoftwareNowInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateGatewaySoftwareNowInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateGatewaySoftwareNowInput of this UpdateGatewaySoftwareNowInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this UpdateGatewaySoftwareNowInput.
        ...
        :return: The gateway_arn of this UpdateGatewaySoftwareNowInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this UpdateGatewaySoftwareNowInput.
