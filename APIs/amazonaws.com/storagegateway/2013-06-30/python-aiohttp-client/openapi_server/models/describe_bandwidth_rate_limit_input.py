...
class DescribeBandwidthRateLimitInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DescribeBandwidthRateLimitInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DescribeBandwidthRateLimitInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeBandwidthRateLimitInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeBandwidthRateLimitInput of this DescribeBandwidthRateLimitInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DescribeBandwidthRateLimitInput.
        ...
        :return: The gateway_arn of this DescribeBandwidthRateLimitInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DescribeBandwidthRateLimitInput.
