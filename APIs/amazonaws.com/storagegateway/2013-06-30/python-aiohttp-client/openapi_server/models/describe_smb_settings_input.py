...
class DescribeSMBSettingsInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DescribeSMBSettingsInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DescribeSMBSettingsInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeSMBSettingsInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeSMBSettingsInput of this DescribeSMBSettingsInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DescribeSMBSettingsInput.
        ...
        :return: The gateway_arn of this DescribeSMBSettingsInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DescribeSMBSettingsInput.
