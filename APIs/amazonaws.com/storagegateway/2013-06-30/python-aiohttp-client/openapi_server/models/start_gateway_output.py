...
class StartGatewayOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """StartGatewayOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this StartGatewayOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StartGatewayOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StartGatewayOutput of this StartGatewayOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this StartGatewayOutput.
        ...
        :return: The gateway_arn of this StartGatewayOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this StartGatewayOutput.
