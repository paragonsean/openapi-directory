...
class StartAvailabilityMonitorTestInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """StartAvailabilityMonitorTestInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this StartAvailabilityMonitorTestInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StartAvailabilityMonitorTestInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StartAvailabilityMonitorTestInput of this StartAvailabilityMonitorTestInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this StartAvailabilityMonitorTestInput.
        ...
        :return: The gateway_arn of this StartAvailabilityMonitorTestInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this StartAvailabilityMonitorTestInput.
