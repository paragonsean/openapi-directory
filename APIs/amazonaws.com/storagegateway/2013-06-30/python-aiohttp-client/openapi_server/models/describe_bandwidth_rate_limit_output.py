...
class DescribeBandwidthRateLimitOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None, average_upload_rate_limit_in_bits_per_sec: int=None, average_download_rate_limit_in_bits_per_sec: int=None):
        """DescribeBandwidthRateLimitOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DescribeBandwidthRateLimitOutput.
        :param average_upload_rate_limit_in_bits_per_sec: The average_upload_rate_limit_in_bits_per_sec of this DescribeBandwidthRateLimitOutput.
        :param average_download_rate_limit_in_bits_per_sec: The average_download_rate_limit_in_bits_per_sec of this DescribeBandwidthRateLimitOutput.
        """
        self.openapi_types = {
            'gateway_arn': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeBandwidthRateLimitOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeBandwidthRateLimitOutput of this DescribeBandwidthRateLimitOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DescribeBandwidthRateLimitOutput.
        ...
        :return: The gateway_arn of this DescribeBandwidthRateLimitOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DescribeBandwidthRateLimitOutput.
    ...
    def average_upload_rate_limit_in_bits_per_sec(self):
        """Gets the average_upload_rate_limit_in_bits_per_sec of this DescribeBandwidthRateLimitOutput.


        :return: The average_upload_rate_limit_in_bits_per_sec of this DescribeBandwidthRateLimitOutput.
        :rtype: int
        """
    ...
    def average_upload_rate_limit_in_bits_per_sec(self, average_upload_rate_limit_in_bits_per_sec):
        """Sets the average_upload_rate_limit_in_bits_per_sec of this DescribeBandwidthRateLimitOutput.
    ...
    def average_download_rate_limit_in_bits_per_sec(self):
        """Gets the average_download_rate_limit_in_bits_per_sec of this DescribeBandwidthRateLimitOutput.


        :return: The average_download_rate_limit_in_bits_per_sec of this DescribeBandwidthRateLimitOutput.
        :rtype: int
        """
    ...
    def average_download_rate_limit_in_bits_per_sec(self, average_download_rate_limit_in_bits_per_sec):
        """Sets the average_download_rate_limit_in_bits_per_sec of this DescribeBandwidthRateLimitOutput.
