...
class ShutdownGatewayOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """ShutdownGatewayOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this ShutdownGatewayOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ShutdownGatewayOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ShutdownGatewayOutput of this ShutdownGatewayOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this ShutdownGatewayOutput.
        ...
        :return: The gateway_arn of this ShutdownGatewayOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this ShutdownGatewayOutput.
