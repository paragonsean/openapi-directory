...
class DisableGatewayInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DisableGatewayInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DisableGatewayInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DisableGatewayInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DisableGatewayInput of this DisableGatewayInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DisableGatewayInput.
        ...
        :return: The gateway_arn of this DisableGatewayInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DisableGatewayInput.
