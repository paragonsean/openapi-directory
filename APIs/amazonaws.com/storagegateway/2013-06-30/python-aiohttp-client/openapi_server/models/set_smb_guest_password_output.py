...
class SetSMBGuestPasswordOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """SetSMBGuestPasswordOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this SetSMBGuestPasswordOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SetSMBGuestPasswordOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SetSMBGuestPasswordOutput of this SetSMBGuestPasswordOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this SetSMBGuestPasswordOutput.
        ...
        :return: The gateway_arn of this SetSMBGuestPasswordOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this SetSMBGuestPasswordOutput.
