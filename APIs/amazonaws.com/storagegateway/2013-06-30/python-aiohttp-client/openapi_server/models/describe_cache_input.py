...
class DescribeCacheInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DescribeCacheInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DescribeCacheInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeCacheInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeCacheInput of this DescribeCacheInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DescribeCacheInput.
        ...
        :return: The gateway_arn of this DescribeCacheInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DescribeCacheInput.
