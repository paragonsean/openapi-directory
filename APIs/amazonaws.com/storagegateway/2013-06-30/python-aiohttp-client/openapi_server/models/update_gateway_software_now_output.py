...
class UpdateGatewaySoftwareNowOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """UpdateGatewaySoftwareNowOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this UpdateGatewaySoftwareNowOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateGatewaySoftwareNowOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateGatewaySoftwareNowOutput of this UpdateGatewaySoftwareNowOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this UpdateGatewaySoftwareNowOutput.
        ...
        :return: The gateway_arn of this UpdateGatewaySoftwareNowOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this UpdateGatewaySoftwareNowOutput.
