...
class DeleteBandwidthRateLimitOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DeleteBandwidthRateLimitOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DeleteBandwidthRateLimitOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteBandwidthRateLimitOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteBandwidthRateLimitOutput of this DeleteBandwidthRateLimitOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DeleteBandwidthRateLimitOutput.
        ...
        :return: The gateway_arn of this DeleteBandwidthRateLimitOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DeleteBandwidthRateLimitOutput.
