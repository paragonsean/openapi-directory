...
class DescribeBandwidthRateLimitScheduleInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DescribeBandwidthRateLimitScheduleInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DescribeBandwidthRateLimitScheduleInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeBandwidthRateLimitScheduleInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeBandwidthRateLimitScheduleInput of this DescribeBandwidthRateLimitScheduleInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DescribeBandwidthRateLimitScheduleInput.
        ...
        :return: The gateway_arn of this DescribeBandwidthRateLimitScheduleInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DescribeBandwidthRateLimitScheduleInput.
