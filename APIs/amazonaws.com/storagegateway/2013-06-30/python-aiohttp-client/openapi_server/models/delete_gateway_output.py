...
class DeleteGatewayOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DeleteGatewayOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DeleteGatewayOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteGatewayOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteGatewayOutput of this DeleteGatewayOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DeleteGatewayOutput.
        ...
        :return: The gateway_arn of this DeleteGatewayOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DeleteGatewayOutput.
