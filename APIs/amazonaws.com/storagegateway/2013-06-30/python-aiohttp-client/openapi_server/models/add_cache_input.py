...
class AddCacheInput(Model):
    ...
    def __init__(self, gateway_arn: str=None, disk_ids: List=None):
        """AddCacheInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this AddCacheInput.
        :param disk_ids: The disk_ids of this AddCacheInput.
        """
        self.openapi_types = {
            'gateway_arn': str,
            'disk_ids': List
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AddCacheInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AddCacheInput of this AddCacheInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this AddCacheInput.
        ...
        :return: The gateway_arn of this AddCacheInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this AddCacheInput.
    ...
    @property
    def disk_ids(self):
        """Gets the disk_ids of this AddCacheInput.


        :return: The disk_ids of this AddCacheInput.
        :rtype: List
        """
    ...
    def disk_ids(self, disk_ids):
        """Sets the disk_ids of this AddCacheInput.
