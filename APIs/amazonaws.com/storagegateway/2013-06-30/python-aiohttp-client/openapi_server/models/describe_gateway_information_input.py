...
class DescribeGatewayInformationInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DescribeGatewayInformationInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DescribeGatewayInformationInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeGatewayInformationInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeGatewayInformationInput of this DescribeGatewayInformationInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DescribeGatewayInformationInput.
        ...
        :return: The gateway_arn of this DescribeGatewayInformationInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DescribeGatewayInformationInput.
