...
class ActivateGatewayOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """ActivateGatewayOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this ActivateGatewayOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ActivateGatewayOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ActivateGatewayOutput of this ActivateGatewayOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this ActivateGatewayOutput.
        ...
        :return: The gateway_arn of this ActivateGatewayOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this ActivateGatewayOutput.
