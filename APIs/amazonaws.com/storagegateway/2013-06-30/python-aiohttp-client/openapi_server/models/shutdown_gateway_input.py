...
class ShutdownGatewayInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """ShutdownGatewayInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this ShutdownGatewayInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ShutdownGatewayInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ShutdownGatewayInput of this ShutdownGatewayInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this ShutdownGatewayInput.
        ...
        :return: The gateway_arn of this ShutdownGatewayInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this ShutdownGatewayInput.
