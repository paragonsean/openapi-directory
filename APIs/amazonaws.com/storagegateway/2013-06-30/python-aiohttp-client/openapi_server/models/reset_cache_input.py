...
class ResetCacheInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """ResetCacheInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this ResetCacheInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ResetCacheInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ResetCacheInput of this ResetCacheInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this ResetCacheInput.
        ...
        :return: The gateway_arn of this ResetCacheInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this ResetCacheInput.
