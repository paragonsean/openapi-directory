...
class UpdateSMBSecurityStrategyOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """UpdateSMBSecurityStrategyOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this UpdateSMBSecurityStrategyOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateSMBSecurityStrategyOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateSMBSecurityStrategyOutput of this UpdateSMBSecurityStrategyOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this UpdateSMBSecurityStrategyOutput.
        ...
        :return: The gateway_arn of this UpdateSMBSecurityStrategyOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this UpdateSMBSecurityStrategyOutput.
