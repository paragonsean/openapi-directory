...
class AddCacheOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """AddCacheOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this AddCacheOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AddCacheOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AddCacheOutput of this AddCacheOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this AddCacheOutput.
        ...
        :return: The gateway_arn of this AddCacheOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this AddCacheOutput.
