...
class UpdateBandwidthRateLimitOutput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """UpdateBandwidthRateLimitOutput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this UpdateBandwidthRateLimitOutput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateBandwidthRateLimitOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateBandwidthRateLimitOutput of this UpdateBandwidthRateLimitOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this UpdateBandwidthRateLimitOutput.
        ...
        :return: The gateway_arn of this UpdateBandwidthRateLimitOutput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this UpdateBandwidthRateLimitOutput.
