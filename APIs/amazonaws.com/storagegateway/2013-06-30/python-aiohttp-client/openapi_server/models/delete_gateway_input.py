...
class DeleteGatewayInput(Model):
    ...
    def __init__(self, gateway_arn: str=None):
        """DeleteGatewayInput - a model defined in OpenAPI

        :param gateway_arn: The gateway_arn of this DeleteGatewayInput.
        """
        self.openapi_types = {
            'gateway_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteGatewayInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteGatewayInput of this DeleteGatewayInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_arn(self):
        """Gets the gateway_arn of this DeleteGatewayInput.
        ...
        :return: The gateway_arn of this DeleteGatewayInput.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this DeleteGatewayInput.
