...
/**
 * The CreateCachediSCSIVolumeOutput model module.
 * @module model/CreateCachediSCSIVolumeOutput
 * @version 2013-06-30
 */
class CreateCachediSCSIVolumeOutput {
    /**
     * Constructs a new <code>CreateCachediSCSIVolumeOutput</code>.
     * @alias module:model/CreateCachediSCSIVolumeOutput
     */
    constructor() { 
        
        CreateCachediSCSIVolumeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateCachediSCSIVolumeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCachediSCSIVolumeOutput} obj Optional instance to populate.
     * @return {module:model/CreateCachediSCSIVolumeOutput} The populated <code>CreateCachediSCSIVolumeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCachediSCSIVolumeOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCachediSCSIVolumeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCachediSCSIVolumeOutput</code>.
     */
 ...
 */
CreateCachediSCSIVolumeOutput.prototype['VolumeARN'] = undefined;

/**
 * @member {String} TargetARN
 */
CreateCachediSCSIVolumeOutput.prototype['TargetARN'] = undefined;
...
export default CreateCachediSCSIVolumeOutput;
