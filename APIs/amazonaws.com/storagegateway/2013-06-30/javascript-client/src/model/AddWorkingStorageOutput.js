...
/**
 * The AddWorkingStorageOutput model module.
 * @module model/AddWorkingStorageOutput
 * @version 2013-06-30
 */
class AddWorkingStorageOutput {
    /**
     * Constructs a new <code>AddWorkingStorageOutput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway for which working storage was configured.
     * @alias module:model/AddWorkingStorageOutput
     */
    constructor() { 
        
        AddWorkingStorageOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddWorkingStorageOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddWorkingStorageOutput} obj Optional instance to populate.
     * @return {module:model/AddWorkingStorageOutput} The populated <code>AddWorkingStorageOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddWorkingStorageOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>AddWorkingStorageOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddWorkingStorageOutput</code>.
     */
 ...
 */
AddWorkingStorageOutput.prototype['GatewayARN'] = undefined;
...
export default AddWorkingStorageOutput;
