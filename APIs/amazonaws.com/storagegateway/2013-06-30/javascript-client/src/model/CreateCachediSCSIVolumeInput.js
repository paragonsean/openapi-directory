...
/**
 * The CreateCachediSCSIVolumeInput model module.
 * @module model/CreateCachediSCSIVolumeInput
 * @version 2013-06-30
 */
class CreateCachediSCSIVolumeInput {
    /**
     * Constructs a new <code>CreateCachediSCSIVolumeInput</code>.
     * @alias module:model/CreateCachediSCSIVolumeInput
     ...
     * @param volumeSizeInBytes {Number} 
     * @param targetName {String} 
     * @param networkInterfaceId {String} 
     * @param clientToken {String} 
     */
    constructor(gatewayARN, volumeSizeInBytes, targetName, networkInterfaceId, clientToken) { 
        
        CreateCachediSCSIVolumeInput.initialize(this, gatewayARN, volumeSizeInBytes, targetName, networkInterfaceId, clientToken);
    }
     ...
     */
    static initialize(obj, gatewayARN, volumeSizeInBytes, targetName, networkInterfaceId, clientToken) { 
        obj['GatewayARN'] = gatewayARN;
        obj['VolumeSizeInBytes'] = volumeSizeInBytes;
    ...
    /**
     * Constructs a <code>CreateCachediSCSIVolumeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCachediSCSIVolumeInput} obj Optional instance to populate.
     * @return {module:model/CreateCachediSCSIVolumeInput} The populated <code>CreateCachediSCSIVolumeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCachediSCSIVolumeInput();
            ...
            if (data.hasOwnProperty('SourceVolumeARN')) {
                obj['SourceVolumeARN'] = ApiClient.convertToType(data['SourceVolumeARN'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCachediSCSIVolumeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCachediSCSIVolumeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCachediSCSIVolumeInput.RequiredProperties) {
        ...
        if (data['SourceVolumeARN']) { // data not null
          String.validateJSON(data['SourceVolumeARN']);
        }
...
CreateCachediSCSIVolumeInput.RequiredProperties = ["GatewayARN", "VolumeSizeInBytes", "TargetName", "NetworkInterfaceId", "ClientToken"];
 ...
 */
CreateCachediSCSIVolumeInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Number} VolumeSizeInBytes
 */
CreateCachediSCSIVolumeInput.prototype['VolumeSizeInBytes'] = undefined;

/**
 * @member {String} SnapshotId
 */
CreateCachediSCSIVolumeInput.prototype['SnapshotId'] = undefined;

/**
 * @member {String} TargetName
 */
CreateCachediSCSIVolumeInput.prototype['TargetName'] = undefined;

/**
 * @member {String} SourceVolumeARN
 */
CreateCachediSCSIVolumeInput.prototype['SourceVolumeARN'] = undefined;

/**
 * @member {String} NetworkInterfaceId
 */
CreateCachediSCSIVolumeInput.prototype['NetworkInterfaceId'] = undefined;

/**
 * @member {String} ClientToken
 */
CreateCachediSCSIVolumeInput.prototype['ClientToken'] = undefined;

/**
 * @member {Boolean} KMSEncrypted
 */
CreateCachediSCSIVolumeInput.prototype['KMSEncrypted'] = undefined;

/**
 * @member {String} KMSKey
 */
CreateCachediSCSIVolumeInput.prototype['KMSKey'] = undefined;

/**
 * @member {Array} Tags
 */
CreateCachediSCSIVolumeInput.prototype['Tags'] = undefined;
...
export default CreateCachediSCSIVolumeInput;
