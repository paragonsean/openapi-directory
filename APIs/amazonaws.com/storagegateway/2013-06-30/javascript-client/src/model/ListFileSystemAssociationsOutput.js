...
/**
 * The ListFileSystemAssociationsOutput model module.
 * @module model/ListFileSystemAssociationsOutput
 * @version 2013-06-30
 */
class ListFileSystemAssociationsOutput {
    /**
     * Constructs a new <code>ListFileSystemAssociationsOutput</code>.
     * @alias module:model/ListFileSystemAssociationsOutput
     */
    constructor() { 
        
        ListFileSystemAssociationsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFileSystemAssociationsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFileSystemAssociationsOutput} obj Optional instance to populate.
     * @return {module:model/ListFileSystemAssociationsOutput} The populated <code>ListFileSystemAssociationsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFileSystemAssociationsOutput();
            ...
            if (data.hasOwnProperty('FileSystemAssociationSummaryList')) {
                obj['FileSystemAssociationSummaryList'] = ApiClient.convertToType(data['FileSystemAssociationSummaryList'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListFileSystemAssociationsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFileSystemAssociationsOutput</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `FileSystemAssociationSummaryList`
        if (data['FileSystemAssociationSummaryList']) { // data not null
          Array.validateJSON(data['FileSystemAssociationSummaryList']);
        }
 ...
 */
ListFileSystemAssociationsOutput.prototype['Marker'] = undefined;

/**
 * @member {String} NextMarker
 */
ListFileSystemAssociationsOutput.prototype['NextMarker'] = undefined;

/**
 * @member {Array} FileSystemAssociationSummaryList
 */
ListFileSystemAssociationsOutput.prototype['FileSystemAssociationSummaryList'] = undefined;
...
export default ListFileSystemAssociationsOutput;
