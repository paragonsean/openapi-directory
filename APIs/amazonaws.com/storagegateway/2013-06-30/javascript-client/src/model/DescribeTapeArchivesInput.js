...
/**
 * The DescribeTapeArchivesInput model module.
 * @module model/DescribeTapeArchivesInput
 * @version 2013-06-30
 */
class DescribeTapeArchivesInput {
    /**
     * Constructs a new <code>DescribeTapeArchivesInput</code>.
     * DescribeTapeArchivesInput
     * @alias module:model/DescribeTapeArchivesInput
     */
    constructor() { 
        
        DescribeTapeArchivesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeTapeArchivesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTapeArchivesInput} obj Optional instance to populate.
     * @return {module:model/DescribeTapeArchivesInput} The populated <code>DescribeTapeArchivesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTapeArchivesInput();

            if (data.hasOwnProperty('TapeARNs')) {
                obj['TapeARNs'] = ApiClient.convertToType(data['TapeARNs'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTapeArchivesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTapeArchivesInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `TapeARNs`
        if (data['TapeARNs']) { // data not null
          Array.validateJSON(data['TapeARNs']);
        }
...
/**
 * @member {Array} TapeARNs
 */
DescribeTapeArchivesInput.prototype['TapeARNs'] = undefined;

/**
 * @member {String} Marker
 */
DescribeTapeArchivesInput.prototype['Marker'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeTapeArchivesInput.prototype['Limit'] = undefined;
...
export default DescribeTapeArchivesInput;
