...
/**
 * The DescribeUploadBufferOutput model module.
 * @module model/DescribeUploadBufferOutput
 * @version 2013-06-30
 */
class DescribeUploadBufferOutput {
    /**
     * Constructs a new <code>DescribeUploadBufferOutput</code>.
     * @alias module:model/DescribeUploadBufferOutput
     */
    constructor() { 
        
        DescribeUploadBufferOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeUploadBufferOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeUploadBufferOutput} obj Optional instance to populate.
     * @return {module:model/DescribeUploadBufferOutput} The populated <code>DescribeUploadBufferOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeUploadBufferOutput();
            ...
            if (data.hasOwnProperty('UploadBufferUsedInBytes')) {
                obj['UploadBufferUsedInBytes'] = ApiClient.convertToType(data['UploadBufferUsedInBytes'], 'Number');
            }
            if (data.hasOwnProperty('UploadBufferAllocatedInBytes')) {
                obj['UploadBufferAllocatedInBytes'] = ApiClient.convertToType(data['UploadBufferAllocatedInBytes'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeUploadBufferOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeUploadBufferOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['UploadBufferUsedInBytes']) { // data not null
          Number.validateJSON(data['UploadBufferUsedInBytes']);
        }
        // validate the optional field `UploadBufferAllocatedInBytes`
        if (data['UploadBufferAllocatedInBytes']) { // data not null
          Number.validateJSON(data['UploadBufferAllocatedInBytes']);
        }
 ...
 */
DescribeUploadBufferOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {Array} DiskIds
 */
DescribeUploadBufferOutput.prototype['DiskIds'] = undefined;

/**
 * @member {Number} UploadBufferUsedInBytes
 */
DescribeUploadBufferOutput.prototype['UploadBufferUsedInBytes'] = undefined;

/**
 * @member {Number} UploadBufferAllocatedInBytes
 */
DescribeUploadBufferOutput.prototype['UploadBufferAllocatedInBytes'] = undefined;
...
export default DescribeUploadBufferOutput;
