...
/**
 * The UpdateNFSFileShareOutput model module.
 * @module model/UpdateNFSFileShareOutput
 * @version 2013-06-30
 */
class UpdateNFSFileShareOutput {
    /**
     * Constructs a new <code>UpdateNFSFileShareOutput</code>.
     * UpdateNFSFileShareOutput
     * @alias module:model/UpdateNFSFileShareOutput
     */
    constructor() { 
        
        UpdateNFSFileShareOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateNFSFileShareOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateNFSFileShareOutput} obj Optional instance to populate.
     * @return {module:model/UpdateNFSFileShareOutput} The populated <code>UpdateNFSFileShareOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateNFSFileShareOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateNFSFileShareOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateNFSFileShareOutput</code>.
     */
 ...
 */
UpdateNFSFileShareOutput.prototype['FileShareARN'] = undefined;
...
export default UpdateNFSFileShareOutput;
