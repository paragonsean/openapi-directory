...
/**
 * The DisassociateFileSystemInput model module.
 * @module model/DisassociateFileSystemInput
 * @version 2013-06-30
 */
class DisassociateFileSystemInput {
    /**
     * Constructs a new <code>DisassociateFileSystemInput</code>.
     * @alias module:model/DisassociateFileSystemInput
     * @param fileSystemAssociationARN {String} 
     */
    constructor(fileSystemAssociationARN) { 
        
        DisassociateFileSystemInput.initialize(this, fileSystemAssociationARN);
    }
    ...
    /**
     * Constructs a <code>DisassociateFileSystemInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateFileSystemInput} obj Optional instance to populate.
     * @return {module:model/DisassociateFileSystemInput} The populated <code>DisassociateFileSystemInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateFileSystemInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateFileSystemInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateFileSystemInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisassociateFileSystemInput.RequiredProperties) {
...
DisassociateFileSystemInput.RequiredProperties = ["FileSystemAssociationARN"];

/**
 * @member {String} FileSystemAssociationARN
 */
DisassociateFileSystemInput.prototype['FileSystemAssociationARN'] = undefined;

/**
 * @member {Boolean} ForceDelete
 */
DisassociateFileSystemInput.prototype['ForceDelete'] = undefined;
...
export default DisassociateFileSystemInput;
