...
/**
 * The DescribeVTLDevicesOutput model module.
 * @module model/DescribeVTLDevicesOutput
 * @version 2013-06-30
 */
class DescribeVTLDevicesOutput {
    /**
     * Constructs a new <code>DescribeVTLDevicesOutput</code>.
     * DescribeVTLDevicesOutput
     * @alias module:model/DescribeVTLDevicesOutput
     */
    constructor() { 
        
        DescribeVTLDevicesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeVTLDevicesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeVTLDevicesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeVTLDevicesOutput} The populated <code>DescribeVTLDevicesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeVTLDevicesOutput();

            if (data.hasOwnProperty('GatewayARN')) {
                obj['GatewayARN'] = ApiClient.convertToType(data['GatewayARN'], 'String');
            }
            if (data.hasOwnProperty('VTLDevices')) {
                obj['VTLDevices'] = ApiClient.convertToType(data['VTLDevices'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeVTLDevicesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeVTLDevicesOutput</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `VTLDevices`
        if (data['VTLDevices']) { // data not null
          Array.validateJSON(data['VTLDevices']);
        }
 ...
 */
DescribeVTLDevicesOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {Array} VTLDevices
 */
DescribeVTLDevicesOutput.prototype['VTLDevices'] = undefined;

/**
 * @member {String} Marker
 */
DescribeVTLDevicesOutput.prototype['Marker'] = undefined;
...
export default DescribeVTLDevicesOutput;
