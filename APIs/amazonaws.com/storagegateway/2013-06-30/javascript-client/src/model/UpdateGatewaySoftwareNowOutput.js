...
/**
 * The UpdateGatewaySoftwareNowOutput model module.
 * @module model/UpdateGatewaySoftwareNowOutput
 * @version 2013-06-30
 */
class UpdateGatewaySoftwareNowOutput {
    /**
     * Constructs a new <code>UpdateGatewaySoftwareNowOutput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway that was updated.
     * @alias module:model/UpdateGatewaySoftwareNowOutput
     */
    constructor() { 
        
        UpdateGatewaySoftwareNowOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateGatewaySoftwareNowOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGatewaySoftwareNowOutput} obj Optional instance to populate.
     * @return {module:model/UpdateGatewaySoftwareNowOutput} The populated <code>UpdateGatewaySoftwareNowOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGatewaySoftwareNowOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGatewaySoftwareNowOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGatewaySoftwareNowOutput</code>.
     */
 ...
 */
UpdateGatewaySoftwareNowOutput.prototype['GatewayARN'] = undefined;
...
export default UpdateGatewaySoftwareNowOutput;
