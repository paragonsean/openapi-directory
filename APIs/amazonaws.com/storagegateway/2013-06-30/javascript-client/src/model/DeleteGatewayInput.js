...
/**
 * The DeleteGatewayInput model module.
 * @module model/DeleteGatewayInput
 * @version 2013-06-30
 */
class DeleteGatewayInput {
    /**
     * Constructs a new <code>DeleteGatewayInput</code>.
     * A JSON object containing the ID of the gateway to delete.
     * @alias module:model/DeleteGatewayInput
    ...
    constructor(gatewayARN) { 
        ...
        DeleteGatewayInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DeleteGatewayInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteGatewayInput} obj Optional instance to populate.
     * @return {module:model/DeleteGatewayInput} The populated <code>DeleteGatewayInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteGatewayInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteGatewayInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteGatewayInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteGatewayInput.RequiredProperties) {
...
DeleteGatewayInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DeleteGatewayInput.prototype['GatewayARN'] = undefined;
...
export default DeleteGatewayInput;
