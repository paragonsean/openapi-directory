...
/**
 * The DisableGatewayInput model module.
 * @module model/DisableGatewayInput
 * @version 2013-06-30
 */
class DisableGatewayInput {
    /**
     * Constructs a new <code>DisableGatewayInput</code>.
     * DisableGatewayInput
     * @alias module:model/DisableGatewayInput
    ...
    constructor(gatewayARN) { 
        ...
        DisableGatewayInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DisableGatewayInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisableGatewayInput} obj Optional instance to populate.
     * @return {module:model/DisableGatewayInput} The populated <code>DisableGatewayInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisableGatewayInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DisableGatewayInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisableGatewayInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisableGatewayInput.RequiredProperties) {
...
DisableGatewayInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DisableGatewayInput.prototype['GatewayARN'] = undefined;
...
export default DisableGatewayInput;
