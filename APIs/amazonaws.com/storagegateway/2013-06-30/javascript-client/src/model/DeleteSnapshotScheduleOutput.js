...
/**
 * The DeleteSnapshotScheduleOutput model module.
 * @module model/DeleteSnapshotScheduleOutput
 * @version 2013-06-30
 */
class DeleteSnapshotScheduleOutput {
    /**
     * Constructs a new <code>DeleteSnapshotScheduleOutput</code>.
     * @alias module:model/DeleteSnapshotScheduleOutput
     */
    constructor() { 
        
        DeleteSnapshotScheduleOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteSnapshotScheduleOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteSnapshotScheduleOutput} obj Optional instance to populate.
     * @return {module:model/DeleteSnapshotScheduleOutput} The populated <code>DeleteSnapshotScheduleOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteSnapshotScheduleOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteSnapshotScheduleOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteSnapshotScheduleOutput</code>.
     */
 ...
 */
DeleteSnapshotScheduleOutput.prototype['VolumeARN'] = undefined;
...
export default DeleteSnapshotScheduleOutput;
