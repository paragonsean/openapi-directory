...
* @readonly
*/
export default class ActiveDirectoryStatus {
    ...
    /**
    * Returns a <code>ActiveDirectoryStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ActiveDirectoryStatus} The enum <code>ActiveDirectoryStatus</code> value.
    */
