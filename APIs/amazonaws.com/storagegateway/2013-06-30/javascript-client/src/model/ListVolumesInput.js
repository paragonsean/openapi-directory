...
/**
 * The ListVolumesInput model module.
 * @module model/ListVolumesInput
 * @version 2013-06-30
 */
class ListVolumesInput {
    /**
     * Constructs a new <code>ListVolumesInput</code>.
     ...
     * @alias module:model/ListVolumesInput
     */
    constructor() { 
        
        ListVolumesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListVolumesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListVolumesInput} obj Optional instance to populate.
     * @return {module:model/ListVolumesInput} The populated <code>ListVolumesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListVolumesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListVolumesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListVolumesInput</code>.
     */
 ...
 */
ListVolumesInput.prototype['GatewayARN'] = undefined;

/**
 * @member {String} Marker
 */
ListVolumesInput.prototype['Marker'] = undefined;

/**
 * @member {Number} Limit
 */
ListVolumesInput.prototype['Limit'] = undefined;
...
export default ListVolumesInput;
