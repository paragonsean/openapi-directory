...
/**
 * The CreateStorediSCSIVolumeOutput model module.
 * @module model/CreateStorediSCSIVolumeOutput
 * @version 2013-06-30
 */
class CreateStorediSCSIVolumeOutput {
    /**
     * Constructs a new <code>CreateStorediSCSIVolumeOutput</code>.
     * A JSON object containing the following fields:
     * @alias module:model/CreateStorediSCSIVolumeOutput
     */
    constructor() { 
        
        CreateStorediSCSIVolumeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateStorediSCSIVolumeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStorediSCSIVolumeOutput} obj Optional instance to populate.
     * @return {module:model/CreateStorediSCSIVolumeOutput} The populated <code>CreateStorediSCSIVolumeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStorediSCSIVolumeOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStorediSCSIVolumeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStorediSCSIVolumeOutput</code>.
     */
 ...
 */
CreateStorediSCSIVolumeOutput.prototype['VolumeARN'] = undefined;

/**
 * @member {Number} VolumeSizeInBytes
 */
CreateStorediSCSIVolumeOutput.prototype['VolumeSizeInBytes'] = undefined;

/**
 * @member {String} TargetARN
 */
CreateStorediSCSIVolumeOutput.prototype['TargetARN'] = undefined;
...
export default CreateStorediSCSIVolumeOutput;
