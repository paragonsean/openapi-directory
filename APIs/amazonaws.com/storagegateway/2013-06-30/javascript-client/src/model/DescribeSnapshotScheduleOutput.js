...
/**
 * The DescribeSnapshotScheduleOutput model module.
 * @module model/DescribeSnapshotScheduleOutput
 * @version 2013-06-30
 */
class DescribeSnapshotScheduleOutput {
    /**
     * Constructs a new <code>DescribeSnapshotScheduleOutput</code>.
     * @alias module:model/DescribeSnapshotScheduleOutput
     */
    constructor() { 
        
        DescribeSnapshotScheduleOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeSnapshotScheduleOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeSnapshotScheduleOutput} obj Optional instance to populate.
     * @return {module:model/DescribeSnapshotScheduleOutput} The populated <code>DescribeSnapshotScheduleOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeSnapshotScheduleOutput();
            ...
            if (data.hasOwnProperty('RecurrenceInHours')) {
                obj['RecurrenceInHours'] = ApiClient.convertToType(data['RecurrenceInHours'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeSnapshotScheduleOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeSnapshotScheduleOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['StartAt']) { // data not null
          Number.validateJSON(data['StartAt']);
        }
        // validate the optional field `RecurrenceInHours`
        if (data['RecurrenceInHours']) { // data not null
          Number.validateJSON(data['RecurrenceInHours']);
        }
 ...
 */
DescribeSnapshotScheduleOutput.prototype['VolumeARN'] = undefined;

/**
 * @member {Number} StartAt
 */
DescribeSnapshotScheduleOutput.prototype['StartAt'] = undefined;

/**
 * @member {Number} RecurrenceInHours
 */
DescribeSnapshotScheduleOutput.prototype['RecurrenceInHours'] = undefined;

/**
 * @member {String} Description
 */
DescribeSnapshotScheduleOutput.prototype['Description'] = undefined;

/**
 * @member {String} Timezone
 */
DescribeSnapshotScheduleOutput.prototype['Timezone'] = undefined;

/**
 * @member {Array} Tags
 */
DescribeSnapshotScheduleOutput.prototype['Tags'] = undefined;
...
export default DescribeSnapshotScheduleOutput;
