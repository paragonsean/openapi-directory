...
/**
 * The UpdateGatewayInformationOutput model module.
 * @module model/UpdateGatewayInformationOutput
 * @version 2013-06-30
 */
class UpdateGatewayInformationOutput {
    /**
     * Constructs a new <code>UpdateGatewayInformationOutput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway that was updated.
     * @alias module:model/UpdateGatewayInformationOutput
     */
    constructor() { 
        
        UpdateGatewayInformationOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateGatewayInformationOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGatewayInformationOutput} obj Optional instance to populate.
     * @return {module:model/UpdateGatewayInformationOutput} The populated <code>UpdateGatewayInformationOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGatewayInformationOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGatewayInformationOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGatewayInformationOutput</code>.
     */
 ...
 */
UpdateGatewayInformationOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {String} GatewayName
 */
UpdateGatewayInformationOutput.prototype['GatewayName'] = undefined;
...
export default UpdateGatewayInformationOutput;
