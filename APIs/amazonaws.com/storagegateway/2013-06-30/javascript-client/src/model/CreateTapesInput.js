...
/**
 * The CreateTapesInput model module.
 * @module model/CreateTapesInput
 * @version 2013-06-30
 */
class CreateTapesInput {
    /**
     * Constructs a new <code>CreateTapesInput</code>.
     * CreateTapesInput
     * @alias module:model/CreateTapesInput
     * @param gatewayARN {String} 
     * @param tapeSizeInBytes {Number} 
     * @param clientToken {String} 
     * @param numTapesToCreate {Number} 
     * @param tapeBarcodePrefix {String} 
     */
    constructor(gatewayARN, tapeSizeInBytes, clientToken, numTapesToCreate, tapeBarcodePrefix) { 
        
        CreateTapesInput.initialize(this, gatewayARN, tapeSizeInBytes, clientToken, numTapesToCreate, tapeBarcodePrefix);
    }
     ...
     */
    static initialize(obj, gatewayARN, tapeSizeInBytes, clientToken, numTapesToCreate, tapeBarcodePrefix) { 
        obj['GatewayARN'] = gatewayARN;
        obj['TapeSizeInBytes'] = tapeSizeInBytes;
        obj['ClientToken'] = clientToken;
        obj['NumTapesToCreate'] = numTapesToCreate;
        obj['TapeBarcodePrefix'] = tapeBarcodePrefix;
    }

    /**
     * Constructs a <code>CreateTapesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTapesInput} obj Optional instance to populate.
     * @return {module:model/CreateTapesInput} The populated <code>CreateTapesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTapesInput();
            ...
            if (data.hasOwnProperty('NumTapesToCreate')) {
                obj['NumTapesToCreate'] = ApiClient.convertToType(data['NumTapesToCreate'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTapesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTapesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateTapesInput.RequiredProperties) {
        ...
        // validate the optional field `NumTapesToCreate`
        if (data['NumTapesToCreate']) { // data not null
          Number.validateJSON(data['NumTapesToCreate']);
        }
...
CreateTapesInput.RequiredProperties = ["GatewayARN", "TapeSizeInBytes", "ClientToken", "NumTapesToCreate", "TapeBarcodePrefix"];

/**
 * @member {String} GatewayARN
 */
CreateTapesInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Number} TapeSizeInBytes
 */
CreateTapesInput.prototype['TapeSizeInBytes'] = undefined;

/**
 * @member {String} ClientToken
 */
CreateTapesInput.prototype['ClientToken'] = undefined;

/**
 * @member {Number} NumTapesToCreate
 */
CreateTapesInput.prototype['NumTapesToCreate'] = undefined;

/**
 * @member {String} TapeBarcodePrefix
 */
CreateTapesInput.prototype['TapeBarcodePrefix'] = undefined;

/**
 * @member {Boolean} KMSEncrypted
 */
CreateTapesInput.prototype['KMSEncrypted'] = undefined;

/**
 * @member {String} KMSKey
 */
CreateTapesInput.prototype['KMSKey'] = undefined;

/**
 * @member {String} PoolId
 */
CreateTapesInput.prototype['PoolId'] = undefined;

/**
 * @member {Boolean} Worm
 */
CreateTapesInput.prototype['Worm'] = undefined;

/**
 * @member {Array} Tags
 */
CreateTapesInput.prototype['Tags'] = undefined;
...
export default CreateTapesInput;
