...
/**
 * The DescribeGatewayInformationInput model module.
 * @module model/DescribeGatewayInformationInput
 * @version 2013-06-30
 */
class DescribeGatewayInformationInput {
    /**
     * Constructs a new <code>DescribeGatewayInformationInput</code>.
     * A JSON object containing the ID of the gateway.
     * @alias module:model/DescribeGatewayInformationInput
    ...
    constructor(gatewayARN) { 
        ...
        DescribeGatewayInformationInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DescribeGatewayInformationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGatewayInformationInput} obj Optional instance to populate.
     * @return {module:model/DescribeGatewayInformationInput} The populated <code>DescribeGatewayInformationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGatewayInformationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGatewayInformationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGatewayInformationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeGatewayInformationInput.RequiredProperties) {
...
DescribeGatewayInformationInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DescribeGatewayInformationInput.prototype['GatewayARN'] = undefined;
...
export default DescribeGatewayInformationInput;
