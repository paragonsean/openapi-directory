...
/**
 * The DescribeSnapshotScheduleInput model module.
 * @module model/DescribeSnapshotScheduleInput
 * @version 2013-06-30
 */
class DescribeSnapshotScheduleInput {
    /**
     * Constructs a new <code>DescribeSnapshotScheduleInput</code>.
     * A JSON object containing the &lt;a&gt;DescribeSnapshotScheduleInput$VolumeARN&lt;/a&gt; of the volume.
     * @alias module:model/DescribeSnapshotScheduleInput
     * @param volumeARN {String} 
     */
    constructor(volumeARN) { 
        
        DescribeSnapshotScheduleInput.initialize(this, volumeARN);
    }
    ...
    /**
     * Constructs a <code>DescribeSnapshotScheduleInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeSnapshotScheduleInput} obj Optional instance to populate.
     * @return {module:model/DescribeSnapshotScheduleInput} The populated <code>DescribeSnapshotScheduleInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeSnapshotScheduleInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeSnapshotScheduleInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeSnapshotScheduleInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeSnapshotScheduleInput.RequiredProperties) {
...
DescribeSnapshotScheduleInput.RequiredProperties = ["VolumeARN"];

/**
 * @member {String} VolumeARN
 */
DescribeSnapshotScheduleInput.prototype['VolumeARN'] = undefined;
...
export default DescribeSnapshotScheduleInput;
