...
/**
 * The UpdateVTLDeviceTypeInput model module.
 * @module model/UpdateVTLDeviceTypeInput
 * @version 2013-06-30
 */
class UpdateVTLDeviceTypeInput {
    /**
     * Constructs a new <code>UpdateVTLDeviceTypeInput</code>.
     * @alias module:model/UpdateVTLDeviceTypeInput
     * @param vTLDeviceARN {String} 
     * @param deviceType {String} 
     */
    constructor(vTLDeviceARN, deviceType) { 
        
        UpdateVTLDeviceTypeInput.initialize(this, vTLDeviceARN, deviceType);
    }
     ...
     */
    static initialize(obj, vTLDeviceARN, deviceType) { 
        obj['VTLDeviceARN'] = vTLDeviceARN;
        obj['DeviceType'] = deviceType;
    }

    /**
     * Constructs a <code>UpdateVTLDeviceTypeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateVTLDeviceTypeInput} obj Optional instance to populate.
     * @return {module:model/UpdateVTLDeviceTypeInput} The populated <code>UpdateVTLDeviceTypeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateVTLDeviceTypeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateVTLDeviceTypeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateVTLDeviceTypeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateVTLDeviceTypeInput.RequiredProperties) {
...
UpdateVTLDeviceTypeInput.RequiredProperties = ["VTLDeviceARN", "DeviceType"];

/**
 * @member {String} VTLDeviceARN
 */
UpdateVTLDeviceTypeInput.prototype['VTLDeviceARN'] = undefined;

/**
 * @member {String} DeviceType
 */
UpdateVTLDeviceTypeInput.prototype['DeviceType'] = undefined;
...
export default UpdateVTLDeviceTypeInput;
