...
/**
 * The ListVolumeInitiatorsOutput model module.
 * @module model/ListVolumeInitiatorsOutput
 * @version 2013-06-30
 */
class ListVolumeInitiatorsOutput {
    /**
     * Constructs a new <code>ListVolumeInitiatorsOutput</code>.
     * ListVolumeInitiatorsOutput
     * @alias module:model/ListVolumeInitiatorsOutput
     */
    constructor() { 
        
        ListVolumeInitiatorsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListVolumeInitiatorsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListVolumeInitiatorsOutput} obj Optional instance to populate.
     * @return {module:model/ListVolumeInitiatorsOutput} The populated <code>ListVolumeInitiatorsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListVolumeInitiatorsOutput();

            if (data.hasOwnProperty('Initiators')) {
                obj['Initiators'] = ApiClient.convertToType(data['Initiators'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListVolumeInitiatorsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListVolumeInitiatorsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Initiators`
        if (data['Initiators']) { // data not null
          Array.validateJSON(data['Initiators']);
        }
...
/**
 * @member {Array} Initiators
 */
ListVolumeInitiatorsOutput.prototype['Initiators'] = undefined;
...
export default ListVolumeInitiatorsOutput;
