...
/**
 * The DescribeCachediSCSIVolumesInput model module.
 * @module model/DescribeCachediSCSIVolumesInput
 * @version 2013-06-30
 */
class DescribeCachediSCSIVolumesInput {
    /**
     * Constructs a new <code>DescribeCachediSCSIVolumesInput</code>.
     * @alias module:model/DescribeCachediSCSIVolumesInput
     * @param volumeARNs {Array} 
     */
    constructor(volumeARNs) { 
        
        DescribeCachediSCSIVolumesInput.initialize(this, volumeARNs);
    }
    ...
    /**
     * Constructs a <code>DescribeCachediSCSIVolumesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCachediSCSIVolumesInput} obj Optional instance to populate.
     * @return {module:model/DescribeCachediSCSIVolumesInput} The populated <code>DescribeCachediSCSIVolumesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCachediSCSIVolumesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCachediSCSIVolumesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCachediSCSIVolumesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeCachediSCSIVolumesInput.RequiredProperties) {
...
DescribeCachediSCSIVolumesInput.RequiredProperties = ["VolumeARNs"];

/**
 * @member {Array} VolumeARNs
 */
DescribeCachediSCSIVolumesInput.prototype['VolumeARNs'] = undefined;
...
export default DescribeCachediSCSIVolumesInput;
