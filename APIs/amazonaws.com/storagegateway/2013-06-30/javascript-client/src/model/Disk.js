...
class Disk {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('DiskNode')) {
                obj['DiskNode'] = ApiClient.convertToType(data['DiskNode'], 'String');
            }
            if (data.hasOwnProperty('DiskStatus')) {
                obj['DiskStatus'] = ApiClient.convertToType(data['DiskStatus'], 'String');
            }
            if (data.hasOwnProperty('DiskSizeInBytes')) {
                obj['DiskSizeInBytes'] = ApiClient.convertToType(data['DiskSizeInBytes'], 'Number');
            }
            if (data.hasOwnProperty('DiskAllocationType')) {
                obj['DiskAllocationType'] = ApiClient.convertToType(data['DiskAllocationType'], 'String');
            }
            if (data.hasOwnProperty('DiskAllocationResource')) {
                obj['DiskAllocationResource'] = ApiClient.convertToType(data['DiskAllocationResource'], 'String');
            }
            if (data.hasOwnProperty('DiskAttributeList')) {
                obj['DiskAttributeList'] = ApiClient.convertToType(data['DiskAttributeList'], ['String']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['DiskPath']) { // data not null
          String.validateJSON(data['DiskPath']);
        }
        // validate the optional field `DiskNode`
        if (data['DiskNode']) { // data not null
          String.validateJSON(data['DiskNode']);
        }
        // validate the optional field `DiskStatus`
        if (data['DiskStatus']) { // data not null
          String.validateJSON(data['DiskStatus']);
        }
        // validate the optional field `DiskSizeInBytes`
        if (data['DiskSizeInBytes']) { // data not null
          Number.validateJSON(data['DiskSizeInBytes']);
        }
        // ensure the json data is a string
        if (data['DiskAllocationType'] && !(typeof data['DiskAllocationType'] === 'string' || data['DiskAllocationType'] instanceof String)) {
            throw new Error("Expected the field `DiskAllocationType` to be a primitive type in the JSON string but got " + data['DiskAllocationType']);
        }
        // validate the optional field `DiskAllocationResource`
        if (data['DiskAllocationResource']) { // data not null
          String.validateJSON(data['DiskAllocationResource']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['DiskAttributeList'])) {
            throw new Error("Expected the field `DiskAttributeList` to be an array in the JSON data but got " + data['DiskAttributeList']);
        }
 ...
 */
Disk.prototype['DiskId'] = undefined;

/**
 * @member {String} DiskPath
 */
Disk.prototype['DiskPath'] = undefined;

/**
 * @member {String} DiskNode
 */
Disk.prototype['DiskNode'] = undefined;

/**
 * @member {String} DiskStatus
 */
Disk.prototype['DiskStatus'] = undefined;

/**
 * @member {Number} DiskSizeInBytes
 */
Disk.prototype['DiskSizeInBytes'] = undefined;
 ...
 * @member {String} DiskAllocationType
 */
Disk.prototype['DiskAllocationType'] = undefined;

/**
 * @member {String} DiskAllocationResource
 */
Disk.prototype['DiskAllocationResource'] = undefined;

/**
 * A list of values that represents attributes of a local disk.
 * @member {Array.<String>} DiskAttributeList
 */
Disk.prototype['DiskAttributeList'] = undefined;
