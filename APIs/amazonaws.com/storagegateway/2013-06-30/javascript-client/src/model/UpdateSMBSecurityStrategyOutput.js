...
/**
 * The UpdateSMBSecurityStrategyOutput model module.
 * @module model/UpdateSMBSecurityStrategyOutput
 * @version 2013-06-30
 */
class UpdateSMBSecurityStrategyOutput {
    /**
     * Constructs a new <code>UpdateSMBSecurityStrategyOutput</code>.
     * @alias module:model/UpdateSMBSecurityStrategyOutput
     */
    constructor() { 
        
        UpdateSMBSecurityStrategyOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSMBSecurityStrategyOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSMBSecurityStrategyOutput} obj Optional instance to populate.
     * @return {module:model/UpdateSMBSecurityStrategyOutput} The populated <code>UpdateSMBSecurityStrategyOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSMBSecurityStrategyOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSMBSecurityStrategyOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSMBSecurityStrategyOutput</code>.
     */
 ...
 */
UpdateSMBSecurityStrategyOutput.prototype['GatewayARN'] = undefined;
...
export default UpdateSMBSecurityStrategyOutput;
