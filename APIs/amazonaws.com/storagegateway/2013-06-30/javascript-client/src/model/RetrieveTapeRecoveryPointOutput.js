...
/**
 * The RetrieveTapeRecoveryPointOutput model module.
 * @module model/RetrieveTapeRecoveryPointOutput
 * @version 2013-06-30
 */
class RetrieveTapeRecoveryPointOutput {
    /**
     * Constructs a new <code>RetrieveTapeRecoveryPointOutput</code>.
     * RetrieveTapeRecoveryPointOutput
     * @alias module:model/RetrieveTapeRecoveryPointOutput
     */
    constructor() { 
        
        RetrieveTapeRecoveryPointOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RetrieveTapeRecoveryPointOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RetrieveTapeRecoveryPointOutput} obj Optional instance to populate.
     * @return {module:model/RetrieveTapeRecoveryPointOutput} The populated <code>RetrieveTapeRecoveryPointOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RetrieveTapeRecoveryPointOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>RetrieveTapeRecoveryPointOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RetrieveTapeRecoveryPointOutput</code>.
     */
 ...
 */
RetrieveTapeRecoveryPointOutput.prototype['TapeARN'] = undefined;
...
export default RetrieveTapeRecoveryPointOutput;
