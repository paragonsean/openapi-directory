...
/**
 * The DescribeAvailabilityMonitorTestInput model module.
 * @module model/DescribeAvailabilityMonitorTestInput
 * @version 2013-06-30
 */
class DescribeAvailabilityMonitorTestInput {
    /**
     * Constructs a new <code>DescribeAvailabilityMonitorTestInput</code>.
     * @alias module:model/DescribeAvailabilityMonitorTestInput
    ...
    constructor(gatewayARN) { 
        ...
        DescribeAvailabilityMonitorTestInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DescribeAvailabilityMonitorTestInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAvailabilityMonitorTestInput} obj Optional instance to populate.
     * @return {module:model/DescribeAvailabilityMonitorTestInput} The populated <code>DescribeAvailabilityMonitorTestInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAvailabilityMonitorTestInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAvailabilityMonitorTestInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAvailabilityMonitorTestInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeAvailabilityMonitorTestInput.RequiredProperties) {
...
DescribeAvailabilityMonitorTestInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DescribeAvailabilityMonitorTestInput.prototype['GatewayARN'] = undefined;
...
export default DescribeAvailabilityMonitorTestInput;
