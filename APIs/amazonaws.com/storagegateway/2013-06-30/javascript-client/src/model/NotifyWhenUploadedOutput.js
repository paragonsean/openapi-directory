...
/**
 * The NotifyWhenUploadedOutput model module.
 * @module model/NotifyWhenUploadedOutput
 * @version 2013-06-30
 */
class NotifyWhenUploadedOutput {
    /**
     * Constructs a new <code>NotifyWhenUploadedOutput</code>.
     * @alias module:model/NotifyWhenUploadedOutput
     */
    constructor() { 
        
        NotifyWhenUploadedOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NotifyWhenUploadedOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NotifyWhenUploadedOutput} obj Optional instance to populate.
     * @return {module:model/NotifyWhenUploadedOutput} The populated <code>NotifyWhenUploadedOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NotifyWhenUploadedOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>NotifyWhenUploadedOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotifyWhenUploadedOutput</code>.
     */
 ...
 */
NotifyWhenUploadedOutput.prototype['FileShareARN'] = undefined;

/**
 * The randomly generated ID of the notification that was sent. This ID is in UUID format.
 * @member {String} NotificationId
 */
NotifyWhenUploadedOutput.prototype['NotificationId'] = undefined;
...
export default NotifyWhenUploadedOutput;
