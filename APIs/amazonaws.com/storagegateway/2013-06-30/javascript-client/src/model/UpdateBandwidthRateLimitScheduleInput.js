...
/**
 * The UpdateBandwidthRateLimitScheduleInput model module.
 * @module model/UpdateBandwidthRateLimitScheduleInput
 * @version 2013-06-30
 */
class UpdateBandwidthRateLimitScheduleInput {
    /**
     * Constructs a new <code>UpdateBandwidthRateLimitScheduleInput</code>.
     * @alias module:model/UpdateBandwidthRateLimitScheduleInput
     ...
     * @param bandwidthRateLimitIntervals {Array} 
     */
    constructor(gatewayARN, bandwidthRateLimitIntervals) { 
        
        UpdateBandwidthRateLimitScheduleInput.initialize(this, gatewayARN, bandwidthRateLimitIntervals);
    }
     ...
     */
    static initialize(obj, gatewayARN, bandwidthRateLimitIntervals) { 
        obj['GatewayARN'] = gatewayARN;
        obj['BandwidthRateLimitIntervals'] = bandwidthRateLimitIntervals;
    }

    /**
     * Constructs a <code>UpdateBandwidthRateLimitScheduleInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateBandwidthRateLimitScheduleInput} obj Optional instance to populate.
     * @return {module:model/UpdateBandwidthRateLimitScheduleInput} The populated <code>UpdateBandwidthRateLimitScheduleInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateBandwidthRateLimitScheduleInput();

            if (data.hasOwnProperty('GatewayARN')) {
                obj['GatewayARN'] = ApiClient.convertToType(data['GatewayARN'], 'String');
            }
            if (data.hasOwnProperty('BandwidthRateLimitIntervals')) {
                obj['BandwidthRateLimitIntervals'] = ApiClient.convertToType(data['BandwidthRateLimitIntervals'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateBandwidthRateLimitScheduleInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateBandwidthRateLimitScheduleInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateBandwidthRateLimitScheduleInput.RequiredProperties) {
        ...
        if (data['BandwidthRateLimitIntervals']) { // data not null
          Array.validateJSON(data['BandwidthRateLimitIntervals']);
        }
...
UpdateBandwidthRateLimitScheduleInput.RequiredProperties = ["GatewayARN", "BandwidthRateLimitIntervals"];
 ...
 */
UpdateBandwidthRateLimitScheduleInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Array} BandwidthRateLimitIntervals
 */
UpdateBandwidthRateLimitScheduleInput.prototype['BandwidthRateLimitIntervals'] = undefined;
...
export default UpdateBandwidthRateLimitScheduleInput;
