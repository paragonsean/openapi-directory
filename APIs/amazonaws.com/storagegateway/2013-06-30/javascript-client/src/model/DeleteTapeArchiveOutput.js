...
/**
 * The DeleteTapeArchiveOutput model module.
 * @module model/DeleteTapeArchiveOutput
 * @version 2013-06-30
 */
class DeleteTapeArchiveOutput {
    /**
     * Constructs a new <code>DeleteTapeArchiveOutput</code>.
     * DeleteTapeArchiveOutput
     * @alias module:model/DeleteTapeArchiveOutput
     */
    constructor() { 
        
        DeleteTapeArchiveOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteTapeArchiveOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteTapeArchiveOutput} obj Optional instance to populate.
     * @return {module:model/DeleteTapeArchiveOutput} The populated <code>DeleteTapeArchiveOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteTapeArchiveOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteTapeArchiveOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteTapeArchiveOutput</code>.
     */
 ...
 */
DeleteTapeArchiveOutput.prototype['TapeARN'] = undefined;
...
export default DeleteTapeArchiveOutput;
