...
/**
 * The UpdateGatewayInformationInput model module.
 * @module model/UpdateGatewayInformationInput
 * @version 2013-06-30
 */
class UpdateGatewayInformationInput {
    /**
     * Constructs a new <code>UpdateGatewayInformationInput</code>.
     * @alias module:model/UpdateGatewayInformationInput
    ...
    constructor(gatewayARN) { 
        ...
        UpdateGatewayInformationInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>UpdateGatewayInformationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGatewayInformationInput} obj Optional instance to populate.
     * @return {module:model/UpdateGatewayInformationInput} The populated <code>UpdateGatewayInformationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGatewayInformationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGatewayInformationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGatewayInformationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateGatewayInformationInput.RequiredProperties) {
...
UpdateGatewayInformationInput.RequiredProperties = ["GatewayARN"];
 ...
 */
UpdateGatewayInformationInput.prototype['GatewayARN'] = undefined;

/**
 * The name you configured for your gateway.
 * @member {String} GatewayName
 */
UpdateGatewayInformationInput.prototype['GatewayName'] = undefined;

/**
 * @member {String} GatewayTimezone
 */
UpdateGatewayInformationInput.prototype['GatewayTimezone'] = undefined;

/**
 * @member {String} CloudWatchLogGroupARN
 */
UpdateGatewayInformationInput.prototype['CloudWatchLogGroupARN'] = undefined;

/**
 * @member {module:model/GatewayCapacity} GatewayCapacity
 */
UpdateGatewayInformationInput.prototype['GatewayCapacity'] = undefined;
...
export default UpdateGatewayInformationInput;
