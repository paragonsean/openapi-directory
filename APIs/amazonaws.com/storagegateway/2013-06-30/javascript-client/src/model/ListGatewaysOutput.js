...
/**
 * The ListGatewaysOutput model module.
 * @module model/ListGatewaysOutput
 * @version 2013-06-30
 */
class ListGatewaysOutput {
    /**
     * Constructs a new <code>ListGatewaysOutput</code>.
     * @alias module:model/ListGatewaysOutput
     */
    constructor() { 
        
        ListGatewaysOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListGatewaysOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGatewaysOutput} obj Optional instance to populate.
     * @return {module:model/ListGatewaysOutput} The populated <code>ListGatewaysOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGatewaysOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListGatewaysOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGatewaysOutput</code>.
     */
 ...
 */
ListGatewaysOutput.prototype['Gateways'] = undefined;

/**
 * @member {String} Marker
 */
ListGatewaysOutput.prototype['Marker'] = undefined;
...
export default ListGatewaysOutput;
