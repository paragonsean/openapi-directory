...
/**
 * The ListTapesOutput model module.
 * @module model/ListTapesOutput
 * @version 2013-06-30
 */
class ListTapesOutput {
    /**
     * Constructs a new <code>ListTapesOutput</code>.
     ...
     * @alias module:model/ListTapesOutput
     */
    constructor() { 
        
        ListTapesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListTapesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTapesOutput} obj Optional instance to populate.
     * @return {module:model/ListTapesOutput} The populated <code>ListTapesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTapesOutput();

            if (data.hasOwnProperty('TapeInfos')) {
                obj['TapeInfos'] = ApiClient.convertToType(data['TapeInfos'], [TapeInfo]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListTapesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTapesOutput</code>.
     */
    static validateJSON(data) {
        if (data['TapeInfos']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['TapeInfos'])) {
                throw new Error("Expected the field `TapeInfos` to be an array in the JSON data but got " + data['TapeInfos']);
            }
            // validate the optional field `TapeInfos` (array)
            for (const item of data['TapeInfos']) {
                TapeInfo.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/TapeInfo>} TapeInfos
 */
ListTapesOutput.prototype['TapeInfos'] = undefined;

/**
 * @member {String} Marker
 */
ListTapesOutput.prototype['Marker'] = undefined;
...
export default ListTapesOutput;
