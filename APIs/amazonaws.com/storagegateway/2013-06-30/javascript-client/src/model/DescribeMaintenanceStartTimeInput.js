...
/**
 * The DescribeMaintenanceStartTimeInput model module.
 * @module model/DescribeMaintenanceStartTimeInput
 * @version 2013-06-30
 */
class DescribeMaintenanceStartTimeInput {
    /**
     * Constructs a new <code>DescribeMaintenanceStartTimeInput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway.
     * @alias module:model/DescribeMaintenanceStartTimeInput
    ...
    constructor(gatewayARN) { 
        ...
        DescribeMaintenanceStartTimeInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DescribeMaintenanceStartTimeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMaintenanceStartTimeInput} obj Optional instance to populate.
     * @return {module:model/DescribeMaintenanceStartTimeInput} The populated <code>DescribeMaintenanceStartTimeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMaintenanceStartTimeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMaintenanceStartTimeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMaintenanceStartTimeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeMaintenanceStartTimeInput.RequiredProperties) {
...
DescribeMaintenanceStartTimeInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DescribeMaintenanceStartTimeInput.prototype['GatewayARN'] = undefined;
...
export default DescribeMaintenanceStartTimeInput;
