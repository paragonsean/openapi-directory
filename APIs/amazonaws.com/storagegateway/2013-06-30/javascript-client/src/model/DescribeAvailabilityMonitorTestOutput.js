...
import AvailabilityMonitorTestStatus from './AvailabilityMonitorTestStatus';

/**
 * The DescribeAvailabilityMonitorTestOutput model module.
 * @module model/DescribeAvailabilityMonitorTestOutput
 * @version 2013-06-30
 */
class DescribeAvailabilityMonitorTestOutput {
    /**
     * Constructs a new <code>DescribeAvailabilityMonitorTestOutput</code>.
     * @alias module:model/DescribeAvailabilityMonitorTestOutput
     */
    constructor() { 
        
        DescribeAvailabilityMonitorTestOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAvailabilityMonitorTestOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAvailabilityMonitorTestOutput} obj Optional instance to populate.
     * @return {module:model/DescribeAvailabilityMonitorTestOutput} The populated <code>DescribeAvailabilityMonitorTestOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAvailabilityMonitorTestOutput();

            if (data.hasOwnProperty('GatewayARN')) {
                obj['GatewayARN'] = ApiClient.convertToType(data['GatewayARN'], 'String');
            }
            if (data.hasOwnProperty('Status')) {
                obj['Status'] = ApiClient.convertToType(data['Status'], AvailabilityMonitorTestStatus);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAvailabilityMonitorTestOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAvailabilityMonitorTestOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Status']) { // data not null
          AvailabilityMonitorTestStatus.validateJSON(data['Status']);
        }
 ...
 */
DescribeAvailabilityMonitorTestOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {module:model/AvailabilityMonitorTestStatus} Status
 */
DescribeAvailabilityMonitorTestOutput.prototype['Status'] = undefined;

/**
 * @member {Date} StartTime
 */
DescribeAvailabilityMonitorTestOutput.prototype['StartTime'] = undefined;
...
export default DescribeAvailabilityMonitorTestOutput;
