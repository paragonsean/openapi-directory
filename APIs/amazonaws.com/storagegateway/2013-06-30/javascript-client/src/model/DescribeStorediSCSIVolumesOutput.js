...
/**
 * The DescribeStorediSCSIVolumesOutput model module.
 * @module model/DescribeStorediSCSIVolumesOutput
 * @version 2013-06-30
 */
class DescribeStorediSCSIVolumesOutput {
    /**
     * Constructs a new <code>DescribeStorediSCSIVolumesOutput</code>.
     * @alias module:model/DescribeStorediSCSIVolumesOutput
     */
    constructor() { 
        
        DescribeStorediSCSIVolumesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeStorediSCSIVolumesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeStorediSCSIVolumesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeStorediSCSIVolumesOutput} The populated <code>DescribeStorediSCSIVolumesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeStorediSCSIVolumesOutput();

            if (data.hasOwnProperty('StorediSCSIVolumes')) {
                obj['StorediSCSIVolumes'] = ApiClient.convertToType(data['StorediSCSIVolumes'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeStorediSCSIVolumesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeStorediSCSIVolumesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `StorediSCSIVolumes`
        if (data['StorediSCSIVolumes']) { // data not null
          Array.validateJSON(data['StorediSCSIVolumes']);
        }
...
/**
 * @member {Array} StorediSCSIVolumes
 */
DescribeStorediSCSIVolumesOutput.prototype['StorediSCSIVolumes'] = undefined;
...
export default DescribeStorediSCSIVolumesOutput;
