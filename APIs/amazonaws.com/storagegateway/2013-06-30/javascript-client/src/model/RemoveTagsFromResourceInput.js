...
/**
 * The RemoveTagsFromResourceInput model module.
 * @module model/RemoveTagsFromResourceInput
 * @version 2013-06-30
 */
class RemoveTagsFromResourceInput {
    /**
     * Constructs a new <code>RemoveTagsFromResourceInput</code>.
     * RemoveTagsFromResourceInput
     * @alias module:model/RemoveTagsFromResourceInput
     * @param resourceARN {String} 
     * @param tagKeys {Array} 
     */
    constructor(resourceARN, tagKeys) { 
        
        RemoveTagsFromResourceInput.initialize(this, resourceARN, tagKeys);
    }
    ...
    /**
     * Constructs a <code>RemoveTagsFromResourceInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveTagsFromResourceInput} obj Optional instance to populate.
     * @return {module:model/RemoveTagsFromResourceInput} The populated <code>RemoveTagsFromResourceInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveTagsFromResourceInput();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveTagsFromResourceInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveTagsFromResourceInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RemoveTagsFromResourceInput.RequiredProperties) {
...
RemoveTagsFromResourceInput.RequiredProperties = ["ResourceARN", "TagKeys"];

/**
 * @member {String} ResourceARN
 */
RemoveTagsFromResourceInput.prototype['ResourceARN'] = undefined;

/**
 * @member {Array} TagKeys
 */
RemoveTagsFromResourceInput.prototype['TagKeys'] = undefined;
...
export default RemoveTagsFromResourceInput;
