...
/**
 * The TapeRecoveryPointInfo model module.
 * @module model/TapeRecoveryPointInfo
 * @version 2013-06-30
 */
class TapeRecoveryPointInfo {
    /**
     * Constructs a new <code>TapeRecoveryPointInfo</code>.
     * Describes a recovery point.
     * @alias module:model/TapeRecoveryPointInfo
     */
    constructor() { 
        
        TapeRecoveryPointInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TapeRecoveryPointInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TapeRecoveryPointInfo} obj Optional instance to populate.
     * @return {module:model/TapeRecoveryPointInfo} The populated <code>TapeRecoveryPointInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TapeRecoveryPointInfo();

            if (data.hasOwnProperty('TapeARN')) {
                obj['TapeARN'] = ApiClient.convertToType(data['TapeARN'], 'String');
            }
            if (data.hasOwnProperty('TapeRecoveryPointTime')) {
                obj['TapeRecoveryPointTime'] = ApiClient.convertToType(data['TapeRecoveryPointTime'], 'Date');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TapeRecoveryPointInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TapeRecoveryPointInfo</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `TapeRecoveryPointTime`
        if (data['TapeRecoveryPointTime']) { // data not null
          Date.validateJSON(data['TapeRecoveryPointTime']);
        }
 ...
 */
TapeRecoveryPointInfo.prototype['TapeARN'] = undefined;

/**
 * @member {Date} TapeRecoveryPointTime
 */
TapeRecoveryPointInfo.prototype['TapeRecoveryPointTime'] = undefined;

/**
 * @member {Number} TapeSizeInBytes
 */
TapeRecoveryPointInfo.prototype['TapeSizeInBytes'] = undefined;

/**
 * @member {String} TapeStatus
 */
TapeRecoveryPointInfo.prototype['TapeStatus'] = undefined;
...
export default TapeRecoveryPointInfo;
