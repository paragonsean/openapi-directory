...
/**
 * The CacheAttributes model module.
 * @module model/CacheAttributes
 * @version 2013-06-30
 */
class CacheAttributes {
    /**
     * Constructs a new <code>CacheAttributes</code>.
     * The refresh cache information for the file share or FSx file systems.
     * @alias module:model/CacheAttributes
     */
    constructor() { 
        
        CacheAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CacheAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CacheAttributes} obj Optional instance to populate.
     * @return {module:model/CacheAttributes} The populated <code>CacheAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CacheAttributes();

            if (data.hasOwnProperty('CacheStaleTimeoutInSeconds')) {
                obj['CacheStaleTimeoutInSeconds'] = ApiClient.convertToType(data['CacheStaleTimeoutInSeconds'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CacheAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CacheAttributes</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CacheStaleTimeoutInSeconds`
        if (data['CacheStaleTimeoutInSeconds']) { // data not null
          Number.validateJSON(data['CacheStaleTimeoutInSeconds']);
        }
...
/**
 * @member {Number} CacheStaleTimeoutInSeconds
 */
CacheAttributes.prototype['CacheStaleTimeoutInSeconds'] = undefined;
...
export default CacheAttributes;
