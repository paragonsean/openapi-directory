...
/**
 * The DeleteFileShareOutput model module.
 * @module model/DeleteFileShareOutput
 * @version 2013-06-30
 */
class DeleteFileShareOutput {
    /**
     * Constructs a new <code>DeleteFileShareOutput</code>.
     * DeleteFileShareOutput
     * @alias module:model/DeleteFileShareOutput
     */
    constructor() { 
        
        DeleteFileShareOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteFileShareOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFileShareOutput} obj Optional instance to populate.
     * @return {module:model/DeleteFileShareOutput} The populated <code>DeleteFileShareOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFileShareOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFileShareOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFileShareOutput</code>.
     */
 ...
 */
DeleteFileShareOutput.prototype['FileShareARN'] = undefined;
...
export default DeleteFileShareOutput;
