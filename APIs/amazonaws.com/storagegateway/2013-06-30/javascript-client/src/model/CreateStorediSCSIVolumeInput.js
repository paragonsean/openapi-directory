...
/**
 * The CreateStorediSCSIVolumeInput model module.
 * @module model/CreateStorediSCSIVolumeInput
 * @version 2013-06-30
 */
class CreateStorediSCSIVolumeInput {
    /**
     * Constructs a new <code>CreateStorediSCSIVolumeInput</code>.
     ...
     * @alias module:model/CreateStorediSCSIVolumeInput
     ...
     * @param diskId {String} 
     * @param preserveExistingData {Boolean} 
     * @param targetName {String} 
     * @param networkInterfaceId {String} 
     */
    constructor(gatewayARN, diskId, preserveExistingData, targetName, networkInterfaceId) { 
        
        CreateStorediSCSIVolumeInput.initialize(this, gatewayARN, diskId, preserveExistingData, targetName, networkInterfaceId);
    }
     ...
     */
    static initialize(obj, gatewayARN, diskId, preserveExistingData, targetName, networkInterfaceId) { 
        obj['GatewayARN'] = gatewayARN;
        obj['DiskId'] = diskId;
        obj['PreserveExistingData'] = preserveExistingData;
        obj['TargetName'] = targetName;
        obj['NetworkInterfaceId'] = networkInterfaceId;
    }

    /**
     * Constructs a <code>CreateStorediSCSIVolumeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStorediSCSIVolumeInput} obj Optional instance to populate.
     * @return {module:model/CreateStorediSCSIVolumeInput} The populated <code>CreateStorediSCSIVolumeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStorediSCSIVolumeInput();
            ...
            if (data.hasOwnProperty('PreserveExistingData')) {
                obj['PreserveExistingData'] = ApiClient.convertToType(data['PreserveExistingData'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStorediSCSIVolumeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStorediSCSIVolumeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateStorediSCSIVolumeInput.RequiredProperties) {
        ...
        // validate the optional field `PreserveExistingData`
        if (data['PreserveExistingData']) { // data not null
          Boolean.validateJSON(data['PreserveExistingData']);
        }
...
CreateStorediSCSIVolumeInput.RequiredProperties = ["GatewayARN", "DiskId", "PreserveExistingData", "TargetName", "NetworkInterfaceId"];
 ...
 */
CreateStorediSCSIVolumeInput.prototype['GatewayARN'] = undefined;

/**
 * @member {String} DiskId
 */
CreateStorediSCSIVolumeInput.prototype['DiskId'] = undefined;

/**
 * @member {String} SnapshotId
 */
CreateStorediSCSIVolumeInput.prototype['SnapshotId'] = undefined;

/**
 * @member {Boolean} PreserveExistingData
 */
CreateStorediSCSIVolumeInput.prototype['PreserveExistingData'] = undefined;

/**
 * @member {String} TargetName
 */
CreateStorediSCSIVolumeInput.prototype['TargetName'] = undefined;

/**
 * @member {String} NetworkInterfaceId
 */
CreateStorediSCSIVolumeInput.prototype['NetworkInterfaceId'] = undefined;

/**
 * @member {Boolean} KMSEncrypted
 */
CreateStorediSCSIVolumeInput.prototype['KMSEncrypted'] = undefined;

/**
 * @member {String} KMSKey
 */
CreateStorediSCSIVolumeInput.prototype['KMSKey'] = undefined;

/**
 * @member {Array} Tags
 */
CreateStorediSCSIVolumeInput.prototype['Tags'] = undefined;
...
export default CreateStorediSCSIVolumeInput;
