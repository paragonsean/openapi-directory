...
/**
 * The RetrieveTapeRecoveryPointInput model module.
 * @module model/RetrieveTapeRecoveryPointInput
 * @version 2013-06-30
 */
class RetrieveTapeRecoveryPointInput {
    /**
     * Constructs a new <code>RetrieveTapeRecoveryPointInput</code>.
     * RetrieveTapeRecoveryPointInput
     * @alias module:model/RetrieveTapeRecoveryPointInput
    ...
    constructor(tapeARN, gatewayARN) { 
        ...
        RetrieveTapeRecoveryPointInput.initialize(this, tapeARN, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>RetrieveTapeRecoveryPointInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RetrieveTapeRecoveryPointInput} obj Optional instance to populate.
     * @return {module:model/RetrieveTapeRecoveryPointInput} The populated <code>RetrieveTapeRecoveryPointInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RetrieveTapeRecoveryPointInput();
    ...
    /**
     * Validates the JSON data with respect to <code>RetrieveTapeRecoveryPointInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RetrieveTapeRecoveryPointInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RetrieveTapeRecoveryPointInput.RequiredProperties) {
...
RetrieveTapeRecoveryPointInput.RequiredProperties = ["TapeARN", "GatewayARN"];

/**
 * @member {String} TapeARN
 */
RetrieveTapeRecoveryPointInput.prototype['TapeARN'] = undefined;
 ...
 */
RetrieveTapeRecoveryPointInput.prototype['GatewayARN'] = undefined;
...
export default RetrieveTapeRecoveryPointInput;
