...
/**
 * The DescribeBandwidthRateLimitInput model module.
 * @module model/DescribeBandwidthRateLimitInput
 * @version 2013-06-30
 */
class DescribeBandwidthRateLimitInput {
    /**
     * Constructs a new <code>DescribeBandwidthRateLimitInput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway.
     * @alias module:model/DescribeBandwidthRateLimitInput
    ...
    constructor(gatewayARN) { 
        ...
        DescribeBandwidthRateLimitInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DescribeBandwidthRateLimitInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBandwidthRateLimitInput} obj Optional instance to populate.
     * @return {module:model/DescribeBandwidthRateLimitInput} The populated <code>DescribeBandwidthRateLimitInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBandwidthRateLimitInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBandwidthRateLimitInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBandwidthRateLimitInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeBandwidthRateLimitInput.RequiredProperties) {
...
DescribeBandwidthRateLimitInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DescribeBandwidthRateLimitInput.prototype['GatewayARN'] = undefined;
...
export default DescribeBandwidthRateLimitInput;
