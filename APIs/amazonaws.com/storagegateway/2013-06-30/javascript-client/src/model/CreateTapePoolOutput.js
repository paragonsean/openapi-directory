...
/**
 * The CreateTapePoolOutput model module.
 * @module model/CreateTapePoolOutput
 * @version 2013-06-30
 */
class CreateTapePoolOutput {
    /**
     * Constructs a new <code>CreateTapePoolOutput</code>.
     * @alias module:model/CreateTapePoolOutput
     */
    constructor() { 
        
        CreateTapePoolOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateTapePoolOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTapePoolOutput} obj Optional instance to populate.
     * @return {module:model/CreateTapePoolOutput} The populated <code>CreateTapePoolOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTapePoolOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTapePoolOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTapePoolOutput</code>.
     */
 ...
 */
CreateTapePoolOutput.prototype['PoolARN'] = undefined;
...
export default CreateTapePoolOutput;
