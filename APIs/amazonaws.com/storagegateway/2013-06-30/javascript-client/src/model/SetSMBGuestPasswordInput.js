...
/**
 * The SetSMBGuestPasswordInput model module.
 * @module model/SetSMBGuestPasswordInput
 * @version 2013-06-30
 */
class SetSMBGuestPasswordInput {
    /**
     * Constructs a new <code>SetSMBGuestPasswordInput</code>.
     * SetSMBGuestPasswordInput
     * @alias module:model/SetSMBGuestPasswordInput
     * @param gatewayARN {String} 
     * @param password {String} 
     */
    constructor(gatewayARN, password) { 
        
        SetSMBGuestPasswordInput.initialize(this, gatewayARN, password);
    }
     ...
     */
    static initialize(obj, gatewayARN, password) { 
        obj['GatewayARN'] = gatewayARN;
        obj['Password'] = password;
    }

    /**
     * Constructs a <code>SetSMBGuestPasswordInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetSMBGuestPasswordInput} obj Optional instance to populate.
     * @return {module:model/SetSMBGuestPasswordInput} The populated <code>SetSMBGuestPasswordInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetSMBGuestPasswordInput();
    ...
    /**
     * Validates the JSON data with respect to <code>SetSMBGuestPasswordInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetSMBGuestPasswordInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetSMBGuestPasswordInput.RequiredProperties) {
...
SetSMBGuestPasswordInput.RequiredProperties = ["GatewayARN", "Password"];

/**
 * @member {String} GatewayARN
 */
SetSMBGuestPasswordInput.prototype['GatewayARN'] = undefined;

/**
 * @member {String} Password
 */
SetSMBGuestPasswordInput.prototype['Password'] = undefined;
...
export default SetSMBGuestPasswordInput;
