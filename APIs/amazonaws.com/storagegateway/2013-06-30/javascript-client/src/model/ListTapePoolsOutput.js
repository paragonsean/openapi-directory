...
/**
 * The ListTapePoolsOutput model module.
 * @module model/ListTapePoolsOutput
 * @version 2013-06-30
 */
class ListTapePoolsOutput {
    /**
     * Constructs a new <code>ListTapePoolsOutput</code>.
     * @alias module:model/ListTapePoolsOutput
     */
    constructor() { 
        
        ListTapePoolsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListTapePoolsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTapePoolsOutput} obj Optional instance to populate.
     * @return {module:model/ListTapePoolsOutput} The populated <code>ListTapePoolsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTapePoolsOutput();

            if (data.hasOwnProperty('PoolInfos')) {
                obj['PoolInfos'] = ApiClient.convertToType(data['PoolInfos'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListTapePoolsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTapePoolsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PoolInfos`
        if (data['PoolInfos']) { // data not null
          Array.validateJSON(data['PoolInfos']);
        }
...
/**
 * @member {Array} PoolInfos
 */
ListTapePoolsOutput.prototype['PoolInfos'] = undefined;

/**
 * @member {String} Marker
 */
ListTapePoolsOutput.prototype['Marker'] = undefined;
...
export default ListTapePoolsOutput;
