...
/**
 * The StartAvailabilityMonitorTestOutput model module.
 * @module model/StartAvailabilityMonitorTestOutput
 * @version 2013-06-30
 */
class StartAvailabilityMonitorTestOutput {
    /**
     * Constructs a new <code>StartAvailabilityMonitorTestOutput</code>.
     * @alias module:model/StartAvailabilityMonitorTestOutput
     */
    constructor() { 
        
        StartAvailabilityMonitorTestOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartAvailabilityMonitorTestOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartAvailabilityMonitorTestOutput} obj Optional instance to populate.
     * @return {module:model/StartAvailabilityMonitorTestOutput} The populated <code>StartAvailabilityMonitorTestOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartAvailabilityMonitorTestOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>StartAvailabilityMonitorTestOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartAvailabilityMonitorTestOutput</code>.
     */
 ...
 */
StartAvailabilityMonitorTestOutput.prototype['GatewayARN'] = undefined;
...
export default StartAvailabilityMonitorTestOutput;
