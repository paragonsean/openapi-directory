...
/**
 * The ListVolumeRecoveryPointsOutput model module.
 * @module model/ListVolumeRecoveryPointsOutput
 * @version 2013-06-30
 */
class ListVolumeRecoveryPointsOutput {
    /**
     * Constructs a new <code>ListVolumeRecoveryPointsOutput</code>.
     * @alias module:model/ListVolumeRecoveryPointsOutput
     */
    constructor() { 
        
        ListVolumeRecoveryPointsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListVolumeRecoveryPointsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListVolumeRecoveryPointsOutput} obj Optional instance to populate.
     * @return {module:model/ListVolumeRecoveryPointsOutput} The populated <code>ListVolumeRecoveryPointsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListVolumeRecoveryPointsOutput();

            if (data.hasOwnProperty('GatewayARN')) {
                obj['GatewayARN'] = ApiClient.convertToType(data['GatewayARN'], 'String');
            }
            if (data.hasOwnProperty('VolumeRecoveryPointInfos')) {
                obj['VolumeRecoveryPointInfos'] = ApiClient.convertToType(data['VolumeRecoveryPointInfos'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListVolumeRecoveryPointsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListVolumeRecoveryPointsOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['VolumeRecoveryPointInfos']) { // data not null
          Array.validateJSON(data['VolumeRecoveryPointInfos']);
        }
 ...
 */
ListVolumeRecoveryPointsOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {Array} VolumeRecoveryPointInfos
 */
ListVolumeRecoveryPointsOutput.prototype['VolumeRecoveryPointInfos'] = undefined;
...
export default ListVolumeRecoveryPointsOutput;
