...
/**
 * The ActivateGatewayOutput model module.
 * @module model/ActivateGatewayOutput
 * @version 2013-06-30
 */
class ActivateGatewayOutput {
    /**
     * Constructs a new <code>ActivateGatewayOutput</code>.
     ...
     * @alias module:model/ActivateGatewayOutput
     */
    constructor() { 
        
        ActivateGatewayOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActivateGatewayOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActivateGatewayOutput} obj Optional instance to populate.
     * @return {module:model/ActivateGatewayOutput} The populated <code>ActivateGatewayOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActivateGatewayOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ActivateGatewayOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActivateGatewayOutput</code>.
     */
 ...
 */
ActivateGatewayOutput.prototype['GatewayARN'] = undefined;
...
export default ActivateGatewayOutput;
