...
/**
 * The DeleteAutomaticTapeCreationPolicyOutput model module.
 * @module model/DeleteAutomaticTapeCreationPolicyOutput
 * @version 2013-06-30
 */
class DeleteAutomaticTapeCreationPolicyOutput {
    /**
     * Constructs a new <code>DeleteAutomaticTapeCreationPolicyOutput</code>.
     * @alias module:model/DeleteAutomaticTapeCreationPolicyOutput
     */
    constructor() { 
        
        DeleteAutomaticTapeCreationPolicyOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteAutomaticTapeCreationPolicyOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAutomaticTapeCreationPolicyOutput} obj Optional instance to populate.
     * @return {module:model/DeleteAutomaticTapeCreationPolicyOutput} The populated <code>DeleteAutomaticTapeCreationPolicyOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAutomaticTapeCreationPolicyOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAutomaticTapeCreationPolicyOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAutomaticTapeCreationPolicyOutput</code>.
     */
 ...
 */
DeleteAutomaticTapeCreationPolicyOutput.prototype['GatewayARN'] = undefined;
...
export default DeleteAutomaticTapeCreationPolicyOutput;
