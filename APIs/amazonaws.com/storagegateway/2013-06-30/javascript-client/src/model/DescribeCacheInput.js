...
/**
 * The DescribeCacheInput model module.
 * @module model/DescribeCacheInput
 * @version 2013-06-30
 */
class DescribeCacheInput {
    /**
     * Constructs a new <code>DescribeCacheInput</code>.
     * @alias module:model/DescribeCacheInput
    ...
    constructor(gatewayARN) { 
        ...
        DescribeCacheInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DescribeCacheInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCacheInput} obj Optional instance to populate.
     * @return {module:model/DescribeCacheInput} The populated <code>DescribeCacheInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCacheInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCacheInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCacheInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeCacheInput.RequiredProperties) {
...
DescribeCacheInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DescribeCacheInput.prototype['GatewayARN'] = undefined;
...
export default DescribeCacheInput;
