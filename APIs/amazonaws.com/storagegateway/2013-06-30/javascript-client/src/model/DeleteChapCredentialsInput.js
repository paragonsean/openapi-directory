...
/**
 * The DeleteChapCredentialsInput model module.
 * @module model/DeleteChapCredentialsInput
 * @version 2013-06-30
 */
class DeleteChapCredentialsInput {
    /**
     * Constructs a new <code>DeleteChapCredentialsInput</code>.
     ...
     * @alias module:model/DeleteChapCredentialsInput
     * @param targetARN {String} 
     * @param initiatorName {String} 
     */
    constructor(targetARN, initiatorName) { 
        
        DeleteChapCredentialsInput.initialize(this, targetARN, initiatorName);
    }
     ...
     */
    static initialize(obj, targetARN, initiatorName) { 
        obj['TargetARN'] = targetARN;
        obj['InitiatorName'] = initiatorName;
    }

    /**
     * Constructs a <code>DeleteChapCredentialsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteChapCredentialsInput} obj Optional instance to populate.
     * @return {module:model/DeleteChapCredentialsInput} The populated <code>DeleteChapCredentialsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteChapCredentialsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteChapCredentialsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteChapCredentialsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteChapCredentialsInput.RequiredProperties) {
...
DeleteChapCredentialsInput.RequiredProperties = ["TargetARN", "InitiatorName"];

/**
 * @member {String} TargetARN
 */
DeleteChapCredentialsInput.prototype['TargetARN'] = undefined;

/**
 * @member {String} InitiatorName
 */
DeleteChapCredentialsInput.prototype['InitiatorName'] = undefined;
...
export default DeleteChapCredentialsInput;
