...
/**
 * The UpdateSnapshotScheduleOutput model module.
 * @module model/UpdateSnapshotScheduleOutput
 * @version 2013-06-30
 */
class UpdateSnapshotScheduleOutput {
    /**
     * Constructs a new <code>UpdateSnapshotScheduleOutput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the updated storage volume.
     * @alias module:model/UpdateSnapshotScheduleOutput
     */
    constructor() { 
        
        UpdateSnapshotScheduleOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSnapshotScheduleOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSnapshotScheduleOutput} obj Optional instance to populate.
     * @return {module:model/UpdateSnapshotScheduleOutput} The populated <code>UpdateSnapshotScheduleOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSnapshotScheduleOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSnapshotScheduleOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSnapshotScheduleOutput</code>.
     */
 ...
 */
UpdateSnapshotScheduleOutput.prototype['VolumeARN'] = undefined;
...
export default UpdateSnapshotScheduleOutput;
