...
/**
 * The UpdateSnapshotScheduleInput model module.
 * @module model/UpdateSnapshotScheduleInput
 * @version 2013-06-30
 */
class UpdateSnapshotScheduleInput {
    /**
     * Constructs a new <code>UpdateSnapshotScheduleInput</code>.
     ...
     * @alias module:model/UpdateSnapshotScheduleInput
     * @param volumeARN {String} 
     * @param startAt {Number} 
     * @param recurrenceInHours {Number} 
     */
    constructor(volumeARN, startAt, recurrenceInHours) { 
        
        UpdateSnapshotScheduleInput.initialize(this, volumeARN, startAt, recurrenceInHours);
    }
     ...
     */
    static initialize(obj, volumeARN, startAt, recurrenceInHours) { 
        obj['VolumeARN'] = volumeARN;
        obj['StartAt'] = startAt;
        obj['RecurrenceInHours'] = recurrenceInHours;
    }

    /**
     * Constructs a <code>UpdateSnapshotScheduleInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSnapshotScheduleInput} obj Optional instance to populate.
     * @return {module:model/UpdateSnapshotScheduleInput} The populated <code>UpdateSnapshotScheduleInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSnapshotScheduleInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSnapshotScheduleInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSnapshotScheduleInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateSnapshotScheduleInput.RequiredProperties) {
...
UpdateSnapshotScheduleInput.RequiredProperties = ["VolumeARN", "StartAt", "RecurrenceInHours"];

/**
 * @member {String} VolumeARN
 */
UpdateSnapshotScheduleInput.prototype['VolumeARN'] = undefined;

/**
 * @member {Number} StartAt
 */
UpdateSnapshotScheduleInput.prototype['StartAt'] = undefined;

/**
 * @member {Number} RecurrenceInHours
 */
UpdateSnapshotScheduleInput.prototype['RecurrenceInHours'] = undefined;

/**
 * @member {String} Description
 */
UpdateSnapshotScheduleInput.prototype['Description'] = undefined;

/**
 * @member {Array} Tags
 */
UpdateSnapshotScheduleInput.prototype['Tags'] = undefined;
...
export default UpdateSnapshotScheduleInput;
