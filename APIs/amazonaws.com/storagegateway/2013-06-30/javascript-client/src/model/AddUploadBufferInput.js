...
/**
 * The AddUploadBufferInput model module.
 * @module model/AddUploadBufferInput
 * @version 2013-06-30
 */
class AddUploadBufferInput {
    /**
     * Constructs a new <code>AddUploadBufferInput</code>.
     * @alias module:model/AddUploadBufferInput
     ...
     * @param diskIds {Array} 
     */
    constructor(gatewayARN, diskIds) { 
        
        AddUploadBufferInput.initialize(this, gatewayARN, diskIds);
    }
     ...
     */
    static initialize(obj, gatewayARN, diskIds) { 
        obj['GatewayARN'] = gatewayARN;
        obj['DiskIds'] = diskIds;
    }

    /**
     * Constructs a <code>AddUploadBufferInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddUploadBufferInput} obj Optional instance to populate.
     * @return {module:model/AddUploadBufferInput} The populated <code>AddUploadBufferInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddUploadBufferInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AddUploadBufferInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddUploadBufferInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddUploadBufferInput.RequiredProperties) {
...
AddUploadBufferInput.RequiredProperties = ["GatewayARN", "DiskIds"];
 ...
 */
AddUploadBufferInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Array} DiskIds
 */
AddUploadBufferInput.prototype['DiskIds'] = undefined;
...
export default AddUploadBufferInput;
