...
/**
 * The DescribeChapCredentialsInput model module.
 * @module model/DescribeChapCredentialsInput
 * @version 2013-06-30
 */
class DescribeChapCredentialsInput {
    /**
     * Constructs a new <code>DescribeChapCredentialsInput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the iSCSI volume target.
     * @alias module:model/DescribeChapCredentialsInput
     * @param targetARN {String} 
     */
    constructor(targetARN) { 
        
        DescribeChapCredentialsInput.initialize(this, targetARN);
    }
    ...
    /**
     * Constructs a <code>DescribeChapCredentialsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeChapCredentialsInput} obj Optional instance to populate.
     * @return {module:model/DescribeChapCredentialsInput} The populated <code>DescribeChapCredentialsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeChapCredentialsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeChapCredentialsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeChapCredentialsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeChapCredentialsInput.RequiredProperties) {
...
DescribeChapCredentialsInput.RequiredProperties = ["TargetARN"];

/**
 * @member {String} TargetARN
 */
DescribeChapCredentialsInput.prototype['TargetARN'] = undefined;
...
export default DescribeChapCredentialsInput;
