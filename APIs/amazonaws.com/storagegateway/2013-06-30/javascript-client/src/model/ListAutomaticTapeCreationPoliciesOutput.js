...
/**
 * The ListAutomaticTapeCreationPoliciesOutput model module.
 * @module model/ListAutomaticTapeCreationPoliciesOutput
 * @version 2013-06-30
 */
class ListAutomaticTapeCreationPoliciesOutput {
    /**
     * Constructs a new <code>ListAutomaticTapeCreationPoliciesOutput</code>.
     * @alias module:model/ListAutomaticTapeCreationPoliciesOutput
     */
    constructor() { 
        
        ListAutomaticTapeCreationPoliciesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAutomaticTapeCreationPoliciesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAutomaticTapeCreationPoliciesOutput} obj Optional instance to populate.
     * @return {module:model/ListAutomaticTapeCreationPoliciesOutput} The populated <code>ListAutomaticTapeCreationPoliciesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAutomaticTapeCreationPoliciesOutput();

            if (data.hasOwnProperty('AutomaticTapeCreationPolicyInfos')) {
                obj['AutomaticTapeCreationPolicyInfos'] = ApiClient.convertToType(data['AutomaticTapeCreationPolicyInfos'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListAutomaticTapeCreationPoliciesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAutomaticTapeCreationPoliciesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `AutomaticTapeCreationPolicyInfos`
        if (data['AutomaticTapeCreationPolicyInfos']) { // data not null
          Array.validateJSON(data['AutomaticTapeCreationPolicyInfos']);
        }
...
/**
 * @member {Array} AutomaticTapeCreationPolicyInfos
 */
ListAutomaticTapeCreationPoliciesOutput.prototype['AutomaticTapeCreationPolicyInfos'] = undefined;
...
export default ListAutomaticTapeCreationPoliciesOutput;
