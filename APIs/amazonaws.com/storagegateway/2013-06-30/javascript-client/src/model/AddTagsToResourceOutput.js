...
/**
 * The AddTagsToResourceOutput model module.
 * @module model/AddTagsToResourceOutput
 * @version 2013-06-30
 */
class AddTagsToResourceOutput {
    /**
     * Constructs a new <code>AddTagsToResourceOutput</code>.
     * AddTagsToResourceOutput
     * @alias module:model/AddTagsToResourceOutput
     */
    constructor() { 
        
        AddTagsToResourceOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddTagsToResourceOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddTagsToResourceOutput} obj Optional instance to populate.
     * @return {module:model/AddTagsToResourceOutput} The populated <code>AddTagsToResourceOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddTagsToResourceOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>AddTagsToResourceOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddTagsToResourceOutput</code>.
     */
 ...
 */
AddTagsToResourceOutput.prototype['ResourceARN'] = undefined;
...
export default AddTagsToResourceOutput;
