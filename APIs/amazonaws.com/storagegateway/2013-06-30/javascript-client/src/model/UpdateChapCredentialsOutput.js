...
/**
 * The UpdateChapCredentialsOutput model module.
 * @module model/UpdateChapCredentialsOutput
 * @version 2013-06-30
 */
class UpdateChapCredentialsOutput {
    /**
     * Constructs a new <code>UpdateChapCredentialsOutput</code>.
     * A JSON object containing the following fields:
     * @alias module:model/UpdateChapCredentialsOutput
     */
    constructor() { 
        
        UpdateChapCredentialsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateChapCredentialsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateChapCredentialsOutput} obj Optional instance to populate.
     * @return {module:model/UpdateChapCredentialsOutput} The populated <code>UpdateChapCredentialsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateChapCredentialsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateChapCredentialsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateChapCredentialsOutput</code>.
     */
 ...
 */
UpdateChapCredentialsOutput.prototype['TargetARN'] = undefined;

/**
 * @member {String} InitiatorName
 */
UpdateChapCredentialsOutput.prototype['InitiatorName'] = undefined;
...
export default UpdateChapCredentialsOutput;
