...
/**
 * The AddCacheOutput model module.
 * @module model/AddCacheOutput
 * @version 2013-06-30
 */
class AddCacheOutput {
    /**
     * Constructs a new <code>AddCacheOutput</code>.
     * @alias module:model/AddCacheOutput
     */
    constructor() { 
        
        AddCacheOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddCacheOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddCacheOutput} obj Optional instance to populate.
     * @return {module:model/AddCacheOutput} The populated <code>AddCacheOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddCacheOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>AddCacheOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddCacheOutput</code>.
     */
 ...
 */
AddCacheOutput.prototype['GatewayARN'] = undefined;
