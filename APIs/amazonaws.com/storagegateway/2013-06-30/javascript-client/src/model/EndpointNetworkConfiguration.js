...
/**
 * The EndpointNetworkConfiguration model module.
 * @module model/EndpointNetworkConfiguration
 * @version 2013-06-30
 */
class EndpointNetworkConfiguration {
    /**
     * Constructs a new <code>EndpointNetworkConfiguration</code>.
     * Specifies network configuration information for the gateway associated with the Amazon FSx file system.
     * @alias module:model/EndpointNetworkConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>EndpointNetworkConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EndpointNetworkConfiguration} obj Optional instance to populate.
     * @return {module:model/EndpointNetworkConfiguration} The populated <code>EndpointNetworkConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EndpointNetworkConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>EndpointNetworkConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EndpointNetworkConfiguration</code>.
     */
...
export default EndpointNetworkConfiguration;
