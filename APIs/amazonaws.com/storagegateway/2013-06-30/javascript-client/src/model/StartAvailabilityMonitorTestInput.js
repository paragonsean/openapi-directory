...
/**
 * The StartAvailabilityMonitorTestInput model module.
 * @module model/StartAvailabilityMonitorTestInput
 * @version 2013-06-30
 */
class StartAvailabilityMonitorTestInput {
    /**
     * Constructs a new <code>StartAvailabilityMonitorTestInput</code>.
     * @alias module:model/StartAvailabilityMonitorTestInput
    ...
    constructor(gatewayARN) { 
        ...
        StartAvailabilityMonitorTestInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>StartAvailabilityMonitorTestInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartAvailabilityMonitorTestInput} obj Optional instance to populate.
     * @return {module:model/StartAvailabilityMonitorTestInput} The populated <code>StartAvailabilityMonitorTestInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartAvailabilityMonitorTestInput();
    ...
    /**
     * Validates the JSON data with respect to <code>StartAvailabilityMonitorTestInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartAvailabilityMonitorTestInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartAvailabilityMonitorTestInput.RequiredProperties) {
...
StartAvailabilityMonitorTestInput.RequiredProperties = ["GatewayARN"];
 ...
 */
StartAvailabilityMonitorTestInput.prototype['GatewayARN'] = undefined;
...
export default StartAvailabilityMonitorTestInput;
