...
/**
 * The DescribeFileSystemAssociationsInput model module.
 * @module model/DescribeFileSystemAssociationsInput
 * @version 2013-06-30
 */
class DescribeFileSystemAssociationsInput {
    /**
     * Constructs a new <code>DescribeFileSystemAssociationsInput</code>.
     * @alias module:model/DescribeFileSystemAssociationsInput
     * @param fileSystemAssociationARNList {Array} 
     */
    constructor(fileSystemAssociationARNList) { 
        
        DescribeFileSystemAssociationsInput.initialize(this, fileSystemAssociationARNList);
    }
     ...
     */
    static initialize(obj, fileSystemAssociationARNList) { 
        obj['FileSystemAssociationARNList'] = fileSystemAssociationARNList;
    }

    /**
     * Constructs a <code>DescribeFileSystemAssociationsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFileSystemAssociationsInput} obj Optional instance to populate.
     * @return {module:model/DescribeFileSystemAssociationsInput} The populated <code>DescribeFileSystemAssociationsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFileSystemAssociationsInput();

            if (data.hasOwnProperty('FileSystemAssociationARNList')) {
                obj['FileSystemAssociationARNList'] = ApiClient.convertToType(data['FileSystemAssociationARNList'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFileSystemAssociationsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFileSystemAssociationsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeFileSystemAssociationsInput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `FileSystemAssociationARNList`
        if (data['FileSystemAssociationARNList']) { // data not null
          Array.validateJSON(data['FileSystemAssociationARNList']);
        }
...
DescribeFileSystemAssociationsInput.RequiredProperties = ["FileSystemAssociationARNList"];

/**
 * @member {Array} FileSystemAssociationARNList
 */
DescribeFileSystemAssociationsInput.prototype['FileSystemAssociationARNList'] = undefined;
...
export default DescribeFileSystemAssociationsInput;
