...
/**
 * The CreateNFSFileShareOutput model module.
 * @module model/CreateNFSFileShareOutput
 * @version 2013-06-30
 */
class CreateNFSFileShareOutput {
    /**
     * Constructs a new <code>CreateNFSFileShareOutput</code>.
     * CreateNFSFileShareOutput
     * @alias module:model/CreateNFSFileShareOutput
     */
    constructor() { 
        
        CreateNFSFileShareOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateNFSFileShareOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateNFSFileShareOutput} obj Optional instance to populate.
     * @return {module:model/CreateNFSFileShareOutput} The populated <code>CreateNFSFileShareOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateNFSFileShareOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateNFSFileShareOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateNFSFileShareOutput</code>.
     */
 ...
 */
CreateNFSFileShareOutput.prototype['FileShareARN'] = undefined;
...
export default CreateNFSFileShareOutput;
