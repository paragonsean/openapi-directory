...
* @readonly
*/
export default class AvailabilityMonitorTestStatus {
    ...
    /**
    * Returns a <code>AvailabilityMonitorTestStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AvailabilityMonitorTestStatus} The enum <code>AvailabilityMonitorTestStatus</code> value.
    */
