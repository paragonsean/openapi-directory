...
import ActiveDirectoryStatus from './ActiveDirectoryStatus';

/**
 * The JoinDomainOutput model module.
 * @module model/JoinDomainOutput
 * @version 2013-06-30
 */
class JoinDomainOutput {
    /**
     * Constructs a new <code>JoinDomainOutput</code>.
     * JoinDomainOutput
     * @alias module:model/JoinDomainOutput
     */
    constructor() { 
        
        JoinDomainOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JoinDomainOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JoinDomainOutput} obj Optional instance to populate.
     * @return {module:model/JoinDomainOutput} The populated <code>JoinDomainOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JoinDomainOutput();

            if (data.hasOwnProperty('GatewayARN')) {
                obj['GatewayARN'] = ApiClient.convertToType(data['GatewayARN'], 'String');
            }
            if (data.hasOwnProperty('ActiveDirectoryStatus')) {
                obj['ActiveDirectoryStatus'] = ApiClient.convertToType(data['ActiveDirectoryStatus'], ActiveDirectoryStatus);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>JoinDomainOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JoinDomainOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['ActiveDirectoryStatus']) { // data not null
          ActiveDirectoryStatus.validateJSON(data['ActiveDirectoryStatus']);
        }
 ...
 */
JoinDomainOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {module:model/ActiveDirectoryStatus} ActiveDirectoryStatus
 */
JoinDomainOutput.prototype['ActiveDirectoryStatus'] = undefined;
...
export default JoinDomainOutput;
