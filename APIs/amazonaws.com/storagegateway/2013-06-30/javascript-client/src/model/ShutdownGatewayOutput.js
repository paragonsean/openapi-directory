...
/**
 * The ShutdownGatewayOutput model module.
 * @module model/ShutdownGatewayOutput
 * @version 2013-06-30
 */
class ShutdownGatewayOutput {
    /**
     * Constructs a new <code>ShutdownGatewayOutput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway that was shut down.
     * @alias module:model/ShutdownGatewayOutput
     */
    constructor() { 
        
        ShutdownGatewayOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ShutdownGatewayOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShutdownGatewayOutput} obj Optional instance to populate.
     * @return {module:model/ShutdownGatewayOutput} The populated <code>ShutdownGatewayOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShutdownGatewayOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ShutdownGatewayOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShutdownGatewayOutput</code>.
     */
 ...
 */
ShutdownGatewayOutput.prototype['GatewayARN'] = undefined;
...
export default ShutdownGatewayOutput;
