...
/**
 * The VolumeInfo model module.
 * @module model/VolumeInfo
 * @version 2013-06-30
 */
class VolumeInfo {
    /**
     * Constructs a new <code>VolumeInfo</code>.
     * Describes a storage volume object.
     * @alias module:model/VolumeInfo
     */
    constructor() { 
        
        VolumeInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VolumeInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VolumeInfo} obj Optional instance to populate.
     * @return {module:model/VolumeInfo} The populated <code>VolumeInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VolumeInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>VolumeInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VolumeInfo</code>.
     */
 ...
 */
VolumeInfo.prototype['VolumeARN'] = undefined;

/**
 * @member {String} VolumeId
 */
VolumeInfo.prototype['VolumeId'] = undefined;
 ...
 */
VolumeInfo.prototype['GatewayARN'] = undefined;

/**
 * @member {String} GatewayId
 */
VolumeInfo.prototype['GatewayId'] = undefined;

/**
 * @member {String} VolumeType
 */
VolumeInfo.prototype['VolumeType'] = undefined;

/**
 * @member {Number} VolumeSizeInBytes
 */
VolumeInfo.prototype['VolumeSizeInBytes'] = undefined;

/**
 * @member {String} VolumeAttachmentStatus
 */
VolumeInfo.prototype['VolumeAttachmentStatus'] = undefined;
