...
/**
 * The DescribeSMBSettingsInput model module.
 * @module model/DescribeSMBSettingsInput
 * @version 2013-06-30
 */
class DescribeSMBSettingsInput {
    /**
     * Constructs a new <code>DescribeSMBSettingsInput</code>.
     * @alias module:model/DescribeSMBSettingsInput
    ...
    constructor(gatewayARN) { 
        ...
        DescribeSMBSettingsInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DescribeSMBSettingsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeSMBSettingsInput} obj Optional instance to populate.
     * @return {module:model/DescribeSMBSettingsInput} The populated <code>DescribeSMBSettingsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeSMBSettingsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeSMBSettingsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeSMBSettingsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeSMBSettingsInput.RequiredProperties) {
...
DescribeSMBSettingsInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DescribeSMBSettingsInput.prototype['GatewayARN'] = undefined;
...
export default DescribeSMBSettingsInput;
