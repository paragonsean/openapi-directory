...
/**
 * The CreateNFSFileShareInputNFSFileShareDefaults model module.
 * @module model/CreateNFSFileShareInputNFSFileShareDefaults
 * @version 2013-06-30
 */
class CreateNFSFileShareInputNFSFileShareDefaults {
    /**
     * Constructs a new <code>CreateNFSFileShareInputNFSFileShareDefaults</code>.
     * @alias module:model/CreateNFSFileShareInputNFSFileShareDefaults
     * @implements module:model/NFSFileShareDefaults
     */
    constructor() { 
        NFSFileShareDefaults.initialize(this);
        CreateNFSFileShareInputNFSFileShareDefaults.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateNFSFileShareInputNFSFileShareDefaults</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateNFSFileShareInputNFSFileShareDefaults} obj Optional instance to populate.
     * @return {module:model/CreateNFSFileShareInputNFSFileShareDefaults} The populated <code>CreateNFSFileShareInputNFSFileShareDefaults</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateNFSFileShareInputNFSFileShareDefaults();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateNFSFileShareInputNFSFileShareDefaults</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateNFSFileShareInputNFSFileShareDefaults</code>.
     */
 ...
 */
CreateNFSFileShareInputNFSFileShareDefaults.prototype['FileMode'] = undefined;

/**
 * @member {String} DirectoryMode
 */
CreateNFSFileShareInputNFSFileShareDefaults.prototype['DirectoryMode'] = undefined;

/**
 * @member {Number} GroupId
 */
CreateNFSFileShareInputNFSFileShareDefaults.prototype['GroupId'] = undefined;

/**
 * @member {Number} OwnerId
 */
CreateNFSFileShareInputNFSFileShareDefaults.prototype['OwnerId'] = undefined;
...
export default CreateNFSFileShareInputNFSFileShareDefaults;
