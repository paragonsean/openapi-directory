...
/**
 * The DeleteAutomaticTapeCreationPolicyInput model module.
 * @module model/DeleteAutomaticTapeCreationPolicyInput
 * @version 2013-06-30
 */
class DeleteAutomaticTapeCreationPolicyInput {
    /**
     * Constructs a new <code>DeleteAutomaticTapeCreationPolicyInput</code>.
     * @alias module:model/DeleteAutomaticTapeCreationPolicyInput
    ...
    constructor(gatewayARN) { 
        ...
        DeleteAutomaticTapeCreationPolicyInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DeleteAutomaticTapeCreationPolicyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAutomaticTapeCreationPolicyInput} obj Optional instance to populate.
     * @return {module:model/DeleteAutomaticTapeCreationPolicyInput} The populated <code>DeleteAutomaticTapeCreationPolicyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAutomaticTapeCreationPolicyInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAutomaticTapeCreationPolicyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAutomaticTapeCreationPolicyInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteAutomaticTapeCreationPolicyInput.RequiredProperties) {
...
DeleteAutomaticTapeCreationPolicyInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DeleteAutomaticTapeCreationPolicyInput.prototype['GatewayARN'] = undefined;
...
export default DeleteAutomaticTapeCreationPolicyInput;
