...
/**
 * The DeleteTapeOutput model module.
 * @module model/DeleteTapeOutput
 * @version 2013-06-30
 */
class DeleteTapeOutput {
    /**
     * Constructs a new <code>DeleteTapeOutput</code>.
     * DeleteTapeOutput
     * @alias module:model/DeleteTapeOutput
     */
    constructor() { 
        
        DeleteTapeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteTapeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteTapeOutput} obj Optional instance to populate.
     * @return {module:model/DeleteTapeOutput} The populated <code>DeleteTapeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteTapeOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteTapeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteTapeOutput</code>.
     */
 ...
 */
DeleteTapeOutput.prototype['TapeARN'] = undefined;
...
export default DeleteTapeOutput;
