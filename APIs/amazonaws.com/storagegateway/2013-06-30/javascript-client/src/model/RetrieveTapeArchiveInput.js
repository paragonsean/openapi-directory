...
/**
 * The RetrieveTapeArchiveInput model module.
 * @module model/RetrieveTapeArchiveInput
 * @version 2013-06-30
 */
class RetrieveTapeArchiveInput {
    /**
     * Constructs a new <code>RetrieveTapeArchiveInput</code>.
     * RetrieveTapeArchiveInput
     * @alias module:model/RetrieveTapeArchiveInput
     * @param tapeARN {String} 
     * @param gatewayARN {String} 
     */
    constructor(tapeARN, gatewayARN) { 
        
        RetrieveTapeArchiveInput.initialize(this, tapeARN, gatewayARN);
    }
     ...
     */
    static initialize(obj, tapeARN, gatewayARN) { 
        obj['TapeARN'] = tapeARN;
        obj['GatewayARN'] = gatewayARN;
    }

    /**
     * Constructs a <code>RetrieveTapeArchiveInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RetrieveTapeArchiveInput} obj Optional instance to populate.
     * @return {module:model/RetrieveTapeArchiveInput} The populated <code>RetrieveTapeArchiveInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RetrieveTapeArchiveInput();
    ...
    /**
     * Validates the JSON data with respect to <code>RetrieveTapeArchiveInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RetrieveTapeArchiveInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RetrieveTapeArchiveInput.RequiredProperties) {
...
RetrieveTapeArchiveInput.RequiredProperties = ["TapeARN", "GatewayARN"];

/**
 * @member {String} TapeARN
 */
RetrieveTapeArchiveInput.prototype['TapeARN'] = undefined;

/**
 * @member {String} GatewayARN
 */
RetrieveTapeArchiveInput.prototype['GatewayARN'] = undefined;
...
export default RetrieveTapeArchiveInput;
