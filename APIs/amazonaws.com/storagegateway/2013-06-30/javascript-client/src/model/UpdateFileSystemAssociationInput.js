...
/**
 * The UpdateFileSystemAssociationInput model module.
 * @module model/UpdateFileSystemAssociationInput
 * @version 2013-06-30
 */
class UpdateFileSystemAssociationInput {
    /**
     * Constructs a new <code>UpdateFileSystemAssociationInput</code>.
     * @alias module:model/UpdateFileSystemAssociationInput
     * @param fileSystemAssociationARN {String} 
     */
    constructor(fileSystemAssociationARN) { 
        
        UpdateFileSystemAssociationInput.initialize(this, fileSystemAssociationARN);
    }
     ...
     */
    static initialize(obj, fileSystemAssociationARN) { 
        obj['FileSystemAssociationARN'] = fileSystemAssociationARN;
    }

    /**
     * Constructs a <code>UpdateFileSystemAssociationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFileSystemAssociationInput} obj Optional instance to populate.
     * @return {module:model/UpdateFileSystemAssociationInput} The populated <code>UpdateFileSystemAssociationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFileSystemAssociationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFileSystemAssociationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFileSystemAssociationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateFileSystemAssociationInput.RequiredProperties) {
...
UpdateFileSystemAssociationInput.RequiredProperties = ["FileSystemAssociationARN"];

/**
 * @member {String} FileSystemAssociationARN
 */
UpdateFileSystemAssociationInput.prototype['FileSystemAssociationARN'] = undefined;

/**
 * @member {String} UserName
 */
UpdateFileSystemAssociationInput.prototype['UserName'] = undefined;

/**
 * @member {String} Password
 */
UpdateFileSystemAssociationInput.prototype['Password'] = undefined;

/**
 * @member {String} AuditDestinationARN
 */
UpdateFileSystemAssociationInput.prototype['AuditDestinationARN'] = undefined;

/**
 * @member {module:model/CacheAttributes} CacheAttributes
 */
UpdateFileSystemAssociationInput.prototype['CacheAttributes'] = undefined;
...
export default UpdateFileSystemAssociationInput;
