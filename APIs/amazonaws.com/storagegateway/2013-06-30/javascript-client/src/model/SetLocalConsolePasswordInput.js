...
/**
 * The SetLocalConsolePasswordInput model module.
 * @module model/SetLocalConsolePasswordInput
 * @version 2013-06-30
 */
class SetLocalConsolePasswordInput {
    /**
     * Constructs a new <code>SetLocalConsolePasswordInput</code>.
     * SetLocalConsolePasswordInput
     * @alias module:model/SetLocalConsolePasswordInput
     ...
     * @param localConsolePassword {String} 
     */
    constructor(gatewayARN, localConsolePassword) { 
        
        SetLocalConsolePasswordInput.initialize(this, gatewayARN, localConsolePassword);
    }
     ...
     */
    static initialize(obj, gatewayARN, localConsolePassword) { 
        obj['GatewayARN'] = gatewayARN;
        obj['LocalConsolePassword'] = localConsolePassword;
    }

    /**
     * Constructs a <code>SetLocalConsolePasswordInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetLocalConsolePasswordInput} obj Optional instance to populate.
     * @return {module:model/SetLocalConsolePasswordInput} The populated <code>SetLocalConsolePasswordInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetLocalConsolePasswordInput();

            if (data.hasOwnProperty('GatewayARN')) {
                obj['GatewayARN'] = ApiClient.convertToType(data['GatewayARN'], 'String');
            }
            if (data.hasOwnProperty('LocalConsolePassword')) {
                obj['LocalConsolePassword'] = ApiClient.convertToType(data['LocalConsolePassword'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SetLocalConsolePasswordInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetLocalConsolePasswordInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetLocalConsolePasswordInput.RequiredProperties) {
        ...
        // validate the optional field `LocalConsolePassword`
        if (data['LocalConsolePassword']) { // data not null
          String.validateJSON(data['LocalConsolePassword']);
        }
...
SetLocalConsolePasswordInput.RequiredProperties = ["GatewayARN", "LocalConsolePassword"];
 ...
 */
SetLocalConsolePasswordInput.prototype['GatewayARN'] = undefined;

/**
 * @member {String} LocalConsolePassword
 */
SetLocalConsolePasswordInput.prototype['LocalConsolePassword'] = undefined;
...
export default SetLocalConsolePasswordInput;
