...
/**
 * The DeleteBandwidthRateLimitInput model module.
 * @module model/DeleteBandwidthRateLimitInput
 * @version 2013-06-30
 */
class DeleteBandwidthRateLimitInput {
    /**
     * Constructs a new <code>DeleteBandwidthRateLimitInput</code>.
     * &lt;p&gt;A JSON object containing the following fields:&lt;/p&gt; &lt;ul&gt; &lt;li&gt; &lt;p&gt; &lt;a&gt;DeleteBandwidthRateLimitInput$BandwidthType&lt;/a&gt; &lt;/p&gt; &lt;/li&gt; &lt;/ul&gt;
     * @alias module:model/DeleteBandwidthRateLimitInput
     ...
     * @param bandwidthType {String} 
     */
    constructor(gatewayARN, bandwidthType) { 
        
        DeleteBandwidthRateLimitInput.initialize(this, gatewayARN, bandwidthType);
    }
     ...
     */
    static initialize(obj, gatewayARN, bandwidthType) { 
        obj['GatewayARN'] = gatewayARN;
        obj['BandwidthType'] = bandwidthType;
    }

    /**
     * Constructs a <code>DeleteBandwidthRateLimitInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteBandwidthRateLimitInput} obj Optional instance to populate.
     * @return {module:model/DeleteBandwidthRateLimitInput} The populated <code>DeleteBandwidthRateLimitInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteBandwidthRateLimitInput();

            if (data.hasOwnProperty('GatewayARN')) {
                obj['GatewayARN'] = ApiClient.convertToType(data['GatewayARN'], 'String');
            }
            if (data.hasOwnProperty('BandwidthType')) {
                obj['BandwidthType'] = ApiClient.convertToType(data['BandwidthType'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteBandwidthRateLimitInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteBandwidthRateLimitInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteBandwidthRateLimitInput.RequiredProperties) {
        ...
        // validate the optional field `BandwidthType`
        if (data['BandwidthType']) { // data not null
          String.validateJSON(data['BandwidthType']);
        }
...
DeleteBandwidthRateLimitInput.RequiredProperties = ["GatewayARN", "BandwidthType"];
 ...
 */
DeleteBandwidthRateLimitInput.prototype['GatewayARN'] = undefined;

/**
 * @member {String} BandwidthType
 */
DeleteBandwidthRateLimitInput.prototype['BandwidthType'] = undefined;
...
export default DeleteBandwidthRateLimitInput;
