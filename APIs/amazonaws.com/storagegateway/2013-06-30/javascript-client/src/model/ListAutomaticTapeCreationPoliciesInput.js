...
/**
 * The ListAutomaticTapeCreationPoliciesInput model module.
 * @module model/ListAutomaticTapeCreationPoliciesInput
 * @version 2013-06-30
 */
class ListAutomaticTapeCreationPoliciesInput {
    /**
     * Constructs a new <code>ListAutomaticTapeCreationPoliciesInput</code>.
     * @alias module:model/ListAutomaticTapeCreationPoliciesInput
     */
    constructor() { 
        
        ListAutomaticTapeCreationPoliciesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAutomaticTapeCreationPoliciesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAutomaticTapeCreationPoliciesInput} obj Optional instance to populate.
     * @return {module:model/ListAutomaticTapeCreationPoliciesInput} The populated <code>ListAutomaticTapeCreationPoliciesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAutomaticTapeCreationPoliciesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAutomaticTapeCreationPoliciesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAutomaticTapeCreationPoliciesInput</code>.
     */
 ...
 */
ListAutomaticTapeCreationPoliciesInput.prototype['GatewayARN'] = undefined;
...
export default ListAutomaticTapeCreationPoliciesInput;
