...
import RetentionLockType from './RetentionLockType';
import TapeStorageClass from './TapeStorageClass';

/**
 * The CreateTapePoolInput model module.
 * @module model/CreateTapePoolInput
 * @version 2013-06-30
 */
class CreateTapePoolInput {
    /**
     * Constructs a new <code>CreateTapePoolInput</code>.
     * @alias module:model/CreateTapePoolInput
     * @param poolName {String} 
     * @param storageClass {module:model/TapeStorageClass} 
     */
    constructor(poolName, storageClass) { 
        
        CreateTapePoolInput.initialize(this, poolName, storageClass);
    }
     ...
     */
    static initialize(obj, poolName, storageClass) { 
        obj['PoolName'] = poolName;
        obj['StorageClass'] = storageClass;
    }

    /**
     * Constructs a <code>CreateTapePoolInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTapePoolInput} obj Optional instance to populate.
     * @return {module:model/CreateTapePoolInput} The populated <code>CreateTapePoolInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTapePoolInput();
            ...
            if (data.hasOwnProperty('StorageClass')) {
                obj['StorageClass'] = ApiClient.convertToType(data['StorageClass'], TapeStorageClass);
            }
            if (data.hasOwnProperty('RetentionLockType')) {
                obj['RetentionLockType'] = ApiClient.convertToType(data['RetentionLockType'], RetentionLockType);
            }
            if (data.hasOwnProperty('RetentionLockTimeInDays')) {
                obj['RetentionLockTimeInDays'] = ApiClient.convertToType(data['RetentionLockTimeInDays'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTapePoolInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTapePoolInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateTapePoolInput.RequiredProperties) {
        ...
        if (data['StorageClass']) { // data not null
          TapeStorageClass.validateJSON(data['StorageClass']);
        }
        // validate the optional field `RetentionLockType`
        if (data['RetentionLockType']) { // data not null
          RetentionLockType.validateJSON(data['RetentionLockType']);
        }
        // validate the optional field `RetentionLockTimeInDays`
        if (data['RetentionLockTimeInDays']) { // data not null
          Number.validateJSON(data['RetentionLockTimeInDays']);
        }
...
CreateTapePoolInput.RequiredProperties = ["PoolName", "StorageClass"];

/**
 * @member {String} PoolName
 */
CreateTapePoolInput.prototype['PoolName'] = undefined;

/**
 * @member {module:model/TapeStorageClass} StorageClass
 */
CreateTapePoolInput.prototype['StorageClass'] = undefined;

/**
 * @member {module:model/RetentionLockType} RetentionLockType
 */
CreateTapePoolInput.prototype['RetentionLockType'] = undefined;

/**
 * @member {Number} RetentionLockTimeInDays
 */
CreateTapePoolInput.prototype['RetentionLockTimeInDays'] = undefined;

/**
 * @member {Array} Tags
 */
CreateTapePoolInput.prototype['Tags'] = undefined;
...
export default CreateTapePoolInput;
