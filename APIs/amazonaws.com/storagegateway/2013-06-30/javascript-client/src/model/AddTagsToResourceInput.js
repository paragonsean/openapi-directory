...
/**
 * The AddTagsToResourceInput model module.
 * @module model/AddTagsToResourceInput
 * @version 2013-06-30
 */
class AddTagsToResourceInput {
    /**
     * Constructs a new <code>AddTagsToResourceInput</code>.
     * AddTagsToResourceInput
     * @alias module:model/AddTagsToResourceInput
     * @param resourceARN {String} 
     * @param tags {Array} 
     */
    constructor(resourceARN, tags) { 
        
        AddTagsToResourceInput.initialize(this, resourceARN, tags);
    }
    ...
    /**
     * Constructs a <code>AddTagsToResourceInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddTagsToResourceInput} obj Optional instance to populate.
     * @return {module:model/AddTagsToResourceInput} The populated <code>AddTagsToResourceInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddTagsToResourceInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AddTagsToResourceInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddTagsToResourceInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddTagsToResourceInput.RequiredProperties) {
...
AddTagsToResourceInput.RequiredProperties = ["ResourceARN", "Tags"];

/**
 * @member {String} ResourceARN
 */
AddTagsToResourceInput.prototype['ResourceARN'] = undefined;

/**
 * @member {Array} Tags
 */
AddTagsToResourceInput.prototype['Tags'] = undefined;
...
export default AddTagsToResourceInput;
