...
/**
 * The AutomaticTapeCreationPolicyInfo model module.
 * @module model/AutomaticTapeCreationPolicyInfo
 * @version 2013-06-30
 */
class AutomaticTapeCreationPolicyInfo {
    /**
     * Constructs a new <code>AutomaticTapeCreationPolicyInfo</code>.
     * Information about the gateway&#39;s automatic tape creation policies, including the automatic tape creation rules and the gateway that is using the policies.
     * @alias module:model/AutomaticTapeCreationPolicyInfo
     */
    constructor() { 
        
        AutomaticTapeCreationPolicyInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AutomaticTapeCreationPolicyInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AutomaticTapeCreationPolicyInfo} obj Optional instance to populate.
     * @return {module:model/AutomaticTapeCreationPolicyInfo} The populated <code>AutomaticTapeCreationPolicyInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutomaticTapeCreationPolicyInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>AutomaticTapeCreationPolicyInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutomaticTapeCreationPolicyInfo</code>.
     */
 ...
 */
AutomaticTapeCreationPolicyInfo.prototype['AutomaticTapeCreationRules'] = undefined;
 ...
 */
AutomaticTapeCreationPolicyInfo.prototype['GatewayARN'] = undefined;
...
export default AutomaticTapeCreationPolicyInfo;
