...
/**
 * The CreateSnapshotFromVolumeRecoveryPointInput model module.
 * @module model/CreateSnapshotFromVolumeRecoveryPointInput
 * @version 2013-06-30
 */
class CreateSnapshotFromVolumeRecoveryPointInput {
    /**
     * Constructs a new <code>CreateSnapshotFromVolumeRecoveryPointInput</code>.
     * @alias module:model/CreateSnapshotFromVolumeRecoveryPointInput
     * @param volumeARN {String} 
     * @param snapshotDescription {String} 
     */
    constructor(volumeARN, snapshotDescription) { 
        
        CreateSnapshotFromVolumeRecoveryPointInput.initialize(this, volumeARN, snapshotDescription);
    }
     ...
     */
    static initialize(obj, volumeARN, snapshotDescription) { 
        obj['VolumeARN'] = volumeARN;
        obj['SnapshotDescription'] = snapshotDescription;
    }

    /**
     * Constructs a <code>CreateSnapshotFromVolumeRecoveryPointInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSnapshotFromVolumeRecoveryPointInput} obj Optional instance to populate.
     * @return {module:model/CreateSnapshotFromVolumeRecoveryPointInput} The populated <code>CreateSnapshotFromVolumeRecoveryPointInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSnapshotFromVolumeRecoveryPointInput();

            if (data.hasOwnProperty('VolumeARN')) {
                obj['VolumeARN'] = ApiClient.convertToType(data['VolumeARN'], 'String');
            }
            if (data.hasOwnProperty('SnapshotDescription')) {
                obj['SnapshotDescription'] = ApiClient.convertToType(data['SnapshotDescription'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSnapshotFromVolumeRecoveryPointInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSnapshotFromVolumeRecoveryPointInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateSnapshotFromVolumeRecoveryPointInput.RequiredProperties) {
        ...
        // validate the optional field `SnapshotDescription`
        if (data['SnapshotDescription']) { // data not null
          String.validateJSON(data['SnapshotDescription']);
        }
...
CreateSnapshotFromVolumeRecoveryPointInput.RequiredProperties = ["VolumeARN", "SnapshotDescription"];

/**
 * @member {String} VolumeARN
 */
CreateSnapshotFromVolumeRecoveryPointInput.prototype['VolumeARN'] = undefined;

/**
 * @member {String} SnapshotDescription
 */
CreateSnapshotFromVolumeRecoveryPointInput.prototype['SnapshotDescription'] = undefined;

/**
 * @member {Array} Tags
 */
CreateSnapshotFromVolumeRecoveryPointInput.prototype['Tags'] = undefined;
...
export default CreateSnapshotFromVolumeRecoveryPointInput;
