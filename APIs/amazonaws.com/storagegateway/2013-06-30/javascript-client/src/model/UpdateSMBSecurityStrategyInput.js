...
/**
 * The UpdateSMBSecurityStrategyInput model module.
 * @module model/UpdateSMBSecurityStrategyInput
 * @version 2013-06-30
 */
class UpdateSMBSecurityStrategyInput {
    /**
     * Constructs a new <code>UpdateSMBSecurityStrategyInput</code>.
     * @alias module:model/UpdateSMBSecurityStrategyInput
     ...
     * @param sMBSecurityStrategy {module:model/SMBSecurityStrategy} 
     */
    constructor(gatewayARN, sMBSecurityStrategy) { 
        
        UpdateSMBSecurityStrategyInput.initialize(this, gatewayARN, sMBSecurityStrategy);
    }
     ...
     */
    static initialize(obj, gatewayARN, sMBSecurityStrategy) { 
        obj['GatewayARN'] = gatewayARN;
        obj['SMBSecurityStrategy'] = sMBSecurityStrategy;
    }

    /**
     * Constructs a <code>UpdateSMBSecurityStrategyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSMBSecurityStrategyInput} obj Optional instance to populate.
     * @return {module:model/UpdateSMBSecurityStrategyInput} The populated <code>UpdateSMBSecurityStrategyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSMBSecurityStrategyInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSMBSecurityStrategyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSMBSecurityStrategyInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateSMBSecurityStrategyInput.RequiredProperties) {
...
UpdateSMBSecurityStrategyInput.RequiredProperties = ["GatewayARN", "SMBSecurityStrategy"];
 ...
 */
UpdateSMBSecurityStrategyInput.prototype['GatewayARN'] = undefined;

/**
 * @member {module:model/SMBSecurityStrategy} SMBSecurityStrategy
 */
UpdateSMBSecurityStrategyInput.prototype['SMBSecurityStrategy'] = undefined;
...
export default UpdateSMBSecurityStrategyInput;
