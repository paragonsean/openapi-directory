...
/**
 * The ResetCacheOutput model module.
 * @module model/ResetCacheOutput
 * @version 2013-06-30
 */
class ResetCacheOutput {
    /**
     * Constructs a new <code>ResetCacheOutput</code>.
     * @alias module:model/ResetCacheOutput
     */
    constructor() { 
        
        ResetCacheOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResetCacheOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResetCacheOutput} obj Optional instance to populate.
     * @return {module:model/ResetCacheOutput} The populated <code>ResetCacheOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResetCacheOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ResetCacheOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResetCacheOutput</code>.
     */
 ...
 */
ResetCacheOutput.prototype['GatewayARN'] = undefined;
...
export default ResetCacheOutput;
