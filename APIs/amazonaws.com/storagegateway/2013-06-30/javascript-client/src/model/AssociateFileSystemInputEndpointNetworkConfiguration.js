...
import EndpointNetworkConfiguration from './EndpointNetworkConfiguration';

/**
 * The AssociateFileSystemInputEndpointNetworkConfiguration model module.
 * @module model/AssociateFileSystemInputEndpointNetworkConfiguration
 * @version 2013-06-30
 */
class AssociateFileSystemInputEndpointNetworkConfiguration {
    /**
     * Constructs a new <code>AssociateFileSystemInputEndpointNetworkConfiguration</code>.
     * @alias module:model/AssociateFileSystemInputEndpointNetworkConfiguration
     * @implements module:model/EndpointNetworkConfiguration
     */
    constructor() { 
        EndpointNetworkConfiguration.initialize(this);
        AssociateFileSystemInputEndpointNetworkConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociateFileSystemInputEndpointNetworkConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateFileSystemInputEndpointNetworkConfiguration} obj Optional instance to populate.
     * @return {module:model/AssociateFileSystemInputEndpointNetworkConfiguration} The populated <code>AssociateFileSystemInputEndpointNetworkConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateFileSystemInputEndpointNetworkConfiguration();
            EndpointNetworkConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateFileSystemInputEndpointNetworkConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateFileSystemInputEndpointNetworkConfiguration</code>.
     */
 ...
 */
AssociateFileSystemInputEndpointNetworkConfiguration.prototype['IpAddresses'] = undefined;


// Implement EndpointNetworkConfiguration interface:
/**
 * @member {Array} IpAddresses
 */
EndpointNetworkConfiguration.prototype['IpAddresses'] = undefined;




export default AssociateFileSystemInputEndpointNetworkConfiguration;
