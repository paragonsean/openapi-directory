...
import SMBLocalGroups from './SMBLocalGroups';

/**
 * The DescribeSMBSettingsOutputSMBLocalGroups model module.
 * @module model/DescribeSMBSettingsOutputSMBLocalGroups
 * @version 2013-06-30
 */
class DescribeSMBSettingsOutputSMBLocalGroups {
    /**
     * Constructs a new <code>DescribeSMBSettingsOutputSMBLocalGroups</code>.
     * @alias module:model/DescribeSMBSettingsOutputSMBLocalGroups
     * @implements module:model/SMBLocalGroups
     */
    constructor() { 
        SMBLocalGroups.initialize(this);
        DescribeSMBSettingsOutputSMBLocalGroups.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeSMBSettingsOutputSMBLocalGroups</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeSMBSettingsOutputSMBLocalGroups} obj Optional instance to populate.
     * @return {module:model/DescribeSMBSettingsOutputSMBLocalGroups} The populated <code>DescribeSMBSettingsOutputSMBLocalGroups</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeSMBSettingsOutputSMBLocalGroups();
            SMBLocalGroups.constructFromObject(data, obj);

            if (data.hasOwnProperty('GatewayAdmins')) {
                obj['GatewayAdmins'] = ApiClient.convertToType(data['GatewayAdmins'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeSMBSettingsOutputSMBLocalGroups</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeSMBSettingsOutputSMBLocalGroups</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GatewayAdmins`
        if (data['GatewayAdmins']) { // data not null
          Array.validateJSON(data['GatewayAdmins']);
        }
...
/**
 * @member {Array} GatewayAdmins
 */
DescribeSMBSettingsOutputSMBLocalGroups.prototype['GatewayAdmins'] = undefined;


// Implement SMBLocalGroups interface:
/**
 * @member {Array} GatewayAdmins
 */
SMBLocalGroups.prototype['GatewayAdmins'] = undefined;




export default DescribeSMBSettingsOutputSMBLocalGroups;
