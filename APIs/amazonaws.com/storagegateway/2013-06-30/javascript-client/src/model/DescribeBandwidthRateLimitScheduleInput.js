...
/**
 * The DescribeBandwidthRateLimitScheduleInput model module.
 * @module model/DescribeBandwidthRateLimitScheduleInput
 * @version 2013-06-30
 */
class DescribeBandwidthRateLimitScheduleInput {
    /**
     * Constructs a new <code>DescribeBandwidthRateLimitScheduleInput</code>.
     * @alias module:model/DescribeBandwidthRateLimitScheduleInput
    ...
    constructor(gatewayARN) { 
        ...
        DescribeBandwidthRateLimitScheduleInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DescribeBandwidthRateLimitScheduleInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBandwidthRateLimitScheduleInput} obj Optional instance to populate.
     * @return {module:model/DescribeBandwidthRateLimitScheduleInput} The populated <code>DescribeBandwidthRateLimitScheduleInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBandwidthRateLimitScheduleInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBandwidthRateLimitScheduleInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBandwidthRateLimitScheduleInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeBandwidthRateLimitScheduleInput.RequiredProperties) {
...
DescribeBandwidthRateLimitScheduleInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DescribeBandwidthRateLimitScheduleInput.prototype['GatewayARN'] = undefined;
...
export default DescribeBandwidthRateLimitScheduleInput;
