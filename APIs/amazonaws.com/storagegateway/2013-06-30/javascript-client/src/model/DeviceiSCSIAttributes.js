...
/**
 * The DeviceiSCSIAttributes model module.
 * @module model/DeviceiSCSIAttributes
 * @version 2013-06-30
 */
class DeviceiSCSIAttributes {
    /**
     * Constructs a new <code>DeviceiSCSIAttributes</code>.
     * Lists iSCSI information about a VTL device.
     * @alias module:model/DeviceiSCSIAttributes
     */
    constructor() { 
        
        DeviceiSCSIAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeviceiSCSIAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeviceiSCSIAttributes} obj Optional instance to populate.
     * @return {module:model/DeviceiSCSIAttributes} The populated <code>DeviceiSCSIAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeviceiSCSIAttributes();
            ...
            if (data.hasOwnProperty('NetworkInterfacePort')) {
                obj['NetworkInterfacePort'] = ApiClient.convertToType(data['NetworkInterfacePort'], 'Number');
            }
            if (data.hasOwnProperty('ChapEnabled')) {
                obj['ChapEnabled'] = ApiClient.convertToType(data['ChapEnabled'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeviceiSCSIAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeviceiSCSIAttributes</code>.
     */
    static validateJSON(data) {
        ...
        if (data['NetworkInterfacePort']) { // data not null
          Number.validateJSON(data['NetworkInterfacePort']);
        }
        // validate the optional field `ChapEnabled`
        if (data['ChapEnabled']) { // data not null
          Boolean.validateJSON(data['ChapEnabled']);
        }
 ...
 */
DeviceiSCSIAttributes.prototype['TargetARN'] = undefined;

/**
 * @member {String} NetworkInterfaceId
 */
DeviceiSCSIAttributes.prototype['NetworkInterfaceId'] = undefined;

/**
 * @member {Number} NetworkInterfacePort
 */
DeviceiSCSIAttributes.prototype['NetworkInterfacePort'] = undefined;

/**
 * @member {Boolean} ChapEnabled
 */
DeviceiSCSIAttributes.prototype['ChapEnabled'] = undefined;
...
export default DeviceiSCSIAttributes;
