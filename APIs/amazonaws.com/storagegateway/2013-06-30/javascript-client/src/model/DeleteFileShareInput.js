...
/**
 * The DeleteFileShareInput model module.
 * @module model/DeleteFileShareInput
 * @version 2013-06-30
 */
class DeleteFileShareInput {
    /**
     * Constructs a new <code>DeleteFileShareInput</code>.
     * DeleteFileShareInput
     * @alias module:model/DeleteFileShareInput
     * @param fileShareARN {String} 
     */
    constructor(fileShareARN) { 
        
        DeleteFileShareInput.initialize(this, fileShareARN);
    }
    ...
    /**
     * Constructs a <code>DeleteFileShareInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFileShareInput} obj Optional instance to populate.
     * @return {module:model/DeleteFileShareInput} The populated <code>DeleteFileShareInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFileShareInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFileShareInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFileShareInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteFileShareInput.RequiredProperties) {
...
DeleteFileShareInput.RequiredProperties = ["FileShareARN"];

/**
 * @member {String} FileShareARN
 */
DeleteFileShareInput.prototype['FileShareARN'] = undefined;

/**
 * @member {Boolean} ForceDelete
 */
DeleteFileShareInput.prototype['ForceDelete'] = undefined;
...
export default DeleteFileShareInput;
