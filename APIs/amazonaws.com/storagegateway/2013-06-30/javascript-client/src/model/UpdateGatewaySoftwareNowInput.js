...
/**
 * The UpdateGatewaySoftwareNowInput model module.
 * @module model/UpdateGatewaySoftwareNowInput
 * @version 2013-06-30
 */
class UpdateGatewaySoftwareNowInput {
    /**
     * Constructs a new <code>UpdateGatewaySoftwareNowInput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway to update.
     * @alias module:model/UpdateGatewaySoftwareNowInput
    ...
    constructor(gatewayARN) { 
        ...
        UpdateGatewaySoftwareNowInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>UpdateGatewaySoftwareNowInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGatewaySoftwareNowInput} obj Optional instance to populate.
     * @return {module:model/UpdateGatewaySoftwareNowInput} The populated <code>UpdateGatewaySoftwareNowInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGatewaySoftwareNowInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGatewaySoftwareNowInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGatewaySoftwareNowInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateGatewaySoftwareNowInput.RequiredProperties) {
...
UpdateGatewaySoftwareNowInput.RequiredProperties = ["GatewayARN"];
 ...
 */
UpdateGatewaySoftwareNowInput.prototype['GatewayARN'] = undefined;
...
export default UpdateGatewaySoftwareNowInput;
