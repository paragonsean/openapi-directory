...
/**
 * The UpdateBandwidthRateLimitInput model module.
 * @module model/UpdateBandwidthRateLimitInput
 * @version 2013-06-30
 */
class UpdateBandwidthRateLimitInput {
    /**
     * Constructs a new <code>UpdateBandwidthRateLimitInput</code>.
     ...
     * @alias module:model/UpdateBandwidthRateLimitInput
    ...
    constructor(gatewayARN) { 
        ...
        UpdateBandwidthRateLimitInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>UpdateBandwidthRateLimitInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateBandwidthRateLimitInput} obj Optional instance to populate.
     * @return {module:model/UpdateBandwidthRateLimitInput} The populated <code>UpdateBandwidthRateLimitInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateBandwidthRateLimitInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateBandwidthRateLimitInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateBandwidthRateLimitInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateBandwidthRateLimitInput.RequiredProperties) {
...
UpdateBandwidthRateLimitInput.RequiredProperties = ["GatewayARN"];
 ...
 */
UpdateBandwidthRateLimitInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Number} AverageUploadRateLimitInBitsPerSec
 */
UpdateBandwidthRateLimitInput.prototype['AverageUploadRateLimitInBitsPerSec'] = undefined;

/**
 * @member {Number} AverageDownloadRateLimitInBitsPerSec
 */
UpdateBandwidthRateLimitInput.prototype['AverageDownloadRateLimitInBitsPerSec'] = undefined;
...
export default UpdateBandwidthRateLimitInput;
