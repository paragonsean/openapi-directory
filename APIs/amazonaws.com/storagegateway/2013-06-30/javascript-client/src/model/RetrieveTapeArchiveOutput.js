...
/**
 * The RetrieveTapeArchiveOutput model module.
 * @module model/RetrieveTapeArchiveOutput
 * @version 2013-06-30
 */
class RetrieveTapeArchiveOutput {
    /**
     * Constructs a new <code>RetrieveTapeArchiveOutput</code>.
     * RetrieveTapeArchiveOutput
     * @alias module:model/RetrieveTapeArchiveOutput
     */
    constructor() { 
        
        RetrieveTapeArchiveOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RetrieveTapeArchiveOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RetrieveTapeArchiveOutput} obj Optional instance to populate.
     * @return {module:model/RetrieveTapeArchiveOutput} The populated <code>RetrieveTapeArchiveOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RetrieveTapeArchiveOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>RetrieveTapeArchiveOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RetrieveTapeArchiveOutput</code>.
     */
 ...
 */
RetrieveTapeArchiveOutput.prototype['TapeARN'] = undefined;
...
export default RetrieveTapeArchiveOutput;
