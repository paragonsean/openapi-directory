...
/**
 * The CachediSCSIVolume model module.
 * @module model/CachediSCSIVolume
 * @version 2013-06-30
 */
class CachediSCSIVolume {
    /**
     * Constructs a new <code>CachediSCSIVolume</code>.
     * Describes an iSCSI cached volume.
     * @alias module:model/CachediSCSIVolume
     */
    constructor() { 
        
        CachediSCSIVolume.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CachediSCSIVolume</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CachediSCSIVolume} obj Optional instance to populate.
     * @return {module:model/CachediSCSIVolume} The populated <code>CachediSCSIVolume</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CachediSCSIVolume();
    ...
    /**
     * Validates the JSON data with respect to <code>CachediSCSIVolume</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CachediSCSIVolume</code>.
     */
 ...
 */
CachediSCSIVolume.prototype['VolumeARN'] = undefined;

/**
 * @member {String} VolumeId
 */
CachediSCSIVolume.prototype['VolumeId'] = undefined;

/**
 * @member {String} VolumeType
 */
CachediSCSIVolume.prototype['VolumeType'] = undefined;

/**
 * @member {String} VolumeStatus
 */
CachediSCSIVolume.prototype['VolumeStatus'] = undefined;

/**
 * @member {String} VolumeAttachmentStatus
 */
CachediSCSIVolume.prototype['VolumeAttachmentStatus'] = undefined;

/**
 * @member {Number} VolumeSizeInBytes
 */
CachediSCSIVolume.prototype['VolumeSizeInBytes'] = undefined;

/**
 * @member {Number} VolumeProgress
 */
CachediSCSIVolume.prototype['VolumeProgress'] = undefined;

/**
 * @member {String} SourceSnapshotId
 */
CachediSCSIVolume.prototype['SourceSnapshotId'] = undefined;

/**
 * @member {module:model/CachediSCSIVolumeVolumeiSCSIAttributes} VolumeiSCSIAttributes
 */
CachediSCSIVolume.prototype['VolumeiSCSIAttributes'] = undefined;

/**
 * @member {Date} CreatedDate
 */
CachediSCSIVolume.prototype['CreatedDate'] = undefined;

/**
 * @member {Number} VolumeUsedInBytes
 */
CachediSCSIVolume.prototype['VolumeUsedInBytes'] = undefined;
 ...
 */
CachediSCSIVolume.prototype['KMSKey'] = undefined;

/**
 * @member {String} TargetName
 */
CachediSCSIVolume.prototype['TargetName'] = undefined;
...
export default CachediSCSIVolume;
