...
* @readonly
*/
export default class HostEnvironment {
    ...
    /**
    * Returns a <code>HostEnvironment</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/HostEnvironment} The enum <code>HostEnvironment</code> value.
    */
