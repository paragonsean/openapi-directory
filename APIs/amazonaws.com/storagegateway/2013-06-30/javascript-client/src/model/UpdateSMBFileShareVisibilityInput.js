...
/**
 * The UpdateSMBFileShareVisibilityInput model module.
 * @module model/UpdateSMBFileShareVisibilityInput
 * @version 2013-06-30
 */
class UpdateSMBFileShareVisibilityInput {
    /**
     * Constructs a new <code>UpdateSMBFileShareVisibilityInput</code>.
     * @alias module:model/UpdateSMBFileShareVisibilityInput
     ...
     * @param fileSharesVisible {Boolean} 
     */
    constructor(gatewayARN, fileSharesVisible) { 
        
        UpdateSMBFileShareVisibilityInput.initialize(this, gatewayARN, fileSharesVisible);
    }
     ...
     */
    static initialize(obj, gatewayARN, fileSharesVisible) { 
        obj['GatewayARN'] = gatewayARN;
        obj['FileSharesVisible'] = fileSharesVisible;
    }

    /**
     * Constructs a <code>UpdateSMBFileShareVisibilityInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSMBFileShareVisibilityInput} obj Optional instance to populate.
     * @return {module:model/UpdateSMBFileShareVisibilityInput} The populated <code>UpdateSMBFileShareVisibilityInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSMBFileShareVisibilityInput();

            if (data.hasOwnProperty('GatewayARN')) {
                obj['GatewayARN'] = ApiClient.convertToType(data['GatewayARN'], 'String');
            }
            if (data.hasOwnProperty('FileSharesVisible')) {
                obj['FileSharesVisible'] = ApiClient.convertToType(data['FileSharesVisible'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSMBFileShareVisibilityInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSMBFileShareVisibilityInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateSMBFileShareVisibilityInput.RequiredProperties) {
        ...
        if (data['FileSharesVisible']) { // data not null
          Boolean.validateJSON(data['FileSharesVisible']);
        }
...
UpdateSMBFileShareVisibilityInput.RequiredProperties = ["GatewayARN", "FileSharesVisible"];
 ...
 */
UpdateSMBFileShareVisibilityInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Boolean} FileSharesVisible
 */
UpdateSMBFileShareVisibilityInput.prototype['FileSharesVisible'] = undefined;
...
export default UpdateSMBFileShareVisibilityInput;
