...
/**
 * The ListVolumesOutput model module.
 * @module model/ListVolumesOutput
 * @version 2013-06-30
 */
class ListVolumesOutput {
    /**
     * Constructs a new <code>ListVolumesOutput</code>.
     ...
     * @alias module:model/ListVolumesOutput
     */
    constructor() { 
        
        ListVolumesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListVolumesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListVolumesOutput} obj Optional instance to populate.
     * @return {module:model/ListVolumesOutput} The populated <code>ListVolumesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListVolumesOutput();
            ...
            if (data.hasOwnProperty('VolumeInfos')) {
                obj['VolumeInfos'] = ApiClient.convertToType(data['VolumeInfos'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListVolumesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListVolumesOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['VolumeInfos']) { // data not null
          Array.validateJSON(data['VolumeInfos']);
        }
 ...
 */
ListVolumesOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {String} Marker
 */
ListVolumesOutput.prototype['Marker'] = undefined;

/**
 * @member {Array} VolumeInfos
 */
ListVolumesOutput.prototype['VolumeInfos'] = undefined;
...
export default ListVolumesOutput;
