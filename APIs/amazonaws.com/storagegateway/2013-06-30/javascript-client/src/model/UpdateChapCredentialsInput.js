...
/**
 * The UpdateChapCredentialsInput model module.
 * @module model/UpdateChapCredentialsInput
 * @version 2013-06-30
 */
class UpdateChapCredentialsInput {
    /**
     * Constructs a new <code>UpdateChapCredentialsInput</code>.
     ...
     * @alias module:model/UpdateChapCredentialsInput
     * @param targetARN {String} 
     * @param secretToAuthenticateInitiator {String} 
     * @param initiatorName {String} 
     */
    constructor(targetARN, secretToAuthenticateInitiator, initiatorName) { 
        
        UpdateChapCredentialsInput.initialize(this, targetARN, secretToAuthenticateInitiator, initiatorName);
    }
     ...
     */
    static initialize(obj, targetARN, secretToAuthenticateInitiator, initiatorName) { 
        obj['TargetARN'] = targetARN;
        obj['SecretToAuthenticateInitiator'] = secretToAuthenticateInitiator;
        obj['InitiatorName'] = initiatorName;
    }

    /**
     * Constructs a <code>UpdateChapCredentialsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateChapCredentialsInput} obj Optional instance to populate.
     * @return {module:model/UpdateChapCredentialsInput} The populated <code>UpdateChapCredentialsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateChapCredentialsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateChapCredentialsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateChapCredentialsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateChapCredentialsInput.RequiredProperties) {
...
UpdateChapCredentialsInput.RequiredProperties = ["TargetARN", "SecretToAuthenticateInitiator", "InitiatorName"];

/**
 * @member {String} TargetARN
 */
UpdateChapCredentialsInput.prototype['TargetARN'] = undefined;

/**
 * @member {String} SecretToAuthenticateInitiator
 */
UpdateChapCredentialsInput.prototype['SecretToAuthenticateInitiator'] = undefined;

/**
 * @member {String} InitiatorName
 */
UpdateChapCredentialsInput.prototype['InitiatorName'] = undefined;

/**
 * @member {String} SecretToAuthenticateTarget
 */
UpdateChapCredentialsInput.prototype['SecretToAuthenticateTarget'] = undefined;
...
export default UpdateChapCredentialsInput;
