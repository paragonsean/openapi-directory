...
/**
 * The ResetCacheInput model module.
 * @module model/ResetCacheInput
 * @version 2013-06-30
 */
class ResetCacheInput {
    /**
     * Constructs a new <code>ResetCacheInput</code>.
     * @alias module:model/ResetCacheInput
    ...
    constructor(gatewayARN) { 
        ...
        ResetCacheInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>ResetCacheInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResetCacheInput} obj Optional instance to populate.
     * @return {module:model/ResetCacheInput} The populated <code>ResetCacheInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResetCacheInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ResetCacheInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResetCacheInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ResetCacheInput.RequiredProperties) {
...
ResetCacheInput.RequiredProperties = ["GatewayARN"];
 ...
 */
ResetCacheInput.prototype['GatewayARN'] = undefined;
...
export default ResetCacheInput;
