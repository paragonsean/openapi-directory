...
/**
 * The CancelArchivalInput model module.
 * @module model/CancelArchivalInput
 * @version 2013-06-30
 */
class CancelArchivalInput {
    /**
     * Constructs a new <code>CancelArchivalInput</code>.
     * CancelArchivalInput
     * @alias module:model/CancelArchivalInput
    ...
    constructor(gatewayARN, tapeARN) { 
        ...
        CancelArchivalInput.initialize(this, gatewayARN, tapeARN);
    }
    ...
    /**
     * Constructs a <code>CancelArchivalInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelArchivalInput} obj Optional instance to populate.
     * @return {module:model/CancelArchivalInput} The populated <code>CancelArchivalInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelArchivalInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelArchivalInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelArchivalInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CancelArchivalInput.RequiredProperties) {
...
CancelArchivalInput.RequiredProperties = ["GatewayARN", "TapeARN"];
 ...
 */
CancelArchivalInput.prototype['GatewayARN'] = undefined;

/**
 * @member {String} TapeARN
 */
CancelArchivalInput.prototype['TapeARN'] = undefined;
...
export default CancelArchivalInput;
