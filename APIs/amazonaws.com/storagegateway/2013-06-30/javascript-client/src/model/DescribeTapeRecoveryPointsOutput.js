...
/**
 * The DescribeTapeRecoveryPointsOutput model module.
 * @module model/DescribeTapeRecoveryPointsOutput
 * @version 2013-06-30
 */
class DescribeTapeRecoveryPointsOutput {
    /**
     * Constructs a new <code>DescribeTapeRecoveryPointsOutput</code>.
     * DescribeTapeRecoveryPointsOutput
     * @alias module:model/DescribeTapeRecoveryPointsOutput
     */
    constructor() { 
        
        DescribeTapeRecoveryPointsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeTapeRecoveryPointsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTapeRecoveryPointsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeTapeRecoveryPointsOutput} The populated <code>DescribeTapeRecoveryPointsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTapeRecoveryPointsOutput();

            if (data.hasOwnProperty('GatewayARN')) {
                obj['GatewayARN'] = ApiClient.convertToType(data['GatewayARN'], 'String');
            }
            if (data.hasOwnProperty('TapeRecoveryPointInfos')) {
                obj['TapeRecoveryPointInfos'] = ApiClient.convertToType(data['TapeRecoveryPointInfos'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTapeRecoveryPointsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTapeRecoveryPointsOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['TapeRecoveryPointInfos']) { // data not null
          Array.validateJSON(data['TapeRecoveryPointInfos']);
        }
 ...
 */
DescribeTapeRecoveryPointsOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {Array} TapeRecoveryPointInfos
 */
DescribeTapeRecoveryPointsOutput.prototype['TapeRecoveryPointInfos'] = undefined;

/**
 * @member {String} Marker
 */
DescribeTapeRecoveryPointsOutput.prototype['Marker'] = undefined;
...
export default DescribeTapeRecoveryPointsOutput;
