...
/**
 * The NFSFileShareInfoCacheAttributes model module.
 * @module model/NFSFileShareInfoCacheAttributes
 * @version 2013-06-30
 */
class NFSFileShareInfoCacheAttributes {
    /**
     * Constructs a new <code>NFSFileShareInfoCacheAttributes</code>.
     * @alias module:model/NFSFileShareInfoCacheAttributes
     * @implements module:model/CacheAttributes
     */
    constructor() { 
        CacheAttributes.initialize(this);
        NFSFileShareInfoCacheAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NFSFileShareInfoCacheAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NFSFileShareInfoCacheAttributes} obj Optional instance to populate.
     * @return {module:model/NFSFileShareInfoCacheAttributes} The populated <code>NFSFileShareInfoCacheAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NFSFileShareInfoCacheAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>NFSFileShareInfoCacheAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NFSFileShareInfoCacheAttributes</code>.
     */
 ...
 */
NFSFileShareInfoCacheAttributes.prototype['CacheStaleTimeoutInSeconds'] = undefined;
...
export default NFSFileShareInfoCacheAttributes;
