...
/**
 * The CreateTapeWithBarcodeOutput model module.
 * @module model/CreateTapeWithBarcodeOutput
 * @version 2013-06-30
 */
class CreateTapeWithBarcodeOutput {
    /**
     * Constructs a new <code>CreateTapeWithBarcodeOutput</code>.
     * CreateTapeOutput
     * @alias module:model/CreateTapeWithBarcodeOutput
     */
    constructor() { 
        
        CreateTapeWithBarcodeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateTapeWithBarcodeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTapeWithBarcodeOutput} obj Optional instance to populate.
     * @return {module:model/CreateTapeWithBarcodeOutput} The populated <code>CreateTapeWithBarcodeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTapeWithBarcodeOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTapeWithBarcodeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTapeWithBarcodeOutput</code>.
     */
 ...
 */
CreateTapeWithBarcodeOutput.prototype['TapeARN'] = undefined;
...
export default CreateTapeWithBarcodeOutput;
