...
* @readonly
*/
export default class TapeStorageClass {
    ...
    /**
    * Returns a <code>TapeStorageClass</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TapeStorageClass} The enum <code>TapeStorageClass</code> value.
    */
