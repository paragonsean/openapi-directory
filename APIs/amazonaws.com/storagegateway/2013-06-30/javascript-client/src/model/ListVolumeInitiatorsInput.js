...
/**
 * The ListVolumeInitiatorsInput model module.
 * @module model/ListVolumeInitiatorsInput
 * @version 2013-06-30
 */
class ListVolumeInitiatorsInput {
    /**
     * Constructs a new <code>ListVolumeInitiatorsInput</code>.
     * ListVolumeInitiatorsInput
     * @alias module:model/ListVolumeInitiatorsInput
     * @param volumeARN {String} 
     */
    constructor(volumeARN) { 
        
        ListVolumeInitiatorsInput.initialize(this, volumeARN);
    }
    ...
    /**
     * Constructs a <code>ListVolumeInitiatorsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListVolumeInitiatorsInput} obj Optional instance to populate.
     * @return {module:model/ListVolumeInitiatorsInput} The populated <code>ListVolumeInitiatorsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListVolumeInitiatorsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListVolumeInitiatorsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListVolumeInitiatorsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListVolumeInitiatorsInput.RequiredProperties) {
...
ListVolumeInitiatorsInput.RequiredProperties = ["VolumeARN"];

/**
 * @member {String} VolumeARN
 */
ListVolumeInitiatorsInput.prototype['VolumeARN'] = undefined;
...
export default ListVolumeInitiatorsInput;
