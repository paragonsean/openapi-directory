...
/**
 * The DescribeTapeRecoveryPointsInput model module.
 * @module model/DescribeTapeRecoveryPointsInput
 * @version 2013-06-30
 */
class DescribeTapeRecoveryPointsInput {
    /**
     * Constructs a new <code>DescribeTapeRecoveryPointsInput</code>.
     * DescribeTapeRecoveryPointsInput
     * @alias module:model/DescribeTapeRecoveryPointsInput
    ...
    constructor(gatewayARN) { 
        ...
        DescribeTapeRecoveryPointsInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DescribeTapeRecoveryPointsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTapeRecoveryPointsInput} obj Optional instance to populate.
     * @return {module:model/DescribeTapeRecoveryPointsInput} The populated <code>DescribeTapeRecoveryPointsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTapeRecoveryPointsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTapeRecoveryPointsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTapeRecoveryPointsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeTapeRecoveryPointsInput.RequiredProperties) {
...
DescribeTapeRecoveryPointsInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DescribeTapeRecoveryPointsInput.prototype['GatewayARN'] = undefined;

/**
 * @member {String} Marker
 */
DescribeTapeRecoveryPointsInput.prototype['Marker'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeTapeRecoveryPointsInput.prototype['Limit'] = undefined;
...
export default DescribeTapeRecoveryPointsInput;
