...
/**
 * The DeleteTapePoolInput model module.
 * @module model/DeleteTapePoolInput
 * @version 2013-06-30
 */
class DeleteTapePoolInput {
    /**
     * Constructs a new <code>DeleteTapePoolInput</code>.
     * @alias module:model/DeleteTapePoolInput
     * @param poolARN {String} 
     */
    constructor(poolARN) { 
        
        DeleteTapePoolInput.initialize(this, poolARN);
    }
     ...
     */
    static initialize(obj, poolARN) { 
        obj['PoolARN'] = poolARN;
    }

    /**
     * Constructs a <code>DeleteTapePoolInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteTapePoolInput} obj Optional instance to populate.
     * @return {module:model/DeleteTapePoolInput} The populated <code>DeleteTapePoolInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteTapePoolInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteTapePoolInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteTapePoolInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteTapePoolInput.RequiredProperties) {
...
DeleteTapePoolInput.RequiredProperties = ["PoolARN"];

/**
 * @member {String} PoolARN
 */
DeleteTapePoolInput.prototype['PoolARN'] = undefined;
...
export default DeleteTapePoolInput;
