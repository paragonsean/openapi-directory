...
import VolumeiSCSIAttributes from './VolumeiSCSIAttributes';

/**
 * The CachediSCSIVolumeVolumeiSCSIAttributes model module.
 * @module model/CachediSCSIVolumeVolumeiSCSIAttributes
 * @version 2013-06-30
 */
class CachediSCSIVolumeVolumeiSCSIAttributes {
    /**
     * Constructs a new <code>CachediSCSIVolumeVolumeiSCSIAttributes</code>.
     * @alias module:model/CachediSCSIVolumeVolumeiSCSIAttributes
     * @implements module:model/VolumeiSCSIAttributes
     */
    constructor() { 
        VolumeiSCSIAttributes.initialize(this);
        CachediSCSIVolumeVolumeiSCSIAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CachediSCSIVolumeVolumeiSCSIAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CachediSCSIVolumeVolumeiSCSIAttributes} obj Optional instance to populate.
     * @return {module:model/CachediSCSIVolumeVolumeiSCSIAttributes} The populated <code>CachediSCSIVolumeVolumeiSCSIAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CachediSCSIVolumeVolumeiSCSIAttributes();
            VolumeiSCSIAttributes.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('LunNumber')) {
                obj['LunNumber'] = ApiClient.convertToType(data['LunNumber'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CachediSCSIVolumeVolumeiSCSIAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CachediSCSIVolumeVolumeiSCSIAttributes</code>.
     */
    static validateJSON(data) {
        ...
        if (data['LunNumber']) { // data not null
          Number.validateJSON(data['LunNumber']);
        }
 ...
 */
CachediSCSIVolumeVolumeiSCSIAttributes.prototype['TargetARN'] = undefined;

/**
 * @member {String} NetworkInterfaceId
 */
CachediSCSIVolumeVolumeiSCSIAttributes.prototype['NetworkInterfaceId'] = undefined;

/**
 * @member {Number} NetworkInterfacePort
 */
CachediSCSIVolumeVolumeiSCSIAttributes.prototype['NetworkInterfacePort'] = undefined;

/**
 * @member {Number} LunNumber
 */
CachediSCSIVolumeVolumeiSCSIAttributes.prototype['LunNumber'] = undefined;

/**
 * @member {Boolean} ChapEnabled
 */
CachediSCSIVolumeVolumeiSCSIAttributes.prototype['ChapEnabled'] = undefined;


// Implement VolumeiSCSIAttributes interface:
/**
 * @member {String} TargetARN
 */
VolumeiSCSIAttributes.prototype['TargetARN'] = undefined;
/**
 * @member {String} NetworkInterfaceId
 */
VolumeiSCSIAttributes.prototype['NetworkInterfaceId'] = undefined;
/**
 * @member {Number} NetworkInterfacePort
 */
VolumeiSCSIAttributes.prototype['NetworkInterfacePort'] = undefined;
/**
 * @member {Number} LunNumber
 */
VolumeiSCSIAttributes.prototype['LunNumber'] = undefined;
/**
 * @member {Boolean} ChapEnabled
 */
VolumeiSCSIAttributes.prototype['ChapEnabled'] = undefined;




export default CachediSCSIVolumeVolumeiSCSIAttributes;
