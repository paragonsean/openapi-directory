...
* @readonly
*/
export default class CaseSensitivity {
    ...
    /**
    * Returns a <code>CaseSensitivity</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CaseSensitivity} The enum <code>CaseSensitivity</code> value.
    */
