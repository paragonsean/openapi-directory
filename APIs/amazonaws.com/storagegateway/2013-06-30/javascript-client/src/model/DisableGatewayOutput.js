...
/**
 * The DisableGatewayOutput model module.
 * @module model/DisableGatewayOutput
 * @version 2013-06-30
 */
class DisableGatewayOutput {
    /**
     * Constructs a new <code>DisableGatewayOutput</code>.
     * DisableGatewayOutput
     * @alias module:model/DisableGatewayOutput
     */
    constructor() { 
        
        DisableGatewayOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisableGatewayOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisableGatewayOutput} obj Optional instance to populate.
     * @return {module:model/DisableGatewayOutput} The populated <code>DisableGatewayOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisableGatewayOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DisableGatewayOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisableGatewayOutput</code>.
     */
 ...
 */
DisableGatewayOutput.prototype['GatewayARN'] = undefined;
...
export default DisableGatewayOutput;
