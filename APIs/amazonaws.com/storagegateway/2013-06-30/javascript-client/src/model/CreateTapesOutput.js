...
/**
 * The CreateTapesOutput model module.
 * @module model/CreateTapesOutput
 * @version 2013-06-30
 */
class CreateTapesOutput {
    /**
     * Constructs a new <code>CreateTapesOutput</code>.
     * CreateTapeOutput
     * @alias module:model/CreateTapesOutput
     */
    constructor() { 
        
        CreateTapesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateTapesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTapesOutput} obj Optional instance to populate.
     * @return {module:model/CreateTapesOutput} The populated <code>CreateTapesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTapesOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTapesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTapesOutput</code>.
     */
 ...
 */
CreateTapesOutput.prototype['TapeARNs'] = undefined;
...
export default CreateTapesOutput;
