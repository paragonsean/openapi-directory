...
/**
 * The FileSystemAssociationSummary model module.
 * @module model/FileSystemAssociationSummary
 * @version 2013-06-30
 */
class FileSystemAssociationSummary {
    /**
     * Constructs a new <code>FileSystemAssociationSummary</code>.
     * Gets the summary returned by &lt;code&gt;ListFileSystemAssociation&lt;/code&gt;, which is a summary of a created file system association.
     * @alias module:model/FileSystemAssociationSummary
     */
    constructor() { 
        
        FileSystemAssociationSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FileSystemAssociationSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileSystemAssociationSummary} obj Optional instance to populate.
     * @return {module:model/FileSystemAssociationSummary} The populated <code>FileSystemAssociationSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileSystemAssociationSummary();

            if (data.hasOwnProperty('FileSystemAssociationId')) {
                obj['FileSystemAssociationId'] = ApiClient.convertToType(data['FileSystemAssociationId'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FileSystemAssociationSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileSystemAssociationSummary</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FileSystemAssociationId`
        if (data['FileSystemAssociationId']) { // data not null
          String.validateJSON(data['FileSystemAssociationId']);
        }
...
/**
 * @member {String} FileSystemAssociationId
 */
FileSystemAssociationSummary.prototype['FileSystemAssociationId'] = undefined;

/**
 * @member {String} FileSystemAssociationARN
 */
FileSystemAssociationSummary.prototype['FileSystemAssociationARN'] = undefined;

/**
 * @member {String} FileSystemAssociationStatus
 */
FileSystemAssociationSummary.prototype['FileSystemAssociationStatus'] = undefined;
 ...
 */
FileSystemAssociationSummary.prototype['GatewayARN'] = undefined;
...
export default FileSystemAssociationSummary;
