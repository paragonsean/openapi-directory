...
/**
 * The DescribeWorkingStorageInput model module.
 * @module model/DescribeWorkingStorageInput
 * @version 2013-06-30
 */
class DescribeWorkingStorageInput {
    /**
     * Constructs a new <code>DescribeWorkingStorageInput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway.
     * @alias module:model/DescribeWorkingStorageInput
    ...
    constructor(gatewayARN) { 
        ...
        DescribeWorkingStorageInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DescribeWorkingStorageInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeWorkingStorageInput} obj Optional instance to populate.
     * @return {module:model/DescribeWorkingStorageInput} The populated <code>DescribeWorkingStorageInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeWorkingStorageInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeWorkingStorageInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeWorkingStorageInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeWorkingStorageInput.RequiredProperties) {
...
DescribeWorkingStorageInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DescribeWorkingStorageInput.prototype['GatewayARN'] = undefined;
...
export default DescribeWorkingStorageInput;
