...
/**
 * The UpdateAutomaticTapeCreationPolicyInput model module.
 * @module model/UpdateAutomaticTapeCreationPolicyInput
 * @version 2013-06-30
 */
class UpdateAutomaticTapeCreationPolicyInput {
    /**
     * Constructs a new <code>UpdateAutomaticTapeCreationPolicyInput</code>.
     * @alias module:model/UpdateAutomaticTapeCreationPolicyInput
     * @param automaticTapeCreationRules {Array} 
     ...
     */
    constructor(automaticTapeCreationRules, gatewayARN) { 
        
        UpdateAutomaticTapeCreationPolicyInput.initialize(this, automaticTapeCreationRules, gatewayARN);
    }
     ...
     */
    static initialize(obj, automaticTapeCreationRules, gatewayARN) { 
        obj['AutomaticTapeCreationRules'] = automaticTapeCreationRules;
        obj['GatewayARN'] = gatewayARN;
    }

    /**
     * Constructs a <code>UpdateAutomaticTapeCreationPolicyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAutomaticTapeCreationPolicyInput} obj Optional instance to populate.
     * @return {module:model/UpdateAutomaticTapeCreationPolicyInput} The populated <code>UpdateAutomaticTapeCreationPolicyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAutomaticTapeCreationPolicyInput();

            if (data.hasOwnProperty('AutomaticTapeCreationRules')) {
                obj['AutomaticTapeCreationRules'] = ApiClient.convertToType(data['AutomaticTapeCreationRules'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAutomaticTapeCreationPolicyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAutomaticTapeCreationPolicyInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateAutomaticTapeCreationPolicyInput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `AutomaticTapeCreationRules`
        if (data['AutomaticTapeCreationRules']) { // data not null
          Array.validateJSON(data['AutomaticTapeCreationRules']);
        }
...
UpdateAutomaticTapeCreationPolicyInput.RequiredProperties = ["AutomaticTapeCreationRules", "GatewayARN"];

/**
 * @member {Array} AutomaticTapeCreationRules
 */
UpdateAutomaticTapeCreationPolicyInput.prototype['AutomaticTapeCreationRules'] = undefined;
 ...
 */
UpdateAutomaticTapeCreationPolicyInput.prototype['GatewayARN'] = undefined;
...
export default UpdateAutomaticTapeCreationPolicyInput;
