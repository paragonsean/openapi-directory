...
import DeviceiSCSIAttributes from './DeviceiSCSIAttributes';

/**
 * The VTLDeviceDeviceiSCSIAttributes model module.
 * @module model/VTLDeviceDeviceiSCSIAttributes
 * @version 2013-06-30
 */
class VTLDeviceDeviceiSCSIAttributes {
    /**
     * Constructs a new <code>VTLDeviceDeviceiSCSIAttributes</code>.
     * @alias module:model/VTLDeviceDeviceiSCSIAttributes
     * @implements module:model/DeviceiSCSIAttributes
     */
    constructor() { 
        DeviceiSCSIAttributes.initialize(this);
        VTLDeviceDeviceiSCSIAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VTLDeviceDeviceiSCSIAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VTLDeviceDeviceiSCSIAttributes} obj Optional instance to populate.
     * @return {module:model/VTLDeviceDeviceiSCSIAttributes} The populated <code>VTLDeviceDeviceiSCSIAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VTLDeviceDeviceiSCSIAttributes();
            DeviceiSCSIAttributes.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>VTLDeviceDeviceiSCSIAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VTLDeviceDeviceiSCSIAttributes</code>.
     */
 ...
 */
VTLDeviceDeviceiSCSIAttributes.prototype['TargetARN'] = undefined;

/**
 * @member {String} NetworkInterfaceId
 */
VTLDeviceDeviceiSCSIAttributes.prototype['NetworkInterfaceId'] = undefined;

/**
 * @member {Number} NetworkInterfacePort
 */
VTLDeviceDeviceiSCSIAttributes.prototype['NetworkInterfacePort'] = undefined;

/**
 * @member {Boolean} ChapEnabled
 */
VTLDeviceDeviceiSCSIAttributes.prototype['ChapEnabled'] = undefined;


// Implement DeviceiSCSIAttributes interface:
/**
 * @member {String} TargetARN
 */
...
export default VTLDeviceDeviceiSCSIAttributes;
