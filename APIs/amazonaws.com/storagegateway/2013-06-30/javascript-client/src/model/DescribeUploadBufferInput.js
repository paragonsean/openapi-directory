...
/**
 * The DescribeUploadBufferInput model module.
 * @module model/DescribeUploadBufferInput
 * @version 2013-06-30
 */
class DescribeUploadBufferInput {
    /**
     * Constructs a new <code>DescribeUploadBufferInput</code>.
     * @alias module:model/DescribeUploadBufferInput
    ...
    constructor(gatewayARN) { 
        ...
        DescribeUploadBufferInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DescribeUploadBufferInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeUploadBufferInput} obj Optional instance to populate.
     * @return {module:model/DescribeUploadBufferInput} The populated <code>DescribeUploadBufferInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeUploadBufferInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeUploadBufferInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeUploadBufferInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeUploadBufferInput.RequiredProperties) {
...
DescribeUploadBufferInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DescribeUploadBufferInput.prototype['GatewayARN'] = undefined;
...
export default DescribeUploadBufferInput;
