...
/**
 * The RemoveTagsFromResourceOutput model module.
 * @module model/RemoveTagsFromResourceOutput
 * @version 2013-06-30
 */
class RemoveTagsFromResourceOutput {
    /**
     * Constructs a new <code>RemoveTagsFromResourceOutput</code>.
     * RemoveTagsFromResourceOutput
     * @alias module:model/RemoveTagsFromResourceOutput
     */
    constructor() { 
        
        RemoveTagsFromResourceOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemoveTagsFromResourceOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveTagsFromResourceOutput} obj Optional instance to populate.
     * @return {module:model/RemoveTagsFromResourceOutput} The populated <code>RemoveTagsFromResourceOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveTagsFromResourceOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveTagsFromResourceOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveTagsFromResourceOutput</code>.
     */
 ...
 */
RemoveTagsFromResourceOutput.prototype['ResourceARN'] = undefined;
...
export default RemoveTagsFromResourceOutput;
