...
/**
 * The AttachVolumeInput model module.
 * @module model/AttachVolumeInput
 * @version 2013-06-30
 */
class AttachVolumeInput {
    /**
     * Constructs a new <code>AttachVolumeInput</code>.
     * AttachVolumeInput
     * @alias module:model/AttachVolumeInput
     * @param gatewayARN {String} 
     * @param volumeARN {String} 
     * @param networkInterfaceId {String} 
     */
    constructor(gatewayARN, volumeARN, networkInterfaceId) { 
        
        AttachVolumeInput.initialize(this, gatewayARN, volumeARN, networkInterfaceId);
    }
     ...
     */
    static initialize(obj, gatewayARN, volumeARN, networkInterfaceId) { 
        obj['GatewayARN'] = gatewayARN;
        obj['VolumeARN'] = volumeARN;
        obj['NetworkInterfaceId'] = networkInterfaceId;
    }

    /**
     * Constructs a <code>AttachVolumeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttachVolumeInput} obj Optional instance to populate.
     * @return {module:model/AttachVolumeInput} The populated <code>AttachVolumeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttachVolumeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AttachVolumeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttachVolumeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AttachVolumeInput.RequiredProperties) {
        ...
        if (data['DiskId']) { // data not null
          String.validateJSON(data['DiskId']);
        }
...
AttachVolumeInput.RequiredProperties = ["GatewayARN", "VolumeARN", "NetworkInterfaceId"];

/**
 * @member {String} GatewayARN
 */
AttachVolumeInput.prototype['GatewayARN'] = undefined;

/**
 * @member {String} TargetName
 */
AttachVolumeInput.prototype['TargetName'] = undefined;

/**
 * @member {String} VolumeARN
 */
AttachVolumeInput.prototype['VolumeARN'] = undefined;

/**
 * @member {String} NetworkInterfaceId
 */
AttachVolumeInput.prototype['NetworkInterfaceId'] = undefined;

/**
 * @member {String} DiskId
 */
AttachVolumeInput.prototype['DiskId'] = undefined;
...
export default AttachVolumeInput;
