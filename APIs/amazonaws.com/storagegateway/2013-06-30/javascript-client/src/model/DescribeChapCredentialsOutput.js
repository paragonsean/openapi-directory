...
/**
 * The DescribeChapCredentialsOutput model module.
 * @module model/DescribeChapCredentialsOutput
 * @version 2013-06-30
 */
class DescribeChapCredentialsOutput {
    /**
     * Constructs a new <code>DescribeChapCredentialsOutput</code>.
     * A JSON object containing the following fields:
     * @alias module:model/DescribeChapCredentialsOutput
     */
    constructor() { 
        
        DescribeChapCredentialsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeChapCredentialsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeChapCredentialsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeChapCredentialsOutput} The populated <code>DescribeChapCredentialsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeChapCredentialsOutput();

            if (data.hasOwnProperty('ChapCredentials')) {
                obj['ChapCredentials'] = ApiClient.convertToType(data['ChapCredentials'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeChapCredentialsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeChapCredentialsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ChapCredentials`
        if (data['ChapCredentials']) { // data not null
          Array.validateJSON(data['ChapCredentials']);
        }
...
/**
 * @member {Array} ChapCredentials
 */
DescribeChapCredentialsOutput.prototype['ChapCredentials'] = undefined;
...
export default DescribeChapCredentialsOutput;
