...
/**
 * The UpdateBandwidthRateLimitScheduleOutput model module.
 * @module model/UpdateBandwidthRateLimitScheduleOutput
 * @version 2013-06-30
 */
class UpdateBandwidthRateLimitScheduleOutput {
    /**
     * Constructs a new <code>UpdateBandwidthRateLimitScheduleOutput</code>.
     * @alias module:model/UpdateBandwidthRateLimitScheduleOutput
     */
    constructor() { 
        
        UpdateBandwidthRateLimitScheduleOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateBandwidthRateLimitScheduleOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateBandwidthRateLimitScheduleOutput} obj Optional instance to populate.
     * @return {module:model/UpdateBandwidthRateLimitScheduleOutput} The populated <code>UpdateBandwidthRateLimitScheduleOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateBandwidthRateLimitScheduleOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateBandwidthRateLimitScheduleOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateBandwidthRateLimitScheduleOutput</code>.
     */
 ...
 */
UpdateBandwidthRateLimitScheduleOutput.prototype['GatewayARN'] = undefined;
...
export default UpdateBandwidthRateLimitScheduleOutput;
