...
/**
 * The SMBLocalGroups model module.
 * @module model/SMBLocalGroups
 * @version 2013-06-30
 */
class SMBLocalGroups {
    /**
     * Constructs a new <code>SMBLocalGroups</code>.
     * A list of Active Directory users and groups that have special permissions for SMB file shares on the gateway.
     * @alias module:model/SMBLocalGroups
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SMBLocalGroups</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SMBLocalGroups} obj Optional instance to populate.
     * @return {module:model/SMBLocalGroups} The populated <code>SMBLocalGroups</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SMBLocalGroups();
    ...
    /**
     * Validates the JSON data with respect to <code>SMBLocalGroups</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SMBLocalGroups</code>.
     */
