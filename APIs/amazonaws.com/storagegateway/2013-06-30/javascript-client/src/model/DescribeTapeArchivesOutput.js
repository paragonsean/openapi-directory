...
/**
 * The DescribeTapeArchivesOutput model module.
 * @module model/DescribeTapeArchivesOutput
 * @version 2013-06-30
 */
class DescribeTapeArchivesOutput {
    /**
     * Constructs a new <code>DescribeTapeArchivesOutput</code>.
     * DescribeTapeArchivesOutput
     * @alias module:model/DescribeTapeArchivesOutput
     */
    constructor() { 
        
        DescribeTapeArchivesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeTapeArchivesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTapeArchivesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeTapeArchivesOutput} The populated <code>DescribeTapeArchivesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTapeArchivesOutput();

            if (data.hasOwnProperty('TapeArchives')) {
                obj['TapeArchives'] = ApiClient.convertToType(data['TapeArchives'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTapeArchivesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTapeArchivesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `TapeArchives`
        if (data['TapeArchives']) { // data not null
          Array.validateJSON(data['TapeArchives']);
        }
...
/**
 * @member {Array} TapeArchives
 */
DescribeTapeArchivesOutput.prototype['TapeArchives'] = undefined;

/**
 * @member {String} Marker
 */
DescribeTapeArchivesOutput.prototype['Marker'] = undefined;
...
export default DescribeTapeArchivesOutput;
