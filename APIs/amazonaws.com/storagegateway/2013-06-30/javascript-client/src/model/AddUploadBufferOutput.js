...
/**
 * The AddUploadBufferOutput model module.
 * @module model/AddUploadBufferOutput
 * @version 2013-06-30
 */
class AddUploadBufferOutput {
    /**
     * Constructs a new <code>AddUploadBufferOutput</code>.
     * @alias module:model/AddUploadBufferOutput
     */
    constructor() { 
        
        AddUploadBufferOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddUploadBufferOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddUploadBufferOutput} obj Optional instance to populate.
     * @return {module:model/AddUploadBufferOutput} The populated <code>AddUploadBufferOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddUploadBufferOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>AddUploadBufferOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddUploadBufferOutput</code>.
     */
 ...
 */
AddUploadBufferOutput.prototype['GatewayARN'] = undefined;
...
export default AddUploadBufferOutput;
