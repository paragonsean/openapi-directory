...
/**
 * The DescribeNFSFileSharesOutput model module.
 * @module model/DescribeNFSFileSharesOutput
 * @version 2013-06-30
 */
class DescribeNFSFileSharesOutput {
    /**
     * Constructs a new <code>DescribeNFSFileSharesOutput</code>.
     * DescribeNFSFileSharesOutput
     * @alias module:model/DescribeNFSFileSharesOutput
     */
    constructor() { 
        
        DescribeNFSFileSharesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeNFSFileSharesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeNFSFileSharesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeNFSFileSharesOutput} The populated <code>DescribeNFSFileSharesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeNFSFileSharesOutput();

            if (data.hasOwnProperty('NFSFileShareInfoList')) {
                obj['NFSFileShareInfoList'] = ApiClient.convertToType(data['NFSFileShareInfoList'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeNFSFileSharesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeNFSFileSharesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `NFSFileShareInfoList`
        if (data['NFSFileShareInfoList']) { // data not null
          Array.validateJSON(data['NFSFileShareInfoList']);
        }
...
/**
 * @member {Array} NFSFileShareInfoList
 */
DescribeNFSFileSharesOutput.prototype['NFSFileShareInfoList'] = undefined;
...
export default DescribeNFSFileSharesOutput;
