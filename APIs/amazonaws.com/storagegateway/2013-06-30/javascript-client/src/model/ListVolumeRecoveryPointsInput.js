...
/**
 * The ListVolumeRecoveryPointsInput model module.
 * @module model/ListVolumeRecoveryPointsInput
 * @version 2013-06-30
 */
class ListVolumeRecoveryPointsInput {
    /**
     * Constructs a new <code>ListVolumeRecoveryPointsInput</code>.
     * @alias module:model/ListVolumeRecoveryPointsInput
    ...
    constructor(gatewayARN) { 
        ...
        ListVolumeRecoveryPointsInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>ListVolumeRecoveryPointsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListVolumeRecoveryPointsInput} obj Optional instance to populate.
     * @return {module:model/ListVolumeRecoveryPointsInput} The populated <code>ListVolumeRecoveryPointsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListVolumeRecoveryPointsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListVolumeRecoveryPointsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListVolumeRecoveryPointsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListVolumeRecoveryPointsInput.RequiredProperties) {
...
ListVolumeRecoveryPointsInput.RequiredProperties = ["GatewayARN"];
 ...
 */
ListVolumeRecoveryPointsInput.prototype['GatewayARN'] = undefined;
...
export default ListVolumeRecoveryPointsInput;
