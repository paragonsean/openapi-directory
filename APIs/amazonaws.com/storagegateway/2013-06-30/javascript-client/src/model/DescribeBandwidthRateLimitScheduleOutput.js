...
/**
 * The DescribeBandwidthRateLimitScheduleOutput model module.
 * @module model/DescribeBandwidthRateLimitScheduleOutput
 * @version 2013-06-30
 */
class DescribeBandwidthRateLimitScheduleOutput {
    /**
     * Constructs a new <code>DescribeBandwidthRateLimitScheduleOutput</code>.
     * @alias module:model/DescribeBandwidthRateLimitScheduleOutput
     */
    constructor() { 
        
        DescribeBandwidthRateLimitScheduleOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeBandwidthRateLimitScheduleOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBandwidthRateLimitScheduleOutput} obj Optional instance to populate.
     * @return {module:model/DescribeBandwidthRateLimitScheduleOutput} The populated <code>DescribeBandwidthRateLimitScheduleOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBandwidthRateLimitScheduleOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBandwidthRateLimitScheduleOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBandwidthRateLimitScheduleOutput</code>.
     */
 ...
 */
DescribeBandwidthRateLimitScheduleOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {Array} BandwidthRateLimitIntervals
 */
DescribeBandwidthRateLimitScheduleOutput.prototype['BandwidthRateLimitIntervals'] = undefined;
...
export default DescribeBandwidthRateLimitScheduleOutput;
