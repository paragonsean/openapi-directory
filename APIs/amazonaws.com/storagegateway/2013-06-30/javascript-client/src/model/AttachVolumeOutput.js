...
/**
 * The AttachVolumeOutput model module.
 * @module model/AttachVolumeOutput
 * @version 2013-06-30
 */
class AttachVolumeOutput {
    /**
     * Constructs a new <code>AttachVolumeOutput</code>.
     * AttachVolumeOutput
     * @alias module:model/AttachVolumeOutput
     */
    constructor() { 
        
        AttachVolumeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AttachVolumeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttachVolumeOutput} obj Optional instance to populate.
     * @return {module:model/AttachVolumeOutput} The populated <code>AttachVolumeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttachVolumeOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>AttachVolumeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttachVolumeOutput</code>.
     */
 ...
 */
AttachVolumeOutput.prototype['VolumeARN'] = undefined;

/**
 * @member {String} TargetARN
 */
AttachVolumeOutput.prototype['TargetARN'] = undefined;
...
export default AttachVolumeOutput;
