...
/**
 * The UpdateFileSystemAssociationOutput model module.
 * @module model/UpdateFileSystemAssociationOutput
 * @version 2013-06-30
 */
class UpdateFileSystemAssociationOutput {
    /**
     * Constructs a new <code>UpdateFileSystemAssociationOutput</code>.
     * @alias module:model/UpdateFileSystemAssociationOutput
     */
    constructor() { 
        
        UpdateFileSystemAssociationOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFileSystemAssociationOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFileSystemAssociationOutput} obj Optional instance to populate.
     * @return {module:model/UpdateFileSystemAssociationOutput} The populated <code>UpdateFileSystemAssociationOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFileSystemAssociationOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFileSystemAssociationOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFileSystemAssociationOutput</code>.
     */
 ...
 */
UpdateFileSystemAssociationOutput.prototype['FileSystemAssociationARN'] = undefined;
...
export default UpdateFileSystemAssociationOutput;
