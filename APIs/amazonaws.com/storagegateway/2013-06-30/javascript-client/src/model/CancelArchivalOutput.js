...
/**
 * The CancelArchivalOutput model module.
 * @module model/CancelArchivalOutput
 * @version 2013-06-30
 */
class CancelArchivalOutput {
    /**
     * Constructs a new <code>CancelArchivalOutput</code>.
     * CancelArchivalOutput
     * @alias module:model/CancelArchivalOutput
     */
    constructor() { 
        
        CancelArchivalOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CancelArchivalOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelArchivalOutput} obj Optional instance to populate.
     * @return {module:model/CancelArchivalOutput} The populated <code>CancelArchivalOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelArchivalOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelArchivalOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelArchivalOutput</code>.
     */
 ...
 */
CancelArchivalOutput.prototype['TapeARN'] = undefined;
...
export default CancelArchivalOutput;
