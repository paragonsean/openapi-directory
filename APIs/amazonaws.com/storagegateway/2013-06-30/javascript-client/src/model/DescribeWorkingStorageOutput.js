...
/**
 * The DescribeWorkingStorageOutput model module.
 * @module model/DescribeWorkingStorageOutput
 * @version 2013-06-30
 */
class DescribeWorkingStorageOutput {
    /**
     * Constructs a new <code>DescribeWorkingStorageOutput</code>.
     * A JSON object containing the following fields:
     * @alias module:model/DescribeWorkingStorageOutput
     */
    constructor() { 
        
        DescribeWorkingStorageOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeWorkingStorageOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeWorkingStorageOutput} obj Optional instance to populate.
     * @return {module:model/DescribeWorkingStorageOutput} The populated <code>DescribeWorkingStorageOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeWorkingStorageOutput();

            if (data.hasOwnProperty('GatewayARN')) {
                obj['GatewayARN'] = ApiClient.convertToType(data['GatewayARN'], 'String');
            }
            if (data.hasOwnProperty('DiskIds')) {
                obj['DiskIds'] = ApiClient.convertToType(data['DiskIds'], Array);
            }
            if (data.hasOwnProperty('WorkingStorageUsedInBytes')) {
                obj['WorkingStorageUsedInBytes'] = ApiClient.convertToType(data['WorkingStorageUsedInBytes'], 'Number');
            }
            if (data.hasOwnProperty('WorkingStorageAllocatedInBytes')) {
                obj['WorkingStorageAllocatedInBytes'] = ApiClient.convertToType(data['WorkingStorageAllocatedInBytes'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeWorkingStorageOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeWorkingStorageOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['DiskIds']) { // data not null
          Array.validateJSON(data['DiskIds']);
        }
        // validate the optional field `WorkingStorageUsedInBytes`
        if (data['WorkingStorageUsedInBytes']) { // data not null
          Number.validateJSON(data['WorkingStorageUsedInBytes']);
        }
        // validate the optional field `WorkingStorageAllocatedInBytes`
        if (data['WorkingStorageAllocatedInBytes']) { // data not null
          Number.validateJSON(data['WorkingStorageAllocatedInBytes']);
        }
 ...
 */
DescribeWorkingStorageOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {Array} DiskIds
 */
DescribeWorkingStorageOutput.prototype['DiskIds'] = undefined;

/**
 * @member {Number} WorkingStorageUsedInBytes
 */
DescribeWorkingStorageOutput.prototype['WorkingStorageUsedInBytes'] = undefined;

/**
 * @member {Number} WorkingStorageAllocatedInBytes
 */
DescribeWorkingStorageOutput.prototype['WorkingStorageAllocatedInBytes'] = undefined;
...
export default DescribeWorkingStorageOutput;
