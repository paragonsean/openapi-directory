...
/**
 * The DeleteVolumeOutput model module.
 * @module model/DeleteVolumeOutput
 * @version 2013-06-30
 */
class DeleteVolumeOutput {
    /**
     * Constructs a new <code>DeleteVolumeOutput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the storage volume that was deleted.
     * @alias module:model/DeleteVolumeOutput
     */
    constructor() { 
        
        DeleteVolumeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteVolumeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteVolumeOutput} obj Optional instance to populate.
     * @return {module:model/DeleteVolumeOutput} The populated <code>DeleteVolumeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteVolumeOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteVolumeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteVolumeOutput</code>.
     */
 ...
 */
DeleteVolumeOutput.prototype['VolumeARN'] = undefined;
...
export default DeleteVolumeOutput;
