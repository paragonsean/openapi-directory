...
/**
 * The ListTapesInput model module.
 * @module model/ListTapesInput
 * @version 2013-06-30
 */
class ListTapesInput {
    /**
     * Constructs a new <code>ListTapesInput</code>.
     ...
     * @alias module:model/ListTapesInput
     */
    constructor() { 
        
        ListTapesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListTapesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTapesInput} obj Optional instance to populate.
     * @return {module:model/ListTapesInput} The populated <code>ListTapesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTapesInput();

            if (data.hasOwnProperty('TapeARNs')) {
                obj['TapeARNs'] = ApiClient.convertToType(data['TapeARNs'], ['String']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListTapesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTapesInput</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['TapeARNs'])) {
            throw new Error("Expected the field `TapeARNs` to be an array in the JSON data but got " + data['TapeARNs']);
        }
 ...
 * @member {Array.<String>} TapeARNs
 */
ListTapesInput.prototype['TapeARNs'] = undefined;

/**
 * @member {String} Marker
 */
ListTapesInput.prototype['Marker'] = undefined;

/**
 * @member {Number} Limit
 */
ListTapesInput.prototype['Limit'] = undefined;
