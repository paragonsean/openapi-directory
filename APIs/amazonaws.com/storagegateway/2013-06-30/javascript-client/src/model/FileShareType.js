...
* @readonly
*/
export default class FileShareType {
    ...
    /**
    * Returns a <code>FileShareType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FileShareType} The enum <code>FileShareType</code> value.
    */
