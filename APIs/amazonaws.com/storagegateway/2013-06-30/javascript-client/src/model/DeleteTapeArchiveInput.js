...
/**
 * The DeleteTapeArchiveInput model module.
 * @module model/DeleteTapeArchiveInput
 * @version 2013-06-30
 */
class DeleteTapeArchiveInput {
    /**
     * Constructs a new <code>DeleteTapeArchiveInput</code>.
     * DeleteTapeArchiveInput
     * @alias module:model/DeleteTapeArchiveInput
     * @param tapeARN {String} 
     */
    constructor(tapeARN) { 
        
        DeleteTapeArchiveInput.initialize(this, tapeARN);
    }
     ...
     */
    static initialize(obj, tapeARN) { 
        obj['TapeARN'] = tapeARN;
    }

    /**
     * Constructs a <code>DeleteTapeArchiveInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteTapeArchiveInput} obj Optional instance to populate.
     * @return {module:model/DeleteTapeArchiveInput} The populated <code>DeleteTapeArchiveInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteTapeArchiveInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteTapeArchiveInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteTapeArchiveInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteTapeArchiveInput.RequiredProperties) {
...
DeleteTapeArchiveInput.RequiredProperties = ["TapeARN"];

/**
 * @member {String} TapeARN
 */
DeleteTapeArchiveInput.prototype['TapeARN'] = undefined;

/**
 * @member {Boolean} BypassGovernanceRetention
 */
DeleteTapeArchiveInput.prototype['BypassGovernanceRetention'] = undefined;
...
export default DeleteTapeArchiveInput;
