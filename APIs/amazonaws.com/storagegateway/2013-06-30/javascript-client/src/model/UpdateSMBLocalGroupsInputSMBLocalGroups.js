...
/**
 * The UpdateSMBLocalGroupsInputSMBLocalGroups model module.
 * @module model/UpdateSMBLocalGroupsInputSMBLocalGroups
 * @version 2013-06-30
 */
class UpdateSMBLocalGroupsInputSMBLocalGroups {
    /**
     * Constructs a new <code>UpdateSMBLocalGroupsInputSMBLocalGroups</code>.
     * @alias module:model/UpdateSMBLocalGroupsInputSMBLocalGroups
     * @implements module:model/SMBLocalGroups
     */
    constructor() { 
        SMBLocalGroups.initialize(this);
        UpdateSMBLocalGroupsInputSMBLocalGroups.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSMBLocalGroupsInputSMBLocalGroups</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSMBLocalGroupsInputSMBLocalGroups} obj Optional instance to populate.
     * @return {module:model/UpdateSMBLocalGroupsInputSMBLocalGroups} The populated <code>UpdateSMBLocalGroupsInputSMBLocalGroups</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSMBLocalGroupsInputSMBLocalGroups();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSMBLocalGroupsInputSMBLocalGroups</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSMBLocalGroupsInputSMBLocalGroups</code>.
     */
 ...
 */
UpdateSMBLocalGroupsInputSMBLocalGroups.prototype['GatewayAdmins'] = undefined;
...
export default UpdateSMBLocalGroupsInputSMBLocalGroups;
