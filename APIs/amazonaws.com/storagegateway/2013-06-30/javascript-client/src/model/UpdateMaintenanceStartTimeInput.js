...
/**
 * The UpdateMaintenanceStartTimeInput model module.
 * @module model/UpdateMaintenanceStartTimeInput
 * @version 2013-06-30
 */
class UpdateMaintenanceStartTimeInput {
    /**
     * Constructs a new <code>UpdateMaintenanceStartTimeInput</code>.
     ...
     * @alias module:model/UpdateMaintenanceStartTimeInput
     ...
     */
    constructor(gatewayARN, hourOfDay, minuteOfHour) { 
        
        UpdateMaintenanceStartTimeInput.initialize(this, gatewayARN, hourOfDay, minuteOfHour);
    }
     ...
     */
    static initialize(obj, gatewayARN, hourOfDay, minuteOfHour) { 
    ...
    /**
     * Constructs a <code>UpdateMaintenanceStartTimeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateMaintenanceStartTimeInput} obj Optional instance to populate.
     * @return {module:model/UpdateMaintenanceStartTimeInput} The populated <code>UpdateMaintenanceStartTimeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateMaintenanceStartTimeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateMaintenanceStartTimeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateMaintenanceStartTimeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateMaintenanceStartTimeInput.RequiredProperties) {
...
UpdateMaintenanceStartTimeInput.RequiredProperties = ["GatewayARN", "HourOfDay", "MinuteOfHour"];
 ...
 */
UpdateMaintenanceStartTimeInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Number} HourOfDay
 */
UpdateMaintenanceStartTimeInput.prototype['HourOfDay'] = undefined;

/**
 * @member {Number} MinuteOfHour
 */
UpdateMaintenanceStartTimeInput.prototype['MinuteOfHour'] = undefined;

/**
 * @member {Number} DayOfWeek
 */
UpdateMaintenanceStartTimeInput.prototype['DayOfWeek'] = undefined;

/**
 * @member {Number} DayOfMonth
 */
UpdateMaintenanceStartTimeInput.prototype['DayOfMonth'] = undefined;
...
export default UpdateMaintenanceStartTimeInput;
