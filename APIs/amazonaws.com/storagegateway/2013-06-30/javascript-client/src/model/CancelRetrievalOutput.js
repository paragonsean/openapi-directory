...
/**
 * The CancelRetrievalOutput model module.
 * @module model/CancelRetrievalOutput
 * @version 2013-06-30
 */
class CancelRetrievalOutput {
    /**
     * Constructs a new <code>CancelRetrievalOutput</code>.
     * CancelRetrievalOutput
     * @alias module:model/CancelRetrievalOutput
     */
    constructor() { 
        
        CancelRetrievalOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CancelRetrievalOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelRetrievalOutput} obj Optional instance to populate.
     * @return {module:model/CancelRetrievalOutput} The populated <code>CancelRetrievalOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelRetrievalOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelRetrievalOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelRetrievalOutput</code>.
     */
 ...
 */
CancelRetrievalOutput.prototype['TapeARN'] = undefined;
...
export default CancelRetrievalOutput;
