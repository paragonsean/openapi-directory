...
/**
 * The UpdateMaintenanceStartTimeOutput model module.
 * @module model/UpdateMaintenanceStartTimeOutput
 * @version 2013-06-30
 */
class UpdateMaintenanceStartTimeOutput {
    /**
     * Constructs a new <code>UpdateMaintenanceStartTimeOutput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway whose maintenance start time is updated.
     * @alias module:model/UpdateMaintenanceStartTimeOutput
     */
    constructor() { 
        
        UpdateMaintenanceStartTimeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateMaintenanceStartTimeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateMaintenanceStartTimeOutput} obj Optional instance to populate.
     * @return {module:model/UpdateMaintenanceStartTimeOutput} The populated <code>UpdateMaintenanceStartTimeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateMaintenanceStartTimeOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateMaintenanceStartTimeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateMaintenanceStartTimeOutput</code>.
     */
 ...
 */
UpdateMaintenanceStartTimeOutput.prototype['GatewayARN'] = undefined;
...
export default UpdateMaintenanceStartTimeOutput;
