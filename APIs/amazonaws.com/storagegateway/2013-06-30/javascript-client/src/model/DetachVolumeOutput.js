...
/**
 * The DetachVolumeOutput model module.
 * @module model/DetachVolumeOutput
 * @version 2013-06-30
 */
class DetachVolumeOutput {
    /**
     * Constructs a new <code>DetachVolumeOutput</code>.
     * AttachVolumeOutput
     * @alias module:model/DetachVolumeOutput
     */
    constructor() { 
        
        DetachVolumeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetachVolumeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetachVolumeOutput} obj Optional instance to populate.
     * @return {module:model/DetachVolumeOutput} The populated <code>DetachVolumeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetachVolumeOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DetachVolumeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetachVolumeOutput</code>.
     */
 ...
 */
DetachVolumeOutput.prototype['VolumeARN'] = undefined;
...
export default DetachVolumeOutput;
