...
/**
 * The DeleteSnapshotScheduleInput model module.
 * @module model/DeleteSnapshotScheduleInput
 * @version 2013-06-30
 */
class DeleteSnapshotScheduleInput {
    /**
     * Constructs a new <code>DeleteSnapshotScheduleInput</code>.
     * @alias module:model/DeleteSnapshotScheduleInput
     * @param volumeARN {String} 
     */
    constructor(volumeARN) { 
        
        DeleteSnapshotScheduleInput.initialize(this, volumeARN);
    }
    ...
    /**
     * Constructs a <code>DeleteSnapshotScheduleInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteSnapshotScheduleInput} obj Optional instance to populate.
     * @return {module:model/DeleteSnapshotScheduleInput} The populated <code>DeleteSnapshotScheduleInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteSnapshotScheduleInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteSnapshotScheduleInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteSnapshotScheduleInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteSnapshotScheduleInput.RequiredProperties) {
...
DeleteSnapshotScheduleInput.RequiredProperties = ["VolumeARN"];

/**
 * @member {String} VolumeARN
 */
DeleteSnapshotScheduleInput.prototype['VolumeARN'] = undefined;
...
export default DeleteSnapshotScheduleInput;
