...
/**
 * The FileSystemAssociationInfoEndpointNetworkConfiguration model module.
 * @module model/FileSystemAssociationInfoEndpointNetworkConfiguration
 * @version 2013-06-30
 */
class FileSystemAssociationInfoEndpointNetworkConfiguration {
    /**
     * Constructs a new <code>FileSystemAssociationInfoEndpointNetworkConfiguration</code>.
     * @alias module:model/FileSystemAssociationInfoEndpointNetworkConfiguration
     * @implements module:model/EndpointNetworkConfiguration
     */
    constructor() { 
        EndpointNetworkConfiguration.initialize(this);
        FileSystemAssociationInfoEndpointNetworkConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FileSystemAssociationInfoEndpointNetworkConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileSystemAssociationInfoEndpointNetworkConfiguration} obj Optional instance to populate.
     * @return {module:model/FileSystemAssociationInfoEndpointNetworkConfiguration} The populated <code>FileSystemAssociationInfoEndpointNetworkConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileSystemAssociationInfoEndpointNetworkConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>FileSystemAssociationInfoEndpointNetworkConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileSystemAssociationInfoEndpointNetworkConfiguration</code>.
     */
 ...
 */
FileSystemAssociationInfoEndpointNetworkConfiguration.prototype['IpAddresses'] = undefined;
...
export default FileSystemAssociationInfoEndpointNetworkConfiguration;
