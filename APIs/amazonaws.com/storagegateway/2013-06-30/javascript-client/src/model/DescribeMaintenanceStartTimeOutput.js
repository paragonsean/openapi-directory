...
/**
 * The DescribeMaintenanceStartTimeOutput model module.
 * @module model/DescribeMaintenanceStartTimeOutput
 * @version 2013-06-30
 */
class DescribeMaintenanceStartTimeOutput {
    /**
     * Constructs a new <code>DescribeMaintenanceStartTimeOutput</code>.
     ...
     * @alias module:model/DescribeMaintenanceStartTimeOutput
     */
    constructor() { 
        
        DescribeMaintenanceStartTimeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeMaintenanceStartTimeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMaintenanceStartTimeOutput} obj Optional instance to populate.
     * @return {module:model/DescribeMaintenanceStartTimeOutput} The populated <code>DescribeMaintenanceStartTimeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMaintenanceStartTimeOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMaintenanceStartTimeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMaintenanceStartTimeOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['DayOfWeek']) { // data not null
          Number.validateJSON(data['DayOfWeek']);
        }
 ...
 */
DescribeMaintenanceStartTimeOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {Number} HourOfDay
 */
DescribeMaintenanceStartTimeOutput.prototype['HourOfDay'] = undefined;

/**
 * @member {Number} MinuteOfHour
 */
DescribeMaintenanceStartTimeOutput.prototype['MinuteOfHour'] = undefined;

/**
 * @member {Number} DayOfWeek
 */
DescribeMaintenanceStartTimeOutput.prototype['DayOfWeek'] = undefined;

/**
 * @member {Number} DayOfMonth
 */
DescribeMaintenanceStartTimeOutput.prototype['DayOfMonth'] = undefined;

/**
 * @member {String} Timezone
 */
DescribeMaintenanceStartTimeOutput.prototype['Timezone'] = undefined;
...
export default DescribeMaintenanceStartTimeOutput;
