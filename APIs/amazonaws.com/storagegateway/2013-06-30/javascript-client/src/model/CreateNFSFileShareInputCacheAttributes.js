...
/**
 * The CreateNFSFileShareInputCacheAttributes model module.
 * @module model/CreateNFSFileShareInputCacheAttributes
 * @version 2013-06-30
 */
class CreateNFSFileShareInputCacheAttributes {
    /**
     * Constructs a new <code>CreateNFSFileShareInputCacheAttributes</code>.
     * @alias module:model/CreateNFSFileShareInputCacheAttributes
     * @implements module:model/CacheAttributes
     */
    constructor() { 
        CacheAttributes.initialize(this);
        CreateNFSFileShareInputCacheAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateNFSFileShareInputCacheAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateNFSFileShareInputCacheAttributes} obj Optional instance to populate.
     * @return {module:model/CreateNFSFileShareInputCacheAttributes} The populated <code>CreateNFSFileShareInputCacheAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateNFSFileShareInputCacheAttributes();
            CacheAttributes.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateNFSFileShareInputCacheAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateNFSFileShareInputCacheAttributes</code>.
     */
 ...
 */
CreateNFSFileShareInputCacheAttributes.prototype['CacheStaleTimeoutInSeconds'] = undefined;


// Implement CacheAttributes interface:
/**
 * @member {Number} CacheStaleTimeoutInSeconds
 */
...
export default CreateNFSFileShareInputCacheAttributes;
