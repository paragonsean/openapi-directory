...
/**
 * The UpdateVTLDeviceTypeOutput model module.
 * @module model/UpdateVTLDeviceTypeOutput
 * @version 2013-06-30
 */
class UpdateVTLDeviceTypeOutput {
    /**
     * Constructs a new <code>UpdateVTLDeviceTypeOutput</code>.
     * UpdateVTLDeviceTypeOutput
     * @alias module:model/UpdateVTLDeviceTypeOutput
     */
    constructor() { 
        
        UpdateVTLDeviceTypeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateVTLDeviceTypeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateVTLDeviceTypeOutput} obj Optional instance to populate.
     * @return {module:model/UpdateVTLDeviceTypeOutput} The populated <code>UpdateVTLDeviceTypeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateVTLDeviceTypeOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateVTLDeviceTypeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateVTLDeviceTypeOutput</code>.
     */
 ...
 */
UpdateVTLDeviceTypeOutput.prototype['VTLDeviceARN'] = undefined;
...
export default UpdateVTLDeviceTypeOutput;
