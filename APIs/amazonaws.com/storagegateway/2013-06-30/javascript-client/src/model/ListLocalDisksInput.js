...
/**
 * The ListLocalDisksInput model module.
 * @module model/ListLocalDisksInput
 * @version 2013-06-30
 */
class ListLocalDisksInput {
    /**
     * Constructs a new <code>ListLocalDisksInput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway.
     * @alias module:model/ListLocalDisksInput
    ...
    constructor(gatewayARN) { 
        ...
        ListLocalDisksInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>ListLocalDisksInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListLocalDisksInput} obj Optional instance to populate.
     * @return {module:model/ListLocalDisksInput} The populated <code>ListLocalDisksInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListLocalDisksInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListLocalDisksInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLocalDisksInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListLocalDisksInput.RequiredProperties) {
...
ListLocalDisksInput.RequiredProperties = ["GatewayARN"];
 ...
 */
ListLocalDisksInput.prototype['GatewayARN'] = undefined;
...
export default ListLocalDisksInput;
