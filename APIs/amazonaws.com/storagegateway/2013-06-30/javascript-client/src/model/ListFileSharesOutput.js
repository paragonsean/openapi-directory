...
/**
 * The ListFileSharesOutput model module.
 * @module model/ListFileSharesOutput
 * @version 2013-06-30
 */
class ListFileSharesOutput {
    /**
     * Constructs a new <code>ListFileSharesOutput</code>.
     * ListFileShareOutput
     * @alias module:model/ListFileSharesOutput
     */
    constructor() { 
        
        ListFileSharesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFileSharesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFileSharesOutput} obj Optional instance to populate.
     * @return {module:model/ListFileSharesOutput} The populated <code>ListFileSharesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFileSharesOutput();
            ...
            if (data.hasOwnProperty('FileShareInfoList')) {
                obj['FileShareInfoList'] = ApiClient.convertToType(data['FileShareInfoList'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListFileSharesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFileSharesOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['FileShareInfoList']) { // data not null
          Array.validateJSON(data['FileShareInfoList']);
        }
 ...
 */
ListFileSharesOutput.prototype['Marker'] = undefined;

/**
 * @member {String} NextMarker
 */
ListFileSharesOutput.prototype['NextMarker'] = undefined;

/**
 * @member {Array} FileShareInfoList
 */
ListFileSharesOutput.prototype['FileShareInfoList'] = undefined;
...
export default ListFileSharesOutput;
