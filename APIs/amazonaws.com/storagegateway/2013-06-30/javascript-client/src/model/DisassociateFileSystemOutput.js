...
/**
 * The DisassociateFileSystemOutput model module.
 * @module model/DisassociateFileSystemOutput
 * @version 2013-06-30
 */
class DisassociateFileSystemOutput {
    /**
     * Constructs a new <code>DisassociateFileSystemOutput</code>.
     * @alias module:model/DisassociateFileSystemOutput
     */
    constructor() { 
        
        DisassociateFileSystemOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisassociateFileSystemOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateFileSystemOutput} obj Optional instance to populate.
     * @return {module:model/DisassociateFileSystemOutput} The populated <code>DisassociateFileSystemOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateFileSystemOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateFileSystemOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateFileSystemOutput</code>.
     */
 ...
 */
DisassociateFileSystemOutput.prototype['FileSystemAssociationARN'] = undefined;
...
export default DisassociateFileSystemOutput;
