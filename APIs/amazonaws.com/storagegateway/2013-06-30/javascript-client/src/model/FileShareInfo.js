...
import FileShareType from './FileShareType';

/**
 * The FileShareInfo model module.
 * @module model/FileShareInfo
 * @version 2013-06-30
 */
class FileShareInfo {
    /**
     * Constructs a new <code>FileShareInfo</code>.
     * Describes a file share. Only supported S3 File Gateway.
     * @alias module:model/FileShareInfo
     */
    constructor() { 
        
        FileShareInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FileShareInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileShareInfo} obj Optional instance to populate.
     * @return {module:model/FileShareInfo} The populated <code>FileShareInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileShareInfo();

            if (data.hasOwnProperty('FileShareType')) {
                obj['FileShareType'] = FileShareType.constructFromObject(data['FileShareType']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FileShareInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileShareInfo</code>.
     */
...
/**
 * @member {module:model/FileShareType} FileShareType
 */
FileShareInfo.prototype['FileShareType'] = undefined;

/**
 * The Amazon Resource Name (ARN) of the file share.
 * @member {String} FileShareARN
 */
FileShareInfo.prototype['FileShareARN'] = undefined;

/**
 * The ID of the file share.
 * @member {String} FileShareId
 */
FileShareInfo.prototype['FileShareId'] = undefined;
 ...
 */
FileShareInfo.prototype['FileShareStatus'] = undefined;
 ...
 */
FileShareInfo.prototype['GatewayARN'] = undefined;
