...
/**
 * The AddWorkingStorageInput model module.
 * @module model/AddWorkingStorageInput
 * @version 2013-06-30
 */
class AddWorkingStorageInput {
    /**
     * Constructs a new <code>AddWorkingStorageInput</code>.
     * &lt;p&gt;A JSON object containing one or more of the following fields:&lt;/p&gt; &lt;ul&gt; &lt;li&gt; &lt;p&gt; &lt;a&gt;AddWorkingStorageInput$DiskIds&lt;/a&gt; &lt;/p&gt; &lt;/li&gt; &lt;/ul&gt;
     * @alias module:model/AddWorkingStorageInput
    ...
    constructor(gatewayARN, diskIds) { 
        ...
        AddWorkingStorageInput.initialize(this, gatewayARN, diskIds);
    }
    ...
    /**
     * Constructs a <code>AddWorkingStorageInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddWorkingStorageInput} obj Optional instance to populate.
     * @return {module:model/AddWorkingStorageInput} The populated <code>AddWorkingStorageInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddWorkingStorageInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AddWorkingStorageInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddWorkingStorageInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddWorkingStorageInput.RequiredProperties) {
...
AddWorkingStorageInput.RequiredProperties = ["GatewayARN", "DiskIds"];
 ...
 */
AddWorkingStorageInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Array} DiskIds
 */
AddWorkingStorageInput.prototype['DiskIds'] = undefined;
...
export default AddWorkingStorageInput;
