...
/**
 * The NotifyWhenUploadedInput model module.
 * @module model/NotifyWhenUploadedInput
 * @version 2013-06-30
 */
class NotifyWhenUploadedInput {
    /**
     * Constructs a new <code>NotifyWhenUploadedInput</code>.
     * @alias module:model/NotifyWhenUploadedInput
     * @param fileShareARN {String} The Amazon Resource Name (ARN) of the file share.
     */
    constructor(fileShareARN) { 
        
        NotifyWhenUploadedInput.initialize(this, fileShareARN);
    }
    ...
    /**
     * Constructs a <code>NotifyWhenUploadedInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NotifyWhenUploadedInput} obj Optional instance to populate.
     * @return {module:model/NotifyWhenUploadedInput} The populated <code>NotifyWhenUploadedInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NotifyWhenUploadedInput();
    ...
    /**
     * Validates the JSON data with respect to <code>NotifyWhenUploadedInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotifyWhenUploadedInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NotifyWhenUploadedInput.RequiredProperties) {
...
NotifyWhenUploadedInput.RequiredProperties = ["FileShareARN"];

/**
 * The Amazon Resource Name (ARN) of the file share.
 * @member {String} FileShareARN
 */
NotifyWhenUploadedInput.prototype['FileShareARN'] = undefined;
...
export default NotifyWhenUploadedInput;
