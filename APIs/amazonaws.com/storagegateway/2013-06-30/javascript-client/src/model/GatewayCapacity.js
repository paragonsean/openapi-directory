...
* @readonly
*/
export default class GatewayCapacity {
    ...
    /**
    * Returns a <code>GatewayCapacity</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GatewayCapacity} The enum <code>GatewayCapacity</code> value.
    */
