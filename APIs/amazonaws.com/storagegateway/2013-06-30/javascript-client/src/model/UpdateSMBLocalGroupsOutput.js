...
/**
 * The UpdateSMBLocalGroupsOutput model module.
 * @module model/UpdateSMBLocalGroupsOutput
 * @version 2013-06-30
 */
class UpdateSMBLocalGroupsOutput {
    /**
     * Constructs a new <code>UpdateSMBLocalGroupsOutput</code>.
     * @alias module:model/UpdateSMBLocalGroupsOutput
     */
    constructor() { 
        
        UpdateSMBLocalGroupsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSMBLocalGroupsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSMBLocalGroupsOutput} obj Optional instance to populate.
     * @return {module:model/UpdateSMBLocalGroupsOutput} The populated <code>UpdateSMBLocalGroupsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSMBLocalGroupsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSMBLocalGroupsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSMBLocalGroupsOutput</code>.
     */
 ...
 */
UpdateSMBLocalGroupsOutput.prototype['GatewayARN'] = undefined;
...
export default UpdateSMBLocalGroupsOutput;
