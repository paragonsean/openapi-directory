...
/**
 * The UpdateSMBFileShareOutput model module.
 * @module model/UpdateSMBFileShareOutput
 * @version 2013-06-30
 */
class UpdateSMBFileShareOutput {
    /**
     * Constructs a new <code>UpdateSMBFileShareOutput</code>.
     * UpdateSMBFileShareOutput
     * @alias module:model/UpdateSMBFileShareOutput
     */
    constructor() { 
        
        UpdateSMBFileShareOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSMBFileShareOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSMBFileShareOutput} obj Optional instance to populate.
     * @return {module:model/UpdateSMBFileShareOutput} The populated <code>UpdateSMBFileShareOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSMBFileShareOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSMBFileShareOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSMBFileShareOutput</code>.
     */
 ...
 */
UpdateSMBFileShareOutput.prototype['FileShareARN'] = undefined;
...
export default UpdateSMBFileShareOutput;
