...
/**
 * The ListTapePoolsInput model module.
 * @module model/ListTapePoolsInput
 * @version 2013-06-30
 */
class ListTapePoolsInput {
    /**
     * Constructs a new <code>ListTapePoolsInput</code>.
     * @alias module:model/ListTapePoolsInput
     */
    constructor() { 
        
        ListTapePoolsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListTapePoolsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTapePoolsInput} obj Optional instance to populate.
     * @return {module:model/ListTapePoolsInput} The populated <code>ListTapePoolsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTapePoolsInput();

            if (data.hasOwnProperty('PoolARNs')) {
                obj['PoolARNs'] = ApiClient.convertToType(data['PoolARNs'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListTapePoolsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTapePoolsInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PoolARNs`
        if (data['PoolARNs']) { // data not null
          Array.validateJSON(data['PoolARNs']);
        }
...
/**
 * @member {Array} PoolARNs
 */
ListTapePoolsInput.prototype['PoolARNs'] = undefined;

/**
 * @member {String} Marker
 */
ListTapePoolsInput.prototype['Marker'] = undefined;

/**
 * @member {Number} Limit
 */
ListTapePoolsInput.prototype['Limit'] = undefined;
...
export default ListTapePoolsInput;
