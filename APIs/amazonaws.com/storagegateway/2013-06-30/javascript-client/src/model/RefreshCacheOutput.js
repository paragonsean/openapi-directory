...
/**
 * The RefreshCacheOutput model module.
 * @module model/RefreshCacheOutput
 * @version 2013-06-30
 */
class RefreshCacheOutput {
    /**
     * Constructs a new <code>RefreshCacheOutput</code>.
     * RefreshCacheOutput
     * @alias module:model/RefreshCacheOutput
     */
    constructor() { 
        
        RefreshCacheOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RefreshCacheOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RefreshCacheOutput} obj Optional instance to populate.
     * @return {module:model/RefreshCacheOutput} The populated <code>RefreshCacheOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RefreshCacheOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>RefreshCacheOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RefreshCacheOutput</code>.
     */
...
export default RefreshCacheOutput;
