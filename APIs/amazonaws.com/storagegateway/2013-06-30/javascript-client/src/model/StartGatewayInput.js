...
/**
 * The StartGatewayInput model module.
 * @module model/StartGatewayInput
 * @version 2013-06-30
 */
class StartGatewayInput {
    /**
     * Constructs a new <code>StartGatewayInput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway to start.
     * @alias module:model/StartGatewayInput
    ...
    constructor(gatewayARN) { 
        ...
        StartGatewayInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>StartGatewayInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartGatewayInput} obj Optional instance to populate.
     * @return {module:model/StartGatewayInput} The populated <code>StartGatewayInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartGatewayInput();
    ...
    /**
     * Validates the JSON data with respect to <code>StartGatewayInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartGatewayInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartGatewayInput.RequiredProperties) {
...
StartGatewayInput.RequiredProperties = ["GatewayARN"];
 ...
 */
StartGatewayInput.prototype['GatewayARN'] = undefined;
...
export default StartGatewayInput;
