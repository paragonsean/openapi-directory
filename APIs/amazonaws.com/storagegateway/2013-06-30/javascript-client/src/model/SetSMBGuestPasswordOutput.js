...
/**
 * The SetSMBGuestPasswordOutput model module.
 * @module model/SetSMBGuestPasswordOutput
 * @version 2013-06-30
 */
class SetSMBGuestPasswordOutput {
    /**
     * Constructs a new <code>SetSMBGuestPasswordOutput</code>.
     * @alias module:model/SetSMBGuestPasswordOutput
     */
    constructor() { 
        
        SetSMBGuestPasswordOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetSMBGuestPasswordOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetSMBGuestPasswordOutput} obj Optional instance to populate.
     * @return {module:model/SetSMBGuestPasswordOutput} The populated <code>SetSMBGuestPasswordOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetSMBGuestPasswordOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>SetSMBGuestPasswordOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetSMBGuestPasswordOutput</code>.
     */
 ...
 */
SetSMBGuestPasswordOutput.prototype['GatewayARN'] = undefined;
...
export default SetSMBGuestPasswordOutput;
