...
/**
 * The DescribeBandwidthRateLimitOutput model module.
 * @module model/DescribeBandwidthRateLimitOutput
 * @version 2013-06-30
 */
class DescribeBandwidthRateLimitOutput {
    /**
     * Constructs a new <code>DescribeBandwidthRateLimitOutput</code>.
     * A JSON object containing the following fields:
     * @alias module:model/DescribeBandwidthRateLimitOutput
     */
    constructor() { 
        
        DescribeBandwidthRateLimitOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeBandwidthRateLimitOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBandwidthRateLimitOutput} obj Optional instance to populate.
     * @return {module:model/DescribeBandwidthRateLimitOutput} The populated <code>DescribeBandwidthRateLimitOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBandwidthRateLimitOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBandwidthRateLimitOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBandwidthRateLimitOutput</code>.
     */
 ...
 */
DescribeBandwidthRateLimitOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {Number} AverageUploadRateLimitInBitsPerSec
 */
DescribeBandwidthRateLimitOutput.prototype['AverageUploadRateLimitInBitsPerSec'] = undefined;

/**
 * @member {Number} AverageDownloadRateLimitInBitsPerSec
 */
DescribeBandwidthRateLimitOutput.prototype['AverageDownloadRateLimitInBitsPerSec'] = undefined;
...
export default DescribeBandwidthRateLimitOutput;
