...
/**
 * The ShutdownGatewayInput model module.
 * @module model/ShutdownGatewayInput
 * @version 2013-06-30
 */
class ShutdownGatewayInput {
    /**
     * Constructs a new <code>ShutdownGatewayInput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway to shut down.
     * @alias module:model/ShutdownGatewayInput
    ...
    constructor(gatewayARN) { 
        ...
        ShutdownGatewayInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>ShutdownGatewayInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShutdownGatewayInput} obj Optional instance to populate.
     * @return {module:model/ShutdownGatewayInput} The populated <code>ShutdownGatewayInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShutdownGatewayInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ShutdownGatewayInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShutdownGatewayInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ShutdownGatewayInput.RequiredProperties) {
...
ShutdownGatewayInput.RequiredProperties = ["GatewayARN"];
 ...
 */
ShutdownGatewayInput.prototype['GatewayARN'] = undefined;
...
export default ShutdownGatewayInput;
