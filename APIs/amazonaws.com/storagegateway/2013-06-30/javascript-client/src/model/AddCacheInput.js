...
/**
 * The AddCacheInput model module.
 * @module model/AddCacheInput
 * @version 2013-06-30
 */
class AddCacheInput {
    /**
     * Constructs a new <code>AddCacheInput</code>.
     * @alias module:model/AddCacheInput
    ...
    constructor(gatewayARN, diskIds) { 
        ...
        AddCacheInput.initialize(this, gatewayARN, diskIds);
    }
    ...
    /**
     * Constructs a <code>AddCacheInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddCacheInput} obj Optional instance to populate.
     * @return {module:model/AddCacheInput} The populated <code>AddCacheInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddCacheInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AddCacheInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddCacheInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddCacheInput.RequiredProperties) {
...
AddCacheInput.RequiredProperties = ["GatewayARN", "DiskIds"];
 ...
 */
AddCacheInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Array} DiskIds
 */
AddCacheInput.prototype['DiskIds'] = undefined;
