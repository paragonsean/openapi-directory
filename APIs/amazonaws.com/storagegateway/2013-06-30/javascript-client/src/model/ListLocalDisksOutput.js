...
/**
 * The ListLocalDisksOutput model module.
 * @module model/ListLocalDisksOutput
 * @version 2013-06-30
 */
class ListLocalDisksOutput {
    /**
     * Constructs a new <code>ListLocalDisksOutput</code>.
     * @alias module:model/ListLocalDisksOutput
     */
    constructor() { 
        
        ListLocalDisksOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListLocalDisksOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListLocalDisksOutput} obj Optional instance to populate.
     * @return {module:model/ListLocalDisksOutput} The populated <code>ListLocalDisksOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListLocalDisksOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListLocalDisksOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLocalDisksOutput</code>.
     */
 ...
 */
ListLocalDisksOutput.prototype['GatewayARN'] = undefined;

/**
 * @member {Array} Disks
 */
ListLocalDisksOutput.prototype['Disks'] = undefined;
...
export default ListLocalDisksOutput;
