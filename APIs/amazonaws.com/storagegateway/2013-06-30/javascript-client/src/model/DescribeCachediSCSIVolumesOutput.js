...
/**
 * The DescribeCachediSCSIVolumesOutput model module.
 * @module model/DescribeCachediSCSIVolumesOutput
 * @version 2013-06-30
 */
class DescribeCachediSCSIVolumesOutput {
    /**
     * Constructs a new <code>DescribeCachediSCSIVolumesOutput</code>.
     * A JSON object containing the following fields:
     * @alias module:model/DescribeCachediSCSIVolumesOutput
     */
    constructor() { 
        
        DescribeCachediSCSIVolumesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeCachediSCSIVolumesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCachediSCSIVolumesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeCachediSCSIVolumesOutput} The populated <code>DescribeCachediSCSIVolumesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCachediSCSIVolumesOutput();

            if (data.hasOwnProperty('CachediSCSIVolumes')) {
                obj['CachediSCSIVolumes'] = ApiClient.convertToType(data['CachediSCSIVolumes'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCachediSCSIVolumesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCachediSCSIVolumesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CachediSCSIVolumes`
        if (data['CachediSCSIVolumes']) { // data not null
          Array.validateJSON(data['CachediSCSIVolumes']);
        }
...
/**
 * @member {Array} CachediSCSIVolumes
 */
DescribeCachediSCSIVolumesOutput.prototype['CachediSCSIVolumes'] = undefined;
...
export default DescribeCachediSCSIVolumesOutput;
