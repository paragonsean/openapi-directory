...
/**
 * The CreateTapeWithBarcodeInput model module.
 * @module model/CreateTapeWithBarcodeInput
 * @version 2013-06-30
 */
class CreateTapeWithBarcodeInput {
    /**
     * Constructs a new <code>CreateTapeWithBarcodeInput</code>.
     * CreateTapeWithBarcodeInput
     * @alias module:model/CreateTapeWithBarcodeInput
     * @param gatewayARN {String} 
     * @param tapeSizeInBytes {Number} 
     * @param tapeBarcode {String} 
     */
    constructor(gatewayARN, tapeSizeInBytes, tapeBarcode) { 
        
        CreateTapeWithBarcodeInput.initialize(this, gatewayARN, tapeSizeInBytes, tapeBarcode);
    }
     ...
     */
    static initialize(obj, gatewayARN, tapeSizeInBytes, tapeBarcode) { 
        obj['GatewayARN'] = gatewayARN;
        obj['TapeSizeInBytes'] = tapeSizeInBytes;
        obj['TapeBarcode'] = tapeBarcode;
    }

    /**
     * Constructs a <code>CreateTapeWithBarcodeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTapeWithBarcodeInput} obj Optional instance to populate.
     * @return {module:model/CreateTapeWithBarcodeInput} The populated <code>CreateTapeWithBarcodeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTapeWithBarcodeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTapeWithBarcodeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTapeWithBarcodeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateTapeWithBarcodeInput.RequiredProperties) {
...
CreateTapeWithBarcodeInput.RequiredProperties = ["GatewayARN", "TapeSizeInBytes", "TapeBarcode"];

/**
 * @member {String} GatewayARN
 */
CreateTapeWithBarcodeInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Number} TapeSizeInBytes
 */
CreateTapeWithBarcodeInput.prototype['TapeSizeInBytes'] = undefined;

/**
 * @member {String} TapeBarcode
 */
CreateTapeWithBarcodeInput.prototype['TapeBarcode'] = undefined;

/**
 * @member {Boolean} KMSEncrypted
 */
CreateTapeWithBarcodeInput.prototype['KMSEncrypted'] = undefined;

/**
 * @member {String} KMSKey
 */
CreateTapeWithBarcodeInput.prototype['KMSKey'] = undefined;

/**
 * @member {String} PoolId
 */
CreateTapeWithBarcodeInput.prototype['PoolId'] = undefined;

/**
 * @member {Boolean} Worm
 */
CreateTapeWithBarcodeInput.prototype['Worm'] = undefined;

/**
 * @member {Array} Tags
 */
CreateTapeWithBarcodeInput.prototype['Tags'] = undefined;
...
export default CreateTapeWithBarcodeInput;
