...
/**
 * The SetLocalConsolePasswordOutput model module.
 * @module model/SetLocalConsolePasswordOutput
 * @version 2013-06-30
 */
class SetLocalConsolePasswordOutput {
    /**
     * Constructs a new <code>SetLocalConsolePasswordOutput</code>.
     * @alias module:model/SetLocalConsolePasswordOutput
     */
    constructor() { 
        
        SetLocalConsolePasswordOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetLocalConsolePasswordOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetLocalConsolePasswordOutput} obj Optional instance to populate.
     * @return {module:model/SetLocalConsolePasswordOutput} The populated <code>SetLocalConsolePasswordOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetLocalConsolePasswordOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>SetLocalConsolePasswordOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetLocalConsolePasswordOutput</code>.
     */
 ...
 */
SetLocalConsolePasswordOutput.prototype['GatewayARN'] = undefined;
...
export default SetLocalConsolePasswordOutput;
