...
/**
 * The AssignTapePoolInput model module.
 * @module model/AssignTapePoolInput
 * @version 2013-06-30
 */
class AssignTapePoolInput {
    /**
     * Constructs a new <code>AssignTapePoolInput</code>.
     * @alias module:model/AssignTapePoolInput
     * @param tapeARN {String} 
     * @param poolId {String} 
     */
    constructor(tapeARN, poolId) { 
        
        AssignTapePoolInput.initialize(this, tapeARN, poolId);
    }
     ...
     */
    static initialize(obj, tapeARN, poolId) { 
        obj['TapeARN'] = tapeARN;
        obj['PoolId'] = poolId;
    }

    /**
     * Constructs a <code>AssignTapePoolInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssignTapePoolInput} obj Optional instance to populate.
     * @return {module:model/AssignTapePoolInput} The populated <code>AssignTapePoolInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssignTapePoolInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AssignTapePoolInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssignTapePoolInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssignTapePoolInput.RequiredProperties) {
...
AssignTapePoolInput.RequiredProperties = ["TapeARN", "PoolId"];

/**
 * @member {String} TapeARN
 */
AssignTapePoolInput.prototype['TapeARN'] = undefined;

/**
 * @member {String} PoolId
 */
AssignTapePoolInput.prototype['PoolId'] = undefined;

/**
 * @member {Boolean} BypassGovernanceRetention
 */
AssignTapePoolInput.prototype['BypassGovernanceRetention'] = undefined;
...
export default AssignTapePoolInput;
