...
/**
 * The ChapInfo model module.
 * @module model/ChapInfo
 * @version 2013-06-30
 */
class ChapInfo {
    /**
     * Constructs a new <code>ChapInfo</code>.
     * Describes Challenge-Handshake Authentication Protocol (CHAP) information that supports authentication between your gateway and iSCSI initiators.
     * @alias module:model/ChapInfo
     */
    constructor() { 
        
        ChapInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChapInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChapInfo} obj Optional instance to populate.
     * @return {module:model/ChapInfo} The populated <code>ChapInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChapInfo();

            if (data.hasOwnProperty('TargetARN')) {
                obj['TargetARN'] = ApiClient.convertToType(data['TargetARN'], 'String');
            }
            if (data.hasOwnProperty('SecretToAuthenticateInitiator')) {
                obj['SecretToAuthenticateInitiator'] = ApiClient.convertToType(data['SecretToAuthenticateInitiator'], 'String');
            }
            if (data.hasOwnProperty('InitiatorName')) {
                obj['InitiatorName'] = ApiClient.convertToType(data['InitiatorName'], 'String');
            }
            if (data.hasOwnProperty('SecretToAuthenticateTarget')) {
                obj['SecretToAuthenticateTarget'] = ApiClient.convertToType(data['SecretToAuthenticateTarget'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ChapInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChapInfo</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `SecretToAuthenticateInitiator`
        if (data['SecretToAuthenticateInitiator']) { // data not null
          String.validateJSON(data['SecretToAuthenticateInitiator']);
        }
        // validate the optional field `InitiatorName`
        if (data['InitiatorName']) { // data not null
          String.validateJSON(data['InitiatorName']);
        }
        // validate the optional field `SecretToAuthenticateTarget`
        if (data['SecretToAuthenticateTarget']) { // data not null
          String.validateJSON(data['SecretToAuthenticateTarget']);
        }
 ...
 */
ChapInfo.prototype['TargetARN'] = undefined;

/**
 * @member {String} SecretToAuthenticateInitiator
 */
ChapInfo.prototype['SecretToAuthenticateInitiator'] = undefined;

/**
 * @member {String} InitiatorName
 */
ChapInfo.prototype['InitiatorName'] = undefined;

/**
 * @member {String} SecretToAuthenticateTarget
 */
ChapInfo.prototype['SecretToAuthenticateTarget'] = undefined;
