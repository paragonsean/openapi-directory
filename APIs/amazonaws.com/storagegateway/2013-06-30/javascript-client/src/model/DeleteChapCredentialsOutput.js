...
/**
 * The DeleteChapCredentialsOutput model module.
 * @module model/DeleteChapCredentialsOutput
 * @version 2013-06-30
 */
class DeleteChapCredentialsOutput {
    /**
     * Constructs a new <code>DeleteChapCredentialsOutput</code>.
     * A JSON object containing the following fields:
     * @alias module:model/DeleteChapCredentialsOutput
     */
    constructor() { 
        
        DeleteChapCredentialsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteChapCredentialsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteChapCredentialsOutput} obj Optional instance to populate.
     * @return {module:model/DeleteChapCredentialsOutput} The populated <code>DeleteChapCredentialsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteChapCredentialsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteChapCredentialsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteChapCredentialsOutput</code>.
     */
 ...
 */
DeleteChapCredentialsOutput.prototype['TargetARN'] = undefined;

/**
 * @member {String} InitiatorName
 */
DeleteChapCredentialsOutput.prototype['InitiatorName'] = undefined;
...
export default DeleteChapCredentialsOutput;
