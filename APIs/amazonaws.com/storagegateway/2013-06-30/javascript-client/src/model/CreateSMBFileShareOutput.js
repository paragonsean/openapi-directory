...
/**
 * The CreateSMBFileShareOutput model module.
 * @module model/CreateSMBFileShareOutput
 * @version 2013-06-30
 */
class CreateSMBFileShareOutput {
    /**
     * Constructs a new <code>CreateSMBFileShareOutput</code>.
     * CreateSMBFileShareOutput
     * @alias module:model/CreateSMBFileShareOutput
     */
    constructor() { 
        
        CreateSMBFileShareOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateSMBFileShareOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSMBFileShareOutput} obj Optional instance to populate.
     * @return {module:model/CreateSMBFileShareOutput} The populated <code>CreateSMBFileShareOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSMBFileShareOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSMBFileShareOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSMBFileShareOutput</code>.
     */
 ...
 */
CreateSMBFileShareOutput.prototype['FileShareARN'] = undefined;
...
export default CreateSMBFileShareOutput;
