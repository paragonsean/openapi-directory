...
/**
 * The ListFileSharesInput model module.
 * @module model/ListFileSharesInput
 * @version 2013-06-30
 */
class ListFileSharesInput {
    /**
     * Constructs a new <code>ListFileSharesInput</code>.
     * ListFileShareInput
     * @alias module:model/ListFileSharesInput
     */
    constructor() { 
        
        ListFileSharesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFileSharesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFileSharesInput} obj Optional instance to populate.
     * @return {module:model/ListFileSharesInput} The populated <code>ListFileSharesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFileSharesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListFileSharesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFileSharesInput</code>.
     */
 ...
 */
ListFileSharesInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Number} Limit
 */
ListFileSharesInput.prototype['Limit'] = undefined;

/**
 * @member {String} Marker
 */
ListFileSharesInput.prototype['Marker'] = undefined;
...
export default ListFileSharesInput;
