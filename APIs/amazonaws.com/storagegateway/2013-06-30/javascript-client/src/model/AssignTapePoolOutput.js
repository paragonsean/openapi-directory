...
/**
 * The AssignTapePoolOutput model module.
 * @module model/AssignTapePoolOutput
 * @version 2013-06-30
 */
class AssignTapePoolOutput {
    /**
     * Constructs a new <code>AssignTapePoolOutput</code>.
     * @alias module:model/AssignTapePoolOutput
     */
    constructor() { 
        
        AssignTapePoolOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssignTapePoolOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssignTapePoolOutput} obj Optional instance to populate.
     * @return {module:model/AssignTapePoolOutput} The populated <code>AssignTapePoolOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssignTapePoolOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>AssignTapePoolOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssignTapePoolOutput</code>.
     */
 ...
 */
AssignTapePoolOutput.prototype['TapeARN'] = undefined;
...
export default AssignTapePoolOutput;
