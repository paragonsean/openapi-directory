...
/**
 * The NFSFileShareDefaults model module.
 * @module model/NFSFileShareDefaults
 * @version 2013-06-30
 */
class NFSFileShareDefaults {
    /**
     * Constructs a new <code>NFSFileShareDefaults</code>.
     ...
     * @alias module:model/NFSFileShareDefaults
     */
    constructor() { 
        
        NFSFileShareDefaults.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NFSFileShareDefaults</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NFSFileShareDefaults} obj Optional instance to populate.
     * @return {module:model/NFSFileShareDefaults} The populated <code>NFSFileShareDefaults</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NFSFileShareDefaults();

            if (data.hasOwnProperty('FileMode')) {
                obj['FileMode'] = ApiClient.convertToType(data['FileMode'], 'String');
            }
            if (data.hasOwnProperty('DirectoryMode')) {
                obj['DirectoryMode'] = ApiClient.convertToType(data['DirectoryMode'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>NFSFileShareDefaults</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NFSFileShareDefaults</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FileMode`
        if (data['FileMode']) { // data not null
          String.validateJSON(data['FileMode']);
        }
        // validate the optional field `DirectoryMode`
        if (data['DirectoryMode']) { // data not null
          String.validateJSON(data['DirectoryMode']);
        }
        // validate the optional field `GroupId`
        if (data['GroupId']) { // data not null
          Number.validateJSON(data['GroupId']);
        }
        // validate the optional field `OwnerId`
        if (data['OwnerId']) { // data not null
          Number.validateJSON(data['OwnerId']);
        }
 ...
 */
NFSFileShareDefaults.prototype['FileMode'] = undefined;

/**
 * @member {String} DirectoryMode
 */
NFSFileShareDefaults.prototype['DirectoryMode'] = undefined;

/**
 * @member {Number} GroupId
 */
NFSFileShareDefaults.prototype['GroupId'] = undefined;

/**
 * @member {Number} OwnerId
 */
NFSFileShareDefaults.prototype['OwnerId'] = undefined;
...
export default NFSFileShareDefaults;
