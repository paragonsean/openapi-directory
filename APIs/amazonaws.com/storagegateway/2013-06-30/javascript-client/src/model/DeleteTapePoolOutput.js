...
/**
 * The DeleteTapePoolOutput model module.
 * @module model/DeleteTapePoolOutput
 * @version 2013-06-30
 */
class DeleteTapePoolOutput {
    /**
     * Constructs a new <code>DeleteTapePoolOutput</code>.
     * @alias module:model/DeleteTapePoolOutput
     */
    constructor() { 
        
        DeleteTapePoolOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteTapePoolOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteTapePoolOutput} obj Optional instance to populate.
     * @return {module:model/DeleteTapePoolOutput} The populated <code>DeleteTapePoolOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteTapePoolOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteTapePoolOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteTapePoolOutput</code>.
     */
 ...
 */
DeleteTapePoolOutput.prototype['PoolARN'] = undefined;
...
export default DeleteTapePoolOutput;
