...
/**
 * The CreateSnapshotFromVolumeRecoveryPointOutput model module.
 * @module model/CreateSnapshotFromVolumeRecoveryPointOutput
 * @version 2013-06-30
 */
class CreateSnapshotFromVolumeRecoveryPointOutput {
    /**
     * Constructs a new <code>CreateSnapshotFromVolumeRecoveryPointOutput</code>.
     * @alias module:model/CreateSnapshotFromVolumeRecoveryPointOutput
     */
    constructor() { 
        
        CreateSnapshotFromVolumeRecoveryPointOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateSnapshotFromVolumeRecoveryPointOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSnapshotFromVolumeRecoveryPointOutput} obj Optional instance to populate.
     * @return {module:model/CreateSnapshotFromVolumeRecoveryPointOutput} The populated <code>CreateSnapshotFromVolumeRecoveryPointOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSnapshotFromVolumeRecoveryPointOutput();
            ...
            if (data.hasOwnProperty('VolumeRecoveryPointTime')) {
                obj['VolumeRecoveryPointTime'] = ApiClient.convertToType(data['VolumeRecoveryPointTime'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSnapshotFromVolumeRecoveryPointOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSnapshotFromVolumeRecoveryPointOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['VolumeRecoveryPointTime']) { // data not null
          String.validateJSON(data['VolumeRecoveryPointTime']);
        }
 ...
 */
CreateSnapshotFromVolumeRecoveryPointOutput.prototype['SnapshotId'] = undefined;

/**
 * @member {String} VolumeARN
 */
CreateSnapshotFromVolumeRecoveryPointOutput.prototype['VolumeARN'] = undefined;

/**
 * @member {String} VolumeRecoveryPointTime
 */
CreateSnapshotFromVolumeRecoveryPointOutput.prototype['VolumeRecoveryPointTime'] = undefined;
...
export default CreateSnapshotFromVolumeRecoveryPointOutput;
