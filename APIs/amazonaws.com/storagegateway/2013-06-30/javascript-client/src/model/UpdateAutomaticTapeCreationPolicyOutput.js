...
/**
 * The UpdateAutomaticTapeCreationPolicyOutput model module.
 * @module model/UpdateAutomaticTapeCreationPolicyOutput
 * @version 2013-06-30
 */
class UpdateAutomaticTapeCreationPolicyOutput {
    /**
     * Constructs a new <code>UpdateAutomaticTapeCreationPolicyOutput</code>.
     * @alias module:model/UpdateAutomaticTapeCreationPolicyOutput
     */
    constructor() { 
        
        UpdateAutomaticTapeCreationPolicyOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateAutomaticTapeCreationPolicyOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAutomaticTapeCreationPolicyOutput} obj Optional instance to populate.
     * @return {module:model/UpdateAutomaticTapeCreationPolicyOutput} The populated <code>UpdateAutomaticTapeCreationPolicyOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAutomaticTapeCreationPolicyOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAutomaticTapeCreationPolicyOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAutomaticTapeCreationPolicyOutput</code>.
     */
 ...
 */
UpdateAutomaticTapeCreationPolicyOutput.prototype['GatewayARN'] = undefined;
...
export default UpdateAutomaticTapeCreationPolicyOutput;
