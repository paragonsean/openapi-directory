...
/**
 * The VolumeRecoveryPointInfo model module.
 * @module model/VolumeRecoveryPointInfo
 * @version 2013-06-30
 */
class VolumeRecoveryPointInfo {
    /**
     * Constructs a new <code>VolumeRecoveryPointInfo</code>.
     * Describes a storage volume recovery point object.
     * @alias module:model/VolumeRecoveryPointInfo
     */
    constructor() { 
        
        VolumeRecoveryPointInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VolumeRecoveryPointInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VolumeRecoveryPointInfo} obj Optional instance to populate.
     * @return {module:model/VolumeRecoveryPointInfo} The populated <code>VolumeRecoveryPointInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VolumeRecoveryPointInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>VolumeRecoveryPointInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VolumeRecoveryPointInfo</code>.
     */
 ...
 */
VolumeRecoveryPointInfo.prototype['VolumeARN'] = undefined;

/**
 * @member {Number} VolumeSizeInBytes
 */
VolumeRecoveryPointInfo.prototype['VolumeSizeInBytes'] = undefined;

/**
 * @member {Number} VolumeUsageInBytes
 */
VolumeRecoveryPointInfo.prototype['VolumeUsageInBytes'] = undefined;

/**
 * @member {String} VolumeRecoveryPointTime
 */
VolumeRecoveryPointInfo.prototype['VolumeRecoveryPointTime'] = undefined;
...
export default VolumeRecoveryPointInfo;
