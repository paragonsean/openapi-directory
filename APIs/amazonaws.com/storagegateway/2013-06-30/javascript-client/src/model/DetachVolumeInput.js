...
/**
 * The DetachVolumeInput model module.
 * @module model/DetachVolumeInput
 * @version 2013-06-30
 */
class DetachVolumeInput {
    /**
     * Constructs a new <code>DetachVolumeInput</code>.
     * AttachVolumeInput
     * @alias module:model/DetachVolumeInput
     * @param volumeARN {String} 
     */
    constructor(volumeARN) { 
        
        DetachVolumeInput.initialize(this, volumeARN);
    }
     ...
     */
    static initialize(obj, volumeARN) { 
        obj['VolumeARN'] = volumeARN;
    }

    /**
     * Constructs a <code>DetachVolumeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetachVolumeInput} obj Optional instance to populate.
     * @return {module:model/DetachVolumeInput} The populated <code>DetachVolumeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetachVolumeInput();

            if (data.hasOwnProperty('VolumeARN')) {
                obj['VolumeARN'] = ApiClient.convertToType(data['VolumeARN'], 'String');
            }
            if (data.hasOwnProperty('ForceDetach')) {
                obj['ForceDetach'] = ApiClient.convertToType(data['ForceDetach'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetachVolumeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetachVolumeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DetachVolumeInput.RequiredProperties) {
        ...
        // validate the optional field `ForceDetach`
        if (data['ForceDetach']) { // data not null
          Boolean.validateJSON(data['ForceDetach']);
        }
...
DetachVolumeInput.RequiredProperties = ["VolumeARN"];

/**
 * @member {String} VolumeARN
 */
DetachVolumeInput.prototype['VolumeARN'] = undefined;

/**
 * @member {Boolean} ForceDetach
 */
DetachVolumeInput.prototype['ForceDetach'] = undefined;
...
export default DetachVolumeInput;
