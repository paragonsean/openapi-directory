...
/**
 * The VolumeiSCSIAttributes model module.
 * @module model/VolumeiSCSIAttributes
 * @version 2013-06-30
 */
class VolumeiSCSIAttributes {
    /**
     * Constructs a new <code>VolumeiSCSIAttributes</code>.
     * Lists iSCSI information about a volume.
     * @alias module:model/VolumeiSCSIAttributes
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>VolumeiSCSIAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VolumeiSCSIAttributes} obj Optional instance to populate.
     * @return {module:model/VolumeiSCSIAttributes} The populated <code>VolumeiSCSIAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VolumeiSCSIAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>VolumeiSCSIAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VolumeiSCSIAttributes</code>.
     */
...
export default VolumeiSCSIAttributes;
