...
/**
 * The UpdateBandwidthRateLimitOutput model module.
 * @module model/UpdateBandwidthRateLimitOutput
 * @version 2013-06-30
 */
class UpdateBandwidthRateLimitOutput {
    /**
     * Constructs a new <code>UpdateBandwidthRateLimitOutput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway whose throttle information was updated.
     * @alias module:model/UpdateBandwidthRateLimitOutput
     */
    constructor() { 
        
        UpdateBandwidthRateLimitOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateBandwidthRateLimitOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateBandwidthRateLimitOutput} obj Optional instance to populate.
     * @return {module:model/UpdateBandwidthRateLimitOutput} The populated <code>UpdateBandwidthRateLimitOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateBandwidthRateLimitOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateBandwidthRateLimitOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateBandwidthRateLimitOutput</code>.
     */
 ...
 */
UpdateBandwidthRateLimitOutput.prototype['GatewayARN'] = undefined;
...
export default UpdateBandwidthRateLimitOutput;
