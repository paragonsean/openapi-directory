...
/**
 * The DescribeSMBFileSharesOutput model module.
 * @module model/DescribeSMBFileSharesOutput
 * @version 2013-06-30
 */
class DescribeSMBFileSharesOutput {
    /**
     * Constructs a new <code>DescribeSMBFileSharesOutput</code>.
     * DescribeSMBFileSharesOutput
     * @alias module:model/DescribeSMBFileSharesOutput
     */
    constructor() { 
        
        DescribeSMBFileSharesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeSMBFileSharesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeSMBFileSharesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeSMBFileSharesOutput} The populated <code>DescribeSMBFileSharesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeSMBFileSharesOutput();

            if (data.hasOwnProperty('SMBFileShareInfoList')) {
                obj['SMBFileShareInfoList'] = ApiClient.convertToType(data['SMBFileShareInfoList'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeSMBFileSharesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeSMBFileSharesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SMBFileShareInfoList`
        if (data['SMBFileShareInfoList']) { // data not null
          Array.validateJSON(data['SMBFileShareInfoList']);
        }
...
/**
 * @member {Array} SMBFileShareInfoList
 */
DescribeSMBFileSharesOutput.prototype['SMBFileShareInfoList'] = undefined;
...
export default DescribeSMBFileSharesOutput;
