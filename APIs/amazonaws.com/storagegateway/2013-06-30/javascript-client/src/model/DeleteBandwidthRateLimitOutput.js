...
/**
 * The DeleteBandwidthRateLimitOutput model module.
 * @module model/DeleteBandwidthRateLimitOutput
 * @version 2013-06-30
 */
class DeleteBandwidthRateLimitOutput {
    /**
     * Constructs a new <code>DeleteBandwidthRateLimitOutput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway whose bandwidth rate information was deleted.
     * @alias module:model/DeleteBandwidthRateLimitOutput
     */
    constructor() { 
        
        DeleteBandwidthRateLimitOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteBandwidthRateLimitOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteBandwidthRateLimitOutput} obj Optional instance to populate.
     * @return {module:model/DeleteBandwidthRateLimitOutput} The populated <code>DeleteBandwidthRateLimitOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteBandwidthRateLimitOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteBandwidthRateLimitOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteBandwidthRateLimitOutput</code>.
     */
 ...
 */
DeleteBandwidthRateLimitOutput.prototype['GatewayARN'] = undefined;
...
export default DeleteBandwidthRateLimitOutput;
