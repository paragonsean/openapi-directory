...
/**
 * The DescribeTapesInput model module.
 * @module model/DescribeTapesInput
 * @version 2013-06-30
 */
class DescribeTapesInput {
    /**
     * Constructs a new <code>DescribeTapesInput</code>.
     * DescribeTapesInput
     * @alias module:model/DescribeTapesInput
    ...
    constructor(gatewayARN) { 
        ...
        DescribeTapesInput.initialize(this, gatewayARN);
    }
    ...
    /**
     * Constructs a <code>DescribeTapesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTapesInput} obj Optional instance to populate.
     * @return {module:model/DescribeTapesInput} The populated <code>DescribeTapesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTapesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTapesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTapesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeTapesInput.RequiredProperties) {
...
DescribeTapesInput.RequiredProperties = ["GatewayARN"];
 ...
 */
DescribeTapesInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Array} TapeARNs
 */
DescribeTapesInput.prototype['TapeARNs'] = undefined;

/**
 * @member {String} Marker
 */
DescribeTapesInput.prototype['Marker'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeTapesInput.prototype['Limit'] = undefined;
...
export default DescribeTapesInput;
