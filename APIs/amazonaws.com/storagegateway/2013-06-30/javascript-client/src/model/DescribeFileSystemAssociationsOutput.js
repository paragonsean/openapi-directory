...
/**
 * The DescribeFileSystemAssociationsOutput model module.
 * @module model/DescribeFileSystemAssociationsOutput
 * @version 2013-06-30
 */
class DescribeFileSystemAssociationsOutput {
    /**
     * Constructs a new <code>DescribeFileSystemAssociationsOutput</code>.
     * @alias module:model/DescribeFileSystemAssociationsOutput
     */
    constructor() { 
        
        DescribeFileSystemAssociationsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFileSystemAssociationsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFileSystemAssociationsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeFileSystemAssociationsOutput} The populated <code>DescribeFileSystemAssociationsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFileSystemAssociationsOutput();

            if (data.hasOwnProperty('FileSystemAssociationInfoList')) {
                obj['FileSystemAssociationInfoList'] = ApiClient.convertToType(data['FileSystemAssociationInfoList'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFileSystemAssociationsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFileSystemAssociationsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FileSystemAssociationInfoList`
        if (data['FileSystemAssociationInfoList']) { // data not null
          Array.validateJSON(data['FileSystemAssociationInfoList']);
        }
...
/**
 * @member {Array} FileSystemAssociationInfoList
 */
DescribeFileSystemAssociationsOutput.prototype['FileSystemAssociationInfoList'] = undefined;
...
export default DescribeFileSystemAssociationsOutput;
