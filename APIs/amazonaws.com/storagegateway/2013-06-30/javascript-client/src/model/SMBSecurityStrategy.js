...
* @readonly
*/
export default class SMBSecurityStrategy {
    ...
    /**
    * Returns a <code>SMBSecurityStrategy</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SMBSecurityStrategy} The enum <code>SMBSecurityStrategy</code> value.
    */
