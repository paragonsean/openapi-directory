...
/**
 * The FileSystemAssociationStatusDetail model module.
 * @module model/FileSystemAssociationStatusDetail
 * @version 2013-06-30
 */
class FileSystemAssociationStatusDetail {
    /**
     * Constructs a new <code>FileSystemAssociationStatusDetail</code>.
     * Detailed information on file system association status.
     * @alias module:model/FileSystemAssociationStatusDetail
     */
    constructor() { 
        
        FileSystemAssociationStatusDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FileSystemAssociationStatusDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileSystemAssociationStatusDetail} obj Optional instance to populate.
     * @return {module:model/FileSystemAssociationStatusDetail} The populated <code>FileSystemAssociationStatusDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileSystemAssociationStatusDetail();
    ...
    /**
     * Validates the JSON data with respect to <code>FileSystemAssociationStatusDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileSystemAssociationStatusDetail</code>.
     */
 ...
 */
FileSystemAssociationStatusDetail.prototype['ErrorCode'] = undefined;
...
export default FileSystemAssociationStatusDetail;
