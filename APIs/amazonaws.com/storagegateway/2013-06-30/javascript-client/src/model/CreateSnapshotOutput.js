...
/**
 * The CreateSnapshotOutput model module.
 * @module model/CreateSnapshotOutput
 * @version 2013-06-30
 */
class CreateSnapshotOutput {
    /**
     * Constructs a new <code>CreateSnapshotOutput</code>.
     * A JSON object containing the following fields:
     * @alias module:model/CreateSnapshotOutput
     */
    constructor() { 
        
        CreateSnapshotOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateSnapshotOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSnapshotOutput} obj Optional instance to populate.
     * @return {module:model/CreateSnapshotOutput} The populated <code>CreateSnapshotOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSnapshotOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSnapshotOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSnapshotOutput</code>.
     */
 ...
 */
CreateSnapshotOutput.prototype['VolumeARN'] = undefined;

/**
 * @member {String} SnapshotId
 */
CreateSnapshotOutput.prototype['SnapshotId'] = undefined;
...
export default CreateSnapshotOutput;
