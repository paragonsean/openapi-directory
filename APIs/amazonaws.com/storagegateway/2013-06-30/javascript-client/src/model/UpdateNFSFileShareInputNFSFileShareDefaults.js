...
/**
 * The UpdateNFSFileShareInputNFSFileShareDefaults model module.
 * @module model/UpdateNFSFileShareInputNFSFileShareDefaults
 * @version 2013-06-30
 */
class UpdateNFSFileShareInputNFSFileShareDefaults {
    /**
     * Constructs a new <code>UpdateNFSFileShareInputNFSFileShareDefaults</code>.
     * @alias module:model/UpdateNFSFileShareInputNFSFileShareDefaults
     * @implements module:model/NFSFileShareDefaults
     */
    constructor() { 
        NFSFileShareDefaults.initialize(this);
        UpdateNFSFileShareInputNFSFileShareDefaults.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateNFSFileShareInputNFSFileShareDefaults</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateNFSFileShareInputNFSFileShareDefaults} obj Optional instance to populate.
     * @return {module:model/UpdateNFSFileShareInputNFSFileShareDefaults} The populated <code>UpdateNFSFileShareInputNFSFileShareDefaults</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateNFSFileShareInputNFSFileShareDefaults();
            NFSFileShareDefaults.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateNFSFileShareInputNFSFileShareDefaults</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateNFSFileShareInputNFSFileShareDefaults</code>.
     */
 ...
 */
UpdateNFSFileShareInputNFSFileShareDefaults.prototype['FileMode'] = undefined;

/**
 * @member {String} DirectoryMode
 */
UpdateNFSFileShareInputNFSFileShareDefaults.prototype['DirectoryMode'] = undefined;

/**
 * @member {Number} GroupId
 */
UpdateNFSFileShareInputNFSFileShareDefaults.prototype['GroupId'] = undefined;

/**
 * @member {Number} OwnerId
 */
UpdateNFSFileShareInputNFSFileShareDefaults.prototype['OwnerId'] = undefined;


// Implement NFSFileShareDefaults interface:
/**
 * @member {String} FileMode
 */
...
export default UpdateNFSFileShareInputNFSFileShareDefaults;
