...
/**
 * The DeleteVolumeInput model module.
 * @module model/DeleteVolumeInput
 * @version 2013-06-30
 */
class DeleteVolumeInput {
    /**
     * Constructs a new <code>DeleteVolumeInput</code>.
     * A JSON object containing the &lt;a&gt;DeleteVolumeInput$VolumeARN&lt;/a&gt; to delete.
     * @alias module:model/DeleteVolumeInput
     * @param volumeARN {String} 
     */
    constructor(volumeARN) { 
        
        DeleteVolumeInput.initialize(this, volumeARN);
    }
    ...
    /**
     * Constructs a <code>DeleteVolumeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteVolumeInput} obj Optional instance to populate.
     * @return {module:model/DeleteVolumeInput} The populated <code>DeleteVolumeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteVolumeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteVolumeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteVolumeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteVolumeInput.RequiredProperties) {
...
DeleteVolumeInput.RequiredProperties = ["VolumeARN"];

/**
 * @member {String} VolumeARN
 */
DeleteVolumeInput.prototype['VolumeARN'] = undefined;
...
export default DeleteVolumeInput;
