...
/**
 * The ListFileSystemAssociationsInput model module.
 * @module model/ListFileSystemAssociationsInput
 * @version 2013-06-30
 */
class ListFileSystemAssociationsInput {
    /**
     * Constructs a new <code>ListFileSystemAssociationsInput</code>.
     * @alias module:model/ListFileSystemAssociationsInput
     */
    constructor() { 
        
        ListFileSystemAssociationsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFileSystemAssociationsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFileSystemAssociationsInput} obj Optional instance to populate.
     * @return {module:model/ListFileSystemAssociationsInput} The populated <code>ListFileSystemAssociationsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFileSystemAssociationsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListFileSystemAssociationsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFileSystemAssociationsInput</code>.
     */
 ...
 */
ListFileSystemAssociationsInput.prototype['GatewayARN'] = undefined;

/**
 * @member {Number} Limit
 */
ListFileSystemAssociationsInput.prototype['Limit'] = undefined;

/**
 * @member {String} Marker
 */
ListFileSystemAssociationsInput.prototype['Marker'] = undefined;
...
export default ListFileSystemAssociationsInput;
