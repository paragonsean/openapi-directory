...
* @readonly
*/
export default class ObjectACL {
    ...
    /**
    * Returns a <code>ObjectACL</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ObjectACL} The enum <code>ObjectACL</code> value.
    */
