...
/**
 * The DescribeSMBFileSharesInput model module.
 * @module model/DescribeSMBFileSharesInput
 * @version 2013-06-30
 */
class DescribeSMBFileSharesInput {
    /**
     * Constructs a new <code>DescribeSMBFileSharesInput</code>.
     * DescribeSMBFileSharesInput
     * @alias module:model/DescribeSMBFileSharesInput
     * @param fileShareARNList {Array} 
     */
    constructor(fileShareARNList) { 
        
        DescribeSMBFileSharesInput.initialize(this, fileShareARNList);
    }
     ...
     */
    static initialize(obj, fileShareARNList) { 
        obj['FileShareARNList'] = fileShareARNList;
    }

    /**
     * Constructs a <code>DescribeSMBFileSharesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeSMBFileSharesInput} obj Optional instance to populate.
     * @return {module:model/DescribeSMBFileSharesInput} The populated <code>DescribeSMBFileSharesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeSMBFileSharesInput();

            if (data.hasOwnProperty('FileShareARNList')) {
                obj['FileShareARNList'] = ApiClient.convertToType(data['FileShareARNList'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeSMBFileSharesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeSMBFileSharesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeSMBFileSharesInput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `FileShareARNList`
        if (data['FileShareARNList']) { // data not null
          Array.validateJSON(data['FileShareARNList']);
        }
...
DescribeSMBFileSharesInput.RequiredProperties = ["FileShareARNList"];

/**
 * @member {Array} FileShareARNList
 */
DescribeSMBFileSharesInput.prototype['FileShareARNList'] = undefined;
...
export default DescribeSMBFileSharesInput;
