...
/**
 * The CancelRetrievalInput model module.
 * @module model/CancelRetrievalInput
 * @version 2013-06-30
 */
class CancelRetrievalInput {
    /**
     * Constructs a new <code>CancelRetrievalInput</code>.
     * CancelRetrievalInput
     * @alias module:model/CancelRetrievalInput
    ...
    constructor(gatewayARN, tapeARN) { 
        ...
        CancelRetrievalInput.initialize(this, gatewayARN, tapeARN);
    }
    ...
    /**
     * Constructs a <code>CancelRetrievalInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelRetrievalInput} obj Optional instance to populate.
     * @return {module:model/CancelRetrievalInput} The populated <code>CancelRetrievalInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelRetrievalInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelRetrievalInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelRetrievalInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CancelRetrievalInput.RequiredProperties) {
...
CancelRetrievalInput.RequiredProperties = ["GatewayARN", "TapeARN"];
 ...
 */
CancelRetrievalInput.prototype['GatewayARN'] = undefined;

/**
 * @member {String} TapeARN
 */
CancelRetrievalInput.prototype['TapeARN'] = undefined;
...
export default CancelRetrievalInput;
