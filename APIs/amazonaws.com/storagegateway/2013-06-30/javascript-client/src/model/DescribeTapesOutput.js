...
/**
 * The DescribeTapesOutput model module.
 * @module model/DescribeTapesOutput
 * @version 2013-06-30
 */
class DescribeTapesOutput {
    /**
     * Constructs a new <code>DescribeTapesOutput</code>.
     * DescribeTapesOutput
     * @alias module:model/DescribeTapesOutput
     */
    constructor() { 
        
        DescribeTapesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeTapesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTapesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeTapesOutput} The populated <code>DescribeTapesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTapesOutput();

            if (data.hasOwnProperty('Tapes')) {
                obj['Tapes'] = ApiClient.convertToType(data['Tapes'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTapesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTapesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Tapes`
        if (data['Tapes']) { // data not null
          Array.validateJSON(data['Tapes']);
        }
 ...
 * @member {Array} Tapes
 */
DescribeTapesOutput.prototype['Tapes'] = undefined;

/**
 * @member {String} Marker
 */
DescribeTapesOutput.prototype['Marker'] = undefined;
...
export default DescribeTapesOutput;
