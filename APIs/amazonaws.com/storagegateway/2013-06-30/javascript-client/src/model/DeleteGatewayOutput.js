...
/**
 * The DeleteGatewayOutput model module.
 * @module model/DeleteGatewayOutput
 * @version 2013-06-30
 */
class DeleteGatewayOutput {
    /**
     * Constructs a new <code>DeleteGatewayOutput</code>.
     * A JSON object containing the ID of the deleted gateway.
     * @alias module:model/DeleteGatewayOutput
     */
    constructor() { 
        
        DeleteGatewayOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteGatewayOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteGatewayOutput} obj Optional instance to populate.
     * @return {module:model/DeleteGatewayOutput} The populated <code>DeleteGatewayOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteGatewayOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteGatewayOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteGatewayOutput</code>.
     */
 ...
 */
DeleteGatewayOutput.prototype['GatewayARN'] = undefined;
...
export default DeleteGatewayOutput;
