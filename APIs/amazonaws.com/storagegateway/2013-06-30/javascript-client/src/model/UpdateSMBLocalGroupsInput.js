...
import UpdateSMBLocalGroupsInputSMBLocalGroups from './UpdateSMBLocalGroupsInputSMBLocalGroups';

/**
 * The UpdateSMBLocalGroupsInput model module.
 * @module model/UpdateSMBLocalGroupsInput
 * @version 2013-06-30
 */
class UpdateSMBLocalGroupsInput {
    /**
     * Constructs a new <code>UpdateSMBLocalGroupsInput</code>.
     * @alias module:model/UpdateSMBLocalGroupsInput
     ...
     * @param sMBLocalGroups {module:model/UpdateSMBLocalGroupsInputSMBLocalGroups} 
     */
    constructor(gatewayARN, sMBLocalGroups) { 
        
        UpdateSMBLocalGroupsInput.initialize(this, gatewayARN, sMBLocalGroups);
    }
     ...
     */
    static initialize(obj, gatewayARN, sMBLocalGroups) { 
        obj['GatewayARN'] = gatewayARN;
        obj['SMBLocalGroups'] = sMBLocalGroups;
    }

    /**
     * Constructs a <code>UpdateSMBLocalGroupsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSMBLocalGroupsInput} obj Optional instance to populate.
     * @return {module:model/UpdateSMBLocalGroupsInput} The populated <code>UpdateSMBLocalGroupsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSMBLocalGroupsInput();

            if (data.hasOwnProperty('GatewayARN')) {
                obj['GatewayARN'] = ApiClient.convertToType(data['GatewayARN'], 'String');
            }
            if (data.hasOwnProperty('SMBLocalGroups')) {
                obj['SMBLocalGroups'] = UpdateSMBLocalGroupsInputSMBLocalGroups.constructFromObject(data['SMBLocalGroups']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSMBLocalGroupsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSMBLocalGroupsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateSMBLocalGroupsInput.RequiredProperties) {
        ...
        if (data['SMBLocalGroups']) { // data not null
          UpdateSMBLocalGroupsInputSMBLocalGroups.validateJSON(data['SMBLocalGroups']);
        }
...
UpdateSMBLocalGroupsInput.RequiredProperties = ["GatewayARN", "SMBLocalGroups"];
 ...
 */
UpdateSMBLocalGroupsInput.prototype['GatewayARN'] = undefined;

/**
 * @member {module:model/UpdateSMBLocalGroupsInputSMBLocalGroups} SMBLocalGroups
 */
UpdateSMBLocalGroupsInput.prototype['SMBLocalGroups'] = undefined;
...
export default UpdateSMBLocalGroupsInput;
