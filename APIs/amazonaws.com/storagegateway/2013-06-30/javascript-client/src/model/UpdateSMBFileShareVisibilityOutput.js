...
/**
 * The UpdateSMBFileShareVisibilityOutput model module.
 * @module model/UpdateSMBFileShareVisibilityOutput
 * @version 2013-06-30
 */
class UpdateSMBFileShareVisibilityOutput {
    /**
     * Constructs a new <code>UpdateSMBFileShareVisibilityOutput</code>.
     * @alias module:model/UpdateSMBFileShareVisibilityOutput
     */
    constructor() { 
        
        UpdateSMBFileShareVisibilityOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSMBFileShareVisibilityOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSMBFileShareVisibilityOutput} obj Optional instance to populate.
     * @return {module:model/UpdateSMBFileShareVisibilityOutput} The populated <code>UpdateSMBFileShareVisibilityOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSMBFileShareVisibilityOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSMBFileShareVisibilityOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSMBFileShareVisibilityOutput</code>.
     */
 ...
 */
UpdateSMBFileShareVisibilityOutput.prototype['GatewayARN'] = undefined;
...
export default UpdateSMBFileShareVisibilityOutput;
