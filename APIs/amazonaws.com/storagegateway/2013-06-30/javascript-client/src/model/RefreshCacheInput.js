...
/**
 * The RefreshCacheInput model module.
 * @module model/RefreshCacheInput
 * @version 2013-06-30
 */
class RefreshCacheInput {
    /**
     * Constructs a new <code>RefreshCacheInput</code>.
     * RefreshCacheInput
     * @alias module:model/RefreshCacheInput
     * @param fileShareARN {String} 
     */
    constructor(fileShareARN) { 
        
        RefreshCacheInput.initialize(this, fileShareARN);
    }
    ...
    /**
     * Constructs a <code>RefreshCacheInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RefreshCacheInput} obj Optional instance to populate.
     * @return {module:model/RefreshCacheInput} The populated <code>RefreshCacheInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RefreshCacheInput();

            if (data.hasOwnProperty('FileShareARN')) {
                obj['FileShareARN'] = ApiClient.convertToType(data['FileShareARN'], 'String');
            }
            if (data.hasOwnProperty('FolderList')) {
                obj['FolderList'] = ApiClient.convertToType(data['FolderList'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RefreshCacheInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RefreshCacheInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RefreshCacheInput.RequiredProperties) {
        ...
        if (data['FolderList']) { // data not null
          Array.validateJSON(data['FolderList']);
        }
        // validate the optional field `Recursive`
        if (data['Recursive']) { // data not null
          Boolean.validateJSON(data['Recursive']);
        }
...
RefreshCacheInput.RequiredProperties = ["FileShareARN"];

/**
 * @member {String} FileShareARN
 */
RefreshCacheInput.prototype['FileShareARN'] = undefined;

/**
 * @member {Array} FolderList
 */
RefreshCacheInput.prototype['FolderList'] = undefined;

/**
 * @member {Boolean} Recursive
 */
RefreshCacheInput.prototype['Recursive'] = undefined;
...
export default RefreshCacheInput;
