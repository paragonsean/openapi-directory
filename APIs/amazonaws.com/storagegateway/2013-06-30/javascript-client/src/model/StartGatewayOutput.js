...
/**
 * The StartGatewayOutput model module.
 * @module model/StartGatewayOutput
 * @version 2013-06-30
 */
class StartGatewayOutput {
    /**
     * Constructs a new <code>StartGatewayOutput</code>.
     * A JSON object containing the Amazon Resource Name (ARN) of the gateway that was restarted.
     * @alias module:model/StartGatewayOutput
     */
    constructor() { 
        
        StartGatewayOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartGatewayOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartGatewayOutput} obj Optional instance to populate.
     * @return {module:model/StartGatewayOutput} The populated <code>StartGatewayOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartGatewayOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>StartGatewayOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartGatewayOutput</code>.
     */
 ...
 */
StartGatewayOutput.prototype['GatewayARN'] = undefined;
...
export default StartGatewayOutput;
