...
/**
 * The ListGatewaysInput model module.
 * @module model/ListGatewaysInput
 * @version 2013-06-30
 */
class ListGatewaysInput {
    /**
     * Constructs a new <code>ListGatewaysInput</code>.
     ...
     * @alias module:model/ListGatewaysInput
     */
    constructor() { 
        
        ListGatewaysInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListGatewaysInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGatewaysInput} obj Optional instance to populate.
     * @return {module:model/ListGatewaysInput} The populated <code>ListGatewaysInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGatewaysInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListGatewaysInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGatewaysInput</code>.
     */
 ...
 */
ListGatewaysInput.prototype['Marker'] = undefined;

/**
 * @member {Number} Limit
 */
ListGatewaysInput.prototype['Limit'] = undefined;
...
export default ListGatewaysInput;
