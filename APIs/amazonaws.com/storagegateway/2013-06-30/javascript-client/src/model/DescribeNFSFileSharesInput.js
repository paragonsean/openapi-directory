...
/**
 * The DescribeNFSFileSharesInput model module.
 * @module model/DescribeNFSFileSharesInput
 * @version 2013-06-30
 */
class DescribeNFSFileSharesInput {
    /**
     * Constructs a new <code>DescribeNFSFileSharesInput</code>.
     * DescribeNFSFileSharesInput
     * @alias module:model/DescribeNFSFileSharesInput
     * @param fileShareARNList {Array} 
     */
    constructor(fileShareARNList) { 
        
        DescribeNFSFileSharesInput.initialize(this, fileShareARNList);
    }
    ...
    /**
     * Constructs a <code>DescribeNFSFileSharesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeNFSFileSharesInput} obj Optional instance to populate.
     * @return {module:model/DescribeNFSFileSharesInput} The populated <code>DescribeNFSFileSharesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeNFSFileSharesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeNFSFileSharesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeNFSFileSharesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeNFSFileSharesInput.RequiredProperties) {
...
DescribeNFSFileSharesInput.RequiredProperties = ["FileShareARNList"];

/**
 * @member {Array} FileShareARNList
 */
DescribeNFSFileSharesInput.prototype['FileShareARNList'] = undefined;
...
export default DescribeNFSFileSharesInput;
