...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://storagegateway.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://storagegateway.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2013-06-30/Javascript'
        };
