...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CancelArchivalOutput();
  });
  ...
  describe('CancelArchivalOutput', function() {
    it('should create an instance of CancelArchivalOutput', function() {
      // uncomment below and update the code to test CancelArchivalOutput
      //var instance = new AwsStorageGateway.CancelArchivalOutput();
      //expect(instance).to.be.a(AwsStorageGateway.CancelArchivalOutput);
    });
