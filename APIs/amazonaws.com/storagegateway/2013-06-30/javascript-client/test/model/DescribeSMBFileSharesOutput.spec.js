...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeSMBFileSharesOutput();
  });
  ...
  describe('DescribeSMBFileSharesOutput', function() {
    it('should create an instance of DescribeSMBFileSharesOutput', function() {
      // uncomment below and update the code to test DescribeSMBFileSharesOutput
      //var instance = new AwsStorageGateway.DescribeSMBFileSharesOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeSMBFileSharesOutput);
    });

    it('should have the property sMBFileShareInfoList (base name: "SMBFileShareInfoList")', function() {
      // uncomment below and update the code to test the property sMBFileShareInfoList
      //var instance = new AwsStorageGateway.DescribeSMBFileSharesOutput();
