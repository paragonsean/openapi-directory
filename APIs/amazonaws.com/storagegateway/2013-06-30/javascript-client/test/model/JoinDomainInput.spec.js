...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.JoinDomainInput();
  });
  ...
  describe('JoinDomainInput', function() {
    it('should create an instance of JoinDomainInput', function() {
      // uncomment below and update the code to test JoinDomainInput
      //var instance = new AwsStorageGateway.JoinDomainInput();
      //expect(instance).to.be.a(AwsStorageGateway.JoinDomainInput);
    });
    ...
    it('should have the property domainControllers (base name: "DomainControllers")', function() {
      // uncomment below and update the code to test the property domainControllers
      //var instance = new AwsStorageGateway.JoinDomainInput();
      //expect(instance).to.be();
    });
