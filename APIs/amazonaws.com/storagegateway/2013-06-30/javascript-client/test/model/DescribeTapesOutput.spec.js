...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeTapesOutput();
  });
  ...
  describe('DescribeTapesOutput', function() {
    it('should create an instance of DescribeTapesOutput', function() {
      // uncomment below and update the code to test DescribeTapesOutput
      //var instance = new AwsStorageGateway.DescribeTapesOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeTapesOutput);
    });
