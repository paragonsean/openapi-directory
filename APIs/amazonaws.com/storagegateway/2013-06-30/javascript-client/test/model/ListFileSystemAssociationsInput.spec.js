...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListFileSystemAssociationsInput();
  });
  ...
  describe('ListFileSystemAssociationsInput', function() {
    it('should create an instance of ListFileSystemAssociationsInput', function() {
      // uncomment below and update the code to test ListFileSystemAssociationsInput
      //var instance = new AwsStorageGateway.ListFileSystemAssociationsInput();
      //expect(instance).to.be.a(AwsStorageGateway.ListFileSystemAssociationsInput);
    });
