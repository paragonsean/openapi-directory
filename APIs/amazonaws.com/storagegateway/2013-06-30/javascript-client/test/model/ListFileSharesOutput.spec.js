...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListFileSharesOutput();
  });
  ...
  describe('ListFileSharesOutput', function() {
    it('should create an instance of ListFileSharesOutput', function() {
      // uncomment below and update the code to test ListFileSharesOutput
      //var instance = new AwsStorageGateway.ListFileSharesOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ListFileSharesOutput);
    });
    ...
    it('should have the property fileShareInfoList (base name: "FileShareInfoList")', function() {
      // uncomment below and update the code to test the property fileShareInfoList
      //var instance = new AwsStorageGateway.ListFileSharesOutput();
      //expect(instance).to.be();
    });
