...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AddWorkingStorageOutput();
  });
  ...
  describe('AddWorkingStorageOutput', function() {
    it('should create an instance of AddWorkingStorageOutput', function() {
      // uncomment below and update the code to test AddWorkingStorageOutput
      //var instance = new AwsStorageGateway.AddWorkingStorageOutput();
      //expect(instance).to.be.a(AwsStorageGateway.AddWorkingStorageOutput);
    });
