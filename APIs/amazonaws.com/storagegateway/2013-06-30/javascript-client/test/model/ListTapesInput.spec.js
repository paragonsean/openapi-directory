...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListTapesInput();
  });
  ...
  describe('ListTapesInput', function() {
    it('should create an instance of ListTapesInput', function() {
      // uncomment below and update the code to test ListTapesInput
      //var instance = new AwsStorageGateway.ListTapesInput();
      //expect(instance).to.be.a(AwsStorageGateway.ListTapesInput);
    });
