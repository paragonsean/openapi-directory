...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateSnapshotFromVolumeRecoveryPointOutput();
  });
  ...
  describe('CreateSnapshotFromVolumeRecoveryPointOutput', function() {
    it('should create an instance of CreateSnapshotFromVolumeRecoveryPointOutput', function() {
      // uncomment below and update the code to test CreateSnapshotFromVolumeRecoveryPointOutput
      //var instance = new AwsStorageGateway.CreateSnapshotFromVolumeRecoveryPointOutput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateSnapshotFromVolumeRecoveryPointOutput);
    });
    ...
    it('should have the property volumeARN (base name: "VolumeARN")', function() {
      // uncomment below and update the code to test the property volumeARN
      //var instance = new AwsStorageGateway.CreateSnapshotFromVolumeRecoveryPointOutput();
      //expect(instance).to.be();
    });

    it('should have the property volumeRecoveryPointTime (base name: "VolumeRecoveryPointTime")', function() {
      // uncomment below and update the code to test the property volumeRecoveryPointTime
      //var instance = new AwsStorageGateway.CreateSnapshotFromVolumeRecoveryPointOutput();
      //expect(instance).to.be();
    });
