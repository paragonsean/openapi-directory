...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ActivateGatewayOutput();
  });
  ...
  describe('ActivateGatewayOutput', function() {
    it('should create an instance of ActivateGatewayOutput', function() {
      // uncomment below and update the code to test ActivateGatewayOutput
      //var instance = new AwsStorageGateway.ActivateGatewayOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ActivateGatewayOutput);
    });
