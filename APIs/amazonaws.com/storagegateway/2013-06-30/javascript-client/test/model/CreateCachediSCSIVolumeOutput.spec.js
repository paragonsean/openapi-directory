...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateCachediSCSIVolumeOutput();
  });
  ...
  describe('CreateCachediSCSIVolumeOutput', function() {
    it('should create an instance of CreateCachediSCSIVolumeOutput', function() {
      // uncomment below and update the code to test CreateCachediSCSIVolumeOutput
      //var instance = new AwsStorageGateway.CreateCachediSCSIVolumeOutput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateCachediSCSIVolumeOutput);
    });
