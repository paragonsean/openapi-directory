...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteGatewayInput();
  });
  ...
  describe('DeleteGatewayInput', function() {
    it('should create an instance of DeleteGatewayInput', function() {
      // uncomment below and update the code to test DeleteGatewayInput
      //var instance = new AwsStorageGateway.DeleteGatewayInput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteGatewayInput);
    });
