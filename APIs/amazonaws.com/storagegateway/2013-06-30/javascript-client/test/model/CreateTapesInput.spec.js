...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateTapesInput();
  });
  ...
  describe('CreateTapesInput', function() {
    it('should create an instance of CreateTapesInput', function() {
      // uncomment below and update the code to test CreateTapesInput
      //var instance = new AwsStorageGateway.CreateTapesInput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateTapesInput);
    });
    ...
    it('should have the property numTapesToCreate (base name: "NumTapesToCreate")', function() {
      // uncomment below and update the code to test the property numTapesToCreate
      //var instance = new AwsStorageGateway.CreateTapesInput();
      //expect(instance).to.be();
    });
