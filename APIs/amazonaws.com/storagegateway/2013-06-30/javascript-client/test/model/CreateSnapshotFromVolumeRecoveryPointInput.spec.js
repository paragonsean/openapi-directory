...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateSnapshotFromVolumeRecoveryPointInput();
  });
  ...
  describe('CreateSnapshotFromVolumeRecoveryPointInput', function() {
    it('should create an instance of CreateSnapshotFromVolumeRecoveryPointInput', function() {
      // uncomment below and update the code to test CreateSnapshotFromVolumeRecoveryPointInput
      //var instance = new AwsStorageGateway.CreateSnapshotFromVolumeRecoveryPointInput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateSnapshotFromVolumeRecoveryPointInput);
    });
