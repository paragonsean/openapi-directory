...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeBandwidthRateLimitScheduleOutput();
  });
  ...
  describe('DescribeBandwidthRateLimitScheduleOutput', function() {
    it('should create an instance of DescribeBandwidthRateLimitScheduleOutput', function() {
      // uncomment below and update the code to test DescribeBandwidthRateLimitScheduleOutput
      //var instance = new AwsStorageGateway.DescribeBandwidthRateLimitScheduleOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeBandwidthRateLimitScheduleOutput);
    });
    ...
    it('should have the property bandwidthRateLimitIntervals (base name: "BandwidthRateLimitIntervals")', function() {
      // uncomment below and update the code to test the property bandwidthRateLimitIntervals
      //var instance = new AwsStorageGateway.DescribeBandwidthRateLimitScheduleOutput();
      //expect(instance).to.be();
    });
