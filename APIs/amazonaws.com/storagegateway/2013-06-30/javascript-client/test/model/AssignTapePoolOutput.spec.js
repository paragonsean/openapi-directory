...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AssignTapePoolOutput();
  });
  ...
  describe('AssignTapePoolOutput', function() {
    it('should create an instance of AssignTapePoolOutput', function() {
      // uncomment below and update the code to test AssignTapePoolOutput
      //var instance = new AwsStorageGateway.AssignTapePoolOutput();
      //expect(instance).to.be.a(AwsStorageGateway.AssignTapePoolOutput);
    });
