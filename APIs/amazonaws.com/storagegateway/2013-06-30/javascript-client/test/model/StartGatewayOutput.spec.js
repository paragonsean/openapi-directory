...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.StartGatewayOutput();
  });
  ...
  describe('StartGatewayOutput', function() {
    it('should create an instance of StartGatewayOutput', function() {
      // uncomment below and update the code to test StartGatewayOutput
      //var instance = new AwsStorageGateway.StartGatewayOutput();
      //expect(instance).to.be.a(AwsStorageGateway.StartGatewayOutput);
    });
