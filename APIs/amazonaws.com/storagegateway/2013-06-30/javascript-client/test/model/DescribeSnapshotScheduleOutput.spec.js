...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeSnapshotScheduleOutput();
  });
  ...
  describe('DescribeSnapshotScheduleOutput', function() {
    it('should create an instance of DescribeSnapshotScheduleOutput', function() {
      // uncomment below and update the code to test DescribeSnapshotScheduleOutput
      //var instance = new AwsStorageGateway.DescribeSnapshotScheduleOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeSnapshotScheduleOutput);
    });
