...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.RefreshCacheOutput();
  });
  ...
  describe('RefreshCacheOutput', function() {
    it('should create an instance of RefreshCacheOutput', function() {
      // uncomment below and update the code to test RefreshCacheOutput
      //var instance = new AwsStorageGateway.RefreshCacheOutput();
      //expect(instance).to.be.a(AwsStorageGateway.RefreshCacheOutput);
    });
