...
(function(root, factory) {
  ...
  describe('FileShareType', function() {
    it('should create an instance of FileShareType', function() {
      // uncomment below and update the code to test FileShareType
      //var instance = new AwsStorageGateway.FileShareType();
      //expect(instance).to.be.a(AwsStorageGateway.FileShareType);
    });
