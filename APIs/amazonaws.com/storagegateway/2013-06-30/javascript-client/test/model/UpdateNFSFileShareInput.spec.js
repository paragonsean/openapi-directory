...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateNFSFileShareInput();
  });
  ...
  describe('UpdateNFSFileShareInput', function() {
    it('should create an instance of UpdateNFSFileShareInput', function() {
      // uncomment below and update the code to test UpdateNFSFileShareInput
      //var instance = new AwsStorageGateway.UpdateNFSFileShareInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateNFSFileShareInput);
    });
