...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateSMBSecurityStrategyInput();
  });
  ...
  describe('UpdateSMBSecurityStrategyInput', function() {
    it('should create an instance of UpdateSMBSecurityStrategyInput', function() {
      // uncomment below and update the code to test UpdateSMBSecurityStrategyInput
      //var instance = new AwsStorageGateway.UpdateSMBSecurityStrategyInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateSMBSecurityStrategyInput);
    });
