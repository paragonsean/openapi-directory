...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CancelRetrievalInput();
  });
  ...
  describe('CancelRetrievalInput', function() {
    it('should create an instance of CancelRetrievalInput', function() {
      // uncomment below and update the code to test CancelRetrievalInput
      //var instance = new AwsStorageGateway.CancelRetrievalInput();
      //expect(instance).to.be.a(AwsStorageGateway.CancelRetrievalInput);
    });
