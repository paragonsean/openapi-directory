...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.RetrieveTapeArchiveOutput();
  });
  ...
  describe('RetrieveTapeArchiveOutput', function() {
    it('should create an instance of RetrieveTapeArchiveOutput', function() {
      // uncomment below and update the code to test RetrieveTapeArchiveOutput
      //var instance = new AwsStorageGateway.RetrieveTapeArchiveOutput();
      //expect(instance).to.be.a(AwsStorageGateway.RetrieveTapeArchiveOutput);
    });
