...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.SetSMBGuestPasswordOutput();
  });
  ...
  describe('SetSMBGuestPasswordOutput', function() {
    it('should create an instance of SetSMBGuestPasswordOutput', function() {
      // uncomment below and update the code to test SetSMBGuestPasswordOutput
      //var instance = new AwsStorageGateway.SetSMBGuestPasswordOutput();
      //expect(instance).to.be.a(AwsStorageGateway.SetSMBGuestPasswordOutput);
    });
