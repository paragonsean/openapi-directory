...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListAutomaticTapeCreationPoliciesOutput();
  });
  ...
  describe('ListAutomaticTapeCreationPoliciesOutput', function() {
    it('should create an instance of ListAutomaticTapeCreationPoliciesOutput', function() {
      // uncomment below and update the code to test ListAutomaticTapeCreationPoliciesOutput
      //var instance = new AwsStorageGateway.ListAutomaticTapeCreationPoliciesOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ListAutomaticTapeCreationPoliciesOutput);
    });

    it('should have the property automaticTapeCreationPolicyInfos (base name: "AutomaticTapeCreationPolicyInfos")', function() {
      // uncomment below and update the code to test the property automaticTapeCreationPolicyInfos
      //var instance = new AwsStorageGateway.ListAutomaticTapeCreationPoliciesOutput();
