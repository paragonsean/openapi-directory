...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListLocalDisksOutput();
  });
  ...
  describe('ListLocalDisksOutput', function() {
    it('should create an instance of ListLocalDisksOutput', function() {
      // uncomment below and update the code to test ListLocalDisksOutput
      //var instance = new AwsStorageGateway.ListLocalDisksOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ListLocalDisksOutput);
    });
