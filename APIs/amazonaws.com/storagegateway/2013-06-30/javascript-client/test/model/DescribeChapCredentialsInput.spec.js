...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeChapCredentialsInput();
  });
  ...
  describe('DescribeChapCredentialsInput', function() {
    it('should create an instance of DescribeChapCredentialsInput', function() {
      // uncomment below and update the code to test DescribeChapCredentialsInput
      //var instance = new AwsStorageGateway.DescribeChapCredentialsInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeChapCredentialsInput);
    });
