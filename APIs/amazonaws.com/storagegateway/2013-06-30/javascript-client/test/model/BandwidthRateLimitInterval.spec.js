...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.BandwidthRateLimitInterval();
  });
  ...
  describe('BandwidthRateLimitInterval', function() {
    it('should create an instance of BandwidthRateLimitInterval', function() {
      // uncomment below and update the code to test BandwidthRateLimitInterval
      //var instance = new AwsStorageGateway.BandwidthRateLimitInterval();
      //expect(instance).to.be.a(AwsStorageGateway.BandwidthRateLimitInterval);
    });

    it('should have the property startHourOfDay (base name: "StartHourOfDay")', function() {
      // uncomment below and update the code to test the property startHourOfDay
      //var instance = new AwsStorageGateway.BandwidthRateLimitInterval();
      //expect(instance).to.be();
    });

    it('should have the property startMinuteOfHour (base name: "StartMinuteOfHour")', function() {
      // uncomment below and update the code to test the property startMinuteOfHour
      //var instance = new AwsStorageGateway.BandwidthRateLimitInterval();
      //expect(instance).to.be();
    });

    it('should have the property endHourOfDay (base name: "EndHourOfDay")', function() {
      // uncomment below and update the code to test the property endHourOfDay
      //var instance = new AwsStorageGateway.BandwidthRateLimitInterval();
      //expect(instance).to.be();
    });

    it('should have the property endMinuteOfHour (base name: "EndMinuteOfHour")', function() {
      // uncomment below and update the code to test the property endMinuteOfHour
      //var instance = new AwsStorageGateway.BandwidthRateLimitInterval();
      //expect(instance).to.be();
    });
    ...
    it('should have the property averageUploadRateLimitInBitsPerSec (base name: "AverageUploadRateLimitInBitsPerSec")', function() {
      // uncomment below and update the code to test the property averageUploadRateLimitInBitsPerSec
      //var instance = new AwsStorageGateway.BandwidthRateLimitInterval();
      //expect(instance).to.be();
    });

    it('should have the property averageDownloadRateLimitInBitsPerSec (base name: "AverageDownloadRateLimitInBitsPerSec")', function() {
      // uncomment below and update the code to test the property averageDownloadRateLimitInBitsPerSec
      //var instance = new AwsStorageGateway.BandwidthRateLimitInterval();
      //expect(instance).to.be();
    });
