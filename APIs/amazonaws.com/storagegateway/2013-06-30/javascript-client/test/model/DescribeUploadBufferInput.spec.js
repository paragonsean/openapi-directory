...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeUploadBufferInput();
  });
  ...
  describe('DescribeUploadBufferInput', function() {
    it('should create an instance of DescribeUploadBufferInput', function() {
      // uncomment below and update the code to test DescribeUploadBufferInput
      //var instance = new AwsStorageGateway.DescribeUploadBufferInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeUploadBufferInput);
    });
