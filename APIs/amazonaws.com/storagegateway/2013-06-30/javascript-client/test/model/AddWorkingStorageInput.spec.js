...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AddWorkingStorageInput();
  });
  ...
  describe('AddWorkingStorageInput', function() {
    it('should create an instance of AddWorkingStorageInput', function() {
      // uncomment below and update the code to test AddWorkingStorageInput
      //var instance = new AwsStorageGateway.AddWorkingStorageInput();
      //expect(instance).to.be.a(AwsStorageGateway.AddWorkingStorageInput);
    });
