...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CachediSCSIVolumeVolumeiSCSIAttributes();
  });
  ...
  describe('CachediSCSIVolumeVolumeiSCSIAttributes', function() {
    it('should create an instance of CachediSCSIVolumeVolumeiSCSIAttributes', function() {
      // uncomment below and update the code to test CachediSCSIVolumeVolumeiSCSIAttributes
      //var instance = new AwsStorageGateway.CachediSCSIVolumeVolumeiSCSIAttributes();
      //expect(instance).to.be.a(AwsStorageGateway.CachediSCSIVolumeVolumeiSCSIAttributes);
    });
    ...
    it('should have the property networkInterfacePort (base name: "NetworkInterfacePort")', function() {
      // uncomment below and update the code to test the property networkInterfacePort
      //var instance = new AwsStorageGateway.CachediSCSIVolumeVolumeiSCSIAttributes();
      //expect(instance).to.be();
    });

    it('should have the property lunNumber (base name: "LunNumber")', function() {
      // uncomment below and update the code to test the property lunNumber
      //var instance = new AwsStorageGateway.CachediSCSIVolumeVolumeiSCSIAttributes();
      //expect(instance).to.be();
    });

    it('should have the property chapEnabled (base name: "ChapEnabled")', function() {
      // uncomment below and update the code to test the property chapEnabled
      //var instance = new AwsStorageGateway.CachediSCSIVolumeVolumeiSCSIAttributes();
      //expect(instance).to.be();
    });
