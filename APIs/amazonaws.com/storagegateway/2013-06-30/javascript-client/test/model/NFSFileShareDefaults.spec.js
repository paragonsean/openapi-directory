...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.NFSFileShareDefaults();
  });
  ...
  describe('NFSFileShareDefaults', function() {
    it('should create an instance of NFSFileShareDefaults', function() {
      // uncomment below and update the code to test NFSFileShareDefaults
      //var instance = new AwsStorageGateway.NFSFileShareDefaults();
      //expect(instance).to.be.a(AwsStorageGateway.NFSFileShareDefaults);
    });
