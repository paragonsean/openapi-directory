...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateNFSFileShareOutput();
  });
  ...
  describe('UpdateNFSFileShareOutput', function() {
    it('should create an instance of UpdateNFSFileShareOutput', function() {
      // uncomment below and update the code to test UpdateNFSFileShareOutput
      //var instance = new AwsStorageGateway.UpdateNFSFileShareOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateNFSFileShareOutput);
    });
