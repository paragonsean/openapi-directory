...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DetachVolumeInput();
  });
  ...
  describe('DetachVolumeInput', function() {
    it('should create an instance of DetachVolumeInput', function() {
      // uncomment below and update the code to test DetachVolumeInput
      //var instance = new AwsStorageGateway.DetachVolumeInput();
      //expect(instance).to.be.a(AwsStorageGateway.DetachVolumeInput);
    });
    ...
    it('should have the property forceDetach (base name: "ForceDetach")', function() {
      // uncomment below and update the code to test the property forceDetach
      //var instance = new AwsStorageGateway.DetachVolumeInput();
      //expect(instance).to.be();
    });
