...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.FileShareInfo();
  });
  ...
  describe('FileShareInfo', function() {
    it('should create an instance of FileShareInfo', function() {
      // uncomment below and update the code to test FileShareInfo
      //var instance = new AwsStorageGateway.FileShareInfo();
      //expect(instance).to.be.a(AwsStorageGateway.FileShareInfo);
    });

    it('should have the property fileShareType (base name: "FileShareType")', function() {
      // uncomment below and update the code to test the property fileShareType
      //var instance = new AwsStorageGateway.FileShareInfo();
