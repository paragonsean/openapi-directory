...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.FileSystemAssociationInfoEndpointNetworkConfiguration();
  });
  ...
  describe('FileSystemAssociationInfoEndpointNetworkConfiguration', function() {
    it('should create an instance of FileSystemAssociationInfoEndpointNetworkConfiguration', function() {
      // uncomment below and update the code to test FileSystemAssociationInfoEndpointNetworkConfiguration
      //var instance = new AwsStorageGateway.FileSystemAssociationInfoEndpointNetworkConfiguration();
      //expect(instance).to.be.a(AwsStorageGateway.FileSystemAssociationInfoEndpointNetworkConfiguration);
    });
