...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateVTLDeviceTypeInput();
  });
  ...
  describe('UpdateVTLDeviceTypeInput', function() {
    it('should create an instance of UpdateVTLDeviceTypeInput', function() {
      // uncomment below and update the code to test UpdateVTLDeviceTypeInput
      //var instance = new AwsStorageGateway.UpdateVTLDeviceTypeInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateVTLDeviceTypeInput);
    });

    it('should have the property vTLDeviceARN (base name: "VTLDeviceARN")', function() {
      // uncomment below and update the code to test the property vTLDeviceARN
      //var instance = new AwsStorageGateway.UpdateVTLDeviceTypeInput();
