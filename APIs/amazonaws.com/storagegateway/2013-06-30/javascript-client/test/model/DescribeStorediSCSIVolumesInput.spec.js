...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeStorediSCSIVolumesInput();
  });
  ...
  describe('DescribeStorediSCSIVolumesInput', function() {
    it('should create an instance of DescribeStorediSCSIVolumesInput', function() {
      // uncomment below and update the code to test DescribeStorediSCSIVolumesInput
      //var instance = new AwsStorageGateway.DescribeStorediSCSIVolumesInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeStorediSCSIVolumesInput);
    });
