...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateSMBFileShareVisibilityOutput();
  });
  ...
  describe('UpdateSMBFileShareVisibilityOutput', function() {
    it('should create an instance of UpdateSMBFileShareVisibilityOutput', function() {
      // uncomment below and update the code to test UpdateSMBFileShareVisibilityOutput
      //var instance = new AwsStorageGateway.UpdateSMBFileShareVisibilityOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateSMBFileShareVisibilityOutput);
    });
