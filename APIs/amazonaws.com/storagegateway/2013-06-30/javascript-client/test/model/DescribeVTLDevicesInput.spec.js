...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeVTLDevicesInput();
  });
  ...
  describe('DescribeVTLDevicesInput', function() {
    it('should create an instance of DescribeVTLDevicesInput', function() {
      // uncomment below and update the code to test DescribeVTLDevicesInput
      //var instance = new AwsStorageGateway.DescribeVTLDevicesInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeVTLDevicesInput);
    });
    ...
    it('should have the property vTLDeviceARNs (base name: "VTLDeviceARNs")', function() {
      // uncomment below and update the code to test the property vTLDeviceARNs
      //var instance = new AwsStorageGateway.DescribeVTLDevicesInput();
      //expect(instance).to.be();
    });
