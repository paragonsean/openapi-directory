...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeSMBSettingsOutput();
  });
  ...
  describe('DescribeSMBSettingsOutput', function() {
    it('should create an instance of DescribeSMBSettingsOutput', function() {
      // uncomment below and update the code to test DescribeSMBSettingsOutput
      //var instance = new AwsStorageGateway.DescribeSMBSettingsOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeSMBSettingsOutput);
    });
    ...
    it('should have the property activeDirectoryStatus (base name: "ActiveDirectoryStatus")', function() {
      // uncomment below and update the code to test the property activeDirectoryStatus
      //var instance = new AwsStorageGateway.DescribeSMBSettingsOutput();
      //expect(instance).to.be();
    });

    it('should have the property sMBGuestPasswordSet (base name: "SMBGuestPasswordSet")', function() {
      // uncomment below and update the code to test the property sMBGuestPasswordSet
      //var instance = new AwsStorageGateway.DescribeSMBSettingsOutput();
      //expect(instance).to.be();
    });

    it('should have the property sMBSecurityStrategy (base name: "SMBSecurityStrategy")', function() {
      // uncomment below and update the code to test the property sMBSecurityStrategy
      //var instance = new AwsStorageGateway.DescribeSMBSettingsOutput();
      //expect(instance).to.be();
    });

    it('should have the property fileSharesVisible (base name: "FileSharesVisible")', function() {
      // uncomment below and update the code to test the property fileSharesVisible
      //var instance = new AwsStorageGateway.DescribeSMBSettingsOutput();
      //expect(instance).to.be();
    });

    it('should have the property sMBLocalGroups (base name: "SMBLocalGroups")', function() {
      // uncomment below and update the code to test the property sMBLocalGroups
      //var instance = new AwsStorageGateway.DescribeSMBSettingsOutput();
      //expect(instance).to.be();
    });
