...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.NFSFileShareInfoCacheAttributes();
  });
  ...
  describe('NFSFileShareInfoCacheAttributes', function() {
    it('should create an instance of NFSFileShareInfoCacheAttributes', function() {
      // uncomment below and update the code to test NFSFileShareInfoCacheAttributes
      //var instance = new AwsStorageGateway.NFSFileShareInfoCacheAttributes();
      //expect(instance).to.be.a(AwsStorageGateway.NFSFileShareInfoCacheAttributes);
    });
