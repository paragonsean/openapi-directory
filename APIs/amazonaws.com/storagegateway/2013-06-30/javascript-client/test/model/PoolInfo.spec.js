...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.PoolInfo();
  });
  ...
  describe('PoolInfo', function() {
    it('should create an instance of PoolInfo', function() {
      // uncomment below and update the code to test PoolInfo
      //var instance = new AwsStorageGateway.PoolInfo();
      //expect(instance).to.be.a(AwsStorageGateway.PoolInfo);
    });
    ...
    it('should have the property poolStatus (base name: "PoolStatus")', function() {
      // uncomment below and update the code to test the property poolStatus
      //var instance = new AwsStorageGateway.PoolInfo();
      //expect(instance).to.be();
    });
