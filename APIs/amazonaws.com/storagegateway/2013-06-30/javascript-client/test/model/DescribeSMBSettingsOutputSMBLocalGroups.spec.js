...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeSMBSettingsOutputSMBLocalGroups();
  });
  ...
  describe('DescribeSMBSettingsOutputSMBLocalGroups', function() {
    it('should create an instance of DescribeSMBSettingsOutputSMBLocalGroups', function() {
      // uncomment below and update the code to test DescribeSMBSettingsOutputSMBLocalGroups
      //var instance = new AwsStorageGateway.DescribeSMBSettingsOutputSMBLocalGroups();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeSMBSettingsOutputSMBLocalGroups);
    });

    it('should have the property gatewayAdmins (base name: "GatewayAdmins")', function() {
      // uncomment below and update the code to test the property gatewayAdmins
      //var instance = new AwsStorageGateway.DescribeSMBSettingsOutputSMBLocalGroups();
