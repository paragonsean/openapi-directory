...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateSMBFileShareOutput();
  });
  ...
  describe('CreateSMBFileShareOutput', function() {
    it('should create an instance of CreateSMBFileShareOutput', function() {
      // uncomment below and update the code to test CreateSMBFileShareOutput
      //var instance = new AwsStorageGateway.CreateSMBFileShareOutput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateSMBFileShareOutput);
    });
