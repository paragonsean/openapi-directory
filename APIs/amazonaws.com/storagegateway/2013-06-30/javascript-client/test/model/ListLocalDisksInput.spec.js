...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListLocalDisksInput();
  });
  ...
  describe('ListLocalDisksInput', function() {
    it('should create an instance of ListLocalDisksInput', function() {
      // uncomment below and update the code to test ListLocalDisksInput
      //var instance = new AwsStorageGateway.ListLocalDisksInput();
      //expect(instance).to.be.a(AwsStorageGateway.ListLocalDisksInput);
    });
