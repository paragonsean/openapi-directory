...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AddTagsToResourceOutput();
  });
  ...
  describe('AddTagsToResourceOutput', function() {
    it('should create an instance of AddTagsToResourceOutput', function() {
      // uncomment below and update the code to test AddTagsToResourceOutput
      //var instance = new AwsStorageGateway.AddTagsToResourceOutput();
      //expect(instance).to.be.a(AwsStorageGateway.AddTagsToResourceOutput);
    });
