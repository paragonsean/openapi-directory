...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CacheAttributes();
  });
  ...
  describe('CacheAttributes', function() {
    it('should create an instance of CacheAttributes', function() {
      // uncomment below and update the code to test CacheAttributes
      //var instance = new AwsStorageGateway.CacheAttributes();
      //expect(instance).to.be.a(AwsStorageGateway.CacheAttributes);
    });
