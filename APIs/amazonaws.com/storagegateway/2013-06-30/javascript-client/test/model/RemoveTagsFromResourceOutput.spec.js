...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.RemoveTagsFromResourceOutput();
  });
  ...
  describe('RemoveTagsFromResourceOutput', function() {
    it('should create an instance of RemoveTagsFromResourceOutput', function() {
      // uncomment below and update the code to test RemoveTagsFromResourceOutput
      //var instance = new AwsStorageGateway.RemoveTagsFromResourceOutput();
      //expect(instance).to.be.a(AwsStorageGateway.RemoveTagsFromResourceOutput);
    });
