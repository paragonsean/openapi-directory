...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.VolumeRecoveryPointInfo();
  });
  ...
  describe('VolumeRecoveryPointInfo', function() {
    it('should create an instance of VolumeRecoveryPointInfo', function() {
      // uncomment below and update the code to test VolumeRecoveryPointInfo
      //var instance = new AwsStorageGateway.VolumeRecoveryPointInfo();
      //expect(instance).to.be.a(AwsStorageGateway.VolumeRecoveryPointInfo);
    });
