...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.NotifyWhenUploadedOutput();
  });
  ...
  describe('NotifyWhenUploadedOutput', function() {
    it('should create an instance of NotifyWhenUploadedOutput', function() {
      // uncomment below and update the code to test NotifyWhenUploadedOutput
      //var instance = new AwsStorageGateway.NotifyWhenUploadedOutput();
      //expect(instance).to.be.a(AwsStorageGateway.NotifyWhenUploadedOutput);
    });
