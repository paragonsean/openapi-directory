...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateBandwidthRateLimitScheduleOutput();
  });
  ...
  describe('UpdateBandwidthRateLimitScheduleOutput', function() {
    it('should create an instance of UpdateBandwidthRateLimitScheduleOutput', function() {
      // uncomment below and update the code to test UpdateBandwidthRateLimitScheduleOutput
      //var instance = new AwsStorageGateway.UpdateBandwidthRateLimitScheduleOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateBandwidthRateLimitScheduleOutput);
    });
