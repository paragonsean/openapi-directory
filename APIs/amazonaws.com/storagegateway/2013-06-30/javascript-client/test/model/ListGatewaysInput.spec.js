...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListGatewaysInput();
  });
  ...
  describe('ListGatewaysInput', function() {
    it('should create an instance of ListGatewaysInput', function() {
      // uncomment below and update the code to test ListGatewaysInput
      //var instance = new AwsStorageGateway.ListGatewaysInput();
      //expect(instance).to.be.a(AwsStorageGateway.ListGatewaysInput);
    });
