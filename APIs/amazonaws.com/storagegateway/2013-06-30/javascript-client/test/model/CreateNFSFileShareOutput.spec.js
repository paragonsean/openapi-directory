...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateNFSFileShareOutput();
  });
  ...
  describe('CreateNFSFileShareOutput', function() {
    it('should create an instance of CreateNFSFileShareOutput', function() {
      // uncomment below and update the code to test CreateNFSFileShareOutput
      //var instance = new AwsStorageGateway.CreateNFSFileShareOutput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateNFSFileShareOutput);
    });
