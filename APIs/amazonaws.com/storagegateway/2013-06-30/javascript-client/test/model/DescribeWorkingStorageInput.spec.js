...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeWorkingStorageInput();
  });
  ...
  describe('DescribeWorkingStorageInput', function() {
    it('should create an instance of DescribeWorkingStorageInput', function() {
      // uncomment below and update the code to test DescribeWorkingStorageInput
      //var instance = new AwsStorageGateway.DescribeWorkingStorageInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeWorkingStorageInput);
    });
