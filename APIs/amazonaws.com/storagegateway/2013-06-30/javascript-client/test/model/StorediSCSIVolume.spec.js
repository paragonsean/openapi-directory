...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.StorediSCSIVolume();
  });
  ...
  describe('StorediSCSIVolume', function() {
    it('should create an instance of StorediSCSIVolume', function() {
      // uncomment below and update the code to test StorediSCSIVolume
      //var instance = new AwsStorageGateway.StorediSCSIVolume();
      //expect(instance).to.be.a(AwsStorageGateway.StorediSCSIVolume);
    });
    ...
    it('should have the property volumeStatus (base name: "VolumeStatus")', function() {
      // uncomment below and update the code to test the property volumeStatus
      //var instance = new AwsStorageGateway.StorediSCSIVolume();
      //expect(instance).to.be();
    });
    ...
    it('should have the property volumeProgress (base name: "VolumeProgress")', function() {
      // uncomment below and update the code to test the property volumeProgress
      //var instance = new AwsStorageGateway.StorediSCSIVolume();
      //expect(instance).to.be();
    });

    it('should have the property volumeDiskId (base name: "VolumeDiskId")', function() {
      // uncomment below and update the code to test the property volumeDiskId
      //var instance = new AwsStorageGateway.StorediSCSIVolume();
      //expect(instance).to.be();
    });
    ...
    it('should have the property preservedExistingData (base name: "PreservedExistingData")', function() {
      // uncomment below and update the code to test the property preservedExistingData
      //var instance = new AwsStorageGateway.StorediSCSIVolume();
      //expect(instance).to.be();
    });

    it('should have the property volumeiSCSIAttributes (base name: "VolumeiSCSIAttributes")', function() {
      // uncomment below and update the code to test the property volumeiSCSIAttributes
      //var instance = new AwsStorageGateway.StorediSCSIVolume();
      //expect(instance).to.be();
    });
    ...
    it('should have the property volumeUsedInBytes (base name: "VolumeUsedInBytes")', function() {
      // uncomment below and update the code to test the property volumeUsedInBytes
      //var instance = new AwsStorageGateway.StorediSCSIVolume();
      //expect(instance).to.be();
    });
