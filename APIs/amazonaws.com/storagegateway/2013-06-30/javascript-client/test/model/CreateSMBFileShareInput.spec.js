...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateSMBFileShareInput();
  });
  ...
  describe('CreateSMBFileShareInput', function() {
    it('should create an instance of CreateSMBFileShareInput', function() {
      // uncomment below and update the code to test CreateSMBFileShareInput
      //var instance = new AwsStorageGateway.CreateSMBFileShareInput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateSMBFileShareInput);
    });
    ...
    it('should have the property sMBACLEnabled (base name: "SMBACLEnabled")', function() {
      // uncomment below and update the code to test the property sMBACLEnabled
      //var instance = new AwsStorageGateway.CreateSMBFileShareInput();
      //expect(instance).to.be();
    });

    it('should have the property accessBasedEnumeration (base name: "AccessBasedEnumeration")', function() {
      // uncomment below and update the code to test the property accessBasedEnumeration
      //var instance = new AwsStorageGateway.CreateSMBFileShareInput();
      //expect(instance).to.be();
    });

    it('should have the property adminUserList (base name: "AdminUserList")', function() {
      // uncomment below and update the code to test the property adminUserList
      //var instance = new AwsStorageGateway.CreateSMBFileShareInput();
      //expect(instance).to.be();
    });

    it('should have the property validUserList (base name: "ValidUserList")', function() {
      // uncomment below and update the code to test the property validUserList
      //var instance = new AwsStorageGateway.CreateSMBFileShareInput();
      //expect(instance).to.be();
    });

    it('should have the property invalidUserList (base name: "InvalidUserList")', function() {
      // uncomment below and update the code to test the property invalidUserList
      //var instance = new AwsStorageGateway.CreateSMBFileShareInput();
      //expect(instance).to.be();
    });
    ...
    it('should have the property oplocksEnabled (base name: "OplocksEnabled")', function() {
      // uncomment below and update the code to test the property oplocksEnabled
      //var instance = new AwsStorageGateway.CreateSMBFileShareInput();
      //expect(instance).to.be();
    });
