...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateGatewaySoftwareNowOutput();
  });
  ...
  describe('UpdateGatewaySoftwareNowOutput', function() {
    it('should create an instance of UpdateGatewaySoftwareNowOutput', function() {
      // uncomment below and update the code to test UpdateGatewaySoftwareNowOutput
      //var instance = new AwsStorageGateway.UpdateGatewaySoftwareNowOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateGatewaySoftwareNowOutput);
    });
