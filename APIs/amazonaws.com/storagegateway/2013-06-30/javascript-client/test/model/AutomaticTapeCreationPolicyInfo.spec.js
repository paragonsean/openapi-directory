...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AutomaticTapeCreationPolicyInfo();
  });
  ...
  describe('AutomaticTapeCreationPolicyInfo', function() {
    it('should create an instance of AutomaticTapeCreationPolicyInfo', function() {
      // uncomment below and update the code to test AutomaticTapeCreationPolicyInfo
      //var instance = new AwsStorageGateway.AutomaticTapeCreationPolicyInfo();
      //expect(instance).to.be.a(AwsStorageGateway.AutomaticTapeCreationPolicyInfo);
    });
