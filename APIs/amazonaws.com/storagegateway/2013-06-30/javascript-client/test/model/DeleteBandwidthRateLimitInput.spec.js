...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteBandwidthRateLimitInput();
  });
  ...
  describe('DeleteBandwidthRateLimitInput', function() {
    it('should create an instance of DeleteBandwidthRateLimitInput', function() {
      // uncomment below and update the code to test DeleteBandwidthRateLimitInput
      //var instance = new AwsStorageGateway.DeleteBandwidthRateLimitInput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteBandwidthRateLimitInput);
    });
    ...
    it('should have the property bandwidthType (base name: "BandwidthType")', function() {
      // uncomment below and update the code to test the property bandwidthType
      //var instance = new AwsStorageGateway.DeleteBandwidthRateLimitInput();
      //expect(instance).to.be();
    });
