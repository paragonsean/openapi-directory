...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeSnapshotScheduleInput();
  });
  ...
  describe('DescribeSnapshotScheduleInput', function() {
    it('should create an instance of DescribeSnapshotScheduleInput', function() {
      // uncomment below and update the code to test DescribeSnapshotScheduleInput
      //var instance = new AwsStorageGateway.DescribeSnapshotScheduleInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeSnapshotScheduleInput);
    });
