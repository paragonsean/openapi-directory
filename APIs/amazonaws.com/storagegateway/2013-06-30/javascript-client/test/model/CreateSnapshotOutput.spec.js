...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateSnapshotOutput();
  });
  ...
  describe('CreateSnapshotOutput', function() {
    it('should create an instance of CreateSnapshotOutput', function() {
      // uncomment below and update the code to test CreateSnapshotOutput
      //var instance = new AwsStorageGateway.CreateSnapshotOutput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateSnapshotOutput);
    });
