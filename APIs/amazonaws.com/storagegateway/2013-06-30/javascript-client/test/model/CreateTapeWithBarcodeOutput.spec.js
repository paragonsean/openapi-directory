...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateTapeWithBarcodeOutput();
  });
  ...
  describe('CreateTapeWithBarcodeOutput', function() {
    it('should create an instance of CreateTapeWithBarcodeOutput', function() {
      // uncomment below and update the code to test CreateTapeWithBarcodeOutput
      //var instance = new AwsStorageGateway.CreateTapeWithBarcodeOutput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateTapeWithBarcodeOutput);
    });
