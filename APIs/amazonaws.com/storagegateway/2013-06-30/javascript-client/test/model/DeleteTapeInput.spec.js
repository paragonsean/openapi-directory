...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteTapeInput();
  });
  ...
  describe('DeleteTapeInput', function() {
    it('should create an instance of DeleteTapeInput', function() {
      // uncomment below and update the code to test DeleteTapeInput
      //var instance = new AwsStorageGateway.DeleteTapeInput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteTapeInput);
    });
