...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListFileSystemAssociationsOutput();
  });
  ...
  describe('ListFileSystemAssociationsOutput', function() {
    it('should create an instance of ListFileSystemAssociationsOutput', function() {
      // uncomment below and update the code to test ListFileSystemAssociationsOutput
      //var instance = new AwsStorageGateway.ListFileSystemAssociationsOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ListFileSystemAssociationsOutput);
    });
    ...
    it('should have the property fileSystemAssociationSummaryList (base name: "FileSystemAssociationSummaryList")', function() {
      // uncomment below and update the code to test the property fileSystemAssociationSummaryList
      //var instance = new AwsStorageGateway.ListFileSystemAssociationsOutput();
      //expect(instance).to.be();
    });
