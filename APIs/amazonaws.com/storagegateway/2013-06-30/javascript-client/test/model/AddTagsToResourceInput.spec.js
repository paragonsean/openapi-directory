...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AddTagsToResourceInput();
  });
  ...
  describe('AddTagsToResourceInput', function() {
    it('should create an instance of AddTagsToResourceInput', function() {
      // uncomment below and update the code to test AddTagsToResourceInput
      //var instance = new AwsStorageGateway.AddTagsToResourceInput();
      //expect(instance).to.be.a(AwsStorageGateway.AddTagsToResourceInput);
    });
