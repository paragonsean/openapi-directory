...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeTapeArchivesOutput();
  });
  ...
  describe('DescribeTapeArchivesOutput', function() {
    it('should create an instance of DescribeTapeArchivesOutput', function() {
      // uncomment below and update the code to test DescribeTapeArchivesOutput
      //var instance = new AwsStorageGateway.DescribeTapeArchivesOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeTapeArchivesOutput);
    });

    it('should have the property tapeArchives (base name: "TapeArchives")', function() {
      // uncomment below and update the code to test the property tapeArchives
      //var instance = new AwsStorageGateway.DescribeTapeArchivesOutput();
