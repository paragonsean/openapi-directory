...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteChapCredentialsOutput();
  });
  ...
  describe('DeleteChapCredentialsOutput', function() {
    it('should create an instance of DeleteChapCredentialsOutput', function() {
      // uncomment below and update the code to test DeleteChapCredentialsOutput
      //var instance = new AwsStorageGateway.DeleteChapCredentialsOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteChapCredentialsOutput);
    });
