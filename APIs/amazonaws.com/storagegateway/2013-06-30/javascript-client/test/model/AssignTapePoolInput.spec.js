...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AssignTapePoolInput();
  });
  ...
  describe('AssignTapePoolInput', function() {
    it('should create an instance of AssignTapePoolInput', function() {
      // uncomment below and update the code to test AssignTapePoolInput
      //var instance = new AwsStorageGateway.AssignTapePoolInput();
      //expect(instance).to.be.a(AwsStorageGateway.AssignTapePoolInput);
    });
