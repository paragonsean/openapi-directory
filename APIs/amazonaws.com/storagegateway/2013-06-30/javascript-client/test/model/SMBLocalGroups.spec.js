...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.SMBLocalGroups();
  });
  ...
  describe('SMBLocalGroups', function() {
    it('should create an instance of SMBLocalGroups', function() {
      // uncomment below and update the code to test SMBLocalGroups
      //var instance = new AwsStorageGateway.SMBLocalGroups();
      //expect(instance).to.be.a(AwsStorageGateway.SMBLocalGroups);
    });
