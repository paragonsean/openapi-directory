...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteFileShareOutput();
  });
  ...
  describe('DeleteFileShareOutput', function() {
    it('should create an instance of DeleteFileShareOutput', function() {
      // uncomment below and update the code to test DeleteFileShareOutput
      //var instance = new AwsStorageGateway.DeleteFileShareOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteFileShareOutput);
    });
