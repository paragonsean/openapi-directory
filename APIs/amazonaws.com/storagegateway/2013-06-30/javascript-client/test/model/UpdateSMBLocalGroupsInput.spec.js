...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateSMBLocalGroupsInput();
  });
  ...
  describe('UpdateSMBLocalGroupsInput', function() {
    it('should create an instance of UpdateSMBLocalGroupsInput', function() {
      // uncomment below and update the code to test UpdateSMBLocalGroupsInput
      //var instance = new AwsStorageGateway.UpdateSMBLocalGroupsInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateSMBLocalGroupsInput);
    });
