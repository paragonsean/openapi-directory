...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeFileSystemAssociationsOutput();
  });
  ...
  describe('DescribeFileSystemAssociationsOutput', function() {
    it('should create an instance of DescribeFileSystemAssociationsOutput', function() {
      // uncomment below and update the code to test DescribeFileSystemAssociationsOutput
      //var instance = new AwsStorageGateway.DescribeFileSystemAssociationsOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeFileSystemAssociationsOutput);
    });

    it('should have the property fileSystemAssociationInfoList (base name: "FileSystemAssociationInfoList")', function() {
      // uncomment below and update the code to test the property fileSystemAssociationInfoList
      //var instance = new AwsStorageGateway.DescribeFileSystemAssociationsOutput();
