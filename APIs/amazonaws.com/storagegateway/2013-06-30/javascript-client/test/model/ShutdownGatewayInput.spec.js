...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ShutdownGatewayInput();
  });
  ...
  describe('ShutdownGatewayInput', function() {
    it('should create an instance of ShutdownGatewayInput', function() {
      // uncomment below and update the code to test ShutdownGatewayInput
      //var instance = new AwsStorageGateway.ShutdownGatewayInput();
      //expect(instance).to.be.a(AwsStorageGateway.ShutdownGatewayInput);
    });
