...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AssociateFileSystemInput();
  });
  ...
  describe('AssociateFileSystemInput', function() {
    it('should create an instance of AssociateFileSystemInput', function() {
      // uncomment below and update the code to test AssociateFileSystemInput
      //var instance = new AwsStorageGateway.AssociateFileSystemInput();
      //expect(instance).to.be.a(AwsStorageGateway.AssociateFileSystemInput);
    });
