...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeSMBFileSharesInput();
  });
  ...
  describe('DescribeSMBFileSharesInput', function() {
    it('should create an instance of DescribeSMBFileSharesInput', function() {
      // uncomment below and update the code to test DescribeSMBFileSharesInput
      //var instance = new AwsStorageGateway.DescribeSMBFileSharesInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeSMBFileSharesInput);
    });

    it('should have the property fileShareARNList (base name: "FileShareARNList")', function() {
      // uncomment below and update the code to test the property fileShareARNList
      //var instance = new AwsStorageGateway.DescribeSMBFileSharesInput();
