...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeBandwidthRateLimitOutput();
  });
  ...
  describe('DescribeBandwidthRateLimitOutput', function() {
    it('should create an instance of DescribeBandwidthRateLimitOutput', function() {
      // uncomment below and update the code to test DescribeBandwidthRateLimitOutput
      //var instance = new AwsStorageGateway.DescribeBandwidthRateLimitOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeBandwidthRateLimitOutput);
    });
