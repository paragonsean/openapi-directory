...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListFileSharesInput();
  });
  ...
  describe('ListFileSharesInput', function() {
    it('should create an instance of ListFileSharesInput', function() {
      // uncomment below and update the code to test ListFileSharesInput
      //var instance = new AwsStorageGateway.ListFileSharesInput();
      //expect(instance).to.be.a(AwsStorageGateway.ListFileSharesInput);
    });
