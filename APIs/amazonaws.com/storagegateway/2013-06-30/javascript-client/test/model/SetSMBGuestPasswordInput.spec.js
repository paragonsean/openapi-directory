...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.SetSMBGuestPasswordInput();
  });
  ...
  describe('SetSMBGuestPasswordInput', function() {
    it('should create an instance of SetSMBGuestPasswordInput', function() {
      // uncomment below and update the code to test SetSMBGuestPasswordInput
      //var instance = new AwsStorageGateway.SetSMBGuestPasswordInput();
      //expect(instance).to.be.a(AwsStorageGateway.SetSMBGuestPasswordInput);
    });
