...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateNFSFileShareInputCacheAttributes();
  });
  ...
  describe('CreateNFSFileShareInputCacheAttributes', function() {
    it('should create an instance of CreateNFSFileShareInputCacheAttributes', function() {
      // uncomment below and update the code to test CreateNFSFileShareInputCacheAttributes
      //var instance = new AwsStorageGateway.CreateNFSFileShareInputCacheAttributes();
      //expect(instance).to.be.a(AwsStorageGateway.CreateNFSFileShareInputCacheAttributes);
    });

    it('should have the property cacheStaleTimeoutInSeconds (base name: "CacheStaleTimeoutInSeconds")', function() {
      // uncomment below and update the code to test the property cacheStaleTimeoutInSeconds
      //var instance = new AwsStorageGateway.CreateNFSFileShareInputCacheAttributes();
