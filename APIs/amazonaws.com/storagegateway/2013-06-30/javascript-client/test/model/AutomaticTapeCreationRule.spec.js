...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AutomaticTapeCreationRule();
  });
  ...
  describe('AutomaticTapeCreationRule', function() {
    it('should create an instance of AutomaticTapeCreationRule', function() {
      // uncomment below and update the code to test AutomaticTapeCreationRule
      //var instance = new AwsStorageGateway.AutomaticTapeCreationRule();
      //expect(instance).to.be.a(AwsStorageGateway.AutomaticTapeCreationRule);
    });

    it('should have the property tapeBarcodePrefix (base name: "TapeBarcodePrefix")', function() {
      // uncomment below and update the code to test the property tapeBarcodePrefix
      //var instance = new AwsStorageGateway.AutomaticTapeCreationRule();
    ...
    it('should have the property tapeSizeInBytes (base name: "TapeSizeInBytes")', function() {
      // uncomment below and update the code to test the property tapeSizeInBytes
      //var instance = new AwsStorageGateway.AutomaticTapeCreationRule();
      //expect(instance).to.be();
    });

    it('should have the property minimumNumTapes (base name: "MinimumNumTapes")', function() {
      // uncomment below and update the code to test the property minimumNumTapes
      //var instance = new AwsStorageGateway.AutomaticTapeCreationRule();
      //expect(instance).to.be();
    });
