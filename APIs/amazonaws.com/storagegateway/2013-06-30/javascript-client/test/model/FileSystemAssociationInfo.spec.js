...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.FileSystemAssociationInfo();
  });
  ...
  describe('FileSystemAssociationInfo', function() {
    it('should create an instance of FileSystemAssociationInfo', function() {
      // uncomment below and update the code to test FileSystemAssociationInfo
      //var instance = new AwsStorageGateway.FileSystemAssociationInfo();
      //expect(instance).to.be.a(AwsStorageGateway.FileSystemAssociationInfo);
    });

    it('should have the property fileSystemAssociationARN (base name: "FileSystemAssociationARN")', function() {
      // uncomment below and update the code to test the property fileSystemAssociationARN
      //var instance = new AwsStorageGateway.FileSystemAssociationInfo();
    ...
    it('should have the property fileSystemAssociationStatus (base name: "FileSystemAssociationStatus")', function() {
      // uncomment below and update the code to test the property fileSystemAssociationStatus
      //var instance = new AwsStorageGateway.FileSystemAssociationInfo();
      //expect(instance).to.be();
    });
    ...
    it('should have the property endpointNetworkConfiguration (base name: "EndpointNetworkConfiguration")', function() {
      // uncomment below and update the code to test the property endpointNetworkConfiguration
      //var instance = new AwsStorageGateway.FileSystemAssociationInfo();
      //expect(instance).to.be();
    });

    it('should have the property fileSystemAssociationStatusDetails (base name: "FileSystemAssociationStatusDetails")', function() {
      // uncomment below and update the code to test the property fileSystemAssociationStatusDetails
      //var instance = new AwsStorageGateway.FileSystemAssociationInfo();
      //expect(instance).to.be();
    });
