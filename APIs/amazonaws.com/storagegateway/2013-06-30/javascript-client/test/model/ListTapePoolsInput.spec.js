...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListTapePoolsInput();
  });
  ...
  describe('ListTapePoolsInput', function() {
    it('should create an instance of ListTapePoolsInput', function() {
      // uncomment below and update the code to test ListTapePoolsInput
      //var instance = new AwsStorageGateway.ListTapePoolsInput();
      //expect(instance).to.be.a(AwsStorageGateway.ListTapePoolsInput);
    });

    it('should have the property poolARNs (base name: "PoolARNs")', function() {
      // uncomment below and update the code to test the property poolARNs
      //var instance = new AwsStorageGateway.ListTapePoolsInput();
