...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeGatewayInformationInput();
  });
  ...
  describe('DescribeGatewayInformationInput', function() {
    it('should create an instance of DescribeGatewayInformationInput', function() {
      // uncomment below and update the code to test DescribeGatewayInformationInput
      //var instance = new AwsStorageGateway.DescribeGatewayInformationInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeGatewayInformationInput);
    });
