...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.VTLDevice();
  });
  ...
  describe('VTLDevice', function() {
    it('should create an instance of VTLDevice', function() {
      // uncomment below and update the code to test VTLDevice
      //var instance = new AwsStorageGateway.VTLDevice();
      //expect(instance).to.be.a(AwsStorageGateway.VTLDevice);
    });
    ...
    it('should have the property vTLDeviceType (base name: "VTLDeviceType")', function() {
      // uncomment below and update the code to test the property vTLDeviceType
      //var instance = new AwsStorageGateway.VTLDevice();
      //expect(instance).to.be();
    });

    it('should have the property vTLDeviceVendor (base name: "VTLDeviceVendor")', function() {
      // uncomment below and update the code to test the property vTLDeviceVendor
      //var instance = new AwsStorageGateway.VTLDevice();
      //expect(instance).to.be();
    });

    it('should have the property vTLDeviceProductIdentifier (base name: "VTLDeviceProductIdentifier")', function() {
      // uncomment below and update the code to test the property vTLDeviceProductIdentifier
      //var instance = new AwsStorageGateway.VTLDevice();
      //expect(instance).to.be();
    });

    it('should have the property deviceiSCSIAttributes (base name: "DeviceiSCSIAttributes")', function() {
      // uncomment below and update the code to test the property deviceiSCSIAttributes
      //var instance = new AwsStorageGateway.VTLDevice();
      //expect(instance).to.be();
    });
