...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.EndpointNetworkConfiguration();
  });
  ...
  describe('EndpointNetworkConfiguration', function() {
    it('should create an instance of EndpointNetworkConfiguration', function() {
      // uncomment below and update the code to test EndpointNetworkConfiguration
      //var instance = new AwsStorageGateway.EndpointNetworkConfiguration();
      //expect(instance).to.be.a(AwsStorageGateway.EndpointNetworkConfiguration);
    });
