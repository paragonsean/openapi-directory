...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.FileSystemAssociationStatusDetail();
  });
  ...
  describe('FileSystemAssociationStatusDetail', function() {
    it('should create an instance of FileSystemAssociationStatusDetail', function() {
      // uncomment below and update the code to test FileSystemAssociationStatusDetail
      //var instance = new AwsStorageGateway.FileSystemAssociationStatusDetail();
      //expect(instance).to.be.a(AwsStorageGateway.FileSystemAssociationStatusDetail);
    });
