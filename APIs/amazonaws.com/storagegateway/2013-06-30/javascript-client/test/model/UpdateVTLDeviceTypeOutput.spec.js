...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateVTLDeviceTypeOutput();
  });
  ...
  describe('UpdateVTLDeviceTypeOutput', function() {
    it('should create an instance of UpdateVTLDeviceTypeOutput', function() {
      // uncomment below and update the code to test UpdateVTLDeviceTypeOutput
      //var instance = new AwsStorageGateway.UpdateVTLDeviceTypeOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateVTLDeviceTypeOutput);
    });
