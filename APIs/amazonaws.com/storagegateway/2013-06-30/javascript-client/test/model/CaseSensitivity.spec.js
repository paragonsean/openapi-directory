...
(function(root, factory) {
  ...
  describe('CaseSensitivity', function() {
    it('should create an instance of CaseSensitivity', function() {
      // uncomment below and update the code to test CaseSensitivity
      //var instance = new AwsStorageGateway.CaseSensitivity();
      //expect(instance).to.be.a(AwsStorageGateway.CaseSensitivity);
    });
