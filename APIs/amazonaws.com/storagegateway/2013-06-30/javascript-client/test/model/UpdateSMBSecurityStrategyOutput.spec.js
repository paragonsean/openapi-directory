...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateSMBSecurityStrategyOutput();
  });
  ...
  describe('UpdateSMBSecurityStrategyOutput', function() {
    it('should create an instance of UpdateSMBSecurityStrategyOutput', function() {
      // uncomment below and update the code to test UpdateSMBSecurityStrategyOutput
      //var instance = new AwsStorageGateway.UpdateSMBSecurityStrategyOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateSMBSecurityStrategyOutput);
    });
