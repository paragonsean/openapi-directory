...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateChapCredentialsInput();
  });
  ...
  describe('UpdateChapCredentialsInput', function() {
    it('should create an instance of UpdateChapCredentialsInput', function() {
      // uncomment below and update the code to test UpdateChapCredentialsInput
      //var instance = new AwsStorageGateway.UpdateChapCredentialsInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateChapCredentialsInput);
    });
