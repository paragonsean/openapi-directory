...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeAvailabilityMonitorTestOutput();
  });
  ...
  describe('DescribeAvailabilityMonitorTestOutput', function() {
    it('should create an instance of DescribeAvailabilityMonitorTestOutput', function() {
      // uncomment below and update the code to test DescribeAvailabilityMonitorTestOutput
      //var instance = new AwsStorageGateway.DescribeAvailabilityMonitorTestOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeAvailabilityMonitorTestOutput);
    });
