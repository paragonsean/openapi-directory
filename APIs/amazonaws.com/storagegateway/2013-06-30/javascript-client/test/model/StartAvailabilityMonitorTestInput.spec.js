...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.StartAvailabilityMonitorTestInput();
  });
  ...
  describe('StartAvailabilityMonitorTestInput', function() {
    it('should create an instance of StartAvailabilityMonitorTestInput', function() {
      // uncomment below and update the code to test StartAvailabilityMonitorTestInput
      //var instance = new AwsStorageGateway.StartAvailabilityMonitorTestInput();
      //expect(instance).to.be.a(AwsStorageGateway.StartAvailabilityMonitorTestInput);
    });
