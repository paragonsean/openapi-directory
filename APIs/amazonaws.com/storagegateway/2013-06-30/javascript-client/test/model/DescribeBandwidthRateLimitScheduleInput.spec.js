...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeBandwidthRateLimitScheduleInput();
  });
  ...
  describe('DescribeBandwidthRateLimitScheduleInput', function() {
    it('should create an instance of DescribeBandwidthRateLimitScheduleInput', function() {
      // uncomment below and update the code to test DescribeBandwidthRateLimitScheduleInput
      //var instance = new AwsStorageGateway.DescribeBandwidthRateLimitScheduleInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeBandwidthRateLimitScheduleInput);
    });
