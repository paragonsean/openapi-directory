...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeNFSFileSharesOutput();
  });
  ...
  describe('DescribeNFSFileSharesOutput', function() {
    it('should create an instance of DescribeNFSFileSharesOutput', function() {
      // uncomment below and update the code to test DescribeNFSFileSharesOutput
      //var instance = new AwsStorageGateway.DescribeNFSFileSharesOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeNFSFileSharesOutput);
    });

    it('should have the property nFSFileShareInfoList (base name: "NFSFileShareInfoList")', function() {
      // uncomment below and update the code to test the property nFSFileShareInfoList
      //var instance = new AwsStorageGateway.DescribeNFSFileSharesOutput();
