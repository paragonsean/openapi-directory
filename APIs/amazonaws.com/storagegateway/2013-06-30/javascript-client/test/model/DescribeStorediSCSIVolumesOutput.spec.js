...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeStorediSCSIVolumesOutput();
  });
  ...
  describe('DescribeStorediSCSIVolumesOutput', function() {
    it('should create an instance of DescribeStorediSCSIVolumesOutput', function() {
      // uncomment below and update the code to test DescribeStorediSCSIVolumesOutput
      //var instance = new AwsStorageGateway.DescribeStorediSCSIVolumesOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeStorediSCSIVolumesOutput);
    });

    it('should have the property storediSCSIVolumes (base name: "StorediSCSIVolumes")', function() {
      // uncomment below and update the code to test the property storediSCSIVolumes
      //var instance = new AwsStorageGateway.DescribeStorediSCSIVolumesOutput();
