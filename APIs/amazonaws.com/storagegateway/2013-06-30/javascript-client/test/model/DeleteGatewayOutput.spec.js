...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteGatewayOutput();
  });
  ...
  describe('DeleteGatewayOutput', function() {
    it('should create an instance of DeleteGatewayOutput', function() {
      // uncomment below and update the code to test DeleteGatewayOutput
      //var instance = new AwsStorageGateway.DeleteGatewayOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteGatewayOutput);
    });
