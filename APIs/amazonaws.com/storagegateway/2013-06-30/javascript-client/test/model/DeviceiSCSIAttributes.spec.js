...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeviceiSCSIAttributes();
  });
  ...
  describe('DeviceiSCSIAttributes', function() {
    it('should create an instance of DeviceiSCSIAttributes', function() {
      // uncomment below and update the code to test DeviceiSCSIAttributes
      //var instance = new AwsStorageGateway.DeviceiSCSIAttributes();
      //expect(instance).to.be.a(AwsStorageGateway.DeviceiSCSIAttributes);
    });
