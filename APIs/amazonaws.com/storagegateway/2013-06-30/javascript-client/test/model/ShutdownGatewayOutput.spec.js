...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ShutdownGatewayOutput();
  });
  ...
  describe('ShutdownGatewayOutput', function() {
    it('should create an instance of ShutdownGatewayOutput', function() {
      // uncomment below and update the code to test ShutdownGatewayOutput
      //var instance = new AwsStorageGateway.ShutdownGatewayOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ShutdownGatewayOutput);
    });
