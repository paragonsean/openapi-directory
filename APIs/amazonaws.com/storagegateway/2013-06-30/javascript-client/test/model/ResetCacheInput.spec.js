...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ResetCacheInput();
  });
  ...
  describe('ResetCacheInput', function() {
    it('should create an instance of ResetCacheInput', function() {
      // uncomment below and update the code to test ResetCacheInput
      //var instance = new AwsStorageGateway.ResetCacheInput();
      //expect(instance).to.be.a(AwsStorageGateway.ResetCacheInput);
    });
