...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteAutomaticTapeCreationPolicyInput();
  });
  ...
  describe('DeleteAutomaticTapeCreationPolicyInput', function() {
    it('should create an instance of DeleteAutomaticTapeCreationPolicyInput', function() {
      // uncomment below and update the code to test DeleteAutomaticTapeCreationPolicyInput
      //var instance = new AwsStorageGateway.DeleteAutomaticTapeCreationPolicyInput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteAutomaticTapeCreationPolicyInput);
    });
