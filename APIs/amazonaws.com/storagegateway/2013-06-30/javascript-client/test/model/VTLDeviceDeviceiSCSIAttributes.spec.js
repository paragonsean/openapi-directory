...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.VTLDeviceDeviceiSCSIAttributes();
  });
  ...
  describe('VTLDeviceDeviceiSCSIAttributes', function() {
    it('should create an instance of VTLDeviceDeviceiSCSIAttributes', function() {
      // uncomment below and update the code to test VTLDeviceDeviceiSCSIAttributes
      //var instance = new AwsStorageGateway.VTLDeviceDeviceiSCSIAttributes();
      //expect(instance).to.be.a(AwsStorageGateway.VTLDeviceDeviceiSCSIAttributes);
    });
