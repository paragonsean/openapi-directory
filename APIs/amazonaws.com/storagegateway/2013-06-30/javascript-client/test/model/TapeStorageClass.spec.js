...
(function(root, factory) {
  ...
  describe('TapeStorageClass', function() {
    it('should create an instance of TapeStorageClass', function() {
      // uncomment below and update the code to test TapeStorageClass
      //var instance = new AwsStorageGateway.TapeStorageClass();
      //expect(instance).to.be.a(AwsStorageGateway.TapeStorageClass);
    });
