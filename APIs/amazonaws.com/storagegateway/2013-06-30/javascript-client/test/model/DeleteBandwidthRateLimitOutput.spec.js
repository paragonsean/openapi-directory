...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteBandwidthRateLimitOutput();
  });
  ...
  describe('DeleteBandwidthRateLimitOutput', function() {
    it('should create an instance of DeleteBandwidthRateLimitOutput', function() {
      // uncomment below and update the code to test DeleteBandwidthRateLimitOutput
      //var instance = new AwsStorageGateway.DeleteBandwidthRateLimitOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteBandwidthRateLimitOutput);
    });
