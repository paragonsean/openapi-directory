...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListVolumeInitiatorsInput();
  });
  ...
  describe('ListVolumeInitiatorsInput', function() {
    it('should create an instance of ListVolumeInitiatorsInput', function() {
      // uncomment below and update the code to test ListVolumeInitiatorsInput
      //var instance = new AwsStorageGateway.ListVolumeInitiatorsInput();
      //expect(instance).to.be.a(AwsStorageGateway.ListVolumeInitiatorsInput);
    });
