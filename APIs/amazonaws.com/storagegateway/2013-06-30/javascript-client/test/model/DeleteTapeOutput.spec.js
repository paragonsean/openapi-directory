...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteTapeOutput();
  });
  ...
  describe('DeleteTapeOutput', function() {
    it('should create an instance of DeleteTapeOutput', function() {
      // uncomment below and update the code to test DeleteTapeOutput
      //var instance = new AwsStorageGateway.DeleteTapeOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteTapeOutput);
    });
