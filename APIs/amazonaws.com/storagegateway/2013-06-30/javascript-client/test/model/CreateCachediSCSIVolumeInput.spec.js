...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateCachediSCSIVolumeInput();
  });
  ...
  describe('CreateCachediSCSIVolumeInput', function() {
    it('should create an instance of CreateCachediSCSIVolumeInput', function() {
      // uncomment below and update the code to test CreateCachediSCSIVolumeInput
      //var instance = new AwsStorageGateway.CreateCachediSCSIVolumeInput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateCachediSCSIVolumeInput);
    });
    ...
    it('should have the property sourceVolumeARN (base name: "SourceVolumeARN")', function() {
      // uncomment below and update the code to test the property sourceVolumeARN
      //var instance = new AwsStorageGateway.CreateCachediSCSIVolumeInput();
      //expect(instance).to.be();
    });
