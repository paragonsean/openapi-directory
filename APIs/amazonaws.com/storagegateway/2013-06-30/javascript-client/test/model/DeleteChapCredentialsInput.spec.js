...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteChapCredentialsInput();
  });
  ...
  describe('DeleteChapCredentialsInput', function() {
    it('should create an instance of DeleteChapCredentialsInput', function() {
      // uncomment below and update the code to test DeleteChapCredentialsInput
      //var instance = new AwsStorageGateway.DeleteChapCredentialsInput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteChapCredentialsInput);
    });
