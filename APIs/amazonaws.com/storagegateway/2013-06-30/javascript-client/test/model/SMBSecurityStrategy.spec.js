...
(function(root, factory) {
  ...
  describe('SMBSecurityStrategy', function() {
    it('should create an instance of SMBSecurityStrategy', function() {
      // uncomment below and update the code to test SMBSecurityStrategy
      //var instance = new AwsStorageGateway.SMBSecurityStrategy();
      //expect(instance).to.be.a(AwsStorageGateway.SMBSecurityStrategy);
    });
