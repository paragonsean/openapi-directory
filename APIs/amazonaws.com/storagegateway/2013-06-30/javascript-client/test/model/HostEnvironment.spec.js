...
(function(root, factory) {
  ...
  describe('HostEnvironment', function() {
    it('should create an instance of HostEnvironment', function() {
      // uncomment below and update the code to test HostEnvironment
      //var instance = new AwsStorageGateway.HostEnvironment();
      //expect(instance).to.be.a(AwsStorageGateway.HostEnvironment);
    });
