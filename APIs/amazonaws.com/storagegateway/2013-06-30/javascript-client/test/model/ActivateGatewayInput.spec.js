...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ActivateGatewayInput();
  });
  ...
  describe('ActivateGatewayInput', function() {
    it('should create an instance of ActivateGatewayInput', function() {
      // uncomment below and update the code to test ActivateGatewayInput
      //var instance = new AwsStorageGateway.ActivateGatewayInput();
      //expect(instance).to.be.a(AwsStorageGateway.ActivateGatewayInput);
    });
    ...
    it('should have the property gatewayRegion (base name: "GatewayRegion")', function() {
      // uncomment below and update the code to test the property gatewayRegion
      //var instance = new AwsStorageGateway.ActivateGatewayInput();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tapeDriveType (base name: "TapeDriveType")', function() {
      // uncomment below and update the code to test the property tapeDriveType
      //var instance = new AwsStorageGateway.ActivateGatewayInput();
      //expect(instance).to.be();
    });

    it('should have the property mediumChangerType (base name: "MediumChangerType")', function() {
      // uncomment below and update the code to test the property mediumChangerType
      //var instance = new AwsStorageGateway.ActivateGatewayInput();
      //expect(instance).to.be();
    });
