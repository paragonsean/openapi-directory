...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateStorediSCSIVolumeInput();
  });
  ...
  describe('CreateStorediSCSIVolumeInput', function() {
    it('should create an instance of CreateStorediSCSIVolumeInput', function() {
      // uncomment below and update the code to test CreateStorediSCSIVolumeInput
      //var instance = new AwsStorageGateway.CreateStorediSCSIVolumeInput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateStorediSCSIVolumeInput);
    });
    ...
    it('should have the property preserveExistingData (base name: "PreserveExistingData")', function() {
      // uncomment below and update the code to test the property preserveExistingData
      //var instance = new AwsStorageGateway.CreateStorediSCSIVolumeInput();
      //expect(instance).to.be();
    });
