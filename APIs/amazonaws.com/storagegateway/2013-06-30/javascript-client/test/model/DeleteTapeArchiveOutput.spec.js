...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteTapeArchiveOutput();
  });
  ...
  describe('DeleteTapeArchiveOutput', function() {
    it('should create an instance of DeleteTapeArchiveOutput', function() {
      // uncomment below and update the code to test DeleteTapeArchiveOutput
      //var instance = new AwsStorageGateway.DeleteTapeArchiveOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteTapeArchiveOutput);
    });

    it('should have the property tapeARN (base name: "TapeARN")', function() {
      // uncomment below and update the code to test the property tapeARN
      //var instance = new AwsStorageGateway.DeleteTapeArchiveOutput();
