...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateSnapshotScheduleInput();
  });
  ...
  describe('UpdateSnapshotScheduleInput', function() {
    it('should create an instance of UpdateSnapshotScheduleInput', function() {
      // uncomment below and update the code to test UpdateSnapshotScheduleInput
      //var instance = new AwsStorageGateway.UpdateSnapshotScheduleInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateSnapshotScheduleInput);
    });
    ...
    it('should have the property recurrenceInHours (base name: "RecurrenceInHours")', function() {
      // uncomment below and update the code to test the property recurrenceInHours
      //var instance = new AwsStorageGateway.UpdateSnapshotScheduleInput();
      //expect(instance).to.be();
    });
