...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeVTLDevicesOutput();
  });
  ...
  describe('DescribeVTLDevicesOutput', function() {
    it('should create an instance of DescribeVTLDevicesOutput', function() {
      // uncomment below and update the code to test DescribeVTLDevicesOutput
      //var instance = new AwsStorageGateway.DescribeVTLDevicesOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeVTLDevicesOutput);
    });
    ...
    it('should have the property vTLDevices (base name: "VTLDevices")', function() {
      // uncomment below and update the code to test the property vTLDevices
      //var instance = new AwsStorageGateway.DescribeVTLDevicesOutput();
      //expect(instance).to.be();
    });
