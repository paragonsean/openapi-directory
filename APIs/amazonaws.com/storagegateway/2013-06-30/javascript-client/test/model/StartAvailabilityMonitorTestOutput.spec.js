...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.StartAvailabilityMonitorTestOutput();
  });
  ...
  describe('StartAvailabilityMonitorTestOutput', function() {
    it('should create an instance of StartAvailabilityMonitorTestOutput', function() {
      // uncomment below and update the code to test StartAvailabilityMonitorTestOutput
      //var instance = new AwsStorageGateway.StartAvailabilityMonitorTestOutput();
      //expect(instance).to.be.a(AwsStorageGateway.StartAvailabilityMonitorTestOutput);
    });
