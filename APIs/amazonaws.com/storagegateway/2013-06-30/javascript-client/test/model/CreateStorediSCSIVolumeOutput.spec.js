...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateStorediSCSIVolumeOutput();
  });
  ...
  describe('CreateStorediSCSIVolumeOutput', function() {
    it('should create an instance of CreateStorediSCSIVolumeOutput', function() {
      // uncomment below and update the code to test CreateStorediSCSIVolumeOutput
      //var instance = new AwsStorageGateway.CreateStorediSCSIVolumeOutput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateStorediSCSIVolumeOutput);
    });
