...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateSMBFileShareInput();
  });
  ...
  describe('UpdateSMBFileShareInput', function() {
    it('should create an instance of UpdateSMBFileShareInput', function() {
      // uncomment below and update the code to test UpdateSMBFileShareInput
      //var instance = new AwsStorageGateway.UpdateSMBFileShareInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateSMBFileShareInput);
    });
