...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateSMBLocalGroupsInputSMBLocalGroups();
  });
  ...
  describe('UpdateSMBLocalGroupsInputSMBLocalGroups', function() {
    it('should create an instance of UpdateSMBLocalGroupsInputSMBLocalGroups', function() {
      // uncomment below and update the code to test UpdateSMBLocalGroupsInputSMBLocalGroups
      //var instance = new AwsStorageGateway.UpdateSMBLocalGroupsInputSMBLocalGroups();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateSMBLocalGroupsInputSMBLocalGroups);
    });
