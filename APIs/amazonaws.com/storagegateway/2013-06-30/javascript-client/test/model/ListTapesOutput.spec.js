...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListTapesOutput();
  });
  ...
  describe('ListTapesOutput', function() {
    it('should create an instance of ListTapesOutput', function() {
      // uncomment below and update the code to test ListTapesOutput
      //var instance = new AwsStorageGateway.ListTapesOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ListTapesOutput);
    });

    it('should have the property tapeInfos (base name: "TapeInfos")', function() {
      // uncomment below and update the code to test the property tapeInfos
      //var instance = new AwsStorageGateway.ListTapesOutput();
