...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateSMBLocalGroupsOutput();
  });
  ...
  describe('UpdateSMBLocalGroupsOutput', function() {
    it('should create an instance of UpdateSMBLocalGroupsOutput', function() {
      // uncomment below and update the code to test UpdateSMBLocalGroupsOutput
      //var instance = new AwsStorageGateway.UpdateSMBLocalGroupsOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateSMBLocalGroupsOutput);
    });
