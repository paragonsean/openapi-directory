...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteVolumeInput();
  });
  ...
  describe('DeleteVolumeInput', function() {
    it('should create an instance of DeleteVolumeInput', function() {
      // uncomment below and update the code to test DeleteVolumeInput
      //var instance = new AwsStorageGateway.DeleteVolumeInput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteVolumeInput);
    });
