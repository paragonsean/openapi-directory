...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListVolumeRecoveryPointsOutput();
  });
  ...
  describe('ListVolumeRecoveryPointsOutput', function() {
    it('should create an instance of ListVolumeRecoveryPointsOutput', function() {
      // uncomment below and update the code to test ListVolumeRecoveryPointsOutput
      //var instance = new AwsStorageGateway.ListVolumeRecoveryPointsOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ListVolumeRecoveryPointsOutput);
    });
    ...
    it('should have the property volumeRecoveryPointInfos (base name: "VolumeRecoveryPointInfos")', function() {
      // uncomment below and update the code to test the property volumeRecoveryPointInfos
      //var instance = new AwsStorageGateway.ListVolumeRecoveryPointsOutput();
      //expect(instance).to.be();
    });
