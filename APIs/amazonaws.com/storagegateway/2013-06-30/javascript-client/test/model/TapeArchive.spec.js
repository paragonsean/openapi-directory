...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.TapeArchive();
  });
  ...
  describe('TapeArchive', function() {
    it('should create an instance of TapeArchive', function() {
      // uncomment below and update the code to test TapeArchive
      //var instance = new AwsStorageGateway.TapeArchive();
      //expect(instance).to.be.a(AwsStorageGateway.TapeArchive);
    });
    ...
    it('should have the property tapeCreatedDate (base name: "TapeCreatedDate")', function() {
      // uncomment below and update the code to test the property tapeCreatedDate
      //var instance = new AwsStorageGateway.TapeArchive();
      //expect(instance).to.be();
    });
    ...
    it('should have the property retrievedTo (base name: "RetrievedTo")', function() {
      // uncomment below and update the code to test the property retrievedTo
      //var instance = new AwsStorageGateway.TapeArchive();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tapeUsedInBytes (base name: "TapeUsedInBytes")', function() {
      // uncomment below and update the code to test the property tapeUsedInBytes
      //var instance = new AwsStorageGateway.TapeArchive();
      //expect(instance).to.be();
    });
    ...
    it('should have the property retentionStartDate (base name: "RetentionStartDate")', function() {
      // uncomment below and update the code to test the property retentionStartDate
      //var instance = new AwsStorageGateway.TapeArchive();
      //expect(instance).to.be();
    });

    it('should have the property poolEntryDate (base name: "PoolEntryDate")', function() {
      // uncomment below and update the code to test the property poolEntryDate
      //var instance = new AwsStorageGateway.TapeArchive();
      //expect(instance).to.be();
    });
