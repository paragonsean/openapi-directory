...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DisassociateFileSystemOutput();
  });
  ...
  describe('DisassociateFileSystemOutput', function() {
    it('should create an instance of DisassociateFileSystemOutput', function() {
      // uncomment below and update the code to test DisassociateFileSystemOutput
      //var instance = new AwsStorageGateway.DisassociateFileSystemOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DisassociateFileSystemOutput);
    });
