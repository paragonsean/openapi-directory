...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListVolumesInput();
  });
  ...
  describe('ListVolumesInput', function() {
    it('should create an instance of ListVolumesInput', function() {
      // uncomment below and update the code to test ListVolumesInput
      //var instance = new AwsStorageGateway.ListVolumesInput();
      //expect(instance).to.be.a(AwsStorageGateway.ListVolumesInput);
    });
