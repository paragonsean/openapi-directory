...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListTapePoolsOutput();
  });
  ...
  describe('ListTapePoolsOutput', function() {
    it('should create an instance of ListTapePoolsOutput', function() {
      // uncomment below and update the code to test ListTapePoolsOutput
      //var instance = new AwsStorageGateway.ListTapePoolsOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ListTapePoolsOutput);
    });

    it('should have the property poolInfos (base name: "PoolInfos")', function() {
      // uncomment below and update the code to test the property poolInfos
      //var instance = new AwsStorageGateway.ListTapePoolsOutput();
