...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeTapesInput();
  });
  ...
  describe('DescribeTapesInput', function() {
    it('should create an instance of DescribeTapesInput', function() {
      // uncomment below and update the code to test DescribeTapesInput
      //var instance = new AwsStorageGateway.DescribeTapesInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeTapesInput);
    });
