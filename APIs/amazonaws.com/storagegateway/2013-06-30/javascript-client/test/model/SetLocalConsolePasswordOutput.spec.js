...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.SetLocalConsolePasswordOutput();
  });
  ...
  describe('SetLocalConsolePasswordOutput', function() {
    it('should create an instance of SetLocalConsolePasswordOutput', function() {
      // uncomment below and update the code to test SetLocalConsolePasswordOutput
      //var instance = new AwsStorageGateway.SetLocalConsolePasswordOutput();
      //expect(instance).to.be.a(AwsStorageGateway.SetLocalConsolePasswordOutput);
    });
