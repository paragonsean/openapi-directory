...
(function(root, factory) {
  ...
  describe('AvailabilityMonitorTestStatus', function() {
    it('should create an instance of AvailabilityMonitorTestStatus', function() {
      // uncomment below and update the code to test AvailabilityMonitorTestStatus
      //var instance = new AwsStorageGateway.AvailabilityMonitorTestStatus();
      //expect(instance).to.be.a(AwsStorageGateway.AvailabilityMonitorTestStatus);
    });
