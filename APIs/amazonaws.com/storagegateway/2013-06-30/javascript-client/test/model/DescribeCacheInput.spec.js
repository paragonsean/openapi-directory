...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeCacheInput();
  });
  ...
  describe('DescribeCacheInput', function() {
    it('should create an instance of DescribeCacheInput', function() {
      // uncomment below and update the code to test DescribeCacheInput
      //var instance = new AwsStorageGateway.DescribeCacheInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeCacheInput);
    });
