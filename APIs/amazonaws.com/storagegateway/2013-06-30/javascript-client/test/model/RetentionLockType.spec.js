...
(function(root, factory) {
  ...
  describe('RetentionLockType', function() {
    it('should create an instance of RetentionLockType', function() {
      // uncomment below and update the code to test RetentionLockType
      //var instance = new AwsStorageGateway.RetentionLockType();
      //expect(instance).to.be.a(AwsStorageGateway.RetentionLockType);
    });
