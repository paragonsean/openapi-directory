...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeCachediSCSIVolumesInput();
  });
  ...
  describe('DescribeCachediSCSIVolumesInput', function() {
    it('should create an instance of DescribeCachediSCSIVolumesInput', function() {
      // uncomment below and update the code to test DescribeCachediSCSIVolumesInput
      //var instance = new AwsStorageGateway.DescribeCachediSCSIVolumesInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeCachediSCSIVolumesInput);
    });

    it('should have the property volumeARNs (base name: "VolumeARNs")', function() {
      // uncomment below and update the code to test the property volumeARNs
      //var instance = new AwsStorageGateway.DescribeCachediSCSIVolumesInput();
