...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateNFSFileShareInputNFSFileShareDefaults();
  });
  ...
  describe('UpdateNFSFileShareInputNFSFileShareDefaults', function() {
    it('should create an instance of UpdateNFSFileShareInputNFSFileShareDefaults', function() {
      // uncomment below and update the code to test UpdateNFSFileShareInputNFSFileShareDefaults
      //var instance = new AwsStorageGateway.UpdateNFSFileShareInputNFSFileShareDefaults();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateNFSFileShareInputNFSFileShareDefaults);
    });
