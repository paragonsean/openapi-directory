...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.RemoveTagsFromResourceInput();
  });
  ...
  describe('RemoveTagsFromResourceInput', function() {
    it('should create an instance of RemoveTagsFromResourceInput', function() {
      // uncomment below and update the code to test RemoveTagsFromResourceInput
      //var instance = new AwsStorageGateway.RemoveTagsFromResourceInput();
      //expect(instance).to.be.a(AwsStorageGateway.RemoveTagsFromResourceInput);
    });
