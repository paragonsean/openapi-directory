...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeCacheOutput();
  });
  ...
  describe('DescribeCacheOutput', function() {
    it('should create an instance of DescribeCacheOutput', function() {
      // uncomment below and update the code to test DescribeCacheOutput
      //var instance = new AwsStorageGateway.DescribeCacheOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeCacheOutput);
    });
    ...
    it('should have the property diskIds (base name: "DiskIds")', function() {
      // uncomment below and update the code to test the property diskIds
      //var instance = new AwsStorageGateway.DescribeCacheOutput();
      //expect(instance).to.be();
    });

    it('should have the property cacheAllocatedInBytes (base name: "CacheAllocatedInBytes")', function() {
      // uncomment below and update the code to test the property cacheAllocatedInBytes
      //var instance = new AwsStorageGateway.DescribeCacheOutput();
      //expect(instance).to.be();
    });

    it('should have the property cacheUsedPercentage (base name: "CacheUsedPercentage")', function() {
      // uncomment below and update the code to test the property cacheUsedPercentage
      //var instance = new AwsStorageGateway.DescribeCacheOutput();
      //expect(instance).to.be();
    });

    it('should have the property cacheDirtyPercentage (base name: "CacheDirtyPercentage")', function() {
      // uncomment below and update the code to test the property cacheDirtyPercentage
      //var instance = new AwsStorageGateway.DescribeCacheOutput();
      //expect(instance).to.be();
    });

    it('should have the property cacheHitPercentage (base name: "CacheHitPercentage")', function() {
      // uncomment below and update the code to test the property cacheHitPercentage
      //var instance = new AwsStorageGateway.DescribeCacheOutput();
      //expect(instance).to.be();
    });

    it('should have the property cacheMissPercentage (base name: "CacheMissPercentage")', function() {
      // uncomment below and update the code to test the property cacheMissPercentage
      //var instance = new AwsStorageGateway.DescribeCacheOutput();
      //expect(instance).to.be();
    });
