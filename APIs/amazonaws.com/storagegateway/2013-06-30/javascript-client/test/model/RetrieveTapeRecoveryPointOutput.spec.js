...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.RetrieveTapeRecoveryPointOutput();
  });
  ...
  describe('RetrieveTapeRecoveryPointOutput', function() {
    it('should create an instance of RetrieveTapeRecoveryPointOutput', function() {
      // uncomment below and update the code to test RetrieveTapeRecoveryPointOutput
      //var instance = new AwsStorageGateway.RetrieveTapeRecoveryPointOutput();
      //expect(instance).to.be.a(AwsStorageGateway.RetrieveTapeRecoveryPointOutput);
    });
