...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeBandwidthRateLimitInput();
  });
  ...
  describe('DescribeBandwidthRateLimitInput', function() {
    it('should create an instance of DescribeBandwidthRateLimitInput', function() {
      // uncomment below and update the code to test DescribeBandwidthRateLimitInput
      //var instance = new AwsStorageGateway.DescribeBandwidthRateLimitInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeBandwidthRateLimitInput);
    });
