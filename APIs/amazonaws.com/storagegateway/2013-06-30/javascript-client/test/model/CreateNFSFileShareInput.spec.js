...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateNFSFileShareInput();
  });
  ...
  describe('CreateNFSFileShareInput', function() {
    it('should create an instance of CreateNFSFileShareInput', function() {
      // uncomment below and update the code to test CreateNFSFileShareInput
      //var instance = new AwsStorageGateway.CreateNFSFileShareInput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateNFSFileShareInput);
    });
