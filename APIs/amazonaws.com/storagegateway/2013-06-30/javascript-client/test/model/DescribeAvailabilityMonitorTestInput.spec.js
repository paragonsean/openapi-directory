...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeAvailabilityMonitorTestInput();
  });
  ...
  describe('DescribeAvailabilityMonitorTestInput', function() {
    it('should create an instance of DescribeAvailabilityMonitorTestInput', function() {
      // uncomment below and update the code to test DescribeAvailabilityMonitorTestInput
      //var instance = new AwsStorageGateway.DescribeAvailabilityMonitorTestInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeAvailabilityMonitorTestInput);
    });
