...
(function(root, factory) {
  ...
  describe('ActiveDirectoryStatus', function() {
    it('should create an instance of ActiveDirectoryStatus', function() {
      // uncomment below and update the code to test ActiveDirectoryStatus
      //var instance = new AwsStorageGateway.ActiveDirectoryStatus();
      //expect(instance).to.be.a(AwsStorageGateway.ActiveDirectoryStatus);
    });
