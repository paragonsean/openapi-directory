...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AddUploadBufferInput();
  });
  ...
  describe('AddUploadBufferInput', function() {
    it('should create an instance of AddUploadBufferInput', function() {
      // uncomment below and update the code to test AddUploadBufferInput
      //var instance = new AwsStorageGateway.AddUploadBufferInput();
      //expect(instance).to.be.a(AwsStorageGateway.AddUploadBufferInput);
    });
