...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AddCacheOutput();
  });
  ...
  describe('AddCacheOutput', function() {
    it('should create an instance of AddCacheOutput', function() {
      // uncomment below and update the code to test AddCacheOutput
      //var instance = new AwsStorageGateway.AddCacheOutput();
      //expect(instance).to.be.a(AwsStorageGateway.AddCacheOutput);
    });
