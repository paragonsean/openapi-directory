...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DisassociateFileSystemInput();
  });
  ...
  describe('DisassociateFileSystemInput', function() {
    it('should create an instance of DisassociateFileSystemInput', function() {
      // uncomment below and update the code to test DisassociateFileSystemInput
      //var instance = new AwsStorageGateway.DisassociateFileSystemInput();
      //expect(instance).to.be.a(AwsStorageGateway.DisassociateFileSystemInput);
    });
    ...
    it('should have the property forceDelete (base name: "ForceDelete")', function() {
      // uncomment below and update the code to test the property forceDelete
      //var instance = new AwsStorageGateway.DisassociateFileSystemInput();
      //expect(instance).to.be();
    });
