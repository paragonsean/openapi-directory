...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeMaintenanceStartTimeOutput();
  });
  ...
  describe('DescribeMaintenanceStartTimeOutput', function() {
    it('should create an instance of DescribeMaintenanceStartTimeOutput', function() {
      // uncomment below and update the code to test DescribeMaintenanceStartTimeOutput
      //var instance = new AwsStorageGateway.DescribeMaintenanceStartTimeOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeMaintenanceStartTimeOutput);
    });
