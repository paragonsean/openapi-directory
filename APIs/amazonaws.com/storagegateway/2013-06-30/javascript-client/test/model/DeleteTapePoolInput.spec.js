...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteTapePoolInput();
  });
  ...
  describe('DeleteTapePoolInput', function() {
    it('should create an instance of DeleteTapePoolInput', function() {
      // uncomment below and update the code to test DeleteTapePoolInput
      //var instance = new AwsStorageGateway.DeleteTapePoolInput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteTapePoolInput);
    });
