...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeTapeRecoveryPointsInput();
  });
  ...
  describe('DescribeTapeRecoveryPointsInput', function() {
    it('should create an instance of DescribeTapeRecoveryPointsInput', function() {
      // uncomment below and update the code to test DescribeTapeRecoveryPointsInput
      //var instance = new AwsStorageGateway.DescribeTapeRecoveryPointsInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeTapeRecoveryPointsInput);
    });
