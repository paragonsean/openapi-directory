...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CancelRetrievalOutput();
  });
  ...
  describe('CancelRetrievalOutput', function() {
    it('should create an instance of CancelRetrievalOutput', function() {
      // uncomment below and update the code to test CancelRetrievalOutput
      //var instance = new AwsStorageGateway.CancelRetrievalOutput();
      //expect(instance).to.be.a(AwsStorageGateway.CancelRetrievalOutput);
    });
