...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateAutomaticTapeCreationPolicyOutput();
  });
  ...
  describe('UpdateAutomaticTapeCreationPolicyOutput', function() {
    it('should create an instance of UpdateAutomaticTapeCreationPolicyOutput', function() {
      // uncomment below and update the code to test UpdateAutomaticTapeCreationPolicyOutput
      //var instance = new AwsStorageGateway.UpdateAutomaticTapeCreationPolicyOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateAutomaticTapeCreationPolicyOutput);
    });
