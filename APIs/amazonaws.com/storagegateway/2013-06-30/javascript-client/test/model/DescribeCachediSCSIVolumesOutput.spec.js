...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeCachediSCSIVolumesOutput();
  });
  ...
  describe('DescribeCachediSCSIVolumesOutput', function() {
    it('should create an instance of DescribeCachediSCSIVolumesOutput', function() {
      // uncomment below and update the code to test DescribeCachediSCSIVolumesOutput
      //var instance = new AwsStorageGateway.DescribeCachediSCSIVolumesOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeCachediSCSIVolumesOutput);
    });

    it('should have the property cachediSCSIVolumes (base name: "CachediSCSIVolumes")', function() {
      // uncomment below and update the code to test the property cachediSCSIVolumes
      //var instance = new AwsStorageGateway.DescribeCachediSCSIVolumesOutput();
