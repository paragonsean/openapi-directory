...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeNFSFileSharesInput();
  });
  ...
  describe('DescribeNFSFileSharesInput', function() {
    it('should create an instance of DescribeNFSFileSharesInput', function() {
      // uncomment below and update the code to test DescribeNFSFileSharesInput
      //var instance = new AwsStorageGateway.DescribeNFSFileSharesInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeNFSFileSharesInput);
    });
