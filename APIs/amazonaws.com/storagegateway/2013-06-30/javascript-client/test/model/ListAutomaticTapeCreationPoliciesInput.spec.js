...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListAutomaticTapeCreationPoliciesInput();
  });
  ...
  describe('ListAutomaticTapeCreationPoliciesInput', function() {
    it('should create an instance of ListAutomaticTapeCreationPoliciesInput', function() {
      // uncomment below and update the code to test ListAutomaticTapeCreationPoliciesInput
      //var instance = new AwsStorageGateway.ListAutomaticTapeCreationPoliciesInput();
      //expect(instance).to.be.a(AwsStorageGateway.ListAutomaticTapeCreationPoliciesInput);
    });
