...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeTapeRecoveryPointsOutput();
  });
  ...
  describe('DescribeTapeRecoveryPointsOutput', function() {
    it('should create an instance of DescribeTapeRecoveryPointsOutput', function() {
      // uncomment below and update the code to test DescribeTapeRecoveryPointsOutput
      //var instance = new AwsStorageGateway.DescribeTapeRecoveryPointsOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeTapeRecoveryPointsOutput);
    });
    ...
    it('should have the property tapeRecoveryPointInfos (base name: "TapeRecoveryPointInfos")', function() {
      // uncomment below and update the code to test the property tapeRecoveryPointInfos
      //var instance = new AwsStorageGateway.DescribeTapeRecoveryPointsOutput();
      //expect(instance).to.be();
    });
