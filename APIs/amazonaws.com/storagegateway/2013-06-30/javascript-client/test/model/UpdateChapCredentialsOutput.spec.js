...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateChapCredentialsOutput();
  });
  ...
  describe('UpdateChapCredentialsOutput', function() {
    it('should create an instance of UpdateChapCredentialsOutput', function() {
      // uncomment below and update the code to test UpdateChapCredentialsOutput
      //var instance = new AwsStorageGateway.UpdateChapCredentialsOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateChapCredentialsOutput);
    });
