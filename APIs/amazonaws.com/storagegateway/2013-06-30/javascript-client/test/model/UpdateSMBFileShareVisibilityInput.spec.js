...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateSMBFileShareVisibilityInput();
  });
  ...
  describe('UpdateSMBFileShareVisibilityInput', function() {
    it('should create an instance of UpdateSMBFileShareVisibilityInput', function() {
      // uncomment below and update the code to test UpdateSMBFileShareVisibilityInput
      //var instance = new AwsStorageGateway.UpdateSMBFileShareVisibilityInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateSMBFileShareVisibilityInput);
    });
