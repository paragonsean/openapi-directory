...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.RetrieveTapeArchiveInput();
  });
  ...
  describe('RetrieveTapeArchiveInput', function() {
    it('should create an instance of RetrieveTapeArchiveInput', function() {
      // uncomment below and update the code to test RetrieveTapeArchiveInput
      //var instance = new AwsStorageGateway.RetrieveTapeArchiveInput();
      //expect(instance).to.be.a(AwsStorageGateway.RetrieveTapeArchiveInput);
    });
