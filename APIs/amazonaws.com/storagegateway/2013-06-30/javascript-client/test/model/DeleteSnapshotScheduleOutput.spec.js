...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteSnapshotScheduleOutput();
  });
  ...
  describe('DeleteSnapshotScheduleOutput', function() {
    it('should create an instance of DeleteSnapshotScheduleOutput', function() {
      // uncomment below and update the code to test DeleteSnapshotScheduleOutput
      //var instance = new AwsStorageGateway.DeleteSnapshotScheduleOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteSnapshotScheduleOutput);
    });
