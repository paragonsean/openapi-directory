...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeFileSystemAssociationsInput();
  });
  ...
  describe('DescribeFileSystemAssociationsInput', function() {
    it('should create an instance of DescribeFileSystemAssociationsInput', function() {
      // uncomment below and update the code to test DescribeFileSystemAssociationsInput
      //var instance = new AwsStorageGateway.DescribeFileSystemAssociationsInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeFileSystemAssociationsInput);
    });

    it('should have the property fileSystemAssociationARNList (base name: "FileSystemAssociationARNList")', function() {
      // uncomment below and update the code to test the property fileSystemAssociationARNList
      //var instance = new AwsStorageGateway.DescribeFileSystemAssociationsInput();
