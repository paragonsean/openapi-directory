...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DisableGatewayOutput();
  });
  ...
  describe('DisableGatewayOutput', function() {
    it('should create an instance of DisableGatewayOutput', function() {
      // uncomment below and update the code to test DisableGatewayOutput
      //var instance = new AwsStorageGateway.DisableGatewayOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DisableGatewayOutput);
    });
