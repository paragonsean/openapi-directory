...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.VolumeInfo();
  });
  ...
  describe('VolumeInfo', function() {
    it('should create an instance of VolumeInfo', function() {
      // uncomment below and update the code to test VolumeInfo
      //var instance = new AwsStorageGateway.VolumeInfo();
      //expect(instance).to.be.a(AwsStorageGateway.VolumeInfo);
    });
    ...
    it('should have the property volumeSizeInBytes (base name: "VolumeSizeInBytes")', function() {
      // uncomment below and update the code to test the property volumeSizeInBytes
      //var instance = new AwsStorageGateway.VolumeInfo();
      //expect(instance).to.be();
    });

    it('should have the property volumeAttachmentStatus (base name: "VolumeAttachmentStatus")', function() {
      // uncomment below and update the code to test the property volumeAttachmentStatus
      //var instance = new AwsStorageGateway.VolumeInfo();
      //expect(instance).to.be();
    });
