...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AssociateFileSystemOutput();
  });
  ...
  describe('AssociateFileSystemOutput', function() {
    it('should create an instance of AssociateFileSystemOutput', function() {
      // uncomment below and update the code to test AssociateFileSystemOutput
      //var instance = new AwsStorageGateway.AssociateFileSystemOutput();
      //expect(instance).to.be.a(AwsStorageGateway.AssociateFileSystemOutput);
    });
