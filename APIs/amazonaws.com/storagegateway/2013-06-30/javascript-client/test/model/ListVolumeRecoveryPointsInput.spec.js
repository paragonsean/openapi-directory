...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListVolumeRecoveryPointsInput();
  });
  ...
  describe('ListVolumeRecoveryPointsInput', function() {
    it('should create an instance of ListVolumeRecoveryPointsInput', function() {
      // uncomment below and update the code to test ListVolumeRecoveryPointsInput
      //var instance = new AwsStorageGateway.ListVolumeRecoveryPointsInput();
      //expect(instance).to.be.a(AwsStorageGateway.ListVolumeRecoveryPointsInput);
    });
