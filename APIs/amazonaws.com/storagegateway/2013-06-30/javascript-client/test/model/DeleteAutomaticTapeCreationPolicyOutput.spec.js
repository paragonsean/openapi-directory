...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteAutomaticTapeCreationPolicyOutput();
  });
  ...
  describe('DeleteAutomaticTapeCreationPolicyOutput', function() {
    it('should create an instance of DeleteAutomaticTapeCreationPolicyOutput', function() {
      // uncomment below and update the code to test DeleteAutomaticTapeCreationPolicyOutput
      //var instance = new AwsStorageGateway.DeleteAutomaticTapeCreationPolicyOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteAutomaticTapeCreationPolicyOutput);
    });
