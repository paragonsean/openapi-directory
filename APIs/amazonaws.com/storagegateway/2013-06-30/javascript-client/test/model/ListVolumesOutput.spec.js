...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListVolumesOutput();
  });
  ...
  describe('ListVolumesOutput', function() {
    it('should create an instance of ListVolumesOutput', function() {
      // uncomment below and update the code to test ListVolumesOutput
      //var instance = new AwsStorageGateway.ListVolumesOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ListVolumesOutput);
    });
    ...
    it('should have the property volumeInfos (base name: "VolumeInfos")', function() {
      // uncomment below and update the code to test the property volumeInfos
      //var instance = new AwsStorageGateway.ListVolumesOutput();
      //expect(instance).to.be();
    });
