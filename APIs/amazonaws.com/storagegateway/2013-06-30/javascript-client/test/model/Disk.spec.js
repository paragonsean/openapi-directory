...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.Disk();
  });
  ...
  describe('Disk', function() {
    it('should create an instance of Disk', function() {
      ...
      //var instance = new AwsStorageGateway.Disk();
      //expect(instance).to.be.a(AwsStorageGateway.Disk);
    });
    ...
    it('should have the property diskNode (base name: "DiskNode")', function() {
      // uncomment below and update the code to test the property diskNode
      //var instance = new AwsStorageGateway.Disk();
      //expect(instance).to.be();
    });
    ...
    it('should have the property diskSizeInBytes (base name: "DiskSizeInBytes")', function() {
      // uncomment below and update the code to test the property diskSizeInBytes
      //var instance = new AwsStorageGateway.Disk();
      //expect(instance).to.be();
    });

    it('should have the property diskAllocationType (base name: "DiskAllocationType")', function() {
      // uncomment below and update the code to test the property diskAllocationType
      //var instance = new AwsStorageGateway.Disk();
      //expect(instance).to.be();
    });

    it('should have the property diskAllocationResource (base name: "DiskAllocationResource")', function() {
      // uncomment below and update the code to test the property diskAllocationResource
      //var instance = new AwsStorageGateway.Disk();
      //expect(instance).to.be();
    });

    it('should have the property diskAttributeList (base name: "DiskAttributeList")', function() {
      // uncomment below and update the code to test the property diskAttributeList
      //var instance = new AwsStorageGateway.Disk();
      //expect(instance).to.be();
    });
