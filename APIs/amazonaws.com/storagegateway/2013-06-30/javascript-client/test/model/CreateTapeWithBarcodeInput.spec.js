...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateTapeWithBarcodeInput();
  });
  ...
  describe('CreateTapeWithBarcodeInput', function() {
    it('should create an instance of CreateTapeWithBarcodeInput', function() {
      // uncomment below and update the code to test CreateTapeWithBarcodeInput
      //var instance = new AwsStorageGateway.CreateTapeWithBarcodeInput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateTapeWithBarcodeInput);
    });
    ...
    it('should have the property tapeBarcode (base name: "TapeBarcode")', function() {
