...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DisableGatewayInput();
  });
  ...
  describe('DisableGatewayInput', function() {
    it('should create an instance of DisableGatewayInput', function() {
      // uncomment below and update the code to test DisableGatewayInput
      //var instance = new AwsStorageGateway.DisableGatewayInput();
      //expect(instance).to.be.a(AwsStorageGateway.DisableGatewayInput);
    });
