...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateFileSystemAssociationInput();
  });
  ...
  describe('UpdateFileSystemAssociationInput', function() {
    it('should create an instance of UpdateFileSystemAssociationInput', function() {
      // uncomment below and update the code to test UpdateFileSystemAssociationInput
      //var instance = new AwsStorageGateway.UpdateFileSystemAssociationInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateFileSystemAssociationInput);
    });
