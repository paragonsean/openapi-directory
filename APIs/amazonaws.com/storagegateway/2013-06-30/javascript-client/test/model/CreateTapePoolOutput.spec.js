...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateTapePoolOutput();
  });
  ...
  describe('CreateTapePoolOutput', function() {
    it('should create an instance of CreateTapePoolOutput', function() {
      // uncomment below and update the code to test CreateTapePoolOutput
      //var instance = new AwsStorageGateway.CreateTapePoolOutput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateTapePoolOutput);
    });
