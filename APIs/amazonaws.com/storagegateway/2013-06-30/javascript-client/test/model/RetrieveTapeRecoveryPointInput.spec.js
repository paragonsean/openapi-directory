...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.RetrieveTapeRecoveryPointInput();
  });
  ...
  describe('RetrieveTapeRecoveryPointInput', function() {
    it('should create an instance of RetrieveTapeRecoveryPointInput', function() {
      // uncomment below and update the code to test RetrieveTapeRecoveryPointInput
      //var instance = new AwsStorageGateway.RetrieveTapeRecoveryPointInput();
      //expect(instance).to.be.a(AwsStorageGateway.RetrieveTapeRecoveryPointInput);
    });
