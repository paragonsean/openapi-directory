...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.RefreshCacheInput();
  });
  ...
  describe('RefreshCacheInput', function() {
    it('should create an instance of RefreshCacheInput', function() {
      // uncomment below and update the code to test RefreshCacheInput
      //var instance = new AwsStorageGateway.RefreshCacheInput();
      //expect(instance).to.be.a(AwsStorageGateway.RefreshCacheInput);
    });
    ...
    it('should have the property folderList (base name: "FolderList")', function() {
      // uncomment below and update the code to test the property folderList
      //var instance = new AwsStorageGateway.RefreshCacheInput();
      //expect(instance).to.be();
    });
