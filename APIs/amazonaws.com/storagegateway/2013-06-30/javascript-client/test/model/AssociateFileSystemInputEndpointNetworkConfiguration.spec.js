...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AssociateFileSystemInputEndpointNetworkConfiguration();
  });
  ...
  describe('AssociateFileSystemInputEndpointNetworkConfiguration', function() {
    it('should create an instance of AssociateFileSystemInputEndpointNetworkConfiguration', function() {
      // uncomment below and update the code to test AssociateFileSystemInputEndpointNetworkConfiguration
      //var instance = new AwsStorageGateway.AssociateFileSystemInputEndpointNetworkConfiguration();
      //expect(instance).to.be.a(AwsStorageGateway.AssociateFileSystemInputEndpointNetworkConfiguration);
    });
