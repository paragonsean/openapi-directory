...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateMaintenanceStartTimeOutput();
  });
  ...
  describe('UpdateMaintenanceStartTimeOutput', function() {
    it('should create an instance of UpdateMaintenanceStartTimeOutput', function() {
      // uncomment below and update the code to test UpdateMaintenanceStartTimeOutput
      //var instance = new AwsStorageGateway.UpdateMaintenanceStartTimeOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateMaintenanceStartTimeOutput);
    });
