...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AddUploadBufferOutput();
  });
  ...
  describe('AddUploadBufferOutput', function() {
    it('should create an instance of AddUploadBufferOutput', function() {
      // uncomment below and update the code to test AddUploadBufferOutput
      //var instance = new AwsStorageGateway.AddUploadBufferOutput();
      //expect(instance).to.be.a(AwsStorageGateway.AddUploadBufferOutput);
    });
