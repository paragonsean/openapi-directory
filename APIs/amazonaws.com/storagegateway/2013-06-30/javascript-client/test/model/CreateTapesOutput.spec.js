...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateTapesOutput();
  });
  ...
  describe('CreateTapesOutput', function() {
    it('should create an instance of CreateTapesOutput', function() {
      // uncomment below and update the code to test CreateTapesOutput
      //var instance = new AwsStorageGateway.CreateTapesOutput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateTapesOutput);
    });
