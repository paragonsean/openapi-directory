...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ResetCacheOutput();
  });
  ...
  describe('ResetCacheOutput', function() {
    it('should create an instance of ResetCacheOutput', function() {
      // uncomment below and update the code to test ResetCacheOutput
      //var instance = new AwsStorageGateway.ResetCacheOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ResetCacheOutput);
    });
