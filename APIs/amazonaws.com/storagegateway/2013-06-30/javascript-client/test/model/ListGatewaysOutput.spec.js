...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListGatewaysOutput();
  });
  ...
  describe('ListGatewaysOutput', function() {
    it('should create an instance of ListGatewaysOutput', function() {
      // uncomment below and update the code to test ListGatewaysOutput
      //var instance = new AwsStorageGateway.ListGatewaysOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ListGatewaysOutput);
    });
