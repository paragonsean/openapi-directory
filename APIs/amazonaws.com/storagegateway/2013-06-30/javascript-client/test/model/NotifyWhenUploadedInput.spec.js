...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.NotifyWhenUploadedInput();
  });
  ...
  describe('NotifyWhenUploadedInput', function() {
    it('should create an instance of NotifyWhenUploadedInput', function() {
      // uncomment below and update the code to test NotifyWhenUploadedInput
      //var instance = new AwsStorageGateway.NotifyWhenUploadedInput();
      //expect(instance).to.be.a(AwsStorageGateway.NotifyWhenUploadedInput);
    });
