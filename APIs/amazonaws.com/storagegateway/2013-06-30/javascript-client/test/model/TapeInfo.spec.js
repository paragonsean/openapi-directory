...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.TapeInfo();
  });
  ...
  describe('TapeInfo', function() {
    it('should create an instance of TapeInfo', function() {
      // uncomment below and update the code to test TapeInfo
      //var instance = new AwsStorageGateway.TapeInfo();
      //expect(instance).to.be.a(AwsStorageGateway.TapeInfo);
    });
