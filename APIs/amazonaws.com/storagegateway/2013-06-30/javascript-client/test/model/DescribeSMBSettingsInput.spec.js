...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeSMBSettingsInput();
  });
  ...
  describe('DescribeSMBSettingsInput', function() {
    it('should create an instance of DescribeSMBSettingsInput', function() {
      // uncomment below and update the code to test DescribeSMBSettingsInput
      //var instance = new AwsStorageGateway.DescribeSMBSettingsInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeSMBSettingsInput);
    });
