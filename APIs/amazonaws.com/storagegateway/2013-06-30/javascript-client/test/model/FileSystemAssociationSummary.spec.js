...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.FileSystemAssociationSummary();
  });
  ...
  describe('FileSystemAssociationSummary', function() {
    it('should create an instance of FileSystemAssociationSummary', function() {
      // uncomment below and update the code to test FileSystemAssociationSummary
      //var instance = new AwsStorageGateway.FileSystemAssociationSummary();
      //expect(instance).to.be.a(AwsStorageGateway.FileSystemAssociationSummary);
    });

    it('should have the property fileSystemAssociationId (base name: "FileSystemAssociationId")', function() {
      // uncomment below and update the code to test the property fileSystemAssociationId
      //var instance = new AwsStorageGateway.FileSystemAssociationSummary();
