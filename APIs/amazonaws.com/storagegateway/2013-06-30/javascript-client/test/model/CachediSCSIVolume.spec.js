...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CachediSCSIVolume();
  });
  ...
  describe('CachediSCSIVolume', function() {
    it('should create an instance of CachediSCSIVolume', function() {
      // uncomment below and update the code to test CachediSCSIVolume
      //var instance = new AwsStorageGateway.CachediSCSIVolume();
      //expect(instance).to.be.a(AwsStorageGateway.CachediSCSIVolume);
    });
