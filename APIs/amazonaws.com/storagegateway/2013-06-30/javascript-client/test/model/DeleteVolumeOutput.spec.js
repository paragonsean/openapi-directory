...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteVolumeOutput();
  });
  ...
  describe('DeleteVolumeOutput', function() {
    it('should create an instance of DeleteVolumeOutput', function() {
      // uncomment below and update the code to test DeleteVolumeOutput
      //var instance = new AwsStorageGateway.DeleteVolumeOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteVolumeOutput);
    });
