...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AddCacheInput();
  });
  ...
  describe('AddCacheInput', function() {
    it('should create an instance of AddCacheInput', function() {
      // uncomment below and update the code to test AddCacheInput
      //var instance = new AwsStorageGateway.AddCacheInput();
      //expect(instance).to.be.a(AwsStorageGateway.AddCacheInput);
    });
