...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateGatewaySoftwareNowInput();
  });
  ...
  describe('UpdateGatewaySoftwareNowInput', function() {
    it('should create an instance of UpdateGatewaySoftwareNowInput', function() {
      // uncomment below and update the code to test UpdateGatewaySoftwareNowInput
      //var instance = new AwsStorageGateway.UpdateGatewaySoftwareNowInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateGatewaySoftwareNowInput);
    });
