...
(function(root, factory) {
  ...
  describe('GatewayCapacity', function() {
    it('should create an instance of GatewayCapacity', function() {
      // uncomment below and update the code to test GatewayCapacity
      //var instance = new AwsStorageGateway.GatewayCapacity();
      //expect(instance).to.be.a(AwsStorageGateway.GatewayCapacity);
    });
