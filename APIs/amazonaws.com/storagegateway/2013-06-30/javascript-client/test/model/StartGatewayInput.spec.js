...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.StartGatewayInput();
  });
  ...
  describe('StartGatewayInput', function() {
    it('should create an instance of StartGatewayInput', function() {
      // uncomment below and update the code to test StartGatewayInput
      //var instance = new AwsStorageGateway.StartGatewayInput();
      //expect(instance).to.be.a(AwsStorageGateway.StartGatewayInput);
    });
