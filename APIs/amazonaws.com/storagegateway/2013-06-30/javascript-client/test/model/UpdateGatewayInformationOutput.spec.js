...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateGatewayInformationOutput();
  });
  ...
  describe('UpdateGatewayInformationOutput', function() {
    it('should create an instance of UpdateGatewayInformationOutput', function() {
      // uncomment below and update the code to test UpdateGatewayInformationOutput
      //var instance = new AwsStorageGateway.UpdateGatewayInformationOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateGatewayInformationOutput);
    });
