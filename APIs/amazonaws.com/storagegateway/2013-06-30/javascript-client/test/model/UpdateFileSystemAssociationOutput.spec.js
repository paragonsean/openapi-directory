...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateFileSystemAssociationOutput();
  });
  ...
  describe('UpdateFileSystemAssociationOutput', function() {
    it('should create an instance of UpdateFileSystemAssociationOutput', function() {
      // uncomment below and update the code to test UpdateFileSystemAssociationOutput
      //var instance = new AwsStorageGateway.UpdateFileSystemAssociationOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateFileSystemAssociationOutput);
    });
