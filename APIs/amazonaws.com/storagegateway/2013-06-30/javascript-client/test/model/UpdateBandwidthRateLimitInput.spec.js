...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateBandwidthRateLimitInput();
  });
  ...
  describe('UpdateBandwidthRateLimitInput', function() {
    it('should create an instance of UpdateBandwidthRateLimitInput', function() {
      // uncomment below and update the code to test UpdateBandwidthRateLimitInput
      //var instance = new AwsStorageGateway.UpdateBandwidthRateLimitInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateBandwidthRateLimitInput);
    });
