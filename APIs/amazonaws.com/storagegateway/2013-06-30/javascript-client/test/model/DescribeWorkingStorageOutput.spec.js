...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeWorkingStorageOutput();
  });
  ...
  describe('DescribeWorkingStorageOutput', function() {
    it('should create an instance of DescribeWorkingStorageOutput', function() {
      // uncomment below and update the code to test DescribeWorkingStorageOutput
      //var instance = new AwsStorageGateway.DescribeWorkingStorageOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeWorkingStorageOutput);
    });
    ...
    it('should have the property workingStorageUsedInBytes (base name: "WorkingStorageUsedInBytes")', function() {
      // uncomment below and update the code to test the property workingStorageUsedInBytes
      //var instance = new AwsStorageGateway.DescribeWorkingStorageOutput();
      //expect(instance).to.be();
    });

    it('should have the property workingStorageAllocatedInBytes (base name: "WorkingStorageAllocatedInBytes")', function() {
      // uncomment below and update the code to test the property workingStorageAllocatedInBytes
      //var instance = new AwsStorageGateway.DescribeWorkingStorageOutput();
      //expect(instance).to.be();
    });
