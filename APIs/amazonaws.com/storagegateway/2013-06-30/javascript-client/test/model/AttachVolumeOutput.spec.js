...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AttachVolumeOutput();
  });
  ...
  describe('AttachVolumeOutput', function() {
    it('should create an instance of AttachVolumeOutput', function() {
      // uncomment below and update the code to test AttachVolumeOutput
      //var instance = new AwsStorageGateway.AttachVolumeOutput();
      //expect(instance).to.be.a(AwsStorageGateway.AttachVolumeOutput);
    });
