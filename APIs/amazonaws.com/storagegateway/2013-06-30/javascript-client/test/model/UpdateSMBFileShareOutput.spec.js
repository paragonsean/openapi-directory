...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateSMBFileShareOutput();
  });
  ...
  describe('UpdateSMBFileShareOutput', function() {
    it('should create an instance of UpdateSMBFileShareOutput', function() {
      // uncomment below and update the code to test UpdateSMBFileShareOutput
      //var instance = new AwsStorageGateway.UpdateSMBFileShareOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateSMBFileShareOutput);
    });
