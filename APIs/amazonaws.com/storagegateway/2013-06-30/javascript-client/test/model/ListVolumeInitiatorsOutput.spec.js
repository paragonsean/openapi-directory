...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListVolumeInitiatorsOutput();
  });
  ...
  describe('ListVolumeInitiatorsOutput', function() {
    it('should create an instance of ListVolumeInitiatorsOutput', function() {
      // uncomment below and update the code to test ListVolumeInitiatorsOutput
      //var instance = new AwsStorageGateway.ListVolumeInitiatorsOutput();
      //expect(instance).to.be.a(AwsStorageGateway.ListVolumeInitiatorsOutput);
    });

    it('should have the property initiators (base name: "Initiators")', function() {
      // uncomment below and update the code to test the property initiators
      //var instance = new AwsStorageGateway.ListVolumeInitiatorsOutput();
