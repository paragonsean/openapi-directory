...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateMaintenanceStartTimeInput();
  });
  ...
  describe('UpdateMaintenanceStartTimeInput', function() {
    it('should create an instance of UpdateMaintenanceStartTimeInput', function() {
      // uncomment below and update the code to test UpdateMaintenanceStartTimeInput
      //var instance = new AwsStorageGateway.UpdateMaintenanceStartTimeInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateMaintenanceStartTimeInput);
    });
