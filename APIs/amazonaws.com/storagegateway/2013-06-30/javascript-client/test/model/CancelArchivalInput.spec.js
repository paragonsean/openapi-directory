...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CancelArchivalInput();
  });
  ...
  describe('CancelArchivalInput', function() {
    it('should create an instance of CancelArchivalInput', function() {
      // uncomment below and update the code to test CancelArchivalInput
      //var instance = new AwsStorageGateway.CancelArchivalInput();
      //expect(instance).to.be.a(AwsStorageGateway.CancelArchivalInput);
    });
