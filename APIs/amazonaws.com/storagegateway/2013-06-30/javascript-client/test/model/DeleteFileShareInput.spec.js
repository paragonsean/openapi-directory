...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteFileShareInput();
  });
  ...
  describe('DeleteFileShareInput', function() {
    it('should create an instance of DeleteFileShareInput', function() {
      // uncomment below and update the code to test DeleteFileShareInput
      //var instance = new AwsStorageGateway.DeleteFileShareInput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteFileShareInput);
    });
