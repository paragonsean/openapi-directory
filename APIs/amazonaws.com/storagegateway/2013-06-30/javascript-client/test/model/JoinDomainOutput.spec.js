...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.JoinDomainOutput();
  });
  ...
  describe('JoinDomainOutput', function() {
    it('should create an instance of JoinDomainOutput', function() {
      // uncomment below and update the code to test JoinDomainOutput
      //var instance = new AwsStorageGateway.JoinDomainOutput();
      //expect(instance).to.be.a(AwsStorageGateway.JoinDomainOutput);
    });
