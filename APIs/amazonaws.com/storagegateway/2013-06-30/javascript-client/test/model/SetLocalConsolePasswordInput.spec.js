...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.SetLocalConsolePasswordInput();
  });
  ...
  describe('SetLocalConsolePasswordInput', function() {
    it('should create an instance of SetLocalConsolePasswordInput', function() {
      // uncomment below and update the code to test SetLocalConsolePasswordInput
      //var instance = new AwsStorageGateway.SetLocalConsolePasswordInput();
      //expect(instance).to.be.a(AwsStorageGateway.SetLocalConsolePasswordInput);
    });
    ...
    it('should have the property localConsolePassword (base name: "LocalConsolePassword")', function() {
      // uncomment below and update the code to test the property localConsolePassword
      //var instance = new AwsStorageGateway.SetLocalConsolePasswordInput();
      //expect(instance).to.be();
    });
