...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateSnapshotInput();
  });
  ...
  describe('CreateSnapshotInput', function() {
    it('should create an instance of CreateSnapshotInput', function() {
      ...
      //var instance = new AwsStorageGateway.CreateSnapshotInput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateSnapshotInput);
    });
    ...
    it('should have the property snapshotDescription (base name: "SnapshotDescription")', function() {
      // uncomment below and update the code to test the property snapshotDescription
      //var instance = new AwsStorageGateway.CreateSnapshotInput();
      //expect(instance).to.be();
    });
