...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateBandwidthRateLimitOutput();
  });
  ...
  describe('UpdateBandwidthRateLimitOutput', function() {
    it('should create an instance of UpdateBandwidthRateLimitOutput', function() {
      // uncomment below and update the code to test UpdateBandwidthRateLimitOutput
      //var instance = new AwsStorageGateway.UpdateBandwidthRateLimitOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateBandwidthRateLimitOutput);
    });
