...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.NetworkInterface();
  });
  ...
  describe('NetworkInterface', function() {
    it('should create an instance of NetworkInterface', function() {
      ...
      //var instance = new AwsStorageGateway.NetworkInterface();
      //expect(instance).to.be.a(AwsStorageGateway.NetworkInterface);
    });
