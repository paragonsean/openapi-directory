...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateSnapshotScheduleOutput();
  });
  ...
  describe('UpdateSnapshotScheduleOutput', function() {
    it('should create an instance of UpdateSnapshotScheduleOutput', function() {
      // uncomment below and update the code to test UpdateSnapshotScheduleOutput
      //var instance = new AwsStorageGateway.UpdateSnapshotScheduleOutput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateSnapshotScheduleOutput);
    });
