...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateGatewayInformationInput();
  });
  ...
  describe('UpdateGatewayInformationInput', function() {
    it('should create an instance of UpdateGatewayInformationInput', function() {
      // uncomment below and update the code to test UpdateGatewayInformationInput
      //var instance = new AwsStorageGateway.UpdateGatewayInformationInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateGatewayInformationInput);
    });
