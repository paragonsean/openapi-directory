...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.AttachVolumeInput();
  });
  ...
  describe('AttachVolumeInput', function() {
    it('should create an instance of AttachVolumeInput', function() {
      // uncomment below and update the code to test AttachVolumeInput
      //var instance = new AwsStorageGateway.AttachVolumeInput();
      //expect(instance).to.be.a(AwsStorageGateway.AttachVolumeInput);
    });
