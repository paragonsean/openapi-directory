...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteTapePoolOutput();
  });
  ...
  describe('DeleteTapePoolOutput', function() {
    it('should create an instance of DeleteTapePoolOutput', function() {
      // uncomment below and update the code to test DeleteTapePoolOutput
      //var instance = new AwsStorageGateway.DeleteTapePoolOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteTapePoolOutput);
    });
