...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DetachVolumeOutput();
  });
  ...
  describe('DetachVolumeOutput', function() {
    it('should create an instance of DetachVolumeOutput', function() {
      // uncomment below and update the code to test DetachVolumeOutput
      //var instance = new AwsStorageGateway.DetachVolumeOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DetachVolumeOutput);
    });
