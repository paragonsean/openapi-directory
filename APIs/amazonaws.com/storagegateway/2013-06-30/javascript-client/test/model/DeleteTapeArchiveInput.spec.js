...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteTapeArchiveInput();
  });
  ...
  describe('DeleteTapeArchiveInput', function() {
    it('should create an instance of DeleteTapeArchiveInput', function() {
      // uncomment below and update the code to test DeleteTapeArchiveInput
      //var instance = new AwsStorageGateway.DeleteTapeArchiveInput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteTapeArchiveInput);
    });
    ...
    it('should have the property bypassGovernanceRetention (base name: "BypassGovernanceRetention")', function() {
      // uncomment below and update the code to test the property bypassGovernanceRetention
      //var instance = new AwsStorageGateway.DeleteTapeArchiveInput();
      //expect(instance).to.be();
    });
