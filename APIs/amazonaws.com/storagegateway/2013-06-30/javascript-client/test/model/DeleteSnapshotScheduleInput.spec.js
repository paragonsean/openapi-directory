...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DeleteSnapshotScheduleInput();
  });
  ...
  describe('DeleteSnapshotScheduleInput', function() {
    it('should create an instance of DeleteSnapshotScheduleInput', function() {
      // uncomment below and update the code to test DeleteSnapshotScheduleInput
      //var instance = new AwsStorageGateway.DeleteSnapshotScheduleInput();
      //expect(instance).to.be.a(AwsStorageGateway.DeleteSnapshotScheduleInput);
    });
