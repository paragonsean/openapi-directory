...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeTapeArchivesInput();
  });
  ...
  describe('DescribeTapeArchivesInput', function() {
    it('should create an instance of DescribeTapeArchivesInput', function() {
      // uncomment below and update the code to test DescribeTapeArchivesInput
      //var instance = new AwsStorageGateway.DescribeTapeArchivesInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeTapeArchivesInput);
    });

    it('should have the property tapeARNs (base name: "TapeARNs")', function() {
      // uncomment below and update the code to test the property tapeARNs
      //var instance = new AwsStorageGateway.DescribeTapeArchivesInput();
