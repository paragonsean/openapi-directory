...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeChapCredentialsOutput();
  });
  ...
  describe('DescribeChapCredentialsOutput', function() {
    it('should create an instance of DescribeChapCredentialsOutput', function() {
      // uncomment below and update the code to test DescribeChapCredentialsOutput
      //var instance = new AwsStorageGateway.DescribeChapCredentialsOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeChapCredentialsOutput);
    });

    it('should have the property chapCredentials (base name: "ChapCredentials")', function() {
      // uncomment below and update the code to test the property chapCredentials
      //var instance = new AwsStorageGateway.DescribeChapCredentialsOutput();
