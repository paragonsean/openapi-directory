...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ListTagsForResourceInput();
  });
  ...
  describe('ListTagsForResourceInput', function() {
    it('should create an instance of ListTagsForResourceInput', function() {
      ...
      //var instance = new AwsStorageGateway.ListTagsForResourceInput();
      //expect(instance).to.be.a(AwsStorageGateway.ListTagsForResourceInput);
    });
