...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.GatewayInfo();
  });
  ...
  describe('GatewayInfo', function() {
    it('should create an instance of GatewayInfo', function() {
      // uncomment below and update the code to test GatewayInfo
      //var instance = new AwsStorageGateway.GatewayInfo();
      //expect(instance).to.be.a(AwsStorageGateway.GatewayInfo);
    });
    ...
    it('should have the property gatewayOperationalState (base name: "GatewayOperationalState")', function() {
      // uncomment below and update the code to test the property gatewayOperationalState
      //var instance = new AwsStorageGateway.GatewayInfo();
      //expect(instance).to.be();
    });
