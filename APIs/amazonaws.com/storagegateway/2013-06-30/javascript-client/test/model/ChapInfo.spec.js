...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.ChapInfo();
  });
  ...
  describe('ChapInfo', function() {
    it('should create an instance of ChapInfo', function() {
      // uncomment below and update the code to test ChapInfo
      //var instance = new AwsStorageGateway.ChapInfo();
      //expect(instance).to.be.a(AwsStorageGateway.ChapInfo);
    });
    ...
    it('should have the property secretToAuthenticateInitiator (base name: "SecretToAuthenticateInitiator")', function() {
      // uncomment below and update the code to test the property secretToAuthenticateInitiator
      //var instance = new AwsStorageGateway.ChapInfo();
      //expect(instance).to.be();
    });
    ...
    it('should have the property secretToAuthenticateTarget (base name: "SecretToAuthenticateTarget")', function() {
      // uncomment below and update the code to test the property secretToAuthenticateTarget
      //var instance = new AwsStorageGateway.ChapInfo();
      //expect(instance).to.be();
    });
