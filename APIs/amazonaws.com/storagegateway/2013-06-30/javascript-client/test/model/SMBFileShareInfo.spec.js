...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.SMBFileShareInfo();
  });
  ...
  describe('SMBFileShareInfo', function() {
    it('should create an instance of SMBFileShareInfo', function() {
      // uncomment below and update the code to test SMBFileShareInfo
      //var instance = new AwsStorageGateway.SMBFileShareInfo();
      //expect(instance).to.be.a(AwsStorageGateway.SMBFileShareInfo);
    });
