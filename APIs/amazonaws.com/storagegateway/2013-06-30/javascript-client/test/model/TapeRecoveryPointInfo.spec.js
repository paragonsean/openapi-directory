...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.TapeRecoveryPointInfo();
  });
  ...
  describe('TapeRecoveryPointInfo', function() {
    it('should create an instance of TapeRecoveryPointInfo', function() {
      // uncomment below and update the code to test TapeRecoveryPointInfo
      //var instance = new AwsStorageGateway.TapeRecoveryPointInfo();
      //expect(instance).to.be.a(AwsStorageGateway.TapeRecoveryPointInfo);
    });
    ...
    it('should have the property tapeRecoveryPointTime (base name: "TapeRecoveryPointTime")', function() {
      // uncomment below and update the code to test the property tapeRecoveryPointTime
      //var instance = new AwsStorageGateway.TapeRecoveryPointInfo();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tapeStatus (base name: "TapeStatus")', function() {
      // uncomment below and update the code to test the property tapeStatus
      //var instance = new AwsStorageGateway.TapeRecoveryPointInfo();
      //expect(instance).to.be();
    });
