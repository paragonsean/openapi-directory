...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateNFSFileShareInputNFSFileShareDefaults();
  });
  ...
  describe('CreateNFSFileShareInputNFSFileShareDefaults', function() {
    it('should create an instance of CreateNFSFileShareInputNFSFileShareDefaults', function() {
      // uncomment below and update the code to test CreateNFSFileShareInputNFSFileShareDefaults
      //var instance = new AwsStorageGateway.CreateNFSFileShareInputNFSFileShareDefaults();
      //expect(instance).to.be.a(AwsStorageGateway.CreateNFSFileShareInputNFSFileShareDefaults);
    });
    ...
    it('should have the property directoryMode (base name: "DirectoryMode")', function() {
      // uncomment below and update the code to test the property directoryMode
      //var instance = new AwsStorageGateway.CreateNFSFileShareInputNFSFileShareDefaults();
      //expect(instance).to.be();
    });
