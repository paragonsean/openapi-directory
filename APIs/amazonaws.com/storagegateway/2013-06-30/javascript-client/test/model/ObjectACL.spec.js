...
(function(root, factory) {
  ...
  describe('ObjectACL', function() {
    it('should create an instance of ObjectACL', function() {
      // uncomment below and update the code to test ObjectACL
      //var instance = new AwsStorageGateway.ObjectACL();
      //expect(instance).to.be.a(AwsStorageGateway.ObjectACL);
    });
