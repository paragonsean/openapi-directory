...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeUploadBufferOutput();
  });
  ...
  describe('DescribeUploadBufferOutput', function() {
    it('should create an instance of DescribeUploadBufferOutput', function() {
      // uncomment below and update the code to test DescribeUploadBufferOutput
      //var instance = new AwsStorageGateway.DescribeUploadBufferOutput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeUploadBufferOutput);
    });
    ...
    it('should have the property uploadBufferUsedInBytes (base name: "UploadBufferUsedInBytes")', function() {
      // uncomment below and update the code to test the property uploadBufferUsedInBytes
      //var instance = new AwsStorageGateway.DescribeUploadBufferOutput();
      //expect(instance).to.be();
    });

    it('should have the property uploadBufferAllocatedInBytes (base name: "UploadBufferAllocatedInBytes")', function() {
      // uncomment below and update the code to test the property uploadBufferAllocatedInBytes
      //var instance = new AwsStorageGateway.DescribeUploadBufferOutput();
      //expect(instance).to.be();
    });
