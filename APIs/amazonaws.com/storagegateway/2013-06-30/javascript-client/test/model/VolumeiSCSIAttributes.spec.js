...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.VolumeiSCSIAttributes();
  });
  ...
  describe('VolumeiSCSIAttributes', function() {
    it('should create an instance of VolumeiSCSIAttributes', function() {
      // uncomment below and update the code to test VolumeiSCSIAttributes
      //var instance = new AwsStorageGateway.VolumeiSCSIAttributes();
      //expect(instance).to.be.a(AwsStorageGateway.VolumeiSCSIAttributes);
    });
