...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.DescribeMaintenanceStartTimeInput();
  });
  ...
  describe('DescribeMaintenanceStartTimeInput', function() {
    it('should create an instance of DescribeMaintenanceStartTimeInput', function() {
      // uncomment below and update the code to test DescribeMaintenanceStartTimeInput
      //var instance = new AwsStorageGateway.DescribeMaintenanceStartTimeInput();
      //expect(instance).to.be.a(AwsStorageGateway.DescribeMaintenanceStartTimeInput);
    });
