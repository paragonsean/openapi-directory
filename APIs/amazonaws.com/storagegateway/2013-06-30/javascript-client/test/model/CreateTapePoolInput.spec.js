...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.CreateTapePoolInput();
  });
  ...
  describe('CreateTapePoolInput', function() {
    it('should create an instance of CreateTapePoolInput', function() {
      // uncomment below and update the code to test CreateTapePoolInput
      //var instance = new AwsStorageGateway.CreateTapePoolInput();
      //expect(instance).to.be.a(AwsStorageGateway.CreateTapePoolInput);
    });
    ...
    it('should have the property retentionLockType (base name: "RetentionLockType")', function() {
      // uncomment below and update the code to test the property retentionLockType
      //var instance = new AwsStorageGateway.CreateTapePoolInput();
      //expect(instance).to.be();
    });

    it('should have the property retentionLockTimeInDays (base name: "RetentionLockTimeInDays")', function() {
      // uncomment below and update the code to test the property retentionLockTimeInDays
      //var instance = new AwsStorageGateway.CreateTapePoolInput();
      //expect(instance).to.be();
    });
