...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateAutomaticTapeCreationPolicyInput();
  });
  ...
  describe('UpdateAutomaticTapeCreationPolicyInput', function() {
    it('should create an instance of UpdateAutomaticTapeCreationPolicyInput', function() {
      // uncomment below and update the code to test UpdateAutomaticTapeCreationPolicyInput
      //var instance = new AwsStorageGateway.UpdateAutomaticTapeCreationPolicyInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateAutomaticTapeCreationPolicyInput);
    });

    it('should have the property automaticTapeCreationRules (base name: "AutomaticTapeCreationRules")', function() {
      // uncomment below and update the code to test the property automaticTapeCreationRules
      //var instance = new AwsStorageGateway.UpdateAutomaticTapeCreationPolicyInput();
