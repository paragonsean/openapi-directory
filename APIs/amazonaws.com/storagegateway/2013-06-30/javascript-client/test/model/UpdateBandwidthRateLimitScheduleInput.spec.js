...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStorageGateway.UpdateBandwidthRateLimitScheduleInput();
  });
  ...
  describe('UpdateBandwidthRateLimitScheduleInput', function() {
    it('should create an instance of UpdateBandwidthRateLimitScheduleInput', function() {
      // uncomment below and update the code to test UpdateBandwidthRateLimitScheduleInput
      //var instance = new AwsStorageGateway.UpdateBandwidthRateLimitScheduleInput();
      //expect(instance).to.be.a(AwsStorageGateway.UpdateBandwidthRateLimitScheduleInput);
    });
