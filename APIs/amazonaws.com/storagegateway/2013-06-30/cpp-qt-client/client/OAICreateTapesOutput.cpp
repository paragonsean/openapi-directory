...
OAICreateTapesOutput::OAICreateTapesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTapesOutput::OAICreateTapesOutput() {
    this->initializeModel();
}

OAICreateTapesOutput::~OAICreateTapesOutput() {}

void OAICreateTapesOutput::initializeModel() {

    m_tape_arns_isSet = false;
    m_tape_arns_isValid = false;
}

void OAICreateTapesOutput::fromJson(QString jsonString) {
...
void OAICreateTapesOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateTapesOutput::asJson() const {
...
QJsonObject OAICreateTapesOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAICreateTapesOutput::getTapeArns() const {
    return m_tape_arns;
}
void OAICreateTapesOutput::setTapeArns(const QList &tape_arns) {
    m_tape_arns = tape_arns;
    m_tape_arns_isSet = true;
}

bool OAICreateTapesOutput::is_tape_arns_Set() const{
    return m_tape_arns_isSet;
}

bool OAICreateTapesOutput::is_tape_arns_Valid() const{
    return m_tape_arns_isValid;
}

bool OAICreateTapesOutput::isSet() const {
...
bool OAICreateTapesOutput::isValid() const {
