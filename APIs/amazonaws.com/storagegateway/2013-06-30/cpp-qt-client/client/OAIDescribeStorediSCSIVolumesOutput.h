...
/*
 * OAIDescribeStorediSCSIVolumesOutput.h
 *
 * 
 */

#ifndef OAIDescribeStorediSCSIVolumesOutput_H
#define OAIDescribeStorediSCSIVolumesOutput_H
...
class OAIDescribeStorediSCSIVolumesOutput : public OAIObject {
public:
    OAIDescribeStorediSCSIVolumesOutput();
    OAIDescribeStorediSCSIVolumesOutput(QString json);
    ~OAIDescribeStorediSCSIVolumesOutput() override;
    ...
    QList getStorediScsiVolumes() const;
    void setStorediScsiVolumes(const QList &storedi_scsi_volumes);
    bool is_storedi_scsi_volumes_Set() const;
    bool is_storedi_scsi_volumes_Valid() const;
...
private:
    ...
    QList m_storedi_scsi_volumes;
    bool m_storedi_scsi_volumes_isSet;
    bool m_storedi_scsi_volumes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStorediSCSIVolumesOutput)

#endif // OAIDescribeStorediSCSIVolumesOutput_H
