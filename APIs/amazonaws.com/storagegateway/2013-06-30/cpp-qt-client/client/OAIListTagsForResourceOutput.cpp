...
QString OAIListTagsForResourceOutput::getResourceArn() const {
    return m_resource_arn;
}
void OAIListTagsForResourceOutput::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIListTagsForResourceOutput::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIListTagsForResourceOutput::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QString OAIListTagsForResourceOutput::getMarker() const {
    return m_marker;
}
void OAIListTagsForResourceOutput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListTagsForResourceOutput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListTagsForResourceOutput::is_marker_Valid() const{
