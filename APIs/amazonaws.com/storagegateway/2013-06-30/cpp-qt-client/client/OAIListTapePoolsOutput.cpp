...
OAIListTapePoolsOutput::OAIListTapePoolsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTapePoolsOutput::OAIListTapePoolsOutput() {
    this->initializeModel();
}

OAIListTapePoolsOutput::~OAIListTapePoolsOutput() {}

void OAIListTapePoolsOutput::initializeModel() {

    m_pool_infos_isSet = false;
    m_pool_infos_isValid = false;

    m_marker_isSet = false;
    m_marker_isValid = false;
}

void OAIListTapePoolsOutput::fromJson(QString jsonString) {
...
void OAIListTapePoolsOutput::fromJsonObject(QJsonObject json) {

    m_pool_infos_isValid = ::OpenAPI::fromJsonValue(m_pool_infos, json[QString("PoolInfos")]);
    m_pool_infos_isSet = !json[QString("PoolInfos")].isNull() && m_pool_infos_isValid;
...
QString OAIListTapePoolsOutput::asJson() const {
...
QJsonObject OAIListTapePoolsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_pool_infos.isSet()) {
        obj.insert(QString("PoolInfos"), ::OpenAPI::toJsonValue(m_pool_infos));
    }
    if (m_marker_isSet) {
...
QList OAIListTapePoolsOutput::getPoolInfos() const {
    return m_pool_infos;
}
void OAIListTapePoolsOutput::setPoolInfos(const QList &pool_infos) {
    m_pool_infos = pool_infos;
    m_pool_infos_isSet = true;
}

bool OAIListTapePoolsOutput::is_pool_infos_Set() const{
    return m_pool_infos_isSet;
}

bool OAIListTapePoolsOutput::is_pool_infos_Valid() const{
    return m_pool_infos_isValid;
}

QString OAIListTapePoolsOutput::getMarker() const {
    return m_marker;
}
void OAIListTapePoolsOutput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListTapePoolsOutput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListTapePoolsOutput::is_marker_Valid() const{
    return m_marker_isValid;
}

bool OAIListTapePoolsOutput::isSet() const {
...
bool OAIListTapePoolsOutput::isValid() const {
