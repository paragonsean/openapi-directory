...
OAICreateSMBFileShareOutput::OAICreateSMBFileShareOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSMBFileShareOutput::OAICreateSMBFileShareOutput() {
    this->initializeModel();
}

OAICreateSMBFileShareOutput::~OAICreateSMBFileShareOutput() {}

void OAICreateSMBFileShareOutput::initializeModel() {

    m_file_share_arn_isSet = false;
    m_file_share_arn_isValid = false;
}

void OAICreateSMBFileShareOutput::fromJson(QString jsonString) {
...
void OAICreateSMBFileShareOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateSMBFileShareOutput::asJson() const {
...
QJsonObject OAICreateSMBFileShareOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSMBFileShareOutput::getFileShareArn() const {
    return m_file_share_arn;
}
void OAICreateSMBFileShareOutput::setFileShareArn(const QString &file_share_arn) {
    m_file_share_arn = file_share_arn;
    m_file_share_arn_isSet = true;
}

bool OAICreateSMBFileShareOutput::is_file_share_arn_Set() const{
    return m_file_share_arn_isSet;
}

bool OAICreateSMBFileShareOutput::is_file_share_arn_Valid() const{
    return m_file_share_arn_isValid;
}

bool OAICreateSMBFileShareOutput::isSet() const {
...
bool OAICreateSMBFileShareOutput::isValid() const {
