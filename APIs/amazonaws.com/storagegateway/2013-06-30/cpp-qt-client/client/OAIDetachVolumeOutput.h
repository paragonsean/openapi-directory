...
/*
 * OAIDetachVolumeOutput.h
 *
 * AttachVolumeOutput
 */

#ifndef OAIDetachVolumeOutput_H
#define OAIDetachVolumeOutput_H
...
class OAIDetachVolumeOutput : public OAIObject {
public:
    OAIDetachVolumeOutput();
    OAIDetachVolumeOutput(QString json);
    ~OAIDetachVolumeOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetachVolumeOutput)

#endif // OAIDetachVolumeOutput_H
