...
/*
 * OAIDescribeAvailabilityMonitorTestInput.h
 *
 * 
 */

#ifndef OAIDescribeAvailabilityMonitorTestInput_H
#define OAIDescribeAvailabilityMonitorTestInput_H
...
class OAIDescribeAvailabilityMonitorTestInput : public OAIObject {
public:
    OAIDescribeAvailabilityMonitorTestInput();
    OAIDescribeAvailabilityMonitorTestInput(QString json);
    ~OAIDescribeAvailabilityMonitorTestInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAvailabilityMonitorTestInput)

#endif // OAIDescribeAvailabilityMonitorTestInput_H
