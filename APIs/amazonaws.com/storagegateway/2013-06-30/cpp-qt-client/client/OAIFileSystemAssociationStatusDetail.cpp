...
#include "OAIFileSystemAssociationStatusDetail.h"
...
OAIFileSystemAssociationStatusDetail::OAIFileSystemAssociationStatusDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFileSystemAssociationStatusDetail::OAIFileSystemAssociationStatusDetail() {
    this->initializeModel();
}

OAIFileSystemAssociationStatusDetail::~OAIFileSystemAssociationStatusDetail() {}

void OAIFileSystemAssociationStatusDetail::initializeModel() {

    m_error_code_isSet = false;
    m_error_code_isValid = false;
}

void OAIFileSystemAssociationStatusDetail::fromJson(QString jsonString) {
...
void OAIFileSystemAssociationStatusDetail::fromJsonObject(QJsonObject json) {

    m_error_code_isValid = ::OpenAPI::fromJsonValue(m_error_code, json[QString("ErrorCode")]);
    m_error_code_isSet = !json[QString("ErrorCode")].isNull() && m_error_code_isValid;
}

QString OAIFileSystemAssociationStatusDetail::asJson() const {
...
QJsonObject OAIFileSystemAssociationStatusDetail::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFileSystemAssociationStatusDetail::getErrorCode() const {
    return m_error_code;
}
void OAIFileSystemAssociationStatusDetail::setErrorCode(const QString &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIFileSystemAssociationStatusDetail::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIFileSystemAssociationStatusDetail::is_error_code_Valid() const{
    return m_error_code_isValid;
}

bool OAIFileSystemAssociationStatusDetail::isSet() const {
...
bool OAIFileSystemAssociationStatusDetail::isValid() const {
