...
OAIStartGatewayInput::OAIStartGatewayInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartGatewayInput::OAIStartGatewayInput() {
    this->initializeModel();
}

OAIStartGatewayInput::~OAIStartGatewayInput() {}

void OAIStartGatewayInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIStartGatewayInput::fromJson(QString jsonString) {
...
void OAIStartGatewayInput::fromJsonObject(QJsonObject json) {
...
QString OAIStartGatewayInput::asJson() const {
...
QJsonObject OAIStartGatewayInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartGatewayInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIStartGatewayInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIStartGatewayInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIStartGatewayInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIStartGatewayInput::isSet() const {
...
bool OAIStartGatewayInput::isValid() const {
