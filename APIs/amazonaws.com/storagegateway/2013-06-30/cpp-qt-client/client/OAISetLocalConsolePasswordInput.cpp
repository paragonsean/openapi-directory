...
OAISetLocalConsolePasswordInput::OAISetLocalConsolePasswordInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetLocalConsolePasswordInput::OAISetLocalConsolePasswordInput() {
    this->initializeModel();
}

OAISetLocalConsolePasswordInput::~OAISetLocalConsolePasswordInput() {}

void OAISetLocalConsolePasswordInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;

    m_local_console_password_isSet = false;
    m_local_console_password_isValid = false;
}

void OAISetLocalConsolePasswordInput::fromJson(QString jsonString) {
...
void OAISetLocalConsolePasswordInput::fromJsonObject(QJsonObject json) {
    ...
    m_local_console_password_isValid = ::OpenAPI::fromJsonValue(m_local_console_password, json[QString("LocalConsolePassword")]);
    m_local_console_password_isSet = !json[QString("LocalConsolePassword")].isNull() && m_local_console_password_isValid;
}

QString OAISetLocalConsolePasswordInput::asJson() const {
...
QJsonObject OAISetLocalConsolePasswordInput::asJsonObject() const {
    QJsonObject obj;
    if (m_gateway_arn_isSet) {
        obj.insert(QString("GatewayARN"), ::OpenAPI::toJsonValue(m_gateway_arn));
    }
    if (m_local_console_password_isSet) {
        obj.insert(QString("LocalConsolePassword"), ::OpenAPI::toJsonValue(m_local_console_password));
    }
    return obj;
}

QString OAISetLocalConsolePasswordInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAISetLocalConsolePasswordInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAISetLocalConsolePasswordInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAISetLocalConsolePasswordInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QString OAISetLocalConsolePasswordInput::getLocalConsolePassword() const {
    return m_local_console_password;
}
void OAISetLocalConsolePasswordInput::setLocalConsolePassword(const QString &local_console_password) {
    m_local_console_password = local_console_password;
    m_local_console_password_isSet = true;
}

bool OAISetLocalConsolePasswordInput::is_local_console_password_Set() const{
    return m_local_console_password_isSet;
}

bool OAISetLocalConsolePasswordInput::is_local_console_password_Valid() const{
    return m_local_console_password_isValid;
}

bool OAISetLocalConsolePasswordInput::isSet() const {
...
bool OAISetLocalConsolePasswordInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_gateway_arn_isValid && m_local_console_password_isValid && true;
}
