...
/*
 * OAIDeleteTapePoolOutput.h
 *
 * 
 */

#ifndef OAIDeleteTapePoolOutput_H
#define OAIDeleteTapePoolOutput_H
...
class OAIDeleteTapePoolOutput : public OAIObject {
public:
    OAIDeleteTapePoolOutput();
    OAIDeleteTapePoolOutput(QString json);
    ~OAIDeleteTapePoolOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTapePoolOutput)

#endif // OAIDeleteTapePoolOutput_H
