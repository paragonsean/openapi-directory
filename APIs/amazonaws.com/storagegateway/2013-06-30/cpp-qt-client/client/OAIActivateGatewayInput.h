...
#ifndef OAIActivateGatewayInput_H
#define OAIActivateGatewayInput_H
...
class OAIActivateGatewayInput : public OAIObject {
public:
    OAIActivateGatewayInput();
    OAIActivateGatewayInput(QString json);
    ~OAIActivateGatewayInput() override;
    ...
    QString getGatewayRegion() const;
    void setGatewayRegion(const QString &gateway_region);
    bool is_gateway_region_Set() const;
    bool is_gateway_region_Valid() const;
    ...
    QString getTapeDriveType() const;
    void setTapeDriveType(const QString &tape_drive_type);
    bool is_tape_drive_type_Set() const;
    bool is_tape_drive_type_Valid() const;

    QString getMediumChangerType() const;
    void setMediumChangerType(const QString &medium_changer_type);
    bool is_medium_changer_type_Set() const;
    bool is_medium_changer_type_Valid() const;
...
private:
    ...
    QString m_gateway_region;
    bool m_gateway_region_isSet;
    bool m_gateway_region_isValid;

    QString m_gateway_type;
    bool m_gateway_type_isSet;
    bool m_gateway_type_isValid;

    QString m_tape_drive_type;
    bool m_tape_drive_type_isSet;
    bool m_tape_drive_type_isValid;

    QString m_medium_changer_type;
    bool m_medium_changer_type_isSet;
    bool m_medium_changer_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivateGatewayInput)

#endif // OAIActivateGatewayInput_H
