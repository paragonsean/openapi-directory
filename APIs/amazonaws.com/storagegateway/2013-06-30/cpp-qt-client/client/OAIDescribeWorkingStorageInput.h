...
/*
 * OAIDescribeWorkingStorageInput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway.
 */

#ifndef OAIDescribeWorkingStorageInput_H
#define OAIDescribeWorkingStorageInput_H
...
class OAIDescribeWorkingStorageInput : public OAIObject {
public:
    OAIDescribeWorkingStorageInput();
    OAIDescribeWorkingStorageInput(QString json);
    ~OAIDescribeWorkingStorageInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeWorkingStorageInput)

#endif // OAIDescribeWorkingStorageInput_H
