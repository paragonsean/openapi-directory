...
/*
 * OAIDescribeCachediSCSIVolumesOutput.h
 *
 * A JSON object containing the following fields:
 */

#ifndef OAIDescribeCachediSCSIVolumesOutput_H
#define OAIDescribeCachediSCSIVolumesOutput_H
...
class OAIDescribeCachediSCSIVolumesOutput : public OAIObject {
public:
    OAIDescribeCachediSCSIVolumesOutput();
    OAIDescribeCachediSCSIVolumesOutput(QString json);
    ~OAIDescribeCachediSCSIVolumesOutput() override;
    ...
    QList getCachediScsiVolumes() const;
    void setCachediScsiVolumes(const QList &cachedi_scsi_volumes);
    bool is_cachedi_scsi_volumes_Set() const;
    bool is_cachedi_scsi_volumes_Valid() const;
...
private:
    ...
    QList m_cachedi_scsi_volumes;
    bool m_cachedi_scsi_volumes_isSet;
    bool m_cachedi_scsi_volumes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCachediSCSIVolumesOutput)

#endif // OAIDescribeCachediSCSIVolumesOutput_H
