...
/*
 * OAIBandwidthRateLimitInterval.h
 *
 *  Describes a bandwidth rate limit interval for a gateway. A bandwidth rate limit schedule consists of one or more bandwidth rate limit intervals. A bandwidth rate limit interval defines a period of time on one or more days of the week, during which bandwidth rate limits are specified for uploading, downloading, or both. 
 */

#ifndef OAIBandwidthRateLimitInterval_H
#define OAIBandwidthRateLimitInterval_H
...
class OAIBandwidthRateLimitInterval : public OAIObject {
public:
    OAIBandwidthRateLimitInterval();
    OAIBandwidthRateLimitInterval(QString json);
    ~OAIBandwidthRateLimitInterval() override;
    ...
    qint32 getStartHourOfDay() const;
    void setStartHourOfDay(const qint32 &start_hour_of_day);
    bool is_start_hour_of_day_Set() const;
    bool is_start_hour_of_day_Valid() const;

    qint32 getStartMinuteOfHour() const;
    void setStartMinuteOfHour(const qint32 &start_minute_of_hour);
    bool is_start_minute_of_hour_Set() const;
    bool is_start_minute_of_hour_Valid() const;

    qint32 getEndHourOfDay() const;
    void setEndHourOfDay(const qint32 &end_hour_of_day);
    bool is_end_hour_of_day_Set() const;
    bool is_end_hour_of_day_Valid() const;

    qint32 getEndMinuteOfHour() const;
    void setEndMinuteOfHour(const qint32 &end_minute_of_hour);
    bool is_end_minute_of_hour_Set() const;
    bool is_end_minute_of_hour_Valid() const;

    QList getDaysOfWeek() const;
    void setDaysOfWeek(const QList &days_of_week);
    bool is_days_of_week_Set() const;
    bool is_days_of_week_Valid() const;

    qint32 getAverageUploadRateLimitInBitsPerSec() const;
    void setAverageUploadRateLimitInBitsPerSec(const qint32 &average_upload_rate_limit_in_bits_per_sec);
    bool is_average_upload_rate_limit_in_bits_per_sec_Set() const;
    bool is_average_upload_rate_limit_in_bits_per_sec_Valid() const;

    qint32 getAverageDownloadRateLimitInBitsPerSec() const;
    void setAverageDownloadRateLimitInBitsPerSec(const qint32 &average_download_rate_limit_in_bits_per_sec);
    bool is_average_download_rate_limit_in_bits_per_sec_Set() const;
    bool is_average_download_rate_limit_in_bits_per_sec_Valid() const;
...
private:
    ...
    qint32 m_start_hour_of_day;
    bool m_start_hour_of_day_isSet;
    bool m_start_hour_of_day_isValid;

    qint32 m_start_minute_of_hour;
    bool m_start_minute_of_hour_isSet;
    bool m_start_minute_of_hour_isValid;

    qint32 m_end_hour_of_day;
    bool m_end_hour_of_day_isSet;
    bool m_end_hour_of_day_isValid;

    qint32 m_end_minute_of_hour;
    bool m_end_minute_of_hour_isSet;
    bool m_end_minute_of_hour_isValid;

    QList m_days_of_week;
    bool m_days_of_week_isSet;
    bool m_days_of_week_isValid;

    qint32 m_average_upload_rate_limit_in_bits_per_sec;
    bool m_average_upload_rate_limit_in_bits_per_sec_isSet;
    bool m_average_upload_rate_limit_in_bits_per_sec_isValid;

    qint32 m_average_download_rate_limit_in_bits_per_sec;
    bool m_average_download_rate_limit_in_bits_per_sec_isSet;
    bool m_average_download_rate_limit_in_bits_per_sec_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBandwidthRateLimitInterval)

#endif // OAIBandwidthRateLimitInterval_H
