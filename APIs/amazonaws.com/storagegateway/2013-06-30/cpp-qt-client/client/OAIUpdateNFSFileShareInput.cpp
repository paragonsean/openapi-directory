...
OAIUpdateNFSFileShareInput::OAIUpdateNFSFileShareInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateNFSFileShareInput::OAIUpdateNFSFileShareInput() {
    this->initializeModel();
}

OAIUpdateNFSFileShareInput::~OAIUpdateNFSFileShareInput() {}

void OAIUpdateNFSFileShareInput::initializeModel() {
...
void OAIUpdateNFSFileShareInput::fromJson(QString jsonString) {
...
void OAIUpdateNFSFileShareInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateNFSFileShareInput::asJson() const {
...
QJsonObject OAIUpdateNFSFileShareInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateNFSFileShareInput::getFileShareArn() const {
    return m_file_share_arn;
}
void OAIUpdateNFSFileShareInput::setFileShareArn(const QString &file_share_arn) {
    m_file_share_arn = file_share_arn;
    m_file_share_arn_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_file_share_arn_Set() const{
    return m_file_share_arn_isSet;
}

bool OAIUpdateNFSFileShareInput::is_file_share_arn_Valid() const{
    return m_file_share_arn_isValid;
}

bool OAIUpdateNFSFileShareInput::getKmsEncrypted() const {
    return m_kms_encrypted;
}
void OAIUpdateNFSFileShareInput::setKmsEncrypted(const bool &kms_encrypted) {
    m_kms_encrypted = kms_encrypted;
    m_kms_encrypted_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_kms_encrypted_Set() const{
    return m_kms_encrypted_isSet;
}

bool OAIUpdateNFSFileShareInput::is_kms_encrypted_Valid() const{
    return m_kms_encrypted_isValid;
}

QString OAIUpdateNFSFileShareInput::getKmsKey() const {
    return m_kms_key;
}
void OAIUpdateNFSFileShareInput::setKmsKey(const QString &kms_key) {
    m_kms_key = kms_key;
    m_kms_key_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_kms_key_Set() const{
    return m_kms_key_isSet;
}

bool OAIUpdateNFSFileShareInput::is_kms_key_Valid() const{
    return m_kms_key_isValid;
}

OAIUpdateNFSFileShareInput_NFSFileShareDefaults OAIUpdateNFSFileShareInput::getNfsFileShareDefaults() const {
    return m_nfs_file_share_defaults;
}
void OAIUpdateNFSFileShareInput::setNfsFileShareDefaults(const OAIUpdateNFSFileShareInput_NFSFileShareDefaults &nfs_file_share_defaults) {
    m_nfs_file_share_defaults = nfs_file_share_defaults;
    m_nfs_file_share_defaults_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_nfs_file_share_defaults_Set() const{
    return m_nfs_file_share_defaults_isSet;
}

bool OAIUpdateNFSFileShareInput::is_nfs_file_share_defaults_Valid() const{
    return m_nfs_file_share_defaults_isValid;
}

QString OAIUpdateNFSFileShareInput::getDefaultStorageClass() const {
    return m_default_storage_class;
}
void OAIUpdateNFSFileShareInput::setDefaultStorageClass(const QString &default_storage_class) {
    m_default_storage_class = default_storage_class;
    m_default_storage_class_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_default_storage_class_Set() const{
    return m_default_storage_class_isSet;
}

bool OAIUpdateNFSFileShareInput::is_default_storage_class_Valid() const{
    return m_default_storage_class_isValid;
}

OAIObjectACL OAIUpdateNFSFileShareInput::getObjectAcl() const {
    return m_object_acl;
}
void OAIUpdateNFSFileShareInput::setObjectAcl(const OAIObjectACL &object_acl) {
    m_object_acl = object_acl;
    m_object_acl_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_object_acl_Set() const{
    return m_object_acl_isSet;
}

bool OAIUpdateNFSFileShareInput::is_object_acl_Valid() const{
    return m_object_acl_isValid;
}

QList OAIUpdateNFSFileShareInput::getClientList() const {
    return m_client_list;
}
void OAIUpdateNFSFileShareInput::setClientList(const QList &client_list) {
    m_client_list = client_list;
    m_client_list_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_client_list_Set() const{
    return m_client_list_isSet;
}

bool OAIUpdateNFSFileShareInput::is_client_list_Valid() const{
    return m_client_list_isValid;
}

QString OAIUpdateNFSFileShareInput::getSquash() const {
    return m_squash;
}
void OAIUpdateNFSFileShareInput::setSquash(const QString &squash) {
    m_squash = squash;
    m_squash_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_squash_Set() const{
    return m_squash_isSet;
}

bool OAIUpdateNFSFileShareInput::is_squash_Valid() const{
    return m_squash_isValid;
}

bool OAIUpdateNFSFileShareInput::getReadOnly() const {
    return m_read_only;
}
void OAIUpdateNFSFileShareInput::setReadOnly(const bool &read_only) {
    m_read_only = read_only;
    m_read_only_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_read_only_Set() const{
    return m_read_only_isSet;
}

bool OAIUpdateNFSFileShareInput::is_read_only_Valid() const{
    return m_read_only_isValid;
}

bool OAIUpdateNFSFileShareInput::getGuessMimeTypeEnabled() const {
    return m_guess_mime_type_enabled;
}
void OAIUpdateNFSFileShareInput::setGuessMimeTypeEnabled(const bool &guess_mime_type_enabled) {
    m_guess_mime_type_enabled = guess_mime_type_enabled;
    m_guess_mime_type_enabled_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_guess_mime_type_enabled_Set() const{
    return m_guess_mime_type_enabled_isSet;
}

bool OAIUpdateNFSFileShareInput::is_guess_mime_type_enabled_Valid() const{
    return m_guess_mime_type_enabled_isValid;
}

bool OAIUpdateNFSFileShareInput::getRequesterPays() const {
    return m_requester_pays;
}
void OAIUpdateNFSFileShareInput::setRequesterPays(const bool &requester_pays) {
    m_requester_pays = requester_pays;
    m_requester_pays_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_requester_pays_Set() const{
    return m_requester_pays_isSet;
}

bool OAIUpdateNFSFileShareInput::is_requester_pays_Valid() const{
    return m_requester_pays_isValid;
}

QString OAIUpdateNFSFileShareInput::getFileShareName() const {
    return m_file_share_name;
}
void OAIUpdateNFSFileShareInput::setFileShareName(const QString &file_share_name) {
    m_file_share_name = file_share_name;
    m_file_share_name_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_file_share_name_Set() const{
    return m_file_share_name_isSet;
}

bool OAIUpdateNFSFileShareInput::is_file_share_name_Valid() const{
    return m_file_share_name_isValid;
}

OAICreateNFSFileShareInput_CacheAttributes OAIUpdateNFSFileShareInput::getCacheAttributes() const {
    return m_cache_attributes;
}
void OAIUpdateNFSFileShareInput::setCacheAttributes(const OAICreateNFSFileShareInput_CacheAttributes &cache_attributes) {
    m_cache_attributes = cache_attributes;
    m_cache_attributes_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_cache_attributes_Set() const{
    return m_cache_attributes_isSet;
}

bool OAIUpdateNFSFileShareInput::is_cache_attributes_Valid() const{
    return m_cache_attributes_isValid;
}

QString OAIUpdateNFSFileShareInput::getNotificationPolicy() const {
    return m_notification_policy;
}
void OAIUpdateNFSFileShareInput::setNotificationPolicy(const QString &notification_policy) {
    m_notification_policy = notification_policy;
    m_notification_policy_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_notification_policy_Set() const{
    return m_notification_policy_isSet;
}

bool OAIUpdateNFSFileShareInput::is_notification_policy_Valid() const{
    return m_notification_policy_isValid;
}

QString OAIUpdateNFSFileShareInput::getAuditDestinationArn() const {
    return m_audit_destination_arn;
}
void OAIUpdateNFSFileShareInput::setAuditDestinationArn(const QString &audit_destination_arn) {
    m_audit_destination_arn = audit_destination_arn;
    m_audit_destination_arn_isSet = true;
}

bool OAIUpdateNFSFileShareInput::is_audit_destination_arn_Set() const{
    return m_audit_destination_arn_isSet;
}

bool OAIUpdateNFSFileShareInput::is_audit_destination_arn_Valid() const{
    return m_audit_destination_arn_isValid;
}

bool OAIUpdateNFSFileShareInput::isSet() const {
...
bool OAIUpdateNFSFileShareInput::isValid() const {
