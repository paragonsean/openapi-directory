...
OAIDetachVolumeInput::OAIDetachVolumeInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetachVolumeInput::OAIDetachVolumeInput() {
    this->initializeModel();
}

OAIDetachVolumeInput::~OAIDetachVolumeInput() {}

void OAIDetachVolumeInput::initializeModel() {

    m_volume_arn_isSet = false;
    m_volume_arn_isValid = false;

    m_force_detach_isSet = false;
    m_force_detach_isValid = false;
}

void OAIDetachVolumeInput::fromJson(QString jsonString) {
...
void OAIDetachVolumeInput::fromJsonObject(QJsonObject json) {
    ...
    m_force_detach_isValid = ::OpenAPI::fromJsonValue(m_force_detach, json[QString("ForceDetach")]);
    m_force_detach_isSet = !json[QString("ForceDetach")].isNull() && m_force_detach_isValid;
}

QString OAIDetachVolumeInput::asJson() const {
...
QJsonObject OAIDetachVolumeInput::asJsonObject() const {
    QJsonObject obj;
    if (m_volume_arn_isSet) {
        obj.insert(QString("VolumeARN"), ::OpenAPI::toJsonValue(m_volume_arn));
    }
    if (m_force_detach_isSet) {
        obj.insert(QString("ForceDetach"), ::OpenAPI::toJsonValue(m_force_detach));
    }
    return obj;
}

QString OAIDetachVolumeInput::getVolumeArn() const {
    return m_volume_arn;
}
void OAIDetachVolumeInput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAIDetachVolumeInput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAIDetachVolumeInput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

bool OAIDetachVolumeInput::getForceDetach() const {
    return m_force_detach;
}
void OAIDetachVolumeInput::setForceDetach(const bool &force_detach) {
    m_force_detach = force_detach;
    m_force_detach_isSet = true;
}

bool OAIDetachVolumeInput::is_force_detach_Set() const{
    return m_force_detach_isSet;
}

bool OAIDetachVolumeInput::is_force_detach_Valid() const{
    return m_force_detach_isValid;
}

bool OAIDetachVolumeInput::isSet() const {
...
bool OAIDetachVolumeInput::isValid() const {
