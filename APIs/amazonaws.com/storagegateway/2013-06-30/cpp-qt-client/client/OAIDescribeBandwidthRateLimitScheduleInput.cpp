...
OAIDescribeBandwidthRateLimitScheduleInput::OAIDescribeBandwidthRateLimitScheduleInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBandwidthRateLimitScheduleInput::OAIDescribeBandwidthRateLimitScheduleInput() {
    this->initializeModel();
}

OAIDescribeBandwidthRateLimitScheduleInput::~OAIDescribeBandwidthRateLimitScheduleInput() {}

void OAIDescribeBandwidthRateLimitScheduleInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDescribeBandwidthRateLimitScheduleInput::fromJson(QString jsonString) {
...
void OAIDescribeBandwidthRateLimitScheduleInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBandwidthRateLimitScheduleInput::asJson() const {
...
QJsonObject OAIDescribeBandwidthRateLimitScheduleInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBandwidthRateLimitScheduleInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeBandwidthRateLimitScheduleInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeBandwidthRateLimitScheduleInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeBandwidthRateLimitScheduleInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDescribeBandwidthRateLimitScheduleInput::isSet() const {
...
bool OAIDescribeBandwidthRateLimitScheduleInput::isValid() const {
