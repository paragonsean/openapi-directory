...
/*
 * OAIDescribeFileSystemAssociationsInput.h
 *
 * 
 */

#ifndef OAIDescribeFileSystemAssociationsInput_H
#define OAIDescribeFileSystemAssociationsInput_H
...
class OAIDescribeFileSystemAssociationsInput : public OAIObject {
public:
    OAIDescribeFileSystemAssociationsInput();
    OAIDescribeFileSystemAssociationsInput(QString json);
    ~OAIDescribeFileSystemAssociationsInput() override;
    ...
    QList getFileSystemAssociationArnList() const;
    void setFileSystemAssociationArnList(const QList &file_system_association_arn_list);
    bool is_file_system_association_arn_list_Set() const;
    bool is_file_system_association_arn_list_Valid() const;
...
private:
    ...
    QList m_file_system_association_arn_list;
    bool m_file_system_association_arn_list_isSet;
    bool m_file_system_association_arn_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFileSystemAssociationsInput)

#endif // OAIDescribeFileSystemAssociationsInput_H
