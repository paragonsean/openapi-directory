...
OAIDescribeTapeRecoveryPointsInput::OAIDescribeTapeRecoveryPointsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTapeRecoveryPointsInput::OAIDescribeTapeRecoveryPointsInput() {
    this->initializeModel();
}

OAIDescribeTapeRecoveryPointsInput::~OAIDescribeTapeRecoveryPointsInput() {}

void OAIDescribeTapeRecoveryPointsInput::initializeModel() {
...
void OAIDescribeTapeRecoveryPointsInput::fromJson(QString jsonString) {
...
void OAIDescribeTapeRecoveryPointsInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeTapeRecoveryPointsInput::asJson() const {
...
QJsonObject OAIDescribeTapeRecoveryPointsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeTapeRecoveryPointsInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeTapeRecoveryPointsInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeTapeRecoveryPointsInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeTapeRecoveryPointsInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QString OAIDescribeTapeRecoveryPointsInput::getMarker() const {
    return m_marker;
}
void OAIDescribeTapeRecoveryPointsInput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIDescribeTapeRecoveryPointsInput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIDescribeTapeRecoveryPointsInput::is_marker_Valid() const{
    return m_marker_isValid;
}

qint32 OAIDescribeTapeRecoveryPointsInput::getLimit() const {
    return m_limit;
}
void OAIDescribeTapeRecoveryPointsInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeTapeRecoveryPointsInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeTapeRecoveryPointsInput::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAIDescribeTapeRecoveryPointsInput::isSet() const {
...
bool OAIDescribeTapeRecoveryPointsInput::isValid() const {
