...
/*
 * OAIListVolumeRecoveryPointsInput.h
 *
 * 
 */

#ifndef OAIListVolumeRecoveryPointsInput_H
#define OAIListVolumeRecoveryPointsInput_H
...
class OAIListVolumeRecoveryPointsInput : public OAIObject {
public:
    OAIListVolumeRecoveryPointsInput();
    OAIListVolumeRecoveryPointsInput(QString json);
    ~OAIListVolumeRecoveryPointsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListVolumeRecoveryPointsInput)

#endif // OAIListVolumeRecoveryPointsInput_H
