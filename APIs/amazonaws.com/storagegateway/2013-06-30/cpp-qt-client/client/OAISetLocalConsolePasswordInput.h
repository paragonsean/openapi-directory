...
/*
 * OAISetLocalConsolePasswordInput.h
 *
 * SetLocalConsolePasswordInput
 */

#ifndef OAISetLocalConsolePasswordInput_H
#define OAISetLocalConsolePasswordInput_H
...
class OAISetLocalConsolePasswordInput : public OAIObject {
public:
    OAISetLocalConsolePasswordInput();
    OAISetLocalConsolePasswordInput(QString json);
    ~OAISetLocalConsolePasswordInput() override;
    ...
    QString getLocalConsolePassword() const;
    void setLocalConsolePassword(const QString &local_console_password);
    bool is_local_console_password_Set() const;
    bool is_local_console_password_Valid() const;
...
private:
    ...
    QString m_local_console_password;
    bool m_local_console_password_isSet;
    bool m_local_console_password_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISetLocalConsolePasswordInput)

#endif // OAISetLocalConsolePasswordInput_H
