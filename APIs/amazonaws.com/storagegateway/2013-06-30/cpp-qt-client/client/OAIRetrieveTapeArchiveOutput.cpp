...
OAIRetrieveTapeArchiveOutput::OAIRetrieveTapeArchiveOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRetrieveTapeArchiveOutput::OAIRetrieveTapeArchiveOutput() {
    this->initializeModel();
}

OAIRetrieveTapeArchiveOutput::~OAIRetrieveTapeArchiveOutput() {}

void OAIRetrieveTapeArchiveOutput::initializeModel() {

    m_tape_arn_isSet = false;
    m_tape_arn_isValid = false;
}

void OAIRetrieveTapeArchiveOutput::fromJson(QString jsonString) {
...
void OAIRetrieveTapeArchiveOutput::fromJsonObject(QJsonObject json) {
...
QString OAIRetrieveTapeArchiveOutput::asJson() const {
...
QJsonObject OAIRetrieveTapeArchiveOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_arn_isSet) {
...
QString OAIRetrieveTapeArchiveOutput::getTapeArn() const {
    return m_tape_arn;
}
void OAIRetrieveTapeArchiveOutput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAIRetrieveTapeArchiveOutput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAIRetrieveTapeArchiveOutput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

bool OAIRetrieveTapeArchiveOutput::isSet() const {
...
bool OAIRetrieveTapeArchiveOutput::isValid() const {
