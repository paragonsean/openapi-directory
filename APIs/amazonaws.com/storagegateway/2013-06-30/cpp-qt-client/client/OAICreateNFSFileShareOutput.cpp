...
OAICreateNFSFileShareOutput::OAICreateNFSFileShareOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateNFSFileShareOutput::OAICreateNFSFileShareOutput() {
    this->initializeModel();
}

OAICreateNFSFileShareOutput::~OAICreateNFSFileShareOutput() {}

void OAICreateNFSFileShareOutput::initializeModel() {

    m_file_share_arn_isSet = false;
    m_file_share_arn_isValid = false;
}

void OAICreateNFSFileShareOutput::fromJson(QString jsonString) {
...
void OAICreateNFSFileShareOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateNFSFileShareOutput::asJson() const {
...
QJsonObject OAICreateNFSFileShareOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateNFSFileShareOutput::getFileShareArn() const {
    return m_file_share_arn;
}
void OAICreateNFSFileShareOutput::setFileShareArn(const QString &file_share_arn) {
    m_file_share_arn = file_share_arn;
    m_file_share_arn_isSet = true;
}

bool OAICreateNFSFileShareOutput::is_file_share_arn_Set() const{
    return m_file_share_arn_isSet;
}

bool OAICreateNFSFileShareOutput::is_file_share_arn_Valid() const{
    return m_file_share_arn_isValid;
}

bool OAICreateNFSFileShareOutput::isSet() const {
...
bool OAICreateNFSFileShareOutput::isValid() const {
