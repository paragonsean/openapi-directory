...
OAIAddTagsToResourceInput::OAIAddTagsToResourceInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddTagsToResourceInput::OAIAddTagsToResourceInput() {
    this->initializeModel();
}

OAIAddTagsToResourceInput::~OAIAddTagsToResourceInput() {}

void OAIAddTagsToResourceInput::initializeModel() {
...
void OAIAddTagsToResourceInput::fromJson(QString jsonString) {
...
void OAIAddTagsToResourceInput::fromJsonObject(QJsonObject json) {
...
QString OAIAddTagsToResourceInput::asJson() const {
...
QJsonObject OAIAddTagsToResourceInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddTagsToResourceInput::getResourceArn() const {
    return m_resource_arn;
}
void OAIAddTagsToResourceInput::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIAddTagsToResourceInput::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIAddTagsToResourceInput::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QList OAIAddTagsToResourceInput::getTags() const {
    return m_tags;
}
void OAIAddTagsToResourceInput::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIAddTagsToResourceInput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIAddTagsToResourceInput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIAddTagsToResourceInput::isSet() const {
...
bool OAIAddTagsToResourceInput::isValid() const {
