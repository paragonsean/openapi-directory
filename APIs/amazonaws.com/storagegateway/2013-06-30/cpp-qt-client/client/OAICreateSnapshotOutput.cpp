...
OAICreateSnapshotOutput::OAICreateSnapshotOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSnapshotOutput::OAICreateSnapshotOutput() {
    this->initializeModel();
}

OAICreateSnapshotOutput::~OAICreateSnapshotOutput() {}

void OAICreateSnapshotOutput::initializeModel() {
...
void OAICreateSnapshotOutput::fromJson(QString jsonString) {
...
void OAICreateSnapshotOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateSnapshotOutput::asJson() const {
...
QJsonObject OAICreateSnapshotOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSnapshotOutput::getVolumeArn() const {
    return m_volume_arn;
}
void OAICreateSnapshotOutput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAICreateSnapshotOutput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAICreateSnapshotOutput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

QString OAICreateSnapshotOutput::getSnapshotId() const {
    return m_snapshot_id;
}
void OAICreateSnapshotOutput::setSnapshotId(const QString &snapshot_id) {
    m_snapshot_id = snapshot_id;
    m_snapshot_id_isSet = true;
}

bool OAICreateSnapshotOutput::is_snapshot_id_Set() const{
    return m_snapshot_id_isSet;
}

bool OAICreateSnapshotOutput::is_snapshot_id_Valid() const{
    return m_snapshot_id_isValid;
}

bool OAICreateSnapshotOutput::isSet() const {
...
bool OAICreateSnapshotOutput::isValid() const {
