...
/*
 * OAIDeleteTapePoolInput.h
 *
 * 
 */

#ifndef OAIDeleteTapePoolInput_H
#define OAIDeleteTapePoolInput_H
...
class OAIDeleteTapePoolInput : public OAIObject {
public:
    OAIDeleteTapePoolInput();
    OAIDeleteTapePoolInput(QString json);
    ~OAIDeleteTapePoolInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTapePoolInput)

#endif // OAIDeleteTapePoolInput_H
