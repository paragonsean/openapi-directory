...
OAIDisableGatewayInput::OAIDisableGatewayInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisableGatewayInput::OAIDisableGatewayInput() {
    this->initializeModel();
}

OAIDisableGatewayInput::~OAIDisableGatewayInput() {}

void OAIDisableGatewayInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDisableGatewayInput::fromJson(QString jsonString) {
...
void OAIDisableGatewayInput::fromJsonObject(QJsonObject json) {
...
QString OAIDisableGatewayInput::asJson() const {
...
QJsonObject OAIDisableGatewayInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisableGatewayInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDisableGatewayInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDisableGatewayInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDisableGatewayInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDisableGatewayInput::isSet() const {
...
bool OAIDisableGatewayInput::isValid() const {
