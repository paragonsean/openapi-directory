...
OAIUpdateMaintenanceStartTimeOutput::OAIUpdateMaintenanceStartTimeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateMaintenanceStartTimeOutput::OAIUpdateMaintenanceStartTimeOutput() {
    this->initializeModel();
}

OAIUpdateMaintenanceStartTimeOutput::~OAIUpdateMaintenanceStartTimeOutput() {}

void OAIUpdateMaintenanceStartTimeOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIUpdateMaintenanceStartTimeOutput::fromJson(QString jsonString) {
...
void OAIUpdateMaintenanceStartTimeOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateMaintenanceStartTimeOutput::asJson() const {
...
QJsonObject OAIUpdateMaintenanceStartTimeOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateMaintenanceStartTimeOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateMaintenanceStartTimeOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateMaintenanceStartTimeOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateMaintenanceStartTimeOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIUpdateMaintenanceStartTimeOutput::isSet() const {
...
bool OAIUpdateMaintenanceStartTimeOutput::isValid() const {
