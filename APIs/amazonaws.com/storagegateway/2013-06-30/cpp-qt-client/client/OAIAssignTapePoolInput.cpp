...
OAIAssignTapePoolInput::OAIAssignTapePoolInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssignTapePoolInput::OAIAssignTapePoolInput() {
    this->initializeModel();
}

OAIAssignTapePoolInput::~OAIAssignTapePoolInput() {}

void OAIAssignTapePoolInput::initializeModel() {
...
void OAIAssignTapePoolInput::fromJson(QString jsonString) {
...
void OAIAssignTapePoolInput::fromJsonObject(QJsonObject json) {
...
QString OAIAssignTapePoolInput::asJson() const {
...
QJsonObject OAIAssignTapePoolInput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_arn_isSet) {
...
QString OAIAssignTapePoolInput::getTapeArn() const {
    return m_tape_arn;
}
void OAIAssignTapePoolInput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAIAssignTapePoolInput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAIAssignTapePoolInput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

QString OAIAssignTapePoolInput::getPoolId() const {
    return m_pool_id;
}
void OAIAssignTapePoolInput::setPoolId(const QString &pool_id) {
    m_pool_id = pool_id;
    m_pool_id_isSet = true;
}

bool OAIAssignTapePoolInput::is_pool_id_Set() const{
    return m_pool_id_isSet;
}

bool OAIAssignTapePoolInput::is_pool_id_Valid() const{
    return m_pool_id_isValid;
}

bool OAIAssignTapePoolInput::getBypassGovernanceRetention() const {
    return m_bypass_governance_retention;
}
void OAIAssignTapePoolInput::setBypassGovernanceRetention(const bool &bypass_governance_retention) {
    m_bypass_governance_retention = bypass_governance_retention;
    m_bypass_governance_retention_isSet = true;
}

bool OAIAssignTapePoolInput::is_bypass_governance_retention_Set() const{
    return m_bypass_governance_retention_isSet;
}

bool OAIAssignTapePoolInput::is_bypass_governance_retention_Valid() const{
    return m_bypass_governance_retention_isValid;
}

bool OAIAssignTapePoolInput::isSet() const {
...
bool OAIAssignTapePoolInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_tape_arn_isValid && m_pool_id_isValid && true;
}
