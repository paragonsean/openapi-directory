...
/*
 * OAIDescribeUploadBufferOutput.h
 *
 * 
 */

#ifndef OAIDescribeUploadBufferOutput_H
#define OAIDescribeUploadBufferOutput_H
...
class OAIDescribeUploadBufferOutput : public OAIObject {
public:
    OAIDescribeUploadBufferOutput();
    OAIDescribeUploadBufferOutput(QString json);
    ~OAIDescribeUploadBufferOutput() override;
    ...
    qint32 getUploadBufferUsedInBytes() const;
    void setUploadBufferUsedInBytes(const qint32 &upload_buffer_used_in_bytes);
    bool is_upload_buffer_used_in_bytes_Set() const;
    bool is_upload_buffer_used_in_bytes_Valid() const;

    qint32 getUploadBufferAllocatedInBytes() const;
    void setUploadBufferAllocatedInBytes(const qint32 &upload_buffer_allocated_in_bytes);
    bool is_upload_buffer_allocated_in_bytes_Set() const;
    bool is_upload_buffer_allocated_in_bytes_Valid() const;
...
private:
    ...
    qint32 m_upload_buffer_used_in_bytes;
    bool m_upload_buffer_used_in_bytes_isSet;
    bool m_upload_buffer_used_in_bytes_isValid;

    qint32 m_upload_buffer_allocated_in_bytes;
    bool m_upload_buffer_allocated_in_bytes_isSet;
    bool m_upload_buffer_allocated_in_bytes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUploadBufferOutput)

#endif // OAIDescribeUploadBufferOutput_H
