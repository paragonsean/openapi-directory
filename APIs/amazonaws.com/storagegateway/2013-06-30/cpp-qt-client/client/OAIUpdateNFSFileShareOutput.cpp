...
OAIUpdateNFSFileShareOutput::OAIUpdateNFSFileShareOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateNFSFileShareOutput::OAIUpdateNFSFileShareOutput() {
    this->initializeModel();
}

OAIUpdateNFSFileShareOutput::~OAIUpdateNFSFileShareOutput() {}

void OAIUpdateNFSFileShareOutput::initializeModel() {

    m_file_share_arn_isSet = false;
    m_file_share_arn_isValid = false;
}

void OAIUpdateNFSFileShareOutput::fromJson(QString jsonString) {
...
void OAIUpdateNFSFileShareOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateNFSFileShareOutput::asJson() const {
...
QJsonObject OAIUpdateNFSFileShareOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateNFSFileShareOutput::getFileShareArn() const {
    return m_file_share_arn;
}
void OAIUpdateNFSFileShareOutput::setFileShareArn(const QString &file_share_arn) {
    m_file_share_arn = file_share_arn;
    m_file_share_arn_isSet = true;
}

bool OAIUpdateNFSFileShareOutput::is_file_share_arn_Set() const{
    return m_file_share_arn_isSet;
}

bool OAIUpdateNFSFileShareOutput::is_file_share_arn_Valid() const{
    return m_file_share_arn_isValid;
}

bool OAIUpdateNFSFileShareOutput::isSet() const {
...
bool OAIUpdateNFSFileShareOutput::isValid() const {
