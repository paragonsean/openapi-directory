...
/*
 * OAIDeleteVolumeOutput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the storage volume that was deleted.
 */

#ifndef OAIDeleteVolumeOutput_H
#define OAIDeleteVolumeOutput_H
...
class OAIDeleteVolumeOutput : public OAIObject {
public:
    OAIDeleteVolumeOutput();
    OAIDeleteVolumeOutput(QString json);
    ~OAIDeleteVolumeOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteVolumeOutput)

#endif // OAIDeleteVolumeOutput_H
