...
/*
 * OAIDescribeCacheOutput.h
 *
 * 
 */

#ifndef OAIDescribeCacheOutput_H
#define OAIDescribeCacheOutput_H
...
class OAIDescribeCacheOutput : public OAIObject {
public:
    OAIDescribeCacheOutput();
    OAIDescribeCacheOutput(QString json);
    ~OAIDescribeCacheOutput() override;
    ...
    QList getDiskIds() const;
    void setDiskIds(const QList &disk_ids);
    bool is_disk_ids_Set() const;
    bool is_disk_ids_Valid() const;

    qint32 getCacheAllocatedInBytes() const;
    void setCacheAllocatedInBytes(const qint32 &cache_allocated_in_bytes);
    bool is_cache_allocated_in_bytes_Set() const;
    bool is_cache_allocated_in_bytes_Valid() const;

    double getCacheUsedPercentage() const;
    void setCacheUsedPercentage(const double &cache_used_percentage);
    bool is_cache_used_percentage_Set() const;
    bool is_cache_used_percentage_Valid() const;

    double getCacheDirtyPercentage() const;
    void setCacheDirtyPercentage(const double &cache_dirty_percentage);
    bool is_cache_dirty_percentage_Set() const;
    bool is_cache_dirty_percentage_Valid() const;

    double getCacheHitPercentage() const;
    void setCacheHitPercentage(const double &cache_hit_percentage);
    bool is_cache_hit_percentage_Set() const;
    bool is_cache_hit_percentage_Valid() const;

    double getCacheMissPercentage() const;
    void setCacheMissPercentage(const double &cache_miss_percentage);
    bool is_cache_miss_percentage_Set() const;
    bool is_cache_miss_percentage_Valid() const;
...
private:
    ...
    QList m_disk_ids;
    bool m_disk_ids_isSet;
    bool m_disk_ids_isValid;

    qint32 m_cache_allocated_in_bytes;
    bool m_cache_allocated_in_bytes_isSet;
    bool m_cache_allocated_in_bytes_isValid;

    double m_cache_used_percentage;
    bool m_cache_used_percentage_isSet;
    bool m_cache_used_percentage_isValid;

    double m_cache_dirty_percentage;
    bool m_cache_dirty_percentage_isSet;
    bool m_cache_dirty_percentage_isValid;

    double m_cache_hit_percentage;
    bool m_cache_hit_percentage_isSet;
    bool m_cache_hit_percentage_isValid;

    double m_cache_miss_percentage;
    bool m_cache_miss_percentage_isSet;
    bool m_cache_miss_percentage_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCacheOutput)

#endif // OAIDescribeCacheOutput_H
