...
/*
 * OAIResetCacheInput.h
 *
 * 
 */

#ifndef OAIResetCacheInput_H
#define OAIResetCacheInput_H
...
class OAIResetCacheInput : public OAIObject {
public:
    OAIResetCacheInput();
    OAIResetCacheInput(QString json);
    ~OAIResetCacheInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResetCacheInput)

#endif // OAIResetCacheInput_H
