...
OAICancelRetrievalOutput::OAICancelRetrievalOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICancelRetrievalOutput::OAICancelRetrievalOutput() {
    this->initializeModel();
}

OAICancelRetrievalOutput::~OAICancelRetrievalOutput() {}

void OAICancelRetrievalOutput::initializeModel() {

    m_tape_arn_isSet = false;
    m_tape_arn_isValid = false;
}

void OAICancelRetrievalOutput::fromJson(QString jsonString) {
...
void OAICancelRetrievalOutput::fromJsonObject(QJsonObject json) {
...
QString OAICancelRetrievalOutput::asJson() const {
...
QJsonObject OAICancelRetrievalOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_arn_isSet) {
...
QString OAICancelRetrievalOutput::getTapeArn() const {
    return m_tape_arn;
}
void OAICancelRetrievalOutput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAICancelRetrievalOutput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAICancelRetrievalOutput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

bool OAICancelRetrievalOutput::isSet() const {
...
bool OAICancelRetrievalOutput::isValid() const {
