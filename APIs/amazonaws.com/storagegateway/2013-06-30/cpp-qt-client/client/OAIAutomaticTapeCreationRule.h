...
/*
 * OAIAutomaticTapeCreationRule.h
 *
...
#ifndef OAIAutomaticTapeCreationRule_H
#define OAIAutomaticTapeCreationRule_H
...
class OAIAutomaticTapeCreationRule : public OAIObject {
public:
    OAIAutomaticTapeCreationRule();
    OAIAutomaticTapeCreationRule(QString json);
    ~OAIAutomaticTapeCreationRule() override;
    ...
    qint32 getMinimumNumTapes() const;
    void setMinimumNumTapes(const qint32 &minimum_num_tapes);
    bool is_minimum_num_tapes_Set() const;
    bool is_minimum_num_tapes_Valid() const;
...
private:
    ...
    qint32 m_minimum_num_tapes;
    bool m_minimum_num_tapes_isSet;
    bool m_minimum_num_tapes_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutomaticTapeCreationRule)

#endif // OAIAutomaticTapeCreationRule_H
