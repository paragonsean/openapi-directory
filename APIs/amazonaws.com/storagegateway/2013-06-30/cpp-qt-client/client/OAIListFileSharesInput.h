...
/*
 * OAIListFileSharesInput.h
 *
 * ListFileShareInput
 */

#ifndef OAIListFileSharesInput_H
#define OAIListFileSharesInput_H
...
class OAIListFileSharesInput : public OAIObject {
public:
    OAIListFileSharesInput();
    OAIListFileSharesInput(QString json);
    ~OAIListFileSharesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFileSharesInput)

#endif // OAIListFileSharesInput_H
