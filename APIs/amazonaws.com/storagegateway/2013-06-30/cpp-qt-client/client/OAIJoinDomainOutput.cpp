...
OAIJoinDomainOutput::OAIJoinDomainOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJoinDomainOutput::OAIJoinDomainOutput() {
    this->initializeModel();
}

OAIJoinDomainOutput::~OAIJoinDomainOutput() {}

void OAIJoinDomainOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;

    m_active_directory_status_isSet = false;
    m_active_directory_status_isValid = false;
}

void OAIJoinDomainOutput::fromJson(QString jsonString) {
...
void OAIJoinDomainOutput::fromJsonObject(QJsonObject json) {
    ...
    m_active_directory_status_isValid = ::OpenAPI::fromJsonValue(m_active_directory_status, json[QString("ActiveDirectoryStatus")]);
    m_active_directory_status_isSet = !json[QString("ActiveDirectoryStatus")].isNull() && m_active_directory_status_isValid;
}

QString OAIJoinDomainOutput::asJson() const {
...
QJsonObject OAIJoinDomainOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_gateway_arn_isSet) {
        obj.insert(QString("GatewayARN"), ::OpenAPI::toJsonValue(m_gateway_arn));
    }
    if (m_active_directory_status.isSet()) {
        obj.insert(QString("ActiveDirectoryStatus"), ::OpenAPI::toJsonValue(m_active_directory_status));
    }
    return obj;
}

QString OAIJoinDomainOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIJoinDomainOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIJoinDomainOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIJoinDomainOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

OAIActiveDirectoryStatus OAIJoinDomainOutput::getActiveDirectoryStatus() const {
    return m_active_directory_status;
}
void OAIJoinDomainOutput::setActiveDirectoryStatus(const OAIActiveDirectoryStatus &active_directory_status) {
    m_active_directory_status = active_directory_status;
    m_active_directory_status_isSet = true;
}

bool OAIJoinDomainOutput::is_active_directory_status_Set() const{
    return m_active_directory_status_isSet;
}

bool OAIJoinDomainOutput::is_active_directory_status_Valid() const{
    return m_active_directory_status_isValid;
}

bool OAIJoinDomainOutput::isSet() const {
...
bool OAIJoinDomainOutput::isValid() const {
