...
/*
 * OAIUpdateGatewaySoftwareNowOutput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway that was updated.
 */

#ifndef OAIUpdateGatewaySoftwareNowOutput_H
#define OAIUpdateGatewaySoftwareNowOutput_H
...
class OAIUpdateGatewaySoftwareNowOutput : public OAIObject {
public:
    OAIUpdateGatewaySoftwareNowOutput();
    OAIUpdateGatewaySoftwareNowOutput(QString json);
    ~OAIUpdateGatewaySoftwareNowOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGatewaySoftwareNowOutput)

#endif // OAIUpdateGatewaySoftwareNowOutput_H
