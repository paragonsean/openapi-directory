...
/*
 * OAIDescribeAvailabilityMonitorTestOutput.h
 *
 * 
 */

#ifndef OAIDescribeAvailabilityMonitorTestOutput_H
#define OAIDescribeAvailabilityMonitorTestOutput_H

#include <QJsonObject>

#include "OAIAvailabilityMonitorTestStatus.h"
#include <QDateTime>
#include <QString>
...
class OAIDescribeAvailabilityMonitorTestOutput : public OAIObject {
public:
    OAIDescribeAvailabilityMonitorTestOutput();
    OAIDescribeAvailabilityMonitorTestOutput(QString json);
    ~OAIDescribeAvailabilityMonitorTestOutput() override;
    ...
    OAIAvailabilityMonitorTestStatus getStatus() const;
    void setStatus(const OAIAvailabilityMonitorTestStatus &status);
...
private:
    ...
    OAIAvailabilityMonitorTestStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAvailabilityMonitorTestOutput)

#endif // OAIDescribeAvailabilityMonitorTestOutput_H
