...
#ifndef OAIChapInfo_H
#define OAIChapInfo_H
...
class OAIChapInfo : public OAIObject {
public:
    OAIChapInfo();
    OAIChapInfo(QString json);
    ~OAIChapInfo() override;
    ...
    QString getSecretToAuthenticateInitiator() const;
    void setSecretToAuthenticateInitiator(const QString &secret_to_authenticate_initiator);
    bool is_secret_to_authenticate_initiator_Set() const;
    bool is_secret_to_authenticate_initiator_Valid() const;
    ...
    QString getSecretToAuthenticateTarget() const;
    void setSecretToAuthenticateTarget(const QString &secret_to_authenticate_target);
    bool is_secret_to_authenticate_target_Set() const;
    bool is_secret_to_authenticate_target_Valid() const;
...
private:
    ...
    QString m_secret_to_authenticate_initiator;
    bool m_secret_to_authenticate_initiator_isSet;
    bool m_secret_to_authenticate_initiator_isValid;

    QString m_initiator_name;
    bool m_initiator_name_isSet;
    bool m_initiator_name_isValid;

    QString m_secret_to_authenticate_target;
    bool m_secret_to_authenticate_target_isSet;
    bool m_secret_to_authenticate_target_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIChapInfo)
