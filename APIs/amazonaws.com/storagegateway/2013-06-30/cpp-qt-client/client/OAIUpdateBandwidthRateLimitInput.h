...
/*
 * OAIUpdateBandwidthRateLimitInput.h
 *
...
#ifndef OAIUpdateBandwidthRateLimitInput_H
#define OAIUpdateBandwidthRateLimitInput_H
...
class OAIUpdateBandwidthRateLimitInput : public OAIObject {
public:
    OAIUpdateBandwidthRateLimitInput();
    OAIUpdateBandwidthRateLimitInput(QString json);
    ~OAIUpdateBandwidthRateLimitInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBandwidthRateLimitInput)

#endif // OAIUpdateBandwidthRateLimitInput_H
