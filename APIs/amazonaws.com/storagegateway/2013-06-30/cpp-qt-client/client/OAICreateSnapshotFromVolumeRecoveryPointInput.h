...
/*
 * OAICreateSnapshotFromVolumeRecoveryPointInput.h
 *
 * 
 */

#ifndef OAICreateSnapshotFromVolumeRecoveryPointInput_H
#define OAICreateSnapshotFromVolumeRecoveryPointInput_H
...
class OAICreateSnapshotFromVolumeRecoveryPointInput : public OAIObject {
public:
    OAICreateSnapshotFromVolumeRecoveryPointInput();
    OAICreateSnapshotFromVolumeRecoveryPointInput(QString json);
    ~OAICreateSnapshotFromVolumeRecoveryPointInput() override;
    ...
    void setSnapshotDescription(const QString &snapshot_description);
    bool is_snapshot_description_Set() const;
    bool is_snapshot_description_Valid() const;
...
private:
    ...
    QString m_snapshot_description;
    bool m_snapshot_description_isSet;
    bool m_snapshot_description_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSnapshotFromVolumeRecoveryPointInput)

#endif // OAICreateSnapshotFromVolumeRecoveryPointInput_H
