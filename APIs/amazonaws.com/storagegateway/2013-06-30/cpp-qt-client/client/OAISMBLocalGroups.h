...
#ifndef OAISMBLocalGroups_H
#define OAISMBLocalGroups_H
...
class OAISMBLocalGroups : public OAIObject {
public:
    OAISMBLocalGroups();
    OAISMBLocalGroups(QString json);
    ~OAISMBLocalGroups() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISMBLocalGroups)

#endif // OAISMBLocalGroups_H
