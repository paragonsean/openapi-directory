...
class OAIAddWorkingStorageInput : public OAIObject {
public:
    OAIAddWorkingStorageInput();
    OAIAddWorkingStorageInput(QString json);
    ~OAIAddWorkingStorageInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddWorkingStorageInput)

#endif // OAIAddWorkingStorageInput_H
