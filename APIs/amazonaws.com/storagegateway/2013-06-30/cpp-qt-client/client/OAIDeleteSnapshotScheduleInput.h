...
/*
 * OAIDeleteSnapshotScheduleInput.h
 *
 * 
 */

#ifndef OAIDeleteSnapshotScheduleInput_H
#define OAIDeleteSnapshotScheduleInput_H
...
class OAIDeleteSnapshotScheduleInput : public OAIObject {
public:
    OAIDeleteSnapshotScheduleInput();
    OAIDeleteSnapshotScheduleInput(QString json);
    ~OAIDeleteSnapshotScheduleInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSnapshotScheduleInput)

#endif // OAIDeleteSnapshotScheduleInput_H
