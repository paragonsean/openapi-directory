...
#ifndef OAIVolumeInfo_H
#define OAIVolumeInfo_H
...
class OAIVolumeInfo : public OAIObject {
public:
    OAIVolumeInfo();
    OAIVolumeInfo(QString json);
    ~OAIVolumeInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVolumeInfo)

#endif // OAIVolumeInfo_H
