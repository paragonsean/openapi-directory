...
/*
 * OAIRetentionLockType.h
 *
 * 
 */

#ifndef OAIRetentionLockType_H
#define OAIRetentionLockType_H
...
class OAIRetentionLockType : public OAIEnum {
public:
    OAIRetentionLockType();
    OAIRetentionLockType(QString json);
    ~OAIRetentionLockType() override;
    ...
    enum class eOAIRetentionLockType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        COMPLIANCE, 
        GOVERNANCE, 
        NONE
    };
    OAIRetentionLockType::eOAIRetentionLockType getValue() const;
    void setValue(const OAIRetentionLockType::eOAIRetentionLockType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetentionLockType)

#endif // OAIRetentionLockType_H
