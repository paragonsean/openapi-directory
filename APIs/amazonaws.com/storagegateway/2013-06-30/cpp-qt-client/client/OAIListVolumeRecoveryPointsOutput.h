...
/*
 * OAIListVolumeRecoveryPointsOutput.h
 *
 * 
 */

#ifndef OAIListVolumeRecoveryPointsOutput_H
#define OAIListVolumeRecoveryPointsOutput_H
...
class OAIListVolumeRecoveryPointsOutput : public OAIObject {
public:
    OAIListVolumeRecoveryPointsOutput();
    OAIListVolumeRecoveryPointsOutput(QString json);
    ~OAIListVolumeRecoveryPointsOutput() override;
    ...
    QList getVolumeRecoveryPointInfos() const;
    void setVolumeRecoveryPointInfos(const QList &volume_recovery_point_infos);
    bool is_volume_recovery_point_infos_Set() const;
    bool is_volume_recovery_point_infos_Valid() const;
...
private:
    ...
    QList m_volume_recovery_point_infos;
    bool m_volume_recovery_point_infos_isSet;
    bool m_volume_recovery_point_infos_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListVolumeRecoveryPointsOutput)

#endif // OAIListVolumeRecoveryPointsOutput_H
