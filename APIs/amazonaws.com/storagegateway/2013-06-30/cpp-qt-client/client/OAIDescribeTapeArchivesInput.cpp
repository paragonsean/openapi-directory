...
OAIDescribeTapeArchivesInput::OAIDescribeTapeArchivesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTapeArchivesInput::OAIDescribeTapeArchivesInput() {
    this->initializeModel();
}

OAIDescribeTapeArchivesInput::~OAIDescribeTapeArchivesInput() {}

void OAIDescribeTapeArchivesInput::initializeModel() {
...
void OAIDescribeTapeArchivesInput::fromJson(QString jsonString) {
...
void OAIDescribeTapeArchivesInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeTapeArchivesInput::asJson() const {
...
QJsonObject OAIDescribeTapeArchivesInput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeTapeArchivesInput::getTapeArns() const {
    return m_tape_arns;
}
void OAIDescribeTapeArchivesInput::setTapeArns(const QList &tape_arns) {
    m_tape_arns = tape_arns;
    m_tape_arns_isSet = true;
}

bool OAIDescribeTapeArchivesInput::is_tape_arns_Set() const{
    return m_tape_arns_isSet;
}

bool OAIDescribeTapeArchivesInput::is_tape_arns_Valid() const{
    return m_tape_arns_isValid;
}

QString OAIDescribeTapeArchivesInput::getMarker() const {
    return m_marker;
}
void OAIDescribeTapeArchivesInput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIDescribeTapeArchivesInput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIDescribeTapeArchivesInput::is_marker_Valid() const{
    return m_marker_isValid;
}

qint32 OAIDescribeTapeArchivesInput::getLimit() const {
    return m_limit;
}
void OAIDescribeTapeArchivesInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeTapeArchivesInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeTapeArchivesInput::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAIDescribeTapeArchivesInput::isSet() const {
...
bool OAIDescribeTapeArchivesInput::isValid() const {
