...
#ifndef OAINFSFileShareInfo_H
#define OAINFSFileShareInfo_H

#include <QJsonObject>

#include "OAINFSFileShareDefaults.h"
#include "OAINFSFileShareInfo_CacheAttributes.h"
...
namespace OpenAPI {
class OAINFSFileShareDefaults;
class OAINFSFileShareInfo_CacheAttributes;

class OAINFSFileShareInfo : public OAIObject {
public:
    OAINFSFileShareInfo();
    OAINFSFileShareInfo(QString json);
    ~OAINFSFileShareInfo() override;
    ...
    OAINFSFileShareDefaults getNfsFileShareDefaults() const;
    void setNfsFileShareDefaults(const OAINFSFileShareDefaults &nfs_file_share_defaults);
    ...
    QString getFileShareId() const;
    void setFileShareId(const QString &file_share_id);
    bool is_file_share_id_Set() const;
    bool is_file_share_id_Valid() const;

    QString getFileShareStatus() const;
    void setFileShareStatus(const QString &file_share_status);
    bool is_file_share_status_Set() const;
    bool is_file_share_status_Valid() const;
    ...
    void setClientList(const QList<QString> &client_list);
    ...
    OAINFSFileShareInfo_CacheAttributes getCacheAttributes() const;
    void setCacheAttributes(const OAINFSFileShareInfo_CacheAttributes &cache_attributes);
...
private:
    ...
    OAINFSFileShareDefaults m_nfs_file_share_defaults;
    ...
    QString m_file_share_id;
    bool m_file_share_id_isSet;
    bool m_file_share_id_isValid;

    QString m_file_share_status;
    bool m_file_share_status_isSet;
    bool m_file_share_status_isValid;
    ...
    OAINFSFileShareInfo_CacheAttributes m_cache_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAINFSFileShareInfo)

#endif // OAINFSFileShareInfo_H
