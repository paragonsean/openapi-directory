...
/*
 * OAICreateTapesOutput.h
 *
 * CreateTapeOutput
 */

#ifndef OAICreateTapesOutput_H
#define OAICreateTapesOutput_H
...
class OAICreateTapesOutput : public OAIObject {
public:
    OAICreateTapesOutput();
    OAICreateTapesOutput(QString json);
    ~OAICreateTapesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTapesOutput)

#endif // OAICreateTapesOutput_H
