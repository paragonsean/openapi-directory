...
OAIListTapesOutput::OAIListTapesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTapesOutput::OAIListTapesOutput() {
    this->initializeModel();
}

OAIListTapesOutput::~OAIListTapesOutput() {}

void OAIListTapesOutput::initializeModel() {

    m_tape_infos_isSet = false;
    m_tape_infos_isValid = false;

    m_marker_isSet = false;
    m_marker_isValid = false;
}

void OAIListTapesOutput::fromJson(QString jsonString) {
...
void OAIListTapesOutput::fromJsonObject(QJsonObject json) {

    m_tape_infos_isValid = ::OpenAPI::fromJsonValue(m_tape_infos, json[QString("TapeInfos")]);
    m_tape_infos_isSet = !json[QString("TapeInfos")].isNull() && m_tape_infos_isValid;
...
QString OAIListTapesOutput::asJson() const {
...
QJsonObject OAIListTapesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_infos.size() > 0) {
        obj.insert(QString("TapeInfos"), ::OpenAPI::toJsonValue(m_tape_infos));
    }
    if (m_marker_isSet) {
...
QList<OAITapeInfo> OAIListTapesOutput::getTapeInfos() const {
    return m_tape_infos;
}
void OAIListTapesOutput::setTapeInfos(const QList<OAITapeInfo> &tape_infos) {
    m_tape_infos = tape_infos;
    m_tape_infos_isSet = true;
}

bool OAIListTapesOutput::is_tape_infos_Set() const{
    return m_tape_infos_isSet;
}

bool OAIListTapesOutput::is_tape_infos_Valid() const{
    return m_tape_infos_isValid;
}

QString OAIListTapesOutput::getMarker() const {
    return m_marker;
}
void OAIListTapesOutput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListTapesOutput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListTapesOutput::is_marker_Valid() const{
    return m_marker_isValid;
}

bool OAIListTapesOutput::isSet() const {
...
bool OAIListTapesOutput::isValid() const {
