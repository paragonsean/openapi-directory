...
/*
 * OAIUpdateSMBFileShareVisibilityInput.h
 *
 * 
 */

#ifndef OAIUpdateSMBFileShareVisibilityInput_H
#define OAIUpdateSMBFileShareVisibilityInput_H
...
class OAIUpdateSMBFileShareVisibilityInput : public OAIObject {
public:
    OAIUpdateSMBFileShareVisibilityInput();
    OAIUpdateSMBFileShareVisibilityInput(QString json);
    ~OAIUpdateSMBFileShareVisibilityInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSMBFileShareVisibilityInput)

#endif // OAIUpdateSMBFileShareVisibilityInput_H
