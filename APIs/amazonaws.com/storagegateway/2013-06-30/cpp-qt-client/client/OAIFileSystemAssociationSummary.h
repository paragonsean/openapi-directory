...
class OAIFileSystemAssociationSummary : public OAIObject {
public:
    OAIFileSystemAssociationSummary();
    OAIFileSystemAssociationSummary(QString json);
    ~OAIFileSystemAssociationSummary() override;
    ...
    QString getFileSystemAssociationId() const;
    void setFileSystemAssociationId(const QString &file_system_association_id);
    bool is_file_system_association_id_Set() const;
    bool is_file_system_association_id_Valid() const;
...
private:
    ...
    QString m_file_system_association_id;
    bool m_file_system_association_id_isSet;
    bool m_file_system_association_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileSystemAssociationSummary)

#endif // OAIFileSystemAssociationSummary_H
