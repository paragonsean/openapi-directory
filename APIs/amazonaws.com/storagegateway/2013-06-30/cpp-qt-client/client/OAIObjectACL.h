...
#ifndef OAIObjectACL_H
#define OAIObjectACL_H
...
class OAIObjectACL : public OAIEnum {
public:
    OAIObjectACL();
    OAIObjectACL(QString json);
    ~OAIObjectACL() override;
    ...
    OAIObjectACL::eOAIObjectACL getValue() const;
    void setValue(const OAIObjectACL::eOAIObjectACL& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIObjectACL)

#endif // OAIObjectACL_H
