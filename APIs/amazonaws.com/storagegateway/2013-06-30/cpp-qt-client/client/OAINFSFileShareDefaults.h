...
#ifndef OAINFSFileShareDefaults_H
#define OAINFSFileShareDefaults_H
...
class OAINFSFileShareDefaults : public OAIObject {
public:
    OAINFSFileShareDefaults();
    OAINFSFileShareDefaults(QString json);
    ~OAINFSFileShareDefaults() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINFSFileShareDefaults)

#endif // OAINFSFileShareDefaults_H
