...
OAIListGatewaysInput::OAIListGatewaysInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGatewaysInput::OAIListGatewaysInput() {
    this->initializeModel();
}

OAIListGatewaysInput::~OAIListGatewaysInput() {}

void OAIListGatewaysInput::initializeModel() {
...
void OAIListGatewaysInput::fromJson(QString jsonString) {
...
void OAIListGatewaysInput::fromJsonObject(QJsonObject json) {
...
QString OAIListGatewaysInput::asJson() const {
...
QJsonObject OAIListGatewaysInput::asJsonObject() const {
    QJsonObject obj;
    if (m_marker_isSet) {
...
QString OAIListGatewaysInput::getMarker() const {
    return m_marker;
}
void OAIListGatewaysInput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListGatewaysInput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListGatewaysInput::is_marker_Valid() const{
    return m_marker_isValid;
}

qint32 OAIListGatewaysInput::getLimit() const {
    return m_limit;
}
void OAIListGatewaysInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListGatewaysInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListGatewaysInput::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAIListGatewaysInput::isSet() const {
...
bool OAIListGatewaysInput::isValid() const {
