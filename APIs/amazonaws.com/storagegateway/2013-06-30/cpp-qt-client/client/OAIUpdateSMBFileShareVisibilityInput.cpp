...
OAIUpdateSMBFileShareVisibilityInput::OAIUpdateSMBFileShareVisibilityInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSMBFileShareVisibilityInput::OAIUpdateSMBFileShareVisibilityInput() {
    this->initializeModel();
}

OAIUpdateSMBFileShareVisibilityInput::~OAIUpdateSMBFileShareVisibilityInput() {}

void OAIUpdateSMBFileShareVisibilityInput::initializeModel() {
...
void OAIUpdateSMBFileShareVisibilityInput::fromJson(QString jsonString) {
...
void OAIUpdateSMBFileShareVisibilityInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSMBFileShareVisibilityInput::asJson() const {
...
QJsonObject OAIUpdateSMBFileShareVisibilityInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSMBFileShareVisibilityInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateSMBFileShareVisibilityInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateSMBFileShareVisibilityInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateSMBFileShareVisibilityInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIUpdateSMBFileShareVisibilityInput::getFileSharesVisible() const {
    return m_file_shares_visible;
}
void OAIUpdateSMBFileShareVisibilityInput::setFileSharesVisible(const bool &file_shares_visible) {
    m_file_shares_visible = file_shares_visible;
    m_file_shares_visible_isSet = true;
}

bool OAIUpdateSMBFileShareVisibilityInput::is_file_shares_visible_Set() const{
    return m_file_shares_visible_isSet;
}

bool OAIUpdateSMBFileShareVisibilityInput::is_file_shares_visible_Valid() const{
    return m_file_shares_visible_isValid;
}

bool OAIUpdateSMBFileShareVisibilityInput::isSet() const {
...
bool OAIUpdateSMBFileShareVisibilityInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_gateway_arn_isValid && m_file_shares_visible_isValid && true;
}
