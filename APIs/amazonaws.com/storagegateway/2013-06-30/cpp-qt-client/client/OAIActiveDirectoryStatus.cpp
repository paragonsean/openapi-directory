...
OAIActiveDirectoryStatus::OAIActiveDirectoryStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActiveDirectoryStatus::OAIActiveDirectoryStatus() {
    this->initializeModel();
}

OAIActiveDirectoryStatus::~OAIActiveDirectoryStatus() {}

void OAIActiveDirectoryStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIActiveDirectoryStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIActiveDirectoryStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACCESS_DENIED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActiveDirectoryStatus::ACCESS_DENIED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DETACHED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActiveDirectoryStatus::DETACHED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("JOINED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActiveDirectoryStatus::JOINED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("JOINING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActiveDirectoryStatus::JOINING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NETWORK_ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActiveDirectoryStatus::NETWORK_ERROR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TIMEOUT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActiveDirectoryStatus::TIMEOUT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UNKNOWN_ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActiveDirectoryStatus::UNKNOWN_ERROR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIActiveDirectoryStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIActiveDirectoryStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIActiveDirectoryStatus::ACCESS_DENIED:
            val = "ACCESS_DENIED";
            break;
        case eOAIActiveDirectoryStatus::DETACHED:
            val = "DETACHED";
            break;
        case eOAIActiveDirectoryStatus::JOINED:
            val = "JOINED";
            break;
        case eOAIActiveDirectoryStatus::JOINING:
            val = "JOINING";
            break;
        case eOAIActiveDirectoryStatus::NETWORK_ERROR:
            val = "NETWORK_ERROR";
            break;
        case eOAIActiveDirectoryStatus::TIMEOUT:
            val = "TIMEOUT";
            break;
        case eOAIActiveDirectoryStatus::UNKNOWN_ERROR:
            val = "UNKNOWN_ERROR";
            break;
        default:
            break;
...
QJsonValue OAIActiveDirectoryStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIActiveDirectoryStatus::eOAIActiveDirectoryStatus OAIActiveDirectoryStatus::getValue() const {
    return m_value;
}

void OAIActiveDirectoryStatus::setValue(const OAIActiveDirectoryStatus::eOAIActiveDirectoryStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIActiveDirectoryStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIActiveDirectoryStatus::isValid() const {
