...
/*
 * OAIAvailabilityMonitorTestStatus.h
 *
 * 
 */

#ifndef OAIAvailabilityMonitorTestStatus_H
#define OAIAvailabilityMonitorTestStatus_H
...
class OAIAvailabilityMonitorTestStatus : public OAIEnum {
public:
    OAIAvailabilityMonitorTestStatus();
    OAIAvailabilityMonitorTestStatus(QString json);
    ~OAIAvailabilityMonitorTestStatus() override;
    ...
    enum class eOAIAvailabilityMonitorTestStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        COMPLETE, 
        FAILED, 
        PENDING
    };
    OAIAvailabilityMonitorTestStatus::eOAIAvailabilityMonitorTestStatus getValue() const;
    void setValue(const OAIAvailabilityMonitorTestStatus::eOAIAvailabilityMonitorTestStatus& value);
...
private:
    ...
    eOAIAvailabilityMonitorTestStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAvailabilityMonitorTestStatus)

#endif // OAIAvailabilityMonitorTestStatus_H
