...
OAIUpdateMaintenanceStartTimeInput::OAIUpdateMaintenanceStartTimeInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateMaintenanceStartTimeInput::OAIUpdateMaintenanceStartTimeInput() {
    this->initializeModel();
}

OAIUpdateMaintenanceStartTimeInput::~OAIUpdateMaintenanceStartTimeInput() {}

void OAIUpdateMaintenanceStartTimeInput::initializeModel() {
...
void OAIUpdateMaintenanceStartTimeInput::fromJson(QString jsonString) {
...
void OAIUpdateMaintenanceStartTimeInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateMaintenanceStartTimeInput::asJson() const {
...
QJsonObject OAIUpdateMaintenanceStartTimeInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateMaintenanceStartTimeInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateMaintenanceStartTimeInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateMaintenanceStartTimeInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateMaintenanceStartTimeInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

qint32 OAIUpdateMaintenanceStartTimeInput::getHourOfDay() const {
    return m_hour_of_day;
}
void OAIUpdateMaintenanceStartTimeInput::setHourOfDay(const qint32 &hour_of_day) {
    m_hour_of_day = hour_of_day;
    m_hour_of_day_isSet = true;
}

bool OAIUpdateMaintenanceStartTimeInput::is_hour_of_day_Set() const{
    return m_hour_of_day_isSet;
}

bool OAIUpdateMaintenanceStartTimeInput::is_hour_of_day_Valid() const{
    return m_hour_of_day_isValid;
}

qint32 OAIUpdateMaintenanceStartTimeInput::getMinuteOfHour() const {
    return m_minute_of_hour;
}
void OAIUpdateMaintenanceStartTimeInput::setMinuteOfHour(const qint32 &minute_of_hour) {
    m_minute_of_hour = minute_of_hour;
    m_minute_of_hour_isSet = true;
}

bool OAIUpdateMaintenanceStartTimeInput::is_minute_of_hour_Set() const{
    return m_minute_of_hour_isSet;
}

bool OAIUpdateMaintenanceStartTimeInput::is_minute_of_hour_Valid() const{
    return m_minute_of_hour_isValid;
}

qint32 OAIUpdateMaintenanceStartTimeInput::getDayOfWeek() const {
    return m_day_of_week;
}
void OAIUpdateMaintenanceStartTimeInput::setDayOfWeek(const qint32 &day_of_week) {
    m_day_of_week = day_of_week;
    m_day_of_week_isSet = true;
}

bool OAIUpdateMaintenanceStartTimeInput::is_day_of_week_Set() const{
    return m_day_of_week_isSet;
}

bool OAIUpdateMaintenanceStartTimeInput::is_day_of_week_Valid() const{
    return m_day_of_week_isValid;
}

qint32 OAIUpdateMaintenanceStartTimeInput::getDayOfMonth() const {
    return m_day_of_month;
}
void OAIUpdateMaintenanceStartTimeInput::setDayOfMonth(const qint32 &day_of_month) {
    m_day_of_month = day_of_month;
    m_day_of_month_isSet = true;
}

bool OAIUpdateMaintenanceStartTimeInput::is_day_of_month_Set() const{
    return m_day_of_month_isSet;
}

bool OAIUpdateMaintenanceStartTimeInput::is_day_of_month_Valid() const{
    return m_day_of_month_isValid;
}

bool OAIUpdateMaintenanceStartTimeInput::isSet() const {
...
bool OAIUpdateMaintenanceStartTimeInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_gateway_arn_isValid && m_hour_of_day_isValid && m_minute_of_hour_isValid && true;
}
