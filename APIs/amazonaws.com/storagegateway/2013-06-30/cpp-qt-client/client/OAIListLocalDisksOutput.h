...
/*
 * OAIListLocalDisksOutput.h
 *
 * 
 */

#ifndef OAIListLocalDisksOutput_H
#define OAIListLocalDisksOutput_H
...
class OAIListLocalDisksOutput : public OAIObject {
public:
    OAIListLocalDisksOutput();
    OAIListLocalDisksOutput(QString json);
    ~OAIListLocalDisksOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLocalDisksOutput)

#endif // OAIListLocalDisksOutput_H
