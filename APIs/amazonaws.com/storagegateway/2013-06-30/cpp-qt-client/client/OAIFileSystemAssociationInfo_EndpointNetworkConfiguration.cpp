...
#include "OAIFileSystemAssociationInfo_EndpointNetworkConfiguration.h"
...
OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::OAIFileSystemAssociationInfo_EndpointNetworkConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::OAIFileSystemAssociationInfo_EndpointNetworkConfiguration() {
    this->initializeModel();
}

OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::~OAIFileSystemAssociationInfo_EndpointNetworkConfiguration() {}

void OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::initializeModel() {

    m_ip_addresses_isSet = false;
    m_ip_addresses_isValid = false;
}

void OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::fromJson(QString jsonString) {
...
void OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::asJson() const {
...
QJsonObject OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::getIpAddresses() const {
    return m_ip_addresses;
}
void OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::setIpAddresses(const QList &ip_addresses) {
    m_ip_addresses = ip_addresses;
    m_ip_addresses_isSet = true;
}

bool OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::is_ip_addresses_Set() const{
    return m_ip_addresses_isSet;
}

bool OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::is_ip_addresses_Valid() const{
    return m_ip_addresses_isValid;
}

bool OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::isSet() const {
...
bool OAIFileSystemAssociationInfo_EndpointNetworkConfiguration::isValid() const {
