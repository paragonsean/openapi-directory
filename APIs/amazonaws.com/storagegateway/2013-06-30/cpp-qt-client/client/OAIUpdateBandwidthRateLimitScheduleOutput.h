...
/*
 * OAIUpdateBandwidthRateLimitScheduleOutput.h
 *
 * 
 */

#ifndef OAIUpdateBandwidthRateLimitScheduleOutput_H
#define OAIUpdateBandwidthRateLimitScheduleOutput_H
...
class OAIUpdateBandwidthRateLimitScheduleOutput : public OAIObject {
public:
    OAIUpdateBandwidthRateLimitScheduleOutput();
    OAIUpdateBandwidthRateLimitScheduleOutput(QString json);
    ~OAIUpdateBandwidthRateLimitScheduleOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBandwidthRateLimitScheduleOutput)

#endif // OAIUpdateBandwidthRateLimitScheduleOutput_H
