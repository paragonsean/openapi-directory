...
OAIGatewayCapacity::OAIGatewayCapacity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGatewayCapacity::OAIGatewayCapacity() {
    this->initializeModel();
}

OAIGatewayCapacity::~OAIGatewayCapacity() {}

void OAIGatewayCapacity::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGatewayCapacity::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGatewayCapacity::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Small", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGatewayCapacity::SMALL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Medium", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGatewayCapacity::MEDIUM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Large", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGatewayCapacity::LARGE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGatewayCapacity::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGatewayCapacity::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGatewayCapacity::SMALL:
            val = "Small";
            break;
        case eOAIGatewayCapacity::MEDIUM:
            val = "Medium";
            break;
        case eOAIGatewayCapacity::LARGE:
            val = "Large";
            break;
        default:
            break;
...
QJsonValue OAIGatewayCapacity::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGatewayCapacity::eOAIGatewayCapacity OAIGatewayCapacity::getValue() const {
    return m_value;
}

void OAIGatewayCapacity::setValue(const OAIGatewayCapacity::eOAIGatewayCapacity& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGatewayCapacity::isSet() const {
    
    return m_value_isSet;
}

bool OAIGatewayCapacity::isValid() const {
