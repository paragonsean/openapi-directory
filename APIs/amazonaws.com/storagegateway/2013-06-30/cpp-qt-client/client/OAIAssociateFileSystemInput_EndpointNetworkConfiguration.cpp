...
OAIAssociateFileSystemInput_EndpointNetworkConfiguration::OAIAssociateFileSystemInput_EndpointNetworkConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateFileSystemInput_EndpointNetworkConfiguration::OAIAssociateFileSystemInput_EndpointNetworkConfiguration() {
    this->initializeModel();
}

OAIAssociateFileSystemInput_EndpointNetworkConfiguration::~OAIAssociateFileSystemInput_EndpointNetworkConfiguration() {}

void OAIAssociateFileSystemInput_EndpointNetworkConfiguration::initializeModel() {

    m_ip_addresses_isSet = false;
    m_ip_addresses_isValid = false;
}

void OAIAssociateFileSystemInput_EndpointNetworkConfiguration::fromJson(QString jsonString) {
...
void OAIAssociateFileSystemInput_EndpointNetworkConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateFileSystemInput_EndpointNetworkConfiguration::asJson() const {
...
QJsonObject OAIAssociateFileSystemInput_EndpointNetworkConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIAssociateFileSystemInput_EndpointNetworkConfiguration::getIpAddresses() const {
    return m_ip_addresses;
}
void OAIAssociateFileSystemInput_EndpointNetworkConfiguration::setIpAddresses(const QList &ip_addresses) {
    m_ip_addresses = ip_addresses;
    m_ip_addresses_isSet = true;
}

bool OAIAssociateFileSystemInput_EndpointNetworkConfiguration::is_ip_addresses_Set() const{
    return m_ip_addresses_isSet;
}

bool OAIAssociateFileSystemInput_EndpointNetworkConfiguration::is_ip_addresses_Valid() const{
    return m_ip_addresses_isValid;
}

bool OAIAssociateFileSystemInput_EndpointNetworkConfiguration::isSet() const {
...
bool OAIAssociateFileSystemInput_EndpointNetworkConfiguration::isValid() const {
