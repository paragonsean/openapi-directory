...
OAIAddUploadBufferInput::OAIAddUploadBufferInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddUploadBufferInput::OAIAddUploadBufferInput() {
    this->initializeModel();
}

OAIAddUploadBufferInput::~OAIAddUploadBufferInput() {}

void OAIAddUploadBufferInput::initializeModel() {
...
void OAIAddUploadBufferInput::fromJson(QString jsonString) {
...
void OAIAddUploadBufferInput::fromJsonObject(QJsonObject json) {
...
QString OAIAddUploadBufferInput::asJson() const {
...
QJsonObject OAIAddUploadBufferInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddUploadBufferInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIAddUploadBufferInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIAddUploadBufferInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIAddUploadBufferInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QList OAIAddUploadBufferInput::getDiskIds() const {
    return m_disk_ids;
}
void OAIAddUploadBufferInput::setDiskIds(const QList &disk_ids) {
    m_disk_ids = disk_ids;
    m_disk_ids_isSet = true;
}

bool OAIAddUploadBufferInput::is_disk_ids_Set() const{
    return m_disk_ids_isSet;
}

bool OAIAddUploadBufferInput::is_disk_ids_Valid() const{
    return m_disk_ids_isValid;
}

bool OAIAddUploadBufferInput::isSet() const {
...
bool OAIAddUploadBufferInput::isValid() const {
