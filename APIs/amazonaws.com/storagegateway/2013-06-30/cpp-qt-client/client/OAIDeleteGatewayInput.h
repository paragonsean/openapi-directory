...
/*
 * OAIDeleteGatewayInput.h
 *
 * A JSON object containing the ID of the gateway to delete.
 */

#ifndef OAIDeleteGatewayInput_H
#define OAIDeleteGatewayInput_H
...
class OAIDeleteGatewayInput : public OAIObject {
public:
    OAIDeleteGatewayInput();
    OAIDeleteGatewayInput(QString json);
    ~OAIDeleteGatewayInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteGatewayInput)

#endif // OAIDeleteGatewayInput_H
