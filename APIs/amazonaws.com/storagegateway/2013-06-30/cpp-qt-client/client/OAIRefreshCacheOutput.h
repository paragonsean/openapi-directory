...
/*
 * OAIRefreshCacheOutput.h
 *
 * RefreshCacheOutput
 */

#ifndef OAIRefreshCacheOutput_H
#define OAIRefreshCacheOutput_H
...
class OAIRefreshCacheOutput : public OAIObject {
public:
    OAIRefreshCacheOutput();
    OAIRefreshCacheOutput(QString json);
    ~OAIRefreshCacheOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefreshCacheOutput)

#endif // OAIRefreshCacheOutput_H
