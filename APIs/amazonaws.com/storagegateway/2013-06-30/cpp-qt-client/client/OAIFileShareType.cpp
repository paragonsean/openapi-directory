...
OAIFileShareType::OAIFileShareType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFileShareType::OAIFileShareType() {
    this->initializeModel();
}

OAIFileShareType::~OAIFileShareType() {}

void OAIFileShareType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFileShareType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFileShareType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NFS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFileShareType::NFS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SMB", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFileShareType::SMB;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFileShareType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFileShareType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFileShareType::NFS:
            val = "NFS";
            break;
        case eOAIFileShareType::SMB:
            val = "SMB";
            break;
        default:
            break;
...
QJsonValue OAIFileShareType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFileShareType::eOAIFileShareType OAIFileShareType::getValue() const {
    return m_value;
}

void OAIFileShareType::setValue(const OAIFileShareType::eOAIFileShareType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFileShareType::isSet() const {
    
    return m_value_isSet;
}

bool OAIFileShareType::isValid() const {
