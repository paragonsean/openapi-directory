...
OAIDeleteVolumeInput::OAIDeleteVolumeInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteVolumeInput::OAIDeleteVolumeInput() {
    this->initializeModel();
}

OAIDeleteVolumeInput::~OAIDeleteVolumeInput() {}

void OAIDeleteVolumeInput::initializeModel() {

    m_volume_arn_isSet = false;
    m_volume_arn_isValid = false;
}

void OAIDeleteVolumeInput::fromJson(QString jsonString) {
...
void OAIDeleteVolumeInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteVolumeInput::asJson() const {
...
QJsonObject OAIDeleteVolumeInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteVolumeInput::getVolumeArn() const {
    return m_volume_arn;
}
void OAIDeleteVolumeInput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAIDeleteVolumeInput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAIDeleteVolumeInput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

bool OAIDeleteVolumeInput::isSet() const {
...
bool OAIDeleteVolumeInput::isValid() const {
