...
/*
 * OAIDescribeVTLDevicesInput.h
 *
 * DescribeVTLDevicesInput
 */

#ifndef OAIDescribeVTLDevicesInput_H
#define OAIDescribeVTLDevicesInput_H
...
class OAIDescribeVTLDevicesInput : public OAIObject {
public:
    OAIDescribeVTLDevicesInput();
    OAIDescribeVTLDevicesInput(QString json);
    ~OAIDescribeVTLDevicesInput() override;
    ...
    QList getVtlDeviceArns() const;
    void setVtlDeviceArns(const QList &vtl_device_arns);
    bool is_vtl_device_arns_Set() const;
    bool is_vtl_device_arns_Valid() const;
...
private:
    ...
    QList m_vtl_device_arns;
    bool m_vtl_device_arns_isSet;
    bool m_vtl_device_arns_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeVTLDevicesInput)

#endif // OAIDescribeVTLDevicesInput_H
