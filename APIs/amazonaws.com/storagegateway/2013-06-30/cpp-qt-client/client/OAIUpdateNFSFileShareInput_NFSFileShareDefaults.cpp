...
OAIUpdateNFSFileShareInput_NFSFileShareDefaults::OAIUpdateNFSFileShareInput_NFSFileShareDefaults(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateNFSFileShareInput_NFSFileShareDefaults::OAIUpdateNFSFileShareInput_NFSFileShareDefaults() {
    this->initializeModel();
}

OAIUpdateNFSFileShareInput_NFSFileShareDefaults::~OAIUpdateNFSFileShareInput_NFSFileShareDefaults() {}

void OAIUpdateNFSFileShareInput_NFSFileShareDefaults::initializeModel() {
...
void OAIUpdateNFSFileShareInput_NFSFileShareDefaults::fromJson(QString jsonString) {
...
void OAIUpdateNFSFileShareInput_NFSFileShareDefaults::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateNFSFileShareInput_NFSFileShareDefaults::asJson() const {
...
QJsonObject OAIUpdateNFSFileShareInput_NFSFileShareDefaults::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateNFSFileShareInput_NFSFileShareDefaults::getFileMode() const {
    return m_file_mode;
}
void OAIUpdateNFSFileShareInput_NFSFileShareDefaults::setFileMode(const QString &file_mode) {
    m_file_mode = file_mode;
    m_file_mode_isSet = true;
}

bool OAIUpdateNFSFileShareInput_NFSFileShareDefaults::is_file_mode_Set() const{
    return m_file_mode_isSet;
}

bool OAIUpdateNFSFileShareInput_NFSFileShareDefaults::is_file_mode_Valid() const{
    return m_file_mode_isValid;
}

QString OAIUpdateNFSFileShareInput_NFSFileShareDefaults::getDirectoryMode() const {
    return m_directory_mode;
}
void OAIUpdateNFSFileShareInput_NFSFileShareDefaults::setDirectoryMode(const QString &directory_mode) {
    m_directory_mode = directory_mode;
    m_directory_mode_isSet = true;
}

bool OAIUpdateNFSFileShareInput_NFSFileShareDefaults::is_directory_mode_Set() const{
    return m_directory_mode_isSet;
}

bool OAIUpdateNFSFileShareInput_NFSFileShareDefaults::is_directory_mode_Valid() const{
    return m_directory_mode_isValid;
}

qint32 OAIUpdateNFSFileShareInput_NFSFileShareDefaults::getGroupId() const {
    return m_group_id;
}
void OAIUpdateNFSFileShareInput_NFSFileShareDefaults::setGroupId(const qint32 &group_id) {
    m_group_id = group_id;
    m_group_id_isSet = true;
}

bool OAIUpdateNFSFileShareInput_NFSFileShareDefaults::is_group_id_Set() const{
    return m_group_id_isSet;
}

bool OAIUpdateNFSFileShareInput_NFSFileShareDefaults::is_group_id_Valid() const{
    return m_group_id_isValid;
}

qint32 OAIUpdateNFSFileShareInput_NFSFileShareDefaults::getOwnerId() const {
    return m_owner_id;
}
void OAIUpdateNFSFileShareInput_NFSFileShareDefaults::setOwnerId(const qint32 &owner_id) {
    m_owner_id = owner_id;
    m_owner_id_isSet = true;
}

bool OAIUpdateNFSFileShareInput_NFSFileShareDefaults::is_owner_id_Set() const{
    return m_owner_id_isSet;
}

bool OAIUpdateNFSFileShareInput_NFSFileShareDefaults::is_owner_id_Valid() const{
    return m_owner_id_isValid;
}

bool OAIUpdateNFSFileShareInput_NFSFileShareDefaults::isSet() const {
...
bool OAIUpdateNFSFileShareInput_NFSFileShareDefaults::isValid() const {
