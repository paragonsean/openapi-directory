...
/*
 * OAICreateNFSFileShareInput_NFSFileShareDefaults.h
 *
 * 
 */

#ifndef OAICreateNFSFileShareInput_NFSFileShareDefaults_H
#define OAICreateNFSFileShareInput_NFSFileShareDefaults_H
...
class OAICreateNFSFileShareInput_NFSFileShareDefaults : public OAIObject {
public:
    OAICreateNFSFileShareInput_NFSFileShareDefaults();
    OAICreateNFSFileShareInput_NFSFileShareDefaults(QString json);
    ~OAICreateNFSFileShareInput_NFSFileShareDefaults() override;
    ...
    QString getDirectoryMode() const;
    void setDirectoryMode(const QString &directory_mode);
    bool is_directory_mode_Set() const;
    bool is_directory_mode_Valid() const;
...
private:
    ...
    QString m_directory_mode;
    bool m_directory_mode_isSet;
    bool m_directory_mode_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNFSFileShareInput_NFSFileShareDefaults)

#endif // OAICreateNFSFileShareInput_NFSFileShareDefaults_H
