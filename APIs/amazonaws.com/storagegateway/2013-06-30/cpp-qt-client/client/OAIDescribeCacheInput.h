...
/*
 * OAIDescribeCacheInput.h
 *
 * 
 */

#ifndef OAIDescribeCacheInput_H
#define OAIDescribeCacheInput_H
...
class OAIDescribeCacheInput : public OAIObject {
public:
    OAIDescribeCacheInput();
    OAIDescribeCacheInput(QString json);
    ~OAIDescribeCacheInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCacheInput)

#endif // OAIDescribeCacheInput_H
