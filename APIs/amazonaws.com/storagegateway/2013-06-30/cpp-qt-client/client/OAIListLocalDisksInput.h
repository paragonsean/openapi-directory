...
/*
 * OAIListLocalDisksInput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway.
 */

#ifndef OAIListLocalDisksInput_H
#define OAIListLocalDisksInput_H
...
class OAIListLocalDisksInput : public OAIObject {
public:
    OAIListLocalDisksInput();
    OAIListLocalDisksInput(QString json);
    ~OAIListLocalDisksInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLocalDisksInput)

#endif // OAIListLocalDisksInput_H
