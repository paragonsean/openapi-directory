...
/*
 * OAISetSMBGuestPasswordOutput.h
 *
 * 
 */

#ifndef OAISetSMBGuestPasswordOutput_H
#define OAISetSMBGuestPasswordOutput_H
...
class OAISetSMBGuestPasswordOutput : public OAIObject {
public:
    OAISetSMBGuestPasswordOutput();
    OAISetSMBGuestPasswordOutput(QString json);
    ~OAISetSMBGuestPasswordOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetSMBGuestPasswordOutput)

#endif // OAISetSMBGuestPasswordOutput_H
