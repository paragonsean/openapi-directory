...
#include "OAIVolumeRecoveryPointInfo.h"
...
OAIVolumeRecoveryPointInfo::OAIVolumeRecoveryPointInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVolumeRecoveryPointInfo::OAIVolumeRecoveryPointInfo() {
    this->initializeModel();
}

OAIVolumeRecoveryPointInfo::~OAIVolumeRecoveryPointInfo() {}

void OAIVolumeRecoveryPointInfo::initializeModel() {
...
void OAIVolumeRecoveryPointInfo::fromJson(QString jsonString) {
...
void OAIVolumeRecoveryPointInfo::fromJsonObject(QJsonObject json) {
...
QString OAIVolumeRecoveryPointInfo::asJson() const {
...
QJsonObject OAIVolumeRecoveryPointInfo::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVolumeRecoveryPointInfo::getVolumeArn() const {
    return m_volume_arn;
}
void OAIVolumeRecoveryPointInfo::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAIVolumeRecoveryPointInfo::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAIVolumeRecoveryPointInfo::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

qint32 OAIVolumeRecoveryPointInfo::getVolumeSizeInBytes() const {
    return m_volume_size_in_bytes;
}
void OAIVolumeRecoveryPointInfo::setVolumeSizeInBytes(const qint32 &volume_size_in_bytes) {
    m_volume_size_in_bytes = volume_size_in_bytes;
    m_volume_size_in_bytes_isSet = true;
}

bool OAIVolumeRecoveryPointInfo::is_volume_size_in_bytes_Set() const{
    return m_volume_size_in_bytes_isSet;
}

bool OAIVolumeRecoveryPointInfo::is_volume_size_in_bytes_Valid() const{
    return m_volume_size_in_bytes_isValid;
}

qint32 OAIVolumeRecoveryPointInfo::getVolumeUsageInBytes() const {
    return m_volume_usage_in_bytes;
}
void OAIVolumeRecoveryPointInfo::setVolumeUsageInBytes(const qint32 &volume_usage_in_bytes) {
    m_volume_usage_in_bytes = volume_usage_in_bytes;
    m_volume_usage_in_bytes_isSet = true;
}

bool OAIVolumeRecoveryPointInfo::is_volume_usage_in_bytes_Set() const{
    return m_volume_usage_in_bytes_isSet;
}

bool OAIVolumeRecoveryPointInfo::is_volume_usage_in_bytes_Valid() const{
    return m_volume_usage_in_bytes_isValid;
}

QString OAIVolumeRecoveryPointInfo::getVolumeRecoveryPointTime() const {
    return m_volume_recovery_point_time;
}
void OAIVolumeRecoveryPointInfo::setVolumeRecoveryPointTime(const QString &volume_recovery_point_time) {
    m_volume_recovery_point_time = volume_recovery_point_time;
    m_volume_recovery_point_time_isSet = true;
}

bool OAIVolumeRecoveryPointInfo::is_volume_recovery_point_time_Set() const{
    return m_volume_recovery_point_time_isSet;
}

bool OAIVolumeRecoveryPointInfo::is_volume_recovery_point_time_Valid() const{
    return m_volume_recovery_point_time_isValid;
}

bool OAIVolumeRecoveryPointInfo::isSet() const {
...
bool OAIVolumeRecoveryPointInfo::isValid() const {
