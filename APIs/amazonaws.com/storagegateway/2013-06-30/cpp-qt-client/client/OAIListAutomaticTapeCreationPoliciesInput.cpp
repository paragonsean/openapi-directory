...
OAIListAutomaticTapeCreationPoliciesInput::OAIListAutomaticTapeCreationPoliciesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAutomaticTapeCreationPoliciesInput::OAIListAutomaticTapeCreationPoliciesInput() {
    this->initializeModel();
}

OAIListAutomaticTapeCreationPoliciesInput::~OAIListAutomaticTapeCreationPoliciesInput() {}

void OAIListAutomaticTapeCreationPoliciesInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIListAutomaticTapeCreationPoliciesInput::fromJson(QString jsonString) {
...
void OAIListAutomaticTapeCreationPoliciesInput::fromJsonObject(QJsonObject json) {
...
QString OAIListAutomaticTapeCreationPoliciesInput::asJson() const {
...
QJsonObject OAIListAutomaticTapeCreationPoliciesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListAutomaticTapeCreationPoliciesInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIListAutomaticTapeCreationPoliciesInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIListAutomaticTapeCreationPoliciesInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIListAutomaticTapeCreationPoliciesInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIListAutomaticTapeCreationPoliciesInput::isSet() const {
...
bool OAIListAutomaticTapeCreationPoliciesInput::isValid() const {
