...
#ifndef OAIListVolumesInput_H
#define OAIListVolumesInput_H
...
class OAIListVolumesInput : public OAIObject {
public:
    OAIListVolumesInput();
    OAIListVolumesInput(QString json);
    ~OAIListVolumesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListVolumesInput)

#endif // OAIListVolumesInput_H
