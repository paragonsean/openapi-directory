...
OAIDeleteGatewayInput::OAIDeleteGatewayInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteGatewayInput::OAIDeleteGatewayInput() {
    this->initializeModel();
}

OAIDeleteGatewayInput::~OAIDeleteGatewayInput() {}

void OAIDeleteGatewayInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDeleteGatewayInput::fromJson(QString jsonString) {
...
void OAIDeleteGatewayInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteGatewayInput::asJson() const {
...
QJsonObject OAIDeleteGatewayInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteGatewayInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDeleteGatewayInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDeleteGatewayInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDeleteGatewayInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDeleteGatewayInput::isSet() const {
...
bool OAIDeleteGatewayInput::isValid() const {
