...
/*
 * OAICreateStorediSCSIVolumeOutput.h
 *
 * A JSON object containing the following fields:
 */

#ifndef OAICreateStorediSCSIVolumeOutput_H
#define OAICreateStorediSCSIVolumeOutput_H
...
class OAICreateStorediSCSIVolumeOutput : public OAIObject {
public:
    OAICreateStorediSCSIVolumeOutput();
    OAICreateStorediSCSIVolumeOutput(QString json);
    ~OAICreateStorediSCSIVolumeOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStorediSCSIVolumeOutput)

#endif // OAICreateStorediSCSIVolumeOutput_H
