...
/*
 * OAIVTLDevice_DeviceiSCSIAttributes.h
 *
 * 
 */

#ifndef OAIVTLDevice_DeviceiSCSIAttributes_H
#define OAIVTLDevice_DeviceiSCSIAttributes_H
...
class OAIVTLDevice_DeviceiSCSIAttributes : public OAIObject {
public:
    OAIVTLDevice_DeviceiSCSIAttributes();
    OAIVTLDevice_DeviceiSCSIAttributes(QString json);
    ~OAIVTLDevice_DeviceiSCSIAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVTLDevice_DeviceiSCSIAttributes)

#endif // OAIVTLDevice_DeviceiSCSIAttributes_H
