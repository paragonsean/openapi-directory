...
OAIDescribeStorediSCSIVolumesOutput::OAIDescribeStorediSCSIVolumesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeStorediSCSIVolumesOutput::OAIDescribeStorediSCSIVolumesOutput() {
    this->initializeModel();
}

OAIDescribeStorediSCSIVolumesOutput::~OAIDescribeStorediSCSIVolumesOutput() {}

void OAIDescribeStorediSCSIVolumesOutput::initializeModel() {

    m_storedi_scsi_volumes_isSet = false;
    m_storedi_scsi_volumes_isValid = false;
}

void OAIDescribeStorediSCSIVolumesOutput::fromJson(QString jsonString) {
...
void OAIDescribeStorediSCSIVolumesOutput::fromJsonObject(QJsonObject json) {

    m_storedi_scsi_volumes_isValid = ::OpenAPI::fromJsonValue(m_storedi_scsi_volumes, json[QString("StorediSCSIVolumes")]);
    m_storedi_scsi_volumes_isSet = !json[QString("StorediSCSIVolumes")].isNull() && m_storedi_scsi_volumes_isValid;
}

QString OAIDescribeStorediSCSIVolumesOutput::asJson() const {
...
QJsonObject OAIDescribeStorediSCSIVolumesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_storedi_scsi_volumes.isSet()) {
        obj.insert(QString("StorediSCSIVolumes"), ::OpenAPI::toJsonValue(m_storedi_scsi_volumes));
    }
    return obj;
}

QList OAIDescribeStorediSCSIVolumesOutput::getStorediScsiVolumes() const {
    return m_storedi_scsi_volumes;
}
void OAIDescribeStorediSCSIVolumesOutput::setStorediScsiVolumes(const QList &storedi_scsi_volumes) {
    m_storedi_scsi_volumes = storedi_scsi_volumes;
    m_storedi_scsi_volumes_isSet = true;
}

bool OAIDescribeStorediSCSIVolumesOutput::is_storedi_scsi_volumes_Set() const{
    return m_storedi_scsi_volumes_isSet;
}

bool OAIDescribeStorediSCSIVolumesOutput::is_storedi_scsi_volumes_Valid() const{
    return m_storedi_scsi_volumes_isValid;
}

bool OAIDescribeStorediSCSIVolumesOutput::isSet() const {
...
bool OAIDescribeStorediSCSIVolumesOutput::isValid() const {
