...
/*
 * OAIDeleteBandwidthRateLimitOutput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway whose bandwidth rate information was deleted.
 */

#ifndef OAIDeleteBandwidthRateLimitOutput_H
#define OAIDeleteBandwidthRateLimitOutput_H
...
class OAIDeleteBandwidthRateLimitOutput : public OAIObject {
public:
    OAIDeleteBandwidthRateLimitOutput();
    OAIDeleteBandwidthRateLimitOutput(QString json);
    ~OAIDeleteBandwidthRateLimitOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBandwidthRateLimitOutput)

#endif // OAIDeleteBandwidthRateLimitOutput_H
