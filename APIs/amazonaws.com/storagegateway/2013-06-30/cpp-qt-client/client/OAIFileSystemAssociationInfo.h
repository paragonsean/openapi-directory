...
/*
 * OAIFileSystemAssociationInfo.h
 *
...
#ifndef OAIFileSystemAssociationInfo_H
#define OAIFileSystemAssociationInfo_H
...
class OAIFileSystemAssociationInfo_EndpointNetworkConfiguration;

class OAIFileSystemAssociationInfo : public OAIObject {
public:
    OAIFileSystemAssociationInfo();
    OAIFileSystemAssociationInfo(QString json);
    ~OAIFileSystemAssociationInfo() override;
    ...
    QString getFileSystemAssociationStatus() const;
    void setFileSystemAssociationStatus(const QString &file_system_association_status);
    bool is_file_system_association_status_Set() const;
    bool is_file_system_association_status_Valid() const;
    ...
    OAIFileSystemAssociationInfo_EndpointNetworkConfiguration getEndpointNetworkConfiguration() const;
    void setEndpointNetworkConfiguration(const OAIFileSystemAssociationInfo_EndpointNetworkConfiguration &endpoint_network_configuration);
    bool is_endpoint_network_configuration_Set() const;
    bool is_endpoint_network_configuration_Valid() const;

    QList getFileSystemAssociationStatusDetails() const;
    void setFileSystemAssociationStatusDetails(const QList &file_system_association_status_details);
    bool is_file_system_association_status_details_Set() const;
    bool is_file_system_association_status_details_Valid() const;
...
private:
    ...
    QString m_file_system_association_status;
    bool m_file_system_association_status_isSet;
    bool m_file_system_association_status_isValid;
    ...
    OAIFileSystemAssociationInfo_EndpointNetworkConfiguration m_endpoint_network_configuration;
    bool m_endpoint_network_configuration_isSet;
    bool m_endpoint_network_configuration_isValid;

    QList m_file_system_association_status_details;
    bool m_file_system_association_status_details_isSet;
    bool m_file_system_association_status_details_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIFileSystemAssociationInfo)

#endif // OAIFileSystemAssociationInfo_H
