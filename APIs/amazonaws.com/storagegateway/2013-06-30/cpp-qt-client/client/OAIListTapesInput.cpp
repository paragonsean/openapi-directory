...
OAIListTapesInput::OAIListTapesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTapesInput::OAIListTapesInput() {
    this->initializeModel();
}

OAIListTapesInput::~OAIListTapesInput() {}

void OAIListTapesInput::initializeModel() {
...
void OAIListTapesInput::fromJson(QString jsonString) {
...
void OAIListTapesInput::fromJsonObject(QJsonObject json) {
...
QString OAIListTapesInput::asJson() const {
...
QJsonObject OAIListTapesInput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_arns.size() > 0) {
...
QList<QString> OAIListTapesInput::getTapeArns() const {
    return m_tape_arns;
}
void OAIListTapesInput::setTapeArns(const QList<QString> &tape_arns) {
    m_tape_arns = tape_arns;
    m_tape_arns_isSet = true;
}

bool OAIListTapesInput::is_tape_arns_Set() const{
    return m_tape_arns_isSet;
}

bool OAIListTapesInput::is_tape_arns_Valid() const{
    return m_tape_arns_isValid;
}

QString OAIListTapesInput::getMarker() const {
    return m_marker;
}
void OAIListTapesInput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListTapesInput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListTapesInput::is_marker_Valid() const{
    return m_marker_isValid;
}

qint32 OAIListTapesInput::getLimit() const {
    return m_limit;
}
void OAIListTapesInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListTapesInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListTapesInput::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAIListTapesInput::isSet() const {
...
bool OAIListTapesInput::isValid() const {
