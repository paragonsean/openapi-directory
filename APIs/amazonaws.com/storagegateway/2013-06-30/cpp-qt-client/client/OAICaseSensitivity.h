...
/*
 * OAICaseSensitivity.h
 *
 * 
 */

#ifndef OAICaseSensitivity_H
#define OAICaseSensitivity_H
...
class OAICaseSensitivity : public OAIEnum {
public:
    OAICaseSensitivity();
    OAICaseSensitivity(QString json);
    ~OAICaseSensitivity() override;
    ...
    enum class eOAICaseSensitivity {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CLIENTSPECIFIED, 
        CASESENSITIVE
    };
    OAICaseSensitivity::eOAICaseSensitivity getValue() const;
    void setValue(const OAICaseSensitivity::eOAICaseSensitivity& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAICaseSensitivity)

#endif // OAICaseSensitivity_H
