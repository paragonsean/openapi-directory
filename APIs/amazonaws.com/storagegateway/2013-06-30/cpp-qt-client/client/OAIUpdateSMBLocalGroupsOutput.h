...
/*
 * OAIUpdateSMBLocalGroupsOutput.h
 *
 * 
 */

#ifndef OAIUpdateSMBLocalGroupsOutput_H
#define OAIUpdateSMBLocalGroupsOutput_H
...
class OAIUpdateSMBLocalGroupsOutput : public OAIObject {
public:
    OAIUpdateSMBLocalGroupsOutput();
    OAIUpdateSMBLocalGroupsOutput(QString json);
    ~OAIUpdateSMBLocalGroupsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSMBLocalGroupsOutput)

#endif // OAIUpdateSMBLocalGroupsOutput_H
