...
OAIActivateGatewayOutput::OAIActivateGatewayOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActivateGatewayOutput::OAIActivateGatewayOutput() {
    this->initializeModel();
}

OAIActivateGatewayOutput::~OAIActivateGatewayOutput() {}

void OAIActivateGatewayOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIActivateGatewayOutput::fromJson(QString jsonString) {
...
void OAIActivateGatewayOutput::fromJsonObject(QJsonObject json) {
...
QString OAIActivateGatewayOutput::asJson() const {
...
QJsonObject OAIActivateGatewayOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIActivateGatewayOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIActivateGatewayOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIActivateGatewayOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIActivateGatewayOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIActivateGatewayOutput::isSet() const {
...
bool OAIActivateGatewayOutput::isValid() const {
