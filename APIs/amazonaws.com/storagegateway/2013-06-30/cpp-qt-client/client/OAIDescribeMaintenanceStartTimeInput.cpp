...
OAIDescribeMaintenanceStartTimeInput::OAIDescribeMaintenanceStartTimeInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeMaintenanceStartTimeInput::OAIDescribeMaintenanceStartTimeInput() {
    this->initializeModel();
}

OAIDescribeMaintenanceStartTimeInput::~OAIDescribeMaintenanceStartTimeInput() {}

void OAIDescribeMaintenanceStartTimeInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDescribeMaintenanceStartTimeInput::fromJson(QString jsonString) {
...
void OAIDescribeMaintenanceStartTimeInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeMaintenanceStartTimeInput::asJson() const {
...
QJsonObject OAIDescribeMaintenanceStartTimeInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeMaintenanceStartTimeInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeMaintenanceStartTimeInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeMaintenanceStartTimeInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeMaintenanceStartTimeInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDescribeMaintenanceStartTimeInput::isSet() const {
...
bool OAIDescribeMaintenanceStartTimeInput::isValid() const {
