...
OAIDescribeVTLDevicesOutput::OAIDescribeVTLDevicesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeVTLDevicesOutput::OAIDescribeVTLDevicesOutput() {
    this->initializeModel();
}

OAIDescribeVTLDevicesOutput::~OAIDescribeVTLDevicesOutput() {}

void OAIDescribeVTLDevicesOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;

    m_vtl_devices_isSet = false;
    m_vtl_devices_isValid = false;

    m_marker_isSet = false;
    m_marker_isValid = false;
}

void OAIDescribeVTLDevicesOutput::fromJson(QString jsonString) {
...
void OAIDescribeVTLDevicesOutput::fromJsonObject(QJsonObject json) {
    ...
    m_vtl_devices_isValid = ::OpenAPI::fromJsonValue(m_vtl_devices, json[QString("VTLDevices")]);
    m_vtl_devices_isSet = !json[QString("VTLDevices")].isNull() && m_vtl_devices_isValid;
...
QString OAIDescribeVTLDevicesOutput::asJson() const {
...
QJsonObject OAIDescribeVTLDevicesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_gateway_arn_isSet) {
        obj.insert(QString("GatewayARN"), ::OpenAPI::toJsonValue(m_gateway_arn));
    }
    if (m_vtl_devices.isSet()) {
        obj.insert(QString("VTLDevices"), ::OpenAPI::toJsonValue(m_vtl_devices));
    }
    if (m_marker_isSet) {
...
QString OAIDescribeVTLDevicesOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeVTLDevicesOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeVTLDevicesOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeVTLDevicesOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QList OAIDescribeVTLDevicesOutput::getVtlDevices() const {
    return m_vtl_devices;
}
void OAIDescribeVTLDevicesOutput::setVtlDevices(const QList &vtl_devices) {
    m_vtl_devices = vtl_devices;
    m_vtl_devices_isSet = true;
}

bool OAIDescribeVTLDevicesOutput::is_vtl_devices_Set() const{
    return m_vtl_devices_isSet;
}

bool OAIDescribeVTLDevicesOutput::is_vtl_devices_Valid() const{
    return m_vtl_devices_isValid;
}

QString OAIDescribeVTLDevicesOutput::getMarker() const {
    return m_marker;
}
void OAIDescribeVTLDevicesOutput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIDescribeVTLDevicesOutput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIDescribeVTLDevicesOutput::is_marker_Valid() const{
    return m_marker_isValid;
}

bool OAIDescribeVTLDevicesOutput::isSet() const {
...
bool OAIDescribeVTLDevicesOutput::isValid() const {
