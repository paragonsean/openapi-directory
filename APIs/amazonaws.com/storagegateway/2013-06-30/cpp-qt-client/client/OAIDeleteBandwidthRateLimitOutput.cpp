...
OAIDeleteBandwidthRateLimitOutput::OAIDeleteBandwidthRateLimitOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteBandwidthRateLimitOutput::OAIDeleteBandwidthRateLimitOutput() {
    this->initializeModel();
}

OAIDeleteBandwidthRateLimitOutput::~OAIDeleteBandwidthRateLimitOutput() {}

void OAIDeleteBandwidthRateLimitOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDeleteBandwidthRateLimitOutput::fromJson(QString jsonString) {
...
void OAIDeleteBandwidthRateLimitOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteBandwidthRateLimitOutput::asJson() const {
...
QJsonObject OAIDeleteBandwidthRateLimitOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteBandwidthRateLimitOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDeleteBandwidthRateLimitOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDeleteBandwidthRateLimitOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDeleteBandwidthRateLimitOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDeleteBandwidthRateLimitOutput::isSet() const {
...
bool OAIDeleteBandwidthRateLimitOutput::isValid() const {
