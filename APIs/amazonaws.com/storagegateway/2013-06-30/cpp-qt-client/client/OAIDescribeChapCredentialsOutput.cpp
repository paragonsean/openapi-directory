...
OAIDescribeChapCredentialsOutput::OAIDescribeChapCredentialsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeChapCredentialsOutput::OAIDescribeChapCredentialsOutput() {
    this->initializeModel();
}

OAIDescribeChapCredentialsOutput::~OAIDescribeChapCredentialsOutput() {}

void OAIDescribeChapCredentialsOutput::initializeModel() {

    m_chap_credentials_isSet = false;
    m_chap_credentials_isValid = false;
}

void OAIDescribeChapCredentialsOutput::fromJson(QString jsonString) {
...
void OAIDescribeChapCredentialsOutput::fromJsonObject(QJsonObject json) {

    m_chap_credentials_isValid = ::OpenAPI::fromJsonValue(m_chap_credentials, json[QString("ChapCredentials")]);
    m_chap_credentials_isSet = !json[QString("ChapCredentials")].isNull() && m_chap_credentials_isValid;
}

QString OAIDescribeChapCredentialsOutput::asJson() const {
...
QJsonObject OAIDescribeChapCredentialsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_chap_credentials.isSet()) {
        obj.insert(QString("ChapCredentials"), ::OpenAPI::toJsonValue(m_chap_credentials));
    }
    return obj;
}

QList OAIDescribeChapCredentialsOutput::getChapCredentials() const {
    return m_chap_credentials;
}
void OAIDescribeChapCredentialsOutput::setChapCredentials(const QList &chap_credentials) {
    m_chap_credentials = chap_credentials;
    m_chap_credentials_isSet = true;
}

bool OAIDescribeChapCredentialsOutput::is_chap_credentials_Set() const{
    return m_chap_credentials_isSet;
}

bool OAIDescribeChapCredentialsOutput::is_chap_credentials_Valid() const{
    return m_chap_credentials_isValid;
}

bool OAIDescribeChapCredentialsOutput::isSet() const {
...
bool OAIDescribeChapCredentialsOutput::isValid() const {
