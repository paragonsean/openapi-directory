...
OAIUpdateBandwidthRateLimitScheduleOutput::OAIUpdateBandwidthRateLimitScheduleOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateBandwidthRateLimitScheduleOutput::OAIUpdateBandwidthRateLimitScheduleOutput() {
    this->initializeModel();
}

OAIUpdateBandwidthRateLimitScheduleOutput::~OAIUpdateBandwidthRateLimitScheduleOutput() {}

void OAIUpdateBandwidthRateLimitScheduleOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIUpdateBandwidthRateLimitScheduleOutput::fromJson(QString jsonString) {
...
void OAIUpdateBandwidthRateLimitScheduleOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateBandwidthRateLimitScheduleOutput::asJson() const {
...
QJsonObject OAIUpdateBandwidthRateLimitScheduleOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateBandwidthRateLimitScheduleOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateBandwidthRateLimitScheduleOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateBandwidthRateLimitScheduleOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateBandwidthRateLimitScheduleOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIUpdateBandwidthRateLimitScheduleOutput::isSet() const {
...
bool OAIUpdateBandwidthRateLimitScheduleOutput::isValid() const {
