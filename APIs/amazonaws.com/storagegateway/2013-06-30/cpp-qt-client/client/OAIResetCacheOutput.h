...
/*
 * OAIResetCacheOutput.h
 *
 * 
 */

#ifndef OAIResetCacheOutput_H
#define OAIResetCacheOutput_H
...
class OAIResetCacheOutput : public OAIObject {
public:
    OAIResetCacheOutput();
    OAIResetCacheOutput(QString json);
    ~OAIResetCacheOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResetCacheOutput)

#endif // OAIResetCacheOutput_H
