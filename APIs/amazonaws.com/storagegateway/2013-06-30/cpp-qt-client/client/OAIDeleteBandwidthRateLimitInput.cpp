...
OAIDeleteBandwidthRateLimitInput::OAIDeleteBandwidthRateLimitInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteBandwidthRateLimitInput::OAIDeleteBandwidthRateLimitInput() {
    this->initializeModel();
}

OAIDeleteBandwidthRateLimitInput::~OAIDeleteBandwidthRateLimitInput() {}

void OAIDeleteBandwidthRateLimitInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;

    m_bandwidth_type_isSet = false;
    m_bandwidth_type_isValid = false;
}

void OAIDeleteBandwidthRateLimitInput::fromJson(QString jsonString) {
...
void OAIDeleteBandwidthRateLimitInput::fromJsonObject(QJsonObject json) {
    ...
    m_bandwidth_type_isValid = ::OpenAPI::fromJsonValue(m_bandwidth_type, json[QString("BandwidthType")]);
    m_bandwidth_type_isSet = !json[QString("BandwidthType")].isNull() && m_bandwidth_type_isValid;
}

QString OAIDeleteBandwidthRateLimitInput::asJson() const {
...
QJsonObject OAIDeleteBandwidthRateLimitInput::asJsonObject() const {
    QJsonObject obj;
    if (m_gateway_arn_isSet) {
        obj.insert(QString("GatewayARN"), ::OpenAPI::toJsonValue(m_gateway_arn));
    }
    if (m_bandwidth_type_isSet) {
        obj.insert(QString("BandwidthType"), ::OpenAPI::toJsonValue(m_bandwidth_type));
    }
    return obj;
}

QString OAIDeleteBandwidthRateLimitInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDeleteBandwidthRateLimitInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDeleteBandwidthRateLimitInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDeleteBandwidthRateLimitInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QString OAIDeleteBandwidthRateLimitInput::getBandwidthType() const {
    return m_bandwidth_type;
}
void OAIDeleteBandwidthRateLimitInput::setBandwidthType(const QString &bandwidth_type) {
    m_bandwidth_type = bandwidth_type;
    m_bandwidth_type_isSet = true;
}

bool OAIDeleteBandwidthRateLimitInput::is_bandwidth_type_Set() const{
    return m_bandwidth_type_isSet;
}

bool OAIDeleteBandwidthRateLimitInput::is_bandwidth_type_Valid() const{
    return m_bandwidth_type_isValid;
}

bool OAIDeleteBandwidthRateLimitInput::isSet() const {
...
bool OAIDeleteBandwidthRateLimitInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_gateway_arn_isValid && m_bandwidth_type_isValid && true;
}
