...
OAIDescribeNFSFileSharesInput::OAIDescribeNFSFileSharesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeNFSFileSharesInput::OAIDescribeNFSFileSharesInput() {
    this->initializeModel();
}

OAIDescribeNFSFileSharesInput::~OAIDescribeNFSFileSharesInput() {}

void OAIDescribeNFSFileSharesInput::initializeModel() {

    m_file_share_arn_list_isSet = false;
    m_file_share_arn_list_isValid = false;
}

void OAIDescribeNFSFileSharesInput::fromJson(QString jsonString) {
...
void OAIDescribeNFSFileSharesInput::fromJsonObject(QJsonObject json) {

    m_file_share_arn_list_isValid = ::OpenAPI::fromJsonValue(m_file_share_arn_list, json[QString("FileShareARNList")]);
    m_file_share_arn_list_isSet = !json[QString("FileShareARNList")].isNull() && m_file_share_arn_list_isValid;
}

QString OAIDescribeNFSFileSharesInput::asJson() const {
...
QJsonObject OAIDescribeNFSFileSharesInput::asJsonObject() const {
    QJsonObject obj;
    if (m_file_share_arn_list.isSet()) {
        obj.insert(QString("FileShareARNList"), ::OpenAPI::toJsonValue(m_file_share_arn_list));
    }
    return obj;
}

QList OAIDescribeNFSFileSharesInput::getFileShareArnList() const {
    return m_file_share_arn_list;
}
void OAIDescribeNFSFileSharesInput::setFileShareArnList(const QList &file_share_arn_list) {
    m_file_share_arn_list = file_share_arn_list;
    m_file_share_arn_list_isSet = true;
}

bool OAIDescribeNFSFileSharesInput::is_file_share_arn_list_Set() const{
    return m_file_share_arn_list_isSet;
}

bool OAIDescribeNFSFileSharesInput::is_file_share_arn_list_Valid() const{
    return m_file_share_arn_list_isValid;
}

bool OAIDescribeNFSFileSharesInput::isSet() const {
...
bool OAIDescribeNFSFileSharesInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_file_share_arn_list_isValid && true;
}
