...
/*
 * OAIShutdownGatewayInput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway to shut down.
 */

#ifndef OAIShutdownGatewayInput_H
#define OAIShutdownGatewayInput_H
...
class OAIShutdownGatewayInput : public OAIObject {
public:
    OAIShutdownGatewayInput();
    OAIShutdownGatewayInput(QString json);
    ~OAIShutdownGatewayInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShutdownGatewayInput)

#endif // OAIShutdownGatewayInput_H
