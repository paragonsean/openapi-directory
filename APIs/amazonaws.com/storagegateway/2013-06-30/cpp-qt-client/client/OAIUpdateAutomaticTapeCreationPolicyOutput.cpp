...
OAIUpdateAutomaticTapeCreationPolicyOutput::OAIUpdateAutomaticTapeCreationPolicyOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAutomaticTapeCreationPolicyOutput::OAIUpdateAutomaticTapeCreationPolicyOutput() {
    this->initializeModel();
}

OAIUpdateAutomaticTapeCreationPolicyOutput::~OAIUpdateAutomaticTapeCreationPolicyOutput() {}

void OAIUpdateAutomaticTapeCreationPolicyOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIUpdateAutomaticTapeCreationPolicyOutput::fromJson(QString jsonString) {
...
void OAIUpdateAutomaticTapeCreationPolicyOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAutomaticTapeCreationPolicyOutput::asJson() const {
...
QJsonObject OAIUpdateAutomaticTapeCreationPolicyOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateAutomaticTapeCreationPolicyOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateAutomaticTapeCreationPolicyOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateAutomaticTapeCreationPolicyOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateAutomaticTapeCreationPolicyOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIUpdateAutomaticTapeCreationPolicyOutput::isSet() const {
...
bool OAIUpdateAutomaticTapeCreationPolicyOutput::isValid() const {
