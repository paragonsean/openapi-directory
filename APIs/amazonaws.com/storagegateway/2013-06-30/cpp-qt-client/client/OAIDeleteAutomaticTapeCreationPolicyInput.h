...
/*
 * OAIDeleteAutomaticTapeCreationPolicyInput.h
 *
 * 
 */

#ifndef OAIDeleteAutomaticTapeCreationPolicyInput_H
#define OAIDeleteAutomaticTapeCreationPolicyInput_H
...
class OAIDeleteAutomaticTapeCreationPolicyInput : public OAIObject {
public:
    OAIDeleteAutomaticTapeCreationPolicyInput();
    OAIDeleteAutomaticTapeCreationPolicyInput(QString json);
    ~OAIDeleteAutomaticTapeCreationPolicyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAutomaticTapeCreationPolicyInput)

#endif // OAIDeleteAutomaticTapeCreationPolicyInput_H
