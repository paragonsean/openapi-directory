...
OAICaseSensitivity::OAICaseSensitivity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICaseSensitivity::OAICaseSensitivity() {
    this->initializeModel();
}

OAICaseSensitivity::~OAICaseSensitivity() {}

void OAICaseSensitivity::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAICaseSensitivity::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAICaseSensitivity::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ClientSpecified", Qt::CaseInsensitive) == 0) {
        m_value = eOAICaseSensitivity::CLIENTSPECIFIED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CaseSensitive", Qt::CaseInsensitive) == 0) {
        m_value = eOAICaseSensitivity::CASESENSITIVE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAICaseSensitivity::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAICaseSensitivity::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAICaseSensitivity::CLIENTSPECIFIED:
            val = "ClientSpecified";
            break;
        case eOAICaseSensitivity::CASESENSITIVE:
            val = "CaseSensitive";
            break;
        default:
            break;
...
QJsonValue OAICaseSensitivity::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAICaseSensitivity::eOAICaseSensitivity OAICaseSensitivity::getValue() const {
    return m_value;
}

void OAICaseSensitivity::setValue(const OAICaseSensitivity::eOAICaseSensitivity& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAICaseSensitivity::isSet() const {
    
    return m_value_isSet;
}

bool OAICaseSensitivity::isValid() const {
