...
OAIUpdateSMBFileShareOutput::OAIUpdateSMBFileShareOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSMBFileShareOutput::OAIUpdateSMBFileShareOutput() {
    this->initializeModel();
}

OAIUpdateSMBFileShareOutput::~OAIUpdateSMBFileShareOutput() {}

void OAIUpdateSMBFileShareOutput::initializeModel() {

    m_file_share_arn_isSet = false;
    m_file_share_arn_isValid = false;
}

void OAIUpdateSMBFileShareOutput::fromJson(QString jsonString) {
...
void OAIUpdateSMBFileShareOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSMBFileShareOutput::asJson() const {
...
QJsonObject OAIUpdateSMBFileShareOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSMBFileShareOutput::getFileShareArn() const {
    return m_file_share_arn;
}
void OAIUpdateSMBFileShareOutput::setFileShareArn(const QString &file_share_arn) {
    m_file_share_arn = file_share_arn;
    m_file_share_arn_isSet = true;
}

bool OAIUpdateSMBFileShareOutput::is_file_share_arn_Set() const{
    return m_file_share_arn_isSet;
}

bool OAIUpdateSMBFileShareOutput::is_file_share_arn_Valid() const{
    return m_file_share_arn_isValid;
}

bool OAIUpdateSMBFileShareOutput::isSet() const {
...
bool OAIUpdateSMBFileShareOutput::isValid() const {
