...
/*
 * OAIListGatewaysOutput.h
 *
 * 
 */

#ifndef OAIListGatewaysOutput_H
#define OAIListGatewaysOutput_H
...
class OAIListGatewaysOutput : public OAIObject {
public:
    OAIListGatewaysOutput();
    OAIListGatewaysOutput(QString json);
    ~OAIListGatewaysOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGatewaysOutput)

#endif // OAIListGatewaysOutput_H
