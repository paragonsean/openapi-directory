...
OAIDeleteFileShareOutput::OAIDeleteFileShareOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteFileShareOutput::OAIDeleteFileShareOutput() {
    this->initializeModel();
}

OAIDeleteFileShareOutput::~OAIDeleteFileShareOutput() {}

void OAIDeleteFileShareOutput::initializeModel() {

    m_file_share_arn_isSet = false;
    m_file_share_arn_isValid = false;
}

void OAIDeleteFileShareOutput::fromJson(QString jsonString) {
...
void OAIDeleteFileShareOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteFileShareOutput::asJson() const {
...
QJsonObject OAIDeleteFileShareOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteFileShareOutput::getFileShareArn() const {
    return m_file_share_arn;
}
void OAIDeleteFileShareOutput::setFileShareArn(const QString &file_share_arn) {
    m_file_share_arn = file_share_arn;
    m_file_share_arn_isSet = true;
}

bool OAIDeleteFileShareOutput::is_file_share_arn_Set() const{
    return m_file_share_arn_isSet;
}

bool OAIDeleteFileShareOutput::is_file_share_arn_Valid() const{
    return m_file_share_arn_isValid;
}

bool OAIDeleteFileShareOutput::isSet() const {
...
bool OAIDeleteFileShareOutput::isValid() const {
