...
OAICancelRetrievalInput::OAICancelRetrievalInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICancelRetrievalInput::OAICancelRetrievalInput() {
    this->initializeModel();
}

OAICancelRetrievalInput::~OAICancelRetrievalInput() {}

void OAICancelRetrievalInput::initializeModel() {
...
void OAICancelRetrievalInput::fromJson(QString jsonString) {
...
void OAICancelRetrievalInput::fromJsonObject(QJsonObject json) {
...
QString OAICancelRetrievalInput::asJson() const {
...
QJsonObject OAICancelRetrievalInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICancelRetrievalInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAICancelRetrievalInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAICancelRetrievalInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAICancelRetrievalInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QString OAICancelRetrievalInput::getTapeArn() const {
    return m_tape_arn;
}
void OAICancelRetrievalInput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAICancelRetrievalInput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAICancelRetrievalInput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

bool OAICancelRetrievalInput::isSet() const {
...
bool OAICancelRetrievalInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_gateway_arn_isValid && m_tape_arn_isValid && true;
}
