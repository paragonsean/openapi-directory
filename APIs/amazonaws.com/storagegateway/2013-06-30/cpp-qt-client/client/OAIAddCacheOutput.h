...
#ifndef OAIAddCacheOutput_H
#define OAIAddCacheOutput_H
...
class OAIAddCacheOutput : public OAIObject {
public:
    OAIAddCacheOutput();
    OAIAddCacheOutput(QString json);
    ~OAIAddCacheOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddCacheOutput)

#endif // OAIAddCacheOutput_H
