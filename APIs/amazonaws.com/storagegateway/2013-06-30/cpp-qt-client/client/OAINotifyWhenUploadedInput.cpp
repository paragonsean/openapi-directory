...
OAINotifyWhenUploadedInput::OAINotifyWhenUploadedInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotifyWhenUploadedInput::OAINotifyWhenUploadedInput() {
    this->initializeModel();
}

OAINotifyWhenUploadedInput::~OAINotifyWhenUploadedInput() {}

void OAINotifyWhenUploadedInput::initializeModel() {

    m_file_share_arn_isSet = false;
    m_file_share_arn_isValid = false;
}

void OAINotifyWhenUploadedInput::fromJson(QString jsonString) {
...
void OAINotifyWhenUploadedInput::fromJsonObject(QJsonObject json) {
...
QString OAINotifyWhenUploadedInput::asJson() const {
...
QJsonObject OAINotifyWhenUploadedInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAINotifyWhenUploadedInput::getFileShareArn() const {
    return m_file_share_arn;
}
void OAINotifyWhenUploadedInput::setFileShareArn(const QString &file_share_arn) {
    m_file_share_arn = file_share_arn;
    m_file_share_arn_isSet = true;
}

bool OAINotifyWhenUploadedInput::is_file_share_arn_Set() const{
    return m_file_share_arn_isSet;
}

bool OAINotifyWhenUploadedInput::is_file_share_arn_Valid() const{
    return m_file_share_arn_isValid;
}

bool OAINotifyWhenUploadedInput::isSet() const {
...
bool OAINotifyWhenUploadedInput::isValid() const {
