...
OAIUpdateAutomaticTapeCreationPolicyInput::OAIUpdateAutomaticTapeCreationPolicyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAutomaticTapeCreationPolicyInput::OAIUpdateAutomaticTapeCreationPolicyInput() {
    this->initializeModel();
}

OAIUpdateAutomaticTapeCreationPolicyInput::~OAIUpdateAutomaticTapeCreationPolicyInput() {}

void OAIUpdateAutomaticTapeCreationPolicyInput::initializeModel() {

    m_automatic_tape_creation_rules_isSet = false;
    m_automatic_tape_creation_rules_isValid = false;

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIUpdateAutomaticTapeCreationPolicyInput::fromJson(QString jsonString) {
...
void OAIUpdateAutomaticTapeCreationPolicyInput::fromJsonObject(QJsonObject json) {

    m_automatic_tape_creation_rules_isValid = ::OpenAPI::fromJsonValue(m_automatic_tape_creation_rules, json[QString("AutomaticTapeCreationRules")]);
    m_automatic_tape_creation_rules_isSet = !json[QString("AutomaticTapeCreationRules")].isNull() && m_automatic_tape_creation_rules_isValid;
...
QString OAIUpdateAutomaticTapeCreationPolicyInput::asJson() const {
...
QJsonObject OAIUpdateAutomaticTapeCreationPolicyInput::asJsonObject() const {
    QJsonObject obj;
    if (m_automatic_tape_creation_rules.isSet()) {
        obj.insert(QString("AutomaticTapeCreationRules"), ::OpenAPI::toJsonValue(m_automatic_tape_creation_rules));
    }
...
QList OAIUpdateAutomaticTapeCreationPolicyInput::getAutomaticTapeCreationRules() const {
    return m_automatic_tape_creation_rules;
}
void OAIUpdateAutomaticTapeCreationPolicyInput::setAutomaticTapeCreationRules(const QList &automatic_tape_creation_rules) {
    m_automatic_tape_creation_rules = automatic_tape_creation_rules;
    m_automatic_tape_creation_rules_isSet = true;
}

bool OAIUpdateAutomaticTapeCreationPolicyInput::is_automatic_tape_creation_rules_Set() const{
    return m_automatic_tape_creation_rules_isSet;
}

bool OAIUpdateAutomaticTapeCreationPolicyInput::is_automatic_tape_creation_rules_Valid() const{
    return m_automatic_tape_creation_rules_isValid;
}

QString OAIUpdateAutomaticTapeCreationPolicyInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateAutomaticTapeCreationPolicyInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateAutomaticTapeCreationPolicyInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateAutomaticTapeCreationPolicyInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIUpdateAutomaticTapeCreationPolicyInput::isSet() const {
...
bool OAIUpdateAutomaticTapeCreationPolicyInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_automatic_tape_creation_rules_isValid && m_gateway_arn_isValid && true;
}
