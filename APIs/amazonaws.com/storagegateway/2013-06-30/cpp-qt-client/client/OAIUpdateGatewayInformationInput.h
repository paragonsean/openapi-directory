...
/*
 * OAIUpdateGatewayInformationInput.h
 *
 * 
 */

#ifndef OAIUpdateGatewayInformationInput_H
#define OAIUpdateGatewayInformationInput_H
...
class OAIUpdateGatewayInformationInput : public OAIObject {
public:
    OAIUpdateGatewayInformationInput();
    OAIUpdateGatewayInformationInput(QString json);
    ~OAIUpdateGatewayInformationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGatewayInformationInput)

#endif // OAIUpdateGatewayInformationInput_H
