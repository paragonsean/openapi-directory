...
#include "OAIEndpointNetworkConfiguration.h"
...
OAIEndpointNetworkConfiguration::OAIEndpointNetworkConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEndpointNetworkConfiguration::OAIEndpointNetworkConfiguration() {
    this->initializeModel();
}

OAIEndpointNetworkConfiguration::~OAIEndpointNetworkConfiguration() {}

void OAIEndpointNetworkConfiguration::initializeModel() {

    m_ip_addresses_isSet = false;
    m_ip_addresses_isValid = false;
}

void OAIEndpointNetworkConfiguration::fromJson(QString jsonString) {
...
void OAIEndpointNetworkConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIEndpointNetworkConfiguration::asJson() const {
...
QJsonObject OAIEndpointNetworkConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIEndpointNetworkConfiguration::getIpAddresses() const {
    return m_ip_addresses;
}
void OAIEndpointNetworkConfiguration::setIpAddresses(const QList &ip_addresses) {
    m_ip_addresses = ip_addresses;
    m_ip_addresses_isSet = true;
}

bool OAIEndpointNetworkConfiguration::is_ip_addresses_Set() const{
    return m_ip_addresses_isSet;
}

bool OAIEndpointNetworkConfiguration::is_ip_addresses_Valid() const{
    return m_ip_addresses_isValid;
}

bool OAIEndpointNetworkConfiguration::isSet() const {
...
bool OAIEndpointNetworkConfiguration::isValid() const {
