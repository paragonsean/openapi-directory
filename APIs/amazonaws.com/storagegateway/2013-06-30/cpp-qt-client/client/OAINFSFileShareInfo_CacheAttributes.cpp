...
OAINFSFileShareInfo_CacheAttributes::OAINFSFileShareInfo_CacheAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINFSFileShareInfo_CacheAttributes::OAINFSFileShareInfo_CacheAttributes() {
    this->initializeModel();
}

OAINFSFileShareInfo_CacheAttributes::~OAINFSFileShareInfo_CacheAttributes() {}

void OAINFSFileShareInfo_CacheAttributes::initializeModel() {

    m_cache_stale_timeout_in_seconds_isSet = false;
    m_cache_stale_timeout_in_seconds_isValid = false;
}

void OAINFSFileShareInfo_CacheAttributes::fromJson(QString jsonString) {
...
void OAINFSFileShareInfo_CacheAttributes::fromJsonObject(QJsonObject json) {
...
QString OAINFSFileShareInfo_CacheAttributes::asJson() const {
...
QJsonObject OAINFSFileShareInfo_CacheAttributes::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAINFSFileShareInfo_CacheAttributes::getCacheStaleTimeoutInSeconds() const {
    return m_cache_stale_timeout_in_seconds;
}
void OAINFSFileShareInfo_CacheAttributes::setCacheStaleTimeoutInSeconds(const qint32 &cache_stale_timeout_in_seconds) {
    m_cache_stale_timeout_in_seconds = cache_stale_timeout_in_seconds;
    m_cache_stale_timeout_in_seconds_isSet = true;
}

bool OAINFSFileShareInfo_CacheAttributes::is_cache_stale_timeout_in_seconds_Set() const{
    return m_cache_stale_timeout_in_seconds_isSet;
}

bool OAINFSFileShareInfo_CacheAttributes::is_cache_stale_timeout_in_seconds_Valid() const{
    return m_cache_stale_timeout_in_seconds_isValid;
}

bool OAINFSFileShareInfo_CacheAttributes::isSet() const {
...
bool OAINFSFileShareInfo_CacheAttributes::isValid() const {
