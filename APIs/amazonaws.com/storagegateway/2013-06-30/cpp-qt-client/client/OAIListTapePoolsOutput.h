...
/*
 * OAIListTapePoolsOutput.h
 *
 * 
 */

#ifndef OAIListTapePoolsOutput_H
#define OAIListTapePoolsOutput_H
...
class OAIListTapePoolsOutput : public OAIObject {
public:
    OAIListTapePoolsOutput();
    OAIListTapePoolsOutput(QString json);
    ~OAIListTapePoolsOutput() override;
    ...
    QList getPoolInfos() const;
    void setPoolInfos(const QList &pool_infos);
    bool is_pool_infos_Set() const;
    bool is_pool_infos_Valid() const;
...
private:
    ...
    QList m_pool_infos;
    bool m_pool_infos_isSet;
    bool m_pool_infos_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTapePoolsOutput)

#endif // OAIListTapePoolsOutput_H
