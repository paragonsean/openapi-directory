...
OAICancelArchivalOutput::OAICancelArchivalOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICancelArchivalOutput::OAICancelArchivalOutput() {
    this->initializeModel();
}

OAICancelArchivalOutput::~OAICancelArchivalOutput() {}

void OAICancelArchivalOutput::initializeModel() {

    m_tape_arn_isSet = false;
    m_tape_arn_isValid = false;
}

void OAICancelArchivalOutput::fromJson(QString jsonString) {
...
void OAICancelArchivalOutput::fromJsonObject(QJsonObject json) {
...
QString OAICancelArchivalOutput::asJson() const {
...
QJsonObject OAICancelArchivalOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_arn_isSet) {
...
QString OAICancelArchivalOutput::getTapeArn() const {
    return m_tape_arn;
}
void OAICancelArchivalOutput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAICancelArchivalOutput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAICancelArchivalOutput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

bool OAICancelArchivalOutput::isSet() const {
...
bool OAICancelArchivalOutput::isValid() const {
