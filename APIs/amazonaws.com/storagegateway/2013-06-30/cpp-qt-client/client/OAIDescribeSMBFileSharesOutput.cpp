...
OAIDescribeSMBFileSharesOutput::OAIDescribeSMBFileSharesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeSMBFileSharesOutput::OAIDescribeSMBFileSharesOutput() {
    this->initializeModel();
}

OAIDescribeSMBFileSharesOutput::~OAIDescribeSMBFileSharesOutput() {}

void OAIDescribeSMBFileSharesOutput::initializeModel() {

    m_smb_file_share_info_list_isSet = false;
    m_smb_file_share_info_list_isValid = false;
}

void OAIDescribeSMBFileSharesOutput::fromJson(QString jsonString) {
...
void OAIDescribeSMBFileSharesOutput::fromJsonObject(QJsonObject json) {

    m_smb_file_share_info_list_isValid = ::OpenAPI::fromJsonValue(m_smb_file_share_info_list, json[QString("SMBFileShareInfoList")]);
    m_smb_file_share_info_list_isSet = !json[QString("SMBFileShareInfoList")].isNull() && m_smb_file_share_info_list_isValid;
}

QString OAIDescribeSMBFileSharesOutput::asJson() const {
...
QJsonObject OAIDescribeSMBFileSharesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_smb_file_share_info_list.isSet()) {
        obj.insert(QString("SMBFileShareInfoList"), ::OpenAPI::toJsonValue(m_smb_file_share_info_list));
    }
    return obj;
}

QList OAIDescribeSMBFileSharesOutput::getSmbFileShareInfoList() const {
    return m_smb_file_share_info_list;
}
void OAIDescribeSMBFileSharesOutput::setSmbFileShareInfoList(const QList &smb_file_share_info_list) {
    m_smb_file_share_info_list = smb_file_share_info_list;
    m_smb_file_share_info_list_isSet = true;
}

bool OAIDescribeSMBFileSharesOutput::is_smb_file_share_info_list_Set() const{
    return m_smb_file_share_info_list_isSet;
}

bool OAIDescribeSMBFileSharesOutput::is_smb_file_share_info_list_Valid() const{
    return m_smb_file_share_info_list_isValid;
}

bool OAIDescribeSMBFileSharesOutput::isSet() const {
...
bool OAIDescribeSMBFileSharesOutput::isValid() const {
