...
OAIListVolumesInput::OAIListVolumesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListVolumesInput::OAIListVolumesInput() {
    this->initializeModel();
}

OAIListVolumesInput::~OAIListVolumesInput() {}

void OAIListVolumesInput::initializeModel() {
...
void OAIListVolumesInput::fromJson(QString jsonString) {
...
void OAIListVolumesInput::fromJsonObject(QJsonObject json) {
...
QString OAIListVolumesInput::asJson() const {
...
QJsonObject OAIListVolumesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListVolumesInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIListVolumesInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIListVolumesInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIListVolumesInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QString OAIListVolumesInput::getMarker() const {
    return m_marker;
}
void OAIListVolumesInput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListVolumesInput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListVolumesInput::is_marker_Valid() const{
    return m_marker_isValid;
}

qint32 OAIListVolumesInput::getLimit() const {
    return m_limit;
}
void OAIListVolumesInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListVolumesInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListVolumesInput::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAIListVolumesInput::isSet() const {
...
bool OAIListVolumesInput::isValid() const {
