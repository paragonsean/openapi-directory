...
OAIUpdateSMBLocalGroupsOutput::OAIUpdateSMBLocalGroupsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSMBLocalGroupsOutput::OAIUpdateSMBLocalGroupsOutput() {
    this->initializeModel();
}

OAIUpdateSMBLocalGroupsOutput::~OAIUpdateSMBLocalGroupsOutput() {}

void OAIUpdateSMBLocalGroupsOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIUpdateSMBLocalGroupsOutput::fromJson(QString jsonString) {
...
void OAIUpdateSMBLocalGroupsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSMBLocalGroupsOutput::asJson() const {
...
QJsonObject OAIUpdateSMBLocalGroupsOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSMBLocalGroupsOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateSMBLocalGroupsOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateSMBLocalGroupsOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateSMBLocalGroupsOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIUpdateSMBLocalGroupsOutput::isSet() const {
...
bool OAIUpdateSMBLocalGroupsOutput::isValid() const {
