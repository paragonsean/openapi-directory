...
/*
 * OAIListFileSharesOutput.h
 *
 * ListFileShareOutput
 */

#ifndef OAIListFileSharesOutput_H
#define OAIListFileSharesOutput_H
...
class OAIListFileSharesOutput : public OAIObject {
public:
    OAIListFileSharesOutput();
    OAIListFileSharesOutput(QString json);
    ~OAIListFileSharesOutput() override;
    ...
    QList getFileShareInfoList() const;
    void setFileShareInfoList(const QList &file_share_info_list);
    bool is_file_share_info_list_Set() const;
    bool is_file_share_info_list_Valid() const;
...
private:
    ...
    QList m_file_share_info_list;
    bool m_file_share_info_list_isSet;
    bool m_file_share_info_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListFileSharesOutput)

#endif // OAIListFileSharesOutput_H
