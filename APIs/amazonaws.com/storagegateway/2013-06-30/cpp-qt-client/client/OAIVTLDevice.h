...
#ifndef OAIVTLDevice_H
#define OAIVTLDevice_H
...
namespace OpenAPI {
class OAIVTLDevice_DeviceiSCSIAttributes;

class OAIVTLDevice : public OAIObject {
public:
    OAIVTLDevice();
    OAIVTLDevice(QString json);
    ~OAIVTLDevice() override;
    ...
    QString getVtlDeviceType() const;
    void setVtlDeviceType(const QString &vtl_device_type);
    bool is_vtl_device_type_Set() const;
    bool is_vtl_device_type_Valid() const;

    QString getVtlDeviceVendor() const;
    void setVtlDeviceVendor(const QString &vtl_device_vendor);
    bool is_vtl_device_vendor_Set() const;
    bool is_vtl_device_vendor_Valid() const;

    QString getVtlDeviceProductIdentifier() const;
    void setVtlDeviceProductIdentifier(const QString &vtl_device_product_identifier);
    bool is_vtl_device_product_identifier_Set() const;
    bool is_vtl_device_product_identifier_Valid() const;

    OAIVTLDevice_DeviceiSCSIAttributes getDeviceiScsiAttributes() const;
    void setDeviceiScsiAttributes(const OAIVTLDevice_DeviceiSCSIAttributes &devicei_scsi_attributes);
    bool is_devicei_scsi_attributes_Set() const;
    bool is_devicei_scsi_attributes_Valid() const;
...
private:
    ...
    QString m_vtl_device_type;
    bool m_vtl_device_type_isSet;
    bool m_vtl_device_type_isValid;

    QString m_vtl_device_vendor;
    bool m_vtl_device_vendor_isSet;
    bool m_vtl_device_vendor_isValid;

    QString m_vtl_device_product_identifier;
    bool m_vtl_device_product_identifier_isSet;
    bool m_vtl_device_product_identifier_isValid;

    OAIVTLDevice_DeviceiSCSIAttributes m_devicei_scsi_attributes;
    bool m_devicei_scsi_attributes_isSet;
    bool m_devicei_scsi_attributes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIVTLDevice)

#endif // OAIVTLDevice_H
