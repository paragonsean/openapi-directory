...
OAIStartGatewayOutput::OAIStartGatewayOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartGatewayOutput::OAIStartGatewayOutput() {
    this->initializeModel();
}

OAIStartGatewayOutput::~OAIStartGatewayOutput() {}

void OAIStartGatewayOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIStartGatewayOutput::fromJson(QString jsonString) {
...
void OAIStartGatewayOutput::fromJsonObject(QJsonObject json) {
...
QString OAIStartGatewayOutput::asJson() const {
...
QJsonObject OAIStartGatewayOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartGatewayOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIStartGatewayOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIStartGatewayOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIStartGatewayOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIStartGatewayOutput::isSet() const {
...
bool OAIStartGatewayOutput::isValid() const {
