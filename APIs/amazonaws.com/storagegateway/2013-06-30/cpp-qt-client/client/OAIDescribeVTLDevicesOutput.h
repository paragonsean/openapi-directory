...
/*
 * OAIDescribeVTLDevicesOutput.h
 *
 * DescribeVTLDevicesOutput
 */

#ifndef OAIDescribeVTLDevicesOutput_H
#define OAIDescribeVTLDevicesOutput_H
...
class OAIDescribeVTLDevicesOutput : public OAIObject {
public:
    OAIDescribeVTLDevicesOutput();
    OAIDescribeVTLDevicesOutput(QString json);
    ~OAIDescribeVTLDevicesOutput() override;
    ...
    QList getVtlDevices() const;
    void setVtlDevices(const QList &vtl_devices);
    bool is_vtl_devices_Set() const;
    bool is_vtl_devices_Valid() const;
...
private:
    ...
    QList m_vtl_devices;
    bool m_vtl_devices_isSet;
    bool m_vtl_devices_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeVTLDevicesOutput)

#endif // OAIDescribeVTLDevicesOutput_H
