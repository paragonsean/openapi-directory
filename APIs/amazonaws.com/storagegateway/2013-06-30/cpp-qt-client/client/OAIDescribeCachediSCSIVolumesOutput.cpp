...
OAIDescribeCachediSCSIVolumesOutput::OAIDescribeCachediSCSIVolumesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCachediSCSIVolumesOutput::OAIDescribeCachediSCSIVolumesOutput() {
    this->initializeModel();
}

OAIDescribeCachediSCSIVolumesOutput::~OAIDescribeCachediSCSIVolumesOutput() {}

void OAIDescribeCachediSCSIVolumesOutput::initializeModel() {

    m_cachedi_scsi_volumes_isSet = false;
    m_cachedi_scsi_volumes_isValid = false;
}

void OAIDescribeCachediSCSIVolumesOutput::fromJson(QString jsonString) {
...
void OAIDescribeCachediSCSIVolumesOutput::fromJsonObject(QJsonObject json) {

    m_cachedi_scsi_volumes_isValid = ::OpenAPI::fromJsonValue(m_cachedi_scsi_volumes, json[QString("CachediSCSIVolumes")]);
    m_cachedi_scsi_volumes_isSet = !json[QString("CachediSCSIVolumes")].isNull() && m_cachedi_scsi_volumes_isValid;
}

QString OAIDescribeCachediSCSIVolumesOutput::asJson() const {
...
QJsonObject OAIDescribeCachediSCSIVolumesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_cachedi_scsi_volumes.isSet()) {
        obj.insert(QString("CachediSCSIVolumes"), ::OpenAPI::toJsonValue(m_cachedi_scsi_volumes));
    }
    return obj;
}

QList OAIDescribeCachediSCSIVolumesOutput::getCachediScsiVolumes() const {
    return m_cachedi_scsi_volumes;
}
void OAIDescribeCachediSCSIVolumesOutput::setCachediScsiVolumes(const QList &cachedi_scsi_volumes) {
    m_cachedi_scsi_volumes = cachedi_scsi_volumes;
    m_cachedi_scsi_volumes_isSet = true;
}

bool OAIDescribeCachediSCSIVolumesOutput::is_cachedi_scsi_volumes_Set() const{
    return m_cachedi_scsi_volumes_isSet;
}

bool OAIDescribeCachediSCSIVolumesOutput::is_cachedi_scsi_volumes_Valid() const{
    return m_cachedi_scsi_volumes_isValid;
}

bool OAIDescribeCachediSCSIVolumesOutput::isSet() const {
...
bool OAIDescribeCachediSCSIVolumesOutput::isValid() const {
