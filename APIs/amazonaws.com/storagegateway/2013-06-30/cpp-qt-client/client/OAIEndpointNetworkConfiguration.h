...
/*
 * OAIEndpointNetworkConfiguration.h
 *
 * Specifies network configuration information for the gateway associated with the Amazon FSx file system.
 */

#ifndef OAIEndpointNetworkConfiguration_H
#define OAIEndpointNetworkConfiguration_H
...
class OAIEndpointNetworkConfiguration : public OAIObject {
public:
    OAIEndpointNetworkConfiguration();
    OAIEndpointNetworkConfiguration(QString json);
    ~OAIEndpointNetworkConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointNetworkConfiguration)

#endif // OAIEndpointNetworkConfiguration_H
