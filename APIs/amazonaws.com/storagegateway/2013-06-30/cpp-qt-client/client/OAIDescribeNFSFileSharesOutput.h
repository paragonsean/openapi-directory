...
/*
 * OAIDescribeNFSFileSharesOutput.h
 *
 * DescribeNFSFileSharesOutput
 */

#ifndef OAIDescribeNFSFileSharesOutput_H
#define OAIDescribeNFSFileSharesOutput_H
...
class OAIDescribeNFSFileSharesOutput : public OAIObject {
public:
    OAIDescribeNFSFileSharesOutput();
    OAIDescribeNFSFileSharesOutput(QString json);
    ~OAIDescribeNFSFileSharesOutput() override;
    ...
    QList getNfsFileShareInfoList() const;
    void setNfsFileShareInfoList(const QList &nfs_file_share_info_list);
    bool is_nfs_file_share_info_list_Set() const;
    bool is_nfs_file_share_info_list_Valid() const;
...
private:
    ...
    QList m_nfs_file_share_info_list;
    bool m_nfs_file_share_info_list_isSet;
    bool m_nfs_file_share_info_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeNFSFileSharesOutput)

#endif // OAIDescribeNFSFileSharesOutput_H
