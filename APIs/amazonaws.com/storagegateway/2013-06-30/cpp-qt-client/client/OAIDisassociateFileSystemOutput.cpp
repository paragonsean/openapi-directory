...
OAIDisassociateFileSystemOutput::OAIDisassociateFileSystemOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateFileSystemOutput::OAIDisassociateFileSystemOutput() {
    this->initializeModel();
}

OAIDisassociateFileSystemOutput::~OAIDisassociateFileSystemOutput() {}

void OAIDisassociateFileSystemOutput::initializeModel() {

    m_file_system_association_arn_isSet = false;
    m_file_system_association_arn_isValid = false;
}

void OAIDisassociateFileSystemOutput::fromJson(QString jsonString) {
...
void OAIDisassociateFileSystemOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDisassociateFileSystemOutput::asJson() const {
...
QJsonObject OAIDisassociateFileSystemOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisassociateFileSystemOutput::getFileSystemAssociationArn() const {
    return m_file_system_association_arn;
}
void OAIDisassociateFileSystemOutput::setFileSystemAssociationArn(const QString &file_system_association_arn) {
    m_file_system_association_arn = file_system_association_arn;
    m_file_system_association_arn_isSet = true;
}

bool OAIDisassociateFileSystemOutput::is_file_system_association_arn_Set() const{
    return m_file_system_association_arn_isSet;
}

bool OAIDisassociateFileSystemOutput::is_file_system_association_arn_Valid() const{
    return m_file_system_association_arn_isValid;
}

bool OAIDisassociateFileSystemOutput::isSet() const {
...
bool OAIDisassociateFileSystemOutput::isValid() const {
