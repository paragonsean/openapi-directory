...
/*
 * OAIRefreshCacheInput.h
 *
 * RefreshCacheInput
 */

#ifndef OAIRefreshCacheInput_H
#define OAIRefreshCacheInput_H
...
class OAIRefreshCacheInput : public OAIObject {
public:
    OAIRefreshCacheInput();
    OAIRefreshCacheInput(QString json);
    ~OAIRefreshCacheInput() override;
    ...
    QList getFolderList() const;
    void setFolderList(const QList &folder_list);
    bool is_folder_list_Set() const;
    bool is_folder_list_Valid() const;
...
private:
    ...
    QList m_folder_list;
    bool m_folder_list_isSet;
    bool m_folder_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefreshCacheInput)

#endif // OAIRefreshCacheInput_H
