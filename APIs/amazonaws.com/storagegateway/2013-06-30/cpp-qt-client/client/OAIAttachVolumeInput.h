...
/*
 * OAIAttachVolumeInput.h
 *
 * AttachVolumeInput
 */

#ifndef OAIAttachVolumeInput_H
#define OAIAttachVolumeInput_H
...
class OAIAttachVolumeInput : public OAIObject {
public:
    OAIAttachVolumeInput();
    OAIAttachVolumeInput(QString json);
    ~OAIAttachVolumeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachVolumeInput)

#endif // OAIAttachVolumeInput_H
