...
OAICreateSMBFileShareInput::OAICreateSMBFileShareInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSMBFileShareInput::OAICreateSMBFileShareInput() {
    this->initializeModel();
}

OAICreateSMBFileShareInput::~OAICreateSMBFileShareInput() {}

void OAICreateSMBFileShareInput::initializeModel() {
...
void OAICreateSMBFileShareInput::fromJson(QString jsonString) {
...
void OAICreateSMBFileShareInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateSMBFileShareInput::asJson() const {
...
QJsonObject OAICreateSMBFileShareInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSMBFileShareInput::getClientToken() const {
    return m_client_token;
}
void OAICreateSMBFileShareInput::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAICreateSMBFileShareInput::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAICreateSMBFileShareInput::is_client_token_Valid() const{
    return m_client_token_isValid;
}

QString OAICreateSMBFileShareInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAICreateSMBFileShareInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAICreateSMBFileShareInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAICreateSMBFileShareInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAICreateSMBFileShareInput::getKmsEncrypted() const {
    return m_kms_encrypted;
}
void OAICreateSMBFileShareInput::setKmsEncrypted(const bool &kms_encrypted) {
    m_kms_encrypted = kms_encrypted;
    m_kms_encrypted_isSet = true;
}

bool OAICreateSMBFileShareInput::is_kms_encrypted_Set() const{
    return m_kms_encrypted_isSet;
}

bool OAICreateSMBFileShareInput::is_kms_encrypted_Valid() const{
    return m_kms_encrypted_isValid;
}

QString OAICreateSMBFileShareInput::getKmsKey() const {
    return m_kms_key;
}
void OAICreateSMBFileShareInput::setKmsKey(const QString &kms_key) {
    m_kms_key = kms_key;
    m_kms_key_isSet = true;
}

bool OAICreateSMBFileShareInput::is_kms_key_Set() const{
    return m_kms_key_isSet;
}

bool OAICreateSMBFileShareInput::is_kms_key_Valid() const{
    return m_kms_key_isValid;
}

QString OAICreateSMBFileShareInput::getRole() const {
    return m_role;
}
void OAICreateSMBFileShareInput::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAICreateSMBFileShareInput::is_role_Set() const{
    return m_role_isSet;
}

bool OAICreateSMBFileShareInput::is_role_Valid() const{
    return m_role_isValid;
}

QString OAICreateSMBFileShareInput::getLocationArn() const {
    return m_location_arn;
}
void OAICreateSMBFileShareInput::setLocationArn(const QString &location_arn) {
    m_location_arn = location_arn;
    m_location_arn_isSet = true;
}

bool OAICreateSMBFileShareInput::is_location_arn_Set() const{
    return m_location_arn_isSet;
}

bool OAICreateSMBFileShareInput::is_location_arn_Valid() const{
    return m_location_arn_isValid;
}

QString OAICreateSMBFileShareInput::getDefaultStorageClass() const {
    return m_default_storage_class;
}
void OAICreateSMBFileShareInput::setDefaultStorageClass(const QString &default_storage_class) {
    m_default_storage_class = default_storage_class;
    m_default_storage_class_isSet = true;
}

bool OAICreateSMBFileShareInput::is_default_storage_class_Set() const{
    return m_default_storage_class_isSet;
}

bool OAICreateSMBFileShareInput::is_default_storage_class_Valid() const{
    return m_default_storage_class_isValid;
}

OAIObjectACL OAICreateSMBFileShareInput::getObjectAcl() const {
    return m_object_acl;
}
void OAICreateSMBFileShareInput::setObjectAcl(const OAIObjectACL &object_acl) {
    m_object_acl = object_acl;
    m_object_acl_isSet = true;
}

bool OAICreateSMBFileShareInput::is_object_acl_Set() const{
    return m_object_acl_isSet;
}

bool OAICreateSMBFileShareInput::is_object_acl_Valid() const{
    return m_object_acl_isValid;
}

bool OAICreateSMBFileShareInput::getReadOnly() const {
    return m_read_only;
}
void OAICreateSMBFileShareInput::setReadOnly(const bool &read_only) {
    m_read_only = read_only;
    m_read_only_isSet = true;
}

bool OAICreateSMBFileShareInput::is_read_only_Set() const{
    return m_read_only_isSet;
}

bool OAICreateSMBFileShareInput::is_read_only_Valid() const{
    return m_read_only_isValid;
}

bool OAICreateSMBFileShareInput::getGuessMimeTypeEnabled() const {
    return m_guess_mime_type_enabled;
}
void OAICreateSMBFileShareInput::setGuessMimeTypeEnabled(const bool &guess_mime_type_enabled) {
    m_guess_mime_type_enabled = guess_mime_type_enabled;
    m_guess_mime_type_enabled_isSet = true;
}

bool OAICreateSMBFileShareInput::is_guess_mime_type_enabled_Set() const{
    return m_guess_mime_type_enabled_isSet;
}

bool OAICreateSMBFileShareInput::is_guess_mime_type_enabled_Valid() const{
    return m_guess_mime_type_enabled_isValid;
}

bool OAICreateSMBFileShareInput::getRequesterPays() const {
    return m_requester_pays;
}
void OAICreateSMBFileShareInput::setRequesterPays(const bool &requester_pays) {
    m_requester_pays = requester_pays;
    m_requester_pays_isSet = true;
}

bool OAICreateSMBFileShareInput::is_requester_pays_Set() const{
    return m_requester_pays_isSet;
}

bool OAICreateSMBFileShareInput::is_requester_pays_Valid() const{
    return m_requester_pays_isValid;
}

bool OAICreateSMBFileShareInput::getSmbaclEnabled() const {
    return m_smbacl_enabled;
}
void OAICreateSMBFileShareInput::setSmbaclEnabled(const bool &smbacl_enabled) {
    m_smbacl_enabled = smbacl_enabled;
    m_smbacl_enabled_isSet = true;
}

bool OAICreateSMBFileShareInput::is_smbacl_enabled_Set() const{
    return m_smbacl_enabled_isSet;
}

bool OAICreateSMBFileShareInput::is_smbacl_enabled_Valid() const{
    return m_smbacl_enabled_isValid;
}

bool OAICreateSMBFileShareInput::getAccessBasedEnumeration() const {
    return m_access_based_enumeration;
}
void OAICreateSMBFileShareInput::setAccessBasedEnumeration(const bool &access_based_enumeration) {
    m_access_based_enumeration = access_based_enumeration;
    m_access_based_enumeration_isSet = true;
}

bool OAICreateSMBFileShareInput::is_access_based_enumeration_Set() const{
    return m_access_based_enumeration_isSet;
}

bool OAICreateSMBFileShareInput::is_access_based_enumeration_Valid() const{
    return m_access_based_enumeration_isValid;
}

QList OAICreateSMBFileShareInput::getAdminUserList() const {
    return m_admin_user_list;
}
void OAICreateSMBFileShareInput::setAdminUserList(const QList &admin_user_list) {
    m_admin_user_list = admin_user_list;
    m_admin_user_list_isSet = true;
}

bool OAICreateSMBFileShareInput::is_admin_user_list_Set() const{
    return m_admin_user_list_isSet;
}

bool OAICreateSMBFileShareInput::is_admin_user_list_Valid() const{
    return m_admin_user_list_isValid;
}

QList OAICreateSMBFileShareInput::getValidUserList() const {
    return m_valid_user_list;
}
void OAICreateSMBFileShareInput::setValidUserList(const QList &valid_user_list) {
    m_valid_user_list = valid_user_list;
    m_valid_user_list_isSet = true;
}

bool OAICreateSMBFileShareInput::is_valid_user_list_Set() const{
    return m_valid_user_list_isSet;
}

bool OAICreateSMBFileShareInput::is_valid_user_list_Valid() const{
    return m_valid_user_list_isValid;
}

QList OAICreateSMBFileShareInput::getInvalidUserList() const {
    return m_invalid_user_list;
}
void OAICreateSMBFileShareInput::setInvalidUserList(const QList &invalid_user_list) {
    m_invalid_user_list = invalid_user_list;
    m_invalid_user_list_isSet = true;
}

bool OAICreateSMBFileShareInput::is_invalid_user_list_Set() const{
    return m_invalid_user_list_isSet;
}

bool OAICreateSMBFileShareInput::is_invalid_user_list_Valid() const{
    return m_invalid_user_list_isValid;
}

QString OAICreateSMBFileShareInput::getAuditDestinationArn() const {
    return m_audit_destination_arn;
}
void OAICreateSMBFileShareInput::setAuditDestinationArn(const QString &audit_destination_arn) {
    m_audit_destination_arn = audit_destination_arn;
    m_audit_destination_arn_isSet = true;
}

bool OAICreateSMBFileShareInput::is_audit_destination_arn_Set() const{
    return m_audit_destination_arn_isSet;
}

bool OAICreateSMBFileShareInput::is_audit_destination_arn_Valid() const{
    return m_audit_destination_arn_isValid;
}

QString OAICreateSMBFileShareInput::getAuthentication() const {
    return m_authentication;
}
void OAICreateSMBFileShareInput::setAuthentication(const QString &authentication) {
    m_authentication = authentication;
    m_authentication_isSet = true;
}

bool OAICreateSMBFileShareInput::is_authentication_Set() const{
    return m_authentication_isSet;
}

bool OAICreateSMBFileShareInput::is_authentication_Valid() const{
    return m_authentication_isValid;
}

OAICaseSensitivity OAICreateSMBFileShareInput::getCaseSensitivity() const {
    return m_case_sensitivity;
}
void OAICreateSMBFileShareInput::setCaseSensitivity(const OAICaseSensitivity &case_sensitivity) {
    m_case_sensitivity = case_sensitivity;
    m_case_sensitivity_isSet = true;
}

bool OAICreateSMBFileShareInput::is_case_sensitivity_Set() const{
    return m_case_sensitivity_isSet;
}

bool OAICreateSMBFileShareInput::is_case_sensitivity_Valid() const{
    return m_case_sensitivity_isValid;
}

QList OAICreateSMBFileShareInput::getTags() const {
    return m_tags;
}
void OAICreateSMBFileShareInput::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateSMBFileShareInput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateSMBFileShareInput::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAICreateSMBFileShareInput::getFileShareName() const {
    return m_file_share_name;
}
void OAICreateSMBFileShareInput::setFileShareName(const QString &file_share_name) {
    m_file_share_name = file_share_name;
    m_file_share_name_isSet = true;
}

bool OAICreateSMBFileShareInput::is_file_share_name_Set() const{
    return m_file_share_name_isSet;
}

bool OAICreateSMBFileShareInput::is_file_share_name_Valid() const{
    return m_file_share_name_isValid;
}

OAICreateNFSFileShareInput_CacheAttributes OAICreateSMBFileShareInput::getCacheAttributes() const {
    return m_cache_attributes;
}
void OAICreateSMBFileShareInput::setCacheAttributes(const OAICreateNFSFileShareInput_CacheAttributes &cache_attributes) {
    m_cache_attributes = cache_attributes;
    m_cache_attributes_isSet = true;
}

bool OAICreateSMBFileShareInput::is_cache_attributes_Set() const{
    return m_cache_attributes_isSet;
}

bool OAICreateSMBFileShareInput::is_cache_attributes_Valid() const{
    return m_cache_attributes_isValid;
}

QString OAICreateSMBFileShareInput::getNotificationPolicy() const {
    return m_notification_policy;
}
void OAICreateSMBFileShareInput::setNotificationPolicy(const QString &notification_policy) {
    m_notification_policy = notification_policy;
    m_notification_policy_isSet = true;
}

bool OAICreateSMBFileShareInput::is_notification_policy_Set() const{
    return m_notification_policy_isSet;
}

bool OAICreateSMBFileShareInput::is_notification_policy_Valid() const{
    return m_notification_policy_isValid;
}

QString OAICreateSMBFileShareInput::getVpcEndpointDnsName() const {
    return m_vpc_endpoint_dns_name;
}
void OAICreateSMBFileShareInput::setVpcEndpointDnsName(const QString &vpc_endpoint_dns_name) {
    m_vpc_endpoint_dns_name = vpc_endpoint_dns_name;
    m_vpc_endpoint_dns_name_isSet = true;
}

bool OAICreateSMBFileShareInput::is_vpc_endpoint_dns_name_Set() const{
    return m_vpc_endpoint_dns_name_isSet;
}

bool OAICreateSMBFileShareInput::is_vpc_endpoint_dns_name_Valid() const{
    return m_vpc_endpoint_dns_name_isValid;
}

QString OAICreateSMBFileShareInput::getBucketRegion() const {
    return m_bucket_region;
}
void OAICreateSMBFileShareInput::setBucketRegion(const QString &bucket_region) {
    m_bucket_region = bucket_region;
    m_bucket_region_isSet = true;
}

bool OAICreateSMBFileShareInput::is_bucket_region_Set() const{
    return m_bucket_region_isSet;
}

bool OAICreateSMBFileShareInput::is_bucket_region_Valid() const{
    return m_bucket_region_isValid;
}

bool OAICreateSMBFileShareInput::getOplocksEnabled() const {
    return m_oplocks_enabled;
}
void OAICreateSMBFileShareInput::setOplocksEnabled(const bool &oplocks_enabled) {
    m_oplocks_enabled = oplocks_enabled;
    m_oplocks_enabled_isSet = true;
}

bool OAICreateSMBFileShareInput::is_oplocks_enabled_Set() const{
    return m_oplocks_enabled_isSet;
}

bool OAICreateSMBFileShareInput::is_oplocks_enabled_Valid() const{
    return m_oplocks_enabled_isValid;
}

bool OAICreateSMBFileShareInput::isSet() const {
...
bool OAICreateSMBFileShareInput::isValid() const {
