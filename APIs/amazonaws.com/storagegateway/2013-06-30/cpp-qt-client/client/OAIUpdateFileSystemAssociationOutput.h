...
/*
 * OAIUpdateFileSystemAssociationOutput.h
 *
 * 
 */

#ifndef OAIUpdateFileSystemAssociationOutput_H
#define OAIUpdateFileSystemAssociationOutput_H
...
class OAIUpdateFileSystemAssociationOutput : public OAIObject {
public:
    OAIUpdateFileSystemAssociationOutput();
    OAIUpdateFileSystemAssociationOutput(QString json);
    ~OAIUpdateFileSystemAssociationOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFileSystemAssociationOutput)

#endif // OAIUpdateFileSystemAssociationOutput_H
