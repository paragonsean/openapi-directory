...
/*
 * OAITapeStorageClass.h
 *
 * 
 */

#ifndef OAITapeStorageClass_H
#define OAITapeStorageClass_H
...
class OAITapeStorageClass : public OAIEnum {
public:
    OAITapeStorageClass();
    OAITapeStorageClass(QString json);
    ~OAITapeStorageClass() override;
    ...
    enum class eOAITapeStorageClass {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DEEP_ARCHIVE, 
        GLACIER
    };
    OAITapeStorageClass::eOAITapeStorageClass getValue() const;
    void setValue(const OAITapeStorageClass::eOAITapeStorageClass& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITapeStorageClass)

#endif // OAITapeStorageClass_H
