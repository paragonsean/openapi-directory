...
OAIDeleteGatewayOutput::OAIDeleteGatewayOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteGatewayOutput::OAIDeleteGatewayOutput() {
    this->initializeModel();
}

OAIDeleteGatewayOutput::~OAIDeleteGatewayOutput() {}

void OAIDeleteGatewayOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDeleteGatewayOutput::fromJson(QString jsonString) {
...
void OAIDeleteGatewayOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteGatewayOutput::asJson() const {
...
QJsonObject OAIDeleteGatewayOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteGatewayOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDeleteGatewayOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDeleteGatewayOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDeleteGatewayOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDeleteGatewayOutput::isSet() const {
...
bool OAIDeleteGatewayOutput::isValid() const {
