...
OAIResetCacheOutput::OAIResetCacheOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResetCacheOutput::OAIResetCacheOutput() {
    this->initializeModel();
}

OAIResetCacheOutput::~OAIResetCacheOutput() {}

void OAIResetCacheOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIResetCacheOutput::fromJson(QString jsonString) {
...
void OAIResetCacheOutput::fromJsonObject(QJsonObject json) {
...
QString OAIResetCacheOutput::asJson() const {
...
QJsonObject OAIResetCacheOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIResetCacheOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIResetCacheOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIResetCacheOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIResetCacheOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIResetCacheOutput::isSet() const {
...
bool OAIResetCacheOutput::isValid() const {
