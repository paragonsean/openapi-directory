...
OAIRetrieveTapeArchiveInput::OAIRetrieveTapeArchiveInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRetrieveTapeArchiveInput::OAIRetrieveTapeArchiveInput() {
    this->initializeModel();
}

OAIRetrieveTapeArchiveInput::~OAIRetrieveTapeArchiveInput() {}

void OAIRetrieveTapeArchiveInput::initializeModel() {
...
void OAIRetrieveTapeArchiveInput::fromJson(QString jsonString) {
...
void OAIRetrieveTapeArchiveInput::fromJsonObject(QJsonObject json) {
...
QString OAIRetrieveTapeArchiveInput::asJson() const {
...
QJsonObject OAIRetrieveTapeArchiveInput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_arn_isSet) {
...
QString OAIRetrieveTapeArchiveInput::getTapeArn() const {
    return m_tape_arn;
}
void OAIRetrieveTapeArchiveInput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAIRetrieveTapeArchiveInput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAIRetrieveTapeArchiveInput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

QString OAIRetrieveTapeArchiveInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIRetrieveTapeArchiveInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIRetrieveTapeArchiveInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIRetrieveTapeArchiveInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIRetrieveTapeArchiveInput::isSet() const {
...
bool OAIRetrieveTapeArchiveInput::isValid() const {
