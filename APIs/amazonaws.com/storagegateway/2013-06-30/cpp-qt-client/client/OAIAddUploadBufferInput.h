...
/*
 * OAIAddUploadBufferInput.h
 *
 * 
 */

#ifndef OAIAddUploadBufferInput_H
#define OAIAddUploadBufferInput_H
...
class OAIAddUploadBufferInput : public OAIObject {
public:
    OAIAddUploadBufferInput();
    OAIAddUploadBufferInput(QString json);
    ~OAIAddUploadBufferInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddUploadBufferInput)

#endif // OAIAddUploadBufferInput_H
