...
OAIDescribeAvailabilityMonitorTestInput::OAIDescribeAvailabilityMonitorTestInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAvailabilityMonitorTestInput::OAIDescribeAvailabilityMonitorTestInput() {
    this->initializeModel();
}

OAIDescribeAvailabilityMonitorTestInput::~OAIDescribeAvailabilityMonitorTestInput() {}

void OAIDescribeAvailabilityMonitorTestInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDescribeAvailabilityMonitorTestInput::fromJson(QString jsonString) {
...
void OAIDescribeAvailabilityMonitorTestInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeAvailabilityMonitorTestInput::asJson() const {
...
QJsonObject OAIDescribeAvailabilityMonitorTestInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeAvailabilityMonitorTestInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeAvailabilityMonitorTestInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeAvailabilityMonitorTestInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeAvailabilityMonitorTestInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDescribeAvailabilityMonitorTestInput::isSet() const {
...
bool OAIDescribeAvailabilityMonitorTestInput::isValid() const {
