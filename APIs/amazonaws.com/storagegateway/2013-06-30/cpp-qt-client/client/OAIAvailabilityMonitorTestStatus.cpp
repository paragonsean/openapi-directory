...
OAIAvailabilityMonitorTestStatus::OAIAvailabilityMonitorTestStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAvailabilityMonitorTestStatus::OAIAvailabilityMonitorTestStatus() {
    this->initializeModel();
}

OAIAvailabilityMonitorTestStatus::~OAIAvailabilityMonitorTestStatus() {}

void OAIAvailabilityMonitorTestStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAvailabilityMonitorTestStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAvailabilityMonitorTestStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("COMPLETE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAvailabilityMonitorTestStatus::COMPLETE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAvailabilityMonitorTestStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PENDING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAvailabilityMonitorTestStatus::PENDING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAvailabilityMonitorTestStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAvailabilityMonitorTestStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAvailabilityMonitorTestStatus::COMPLETE:
            val = "COMPLETE";
            break;
        case eOAIAvailabilityMonitorTestStatus::FAILED:
            val = "FAILED";
            break;
        case eOAIAvailabilityMonitorTestStatus::PENDING:
            val = "PENDING";
            break;
        default:
            break;
...
QJsonValue OAIAvailabilityMonitorTestStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAvailabilityMonitorTestStatus::eOAIAvailabilityMonitorTestStatus OAIAvailabilityMonitorTestStatus::getValue() const {
    return m_value;
}

void OAIAvailabilityMonitorTestStatus::setValue(const OAIAvailabilityMonitorTestStatus::eOAIAvailabilityMonitorTestStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAvailabilityMonitorTestStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIAvailabilityMonitorTestStatus::isValid() const {
