...
#ifndef OAIPoolInfo_H
#define OAIPoolInfo_H
...
class OAIPoolInfo : public OAIObject {
public:
    OAIPoolInfo();
    OAIPoolInfo(QString json);
    ~OAIPoolInfo() override;
    ...
    OAIPoolStatus getPoolStatus() const;
    void setPoolStatus(const OAIPoolStatus &pool_status);
    bool is_pool_status_Set() const;
    bool is_pool_status_Valid() const;
...
private:
    ...
    OAIPoolStatus m_pool_status;
    bool m_pool_status_isSet;
    bool m_pool_status_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPoolInfo)
