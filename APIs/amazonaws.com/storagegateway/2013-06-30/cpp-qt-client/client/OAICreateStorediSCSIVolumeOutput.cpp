...
OAICreateStorediSCSIVolumeOutput::OAICreateStorediSCSIVolumeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStorediSCSIVolumeOutput::OAICreateStorediSCSIVolumeOutput() {
    this->initializeModel();
}

OAICreateStorediSCSIVolumeOutput::~OAICreateStorediSCSIVolumeOutput() {}

void OAICreateStorediSCSIVolumeOutput::initializeModel() {
...
void OAICreateStorediSCSIVolumeOutput::fromJson(QString jsonString) {
...
void OAICreateStorediSCSIVolumeOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateStorediSCSIVolumeOutput::asJson() const {
...
QJsonObject OAICreateStorediSCSIVolumeOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateStorediSCSIVolumeOutput::getVolumeArn() const {
    return m_volume_arn;
}
void OAICreateStorediSCSIVolumeOutput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAICreateStorediSCSIVolumeOutput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAICreateStorediSCSIVolumeOutput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

qint32 OAICreateStorediSCSIVolumeOutput::getVolumeSizeInBytes() const {
    return m_volume_size_in_bytes;
}
void OAICreateStorediSCSIVolumeOutput::setVolumeSizeInBytes(const qint32 &volume_size_in_bytes) {
    m_volume_size_in_bytes = volume_size_in_bytes;
    m_volume_size_in_bytes_isSet = true;
}

bool OAICreateStorediSCSIVolumeOutput::is_volume_size_in_bytes_Set() const{
    return m_volume_size_in_bytes_isSet;
}

bool OAICreateStorediSCSIVolumeOutput::is_volume_size_in_bytes_Valid() const{
    return m_volume_size_in_bytes_isValid;
}

QString OAICreateStorediSCSIVolumeOutput::getTargetArn() const {
    return m_target_arn;
}
void OAICreateStorediSCSIVolumeOutput::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAICreateStorediSCSIVolumeOutput::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAICreateStorediSCSIVolumeOutput::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

bool OAICreateStorediSCSIVolumeOutput::isSet() const {
...
bool OAICreateStorediSCSIVolumeOutput::isValid() const {
