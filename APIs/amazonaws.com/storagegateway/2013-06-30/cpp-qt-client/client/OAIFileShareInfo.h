...
#ifndef OAIFileShareInfo_H
#define OAIFileShareInfo_H

#include <QJsonObject>

#include "OAIFileShareType.h"
#include <QString>
...
class OAIFileShareInfo : public OAIObject {
public:
    OAIFileShareInfo();
    OAIFileShareInfo(QString json);
    ~OAIFileShareInfo() override;
    ...
    OAIFileShareType getFileShareType() const;
    void setFileShareType(const OAIFileShareType &file_share_type);
    bool is_file_share_type_Set() const;
    bool is_file_share_type_Valid() const;
...
private:
    ...
    OAIFileShareType m_file_share_type;
    bool m_file_share_type_isSet;
    bool m_file_share_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileShareInfo)

#endif // OAIFileShareInfo_H
