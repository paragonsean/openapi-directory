...
/*
 * OAIDeleteVolumeInput.h
 *
 * A JSON object containing the &lt;a&gt;DeleteVolumeInput$VolumeARN&lt;/a&gt; to delete.
 */

#ifndef OAIDeleteVolumeInput_H
#define OAIDeleteVolumeInput_H
...
class OAIDeleteVolumeInput : public OAIObject {
public:
    OAIDeleteVolumeInput();
    OAIDeleteVolumeInput(QString json);
    ~OAIDeleteVolumeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteVolumeInput)

#endif // OAIDeleteVolumeInput_H
