...
class OAITape : public OAIObject {
public:
    OAITape();
    OAITape(QString json);
    ~OAITape() override;
    ...
    QString getVtlDevice() const;
    void setVtlDevice(const QString &vtl_device);
    bool is_vtl_device_Set() const;
    bool is_vtl_device_Valid() const;
...
private:
    ...
    QString m_vtl_device;
    bool m_vtl_device_isSet;
    bool m_vtl_device_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITape)
