...
OAIDeleteAutomaticTapeCreationPolicyOutput::OAIDeleteAutomaticTapeCreationPolicyOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAutomaticTapeCreationPolicyOutput::OAIDeleteAutomaticTapeCreationPolicyOutput() {
    this->initializeModel();
}

OAIDeleteAutomaticTapeCreationPolicyOutput::~OAIDeleteAutomaticTapeCreationPolicyOutput() {}

void OAIDeleteAutomaticTapeCreationPolicyOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDeleteAutomaticTapeCreationPolicyOutput::fromJson(QString jsonString) {
...
void OAIDeleteAutomaticTapeCreationPolicyOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteAutomaticTapeCreationPolicyOutput::asJson() const {
...
QJsonObject OAIDeleteAutomaticTapeCreationPolicyOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteAutomaticTapeCreationPolicyOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDeleteAutomaticTapeCreationPolicyOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDeleteAutomaticTapeCreationPolicyOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDeleteAutomaticTapeCreationPolicyOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDeleteAutomaticTapeCreationPolicyOutput::isSet() const {
...
bool OAIDeleteAutomaticTapeCreationPolicyOutput::isValid() const {
