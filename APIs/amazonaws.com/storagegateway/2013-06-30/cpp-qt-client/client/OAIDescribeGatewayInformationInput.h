...
/*
 * OAIDescribeGatewayInformationInput.h
 *
 * A JSON object containing the ID of the gateway.
 */

#ifndef OAIDescribeGatewayInformationInput_H
#define OAIDescribeGatewayInformationInput_H
...
class OAIDescribeGatewayInformationInput : public OAIObject {
public:
    OAIDescribeGatewayInformationInput();
    OAIDescribeGatewayInformationInput(QString json);
    ~OAIDescribeGatewayInformationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGatewayInformationInput)

#endif // OAIDescribeGatewayInformationInput_H
