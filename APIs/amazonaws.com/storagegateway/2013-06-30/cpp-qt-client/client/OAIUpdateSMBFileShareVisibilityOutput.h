...
/*
 * OAIUpdateSMBFileShareVisibilityOutput.h
 *
 * 
 */

#ifndef OAIUpdateSMBFileShareVisibilityOutput_H
#define OAIUpdateSMBFileShareVisibilityOutput_H
...
class OAIUpdateSMBFileShareVisibilityOutput : public OAIObject {
public:
    OAIUpdateSMBFileShareVisibilityOutput();
    OAIUpdateSMBFileShareVisibilityOutput(QString json);
    ~OAIUpdateSMBFileShareVisibilityOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSMBFileShareVisibilityOutput)

#endif // OAIUpdateSMBFileShareVisibilityOutput_H
