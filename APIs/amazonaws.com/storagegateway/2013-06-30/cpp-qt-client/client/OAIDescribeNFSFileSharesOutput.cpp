...
OAIDescribeNFSFileSharesOutput::OAIDescribeNFSFileSharesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeNFSFileSharesOutput::OAIDescribeNFSFileSharesOutput() {
    this->initializeModel();
}

OAIDescribeNFSFileSharesOutput::~OAIDescribeNFSFileSharesOutput() {}

void OAIDescribeNFSFileSharesOutput::initializeModel() {

    m_nfs_file_share_info_list_isSet = false;
    m_nfs_file_share_info_list_isValid = false;
}

void OAIDescribeNFSFileSharesOutput::fromJson(QString jsonString) {
...
void OAIDescribeNFSFileSharesOutput::fromJsonObject(QJsonObject json) {

    m_nfs_file_share_info_list_isValid = ::OpenAPI::fromJsonValue(m_nfs_file_share_info_list, json[QString("NFSFileShareInfoList")]);
    m_nfs_file_share_info_list_isSet = !json[QString("NFSFileShareInfoList")].isNull() && m_nfs_file_share_info_list_isValid;
}

QString OAIDescribeNFSFileSharesOutput::asJson() const {
...
QJsonObject OAIDescribeNFSFileSharesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_nfs_file_share_info_list.isSet()) {
        obj.insert(QString("NFSFileShareInfoList"), ::OpenAPI::toJsonValue(m_nfs_file_share_info_list));
    }
    return obj;
}

QList OAIDescribeNFSFileSharesOutput::getNfsFileShareInfoList() const {
    return m_nfs_file_share_info_list;
}
void OAIDescribeNFSFileSharesOutput::setNfsFileShareInfoList(const QList &nfs_file_share_info_list) {
    m_nfs_file_share_info_list = nfs_file_share_info_list;
    m_nfs_file_share_info_list_isSet = true;
}

bool OAIDescribeNFSFileSharesOutput::is_nfs_file_share_info_list_Set() const{
    return m_nfs_file_share_info_list_isSet;
}

bool OAIDescribeNFSFileSharesOutput::is_nfs_file_share_info_list_Valid() const{
    return m_nfs_file_share_info_list_isValid;
}

bool OAIDescribeNFSFileSharesOutput::isSet() const {
...
bool OAIDescribeNFSFileSharesOutput::isValid() const {
