...
/*
 * OAIUpdateSMBSecurityStrategyOutput.h
 *
 * 
 */

#ifndef OAIUpdateSMBSecurityStrategyOutput_H
#define OAIUpdateSMBSecurityStrategyOutput_H
...
class OAIUpdateSMBSecurityStrategyOutput : public OAIObject {
public:
    OAIUpdateSMBSecurityStrategyOutput();
    OAIUpdateSMBSecurityStrategyOutput(QString json);
    ~OAIUpdateSMBSecurityStrategyOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSMBSecurityStrategyOutput)

#endif // OAIUpdateSMBSecurityStrategyOutput_H
