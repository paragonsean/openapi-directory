...
OAIUpdateSnapshotScheduleOutput::OAIUpdateSnapshotScheduleOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSnapshotScheduleOutput::OAIUpdateSnapshotScheduleOutput() {
    this->initializeModel();
}

OAIUpdateSnapshotScheduleOutput::~OAIUpdateSnapshotScheduleOutput() {}

void OAIUpdateSnapshotScheduleOutput::initializeModel() {

    m_volume_arn_isSet = false;
    m_volume_arn_isValid = false;
}

void OAIUpdateSnapshotScheduleOutput::fromJson(QString jsonString) {
...
void OAIUpdateSnapshotScheduleOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSnapshotScheduleOutput::asJson() const {
...
QJsonObject OAIUpdateSnapshotScheduleOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSnapshotScheduleOutput::getVolumeArn() const {
    return m_volume_arn;
}
void OAIUpdateSnapshotScheduleOutput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAIUpdateSnapshotScheduleOutput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAIUpdateSnapshotScheduleOutput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

bool OAIUpdateSnapshotScheduleOutput::isSet() const {
...
bool OAIUpdateSnapshotScheduleOutput::isValid() const {
