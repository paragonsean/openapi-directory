...
/*
 * OAIListFileSystemAssociationsOutput.h
 *
 * 
 */

#ifndef OAIListFileSystemAssociationsOutput_H
#define OAIListFileSystemAssociationsOutput_H
...
class OAIListFileSystemAssociationsOutput : public OAIObject {
public:
    OAIListFileSystemAssociationsOutput();
    OAIListFileSystemAssociationsOutput(QString json);
    ~OAIListFileSystemAssociationsOutput() override;
    ...
    QList getFileSystemAssociationSummaryList() const;
    void setFileSystemAssociationSummaryList(const QList &file_system_association_summary_list);
    bool is_file_system_association_summary_list_Set() const;
    bool is_file_system_association_summary_list_Valid() const;
...
private:
    ...
    QList m_file_system_association_summary_list;
    bool m_file_system_association_summary_list_isSet;
    bool m_file_system_association_summary_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListFileSystemAssociationsOutput)

#endif // OAIListFileSystemAssociationsOutput_H
