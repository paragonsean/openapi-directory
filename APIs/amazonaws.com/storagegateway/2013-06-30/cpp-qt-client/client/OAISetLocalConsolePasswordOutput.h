...
/*
 * OAISetLocalConsolePasswordOutput.h
 *
 * 
 */

#ifndef OAISetLocalConsolePasswordOutput_H
#define OAISetLocalConsolePasswordOutput_H
...
class OAISetLocalConsolePasswordOutput : public OAIObject {
public:
    OAISetLocalConsolePasswordOutput();
    OAISetLocalConsolePasswordOutput(QString json);
    ~OAISetLocalConsolePasswordOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetLocalConsolePasswordOutput)

#endif // OAISetLocalConsolePasswordOutput_H
