...
/*
 * OAICreateCachediSCSIVolumeOutput.h
 *
 * 
 */

#ifndef OAICreateCachediSCSIVolumeOutput_H
#define OAICreateCachediSCSIVolumeOutput_H
...
class OAICreateCachediSCSIVolumeOutput : public OAIObject {
public:
    OAICreateCachediSCSIVolumeOutput();
    OAICreateCachediSCSIVolumeOutput(QString json);
    ~OAICreateCachediSCSIVolumeOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCachediSCSIVolumeOutput)

#endif // OAICreateCachediSCSIVolumeOutput_H
