...
OAIUpdateBandwidthRateLimitScheduleInput::OAIUpdateBandwidthRateLimitScheduleInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateBandwidthRateLimitScheduleInput::OAIUpdateBandwidthRateLimitScheduleInput() {
    this->initializeModel();
}

OAIUpdateBandwidthRateLimitScheduleInput::~OAIUpdateBandwidthRateLimitScheduleInput() {}

void OAIUpdateBandwidthRateLimitScheduleInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;

    m_bandwidth_rate_limit_intervals_isSet = false;
    m_bandwidth_rate_limit_intervals_isValid = false;
}

void OAIUpdateBandwidthRateLimitScheduleInput::fromJson(QString jsonString) {
...
void OAIUpdateBandwidthRateLimitScheduleInput::fromJsonObject(QJsonObject json) {
    ...
    m_bandwidth_rate_limit_intervals_isValid = ::OpenAPI::fromJsonValue(m_bandwidth_rate_limit_intervals, json[QString("BandwidthRateLimitIntervals")]);
    m_bandwidth_rate_limit_intervals_isSet = !json[QString("BandwidthRateLimitIntervals")].isNull() && m_bandwidth_rate_limit_intervals_isValid;
}

QString OAIUpdateBandwidthRateLimitScheduleInput::asJson() const {
...
QJsonObject OAIUpdateBandwidthRateLimitScheduleInput::asJsonObject() const {
    QJsonObject obj;
    if (m_gateway_arn_isSet) {
        obj.insert(QString("GatewayARN"), ::OpenAPI::toJsonValue(m_gateway_arn));
    }
    if (m_bandwidth_rate_limit_intervals.isSet()) {
        obj.insert(QString("BandwidthRateLimitIntervals"), ::OpenAPI::toJsonValue(m_bandwidth_rate_limit_intervals));
    }
    return obj;
}

QString OAIUpdateBandwidthRateLimitScheduleInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateBandwidthRateLimitScheduleInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateBandwidthRateLimitScheduleInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateBandwidthRateLimitScheduleInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QList OAIUpdateBandwidthRateLimitScheduleInput::getBandwidthRateLimitIntervals() const {
    return m_bandwidth_rate_limit_intervals;
}
void OAIUpdateBandwidthRateLimitScheduleInput::setBandwidthRateLimitIntervals(const QList &bandwidth_rate_limit_intervals) {
    m_bandwidth_rate_limit_intervals = bandwidth_rate_limit_intervals;
    m_bandwidth_rate_limit_intervals_isSet = true;
}

bool OAIUpdateBandwidthRateLimitScheduleInput::is_bandwidth_rate_limit_intervals_Set() const{
    return m_bandwidth_rate_limit_intervals_isSet;
}

bool OAIUpdateBandwidthRateLimitScheduleInput::is_bandwidth_rate_limit_intervals_Valid() const{
    return m_bandwidth_rate_limit_intervals_isValid;
}

bool OAIUpdateBandwidthRateLimitScheduleInput::isSet() const {
...
bool OAIUpdateBandwidthRateLimitScheduleInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_gateway_arn_isValid && m_bandwidth_rate_limit_intervals_isValid && true;
}
