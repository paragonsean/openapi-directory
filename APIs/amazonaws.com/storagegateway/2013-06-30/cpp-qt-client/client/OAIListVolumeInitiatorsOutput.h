...
/*
 * OAIListVolumeInitiatorsOutput.h
 *
 * ListVolumeInitiatorsOutput
 */

#ifndef OAIListVolumeInitiatorsOutput_H
#define OAIListVolumeInitiatorsOutput_H
...
class OAIListVolumeInitiatorsOutput : public OAIObject {
public:
    OAIListVolumeInitiatorsOutput();
    OAIListVolumeInitiatorsOutput(QString json);
    ~OAIListVolumeInitiatorsOutput() override;
    ...
    QList getInitiators() const;
    void setInitiators(const QList &initiators);
    bool is_initiators_Set() const;
    bool is_initiators_Valid() const;
...
private:
    ...
    QList m_initiators;
    bool m_initiators_isSet;
    bool m_initiators_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListVolumeInitiatorsOutput)

#endif // OAIListVolumeInitiatorsOutput_H
