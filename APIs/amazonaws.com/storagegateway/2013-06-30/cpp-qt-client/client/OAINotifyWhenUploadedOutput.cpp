...
OAINotifyWhenUploadedOutput::OAINotifyWhenUploadedOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotifyWhenUploadedOutput::OAINotifyWhenUploadedOutput() {
    this->initializeModel();
}

OAINotifyWhenUploadedOutput::~OAINotifyWhenUploadedOutput() {}

void OAINotifyWhenUploadedOutput::initializeModel() {
...
void OAINotifyWhenUploadedOutput::fromJson(QString jsonString) {
...
void OAINotifyWhenUploadedOutput::fromJsonObject(QJsonObject json) {
...
QString OAINotifyWhenUploadedOutput::asJson() const {
...
QJsonObject OAINotifyWhenUploadedOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAINotifyWhenUploadedOutput::getFileShareArn() const {
    return m_file_share_arn;
}
void OAINotifyWhenUploadedOutput::setFileShareArn(const QString &file_share_arn) {
    m_file_share_arn = file_share_arn;
    m_file_share_arn_isSet = true;
}

bool OAINotifyWhenUploadedOutput::is_file_share_arn_Set() const{
    return m_file_share_arn_isSet;
}

bool OAINotifyWhenUploadedOutput::is_file_share_arn_Valid() const{
    return m_file_share_arn_isValid;
}

QString OAINotifyWhenUploadedOutput::getNotificationId() const {
    return m_notification_id;
}
void OAINotifyWhenUploadedOutput::setNotificationId(const QString &notification_id) {
    m_notification_id = notification_id;
    m_notification_id_isSet = true;
}

bool OAINotifyWhenUploadedOutput::is_notification_id_Set() const{
    return m_notification_id_isSet;
}

bool OAINotifyWhenUploadedOutput::is_notification_id_Valid() const{
    return m_notification_id_isValid;
}

bool OAINotifyWhenUploadedOutput::isSet() const {
...
bool OAINotifyWhenUploadedOutput::isValid() const {
