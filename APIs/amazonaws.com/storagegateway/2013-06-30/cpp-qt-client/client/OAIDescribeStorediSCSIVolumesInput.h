...
/*
 * OAIDescribeStorediSCSIVolumesInput.h
 *
 * A JSON object containing a list of &lt;a&gt;DescribeStorediSCSIVolumesInput$VolumeARNs&lt;/a&gt;.
 */

#ifndef OAIDescribeStorediSCSIVolumesInput_H
#define OAIDescribeStorediSCSIVolumesInput_H
...
class OAIDescribeStorediSCSIVolumesInput : public OAIObject {
public:
    OAIDescribeStorediSCSIVolumesInput();
    OAIDescribeStorediSCSIVolumesInput(QString json);
    ~OAIDescribeStorediSCSIVolumesInput() override;
    ...
    QList getVolumeArns() const;
    void setVolumeArns(const QList &volume_arns);
    bool is_volume_arns_Set() const;
    bool is_volume_arns_Valid() const;
...
private:
    ...
    QList m_volume_arns;
    bool m_volume_arns_isSet;
    bool m_volume_arns_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStorediSCSIVolumesInput)

#endif // OAIDescribeStorediSCSIVolumesInput_H
