...
/*
 * OAIUpdateAutomaticTapeCreationPolicyOutput.h
 *
 * 
 */

#ifndef OAIUpdateAutomaticTapeCreationPolicyOutput_H
#define OAIUpdateAutomaticTapeCreationPolicyOutput_H
...
class OAIUpdateAutomaticTapeCreationPolicyOutput : public OAIObject {
public:
    OAIUpdateAutomaticTapeCreationPolicyOutput();
    OAIUpdateAutomaticTapeCreationPolicyOutput(QString json);
    ~OAIUpdateAutomaticTapeCreationPolicyOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAutomaticTapeCreationPolicyOutput)

#endif // OAIUpdateAutomaticTapeCreationPolicyOutput_H
