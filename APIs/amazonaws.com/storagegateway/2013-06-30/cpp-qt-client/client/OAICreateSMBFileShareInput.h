...
/*
 * OAICreateSMBFileShareInput.h
 *
 * CreateSMBFileShareInput
 */

#ifndef OAICreateSMBFileShareInput_H
#define OAICreateSMBFileShareInput_H
...
class OAICreateSMBFileShareInput : public OAIObject {
public:
    OAICreateSMBFileShareInput();
    OAICreateSMBFileShareInput(QString json);
    ~OAICreateSMBFileShareInput() override;
    ...
    QString getVpcEndpointDnsName() const;
    void setVpcEndpointDnsName(const QString &vpc_endpoint_dns_name);
    bool is_vpc_endpoint_dns_name_Set() const;
    bool is_vpc_endpoint_dns_name_Valid() const;
...
private:
    ...
    QString m_vpc_endpoint_dns_name;
    bool m_vpc_endpoint_dns_name_isSet;
    bool m_vpc_endpoint_dns_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSMBFileShareInput)

#endif // OAICreateSMBFileShareInput_H
