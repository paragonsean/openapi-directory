...
OAIDescribeCachediSCSIVolumesInput::OAIDescribeCachediSCSIVolumesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCachediSCSIVolumesInput::OAIDescribeCachediSCSIVolumesInput() {
    this->initializeModel();
}

OAIDescribeCachediSCSIVolumesInput::~OAIDescribeCachediSCSIVolumesInput() {}

void OAIDescribeCachediSCSIVolumesInput::initializeModel() {

    m_volume_arns_isSet = false;
    m_volume_arns_isValid = false;
}

void OAIDescribeCachediSCSIVolumesInput::fromJson(QString jsonString) {
...
void OAIDescribeCachediSCSIVolumesInput::fromJsonObject(QJsonObject json) {

    m_volume_arns_isValid = ::OpenAPI::fromJsonValue(m_volume_arns, json[QString("VolumeARNs")]);
    m_volume_arns_isSet = !json[QString("VolumeARNs")].isNull() && m_volume_arns_isValid;
}

QString OAIDescribeCachediSCSIVolumesInput::asJson() const {
...
QJsonObject OAIDescribeCachediSCSIVolumesInput::asJsonObject() const {
    QJsonObject obj;
    if (m_volume_arns.isSet()) {
        obj.insert(QString("VolumeARNs"), ::OpenAPI::toJsonValue(m_volume_arns));
    }
    return obj;
}

QList OAIDescribeCachediSCSIVolumesInput::getVolumeArns() const {
    return m_volume_arns;
}
void OAIDescribeCachediSCSIVolumesInput::setVolumeArns(const QList &volume_arns) {
    m_volume_arns = volume_arns;
    m_volume_arns_isSet = true;
}

bool OAIDescribeCachediSCSIVolumesInput::is_volume_arns_Set() const{
    return m_volume_arns_isSet;
}

bool OAIDescribeCachediSCSIVolumesInput::is_volume_arns_Valid() const{
    return m_volume_arns_isValid;
}

bool OAIDescribeCachediSCSIVolumesInput::isSet() const {
...
bool OAIDescribeCachediSCSIVolumesInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_volume_arns_isValid && true;
}
