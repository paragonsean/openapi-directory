...
OAIDescribeSMBSettingsInput::OAIDescribeSMBSettingsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeSMBSettingsInput::OAIDescribeSMBSettingsInput() {
    this->initializeModel();
}

OAIDescribeSMBSettingsInput::~OAIDescribeSMBSettingsInput() {}

void OAIDescribeSMBSettingsInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDescribeSMBSettingsInput::fromJson(QString jsonString) {
...
void OAIDescribeSMBSettingsInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeSMBSettingsInput::asJson() const {
...
QJsonObject OAIDescribeSMBSettingsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeSMBSettingsInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeSMBSettingsInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeSMBSettingsInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeSMBSettingsInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDescribeSMBSettingsInput::isSet() const {
...
bool OAIDescribeSMBSettingsInput::isValid() const {
