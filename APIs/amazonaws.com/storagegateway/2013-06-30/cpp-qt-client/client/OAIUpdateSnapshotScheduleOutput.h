...
/*
 * OAIUpdateSnapshotScheduleOutput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the updated storage volume.
 */

#ifndef OAIUpdateSnapshotScheduleOutput_H
#define OAIUpdateSnapshotScheduleOutput_H
...
class OAIUpdateSnapshotScheduleOutput : public OAIObject {
public:
    OAIUpdateSnapshotScheduleOutput();
    OAIUpdateSnapshotScheduleOutput(QString json);
    ~OAIUpdateSnapshotScheduleOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSnapshotScheduleOutput)

#endif // OAIUpdateSnapshotScheduleOutput_H
