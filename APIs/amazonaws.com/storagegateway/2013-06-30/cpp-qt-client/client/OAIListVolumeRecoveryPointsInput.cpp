...
OAIListVolumeRecoveryPointsInput::OAIListVolumeRecoveryPointsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListVolumeRecoveryPointsInput::OAIListVolumeRecoveryPointsInput() {
    this->initializeModel();
}

OAIListVolumeRecoveryPointsInput::~OAIListVolumeRecoveryPointsInput() {}

void OAIListVolumeRecoveryPointsInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIListVolumeRecoveryPointsInput::fromJson(QString jsonString) {
...
void OAIListVolumeRecoveryPointsInput::fromJsonObject(QJsonObject json) {
...
QString OAIListVolumeRecoveryPointsInput::asJson() const {
...
QJsonObject OAIListVolumeRecoveryPointsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListVolumeRecoveryPointsInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIListVolumeRecoveryPointsInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIListVolumeRecoveryPointsInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIListVolumeRecoveryPointsInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIListVolumeRecoveryPointsInput::isSet() const {
...
bool OAIListVolumeRecoveryPointsInput::isValid() const {
