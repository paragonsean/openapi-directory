...
OAIDescribeGatewayInformationInput::OAIDescribeGatewayInformationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeGatewayInformationInput::OAIDescribeGatewayInformationInput() {
    this->initializeModel();
}

OAIDescribeGatewayInformationInput::~OAIDescribeGatewayInformationInput() {}

void OAIDescribeGatewayInformationInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDescribeGatewayInformationInput::fromJson(QString jsonString) {
...
void OAIDescribeGatewayInformationInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeGatewayInformationInput::asJson() const {
...
QJsonObject OAIDescribeGatewayInformationInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeGatewayInformationInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeGatewayInformationInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeGatewayInformationInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeGatewayInformationInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDescribeGatewayInformationInput::isSet() const {
...
bool OAIDescribeGatewayInformationInput::isValid() const {
