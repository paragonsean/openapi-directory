...
/*
 * OAICreateSnapshotFromVolumeRecoveryPointOutput.h
 *
 * 
 */

#ifndef OAICreateSnapshotFromVolumeRecoveryPointOutput_H
#define OAICreateSnapshotFromVolumeRecoveryPointOutput_H
...
class OAICreateSnapshotFromVolumeRecoveryPointOutput : public OAIObject {
public:
    OAICreateSnapshotFromVolumeRecoveryPointOutput();
    OAICreateSnapshotFromVolumeRecoveryPointOutput(QString json);
    ~OAICreateSnapshotFromVolumeRecoveryPointOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSnapshotFromVolumeRecoveryPointOutput)

#endif // OAICreateSnapshotFromVolumeRecoveryPointOutput_H
