...
/*
 * OAIAssignTapePoolOutput.h
 *
 * 
 */

#ifndef OAIAssignTapePoolOutput_H
#define OAIAssignTapePoolOutput_H
...
class OAIAssignTapePoolOutput : public OAIObject {
public:
    OAIAssignTapePoolOutput();
    OAIAssignTapePoolOutput(QString json);
    ~OAIAssignTapePoolOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssignTapePoolOutput)

#endif // OAIAssignTapePoolOutput_H
