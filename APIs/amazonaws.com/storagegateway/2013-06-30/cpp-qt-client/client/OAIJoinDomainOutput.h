...
/*
 * OAIJoinDomainOutput.h
 *
 * JoinDomainOutput
 */

#ifndef OAIJoinDomainOutput_H
#define OAIJoinDomainOutput_H
...
class OAIJoinDomainOutput : public OAIObject {
public:
    OAIJoinDomainOutput();
    OAIJoinDomainOutput(QString json);
    ~OAIJoinDomainOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJoinDomainOutput)

#endif // OAIJoinDomainOutput_H
