...
OAIDescribeStorediSCSIVolumesInput::OAIDescribeStorediSCSIVolumesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeStorediSCSIVolumesInput::OAIDescribeStorediSCSIVolumesInput() {
    this->initializeModel();
}

OAIDescribeStorediSCSIVolumesInput::~OAIDescribeStorediSCSIVolumesInput() {}

void OAIDescribeStorediSCSIVolumesInput::initializeModel() {

    m_volume_arns_isSet = false;
    m_volume_arns_isValid = false;
}

void OAIDescribeStorediSCSIVolumesInput::fromJson(QString jsonString) {
...
void OAIDescribeStorediSCSIVolumesInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeStorediSCSIVolumesInput::asJson() const {
...
QJsonObject OAIDescribeStorediSCSIVolumesInput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeStorediSCSIVolumesInput::getVolumeArns() const {
    return m_volume_arns;
}
void OAIDescribeStorediSCSIVolumesInput::setVolumeArns(const QList &volume_arns) {
    m_volume_arns = volume_arns;
    m_volume_arns_isSet = true;
}

bool OAIDescribeStorediSCSIVolumesInput::is_volume_arns_Set() const{
    return m_volume_arns_isSet;
}

bool OAIDescribeStorediSCSIVolumesInput::is_volume_arns_Valid() const{
    return m_volume_arns_isValid;
}

bool OAIDescribeStorediSCSIVolumesInput::isSet() const {
...
bool OAIDescribeStorediSCSIVolumesInput::isValid() const {
