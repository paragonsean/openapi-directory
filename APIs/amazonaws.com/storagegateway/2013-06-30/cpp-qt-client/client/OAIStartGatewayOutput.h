...
class OAIStartGatewayOutput : public OAIObject {
public:
    OAIStartGatewayOutput();
    OAIStartGatewayOutput(QString json);
    ~OAIStartGatewayOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartGatewayOutput)

#endif // OAIStartGatewayOutput_H
