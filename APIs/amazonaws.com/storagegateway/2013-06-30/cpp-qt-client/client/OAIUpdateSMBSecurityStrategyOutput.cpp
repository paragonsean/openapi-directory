...
OAIUpdateSMBSecurityStrategyOutput::OAIUpdateSMBSecurityStrategyOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSMBSecurityStrategyOutput::OAIUpdateSMBSecurityStrategyOutput() {
    this->initializeModel();
}

OAIUpdateSMBSecurityStrategyOutput::~OAIUpdateSMBSecurityStrategyOutput() {}

void OAIUpdateSMBSecurityStrategyOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIUpdateSMBSecurityStrategyOutput::fromJson(QString jsonString) {
...
void OAIUpdateSMBSecurityStrategyOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSMBSecurityStrategyOutput::asJson() const {
...
QJsonObject OAIUpdateSMBSecurityStrategyOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSMBSecurityStrategyOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateSMBSecurityStrategyOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateSMBSecurityStrategyOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateSMBSecurityStrategyOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIUpdateSMBSecurityStrategyOutput::isSet() const {
...
bool OAIUpdateSMBSecurityStrategyOutput::isValid() const {
