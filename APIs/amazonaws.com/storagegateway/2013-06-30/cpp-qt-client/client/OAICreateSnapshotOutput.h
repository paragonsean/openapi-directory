...
/*
 * OAICreateSnapshotOutput.h
 *
 * A JSON object containing the following fields:
 */

#ifndef OAICreateSnapshotOutput_H
#define OAICreateSnapshotOutput_H
...
class OAICreateSnapshotOutput : public OAIObject {
public:
    OAICreateSnapshotOutput();
    OAICreateSnapshotOutput(QString json);
    ~OAICreateSnapshotOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSnapshotOutput)

#endif // OAICreateSnapshotOutput_H
