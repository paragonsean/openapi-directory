...
/*
 * OAIDescribeUploadBufferInput.h
 *
 * 
 */

#ifndef OAIDescribeUploadBufferInput_H
#define OAIDescribeUploadBufferInput_H
...
class OAIDescribeUploadBufferInput : public OAIObject {
public:
    OAIDescribeUploadBufferInput();
    OAIDescribeUploadBufferInput(QString json);
    ~OAIDescribeUploadBufferInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUploadBufferInput)

#endif // OAIDescribeUploadBufferInput_H
