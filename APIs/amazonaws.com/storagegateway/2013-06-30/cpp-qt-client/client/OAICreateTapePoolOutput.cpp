...
OAICreateTapePoolOutput::OAICreateTapePoolOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTapePoolOutput::OAICreateTapePoolOutput() {
    this->initializeModel();
}

OAICreateTapePoolOutput::~OAICreateTapePoolOutput() {}

void OAICreateTapePoolOutput::initializeModel() {

    m_pool_arn_isSet = false;
    m_pool_arn_isValid = false;
}

void OAICreateTapePoolOutput::fromJson(QString jsonString) {
...
void OAICreateTapePoolOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateTapePoolOutput::asJson() const {
...
QJsonObject OAICreateTapePoolOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_pool_arn_isSet) {
...
QString OAICreateTapePoolOutput::getPoolArn() const {
    return m_pool_arn;
}
void OAICreateTapePoolOutput::setPoolArn(const QString &pool_arn) {
    m_pool_arn = pool_arn;
    m_pool_arn_isSet = true;
}

bool OAICreateTapePoolOutput::is_pool_arn_Set() const{
    return m_pool_arn_isSet;
}

bool OAICreateTapePoolOutput::is_pool_arn_Valid() const{
    return m_pool_arn_isValid;
}

bool OAICreateTapePoolOutput::isSet() const {
...
bool OAICreateTapePoolOutput::isValid() const {
