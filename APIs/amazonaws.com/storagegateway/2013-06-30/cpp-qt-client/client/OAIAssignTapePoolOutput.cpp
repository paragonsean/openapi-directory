...
OAIAssignTapePoolOutput::OAIAssignTapePoolOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssignTapePoolOutput::OAIAssignTapePoolOutput() {
    this->initializeModel();
}

OAIAssignTapePoolOutput::~OAIAssignTapePoolOutput() {}

void OAIAssignTapePoolOutput::initializeModel() {

    m_tape_arn_isSet = false;
    m_tape_arn_isValid = false;
}

void OAIAssignTapePoolOutput::fromJson(QString jsonString) {
...
void OAIAssignTapePoolOutput::fromJsonObject(QJsonObject json) {
...
QString OAIAssignTapePoolOutput::asJson() const {
...
QJsonObject OAIAssignTapePoolOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_arn_isSet) {
...
QString OAIAssignTapePoolOutput::getTapeArn() const {
    return m_tape_arn;
}
void OAIAssignTapePoolOutput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAIAssignTapePoolOutput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAIAssignTapePoolOutput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

bool OAIAssignTapePoolOutput::isSet() const {
...
bool OAIAssignTapePoolOutput::isValid() const {
