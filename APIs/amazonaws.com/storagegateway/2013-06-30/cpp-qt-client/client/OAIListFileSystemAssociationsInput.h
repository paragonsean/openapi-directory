...
/*
 * OAIListFileSystemAssociationsInput.h
 *
 * 
 */

#ifndef OAIListFileSystemAssociationsInput_H
#define OAIListFileSystemAssociationsInput_H
...
class OAIListFileSystemAssociationsInput : public OAIObject {
public:
    OAIListFileSystemAssociationsInput();
    OAIListFileSystemAssociationsInput(QString json);
    ~OAIListFileSystemAssociationsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFileSystemAssociationsInput)

#endif // OAIListFileSystemAssociationsInput_H
