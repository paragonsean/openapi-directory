...
OAIDescribeAvailabilityMonitorTestOutput::OAIDescribeAvailabilityMonitorTestOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAvailabilityMonitorTestOutput::OAIDescribeAvailabilityMonitorTestOutput() {
    this->initializeModel();
}

OAIDescribeAvailabilityMonitorTestOutput::~OAIDescribeAvailabilityMonitorTestOutput() {}

void OAIDescribeAvailabilityMonitorTestOutput::initializeModel() {
...
void OAIDescribeAvailabilityMonitorTestOutput::fromJson(QString jsonString) {
...
void OAIDescribeAvailabilityMonitorTestOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeAvailabilityMonitorTestOutput::asJson() const {
...
QJsonObject OAIDescribeAvailabilityMonitorTestOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeAvailabilityMonitorTestOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeAvailabilityMonitorTestOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeAvailabilityMonitorTestOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeAvailabilityMonitorTestOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

OAIAvailabilityMonitorTestStatus OAIDescribeAvailabilityMonitorTestOutput::getStatus() const {
    return m_status;
}
void OAIDescribeAvailabilityMonitorTestOutput::setStatus(const OAIAvailabilityMonitorTestStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDescribeAvailabilityMonitorTestOutput::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDescribeAvailabilityMonitorTestOutput::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIDescribeAvailabilityMonitorTestOutput::getStartTime() const {
    return m_start_time;
}
void OAIDescribeAvailabilityMonitorTestOutput::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIDescribeAvailabilityMonitorTestOutput::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIDescribeAvailabilityMonitorTestOutput::is_start_time_Valid() const{
    return m_start_time_isValid;
}

bool OAIDescribeAvailabilityMonitorTestOutput::isSet() const {
...
bool OAIDescribeAvailabilityMonitorTestOutput::isValid() const {
