...
/*
 * OAIDescribeSMBSettingsOutput_SMBLocalGroups.h
 *
 * 
 */

#ifndef OAIDescribeSMBSettingsOutput_SMBLocalGroups_H
#define OAIDescribeSMBSettingsOutput_SMBLocalGroups_H
...
class OAIDescribeSMBSettingsOutput_SMBLocalGroups : public OAIObject {
public:
    OAIDescribeSMBSettingsOutput_SMBLocalGroups();
    OAIDescribeSMBSettingsOutput_SMBLocalGroups(QString json);
    ~OAIDescribeSMBSettingsOutput_SMBLocalGroups() override;
    ...
    QList getGatewayAdmins() const;
    void setGatewayAdmins(const QList &gateway_admins);
    bool is_gateway_admins_Set() const;
    bool is_gateway_admins_Valid() const;
...
private:
    ...
    QList m_gateway_admins;
    bool m_gateway_admins_isSet;
    bool m_gateway_admins_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSMBSettingsOutput_SMBLocalGroups)

#endif // OAIDescribeSMBSettingsOutput_SMBLocalGroups_H
