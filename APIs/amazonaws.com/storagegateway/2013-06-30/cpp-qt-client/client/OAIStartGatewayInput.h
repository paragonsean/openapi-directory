...
/*
 * OAIStartGatewayInput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway to start.
 */

#ifndef OAIStartGatewayInput_H
#define OAIStartGatewayInput_H
...
class OAIStartGatewayInput : public OAIObject {
public:
    OAIStartGatewayInput();
    OAIStartGatewayInput(QString json);
    ~OAIStartGatewayInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartGatewayInput)

#endif // OAIStartGatewayInput_H
