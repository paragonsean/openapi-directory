...
OAIListVolumeInitiatorsOutput::OAIListVolumeInitiatorsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListVolumeInitiatorsOutput::OAIListVolumeInitiatorsOutput() {
    this->initializeModel();
}

OAIListVolumeInitiatorsOutput::~OAIListVolumeInitiatorsOutput() {}

void OAIListVolumeInitiatorsOutput::initializeModel() {

    m_initiators_isSet = false;
    m_initiators_isValid = false;
}

void OAIListVolumeInitiatorsOutput::fromJson(QString jsonString) {
...
void OAIListVolumeInitiatorsOutput::fromJsonObject(QJsonObject json) {

    m_initiators_isValid = ::OpenAPI::fromJsonValue(m_initiators, json[QString("Initiators")]);
    m_initiators_isSet = !json[QString("Initiators")].isNull() && m_initiators_isValid;
}

QString OAIListVolumeInitiatorsOutput::asJson() const {
...
QJsonObject OAIListVolumeInitiatorsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_initiators.isSet()) {
        obj.insert(QString("Initiators"), ::OpenAPI::toJsonValue(m_initiators));
    }
    return obj;
}

QList OAIListVolumeInitiatorsOutput::getInitiators() const {
    return m_initiators;
}
void OAIListVolumeInitiatorsOutput::setInitiators(const QList &initiators) {
    m_initiators = initiators;
    m_initiators_isSet = true;
}

bool OAIListVolumeInitiatorsOutput::is_initiators_Set() const{
    return m_initiators_isSet;
}

bool OAIListVolumeInitiatorsOutput::is_initiators_Valid() const{
    return m_initiators_isValid;
}

bool OAIListVolumeInitiatorsOutput::isSet() const {
...
bool OAIListVolumeInitiatorsOutput::isValid() const {
