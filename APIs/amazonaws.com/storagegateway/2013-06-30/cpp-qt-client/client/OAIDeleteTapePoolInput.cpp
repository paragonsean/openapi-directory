...
OAIDeleteTapePoolInput::OAIDeleteTapePoolInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteTapePoolInput::OAIDeleteTapePoolInput() {
    this->initializeModel();
}

OAIDeleteTapePoolInput::~OAIDeleteTapePoolInput() {}

void OAIDeleteTapePoolInput::initializeModel() {

    m_pool_arn_isSet = false;
    m_pool_arn_isValid = false;
}

void OAIDeleteTapePoolInput::fromJson(QString jsonString) {
...
void OAIDeleteTapePoolInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteTapePoolInput::asJson() const {
...
QJsonObject OAIDeleteTapePoolInput::asJsonObject() const {
    QJsonObject obj;
    if (m_pool_arn_isSet) {
...
QString OAIDeleteTapePoolInput::getPoolArn() const {
    return m_pool_arn;
}
void OAIDeleteTapePoolInput::setPoolArn(const QString &pool_arn) {
    m_pool_arn = pool_arn;
    m_pool_arn_isSet = true;
}

bool OAIDeleteTapePoolInput::is_pool_arn_Set() const{
    return m_pool_arn_isSet;
}

bool OAIDeleteTapePoolInput::is_pool_arn_Valid() const{
    return m_pool_arn_isValid;
}

bool OAIDeleteTapePoolInput::isSet() const {
...
bool OAIDeleteTapePoolInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pool_arn_isValid && true;
}
