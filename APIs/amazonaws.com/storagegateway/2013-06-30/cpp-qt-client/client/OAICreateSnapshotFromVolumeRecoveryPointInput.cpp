...
OAICreateSnapshotFromVolumeRecoveryPointInput::OAICreateSnapshotFromVolumeRecoveryPointInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSnapshotFromVolumeRecoveryPointInput::OAICreateSnapshotFromVolumeRecoveryPointInput() {
    this->initializeModel();
}

OAICreateSnapshotFromVolumeRecoveryPointInput::~OAICreateSnapshotFromVolumeRecoveryPointInput() {}

void OAICreateSnapshotFromVolumeRecoveryPointInput::initializeModel() {
...
void OAICreateSnapshotFromVolumeRecoveryPointInput::fromJson(QString jsonString) {
...
void OAICreateSnapshotFromVolumeRecoveryPointInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateSnapshotFromVolumeRecoveryPointInput::asJson() const {
...
QJsonObject OAICreateSnapshotFromVolumeRecoveryPointInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSnapshotFromVolumeRecoveryPointInput::getVolumeArn() const {
    return m_volume_arn;
}
void OAICreateSnapshotFromVolumeRecoveryPointInput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAICreateSnapshotFromVolumeRecoveryPointInput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAICreateSnapshotFromVolumeRecoveryPointInput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

QString OAICreateSnapshotFromVolumeRecoveryPointInput::getSnapshotDescription() const {
    return m_snapshot_description;
}
void OAICreateSnapshotFromVolumeRecoveryPointInput::setSnapshotDescription(const QString &snapshot_description) {
    m_snapshot_description = snapshot_description;
    m_snapshot_description_isSet = true;
}

bool OAICreateSnapshotFromVolumeRecoveryPointInput::is_snapshot_description_Set() const{
    return m_snapshot_description_isSet;
}

bool OAICreateSnapshotFromVolumeRecoveryPointInput::is_snapshot_description_Valid() const{
    return m_snapshot_description_isValid;
}

QList OAICreateSnapshotFromVolumeRecoveryPointInput::getTags() const {
    return m_tags;
}
void OAICreateSnapshotFromVolumeRecoveryPointInput::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateSnapshotFromVolumeRecoveryPointInput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateSnapshotFromVolumeRecoveryPointInput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateSnapshotFromVolumeRecoveryPointInput::isSet() const {
...
bool OAICreateSnapshotFromVolumeRecoveryPointInput::isValid() const {
