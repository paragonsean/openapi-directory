...
OAIRetrieveTapeRecoveryPointInput::OAIRetrieveTapeRecoveryPointInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRetrieveTapeRecoveryPointInput::OAIRetrieveTapeRecoveryPointInput() {
    this->initializeModel();
}

OAIRetrieveTapeRecoveryPointInput::~OAIRetrieveTapeRecoveryPointInput() {}

void OAIRetrieveTapeRecoveryPointInput::initializeModel() {
...
void OAIRetrieveTapeRecoveryPointInput::fromJson(QString jsonString) {
...
void OAIRetrieveTapeRecoveryPointInput::fromJsonObject(QJsonObject json) {
...
QString OAIRetrieveTapeRecoveryPointInput::asJson() const {
...
QJsonObject OAIRetrieveTapeRecoveryPointInput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_arn_isSet) {
...
QString OAIRetrieveTapeRecoveryPointInput::getTapeArn() const {
    return m_tape_arn;
}
void OAIRetrieveTapeRecoveryPointInput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAIRetrieveTapeRecoveryPointInput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAIRetrieveTapeRecoveryPointInput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

QString OAIRetrieveTapeRecoveryPointInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIRetrieveTapeRecoveryPointInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIRetrieveTapeRecoveryPointInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIRetrieveTapeRecoveryPointInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIRetrieveTapeRecoveryPointInput::isSet() const {
...
bool OAIRetrieveTapeRecoveryPointInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_tape_arn_isValid && m_gateway_arn_isValid && true;
}
