...
OAIUpdateBandwidthRateLimitOutput::OAIUpdateBandwidthRateLimitOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateBandwidthRateLimitOutput::OAIUpdateBandwidthRateLimitOutput() {
    this->initializeModel();
}

OAIUpdateBandwidthRateLimitOutput::~OAIUpdateBandwidthRateLimitOutput() {}

void OAIUpdateBandwidthRateLimitOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIUpdateBandwidthRateLimitOutput::fromJson(QString jsonString) {
...
void OAIUpdateBandwidthRateLimitOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateBandwidthRateLimitOutput::asJson() const {
...
QJsonObject OAIUpdateBandwidthRateLimitOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateBandwidthRateLimitOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateBandwidthRateLimitOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateBandwidthRateLimitOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateBandwidthRateLimitOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIUpdateBandwidthRateLimitOutput::isSet() const {
...
bool OAIUpdateBandwidthRateLimitOutput::isValid() const {
