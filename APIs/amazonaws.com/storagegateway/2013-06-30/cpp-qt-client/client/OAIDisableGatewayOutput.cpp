...
OAIDisableGatewayOutput::OAIDisableGatewayOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisableGatewayOutput::OAIDisableGatewayOutput() {
    this->initializeModel();
}

OAIDisableGatewayOutput::~OAIDisableGatewayOutput() {}

void OAIDisableGatewayOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDisableGatewayOutput::fromJson(QString jsonString) {
...
void OAIDisableGatewayOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDisableGatewayOutput::asJson() const {
...
QJsonObject OAIDisableGatewayOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisableGatewayOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDisableGatewayOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDisableGatewayOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDisableGatewayOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDisableGatewayOutput::isSet() const {
...
bool OAIDisableGatewayOutput::isValid() const {
