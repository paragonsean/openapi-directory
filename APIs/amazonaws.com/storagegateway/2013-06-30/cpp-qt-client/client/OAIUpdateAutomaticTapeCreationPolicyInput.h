...
/*
 * OAIUpdateAutomaticTapeCreationPolicyInput.h
 *
 * 
 */

#ifndef OAIUpdateAutomaticTapeCreationPolicyInput_H
#define OAIUpdateAutomaticTapeCreationPolicyInput_H
...
class OAIUpdateAutomaticTapeCreationPolicyInput : public OAIObject {
public:
    OAIUpdateAutomaticTapeCreationPolicyInput();
    OAIUpdateAutomaticTapeCreationPolicyInput(QString json);
    ~OAIUpdateAutomaticTapeCreationPolicyInput() override;
    ...
    QList getAutomaticTapeCreationRules() const;
    void setAutomaticTapeCreationRules(const QList &automatic_tape_creation_rules);
    bool is_automatic_tape_creation_rules_Set() const;
    bool is_automatic_tape_creation_rules_Valid() const;
...
private:
    ...
    QList m_automatic_tape_creation_rules;
    bool m_automatic_tape_creation_rules_isSet;
    bool m_automatic_tape_creation_rules_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAutomaticTapeCreationPolicyInput)

#endif // OAIUpdateAutomaticTapeCreationPolicyInput_H
