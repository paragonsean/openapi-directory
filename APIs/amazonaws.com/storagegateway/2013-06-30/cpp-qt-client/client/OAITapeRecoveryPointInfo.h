...
/*
 * OAITapeRecoveryPointInfo.h
 *
 * Describes a recovery point.
 */

#ifndef OAITapeRecoveryPointInfo_H
#define OAITapeRecoveryPointInfo_H
...
class OAITapeRecoveryPointInfo : public OAIObject {
public:
    OAITapeRecoveryPointInfo();
    OAITapeRecoveryPointInfo(QString json);
    ~OAITapeRecoveryPointInfo() override;
    ...
    QDateTime getTapeRecoveryPointTime() const;
    void setTapeRecoveryPointTime(const QDateTime &tape_recovery_point_time);
    bool is_tape_recovery_point_time_Set() const;
    bool is_tape_recovery_point_time_Valid() const;
...
private:
    ...
    QDateTime m_tape_recovery_point_time;
    bool m_tape_recovery_point_time_isSet;
    bool m_tape_recovery_point_time_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITapeRecoveryPointInfo)

#endif // OAITapeRecoveryPointInfo_H
