...
/*
 * OAIDetachVolumeInput.h
 *
 * AttachVolumeInput
 */

#ifndef OAIDetachVolumeInput_H
#define OAIDetachVolumeInput_H
...
class OAIDetachVolumeInput : public OAIObject {
public:
    OAIDetachVolumeInput();
    OAIDetachVolumeInput(QString json);
    ~OAIDetachVolumeInput() override;
    ...
    void setForceDetach(const bool &force_detach);
    bool is_force_detach_Set() const;
    bool is_force_detach_Valid() const;
...
private:
    ...
    bool m_force_detach;
    bool m_force_detach_isSet;
    bool m_force_detach_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDetachVolumeInput)

#endif // OAIDetachVolumeInput_H
