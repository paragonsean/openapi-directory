...
/*
 * OAIHostEnvironment.h
 *
 * 
 */

#ifndef OAIHostEnvironment_H
#define OAIHostEnvironment_H
...
class OAIHostEnvironment : public OAIEnum {
public:
    OAIHostEnvironment();
    OAIHostEnvironment(QString json);
    ~OAIHostEnvironment() override;
    ...
    enum class eOAIHostEnvironment {
    ...
    OAIHostEnvironment::eOAIHostEnvironment getValue() const;
    void setValue(const OAIHostEnvironment::eOAIHostEnvironment& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIHostEnvironment)

#endif // OAIHostEnvironment_H
