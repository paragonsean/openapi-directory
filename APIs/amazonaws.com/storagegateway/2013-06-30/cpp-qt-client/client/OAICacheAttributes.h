...
/*
 * OAICacheAttributes.h
 *
 * The refresh cache information for the file share or FSx file systems.
 */

#ifndef OAICacheAttributes_H
#define OAICacheAttributes_H
...
class OAICacheAttributes : public OAIObject {
public:
    OAICacheAttributes();
    OAICacheAttributes(QString json);
    ~OAICacheAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICacheAttributes)

#endif // OAICacheAttributes_H
