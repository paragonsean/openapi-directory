...
/*
 * OAIDescribeBandwidthRateLimitScheduleOutput.h
 *
 * 
 */

#ifndef OAIDescribeBandwidthRateLimitScheduleOutput_H
#define OAIDescribeBandwidthRateLimitScheduleOutput_H
...
class OAIDescribeBandwidthRateLimitScheduleOutput : public OAIObject {
public:
    OAIDescribeBandwidthRateLimitScheduleOutput();
    OAIDescribeBandwidthRateLimitScheduleOutput(QString json);
    ~OAIDescribeBandwidthRateLimitScheduleOutput() override;
    ...
    QList getBandwidthRateLimitIntervals() const;
    void setBandwidthRateLimitIntervals(const QList &bandwidth_rate_limit_intervals);
    bool is_bandwidth_rate_limit_intervals_Set() const;
    bool is_bandwidth_rate_limit_intervals_Valid() const;
...
private:
    ...
    QList m_bandwidth_rate_limit_intervals;
    bool m_bandwidth_rate_limit_intervals_isSet;
    bool m_bandwidth_rate_limit_intervals_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBandwidthRateLimitScheduleOutput)

#endif // OAIDescribeBandwidthRateLimitScheduleOutput_H
