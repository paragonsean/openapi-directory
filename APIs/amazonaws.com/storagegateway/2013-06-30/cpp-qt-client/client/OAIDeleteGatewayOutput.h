...
/*
 * OAIDeleteGatewayOutput.h
 *
 * A JSON object containing the ID of the deleted gateway.
 */

#ifndef OAIDeleteGatewayOutput_H
#define OAIDeleteGatewayOutput_H
...
class OAIDeleteGatewayOutput : public OAIObject {
public:
    OAIDeleteGatewayOutput();
    OAIDeleteGatewayOutput(QString json);
    ~OAIDeleteGatewayOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteGatewayOutput)

#endif // OAIDeleteGatewayOutput_H
