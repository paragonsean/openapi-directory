...
OAIResetCacheInput::OAIResetCacheInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResetCacheInput::OAIResetCacheInput() {
    this->initializeModel();
}

OAIResetCacheInput::~OAIResetCacheInput() {}

void OAIResetCacheInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIResetCacheInput::fromJson(QString jsonString) {
...
void OAIResetCacheInput::fromJsonObject(QJsonObject json) {
...
QString OAIResetCacheInput::asJson() const {
...
QJsonObject OAIResetCacheInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIResetCacheInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIResetCacheInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIResetCacheInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIResetCacheInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIResetCacheInput::isSet() const {
...
bool OAIResetCacheInput::isValid() const {
