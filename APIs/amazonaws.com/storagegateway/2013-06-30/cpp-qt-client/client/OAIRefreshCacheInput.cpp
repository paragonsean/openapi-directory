...
OAIRefreshCacheInput::OAIRefreshCacheInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRefreshCacheInput::OAIRefreshCacheInput() {
    this->initializeModel();
}

OAIRefreshCacheInput::~OAIRefreshCacheInput() {}

void OAIRefreshCacheInput::initializeModel() {

    m_file_share_arn_isSet = false;
    m_file_share_arn_isValid = false;

    m_folder_list_isSet = false;
    m_folder_list_isValid = false;

    m_recursive_isSet = false;
    m_recursive_isValid = false;
}

void OAIRefreshCacheInput::fromJson(QString jsonString) {
...
void OAIRefreshCacheInput::fromJsonObject(QJsonObject json) {
    ...
    m_folder_list_isValid = ::OpenAPI::fromJsonValue(m_folder_list, json[QString("FolderList")]);
    m_folder_list_isSet = !json[QString("FolderList")].isNull() && m_folder_list_isValid;
...
QString OAIRefreshCacheInput::asJson() const {
...
QJsonObject OAIRefreshCacheInput::asJsonObject() const {
    QJsonObject obj;
    if (m_file_share_arn_isSet) {
        obj.insert(QString("FileShareARN"), ::OpenAPI::toJsonValue(m_file_share_arn));
    }
    if (m_folder_list.isSet()) {
        obj.insert(QString("FolderList"), ::OpenAPI::toJsonValue(m_folder_list));
    }
...
QString OAIRefreshCacheInput::getFileShareArn() const {
    return m_file_share_arn;
}
void OAIRefreshCacheInput::setFileShareArn(const QString &file_share_arn) {
    m_file_share_arn = file_share_arn;
    m_file_share_arn_isSet = true;
}

bool OAIRefreshCacheInput::is_file_share_arn_Set() const{
    return m_file_share_arn_isSet;
}

bool OAIRefreshCacheInput::is_file_share_arn_Valid() const{
    return m_file_share_arn_isValid;
}

QList OAIRefreshCacheInput::getFolderList() const {
    return m_folder_list;
}
void OAIRefreshCacheInput::setFolderList(const QList &folder_list) {
    m_folder_list = folder_list;
    m_folder_list_isSet = true;
}

bool OAIRefreshCacheInput::is_folder_list_Set() const{
    return m_folder_list_isSet;
}

bool OAIRefreshCacheInput::is_folder_list_Valid() const{
    return m_folder_list_isValid;
}

bool OAIRefreshCacheInput::getRecursive() const {
    return m_recursive;
}
void OAIRefreshCacheInput::setRecursive(const bool &recursive) {
    m_recursive = recursive;
    m_recursive_isSet = true;
}

bool OAIRefreshCacheInput::is_recursive_Set() const{
    return m_recursive_isSet;
}

bool OAIRefreshCacheInput::is_recursive_Valid() const{
    return m_recursive_isValid;
}

bool OAIRefreshCacheInput::isSet() const {
...
bool OAIRefreshCacheInput::isValid() const {
