...
OAIUpdateVTLDeviceTypeOutput::OAIUpdateVTLDeviceTypeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateVTLDeviceTypeOutput::OAIUpdateVTLDeviceTypeOutput() {
    this->initializeModel();
}

OAIUpdateVTLDeviceTypeOutput::~OAIUpdateVTLDeviceTypeOutput() {}

void OAIUpdateVTLDeviceTypeOutput::initializeModel() {

    m_vtl_device_arn_isSet = false;
    m_vtl_device_arn_isValid = false;
}

void OAIUpdateVTLDeviceTypeOutput::fromJson(QString jsonString) {
...
void OAIUpdateVTLDeviceTypeOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateVTLDeviceTypeOutput::asJson() const {
...
QJsonObject OAIUpdateVTLDeviceTypeOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateVTLDeviceTypeOutput::getVtlDeviceArn() const {
    return m_vtl_device_arn;
}
void OAIUpdateVTLDeviceTypeOutput::setVtlDeviceArn(const QString &vtl_device_arn) {
    m_vtl_device_arn = vtl_device_arn;
    m_vtl_device_arn_isSet = true;
}

bool OAIUpdateVTLDeviceTypeOutput::is_vtl_device_arn_Set() const{
    return m_vtl_device_arn_isSet;
}

bool OAIUpdateVTLDeviceTypeOutput::is_vtl_device_arn_Valid() const{
    return m_vtl_device_arn_isValid;
}

bool OAIUpdateVTLDeviceTypeOutput::isSet() const {
...
bool OAIUpdateVTLDeviceTypeOutput::isValid() const {
