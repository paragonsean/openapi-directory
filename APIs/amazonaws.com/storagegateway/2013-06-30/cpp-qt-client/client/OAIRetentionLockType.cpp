...
OAIRetentionLockType::OAIRetentionLockType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRetentionLockType::OAIRetentionLockType() {
    this->initializeModel();
}

OAIRetentionLockType::~OAIRetentionLockType() {}

void OAIRetentionLockType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRetentionLockType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRetentionLockType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("COMPLIANCE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRetentionLockType::COMPLIANCE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GOVERNANCE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRetentionLockType::GOVERNANCE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NONE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRetentionLockType::NONE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRetentionLockType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRetentionLockType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRetentionLockType::COMPLIANCE:
            val = "COMPLIANCE";
            break;
        case eOAIRetentionLockType::GOVERNANCE:
            val = "GOVERNANCE";
            break;
        case eOAIRetentionLockType::NONE:
            val = "NONE";
            break;
        default:
            break;
...
QJsonValue OAIRetentionLockType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRetentionLockType::eOAIRetentionLockType OAIRetentionLockType::getValue() const {
    return m_value;
}

void OAIRetentionLockType::setValue(const OAIRetentionLockType::eOAIRetentionLockType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRetentionLockType::isSet() const {
    
    return m_value_isSet;
}

bool OAIRetentionLockType::isValid() const {
