...
OAIDescribeChapCredentialsInput::OAIDescribeChapCredentialsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeChapCredentialsInput::OAIDescribeChapCredentialsInput() {
    this->initializeModel();
}

OAIDescribeChapCredentialsInput::~OAIDescribeChapCredentialsInput() {}

void OAIDescribeChapCredentialsInput::initializeModel() {

    m_target_arn_isSet = false;
    m_target_arn_isValid = false;
}

void OAIDescribeChapCredentialsInput::fromJson(QString jsonString) {
...
void OAIDescribeChapCredentialsInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeChapCredentialsInput::asJson() const {
...
QJsonObject OAIDescribeChapCredentialsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeChapCredentialsInput::getTargetArn() const {
    return m_target_arn;
}
void OAIDescribeChapCredentialsInput::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAIDescribeChapCredentialsInput::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAIDescribeChapCredentialsInput::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

bool OAIDescribeChapCredentialsInput::isSet() const {
...
bool OAIDescribeChapCredentialsInput::isValid() const {
