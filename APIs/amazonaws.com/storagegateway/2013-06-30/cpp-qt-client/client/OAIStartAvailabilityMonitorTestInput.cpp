...
OAIStartAvailabilityMonitorTestInput::OAIStartAvailabilityMonitorTestInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartAvailabilityMonitorTestInput::OAIStartAvailabilityMonitorTestInput() {
    this->initializeModel();
}

OAIStartAvailabilityMonitorTestInput::~OAIStartAvailabilityMonitorTestInput() {}

void OAIStartAvailabilityMonitorTestInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIStartAvailabilityMonitorTestInput::fromJson(QString jsonString) {
...
void OAIStartAvailabilityMonitorTestInput::fromJsonObject(QJsonObject json) {
...
QString OAIStartAvailabilityMonitorTestInput::asJson() const {
...
QJsonObject OAIStartAvailabilityMonitorTestInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartAvailabilityMonitorTestInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIStartAvailabilityMonitorTestInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIStartAvailabilityMonitorTestInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIStartAvailabilityMonitorTestInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIStartAvailabilityMonitorTestInput::isSet() const {
...
bool OAIStartAvailabilityMonitorTestInput::isValid() const {
