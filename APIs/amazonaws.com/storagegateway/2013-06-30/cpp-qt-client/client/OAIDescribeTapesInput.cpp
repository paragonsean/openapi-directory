...
OAIDescribeTapesInput::OAIDescribeTapesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTapesInput::OAIDescribeTapesInput() {
    this->initializeModel();
}

OAIDescribeTapesInput::~OAIDescribeTapesInput() {}

void OAIDescribeTapesInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;

    m_tape_arns_isSet = false;
    m_tape_arns_isValid = false;
...
void OAIDescribeTapesInput::fromJson(QString jsonString) {
...
void OAIDescribeTapesInput::fromJsonObject(QJsonObject json) {
    ...
    m_tape_arns_isValid = ::OpenAPI::fromJsonValue(m_tape_arns, json[QString("TapeARNs")]);
    m_tape_arns_isSet = !json[QString("TapeARNs")].isNull() && m_tape_arns_isValid;
...
QString OAIDescribeTapesInput::asJson() const {
...
QJsonObject OAIDescribeTapesInput::asJsonObject() const {
    QJsonObject obj;
    if (m_gateway_arn_isSet) {
        obj.insert(QString("GatewayARN"), ::OpenAPI::toJsonValue(m_gateway_arn));
    }
    if (m_tape_arns.isSet()) {
        obj.insert(QString("TapeARNs"), ::OpenAPI::toJsonValue(m_tape_arns));
    }
    if (m_marker_isSet) {
...
QString OAIDescribeTapesInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeTapesInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeTapesInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeTapesInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QList OAIDescribeTapesInput::getTapeArns() const {
    return m_tape_arns;
}
void OAIDescribeTapesInput::setTapeArns(const QList &tape_arns) {
    m_tape_arns = tape_arns;
    m_tape_arns_isSet = true;
}

bool OAIDescribeTapesInput::is_tape_arns_Set() const{
    return m_tape_arns_isSet;
}

bool OAIDescribeTapesInput::is_tape_arns_Valid() const{
    return m_tape_arns_isValid;
}

QString OAIDescribeTapesInput::getMarker() const {
    return m_marker;
}
void OAIDescribeTapesInput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIDescribeTapesInput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIDescribeTapesInput::is_marker_Valid() const{
    return m_marker_isValid;
}

qint32 OAIDescribeTapesInput::getLimit() const {
    return m_limit;
}
void OAIDescribeTapesInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeTapesInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeTapesInput::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAIDescribeTapesInput::isSet() const {
...
bool OAIDescribeTapesInput::isValid() const {
