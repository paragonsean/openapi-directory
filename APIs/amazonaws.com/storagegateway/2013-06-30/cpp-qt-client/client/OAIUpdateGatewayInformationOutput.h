...
/*
 * OAIUpdateGatewayInformationOutput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway that was updated.
 */

#ifndef OAIUpdateGatewayInformationOutput_H
#define OAIUpdateGatewayInformationOutput_H
...
class OAIUpdateGatewayInformationOutput : public OAIObject {
public:
    OAIUpdateGatewayInformationOutput();
    OAIUpdateGatewayInformationOutput(QString json);
    ~OAIUpdateGatewayInformationOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGatewayInformationOutput)

#endif // OAIUpdateGatewayInformationOutput_H
