...
/*
 * OAIDescribeBandwidthRateLimitOutput.h
 *
 * A JSON object containing the following fields:
 */

#ifndef OAIDescribeBandwidthRateLimitOutput_H
#define OAIDescribeBandwidthRateLimitOutput_H
...
class OAIDescribeBandwidthRateLimitOutput : public OAIObject {
public:
    OAIDescribeBandwidthRateLimitOutput();
    OAIDescribeBandwidthRateLimitOutput(QString json);
    ~OAIDescribeBandwidthRateLimitOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBandwidthRateLimitOutput)

#endif // OAIDescribeBandwidthRateLimitOutput_H
