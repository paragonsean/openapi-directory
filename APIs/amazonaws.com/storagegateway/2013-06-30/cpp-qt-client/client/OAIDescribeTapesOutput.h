...
/*
 * OAIDescribeTapesOutput.h
 *
 * DescribeTapesOutput
 */

#ifndef OAIDescribeTapesOutput_H
#define OAIDescribeTapesOutput_H
...
class OAIDescribeTapesOutput : public OAIObject {
public:
    OAIDescribeTapesOutput();
    OAIDescribeTapesOutput(QString json);
    ~OAIDescribeTapesOutput() override;
    ...
    QList getTapes() const;
    void setTapes(const QList &tapes);
    bool is_tapes_Set() const;
    bool is_tapes_Valid() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTapesOutput)

#endif // OAIDescribeTapesOutput_H
