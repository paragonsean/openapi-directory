...
/*
 * OAIUpdateSMBSecurityStrategyInput.h
 *
 * 
 */

#ifndef OAIUpdateSMBSecurityStrategyInput_H
#define OAIUpdateSMBSecurityStrategyInput_H
...
class OAIUpdateSMBSecurityStrategyInput : public OAIObject {
public:
    OAIUpdateSMBSecurityStrategyInput();
    OAIUpdateSMBSecurityStrategyInput(QString json);
    ~OAIUpdateSMBSecurityStrategyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSMBSecurityStrategyInput)

#endif // OAIUpdateSMBSecurityStrategyInput_H
