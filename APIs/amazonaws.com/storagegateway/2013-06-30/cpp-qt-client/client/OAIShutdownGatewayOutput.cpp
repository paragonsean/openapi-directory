...
OAIShutdownGatewayOutput::OAIShutdownGatewayOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIShutdownGatewayOutput::OAIShutdownGatewayOutput() {
    this->initializeModel();
}

OAIShutdownGatewayOutput::~OAIShutdownGatewayOutput() {}

void OAIShutdownGatewayOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIShutdownGatewayOutput::fromJson(QString jsonString) {
...
void OAIShutdownGatewayOutput::fromJsonObject(QJsonObject json) {
...
QString OAIShutdownGatewayOutput::asJson() const {
...
QJsonObject OAIShutdownGatewayOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIShutdownGatewayOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIShutdownGatewayOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIShutdownGatewayOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIShutdownGatewayOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIShutdownGatewayOutput::isSet() const {
...
bool OAIShutdownGatewayOutput::isValid() const {
