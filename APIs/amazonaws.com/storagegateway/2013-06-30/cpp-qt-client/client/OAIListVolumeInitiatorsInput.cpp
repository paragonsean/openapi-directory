...
OAIListVolumeInitiatorsInput::OAIListVolumeInitiatorsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListVolumeInitiatorsInput::OAIListVolumeInitiatorsInput() {
    this->initializeModel();
}

OAIListVolumeInitiatorsInput::~OAIListVolumeInitiatorsInput() {}

void OAIListVolumeInitiatorsInput::initializeModel() {

    m_volume_arn_isSet = false;
    m_volume_arn_isValid = false;
}

void OAIListVolumeInitiatorsInput::fromJson(QString jsonString) {
...
void OAIListVolumeInitiatorsInput::fromJsonObject(QJsonObject json) {
...
QString OAIListVolumeInitiatorsInput::asJson() const {
...
QJsonObject OAIListVolumeInitiatorsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListVolumeInitiatorsInput::getVolumeArn() const {
    return m_volume_arn;
}
void OAIListVolumeInitiatorsInput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAIListVolumeInitiatorsInput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAIListVolumeInitiatorsInput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

bool OAIListVolumeInitiatorsInput::isSet() const {
...
bool OAIListVolumeInitiatorsInput::isValid() const {
