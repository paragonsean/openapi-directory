...
#ifndef OAIListTapesOutput_H
#define OAIListTapesOutput_H
...
class OAIListTapesOutput : public OAIObject {
public:
    OAIListTapesOutput();
    OAIListTapesOutput(QString json);
    ~OAIListTapesOutput() override;
    ...
    QList<OAITapeInfo> getTapeInfos() const;
    void setTapeInfos(const QList<OAITapeInfo> &tape_infos);
    bool is_tape_infos_Set() const;
    bool is_tape_infos_Valid() const;
...
private:
    ...
    QList<OAITapeInfo> m_tape_infos;
    bool m_tape_infos_isSet;
    bool m_tape_infos_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTapesOutput)

#endif // OAIListTapesOutput_H
