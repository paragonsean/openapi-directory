...
OAIDescribeBandwidthRateLimitScheduleOutput::OAIDescribeBandwidthRateLimitScheduleOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBandwidthRateLimitScheduleOutput::OAIDescribeBandwidthRateLimitScheduleOutput() {
    this->initializeModel();
}

OAIDescribeBandwidthRateLimitScheduleOutput::~OAIDescribeBandwidthRateLimitScheduleOutput() {}

void OAIDescribeBandwidthRateLimitScheduleOutput::initializeModel() {
...
void OAIDescribeBandwidthRateLimitScheduleOutput::fromJson(QString jsonString) {
...
void OAIDescribeBandwidthRateLimitScheduleOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBandwidthRateLimitScheduleOutput::asJson() const {
...
QJsonObject OAIDescribeBandwidthRateLimitScheduleOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBandwidthRateLimitScheduleOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeBandwidthRateLimitScheduleOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeBandwidthRateLimitScheduleOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeBandwidthRateLimitScheduleOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QList OAIDescribeBandwidthRateLimitScheduleOutput::getBandwidthRateLimitIntervals() const {
    return m_bandwidth_rate_limit_intervals;
}
void OAIDescribeBandwidthRateLimitScheduleOutput::setBandwidthRateLimitIntervals(const QList &bandwidth_rate_limit_intervals) {
    m_bandwidth_rate_limit_intervals = bandwidth_rate_limit_intervals;
    m_bandwidth_rate_limit_intervals_isSet = true;
}

bool OAIDescribeBandwidthRateLimitScheduleOutput::is_bandwidth_rate_limit_intervals_Set() const{
    return m_bandwidth_rate_limit_intervals_isSet;
}

bool OAIDescribeBandwidthRateLimitScheduleOutput::is_bandwidth_rate_limit_intervals_Valid() const{
    return m_bandwidth_rate_limit_intervals_isValid;
}

bool OAIDescribeBandwidthRateLimitScheduleOutput::isSet() const {
...
bool OAIDescribeBandwidthRateLimitScheduleOutput::isValid() const {
