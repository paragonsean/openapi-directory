...
/*
 * OAIListAutomaticTapeCreationPoliciesOutput.h
 *
 * 
 */

#ifndef OAIListAutomaticTapeCreationPoliciesOutput_H
#define OAIListAutomaticTapeCreationPoliciesOutput_H
...
class OAIListAutomaticTapeCreationPoliciesOutput : public OAIObject {
public:
    OAIListAutomaticTapeCreationPoliciesOutput();
    OAIListAutomaticTapeCreationPoliciesOutput(QString json);
    ~OAIListAutomaticTapeCreationPoliciesOutput() override;
    ...
    QList getAutomaticTapeCreationPolicyInfos() const;
    void setAutomaticTapeCreationPolicyInfos(const QList &automatic_tape_creation_policy_infos);
    bool is_automatic_tape_creation_policy_infos_Set() const;
    bool is_automatic_tape_creation_policy_infos_Valid() const;
...
private:
    ...
    QList m_automatic_tape_creation_policy_infos;
    bool m_automatic_tape_creation_policy_infos_isSet;
    bool m_automatic_tape_creation_policy_infos_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListAutomaticTapeCreationPoliciesOutput)

#endif // OAIListAutomaticTapeCreationPoliciesOutput_H
