...
/*
 * OAIFileSystemAssociationInfo_EndpointNetworkConfiguration.h
 *
 * 
 */

#ifndef OAIFileSystemAssociationInfo_EndpointNetworkConfiguration_H
#define OAIFileSystemAssociationInfo_EndpointNetworkConfiguration_H
...
class OAIFileSystemAssociationInfo_EndpointNetworkConfiguration : public OAIObject {
public:
    OAIFileSystemAssociationInfo_EndpointNetworkConfiguration();
    OAIFileSystemAssociationInfo_EndpointNetworkConfiguration(QString json);
    ~OAIFileSystemAssociationInfo_EndpointNetworkConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileSystemAssociationInfo_EndpointNetworkConfiguration)

#endif // OAIFileSystemAssociationInfo_EndpointNetworkConfiguration_H
