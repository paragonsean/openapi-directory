...
/*
 * OAIDeleteTapeOutput.h
 *
 * DeleteTapeOutput
 */

#ifndef OAIDeleteTapeOutput_H
#define OAIDeleteTapeOutput_H
...
class OAIDeleteTapeOutput : public OAIObject {
public:
    OAIDeleteTapeOutput();
    OAIDeleteTapeOutput(QString json);
    ~OAIDeleteTapeOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTapeOutput)

#endif // OAIDeleteTapeOutput_H
