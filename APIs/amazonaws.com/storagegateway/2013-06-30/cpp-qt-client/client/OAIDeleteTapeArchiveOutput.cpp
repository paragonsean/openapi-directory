...
OAIDeleteTapeArchiveOutput::OAIDeleteTapeArchiveOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteTapeArchiveOutput::OAIDeleteTapeArchiveOutput() {
    this->initializeModel();
}

OAIDeleteTapeArchiveOutput::~OAIDeleteTapeArchiveOutput() {}

void OAIDeleteTapeArchiveOutput::initializeModel() {

    m_tape_arn_isSet = false;
    m_tape_arn_isValid = false;
}

void OAIDeleteTapeArchiveOutput::fromJson(QString jsonString) {
...
void OAIDeleteTapeArchiveOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteTapeArchiveOutput::asJson() const {
...
QJsonObject OAIDeleteTapeArchiveOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_arn_isSet) {
...
QString OAIDeleteTapeArchiveOutput::getTapeArn() const {
    return m_tape_arn;
}
void OAIDeleteTapeArchiveOutput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAIDeleteTapeArchiveOutput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAIDeleteTapeArchiveOutput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

bool OAIDeleteTapeArchiveOutput::isSet() const {
...
bool OAIDeleteTapeArchiveOutput::isValid() const {
