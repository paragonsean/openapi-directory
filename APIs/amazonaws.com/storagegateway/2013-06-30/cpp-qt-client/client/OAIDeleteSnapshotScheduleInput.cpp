...
OAIDeleteSnapshotScheduleInput::OAIDeleteSnapshotScheduleInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteSnapshotScheduleInput::OAIDeleteSnapshotScheduleInput() {
    this->initializeModel();
}

OAIDeleteSnapshotScheduleInput::~OAIDeleteSnapshotScheduleInput() {}

void OAIDeleteSnapshotScheduleInput::initializeModel() {

    m_volume_arn_isSet = false;
    m_volume_arn_isValid = false;
}

void OAIDeleteSnapshotScheduleInput::fromJson(QString jsonString) {
...
void OAIDeleteSnapshotScheduleInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteSnapshotScheduleInput::asJson() const {
...
QJsonObject OAIDeleteSnapshotScheduleInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteSnapshotScheduleInput::getVolumeArn() const {
    return m_volume_arn;
}
void OAIDeleteSnapshotScheduleInput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAIDeleteSnapshotScheduleInput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAIDeleteSnapshotScheduleInput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

bool OAIDeleteSnapshotScheduleInput::isSet() const {
...
bool OAIDeleteSnapshotScheduleInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_volume_arn_isValid && true;
}
