...
OAIListLocalDisksInput::OAIListLocalDisksInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListLocalDisksInput::OAIListLocalDisksInput() {
    this->initializeModel();
}

OAIListLocalDisksInput::~OAIListLocalDisksInput() {}

void OAIListLocalDisksInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIListLocalDisksInput::fromJson(QString jsonString) {
...
void OAIListLocalDisksInput::fromJsonObject(QJsonObject json) {
...
QString OAIListLocalDisksInput::asJson() const {
...
QJsonObject OAIListLocalDisksInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListLocalDisksInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIListLocalDisksInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIListLocalDisksInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIListLocalDisksInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIListLocalDisksInput::isSet() const {
...
bool OAIListLocalDisksInput::isValid() const {
