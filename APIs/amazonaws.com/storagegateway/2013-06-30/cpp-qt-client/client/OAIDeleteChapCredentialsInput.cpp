...
OAIDeleteChapCredentialsInput::OAIDeleteChapCredentialsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteChapCredentialsInput::OAIDeleteChapCredentialsInput() {
    this->initializeModel();
}

OAIDeleteChapCredentialsInput::~OAIDeleteChapCredentialsInput() {}

void OAIDeleteChapCredentialsInput::initializeModel() {
...
void OAIDeleteChapCredentialsInput::fromJson(QString jsonString) {
...
void OAIDeleteChapCredentialsInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteChapCredentialsInput::asJson() const {
...
QJsonObject OAIDeleteChapCredentialsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteChapCredentialsInput::getTargetArn() const {
    return m_target_arn;
}
void OAIDeleteChapCredentialsInput::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAIDeleteChapCredentialsInput::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAIDeleteChapCredentialsInput::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

QString OAIDeleteChapCredentialsInput::getInitiatorName() const {
    return m_initiator_name;
}
void OAIDeleteChapCredentialsInput::setInitiatorName(const QString &initiator_name) {
    m_initiator_name = initiator_name;
    m_initiator_name_isSet = true;
}

bool OAIDeleteChapCredentialsInput::is_initiator_name_Set() const{
    return m_initiator_name_isSet;
}

bool OAIDeleteChapCredentialsInput::is_initiator_name_Valid() const{
    return m_initiator_name_isValid;
}

bool OAIDeleteChapCredentialsInput::isSet() const {
...
bool OAIDeleteChapCredentialsInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_target_arn_isValid && m_initiator_name_isValid && true;
}
