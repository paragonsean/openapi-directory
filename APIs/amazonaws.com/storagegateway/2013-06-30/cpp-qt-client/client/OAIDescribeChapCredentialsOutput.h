...
/*
 * OAIDescribeChapCredentialsOutput.h
 *
 * A JSON object containing the following fields:
 */

#ifndef OAIDescribeChapCredentialsOutput_H
#define OAIDescribeChapCredentialsOutput_H
...
class OAIDescribeChapCredentialsOutput : public OAIObject {
public:
    OAIDescribeChapCredentialsOutput();
    OAIDescribeChapCredentialsOutput(QString json);
    ~OAIDescribeChapCredentialsOutput() override;
    ...
    QList getChapCredentials() const;
    void setChapCredentials(const QList &chap_credentials);
    bool is_chap_credentials_Set() const;
    bool is_chap_credentials_Valid() const;
...
private:
    ...
    QList m_chap_credentials;
    bool m_chap_credentials_isSet;
    bool m_chap_credentials_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeChapCredentialsOutput)

#endif // OAIDescribeChapCredentialsOutput_H
