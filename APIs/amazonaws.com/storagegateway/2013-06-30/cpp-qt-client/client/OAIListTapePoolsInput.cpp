...
OAIListTapePoolsInput::OAIListTapePoolsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTapePoolsInput::OAIListTapePoolsInput() {
    this->initializeModel();
}

OAIListTapePoolsInput::~OAIListTapePoolsInput() {}

void OAIListTapePoolsInput::initializeModel() {

    m_pool_arns_isSet = false;
    m_pool_arns_isValid = false;
...
void OAIListTapePoolsInput::fromJson(QString jsonString) {
...
void OAIListTapePoolsInput::fromJsonObject(QJsonObject json) {

    m_pool_arns_isValid = ::OpenAPI::fromJsonValue(m_pool_arns, json[QString("PoolARNs")]);
    m_pool_arns_isSet = !json[QString("PoolARNs")].isNull() && m_pool_arns_isValid;
...
QString OAIListTapePoolsInput::asJson() const {
...
QJsonObject OAIListTapePoolsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_pool_arns.isSet()) {
        obj.insert(QString("PoolARNs"), ::OpenAPI::toJsonValue(m_pool_arns));
    }
    if (m_marker_isSet) {
...
QList OAIListTapePoolsInput::getPoolArns() const {
    return m_pool_arns;
}
void OAIListTapePoolsInput::setPoolArns(const QList &pool_arns) {
    m_pool_arns = pool_arns;
    m_pool_arns_isSet = true;
}

bool OAIListTapePoolsInput::is_pool_arns_Set() const{
    return m_pool_arns_isSet;
}

bool OAIListTapePoolsInput::is_pool_arns_Valid() const{
    return m_pool_arns_isValid;
}

QString OAIListTapePoolsInput::getMarker() const {
    return m_marker;
}
void OAIListTapePoolsInput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListTapePoolsInput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListTapePoolsInput::is_marker_Valid() const{
    return m_marker_isValid;
}

qint32 OAIListTapePoolsInput::getLimit() const {
    return m_limit;
}
void OAIListTapePoolsInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListTapePoolsInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListTapePoolsInput::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAIListTapePoolsInput::isSet() const {
...
bool OAIListTapePoolsInput::isValid() const {
