...
/*
 * OAIDescribeWorkingStorageOutput.h
 *
 * A JSON object containing the following fields:
 */

#ifndef OAIDescribeWorkingStorageOutput_H
#define OAIDescribeWorkingStorageOutput_H
...
class OAIDescribeWorkingStorageOutput : public OAIObject {
public:
    OAIDescribeWorkingStorageOutput();
    OAIDescribeWorkingStorageOutput(QString json);
    ~OAIDescribeWorkingStorageOutput() override;
    ...
    qint32 getWorkingStorageUsedInBytes() const;
    void setWorkingStorageUsedInBytes(const qint32 &working_storage_used_in_bytes);
    bool is_working_storage_used_in_bytes_Set() const;
    bool is_working_storage_used_in_bytes_Valid() const;

    qint32 getWorkingStorageAllocatedInBytes() const;
    void setWorkingStorageAllocatedInBytes(const qint32 &working_storage_allocated_in_bytes);
    bool is_working_storage_allocated_in_bytes_Set() const;
    bool is_working_storage_allocated_in_bytes_Valid() const;
...
private:
    ...
    qint32 m_working_storage_used_in_bytes;
    bool m_working_storage_used_in_bytes_isSet;
    bool m_working_storage_used_in_bytes_isValid;

    qint32 m_working_storage_allocated_in_bytes;
    bool m_working_storage_allocated_in_bytes_isSet;
    bool m_working_storage_allocated_in_bytes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeWorkingStorageOutput)

#endif // OAIDescribeWorkingStorageOutput_H
