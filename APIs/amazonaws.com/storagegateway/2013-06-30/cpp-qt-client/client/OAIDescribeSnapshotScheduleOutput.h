...
/*
 * OAIDescribeSnapshotScheduleOutput.h
 *
 * 
 */

#ifndef OAIDescribeSnapshotScheduleOutput_H
#define OAIDescribeSnapshotScheduleOutput_H
...
class OAIDescribeSnapshotScheduleOutput : public OAIObject {
public:
    OAIDescribeSnapshotScheduleOutput();
    OAIDescribeSnapshotScheduleOutput(QString json);
    ~OAIDescribeSnapshotScheduleOutput() override;
    ...
    qint32 getRecurrenceInHours() const;
    void setRecurrenceInHours(const qint32 &recurrence_in_hours);
    bool is_recurrence_in_hours_Set() const;
    bool is_recurrence_in_hours_Valid() const;
...
private:
    ...
    qint32 m_recurrence_in_hours;
    bool m_recurrence_in_hours_isSet;
    bool m_recurrence_in_hours_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSnapshotScheduleOutput)

#endif // OAIDescribeSnapshotScheduleOutput_H
