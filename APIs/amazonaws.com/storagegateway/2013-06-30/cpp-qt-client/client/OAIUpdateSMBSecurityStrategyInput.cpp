...
OAIUpdateSMBSecurityStrategyInput::OAIUpdateSMBSecurityStrategyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSMBSecurityStrategyInput::OAIUpdateSMBSecurityStrategyInput() {
    this->initializeModel();
}

OAIUpdateSMBSecurityStrategyInput::~OAIUpdateSMBSecurityStrategyInput() {}

void OAIUpdateSMBSecurityStrategyInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;

    m_smb_security_strategy_isSet = false;
    m_smb_security_strategy_isValid = false;
}

void OAIUpdateSMBSecurityStrategyInput::fromJson(QString jsonString) {
...
void OAIUpdateSMBSecurityStrategyInput::fromJsonObject(QJsonObject json) {
    ...
    m_smb_security_strategy_isValid = ::OpenAPI::fromJsonValue(m_smb_security_strategy, json[QString("SMBSecurityStrategy")]);
    m_smb_security_strategy_isSet = !json[QString("SMBSecurityStrategy")].isNull() && m_smb_security_strategy_isValid;
}

QString OAIUpdateSMBSecurityStrategyInput::asJson() const {
...
QJsonObject OAIUpdateSMBSecurityStrategyInput::asJsonObject() const {
    QJsonObject obj;
    if (m_gateway_arn_isSet) {
        obj.insert(QString("GatewayARN"), ::OpenAPI::toJsonValue(m_gateway_arn));
    }
    if (m_smb_security_strategy.isSet()) {
        obj.insert(QString("SMBSecurityStrategy"), ::OpenAPI::toJsonValue(m_smb_security_strategy));
    }
    return obj;
}

QString OAIUpdateSMBSecurityStrategyInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateSMBSecurityStrategyInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateSMBSecurityStrategyInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateSMBSecurityStrategyInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

OAISMBSecurityStrategy OAIUpdateSMBSecurityStrategyInput::getSmbSecurityStrategy() const {
    return m_smb_security_strategy;
}
void OAIUpdateSMBSecurityStrategyInput::setSmbSecurityStrategy(const OAISMBSecurityStrategy &smb_security_strategy) {
    m_smb_security_strategy = smb_security_strategy;
    m_smb_security_strategy_isSet = true;
}

bool OAIUpdateSMBSecurityStrategyInput::is_smb_security_strategy_Set() const{
    return m_smb_security_strategy_isSet;
}

bool OAIUpdateSMBSecurityStrategyInput::is_smb_security_strategy_Valid() const{
    return m_smb_security_strategy_isValid;
}

bool OAIUpdateSMBSecurityStrategyInput::isSet() const {
...
bool OAIUpdateSMBSecurityStrategyInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_gateway_arn_isValid && m_smb_security_strategy_isValid && true;
}
