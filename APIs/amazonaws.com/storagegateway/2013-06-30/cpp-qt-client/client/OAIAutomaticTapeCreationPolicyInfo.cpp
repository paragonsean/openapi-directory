...
#include "OAIAutomaticTapeCreationPolicyInfo.h"
...
OAIAutomaticTapeCreationPolicyInfo::OAIAutomaticTapeCreationPolicyInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAutomaticTapeCreationPolicyInfo::OAIAutomaticTapeCreationPolicyInfo() {
    this->initializeModel();
}

OAIAutomaticTapeCreationPolicyInfo::~OAIAutomaticTapeCreationPolicyInfo() {}

void OAIAutomaticTapeCreationPolicyInfo::initializeModel() {
...
void OAIAutomaticTapeCreationPolicyInfo::fromJson(QString jsonString) {
...
void OAIAutomaticTapeCreationPolicyInfo::fromJsonObject(QJsonObject json) {
...
QString OAIAutomaticTapeCreationPolicyInfo::asJson() const {
...
QJsonObject OAIAutomaticTapeCreationPolicyInfo::asJsonObject() const {
    QJsonObject obj;
...
QList OAIAutomaticTapeCreationPolicyInfo::getAutomaticTapeCreationRules() const {
    return m_automatic_tape_creation_rules;
}
void OAIAutomaticTapeCreationPolicyInfo::setAutomaticTapeCreationRules(const QList &automatic_tape_creation_rules) {
    m_automatic_tape_creation_rules = automatic_tape_creation_rules;
    m_automatic_tape_creation_rules_isSet = true;
}

bool OAIAutomaticTapeCreationPolicyInfo::is_automatic_tape_creation_rules_Set() const{
    return m_automatic_tape_creation_rules_isSet;
}

bool OAIAutomaticTapeCreationPolicyInfo::is_automatic_tape_creation_rules_Valid() const{
    return m_automatic_tape_creation_rules_isValid;
}

QString OAIAutomaticTapeCreationPolicyInfo::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIAutomaticTapeCreationPolicyInfo::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIAutomaticTapeCreationPolicyInfo::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIAutomaticTapeCreationPolicyInfo::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIAutomaticTapeCreationPolicyInfo::isSet() const {
...
bool OAIAutomaticTapeCreationPolicyInfo::isValid() const {
