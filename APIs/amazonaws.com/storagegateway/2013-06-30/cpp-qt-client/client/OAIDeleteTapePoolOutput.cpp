...
OAIDeleteTapePoolOutput::OAIDeleteTapePoolOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteTapePoolOutput::OAIDeleteTapePoolOutput() {
    this->initializeModel();
}

OAIDeleteTapePoolOutput::~OAIDeleteTapePoolOutput() {}

void OAIDeleteTapePoolOutput::initializeModel() {

    m_pool_arn_isSet = false;
    m_pool_arn_isValid = false;
}

void OAIDeleteTapePoolOutput::fromJson(QString jsonString) {
...
void OAIDeleteTapePoolOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteTapePoolOutput::asJson() const {
...
QJsonObject OAIDeleteTapePoolOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_pool_arn_isSet) {
...
QString OAIDeleteTapePoolOutput::getPoolArn() const {
    return m_pool_arn;
}
void OAIDeleteTapePoolOutput::setPoolArn(const QString &pool_arn) {
    m_pool_arn = pool_arn;
    m_pool_arn_isSet = true;
}

bool OAIDeleteTapePoolOutput::is_pool_arn_Set() const{
    return m_pool_arn_isSet;
}

bool OAIDeleteTapePoolOutput::is_pool_arn_Valid() const{
    return m_pool_arn_isValid;
}

bool OAIDeleteTapePoolOutput::isSet() const {
...
bool OAIDeleteTapePoolOutput::isValid() const {
