...
/*
 * OAIUpdateVTLDeviceTypeInput.h
 *
 * 
 */

#ifndef OAIUpdateVTLDeviceTypeInput_H
#define OAIUpdateVTLDeviceTypeInput_H
...
class OAIUpdateVTLDeviceTypeInput : public OAIObject {
public:
    OAIUpdateVTLDeviceTypeInput();
    OAIUpdateVTLDeviceTypeInput(QString json);
    ~OAIUpdateVTLDeviceTypeInput() override;
    ...
    QString getVtlDeviceArn() const;
    void setVtlDeviceArn(const QString &vtl_device_arn);
    bool is_vtl_device_arn_Set() const;
    bool is_vtl_device_arn_Valid() const;
...
private:
    ...
    QString m_vtl_device_arn;
    bool m_vtl_device_arn_isSet;
    bool m_vtl_device_arn_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVTLDeviceTypeInput)

#endif // OAIUpdateVTLDeviceTypeInput_H
