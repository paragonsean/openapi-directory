...
OAIAddCacheInput::OAIAddCacheInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddCacheInput::OAIAddCacheInput() {
    this->initializeModel();
}

OAIAddCacheInput::~OAIAddCacheInput() {}

void OAIAddCacheInput::initializeModel() {
...
void OAIAddCacheInput::fromJson(QString jsonString) {
...
void OAIAddCacheInput::fromJsonObject(QJsonObject json) {
...
QString OAIAddCacheInput::asJson() const {
...
QJsonObject OAIAddCacheInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddCacheInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIAddCacheInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIAddCacheInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIAddCacheInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QList OAIAddCacheInput::getDiskIds() const {
    return m_disk_ids;
}
void OAIAddCacheInput::setDiskIds(const QList &disk_ids) {
    m_disk_ids = disk_ids;
    m_disk_ids_isSet = true;
}

bool OAIAddCacheInput::is_disk_ids_Set() const{
    return m_disk_ids_isSet;
}

bool OAIAddCacheInput::is_disk_ids_Valid() const{
    return m_disk_ids_isValid;
}

bool OAIAddCacheInput::isSet() const {
...
bool OAIAddCacheInput::isValid() const {
