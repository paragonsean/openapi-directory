...
#include "OAIVolumeiSCSIAttributes.h"
...
OAIVolumeiSCSIAttributes::OAIVolumeiSCSIAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVolumeiSCSIAttributes::OAIVolumeiSCSIAttributes() {
    this->initializeModel();
}

OAIVolumeiSCSIAttributes::~OAIVolumeiSCSIAttributes() {}

void OAIVolumeiSCSIAttributes::initializeModel() {
...
void OAIVolumeiSCSIAttributes::fromJson(QString jsonString) {
...
void OAIVolumeiSCSIAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIVolumeiSCSIAttributes::asJson() const {
...
QJsonObject OAIVolumeiSCSIAttributes::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVolumeiSCSIAttributes::getTargetArn() const {
    return m_target_arn;
}
void OAIVolumeiSCSIAttributes::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAIVolumeiSCSIAttributes::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAIVolumeiSCSIAttributes::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

QString OAIVolumeiSCSIAttributes::getNetworkInterfaceId() const {
    return m_network_interface_id;
}
void OAIVolumeiSCSIAttributes::setNetworkInterfaceId(const QString &network_interface_id) {
    m_network_interface_id = network_interface_id;
    m_network_interface_id_isSet = true;
}

bool OAIVolumeiSCSIAttributes::is_network_interface_id_Set() const{
    return m_network_interface_id_isSet;
}

bool OAIVolumeiSCSIAttributes::is_network_interface_id_Valid() const{
    return m_network_interface_id_isValid;
}

qint32 OAIVolumeiSCSIAttributes::getNetworkInterfacePort() const {
    return m_network_interface_port;
}
void OAIVolumeiSCSIAttributes::setNetworkInterfacePort(const qint32 &network_interface_port) {
    m_network_interface_port = network_interface_port;
    m_network_interface_port_isSet = true;
}

bool OAIVolumeiSCSIAttributes::is_network_interface_port_Set() const{
    return m_network_interface_port_isSet;
}

bool OAIVolumeiSCSIAttributes::is_network_interface_port_Valid() const{
    return m_network_interface_port_isValid;
}

qint32 OAIVolumeiSCSIAttributes::getLunNumber() const {
    return m_lun_number;
}
void OAIVolumeiSCSIAttributes::setLunNumber(const qint32 &lun_number) {
    m_lun_number = lun_number;
    m_lun_number_isSet = true;
}

bool OAIVolumeiSCSIAttributes::is_lun_number_Set() const{
    return m_lun_number_isSet;
}

bool OAIVolumeiSCSIAttributes::is_lun_number_Valid() const{
    return m_lun_number_isValid;
}

bool OAIVolumeiSCSIAttributes::getChapEnabled() const {
    return m_chap_enabled;
}
void OAIVolumeiSCSIAttributes::setChapEnabled(const bool &chap_enabled) {
    m_chap_enabled = chap_enabled;
    m_chap_enabled_isSet = true;
}

bool OAIVolumeiSCSIAttributes::is_chap_enabled_Set() const{
    return m_chap_enabled_isSet;
}

bool OAIVolumeiSCSIAttributes::is_chap_enabled_Valid() const{
    return m_chap_enabled_isValid;
}

bool OAIVolumeiSCSIAttributes::isSet() const {
...
bool OAIVolumeiSCSIAttributes::isValid() const {
