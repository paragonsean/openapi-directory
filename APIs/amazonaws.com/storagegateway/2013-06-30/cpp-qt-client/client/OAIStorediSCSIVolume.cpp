...
#include "OAIStorediSCSIVolume.h"
...
OAIStorediSCSIVolume::OAIStorediSCSIVolume(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStorediSCSIVolume::OAIStorediSCSIVolume() {
    this->initializeModel();
}

OAIStorediSCSIVolume::~OAIStorediSCSIVolume() {}

void OAIStorediSCSIVolume::initializeModel() {
    ...
    m_volume_disk_id_isSet = false;
    m_volume_disk_id_isValid = false;

    m_source_snapshot_id_isSet = false;
    m_source_snapshot_id_isValid = false;

    m_preserved_existing_data_isSet = false;
    m_preserved_existing_data_isValid = false;
...
void OAIStorediSCSIVolume::fromJson(QString jsonString) {
...
void OAIStorediSCSIVolume::fromJsonObject(QJsonObject json) {
    ...
    m_volume_disk_id_isValid = ::OpenAPI::fromJsonValue(m_volume_disk_id, json[QString("VolumeDiskId")]);
    m_volume_disk_id_isSet = !json[QString("VolumeDiskId")].isNull() && m_volume_disk_id_isValid;
    ...
    m_preserved_existing_data_isValid = ::OpenAPI::fromJsonValue(m_preserved_existing_data, json[QString("PreservedExistingData")]);
    m_preserved_existing_data_isSet = !json[QString("PreservedExistingData")].isNull() && m_preserved_existing_data_isValid;
...
QString OAIStorediSCSIVolume::asJson() const {
...
QJsonObject OAIStorediSCSIVolume::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_volume_disk_id_isSet) {
        obj.insert(QString("VolumeDiskId"), ::OpenAPI::toJsonValue(m_volume_disk_id));
    }
    if (m_source_snapshot_id_isSet) {
        obj.insert(QString("SourceSnapshotId"), ::OpenAPI::toJsonValue(m_source_snapshot_id));
    }
    if (m_preserved_existing_data_isSet) {
        obj.insert(QString("PreservedExistingData"), ::OpenAPI::toJsonValue(m_preserved_existing_data));
    }
...
QString OAIStorediSCSIVolume::getVolumeArn() const {
    return m_volume_arn;
}
void OAIStorediSCSIVolume::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAIStorediSCSIVolume::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAIStorediSCSIVolume::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

QString OAIStorediSCSIVolume::getVolumeId() const {
    return m_volume_id;
}
void OAIStorediSCSIVolume::setVolumeId(const QString &volume_id) {
    m_volume_id = volume_id;
    m_volume_id_isSet = true;
}

bool OAIStorediSCSIVolume::is_volume_id_Set() const{
    return m_volume_id_isSet;
}

bool OAIStorediSCSIVolume::is_volume_id_Valid() const{
    return m_volume_id_isValid;
}

QString OAIStorediSCSIVolume::getVolumeType() const {
    return m_volume_type;
}
void OAIStorediSCSIVolume::setVolumeType(const QString &volume_type) {
    m_volume_type = volume_type;
    m_volume_type_isSet = true;
}

bool OAIStorediSCSIVolume::is_volume_type_Set() const{
    return m_volume_type_isSet;
}

bool OAIStorediSCSIVolume::is_volume_type_Valid() const{
    return m_volume_type_isValid;
}

QString OAIStorediSCSIVolume::getVolumeStatus() const {
    return m_volume_status;
}
void OAIStorediSCSIVolume::setVolumeStatus(const QString &volume_status) {
    m_volume_status = volume_status;
    m_volume_status_isSet = true;
}

bool OAIStorediSCSIVolume::is_volume_status_Set() const{
    return m_volume_status_isSet;
}

bool OAIStorediSCSIVolume::is_volume_status_Valid() const{
    return m_volume_status_isValid;
}

QString OAIStorediSCSIVolume::getVolumeAttachmentStatus() const {
    return m_volume_attachment_status;
}
void OAIStorediSCSIVolume::setVolumeAttachmentStatus(const QString &volume_attachment_status) {
    m_volume_attachment_status = volume_attachment_status;
    m_volume_attachment_status_isSet = true;
}

bool OAIStorediSCSIVolume::is_volume_attachment_status_Set() const{
    return m_volume_attachment_status_isSet;
}

bool OAIStorediSCSIVolume::is_volume_attachment_status_Valid() const{
    return m_volume_attachment_status_isValid;
}

qint32 OAIStorediSCSIVolume::getVolumeSizeInBytes() const {
    return m_volume_size_in_bytes;
}
void OAIStorediSCSIVolume::setVolumeSizeInBytes(const qint32 &volume_size_in_bytes) {
    m_volume_size_in_bytes = volume_size_in_bytes;
    m_volume_size_in_bytes_isSet = true;
}

bool OAIStorediSCSIVolume::is_volume_size_in_bytes_Set() const{
    return m_volume_size_in_bytes_isSet;
}

bool OAIStorediSCSIVolume::is_volume_size_in_bytes_Valid() const{
    return m_volume_size_in_bytes_isValid;
}

double OAIStorediSCSIVolume::getVolumeProgress() const {
    return m_volume_progress;
}
void OAIStorediSCSIVolume::setVolumeProgress(const double &volume_progress) {
    m_volume_progress = volume_progress;
    m_volume_progress_isSet = true;
}

bool OAIStorediSCSIVolume::is_volume_progress_Set() const{
    return m_volume_progress_isSet;
}

bool OAIStorediSCSIVolume::is_volume_progress_Valid() const{
    return m_volume_progress_isValid;
}

QString OAIStorediSCSIVolume::getVolumeDiskId() const {
    return m_volume_disk_id;
}
void OAIStorediSCSIVolume::setVolumeDiskId(const QString &volume_disk_id) {
    m_volume_disk_id = volume_disk_id;
    m_volume_disk_id_isSet = true;
}

bool OAIStorediSCSIVolume::is_volume_disk_id_Set() const{
    return m_volume_disk_id_isSet;
}

bool OAIStorediSCSIVolume::is_volume_disk_id_Valid() const{
    return m_volume_disk_id_isValid;
}

QString OAIStorediSCSIVolume::getSourceSnapshotId() const {
    return m_source_snapshot_id;
}
void OAIStorediSCSIVolume::setSourceSnapshotId(const QString &source_snapshot_id) {
    m_source_snapshot_id = source_snapshot_id;
    m_source_snapshot_id_isSet = true;
}

bool OAIStorediSCSIVolume::is_source_snapshot_id_Set() const{
    return m_source_snapshot_id_isSet;
}

bool OAIStorediSCSIVolume::is_source_snapshot_id_Valid() const{
    return m_source_snapshot_id_isValid;
}

bool OAIStorediSCSIVolume::getPreservedExistingData() const {
    return m_preserved_existing_data;
}
void OAIStorediSCSIVolume::setPreservedExistingData(const bool &preserved_existing_data) {
    m_preserved_existing_data = preserved_existing_data;
    m_preserved_existing_data_isSet = true;
}

bool OAIStorediSCSIVolume::is_preserved_existing_data_Set() const{
    return m_preserved_existing_data_isSet;
}

bool OAIStorediSCSIVolume::is_preserved_existing_data_Valid() const{
    return m_preserved_existing_data_isValid;
}

OAICachediSCSIVolume_VolumeiSCSIAttributes OAIStorediSCSIVolume::getVolumeiScsiAttributes() const {
    return m_volumei_scsi_attributes;
}
void OAIStorediSCSIVolume::setVolumeiScsiAttributes(const OAICachediSCSIVolume_VolumeiSCSIAttributes &volumei_scsi_attributes) {
    m_volumei_scsi_attributes = volumei_scsi_attributes;
    m_volumei_scsi_attributes_isSet = true;
}

bool OAIStorediSCSIVolume::is_volumei_scsi_attributes_Set() const{
    return m_volumei_scsi_attributes_isSet;
}

bool OAIStorediSCSIVolume::is_volumei_scsi_attributes_Valid() const{
    return m_volumei_scsi_attributes_isValid;
}

QDateTime OAIStorediSCSIVolume::getCreatedDate() const {
    return m_created_date;
}
void OAIStorediSCSIVolume::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIStorediSCSIVolume::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIStorediSCSIVolume::is_created_date_Valid() const{
    return m_created_date_isValid;
}

qint32 OAIStorediSCSIVolume::getVolumeUsedInBytes() const {
    return m_volume_used_in_bytes;
}
void OAIStorediSCSIVolume::setVolumeUsedInBytes(const qint32 &volume_used_in_bytes) {
    m_volume_used_in_bytes = volume_used_in_bytes;
    m_volume_used_in_bytes_isSet = true;
}

bool OAIStorediSCSIVolume::is_volume_used_in_bytes_Set() const{
    return m_volume_used_in_bytes_isSet;
}

bool OAIStorediSCSIVolume::is_volume_used_in_bytes_Valid() const{
    return m_volume_used_in_bytes_isValid;
}

QString OAIStorediSCSIVolume::getKmsKey() const {
    return m_kms_key;
}
void OAIStorediSCSIVolume::setKmsKey(const QString &kms_key) {
    m_kms_key = kms_key;
    m_kms_key_isSet = true;
}

bool OAIStorediSCSIVolume::is_kms_key_Set() const{
    return m_kms_key_isSet;
}

bool OAIStorediSCSIVolume::is_kms_key_Valid() const{
    return m_kms_key_isValid;
}

QString OAIStorediSCSIVolume::getTargetName() const {
    return m_target_name;
}
void OAIStorediSCSIVolume::setTargetName(const QString &target_name) {
    m_target_name = target_name;
    m_target_name_isSet = true;
}

bool OAIStorediSCSIVolume::is_target_name_Set() const{
    return m_target_name_isSet;
}

bool OAIStorediSCSIVolume::is_target_name_Valid() const{
    return m_target_name_isValid;
}

bool OAIStorediSCSIVolume::isSet() const {
...
bool OAIStorediSCSIVolume::isValid() const {
