...
/*
 * OAINotifyWhenUploadedOutput.h
 *
 * 
 */

#ifndef OAINotifyWhenUploadedOutput_H
#define OAINotifyWhenUploadedOutput_H
...
class OAINotifyWhenUploadedOutput : public OAIObject {
public:
    OAINotifyWhenUploadedOutput();
    OAINotifyWhenUploadedOutput(QString json);
    ~OAINotifyWhenUploadedOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotifyWhenUploadedOutput)

#endif // OAINotifyWhenUploadedOutput_H
