...
/*
 * OAINFSFileShareInfo_CacheAttributes.h
 *
 * 
 */

#ifndef OAINFSFileShareInfo_CacheAttributes_H
#define OAINFSFileShareInfo_CacheAttributes_H
...
class OAINFSFileShareInfo_CacheAttributes : public OAIObject {
public:
    OAINFSFileShareInfo_CacheAttributes();
    OAINFSFileShareInfo_CacheAttributes(QString json);
    ~OAINFSFileShareInfo_CacheAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINFSFileShareInfo_CacheAttributes)

#endif // OAINFSFileShareInfo_CacheAttributes_H
