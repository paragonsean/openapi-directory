...
OAIUpdateChapCredentialsOutput::OAIUpdateChapCredentialsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateChapCredentialsOutput::OAIUpdateChapCredentialsOutput() {
    this->initializeModel();
}

OAIUpdateChapCredentialsOutput::~OAIUpdateChapCredentialsOutput() {}

void OAIUpdateChapCredentialsOutput::initializeModel() {
...
void OAIUpdateChapCredentialsOutput::fromJson(QString jsonString) {
...
void OAIUpdateChapCredentialsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateChapCredentialsOutput::asJson() const {
...
QJsonObject OAIUpdateChapCredentialsOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateChapCredentialsOutput::getTargetArn() const {
    return m_target_arn;
}
void OAIUpdateChapCredentialsOutput::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAIUpdateChapCredentialsOutput::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAIUpdateChapCredentialsOutput::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

QString OAIUpdateChapCredentialsOutput::getInitiatorName() const {
    return m_initiator_name;
}
void OAIUpdateChapCredentialsOutput::setInitiatorName(const QString &initiator_name) {
    m_initiator_name = initiator_name;
    m_initiator_name_isSet = true;
}

bool OAIUpdateChapCredentialsOutput::is_initiator_name_Set() const{
    return m_initiator_name_isSet;
}

bool OAIUpdateChapCredentialsOutput::is_initiator_name_Valid() const{
    return m_initiator_name_isValid;
}

bool OAIUpdateChapCredentialsOutput::isSet() const {
...
bool OAIUpdateChapCredentialsOutput::isValid() const {
