...
OAIDescribeUploadBufferInput::OAIDescribeUploadBufferInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeUploadBufferInput::OAIDescribeUploadBufferInput() {
    this->initializeModel();
}

OAIDescribeUploadBufferInput::~OAIDescribeUploadBufferInput() {}

void OAIDescribeUploadBufferInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDescribeUploadBufferInput::fromJson(QString jsonString) {
...
void OAIDescribeUploadBufferInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeUploadBufferInput::asJson() const {
...
QJsonObject OAIDescribeUploadBufferInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeUploadBufferInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeUploadBufferInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeUploadBufferInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeUploadBufferInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDescribeUploadBufferInput::isSet() const {
...
bool OAIDescribeUploadBufferInput::isValid() const {
