...
OAIDeleteAutomaticTapeCreationPolicyInput::OAIDeleteAutomaticTapeCreationPolicyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAutomaticTapeCreationPolicyInput::OAIDeleteAutomaticTapeCreationPolicyInput() {
    this->initializeModel();
}

OAIDeleteAutomaticTapeCreationPolicyInput::~OAIDeleteAutomaticTapeCreationPolicyInput() {}

void OAIDeleteAutomaticTapeCreationPolicyInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDeleteAutomaticTapeCreationPolicyInput::fromJson(QString jsonString) {
...
void OAIDeleteAutomaticTapeCreationPolicyInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteAutomaticTapeCreationPolicyInput::asJson() const {
...
QJsonObject OAIDeleteAutomaticTapeCreationPolicyInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteAutomaticTapeCreationPolicyInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDeleteAutomaticTapeCreationPolicyInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDeleteAutomaticTapeCreationPolicyInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDeleteAutomaticTapeCreationPolicyInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDeleteAutomaticTapeCreationPolicyInput::isSet() const {
...
bool OAIDeleteAutomaticTapeCreationPolicyInput::isValid() const {
