...
OAIDeleteSnapshotScheduleOutput::OAIDeleteSnapshotScheduleOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteSnapshotScheduleOutput::OAIDeleteSnapshotScheduleOutput() {
    this->initializeModel();
}

OAIDeleteSnapshotScheduleOutput::~OAIDeleteSnapshotScheduleOutput() {}

void OAIDeleteSnapshotScheduleOutput::initializeModel() {

    m_volume_arn_isSet = false;
    m_volume_arn_isValid = false;
}

void OAIDeleteSnapshotScheduleOutput::fromJson(QString jsonString) {
...
void OAIDeleteSnapshotScheduleOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteSnapshotScheduleOutput::asJson() const {
...
QJsonObject OAIDeleteSnapshotScheduleOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteSnapshotScheduleOutput::getVolumeArn() const {
    return m_volume_arn;
}
void OAIDeleteSnapshotScheduleOutput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAIDeleteSnapshotScheduleOutput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAIDeleteSnapshotScheduleOutput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

bool OAIDeleteSnapshotScheduleOutput::isSet() const {
...
bool OAIDeleteSnapshotScheduleOutput::isValid() const {
