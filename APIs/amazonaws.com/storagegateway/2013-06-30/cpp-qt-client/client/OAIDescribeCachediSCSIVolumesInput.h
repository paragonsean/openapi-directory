...
/*
 * OAIDescribeCachediSCSIVolumesInput.h
 *
 * 
 */

#ifndef OAIDescribeCachediSCSIVolumesInput_H
#define OAIDescribeCachediSCSIVolumesInput_H
...
class OAIDescribeCachediSCSIVolumesInput : public OAIObject {
public:
    OAIDescribeCachediSCSIVolumesInput();
    OAIDescribeCachediSCSIVolumesInput(QString json);
    ~OAIDescribeCachediSCSIVolumesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCachediSCSIVolumesInput)

#endif // OAIDescribeCachediSCSIVolumesInput_H
