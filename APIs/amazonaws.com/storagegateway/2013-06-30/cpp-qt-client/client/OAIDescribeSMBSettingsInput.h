...
/*
 * OAIDescribeSMBSettingsInput.h
 *
 * 
 */

#ifndef OAIDescribeSMBSettingsInput_H
#define OAIDescribeSMBSettingsInput_H
...
class OAIDescribeSMBSettingsInput : public OAIObject {
public:
    OAIDescribeSMBSettingsInput();
    OAIDescribeSMBSettingsInput(QString json);
    ~OAIDescribeSMBSettingsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSMBSettingsInput)

#endif // OAIDescribeSMBSettingsInput_H
