...
OAIDeleteVolumeOutput::OAIDeleteVolumeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteVolumeOutput::OAIDeleteVolumeOutput() {
    this->initializeModel();
}

OAIDeleteVolumeOutput::~OAIDeleteVolumeOutput() {}

void OAIDeleteVolumeOutput::initializeModel() {

    m_volume_arn_isSet = false;
    m_volume_arn_isValid = false;
}

void OAIDeleteVolumeOutput::fromJson(QString jsonString) {
...
void OAIDeleteVolumeOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteVolumeOutput::asJson() const {
...
QJsonObject OAIDeleteVolumeOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteVolumeOutput::getVolumeArn() const {
    return m_volume_arn;
}
void OAIDeleteVolumeOutput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAIDeleteVolumeOutput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAIDeleteVolumeOutput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

bool OAIDeleteVolumeOutput::isSet() const {
...
bool OAIDeleteVolumeOutput::isValid() const {
