...
OAIAddUploadBufferOutput::OAIAddUploadBufferOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddUploadBufferOutput::OAIAddUploadBufferOutput() {
    this->initializeModel();
}

OAIAddUploadBufferOutput::~OAIAddUploadBufferOutput() {}

void OAIAddUploadBufferOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIAddUploadBufferOutput::fromJson(QString jsonString) {
...
void OAIAddUploadBufferOutput::fromJsonObject(QJsonObject json) {
...
QString OAIAddUploadBufferOutput::asJson() const {
...
QJsonObject OAIAddUploadBufferOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddUploadBufferOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIAddUploadBufferOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIAddUploadBufferOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIAddUploadBufferOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIAddUploadBufferOutput::isSet() const {
...
bool OAIAddUploadBufferOutput::isValid() const {
