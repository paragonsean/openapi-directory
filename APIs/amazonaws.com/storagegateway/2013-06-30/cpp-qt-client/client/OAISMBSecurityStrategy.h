...
/*
 * OAISMBSecurityStrategy.h
 *
 * 
 */

#ifndef OAISMBSecurityStrategy_H
#define OAISMBSecurityStrategy_H
...
class OAISMBSecurityStrategy : public OAIEnum {
public:
    OAISMBSecurityStrategy();
    OAISMBSecurityStrategy(QString json);
    ~OAISMBSecurityStrategy() override;
    ...
    enum class eOAISMBSecurityStrategy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CLIENTSPECIFIED, 
        MANDATORYSIGNING, 
        MANDATORYENCRYPTION
    };
    OAISMBSecurityStrategy::eOAISMBSecurityStrategy getValue() const;
    void setValue(const OAISMBSecurityStrategy::eOAISMBSecurityStrategy& value);
...
private:
    ...
    eOAISMBSecurityStrategy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISMBSecurityStrategy)

#endif // OAISMBSecurityStrategy_H
