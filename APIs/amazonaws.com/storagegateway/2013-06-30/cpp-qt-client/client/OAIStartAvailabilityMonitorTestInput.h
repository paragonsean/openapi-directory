...
/*
 * OAIStartAvailabilityMonitorTestInput.h
 *
 * 
 */

#ifndef OAIStartAvailabilityMonitorTestInput_H
#define OAIStartAvailabilityMonitorTestInput_H
...
class OAIStartAvailabilityMonitorTestInput : public OAIObject {
public:
    OAIStartAvailabilityMonitorTestInput();
    OAIStartAvailabilityMonitorTestInput(QString json);
    ~OAIStartAvailabilityMonitorTestInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartAvailabilityMonitorTestInput)

#endif // OAIStartAvailabilityMonitorTestInput_H
