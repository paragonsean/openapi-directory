...
/*
 * OAIDescribeSMBFileSharesOutput.h
 *
 * DescribeSMBFileSharesOutput
 */

#ifndef OAIDescribeSMBFileSharesOutput_H
#define OAIDescribeSMBFileSharesOutput_H
...
class OAIDescribeSMBFileSharesOutput : public OAIObject {
public:
    OAIDescribeSMBFileSharesOutput();
    OAIDescribeSMBFileSharesOutput(QString json);
    ~OAIDescribeSMBFileSharesOutput() override;
    ...
    QList getSmbFileShareInfoList() const;
    void setSmbFileShareInfoList(const QList &smb_file_share_info_list);
    bool is_smb_file_share_info_list_Set() const;
    bool is_smb_file_share_info_list_Valid() const;
...
private:
    ...
    QList m_smb_file_share_info_list;
    bool m_smb_file_share_info_list_isSet;
    bool m_smb_file_share_info_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSMBFileSharesOutput)

#endif // OAIDescribeSMBFileSharesOutput_H
