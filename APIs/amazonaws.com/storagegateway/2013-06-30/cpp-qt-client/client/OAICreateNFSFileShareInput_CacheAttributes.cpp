...
OAICreateNFSFileShareInput_CacheAttributes::OAICreateNFSFileShareInput_CacheAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateNFSFileShareInput_CacheAttributes::OAICreateNFSFileShareInput_CacheAttributes() {
    this->initializeModel();
}

OAICreateNFSFileShareInput_CacheAttributes::~OAICreateNFSFileShareInput_CacheAttributes() {}

void OAICreateNFSFileShareInput_CacheAttributes::initializeModel() {

    m_cache_stale_timeout_in_seconds_isSet = false;
    m_cache_stale_timeout_in_seconds_isValid = false;
}

void OAICreateNFSFileShareInput_CacheAttributes::fromJson(QString jsonString) {
...
void OAICreateNFSFileShareInput_CacheAttributes::fromJsonObject(QJsonObject json) {
...
QString OAICreateNFSFileShareInput_CacheAttributes::asJson() const {
...
QJsonObject OAICreateNFSFileShareInput_CacheAttributes::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateNFSFileShareInput_CacheAttributes::getCacheStaleTimeoutInSeconds() const {
    return m_cache_stale_timeout_in_seconds;
}
void OAICreateNFSFileShareInput_CacheAttributes::setCacheStaleTimeoutInSeconds(const qint32 &cache_stale_timeout_in_seconds) {
    m_cache_stale_timeout_in_seconds = cache_stale_timeout_in_seconds;
    m_cache_stale_timeout_in_seconds_isSet = true;
}

bool OAICreateNFSFileShareInput_CacheAttributes::is_cache_stale_timeout_in_seconds_Set() const{
    return m_cache_stale_timeout_in_seconds_isSet;
}

bool OAICreateNFSFileShareInput_CacheAttributes::is_cache_stale_timeout_in_seconds_Valid() const{
    return m_cache_stale_timeout_in_seconds_isValid;
}

bool OAICreateNFSFileShareInput_CacheAttributes::isSet() const {
...
bool OAICreateNFSFileShareInput_CacheAttributes::isValid() const {
