...
OAIUpdateGatewayInformationOutput::OAIUpdateGatewayInformationOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateGatewayInformationOutput::OAIUpdateGatewayInformationOutput() {
    this->initializeModel();
}

OAIUpdateGatewayInformationOutput::~OAIUpdateGatewayInformationOutput() {}

void OAIUpdateGatewayInformationOutput::initializeModel() {
...
void OAIUpdateGatewayInformationOutput::fromJson(QString jsonString) {
...
void OAIUpdateGatewayInformationOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateGatewayInformationOutput::asJson() const {
...
QJsonObject OAIUpdateGatewayInformationOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateGatewayInformationOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateGatewayInformationOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateGatewayInformationOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateGatewayInformationOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QString OAIUpdateGatewayInformationOutput::getGatewayName() const {
    return m_gateway_name;
}
void OAIUpdateGatewayInformationOutput::setGatewayName(const QString &gateway_name) {
    m_gateway_name = gateway_name;
    m_gateway_name_isSet = true;
}

bool OAIUpdateGatewayInformationOutput::is_gateway_name_Set() const{
    return m_gateway_name_isSet;
}

bool OAIUpdateGatewayInformationOutput::is_gateway_name_Valid() const{
    return m_gateway_name_isValid;
}

bool OAIUpdateGatewayInformationOutput::isSet() const {
...
bool OAIUpdateGatewayInformationOutput::isValid() const {
