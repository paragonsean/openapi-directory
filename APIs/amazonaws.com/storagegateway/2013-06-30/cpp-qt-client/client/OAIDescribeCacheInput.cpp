...
OAIDescribeCacheInput::OAIDescribeCacheInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCacheInput::OAIDescribeCacheInput() {
    this->initializeModel();
}

OAIDescribeCacheInput::~OAIDescribeCacheInput() {}

void OAIDescribeCacheInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDescribeCacheInput::fromJson(QString jsonString) {
...
void OAIDescribeCacheInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeCacheInput::asJson() const {
...
QJsonObject OAIDescribeCacheInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeCacheInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeCacheInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeCacheInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeCacheInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDescribeCacheInput::isSet() const {
...
bool OAIDescribeCacheInput::isValid() const {
