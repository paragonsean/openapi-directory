...
/*
 * OAIAttachVolumeOutput.h
 *
 * AttachVolumeOutput
 */

#ifndef OAIAttachVolumeOutput_H
#define OAIAttachVolumeOutput_H
...
class OAIAttachVolumeOutput : public OAIObject {
public:
    OAIAttachVolumeOutput();
    OAIAttachVolumeOutput(QString json);
    ~OAIAttachVolumeOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachVolumeOutput)

#endif // OAIAttachVolumeOutput_H
