...
OAIAddWorkingStorageOutput::OAIAddWorkingStorageOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddWorkingStorageOutput::OAIAddWorkingStorageOutput() {
    this->initializeModel();
}

OAIAddWorkingStorageOutput::~OAIAddWorkingStorageOutput() {}

void OAIAddWorkingStorageOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIAddWorkingStorageOutput::fromJson(QString jsonString) {
...
void OAIAddWorkingStorageOutput::fromJsonObject(QJsonObject json) {
...
QString OAIAddWorkingStorageOutput::asJson() const {
...
QJsonObject OAIAddWorkingStorageOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddWorkingStorageOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIAddWorkingStorageOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIAddWorkingStorageOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIAddWorkingStorageOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIAddWorkingStorageOutput::isSet() const {
...
bool OAIAddWorkingStorageOutput::isValid() const {
