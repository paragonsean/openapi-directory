...
/*
 * OAIDeleteAutomaticTapeCreationPolicyOutput.h
 *
 * 
 */

#ifndef OAIDeleteAutomaticTapeCreationPolicyOutput_H
#define OAIDeleteAutomaticTapeCreationPolicyOutput_H
...
class OAIDeleteAutomaticTapeCreationPolicyOutput : public OAIObject {
public:
    OAIDeleteAutomaticTapeCreationPolicyOutput();
    OAIDeleteAutomaticTapeCreationPolicyOutput(QString json);
    ~OAIDeleteAutomaticTapeCreationPolicyOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAutomaticTapeCreationPolicyOutput)

#endif // OAIDeleteAutomaticTapeCreationPolicyOutput_H
