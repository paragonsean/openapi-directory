...
OAIRemoveTagsFromResourceInput::OAIRemoveTagsFromResourceInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemoveTagsFromResourceInput::OAIRemoveTagsFromResourceInput() {
    this->initializeModel();
}

OAIRemoveTagsFromResourceInput::~OAIRemoveTagsFromResourceInput() {}

void OAIRemoveTagsFromResourceInput::initializeModel() {
...
void OAIRemoveTagsFromResourceInput::fromJson(QString jsonString) {
...
void OAIRemoveTagsFromResourceInput::fromJsonObject(QJsonObject json) {
...
QString OAIRemoveTagsFromResourceInput::asJson() const {
...
QJsonObject OAIRemoveTagsFromResourceInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRemoveTagsFromResourceInput::getResourceArn() const {
    return m_resource_arn;
}
void OAIRemoveTagsFromResourceInput::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIRemoveTagsFromResourceInput::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIRemoveTagsFromResourceInput::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QList OAIRemoveTagsFromResourceInput::getTagKeys() const {
    return m_tag_keys;
}
void OAIRemoveTagsFromResourceInput::setTagKeys(const QList &tag_keys) {
    m_tag_keys = tag_keys;
    m_tag_keys_isSet = true;
}

bool OAIRemoveTagsFromResourceInput::is_tag_keys_Set() const{
    return m_tag_keys_isSet;
}

bool OAIRemoveTagsFromResourceInput::is_tag_keys_Valid() const{
    return m_tag_keys_isValid;
}

bool OAIRemoveTagsFromResourceInput::isSet() const {
...
bool OAIRemoveTagsFromResourceInput::isValid() const {
