...
OAIHostEnvironment::OAIHostEnvironment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHostEnvironment::OAIHostEnvironment() {
    this->initializeModel();
}

OAIHostEnvironment::~OAIHostEnvironment() {}

void OAIHostEnvironment::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIHostEnvironment::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIHostEnvironment::fromJson(QString jsonString) {
    
    if ( jsonString.compare("VMWARE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHostEnvironment::VMWARE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HYPER-V", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHostEnvironment::HYPER_V;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EC2", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHostEnvironment::EC2;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("KVM", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHostEnvironment::KVM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("OTHER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHostEnvironment::OTHER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SNOWBALL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHostEnvironment::SNOWBALL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIHostEnvironment::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIHostEnvironment::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIHostEnvironment::VMWARE:
            val = "VMWARE";
            break;
        case eOAIHostEnvironment::HYPER_V:
            val = "HYPER-V";
            break;
        case eOAIHostEnvironment::EC2:
            val = "EC2";
            break;
        case eOAIHostEnvironment::KVM:
            val = "KVM";
            break;
        case eOAIHostEnvironment::OTHER:
            val = "OTHER";
            break;
        case eOAIHostEnvironment::SNOWBALL:
            val = "SNOWBALL";
            break;
        default:
            break;
...
QJsonValue OAIHostEnvironment::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIHostEnvironment::eOAIHostEnvironment OAIHostEnvironment::getValue() const {
    return m_value;
}

void OAIHostEnvironment::setValue(const OAIHostEnvironment::eOAIHostEnvironment& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIHostEnvironment::isSet() const {
    
    return m_value_isSet;
}

bool OAIHostEnvironment::isValid() const {
