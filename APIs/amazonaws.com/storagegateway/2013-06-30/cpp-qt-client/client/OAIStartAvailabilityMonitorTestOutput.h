...
/*
 * OAIStartAvailabilityMonitorTestOutput.h
 *
 * 
 */

#ifndef OAIStartAvailabilityMonitorTestOutput_H
#define OAIStartAvailabilityMonitorTestOutput_H
...
class OAIStartAvailabilityMonitorTestOutput : public OAIObject {
public:
    OAIStartAvailabilityMonitorTestOutput();
    OAIStartAvailabilityMonitorTestOutput(QString json);
    ~OAIStartAvailabilityMonitorTestOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartAvailabilityMonitorTestOutput)

#endif // OAIStartAvailabilityMonitorTestOutput_H
