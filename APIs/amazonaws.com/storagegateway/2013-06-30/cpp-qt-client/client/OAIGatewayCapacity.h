...
/*
 * OAIGatewayCapacity.h
 *
 * 
 */

#ifndef OAIGatewayCapacity_H
#define OAIGatewayCapacity_H
...
class OAIGatewayCapacity : public OAIEnum {
public:
    OAIGatewayCapacity();
    OAIGatewayCapacity(QString json);
    ~OAIGatewayCapacity() override;
    ...
    enum class eOAIGatewayCapacity {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SMALL, 
        MEDIUM, 
        LARGE
    };
    OAIGatewayCapacity::eOAIGatewayCapacity getValue() const;
    void setValue(const OAIGatewayCapacity::eOAIGatewayCapacity& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGatewayCapacity)

#endif // OAIGatewayCapacity_H
