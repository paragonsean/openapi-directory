...
/*
 * OAICreateTapeWithBarcodeOutput.h
 *
 * CreateTapeOutput
 */

#ifndef OAICreateTapeWithBarcodeOutput_H
#define OAICreateTapeWithBarcodeOutput_H
...
class OAICreateTapeWithBarcodeOutput : public OAIObject {
public:
    OAICreateTapeWithBarcodeOutput();
    OAICreateTapeWithBarcodeOutput(QString json);
    ~OAICreateTapeWithBarcodeOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTapeWithBarcodeOutput)

#endif // OAICreateTapeWithBarcodeOutput_H
