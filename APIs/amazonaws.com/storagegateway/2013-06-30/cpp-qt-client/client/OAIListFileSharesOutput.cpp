...
OAIListFileSharesOutput::OAIListFileSharesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListFileSharesOutput::OAIListFileSharesOutput() {
    this->initializeModel();
}

OAIListFileSharesOutput::~OAIListFileSharesOutput() {}

void OAIListFileSharesOutput::initializeModel() {
    ...
    m_file_share_info_list_isSet = false;
    m_file_share_info_list_isValid = false;
}

void OAIListFileSharesOutput::fromJson(QString jsonString) {
...
void OAIListFileSharesOutput::fromJsonObject(QJsonObject json) {
    ...
    m_file_share_info_list_isValid = ::OpenAPI::fromJsonValue(m_file_share_info_list, json[QString("FileShareInfoList")]);
    m_file_share_info_list_isSet = !json[QString("FileShareInfoList")].isNull() && m_file_share_info_list_isValid;
}

QString OAIListFileSharesOutput::asJson() const {
...
QJsonObject OAIListFileSharesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_marker_isSet) {
    ...
    if (m_file_share_info_list.isSet()) {
        obj.insert(QString("FileShareInfoList"), ::OpenAPI::toJsonValue(m_file_share_info_list));
    }
    return obj;
}

QString OAIListFileSharesOutput::getMarker() const {
    return m_marker;
}
void OAIListFileSharesOutput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListFileSharesOutput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListFileSharesOutput::is_marker_Valid() const{
    return m_marker_isValid;
}

QString OAIListFileSharesOutput::getNextMarker() const {
    return m_next_marker;
}
void OAIListFileSharesOutput::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIListFileSharesOutput::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIListFileSharesOutput::is_next_marker_Valid() const{
    return m_next_marker_isValid;
}

QList OAIListFileSharesOutput::getFileShareInfoList() const {
    return m_file_share_info_list;
}
void OAIListFileSharesOutput::setFileShareInfoList(const QList &file_share_info_list) {
    m_file_share_info_list = file_share_info_list;
    m_file_share_info_list_isSet = true;
}

bool OAIListFileSharesOutput::is_file_share_info_list_Set() const{
    return m_file_share_info_list_isSet;
}

bool OAIListFileSharesOutput::is_file_share_info_list_Valid() const{
    return m_file_share_info_list_isValid;
}

bool OAIListFileSharesOutput::isSet() const {
...
bool OAIListFileSharesOutput::isValid() const {
