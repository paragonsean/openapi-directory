...
/*
 * OAIDescribeTapeArchivesOutput.h
 *
 * DescribeTapeArchivesOutput
 */

#ifndef OAIDescribeTapeArchivesOutput_H
#define OAIDescribeTapeArchivesOutput_H
...
class OAIDescribeTapeArchivesOutput : public OAIObject {
public:
    OAIDescribeTapeArchivesOutput();
    OAIDescribeTapeArchivesOutput(QString json);
    ~OAIDescribeTapeArchivesOutput() override;
    ...
    QList getTapeArchives() const;
    void setTapeArchives(const QList &tape_archives);
    bool is_tape_archives_Set() const;
    bool is_tape_archives_Valid() const;
...
private:
    ...
    QList m_tape_archives;
    bool m_tape_archives_isSet;
    bool m_tape_archives_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTapeArchivesOutput)

#endif // OAIDescribeTapeArchivesOutput_H
