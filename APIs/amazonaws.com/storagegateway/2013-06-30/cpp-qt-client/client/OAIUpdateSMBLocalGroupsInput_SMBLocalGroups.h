...
/*
 * OAIUpdateSMBLocalGroupsInput_SMBLocalGroups.h
 *
 * 
 */

#ifndef OAIUpdateSMBLocalGroupsInput_SMBLocalGroups_H
#define OAIUpdateSMBLocalGroupsInput_SMBLocalGroups_H
...
class OAIUpdateSMBLocalGroupsInput_SMBLocalGroups : public OAIObject {
public:
    OAIUpdateSMBLocalGroupsInput_SMBLocalGroups();
    OAIUpdateSMBLocalGroupsInput_SMBLocalGroups(QString json);
    ~OAIUpdateSMBLocalGroupsInput_SMBLocalGroups() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSMBLocalGroupsInput_SMBLocalGroups)

#endif // OAIUpdateSMBLocalGroupsInput_SMBLocalGroups_H
