...
public:
    ...
    QString getDiskNode() const;
    void setDiskNode(const QString &disk_node);
    bool is_disk_node_Set() const;
    bool is_disk_node_Valid() const;
    ...
    qint32 getDiskSizeInBytes() const;
    void setDiskSizeInBytes(const qint32 &disk_size_in_bytes);
    bool is_disk_size_in_bytes_Set() const;
    bool is_disk_size_in_bytes_Valid() const;

    QString getDiskAllocationType() const;
    void setDiskAllocationType(const QString &disk_allocation_type);
    bool is_disk_allocation_type_Set() const;
    bool is_disk_allocation_type_Valid() const;

    QString getDiskAllocationResource() const;
    void setDiskAllocationResource(const QString &disk_allocation_resource);
    bool is_disk_allocation_resource_Set() const;
    bool is_disk_allocation_resource_Valid() const;

    QList<QString> getDiskAttributeList() const;
    void setDiskAttributeList(const QList<QString> &disk_attribute_list);
    bool is_disk_attribute_list_Set() const;
    bool is_disk_attribute_list_Valid() const;
...
private:
    ...
    QString m_disk_node;
    bool m_disk_node_isSet;
    bool m_disk_node_isValid;

    QString m_disk_status;
    bool m_disk_status_isSet;
    bool m_disk_status_isValid;

    qint32 m_disk_size_in_bytes;
    bool m_disk_size_in_bytes_isSet;
    bool m_disk_size_in_bytes_isValid;

    QString m_disk_allocation_type;
    bool m_disk_allocation_type_isSet;
    bool m_disk_allocation_type_isValid;

    QString m_disk_allocation_resource;
    bool m_disk_allocation_resource_isSet;
    bool m_disk_allocation_resource_isValid;

    QList<QString> m_disk_attribute_list;
    bool m_disk_attribute_list_isSet;
    bool m_disk_attribute_list_isValid;
};
