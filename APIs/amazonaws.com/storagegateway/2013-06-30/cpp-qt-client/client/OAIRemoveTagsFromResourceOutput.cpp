...
OAIRemoveTagsFromResourceOutput::OAIRemoveTagsFromResourceOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemoveTagsFromResourceOutput::OAIRemoveTagsFromResourceOutput() {
    this->initializeModel();
}

OAIRemoveTagsFromResourceOutput::~OAIRemoveTagsFromResourceOutput() {}

void OAIRemoveTagsFromResourceOutput::initializeModel() {

    m_resource_arn_isSet = false;
    m_resource_arn_isValid = false;
}

void OAIRemoveTagsFromResourceOutput::fromJson(QString jsonString) {
...
void OAIRemoveTagsFromResourceOutput::fromJsonObject(QJsonObject json) {

    m_resource_arn_isValid = ::OpenAPI::fromJsonValue(m_resource_arn, json[QString("ResourceARN")]);
    m_resource_arn_isSet = !json[QString("ResourceARN")].isNull() && m_resource_arn_isValid;
}

QString OAIRemoveTagsFromResourceOutput::asJson() const {
...
QJsonObject OAIRemoveTagsFromResourceOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRemoveTagsFromResourceOutput::getResourceArn() const {
    return m_resource_arn;
}
void OAIRemoveTagsFromResourceOutput::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIRemoveTagsFromResourceOutput::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIRemoveTagsFromResourceOutput::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

bool OAIRemoveTagsFromResourceOutput::isSet() const {
...
bool OAIRemoveTagsFromResourceOutput::isValid() const {
