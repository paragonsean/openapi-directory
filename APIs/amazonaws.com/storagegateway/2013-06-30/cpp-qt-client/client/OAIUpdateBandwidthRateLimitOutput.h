...
/*
 * OAIUpdateBandwidthRateLimitOutput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway whose throttle information was updated.
 */

#ifndef OAIUpdateBandwidthRateLimitOutput_H
#define OAIUpdateBandwidthRateLimitOutput_H
...
class OAIUpdateBandwidthRateLimitOutput : public OAIObject {
public:
    OAIUpdateBandwidthRateLimitOutput();
    OAIUpdateBandwidthRateLimitOutput(QString json);
    ~OAIUpdateBandwidthRateLimitOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBandwidthRateLimitOutput)

#endif // OAIUpdateBandwidthRateLimitOutput_H
