...
/*
 * OAIUpdateGatewaySoftwareNowInput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway to update.
 */

#ifndef OAIUpdateGatewaySoftwareNowInput_H
#define OAIUpdateGatewaySoftwareNowInput_H
...
class OAIUpdateGatewaySoftwareNowInput : public OAIObject {
public:
    OAIUpdateGatewaySoftwareNowInput();
    OAIUpdateGatewaySoftwareNowInput(QString json);
    ~OAIUpdateGatewaySoftwareNowInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGatewaySoftwareNowInput)

#endif // OAIUpdateGatewaySoftwareNowInput_H
