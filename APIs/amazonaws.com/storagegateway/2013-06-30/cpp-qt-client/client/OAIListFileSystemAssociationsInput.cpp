...
OAIListFileSystemAssociationsInput::OAIListFileSystemAssociationsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListFileSystemAssociationsInput::OAIListFileSystemAssociationsInput() {
    this->initializeModel();
}

OAIListFileSystemAssociationsInput::~OAIListFileSystemAssociationsInput() {}

void OAIListFileSystemAssociationsInput::initializeModel() {
...
void OAIListFileSystemAssociationsInput::fromJson(QString jsonString) {
...
void OAIListFileSystemAssociationsInput::fromJsonObject(QJsonObject json) {
...
QString OAIListFileSystemAssociationsInput::asJson() const {
...
QJsonObject OAIListFileSystemAssociationsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListFileSystemAssociationsInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIListFileSystemAssociationsInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIListFileSystemAssociationsInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIListFileSystemAssociationsInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

qint32 OAIListFileSystemAssociationsInput::getLimit() const {
    return m_limit;
}
void OAIListFileSystemAssociationsInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListFileSystemAssociationsInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListFileSystemAssociationsInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListFileSystemAssociationsInput::getMarker() const {
    return m_marker;
}
void OAIListFileSystemAssociationsInput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListFileSystemAssociationsInput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListFileSystemAssociationsInput::is_marker_Valid() const{
    return m_marker_isValid;
}

bool OAIListFileSystemAssociationsInput::isSet() const {
...
bool OAIListFileSystemAssociationsInput::isValid() const {
