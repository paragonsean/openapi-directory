...
OAIDescribeSnapshotScheduleInput::OAIDescribeSnapshotScheduleInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeSnapshotScheduleInput::OAIDescribeSnapshotScheduleInput() {
    this->initializeModel();
}

OAIDescribeSnapshotScheduleInput::~OAIDescribeSnapshotScheduleInput() {}

void OAIDescribeSnapshotScheduleInput::initializeModel() {

    m_volume_arn_isSet = false;
    m_volume_arn_isValid = false;
}

void OAIDescribeSnapshotScheduleInput::fromJson(QString jsonString) {
...
void OAIDescribeSnapshotScheduleInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeSnapshotScheduleInput::asJson() const {
...
QJsonObject OAIDescribeSnapshotScheduleInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeSnapshotScheduleInput::getVolumeArn() const {
    return m_volume_arn;
}
void OAIDescribeSnapshotScheduleInput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAIDescribeSnapshotScheduleInput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAIDescribeSnapshotScheduleInput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

bool OAIDescribeSnapshotScheduleInput::isSet() const {
...
bool OAIDescribeSnapshotScheduleInput::isValid() const {
