...
/*
 * OAICreateCachediSCSIVolumeInput.h
 *
 * 
 */

#ifndef OAICreateCachediSCSIVolumeInput_H
#define OAICreateCachediSCSIVolumeInput_H
...
class OAICreateCachediSCSIVolumeInput : public OAIObject {
public:
    OAICreateCachediSCSIVolumeInput();
    OAICreateCachediSCSIVolumeInput(QString json);
    ~OAICreateCachediSCSIVolumeInput() override;
    ...
    QString getSourceVolumeArn() const;
    void setSourceVolumeArn(const QString &source_volume_arn);
    bool is_source_volume_arn_Set() const;
    bool is_source_volume_arn_Valid() const;
...
private:
    ...
    QString m_source_volume_arn;
    bool m_source_volume_arn_isSet;
    bool m_source_volume_arn_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCachediSCSIVolumeInput)

#endif // OAICreateCachediSCSIVolumeInput_H
