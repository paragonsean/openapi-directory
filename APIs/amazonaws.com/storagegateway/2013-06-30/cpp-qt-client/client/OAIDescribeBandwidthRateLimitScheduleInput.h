...
/*
 * OAIDescribeBandwidthRateLimitScheduleInput.h
 *
 * 
 */

#ifndef OAIDescribeBandwidthRateLimitScheduleInput_H
#define OAIDescribeBandwidthRateLimitScheduleInput_H
...
class OAIDescribeBandwidthRateLimitScheduleInput : public OAIObject {
public:
    OAIDescribeBandwidthRateLimitScheduleInput();
    OAIDescribeBandwidthRateLimitScheduleInput(QString json);
    ~OAIDescribeBandwidthRateLimitScheduleInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBandwidthRateLimitScheduleInput)

#endif // OAIDescribeBandwidthRateLimitScheduleInput_H
