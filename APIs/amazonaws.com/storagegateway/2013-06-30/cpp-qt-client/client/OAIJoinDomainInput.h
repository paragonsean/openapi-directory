...
/*
 * OAIJoinDomainInput.h
 *
 * JoinDomainInput
 */

#ifndef OAIJoinDomainInput_H
#define OAIJoinDomainInput_H
...
class OAIJoinDomainInput : public OAIObject {
public:
    OAIJoinDomainInput();
    OAIJoinDomainInput(QString json);
    ~OAIJoinDomainInput() override;
    ...
    QList getDomainControllers() const;
    void setDomainControllers(const QList &domain_controllers);
    bool is_domain_controllers_Set() const;
    bool is_domain_controllers_Valid() const;
...
private:
    ...
    QList m_domain_controllers;
    bool m_domain_controllers_isSet;
    bool m_domain_controllers_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJoinDomainInput)

#endif // OAIJoinDomainInput_H
