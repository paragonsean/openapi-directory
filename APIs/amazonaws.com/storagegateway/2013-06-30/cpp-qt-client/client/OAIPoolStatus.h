...
#ifndef OAIPoolStatus_H
#define OAIPoolStatus_H
...
class OAIPoolStatus : public OAIEnum {
public:
    OAIPoolStatus();
    OAIPoolStatus(QString json);
    ~OAIPoolStatus() override;
    ...
    enum class eOAIPoolStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE, 
        DELETED
    };
    OAIPoolStatus::eOAIPoolStatus getValue() const;
    void setValue(const OAIPoolStatus::eOAIPoolStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPoolStatus)

#endif // OAIPoolStatus_H
