...
/*
 * OAIDescribeChapCredentialsInput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the iSCSI volume target.
 */

#ifndef OAIDescribeChapCredentialsInput_H
#define OAIDescribeChapCredentialsInput_H
...
class OAIDescribeChapCredentialsInput : public OAIObject {
public:
    OAIDescribeChapCredentialsInput();
    OAIDescribeChapCredentialsInput(QString json);
    ~OAIDescribeChapCredentialsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeChapCredentialsInput)

#endif // OAIDescribeChapCredentialsInput_H
