...
OAIAttachVolumeOutput::OAIAttachVolumeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAttachVolumeOutput::OAIAttachVolumeOutput() {
    this->initializeModel();
}

OAIAttachVolumeOutput::~OAIAttachVolumeOutput() {}

void OAIAttachVolumeOutput::initializeModel() {
...
void OAIAttachVolumeOutput::fromJson(QString jsonString) {
...
void OAIAttachVolumeOutput::fromJsonObject(QJsonObject json) {
...
QString OAIAttachVolumeOutput::asJson() const {
...
QJsonObject OAIAttachVolumeOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAttachVolumeOutput::getVolumeArn() const {
    return m_volume_arn;
}
void OAIAttachVolumeOutput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAIAttachVolumeOutput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAIAttachVolumeOutput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

QString OAIAttachVolumeOutput::getTargetArn() const {
    return m_target_arn;
}
void OAIAttachVolumeOutput::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAIAttachVolumeOutput::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAIAttachVolumeOutput::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

bool OAIAttachVolumeOutput::isSet() const {
...
bool OAIAttachVolumeOutput::isValid() const {
