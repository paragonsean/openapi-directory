...
OAIUpdateSMBFileShareVisibilityOutput::OAIUpdateSMBFileShareVisibilityOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSMBFileShareVisibilityOutput::OAIUpdateSMBFileShareVisibilityOutput() {
    this->initializeModel();
}

OAIUpdateSMBFileShareVisibilityOutput::~OAIUpdateSMBFileShareVisibilityOutput() {}

void OAIUpdateSMBFileShareVisibilityOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIUpdateSMBFileShareVisibilityOutput::fromJson(QString jsonString) {
...
void OAIUpdateSMBFileShareVisibilityOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSMBFileShareVisibilityOutput::asJson() const {
...
QJsonObject OAIUpdateSMBFileShareVisibilityOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSMBFileShareVisibilityOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateSMBFileShareVisibilityOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateSMBFileShareVisibilityOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateSMBFileShareVisibilityOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIUpdateSMBFileShareVisibilityOutput::isSet() const {
...
bool OAIUpdateSMBFileShareVisibilityOutput::isValid() const {
