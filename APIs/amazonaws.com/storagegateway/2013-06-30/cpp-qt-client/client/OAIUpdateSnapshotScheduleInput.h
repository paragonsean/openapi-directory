...
/*
 * OAIUpdateSnapshotScheduleInput.h
 *
...
#ifndef OAIUpdateSnapshotScheduleInput_H
#define OAIUpdateSnapshotScheduleInput_H
...
class OAIUpdateSnapshotScheduleInput : public OAIObject {
public:
    OAIUpdateSnapshotScheduleInput();
    OAIUpdateSnapshotScheduleInput(QString json);
    ~OAIUpdateSnapshotScheduleInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSnapshotScheduleInput)

#endif // OAIUpdateSnapshotScheduleInput_H
