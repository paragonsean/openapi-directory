...
OAISetLocalConsolePasswordOutput::OAISetLocalConsolePasswordOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetLocalConsolePasswordOutput::OAISetLocalConsolePasswordOutput() {
    this->initializeModel();
}

OAISetLocalConsolePasswordOutput::~OAISetLocalConsolePasswordOutput() {}

void OAISetLocalConsolePasswordOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAISetLocalConsolePasswordOutput::fromJson(QString jsonString) {
...
void OAISetLocalConsolePasswordOutput::fromJsonObject(QJsonObject json) {
...
QString OAISetLocalConsolePasswordOutput::asJson() const {
...
QJsonObject OAISetLocalConsolePasswordOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAISetLocalConsolePasswordOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAISetLocalConsolePasswordOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAISetLocalConsolePasswordOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAISetLocalConsolePasswordOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAISetLocalConsolePasswordOutput::isSet() const {
...
bool OAISetLocalConsolePasswordOutput::isValid() const {
