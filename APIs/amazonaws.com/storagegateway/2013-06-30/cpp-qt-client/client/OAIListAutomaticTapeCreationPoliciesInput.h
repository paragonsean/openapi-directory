...
/*
 * OAIListAutomaticTapeCreationPoliciesInput.h
 *
 * 
 */

#ifndef OAIListAutomaticTapeCreationPoliciesInput_H
#define OAIListAutomaticTapeCreationPoliciesInput_H
...
class OAIListAutomaticTapeCreationPoliciesInput : public OAIObject {
public:
    OAIListAutomaticTapeCreationPoliciesInput();
    OAIListAutomaticTapeCreationPoliciesInput(QString json);
    ~OAIListAutomaticTapeCreationPoliciesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAutomaticTapeCreationPoliciesInput)

#endif // OAIListAutomaticTapeCreationPoliciesInput_H
