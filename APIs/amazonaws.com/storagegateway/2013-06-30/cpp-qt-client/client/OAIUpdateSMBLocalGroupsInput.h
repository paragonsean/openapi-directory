...
/*
 * OAIUpdateSMBLocalGroupsInput.h
 *
 * 
 */

#ifndef OAIUpdateSMBLocalGroupsInput_H
#define OAIUpdateSMBLocalGroupsInput_H
...
namespace OpenAPI {
class OAIUpdateSMBLocalGroupsInput_SMBLocalGroups;

class OAIUpdateSMBLocalGroupsInput : public OAIObject {
public:
    OAIUpdateSMBLocalGroupsInput();
    OAIUpdateSMBLocalGroupsInput(QString json);
    ~OAIUpdateSMBLocalGroupsInput() override;
    ...
    OAIUpdateSMBLocalGroupsInput_SMBLocalGroups getSmbLocalGroups() const;
    void setSmbLocalGroups(const OAIUpdateSMBLocalGroupsInput_SMBLocalGroups &smb_local_groups);
...
private:
    ...
    OAIUpdateSMBLocalGroupsInput_SMBLocalGroups m_smb_local_groups;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSMBLocalGroupsInput)

#endif // OAIUpdateSMBLocalGroupsInput_H
