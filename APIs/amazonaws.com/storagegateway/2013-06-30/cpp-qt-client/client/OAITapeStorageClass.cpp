...
OAITapeStorageClass::OAITapeStorageClass(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITapeStorageClass::OAITapeStorageClass() {
    this->initializeModel();
}

OAITapeStorageClass::~OAITapeStorageClass() {}

void OAITapeStorageClass::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITapeStorageClass::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITapeStorageClass::fromJson(QString jsonString) {
    
    if ( jsonString.compare("DEEP_ARCHIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAITapeStorageClass::DEEP_ARCHIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GLACIER", Qt::CaseInsensitive) == 0) {
        m_value = eOAITapeStorageClass::GLACIER;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITapeStorageClass::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITapeStorageClass::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITapeStorageClass::DEEP_ARCHIVE:
            val = "DEEP_ARCHIVE";
            break;
        case eOAITapeStorageClass::GLACIER:
            val = "GLACIER";
            break;
        default:
            break;
...
QJsonValue OAITapeStorageClass::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITapeStorageClass::eOAITapeStorageClass OAITapeStorageClass::getValue() const {
    return m_value;
}

void OAITapeStorageClass::setValue(const OAITapeStorageClass::eOAITapeStorageClass& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITapeStorageClass::isSet() const {
    
    return m_value_isSet;
}

bool OAITapeStorageClass::isValid() const {
