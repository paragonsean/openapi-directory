...
OAIListVolumeRecoveryPointsOutput::OAIListVolumeRecoveryPointsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListVolumeRecoveryPointsOutput::OAIListVolumeRecoveryPointsOutput() {
    this->initializeModel();
}

OAIListVolumeRecoveryPointsOutput::~OAIListVolumeRecoveryPointsOutput() {}

void OAIListVolumeRecoveryPointsOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;

    m_volume_recovery_point_infos_isSet = false;
    m_volume_recovery_point_infos_isValid = false;
}

void OAIListVolumeRecoveryPointsOutput::fromJson(QString jsonString) {
...
void OAIListVolumeRecoveryPointsOutput::fromJsonObject(QJsonObject json) {
    ...
    m_volume_recovery_point_infos_isValid = ::OpenAPI::fromJsonValue(m_volume_recovery_point_infos, json[QString("VolumeRecoveryPointInfos")]);
    m_volume_recovery_point_infos_isSet = !json[QString("VolumeRecoveryPointInfos")].isNull() && m_volume_recovery_point_infos_isValid;
}

QString OAIListVolumeRecoveryPointsOutput::asJson() const {
...
QJsonObject OAIListVolumeRecoveryPointsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_gateway_arn_isSet) {
        obj.insert(QString("GatewayARN"), ::OpenAPI::toJsonValue(m_gateway_arn));
    }
    if (m_volume_recovery_point_infos.isSet()) {
        obj.insert(QString("VolumeRecoveryPointInfos"), ::OpenAPI::toJsonValue(m_volume_recovery_point_infos));
    }
    return obj;
}

QString OAIListVolumeRecoveryPointsOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIListVolumeRecoveryPointsOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIListVolumeRecoveryPointsOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIListVolumeRecoveryPointsOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QList OAIListVolumeRecoveryPointsOutput::getVolumeRecoveryPointInfos() const {
    return m_volume_recovery_point_infos;
}
void OAIListVolumeRecoveryPointsOutput::setVolumeRecoveryPointInfos(const QList &volume_recovery_point_infos) {
    m_volume_recovery_point_infos = volume_recovery_point_infos;
    m_volume_recovery_point_infos_isSet = true;
}

bool OAIListVolumeRecoveryPointsOutput::is_volume_recovery_point_infos_Set() const{
    return m_volume_recovery_point_infos_isSet;
}

bool OAIListVolumeRecoveryPointsOutput::is_volume_recovery_point_infos_Valid() const{
    return m_volume_recovery_point_infos_isValid;
}

bool OAIListVolumeRecoveryPointsOutput::isSet() const {
...
bool OAIListVolumeRecoveryPointsOutput::isValid() const {
