...
OAISetSMBGuestPasswordInput::OAISetSMBGuestPasswordInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetSMBGuestPasswordInput::OAISetSMBGuestPasswordInput() {
    this->initializeModel();
}

OAISetSMBGuestPasswordInput::~OAISetSMBGuestPasswordInput() {}

void OAISetSMBGuestPasswordInput::initializeModel() {
...
void OAISetSMBGuestPasswordInput::fromJson(QString jsonString) {
...
void OAISetSMBGuestPasswordInput::fromJsonObject(QJsonObject json) {
...
QString OAISetSMBGuestPasswordInput::asJson() const {
...
QJsonObject OAISetSMBGuestPasswordInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAISetSMBGuestPasswordInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAISetSMBGuestPasswordInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAISetSMBGuestPasswordInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAISetSMBGuestPasswordInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QString OAISetSMBGuestPasswordInput::getPassword() const {
    return m_password;
}
void OAISetSMBGuestPasswordInput::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAISetSMBGuestPasswordInput::is_password_Set() const{
    return m_password_isSet;
}

bool OAISetSMBGuestPasswordInput::is_password_Valid() const{
    return m_password_isValid;
}

bool OAISetSMBGuestPasswordInput::isSet() const {
...
bool OAISetSMBGuestPasswordInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_gateway_arn_isValid && m_password_isValid && true;
}
