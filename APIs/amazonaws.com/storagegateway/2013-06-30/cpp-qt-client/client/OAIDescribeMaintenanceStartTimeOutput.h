...
/*
 * OAIDescribeMaintenanceStartTimeOutput.h
 *
...
#ifndef OAIDescribeMaintenanceStartTimeOutput_H
#define OAIDescribeMaintenanceStartTimeOutput_H
...
class OAIDescribeMaintenanceStartTimeOutput : public OAIObject {
public:
    OAIDescribeMaintenanceStartTimeOutput();
    OAIDescribeMaintenanceStartTimeOutput(QString json);
    ~OAIDescribeMaintenanceStartTimeOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMaintenanceStartTimeOutput)

#endif // OAIDescribeMaintenanceStartTimeOutput_H
