...
OAIStartAvailabilityMonitorTestOutput::OAIStartAvailabilityMonitorTestOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartAvailabilityMonitorTestOutput::OAIStartAvailabilityMonitorTestOutput() {
    this->initializeModel();
}

OAIStartAvailabilityMonitorTestOutput::~OAIStartAvailabilityMonitorTestOutput() {}

void OAIStartAvailabilityMonitorTestOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIStartAvailabilityMonitorTestOutput::fromJson(QString jsonString) {
...
void OAIStartAvailabilityMonitorTestOutput::fromJsonObject(QJsonObject json) {
...
QString OAIStartAvailabilityMonitorTestOutput::asJson() const {
...
QJsonObject OAIStartAvailabilityMonitorTestOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartAvailabilityMonitorTestOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIStartAvailabilityMonitorTestOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIStartAvailabilityMonitorTestOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIStartAvailabilityMonitorTestOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIStartAvailabilityMonitorTestOutput::isSet() const {
...
bool OAIStartAvailabilityMonitorTestOutput::isValid() const {
