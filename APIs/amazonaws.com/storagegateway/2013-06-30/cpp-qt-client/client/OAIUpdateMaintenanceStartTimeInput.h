...
/*
 * OAIUpdateMaintenanceStartTimeInput.h
 *
...
#ifndef OAIUpdateMaintenanceStartTimeInput_H
#define OAIUpdateMaintenanceStartTimeInput_H
...
class OAIUpdateMaintenanceStartTimeInput : public OAIObject {
public:
    OAIUpdateMaintenanceStartTimeInput();
    OAIUpdateMaintenanceStartTimeInput(QString json);
    ~OAIUpdateMaintenanceStartTimeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMaintenanceStartTimeInput)

#endif // OAIUpdateMaintenanceStartTimeInput_H
