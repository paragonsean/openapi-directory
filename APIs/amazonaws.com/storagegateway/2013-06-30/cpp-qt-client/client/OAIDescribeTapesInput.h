...
/*
 * OAIDescribeTapesInput.h
 *
 * DescribeTapesInput
 */

#ifndef OAIDescribeTapesInput_H
#define OAIDescribeTapesInput_H
...
class OAIDescribeTapesInput : public OAIObject {
public:
    OAIDescribeTapesInput();
    OAIDescribeTapesInput(QString json);
    ~OAIDescribeTapesInput() override;
    ...
    QList getTapeArns() const;
    void setTapeArns(const QList &tape_arns);
    bool is_tape_arns_Set() const;
    bool is_tape_arns_Valid() const;
...
private:
    ...
    QList m_tape_arns;
    bool m_tape_arns_isSet;
    bool m_tape_arns_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTapesInput)

#endif // OAIDescribeTapesInput_H
