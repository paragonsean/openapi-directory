...
/*
 * OAICreateNFSFileShareInput_CacheAttributes.h
 *
 * 
 */

#ifndef OAICreateNFSFileShareInput_CacheAttributes_H
#define OAICreateNFSFileShareInput_CacheAttributes_H
...
class OAICreateNFSFileShareInput_CacheAttributes : public OAIObject {
public:
    OAICreateNFSFileShareInput_CacheAttributes();
    OAICreateNFSFileShareInput_CacheAttributes(QString json);
    ~OAICreateNFSFileShareInput_CacheAttributes() override;
    ...
    qint32 getCacheStaleTimeoutInSeconds() const;
    void setCacheStaleTimeoutInSeconds(const qint32 &cache_stale_timeout_in_seconds);
    bool is_cache_stale_timeout_in_seconds_Set() const;
    bool is_cache_stale_timeout_in_seconds_Valid() const;
...
private:
    ...
    qint32 m_cache_stale_timeout_in_seconds;
    bool m_cache_stale_timeout_in_seconds_isSet;
    bool m_cache_stale_timeout_in_seconds_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateNFSFileShareInput_CacheAttributes)

#endif // OAICreateNFSFileShareInput_CacheAttributes_H
