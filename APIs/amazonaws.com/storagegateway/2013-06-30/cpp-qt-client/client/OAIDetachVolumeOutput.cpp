...
OAIDetachVolumeOutput::OAIDetachVolumeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetachVolumeOutput::OAIDetachVolumeOutput() {
    this->initializeModel();
}

OAIDetachVolumeOutput::~OAIDetachVolumeOutput() {}

void OAIDetachVolumeOutput::initializeModel() {

    m_volume_arn_isSet = false;
    m_volume_arn_isValid = false;
}

void OAIDetachVolumeOutput::fromJson(QString jsonString) {
...
void OAIDetachVolumeOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDetachVolumeOutput::asJson() const {
...
QJsonObject OAIDetachVolumeOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDetachVolumeOutput::getVolumeArn() const {
    return m_volume_arn;
}
void OAIDetachVolumeOutput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAIDetachVolumeOutput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAIDetachVolumeOutput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

bool OAIDetachVolumeOutput::isSet() const {
...
bool OAIDetachVolumeOutput::isValid() const {
