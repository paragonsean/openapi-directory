...
/*
 * OAIAssignTapePoolInput.h
 *
 * 
 */

#ifndef OAIAssignTapePoolInput_H
#define OAIAssignTapePoolInput_H
...
class OAIAssignTapePoolInput : public OAIObject {
public:
    OAIAssignTapePoolInput();
    OAIAssignTapePoolInput(QString json);
    ~OAIAssignTapePoolInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssignTapePoolInput)

#endif // OAIAssignTapePoolInput_H
