...
OAIDescribeWorkingStorageInput::OAIDescribeWorkingStorageInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeWorkingStorageInput::OAIDescribeWorkingStorageInput() {
    this->initializeModel();
}

OAIDescribeWorkingStorageInput::~OAIDescribeWorkingStorageInput() {}

void OAIDescribeWorkingStorageInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDescribeWorkingStorageInput::fromJson(QString jsonString) {
...
void OAIDescribeWorkingStorageInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeWorkingStorageInput::asJson() const {
...
QJsonObject OAIDescribeWorkingStorageInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeWorkingStorageInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeWorkingStorageInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeWorkingStorageInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeWorkingStorageInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDescribeWorkingStorageInput::isSet() const {
...
bool OAIDescribeWorkingStorageInput::isValid() const {
