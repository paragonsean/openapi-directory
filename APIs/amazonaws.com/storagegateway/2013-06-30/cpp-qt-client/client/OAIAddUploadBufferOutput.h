...
/*
 * OAIAddUploadBufferOutput.h
 *
 * 
 */

#ifndef OAIAddUploadBufferOutput_H
#define OAIAddUploadBufferOutput_H
...
class OAIAddUploadBufferOutput : public OAIObject {
public:
    OAIAddUploadBufferOutput();
    OAIAddUploadBufferOutput(QString json);
    ~OAIAddUploadBufferOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddUploadBufferOutput)

#endif // OAIAddUploadBufferOutput_H
