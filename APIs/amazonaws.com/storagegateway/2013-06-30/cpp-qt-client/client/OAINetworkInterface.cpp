...
QString OAINetworkInterface::getIpv4Address() const {
    return m_ipv4_address;
}
void OAINetworkInterface::setIpv4Address(const QString &ipv4_address) {
    m_ipv4_address = ipv4_address;
    m_ipv4_address_isSet = true;
}

bool OAINetworkInterface::is_ipv4_address_Set() const{
    return m_ipv4_address_isSet;
}

bool OAINetworkInterface::is_ipv4_address_Valid() const{
