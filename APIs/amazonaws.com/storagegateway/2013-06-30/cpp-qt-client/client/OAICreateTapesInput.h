...
/*
 * OAICreateTapesInput.h
 *
 * CreateTapesInput
 */

#ifndef OAICreateTapesInput_H
#define OAICreateTapesInput_H
...
class OAICreateTapesInput : public OAIObject {
public:
    OAICreateTapesInput();
    OAICreateTapesInput(QString json);
    ~OAICreateTapesInput() override;
    ...
    qint32 getNumTapesToCreate() const;
    void setNumTapesToCreate(const qint32 &num_tapes_to_create);
    bool is_num_tapes_to_create_Set() const;
    bool is_num_tapes_to_create_Valid() const;

    QString getTapeBarcodePrefix() const;
    void setTapeBarcodePrefix(const QString &tape_barcode_prefix);
    bool is_tape_barcode_prefix_Set() const;
    bool is_tape_barcode_prefix_Valid() const;
...
private:
    ...
    qint32 m_num_tapes_to_create;
    bool m_num_tapes_to_create_isSet;
    bool m_num_tapes_to_create_isValid;

    QString m_tape_barcode_prefix;
    bool m_tape_barcode_prefix_isSet;
    bool m_tape_barcode_prefix_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTapesInput)

#endif // OAICreateTapesInput_H
