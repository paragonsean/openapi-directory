...
OAIListLocalDisksOutput::OAIListLocalDisksOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListLocalDisksOutput::OAIListLocalDisksOutput() {
    this->initializeModel();
}

OAIListLocalDisksOutput::~OAIListLocalDisksOutput() {}

void OAIListLocalDisksOutput::initializeModel() {
...
void OAIListLocalDisksOutput::fromJson(QString jsonString) {
...
void OAIListLocalDisksOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListLocalDisksOutput::asJson() const {
...
QJsonObject OAIListLocalDisksOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListLocalDisksOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIListLocalDisksOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIListLocalDisksOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIListLocalDisksOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QList OAIListLocalDisksOutput::getDisks() const {
    return m_disks;
}
void OAIListLocalDisksOutput::setDisks(const QList &disks) {
    m_disks = disks;
    m_disks_isSet = true;
}

bool OAIListLocalDisksOutput::is_disks_Set() const{
    return m_disks_isSet;
}

bool OAIListLocalDisksOutput::is_disks_Valid() const{
    return m_disks_isValid;
}

bool OAIListLocalDisksOutput::isSet() const {
...
bool OAIListLocalDisksOutput::isValid() const {
