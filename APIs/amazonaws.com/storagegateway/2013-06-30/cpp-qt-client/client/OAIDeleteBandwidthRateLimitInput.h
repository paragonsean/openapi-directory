...
/*
 * OAIDeleteBandwidthRateLimitInput.h
 *
 * &lt;p&gt;A JSON object containing the following fields:&lt;/p&gt; &lt;ul&gt; &lt;li&gt; &lt;p&gt; &lt;a&gt;DeleteBandwidthRateLimitInput$BandwidthType&lt;/a&gt; &lt;/p&gt; &lt;/li&gt; &lt;/ul&gt;
 */

#ifndef OAIDeleteBandwidthRateLimitInput_H
#define OAIDeleteBandwidthRateLimitInput_H
...
class OAIDeleteBandwidthRateLimitInput : public OAIObject {
public:
    OAIDeleteBandwidthRateLimitInput();
    OAIDeleteBandwidthRateLimitInput(QString json);
    ~OAIDeleteBandwidthRateLimitInput() override;
    ...
    QString getBandwidthType() const;
    void setBandwidthType(const QString &bandwidth_type);
    bool is_bandwidth_type_Set() const;
    bool is_bandwidth_type_Valid() const;
...
private:
    ...
    QString m_bandwidth_type;
    bool m_bandwidth_type_isSet;
    bool m_bandwidth_type_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBandwidthRateLimitInput)

#endif // OAIDeleteBandwidthRateLimitInput_H
