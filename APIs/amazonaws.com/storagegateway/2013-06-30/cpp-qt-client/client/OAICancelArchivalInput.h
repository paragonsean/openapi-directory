...
/*
 * OAICancelArchivalInput.h
 *
 * CancelArchivalInput
 */

#ifndef OAICancelArchivalInput_H
#define OAICancelArchivalInput_H
...
class OAICancelArchivalInput : public OAIObject {
public:
    OAICancelArchivalInput();
    OAICancelArchivalInput(QString json);
    ~OAICancelArchivalInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelArchivalInput)

#endif // OAICancelArchivalInput_H
