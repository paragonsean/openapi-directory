...
/*
 * OAIAutomaticTapeCreationPolicyInfo.h
 *
 * Information about the gateway&#39;s automatic tape creation policies, including the automatic tape creation rules and the gateway that is using the policies.
 */

#ifndef OAIAutomaticTapeCreationPolicyInfo_H
#define OAIAutomaticTapeCreationPolicyInfo_H
...
class OAIAutomaticTapeCreationPolicyInfo : public OAIObject {
public:
    OAIAutomaticTapeCreationPolicyInfo();
    OAIAutomaticTapeCreationPolicyInfo(QString json);
    ~OAIAutomaticTapeCreationPolicyInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutomaticTapeCreationPolicyInfo)

#endif // OAIAutomaticTapeCreationPolicyInfo_H
