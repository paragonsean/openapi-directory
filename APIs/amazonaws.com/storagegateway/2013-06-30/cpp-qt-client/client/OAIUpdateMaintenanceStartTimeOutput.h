...
/*
 * OAIUpdateMaintenanceStartTimeOutput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway whose maintenance start time is updated.
 */

#ifndef OAIUpdateMaintenanceStartTimeOutput_H
#define OAIUpdateMaintenanceStartTimeOutput_H
...
class OAIUpdateMaintenanceStartTimeOutput : public OAIObject {
public:
    OAIUpdateMaintenanceStartTimeOutput();
    OAIUpdateMaintenanceStartTimeOutput(QString json);
    ~OAIUpdateMaintenanceStartTimeOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMaintenanceStartTimeOutput)

#endif // OAIUpdateMaintenanceStartTimeOutput_H
