...
OAIAddCacheOutput::OAIAddCacheOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddCacheOutput::OAIAddCacheOutput() {
    this->initializeModel();
}

OAIAddCacheOutput::~OAIAddCacheOutput() {}

void OAIAddCacheOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIAddCacheOutput::fromJson(QString jsonString) {
...
void OAIAddCacheOutput::fromJsonObject(QJsonObject json) {
...
QString OAIAddCacheOutput::asJson() const {
...
QJsonObject OAIAddCacheOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddCacheOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIAddCacheOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIAddCacheOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIAddCacheOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIAddCacheOutput::isSet() const {
...
bool OAIAddCacheOutput::isValid() const {
