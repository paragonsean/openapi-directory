...
OAIUpdateVTLDeviceTypeInput::OAIUpdateVTLDeviceTypeInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateVTLDeviceTypeInput::OAIUpdateVTLDeviceTypeInput() {
    this->initializeModel();
}

OAIUpdateVTLDeviceTypeInput::~OAIUpdateVTLDeviceTypeInput() {}

void OAIUpdateVTLDeviceTypeInput::initializeModel() {
...
void OAIUpdateVTLDeviceTypeInput::fromJson(QString jsonString) {
...
void OAIUpdateVTLDeviceTypeInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateVTLDeviceTypeInput::asJson() const {
...
QJsonObject OAIUpdateVTLDeviceTypeInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateVTLDeviceTypeInput::getVtlDeviceArn() const {
    return m_vtl_device_arn;
}
void OAIUpdateVTLDeviceTypeInput::setVtlDeviceArn(const QString &vtl_device_arn) {
    m_vtl_device_arn = vtl_device_arn;
    m_vtl_device_arn_isSet = true;
}

bool OAIUpdateVTLDeviceTypeInput::is_vtl_device_arn_Set() const{
    return m_vtl_device_arn_isSet;
}

bool OAIUpdateVTLDeviceTypeInput::is_vtl_device_arn_Valid() const{
    return m_vtl_device_arn_isValid;
}

QString OAIUpdateVTLDeviceTypeInput::getDeviceType() const {
    return m_device_type;
}
void OAIUpdateVTLDeviceTypeInput::setDeviceType(const QString &device_type) {
    m_device_type = device_type;
    m_device_type_isSet = true;
}

bool OAIUpdateVTLDeviceTypeInput::is_device_type_Set() const{
    return m_device_type_isSet;
}

bool OAIUpdateVTLDeviceTypeInput::is_device_type_Valid() const{
    return m_device_type_isValid;
}

bool OAIUpdateVTLDeviceTypeInput::isSet() const {
...
bool OAIUpdateVTLDeviceTypeInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_vtl_device_arn_isValid && m_device_type_isValid && true;
}
