...
OAIUpdateGatewaySoftwareNowInput::OAIUpdateGatewaySoftwareNowInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateGatewaySoftwareNowInput::OAIUpdateGatewaySoftwareNowInput() {
    this->initializeModel();
}

OAIUpdateGatewaySoftwareNowInput::~OAIUpdateGatewaySoftwareNowInput() {}

void OAIUpdateGatewaySoftwareNowInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIUpdateGatewaySoftwareNowInput::fromJson(QString jsonString) {
...
void OAIUpdateGatewaySoftwareNowInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateGatewaySoftwareNowInput::asJson() const {
...
QJsonObject OAIUpdateGatewaySoftwareNowInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateGatewaySoftwareNowInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateGatewaySoftwareNowInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateGatewaySoftwareNowInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateGatewaySoftwareNowInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIUpdateGatewaySoftwareNowInput::isSet() const {
...
bool OAIUpdateGatewaySoftwareNowInput::isValid() const {
