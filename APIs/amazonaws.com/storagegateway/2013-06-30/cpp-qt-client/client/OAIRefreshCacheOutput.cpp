...
OAIRefreshCacheOutput::OAIRefreshCacheOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRefreshCacheOutput::OAIRefreshCacheOutput() {
    this->initializeModel();
}

OAIRefreshCacheOutput::~OAIRefreshCacheOutput() {}

void OAIRefreshCacheOutput::initializeModel() {
...
void OAIRefreshCacheOutput::fromJson(QString jsonString) {
...
void OAIRefreshCacheOutput::fromJsonObject(QJsonObject json) {
...
QString OAIRefreshCacheOutput::asJson() const {
...
QJsonObject OAIRefreshCacheOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRefreshCacheOutput::getFileShareArn() const {
    return m_file_share_arn;
}
void OAIRefreshCacheOutput::setFileShareArn(const QString &file_share_arn) {
    m_file_share_arn = file_share_arn;
    m_file_share_arn_isSet = true;
}

bool OAIRefreshCacheOutput::is_file_share_arn_Set() const{
    return m_file_share_arn_isSet;
}

bool OAIRefreshCacheOutput::is_file_share_arn_Valid() const{
    return m_file_share_arn_isValid;
}

QString OAIRefreshCacheOutput::getNotificationId() const {
    return m_notification_id;
}
void OAIRefreshCacheOutput::setNotificationId(const QString &notification_id) {
    m_notification_id = notification_id;
    m_notification_id_isSet = true;
}

bool OAIRefreshCacheOutput::is_notification_id_Set() const{
    return m_notification_id_isSet;
}

bool OAIRefreshCacheOutput::is_notification_id_Valid() const{
    return m_notification_id_isValid;
}

bool OAIRefreshCacheOutput::isSet() const {
...
bool OAIRefreshCacheOutput::isValid() const {
