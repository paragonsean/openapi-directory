...
/*
 * OAIDescribeSnapshotScheduleInput.h
 *
 * A JSON object containing the &lt;a&gt;DescribeSnapshotScheduleInput$VolumeARN&lt;/a&gt; of the volume.
 */

#ifndef OAIDescribeSnapshotScheduleInput_H
#define OAIDescribeSnapshotScheduleInput_H
...
class OAIDescribeSnapshotScheduleInput : public OAIObject {
public:
    OAIDescribeSnapshotScheduleInput();
    OAIDescribeSnapshotScheduleInput(QString json);
    ~OAIDescribeSnapshotScheduleInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSnapshotScheduleInput)

#endif // OAIDescribeSnapshotScheduleInput_H
