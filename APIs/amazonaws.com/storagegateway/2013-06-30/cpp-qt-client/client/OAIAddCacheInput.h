...
#ifndef OAIAddCacheInput_H
#define OAIAddCacheInput_H
...
class OAIAddCacheInput : public OAIObject {
public:
    OAIAddCacheInput();
    OAIAddCacheInput(QString json);
    ~OAIAddCacheInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddCacheInput)

#endif // OAIAddCacheInput_H
