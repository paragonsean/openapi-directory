...
/*
 * OAICreateTapePoolOutput.h
 *
 * 
 */

#ifndef OAICreateTapePoolOutput_H
#define OAICreateTapePoolOutput_H
...
class OAICreateTapePoolOutput : public OAIObject {
public:
    OAICreateTapePoolOutput();
    OAICreateTapePoolOutput(QString json);
    ~OAICreateTapePoolOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTapePoolOutput)

#endif // OAICreateTapePoolOutput_H
