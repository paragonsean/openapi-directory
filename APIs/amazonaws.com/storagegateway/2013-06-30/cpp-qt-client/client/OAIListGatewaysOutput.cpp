...
OAIListGatewaysOutput::OAIListGatewaysOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGatewaysOutput::OAIListGatewaysOutput() {
    this->initializeModel();
}

OAIListGatewaysOutput::~OAIListGatewaysOutput() {}

void OAIListGatewaysOutput::initializeModel() {
...
void OAIListGatewaysOutput::fromJson(QString jsonString) {
...
void OAIListGatewaysOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListGatewaysOutput::asJson() const {
...
QJsonObject OAIListGatewaysOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_gateways.isSet()) {
...
QList OAIListGatewaysOutput::getGateways() const {
    return m_gateways;
}
void OAIListGatewaysOutput::setGateways(const QList &gateways) {
    m_gateways = gateways;
    m_gateways_isSet = true;
}

bool OAIListGatewaysOutput::is_gateways_Set() const{
    return m_gateways_isSet;
}

bool OAIListGatewaysOutput::is_gateways_Valid() const{
    return m_gateways_isValid;
}

QString OAIListGatewaysOutput::getMarker() const {
    return m_marker;
}
void OAIListGatewaysOutput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListGatewaysOutput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListGatewaysOutput::is_marker_Valid() const{
    return m_marker_isValid;
}

bool OAIListGatewaysOutput::isSet() const {
...
bool OAIListGatewaysOutput::isValid() const {
