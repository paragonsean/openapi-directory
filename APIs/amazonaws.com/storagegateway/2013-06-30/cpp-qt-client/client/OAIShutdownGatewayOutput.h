...
/*
 * OAIShutdownGatewayOutput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway that was shut down.
 */

#ifndef OAIShutdownGatewayOutput_H
#define OAIShutdownGatewayOutput_H
...
class OAIShutdownGatewayOutput : public OAIObject {
public:
    OAIShutdownGatewayOutput();
    OAIShutdownGatewayOutput(QString json);
    ~OAIShutdownGatewayOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShutdownGatewayOutput)

#endif // OAIShutdownGatewayOutput_H
