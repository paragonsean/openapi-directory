...
/*
 * OAIDescribeSMBFileSharesInput.h
 *
 * DescribeSMBFileSharesInput
 */

#ifndef OAIDescribeSMBFileSharesInput_H
#define OAIDescribeSMBFileSharesInput_H
...
class OAIDescribeSMBFileSharesInput : public OAIObject {
public:
    OAIDescribeSMBFileSharesInput();
    OAIDescribeSMBFileSharesInput(QString json);
    ~OAIDescribeSMBFileSharesInput() override;
    ...
    QList getFileShareArnList() const;
    void setFileShareArnList(const QList &file_share_arn_list);
    bool is_file_share_arn_list_Set() const;
    bool is_file_share_arn_list_Valid() const;
...
private:
    ...
    QList m_file_share_arn_list;
    bool m_file_share_arn_list_isSet;
    bool m_file_share_arn_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSMBFileSharesInput)

#endif // OAIDescribeSMBFileSharesInput_H
