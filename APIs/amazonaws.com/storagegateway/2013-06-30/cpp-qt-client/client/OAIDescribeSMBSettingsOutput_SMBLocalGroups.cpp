...
OAIDescribeSMBSettingsOutput_SMBLocalGroups::OAIDescribeSMBSettingsOutput_SMBLocalGroups(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeSMBSettingsOutput_SMBLocalGroups::OAIDescribeSMBSettingsOutput_SMBLocalGroups() {
    this->initializeModel();
}

OAIDescribeSMBSettingsOutput_SMBLocalGroups::~OAIDescribeSMBSettingsOutput_SMBLocalGroups() {}

void OAIDescribeSMBSettingsOutput_SMBLocalGroups::initializeModel() {

    m_gateway_admins_isSet = false;
    m_gateway_admins_isValid = false;
}

void OAIDescribeSMBSettingsOutput_SMBLocalGroups::fromJson(QString jsonString) {
...
void OAIDescribeSMBSettingsOutput_SMBLocalGroups::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeSMBSettingsOutput_SMBLocalGroups::asJson() const {
...
QJsonObject OAIDescribeSMBSettingsOutput_SMBLocalGroups::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeSMBSettingsOutput_SMBLocalGroups::getGatewayAdmins() const {
    return m_gateway_admins;
}
void OAIDescribeSMBSettingsOutput_SMBLocalGroups::setGatewayAdmins(const QList &gateway_admins) {
    m_gateway_admins = gateway_admins;
    m_gateway_admins_isSet = true;
}

bool OAIDescribeSMBSettingsOutput_SMBLocalGroups::is_gateway_admins_Set() const{
    return m_gateway_admins_isSet;
}

bool OAIDescribeSMBSettingsOutput_SMBLocalGroups::is_gateway_admins_Valid() const{
    return m_gateway_admins_isValid;
}

bool OAIDescribeSMBSettingsOutput_SMBLocalGroups::isSet() const {
...
bool OAIDescribeSMBSettingsOutput_SMBLocalGroups::isValid() const {
