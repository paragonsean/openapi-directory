...
OAIDeleteTapeOutput::OAIDeleteTapeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteTapeOutput::OAIDeleteTapeOutput() {
    this->initializeModel();
}

OAIDeleteTapeOutput::~OAIDeleteTapeOutput() {}

void OAIDeleteTapeOutput::initializeModel() {

    m_tape_arn_isSet = false;
    m_tape_arn_isValid = false;
}

void OAIDeleteTapeOutput::fromJson(QString jsonString) {
...
void OAIDeleteTapeOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteTapeOutput::asJson() const {
...
QJsonObject OAIDeleteTapeOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_arn_isSet) {
...
QString OAIDeleteTapeOutput::getTapeArn() const {
    return m_tape_arn;
}
void OAIDeleteTapeOutput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAIDeleteTapeOutput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAIDeleteTapeOutput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

bool OAIDeleteTapeOutput::isSet() const {
...
bool OAIDeleteTapeOutput::isValid() const {
