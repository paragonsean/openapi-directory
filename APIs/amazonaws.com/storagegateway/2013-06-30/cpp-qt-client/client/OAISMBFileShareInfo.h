...
#ifndef OAISMBFileShareInfo_H
#define OAISMBFileShareInfo_H
...
class OAISMBFileShareInfo : public OAIObject {
public:
    OAISMBFileShareInfo();
    OAISMBFileShareInfo(QString json);
    ~OAISMBFileShareInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISMBFileShareInfo)

#endif // OAISMBFileShareInfo_H
