...
#ifndef OAIListTapesInput_H
#define OAIListTapesInput_H
...
class OAIListTapesInput : public OAIObject {
public:
    OAIListTapesInput();
    OAIListTapesInput(QString json);
    ~OAIListTapesInput() override;
    ...
    QList<QString> getTapeArns() const;
    void setTapeArns(const QList<QString> &tape_arns);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTapesInput)

#endif // OAIListTapesInput_H
