...
OAIAddTagsToResourceOutput::OAIAddTagsToResourceOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddTagsToResourceOutput::OAIAddTagsToResourceOutput() {
    this->initializeModel();
}

OAIAddTagsToResourceOutput::~OAIAddTagsToResourceOutput() {}

void OAIAddTagsToResourceOutput::initializeModel() {

    m_resource_arn_isSet = false;
    m_resource_arn_isValid = false;
}

void OAIAddTagsToResourceOutput::fromJson(QString jsonString) {
...
void OAIAddTagsToResourceOutput::fromJsonObject(QJsonObject json) {

    m_resource_arn_isValid = ::OpenAPI::fromJsonValue(m_resource_arn, json[QString("ResourceARN")]);
    m_resource_arn_isSet = !json[QString("ResourceARN")].isNull() && m_resource_arn_isValid;
}

QString OAIAddTagsToResourceOutput::asJson() const {
...
QJsonObject OAIAddTagsToResourceOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddTagsToResourceOutput::getResourceArn() const {
    return m_resource_arn;
}
void OAIAddTagsToResourceOutput::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIAddTagsToResourceOutput::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIAddTagsToResourceOutput::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

bool OAIAddTagsToResourceOutput::isSet() const {
...
bool OAIAddTagsToResourceOutput::isValid() const {
