...
/*
 * OAIDeleteSnapshotScheduleOutput.h
 *
 * 
 */

#ifndef OAIDeleteSnapshotScheduleOutput_H
#define OAIDeleteSnapshotScheduleOutput_H
...
class OAIDeleteSnapshotScheduleOutput : public OAIObject {
public:
    OAIDeleteSnapshotScheduleOutput();
    OAIDeleteSnapshotScheduleOutput(QString json);
    ~OAIDeleteSnapshotScheduleOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSnapshotScheduleOutput)

#endif // OAIDeleteSnapshotScheduleOutput_H
