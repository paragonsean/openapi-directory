...
/*
 * OAINotifyWhenUploadedInput.h
 *
 * 
 */

#ifndef OAINotifyWhenUploadedInput_H
#define OAINotifyWhenUploadedInput_H
...
class OAINotifyWhenUploadedInput : public OAIObject {
public:
    OAINotifyWhenUploadedInput();
    OAINotifyWhenUploadedInput(QString json);
    ~OAINotifyWhenUploadedInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotifyWhenUploadedInput)

#endif // OAINotifyWhenUploadedInput_H
