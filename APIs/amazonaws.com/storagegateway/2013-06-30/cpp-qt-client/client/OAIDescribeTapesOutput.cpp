...
OAIDescribeTapesOutput::OAIDescribeTapesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTapesOutput::OAIDescribeTapesOutput() {
    this->initializeModel();
}

OAIDescribeTapesOutput::~OAIDescribeTapesOutput() {}

void OAIDescribeTapesOutput::initializeModel() {

    m_tapes_isSet = false;
    m_tapes_isValid = false;

    m_marker_isSet = false;
    m_marker_isValid = false;
}

void OAIDescribeTapesOutput::fromJson(QString jsonString) {
...
void OAIDescribeTapesOutput::fromJsonObject(QJsonObject json) {

    m_tapes_isValid = ::OpenAPI::fromJsonValue(m_tapes, json[QString("Tapes")]);
    m_tapes_isSet = !json[QString("Tapes")].isNull() && m_tapes_isValid;
...
QString OAIDescribeTapesOutput::asJson() const {
...
QJsonObject OAIDescribeTapesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_tapes.isSet()) {
        obj.insert(QString("Tapes"), ::OpenAPI::toJsonValue(m_tapes));
    }
    if (m_marker_isSet) {
...
QList OAIDescribeTapesOutput::getTapes() const {
    return m_tapes;
}
void OAIDescribeTapesOutput::setTapes(const QList &tapes) {
    m_tapes = tapes;
    m_tapes_isSet = true;
}

bool OAIDescribeTapesOutput::is_tapes_Set() const{
    return m_tapes_isSet;
}

bool OAIDescribeTapesOutput::is_tapes_Valid() const{
    return m_tapes_isValid;
}

QString OAIDescribeTapesOutput::getMarker() const {
    return m_marker;
}
void OAIDescribeTapesOutput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIDescribeTapesOutput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIDescribeTapesOutput::is_marker_Valid() const{
    return m_marker_isValid;
}

bool OAIDescribeTapesOutput::isSet() const {
...
bool OAIDescribeTapesOutput::isValid() const {
