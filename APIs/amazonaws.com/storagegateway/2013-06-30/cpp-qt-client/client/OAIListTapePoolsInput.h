...
/*
 * OAIListTapePoolsInput.h
 *
 * 
 */

#ifndef OAIListTapePoolsInput_H
#define OAIListTapePoolsInput_H
...
class OAIListTapePoolsInput : public OAIObject {
public:
    OAIListTapePoolsInput();
    OAIListTapePoolsInput(QString json);
    ~OAIListTapePoolsInput() override;
    ...
    QList getPoolArns() const;
    void setPoolArns(const QList &pool_arns);
    bool is_pool_arns_Set() const;
    bool is_pool_arns_Valid() const;
...
private:
    ...
    QList m_pool_arns;
    bool m_pool_arns_isSet;
    bool m_pool_arns_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTapePoolsInput)

#endif // OAIListTapePoolsInput_H
