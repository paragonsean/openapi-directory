...
OAIDescribeTapeRecoveryPointsOutput::OAIDescribeTapeRecoveryPointsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTapeRecoveryPointsOutput::OAIDescribeTapeRecoveryPointsOutput() {
    this->initializeModel();
}

OAIDescribeTapeRecoveryPointsOutput::~OAIDescribeTapeRecoveryPointsOutput() {}

void OAIDescribeTapeRecoveryPointsOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;

    m_tape_recovery_point_infos_isSet = false;
    m_tape_recovery_point_infos_isValid = false;

    m_marker_isSet = false;
    m_marker_isValid = false;
}

void OAIDescribeTapeRecoveryPointsOutput::fromJson(QString jsonString) {
...
void OAIDescribeTapeRecoveryPointsOutput::fromJsonObject(QJsonObject json) {
    ...
    m_tape_recovery_point_infos_isValid = ::OpenAPI::fromJsonValue(m_tape_recovery_point_infos, json[QString("TapeRecoveryPointInfos")]);
    m_tape_recovery_point_infos_isSet = !json[QString("TapeRecoveryPointInfos")].isNull() && m_tape_recovery_point_infos_isValid;
...
QString OAIDescribeTapeRecoveryPointsOutput::asJson() const {
...
QJsonObject OAIDescribeTapeRecoveryPointsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_gateway_arn_isSet) {
        obj.insert(QString("GatewayARN"), ::OpenAPI::toJsonValue(m_gateway_arn));
    }
    if (m_tape_recovery_point_infos.isSet()) {
        obj.insert(QString("TapeRecoveryPointInfos"), ::OpenAPI::toJsonValue(m_tape_recovery_point_infos));
    }
    if (m_marker_isSet) {
...
QString OAIDescribeTapeRecoveryPointsOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeTapeRecoveryPointsOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeTapeRecoveryPointsOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeTapeRecoveryPointsOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QList OAIDescribeTapeRecoveryPointsOutput::getTapeRecoveryPointInfos() const {
    return m_tape_recovery_point_infos;
}
void OAIDescribeTapeRecoveryPointsOutput::setTapeRecoveryPointInfos(const QList &tape_recovery_point_infos) {
    m_tape_recovery_point_infos = tape_recovery_point_infos;
    m_tape_recovery_point_infos_isSet = true;
}

bool OAIDescribeTapeRecoveryPointsOutput::is_tape_recovery_point_infos_Set() const{
    return m_tape_recovery_point_infos_isSet;
}

bool OAIDescribeTapeRecoveryPointsOutput::is_tape_recovery_point_infos_Valid() const{
    return m_tape_recovery_point_infos_isValid;
}

QString OAIDescribeTapeRecoveryPointsOutput::getMarker() const {
    return m_marker;
}
void OAIDescribeTapeRecoveryPointsOutput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIDescribeTapeRecoveryPointsOutput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIDescribeTapeRecoveryPointsOutput::is_marker_Valid() const{
    return m_marker_isValid;
}

bool OAIDescribeTapeRecoveryPointsOutput::isSet() const {
...
bool OAIDescribeTapeRecoveryPointsOutput::isValid() const {
