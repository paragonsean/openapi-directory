...
OAIUpdateFileSystemAssociationOutput::OAIUpdateFileSystemAssociationOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFileSystemAssociationOutput::OAIUpdateFileSystemAssociationOutput() {
    this->initializeModel();
}

OAIUpdateFileSystemAssociationOutput::~OAIUpdateFileSystemAssociationOutput() {}

void OAIUpdateFileSystemAssociationOutput::initializeModel() {

    m_file_system_association_arn_isSet = false;
    m_file_system_association_arn_isValid = false;
}

void OAIUpdateFileSystemAssociationOutput::fromJson(QString jsonString) {
...
void OAIUpdateFileSystemAssociationOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFileSystemAssociationOutput::asJson() const {
...
QJsonObject OAIUpdateFileSystemAssociationOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateFileSystemAssociationOutput::getFileSystemAssociationArn() const {
    return m_file_system_association_arn;
}
void OAIUpdateFileSystemAssociationOutput::setFileSystemAssociationArn(const QString &file_system_association_arn) {
    m_file_system_association_arn = file_system_association_arn;
    m_file_system_association_arn_isSet = true;
}

bool OAIUpdateFileSystemAssociationOutput::is_file_system_association_arn_Set() const{
    return m_file_system_association_arn_isSet;
}

bool OAIUpdateFileSystemAssociationOutput::is_file_system_association_arn_Valid() const{
    return m_file_system_association_arn_isValid;
}

bool OAIUpdateFileSystemAssociationOutput::isSet() const {
...
bool OAIUpdateFileSystemAssociationOutput::isValid() const {
