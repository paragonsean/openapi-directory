...
#ifndef OAIListVolumesOutput_H
#define OAIListVolumesOutput_H
...
class OAIListVolumesOutput : public OAIObject {
public:
    OAIListVolumesOutput();
    OAIListVolumesOutput(QString json);
    ~OAIListVolumesOutput() override;
    ...
    QList getVolumeInfos() const;
    void setVolumeInfos(const QList &volume_infos);
    bool is_volume_infos_Set() const;
    bool is_volume_infos_Valid() const;
...
private:
    ...
    QList m_volume_infos;
    bool m_volume_infos_isSet;
    bool m_volume_infos_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListVolumesOutput)

#endif // OAIListVolumesOutput_H
