...
OAIDescribeFileSystemAssociationsOutput::OAIDescribeFileSystemAssociationsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFileSystemAssociationsOutput::OAIDescribeFileSystemAssociationsOutput() {
    this->initializeModel();
}

OAIDescribeFileSystemAssociationsOutput::~OAIDescribeFileSystemAssociationsOutput() {}

void OAIDescribeFileSystemAssociationsOutput::initializeModel() {

    m_file_system_association_info_list_isSet = false;
    m_file_system_association_info_list_isValid = false;
}

void OAIDescribeFileSystemAssociationsOutput::fromJson(QString jsonString) {
...
void OAIDescribeFileSystemAssociationsOutput::fromJsonObject(QJsonObject json) {

    m_file_system_association_info_list_isValid = ::OpenAPI::fromJsonValue(m_file_system_association_info_list, json[QString("FileSystemAssociationInfoList")]);
    m_file_system_association_info_list_isSet = !json[QString("FileSystemAssociationInfoList")].isNull() && m_file_system_association_info_list_isValid;
}

QString OAIDescribeFileSystemAssociationsOutput::asJson() const {
...
QJsonObject OAIDescribeFileSystemAssociationsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_file_system_association_info_list.isSet()) {
        obj.insert(QString("FileSystemAssociationInfoList"), ::OpenAPI::toJsonValue(m_file_system_association_info_list));
    }
    return obj;
}

QList OAIDescribeFileSystemAssociationsOutput::getFileSystemAssociationInfoList() const {
    return m_file_system_association_info_list;
}
void OAIDescribeFileSystemAssociationsOutput::setFileSystemAssociationInfoList(const QList &file_system_association_info_list) {
    m_file_system_association_info_list = file_system_association_info_list;
    m_file_system_association_info_list_isSet = true;
}

bool OAIDescribeFileSystemAssociationsOutput::is_file_system_association_info_list_Set() const{
    return m_file_system_association_info_list_isSet;
}

bool OAIDescribeFileSystemAssociationsOutput::is_file_system_association_info_list_Valid() const{
    return m_file_system_association_info_list_isValid;
}

bool OAIDescribeFileSystemAssociationsOutput::isSet() const {
...
bool OAIDescribeFileSystemAssociationsOutput::isValid() const {
