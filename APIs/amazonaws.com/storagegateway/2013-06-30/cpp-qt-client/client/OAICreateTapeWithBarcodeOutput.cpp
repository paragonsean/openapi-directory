...
OAICreateTapeWithBarcodeOutput::OAICreateTapeWithBarcodeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTapeWithBarcodeOutput::OAICreateTapeWithBarcodeOutput() {
    this->initializeModel();
}

OAICreateTapeWithBarcodeOutput::~OAICreateTapeWithBarcodeOutput() {}

void OAICreateTapeWithBarcodeOutput::initializeModel() {

    m_tape_arn_isSet = false;
    m_tape_arn_isValid = false;
}

void OAICreateTapeWithBarcodeOutput::fromJson(QString jsonString) {
...
void OAICreateTapeWithBarcodeOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateTapeWithBarcodeOutput::asJson() const {
...
QJsonObject OAICreateTapeWithBarcodeOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_arn_isSet) {
...
QString OAICreateTapeWithBarcodeOutput::getTapeArn() const {
    return m_tape_arn;
}
void OAICreateTapeWithBarcodeOutput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAICreateTapeWithBarcodeOutput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAICreateTapeWithBarcodeOutput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

bool OAICreateTapeWithBarcodeOutput::isSet() const {
...
bool OAICreateTapeWithBarcodeOutput::isValid() const {
