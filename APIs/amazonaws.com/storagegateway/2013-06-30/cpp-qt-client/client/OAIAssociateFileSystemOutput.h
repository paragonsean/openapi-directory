...
/*
 * OAIAssociateFileSystemOutput.h
 *
 * 
 */

#ifndef OAIAssociateFileSystemOutput_H
#define OAIAssociateFileSystemOutput_H
...
class OAIAssociateFileSystemOutput : public OAIObject {
public:
    OAIAssociateFileSystemOutput();
    OAIAssociateFileSystemOutput(QString json);
    ~OAIAssociateFileSystemOutput() override;
    ...
    QString getFileSystemAssociationArn() const;
    void setFileSystemAssociationArn(const QString &file_system_association_arn);
    bool is_file_system_association_arn_Set() const;
    bool is_file_system_association_arn_Valid() const;
...
private:
    ...
    QString m_file_system_association_arn;
    bool m_file_system_association_arn_isSet;
    bool m_file_system_association_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAssociateFileSystemOutput)

#endif // OAIAssociateFileSystemOutput_H
