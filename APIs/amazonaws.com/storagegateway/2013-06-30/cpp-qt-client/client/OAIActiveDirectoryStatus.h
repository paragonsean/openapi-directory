...
/*
 * OAIActiveDirectoryStatus.h
 *
 * 
 */

#ifndef OAIActiveDirectoryStatus_H
#define OAIActiveDirectoryStatus_H
...
class OAIActiveDirectoryStatus : public OAIEnum {
public:
    OAIActiveDirectoryStatus();
    OAIActiveDirectoryStatus(QString json);
    ~OAIActiveDirectoryStatus() override;
    ...
    enum class eOAIActiveDirectoryStatus {
    ...
    OAIActiveDirectoryStatus::eOAIActiveDirectoryStatus getValue() const;
    void setValue(const OAIActiveDirectoryStatus::eOAIActiveDirectoryStatus& value);
...
private:
    ...
    eOAIActiveDirectoryStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActiveDirectoryStatus)

#endif // OAIActiveDirectoryStatus_H
