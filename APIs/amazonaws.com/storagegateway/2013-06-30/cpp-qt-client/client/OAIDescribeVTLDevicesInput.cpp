...
OAIDescribeVTLDevicesInput::OAIDescribeVTLDevicesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeVTLDevicesInput::OAIDescribeVTLDevicesInput() {
    this->initializeModel();
}

OAIDescribeVTLDevicesInput::~OAIDescribeVTLDevicesInput() {}

void OAIDescribeVTLDevicesInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;

    m_vtl_device_arns_isSet = false;
    m_vtl_device_arns_isValid = false;
...
void OAIDescribeVTLDevicesInput::fromJson(QString jsonString) {
...
void OAIDescribeVTLDevicesInput::fromJsonObject(QJsonObject json) {
    ...
    m_vtl_device_arns_isValid = ::OpenAPI::fromJsonValue(m_vtl_device_arns, json[QString("VTLDeviceARNs")]);
    m_vtl_device_arns_isSet = !json[QString("VTLDeviceARNs")].isNull() && m_vtl_device_arns_isValid;
...
QString OAIDescribeVTLDevicesInput::asJson() const {
...
QJsonObject OAIDescribeVTLDevicesInput::asJsonObject() const {
    QJsonObject obj;
    if (m_gateway_arn_isSet) {
        obj.insert(QString("GatewayARN"), ::OpenAPI::toJsonValue(m_gateway_arn));
    }
    if (m_vtl_device_arns.isSet()) {
        obj.insert(QString("VTLDeviceARNs"), ::OpenAPI::toJsonValue(m_vtl_device_arns));
    }
    if (m_marker_isSet) {
...
QString OAIDescribeVTLDevicesInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeVTLDevicesInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeVTLDevicesInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeVTLDevicesInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QList OAIDescribeVTLDevicesInput::getVtlDeviceArns() const {
    return m_vtl_device_arns;
}
void OAIDescribeVTLDevicesInput::setVtlDeviceArns(const QList &vtl_device_arns) {
    m_vtl_device_arns = vtl_device_arns;
    m_vtl_device_arns_isSet = true;
}

bool OAIDescribeVTLDevicesInput::is_vtl_device_arns_Set() const{
    return m_vtl_device_arns_isSet;
}

bool OAIDescribeVTLDevicesInput::is_vtl_device_arns_Valid() const{
    return m_vtl_device_arns_isValid;
}

QString OAIDescribeVTLDevicesInput::getMarker() const {
    return m_marker;
}
void OAIDescribeVTLDevicesInput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIDescribeVTLDevicesInput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIDescribeVTLDevicesInput::is_marker_Valid() const{
    return m_marker_isValid;
}

qint32 OAIDescribeVTLDevicesInput::getLimit() const {
    return m_limit;
}
void OAIDescribeVTLDevicesInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeVTLDevicesInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeVTLDevicesInput::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAIDescribeVTLDevicesInput::isSet() const {
...
bool OAIDescribeVTLDevicesInput::isValid() const {
