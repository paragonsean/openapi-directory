...
OAIUpdateSMBLocalGroupsInput::OAIUpdateSMBLocalGroupsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSMBLocalGroupsInput::OAIUpdateSMBLocalGroupsInput() {
    this->initializeModel();
}

OAIUpdateSMBLocalGroupsInput::~OAIUpdateSMBLocalGroupsInput() {}

void OAIUpdateSMBLocalGroupsInput::initializeModel() {
...
void OAIUpdateSMBLocalGroupsInput::fromJson(QString jsonString) {
...
void OAIUpdateSMBLocalGroupsInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSMBLocalGroupsInput::asJson() const {
...
QJsonObject OAIUpdateSMBLocalGroupsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSMBLocalGroupsInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateSMBLocalGroupsInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateSMBLocalGroupsInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateSMBLocalGroupsInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

OAIUpdateSMBLocalGroupsInput_SMBLocalGroups OAIUpdateSMBLocalGroupsInput::getSmbLocalGroups() const {
    return m_smb_local_groups;
}
void OAIUpdateSMBLocalGroupsInput::setSmbLocalGroups(const OAIUpdateSMBLocalGroupsInput_SMBLocalGroups &smb_local_groups) {
    m_smb_local_groups = smb_local_groups;
    m_smb_local_groups_isSet = true;
}

bool OAIUpdateSMBLocalGroupsInput::is_smb_local_groups_Set() const{
    return m_smb_local_groups_isSet;
}

bool OAIUpdateSMBLocalGroupsInput::is_smb_local_groups_Valid() const{
    return m_smb_local_groups_isValid;
}

bool OAIUpdateSMBLocalGroupsInput::isSet() const {
...
bool OAIUpdateSMBLocalGroupsInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_gateway_arn_isValid && m_smb_local_groups_isValid && true;
}
