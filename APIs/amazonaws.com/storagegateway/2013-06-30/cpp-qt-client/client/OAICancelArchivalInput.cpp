...
OAICancelArchivalInput::OAICancelArchivalInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICancelArchivalInput::OAICancelArchivalInput() {
    this->initializeModel();
}

OAICancelArchivalInput::~OAICancelArchivalInput() {}

void OAICancelArchivalInput::initializeModel() {
...
void OAICancelArchivalInput::fromJson(QString jsonString) {
...
void OAICancelArchivalInput::fromJsonObject(QJsonObject json) {
...
QString OAICancelArchivalInput::asJson() const {
...
QJsonObject OAICancelArchivalInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICancelArchivalInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAICancelArchivalInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAICancelArchivalInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAICancelArchivalInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QString OAICancelArchivalInput::getTapeArn() const {
    return m_tape_arn;
}
void OAICancelArchivalInput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAICancelArchivalInput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAICancelArchivalInput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

bool OAICancelArchivalInput::isSet() const {
...
bool OAICancelArchivalInput::isValid() const {
