...
OAIDeleteChapCredentialsOutput::OAIDeleteChapCredentialsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteChapCredentialsOutput::OAIDeleteChapCredentialsOutput() {
    this->initializeModel();
}

OAIDeleteChapCredentialsOutput::~OAIDeleteChapCredentialsOutput() {}

void OAIDeleteChapCredentialsOutput::initializeModel() {
...
void OAIDeleteChapCredentialsOutput::fromJson(QString jsonString) {
...
void OAIDeleteChapCredentialsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteChapCredentialsOutput::asJson() const {
...
QJsonObject OAIDeleteChapCredentialsOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteChapCredentialsOutput::getTargetArn() const {
    return m_target_arn;
}
void OAIDeleteChapCredentialsOutput::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAIDeleteChapCredentialsOutput::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAIDeleteChapCredentialsOutput::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

QString OAIDeleteChapCredentialsOutput::getInitiatorName() const {
    return m_initiator_name;
}
void OAIDeleteChapCredentialsOutput::setInitiatorName(const QString &initiator_name) {
    m_initiator_name = initiator_name;
    m_initiator_name_isSet = true;
}

bool OAIDeleteChapCredentialsOutput::is_initiator_name_Set() const{
    return m_initiator_name_isSet;
}

bool OAIDeleteChapCredentialsOutput::is_initiator_name_Valid() const{
    return m_initiator_name_isValid;
}

bool OAIDeleteChapCredentialsOutput::isSet() const {
...
bool OAIDeleteChapCredentialsOutput::isValid() const {
