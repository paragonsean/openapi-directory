...
OAIObjectACL::OAIObjectACL(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIObjectACL::OAIObjectACL() {
    this->initializeModel();
}

OAIObjectACL::~OAIObjectACL() {}

void OAIObjectACL::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIObjectACL::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIObjectACL::fromJson(QString jsonString) {
    
    if ( jsonString.compare("private", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectACL::PRIVATE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("public-read", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectACL::PUBLIC_READ;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("public-read-write", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectACL::PUBLIC_READ_WRITE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("authenticated-read", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectACL::AUTHENTICATED_READ;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("bucket-owner-read", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectACL::BUCKET_OWNER_READ;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("bucket-owner-full-control", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectACL::BUCKET_OWNER_FULL_CONTROL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("aws-exec-read", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectACL::AWS_EXEC_READ;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIObjectACL::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIObjectACL::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIObjectACL::PRIVATE:
            val = "private";
            break;
        case eOAIObjectACL::PUBLIC_READ:
            val = "public-read";
            break;
        case eOAIObjectACL::PUBLIC_READ_WRITE:
            val = "public-read-write";
            break;
        case eOAIObjectACL::AUTHENTICATED_READ:
            val = "authenticated-read";
            break;
        case eOAIObjectACL::BUCKET_OWNER_READ:
            val = "bucket-owner-read";
            break;
        case eOAIObjectACL::BUCKET_OWNER_FULL_CONTROL:
            val = "bucket-owner-full-control";
            break;
        case eOAIObjectACL::AWS_EXEC_READ:
            val = "aws-exec-read";
            break;
        default:
            break;
...
QJsonValue OAIObjectACL::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIObjectACL::eOAIObjectACL OAIObjectACL::getValue() const {
    return m_value;
}

void OAIObjectACL::setValue(const OAIObjectACL::eOAIObjectACL& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIObjectACL::isSet() const {
    
    return m_value_isSet;
}

bool OAIObjectACL::isValid() const {
