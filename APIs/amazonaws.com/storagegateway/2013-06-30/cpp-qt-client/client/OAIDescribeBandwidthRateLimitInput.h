...
/*
 * OAIDescribeBandwidthRateLimitInput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway.
 */

#ifndef OAIDescribeBandwidthRateLimitInput_H
#define OAIDescribeBandwidthRateLimitInput_H
...
class OAIDescribeBandwidthRateLimitInput : public OAIObject {
public:
    OAIDescribeBandwidthRateLimitInput();
    OAIDescribeBandwidthRateLimitInput(QString json);
    ~OAIDescribeBandwidthRateLimitInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBandwidthRateLimitInput)

#endif // OAIDescribeBandwidthRateLimitInput_H
