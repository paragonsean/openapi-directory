...
/*
 * OAICreateNFSFileShareInput.h
 *
 * CreateNFSFileShareInput
 */

#ifndef OAICreateNFSFileShareInput_H
#define OAICreateNFSFileShareInput_H
...
namespace OpenAPI {
class OAICreateNFSFileShareInput_NFSFileShareDefaults;
class OAICreateNFSFileShareInput_CacheAttributes;

class OAICreateNFSFileShareInput : public OAIObject {
public:
    OAICreateNFSFileShareInput();
    OAICreateNFSFileShareInput(QString json);
    ~OAICreateNFSFileShareInput() override;
    ...
    OAICreateNFSFileShareInput_NFSFileShareDefaults getNfsFileShareDefaults() const;
    void setNfsFileShareDefaults(const OAICreateNFSFileShareInput_NFSFileShareDefaults &nfs_file_share_defaults);
...
private:
    ...
    OAICreateNFSFileShareInput_NFSFileShareDefaults m_nfs_file_share_defaults;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNFSFileShareInput)

#endif // OAICreateNFSFileShareInput_H
