...
/*
 * OAIDescribeFileSystemAssociationsOutput.h
 *
 * 
 */

#ifndef OAIDescribeFileSystemAssociationsOutput_H
#define OAIDescribeFileSystemAssociationsOutput_H
...
class OAIDescribeFileSystemAssociationsOutput : public OAIObject {
public:
    OAIDescribeFileSystemAssociationsOutput();
    OAIDescribeFileSystemAssociationsOutput(QString json);
    ~OAIDescribeFileSystemAssociationsOutput() override;
    ...
    QList getFileSystemAssociationInfoList() const;
    void setFileSystemAssociationInfoList(const QList &file_system_association_info_list);
    bool is_file_system_association_info_list_Set() const;
    bool is_file_system_association_info_list_Valid() const;
...
private:
    ...
    QList m_file_system_association_info_list;
    bool m_file_system_association_info_list_isSet;
    bool m_file_system_association_info_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFileSystemAssociationsOutput)

#endif // OAIDescribeFileSystemAssociationsOutput_H
