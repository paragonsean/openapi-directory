...
/*
 * OAIDisableGatewayInput.h
 *
 * DisableGatewayInput
 */

#ifndef OAIDisableGatewayInput_H
#define OAIDisableGatewayInput_H
...
class OAIDisableGatewayInput : public OAIObject {
public:
    OAIDisableGatewayInput();
    OAIDisableGatewayInput(QString json);
    ~OAIDisableGatewayInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisableGatewayInput)

#endif // OAIDisableGatewayInput_H
