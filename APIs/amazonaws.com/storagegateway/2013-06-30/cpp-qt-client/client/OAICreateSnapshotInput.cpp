...
OAICreateSnapshotInput::OAICreateSnapshotInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSnapshotInput::OAICreateSnapshotInput() {
    this->initializeModel();
}

OAICreateSnapshotInput::~OAICreateSnapshotInput() {}

void OAICreateSnapshotInput::initializeModel() {

    m_volume_arn_isSet = false;
    m_volume_arn_isValid = false;

    m_snapshot_description_isSet = false;
    m_snapshot_description_isValid = false;

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAICreateSnapshotInput::fromJson(QString jsonString) {
...
void OAICreateSnapshotInput::fromJsonObject(QJsonObject json) {
    ...
    m_snapshot_description_isValid = ::OpenAPI::fromJsonValue(m_snapshot_description, json[QString("SnapshotDescription")]);
    m_snapshot_description_isSet = !json[QString("SnapshotDescription")].isNull() && m_snapshot_description_isValid;

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAICreateSnapshotInput::asJson() const {
...
QJsonObject OAICreateSnapshotInput::asJsonObject() const {
    QJsonObject obj;
    if (m_volume_arn_isSet) {
        obj.insert(QString("VolumeARN"), ::OpenAPI::toJsonValue(m_volume_arn));
    }
    if (m_snapshot_description_isSet) {
        obj.insert(QString("SnapshotDescription"), ::OpenAPI::toJsonValue(m_snapshot_description));
    }
    if (m_tags.isSet()) {
...
QString OAICreateSnapshotInput::getVolumeArn() const {
    return m_volume_arn;
}
void OAICreateSnapshotInput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAICreateSnapshotInput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAICreateSnapshotInput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

QString OAICreateSnapshotInput::getSnapshotDescription() const {
    return m_snapshot_description;
}
void OAICreateSnapshotInput::setSnapshotDescription(const QString &snapshot_description) {
    m_snapshot_description = snapshot_description;
    m_snapshot_description_isSet = true;
}

bool OAICreateSnapshotInput::is_snapshot_description_Set() const{
    return m_snapshot_description_isSet;
}

bool OAICreateSnapshotInput::is_snapshot_description_Valid() const{
    return m_snapshot_description_isValid;
}

QList OAICreateSnapshotInput::getTags() const {
    return m_tags;
}
void OAICreateSnapshotInput::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateSnapshotInput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateSnapshotInput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateSnapshotInput::isSet() const {
...
bool OAICreateSnapshotInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_volume_arn_isValid && m_snapshot_description_isValid && true;
}
