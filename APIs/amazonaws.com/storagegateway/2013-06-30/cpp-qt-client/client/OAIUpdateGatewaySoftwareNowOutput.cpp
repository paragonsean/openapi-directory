...
OAIUpdateGatewaySoftwareNowOutput::OAIUpdateGatewaySoftwareNowOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateGatewaySoftwareNowOutput::OAIUpdateGatewaySoftwareNowOutput() {
    this->initializeModel();
}

OAIUpdateGatewaySoftwareNowOutput::~OAIUpdateGatewaySoftwareNowOutput() {}

void OAIUpdateGatewaySoftwareNowOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIUpdateGatewaySoftwareNowOutput::fromJson(QString jsonString) {
...
void OAIUpdateGatewaySoftwareNowOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateGatewaySoftwareNowOutput::asJson() const {
...
QJsonObject OAIUpdateGatewaySoftwareNowOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateGatewaySoftwareNowOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIUpdateGatewaySoftwareNowOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIUpdateGatewaySoftwareNowOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIUpdateGatewaySoftwareNowOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIUpdateGatewaySoftwareNowOutput::isSet() const {
...
bool OAIUpdateGatewaySoftwareNowOutput::isValid() const {
