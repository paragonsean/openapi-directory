...
OAIListAutomaticTapeCreationPoliciesOutput::OAIListAutomaticTapeCreationPoliciesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAutomaticTapeCreationPoliciesOutput::OAIListAutomaticTapeCreationPoliciesOutput() {
    this->initializeModel();
}

OAIListAutomaticTapeCreationPoliciesOutput::~OAIListAutomaticTapeCreationPoliciesOutput() {}

void OAIListAutomaticTapeCreationPoliciesOutput::initializeModel() {

    m_automatic_tape_creation_policy_infos_isSet = false;
    m_automatic_tape_creation_policy_infos_isValid = false;
}

void OAIListAutomaticTapeCreationPoliciesOutput::fromJson(QString jsonString) {
...
void OAIListAutomaticTapeCreationPoliciesOutput::fromJsonObject(QJsonObject json) {

    m_automatic_tape_creation_policy_infos_isValid = ::OpenAPI::fromJsonValue(m_automatic_tape_creation_policy_infos, json[QString("AutomaticTapeCreationPolicyInfos")]);
    m_automatic_tape_creation_policy_infos_isSet = !json[QString("AutomaticTapeCreationPolicyInfos")].isNull() && m_automatic_tape_creation_policy_infos_isValid;
}

QString OAIListAutomaticTapeCreationPoliciesOutput::asJson() const {
...
QJsonObject OAIListAutomaticTapeCreationPoliciesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_automatic_tape_creation_policy_infos.isSet()) {
        obj.insert(QString("AutomaticTapeCreationPolicyInfos"), ::OpenAPI::toJsonValue(m_automatic_tape_creation_policy_infos));
    }
    return obj;
}

QList OAIListAutomaticTapeCreationPoliciesOutput::getAutomaticTapeCreationPolicyInfos() const {
    return m_automatic_tape_creation_policy_infos;
}
void OAIListAutomaticTapeCreationPoliciesOutput::setAutomaticTapeCreationPolicyInfos(const QList &automatic_tape_creation_policy_infos) {
    m_automatic_tape_creation_policy_infos = automatic_tape_creation_policy_infos;
    m_automatic_tape_creation_policy_infos_isSet = true;
}

bool OAIListAutomaticTapeCreationPoliciesOutput::is_automatic_tape_creation_policy_infos_Set() const{
    return m_automatic_tape_creation_policy_infos_isSet;
}

bool OAIListAutomaticTapeCreationPoliciesOutput::is_automatic_tape_creation_policy_infos_Valid() const{
    return m_automatic_tape_creation_policy_infos_isValid;
}

bool OAIListAutomaticTapeCreationPoliciesOutput::isSet() const {
...
bool OAIListAutomaticTapeCreationPoliciesOutput::isValid() const {
