...
/*
 * OAIDescribeMaintenanceStartTimeInput.h
 *
 * A JSON object containing the Amazon Resource Name (ARN) of the gateway.
 */

#ifndef OAIDescribeMaintenanceStartTimeInput_H
#define OAIDescribeMaintenanceStartTimeInput_H
...
class OAIDescribeMaintenanceStartTimeInput : public OAIObject {
public:
    OAIDescribeMaintenanceStartTimeInput();
    OAIDescribeMaintenanceStartTimeInput(QString json);
    ~OAIDescribeMaintenanceStartTimeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMaintenanceStartTimeInput)

#endif // OAIDescribeMaintenanceStartTimeInput_H
