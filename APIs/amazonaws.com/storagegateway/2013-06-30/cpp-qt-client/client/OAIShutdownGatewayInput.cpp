...
OAIShutdownGatewayInput::OAIShutdownGatewayInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIShutdownGatewayInput::OAIShutdownGatewayInput() {
    this->initializeModel();
}

OAIShutdownGatewayInput::~OAIShutdownGatewayInput() {}

void OAIShutdownGatewayInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIShutdownGatewayInput::fromJson(QString jsonString) {
...
void OAIShutdownGatewayInput::fromJsonObject(QJsonObject json) {
...
QString OAIShutdownGatewayInput::asJson() const {
...
QJsonObject OAIShutdownGatewayInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIShutdownGatewayInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIShutdownGatewayInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIShutdownGatewayInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIShutdownGatewayInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIShutdownGatewayInput::isSet() const {
...
bool OAIShutdownGatewayInput::isValid() const {
