...
OAIAddWorkingStorageInput::OAIAddWorkingStorageInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddWorkingStorageInput::OAIAddWorkingStorageInput() {
    this->initializeModel();
}

OAIAddWorkingStorageInput::~OAIAddWorkingStorageInput() {}

void OAIAddWorkingStorageInput::initializeModel() {
...
void OAIAddWorkingStorageInput::fromJson(QString jsonString) {
...
void OAIAddWorkingStorageInput::fromJsonObject(QJsonObject json) {
...
QString OAIAddWorkingStorageInput::asJson() const {
...
QJsonObject OAIAddWorkingStorageInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddWorkingStorageInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIAddWorkingStorageInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIAddWorkingStorageInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIAddWorkingStorageInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

QList OAIAddWorkingStorageInput::getDiskIds() const {
    return m_disk_ids;
}
void OAIAddWorkingStorageInput::setDiskIds(const QList &disk_ids) {
    m_disk_ids = disk_ids;
    m_disk_ids_isSet = true;
}

bool OAIAddWorkingStorageInput::is_disk_ids_Set() const{
    return m_disk_ids_isSet;
}

bool OAIAddWorkingStorageInput::is_disk_ids_Valid() const{
    return m_disk_ids_isValid;
}

bool OAIAddWorkingStorageInput::isSet() const {
...
bool OAIAddWorkingStorageInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_gateway_arn_isValid && m_disk_ids_isValid && true;
}
