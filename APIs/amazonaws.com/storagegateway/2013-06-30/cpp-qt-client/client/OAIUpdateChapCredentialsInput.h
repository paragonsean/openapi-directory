...
/*
 * OAIUpdateChapCredentialsInput.h
 *
...
#ifndef OAIUpdateChapCredentialsInput_H
#define OAIUpdateChapCredentialsInput_H
...
class OAIUpdateChapCredentialsInput : public OAIObject {
public:
    OAIUpdateChapCredentialsInput();
    OAIUpdateChapCredentialsInput(QString json);
    ~OAIUpdateChapCredentialsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateChapCredentialsInput)

#endif // OAIUpdateChapCredentialsInput_H
