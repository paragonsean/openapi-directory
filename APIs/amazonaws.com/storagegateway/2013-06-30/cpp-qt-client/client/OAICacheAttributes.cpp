...
OAICacheAttributes::OAICacheAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICacheAttributes::OAICacheAttributes() {
    this->initializeModel();
}

OAICacheAttributes::~OAICacheAttributes() {}

void OAICacheAttributes::initializeModel() {

    m_cache_stale_timeout_in_seconds_isSet = false;
    m_cache_stale_timeout_in_seconds_isValid = false;
}

void OAICacheAttributes::fromJson(QString jsonString) {
...
void OAICacheAttributes::fromJsonObject(QJsonObject json) {

    m_cache_stale_timeout_in_seconds_isValid = ::OpenAPI::fromJsonValue(m_cache_stale_timeout_in_seconds, json[QString("CacheStaleTimeoutInSeconds")]);
    m_cache_stale_timeout_in_seconds_isSet = !json[QString("CacheStaleTimeoutInSeconds")].isNull() && m_cache_stale_timeout_in_seconds_isValid;
}

QString OAICacheAttributes::asJson() const {
...
QJsonObject OAICacheAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_cache_stale_timeout_in_seconds_isSet) {
        obj.insert(QString("CacheStaleTimeoutInSeconds"), ::OpenAPI::toJsonValue(m_cache_stale_timeout_in_seconds));
    }
    return obj;
}

qint32 OAICacheAttributes::getCacheStaleTimeoutInSeconds() const {
    return m_cache_stale_timeout_in_seconds;
}
void OAICacheAttributes::setCacheStaleTimeoutInSeconds(const qint32 &cache_stale_timeout_in_seconds) {
    m_cache_stale_timeout_in_seconds = cache_stale_timeout_in_seconds;
    m_cache_stale_timeout_in_seconds_isSet = true;
}

bool OAICacheAttributes::is_cache_stale_timeout_in_seconds_Set() const{
    return m_cache_stale_timeout_in_seconds_isSet;
}

bool OAICacheAttributes::is_cache_stale_timeout_in_seconds_Valid() const{
    return m_cache_stale_timeout_in_seconds_isValid;
}

bool OAICacheAttributes::isSet() const {
...
bool OAICacheAttributes::isValid() const {
