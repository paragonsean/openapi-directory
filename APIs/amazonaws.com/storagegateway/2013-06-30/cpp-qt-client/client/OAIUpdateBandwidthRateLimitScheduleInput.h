...
/*
 * OAIUpdateBandwidthRateLimitScheduleInput.h
 *
 * 
 */

#ifndef OAIUpdateBandwidthRateLimitScheduleInput_H
#define OAIUpdateBandwidthRateLimitScheduleInput_H
...
class OAIUpdateBandwidthRateLimitScheduleInput : public OAIObject {
public:
    OAIUpdateBandwidthRateLimitScheduleInput();
    OAIUpdateBandwidthRateLimitScheduleInput(QString json);
    ~OAIUpdateBandwidthRateLimitScheduleInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBandwidthRateLimitScheduleInput)

#endif // OAIUpdateBandwidthRateLimitScheduleInput_H
