...
/*
 * OAIDeleteChapCredentialsInput.h
 *
...
#ifndef OAIDeleteChapCredentialsInput_H
#define OAIDeleteChapCredentialsInput_H
...
class OAIDeleteChapCredentialsInput : public OAIObject {
public:
    OAIDeleteChapCredentialsInput();
    OAIDeleteChapCredentialsInput(QString json);
    ~OAIDeleteChapCredentialsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteChapCredentialsInput)

#endif // OAIDeleteChapCredentialsInput_H
