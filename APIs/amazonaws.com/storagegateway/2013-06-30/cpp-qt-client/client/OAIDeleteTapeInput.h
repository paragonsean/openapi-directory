...
/*
 * OAIDeleteTapeInput.h
 *
 * DeleteTapeInput
 */

#ifndef OAIDeleteTapeInput_H
#define OAIDeleteTapeInput_H
...
class OAIDeleteTapeInput : public OAIObject {
public:
    OAIDeleteTapeInput();
    OAIDeleteTapeInput(QString json);
    ~OAIDeleteTapeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTapeInput)

#endif // OAIDeleteTapeInput_H
