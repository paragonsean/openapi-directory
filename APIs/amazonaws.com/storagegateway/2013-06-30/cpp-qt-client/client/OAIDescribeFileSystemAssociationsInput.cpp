...
OAIDescribeFileSystemAssociationsInput::OAIDescribeFileSystemAssociationsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFileSystemAssociationsInput::OAIDescribeFileSystemAssociationsInput() {
    this->initializeModel();
}

OAIDescribeFileSystemAssociationsInput::~OAIDescribeFileSystemAssociationsInput() {}

void OAIDescribeFileSystemAssociationsInput::initializeModel() {

    m_file_system_association_arn_list_isSet = false;
    m_file_system_association_arn_list_isValid = false;
}

void OAIDescribeFileSystemAssociationsInput::fromJson(QString jsonString) {
...
void OAIDescribeFileSystemAssociationsInput::fromJsonObject(QJsonObject json) {

    m_file_system_association_arn_list_isValid = ::OpenAPI::fromJsonValue(m_file_system_association_arn_list, json[QString("FileSystemAssociationARNList")]);
    m_file_system_association_arn_list_isSet = !json[QString("FileSystemAssociationARNList")].isNull() && m_file_system_association_arn_list_isValid;
}

QString OAIDescribeFileSystemAssociationsInput::asJson() const {
...
QJsonObject OAIDescribeFileSystemAssociationsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_file_system_association_arn_list.isSet()) {
        obj.insert(QString("FileSystemAssociationARNList"), ::OpenAPI::toJsonValue(m_file_system_association_arn_list));
    }
    return obj;
}

QList OAIDescribeFileSystemAssociationsInput::getFileSystemAssociationArnList() const {
    return m_file_system_association_arn_list;
}
void OAIDescribeFileSystemAssociationsInput::setFileSystemAssociationArnList(const QList &file_system_association_arn_list) {
    m_file_system_association_arn_list = file_system_association_arn_list;
    m_file_system_association_arn_list_isSet = true;
}

bool OAIDescribeFileSystemAssociationsInput::is_file_system_association_arn_list_Set() const{
    return m_file_system_association_arn_list_isSet;
}

bool OAIDescribeFileSystemAssociationsInput::is_file_system_association_arn_list_Valid() const{
    return m_file_system_association_arn_list_isValid;
}

bool OAIDescribeFileSystemAssociationsInput::isSet() const {
...
bool OAIDescribeFileSystemAssociationsInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_file_system_association_arn_list_isValid && true;
}
