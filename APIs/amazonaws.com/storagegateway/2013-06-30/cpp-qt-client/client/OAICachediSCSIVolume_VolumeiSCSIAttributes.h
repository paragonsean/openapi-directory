...
/*
 * OAICachediSCSIVolume_VolumeiSCSIAttributes.h
 *
 * 
 */

#ifndef OAICachediSCSIVolume_VolumeiSCSIAttributes_H
#define OAICachediSCSIVolume_VolumeiSCSIAttributes_H
...
class OAICachediSCSIVolume_VolumeiSCSIAttributes : public OAIObject {
public:
    OAICachediSCSIVolume_VolumeiSCSIAttributes();
    OAICachediSCSIVolume_VolumeiSCSIAttributes(QString json);
    ~OAICachediSCSIVolume_VolumeiSCSIAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICachediSCSIVolume_VolumeiSCSIAttributes)

#endif // OAICachediSCSIVolume_VolumeiSCSIAttributes_H
