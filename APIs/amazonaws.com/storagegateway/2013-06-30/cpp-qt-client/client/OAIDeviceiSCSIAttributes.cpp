...
#include "OAIDeviceiSCSIAttributes.h"
...
OAIDeviceiSCSIAttributes::OAIDeviceiSCSIAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeviceiSCSIAttributes::OAIDeviceiSCSIAttributes() {
    this->initializeModel();
}

OAIDeviceiSCSIAttributes::~OAIDeviceiSCSIAttributes() {}

void OAIDeviceiSCSIAttributes::initializeModel() {
...
void OAIDeviceiSCSIAttributes::fromJson(QString jsonString) {
...
void OAIDeviceiSCSIAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIDeviceiSCSIAttributes::asJson() const {
...
QJsonObject OAIDeviceiSCSIAttributes::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeviceiSCSIAttributes::getTargetArn() const {
    return m_target_arn;
}
void OAIDeviceiSCSIAttributes::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAIDeviceiSCSIAttributes::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAIDeviceiSCSIAttributes::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

QString OAIDeviceiSCSIAttributes::getNetworkInterfaceId() const {
    return m_network_interface_id;
}
void OAIDeviceiSCSIAttributes::setNetworkInterfaceId(const QString &network_interface_id) {
    m_network_interface_id = network_interface_id;
    m_network_interface_id_isSet = true;
}

bool OAIDeviceiSCSIAttributes::is_network_interface_id_Set() const{
    return m_network_interface_id_isSet;
}

bool OAIDeviceiSCSIAttributes::is_network_interface_id_Valid() const{
    return m_network_interface_id_isValid;
}

qint32 OAIDeviceiSCSIAttributes::getNetworkInterfacePort() const {
    return m_network_interface_port;
}
void OAIDeviceiSCSIAttributes::setNetworkInterfacePort(const qint32 &network_interface_port) {
    m_network_interface_port = network_interface_port;
    m_network_interface_port_isSet = true;
}

bool OAIDeviceiSCSIAttributes::is_network_interface_port_Set() const{
    return m_network_interface_port_isSet;
}

bool OAIDeviceiSCSIAttributes::is_network_interface_port_Valid() const{
    return m_network_interface_port_isValid;
}

bool OAIDeviceiSCSIAttributes::getChapEnabled() const {
    return m_chap_enabled;
}
void OAIDeviceiSCSIAttributes::setChapEnabled(const bool &chap_enabled) {
    m_chap_enabled = chap_enabled;
    m_chap_enabled_isSet = true;
}

bool OAIDeviceiSCSIAttributes::is_chap_enabled_Set() const{
    return m_chap_enabled_isSet;
}

bool OAIDeviceiSCSIAttributes::is_chap_enabled_Valid() const{
    return m_chap_enabled_isValid;
}

bool OAIDeviceiSCSIAttributes::isSet() const {
...
bool OAIDeviceiSCSIAttributes::isValid() const {
