...
OAIDescribeBandwidthRateLimitInput::OAIDescribeBandwidthRateLimitInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBandwidthRateLimitInput::OAIDescribeBandwidthRateLimitInput() {
    this->initializeModel();
}

OAIDescribeBandwidthRateLimitInput::~OAIDescribeBandwidthRateLimitInput() {}

void OAIDescribeBandwidthRateLimitInput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAIDescribeBandwidthRateLimitInput::fromJson(QString jsonString) {
...
void OAIDescribeBandwidthRateLimitInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBandwidthRateLimitInput::asJson() const {
...
QJsonObject OAIDescribeBandwidthRateLimitInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBandwidthRateLimitInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIDescribeBandwidthRateLimitInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIDescribeBandwidthRateLimitInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIDescribeBandwidthRateLimitInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIDescribeBandwidthRateLimitInput::isSet() const {
...
bool OAIDescribeBandwidthRateLimitInput::isValid() const {
