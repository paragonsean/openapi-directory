...
OAISetSMBGuestPasswordOutput::OAISetSMBGuestPasswordOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetSMBGuestPasswordOutput::OAISetSMBGuestPasswordOutput() {
    this->initializeModel();
}

OAISetSMBGuestPasswordOutput::~OAISetSMBGuestPasswordOutput() {}

void OAISetSMBGuestPasswordOutput::initializeModel() {

    m_gateway_arn_isSet = false;
    m_gateway_arn_isValid = false;
}

void OAISetSMBGuestPasswordOutput::fromJson(QString jsonString) {
...
void OAISetSMBGuestPasswordOutput::fromJsonObject(QJsonObject json) {
...
QString OAISetSMBGuestPasswordOutput::asJson() const {
...
QJsonObject OAISetSMBGuestPasswordOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAISetSMBGuestPasswordOutput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAISetSMBGuestPasswordOutput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAISetSMBGuestPasswordOutput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAISetSMBGuestPasswordOutput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAISetSMBGuestPasswordOutput::isSet() const {
...
bool OAISetSMBGuestPasswordOutput::isValid() const {
