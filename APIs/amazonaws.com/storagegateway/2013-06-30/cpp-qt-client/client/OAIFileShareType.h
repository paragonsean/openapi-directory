...
#ifndef OAIFileShareType_H
#define OAIFileShareType_H
...
class OAIFileShareType : public OAIEnum {
public:
    OAIFileShareType();
    OAIFileShareType(QString json);
    ~OAIFileShareType() override;
    ...
    enum class eOAIFileShareType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NFS, 
        SMB
    };
    OAIFileShareType::eOAIFileShareType getValue() const;
    void setValue(const OAIFileShareType::eOAIFileShareType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileShareType)

#endif // OAIFileShareType_H
