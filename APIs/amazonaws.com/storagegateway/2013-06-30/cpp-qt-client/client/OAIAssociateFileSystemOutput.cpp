...
OAIAssociateFileSystemOutput::OAIAssociateFileSystemOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateFileSystemOutput::OAIAssociateFileSystemOutput() {
    this->initializeModel();
}

OAIAssociateFileSystemOutput::~OAIAssociateFileSystemOutput() {}

void OAIAssociateFileSystemOutput::initializeModel() {

    m_file_system_association_arn_isSet = false;
    m_file_system_association_arn_isValid = false;
}

void OAIAssociateFileSystemOutput::fromJson(QString jsonString) {
...
void OAIAssociateFileSystemOutput::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateFileSystemOutput::asJson() const {
...
QJsonObject OAIAssociateFileSystemOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateFileSystemOutput::getFileSystemAssociationArn() const {
    return m_file_system_association_arn;
}
void OAIAssociateFileSystemOutput::setFileSystemAssociationArn(const QString &file_system_association_arn) {
    m_file_system_association_arn = file_system_association_arn;
    m_file_system_association_arn_isSet = true;
}

bool OAIAssociateFileSystemOutput::is_file_system_association_arn_Set() const{
    return m_file_system_association_arn_isSet;
}

bool OAIAssociateFileSystemOutput::is_file_system_association_arn_Valid() const{
    return m_file_system_association_arn_isValid;
}

bool OAIAssociateFileSystemOutput::isSet() const {
...
bool OAIAssociateFileSystemOutput::isValid() const {
