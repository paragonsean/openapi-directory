...
QString OAIListTagsForResourceInput::getMarker() const {
    return m_marker;
}
void OAIListTagsForResourceInput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListTagsForResourceInput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListTagsForResourceInput::is_marker_Valid() const{
    return m_marker_isValid;
}

qint32 OAIListTagsForResourceInput::getLimit() const {
    return m_limit;
}
void OAIListTagsForResourceInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListTagsForResourceInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListTagsForResourceInput::is_limit_Valid() const{
