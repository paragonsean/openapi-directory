...
OAIRetrieveTapeRecoveryPointOutput::OAIRetrieveTapeRecoveryPointOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRetrieveTapeRecoveryPointOutput::OAIRetrieveTapeRecoveryPointOutput() {
    this->initializeModel();
}

OAIRetrieveTapeRecoveryPointOutput::~OAIRetrieveTapeRecoveryPointOutput() {}

void OAIRetrieveTapeRecoveryPointOutput::initializeModel() {

    m_tape_arn_isSet = false;
    m_tape_arn_isValid = false;
}

void OAIRetrieveTapeRecoveryPointOutput::fromJson(QString jsonString) {
...
void OAIRetrieveTapeRecoveryPointOutput::fromJsonObject(QJsonObject json) {
...
QString OAIRetrieveTapeRecoveryPointOutput::asJson() const {
...
QJsonObject OAIRetrieveTapeRecoveryPointOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_arn_isSet) {
...
QString OAIRetrieveTapeRecoveryPointOutput::getTapeArn() const {
    return m_tape_arn;
}
void OAIRetrieveTapeRecoveryPointOutput::setTapeArn(const QString &tape_arn) {
    m_tape_arn = tape_arn;
    m_tape_arn_isSet = true;
}

bool OAIRetrieveTapeRecoveryPointOutput::is_tape_arn_Set() const{
    return m_tape_arn_isSet;
}

bool OAIRetrieveTapeRecoveryPointOutput::is_tape_arn_Valid() const{
    return m_tape_arn_isValid;
}

bool OAIRetrieveTapeRecoveryPointOutput::isSet() const {
...
bool OAIRetrieveTapeRecoveryPointOutput::isValid() const {
