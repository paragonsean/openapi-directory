...
OAIDisassociateFileSystemInput::OAIDisassociateFileSystemInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateFileSystemInput::OAIDisassociateFileSystemInput() {
    this->initializeModel();
}

OAIDisassociateFileSystemInput::~OAIDisassociateFileSystemInput() {}

void OAIDisassociateFileSystemInput::initializeModel() {
...
void OAIDisassociateFileSystemInput::fromJson(QString jsonString) {
...
void OAIDisassociateFileSystemInput::fromJsonObject(QJsonObject json) {
...
QString OAIDisassociateFileSystemInput::asJson() const {
...
QJsonObject OAIDisassociateFileSystemInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisassociateFileSystemInput::getFileSystemAssociationArn() const {
    return m_file_system_association_arn;
}
void OAIDisassociateFileSystemInput::setFileSystemAssociationArn(const QString &file_system_association_arn) {
    m_file_system_association_arn = file_system_association_arn;
    m_file_system_association_arn_isSet = true;
}

bool OAIDisassociateFileSystemInput::is_file_system_association_arn_Set() const{
    return m_file_system_association_arn_isSet;
}

bool OAIDisassociateFileSystemInput::is_file_system_association_arn_Valid() const{
    return m_file_system_association_arn_isValid;
}

bool OAIDisassociateFileSystemInput::getForceDelete() const {
    return m_force_delete;
}
void OAIDisassociateFileSystemInput::setForceDelete(const bool &force_delete) {
    m_force_delete = force_delete;
    m_force_delete_isSet = true;
}

bool OAIDisassociateFileSystemInput::is_force_delete_Set() const{
    return m_force_delete_isSet;
}

bool OAIDisassociateFileSystemInput::is_force_delete_Valid() const{
    return m_force_delete_isValid;
}

bool OAIDisassociateFileSystemInput::isSet() const {
...
bool OAIDisassociateFileSystemInput::isValid() const {
