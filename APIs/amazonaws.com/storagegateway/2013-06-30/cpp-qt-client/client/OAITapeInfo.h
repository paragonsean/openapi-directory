...
#ifndef OAITapeInfo_H
#define OAITapeInfo_H
...
class OAITapeInfo : public OAIObject {
public:
    OAITapeInfo();
    OAITapeInfo(QString json);
    ~OAITapeInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITapeInfo)
