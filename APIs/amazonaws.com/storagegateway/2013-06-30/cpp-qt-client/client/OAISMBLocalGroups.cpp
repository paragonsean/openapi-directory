...
OAISMBLocalGroups::OAISMBLocalGroups(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISMBLocalGroups::OAISMBLocalGroups() {
    this->initializeModel();
}

OAISMBLocalGroups::~OAISMBLocalGroups() {}

void OAISMBLocalGroups::initializeModel() {

    m_gateway_admins_isSet = false;
    m_gateway_admins_isValid = false;
}

void OAISMBLocalGroups::fromJson(QString jsonString) {
...
void OAISMBLocalGroups::fromJsonObject(QJsonObject json) {
...
QString OAISMBLocalGroups::asJson() const {
...
QJsonObject OAISMBLocalGroups::asJsonObject() const {
    QJsonObject obj;
...
QList OAISMBLocalGroups::getGatewayAdmins() const {
    return m_gateway_admins;
}
void OAISMBLocalGroups::setGatewayAdmins(const QList &gateway_admins) {
    m_gateway_admins = gateway_admins;
    m_gateway_admins_isSet = true;
}

bool OAISMBLocalGroups::is_gateway_admins_Set() const{
    return m_gateway_admins_isSet;
}

bool OAISMBLocalGroups::is_gateway_admins_Valid() const{
    return m_gateway_admins_isValid;
}

bool OAISMBLocalGroups::isSet() const {
...
bool OAISMBLocalGroups::isValid() const {
