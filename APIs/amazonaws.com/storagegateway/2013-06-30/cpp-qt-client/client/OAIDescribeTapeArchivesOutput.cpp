...
OAIDescribeTapeArchivesOutput::OAIDescribeTapeArchivesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTapeArchivesOutput::OAIDescribeTapeArchivesOutput() {
    this->initializeModel();
}

OAIDescribeTapeArchivesOutput::~OAIDescribeTapeArchivesOutput() {}

void OAIDescribeTapeArchivesOutput::initializeModel() {

    m_tape_archives_isSet = false;
    m_tape_archives_isValid = false;

    m_marker_isSet = false;
    m_marker_isValid = false;
}

void OAIDescribeTapeArchivesOutput::fromJson(QString jsonString) {
...
void OAIDescribeTapeArchivesOutput::fromJsonObject(QJsonObject json) {

    m_tape_archives_isValid = ::OpenAPI::fromJsonValue(m_tape_archives, json[QString("TapeArchives")]);
    m_tape_archives_isSet = !json[QString("TapeArchives")].isNull() && m_tape_archives_isValid;
...
QString OAIDescribeTapeArchivesOutput::asJson() const {
...
QJsonObject OAIDescribeTapeArchivesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_tape_archives.isSet()) {
        obj.insert(QString("TapeArchives"), ::OpenAPI::toJsonValue(m_tape_archives));
    }
    if (m_marker_isSet) {
...
QList OAIDescribeTapeArchivesOutput::getTapeArchives() const {
    return m_tape_archives;
}
void OAIDescribeTapeArchivesOutput::setTapeArchives(const QList &tape_archives) {
    m_tape_archives = tape_archives;
    m_tape_archives_isSet = true;
}

bool OAIDescribeTapeArchivesOutput::is_tape_archives_Set() const{
    return m_tape_archives_isSet;
}

bool OAIDescribeTapeArchivesOutput::is_tape_archives_Valid() const{
    return m_tape_archives_isValid;
}

QString OAIDescribeTapeArchivesOutput::getMarker() const {
    return m_marker;
}
void OAIDescribeTapeArchivesOutput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIDescribeTapeArchivesOutput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIDescribeTapeArchivesOutput::is_marker_Valid() const{
    return m_marker_isValid;
}

bool OAIDescribeTapeArchivesOutput::isSet() const {
...
bool OAIDescribeTapeArchivesOutput::isValid() const {
