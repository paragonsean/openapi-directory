...
/*
 * OAIDisassociateFileSystemOutput.h
 *
 * 
 */

#ifndef OAIDisassociateFileSystemOutput_H
#define OAIDisassociateFileSystemOutput_H
...
class OAIDisassociateFileSystemOutput : public OAIObject {
public:
    OAIDisassociateFileSystemOutput();
    OAIDisassociateFileSystemOutput(QString json);
    ~OAIDisassociateFileSystemOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateFileSystemOutput)

#endif // OAIDisassociateFileSystemOutput_H
