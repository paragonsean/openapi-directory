...
OAISMBSecurityStrategy::OAISMBSecurityStrategy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISMBSecurityStrategy::OAISMBSecurityStrategy() {
    this->initializeModel();
}

OAISMBSecurityStrategy::~OAISMBSecurityStrategy() {}

void OAISMBSecurityStrategy::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAISMBSecurityStrategy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAISMBSecurityStrategy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ClientSpecified", Qt::CaseInsensitive) == 0) {
        m_value = eOAISMBSecurityStrategy::CLIENTSPECIFIED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MandatorySigning", Qt::CaseInsensitive) == 0) {
        m_value = eOAISMBSecurityStrategy::MANDATORYSIGNING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MandatoryEncryption", Qt::CaseInsensitive) == 0) {
        m_value = eOAISMBSecurityStrategy::MANDATORYENCRYPTION;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAISMBSecurityStrategy::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAISMBSecurityStrategy::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAISMBSecurityStrategy::CLIENTSPECIFIED:
            val = "ClientSpecified";
            break;
        case eOAISMBSecurityStrategy::MANDATORYSIGNING:
            val = "MandatorySigning";
            break;
        case eOAISMBSecurityStrategy::MANDATORYENCRYPTION:
            val = "MandatoryEncryption";
            break;
        default:
            break;
    }
...
QJsonValue OAISMBSecurityStrategy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAISMBSecurityStrategy::eOAISMBSecurityStrategy OAISMBSecurityStrategy::getValue() const {
    return m_value;
}

void OAISMBSecurityStrategy::setValue(const OAISMBSecurityStrategy::eOAISMBSecurityStrategy& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAISMBSecurityStrategy::isSet() const {
    
    return m_value_isSet;
}

bool OAISMBSecurityStrategy::isValid() const {
