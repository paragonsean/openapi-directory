...
OAIListFileSharesInput::OAIListFileSharesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListFileSharesInput::OAIListFileSharesInput() {
    this->initializeModel();
}

OAIListFileSharesInput::~OAIListFileSharesInput() {}

void OAIListFileSharesInput::initializeModel() {
...
void OAIListFileSharesInput::fromJson(QString jsonString) {
...
void OAIListFileSharesInput::fromJsonObject(QJsonObject json) {
...
QString OAIListFileSharesInput::asJson() const {
...
QJsonObject OAIListFileSharesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListFileSharesInput::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIListFileSharesInput::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIListFileSharesInput::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIListFileSharesInput::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

qint32 OAIListFileSharesInput::getLimit() const {
    return m_limit;
}
void OAIListFileSharesInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListFileSharesInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListFileSharesInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListFileSharesInput::getMarker() const {
    return m_marker;
}
void OAIListFileSharesInput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListFileSharesInput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListFileSharesInput::is_marker_Valid() const{
    return m_marker_isValid;
}

bool OAIListFileSharesInput::isSet() const {
...
bool OAIListFileSharesInput::isValid() const {
