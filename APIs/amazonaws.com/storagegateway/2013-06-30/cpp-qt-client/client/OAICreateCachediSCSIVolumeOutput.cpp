...
OAICreateCachediSCSIVolumeOutput::OAICreateCachediSCSIVolumeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCachediSCSIVolumeOutput::OAICreateCachediSCSIVolumeOutput() {
    this->initializeModel();
}

OAICreateCachediSCSIVolumeOutput::~OAICreateCachediSCSIVolumeOutput() {}

void OAICreateCachediSCSIVolumeOutput::initializeModel() {
...
void OAICreateCachediSCSIVolumeOutput::fromJson(QString jsonString) {
...
void OAICreateCachediSCSIVolumeOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateCachediSCSIVolumeOutput::asJson() const {
...
QJsonObject OAICreateCachediSCSIVolumeOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateCachediSCSIVolumeOutput::getVolumeArn() const {
    return m_volume_arn;
}
void OAICreateCachediSCSIVolumeOutput::setVolumeArn(const QString &volume_arn) {
    m_volume_arn = volume_arn;
    m_volume_arn_isSet = true;
}

bool OAICreateCachediSCSIVolumeOutput::is_volume_arn_Set() const{
    return m_volume_arn_isSet;
}

bool OAICreateCachediSCSIVolumeOutput::is_volume_arn_Valid() const{
    return m_volume_arn_isValid;
}

QString OAICreateCachediSCSIVolumeOutput::getTargetArn() const {
    return m_target_arn;
}
void OAICreateCachediSCSIVolumeOutput::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAICreateCachediSCSIVolumeOutput::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAICreateCachediSCSIVolumeOutput::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

bool OAICreateCachediSCSIVolumeOutput::isSet() const {
...
bool OAICreateCachediSCSIVolumeOutput::isValid() const {
