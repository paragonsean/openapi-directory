...
/*
 * OAIDisassociateFileSystemInput.h
 *
 * 
 */

#ifndef OAIDisassociateFileSystemInput_H
#define OAIDisassociateFileSystemInput_H
...
class OAIDisassociateFileSystemInput : public OAIObject {
public:
    OAIDisassociateFileSystemInput();
    OAIDisassociateFileSystemInput(QString json);
    ~OAIDisassociateFileSystemInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateFileSystemInput)

#endif // OAIDisassociateFileSystemInput_H
