...
/*
 * OAIStorediSCSIVolume.h
 *
 * Describes an iSCSI stored volume.
 */

#ifndef OAIStorediSCSIVolume_H
#define OAIStorediSCSIVolume_H
...
class OAIStorediSCSIVolume : public OAIObject {
public:
    OAIStorediSCSIVolume();
    OAIStorediSCSIVolume(QString json);
    ~OAIStorediSCSIVolume() override;
    ...
    QString getVolumeDiskId() const;
    void setVolumeDiskId(const QString &volume_disk_id);
    bool is_volume_disk_id_Set() const;
    bool is_volume_disk_id_Valid() const;
    ...
    void setPreservedExistingData(const bool &preserved_existing_data);
    bool is_preserved_existing_data_Set() const;
    bool is_preserved_existing_data_Valid() const;
...
private:
    ...
    QString m_volume_disk_id;
    bool m_volume_disk_id_isSet;
    bool m_volume_disk_id_isValid;

    QString m_source_snapshot_id;
    bool m_source_snapshot_id_isSet;
    bool m_source_snapshot_id_isValid;

    bool m_preserved_existing_data;
    bool m_preserved_existing_data_isSet;
    bool m_preserved_existing_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStorediSCSIVolume)

#endif // OAIStorediSCSIVolume_H
