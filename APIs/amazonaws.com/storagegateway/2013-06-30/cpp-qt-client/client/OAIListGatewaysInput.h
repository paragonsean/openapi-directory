...
#ifndef OAIListGatewaysInput_H
#define OAIListGatewaysInput_H
...
class OAIListGatewaysInput : public OAIObject {
public:
    OAIListGatewaysInput();
    OAIListGatewaysInput(QString json);
    ~OAIListGatewaysInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGatewaysInput)

#endif // OAIListGatewaysInput_H
