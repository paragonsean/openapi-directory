...
class OAIAddWorkingStorageOutput : public OAIObject {
public:
    OAIAddWorkingStorageOutput();
    OAIAddWorkingStorageOutput(QString json);
    ~OAIAddWorkingStorageOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddWorkingStorageOutput)

#endif // OAIAddWorkingStorageOutput_H
