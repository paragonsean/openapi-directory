...
/*
 * OAIVolumeRecoveryPointInfo.h
 *
 * Describes a storage volume recovery point object.
 */

#ifndef OAIVolumeRecoveryPointInfo_H
#define OAIVolumeRecoveryPointInfo_H
...
class OAIVolumeRecoveryPointInfo : public OAIObject {
public:
    OAIVolumeRecoveryPointInfo();
    OAIVolumeRecoveryPointInfo(QString json);
    ~OAIVolumeRecoveryPointInfo() override;
    ...
    QString getVolumeRecoveryPointTime() const;
    void setVolumeRecoveryPointTime(const QString &volume_recovery_point_time);
    bool is_volume_recovery_point_time_Set() const;
    bool is_volume_recovery_point_time_Valid() const;
...
private:
    ...
    QString m_volume_recovery_point_time;
    bool m_volume_recovery_point_time_isSet;
    bool m_volume_recovery_point_time_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIVolumeRecoveryPointInfo)

#endif // OAIVolumeRecoveryPointInfo_H
