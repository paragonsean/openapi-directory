...
OAIDescribeSMBFileSharesInput::OAIDescribeSMBFileSharesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeSMBFileSharesInput::OAIDescribeSMBFileSharesInput() {
    this->initializeModel();
}

OAIDescribeSMBFileSharesInput::~OAIDescribeSMBFileSharesInput() {}

void OAIDescribeSMBFileSharesInput::initializeModel() {

    m_file_share_arn_list_isSet = false;
    m_file_share_arn_list_isValid = false;
}

void OAIDescribeSMBFileSharesInput::fromJson(QString jsonString) {
...
void OAIDescribeSMBFileSharesInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeSMBFileSharesInput::asJson() const {
...
QJsonObject OAIDescribeSMBFileSharesInput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeSMBFileSharesInput::getFileShareArnList() const {
    return m_file_share_arn_list;
}
void OAIDescribeSMBFileSharesInput::setFileShareArnList(const QList &file_share_arn_list) {
    m_file_share_arn_list = file_share_arn_list;
    m_file_share_arn_list_isSet = true;
}

bool OAIDescribeSMBFileSharesInput::is_file_share_arn_list_Set() const{
    return m_file_share_arn_list_isSet;
}

bool OAIDescribeSMBFileSharesInput::is_file_share_arn_list_Valid() const{
    return m_file_share_arn_list_isValid;
}

bool OAIDescribeSMBFileSharesInput::isSet() const {
...
bool OAIDescribeSMBFileSharesInput::isValid() const {
