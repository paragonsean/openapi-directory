...
OAIFileShareInfo::OAIFileShareInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFileShareInfo::OAIFileShareInfo() {
    this->initializeModel();
}

OAIFileShareInfo::~OAIFileShareInfo() {}

void OAIFileShareInfo::initializeModel() {

    m_file_share_type_isSet = false;
    m_file_share_type_isValid = false;
...
void OAIFileShareInfo::fromJson(QString jsonString) {
...
void OAIFileShareInfo::fromJsonObject(QJsonObject json) {

    m_file_share_type_isValid = ::OpenAPI::fromJsonValue(m_file_share_type, json[QString("FileShareType")]);
    m_file_share_type_isSet = !json[QString("FileShareType")].isNull() && m_file_share_type_isValid;
...
QString OAIFileShareInfo::asJson() const {
...
QJsonObject OAIFileShareInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_file_share_type.isSet()) {
        obj.insert(QString("FileShareType"), ::OpenAPI::toJsonValue(m_file_share_type));
    }
...
OAIFileShareType OAIFileShareInfo::getFileShareType() const {
    return m_file_share_type;
}
void OAIFileShareInfo::setFileShareType(const OAIFileShareType &file_share_type) {
    m_file_share_type = file_share_type;
    m_file_share_type_isSet = true;
}

bool OAIFileShareInfo::is_file_share_type_Set() const{
    return m_file_share_type_isSet;
}

bool OAIFileShareInfo::is_file_share_type_Valid() const{
    return m_file_share_type_isValid;
}

QString OAIFileShareInfo::getFileShareArn() const {
    return m_file_share_arn;
}
void OAIFileShareInfo::setFileShareArn(const QString &file_share_arn) {
    m_file_share_arn = file_share_arn;
    m_file_share_arn_isSet = true;
}

bool OAIFileShareInfo::is_file_share_arn_Set() const{
    return m_file_share_arn_isSet;
}

bool OAIFileShareInfo::is_file_share_arn_Valid() const{
    return m_file_share_arn_isValid;
}

QString OAIFileShareInfo::getFileShareId() const {
    return m_file_share_id;
}
void OAIFileShareInfo::setFileShareId(const QString &file_share_id) {
    m_file_share_id = file_share_id;
    m_file_share_id_isSet = true;
}

bool OAIFileShareInfo::is_file_share_id_Set() const{
    return m_file_share_id_isSet;
}

bool OAIFileShareInfo::is_file_share_id_Valid() const{
    return m_file_share_id_isValid;
}

QString OAIFileShareInfo::getFileShareStatus() const {
    return m_file_share_status;
}
void OAIFileShareInfo::setFileShareStatus(const QString &file_share_status) {
    m_file_share_status = file_share_status;
    m_file_share_status_isSet = true;
}

bool OAIFileShareInfo::is_file_share_status_Set() const{
    return m_file_share_status_isSet;
}

bool OAIFileShareInfo::is_file_share_status_Valid() const{
    return m_file_share_status_isValid;
}

QString OAIFileShareInfo::getGatewayArn() const {
    return m_gateway_arn;
}
void OAIFileShareInfo::setGatewayArn(const QString &gateway_arn) {
    m_gateway_arn = gateway_arn;
    m_gateway_arn_isSet = true;
}

bool OAIFileShareInfo::is_gateway_arn_Set() const{
    return m_gateway_arn_isSet;
}

bool OAIFileShareInfo::is_gateway_arn_Valid() const{
    return m_gateway_arn_isValid;
}

bool OAIFileShareInfo::isSet() const {
...
bool OAIFileShareInfo::isValid() const {
