# AmazonLexModelBuildingService.PutBotAliasRequest
...
**tags** | [**[Tag]**](Tag.md) | A list of tags to add to the bot alias. You can only add tags when you create an alias, you can&#39;t use the &lt;code&gt;PutBotAlias&lt;/code&gt; operation to update the tags on a bot alias. To update tags, use the &lt;code&gt;TagResource&lt;/code&gt; operation. | [optional] 
