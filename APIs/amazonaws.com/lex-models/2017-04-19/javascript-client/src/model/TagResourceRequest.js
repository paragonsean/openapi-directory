...
class TagResourceRequest {
     ...
     * @param tags {Array.<module:model/Tag>} A list of tag keys to add to the resource. If a tag key already exists, the existing value is replaced with the new value.
     */
    constructor(tags) { 
