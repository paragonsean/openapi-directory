...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.CreateBotVersionResponseClarificationPrompt();
  });
  ...
  describe('CreateBotVersionResponseClarificationPrompt', function() {
    it('should create an instance of CreateBotVersionResponseClarificationPrompt', function() {
      // uncomment below and update the code to test CreateBotVersionResponseClarificationPrompt
      //var instance = new AmazonLexModelBuildingService.CreateBotVersionResponseClarificationPrompt();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.CreateBotVersionResponseClarificationPrompt);
    });
