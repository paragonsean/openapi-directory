...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.BotAliasMetadata();
  });
  ...
  describe('BotAliasMetadata', function() {
    it('should create an instance of BotAliasMetadata', function() {
      // uncomment below and update the code to test BotAliasMetadata
      //var instance = new AmazonLexModelBuildingService.BotAliasMetadata();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.BotAliasMetadata);
    });
