...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.Prompt();
  });
  ...
  describe('Prompt', function() {
    it('should create an instance of Prompt', function() {
      ...
      //var instance = new AmazonLexModelBuildingService.Prompt();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.Prompt);
    });
