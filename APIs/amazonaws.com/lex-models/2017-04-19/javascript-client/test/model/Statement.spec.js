...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.Statement();
  });
  ...
  describe('Statement', function() {
    it('should create an instance of Statement', function() {
      ...
      //var instance = new AmazonLexModelBuildingService.Statement();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.Statement);
    });
