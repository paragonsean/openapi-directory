...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.Tag();
  });
  ...
  describe('Tag', function() {
    it('should create an instance of Tag', function() {
      ...
      //var instance = new AmazonLexModelBuildingService.Tag();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.Tag);
    });
