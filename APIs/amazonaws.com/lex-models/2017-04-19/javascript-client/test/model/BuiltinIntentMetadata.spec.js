...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.BuiltinIntentMetadata();
  });
  ...
  describe('BuiltinIntentMetadata', function() {
    it('should create an instance of BuiltinIntentMetadata', function() {
      // uncomment below and update the code to test BuiltinIntentMetadata
      //var instance = new AmazonLexModelBuildingService.BuiltinIntentMetadata();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.BuiltinIntentMetadata);
    });
