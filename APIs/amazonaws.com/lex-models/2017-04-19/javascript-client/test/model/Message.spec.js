...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.Message();
  });
  ...
  describe('Message', function() {
    it('should create an instance of Message', function() {
      ...
      //var instance = new AmazonLexModelBuildingService.Message();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.Message);
    });
