...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.PutBotRequestClarificationPrompt();
  });
  ...
  describe('PutBotRequestClarificationPrompt', function() {
    it('should create an instance of PutBotRequestClarificationPrompt', function() {
      // uncomment below and update the code to test PutBotRequestClarificationPrompt
      //var instance = new AmazonLexModelBuildingService.PutBotRequestClarificationPrompt();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.PutBotRequestClarificationPrompt);
    });
