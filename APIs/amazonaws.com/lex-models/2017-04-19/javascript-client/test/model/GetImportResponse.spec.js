...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.GetImportResponse();
  });
  ...
  describe('GetImportResponse', function() {
    it('should create an instance of GetImportResponse', function() {
      ...
      //var instance = new AmazonLexModelBuildingService.GetImportResponse();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.GetImportResponse);
    });
