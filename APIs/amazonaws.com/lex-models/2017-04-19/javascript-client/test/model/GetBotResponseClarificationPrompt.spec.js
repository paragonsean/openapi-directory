...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.GetBotResponseClarificationPrompt();
  });
  ...
  describe('GetBotResponseClarificationPrompt', function() {
    it('should create an instance of GetBotResponseClarificationPrompt', function() {
      // uncomment below and update the code to test GetBotResponseClarificationPrompt
      //var instance = new AmazonLexModelBuildingService.GetBotResponseClarificationPrompt();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.GetBotResponseClarificationPrompt);
    });
