...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.GetIntentsResponse();
  });
  ...
  describe('GetIntentsResponse', function() {
    it('should create an instance of GetIntentsResponse', function() {
      // uncomment below and update the code to test GetIntentsResponse
      //var instance = new AmazonLexModelBuildingService.GetIntentsResponse();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.GetIntentsResponse);
    });
