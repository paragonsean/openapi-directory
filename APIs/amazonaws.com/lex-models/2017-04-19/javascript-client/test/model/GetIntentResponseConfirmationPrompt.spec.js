...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.GetIntentResponseConfirmationPrompt();
  });
  ...
  describe('GetIntentResponseConfirmationPrompt', function() {
    it('should create an instance of GetIntentResponseConfirmationPrompt', function() {
      // uncomment below and update the code to test GetIntentResponseConfirmationPrompt
      //var instance = new AmazonLexModelBuildingService.GetIntentResponseConfirmationPrompt();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.GetIntentResponseConfirmationPrompt);
    });
