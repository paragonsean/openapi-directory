...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.BuiltinSlotTypeMetadata();
  });
  ...
  describe('BuiltinSlotTypeMetadata', function() {
    it('should create an instance of BuiltinSlotTypeMetadata', function() {
      // uncomment below and update the code to test BuiltinSlotTypeMetadata
      //var instance = new AmazonLexModelBuildingService.BuiltinSlotTypeMetadata();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.BuiltinSlotTypeMetadata);
    });
