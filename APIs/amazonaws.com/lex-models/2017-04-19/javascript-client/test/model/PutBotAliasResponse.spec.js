...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.PutBotAliasResponse();
  });
  ...
  describe('PutBotAliasResponse', function() {
    it('should create an instance of PutBotAliasResponse', function() {
      // uncomment below and update the code to test PutBotAliasResponse
      //var instance = new AmazonLexModelBuildingService.PutBotAliasResponse();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.PutBotAliasResponse);
    });
