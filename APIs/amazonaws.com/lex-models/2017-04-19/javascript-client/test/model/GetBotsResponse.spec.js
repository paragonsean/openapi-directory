...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.GetBotsResponse();
  });
  ...
  describe('GetBotsResponse', function() {
    it('should create an instance of GetBotsResponse', function() {
      // uncomment below and update the code to test GetBotsResponse
      //var instance = new AmazonLexModelBuildingService.GetBotsResponse();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.GetBotsResponse);
    });
