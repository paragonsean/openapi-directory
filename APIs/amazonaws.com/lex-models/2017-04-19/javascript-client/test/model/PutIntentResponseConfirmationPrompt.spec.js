...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.PutIntentResponseConfirmationPrompt();
  });
  ...
  describe('PutIntentResponseConfirmationPrompt', function() {
    it('should create an instance of PutIntentResponseConfirmationPrompt', function() {
      // uncomment below and update the code to test PutIntentResponseConfirmationPrompt
      //var instance = new AmazonLexModelBuildingService.PutIntentResponseConfirmationPrompt();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.PutIntentResponseConfirmationPrompt);
    });
