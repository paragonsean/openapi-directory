...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.PutIntentRequestFollowUpPromptPrompt();
  });
  ...
  describe('PutIntentRequestFollowUpPromptPrompt', function() {
    it('should create an instance of PutIntentRequestFollowUpPromptPrompt', function() {
      // uncomment below and update the code to test PutIntentRequestFollowUpPromptPrompt
      //var instance = new AmazonLexModelBuildingService.PutIntentRequestFollowUpPromptPrompt();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.PutIntentRequestFollowUpPromptPrompt);
    });
