...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.PutIntentRequestConfirmationPrompt();
  });
  ...
  describe('PutIntentRequestConfirmationPrompt', function() {
    it('should create an instance of PutIntentRequestConfirmationPrompt', function() {
      // uncomment below and update the code to test PutIntentRequestConfirmationPrompt
      //var instance = new AmazonLexModelBuildingService.PutIntentRequestConfirmationPrompt();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.PutIntentRequestConfirmationPrompt);
    });
