...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingService.SlotValueElicitationPrompt();
  });
  ...
  describe('SlotValueElicitationPrompt', function() {
    it('should create an instance of SlotValueElicitationPrompt', function() {
      // uncomment below and update the code to test SlotValueElicitationPrompt
      //var instance = new AmazonLexModelBuildingService.SlotValueElicitationPrompt();
      //expect(instance).to.be.a(AmazonLexModelBuildingService.SlotValueElicitationPrompt);
    });
