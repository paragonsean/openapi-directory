...
|**slotTypeConfigurations** | [**List&lt;SlotTypeConfiguration&gt;**](SlotTypeConfiguration.md) | Configuration information that extends the parent built-in slot type. The configuration is added to the settings for the parent slot type. |  [optional] |
