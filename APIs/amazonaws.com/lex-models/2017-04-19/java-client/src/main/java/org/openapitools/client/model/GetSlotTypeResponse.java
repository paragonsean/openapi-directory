...
public class GetSlotTypeResponse {
  ...
  public GetSlotTypeResponse() {
  }

  public GetSlotTypeResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetSlotTypeResponse description(String description) {
  ...
  public GetSlotTypeResponse enumerationValues(List enumerationValues) {
  ...
  public GetSlotTypeResponse lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public GetSlotTypeResponse createdDate(OffsetDateTime createdDate) {
  ...
  public GetSlotTypeResponse version(String version) {
  ...
  public GetSlotTypeResponse checksum(String checksum) {
  ...
  public GetSlotTypeResponse valueSelectionStrategy(SlotValueSelectionStrategy valueSelectionStrategy) {
  ...
  public GetSlotTypeResponse parentSlotTypeSignature(String parentSlotTypeSignature) {
  ...
  public GetSlotTypeResponse slotTypeConfigurations(List slotTypeConfigurations) {
  ...
  public boolean equals(Object o) {
    ...
    GetSlotTypeResponse getSlotTypeResponse = (GetSlotTypeResponse) o;
    return Objects.equals(this.name, getSlotTypeResponse.name) &&
        Objects.equals(this.description, getSlotTypeResponse.description) &&
        Objects.equals(this.enumerationValues, getSlotTypeResponse.enumerationValues) &&
        Objects.equals(this.lastUpdatedDate, getSlotTypeResponse.lastUpdatedDate) &&
        Objects.equals(this.createdDate, getSlotTypeResponse.createdDate) &&
        Objects.equals(this.version, getSlotTypeResponse.version) &&
        Objects.equals(this.checksum, getSlotTypeResponse.checksum) &&
        Objects.equals(this.valueSelectionStrategy, getSlotTypeResponse.valueSelectionStrategy) &&
        Objects.equals(this.parentSlotTypeSignature, getSlotTypeResponse.parentSlotTypeSignature) &&
        Objects.equals(this.slotTypeConfigurations, getSlotTypeResponse.slotTypeConfigurations);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSlotTypeResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSlotTypeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSlotTypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSlotTypeResponse is not found in the empty JSON string", GetSlotTypeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSlotTypeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSlotTypeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSlotTypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSlotTypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSlotTypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSlotTypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSlotTypeResponse>() {
           @Override
           public void write(JsonWriter out, GetSlotTypeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSlotTypeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSlotTypeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSlotTypeResponse
   * @throws IOException if the JSON string is invalid with respect to GetSlotTypeResponse
   */
  public static GetSlotTypeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSlotTypeResponse.class);
  }

  /**
   * Convert an instance of GetSlotTypeResponse to an JSON string
   *
   * @return JSON string
   */
