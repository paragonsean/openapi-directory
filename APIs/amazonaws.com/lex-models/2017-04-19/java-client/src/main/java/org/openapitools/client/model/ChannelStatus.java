...
public enum ChannelStatus {
  ...
  public static class Adapter extends TypeAdapter<ChannelStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChannelStatus enumeration) throws IOException {
