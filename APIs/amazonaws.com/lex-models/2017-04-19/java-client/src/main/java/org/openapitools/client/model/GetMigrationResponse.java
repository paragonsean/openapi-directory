...
public class GetMigrationResponse {
  ...
  public GetMigrationResponse() {
  }

  public GetMigrationResponse migrationId(String migrationId) {
  ...
  public GetMigrationResponse v1BotName(String v1BotName) {
  ...
  public GetMigrationResponse v1BotVersion(String v1BotVersion) {
  ...
  public GetMigrationResponse v1BotLocale(Locale v1BotLocale) {
  ...
  public GetMigrationResponse v2BotId(String v2BotId) {
  ...
  public GetMigrationResponse v2BotRole(String v2BotRole) {
  ...
  public GetMigrationResponse migrationStatus(MigrationStatus migrationStatus) {
  ...
  public GetMigrationResponse migrationStrategy(MigrationStrategy migrationStrategy) {
  ...
  public GetMigrationResponse migrationTimestamp(OffsetDateTime migrationTimestamp) {
  ...
  public GetMigrationResponse alerts(List alerts) {
    this.alerts = alerts;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetMigrationResponse getMigrationResponse = (GetMigrationResponse) o;
    return Objects.equals(this.migrationId, getMigrationResponse.migrationId) &&
        Objects.equals(this.v1BotName, getMigrationResponse.v1BotName) &&
        Objects.equals(this.v1BotVersion, getMigrationResponse.v1BotVersion) &&
        Objects.equals(this.v1BotLocale, getMigrationResponse.v1BotLocale) &&
        Objects.equals(this.v2BotId, getMigrationResponse.v2BotId) &&
        Objects.equals(this.v2BotRole, getMigrationResponse.v2BotRole) &&
        Objects.equals(this.migrationStatus, getMigrationResponse.migrationStatus) &&
        Objects.equals(this.migrationStrategy, getMigrationResponse.migrationStrategy) &&
        Objects.equals(this.migrationTimestamp, getMigrationResponse.migrationTimestamp) &&
        Objects.equals(this.alerts, getMigrationResponse.alerts);
  }

  @Override
  public int hashCode() {
    return Objects.hash(migrationId, v1BotName, v1BotVersion, v1BotLocale, v2BotId, v2BotRole, migrationStatus, migrationStrategy, migrationTimestamp, alerts);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetMigrationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMigrationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMigrationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMigrationResponse is not found in the empty JSON string", GetMigrationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMigrationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMigrationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("alerts") != null && !jsonObj.get("alerts").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("alerts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMigrationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMigrationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMigrationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMigrationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMigrationResponse>() {
           @Override
           public void write(JsonWriter out, GetMigrationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMigrationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMigrationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMigrationResponse
   * @throws IOException if the JSON string is invalid with respect to GetMigrationResponse
   */
  public static GetMigrationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMigrationResponse.class);
  }

  /**
   * Convert an instance of GetMigrationResponse to an JSON string
   *
   * @return JSON string
   */
