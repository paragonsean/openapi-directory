...
public class CreateSlotTypeVersionResponse {
  ...
  public CreateSlotTypeVersionResponse() {
  }

  public CreateSlotTypeVersionResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateSlotTypeVersionResponse description(String description) {
  ...
  public CreateSlotTypeVersionResponse enumerationValues(List enumerationValues) {
  ...
  public CreateSlotTypeVersionResponse lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public CreateSlotTypeVersionResponse createdDate(OffsetDateTime createdDate) {
  ...
  public CreateSlotTypeVersionResponse version(String version) {
  ...
  public CreateSlotTypeVersionResponse checksum(String checksum) {
  ...
  public CreateSlotTypeVersionResponse valueSelectionStrategy(SlotValueSelectionStrategy valueSelectionStrategy) {
  ...
  public CreateSlotTypeVersionResponse parentSlotTypeSignature(String parentSlotTypeSignature) {
  ...
  public CreateSlotTypeVersionResponse slotTypeConfigurations(List slotTypeConfigurations) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSlotTypeVersionResponse createSlotTypeVersionResponse = (CreateSlotTypeVersionResponse) o;
    return Objects.equals(this.name, createSlotTypeVersionResponse.name) &&
        Objects.equals(this.description, createSlotTypeVersionResponse.description) &&
        Objects.equals(this.enumerationValues, createSlotTypeVersionResponse.enumerationValues) &&
        Objects.equals(this.lastUpdatedDate, createSlotTypeVersionResponse.lastUpdatedDate) &&
        Objects.equals(this.createdDate, createSlotTypeVersionResponse.createdDate) &&
        Objects.equals(this.version, createSlotTypeVersionResponse.version) &&
        Objects.equals(this.checksum, createSlotTypeVersionResponse.checksum) &&
        Objects.equals(this.valueSelectionStrategy, createSlotTypeVersionResponse.valueSelectionStrategy) &&
        Objects.equals(this.parentSlotTypeSignature, createSlotTypeVersionResponse.parentSlotTypeSignature) &&
        Objects.equals(this.slotTypeConfigurations, createSlotTypeVersionResponse.slotTypeConfigurations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, enumerationValues, lastUpdatedDate, createdDate, version, checksum, valueSelectionStrategy, parentSlotTypeSignature, slotTypeConfigurations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateSlotTypeVersionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSlotTypeVersionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSlotTypeVersionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSlotTypeVersionResponse is not found in the empty JSON string", CreateSlotTypeVersionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSlotTypeVersionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSlotTypeVersionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSlotTypeVersionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSlotTypeVersionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSlotTypeVersionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSlotTypeVersionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSlotTypeVersionResponse>() {
           @Override
           public void write(JsonWriter out, CreateSlotTypeVersionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSlotTypeVersionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSlotTypeVersionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSlotTypeVersionResponse
   * @throws IOException if the JSON string is invalid with respect to CreateSlotTypeVersionResponse
   */
  public static CreateSlotTypeVersionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSlotTypeVersionResponse.class);
  }

  /**
   * Convert an instance of CreateSlotTypeVersionResponse to an JSON string
   *
   * @return JSON string
   */
