...
class PutIntentResponseFollowUpPrompt(Model):
    ...
    def __init__(self, prompt: PutIntentRequestFollowUpPromptPrompt=None, rejection_statement: PutIntentRequestFollowUpPromptRejectionStatement=None):
        """PutIntentResponseFollowUpPrompt - a model defined in OpenAPI

        :param prompt: The prompt of this PutIntentResponseFollowUpPrompt.
        :param rejection_statement: The rejection_statement of this PutIntentResponseFollowUpPrompt.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PutIntentResponseFollowUpPrompt':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PutIntentResponse_followUpPrompt of this PutIntentResponseFollowUpPrompt.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def prompt(self):
        """Gets the prompt of this PutIntentResponseFollowUpPrompt.


        :return: The prompt of this PutIntentResponseFollowUpPrompt.
    ...
    def prompt(self, prompt):
        """Sets the prompt of this PutIntentResponseFollowUpPrompt.
    ...
    def rejection_statement(self):
        """Gets the rejection_statement of this PutIntentResponseFollowUpPrompt.


        :return: The rejection_statement of this PutIntentResponseFollowUpPrompt.
    ...
    def rejection_statement(self, rejection_statement):
        """Sets the rejection_statement of this PutIntentResponseFollowUpPrompt.
