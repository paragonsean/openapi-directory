...
class Prompt(Model):
    ...
    def __init__(self, messages: List=None, max_attempts: int=None, response_card: str=None):
        ...
        :param messages: The messages of this Prompt.
        :param max_attempts: The max_attempts of this Prompt.
        :param response_card: The response_card of this Prompt.
        """
        self.openapi_types = {
            'messages': List,
            'max_attempts': int,
    ...
    @property
    def messages(self):
        """Gets the messages of this Prompt.


        :return: The messages of this Prompt.
        :rtype: List
        """
    ...
    def messages(self, messages):
        """Sets the messages of this Prompt.
    ...
    def max_attempts(self):
        """Gets the max_attempts of this Prompt.


        :return: The max_attempts of this Prompt.
        :rtype: int
        """
    ...
    def max_attempts(self, max_attempts):
        """Sets the max_attempts of this Prompt.
    ...
    def response_card(self):
        """Gets the response_card of this Prompt.


        :return: The response_card of this Prompt.
        :rtype: str
        """
    ...
    def response_card(self, response_card):
        """Sets the response_card of this Prompt.
