...
class PutIntentRequestFollowUpPrompt(Model):
    ...
    def __init__(self, prompt: PutIntentRequestFollowUpPromptPrompt=None, rejection_statement: PutIntentRequestFollowUpPromptRejectionStatement=None):
        """PutIntentRequestFollowUpPrompt - a model defined in OpenAPI

        :param prompt: The prompt of this PutIntentRequestFollowUpPrompt.
        :param rejection_statement: The rejection_statement of this PutIntentRequestFollowUpPrompt.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PutIntentRequestFollowUpPrompt':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PutIntentRequest_followUpPrompt of this PutIntentRequestFollowUpPrompt.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def prompt(self):
        """Gets the prompt of this PutIntentRequestFollowUpPrompt.


        :return: The prompt of this PutIntentRequestFollowUpPrompt.
    ...
    def prompt(self, prompt):
        """Sets the prompt of this PutIntentRequestFollowUpPrompt.
    ...
    def rejection_statement(self):
        """Gets the rejection_statement of this PutIntentRequestFollowUpPrompt.


        :return: The rejection_statement of this PutIntentRequestFollowUpPrompt.
    ...
    def rejection_statement(self, rejection_statement):
        """Sets the rejection_statement of this PutIntentRequestFollowUpPrompt.
