...
/*
 * OAISlot_valueElicitationPrompt.h
 *
 * 
 */

#ifndef OAISlot_valueElicitationPrompt_H
#define OAISlot_valueElicitationPrompt_H
...
class OAISlot_valueElicitationPrompt : public OAIObject {
public:
    OAISlot_valueElicitationPrompt();
    OAISlot_valueElicitationPrompt(QString json);
    ~OAISlot_valueElicitationPrompt() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISlot_valueElicitationPrompt)

#endif // OAISlot_valueElicitationPrompt_H
