...
OAIGetMigrationResponse::OAIGetMigrationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMigrationResponse::OAIGetMigrationResponse() {
    this->initializeModel();
}

OAIGetMigrationResponse::~OAIGetMigrationResponse() {}

void OAIGetMigrationResponse::initializeModel() {
...
void OAIGetMigrationResponse::fromJson(QString jsonString) {
...
void OAIGetMigrationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetMigrationResponse::asJson() const {
...
QJsonObject OAIGetMigrationResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetMigrationResponse::getMigrationId() const {
    return m_migration_id;
}
void OAIGetMigrationResponse::setMigrationId(const QString &migration_id) {
    m_migration_id = migration_id;
    m_migration_id_isSet = true;
}

bool OAIGetMigrationResponse::is_migration_id_Set() const{
    return m_migration_id_isSet;
}

bool OAIGetMigrationResponse::is_migration_id_Valid() const{
    return m_migration_id_isValid;
}

QString OAIGetMigrationResponse::getV1BotName() const {
    return m_v1_bot_name;
}
void OAIGetMigrationResponse::setV1BotName(const QString &v1_bot_name) {
    m_v1_bot_name = v1_bot_name;
    m_v1_bot_name_isSet = true;
}

bool OAIGetMigrationResponse::is_v1_bot_name_Set() const{
    return m_v1_bot_name_isSet;
}

bool OAIGetMigrationResponse::is_v1_bot_name_Valid() const{
    return m_v1_bot_name_isValid;
}

QString OAIGetMigrationResponse::getV1BotVersion() const {
    return m_v1_bot_version;
}
void OAIGetMigrationResponse::setV1BotVersion(const QString &v1_bot_version) {
    m_v1_bot_version = v1_bot_version;
    m_v1_bot_version_isSet = true;
}

bool OAIGetMigrationResponse::is_v1_bot_version_Set() const{
    return m_v1_bot_version_isSet;
}

bool OAIGetMigrationResponse::is_v1_bot_version_Valid() const{
    return m_v1_bot_version_isValid;
}

OAILocale OAIGetMigrationResponse::getV1BotLocale() const {
    return m_v1_bot_locale;
}
void OAIGetMigrationResponse::setV1BotLocale(const OAILocale &v1_bot_locale) {
    m_v1_bot_locale = v1_bot_locale;
    m_v1_bot_locale_isSet = true;
}

bool OAIGetMigrationResponse::is_v1_bot_locale_Set() const{
    return m_v1_bot_locale_isSet;
}

bool OAIGetMigrationResponse::is_v1_bot_locale_Valid() const{
    return m_v1_bot_locale_isValid;
}

QString OAIGetMigrationResponse::getV2BotId() const {
    return m_v2_bot_id;
}
void OAIGetMigrationResponse::setV2BotId(const QString &v2_bot_id) {
    m_v2_bot_id = v2_bot_id;
    m_v2_bot_id_isSet = true;
}

bool OAIGetMigrationResponse::is_v2_bot_id_Set() const{
    return m_v2_bot_id_isSet;
}

bool OAIGetMigrationResponse::is_v2_bot_id_Valid() const{
    return m_v2_bot_id_isValid;
}

QString OAIGetMigrationResponse::getV2BotRole() const {
    return m_v2_bot_role;
}
void OAIGetMigrationResponse::setV2BotRole(const QString &v2_bot_role) {
    m_v2_bot_role = v2_bot_role;
    m_v2_bot_role_isSet = true;
}

bool OAIGetMigrationResponse::is_v2_bot_role_Set() const{
    return m_v2_bot_role_isSet;
}

bool OAIGetMigrationResponse::is_v2_bot_role_Valid() const{
    return m_v2_bot_role_isValid;
}

OAIMigrationStatus OAIGetMigrationResponse::getMigrationStatus() const {
    return m_migration_status;
}
void OAIGetMigrationResponse::setMigrationStatus(const OAIMigrationStatus &migration_status) {
    m_migration_status = migration_status;
    m_migration_status_isSet = true;
}

bool OAIGetMigrationResponse::is_migration_status_Set() const{
    return m_migration_status_isSet;
}

bool OAIGetMigrationResponse::is_migration_status_Valid() const{
    return m_migration_status_isValid;
}

OAIMigrationStrategy OAIGetMigrationResponse::getMigrationStrategy() const {
    return m_migration_strategy;
}
void OAIGetMigrationResponse::setMigrationStrategy(const OAIMigrationStrategy &migration_strategy) {
    m_migration_strategy = migration_strategy;
    m_migration_strategy_isSet = true;
}

bool OAIGetMigrationResponse::is_migration_strategy_Set() const{
    return m_migration_strategy_isSet;
}

bool OAIGetMigrationResponse::is_migration_strategy_Valid() const{
    return m_migration_strategy_isValid;
}

QDateTime OAIGetMigrationResponse::getMigrationTimestamp() const {
    return m_migration_timestamp;
}
void OAIGetMigrationResponse::setMigrationTimestamp(const QDateTime &migration_timestamp) {
    m_migration_timestamp = migration_timestamp;
    m_migration_timestamp_isSet = true;
}

bool OAIGetMigrationResponse::is_migration_timestamp_Set() const{
    return m_migration_timestamp_isSet;
}

bool OAIGetMigrationResponse::is_migration_timestamp_Valid() const{
    return m_migration_timestamp_isValid;
}

QList OAIGetMigrationResponse::getAlerts() const {
    return m_alerts;
}
void OAIGetMigrationResponse::setAlerts(const QList &alerts) {
    m_alerts = alerts;
    m_alerts_isSet = true;
}

bool OAIGetMigrationResponse::is_alerts_Set() const{
    return m_alerts_isSet;
}

bool OAIGetMigrationResponse::is_alerts_Valid() const{
    return m_alerts_isValid;
}

bool OAIGetMigrationResponse::isSet() const {
...
bool OAIGetMigrationResponse::isValid() const {
