...
/*
 * OAIPutBotAliasResponse.h
 *
 * 
 */

#ifndef OAIPutBotAliasResponse_H
#define OAIPutBotAliasResponse_H
...
class OAIPutBotAliasResponse : public OAIObject {
public:
    OAIPutBotAliasResponse();
    OAIPutBotAliasResponse(QString json);
    ~OAIPutBotAliasResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutBotAliasResponse)

#endif // OAIPutBotAliasResponse_H
