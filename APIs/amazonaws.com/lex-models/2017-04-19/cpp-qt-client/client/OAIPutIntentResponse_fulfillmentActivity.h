...
/*
 * OAIPutIntentResponse_fulfillmentActivity.h
 *
 * 
 */

#ifndef OAIPutIntentResponse_fulfillmentActivity_H
#define OAIPutIntentResponse_fulfillmentActivity_H
...
class OAIPutIntentResponse_fulfillmentActivity : public OAIObject {
public:
    OAIPutIntentResponse_fulfillmentActivity();
    OAIPutIntentResponse_fulfillmentActivity(QString json);
    ~OAIPutIntentResponse_fulfillmentActivity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutIntentResponse_fulfillmentActivity)

#endif // OAIPutIntentResponse_fulfillmentActivity_H
