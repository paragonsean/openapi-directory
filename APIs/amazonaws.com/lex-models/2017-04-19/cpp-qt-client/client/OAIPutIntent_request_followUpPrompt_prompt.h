...
/*
 * OAIPutIntent_request_followUpPrompt_prompt.h
 *
 * 
 */

#ifndef OAIPutIntent_request_followUpPrompt_prompt_H
#define OAIPutIntent_request_followUpPrompt_prompt_H
...
class OAIPutIntent_request_followUpPrompt_prompt : public OAIObject {
public:
    OAIPutIntent_request_followUpPrompt_prompt();
    OAIPutIntent_request_followUpPrompt_prompt(QString json);
    ~OAIPutIntent_request_followUpPrompt_prompt() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutIntent_request_followUpPrompt_prompt)

#endif // OAIPutIntent_request_followUpPrompt_prompt_H
