...
QList OAIPrompt::getMessages() const {
    return m_messages;
}
void OAIPrompt::setMessages(const QList &messages) {
    m_messages = messages;
    m_messages_isSet = true;
}

bool OAIPrompt::is_messages_Set() const{
    return m_messages_isSet;
}

bool OAIPrompt::is_messages_Valid() const{
    return m_messages_isValid;
}

qint32 OAIPrompt::getMaxAttempts() const {
    return m_max_attempts;
}
void OAIPrompt::setMaxAttempts(const qint32 &max_attempts) {
    m_max_attempts = max_attempts;
    m_max_attempts_isSet = true;
}

bool OAIPrompt::is_max_attempts_Set() const{
    return m_max_attempts_isSet;
}

bool OAIPrompt::is_max_attempts_Valid() const{
    return m_max_attempts_isValid;
}

QString OAIPrompt::getResponseCard() const {
    return m_response_card;
}
void OAIPrompt::setResponseCard(const QString &response_card) {
    m_response_card = response_card;
    m_response_card_isSet = true;
}

bool OAIPrompt::is_response_card_Set() const{
    return m_response_card_isSet;
}

bool OAIPrompt::is_response_card_Valid() const{
