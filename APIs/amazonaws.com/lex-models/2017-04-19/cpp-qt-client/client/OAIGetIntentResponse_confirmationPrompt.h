...
/*
 * OAIGetIntentResponse_confirmationPrompt.h
 *
 * 
 */

#ifndef OAIGetIntentResponse_confirmationPrompt_H
#define OAIGetIntentResponse_confirmationPrompt_H
...
class OAIGetIntentResponse_confirmationPrompt : public OAIObject {
public:
    OAIGetIntentResponse_confirmationPrompt();
    OAIGetIntentResponse_confirmationPrompt(QString json);
    ~OAIGetIntentResponse_confirmationPrompt() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetIntentResponse_confirmationPrompt)

#endif // OAIGetIntentResponse_confirmationPrompt_H
