...
OAIPutIntentResponse::OAIPutIntentResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutIntentResponse::OAIPutIntentResponse() {
    this->initializeModel();
}

OAIPutIntentResponse::~OAIPutIntentResponse() {}

void OAIPutIntentResponse::initializeModel() {
...
void OAIPutIntentResponse::fromJson(QString jsonString) {
...
void OAIPutIntentResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPutIntentResponse::asJson() const {
...
QJsonObject OAIPutIntentResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIPutIntentResponse::getName() const {
    return m_name;
}
void OAIPutIntentResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPutIntentResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPutIntentResponse::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPutIntentResponse::getDescription() const {
    return m_description;
}
void OAIPutIntentResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPutIntentResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPutIntentResponse::is_description_Valid() const{
    return m_description_isValid;
}

QList OAIPutIntentResponse::getRSlots() const {
    return m_r_slots;
}
void OAIPutIntentResponse::setRSlots(const QList &r_slots) {
    m_r_slots = r_slots;
    m_r_slots_isSet = true;
}

bool OAIPutIntentResponse::is_r_slots_Set() const{
    return m_r_slots_isSet;
}

bool OAIPutIntentResponse::is_r_slots_Valid() const{
    return m_r_slots_isValid;
}

QList OAIPutIntentResponse::getSampleUtterances() const {
    return m_sample_utterances;
}
void OAIPutIntentResponse::setSampleUtterances(const QList &sample_utterances) {
    m_sample_utterances = sample_utterances;
    m_sample_utterances_isSet = true;
}

bool OAIPutIntentResponse::is_sample_utterances_Set() const{
    return m_sample_utterances_isSet;
}

bool OAIPutIntentResponse::is_sample_utterances_Valid() const{
    return m_sample_utterances_isValid;
}

OAIPutIntentResponse_confirmationPrompt OAIPutIntentResponse::getConfirmationPrompt() const {
    return m_confirmation_prompt;
}
void OAIPutIntentResponse::setConfirmationPrompt(const OAIPutIntentResponse_confirmationPrompt &confirmation_prompt) {
    m_confirmation_prompt = confirmation_prompt;
    m_confirmation_prompt_isSet = true;
}

bool OAIPutIntentResponse::is_confirmation_prompt_Set() const{
    return m_confirmation_prompt_isSet;
}

bool OAIPutIntentResponse::is_confirmation_prompt_Valid() const{
    return m_confirmation_prompt_isValid;
}

OAIPutIntentResponse_rejectionStatement OAIPutIntentResponse::getRejectionStatement() const {
    return m_rejection_statement;
}
void OAIPutIntentResponse::setRejectionStatement(const OAIPutIntentResponse_rejectionStatement &rejection_statement) {
    m_rejection_statement = rejection_statement;
    m_rejection_statement_isSet = true;
}

bool OAIPutIntentResponse::is_rejection_statement_Set() const{
    return m_rejection_statement_isSet;
}

bool OAIPutIntentResponse::is_rejection_statement_Valid() const{
    return m_rejection_statement_isValid;
}

OAIPutIntentResponse_followUpPrompt OAIPutIntentResponse::getFollowUpPrompt() const {
    return m_follow_up_prompt;
}
void OAIPutIntentResponse::setFollowUpPrompt(const OAIPutIntentResponse_followUpPrompt &follow_up_prompt) {
    m_follow_up_prompt = follow_up_prompt;
    m_follow_up_prompt_isSet = true;
}

bool OAIPutIntentResponse::is_follow_up_prompt_Set() const{
    return m_follow_up_prompt_isSet;
}

bool OAIPutIntentResponse::is_follow_up_prompt_Valid() const{
    return m_follow_up_prompt_isValid;
}

OAIPutIntentResponse_conclusionStatement OAIPutIntentResponse::getConclusionStatement() const {
    return m_conclusion_statement;
}
void OAIPutIntentResponse::setConclusionStatement(const OAIPutIntentResponse_conclusionStatement &conclusion_statement) {
    m_conclusion_statement = conclusion_statement;
    m_conclusion_statement_isSet = true;
}

bool OAIPutIntentResponse::is_conclusion_statement_Set() const{
    return m_conclusion_statement_isSet;
}

bool OAIPutIntentResponse::is_conclusion_statement_Valid() const{
    return m_conclusion_statement_isValid;
}

OAIPutIntentResponse_dialogCodeHook OAIPutIntentResponse::getDialogCodeHook() const {
    return m_dialog_code_hook;
}
void OAIPutIntentResponse::setDialogCodeHook(const OAIPutIntentResponse_dialogCodeHook &dialog_code_hook) {
    m_dialog_code_hook = dialog_code_hook;
    m_dialog_code_hook_isSet = true;
}

bool OAIPutIntentResponse::is_dialog_code_hook_Set() const{
    return m_dialog_code_hook_isSet;
}

bool OAIPutIntentResponse::is_dialog_code_hook_Valid() const{
    return m_dialog_code_hook_isValid;
}

OAIPutIntentResponse_fulfillmentActivity OAIPutIntentResponse::getFulfillmentActivity() const {
    return m_fulfillment_activity;
}
void OAIPutIntentResponse::setFulfillmentActivity(const OAIPutIntentResponse_fulfillmentActivity &fulfillment_activity) {
    m_fulfillment_activity = fulfillment_activity;
    m_fulfillment_activity_isSet = true;
}

bool OAIPutIntentResponse::is_fulfillment_activity_Set() const{
    return m_fulfillment_activity_isSet;
}

bool OAIPutIntentResponse::is_fulfillment_activity_Valid() const{
    return m_fulfillment_activity_isValid;
}

QString OAIPutIntentResponse::getParentIntentSignature() const {
    return m_parent_intent_signature;
}
void OAIPutIntentResponse::setParentIntentSignature(const QString &parent_intent_signature) {
    m_parent_intent_signature = parent_intent_signature;
    m_parent_intent_signature_isSet = true;
}

bool OAIPutIntentResponse::is_parent_intent_signature_Set() const{
    return m_parent_intent_signature_isSet;
}

bool OAIPutIntentResponse::is_parent_intent_signature_Valid() const{
    return m_parent_intent_signature_isValid;
}

QDateTime OAIPutIntentResponse::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAIPutIntentResponse::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAIPutIntentResponse::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAIPutIntentResponse::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

QDateTime OAIPutIntentResponse::getCreatedDate() const {
    return m_created_date;
}
void OAIPutIntentResponse::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIPutIntentResponse::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIPutIntentResponse::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QString OAIPutIntentResponse::getVersion() const {
    return m_version;
}
void OAIPutIntentResponse::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIPutIntentResponse::is_version_Set() const{
    return m_version_isSet;
}

bool OAIPutIntentResponse::is_version_Valid() const{
    return m_version_isValid;
}

QString OAIPutIntentResponse::getChecksum() const {
    return m_checksum;
}
void OAIPutIntentResponse::setChecksum(const QString &checksum) {
    m_checksum = checksum;
    m_checksum_isSet = true;
}

bool OAIPutIntentResponse::is_checksum_Set() const{
    return m_checksum_isSet;
}

bool OAIPutIntentResponse::is_checksum_Valid() const{
    return m_checksum_isValid;
}

bool OAIPutIntentResponse::getCreateVersion() const {
    return m_create_version;
}
void OAIPutIntentResponse::setCreateVersion(const bool &create_version) {
    m_create_version = create_version;
    m_create_version_isSet = true;
}

bool OAIPutIntentResponse::is_create_version_Set() const{
    return m_create_version_isSet;
}

bool OAIPutIntentResponse::is_create_version_Valid() const{
    return m_create_version_isValid;
}

OAIPutIntentResponse_kendraConfiguration OAIPutIntentResponse::getKendraConfiguration() const {
    return m_kendra_configuration;
}
void OAIPutIntentResponse::setKendraConfiguration(const OAIPutIntentResponse_kendraConfiguration &kendra_configuration) {
    m_kendra_configuration = kendra_configuration;
    m_kendra_configuration_isSet = true;
}

bool OAIPutIntentResponse::is_kendra_configuration_Set() const{
    return m_kendra_configuration_isSet;
}

bool OAIPutIntentResponse::is_kendra_configuration_Valid() const{
    return m_kendra_configuration_isValid;
}

QList OAIPutIntentResponse::getInputContexts() const {
    return m_input_contexts;
}
void OAIPutIntentResponse::setInputContexts(const QList &input_contexts) {
    m_input_contexts = input_contexts;
    m_input_contexts_isSet = true;
}

bool OAIPutIntentResponse::is_input_contexts_Set() const{
    return m_input_contexts_isSet;
}

bool OAIPutIntentResponse::is_input_contexts_Valid() const{
    return m_input_contexts_isValid;
}

QList OAIPutIntentResponse::getOutputContexts() const {
    return m_output_contexts;
}
void OAIPutIntentResponse::setOutputContexts(const QList &output_contexts) {
    m_output_contexts = output_contexts;
    m_output_contexts_isSet = true;
}

bool OAIPutIntentResponse::is_output_contexts_Set() const{
    return m_output_contexts_isSet;
}

bool OAIPutIntentResponse::is_output_contexts_Valid() const{
    return m_output_contexts_isValid;
}

bool OAIPutIntentResponse::isSet() const {
...
bool OAIPutIntentResponse::isValid() const {
