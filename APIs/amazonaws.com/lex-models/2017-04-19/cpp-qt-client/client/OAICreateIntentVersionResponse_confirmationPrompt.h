...
/*
 * OAICreateIntentVersionResponse_confirmationPrompt.h
 *
 * 
 */

#ifndef OAICreateIntentVersionResponse_confirmationPrompt_H
#define OAICreateIntentVersionResponse_confirmationPrompt_H
...
class OAICreateIntentVersionResponse_confirmationPrompt : public OAIObject {
public:
    OAICreateIntentVersionResponse_confirmationPrompt();
    OAICreateIntentVersionResponse_confirmationPrompt(QString json);
    ~OAICreateIntentVersionResponse_confirmationPrompt() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIntentVersionResponse_confirmationPrompt)

#endif // OAICreateIntentVersionResponse_confirmationPrompt_H
