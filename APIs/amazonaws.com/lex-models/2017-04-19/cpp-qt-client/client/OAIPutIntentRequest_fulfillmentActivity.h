...
/*
 * OAIPutIntentRequest_fulfillmentActivity.h
 *
 * 
 */

#ifndef OAIPutIntentRequest_fulfillmentActivity_H
#define OAIPutIntentRequest_fulfillmentActivity_H
...
class OAIPutIntentRequest_fulfillmentActivity : public OAIObject {
public:
    OAIPutIntentRequest_fulfillmentActivity();
    OAIPutIntentRequest_fulfillmentActivity(QString json);
    ~OAIPutIntentRequest_fulfillmentActivity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutIntentRequest_fulfillmentActivity)

#endif // OAIPutIntentRequest_fulfillmentActivity_H
