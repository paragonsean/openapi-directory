...
/*
 * OAIGetSlotTypeResponse.h
 *
 * 
 */

#ifndef OAIGetSlotTypeResponse_H
#define OAIGetSlotTypeResponse_H
...
class OAIGetSlotTypeResponse : public OAIObject {
public:
    OAIGetSlotTypeResponse();
    OAIGetSlotTypeResponse(QString json);
    ~OAIGetSlotTypeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSlotTypeResponse)

#endif // OAIGetSlotTypeResponse_H
