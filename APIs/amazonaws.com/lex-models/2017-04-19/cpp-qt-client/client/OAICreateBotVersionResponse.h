...
namespace OpenAPI {
class OAICreateBotVersionResponse_clarificationPrompt;
...
public:
    ...
    OAICreateBotVersionResponse_clarificationPrompt getClarificationPrompt() const;
    void setClarificationPrompt(const OAICreateBotVersionResponse_clarificationPrompt &clarification_prompt);
...
private:
    ...
    OAICreateBotVersionResponse_clarificationPrompt m_clarification_prompt;
