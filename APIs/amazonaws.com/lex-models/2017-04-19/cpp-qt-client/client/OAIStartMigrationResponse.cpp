...
OAIStartMigrationResponse::OAIStartMigrationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartMigrationResponse::OAIStartMigrationResponse() {
    this->initializeModel();
}

OAIStartMigrationResponse::~OAIStartMigrationResponse() {}

void OAIStartMigrationResponse::initializeModel() {
...
void OAIStartMigrationResponse::fromJson(QString jsonString) {
...
void OAIStartMigrationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIStartMigrationResponse::asJson() const {
...
QJsonObject OAIStartMigrationResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartMigrationResponse::getV1BotName() const {
    return m_v1_bot_name;
}
void OAIStartMigrationResponse::setV1BotName(const QString &v1_bot_name) {
    m_v1_bot_name = v1_bot_name;
    m_v1_bot_name_isSet = true;
}

bool OAIStartMigrationResponse::is_v1_bot_name_Set() const{
    return m_v1_bot_name_isSet;
}

bool OAIStartMigrationResponse::is_v1_bot_name_Valid() const{
    return m_v1_bot_name_isValid;
}

QString OAIStartMigrationResponse::getV1BotVersion() const {
    return m_v1_bot_version;
}
void OAIStartMigrationResponse::setV1BotVersion(const QString &v1_bot_version) {
    m_v1_bot_version = v1_bot_version;
    m_v1_bot_version_isSet = true;
}

bool OAIStartMigrationResponse::is_v1_bot_version_Set() const{
    return m_v1_bot_version_isSet;
}

bool OAIStartMigrationResponse::is_v1_bot_version_Valid() const{
    return m_v1_bot_version_isValid;
}

OAILocale OAIStartMigrationResponse::getV1BotLocale() const {
    return m_v1_bot_locale;
}
void OAIStartMigrationResponse::setV1BotLocale(const OAILocale &v1_bot_locale) {
    m_v1_bot_locale = v1_bot_locale;
    m_v1_bot_locale_isSet = true;
}

bool OAIStartMigrationResponse::is_v1_bot_locale_Set() const{
    return m_v1_bot_locale_isSet;
}

bool OAIStartMigrationResponse::is_v1_bot_locale_Valid() const{
    return m_v1_bot_locale_isValid;
}

QString OAIStartMigrationResponse::getV2BotId() const {
    return m_v2_bot_id;
}
void OAIStartMigrationResponse::setV2BotId(const QString &v2_bot_id) {
    m_v2_bot_id = v2_bot_id;
    m_v2_bot_id_isSet = true;
}

bool OAIStartMigrationResponse::is_v2_bot_id_Set() const{
    return m_v2_bot_id_isSet;
}

bool OAIStartMigrationResponse::is_v2_bot_id_Valid() const{
    return m_v2_bot_id_isValid;
}

QString OAIStartMigrationResponse::getV2BotRole() const {
    return m_v2_bot_role;
}
void OAIStartMigrationResponse::setV2BotRole(const QString &v2_bot_role) {
    m_v2_bot_role = v2_bot_role;
    m_v2_bot_role_isSet = true;
}

bool OAIStartMigrationResponse::is_v2_bot_role_Set() const{
    return m_v2_bot_role_isSet;
}

bool OAIStartMigrationResponse::is_v2_bot_role_Valid() const{
    return m_v2_bot_role_isValid;
}

QString OAIStartMigrationResponse::getMigrationId() const {
    return m_migration_id;
}
void OAIStartMigrationResponse::setMigrationId(const QString &migration_id) {
    m_migration_id = migration_id;
    m_migration_id_isSet = true;
}

bool OAIStartMigrationResponse::is_migration_id_Set() const{
    return m_migration_id_isSet;
}

bool OAIStartMigrationResponse::is_migration_id_Valid() const{
    return m_migration_id_isValid;
}

OAIMigrationStrategy OAIStartMigrationResponse::getMigrationStrategy() const {
    return m_migration_strategy;
}
void OAIStartMigrationResponse::setMigrationStrategy(const OAIMigrationStrategy &migration_strategy) {
    m_migration_strategy = migration_strategy;
    m_migration_strategy_isSet = true;
}

bool OAIStartMigrationResponse::is_migration_strategy_Set() const{
    return m_migration_strategy_isSet;
}

bool OAIStartMigrationResponse::is_migration_strategy_Valid() const{
    return m_migration_strategy_isValid;
}

QDateTime OAIStartMigrationResponse::getMigrationTimestamp() const {
    return m_migration_timestamp;
}
void OAIStartMigrationResponse::setMigrationTimestamp(const QDateTime &migration_timestamp) {
    m_migration_timestamp = migration_timestamp;
    m_migration_timestamp_isSet = true;
}

bool OAIStartMigrationResponse::is_migration_timestamp_Set() const{
    return m_migration_timestamp_isSet;
}

bool OAIStartMigrationResponse::is_migration_timestamp_Valid() const{
    return m_migration_timestamp_isValid;
}

bool OAIStartMigrationResponse::isSet() const {
...
bool OAIStartMigrationResponse::isValid() const {
