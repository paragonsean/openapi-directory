...
/*
 * OAIPutBotResponse_clarificationPrompt.h
 *
 * 
 */

#ifndef OAIPutBotResponse_clarificationPrompt_H
#define OAIPutBotResponse_clarificationPrompt_H
...
class OAIPutBotResponse_clarificationPrompt : public OAIObject {
public:
    OAIPutBotResponse_clarificationPrompt();
    OAIPutBotResponse_clarificationPrompt(QString json);
    ~OAIPutBotResponse_clarificationPrompt() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutBotResponse_clarificationPrompt)

#endif // OAIPutBotResponse_clarificationPrompt_H
