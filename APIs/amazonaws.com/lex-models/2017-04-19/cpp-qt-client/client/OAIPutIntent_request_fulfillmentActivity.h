...
/*
 * OAIPutIntent_request_fulfillmentActivity.h
 *
...
#ifndef OAIPutIntent_request_fulfillmentActivity_H
#define OAIPutIntent_request_fulfillmentActivity_H
...
class OAIPutIntent_request_fulfillmentActivity : public OAIObject {
public:
    OAIPutIntent_request_fulfillmentActivity();
    OAIPutIntent_request_fulfillmentActivity(QString json);
    ~OAIPutIntent_request_fulfillmentActivity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutIntent_request_fulfillmentActivity)

#endif // OAIPutIntent_request_fulfillmentActivity_H
