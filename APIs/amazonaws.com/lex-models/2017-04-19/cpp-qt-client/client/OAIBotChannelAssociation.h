...
/*
 * OAIBotChannelAssociation.h
 *
 * Represents an association between an Amazon Lex bot and an external messaging platform.
 */

#ifndef OAIBotChannelAssociation_H
#define OAIBotChannelAssociation_H
...
class OAIBotChannelAssociation : public OAIObject {
public:
    OAIBotChannelAssociation();
    OAIBotChannelAssociation(QString json);
    ~OAIBotChannelAssociation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBotChannelAssociation)

#endif // OAIBotChannelAssociation_H
