...
/*
 * OAILogSettingsRequest.h
 *
 * Settings used to configure delivery mode and destination for conversation logs.
 */

#ifndef OAILogSettingsRequest_H
#define OAILogSettingsRequest_H
...
class OAILogSettingsRequest : public OAIObject {
public:
    OAILogSettingsRequest();
    OAILogSettingsRequest(QString json);
    ~OAILogSettingsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogSettingsRequest)

#endif // OAILogSettingsRequest_H
