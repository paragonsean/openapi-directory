...
/*
 * OAIGetIntentResponse_fulfillmentActivity.h
 *
 * 
 */

#ifndef OAIGetIntentResponse_fulfillmentActivity_H
#define OAIGetIntentResponse_fulfillmentActivity_H
...
class OAIGetIntentResponse_fulfillmentActivity : public OAIObject {
public:
    OAIGetIntentResponse_fulfillmentActivity();
    OAIGetIntentResponse_fulfillmentActivity(QString json);
    ~OAIGetIntentResponse_fulfillmentActivity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetIntentResponse_fulfillmentActivity)

#endif // OAIGetIntentResponse_fulfillmentActivity_H
