...
#ifndef OAIOutputContext_H
#define OAIOutputContext_H
...
class OAIOutputContext : public OAIObject {
public:
    OAIOutputContext();
    OAIOutputContext(QString json);
    ~OAIOutputContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutputContext)

#endif // OAIOutputContext_H
