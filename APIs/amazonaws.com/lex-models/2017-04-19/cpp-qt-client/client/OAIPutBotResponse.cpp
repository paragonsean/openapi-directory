...
OAIPutBotResponse::OAIPutBotResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutBotResponse::OAIPutBotResponse() {
    this->initializeModel();
}

OAIPutBotResponse::~OAIPutBotResponse() {}

void OAIPutBotResponse::initializeModel() {
...
void OAIPutBotResponse::fromJson(QString jsonString) {
...
void OAIPutBotResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPutBotResponse::asJson() const {
...
QJsonObject OAIPutBotResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIPutBotResponse::getName() const {
    return m_name;
}
void OAIPutBotResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPutBotResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPutBotResponse::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPutBotResponse::getDescription() const {
    return m_description;
}
void OAIPutBotResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPutBotResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPutBotResponse::is_description_Valid() const{
    return m_description_isValid;
}

QList OAIPutBotResponse::getIntents() const {
    return m_intents;
}
void OAIPutBotResponse::setIntents(const QList &intents) {
    m_intents = intents;
    m_intents_isSet = true;
}

bool OAIPutBotResponse::is_intents_Set() const{
    return m_intents_isSet;
}

bool OAIPutBotResponse::is_intents_Valid() const{
    return m_intents_isValid;
}

bool OAIPutBotResponse::getEnableModelImprovements() const {
    return m_enable_model_improvements;
}
void OAIPutBotResponse::setEnableModelImprovements(const bool &enable_model_improvements) {
    m_enable_model_improvements = enable_model_improvements;
    m_enable_model_improvements_isSet = true;
}

bool OAIPutBotResponse::is_enable_model_improvements_Set() const{
    return m_enable_model_improvements_isSet;
}

bool OAIPutBotResponse::is_enable_model_improvements_Valid() const{
    return m_enable_model_improvements_isValid;
}

double OAIPutBotResponse::getNluIntentConfidenceThreshold() const {
    return m_nlu_intent_confidence_threshold;
}
void OAIPutBotResponse::setNluIntentConfidenceThreshold(const double &nlu_intent_confidence_threshold) {
    m_nlu_intent_confidence_threshold = nlu_intent_confidence_threshold;
    m_nlu_intent_confidence_threshold_isSet = true;
}

bool OAIPutBotResponse::is_nlu_intent_confidence_threshold_Set() const{
    return m_nlu_intent_confidence_threshold_isSet;
}

bool OAIPutBotResponse::is_nlu_intent_confidence_threshold_Valid() const{
    return m_nlu_intent_confidence_threshold_isValid;
}

OAIPutBotResponse_clarificationPrompt OAIPutBotResponse::getClarificationPrompt() const {
    return m_clarification_prompt;
}
void OAIPutBotResponse::setClarificationPrompt(const OAIPutBotResponse_clarificationPrompt &clarification_prompt) {
    m_clarification_prompt = clarification_prompt;
    m_clarification_prompt_isSet = true;
}

bool OAIPutBotResponse::is_clarification_prompt_Set() const{
    return m_clarification_prompt_isSet;
}

bool OAIPutBotResponse::is_clarification_prompt_Valid() const{
    return m_clarification_prompt_isValid;
}

OAICreateBotVersionResponse_abortStatement OAIPutBotResponse::getAbortStatement() const {
    return m_abort_statement;
}
void OAIPutBotResponse::setAbortStatement(const OAICreateBotVersionResponse_abortStatement &abort_statement) {
    m_abort_statement = abort_statement;
    m_abort_statement_isSet = true;
}

bool OAIPutBotResponse::is_abort_statement_Set() const{
    return m_abort_statement_isSet;
}

bool OAIPutBotResponse::is_abort_statement_Valid() const{
    return m_abort_statement_isValid;
}

OAIStatus OAIPutBotResponse::getStatus() const {
    return m_status;
}
void OAIPutBotResponse::setStatus(const OAIStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPutBotResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPutBotResponse::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIPutBotResponse::getFailureReason() const {
    return m_failure_reason;
}
void OAIPutBotResponse::setFailureReason(const QString &failure_reason) {
    m_failure_reason = failure_reason;
    m_failure_reason_isSet = true;
}

bool OAIPutBotResponse::is_failure_reason_Set() const{
    return m_failure_reason_isSet;
}

bool OAIPutBotResponse::is_failure_reason_Valid() const{
    return m_failure_reason_isValid;
}

QDateTime OAIPutBotResponse::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAIPutBotResponse::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAIPutBotResponse::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAIPutBotResponse::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

QDateTime OAIPutBotResponse::getCreatedDate() const {
    return m_created_date;
}
void OAIPutBotResponse::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIPutBotResponse::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIPutBotResponse::is_created_date_Valid() const{
    return m_created_date_isValid;
}

qint32 OAIPutBotResponse::getIdleSessionTtlinSeconds() const {
    return m_idle_session_ttlin_seconds;
}
void OAIPutBotResponse::setIdleSessionTtlinSeconds(const qint32 &idle_session_ttlin_seconds) {
    m_idle_session_ttlin_seconds = idle_session_ttlin_seconds;
    m_idle_session_ttlin_seconds_isSet = true;
}

bool OAIPutBotResponse::is_idle_session_ttlin_seconds_Set() const{
    return m_idle_session_ttlin_seconds_isSet;
}

bool OAIPutBotResponse::is_idle_session_ttlin_seconds_Valid() const{
    return m_idle_session_ttlin_seconds_isValid;
}

QString OAIPutBotResponse::getVoiceId() const {
    return m_voice_id;
}
void OAIPutBotResponse::setVoiceId(const QString &voice_id) {
    m_voice_id = voice_id;
    m_voice_id_isSet = true;
}

bool OAIPutBotResponse::is_voice_id_Set() const{
    return m_voice_id_isSet;
}

bool OAIPutBotResponse::is_voice_id_Valid() const{
    return m_voice_id_isValid;
}

QString OAIPutBotResponse::getChecksum() const {
    return m_checksum;
}
void OAIPutBotResponse::setChecksum(const QString &checksum) {
    m_checksum = checksum;
    m_checksum_isSet = true;
}

bool OAIPutBotResponse::is_checksum_Set() const{
    return m_checksum_isSet;
}

bool OAIPutBotResponse::is_checksum_Valid() const{
    return m_checksum_isValid;
}

QString OAIPutBotResponse::getVersion() const {
    return m_version;
}
void OAIPutBotResponse::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIPutBotResponse::is_version_Set() const{
    return m_version_isSet;
}

bool OAIPutBotResponse::is_version_Valid() const{
    return m_version_isValid;
}

OAILocale OAIPutBotResponse::getLocale() const {
    return m_locale;
}
void OAIPutBotResponse::setLocale(const OAILocale &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIPutBotResponse::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIPutBotResponse::is_locale_Valid() const{
    return m_locale_isValid;
}

bool OAIPutBotResponse::getChildDirected() const {
    return m_child_directed;
}
void OAIPutBotResponse::setChildDirected(const bool &child_directed) {
    m_child_directed = child_directed;
    m_child_directed_isSet = true;
}

bool OAIPutBotResponse::is_child_directed_Set() const{
    return m_child_directed_isSet;
}

bool OAIPutBotResponse::is_child_directed_Valid() const{
    return m_child_directed_isValid;
}

bool OAIPutBotResponse::getCreateVersion() const {
    return m_create_version;
}
void OAIPutBotResponse::setCreateVersion(const bool &create_version) {
    m_create_version = create_version;
    m_create_version_isSet = true;
}

bool OAIPutBotResponse::is_create_version_Set() const{
    return m_create_version_isSet;
}

bool OAIPutBotResponse::is_create_version_Valid() const{
    return m_create_version_isValid;
}

bool OAIPutBotResponse::getDetectSentiment() const {
    return m_detect_sentiment;
}
void OAIPutBotResponse::setDetectSentiment(const bool &detect_sentiment) {
    m_detect_sentiment = detect_sentiment;
    m_detect_sentiment_isSet = true;
}

bool OAIPutBotResponse::is_detect_sentiment_Set() const{
    return m_detect_sentiment_isSet;
}

bool OAIPutBotResponse::is_detect_sentiment_Valid() const{
    return m_detect_sentiment_isValid;
}

QList OAIPutBotResponse::getTags() const {
    return m_tags;
}
void OAIPutBotResponse::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIPutBotResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIPutBotResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIPutBotResponse::isSet() const {
...
bool OAIPutBotResponse::isValid() const {
