...
#ifndef OAIPutBotResponse_H
#define OAIPutBotResponse_H

#include <QJsonObject>

#include "OAICreateBotVersionResponse_abortStatement.h"
#include "OAILocale.h"
#include "OAIPutBotResponse_clarificationPrompt.h"
#include "OAIStatus.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIPutBotResponse_clarificationPrompt;
class OAICreateBotVersionResponse_abortStatement;

class OAIPutBotResponse : public OAIObject {
public:
    OAIPutBotResponse();
    OAIPutBotResponse(QString json);
    ~OAIPutBotResponse() override;
    ...
    OAIPutBotResponse_clarificationPrompt getClarificationPrompt() const;
    void setClarificationPrompt(const OAIPutBotResponse_clarificationPrompt &clarification_prompt);
    bool is_clarification_prompt_Set() const;
    bool is_clarification_prompt_Valid() const;

    OAICreateBotVersionResponse_abortStatement getAbortStatement() const;
    void setAbortStatement(const OAICreateBotVersionResponse_abortStatement &abort_statement);
...
private:
    ...
    OAIPutBotResponse_clarificationPrompt m_clarification_prompt;
    bool m_clarification_prompt_isSet;
    bool m_clarification_prompt_isValid;

    OAICreateBotVersionResponse_abortStatement m_abort_statement;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutBotResponse)

#endif // OAIPutBotResponse_H
