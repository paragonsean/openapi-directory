...
#include "OAIPutSlotTypeRequest.h"
...
OAIPutSlotTypeRequest::OAIPutSlotTypeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutSlotTypeRequest::OAIPutSlotTypeRequest() {
    this->initializeModel();
}

OAIPutSlotTypeRequest::~OAIPutSlotTypeRequest() {}

void OAIPutSlotTypeRequest::initializeModel() {
...
void OAIPutSlotTypeRequest::fromJson(QString jsonString) {
...
void OAIPutSlotTypeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutSlotTypeRequest::asJson() const {
...
QJsonObject OAIPutSlotTypeRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutSlotTypeRequest::getDescription() const {
    return m_description;
}
void OAIPutSlotTypeRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPutSlotTypeRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPutSlotTypeRequest::is_description_Valid() const{
    return m_description_isValid;
}

QList OAIPutSlotTypeRequest::getEnumerationValues() const {
    return m_enumeration_values;
}
void OAIPutSlotTypeRequest::setEnumerationValues(const QList &enumeration_values) {
    m_enumeration_values = enumeration_values;
    m_enumeration_values_isSet = true;
}

bool OAIPutSlotTypeRequest::is_enumeration_values_Set() const{
    return m_enumeration_values_isSet;
}

bool OAIPutSlotTypeRequest::is_enumeration_values_Valid() const{
    return m_enumeration_values_isValid;
}

QString OAIPutSlotTypeRequest::getChecksum() const {
    return m_checksum;
}
void OAIPutSlotTypeRequest::setChecksum(const QString &checksum) {
    m_checksum = checksum;
    m_checksum_isSet = true;
}

bool OAIPutSlotTypeRequest::is_checksum_Set() const{
    return m_checksum_isSet;
}

bool OAIPutSlotTypeRequest::is_checksum_Valid() const{
    return m_checksum_isValid;
}

OAISlotValueSelectionStrategy OAIPutSlotTypeRequest::getValueSelectionStrategy() const {
    return m_value_selection_strategy;
}
void OAIPutSlotTypeRequest::setValueSelectionStrategy(const OAISlotValueSelectionStrategy &value_selection_strategy) {
    m_value_selection_strategy = value_selection_strategy;
    m_value_selection_strategy_isSet = true;
}

bool OAIPutSlotTypeRequest::is_value_selection_strategy_Set() const{
    return m_value_selection_strategy_isSet;
}

bool OAIPutSlotTypeRequest::is_value_selection_strategy_Valid() const{
    return m_value_selection_strategy_isValid;
}

bool OAIPutSlotTypeRequest::getCreateVersion() const {
    return m_create_version;
}
void OAIPutSlotTypeRequest::setCreateVersion(const bool &create_version) {
    m_create_version = create_version;
    m_create_version_isSet = true;
}

bool OAIPutSlotTypeRequest::is_create_version_Set() const{
    return m_create_version_isSet;
}

bool OAIPutSlotTypeRequest::is_create_version_Valid() const{
    return m_create_version_isValid;
}

QString OAIPutSlotTypeRequest::getParentSlotTypeSignature() const {
    return m_parent_slot_type_signature;
}
void OAIPutSlotTypeRequest::setParentSlotTypeSignature(const QString &parent_slot_type_signature) {
    m_parent_slot_type_signature = parent_slot_type_signature;
    m_parent_slot_type_signature_isSet = true;
}

bool OAIPutSlotTypeRequest::is_parent_slot_type_signature_Set() const{
    return m_parent_slot_type_signature_isSet;
}

bool OAIPutSlotTypeRequest::is_parent_slot_type_signature_Valid() const{
    return m_parent_slot_type_signature_isValid;
}

QList OAIPutSlotTypeRequest::getSlotTypeConfigurations() const {
    return m_slot_type_configurations;
}
void OAIPutSlotTypeRequest::setSlotTypeConfigurations(const QList &slot_type_configurations) {
    m_slot_type_configurations = slot_type_configurations;
    m_slot_type_configurations_isSet = true;
}

bool OAIPutSlotTypeRequest::is_slot_type_configurations_Set() const{
    return m_slot_type_configurations_isSet;
}

bool OAIPutSlotTypeRequest::is_slot_type_configurations_Valid() const{
    return m_slot_type_configurations_isValid;
}

bool OAIPutSlotTypeRequest::isSet() const {
...
bool OAIPutSlotTypeRequest::isValid() const {
