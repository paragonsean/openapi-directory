...
QList OAIStatement::getMessages() const {
    return m_messages;
}
void OAIStatement::setMessages(const QList &messages) {
    m_messages = messages;
    m_messages_isSet = true;
}

bool OAIStatement::is_messages_Set() const{
    return m_messages_isSet;
}

bool OAIStatement::is_messages_Valid() const{
    return m_messages_isValid;
}

QString OAIStatement::getResponseCard() const {
    return m_response_card;
}
void OAIStatement::setResponseCard(const QString &response_card) {
    m_response_card = response_card;
    m_response_card_isSet = true;
}

bool OAIStatement::is_response_card_Set() const{
    return m_response_card_isSet;
}

bool OAIStatement::is_response_card_Valid() const{
