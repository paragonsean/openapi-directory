...
/*
 * OAIGetBotResponse_clarificationPrompt.h
 *
 * 
 */

#ifndef OAIGetBotResponse_clarificationPrompt_H
#define OAIGetBotResponse_clarificationPrompt_H
...
class OAIGetBotResponse_clarificationPrompt : public OAIObject {
public:
    OAIGetBotResponse_clarificationPrompt();
    OAIGetBotResponse_clarificationPrompt(QString json);
    ~OAIGetBotResponse_clarificationPrompt() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBotResponse_clarificationPrompt)

#endif // OAIGetBotResponse_clarificationPrompt_H
