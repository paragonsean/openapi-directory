...
/*
 * OAICreateIntentVersionResponse.h
 *
 * 
 */

#ifndef OAICreateIntentVersionResponse_H
#define OAICreateIntentVersionResponse_H

#include <QJsonObject>

#include "OAICreateIntentVersionResponse_conclusionStatement.h"
...
namespace OpenAPI {
class OAICreateIntentVersionResponse_confirmationPrompt;
class OAICreateIntentVersionResponse_rejectionStatement;
class OAICreateIntentVersionResponse_followUpPrompt;
class OAICreateIntentVersionResponse_conclusionStatement;
class OAICreateIntentVersionResponse_dialogCodeHook;
class OAICreateIntentVersionResponse_fulfillmentActivity;
class OAICreateIntentVersionResponse_kendraConfiguration;

class OAICreateIntentVersionResponse : public OAIObject {
public:
    OAICreateIntentVersionResponse();
    OAICreateIntentVersionResponse(QString json);
    ~OAICreateIntentVersionResponse() override;
    ...
    OAICreateIntentVersionResponse_confirmationPrompt getConfirmationPrompt() const;
    void setConfirmationPrompt(const OAICreateIntentVersionResponse_confirmationPrompt &confirmation_prompt);
    ...
    OAICreateIntentVersionResponse_followUpPrompt getFollowUpPrompt() const;
    void setFollowUpPrompt(const OAICreateIntentVersionResponse_followUpPrompt &follow_up_prompt);
    bool is_follow_up_prompt_Set() const;
    bool is_follow_up_prompt_Valid() const;

    OAICreateIntentVersionResponse_conclusionStatement getConclusionStatement() const;
    void setConclusionStatement(const OAICreateIntentVersionResponse_conclusionStatement &conclusion_statement);
    bool is_conclusion_statement_Set() const;
    bool is_conclusion_statement_Valid() const;

    OAICreateIntentVersionResponse_dialogCodeHook getDialogCodeHook() const;
    void setDialogCodeHook(const OAICreateIntentVersionResponse_dialogCodeHook &dialog_code_hook);
    bool is_dialog_code_hook_Set() const;
    bool is_dialog_code_hook_Valid() const;

    OAICreateIntentVersionResponse_fulfillmentActivity getFulfillmentActivity() const;
    void setFulfillmentActivity(const OAICreateIntentVersionResponse_fulfillmentActivity &fulfillment_activity);
    ...
    OAICreateIntentVersionResponse_kendraConfiguration getKendraConfiguration() const;
    void setKendraConfiguration(const OAICreateIntentVersionResponse_kendraConfiguration &kendra_configuration);
...
private:
    ...
    OAICreateIntentVersionResponse_confirmationPrompt m_confirmation_prompt;
    ...
    OAICreateIntentVersionResponse_followUpPrompt m_follow_up_prompt;
    bool m_follow_up_prompt_isSet;
    bool m_follow_up_prompt_isValid;

    OAICreateIntentVersionResponse_conclusionStatement m_conclusion_statement;
    bool m_conclusion_statement_isSet;
    bool m_conclusion_statement_isValid;

    OAICreateIntentVersionResponse_dialogCodeHook m_dialog_code_hook;
    bool m_dialog_code_hook_isSet;
    bool m_dialog_code_hook_isValid;

    OAICreateIntentVersionResponse_fulfillmentActivity m_fulfillment_activity;
    ...
    OAICreateIntentVersionResponse_kendraConfiguration m_kendra_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIntentVersionResponse)

#endif // OAICreateIntentVersionResponse_H
