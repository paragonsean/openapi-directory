...
/*
 * OAICreateBotVersionResponse_clarificationPrompt.h
 *
 * 
 */

#ifndef OAICreateBotVersionResponse_clarificationPrompt_H
#define OAICreateBotVersionResponse_clarificationPrompt_H
...
class OAICreateBotVersionResponse_clarificationPrompt : public OAIObject {
public:
    OAICreateBotVersionResponse_clarificationPrompt();
    OAICreateBotVersionResponse_clarificationPrompt(QString json);
    ~OAICreateBotVersionResponse_clarificationPrompt() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBotVersionResponse_clarificationPrompt)

#endif // OAICreateBotVersionResponse_clarificationPrompt_H
