...
/*
 * OAIPutBotRequest_clarificationPrompt.h
 *
 * 
 */

#ifndef OAIPutBotRequest_clarificationPrompt_H
#define OAIPutBotRequest_clarificationPrompt_H
...
class OAIPutBotRequest_clarificationPrompt : public OAIObject {
public:
    OAIPutBotRequest_clarificationPrompt();
    OAIPutBotRequest_clarificationPrompt(QString json);
    ~OAIPutBotRequest_clarificationPrompt() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutBotRequest_clarificationPrompt)

#endif // OAIPutBotRequest_clarificationPrompt_H
