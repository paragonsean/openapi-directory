...
#ifndef OAIIdentityUsage_H
#define OAIIdentityUsage_H
...
class OAIIdentityUsage : public OAIObject {
public:
    OAIIdentityUsage();
    OAIIdentityUsage(QString json);
    ~OAIIdentityUsage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentityUsage)

#endif // OAIIdentityUsage_H
