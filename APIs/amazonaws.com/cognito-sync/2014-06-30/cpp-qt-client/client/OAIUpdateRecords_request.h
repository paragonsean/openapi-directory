...
/*
 * OAIUpdateRecords_request.h
 *
 * 
 */

#ifndef OAIUpdateRecords_request_H
#define OAIUpdateRecords_request_H
...
namespace OpenAPI {
class OAIRecordPatch;

class OAIUpdateRecords_request : public OAIObject {
public:
    OAIUpdateRecords_request();
    OAIUpdateRecords_request(QString json);
    ~OAIUpdateRecords_request() override;
    ...
    QList<OAIRecordPatch> getRecordPatches() const;
    void setRecordPatches(const QList<OAIRecordPatch> &record_patches);
...
private:
    ...
    QList<OAIRecordPatch> m_record_patches;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRecords_request)

#endif // OAIUpdateRecords_request_H
