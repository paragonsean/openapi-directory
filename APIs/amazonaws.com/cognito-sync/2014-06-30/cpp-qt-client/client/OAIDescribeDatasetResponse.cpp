...
void OAIDescribeDatasetResponse::setDataset(const OAIDescribeDatasetResponse_Dataset &dataset) {
    m_dataset = dataset;
    m_dataset_isSet = true;
}

bool OAIDescribeDatasetResponse::is_dataset_Set() const{
    return m_dataset_isSet;
}

bool OAIDescribeDatasetResponse::is_dataset_Valid() const{
