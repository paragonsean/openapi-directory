...
/*
 * OAIIdentityPoolUsage.h
 *
 * Usage information for the identity pool.
 */

#ifndef OAIIdentityPoolUsage_H
#define OAIIdentityPoolUsage_H
...
class OAIIdentityPoolUsage : public OAIObject {
public:
    OAIIdentityPoolUsage();
    OAIIdentityPoolUsage(QString json);
    ~OAIIdentityPoolUsage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentityPoolUsage)

#endif // OAIIdentityPoolUsage_H
