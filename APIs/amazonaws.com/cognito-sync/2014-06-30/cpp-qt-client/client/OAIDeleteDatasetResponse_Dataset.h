...
/*
 * OAIDeleteDatasetResponse_Dataset.h
 *
 * 
 */

#ifndef OAIDeleteDatasetResponse_Dataset_H
#define OAIDeleteDatasetResponse_Dataset_H
...
class OAIDeleteDatasetResponse_Dataset : public OAIObject {
public:
    OAIDeleteDatasetResponse_Dataset();
    OAIDeleteDatasetResponse_Dataset(QString json);
    ~OAIDeleteDatasetResponse_Dataset() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDatasetResponse_Dataset)

#endif // OAIDeleteDatasetResponse_Dataset_H
