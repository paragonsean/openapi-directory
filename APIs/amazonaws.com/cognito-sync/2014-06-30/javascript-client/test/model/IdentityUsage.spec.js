...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoSync.IdentityUsage();
  });
  ...
  describe('IdentityUsage', function() {
    it('should create an instance of IdentityUsage', function() {
      // uncomment below and update the code to test IdentityUsage
      //var instance = new AmazonCognitoSync.IdentityUsage();
      //expect(instance).to.be.a(AmazonCognitoSync.IdentityUsage);
    });
