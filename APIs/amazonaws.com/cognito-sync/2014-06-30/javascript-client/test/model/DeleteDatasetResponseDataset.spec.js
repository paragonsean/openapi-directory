...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoSync.DeleteDatasetResponseDataset();
  });
  ...
  describe('DeleteDatasetResponseDataset', function() {
    it('should create an instance of DeleteDatasetResponseDataset', function() {
      // uncomment below and update the code to test DeleteDatasetResponseDataset
      //var instance = new AmazonCognitoSync.DeleteDatasetResponseDataset();
      //expect(instance).to.be.a(AmazonCognitoSync.DeleteDatasetResponseDataset);
    });
