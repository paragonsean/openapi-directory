...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoSync.DescribeDatasetResponseDataset();
  });
  ...
  describe('DescribeDatasetResponseDataset', function() {
    it('should create an instance of DescribeDatasetResponseDataset', function() {
      // uncomment below and update the code to test DescribeDatasetResponseDataset
      //var instance = new AmazonCognitoSync.DescribeDatasetResponseDataset();
      //expect(instance).to.be.a(AmazonCognitoSync.DescribeDatasetResponseDataset);
    });
    ...
    it('should have the property numRecords (base name: "NumRecords")', function() {
      // uncomment below and update the code to test the property numRecords
      //var instance = new AmazonCognitoSync.DescribeDatasetResponseDataset();
      //expect(instance).to.be();
    });
