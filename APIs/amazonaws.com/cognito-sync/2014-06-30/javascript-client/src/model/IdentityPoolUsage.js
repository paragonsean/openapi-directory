...
/**
 * The IdentityPoolUsage model module.
 * @module model/IdentityPoolUsage
 * @version 2014-06-30
 */
class IdentityPoolUsage {
    /**
     * Constructs a new <code>IdentityPoolUsage</code>.
     * Usage information for the identity pool.
     * @alias module:model/IdentityPoolUsage
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>IdentityPoolUsage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IdentityPoolUsage} obj Optional instance to populate.
     * @return {module:model/IdentityPoolUsage} The populated <code>IdentityPoolUsage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IdentityPoolUsage();
    ...
    /**
     * Validates the JSON data with respect to <code>IdentityPoolUsage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IdentityPoolUsage</code>.
     */
...
export default IdentityPoolUsage;
