...
class SigningPlatformSigningConfiguration(Model):
    ...
    def __init__(self, encryption_algorithm_options: SigningConfigurationEncryptionAlgorithmOptions=None, hash_algorithm_options: SigningConfigurationHashAlgorithmOptions=None):
        """SigningPlatformSigningConfiguration - a model defined in OpenAPI

        :param encryption_algorithm_options: The encryption_algorithm_options of this SigningPlatformSigningConfiguration.
        :param hash_algorithm_options: The hash_algorithm_options of this SigningPlatformSigningConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SigningPlatformSigningConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SigningPlatform_signingConfiguration of this SigningPlatformSigningConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def encryption_algorithm_options(self):
        """Gets the encryption_algorithm_options of this SigningPlatformSigningConfiguration.


        :return: The encryption_algorithm_options of this SigningPlatformSigningConfiguration.
    ...
    def encryption_algorithm_options(self, encryption_algorithm_options):
        """Sets the encryption_algorithm_options of this SigningPlatformSigningConfiguration.
    ...
    def hash_algorithm_options(self):
        """Gets the hash_algorithm_options of this SigningPlatformSigningConfiguration.


        :return: The hash_algorithm_options of this SigningPlatformSigningConfiguration.
    ...
    def hash_algorithm_options(self, hash_algorithm_options):
        """Sets the hash_algorithm_options of this SigningPlatformSigningConfiguration.
