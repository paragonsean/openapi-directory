...
class SigningConfiguration(Model):
    ...
    def __init__(self, encryption_algorithm_options: SigningConfigurationEncryptionAlgorithmOptions=None, hash_algorithm_options: SigningConfigurationHashAlgorithmOptions=None):
        """SigningConfiguration - a model defined in OpenAPI

        :param encryption_algorithm_options: The encryption_algorithm_options of this SigningConfiguration.
        :param hash_algorithm_options: The hash_algorithm_options of this SigningConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SigningConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SigningConfiguration of this SigningConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def encryption_algorithm_options(self):
        """Gets the encryption_algorithm_options of this SigningConfiguration.


        :return: The encryption_algorithm_options of this SigningConfiguration.
    ...
    def encryption_algorithm_options(self, encryption_algorithm_options):
        """Sets the encryption_algorithm_options of this SigningConfiguration.
    ...
    def hash_algorithm_options(self):
        """Gets the hash_algorithm_options of this SigningConfiguration.


        :return: The hash_algorithm_options of this SigningConfiguration.
    ...
    def hash_algorithm_options(self, hash_algorithm_options):
        """Sets the hash_algorithm_options of this SigningConfiguration.
