...
OAIAddProfilePermissionResponse::OAIAddProfilePermissionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddProfilePermissionResponse::OAIAddProfilePermissionResponse() {
    this->initializeModel();
}

OAIAddProfilePermissionResponse::~OAIAddProfilePermissionResponse() {}

void OAIAddProfilePermissionResponse::initializeModel() {

    m_revision_id_isSet = false;
    m_revision_id_isValid = false;
}

void OAIAddProfilePermissionResponse::fromJson(QString jsonString) {
...
void OAIAddProfilePermissionResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAddProfilePermissionResponse::asJson() const {
...
QJsonObject OAIAddProfilePermissionResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddProfilePermissionResponse::getRevisionId() const {
    return m_revision_id;
}
void OAIAddProfilePermissionResponse::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIAddProfilePermissionResponse::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIAddProfilePermissionResponse::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

bool OAIAddProfilePermissionResponse::isSet() const {
...
bool OAIAddProfilePermissionResponse::isValid() const {
