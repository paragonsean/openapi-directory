...
OAIDescribeSigningJobResponse_signedObject::OAIDescribeSigningJobResponse_signedObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeSigningJobResponse_signedObject::OAIDescribeSigningJobResponse_signedObject() {
    this->initializeModel();
}

OAIDescribeSigningJobResponse_signedObject::~OAIDescribeSigningJobResponse_signedObject() {}

void OAIDescribeSigningJobResponse_signedObject::initializeModel() {

    m_s3_isSet = false;
    m_s3_isValid = false;
}

void OAIDescribeSigningJobResponse_signedObject::fromJson(QString jsonString) {
...
void OAIDescribeSigningJobResponse_signedObject::fromJsonObject(QJsonObject json) {

    m_s3_isValid = ::OpenAPI::fromJsonValue(m_s3, json[QString("s3")]);
    m_s3_isSet = !json[QString("s3")].isNull() && m_s3_isValid;
}

QString OAIDescribeSigningJobResponse_signedObject::asJson() const {
...
QJsonObject OAIDescribeSigningJobResponse_signedObject::asJsonObject() const {
    QJsonObject obj;
    if (m_s3.isSet()) {
...
OAISignedObject_s3 OAIDescribeSigningJobResponse_signedObject::getS3() const {
    return m_s3;
}
void OAIDescribeSigningJobResponse_signedObject::setS3(const OAISignedObject_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAIDescribeSigningJobResponse_signedObject::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAIDescribeSigningJobResponse_signedObject::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAIDescribeSigningJobResponse_signedObject::isSet() const {
...
bool OAIDescribeSigningJobResponse_signedObject::isValid() const {
