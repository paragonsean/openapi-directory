...
OAISigningJob_signingMaterial::OAISigningJob_signingMaterial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISigningJob_signingMaterial::OAISigningJob_signingMaterial() {
    this->initializeModel();
}

OAISigningJob_signingMaterial::~OAISigningJob_signingMaterial() {}

void OAISigningJob_signingMaterial::initializeModel() {

    m_certificate_arn_isSet = false;
    m_certificate_arn_isValid = false;
}

void OAISigningJob_signingMaterial::fromJson(QString jsonString) {
...
void OAISigningJob_signingMaterial::fromJsonObject(QJsonObject json) {
...
QString OAISigningJob_signingMaterial::asJson() const {
...
QJsonObject OAISigningJob_signingMaterial::asJsonObject() const {
    QJsonObject obj;
...
QString OAISigningJob_signingMaterial::getCertificateArn() const {
    return m_certificate_arn;
}
void OAISigningJob_signingMaterial::setCertificateArn(const QString &certificate_arn) {
    m_certificate_arn = certificate_arn;
    m_certificate_arn_isSet = true;
}

bool OAISigningJob_signingMaterial::is_certificate_arn_Set() const{
    return m_certificate_arn_isSet;
}

bool OAISigningJob_signingMaterial::is_certificate_arn_Valid() const{
    return m_certificate_arn_isValid;
}

bool OAISigningJob_signingMaterial::isSet() const {
...
bool OAISigningJob_signingMaterial::isValid() const {
