...
OAISigningProfile_signingMaterial::OAISigningProfile_signingMaterial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISigningProfile_signingMaterial::OAISigningProfile_signingMaterial() {
    this->initializeModel();
}

OAISigningProfile_signingMaterial::~OAISigningProfile_signingMaterial() {}

void OAISigningProfile_signingMaterial::initializeModel() {

    m_certificate_arn_isSet = false;
    m_certificate_arn_isValid = false;
}

void OAISigningProfile_signingMaterial::fromJson(QString jsonString) {
...
void OAISigningProfile_signingMaterial::fromJsonObject(QJsonObject json) {
...
QString OAISigningProfile_signingMaterial::asJson() const {
...
QJsonObject OAISigningProfile_signingMaterial::asJsonObject() const {
    QJsonObject obj;
...
QString OAISigningProfile_signingMaterial::getCertificateArn() const {
    return m_certificate_arn;
}
void OAISigningProfile_signingMaterial::setCertificateArn(const QString &certificate_arn) {
    m_certificate_arn = certificate_arn;
    m_certificate_arn_isSet = true;
}

bool OAISigningProfile_signingMaterial::is_certificate_arn_Set() const{
    return m_certificate_arn_isSet;
}

bool OAISigningProfile_signingMaterial::is_certificate_arn_Valid() const{
    return m_certificate_arn_isValid;
}

bool OAISigningProfile_signingMaterial::isSet() const {
...
bool OAISigningProfile_signingMaterial::isValid() const {
