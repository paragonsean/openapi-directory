...
/*
 * OAISigningPlatformOverrides.h
 *
 * Any overrides that are applied to the signing configuration of a code signing platform.
 */

#ifndef OAISigningPlatformOverrides_H
#define OAISigningPlatformOverrides_H
...
class OAISigningPlatformOverrides : public OAIObject {
public:
    OAISigningPlatformOverrides();
    OAISigningPlatformOverrides(QString json);
    ~OAISigningPlatformOverrides() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningPlatformOverrides)

#endif // OAISigningPlatformOverrides_H
