...
#ifndef OAISigningStatus_H
#define OAISigningStatus_H
...
class OAISigningStatus : public OAIEnum {
public:
    OAISigningStatus();
    OAISigningStatus(QString json);
    ~OAISigningStatus() override;
    ...
    enum class eOAISigningStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        INPROGRESS, 
        FAILED, 
        SUCCEEDED
    };
    OAISigningStatus::eOAISigningStatus getValue() const;
    void setValue(const OAISigningStatus::eOAISigningStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningStatus)

#endif // OAISigningStatus_H
