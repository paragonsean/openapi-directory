...
void OAIEncryptionAlgorithm::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("RSA", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEncryptionAlgorithm::RSA;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ECDSA", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEncryptionAlgorithm::ECDSA;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIEncryptionAlgorithm::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIEncryptionAlgorithm::RSA:
            val = "RSA";
            break;
        case eOAIEncryptionAlgorithm::ECDSA:
            val = "ECDSA";
            break;
        default:
            break;
