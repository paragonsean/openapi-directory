...
/*
 * OAIGetRevocationStatusResponse.h
 *
 * 
 */

#ifndef OAIGetRevocationStatusResponse_H
#define OAIGetRevocationStatusResponse_H
...
class OAIGetRevocationStatusResponse : public OAIObject {
public:
    OAIGetRevocationStatusResponse();
    OAIGetRevocationStatusResponse(QString json);
    ~OAIGetRevocationStatusResponse() override;
    ...
    QList getRevokedEntities() const;
    void setRevokedEntities(const QList &revoked_entities);
    bool is_revoked_entities_Set() const;
    bool is_revoked_entities_Valid() const;
...
private:
    ...
    QList m_revoked_entities;
    bool m_revoked_entities_isSet;
    bool m_revoked_entities_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetRevocationStatusResponse)

#endif // OAIGetRevocationStatusResponse_H
