...
/*
 * OAIAddProfilePermission_request.h
 *
 * 
 */

#ifndef OAIAddProfilePermission_request_H
#define OAIAddProfilePermission_request_H
...
class OAIAddProfilePermission_request : public OAIObject {
public:
    OAIAddProfilePermission_request();
    OAIAddProfilePermission_request(QString json);
    ~OAIAddProfilePermission_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddProfilePermission_request)

#endif // OAIAddProfilePermission_request_H
