...
QString OAIPermission::getStatementId() const {
    return m_statement_id;
}
void OAIPermission::setStatementId(const QString &statement_id) {
    m_statement_id = statement_id;
    m_statement_id_isSet = true;
}

bool OAIPermission::is_statement_id_Set() const{
    return m_statement_id_isSet;
}

bool OAIPermission::is_statement_id_Valid() const{
    return m_statement_id_isValid;
}

QString OAIPermission::getProfileVersion() const {
    return m_profile_version;
}
void OAIPermission::setProfileVersion(const QString &profile_version) {
    m_profile_version = profile_version;
    m_profile_version_isSet = true;
}

bool OAIPermission::is_profile_version_Set() const{
    return m_profile_version_isSet;
}

bool OAIPermission::is_profile_version_Valid() const{
