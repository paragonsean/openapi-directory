...
#ifndef OAIS3SignedObject_H
#define OAIS3SignedObject_H
...
class OAIS3SignedObject : public OAIObject {
public:
    OAIS3SignedObject();
    OAIS3SignedObject(QString json);
    ~OAIS3SignedObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3SignedObject)

#endif // OAIS3SignedObject_H
