...
/*
 * OAISignPayloadRequest.h
 *
 * 
 */

#ifndef OAISignPayloadRequest_H
#define OAISignPayloadRequest_H
...
class OAISignPayloadRequest : public OAIObject {
public:
    OAISignPayloadRequest();
    OAISignPayloadRequest(QString json);
    ~OAISignPayloadRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignPayloadRequest)

#endif // OAISignPayloadRequest_H
