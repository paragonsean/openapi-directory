...
/*
 * OAISigningJob_source.h
 *
 * 
 */

#ifndef OAISigningJob_source_H
#define OAISigningJob_source_H
...
class OAISigningJob_source : public OAIObject {
public:
    OAISigningJob_source();
    OAISigningJob_source(QString json);
    ~OAISigningJob_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningJob_source)

#endif // OAISigningJob_source_H
