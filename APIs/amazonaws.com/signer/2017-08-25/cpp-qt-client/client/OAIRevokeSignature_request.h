...
/*
 * OAIRevokeSignature_request.h
 *
 * 
 */

#ifndef OAIRevokeSignature_request_H
#define OAIRevokeSignature_request_H
...
class OAIRevokeSignature_request : public OAIObject {
public:
    OAIRevokeSignature_request();
    OAIRevokeSignature_request(QString json);
    ~OAIRevokeSignature_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRevokeSignature_request)

#endif // OAIRevokeSignature_request_H
