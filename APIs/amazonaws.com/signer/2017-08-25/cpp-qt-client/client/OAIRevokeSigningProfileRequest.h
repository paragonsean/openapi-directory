...
/*
 * OAIRevokeSigningProfileRequest.h
 *
 * 
 */

#ifndef OAIRevokeSigningProfileRequest_H
#define OAIRevokeSigningProfileRequest_H
...
class OAIRevokeSigningProfileRequest : public OAIObject {
public:
    OAIRevokeSigningProfileRequest();
    OAIRevokeSigningProfileRequest(QString json);
    ~OAIRevokeSigningProfileRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRevokeSigningProfileRequest)

#endif // OAIRevokeSigningProfileRequest_H
