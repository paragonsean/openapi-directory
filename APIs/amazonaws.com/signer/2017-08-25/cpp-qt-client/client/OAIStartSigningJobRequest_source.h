...
/*
 * OAIStartSigningJobRequest_source.h
 *
 * 
 */

#ifndef OAIStartSigningJobRequest_source_H
#define OAIStartSigningJobRequest_source_H
...
class OAIStartSigningJobRequest_source : public OAIObject {
public:
    OAIStartSigningJobRequest_source();
    OAIStartSigningJobRequest_source(QString json);
    ~OAIStartSigningJobRequest_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSigningJobRequest_source)

#endif // OAIStartSigningJobRequest_source_H
