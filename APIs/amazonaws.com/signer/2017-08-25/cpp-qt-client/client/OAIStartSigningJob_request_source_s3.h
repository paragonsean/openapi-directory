...
/*
 * OAIStartSigningJob_request_source_s3.h
 *
 * 
 */

#ifndef OAIStartSigningJob_request_source_s3_H
#define OAIStartSigningJob_request_source_s3_H
...
class OAIStartSigningJob_request_source_s3 : public OAIObject {
public:
    OAIStartSigningJob_request_source_s3();
    OAIStartSigningJob_request_source_s3(QString json);
    ~OAIStartSigningJob_request_source_s3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSigningJob_request_source_s3)

#endif // OAIStartSigningJob_request_source_s3_H
