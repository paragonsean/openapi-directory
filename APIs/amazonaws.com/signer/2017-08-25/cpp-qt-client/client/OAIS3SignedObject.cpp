...
OAIS3SignedObject::OAIS3SignedObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3SignedObject::OAIS3SignedObject() {
    this->initializeModel();
}

OAIS3SignedObject::~OAIS3SignedObject() {}

void OAIS3SignedObject::initializeModel() {
...
void OAIS3SignedObject::fromJson(QString jsonString) {
...
void OAIS3SignedObject::fromJsonObject(QJsonObject json) {
...
QString OAIS3SignedObject::asJson() const {
...
QJsonObject OAIS3SignedObject::asJsonObject() const {
    QJsonObject obj;
...
QString OAIS3SignedObject::getBucketName() const {
    return m_bucket_name;
}
void OAIS3SignedObject::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAIS3SignedObject::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAIS3SignedObject::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

QString OAIS3SignedObject::getKey() const {
    return m_key;
}
void OAIS3SignedObject::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAIS3SignedObject::is_key_Set() const{
    return m_key_isSet;
}

bool OAIS3SignedObject::is_key_Valid() const{
    return m_key_isValid;
}

bool OAIS3SignedObject::isSet() const {
...
bool OAIS3SignedObject::isValid() const {
