...
OAISignedObject_s3::OAISignedObject_s3(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISignedObject_s3::OAISignedObject_s3() {
    this->initializeModel();
}

OAISignedObject_s3::~OAISignedObject_s3() {}

void OAISignedObject_s3::initializeModel() {
...
void OAISignedObject_s3::fromJson(QString jsonString) {
...
void OAISignedObject_s3::fromJsonObject(QJsonObject json) {
...
QString OAISignedObject_s3::asJson() const {
...
QJsonObject OAISignedObject_s3::asJsonObject() const {
    QJsonObject obj;
...
QString OAISignedObject_s3::getBucketName() const {
    return m_bucket_name;
}
void OAISignedObject_s3::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAISignedObject_s3::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAISignedObject_s3::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

QString OAISignedObject_s3::getKey() const {
    return m_key;
}
void OAISignedObject_s3::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAISignedObject_s3::is_key_Set() const{
    return m_key_isSet;
}

bool OAISignedObject_s3::is_key_Valid() const{
    return m_key_isValid;
}

bool OAISignedObject_s3::isSet() const {
...
bool OAISignedObject_s3::isValid() const {
