...
OAIStartSigningJob_request_source_s3 OAISource::getS3() const {
    return m_s3;
}
void OAISource::setS3(const OAIStartSigningJob_request_source_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAISource::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAISource::is_s3_Valid() const{
    return m_s3_isValid;
}
