...
/*
 * OAIRevokeSignatureRequest.h
 *
 * 
 */

#ifndef OAIRevokeSignatureRequest_H
#define OAIRevokeSignatureRequest_H
...
class OAIRevokeSignatureRequest : public OAIObject {
public:
    OAIRevokeSignatureRequest();
    OAIRevokeSignatureRequest(QString json);
    ~OAIRevokeSignatureRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRevokeSignatureRequest)

#endif // OAIRevokeSignatureRequest_H
