...
/*
 * OAIDescribeSigningJobResponse_signedObject.h
 *
 * 
 */

#ifndef OAIDescribeSigningJobResponse_signedObject_H
#define OAIDescribeSigningJobResponse_signedObject_H

#include <QJsonObject>

#include "OAISignedObject_s3.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAISignedObject_s3;

class OAIDescribeSigningJobResponse_signedObject : public OAIObject {
public:
    OAIDescribeSigningJobResponse_signedObject();
    OAIDescribeSigningJobResponse_signedObject(QString json);
    ~OAIDescribeSigningJobResponse_signedObject() override;
    ...
    OAISignedObject_s3 getS3() const;
    void setS3(const OAISignedObject_s3 &s3);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSigningJobResponse_signedObject)

#endif // OAIDescribeSigningJobResponse_signedObject_H
