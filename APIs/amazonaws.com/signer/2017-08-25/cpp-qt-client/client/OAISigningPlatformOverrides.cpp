...
#include "OAISigningPlatformOverrides.h"
...
OAISigningPlatformOverrides::OAISigningPlatformOverrides(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISigningPlatformOverrides::OAISigningPlatformOverrides() {
    this->initializeModel();
}

OAISigningPlatformOverrides::~OAISigningPlatformOverrides() {}

void OAISigningPlatformOverrides::initializeModel() {
...
void OAISigningPlatformOverrides::fromJson(QString jsonString) {
...
void OAISigningPlatformOverrides::fromJsonObject(QJsonObject json) {
...
QString OAISigningPlatformOverrides::asJson() const {
...
QJsonObject OAISigningPlatformOverrides::asJsonObject() const {
    QJsonObject obj;
...
OAIPutSigningProfile_request_overrides_signingConfiguration OAISigningPlatformOverrides::getSigningConfiguration() const {
    return m_signing_configuration;
}
void OAISigningPlatformOverrides::setSigningConfiguration(const OAIPutSigningProfile_request_overrides_signingConfiguration &signing_configuration) {
    m_signing_configuration = signing_configuration;
    m_signing_configuration_isSet = true;
}

bool OAISigningPlatformOverrides::is_signing_configuration_Set() const{
    return m_signing_configuration_isSet;
}

bool OAISigningPlatformOverrides::is_signing_configuration_Valid() const{
    return m_signing_configuration_isValid;
}

OAIImageFormat OAISigningPlatformOverrides::getSigningImageFormat() const {
    return m_signing_image_format;
}
void OAISigningPlatformOverrides::setSigningImageFormat(const OAIImageFormat &signing_image_format) {
    m_signing_image_format = signing_image_format;
    m_signing_image_format_isSet = true;
}

bool OAISigningPlatformOverrides::is_signing_image_format_Set() const{
    return m_signing_image_format_isSet;
}

bool OAISigningPlatformOverrides::is_signing_image_format_Valid() const{
    return m_signing_image_format_isValid;
}

bool OAISigningPlatformOverrides::isSet() const {
...
bool OAISigningPlatformOverrides::isValid() const {
