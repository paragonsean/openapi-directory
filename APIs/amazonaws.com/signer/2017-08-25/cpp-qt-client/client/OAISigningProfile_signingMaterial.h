...
/*
 * OAISigningProfile_signingMaterial.h
 *
 * 
 */

#ifndef OAISigningProfile_signingMaterial_H
#define OAISigningProfile_signingMaterial_H
...
class OAISigningProfile_signingMaterial : public OAIObject {
public:
    OAISigningProfile_signingMaterial();
    OAISigningProfile_signingMaterial(QString json);
    ~OAISigningProfile_signingMaterial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningProfile_signingMaterial)

#endif // OAISigningProfile_signingMaterial_H
