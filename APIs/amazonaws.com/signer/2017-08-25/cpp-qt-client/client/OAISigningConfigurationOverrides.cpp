...
#include "OAISigningConfigurationOverrides.h"
...
OAISigningConfigurationOverrides::OAISigningConfigurationOverrides(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISigningConfigurationOverrides::OAISigningConfigurationOverrides() {
    this->initializeModel();
}

OAISigningConfigurationOverrides::~OAISigningConfigurationOverrides() {}

void OAISigningConfigurationOverrides::initializeModel() {
...
void OAISigningConfigurationOverrides::fromJson(QString jsonString) {
...
void OAISigningConfigurationOverrides::fromJsonObject(QJsonObject json) {
...
QString OAISigningConfigurationOverrides::asJson() const {
...
QJsonObject OAISigningConfigurationOverrides::asJsonObject() const {
    QJsonObject obj;
    if (m_encryption_algorithm.isSet()) {
        obj.insert(QString("encryptionAlgorithm"), ::OpenAPI::toJsonValue(m_encryption_algorithm));
    }
    if (m_hash_algorithm.isSet()) {
        obj.insert(QString("hashAlgorithm"), ::OpenAPI::toJsonValue(m_hash_algorithm));
    }
    return obj;
}

OAIEncryptionAlgorithm OAISigningConfigurationOverrides::getEncryptionAlgorithm() const {
    return m_encryption_algorithm;
}
void OAISigningConfigurationOverrides::setEncryptionAlgorithm(const OAIEncryptionAlgorithm &encryption_algorithm) {
    m_encryption_algorithm = encryption_algorithm;
    m_encryption_algorithm_isSet = true;
}

bool OAISigningConfigurationOverrides::is_encryption_algorithm_Set() const{
    return m_encryption_algorithm_isSet;
}

bool OAISigningConfigurationOverrides::is_encryption_algorithm_Valid() const{
    return m_encryption_algorithm_isValid;
}

OAIHashAlgorithm OAISigningConfigurationOverrides::getHashAlgorithm() const {
    return m_hash_algorithm;
}
void OAISigningConfigurationOverrides::setHashAlgorithm(const OAIHashAlgorithm &hash_algorithm) {
    m_hash_algorithm = hash_algorithm;
    m_hash_algorithm_isSet = true;
}

bool OAISigningConfigurationOverrides::is_hash_algorithm_Set() const{
    return m_hash_algorithm_isSet;
}

bool OAISigningConfigurationOverrides::is_hash_algorithm_Valid() const{
    return m_hash_algorithm_isValid;
}

bool OAISigningConfigurationOverrides::isSet() const {
...
bool OAISigningConfigurationOverrides::isValid() const {
