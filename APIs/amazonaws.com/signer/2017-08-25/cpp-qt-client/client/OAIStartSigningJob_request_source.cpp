...
OAIStartSigningJob_request_source::OAIStartSigningJob_request_source(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartSigningJob_request_source::OAIStartSigningJob_request_source() {
    this->initializeModel();
}

OAIStartSigningJob_request_source::~OAIStartSigningJob_request_source() {}

void OAIStartSigningJob_request_source::initializeModel() {

    m_s3_isSet = false;
    m_s3_isValid = false;
}

void OAIStartSigningJob_request_source::fromJson(QString jsonString) {
...
void OAIStartSigningJob_request_source::fromJsonObject(QJsonObject json) {

    m_s3_isValid = ::OpenAPI::fromJsonValue(m_s3, json[QString("s3")]);
    m_s3_isSet = !json[QString("s3")].isNull() && m_s3_isValid;
}

QString OAIStartSigningJob_request_source::asJson() const {
...
QJsonObject OAIStartSigningJob_request_source::asJsonObject() const {
    QJsonObject obj;
    if (m_s3.isSet()) {
...
OAIStartSigningJob_request_source_s3 OAIStartSigningJob_request_source::getS3() const {
    return m_s3;
}
void OAIStartSigningJob_request_source::setS3(const OAIStartSigningJob_request_source_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAIStartSigningJob_request_source::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAIStartSigningJob_request_source::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAIStartSigningJob_request_source::isSet() const {
...
bool OAIStartSigningJob_request_source::isValid() const {
