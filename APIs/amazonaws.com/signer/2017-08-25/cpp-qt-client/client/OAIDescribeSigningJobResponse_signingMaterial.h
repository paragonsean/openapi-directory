...
/*
 * OAIDescribeSigningJobResponse_signingMaterial.h
 *
 * 
 */

#ifndef OAIDescribeSigningJobResponse_signingMaterial_H
#define OAIDescribeSigningJobResponse_signingMaterial_H
...
class OAIDescribeSigningJobResponse_signingMaterial : public OAIObject {
public:
    OAIDescribeSigningJobResponse_signingMaterial();
    OAIDescribeSigningJobResponse_signingMaterial(QString json);
    ~OAIDescribeSigningJobResponse_signingMaterial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSigningJobResponse_signingMaterial)

#endif // OAIDescribeSigningJobResponse_signingMaterial_H
