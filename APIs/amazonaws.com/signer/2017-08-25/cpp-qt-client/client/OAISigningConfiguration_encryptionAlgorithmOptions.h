...
/*
 * OAISigningConfiguration_encryptionAlgorithmOptions.h
 *
 * 
 */

#ifndef OAISigningConfiguration_encryptionAlgorithmOptions_H
#define OAISigningConfiguration_encryptionAlgorithmOptions_H
...
class OAISigningConfiguration_encryptionAlgorithmOptions : public OAIObject {
public:
    OAISigningConfiguration_encryptionAlgorithmOptions();
    OAISigningConfiguration_encryptionAlgorithmOptions(QString json);
    ~OAISigningConfiguration_encryptionAlgorithmOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningConfiguration_encryptionAlgorithmOptions)

#endif // OAISigningConfiguration_encryptionAlgorithmOptions_H
