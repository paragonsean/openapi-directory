...
OAISigningConfiguration_encryptionAlgorithmOptions::OAISigningConfiguration_encryptionAlgorithmOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISigningConfiguration_encryptionAlgorithmOptions::OAISigningConfiguration_encryptionAlgorithmOptions() {
    this->initializeModel();
}

OAISigningConfiguration_encryptionAlgorithmOptions::~OAISigningConfiguration_encryptionAlgorithmOptions() {}

void OAISigningConfiguration_encryptionAlgorithmOptions::initializeModel() {
...
void OAISigningConfiguration_encryptionAlgorithmOptions::fromJson(QString jsonString) {
...
void OAISigningConfiguration_encryptionAlgorithmOptions::fromJsonObject(QJsonObject json) {
...
QString OAISigningConfiguration_encryptionAlgorithmOptions::asJson() const {
...
QJsonObject OAISigningConfiguration_encryptionAlgorithmOptions::asJsonObject() const {
    QJsonObject obj;
...
QList OAISigningConfiguration_encryptionAlgorithmOptions::getAllowedValues() const {
    return m_allowed_values;
}
void OAISigningConfiguration_encryptionAlgorithmOptions::setAllowedValues(const QList &allowed_values) {
    m_allowed_values = allowed_values;
    m_allowed_values_isSet = true;
}

bool OAISigningConfiguration_encryptionAlgorithmOptions::is_allowed_values_Set() const{
    return m_allowed_values_isSet;
}

bool OAISigningConfiguration_encryptionAlgorithmOptions::is_allowed_values_Valid() const{
    return m_allowed_values_isValid;
}

OAIEncryptionAlgorithm OAISigningConfiguration_encryptionAlgorithmOptions::getDefaultValue() const {
    return m_default_value;
}
void OAISigningConfiguration_encryptionAlgorithmOptions::setDefaultValue(const OAIEncryptionAlgorithm &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAISigningConfiguration_encryptionAlgorithmOptions::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAISigningConfiguration_encryptionAlgorithmOptions::is_default_value_Valid() const{
    return m_default_value_isValid;
}

bool OAISigningConfiguration_encryptionAlgorithmOptions::isSet() const {
...
bool OAISigningConfiguration_encryptionAlgorithmOptions::isValid() const {
