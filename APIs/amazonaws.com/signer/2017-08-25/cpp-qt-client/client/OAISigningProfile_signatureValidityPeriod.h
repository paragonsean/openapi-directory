...
/*
 * OAISigningProfile_signatureValidityPeriod.h
 *
 * 
 */

#ifndef OAISigningProfile_signatureValidityPeriod_H
#define OAISigningProfile_signatureValidityPeriod_H
...
class OAISigningProfile_signatureValidityPeriod : public OAIObject {
public:
    OAISigningProfile_signatureValidityPeriod();
    OAISigningProfile_signatureValidityPeriod(QString json);
    ~OAISigningProfile_signatureValidityPeriod() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningProfile_signatureValidityPeriod)

#endif // OAISigningProfile_signatureValidityPeriod_H
