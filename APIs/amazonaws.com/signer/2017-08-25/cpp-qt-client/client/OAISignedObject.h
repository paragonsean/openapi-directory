...
#ifndef OAISignedObject_H
#define OAISignedObject_H
...
class OAISignedObject : public OAIObject {
public:
    OAISignedObject();
    OAISignedObject(QString json);
    ~OAISignedObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignedObject)

#endif // OAISignedObject_H
