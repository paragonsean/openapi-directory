...
OAIGetSigningProfileResponse_signingMaterial::OAIGetSigningProfileResponse_signingMaterial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSigningProfileResponse_signingMaterial::OAIGetSigningProfileResponse_signingMaterial() {
    this->initializeModel();
}

OAIGetSigningProfileResponse_signingMaterial::~OAIGetSigningProfileResponse_signingMaterial() {}

void OAIGetSigningProfileResponse_signingMaterial::initializeModel() {

    m_certificate_arn_isSet = false;
    m_certificate_arn_isValid = false;
}

void OAIGetSigningProfileResponse_signingMaterial::fromJson(QString jsonString) {
...
void OAIGetSigningProfileResponse_signingMaterial::fromJsonObject(QJsonObject json) {
...
QString OAIGetSigningProfileResponse_signingMaterial::asJson() const {
...
QJsonObject OAIGetSigningProfileResponse_signingMaterial::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetSigningProfileResponse_signingMaterial::getCertificateArn() const {
    return m_certificate_arn;
}
void OAIGetSigningProfileResponse_signingMaterial::setCertificateArn(const QString &certificate_arn) {
    m_certificate_arn = certificate_arn;
    m_certificate_arn_isSet = true;
}

bool OAIGetSigningProfileResponse_signingMaterial::is_certificate_arn_Set() const{
    return m_certificate_arn_isSet;
}

bool OAIGetSigningProfileResponse_signingMaterial::is_certificate_arn_Valid() const{
    return m_certificate_arn_isValid;
}

bool OAIGetSigningProfileResponse_signingMaterial::isSet() const {
...
bool OAIGetSigningProfileResponse_signingMaterial::isValid() const {
