...
OAISigningProfileStatus::OAISigningProfileStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISigningProfileStatus::OAISigningProfileStatus() {
    this->initializeModel();
}

OAISigningProfileStatus::~OAISigningProfileStatus() {}

void OAISigningProfileStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAISigningProfileStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAISigningProfileStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Active", Qt::CaseInsensitive) == 0) {
        m_value = eOAISigningProfileStatus::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Canceled", Qt::CaseInsensitive) == 0) {
        m_value = eOAISigningProfileStatus::CANCELED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Revoked", Qt::CaseInsensitive) == 0) {
        m_value = eOAISigningProfileStatus::REVOKED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAISigningProfileStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAISigningProfileStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAISigningProfileStatus::ACTIVE:
            val = "Active";
            break;
        case eOAISigningProfileStatus::CANCELED:
            val = "Canceled";
            break;
        case eOAISigningProfileStatus::REVOKED:
            val = "Revoked";
            break;
        default:
            break;
...
QJsonValue OAISigningProfileStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAISigningProfileStatus::eOAISigningProfileStatus OAISigningProfileStatus::getValue() const {
    return m_value;
}

void OAISigningProfileStatus::setValue(const OAISigningProfileStatus::eOAISigningProfileStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAISigningProfileStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAISigningProfileStatus::isValid() const {
