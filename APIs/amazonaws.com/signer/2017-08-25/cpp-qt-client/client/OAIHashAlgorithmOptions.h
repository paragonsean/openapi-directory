...
/*
 * OAIHashAlgorithmOptions.h
 *
 * The hash algorithms that are available to a code signing job.
 */

#ifndef OAIHashAlgorithmOptions_H
#define OAIHashAlgorithmOptions_H
...
class OAIHashAlgorithmOptions : public OAIObject {
public:
    OAIHashAlgorithmOptions();
    OAIHashAlgorithmOptions(QString json);
    ~OAIHashAlgorithmOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHashAlgorithmOptions)

#endif // OAIHashAlgorithmOptions_H
