...
/*
 * OAIStartSigningJob_request_source.h
 *
 * An &lt;code&gt;S3Source&lt;/code&gt; object that contains information about the S3 bucket where you saved your unsigned code.
 */

#ifndef OAIStartSigningJob_request_source_H
#define OAIStartSigningJob_request_source_H
...
class OAIStartSigningJob_request_source : public OAIObject {
public:
    OAIStartSigningJob_request_source();
    OAIStartSigningJob_request_source(QString json);
    ~OAIStartSigningJob_request_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSigningJob_request_source)

#endif // OAIStartSigningJob_request_source_H
