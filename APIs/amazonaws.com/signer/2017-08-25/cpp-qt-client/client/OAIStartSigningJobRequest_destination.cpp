...
#include "OAIStartSigningJobRequest_destination.h"
...
OAIStartSigningJobRequest_destination::OAIStartSigningJobRequest_destination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartSigningJobRequest_destination::OAIStartSigningJobRequest_destination() {
    this->initializeModel();
}

OAIStartSigningJobRequest_destination::~OAIStartSigningJobRequest_destination() {}

void OAIStartSigningJobRequest_destination::initializeModel() {

    m_s3_isSet = false;
    m_s3_isValid = false;
}

void OAIStartSigningJobRequest_destination::fromJson(QString jsonString) {
...
void OAIStartSigningJobRequest_destination::fromJsonObject(QJsonObject json) {

    m_s3_isValid = ::OpenAPI::fromJsonValue(m_s3, json[QString("s3")]);
    m_s3_isSet = !json[QString("s3")].isNull() && m_s3_isValid;
}

QString OAIStartSigningJobRequest_destination::asJson() const {
...
QJsonObject OAIStartSigningJobRequest_destination::asJsonObject() const {
    QJsonObject obj;
    if (m_s3.isSet()) {
...
OAIStartSigningJob_request_destination_s3 OAIStartSigningJobRequest_destination::getS3() const {
    return m_s3;
}
void OAIStartSigningJobRequest_destination::setS3(const OAIStartSigningJob_request_destination_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAIStartSigningJobRequest_destination::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAIStartSigningJobRequest_destination::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAIStartSigningJobRequest_destination::isSet() const {
...
bool OAIStartSigningJobRequest_destination::isValid() const {
