...
OAISignedObject::OAISignedObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISignedObject::OAISignedObject() {
    this->initializeModel();
}

OAISignedObject::~OAISignedObject() {}

void OAISignedObject::initializeModel() {

    m_s3_isSet = false;
    m_s3_isValid = false;
}

void OAISignedObject::fromJson(QString jsonString) {
...
QJsonObject OAISignedObject::asJsonObject() const {
    QJsonObject obj;
    if (m_s3.isSet()) {
...
OAISignedObject_s3 OAISignedObject::getS3() const {
    return m_s3;
}
void OAISignedObject::setS3(const OAISignedObject_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAISignedObject::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAISignedObject::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAISignedObject::isSet() const {
...
bool OAISignedObject::isValid() const {
