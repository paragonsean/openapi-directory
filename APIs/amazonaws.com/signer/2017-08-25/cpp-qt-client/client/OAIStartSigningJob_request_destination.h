...
/*
 * OAIStartSigningJob_request_destination.h
 *
 * Points to an &lt;code&gt;S3Destination&lt;/code&gt; object that contains information about your S3 bucket.
 */

#ifndef OAIStartSigningJob_request_destination_H
#define OAIStartSigningJob_request_destination_H
...
class OAIStartSigningJob_request_destination : public OAIObject {
public:
    OAIStartSigningJob_request_destination();
    OAIStartSigningJob_request_destination(QString json);
    ~OAIStartSigningJob_request_destination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSigningJob_request_destination)

#endif // OAIStartSigningJob_request_destination_H
