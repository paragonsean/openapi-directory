...
OAIDescribeSigningJobResponse_overrides::OAIDescribeSigningJobResponse_overrides(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeSigningJobResponse_overrides::OAIDescribeSigningJobResponse_overrides() {
    this->initializeModel();
}

OAIDescribeSigningJobResponse_overrides::~OAIDescribeSigningJobResponse_overrides() {}

void OAIDescribeSigningJobResponse_overrides::initializeModel() {
...
void OAIDescribeSigningJobResponse_overrides::fromJson(QString jsonString) {
...
void OAIDescribeSigningJobResponse_overrides::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeSigningJobResponse_overrides::asJson() const {
...
QJsonObject OAIDescribeSigningJobResponse_overrides::asJsonObject() const {
    QJsonObject obj;
...
OAIPutSigningProfile_request_overrides_signingConfiguration OAIDescribeSigningJobResponse_overrides::getSigningConfiguration() const {
    return m_signing_configuration;
}
void OAIDescribeSigningJobResponse_overrides::setSigningConfiguration(const OAIPutSigningProfile_request_overrides_signingConfiguration &signing_configuration) {
    m_signing_configuration = signing_configuration;
    m_signing_configuration_isSet = true;
}

bool OAIDescribeSigningJobResponse_overrides::is_signing_configuration_Set() const{
    return m_signing_configuration_isSet;
}

bool OAIDescribeSigningJobResponse_overrides::is_signing_configuration_Valid() const{
    return m_signing_configuration_isValid;
}

OAIImageFormat OAIDescribeSigningJobResponse_overrides::getSigningImageFormat() const {
    return m_signing_image_format;
}
void OAIDescribeSigningJobResponse_overrides::setSigningImageFormat(const OAIImageFormat &signing_image_format) {
    m_signing_image_format = signing_image_format;
    m_signing_image_format_isSet = true;
}

bool OAIDescribeSigningJobResponse_overrides::is_signing_image_format_Set() const{
    return m_signing_image_format_isSet;
}

bool OAIDescribeSigningJobResponse_overrides::is_signing_image_format_Valid() const{
    return m_signing_image_format_isValid;
}

bool OAIDescribeSigningJobResponse_overrides::isSet() const {
...
bool OAIDescribeSigningJobResponse_overrides::isValid() const {
