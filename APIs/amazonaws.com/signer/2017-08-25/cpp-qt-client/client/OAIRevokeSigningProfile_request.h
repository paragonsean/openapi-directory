...
/*
 * OAIRevokeSigningProfile_request.h
 *
 * 
 */

#ifndef OAIRevokeSigningProfile_request_H
#define OAIRevokeSigningProfile_request_H
...
class OAIRevokeSigningProfile_request : public OAIObject {
public:
    OAIRevokeSigningProfile_request();
    OAIRevokeSigningProfile_request(QString json);
    ~OAIRevokeSigningProfile_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRevokeSigningProfile_request)

#endif // OAIRevokeSigningProfile_request_H
