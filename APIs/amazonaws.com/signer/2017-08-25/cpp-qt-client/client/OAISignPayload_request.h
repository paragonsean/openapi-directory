...
/*
 * OAISignPayload_request.h
 *
 * 
 */

#ifndef OAISignPayload_request_H
#define OAISignPayload_request_H
...
class OAISignPayload_request : public OAIObject {
public:
    OAISignPayload_request();
    OAISignPayload_request(QString json);
    ~OAISignPayload_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignPayload_request)

#endif // OAISignPayload_request_H
