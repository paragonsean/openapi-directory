...
/*
 * OAIAddProfilePermissionResponse.h
 *
 * 
 */

#ifndef OAIAddProfilePermissionResponse_H
#define OAIAddProfilePermissionResponse_H
...
class OAIAddProfilePermissionResponse : public OAIObject {
public:
    OAIAddProfilePermissionResponse();
    OAIAddProfilePermissionResponse(QString json);
    ~OAIAddProfilePermissionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddProfilePermissionResponse)

#endif // OAIAddProfilePermissionResponse_H
