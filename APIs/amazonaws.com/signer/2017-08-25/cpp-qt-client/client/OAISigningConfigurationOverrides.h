...
/*
 * OAISigningConfigurationOverrides.h
 *
 * A signing configuration that overrides the default encryption or hash algorithm of a signing job.
 */

#ifndef OAISigningConfigurationOverrides_H
#define OAISigningConfigurationOverrides_H
...
class OAISigningConfigurationOverrides : public OAIObject {
public:
    OAISigningConfigurationOverrides();
    OAISigningConfigurationOverrides(QString json);
    ~OAISigningConfigurationOverrides() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningConfigurationOverrides)

#endif // OAISigningConfigurationOverrides_H
