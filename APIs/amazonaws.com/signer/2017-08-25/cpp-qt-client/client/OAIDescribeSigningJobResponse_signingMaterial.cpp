...
OAIDescribeSigningJobResponse_signingMaterial::OAIDescribeSigningJobResponse_signingMaterial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeSigningJobResponse_signingMaterial::OAIDescribeSigningJobResponse_signingMaterial() {
    this->initializeModel();
}

OAIDescribeSigningJobResponse_signingMaterial::~OAIDescribeSigningJobResponse_signingMaterial() {}

void OAIDescribeSigningJobResponse_signingMaterial::initializeModel() {

    m_certificate_arn_isSet = false;
    m_certificate_arn_isValid = false;
}

void OAIDescribeSigningJobResponse_signingMaterial::fromJson(QString jsonString) {
...
void OAIDescribeSigningJobResponse_signingMaterial::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeSigningJobResponse_signingMaterial::asJson() const {
...
QJsonObject OAIDescribeSigningJobResponse_signingMaterial::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeSigningJobResponse_signingMaterial::getCertificateArn() const {
    return m_certificate_arn;
}
void OAIDescribeSigningJobResponse_signingMaterial::setCertificateArn(const QString &certificate_arn) {
    m_certificate_arn = certificate_arn;
    m_certificate_arn_isSet = true;
}

bool OAIDescribeSigningJobResponse_signingMaterial::is_certificate_arn_Set() const{
    return m_certificate_arn_isSet;
}

bool OAIDescribeSigningJobResponse_signingMaterial::is_certificate_arn_Valid() const{
    return m_certificate_arn_isValid;
}

bool OAIDescribeSigningJobResponse_signingMaterial::isSet() const {
...
bool OAIDescribeSigningJobResponse_signingMaterial::isValid() const {
