...
OAIGetSigningPlatformResponse::OAIGetSigningPlatformResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSigningPlatformResponse::OAIGetSigningPlatformResponse() {
    this->initializeModel();
}

OAIGetSigningPlatformResponse::~OAIGetSigningPlatformResponse() {}

void OAIGetSigningPlatformResponse::initializeModel() {
...
void OAIGetSigningPlatformResponse::fromJson(QString jsonString) {
...
void OAIGetSigningPlatformResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetSigningPlatformResponse::asJson() const {
...
QJsonObject OAIGetSigningPlatformResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetSigningPlatformResponse::getPlatformId() const {
    return m_platform_id;
}
void OAIGetSigningPlatformResponse::setPlatformId(const QString &platform_id) {
    m_platform_id = platform_id;
    m_platform_id_isSet = true;
}

bool OAIGetSigningPlatformResponse::is_platform_id_Set() const{
    return m_platform_id_isSet;
}

bool OAIGetSigningPlatformResponse::is_platform_id_Valid() const{
    return m_platform_id_isValid;
}

QString OAIGetSigningPlatformResponse::getDisplayName() const {
    return m_display_name;
}
void OAIGetSigningPlatformResponse::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIGetSigningPlatformResponse::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIGetSigningPlatformResponse::is_display_name_Valid() const{
    return m_display_name_isValid;
}

QString OAIGetSigningPlatformResponse::getPartner() const {
    return m_partner;
}
void OAIGetSigningPlatformResponse::setPartner(const QString &partner) {
    m_partner = partner;
    m_partner_isSet = true;
}

bool OAIGetSigningPlatformResponse::is_partner_Set() const{
    return m_partner_isSet;
}

bool OAIGetSigningPlatformResponse::is_partner_Valid() const{
    return m_partner_isValid;
}

QString OAIGetSigningPlatformResponse::getTarget() const {
    return m_target;
}
void OAIGetSigningPlatformResponse::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIGetSigningPlatformResponse::is_target_Set() const{
    return m_target_isSet;
}

bool OAIGetSigningPlatformResponse::is_target_Valid() const{
    return m_target_isValid;
}

OAICategory OAIGetSigningPlatformResponse::getCategory() const {
    return m_category;
}
void OAIGetSigningPlatformResponse::setCategory(const OAICategory &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIGetSigningPlatformResponse::is_category_Set() const{
    return m_category_isSet;
}

bool OAIGetSigningPlatformResponse::is_category_Valid() const{
    return m_category_isValid;
}

OAIGetSigningPlatformResponse_signingConfiguration OAIGetSigningPlatformResponse::getSigningConfiguration() const {
    return m_signing_configuration;
}
void OAIGetSigningPlatformResponse::setSigningConfiguration(const OAIGetSigningPlatformResponse_signingConfiguration &signing_configuration) {
    m_signing_configuration = signing_configuration;
    m_signing_configuration_isSet = true;
}

bool OAIGetSigningPlatformResponse::is_signing_configuration_Set() const{
    return m_signing_configuration_isSet;
}

bool OAIGetSigningPlatformResponse::is_signing_configuration_Valid() const{
    return m_signing_configuration_isValid;
}

OAIGetSigningPlatformResponse_signingImageFormat OAIGetSigningPlatformResponse::getSigningImageFormat() const {
    return m_signing_image_format;
}
void OAIGetSigningPlatformResponse::setSigningImageFormat(const OAIGetSigningPlatformResponse_signingImageFormat &signing_image_format) {
    m_signing_image_format = signing_image_format;
    m_signing_image_format_isSet = true;
}

bool OAIGetSigningPlatformResponse::is_signing_image_format_Set() const{
    return m_signing_image_format_isSet;
}

bool OAIGetSigningPlatformResponse::is_signing_image_format_Valid() const{
    return m_signing_image_format_isValid;
}

qint32 OAIGetSigningPlatformResponse::getMaxSizeInMb() const {
    return m_max_size_in_mb;
}
void OAIGetSigningPlatformResponse::setMaxSizeInMb(const qint32 &max_size_in_mb) {
    m_max_size_in_mb = max_size_in_mb;
    m_max_size_in_mb_isSet = true;
}

bool OAIGetSigningPlatformResponse::is_max_size_in_mb_Set() const{
    return m_max_size_in_mb_isSet;
}

bool OAIGetSigningPlatformResponse::is_max_size_in_mb_Valid() const{
    return m_max_size_in_mb_isValid;
}

bool OAIGetSigningPlatformResponse::getRevocationSupported() const {
    return m_revocation_supported;
}
void OAIGetSigningPlatformResponse::setRevocationSupported(const bool &revocation_supported) {
    m_revocation_supported = revocation_supported;
    m_revocation_supported_isSet = true;
}

bool OAIGetSigningPlatformResponse::is_revocation_supported_Set() const{
    return m_revocation_supported_isSet;
}

bool OAIGetSigningPlatformResponse::is_revocation_supported_Valid() const{
    return m_revocation_supported_isValid;
}

bool OAIGetSigningPlatformResponse::isSet() const {
...
bool OAIGetSigningPlatformResponse::isValid() const {
