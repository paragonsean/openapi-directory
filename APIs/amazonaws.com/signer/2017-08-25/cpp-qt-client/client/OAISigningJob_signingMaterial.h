...
/*
 * OAISigningJob_signingMaterial.h
 *
 * 
 */

#ifndef OAISigningJob_signingMaterial_H
#define OAISigningJob_signingMaterial_H
...
class OAISigningJob_signingMaterial : public OAIObject {
public:
    OAISigningJob_signingMaterial();
    OAISigningJob_signingMaterial(QString json);
    ~OAISigningJob_signingMaterial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningJob_signingMaterial)

#endif // OAISigningJob_signingMaterial_H
