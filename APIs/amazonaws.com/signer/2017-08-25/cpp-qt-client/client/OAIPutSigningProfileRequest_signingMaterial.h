...
/*
 * OAIPutSigningProfileRequest_signingMaterial.h
 *
 * 
 */

#ifndef OAIPutSigningProfileRequest_signingMaterial_H
#define OAIPutSigningProfileRequest_signingMaterial_H
...
class OAIPutSigningProfileRequest_signingMaterial : public OAIObject {
public:
    OAIPutSigningProfileRequest_signingMaterial();
    OAIPutSigningProfileRequest_signingMaterial(QString json);
    ~OAIPutSigningProfileRequest_signingMaterial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSigningProfileRequest_signingMaterial)

#endif // OAIPutSigningProfileRequest_signingMaterial_H
