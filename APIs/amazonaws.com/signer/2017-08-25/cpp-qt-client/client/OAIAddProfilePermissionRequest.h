...
/*
 * OAIAddProfilePermissionRequest.h
 *
 * 
 */

#ifndef OAIAddProfilePermissionRequest_H
#define OAIAddProfilePermissionRequest_H
...
class OAIAddProfilePermissionRequest : public OAIObject {
public:
    OAIAddProfilePermissionRequest();
    OAIAddProfilePermissionRequest(QString json);
    ~OAIAddProfilePermissionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddProfilePermissionRequest)

#endif // OAIAddProfilePermissionRequest_H
