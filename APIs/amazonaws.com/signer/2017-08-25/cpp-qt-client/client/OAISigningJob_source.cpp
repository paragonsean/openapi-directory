...
OAISigningJob_source::OAISigningJob_source(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISigningJob_source::OAISigningJob_source() {
    this->initializeModel();
}

OAISigningJob_source::~OAISigningJob_source() {}

void OAISigningJob_source::initializeModel() {

    m_s3_isSet = false;
    m_s3_isValid = false;
}

void OAISigningJob_source::fromJson(QString jsonString) {
...
QJsonObject OAISigningJob_source::asJsonObject() const {
    QJsonObject obj;
    if (m_s3.isSet()) {
...
OAIStartSigningJob_request_source_s3 OAISigningJob_source::getS3() const {
    return m_s3;
}
void OAISigningJob_source::setS3(const OAIStartSigningJob_request_source_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAISigningJob_source::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAISigningJob_source::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAISigningJob_source::isSet() const {
...
bool OAISigningJob_source::isValid() const {
