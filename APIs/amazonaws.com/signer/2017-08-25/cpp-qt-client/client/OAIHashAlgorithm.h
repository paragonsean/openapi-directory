...
#ifndef OAIHashAlgorithm_H
#define OAIHashAlgorithm_H
...
class OAIHashAlgorithm : public OAIEnum {
public:
    OAIHashAlgorithm();
    OAIHashAlgorithm(QString json);
    ~OAIHashAlgorithm() override;
    ...
    enum class eOAIHashAlgorithm {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SHA1, 
        SHA256
    };
    OAIHashAlgorithm::eOAIHashAlgorithm getValue() const;
    void setValue(const OAIHashAlgorithm::eOAIHashAlgorithm& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIHashAlgorithm)

#endif // OAIHashAlgorithm_H
