...
/*
 * OAISigningConfiguration_hashAlgorithmOptions.h
 *
 * 
 */

#ifndef OAISigningConfiguration_hashAlgorithmOptions_H
#define OAISigningConfiguration_hashAlgorithmOptions_H
...
class OAISigningConfiguration_hashAlgorithmOptions : public OAIObject {
public:
    OAISigningConfiguration_hashAlgorithmOptions();
    OAISigningConfiguration_hashAlgorithmOptions(QString json);
    ~OAISigningConfiguration_hashAlgorithmOptions() override;
    ...
    OAIHashAlgorithm getDefaultValue() const;
    void setDefaultValue(const OAIHashAlgorithm &default_value);
...
private:
    ...
    OAIHashAlgorithm m_default_value;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningConfiguration_hashAlgorithmOptions)

#endif // OAISigningConfiguration_hashAlgorithmOptions_H
