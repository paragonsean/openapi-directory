...
/*
 * OAIPutSigningProfileRequest.h
 *
 * 
 */

#ifndef OAIPutSigningProfileRequest_H
#define OAIPutSigningProfileRequest_H

#include <QJsonObject>

#include "OAIPutSigningProfileRequest_overrides.h"
...
namespace OpenAPI {
class OAIPutSigningProfileRequest_signingMaterial;
class OAIPutSigningProfileRequest_signatureValidityPeriod;
class OAIPutSigningProfileRequest_overrides;

class OAIPutSigningProfileRequest : public OAIObject {
public:
    OAIPutSigningProfileRequest();
    OAIPutSigningProfileRequest(QString json);
    ~OAIPutSigningProfileRequest() override;
    ...
    OAIPutSigningProfileRequest_signingMaterial getSigningMaterial() const;
    void setSigningMaterial(const OAIPutSigningProfileRequest_signingMaterial &signing_material);
    bool is_signing_material_Set() const;
    bool is_signing_material_Valid() const;

    OAIPutSigningProfileRequest_signatureValidityPeriod getSignatureValidityPeriod() const;
    void setSignatureValidityPeriod(const OAIPutSigningProfileRequest_signatureValidityPeriod &signature_validity_period);
    ...
    OAIPutSigningProfileRequest_overrides getOverrides() const;
    void setOverrides(const OAIPutSigningProfileRequest_overrides &overrides);
...
private:
    ...
    OAIPutSigningProfileRequest_signingMaterial m_signing_material;
    bool m_signing_material_isSet;
    bool m_signing_material_isValid;

    OAIPutSigningProfileRequest_signatureValidityPeriod m_signature_validity_period;
    ...
    OAIPutSigningProfileRequest_overrides m_overrides;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSigningProfileRequest)

#endif // OAIPutSigningProfileRequest_H
