...
/*
 * OAIDescribeSigningJobResponse_overrides.h
 *
 * 
 */

#ifndef OAIDescribeSigningJobResponse_overrides_H
#define OAIDescribeSigningJobResponse_overrides_H
...
class OAIDescribeSigningJobResponse_overrides : public OAIObject {
public:
    OAIDescribeSigningJobResponse_overrides();
    OAIDescribeSigningJobResponse_overrides(QString json);
    ~OAIDescribeSigningJobResponse_overrides() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSigningJobResponse_overrides)

#endif // OAIDescribeSigningJobResponse_overrides_H
