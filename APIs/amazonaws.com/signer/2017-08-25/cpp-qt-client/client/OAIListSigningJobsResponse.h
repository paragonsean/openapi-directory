...
/*
 * OAIListSigningJobsResponse.h
 *
 * 
 */

#ifndef OAIListSigningJobsResponse_H
#define OAIListSigningJobsResponse_H
...
class OAIListSigningJobsResponse : public OAIObject {
public:
    OAIListSigningJobsResponse();
    OAIListSigningJobsResponse(QString json);
    ~OAIListSigningJobsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSigningJobsResponse)

#endif // OAIListSigningJobsResponse_H
