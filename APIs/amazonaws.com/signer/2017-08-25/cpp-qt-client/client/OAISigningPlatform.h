...
/*
 * OAISigningPlatform.h
 *
 * Contains information about the signing configurations and parameters that are used to perform a code signing job.
 */

#ifndef OAISigningPlatform_H
#define OAISigningPlatform_H
...
namespace OpenAPI {
class OAISigningPlatform_signingConfiguration;
class OAISigningImageFormat;

class OAISigningPlatform : public OAIObject {
public:
    OAISigningPlatform();
    OAISigningPlatform(QString json);
    ~OAISigningPlatform() override;
    ...
    OAISigningPlatform_signingConfiguration getSigningConfiguration() const;
    void setSigningConfiguration(const OAISigningPlatform_signingConfiguration &signing_configuration);
    bool is_signing_configuration_Set() const;
    bool is_signing_configuration_Valid() const;

    OAISigningImageFormat getSigningImageFormat() const;
    void setSigningImageFormat(const OAISigningImageFormat &signing_image_format);
...
private:
    ...
    OAISigningPlatform_signingConfiguration m_signing_configuration;
    bool m_signing_configuration_isSet;
    bool m_signing_configuration_isValid;

    OAISigningImageFormat m_signing_image_format;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningPlatform)

#endif // OAISigningPlatform_H
