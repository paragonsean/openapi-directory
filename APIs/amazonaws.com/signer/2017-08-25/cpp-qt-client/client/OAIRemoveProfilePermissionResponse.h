...
/*
 * OAIRemoveProfilePermissionResponse.h
 *
 * 
 */

#ifndef OAIRemoveProfilePermissionResponse_H
#define OAIRemoveProfilePermissionResponse_H
...
class OAIRemoveProfilePermissionResponse : public OAIObject {
public:
    OAIRemoveProfilePermissionResponse();
    OAIRemoveProfilePermissionResponse(QString json);
    ~OAIRemoveProfilePermissionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveProfilePermissionResponse)

#endif // OAIRemoveProfilePermissionResponse_H
