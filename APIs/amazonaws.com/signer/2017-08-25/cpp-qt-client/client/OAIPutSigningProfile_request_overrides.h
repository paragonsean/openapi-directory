...
/*
 * OAIPutSigningProfile_request_overrides.h
 *
 * Any overrides that are applied to the signing configuration of a code signing platform.
 */

#ifndef OAIPutSigningProfile_request_overrides_H
#define OAIPutSigningProfile_request_overrides_H
...
class OAIPutSigningProfile_request_overrides : public OAIObject {
public:
    OAIPutSigningProfile_request_overrides();
    OAIPutSigningProfile_request_overrides(QString json);
    ~OAIPutSigningProfile_request_overrides() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSigningProfile_request_overrides)

#endif // OAIPutSigningProfile_request_overrides_H
