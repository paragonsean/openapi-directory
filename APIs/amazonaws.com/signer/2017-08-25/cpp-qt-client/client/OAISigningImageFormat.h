...
/*
 * OAISigningImageFormat.h
 *
 * The image format of a code signing platform or profile.
 */

#ifndef OAISigningImageFormat_H
#define OAISigningImageFormat_H
...
class OAISigningImageFormat : public OAIObject {
public:
    OAISigningImageFormat();
    OAISigningImageFormat(QString json);
    ~OAISigningImageFormat() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningImageFormat)

#endif // OAISigningImageFormat_H
