...
/*
 * OAIStartSigningJob_request.h
 *
 * 
 */

#ifndef OAIStartSigningJob_request_H
#define OAIStartSigningJob_request_H

#include <QJsonObject>

#include "OAIStartSigningJob_request_destination.h"
#include "OAIStartSigningJob_request_source.h"
#include <QString>
...
namespace OpenAPI {
class OAIStartSigningJob_request_source;
class OAIStartSigningJob_request_destination;

class OAIStartSigningJob_request : public OAIObject {
public:
    OAIStartSigningJob_request();
    OAIStartSigningJob_request(QString json);
    ~OAIStartSigningJob_request() override;
    ...
    OAIStartSigningJob_request_source getSource() const;
    void setSource(const OAIStartSigningJob_request_source &source);
    bool is_source_Set() const;
    bool is_source_Valid() const;

    OAIStartSigningJob_request_destination getDestination() const;
    void setDestination(const OAIStartSigningJob_request_destination &destination);
    ...
    QString getProfileOwner() const;
    void setProfileOwner(const QString &profile_owner);
    bool is_profile_owner_Set() const;
    bool is_profile_owner_Valid() const;
...
private:
    ...
    OAIStartSigningJob_request_source m_source;
    bool m_source_isSet;
    bool m_source_isValid;

    OAIStartSigningJob_request_destination m_destination;
    ...
    QString m_profile_owner;
    bool m_profile_owner_isSet;
    bool m_profile_owner_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartSigningJob_request)

#endif // OAIStartSigningJob_request_H
