...
OAIPutSigningProfile_request_signingMaterial::OAIPutSigningProfile_request_signingMaterial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutSigningProfile_request_signingMaterial::OAIPutSigningProfile_request_signingMaterial() {
    this->initializeModel();
}

OAIPutSigningProfile_request_signingMaterial::~OAIPutSigningProfile_request_signingMaterial() {}

void OAIPutSigningProfile_request_signingMaterial::initializeModel() {

    m_certificate_arn_isSet = false;
    m_certificate_arn_isValid = false;
}

void OAIPutSigningProfile_request_signingMaterial::fromJson(QString jsonString) {
...
void OAIPutSigningProfile_request_signingMaterial::fromJsonObject(QJsonObject json) {
...
QString OAIPutSigningProfile_request_signingMaterial::asJson() const {
...
QJsonObject OAIPutSigningProfile_request_signingMaterial::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutSigningProfile_request_signingMaterial::getCertificateArn() const {
    return m_certificate_arn;
}
void OAIPutSigningProfile_request_signingMaterial::setCertificateArn(const QString &certificate_arn) {
    m_certificate_arn = certificate_arn;
    m_certificate_arn_isSet = true;
}

bool OAIPutSigningProfile_request_signingMaterial::is_certificate_arn_Set() const{
    return m_certificate_arn_isSet;
}

bool OAIPutSigningProfile_request_signingMaterial::is_certificate_arn_Valid() const{
    return m_certificate_arn_isValid;
}

bool OAIPutSigningProfile_request_signingMaterial::isSet() const {
...
bool OAIPutSigningProfile_request_signingMaterial::isValid() const {
