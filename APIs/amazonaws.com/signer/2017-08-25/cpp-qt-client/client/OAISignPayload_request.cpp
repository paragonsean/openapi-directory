...
OAISignPayload_request::OAISignPayload_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISignPayload_request::OAISignPayload_request() {
    this->initializeModel();
}

OAISignPayload_request::~OAISignPayload_request() {}

void OAISignPayload_request::initializeModel() {
...
void OAISignPayload_request::fromJson(QString jsonString) {
...
void OAISignPayload_request::fromJsonObject(QJsonObject json) {
...
QString OAISignPayload_request::asJson() const {
...
QJsonObject OAISignPayload_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAISignPayload_request::getProfileName() const {
    return m_profile_name;
}
void OAISignPayload_request::setProfileName(const QString &profile_name) {
    m_profile_name = profile_name;
    m_profile_name_isSet = true;
}

bool OAISignPayload_request::is_profile_name_Set() const{
    return m_profile_name_isSet;
}

bool OAISignPayload_request::is_profile_name_Valid() const{
    return m_profile_name_isValid;
}

QString OAISignPayload_request::getProfileOwner() const {
    return m_profile_owner;
}
void OAISignPayload_request::setProfileOwner(const QString &profile_owner) {
    m_profile_owner = profile_owner;
    m_profile_owner_isSet = true;
}

bool OAISignPayload_request::is_profile_owner_Set() const{
    return m_profile_owner_isSet;
}

bool OAISignPayload_request::is_profile_owner_Valid() const{
    return m_profile_owner_isValid;
}

QString OAISignPayload_request::getPayload() const {
    return m_payload;
}
void OAISignPayload_request::setPayload(const QString &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAISignPayload_request::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAISignPayload_request::is_payload_Valid() const{
    return m_payload_isValid;
}

QString OAISignPayload_request::getPayloadFormat() const {
    return m_payload_format;
}
void OAISignPayload_request::setPayloadFormat(const QString &payload_format) {
    m_payload_format = payload_format;
    m_payload_format_isSet = true;
}

bool OAISignPayload_request::is_payload_format_Set() const{
    return m_payload_format_isSet;
}

bool OAISignPayload_request::is_payload_format_Valid() const{
    return m_payload_format_isValid;
}

bool OAISignPayload_request::isSet() const {
...
bool OAISignPayload_request::isValid() const {
