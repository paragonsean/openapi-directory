...
/*
 * OAISignedObject_s3.h
 *
 * 
 */

#ifndef OAISignedObject_s3_H
#define OAISignedObject_s3_H
...
class OAISignedObject_s3 : public OAIObject {
public:
    OAISignedObject_s3();
    OAISignedObject_s3(QString json);
    ~OAISignedObject_s3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignedObject_s3)

#endif // OAISignedObject_s3_H
