...
/*
 * OAISignPayloadResponse.h
 *
 * 
 */

#ifndef OAISignPayloadResponse_H
#define OAISignPayloadResponse_H
...
class OAISignPayloadResponse : public OAIObject {
public:
    OAISignPayloadResponse();
    OAISignPayloadResponse(QString json);
    ~OAISignPayloadResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignPayloadResponse)

#endif // OAISignPayloadResponse_H
