...
/*
 * OAIPutSigningProfileResponse.h
 *
 * 
 */

#ifndef OAIPutSigningProfileResponse_H
#define OAIPutSigningProfileResponse_H
...
class OAIPutSigningProfileResponse : public OAIObject {
public:
    OAIPutSigningProfileResponse();
    OAIPutSigningProfileResponse(QString json);
    ~OAIPutSigningProfileResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSigningProfileResponse)

#endif // OAIPutSigningProfileResponse_H
