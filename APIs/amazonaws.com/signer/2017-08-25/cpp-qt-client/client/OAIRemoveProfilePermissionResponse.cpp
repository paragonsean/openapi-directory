...
OAIRemoveProfilePermissionResponse::OAIRemoveProfilePermissionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemoveProfilePermissionResponse::OAIRemoveProfilePermissionResponse() {
    this->initializeModel();
}

OAIRemoveProfilePermissionResponse::~OAIRemoveProfilePermissionResponse() {}

void OAIRemoveProfilePermissionResponse::initializeModel() {

    m_revision_id_isSet = false;
    m_revision_id_isValid = false;
}

void OAIRemoveProfilePermissionResponse::fromJson(QString jsonString) {
...
void OAIRemoveProfilePermissionResponse::fromJsonObject(QJsonObject json) {
...
QString OAIRemoveProfilePermissionResponse::asJson() const {
...
QJsonObject OAIRemoveProfilePermissionResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRemoveProfilePermissionResponse::getRevisionId() const {
    return m_revision_id;
}
void OAIRemoveProfilePermissionResponse::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIRemoveProfilePermissionResponse::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIRemoveProfilePermissionResponse::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

bool OAIRemoveProfilePermissionResponse::isSet() const {
...
bool OAIRemoveProfilePermissionResponse::isValid() const {
