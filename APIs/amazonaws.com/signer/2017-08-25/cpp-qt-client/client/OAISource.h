...
#include "OAIStartSigningJob_request_source_s3.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIStartSigningJob_request_source_s3;
...
public:
    ...
    OAIStartSigningJob_request_source_s3 getS3() const;
    void setS3(const OAIStartSigningJob_request_source_s3 &s3);
...
private:
    ...
    OAIStartSigningJob_request_source_s3 m_s3;
    bool m_s3_isSet;
    bool m_s3_isValid;
};
