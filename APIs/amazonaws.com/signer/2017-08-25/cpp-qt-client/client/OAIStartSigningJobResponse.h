...
/*
 * OAIStartSigningJobResponse.h
 *
 * 
 */

#ifndef OAIStartSigningJobResponse_H
#define OAIStartSigningJobResponse_H
...
class OAIStartSigningJobResponse : public OAIObject {
public:
    OAIStartSigningJobResponse();
    OAIStartSigningJobResponse(QString json);
    ~OAIStartSigningJobResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSigningJobResponse)

#endif // OAIStartSigningJobResponse_H
