...
/*
 * OAIDescribeSigningJobResponse_revocationRecord.h
 *
 * 
 */

#ifndef OAIDescribeSigningJobResponse_revocationRecord_H
#define OAIDescribeSigningJobResponse_revocationRecord_H
...
class OAIDescribeSigningJobResponse_revocationRecord : public OAIObject {
public:
    OAIDescribeSigningJobResponse_revocationRecord();
    OAIDescribeSigningJobResponse_revocationRecord(QString json);
    ~OAIDescribeSigningJobResponse_revocationRecord() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSigningJobResponse_revocationRecord)

#endif // OAIDescribeSigningJobResponse_revocationRecord_H
