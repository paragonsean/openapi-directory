...
/*
 * OAIGetSigningProfileResponse_signingMaterial.h
 *
 * 
 */

#ifndef OAIGetSigningProfileResponse_signingMaterial_H
#define OAIGetSigningProfileResponse_signingMaterial_H
...
class OAIGetSigningProfileResponse_signingMaterial : public OAIObject {
public:
    OAIGetSigningProfileResponse_signingMaterial();
    OAIGetSigningProfileResponse_signingMaterial(QString json);
    ~OAIGetSigningProfileResponse_signingMaterial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSigningProfileResponse_signingMaterial)

#endif // OAIGetSigningProfileResponse_signingMaterial_H
