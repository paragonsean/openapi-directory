...
#include "OAIHashAlgorithmOptions.h"
...
OAIHashAlgorithmOptions::OAIHashAlgorithmOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHashAlgorithmOptions::OAIHashAlgorithmOptions() {
    this->initializeModel();
}

OAIHashAlgorithmOptions::~OAIHashAlgorithmOptions() {}

void OAIHashAlgorithmOptions::initializeModel() {
...
void OAIHashAlgorithmOptions::fromJson(QString jsonString) {
...
void OAIHashAlgorithmOptions::fromJsonObject(QJsonObject json) {
...
QString OAIHashAlgorithmOptions::asJson() const {
...
QJsonObject OAIHashAlgorithmOptions::asJsonObject() const {
    QJsonObject obj;
...
QList OAIHashAlgorithmOptions::getAllowedValues() const {
    return m_allowed_values;
}
void OAIHashAlgorithmOptions::setAllowedValues(const QList &allowed_values) {
    m_allowed_values = allowed_values;
    m_allowed_values_isSet = true;
}

bool OAIHashAlgorithmOptions::is_allowed_values_Set() const{
    return m_allowed_values_isSet;
}

bool OAIHashAlgorithmOptions::is_allowed_values_Valid() const{
    return m_allowed_values_isValid;
}

OAIHashAlgorithm OAIHashAlgorithmOptions::getDefaultValue() const {
    return m_default_value;
}
void OAIHashAlgorithmOptions::setDefaultValue(const OAIHashAlgorithm &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIHashAlgorithmOptions::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIHashAlgorithmOptions::is_default_value_Valid() const{
    return m_default_value_isValid;
}

bool OAIHashAlgorithmOptions::isSet() const {
...
bool OAIHashAlgorithmOptions::isValid() const {
