...
/*
 * OAISigningMaterial.h
 *
 * The ACM certificate that is used to sign your code.
 */

#ifndef OAISigningMaterial_H
#define OAISigningMaterial_H
...
class OAISigningMaterial : public OAIObject {
public:
    OAISigningMaterial();
    OAISigningMaterial(QString json);
    ~OAISigningMaterial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningMaterial)

#endif // OAISigningMaterial_H
