...
#include "OAIStartSigningJobRequest_source.h"
...
OAIStartSigningJobRequest_source::OAIStartSigningJobRequest_source(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartSigningJobRequest_source::OAIStartSigningJobRequest_source() {
    this->initializeModel();
}

OAIStartSigningJobRequest_source::~OAIStartSigningJobRequest_source() {}

void OAIStartSigningJobRequest_source::initializeModel() {

    m_s3_isSet = false;
    m_s3_isValid = false;
}

void OAIStartSigningJobRequest_source::fromJson(QString jsonString) {
...
void OAIStartSigningJobRequest_source::fromJsonObject(QJsonObject json) {

    m_s3_isValid = ::OpenAPI::fromJsonValue(m_s3, json[QString("s3")]);
    m_s3_isSet = !json[QString("s3")].isNull() && m_s3_isValid;
}

QString OAIStartSigningJobRequest_source::asJson() const {
...
QJsonObject OAIStartSigningJobRequest_source::asJsonObject() const {
    QJsonObject obj;
    if (m_s3.isSet()) {
...
OAIStartSigningJob_request_source_s3 OAIStartSigningJobRequest_source::getS3() const {
    return m_s3;
}
void OAIStartSigningJobRequest_source::setS3(const OAIStartSigningJob_request_source_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAIStartSigningJobRequest_source::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAIStartSigningJobRequest_source::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAIStartSigningJobRequest_source::isSet() const {
...
bool OAIStartSigningJobRequest_source::isValid() const {
