...
OAISigningJob_signedObject::OAISigningJob_signedObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISigningJob_signedObject::OAISigningJob_signedObject() {
    this->initializeModel();
}

OAISigningJob_signedObject::~OAISigningJob_signedObject() {}

void OAISigningJob_signedObject::initializeModel() {

    m_s3_isSet = false;
    m_s3_isValid = false;
}

void OAISigningJob_signedObject::fromJson(QString jsonString) {
...
void OAISigningJob_signedObject::fromJsonObject(QJsonObject json) {

    m_s3_isValid = ::OpenAPI::fromJsonValue(m_s3, json[QString("s3")]);
    m_s3_isSet = !json[QString("s3")].isNull() && m_s3_isValid;
}

QString OAISigningJob_signedObject::asJson() const {
...
QJsonObject OAISigningJob_signedObject::asJsonObject() const {
    QJsonObject obj;
    if (m_s3.isSet()) {
...
OAISignedObject_s3 OAISigningJob_signedObject::getS3() const {
    return m_s3;
}
void OAISigningJob_signedObject::setS3(const OAISignedObject_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAISigningJob_signedObject::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAISigningJob_signedObject::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAISigningJob_signedObject::isSet() const {
...
bool OAISigningJob_signedObject::isValid() const {
