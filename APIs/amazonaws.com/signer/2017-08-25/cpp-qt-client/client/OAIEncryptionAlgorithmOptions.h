...
/*
 * OAIEncryptionAlgorithmOptions.h
 *
 * The encryption algorithm options that are available to a code signing job.
 */

#ifndef OAIEncryptionAlgorithmOptions_H
#define OAIEncryptionAlgorithmOptions_H
...
class OAIEncryptionAlgorithmOptions : public OAIObject {
public:
    OAIEncryptionAlgorithmOptions();
    OAIEncryptionAlgorithmOptions(QString json);
    ~OAIEncryptionAlgorithmOptions() override;
    ...
    OAIEncryptionAlgorithm getDefaultValue() const;
    void setDefaultValue(const OAIEncryptionAlgorithm &default_value);
...
private:
    ...
    OAIEncryptionAlgorithm m_default_value;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEncryptionAlgorithmOptions)

#endif // OAIEncryptionAlgorithmOptions_H
