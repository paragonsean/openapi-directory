...
#ifndef OAIValidityType_H
#define OAIValidityType_H
...
class OAIValidityType : public OAIEnum {
public:
    OAIValidityType();
    OAIValidityType(QString json);
    ~OAIValidityType() override;
    ...
    enum class eOAIValidityType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DAYS, 
        MONTHS, 
        YEARS
    };
    OAIValidityType::eOAIValidityType getValue() const;
    void setValue(const OAIValidityType::eOAIValidityType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidityType)

#endif // OAIValidityType_H
