...
/*
 * OAISigningProfileStatus.h
 *
 * 
 */

#ifndef OAISigningProfileStatus_H
#define OAISigningProfileStatus_H
...
class OAISigningProfileStatus : public OAIEnum {
public:
    OAISigningProfileStatus();
    OAISigningProfileStatus(QString json);
    ~OAISigningProfileStatus() override;
    ...
    enum class eOAISigningProfileStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE, 
        CANCELED, 
        REVOKED
    };
    OAISigningProfileStatus::eOAISigningProfileStatus getValue() const;
    void setValue(const OAISigningProfileStatus::eOAISigningProfileStatus& value);
...
private:
    ...
    eOAISigningProfileStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningProfileStatus)

#endif // OAISigningProfileStatus_H
