...
OAIStartSigningJob_request_destination_s3 OAIDestination::getS3() const {
    return m_s3;
}
void OAIDestination::setS3(const OAIStartSigningJob_request_destination_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAIDestination::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAIDestination::is_s3_Valid() const{
    return m_s3_isValid;
}
