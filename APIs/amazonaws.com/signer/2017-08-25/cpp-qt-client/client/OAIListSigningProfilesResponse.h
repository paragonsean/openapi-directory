...
/*
 * OAIListSigningProfilesResponse.h
 *
 * 
 */

#ifndef OAIListSigningProfilesResponse_H
#define OAIListSigningProfilesResponse_H
...
class OAIListSigningProfilesResponse : public OAIObject {
public:
    OAIListSigningProfilesResponse();
    OAIListSigningProfilesResponse(QString json);
    ~OAIListSigningProfilesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSigningProfilesResponse)

#endif // OAIListSigningProfilesResponse_H
