...
/*
 * OAIStartSigningJobRequest.h
 *
 * 
 */

#ifndef OAIStartSigningJobRequest_H
#define OAIStartSigningJobRequest_H
...
namespace OpenAPI {
class OAIStartSigningJobRequest_source;
class OAIStartSigningJobRequest_destination;

class OAIStartSigningJobRequest : public OAIObject {
public:
    OAIStartSigningJobRequest();
    OAIStartSigningJobRequest(QString json);
    ~OAIStartSigningJobRequest() override;
    ...
    OAIStartSigningJobRequest_source getSource() const;
    void setSource(const OAIStartSigningJobRequest_source &source);
    bool is_source_Set() const;
    bool is_source_Valid() const;

    OAIStartSigningJobRequest_destination getDestination() const;
    void setDestination(const OAIStartSigningJobRequest_destination &destination);
...
private:
    ...
    OAIStartSigningJobRequest_source m_source;
    bool m_source_isSet;
    bool m_source_isValid;

    OAIStartSigningJobRequest_destination m_destination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSigningJobRequest)

#endif // OAIStartSigningJobRequest_H
