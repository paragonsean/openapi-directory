...
/*
 * OAIStartSigningJobRequest_destination.h
 *
 * 
 */

#ifndef OAIStartSigningJobRequest_destination_H
#define OAIStartSigningJobRequest_destination_H
...
namespace OpenAPI {
class OAIStartSigningJob_request_destination_s3;

class OAIStartSigningJobRequest_destination : public OAIObject {
public:
    OAIStartSigningJobRequest_destination();
    OAIStartSigningJobRequest_destination(QString json);
    ~OAIStartSigningJobRequest_destination() override;
    ...
    OAIStartSigningJob_request_destination_s3 getS3() const;
    void setS3(const OAIStartSigningJob_request_destination_s3 &s3);
...
private:
    ...
    OAIStartSigningJob_request_destination_s3 m_s3;
    bool m_s3_isSet;
    bool m_s3_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSigningJobRequest_destination)

#endif // OAIStartSigningJobRequest_destination_H
