...
OAIRevokeSignature_request::OAIRevokeSignature_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRevokeSignature_request::OAIRevokeSignature_request() {
    this->initializeModel();
}

OAIRevokeSignature_request::~OAIRevokeSignature_request() {}

void OAIRevokeSignature_request::initializeModel() {
...
void OAIRevokeSignature_request::fromJson(QString jsonString) {
...
void OAIRevokeSignature_request::fromJsonObject(QJsonObject json) {
...
QString OAIRevokeSignature_request::asJson() const {
...
QJsonObject OAIRevokeSignature_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRevokeSignature_request::getJobOwner() const {
    return m_job_owner;
}
void OAIRevokeSignature_request::setJobOwner(const QString &job_owner) {
    m_job_owner = job_owner;
    m_job_owner_isSet = true;
}

bool OAIRevokeSignature_request::is_job_owner_Set() const{
    return m_job_owner_isSet;
}

bool OAIRevokeSignature_request::is_job_owner_Valid() const{
    return m_job_owner_isValid;
}

QString OAIRevokeSignature_request::getReason() const {
    return m_reason;
}
void OAIRevokeSignature_request::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIRevokeSignature_request::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIRevokeSignature_request::is_reason_Valid() const{
    return m_reason_isValid;
}

bool OAIRevokeSignature_request::isSet() const {
...
bool OAIRevokeSignature_request::isValid() const {
