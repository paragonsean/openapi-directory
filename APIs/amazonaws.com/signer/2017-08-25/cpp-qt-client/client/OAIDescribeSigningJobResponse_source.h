...
/*
 * OAIDescribeSigningJobResponse_source.h
 *
 * 
 */

#ifndef OAIDescribeSigningJobResponse_source_H
#define OAIDescribeSigningJobResponse_source_H
...
class OAIDescribeSigningJobResponse_source : public OAIObject {
public:
    OAIDescribeSigningJobResponse_source();
    OAIDescribeSigningJobResponse_source(QString json);
    ~OAIDescribeSigningJobResponse_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSigningJobResponse_source)

#endif // OAIDescribeSigningJobResponse_source_H
