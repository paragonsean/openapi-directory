...
/*
 * OAISigningJob_signedObject.h
 *
 * 
 */

#ifndef OAISigningJob_signedObject_H
#define OAISigningJob_signedObject_H
...
class OAISigningJob_signedObject : public OAIObject {
public:
    OAISigningJob_signedObject();
    OAISigningJob_signedObject(QString json);
    ~OAISigningJob_signedObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningJob_signedObject)

#endif // OAISigningJob_signedObject_H
