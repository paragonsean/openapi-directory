...
/**
 * The StartSigningJobRequestDestinationS3 model module.
 * @module model/StartSigningJobRequestDestinationS3
 * @version 2017-08-25
 */
class StartSigningJobRequestDestinationS3 {
    /**
     * Constructs a new <code>StartSigningJobRequestDestinationS3</code>.
     * @alias module:model/StartSigningJobRequestDestinationS3
     * @implements module:model/S3Destination
     */
    constructor() { 
        S3Destination.initialize(this);
        StartSigningJobRequestDestinationS3.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartSigningJobRequestDestinationS3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartSigningJobRequestDestinationS3} obj Optional instance to populate.
     * @return {module:model/StartSigningJobRequestDestinationS3} The populated <code>StartSigningJobRequestDestinationS3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartSigningJobRequestDestinationS3();
    ...
    /**
     * Validates the JSON data with respect to <code>StartSigningJobRequestDestinationS3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartSigningJobRequestDestinationS3</code>.
     */
 ...
 */
StartSigningJobRequestDestinationS3.prototype['bucketName'] = undefined;

/**
 * @member {String} prefix
 */
StartSigningJobRequestDestinationS3.prototype['prefix'] = undefined;
...
export default StartSigningJobRequestDestinationS3;
