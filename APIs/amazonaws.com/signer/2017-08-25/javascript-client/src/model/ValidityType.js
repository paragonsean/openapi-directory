...
* @readonly
*/
export default class ValidityType {
    ...
    /**
    * Returns a <code>ValidityType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ValidityType} The enum <code>ValidityType</code> value.
    */
