...
/**
 * The S3SignedObject model module.
 * @module model/S3SignedObject
 * @version 2017-08-25
 */
class S3SignedObject {
    /**
     * Constructs a new <code>S3SignedObject</code>.
     * The S3 bucket name and key where code signing saved your signed code image.
     * @alias module:model/S3SignedObject
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>S3SignedObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/S3SignedObject} obj Optional instance to populate.
     * @return {module:model/S3SignedObject} The populated <code>S3SignedObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new S3SignedObject();
    ...
    /**
     * Validates the JSON data with respect to <code>S3SignedObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>S3SignedObject</code>.
     */
