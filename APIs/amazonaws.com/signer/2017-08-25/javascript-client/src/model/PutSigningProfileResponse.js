...
/**
 * The PutSigningProfileResponse model module.
 * @module model/PutSigningProfileResponse
 * @version 2017-08-25
 */
class PutSigningProfileResponse {
    /**
     * Constructs a new <code>PutSigningProfileResponse</code>.
     * @alias module:model/PutSigningProfileResponse
     */
    constructor() { 
        
        PutSigningProfileResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutSigningProfileResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutSigningProfileResponse} obj Optional instance to populate.
     * @return {module:model/PutSigningProfileResponse} The populated <code>PutSigningProfileResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutSigningProfileResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PutSigningProfileResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutSigningProfileResponse</code>.
     */
 ...
 * @member {String} arn
 */
PutSigningProfileResponse.prototype['arn'] = undefined;

/**
 * @member {String} profileVersion
 */
PutSigningProfileResponse.prototype['profileVersion'] = undefined;

/**
 * @member {String} profileVersionArn
 */
PutSigningProfileResponse.prototype['profileVersionArn'] = undefined;
...
export default PutSigningProfileResponse;
