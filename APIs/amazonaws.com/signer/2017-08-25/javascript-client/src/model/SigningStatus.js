...
* @readonly
*/
export default class SigningStatus {
    ...
    /**
    * Returns a <code>SigningStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SigningStatus} The enum <code>SigningStatus</code> value.
    */
