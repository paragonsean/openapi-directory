...
* @readonly
*/
export default class SigningProfileStatus {
    ...
    /**
    * Returns a <code>SigningProfileStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SigningProfileStatus} The enum <code>SigningProfileStatus</code> value.
    */
