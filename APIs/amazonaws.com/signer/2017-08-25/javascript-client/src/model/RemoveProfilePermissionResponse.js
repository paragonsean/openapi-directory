...
/**
 * The RemoveProfilePermissionResponse model module.
 * @module model/RemoveProfilePermissionResponse
 * @version 2017-08-25
 */
class RemoveProfilePermissionResponse {
    /**
     * Constructs a new <code>RemoveProfilePermissionResponse</code>.
     * @alias module:model/RemoveProfilePermissionResponse
     */
    constructor() { 
        
        RemoveProfilePermissionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemoveProfilePermissionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveProfilePermissionResponse} obj Optional instance to populate.
     * @return {module:model/RemoveProfilePermissionResponse} The populated <code>RemoveProfilePermissionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveProfilePermissionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveProfilePermissionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveProfilePermissionResponse</code>.
     */
 ...
 */
RemoveProfilePermissionResponse.prototype['revisionId'] = undefined;
...
export default RemoveProfilePermissionResponse;
