...
/**
 * The SigningMaterial model module.
 * @module model/SigningMaterial
 * @version 2017-08-25
 */
class SigningMaterial {
    /**
     * Constructs a new <code>SigningMaterial</code>.
     * The ACM certificate that is used to sign your code.
     * @alias module:model/SigningMaterial
    ...
    /**
     * Constructs a <code>SigningMaterial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SigningMaterial} obj Optional instance to populate.
     * @return {module:model/SigningMaterial} The populated <code>SigningMaterial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SigningMaterial();
    ...
    /**
     * Validates the JSON data with respect to <code>SigningMaterial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SigningMaterial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SigningMaterial.RequiredProperties) {
...
SigningMaterial.RequiredProperties = ["certificateArn"];
...
export default SigningMaterial;
