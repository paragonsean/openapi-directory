...
/**
 * The SignatureValidityPeriod model module.
 * @module model/SignatureValidityPeriod
 * @version 2017-08-25
 */
class SignatureValidityPeriod {
    /**
     * Constructs a new <code>SignatureValidityPeriod</code>.
     * The validity period for a signing job.
     * @alias module:model/SignatureValidityPeriod
     */
    constructor() { 
        
        SignatureValidityPeriod.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SignatureValidityPeriod</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SignatureValidityPeriod} obj Optional instance to populate.
     * @return {module:model/SignatureValidityPeriod} The populated <code>SignatureValidityPeriod</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SignatureValidityPeriod();

            if (data.hasOwnProperty('value')) {
                obj['value'] = ApiClient.convertToType(data['value'], 'Number');
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = ApiClient.convertToType(data['type'], ValidityType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SignatureValidityPeriod</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SignatureValidityPeriod</code>.
     */
    static validateJSON(data) {
        ...
        if (data['type']) { // data not null
          ValidityType.validateJSON(data['type']);
        }
 ...
 * @member {Number} value
 */
SignatureValidityPeriod.prototype['value'] = undefined;

/**
 * @member {module:model/ValidityType} type
 */
SignatureValidityPeriod.prototype['type'] = undefined;
...
export default SignatureValidityPeriod;
