# AwsSigner.AddProfilePermissionRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**profileVersion** | **String** | The version of the signing profile. | [optional] 
...
**revisionId** | **String** | A unique identifier for the current profile revision. | [optional] 
