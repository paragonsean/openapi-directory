...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningJobRevocationRecord();
  });
  ...
  describe('SigningJobRevocationRecord', function() {
    it('should create an instance of SigningJobRevocationRecord', function() {
      // uncomment below and update the code to test SigningJobRevocationRecord
      //var instance = new AwsSigner.SigningJobRevocationRecord();
      //expect(instance).to.be.a(AwsSigner.SigningJobRevocationRecord);
    });
