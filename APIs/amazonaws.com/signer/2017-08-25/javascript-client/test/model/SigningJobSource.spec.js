...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningJobSource();
  });
  ...
  describe('SigningJobSource', function() {
    it('should create an instance of SigningJobSource', function() {
      // uncomment below and update the code to test SigningJobSource
      //var instance = new AwsSigner.SigningJobSource();
      //expect(instance).to.be.a(AwsSigner.SigningJobSource);
    });
