...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SignPayloadResponse();
  });
  ...
  describe('SignPayloadResponse', function() {
    it('should create an instance of SignPayloadResponse', function() {
      // uncomment below and update the code to test SignPayloadResponse
      //var instance = new AwsSigner.SignPayloadResponse();
      //expect(instance).to.be.a(AwsSigner.SignPayloadResponse);
    });
