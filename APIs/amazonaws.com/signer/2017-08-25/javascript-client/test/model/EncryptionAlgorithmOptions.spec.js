...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.EncryptionAlgorithmOptions();
  });
  ...
  describe('EncryptionAlgorithmOptions', function() {
    it('should create an instance of EncryptionAlgorithmOptions', function() {
      // uncomment below and update the code to test EncryptionAlgorithmOptions
      //var instance = new AwsSigner.EncryptionAlgorithmOptions();
      //expect(instance).to.be.a(AwsSigner.EncryptionAlgorithmOptions);
    });
