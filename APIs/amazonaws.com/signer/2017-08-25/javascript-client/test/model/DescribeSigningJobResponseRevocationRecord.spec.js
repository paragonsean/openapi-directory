...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.DescribeSigningJobResponseRevocationRecord();
  });
  ...
  describe('DescribeSigningJobResponseRevocationRecord', function() {
    it('should create an instance of DescribeSigningJobResponseRevocationRecord', function() {
      // uncomment below and update the code to test DescribeSigningJobResponseRevocationRecord
      //var instance = new AwsSigner.DescribeSigningJobResponseRevocationRecord();
      //expect(instance).to.be.a(AwsSigner.DescribeSigningJobResponseRevocationRecord);
    });
