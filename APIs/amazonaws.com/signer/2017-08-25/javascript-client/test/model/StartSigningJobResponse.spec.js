...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.StartSigningJobResponse();
  });
  ...
  describe('StartSigningJobResponse', function() {
    it('should create an instance of StartSigningJobResponse', function() {
      // uncomment below and update the code to test StartSigningJobResponse
      //var instance = new AwsSigner.StartSigningJobResponse();
      //expect(instance).to.be.a(AwsSigner.StartSigningJobResponse);
    });
