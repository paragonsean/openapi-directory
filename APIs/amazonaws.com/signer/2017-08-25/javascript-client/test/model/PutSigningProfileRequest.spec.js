...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.PutSigningProfileRequest();
  });
  ...
  describe('PutSigningProfileRequest', function() {
    it('should create an instance of PutSigningProfileRequest', function() {
      // uncomment below and update the code to test PutSigningProfileRequest
      //var instance = new AwsSigner.PutSigningProfileRequest();
      //expect(instance).to.be.a(AwsSigner.PutSigningProfileRequest);
    });
