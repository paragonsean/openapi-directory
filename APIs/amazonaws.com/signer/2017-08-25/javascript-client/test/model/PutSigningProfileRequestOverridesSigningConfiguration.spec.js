...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.PutSigningProfileRequestOverridesSigningConfiguration();
  });
  ...
  describe('PutSigningProfileRequestOverridesSigningConfiguration', function() {
    it('should create an instance of PutSigningProfileRequestOverridesSigningConfiguration', function() {
      // uncomment below and update the code to test PutSigningProfileRequestOverridesSigningConfiguration
      //var instance = new AwsSigner.PutSigningProfileRequestOverridesSigningConfiguration();
      //expect(instance).to.be.a(AwsSigner.PutSigningProfileRequestOverridesSigningConfiguration);
    });
