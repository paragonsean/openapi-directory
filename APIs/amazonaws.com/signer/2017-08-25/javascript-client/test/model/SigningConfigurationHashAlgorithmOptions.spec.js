...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningConfigurationHashAlgorithmOptions();
  });
  ...
  describe('SigningConfigurationHashAlgorithmOptions', function() {
    it('should create an instance of SigningConfigurationHashAlgorithmOptions', function() {
      // uncomment below and update the code to test SigningConfigurationHashAlgorithmOptions
      //var instance = new AwsSigner.SigningConfigurationHashAlgorithmOptions();
      //expect(instance).to.be.a(AwsSigner.SigningConfigurationHashAlgorithmOptions);
    });
