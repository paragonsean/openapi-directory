...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.StartSigningJobRequestDestinationS3();
  });
  ...
  describe('StartSigningJobRequestDestinationS3', function() {
    it('should create an instance of StartSigningJobRequestDestinationS3', function() {
      // uncomment below and update the code to test StartSigningJobRequestDestinationS3
      //var instance = new AwsSigner.StartSigningJobRequestDestinationS3();
      //expect(instance).to.be.a(AwsSigner.StartSigningJobRequestDestinationS3);
    });
