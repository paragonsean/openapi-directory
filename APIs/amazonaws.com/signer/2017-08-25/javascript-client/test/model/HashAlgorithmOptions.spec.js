...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.HashAlgorithmOptions();
  });
  ...
  describe('HashAlgorithmOptions', function() {
    it('should create an instance of HashAlgorithmOptions', function() {
      // uncomment below and update the code to test HashAlgorithmOptions
      //var instance = new AwsSigner.HashAlgorithmOptions();
      //expect(instance).to.be.a(AwsSigner.HashAlgorithmOptions);
    });
