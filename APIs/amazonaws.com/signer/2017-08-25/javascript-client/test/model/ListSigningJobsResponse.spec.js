...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.ListSigningJobsResponse();
  });
  ...
  describe('ListSigningJobsResponse', function() {
    it('should create an instance of ListSigningJobsResponse', function() {
      // uncomment below and update the code to test ListSigningJobsResponse
      //var instance = new AwsSigner.ListSigningJobsResponse();
      //expect(instance).to.be.a(AwsSigner.ListSigningJobsResponse);
    });
