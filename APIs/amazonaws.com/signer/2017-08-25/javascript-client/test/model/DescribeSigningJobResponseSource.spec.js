...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.DescribeSigningJobResponseSource();
  });
  ...
  describe('DescribeSigningJobResponseSource', function() {
    it('should create an instance of DescribeSigningJobResponseSource', function() {
      // uncomment below and update the code to test DescribeSigningJobResponseSource
      //var instance = new AwsSigner.DescribeSigningJobResponseSource();
      //expect(instance).to.be.a(AwsSigner.DescribeSigningJobResponseSource);
    });
