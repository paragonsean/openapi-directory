...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.S3Source();
  });
  ...
  describe('S3Source', function() {
    it('should create an instance of S3Source', function() {
      // uncomment below and update the code to test S3Source
      //var instance = new AwsSigner.S3Source();
      //expect(instance).to.be.a(AwsSigner.S3Source);
    });
