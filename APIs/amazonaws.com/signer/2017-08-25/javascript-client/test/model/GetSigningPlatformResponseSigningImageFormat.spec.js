...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.GetSigningPlatformResponseSigningImageFormat();
  });
  ...
  describe('GetSigningPlatformResponseSigningImageFormat', function() {
    it('should create an instance of GetSigningPlatformResponseSigningImageFormat', function() {
      // uncomment below and update the code to test GetSigningPlatformResponseSigningImageFormat
      //var instance = new AwsSigner.GetSigningPlatformResponseSigningImageFormat();
      //expect(instance).to.be.a(AwsSigner.GetSigningPlatformResponseSigningImageFormat);
    });
