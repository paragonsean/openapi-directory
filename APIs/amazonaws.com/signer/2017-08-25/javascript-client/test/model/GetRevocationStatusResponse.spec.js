...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.GetRevocationStatusResponse();
  });
  ...
  describe('GetRevocationStatusResponse', function() {
    it('should create an instance of GetRevocationStatusResponse', function() {
      // uncomment below and update the code to test GetRevocationStatusResponse
      //var instance = new AwsSigner.GetRevocationStatusResponse();
      //expect(instance).to.be.a(AwsSigner.GetRevocationStatusResponse);
    });

    it('should have the property revokedEntities (base name: "revokedEntities")', function() {
      // uncomment below and update the code to test the property revokedEntities
      //var instance = new AwsSigner.GetRevocationStatusResponse();
