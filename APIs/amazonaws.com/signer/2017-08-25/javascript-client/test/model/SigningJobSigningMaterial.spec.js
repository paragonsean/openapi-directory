...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningJobSigningMaterial();
  });
  ...
  describe('SigningJobSigningMaterial', function() {
    it('should create an instance of SigningJobSigningMaterial', function() {
      // uncomment below and update the code to test SigningJobSigningMaterial
      //var instance = new AwsSigner.SigningJobSigningMaterial();
      //expect(instance).to.be.a(AwsSigner.SigningJobSigningMaterial);
    });
