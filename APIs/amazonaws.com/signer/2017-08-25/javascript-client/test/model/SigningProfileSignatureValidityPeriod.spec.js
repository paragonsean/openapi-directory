...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningProfileSignatureValidityPeriod();
  });
  ...
  describe('SigningProfileSignatureValidityPeriod', function() {
    it('should create an instance of SigningProfileSignatureValidityPeriod', function() {
      // uncomment below and update the code to test SigningProfileSignatureValidityPeriod
      //var instance = new AwsSigner.SigningProfileSignatureValidityPeriod();
      //expect(instance).to.be.a(AwsSigner.SigningProfileSignatureValidityPeriod);
    });
