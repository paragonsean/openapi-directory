...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.PutSigningProfileRequestOverrides();
  });
  ...
  describe('PutSigningProfileRequestOverrides', function() {
    it('should create an instance of PutSigningProfileRequestOverrides', function() {
      // uncomment below and update the code to test PutSigningProfileRequestOverrides
      //var instance = new AwsSigner.PutSigningProfileRequestOverrides();
      //expect(instance).to.be.a(AwsSigner.PutSigningProfileRequestOverrides);
    });
