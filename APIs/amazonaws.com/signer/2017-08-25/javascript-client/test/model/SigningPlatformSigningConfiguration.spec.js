...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningPlatformSigningConfiguration();
  });
  ...
  describe('SigningPlatformSigningConfiguration', function() {
    it('should create an instance of SigningPlatformSigningConfiguration', function() {
      // uncomment below and update the code to test SigningPlatformSigningConfiguration
      //var instance = new AwsSigner.SigningPlatformSigningConfiguration();
      //expect(instance).to.be.a(AwsSigner.SigningPlatformSigningConfiguration);
    });
