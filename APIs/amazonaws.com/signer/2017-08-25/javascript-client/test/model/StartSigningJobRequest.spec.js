...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.StartSigningJobRequest();
  });
  ...
  describe('StartSigningJobRequest', function() {
    it('should create an instance of StartSigningJobRequest', function() {
      // uncomment below and update the code to test StartSigningJobRequest
      //var instance = new AwsSigner.StartSigningJobRequest();
      //expect(instance).to.be.a(AwsSigner.StartSigningJobRequest);
    });
    ...
    it('should have the property profileOwner (base name: "profileOwner")', function() {
      // uncomment below and update the code to test the property profileOwner
      //var instance = new AwsSigner.StartSigningJobRequest();
      //expect(instance).to.be();
    });
