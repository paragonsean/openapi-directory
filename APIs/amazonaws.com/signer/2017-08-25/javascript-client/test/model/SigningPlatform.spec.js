...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningPlatform();
  });
  ...
  describe('SigningPlatform', function() {
    it('should create an instance of SigningPlatform', function() {
      // uncomment below and update the code to test SigningPlatform
      //var instance = new AwsSigner.SigningPlatform();
      //expect(instance).to.be.a(AwsSigner.SigningPlatform);
    });
