...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningConfigurationOverrides();
  });
  ...
  describe('SigningConfigurationOverrides', function() {
    it('should create an instance of SigningConfigurationOverrides', function() {
      // uncomment below and update the code to test SigningConfigurationOverrides
      //var instance = new AwsSigner.SigningConfigurationOverrides();
      //expect(instance).to.be.a(AwsSigner.SigningConfigurationOverrides);
    });
