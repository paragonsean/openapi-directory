...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.RevokeSigningProfileRequest();
  });
  ...
  describe('RevokeSigningProfileRequest', function() {
    it('should create an instance of RevokeSigningProfileRequest', function() {
      // uncomment below and update the code to test RevokeSigningProfileRequest
      //var instance = new AwsSigner.RevokeSigningProfileRequest();
      //expect(instance).to.be.a(AwsSigner.RevokeSigningProfileRequest);
    });
