...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.RevokeSignatureRequest();
  });
  ...
  describe('RevokeSignatureRequest', function() {
    it('should create an instance of RevokeSignatureRequest', function() {
      // uncomment below and update the code to test RevokeSignatureRequest
      //var instance = new AwsSigner.RevokeSignatureRequest();
      //expect(instance).to.be.a(AwsSigner.RevokeSignatureRequest);
    });
