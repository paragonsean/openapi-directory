...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.StartSigningJobRequestSource();
  });
  ...
  describe('StartSigningJobRequestSource', function() {
    it('should create an instance of StartSigningJobRequestSource', function() {
      // uncomment below and update the code to test StartSigningJobRequestSource
      //var instance = new AwsSigner.StartSigningJobRequestSource();
      //expect(instance).to.be.a(AwsSigner.StartSigningJobRequestSource);
    });
