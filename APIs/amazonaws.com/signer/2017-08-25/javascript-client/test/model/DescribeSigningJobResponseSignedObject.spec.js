...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.DescribeSigningJobResponseSignedObject();
  });
  ...
  describe('DescribeSigningJobResponseSignedObject', function() {
    it('should create an instance of DescribeSigningJobResponseSignedObject', function() {
      // uncomment below and update the code to test DescribeSigningJobResponseSignedObject
      //var instance = new AwsSigner.DescribeSigningJobResponseSignedObject();
      //expect(instance).to.be.a(AwsSigner.DescribeSigningJobResponseSignedObject);
    });
