...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningConfigurationEncryptionAlgorithmOptions();
  });
  ...
  describe('SigningConfigurationEncryptionAlgorithmOptions', function() {
    it('should create an instance of SigningConfigurationEncryptionAlgorithmOptions', function() {
      // uncomment below and update the code to test SigningConfigurationEncryptionAlgorithmOptions
      //var instance = new AwsSigner.SigningConfigurationEncryptionAlgorithmOptions();
      //expect(instance).to.be.a(AwsSigner.SigningConfigurationEncryptionAlgorithmOptions);
    });
