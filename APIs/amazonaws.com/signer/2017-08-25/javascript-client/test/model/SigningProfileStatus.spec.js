...
(function(root, factory) {
  ...
  describe('SigningProfileStatus', function() {
    it('should create an instance of SigningProfileStatus', function() {
      // uncomment below and update the code to test SigningProfileStatus
      //var instance = new AwsSigner.SigningProfileStatus();
      //expect(instance).to.be.a(AwsSigner.SigningProfileStatus);
    });
