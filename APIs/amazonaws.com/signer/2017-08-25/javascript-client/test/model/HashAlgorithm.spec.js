...
(function(root, factory) {
  ...
  describe('HashAlgorithm', function() {
    it('should create an instance of HashAlgorithm', function() {
      // uncomment below and update the code to test HashAlgorithm
      //var instance = new AwsSigner.HashAlgorithm();
      //expect(instance).to.be.a(AwsSigner.HashAlgorithm);
    });
