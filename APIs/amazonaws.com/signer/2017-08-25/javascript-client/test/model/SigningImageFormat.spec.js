...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningImageFormat();
  });
  ...
  describe('SigningImageFormat', function() {
    it('should create an instance of SigningImageFormat', function() {
      // uncomment below and update the code to test SigningImageFormat
      //var instance = new AwsSigner.SigningImageFormat();
      //expect(instance).to.be.a(AwsSigner.SigningImageFormat);
    });
