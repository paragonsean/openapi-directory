...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.GetSigningPlatformResponseSigningConfiguration();
  });
  ...
  describe('GetSigningPlatformResponseSigningConfiguration', function() {
    it('should create an instance of GetSigningPlatformResponseSigningConfiguration', function() {
      // uncomment below and update the code to test GetSigningPlatformResponseSigningConfiguration
      //var instance = new AwsSigner.GetSigningPlatformResponseSigningConfiguration();
      //expect(instance).to.be.a(AwsSigner.GetSigningPlatformResponseSigningConfiguration);
    });
