...
(function(root, factory) {
  ...
  describe('ValidityType', function() {
    it('should create an instance of ValidityType', function() {
      // uncomment below and update the code to test ValidityType
      //var instance = new AwsSigner.ValidityType();
      //expect(instance).to.be.a(AwsSigner.ValidityType);
    });
