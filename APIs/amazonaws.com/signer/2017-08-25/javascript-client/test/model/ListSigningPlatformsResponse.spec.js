...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.ListSigningPlatformsResponse();
  });
  ...
  describe('ListSigningPlatformsResponse', function() {
    it('should create an instance of ListSigningPlatformsResponse', function() {
      // uncomment below and update the code to test ListSigningPlatformsResponse
      //var instance = new AwsSigner.ListSigningPlatformsResponse();
      //expect(instance).to.be.a(AwsSigner.ListSigningPlatformsResponse);
    });
