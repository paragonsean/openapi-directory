...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.S3SignedObject();
  });
  ...
  describe('S3SignedObject', function() {
    it('should create an instance of S3SignedObject', function() {
      // uncomment below and update the code to test S3SignedObject
      //var instance = new AwsSigner.S3SignedObject();
      //expect(instance).to.be.a(AwsSigner.S3SignedObject);
    });
