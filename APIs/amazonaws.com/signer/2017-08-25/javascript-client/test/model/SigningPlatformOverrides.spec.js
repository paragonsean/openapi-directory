...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningPlatformOverrides();
  });
  ...
  describe('SigningPlatformOverrides', function() {
    it('should create an instance of SigningPlatformOverrides', function() {
      // uncomment below and update the code to test SigningPlatformOverrides
      //var instance = new AwsSigner.SigningPlatformOverrides();
      //expect(instance).to.be.a(AwsSigner.SigningPlatformOverrides);
    });
