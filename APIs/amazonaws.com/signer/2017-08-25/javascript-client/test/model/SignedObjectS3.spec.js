...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SignedObjectS3();
  });
  ...
  describe('SignedObjectS3', function() {
    it('should create an instance of SignedObjectS3', function() {
      // uncomment below and update the code to test SignedObjectS3
      //var instance = new AwsSigner.SignedObjectS3();
      //expect(instance).to.be.a(AwsSigner.SignedObjectS3);
    });
