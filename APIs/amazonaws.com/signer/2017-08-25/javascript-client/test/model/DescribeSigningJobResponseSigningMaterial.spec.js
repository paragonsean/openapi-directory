...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.DescribeSigningJobResponseSigningMaterial();
  });
  ...
  describe('DescribeSigningJobResponseSigningMaterial', function() {
    it('should create an instance of DescribeSigningJobResponseSigningMaterial', function() {
      // uncomment below and update the code to test DescribeSigningJobResponseSigningMaterial
      //var instance = new AwsSigner.DescribeSigningJobResponseSigningMaterial();
      //expect(instance).to.be.a(AwsSigner.DescribeSigningJobResponseSigningMaterial);
    });
