...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.GetSigningProfileResponseOverrides();
  });
  ...
  describe('GetSigningProfileResponseOverrides', function() {
    it('should create an instance of GetSigningProfileResponseOverrides', function() {
      // uncomment below and update the code to test GetSigningProfileResponseOverrides
      //var instance = new AwsSigner.GetSigningProfileResponseOverrides();
      //expect(instance).to.be.a(AwsSigner.GetSigningProfileResponseOverrides);
    });
