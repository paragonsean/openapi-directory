...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningConfiguration();
  });
  ...
  describe('SigningConfiguration', function() {
    it('should create an instance of SigningConfiguration', function() {
      // uncomment below and update the code to test SigningConfiguration
      //var instance = new AwsSigner.SigningConfiguration();
      //expect(instance).to.be.a(AwsSigner.SigningConfiguration);
    });

    it('should have the property encryptionAlgorithmOptions (base name: "encryptionAlgorithmOptions")', function() {
      // uncomment below and update the code to test the property encryptionAlgorithmOptions
      //var instance = new AwsSigner.SigningConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property hashAlgorithmOptions (base name: "hashAlgorithmOptions")', function() {
      // uncomment below and update the code to test the property hashAlgorithmOptions
      //var instance = new AwsSigner.SigningConfiguration();
      //expect(instance).to.be();
    });
