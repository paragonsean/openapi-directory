...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.PutSigningProfileRequestSigningMaterial();
  });
  ...
  describe('PutSigningProfileRequestSigningMaterial', function() {
    it('should create an instance of PutSigningProfileRequestSigningMaterial', function() {
      // uncomment below and update the code to test PutSigningProfileRequestSigningMaterial
      //var instance = new AwsSigner.PutSigningProfileRequestSigningMaterial();
      //expect(instance).to.be.a(AwsSigner.PutSigningProfileRequestSigningMaterial);
    });
