...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.AddProfilePermissionRequest();
  });
  ...
  describe('AddProfilePermissionRequest', function() {
    it('should create an instance of AddProfilePermissionRequest', function() {
      // uncomment below and update the code to test AddProfilePermissionRequest
      //var instance = new AwsSigner.AddProfilePermissionRequest();
      //expect(instance).to.be.a(AwsSigner.AddProfilePermissionRequest);
    });
