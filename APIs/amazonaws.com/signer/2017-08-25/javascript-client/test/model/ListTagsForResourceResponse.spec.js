...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AwsSigner.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AwsSigner.ListTagsForResourceResponse);
    });
