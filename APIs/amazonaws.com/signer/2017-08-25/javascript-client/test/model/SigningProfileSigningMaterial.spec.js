...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningProfileSigningMaterial();
  });
  ...
  describe('SigningProfileSigningMaterial', function() {
    it('should create an instance of SigningProfileSigningMaterial', function() {
      // uncomment below and update the code to test SigningProfileSigningMaterial
      //var instance = new AwsSigner.SigningProfileSigningMaterial();
      //expect(instance).to.be.a(AwsSigner.SigningProfileSigningMaterial);
    });
