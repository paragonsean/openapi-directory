...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.StartSigningJobRequestDestination();
  });
  ...
  describe('StartSigningJobRequestDestination', function() {
    it('should create an instance of StartSigningJobRequestDestination', function() {
      // uncomment below and update the code to test StartSigningJobRequestDestination
      //var instance = new AwsSigner.StartSigningJobRequestDestination();
      //expect(instance).to.be.a(AwsSigner.StartSigningJobRequestDestination);
    });
