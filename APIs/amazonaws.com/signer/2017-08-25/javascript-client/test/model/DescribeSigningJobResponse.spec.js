...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.DescribeSigningJobResponse();
  });
  ...
  describe('DescribeSigningJobResponse', function() {
    it('should create an instance of DescribeSigningJobResponse', function() {
      // uncomment below and update the code to test DescribeSigningJobResponse
      //var instance = new AwsSigner.DescribeSigningJobResponse();
      //expect(instance).to.be.a(AwsSigner.DescribeSigningJobResponse);
    });
    ...
    it('should have the property signingParameters (base name: "signingParameters")', function() {
      // uncomment below and update the code to test the property signingParameters
      //var instance = new AwsSigner.DescribeSigningJobResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property revocationRecord (base name: "revocationRecord")', function() {
      // uncomment below and update the code to test the property revocationRecord
      //var instance = new AwsSigner.DescribeSigningJobResponse();
      //expect(instance).to.be();
    });
