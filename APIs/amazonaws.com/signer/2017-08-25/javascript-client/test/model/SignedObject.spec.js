...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SignedObject();
  });
  ...
  describe('SignedObject', function() {
    it('should create an instance of SignedObject', function() {
      // uncomment below and update the code to test SignedObject
      //var instance = new AwsSigner.SignedObject();
      //expect(instance).to.be.a(AwsSigner.SignedObject);
    });
