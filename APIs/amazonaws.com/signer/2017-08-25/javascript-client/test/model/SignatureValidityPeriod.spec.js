...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SignatureValidityPeriod();
  });
  ...
  describe('SignatureValidityPeriod', function() {
    it('should create an instance of SignatureValidityPeriod', function() {
      // uncomment below and update the code to test SignatureValidityPeriod
      //var instance = new AwsSigner.SignatureValidityPeriod();
      //expect(instance).to.be.a(AwsSigner.SignatureValidityPeriod);
    });
