...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningProfile();
  });
  ...
  describe('SigningProfile', function() {
    it('should create an instance of SigningProfile', function() {
      // uncomment below and update the code to test SigningProfile
      //var instance = new AwsSigner.SigningProfile();
      //expect(instance).to.be.a(AwsSigner.SigningProfile);
    });
