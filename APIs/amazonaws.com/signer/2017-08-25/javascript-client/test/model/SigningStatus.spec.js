...
(function(root, factory) {
  ...
  describe('SigningStatus', function() {
    it('should create an instance of SigningStatus', function() {
      // uncomment below and update the code to test SigningStatus
      //var instance = new AwsSigner.SigningStatus();
      //expect(instance).to.be.a(AwsSigner.SigningStatus);
    });
