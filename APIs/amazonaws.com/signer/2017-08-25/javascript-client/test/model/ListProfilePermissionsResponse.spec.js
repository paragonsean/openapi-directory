...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.ListProfilePermissionsResponse();
  });
  ...
  describe('ListProfilePermissionsResponse', function() {
    it('should create an instance of ListProfilePermissionsResponse', function() {
      // uncomment below and update the code to test ListProfilePermissionsResponse
      //var instance = new AwsSigner.ListProfilePermissionsResponse();
      //expect(instance).to.be.a(AwsSigner.ListProfilePermissionsResponse);
    });
    ...
    it('should have the property policySizeBytes (base name: "policySizeBytes")', function() {
      // uncomment below and update the code to test the property policySizeBytes
      //var instance = new AwsSigner.ListProfilePermissionsResponse();
      //expect(instance).to.be();
    });
