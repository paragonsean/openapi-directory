...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.StartSigningJobRequestSourceS3();
  });
  ...
  describe('StartSigningJobRequestSourceS3', function() {
    it('should create an instance of StartSigningJobRequestSourceS3', function() {
      // uncomment below and update the code to test StartSigningJobRequestSourceS3
      //var instance = new AwsSigner.StartSigningJobRequestSourceS3();
      //expect(instance).to.be.a(AwsSigner.StartSigningJobRequestSourceS3);
    });
