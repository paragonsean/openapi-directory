...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.AddProfilePermissionResponse();
  });
  ...
  describe('AddProfilePermissionResponse', function() {
    it('should create an instance of AddProfilePermissionResponse', function() {
      // uncomment below and update the code to test AddProfilePermissionResponse
      //var instance = new AwsSigner.AddProfilePermissionResponse();
      //expect(instance).to.be.a(AwsSigner.AddProfilePermissionResponse);
    });
