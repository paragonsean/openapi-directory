...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.GetSigningProfileResponseSigningMaterial();
  });
  ...
  describe('GetSigningProfileResponseSigningMaterial', function() {
    it('should create an instance of GetSigningProfileResponseSigningMaterial', function() {
      // uncomment below and update the code to test GetSigningProfileResponseSigningMaterial
      //var instance = new AwsSigner.GetSigningProfileResponseSigningMaterial();
      //expect(instance).to.be.a(AwsSigner.GetSigningProfileResponseSigningMaterial);
    });
