...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.RemoveProfilePermissionResponse();
  });
  ...
  describe('RemoveProfilePermissionResponse', function() {
    it('should create an instance of RemoveProfilePermissionResponse', function() {
      // uncomment below and update the code to test RemoveProfilePermissionResponse
      //var instance = new AwsSigner.RemoveProfilePermissionResponse();
      //expect(instance).to.be.a(AwsSigner.RemoveProfilePermissionResponse);
    });
