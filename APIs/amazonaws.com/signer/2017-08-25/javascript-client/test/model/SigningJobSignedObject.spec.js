...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningJobSignedObject();
  });
  ...
  describe('SigningJobSignedObject', function() {
    it('should create an instance of SigningJobSignedObject', function() {
      // uncomment below and update the code to test SigningJobSignedObject
      //var instance = new AwsSigner.SigningJobSignedObject();
      //expect(instance).to.be.a(AwsSigner.SigningJobSignedObject);
    });
