...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.DescribeSigningJobResponseOverrides();
  });
  ...
  describe('DescribeSigningJobResponseOverrides', function() {
    it('should create an instance of DescribeSigningJobResponseOverrides', function() {
      // uncomment below and update the code to test DescribeSigningJobResponseOverrides
      //var instance = new AwsSigner.DescribeSigningJobResponseOverrides();
      //expect(instance).to.be.a(AwsSigner.DescribeSigningJobResponseOverrides);
    });
