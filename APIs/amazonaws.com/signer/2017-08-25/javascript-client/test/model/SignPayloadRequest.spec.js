...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SignPayloadRequest();
  });
  ...
  describe('SignPayloadRequest', function() {
    it('should create an instance of SignPayloadRequest', function() {
      // uncomment below and update the code to test SignPayloadRequest
      //var instance = new AwsSigner.SignPayloadRequest();
      //expect(instance).to.be.a(AwsSigner.SignPayloadRequest);
    });
