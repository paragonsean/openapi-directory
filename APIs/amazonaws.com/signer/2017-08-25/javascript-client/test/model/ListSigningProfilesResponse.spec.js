...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.ListSigningProfilesResponse();
  });
  ...
  describe('ListSigningProfilesResponse', function() {
    it('should create an instance of ListSigningProfilesResponse', function() {
      // uncomment below and update the code to test ListSigningProfilesResponse
      //var instance = new AwsSigner.ListSigningProfilesResponse();
      //expect(instance).to.be.a(AwsSigner.ListSigningProfilesResponse);
    });
