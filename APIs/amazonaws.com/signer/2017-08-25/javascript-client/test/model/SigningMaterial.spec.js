...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.SigningMaterial();
  });
  ...
  describe('SigningMaterial', function() {
    it('should create an instance of SigningMaterial', function() {
      // uncomment below and update the code to test SigningMaterial
      //var instance = new AwsSigner.SigningMaterial();
      //expect(instance).to.be.a(AwsSigner.SigningMaterial);
    });
