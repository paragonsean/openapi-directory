...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.PutSigningProfileRequestSignatureValidityPeriod();
  });
  ...
  describe('PutSigningProfileRequestSignatureValidityPeriod', function() {
    it('should create an instance of PutSigningProfileRequestSignatureValidityPeriod', function() {
      // uncomment below and update the code to test PutSigningProfileRequestSignatureValidityPeriod
      //var instance = new AwsSigner.PutSigningProfileRequestSignatureValidityPeriod();
      //expect(instance).to.be.a(AwsSigner.PutSigningProfileRequestSignatureValidityPeriod);
    });
