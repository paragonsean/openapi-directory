...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSigner.GetSigningProfileResponse();
  });
  ...
  describe('GetSigningProfileResponse', function() {
    it('should create an instance of GetSigningProfileResponse', function() {
      // uncomment below and update the code to test GetSigningProfileResponse
      //var instance = new AwsSigner.GetSigningProfileResponse();
      //expect(instance).to.be.a(AwsSigner.GetSigningProfileResponse);
    });
    ...
    it('should have the property signatureValidityPeriod (base name: "signatureValidityPeriod")', function() {
      // uncomment below and update the code to test the property signatureValidityPeriod
      //var instance = new AwsSigner.GetSigningProfileResponse();
      //expect(instance).to.be();
    });
