...
/**
 * Gets or Sets ValidityType
 */
@JsonAdapter(ValidityType.Adapter.class)
public enum ValidityType {
  ...
  public static ValidityType fromValue(String value) {
    for (ValidityType b : ValidityType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ValidityType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ValidityType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ValidityType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ValidityType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ValidityType.fromValue(value);
  }
}
