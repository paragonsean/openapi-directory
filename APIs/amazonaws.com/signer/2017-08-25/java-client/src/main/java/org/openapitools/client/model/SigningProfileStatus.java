...
/**
 * Gets or Sets SigningProfileStatus
 */
@JsonAdapter(SigningProfileStatus.Adapter.class)
public enum SigningProfileStatus {
  ...
  SigningProfileStatus(String value) {
    this.value = value;
  }
  ...
  public static SigningProfileStatus fromValue(String value) {
    for (SigningProfileStatus b : SigningProfileStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<SigningProfileStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final SigningProfileStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SigningProfileStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SigningProfileStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SigningProfileStatus.fromValue(value);
  }
}
