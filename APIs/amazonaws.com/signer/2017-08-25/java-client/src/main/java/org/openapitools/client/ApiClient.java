...
public class ApiClient {
    ...
    private String basePath = "http://signer.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://signer.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://signer.{region}.amazonaws.com",
      "The signer multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://signer.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://signer.{region}.amazonaws.com.cn",
      "The signer endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-08-25/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://signer.us-east-1.amazonaws.com
