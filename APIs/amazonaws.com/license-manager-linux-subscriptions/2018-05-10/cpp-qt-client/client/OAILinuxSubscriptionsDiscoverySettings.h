...
/*
 * OAILinuxSubscriptionsDiscoverySettings.h
 *
 * Lists the settings defined for discovering Linux subscriptions.
 */

#ifndef OAILinuxSubscriptionsDiscoverySettings_H
#define OAILinuxSubscriptionsDiscoverySettings_H
...
class OAILinuxSubscriptionsDiscoverySettings : public OAIObject {
public:
    OAILinuxSubscriptionsDiscoverySettings();
    OAILinuxSubscriptionsDiscoverySettings(QString json);
    ~OAILinuxSubscriptionsDiscoverySettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinuxSubscriptionsDiscoverySettings)

#endif // OAILinuxSubscriptionsDiscoverySettings_H
