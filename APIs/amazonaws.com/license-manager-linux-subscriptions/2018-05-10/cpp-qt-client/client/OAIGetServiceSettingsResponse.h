...
namespace OpenAPI {
class OAIGetServiceSettingsResponse_LinuxSubscriptionsDiscoverySettings;
...
public:
    ...
    OAIGetServiceSettingsResponse_LinuxSubscriptionsDiscoverySettings getLinuxSubscriptionsDiscoverySettings() const;
    void setLinuxSubscriptionsDiscoverySettings(const OAIGetServiceSettingsResponse_LinuxSubscriptionsDiscoverySettings &linux_subscriptions_discovery_settings);
...
private:
    ...
    OAIGetServiceSettingsResponse_LinuxSubscriptionsDiscoverySettings m_linux_subscriptions_discovery_settings;
