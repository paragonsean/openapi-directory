...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::getServiceSettingsSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::getServiceSettingsSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      apiInstance.getServiceSettings(x_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
