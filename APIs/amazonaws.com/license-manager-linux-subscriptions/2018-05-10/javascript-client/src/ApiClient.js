...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://license-manager-linux-subscriptions.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://license-manager-linux-subscriptions.us-east-1.amazonaws.com
         */
