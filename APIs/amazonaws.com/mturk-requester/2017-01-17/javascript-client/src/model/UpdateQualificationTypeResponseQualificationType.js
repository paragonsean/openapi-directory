...
/**
 * The UpdateQualificationTypeResponseQualificationType model module.
 * @module model/UpdateQualificationTypeResponseQualificationType
 * @version 2017-01-17
 */
class UpdateQualificationTypeResponseQualificationType {
    /**
     * Constructs a new <code>UpdateQualificationTypeResponseQualificationType</code>.
     * @alias module:model/UpdateQualificationTypeResponseQualificationType
     * @implements module:model/QualificationType
     */
    constructor() { 
        QualificationType.initialize(this);
        UpdateQualificationTypeResponseQualificationType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateQualificationTypeResponseQualificationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateQualificationTypeResponseQualificationType} obj Optional instance to populate.
     * @return {module:model/UpdateQualificationTypeResponseQualificationType} The populated <code>UpdateQualificationTypeResponseQualificationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateQualificationTypeResponseQualificationType();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateQualificationTypeResponseQualificationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateQualificationTypeResponseQualificationType</code>.
     */
 ...
 */
UpdateQualificationTypeResponseQualificationType.prototype['QualificationTypeId'] = undefined;

/**
 * @member {Date} CreationTime
 */
UpdateQualificationTypeResponseQualificationType.prototype['CreationTime'] = undefined;

/**
 * @member {String} Name
 */
UpdateQualificationTypeResponseQualificationType.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
UpdateQualificationTypeResponseQualificationType.prototype['Description'] = undefined;

/**
 * @member {String} Keywords
 */
UpdateQualificationTypeResponseQualificationType.prototype['Keywords'] = undefined;

/**
 * @member {module:model/QualificationTypeStatus} QualificationTypeStatus
 */
UpdateQualificationTypeResponseQualificationType.prototype['QualificationTypeStatus'] = undefined;

/**
 * @member {String} Test
 */
UpdateQualificationTypeResponseQualificationType.prototype['Test'] = undefined;

/**
 * @member {Number} TestDurationInSeconds
 */
UpdateQualificationTypeResponseQualificationType.prototype['TestDurationInSeconds'] = undefined;

/**
 * @member {String} AnswerKey
 */
UpdateQualificationTypeResponseQualificationType.prototype['AnswerKey'] = undefined;

/**
 * @member {Number} RetryDelayInSeconds
 */
UpdateQualificationTypeResponseQualificationType.prototype['RetryDelayInSeconds'] = undefined;

/**
 * @member {Boolean} IsRequestable
 */
UpdateQualificationTypeResponseQualificationType.prototype['IsRequestable'] = undefined;

/**
 * @member {Boolean} AutoGranted
 */
UpdateQualificationTypeResponseQualificationType.prototype['AutoGranted'] = undefined;

/**
 * @member {Number} AutoGrantedValue
 */
UpdateQualificationTypeResponseQualificationType.prototype['AutoGrantedValue'] = undefined;
...
export default UpdateQualificationTypeResponseQualificationType;
