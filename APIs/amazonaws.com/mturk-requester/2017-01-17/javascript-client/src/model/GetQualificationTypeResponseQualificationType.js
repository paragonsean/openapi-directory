...
/**
 * The GetQualificationTypeResponseQualificationType model module.
 * @module model/GetQualificationTypeResponseQualificationType
 * @version 2017-01-17
 */
class GetQualificationTypeResponseQualificationType {
    /**
     * Constructs a new <code>GetQualificationTypeResponseQualificationType</code>.
     * @alias module:model/GetQualificationTypeResponseQualificationType
     * @implements module:model/QualificationType
     */
    constructor() { 
        QualificationType.initialize(this);
        GetQualificationTypeResponseQualificationType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetQualificationTypeResponseQualificationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetQualificationTypeResponseQualificationType} obj Optional instance to populate.
     * @return {module:model/GetQualificationTypeResponseQualificationType} The populated <code>GetQualificationTypeResponseQualificationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetQualificationTypeResponseQualificationType();
    ...
    /**
     * Validates the JSON data with respect to <code>GetQualificationTypeResponseQualificationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetQualificationTypeResponseQualificationType</code>.
     */
 ...
 */
GetQualificationTypeResponseQualificationType.prototype['QualificationTypeId'] = undefined;

/**
 * @member {Date} CreationTime
 */
GetQualificationTypeResponseQualificationType.prototype['CreationTime'] = undefined;

/**
 * @member {String} Name
 */
GetQualificationTypeResponseQualificationType.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
GetQualificationTypeResponseQualificationType.prototype['Description'] = undefined;

/**
 * @member {String} Keywords
 */
GetQualificationTypeResponseQualificationType.prototype['Keywords'] = undefined;

/**
 * @member {module:model/QualificationTypeStatus} QualificationTypeStatus
 */
GetQualificationTypeResponseQualificationType.prototype['QualificationTypeStatus'] = undefined;

/**
 * @member {String} Test
 */
GetQualificationTypeResponseQualificationType.prototype['Test'] = undefined;

/**
 * @member {Number} TestDurationInSeconds
 */
GetQualificationTypeResponseQualificationType.prototype['TestDurationInSeconds'] = undefined;

/**
 * @member {String} AnswerKey
 */
GetQualificationTypeResponseQualificationType.prototype['AnswerKey'] = undefined;

/**
 * @member {Number} RetryDelayInSeconds
 */
GetQualificationTypeResponseQualificationType.prototype['RetryDelayInSeconds'] = undefined;

/**
 * @member {Boolean} IsRequestable
 */
GetQualificationTypeResponseQualificationType.prototype['IsRequestable'] = undefined;

/**
 * @member {Boolean} AutoGranted
 */
GetQualificationTypeResponseQualificationType.prototype['AutoGranted'] = undefined;

/**
 * @member {Number} AutoGrantedValue
 */
GetQualificationTypeResponseQualificationType.prototype['AutoGrantedValue'] = undefined;
...
export default GetQualificationTypeResponseQualificationType;
