...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMechanicalTurk.ListWorkerBlocksRequest();
  });
  ...
  describe('ListWorkerBlocksRequest', function() {
    it('should create an instance of ListWorkerBlocksRequest', function() {
      // uncomment below and update the code to test ListWorkerBlocksRequest
      //var instance = new AmazonMechanicalTurk.ListWorkerBlocksRequest();
      //expect(instance).to.be.a(AmazonMechanicalTurk.ListWorkerBlocksRequest);
    });
