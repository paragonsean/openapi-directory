...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMechanicalTurk.ListHITsForQualificationTypeResponse();
  });
  ...
  describe('ListHITsForQualificationTypeResponse', function() {
    it('should create an instance of ListHITsForQualificationTypeResponse', function() {
      // uncomment below and update the code to test ListHITsForQualificationTypeResponse
      //var instance = new AmazonMechanicalTurk.ListHITsForQualificationTypeResponse();
      //expect(instance).to.be.a(AmazonMechanicalTurk.ListHITsForQualificationTypeResponse);
    });
