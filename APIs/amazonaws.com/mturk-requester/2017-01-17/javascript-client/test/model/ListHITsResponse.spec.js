...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMechanicalTurk.ListHITsResponse();
  });
  ...
  describe('ListHITsResponse', function() {
    it('should create an instance of ListHITsResponse', function() {
      // uncomment below and update the code to test ListHITsResponse
      //var instance = new AmazonMechanicalTurk.ListHITsResponse();
      //expect(instance).to.be.a(AmazonMechanicalTurk.ListHITsResponse);
    });
