...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMechanicalTurk.ListHITsRequest();
  });
  ...
  describe('ListHITsRequest', function() {
    it('should create an instance of ListHITsRequest', function() {
      // uncomment below and update the code to test ListHITsRequest
      //var instance = new AmazonMechanicalTurk.ListHITsRequest();
      //expect(instance).to.be.a(AmazonMechanicalTurk.ListHITsRequest);
    });
