...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMechanicalTurk.ReviewPolicy();
  });
  ...
  describe('ReviewPolicy', function() {
    it('should create an instance of ReviewPolicy', function() {
      // uncomment below and update the code to test ReviewPolicy
      //var instance = new AmazonMechanicalTurk.ReviewPolicy();
      //expect(instance).to.be.a(AmazonMechanicalTurk.ReviewPolicy);
    });
