...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMechanicalTurk.GetAssignmentResponse();
  });
  ...
  describe('GetAssignmentResponse', function() {
    it('should create an instance of GetAssignmentResponse', function() {
      // uncomment below and update the code to test GetAssignmentResponse
      //var instance = new AmazonMechanicalTurk.GetAssignmentResponse();
      //expect(instance).to.be.a(AmazonMechanicalTurk.GetAssignmentResponse);
    });
