...
/*
 * OAIGetHITResponse_HIT.h
 *
 * 
 */

#ifndef OAIGetHITResponse_HIT_H
#define OAIGetHITResponse_HIT_H
...
class OAIGetHITResponse_HIT : public OAIObject {
public:
    OAIGetHITResponse_HIT();
    OAIGetHITResponse_HIT(QString json);
    ~OAIGetHITResponse_HIT() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetHITResponse_HIT)

#endif // OAIGetHITResponse_HIT_H
