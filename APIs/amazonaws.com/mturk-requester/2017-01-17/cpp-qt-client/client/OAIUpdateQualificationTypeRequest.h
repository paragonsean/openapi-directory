...
/*
 * OAIUpdateQualificationTypeRequest.h
 *
 * 
 */

#ifndef OAIUpdateQualificationTypeRequest_H
#define OAIUpdateQualificationTypeRequest_H
...
class OAIUpdateQualificationTypeRequest : public OAIObject {
public:
    OAIUpdateQualificationTypeRequest();
    OAIUpdateQualificationTypeRequest(QString json);
    ~OAIUpdateQualificationTypeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateQualificationTypeRequest)

#endif // OAIUpdateQualificationTypeRequest_H
