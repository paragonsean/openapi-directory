...
/*
 * OAIListHITsResponse.h
 *
 * 
 */

#ifndef OAIListHITsResponse_H
#define OAIListHITsResponse_H
...
class OAIListHITsResponse : public OAIObject {
public:
    OAIListHITsResponse();
    OAIListHITsResponse(QString json);
    ~OAIListHITsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHITsResponse)

#endif // OAIListHITsResponse_H
