...
/*
 * OAIQualificationType.h
 *
 *  The QualificationType data structure represents a Qualification type, a description of a property of a Worker that must match the requirements of a HIT for the Worker to be able to accept the HIT. The type also describes how a Worker can obtain a Qualification of that type, such as through a Qualification test. 
 */

#ifndef OAIQualificationType_H
#define OAIQualificationType_H
...
class OAIQualificationType : public OAIObject {
public:
    OAIQualificationType();
    OAIQualificationType(QString json);
    ~OAIQualificationType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQualificationType)

#endif // OAIQualificationType_H
