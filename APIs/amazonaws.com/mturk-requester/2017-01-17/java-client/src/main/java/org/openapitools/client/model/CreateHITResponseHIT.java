...
public class CreateHITResponseHIT {
  ...
  public CreateHITResponseHIT() {
  }

  public CreateHITResponseHIT hiTId(String hiTId) {
    this.hiTId = hiTId;
    return this;
  }
  ...
  public CreateHITResponseHIT hiTTypeId(String hiTTypeId) {
  ...
  public CreateHITResponseHIT hiTGroupId(String hiTGroupId) {
  ...
  public CreateHITResponseHIT hiTLayoutId(String hiTLayoutId) {
  ...
  public CreateHITResponseHIT creationTime(OffsetDateTime creationTime) {
  ...
  public CreateHITResponseHIT title(String title) {
    this.title = title;
    return this;
  }
  ...
  public CreateHITResponseHIT description(String description) {
  ...
  public CreateHITResponseHIT question(String question) {
  ...
  public CreateHITResponseHIT keywords(String keywords) {
  ...
  public CreateHITResponseHIT hiTStatus(HITStatus hiTStatus) {
  ...
  public CreateHITResponseHIT maxAssignments(Integer maxAssignments) {
  ...
  public CreateHITResponseHIT reward(String reward) {
    this.reward = reward;
    return this;
  }
  ...
  public CreateHITResponseHIT autoApprovalDelayInSeconds(Integer autoApprovalDelayInSeconds) {
  ...
  public CreateHITResponseHIT expiration(OffsetDateTime expiration) {
  ...
  public CreateHITResponseHIT assignmentDurationInSeconds(Integer assignmentDurationInSeconds) {
  ...
  public CreateHITResponseHIT requesterAnnotation(String requesterAnnotation) {
  ...
  public CreateHITResponseHIT qualificationRequirements(List qualificationRequirements) {
  ...
  public CreateHITResponseHIT hiTReviewStatus(HITReviewStatus hiTReviewStatus) {
  ...
  public CreateHITResponseHIT numberOfAssignmentsPending(Integer numberOfAssignmentsPending) {
  ...
  public CreateHITResponseHIT numberOfAssignmentsAvailable(Integer numberOfAssignmentsAvailable) {
  ...
  public CreateHITResponseHIT numberOfAssignmentsCompleted(Integer numberOfAssignmentsCompleted) {
  ...
  public boolean equals(Object o) {
    ...
    CreateHITResponseHIT createHITResponseHIT = (CreateHITResponseHIT) o;
    return Objects.equals(this.hiTId, createHITResponseHIT.hiTId) &&
        Objects.equals(this.hiTTypeId, createHITResponseHIT.hiTTypeId) &&
        Objects.equals(this.hiTGroupId, createHITResponseHIT.hiTGroupId) &&
        Objects.equals(this.hiTLayoutId, createHITResponseHIT.hiTLayoutId) &&
        Objects.equals(this.creationTime, createHITResponseHIT.creationTime) &&
        Objects.equals(this.title, createHITResponseHIT.title) &&
        Objects.equals(this.description, createHITResponseHIT.description) &&
        Objects.equals(this.question, createHITResponseHIT.question) &&
        Objects.equals(this.keywords, createHITResponseHIT.keywords) &&
        Objects.equals(this.hiTStatus, createHITResponseHIT.hiTStatus) &&
        Objects.equals(this.maxAssignments, createHITResponseHIT.maxAssignments) &&
        Objects.equals(this.reward, createHITResponseHIT.reward) &&
        Objects.equals(this.autoApprovalDelayInSeconds, createHITResponseHIT.autoApprovalDelayInSeconds) &&
        Objects.equals(this.expiration, createHITResponseHIT.expiration) &&
        Objects.equals(this.assignmentDurationInSeconds, createHITResponseHIT.assignmentDurationInSeconds) &&
        Objects.equals(this.requesterAnnotation, createHITResponseHIT.requesterAnnotation) &&
        Objects.equals(this.qualificationRequirements, createHITResponseHIT.qualificationRequirements) &&
        Objects.equals(this.hiTReviewStatus, createHITResponseHIT.hiTReviewStatus) &&
        Objects.equals(this.numberOfAssignmentsPending, createHITResponseHIT.numberOfAssignmentsPending) &&
        Objects.equals(this.numberOfAssignmentsAvailable, createHITResponseHIT.numberOfAssignmentsAvailable) &&
        Objects.equals(this.numberOfAssignmentsCompleted, createHITResponseHIT.numberOfAssignmentsCompleted);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateHITResponseHIT {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateHITResponseHIT
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateHITResponseHIT.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateHITResponseHIT is not found in the empty JSON string", CreateHITResponseHIT.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateHITResponseHIT.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateHITResponseHIT` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateHITResponseHIT.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateHITResponseHIT' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateHITResponseHIT> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateHITResponseHIT.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateHITResponseHIT>() {
           @Override
           public void write(JsonWriter out, CreateHITResponseHIT value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateHITResponseHIT read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateHITResponseHIT given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateHITResponseHIT
   * @throws IOException if the JSON string is invalid with respect to CreateHITResponseHIT
   */
  public static CreateHITResponseHIT fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateHITResponseHIT.class);
  }

  /**
   * Convert an instance of CreateHITResponseHIT to an JSON string
   *
   * @return JSON string
   */
