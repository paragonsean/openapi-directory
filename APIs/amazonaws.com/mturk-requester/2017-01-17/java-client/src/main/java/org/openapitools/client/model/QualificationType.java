...
public class QualificationType {
  ...
  public QualificationType qualificationTypeId(String qualificationTypeId) {
  ...
  public QualificationType creationTime(OffsetDateTime creationTime) {
  ...
  public QualificationType name(String name) {
    this.name = name;
    return this;
  }
  ...
  public QualificationType description(String description) {
  ...
  public QualificationType keywords(String keywords) {
  ...
  public QualificationType qualificationTypeStatus(QualificationTypeStatus qualificationTypeStatus) {
  ...
  public QualificationType test(String test) {
    this.test = test;
    return this;
  }
  ...
  public QualificationType testDurationInSeconds(Integer testDurationInSeconds) {
  ...
  public QualificationType answerKey(String answerKey) {
  ...
  public QualificationType retryDelayInSeconds(Integer retryDelayInSeconds) {
  ...
  public QualificationType isRequestable(Boolean isRequestable) {
  ...
  public QualificationType autoGranted(Boolean autoGranted) {
  ...
  public QualificationType autoGrantedValue(Integer autoGrantedValue) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.qualificationTypeId, qualificationType.qualificationTypeId) &&
        Objects.equals(this.creationTime, qualificationType.creationTime) &&
        Objects.equals(this.name, qualificationType.name) &&
        Objects.equals(this.description, qualificationType.description) &&
        Objects.equals(this.keywords, qualificationType.keywords) &&
        Objects.equals(this.qualificationTypeStatus, qualificationType.qualificationTypeStatus) &&
        Objects.equals(this.test, qualificationType.test) &&
        Objects.equals(this.testDurationInSeconds, qualificationType.testDurationInSeconds) &&
        Objects.equals(this.answerKey, qualificationType.answerKey) &&
        Objects.equals(this.retryDelayInSeconds, qualificationType.retryDelayInSeconds) &&
        Objects.equals(this.isRequestable, qualificationType.isRequestable) &&
        Objects.equals(this.autoGranted, qualificationType.autoGranted) &&
        Objects.equals(this.autoGrantedValue, qualificationType.autoGrantedValue);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to QualificationType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QualificationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QualificationType is not found in the empty JSON string", QualificationType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QualificationType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QualificationType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QualificationType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QualificationType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QualificationType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QualificationType.class));

       return (TypeAdapter<T>) new TypeAdapter<QualificationType>() {
           @Override
           public void write(JsonWriter out, QualificationType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QualificationType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QualificationType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QualificationType
   * @throws IOException if the JSON string is invalid with respect to QualificationType
   */
  public static QualificationType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QualificationType.class);
  }

  /**
   * Convert an instance of QualificationType to an JSON string
   *
   * @return JSON string
   */
