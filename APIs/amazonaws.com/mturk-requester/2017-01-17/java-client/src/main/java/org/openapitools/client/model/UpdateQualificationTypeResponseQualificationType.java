...
public class UpdateQualificationTypeResponseQualificationType {
  ...
  public UpdateQualificationTypeResponseQualificationType() {
  }

  public UpdateQualificationTypeResponseQualificationType qualificationTypeId(String qualificationTypeId) {
  ...
  public UpdateQualificationTypeResponseQualificationType creationTime(OffsetDateTime creationTime) {
  ...
  public UpdateQualificationTypeResponseQualificationType name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateQualificationTypeResponseQualificationType description(String description) {
  ...
  public UpdateQualificationTypeResponseQualificationType keywords(String keywords) {
  ...
  public UpdateQualificationTypeResponseQualificationType qualificationTypeStatus(QualificationTypeStatus qualificationTypeStatus) {
  ...
  public UpdateQualificationTypeResponseQualificationType test(String test) {
    this.test = test;
    return this;
  }
  ...
  public UpdateQualificationTypeResponseQualificationType testDurationInSeconds(Integer testDurationInSeconds) {
  ...
  public UpdateQualificationTypeResponseQualificationType answerKey(String answerKey) {
  ...
  public UpdateQualificationTypeResponseQualificationType retryDelayInSeconds(Integer retryDelayInSeconds) {
  ...
  public UpdateQualificationTypeResponseQualificationType isRequestable(Boolean isRequestable) {
  ...
  public UpdateQualificationTypeResponseQualificationType autoGranted(Boolean autoGranted) {
  ...
  public UpdateQualificationTypeResponseQualificationType autoGrantedValue(Integer autoGrantedValue) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateQualificationTypeResponseQualificationType updateQualificationTypeResponseQualificationType = (UpdateQualificationTypeResponseQualificationType) o;
    return Objects.equals(this.qualificationTypeId, updateQualificationTypeResponseQualificationType.qualificationTypeId) &&
        Objects.equals(this.creationTime, updateQualificationTypeResponseQualificationType.creationTime) &&
        Objects.equals(this.name, updateQualificationTypeResponseQualificationType.name) &&
        Objects.equals(this.description, updateQualificationTypeResponseQualificationType.description) &&
        Objects.equals(this.keywords, updateQualificationTypeResponseQualificationType.keywords) &&
        Objects.equals(this.qualificationTypeStatus, updateQualificationTypeResponseQualificationType.qualificationTypeStatus) &&
        Objects.equals(this.test, updateQualificationTypeResponseQualificationType.test) &&
        Objects.equals(this.testDurationInSeconds, updateQualificationTypeResponseQualificationType.testDurationInSeconds) &&
        Objects.equals(this.answerKey, updateQualificationTypeResponseQualificationType.answerKey) &&
        Objects.equals(this.retryDelayInSeconds, updateQualificationTypeResponseQualificationType.retryDelayInSeconds) &&
        Objects.equals(this.isRequestable, updateQualificationTypeResponseQualificationType.isRequestable) &&
        Objects.equals(this.autoGranted, updateQualificationTypeResponseQualificationType.autoGranted) &&
        Objects.equals(this.autoGrantedValue, updateQualificationTypeResponseQualificationType.autoGrantedValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateQualificationTypeResponseQualificationType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateQualificationTypeResponseQualificationType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateQualificationTypeResponseQualificationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateQualificationTypeResponseQualificationType is not found in the empty JSON string", UpdateQualificationTypeResponseQualificationType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateQualificationTypeResponseQualificationType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateQualificationTypeResponseQualificationType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateQualificationTypeResponseQualificationType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateQualificationTypeResponseQualificationType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateQualificationTypeResponseQualificationType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateQualificationTypeResponseQualificationType.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateQualificationTypeResponseQualificationType>() {
           @Override
           public void write(JsonWriter out, UpdateQualificationTypeResponseQualificationType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateQualificationTypeResponseQualificationType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateQualificationTypeResponseQualificationType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateQualificationTypeResponseQualificationType
   * @throws IOException if the JSON string is invalid with respect to UpdateQualificationTypeResponseQualificationType
   */
  public static UpdateQualificationTypeResponseQualificationType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateQualificationTypeResponseQualificationType.class);
  }

  /**
   * Convert an instance of UpdateQualificationTypeResponseQualificationType to an JSON string
   *
   * @return JSON string
   */
