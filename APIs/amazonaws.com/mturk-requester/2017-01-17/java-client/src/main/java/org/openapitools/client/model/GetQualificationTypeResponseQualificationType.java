...
public class GetQualificationTypeResponseQualificationType {
  ...
  public GetQualificationTypeResponseQualificationType() {
  }

  public GetQualificationTypeResponseQualificationType qualificationTypeId(String qualificationTypeId) {
  ...
  public GetQualificationTypeResponseQualificationType creationTime(OffsetDateTime creationTime) {
  ...
  public GetQualificationTypeResponseQualificationType name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetQualificationTypeResponseQualificationType description(String description) {
  ...
  public GetQualificationTypeResponseQualificationType keywords(String keywords) {
  ...
  public GetQualificationTypeResponseQualificationType qualificationTypeStatus(QualificationTypeStatus qualificationTypeStatus) {
  ...
  public GetQualificationTypeResponseQualificationType test(String test) {
    this.test = test;
    return this;
  }
  ...
  public GetQualificationTypeResponseQualificationType testDurationInSeconds(Integer testDurationInSeconds) {
  ...
  public GetQualificationTypeResponseQualificationType answerKey(String answerKey) {
  ...
  public GetQualificationTypeResponseQualificationType retryDelayInSeconds(Integer retryDelayInSeconds) {
  ...
  public GetQualificationTypeResponseQualificationType isRequestable(Boolean isRequestable) {
  ...
  public GetQualificationTypeResponseQualificationType autoGranted(Boolean autoGranted) {
  ...
  public GetQualificationTypeResponseQualificationType autoGrantedValue(Integer autoGrantedValue) {
  ...
  public boolean equals(Object o) {
    ...
    GetQualificationTypeResponseQualificationType getQualificationTypeResponseQualificationType = (GetQualificationTypeResponseQualificationType) o;
    return Objects.equals(this.qualificationTypeId, getQualificationTypeResponseQualificationType.qualificationTypeId) &&
        Objects.equals(this.creationTime, getQualificationTypeResponseQualificationType.creationTime) &&
        Objects.equals(this.name, getQualificationTypeResponseQualificationType.name) &&
        Objects.equals(this.description, getQualificationTypeResponseQualificationType.description) &&
        Objects.equals(this.keywords, getQualificationTypeResponseQualificationType.keywords) &&
        Objects.equals(this.qualificationTypeStatus, getQualificationTypeResponseQualificationType.qualificationTypeStatus) &&
        Objects.equals(this.test, getQualificationTypeResponseQualificationType.test) &&
        Objects.equals(this.testDurationInSeconds, getQualificationTypeResponseQualificationType.testDurationInSeconds) &&
        Objects.equals(this.answerKey, getQualificationTypeResponseQualificationType.answerKey) &&
        Objects.equals(this.retryDelayInSeconds, getQualificationTypeResponseQualificationType.retryDelayInSeconds) &&
        Objects.equals(this.isRequestable, getQualificationTypeResponseQualificationType.isRequestable) &&
        Objects.equals(this.autoGranted, getQualificationTypeResponseQualificationType.autoGranted) &&
        Objects.equals(this.autoGrantedValue, getQualificationTypeResponseQualificationType.autoGrantedValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetQualificationTypeResponseQualificationType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetQualificationTypeResponseQualificationType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetQualificationTypeResponseQualificationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetQualificationTypeResponseQualificationType is not found in the empty JSON string", GetQualificationTypeResponseQualificationType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetQualificationTypeResponseQualificationType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetQualificationTypeResponseQualificationType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetQualificationTypeResponseQualificationType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetQualificationTypeResponseQualificationType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetQualificationTypeResponseQualificationType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetQualificationTypeResponseQualificationType.class));

       return (TypeAdapter<T>) new TypeAdapter<GetQualificationTypeResponseQualificationType>() {
           @Override
           public void write(JsonWriter out, GetQualificationTypeResponseQualificationType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetQualificationTypeResponseQualificationType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetQualificationTypeResponseQualificationType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetQualificationTypeResponseQualificationType
   * @throws IOException if the JSON string is invalid with respect to GetQualificationTypeResponseQualificationType
   */
  public static GetQualificationTypeResponseQualificationType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetQualificationTypeResponseQualificationType.class);
  }

  /**
   * Convert an instance of GetQualificationTypeResponseQualificationType to an JSON string
   *
   * @return JSON string
   */
