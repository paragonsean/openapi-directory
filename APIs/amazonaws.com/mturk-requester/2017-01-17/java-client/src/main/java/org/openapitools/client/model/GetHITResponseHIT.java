...
public class GetHITResponseHIT {
  ...
  public GetHITResponseHIT() {
  }

  public GetHITResponseHIT hiTId(String hiTId) {
    this.hiTId = hiTId;
    return this;
  }
  ...
  public GetHITResponseHIT hiTTypeId(String hiTTypeId) {
  ...
  public GetHITResponseHIT hiTGroupId(String hiTGroupId) {
  ...
  public GetHITResponseHIT hiTLayoutId(String hiTLayoutId) {
  ...
  public GetHITResponseHIT creationTime(OffsetDateTime creationTime) {
  ...
  public GetHITResponseHIT title(String title) {
    this.title = title;
    return this;
  }
  ...
  public GetHITResponseHIT description(String description) {
  ...
  public GetHITResponseHIT question(String question) {
  ...
  public GetHITResponseHIT keywords(String keywords) {
  ...
  public GetHITResponseHIT hiTStatus(HITStatus hiTStatus) {
  ...
  public GetHITResponseHIT maxAssignments(Integer maxAssignments) {
  ...
  public GetHITResponseHIT reward(String reward) {
    this.reward = reward;
    return this;
  }
  ...
  public GetHITResponseHIT autoApprovalDelayInSeconds(Integer autoApprovalDelayInSeconds) {
  ...
  public GetHITResponseHIT expiration(OffsetDateTime expiration) {
  ...
  public GetHITResponseHIT assignmentDurationInSeconds(Integer assignmentDurationInSeconds) {
  ...
  public GetHITResponseHIT requesterAnnotation(String requesterAnnotation) {
  ...
  public GetHITResponseHIT qualificationRequirements(List qualificationRequirements) {
  ...
  public GetHITResponseHIT hiTReviewStatus(HITReviewStatus hiTReviewStatus) {
  ...
  public GetHITResponseHIT numberOfAssignmentsPending(Integer numberOfAssignmentsPending) {
  ...
  public GetHITResponseHIT numberOfAssignmentsAvailable(Integer numberOfAssignmentsAvailable) {
  ...
  public GetHITResponseHIT numberOfAssignmentsCompleted(Integer numberOfAssignmentsCompleted) {
  ...
  public boolean equals(Object o) {
    ...
    GetHITResponseHIT getHITResponseHIT = (GetHITResponseHIT) o;
    return Objects.equals(this.hiTId, getHITResponseHIT.hiTId) &&
        Objects.equals(this.hiTTypeId, getHITResponseHIT.hiTTypeId) &&
        Objects.equals(this.hiTGroupId, getHITResponseHIT.hiTGroupId) &&
        Objects.equals(this.hiTLayoutId, getHITResponseHIT.hiTLayoutId) &&
        Objects.equals(this.creationTime, getHITResponseHIT.creationTime) &&
        Objects.equals(this.title, getHITResponseHIT.title) &&
        Objects.equals(this.description, getHITResponseHIT.description) &&
        Objects.equals(this.question, getHITResponseHIT.question) &&
        Objects.equals(this.keywords, getHITResponseHIT.keywords) &&
        Objects.equals(this.hiTStatus, getHITResponseHIT.hiTStatus) &&
        Objects.equals(this.maxAssignments, getHITResponseHIT.maxAssignments) &&
        Objects.equals(this.reward, getHITResponseHIT.reward) &&
        Objects.equals(this.autoApprovalDelayInSeconds, getHITResponseHIT.autoApprovalDelayInSeconds) &&
        Objects.equals(this.expiration, getHITResponseHIT.expiration) &&
        Objects.equals(this.assignmentDurationInSeconds, getHITResponseHIT.assignmentDurationInSeconds) &&
        Objects.equals(this.requesterAnnotation, getHITResponseHIT.requesterAnnotation) &&
        Objects.equals(this.qualificationRequirements, getHITResponseHIT.qualificationRequirements) &&
        Objects.equals(this.hiTReviewStatus, getHITResponseHIT.hiTReviewStatus) &&
        Objects.equals(this.numberOfAssignmentsPending, getHITResponseHIT.numberOfAssignmentsPending) &&
        Objects.equals(this.numberOfAssignmentsAvailable, getHITResponseHIT.numberOfAssignmentsAvailable) &&
        Objects.equals(this.numberOfAssignmentsCompleted, getHITResponseHIT.numberOfAssignmentsCompleted);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetHITResponseHIT {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetHITResponseHIT
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetHITResponseHIT.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetHITResponseHIT is not found in the empty JSON string", GetHITResponseHIT.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetHITResponseHIT.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetHITResponseHIT` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetHITResponseHIT.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetHITResponseHIT' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetHITResponseHIT> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetHITResponseHIT.class));

       return (TypeAdapter<T>) new TypeAdapter<GetHITResponseHIT>() {
           @Override
           public void write(JsonWriter out, GetHITResponseHIT value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetHITResponseHIT read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetHITResponseHIT given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetHITResponseHIT
   * @throws IOException if the JSON string is invalid with respect to GetHITResponseHIT
   */
  public static GetHITResponseHIT fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetHITResponseHIT.class);
  }

  /**
   * Convert an instance of GetHITResponseHIT to an JSON string
   *
   * @return JSON string
   */
