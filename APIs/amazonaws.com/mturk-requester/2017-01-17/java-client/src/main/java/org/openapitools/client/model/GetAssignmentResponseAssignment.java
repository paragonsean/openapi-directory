...
public class GetAssignmentResponseAssignment {
  ...
  public GetAssignmentResponseAssignment() {
  }

  public GetAssignmentResponseAssignment assignmentId(String assignmentId) {
  ...
  public GetAssignmentResponseAssignment workerId(String workerId) {
  ...
  public GetAssignmentResponseAssignment hiTId(String hiTId) {
    this.hiTId = hiTId;
    return this;
  }
  ...
  public GetAssignmentResponseAssignment assignmentStatus(AssignmentStatus assignmentStatus) {
  ...
  public GetAssignmentResponseAssignment autoApprovalTime(OffsetDateTime autoApprovalTime) {
  ...
  public GetAssignmentResponseAssignment acceptTime(OffsetDateTime acceptTime) {
  ...
  public GetAssignmentResponseAssignment submitTime(OffsetDateTime submitTime) {
  ...
  public GetAssignmentResponseAssignment approvalTime(OffsetDateTime approvalTime) {
  ...
  public GetAssignmentResponseAssignment rejectionTime(OffsetDateTime rejectionTime) {
  ...
  public GetAssignmentResponseAssignment deadline(OffsetDateTime deadline) {
  ...
  public GetAssignmentResponseAssignment answer(String answer) {
    this.answer = answer;
    return this;
  }
  ...
  public GetAssignmentResponseAssignment requesterFeedback(String requesterFeedback) {
  ...
  public boolean equals(Object o) {
    ...
    GetAssignmentResponseAssignment getAssignmentResponseAssignment = (GetAssignmentResponseAssignment) o;
    return Objects.equals(this.assignmentId, getAssignmentResponseAssignment.assignmentId) &&
        Objects.equals(this.workerId, getAssignmentResponseAssignment.workerId) &&
        Objects.equals(this.hiTId, getAssignmentResponseAssignment.hiTId) &&
        Objects.equals(this.assignmentStatus, getAssignmentResponseAssignment.assignmentStatus) &&
        Objects.equals(this.autoApprovalTime, getAssignmentResponseAssignment.autoApprovalTime) &&
        Objects.equals(this.acceptTime, getAssignmentResponseAssignment.acceptTime) &&
        Objects.equals(this.submitTime, getAssignmentResponseAssignment.submitTime) &&
        Objects.equals(this.approvalTime, getAssignmentResponseAssignment.approvalTime) &&
        Objects.equals(this.rejectionTime, getAssignmentResponseAssignment.rejectionTime) &&
        Objects.equals(this.deadline, getAssignmentResponseAssignment.deadline) &&
        Objects.equals(this.answer, getAssignmentResponseAssignment.answer) &&
        Objects.equals(this.requesterFeedback, getAssignmentResponseAssignment.requesterFeedback);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAssignmentResponseAssignment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAssignmentResponseAssignment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAssignmentResponseAssignment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAssignmentResponseAssignment is not found in the empty JSON string", GetAssignmentResponseAssignment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAssignmentResponseAssignment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAssignmentResponseAssignment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAssignmentResponseAssignment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAssignmentResponseAssignment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAssignmentResponseAssignment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAssignmentResponseAssignment.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAssignmentResponseAssignment>() {
           @Override
           public void write(JsonWriter out, GetAssignmentResponseAssignment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAssignmentResponseAssignment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAssignmentResponseAssignment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAssignmentResponseAssignment
   * @throws IOException if the JSON string is invalid with respect to GetAssignmentResponseAssignment
   */
  public static GetAssignmentResponseAssignment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAssignmentResponseAssignment.class);
  }

  /**
   * Convert an instance of GetAssignmentResponseAssignment to an JSON string
   *
   * @return JSON string
   */
