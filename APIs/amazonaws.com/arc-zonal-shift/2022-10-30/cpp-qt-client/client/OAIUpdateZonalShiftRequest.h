...
/*
 * OAIUpdateZonalShiftRequest.h
 *
 * 
 */

#ifndef OAIUpdateZonalShiftRequest_H
#define OAIUpdateZonalShiftRequest_H
...
class OAIUpdateZonalShiftRequest : public OAIObject {
public:
    OAIUpdateZonalShiftRequest();
    OAIUpdateZonalShiftRequest(QString json);
    ~OAIUpdateZonalShiftRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateZonalShiftRequest)

#endif // OAIUpdateZonalShiftRequest_H
