...
#ifndef OAIZonalShift_H
#define OAIZonalShift_H
...
class OAIZonalShift : public OAIObject {
public:
    OAIZonalShift();
    OAIZonalShift(QString json);
    ~OAIZonalShift() override;
    ...
    OAIZonalShiftStatus getStatus() const;
    void setStatus(const OAIZonalShiftStatus &status);
...
Q_DECLARE_METATYPE(OpenAPI::OAIZonalShift)

#endif // OAIZonalShift_H
