...
OAIZonalShift::OAIZonalShift(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIZonalShift::OAIZonalShift() {
    this->initializeModel();
}

OAIZonalShift::~OAIZonalShift() {}

void OAIZonalShift::initializeModel() {
...
void OAIZonalShift::fromJson(QString jsonString) {
...
void OAIZonalShift::fromJsonObject(QJsonObject json) {
...
QString OAIZonalShift::asJson() const {
...
QJsonObject OAIZonalShift::asJsonObject() const {
    QJsonObject obj;
...
QString OAIZonalShift::getAwayFrom() const {
    return m_away_from;
}
void OAIZonalShift::setAwayFrom(const QString &away_from) {
    m_away_from = away_from;
    m_away_from_isSet = true;
}

bool OAIZonalShift::is_away_from_Set() const{
    return m_away_from_isSet;
}

bool OAIZonalShift::is_away_from_Valid() const{
    return m_away_from_isValid;
}

QString OAIZonalShift::getComment() const {
    return m_comment;
}
void OAIZonalShift::setComment(const QString &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIZonalShift::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIZonalShift::is_comment_Valid() const{
    return m_comment_isValid;
}

QDateTime OAIZonalShift::getExpiryTime() const {
    return m_expiry_time;
}
void OAIZonalShift::setExpiryTime(const QDateTime &expiry_time) {
    m_expiry_time = expiry_time;
    m_expiry_time_isSet = true;
}

bool OAIZonalShift::is_expiry_time_Set() const{
    return m_expiry_time_isSet;
}

bool OAIZonalShift::is_expiry_time_Valid() const{
    return m_expiry_time_isValid;
}

QString OAIZonalShift::getResourceIdentifier() const {
    return m_resource_identifier;
}
void OAIZonalShift::setResourceIdentifier(const QString &resource_identifier) {
    m_resource_identifier = resource_identifier;
    m_resource_identifier_isSet = true;
}

bool OAIZonalShift::is_resource_identifier_Set() const{
    return m_resource_identifier_isSet;
}

bool OAIZonalShift::is_resource_identifier_Valid() const{
    return m_resource_identifier_isValid;
}

QDateTime OAIZonalShift::getStartTime() const {
    return m_start_time;
}
void OAIZonalShift::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIZonalShift::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIZonalShift::is_start_time_Valid() const{
    return m_start_time_isValid;
}

OAIZonalShiftStatus OAIZonalShift::getStatus() const {
    return m_status;
}
void OAIZonalShift::setStatus(const OAIZonalShiftStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIZonalShift::is_status_Set() const{
    return m_status_isSet;
}

bool OAIZonalShift::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIZonalShift::getZonalShiftId() const {
    return m_zonal_shift_id;
}
void OAIZonalShift::setZonalShiftId(const QString &zonal_shift_id) {
    m_zonal_shift_id = zonal_shift_id;
    m_zonal_shift_id_isSet = true;
}

bool OAIZonalShift::is_zonal_shift_id_Set() const{
    return m_zonal_shift_id_isSet;
}

bool OAIZonalShift::is_zonal_shift_id_Valid() const{
    return m_zonal_shift_id_isValid;
}

bool OAIZonalShift::isSet() const {
...
bool OAIZonalShift::isValid() const {
