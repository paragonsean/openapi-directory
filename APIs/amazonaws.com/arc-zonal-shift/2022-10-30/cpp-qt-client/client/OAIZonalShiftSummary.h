...
#ifndef OAIZonalShiftSummary_H
#define OAIZonalShiftSummary_H
...
class OAIZonalShiftSummary : public OAIObject {
public:
    OAIZonalShiftSummary();
    OAIZonalShiftSummary(QString json);
    ~OAIZonalShiftSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIZonalShiftSummary)

#endif // OAIZonalShiftSummary_H
