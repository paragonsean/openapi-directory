...
OAIAppliedStatus::OAIAppliedStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAppliedStatus::OAIAppliedStatus() {
    this->initializeModel();
}

OAIAppliedStatus::~OAIAppliedStatus() {}

void OAIAppliedStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAppliedStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAppliedStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("APPLIED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAppliedStatus::APPLIED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NOT_APPLIED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAppliedStatus::NOT_APPLIED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAppliedStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAppliedStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAppliedStatus::APPLIED:
            val = "APPLIED";
            break;
        case eOAIAppliedStatus::NOT_APPLIED:
            val = "NOT_APPLIED";
            break;
        default:
            break;
...
QJsonValue OAIAppliedStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAppliedStatus::eOAIAppliedStatus OAIAppliedStatus::getValue() const {
    return m_value;
}

void OAIAppliedStatus::setValue(const OAIAppliedStatus::eOAIAppliedStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAppliedStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIAppliedStatus::isValid() const {
