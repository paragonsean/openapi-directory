...
OAIListManagedResourcesResponse::OAIListManagedResourcesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListManagedResourcesResponse::OAIListManagedResourcesResponse() {
    this->initializeModel();
}

OAIListManagedResourcesResponse::~OAIListManagedResourcesResponse() {}

void OAIListManagedResourcesResponse::initializeModel() {
...
void OAIListManagedResourcesResponse::fromJson(QString jsonString) {
...
void OAIListManagedResourcesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListManagedResourcesResponse::asJson() const {
...
QJsonObject OAIListManagedResourcesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_items.isSet()) {
...
QList OAIListManagedResourcesResponse::getItems() const {
    return m_items;
}
void OAIListManagedResourcesResponse::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIListManagedResourcesResponse::is_items_Set() const{
    return m_items_isSet;
}

bool OAIListManagedResourcesResponse::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIListManagedResourcesResponse::getNextToken() const {
    return m_next_token;
}
void OAIListManagedResourcesResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListManagedResourcesResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListManagedResourcesResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListManagedResourcesResponse::isSet() const {
...
bool OAIListManagedResourcesResponse::isValid() const {
