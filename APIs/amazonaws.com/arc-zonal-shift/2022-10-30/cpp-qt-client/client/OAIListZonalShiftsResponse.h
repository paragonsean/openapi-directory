...
/*
 * OAIListZonalShiftsResponse.h
 *
 * 
 */

#ifndef OAIListZonalShiftsResponse_H
#define OAIListZonalShiftsResponse_H
...
class OAIListZonalShiftsResponse : public OAIObject {
public:
    OAIListZonalShiftsResponse();
    OAIListZonalShiftsResponse(QString json);
    ~OAIListZonalShiftsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListZonalShiftsResponse)

#endif // OAIListZonalShiftsResponse_H
