...
#ifndef OAIAppliedStatus_H
#define OAIAppliedStatus_H
...
class OAIAppliedStatus : public OAIEnum {
public:
    OAIAppliedStatus();
    OAIAppliedStatus(QString json);
    ~OAIAppliedStatus() override;
    ...
    enum class eOAIAppliedStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        APPLIED, 
        NOT_APPLIED
    };
    OAIAppliedStatus::eOAIAppliedStatus getValue() const;
    void setValue(const OAIAppliedStatus::eOAIAppliedStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppliedStatus)

#endif // OAIAppliedStatus_H
