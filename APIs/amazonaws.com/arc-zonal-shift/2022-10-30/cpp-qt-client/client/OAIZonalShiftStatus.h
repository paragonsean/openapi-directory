...
/*
 * OAIZonalShiftStatus.h
 *
 * 
 */

#ifndef OAIZonalShiftStatus_H
#define OAIZonalShiftStatus_H
...
class OAIZonalShiftStatus : public OAIEnum {
public:
    OAIZonalShiftStatus();
    OAIZonalShiftStatus(QString json);
    ~OAIZonalShiftStatus() override;
    ...
    enum class eOAIZonalShiftStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE, 
        EXPIRED, 
        CANCELED
    };
    OAIZonalShiftStatus::eOAIZonalShiftStatus getValue() const;
    void setValue(const OAIZonalShiftStatus::eOAIZonalShiftStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIZonalShiftStatus)

#endif // OAIZonalShiftStatus_H
