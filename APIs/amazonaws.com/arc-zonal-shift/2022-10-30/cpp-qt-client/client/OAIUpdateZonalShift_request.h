...
/*
 * OAIUpdateZonalShift_request.h
 *
 * 
 */

#ifndef OAIUpdateZonalShift_request_H
#define OAIUpdateZonalShift_request_H
...
class OAIUpdateZonalShift_request : public OAIObject {
public:
    OAIUpdateZonalShift_request();
    OAIUpdateZonalShift_request(QString json);
    ~OAIUpdateZonalShift_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateZonalShift_request)

#endif // OAIUpdateZonalShift_request_H
