...
#include "OAIZonalShiftInResource.h"
...
OAIZonalShiftInResource::OAIZonalShiftInResource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIZonalShiftInResource::OAIZonalShiftInResource() {
    this->initializeModel();
}

OAIZonalShiftInResource::~OAIZonalShiftInResource() {}

void OAIZonalShiftInResource::initializeModel() {

    m_applied_status_isSet = false;
    m_applied_status_isValid = false;
...
void OAIZonalShiftInResource::fromJson(QString jsonString) {
...
void OAIZonalShiftInResource::fromJsonObject(QJsonObject json) {

    m_applied_status_isValid = ::OpenAPI::fromJsonValue(m_applied_status, json[QString("appliedStatus")]);
    m_applied_status_isSet = !json[QString("appliedStatus")].isNull() && m_applied_status_isValid;
...
QString OAIZonalShiftInResource::asJson() const {
...
QJsonObject OAIZonalShiftInResource::asJsonObject() const {
    QJsonObject obj;
    if (m_applied_status.isSet()) {
        obj.insert(QString("appliedStatus"), ::OpenAPI::toJsonValue(m_applied_status));
    }
...
OAIAppliedStatus OAIZonalShiftInResource::getAppliedStatus() const {
    return m_applied_status;
}
void OAIZonalShiftInResource::setAppliedStatus(const OAIAppliedStatus &applied_status) {
    m_applied_status = applied_status;
    m_applied_status_isSet = true;
}

bool OAIZonalShiftInResource::is_applied_status_Set() const{
    return m_applied_status_isSet;
}

bool OAIZonalShiftInResource::is_applied_status_Valid() const{
    return m_applied_status_isValid;
}

QString OAIZonalShiftInResource::getAwayFrom() const {
    return m_away_from;
}
void OAIZonalShiftInResource::setAwayFrom(const QString &away_from) {
    m_away_from = away_from;
    m_away_from_isSet = true;
}

bool OAIZonalShiftInResource::is_away_from_Set() const{
    return m_away_from_isSet;
}

bool OAIZonalShiftInResource::is_away_from_Valid() const{
    return m_away_from_isValid;
}

QString OAIZonalShiftInResource::getComment() const {
    return m_comment;
}
void OAIZonalShiftInResource::setComment(const QString &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIZonalShiftInResource::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIZonalShiftInResource::is_comment_Valid() const{
    return m_comment_isValid;
}

QDateTime OAIZonalShiftInResource::getExpiryTime() const {
    return m_expiry_time;
}
void OAIZonalShiftInResource::setExpiryTime(const QDateTime &expiry_time) {
    m_expiry_time = expiry_time;
    m_expiry_time_isSet = true;
}

bool OAIZonalShiftInResource::is_expiry_time_Set() const{
    return m_expiry_time_isSet;
}

bool OAIZonalShiftInResource::is_expiry_time_Valid() const{
    return m_expiry_time_isValid;
}

QString OAIZonalShiftInResource::getResourceIdentifier() const {
    return m_resource_identifier;
}
void OAIZonalShiftInResource::setResourceIdentifier(const QString &resource_identifier) {
    m_resource_identifier = resource_identifier;
    m_resource_identifier_isSet = true;
}

bool OAIZonalShiftInResource::is_resource_identifier_Set() const{
    return m_resource_identifier_isSet;
}

bool OAIZonalShiftInResource::is_resource_identifier_Valid() const{
    return m_resource_identifier_isValid;
}

QDateTime OAIZonalShiftInResource::getStartTime() const {
    return m_start_time;
}
void OAIZonalShiftInResource::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIZonalShiftInResource::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIZonalShiftInResource::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QString OAIZonalShiftInResource::getZonalShiftId() const {
    return m_zonal_shift_id;
}
void OAIZonalShiftInResource::setZonalShiftId(const QString &zonal_shift_id) {
    m_zonal_shift_id = zonal_shift_id;
    m_zonal_shift_id_isSet = true;
}

bool OAIZonalShiftInResource::is_zonal_shift_id_Set() const{
    return m_zonal_shift_id_isSet;
}

bool OAIZonalShiftInResource::is_zonal_shift_id_Valid() const{
    return m_zonal_shift_id_isValid;
}

bool OAIZonalShiftInResource::isSet() const {
...
bool OAIZonalShiftInResource::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_applied_status_isValid && m_away_from_isValid && m_comment_isValid && m_expiry_time_isValid && m_resource_identifier_isValid && m_start_time_isValid && m_zonal_shift_id_isValid && true;
}
