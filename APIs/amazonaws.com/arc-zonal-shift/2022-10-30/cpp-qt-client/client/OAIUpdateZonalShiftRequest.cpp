...
#include "OAIUpdateZonalShiftRequest.h"
...
OAIUpdateZonalShiftRequest::OAIUpdateZonalShiftRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateZonalShiftRequest::OAIUpdateZonalShiftRequest() {
    this->initializeModel();
}

OAIUpdateZonalShiftRequest::~OAIUpdateZonalShiftRequest() {}

void OAIUpdateZonalShiftRequest::initializeModel() {
...
void OAIUpdateZonalShiftRequest::fromJson(QString jsonString) {
...
void OAIUpdateZonalShiftRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateZonalShiftRequest::asJson() const {
...
QJsonObject OAIUpdateZonalShiftRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_comment_isSet) {
...
QString OAIUpdateZonalShiftRequest::getComment() const {
    return m_comment;
}
void OAIUpdateZonalShiftRequest::setComment(const QString &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIUpdateZonalShiftRequest::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIUpdateZonalShiftRequest::is_comment_Valid() const{
    return m_comment_isValid;
}

QString OAIUpdateZonalShiftRequest::getExpiresIn() const {
    return m_expires_in;
}
void OAIUpdateZonalShiftRequest::setExpiresIn(const QString &expires_in) {
    m_expires_in = expires_in;
    m_expires_in_isSet = true;
}

bool OAIUpdateZonalShiftRequest::is_expires_in_Set() const{
    return m_expires_in_isSet;
}

bool OAIUpdateZonalShiftRequest::is_expires_in_Valid() const{
    return m_expires_in_isValid;
}

bool OAIUpdateZonalShiftRequest::isSet() const {
...
bool OAIUpdateZonalShiftRequest::isValid() const {
