...
/*
 * OAIStartZonalShift_request.h
 *
 * 
 */

#ifndef OAIStartZonalShift_request_H
#define OAIStartZonalShift_request_H
...
class OAIStartZonalShift_request : public OAIObject {
public:
    OAIStartZonalShift_request();
    OAIStartZonalShift_request(QString json);
    ~OAIStartZonalShift_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartZonalShift_request)

#endif // OAIStartZonalShift_request_H
