...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://arc-zonal-shift.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://arc-zonal-shift.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2022-10-30/Javascript'
        };
