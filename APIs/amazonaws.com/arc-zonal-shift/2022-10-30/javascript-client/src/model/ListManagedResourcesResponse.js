...
/**
 * The ListManagedResourcesResponse model module.
 * @module model/ListManagedResourcesResponse
 * @version 2022-10-30
 */
class ListManagedResourcesResponse {
    /**
     * Constructs a new <code>ListManagedResourcesResponse</code>.
     * @alias module:model/ListManagedResourcesResponse
     * @param items {Array} 
     */
    constructor(items) { 
        
        ListManagedResourcesResponse.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>ListManagedResourcesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListManagedResourcesResponse} obj Optional instance to populate.
     * @return {module:model/ListManagedResourcesResponse} The populated <code>ListManagedResourcesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListManagedResourcesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListManagedResourcesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListManagedResourcesResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListManagedResourcesResponse.RequiredProperties) {
...
ListManagedResourcesResponse.RequiredProperties = ["items"];

/**
 * @member {Array} items
 */
ListManagedResourcesResponse.prototype['items'] = undefined;

/**
 * @member {String} nextToken
 */
ListManagedResourcesResponse.prototype['nextToken'] = undefined;
...
export default ListManagedResourcesResponse;
