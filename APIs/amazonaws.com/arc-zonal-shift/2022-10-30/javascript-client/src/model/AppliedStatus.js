...
* @readonly
*/
export default class AppliedStatus {
    ...
    /**
    * Returns a <code>AppliedStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AppliedStatus} The enum <code>AppliedStatus</code> value.
    */
