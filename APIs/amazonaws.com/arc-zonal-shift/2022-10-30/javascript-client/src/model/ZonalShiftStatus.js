...
* @readonly
*/
export default class ZonalShiftStatus {
    ...
    /**
    * Returns a <code>ZonalShiftStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ZonalShiftStatus} The enum <code>ZonalShiftStatus</code> value.
    */
