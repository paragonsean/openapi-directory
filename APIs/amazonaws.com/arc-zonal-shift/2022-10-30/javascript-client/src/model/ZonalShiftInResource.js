...
/**
 * The ZonalShiftInResource model module.
 * @module model/ZonalShiftInResource
 * @version 2022-10-30
 */
class ZonalShiftInResource {
    /**
     * Constructs a new <code>ZonalShiftInResource</code>.
     * A complex structure that lists the zonal shifts for a managed resource and their statuses for the resource.
     * @alias module:model/ZonalShiftInResource
     * @param appliedStatus {module:model/AppliedStatus} 
     ...
     */
    constructor(appliedStatus, awayFrom, comment, expiryTime, resourceIdentifier, startTime, zonalShiftId) { 
        
        ZonalShiftInResource.initialize(this, appliedStatus, awayFrom, comment, expiryTime, resourceIdentifier, startTime, zonalShiftId);
    }
     ...
     */
    static initialize(obj, appliedStatus, awayFrom, comment, expiryTime, resourceIdentifier, startTime, zonalShiftId) { 
        obj['appliedStatus'] = appliedStatus;
    ...
    /**
     * Constructs a <code>ZonalShiftInResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ZonalShiftInResource} obj Optional instance to populate.
     * @return {module:model/ZonalShiftInResource} The populated <code>ZonalShiftInResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ZonalShiftInResource();

            if (data.hasOwnProperty('appliedStatus')) {
                obj['appliedStatus'] = ApiClient.convertToType(data['appliedStatus'], AppliedStatus);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ZonalShiftInResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ZonalShiftInResource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ZonalShiftInResource.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `appliedStatus`
        if (data['appliedStatus']) { // data not null
          AppliedStatus.validateJSON(data['appliedStatus']);
        }
...
ZonalShiftInResource.RequiredProperties = ["appliedStatus", "awayFrom", "comment", "expiryTime", "resourceIdentifier", "startTime", "zonalShiftId"];

/**
 * @member {module:model/AppliedStatus} appliedStatus
 */
ZonalShiftInResource.prototype['appliedStatus'] = undefined;

/**
 * @member {String} awayFrom
 */
ZonalShiftInResource.prototype['awayFrom'] = undefined;

/**
 * @member {String} comment
 */
ZonalShiftInResource.prototype['comment'] = undefined;

/**
 * @member {Date} expiryTime
 */
ZonalShiftInResource.prototype['expiryTime'] = undefined;

/**
 * @member {String} resourceIdentifier
 */
ZonalShiftInResource.prototype['resourceIdentifier'] = undefined;

/**
 * @member {Date} startTime
 */
ZonalShiftInResource.prototype['startTime'] = undefined;

/**
 * @member {String} zonalShiftId
 */
ZonalShiftInResource.prototype['zonalShiftId'] = undefined;
...
export default ZonalShiftInResource;
