...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsArcZonalShift.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('cancelZonalShift', function() {
      it('should call cancelZonalShift successfully', function(done) {
        //uncomment below and update the code to test cancelZonalShift
        //instance.cancelZonalShift(function(error) {
    ...
    describe('getManagedResource', function() {
      it('should call getManagedResource successfully', function(done) {
        //uncomment below and update the code to test getManagedResource
        //instance.getManagedResource(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listManagedResources', function() {
      it('should call listManagedResources successfully', function(done) {
        //uncomment below and update the code to test listManagedResources
        //instance.listManagedResources(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listZonalShifts', function() {
      it('should call listZonalShifts successfully', function(done) {
        //uncomment below and update the code to test listZonalShifts
        //instance.listZonalShifts(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('startZonalShift', function() {
      it('should call startZonalShift successfully', function(done) {
        //uncomment below and update the code to test startZonalShift
        //instance.startZonalShift(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateZonalShift', function() {
      it('should call updateZonalShift successfully', function(done) {
        //uncomment below and update the code to test updateZonalShift
        //instance.updateZonalShift(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
