...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsArcZonalShift.ZonalShiftSummary();
  });
  ...
  describe('ZonalShiftSummary', function() {
    it('should create an instance of ZonalShiftSummary', function() {
      // uncomment below and update the code to test ZonalShiftSummary
      //var instance = new AwsArcZonalShift.ZonalShiftSummary();
      //expect(instance).to.be.a(AwsArcZonalShift.ZonalShiftSummary);
    });
