...
(function(root, factory) {
  ...
  describe('AppliedStatus', function() {
    it('should create an instance of AppliedStatus', function() {
      // uncomment below and update the code to test AppliedStatus
      //var instance = new AwsArcZonalShift.AppliedStatus();
      //expect(instance).to.be.a(AwsArcZonalShift.AppliedStatus);
    });
