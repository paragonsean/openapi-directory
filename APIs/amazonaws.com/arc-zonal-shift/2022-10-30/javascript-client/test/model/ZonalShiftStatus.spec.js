...
(function(root, factory) {
  ...
  describe('ZonalShiftStatus', function() {
    it('should create an instance of ZonalShiftStatus', function() {
      // uncomment below and update the code to test ZonalShiftStatus
      //var instance = new AwsArcZonalShift.ZonalShiftStatus();
      //expect(instance).to.be.a(AwsArcZonalShift.ZonalShiftStatus);
    });
