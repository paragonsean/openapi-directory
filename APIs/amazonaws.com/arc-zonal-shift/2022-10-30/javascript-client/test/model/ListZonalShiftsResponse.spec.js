...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsArcZonalShift.ListZonalShiftsResponse();
  });
  ...
  describe('ListZonalShiftsResponse', function() {
    it('should create an instance of ListZonalShiftsResponse', function() {
      // uncomment below and update the code to test ListZonalShiftsResponse
      //var instance = new AwsArcZonalShift.ListZonalShiftsResponse();
      //expect(instance).to.be.a(AwsArcZonalShift.ListZonalShiftsResponse);
    });
