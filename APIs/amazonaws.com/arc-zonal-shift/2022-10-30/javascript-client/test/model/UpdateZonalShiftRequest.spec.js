...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsArcZonalShift.UpdateZonalShiftRequest();
  });
  ...
  describe('UpdateZonalShiftRequest', function() {
    it('should create an instance of UpdateZonalShiftRequest', function() {
      // uncomment below and update the code to test UpdateZonalShiftRequest
      //var instance = new AwsArcZonalShift.UpdateZonalShiftRequest();
      //expect(instance).to.be.a(AwsArcZonalShift.UpdateZonalShiftRequest);
    });
