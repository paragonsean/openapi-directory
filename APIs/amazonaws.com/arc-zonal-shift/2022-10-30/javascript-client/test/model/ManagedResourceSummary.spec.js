...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsArcZonalShift.ManagedResourceSummary();
  });
  ...
  describe('ManagedResourceSummary', function() {
    it('should create an instance of ManagedResourceSummary', function() {
      // uncomment below and update the code to test ManagedResourceSummary
      //var instance = new AwsArcZonalShift.ManagedResourceSummary();
      //expect(instance).to.be.a(AwsArcZonalShift.ManagedResourceSummary);
    });
