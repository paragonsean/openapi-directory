...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsArcZonalShift.GetManagedResourceResponse();
  });
  ...
  describe('GetManagedResourceResponse', function() {
    it('should create an instance of GetManagedResourceResponse', function() {
      // uncomment below and update the code to test GetManagedResourceResponse
      //var instance = new AwsArcZonalShift.GetManagedResourceResponse();
      //expect(instance).to.be.a(AwsArcZonalShift.GetManagedResourceResponse);
    });

    it('should have the property appliedWeights (base name: "appliedWeights")', function() {
      // uncomment below and update the code to test the property appliedWeights
      //var instance = new AwsArcZonalShift.GetManagedResourceResponse();
    ...
    it('should have the property zonalShifts (base name: "zonalShifts")', function() {
      // uncomment below and update the code to test the property zonalShifts
      //var instance = new AwsArcZonalShift.GetManagedResourceResponse();
      //expect(instance).to.be();
    });
