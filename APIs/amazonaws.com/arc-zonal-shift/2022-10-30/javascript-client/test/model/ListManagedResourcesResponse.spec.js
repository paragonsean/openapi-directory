...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsArcZonalShift.ListManagedResourcesResponse();
  });
  ...
  describe('ListManagedResourcesResponse', function() {
    it('should create an instance of ListManagedResourcesResponse', function() {
      // uncomment below and update the code to test ListManagedResourcesResponse
      //var instance = new AwsArcZonalShift.ListManagedResourcesResponse();
      //expect(instance).to.be.a(AwsArcZonalShift.ListManagedResourcesResponse);
    });
