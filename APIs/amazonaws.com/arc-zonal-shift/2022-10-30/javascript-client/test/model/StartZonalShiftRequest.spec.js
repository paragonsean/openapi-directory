...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsArcZonalShift.StartZonalShiftRequest();
  });
  ...
  describe('StartZonalShiftRequest', function() {
    it('should create an instance of StartZonalShiftRequest', function() {
      // uncomment below and update the code to test StartZonalShiftRequest
      //var instance = new AwsArcZonalShift.StartZonalShiftRequest();
      //expect(instance).to.be.a(AwsArcZonalShift.StartZonalShiftRequest);
    });
