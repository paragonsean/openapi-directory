...
public class ZonalShiftSummary {
  ...
  public ZonalShiftSummary awayFrom(String awayFrom) {
  ...
  public ZonalShiftSummary comment(String comment) {
  ...
  public ZonalShiftSummary expiryTime(OffsetDateTime expiryTime) {
  ...
  public ZonalShiftSummary resourceIdentifier(String resourceIdentifier) {
  ...
  public ZonalShiftSummary startTime(OffsetDateTime startTime) {
  ...
  public ZonalShiftSummary status(ZonalShiftStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ZonalShiftSummary zonalShiftId(String zonalShiftId) {
  ...
  public boolean equals(Object o) {
    ...
    ZonalShiftSummary zonalShiftSummary = (ZonalShiftSummary) o;
    return Objects.equals(this.awayFrom, zonalShiftSummary.awayFrom) &&
        Objects.equals(this.comment, zonalShiftSummary.comment) &&
        Objects.equals(this.expiryTime, zonalShiftSummary.expiryTime) &&
        Objects.equals(this.resourceIdentifier, zonalShiftSummary.resourceIdentifier) &&
        Objects.equals(this.startTime, zonalShiftSummary.startTime) &&
        Objects.equals(this.status, zonalShiftSummary.status) &&
        Objects.equals(this.zonalShiftId, zonalShiftSummary.zonalShiftId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ZonalShiftSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ZonalShiftSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ZonalShiftSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ZonalShiftSummary is not found in the empty JSON string", ZonalShiftSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ZonalShiftSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ZonalShiftSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ZonalShiftSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ZonalShiftSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ZonalShiftSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ZonalShiftSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ZonalShiftSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ZonalShiftSummary>() {
           @Override
           public void write(JsonWriter out, ZonalShiftSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ZonalShiftSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ZonalShiftSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ZonalShiftSummary
   * @throws IOException if the JSON string is invalid with respect to ZonalShiftSummary
   */
  public static ZonalShiftSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ZonalShiftSummary.class);
  }

  /**
   * Convert an instance of ZonalShiftSummary to an JSON string
   *
   * @return JSON string
   */
