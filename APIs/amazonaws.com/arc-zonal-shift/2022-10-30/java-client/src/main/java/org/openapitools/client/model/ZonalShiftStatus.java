...
/**
 * Gets or Sets ZonalShiftStatus
 */
@JsonAdapter(ZonalShiftStatus.Adapter.class)
public enum ZonalShiftStatus {
  ...
  public static ZonalShiftStatus fromValue(String value) {
    for (ZonalShiftStatus b : ZonalShiftStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ZonalShiftStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ZonalShiftStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ZonalShiftStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ZonalShiftStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ZonalShiftStatus.fromValue(value);
  }
}
