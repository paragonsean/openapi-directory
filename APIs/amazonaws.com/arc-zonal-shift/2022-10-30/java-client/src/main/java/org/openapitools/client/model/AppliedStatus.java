...
/**
 * Gets or Sets AppliedStatus
 */
@JsonAdapter(AppliedStatus.Adapter.class)
public enum AppliedStatus {
  ...
  public static AppliedStatus fromValue(String value) {
    for (AppliedStatus b : AppliedStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<AppliedStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AppliedStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AppliedStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AppliedStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AppliedStatus.fromValue(value);
  }
}
