...
public class FileCacheCreatingLustreConfiguration {
  ...
  public FileCacheCreatingLustreConfiguration() {
  }

  public FileCacheCreatingLustreConfiguration perUnitStorageThroughput(Integer perUnitStorageThroughput) {
  ...
  public FileCacheCreatingLustreConfiguration deploymentType(FileCacheLustreDeploymentType deploymentType) {
  ...
  public FileCacheCreatingLustreConfiguration mountName(String mountName) {
  ...
  public FileCacheCreatingLustreConfiguration weeklyMaintenanceStartTime(String weeklyMaintenanceStartTime) {
  ...
  public FileCacheCreatingLustreConfiguration metadataConfiguration(CreateFileCacheLustreConfigurationMetadataConfiguration metadataConfiguration) {
  ...
  public FileCacheCreatingLustreConfiguration logConfiguration(FileCacheLustreConfigurationLogConfiguration logConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    FileCacheCreatingLustreConfiguration fileCacheCreatingLustreConfiguration = (FileCacheCreatingLustreConfiguration) o;
    return Objects.equals(this.perUnitStorageThroughput, fileCacheCreatingLustreConfiguration.perUnitStorageThroughput) &&
        Objects.equals(this.deploymentType, fileCacheCreatingLustreConfiguration.deploymentType) &&
        Objects.equals(this.mountName, fileCacheCreatingLustreConfiguration.mountName) &&
        Objects.equals(this.weeklyMaintenanceStartTime, fileCacheCreatingLustreConfiguration.weeklyMaintenanceStartTime) &&
        Objects.equals(this.metadataConfiguration, fileCacheCreatingLustreConfiguration.metadataConfiguration) &&
        Objects.equals(this.logConfiguration, fileCacheCreatingLustreConfiguration.logConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileCacheCreatingLustreConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FileCacheCreatingLustreConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FileCacheCreatingLustreConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileCacheCreatingLustreConfiguration is not found in the empty JSON string", FileCacheCreatingLustreConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FileCacheCreatingLustreConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FileCacheCreatingLustreConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileCacheCreatingLustreConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileCacheCreatingLustreConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileCacheCreatingLustreConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileCacheCreatingLustreConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<FileCacheCreatingLustreConfiguration>() {
           @Override
           public void write(JsonWriter out, FileCacheCreatingLustreConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FileCacheCreatingLustreConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FileCacheCreatingLustreConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FileCacheCreatingLustreConfiguration
   * @throws IOException if the JSON string is invalid with respect to FileCacheCreatingLustreConfiguration
   */
  public static FileCacheCreatingLustreConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileCacheCreatingLustreConfiguration.class);
  }

  /**
   * Convert an instance of FileCacheCreatingLustreConfiguration to an JSON string
   *
   * @return JSON string
   */
