...
public class UpdateFileCacheResponseFileCache {
  ...
  public UpdateFileCacheResponseFileCache() {
  }

  public UpdateFileCacheResponseFileCache ownerId(String ownerId) {
  ...
  public UpdateFileCacheResponseFileCache creationTime(OffsetDateTime creationTime) {
  ...
  public UpdateFileCacheResponseFileCache fileCacheId(String fileCacheId) {
  ...
  public UpdateFileCacheResponseFileCache fileCacheType(FileCacheType fileCacheType) {
  ...
  public UpdateFileCacheResponseFileCache fileCacheTypeVersion(String fileCacheTypeVersion) {
  ...
  public UpdateFileCacheResponseFileCache lifecycle(FileCacheLifecycle lifecycle) {
  ...
  public UpdateFileCacheResponseFileCache failureDetails(FileCacheCreatingFailureDetails failureDetails) {
  ...
  public UpdateFileCacheResponseFileCache storageCapacity(Integer storageCapacity) {
  ...
  public UpdateFileCacheResponseFileCache vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public UpdateFileCacheResponseFileCache subnetIds(List<String> subnetIds) {
    this.subnetIds = subnetIds;
    return this;
  }

  public UpdateFileCacheResponseFileCache addSubnetIdsItem(String subnetIdsItem) {
  ...
  public UpdateFileCacheResponseFileCache networkInterfaceIds(List<String> networkInterfaceIds) {
    this.networkInterfaceIds = networkInterfaceIds;
    return this;
  }

  public UpdateFileCacheResponseFileCache addNetworkInterfaceIdsItem(String networkInterfaceIdsItem) {
  ...
  public UpdateFileCacheResponseFileCache dnSName(String dnSName) {
  ...
  public UpdateFileCacheResponseFileCache kmsKeyId(String kmsKeyId) {
  ...
  public UpdateFileCacheResponseFileCache resourceARN(String resourceARN) {
  ...
  public UpdateFileCacheResponseFileCache lustreConfiguration(FileCacheCreatingLustreConfiguration lustreConfiguration) {
  ...
  public UpdateFileCacheResponseFileCache dataRepositoryAssociationIds(List dataRepositoryAssociationIds) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFileCacheResponseFileCache updateFileCacheResponseFileCache = (UpdateFileCacheResponseFileCache) o;
    return Objects.equals(this.ownerId, updateFileCacheResponseFileCache.ownerId) &&
        Objects.equals(this.creationTime, updateFileCacheResponseFileCache.creationTime) &&
        Objects.equals(this.fileCacheId, updateFileCacheResponseFileCache.fileCacheId) &&
        Objects.equals(this.fileCacheType, updateFileCacheResponseFileCache.fileCacheType) &&
        Objects.equals(this.fileCacheTypeVersion, updateFileCacheResponseFileCache.fileCacheTypeVersion) &&
        Objects.equals(this.lifecycle, updateFileCacheResponseFileCache.lifecycle) &&
        Objects.equals(this.failureDetails, updateFileCacheResponseFileCache.failureDetails) &&
        Objects.equals(this.storageCapacity, updateFileCacheResponseFileCache.storageCapacity) &&
        Objects.equals(this.vpcId, updateFileCacheResponseFileCache.vpcId) &&
        Objects.equals(this.subnetIds, updateFileCacheResponseFileCache.subnetIds) &&
        Objects.equals(this.networkInterfaceIds, updateFileCacheResponseFileCache.networkInterfaceIds) &&
        Objects.equals(this.dnSName, updateFileCacheResponseFileCache.dnSName) &&
        Objects.equals(this.kmsKeyId, updateFileCacheResponseFileCache.kmsKeyId) &&
        Objects.equals(this.resourceARN, updateFileCacheResponseFileCache.resourceARN) &&
        Objects.equals(this.lustreConfiguration, updateFileCacheResponseFileCache.lustreConfiguration) &&
        Objects.equals(this.dataRepositoryAssociationIds, updateFileCacheResponseFileCache.dataRepositoryAssociationIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateFileCacheResponseFileCache {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFileCacheResponseFileCache
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFileCacheResponseFileCache.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFileCacheResponseFileCache is not found in the empty JSON string", UpdateFileCacheResponseFileCache.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFileCacheResponseFileCache.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFileCacheResponseFileCache` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFileCacheResponseFileCache.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFileCacheResponseFileCache' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFileCacheResponseFileCache> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFileCacheResponseFileCache.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFileCacheResponseFileCache>() {
           @Override
           public void write(JsonWriter out, UpdateFileCacheResponseFileCache value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFileCacheResponseFileCache read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFileCacheResponseFileCache given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFileCacheResponseFileCache
   * @throws IOException if the JSON string is invalid with respect to UpdateFileCacheResponseFileCache
   */
  public static UpdateFileCacheResponseFileCache fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFileCacheResponseFileCache.class);
  }

  /**
   * Convert an instance of UpdateFileCacheResponseFileCache to an JSON string
   *
   * @return JSON string
   */
