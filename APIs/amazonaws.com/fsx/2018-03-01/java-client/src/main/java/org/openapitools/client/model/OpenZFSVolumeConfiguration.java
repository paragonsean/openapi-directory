...
public class OpenZFSVolumeConfiguration {
  ...
  public OpenZFSVolumeConfiguration parentVolumeId(String parentVolumeId) {
  ...
  public OpenZFSVolumeConfiguration volumePath(String volumePath) {
  ...
  public OpenZFSVolumeConfiguration storageCapacityReservationGiB(Integer storageCapacityReservationGiB) {
  ...
  public OpenZFSVolumeConfiguration storageCapacityQuotaGiB(Integer storageCapacityQuotaGiB) {
  ...
  public OpenZFSVolumeConfiguration recordSizeKiB(Integer recordSizeKiB) {
  ...
  public OpenZFSVolumeConfiguration dataCompressionType(OpenZFSDataCompressionType dataCompressionType) {
  ...
  public OpenZFSVolumeConfiguration copyTagsToSnapshots(Boolean copyTagsToSnapshots) {
  ...
  public OpenZFSVolumeConfiguration originSnapshot(OpenZFSVolumeConfigurationOriginSnapshot originSnapshot) {
  ...
  public OpenZFSVolumeConfiguration readOnly(Boolean readOnly) {
  ...
  public OpenZFSVolumeConfiguration nfsExports(List nfsExports) {
  ...
  public OpenZFSVolumeConfiguration userAndGroupQuotas(List userAndGroupQuotas) {
  ...
  public OpenZFSVolumeConfiguration restoreToSnapshot(String restoreToSnapshot) {
  ...
  public OpenZFSVolumeConfiguration deleteIntermediateSnaphots(Boolean deleteIntermediateSnaphots) {
  ...
  public OpenZFSVolumeConfiguration deleteClonedVolumes(Boolean deleteClonedVolumes) {
  ...
  public boolean equals(Object o) {
    ...
    OpenZFSVolumeConfiguration openZFSVolumeConfiguration = (OpenZFSVolumeConfiguration) o;
    return Objects.equals(this.parentVolumeId, openZFSVolumeConfiguration.parentVolumeId) &&
        Objects.equals(this.volumePath, openZFSVolumeConfiguration.volumePath) &&
        Objects.equals(this.storageCapacityReservationGiB, openZFSVolumeConfiguration.storageCapacityReservationGiB) &&
        Objects.equals(this.storageCapacityQuotaGiB, openZFSVolumeConfiguration.storageCapacityQuotaGiB) &&
        Objects.equals(this.recordSizeKiB, openZFSVolumeConfiguration.recordSizeKiB) &&
        Objects.equals(this.dataCompressionType, openZFSVolumeConfiguration.dataCompressionType) &&
        Objects.equals(this.copyTagsToSnapshots, openZFSVolumeConfiguration.copyTagsToSnapshots) &&
        Objects.equals(this.originSnapshot, openZFSVolumeConfiguration.originSnapshot) &&
        Objects.equals(this.readOnly, openZFSVolumeConfiguration.readOnly) &&
        Objects.equals(this.nfsExports, openZFSVolumeConfiguration.nfsExports) &&
        Objects.equals(this.userAndGroupQuotas, openZFSVolumeConfiguration.userAndGroupQuotas) &&
        Objects.equals(this.restoreToSnapshot, openZFSVolumeConfiguration.restoreToSnapshot) &&
        Objects.equals(this.deleteIntermediateSnaphots, openZFSVolumeConfiguration.deleteIntermediateSnaphots) &&
        Objects.equals(this.deleteClonedVolumes, openZFSVolumeConfiguration.deleteClonedVolumes);
  }
  ...
  public String toString() {
    ...
    sb.append("class OpenZFSVolumeConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OpenZFSVolumeConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpenZFSVolumeConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpenZFSVolumeConfiguration is not found in the empty JSON string", OpenZFSVolumeConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OpenZFSVolumeConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OpenZFSVolumeConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpenZFSVolumeConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpenZFSVolumeConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpenZFSVolumeConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpenZFSVolumeConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<OpenZFSVolumeConfiguration>() {
           @Override
           public void write(JsonWriter out, OpenZFSVolumeConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OpenZFSVolumeConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OpenZFSVolumeConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OpenZFSVolumeConfiguration
   * @throws IOException if the JSON string is invalid with respect to OpenZFSVolumeConfiguration
   */
  public static OpenZFSVolumeConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpenZFSVolumeConfiguration.class);
  }

  /**
   * Convert an instance of OpenZFSVolumeConfiguration to an JSON string
   *
   * @return JSON string
   */
