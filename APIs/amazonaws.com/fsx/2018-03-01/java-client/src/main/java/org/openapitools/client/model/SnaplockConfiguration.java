...
public class SnaplockConfiguration {
  ...
  public SnaplockConfiguration() {
  }

  public SnaplockConfiguration auditLogVolume(Boolean auditLogVolume) {
  ...
  public SnaplockConfiguration autocommitPeriod(CreateSnaplockConfigurationAutocommitPeriod autocommitPeriod) {
  ...
  public SnaplockConfiguration privilegedDelete(PrivilegedDelete privilegedDelete) {
  ...
  public SnaplockConfiguration retentionPeriod(CreateSnaplockConfigurationRetentionPeriod retentionPeriod) {
  ...
  public SnaplockConfiguration snaplockType(SnaplockType snaplockType) {
  ...
  public SnaplockConfiguration volumeAppendModeEnabled(Boolean volumeAppendModeEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    SnaplockConfiguration snaplockConfiguration = (SnaplockConfiguration) o;
    return Objects.equals(this.auditLogVolume, snaplockConfiguration.auditLogVolume) &&
        Objects.equals(this.autocommitPeriod, snaplockConfiguration.autocommitPeriod) &&
        Objects.equals(this.privilegedDelete, snaplockConfiguration.privilegedDelete) &&
        Objects.equals(this.retentionPeriod, snaplockConfiguration.retentionPeriod) &&
        Objects.equals(this.snaplockType, snaplockConfiguration.snaplockType) &&
        Objects.equals(this.volumeAppendModeEnabled, snaplockConfiguration.volumeAppendModeEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnaplockConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SnaplockConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SnaplockConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnaplockConfiguration is not found in the empty JSON string", SnaplockConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SnaplockConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SnaplockConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnaplockConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnaplockConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnaplockConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnaplockConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<SnaplockConfiguration>() {
           @Override
           public void write(JsonWriter out, SnaplockConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SnaplockConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SnaplockConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SnaplockConfiguration
   * @throws IOException if the JSON string is invalid with respect to SnaplockConfiguration
   */
  public static SnaplockConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnaplockConfiguration.class);
  }

  /**
   * Convert an instance of SnaplockConfiguration to an JSON string
   *
   * @return JSON string
   */
