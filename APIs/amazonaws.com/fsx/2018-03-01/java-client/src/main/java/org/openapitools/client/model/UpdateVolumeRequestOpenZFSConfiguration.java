...
public class UpdateVolumeRequestOpenZFSConfiguration {
  ...
  public UpdateVolumeRequestOpenZFSConfiguration() {
  }

  public UpdateVolumeRequestOpenZFSConfiguration storageCapacityReservationGiB(Integer storageCapacityReservationGiB) {
  ...
  public UpdateVolumeRequestOpenZFSConfiguration storageCapacityQuotaGiB(Integer storageCapacityQuotaGiB) {
  ...
  public UpdateVolumeRequestOpenZFSConfiguration recordSizeKiB(Integer recordSizeKiB) {
  ...
  public UpdateVolumeRequestOpenZFSConfiguration dataCompressionType(OpenZFSDataCompressionType dataCompressionType) {
  ...
  public UpdateVolumeRequestOpenZFSConfiguration nfsExports(List nfsExports) {
  ...
  public UpdateVolumeRequestOpenZFSConfiguration userAndGroupQuotas(List userAndGroupQuotas) {
  ...
  public UpdateVolumeRequestOpenZFSConfiguration readOnly(Boolean readOnly) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateVolumeRequestOpenZFSConfiguration updateVolumeRequestOpenZFSConfiguration = (UpdateVolumeRequestOpenZFSConfiguration) o;
    return Objects.equals(this.storageCapacityReservationGiB, updateVolumeRequestOpenZFSConfiguration.storageCapacityReservationGiB) &&
        Objects.equals(this.storageCapacityQuotaGiB, updateVolumeRequestOpenZFSConfiguration.storageCapacityQuotaGiB) &&
        Objects.equals(this.recordSizeKiB, updateVolumeRequestOpenZFSConfiguration.recordSizeKiB) &&
        Objects.equals(this.dataCompressionType, updateVolumeRequestOpenZFSConfiguration.dataCompressionType) &&
        Objects.equals(this.nfsExports, updateVolumeRequestOpenZFSConfiguration.nfsExports) &&
        Objects.equals(this.userAndGroupQuotas, updateVolumeRequestOpenZFSConfiguration.userAndGroupQuotas) &&
        Objects.equals(this.readOnly, updateVolumeRequestOpenZFSConfiguration.readOnly);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateVolumeRequestOpenZFSConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateVolumeRequestOpenZFSConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateVolumeRequestOpenZFSConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateVolumeRequestOpenZFSConfiguration is not found in the empty JSON string", UpdateVolumeRequestOpenZFSConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateVolumeRequestOpenZFSConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateVolumeRequestOpenZFSConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateVolumeRequestOpenZFSConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateVolumeRequestOpenZFSConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateVolumeRequestOpenZFSConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateVolumeRequestOpenZFSConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateVolumeRequestOpenZFSConfiguration>() {
           @Override
           public void write(JsonWriter out, UpdateVolumeRequestOpenZFSConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateVolumeRequestOpenZFSConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateVolumeRequestOpenZFSConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateVolumeRequestOpenZFSConfiguration
   * @throws IOException if the JSON string is invalid with respect to UpdateVolumeRequestOpenZFSConfiguration
   */
  public static UpdateVolumeRequestOpenZFSConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateVolumeRequestOpenZFSConfiguration.class);
  }

  /**
   * Convert an instance of UpdateVolumeRequestOpenZFSConfiguration to an JSON string
   *
   * @return JSON string
   */
