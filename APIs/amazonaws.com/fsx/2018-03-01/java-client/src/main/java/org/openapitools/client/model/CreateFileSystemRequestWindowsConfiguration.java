...
public class CreateFileSystemRequestWindowsConfiguration {
  ...
  public CreateFileSystemRequestWindowsConfiguration() {
  }

  public CreateFileSystemRequestWindowsConfiguration activeDirectoryId(String activeDirectoryId) {
  ...
  public CreateFileSystemRequestWindowsConfiguration selfManagedActiveDirectoryConfiguration(SelfManagedActiveDirectoryConfiguration selfManagedActiveDirectoryConfiguration) {
  ...
  public CreateFileSystemRequestWindowsConfiguration deploymentType(WindowsDeploymentType deploymentType) {
  ...
  public CreateFileSystemRequestWindowsConfiguration preferredSubnetId(String preferredSubnetId) {
  ...
  public CreateFileSystemRequestWindowsConfiguration throughputCapacity(Integer throughputCapacity) {
  ...
  public CreateFileSystemRequestWindowsConfiguration weeklyMaintenanceStartTime(String weeklyMaintenanceStartTime) {
  ...
  public CreateFileSystemRequestWindowsConfiguration dailyAutomaticBackupStartTime(String dailyAutomaticBackupStartTime) {
  ...
  public CreateFileSystemRequestWindowsConfiguration automaticBackupRetentionDays(Integer automaticBackupRetentionDays) {
  ...
  public CreateFileSystemRequestWindowsConfiguration copyTagsToBackups(Boolean copyTagsToBackups) {
  ...
  public CreateFileSystemRequestWindowsConfiguration aliases(List aliases) {
  ...
  public CreateFileSystemRequestWindowsConfiguration auditLogConfiguration(CreateFileSystemWindowsConfigurationAuditLogConfiguration auditLogConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFileSystemRequestWindowsConfiguration createFileSystemRequestWindowsConfiguration = (CreateFileSystemRequestWindowsConfiguration) o;
    return Objects.equals(this.activeDirectoryId, createFileSystemRequestWindowsConfiguration.activeDirectoryId) &&
        Objects.equals(this.selfManagedActiveDirectoryConfiguration, createFileSystemRequestWindowsConfiguration.selfManagedActiveDirectoryConfiguration) &&
        Objects.equals(this.deploymentType, createFileSystemRequestWindowsConfiguration.deploymentType) &&
        Objects.equals(this.preferredSubnetId, createFileSystemRequestWindowsConfiguration.preferredSubnetId) &&
        Objects.equals(this.throughputCapacity, createFileSystemRequestWindowsConfiguration.throughputCapacity) &&
        Objects.equals(this.weeklyMaintenanceStartTime, createFileSystemRequestWindowsConfiguration.weeklyMaintenanceStartTime) &&
        Objects.equals(this.dailyAutomaticBackupStartTime, createFileSystemRequestWindowsConfiguration.dailyAutomaticBackupStartTime) &&
        Objects.equals(this.automaticBackupRetentionDays, createFileSystemRequestWindowsConfiguration.automaticBackupRetentionDays) &&
        Objects.equals(this.copyTagsToBackups, createFileSystemRequestWindowsConfiguration.copyTagsToBackups) &&
        Objects.equals(this.aliases, createFileSystemRequestWindowsConfiguration.aliases) &&
        Objects.equals(this.auditLogConfiguration, createFileSystemRequestWindowsConfiguration.auditLogConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFileSystemRequestWindowsConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFileSystemRequestWindowsConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFileSystemRequestWindowsConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFileSystemRequestWindowsConfiguration is not found in the empty JSON string", CreateFileSystemRequestWindowsConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFileSystemRequestWindowsConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFileSystemRequestWindowsConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateFileSystemRequestWindowsConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFileSystemRequestWindowsConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFileSystemRequestWindowsConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFileSystemRequestWindowsConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFileSystemRequestWindowsConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFileSystemRequestWindowsConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateFileSystemRequestWindowsConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFileSystemRequestWindowsConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFileSystemRequestWindowsConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFileSystemRequestWindowsConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateFileSystemRequestWindowsConfiguration
   */
  public static CreateFileSystemRequestWindowsConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFileSystemRequestWindowsConfiguration.class);
  }

  /**
   * Convert an instance of CreateFileSystemRequestWindowsConfiguration to an JSON string
   *
   * @return JSON string
   */
