...
public class CreateSnaplockConfiguration {
  ...
  public CreateSnaplockConfiguration() {
  }

  public CreateSnaplockConfiguration auditLogVolume(Boolean auditLogVolume) {
  ...
  public CreateSnaplockConfiguration autocommitPeriod(CreateSnaplockConfigurationAutocommitPeriod autocommitPeriod) {
  ...
  public CreateSnaplockConfiguration privilegedDelete(PrivilegedDelete privilegedDelete) {
  ...
  public CreateSnaplockConfiguration retentionPeriod(CreateSnaplockConfigurationRetentionPeriod retentionPeriod) {
  ...
  public CreateSnaplockConfiguration snaplockType(SnaplockType snaplockType) {
  ...
  public CreateSnaplockConfiguration volumeAppendModeEnabled(Boolean volumeAppendModeEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSnaplockConfiguration createSnaplockConfiguration = (CreateSnaplockConfiguration) o;
    return Objects.equals(this.auditLogVolume, createSnaplockConfiguration.auditLogVolume) &&
        Objects.equals(this.autocommitPeriod, createSnaplockConfiguration.autocommitPeriod) &&
        Objects.equals(this.privilegedDelete, createSnaplockConfiguration.privilegedDelete) &&
        Objects.equals(this.retentionPeriod, createSnaplockConfiguration.retentionPeriod) &&
        Objects.equals(this.snaplockType, createSnaplockConfiguration.snaplockType) &&
        Objects.equals(this.volumeAppendModeEnabled, createSnaplockConfiguration.volumeAppendModeEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSnaplockConfiguration {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("SnaplockType");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSnaplockConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSnaplockConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSnaplockConfiguration is not found in the empty JSON string", CreateSnaplockConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSnaplockConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSnaplockConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateSnaplockConfiguration.openapiRequiredFields) {
      ...
      // validate the required field `SnaplockType`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSnaplockConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSnaplockConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSnaplockConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSnaplockConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSnaplockConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateSnaplockConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSnaplockConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSnaplockConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSnaplockConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateSnaplockConfiguration
   */
  public static CreateSnaplockConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSnaplockConfiguration.class);
  }

  /**
   * Convert an instance of CreateSnaplockConfiguration to an JSON string
   *
   * @return JSON string
   */
