...
public class CreateVolumeRequestOntapConfiguration {
  ...
  public CreateVolumeRequestOntapConfiguration() {
  }

  public CreateVolumeRequestOntapConfiguration junctionPath(String junctionPath) {
  ...
  public CreateVolumeRequestOntapConfiguration securityStyle(SecurityStyle securityStyle) {
  ...
  public CreateVolumeRequestOntapConfiguration sizeInMegabytes(Integer sizeInMegabytes) {
  ...
  public CreateVolumeRequestOntapConfiguration storageEfficiencyEnabled(Boolean storageEfficiencyEnabled) {
  ...
  public CreateVolumeRequestOntapConfiguration storageVirtualMachineId(String storageVirtualMachineId) {
  ...
  public CreateVolumeRequestOntapConfiguration tieringPolicy(TieringPolicy tieringPolicy) {
  ...
  public CreateVolumeRequestOntapConfiguration ontapVolumeType(InputOntapVolumeType ontapVolumeType) {
  ...
  public CreateVolumeRequestOntapConfiguration snapshotPolicy(String snapshotPolicy) {
  ...
  public CreateVolumeRequestOntapConfiguration copyTagsToBackups(Boolean copyTagsToBackups) {
  ...
  public CreateVolumeRequestOntapConfiguration snaplockConfiguration(CreateOntapVolumeConfigurationSnaplockConfiguration snaplockConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    CreateVolumeRequestOntapConfiguration createVolumeRequestOntapConfiguration = (CreateVolumeRequestOntapConfiguration) o;
    return Objects.equals(this.junctionPath, createVolumeRequestOntapConfiguration.junctionPath) &&
        Objects.equals(this.securityStyle, createVolumeRequestOntapConfiguration.securityStyle) &&
        Objects.equals(this.sizeInMegabytes, createVolumeRequestOntapConfiguration.sizeInMegabytes) &&
        Objects.equals(this.storageEfficiencyEnabled, createVolumeRequestOntapConfiguration.storageEfficiencyEnabled) &&
        Objects.equals(this.storageVirtualMachineId, createVolumeRequestOntapConfiguration.storageVirtualMachineId) &&
        Objects.equals(this.tieringPolicy, createVolumeRequestOntapConfiguration.tieringPolicy) &&
        Objects.equals(this.ontapVolumeType, createVolumeRequestOntapConfiguration.ontapVolumeType) &&
        Objects.equals(this.snapshotPolicy, createVolumeRequestOntapConfiguration.snapshotPolicy) &&
        Objects.equals(this.copyTagsToBackups, createVolumeRequestOntapConfiguration.copyTagsToBackups) &&
        Objects.equals(this.snaplockConfiguration, createVolumeRequestOntapConfiguration.snaplockConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateVolumeRequestOntapConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateVolumeRequestOntapConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateVolumeRequestOntapConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateVolumeRequestOntapConfiguration is not found in the empty JSON string", CreateVolumeRequestOntapConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateVolumeRequestOntapConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateVolumeRequestOntapConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateVolumeRequestOntapConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateVolumeRequestOntapConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateVolumeRequestOntapConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateVolumeRequestOntapConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateVolumeRequestOntapConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateVolumeRequestOntapConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateVolumeRequestOntapConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateVolumeRequestOntapConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateVolumeRequestOntapConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateVolumeRequestOntapConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateVolumeRequestOntapConfiguration
   */
  public static CreateVolumeRequestOntapConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateVolumeRequestOntapConfiguration.class);
  }

  /**
   * Convert an instance of CreateVolumeRequestOntapConfiguration to an JSON string
   *
   * @return JSON string
   */
