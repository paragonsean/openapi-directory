...
public class CreateOntapVolumeConfiguration {
  ...
  public CreateOntapVolumeConfiguration junctionPath(String junctionPath) {
  ...
  public CreateOntapVolumeConfiguration securityStyle(SecurityStyle securityStyle) {
  ...
  public CreateOntapVolumeConfiguration sizeInMegabytes(Integer sizeInMegabytes) {
  ...
  public CreateOntapVolumeConfiguration storageEfficiencyEnabled(Boolean storageEfficiencyEnabled) {
  ...
  public CreateOntapVolumeConfiguration storageVirtualMachineId(String storageVirtualMachineId) {
  ...
  public CreateOntapVolumeConfiguration tieringPolicy(TieringPolicy tieringPolicy) {
  ...
  public CreateOntapVolumeConfiguration ontapVolumeType(InputOntapVolumeType ontapVolumeType) {
  ...
  public CreateOntapVolumeConfiguration snapshotPolicy(String snapshotPolicy) {
  ...
  public CreateOntapVolumeConfiguration copyTagsToBackups(Boolean copyTagsToBackups) {
  ...
  public CreateOntapVolumeConfiguration snaplockConfiguration(CreateOntapVolumeConfigurationSnaplockConfiguration snaplockConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    CreateOntapVolumeConfiguration createOntapVolumeConfiguration = (CreateOntapVolumeConfiguration) o;
    return Objects.equals(this.junctionPath, createOntapVolumeConfiguration.junctionPath) &&
        Objects.equals(this.securityStyle, createOntapVolumeConfiguration.securityStyle) &&
        Objects.equals(this.sizeInMegabytes, createOntapVolumeConfiguration.sizeInMegabytes) &&
        Objects.equals(this.storageEfficiencyEnabled, createOntapVolumeConfiguration.storageEfficiencyEnabled) &&
        Objects.equals(this.storageVirtualMachineId, createOntapVolumeConfiguration.storageVirtualMachineId) &&
        Objects.equals(this.tieringPolicy, createOntapVolumeConfiguration.tieringPolicy) &&
        Objects.equals(this.ontapVolumeType, createOntapVolumeConfiguration.ontapVolumeType) &&
        Objects.equals(this.snapshotPolicy, createOntapVolumeConfiguration.snapshotPolicy) &&
        Objects.equals(this.copyTagsToBackups, createOntapVolumeConfiguration.copyTagsToBackups) &&
        Objects.equals(this.snaplockConfiguration, createOntapVolumeConfiguration.snaplockConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateOntapVolumeConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateOntapVolumeConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateOntapVolumeConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOntapVolumeConfiguration is not found in the empty JSON string", CreateOntapVolumeConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOntapVolumeConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOntapVolumeConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateOntapVolumeConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOntapVolumeConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOntapVolumeConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOntapVolumeConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOntapVolumeConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOntapVolumeConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateOntapVolumeConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateOntapVolumeConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateOntapVolumeConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateOntapVolumeConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateOntapVolumeConfiguration
   */
  public static CreateOntapVolumeConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOntapVolumeConfiguration.class);
  }

  /**
   * Convert an instance of CreateOntapVolumeConfiguration to an JSON string
   *
   * @return JSON string
   */
