...
public class WindowsFileSystemConfiguration {
  ...
  public WindowsFileSystemConfiguration activeDirectoryId(String activeDirectoryId) {
  ...
  public WindowsFileSystemConfiguration selfManagedActiveDirectoryConfiguration(SelfManagedActiveDirectoryAttributes selfManagedActiveDirectoryConfiguration) {
  ...
  public WindowsFileSystemConfiguration deploymentType(WindowsDeploymentType deploymentType) {
  ...
  public WindowsFileSystemConfiguration remoteAdministrationEndpoint(String remoteAdministrationEndpoint) {
  ...
  public WindowsFileSystemConfiguration preferredSubnetId(String preferredSubnetId) {
  ...
  public WindowsFileSystemConfiguration preferredFileServerIp(String preferredFileServerIp) {
  ...
  public WindowsFileSystemConfiguration throughputCapacity(Integer throughputCapacity) {
  ...
  public WindowsFileSystemConfiguration maintenanceOperationsInProgress(List maintenanceOperationsInProgress) {
  ...
  public WindowsFileSystemConfiguration weeklyMaintenanceStartTime(String weeklyMaintenanceStartTime) {
  ...
  public WindowsFileSystemConfiguration dailyAutomaticBackupStartTime(String dailyAutomaticBackupStartTime) {
  ...
  public WindowsFileSystemConfiguration automaticBackupRetentionDays(Integer automaticBackupRetentionDays) {
  ...
  public WindowsFileSystemConfiguration copyTagsToBackups(Boolean copyTagsToBackups) {
  ...
  public WindowsFileSystemConfiguration aliases(List<Alias> aliases) {
    this.aliases = aliases;
    return this;
  }

  public WindowsFileSystemConfiguration addAliasesItem(Alias aliasesItem) {
  ...
  public WindowsFileSystemConfiguration auditLogConfiguration(WindowsFileSystemConfigurationAuditLogConfiguration auditLogConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    WindowsFileSystemConfiguration windowsFileSystemConfiguration = (WindowsFileSystemConfiguration) o;
    return Objects.equals(this.activeDirectoryId, windowsFileSystemConfiguration.activeDirectoryId) &&
        Objects.equals(this.selfManagedActiveDirectoryConfiguration, windowsFileSystemConfiguration.selfManagedActiveDirectoryConfiguration) &&
        Objects.equals(this.deploymentType, windowsFileSystemConfiguration.deploymentType) &&
        Objects.equals(this.remoteAdministrationEndpoint, windowsFileSystemConfiguration.remoteAdministrationEndpoint) &&
        Objects.equals(this.preferredSubnetId, windowsFileSystemConfiguration.preferredSubnetId) &&
        Objects.equals(this.preferredFileServerIp, windowsFileSystemConfiguration.preferredFileServerIp) &&
        Objects.equals(this.throughputCapacity, windowsFileSystemConfiguration.throughputCapacity) &&
        Objects.equals(this.maintenanceOperationsInProgress, windowsFileSystemConfiguration.maintenanceOperationsInProgress) &&
        Objects.equals(this.weeklyMaintenanceStartTime, windowsFileSystemConfiguration.weeklyMaintenanceStartTime) &&
        Objects.equals(this.dailyAutomaticBackupStartTime, windowsFileSystemConfiguration.dailyAutomaticBackupStartTime) &&
        Objects.equals(this.automaticBackupRetentionDays, windowsFileSystemConfiguration.automaticBackupRetentionDays) &&
        Objects.equals(this.copyTagsToBackups, windowsFileSystemConfiguration.copyTagsToBackups) &&
        Objects.equals(this.aliases, windowsFileSystemConfiguration.aliases) &&
        Objects.equals(this.auditLogConfiguration, windowsFileSystemConfiguration.auditLogConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class WindowsFileSystemConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WindowsFileSystemConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WindowsFileSystemConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WindowsFileSystemConfiguration is not found in the empty JSON string", WindowsFileSystemConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WindowsFileSystemConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WindowsFileSystemConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WindowsFileSystemConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WindowsFileSystemConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WindowsFileSystemConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WindowsFileSystemConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<WindowsFileSystemConfiguration>() {
           @Override
           public void write(JsonWriter out, WindowsFileSystemConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WindowsFileSystemConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WindowsFileSystemConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WindowsFileSystemConfiguration
   * @throws IOException if the JSON string is invalid with respect to WindowsFileSystemConfiguration
   */
  public static WindowsFileSystemConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WindowsFileSystemConfiguration.class);
  }

  /**
   * Convert an instance of WindowsFileSystemConfiguration to an JSON string
   *
   * @return JSON string
   */
