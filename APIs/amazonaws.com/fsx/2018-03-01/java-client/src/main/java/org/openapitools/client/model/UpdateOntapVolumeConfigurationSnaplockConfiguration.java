...
public class UpdateOntapVolumeConfigurationSnaplockConfiguration {
  ...
  public UpdateOntapVolumeConfigurationSnaplockConfiguration() {
  }

  public UpdateOntapVolumeConfigurationSnaplockConfiguration auditLogVolume(Boolean auditLogVolume) {
  ...
  public UpdateOntapVolumeConfigurationSnaplockConfiguration autocommitPeriod(CreateSnaplockConfigurationAutocommitPeriod autocommitPeriod) {
  ...
  public UpdateOntapVolumeConfigurationSnaplockConfiguration privilegedDelete(PrivilegedDelete privilegedDelete) {
  ...
  public UpdateOntapVolumeConfigurationSnaplockConfiguration retentionPeriod(CreateSnaplockConfigurationRetentionPeriod retentionPeriod) {
  ...
  public UpdateOntapVolumeConfigurationSnaplockConfiguration volumeAppendModeEnabled(Boolean volumeAppendModeEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateOntapVolumeConfigurationSnaplockConfiguration updateOntapVolumeConfigurationSnaplockConfiguration = (UpdateOntapVolumeConfigurationSnaplockConfiguration) o;
    return Objects.equals(this.auditLogVolume, updateOntapVolumeConfigurationSnaplockConfiguration.auditLogVolume) &&
        Objects.equals(this.autocommitPeriod, updateOntapVolumeConfigurationSnaplockConfiguration.autocommitPeriod) &&
        Objects.equals(this.privilegedDelete, updateOntapVolumeConfigurationSnaplockConfiguration.privilegedDelete) &&
        Objects.equals(this.retentionPeriod, updateOntapVolumeConfigurationSnaplockConfiguration.retentionPeriod) &&
        Objects.equals(this.volumeAppendModeEnabled, updateOntapVolumeConfigurationSnaplockConfiguration.volumeAppendModeEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateOntapVolumeConfigurationSnaplockConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateOntapVolumeConfigurationSnaplockConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateOntapVolumeConfigurationSnaplockConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateOntapVolumeConfigurationSnaplockConfiguration is not found in the empty JSON string", UpdateOntapVolumeConfigurationSnaplockConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateOntapVolumeConfigurationSnaplockConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateOntapVolumeConfigurationSnaplockConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateOntapVolumeConfigurationSnaplockConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateOntapVolumeConfigurationSnaplockConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateOntapVolumeConfigurationSnaplockConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateOntapVolumeConfigurationSnaplockConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateOntapVolumeConfigurationSnaplockConfiguration>() {
           @Override
           public void write(JsonWriter out, UpdateOntapVolumeConfigurationSnaplockConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateOntapVolumeConfigurationSnaplockConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateOntapVolumeConfigurationSnaplockConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateOntapVolumeConfigurationSnaplockConfiguration
   * @throws IOException if the JSON string is invalid with respect to UpdateOntapVolumeConfigurationSnaplockConfiguration
   */
  public static UpdateOntapVolumeConfigurationSnaplockConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateOntapVolumeConfigurationSnaplockConfiguration.class);
  }

  /**
   * Convert an instance of UpdateOntapVolumeConfigurationSnaplockConfiguration to an JSON string
   *
   * @return JSON string
   */
