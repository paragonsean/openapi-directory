...
public class OpenZFSCreateRootVolumeConfiguration {
  ...
  public OpenZFSCreateRootVolumeConfiguration recordSizeKiB(Integer recordSizeKiB) {
  ...
  public OpenZFSCreateRootVolumeConfiguration dataCompressionType(OpenZFSDataCompressionType dataCompressionType) {
  ...
  public OpenZFSCreateRootVolumeConfiguration nfsExports(List nfsExports) {
  ...
  public OpenZFSCreateRootVolumeConfiguration userAndGroupQuotas(List userAndGroupQuotas) {
  ...
  public OpenZFSCreateRootVolumeConfiguration copyTagsToSnapshots(Boolean copyTagsToSnapshots) {
  ...
  public OpenZFSCreateRootVolumeConfiguration readOnly(Boolean readOnly) {
  ...
  public boolean equals(Object o) {
    ...
    OpenZFSCreateRootVolumeConfiguration openZFSCreateRootVolumeConfiguration = (OpenZFSCreateRootVolumeConfiguration) o;
    return Objects.equals(this.recordSizeKiB, openZFSCreateRootVolumeConfiguration.recordSizeKiB) &&
        Objects.equals(this.dataCompressionType, openZFSCreateRootVolumeConfiguration.dataCompressionType) &&
        Objects.equals(this.nfsExports, openZFSCreateRootVolumeConfiguration.nfsExports) &&
        Objects.equals(this.userAndGroupQuotas, openZFSCreateRootVolumeConfiguration.userAndGroupQuotas) &&
        Objects.equals(this.copyTagsToSnapshots, openZFSCreateRootVolumeConfiguration.copyTagsToSnapshots) &&
        Objects.equals(this.readOnly, openZFSCreateRootVolumeConfiguration.readOnly);
  }
  ...
  public String toString() {
    ...
    sb.append("class OpenZFSCreateRootVolumeConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OpenZFSCreateRootVolumeConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpenZFSCreateRootVolumeConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpenZFSCreateRootVolumeConfiguration is not found in the empty JSON string", OpenZFSCreateRootVolumeConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OpenZFSCreateRootVolumeConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OpenZFSCreateRootVolumeConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpenZFSCreateRootVolumeConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpenZFSCreateRootVolumeConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpenZFSCreateRootVolumeConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpenZFSCreateRootVolumeConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<OpenZFSCreateRootVolumeConfiguration>() {
           @Override
           public void write(JsonWriter out, OpenZFSCreateRootVolumeConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OpenZFSCreateRootVolumeConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OpenZFSCreateRootVolumeConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OpenZFSCreateRootVolumeConfiguration
   * @throws IOException if the JSON string is invalid with respect to OpenZFSCreateRootVolumeConfiguration
   */
  public static OpenZFSCreateRootVolumeConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpenZFSCreateRootVolumeConfiguration.class);
  }

  /**
   * Convert an instance of OpenZFSCreateRootVolumeConfiguration to an JSON string
   *
   * @return JSON string
   */
