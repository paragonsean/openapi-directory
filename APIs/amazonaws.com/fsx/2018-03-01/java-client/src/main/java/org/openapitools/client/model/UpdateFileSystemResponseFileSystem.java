...
public class UpdateFileSystemResponseFileSystem {
  ...
  public UpdateFileSystemResponseFileSystem() {
  }

  public UpdateFileSystemResponseFileSystem ownerId(String ownerId) {
  ...
  public UpdateFileSystemResponseFileSystem creationTime(OffsetDateTime creationTime) {
  ...
  public UpdateFileSystemResponseFileSystem fileSystemId(String fileSystemId) {
  ...
  public UpdateFileSystemResponseFileSystem fileSystemType(FileSystemType fileSystemType) {
  ...
  public UpdateFileSystemResponseFileSystem lifecycle(FileSystemLifecycle lifecycle) {
  ...
  public UpdateFileSystemResponseFileSystem failureDetails(FileSystemFailureDetails failureDetails) {
  ...
  public UpdateFileSystemResponseFileSystem storageCapacity(Integer storageCapacity) {
  ...
  public UpdateFileSystemResponseFileSystem storageType(StorageType storageType) {
  ...
  public UpdateFileSystemResponseFileSystem vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public UpdateFileSystemResponseFileSystem subnetIds(List subnetIds) {
  ...
  public UpdateFileSystemResponseFileSystem networkInterfaceIds(List networkInterfaceIds) {
  ...
  public UpdateFileSystemResponseFileSystem dnSName(String dnSName) {
  ...
  public UpdateFileSystemResponseFileSystem kmsKeyId(String kmsKeyId) {
  ...
  public UpdateFileSystemResponseFileSystem resourceARN(String resourceARN) {
  ...
  public UpdateFileSystemResponseFileSystem tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public UpdateFileSystemResponseFileSystem windowsConfiguration(FileSystemWindowsConfiguration windowsConfiguration) {
  ...
  public UpdateFileSystemResponseFileSystem lustreConfiguration(LustreFileSystemConfiguration lustreConfiguration) {
  ...
  public UpdateFileSystemResponseFileSystem administrativeActions(List administrativeActions) {
  ...
  public UpdateFileSystemResponseFileSystem ontapConfiguration(FileSystemOntapConfiguration ontapConfiguration) {
  ...
  public UpdateFileSystemResponseFileSystem fileSystemTypeVersion(String fileSystemTypeVersion) {
  ...
  public UpdateFileSystemResponseFileSystem openZFSConfiguration(FileSystemOpenZFSConfiguration openZFSConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFileSystemResponseFileSystem updateFileSystemResponseFileSystem = (UpdateFileSystemResponseFileSystem) o;
    return Objects.equals(this.ownerId, updateFileSystemResponseFileSystem.ownerId) &&
        Objects.equals(this.creationTime, updateFileSystemResponseFileSystem.creationTime) &&
        Objects.equals(this.fileSystemId, updateFileSystemResponseFileSystem.fileSystemId) &&
        Objects.equals(this.fileSystemType, updateFileSystemResponseFileSystem.fileSystemType) &&
        Objects.equals(this.lifecycle, updateFileSystemResponseFileSystem.lifecycle) &&
        Objects.equals(this.failureDetails, updateFileSystemResponseFileSystem.failureDetails) &&
        Objects.equals(this.storageCapacity, updateFileSystemResponseFileSystem.storageCapacity) &&
        Objects.equals(this.storageType, updateFileSystemResponseFileSystem.storageType) &&
        Objects.equals(this.vpcId, updateFileSystemResponseFileSystem.vpcId) &&
        Objects.equals(this.subnetIds, updateFileSystemResponseFileSystem.subnetIds) &&
        Objects.equals(this.networkInterfaceIds, updateFileSystemResponseFileSystem.networkInterfaceIds) &&
        Objects.equals(this.dnSName, updateFileSystemResponseFileSystem.dnSName) &&
        Objects.equals(this.kmsKeyId, updateFileSystemResponseFileSystem.kmsKeyId) &&
        Objects.equals(this.resourceARN, updateFileSystemResponseFileSystem.resourceARN) &&
        Objects.equals(this.tags, updateFileSystemResponseFileSystem.tags) &&
        Objects.equals(this.windowsConfiguration, updateFileSystemResponseFileSystem.windowsConfiguration) &&
        Objects.equals(this.lustreConfiguration, updateFileSystemResponseFileSystem.lustreConfiguration) &&
        Objects.equals(this.administrativeActions, updateFileSystemResponseFileSystem.administrativeActions) &&
        Objects.equals(this.ontapConfiguration, updateFileSystemResponseFileSystem.ontapConfiguration) &&
        Objects.equals(this.fileSystemTypeVersion, updateFileSystemResponseFileSystem.fileSystemTypeVersion) &&
        Objects.equals(this.openZFSConfiguration, updateFileSystemResponseFileSystem.openZFSConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateFileSystemResponseFileSystem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFileSystemResponseFileSystem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFileSystemResponseFileSystem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFileSystemResponseFileSystem is not found in the empty JSON string", UpdateFileSystemResponseFileSystem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFileSystemResponseFileSystem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFileSystemResponseFileSystem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFileSystemResponseFileSystem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFileSystemResponseFileSystem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFileSystemResponseFileSystem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFileSystemResponseFileSystem.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFileSystemResponseFileSystem>() {
           @Override
           public void write(JsonWriter out, UpdateFileSystemResponseFileSystem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFileSystemResponseFileSystem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFileSystemResponseFileSystem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFileSystemResponseFileSystem
   * @throws IOException if the JSON string is invalid with respect to UpdateFileSystemResponseFileSystem
   */
  public static UpdateFileSystemResponseFileSystem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFileSystemResponseFileSystem.class);
  }

  /**
   * Convert an instance of UpdateFileSystemResponseFileSystem to an JSON string
   *
   * @return JSON string
   */
