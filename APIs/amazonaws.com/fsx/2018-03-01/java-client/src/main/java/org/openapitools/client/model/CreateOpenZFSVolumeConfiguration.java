...
public class CreateOpenZFSVolumeConfiguration {
  ...
  public CreateOpenZFSVolumeConfiguration parentVolumeId(String parentVolumeId) {
  ...
  public CreateOpenZFSVolumeConfiguration storageCapacityReservationGiB(Integer storageCapacityReservationGiB) {
  ...
  public CreateOpenZFSVolumeConfiguration storageCapacityQuotaGiB(Integer storageCapacityQuotaGiB) {
  ...
  public CreateOpenZFSVolumeConfiguration recordSizeKiB(Integer recordSizeKiB) {
  ...
  public CreateOpenZFSVolumeConfiguration dataCompressionType(OpenZFSDataCompressionType dataCompressionType) {
  ...
  public CreateOpenZFSVolumeConfiguration copyTagsToSnapshots(Boolean copyTagsToSnapshots) {
  ...
  public CreateOpenZFSVolumeConfiguration originSnapshot(CreateOpenZFSVolumeConfigurationOriginSnapshot originSnapshot) {
  ...
  public CreateOpenZFSVolumeConfiguration readOnly(Boolean readOnly) {
  ...
  public CreateOpenZFSVolumeConfiguration nfsExports(List nfsExports) {
  ...
  public CreateOpenZFSVolumeConfiguration userAndGroupQuotas(List userAndGroupQuotas) {
  ...
  public boolean equals(Object o) {
    ...
    CreateOpenZFSVolumeConfiguration createOpenZFSVolumeConfiguration = (CreateOpenZFSVolumeConfiguration) o;
    return Objects.equals(this.parentVolumeId, createOpenZFSVolumeConfiguration.parentVolumeId) &&
        Objects.equals(this.storageCapacityReservationGiB, createOpenZFSVolumeConfiguration.storageCapacityReservationGiB) &&
        Objects.equals(this.storageCapacityQuotaGiB, createOpenZFSVolumeConfiguration.storageCapacityQuotaGiB) &&
        Objects.equals(this.recordSizeKiB, createOpenZFSVolumeConfiguration.recordSizeKiB) &&
        Objects.equals(this.dataCompressionType, createOpenZFSVolumeConfiguration.dataCompressionType) &&
        Objects.equals(this.copyTagsToSnapshots, createOpenZFSVolumeConfiguration.copyTagsToSnapshots) &&
        Objects.equals(this.originSnapshot, createOpenZFSVolumeConfiguration.originSnapshot) &&
        Objects.equals(this.readOnly, createOpenZFSVolumeConfiguration.readOnly) &&
        Objects.equals(this.nfsExports, createOpenZFSVolumeConfiguration.nfsExports) &&
        Objects.equals(this.userAndGroupQuotas, createOpenZFSVolumeConfiguration.userAndGroupQuotas);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateOpenZFSVolumeConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateOpenZFSVolumeConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateOpenZFSVolumeConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOpenZFSVolumeConfiguration is not found in the empty JSON string", CreateOpenZFSVolumeConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOpenZFSVolumeConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOpenZFSVolumeConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateOpenZFSVolumeConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOpenZFSVolumeConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOpenZFSVolumeConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOpenZFSVolumeConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOpenZFSVolumeConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOpenZFSVolumeConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateOpenZFSVolumeConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateOpenZFSVolumeConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateOpenZFSVolumeConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateOpenZFSVolumeConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateOpenZFSVolumeConfiguration
   */
  public static CreateOpenZFSVolumeConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOpenZFSVolumeConfiguration.class);
  }

  /**
   * Convert an instance of CreateOpenZFSVolumeConfiguration to an JSON string
   *
   * @return JSON string
   */
