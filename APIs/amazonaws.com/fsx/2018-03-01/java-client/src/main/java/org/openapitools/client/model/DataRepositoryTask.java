...
public class DataRepositoryTask {
  ...
  public DataRepositoryTask taskId(String taskId) {
    this.taskId = taskId;
    return this;
  }
  ...
  public DataRepositoryTask lifecycle(DataRepositoryTaskLifecycle lifecycle) {
  ...
  public DataRepositoryTask type(DataRepositoryTaskType type) {
    this.type = type;
    return this;
  }
  ...
  public DataRepositoryTask creationTime(OffsetDateTime creationTime) {
  ...
  public DataRepositoryTask startTime(OffsetDateTime startTime) {
  ...
  public DataRepositoryTask endTime(OffsetDateTime endTime) {
  ...
  public DataRepositoryTask resourceARN(String resourceARN) {
  ...
  public DataRepositoryTask tags(List<Tag> tags) {
    this.tags = tags;
    return this;
  }

  public DataRepositoryTask addTagsItem(Tag tagsItem) {
    if (this.tags == null) {
  ...
  public DataRepositoryTask fileSystemId(String fileSystemId) {
  ...
  public DataRepositoryTask paths(List paths) {
    this.paths = paths;
    return this;
  }
  ...
  public DataRepositoryTask failureDetails(DataRepositoryTaskFailureDetails failureDetails) {
  ...
  public DataRepositoryTask status(DataRepositoryTaskStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DataRepositoryTask report(CompletionReport report) {
    this.report = report;
    return this;
  }
  ...
  public DataRepositoryTask capacityToRelease(Integer capacityToRelease) {
  ...
  public DataRepositoryTask fileCacheId(String fileCacheId) {
  ...
  public boolean equals(Object o) {
    ...
    DataRepositoryTask dataRepositoryTask = (DataRepositoryTask) o;
    return Objects.equals(this.taskId, dataRepositoryTask.taskId) &&
        Objects.equals(this.lifecycle, dataRepositoryTask.lifecycle) &&
        Objects.equals(this.type, dataRepositoryTask.type) &&
        Objects.equals(this.creationTime, dataRepositoryTask.creationTime) &&
        Objects.equals(this.startTime, dataRepositoryTask.startTime) &&
        Objects.equals(this.endTime, dataRepositoryTask.endTime) &&
        Objects.equals(this.resourceARN, dataRepositoryTask.resourceARN) &&
        Objects.equals(this.tags, dataRepositoryTask.tags) &&
        Objects.equals(this.fileSystemId, dataRepositoryTask.fileSystemId) &&
        Objects.equals(this.paths, dataRepositoryTask.paths) &&
        Objects.equals(this.failureDetails, dataRepositoryTask.failureDetails) &&
        Objects.equals(this.status, dataRepositoryTask.status) &&
        Objects.equals(this.report, dataRepositoryTask.report) &&
        Objects.equals(this.capacityToRelease, dataRepositoryTask.capacityToRelease) &&
        Objects.equals(this.fileCacheId, dataRepositoryTask.fileCacheId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataRepositoryTask {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataRepositoryTask
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataRepositoryTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataRepositoryTask is not found in the empty JSON string", DataRepositoryTask.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataRepositoryTask.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataRepositoryTask` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DataRepositoryTask.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataRepositoryTask.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataRepositoryTask' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataRepositoryTask> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataRepositoryTask.class));

       return (TypeAdapter<T>) new TypeAdapter<DataRepositoryTask>() {
           @Override
           public void write(JsonWriter out, DataRepositoryTask value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataRepositoryTask read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataRepositoryTask given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataRepositoryTask
   * @throws IOException if the JSON string is invalid with respect to DataRepositoryTask
   */
  public static DataRepositoryTask fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataRepositoryTask.class);
  }

  /**
   * Convert an instance of DataRepositoryTask to an JSON string
   *
   * @return JSON string
   */
