...
public class CreateFileSystemFromBackupResponseFileSystem {
  ...
  public CreateFileSystemFromBackupResponseFileSystem() {
  }

  public CreateFileSystemFromBackupResponseFileSystem ownerId(String ownerId) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem creationTime(OffsetDateTime creationTime) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem fileSystemId(String fileSystemId) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem fileSystemType(FileSystemType fileSystemType) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem lifecycle(FileSystemLifecycle lifecycle) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem failureDetails(FileSystemFailureDetails failureDetails) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem storageCapacity(Integer storageCapacity) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem storageType(StorageType storageType) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public CreateFileSystemFromBackupResponseFileSystem subnetIds(List subnetIds) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem networkInterfaceIds(List networkInterfaceIds) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem dnSName(String dnSName) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem kmsKeyId(String kmsKeyId) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem resourceARN(String resourceARN) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateFileSystemFromBackupResponseFileSystem windowsConfiguration(FileSystemWindowsConfiguration windowsConfiguration) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem lustreConfiguration(LustreFileSystemConfiguration lustreConfiguration) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem administrativeActions(List administrativeActions) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem ontapConfiguration(FileSystemOntapConfiguration ontapConfiguration) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem fileSystemTypeVersion(String fileSystemTypeVersion) {
  ...
  public CreateFileSystemFromBackupResponseFileSystem openZFSConfiguration(FileSystemOpenZFSConfiguration openZFSConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFileSystemFromBackupResponseFileSystem createFileSystemFromBackupResponseFileSystem = (CreateFileSystemFromBackupResponseFileSystem) o;
    return Objects.equals(this.ownerId, createFileSystemFromBackupResponseFileSystem.ownerId) &&
        Objects.equals(this.creationTime, createFileSystemFromBackupResponseFileSystem.creationTime) &&
        Objects.equals(this.fileSystemId, createFileSystemFromBackupResponseFileSystem.fileSystemId) &&
        Objects.equals(this.fileSystemType, createFileSystemFromBackupResponseFileSystem.fileSystemType) &&
        Objects.equals(this.lifecycle, createFileSystemFromBackupResponseFileSystem.lifecycle) &&
        Objects.equals(this.failureDetails, createFileSystemFromBackupResponseFileSystem.failureDetails) &&
        Objects.equals(this.storageCapacity, createFileSystemFromBackupResponseFileSystem.storageCapacity) &&
        Objects.equals(this.storageType, createFileSystemFromBackupResponseFileSystem.storageType) &&
        Objects.equals(this.vpcId, createFileSystemFromBackupResponseFileSystem.vpcId) &&
        Objects.equals(this.subnetIds, createFileSystemFromBackupResponseFileSystem.subnetIds) &&
        Objects.equals(this.networkInterfaceIds, createFileSystemFromBackupResponseFileSystem.networkInterfaceIds) &&
        Objects.equals(this.dnSName, createFileSystemFromBackupResponseFileSystem.dnSName) &&
        Objects.equals(this.kmsKeyId, createFileSystemFromBackupResponseFileSystem.kmsKeyId) &&
        Objects.equals(this.resourceARN, createFileSystemFromBackupResponseFileSystem.resourceARN) &&
        Objects.equals(this.tags, createFileSystemFromBackupResponseFileSystem.tags) &&
        Objects.equals(this.windowsConfiguration, createFileSystemFromBackupResponseFileSystem.windowsConfiguration) &&
        Objects.equals(this.lustreConfiguration, createFileSystemFromBackupResponseFileSystem.lustreConfiguration) &&
        Objects.equals(this.administrativeActions, createFileSystemFromBackupResponseFileSystem.administrativeActions) &&
        Objects.equals(this.ontapConfiguration, createFileSystemFromBackupResponseFileSystem.ontapConfiguration) &&
        Objects.equals(this.fileSystemTypeVersion, createFileSystemFromBackupResponseFileSystem.fileSystemTypeVersion) &&
        Objects.equals(this.openZFSConfiguration, createFileSystemFromBackupResponseFileSystem.openZFSConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFileSystemFromBackupResponseFileSystem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFileSystemFromBackupResponseFileSystem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFileSystemFromBackupResponseFileSystem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFileSystemFromBackupResponseFileSystem is not found in the empty JSON string", CreateFileSystemFromBackupResponseFileSystem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFileSystemFromBackupResponseFileSystem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFileSystemFromBackupResponseFileSystem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFileSystemFromBackupResponseFileSystem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFileSystemFromBackupResponseFileSystem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFileSystemFromBackupResponseFileSystem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFileSystemFromBackupResponseFileSystem.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFileSystemFromBackupResponseFileSystem>() {
           @Override
           public void write(JsonWriter out, CreateFileSystemFromBackupResponseFileSystem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFileSystemFromBackupResponseFileSystem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFileSystemFromBackupResponseFileSystem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFileSystemFromBackupResponseFileSystem
   * @throws IOException if the JSON string is invalid with respect to CreateFileSystemFromBackupResponseFileSystem
   */
  public static CreateFileSystemFromBackupResponseFileSystem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFileSystemFromBackupResponseFileSystem.class);
  }

  /**
   * Convert an instance of CreateFileSystemFromBackupResponseFileSystem to an JSON string
   *
   * @return JSON string
   */
