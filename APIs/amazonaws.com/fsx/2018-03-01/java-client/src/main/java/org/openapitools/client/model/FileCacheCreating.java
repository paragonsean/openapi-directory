...
public class FileCacheCreating {
  ...
  public FileCacheCreating ownerId(String ownerId) {
  ...
  public FileCacheCreating creationTime(OffsetDateTime creationTime) {
  ...
  public FileCacheCreating fileCacheId(String fileCacheId) {
  ...
  public FileCacheCreating fileCacheType(FileCacheType fileCacheType) {
  ...
  public FileCacheCreating fileCacheTypeVersion(String fileCacheTypeVersion) {
  ...
  public FileCacheCreating lifecycle(FileCacheLifecycle lifecycle) {
  ...
  public FileCacheCreating failureDetails(FileCacheCreatingFailureDetails failureDetails) {
  ...
  public FileCacheCreating storageCapacity(Integer storageCapacity) {
  ...
  public FileCacheCreating vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public FileCacheCreating subnetIds(List<String> subnetIds) {
    this.subnetIds = subnetIds;
    return this;
  }

  public FileCacheCreating addSubnetIdsItem(String subnetIdsItem) {
  ...
  public FileCacheCreating networkInterfaceIds(List<String> networkInterfaceIds) {
    this.networkInterfaceIds = networkInterfaceIds;
    return this;
  }

  public FileCacheCreating addNetworkInterfaceIdsItem(String networkInterfaceIdsItem) {
  ...
  public FileCacheCreating dnSName(String dnSName) {
  ...
  public FileCacheCreating kmsKeyId(String kmsKeyId) {
  ...
  public FileCacheCreating resourceARN(String resourceARN) {
  ...
  public FileCacheCreating tags(List<Tag> tags) {
    this.tags = tags;
    return this;
  }

  public FileCacheCreating addTagsItem(Tag tagsItem) {
    if (this.tags == null) {
  ...
  public FileCacheCreating copyTagsToDataRepositoryAssociations(Boolean copyTagsToDataRepositoryAssociations) {
  ...
  public FileCacheCreating lustreConfiguration(FileCacheCreatingLustreConfiguration lustreConfiguration) {
  ...
  public FileCacheCreating dataRepositoryAssociationIds(List dataRepositoryAssociationIds) {
  ...
  public boolean equals(Object o) {
    ...
    FileCacheCreating fileCacheCreating = (FileCacheCreating) o;
    return Objects.equals(this.ownerId, fileCacheCreating.ownerId) &&
        Objects.equals(this.creationTime, fileCacheCreating.creationTime) &&
        Objects.equals(this.fileCacheId, fileCacheCreating.fileCacheId) &&
        Objects.equals(this.fileCacheType, fileCacheCreating.fileCacheType) &&
        Objects.equals(this.fileCacheTypeVersion, fileCacheCreating.fileCacheTypeVersion) &&
        Objects.equals(this.lifecycle, fileCacheCreating.lifecycle) &&
        Objects.equals(this.failureDetails, fileCacheCreating.failureDetails) &&
        Objects.equals(this.storageCapacity, fileCacheCreating.storageCapacity) &&
        Objects.equals(this.vpcId, fileCacheCreating.vpcId) &&
        Objects.equals(this.subnetIds, fileCacheCreating.subnetIds) &&
        Objects.equals(this.networkInterfaceIds, fileCacheCreating.networkInterfaceIds) &&
        Objects.equals(this.dnSName, fileCacheCreating.dnSName) &&
        Objects.equals(this.kmsKeyId, fileCacheCreating.kmsKeyId) &&
        Objects.equals(this.resourceARN, fileCacheCreating.resourceARN) &&
        Objects.equals(this.tags, fileCacheCreating.tags) &&
        Objects.equals(this.copyTagsToDataRepositoryAssociations, fileCacheCreating.copyTagsToDataRepositoryAssociations) &&
        Objects.equals(this.lustreConfiguration, fileCacheCreating.lustreConfiguration) &&
        Objects.equals(this.dataRepositoryAssociationIds, fileCacheCreating.dataRepositoryAssociationIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileCacheCreating {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FileCacheCreating
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FileCacheCreating.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileCacheCreating is not found in the empty JSON string", FileCacheCreating.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FileCacheCreating.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FileCacheCreating` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileCacheCreating.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileCacheCreating' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileCacheCreating> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileCacheCreating.class));

       return (TypeAdapter<T>) new TypeAdapter<FileCacheCreating>() {
           @Override
           public void write(JsonWriter out, FileCacheCreating value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FileCacheCreating read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FileCacheCreating given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FileCacheCreating
   * @throws IOException if the JSON string is invalid with respect to FileCacheCreating
   */
  public static FileCacheCreating fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileCacheCreating.class);
  }

  /**
   * Convert an instance of FileCacheCreating to an JSON string
   *
   * @return JSON string
   */
