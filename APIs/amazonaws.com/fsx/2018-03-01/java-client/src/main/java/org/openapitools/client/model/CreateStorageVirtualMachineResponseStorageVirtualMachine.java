...
public class CreateStorageVirtualMachineResponseStorageVirtualMachine {
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine() {
  }

  public CreateStorageVirtualMachineResponseStorageVirtualMachine activeDirectoryConfiguration(StorageVirtualMachineActiveDirectoryConfiguration activeDirectoryConfiguration) {
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine creationTime(OffsetDateTime creationTime) {
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine endpoints(StorageVirtualMachineEndpoints endpoints) {
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine fileSystemId(String fileSystemId) {
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine lifecycle(StorageVirtualMachineLifecycle lifecycle) {
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine resourceARN(String resourceARN) {
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine storageVirtualMachineId(String storageVirtualMachineId) {
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine subtype(StorageVirtualMachineSubtype subtype) {
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine UUID(String UUID) {
    this.UUID = UUID;
    return this;
  }
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine tags(List<Tag> tags) {
    this.tags = tags;
    return this;
  }

  public CreateStorageVirtualMachineResponseStorageVirtualMachine addTagsItem(Tag tagsItem) {
    if (this.tags == null) {
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine lifecycleTransitionReason(StorageVirtualMachineLifecycleTransitionReason lifecycleTransitionReason) {
  ...
  public CreateStorageVirtualMachineResponseStorageVirtualMachine rootVolumeSecurityStyle(StorageVirtualMachineRootVolumeSecurityStyle rootVolumeSecurityStyle) {
  ...
  public boolean equals(Object o) {
    ...
    CreateStorageVirtualMachineResponseStorageVirtualMachine createStorageVirtualMachineResponseStorageVirtualMachine = (CreateStorageVirtualMachineResponseStorageVirtualMachine) o;
    return Objects.equals(this.activeDirectoryConfiguration, createStorageVirtualMachineResponseStorageVirtualMachine.activeDirectoryConfiguration) &&
        Objects.equals(this.creationTime, createStorageVirtualMachineResponseStorageVirtualMachine.creationTime) &&
        Objects.equals(this.endpoints, createStorageVirtualMachineResponseStorageVirtualMachine.endpoints) &&
        Objects.equals(this.fileSystemId, createStorageVirtualMachineResponseStorageVirtualMachine.fileSystemId) &&
        Objects.equals(this.lifecycle, createStorageVirtualMachineResponseStorageVirtualMachine.lifecycle) &&
        Objects.equals(this.name, createStorageVirtualMachineResponseStorageVirtualMachine.name) &&
        Objects.equals(this.resourceARN, createStorageVirtualMachineResponseStorageVirtualMachine.resourceARN) &&
        Objects.equals(this.storageVirtualMachineId, createStorageVirtualMachineResponseStorageVirtualMachine.storageVirtualMachineId) &&
        Objects.equals(this.subtype, createStorageVirtualMachineResponseStorageVirtualMachine.subtype) &&
        Objects.equals(this.UUID, createStorageVirtualMachineResponseStorageVirtualMachine.UUID) &&
        Objects.equals(this.tags, createStorageVirtualMachineResponseStorageVirtualMachine.tags) &&
        Objects.equals(this.lifecycleTransitionReason, createStorageVirtualMachineResponseStorageVirtualMachine.lifecycleTransitionReason) &&
        Objects.equals(this.rootVolumeSecurityStyle, createStorageVirtualMachineResponseStorageVirtualMachine.rootVolumeSecurityStyle);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateStorageVirtualMachineResponseStorageVirtualMachine {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStorageVirtualMachineResponseStorageVirtualMachine
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStorageVirtualMachineResponseStorageVirtualMachine.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStorageVirtualMachineResponseStorageVirtualMachine is not found in the empty JSON string", CreateStorageVirtualMachineResponseStorageVirtualMachine.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStorageVirtualMachineResponseStorageVirtualMachine.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStorageVirtualMachineResponseStorageVirtualMachine` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStorageVirtualMachineResponseStorageVirtualMachine.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStorageVirtualMachineResponseStorageVirtualMachine' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStorageVirtualMachineResponseStorageVirtualMachine> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStorageVirtualMachineResponseStorageVirtualMachine.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStorageVirtualMachineResponseStorageVirtualMachine>() {
           @Override
           public void write(JsonWriter out, CreateStorageVirtualMachineResponseStorageVirtualMachine value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStorageVirtualMachineResponseStorageVirtualMachine read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStorageVirtualMachineResponseStorageVirtualMachine given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStorageVirtualMachineResponseStorageVirtualMachine
   * @throws IOException if the JSON string is invalid with respect to CreateStorageVirtualMachineResponseStorageVirtualMachine
   */
  public static CreateStorageVirtualMachineResponseStorageVirtualMachine fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStorageVirtualMachineResponseStorageVirtualMachine.class);
  }

  /**
   * Convert an instance of CreateStorageVirtualMachineResponseStorageVirtualMachine to an JSON string
   *
   * @return JSON string
   */
