...
public class UpdateDataRepositoryAssociationResponseAssociation {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation() {
  }

  public UpdateDataRepositoryAssociationResponseAssociation associationId(String associationId) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation resourceARN(String resourceARN) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation fileSystemId(String fileSystemId) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation lifecycle(DataRepositoryLifecycle lifecycle) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation failureDetails(DataRepositoryFailureDetails failureDetails) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation fileSystemPath(String fileSystemPath) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation dataRepositoryPath(String dataRepositoryPath) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation batchImportMetaDataOnCreate(Boolean batchImportMetaDataOnCreate) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation importedFileChunkSize(Integer importedFileChunkSize) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation S3(DataRepositoryAssociationS3 S3) {
    this.S3 = S3;
    return this;
  }
  ...
  public UpdateDataRepositoryAssociationResponseAssociation tags(List<Tag> tags) {
    this.tags = tags;
    return this;
  }

  public UpdateDataRepositoryAssociationResponseAssociation addTagsItem(Tag tagsItem) {
    if (this.tags == null) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation creationTime(OffsetDateTime creationTime) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation fileCacheId(String fileCacheId) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation fileCachePath(String fileCachePath) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation dataRepositorySubdirectories(List dataRepositorySubdirectories) {
  ...
  public UpdateDataRepositoryAssociationResponseAssociation NFS(DataRepositoryAssociationNFS NFS) {
    this.NFS = NFS;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateDataRepositoryAssociationResponseAssociation updateDataRepositoryAssociationResponseAssociation = (UpdateDataRepositoryAssociationResponseAssociation) o;
    return Objects.equals(this.associationId, updateDataRepositoryAssociationResponseAssociation.associationId) &&
        Objects.equals(this.resourceARN, updateDataRepositoryAssociationResponseAssociation.resourceARN) &&
        Objects.equals(this.fileSystemId, updateDataRepositoryAssociationResponseAssociation.fileSystemId) &&
        Objects.equals(this.lifecycle, updateDataRepositoryAssociationResponseAssociation.lifecycle) &&
        Objects.equals(this.failureDetails, updateDataRepositoryAssociationResponseAssociation.failureDetails) &&
        Objects.equals(this.fileSystemPath, updateDataRepositoryAssociationResponseAssociation.fileSystemPath) &&
        Objects.equals(this.dataRepositoryPath, updateDataRepositoryAssociationResponseAssociation.dataRepositoryPath) &&
        Objects.equals(this.batchImportMetaDataOnCreate, updateDataRepositoryAssociationResponseAssociation.batchImportMetaDataOnCreate) &&
        Objects.equals(this.importedFileChunkSize, updateDataRepositoryAssociationResponseAssociation.importedFileChunkSize) &&
        Objects.equals(this.S3, updateDataRepositoryAssociationResponseAssociation.S3) &&
        Objects.equals(this.tags, updateDataRepositoryAssociationResponseAssociation.tags) &&
        Objects.equals(this.creationTime, updateDataRepositoryAssociationResponseAssociation.creationTime) &&
        Objects.equals(this.fileCacheId, updateDataRepositoryAssociationResponseAssociation.fileCacheId) &&
        Objects.equals(this.fileCachePath, updateDataRepositoryAssociationResponseAssociation.fileCachePath) &&
        Objects.equals(this.dataRepositorySubdirectories, updateDataRepositoryAssociationResponseAssociation.dataRepositorySubdirectories) &&
        Objects.equals(this.NFS, updateDataRepositoryAssociationResponseAssociation.NFS);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDataRepositoryAssociationResponseAssociation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDataRepositoryAssociationResponseAssociation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDataRepositoryAssociationResponseAssociation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDataRepositoryAssociationResponseAssociation is not found in the empty JSON string", UpdateDataRepositoryAssociationResponseAssociation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDataRepositoryAssociationResponseAssociation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDataRepositoryAssociationResponseAssociation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDataRepositoryAssociationResponseAssociation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDataRepositoryAssociationResponseAssociation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDataRepositoryAssociationResponseAssociation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDataRepositoryAssociationResponseAssociation.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDataRepositoryAssociationResponseAssociation>() {
           @Override
           public void write(JsonWriter out, UpdateDataRepositoryAssociationResponseAssociation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDataRepositoryAssociationResponseAssociation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDataRepositoryAssociationResponseAssociation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDataRepositoryAssociationResponseAssociation
   * @throws IOException if the JSON string is invalid with respect to UpdateDataRepositoryAssociationResponseAssociation
   */
  public static UpdateDataRepositoryAssociationResponseAssociation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDataRepositoryAssociationResponseAssociation.class);
  }

  /**
   * Convert an instance of UpdateDataRepositoryAssociationResponseAssociation to an JSON string
   *
   * @return JSON string
   */
