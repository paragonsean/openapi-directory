...
#include "OAIUpdateFileSystemOpenZFSConfiguration.h"
...
OAIUpdateFileSystemOpenZFSConfiguration::OAIUpdateFileSystemOpenZFSConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFileSystemOpenZFSConfiguration::OAIUpdateFileSystemOpenZFSConfiguration() {
    this->initializeModel();
}

OAIUpdateFileSystemOpenZFSConfiguration::~OAIUpdateFileSystemOpenZFSConfiguration() {}

void OAIUpdateFileSystemOpenZFSConfiguration::initializeModel() {
...
void OAIUpdateFileSystemOpenZFSConfiguration::fromJson(QString jsonString) {
...
void OAIUpdateFileSystemOpenZFSConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFileSystemOpenZFSConfiguration::asJson() const {
...
QJsonObject OAIUpdateFileSystemOpenZFSConfiguration::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIUpdateFileSystemOpenZFSConfiguration::getAutomaticBackupRetentionDays() const {
    return m_automatic_backup_retention_days;
}
void OAIUpdateFileSystemOpenZFSConfiguration::setAutomaticBackupRetentionDays(const qint32 &automatic_backup_retention_days) {
    m_automatic_backup_retention_days = automatic_backup_retention_days;
    m_automatic_backup_retention_days_isSet = true;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_automatic_backup_retention_days_Set() const{
    return m_automatic_backup_retention_days_isSet;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_automatic_backup_retention_days_Valid() const{
    return m_automatic_backup_retention_days_isValid;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::getCopyTagsToBackups() const {
    return m_copy_tags_to_backups;
}
void OAIUpdateFileSystemOpenZFSConfiguration::setCopyTagsToBackups(const bool &copy_tags_to_backups) {
    m_copy_tags_to_backups = copy_tags_to_backups;
    m_copy_tags_to_backups_isSet = true;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_copy_tags_to_backups_Set() const{
    return m_copy_tags_to_backups_isSet;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_copy_tags_to_backups_Valid() const{
    return m_copy_tags_to_backups_isValid;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::getCopyTagsToVolumes() const {
    return m_copy_tags_to_volumes;
}
void OAIUpdateFileSystemOpenZFSConfiguration::setCopyTagsToVolumes(const bool &copy_tags_to_volumes) {
    m_copy_tags_to_volumes = copy_tags_to_volumes;
    m_copy_tags_to_volumes_isSet = true;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_copy_tags_to_volumes_Set() const{
    return m_copy_tags_to_volumes_isSet;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_copy_tags_to_volumes_Valid() const{
    return m_copy_tags_to_volumes_isValid;
}

QString OAIUpdateFileSystemOpenZFSConfiguration::getDailyAutomaticBackupStartTime() const {
    return m_daily_automatic_backup_start_time;
}
void OAIUpdateFileSystemOpenZFSConfiguration::setDailyAutomaticBackupStartTime(const QString &daily_automatic_backup_start_time) {
    m_daily_automatic_backup_start_time = daily_automatic_backup_start_time;
    m_daily_automatic_backup_start_time_isSet = true;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_daily_automatic_backup_start_time_Set() const{
    return m_daily_automatic_backup_start_time_isSet;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_daily_automatic_backup_start_time_Valid() const{
    return m_daily_automatic_backup_start_time_isValid;
}

qint32 OAIUpdateFileSystemOpenZFSConfiguration::getThroughputCapacity() const {
    return m_throughput_capacity;
}
void OAIUpdateFileSystemOpenZFSConfiguration::setThroughputCapacity(const qint32 &throughput_capacity) {
    m_throughput_capacity = throughput_capacity;
    m_throughput_capacity_isSet = true;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_throughput_capacity_Set() const{
    return m_throughput_capacity_isSet;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_throughput_capacity_Valid() const{
    return m_throughput_capacity_isValid;
}

QString OAIUpdateFileSystemOpenZFSConfiguration::getWeeklyMaintenanceStartTime() const {
    return m_weekly_maintenance_start_time;
}
void OAIUpdateFileSystemOpenZFSConfiguration::setWeeklyMaintenanceStartTime(const QString &weekly_maintenance_start_time) {
    m_weekly_maintenance_start_time = weekly_maintenance_start_time;
    m_weekly_maintenance_start_time_isSet = true;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_weekly_maintenance_start_time_Set() const{
    return m_weekly_maintenance_start_time_isSet;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_weekly_maintenance_start_time_Valid() const{
    return m_weekly_maintenance_start_time_isValid;
}

OAIDiskIopsConfiguration OAIUpdateFileSystemOpenZFSConfiguration::getDiskIopsConfiguration() const {
    return m_disk_iops_configuration;
}
void OAIUpdateFileSystemOpenZFSConfiguration::setDiskIopsConfiguration(const OAIDiskIopsConfiguration &disk_iops_configuration) {
    m_disk_iops_configuration = disk_iops_configuration;
    m_disk_iops_configuration_isSet = true;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_disk_iops_configuration_Set() const{
    return m_disk_iops_configuration_isSet;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::is_disk_iops_configuration_Valid() const{
    return m_disk_iops_configuration_isValid;
}

bool OAIUpdateFileSystemOpenZFSConfiguration::isSet() const {
...
bool OAIUpdateFileSystemOpenZFSConfiguration::isValid() const {
