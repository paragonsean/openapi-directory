...
/*
 * OAICreateSnaplockConfiguration.h
 *
 * Defines the SnapLock configuration when creating an FSx for ONTAP SnapLock volume. 
 */

#ifndef OAICreateSnaplockConfiguration_H
#define OAICreateSnaplockConfiguration_H
...
class OAICreateSnaplockConfiguration : public OAIObject {
public:
    OAICreateSnaplockConfiguration();
    OAICreateSnaplockConfiguration(QString json);
    ~OAICreateSnaplockConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSnaplockConfiguration)

#endif // OAICreateSnaplockConfiguration_H
