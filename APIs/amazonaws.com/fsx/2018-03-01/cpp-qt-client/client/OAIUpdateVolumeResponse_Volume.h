...
/*
 * OAIUpdateVolumeResponse_Volume.h
 *
 * 
 */

#ifndef OAIUpdateVolumeResponse_Volume_H
#define OAIUpdateVolumeResponse_Volume_H
...
class OAIUpdateVolumeResponse_Volume : public OAIObject {
public:
    OAIUpdateVolumeResponse_Volume();
    OAIUpdateVolumeResponse_Volume(QString json);
    ~OAIUpdateVolumeResponse_Volume() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVolumeResponse_Volume)

#endif // OAIUpdateVolumeResponse_Volume_H
