...
/*
 * OAIDisassociateFileSystemAliasesRequest.h
 *
 * The request object of DNS aliases to disassociate from an Amazon FSx for Windows File Server file system.
 */

#ifndef OAIDisassociateFileSystemAliasesRequest_H
#define OAIDisassociateFileSystemAliasesRequest_H
...
class OAIDisassociateFileSystemAliasesRequest : public OAIObject {
public:
    OAIDisassociateFileSystemAliasesRequest();
    OAIDisassociateFileSystemAliasesRequest(QString json);
    ~OAIDisassociateFileSystemAliasesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateFileSystemAliasesRequest)

#endif // OAIDisassociateFileSystemAliasesRequest_H
