...
#ifndef OAISnaplockRetentionPeriod_H
#define OAISnaplockRetentionPeriod_H
...
class OAISnaplockRetentionPeriod : public OAIObject {
public:
    OAISnaplockRetentionPeriod();
    OAISnaplockRetentionPeriod(QString json);
    ~OAISnaplockRetentionPeriod() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISnaplockRetentionPeriod)

#endif // OAISnaplockRetentionPeriod_H
