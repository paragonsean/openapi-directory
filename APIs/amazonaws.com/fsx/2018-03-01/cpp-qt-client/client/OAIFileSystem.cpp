...
OAIFileSystem::OAIFileSystem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFileSystem::OAIFileSystem() {
    this->initializeModel();
}

OAIFileSystem::~OAIFileSystem() {}

void OAIFileSystem::initializeModel() {
...
void OAIFileSystem::fromJson(QString jsonString) {
...
void OAIFileSystem::fromJsonObject(QJsonObject json) {
...
QString OAIFileSystem::asJson() const {
...
QJsonObject OAIFileSystem::asJsonObject() const {
    QJsonObject obj;
    if (m_owner_id_isSet) {
...
QString OAIFileSystem::getOwnerId() const {
    return m_owner_id;
}
void OAIFileSystem::setOwnerId(const QString &owner_id) {
    m_owner_id = owner_id;
    m_owner_id_isSet = true;
}

bool OAIFileSystem::is_owner_id_Set() const{
    return m_owner_id_isSet;
}

bool OAIFileSystem::is_owner_id_Valid() const{
    return m_owner_id_isValid;
}

QDateTime OAIFileSystem::getCreationTime() const {
    return m_creation_time;
}
void OAIFileSystem::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIFileSystem::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIFileSystem::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QString OAIFileSystem::getFileSystemId() const {
    return m_file_system_id;
}
void OAIFileSystem::setFileSystemId(const QString &file_system_id) {
    m_file_system_id = file_system_id;
    m_file_system_id_isSet = true;
}

bool OAIFileSystem::is_file_system_id_Set() const{
    return m_file_system_id_isSet;
}

bool OAIFileSystem::is_file_system_id_Valid() const{
    return m_file_system_id_isValid;
}

OAIFileSystemType OAIFileSystem::getFileSystemType() const {
    return m_file_system_type;
}
void OAIFileSystem::setFileSystemType(const OAIFileSystemType &file_system_type) {
    m_file_system_type = file_system_type;
    m_file_system_type_isSet = true;
}

bool OAIFileSystem::is_file_system_type_Set() const{
    return m_file_system_type_isSet;
}

bool OAIFileSystem::is_file_system_type_Valid() const{
    return m_file_system_type_isValid;
}

OAIFileSystemLifecycle OAIFileSystem::getLifecycle() const {
    return m_lifecycle;
}
void OAIFileSystem::setLifecycle(const OAIFileSystemLifecycle &lifecycle) {
    m_lifecycle = lifecycle;
    m_lifecycle_isSet = true;
}

bool OAIFileSystem::is_lifecycle_Set() const{
    return m_lifecycle_isSet;
}

bool OAIFileSystem::is_lifecycle_Valid() const{
    return m_lifecycle_isValid;
}

OAIFileSystemFailureDetails OAIFileSystem::getFailureDetails() const {
    return m_failure_details;
}
void OAIFileSystem::setFailureDetails(const OAIFileSystemFailureDetails &failure_details) {
    m_failure_details = failure_details;
    m_failure_details_isSet = true;
}

bool OAIFileSystem::is_failure_details_Set() const{
    return m_failure_details_isSet;
}

bool OAIFileSystem::is_failure_details_Valid() const{
    return m_failure_details_isValid;
}

qint32 OAIFileSystem::getStorageCapacity() const {
    return m_storage_capacity;
}
void OAIFileSystem::setStorageCapacity(const qint32 &storage_capacity) {
    m_storage_capacity = storage_capacity;
    m_storage_capacity_isSet = true;
}

bool OAIFileSystem::is_storage_capacity_Set() const{
    return m_storage_capacity_isSet;
}

bool OAIFileSystem::is_storage_capacity_Valid() const{
    return m_storage_capacity_isValid;
}

OAIStorageType OAIFileSystem::getStorageType() const {
    return m_storage_type;
}
void OAIFileSystem::setStorageType(const OAIStorageType &storage_type) {
    m_storage_type = storage_type;
    m_storage_type_isSet = true;
}

bool OAIFileSystem::is_storage_type_Set() const{
    return m_storage_type_isSet;
}

bool OAIFileSystem::is_storage_type_Valid() const{
    return m_storage_type_isValid;
}

QString OAIFileSystem::getVpcId() const {
    return m_vpc_id;
}
void OAIFileSystem::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAIFileSystem::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAIFileSystem::is_vpc_id_Valid() const{
    return m_vpc_id_isValid;
}

QList OAIFileSystem::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIFileSystem::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIFileSystem::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIFileSystem::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAIFileSystem::getNetworkInterfaceIds() const {
    return m_network_interface_ids;
}
void OAIFileSystem::setNetworkInterfaceIds(const QList &network_interface_ids) {
    m_network_interface_ids = network_interface_ids;
    m_network_interface_ids_isSet = true;
}

bool OAIFileSystem::is_network_interface_ids_Set() const{
    return m_network_interface_ids_isSet;
}

bool OAIFileSystem::is_network_interface_ids_Valid() const{
    return m_network_interface_ids_isValid;
}

QString OAIFileSystem::getDnsName() const {
    return m_dns_name;
}
void OAIFileSystem::setDnsName(const QString &dns_name) {
    m_dns_name = dns_name;
    m_dns_name_isSet = true;
}

bool OAIFileSystem::is_dns_name_Set() const{
    return m_dns_name_isSet;
}

bool OAIFileSystem::is_dns_name_Valid() const{
    return m_dns_name_isValid;
}

QString OAIFileSystem::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIFileSystem::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIFileSystem::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIFileSystem::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

QString OAIFileSystem::getResourceArn() const {
    return m_resource_arn;
}
void OAIFileSystem::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIFileSystem::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIFileSystem::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QList OAIFileSystem::getTags() const {
    return m_tags;
}
void OAIFileSystem::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIFileSystem::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIFileSystem::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIFileSystem_WindowsConfiguration OAIFileSystem::getWindowsConfiguration() const {
    return m_windows_configuration;
}
void OAIFileSystem::setWindowsConfiguration(const OAIFileSystem_WindowsConfiguration &windows_configuration) {
    m_windows_configuration = windows_configuration;
    m_windows_configuration_isSet = true;
}

bool OAIFileSystem::is_windows_configuration_Set() const{
    return m_windows_configuration_isSet;
}

bool OAIFileSystem::is_windows_configuration_Valid() const{
    return m_windows_configuration_isValid;
}

OAILustreFileSystemConfiguration OAIFileSystem::getLustreConfiguration() const {
    return m_lustre_configuration;
}
void OAIFileSystem::setLustreConfiguration(const OAILustreFileSystemConfiguration &lustre_configuration) {
    m_lustre_configuration = lustre_configuration;
    m_lustre_configuration_isSet = true;
}

bool OAIFileSystem::is_lustre_configuration_Set() const{
    return m_lustre_configuration_isSet;
}

bool OAIFileSystem::is_lustre_configuration_Valid() const{
    return m_lustre_configuration_isValid;
}

QList OAIFileSystem::getAdministrativeActions() const {
    return m_administrative_actions;
}
void OAIFileSystem::setAdministrativeActions(const QList &administrative_actions) {
    m_administrative_actions = administrative_actions;
    m_administrative_actions_isSet = true;
}

bool OAIFileSystem::is_administrative_actions_Set() const{
    return m_administrative_actions_isSet;
}

bool OAIFileSystem::is_administrative_actions_Valid() const{
    return m_administrative_actions_isValid;
}

OAIFileSystem_OntapConfiguration OAIFileSystem::getOntapConfiguration() const {
    return m_ontap_configuration;
}
void OAIFileSystem::setOntapConfiguration(const OAIFileSystem_OntapConfiguration &ontap_configuration) {
    m_ontap_configuration = ontap_configuration;
    m_ontap_configuration_isSet = true;
}

bool OAIFileSystem::is_ontap_configuration_Set() const{
    return m_ontap_configuration_isSet;
}

bool OAIFileSystem::is_ontap_configuration_Valid() const{
    return m_ontap_configuration_isValid;
}

QString OAIFileSystem::getFileSystemTypeVersion() const {
    return m_file_system_type_version;
}
void OAIFileSystem::setFileSystemTypeVersion(const QString &file_system_type_version) {
    m_file_system_type_version = file_system_type_version;
    m_file_system_type_version_isSet = true;
}

bool OAIFileSystem::is_file_system_type_version_Set() const{
    return m_file_system_type_version_isSet;
}

bool OAIFileSystem::is_file_system_type_version_Valid() const{
    return m_file_system_type_version_isValid;
}

OAIFileSystem_OpenZFSConfiguration OAIFileSystem::getOpenZfsConfiguration() const {
    return m_open_zfs_configuration;
}
void OAIFileSystem::setOpenZfsConfiguration(const OAIFileSystem_OpenZFSConfiguration &open_zfs_configuration) {
    m_open_zfs_configuration = open_zfs_configuration;
    m_open_zfs_configuration_isSet = true;
}

bool OAIFileSystem::is_open_zfs_configuration_Set() const{
    return m_open_zfs_configuration_isSet;
}

bool OAIFileSystem::is_open_zfs_configuration_Valid() const{
    return m_open_zfs_configuration_isValid;
}

bool OAIFileSystem::isSet() const {
...
bool OAIFileSystem::isValid() const {
