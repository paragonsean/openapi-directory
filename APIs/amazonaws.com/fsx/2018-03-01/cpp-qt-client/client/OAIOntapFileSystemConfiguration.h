...
/*
 * OAIOntapFileSystemConfiguration.h
 *
 * Configuration for the FSx for NetApp ONTAP file system.
 */

#ifndef OAIOntapFileSystemConfiguration_H
#define OAIOntapFileSystemConfiguration_H
...
class OAIOntapFileSystemConfiguration : public OAIObject {
public:
    OAIOntapFileSystemConfiguration();
    OAIOntapFileSystemConfiguration(QString json);
    ~OAIOntapFileSystemConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOntapFileSystemConfiguration)

#endif // OAIOntapFileSystemConfiguration_H
