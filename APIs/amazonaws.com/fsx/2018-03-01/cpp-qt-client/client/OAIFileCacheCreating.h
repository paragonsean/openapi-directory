...
class OAIFileCacheCreating : public OAIObject {
public:
    OAIFileCacheCreating();
    OAIFileCacheCreating(QString json);
    ~OAIFileCacheCreating() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileCacheCreating)

#endif // OAIFileCacheCreating_H
