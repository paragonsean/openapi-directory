...
/*
 * OAICreateOpenZFSVolumeConfiguration.h
 *
 * Specifies the configuration of the Amazon FSx for OpenZFS volume that you are creating.
 */

#ifndef OAICreateOpenZFSVolumeConfiguration_H
#define OAICreateOpenZFSVolumeConfiguration_H
...
class OAICreateOpenZFSVolumeConfiguration : public OAIObject {
public:
    OAICreateOpenZFSVolumeConfiguration();
    OAICreateOpenZFSVolumeConfiguration(QString json);
    ~OAICreateOpenZFSVolumeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOpenZFSVolumeConfiguration)

#endif // OAICreateOpenZFSVolumeConfiguration_H
