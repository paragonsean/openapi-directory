...
#ifndef OAIVolumeFilter_H
#define OAIVolumeFilter_H
...
class OAIVolumeFilter : public OAIObject {
public:
    OAIVolumeFilter();
    OAIVolumeFilter(QString json);
    ~OAIVolumeFilter() override;
    ...
    OAIVolumeFilterName getName() const;
    void setName(const OAIVolumeFilterName &name);
...
Q_DECLARE_METATYPE(OpenAPI::OAIVolumeFilter)

#endif // OAIVolumeFilter_H
