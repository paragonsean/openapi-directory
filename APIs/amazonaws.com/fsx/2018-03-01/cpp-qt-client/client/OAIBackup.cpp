...
OAIBackupLifecycle OAIBackup::getLifecycle() const {
    return m_lifecycle;
}
void OAIBackup::setLifecycle(const OAIBackupLifecycle &lifecycle) {
    m_lifecycle = lifecycle;
    m_lifecycle_isSet = true;
}

bool OAIBackup::is_lifecycle_Set() const{
    return m_lifecycle_isSet;
}

bool OAIBackup::is_lifecycle_Valid() const{
    return m_lifecycle_isValid;
}

OAIBackup_FailureDetails OAIBackup::getFailureDetails() const {
    return m_failure_details;
}
void OAIBackup::setFailureDetails(const OAIBackup_FailureDetails &failure_details) {
    m_failure_details = failure_details;
    m_failure_details_isSet = true;
}

bool OAIBackup::is_failure_details_Set() const{
    return m_failure_details_isSet;
}

bool OAIBackup::is_failure_details_Valid() const{
    return m_failure_details_isValid;
}

OAIBackupType OAIBackup::getType() const {
    return m_type;
}
void OAIBackup::setType(const OAIBackupType &type) {
    m_type = type;
    m_type_isSet = true;
}
...
qint32 OAIBackup::getProgressPercent() const {
    return m_progress_percent;
}
void OAIBackup::setProgressPercent(const qint32 &progress_percent) {
    m_progress_percent = progress_percent;
    m_progress_percent_isSet = true;
}

bool OAIBackup::is_progress_percent_Set() const{
    return m_progress_percent_isSet;
}

bool OAIBackup::is_progress_percent_Valid() const{
    return m_progress_percent_isValid;
}

QDateTime OAIBackup::getCreationTime() const {
    return m_creation_time;
}
void OAIBackup::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIBackup::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIBackup::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QString OAIBackup::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIBackup::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIBackup::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIBackup::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

QString OAIBackup::getResourceArn() const {
    return m_resource_arn;
}
void OAIBackup::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIBackup::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIBackup::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QList OAIBackup::getTags() const {
    return m_tags;
}
void OAIBackup::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIBackup::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIBackup::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIBackup_FileSystem OAIBackup::getFileSystem() const {
    return m_file_system;
}
void OAIBackup::setFileSystem(const OAIBackup_FileSystem &file_system) {
    m_file_system = file_system;
    m_file_system_isSet = true;
}

bool OAIBackup::is_file_system_Set() const{
    return m_file_system_isSet;
}

bool OAIBackup::is_file_system_Valid() const{
    return m_file_system_isValid;
}

OAIBackup_DirectoryInformation OAIBackup::getDirectoryInformation() const {
    return m_directory_information;
}
void OAIBackup::setDirectoryInformation(const OAIBackup_DirectoryInformation &directory_information) {
    m_directory_information = directory_information;
    m_directory_information_isSet = true;
}

bool OAIBackup::is_directory_information_Set() const{
    return m_directory_information_isSet;
}

bool OAIBackup::is_directory_information_Valid() const{
    return m_directory_information_isValid;
}

QString OAIBackup::getOwnerId() const {
    return m_owner_id;
}
void OAIBackup::setOwnerId(const QString &owner_id) {
    m_owner_id = owner_id;
    m_owner_id_isSet = true;
}

bool OAIBackup::is_owner_id_Set() const{
    return m_owner_id_isSet;
}

bool OAIBackup::is_owner_id_Valid() const{
    return m_owner_id_isValid;
}

QString OAIBackup::getSourceBackupId() const {
    return m_source_backup_id;
}
void OAIBackup::setSourceBackupId(const QString &source_backup_id) {
    m_source_backup_id = source_backup_id;
    m_source_backup_id_isSet = true;
}

bool OAIBackup::is_source_backup_id_Set() const{
    return m_source_backup_id_isSet;
}

bool OAIBackup::is_source_backup_id_Valid() const{
    return m_source_backup_id_isValid;
}

QString OAIBackup::getSourceBackupRegion() const {
    return m_source_backup_region;
}
void OAIBackup::setSourceBackupRegion(const QString &source_backup_region) {
    m_source_backup_region = source_backup_region;
    m_source_backup_region_isSet = true;
}

bool OAIBackup::is_source_backup_region_Set() const{
    return m_source_backup_region_isSet;
}

bool OAIBackup::is_source_backup_region_Valid() const{
    return m_source_backup_region_isValid;
}

OAIResourceType OAIBackup::getResourceType() const {
    return m_resource_type;
}
void OAIBackup::setResourceType(const OAIResourceType &resource_type) {
    m_resource_type = resource_type;
    m_resource_type_isSet = true;
}

bool OAIBackup::is_resource_type_Set() const{
    return m_resource_type_isSet;
}

bool OAIBackup::is_resource_type_Valid() const{
    return m_resource_type_isValid;
}

OAIVolume OAIBackup::getVolume() const {
    return m_volume;
}
void OAIBackup::setVolume(const OAIVolume &volume) {
    m_volume = volume;
    m_volume_isSet = true;
}

bool OAIBackup::is_volume_Set() const{
    return m_volume_isSet;
}

bool OAIBackup::is_volume_Valid() const{
