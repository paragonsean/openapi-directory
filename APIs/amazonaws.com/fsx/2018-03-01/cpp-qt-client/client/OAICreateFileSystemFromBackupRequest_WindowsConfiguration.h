...
/*
 * OAICreateFileSystemFromBackupRequest_WindowsConfiguration.h
 *
 * 
 */

#ifndef OAICreateFileSystemFromBackupRequest_WindowsConfiguration_H
#define OAICreateFileSystemFromBackupRequest_WindowsConfiguration_H
...
class OAICreateFileSystemFromBackupRequest_WindowsConfiguration : public OAIObject {
public:
    OAICreateFileSystemFromBackupRequest_WindowsConfiguration();
    OAICreateFileSystemFromBackupRequest_WindowsConfiguration(QString json);
    ~OAICreateFileSystemFromBackupRequest_WindowsConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFileSystemFromBackupRequest_WindowsConfiguration)

#endif // OAICreateFileSystemFromBackupRequest_WindowsConfiguration_H
