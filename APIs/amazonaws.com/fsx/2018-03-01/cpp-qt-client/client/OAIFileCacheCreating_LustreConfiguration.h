...
/*
 * OAIFileCacheCreating_LustreConfiguration.h
 *
 * 
 */

#ifndef OAIFileCacheCreating_LustreConfiguration_H
#define OAIFileCacheCreating_LustreConfiguration_H
...
class OAIFileCacheCreating_LustreConfiguration : public OAIObject {
public:
    OAIFileCacheCreating_LustreConfiguration();
    OAIFileCacheCreating_LustreConfiguration(QString json);
    ~OAIFileCacheCreating_LustreConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileCacheCreating_LustreConfiguration)

#endif // OAIFileCacheCreating_LustreConfiguration_H
