...
/*
 * OAICreateStorageVirtualMachineResponse_StorageVirtualMachine.h
 *
 * 
 */

#ifndef OAICreateStorageVirtualMachineResponse_StorageVirtualMachine_H
#define OAICreateStorageVirtualMachineResponse_StorageVirtualMachine_H
...
class OAICreateStorageVirtualMachineResponse_StorageVirtualMachine : public OAIObject {
public:
    OAICreateStorageVirtualMachineResponse_StorageVirtualMachine();
    OAICreateStorageVirtualMachineResponse_StorageVirtualMachine(QString json);
    ~OAICreateStorageVirtualMachineResponse_StorageVirtualMachine() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStorageVirtualMachineResponse_StorageVirtualMachine)

#endif // OAICreateStorageVirtualMachineResponse_StorageVirtualMachine_H
