...
/*
 * OAIUpdateFileSystemResponse_FileSystem.h
 *
 * 
 */

#ifndef OAIUpdateFileSystemResponse_FileSystem_H
#define OAIUpdateFileSystemResponse_FileSystem_H
...
class OAIUpdateFileSystemResponse_FileSystem : public OAIObject {
public:
    OAIUpdateFileSystemResponse_FileSystem();
    OAIUpdateFileSystemResponse_FileSystem(QString json);
    ~OAIUpdateFileSystemResponse_FileSystem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFileSystemResponse_FileSystem)

#endif // OAIUpdateFileSystemResponse_FileSystem_H
