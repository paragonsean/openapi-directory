...
OAIBackup_FileSystem::OAIBackup_FileSystem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBackup_FileSystem::OAIBackup_FileSystem() {
    this->initializeModel();
}

OAIBackup_FileSystem::~OAIBackup_FileSystem() {}

void OAIBackup_FileSystem::initializeModel() {
...
void OAIBackup_FileSystem::fromJson(QString jsonString) {
...
void OAIBackup_FileSystem::fromJsonObject(QJsonObject json) {
...
QString OAIBackup_FileSystem::asJson() const {
...
QJsonObject OAIBackup_FileSystem::asJsonObject() const {
    QJsonObject obj;
    if (m_owner_id_isSet) {
...
QString OAIBackup_FileSystem::getOwnerId() const {
    return m_owner_id;
}
void OAIBackup_FileSystem::setOwnerId(const QString &owner_id) {
    m_owner_id = owner_id;
    m_owner_id_isSet = true;
}

bool OAIBackup_FileSystem::is_owner_id_Set() const{
    return m_owner_id_isSet;
}

bool OAIBackup_FileSystem::is_owner_id_Valid() const{
    return m_owner_id_isValid;
}

QDateTime OAIBackup_FileSystem::getCreationTime() const {
    return m_creation_time;
}
void OAIBackup_FileSystem::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIBackup_FileSystem::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIBackup_FileSystem::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QString OAIBackup_FileSystem::getFileSystemId() const {
    return m_file_system_id;
}
void OAIBackup_FileSystem::setFileSystemId(const QString &file_system_id) {
    m_file_system_id = file_system_id;
    m_file_system_id_isSet = true;
}

bool OAIBackup_FileSystem::is_file_system_id_Set() const{
    return m_file_system_id_isSet;
}

bool OAIBackup_FileSystem::is_file_system_id_Valid() const{
    return m_file_system_id_isValid;
}

OAIFileSystemType OAIBackup_FileSystem::getFileSystemType() const {
    return m_file_system_type;
}
void OAIBackup_FileSystem::setFileSystemType(const OAIFileSystemType &file_system_type) {
    m_file_system_type = file_system_type;
    m_file_system_type_isSet = true;
}

bool OAIBackup_FileSystem::is_file_system_type_Set() const{
    return m_file_system_type_isSet;
}

bool OAIBackup_FileSystem::is_file_system_type_Valid() const{
    return m_file_system_type_isValid;
}

OAIFileSystemLifecycle OAIBackup_FileSystem::getLifecycle() const {
    return m_lifecycle;
}
void OAIBackup_FileSystem::setLifecycle(const OAIFileSystemLifecycle &lifecycle) {
    m_lifecycle = lifecycle;
    m_lifecycle_isSet = true;
}

bool OAIBackup_FileSystem::is_lifecycle_Set() const{
    return m_lifecycle_isSet;
}

bool OAIBackup_FileSystem::is_lifecycle_Valid() const{
    return m_lifecycle_isValid;
}

OAIFileSystemFailureDetails OAIBackup_FileSystem::getFailureDetails() const {
    return m_failure_details;
}
void OAIBackup_FileSystem::setFailureDetails(const OAIFileSystemFailureDetails &failure_details) {
    m_failure_details = failure_details;
    m_failure_details_isSet = true;
}

bool OAIBackup_FileSystem::is_failure_details_Set() const{
    return m_failure_details_isSet;
}

bool OAIBackup_FileSystem::is_failure_details_Valid() const{
    return m_failure_details_isValid;
}

qint32 OAIBackup_FileSystem::getStorageCapacity() const {
    return m_storage_capacity;
}
void OAIBackup_FileSystem::setStorageCapacity(const qint32 &storage_capacity) {
    m_storage_capacity = storage_capacity;
    m_storage_capacity_isSet = true;
}

bool OAIBackup_FileSystem::is_storage_capacity_Set() const{
    return m_storage_capacity_isSet;
}

bool OAIBackup_FileSystem::is_storage_capacity_Valid() const{
    return m_storage_capacity_isValid;
}

OAIStorageType OAIBackup_FileSystem::getStorageType() const {
    return m_storage_type;
}
void OAIBackup_FileSystem::setStorageType(const OAIStorageType &storage_type) {
    m_storage_type = storage_type;
    m_storage_type_isSet = true;
}

bool OAIBackup_FileSystem::is_storage_type_Set() const{
    return m_storage_type_isSet;
}

bool OAIBackup_FileSystem::is_storage_type_Valid() const{
    return m_storage_type_isValid;
}

QString OAIBackup_FileSystem::getVpcId() const {
    return m_vpc_id;
}
void OAIBackup_FileSystem::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAIBackup_FileSystem::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAIBackup_FileSystem::is_vpc_id_Valid() const{
    return m_vpc_id_isValid;
}

QList OAIBackup_FileSystem::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIBackup_FileSystem::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIBackup_FileSystem::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIBackup_FileSystem::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAIBackup_FileSystem::getNetworkInterfaceIds() const {
    return m_network_interface_ids;
}
void OAIBackup_FileSystem::setNetworkInterfaceIds(const QList &network_interface_ids) {
    m_network_interface_ids = network_interface_ids;
    m_network_interface_ids_isSet = true;
}

bool OAIBackup_FileSystem::is_network_interface_ids_Set() const{
    return m_network_interface_ids_isSet;
}

bool OAIBackup_FileSystem::is_network_interface_ids_Valid() const{
    return m_network_interface_ids_isValid;
}

QString OAIBackup_FileSystem::getDnsName() const {
    return m_dns_name;
}
void OAIBackup_FileSystem::setDnsName(const QString &dns_name) {
    m_dns_name = dns_name;
    m_dns_name_isSet = true;
}

bool OAIBackup_FileSystem::is_dns_name_Set() const{
    return m_dns_name_isSet;
}

bool OAIBackup_FileSystem::is_dns_name_Valid() const{
    return m_dns_name_isValid;
}

QString OAIBackup_FileSystem::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIBackup_FileSystem::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIBackup_FileSystem::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIBackup_FileSystem::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

QString OAIBackup_FileSystem::getResourceArn() const {
    return m_resource_arn;
}
void OAIBackup_FileSystem::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIBackup_FileSystem::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIBackup_FileSystem::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QList OAIBackup_FileSystem::getTags() const {
    return m_tags;
}
void OAIBackup_FileSystem::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIBackup_FileSystem::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIBackup_FileSystem::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIFileSystem_WindowsConfiguration OAIBackup_FileSystem::getWindowsConfiguration() const {
    return m_windows_configuration;
}
void OAIBackup_FileSystem::setWindowsConfiguration(const OAIFileSystem_WindowsConfiguration &windows_configuration) {
    m_windows_configuration = windows_configuration;
    m_windows_configuration_isSet = true;
}

bool OAIBackup_FileSystem::is_windows_configuration_Set() const{
    return m_windows_configuration_isSet;
}

bool OAIBackup_FileSystem::is_windows_configuration_Valid() const{
    return m_windows_configuration_isValid;
}

OAILustreFileSystemConfiguration OAIBackup_FileSystem::getLustreConfiguration() const {
    return m_lustre_configuration;
}
void OAIBackup_FileSystem::setLustreConfiguration(const OAILustreFileSystemConfiguration &lustre_configuration) {
    m_lustre_configuration = lustre_configuration;
    m_lustre_configuration_isSet = true;
}

bool OAIBackup_FileSystem::is_lustre_configuration_Set() const{
    return m_lustre_configuration_isSet;
}

bool OAIBackup_FileSystem::is_lustre_configuration_Valid() const{
    return m_lustre_configuration_isValid;
}

QList OAIBackup_FileSystem::getAdministrativeActions() const {
    return m_administrative_actions;
}
void OAIBackup_FileSystem::setAdministrativeActions(const QList &administrative_actions) {
    m_administrative_actions = administrative_actions;
    m_administrative_actions_isSet = true;
}

bool OAIBackup_FileSystem::is_administrative_actions_Set() const{
    return m_administrative_actions_isSet;
}

bool OAIBackup_FileSystem::is_administrative_actions_Valid() const{
    return m_administrative_actions_isValid;
}

OAIFileSystem_OntapConfiguration OAIBackup_FileSystem::getOntapConfiguration() const {
    return m_ontap_configuration;
}
void OAIBackup_FileSystem::setOntapConfiguration(const OAIFileSystem_OntapConfiguration &ontap_configuration) {
    m_ontap_configuration = ontap_configuration;
    m_ontap_configuration_isSet = true;
}

bool OAIBackup_FileSystem::is_ontap_configuration_Set() const{
    return m_ontap_configuration_isSet;
}

bool OAIBackup_FileSystem::is_ontap_configuration_Valid() const{
    return m_ontap_configuration_isValid;
}

QString OAIBackup_FileSystem::getFileSystemTypeVersion() const {
    return m_file_system_type_version;
}
void OAIBackup_FileSystem::setFileSystemTypeVersion(const QString &file_system_type_version) {
    m_file_system_type_version = file_system_type_version;
    m_file_system_type_version_isSet = true;
}

bool OAIBackup_FileSystem::is_file_system_type_version_Set() const{
    return m_file_system_type_version_isSet;
}

bool OAIBackup_FileSystem::is_file_system_type_version_Valid() const{
    return m_file_system_type_version_isValid;
}

OAIFileSystem_OpenZFSConfiguration OAIBackup_FileSystem::getOpenZfsConfiguration() const {
    return m_open_zfs_configuration;
}
void OAIBackup_FileSystem::setOpenZfsConfiguration(const OAIFileSystem_OpenZFSConfiguration &open_zfs_configuration) {
    m_open_zfs_configuration = open_zfs_configuration;
    m_open_zfs_configuration_isSet = true;
}

bool OAIBackup_FileSystem::is_open_zfs_configuration_Set() const{
    return m_open_zfs_configuration_isSet;
}

bool OAIBackup_FileSystem::is_open_zfs_configuration_Valid() const{
    return m_open_zfs_configuration_isValid;
}

bool OAIBackup_FileSystem::isSet() const {
...
bool OAIBackup_FileSystem::isValid() const {
