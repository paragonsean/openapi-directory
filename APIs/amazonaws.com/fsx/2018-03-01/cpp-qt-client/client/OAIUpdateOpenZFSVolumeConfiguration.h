...
/*
 * OAIUpdateOpenZFSVolumeConfiguration.h
 *
 * Used to specify changes to the OpenZFS configuration for the volume that you are updating.
 */

#ifndef OAIUpdateOpenZFSVolumeConfiguration_H
#define OAIUpdateOpenZFSVolumeConfiguration_H
...
class OAIUpdateOpenZFSVolumeConfiguration : public OAIObject {
public:
    OAIUpdateOpenZFSVolumeConfiguration();
    OAIUpdateOpenZFSVolumeConfiguration(QString json);
    ~OAIUpdateOpenZFSVolumeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOpenZFSVolumeConfiguration)

#endif // OAIUpdateOpenZFSVolumeConfiguration_H
