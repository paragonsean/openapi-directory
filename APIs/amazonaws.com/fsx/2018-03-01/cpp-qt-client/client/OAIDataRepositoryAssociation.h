...
/*
 * OAIDataRepositoryAssociation.h
 *
...
#ifndef OAIDataRepositoryAssociation_H
#define OAIDataRepositoryAssociation_H
...
class OAIDataRepositoryAssociation : public OAIObject {
public:
    OAIDataRepositoryAssociation();
    OAIDataRepositoryAssociation(QString json);
    ~OAIDataRepositoryAssociation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataRepositoryAssociation)

#endif // OAIDataRepositoryAssociation_H
