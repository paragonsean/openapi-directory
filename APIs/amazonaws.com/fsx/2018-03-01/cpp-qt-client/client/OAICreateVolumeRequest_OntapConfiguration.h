...
/*
 * OAICreateVolumeRequest_OntapConfiguration.h
 *
 * 
 */

#ifndef OAICreateVolumeRequest_OntapConfiguration_H
#define OAICreateVolumeRequest_OntapConfiguration_H
...
class OAICreateVolumeRequest_OntapConfiguration : public OAIObject {
public:
    OAICreateVolumeRequest_OntapConfiguration();
    OAICreateVolumeRequest_OntapConfiguration(QString json);
    ~OAICreateVolumeRequest_OntapConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVolumeRequest_OntapConfiguration)

#endif // OAICreateVolumeRequest_OntapConfiguration_H
