...
/*
 * OAIDeleteFileCacheRequest.h
 *
 * 
 */

#ifndef OAIDeleteFileCacheRequest_H
#define OAIDeleteFileCacheRequest_H
...
class OAIDeleteFileCacheRequest : public OAIObject {
public:
    OAIDeleteFileCacheRequest();
    OAIDeleteFileCacheRequest(QString json);
    ~OAIDeleteFileCacheRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFileCacheRequest)

#endif // OAIDeleteFileCacheRequest_H
