...
/*
 * OAICreateOntapVolumeConfiguration.h
 *
 * Specifies the configuration of the ONTAP volume that you are creating.
 */

#ifndef OAICreateOntapVolumeConfiguration_H
#define OAICreateOntapVolumeConfiguration_H
...
class OAICreateOntapVolumeConfiguration : public OAIObject {
public:
    OAICreateOntapVolumeConfiguration();
    OAICreateOntapVolumeConfiguration(QString json);
    ~OAICreateOntapVolumeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOntapVolumeConfiguration)

#endif // OAICreateOntapVolumeConfiguration_H
