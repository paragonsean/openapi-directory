...
#ifndef OAIFileSystem_H
#define OAIFileSystem_H
...
class OAIFileSystem : public OAIObject {
public:
    OAIFileSystem();
    OAIFileSystem(QString json);
    ~OAIFileSystem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileSystem)

#endif // OAIFileSystem_H
