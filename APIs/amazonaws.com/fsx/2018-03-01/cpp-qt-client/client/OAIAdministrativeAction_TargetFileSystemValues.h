...
/*
 * OAIAdministrativeAction_TargetFileSystemValues.h
 *
 * 
 */

#ifndef OAIAdministrativeAction_TargetFileSystemValues_H
#define OAIAdministrativeAction_TargetFileSystemValues_H
...
class OAIAdministrativeAction_TargetFileSystemValues : public OAIObject {
public:
    OAIAdministrativeAction_TargetFileSystemValues();
    OAIAdministrativeAction_TargetFileSystemValues(QString json);
    ~OAIAdministrativeAction_TargetFileSystemValues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdministrativeAction_TargetFileSystemValues)

#endif // OAIAdministrativeAction_TargetFileSystemValues_H
