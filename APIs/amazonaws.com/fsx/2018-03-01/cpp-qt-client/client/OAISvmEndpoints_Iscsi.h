...
/*
 * OAISvmEndpoints_Iscsi.h
 *
 * 
 */

#ifndef OAISvmEndpoints_Iscsi_H
#define OAISvmEndpoints_Iscsi_H
...
class OAISvmEndpoints_Iscsi : public OAIObject {
public:
    OAISvmEndpoints_Iscsi();
    OAISvmEndpoints_Iscsi(QString json);
    ~OAISvmEndpoints_Iscsi() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISvmEndpoints_Iscsi)

#endif // OAISvmEndpoints_Iscsi_H
