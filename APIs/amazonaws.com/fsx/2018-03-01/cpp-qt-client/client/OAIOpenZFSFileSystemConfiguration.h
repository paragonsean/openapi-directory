...
/*
 * OAIOpenZFSFileSystemConfiguration.h
 *
 * The configuration for the Amazon FSx for OpenZFS file system. 
 */

#ifndef OAIOpenZFSFileSystemConfiguration_H
#define OAIOpenZFSFileSystemConfiguration_H
...
class OAIOpenZFSFileSystemConfiguration : public OAIObject {
public:
    OAIOpenZFSFileSystemConfiguration();
    OAIOpenZFSFileSystemConfiguration(QString json);
    ~OAIOpenZFSFileSystemConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOpenZFSFileSystemConfiguration)

#endif // OAIOpenZFSFileSystemConfiguration_H
