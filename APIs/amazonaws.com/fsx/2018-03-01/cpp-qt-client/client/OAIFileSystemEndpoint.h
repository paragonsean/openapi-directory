...
#ifndef OAIFileSystemEndpoint_H
#define OAIFileSystemEndpoint_H
...
class OAIFileSystemEndpoint : public OAIObject {
public:
    OAIFileSystemEndpoint();
    OAIFileSystemEndpoint(QString json);
    ~OAIFileSystemEndpoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileSystemEndpoint)

#endif // OAIFileSystemEndpoint_H
