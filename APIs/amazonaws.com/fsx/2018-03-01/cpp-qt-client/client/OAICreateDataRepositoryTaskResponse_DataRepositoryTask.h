...
/*
 * OAICreateDataRepositoryTaskResponse_DataRepositoryTask.h
 *
 * 
 */

#ifndef OAICreateDataRepositoryTaskResponse_DataRepositoryTask_H
#define OAICreateDataRepositoryTaskResponse_DataRepositoryTask_H
...
class OAICreateDataRepositoryTaskResponse_DataRepositoryTask : public OAIObject {
public:
    OAICreateDataRepositoryTaskResponse_DataRepositoryTask();
    OAICreateDataRepositoryTaskResponse_DataRepositoryTask(QString json);
    ~OAICreateDataRepositoryTaskResponse_DataRepositoryTask() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDataRepositoryTaskResponse_DataRepositoryTask)

#endif // OAICreateDataRepositoryTaskResponse_DataRepositoryTask_H
