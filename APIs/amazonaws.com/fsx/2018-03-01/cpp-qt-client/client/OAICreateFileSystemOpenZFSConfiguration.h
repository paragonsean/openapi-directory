...
/*
 * OAICreateFileSystemOpenZFSConfiguration.h
 *
 * The Amazon FSx for OpenZFS configuration properties for the file system that you are creating.
 */

#ifndef OAICreateFileSystemOpenZFSConfiguration_H
#define OAICreateFileSystemOpenZFSConfiguration_H
...
class OAICreateFileSystemOpenZFSConfiguration : public OAIObject {
public:
    OAICreateFileSystemOpenZFSConfiguration();
    OAICreateFileSystemOpenZFSConfiguration(QString json);
    ~OAICreateFileSystemOpenZFSConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFileSystemOpenZFSConfiguration)

#endif // OAICreateFileSystemOpenZFSConfiguration_H
