...
/*
 * OAICreateFileSystemResponse_FileSystem.h
 *
 * 
 */

#ifndef OAICreateFileSystemResponse_FileSystem_H
#define OAICreateFileSystemResponse_FileSystem_H
...
class OAICreateFileSystemResponse_FileSystem : public OAIObject {
public:
    OAICreateFileSystemResponse_FileSystem();
    OAICreateFileSystemResponse_FileSystem(QString json);
    ~OAICreateFileSystemResponse_FileSystem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFileSystemResponse_FileSystem)

#endif // OAICreateFileSystemResponse_FileSystem_H
