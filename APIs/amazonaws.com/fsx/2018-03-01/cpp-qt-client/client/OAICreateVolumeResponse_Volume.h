...
/*
 * OAICreateVolumeResponse_Volume.h
 *
 * 
 */

#ifndef OAICreateVolumeResponse_Volume_H
#define OAICreateVolumeResponse_Volume_H
...
class OAICreateVolumeResponse_Volume : public OAIObject {
public:
    OAICreateVolumeResponse_Volume();
    OAICreateVolumeResponse_Volume(QString json);
    ~OAICreateVolumeResponse_Volume() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVolumeResponse_Volume)

#endif // OAICreateVolumeResponse_Volume_H
