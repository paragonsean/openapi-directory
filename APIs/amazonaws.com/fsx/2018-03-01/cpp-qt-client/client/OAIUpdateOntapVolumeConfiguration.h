...
/*
 * OAIUpdateOntapVolumeConfiguration.h
 *
 * Used to specify changes to the ONTAP configuration for the volume you are updating.
 */

#ifndef OAIUpdateOntapVolumeConfiguration_H
#define OAIUpdateOntapVolumeConfiguration_H
...
class OAIUpdateOntapVolumeConfiguration : public OAIObject {
public:
    OAIUpdateOntapVolumeConfiguration();
    OAIUpdateOntapVolumeConfiguration(QString json);
    ~OAIUpdateOntapVolumeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOntapVolumeConfiguration)

#endif // OAIUpdateOntapVolumeConfiguration_H
