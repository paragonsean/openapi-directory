...
/*
 * OAISnaplockConfiguration.h
 *
 * Specifies the SnapLock configuration for an FSx for ONTAP SnapLock volume. 
 */

#ifndef OAISnaplockConfiguration_H
#define OAISnaplockConfiguration_H
...
class OAISnaplockConfiguration : public OAIObject {
public:
    OAISnaplockConfiguration();
    OAISnaplockConfiguration(QString json);
    ~OAISnaplockConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISnaplockConfiguration)

#endif // OAISnaplockConfiguration_H
