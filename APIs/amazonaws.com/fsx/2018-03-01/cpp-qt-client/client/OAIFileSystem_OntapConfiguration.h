...
/*
 * OAIFileSystem_OntapConfiguration.h
 *
 * 
 */

#ifndef OAIFileSystem_OntapConfiguration_H
#define OAIFileSystem_OntapConfiguration_H
...
namespace OpenAPI {
class OAIOntapFileSystemConfiguration_Endpoints;
class OAIOntapFileSystemConfiguration_DiskIopsConfiguration;

class OAIFileSystem_OntapConfiguration : public OAIObject {
public:
    OAIFileSystem_OntapConfiguration();
    OAIFileSystem_OntapConfiguration(QString json);
    ~OAIFileSystem_OntapConfiguration() override;
    ...
    OAIOntapFileSystemConfiguration_Endpoints getEndpoints() const;
    void setEndpoints(const OAIOntapFileSystemConfiguration_Endpoints &endpoints);
    bool is_endpoints_Set() const;
    bool is_endpoints_Valid() const;

    OAIOntapFileSystemConfiguration_DiskIopsConfiguration getDiskIopsConfiguration() const;
    void setDiskIopsConfiguration(const OAIOntapFileSystemConfiguration_DiskIopsConfiguration &disk_iops_configuration);
...
private:
    ...
    OAIOntapFileSystemConfiguration_Endpoints m_endpoints;
    bool m_endpoints_isSet;
    bool m_endpoints_isValid;

    OAIOntapFileSystemConfiguration_DiskIopsConfiguration m_disk_iops_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileSystem_OntapConfiguration)

#endif // OAIFileSystem_OntapConfiguration_H
