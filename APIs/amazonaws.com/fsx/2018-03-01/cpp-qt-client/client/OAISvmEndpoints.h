...
#ifndef OAISvmEndpoints_H
#define OAISvmEndpoints_H
...
class OAISvmEndpoints : public OAIObject {
public:
    OAISvmEndpoints();
    OAISvmEndpoints(QString json);
    ~OAISvmEndpoints() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISvmEndpoints)

#endif // OAISvmEndpoints_H
