...
/*
 * OAIUpdateFileCacheResponse_FileCache.h
 *
 * 
 */

#ifndef OAIUpdateFileCacheResponse_FileCache_H
#define OAIUpdateFileCacheResponse_FileCache_H
...
class OAIUpdateFileCacheResponse_FileCache : public OAIObject {
public:
    OAIUpdateFileCacheResponse_FileCache();
    OAIUpdateFileCacheResponse_FileCache(QString json);
    ~OAIUpdateFileCacheResponse_FileCache() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFileCacheResponse_FileCache)

#endif // OAIUpdateFileCacheResponse_FileCache_H
