...
/*
 * OAICreateFileSystemFromBackupRequest_OpenZFSConfiguration.h
 *
 * 
 */

#ifndef OAICreateFileSystemFromBackupRequest_OpenZFSConfiguration_H
#define OAICreateFileSystemFromBackupRequest_OpenZFSConfiguration_H
...
class OAICreateFileSystemOpenZFSConfiguration_RootVolumeConfiguration;

class OAICreateFileSystemFromBackupRequest_OpenZFSConfiguration : public OAIObject {
public:
    OAICreateFileSystemFromBackupRequest_OpenZFSConfiguration();
    OAICreateFileSystemFromBackupRequest_OpenZFSConfiguration(QString json);
    ~OAICreateFileSystemFromBackupRequest_OpenZFSConfiguration() override;
    ...
    OAICreateFileSystemOpenZFSConfiguration_RootVolumeConfiguration getRootVolumeConfiguration() const;
    void setRootVolumeConfiguration(const OAICreateFileSystemOpenZFSConfiguration_RootVolumeConfiguration &root_volume_configuration);
    bool is_root_volume_configuration_Set() const;
    bool is_root_volume_configuration_Valid() const;
...
private:
    ...
    OAICreateFileSystemOpenZFSConfiguration_RootVolumeConfiguration m_root_volume_configuration;
    bool m_root_volume_configuration_isSet;
    bool m_root_volume_configuration_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateFileSystemFromBackupRequest_OpenZFSConfiguration)

#endif // OAICreateFileSystemFromBackupRequest_OpenZFSConfiguration_H
