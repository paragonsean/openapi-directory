...
#include "OAIUpdateOpenZFSVolumeConfiguration.h"
...
OAIUpdateOpenZFSVolumeConfiguration::OAIUpdateOpenZFSVolumeConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateOpenZFSVolumeConfiguration::OAIUpdateOpenZFSVolumeConfiguration() {
    this->initializeModel();
}

OAIUpdateOpenZFSVolumeConfiguration::~OAIUpdateOpenZFSVolumeConfiguration() {}

void OAIUpdateOpenZFSVolumeConfiguration::initializeModel() {
...
void OAIUpdateOpenZFSVolumeConfiguration::fromJson(QString jsonString) {
...
void OAIUpdateOpenZFSVolumeConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateOpenZFSVolumeConfiguration::asJson() const {
...
QJsonObject OAIUpdateOpenZFSVolumeConfiguration::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIUpdateOpenZFSVolumeConfiguration::getStorageCapacityReservationGiB() const {
    return m_storage_capacity_reservation_gi_b;
}
void OAIUpdateOpenZFSVolumeConfiguration::setStorageCapacityReservationGiB(const qint32 &storage_capacity_reservation_gi_b) {
    m_storage_capacity_reservation_gi_b = storage_capacity_reservation_gi_b;
    m_storage_capacity_reservation_gi_b_isSet = true;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_storage_capacity_reservation_gi_b_Set() const{
    return m_storage_capacity_reservation_gi_b_isSet;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_storage_capacity_reservation_gi_b_Valid() const{
    return m_storage_capacity_reservation_gi_b_isValid;
}

qint32 OAIUpdateOpenZFSVolumeConfiguration::getStorageCapacityQuotaGiB() const {
    return m_storage_capacity_quota_gi_b;
}
void OAIUpdateOpenZFSVolumeConfiguration::setStorageCapacityQuotaGiB(const qint32 &storage_capacity_quota_gi_b) {
    m_storage_capacity_quota_gi_b = storage_capacity_quota_gi_b;
    m_storage_capacity_quota_gi_b_isSet = true;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_storage_capacity_quota_gi_b_Set() const{
    return m_storage_capacity_quota_gi_b_isSet;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_storage_capacity_quota_gi_b_Valid() const{
    return m_storage_capacity_quota_gi_b_isValid;
}

qint32 OAIUpdateOpenZFSVolumeConfiguration::getRecordSizeKiB() const {
    return m_record_size_ki_b;
}
void OAIUpdateOpenZFSVolumeConfiguration::setRecordSizeKiB(const qint32 &record_size_ki_b) {
    m_record_size_ki_b = record_size_ki_b;
    m_record_size_ki_b_isSet = true;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_record_size_ki_b_Set() const{
    return m_record_size_ki_b_isSet;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_record_size_ki_b_Valid() const{
    return m_record_size_ki_b_isValid;
}

OAIOpenZFSDataCompressionType OAIUpdateOpenZFSVolumeConfiguration::getDataCompressionType() const {
    return m_data_compression_type;
}
void OAIUpdateOpenZFSVolumeConfiguration::setDataCompressionType(const OAIOpenZFSDataCompressionType &data_compression_type) {
    m_data_compression_type = data_compression_type;
    m_data_compression_type_isSet = true;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_data_compression_type_Set() const{
    return m_data_compression_type_isSet;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_data_compression_type_Valid() const{
    return m_data_compression_type_isValid;
}

QList OAIUpdateOpenZFSVolumeConfiguration::getNfsExports() const {
    return m_nfs_exports;
}
void OAIUpdateOpenZFSVolumeConfiguration::setNfsExports(const QList &nfs_exports) {
    m_nfs_exports = nfs_exports;
    m_nfs_exports_isSet = true;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_nfs_exports_Set() const{
    return m_nfs_exports_isSet;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_nfs_exports_Valid() const{
    return m_nfs_exports_isValid;
}

QList OAIUpdateOpenZFSVolumeConfiguration::getUserAndGroupQuotas() const {
    return m_user_and_group_quotas;
}
void OAIUpdateOpenZFSVolumeConfiguration::setUserAndGroupQuotas(const QList &user_and_group_quotas) {
    m_user_and_group_quotas = user_and_group_quotas;
    m_user_and_group_quotas_isSet = true;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_user_and_group_quotas_Set() const{
    return m_user_and_group_quotas_isSet;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_user_and_group_quotas_Valid() const{
    return m_user_and_group_quotas_isValid;
}

bool OAIUpdateOpenZFSVolumeConfiguration::getReadOnly() const {
    return m_read_only;
}
void OAIUpdateOpenZFSVolumeConfiguration::setReadOnly(const bool &read_only) {
    m_read_only = read_only;
    m_read_only_isSet = true;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_read_only_Set() const{
    return m_read_only_isSet;
}

bool OAIUpdateOpenZFSVolumeConfiguration::is_read_only_Valid() const{
    return m_read_only_isValid;
}

bool OAIUpdateOpenZFSVolumeConfiguration::isSet() const {
...
bool OAIUpdateOpenZFSVolumeConfiguration::isValid() const {
