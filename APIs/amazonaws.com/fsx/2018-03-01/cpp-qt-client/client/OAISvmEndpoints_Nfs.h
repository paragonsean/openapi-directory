...
/*
 * OAISvmEndpoints_Nfs.h
 *
 * 
 */

#ifndef OAISvmEndpoints_Nfs_H
#define OAISvmEndpoints_Nfs_H
...
class OAISvmEndpoints_Nfs : public OAIObject {
public:
    OAISvmEndpoints_Nfs();
    OAISvmEndpoints_Nfs(QString json);
    ~OAISvmEndpoints_Nfs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISvmEndpoints_Nfs)

#endif // OAISvmEndpoints_Nfs_H
