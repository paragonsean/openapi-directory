...
/*
 * OAICreateFileCacheLustreConfiguration.h
 *
 * The Amazon File Cache configuration for the cache that you are creating.
 */

#ifndef OAICreateFileCacheLustreConfiguration_H
#define OAICreateFileCacheLustreConfiguration_H
...
class OAICreateFileCacheLustreConfiguration : public OAIObject {
public:
    OAICreateFileCacheLustreConfiguration();
    OAICreateFileCacheLustreConfiguration(QString json);
    ~OAICreateFileCacheLustreConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFileCacheLustreConfiguration)

#endif // OAICreateFileCacheLustreConfiguration_H
