...
#include "OAIFileCacheLustreConfiguration.h"
...
OAIFileCacheLustreConfiguration::OAIFileCacheLustreConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFileCacheLustreConfiguration::OAIFileCacheLustreConfiguration() {
    this->initializeModel();
}

OAIFileCacheLustreConfiguration::~OAIFileCacheLustreConfiguration() {}

void OAIFileCacheLustreConfiguration::initializeModel() {
...
void OAIFileCacheLustreConfiguration::fromJson(QString jsonString) {
...
void OAIFileCacheLustreConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIFileCacheLustreConfiguration::asJson() const {
...
QJsonObject OAIFileCacheLustreConfiguration::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIFileCacheLustreConfiguration::getPerUnitStorageThroughput() const {
    return m_per_unit_storage_throughput;
}
void OAIFileCacheLustreConfiguration::setPerUnitStorageThroughput(const qint32 &per_unit_storage_throughput) {
    m_per_unit_storage_throughput = per_unit_storage_throughput;
    m_per_unit_storage_throughput_isSet = true;
}

bool OAIFileCacheLustreConfiguration::is_per_unit_storage_throughput_Set() const{
    return m_per_unit_storage_throughput_isSet;
}

bool OAIFileCacheLustreConfiguration::is_per_unit_storage_throughput_Valid() const{
    return m_per_unit_storage_throughput_isValid;
}

OAIFileCacheLustreDeploymentType OAIFileCacheLustreConfiguration::getDeploymentType() const {
    return m_deployment_type;
}
void OAIFileCacheLustreConfiguration::setDeploymentType(const OAIFileCacheLustreDeploymentType &deployment_type) {
    m_deployment_type = deployment_type;
    m_deployment_type_isSet = true;
}

bool OAIFileCacheLustreConfiguration::is_deployment_type_Set() const{
    return m_deployment_type_isSet;
}

bool OAIFileCacheLustreConfiguration::is_deployment_type_Valid() const{
    return m_deployment_type_isValid;
}

QString OAIFileCacheLustreConfiguration::getMountName() const {
    return m_mount_name;
}
void OAIFileCacheLustreConfiguration::setMountName(const QString &mount_name) {
    m_mount_name = mount_name;
    m_mount_name_isSet = true;
}

bool OAIFileCacheLustreConfiguration::is_mount_name_Set() const{
    return m_mount_name_isSet;
}

bool OAIFileCacheLustreConfiguration::is_mount_name_Valid() const{
    return m_mount_name_isValid;
}

QString OAIFileCacheLustreConfiguration::getWeeklyMaintenanceStartTime() const {
    return m_weekly_maintenance_start_time;
}
void OAIFileCacheLustreConfiguration::setWeeklyMaintenanceStartTime(const QString &weekly_maintenance_start_time) {
    m_weekly_maintenance_start_time = weekly_maintenance_start_time;
    m_weekly_maintenance_start_time_isSet = true;
}

bool OAIFileCacheLustreConfiguration::is_weekly_maintenance_start_time_Set() const{
    return m_weekly_maintenance_start_time_isSet;
}

bool OAIFileCacheLustreConfiguration::is_weekly_maintenance_start_time_Valid() const{
    return m_weekly_maintenance_start_time_isValid;
}

OAICreateFileCacheLustreConfiguration_MetadataConfiguration OAIFileCacheLustreConfiguration::getMetadataConfiguration() const {
    return m_metadata_configuration;
}
void OAIFileCacheLustreConfiguration::setMetadataConfiguration(const OAICreateFileCacheLustreConfiguration_MetadataConfiguration &metadata_configuration) {
    m_metadata_configuration = metadata_configuration;
    m_metadata_configuration_isSet = true;
}

bool OAIFileCacheLustreConfiguration::is_metadata_configuration_Set() const{
    return m_metadata_configuration_isSet;
}

bool OAIFileCacheLustreConfiguration::is_metadata_configuration_Valid() const{
    return m_metadata_configuration_isValid;
}

OAIFileCacheLustreConfiguration_LogConfiguration OAIFileCacheLustreConfiguration::getLogConfiguration() const {
    return m_log_configuration;
}
void OAIFileCacheLustreConfiguration::setLogConfiguration(const OAIFileCacheLustreConfiguration_LogConfiguration &log_configuration) {
    m_log_configuration = log_configuration;
    m_log_configuration_isSet = true;
}

bool OAIFileCacheLustreConfiguration::is_log_configuration_Set() const{
    return m_log_configuration_isSet;
}

bool OAIFileCacheLustreConfiguration::is_log_configuration_Valid() const{
    return m_log_configuration_isValid;
}

bool OAIFileCacheLustreConfiguration::isSet() const {
...
bool OAIFileCacheLustreConfiguration::isValid() const {
