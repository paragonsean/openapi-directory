...
/*
 * OAISvmEndpoints_Management.h
 *
 * 
 */

#ifndef OAISvmEndpoints_Management_H
#define OAISvmEndpoints_Management_H
...
class OAISvmEndpoints_Management : public OAIObject {
public:
    OAISvmEndpoints_Management();
    OAISvmEndpoints_Management(QString json);
    ~OAISvmEndpoints_Management() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISvmEndpoints_Management)

#endif // OAISvmEndpoints_Management_H
