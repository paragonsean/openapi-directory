...
/*
 * OAICreateFileSystemFromBackupResponse_FileSystem.h
 *
 * 
 */

#ifndef OAICreateFileSystemFromBackupResponse_FileSystem_H
#define OAICreateFileSystemFromBackupResponse_FileSystem_H
...
class OAICreateFileSystemFromBackupResponse_FileSystem : public OAIObject {
public:
    OAICreateFileSystemFromBackupResponse_FileSystem();
    OAICreateFileSystemFromBackupResponse_FileSystem(QString json);
    ~OAICreateFileSystemFromBackupResponse_FileSystem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFileSystemFromBackupResponse_FileSystem)

#endif // OAICreateFileSystemFromBackupResponse_FileSystem_H
