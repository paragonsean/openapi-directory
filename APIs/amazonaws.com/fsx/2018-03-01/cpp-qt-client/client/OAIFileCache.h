...
#ifndef OAIFileCache_H
#define OAIFileCache_H
...
class OAIFileCache : public OAIObject {
public:
    OAIFileCache();
    OAIFileCache(QString json);
    ~OAIFileCache() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileCache)

#endif // OAIFileCache_H
