...
void OAIDescribeSnapshotsRequest::initializeModel() {
    ...
    m_snapshot_ids_isSet = false;
    m_snapshot_ids_isValid = false;
...
void OAIDescribeSnapshotsRequest::fromJsonObject(QJsonObject json) {
    ...
    m_snapshot_ids_isValid = ::OpenAPI::fromJsonValue(m_snapshot_ids, json[QString("SnapshotIds")]);
    m_snapshot_ids_isSet = !json[QString("SnapshotIds")].isNull() && m_snapshot_ids_isValid;
...
QJsonObject OAIDescribeSnapshotsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_snapshot_ids.isSet()) {
        obj.insert(QString("SnapshotIds"), ::OpenAPI::toJsonValue(m_snapshot_ids));
    }
    if (m_filters.isSet()) {
...
QList OAIDescribeSnapshotsRequest::getSnapshotIds() const {
    return m_snapshot_ids;
}
void OAIDescribeSnapshotsRequest::setSnapshotIds(const QList &snapshot_ids) {
    m_snapshot_ids = snapshot_ids;
    m_snapshot_ids_isSet = true;
}

bool OAIDescribeSnapshotsRequest::is_snapshot_ids_Set() const{
    return m_snapshot_ids_isSet;
}

bool OAIDescribeSnapshotsRequest::is_snapshot_ids_Valid() const{
    return m_snapshot_ids_isValid;
}

QList OAIDescribeSnapshotsRequest::getFilters() const {
    return m_filters;
}
void OAIDescribeSnapshotsRequest::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIDescribeSnapshotsRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIDescribeSnapshotsRequest::is_filters_Valid() const{
