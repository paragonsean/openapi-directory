...
/*
 * OAICreateFileSystemRequest_OpenZFSConfiguration.h
 *
 * 
 */

#ifndef OAICreateFileSystemRequest_OpenZFSConfiguration_H
#define OAICreateFileSystemRequest_OpenZFSConfiguration_H
...
class OAICreateFileSystemRequest_OpenZFSConfiguration : public OAIObject {
public:
    OAICreateFileSystemRequest_OpenZFSConfiguration();
    OAICreateFileSystemRequest_OpenZFSConfiguration(QString json);
    ~OAICreateFileSystemRequest_OpenZFSConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFileSystemRequest_OpenZFSConfiguration)

#endif // OAICreateFileSystemRequest_OpenZFSConfiguration_H
