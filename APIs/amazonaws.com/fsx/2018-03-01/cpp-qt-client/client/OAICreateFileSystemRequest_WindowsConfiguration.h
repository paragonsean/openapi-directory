...
/*
 * OAICreateFileSystemRequest_WindowsConfiguration.h
 *
 * 
 */

#ifndef OAICreateFileSystemRequest_WindowsConfiguration_H
#define OAICreateFileSystemRequest_WindowsConfiguration_H
...
class OAICreateFileSystemRequest_WindowsConfiguration : public OAIObject {
public:
    OAICreateFileSystemRequest_WindowsConfiguration();
    OAICreateFileSystemRequest_WindowsConfiguration(QString json);
    ~OAICreateFileSystemRequest_WindowsConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFileSystemRequest_WindowsConfiguration)

#endif // OAICreateFileSystemRequest_WindowsConfiguration_H
