...
/*
 * OAIUpdateFileSystemRequest_OpenZFSConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateFileSystemRequest_OpenZFSConfiguration_H
#define OAIUpdateFileSystemRequest_OpenZFSConfiguration_H
...
class OAIUpdateFileSystemRequest_OpenZFSConfiguration : public OAIObject {
public:
    OAIUpdateFileSystemRequest_OpenZFSConfiguration();
    OAIUpdateFileSystemRequest_OpenZFSConfiguration(QString json);
    ~OAIUpdateFileSystemRequest_OpenZFSConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFileSystemRequest_OpenZFSConfiguration)

#endif // OAIUpdateFileSystemRequest_OpenZFSConfiguration_H
