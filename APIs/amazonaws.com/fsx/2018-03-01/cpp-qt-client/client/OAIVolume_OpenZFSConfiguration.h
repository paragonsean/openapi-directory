...
/*
 * OAIVolume_OpenZFSConfiguration.h
 *
 * 
 */

#ifndef OAIVolume_OpenZFSConfiguration_H
#define OAIVolume_OpenZFSConfiguration_H
...
namespace OpenAPI {
class OAIOpenZFSVolumeConfiguration_OriginSnapshot;

class OAIVolume_OpenZFSConfiguration : public OAIObject {
public:
    OAIVolume_OpenZFSConfiguration();
    OAIVolume_OpenZFSConfiguration(QString json);
    ~OAIVolume_OpenZFSConfiguration() override;
    ...
    void setVolumePath(const QString &volume_path);
    bool is_volume_path_Set() const;
    bool is_volume_path_Valid() const;
    ...
    OAIOpenZFSVolumeConfiguration_OriginSnapshot getOriginSnapshot() const;
    void setOriginSnapshot(const OAIOpenZFSVolumeConfiguration_OriginSnapshot &origin_snapshot);
    ...
    QString getRestoreToSnapshot() const;
    void setRestoreToSnapshot(const QString &restore_to_snapshot);
    bool is_restore_to_snapshot_Set() const;
    bool is_restore_to_snapshot_Valid() const;

    bool getDeleteIntermediateSnaphots() const;
    void setDeleteIntermediateSnaphots(const bool &delete_intermediate_snaphots);
    bool is_delete_intermediate_snaphots_Set() const;
    bool is_delete_intermediate_snaphots_Valid() const;

    bool getDeleteClonedVolumes() const;
    void setDeleteClonedVolumes(const bool &delete_cloned_volumes);
    bool is_delete_cloned_volumes_Set() const;
    bool is_delete_cloned_volumes_Valid() const;
...
private:
    ...
    QString m_volume_path;
    bool m_volume_path_isSet;
    bool m_volume_path_isValid;
    ...
    OAIOpenZFSVolumeConfiguration_OriginSnapshot m_origin_snapshot;
    ...
    QString m_restore_to_snapshot;
    bool m_restore_to_snapshot_isSet;
    bool m_restore_to_snapshot_isValid;

    bool m_delete_intermediate_snaphots;
    bool m_delete_intermediate_snaphots_isSet;
    bool m_delete_intermediate_snaphots_isValid;

    bool m_delete_cloned_volumes;
    bool m_delete_cloned_volumes_isSet;
    bool m_delete_cloned_volumes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIVolume_OpenZFSConfiguration)

#endif // OAIVolume_OpenZFSConfiguration_H
