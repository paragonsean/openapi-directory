...
/*
 * OAIUpdateVolumeRequest_OpenZFSConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateVolumeRequest_OpenZFSConfiguration_H
#define OAIUpdateVolumeRequest_OpenZFSConfiguration_H
...
class OAIUpdateVolumeRequest_OpenZFSConfiguration : public OAIObject {
public:
    OAIUpdateVolumeRequest_OpenZFSConfiguration();
    OAIUpdateVolumeRequest_OpenZFSConfiguration(QString json);
    ~OAIUpdateVolumeRequest_OpenZFSConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVolumeRequest_OpenZFSConfiguration)

#endif // OAIUpdateVolumeRequest_OpenZFSConfiguration_H
