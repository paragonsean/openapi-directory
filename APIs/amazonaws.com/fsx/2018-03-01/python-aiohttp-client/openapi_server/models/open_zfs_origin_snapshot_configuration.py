...
class OpenZFSOriginSnapshotConfiguration(Model):
    ...
    def __init__(self, snapshot_arn: str=None, copy_strategy: OpenZFSCopyStrategy=None):
        """OpenZFSOriginSnapshotConfiguration - a model defined in OpenAPI

        :param snapshot_arn: The snapshot_arn of this OpenZFSOriginSnapshotConfiguration.
        :param copy_strategy: The copy_strategy of this OpenZFSOriginSnapshotConfiguration.
        """
        self.openapi_types = {
            'snapshot_arn': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'OpenZFSOriginSnapshotConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The OpenZFSOriginSnapshotConfiguration of this OpenZFSOriginSnapshotConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def snapshot_arn(self):
        """Gets the snapshot_arn of this OpenZFSOriginSnapshotConfiguration.
        ...
        :return: The snapshot_arn of this OpenZFSOriginSnapshotConfiguration.
        :rtype: str
        """
    ...
    def snapshot_arn(self, snapshot_arn):
        """Sets the snapshot_arn of this OpenZFSOriginSnapshotConfiguration.
    ...
    def copy_strategy(self):
        """Gets the copy_strategy of this OpenZFSOriginSnapshotConfiguration.


        :return: The copy_strategy of this OpenZFSOriginSnapshotConfiguration.
    ...
    def copy_strategy(self, copy_strategy):
        """Sets the copy_strategy of this OpenZFSOriginSnapshotConfiguration.
