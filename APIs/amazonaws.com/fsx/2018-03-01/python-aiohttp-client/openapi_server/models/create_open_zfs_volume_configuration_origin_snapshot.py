...
class CreateOpenZFSVolumeConfigurationOriginSnapshot(Model):
    ...
    def __init__(self, snapshot_arn: str=None, copy_strategy: OpenZFSCopyStrategy=None):
        """CreateOpenZFSVolumeConfigurationOriginSnapshot - a model defined in OpenAPI

        :param snapshot_arn: The snapshot_arn of this CreateOpenZFSVolumeConfigurationOriginSnapshot.
        :param copy_strategy: The copy_strategy of this CreateOpenZFSVolumeConfigurationOriginSnapshot.
        """
        self.openapi_types = {
            'snapshot_arn': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateOpenZFSVolumeConfigurationOriginSnapshot':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateOpenZFSVolumeConfiguration_OriginSnapshot of this CreateOpenZFSVolumeConfigurationOriginSnapshot.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def snapshot_arn(self):
        """Gets the snapshot_arn of this CreateOpenZFSVolumeConfigurationOriginSnapshot.
        ...
        :return: The snapshot_arn of this CreateOpenZFSVolumeConfigurationOriginSnapshot.
        :rtype: str
        """
    ...
    def snapshot_arn(self, snapshot_arn):
        """Sets the snapshot_arn of this CreateOpenZFSVolumeConfigurationOriginSnapshot.
    ...
    def copy_strategy(self):
        """Gets the copy_strategy of this CreateOpenZFSVolumeConfigurationOriginSnapshot.


        :return: The copy_strategy of this CreateOpenZFSVolumeConfigurationOriginSnapshot.
    ...
    def copy_strategy(self, copy_strategy):
        """Sets the copy_strategy of this CreateOpenZFSVolumeConfigurationOriginSnapshot.
