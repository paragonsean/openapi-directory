...
class FileSystemEndpoint(Model):
    ...
    def __init__(self, dns_name: str=None, ip_addresses: List=None):
        """FileSystemEndpoint - a model defined in OpenAPI

        :param dns_name: The dns_name of this FileSystemEndpoint.
        :param ip_addresses: The ip_addresses of this FileSystemEndpoint.
        """
        self.openapi_types = {
            'dns_name': str,
            'ip_addresses': List
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'FileSystemEndpoint':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The FileSystemEndpoint of this FileSystemEndpoint.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def dns_name(self):
        """Gets the dns_name of this FileSystemEndpoint.

        The file system's DNS name. You can mount your file system using its DNS name.

        :return: The dns_name of this FileSystemEndpoint.
        :rtype: str
        """
    ...
    def dns_name(self, dns_name):
        """Sets the dns_name of this FileSystemEndpoint.
    ...
    def ip_addresses(self):
        """Gets the ip_addresses of this FileSystemEndpoint.


        :return: The ip_addresses of this FileSystemEndpoint.
        :rtype: List
        """
    ...
    def ip_addresses(self, ip_addresses):
        """Sets the ip_addresses of this FileSystemEndpoint.
