...
class SvmEndpoint(Model):
    ...
    def __init__(self, dns_name: str=None, ip_addresses: List=None):
        """SvmEndpoint - a model defined in OpenAPI

        :param dns_name: The dns_name of this SvmEndpoint.
        :param ip_addresses: The ip_addresses of this SvmEndpoint.
        """
        self.openapi_types = {
            'dns_name': str,
            'ip_addresses': List
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SvmEndpoint':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SvmEndpoint of this SvmEndpoint.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def dns_name(self):
        """Gets the dns_name of this SvmEndpoint.

        The file system's DNS name. You can mount your file system using its DNS name.

        :return: The dns_name of this SvmEndpoint.
        :rtype: str
        """
    ...
    def dns_name(self, dns_name):
        """Sets the dns_name of this SvmEndpoint.
    ...
    def ip_addresses(self):
        """Gets the ip_addresses of this SvmEndpoint.


        :return: The ip_addresses of this SvmEndpoint.
        :rtype: List
        """
    ...
    def ip_addresses(self, ip_addresses):
        """Sets the ip_addresses of this SvmEndpoint.
