...
class DeleteVolumeResponseOntapResponse(Model):
    ...
    def __init__(self, final_backup_id: str=None, final_backup_tags: List[Tag]=None):
        """DeleteVolumeResponseOntapResponse - a model defined in OpenAPI

        :param final_backup_id: The final_backup_id of this DeleteVolumeResponseOntapResponse.
        :param final_backup_tags: The final_backup_tags of this DeleteVolumeResponseOntapResponse.
        """
        self.openapi_types = {
            'final_backup_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteVolumeResponseOntapResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteVolumeResponse_OntapResponse of this DeleteVolumeResponseOntapResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def final_backup_id(self):
        """Gets the final_backup_id of this DeleteVolumeResponseOntapResponse.

        The ID of the source backup. Specifies the backup that you are copying.

        :return: The final_backup_id of this DeleteVolumeResponseOntapResponse.
        :rtype: str
        """
    ...
    def final_backup_id(self, final_backup_id):
        """Sets the final_backup_id of this DeleteVolumeResponseOntapResponse.
    ...
    def final_backup_tags(self):
        """Gets the final_backup_tags of this DeleteVolumeResponseOntapResponse.

        A list of <code>Tag</code> values, with a maximum of 50 elements.

        :return: The final_backup_tags of this DeleteVolumeResponseOntapResponse.
        :rtype: List[Tag]
        """
    ...
    def final_backup_tags(self, final_backup_tags):
        """Sets the final_backup_tags of this DeleteVolumeResponseOntapResponse.
