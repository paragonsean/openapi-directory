...
class DeleteVolumeOntapResponse(Model):
    ...
    def __init__(self, final_backup_id: str=None, final_backup_tags: List[Tag]=None):
        """DeleteVolumeOntapResponse - a model defined in OpenAPI

        :param final_backup_id: The final_backup_id of this DeleteVolumeOntapResponse.
        :param final_backup_tags: The final_backup_tags of this DeleteVolumeOntapResponse.
        """
        self.openapi_types = {
            'final_backup_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteVolumeOntapResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteVolumeOntapResponse of this DeleteVolumeOntapResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def final_backup_id(self):
        """Gets the final_backup_id of this DeleteVolumeOntapResponse.

        The ID of the source backup. Specifies the backup that you are copying.

        :return: The final_backup_id of this DeleteVolumeOntapResponse.
        :rtype: str
        """
    ...
    def final_backup_id(self, final_backup_id):
        """Sets the final_backup_id of this DeleteVolumeOntapResponse.
    ...
    def final_backup_tags(self):
        """Gets the final_backup_tags of this DeleteVolumeOntapResponse.

        A list of <code>Tag</code> values, with a maximum of 50 elements.

        :return: The final_backup_tags of this DeleteVolumeOntapResponse.
        :rtype: List[Tag]
        """
    ...
    def final_backup_tags(self, final_backup_tags):
        """Sets the final_backup_tags of this DeleteVolumeOntapResponse.
