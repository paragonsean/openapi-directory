...
class SvmEndpointsIscsi(Model):
    ...
    def __init__(self, dns_name: str=None, ip_addresses: List=None):
        """SvmEndpointsIscsi - a model defined in OpenAPI

        :param dns_name: The dns_name of this SvmEndpointsIscsi.
        :param ip_addresses: The ip_addresses of this SvmEndpointsIscsi.
        """
        self.openapi_types = {
            'dns_name': str,
            'ip_addresses': List
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SvmEndpointsIscsi':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SvmEndpoints_Iscsi of this SvmEndpointsIscsi.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def dns_name(self):
        """Gets the dns_name of this SvmEndpointsIscsi.

        The file system's DNS name. You can mount your file system using its DNS name.

        :return: The dns_name of this SvmEndpointsIscsi.
        :rtype: str
        """
    ...
    def dns_name(self, dns_name):
        """Sets the dns_name of this SvmEndpointsIscsi.
    ...
    def ip_addresses(self):
        """Gets the ip_addresses of this SvmEndpointsIscsi.


        :return: The ip_addresses of this SvmEndpointsIscsi.
        :rtype: List
        """
    ...
    def ip_addresses(self, ip_addresses):
        """Sets the ip_addresses of this SvmEndpointsIscsi.
