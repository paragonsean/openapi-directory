...
class FileCache(Model):
    ...
    def __init__(self, owner_id: str=None, creation_time: datetime=None, file_cache_id: str=None, file_cache_type: FileCacheType=None, file_cache_type_version: str=None, lifecycle: FileCacheLifecycle=None, failure_details: FileCacheCreatingFailureDetails=None, storage_capacity: int=None, vpc_id: str=None, subnet_ids: List[str]=None, network_interface_ids: List[str]=None, dns_name: str=None, kms_key_id: str=None, resource_arn: str=None, lustre_configuration: FileCacheCreatingLustreConfiguration=None, data_repository_association_ids: List=None):
        """FileCache - a model defined in OpenAPI

        :param owner_id: The owner_id of this FileCache.
        :param creation_time: The creation_time of this FileCache.
        :param file_cache_id: The file_cache_id of this FileCache.
        :param file_cache_type: The file_cache_type of this FileCache.
        :param file_cache_type_version: The file_cache_type_version of this FileCache.
        :param lifecycle: The lifecycle of this FileCache.
        :param failure_details: The failure_details of this FileCache.
        :param storage_capacity: The storage_capacity of this FileCache.
        :param vpc_id: The vpc_id of this FileCache.
        :param subnet_ids: The subnet_ids of this FileCache.
        :param network_interface_ids: The network_interface_ids of this FileCache.
        :param dns_name: The dns_name of this FileCache.
        :param kms_key_id: The kms_key_id of this FileCache.
        :param resource_arn: The resource_arn of this FileCache.
        :param lustre_configuration: The lustre_configuration of this FileCache.
        :param data_repository_association_ids: The data_repository_association_ids of this FileCache.
        """
        self.openapi_types = {
            'owner_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'FileCache':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The FileCache of this FileCache.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def owner_id(self):
        """Gets the owner_id of this FileCache.

        An Amazon Web Services account ID. This ID is a 12-digit number that you use to construct Amazon Resource Names (ARNs) for resources.

        :return: The owner_id of this FileCache.
        :rtype: str
        """
    ...
    def owner_id(self, owner_id):
        """Sets the owner_id of this FileCache.
    ...
    def creation_time(self):
        """Gets the creation_time of this FileCache.

        The time that the resource was created, in seconds (since 1970-01-01T00:00:00Z), also known as Unix time.

        :return: The creation_time of this FileCache.
        :rtype: datetime
        """
    ...
    def creation_time(self, creation_time):
        """Sets the creation_time of this FileCache.
    ...
    def file_cache_id(self):
        """Gets the file_cache_id of this FileCache.


        :return: The file_cache_id of this FileCache.
        :rtype: str
        """
    ...
    def file_cache_id(self, file_cache_id):
        """Sets the file_cache_id of this FileCache.
    ...
    def file_cache_type(self):
        """Gets the file_cache_type of this FileCache.


        :return: The file_cache_type of this FileCache.
        :rtype: FileCacheType
        """
    ...
    def file_cache_type(self, file_cache_type):
        """Sets the file_cache_type of this FileCache.
    ...
    def file_cache_type_version(self):
        """Gets the file_cache_type_version of this FileCache.


        :return: The file_cache_type_version of this FileCache.
        :rtype: str
        """
    ...
    def file_cache_type_version(self, file_cache_type_version):
        """Sets the file_cache_type_version of this FileCache.
    ...
    @property
    def lifecycle(self):
        """Gets the lifecycle of this FileCache.


        :return: The lifecycle of this FileCache.
    ...
    def lifecycle(self, lifecycle):
        """Sets the lifecycle of this FileCache.
    ...
    def failure_details(self):
        """Gets the failure_details of this FileCache.


        :return: The failure_details of this FileCache.
    ...
    def failure_details(self, failure_details):
        """Sets the failure_details of this FileCache.
    ...
    def storage_capacity(self):
        """Gets the storage_capacity of this FileCache.


        :return: The storage_capacity of this FileCache.
        :rtype: int
        """
    ...
    def storage_capacity(self, storage_capacity):
        """Sets the storage_capacity of this FileCache.
    ...
    @property
    def vpc_id(self):
        """Gets the vpc_id of this FileCache.
        ...
        :return: The vpc_id of this FileCache.
        :rtype: str
        """
        return self._vpc_id
    ...
    def vpc_id(self, vpc_id):
        """Sets the vpc_id of this FileCache.
    ...
    @property
    def subnet_ids(self):
        """Gets the subnet_ids of this FileCache.
        ...
        :return: The subnet_ids of this FileCache.
        :rtype: List[str]
        """
    ...
    def subnet_ids(self, subnet_ids):
        """Sets the subnet_ids of this FileCache.
    ...
    def network_interface_ids(self):
        """Gets the network_interface_ids of this FileCache.

        A list of network interface IDs.

        :return: The network_interface_ids of this FileCache.
        :rtype: List[str]
        """
    ...
    def network_interface_ids(self, network_interface_ids):
        """Sets the network_interface_ids of this FileCache.
    ...
    @property
    def dns_name(self):
        """Gets the dns_name of this FileCache.


        :return: The dns_name of this FileCache.
        :rtype: str
        """
    ...
    def dns_name(self, dns_name):
        """Sets the dns_name of this FileCache.
    ...
    @property
    def kms_key_id(self):
        """Gets the kms_key_id of this FileCache.


        :return: The kms_key_id of this FileCache.
        :rtype: str
        """
    ...
    def kms_key_id(self, kms_key_id):
        """Sets the kms_key_id of this FileCache.
    ...
    def resource_arn(self):
        """Gets the resource_arn of this FileCache.
        ...
        :return: The resource_arn of this FileCache.
        :rtype: str
        """
    ...
    def resource_arn(self, resource_arn):
        """Sets the resource_arn of this FileCache.
    ...
    def lustre_configuration(self):
        """Gets the lustre_configuration of this FileCache.


        :return: The lustre_configuration of this FileCache.
    ...
    def lustre_configuration(self, lustre_configuration):
        """Sets the lustre_configuration of this FileCache.
    ...
    def data_repository_association_ids(self):
        """Gets the data_repository_association_ids of this FileCache.


        :return: The data_repository_association_ids of this FileCache.
        :rtype: List
        """
    ...
    def data_repository_association_ids(self, data_repository_association_ids):
        """Sets the data_repository_association_ids of this FileCache.
