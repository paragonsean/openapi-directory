...
class CreateOpenZFSOriginSnapshotConfiguration(Model):
    ...
    def __init__(self, snapshot_arn: str=None, copy_strategy: OpenZFSCopyStrategy=None):
        """CreateOpenZFSOriginSnapshotConfiguration - a model defined in OpenAPI

        :param snapshot_arn: The snapshot_arn of this CreateOpenZFSOriginSnapshotConfiguration.
        :param copy_strategy: The copy_strategy of this CreateOpenZFSOriginSnapshotConfiguration.
        """
        self.openapi_types = {
            'snapshot_arn': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateOpenZFSOriginSnapshotConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateOpenZFSOriginSnapshotConfiguration of this CreateOpenZFSOriginSnapshotConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def snapshot_arn(self):
        """Gets the snapshot_arn of this CreateOpenZFSOriginSnapshotConfiguration.
        ...
        :return: The snapshot_arn of this CreateOpenZFSOriginSnapshotConfiguration.
        :rtype: str
        """
    ...
    def snapshot_arn(self, snapshot_arn):
        """Sets the snapshot_arn of this CreateOpenZFSOriginSnapshotConfiguration.
    ...
    def copy_strategy(self):
        """Gets the copy_strategy of this CreateOpenZFSOriginSnapshotConfiguration.


        :return: The copy_strategy of this CreateOpenZFSOriginSnapshotConfiguration.
    ...
    def copy_strategy(self, copy_strategy):
        """Sets the copy_strategy of this CreateOpenZFSOriginSnapshotConfiguration.
        ...
        if copy_strategy is None:
            raise ValueError("Invalid value for `copy_strategy`, must not be `None`")
