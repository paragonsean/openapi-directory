...
class UpdateFileCacheLustreConfiguration(Model):
    ...
    def __init__(self, weekly_maintenance_start_time: str=None):
        """UpdateFileCacheLustreConfiguration - a model defined in OpenAPI

        :param weekly_maintenance_start_time: The weekly_maintenance_start_time of this UpdateFileCacheLustreConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateFileCacheLustreConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateFileCacheLustreConfiguration of this UpdateFileCacheLustreConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def weekly_maintenance_start_time(self):
        """Gets the weekly_maintenance_start_time of this UpdateFileCacheLustreConfiguration.
        ...
        :return: The weekly_maintenance_start_time of this UpdateFileCacheLustreConfiguration.
        :rtype: str
        """
    ...
    def weekly_maintenance_start_time(self, weekly_maintenance_start_time):
        """Sets the weekly_maintenance_start_time of this UpdateFileCacheLustreConfiguration.
