...
class DeleteFileSystemResponseOpenZFSResponse(Model):
    ...
    def __init__(self, final_backup_id: str=None, final_backup_tags: List[Tag]=None):
        """DeleteFileSystemResponseOpenZFSResponse - a model defined in OpenAPI

        :param final_backup_id: The final_backup_id of this DeleteFileSystemResponseOpenZFSResponse.
        :param final_backup_tags: The final_backup_tags of this DeleteFileSystemResponseOpenZFSResponse.
        """
        self.openapi_types = {
            'final_backup_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteFileSystemResponseOpenZFSResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteFileSystemResponse_OpenZFSResponse of this DeleteFileSystemResponseOpenZFSResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def final_backup_id(self):
        """Gets the final_backup_id of this DeleteFileSystemResponseOpenZFSResponse.

        The ID of the source backup. Specifies the backup that you are copying.

        :return: The final_backup_id of this DeleteFileSystemResponseOpenZFSResponse.
        :rtype: str
        """
    ...
    def final_backup_id(self, final_backup_id):
        """Sets the final_backup_id of this DeleteFileSystemResponseOpenZFSResponse.
    ...
    def final_backup_tags(self):
        """Gets the final_backup_tags of this DeleteFileSystemResponseOpenZFSResponse.

        A list of <code>Tag</code> values, with a maximum of 50 elements.

        :return: The final_backup_tags of this DeleteFileSystemResponseOpenZFSResponse.
        :rtype: List[Tag]
        """
    ...
    def final_backup_tags(self, final_backup_tags):
        """Sets the final_backup_tags of this DeleteFileSystemResponseOpenZFSResponse.
