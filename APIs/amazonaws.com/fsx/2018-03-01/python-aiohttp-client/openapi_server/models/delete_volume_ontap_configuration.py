...
class DeleteVolumeOntapConfiguration(Model):
    ...
    def __init__(self, skip_final_backup: bool=None, final_backup_tags: List[Tag]=None, bypass_snaplock_enterprise_retention: bool=None):
        """DeleteVolumeOntapConfiguration - a model defined in OpenAPI

        :param skip_final_backup: The skip_final_backup of this DeleteVolumeOntapConfiguration.
        :param final_backup_tags: The final_backup_tags of this DeleteVolumeOntapConfiguration.
        :param bypass_snaplock_enterprise_retention: The bypass_snaplock_enterprise_retention of this DeleteVolumeOntapConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteVolumeOntapConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteVolumeOntapConfiguration of this DeleteVolumeOntapConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def skip_final_backup(self):
        """Gets the skip_final_backup of this DeleteVolumeOntapConfiguration.


        :return: The skip_final_backup of this DeleteVolumeOntapConfiguration.
        :rtype: bool
        """
    ...
    def skip_final_backup(self, skip_final_backup):
        """Sets the skip_final_backup of this DeleteVolumeOntapConfiguration.
    ...
    def final_backup_tags(self):
        """Gets the final_backup_tags of this DeleteVolumeOntapConfiguration.

        A list of <code>Tag</code> values, with a maximum of 50 elements.

        :return: The final_backup_tags of this DeleteVolumeOntapConfiguration.
        :rtype: List[Tag]
        """
    ...
    def final_backup_tags(self, final_backup_tags):
        """Sets the final_backup_tags of this DeleteVolumeOntapConfiguration.
    ...
    def bypass_snaplock_enterprise_retention(self):
        """Gets the bypass_snaplock_enterprise_retention of this DeleteVolumeOntapConfiguration.


        :return: The bypass_snaplock_enterprise_retention of this DeleteVolumeOntapConfiguration.
        :rtype: bool
        """
    ...
    def bypass_snaplock_enterprise_retention(self, bypass_snaplock_enterprise_retention):
        """Sets the bypass_snaplock_enterprise_retention of this DeleteVolumeOntapConfiguration.
