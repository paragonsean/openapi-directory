...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.SvmEndpoint();
  });
  ...
  describe('SvmEndpoint', function() {
    it('should create an instance of SvmEndpoint', function() {
      // uncomment below and update the code to test SvmEndpoint
      //var instance = new AmazonFsx.SvmEndpoint();
      //expect(instance).to.be.a(AmazonFsx.SvmEndpoint);
    });
