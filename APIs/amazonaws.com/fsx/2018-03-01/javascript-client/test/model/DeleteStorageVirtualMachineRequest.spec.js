...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.DeleteStorageVirtualMachineRequest();
  });
  ...
  describe('DeleteStorageVirtualMachineRequest', function() {
    it('should create an instance of DeleteStorageVirtualMachineRequest', function() {
      // uncomment below and update the code to test DeleteStorageVirtualMachineRequest
      //var instance = new AmazonFsx.DeleteStorageVirtualMachineRequest();
      //expect(instance).to.be.a(AmazonFsx.DeleteStorageVirtualMachineRequest);
    });
