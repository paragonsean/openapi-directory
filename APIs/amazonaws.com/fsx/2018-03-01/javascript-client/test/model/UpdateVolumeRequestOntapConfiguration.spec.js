...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.UpdateVolumeRequestOntapConfiguration();
  });
  ...
  describe('UpdateVolumeRequestOntapConfiguration', function() {
    it('should create an instance of UpdateVolumeRequestOntapConfiguration', function() {
      // uncomment below and update the code to test UpdateVolumeRequestOntapConfiguration
      //var instance = new AmazonFsx.UpdateVolumeRequestOntapConfiguration();
      //expect(instance).to.be.a(AmazonFsx.UpdateVolumeRequestOntapConfiguration);
    });
