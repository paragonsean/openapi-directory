...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.DeleteFileCacheResponse();
  });
  ...
  describe('DeleteFileCacheResponse', function() {
    it('should create an instance of DeleteFileCacheResponse', function() {
      // uncomment below and update the code to test DeleteFileCacheResponse
      //var instance = new AmazonFsx.DeleteFileCacheResponse();
      //expect(instance).to.be.a(AmazonFsx.DeleteFileCacheResponse);
    });
