...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.AssociateFileSystemAliasesRequest();
  });
  ...
  describe('AssociateFileSystemAliasesRequest', function() {
    it('should create an instance of AssociateFileSystemAliasesRequest', function() {
      // uncomment below and update the code to test AssociateFileSystemAliasesRequest
      //var instance = new AmazonFsx.AssociateFileSystemAliasesRequest();
      //expect(instance).to.be.a(AmazonFsx.AssociateFileSystemAliasesRequest);
    });
