...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.OpenZFSVolumeConfiguration();
  });
  ...
  describe('OpenZFSVolumeConfiguration', function() {
    it('should create an instance of OpenZFSVolumeConfiguration', function() {
      // uncomment below and update the code to test OpenZFSVolumeConfiguration
      //var instance = new AmazonFsx.OpenZFSVolumeConfiguration();
      //expect(instance).to.be.a(AmazonFsx.OpenZFSVolumeConfiguration);
    });
