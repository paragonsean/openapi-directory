...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.CreateFileSystemOpenZFSConfigurationRootVolumeConfiguration();
  });
  ...
  describe('CreateFileSystemOpenZFSConfigurationRootVolumeConfiguration', function() {
    it('should create an instance of CreateFileSystemOpenZFSConfigurationRootVolumeConfiguration', function() {
      // uncomment below and update the code to test CreateFileSystemOpenZFSConfigurationRootVolumeConfiguration
      //var instance = new AmazonFsx.CreateFileSystemOpenZFSConfigurationRootVolumeConfiguration();
      //expect(instance).to.be.a(AmazonFsx.CreateFileSystemOpenZFSConfigurationRootVolumeConfiguration);
    });
