...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.SvmEndpointsIscsi();
  });
  ...
  describe('SvmEndpointsIscsi', function() {
    it('should create an instance of SvmEndpointsIscsi', function() {
      // uncomment below and update the code to test SvmEndpointsIscsi
      //var instance = new AmazonFsx.SvmEndpointsIscsi();
      //expect(instance).to.be.a(AmazonFsx.SvmEndpointsIscsi);
    });
