...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.FileCacheCreating();
  });
  ...
  describe('FileCacheCreating', function() {
    it('should create an instance of FileCacheCreating', function() {
      // uncomment below and update the code to test FileCacheCreating
      //var instance = new AmazonFsx.FileCacheCreating();
      //expect(instance).to.be.a(AmazonFsx.FileCacheCreating);
    });
