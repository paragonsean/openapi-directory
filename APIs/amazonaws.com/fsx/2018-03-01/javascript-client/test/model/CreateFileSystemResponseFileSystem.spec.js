...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.CreateFileSystemResponseFileSystem();
  });
  ...
  describe('CreateFileSystemResponseFileSystem', function() {
    it('should create an instance of CreateFileSystemResponseFileSystem', function() {
      // uncomment below and update the code to test CreateFileSystemResponseFileSystem
      //var instance = new AmazonFsx.CreateFileSystemResponseFileSystem();
      //expect(instance).to.be.a(AmazonFsx.CreateFileSystemResponseFileSystem);
    });
