...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.DescribeFileSystemAliasesRequest();
  });
  ...
  describe('DescribeFileSystemAliasesRequest', function() {
    it('should create an instance of DescribeFileSystemAliasesRequest', function() {
      // uncomment below and update the code to test DescribeFileSystemAliasesRequest
      //var instance = new AmazonFsx.DescribeFileSystemAliasesRequest();
      //expect(instance).to.be.a(AmazonFsx.DescribeFileSystemAliasesRequest);
    });
