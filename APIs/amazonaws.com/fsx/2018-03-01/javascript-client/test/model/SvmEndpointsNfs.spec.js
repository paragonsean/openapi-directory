...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.SvmEndpointsNfs();
  });
  ...
  describe('SvmEndpointsNfs', function() {
    it('should create an instance of SvmEndpointsNfs', function() {
      // uncomment below and update the code to test SvmEndpointsNfs
      //var instance = new AmazonFsx.SvmEndpointsNfs();
      //expect(instance).to.be.a(AmazonFsx.SvmEndpointsNfs);
    });
