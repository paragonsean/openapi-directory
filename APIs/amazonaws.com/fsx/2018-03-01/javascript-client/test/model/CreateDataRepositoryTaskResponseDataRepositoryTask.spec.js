...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.CreateDataRepositoryTaskResponseDataRepositoryTask();
  });
  ...
  describe('CreateDataRepositoryTaskResponseDataRepositoryTask', function() {
    it('should create an instance of CreateDataRepositoryTaskResponseDataRepositoryTask', function() {
      // uncomment below and update the code to test CreateDataRepositoryTaskResponseDataRepositoryTask
      //var instance = new AmazonFsx.CreateDataRepositoryTaskResponseDataRepositoryTask();
      //expect(instance).to.be.a(AmazonFsx.CreateDataRepositoryTaskResponseDataRepositoryTask);
    });
