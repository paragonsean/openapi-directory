...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.FileCacheCreatingLustreConfiguration();
  });
  ...
  describe('FileCacheCreatingLustreConfiguration', function() {
    it('should create an instance of FileCacheCreatingLustreConfiguration', function() {
      // uncomment below and update the code to test FileCacheCreatingLustreConfiguration
      //var instance = new AmazonFsx.FileCacheCreatingLustreConfiguration();
      //expect(instance).to.be.a(AmazonFsx.FileCacheCreatingLustreConfiguration);
    });
