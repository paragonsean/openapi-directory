...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.DeleteFileCacheRequest();
  });
  ...
  describe('DeleteFileCacheRequest', function() {
    it('should create an instance of DeleteFileCacheRequest', function() {
      // uncomment below and update the code to test DeleteFileCacheRequest
      //var instance = new AmazonFsx.DeleteFileCacheRequest();
      //expect(instance).to.be.a(AmazonFsx.DeleteFileCacheRequest);
    });
