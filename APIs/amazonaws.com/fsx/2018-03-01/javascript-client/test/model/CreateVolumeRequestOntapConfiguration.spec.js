...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.CreateVolumeRequestOntapConfiguration();
  });
  ...
  describe('CreateVolumeRequestOntapConfiguration', function() {
    it('should create an instance of CreateVolumeRequestOntapConfiguration', function() {
      // uncomment below and update the code to test CreateVolumeRequestOntapConfiguration
      //var instance = new AmazonFsx.CreateVolumeRequestOntapConfiguration();
      //expect(instance).to.be.a(AmazonFsx.CreateVolumeRequestOntapConfiguration);
    });
