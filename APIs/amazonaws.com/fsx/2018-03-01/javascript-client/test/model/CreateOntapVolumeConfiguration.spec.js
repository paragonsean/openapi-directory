...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.CreateOntapVolumeConfiguration();
  });
  ...
  describe('CreateOntapVolumeConfiguration', function() {
    it('should create an instance of CreateOntapVolumeConfiguration', function() {
      // uncomment below and update the code to test CreateOntapVolumeConfiguration
      //var instance = new AmazonFsx.CreateOntapVolumeConfiguration();
      //expect(instance).to.be.a(AmazonFsx.CreateOntapVolumeConfiguration);
    });
