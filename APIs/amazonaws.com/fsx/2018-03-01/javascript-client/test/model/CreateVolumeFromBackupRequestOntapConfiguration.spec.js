...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.CreateVolumeFromBackupRequestOntapConfiguration();
  });
  ...
  describe('CreateVolumeFromBackupRequestOntapConfiguration', function() {
    it('should create an instance of CreateVolumeFromBackupRequestOntapConfiguration', function() {
      // uncomment below and update the code to test CreateVolumeFromBackupRequestOntapConfiguration
      //var instance = new AmazonFsx.CreateVolumeFromBackupRequestOntapConfiguration();
      //expect(instance).to.be.a(AmazonFsx.CreateVolumeFromBackupRequestOntapConfiguration);
    });
