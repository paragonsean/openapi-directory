...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.DescribeBackupsRequest();
  });
  ...
  describe('DescribeBackupsRequest', function() {
    it('should create an instance of DescribeBackupsRequest', function() {
      // uncomment below and update the code to test DescribeBackupsRequest
      //var instance = new AmazonFsx.DescribeBackupsRequest();
      //expect(instance).to.be.a(AmazonFsx.DescribeBackupsRequest);
    });

    it('should have the property backupIds (base name: "BackupIds")', function() {
      // uncomment below and update the code to test the property backupIds
      //var instance = new AmazonFsx.DescribeBackupsRequest();
