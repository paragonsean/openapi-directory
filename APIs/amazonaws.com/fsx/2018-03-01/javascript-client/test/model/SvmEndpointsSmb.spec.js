...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.SvmEndpointsSmb();
  });
  ...
  describe('SvmEndpointsSmb', function() {
    it('should create an instance of SvmEndpointsSmb', function() {
      // uncomment below and update the code to test SvmEndpointsSmb
      //var instance = new AmazonFsx.SvmEndpointsSmb();
      //expect(instance).to.be.a(AmazonFsx.SvmEndpointsSmb);
    });
