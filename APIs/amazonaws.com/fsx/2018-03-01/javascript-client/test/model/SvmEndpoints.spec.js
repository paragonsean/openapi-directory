...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.SvmEndpoints();
  });
  ...
  describe('SvmEndpoints', function() {
    it('should create an instance of SvmEndpoints', function() {
      // uncomment below and update the code to test SvmEndpoints
      //var instance = new AmazonFsx.SvmEndpoints();
      //expect(instance).to.be.a(AmazonFsx.SvmEndpoints);
    });
