...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.CreateDataRepositoryAssociationResponseAssociation();
  });
  ...
  describe('CreateDataRepositoryAssociationResponseAssociation', function() {
    it('should create an instance of CreateDataRepositoryAssociationResponseAssociation', function() {
      // uncomment below and update the code to test CreateDataRepositoryAssociationResponseAssociation
      //var instance = new AmazonFsx.CreateDataRepositoryAssociationResponseAssociation();
      //expect(instance).to.be.a(AmazonFsx.CreateDataRepositoryAssociationResponseAssociation);
    });
