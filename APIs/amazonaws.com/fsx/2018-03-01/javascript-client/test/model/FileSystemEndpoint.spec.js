...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.FileSystemEndpoint();
  });
  ...
  describe('FileSystemEndpoint', function() {
    it('should create an instance of FileSystemEndpoint', function() {
      // uncomment below and update the code to test FileSystemEndpoint
      //var instance = new AmazonFsx.FileSystemEndpoint();
      //expect(instance).to.be.a(AmazonFsx.FileSystemEndpoint);
    });
