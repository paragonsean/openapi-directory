...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.BackupFileSystem();
  });
  ...
  describe('BackupFileSystem', function() {
    it('should create an instance of BackupFileSystem', function() {
      // uncomment below and update the code to test BackupFileSystem
      //var instance = new AmazonFsx.BackupFileSystem();
      //expect(instance).to.be.a(AmazonFsx.BackupFileSystem);
    });
