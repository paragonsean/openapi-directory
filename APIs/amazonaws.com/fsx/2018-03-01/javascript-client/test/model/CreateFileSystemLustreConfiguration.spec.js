...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.CreateFileSystemLustreConfiguration();
  });
  ...
  describe('CreateFileSystemLustreConfiguration', function() {
    it('should create an instance of CreateFileSystemLustreConfiguration', function() {
      // uncomment below and update the code to test CreateFileSystemLustreConfiguration
      //var instance = new AmazonFsx.CreateFileSystemLustreConfiguration();
      //expect(instance).to.be.a(AmazonFsx.CreateFileSystemLustreConfiguration);
    });
    ...
    it('should have the property importPath (base name: "ImportPath")', function() {
      // uncomment below and update the code to test the property importPath
      //var instance = new AmazonFsx.CreateFileSystemLustreConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property exportPath (base name: "ExportPath")', function() {
      // uncomment below and update the code to test the property exportPath
      //var instance = new AmazonFsx.CreateFileSystemLustreConfiguration();
      //expect(instance).to.be();
    });
