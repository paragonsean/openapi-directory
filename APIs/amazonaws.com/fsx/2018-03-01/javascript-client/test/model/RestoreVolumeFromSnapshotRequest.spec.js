...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.RestoreVolumeFromSnapshotRequest();
  });
  ...
  describe('RestoreVolumeFromSnapshotRequest', function() {
    it('should create an instance of RestoreVolumeFromSnapshotRequest', function() {
      // uncomment below and update the code to test RestoreVolumeFromSnapshotRequest
      //var instance = new AmazonFsx.RestoreVolumeFromSnapshotRequest();
      //expect(instance).to.be.a(AmazonFsx.RestoreVolumeFromSnapshotRequest);
    });
