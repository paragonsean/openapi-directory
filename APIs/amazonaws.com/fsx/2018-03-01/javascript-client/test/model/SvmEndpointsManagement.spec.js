...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.SvmEndpointsManagement();
  });
  ...
  describe('SvmEndpointsManagement', function() {
    it('should create an instance of SvmEndpointsManagement', function() {
      // uncomment below and update the code to test SvmEndpointsManagement
      //var instance = new AmazonFsx.SvmEndpointsManagement();
      //expect(instance).to.be.a(AmazonFsx.SvmEndpointsManagement);
    });
