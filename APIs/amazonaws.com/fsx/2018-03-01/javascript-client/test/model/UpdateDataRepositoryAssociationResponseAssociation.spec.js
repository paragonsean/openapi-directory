...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.UpdateDataRepositoryAssociationResponseAssociation();
  });
  ...
  describe('UpdateDataRepositoryAssociationResponseAssociation', function() {
    it('should create an instance of UpdateDataRepositoryAssociationResponseAssociation', function() {
      // uncomment below and update the code to test UpdateDataRepositoryAssociationResponseAssociation
      //var instance = new AmazonFsx.UpdateDataRepositoryAssociationResponseAssociation();
      //expect(instance).to.be.a(AmazonFsx.UpdateDataRepositoryAssociationResponseAssociation);
    });
