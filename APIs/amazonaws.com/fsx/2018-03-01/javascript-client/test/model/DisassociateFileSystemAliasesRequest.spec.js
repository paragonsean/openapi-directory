...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.DisassociateFileSystemAliasesRequest();
  });
  ...
  describe('DisassociateFileSystemAliasesRequest', function() {
    it('should create an instance of DisassociateFileSystemAliasesRequest', function() {
      // uncomment below and update the code to test DisassociateFileSystemAliasesRequest
      //var instance = new AmazonFsx.DisassociateFileSystemAliasesRequest();
      //expect(instance).to.be.a(AmazonFsx.DisassociateFileSystemAliasesRequest);
    });
