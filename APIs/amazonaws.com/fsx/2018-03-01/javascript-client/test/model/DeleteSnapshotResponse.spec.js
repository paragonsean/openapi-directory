...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.DeleteSnapshotResponse();
  });
  ...
  describe('DeleteSnapshotResponse', function() {
    it('should create an instance of DeleteSnapshotResponse', function() {
      ...
      //var instance = new AmazonFsx.DeleteSnapshotResponse();
      //expect(instance).to.be.a(AmazonFsx.DeleteSnapshotResponse);
    });
