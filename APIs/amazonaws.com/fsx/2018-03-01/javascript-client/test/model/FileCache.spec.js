...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.FileCache();
  });
  ...
  describe('FileCache', function() {
    it('should create an instance of FileCache', function() {
      // uncomment below and update the code to test FileCache
      //var instance = new AmazonFsx.FileCache();
      //expect(instance).to.be.a(AmazonFsx.FileCache);
    });
