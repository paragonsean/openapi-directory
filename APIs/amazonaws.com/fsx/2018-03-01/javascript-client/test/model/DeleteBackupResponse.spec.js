...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFsx.DeleteBackupResponse();
  });
  ...
  describe('DeleteBackupResponse', function() {
    it('should create an instance of DeleteBackupResponse', function() {
      // uncomment below and update the code to test DeleteBackupResponse
      //var instance = new AmazonFsx.DeleteBackupResponse();
      //expect(instance).to.be.a(AmazonFsx.DeleteBackupResponse);
    });
