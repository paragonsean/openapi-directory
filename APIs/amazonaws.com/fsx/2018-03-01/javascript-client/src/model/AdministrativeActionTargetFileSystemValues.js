...
/**
 * The AdministrativeActionTargetFileSystemValues model module.
 * @module model/AdministrativeActionTargetFileSystemValues
 * @version 2018-03-01
 */
class AdministrativeActionTargetFileSystemValues {
    /**
     * Constructs a new <code>AdministrativeActionTargetFileSystemValues</code>.
     * @alias module:model/AdministrativeActionTargetFileSystemValues
     * @implements module:model/FileSystem
     */
    constructor() { 
        FileSystem.initialize(this);
        AdministrativeActionTargetFileSystemValues.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdministrativeActionTargetFileSystemValues</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdministrativeActionTargetFileSystemValues} obj Optional instance to populate.
     * @return {module:model/AdministrativeActionTargetFileSystemValues} The populated <code>AdministrativeActionTargetFileSystemValues</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdministrativeActionTargetFileSystemValues();
    ...
    /**
     * Validates the JSON data with respect to <code>AdministrativeActionTargetFileSystemValues</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdministrativeActionTargetFileSystemValues</code>.
     */
 ...
 */
AdministrativeActionTargetFileSystemValues.prototype['OwnerId'] = undefined;

/**
 * @member {Date} CreationTime
 */
AdministrativeActionTargetFileSystemValues.prototype['CreationTime'] = undefined;

/**
 * @member {String} FileSystemId
 */
AdministrativeActionTargetFileSystemValues.prototype['FileSystemId'] = undefined;

/**
 * @member {module:model/FileSystemType} FileSystemType
 */
AdministrativeActionTargetFileSystemValues.prototype['FileSystemType'] = undefined;

/**
 * @member {module:model/FileSystemLifecycle} Lifecycle
 */
AdministrativeActionTargetFileSystemValues.prototype['Lifecycle'] = undefined;

/**
 * @member {module:model/FileSystemFailureDetails} FailureDetails
 */
AdministrativeActionTargetFileSystemValues.prototype['FailureDetails'] = undefined;

/**
 * @member {Number} StorageCapacity
 */
AdministrativeActionTargetFileSystemValues.prototype['StorageCapacity'] = undefined;

/**
 * @member {module:model/StorageType} StorageType
 */
AdministrativeActionTargetFileSystemValues.prototype['StorageType'] = undefined;

/**
 * @member {String} VpcId
 */
AdministrativeActionTargetFileSystemValues.prototype['VpcId'] = undefined;

/**
 * @member {Array} SubnetIds
 */
AdministrativeActionTargetFileSystemValues.prototype['SubnetIds'] = undefined;

/**
 * @member {Array} NetworkInterfaceIds
 */
AdministrativeActionTargetFileSystemValues.prototype['NetworkInterfaceIds'] = undefined;

/**
 * @member {String} DNSName
 */
AdministrativeActionTargetFileSystemValues.prototype['DNSName'] = undefined;

/**
 * @member {String} KmsKeyId
 */
AdministrativeActionTargetFileSystemValues.prototype['KmsKeyId'] = undefined;

/**
 * @member {String} ResourceARN
 */
AdministrativeActionTargetFileSystemValues.prototype['ResourceARN'] = undefined;

/**
 * @member {Array} Tags
 */
AdministrativeActionTargetFileSystemValues.prototype['Tags'] = undefined;

/**
 * @member {module:model/FileSystemWindowsConfiguration} WindowsConfiguration
 */
AdministrativeActionTargetFileSystemValues.prototype['WindowsConfiguration'] = undefined;

/**
 * @member {module:model/LustreFileSystemConfiguration} LustreConfiguration
 */
AdministrativeActionTargetFileSystemValues.prototype['LustreConfiguration'] = undefined;

/**
 * @member {Array} AdministrativeActions
 */
AdministrativeActionTargetFileSystemValues.prototype['AdministrativeActions'] = undefined;

/**
 * @member {module:model/FileSystemOntapConfiguration} OntapConfiguration
 */
AdministrativeActionTargetFileSystemValues.prototype['OntapConfiguration'] = undefined;

/**
 * @member {String} FileSystemTypeVersion
 */
AdministrativeActionTargetFileSystemValues.prototype['FileSystemTypeVersion'] = undefined;

/**
 * @member {module:model/FileSystemOpenZFSConfiguration} OpenZFSConfiguration
 */
AdministrativeActionTargetFileSystemValues.prototype['OpenZFSConfiguration'] = undefined;
...
export default AdministrativeActionTargetFileSystemValues;
