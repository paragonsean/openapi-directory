...
/**
 * The UpdateDataRepositoryAssociationResponseAssociation model module.
 * @module model/UpdateDataRepositoryAssociationResponseAssociation
 * @version 2018-03-01
 */
class UpdateDataRepositoryAssociationResponseAssociation {
    /**
     * Constructs a new <code>UpdateDataRepositoryAssociationResponseAssociation</code>.
     * @alias module:model/UpdateDataRepositoryAssociationResponseAssociation
     * @implements module:model/DataRepositoryAssociation
     */
    constructor() { 
        DataRepositoryAssociation.initialize(this);
        UpdateDataRepositoryAssociationResponseAssociation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateDataRepositoryAssociationResponseAssociation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateDataRepositoryAssociationResponseAssociation} obj Optional instance to populate.
     * @return {module:model/UpdateDataRepositoryAssociationResponseAssociation} The populated <code>UpdateDataRepositoryAssociationResponseAssociation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateDataRepositoryAssociationResponseAssociation();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateDataRepositoryAssociationResponseAssociation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateDataRepositoryAssociationResponseAssociation</code>.
     */
 ...
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['AssociationId'] = undefined;
 ...
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['ResourceARN'] = undefined;

/**
 * The globally unique ID of the file system, assigned by Amazon FSx.
 * @member {String} FileSystemId
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['FileSystemId'] = undefined;

/**
 * @member {module:model/DataRepositoryLifecycle} Lifecycle
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['Lifecycle'] = undefined;

/**
 * @member {module:model/DataRepositoryFailureDetails} FailureDetails
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['FailureDetails'] = undefined;

/**
 * @member {String} FileSystemPath
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['FileSystemPath'] = undefined;

/**
 * @member {String} DataRepositoryPath
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['DataRepositoryPath'] = undefined;

/**
 * @member {Boolean} BatchImportMetaDataOnCreate
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['BatchImportMetaDataOnCreate'] = undefined;

/**
 * @member {Number} ImportedFileChunkSize
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['ImportedFileChunkSize'] = undefined;

/**
 * @member {module:model/DataRepositoryAssociationS3} S3
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['S3'] = undefined;

/**
 * A list of <code>Tag</code> values, with a maximum of 50 elements.
 * @member {Array.<module:model/Tag>} Tags
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['Tags'] = undefined;

/**
 * The time that the resource was created, in seconds (since 1970-01-01T00:00:00Z), also known as Unix time.
 * @member {Date} CreationTime
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['CreationTime'] = undefined;

/**
 * @member {String} FileCacheId
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['FileCacheId'] = undefined;

/**
 * @member {String} FileCachePath
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['FileCachePath'] = undefined;

/**
 * @member {Array} DataRepositorySubdirectories
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['DataRepositorySubdirectories'] = undefined;

/**
 * @member {module:model/DataRepositoryAssociationNFS} NFS
 */
UpdateDataRepositoryAssociationResponseAssociation.prototype['NFS'] = undefined;
...
export default UpdateDataRepositoryAssociationResponseAssociation;
