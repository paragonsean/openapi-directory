...
/**
 * The FileCache model module.
 * @module model/FileCache
 * @version 2018-03-01
 */
class FileCache {
    /**
     * Constructs a new <code>FileCache</code>.
    ...
    /**
     * Constructs a <code>FileCache</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileCache} obj Optional instance to populate.
     * @return {module:model/FileCache} The populated <code>FileCache</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileCache();
    ...
    /**
     * Validates the JSON data with respect to <code>FileCache</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileCache</code>.
     */
