...
/**
 * The FileCacheCreating model module.
 * @module model/FileCacheCreating
 * @version 2018-03-01
 */
class FileCacheCreating {
    /**
     * Constructs a new <code>FileCacheCreating</code>.
     * The response object for the Amazon File Cache resource being created in the &lt;code&gt;CreateFileCache&lt;/code&gt; operation.
     * @alias module:model/FileCacheCreating
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>FileCacheCreating</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileCacheCreating} obj Optional instance to populate.
     * @return {module:model/FileCacheCreating} The populated <code>FileCacheCreating</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileCacheCreating();
    ...
    /**
     * Validates the JSON data with respect to <code>FileCacheCreating</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileCacheCreating</code>.
     */
...
export default FileCacheCreating;
