...
/**
 * The StorageVirtualMachine model module.
 * @module model/StorageVirtualMachine
 * @version 2018-03-01
 */
class StorageVirtualMachine {
    /**
     * Constructs a new <code>StorageVirtualMachine</code>.
     * Describes the Amazon FSx for NetApp ONTAP storage virtual machine (SVM) configuration.
     * @alias module:model/StorageVirtualMachine
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StorageVirtualMachine</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StorageVirtualMachine} obj Optional instance to populate.
     * @return {module:model/StorageVirtualMachine} The populated <code>StorageVirtualMachine</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StorageVirtualMachine();
    ...
    /**
     * Validates the JSON data with respect to <code>StorageVirtualMachine</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StorageVirtualMachine</code>.
     */
...
export default StorageVirtualMachine;
