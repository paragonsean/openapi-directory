...
/**
 * The FileSystem model module.
 * @module model/FileSystem
 * @version 2018-03-01
 */
class FileSystem {
    /**
     * Constructs a new <code>FileSystem</code>.
     * A description of a specific Amazon FSx file system.
     * @alias module:model/FileSystem
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>FileSystem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileSystem} obj Optional instance to populate.
     * @return {module:model/FileSystem} The populated <code>FileSystem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileSystem();
    ...
    /**
     * Validates the JSON data with respect to <code>FileSystem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileSystem</code>.
     */
