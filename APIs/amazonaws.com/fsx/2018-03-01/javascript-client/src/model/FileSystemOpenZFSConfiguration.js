...
/**
 * The FileSystemOpenZFSConfiguration model module.
 * @module model/FileSystemOpenZFSConfiguration
 * @version 2018-03-01
 */
class FileSystemOpenZFSConfiguration {
    /**
     * Constructs a new <code>FileSystemOpenZFSConfiguration</code>.
     * @alias module:model/FileSystemOpenZFSConfiguration
     * @implements module:model/OpenZFSFileSystemConfiguration
     */
    constructor() { 
        OpenZFSFileSystemConfiguration.initialize(this);
        FileSystemOpenZFSConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FileSystemOpenZFSConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileSystemOpenZFSConfiguration} obj Optional instance to populate.
     * @return {module:model/FileSystemOpenZFSConfiguration} The populated <code>FileSystemOpenZFSConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileSystemOpenZFSConfiguration();
            OpenZFSFileSystemConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>FileSystemOpenZFSConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileSystemOpenZFSConfiguration</code>.
     */
 ...
 */
FileSystemOpenZFSConfiguration.prototype['AutomaticBackupRetentionDays'] = undefined;

/**
 * @member {Boolean} CopyTagsToBackups
 */
FileSystemOpenZFSConfiguration.prototype['CopyTagsToBackups'] = undefined;

/**
 * @member {Boolean} CopyTagsToVolumes
 */
FileSystemOpenZFSConfiguration.prototype['CopyTagsToVolumes'] = undefined;
 ...
 */
FileSystemOpenZFSConfiguration.prototype['DailyAutomaticBackupStartTime'] = undefined;

/**
 * @member {module:model/OpenZFSDeploymentType} DeploymentType
 */
FileSystemOpenZFSConfiguration.prototype['DeploymentType'] = undefined;

/**
 * @member {Number} ThroughputCapacity
 */
FileSystemOpenZFSConfiguration.prototype['ThroughputCapacity'] = undefined;
 ...
 */
FileSystemOpenZFSConfiguration.prototype['WeeklyMaintenanceStartTime'] = undefined;

/**
 * @member {module:model/DiskIopsConfiguration} DiskIopsConfiguration
 */
FileSystemOpenZFSConfiguration.prototype['DiskIopsConfiguration'] = undefined;

/**
 * @member {String} RootVolumeId
 */
FileSystemOpenZFSConfiguration.prototype['RootVolumeId'] = undefined;


// Implement OpenZFSFileSystemConfiguration interface:
/**
 * The number of days to retain automatic backups. Setting this property to <code>0</code> disables automatic backups. You can retain automatic backups for a maximum of 90 days. The default is <code>30</code>.
 * @member {Number} AutomaticBackupRetentionDays
 */
...
export default FileSystemOpenZFSConfiguration;
