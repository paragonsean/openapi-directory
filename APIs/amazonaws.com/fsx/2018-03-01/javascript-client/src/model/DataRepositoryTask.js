...
/**
 * The DataRepositoryTask model module.
 * @module model/DataRepositoryTask
 * @version 2018-03-01
 */
class DataRepositoryTask {
    /**
     * Constructs a new <code>DataRepositoryTask</code>.
     ...
     * @alias module:model/DataRepositoryTask
     * @param taskId {String} 
    ...
    /**
     * Constructs a <code>DataRepositoryTask</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataRepositoryTask} obj Optional instance to populate.
     * @return {module:model/DataRepositoryTask} The populated <code>DataRepositoryTask</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataRepositoryTask();
    ...
    /**
     * Validates the JSON data with respect to <code>DataRepositoryTask</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataRepositoryTask</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DataRepositoryTask.RequiredProperties) {
...
DataRepositoryTask.RequiredProperties = ["TaskId", "Lifecycle", "Type", "CreationTime"];
...
export default DataRepositoryTask;
