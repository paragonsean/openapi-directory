...
/**
 * The OpenZFSCreateRootVolumeConfiguration model module.
 * @module model/OpenZFSCreateRootVolumeConfiguration
 * @version 2018-03-01
 */
class OpenZFSCreateRootVolumeConfiguration {
    /**
     * Constructs a new <code>OpenZFSCreateRootVolumeConfiguration</code>.
     * The configuration of an Amazon FSx for OpenZFS root volume.
     * @alias module:model/OpenZFSCreateRootVolumeConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>OpenZFSCreateRootVolumeConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OpenZFSCreateRootVolumeConfiguration} obj Optional instance to populate.
     * @return {module:model/OpenZFSCreateRootVolumeConfiguration} The populated <code>OpenZFSCreateRootVolumeConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OpenZFSCreateRootVolumeConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>OpenZFSCreateRootVolumeConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OpenZFSCreateRootVolumeConfiguration</code>.
     */
...
export default OpenZFSCreateRootVolumeConfiguration;
