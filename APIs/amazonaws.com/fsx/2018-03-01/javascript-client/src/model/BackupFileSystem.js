...
/**
 * The BackupFileSystem model module.
 * @module model/BackupFileSystem
 * @version 2018-03-01
 */
class BackupFileSystem {
    /**
     * Constructs a new <code>BackupFileSystem</code>.
     * @alias module:model/BackupFileSystem
     * @implements module:model/FileSystem
     */
    constructor() { 
        FileSystem.initialize(this);
        BackupFileSystem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BackupFileSystem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BackupFileSystem} obj Optional instance to populate.
     * @return {module:model/BackupFileSystem} The populated <code>BackupFileSystem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BackupFileSystem();
    ...
    /**
     * Validates the JSON data with respect to <code>BackupFileSystem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BackupFileSystem</code>.
     */
 ...
 */
BackupFileSystem.prototype['OwnerId'] = undefined;

/**
 * @member {Date} CreationTime
 */
BackupFileSystem.prototype['CreationTime'] = undefined;

/**
 * @member {String} FileSystemId
 */
BackupFileSystem.prototype['FileSystemId'] = undefined;

/**
 * @member {module:model/FileSystemType} FileSystemType
 */
BackupFileSystem.prototype['FileSystemType'] = undefined;

/**
 * @member {module:model/FileSystemLifecycle} Lifecycle
 */
BackupFileSystem.prototype['Lifecycle'] = undefined;

/**
 * @member {module:model/FileSystemFailureDetails} FailureDetails
 */
BackupFileSystem.prototype['FailureDetails'] = undefined;

/**
 * @member {Number} StorageCapacity
 */
BackupFileSystem.prototype['StorageCapacity'] = undefined;

/**
 * @member {module:model/StorageType} StorageType
 */
BackupFileSystem.prototype['StorageType'] = undefined;

/**
 * @member {String} VpcId
 */
BackupFileSystem.prototype['VpcId'] = undefined;

/**
 * @member {Array} SubnetIds
 */
BackupFileSystem.prototype['SubnetIds'] = undefined;

/**
 * @member {Array} NetworkInterfaceIds
 */
BackupFileSystem.prototype['NetworkInterfaceIds'] = undefined;

/**
 * @member {String} DNSName
 */
BackupFileSystem.prototype['DNSName'] = undefined;

/**
 * @member {String} KmsKeyId
 */
BackupFileSystem.prototype['KmsKeyId'] = undefined;

/**
 * @member {String} ResourceARN
 */
BackupFileSystem.prototype['ResourceARN'] = undefined;

/**
 * @member {Array} Tags
 */
BackupFileSystem.prototype['Tags'] = undefined;

/**
 * @member {module:model/FileSystemWindowsConfiguration} WindowsConfiguration
 */
BackupFileSystem.prototype['WindowsConfiguration'] = undefined;

/**
 * @member {module:model/LustreFileSystemConfiguration} LustreConfiguration
 */
BackupFileSystem.prototype['LustreConfiguration'] = undefined;

/**
 * @member {Array} AdministrativeActions
 */
BackupFileSystem.prototype['AdministrativeActions'] = undefined;

/**
 * @member {module:model/FileSystemOntapConfiguration} OntapConfiguration
 */
BackupFileSystem.prototype['OntapConfiguration'] = undefined;

/**
 * @member {String} FileSystemTypeVersion
 */
BackupFileSystem.prototype['FileSystemTypeVersion'] = undefined;

/**
 * @member {module:model/FileSystemOpenZFSConfiguration} OpenZFSConfiguration
 */
BackupFileSystem.prototype['OpenZFSConfiguration'] = undefined;
...
export default BackupFileSystem;
