...
/**
 * The UpdateFileSystemRequestOpenZFSConfiguration model module.
 * @module model/UpdateFileSystemRequestOpenZFSConfiguration
 * @version 2018-03-01
 */
class UpdateFileSystemRequestOpenZFSConfiguration {
    /**
     * Constructs a new <code>UpdateFileSystemRequestOpenZFSConfiguration</code>.
     * @alias module:model/UpdateFileSystemRequestOpenZFSConfiguration
     * @implements module:model/UpdateFileSystemOpenZFSConfiguration
     */
    constructor() { 
        UpdateFileSystemOpenZFSConfiguration.initialize(this);
        UpdateFileSystemRequestOpenZFSConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFileSystemRequestOpenZFSConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFileSystemRequestOpenZFSConfiguration} obj Optional instance to populate.
     * @return {module:model/UpdateFileSystemRequestOpenZFSConfiguration} The populated <code>UpdateFileSystemRequestOpenZFSConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFileSystemRequestOpenZFSConfiguration();
            UpdateFileSystemOpenZFSConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFileSystemRequestOpenZFSConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFileSystemRequestOpenZFSConfiguration</code>.
     */
 ...
 */
UpdateFileSystemRequestOpenZFSConfiguration.prototype['AutomaticBackupRetentionDays'] = undefined;

/**
 * @member {Boolean} CopyTagsToBackups
 */
UpdateFileSystemRequestOpenZFSConfiguration.prototype['CopyTagsToBackups'] = undefined;

/**
 * @member {Boolean} CopyTagsToVolumes
 */
UpdateFileSystemRequestOpenZFSConfiguration.prototype['CopyTagsToVolumes'] = undefined;
 ...
 */
UpdateFileSystemRequestOpenZFSConfiguration.prototype['DailyAutomaticBackupStartTime'] = undefined;

/**
 * @member {Number} ThroughputCapacity
 */
UpdateFileSystemRequestOpenZFSConfiguration.prototype['ThroughputCapacity'] = undefined;
 ...
 */
UpdateFileSystemRequestOpenZFSConfiguration.prototype['WeeklyMaintenanceStartTime'] = undefined;

/**
 * @member {module:model/DiskIopsConfiguration} DiskIopsConfiguration
 */
UpdateFileSystemRequestOpenZFSConfiguration.prototype['DiskIopsConfiguration'] = undefined;


// Implement UpdateFileSystemOpenZFSConfiguration interface:
/**
 * The number of days to retain automatic backups. Setting this property to <code>0</code> disables automatic backups. You can retain automatic backups for a maximum of 90 days. The default is <code>30</code>.
 * @member {Number} AutomaticBackupRetentionDays
 */
...
export default UpdateFileSystemRequestOpenZFSConfiguration;
