...
/**
 * The CreateVolumeFromBackupResponseVolume model module.
 * @module model/CreateVolumeFromBackupResponseVolume
 * @version 2018-03-01
 */
class CreateVolumeFromBackupResponseVolume {
    /**
     * Constructs a new <code>CreateVolumeFromBackupResponseVolume</code>.
     * @alias module:model/CreateVolumeFromBackupResponseVolume
     * @implements module:model/Volume
     */
    constructor() { 
        Volume.initialize(this);
        CreateVolumeFromBackupResponseVolume.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateVolumeFromBackupResponseVolume</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateVolumeFromBackupResponseVolume} obj Optional instance to populate.
     * @return {module:model/CreateVolumeFromBackupResponseVolume} The populated <code>CreateVolumeFromBackupResponseVolume</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateVolumeFromBackupResponseVolume();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateVolumeFromBackupResponseVolume</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateVolumeFromBackupResponseVolume</code>.
     */
 ...
 */
CreateVolumeFromBackupResponseVolume.prototype['CreationTime'] = undefined;

/**
 * The globally unique ID of the file system, assigned by Amazon FSx.
 * @member {String} FileSystemId
 */
CreateVolumeFromBackupResponseVolume.prototype['FileSystemId'] = undefined;

/**
 * @member {module:model/VolumeLifecycle} Lifecycle
 */
CreateVolumeFromBackupResponseVolume.prototype['Lifecycle'] = undefined;

/**
 * @member {String} Name
 */
CreateVolumeFromBackupResponseVolume.prototype['Name'] = undefined;

/**
 * @member {module:model/OntapVolumeConfiguration} OntapConfiguration
 */
CreateVolumeFromBackupResponseVolume.prototype['OntapConfiguration'] = undefined;
 ...
 */
CreateVolumeFromBackupResponseVolume.prototype['ResourceARN'] = undefined;

/**
 * A list of <code>Tag</code> values, with a maximum of 50 elements.
 * @member {Array.<module:model/Tag>} Tags
 */
CreateVolumeFromBackupResponseVolume.prototype['Tags'] = undefined;

/**
 * @member {String} VolumeId
 */
CreateVolumeFromBackupResponseVolume.prototype['VolumeId'] = undefined;

/**
 * @member {module:model/VolumeType} VolumeType
 */
CreateVolumeFromBackupResponseVolume.prototype['VolumeType'] = undefined;

/**
 * @member {module:model/VolumeLifecycleTransitionReason} LifecycleTransitionReason
 */
CreateVolumeFromBackupResponseVolume.prototype['LifecycleTransitionReason'] = undefined;

/**
 * @member {Array} AdministrativeActions
 */
CreateVolumeFromBackupResponseVolume.prototype['AdministrativeActions'] = undefined;

/**
 * @member {module:model/VolumeOpenZFSConfiguration} OpenZFSConfiguration
 */
CreateVolumeFromBackupResponseVolume.prototype['OpenZFSConfiguration'] = undefined;
...
export default CreateVolumeFromBackupResponseVolume;
