...
/**
 * The CreateFileSystemOpenZFSConfiguration model module.
 * @module model/CreateFileSystemOpenZFSConfiguration
 * @version 2018-03-01
 */
class CreateFileSystemOpenZFSConfiguration {
    /**
     * Constructs a new <code>CreateFileSystemOpenZFSConfiguration</code>.
     * The Amazon FSx for OpenZFS configuration properties for the file system that you are creating.
     * @alias module:model/CreateFileSystemOpenZFSConfiguration
    ...
    /**
     * Constructs a <code>CreateFileSystemOpenZFSConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFileSystemOpenZFSConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateFileSystemOpenZFSConfiguration} The populated <code>CreateFileSystemOpenZFSConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFileSystemOpenZFSConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFileSystemOpenZFSConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFileSystemOpenZFSConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFileSystemOpenZFSConfiguration.RequiredProperties) {
...
CreateFileSystemOpenZFSConfiguration.RequiredProperties = ["DeploymentType", "ThroughputCapacity"];
...
export default CreateFileSystemOpenZFSConfiguration;
