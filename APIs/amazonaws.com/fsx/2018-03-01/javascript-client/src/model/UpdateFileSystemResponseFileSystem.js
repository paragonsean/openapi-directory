...
/**
 * The UpdateFileSystemResponseFileSystem model module.
 * @module model/UpdateFileSystemResponseFileSystem
 * @version 2018-03-01
 */
class UpdateFileSystemResponseFileSystem {
    /**
     * Constructs a new <code>UpdateFileSystemResponseFileSystem</code>.
     * @alias module:model/UpdateFileSystemResponseFileSystem
     * @implements module:model/FileSystem
     */
    constructor() { 
        FileSystem.initialize(this);
        UpdateFileSystemResponseFileSystem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFileSystemResponseFileSystem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFileSystemResponseFileSystem} obj Optional instance to populate.
     * @return {module:model/UpdateFileSystemResponseFileSystem} The populated <code>UpdateFileSystemResponseFileSystem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFileSystemResponseFileSystem();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFileSystemResponseFileSystem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFileSystemResponseFileSystem</code>.
     */
 ...
 */
UpdateFileSystemResponseFileSystem.prototype['OwnerId'] = undefined;

/**
 * @member {Date} CreationTime
 */
UpdateFileSystemResponseFileSystem.prototype['CreationTime'] = undefined;

/**
 * @member {String} FileSystemId
 */
UpdateFileSystemResponseFileSystem.prototype['FileSystemId'] = undefined;

/**
 * @member {module:model/FileSystemType} FileSystemType
 */
UpdateFileSystemResponseFileSystem.prototype['FileSystemType'] = undefined;

/**
 * @member {module:model/FileSystemLifecycle} Lifecycle
 */
UpdateFileSystemResponseFileSystem.prototype['Lifecycle'] = undefined;

/**
 * @member {module:model/FileSystemFailureDetails} FailureDetails
 */
UpdateFileSystemResponseFileSystem.prototype['FailureDetails'] = undefined;

/**
 * @member {Number} StorageCapacity
 */
UpdateFileSystemResponseFileSystem.prototype['StorageCapacity'] = undefined;

/**
 * @member {module:model/StorageType} StorageType
 */
UpdateFileSystemResponseFileSystem.prototype['StorageType'] = undefined;

/**
 * @member {String} VpcId
 */
UpdateFileSystemResponseFileSystem.prototype['VpcId'] = undefined;

/**
 * @member {Array} SubnetIds
 */
UpdateFileSystemResponseFileSystem.prototype['SubnetIds'] = undefined;

/**
 * @member {Array} NetworkInterfaceIds
 */
UpdateFileSystemResponseFileSystem.prototype['NetworkInterfaceIds'] = undefined;

/**
 * @member {String} DNSName
 */
UpdateFileSystemResponseFileSystem.prototype['DNSName'] = undefined;

/**
 * @member {String} KmsKeyId
 */
UpdateFileSystemResponseFileSystem.prototype['KmsKeyId'] = undefined;

/**
 * @member {String} ResourceARN
 */
UpdateFileSystemResponseFileSystem.prototype['ResourceARN'] = undefined;

/**
 * @member {Array} Tags
 */
UpdateFileSystemResponseFileSystem.prototype['Tags'] = undefined;

/**
 * @member {module:model/FileSystemWindowsConfiguration} WindowsConfiguration
 */
UpdateFileSystemResponseFileSystem.prototype['WindowsConfiguration'] = undefined;

/**
 * @member {module:model/LustreFileSystemConfiguration} LustreConfiguration
 */
UpdateFileSystemResponseFileSystem.prototype['LustreConfiguration'] = undefined;

/**
 * @member {Array} AdministrativeActions
 */
UpdateFileSystemResponseFileSystem.prototype['AdministrativeActions'] = undefined;

/**
 * @member {module:model/FileSystemOntapConfiguration} OntapConfiguration
 */
UpdateFileSystemResponseFileSystem.prototype['OntapConfiguration'] = undefined;

/**
 * @member {String} FileSystemTypeVersion
 */
UpdateFileSystemResponseFileSystem.prototype['FileSystemTypeVersion'] = undefined;

/**
 * @member {module:model/FileSystemOpenZFSConfiguration} OpenZFSConfiguration
 */
UpdateFileSystemResponseFileSystem.prototype['OpenZFSConfiguration'] = undefined;
...
export default UpdateFileSystemResponseFileSystem;
