...
/**
 * The CreateDataRepositoryAssociationResponseAssociation model module.
 * @module model/CreateDataRepositoryAssociationResponseAssociation
 * @version 2018-03-01
 */
class CreateDataRepositoryAssociationResponseAssociation {
    /**
     * Constructs a new <code>CreateDataRepositoryAssociationResponseAssociation</code>.
     * @alias module:model/CreateDataRepositoryAssociationResponseAssociation
     * @implements module:model/DataRepositoryAssociation
     */
    constructor() { 
        DataRepositoryAssociation.initialize(this);
        CreateDataRepositoryAssociationResponseAssociation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateDataRepositoryAssociationResponseAssociation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDataRepositoryAssociationResponseAssociation} obj Optional instance to populate.
     * @return {module:model/CreateDataRepositoryAssociationResponseAssociation} The populated <code>CreateDataRepositoryAssociationResponseAssociation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDataRepositoryAssociationResponseAssociation();
            DataRepositoryAssociation.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDataRepositoryAssociationResponseAssociation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDataRepositoryAssociationResponseAssociation</code>.
     */
 ...
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['AssociationId'] = undefined;
 ...
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['ResourceARN'] = undefined;

/**
 * The globally unique ID of the file system, assigned by Amazon FSx.
 * @member {String} FileSystemId
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['FileSystemId'] = undefined;

/**
 * @member {module:model/DataRepositoryLifecycle} Lifecycle
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['Lifecycle'] = undefined;

/**
 * @member {module:model/DataRepositoryFailureDetails} FailureDetails
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['FailureDetails'] = undefined;

/**
 * @member {String} FileSystemPath
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['FileSystemPath'] = undefined;

/**
 * @member {String} DataRepositoryPath
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['DataRepositoryPath'] = undefined;

/**
 * @member {Boolean} BatchImportMetaDataOnCreate
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['BatchImportMetaDataOnCreate'] = undefined;

/**
 * @member {Number} ImportedFileChunkSize
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['ImportedFileChunkSize'] = undefined;

/**
 * @member {module:model/DataRepositoryAssociationS3} S3
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['S3'] = undefined;

/**
 * A list of <code>Tag</code> values, with a maximum of 50 elements.
 * @member {Array.<module:model/Tag>} Tags
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['Tags'] = undefined;

/**
 * The time that the resource was created, in seconds (since 1970-01-01T00:00:00Z), also known as Unix time.
 * @member {Date} CreationTime
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['CreationTime'] = undefined;

/**
 * @member {String} FileCacheId
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['FileCacheId'] = undefined;

/**
 * @member {String} FileCachePath
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['FileCachePath'] = undefined;

/**
 * @member {Array} DataRepositorySubdirectories
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['DataRepositorySubdirectories'] = undefined;

/**
 * @member {module:model/DataRepositoryAssociationNFS} NFS
 */
CreateDataRepositoryAssociationResponseAssociation.prototype['NFS'] = undefined;


// Implement DataRepositoryAssociation interface:
/**
 * @member {String} AssociationId
 */
...
export default CreateDataRepositoryAssociationResponseAssociation;
