...
import SnaplockRetentionPeriod from './SnaplockRetentionPeriod';
...
/**
 * The CreateSnaplockConfigurationRetentionPeriod model module.
 * @module model/CreateSnaplockConfigurationRetentionPeriod
 * @version 2018-03-01
 */
class CreateSnaplockConfigurationRetentionPeriod {
    /**
     * Constructs a new <code>CreateSnaplockConfigurationRetentionPeriod</code>.
     * @alias module:model/CreateSnaplockConfigurationRetentionPeriod
     * @implements module:model/SnaplockRetentionPeriod
    ...
    constructor(defaultRetention, minimumRetention, maximumRetention) { 
        ...
        CreateSnaplockConfigurationRetentionPeriod.initialize(this, defaultRetention, minimumRetention, maximumRetention);
    }
    ...
    /**
     * Constructs a <code>CreateSnaplockConfigurationRetentionPeriod</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSnaplockConfigurationRetentionPeriod} obj Optional instance to populate.
     * @return {module:model/CreateSnaplockConfigurationRetentionPeriod} The populated <code>CreateSnaplockConfigurationRetentionPeriod</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSnaplockConfigurationRetentionPeriod();
            SnaplockRetentionPeriod.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSnaplockConfigurationRetentionPeriod</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSnaplockConfigurationRetentionPeriod</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateSnaplockConfigurationRetentionPeriod.RequiredProperties) {
...
CreateSnaplockConfigurationRetentionPeriod.RequiredProperties = ["DefaultRetention", "MinimumRetention", "MaximumRetention"];

/**
 * @member {module:model/SnaplockRetentionPeriodDefaultRetention} DefaultRetention
 */
CreateSnaplockConfigurationRetentionPeriod.prototype['DefaultRetention'] = undefined;

/**
 * @member {module:model/SnaplockRetentionPeriodMinimumRetention} MinimumRetention
 */
CreateSnaplockConfigurationRetentionPeriod.prototype['MinimumRetention'] = undefined;

/**
 * @member {module:model/SnaplockRetentionPeriodMaximumRetention} MaximumRetention
 */
CreateSnaplockConfigurationRetentionPeriod.prototype['MaximumRetention'] = undefined;


// Implement SnaplockRetentionPeriod interface:
/**
 * @member {module:model/SnaplockRetentionPeriodDefaultRetention} DefaultRetention
 */
...
export default CreateSnaplockConfigurationRetentionPeriod;
