...
/**
 * The CreateFileSystemResponseFileSystem model module.
 * @module model/CreateFileSystemResponseFileSystem
 * @version 2018-03-01
 */
class CreateFileSystemResponseFileSystem {
    /**
     * Constructs a new <code>CreateFileSystemResponseFileSystem</code>.
     * @alias module:model/CreateFileSystemResponseFileSystem
     * @implements module:model/FileSystem
     */
    constructor() { 
        FileSystem.initialize(this);
        CreateFileSystemResponseFileSystem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateFileSystemResponseFileSystem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFileSystemResponseFileSystem} obj Optional instance to populate.
     * @return {module:model/CreateFileSystemResponseFileSystem} The populated <code>CreateFileSystemResponseFileSystem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFileSystemResponseFileSystem();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFileSystemResponseFileSystem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFileSystemResponseFileSystem</code>.
     */
 ...
 */
CreateFileSystemResponseFileSystem.prototype['OwnerId'] = undefined;

/**
 * @member {Date} CreationTime
 */
CreateFileSystemResponseFileSystem.prototype['CreationTime'] = undefined;

/**
 * @member {String} FileSystemId
 */
CreateFileSystemResponseFileSystem.prototype['FileSystemId'] = undefined;

/**
 * @member {module:model/FileSystemType} FileSystemType
 */
CreateFileSystemResponseFileSystem.prototype['FileSystemType'] = undefined;

/**
 * @member {module:model/FileSystemLifecycle} Lifecycle
 */
CreateFileSystemResponseFileSystem.prototype['Lifecycle'] = undefined;

/**
 * @member {module:model/FileSystemFailureDetails} FailureDetails
 */
CreateFileSystemResponseFileSystem.prototype['FailureDetails'] = undefined;

/**
 * @member {Number} StorageCapacity
 */
CreateFileSystemResponseFileSystem.prototype['StorageCapacity'] = undefined;

/**
 * @member {module:model/StorageType} StorageType
 */
CreateFileSystemResponseFileSystem.prototype['StorageType'] = undefined;

/**
 * @member {String} VpcId
 */
CreateFileSystemResponseFileSystem.prototype['VpcId'] = undefined;

/**
 * @member {Array} SubnetIds
 */
CreateFileSystemResponseFileSystem.prototype['SubnetIds'] = undefined;

/**
 * @member {Array} NetworkInterfaceIds
 */
CreateFileSystemResponseFileSystem.prototype['NetworkInterfaceIds'] = undefined;

/**
 * @member {String} DNSName
 */
CreateFileSystemResponseFileSystem.prototype['DNSName'] = undefined;

/**
 * @member {String} KmsKeyId
 */
CreateFileSystemResponseFileSystem.prototype['KmsKeyId'] = undefined;

/**
 * @member {String} ResourceARN
 */
CreateFileSystemResponseFileSystem.prototype['ResourceARN'] = undefined;

/**
 * @member {Array} Tags
 */
CreateFileSystemResponseFileSystem.prototype['Tags'] = undefined;

/**
 * @member {module:model/FileSystemWindowsConfiguration} WindowsConfiguration
 */
CreateFileSystemResponseFileSystem.prototype['WindowsConfiguration'] = undefined;

/**
 * @member {module:model/LustreFileSystemConfiguration} LustreConfiguration
 */
CreateFileSystemResponseFileSystem.prototype['LustreConfiguration'] = undefined;

/**
 * @member {Array} AdministrativeActions
 */
CreateFileSystemResponseFileSystem.prototype['AdministrativeActions'] = undefined;

/**
 * @member {module:model/FileSystemOntapConfiguration} OntapConfiguration
 */
CreateFileSystemResponseFileSystem.prototype['OntapConfiguration'] = undefined;

/**
 * @member {String} FileSystemTypeVersion
 */
CreateFileSystemResponseFileSystem.prototype['FileSystemTypeVersion'] = undefined;

/**
 * @member {module:model/FileSystemOpenZFSConfiguration} OpenZFSConfiguration
 */
CreateFileSystemResponseFileSystem.prototype['OpenZFSConfiguration'] = undefined;
...
export default CreateFileSystemResponseFileSystem;
