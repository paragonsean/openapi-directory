...
/**
 * The CreateVolumeResponseVolume model module.
 * @module model/CreateVolumeResponseVolume
 * @version 2018-03-01
 */
class CreateVolumeResponseVolume {
    /**
     * Constructs a new <code>CreateVolumeResponseVolume</code>.
     * @alias module:model/CreateVolumeResponseVolume
     * @implements module:model/Volume
     */
    constructor() { 
        Volume.initialize(this);
        CreateVolumeResponseVolume.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateVolumeResponseVolume</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateVolumeResponseVolume} obj Optional instance to populate.
     * @return {module:model/CreateVolumeResponseVolume} The populated <code>CreateVolumeResponseVolume</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateVolumeResponseVolume();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateVolumeResponseVolume</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateVolumeResponseVolume</code>.
     */
 ...
 */
CreateVolumeResponseVolume.prototype['CreationTime'] = undefined;

/**
 * The globally unique ID of the file system, assigned by Amazon FSx.
 * @member {String} FileSystemId
 */
CreateVolumeResponseVolume.prototype['FileSystemId'] = undefined;

/**
 * @member {module:model/VolumeLifecycle} Lifecycle
 */
CreateVolumeResponseVolume.prototype['Lifecycle'] = undefined;

/**
 * @member {String} Name
 */
CreateVolumeResponseVolume.prototype['Name'] = undefined;

/**
 * @member {module:model/OntapVolumeConfiguration} OntapConfiguration
 */
CreateVolumeResponseVolume.prototype['OntapConfiguration'] = undefined;
 ...
 */
CreateVolumeResponseVolume.prototype['ResourceARN'] = undefined;

/**
 * A list of <code>Tag</code> values, with a maximum of 50 elements.
 * @member {Array.<module:model/Tag>} Tags
 */
CreateVolumeResponseVolume.prototype['Tags'] = undefined;

/**
 * @member {String} VolumeId
 */
CreateVolumeResponseVolume.prototype['VolumeId'] = undefined;

/**
 * @member {module:model/VolumeType} VolumeType
 */
CreateVolumeResponseVolume.prototype['VolumeType'] = undefined;

/**
 * @member {module:model/VolumeLifecycleTransitionReason} LifecycleTransitionReason
 */
CreateVolumeResponseVolume.prototype['LifecycleTransitionReason'] = undefined;

/**
 * @member {Array} AdministrativeActions
 */
CreateVolumeResponseVolume.prototype['AdministrativeActions'] = undefined;

/**
 * @member {module:model/VolumeOpenZFSConfiguration} OpenZFSConfiguration
 */
CreateVolumeResponseVolume.prototype['OpenZFSConfiguration'] = undefined;
...
export default CreateVolumeResponseVolume;
