...
/**
 * The CreateFileSystemWindowsConfiguration model module.
 * @module model/CreateFileSystemWindowsConfiguration
 * @version 2018-03-01
 */
class CreateFileSystemWindowsConfiguration {
    /**
     * Constructs a new <code>CreateFileSystemWindowsConfiguration</code>.
     ...
     * @alias module:model/CreateFileSystemWindowsConfiguration
    ...
    /**
     * Constructs a <code>CreateFileSystemWindowsConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFileSystemWindowsConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateFileSystemWindowsConfiguration} The populated <code>CreateFileSystemWindowsConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFileSystemWindowsConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFileSystemWindowsConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFileSystemWindowsConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFileSystemWindowsConfiguration.RequiredProperties) {
...
CreateFileSystemWindowsConfiguration.RequiredProperties = ["ThroughputCapacity"];
...
export default CreateFileSystemWindowsConfiguration;
