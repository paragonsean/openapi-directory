...
/**
 * The WindowsFileSystemConfiguration model module.
 * @module model/WindowsFileSystemConfiguration
 * @version 2018-03-01
 */
class WindowsFileSystemConfiguration {
    /**
     * Constructs a new <code>WindowsFileSystemConfiguration</code>.
     * The configuration for this Microsoft Windows file system.
     * @alias module:model/WindowsFileSystemConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>WindowsFileSystemConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WindowsFileSystemConfiguration} obj Optional instance to populate.
     * @return {module:model/WindowsFileSystemConfiguration} The populated <code>WindowsFileSystemConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WindowsFileSystemConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>WindowsFileSystemConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WindowsFileSystemConfiguration</code>.
     */
...
export default WindowsFileSystemConfiguration;
