...
class CustomerAgentInfo(Model):
    ...
    def __init__(self, active_agents: int=None, healthy_agents: int=None, black_listed_agents: int=None, shutdown_agents: int=None, unhealthy_agents: int=None, total_agents: int=None, unknown_agents: int=None):
        """CustomerAgentInfo - a model defined in OpenAPI

        :param active_agents: The active_agents of this CustomerAgentInfo.
        :param healthy_agents: The healthy_agents of this CustomerAgentInfo.
        :param black_listed_agents: The black_listed_agents of this CustomerAgentInfo.
        :param shutdown_agents: The shutdown_agents of this CustomerAgentInfo.
        :param unhealthy_agents: The unhealthy_agents of this CustomerAgentInfo.
        :param total_agents: The total_agents of this CustomerAgentInfo.
        :param unknown_agents: The unknown_agents of this CustomerAgentInfo.
        """
        self.openapi_types = {
            'active_agents': int,
            'healthy_agents': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CustomerAgentInfo':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CustomerAgentInfo of this CustomerAgentInfo.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def active_agents(self):
        """Gets the active_agents of this CustomerAgentInfo.


        :return: The active_agents of this CustomerAgentInfo.
        :rtype: int
        """
    ...
    def active_agents(self, active_agents):
        """Sets the active_agents of this CustomerAgentInfo.
    ...
    def healthy_agents(self):
        """Gets the healthy_agents of this CustomerAgentInfo.


        :return: The healthy_agents of this CustomerAgentInfo.
        :rtype: int
        """
    ...
    def healthy_agents(self, healthy_agents):
        """Sets the healthy_agents of this CustomerAgentInfo.
    ...
    def black_listed_agents(self):
        """Gets the black_listed_agents of this CustomerAgentInfo.


        :return: The black_listed_agents of this CustomerAgentInfo.
        :rtype: int
        """
    ...
    def black_listed_agents(self, black_listed_agents):
        """Sets the black_listed_agents of this CustomerAgentInfo.
    ...
    def shutdown_agents(self):
        """Gets the shutdown_agents of this CustomerAgentInfo.


        :return: The shutdown_agents of this CustomerAgentInfo.
        :rtype: int
        """
    ...
    def shutdown_agents(self, shutdown_agents):
        """Sets the shutdown_agents of this CustomerAgentInfo.
    ...
    def unhealthy_agents(self):
        """Gets the unhealthy_agents of this CustomerAgentInfo.


        :return: The unhealthy_agents of this CustomerAgentInfo.
        :rtype: int
        """
    ...
    def unhealthy_agents(self, unhealthy_agents):
        """Sets the unhealthy_agents of this CustomerAgentInfo.
    ...
    def total_agents(self):
        """Gets the total_agents of this CustomerAgentInfo.


        :return: The total_agents of this CustomerAgentInfo.
        :rtype: int
        """
    ...
    def total_agents(self, total_agents):
        """Sets the total_agents of this CustomerAgentInfo.
    ...
    def unknown_agents(self):
        """Gets the unknown_agents of this CustomerAgentInfo.


        :return: The unknown_agents of this CustomerAgentInfo.
        :rtype: int
        """
    ...
    def unknown_agents(self, unknown_agents):
        """Sets the unknown_agents of this CustomerAgentInfo.
