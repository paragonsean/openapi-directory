...
class CreateTagsRequest {
     ...
     * @param tags {Array} 
     */
    constructor(configurationIds, tags) { 
        
        CreateTagsRequest.initialize(this, configurationIds, tags);
    }
     ...
     */
    static initialize(obj, configurationIds, tags) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateTagsRequest.RequiredProperties) {
...
CreateTagsRequest.RequiredProperties = ["configurationIds", "tags"];

/**
 * @member {Array} configurationIds
 */
CreateTagsRequest.prototype['configurationIds'] = undefined;
