...
/**
 * The ExportConfigurationsResponse model module.
 * @module model/ExportConfigurationsResponse
 * @version 2015-11-01
 */
class ExportConfigurationsResponse {
    /**
     * Constructs a new <code>ExportConfigurationsResponse</code>.
     * @alias module:model/ExportConfigurationsResponse
     */
    constructor() { 
        
        ExportConfigurationsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExportConfigurationsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExportConfigurationsResponse} obj Optional instance to populate.
     * @return {module:model/ExportConfigurationsResponse} The populated <code>ExportConfigurationsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExportConfigurationsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ExportConfigurationsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportConfigurationsResponse</code>.
     */
 ...
 */
ExportConfigurationsResponse.prototype['exportId'] = undefined;
...
export default ExportConfigurationsResponse;
