...
/**
 * The StartContinuousExportResponse model module.
 * @module model/StartContinuousExportResponse
 * @version 2015-11-01
 */
class StartContinuousExportResponse {
    /**
     * Constructs a new <code>StartContinuousExportResponse</code>.
     * @alias module:model/StartContinuousExportResponse
     */
    constructor() { 
        
        StartContinuousExportResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartContinuousExportResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartContinuousExportResponse} obj Optional instance to populate.
     * @return {module:model/StartContinuousExportResponse} The populated <code>StartContinuousExportResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartContinuousExportResponse();
            ...
            if (data.hasOwnProperty('schemaStorageConfig')) {
                obj['schemaStorageConfig'] = ApiClient.convertToType(data['schemaStorageConfig'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartContinuousExportResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartContinuousExportResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['schemaStorageConfig']) { // data not null
          Object.validateJSON(data['schemaStorageConfig']);
        }
 ...
 */
StartContinuousExportResponse.prototype['exportId'] = undefined;

/**
 * @member {String} s3Bucket
 */
StartContinuousExportResponse.prototype['s3Bucket'] = undefined;

/**
 * @member {Date} startTime
 */
StartContinuousExportResponse.prototype['startTime'] = undefined;

/**
 * @member {module:model/DataSource} dataSource
 */
StartContinuousExportResponse.prototype['dataSource'] = undefined;

/**
 * @member {Object} schemaStorageConfig
 */
StartContinuousExportResponse.prototype['schemaStorageConfig'] = undefined;
...
export default StartContinuousExportResponse;
