...
/**
 * The ConfigurationTag model module.
 * @module model/ConfigurationTag
 * @version 2015-11-01
 */
class ConfigurationTag {
    /**
     * Constructs a new <code>ConfigurationTag</code>.
     * Tags for a configuration item. Tags are metadata that help you categorize IT assets.
     * @alias module:model/ConfigurationTag
     */
    constructor() { 
        
        ConfigurationTag.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConfigurationTag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfigurationTag} obj Optional instance to populate.
     * @return {module:model/ConfigurationTag} The populated <code>ConfigurationTag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfigurationTag();

            if (data.hasOwnProperty('configurationType')) {
                obj['configurationType'] = ApiClient.convertToType(data['configurationType'], ConfigurationItemType);
            }
            ...
            if (data.hasOwnProperty('timeOfCreation')) {
                obj['timeOfCreation'] = ApiClient.convertToType(data['timeOfCreation'], 'Date');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ConfigurationTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfigurationTag</code>.
     */
    static validateJSON(data) {
        // validate the optional field `configurationType`
        if (data['configurationType']) { // data not null
          ConfigurationItemType.validateJSON(data['configurationType']);
        }
        ...
        if (data['timeOfCreation']) { // data not null
          Date.validateJSON(data['timeOfCreation']);
        }
...
/**
 * @member {module:model/ConfigurationItemType} configurationType
 */
ConfigurationTag.prototype['configurationType'] = undefined;

/**
 * @member {String} configurationId
 */
ConfigurationTag.prototype['configurationId'] = undefined;

/**
 * @member {String} key
 */
ConfigurationTag.prototype['key'] = undefined;

/**
 * @member {String} value
 */
ConfigurationTag.prototype['value'] = undefined;

/**
 * @member {Date} timeOfCreation
 */
ConfigurationTag.prototype['timeOfCreation'] = undefined;
