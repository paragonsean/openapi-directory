...
/**
 * The DescribeExportConfigurationsRequest model module.
 * @module model/DescribeExportConfigurationsRequest
 * @version 2015-11-01
 */
class DescribeExportConfigurationsRequest {
    /**
     * Constructs a new <code>DescribeExportConfigurationsRequest</code>.
     * @alias module:model/DescribeExportConfigurationsRequest
     */
    constructor() { 
        
        DescribeExportConfigurationsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeExportConfigurationsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeExportConfigurationsRequest} obj Optional instance to populate.
     * @return {module:model/DescribeExportConfigurationsRequest} The populated <code>DescribeExportConfigurationsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeExportConfigurationsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeExportConfigurationsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeExportConfigurationsRequest</code>.
     */
 ...
 */
DescribeExportConfigurationsRequest.prototype['exportIds'] = undefined;

/**
 * @member {Number} maxResults
 */
DescribeExportConfigurationsRequest.prototype['maxResults'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeExportConfigurationsRequest.prototype['nextToken'] = undefined;
...
export default DescribeExportConfigurationsRequest;
