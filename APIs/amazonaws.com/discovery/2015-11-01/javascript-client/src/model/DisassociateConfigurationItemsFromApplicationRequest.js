...
/**
 * The DisassociateConfigurationItemsFromApplicationRequest model module.
 * @module model/DisassociateConfigurationItemsFromApplicationRequest
 * @version 2015-11-01
 */
class DisassociateConfigurationItemsFromApplicationRequest {
    /**
     * Constructs a new <code>DisassociateConfigurationItemsFromApplicationRequest</code>.
     * @alias module:model/DisassociateConfigurationItemsFromApplicationRequest
    ...
    constructor(applicationConfigurationId, configurationIds) { 
        ...
        DisassociateConfigurationItemsFromApplicationRequest.initialize(this, applicationConfigurationId, configurationIds);
    }
    ...
    /**
     * Constructs a <code>DisassociateConfigurationItemsFromApplicationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateConfigurationItemsFromApplicationRequest} obj Optional instance to populate.
     * @return {module:model/DisassociateConfigurationItemsFromApplicationRequest} The populated <code>DisassociateConfigurationItemsFromApplicationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateConfigurationItemsFromApplicationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateConfigurationItemsFromApplicationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateConfigurationItemsFromApplicationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisassociateConfigurationItemsFromApplicationRequest.RequiredProperties) {
...
DisassociateConfigurationItemsFromApplicationRequest.RequiredProperties = ["applicationConfigurationId", "configurationIds"];

/**
 * @member {String} applicationConfigurationId
 */
DisassociateConfigurationItemsFromApplicationRequest.prototype['applicationConfigurationId'] = undefined;

/**
 * @member {Array} configurationIds
 */
DisassociateConfigurationItemsFromApplicationRequest.prototype['configurationIds'] = undefined;
...
export default DisassociateConfigurationItemsFromApplicationRequest;
