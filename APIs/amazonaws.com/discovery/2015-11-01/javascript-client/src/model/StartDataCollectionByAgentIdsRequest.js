...
/**
 * The StartDataCollectionByAgentIdsRequest model module.
 * @module model/StartDataCollectionByAgentIdsRequest
 * @version 2015-11-01
 */
class StartDataCollectionByAgentIdsRequest {
    /**
     * Constructs a new <code>StartDataCollectionByAgentIdsRequest</code>.
     * @alias module:model/StartDataCollectionByAgentIdsRequest
     * @param agentIds {Array} 
     */
    constructor(agentIds) { 
        
        StartDataCollectionByAgentIdsRequest.initialize(this, agentIds);
    }
    ...
    /**
     * Constructs a <code>StartDataCollectionByAgentIdsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartDataCollectionByAgentIdsRequest} obj Optional instance to populate.
     * @return {module:model/StartDataCollectionByAgentIdsRequest} The populated <code>StartDataCollectionByAgentIdsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartDataCollectionByAgentIdsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StartDataCollectionByAgentIdsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartDataCollectionByAgentIdsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartDataCollectionByAgentIdsRequest.RequiredProperties) {
...
StartDataCollectionByAgentIdsRequest.RequiredProperties = ["agentIds"];

/**
 * @member {Array} agentIds
 */
StartDataCollectionByAgentIdsRequest.prototype['agentIds'] = undefined;
...
export default StartDataCollectionByAgentIdsRequest;
