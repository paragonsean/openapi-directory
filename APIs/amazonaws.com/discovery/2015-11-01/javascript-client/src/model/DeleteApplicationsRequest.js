...
/**
 * The DeleteApplicationsRequest model module.
 * @module model/DeleteApplicationsRequest
 * @version 2015-11-01
 */
class DeleteApplicationsRequest {
    /**
     * Constructs a new <code>DeleteApplicationsRequest</code>.
     * @alias module:model/DeleteApplicationsRequest
     * @param configurationIds {Array} 
     */
    constructor(configurationIds) { 
        
        DeleteApplicationsRequest.initialize(this, configurationIds);
    }
    ...
    /**
     * Constructs a <code>DeleteApplicationsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteApplicationsRequest} obj Optional instance to populate.
     * @return {module:model/DeleteApplicationsRequest} The populated <code>DeleteApplicationsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteApplicationsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteApplicationsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteApplicationsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteApplicationsRequest.RequiredProperties) {
...
DeleteApplicationsRequest.RequiredProperties = ["configurationIds"];

/**
 * @member {Array} configurationIds
 */
DeleteApplicationsRequest.prototype['configurationIds'] = undefined;
...
export default DeleteApplicationsRequest;
