...
/**
 * The ExportPreferences model module.
 * @module model/ExportPreferences
 * @version 2015-11-01
 */
class ExportPreferences {
    /**
     * Constructs a new <code>ExportPreferences</code>.
     ...
     * @alias module:model/ExportPreferences
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ExportPreferences</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExportPreferences} obj Optional instance to populate.
     * @return {module:model/ExportPreferences} The populated <code>ExportPreferences</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExportPreferences();
    ...
    /**
     * Validates the JSON data with respect to <code>ExportPreferences</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportPreferences</code>.
     */
