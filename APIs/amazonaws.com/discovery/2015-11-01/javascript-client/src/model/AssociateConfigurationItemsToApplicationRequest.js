...
/**
 * The AssociateConfigurationItemsToApplicationRequest model module.
 * @module model/AssociateConfigurationItemsToApplicationRequest
 * @version 2015-11-01
 */
class AssociateConfigurationItemsToApplicationRequest {
    /**
     * Constructs a new <code>AssociateConfigurationItemsToApplicationRequest</code>.
     * @alias module:model/AssociateConfigurationItemsToApplicationRequest
     * @param applicationConfigurationId {String} 
     * @param configurationIds {Array} 
     */
    constructor(applicationConfigurationId, configurationIds) { 
        
        AssociateConfigurationItemsToApplicationRequest.initialize(this, applicationConfigurationId, configurationIds);
    }
     ...
     */
    static initialize(obj, applicationConfigurationId, configurationIds) { 
        obj['applicationConfigurationId'] = applicationConfigurationId;
        obj['configurationIds'] = configurationIds;
    }

    /**
     * Constructs a <code>AssociateConfigurationItemsToApplicationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateConfigurationItemsToApplicationRequest} obj Optional instance to populate.
     * @return {module:model/AssociateConfigurationItemsToApplicationRequest} The populated <code>AssociateConfigurationItemsToApplicationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateConfigurationItemsToApplicationRequest();

            if (data.hasOwnProperty('applicationConfigurationId')) {
                obj['applicationConfigurationId'] = ApiClient.convertToType(data['applicationConfigurationId'], 'String');
            }
            if (data.hasOwnProperty('configurationIds')) {
                obj['configurationIds'] = ApiClient.convertToType(data['configurationIds'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateConfigurationItemsToApplicationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateConfigurationItemsToApplicationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssociateConfigurationItemsToApplicationRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `applicationConfigurationId`
        if (data['applicationConfigurationId']) { // data not null
          String.validateJSON(data['applicationConfigurationId']);
        }
        // validate the optional field `configurationIds`
        if (data['configurationIds']) { // data not null
          Array.validateJSON(data['configurationIds']);
        }
...
AssociateConfigurationItemsToApplicationRequest.RequiredProperties = ["applicationConfigurationId", "configurationIds"];

/**
 * @member {String} applicationConfigurationId
 */
AssociateConfigurationItemsToApplicationRequest.prototype['applicationConfigurationId'] = undefined;

/**
 * @member {Array} configurationIds
 */
AssociateConfigurationItemsToApplicationRequest.prototype['configurationIds'] = undefined;
...
export default AssociateConfigurationItemsToApplicationRequest;
