...
/**
 * The ReservedInstanceOptions model module.
 * @module model/ReservedInstanceOptions
 * @version 2015-11-01
 */
class ReservedInstanceOptions {
    /**
     * Constructs a new <code>ReservedInstanceOptions</code>.
     *  Used to provide Reserved Instance preferences for the recommendation. 
     * @alias module:model/ReservedInstanceOptions
    ...
    /**
     * Constructs a <code>ReservedInstanceOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReservedInstanceOptions} obj Optional instance to populate.
     * @return {module:model/ReservedInstanceOptions} The populated <code>ReservedInstanceOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReservedInstanceOptions();
    ...
    /**
     * Validates the JSON data with respect to <code>ReservedInstanceOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReservedInstanceOptions</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReservedInstanceOptions.RequiredProperties) {
...
ReservedInstanceOptions.RequiredProperties = ["purchasingOption", "offeringClass", "termLength"];
...
export default ReservedInstanceOptions;
