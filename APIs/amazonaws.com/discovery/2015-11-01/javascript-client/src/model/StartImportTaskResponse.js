...
import StartImportTaskResponseTask from './StartImportTaskResponseTask';

/**
 * The StartImportTaskResponse model module.
 * @module model/StartImportTaskResponse
 * @version 2015-11-01
 */
class StartImportTaskResponse {
    /**
     * Constructs a new <code>StartImportTaskResponse</code>.
     * @alias module:model/StartImportTaskResponse
     */
    constructor() { 
        
        StartImportTaskResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartImportTaskResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartImportTaskResponse} obj Optional instance to populate.
     * @return {module:model/StartImportTaskResponse} The populated <code>StartImportTaskResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartImportTaskResponse();

            if (data.hasOwnProperty('task')) {
                obj['task'] = StartImportTaskResponseTask.constructFromObject(data['task']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartImportTaskResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartImportTaskResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `task`
        if (data['task']) { // data not null
          StartImportTaskResponseTask.validateJSON(data['task']);
        }
...
/**
 * @member {module:model/StartImportTaskResponseTask} task
 */
StartImportTaskResponse.prototype['task'] = undefined;
...
export default StartImportTaskResponse;
