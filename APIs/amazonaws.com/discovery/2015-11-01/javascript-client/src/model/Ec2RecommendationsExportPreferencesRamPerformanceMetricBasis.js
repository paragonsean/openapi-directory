...
import UsageMetricBasis from './UsageMetricBasis';

/**
 * The Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis model module.
 * @module model/Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis
 * @version 2015-11-01
 */
class Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis {
    /**
     * Constructs a new <code>Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis</code>.
     * @alias module:model/Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis
     * @implements module:model/UsageMetricBasis
     */
    constructor() { 
        UsageMetricBasis.initialize(this);
        Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis} obj Optional instance to populate.
     * @return {module:model/Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis} The populated <code>Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis();
            UsageMetricBasis.constructFromObject(data, obj);

            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('percentageAdjust')) {
                obj['percentageAdjust'] = ApiClient.convertToType(data['percentageAdjust'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `percentageAdjust`
        if (data['percentageAdjust']) { // data not null
          Number.validateJSON(data['percentageAdjust']);
        }
 ...
 * @member {String} name
 */
Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis.prototype['name'] = undefined;

/**
 * @member {Number} percentageAdjust
 */
Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis.prototype['percentageAdjust'] = undefined;


// Implement UsageMetricBasis interface:
/**
 * @member {String} name
 */
UsageMetricBasis.prototype['name'] = undefined;
/**
 * @member {Number} percentageAdjust
 */
UsageMetricBasis.prototype['percentageAdjust'] = undefined;




export default Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis;
