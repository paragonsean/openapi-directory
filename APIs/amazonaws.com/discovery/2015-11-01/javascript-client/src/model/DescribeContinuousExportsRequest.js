...
/**
 * The DescribeContinuousExportsRequest model module.
 * @module model/DescribeContinuousExportsRequest
 * @version 2015-11-01
 */
class DescribeContinuousExportsRequest {
    /**
     * Constructs a new <code>DescribeContinuousExportsRequest</code>.
     * @alias module:model/DescribeContinuousExportsRequest
     */
    constructor() { 
        
        DescribeContinuousExportsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeContinuousExportsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeContinuousExportsRequest} obj Optional instance to populate.
     * @return {module:model/DescribeContinuousExportsRequest} The populated <code>DescribeContinuousExportsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeContinuousExportsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeContinuousExportsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeContinuousExportsRequest</code>.
     */
 ...
 */
DescribeContinuousExportsRequest.prototype['exportIds'] = undefined;

/**
 * @member {Number} maxResults
 */
DescribeContinuousExportsRequest.prototype['maxResults'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeContinuousExportsRequest.prototype['nextToken'] = undefined;
...
export default DescribeContinuousExportsRequest;
