...
* @readonly
*/
export default class TermLength {
    ...
    /**
    * Returns a <code>TermLength</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TermLength} The enum <code>TermLength</code> value.
    */
