...
/**
 * The AgentConfigurationStatus model module.
 * @module model/AgentConfigurationStatus
 * @version 2015-11-01
 */
class AgentConfigurationStatus {
    /**
     * Constructs a new <code>AgentConfigurationStatus</code>.
     ...
     * @alias module:model/AgentConfigurationStatus
     */
    constructor() { 
        
        AgentConfigurationStatus.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AgentConfigurationStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AgentConfigurationStatus} obj Optional instance to populate.
     * @return {module:model/AgentConfigurationStatus} The populated <code>AgentConfigurationStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AgentConfigurationStatus();

            if (data.hasOwnProperty('agentId')) {
                obj['agentId'] = ApiClient.convertToType(data['agentId'], 'String');
            }
            if (data.hasOwnProperty('operationSucceeded')) {
                obj['operationSucceeded'] = ApiClient.convertToType(data['operationSucceeded'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AgentConfigurationStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AgentConfigurationStatus</code>.
     */
    static validateJSON(data) {
        ...
        if (data['operationSucceeded']) { // data not null
          Boolean.validateJSON(data['operationSucceeded']);
        }
 ...
 */
AgentConfigurationStatus.prototype['agentId'] = undefined;

/**
 * @member {Boolean} operationSucceeded
 */
AgentConfigurationStatus.prototype['operationSucceeded'] = undefined;

/**
 * @member {String} description
 */
AgentConfigurationStatus.prototype['description'] = undefined;
...
export default AgentConfigurationStatus;
