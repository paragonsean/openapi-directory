...
/**
 * The DescribeAgentsResponse model module.
 * @module model/DescribeAgentsResponse
 * @version 2015-11-01
 */
class DescribeAgentsResponse {
    /**
     * Constructs a new <code>DescribeAgentsResponse</code>.
     * @alias module:model/DescribeAgentsResponse
     */
    constructor() { 
        
        DescribeAgentsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAgentsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAgentsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeAgentsResponse} The populated <code>DescribeAgentsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAgentsResponse();

            if (data.hasOwnProperty('agentsInfo')) {
                obj['agentsInfo'] = ApiClient.convertToType(data['agentsInfo'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAgentsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAgentsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `agentsInfo`
        if (data['agentsInfo']) { // data not null
          Array.validateJSON(data['agentsInfo']);
        }
...
/**
 * @member {Array} agentsInfo
 */
DescribeAgentsResponse.prototype['agentsInfo'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeAgentsResponse.prototype['nextToken'] = undefined;
...
export default DescribeAgentsResponse;
