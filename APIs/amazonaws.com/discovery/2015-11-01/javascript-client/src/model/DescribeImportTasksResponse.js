...
/**
 * The DescribeImportTasksResponse model module.
 * @module model/DescribeImportTasksResponse
 * @version 2015-11-01
 */
class DescribeImportTasksResponse {
    /**
     * Constructs a new <code>DescribeImportTasksResponse</code>.
     * @alias module:model/DescribeImportTasksResponse
     */
    constructor() { 
        
        DescribeImportTasksResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeImportTasksResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeImportTasksResponse} obj Optional instance to populate.
     * @return {module:model/DescribeImportTasksResponse} The populated <code>DescribeImportTasksResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeImportTasksResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeImportTasksResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeImportTasksResponse</code>.
     */
 ...
 */
DescribeImportTasksResponse.prototype['nextToken'] = undefined;

/**
 * @member {Array} tasks
 */
DescribeImportTasksResponse.prototype['tasks'] = undefined;
...
export default DescribeImportTasksResponse;
