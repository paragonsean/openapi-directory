...
/**
 * The ListServerNeighborsResponse model module.
 * @module model/ListServerNeighborsResponse
 * @version 2015-11-01
 */
class ListServerNeighborsResponse {
    /**
     * Constructs a new <code>ListServerNeighborsResponse</code>.
     * @alias module:model/ListServerNeighborsResponse
     * @param neighbors {Array} 
     */
    constructor(neighbors) { 
        
        ListServerNeighborsResponse.initialize(this, neighbors);
    }
     ...
     */
    static initialize(obj, neighbors) { 
        obj['neighbors'] = neighbors;
    }

    /**
     * Constructs a <code>ListServerNeighborsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListServerNeighborsResponse} obj Optional instance to populate.
     * @return {module:model/ListServerNeighborsResponse} The populated <code>ListServerNeighborsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListServerNeighborsResponse();

            if (data.hasOwnProperty('neighbors')) {
                obj['neighbors'] = ApiClient.convertToType(data['neighbors'], Array);
            }
            if (data.hasOwnProperty('nextToken')) {
                obj['nextToken'] = ApiClient.convertToType(data['nextToken'], 'String');
            }
            if (data.hasOwnProperty('knownDependencyCount')) {
                obj['knownDependencyCount'] = ApiClient.convertToType(data['knownDependencyCount'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListServerNeighborsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListServerNeighborsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListServerNeighborsResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `neighbors`
        if (data['neighbors']) { // data not null
          Array.validateJSON(data['neighbors']);
        }
        // validate the optional field `nextToken`
        if (data['nextToken']) { // data not null
          String.validateJSON(data['nextToken']);
        }
        // validate the optional field `knownDependencyCount`
        if (data['knownDependencyCount']) { // data not null
          Number.validateJSON(data['knownDependencyCount']);
        }
...
ListServerNeighborsResponse.RequiredProperties = ["neighbors"];

/**
 * @member {Array} neighbors
 */
ListServerNeighborsResponse.prototype['neighbors'] = undefined;

/**
 * @member {String} nextToken
 */
ListServerNeighborsResponse.prototype['nextToken'] = undefined;

/**
 * @member {Number} knownDependencyCount
 */
ListServerNeighborsResponse.prototype['knownDependencyCount'] = undefined;
...
export default ListServerNeighborsResponse;
