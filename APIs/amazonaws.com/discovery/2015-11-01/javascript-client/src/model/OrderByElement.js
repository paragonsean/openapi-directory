...
/**
 * The OrderByElement model module.
 * @module model/OrderByElement
 * @version 2015-11-01
 */
class OrderByElement {
    /**
     * Constructs a new <code>OrderByElement</code>.
     * A field and direction for ordered output.
     * @alias module:model/OrderByElement
     * @param fieldName {String} 
     */
    constructor(fieldName) { 
        
        OrderByElement.initialize(this, fieldName);
    }
     ...
     */
    static initialize(obj, fieldName) { 
        obj['fieldName'] = fieldName;
    }

    /**
     * Constructs a <code>OrderByElement</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderByElement} obj Optional instance to populate.
     * @return {module:model/OrderByElement} The populated <code>OrderByElement</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderByElement();

            if (data.hasOwnProperty('fieldName')) {
                obj['fieldName'] = ApiClient.convertToType(data['fieldName'], 'String');
            }
            if (data.hasOwnProperty('sortOrder')) {
                obj['sortOrder'] = ApiClient.convertToType(data['sortOrder'], OrderString);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrderByElement</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderByElement</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderByElement.RequiredProperties) {
        ...
        if (data['sortOrder']) { // data not null
          OrderString.validateJSON(data['sortOrder']);
        }
...
OrderByElement.RequiredProperties = ["fieldName"];

/**
 * @member {String} fieldName
 */
OrderByElement.prototype['fieldName'] = undefined;

/**
 * @member {module:model/OrderString} sortOrder
 */
OrderByElement.prototype['sortOrder'] = undefined;
