...
class ExportInfo {
     ...
     * @param exportStatus {module:model/ExportStatus} 
     * @param statusMessage {String} 
     * @param exportRequestTime {Date} 
     */
    constructor(exportId, exportStatus, statusMessage, exportRequestTime) { 
        
        ExportInfo.initialize(this, exportId, exportStatus, statusMessage, exportRequestTime);
    }
     ...
     */
    static initialize(obj, exportId, exportStatus, statusMessage, exportRequestTime) { 
        obj['exportId'] = exportId;
        obj['exportStatus'] = exportStatus;
        obj['statusMessage'] = statusMessage;
        obj['exportRequestTime'] = exportRequestTime;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('configurationsDownloadUrl')) {
                obj['configurationsDownloadUrl'] = ApiClient.convertToType(data['configurationsDownloadUrl'], 'String');
            }
            if (data.hasOwnProperty('exportRequestTime')) {
                obj['exportRequestTime'] = ApiClient.convertToType(data['exportRequestTime'], 'Date');
            }
            if (data.hasOwnProperty('isTruncated')) {
                obj['isTruncated'] = ApiClient.convertToType(data['isTruncated'], 'Boolean');
            }
            if (data.hasOwnProperty('requestedStartTime')) {
                obj['requestedStartTime'] = ApiClient.convertToType(data['requestedStartTime'], 'Date');
            }
            if (data.hasOwnProperty('requestedEndTime')) {
                obj['requestedEndTime'] = ApiClient.convertToType(data['requestedEndTime'], 'Date');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ExportInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportInfo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExportInfo.RequiredProperties) {
        ...
        if (data['configurationsDownloadUrl']) { // data not null
          String.validateJSON(data['configurationsDownloadUrl']);
        }
        // validate the optional field `exportRequestTime`
        if (data['exportRequestTime']) { // data not null
          Date.validateJSON(data['exportRequestTime']);
        }
        ...
        if (data['requestedStartTime']) { // data not null
          Date.validateJSON(data['requestedStartTime']);
        }
        // validate the optional field `requestedEndTime`
        if (data['requestedEndTime']) { // data not null
          Date.validateJSON(data['requestedEndTime']);
        }
...
ExportInfo.RequiredProperties = ["exportId", "exportStatus", "statusMessage", "exportRequestTime"];

/**
 * @member {String} exportId
 */
ExportInfo.prototype['exportId'] = undefined;

/**
 * @member {module:model/ExportStatus} exportStatus
 */
ExportInfo.prototype['exportStatus'] = undefined;

/**
 * @member {String} statusMessage
 */
ExportInfo.prototype['statusMessage'] = undefined;

/**
 * @member {String} configurationsDownloadUrl
 */
ExportInfo.prototype['configurationsDownloadUrl'] = undefined;

/**
 * @member {Date} exportRequestTime
 */
ExportInfo.prototype['exportRequestTime'] = undefined;

/**
 * @member {Boolean} isTruncated
 */
ExportInfo.prototype['isTruncated'] = undefined;

/**
 * @member {Date} requestedStartTime
 */
ExportInfo.prototype['requestedStartTime'] = undefined;

/**
 * @member {Date} requestedEndTime
 */
ExportInfo.prototype['requestedEndTime'] = undefined;
