...
* @readonly
*/
export default class PurchasingOption {
    ...
    /**
    * Returns a <code>PurchasingOption</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PurchasingOption} The enum <code>PurchasingOption</code> value.
    */
