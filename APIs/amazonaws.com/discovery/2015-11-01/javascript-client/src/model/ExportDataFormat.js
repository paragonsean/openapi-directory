...
* @readonly
*/
export default class ExportDataFormat {
    ...
    /**
    * Returns a <code>ExportDataFormat</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ExportDataFormat} The enum <code>ExportDataFormat</code> value.
    */
