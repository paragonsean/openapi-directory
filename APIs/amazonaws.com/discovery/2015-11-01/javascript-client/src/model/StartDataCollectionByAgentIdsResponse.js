...
/**
 * The StartDataCollectionByAgentIdsResponse model module.
 * @module model/StartDataCollectionByAgentIdsResponse
 * @version 2015-11-01
 */
class StartDataCollectionByAgentIdsResponse {
    /**
     * Constructs a new <code>StartDataCollectionByAgentIdsResponse</code>.
     * @alias module:model/StartDataCollectionByAgentIdsResponse
     */
    constructor() { 
        
        StartDataCollectionByAgentIdsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartDataCollectionByAgentIdsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartDataCollectionByAgentIdsResponse} obj Optional instance to populate.
     * @return {module:model/StartDataCollectionByAgentIdsResponse} The populated <code>StartDataCollectionByAgentIdsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartDataCollectionByAgentIdsResponse();

            if (data.hasOwnProperty('agentsConfigurationStatus')) {
                obj['agentsConfigurationStatus'] = ApiClient.convertToType(data['agentsConfigurationStatus'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartDataCollectionByAgentIdsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartDataCollectionByAgentIdsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `agentsConfigurationStatus`
        if (data['agentsConfigurationStatus']) { // data not null
          Array.validateJSON(data['agentsConfigurationStatus']);
        }
...
/**
 * @member {Array} agentsConfigurationStatus
 */
StartDataCollectionByAgentIdsResponse.prototype['agentsConfigurationStatus'] = undefined;
...
export default StartDataCollectionByAgentIdsResponse;
