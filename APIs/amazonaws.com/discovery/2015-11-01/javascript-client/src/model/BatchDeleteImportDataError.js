...
import BatchDeleteImportDataErrorCode from './BatchDeleteImportDataErrorCode';

/**
 * The BatchDeleteImportDataError model module.
 * @module model/BatchDeleteImportDataError
 * @version 2015-11-01
 */
class BatchDeleteImportDataError {
    /**
     * Constructs a new <code>BatchDeleteImportDataError</code>.
     * Error messages returned for each import task that you deleted as a response for this command.
     * @alias module:model/BatchDeleteImportDataError
     */
    constructor() { 
        
        BatchDeleteImportDataError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchDeleteImportDataError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchDeleteImportDataError} obj Optional instance to populate.
     * @return {module:model/BatchDeleteImportDataError} The populated <code>BatchDeleteImportDataError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchDeleteImportDataError();

            if (data.hasOwnProperty('importTaskId')) {
                obj['importTaskId'] = ApiClient.convertToType(data['importTaskId'], 'String');
            }
            if (data.hasOwnProperty('errorCode')) {
                obj['errorCode'] = ApiClient.convertToType(data['errorCode'], BatchDeleteImportDataErrorCode);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchDeleteImportDataError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchDeleteImportDataError</code>.
     */
    static validateJSON(data) {
        ...
        if (data['errorCode']) { // data not null
          BatchDeleteImportDataErrorCode.validateJSON(data['errorCode']);
        }
 ...
 */
BatchDeleteImportDataError.prototype['importTaskId'] = undefined;

/**
 * @member {module:model/BatchDeleteImportDataErrorCode} errorCode
 */
BatchDeleteImportDataError.prototype['errorCode'] = undefined;

/**
 * @member {String} errorDescription
 */
BatchDeleteImportDataError.prototype['errorDescription'] = undefined;
...
export default BatchDeleteImportDataError;
