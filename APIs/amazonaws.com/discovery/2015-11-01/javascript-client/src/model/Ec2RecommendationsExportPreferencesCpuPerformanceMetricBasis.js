...
/**
 * The Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis model module.
 * @module model/Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis
 * @version 2015-11-01
 */
class Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis {
    /**
     * Constructs a new <code>Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis</code>.
     * @alias module:model/Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis
     * @implements module:model/UsageMetricBasis
     */
    constructor() { 
        UsageMetricBasis.initialize(this);
        Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis} obj Optional instance to populate.
     * @return {module:model/Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis} The populated <code>Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis();
    ...
    /**
     * Validates the JSON data with respect to <code>Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis</code>.
     */
 ...
 * @member {String} name
 */
Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis.prototype['name'] = undefined;

/**
 * @member {Number} percentageAdjust
 */
Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis.prototype['percentageAdjust'] = undefined;
...
export default Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis;
