...
/**
 * The StopContinuousExportResponse model module.
 * @module model/StopContinuousExportResponse
 * @version 2015-11-01
 */
class StopContinuousExportResponse {
    /**
     * Constructs a new <code>StopContinuousExportResponse</code>.
     * @alias module:model/StopContinuousExportResponse
     */
    constructor() { 
        
        StopContinuousExportResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StopContinuousExportResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopContinuousExportResponse} obj Optional instance to populate.
     * @return {module:model/StopContinuousExportResponse} The populated <code>StopContinuousExportResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopContinuousExportResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StopContinuousExportResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopContinuousExportResponse</code>.
     */
 ...
 */
StopContinuousExportResponse.prototype['startTime'] = undefined;

/**
 * @member {Date} stopTime
 */
StopContinuousExportResponse.prototype['stopTime'] = undefined;
...
export default StopContinuousExportResponse;
