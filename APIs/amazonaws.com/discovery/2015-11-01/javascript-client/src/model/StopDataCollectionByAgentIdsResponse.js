...
/**
 * The StopDataCollectionByAgentIdsResponse model module.
 * @module model/StopDataCollectionByAgentIdsResponse
 * @version 2015-11-01
 */
class StopDataCollectionByAgentIdsResponse {
    /**
     * Constructs a new <code>StopDataCollectionByAgentIdsResponse</code>.
     * @alias module:model/StopDataCollectionByAgentIdsResponse
     */
    constructor() { 
        
        StopDataCollectionByAgentIdsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StopDataCollectionByAgentIdsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopDataCollectionByAgentIdsResponse} obj Optional instance to populate.
     * @return {module:model/StopDataCollectionByAgentIdsResponse} The populated <code>StopDataCollectionByAgentIdsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopDataCollectionByAgentIdsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StopDataCollectionByAgentIdsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopDataCollectionByAgentIdsResponse</code>.
     */
 ...
 */
StopDataCollectionByAgentIdsResponse.prototype['agentsConfigurationStatus'] = undefined;
...
export default StopDataCollectionByAgentIdsResponse;
