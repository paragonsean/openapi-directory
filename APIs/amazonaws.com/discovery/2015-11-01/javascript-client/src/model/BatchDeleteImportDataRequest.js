...
/**
 * The BatchDeleteImportDataRequest model module.
 * @module model/BatchDeleteImportDataRequest
 * @version 2015-11-01
 */
class BatchDeleteImportDataRequest {
    /**
     * Constructs a new <code>BatchDeleteImportDataRequest</code>.
     * @alias module:model/BatchDeleteImportDataRequest
     * @param importTaskIds {Array} 
     */
    constructor(importTaskIds) { 
        
        BatchDeleteImportDataRequest.initialize(this, importTaskIds);
    }
     ...
     */
    static initialize(obj, importTaskIds) { 
        obj['importTaskIds'] = importTaskIds;
    }

    /**
     * Constructs a <code>BatchDeleteImportDataRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchDeleteImportDataRequest} obj Optional instance to populate.
     * @return {module:model/BatchDeleteImportDataRequest} The populated <code>BatchDeleteImportDataRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchDeleteImportDataRequest();

            if (data.hasOwnProperty('importTaskIds')) {
                obj['importTaskIds'] = ApiClient.convertToType(data['importTaskIds'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchDeleteImportDataRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchDeleteImportDataRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchDeleteImportDataRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `importTaskIds`
        if (data['importTaskIds']) { // data not null
          Array.validateJSON(data['importTaskIds']);
        }
...
BatchDeleteImportDataRequest.RequiredProperties = ["importTaskIds"];

/**
 * @member {Array} importTaskIds
 */
BatchDeleteImportDataRequest.prototype['importTaskIds'] = undefined;
...
export default BatchDeleteImportDataRequest;
