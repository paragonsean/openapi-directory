...
* @readonly
*/
export default class ConfigurationItemType {
    ...
    /**
    * Returns a <code>ConfigurationItemType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ConfigurationItemType} The enum <code>ConfigurationItemType</code> value.
    */
