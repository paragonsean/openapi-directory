...
/**
 * The AgentNetworkInfo model module.
 * @module model/AgentNetworkInfo
 * @version 2015-11-01
 */
class AgentNetworkInfo {
    /**
     * Constructs a new <code>AgentNetworkInfo</code>.
     * Network details about the host where the agent/collector resides.
     * @alias module:model/AgentNetworkInfo
     */
    constructor() { 
        
        AgentNetworkInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AgentNetworkInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AgentNetworkInfo} obj Optional instance to populate.
     * @return {module:model/AgentNetworkInfo} The populated <code>AgentNetworkInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AgentNetworkInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>AgentNetworkInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AgentNetworkInfo</code>.
     */
 ...
 */
AgentNetworkInfo.prototype['ipAddress'] = undefined;

/**
 * @member {String} macAddress
 */
AgentNetworkInfo.prototype['macAddress'] = undefined;
...
export default AgentNetworkInfo;
