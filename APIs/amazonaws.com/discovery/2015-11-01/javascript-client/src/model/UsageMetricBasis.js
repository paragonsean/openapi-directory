...
/**
 * The UsageMetricBasis model module.
 * @module model/UsageMetricBasis
 * @version 2015-11-01
 */
class UsageMetricBasis {
    /**
     * Constructs a new <code>UsageMetricBasis</code>.
     *  Specifies the performance metrics to use for the server that is used for recommendations. 
     * @alias module:model/UsageMetricBasis
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>UsageMetricBasis</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UsageMetricBasis} obj Optional instance to populate.
     * @return {module:model/UsageMetricBasis} The populated <code>UsageMetricBasis</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsageMetricBasis();
    ...
    /**
     * Validates the JSON data with respect to <code>UsageMetricBasis</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsageMetricBasis</code>.
     */
...
export default UsageMetricBasis;
