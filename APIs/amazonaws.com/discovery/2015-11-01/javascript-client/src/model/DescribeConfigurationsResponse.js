...
/**
 * The DescribeConfigurationsResponse model module.
 * @module model/DescribeConfigurationsResponse
 * @version 2015-11-01
 */
class DescribeConfigurationsResponse {
    /**
     * Constructs a new <code>DescribeConfigurationsResponse</code>.
     * @alias module:model/DescribeConfigurationsResponse
     */
    constructor() { 
        
        DescribeConfigurationsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeConfigurationsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeConfigurationsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeConfigurationsResponse} The populated <code>DescribeConfigurationsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeConfigurationsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeConfigurationsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeConfigurationsResponse</code>.
     */
 ...
 */
DescribeConfigurationsResponse.prototype['configurations'] = undefined;
...
export default DescribeConfigurationsResponse;
