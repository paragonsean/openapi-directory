...
/**
 * The DescribeExportConfigurationsResponse model module.
 * @module model/DescribeExportConfigurationsResponse
 * @version 2015-11-01
 */
class DescribeExportConfigurationsResponse {
    /**
     * Constructs a new <code>DescribeExportConfigurationsResponse</code>.
     * @alias module:model/DescribeExportConfigurationsResponse
     */
    constructor() { 
        
        DescribeExportConfigurationsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeExportConfigurationsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeExportConfigurationsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeExportConfigurationsResponse} The populated <code>DescribeExportConfigurationsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeExportConfigurationsResponse();

            if (data.hasOwnProperty('exportsInfo')) {
                obj['exportsInfo'] = ApiClient.convertToType(data['exportsInfo'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeExportConfigurationsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeExportConfigurationsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `exportsInfo`
        if (data['exportsInfo']) { // data not null
          Array.validateJSON(data['exportsInfo']);
        }
...
/**
 * @member {Array} exportsInfo
 */
DescribeExportConfigurationsResponse.prototype['exportsInfo'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeExportConfigurationsResponse.prototype['nextToken'] = undefined;
...
export default DescribeExportConfigurationsResponse;
