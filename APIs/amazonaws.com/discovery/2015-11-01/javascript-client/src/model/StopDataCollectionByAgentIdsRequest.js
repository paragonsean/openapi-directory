...
/**
 * The StopDataCollectionByAgentIdsRequest model module.
 * @module model/StopDataCollectionByAgentIdsRequest
 * @version 2015-11-01
 */
class StopDataCollectionByAgentIdsRequest {
    /**
     * Constructs a new <code>StopDataCollectionByAgentIdsRequest</code>.
     * @alias module:model/StopDataCollectionByAgentIdsRequest
     * @param agentIds {Array} 
     */
    constructor(agentIds) { 
        
        StopDataCollectionByAgentIdsRequest.initialize(this, agentIds);
    }
     ...
     */
    static initialize(obj, agentIds) { 
        obj['agentIds'] = agentIds;
    }

    /**
     * Constructs a <code>StopDataCollectionByAgentIdsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopDataCollectionByAgentIdsRequest} obj Optional instance to populate.
     * @return {module:model/StopDataCollectionByAgentIdsRequest} The populated <code>StopDataCollectionByAgentIdsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopDataCollectionByAgentIdsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StopDataCollectionByAgentIdsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopDataCollectionByAgentIdsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StopDataCollectionByAgentIdsRequest.RequiredProperties) {
...
StopDataCollectionByAgentIdsRequest.RequiredProperties = ["agentIds"];

/**
 * @member {Array} agentIds
 */
StopDataCollectionByAgentIdsRequest.prototype['agentIds'] = undefined;
...
export default StopDataCollectionByAgentIdsRequest;
