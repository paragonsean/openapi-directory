...
import ImportTaskFilterName from './ImportTaskFilterName';

/**
 * The ImportTaskFilter model module.
 * @module model/ImportTaskFilter
 * @version 2015-11-01
 */
class ImportTaskFilter {
    /**
     * Constructs a new <code>ImportTaskFilter</code>.
     ...
     * @alias module:model/ImportTaskFilter
     */
    constructor() { 
        
        ImportTaskFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImportTaskFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportTaskFilter} obj Optional instance to populate.
     * @return {module:model/ImportTaskFilter} The populated <code>ImportTaskFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportTaskFilter();

            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], ImportTaskFilterName);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ImportTaskFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportTaskFilter</code>.
     */
    static validateJSON(data) {
        // validate the optional field `name`
        if (data['name']) { // data not null
          ImportTaskFilterName.validateJSON(data['name']);
        }
...
/**
 * @member {module:model/ImportTaskFilterName} name
 */
ImportTaskFilter.prototype['name'] = undefined;

/**
 * @member {Array} values
 */
ImportTaskFilter.prototype['values'] = undefined;
...
export default ImportTaskFilter;
