...
import ContinuousExportStatus from './ContinuousExportStatus';
import DataSource from './DataSource';

/**
 * The ContinuousExportDescription model module.
 * @module model/ContinuousExportDescription
 * @version 2015-11-01
 */
class ContinuousExportDescription {
    /**
     * Constructs a new <code>ContinuousExportDescription</code>.
     * A list of continuous export descriptions.
     * @alias module:model/ContinuousExportDescription
     */
    constructor() { 
        
        ContinuousExportDescription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContinuousExportDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContinuousExportDescription} obj Optional instance to populate.
     * @return {module:model/ContinuousExportDescription} The populated <code>ContinuousExportDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContinuousExportDescription();

            if (data.hasOwnProperty('exportId')) {
                obj['exportId'] = ApiClient.convertToType(data['exportId'], 'String');
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], ContinuousExportStatus);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ContinuousExportDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContinuousExportDescription</code>.
     */
    static validateJSON(data) {
        ...
        if (data['status']) { // data not null
          ContinuousExportStatus.validateJSON(data['status']);
        }
 ...
 */
ContinuousExportDescription.prototype['exportId'] = undefined;

/**
 * @member {module:model/ContinuousExportStatus} status
 */
ContinuousExportDescription.prototype['status'] = undefined;

/**
 * @member {String} statusDetail
 */
ContinuousExportDescription.prototype['statusDetail'] = undefined;

/**
 * @member {String} s3Bucket
 */
ContinuousExportDescription.prototype['s3Bucket'] = undefined;

/**
 * @member {Date} startTime
 */
ContinuousExportDescription.prototype['startTime'] = undefined;

/**
 * @member {Date} stopTime
 */
ContinuousExportDescription.prototype['stopTime'] = undefined;

/**
 * @member {module:model/DataSource} dataSource
 */
ContinuousExportDescription.prototype['dataSource'] = undefined;

/**
 * @member {Object} schemaStorageConfig
 */
ContinuousExportDescription.prototype['schemaStorageConfig'] = undefined;
...
export default ContinuousExportDescription;
