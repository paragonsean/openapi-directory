...
/**
 * The DescribeContinuousExportsResponse model module.
 * @module model/DescribeContinuousExportsResponse
 * @version 2015-11-01
 */
class DescribeContinuousExportsResponse {
    /**
     * Constructs a new <code>DescribeContinuousExportsResponse</code>.
     * @alias module:model/DescribeContinuousExportsResponse
     */
    constructor() { 
        
        DescribeContinuousExportsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeContinuousExportsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeContinuousExportsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeContinuousExportsResponse} The populated <code>DescribeContinuousExportsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeContinuousExportsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeContinuousExportsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeContinuousExportsResponse</code>.
     */
 ...
 */
DescribeContinuousExportsResponse.prototype['descriptions'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeContinuousExportsResponse.prototype['nextToken'] = undefined;
...
export default DescribeContinuousExportsResponse;
