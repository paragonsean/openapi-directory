...
* @readonly
*/
export default class BatchDeleteImportDataErrorCode {
    ...
    /**
    * Returns a <code>BatchDeleteImportDataErrorCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/BatchDeleteImportDataErrorCode} The enum <code>BatchDeleteImportDataErrorCode</code> value.
    */
