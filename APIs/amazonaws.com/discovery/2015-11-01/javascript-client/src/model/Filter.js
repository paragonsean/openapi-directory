...
class Filter {
     ...
     */
    constructor(name, values, condition) { 
        
        Filter.initialize(this, name, values, condition);
    }
     ...
     */
    static initialize(obj, name, values, condition) { 
        obj['name'] = name;
        obj['values'] = values;
...
Filter.RequiredProperties = ["name", "values", "condition"];
