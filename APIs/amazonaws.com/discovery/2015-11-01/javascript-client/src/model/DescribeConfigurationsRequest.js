...
/**
 * The DescribeConfigurationsRequest model module.
 * @module model/DescribeConfigurationsRequest
 * @version 2015-11-01
 */
class DescribeConfigurationsRequest {
    /**
     * Constructs a new <code>DescribeConfigurationsRequest</code>.
     * @alias module:model/DescribeConfigurationsRequest
     * @param configurationIds {Array} 
     */
    constructor(configurationIds) { 
        
        DescribeConfigurationsRequest.initialize(this, configurationIds);
    }
     ...
     */
    static initialize(obj, configurationIds) { 
        obj['configurationIds'] = configurationIds;
    }

    /**
     * Constructs a <code>DescribeConfigurationsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeConfigurationsRequest} obj Optional instance to populate.
     * @return {module:model/DescribeConfigurationsRequest} The populated <code>DescribeConfigurationsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeConfigurationsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeConfigurationsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeConfigurationsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeConfigurationsRequest.RequiredProperties) {
...
DescribeConfigurationsRequest.RequiredProperties = ["configurationIds"];

/**
 * @member {Array} configurationIds
 */
DescribeConfigurationsRequest.prototype['configurationIds'] = undefined;
...
export default DescribeConfigurationsRequest;
