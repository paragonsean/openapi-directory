...
/**
 * The StopContinuousExportRequest model module.
 * @module model/StopContinuousExportRequest
 * @version 2015-11-01
 */
class StopContinuousExportRequest {
    /**
     * Constructs a new <code>StopContinuousExportRequest</code>.
     * @alias module:model/StopContinuousExportRequest
     * @param exportId {String} 
     */
    constructor(exportId) { 
        
        StopContinuousExportRequest.initialize(this, exportId);
    }
    ...
    /**
     * Constructs a <code>StopContinuousExportRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopContinuousExportRequest} obj Optional instance to populate.
     * @return {module:model/StopContinuousExportRequest} The populated <code>StopContinuousExportRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopContinuousExportRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StopContinuousExportRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopContinuousExportRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StopContinuousExportRequest.RequiredProperties) {
...
StopContinuousExportRequest.RequiredProperties = ["exportId"];

/**
 * @member {String} exportId
 */
StopContinuousExportRequest.prototype['exportId'] = undefined;
...
export default StopContinuousExportRequest;
