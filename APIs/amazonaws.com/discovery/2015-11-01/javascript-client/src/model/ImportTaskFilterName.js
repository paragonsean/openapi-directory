...
* @readonly
*/
export default class ImportTaskFilterName {
    ...
    /**
    * Returns a <code>ImportTaskFilterName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ImportTaskFilterName} The enum <code>ImportTaskFilterName</code> value.
    */
