...
/**
 * The ListServerNeighborsRequest model module.
 * @module model/ListServerNeighborsRequest
 * @version 2015-11-01
 */
class ListServerNeighborsRequest {
    /**
     * Constructs a new <code>ListServerNeighborsRequest</code>.
     * @alias module:model/ListServerNeighborsRequest
     * @param configurationId {String} 
     */
    constructor(configurationId) { 
        
        ListServerNeighborsRequest.initialize(this, configurationId);
    }
     ...
     */
    static initialize(obj, configurationId) { 
        obj['configurationId'] = configurationId;
    }

    /**
     * Constructs a <code>ListServerNeighborsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListServerNeighborsRequest} obj Optional instance to populate.
     * @return {module:model/ListServerNeighborsRequest} The populated <code>ListServerNeighborsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListServerNeighborsRequest();

            if (data.hasOwnProperty('configurationId')) {
                obj['configurationId'] = ApiClient.convertToType(data['configurationId'], 'String');
            }
            if (data.hasOwnProperty('portInformationNeeded')) {
                obj['portInformationNeeded'] = ApiClient.convertToType(data['portInformationNeeded'], 'Boolean');
            }
            if (data.hasOwnProperty('neighborConfigurationIds')) {
                obj['neighborConfigurationIds'] = ApiClient.convertToType(data['neighborConfigurationIds'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListServerNeighborsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListServerNeighborsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListServerNeighborsRequest.RequiredProperties) {
        ...
        // validate the optional field `portInformationNeeded`
        if (data['portInformationNeeded']) { // data not null
          Boolean.validateJSON(data['portInformationNeeded']);
        }
        // validate the optional field `neighborConfigurationIds`
        if (data['neighborConfigurationIds']) { // data not null
          Array.validateJSON(data['neighborConfigurationIds']);
        }
...
ListServerNeighborsRequest.RequiredProperties = ["configurationId"];

/**
 * @member {String} configurationId
 */
ListServerNeighborsRequest.prototype['configurationId'] = undefined;

/**
 * @member {Boolean} portInformationNeeded
 */
ListServerNeighborsRequest.prototype['portInformationNeeded'] = undefined;

/**
 * @member {Array} neighborConfigurationIds
 */
ListServerNeighborsRequest.prototype['neighborConfigurationIds'] = undefined;

/**
 * @member {Number} maxResults
 */
ListServerNeighborsRequest.prototype['maxResults'] = undefined;

/**
 * @member {String} nextToken
 */
ListServerNeighborsRequest.prototype['nextToken'] = undefined;
...
export default ListServerNeighborsRequest;
