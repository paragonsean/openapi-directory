...
/**
 * The StartImportTaskRequest model module.
 * @module model/StartImportTaskRequest
 * @version 2015-11-01
 */
class StartImportTaskRequest {
    /**
     * Constructs a new <code>StartImportTaskRequest</code>.
     * @alias module:model/StartImportTaskRequest
     * @param name {String} 
     * @param importUrl {String} 
     */
    constructor(name, importUrl) { 
        
        StartImportTaskRequest.initialize(this, name, importUrl);
    }
     ...
     */
    static initialize(obj, name, importUrl) { 
        obj['name'] = name;
        obj['importUrl'] = importUrl;
    }

    /**
     * Constructs a <code>StartImportTaskRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartImportTaskRequest} obj Optional instance to populate.
     * @return {module:model/StartImportTaskRequest} The populated <code>StartImportTaskRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartImportTaskRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StartImportTaskRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartImportTaskRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartImportTaskRequest.RequiredProperties) {
...
StartImportTaskRequest.RequiredProperties = ["name", "importUrl"];

/**
 * @member {String} clientRequestToken
 */
StartImportTaskRequest.prototype['clientRequestToken'] = undefined;

/**
 * @member {String} name
 */
StartImportTaskRequest.prototype['name'] = undefined;

/**
 * @member {String} importUrl
 */
StartImportTaskRequest.prototype['importUrl'] = undefined;
...
export default StartImportTaskRequest;
