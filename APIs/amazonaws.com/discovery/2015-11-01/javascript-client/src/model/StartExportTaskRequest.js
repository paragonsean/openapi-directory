...
import StartExportTaskRequestPreferences from './StartExportTaskRequestPreferences';

/**
 * The StartExportTaskRequest model module.
 * @module model/StartExportTaskRequest
 * @version 2015-11-01
 */
class StartExportTaskRequest {
    /**
     * Constructs a new <code>StartExportTaskRequest</code>.
     * @alias module:model/StartExportTaskRequest
     */
    constructor() { 
        
        StartExportTaskRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartExportTaskRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartExportTaskRequest} obj Optional instance to populate.
     * @return {module:model/StartExportTaskRequest} The populated <code>StartExportTaskRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartExportTaskRequest();

            if (data.hasOwnProperty('exportDataFormat')) {
                obj['exportDataFormat'] = ApiClient.convertToType(data['exportDataFormat'], Array);
            }
            ...
            if (data.hasOwnProperty('preferences')) {
                obj['preferences'] = StartExportTaskRequestPreferences.constructFromObject(data['preferences']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartExportTaskRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartExportTaskRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `exportDataFormat`
        if (data['exportDataFormat']) { // data not null
          Array.validateJSON(data['exportDataFormat']);
        }
        ...
        if (data['preferences']) { // data not null
          StartExportTaskRequestPreferences.validateJSON(data['preferences']);
        }
...
/**
 * @member {Array} exportDataFormat
 */
StartExportTaskRequest.prototype['exportDataFormat'] = undefined;

/**
 * @member {Array} filters
 */
StartExportTaskRequest.prototype['filters'] = undefined;

/**
 * @member {Date} startTime
 */
StartExportTaskRequest.prototype['startTime'] = undefined;

/**
 * @member {Date} endTime
 */
StartExportTaskRequest.prototype['endTime'] = undefined;

/**
 * @member {module:model/StartExportTaskRequestPreferences} preferences
 */
StartExportTaskRequest.prototype['preferences'] = undefined;
...
export default StartExportTaskRequest;
