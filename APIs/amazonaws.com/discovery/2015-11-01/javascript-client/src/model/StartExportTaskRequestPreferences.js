...
import ExportPreferencesEc2RecommendationsPreferences from './ExportPreferencesEc2RecommendationsPreferences';

/**
 * The StartExportTaskRequestPreferences model module.
 * @module model/StartExportTaskRequestPreferences
 * @version 2015-11-01
 */
class StartExportTaskRequestPreferences {
    /**
     * Constructs a new <code>StartExportTaskRequestPreferences</code>.
     * @alias module:model/StartExportTaskRequestPreferences
     * @implements module:model/ExportPreferences
     */
    constructor() { 
        ExportPreferences.initialize(this);
        StartExportTaskRequestPreferences.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartExportTaskRequestPreferences</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartExportTaskRequestPreferences} obj Optional instance to populate.
     * @return {module:model/StartExportTaskRequestPreferences} The populated <code>StartExportTaskRequestPreferences</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartExportTaskRequestPreferences();
            ExportPreferences.constructFromObject(data, obj);

            if (data.hasOwnProperty('ec2RecommendationsPreferences')) {
                obj['ec2RecommendationsPreferences'] = ExportPreferencesEc2RecommendationsPreferences.constructFromObject(data['ec2RecommendationsPreferences']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartExportTaskRequestPreferences</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartExportTaskRequestPreferences</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ec2RecommendationsPreferences`
        if (data['ec2RecommendationsPreferences']) { // data not null
          ExportPreferencesEc2RecommendationsPreferences.validateJSON(data['ec2RecommendationsPreferences']);
        }
...
/**
 * @member {module:model/ExportPreferencesEc2RecommendationsPreferences} ec2RecommendationsPreferences
 */
StartExportTaskRequestPreferences.prototype['ec2RecommendationsPreferences'] = undefined;


// Implement ExportPreferences interface:
/**
 * @member {module:model/ExportPreferencesEc2RecommendationsPreferences} ec2RecommendationsPreferences
 */
ExportPreferences.prototype['ec2RecommendationsPreferences'] = undefined;




export default StartExportTaskRequestPreferences;
