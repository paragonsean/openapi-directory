...
/**
 * The StartExportTaskResponse model module.
 * @module model/StartExportTaskResponse
 * @version 2015-11-01
 */
class StartExportTaskResponse {
    /**
     * Constructs a new <code>StartExportTaskResponse</code>.
     * @alias module:model/StartExportTaskResponse
     */
    constructor() { 
        
        StartExportTaskResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartExportTaskResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartExportTaskResponse} obj Optional instance to populate.
     * @return {module:model/StartExportTaskResponse} The populated <code>StartExportTaskResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartExportTaskResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartExportTaskResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartExportTaskResponse</code>.
     */
 ...
 */
StartExportTaskResponse.prototype['exportId'] = undefined;
...
export default StartExportTaskResponse;
