...
/**
 * The BatchDeleteImportDataResponse model module.
 * @module model/BatchDeleteImportDataResponse
 * @version 2015-11-01
 */
class BatchDeleteImportDataResponse {
    /**
     * Constructs a new <code>BatchDeleteImportDataResponse</code>.
     * @alias module:model/BatchDeleteImportDataResponse
     */
    constructor() { 
        
        BatchDeleteImportDataResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchDeleteImportDataResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchDeleteImportDataResponse} obj Optional instance to populate.
     * @return {module:model/BatchDeleteImportDataResponse} The populated <code>BatchDeleteImportDataResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchDeleteImportDataResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchDeleteImportDataResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchDeleteImportDataResponse</code>.
     */
 ...
 * @member {Array} errors
 */
BatchDeleteImportDataResponse.prototype['errors'] = undefined;
...
export default BatchDeleteImportDataResponse;
