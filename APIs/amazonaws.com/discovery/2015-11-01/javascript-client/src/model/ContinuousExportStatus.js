...
* @readonly
*/
export default class ContinuousExportStatus {
    ...
    /**
    * Returns a <code>ContinuousExportStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ContinuousExportStatus} The enum <code>ContinuousExportStatus</code> value.
    */
