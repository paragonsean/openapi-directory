...
* @readonly
*/
export default class OrderString {
    ...
    /**
    * Returns a <code>OrderString</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OrderString} The enum <code>OrderString</code> value.
    */
