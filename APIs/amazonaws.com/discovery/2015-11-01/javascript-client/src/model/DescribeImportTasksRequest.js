...
/**
 * The DescribeImportTasksRequest model module.
 * @module model/DescribeImportTasksRequest
 * @version 2015-11-01
 */
class DescribeImportTasksRequest {
    /**
     * Constructs a new <code>DescribeImportTasksRequest</code>.
     * @alias module:model/DescribeImportTasksRequest
     */
    constructor() { 
        
        DescribeImportTasksRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeImportTasksRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeImportTasksRequest} obj Optional instance to populate.
     * @return {module:model/DescribeImportTasksRequest} The populated <code>DescribeImportTasksRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeImportTasksRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeImportTasksRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeImportTasksRequest</code>.
     */
 ...
 */
DescribeImportTasksRequest.prototype['filters'] = undefined;

/**
 * @member {Number} maxResults
 */
DescribeImportTasksRequest.prototype['maxResults'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeImportTasksRequest.prototype['nextToken'] = undefined;
...
export default DescribeImportTasksRequest;
