...
/**
 * The DescribeAgentsRequest model module.
 * @module model/DescribeAgentsRequest
 * @version 2015-11-01
 */
class DescribeAgentsRequest {
    /**
     * Constructs a new <code>DescribeAgentsRequest</code>.
     * @alias module:model/DescribeAgentsRequest
     */
    constructor() { 
        
        DescribeAgentsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAgentsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAgentsRequest} obj Optional instance to populate.
     * @return {module:model/DescribeAgentsRequest} The populated <code>DescribeAgentsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAgentsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAgentsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAgentsRequest</code>.
     */
 ...
 */
DescribeAgentsRequest.prototype['agentIds'] = undefined;

/**
 * @member {Array} filters
 */
DescribeAgentsRequest.prototype['filters'] = undefined;

/**
 * @member {Number} maxResults
 */
DescribeAgentsRequest.prototype['maxResults'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeAgentsRequest.prototype['nextToken'] = undefined;
...
export default DescribeAgentsRequest;
