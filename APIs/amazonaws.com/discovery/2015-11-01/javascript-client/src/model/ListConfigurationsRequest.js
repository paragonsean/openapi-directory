...
/**
 * The ListConfigurationsRequest model module.
 * @module model/ListConfigurationsRequest
 * @version 2015-11-01
 */
class ListConfigurationsRequest {
    /**
     * Constructs a new <code>ListConfigurationsRequest</code>.
     * @alias module:model/ListConfigurationsRequest
     * @param configurationType {module:model/ConfigurationItemType} 
     */
    constructor(configurationType) { 
        
        ListConfigurationsRequest.initialize(this, configurationType);
    }
    ...
    /**
     * Constructs a <code>ListConfigurationsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListConfigurationsRequest} obj Optional instance to populate.
     * @return {module:model/ListConfigurationsRequest} The populated <code>ListConfigurationsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListConfigurationsRequest();
            ...
            if (data.hasOwnProperty('orderBy')) {
                obj['orderBy'] = ApiClient.convertToType(data['orderBy'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListConfigurationsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConfigurationsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListConfigurationsRequest.RequiredProperties) {
        ...
        if (data['orderBy']) { // data not null
          Array.validateJSON(data['orderBy']);
        }
...
ListConfigurationsRequest.RequiredProperties = ["configurationType"];

/**
 * @member {module:model/ConfigurationItemType} configurationType
 */
ListConfigurationsRequest.prototype['configurationType'] = undefined;

/**
 * @member {Array} filters
 */
ListConfigurationsRequest.prototype['filters'] = undefined;

/**
 * @member {Number} maxResults
 */
ListConfigurationsRequest.prototype['maxResults'] = undefined;

/**
 * @member {String} nextToken
 */
ListConfigurationsRequest.prototype['nextToken'] = undefined;

/**
 * @member {Array} orderBy
 */
ListConfigurationsRequest.prototype['orderBy'] = undefined;
...
export default ListConfigurationsRequest;
