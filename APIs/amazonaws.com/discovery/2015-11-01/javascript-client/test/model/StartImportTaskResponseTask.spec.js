...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StartImportTaskResponseTask();
  });
  ...
  describe('StartImportTaskResponseTask', function() {
    it('should create an instance of StartImportTaskResponseTask', function() {
      // uncomment below and update the code to test StartImportTaskResponseTask
      //var instance = new AwsApplicationDiscoveryService.StartImportTaskResponseTask();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StartImportTaskResponseTask);
    });
