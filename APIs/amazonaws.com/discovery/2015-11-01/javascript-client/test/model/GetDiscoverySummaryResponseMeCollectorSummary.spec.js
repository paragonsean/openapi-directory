...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseMeCollectorSummary();
  });
  ...
  describe('GetDiscoverySummaryResponseMeCollectorSummary', function() {
    it('should create an instance of GetDiscoverySummaryResponseMeCollectorSummary', function() {
      // uncomment below and update the code to test GetDiscoverySummaryResponseMeCollectorSummary
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseMeCollectorSummary();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.GetDiscoverySummaryResponseMeCollectorSummary);
    });
