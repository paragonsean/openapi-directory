...
(function(root, factory) {
  ...
  describe('ContinuousExportStatus', function() {
    it('should create an instance of ContinuousExportStatus', function() {
      // uncomment below and update the code to test ContinuousExportStatus
      //var instance = new AwsApplicationDiscoveryService.ContinuousExportStatus();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ContinuousExportStatus);
    });
