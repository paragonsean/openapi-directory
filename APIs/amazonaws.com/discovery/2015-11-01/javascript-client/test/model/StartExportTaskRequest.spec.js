...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StartExportTaskRequest();
  });
  ...
  describe('StartExportTaskRequest', function() {
    it('should create an instance of StartExportTaskRequest', function() {
      // uncomment below and update the code to test StartExportTaskRequest
      //var instance = new AwsApplicationDiscoveryService.StartExportTaskRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StartExportTaskRequest);
    });

    it('should have the property exportDataFormat (base name: "exportDataFormat")', function() {
      // uncomment below and update the code to test the property exportDataFormat
      //var instance = new AwsApplicationDiscoveryService.StartExportTaskRequest();
