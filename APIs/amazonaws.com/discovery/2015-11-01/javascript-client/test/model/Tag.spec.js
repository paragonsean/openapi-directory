...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.Tag();
  });
  ...
  describe('Tag', function() {
    it('should create an instance of Tag', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.Tag();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.Tag);
    });
