...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.AgentNetworkInfo();
  });
  ...
  describe('AgentNetworkInfo', function() {
    it('should create an instance of AgentNetworkInfo', function() {
      // uncomment below and update the code to test AgentNetworkInfo
      //var instance = new AwsApplicationDiscoveryService.AgentNetworkInfo();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.AgentNetworkInfo);
    });
