...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.AwsApplicationDiscoveryService);
  }
}(this, function(expect, AwsApplicationDiscoveryService) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.CustomerConnectorInfo();
  });
  ...
  describe('CustomerConnectorInfo', function() {
    it('should create an instance of CustomerConnectorInfo', function() {
      // uncomment below and update the code to test CustomerConnectorInfo
      //var instance = new AwsApplicationDiscoveryService.CustomerConnectorInfo();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.CustomerConnectorInfo);
    });

    it('should have the property activeConnectors (base name: "activeConnectors")', function() {
      // uncomment below and update the code to test the property activeConnectors
      //var instance = new AwsApplicationDiscoveryService.CustomerConnectorInfo();
      //expect(instance).to.be();
    });

    it('should have the property healthyConnectors (base name: "healthyConnectors")', function() {
      // uncomment below and update the code to test the property healthyConnectors
      //var instance = new AwsApplicationDiscoveryService.CustomerConnectorInfo();
      //expect(instance).to.be();
    });

    it('should have the property blackListedConnectors (base name: "blackListedConnectors")', function() {
      // uncomment below and update the code to test the property blackListedConnectors
      //var instance = new AwsApplicationDiscoveryService.CustomerConnectorInfo();
      //expect(instance).to.be();
    });

    it('should have the property shutdownConnectors (base name: "shutdownConnectors")', function() {
      // uncomment below and update the code to test the property shutdownConnectors
      //var instance = new AwsApplicationDiscoveryService.CustomerConnectorInfo();
      //expect(instance).to.be();
    });

    it('should have the property unhealthyConnectors (base name: "unhealthyConnectors")', function() {
      // uncomment below and update the code to test the property unhealthyConnectors
      //var instance = new AwsApplicationDiscoveryService.CustomerConnectorInfo();
      //expect(instance).to.be();
    });

    it('should have the property totalConnectors (base name: "totalConnectors")', function() {
      // uncomment below and update the code to test the property totalConnectors
      //var instance = new AwsApplicationDiscoveryService.CustomerConnectorInfo();
      //expect(instance).to.be();
    });

    it('should have the property unknownConnectors (base name: "unknownConnectors")', function() {
      // uncomment below and update the code to test the property unknownConnectors
      //var instance = new AwsApplicationDiscoveryService.CustomerConnectorInfo();
      //expect(instance).to.be();
    });
