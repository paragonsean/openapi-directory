...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StopDataCollectionByAgentIdsRequest();
  });
  ...
  describe('StopDataCollectionByAgentIdsRequest', function() {
    it('should create an instance of StopDataCollectionByAgentIdsRequest', function() {
      // uncomment below and update the code to test StopDataCollectionByAgentIdsRequest
      //var instance = new AwsApplicationDiscoveryService.StopDataCollectionByAgentIdsRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StopDataCollectionByAgentIdsRequest);
    });
