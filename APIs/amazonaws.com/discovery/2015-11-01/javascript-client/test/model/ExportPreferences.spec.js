...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ExportPreferences();
  });
  ...
  describe('ExportPreferences', function() {
    it('should create an instance of ExportPreferences', function() {
      // uncomment below and update the code to test ExportPreferences
      //var instance = new AwsApplicationDiscoveryService.ExportPreferences();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ExportPreferences);
    });

    it('should have the property ec2RecommendationsPreferences (base name: "ec2RecommendationsPreferences")', function() {
      // uncomment below and update the code to test the property ec2RecommendationsPreferences
      //var instance = new AwsApplicationDiscoveryService.ExportPreferences();
