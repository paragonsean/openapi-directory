...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeTagsRequest();
  });
  ...
  describe('DescribeTagsRequest', function() {
    it('should create an instance of DescribeTagsRequest', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.DescribeTagsRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeTagsRequest);
    });
