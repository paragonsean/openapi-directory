...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ImportTaskFilter();
  });
  ...
  describe('ImportTaskFilter', function() {
    it('should create an instance of ImportTaskFilter', function() {
      // uncomment below and update the code to test ImportTaskFilter
      //var instance = new AwsApplicationDiscoveryService.ImportTaskFilter();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ImportTaskFilter);
    });
