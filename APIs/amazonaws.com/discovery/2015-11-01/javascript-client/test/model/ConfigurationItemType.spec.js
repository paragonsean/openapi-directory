...
(function(root, factory) {
  ...
  describe('ConfigurationItemType', function() {
    it('should create an instance of ConfigurationItemType', function() {
      // uncomment below and update the code to test ConfigurationItemType
      //var instance = new AwsApplicationDiscoveryService.ConfigurationItemType();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ConfigurationItemType);
    });
