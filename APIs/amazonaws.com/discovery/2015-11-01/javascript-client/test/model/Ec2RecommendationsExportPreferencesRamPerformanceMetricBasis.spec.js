...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis();
  });
  ...
  describe('Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis', function() {
    it('should create an instance of Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis', function() {
      // uncomment below and update the code to test Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis
      //var instance = new AwsApplicationDiscoveryService.Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis);
    });
