...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.CustomerMeCollectorInfo();
  });
  ...
  describe('CustomerMeCollectorInfo', function() {
    it('should create an instance of CustomerMeCollectorInfo', function() {
      // uncomment below and update the code to test CustomerMeCollectorInfo
      //var instance = new AwsApplicationDiscoveryService.CustomerMeCollectorInfo();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.CustomerMeCollectorInfo);
    });

    it('should have the property activeMeCollectors (base name: "activeMeCollectors")', function() {
      // uncomment below and update the code to test the property activeMeCollectors
      //var instance = new AwsApplicationDiscoveryService.CustomerMeCollectorInfo();
      //expect(instance).to.be();
    });

    it('should have the property healthyMeCollectors (base name: "healthyMeCollectors")', function() {
      // uncomment below and update the code to test the property healthyMeCollectors
      //var instance = new AwsApplicationDiscoveryService.CustomerMeCollectorInfo();
      //expect(instance).to.be();
    });

    it('should have the property denyListedMeCollectors (base name: "denyListedMeCollectors")', function() {
      // uncomment below and update the code to test the property denyListedMeCollectors
      //var instance = new AwsApplicationDiscoveryService.CustomerMeCollectorInfo();
      //expect(instance).to.be();
    });

    it('should have the property shutdownMeCollectors (base name: "shutdownMeCollectors")', function() {
      // uncomment below and update the code to test the property shutdownMeCollectors
      //var instance = new AwsApplicationDiscoveryService.CustomerMeCollectorInfo();
      //expect(instance).to.be();
    });

    it('should have the property unhealthyMeCollectors (base name: "unhealthyMeCollectors")', function() {
      // uncomment below and update the code to test the property unhealthyMeCollectors
      //var instance = new AwsApplicationDiscoveryService.CustomerMeCollectorInfo();
      //expect(instance).to.be();
    });

    it('should have the property totalMeCollectors (base name: "totalMeCollectors")', function() {
      // uncomment below and update the code to test the property totalMeCollectors
      //var instance = new AwsApplicationDiscoveryService.CustomerMeCollectorInfo();
      //expect(instance).to.be();
    });

    it('should have the property unknownMeCollectors (base name: "unknownMeCollectors")', function() {
      // uncomment below and update the code to test the property unknownMeCollectors
      //var instance = new AwsApplicationDiscoveryService.CustomerMeCollectorInfo();
      //expect(instance).to.be();
    });
