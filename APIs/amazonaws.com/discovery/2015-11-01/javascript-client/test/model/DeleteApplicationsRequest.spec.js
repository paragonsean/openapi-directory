...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DeleteApplicationsRequest();
  });
  ...
  describe('DeleteApplicationsRequest', function() {
    it('should create an instance of DeleteApplicationsRequest', function() {
      // uncomment below and update the code to test DeleteApplicationsRequest
      //var instance = new AwsApplicationDiscoveryService.DeleteApplicationsRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DeleteApplicationsRequest);
    });
