...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.AgentConfigurationStatus();
  });
  ...
  describe('AgentConfigurationStatus', function() {
    it('should create an instance of AgentConfigurationStatus', function() {
      // uncomment below and update the code to test AgentConfigurationStatus
      //var instance = new AwsApplicationDiscoveryService.AgentConfigurationStatus();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.AgentConfigurationStatus);
    });
    ...
    it('should have the property operationSucceeded (base name: "operationSucceeded")', function() {
      // uncomment below and update the code to test the property operationSucceeded
      //var instance = new AwsApplicationDiscoveryService.AgentConfigurationStatus();
      //expect(instance).to.be();
    });
