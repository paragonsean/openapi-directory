...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeImportTasksResponse();
  });
  ...
  describe('DescribeImportTasksResponse', function() {
    it('should create an instance of DescribeImportTasksResponse', function() {
      // uncomment below and update the code to test DescribeImportTasksResponse
      //var instance = new AwsApplicationDiscoveryService.DescribeImportTasksResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeImportTasksResponse);
    });
