...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeContinuousExportsResponse();
  });
  ...
  describe('DescribeContinuousExportsResponse', function() {
    it('should create an instance of DescribeContinuousExportsResponse', function() {
      // uncomment below and update the code to test DescribeContinuousExportsResponse
      //var instance = new AwsApplicationDiscoveryService.DescribeContinuousExportsResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeContinuousExportsResponse);
    });
