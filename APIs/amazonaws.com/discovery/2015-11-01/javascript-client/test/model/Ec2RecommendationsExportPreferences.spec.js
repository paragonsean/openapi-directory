...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.Ec2RecommendationsExportPreferences();
  });
  ...
  describe('Ec2RecommendationsExportPreferences', function() {
    it('should create an instance of Ec2RecommendationsExportPreferences', function() {
      // uncomment below and update the code to test Ec2RecommendationsExportPreferences
      //var instance = new AwsApplicationDiscoveryService.Ec2RecommendationsExportPreferences();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.Ec2RecommendationsExportPreferences);
    });
