...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeAgentsResponse();
  });
  ...
  describe('DescribeAgentsResponse', function() {
    it('should create an instance of DescribeAgentsResponse', function() {
      // uncomment below and update the code to test DescribeAgentsResponse
      //var instance = new AwsApplicationDiscoveryService.DescribeAgentsResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeAgentsResponse);
    });

    it('should have the property agentsInfo (base name: "agentsInfo")', function() {
      // uncomment below and update the code to test the property agentsInfo
      //var instance = new AwsApplicationDiscoveryService.DescribeAgentsResponse();
