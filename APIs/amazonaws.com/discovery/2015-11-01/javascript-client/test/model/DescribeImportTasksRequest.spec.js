...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeImportTasksRequest();
  });
  ...
  describe('DescribeImportTasksRequest', function() {
    it('should create an instance of DescribeImportTasksRequest', function() {
      // uncomment below and update the code to test DescribeImportTasksRequest
      //var instance = new AwsApplicationDiscoveryService.DescribeImportTasksRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeImportTasksRequest);
    });
