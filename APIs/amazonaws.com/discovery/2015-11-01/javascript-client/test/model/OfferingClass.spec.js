...
(function(root, factory) {
  ...
  describe('OfferingClass', function() {
    it('should create an instance of OfferingClass', function() {
      // uncomment below and update the code to test OfferingClass
      //var instance = new AwsApplicationDiscoveryService.OfferingClass();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.OfferingClass);
    });
