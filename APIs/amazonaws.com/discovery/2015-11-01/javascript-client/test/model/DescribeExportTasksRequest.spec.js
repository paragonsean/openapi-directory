...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeExportTasksRequest();
  });
  ...
  describe('DescribeExportTasksRequest', function() {
    it('should create an instance of DescribeExportTasksRequest', function() {
      // uncomment below and update the code to test DescribeExportTasksRequest
      //var instance = new AwsApplicationDiscoveryService.DescribeExportTasksRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeExportTasksRequest);
    });
