...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.UsageMetricBasis();
  });
  ...
  describe('UsageMetricBasis', function() {
    it('should create an instance of UsageMetricBasis', function() {
      // uncomment below and update the code to test UsageMetricBasis
      //var instance = new AwsApplicationDiscoveryService.UsageMetricBasis();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.UsageMetricBasis);
    });
    ...
    it('should have the property percentageAdjust (base name: "percentageAdjust")', function() {
      // uncomment below and update the code to test the property percentageAdjust
      //var instance = new AwsApplicationDiscoveryService.UsageMetricBasis();
      //expect(instance).to.be();
    });
