...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ExportInfo();
  });
  ...
  describe('ExportInfo', function() {
    it('should create an instance of ExportInfo', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.ExportInfo();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ExportInfo);
    });
    ...
    it('should have the property configurationsDownloadUrl (base name: "configurationsDownloadUrl")', function() {
      // uncomment below and update the code to test the property configurationsDownloadUrl
      //var instance = new AwsApplicationDiscoveryService.ExportInfo();
      //expect(instance).to.be();
    });

    it('should have the property exportRequestTime (base name: "exportRequestTime")', function() {
      // uncomment below and update the code to test the property exportRequestTime
      //var instance = new AwsApplicationDiscoveryService.ExportInfo();
      //expect(instance).to.be();
    });
    ...
    it('should have the property requestedStartTime (base name: "requestedStartTime")', function() {
      // uncomment below and update the code to test the property requestedStartTime
      //var instance = new AwsApplicationDiscoveryService.ExportInfo();
      //expect(instance).to.be();
    });

    it('should have the property requestedEndTime (base name: "requestedEndTime")', function() {
      // uncomment below and update the code to test the property requestedEndTime
      //var instance = new AwsApplicationDiscoveryService.ExportInfo();
      //expect(instance).to.be();
    });
