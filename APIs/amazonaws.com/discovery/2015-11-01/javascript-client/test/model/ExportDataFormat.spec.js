...
(function(root, factory) {
  ...
  describe('ExportDataFormat', function() {
    it('should create an instance of ExportDataFormat', function() {
      // uncomment below and update the code to test ExportDataFormat
      //var instance = new AwsApplicationDiscoveryService.ExportDataFormat();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ExportDataFormat);
    });
