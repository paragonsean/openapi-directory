...
(function(root, factory) {
  ...
  describe('BatchDeleteImportDataErrorCode', function() {
    it('should create an instance of BatchDeleteImportDataErrorCode', function() {
      // uncomment below and update the code to test BatchDeleteImportDataErrorCode
      //var instance = new AwsApplicationDiscoveryService.BatchDeleteImportDataErrorCode();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.BatchDeleteImportDataErrorCode);
    });
