...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeContinuousExportsRequest();
  });
  ...
  describe('DescribeContinuousExportsRequest', function() {
    it('should create an instance of DescribeContinuousExportsRequest', function() {
      // uncomment below and update the code to test DescribeContinuousExportsRequest
      //var instance = new AwsApplicationDiscoveryService.DescribeContinuousExportsRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeContinuousExportsRequest);
    });
