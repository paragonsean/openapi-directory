...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeExportTasksResponse();
  });
  ...
  describe('DescribeExportTasksResponse', function() {
    it('should create an instance of DescribeExportTasksResponse', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.DescribeExportTasksResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeExportTasksResponse);
    });

    it('should have the property exportsInfo (base name: "exportsInfo")', function() {
      // uncomment below and update the code to test the property exportsInfo
      //var instance = new AwsApplicationDiscoveryService.DescribeExportTasksResponse();
