...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.CustomerAgentInfo();
  });
  ...
  describe('CustomerAgentInfo', function() {
    it('should create an instance of CustomerAgentInfo', function() {
      // uncomment below and update the code to test CustomerAgentInfo
      //var instance = new AwsApplicationDiscoveryService.CustomerAgentInfo();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.CustomerAgentInfo);
    });
