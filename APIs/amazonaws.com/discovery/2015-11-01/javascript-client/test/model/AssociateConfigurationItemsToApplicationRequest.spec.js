...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.AssociateConfigurationItemsToApplicationRequest();
  });
  ...
  describe('AssociateConfigurationItemsToApplicationRequest', function() {
    it('should create an instance of AssociateConfigurationItemsToApplicationRequest', function() {
      // uncomment below and update the code to test AssociateConfigurationItemsToApplicationRequest
      //var instance = new AwsApplicationDiscoveryService.AssociateConfigurationItemsToApplicationRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.AssociateConfigurationItemsToApplicationRequest);
    });

    it('should have the property applicationConfigurationId (base name: "applicationConfigurationId")', function() {
      // uncomment below and update the code to test the property applicationConfigurationId
      //var instance = new AwsApplicationDiscoveryService.AssociateConfigurationItemsToApplicationRequest();
