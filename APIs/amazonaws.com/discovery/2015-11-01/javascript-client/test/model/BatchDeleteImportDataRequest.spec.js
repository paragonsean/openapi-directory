...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.BatchDeleteImportDataRequest();
  });
  ...
  describe('BatchDeleteImportDataRequest', function() {
    it('should create an instance of BatchDeleteImportDataRequest', function() {
      // uncomment below and update the code to test BatchDeleteImportDataRequest
      //var instance = new AwsApplicationDiscoveryService.BatchDeleteImportDataRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.BatchDeleteImportDataRequest);
    });

    it('should have the property importTaskIds (base name: "importTaskIds")', function() {
      // uncomment below and update the code to test the property importTaskIds
      //var instance = new AwsApplicationDiscoveryService.BatchDeleteImportDataRequest();
