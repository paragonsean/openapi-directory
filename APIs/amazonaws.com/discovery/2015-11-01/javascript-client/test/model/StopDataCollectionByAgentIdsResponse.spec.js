...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StopDataCollectionByAgentIdsResponse();
  });
  ...
  describe('StopDataCollectionByAgentIdsResponse', function() {
    it('should create an instance of StopDataCollectionByAgentIdsResponse', function() {
      // uncomment below and update the code to test StopDataCollectionByAgentIdsResponse
      //var instance = new AwsApplicationDiscoveryService.StopDataCollectionByAgentIdsResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StopDataCollectionByAgentIdsResponse);
    });
