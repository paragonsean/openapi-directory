...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.BatchDeleteImportDataError();
  });
  ...
  describe('BatchDeleteImportDataError', function() {
    it('should create an instance of BatchDeleteImportDataError', function() {
      // uncomment below and update the code to test BatchDeleteImportDataError
      //var instance = new AwsApplicationDiscoveryService.BatchDeleteImportDataError();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.BatchDeleteImportDataError);
    });
