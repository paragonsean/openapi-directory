...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.TagFilter();
  });
  ...
  describe('TagFilter', function() {
    it('should create an instance of TagFilter', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.TagFilter();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.TagFilter);
    });
