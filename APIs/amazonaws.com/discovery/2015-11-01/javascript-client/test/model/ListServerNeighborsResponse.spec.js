...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ListServerNeighborsResponse();
  });
  ...
  describe('ListServerNeighborsResponse', function() {
    it('should create an instance of ListServerNeighborsResponse', function() {
      // uncomment below and update the code to test ListServerNeighborsResponse
      //var instance = new AwsApplicationDiscoveryService.ListServerNeighborsResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ListServerNeighborsResponse);
    });
    ...
    it('should have the property knownDependencyCount (base name: "knownDependencyCount")', function() {
      // uncomment below and update the code to test the property knownDependencyCount
      //var instance = new AwsApplicationDiscoveryService.ListServerNeighborsResponse();
      //expect(instance).to.be();
    });
