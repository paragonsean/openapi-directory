...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponse();
  });
  ...
  describe('GetDiscoverySummaryResponse', function() {
    it('should create an instance of GetDiscoverySummaryResponse', function() {
      // uncomment below and update the code to test GetDiscoverySummaryResponse
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.GetDiscoverySummaryResponse);
    });
    ...
    it('should have the property serversMappedToApplications (base name: "serversMappedToApplications")', function() {
      // uncomment below and update the code to test the property serversMappedToApplications
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponse();
      //expect(instance).to.be();
    });

    it('should have the property serversMappedtoTags (base name: "serversMappedtoTags")', function() {
      // uncomment below and update the code to test the property serversMappedtoTags
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponse();
      //expect(instance).to.be();
    });

    it('should have the property agentSummary (base name: "agentSummary")', function() {
      // uncomment below and update the code to test the property agentSummary
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponse();
      //expect(instance).to.be();
    });

    it('should have the property connectorSummary (base name: "connectorSummary")', function() {
      // uncomment below and update the code to test the property connectorSummary
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponse();
      //expect(instance).to.be();
    });

    it('should have the property meCollectorSummary (base name: "meCollectorSummary")', function() {
      // uncomment below and update the code to test the property meCollectorSummary
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponse();
      //expect(instance).to.be();
    });

    it('should have the property agentlessCollectorSummary (base name: "agentlessCollectorSummary")', function() {
      // uncomment below and update the code to test the property agentlessCollectorSummary
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponse();
      //expect(instance).to.be();
    });
