...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ContinuousExportDescription();
  });
  ...
  describe('ContinuousExportDescription', function() {
    it('should create an instance of ContinuousExportDescription', function() {
      // uncomment below and update the code to test ContinuousExportDescription
      //var instance = new AwsApplicationDiscoveryService.ContinuousExportDescription();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ContinuousExportDescription);
    });
