...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ListServerNeighborsRequest();
  });
  ...
  describe('ListServerNeighborsRequest', function() {
    it('should create an instance of ListServerNeighborsRequest', function() {
      // uncomment below and update the code to test ListServerNeighborsRequest
      //var instance = new AwsApplicationDiscoveryService.ListServerNeighborsRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ListServerNeighborsRequest);
    });
    ...
    it('should have the property portInformationNeeded (base name: "portInformationNeeded")', function() {
      // uncomment below and update the code to test the property portInformationNeeded
      //var instance = new AwsApplicationDiscoveryService.ListServerNeighborsRequest();
      //expect(instance).to.be();
    });

    it('should have the property neighborConfigurationIds (base name: "neighborConfigurationIds")', function() {
      // uncomment below and update the code to test the property neighborConfigurationIds
      //var instance = new AwsApplicationDiscoveryService.ListServerNeighborsRequest();
      //expect(instance).to.be();
    });
