...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.CreateTagsRequest();
  });
  ...
  describe('CreateTagsRequest', function() {
    it('should create an instance of CreateTagsRequest', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.CreateTagsRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.CreateTagsRequest);
    });
