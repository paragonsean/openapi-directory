...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ListConfigurationsRequest();
  });
  ...
  describe('ListConfigurationsRequest', function() {
    it('should create an instance of ListConfigurationsRequest', function() {
      // uncomment below and update the code to test ListConfigurationsRequest
      //var instance = new AwsApplicationDiscoveryService.ListConfigurationsRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ListConfigurationsRequest);
    });
