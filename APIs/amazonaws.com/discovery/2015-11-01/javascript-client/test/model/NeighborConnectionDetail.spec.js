...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.NeighborConnectionDetail();
  });
  ...
  describe('NeighborConnectionDetail', function() {
    it('should create an instance of NeighborConnectionDetail', function() {
      // uncomment below and update the code to test NeighborConnectionDetail
      //var instance = new AwsApplicationDiscoveryService.NeighborConnectionDetail();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.NeighborConnectionDetail);
    });
    ...
    it('should have the property connectionsCount (base name: "connectionsCount")', function() {
      // uncomment below and update the code to test the property connectionsCount
      //var instance = new AwsApplicationDiscoveryService.NeighborConnectionDetail();
      //expect(instance).to.be();
    });
