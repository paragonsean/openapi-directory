...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ExportFilter();
  });
  ...
  describe('ExportFilter', function() {
    it('should create an instance of ExportFilter', function() {
      // uncomment below and update the code to test ExportFilter
      //var instance = new AwsApplicationDiscoveryService.ExportFilter();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ExportFilter);
    });
