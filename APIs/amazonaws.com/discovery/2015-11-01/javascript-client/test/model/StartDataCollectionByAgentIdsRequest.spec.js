...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StartDataCollectionByAgentIdsRequest();
  });
  ...
  describe('StartDataCollectionByAgentIdsRequest', function() {
    it('should create an instance of StartDataCollectionByAgentIdsRequest', function() {
      // uncomment below and update the code to test StartDataCollectionByAgentIdsRequest
      //var instance = new AwsApplicationDiscoveryService.StartDataCollectionByAgentIdsRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StartDataCollectionByAgentIdsRequest);
    });
