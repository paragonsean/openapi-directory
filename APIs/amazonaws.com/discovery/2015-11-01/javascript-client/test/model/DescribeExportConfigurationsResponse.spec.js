...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeExportConfigurationsResponse();
  });
  ...
  describe('DescribeExportConfigurationsResponse', function() {
    it('should create an instance of DescribeExportConfigurationsResponse', function() {
      // uncomment below and update the code to test DescribeExportConfigurationsResponse
      //var instance = new AwsApplicationDiscoveryService.DescribeExportConfigurationsResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeExportConfigurationsResponse);
    });
