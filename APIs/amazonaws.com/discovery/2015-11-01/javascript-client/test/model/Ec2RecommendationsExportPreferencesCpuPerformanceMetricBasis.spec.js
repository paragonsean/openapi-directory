...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis();
  });
  ...
  describe('Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis', function() {
    it('should create an instance of Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis', function() {
      // uncomment below and update the code to test Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis
      //var instance = new AwsApplicationDiscoveryService.Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis);
    });
