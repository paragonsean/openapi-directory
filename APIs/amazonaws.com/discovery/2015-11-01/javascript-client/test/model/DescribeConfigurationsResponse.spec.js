...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeConfigurationsResponse();
  });
  ...
  describe('DescribeConfigurationsResponse', function() {
    it('should create an instance of DescribeConfigurationsResponse', function() {
      // uncomment below and update the code to test DescribeConfigurationsResponse
      //var instance = new AwsApplicationDiscoveryService.DescribeConfigurationsResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeConfigurationsResponse);
    });
