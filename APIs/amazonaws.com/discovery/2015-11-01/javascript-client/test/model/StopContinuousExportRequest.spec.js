...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StopContinuousExportRequest();
  });
  ...
  describe('StopContinuousExportRequest', function() {
    it('should create an instance of StopContinuousExportRequest', function() {
      // uncomment below and update the code to test StopContinuousExportRequest
      //var instance = new AwsApplicationDiscoveryService.StopContinuousExportRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StopContinuousExportRequest);
    });
