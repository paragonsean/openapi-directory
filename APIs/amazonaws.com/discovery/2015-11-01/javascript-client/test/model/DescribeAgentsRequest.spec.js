...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeAgentsRequest();
  });
  ...
  describe('DescribeAgentsRequest', function() {
    it('should create an instance of DescribeAgentsRequest', function() {
      // uncomment below and update the code to test DescribeAgentsRequest
      //var instance = new AwsApplicationDiscoveryService.DescribeAgentsRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeAgentsRequest);
    });
