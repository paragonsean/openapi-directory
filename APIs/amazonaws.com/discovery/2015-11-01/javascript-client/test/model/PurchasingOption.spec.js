...
(function(root, factory) {
  ...
  describe('PurchasingOption', function() {
    it('should create an instance of PurchasingOption', function() {
      // uncomment below and update the code to test PurchasingOption
      //var instance = new AwsApplicationDiscoveryService.PurchasingOption();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.PurchasingOption);
    });
