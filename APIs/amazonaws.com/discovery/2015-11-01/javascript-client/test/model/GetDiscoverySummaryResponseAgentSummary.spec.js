...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentSummary();
  });
  ...
  describe('GetDiscoverySummaryResponseAgentSummary', function() {
    it('should create an instance of GetDiscoverySummaryResponseAgentSummary', function() {
      // uncomment below and update the code to test GetDiscoverySummaryResponseAgentSummary
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentSummary();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentSummary);
    });

    it('should have the property activeAgents (base name: "activeAgents")', function() {
      // uncomment below and update the code to test the property activeAgents
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentSummary();
      //expect(instance).to.be();
    });

    it('should have the property healthyAgents (base name: "healthyAgents")', function() {
      // uncomment below and update the code to test the property healthyAgents
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentSummary();
      //expect(instance).to.be();
    });

    it('should have the property blackListedAgents (base name: "blackListedAgents")', function() {
      // uncomment below and update the code to test the property blackListedAgents
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentSummary();
      //expect(instance).to.be();
    });

    it('should have the property shutdownAgents (base name: "shutdownAgents")', function() {
      // uncomment below and update the code to test the property shutdownAgents
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentSummary();
      //expect(instance).to.be();
    });

    it('should have the property unhealthyAgents (base name: "unhealthyAgents")', function() {
      // uncomment below and update the code to test the property unhealthyAgents
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentSummary();
      //expect(instance).to.be();
    });

    it('should have the property totalAgents (base name: "totalAgents")', function() {
      // uncomment below and update the code to test the property totalAgents
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentSummary();
      //expect(instance).to.be();
    });

    it('should have the property unknownAgents (base name: "unknownAgents")', function() {
      // uncomment below and update the code to test the property unknownAgents
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentSummary();
      //expect(instance).to.be();
    });
