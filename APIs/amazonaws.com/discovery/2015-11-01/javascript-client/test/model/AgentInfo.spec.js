...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.AgentInfo();
  });
  ...
  describe('AgentInfo', function() {
    it('should create an instance of AgentInfo', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.AgentInfo();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.AgentInfo);
    });
    ...
    it('should have the property agentNetworkInfoList (base name: "agentNetworkInfoList")', function() {
      // uncomment below and update the code to test the property agentNetworkInfoList
      //var instance = new AwsApplicationDiscoveryService.AgentInfo();
      //expect(instance).to.be();
    });
    ...
    it('should have the property lastHealthPingTime (base name: "lastHealthPingTime")', function() {
      // uncomment below and update the code to test the property lastHealthPingTime
      //var instance = new AwsApplicationDiscoveryService.AgentInfo();
      //expect(instance).to.be();
    });
