...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DisassociateConfigurationItemsFromApplicationRequest();
  });
  ...
  describe('DisassociateConfigurationItemsFromApplicationRequest', function() {
    it('should create an instance of DisassociateConfigurationItemsFromApplicationRequest', function() {
      // uncomment below and update the code to test DisassociateConfigurationItemsFromApplicationRequest
      //var instance = new AwsApplicationDiscoveryService.DisassociateConfigurationItemsFromApplicationRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DisassociateConfigurationItemsFromApplicationRequest);
    });
