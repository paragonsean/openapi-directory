...
(function(root, factory) {
  ...
  describe('ImportTaskFilterName', function() {
    it('should create an instance of ImportTaskFilterName', function() {
      // uncomment below and update the code to test ImportTaskFilterName
      //var instance = new AwsApplicationDiscoveryService.ImportTaskFilterName();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ImportTaskFilterName);
    });
