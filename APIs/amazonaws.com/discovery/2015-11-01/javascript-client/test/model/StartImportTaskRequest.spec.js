...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StartImportTaskRequest();
  });
  ...
  describe('StartImportTaskRequest', function() {
    it('should create an instance of StartImportTaskRequest', function() {
      // uncomment below and update the code to test StartImportTaskRequest
      //var instance = new AwsApplicationDiscoveryService.StartImportTaskRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StartImportTaskRequest);
    });
