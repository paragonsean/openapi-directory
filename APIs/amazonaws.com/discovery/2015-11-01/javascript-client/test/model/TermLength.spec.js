...
(function(root, factory) {
  ...
  describe('TermLength', function() {
    it('should create an instance of TermLength', function() {
      // uncomment below and update the code to test TermLength
      //var instance = new AwsApplicationDiscoveryService.TermLength();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.TermLength);
    });
