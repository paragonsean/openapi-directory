...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.CreateApplicationResponse();
  });
  ...
  describe('CreateApplicationResponse', function() {
    it('should create an instance of CreateApplicationResponse', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.CreateApplicationResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.CreateApplicationResponse);
    });
