...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DeleteTagsRequest();
  });
  ...
  describe('DeleteTagsRequest', function() {
    it('should create an instance of DeleteTagsRequest', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.DeleteTagsRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DeleteTagsRequest);
    });
