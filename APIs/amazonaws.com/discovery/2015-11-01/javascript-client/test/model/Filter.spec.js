...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.Filter();
  });
  ...
  describe('Filter', function() {
    it('should create an instance of Filter', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.Filter();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.Filter);
    });
