...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ReservedInstanceOptions();
  });
  ...
  describe('ReservedInstanceOptions', function() {
    it('should create an instance of ReservedInstanceOptions', function() {
      // uncomment below and update the code to test ReservedInstanceOptions
      //var instance = new AwsApplicationDiscoveryService.ReservedInstanceOptions();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ReservedInstanceOptions);
    });

    it('should have the property purchasingOption (base name: "purchasingOption")', function() {
      // uncomment below and update the code to test the property purchasingOption
      //var instance = new AwsApplicationDiscoveryService.ReservedInstanceOptions();
