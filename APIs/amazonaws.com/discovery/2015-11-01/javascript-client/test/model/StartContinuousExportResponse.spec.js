...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StartContinuousExportResponse();
  });
  ...
  describe('StartContinuousExportResponse', function() {
    it('should create an instance of StartContinuousExportResponse', function() {
      // uncomment below and update the code to test StartContinuousExportResponse
      //var instance = new AwsApplicationDiscoveryService.StartContinuousExportResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StartContinuousExportResponse);
    });
    ...
    it('should have the property schemaStorageConfig (base name: "schemaStorageConfig")', function() {
      // uncomment below and update the code to test the property schemaStorageConfig
      //var instance = new AwsApplicationDiscoveryService.StartContinuousExportResponse();
      //expect(instance).to.be();
    });
