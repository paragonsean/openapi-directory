...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StartExportTaskRequestPreferences();
  });
  ...
  describe('StartExportTaskRequestPreferences', function() {
    it('should create an instance of StartExportTaskRequestPreferences', function() {
      // uncomment below and update the code to test StartExportTaskRequestPreferences
      //var instance = new AwsApplicationDiscoveryService.StartExportTaskRequestPreferences();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StartExportTaskRequestPreferences);
    });
