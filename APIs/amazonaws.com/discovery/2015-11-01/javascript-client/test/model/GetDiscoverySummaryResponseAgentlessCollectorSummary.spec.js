...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentlessCollectorSummary();
  });
  ...
  describe('GetDiscoverySummaryResponseAgentlessCollectorSummary', function() {
    it('should create an instance of GetDiscoverySummaryResponseAgentlessCollectorSummary', function() {
      // uncomment below and update the code to test GetDiscoverySummaryResponseAgentlessCollectorSummary
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentlessCollectorSummary();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentlessCollectorSummary);
    });

    it('should have the property activeAgentlessCollectors (base name: "activeAgentlessCollectors")', function() {
      // uncomment below and update the code to test the property activeAgentlessCollectors
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentlessCollectorSummary();
      //expect(instance).to.be();
    });

    it('should have the property healthyAgentlessCollectors (base name: "healthyAgentlessCollectors")', function() {
      // uncomment below and update the code to test the property healthyAgentlessCollectors
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentlessCollectorSummary();
      //expect(instance).to.be();
    });

    it('should have the property denyListedAgentlessCollectors (base name: "denyListedAgentlessCollectors")', function() {
      // uncomment below and update the code to test the property denyListedAgentlessCollectors
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentlessCollectorSummary();
      //expect(instance).to.be();
    });

    it('should have the property shutdownAgentlessCollectors (base name: "shutdownAgentlessCollectors")', function() {
      // uncomment below and update the code to test the property shutdownAgentlessCollectors
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentlessCollectorSummary();
      //expect(instance).to.be();
    });

    it('should have the property unhealthyAgentlessCollectors (base name: "unhealthyAgentlessCollectors")', function() {
      // uncomment below and update the code to test the property unhealthyAgentlessCollectors
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentlessCollectorSummary();
      //expect(instance).to.be();
    });

    it('should have the property totalAgentlessCollectors (base name: "totalAgentlessCollectors")', function() {
      // uncomment below and update the code to test the property totalAgentlessCollectors
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentlessCollectorSummary();
      //expect(instance).to.be();
    });

    it('should have the property unknownAgentlessCollectors (base name: "unknownAgentlessCollectors")', function() {
      // uncomment below and update the code to test the property unknownAgentlessCollectors
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseAgentlessCollectorSummary();
      //expect(instance).to.be();
    });
