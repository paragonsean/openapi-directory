...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StartExportTaskResponse();
  });
  ...
  describe('StartExportTaskResponse', function() {
    it('should create an instance of StartExportTaskResponse', function() {
      // uncomment below and update the code to test StartExportTaskResponse
      //var instance = new AwsApplicationDiscoveryService.StartExportTaskResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StartExportTaskResponse);
    });
