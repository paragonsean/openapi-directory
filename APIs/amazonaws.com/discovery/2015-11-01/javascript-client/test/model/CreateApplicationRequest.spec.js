...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.CreateApplicationRequest();
  });
  ...
  describe('CreateApplicationRequest', function() {
    it('should create an instance of CreateApplicationRequest', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.CreateApplicationRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.CreateApplicationRequest);
    });
