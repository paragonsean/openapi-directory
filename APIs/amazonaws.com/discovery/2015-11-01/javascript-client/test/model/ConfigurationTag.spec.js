...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ConfigurationTag();
  });
  ...
  describe('ConfigurationTag', function() {
    it('should create an instance of ConfigurationTag', function() {
      // uncomment below and update the code to test ConfigurationTag
      //var instance = new AwsApplicationDiscoveryService.ConfigurationTag();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ConfigurationTag);
    });
    ...
    it('should have the property timeOfCreation (base name: "timeOfCreation")', function() {
      // uncomment below and update the code to test the property timeOfCreation
      //var instance = new AwsApplicationDiscoveryService.ConfigurationTag();
      //expect(instance).to.be();
    });
