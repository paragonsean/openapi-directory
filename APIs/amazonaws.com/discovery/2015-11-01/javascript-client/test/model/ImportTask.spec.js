...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ImportTask();
  });
  ...
  describe('ImportTask', function() {
    it('should create an instance of ImportTask', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.ImportTask();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ImportTask);
    });
    ...
    it('should have the property importUrl (base name: "importUrl")', function() {
    ...
    it('should have the property importRequestTime (base name: "importRequestTime")', function() {
      // uncomment below and update the code to test the property importRequestTime
      //var instance = new AwsApplicationDiscoveryService.ImportTask();
      //expect(instance).to.be();
    });

    it('should have the property importCompletionTime (base name: "importCompletionTime")', function() {
      // uncomment below and update the code to test the property importCompletionTime
      //var instance = new AwsApplicationDiscoveryService.ImportTask();
      //expect(instance).to.be();
    });

    it('should have the property importDeletedTime (base name: "importDeletedTime")', function() {
      // uncomment below and update the code to test the property importDeletedTime
      //var instance = new AwsApplicationDiscoveryService.ImportTask();
      //expect(instance).to.be();
    });

    it('should have the property serverImportSuccess (base name: "serverImportSuccess")', function() {
      // uncomment below and update the code to test the property serverImportSuccess
      //var instance = new AwsApplicationDiscoveryService.ImportTask();
      //expect(instance).to.be();
    });

    it('should have the property serverImportFailure (base name: "serverImportFailure")', function() {
      // uncomment below and update the code to test the property serverImportFailure
      //var instance = new AwsApplicationDiscoveryService.ImportTask();
      //expect(instance).to.be();
    });

    it('should have the property applicationImportSuccess (base name: "applicationImportSuccess")', function() {
      // uncomment below and update the code to test the property applicationImportSuccess
      //var instance = new AwsApplicationDiscoveryService.ImportTask();
      //expect(instance).to.be();
    });

    it('should have the property applicationImportFailure (base name: "applicationImportFailure")', function() {
      // uncomment below and update the code to test the property applicationImportFailure
      //var instance = new AwsApplicationDiscoveryService.ImportTask();
      //expect(instance).to.be();
    });

    it('should have the property errorsAndFailedEntriesZip (base name: "errorsAndFailedEntriesZip")', function() {
      // uncomment below and update the code to test the property errorsAndFailedEntriesZip
      //var instance = new AwsApplicationDiscoveryService.ImportTask();
      //expect(instance).to.be();
    });
