...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeExportConfigurationsRequest();
  });
  ...
  describe('DescribeExportConfigurationsRequest', function() {
    it('should create an instance of DescribeExportConfigurationsRequest', function() {
      // uncomment below and update the code to test DescribeExportConfigurationsRequest
      //var instance = new AwsApplicationDiscoveryService.DescribeExportConfigurationsRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeExportConfigurationsRequest);
    });
