...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.OrderByElement();
  });
  ...
  describe('OrderByElement', function() {
    it('should create an instance of OrderByElement', function() {
      // uncomment below and update the code to test OrderByElement
      //var instance = new AwsApplicationDiscoveryService.OrderByElement();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.OrderByElement);
    });
