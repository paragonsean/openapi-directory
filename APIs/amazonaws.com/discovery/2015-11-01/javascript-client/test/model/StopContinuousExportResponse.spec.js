...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StopContinuousExportResponse();
  });
  ...
  describe('StopContinuousExportResponse', function() {
    it('should create an instance of StopContinuousExportResponse', function() {
      // uncomment below and update the code to test StopContinuousExportResponse
      //var instance = new AwsApplicationDiscoveryService.StopContinuousExportResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StopContinuousExportResponse);
    });
