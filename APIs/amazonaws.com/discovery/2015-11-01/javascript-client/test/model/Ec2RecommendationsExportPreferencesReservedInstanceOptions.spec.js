...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.Ec2RecommendationsExportPreferencesReservedInstanceOptions();
  });
  ...
  describe('Ec2RecommendationsExportPreferencesReservedInstanceOptions', function() {
    it('should create an instance of Ec2RecommendationsExportPreferencesReservedInstanceOptions', function() {
      // uncomment below and update the code to test Ec2RecommendationsExportPreferencesReservedInstanceOptions
      //var instance = new AwsApplicationDiscoveryService.Ec2RecommendationsExportPreferencesReservedInstanceOptions();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.Ec2RecommendationsExportPreferencesReservedInstanceOptions);
    });
