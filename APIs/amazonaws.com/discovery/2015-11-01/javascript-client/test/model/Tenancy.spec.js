...
(function(root, factory) {
  ...
  describe('Tenancy', function() {
    it('should create an instance of Tenancy', function() {
      // uncomment below and update the code to test Tenancy
      //var instance = new AwsApplicationDiscoveryService.Tenancy();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.Tenancy);
    });
