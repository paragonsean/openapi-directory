...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StartImportTaskResponse();
  });
  ...
  describe('StartImportTaskResponse', function() {
    it('should create an instance of StartImportTaskResponse', function() {
      // uncomment below and update the code to test StartImportTaskResponse
      //var instance = new AwsApplicationDiscoveryService.StartImportTaskResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StartImportTaskResponse);
    });
