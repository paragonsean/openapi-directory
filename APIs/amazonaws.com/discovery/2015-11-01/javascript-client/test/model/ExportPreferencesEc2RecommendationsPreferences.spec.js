...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ExportPreferencesEc2RecommendationsPreferences();
  });
  ...
  describe('ExportPreferencesEc2RecommendationsPreferences', function() {
    it('should create an instance of ExportPreferencesEc2RecommendationsPreferences', function() {
      // uncomment below and update the code to test ExportPreferencesEc2RecommendationsPreferences
      //var instance = new AwsApplicationDiscoveryService.ExportPreferencesEc2RecommendationsPreferences();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ExportPreferencesEc2RecommendationsPreferences);
    });
    ...
    it('should have the property cpuPerformanceMetricBasis (base name: "cpuPerformanceMetricBasis")', function() {
      // uncomment below and update the code to test the property cpuPerformanceMetricBasis
      //var instance = new AwsApplicationDiscoveryService.ExportPreferencesEc2RecommendationsPreferences();
      //expect(instance).to.be();
    });

    it('should have the property ramPerformanceMetricBasis (base name: "ramPerformanceMetricBasis")', function() {
      // uncomment below and update the code to test the property ramPerformanceMetricBasis
      //var instance = new AwsApplicationDiscoveryService.ExportPreferencesEc2RecommendationsPreferences();
      //expect(instance).to.be();
    });
    ...
    it('should have the property reservedInstanceOptions (base name: "reservedInstanceOptions")', function() {
      // uncomment below and update the code to test the property reservedInstanceOptions
      //var instance = new AwsApplicationDiscoveryService.ExportPreferencesEc2RecommendationsPreferences();
      //expect(instance).to.be();
    });
