...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseConnectorSummary();
  });
  ...
  describe('GetDiscoverySummaryResponseConnectorSummary', function() {
    it('should create an instance of GetDiscoverySummaryResponseConnectorSummary', function() {
      // uncomment below and update the code to test GetDiscoverySummaryResponseConnectorSummary
      //var instance = new AwsApplicationDiscoveryService.GetDiscoverySummaryResponseConnectorSummary();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.GetDiscoverySummaryResponseConnectorSummary);
    });
