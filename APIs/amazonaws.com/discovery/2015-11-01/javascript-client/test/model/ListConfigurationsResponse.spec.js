...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ListConfigurationsResponse();
  });
  ...
  describe('ListConfigurationsResponse', function() {
    it('should create an instance of ListConfigurationsResponse', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.ListConfigurationsResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ListConfigurationsResponse);
    });
