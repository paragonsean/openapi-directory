...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.ExportConfigurationsResponse();
  });
  ...
  describe('ExportConfigurationsResponse', function() {
    it('should create an instance of ExportConfigurationsResponse', function() {
      // uncomment below and update the code to test ExportConfigurationsResponse
      //var instance = new AwsApplicationDiscoveryService.ExportConfigurationsResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.ExportConfigurationsResponse);
    });
