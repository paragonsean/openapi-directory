...
(function(root, factory) {
  ...
  describe('OrderString', function() {
    it('should create an instance of OrderString', function() {
      // uncomment below and update the code to test OrderString
      //var instance = new AwsApplicationDiscoveryService.OrderString();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.OrderString);
    });
