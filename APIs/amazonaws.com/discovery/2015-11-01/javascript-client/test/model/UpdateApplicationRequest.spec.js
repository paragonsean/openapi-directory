...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.UpdateApplicationRequest();
  });
  ...
  describe('UpdateApplicationRequest', function() {
    it('should create an instance of UpdateApplicationRequest', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.UpdateApplicationRequest();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.UpdateApplicationRequest);
    });
