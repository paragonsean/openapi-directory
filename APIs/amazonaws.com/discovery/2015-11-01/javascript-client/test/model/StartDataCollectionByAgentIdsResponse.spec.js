...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.StartDataCollectionByAgentIdsResponse();
  });
  ...
  describe('StartDataCollectionByAgentIdsResponse', function() {
    it('should create an instance of StartDataCollectionByAgentIdsResponse', function() {
      // uncomment below and update the code to test StartDataCollectionByAgentIdsResponse
      //var instance = new AwsApplicationDiscoveryService.StartDataCollectionByAgentIdsResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.StartDataCollectionByAgentIdsResponse);
    });

    it('should have the property agentsConfigurationStatus (base name: "agentsConfigurationStatus")', function() {
      // uncomment below and update the code to test the property agentsConfigurationStatus
      //var instance = new AwsApplicationDiscoveryService.StartDataCollectionByAgentIdsResponse();
