...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsApplicationDiscoveryService.DescribeTagsResponse();
  });
  ...
  describe('DescribeTagsResponse', function() {
    it('should create an instance of DescribeTagsResponse', function() {
      ...
      //var instance = new AwsApplicationDiscoveryService.DescribeTagsResponse();
      //expect(instance).to.be.a(AwsApplicationDiscoveryService.DescribeTagsResponse);
    });
