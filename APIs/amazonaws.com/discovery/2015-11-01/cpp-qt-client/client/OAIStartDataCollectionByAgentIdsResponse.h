...
/*
 * OAIStartDataCollectionByAgentIdsResponse.h
 *
 * 
 */

#ifndef OAIStartDataCollectionByAgentIdsResponse_H
#define OAIStartDataCollectionByAgentIdsResponse_H
...
class OAIStartDataCollectionByAgentIdsResponse : public OAIObject {
public:
    OAIStartDataCollectionByAgentIdsResponse();
    OAIStartDataCollectionByAgentIdsResponse(QString json);
    ~OAIStartDataCollectionByAgentIdsResponse() override;
    ...
    QList getAgentsConfigurationStatus() const;
    void setAgentsConfigurationStatus(const QList &agents_configuration_status);
    bool is_agents_configuration_status_Set() const;
    bool is_agents_configuration_status_Valid() const;
...
private:
    ...
    QList m_agents_configuration_status;
    bool m_agents_configuration_status_isSet;
    bool m_agents_configuration_status_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartDataCollectionByAgentIdsResponse)

#endif // OAIStartDataCollectionByAgentIdsResponse_H
