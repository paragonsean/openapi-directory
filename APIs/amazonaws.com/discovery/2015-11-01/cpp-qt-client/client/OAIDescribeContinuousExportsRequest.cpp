...
OAIDescribeContinuousExportsRequest::OAIDescribeContinuousExportsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeContinuousExportsRequest::OAIDescribeContinuousExportsRequest() {
    this->initializeModel();
}

OAIDescribeContinuousExportsRequest::~OAIDescribeContinuousExportsRequest() {}

void OAIDescribeContinuousExportsRequest::initializeModel() {
...
void OAIDescribeContinuousExportsRequest::fromJson(QString jsonString) {
...
void OAIDescribeContinuousExportsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeContinuousExportsRequest::asJson() const {
...
QJsonObject OAIDescribeContinuousExportsRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeContinuousExportsRequest::getExportIds() const {
    return m_export_ids;
}
void OAIDescribeContinuousExportsRequest::setExportIds(const QList &export_ids) {
    m_export_ids = export_ids;
    m_export_ids_isSet = true;
}

bool OAIDescribeContinuousExportsRequest::is_export_ids_Set() const{
    return m_export_ids_isSet;
}

bool OAIDescribeContinuousExportsRequest::is_export_ids_Valid() const{
    return m_export_ids_isValid;
}

qint32 OAIDescribeContinuousExportsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeContinuousExportsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeContinuousExportsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeContinuousExportsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeContinuousExportsRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeContinuousExportsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeContinuousExportsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeContinuousExportsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeContinuousExportsRequest::isSet() const {
...
bool OAIDescribeContinuousExportsRequest::isValid() const {
