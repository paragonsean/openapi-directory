...
/*
 * OAIConfigurationItemType.h
 *
 * 
 */

#ifndef OAIConfigurationItemType_H
#define OAIConfigurationItemType_H
...
class OAIConfigurationItemType : public OAIEnum {
public:
    OAIConfigurationItemType();
    OAIConfigurationItemType(QString json);
    ~OAIConfigurationItemType() override;
    ...
    enum class eOAIConfigurationItemType {
    ...
    OAIConfigurationItemType::eOAIConfigurationItemType getValue() const;
    void setValue(const OAIConfigurationItemType::eOAIConfigurationItemType& value);
...
private:
    ...
    eOAIConfigurationItemType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigurationItemType)

#endif // OAIConfigurationItemType_H
