...
void OAIImportStatus::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("IMPORT_IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportStatus::IMPORT_IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IMPORT_COMPLETE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportStatus::IMPORT_COMPLETE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IMPORT_COMPLETE_WITH_ERRORS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportStatus::IMPORT_COMPLETE_WITH_ERRORS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IMPORT_FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportStatus::IMPORT_FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IMPORT_FAILED_SERVER_LIMIT_EXCEEDED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportStatus::IMPORT_FAILED_SERVER_LIMIT_EXCEEDED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IMPORT_FAILED_RECORD_LIMIT_EXCEEDED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportStatus::IMPORT_FAILED_RECORD_LIMIT_EXCEEDED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETE_IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportStatus::DELETE_IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETE_COMPLETE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportStatus::DELETE_COMPLETE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETE_FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportStatus::DELETE_FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETE_FAILED_LIMIT_EXCEEDED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportStatus::DELETE_FAILED_LIMIT_EXCEEDED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("INTERNAL_ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportStatus::INTERNAL_ERROR;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIImportStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIImportStatus::IMPORT_IN_PROGRESS:
            val = "IMPORT_IN_PROGRESS";
            break;
        case eOAIImportStatus::IMPORT_COMPLETE:
            val = "IMPORT_COMPLETE";
            break;
        case eOAIImportStatus::IMPORT_COMPLETE_WITH_ERRORS:
            val = "IMPORT_COMPLETE_WITH_ERRORS";
            break;
        case eOAIImportStatus::IMPORT_FAILED:
            val = "IMPORT_FAILED";
            break;
        case eOAIImportStatus::IMPORT_FAILED_SERVER_LIMIT_EXCEEDED:
            val = "IMPORT_FAILED_SERVER_LIMIT_EXCEEDED";
            break;
        case eOAIImportStatus::IMPORT_FAILED_RECORD_LIMIT_EXCEEDED:
            val = "IMPORT_FAILED_RECORD_LIMIT_EXCEEDED";
            break;
        case eOAIImportStatus::DELETE_IN_PROGRESS:
            val = "DELETE_IN_PROGRESS";
            break;
        case eOAIImportStatus::DELETE_COMPLETE:
            val = "DELETE_COMPLETE";
            break;
        case eOAIImportStatus::DELETE_FAILED:
            val = "DELETE_FAILED";
            break;
        case eOAIImportStatus::DELETE_FAILED_LIMIT_EXCEEDED:
            val = "DELETE_FAILED_LIMIT_EXCEEDED";
            break;
        case eOAIImportStatus::INTERNAL_ERROR:
            val = "INTERNAL_ERROR";
            break;
        default:
            break;
