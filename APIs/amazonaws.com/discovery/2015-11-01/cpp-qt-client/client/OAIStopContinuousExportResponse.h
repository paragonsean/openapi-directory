...
/*
 * OAIStopContinuousExportResponse.h
 *
 * 
 */

#ifndef OAIStopContinuousExportResponse_H
#define OAIStopContinuousExportResponse_H
...
class OAIStopContinuousExportResponse : public OAIObject {
public:
    OAIStopContinuousExportResponse();
    OAIStopContinuousExportResponse(QString json);
    ~OAIStopContinuousExportResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopContinuousExportResponse)

#endif // OAIStopContinuousExportResponse_H
