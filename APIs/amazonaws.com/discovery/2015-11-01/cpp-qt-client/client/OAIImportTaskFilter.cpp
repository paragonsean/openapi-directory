...
OAIImportTaskFilter::OAIImportTaskFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportTaskFilter::OAIImportTaskFilter() {
    this->initializeModel();
}

OAIImportTaskFilter::~OAIImportTaskFilter() {}

void OAIImportTaskFilter::initializeModel() {
...
void OAIImportTaskFilter::fromJson(QString jsonString) {
...
void OAIImportTaskFilter::fromJsonObject(QJsonObject json) {
...
QString OAIImportTaskFilter::asJson() const {
...
QJsonObject OAIImportTaskFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_name.isSet()) {
...
OAIImportTaskFilterName OAIImportTaskFilter::getName() const {
    return m_name;
}
void OAIImportTaskFilter::setName(const OAIImportTaskFilterName &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIImportTaskFilter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIImportTaskFilter::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIImportTaskFilter::getValues() const {
    return m_values;
}
void OAIImportTaskFilter::setValues(const QList &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAIImportTaskFilter::is_values_Set() const{
    return m_values_isSet;
}

bool OAIImportTaskFilter::is_values_Valid() const{
    return m_values_isValid;
}

bool OAIImportTaskFilter::isSet() const {
...
bool OAIImportTaskFilter::isValid() const {
