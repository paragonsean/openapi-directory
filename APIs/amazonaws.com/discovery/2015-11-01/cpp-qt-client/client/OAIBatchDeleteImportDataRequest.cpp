...
OAIBatchDeleteImportDataRequest::OAIBatchDeleteImportDataRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchDeleteImportDataRequest::OAIBatchDeleteImportDataRequest() {
    this->initializeModel();
}

OAIBatchDeleteImportDataRequest::~OAIBatchDeleteImportDataRequest() {}

void OAIBatchDeleteImportDataRequest::initializeModel() {

    m_import_task_ids_isSet = false;
    m_import_task_ids_isValid = false;
}

void OAIBatchDeleteImportDataRequest::fromJson(QString jsonString) {
...
void OAIBatchDeleteImportDataRequest::fromJsonObject(QJsonObject json) {

    m_import_task_ids_isValid = ::OpenAPI::fromJsonValue(m_import_task_ids, json[QString("importTaskIds")]);
    m_import_task_ids_isSet = !json[QString("importTaskIds")].isNull() && m_import_task_ids_isValid;
}

QString OAIBatchDeleteImportDataRequest::asJson() const {
...
QJsonObject OAIBatchDeleteImportDataRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_import_task_ids.isSet()) {
        obj.insert(QString("importTaskIds"), ::OpenAPI::toJsonValue(m_import_task_ids));
    }
    return obj;
}

QList OAIBatchDeleteImportDataRequest::getImportTaskIds() const {
    return m_import_task_ids;
}
void OAIBatchDeleteImportDataRequest::setImportTaskIds(const QList &import_task_ids) {
    m_import_task_ids = import_task_ids;
    m_import_task_ids_isSet = true;
}

bool OAIBatchDeleteImportDataRequest::is_import_task_ids_Set() const{
    return m_import_task_ids_isSet;
}

bool OAIBatchDeleteImportDataRequest::is_import_task_ids_Valid() const{
    return m_import_task_ids_isValid;
}

bool OAIBatchDeleteImportDataRequest::isSet() const {
...
bool OAIBatchDeleteImportDataRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_import_task_ids_isValid && true;
}
