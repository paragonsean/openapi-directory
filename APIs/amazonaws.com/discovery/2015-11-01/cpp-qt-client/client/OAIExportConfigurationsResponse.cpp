...
OAIExportConfigurationsResponse::OAIExportConfigurationsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExportConfigurationsResponse::OAIExportConfigurationsResponse() {
    this->initializeModel();
}

OAIExportConfigurationsResponse::~OAIExportConfigurationsResponse() {}

void OAIExportConfigurationsResponse::initializeModel() {

    m_export_id_isSet = false;
    m_export_id_isValid = false;
}

void OAIExportConfigurationsResponse::fromJson(QString jsonString) {
...
void OAIExportConfigurationsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIExportConfigurationsResponse::asJson() const {
...
QJsonObject OAIExportConfigurationsResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIExportConfigurationsResponse::getExportId() const {
    return m_export_id;
}
void OAIExportConfigurationsResponse::setExportId(const QString &export_id) {
    m_export_id = export_id;
    m_export_id_isSet = true;
}

bool OAIExportConfigurationsResponse::is_export_id_Set() const{
    return m_export_id_isSet;
}

bool OAIExportConfigurationsResponse::is_export_id_Valid() const{
    return m_export_id_isValid;
}

bool OAIExportConfigurationsResponse::isSet() const {
...
bool OAIExportConfigurationsResponse::isValid() const {
