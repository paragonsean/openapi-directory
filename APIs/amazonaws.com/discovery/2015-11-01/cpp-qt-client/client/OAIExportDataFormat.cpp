...
OAIExportDataFormat::OAIExportDataFormat(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExportDataFormat::OAIExportDataFormat() {
    this->initializeModel();
}

OAIExportDataFormat::~OAIExportDataFormat() {}

void OAIExportDataFormat::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIExportDataFormat::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIExportDataFormat::fromJson(QString jsonString) {
    
    if ( jsonString.compare("CSV", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExportDataFormat::CSV;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIExportDataFormat::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIExportDataFormat::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIExportDataFormat::CSV:
            val = "CSV";
            break;
        default:
            break;
...
QJsonValue OAIExportDataFormat::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIExportDataFormat::eOAIExportDataFormat OAIExportDataFormat::getValue() const {
    return m_value;
}

void OAIExportDataFormat::setValue(const OAIExportDataFormat::eOAIExportDataFormat& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIExportDataFormat::isSet() const {
    
    return m_value_isSet;
}

bool OAIExportDataFormat::isValid() const {
