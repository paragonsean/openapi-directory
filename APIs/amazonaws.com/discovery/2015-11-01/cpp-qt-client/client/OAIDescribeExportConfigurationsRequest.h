...
/*
 * OAIDescribeExportConfigurationsRequest.h
 *
 * 
 */

#ifndef OAIDescribeExportConfigurationsRequest_H
#define OAIDescribeExportConfigurationsRequest_H
...
class OAIDescribeExportConfigurationsRequest : public OAIObject {
public:
    OAIDescribeExportConfigurationsRequest();
    OAIDescribeExportConfigurationsRequest(QString json);
    ~OAIDescribeExportConfigurationsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeExportConfigurationsRequest)

#endif // OAIDescribeExportConfigurationsRequest_H
