...
/*
 * OAIStopDataCollectionByAgentIdsResponse.h
 *
 * 
 */

#ifndef OAIStopDataCollectionByAgentIdsResponse_H
#define OAIStopDataCollectionByAgentIdsResponse_H
...
class OAIStopDataCollectionByAgentIdsResponse : public OAIObject {
public:
    OAIStopDataCollectionByAgentIdsResponse();
    OAIStopDataCollectionByAgentIdsResponse(QString json);
    ~OAIStopDataCollectionByAgentIdsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopDataCollectionByAgentIdsResponse)

#endif // OAIStopDataCollectionByAgentIdsResponse_H
