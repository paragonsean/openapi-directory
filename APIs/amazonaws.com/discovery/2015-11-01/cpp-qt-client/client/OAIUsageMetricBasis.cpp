...
OAIUsageMetricBasis::OAIUsageMetricBasis(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUsageMetricBasis::OAIUsageMetricBasis() {
    this->initializeModel();
}

OAIUsageMetricBasis::~OAIUsageMetricBasis() {}

void OAIUsageMetricBasis::initializeModel() {
...
void OAIUsageMetricBasis::fromJson(QString jsonString) {
...
void OAIUsageMetricBasis::fromJsonObject(QJsonObject json) {
...
QString OAIUsageMetricBasis::asJson() const {
...
QJsonObject OAIUsageMetricBasis::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIUsageMetricBasis::getName() const {
    return m_name;
}
void OAIUsageMetricBasis::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUsageMetricBasis::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUsageMetricBasis::is_name_Valid() const{
    return m_name_isValid;
}

double OAIUsageMetricBasis::getPercentageAdjust() const {
    return m_percentage_adjust;
}
void OAIUsageMetricBasis::setPercentageAdjust(const double &percentage_adjust) {
    m_percentage_adjust = percentage_adjust;
    m_percentage_adjust_isSet = true;
}

bool OAIUsageMetricBasis::is_percentage_adjust_Set() const{
    return m_percentage_adjust_isSet;
}

bool OAIUsageMetricBasis::is_percentage_adjust_Valid() const{
    return m_percentage_adjust_isValid;
}

bool OAIUsageMetricBasis::isSet() const {
...
bool OAIUsageMetricBasis::isValid() const {
