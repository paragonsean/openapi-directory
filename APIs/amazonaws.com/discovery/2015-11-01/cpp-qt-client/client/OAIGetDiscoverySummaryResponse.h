...
/*
 * OAIGetDiscoverySummaryResponse.h
 *
 * 
 */

#ifndef OAIGetDiscoverySummaryResponse_H
#define OAIGetDiscoverySummaryResponse_H

#include <QJsonObject>

#include "OAIGetDiscoverySummaryResponse_agentSummary.h"
#include "OAIGetDiscoverySummaryResponse_agentlessCollectorSummary.h"
#include "OAIGetDiscoverySummaryResponse_connectorSummary.h"
...
namespace OpenAPI {
class OAIGetDiscoverySummaryResponse_agentSummary;
class OAIGetDiscoverySummaryResponse_connectorSummary;
class OAIGetDiscoverySummaryResponse_meCollectorSummary;
class OAIGetDiscoverySummaryResponse_agentlessCollectorSummary;

class OAIGetDiscoverySummaryResponse : public OAIObject {
public:
    OAIGetDiscoverySummaryResponse();
    OAIGetDiscoverySummaryResponse(QString json);
    ~OAIGetDiscoverySummaryResponse() override;
    ...
    qint32 getApplications() const;
    void setApplications(const qint32 &applications);
    bool is_applications_Set() const;
    bool is_applications_Valid() const;

    qint32 getServersMappedToApplications() const;
    void setServersMappedToApplications(const qint32 &servers_mapped_to_applications);
    bool is_servers_mapped_to_applications_Set() const;
    bool is_servers_mapped_to_applications_Valid() const;

    qint32 getServersMappedtoTags() const;
    void setServersMappedtoTags(const qint32 &servers_mappedto_tags);
    bool is_servers_mappedto_tags_Set() const;
    bool is_servers_mappedto_tags_Valid() const;

    OAIGetDiscoverySummaryResponse_agentSummary getAgentSummary() const;
    void setAgentSummary(const OAIGetDiscoverySummaryResponse_agentSummary &agent_summary);
    bool is_agent_summary_Set() const;
    bool is_agent_summary_Valid() const;

    OAIGetDiscoverySummaryResponse_connectorSummary getConnectorSummary() const;
    void setConnectorSummary(const OAIGetDiscoverySummaryResponse_connectorSummary &connector_summary);
    bool is_connector_summary_Set() const;
    bool is_connector_summary_Valid() const;

    OAIGetDiscoverySummaryResponse_meCollectorSummary getMeCollectorSummary() const;
    void setMeCollectorSummary(const OAIGetDiscoverySummaryResponse_meCollectorSummary &me_collector_summary);
    bool is_me_collector_summary_Set() const;
    bool is_me_collector_summary_Valid() const;

    OAIGetDiscoverySummaryResponse_agentlessCollectorSummary getAgentlessCollectorSummary() const;
    void setAgentlessCollectorSummary(const OAIGetDiscoverySummaryResponse_agentlessCollectorSummary &agentless_collector_summary);
    bool is_agentless_collector_summary_Set() const;
    bool is_agentless_collector_summary_Valid() const;
...
private:
    ...
    qint32 m_applications;
    bool m_applications_isSet;
    bool m_applications_isValid;

    qint32 m_servers_mapped_to_applications;
    bool m_servers_mapped_to_applications_isSet;
    bool m_servers_mapped_to_applications_isValid;

    qint32 m_servers_mappedto_tags;
    bool m_servers_mappedto_tags_isSet;
    bool m_servers_mappedto_tags_isValid;

    OAIGetDiscoverySummaryResponse_agentSummary m_agent_summary;
    bool m_agent_summary_isSet;
    bool m_agent_summary_isValid;

    OAIGetDiscoverySummaryResponse_connectorSummary m_connector_summary;
    bool m_connector_summary_isSet;
    bool m_connector_summary_isValid;

    OAIGetDiscoverySummaryResponse_meCollectorSummary m_me_collector_summary;
    bool m_me_collector_summary_isSet;
    bool m_me_collector_summary_isValid;

    OAIGetDiscoverySummaryResponse_agentlessCollectorSummary m_agentless_collector_summary;
    bool m_agentless_collector_summary_isSet;
    bool m_agentless_collector_summary_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetDiscoverySummaryResponse)

#endif // OAIGetDiscoverySummaryResponse_H
