...
/*
 * OAIDescribeContinuousExportsRequest.h
 *
 * 
 */

#ifndef OAIDescribeContinuousExportsRequest_H
#define OAIDescribeContinuousExportsRequest_H
...
class OAIDescribeContinuousExportsRequest : public OAIObject {
public:
    OAIDescribeContinuousExportsRequest();
    OAIDescribeContinuousExportsRequest(QString json);
    ~OAIDescribeContinuousExportsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeContinuousExportsRequest)

#endif // OAIDescribeContinuousExportsRequest_H
