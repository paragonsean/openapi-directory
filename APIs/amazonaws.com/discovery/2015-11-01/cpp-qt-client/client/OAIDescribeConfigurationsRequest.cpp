...
OAIDescribeConfigurationsRequest::OAIDescribeConfigurationsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeConfigurationsRequest::OAIDescribeConfigurationsRequest() {
    this->initializeModel();
}

OAIDescribeConfigurationsRequest::~OAIDescribeConfigurationsRequest() {}

void OAIDescribeConfigurationsRequest::initializeModel() {

    m_configuration_ids_isSet = false;
    m_configuration_ids_isValid = false;
}

void OAIDescribeConfigurationsRequest::fromJson(QString jsonString) {
...
void OAIDescribeConfigurationsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeConfigurationsRequest::asJson() const {
...
QJsonObject OAIDescribeConfigurationsRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeConfigurationsRequest::getConfigurationIds() const {
    return m_configuration_ids;
}
void OAIDescribeConfigurationsRequest::setConfigurationIds(const QList &configuration_ids) {
    m_configuration_ids = configuration_ids;
    m_configuration_ids_isSet = true;
}

bool OAIDescribeConfigurationsRequest::is_configuration_ids_Set() const{
    return m_configuration_ids_isSet;
}

bool OAIDescribeConfigurationsRequest::is_configuration_ids_Valid() const{
    return m_configuration_ids_isValid;
}

bool OAIDescribeConfigurationsRequest::isSet() const {
...
bool OAIDescribeConfigurationsRequest::isValid() const {
