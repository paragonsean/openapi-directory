...
/*
 * OAIStartExportTaskRequest_preferences.h
 *
 * 
 */

#ifndef OAIStartExportTaskRequest_preferences_H
#define OAIStartExportTaskRequest_preferences_H
...
namespace OpenAPI {
class OAIExportPreferences_ec2RecommendationsPreferences;

class OAIStartExportTaskRequest_preferences : public OAIObject {
public:
    OAIStartExportTaskRequest_preferences();
    OAIStartExportTaskRequest_preferences(QString json);
    ~OAIStartExportTaskRequest_preferences() override;
    ...
    OAIExportPreferences_ec2RecommendationsPreferences getEc2RecommendationsPreferences() const;
    void setEc2RecommendationsPreferences(const OAIExportPreferences_ec2RecommendationsPreferences &ec2_recommendations_preferences);
    bool is_ec2_recommendations_preferences_Set() const;
    bool is_ec2_recommendations_preferences_Valid() const;
...
private:
    ...
    OAIExportPreferences_ec2RecommendationsPreferences m_ec2_recommendations_preferences;
    bool m_ec2_recommendations_preferences_isSet;
    bool m_ec2_recommendations_preferences_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartExportTaskRequest_preferences)

#endif // OAIStartExportTaskRequest_preferences_H
