...
/*
 * OAIDescribeImportTasksResponse.h
 *
 * 
 */

#ifndef OAIDescribeImportTasksResponse_H
#define OAIDescribeImportTasksResponse_H
...
class OAIDescribeImportTasksResponse : public OAIObject {
public:
    OAIDescribeImportTasksResponse();
    OAIDescribeImportTasksResponse(QString json);
    ~OAIDescribeImportTasksResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeImportTasksResponse)

#endif // OAIDescribeImportTasksResponse_H
