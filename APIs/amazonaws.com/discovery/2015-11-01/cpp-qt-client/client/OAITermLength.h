...
#ifndef OAITermLength_H
#define OAITermLength_H
...
class OAITermLength : public OAIEnum {
public:
    OAITermLength();
    OAITermLength(QString json);
    ~OAITermLength() override;
    ...
    enum class eOAITermLength {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ONE_YEAR, 
        THREE_YEAR
    };
    OAITermLength::eOAITermLength getValue() const;
    void setValue(const OAITermLength::eOAITermLength& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITermLength)

#endif // OAITermLength_H
