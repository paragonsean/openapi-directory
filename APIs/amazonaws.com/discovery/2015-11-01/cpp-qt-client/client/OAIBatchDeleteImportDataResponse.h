...
/*
 * OAIBatchDeleteImportDataResponse.h
 *
 * 
 */

#ifndef OAIBatchDeleteImportDataResponse_H
#define OAIBatchDeleteImportDataResponse_H
...
class OAIBatchDeleteImportDataResponse : public OAIObject {
public:
    OAIBatchDeleteImportDataResponse();
    OAIBatchDeleteImportDataResponse(QString json);
    ~OAIBatchDeleteImportDataResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDeleteImportDataResponse)

#endif // OAIBatchDeleteImportDataResponse_H
