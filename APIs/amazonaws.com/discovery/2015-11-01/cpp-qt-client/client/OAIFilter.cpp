...
QString OAIFilter::getCondition() const {
    return m_condition;
}
void OAIFilter::setCondition(const QString &condition) {
...
bool OAIFilter::isValid() const {
    ...
    return m_name_isValid && m_values_isValid && m_condition_isValid && true;
}
