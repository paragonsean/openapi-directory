...
OAIOrderByElement::OAIOrderByElement(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderByElement::OAIOrderByElement() {
    this->initializeModel();
}

OAIOrderByElement::~OAIOrderByElement() {}

void OAIOrderByElement::initializeModel() {
...
void OAIOrderByElement::fromJson(QString jsonString) {
...
void OAIOrderByElement::fromJsonObject(QJsonObject json) {
...
QString OAIOrderByElement::asJson() const {
...
QJsonObject OAIOrderByElement::asJsonObject() const {
    QJsonObject obj;
...
QString OAIOrderByElement::getFieldName() const {
    return m_field_name;
}
void OAIOrderByElement::setFieldName(const QString &field_name) {
    m_field_name = field_name;
    m_field_name_isSet = true;
}

bool OAIOrderByElement::is_field_name_Set() const{
    return m_field_name_isSet;
}

bool OAIOrderByElement::is_field_name_Valid() const{
    return m_field_name_isValid;
}

OAIOrderString OAIOrderByElement::getSortOrder() const {
    return m_sort_order;
}
void OAIOrderByElement::setSortOrder(const OAIOrderString &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIOrderByElement::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIOrderByElement::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

bool OAIOrderByElement::isSet() const {
...
bool OAIOrderByElement::isValid() const {
