...
QString OAIExportFilter::getName() const {
    return m_name;
}
void OAIExportFilter::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}
...
QString OAIExportFilter::getCondition() const {
    return m_condition;
}
void OAIExportFilter::setCondition(const QString &condition) {
    m_condition = condition;
    m_condition_isSet = true;
}

bool OAIExportFilter::is_condition_Set() const{
    return m_condition_isSet;
}

bool OAIExportFilter::is_condition_Valid() const{
