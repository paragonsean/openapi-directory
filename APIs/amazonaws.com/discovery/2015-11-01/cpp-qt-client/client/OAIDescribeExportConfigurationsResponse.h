...
/*
 * OAIDescribeExportConfigurationsResponse.h
 *
 * 
 */

#ifndef OAIDescribeExportConfigurationsResponse_H
#define OAIDescribeExportConfigurationsResponse_H
...
class OAIDescribeExportConfigurationsResponse : public OAIObject {
public:
    OAIDescribeExportConfigurationsResponse();
    OAIDescribeExportConfigurationsResponse(QString json);
    ~OAIDescribeExportConfigurationsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeExportConfigurationsResponse)

#endif // OAIDescribeExportConfigurationsResponse_H
