...
OAIPurchasingOption::OAIPurchasingOption(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPurchasingOption::OAIPurchasingOption() {
    this->initializeModel();
}

OAIPurchasingOption::~OAIPurchasingOption() {}

void OAIPurchasingOption::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPurchasingOption::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPurchasingOption::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ALL_UPFRONT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPurchasingOption::ALL_UPFRONT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PARTIAL_UPFRONT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPurchasingOption::PARTIAL_UPFRONT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NO_UPFRONT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPurchasingOption::NO_UPFRONT;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPurchasingOption::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPurchasingOption::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPurchasingOption::ALL_UPFRONT:
            val = "ALL_UPFRONT";
            break;
        case eOAIPurchasingOption::PARTIAL_UPFRONT:
            val = "PARTIAL_UPFRONT";
            break;
        case eOAIPurchasingOption::NO_UPFRONT:
            val = "NO_UPFRONT";
            break;
        default:
            break;
...
QJsonValue OAIPurchasingOption::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPurchasingOption::eOAIPurchasingOption OAIPurchasingOption::getValue() const {
    return m_value;
}

void OAIPurchasingOption::setValue(const OAIPurchasingOption::eOAIPurchasingOption& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPurchasingOption::isSet() const {
    
    return m_value_isSet;
}

bool OAIPurchasingOption::isValid() const {
