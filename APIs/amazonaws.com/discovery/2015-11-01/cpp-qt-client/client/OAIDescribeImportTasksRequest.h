...
/*
 * OAIDescribeImportTasksRequest.h
 *
 * 
 */

#ifndef OAIDescribeImportTasksRequest_H
#define OAIDescribeImportTasksRequest_H
...
class OAIDescribeImportTasksRequest : public OAIObject {
public:
    OAIDescribeImportTasksRequest();
    OAIDescribeImportTasksRequest(QString json);
    ~OAIDescribeImportTasksRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeImportTasksRequest)

#endif // OAIDescribeImportTasksRequest_H
