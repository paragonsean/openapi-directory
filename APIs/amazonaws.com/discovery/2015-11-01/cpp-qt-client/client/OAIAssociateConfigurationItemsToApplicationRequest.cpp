...
OAIAssociateConfigurationItemsToApplicationRequest::OAIAssociateConfigurationItemsToApplicationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateConfigurationItemsToApplicationRequest::OAIAssociateConfigurationItemsToApplicationRequest() {
    this->initializeModel();
}

OAIAssociateConfigurationItemsToApplicationRequest::~OAIAssociateConfigurationItemsToApplicationRequest() {}

void OAIAssociateConfigurationItemsToApplicationRequest::initializeModel() {
...
void OAIAssociateConfigurationItemsToApplicationRequest::fromJson(QString jsonString) {
...
void OAIAssociateConfigurationItemsToApplicationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateConfigurationItemsToApplicationRequest::asJson() const {
...
QJsonObject OAIAssociateConfigurationItemsToApplicationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateConfigurationItemsToApplicationRequest::getApplicationConfigurationId() const {
    return m_application_configuration_id;
}
void OAIAssociateConfigurationItemsToApplicationRequest::setApplicationConfigurationId(const QString &application_configuration_id) {
    m_application_configuration_id = application_configuration_id;
    m_application_configuration_id_isSet = true;
}

bool OAIAssociateConfigurationItemsToApplicationRequest::is_application_configuration_id_Set() const{
    return m_application_configuration_id_isSet;
}

bool OAIAssociateConfigurationItemsToApplicationRequest::is_application_configuration_id_Valid() const{
    return m_application_configuration_id_isValid;
}

QList OAIAssociateConfigurationItemsToApplicationRequest::getConfigurationIds() const {
    return m_configuration_ids;
}
void OAIAssociateConfigurationItemsToApplicationRequest::setConfigurationIds(const QList &configuration_ids) {
    m_configuration_ids = configuration_ids;
    m_configuration_ids_isSet = true;
}

bool OAIAssociateConfigurationItemsToApplicationRequest::is_configuration_ids_Set() const{
    return m_configuration_ids_isSet;
}

bool OAIAssociateConfigurationItemsToApplicationRequest::is_configuration_ids_Valid() const{
    return m_configuration_ids_isValid;
}

bool OAIAssociateConfigurationItemsToApplicationRequest::isSet() const {
...
bool OAIAssociateConfigurationItemsToApplicationRequest::isValid() const {
