...
QString OAIDescribeTagsResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeTagsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeTagsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeTagsResponse::is_next_token_Valid() const{
