...
OAIStopContinuousExportResponse::OAIStopContinuousExportResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopContinuousExportResponse::OAIStopContinuousExportResponse() {
    this->initializeModel();
}

OAIStopContinuousExportResponse::~OAIStopContinuousExportResponse() {}

void OAIStopContinuousExportResponse::initializeModel() {
...
void OAIStopContinuousExportResponse::fromJson(QString jsonString) {
...
void OAIStopContinuousExportResponse::fromJsonObject(QJsonObject json) {
...
QString OAIStopContinuousExportResponse::asJson() const {
...
QJsonObject OAIStopContinuousExportResponse::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIStopContinuousExportResponse::getStartTime() const {
    return m_start_time;
}
void OAIStopContinuousExportResponse::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIStopContinuousExportResponse::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIStopContinuousExportResponse::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QDateTime OAIStopContinuousExportResponse::getStopTime() const {
    return m_stop_time;
}
void OAIStopContinuousExportResponse::setStopTime(const QDateTime &stop_time) {
    m_stop_time = stop_time;
    m_stop_time_isSet = true;
}

bool OAIStopContinuousExportResponse::is_stop_time_Set() const{
    return m_stop_time_isSet;
}

bool OAIStopContinuousExportResponse::is_stop_time_Valid() const{
    return m_stop_time_isValid;
}

bool OAIStopContinuousExportResponse::isSet() const {
...
bool OAIStopContinuousExportResponse::isValid() const {
