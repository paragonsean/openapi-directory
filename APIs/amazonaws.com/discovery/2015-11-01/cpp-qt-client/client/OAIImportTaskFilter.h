...
#ifndef OAIImportTaskFilter_H
#define OAIImportTaskFilter_H
...
class OAIImportTaskFilter : public OAIObject {
public:
    OAIImportTaskFilter();
    OAIImportTaskFilter(QString json);
    ~OAIImportTaskFilter() override;
    ...
    OAIImportTaskFilterName getName() const;
    void setName(const OAIImportTaskFilterName &name);
...
private:
    ...
    OAIImportTaskFilterName m_name;
    bool m_name_isSet;
    bool m_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportTaskFilter)

#endif // OAIImportTaskFilter_H
