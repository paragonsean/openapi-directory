...
/*
 * OAICustomerAgentlessCollectorInfo.h
 *
 * The inventory data for installed Agentless Collector collectors. 
 */

#ifndef OAICustomerAgentlessCollectorInfo_H
#define OAICustomerAgentlessCollectorInfo_H
...
class OAICustomerAgentlessCollectorInfo : public OAIObject {
public:
    OAICustomerAgentlessCollectorInfo();
    OAICustomerAgentlessCollectorInfo(QString json);
    ~OAICustomerAgentlessCollectorInfo() override;
    ...
    qint32 getActiveAgentlessCollectors() const;
    void setActiveAgentlessCollectors(const qint32 &active_agentless_collectors);
    bool is_active_agentless_collectors_Set() const;
    bool is_active_agentless_collectors_Valid() const;

    qint32 getHealthyAgentlessCollectors() const;
    void setHealthyAgentlessCollectors(const qint32 &healthy_agentless_collectors);
    bool is_healthy_agentless_collectors_Set() const;
    bool is_healthy_agentless_collectors_Valid() const;

    qint32 getDenyListedAgentlessCollectors() const;
    void setDenyListedAgentlessCollectors(const qint32 &deny_listed_agentless_collectors);
    bool is_deny_listed_agentless_collectors_Set() const;
    bool is_deny_listed_agentless_collectors_Valid() const;

    qint32 getShutdownAgentlessCollectors() const;
    void setShutdownAgentlessCollectors(const qint32 &shutdown_agentless_collectors);
    bool is_shutdown_agentless_collectors_Set() const;
    bool is_shutdown_agentless_collectors_Valid() const;

    qint32 getUnhealthyAgentlessCollectors() const;
    void setUnhealthyAgentlessCollectors(const qint32 &unhealthy_agentless_collectors);
    bool is_unhealthy_agentless_collectors_Set() const;
    bool is_unhealthy_agentless_collectors_Valid() const;

    qint32 getTotalAgentlessCollectors() const;
    void setTotalAgentlessCollectors(const qint32 &total_agentless_collectors);
    bool is_total_agentless_collectors_Set() const;
    bool is_total_agentless_collectors_Valid() const;

    qint32 getUnknownAgentlessCollectors() const;
    void setUnknownAgentlessCollectors(const qint32 &unknown_agentless_collectors);
    bool is_unknown_agentless_collectors_Set() const;
    bool is_unknown_agentless_collectors_Valid() const;
...
private:
    ...
    qint32 m_active_agentless_collectors;
    bool m_active_agentless_collectors_isSet;
    bool m_active_agentless_collectors_isValid;

    qint32 m_healthy_agentless_collectors;
    bool m_healthy_agentless_collectors_isSet;
    bool m_healthy_agentless_collectors_isValid;

    qint32 m_deny_listed_agentless_collectors;
    bool m_deny_listed_agentless_collectors_isSet;
    bool m_deny_listed_agentless_collectors_isValid;

    qint32 m_shutdown_agentless_collectors;
    bool m_shutdown_agentless_collectors_isSet;
    bool m_shutdown_agentless_collectors_isValid;

    qint32 m_unhealthy_agentless_collectors;
    bool m_unhealthy_agentless_collectors_isSet;
    bool m_unhealthy_agentless_collectors_isValid;

    qint32 m_total_agentless_collectors;
    bool m_total_agentless_collectors_isSet;
    bool m_total_agentless_collectors_isValid;

    qint32 m_unknown_agentless_collectors;
    bool m_unknown_agentless_collectors_isSet;
    bool m_unknown_agentless_collectors_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICustomerAgentlessCollectorInfo)

#endif // OAICustomerAgentlessCollectorInfo_H
