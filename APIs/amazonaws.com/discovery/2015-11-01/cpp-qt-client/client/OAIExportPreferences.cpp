...
#include "OAIExportPreferences.h"
...
OAIExportPreferences::OAIExportPreferences(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExportPreferences::OAIExportPreferences() {
    this->initializeModel();
}

OAIExportPreferences::~OAIExportPreferences() {}

void OAIExportPreferences::initializeModel() {

    m_ec2_recommendations_preferences_isSet = false;
    m_ec2_recommendations_preferences_isValid = false;
}

void OAIExportPreferences::fromJson(QString jsonString) {
...
void OAIExportPreferences::fromJsonObject(QJsonObject json) {

    m_ec2_recommendations_preferences_isValid = ::OpenAPI::fromJsonValue(m_ec2_recommendations_preferences, json[QString("ec2RecommendationsPreferences")]);
    m_ec2_recommendations_preferences_isSet = !json[QString("ec2RecommendationsPreferences")].isNull() && m_ec2_recommendations_preferences_isValid;
}

QString OAIExportPreferences::asJson() const {
...
QJsonObject OAIExportPreferences::asJsonObject() const {
    QJsonObject obj;
    if (m_ec2_recommendations_preferences.isSet()) {
        obj.insert(QString("ec2RecommendationsPreferences"), ::OpenAPI::toJsonValue(m_ec2_recommendations_preferences));
    }
    return obj;
}

OAIExportPreferences_ec2RecommendationsPreferences OAIExportPreferences::getEc2RecommendationsPreferences() const {
    return m_ec2_recommendations_preferences;
}
void OAIExportPreferences::setEc2RecommendationsPreferences(const OAIExportPreferences_ec2RecommendationsPreferences &ec2_recommendations_preferences) {
    m_ec2_recommendations_preferences = ec2_recommendations_preferences;
    m_ec2_recommendations_preferences_isSet = true;
}

bool OAIExportPreferences::is_ec2_recommendations_preferences_Set() const{
    return m_ec2_recommendations_preferences_isSet;
}

bool OAIExportPreferences::is_ec2_recommendations_preferences_Valid() const{
    return m_ec2_recommendations_preferences_isValid;
}

bool OAIExportPreferences::isSet() const {
...
bool OAIExportPreferences::isValid() const {
