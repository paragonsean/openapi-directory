...
OAITermLength::OAITermLength(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITermLength::OAITermLength() {
    this->initializeModel();
}

OAITermLength::~OAITermLength() {}

void OAITermLength::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITermLength::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITermLength::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ONE_YEAR", Qt::CaseInsensitive) == 0) {
        m_value = eOAITermLength::ONE_YEAR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("THREE_YEAR", Qt::CaseInsensitive) == 0) {
        m_value = eOAITermLength::THREE_YEAR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITermLength::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITermLength::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITermLength::ONE_YEAR:
            val = "ONE_YEAR";
            break;
        case eOAITermLength::THREE_YEAR:
            val = "THREE_YEAR";
            break;
        default:
            break;
...
QJsonValue OAITermLength::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITermLength::eOAITermLength OAITermLength::getValue() const {
    return m_value;
}

void OAITermLength::setValue(const OAITermLength::eOAITermLength& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITermLength::isSet() const {
    
    return m_value_isSet;
}

bool OAITermLength::isValid() const {
