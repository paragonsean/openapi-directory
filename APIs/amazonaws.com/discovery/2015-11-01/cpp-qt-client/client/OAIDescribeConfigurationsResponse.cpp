...
OAIDescribeConfigurationsResponse::OAIDescribeConfigurationsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeConfigurationsResponse::OAIDescribeConfigurationsResponse() {
    this->initializeModel();
}

OAIDescribeConfigurationsResponse::~OAIDescribeConfigurationsResponse() {}

void OAIDescribeConfigurationsResponse::initializeModel() {

    m_configurations_isSet = false;
    m_configurations_isValid = false;
}

void OAIDescribeConfigurationsResponse::fromJson(QString jsonString) {
...
void OAIDescribeConfigurationsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeConfigurationsResponse::asJson() const {
...
QJsonObject OAIDescribeConfigurationsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeConfigurationsResponse::getConfigurations() const {
    return m_configurations;
}
void OAIDescribeConfigurationsResponse::setConfigurations(const QList &configurations) {
    m_configurations = configurations;
    m_configurations_isSet = true;
}

bool OAIDescribeConfigurationsResponse::is_configurations_Set() const{
    return m_configurations_isSet;
}

bool OAIDescribeConfigurationsResponse::is_configurations_Valid() const{
    return m_configurations_isValid;
}

bool OAIDescribeConfigurationsResponse::isSet() const {
...
bool OAIDescribeConfigurationsResponse::isValid() const {
