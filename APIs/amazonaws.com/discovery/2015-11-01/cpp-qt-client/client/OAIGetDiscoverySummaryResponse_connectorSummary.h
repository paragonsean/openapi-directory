...
/*
 * OAIGetDiscoverySummaryResponse_connectorSummary.h
 *
 * 
 */

#ifndef OAIGetDiscoverySummaryResponse_connectorSummary_H
#define OAIGetDiscoverySummaryResponse_connectorSummary_H
...
class OAIGetDiscoverySummaryResponse_connectorSummary : public OAIObject {
public:
    OAIGetDiscoverySummaryResponse_connectorSummary();
    OAIGetDiscoverySummaryResponse_connectorSummary(QString json);
    ~OAIGetDiscoverySummaryResponse_connectorSummary() override;
    ...
    qint32 getActiveConnectors() const;
    void setActiveConnectors(const qint32 &active_connectors);
    bool is_active_connectors_Set() const;
    bool is_active_connectors_Valid() const;

    qint32 getHealthyConnectors() const;
    void setHealthyConnectors(const qint32 &healthy_connectors);
    bool is_healthy_connectors_Set() const;
    bool is_healthy_connectors_Valid() const;

    qint32 getBlackListedConnectors() const;
    void setBlackListedConnectors(const qint32 &black_listed_connectors);
    bool is_black_listed_connectors_Set() const;
    bool is_black_listed_connectors_Valid() const;

    qint32 getShutdownConnectors() const;
    void setShutdownConnectors(const qint32 &shutdown_connectors);
    bool is_shutdown_connectors_Set() const;
    bool is_shutdown_connectors_Valid() const;

    qint32 getUnhealthyConnectors() const;
    void setUnhealthyConnectors(const qint32 &unhealthy_connectors);
    bool is_unhealthy_connectors_Set() const;
    bool is_unhealthy_connectors_Valid() const;

    qint32 getTotalConnectors() const;
    void setTotalConnectors(const qint32 &total_connectors);
    bool is_total_connectors_Set() const;
    bool is_total_connectors_Valid() const;

    qint32 getUnknownConnectors() const;
    void setUnknownConnectors(const qint32 &unknown_connectors);
    bool is_unknown_connectors_Set() const;
    bool is_unknown_connectors_Valid() const;
...
private:
    ...
    qint32 m_active_connectors;
    bool m_active_connectors_isSet;
    bool m_active_connectors_isValid;

    qint32 m_healthy_connectors;
    bool m_healthy_connectors_isSet;
    bool m_healthy_connectors_isValid;

    qint32 m_black_listed_connectors;
    bool m_black_listed_connectors_isSet;
    bool m_black_listed_connectors_isValid;

    qint32 m_shutdown_connectors;
    bool m_shutdown_connectors_isSet;
    bool m_shutdown_connectors_isValid;

    qint32 m_unhealthy_connectors;
    bool m_unhealthy_connectors_isSet;
    bool m_unhealthy_connectors_isValid;

    qint32 m_total_connectors;
    bool m_total_connectors_isSet;
    bool m_total_connectors_isValid;

    qint32 m_unknown_connectors;
    bool m_unknown_connectors_isSet;
    bool m_unknown_connectors_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetDiscoverySummaryResponse_connectorSummary)

#endif // OAIGetDiscoverySummaryResponse_connectorSummary_H
