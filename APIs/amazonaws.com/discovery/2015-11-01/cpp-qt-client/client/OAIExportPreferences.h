...
#ifndef OAIExportPreferences_H
#define OAIExportPreferences_H
...
class OAIExportPreferences : public OAIObject {
public:
    OAIExportPreferences();
    OAIExportPreferences(QString json);
    ~OAIExportPreferences() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportPreferences)

#endif // OAIExportPreferences_H
