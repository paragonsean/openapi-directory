...
/*
 * OAIDisassociateConfigurationItemsFromApplicationRequest.h
 *
 * 
 */

#ifndef OAIDisassociateConfigurationItemsFromApplicationRequest_H
#define OAIDisassociateConfigurationItemsFromApplicationRequest_H
...
class OAIDisassociateConfigurationItemsFromApplicationRequest : public OAIObject {
public:
    OAIDisassociateConfigurationItemsFromApplicationRequest();
    OAIDisassociateConfigurationItemsFromApplicationRequest(QString json);
    ~OAIDisassociateConfigurationItemsFromApplicationRequest() override;
    ...
    QString getApplicationConfigurationId() const;
    void setApplicationConfigurationId(const QString &application_configuration_id);
    bool is_application_configuration_id_Set() const;
    bool is_application_configuration_id_Valid() const;
...
private:
    ...
    QString m_application_configuration_id;
    bool m_application_configuration_id_isSet;
    bool m_application_configuration_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateConfigurationItemsFromApplicationRequest)

#endif // OAIDisassociateConfigurationItemsFromApplicationRequest_H
