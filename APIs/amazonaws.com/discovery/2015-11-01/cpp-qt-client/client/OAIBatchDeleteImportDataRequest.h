...
/*
 * OAIBatchDeleteImportDataRequest.h
 *
 * 
 */

#ifndef OAIBatchDeleteImportDataRequest_H
#define OAIBatchDeleteImportDataRequest_H
...
class OAIBatchDeleteImportDataRequest : public OAIObject {
public:
    OAIBatchDeleteImportDataRequest();
    OAIBatchDeleteImportDataRequest(QString json);
    ~OAIBatchDeleteImportDataRequest() override;
    ...
    QList getImportTaskIds() const;
    void setImportTaskIds(const QList &import_task_ids);
    bool is_import_task_ids_Set() const;
    bool is_import_task_ids_Valid() const;
...
private:
    ...
    QList m_import_task_ids;
    bool m_import_task_ids_isSet;
    bool m_import_task_ids_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBatchDeleteImportDataRequest)

#endif // OAIBatchDeleteImportDataRequest_H
