...
#ifndef OAIAgentConfigurationStatus_H
#define OAIAgentConfigurationStatus_H
...
class OAIAgentConfigurationStatus : public OAIObject {
public:
    OAIAgentConfigurationStatus();
    OAIAgentConfigurationStatus(QString json);
    ~OAIAgentConfigurationStatus() override;
    ...
    void setOperationSucceeded(const bool &operation_succeeded);
    bool is_operation_succeeded_Set() const;
    bool is_operation_succeeded_Valid() const;
...
private:
    ...
    bool m_operation_succeeded_isSet;
    bool m_operation_succeeded_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAgentConfigurationStatus)

#endif // OAIAgentConfigurationStatus_H
