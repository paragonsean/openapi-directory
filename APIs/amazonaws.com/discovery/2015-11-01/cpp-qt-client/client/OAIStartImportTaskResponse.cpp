...
OAIStartImportTaskResponse::OAIStartImportTaskResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartImportTaskResponse::OAIStartImportTaskResponse() {
    this->initializeModel();
}

OAIStartImportTaskResponse::~OAIStartImportTaskResponse() {}

void OAIStartImportTaskResponse::initializeModel() {

    m_task_isSet = false;
    m_task_isValid = false;
}

void OAIStartImportTaskResponse::fromJson(QString jsonString) {
...
QJsonObject OAIStartImportTaskResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_task.isSet()) {
...
OAIStartImportTaskResponse_task OAIStartImportTaskResponse::getTask() const {
    return m_task;
}
void OAIStartImportTaskResponse::setTask(const OAIStartImportTaskResponse_task &task) {
    m_task = task;
    m_task_isSet = true;
}

bool OAIStartImportTaskResponse::is_task_Set() const{
    return m_task_isSet;
}

bool OAIStartImportTaskResponse::is_task_Valid() const{
    return m_task_isValid;
}

bool OAIStartImportTaskResponse::isSet() const {
...
bool OAIStartImportTaskResponse::isValid() const {
