...
OAIDescribeExportTasksRequest::OAIDescribeExportTasksRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeExportTasksRequest::OAIDescribeExportTasksRequest() {
    this->initializeModel();
}

OAIDescribeExportTasksRequest::~OAIDescribeExportTasksRequest() {}

void OAIDescribeExportTasksRequest::initializeModel() {
...
void OAIDescribeExportTasksRequest::fromJson(QString jsonString) {
...
void OAIDescribeExportTasksRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeExportTasksRequest::asJson() const {
...
QJsonObject OAIDescribeExportTasksRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeExportTasksRequest::getExportIds() const {
    return m_export_ids;
}
void OAIDescribeExportTasksRequest::setExportIds(const QList &export_ids) {
    m_export_ids = export_ids;
    m_export_ids_isSet = true;
}

bool OAIDescribeExportTasksRequest::is_export_ids_Set() const{
    return m_export_ids_isSet;
}

bool OAIDescribeExportTasksRequest::is_export_ids_Valid() const{
    return m_export_ids_isValid;
}

QList OAIDescribeExportTasksRequest::getFilters() const {
    return m_filters;
}
void OAIDescribeExportTasksRequest::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIDescribeExportTasksRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIDescribeExportTasksRequest::is_filters_Valid() const{
    return m_filters_isValid;
}

qint32 OAIDescribeExportTasksRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeExportTasksRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeExportTasksRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeExportTasksRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeExportTasksRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeExportTasksRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeExportTasksRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeExportTasksRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeExportTasksRequest::isSet() const {
...
bool OAIDescribeExportTasksRequest::isValid() const {
