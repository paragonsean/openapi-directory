...
/*
 * OAIDescribeExportTasksRequest.h
 *
 * 
 */

#ifndef OAIDescribeExportTasksRequest_H
#define OAIDescribeExportTasksRequest_H
...
class OAIDescribeExportTasksRequest : public OAIObject {
public:
    OAIDescribeExportTasksRequest();
    OAIDescribeExportTasksRequest(QString json);
    ~OAIDescribeExportTasksRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeExportTasksRequest)

#endif // OAIDescribeExportTasksRequest_H
