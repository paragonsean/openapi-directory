...
OAIDescribeExportConfigurationsResponse::OAIDescribeExportConfigurationsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeExportConfigurationsResponse::OAIDescribeExportConfigurationsResponse() {
    this->initializeModel();
}

OAIDescribeExportConfigurationsResponse::~OAIDescribeExportConfigurationsResponse() {}

void OAIDescribeExportConfigurationsResponse::initializeModel() {

    m_exports_info_isSet = false;
    m_exports_info_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIDescribeExportConfigurationsResponse::fromJson(QString jsonString) {
...
void OAIDescribeExportConfigurationsResponse::fromJsonObject(QJsonObject json) {

    m_exports_info_isValid = ::OpenAPI::fromJsonValue(m_exports_info, json[QString("exportsInfo")]);
    m_exports_info_isSet = !json[QString("exportsInfo")].isNull() && m_exports_info_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIDescribeExportConfigurationsResponse::asJson() const {
...
QJsonObject OAIDescribeExportConfigurationsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_exports_info.isSet()) {
        obj.insert(QString("exportsInfo"), ::OpenAPI::toJsonValue(m_exports_info));
    }
...
QList OAIDescribeExportConfigurationsResponse::getExportsInfo() const {
    return m_exports_info;
}
void OAIDescribeExportConfigurationsResponse::setExportsInfo(const QList &exports_info) {
    m_exports_info = exports_info;
    m_exports_info_isSet = true;
}

bool OAIDescribeExportConfigurationsResponse::is_exports_info_Set() const{
    return m_exports_info_isSet;
}

bool OAIDescribeExportConfigurationsResponse::is_exports_info_Valid() const{
    return m_exports_info_isValid;
}

QString OAIDescribeExportConfigurationsResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeExportConfigurationsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeExportConfigurationsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeExportConfigurationsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeExportConfigurationsResponse::isSet() const {
...
bool OAIDescribeExportConfigurationsResponse::isValid() const {
