...
OAIStartExportTaskRequest_preferences::OAIStartExportTaskRequest_preferences(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartExportTaskRequest_preferences::OAIStartExportTaskRequest_preferences() {
    this->initializeModel();
}

OAIStartExportTaskRequest_preferences::~OAIStartExportTaskRequest_preferences() {}

void OAIStartExportTaskRequest_preferences::initializeModel() {

    m_ec2_recommendations_preferences_isSet = false;
    m_ec2_recommendations_preferences_isValid = false;
}

void OAIStartExportTaskRequest_preferences::fromJson(QString jsonString) {
...
void OAIStartExportTaskRequest_preferences::fromJsonObject(QJsonObject json) {
...
QString OAIStartExportTaskRequest_preferences::asJson() const {
...
QJsonObject OAIStartExportTaskRequest_preferences::asJsonObject() const {
    QJsonObject obj;
...
OAIExportPreferences_ec2RecommendationsPreferences OAIStartExportTaskRequest_preferences::getEc2RecommendationsPreferences() const {
    return m_ec2_recommendations_preferences;
}
void OAIStartExportTaskRequest_preferences::setEc2RecommendationsPreferences(const OAIExportPreferences_ec2RecommendationsPreferences &ec2_recommendations_preferences) {
    m_ec2_recommendations_preferences = ec2_recommendations_preferences;
    m_ec2_recommendations_preferences_isSet = true;
}

bool OAIStartExportTaskRequest_preferences::is_ec2_recommendations_preferences_Set() const{
    return m_ec2_recommendations_preferences_isSet;
}

bool OAIStartExportTaskRequest_preferences::is_ec2_recommendations_preferences_Valid() const{
    return m_ec2_recommendations_preferences_isValid;
}

bool OAIStartExportTaskRequest_preferences::isSet() const {
...
bool OAIStartExportTaskRequest_preferences::isValid() const {
