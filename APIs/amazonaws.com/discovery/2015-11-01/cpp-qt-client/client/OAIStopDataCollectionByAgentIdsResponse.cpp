...
OAIStopDataCollectionByAgentIdsResponse::OAIStopDataCollectionByAgentIdsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopDataCollectionByAgentIdsResponse::OAIStopDataCollectionByAgentIdsResponse() {
    this->initializeModel();
}

OAIStopDataCollectionByAgentIdsResponse::~OAIStopDataCollectionByAgentIdsResponse() {}

void OAIStopDataCollectionByAgentIdsResponse::initializeModel() {

    m_agents_configuration_status_isSet = false;
    m_agents_configuration_status_isValid = false;
}

void OAIStopDataCollectionByAgentIdsResponse::fromJson(QString jsonString) {
...
void OAIStopDataCollectionByAgentIdsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIStopDataCollectionByAgentIdsResponse::asJson() const {
...
QJsonObject OAIStopDataCollectionByAgentIdsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIStopDataCollectionByAgentIdsResponse::getAgentsConfigurationStatus() const {
    return m_agents_configuration_status;
}
void OAIStopDataCollectionByAgentIdsResponse::setAgentsConfigurationStatus(const QList &agents_configuration_status) {
    m_agents_configuration_status = agents_configuration_status;
    m_agents_configuration_status_isSet = true;
}

bool OAIStopDataCollectionByAgentIdsResponse::is_agents_configuration_status_Set() const{
    return m_agents_configuration_status_isSet;
}

bool OAIStopDataCollectionByAgentIdsResponse::is_agents_configuration_status_Valid() const{
    return m_agents_configuration_status_isValid;
}

bool OAIStopDataCollectionByAgentIdsResponse::isSet() const {
...
bool OAIStopDataCollectionByAgentIdsResponse::isValid() const {
