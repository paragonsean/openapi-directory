...
QString OAITagFilter::getName() const {
    return m_name;
}
void OAITagFilter::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAITagFilter::is_name_Set() const{
    return m_name_isSet;
}

bool OAITagFilter::is_name_Valid() const{
