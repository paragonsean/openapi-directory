...
OAIDescribeImportTasksResponse::OAIDescribeImportTasksResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeImportTasksResponse::OAIDescribeImportTasksResponse() {
    this->initializeModel();
}

OAIDescribeImportTasksResponse::~OAIDescribeImportTasksResponse() {}

void OAIDescribeImportTasksResponse::initializeModel() {
...
void OAIDescribeImportTasksResponse::fromJson(QString jsonString) {
...
void OAIDescribeImportTasksResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeImportTasksResponse::asJson() const {
...
QJsonObject OAIDescribeImportTasksResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeImportTasksResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeImportTasksResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeImportTasksResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeImportTasksResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIDescribeImportTasksResponse::getTasks() const {
    return m_tasks;
}
void OAIDescribeImportTasksResponse::setTasks(const QList &tasks) {
    m_tasks = tasks;
    m_tasks_isSet = true;
}

bool OAIDescribeImportTasksResponse::is_tasks_Set() const{
    return m_tasks_isSet;
}

bool OAIDescribeImportTasksResponse::is_tasks_Valid() const{
    return m_tasks_isValid;
}

bool OAIDescribeImportTasksResponse::isSet() const {
...
bool OAIDescribeImportTasksResponse::isValid() const {
