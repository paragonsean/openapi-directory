...
#ifndef OAIOrderByElement_H
#define OAIOrderByElement_H
...
class OAIOrderByElement : public OAIObject {
public:
    OAIOrderByElement();
    OAIOrderByElement(QString json);
    ~OAIOrderByElement() override;
    ...
    OAIOrderString getSortOrder() const;
    void setSortOrder(const OAIOrderString &sort_order);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderByElement)

#endif // OAIOrderByElement_H
