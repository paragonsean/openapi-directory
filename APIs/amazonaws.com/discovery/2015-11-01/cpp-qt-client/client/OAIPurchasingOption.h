...
/*
 * OAIPurchasingOption.h
 *
 * 
 */

#ifndef OAIPurchasingOption_H
#define OAIPurchasingOption_H
...
class OAIPurchasingOption : public OAIEnum {
public:
    OAIPurchasingOption();
    OAIPurchasingOption(QString json);
    ~OAIPurchasingOption() override;
    ...
    enum class eOAIPurchasingOption {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ALL_UPFRONT, 
        PARTIAL_UPFRONT, 
        NO_UPFRONT
    };
    OAIPurchasingOption::eOAIPurchasingOption getValue() const;
    void setValue(const OAIPurchasingOption::eOAIPurchasingOption& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPurchasingOption)

#endif // OAIPurchasingOption_H
