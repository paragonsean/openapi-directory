...
/*
 * OAINeighborConnectionDetail.h
 *
 * Details about neighboring servers.
 */

#ifndef OAINeighborConnectionDetail_H
#define OAINeighborConnectionDetail_H
...
class OAINeighborConnectionDetail : public OAIObject {
public:
    OAINeighborConnectionDetail();
    OAINeighborConnectionDetail(QString json);
    ~OAINeighborConnectionDetail() override;
    ...
    QString getDestinationServerId() const;
    void setDestinationServerId(const QString &destination_server_id);
    ...
    qint32 getConnectionsCount() const;
    void setConnectionsCount(const qint32 &connections_count);
    bool is_connections_count_Set() const;
    bool is_connections_count_Valid() const;
...
private:
    ...
    QString m_destination_server_id;
    ...
    qint32 m_connections_count;
    bool m_connections_count_isSet;
    bool m_connections_count_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAINeighborConnectionDetail)

#endif // OAINeighborConnectionDetail_H
