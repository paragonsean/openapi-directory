...
/*
 * OAIDescribeAgentsResponse.h
 *
 * 
 */

#ifndef OAIDescribeAgentsResponse_H
#define OAIDescribeAgentsResponse_H
...
class OAIDescribeAgentsResponse : public OAIObject {
public:
    OAIDescribeAgentsResponse();
    OAIDescribeAgentsResponse(QString json);
    ~OAIDescribeAgentsResponse() override;
    ...
    QList getAgentsInfo() const;
    void setAgentsInfo(const QList &agents_info);
    bool is_agents_info_Set() const;
    bool is_agents_info_Valid() const;
...
private:
    ...
    QList m_agents_info;
    bool m_agents_info_isSet;
    bool m_agents_info_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAgentsResponse)

#endif // OAIDescribeAgentsResponse_H
