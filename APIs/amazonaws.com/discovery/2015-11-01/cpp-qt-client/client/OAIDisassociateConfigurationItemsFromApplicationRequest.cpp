...
OAIDisassociateConfigurationItemsFromApplicationRequest::OAIDisassociateConfigurationItemsFromApplicationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateConfigurationItemsFromApplicationRequest::OAIDisassociateConfigurationItemsFromApplicationRequest() {
    this->initializeModel();
}

OAIDisassociateConfigurationItemsFromApplicationRequest::~OAIDisassociateConfigurationItemsFromApplicationRequest() {}

void OAIDisassociateConfigurationItemsFromApplicationRequest::initializeModel() {

    m_application_configuration_id_isSet = false;
    m_application_configuration_id_isValid = false;

    m_configuration_ids_isSet = false;
    m_configuration_ids_isValid = false;
}

void OAIDisassociateConfigurationItemsFromApplicationRequest::fromJson(QString jsonString) {
...
void OAIDisassociateConfigurationItemsFromApplicationRequest::fromJsonObject(QJsonObject json) {

    m_application_configuration_id_isValid = ::OpenAPI::fromJsonValue(m_application_configuration_id, json[QString("applicationConfigurationId")]);
    m_application_configuration_id_isSet = !json[QString("applicationConfigurationId")].isNull() && m_application_configuration_id_isValid;

    m_configuration_ids_isValid = ::OpenAPI::fromJsonValue(m_configuration_ids, json[QString("configurationIds")]);
    m_configuration_ids_isSet = !json[QString("configurationIds")].isNull() && m_configuration_ids_isValid;
}

QString OAIDisassociateConfigurationItemsFromApplicationRequest::asJson() const {
...
QJsonObject OAIDisassociateConfigurationItemsFromApplicationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_application_configuration_id_isSet) {
        obj.insert(QString("applicationConfigurationId"), ::OpenAPI::toJsonValue(m_application_configuration_id));
    }
    if (m_configuration_ids.isSet()) {
        obj.insert(QString("configurationIds"), ::OpenAPI::toJsonValue(m_configuration_ids));
    }
    return obj;
}

QString OAIDisassociateConfigurationItemsFromApplicationRequest::getApplicationConfigurationId() const {
    return m_application_configuration_id;
}
void OAIDisassociateConfigurationItemsFromApplicationRequest::setApplicationConfigurationId(const QString &application_configuration_id) {
    m_application_configuration_id = application_configuration_id;
    m_application_configuration_id_isSet = true;
}

bool OAIDisassociateConfigurationItemsFromApplicationRequest::is_application_configuration_id_Set() const{
    return m_application_configuration_id_isSet;
}

bool OAIDisassociateConfigurationItemsFromApplicationRequest::is_application_configuration_id_Valid() const{
    return m_application_configuration_id_isValid;
}

QList OAIDisassociateConfigurationItemsFromApplicationRequest::getConfigurationIds() const {
    return m_configuration_ids;
}
void OAIDisassociateConfigurationItemsFromApplicationRequest::setConfigurationIds(const QList &configuration_ids) {
    m_configuration_ids = configuration_ids;
    m_configuration_ids_isSet = true;
}

bool OAIDisassociateConfigurationItemsFromApplicationRequest::is_configuration_ids_Set() const{
    return m_configuration_ids_isSet;
}

bool OAIDisassociateConfigurationItemsFromApplicationRequest::is_configuration_ids_Valid() const{
    return m_configuration_ids_isValid;
}

bool OAIDisassociateConfigurationItemsFromApplicationRequest::isSet() const {
...
bool OAIDisassociateConfigurationItemsFromApplicationRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_application_configuration_id_isValid && m_configuration_ids_isValid && true;
}
