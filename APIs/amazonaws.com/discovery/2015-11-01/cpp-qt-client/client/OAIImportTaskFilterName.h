...
/*
 * OAIImportTaskFilterName.h
 *
 * 
 */

#ifndef OAIImportTaskFilterName_H
#define OAIImportTaskFilterName_H
...
class OAIImportTaskFilterName : public OAIEnum {
public:
    OAIImportTaskFilterName();
    OAIImportTaskFilterName(QString json);
    ~OAIImportTaskFilterName() override;
    ...
    enum class eOAIImportTaskFilterName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        IMPORT_TASK_ID, 
        STATUS, 
        NAME
    };
    OAIImportTaskFilterName::eOAIImportTaskFilterName getValue() const;
    void setValue(const OAIImportTaskFilterName::eOAIImportTaskFilterName& value);
...
private:
    ...
    eOAIImportTaskFilterName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportTaskFilterName)

#endif // OAIImportTaskFilterName_H
