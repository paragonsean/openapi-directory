...
/*
 * OAIStartExportTaskResponse.h
 *
 * 
 */

#ifndef OAIStartExportTaskResponse_H
#define OAIStartExportTaskResponse_H
...
class OAIStartExportTaskResponse : public OAIObject {
public:
    OAIStartExportTaskResponse();
    OAIStartExportTaskResponse(QString json);
    ~OAIStartExportTaskResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartExportTaskResponse)

#endif // OAIStartExportTaskResponse_H
