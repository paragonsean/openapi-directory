...
OAIDescribeAgentsResponse::OAIDescribeAgentsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAgentsResponse::OAIDescribeAgentsResponse() {
    this->initializeModel();
}

OAIDescribeAgentsResponse::~OAIDescribeAgentsResponse() {}

void OAIDescribeAgentsResponse::initializeModel() {

    m_agents_info_isSet = false;
    m_agents_info_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIDescribeAgentsResponse::fromJson(QString jsonString) {
...
void OAIDescribeAgentsResponse::fromJsonObject(QJsonObject json) {

    m_agents_info_isValid = ::OpenAPI::fromJsonValue(m_agents_info, json[QString("agentsInfo")]);
    m_agents_info_isSet = !json[QString("agentsInfo")].isNull() && m_agents_info_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIDescribeAgentsResponse::asJson() const {
...
QJsonObject OAIDescribeAgentsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_agents_info.isSet()) {
        obj.insert(QString("agentsInfo"), ::OpenAPI::toJsonValue(m_agents_info));
    }
...
QList OAIDescribeAgentsResponse::getAgentsInfo() const {
    return m_agents_info;
}
void OAIDescribeAgentsResponse::setAgentsInfo(const QList &agents_info) {
    m_agents_info = agents_info;
    m_agents_info_isSet = true;
}

bool OAIDescribeAgentsResponse::is_agents_info_Set() const{
    return m_agents_info_isSet;
}

bool OAIDescribeAgentsResponse::is_agents_info_Valid() const{
    return m_agents_info_isValid;
}

QString OAIDescribeAgentsResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeAgentsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeAgentsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeAgentsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeAgentsResponse::isSet() const {
...
bool OAIDescribeAgentsResponse::isValid() const {
