...
OAIListConfigurationsRequest::OAIListConfigurationsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListConfigurationsRequest::OAIListConfigurationsRequest() {
    this->initializeModel();
}

OAIListConfigurationsRequest::~OAIListConfigurationsRequest() {}

void OAIListConfigurationsRequest::initializeModel() {
...
void OAIListConfigurationsRequest::fromJson(QString jsonString) {
...
void OAIListConfigurationsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListConfigurationsRequest::asJson() const {
...
QJsonObject OAIListConfigurationsRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIConfigurationItemType OAIListConfigurationsRequest::getConfigurationType() const {
    return m_configuration_type;
}
void OAIListConfigurationsRequest::setConfigurationType(const OAIConfigurationItemType &configuration_type) {
    m_configuration_type = configuration_type;
    m_configuration_type_isSet = true;
}

bool OAIListConfigurationsRequest::is_configuration_type_Set() const{
    return m_configuration_type_isSet;
}

bool OAIListConfigurationsRequest::is_configuration_type_Valid() const{
    return m_configuration_type_isValid;
}

QList OAIListConfigurationsRequest::getFilters() const {
    return m_filters;
}
void OAIListConfigurationsRequest::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIListConfigurationsRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIListConfigurationsRequest::is_filters_Valid() const{
    return m_filters_isValid;
}

qint32 OAIListConfigurationsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListConfigurationsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListConfigurationsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListConfigurationsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListConfigurationsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListConfigurationsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListConfigurationsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListConfigurationsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListConfigurationsRequest::getOrderBy() const {
    return m_order_by;
}
void OAIListConfigurationsRequest::setOrderBy(const QList &order_by) {
    m_order_by = order_by;
    m_order_by_isSet = true;
}

bool OAIListConfigurationsRequest::is_order_by_Set() const{
    return m_order_by_isSet;
}

bool OAIListConfigurationsRequest::is_order_by_Valid() const{
    return m_order_by_isValid;
}

bool OAIListConfigurationsRequest::isSet() const {
...
bool OAIListConfigurationsRequest::isValid() const {
