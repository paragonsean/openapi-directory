...
OAIDeleteApplicationsRequest::OAIDeleteApplicationsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteApplicationsRequest::OAIDeleteApplicationsRequest() {
    this->initializeModel();
}

OAIDeleteApplicationsRequest::~OAIDeleteApplicationsRequest() {}

void OAIDeleteApplicationsRequest::initializeModel() {

    m_configuration_ids_isSet = false;
    m_configuration_ids_isValid = false;
}

void OAIDeleteApplicationsRequest::fromJson(QString jsonString) {
...
void OAIDeleteApplicationsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteApplicationsRequest::asJson() const {
...
QJsonObject OAIDeleteApplicationsRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDeleteApplicationsRequest::getConfigurationIds() const {
    return m_configuration_ids;
}
void OAIDeleteApplicationsRequest::setConfigurationIds(const QList &configuration_ids) {
    m_configuration_ids = configuration_ids;
    m_configuration_ids_isSet = true;
}

bool OAIDeleteApplicationsRequest::is_configuration_ids_Set() const{
    return m_configuration_ids_isSet;
}

bool OAIDeleteApplicationsRequest::is_configuration_ids_Valid() const{
    return m_configuration_ids_isValid;
}

bool OAIDeleteApplicationsRequest::isSet() const {
...
bool OAIDeleteApplicationsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_configuration_ids_isValid && true;
}
