...
public:
    ...
    QList getExportsInfo() const;
    void setExportsInfo(const QList &exports_info);
    bool is_exports_info_Set() const;
    bool is_exports_info_Valid() const;
...
private:
    ...
    QList m_exports_info;
    bool m_exports_info_isSet;
    bool m_exports_info_isValid;
