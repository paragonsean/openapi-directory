...
/*
 * OAIStopDataCollectionByAgentIdsRequest.h
 *
 * 
 */

#ifndef OAIStopDataCollectionByAgentIdsRequest_H
#define OAIStopDataCollectionByAgentIdsRequest_H
...
class OAIStopDataCollectionByAgentIdsRequest : public OAIObject {
public:
    OAIStopDataCollectionByAgentIdsRequest();
    OAIStopDataCollectionByAgentIdsRequest(QString json);
    ~OAIStopDataCollectionByAgentIdsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopDataCollectionByAgentIdsRequest)

#endif // OAIStopDataCollectionByAgentIdsRequest_H
