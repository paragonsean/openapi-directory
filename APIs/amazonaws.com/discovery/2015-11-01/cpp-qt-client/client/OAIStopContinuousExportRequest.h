...
/*
 * OAIStopContinuousExportRequest.h
 *
 * 
 */

#ifndef OAIStopContinuousExportRequest_H
#define OAIStopContinuousExportRequest_H
...
class OAIStopContinuousExportRequest : public OAIObject {
public:
    OAIStopContinuousExportRequest();
    OAIStopContinuousExportRequest(QString json);
    ~OAIStopContinuousExportRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopContinuousExportRequest)

#endif // OAIStopContinuousExportRequest_H
