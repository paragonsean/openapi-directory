...
/*
 * OAIContinuousExportStatus.h
 *
 * 
 */

#ifndef OAIContinuousExportStatus_H
#define OAIContinuousExportStatus_H
...
class OAIContinuousExportStatus : public OAIEnum {
public:
    OAIContinuousExportStatus();
    OAIContinuousExportStatus(QString json);
    ~OAIContinuousExportStatus() override;
    ...
    enum class eOAIContinuousExportStatus {
    ...
    OAIContinuousExportStatus::eOAIContinuousExportStatus getValue() const;
    void setValue(const OAIContinuousExportStatus::eOAIContinuousExportStatus& value);
...
private:
    ...
    eOAIContinuousExportStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContinuousExportStatus)

#endif // OAIContinuousExportStatus_H
