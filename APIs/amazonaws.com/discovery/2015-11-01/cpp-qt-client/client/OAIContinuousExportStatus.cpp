...
#include "OAIContinuousExportStatus.h"
...
OAIContinuousExportStatus::OAIContinuousExportStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIContinuousExportStatus::OAIContinuousExportStatus() {
    this->initializeModel();
}

OAIContinuousExportStatus::~OAIContinuousExportStatus() {}

void OAIContinuousExportStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIContinuousExportStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIContinuousExportStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("START_IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIContinuousExportStatus::START_IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("START_FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIContinuousExportStatus::START_FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIContinuousExportStatus::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIContinuousExportStatus::ERROR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STOP_IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIContinuousExportStatus::STOP_IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STOP_FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIContinuousExportStatus::STOP_FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("INACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIContinuousExportStatus::INACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIContinuousExportStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIContinuousExportStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIContinuousExportStatus::START_IN_PROGRESS:
            val = "START_IN_PROGRESS";
            break;
        case eOAIContinuousExportStatus::START_FAILED:
            val = "START_FAILED";
            break;
        case eOAIContinuousExportStatus::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIContinuousExportStatus::ERROR:
            val = "ERROR";
            break;
        case eOAIContinuousExportStatus::STOP_IN_PROGRESS:
            val = "STOP_IN_PROGRESS";
            break;
        case eOAIContinuousExportStatus::STOP_FAILED:
            val = "STOP_FAILED";
            break;
        case eOAIContinuousExportStatus::INACTIVE:
            val = "INACTIVE";
            break;
        default:
            break;
...
QJsonValue OAIContinuousExportStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIContinuousExportStatus::eOAIContinuousExportStatus OAIContinuousExportStatus::getValue() const {
    return m_value;
}

void OAIContinuousExportStatus::setValue(const OAIContinuousExportStatus::eOAIContinuousExportStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIContinuousExportStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIContinuousExportStatus::isValid() const {
