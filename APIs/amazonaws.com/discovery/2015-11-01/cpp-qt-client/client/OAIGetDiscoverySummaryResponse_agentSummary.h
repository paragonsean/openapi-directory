...
/*
 * OAIGetDiscoverySummaryResponse_agentSummary.h
 *
 * 
 */

#ifndef OAIGetDiscoverySummaryResponse_agentSummary_H
#define OAIGetDiscoverySummaryResponse_agentSummary_H
...
class OAIGetDiscoverySummaryResponse_agentSummary : public OAIObject {
public:
    OAIGetDiscoverySummaryResponse_agentSummary();
    OAIGetDiscoverySummaryResponse_agentSummary(QString json);
    ~OAIGetDiscoverySummaryResponse_agentSummary() override;
    ...
    qint32 getActiveAgents() const;
    void setActiveAgents(const qint32 &active_agents);
    bool is_active_agents_Set() const;
    bool is_active_agents_Valid() const;

    qint32 getHealthyAgents() const;
    void setHealthyAgents(const qint32 &healthy_agents);
    bool is_healthy_agents_Set() const;
    bool is_healthy_agents_Valid() const;

    qint32 getBlackListedAgents() const;
    void setBlackListedAgents(const qint32 &black_listed_agents);
    bool is_black_listed_agents_Set() const;
    bool is_black_listed_agents_Valid() const;

    qint32 getShutdownAgents() const;
    void setShutdownAgents(const qint32 &shutdown_agents);
    bool is_shutdown_agents_Set() const;
    bool is_shutdown_agents_Valid() const;

    qint32 getUnhealthyAgents() const;
    void setUnhealthyAgents(const qint32 &unhealthy_agents);
    bool is_unhealthy_agents_Set() const;
    bool is_unhealthy_agents_Valid() const;

    qint32 getTotalAgents() const;
    void setTotalAgents(const qint32 &total_agents);
    bool is_total_agents_Set() const;
    bool is_total_agents_Valid() const;

    qint32 getUnknownAgents() const;
    void setUnknownAgents(const qint32 &unknown_agents);
    bool is_unknown_agents_Set() const;
    bool is_unknown_agents_Valid() const;
...
private:
    ...
    qint32 m_active_agents;
    bool m_active_agents_isSet;
    bool m_active_agents_isValid;

    qint32 m_healthy_agents;
    bool m_healthy_agents_isSet;
    bool m_healthy_agents_isValid;

    qint32 m_black_listed_agents;
    bool m_black_listed_agents_isSet;
    bool m_black_listed_agents_isValid;

    qint32 m_shutdown_agents;
    bool m_shutdown_agents_isSet;
    bool m_shutdown_agents_isValid;

    qint32 m_unhealthy_agents;
    bool m_unhealthy_agents_isSet;
    bool m_unhealthy_agents_isValid;

    qint32 m_total_agents;
    bool m_total_agents_isSet;
    bool m_total_agents_isValid;

    qint32 m_unknown_agents;
    bool m_unknown_agents_isSet;
    bool m_unknown_agents_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetDiscoverySummaryResponse_agentSummary)

#endif // OAIGetDiscoverySummaryResponse_agentSummary_H
