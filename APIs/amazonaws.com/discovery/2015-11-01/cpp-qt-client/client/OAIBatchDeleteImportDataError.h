...
/*
 * OAIBatchDeleteImportDataError.h
 *
 * Error messages returned for each import task that you deleted as a response for this command.
 */

#ifndef OAIBatchDeleteImportDataError_H
#define OAIBatchDeleteImportDataError_H
...
class OAIBatchDeleteImportDataError : public OAIObject {
public:
    OAIBatchDeleteImportDataError();
    OAIBatchDeleteImportDataError(QString json);
    ~OAIBatchDeleteImportDataError() override;
    ...
    OAIBatchDeleteImportDataErrorCode getErrorCode() const;
    void setErrorCode(const OAIBatchDeleteImportDataErrorCode &error_code);
...
private:
    ...
    OAIBatchDeleteImportDataErrorCode m_error_code;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDeleteImportDataError)

#endif // OAIBatchDeleteImportDataError_H
