...
#include "OAIConfigurationItemType.h"
...
OAIConfigurationItemType::OAIConfigurationItemType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfigurationItemType::OAIConfigurationItemType() {
    this->initializeModel();
}

OAIConfigurationItemType::~OAIConfigurationItemType() {}

void OAIConfigurationItemType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIConfigurationItemType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIConfigurationItemType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SERVER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConfigurationItemType::SERVER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PROCESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConfigurationItemType::PROCESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CONNECTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConfigurationItemType::CONNECTION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("APPLICATION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConfigurationItemType::APPLICATION;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIConfigurationItemType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIConfigurationItemType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIConfigurationItemType::SERVER:
            val = "SERVER";
            break;
        case eOAIConfigurationItemType::PROCESS:
            val = "PROCESS";
            break;
        case eOAIConfigurationItemType::CONNECTION:
            val = "CONNECTION";
            break;
        case eOAIConfigurationItemType::APPLICATION:
            val = "APPLICATION";
            break;
        default:
            break;
...
QJsonValue OAIConfigurationItemType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIConfigurationItemType::eOAIConfigurationItemType OAIConfigurationItemType::getValue() const {
    return m_value;
}

void OAIConfigurationItemType::setValue(const OAIConfigurationItemType::eOAIConfigurationItemType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIConfigurationItemType::isSet() const {
    
    return m_value_isSet;
}

bool OAIConfigurationItemType::isValid() const {
