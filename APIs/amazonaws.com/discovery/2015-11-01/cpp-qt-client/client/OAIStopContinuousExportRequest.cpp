...
OAIStopContinuousExportRequest::OAIStopContinuousExportRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopContinuousExportRequest::OAIStopContinuousExportRequest() {
    this->initializeModel();
}

OAIStopContinuousExportRequest::~OAIStopContinuousExportRequest() {}

void OAIStopContinuousExportRequest::initializeModel() {

    m_export_id_isSet = false;
    m_export_id_isValid = false;
}

void OAIStopContinuousExportRequest::fromJson(QString jsonString) {
...
void OAIStopContinuousExportRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStopContinuousExportRequest::asJson() const {
...
QJsonObject OAIStopContinuousExportRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStopContinuousExportRequest::getExportId() const {
    return m_export_id;
}
void OAIStopContinuousExportRequest::setExportId(const QString &export_id) {
    m_export_id = export_id;
    m_export_id_isSet = true;
}

bool OAIStopContinuousExportRequest::is_export_id_Set() const{
    return m_export_id_isSet;
}

bool OAIStopContinuousExportRequest::is_export_id_Valid() const{
    return m_export_id_isValid;
}

bool OAIStopContinuousExportRequest::isSet() const {
...
bool OAIStopContinuousExportRequest::isValid() const {
