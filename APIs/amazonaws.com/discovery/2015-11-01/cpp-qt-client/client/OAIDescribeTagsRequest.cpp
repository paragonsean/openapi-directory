...
OAIDescribeTagsRequest::OAIDescribeTagsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTagsRequest::OAIDescribeTagsRequest() {
    this->initializeModel();
}

OAIDescribeTagsRequest::~OAIDescribeTagsRequest() {}

void OAIDescribeTagsRequest::initializeModel() {
...
void OAIDescribeTagsRequest::fromJson(QString jsonString) {
...
void OAIDescribeTagsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeTagsRequest::asJson() const {
...
QJsonObject OAIDescribeTagsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.isSet()) {
...
QList OAIDescribeTagsRequest::getFilters() const {
    return m_filters;
}
void OAIDescribeTagsRequest::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIDescribeTagsRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIDescribeTagsRequest::is_filters_Valid() const{
    return m_filters_isValid;
}

qint32 OAIDescribeTagsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeTagsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeTagsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeTagsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeTagsRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeTagsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeTagsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeTagsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeTagsRequest::isSet() const {
...
bool OAIDescribeTagsRequest::isValid() const {
