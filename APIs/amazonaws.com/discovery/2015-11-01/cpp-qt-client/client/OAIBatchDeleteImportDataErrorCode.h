...
/*
 * OAIBatchDeleteImportDataErrorCode.h
 *
 * 
 */

#ifndef OAIBatchDeleteImportDataErrorCode_H
#define OAIBatchDeleteImportDataErrorCode_H
...
class OAIBatchDeleteImportDataErrorCode : public OAIEnum {
public:
    OAIBatchDeleteImportDataErrorCode();
    OAIBatchDeleteImportDataErrorCode(QString json);
    ~OAIBatchDeleteImportDataErrorCode() override;
    ...
    enum class eOAIBatchDeleteImportDataErrorCode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NOT_FOUND, 
        INTERNAL_SERVER_ERROR, 
        OVER_LIMIT
    };
    OAIBatchDeleteImportDataErrorCode::eOAIBatchDeleteImportDataErrorCode getValue() const;
    void setValue(const OAIBatchDeleteImportDataErrorCode::eOAIBatchDeleteImportDataErrorCode& value);
...
private:
    ...
    eOAIBatchDeleteImportDataErrorCode m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDeleteImportDataErrorCode)

#endif // OAIBatchDeleteImportDataErrorCode_H
