...
OAIDescribeImportTasksRequest::OAIDescribeImportTasksRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeImportTasksRequest::OAIDescribeImportTasksRequest() {
    this->initializeModel();
}

OAIDescribeImportTasksRequest::~OAIDescribeImportTasksRequest() {}

void OAIDescribeImportTasksRequest::initializeModel() {
...
void OAIDescribeImportTasksRequest::fromJson(QString jsonString) {
...
void OAIDescribeImportTasksRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeImportTasksRequest::asJson() const {
...
QJsonObject OAIDescribeImportTasksRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.isSet()) {
...
QList OAIDescribeImportTasksRequest::getFilters() const {
    return m_filters;
}
void OAIDescribeImportTasksRequest::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIDescribeImportTasksRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIDescribeImportTasksRequest::is_filters_Valid() const{
    return m_filters_isValid;
}

qint32 OAIDescribeImportTasksRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeImportTasksRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeImportTasksRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeImportTasksRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeImportTasksRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeImportTasksRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeImportTasksRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeImportTasksRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeImportTasksRequest::isSet() const {
...
bool OAIDescribeImportTasksRequest::isValid() const {
