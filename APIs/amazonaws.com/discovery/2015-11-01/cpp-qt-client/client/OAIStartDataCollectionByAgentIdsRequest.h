...
/*
 * OAIStartDataCollectionByAgentIdsRequest.h
 *
 * 
 */

#ifndef OAIStartDataCollectionByAgentIdsRequest_H
#define OAIStartDataCollectionByAgentIdsRequest_H
...
class OAIStartDataCollectionByAgentIdsRequest : public OAIObject {
public:
    OAIStartDataCollectionByAgentIdsRequest();
    OAIStartDataCollectionByAgentIdsRequest(QString json);
    ~OAIStartDataCollectionByAgentIdsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartDataCollectionByAgentIdsRequest)

#endif // OAIStartDataCollectionByAgentIdsRequest_H
