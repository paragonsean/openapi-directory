...
/*
 * OAIEc2RecommendationsExportPreferences_reservedInstanceOptions.h
 *
 * 
 */

#ifndef OAIEc2RecommendationsExportPreferences_reservedInstanceOptions_H
#define OAIEc2RecommendationsExportPreferences_reservedInstanceOptions_H

#include <QJsonObject>

#include "OAIOfferingClass.h"
#include "OAIPurchasingOption.h"
#include "OAITermLength.h"
...
class OAIEc2RecommendationsExportPreferences_reservedInstanceOptions : public OAIObject {
public:
    OAIEc2RecommendationsExportPreferences_reservedInstanceOptions();
    OAIEc2RecommendationsExportPreferences_reservedInstanceOptions(QString json);
    ~OAIEc2RecommendationsExportPreferences_reservedInstanceOptions() override;
    ...
    OAIPurchasingOption getPurchasingOption() const;
    void setPurchasingOption(const OAIPurchasingOption &purchasing_option);
    bool is_purchasing_option_Set() const;
    bool is_purchasing_option_Valid() const;
    ...
    OAITermLength getTermLength() const;
    void setTermLength(const OAITermLength &term_length);
...
private:
    ...
    OAIPurchasingOption m_purchasing_option;
    bool m_purchasing_option_isSet;
    bool m_purchasing_option_isValid;

    OAIOfferingClass m_offering_class;
    bool m_offering_class_isSet;
    bool m_offering_class_isValid;

    OAITermLength m_term_length;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEc2RecommendationsExportPreferences_reservedInstanceOptions)

#endif // OAIEc2RecommendationsExportPreferences_reservedInstanceOptions_H
