...
OAIDescribeExportConfigurationsRequest::OAIDescribeExportConfigurationsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeExportConfigurationsRequest::OAIDescribeExportConfigurationsRequest() {
    this->initializeModel();
}

OAIDescribeExportConfigurationsRequest::~OAIDescribeExportConfigurationsRequest() {}

void OAIDescribeExportConfigurationsRequest::initializeModel() {
...
void OAIDescribeExportConfigurationsRequest::fromJson(QString jsonString) {
...
void OAIDescribeExportConfigurationsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeExportConfigurationsRequest::asJson() const {
...
QJsonObject OAIDescribeExportConfigurationsRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeExportConfigurationsRequest::getExportIds() const {
    return m_export_ids;
}
void OAIDescribeExportConfigurationsRequest::setExportIds(const QList &export_ids) {
    m_export_ids = export_ids;
    m_export_ids_isSet = true;
}

bool OAIDescribeExportConfigurationsRequest::is_export_ids_Set() const{
    return m_export_ids_isSet;
}

bool OAIDescribeExportConfigurationsRequest::is_export_ids_Valid() const{
    return m_export_ids_isValid;
}

qint32 OAIDescribeExportConfigurationsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeExportConfigurationsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeExportConfigurationsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeExportConfigurationsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeExportConfigurationsRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeExportConfigurationsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeExportConfigurationsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeExportConfigurationsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeExportConfigurationsRequest::isSet() const {
...
bool OAIDescribeExportConfigurationsRequest::isValid() const {
