...
/*
 * OAIGetDiscoverySummaryResponse_meCollectorSummary.h
 *
 * 
 */

#ifndef OAIGetDiscoverySummaryResponse_meCollectorSummary_H
#define OAIGetDiscoverySummaryResponse_meCollectorSummary_H
...
class OAIGetDiscoverySummaryResponse_meCollectorSummary : public OAIObject {
public:
    OAIGetDiscoverySummaryResponse_meCollectorSummary();
    OAIGetDiscoverySummaryResponse_meCollectorSummary(QString json);
    ~OAIGetDiscoverySummaryResponse_meCollectorSummary() override;
    ...
    qint32 getActiveMeCollectors() const;
    void setActiveMeCollectors(const qint32 &active_me_collectors);
    bool is_active_me_collectors_Set() const;
    bool is_active_me_collectors_Valid() const;

    qint32 getHealthyMeCollectors() const;
    void setHealthyMeCollectors(const qint32 &healthy_me_collectors);
    bool is_healthy_me_collectors_Set() const;
    bool is_healthy_me_collectors_Valid() const;

    qint32 getDenyListedMeCollectors() const;
    void setDenyListedMeCollectors(const qint32 &deny_listed_me_collectors);
    bool is_deny_listed_me_collectors_Set() const;
    bool is_deny_listed_me_collectors_Valid() const;

    qint32 getShutdownMeCollectors() const;
    void setShutdownMeCollectors(const qint32 &shutdown_me_collectors);
    bool is_shutdown_me_collectors_Set() const;
    bool is_shutdown_me_collectors_Valid() const;

    qint32 getUnhealthyMeCollectors() const;
    void setUnhealthyMeCollectors(const qint32 &unhealthy_me_collectors);
    bool is_unhealthy_me_collectors_Set() const;
    bool is_unhealthy_me_collectors_Valid() const;

    qint32 getTotalMeCollectors() const;
    void setTotalMeCollectors(const qint32 &total_me_collectors);
    bool is_total_me_collectors_Set() const;
    bool is_total_me_collectors_Valid() const;

    qint32 getUnknownMeCollectors() const;
    void setUnknownMeCollectors(const qint32 &unknown_me_collectors);
    bool is_unknown_me_collectors_Set() const;
    bool is_unknown_me_collectors_Valid() const;
...
private:
    ...
    qint32 m_active_me_collectors;
    bool m_active_me_collectors_isSet;
    bool m_active_me_collectors_isValid;

    qint32 m_healthy_me_collectors;
    bool m_healthy_me_collectors_isSet;
    bool m_healthy_me_collectors_isValid;

    qint32 m_deny_listed_me_collectors;
    bool m_deny_listed_me_collectors_isSet;
    bool m_deny_listed_me_collectors_isValid;

    qint32 m_shutdown_me_collectors;
    bool m_shutdown_me_collectors_isSet;
    bool m_shutdown_me_collectors_isValid;

    qint32 m_unhealthy_me_collectors;
    bool m_unhealthy_me_collectors_isSet;
    bool m_unhealthy_me_collectors_isValid;

    qint32 m_total_me_collectors;
    bool m_total_me_collectors_isSet;
    bool m_total_me_collectors_isValid;

    qint32 m_unknown_me_collectors;
    bool m_unknown_me_collectors_isSet;
    bool m_unknown_me_collectors_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetDiscoverySummaryResponse_meCollectorSummary)

#endif // OAIGetDiscoverySummaryResponse_meCollectorSummary_H
