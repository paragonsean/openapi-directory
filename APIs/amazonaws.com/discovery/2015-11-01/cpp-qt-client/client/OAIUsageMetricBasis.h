...
class OAIUsageMetricBasis : public OAIObject {
public:
    OAIUsageMetricBasis();
    OAIUsageMetricBasis(QString json);
    ~OAIUsageMetricBasis() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUsageMetricBasis)

#endif // OAIUsageMetricBasis_H
