...
/*
 * OAIAgentNetworkInfo.h
 *
 * Network details about the host where the agent/collector resides.
 */

#ifndef OAIAgentNetworkInfo_H
#define OAIAgentNetworkInfo_H
...
class OAIAgentNetworkInfo : public OAIObject {
public:
    OAIAgentNetworkInfo();
    OAIAgentNetworkInfo(QString json);
    ~OAIAgentNetworkInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAgentNetworkInfo)

#endif // OAIAgentNetworkInfo_H
