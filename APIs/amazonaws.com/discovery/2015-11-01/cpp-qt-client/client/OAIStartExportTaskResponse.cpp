...
OAIStartExportTaskResponse::OAIStartExportTaskResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartExportTaskResponse::OAIStartExportTaskResponse() {
    this->initializeModel();
}

OAIStartExportTaskResponse::~OAIStartExportTaskResponse() {}

void OAIStartExportTaskResponse::initializeModel() {

    m_export_id_isSet = false;
    m_export_id_isValid = false;
}

void OAIStartExportTaskResponse::fromJson(QString jsonString) {
...
void OAIStartExportTaskResponse::fromJsonObject(QJsonObject json) {
...
QString OAIStartExportTaskResponse::asJson() const {
...
QJsonObject OAIStartExportTaskResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartExportTaskResponse::getExportId() const {
    return m_export_id;
}
void OAIStartExportTaskResponse::setExportId(const QString &export_id) {
    m_export_id = export_id;
    m_export_id_isSet = true;
}

bool OAIStartExportTaskResponse::is_export_id_Set() const{
    return m_export_id_isSet;
}

bool OAIStartExportTaskResponse::is_export_id_Valid() const{
    return m_export_id_isValid;
}

bool OAIStartExportTaskResponse::isSet() const {
...
bool OAIStartExportTaskResponse::isValid() const {
