...
/*
 * OAIListServerNeighborsResponse.h
 *
 * 
 */

#ifndef OAIListServerNeighborsResponse_H
#define OAIListServerNeighborsResponse_H
...
class OAIListServerNeighborsResponse : public OAIObject {
public:
    OAIListServerNeighborsResponse();
    OAIListServerNeighborsResponse(QString json);
    ~OAIListServerNeighborsResponse() override;
    ...
    QList getNeighbors() const;
    void setNeighbors(const QList &neighbors);
    ...
    qint32 getKnownDependencyCount() const;
    void setKnownDependencyCount(const qint32 &known_dependency_count);
    bool is_known_dependency_count_Set() const;
    bool is_known_dependency_count_Valid() const;
...
private:
    ...
    qint32 m_known_dependency_count;
    bool m_known_dependency_count_isSet;
    bool m_known_dependency_count_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListServerNeighborsResponse)

#endif // OAIListServerNeighborsResponse_H
