...
OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis() {
    this->initializeModel();
}

OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::~OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis() {}

void OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::initializeModel() {
...
void OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::fromJson(QString jsonString) {
...
void OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::fromJsonObject(QJsonObject json) {
...
QString OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::asJson() const {
...
QJsonObject OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::getName() const {
    return m_name;
}
void OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::is_name_Set() const{
    return m_name_isSet;
}

bool OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::is_name_Valid() const{
    return m_name_isValid;
}

double OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::getPercentageAdjust() const {
    return m_percentage_adjust;
}
void OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::setPercentageAdjust(const double &percentage_adjust) {
    m_percentage_adjust = percentage_adjust;
    m_percentage_adjust_isSet = true;
}

bool OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::is_percentage_adjust_Set() const{
    return m_percentage_adjust_isSet;
}

bool OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::is_percentage_adjust_Valid() const{
    return m_percentage_adjust_isValid;
}

bool OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::isSet() const {
...
bool OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis::isValid() const {
