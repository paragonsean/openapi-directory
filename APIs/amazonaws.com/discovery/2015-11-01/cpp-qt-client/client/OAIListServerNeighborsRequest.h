...
/*
 * OAIListServerNeighborsRequest.h
 *
 * 
 */

#ifndef OAIListServerNeighborsRequest_H
#define OAIListServerNeighborsRequest_H
...
class OAIListServerNeighborsRequest : public OAIObject {
public:
    OAIListServerNeighborsRequest();
    OAIListServerNeighborsRequest(QString json);
    ~OAIListServerNeighborsRequest() override;
    ...
    void setPortInformationNeeded(const bool &port_information_needed);
    bool is_port_information_needed_Set() const;
    bool is_port_information_needed_Valid() const;

    QList getNeighborConfigurationIds() const;
    void setNeighborConfigurationIds(const QList &neighbor_configuration_ids);
    bool is_neighbor_configuration_ids_Set() const;
    bool is_neighbor_configuration_ids_Valid() const;
...
private:
    ...
    bool m_port_information_needed;
    bool m_port_information_needed_isSet;
    bool m_port_information_needed_isValid;

    QList m_neighbor_configuration_ids;
    bool m_neighbor_configuration_ids_isSet;
    bool m_neighbor_configuration_ids_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListServerNeighborsRequest)

#endif // OAIListServerNeighborsRequest_H
