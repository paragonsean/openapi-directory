...
/*
 * OAIConfigurationTag.h
 *
 * Tags for a configuration item. Tags are metadata that help you categorize IT assets.
 */

#ifndef OAIConfigurationTag_H
#define OAIConfigurationTag_H
...
class OAIConfigurationTag : public OAIObject {
public:
    OAIConfigurationTag();
    OAIConfigurationTag(QString json);
    ~OAIConfigurationTag() override;
    ...
    OAIConfigurationItemType getConfigurationType() const;
    void setConfigurationType(const OAIConfigurationItemType &configuration_type);
    ...
    QDateTime getTimeOfCreation() const;
    void setTimeOfCreation(const QDateTime &time_of_creation);
    bool is_time_of_creation_Set() const;
    bool is_time_of_creation_Valid() const;
...
private:
    ...
    OAIConfigurationItemType m_configuration_type;
    ...
    QDateTime m_time_of_creation;
    bool m_time_of_creation_isSet;
    bool m_time_of_creation_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIConfigurationTag)

#endif // OAIConfigurationTag_H
