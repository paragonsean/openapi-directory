...
OAIStopDataCollectionByAgentIdsRequest::OAIStopDataCollectionByAgentIdsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopDataCollectionByAgentIdsRequest::OAIStopDataCollectionByAgentIdsRequest() {
    this->initializeModel();
}

OAIStopDataCollectionByAgentIdsRequest::~OAIStopDataCollectionByAgentIdsRequest() {}

void OAIStopDataCollectionByAgentIdsRequest::initializeModel() {

    m_agent_ids_isSet = false;
    m_agent_ids_isValid = false;
}

void OAIStopDataCollectionByAgentIdsRequest::fromJson(QString jsonString) {
...
void OAIStopDataCollectionByAgentIdsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStopDataCollectionByAgentIdsRequest::asJson() const {
...
QJsonObject OAIStopDataCollectionByAgentIdsRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIStopDataCollectionByAgentIdsRequest::getAgentIds() const {
    return m_agent_ids;
}
void OAIStopDataCollectionByAgentIdsRequest::setAgentIds(const QList &agent_ids) {
    m_agent_ids = agent_ids;
    m_agent_ids_isSet = true;
}

bool OAIStopDataCollectionByAgentIdsRequest::is_agent_ids_Set() const{
    return m_agent_ids_isSet;
}

bool OAIStopDataCollectionByAgentIdsRequest::is_agent_ids_Valid() const{
    return m_agent_ids_isValid;
}

bool OAIStopDataCollectionByAgentIdsRequest::isSet() const {
...
bool OAIStopDataCollectionByAgentIdsRequest::isValid() const {
