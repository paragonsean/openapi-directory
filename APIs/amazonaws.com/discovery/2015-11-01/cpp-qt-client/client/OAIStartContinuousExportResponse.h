...
/*
 * OAIStartContinuousExportResponse.h
 *
 * 
 */

#ifndef OAIStartContinuousExportResponse_H
#define OAIStartContinuousExportResponse_H
...
class OAIStartContinuousExportResponse : public OAIObject {
public:
    OAIStartContinuousExportResponse();
    OAIStartContinuousExportResponse(QString json);
    ~OAIStartContinuousExportResponse() override;
    ...
    QMap getSchemaStorageConfig() const;
    void setSchemaStorageConfig(const QMap &schema_storage_config);
    bool is_schema_storage_config_Set() const;
    bool is_schema_storage_config_Valid() const;
...
private:
    ...
    QMap m_schema_storage_config;
    bool m_schema_storage_config_isSet;
    bool m_schema_storage_config_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartContinuousExportResponse)

#endif // OAIStartContinuousExportResponse_H
