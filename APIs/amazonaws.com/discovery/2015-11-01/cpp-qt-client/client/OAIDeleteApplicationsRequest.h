...
/*
 * OAIDeleteApplicationsRequest.h
 *
 * 
 */

#ifndef OAIDeleteApplicationsRequest_H
#define OAIDeleteApplicationsRequest_H
...
class OAIDeleteApplicationsRequest : public OAIObject {
public:
    OAIDeleteApplicationsRequest();
    OAIDeleteApplicationsRequest(QString json);
    ~OAIDeleteApplicationsRequest() override;
    ...
    QList getConfigurationIds() const;
    void setConfigurationIds(const QList &configuration_ids);
    bool is_configuration_ids_Set() const;
    bool is_configuration_ids_Valid() const;
...
private:
    ...
    QList m_configuration_ids;
    bool m_configuration_ids_isSet;
    bool m_configuration_ids_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteApplicationsRequest)

#endif // OAIDeleteApplicationsRequest_H
