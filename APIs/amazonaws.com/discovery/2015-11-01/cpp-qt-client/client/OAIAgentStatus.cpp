...
void OAIAgentStatus::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("HEALTHY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAgentStatus::HEALTHY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UNHEALTHY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAgentStatus::UNHEALTHY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RUNNING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAgentStatus::RUNNING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UNKNOWN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAgentStatus::UNKNOWN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("BLACKLISTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAgentStatus::BLACKLISTED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SHUTDOWN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAgentStatus::SHUTDOWN;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIAgentStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIAgentStatus::HEALTHY:
            val = "HEALTHY";
            break;
        case eOAIAgentStatus::UNHEALTHY:
            val = "UNHEALTHY";
            break;
        case eOAIAgentStatus::RUNNING:
            val = "RUNNING";
            break;
        case eOAIAgentStatus::UNKNOWN:
            val = "UNKNOWN";
            break;
        case eOAIAgentStatus::BLACKLISTED:
            val = "BLACKLISTED";
            break;
        case eOAIAgentStatus::SHUTDOWN:
            val = "SHUTDOWN";
            break;
        default:
            break;
