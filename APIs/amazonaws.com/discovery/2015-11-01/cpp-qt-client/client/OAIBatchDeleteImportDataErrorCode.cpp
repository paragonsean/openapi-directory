...
#include "OAIBatchDeleteImportDataErrorCode.h"
...
OAIBatchDeleteImportDataErrorCode::OAIBatchDeleteImportDataErrorCode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchDeleteImportDataErrorCode::OAIBatchDeleteImportDataErrorCode() {
    this->initializeModel();
}

OAIBatchDeleteImportDataErrorCode::~OAIBatchDeleteImportDataErrorCode() {}

void OAIBatchDeleteImportDataErrorCode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIBatchDeleteImportDataErrorCode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIBatchDeleteImportDataErrorCode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NOT_FOUND", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBatchDeleteImportDataErrorCode::NOT_FOUND;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("INTERNAL_SERVER_ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBatchDeleteImportDataErrorCode::INTERNAL_SERVER_ERROR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("OVER_LIMIT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBatchDeleteImportDataErrorCode::OVER_LIMIT;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIBatchDeleteImportDataErrorCode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIBatchDeleteImportDataErrorCode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIBatchDeleteImportDataErrorCode::NOT_FOUND:
            val = "NOT_FOUND";
            break;
        case eOAIBatchDeleteImportDataErrorCode::INTERNAL_SERVER_ERROR:
            val = "INTERNAL_SERVER_ERROR";
            break;
        case eOAIBatchDeleteImportDataErrorCode::OVER_LIMIT:
            val = "OVER_LIMIT";
            break;
        default:
            break;
...
QJsonValue OAIBatchDeleteImportDataErrorCode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIBatchDeleteImportDataErrorCode::eOAIBatchDeleteImportDataErrorCode OAIBatchDeleteImportDataErrorCode::getValue() const {
    return m_value;
}

void OAIBatchDeleteImportDataErrorCode::setValue(const OAIBatchDeleteImportDataErrorCode::eOAIBatchDeleteImportDataErrorCode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIBatchDeleteImportDataErrorCode::isSet() const {
    
    return m_value_isSet;
}

bool OAIBatchDeleteImportDataErrorCode::isValid() const {
