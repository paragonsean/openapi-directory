...
/*
 * OAIDescribeAgentsRequest.h
 *
 * 
 */

#ifndef OAIDescribeAgentsRequest_H
#define OAIDescribeAgentsRequest_H
...
class OAIDescribeAgentsRequest : public OAIObject {
public:
    OAIDescribeAgentsRequest();
    OAIDescribeAgentsRequest(QString json);
    ~OAIDescribeAgentsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAgentsRequest)

#endif // OAIDescribeAgentsRequest_H
