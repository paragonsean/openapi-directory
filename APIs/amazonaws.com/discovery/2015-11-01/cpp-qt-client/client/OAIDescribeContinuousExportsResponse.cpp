...
OAIDescribeContinuousExportsResponse::OAIDescribeContinuousExportsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeContinuousExportsResponse::OAIDescribeContinuousExportsResponse() {
    this->initializeModel();
}

OAIDescribeContinuousExportsResponse::~OAIDescribeContinuousExportsResponse() {}

void OAIDescribeContinuousExportsResponse::initializeModel() {
...
void OAIDescribeContinuousExportsResponse::fromJson(QString jsonString) {
...
void OAIDescribeContinuousExportsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeContinuousExportsResponse::asJson() const {
...
QJsonObject OAIDescribeContinuousExportsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeContinuousExportsResponse::getDescriptions() const {
    return m_descriptions;
}
void OAIDescribeContinuousExportsResponse::setDescriptions(const QList &descriptions) {
    m_descriptions = descriptions;
    m_descriptions_isSet = true;
}

bool OAIDescribeContinuousExportsResponse::is_descriptions_Set() const{
    return m_descriptions_isSet;
}

bool OAIDescribeContinuousExportsResponse::is_descriptions_Valid() const{
    return m_descriptions_isValid;
}

QString OAIDescribeContinuousExportsResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeContinuousExportsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeContinuousExportsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeContinuousExportsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeContinuousExportsResponse::isSet() const {
...
bool OAIDescribeContinuousExportsResponse::isValid() const {
