...
/*
 * OAIStartImportTaskResponse.h
 *
 * 
 */

#ifndef OAIStartImportTaskResponse_H
#define OAIStartImportTaskResponse_H

#include <QJsonObject>

#include "OAIStartImportTaskResponse_task.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIStartImportTaskResponse_task;

class OAIStartImportTaskResponse : public OAIObject {
public:
    OAIStartImportTaskResponse();
    OAIStartImportTaskResponse(QString json);
    ~OAIStartImportTaskResponse() override;
    ...
    OAIStartImportTaskResponse_task getTask() const;
    void setTask(const OAIStartImportTaskResponse_task &task);
...
private:
    ...
    OAIStartImportTaskResponse_task m_task;
    bool m_task_isSet;
    bool m_task_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartImportTaskResponse)

#endif // OAIStartImportTaskResponse_H
