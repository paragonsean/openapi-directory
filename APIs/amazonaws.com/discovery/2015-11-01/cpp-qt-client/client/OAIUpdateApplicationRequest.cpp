...
QString OAIUpdateApplicationRequest::getConfigurationId() const {
    return m_configuration_id;
}
void OAIUpdateApplicationRequest::setConfigurationId(const QString &configuration_id) {
    m_configuration_id = configuration_id;
    m_configuration_id_isSet = true;
}

bool OAIUpdateApplicationRequest::is_configuration_id_Set() const{
    return m_configuration_id_isSet;
}

bool OAIUpdateApplicationRequest::is_configuration_id_Valid() const{
