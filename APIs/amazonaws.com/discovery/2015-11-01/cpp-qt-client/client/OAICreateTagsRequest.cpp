...
QList OAICreateTagsRequest::getConfigurationIds() const {
    return m_configuration_ids;
}
void OAICreateTagsRequest::setConfigurationIds(const QList &configuration_ids) {
    m_configuration_ids = configuration_ids;
    m_configuration_ids_isSet = true;
}

bool OAICreateTagsRequest::is_configuration_ids_Set() const{
    return m_configuration_ids_isSet;
}

bool OAICreateTagsRequest::is_configuration_ids_Valid() const{
...
bool OAICreateTagsRequest::isValid() const {
    ...
    return m_configuration_ids_isValid && m_tags_isValid && true;
}
