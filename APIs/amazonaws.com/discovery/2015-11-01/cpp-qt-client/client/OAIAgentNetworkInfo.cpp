...
OAIAgentNetworkInfo::OAIAgentNetworkInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAgentNetworkInfo::OAIAgentNetworkInfo() {
    this->initializeModel();
}

OAIAgentNetworkInfo::~OAIAgentNetworkInfo() {}

void OAIAgentNetworkInfo::initializeModel() {
...
void OAIAgentNetworkInfo::fromJson(QString jsonString) {
...
void OAIAgentNetworkInfo::fromJsonObject(QJsonObject json) {
...
QString OAIAgentNetworkInfo::asJson() const {
...
QJsonObject OAIAgentNetworkInfo::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAgentNetworkInfo::getIpAddress() const {
    return m_ip_address;
}
void OAIAgentNetworkInfo::setIpAddress(const QString &ip_address) {
    m_ip_address = ip_address;
    m_ip_address_isSet = true;
}

bool OAIAgentNetworkInfo::is_ip_address_Set() const{
    return m_ip_address_isSet;
}

bool OAIAgentNetworkInfo::is_ip_address_Valid() const{
    return m_ip_address_isValid;
}

QString OAIAgentNetworkInfo::getMacAddress() const {
    return m_mac_address;
}
void OAIAgentNetworkInfo::setMacAddress(const QString &mac_address) {
    m_mac_address = mac_address;
    m_mac_address_isSet = true;
}

bool OAIAgentNetworkInfo::is_mac_address_Set() const{
    return m_mac_address_isSet;
}

bool OAIAgentNetworkInfo::is_mac_address_Valid() const{
    return m_mac_address_isValid;
}

bool OAIAgentNetworkInfo::isSet() const {
...
bool OAIAgentNetworkInfo::isValid() const {
