...
OAIOrderString::OAIOrderString(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderString::OAIOrderString() {
    this->initializeModel();
}

OAIOrderString::~OAIOrderString() {}

void OAIOrderString::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIOrderString::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIOrderString::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ASC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrderString::ASC;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DESC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrderString::DESC;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIOrderString::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIOrderString::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIOrderString::ASC:
            val = "ASC";
            break;
        case eOAIOrderString::DESC:
            val = "DESC";
            break;
        default:
            break;
...
QJsonValue OAIOrderString::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIOrderString::eOAIOrderString OAIOrderString::getValue() const {
    return m_value;
}

void OAIOrderString::setValue(const OAIOrderString::eOAIOrderString& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIOrderString::isSet() const {
    
    return m_value_isSet;
}

bool OAIOrderString::isValid() const {
