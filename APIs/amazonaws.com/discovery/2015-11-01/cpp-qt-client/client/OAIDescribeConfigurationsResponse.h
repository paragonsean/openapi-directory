...
/*
 * OAIDescribeConfigurationsResponse.h
 *
 * 
 */

#ifndef OAIDescribeConfigurationsResponse_H
#define OAIDescribeConfigurationsResponse_H
...
class OAIDescribeConfigurationsResponse : public OAIObject {
public:
    OAIDescribeConfigurationsResponse();
    OAIDescribeConfigurationsResponse(QString json);
    ~OAIDescribeConfigurationsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeConfigurationsResponse)

#endif // OAIDescribeConfigurationsResponse_H
