...
OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis() {
    this->initializeModel();
}

OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::~OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis() {}

void OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;

    m_percentage_adjust_isSet = false;
    m_percentage_adjust_isValid = false;
}

void OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::fromJson(QString jsonString) {
...
void OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;

    m_percentage_adjust_isValid = ::OpenAPI::fromJsonValue(m_percentage_adjust, json[QString("percentageAdjust")]);
    m_percentage_adjust_isSet = !json[QString("percentageAdjust")].isNull() && m_percentage_adjust_isValid;
}

QString OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::asJson() const {
...
QJsonObject OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
        obj.insert(QString("name"), ::OpenAPI::toJsonValue(m_name));
    }
    if (m_percentage_adjust_isSet) {
        obj.insert(QString("percentageAdjust"), ::OpenAPI::toJsonValue(m_percentage_adjust));
    }
    return obj;
}

QString OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::getName() const {
    return m_name;
}
void OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::is_name_Set() const{
    return m_name_isSet;
}

bool OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::is_name_Valid() const{
    return m_name_isValid;
}

double OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::getPercentageAdjust() const {
    return m_percentage_adjust;
}
void OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::setPercentageAdjust(const double &percentage_adjust) {
    m_percentage_adjust = percentage_adjust;
    m_percentage_adjust_isSet = true;
}

bool OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::is_percentage_adjust_Set() const{
    return m_percentage_adjust_isSet;
}

bool OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::is_percentage_adjust_Valid() const{
    return m_percentage_adjust_isValid;
}

bool OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::isSet() const {
...
bool OAIEc2RecommendationsExportPreferences_cpuPerformanceMetricBasis::isValid() const {
