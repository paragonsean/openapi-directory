...
class OAITenancy : public OAIEnum {
public:
    OAITenancy();
    OAITenancy(QString json);
    ~OAITenancy() override;
    ...
    enum class eOAITenancy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DEDICATED, 
        SHARED
    };
    OAITenancy::eOAITenancy getValue() const;
    void setValue(const OAITenancy::eOAITenancy& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITenancy)
