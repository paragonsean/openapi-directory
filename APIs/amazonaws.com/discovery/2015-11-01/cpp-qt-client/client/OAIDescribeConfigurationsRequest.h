...
/*
 * OAIDescribeConfigurationsRequest.h
 *
 * 
 */

#ifndef OAIDescribeConfigurationsRequest_H
#define OAIDescribeConfigurationsRequest_H
...
class OAIDescribeConfigurationsRequest : public OAIObject {
public:
    OAIDescribeConfigurationsRequest();
    OAIDescribeConfigurationsRequest(QString json);
    ~OAIDescribeConfigurationsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeConfigurationsRequest)

#endif // OAIDescribeConfigurationsRequest_H
