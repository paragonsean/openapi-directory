...
#include "OAIImportTaskFilterName.h"
...
OAIImportTaskFilterName::OAIImportTaskFilterName(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportTaskFilterName::OAIImportTaskFilterName() {
    this->initializeModel();
}

OAIImportTaskFilterName::~OAIImportTaskFilterName() {}

void OAIImportTaskFilterName::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIImportTaskFilterName::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIImportTaskFilterName::fromJson(QString jsonString) {
    
    if ( jsonString.compare("IMPORT_TASK_ID", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportTaskFilterName::IMPORT_TASK_ID;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STATUS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportTaskFilterName::STATUS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NAME", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImportTaskFilterName::NAME;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIImportTaskFilterName::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIImportTaskFilterName::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIImportTaskFilterName::IMPORT_TASK_ID:
            val = "IMPORT_TASK_ID";
            break;
        case eOAIImportTaskFilterName::STATUS:
            val = "STATUS";
            break;
        case eOAIImportTaskFilterName::NAME:
            val = "NAME";
            break;
        default:
            break;
...
QJsonValue OAIImportTaskFilterName::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIImportTaskFilterName::eOAIImportTaskFilterName OAIImportTaskFilterName::getValue() const {
    return m_value;
}

void OAIImportTaskFilterName::setValue(const OAIImportTaskFilterName::eOAIImportTaskFilterName& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIImportTaskFilterName::isSet() const {
    
    return m_value_isSet;
}

bool OAIImportTaskFilterName::isValid() const {
