...
QString OAICreateApplicationResponse::getConfigurationId() const {
    return m_configuration_id;
}
void OAICreateApplicationResponse::setConfigurationId(const QString &configuration_id) {
    m_configuration_id = configuration_id;
    m_configuration_id_isSet = true;
}

bool OAICreateApplicationResponse::is_configuration_id_Set() const{
    return m_configuration_id_isSet;
}

bool OAICreateApplicationResponse::is_configuration_id_Valid() const{
