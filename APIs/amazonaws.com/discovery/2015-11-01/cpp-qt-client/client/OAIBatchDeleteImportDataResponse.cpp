...
OAIBatchDeleteImportDataResponse::OAIBatchDeleteImportDataResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchDeleteImportDataResponse::OAIBatchDeleteImportDataResponse() {
    this->initializeModel();
}

OAIBatchDeleteImportDataResponse::~OAIBatchDeleteImportDataResponse() {}

void OAIBatchDeleteImportDataResponse::initializeModel() {

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIBatchDeleteImportDataResponse::fromJson(QString jsonString) {
...
void OAIBatchDeleteImportDataResponse::fromJsonObject(QJsonObject json) {

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("errors")]);
    m_errors_isSet = !json[QString("errors")].isNull() && m_errors_isValid;
}

QString OAIBatchDeleteImportDataResponse::asJson() const {
...
QJsonObject OAIBatchDeleteImportDataResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.isSet()) {
...
QList OAIBatchDeleteImportDataResponse::getErrors() const {
    return m_errors;
}
void OAIBatchDeleteImportDataResponse::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIBatchDeleteImportDataResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIBatchDeleteImportDataResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIBatchDeleteImportDataResponse::isSet() const {
...
bool OAIBatchDeleteImportDataResponse::isValid() const {
