...
OAIStartDataCollectionByAgentIdsResponse::OAIStartDataCollectionByAgentIdsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartDataCollectionByAgentIdsResponse::OAIStartDataCollectionByAgentIdsResponse() {
    this->initializeModel();
}

OAIStartDataCollectionByAgentIdsResponse::~OAIStartDataCollectionByAgentIdsResponse() {}

void OAIStartDataCollectionByAgentIdsResponse::initializeModel() {

    m_agents_configuration_status_isSet = false;
    m_agents_configuration_status_isValid = false;
}

void OAIStartDataCollectionByAgentIdsResponse::fromJson(QString jsonString) {
...
void OAIStartDataCollectionByAgentIdsResponse::fromJsonObject(QJsonObject json) {

    m_agents_configuration_status_isValid = ::OpenAPI::fromJsonValue(m_agents_configuration_status, json[QString("agentsConfigurationStatus")]);
    m_agents_configuration_status_isSet = !json[QString("agentsConfigurationStatus")].isNull() && m_agents_configuration_status_isValid;
}

QString OAIStartDataCollectionByAgentIdsResponse::asJson() const {
...
QJsonObject OAIStartDataCollectionByAgentIdsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_agents_configuration_status.isSet()) {
        obj.insert(QString("agentsConfigurationStatus"), ::OpenAPI::toJsonValue(m_agents_configuration_status));
    }
    return obj;
}

QList OAIStartDataCollectionByAgentIdsResponse::getAgentsConfigurationStatus() const {
    return m_agents_configuration_status;
}
void OAIStartDataCollectionByAgentIdsResponse::setAgentsConfigurationStatus(const QList &agents_configuration_status) {
    m_agents_configuration_status = agents_configuration_status;
    m_agents_configuration_status_isSet = true;
}

bool OAIStartDataCollectionByAgentIdsResponse::is_agents_configuration_status_Set() const{
    return m_agents_configuration_status_isSet;
}

bool OAIStartDataCollectionByAgentIdsResponse::is_agents_configuration_status_Valid() const{
    return m_agents_configuration_status_isValid;
}

bool OAIStartDataCollectionByAgentIdsResponse::isSet() const {
...
bool OAIStartDataCollectionByAgentIdsResponse::isValid() const {
