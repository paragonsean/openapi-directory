...
/*
 * OAIExportDataFormat.h
 *
 * 
 */

#ifndef OAIExportDataFormat_H
#define OAIExportDataFormat_H
...
class OAIExportDataFormat : public OAIEnum {
public:
    OAIExportDataFormat();
    OAIExportDataFormat(QString json);
    ~OAIExportDataFormat() override;
    ...
    enum class eOAIExportDataFormat {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CSV
    };
    OAIExportDataFormat::eOAIExportDataFormat getValue() const;
    void setValue(const OAIExportDataFormat::eOAIExportDataFormat& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportDataFormat)

#endif // OAIExportDataFormat_H
