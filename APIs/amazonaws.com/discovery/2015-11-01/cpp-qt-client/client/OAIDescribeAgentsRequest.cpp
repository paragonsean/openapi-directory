...
OAIDescribeAgentsRequest::OAIDescribeAgentsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAgentsRequest::OAIDescribeAgentsRequest() {
    this->initializeModel();
}

OAIDescribeAgentsRequest::~OAIDescribeAgentsRequest() {}

void OAIDescribeAgentsRequest::initializeModel() {
...
void OAIDescribeAgentsRequest::fromJson(QString jsonString) {
...
void OAIDescribeAgentsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeAgentsRequest::asJson() const {
...
QJsonObject OAIDescribeAgentsRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeAgentsRequest::getAgentIds() const {
    return m_agent_ids;
}
void OAIDescribeAgentsRequest::setAgentIds(const QList &agent_ids) {
    m_agent_ids = agent_ids;
    m_agent_ids_isSet = true;
}

bool OAIDescribeAgentsRequest::is_agent_ids_Set() const{
    return m_agent_ids_isSet;
}

bool OAIDescribeAgentsRequest::is_agent_ids_Valid() const{
    return m_agent_ids_isValid;
}

QList OAIDescribeAgentsRequest::getFilters() const {
    return m_filters;
}
void OAIDescribeAgentsRequest::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIDescribeAgentsRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIDescribeAgentsRequest::is_filters_Valid() const{
    return m_filters_isValid;
}

qint32 OAIDescribeAgentsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeAgentsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeAgentsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeAgentsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeAgentsRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeAgentsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeAgentsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeAgentsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeAgentsRequest::isSet() const {
...
bool OAIDescribeAgentsRequest::isValid() const {
