...
/*
 * OAIAssociateConfigurationItemsToApplicationRequest.h
 *
 * 
 */

#ifndef OAIAssociateConfigurationItemsToApplicationRequest_H
#define OAIAssociateConfigurationItemsToApplicationRequest_H
...
class OAIAssociateConfigurationItemsToApplicationRequest : public OAIObject {
public:
    OAIAssociateConfigurationItemsToApplicationRequest();
    OAIAssociateConfigurationItemsToApplicationRequest(QString json);
    ~OAIAssociateConfigurationItemsToApplicationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateConfigurationItemsToApplicationRequest)

#endif // OAIAssociateConfigurationItemsToApplicationRequest_H
