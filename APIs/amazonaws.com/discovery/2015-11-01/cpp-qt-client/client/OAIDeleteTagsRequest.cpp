...
QList OAIDeleteTagsRequest::getConfigurationIds() const {
    return m_configuration_ids;
}
void OAIDeleteTagsRequest::setConfigurationIds(const QList &configuration_ids) {
    m_configuration_ids = configuration_ids;
    m_configuration_ids_isSet = true;
}

bool OAIDeleteTagsRequest::is_configuration_ids_Set() const{
    return m_configuration_ids_isSet;
}

bool OAIDeleteTagsRequest::is_configuration_ids_Valid() const{
    return m_configuration_ids_isValid;
}

QList OAIDeleteTagsRequest::getTags() const {
    return m_tags;
}
void OAIDeleteTagsRequest::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIDeleteTagsRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIDeleteTagsRequest::is_tags_Valid() const{
