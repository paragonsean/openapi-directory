...
/*
 * OAIStartImportTaskRequest.h
 *
 * 
 */

#ifndef OAIStartImportTaskRequest_H
#define OAIStartImportTaskRequest_H
...
class OAIStartImportTaskRequest : public OAIObject {
public:
    OAIStartImportTaskRequest();
    OAIStartImportTaskRequest(QString json);
    ~OAIStartImportTaskRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartImportTaskRequest)

#endif // OAIStartImportTaskRequest_H
