...
#ifndef OAIOrderString_H
#define OAIOrderString_H
...
class OAIOrderString : public OAIEnum {
public:
    OAIOrderString();
    OAIOrderString(QString json);
    ~OAIOrderString() override;
    ...
    enum class eOAIOrderString {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ASC, 
        DESC
    };
    OAIOrderString::eOAIOrderString getValue() const;
    void setValue(const OAIOrderString::eOAIOrderString& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderString)

#endif // OAIOrderString_H
