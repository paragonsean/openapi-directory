...
/*
 * OAIListConfigurationsRequest.h
 *
 * 
 */

#ifndef OAIListConfigurationsRequest_H
#define OAIListConfigurationsRequest_H
...
class OAIListConfigurationsRequest : public OAIObject {
public:
    OAIListConfigurationsRequest();
    OAIListConfigurationsRequest(QString json);
    ~OAIListConfigurationsRequest() override;
    ...
    QList getOrderBy() const;
    void setOrderBy(const QList &order_by);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListConfigurationsRequest)

#endif // OAIListConfigurationsRequest_H
