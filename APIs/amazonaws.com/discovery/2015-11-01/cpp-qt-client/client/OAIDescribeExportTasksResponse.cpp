...
QList OAIDescribeExportTasksResponse::getExportsInfo() const {
    return m_exports_info;
}
void OAIDescribeExportTasksResponse::setExportsInfo(const QList &exports_info) {
    m_exports_info = exports_info;
    m_exports_info_isSet = true;
}

bool OAIDescribeExportTasksResponse::is_exports_info_Set() const{
    return m_exports_info_isSet;
}

bool OAIDescribeExportTasksResponse::is_exports_info_Valid() const{
