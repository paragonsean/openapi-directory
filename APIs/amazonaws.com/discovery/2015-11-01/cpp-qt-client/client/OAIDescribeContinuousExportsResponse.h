...
/*
 * OAIDescribeContinuousExportsResponse.h
 *
 * 
 */

#ifndef OAIDescribeContinuousExportsResponse_H
#define OAIDescribeContinuousExportsResponse_H
...
class OAIDescribeContinuousExportsResponse : public OAIObject {
public:
    OAIDescribeContinuousExportsResponse();
    OAIDescribeContinuousExportsResponse(QString json);
    ~OAIDescribeContinuousExportsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeContinuousExportsResponse)

#endif // OAIDescribeContinuousExportsResponse_H
