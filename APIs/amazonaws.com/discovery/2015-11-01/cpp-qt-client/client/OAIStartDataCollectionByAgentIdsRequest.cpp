...
OAIStartDataCollectionByAgentIdsRequest::OAIStartDataCollectionByAgentIdsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartDataCollectionByAgentIdsRequest::OAIStartDataCollectionByAgentIdsRequest() {
    this->initializeModel();
}

OAIStartDataCollectionByAgentIdsRequest::~OAIStartDataCollectionByAgentIdsRequest() {}

void OAIStartDataCollectionByAgentIdsRequest::initializeModel() {

    m_agent_ids_isSet = false;
    m_agent_ids_isValid = false;
}

void OAIStartDataCollectionByAgentIdsRequest::fromJson(QString jsonString) {
...
void OAIStartDataCollectionByAgentIdsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStartDataCollectionByAgentIdsRequest::asJson() const {
...
QJsonObject OAIStartDataCollectionByAgentIdsRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIStartDataCollectionByAgentIdsRequest::getAgentIds() const {
    return m_agent_ids;
}
void OAIStartDataCollectionByAgentIdsRequest::setAgentIds(const QList &agent_ids) {
    m_agent_ids = agent_ids;
    m_agent_ids_isSet = true;
}

bool OAIStartDataCollectionByAgentIdsRequest::is_agent_ids_Set() const{
    return m_agent_ids_isSet;
}

bool OAIStartDataCollectionByAgentIdsRequest::is_agent_ids_Valid() const{
    return m_agent_ids_isValid;
}

bool OAIStartDataCollectionByAgentIdsRequest::isSet() const {
...
bool OAIStartDataCollectionByAgentIdsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_agent_ids_isValid && true;
}
