...
/*
 * OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis.h
 *
 * 
 */

#ifndef OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis_H
#define OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis_H
...
class OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis : public OAIObject {
public:
    OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis();
    OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis(QString json);
    ~OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis() override;
    ...
    void setPercentageAdjust(const double &percentage_adjust);
    bool is_percentage_adjust_Set() const;
    bool is_percentage_adjust_Valid() const;
...
private:
    ...
    double m_percentage_adjust;
    bool m_percentage_adjust_isSet;
    bool m_percentage_adjust_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis)

#endif // OAIEc2RecommendationsExportPreferences_ramPerformanceMetricBasis_H
