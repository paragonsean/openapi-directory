...
/**
 * Gets or Sets orderString
 */
@JsonAdapter(OrderString.Adapter.class)
public enum OrderString {
  ...
  public static OrderString fromValue(String value) {
    for (OrderString b : OrderString.values()) {
  ...
  public static class Adapter extends TypeAdapter<OrderString> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderString enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderString read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderString.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OrderString.fromValue(value);
  }
}
