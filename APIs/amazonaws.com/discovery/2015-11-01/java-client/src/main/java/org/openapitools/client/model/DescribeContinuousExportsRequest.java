...
public class DescribeContinuousExportsRequest {
  ...
  public DescribeContinuousExportsRequest exportIds(List exportIds) {
  ...
  public DescribeContinuousExportsRequest maxResults(Integer maxResults) {
  ...
  public DescribeContinuousExportsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeContinuousExportsRequest describeContinuousExportsRequest = (DescribeContinuousExportsRequest) o;
    return Objects.equals(this.exportIds, describeContinuousExportsRequest.exportIds) &&
        Objects.equals(this.maxResults, describeContinuousExportsRequest.maxResults) &&
        Objects.equals(this.nextToken, describeContinuousExportsRequest.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeContinuousExportsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeContinuousExportsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeContinuousExportsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeContinuousExportsRequest is not found in the empty JSON string", DescribeContinuousExportsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeContinuousExportsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeContinuousExportsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeContinuousExportsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeContinuousExportsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeContinuousExportsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeContinuousExportsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeContinuousExportsRequest>() {
           @Override
           public void write(JsonWriter out, DescribeContinuousExportsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeContinuousExportsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeContinuousExportsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeContinuousExportsRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeContinuousExportsRequest
   */
  public static DescribeContinuousExportsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeContinuousExportsRequest.class);
  }

  /**
   * Convert an instance of DescribeContinuousExportsRequest to an JSON string
   *
   * @return JSON string
   */
