...
public class Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis {
  ...
  public Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis() {
  }

  public Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis percentageAdjust(Double percentageAdjust) {
  ...
  public boolean equals(Object o) {
    ...
    Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis ec2RecommendationsExportPreferencesRamPerformanceMetricBasis = (Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis) o;
    return Objects.equals(this.name, ec2RecommendationsExportPreferencesRamPerformanceMetricBasis.name) &&
        Objects.equals(this.percentageAdjust, ec2RecommendationsExportPreferencesRamPerformanceMetricBasis.percentageAdjust);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis is not found in the empty JSON string", Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis.class));

       return (TypeAdapter<T>) new TypeAdapter<Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis>() {
           @Override
           public void write(JsonWriter out, Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis
   * @throws IOException if the JSON string is invalid with respect to Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis
   */
  public static Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis.class);
  }

  /**
   * Convert an instance of Ec2RecommendationsExportPreferencesRamPerformanceMetricBasis to an JSON string
   *
   * @return JSON string
   */
