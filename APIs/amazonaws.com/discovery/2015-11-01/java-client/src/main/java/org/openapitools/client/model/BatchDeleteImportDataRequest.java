...
public class BatchDeleteImportDataRequest {
  public static final String SERIALIZED_NAME_IMPORT_TASK_IDS = "importTaskIds";
  @SerializedName(SERIALIZED_NAME_IMPORT_TASK_IDS)
  private List importTaskIds;

  public BatchDeleteImportDataRequest() {
  }

  public BatchDeleteImportDataRequest importTaskIds(List importTaskIds) {
  ...
  public List getImportTaskIds() {
    return importTaskIds;
  }

  public void setImportTaskIds(List importTaskIds) {
    this.importTaskIds = importTaskIds;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchDeleteImportDataRequest batchDeleteImportDataRequest = (BatchDeleteImportDataRequest) o;
    return Objects.equals(this.importTaskIds, batchDeleteImportDataRequest.importTaskIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(importTaskIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchDeleteImportDataRequest {\n");
    sb.append("    importTaskIds: ").append(toIndentedString(importTaskIds)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("importTaskIds");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("importTaskIds");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchDeleteImportDataRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchDeleteImportDataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchDeleteImportDataRequest is not found in the empty JSON string", BatchDeleteImportDataRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchDeleteImportDataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchDeleteImportDataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchDeleteImportDataRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `importTaskIds`
      List.validateJsonElement(jsonObj.get("importTaskIds"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchDeleteImportDataRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchDeleteImportDataRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchDeleteImportDataRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchDeleteImportDataRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchDeleteImportDataRequest>() {
           @Override
           public void write(JsonWriter out, BatchDeleteImportDataRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchDeleteImportDataRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchDeleteImportDataRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchDeleteImportDataRequest
   * @throws IOException if the JSON string is invalid with respect to BatchDeleteImportDataRequest
   */
  public static BatchDeleteImportDataRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchDeleteImportDataRequest.class);
  }

  /**
   * Convert an instance of BatchDeleteImportDataRequest to an JSON string
   *
   * @return JSON string
   */
