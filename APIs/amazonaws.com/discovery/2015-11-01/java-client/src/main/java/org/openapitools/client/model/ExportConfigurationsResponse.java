...
public class ExportConfigurationsResponse {
  ...
  public ExportConfigurationsResponse exportId(String exportId) {
  ...
  public boolean equals(Object o) {
    ...
    ExportConfigurationsResponse exportConfigurationsResponse = (ExportConfigurationsResponse) o;
    return Objects.equals(this.exportId, exportConfigurationsResponse.exportId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportConfigurationsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportConfigurationsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportConfigurationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportConfigurationsResponse is not found in the empty JSON string", ExportConfigurationsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportConfigurationsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportConfigurationsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportConfigurationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportConfigurationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportConfigurationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportConfigurationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportConfigurationsResponse>() {
           @Override
           public void write(JsonWriter out, ExportConfigurationsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportConfigurationsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportConfigurationsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportConfigurationsResponse
   * @throws IOException if the JSON string is invalid with respect to ExportConfigurationsResponse
   */
  public static ExportConfigurationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportConfigurationsResponse.class);
  }

  /**
   * Convert an instance of ExportConfigurationsResponse to an JSON string
   *
   * @return JSON string
   */
