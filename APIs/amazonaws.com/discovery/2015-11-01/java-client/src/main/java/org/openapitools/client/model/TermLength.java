...
/**
 * Gets or Sets TermLength
 */
@JsonAdapter(TermLength.Adapter.class)
public enum TermLength {
  ...
  public static TermLength fromValue(String value) {
    for (TermLength b : TermLength.values()) {
  ...
  public static class Adapter extends TypeAdapter<TermLength> {
    @Override
    public void write(final JsonWriter jsonWriter, final TermLength enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TermLength read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TermLength.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TermLength.fromValue(value);
  }
}
