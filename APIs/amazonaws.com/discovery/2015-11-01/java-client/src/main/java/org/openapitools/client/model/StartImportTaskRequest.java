...
public class StartImportTaskRequest {
  ...
  public StartImportTaskRequest() {
  }

  public StartImportTaskRequest clientRequestToken(String clientRequestToken) {
  ...
  public StartImportTaskRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StartImportTaskRequest importUrl(String importUrl) {
  ...
  public boolean equals(Object o) {
    ...
    StartImportTaskRequest startImportTaskRequest = (StartImportTaskRequest) o;
    return Objects.equals(this.clientRequestToken, startImportTaskRequest.clientRequestToken) &&
        Objects.equals(this.name, startImportTaskRequest.name) &&
        Objects.equals(this.importUrl, startImportTaskRequest.importUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientRequestToken, name, importUrl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartImportTaskRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("importUrl");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartImportTaskRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartImportTaskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartImportTaskRequest is not found in the empty JSON string", StartImportTaskRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartImportTaskRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartImportTaskRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartImportTaskRequest.openapiRequiredFields) {
      ...
      // validate the required field `importUrl`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartImportTaskRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartImportTaskRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartImportTaskRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartImportTaskRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartImportTaskRequest>() {
           @Override
           public void write(JsonWriter out, StartImportTaskRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartImportTaskRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartImportTaskRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartImportTaskRequest
   * @throws IOException if the JSON string is invalid with respect to StartImportTaskRequest
   */
  public static StartImportTaskRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartImportTaskRequest.class);
  }

  /**
   * Convert an instance of StartImportTaskRequest to an JSON string
   *
   * @return JSON string
   */
