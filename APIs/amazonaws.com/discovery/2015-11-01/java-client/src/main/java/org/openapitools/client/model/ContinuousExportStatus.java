...
/**
 * Gets or Sets ContinuousExportStatus
 */
@JsonAdapter(ContinuousExportStatus.Adapter.class)
public enum ContinuousExportStatus {
  ...
  ContinuousExportStatus(String value) {
    this.value = value;
  }
  ...
  public static ContinuousExportStatus fromValue(String value) {
    for (ContinuousExportStatus b : ContinuousExportStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ContinuousExportStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ContinuousExportStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ContinuousExportStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ContinuousExportStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ContinuousExportStatus.fromValue(value);
  }
}
