...
public class OrderByElement {
  ...
  private OrderString sortOrder;

  public OrderByElement() {
  }

  public OrderByElement fieldName(String fieldName) {
  ...
  public OrderByElement sortOrder(OrderString sortOrder) {
  ...
  public OrderString getSortOrder() {
    return sortOrder;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fieldName, orderByElement.fieldName) &&
        Objects.equals(this.sortOrder, orderByElement.sortOrder);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderByElement
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderByElement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderByElement is not found in the empty JSON string", OrderByElement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderByElement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderByElement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderByElement.openapiRequiredFields) {
      ...
      if (jsonObj.get("sortOrder") != null && !jsonObj.get("sortOrder").isJsonNull()) {
        OrderString.validateJsonElement(jsonObj.get("sortOrder"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderByElement.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderByElement' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderByElement> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderByElement.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderByElement>() {
           @Override
           public void write(JsonWriter out, OrderByElement value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderByElement read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderByElement given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderByElement
   * @throws IOException if the JSON string is invalid with respect to OrderByElement
   */
  public static OrderByElement fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderByElement.class);
  }

  /**
   * Convert an instance of OrderByElement to an JSON string
   *
   * @return JSON string
   */
