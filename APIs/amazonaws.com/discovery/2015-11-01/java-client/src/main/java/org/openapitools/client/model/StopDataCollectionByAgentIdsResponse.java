...
public class StopDataCollectionByAgentIdsResponse {
  ...
  public StopDataCollectionByAgentIdsResponse agentsConfigurationStatus(List agentsConfigurationStatus) {
  ...
  public boolean equals(Object o) {
    ...
    StopDataCollectionByAgentIdsResponse stopDataCollectionByAgentIdsResponse = (StopDataCollectionByAgentIdsResponse) o;
    return Objects.equals(this.agentsConfigurationStatus, stopDataCollectionByAgentIdsResponse.agentsConfigurationStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopDataCollectionByAgentIdsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopDataCollectionByAgentIdsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopDataCollectionByAgentIdsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopDataCollectionByAgentIdsResponse is not found in the empty JSON string", StopDataCollectionByAgentIdsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopDataCollectionByAgentIdsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopDataCollectionByAgentIdsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopDataCollectionByAgentIdsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopDataCollectionByAgentIdsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopDataCollectionByAgentIdsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopDataCollectionByAgentIdsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StopDataCollectionByAgentIdsResponse>() {
           @Override
           public void write(JsonWriter out, StopDataCollectionByAgentIdsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopDataCollectionByAgentIdsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopDataCollectionByAgentIdsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopDataCollectionByAgentIdsResponse
   * @throws IOException if the JSON string is invalid with respect to StopDataCollectionByAgentIdsResponse
   */
  public static StopDataCollectionByAgentIdsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopDataCollectionByAgentIdsResponse.class);
  }

  /**
   * Convert an instance of StopDataCollectionByAgentIdsResponse to an JSON string
   *
   * @return JSON string
   */
