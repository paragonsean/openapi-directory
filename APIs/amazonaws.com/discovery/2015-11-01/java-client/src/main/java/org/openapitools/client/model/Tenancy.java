 ...
 */
@JsonAdapter(Tenancy.Adapter.class)
public enum Tenancy {
  ...
  public static class Adapter extends TypeAdapter<Tenancy> {
    @Override
    public void write(final JsonWriter jsonWriter, final Tenancy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public Tenancy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return Tenancy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    Tenancy.fromValue(value);
  }
}
