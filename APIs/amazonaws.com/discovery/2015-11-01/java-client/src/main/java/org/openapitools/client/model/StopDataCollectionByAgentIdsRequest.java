...
public class StopDataCollectionByAgentIdsRequest {
  ...
  public StopDataCollectionByAgentIdsRequest() {
  }

  public StopDataCollectionByAgentIdsRequest agentIds(List agentIds) {
  ...
  public boolean equals(Object o) {
    ...
    StopDataCollectionByAgentIdsRequest stopDataCollectionByAgentIdsRequest = (StopDataCollectionByAgentIdsRequest) o;
    return Objects.equals(this.agentIds, stopDataCollectionByAgentIdsRequest.agentIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopDataCollectionByAgentIdsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopDataCollectionByAgentIdsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopDataCollectionByAgentIdsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopDataCollectionByAgentIdsRequest is not found in the empty JSON string", StopDataCollectionByAgentIdsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopDataCollectionByAgentIdsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopDataCollectionByAgentIdsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StopDataCollectionByAgentIdsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopDataCollectionByAgentIdsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopDataCollectionByAgentIdsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopDataCollectionByAgentIdsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopDataCollectionByAgentIdsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StopDataCollectionByAgentIdsRequest>() {
           @Override
           public void write(JsonWriter out, StopDataCollectionByAgentIdsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopDataCollectionByAgentIdsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopDataCollectionByAgentIdsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopDataCollectionByAgentIdsRequest
   * @throws IOException if the JSON string is invalid with respect to StopDataCollectionByAgentIdsRequest
   */
  public static StopDataCollectionByAgentIdsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopDataCollectionByAgentIdsRequest.class);
  }

  /**
   * Convert an instance of StopDataCollectionByAgentIdsRequest to an JSON string
   *
   * @return JSON string
   */
