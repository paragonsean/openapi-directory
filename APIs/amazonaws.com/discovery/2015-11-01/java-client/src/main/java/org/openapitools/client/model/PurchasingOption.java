...
/**
 * Gets or Sets PurchasingOption
 */
@JsonAdapter(PurchasingOption.Adapter.class)
public enum PurchasingOption {
  ...
  public static PurchasingOption fromValue(String value) {
    for (PurchasingOption b : PurchasingOption.values()) {
  ...
  public static class Adapter extends TypeAdapter<PurchasingOption> {
    @Override
    public void write(final JsonWriter jsonWriter, final PurchasingOption enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PurchasingOption read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PurchasingOption.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PurchasingOption.fromValue(value);
  }
}
