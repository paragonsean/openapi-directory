...
public class AgentConfigurationStatus {
  ...
  public AgentConfigurationStatus agentId(String agentId) {
  ...
  public AgentConfigurationStatus operationSucceeded(Boolean operationSucceeded) {
  ...
  public AgentConfigurationStatus description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    AgentConfigurationStatus agentConfigurationStatus = (AgentConfigurationStatus) o;
    return Objects.equals(this.agentId, agentConfigurationStatus.agentId) &&
        Objects.equals(this.operationSucceeded, agentConfigurationStatus.operationSucceeded) &&
        Objects.equals(this.description, agentConfigurationStatus.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(agentId, operationSucceeded, description);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AgentConfigurationStatus {\n");
  ...
  static {
    ...
    openapiFields.add("operationSucceeded");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentConfigurationStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentConfigurationStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AgentConfigurationStatus is not found in the empty JSON string", AgentConfigurationStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AgentConfigurationStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AgentConfigurationStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `operationSucceeded`
      if (jsonObj.get("operationSucceeded") != null && !jsonObj.get("operationSucceeded").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("operationSucceeded"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentConfigurationStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentConfigurationStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentConfigurationStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentConfigurationStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentConfigurationStatus>() {
           @Override
           public void write(JsonWriter out, AgentConfigurationStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AgentConfigurationStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AgentConfigurationStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentConfigurationStatus
   * @throws IOException if the JSON string is invalid with respect to AgentConfigurationStatus
   */
  public static AgentConfigurationStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentConfigurationStatus.class);
  }

  /**
   * Convert an instance of AgentConfigurationStatus to an JSON string
   *
   * @return JSON string
   */
