...
public class DescribeExportConfigurationsRequest {
  ...
  public DescribeExportConfigurationsRequest exportIds(List exportIds) {
  ...
  public DescribeExportConfigurationsRequest maxResults(Integer maxResults) {
  ...
  public DescribeExportConfigurationsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeExportConfigurationsRequest describeExportConfigurationsRequest = (DescribeExportConfigurationsRequest) o;
    return Objects.equals(this.exportIds, describeExportConfigurationsRequest.exportIds) &&
        Objects.equals(this.maxResults, describeExportConfigurationsRequest.maxResults) &&
        Objects.equals(this.nextToken, describeExportConfigurationsRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exportIds, maxResults, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeExportConfigurationsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeExportConfigurationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeExportConfigurationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeExportConfigurationsRequest is not found in the empty JSON string", DescribeExportConfigurationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeExportConfigurationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeExportConfigurationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeExportConfigurationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeExportConfigurationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeExportConfigurationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeExportConfigurationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeExportConfigurationsRequest>() {
           @Override
           public void write(JsonWriter out, DescribeExportConfigurationsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeExportConfigurationsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeExportConfigurationsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeExportConfigurationsRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeExportConfigurationsRequest
   */
  public static DescribeExportConfigurationsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeExportConfigurationsRequest.class);
  }

  /**
   * Convert an instance of DescribeExportConfigurationsRequest to an JSON string
   *
   * @return JSON string
   */
