...
public class ListServerNeighborsRequest {
  ...
  public static final String SERIALIZED_NAME_PORT_INFORMATION_NEEDED = "portInformationNeeded";
  @SerializedName(SERIALIZED_NAME_PORT_INFORMATION_NEEDED)
  private Boolean portInformationNeeded;

  public static final String SERIALIZED_NAME_NEIGHBOR_CONFIGURATION_IDS = "neighborConfigurationIds";
  @SerializedName(SERIALIZED_NAME_NEIGHBOR_CONFIGURATION_IDS)
  private List neighborConfigurationIds;
  ...
  public ListServerNeighborsRequest() {
  }

  public ListServerNeighborsRequest configurationId(String configurationId) {
  ...
  public ListServerNeighborsRequest portInformationNeeded(Boolean portInformationNeeded) {
    this.portInformationNeeded = portInformationNeeded;
    return this;
  }

  /**
   * Get portInformationNeeded
  ...
  public ListServerNeighborsRequest neighborConfigurationIds(List neighborConfigurationIds) {
    this.neighborConfigurationIds = neighborConfigurationIds;
    return this;
  }

  /**
   * Get neighborConfigurationIds
   * @return neighborConfigurationIds
   */
  @javax.annotation.Nullable
  public List getNeighborConfigurationIds() {
    return neighborConfigurationIds;
  }

  public void setNeighborConfigurationIds(List neighborConfigurationIds) {
    this.neighborConfigurationIds = neighborConfigurationIds;
  }


  public ListServerNeighborsRequest maxResults(Integer maxResults) {
  ...
  public ListServerNeighborsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListServerNeighborsRequest listServerNeighborsRequest = (ListServerNeighborsRequest) o;
    return Objects.equals(this.configurationId, listServerNeighborsRequest.configurationId) &&
        Objects.equals(this.portInformationNeeded, listServerNeighborsRequest.portInformationNeeded) &&
        Objects.equals(this.neighborConfigurationIds, listServerNeighborsRequest.neighborConfigurationIds) &&
        Objects.equals(this.maxResults, listServerNeighborsRequest.maxResults) &&
        Objects.equals(this.nextToken, listServerNeighborsRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configurationId, portInformationNeeded, neighborConfigurationIds, maxResults, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListServerNeighborsRequest {\n");
    sb.append("    configurationId: ").append(toIndentedString(configurationId)).append("\n");
    sb.append("    portInformationNeeded: ").append(toIndentedString(portInformationNeeded)).append("\n");
    sb.append("    neighborConfigurationIds: ").append(toIndentedString(neighborConfigurationIds)).append("\n");
  ...
  static {
    ...
    openapiFields.add("portInformationNeeded");
    openapiFields.add("neighborConfigurationIds");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListServerNeighborsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListServerNeighborsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListServerNeighborsRequest is not found in the empty JSON string", ListServerNeighborsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListServerNeighborsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListServerNeighborsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListServerNeighborsRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("portInformationNeeded") != null && !jsonObj.get("portInformationNeeded").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("portInformationNeeded"));
      }
      // validate the optional field `neighborConfigurationIds`
      if (jsonObj.get("neighborConfigurationIds") != null && !jsonObj.get("neighborConfigurationIds").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("neighborConfigurationIds"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListServerNeighborsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListServerNeighborsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListServerNeighborsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListServerNeighborsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListServerNeighborsRequest>() {
           @Override
           public void write(JsonWriter out, ListServerNeighborsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListServerNeighborsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListServerNeighborsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListServerNeighborsRequest
   * @throws IOException if the JSON string is invalid with respect to ListServerNeighborsRequest
   */
  public static ListServerNeighborsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListServerNeighborsRequest.class);
  }

  /**
   * Convert an instance of ListServerNeighborsRequest to an JSON string
   *
   * @return JSON string
   */
