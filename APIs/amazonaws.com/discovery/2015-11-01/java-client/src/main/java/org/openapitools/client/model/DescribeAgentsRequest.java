...
public class DescribeAgentsRequest {
  ...
  public DescribeAgentsRequest agentIds(List agentIds) {
  ...
  public DescribeAgentsRequest filters(List filters) {
  ...
  public DescribeAgentsRequest maxResults(Integer maxResults) {
  ...
  public DescribeAgentsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAgentsRequest describeAgentsRequest = (DescribeAgentsRequest) o;
    return Objects.equals(this.agentIds, describeAgentsRequest.agentIds) &&
        Objects.equals(this.filters, describeAgentsRequest.filters) &&
        Objects.equals(this.maxResults, describeAgentsRequest.maxResults) &&
        Objects.equals(this.nextToken, describeAgentsRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(agentIds, filters, maxResults, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeAgentsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAgentsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAgentsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAgentsRequest is not found in the empty JSON string", DescribeAgentsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAgentsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAgentsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAgentsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAgentsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAgentsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAgentsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAgentsRequest>() {
           @Override
           public void write(JsonWriter out, DescribeAgentsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAgentsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAgentsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAgentsRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeAgentsRequest
   */
  public static DescribeAgentsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAgentsRequest.class);
  }

  /**
   * Convert an instance of DescribeAgentsRequest to an JSON string
   *
   * @return JSON string
   */
