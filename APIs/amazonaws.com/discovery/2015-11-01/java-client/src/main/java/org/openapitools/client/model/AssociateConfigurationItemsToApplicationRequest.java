...
public class AssociateConfigurationItemsToApplicationRequest {
  public static final String SERIALIZED_NAME_APPLICATION_CONFIGURATION_ID = "applicationConfigurationId";
  @SerializedName(SERIALIZED_NAME_APPLICATION_CONFIGURATION_ID)
  ...
  public AssociateConfigurationItemsToApplicationRequest applicationConfigurationId(String applicationConfigurationId) {
    this.applicationConfigurationId = applicationConfigurationId;
    return this;
  }

  /**
   * Get applicationConfigurationId
  ...
  public AssociateConfigurationItemsToApplicationRequest configurationIds(List configurationIds) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateConfigurationItemsToApplicationRequest associateConfigurationItemsToApplicationRequest = (AssociateConfigurationItemsToApplicationRequest) o;
    return Objects.equals(this.applicationConfigurationId, associateConfigurationItemsToApplicationRequest.applicationConfigurationId) &&
        Objects.equals(this.configurationIds, associateConfigurationItemsToApplicationRequest.configurationIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicationConfigurationId, configurationIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssociateConfigurationItemsToApplicationRequest {\n");
    sb.append("    applicationConfigurationId: ").append(toIndentedString(applicationConfigurationId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("applicationConfigurationId");
    openapiFields.add("configurationIds");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("applicationConfigurationId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateConfigurationItemsToApplicationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateConfigurationItemsToApplicationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateConfigurationItemsToApplicationRequest is not found in the empty JSON string", AssociateConfigurationItemsToApplicationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateConfigurationItemsToApplicationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateConfigurationItemsToApplicationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssociateConfigurationItemsToApplicationRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `applicationConfigurationId`
      String.validateJsonElement(jsonObj.get("applicationConfigurationId"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateConfigurationItemsToApplicationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateConfigurationItemsToApplicationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateConfigurationItemsToApplicationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateConfigurationItemsToApplicationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateConfigurationItemsToApplicationRequest>() {
           @Override
           public void write(JsonWriter out, AssociateConfigurationItemsToApplicationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateConfigurationItemsToApplicationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateConfigurationItemsToApplicationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateConfigurationItemsToApplicationRequest
   * @throws IOException if the JSON string is invalid with respect to AssociateConfigurationItemsToApplicationRequest
   */
  public static AssociateConfigurationItemsToApplicationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateConfigurationItemsToApplicationRequest.class);
  }

  /**
   * Convert an instance of AssociateConfigurationItemsToApplicationRequest to an JSON string
   *
   * @return JSON string
   */
