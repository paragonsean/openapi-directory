...
public class DescribeConfigurationsRequest {
  ...
  public DescribeConfigurationsRequest configurationIds(List configurationIds) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeConfigurationsRequest describeConfigurationsRequest = (DescribeConfigurationsRequest) o;
    return Objects.equals(this.configurationIds, describeConfigurationsRequest.configurationIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configurationIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeConfigurationsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeConfigurationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeConfigurationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeConfigurationsRequest is not found in the empty JSON string", DescribeConfigurationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeConfigurationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeConfigurationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeConfigurationsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeConfigurationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeConfigurationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeConfigurationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeConfigurationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeConfigurationsRequest>() {
           @Override
           public void write(JsonWriter out, DescribeConfigurationsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeConfigurationsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeConfigurationsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeConfigurationsRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeConfigurationsRequest
   */
  public static DescribeConfigurationsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeConfigurationsRequest.class);
  }

  /**
   * Convert an instance of DescribeConfigurationsRequest to an JSON string
   *
   * @return JSON string
   */
