...
import org.openapitools.client.model.ExportPreferencesEc2RecommendationsPreferences;
...
public class StartExportTaskRequestPreferences {
  public static final String SERIALIZED_NAME_EC2_RECOMMENDATIONS_PREFERENCES = "ec2RecommendationsPreferences";
  @SerializedName(SERIALIZED_NAME_EC2_RECOMMENDATIONS_PREFERENCES)
  private ExportPreferencesEc2RecommendationsPreferences ec2RecommendationsPreferences;

  public StartExportTaskRequestPreferences() {
  }

  public StartExportTaskRequestPreferences ec2RecommendationsPreferences(ExportPreferencesEc2RecommendationsPreferences ec2RecommendationsPreferences) {
    this.ec2RecommendationsPreferences = ec2RecommendationsPreferences;
    return this;
  }

  /**
   * Get ec2RecommendationsPreferences
   * @return ec2RecommendationsPreferences
   */
  @javax.annotation.Nullable
  public ExportPreferencesEc2RecommendationsPreferences getEc2RecommendationsPreferences() {
    return ec2RecommendationsPreferences;
  }

  public void setEc2RecommendationsPreferences(ExportPreferencesEc2RecommendationsPreferences ec2RecommendationsPreferences) {
    this.ec2RecommendationsPreferences = ec2RecommendationsPreferences;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartExportTaskRequestPreferences startExportTaskRequestPreferences = (StartExportTaskRequestPreferences) o;
    return Objects.equals(this.ec2RecommendationsPreferences, startExportTaskRequestPreferences.ec2RecommendationsPreferences);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ec2RecommendationsPreferences);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartExportTaskRequestPreferences {\n");
    sb.append("    ec2RecommendationsPreferences: ").append(toIndentedString(ec2RecommendationsPreferences)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("ec2RecommendationsPreferences");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartExportTaskRequestPreferences
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartExportTaskRequestPreferences.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartExportTaskRequestPreferences is not found in the empty JSON string", StartExportTaskRequestPreferences.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartExportTaskRequestPreferences.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartExportTaskRequestPreferences` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ec2RecommendationsPreferences`
      if (jsonObj.get("ec2RecommendationsPreferences") != null && !jsonObj.get("ec2RecommendationsPreferences").isJsonNull()) {
        ExportPreferencesEc2RecommendationsPreferences.validateJsonElement(jsonObj.get("ec2RecommendationsPreferences"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartExportTaskRequestPreferences.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartExportTaskRequestPreferences' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartExportTaskRequestPreferences> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartExportTaskRequestPreferences.class));

       return (TypeAdapter<T>) new TypeAdapter<StartExportTaskRequestPreferences>() {
           @Override
           public void write(JsonWriter out, StartExportTaskRequestPreferences value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartExportTaskRequestPreferences read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartExportTaskRequestPreferences given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartExportTaskRequestPreferences
   * @throws IOException if the JSON string is invalid with respect to StartExportTaskRequestPreferences
   */
  public static StartExportTaskRequestPreferences fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartExportTaskRequestPreferences.class);
  }

  /**
   * Convert an instance of StartExportTaskRequestPreferences to an JSON string
   *
   * @return JSON string
   */
