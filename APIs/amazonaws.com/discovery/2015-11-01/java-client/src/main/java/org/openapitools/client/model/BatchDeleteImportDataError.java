...
import org.openapitools.client.model.BatchDeleteImportDataErrorCode;
...
public class BatchDeleteImportDataError {
  ...
  private BatchDeleteImportDataErrorCode errorCode;
  ...
  public BatchDeleteImportDataError importTaskId(String importTaskId) {
  ...
  public BatchDeleteImportDataError errorCode(BatchDeleteImportDataErrorCode errorCode) {
   ...
   */
  @javax.annotation.Nullable
  public BatchDeleteImportDataErrorCode getErrorCode() {
    return errorCode;
  }

  public void setErrorCode(BatchDeleteImportDataErrorCode errorCode) {
    this.errorCode = errorCode;
  }


  public BatchDeleteImportDataError errorDescription(String errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    BatchDeleteImportDataError batchDeleteImportDataError = (BatchDeleteImportDataError) o;
    return Objects.equals(this.importTaskId, batchDeleteImportDataError.importTaskId) &&
        Objects.equals(this.errorCode, batchDeleteImportDataError.errorCode) &&
        Objects.equals(this.errorDescription, batchDeleteImportDataError.errorDescription);
  }

  @Override
  public int hashCode() {
    return Objects.hash(importTaskId, errorCode, errorDescription);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchDeleteImportDataError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchDeleteImportDataError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchDeleteImportDataError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchDeleteImportDataError is not found in the empty JSON string", BatchDeleteImportDataError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchDeleteImportDataError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchDeleteImportDataError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("errorCode") != null && !jsonObj.get("errorCode").isJsonNull()) {
        BatchDeleteImportDataErrorCode.validateJsonElement(jsonObj.get("errorCode"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchDeleteImportDataError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchDeleteImportDataError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchDeleteImportDataError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchDeleteImportDataError.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchDeleteImportDataError>() {
           @Override
           public void write(JsonWriter out, BatchDeleteImportDataError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchDeleteImportDataError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchDeleteImportDataError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchDeleteImportDataError
   * @throws IOException if the JSON string is invalid with respect to BatchDeleteImportDataError
   */
  public static BatchDeleteImportDataError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchDeleteImportDataError.class);
  }

  /**
   * Convert an instance of BatchDeleteImportDataError to an JSON string
   *
   * @return JSON string
   */
