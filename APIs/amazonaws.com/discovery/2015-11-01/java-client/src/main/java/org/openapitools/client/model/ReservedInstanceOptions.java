...
public class ReservedInstanceOptions {
  ...
  public ReservedInstanceOptions() {
  }

  public ReservedInstanceOptions purchasingOption(PurchasingOption purchasingOption) {
  ...
  public ReservedInstanceOptions offeringClass(OfferingClass offeringClass) {
  ...
  public ReservedInstanceOptions termLength(TermLength termLength) {
  ...
  public boolean equals(Object o) {
    ...
    ReservedInstanceOptions reservedInstanceOptions = (ReservedInstanceOptions) o;
    return Objects.equals(this.purchasingOption, reservedInstanceOptions.purchasingOption) &&
        Objects.equals(this.offeringClass, reservedInstanceOptions.offeringClass) &&
        Objects.equals(this.termLength, reservedInstanceOptions.termLength);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReservedInstanceOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReservedInstanceOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReservedInstanceOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservedInstanceOptions is not found in the empty JSON string", ReservedInstanceOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReservedInstanceOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReservedInstanceOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReservedInstanceOptions.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservedInstanceOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservedInstanceOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservedInstanceOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservedInstanceOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservedInstanceOptions>() {
           @Override
           public void write(JsonWriter out, ReservedInstanceOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReservedInstanceOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReservedInstanceOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReservedInstanceOptions
   * @throws IOException if the JSON string is invalid with respect to ReservedInstanceOptions
   */
  public static ReservedInstanceOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservedInstanceOptions.class);
  }

  /**
   * Convert an instance of ReservedInstanceOptions to an JSON string
   *
   * @return JSON string
   */
