...
public class ListConfigurationsRequest {
  ...
  public ListConfigurationsRequest configurationType(ConfigurationItemType configurationType) {
  ...
  public ListConfigurationsRequest filters(List filters) {
  ...
  public ListConfigurationsRequest maxResults(Integer maxResults) {
  ...
  public ListConfigurationsRequest nextToken(String nextToken) {
  ...
  public ListConfigurationsRequest orderBy(List orderBy) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.configurationType, listConfigurationsRequest.configurationType) &&
        Objects.equals(this.filters, listConfigurationsRequest.filters) &&
        Objects.equals(this.maxResults, listConfigurationsRequest.maxResults) &&
        Objects.equals(this.nextToken, listConfigurationsRequest.nextToken) &&
        Objects.equals(this.orderBy, listConfigurationsRequest.orderBy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configurationType, filters, maxResults, nextToken, orderBy);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListConfigurationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListConfigurationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListConfigurationsRequest is not found in the empty JSON string", ListConfigurationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListConfigurationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListConfigurationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListConfigurationsRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("orderBy") != null && !jsonObj.get("orderBy").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("orderBy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListConfigurationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListConfigurationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListConfigurationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListConfigurationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListConfigurationsRequest>() {
           @Override
           public void write(JsonWriter out, ListConfigurationsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListConfigurationsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListConfigurationsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListConfigurationsRequest
   * @throws IOException if the JSON string is invalid with respect to ListConfigurationsRequest
   */
  public static ListConfigurationsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListConfigurationsRequest.class);
  }

  /**
   * Convert an instance of ListConfigurationsRequest to an JSON string
   *
   * @return JSON string
   */
