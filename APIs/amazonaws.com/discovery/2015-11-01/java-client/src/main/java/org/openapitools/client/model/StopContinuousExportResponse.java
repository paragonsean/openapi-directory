...
public class StopContinuousExportResponse {
  ...
  public StopContinuousExportResponse startTime(OffsetDateTime startTime) {
  ...
  public StopContinuousExportResponse stopTime(OffsetDateTime stopTime) {
  ...
  public boolean equals(Object o) {
    ...
    StopContinuousExportResponse stopContinuousExportResponse = (StopContinuousExportResponse) o;
    return Objects.equals(this.startTime, stopContinuousExportResponse.startTime) &&
        Objects.equals(this.stopTime, stopContinuousExportResponse.stopTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopContinuousExportResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopContinuousExportResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopContinuousExportResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopContinuousExportResponse is not found in the empty JSON string", StopContinuousExportResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopContinuousExportResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopContinuousExportResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopContinuousExportResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopContinuousExportResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopContinuousExportResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopContinuousExportResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StopContinuousExportResponse>() {
           @Override
           public void write(JsonWriter out, StopContinuousExportResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopContinuousExportResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopContinuousExportResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopContinuousExportResponse
   * @throws IOException if the JSON string is invalid with respect to StopContinuousExportResponse
   */
  public static StopContinuousExportResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopContinuousExportResponse.class);
  }

  /**
   * Convert an instance of StopContinuousExportResponse to an JSON string
   *
   * @return JSON string
   */
