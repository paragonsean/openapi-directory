...
/**
 * Gets or Sets ImportTaskFilterName
 */
@JsonAdapter(ImportTaskFilterName.Adapter.class)
public enum ImportTaskFilterName {
  ...
  ImportTaskFilterName(String value) {
    this.value = value;
  }
  ...
  public static ImportTaskFilterName fromValue(String value) {
    for (ImportTaskFilterName b : ImportTaskFilterName.values()) {
  ...
  public static class Adapter extends TypeAdapter<ImportTaskFilterName> {
    @Override
    public void write(final JsonWriter jsonWriter, final ImportTaskFilterName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ImportTaskFilterName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ImportTaskFilterName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ImportTaskFilterName.fromValue(value);
  }
}
