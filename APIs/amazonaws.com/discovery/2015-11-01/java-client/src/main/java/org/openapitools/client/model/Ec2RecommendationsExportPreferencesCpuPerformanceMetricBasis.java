...
public class Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;

  public static final String SERIALIZED_NAME_PERCENTAGE_ADJUST = "percentageAdjust";
  @SerializedName(SERIALIZED_NAME_PERCENTAGE_ADJUST)
  private Double percentageAdjust;

  public Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis() {
  }

  public Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis percentageAdjust(Double percentageAdjust) {
    this.percentageAdjust = percentageAdjust;
    return this;
  }

  /**
   * Get percentageAdjust
  ...
  public boolean equals(Object o) {
    ...
    Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis = (Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis) o;
    return Objects.equals(this.name, ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis.name) &&
        Objects.equals(this.percentageAdjust, ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis.percentageAdjust);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, percentageAdjust);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis {\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    percentageAdjust: ").append(toIndentedString(percentageAdjust)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("percentageAdjust");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis is not found in the empty JSON string", Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("percentageAdjust") != null && !jsonObj.get("percentageAdjust").isJsonNull()) {
        Double.validateJsonElement(jsonObj.get("percentageAdjust"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis.class));

       return (TypeAdapter<T>) new TypeAdapter<Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis>() {
           @Override
           public void write(JsonWriter out, Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis
   * @throws IOException if the JSON string is invalid with respect to Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis
   */
  public static Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis.class);
  }

  /**
   * Convert an instance of Ec2RecommendationsExportPreferencesCpuPerformanceMetricBasis to an JSON string
   *
   * @return JSON string
   */
