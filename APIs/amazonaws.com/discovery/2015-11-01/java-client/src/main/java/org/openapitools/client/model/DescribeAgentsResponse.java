...
public class DescribeAgentsResponse {
  public static final String SERIALIZED_NAME_AGENTS_INFO = "agentsInfo";
  @SerializedName(SERIALIZED_NAME_AGENTS_INFO)
  ...
  public DescribeAgentsResponse agentsInfo(List agentsInfo) {
  ...
  public List getAgentsInfo() {
    return agentsInfo;
  }

  public void setAgentsInfo(List agentsInfo) {
    this.agentsInfo = agentsInfo;
  }


  public DescribeAgentsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAgentsResponse describeAgentsResponse = (DescribeAgentsResponse) o;
    return Objects.equals(this.agentsInfo, describeAgentsResponse.agentsInfo) &&
        Objects.equals(this.nextToken, describeAgentsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(agentsInfo, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeAgentsResponse {\n");
    sb.append("    agentsInfo: ").append(toIndentedString(agentsInfo)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAgentsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAgentsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAgentsResponse is not found in the empty JSON string", DescribeAgentsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAgentsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAgentsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `agentsInfo`
      if (jsonObj.get("agentsInfo") != null && !jsonObj.get("agentsInfo").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("agentsInfo"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAgentsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAgentsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAgentsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAgentsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAgentsResponse>() {
           @Override
           public void write(JsonWriter out, DescribeAgentsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAgentsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAgentsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAgentsResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeAgentsResponse
   */
  public static DescribeAgentsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAgentsResponse.class);
  }

  /**
   * Convert an instance of DescribeAgentsResponse to an JSON string
   *
   * @return JSON string
   */
