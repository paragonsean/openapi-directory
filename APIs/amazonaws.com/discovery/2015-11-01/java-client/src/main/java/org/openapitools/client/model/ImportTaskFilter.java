...
import org.openapitools.client.model.ImportTaskFilterName;
...
public class ImportTaskFilter {
  ...
  private ImportTaskFilterName name;
  ...
  public ImportTaskFilter name(ImportTaskFilterName name) {
    this.name = name;
    return this;
  }
  ...
  public ImportTaskFilterName getName() {
    return name;
  }

  public void setName(ImportTaskFilterName name) {
    this.name = name;
  }


  public ImportTaskFilter values(List values) {
    this.values = values;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTaskFilter importTaskFilter = (ImportTaskFilter) o;
    return Objects.equals(this.name, importTaskFilter.name) &&
        Objects.equals(this.values, importTaskFilter.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTaskFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTaskFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTaskFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTaskFilter is not found in the empty JSON string", ImportTaskFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTaskFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTaskFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `name`
      if (jsonObj.get("name") != null && !jsonObj.get("name").isJsonNull()) {
        ImportTaskFilterName.validateJsonElement(jsonObj.get("name"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTaskFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTaskFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTaskFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTaskFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTaskFilter>() {
           @Override
           public void write(JsonWriter out, ImportTaskFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTaskFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTaskFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTaskFilter
   * @throws IOException if the JSON string is invalid with respect to ImportTaskFilter
   */
  public static ImportTaskFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTaskFilter.class);
  }

  /**
   * Convert an instance of ImportTaskFilter to an JSON string
   *
   * @return JSON string
   */
