...
/**
 * Gets or Sets BatchDeleteImportDataErrorCode
 */
@JsonAdapter(BatchDeleteImportDataErrorCode.Adapter.class)
public enum BatchDeleteImportDataErrorCode {
  ...
  BatchDeleteImportDataErrorCode(String value) {
    this.value = value;
  }
  ...
  public static BatchDeleteImportDataErrorCode fromValue(String value) {
    for (BatchDeleteImportDataErrorCode b : BatchDeleteImportDataErrorCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<BatchDeleteImportDataErrorCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final BatchDeleteImportDataErrorCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public BatchDeleteImportDataErrorCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return BatchDeleteImportDataErrorCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    BatchDeleteImportDataErrorCode.fromValue(value);
  }
}
