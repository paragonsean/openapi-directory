...
public class StartContinuousExportResponse {
  ...
  public StartContinuousExportResponse exportId(String exportId) {
  ...
  public StartContinuousExportResponse s3Bucket(String s3Bucket) {
  ...
  public StartContinuousExportResponse startTime(OffsetDateTime startTime) {
  ...
  public StartContinuousExportResponse dataSource(DataSource dataSource) {
  ...
  public StartContinuousExportResponse schemaStorageConfig(Map schemaStorageConfig) {
  ...
  public boolean equals(Object o) {
    ...
    StartContinuousExportResponse startContinuousExportResponse = (StartContinuousExportResponse) o;
    return Objects.equals(this.exportId, startContinuousExportResponse.exportId) &&
        Objects.equals(this.s3Bucket, startContinuousExportResponse.s3Bucket) &&
        Objects.equals(this.startTime, startContinuousExportResponse.startTime) &&
        Objects.equals(this.dataSource, startContinuousExportResponse.dataSource) &&
        Objects.equals(this.schemaStorageConfig, startContinuousExportResponse.schemaStorageConfig);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exportId, s3Bucket, startTime, dataSource, schemaStorageConfig);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartContinuousExportResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartContinuousExportResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartContinuousExportResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartContinuousExportResponse is not found in the empty JSON string", StartContinuousExportResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartContinuousExportResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartContinuousExportResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartContinuousExportResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartContinuousExportResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartContinuousExportResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartContinuousExportResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartContinuousExportResponse>() {
           @Override
           public void write(JsonWriter out, StartContinuousExportResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartContinuousExportResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartContinuousExportResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartContinuousExportResponse
   * @throws IOException if the JSON string is invalid with respect to StartContinuousExportResponse
   */
  public static StartContinuousExportResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartContinuousExportResponse.class);
  }

  /**
   * Convert an instance of StartContinuousExportResponse to an JSON string
   *
   * @return JSON string
   */
