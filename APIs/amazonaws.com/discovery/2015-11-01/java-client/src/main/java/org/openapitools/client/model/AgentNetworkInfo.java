...
public class AgentNetworkInfo {
  ...
  public AgentNetworkInfo ipAddress(String ipAddress) {
  ...
  public AgentNetworkInfo macAddress(String macAddress) {
  ...
  public boolean equals(Object o) {
    ...
    AgentNetworkInfo agentNetworkInfo = (AgentNetworkInfo) o;
    return Objects.equals(this.ipAddress, agentNetworkInfo.ipAddress) &&
        Objects.equals(this.macAddress, agentNetworkInfo.macAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("class AgentNetworkInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentNetworkInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentNetworkInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AgentNetworkInfo is not found in the empty JSON string", AgentNetworkInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AgentNetworkInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AgentNetworkInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentNetworkInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentNetworkInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentNetworkInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentNetworkInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentNetworkInfo>() {
           @Override
           public void write(JsonWriter out, AgentNetworkInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AgentNetworkInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AgentNetworkInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentNetworkInfo
   * @throws IOException if the JSON string is invalid with respect to AgentNetworkInfo
   */
  public static AgentNetworkInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentNetworkInfo.class);
  }

  /**
   * Convert an instance of AgentNetworkInfo to an JSON string
   *
   * @return JSON string
   */
