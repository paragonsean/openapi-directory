...
public class StopContinuousExportRequest {
  ...
  public StopContinuousExportRequest() {
  }

  public StopContinuousExportRequest exportId(String exportId) {
  ...
  public boolean equals(Object o) {
    ...
    StopContinuousExportRequest stopContinuousExportRequest = (StopContinuousExportRequest) o;
    return Objects.equals(this.exportId, stopContinuousExportRequest.exportId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopContinuousExportRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopContinuousExportRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopContinuousExportRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopContinuousExportRequest is not found in the empty JSON string", StopContinuousExportRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopContinuousExportRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopContinuousExportRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StopContinuousExportRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopContinuousExportRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopContinuousExportRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopContinuousExportRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopContinuousExportRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StopContinuousExportRequest>() {
           @Override
           public void write(JsonWriter out, StopContinuousExportRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopContinuousExportRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopContinuousExportRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopContinuousExportRequest
   * @throws IOException if the JSON string is invalid with respect to StopContinuousExportRequest
   */
  public static StopContinuousExportRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopContinuousExportRequest.class);
  }

  /**
   * Convert an instance of StopContinuousExportRequest to an JSON string
   *
   * @return JSON string
   */
