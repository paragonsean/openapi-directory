...
public class ExportPreferences {
  ...
  public ExportPreferences ec2RecommendationsPreferences(ExportPreferencesEc2RecommendationsPreferences ec2RecommendationsPreferences) {
  ...
  public boolean equals(Object o) {
    ...
    ExportPreferences exportPreferences = (ExportPreferences) o;
    return Objects.equals(this.ec2RecommendationsPreferences, exportPreferences.ec2RecommendationsPreferences);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportPreferences {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportPreferences
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportPreferences.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportPreferences is not found in the empty JSON string", ExportPreferences.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportPreferences.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportPreferences` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportPreferences.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportPreferences' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportPreferences> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportPreferences.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportPreferences>() {
           @Override
           public void write(JsonWriter out, ExportPreferences value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportPreferences read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportPreferences given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportPreferences
   * @throws IOException if the JSON string is invalid with respect to ExportPreferences
   */
  public static ExportPreferences fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportPreferences.class);
  }

  /**
   * Convert an instance of ExportPreferences to an JSON string
   *
   * @return JSON string
   */
