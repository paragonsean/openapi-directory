...
public class DisassociateConfigurationItemsFromApplicationRequest {
  ...
  public DisassociateConfigurationItemsFromApplicationRequest() {
  }

  public DisassociateConfigurationItemsFromApplicationRequest applicationConfigurationId(String applicationConfigurationId) {
  ...
  public DisassociateConfigurationItemsFromApplicationRequest configurationIds(List configurationIds) {
  ...
  public boolean equals(Object o) {
    ...
    DisassociateConfigurationItemsFromApplicationRequest disassociateConfigurationItemsFromApplicationRequest = (DisassociateConfigurationItemsFromApplicationRequest) o;
    return Objects.equals(this.applicationConfigurationId, disassociateConfigurationItemsFromApplicationRequest.applicationConfigurationId) &&
        Objects.equals(this.configurationIds, disassociateConfigurationItemsFromApplicationRequest.configurationIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisassociateConfigurationItemsFromApplicationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateConfigurationItemsFromApplicationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateConfigurationItemsFromApplicationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateConfigurationItemsFromApplicationRequest is not found in the empty JSON string", DisassociateConfigurationItemsFromApplicationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateConfigurationItemsFromApplicationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateConfigurationItemsFromApplicationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisassociateConfigurationItemsFromApplicationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateConfigurationItemsFromApplicationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateConfigurationItemsFromApplicationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateConfigurationItemsFromApplicationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateConfigurationItemsFromApplicationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateConfigurationItemsFromApplicationRequest>() {
           @Override
           public void write(JsonWriter out, DisassociateConfigurationItemsFromApplicationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateConfigurationItemsFromApplicationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateConfigurationItemsFromApplicationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateConfigurationItemsFromApplicationRequest
   * @throws IOException if the JSON string is invalid with respect to DisassociateConfigurationItemsFromApplicationRequest
   */
  public static DisassociateConfigurationItemsFromApplicationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateConfigurationItemsFromApplicationRequest.class);
  }

  /**
   * Convert an instance of DisassociateConfigurationItemsFromApplicationRequest to an JSON string
   *
   * @return JSON string
   */
