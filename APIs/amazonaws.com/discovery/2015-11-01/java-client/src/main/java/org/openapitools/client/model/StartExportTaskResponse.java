...
public class StartExportTaskResponse {
  ...
  public StartExportTaskResponse exportId(String exportId) {
  ...
  public boolean equals(Object o) {
    ...
    StartExportTaskResponse startExportTaskResponse = (StartExportTaskResponse) o;
    return Objects.equals(this.exportId, startExportTaskResponse.exportId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartExportTaskResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartExportTaskResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartExportTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartExportTaskResponse is not found in the empty JSON string", StartExportTaskResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartExportTaskResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartExportTaskResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartExportTaskResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartExportTaskResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartExportTaskResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartExportTaskResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartExportTaskResponse>() {
           @Override
           public void write(JsonWriter out, StartExportTaskResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartExportTaskResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartExportTaskResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartExportTaskResponse
   * @throws IOException if the JSON string is invalid with respect to StartExportTaskResponse
   */
  public static StartExportTaskResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartExportTaskResponse.class);
  }

  /**
   * Convert an instance of StartExportTaskResponse to an JSON string
   *
   * @return JSON string
   */
