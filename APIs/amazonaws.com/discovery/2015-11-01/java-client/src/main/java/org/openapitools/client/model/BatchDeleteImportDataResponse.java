...
public class BatchDeleteImportDataResponse {
  ...
  public BatchDeleteImportDataResponse errors(List errors) {
    this.errors = errors;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchDeleteImportDataResponse batchDeleteImportDataResponse = (BatchDeleteImportDataResponse) o;
    return Objects.equals(this.errors, batchDeleteImportDataResponse.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchDeleteImportDataResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchDeleteImportDataResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchDeleteImportDataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchDeleteImportDataResponse is not found in the empty JSON string", BatchDeleteImportDataResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchDeleteImportDataResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchDeleteImportDataResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchDeleteImportDataResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchDeleteImportDataResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchDeleteImportDataResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchDeleteImportDataResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchDeleteImportDataResponse>() {
           @Override
           public void write(JsonWriter out, BatchDeleteImportDataResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchDeleteImportDataResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchDeleteImportDataResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchDeleteImportDataResponse
   * @throws IOException if the JSON string is invalid with respect to BatchDeleteImportDataResponse
   */
  public static BatchDeleteImportDataResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchDeleteImportDataResponse.class);
  }

  /**
   * Convert an instance of BatchDeleteImportDataResponse to an JSON string
   *
   * @return JSON string
   */
