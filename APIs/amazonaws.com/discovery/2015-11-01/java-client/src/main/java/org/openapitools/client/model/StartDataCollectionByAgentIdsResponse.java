...
public class StartDataCollectionByAgentIdsResponse {
  public static final String SERIALIZED_NAME_AGENTS_CONFIGURATION_STATUS = "agentsConfigurationStatus";
  @SerializedName(SERIALIZED_NAME_AGENTS_CONFIGURATION_STATUS)
  private List agentsConfigurationStatus;

  public StartDataCollectionByAgentIdsResponse() {
  }

  public StartDataCollectionByAgentIdsResponse agentsConfigurationStatus(List agentsConfigurationStatus) {
    this.agentsConfigurationStatus = agentsConfigurationStatus;
    return this;
  }

  /**
   * Get agentsConfigurationStatus
   * @return agentsConfigurationStatus
   */
  @javax.annotation.Nullable
  public List getAgentsConfigurationStatus() {
    return agentsConfigurationStatus;
  }

  public void setAgentsConfigurationStatus(List agentsConfigurationStatus) {
    this.agentsConfigurationStatus = agentsConfigurationStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartDataCollectionByAgentIdsResponse startDataCollectionByAgentIdsResponse = (StartDataCollectionByAgentIdsResponse) o;
    return Objects.equals(this.agentsConfigurationStatus, startDataCollectionByAgentIdsResponse.agentsConfigurationStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(agentsConfigurationStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartDataCollectionByAgentIdsResponse {\n");
    sb.append("    agentsConfigurationStatus: ").append(toIndentedString(agentsConfigurationStatus)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("agentsConfigurationStatus");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartDataCollectionByAgentIdsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartDataCollectionByAgentIdsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartDataCollectionByAgentIdsResponse is not found in the empty JSON string", StartDataCollectionByAgentIdsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartDataCollectionByAgentIdsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartDataCollectionByAgentIdsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `agentsConfigurationStatus`
      if (jsonObj.get("agentsConfigurationStatus") != null && !jsonObj.get("agentsConfigurationStatus").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("agentsConfigurationStatus"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartDataCollectionByAgentIdsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartDataCollectionByAgentIdsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartDataCollectionByAgentIdsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartDataCollectionByAgentIdsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartDataCollectionByAgentIdsResponse>() {
           @Override
           public void write(JsonWriter out, StartDataCollectionByAgentIdsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartDataCollectionByAgentIdsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartDataCollectionByAgentIdsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartDataCollectionByAgentIdsResponse
   * @throws IOException if the JSON string is invalid with respect to StartDataCollectionByAgentIdsResponse
   */
  public static StartDataCollectionByAgentIdsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartDataCollectionByAgentIdsResponse.class);
  }

  /**
   * Convert an instance of StartDataCollectionByAgentIdsResponse to an JSON string
   *
   * @return JSON string
   */
