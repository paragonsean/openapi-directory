...
public class DescribeImportTasksRequest {
  ...
  public DescribeImportTasksRequest filters(List filters) {
  ...
  public DescribeImportTasksRequest maxResults(Integer maxResults) {
  ...
  public DescribeImportTasksRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeImportTasksRequest describeImportTasksRequest = (DescribeImportTasksRequest) o;
    return Objects.equals(this.filters, describeImportTasksRequest.filters) &&
        Objects.equals(this.maxResults, describeImportTasksRequest.maxResults) &&
        Objects.equals(this.nextToken, describeImportTasksRequest.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeImportTasksRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeImportTasksRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeImportTasksRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeImportTasksRequest is not found in the empty JSON string", DescribeImportTasksRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeImportTasksRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeImportTasksRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeImportTasksRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeImportTasksRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeImportTasksRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeImportTasksRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeImportTasksRequest>() {
           @Override
           public void write(JsonWriter out, DescribeImportTasksRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeImportTasksRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeImportTasksRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeImportTasksRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeImportTasksRequest
   */
  public static DescribeImportTasksRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeImportTasksRequest.class);
  }

  /**
   * Convert an instance of DescribeImportTasksRequest to an JSON string
   *
   * @return JSON string
   */
