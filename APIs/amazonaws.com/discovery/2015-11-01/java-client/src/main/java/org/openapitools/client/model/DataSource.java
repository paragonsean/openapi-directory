 ...
 */
@JsonAdapter(DataSource.Adapter.class)
public enum DataSource {
  ...
  public static class Adapter extends TypeAdapter<DataSource> {
    @Override
    public void write(final JsonWriter jsonWriter, final DataSource enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DataSource read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DataSource.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DataSource.fromValue(value);
  }
}
