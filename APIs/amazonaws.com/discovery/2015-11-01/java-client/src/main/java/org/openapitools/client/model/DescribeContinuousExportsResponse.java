...
public class DescribeContinuousExportsResponse {
  ...
  public DescribeContinuousExportsResponse descriptions(List descriptions) {
  ...
  public DescribeContinuousExportsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeContinuousExportsResponse describeContinuousExportsResponse = (DescribeContinuousExportsResponse) o;
    return Objects.equals(this.descriptions, describeContinuousExportsResponse.descriptions) &&
        Objects.equals(this.nextToken, describeContinuousExportsResponse.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeContinuousExportsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeContinuousExportsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeContinuousExportsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeContinuousExportsResponse is not found in the empty JSON string", DescribeContinuousExportsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeContinuousExportsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeContinuousExportsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeContinuousExportsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeContinuousExportsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeContinuousExportsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeContinuousExportsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeContinuousExportsResponse>() {
           @Override
           public void write(JsonWriter out, DescribeContinuousExportsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeContinuousExportsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeContinuousExportsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeContinuousExportsResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeContinuousExportsResponse
   */
  public static DescribeContinuousExportsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeContinuousExportsResponse.class);
  }

  /**
   * Convert an instance of DescribeContinuousExportsResponse to an JSON string
   *
   * @return JSON string
   */
