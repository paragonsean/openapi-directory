...
public class CustomerAgentlessCollectorInfo {
  ...
  public CustomerAgentlessCollectorInfo() {
  }

  public CustomerAgentlessCollectorInfo activeAgentlessCollectors(Integer activeAgentlessCollectors) {
  ...
  public CustomerAgentlessCollectorInfo healthyAgentlessCollectors(Integer healthyAgentlessCollectors) {
  ...
  public CustomerAgentlessCollectorInfo denyListedAgentlessCollectors(Integer denyListedAgentlessCollectors) {
  ...
  public CustomerAgentlessCollectorInfo shutdownAgentlessCollectors(Integer shutdownAgentlessCollectors) {
  ...
  public CustomerAgentlessCollectorInfo unhealthyAgentlessCollectors(Integer unhealthyAgentlessCollectors) {
  ...
  public CustomerAgentlessCollectorInfo totalAgentlessCollectors(Integer totalAgentlessCollectors) {
  ...
  public CustomerAgentlessCollectorInfo unknownAgentlessCollectors(Integer unknownAgentlessCollectors) {
  ...
  public boolean equals(Object o) {
    ...
    CustomerAgentlessCollectorInfo customerAgentlessCollectorInfo = (CustomerAgentlessCollectorInfo) o;
    return Objects.equals(this.activeAgentlessCollectors, customerAgentlessCollectorInfo.activeAgentlessCollectors) &&
        Objects.equals(this.healthyAgentlessCollectors, customerAgentlessCollectorInfo.healthyAgentlessCollectors) &&
        Objects.equals(this.denyListedAgentlessCollectors, customerAgentlessCollectorInfo.denyListedAgentlessCollectors) &&
        Objects.equals(this.shutdownAgentlessCollectors, customerAgentlessCollectorInfo.shutdownAgentlessCollectors) &&
        Objects.equals(this.unhealthyAgentlessCollectors, customerAgentlessCollectorInfo.unhealthyAgentlessCollectors) &&
        Objects.equals(this.totalAgentlessCollectors, customerAgentlessCollectorInfo.totalAgentlessCollectors) &&
        Objects.equals(this.unknownAgentlessCollectors, customerAgentlessCollectorInfo.unknownAgentlessCollectors);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomerAgentlessCollectorInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomerAgentlessCollectorInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerAgentlessCollectorInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomerAgentlessCollectorInfo is not found in the empty JSON string", CustomerAgentlessCollectorInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerAgentlessCollectorInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomerAgentlessCollectorInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustomerAgentlessCollectorInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomerAgentlessCollectorInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomerAgentlessCollectorInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomerAgentlessCollectorInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomerAgentlessCollectorInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomerAgentlessCollectorInfo>() {
           @Override
           public void write(JsonWriter out, CustomerAgentlessCollectorInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomerAgentlessCollectorInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomerAgentlessCollectorInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomerAgentlessCollectorInfo
   * @throws IOException if the JSON string is invalid with respect to CustomerAgentlessCollectorInfo
   */
  public static CustomerAgentlessCollectorInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomerAgentlessCollectorInfo.class);
  }

  /**
   * Convert an instance of CustomerAgentlessCollectorInfo to an JSON string
   *
   * @return JSON string
   */
