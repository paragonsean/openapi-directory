 ...
 */
@JsonAdapter(ConfigurationItemType.Adapter.class)
public enum ConfigurationItemType {
  ...
  public static ConfigurationItemType fromValue(String value) {
    for (ConfigurationItemType b : ConfigurationItemType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ConfigurationItemType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConfigurationItemType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConfigurationItemType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConfigurationItemType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ConfigurationItemType.fromValue(value);
  }
}
