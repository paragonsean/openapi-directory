...
public class UsageMetricBasis {
  ...
  public UsageMetricBasis() {
  }

  public UsageMetricBasis name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UsageMetricBasis percentageAdjust(Double percentageAdjust) {
  ...
  public boolean equals(Object o) {
    ...
    UsageMetricBasis usageMetricBasis = (UsageMetricBasis) o;
    return Objects.equals(this.name, usageMetricBasis.name) &&
        Objects.equals(this.percentageAdjust, usageMetricBasis.percentageAdjust);
  }
  ...
  public String toString() {
    ...
    sb.append("class UsageMetricBasis {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UsageMetricBasis
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsageMetricBasis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsageMetricBasis is not found in the empty JSON string", UsageMetricBasis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UsageMetricBasis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UsageMetricBasis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsageMetricBasis.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsageMetricBasis' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsageMetricBasis> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsageMetricBasis.class));

       return (TypeAdapter<T>) new TypeAdapter<UsageMetricBasis>() {
           @Override
           public void write(JsonWriter out, UsageMetricBasis value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UsageMetricBasis read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UsageMetricBasis given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UsageMetricBasis
   * @throws IOException if the JSON string is invalid with respect to UsageMetricBasis
   */
  public static UsageMetricBasis fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsageMetricBasis.class);
  }

  /**
   * Convert an instance of UsageMetricBasis to an JSON string
   *
   * @return JSON string
   */
