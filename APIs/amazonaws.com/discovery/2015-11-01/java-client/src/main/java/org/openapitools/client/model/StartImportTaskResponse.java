...
import org.openapitools.client.model.StartImportTaskResponseTask;
...
public class StartImportTaskResponse {
  ...
  private StartImportTaskResponseTask task;

  public StartImportTaskResponse() {
  }

  public StartImportTaskResponse task(StartImportTaskResponseTask task) {
    this.task = task;
    return this;
  }
  ...
  public StartImportTaskResponseTask getTask() {
    return task;
  }

  public void setTask(StartImportTaskResponseTask task) {
    this.task = task;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartImportTaskResponse startImportTaskResponse = (StartImportTaskResponse) o;
    return Objects.equals(this.task, startImportTaskResponse.task);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartImportTaskResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartImportTaskResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartImportTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartImportTaskResponse is not found in the empty JSON string", StartImportTaskResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartImportTaskResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartImportTaskResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `task`
      if (jsonObj.get("task") != null && !jsonObj.get("task").isJsonNull()) {
        StartImportTaskResponseTask.validateJsonElement(jsonObj.get("task"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartImportTaskResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartImportTaskResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartImportTaskResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartImportTaskResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartImportTaskResponse>() {
           @Override
           public void write(JsonWriter out, StartImportTaskResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartImportTaskResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartImportTaskResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartImportTaskResponse
   * @throws IOException if the JSON string is invalid with respect to StartImportTaskResponse
   */
  public static StartImportTaskResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartImportTaskResponse.class);
  }

  /**
   * Convert an instance of StartImportTaskResponse to an JSON string
   *
   * @return JSON string
   */
