...
/**
 * Gets or Sets ExportDataFormat
 */
@JsonAdapter(ExportDataFormat.Adapter.class)
public enum ExportDataFormat {
  ...
  public static ExportDataFormat fromValue(String value) {
    for (ExportDataFormat b : ExportDataFormat.values()) {
  ...
  public static class Adapter extends TypeAdapter<ExportDataFormat> {
    @Override
    public void write(final JsonWriter jsonWriter, final ExportDataFormat enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ExportDataFormat read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ExportDataFormat.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ExportDataFormat.fromValue(value);
  }
}
