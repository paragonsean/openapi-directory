...
public class ListServerNeighborsResponse {
  ...
  public static final String SERIALIZED_NAME_KNOWN_DEPENDENCY_COUNT = "knownDependencyCount";
  @SerializedName(SERIALIZED_NAME_KNOWN_DEPENDENCY_COUNT)
  private Integer knownDependencyCount;

  public ListServerNeighborsResponse() {
  }

  public ListServerNeighborsResponse neighbors(List neighbors) {
  ...
  public ListServerNeighborsResponse nextToken(String nextToken) {
  ...
  public ListServerNeighborsResponse knownDependencyCount(Integer knownDependencyCount) {
    this.knownDependencyCount = knownDependencyCount;
    return this;
  }

  /**
   * Get knownDependencyCount
   * @return knownDependencyCount
   */
  @javax.annotation.Nullable
  public Integer getKnownDependencyCount() {
    return knownDependencyCount;
  }

  public void setKnownDependencyCount(Integer knownDependencyCount) {
    this.knownDependencyCount = knownDependencyCount;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListServerNeighborsResponse listServerNeighborsResponse = (ListServerNeighborsResponse) o;
    return Objects.equals(this.neighbors, listServerNeighborsResponse.neighbors) &&
        Objects.equals(this.nextToken, listServerNeighborsResponse.nextToken) &&
        Objects.equals(this.knownDependencyCount, listServerNeighborsResponse.knownDependencyCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(neighbors, nextToken, knownDependencyCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListServerNeighborsResponse {\n");
    sb.append("    neighbors: ").append(toIndentedString(neighbors)).append("\n");
    sb.append("    nextToken: ").append(toIndentedString(nextToken)).append("\n");
    sb.append("    knownDependencyCount: ").append(toIndentedString(knownDependencyCount)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("knownDependencyCount");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("neighbors");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListServerNeighborsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListServerNeighborsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListServerNeighborsResponse is not found in the empty JSON string", ListServerNeighborsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListServerNeighborsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListServerNeighborsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListServerNeighborsResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `neighbors`
      List.validateJsonElement(jsonObj.get("neighbors"));
      // validate the optional field `nextToken`
      if (jsonObj.get("nextToken") != null && !jsonObj.get("nextToken").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("nextToken"));
      }
      // validate the optional field `knownDependencyCount`
      if (jsonObj.get("knownDependencyCount") != null && !jsonObj.get("knownDependencyCount").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("knownDependencyCount"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListServerNeighborsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListServerNeighborsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListServerNeighborsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListServerNeighborsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListServerNeighborsResponse>() {
           @Override
           public void write(JsonWriter out, ListServerNeighborsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListServerNeighborsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListServerNeighborsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListServerNeighborsResponse
   * @throws IOException if the JSON string is invalid with respect to ListServerNeighborsResponse
   */
  public static ListServerNeighborsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListServerNeighborsResponse.class);
  }

  /**
   * Convert an instance of ListServerNeighborsResponse to an JSON string
   *
   * @return JSON string
   */
