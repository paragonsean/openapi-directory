...
public class DescribeConfigurationsResponse {
  ...
  public DescribeConfigurationsResponse configurations(List configurations) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeConfigurationsResponse describeConfigurationsResponse = (DescribeConfigurationsResponse) o;
    return Objects.equals(this.configurations, describeConfigurationsResponse.configurations);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeConfigurationsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeConfigurationsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeConfigurationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeConfigurationsResponse is not found in the empty JSON string", DescribeConfigurationsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeConfigurationsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeConfigurationsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeConfigurationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeConfigurationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeConfigurationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeConfigurationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeConfigurationsResponse>() {
           @Override
           public void write(JsonWriter out, DescribeConfigurationsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeConfigurationsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeConfigurationsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeConfigurationsResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeConfigurationsResponse
   */
  public static DescribeConfigurationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeConfigurationsResponse.class);
  }

  /**
   * Convert an instance of DescribeConfigurationsResponse to an JSON string
   *
   * @return JSON string
   */
