...
public class DescribeExportConfigurationsResponse {
  public static final String SERIALIZED_NAME_EXPORTS_INFO = "exportsInfo";
  @SerializedName(SERIALIZED_NAME_EXPORTS_INFO)
  private List exportsInfo;
  ...
  public DescribeExportConfigurationsResponse exportsInfo(List exportsInfo) {
  ...
  public List getExportsInfo() {
    return exportsInfo;
  }

  public void setExportsInfo(List exportsInfo) {
    this.exportsInfo = exportsInfo;
  }


  public DescribeExportConfigurationsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeExportConfigurationsResponse describeExportConfigurationsResponse = (DescribeExportConfigurationsResponse) o;
    return Objects.equals(this.exportsInfo, describeExportConfigurationsResponse.exportsInfo) &&
        Objects.equals(this.nextToken, describeExportConfigurationsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exportsInfo, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeExportConfigurationsResponse {\n");
    sb.append("    exportsInfo: ").append(toIndentedString(exportsInfo)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeExportConfigurationsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeExportConfigurationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeExportConfigurationsResponse is not found in the empty JSON string", DescribeExportConfigurationsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeExportConfigurationsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeExportConfigurationsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `exportsInfo`
      if (jsonObj.get("exportsInfo") != null && !jsonObj.get("exportsInfo").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("exportsInfo"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeExportConfigurationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeExportConfigurationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeExportConfigurationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeExportConfigurationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeExportConfigurationsResponse>() {
           @Override
           public void write(JsonWriter out, DescribeExportConfigurationsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeExportConfigurationsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeExportConfigurationsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeExportConfigurationsResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeExportConfigurationsResponse
   */
  public static DescribeExportConfigurationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeExportConfigurationsResponse.class);
  }

  /**
   * Convert an instance of DescribeExportConfigurationsResponse to an JSON string
   *
   * @return JSON string
   */
