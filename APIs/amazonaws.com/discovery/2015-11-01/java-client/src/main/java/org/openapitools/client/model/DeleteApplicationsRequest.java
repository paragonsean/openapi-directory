...
public class DeleteApplicationsRequest {
  ...
  public DeleteApplicationsRequest configurationIds(List configurationIds) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteApplicationsRequest deleteApplicationsRequest = (DeleteApplicationsRequest) o;
    return Objects.equals(this.configurationIds, deleteApplicationsRequest.configurationIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteApplicationsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteApplicationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteApplicationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteApplicationsRequest is not found in the empty JSON string", DeleteApplicationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteApplicationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteApplicationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteApplicationsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteApplicationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteApplicationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteApplicationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteApplicationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteApplicationsRequest>() {
           @Override
           public void write(JsonWriter out, DeleteApplicationsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteApplicationsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteApplicationsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteApplicationsRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteApplicationsRequest
   */
  public static DeleteApplicationsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteApplicationsRequest.class);
  }

  /**
   * Convert an instance of DeleteApplicationsRequest to an JSON string
   *
   * @return JSON string
   */
