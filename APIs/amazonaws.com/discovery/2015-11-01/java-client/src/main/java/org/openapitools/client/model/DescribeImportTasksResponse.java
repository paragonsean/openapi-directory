...
public class DescribeImportTasksResponse {
  ...
  public DescribeImportTasksResponse nextToken(String nextToken) {
  ...
  public DescribeImportTasksResponse tasks(List tasks) {
    this.tasks = tasks;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeImportTasksResponse describeImportTasksResponse = (DescribeImportTasksResponse) o;
    return Objects.equals(this.nextToken, describeImportTasksResponse.nextToken) &&
        Objects.equals(this.tasks, describeImportTasksResponse.tasks);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeImportTasksResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeImportTasksResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeImportTasksResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeImportTasksResponse is not found in the empty JSON string", DescribeImportTasksResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeImportTasksResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeImportTasksResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeImportTasksResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeImportTasksResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeImportTasksResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeImportTasksResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeImportTasksResponse>() {
           @Override
           public void write(JsonWriter out, DescribeImportTasksResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeImportTasksResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeImportTasksResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeImportTasksResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeImportTasksResponse
   */
  public static DescribeImportTasksResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeImportTasksResponse.class);
  }

  /**
   * Convert an instance of DescribeImportTasksResponse to an JSON string
   *
   * @return JSON string
   */
