...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.RegisterSlackWorkspaceForOrganizationRequest();
  });
  ...
  describe('RegisterSlackWorkspaceForOrganizationRequest', function() {
    it('should create an instance of RegisterSlackWorkspaceForOrganizationRequest', function() {
      // uncomment below and update the code to test RegisterSlackWorkspaceForOrganizationRequest
      //var instance = new AwsSupportApp.RegisterSlackWorkspaceForOrganizationRequest();
      //expect(instance).to.be.a(AwsSupportApp.RegisterSlackWorkspaceForOrganizationRequest);
    });
