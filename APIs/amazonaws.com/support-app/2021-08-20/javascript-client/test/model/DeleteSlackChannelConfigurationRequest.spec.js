...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.DeleteSlackChannelConfigurationRequest();
  });
  ...
  describe('DeleteSlackChannelConfigurationRequest', function() {
    it('should create an instance of DeleteSlackChannelConfigurationRequest', function() {
      // uncomment below and update the code to test DeleteSlackChannelConfigurationRequest
      //var instance = new AwsSupportApp.DeleteSlackChannelConfigurationRequest();
      //expect(instance).to.be.a(AwsSupportApp.DeleteSlackChannelConfigurationRequest);
    });
