...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.ListSlackChannelConfigurationsResult();
  });
  ...
  describe('ListSlackChannelConfigurationsResult', function() {
    it('should create an instance of ListSlackChannelConfigurationsResult', function() {
      // uncomment below and update the code to test ListSlackChannelConfigurationsResult
      //var instance = new AwsSupportApp.ListSlackChannelConfigurationsResult();
      //expect(instance).to.be.a(AwsSupportApp.ListSlackChannelConfigurationsResult);
    });
    ...
    it('should have the property slackChannelConfigurations (base name: "slackChannelConfigurations")', function() {
      // uncomment below and update the code to test the property slackChannelConfigurations
      //var instance = new AwsSupportApp.ListSlackChannelConfigurationsResult();
      //expect(instance).to.be();
    });
