...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.SlackChannelConfiguration();
  });
  ...
  describe('SlackChannelConfiguration', function() {
    it('should create an instance of SlackChannelConfiguration', function() {
      // uncomment below and update the code to test SlackChannelConfiguration
      //var instance = new AwsSupportApp.SlackChannelConfiguration();
      //expect(instance).to.be.a(AwsSupportApp.SlackChannelConfiguration);
    });
