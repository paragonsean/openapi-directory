...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.RegisterSlackWorkspaceForOrganizationResult();
  });
  ...
  describe('RegisterSlackWorkspaceForOrganizationResult', function() {
    it('should create an instance of RegisterSlackWorkspaceForOrganizationResult', function() {
      // uncomment below and update the code to test RegisterSlackWorkspaceForOrganizationResult
      //var instance = new AwsSupportApp.RegisterSlackWorkspaceForOrganizationResult();
      //expect(instance).to.be.a(AwsSupportApp.RegisterSlackWorkspaceForOrganizationResult);
    });
