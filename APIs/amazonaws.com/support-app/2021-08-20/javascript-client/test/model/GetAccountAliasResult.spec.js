...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.GetAccountAliasResult();
  });
  ...
  describe('GetAccountAliasResult', function() {
    it('should create an instance of GetAccountAliasResult', function() {
      // uncomment below and update the code to test GetAccountAliasResult
      //var instance = new AwsSupportApp.GetAccountAliasResult();
      //expect(instance).to.be.a(AwsSupportApp.GetAccountAliasResult);
    });
