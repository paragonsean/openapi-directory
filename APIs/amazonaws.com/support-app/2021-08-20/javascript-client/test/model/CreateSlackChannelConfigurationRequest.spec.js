...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.CreateSlackChannelConfigurationRequest();
  });
  ...
  describe('CreateSlackChannelConfigurationRequest', function() {
    it('should create an instance of CreateSlackChannelConfigurationRequest', function() {
      // uncomment below and update the code to test CreateSlackChannelConfigurationRequest
      //var instance = new AwsSupportApp.CreateSlackChannelConfigurationRequest();
      //expect(instance).to.be.a(AwsSupportApp.CreateSlackChannelConfigurationRequest);
    });
