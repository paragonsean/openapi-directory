...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.ListSlackWorkspaceConfigurationsResult();
  });
  ...
  describe('ListSlackWorkspaceConfigurationsResult', function() {
    it('should create an instance of ListSlackWorkspaceConfigurationsResult', function() {
      // uncomment below and update the code to test ListSlackWorkspaceConfigurationsResult
      //var instance = new AwsSupportApp.ListSlackWorkspaceConfigurationsResult();
      //expect(instance).to.be.a(AwsSupportApp.ListSlackWorkspaceConfigurationsResult);
    });
    ...
    it('should have the property slackWorkspaceConfigurations (base name: "slackWorkspaceConfigurations")', function() {
      // uncomment below and update the code to test the property slackWorkspaceConfigurations
      //var instance = new AwsSupportApp.ListSlackWorkspaceConfigurationsResult();
      //expect(instance).to.be();
    });
