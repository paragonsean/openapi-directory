...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.PutAccountAliasRequest();
  });
  ...
  describe('PutAccountAliasRequest', function() {
    it('should create an instance of PutAccountAliasRequest', function() {
      // uncomment below and update the code to test PutAccountAliasRequest
      //var instance = new AwsSupportApp.PutAccountAliasRequest();
      //expect(instance).to.be.a(AwsSupportApp.PutAccountAliasRequest);
    });
