...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.UpdateSlackChannelConfigurationRequest();
  });
  ...
  describe('UpdateSlackChannelConfigurationRequest', function() {
    it('should create an instance of UpdateSlackChannelConfigurationRequest', function() {
      // uncomment below and update the code to test UpdateSlackChannelConfigurationRequest
      //var instance = new AwsSupportApp.UpdateSlackChannelConfigurationRequest();
      //expect(instance).to.be.a(AwsSupportApp.UpdateSlackChannelConfigurationRequest);
    });
    ...
    it('should have the property channelRoleArn (base name: "channelRoleArn")', function() {
      // uncomment below and update the code to test the property channelRoleArn
      //var instance = new AwsSupportApp.UpdateSlackChannelConfigurationRequest();
      //expect(instance).to.be();
    });

    it('should have the property notifyOnAddCorrespondenceToCase (base name: "notifyOnAddCorrespondenceToCase")', function() {
      // uncomment below and update the code to test the property notifyOnAddCorrespondenceToCase
      //var instance = new AwsSupportApp.UpdateSlackChannelConfigurationRequest();
      //expect(instance).to.be();
    });

    it('should have the property notifyOnCaseSeverity (base name: "notifyOnCaseSeverity")', function() {
      // uncomment below and update the code to test the property notifyOnCaseSeverity
      //var instance = new AwsSupportApp.UpdateSlackChannelConfigurationRequest();
      //expect(instance).to.be();
    });

    it('should have the property notifyOnCreateOrReopenCase (base name: "notifyOnCreateOrReopenCase")', function() {
      // uncomment below and update the code to test the property notifyOnCreateOrReopenCase
      //var instance = new AwsSupportApp.UpdateSlackChannelConfigurationRequest();
      //expect(instance).to.be();
    });

    it('should have the property notifyOnResolveCase (base name: "notifyOnResolveCase")', function() {
      // uncomment below and update the code to test the property notifyOnResolveCase
      //var instance = new AwsSupportApp.UpdateSlackChannelConfigurationRequest();
      //expect(instance).to.be();
    });
