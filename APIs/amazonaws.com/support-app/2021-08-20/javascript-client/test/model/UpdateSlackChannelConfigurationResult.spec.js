...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.UpdateSlackChannelConfigurationResult();
  });
  ...
  describe('UpdateSlackChannelConfigurationResult', function() {
    it('should create an instance of UpdateSlackChannelConfigurationResult', function() {
      // uncomment below and update the code to test UpdateSlackChannelConfigurationResult
      //var instance = new AwsSupportApp.UpdateSlackChannelConfigurationResult();
      //expect(instance).to.be.a(AwsSupportApp.UpdateSlackChannelConfigurationResult);
    });
