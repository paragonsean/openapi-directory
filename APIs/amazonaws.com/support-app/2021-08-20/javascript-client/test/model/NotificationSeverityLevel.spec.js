...
(function(root, factory) {
  ...
  describe('NotificationSeverityLevel', function() {
    it('should create an instance of NotificationSeverityLevel', function() {
      // uncomment below and update the code to test NotificationSeverityLevel
      //var instance = new AwsSupportApp.NotificationSeverityLevel();
      //expect(instance).to.be.a(AwsSupportApp.NotificationSeverityLevel);
    });
