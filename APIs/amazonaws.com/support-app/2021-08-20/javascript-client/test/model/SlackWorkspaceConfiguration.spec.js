...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.SlackWorkspaceConfiguration();
  });
  ...
  describe('SlackWorkspaceConfiguration', function() {
    it('should create an instance of SlackWorkspaceConfiguration', function() {
      // uncomment below and update the code to test SlackWorkspaceConfiguration
      //var instance = new AwsSupportApp.SlackWorkspaceConfiguration();
      //expect(instance).to.be.a(AwsSupportApp.SlackWorkspaceConfiguration);
    });

    it('should have the property allowOrganizationMemberAccount (base name: "allowOrganizationMemberAccount")', function() {
      // uncomment below and update the code to test the property allowOrganizationMemberAccount
      //var instance = new AwsSupportApp.SlackWorkspaceConfiguration();
