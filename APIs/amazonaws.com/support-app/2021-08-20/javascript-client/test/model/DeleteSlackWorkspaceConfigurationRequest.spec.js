...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.DeleteSlackWorkspaceConfigurationRequest();
  });
  ...
  describe('DeleteSlackWorkspaceConfigurationRequest', function() {
    it('should create an instance of DeleteSlackWorkspaceConfigurationRequest', function() {
      // uncomment below and update the code to test DeleteSlackWorkspaceConfigurationRequest
      //var instance = new AwsSupportApp.DeleteSlackWorkspaceConfigurationRequest();
      //expect(instance).to.be.a(AwsSupportApp.DeleteSlackWorkspaceConfigurationRequest);
    });
