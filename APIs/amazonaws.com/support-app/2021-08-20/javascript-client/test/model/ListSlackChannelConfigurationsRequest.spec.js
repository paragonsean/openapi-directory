...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupportApp.ListSlackChannelConfigurationsRequest();
  });
  ...
  describe('ListSlackChannelConfigurationsRequest', function() {
    it('should create an instance of ListSlackChannelConfigurationsRequest', function() {
      // uncomment below and update the code to test ListSlackChannelConfigurationsRequest
      //var instance = new AwsSupportApp.ListSlackChannelConfigurationsRequest();
      //expect(instance).to.be.a(AwsSupportApp.ListSlackChannelConfigurationsRequest);
    });
