...
/**
 * The SlackWorkspaceConfiguration model module.
 * @module model/SlackWorkspaceConfiguration
 * @version 2021-08-20
 */
class SlackWorkspaceConfiguration {
    /**
     * Constructs a new <code>SlackWorkspaceConfiguration</code>.
     * The configuration for a Slack workspace that you added to an Amazon Web Services account.
     * @alias module:model/SlackWorkspaceConfiguration
     * @param teamId {String} 
     */
    constructor(teamId) { 
        
        SlackWorkspaceConfiguration.initialize(this, teamId);
    }
    ...
    /**
     * Constructs a <code>SlackWorkspaceConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SlackWorkspaceConfiguration} obj Optional instance to populate.
     * @return {module:model/SlackWorkspaceConfiguration} The populated <code>SlackWorkspaceConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SlackWorkspaceConfiguration();

            if (data.hasOwnProperty('allowOrganizationMemberAccount')) {
                obj['allowOrganizationMemberAccount'] = ApiClient.convertToType(data['allowOrganizationMemberAccount'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SlackWorkspaceConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SlackWorkspaceConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SlackWorkspaceConfiguration.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `allowOrganizationMemberAccount`
        if (data['allowOrganizationMemberAccount']) { // data not null
          Boolean.validateJSON(data['allowOrganizationMemberAccount']);
        }
        ...
        if (data['teamName']) { // data not null
          String.validateJSON(data['teamName']);
        }
...
SlackWorkspaceConfiguration.RequiredProperties = ["teamId"];

/**
 * @member {Boolean} allowOrganizationMemberAccount
 */
SlackWorkspaceConfiguration.prototype['allowOrganizationMemberAccount'] = undefined;

/**
 * @member {String} teamId
 */
SlackWorkspaceConfiguration.prototype['teamId'] = undefined;

/**
 * @member {String} teamName
 */
SlackWorkspaceConfiguration.prototype['teamName'] = undefined;
...
export default SlackWorkspaceConfiguration;
