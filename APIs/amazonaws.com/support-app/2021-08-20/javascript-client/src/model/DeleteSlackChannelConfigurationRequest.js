...
/**
 * The DeleteSlackChannelConfigurationRequest model module.
 * @module model/DeleteSlackChannelConfigurationRequest
 * @version 2021-08-20
 */
class DeleteSlackChannelConfigurationRequest {
    /**
     * Constructs a new <code>DeleteSlackChannelConfigurationRequest</code>.
     * @alias module:model/DeleteSlackChannelConfigurationRequest
    ...
    constructor(channelId, teamId) { 
        ...
        DeleteSlackChannelConfigurationRequest.initialize(this, channelId, teamId);
    }
    ...
    /**
     * Constructs a <code>DeleteSlackChannelConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteSlackChannelConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/DeleteSlackChannelConfigurationRequest} The populated <code>DeleteSlackChannelConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteSlackChannelConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteSlackChannelConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteSlackChannelConfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteSlackChannelConfigurationRequest.RequiredProperties) {
...
DeleteSlackChannelConfigurationRequest.RequiredProperties = ["channelId", "teamId"];

/**
 * The channel ID in Slack. This ID identifies a channel within a Slack workspace.
 * @member {String} channelId
 */
DeleteSlackChannelConfigurationRequest.prototype['channelId'] = undefined;

/**
 * The team ID in Slack. This ID uniquely identifies a Slack workspace, such as <code>T012ABCDEFG</code>.
 * @member {String} teamId
 */
DeleteSlackChannelConfigurationRequest.prototype['teamId'] = undefined;
...
export default DeleteSlackChannelConfigurationRequest;
