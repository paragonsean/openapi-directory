...
* @readonly
*/
export default class NotificationSeverityLevel {
    ...
    /**
    * Returns a <code>NotificationSeverityLevel</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/NotificationSeverityLevel} The enum <code>NotificationSeverityLevel</code> value.
    */
