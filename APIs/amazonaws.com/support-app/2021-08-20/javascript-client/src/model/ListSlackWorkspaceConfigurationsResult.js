...
/**
 * The ListSlackWorkspaceConfigurationsResult model module.
 * @module model/ListSlackWorkspaceConfigurationsResult
 * @version 2021-08-20
 */
class ListSlackWorkspaceConfigurationsResult {
    /**
     * Constructs a new <code>ListSlackWorkspaceConfigurationsResult</code>.
     * @alias module:model/ListSlackWorkspaceConfigurationsResult
     */
    constructor() { 
        
        ListSlackWorkspaceConfigurationsResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSlackWorkspaceConfigurationsResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSlackWorkspaceConfigurationsResult} obj Optional instance to populate.
     * @return {module:model/ListSlackWorkspaceConfigurationsResult} The populated <code>ListSlackWorkspaceConfigurationsResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSlackWorkspaceConfigurationsResult();

            if (data.hasOwnProperty('nextToken')) {
                obj['nextToken'] = ApiClient.convertToType(data['nextToken'], 'String');
            }
            if (data.hasOwnProperty('slackWorkspaceConfigurations')) {
                obj['slackWorkspaceConfigurations'] = ApiClient.convertToType(data['slackWorkspaceConfigurations'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListSlackWorkspaceConfigurationsResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSlackWorkspaceConfigurationsResult</code>.
     */
    static validateJSON(data) {
        ...
        if (data['slackWorkspaceConfigurations']) { // data not null
          Array.validateJSON(data['slackWorkspaceConfigurations']);
        }
 ...
 */
ListSlackWorkspaceConfigurationsResult.prototype['nextToken'] = undefined;

/**
 * @member {Array} slackWorkspaceConfigurations
 */
ListSlackWorkspaceConfigurationsResult.prototype['slackWorkspaceConfigurations'] = undefined;
...
export default ListSlackWorkspaceConfigurationsResult;
