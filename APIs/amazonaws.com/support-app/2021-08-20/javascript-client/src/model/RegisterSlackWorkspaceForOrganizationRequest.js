...
/**
 * The RegisterSlackWorkspaceForOrganizationRequest model module.
 * @module model/RegisterSlackWorkspaceForOrganizationRequest
 * @version 2021-08-20
 */
class RegisterSlackWorkspaceForOrganizationRequest {
    /**
     * Constructs a new <code>RegisterSlackWorkspaceForOrganizationRequest</code>.
     * @alias module:model/RegisterSlackWorkspaceForOrganizationRequest
     * @param teamId {String} The team ID in Slack. This ID uniquely identifies a Slack workspace, such as <code>T012ABCDEFG</code>. Specify the Slack workspace that you want to use for your organization.
     */
    constructor(teamId) { 
        
        RegisterSlackWorkspaceForOrganizationRequest.initialize(this, teamId);
    }
    ...
    /**
     * Constructs a <code>RegisterSlackWorkspaceForOrganizationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisterSlackWorkspaceForOrganizationRequest} obj Optional instance to populate.
     * @return {module:model/RegisterSlackWorkspaceForOrganizationRequest} The populated <code>RegisterSlackWorkspaceForOrganizationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisterSlackWorkspaceForOrganizationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RegisterSlackWorkspaceForOrganizationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisterSlackWorkspaceForOrganizationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RegisterSlackWorkspaceForOrganizationRequest.RequiredProperties) {
...
RegisterSlackWorkspaceForOrganizationRequest.RequiredProperties = ["teamId"];
 ...
 */
RegisterSlackWorkspaceForOrganizationRequest.prototype['teamId'] = undefined;
...
export default RegisterSlackWorkspaceForOrganizationRequest;
