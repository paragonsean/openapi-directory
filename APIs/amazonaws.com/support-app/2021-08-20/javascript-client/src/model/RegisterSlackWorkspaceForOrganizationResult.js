...
/**
 * The RegisterSlackWorkspaceForOrganizationResult model module.
 * @module model/RegisterSlackWorkspaceForOrganizationResult
 * @version 2021-08-20
 */
class RegisterSlackWorkspaceForOrganizationResult {
    /**
     * Constructs a new <code>RegisterSlackWorkspaceForOrganizationResult</code>.
     * @alias module:model/RegisterSlackWorkspaceForOrganizationResult
     */
    constructor() { 
        
        RegisterSlackWorkspaceForOrganizationResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RegisterSlackWorkspaceForOrganizationResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisterSlackWorkspaceForOrganizationResult} obj Optional instance to populate.
     * @return {module:model/RegisterSlackWorkspaceForOrganizationResult} The populated <code>RegisterSlackWorkspaceForOrganizationResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisterSlackWorkspaceForOrganizationResult();
    ...
    /**
     * Validates the JSON data with respect to <code>RegisterSlackWorkspaceForOrganizationResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisterSlackWorkspaceForOrganizationResult</code>.
     */
 ...
 */
RegisterSlackWorkspaceForOrganizationResult.prototype['accountType'] = undefined;

/**
 * @member {String} teamId
 */
RegisterSlackWorkspaceForOrganizationResult.prototype['teamId'] = undefined;

/**
 * @member {String} teamName
 */
RegisterSlackWorkspaceForOrganizationResult.prototype['teamName'] = undefined;
...
export default RegisterSlackWorkspaceForOrganizationResult;
