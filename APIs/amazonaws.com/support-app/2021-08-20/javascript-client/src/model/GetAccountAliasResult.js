...
/**
 * The GetAccountAliasResult model module.
 * @module model/GetAccountAliasResult
 * @version 2021-08-20
 */
class GetAccountAliasResult {
    /**
     * Constructs a new <code>GetAccountAliasResult</code>.
     * @alias module:model/GetAccountAliasResult
     */
    constructor() { 
        
        GetAccountAliasResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAccountAliasResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAccountAliasResult} obj Optional instance to populate.
     * @return {module:model/GetAccountAliasResult} The populated <code>GetAccountAliasResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAccountAliasResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetAccountAliasResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAccountAliasResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `accountAlias`
        if (data['accountAlias']) { // data not null
          String.validateJSON(data['accountAlias']);
        }
 ...
 */
GetAccountAliasResult.prototype['accountAlias'] = undefined;
...
export default GetAccountAliasResult;
