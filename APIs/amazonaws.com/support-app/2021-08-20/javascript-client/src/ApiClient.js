...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://supportapp.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://supportapp.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2021-08-20/Javascript'
        };
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "http://supportapp.{region}.amazonaws.com",
              'description': "The SupportApp multi-region endpoint",
              'variables': {
                region: {
            ...
            {
              'url': "https://supportapp.{region}.amazonaws.com",
              'description': "The SupportApp multi-region endpoint",
              'variables': {
                region: {
                    'description': "The AWS region",
            ...
            {
              'url': "http://supportapp.{region}.amazonaws.com.cn",
              'description': "The SupportApp endpoint for China (Beijing) and China (Ningxia)",
              'variables': {
                region: {
                    'description': "The AWS region",
            ...
            {
              'url': "https://supportapp.{region}.amazonaws.com.cn",
              'description': "The SupportApp endpoint for China (Beijing) and China (Ningxia)",
              'variables': {
                region: {
                    'description': "The AWS region",
