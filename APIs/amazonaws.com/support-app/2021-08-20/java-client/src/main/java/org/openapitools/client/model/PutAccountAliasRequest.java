...
public class PutAccountAliasRequest {
  ...
  public PutAccountAliasRequest() {
  }

  public PutAccountAliasRequest accountAlias(String accountAlias) {
  ...
  public boolean equals(Object o) {
    ...
    PutAccountAliasRequest putAccountAliasRequest = (PutAccountAliasRequest) o;
    return Objects.equals(this.accountAlias, putAccountAliasRequest.accountAlias);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutAccountAliasRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("accountAlias");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutAccountAliasRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutAccountAliasRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutAccountAliasRequest is not found in the empty JSON string", PutAccountAliasRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutAccountAliasRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutAccountAliasRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutAccountAliasRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("accountAlias").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutAccountAliasRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutAccountAliasRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutAccountAliasRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutAccountAliasRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutAccountAliasRequest>() {
           @Override
           public void write(JsonWriter out, PutAccountAliasRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutAccountAliasRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutAccountAliasRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutAccountAliasRequest
   * @throws IOException if the JSON string is invalid with respect to PutAccountAliasRequest
   */
  public static PutAccountAliasRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutAccountAliasRequest.class);
  }

  /**
   * Convert an instance of PutAccountAliasRequest to an JSON string
   *
   * @return JSON string
   */
