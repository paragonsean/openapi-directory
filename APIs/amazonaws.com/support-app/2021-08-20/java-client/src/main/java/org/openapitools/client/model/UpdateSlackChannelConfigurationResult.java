...
public class UpdateSlackChannelConfigurationResult {
  ...
  public UpdateSlackChannelConfigurationResult channelId(String channelId) {
  ...
  public UpdateSlackChannelConfigurationResult channelName(String channelName) {
  ...
  public UpdateSlackChannelConfigurationResult channelRoleArn(String channelRoleArn) {
  ...
  public UpdateSlackChannelConfigurationResult notifyOnAddCorrespondenceToCase(Boolean notifyOnAddCorrespondenceToCase) {
  ...
  public UpdateSlackChannelConfigurationResult notifyOnCaseSeverity(NotificationSeverityLevel notifyOnCaseSeverity) {
  ...
  public UpdateSlackChannelConfigurationResult notifyOnCreateOrReopenCase(Boolean notifyOnCreateOrReopenCase) {
  ...
  public UpdateSlackChannelConfigurationResult notifyOnResolveCase(Boolean notifyOnResolveCase) {
  ...
  public UpdateSlackChannelConfigurationResult teamId(String teamId) {
    this.teamId = teamId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateSlackChannelConfigurationResult updateSlackChannelConfigurationResult = (UpdateSlackChannelConfigurationResult) o;
    return Objects.equals(this.channelId, updateSlackChannelConfigurationResult.channelId) &&
        Objects.equals(this.channelName, updateSlackChannelConfigurationResult.channelName) &&
        Objects.equals(this.channelRoleArn, updateSlackChannelConfigurationResult.channelRoleArn) &&
        Objects.equals(this.notifyOnAddCorrespondenceToCase, updateSlackChannelConfigurationResult.notifyOnAddCorrespondenceToCase) &&
        Objects.equals(this.notifyOnCaseSeverity, updateSlackChannelConfigurationResult.notifyOnCaseSeverity) &&
        Objects.equals(this.notifyOnCreateOrReopenCase, updateSlackChannelConfigurationResult.notifyOnCreateOrReopenCase) &&
        Objects.equals(this.notifyOnResolveCase, updateSlackChannelConfigurationResult.notifyOnResolveCase) &&
        Objects.equals(this.teamId, updateSlackChannelConfigurationResult.teamId);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSlackChannelConfigurationResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSlackChannelConfigurationResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSlackChannelConfigurationResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSlackChannelConfigurationResult is not found in the empty JSON string", UpdateSlackChannelConfigurationResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSlackChannelConfigurationResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSlackChannelConfigurationResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSlackChannelConfigurationResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSlackChannelConfigurationResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSlackChannelConfigurationResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSlackChannelConfigurationResult.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSlackChannelConfigurationResult>() {
           @Override
           public void write(JsonWriter out, UpdateSlackChannelConfigurationResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSlackChannelConfigurationResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSlackChannelConfigurationResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSlackChannelConfigurationResult
   * @throws IOException if the JSON string is invalid with respect to UpdateSlackChannelConfigurationResult
   */
  public static UpdateSlackChannelConfigurationResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSlackChannelConfigurationResult.class);
  }

  /**
   * Convert an instance of UpdateSlackChannelConfigurationResult to an JSON string
   *
   * @return JSON string
   */
