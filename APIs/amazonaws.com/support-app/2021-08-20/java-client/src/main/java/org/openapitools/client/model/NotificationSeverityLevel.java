...
/**
 * Gets or Sets NotificationSeverityLevel
 */
@JsonAdapter(NotificationSeverityLevel.Adapter.class)
public enum NotificationSeverityLevel {
  ...
  NotificationSeverityLevel(String value) {
    this.value = value;
  }
  ...
  public static NotificationSeverityLevel fromValue(String value) {
    for (NotificationSeverityLevel b : NotificationSeverityLevel.values()) {
  ...
  public static class Adapter extends TypeAdapter<NotificationSeverityLevel> {
    @Override
    public void write(final JsonWriter jsonWriter, final NotificationSeverityLevel enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public NotificationSeverityLevel read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return NotificationSeverityLevel.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    NotificationSeverityLevel.fromValue(value);
  }
}
