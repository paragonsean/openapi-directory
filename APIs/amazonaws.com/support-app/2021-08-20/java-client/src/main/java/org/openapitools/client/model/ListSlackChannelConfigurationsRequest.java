...
public class ListSlackChannelConfigurationsRequest {
  ...
  public ListSlackChannelConfigurationsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListSlackChannelConfigurationsRequest listSlackChannelConfigurationsRequest = (ListSlackChannelConfigurationsRequest) o;
    return Objects.equals(this.nextToken, listSlackChannelConfigurationsRequest.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListSlackChannelConfigurationsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListSlackChannelConfigurationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListSlackChannelConfigurationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListSlackChannelConfigurationsRequest is not found in the empty JSON string", ListSlackChannelConfigurationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListSlackChannelConfigurationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListSlackChannelConfigurationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListSlackChannelConfigurationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListSlackChannelConfigurationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListSlackChannelConfigurationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListSlackChannelConfigurationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListSlackChannelConfigurationsRequest>() {
           @Override
           public void write(JsonWriter out, ListSlackChannelConfigurationsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListSlackChannelConfigurationsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListSlackChannelConfigurationsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListSlackChannelConfigurationsRequest
   * @throws IOException if the JSON string is invalid with respect to ListSlackChannelConfigurationsRequest
   */
  public static ListSlackChannelConfigurationsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSlackChannelConfigurationsRequest.class);
  }

  /**
   * Convert an instance of ListSlackChannelConfigurationsRequest to an JSON string
   *
   * @return JSON string
   */
