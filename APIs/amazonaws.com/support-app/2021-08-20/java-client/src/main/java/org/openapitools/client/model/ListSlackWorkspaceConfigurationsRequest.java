...
public class ListSlackWorkspaceConfigurationsRequest {
  ...
  public ListSlackWorkspaceConfigurationsRequest() {
  }

  public ListSlackWorkspaceConfigurationsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListSlackWorkspaceConfigurationsRequest listSlackWorkspaceConfigurationsRequest = (ListSlackWorkspaceConfigurationsRequest) o;
    return Objects.equals(this.nextToken, listSlackWorkspaceConfigurationsRequest.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListSlackWorkspaceConfigurationsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListSlackWorkspaceConfigurationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListSlackWorkspaceConfigurationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListSlackWorkspaceConfigurationsRequest is not found in the empty JSON string", ListSlackWorkspaceConfigurationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListSlackWorkspaceConfigurationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListSlackWorkspaceConfigurationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListSlackWorkspaceConfigurationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListSlackWorkspaceConfigurationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListSlackWorkspaceConfigurationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListSlackWorkspaceConfigurationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListSlackWorkspaceConfigurationsRequest>() {
           @Override
           public void write(JsonWriter out, ListSlackWorkspaceConfigurationsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListSlackWorkspaceConfigurationsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListSlackWorkspaceConfigurationsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListSlackWorkspaceConfigurationsRequest
   * @throws IOException if the JSON string is invalid with respect to ListSlackWorkspaceConfigurationsRequest
   */
  public static ListSlackWorkspaceConfigurationsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSlackWorkspaceConfigurationsRequest.class);
  }

  /**
   * Convert an instance of ListSlackWorkspaceConfigurationsRequest to an JSON string
   *
   * @return JSON string
   */
