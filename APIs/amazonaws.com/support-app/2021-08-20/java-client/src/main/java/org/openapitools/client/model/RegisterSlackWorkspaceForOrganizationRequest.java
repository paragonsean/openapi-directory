...
public class RegisterSlackWorkspaceForOrganizationRequest {
  ...
  public RegisterSlackWorkspaceForOrganizationRequest() {
  }

  public RegisterSlackWorkspaceForOrganizationRequest teamId(String teamId) {
    this.teamId = teamId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegisterSlackWorkspaceForOrganizationRequest registerSlackWorkspaceForOrganizationRequest = (RegisterSlackWorkspaceForOrganizationRequest) o;
    return Objects.equals(this.teamId, registerSlackWorkspaceForOrganizationRequest.teamId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegisterSlackWorkspaceForOrganizationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegisterSlackWorkspaceForOrganizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegisterSlackWorkspaceForOrganizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegisterSlackWorkspaceForOrganizationRequest is not found in the empty JSON string", RegisterSlackWorkspaceForOrganizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegisterSlackWorkspaceForOrganizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegisterSlackWorkspaceForOrganizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RegisterSlackWorkspaceForOrganizationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegisterSlackWorkspaceForOrganizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegisterSlackWorkspaceForOrganizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegisterSlackWorkspaceForOrganizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegisterSlackWorkspaceForOrganizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RegisterSlackWorkspaceForOrganizationRequest>() {
           @Override
           public void write(JsonWriter out, RegisterSlackWorkspaceForOrganizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegisterSlackWorkspaceForOrganizationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegisterSlackWorkspaceForOrganizationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegisterSlackWorkspaceForOrganizationRequest
   * @throws IOException if the JSON string is invalid with respect to RegisterSlackWorkspaceForOrganizationRequest
   */
  public static RegisterSlackWorkspaceForOrganizationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegisterSlackWorkspaceForOrganizationRequest.class);
  }

  /**
   * Convert an instance of RegisterSlackWorkspaceForOrganizationRequest to an JSON string
   *
   * @return JSON string
   */
