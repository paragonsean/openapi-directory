...
public class DeleteSlackWorkspaceConfigurationRequest {
  ...
  public DeleteSlackWorkspaceConfigurationRequest() {
  }

  public DeleteSlackWorkspaceConfigurationRequest teamId(String teamId) {
    this.teamId = teamId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteSlackWorkspaceConfigurationRequest deleteSlackWorkspaceConfigurationRequest = (DeleteSlackWorkspaceConfigurationRequest) o;
    return Objects.equals(this.teamId, deleteSlackWorkspaceConfigurationRequest.teamId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteSlackWorkspaceConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSlackWorkspaceConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSlackWorkspaceConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteSlackWorkspaceConfigurationRequest is not found in the empty JSON string", DeleteSlackWorkspaceConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSlackWorkspaceConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteSlackWorkspaceConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteSlackWorkspaceConfigurationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSlackWorkspaceConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSlackWorkspaceConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSlackWorkspaceConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSlackWorkspaceConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSlackWorkspaceConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, DeleteSlackWorkspaceConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSlackWorkspaceConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteSlackWorkspaceConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteSlackWorkspaceConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteSlackWorkspaceConfigurationRequest
   */
  public static DeleteSlackWorkspaceConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteSlackWorkspaceConfigurationRequest.class);
  }

  /**
   * Convert an instance of DeleteSlackWorkspaceConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
