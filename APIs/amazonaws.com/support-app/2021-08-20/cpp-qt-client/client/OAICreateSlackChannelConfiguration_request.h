...
/*
 * OAICreateSlackChannelConfiguration_request.h
 *
 * 
 */

#ifndef OAICreateSlackChannelConfiguration_request_H
#define OAICreateSlackChannelConfiguration_request_H
...
class OAICreateSlackChannelConfiguration_request : public OAIObject {
public:
    OAICreateSlackChannelConfiguration_request();
    OAICreateSlackChannelConfiguration_request(QString json);
    ~OAICreateSlackChannelConfiguration_request() override;
    ...
    bool isNotifyOnAddCorrespondenceToCase() const;
    ...
    QString getNotifyOnCaseSeverity() const;
    void setNotifyOnCaseSeverity(const QString &notify_on_case_severity);
    bool is_notify_on_case_severity_Set() const;
    bool is_notify_on_case_severity_Valid() const;

    bool isNotifyOnCreateOrReopenCase() const;
    ...
    bool isNotifyOnResolveCase() const;
...
private:
    ...
    QString m_notify_on_case_severity;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSlackChannelConfiguration_request)

#endif // OAICreateSlackChannelConfiguration_request_H
