...
OAICreateSlackChannelConfiguration_request::OAICreateSlackChannelConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSlackChannelConfiguration_request::OAICreateSlackChannelConfiguration_request() {
    this->initializeModel();
}

OAICreateSlackChannelConfiguration_request::~OAICreateSlackChannelConfiguration_request() {}

void OAICreateSlackChannelConfiguration_request::initializeModel() {
...
void OAICreateSlackChannelConfiguration_request::fromJson(QString jsonString) {
...
void OAICreateSlackChannelConfiguration_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateSlackChannelConfiguration_request::asJson() const {
...
QJsonObject OAICreateSlackChannelConfiguration_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSlackChannelConfiguration_request::getChannelId() const {
    return m_channel_id;
}
void OAICreateSlackChannelConfiguration_request::setChannelId(const QString &channel_id) {
    m_channel_id = channel_id;
    m_channel_id_isSet = true;
}

bool OAICreateSlackChannelConfiguration_request::is_channel_id_Set() const{
    return m_channel_id_isSet;
}

bool OAICreateSlackChannelConfiguration_request::is_channel_id_Valid() const{
    return m_channel_id_isValid;
}

QString OAICreateSlackChannelConfiguration_request::getChannelName() const {
    return m_channel_name;
}
void OAICreateSlackChannelConfiguration_request::setChannelName(const QString &channel_name) {
    m_channel_name = channel_name;
    m_channel_name_isSet = true;
}

bool OAICreateSlackChannelConfiguration_request::is_channel_name_Set() const{
    return m_channel_name_isSet;
}

bool OAICreateSlackChannelConfiguration_request::is_channel_name_Valid() const{
    return m_channel_name_isValid;
}

QString OAICreateSlackChannelConfiguration_request::getChannelRoleArn() const {
    return m_channel_role_arn;
}
void OAICreateSlackChannelConfiguration_request::setChannelRoleArn(const QString &channel_role_arn) {
    m_channel_role_arn = channel_role_arn;
    m_channel_role_arn_isSet = true;
}

bool OAICreateSlackChannelConfiguration_request::is_channel_role_arn_Set() const{
    return m_channel_role_arn_isSet;
}

bool OAICreateSlackChannelConfiguration_request::is_channel_role_arn_Valid() const{
    return m_channel_role_arn_isValid;
}

bool OAICreateSlackChannelConfiguration_request::isNotifyOnAddCorrespondenceToCase() const {
    return m_notify_on_add_correspondence_to_case;
}
void OAICreateSlackChannelConfiguration_request::setNotifyOnAddCorrespondenceToCase(const bool &notify_on_add_correspondence_to_case) {
...
bool OAICreateSlackChannelConfiguration_request::is_notify_on_add_correspondence_to_case_Set() const{
    return m_notify_on_add_correspondence_to_case_isSet;
}

bool OAICreateSlackChannelConfiguration_request::is_notify_on_add_correspondence_to_case_Valid() const{
    return m_notify_on_add_correspondence_to_case_isValid;
}

QString OAICreateSlackChannelConfiguration_request::getNotifyOnCaseSeverity() const {
    return m_notify_on_case_severity;
}
void OAICreateSlackChannelConfiguration_request::setNotifyOnCaseSeverity(const QString &notify_on_case_severity) {
    m_notify_on_case_severity = notify_on_case_severity;
    m_notify_on_case_severity_isSet = true;
}

bool OAICreateSlackChannelConfiguration_request::is_notify_on_case_severity_Set() const{
    return m_notify_on_case_severity_isSet;
}

bool OAICreateSlackChannelConfiguration_request::is_notify_on_case_severity_Valid() const{
    return m_notify_on_case_severity_isValid;
}

bool OAICreateSlackChannelConfiguration_request::isNotifyOnCreateOrReopenCase() const {
    return m_notify_on_create_or_reopen_case;
}
void OAICreateSlackChannelConfiguration_request::setNotifyOnCreateOrReopenCase(const bool &notify_on_create_or_reopen_case) {
    m_notify_on_create_or_reopen_case = notify_on_create_or_reopen_case;
    m_notify_on_create_or_reopen_case_isSet = true;
}

bool OAICreateSlackChannelConfiguration_request::is_notify_on_create_or_reopen_case_Set() const{
    return m_notify_on_create_or_reopen_case_isSet;
}

bool OAICreateSlackChannelConfiguration_request::is_notify_on_create_or_reopen_case_Valid() const{
    return m_notify_on_create_or_reopen_case_isValid;
}

bool OAICreateSlackChannelConfiguration_request::isNotifyOnResolveCase() const {
    return m_notify_on_resolve_case;
}
void OAICreateSlackChannelConfiguration_request::setNotifyOnResolveCase(const bool &notify_on_resolve_case) {
    m_notify_on_resolve_case = notify_on_resolve_case;
    m_notify_on_resolve_case_isSet = true;
}

bool OAICreateSlackChannelConfiguration_request::is_notify_on_resolve_case_Set() const{
    return m_notify_on_resolve_case_isSet;
}

bool OAICreateSlackChannelConfiguration_request::is_notify_on_resolve_case_Valid() const{
    return m_notify_on_resolve_case_isValid;
}

QString OAICreateSlackChannelConfiguration_request::getTeamId() const {
    return m_team_id;
}
void OAICreateSlackChannelConfiguration_request::setTeamId(const QString &team_id) {
    m_team_id = team_id;
    m_team_id_isSet = true;
}

bool OAICreateSlackChannelConfiguration_request::is_team_id_Set() const{
    return m_team_id_isSet;
}

bool OAICreateSlackChannelConfiguration_request::is_team_id_Valid() const{
    return m_team_id_isValid;
}

bool OAICreateSlackChannelConfiguration_request::isSet() const {
...
bool OAICreateSlackChannelConfiguration_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_channel_id_isValid && m_channel_role_arn_isValid && m_notify_on_case_severity_isValid && m_team_id_isValid && true;
}
