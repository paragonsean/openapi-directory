...
OAIGetAccountAliasResult::OAIGetAccountAliasResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAccountAliasResult::OAIGetAccountAliasResult() {
    this->initializeModel();
}

OAIGetAccountAliasResult::~OAIGetAccountAliasResult() {}

void OAIGetAccountAliasResult::initializeModel() {

    m_account_alias_isSet = false;
    m_account_alias_isValid = false;
}

void OAIGetAccountAliasResult::fromJson(QString jsonString) {
...
void OAIGetAccountAliasResult::fromJsonObject(QJsonObject json) {
...
QString OAIGetAccountAliasResult::asJson() const {
...
QJsonObject OAIGetAccountAliasResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetAccountAliasResult::getAccountAlias() const {
    return m_account_alias;
}
void OAIGetAccountAliasResult::setAccountAlias(const QString &account_alias) {
    m_account_alias = account_alias;
    m_account_alias_isSet = true;
}

bool OAIGetAccountAliasResult::is_account_alias_Set() const{
    return m_account_alias_isSet;
}

bool OAIGetAccountAliasResult::is_account_alias_Valid() const{
    return m_account_alias_isValid;
}

bool OAIGetAccountAliasResult::isSet() const {
...
bool OAIGetAccountAliasResult::isValid() const {
