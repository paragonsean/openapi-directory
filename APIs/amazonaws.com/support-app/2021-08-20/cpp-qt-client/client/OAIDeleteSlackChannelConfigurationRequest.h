...
/*
 * OAIDeleteSlackChannelConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDeleteSlackChannelConfigurationRequest_H
#define OAIDeleteSlackChannelConfigurationRequest_H
...
class OAIDeleteSlackChannelConfigurationRequest : public OAIObject {
public:
    OAIDeleteSlackChannelConfigurationRequest();
    OAIDeleteSlackChannelConfigurationRequest(QString json);
    ~OAIDeleteSlackChannelConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSlackChannelConfigurationRequest)

#endif // OAIDeleteSlackChannelConfigurationRequest_H
