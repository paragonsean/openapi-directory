...
OAIDeleteSlackChannelConfiguration_request::OAIDeleteSlackChannelConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteSlackChannelConfiguration_request::OAIDeleteSlackChannelConfiguration_request() {
    this->initializeModel();
}

OAIDeleteSlackChannelConfiguration_request::~OAIDeleteSlackChannelConfiguration_request() {}

void OAIDeleteSlackChannelConfiguration_request::initializeModel() {
...
void OAIDeleteSlackChannelConfiguration_request::fromJson(QString jsonString) {
...
void OAIDeleteSlackChannelConfiguration_request::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteSlackChannelConfiguration_request::asJson() const {
...
QJsonObject OAIDeleteSlackChannelConfiguration_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteSlackChannelConfiguration_request::getChannelId() const {
    return m_channel_id;
}
void OAIDeleteSlackChannelConfiguration_request::setChannelId(const QString &channel_id) {
    m_channel_id = channel_id;
    m_channel_id_isSet = true;
}

bool OAIDeleteSlackChannelConfiguration_request::is_channel_id_Set() const{
    return m_channel_id_isSet;
}

bool OAIDeleteSlackChannelConfiguration_request::is_channel_id_Valid() const{
    return m_channel_id_isValid;
}

QString OAIDeleteSlackChannelConfiguration_request::getTeamId() const {
    return m_team_id;
}
void OAIDeleteSlackChannelConfiguration_request::setTeamId(const QString &team_id) {
    m_team_id = team_id;
    m_team_id_isSet = true;
}

bool OAIDeleteSlackChannelConfiguration_request::is_team_id_Set() const{
    return m_team_id_isSet;
}

bool OAIDeleteSlackChannelConfiguration_request::is_team_id_Valid() const{
    return m_team_id_isValid;
}

bool OAIDeleteSlackChannelConfiguration_request::isSet() const {
...
bool OAIDeleteSlackChannelConfiguration_request::isValid() const {
