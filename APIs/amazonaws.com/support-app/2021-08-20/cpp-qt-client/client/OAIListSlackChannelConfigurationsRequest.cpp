...
#include "OAIListSlackChannelConfigurationsRequest.h"
...
OAIListSlackChannelConfigurationsRequest::OAIListSlackChannelConfigurationsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListSlackChannelConfigurationsRequest::OAIListSlackChannelConfigurationsRequest() {
    this->initializeModel();
}

OAIListSlackChannelConfigurationsRequest::~OAIListSlackChannelConfigurationsRequest() {}

void OAIListSlackChannelConfigurationsRequest::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListSlackChannelConfigurationsRequest::fromJson(QString jsonString) {
...
void OAIListSlackChannelConfigurationsRequest::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIListSlackChannelConfigurationsRequest::asJson() const {
...
QJsonObject OAIListSlackChannelConfigurationsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListSlackChannelConfigurationsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListSlackChannelConfigurationsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListSlackChannelConfigurationsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListSlackChannelConfigurationsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListSlackChannelConfigurationsRequest::isSet() const {
...
bool OAIListSlackChannelConfigurationsRequest::isValid() const {
