...
/*
 * OAIListSlackWorkspaceConfigurationsResult.h
 *
 * 
 */

#ifndef OAIListSlackWorkspaceConfigurationsResult_H
#define OAIListSlackWorkspaceConfigurationsResult_H
...
class OAIListSlackWorkspaceConfigurationsResult : public OAIObject {
public:
    OAIListSlackWorkspaceConfigurationsResult();
    OAIListSlackWorkspaceConfigurationsResult(QString json);
    ~OAIListSlackWorkspaceConfigurationsResult() override;
    ...
    QList getSlackWorkspaceConfigurations() const;
    void setSlackWorkspaceConfigurations(const QList &slack_workspace_configurations);
    bool is_slack_workspace_configurations_Set() const;
    bool is_slack_workspace_configurations_Valid() const;
...
private:
    ...
    QList m_slack_workspace_configurations;
    bool m_slack_workspace_configurations_isSet;
    bool m_slack_workspace_configurations_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListSlackWorkspaceConfigurationsResult)

#endif // OAIListSlackWorkspaceConfigurationsResult_H
