...
/*
 * OAIUpdateSlackChannelConfigurationRequest.h
 *
 * 
 */

#ifndef OAIUpdateSlackChannelConfigurationRequest_H
#define OAIUpdateSlackChannelConfigurationRequest_H
...
class OAIUpdateSlackChannelConfigurationRequest : public OAIObject {
public:
    OAIUpdateSlackChannelConfigurationRequest();
    OAIUpdateSlackChannelConfigurationRequest(QString json);
    ~OAIUpdateSlackChannelConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSlackChannelConfigurationRequest)

#endif // OAIUpdateSlackChannelConfigurationRequest_H
