...
/*
 * OAIListSlackChannelConfigurationsRequest.h
 *
 * 
 */

#ifndef OAIListSlackChannelConfigurationsRequest_H
#define OAIListSlackChannelConfigurationsRequest_H
...
class OAIListSlackChannelConfigurationsRequest : public OAIObject {
public:
    OAIListSlackChannelConfigurationsRequest();
    OAIListSlackChannelConfigurationsRequest(QString json);
    ~OAIListSlackChannelConfigurationsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSlackChannelConfigurationsRequest)

#endif // OAIListSlackChannelConfigurationsRequest_H
