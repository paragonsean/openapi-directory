...
/*
 * OAIUpdateSlackChannelConfiguration_request.h
 *
 * 
 */

#ifndef OAIUpdateSlackChannelConfiguration_request_H
#define OAIUpdateSlackChannelConfiguration_request_H
...
class OAIUpdateSlackChannelConfiguration_request : public OAIObject {
public:
    OAIUpdateSlackChannelConfiguration_request();
    OAIUpdateSlackChannelConfiguration_request(QString json);
    ~OAIUpdateSlackChannelConfiguration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSlackChannelConfiguration_request)

#endif // OAIUpdateSlackChannelConfiguration_request_H
