...
#include "OAICreateSlackChannelConfigurationRequest.h"
...
OAICreateSlackChannelConfigurationRequest::OAICreateSlackChannelConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSlackChannelConfigurationRequest::OAICreateSlackChannelConfigurationRequest() {
    this->initializeModel();
}

OAICreateSlackChannelConfigurationRequest::~OAICreateSlackChannelConfigurationRequest() {}

void OAICreateSlackChannelConfigurationRequest::initializeModel() {
...
void OAICreateSlackChannelConfigurationRequest::fromJson(QString jsonString) {
...
void OAICreateSlackChannelConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateSlackChannelConfigurationRequest::asJson() const {
...
QJsonObject OAICreateSlackChannelConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSlackChannelConfigurationRequest::getChannelId() const {
    return m_channel_id;
}
void OAICreateSlackChannelConfigurationRequest::setChannelId(const QString &channel_id) {
    m_channel_id = channel_id;
    m_channel_id_isSet = true;
}

bool OAICreateSlackChannelConfigurationRequest::is_channel_id_Set() const{
    return m_channel_id_isSet;
}

bool OAICreateSlackChannelConfigurationRequest::is_channel_id_Valid() const{
    return m_channel_id_isValid;
}

QString OAICreateSlackChannelConfigurationRequest::getChannelName() const {
    return m_channel_name;
}
void OAICreateSlackChannelConfigurationRequest::setChannelName(const QString &channel_name) {
    m_channel_name = channel_name;
    m_channel_name_isSet = true;
}

bool OAICreateSlackChannelConfigurationRequest::is_channel_name_Set() const{
    return m_channel_name_isSet;
}

bool OAICreateSlackChannelConfigurationRequest::is_channel_name_Valid() const{
    return m_channel_name_isValid;
}

QString OAICreateSlackChannelConfigurationRequest::getChannelRoleArn() const {
    return m_channel_role_arn;
}
void OAICreateSlackChannelConfigurationRequest::setChannelRoleArn(const QString &channel_role_arn) {
    m_channel_role_arn = channel_role_arn;
    m_channel_role_arn_isSet = true;
}

bool OAICreateSlackChannelConfigurationRequest::is_channel_role_arn_Set() const{
    return m_channel_role_arn_isSet;
}

bool OAICreateSlackChannelConfigurationRequest::is_channel_role_arn_Valid() const{
    return m_channel_role_arn_isValid;
}

bool OAICreateSlackChannelConfigurationRequest::getNotifyOnAddCorrespondenceToCase() const {
    return m_notify_on_add_correspondence_to_case;
}
void OAICreateSlackChannelConfigurationRequest::setNotifyOnAddCorrespondenceToCase(const bool &notify_on_add_correspondence_to_case) {
...
bool OAICreateSlackChannelConfigurationRequest::is_notify_on_add_correspondence_to_case_Set() const{
    return m_notify_on_add_correspondence_to_case_isSet;
}

bool OAICreateSlackChannelConfigurationRequest::is_notify_on_add_correspondence_to_case_Valid() const{
    return m_notify_on_add_correspondence_to_case_isValid;
}

OAINotificationSeverityLevel OAICreateSlackChannelConfigurationRequest::getNotifyOnCaseSeverity() const {
    return m_notify_on_case_severity;
}
void OAICreateSlackChannelConfigurationRequest::setNotifyOnCaseSeverity(const OAINotificationSeverityLevel &notify_on_case_severity) {
    m_notify_on_case_severity = notify_on_case_severity;
    m_notify_on_case_severity_isSet = true;
}

bool OAICreateSlackChannelConfigurationRequest::is_notify_on_case_severity_Set() const{
    return m_notify_on_case_severity_isSet;
}

bool OAICreateSlackChannelConfigurationRequest::is_notify_on_case_severity_Valid() const{
    return m_notify_on_case_severity_isValid;
}

bool OAICreateSlackChannelConfigurationRequest::getNotifyOnCreateOrReopenCase() const {
    return m_notify_on_create_or_reopen_case;
}
void OAICreateSlackChannelConfigurationRequest::setNotifyOnCreateOrReopenCase(const bool &notify_on_create_or_reopen_case) {
    m_notify_on_create_or_reopen_case = notify_on_create_or_reopen_case;
    m_notify_on_create_or_reopen_case_isSet = true;
}

bool OAICreateSlackChannelConfigurationRequest::is_notify_on_create_or_reopen_case_Set() const{
    return m_notify_on_create_or_reopen_case_isSet;
}

bool OAICreateSlackChannelConfigurationRequest::is_notify_on_create_or_reopen_case_Valid() const{
    return m_notify_on_create_or_reopen_case_isValid;
}

bool OAICreateSlackChannelConfigurationRequest::getNotifyOnResolveCase() const {
    return m_notify_on_resolve_case;
}
void OAICreateSlackChannelConfigurationRequest::setNotifyOnResolveCase(const bool &notify_on_resolve_case) {
    m_notify_on_resolve_case = notify_on_resolve_case;
    m_notify_on_resolve_case_isSet = true;
}

bool OAICreateSlackChannelConfigurationRequest::is_notify_on_resolve_case_Set() const{
    return m_notify_on_resolve_case_isSet;
}

bool OAICreateSlackChannelConfigurationRequest::is_notify_on_resolve_case_Valid() const{
    return m_notify_on_resolve_case_isValid;
}

QString OAICreateSlackChannelConfigurationRequest::getTeamId() const {
    return m_team_id;
}
void OAICreateSlackChannelConfigurationRequest::setTeamId(const QString &team_id) {
    m_team_id = team_id;
    m_team_id_isSet = true;
}

bool OAICreateSlackChannelConfigurationRequest::is_team_id_Set() const{
    return m_team_id_isSet;
}

bool OAICreateSlackChannelConfigurationRequest::is_team_id_Valid() const{
    return m_team_id_isValid;
}

bool OAICreateSlackChannelConfigurationRequest::isSet() const {
...
bool OAICreateSlackChannelConfigurationRequest::isValid() const {
