...
/*
 * OAIDeleteSlackChannelConfiguration_request.h
 *
 * 
 */

#ifndef OAIDeleteSlackChannelConfiguration_request_H
#define OAIDeleteSlackChannelConfiguration_request_H
...
class OAIDeleteSlackChannelConfiguration_request : public OAIObject {
public:
    OAIDeleteSlackChannelConfiguration_request();
    OAIDeleteSlackChannelConfiguration_request(QString json);
    ~OAIDeleteSlackChannelConfiguration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSlackChannelConfiguration_request)

#endif // OAIDeleteSlackChannelConfiguration_request_H
