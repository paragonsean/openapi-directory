...
/*
 * OAIPutAccountAliasRequest.h
 *
 * 
 */

#ifndef OAIPutAccountAliasRequest_H
#define OAIPutAccountAliasRequest_H
...
class OAIPutAccountAliasRequest : public OAIObject {
public:
    OAIPutAccountAliasRequest();
    OAIPutAccountAliasRequest(QString json);
    ~OAIPutAccountAliasRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutAccountAliasRequest)

#endif // OAIPutAccountAliasRequest_H
