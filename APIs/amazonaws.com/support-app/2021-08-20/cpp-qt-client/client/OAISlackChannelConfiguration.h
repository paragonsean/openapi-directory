...
/*
 * OAISlackChannelConfiguration.h
 *
 * The configuration for a Slack channel that you added for your Amazon Web Services account.
 */

#ifndef OAISlackChannelConfiguration_H
#define OAISlackChannelConfiguration_H
...
class OAISlackChannelConfiguration : public OAIObject {
public:
    OAISlackChannelConfiguration();
    OAISlackChannelConfiguration(QString json);
    ~OAISlackChannelConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISlackChannelConfiguration)

#endif // OAISlackChannelConfiguration_H
