...
/*
 * OAIDeleteSlackWorkspaceConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDeleteSlackWorkspaceConfigurationRequest_H
#define OAIDeleteSlackWorkspaceConfigurationRequest_H
...
class OAIDeleteSlackWorkspaceConfigurationRequest : public OAIObject {
public:
    OAIDeleteSlackWorkspaceConfigurationRequest();
    OAIDeleteSlackWorkspaceConfigurationRequest(QString json);
    ~OAIDeleteSlackWorkspaceConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSlackWorkspaceConfigurationRequest)

#endif // OAIDeleteSlackWorkspaceConfigurationRequest_H
