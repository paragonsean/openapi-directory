...
/*
 * OAISlackWorkspaceConfiguration.h
 *
 * The configuration for a Slack workspace that you added to an Amazon Web Services account.
 */

#ifndef OAISlackWorkspaceConfiguration_H
#define OAISlackWorkspaceConfiguration_H
...
class OAISlackWorkspaceConfiguration : public OAIObject {
public:
    OAISlackWorkspaceConfiguration();
    OAISlackWorkspaceConfiguration(QString json);
    ~OAISlackWorkspaceConfiguration() override;
    ...
    bool getAllowOrganizationMemberAccount() const;
    void setAllowOrganizationMemberAccount(const bool &allow_organization_member_account);
    bool is_allow_organization_member_account_Set() const;
    bool is_allow_organization_member_account_Valid() const;
...
private:
    ...
    bool m_allow_organization_member_account;
    bool m_allow_organization_member_account_isSet;
    bool m_allow_organization_member_account_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISlackWorkspaceConfiguration)

#endif // OAISlackWorkspaceConfiguration_H
