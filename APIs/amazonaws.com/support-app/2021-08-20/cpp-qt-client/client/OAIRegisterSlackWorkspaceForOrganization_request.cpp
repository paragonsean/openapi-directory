...
OAIRegisterSlackWorkspaceForOrganization_request::OAIRegisterSlackWorkspaceForOrganization_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegisterSlackWorkspaceForOrganization_request::OAIRegisterSlackWorkspaceForOrganization_request() {
    this->initializeModel();
}

OAIRegisterSlackWorkspaceForOrganization_request::~OAIRegisterSlackWorkspaceForOrganization_request() {}

void OAIRegisterSlackWorkspaceForOrganization_request::initializeModel() {

    m_team_id_isSet = false;
    m_team_id_isValid = false;
}

void OAIRegisterSlackWorkspaceForOrganization_request::fromJson(QString jsonString) {
...
void OAIRegisterSlackWorkspaceForOrganization_request::fromJsonObject(QJsonObject json) {

    m_team_id_isValid = ::OpenAPI::fromJsonValue(m_team_id, json[QString("teamId")]);
    m_team_id_isSet = !json[QString("teamId")].isNull() && m_team_id_isValid;
}

QString OAIRegisterSlackWorkspaceForOrganization_request::asJson() const {
...
QJsonObject OAIRegisterSlackWorkspaceForOrganization_request::asJsonObject() const {
    QJsonObject obj;
    if (m_team_id_isSet) {
...
QString OAIRegisterSlackWorkspaceForOrganization_request::getTeamId() const {
    return m_team_id;
}
void OAIRegisterSlackWorkspaceForOrganization_request::setTeamId(const QString &team_id) {
    m_team_id = team_id;
    m_team_id_isSet = true;
}

bool OAIRegisterSlackWorkspaceForOrganization_request::is_team_id_Set() const{
    return m_team_id_isSet;
}

bool OAIRegisterSlackWorkspaceForOrganization_request::is_team_id_Valid() const{
    return m_team_id_isValid;
}

bool OAIRegisterSlackWorkspaceForOrganization_request::isSet() const {
...
bool OAIRegisterSlackWorkspaceForOrganization_request::isValid() const {
