...
#include "OAISlackChannelConfiguration.h"
...
OAISlackChannelConfiguration::OAISlackChannelConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISlackChannelConfiguration::OAISlackChannelConfiguration() {
    this->initializeModel();
}

OAISlackChannelConfiguration::~OAISlackChannelConfiguration() {}

void OAISlackChannelConfiguration::initializeModel() {
...
void OAISlackChannelConfiguration::fromJson(QString jsonString) {
...
void OAISlackChannelConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAISlackChannelConfiguration::asJson() const {
...
QJsonObject OAISlackChannelConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAISlackChannelConfiguration::getChannelId() const {
    return m_channel_id;
}
void OAISlackChannelConfiguration::setChannelId(const QString &channel_id) {
    m_channel_id = channel_id;
    m_channel_id_isSet = true;
}

bool OAISlackChannelConfiguration::is_channel_id_Set() const{
    return m_channel_id_isSet;
}

bool OAISlackChannelConfiguration::is_channel_id_Valid() const{
    return m_channel_id_isValid;
}

QString OAISlackChannelConfiguration::getChannelName() const {
    return m_channel_name;
}
void OAISlackChannelConfiguration::setChannelName(const QString &channel_name) {
    m_channel_name = channel_name;
    m_channel_name_isSet = true;
}

bool OAISlackChannelConfiguration::is_channel_name_Set() const{
    return m_channel_name_isSet;
}

bool OAISlackChannelConfiguration::is_channel_name_Valid() const{
    return m_channel_name_isValid;
}

QString OAISlackChannelConfiguration::getChannelRoleArn() const {
    return m_channel_role_arn;
}
void OAISlackChannelConfiguration::setChannelRoleArn(const QString &channel_role_arn) {
    m_channel_role_arn = channel_role_arn;
    m_channel_role_arn_isSet = true;
}

bool OAISlackChannelConfiguration::is_channel_role_arn_Set() const{
    return m_channel_role_arn_isSet;
}

bool OAISlackChannelConfiguration::is_channel_role_arn_Valid() const{
    return m_channel_role_arn_isValid;
}

bool OAISlackChannelConfiguration::getNotifyOnAddCorrespondenceToCase() const {
    return m_notify_on_add_correspondence_to_case;
}
void OAISlackChannelConfiguration::setNotifyOnAddCorrespondenceToCase(const bool &notify_on_add_correspondence_to_case) {
...
bool OAISlackChannelConfiguration::is_notify_on_add_correspondence_to_case_Set() const{
    return m_notify_on_add_correspondence_to_case_isSet;
}

bool OAISlackChannelConfiguration::is_notify_on_add_correspondence_to_case_Valid() const{
    return m_notify_on_add_correspondence_to_case_isValid;
}

OAINotificationSeverityLevel OAISlackChannelConfiguration::getNotifyOnCaseSeverity() const {
    return m_notify_on_case_severity;
}
void OAISlackChannelConfiguration::setNotifyOnCaseSeverity(const OAINotificationSeverityLevel &notify_on_case_severity) {
    m_notify_on_case_severity = notify_on_case_severity;
    m_notify_on_case_severity_isSet = true;
}

bool OAISlackChannelConfiguration::is_notify_on_case_severity_Set() const{
    return m_notify_on_case_severity_isSet;
}

bool OAISlackChannelConfiguration::is_notify_on_case_severity_Valid() const{
    return m_notify_on_case_severity_isValid;
}

bool OAISlackChannelConfiguration::getNotifyOnCreateOrReopenCase() const {
    return m_notify_on_create_or_reopen_case;
}
void OAISlackChannelConfiguration::setNotifyOnCreateOrReopenCase(const bool &notify_on_create_or_reopen_case) {
    m_notify_on_create_or_reopen_case = notify_on_create_or_reopen_case;
    m_notify_on_create_or_reopen_case_isSet = true;
}

bool OAISlackChannelConfiguration::is_notify_on_create_or_reopen_case_Set() const{
    return m_notify_on_create_or_reopen_case_isSet;
}

bool OAISlackChannelConfiguration::is_notify_on_create_or_reopen_case_Valid() const{
    return m_notify_on_create_or_reopen_case_isValid;
}

bool OAISlackChannelConfiguration::getNotifyOnResolveCase() const {
    return m_notify_on_resolve_case;
}
void OAISlackChannelConfiguration::setNotifyOnResolveCase(const bool &notify_on_resolve_case) {
    m_notify_on_resolve_case = notify_on_resolve_case;
    m_notify_on_resolve_case_isSet = true;
}

bool OAISlackChannelConfiguration::is_notify_on_resolve_case_Set() const{
    return m_notify_on_resolve_case_isSet;
}

bool OAISlackChannelConfiguration::is_notify_on_resolve_case_Valid() const{
    return m_notify_on_resolve_case_isValid;
}

QString OAISlackChannelConfiguration::getTeamId() const {
    return m_team_id;
}
void OAISlackChannelConfiguration::setTeamId(const QString &team_id) {
    m_team_id = team_id;
    m_team_id_isSet = true;
}

bool OAISlackChannelConfiguration::is_team_id_Set() const{
    return m_team_id_isSet;
}

bool OAISlackChannelConfiguration::is_team_id_Valid() const{
    return m_team_id_isValid;
}

bool OAISlackChannelConfiguration::isSet() const {
...
bool OAISlackChannelConfiguration::isValid() const {
