...
/*
 * OAIListSlackChannelConfigurations_request.h
 *
 * 
 */

#ifndef OAIListSlackChannelConfigurations_request_H
#define OAIListSlackChannelConfigurations_request_H
...
class OAIListSlackChannelConfigurations_request : public OAIObject {
public:
    OAIListSlackChannelConfigurations_request();
    OAIListSlackChannelConfigurations_request(QString json);
    ~OAIListSlackChannelConfigurations_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSlackChannelConfigurations_request)

#endif // OAIListSlackChannelConfigurations_request_H
