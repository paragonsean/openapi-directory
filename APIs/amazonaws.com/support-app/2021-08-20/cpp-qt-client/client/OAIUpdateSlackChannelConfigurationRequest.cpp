...
#include "OAIUpdateSlackChannelConfigurationRequest.h"
...
OAIUpdateSlackChannelConfigurationRequest::OAIUpdateSlackChannelConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSlackChannelConfigurationRequest::OAIUpdateSlackChannelConfigurationRequest() {
    this->initializeModel();
}

OAIUpdateSlackChannelConfigurationRequest::~OAIUpdateSlackChannelConfigurationRequest() {}

void OAIUpdateSlackChannelConfigurationRequest::initializeModel() {
...
void OAIUpdateSlackChannelConfigurationRequest::fromJson(QString jsonString) {
...
void OAIUpdateSlackChannelConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSlackChannelConfigurationRequest::asJson() const {
...
QJsonObject OAIUpdateSlackChannelConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSlackChannelConfigurationRequest::getChannelId() const {
    return m_channel_id;
}
void OAIUpdateSlackChannelConfigurationRequest::setChannelId(const QString &channel_id) {
    m_channel_id = channel_id;
    m_channel_id_isSet = true;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_channel_id_Set() const{
    return m_channel_id_isSet;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_channel_id_Valid() const{
    return m_channel_id_isValid;
}

QString OAIUpdateSlackChannelConfigurationRequest::getChannelName() const {
    return m_channel_name;
}
void OAIUpdateSlackChannelConfigurationRequest::setChannelName(const QString &channel_name) {
    m_channel_name = channel_name;
    m_channel_name_isSet = true;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_channel_name_Set() const{
    return m_channel_name_isSet;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_channel_name_Valid() const{
    return m_channel_name_isValid;
}

QString OAIUpdateSlackChannelConfigurationRequest::getChannelRoleArn() const {
    return m_channel_role_arn;
}
void OAIUpdateSlackChannelConfigurationRequest::setChannelRoleArn(const QString &channel_role_arn) {
    m_channel_role_arn = channel_role_arn;
    m_channel_role_arn_isSet = true;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_channel_role_arn_Set() const{
    return m_channel_role_arn_isSet;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_channel_role_arn_Valid() const{
    return m_channel_role_arn_isValid;
}

bool OAIUpdateSlackChannelConfigurationRequest::getNotifyOnAddCorrespondenceToCase() const {
    return m_notify_on_add_correspondence_to_case;
}
void OAIUpdateSlackChannelConfigurationRequest::setNotifyOnAddCorrespondenceToCase(const bool &notify_on_add_correspondence_to_case) {
...
bool OAIUpdateSlackChannelConfigurationRequest::is_notify_on_add_correspondence_to_case_Set() const{
    return m_notify_on_add_correspondence_to_case_isSet;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_notify_on_add_correspondence_to_case_Valid() const{
    return m_notify_on_add_correspondence_to_case_isValid;
}

OAINotificationSeverityLevel OAIUpdateSlackChannelConfigurationRequest::getNotifyOnCaseSeverity() const {
    return m_notify_on_case_severity;
}
void OAIUpdateSlackChannelConfigurationRequest::setNotifyOnCaseSeverity(const OAINotificationSeverityLevel &notify_on_case_severity) {
    m_notify_on_case_severity = notify_on_case_severity;
    m_notify_on_case_severity_isSet = true;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_notify_on_case_severity_Set() const{
    return m_notify_on_case_severity_isSet;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_notify_on_case_severity_Valid() const{
    return m_notify_on_case_severity_isValid;
}

bool OAIUpdateSlackChannelConfigurationRequest::getNotifyOnCreateOrReopenCase() const {
    return m_notify_on_create_or_reopen_case;
}
void OAIUpdateSlackChannelConfigurationRequest::setNotifyOnCreateOrReopenCase(const bool &notify_on_create_or_reopen_case) {
    m_notify_on_create_or_reopen_case = notify_on_create_or_reopen_case;
    m_notify_on_create_or_reopen_case_isSet = true;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_notify_on_create_or_reopen_case_Set() const{
    return m_notify_on_create_or_reopen_case_isSet;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_notify_on_create_or_reopen_case_Valid() const{
    return m_notify_on_create_or_reopen_case_isValid;
}

bool OAIUpdateSlackChannelConfigurationRequest::getNotifyOnResolveCase() const {
    return m_notify_on_resolve_case;
}
void OAIUpdateSlackChannelConfigurationRequest::setNotifyOnResolveCase(const bool &notify_on_resolve_case) {
    m_notify_on_resolve_case = notify_on_resolve_case;
    m_notify_on_resolve_case_isSet = true;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_notify_on_resolve_case_Set() const{
    return m_notify_on_resolve_case_isSet;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_notify_on_resolve_case_Valid() const{
    return m_notify_on_resolve_case_isValid;
}

QString OAIUpdateSlackChannelConfigurationRequest::getTeamId() const {
    return m_team_id;
}
void OAIUpdateSlackChannelConfigurationRequest::setTeamId(const QString &team_id) {
    m_team_id = team_id;
    m_team_id_isSet = true;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_team_id_Set() const{
    return m_team_id_isSet;
}

bool OAIUpdateSlackChannelConfigurationRequest::is_team_id_Valid() const{
    return m_team_id_isValid;
}

bool OAIUpdateSlackChannelConfigurationRequest::isSet() const {
...
bool OAIUpdateSlackChannelConfigurationRequest::isValid() const {
