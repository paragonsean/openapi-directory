...
#include "OAIPutAccountAliasRequest.h"
...
OAIPutAccountAliasRequest::OAIPutAccountAliasRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutAccountAliasRequest::OAIPutAccountAliasRequest() {
    this->initializeModel();
}

OAIPutAccountAliasRequest::~OAIPutAccountAliasRequest() {}

void OAIPutAccountAliasRequest::initializeModel() {

    m_account_alias_isSet = false;
    m_account_alias_isValid = false;
}

void OAIPutAccountAliasRequest::fromJson(QString jsonString) {
...
void OAIPutAccountAliasRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutAccountAliasRequest::asJson() const {
...
QJsonObject OAIPutAccountAliasRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutAccountAliasRequest::getAccountAlias() const {
    return m_account_alias;
}
void OAIPutAccountAliasRequest::setAccountAlias(const QString &account_alias) {
    m_account_alias = account_alias;
    m_account_alias_isSet = true;
}

bool OAIPutAccountAliasRequest::is_account_alias_Set() const{
    return m_account_alias_isSet;
}

bool OAIPutAccountAliasRequest::is_account_alias_Valid() const{
    return m_account_alias_isValid;
}

bool OAIPutAccountAliasRequest::isSet() const {
...
bool OAIPutAccountAliasRequest::isValid() const {
