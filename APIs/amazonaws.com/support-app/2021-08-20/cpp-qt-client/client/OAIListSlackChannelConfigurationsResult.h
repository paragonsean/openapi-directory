...
/*
 * OAIListSlackChannelConfigurationsResult.h
 *
 * 
 */

#ifndef OAIListSlackChannelConfigurationsResult_H
#define OAIListSlackChannelConfigurationsResult_H
...
class OAIListSlackChannelConfigurationsResult : public OAIObject {
public:
    OAIListSlackChannelConfigurationsResult();
    OAIListSlackChannelConfigurationsResult(QString json);
    ~OAIListSlackChannelConfigurationsResult() override;
    ...
    QList getSlackChannelConfigurations() const;
    void setSlackChannelConfigurations(const QList &slack_channel_configurations);
    bool is_slack_channel_configurations_Set() const;
    bool is_slack_channel_configurations_Valid() const;
...
private:
    ...
    QList m_slack_channel_configurations;
    bool m_slack_channel_configurations_isSet;
    bool m_slack_channel_configurations_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListSlackChannelConfigurationsResult)

#endif // OAIListSlackChannelConfigurationsResult_H
