...
OAIListSlackChannelConfigurations_request::OAIListSlackChannelConfigurations_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListSlackChannelConfigurations_request::OAIListSlackChannelConfigurations_request() {
    this->initializeModel();
}

OAIListSlackChannelConfigurations_request::~OAIListSlackChannelConfigurations_request() {}

void OAIListSlackChannelConfigurations_request::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListSlackChannelConfigurations_request::fromJson(QString jsonString) {
...
void OAIListSlackChannelConfigurations_request::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIListSlackChannelConfigurations_request::asJson() const {
...
QJsonObject OAIListSlackChannelConfigurations_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListSlackChannelConfigurations_request::getNextToken() const {
    return m_next_token;
}
void OAIListSlackChannelConfigurations_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListSlackChannelConfigurations_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListSlackChannelConfigurations_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListSlackChannelConfigurations_request::isSet() const {
...
bool OAIListSlackChannelConfigurations_request::isValid() const {
