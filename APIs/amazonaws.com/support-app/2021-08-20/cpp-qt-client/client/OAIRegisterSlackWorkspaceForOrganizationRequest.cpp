...
#include "OAIRegisterSlackWorkspaceForOrganizationRequest.h"
...
OAIRegisterSlackWorkspaceForOrganizationRequest::OAIRegisterSlackWorkspaceForOrganizationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegisterSlackWorkspaceForOrganizationRequest::OAIRegisterSlackWorkspaceForOrganizationRequest() {
    this->initializeModel();
}

OAIRegisterSlackWorkspaceForOrganizationRequest::~OAIRegisterSlackWorkspaceForOrganizationRequest() {}

void OAIRegisterSlackWorkspaceForOrganizationRequest::initializeModel() {

    m_team_id_isSet = false;
    m_team_id_isValid = false;
}

void OAIRegisterSlackWorkspaceForOrganizationRequest::fromJson(QString jsonString) {
...
void OAIRegisterSlackWorkspaceForOrganizationRequest::fromJsonObject(QJsonObject json) {

    m_team_id_isValid = ::OpenAPI::fromJsonValue(m_team_id, json[QString("teamId")]);
    m_team_id_isSet = !json[QString("teamId")].isNull() && m_team_id_isValid;
}

QString OAIRegisterSlackWorkspaceForOrganizationRequest::asJson() const {
...
QJsonObject OAIRegisterSlackWorkspaceForOrganizationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_team_id_isSet) {
...
QString OAIRegisterSlackWorkspaceForOrganizationRequest::getTeamId() const {
    return m_team_id;
}
void OAIRegisterSlackWorkspaceForOrganizationRequest::setTeamId(const QString &team_id) {
    m_team_id = team_id;
    m_team_id_isSet = true;
}

bool OAIRegisterSlackWorkspaceForOrganizationRequest::is_team_id_Set() const{
    return m_team_id_isSet;
}

bool OAIRegisterSlackWorkspaceForOrganizationRequest::is_team_id_Valid() const{
    return m_team_id_isValid;
}

bool OAIRegisterSlackWorkspaceForOrganizationRequest::isSet() const {
...
bool OAIRegisterSlackWorkspaceForOrganizationRequest::isValid() const {
