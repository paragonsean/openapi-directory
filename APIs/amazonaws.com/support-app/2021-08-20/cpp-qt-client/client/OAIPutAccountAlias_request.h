...
/*
 * OAIPutAccountAlias_request.h
 *
 * 
 */

#ifndef OAIPutAccountAlias_request_H
#define OAIPutAccountAlias_request_H
...
class OAIPutAccountAlias_request : public OAIObject {
public:
    OAIPutAccountAlias_request();
    OAIPutAccountAlias_request(QString json);
    ~OAIPutAccountAlias_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutAccountAlias_request)

#endif // OAIPutAccountAlias_request_H
