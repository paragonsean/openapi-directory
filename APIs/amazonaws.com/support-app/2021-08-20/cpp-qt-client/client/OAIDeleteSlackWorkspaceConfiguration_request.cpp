...
OAIDeleteSlackWorkspaceConfiguration_request::OAIDeleteSlackWorkspaceConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteSlackWorkspaceConfiguration_request::OAIDeleteSlackWorkspaceConfiguration_request() {
    this->initializeModel();
}

OAIDeleteSlackWorkspaceConfiguration_request::~OAIDeleteSlackWorkspaceConfiguration_request() {}

void OAIDeleteSlackWorkspaceConfiguration_request::initializeModel() {

    m_team_id_isSet = false;
    m_team_id_isValid = false;
}

void OAIDeleteSlackWorkspaceConfiguration_request::fromJson(QString jsonString) {
...
void OAIDeleteSlackWorkspaceConfiguration_request::fromJsonObject(QJsonObject json) {

    m_team_id_isValid = ::OpenAPI::fromJsonValue(m_team_id, json[QString("teamId")]);
    m_team_id_isSet = !json[QString("teamId")].isNull() && m_team_id_isValid;
}

QString OAIDeleteSlackWorkspaceConfiguration_request::asJson() const {
...
QJsonObject OAIDeleteSlackWorkspaceConfiguration_request::asJsonObject() const {
    QJsonObject obj;
    if (m_team_id_isSet) {
...
QString OAIDeleteSlackWorkspaceConfiguration_request::getTeamId() const {
    return m_team_id;
}
void OAIDeleteSlackWorkspaceConfiguration_request::setTeamId(const QString &team_id) {
    m_team_id = team_id;
    m_team_id_isSet = true;
}

bool OAIDeleteSlackWorkspaceConfiguration_request::is_team_id_Set() const{
    return m_team_id_isSet;
}

bool OAIDeleteSlackWorkspaceConfiguration_request::is_team_id_Valid() const{
    return m_team_id_isValid;
}

bool OAIDeleteSlackWorkspaceConfiguration_request::isSet() const {
...
bool OAIDeleteSlackWorkspaceConfiguration_request::isValid() const {
