...
/*
 * OAIUpdateSlackChannelConfigurationResult.h
 *
 * 
 */

#ifndef OAIUpdateSlackChannelConfigurationResult_H
#define OAIUpdateSlackChannelConfigurationResult_H
...
class OAIUpdateSlackChannelConfigurationResult : public OAIObject {
public:
    OAIUpdateSlackChannelConfigurationResult();
    OAIUpdateSlackChannelConfigurationResult(QString json);
    ~OAIUpdateSlackChannelConfigurationResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSlackChannelConfigurationResult)

#endif // OAIUpdateSlackChannelConfigurationResult_H
