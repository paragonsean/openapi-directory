...
/*
 * OAIGetAccountAliasResult.h
 *
 * 
 */

#ifndef OAIGetAccountAliasResult_H
#define OAIGetAccountAliasResult_H
...
class OAIGetAccountAliasResult : public OAIObject {
public:
    OAIGetAccountAliasResult();
    OAIGetAccountAliasResult(QString json);
    ~OAIGetAccountAliasResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAccountAliasResult)

#endif // OAIGetAccountAliasResult_H
