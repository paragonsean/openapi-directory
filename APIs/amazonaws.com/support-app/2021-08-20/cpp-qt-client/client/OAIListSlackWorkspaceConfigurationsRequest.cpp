...
#include "OAIListSlackWorkspaceConfigurationsRequest.h"
...
OAIListSlackWorkspaceConfigurationsRequest::OAIListSlackWorkspaceConfigurationsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListSlackWorkspaceConfigurationsRequest::OAIListSlackWorkspaceConfigurationsRequest() {
    this->initializeModel();
}

OAIListSlackWorkspaceConfigurationsRequest::~OAIListSlackWorkspaceConfigurationsRequest() {}

void OAIListSlackWorkspaceConfigurationsRequest::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListSlackWorkspaceConfigurationsRequest::fromJson(QString jsonString) {
...
void OAIListSlackWorkspaceConfigurationsRequest::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIListSlackWorkspaceConfigurationsRequest::asJson() const {
...
QJsonObject OAIListSlackWorkspaceConfigurationsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListSlackWorkspaceConfigurationsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListSlackWorkspaceConfigurationsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListSlackWorkspaceConfigurationsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListSlackWorkspaceConfigurationsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListSlackWorkspaceConfigurationsRequest::isSet() const {
...
bool OAIListSlackWorkspaceConfigurationsRequest::isValid() const {
