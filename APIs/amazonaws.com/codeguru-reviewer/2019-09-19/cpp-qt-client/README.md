...
class Example : public QObject {
    Q_OBJECT
    OAIAssociateRepository_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAIAssociateRepository_request Example::create(){
    OAIAssociateRepository_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::associateRepositorySignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::associateRepositorySignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIAssociateRepository_request oai_associate_repository_request = create(); // OAIAssociateRepository_request | 
      ...
      apiInstance.associateRepository(oai_associate_repository_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
