...
#ifndef OAICodeReview_H
#define OAICodeReview_H
...
class OAICodeReview : public OAIObject {
public:
    OAICodeReview();
    OAICodeReview(QString json);
    ~OAICodeReview() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeReview)

#endif // OAICodeReview_H
