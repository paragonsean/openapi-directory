...
OAIKMSKeyDetails::OAIKMSKeyDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKMSKeyDetails::OAIKMSKeyDetails() {
    this->initializeModel();
}

OAIKMSKeyDetails::~OAIKMSKeyDetails() {}

void OAIKMSKeyDetails::initializeModel() {
...
void OAIKMSKeyDetails::fromJson(QString jsonString) {
...
void OAIKMSKeyDetails::fromJsonObject(QJsonObject json) {
...
QString OAIKMSKeyDetails::asJson() const {
...
QJsonObject OAIKMSKeyDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIKMSKeyDetails::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIKMSKeyDetails::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIKMSKeyDetails::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIKMSKeyDetails::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

OAIEncryptionOption OAIKMSKeyDetails::getEncryptionOption() const {
    return m_encryption_option;
}
void OAIKMSKeyDetails::setEncryptionOption(const OAIEncryptionOption &encryption_option) {
    m_encryption_option = encryption_option;
    m_encryption_option_isSet = true;
}

bool OAIKMSKeyDetails::is_encryption_option_Set() const{
    return m_encryption_option_isSet;
}

bool OAIKMSKeyDetails::is_encryption_option_Valid() const{
    return m_encryption_option_isValid;
}

bool OAIKMSKeyDetails::isSet() const {
...
bool OAIKMSKeyDetails::isValid() const {
