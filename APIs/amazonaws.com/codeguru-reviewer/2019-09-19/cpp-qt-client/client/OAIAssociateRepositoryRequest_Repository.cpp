...
OAIAssociateRepositoryRequest_Repository::OAIAssociateRepositoryRequest_Repository(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateRepositoryRequest_Repository::OAIAssociateRepositoryRequest_Repository() {
    this->initializeModel();
}

OAIAssociateRepositoryRequest_Repository::~OAIAssociateRepositoryRequest_Repository() {}

void OAIAssociateRepositoryRequest_Repository::initializeModel() {
...
void OAIAssociateRepositoryRequest_Repository::fromJson(QString jsonString) {
...
void OAIAssociateRepositoryRequest_Repository::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateRepositoryRequest_Repository::asJson() const {
...
QJsonObject OAIAssociateRepositoryRequest_Repository::asJsonObject() const {
    QJsonObject obj;
...
OAIAssociateRepository_request_Repository_CodeCommit OAIAssociateRepositoryRequest_Repository::getCodeCommit() const {
    return m_code_commit;
}
void OAIAssociateRepositoryRequest_Repository::setCodeCommit(const OAIAssociateRepository_request_Repository_CodeCommit &code_commit) {
    m_code_commit = code_commit;
    m_code_commit_isSet = true;
}

bool OAIAssociateRepositoryRequest_Repository::is_code_commit_Set() const{
    return m_code_commit_isSet;
}

bool OAIAssociateRepositoryRequest_Repository::is_code_commit_Valid() const{
    return m_code_commit_isValid;
}

OAIAssociateRepository_request_Repository_Bitbucket OAIAssociateRepositoryRequest_Repository::getBitbucket() const {
    return m_bitbucket;
}
void OAIAssociateRepositoryRequest_Repository::setBitbucket(const OAIAssociateRepository_request_Repository_Bitbucket &bitbucket) {
    m_bitbucket = bitbucket;
    m_bitbucket_isSet = true;
}

bool OAIAssociateRepositoryRequest_Repository::is_bitbucket_Set() const{
    return m_bitbucket_isSet;
}

bool OAIAssociateRepositoryRequest_Repository::is_bitbucket_Valid() const{
    return m_bitbucket_isValid;
}

OAIAssociateRepository_request_Repository_GitHubEnterpriseServer OAIAssociateRepositoryRequest_Repository::getGitHubEnterpriseServer() const {
    return m_git_hub_enterprise_server;
}
void OAIAssociateRepositoryRequest_Repository::setGitHubEnterpriseServer(const OAIAssociateRepository_request_Repository_GitHubEnterpriseServer &git_hub_enterprise_server) {
    m_git_hub_enterprise_server = git_hub_enterprise_server;
    m_git_hub_enterprise_server_isSet = true;
}

bool OAIAssociateRepositoryRequest_Repository::is_git_hub_enterprise_server_Set() const{
    return m_git_hub_enterprise_server_isSet;
}

bool OAIAssociateRepositoryRequest_Repository::is_git_hub_enterprise_server_Valid() const{
    return m_git_hub_enterprise_server_isValid;
}

OAIS3Repository OAIAssociateRepositoryRequest_Repository::getS3Bucket() const {
    return m_s3_bucket;
}
void OAIAssociateRepositoryRequest_Repository::setS3Bucket(const OAIS3Repository &s3_bucket) {
    m_s3_bucket = s3_bucket;
    m_s3_bucket_isSet = true;
}

bool OAIAssociateRepositoryRequest_Repository::is_s3_bucket_Set() const{
    return m_s3_bucket_isSet;
}

bool OAIAssociateRepositoryRequest_Repository::is_s3_bucket_Valid() const{
    return m_s3_bucket_isValid;
}

bool OAIAssociateRepositoryRequest_Repository::isSet() const {
...
bool OAIAssociateRepositoryRequest_Repository::isValid() const {
