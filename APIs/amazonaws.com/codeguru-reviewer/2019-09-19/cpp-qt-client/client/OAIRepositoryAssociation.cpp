...
#include "OAIRepositoryAssociation.h"
...
OAIRepositoryAssociation::OAIRepositoryAssociation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRepositoryAssociation::OAIRepositoryAssociation() {
    this->initializeModel();
}

OAIRepositoryAssociation::~OAIRepositoryAssociation() {}

void OAIRepositoryAssociation::initializeModel() {
...
void OAIRepositoryAssociation::fromJson(QString jsonString) {
...
void OAIRepositoryAssociation::fromJsonObject(QJsonObject json) {
...
QString OAIRepositoryAssociation::asJson() const {
...
QJsonObject OAIRepositoryAssociation::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRepositoryAssociation::getAssociationId() const {
    return m_association_id;
}
void OAIRepositoryAssociation::setAssociationId(const QString &association_id) {
    m_association_id = association_id;
    m_association_id_isSet = true;
}

bool OAIRepositoryAssociation::is_association_id_Set() const{
    return m_association_id_isSet;
}

bool OAIRepositoryAssociation::is_association_id_Valid() const{
    return m_association_id_isValid;
}

QString OAIRepositoryAssociation::getAssociationArn() const {
    return m_association_arn;
}
void OAIRepositoryAssociation::setAssociationArn(const QString &association_arn) {
    m_association_arn = association_arn;
    m_association_arn_isSet = true;
}

bool OAIRepositoryAssociation::is_association_arn_Set() const{
    return m_association_arn_isSet;
}

bool OAIRepositoryAssociation::is_association_arn_Valid() const{
    return m_association_arn_isValid;
}

QString OAIRepositoryAssociation::getConnectionArn() const {
    return m_connection_arn;
}
void OAIRepositoryAssociation::setConnectionArn(const QString &connection_arn) {
    m_connection_arn = connection_arn;
    m_connection_arn_isSet = true;
}

bool OAIRepositoryAssociation::is_connection_arn_Set() const{
    return m_connection_arn_isSet;
}

bool OAIRepositoryAssociation::is_connection_arn_Valid() const{
    return m_connection_arn_isValid;
}

QString OAIRepositoryAssociation::getName() const {
    return m_name;
}
void OAIRepositoryAssociation::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRepositoryAssociation::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRepositoryAssociation::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIRepositoryAssociation::getOwner() const {
    return m_owner;
}
void OAIRepositoryAssociation::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAIRepositoryAssociation::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAIRepositoryAssociation::is_owner_Valid() const{
    return m_owner_isValid;
}

OAIProviderType OAIRepositoryAssociation::getProviderType() const {
    return m_provider_type;
}
void OAIRepositoryAssociation::setProviderType(const OAIProviderType &provider_type) {
    m_provider_type = provider_type;
    m_provider_type_isSet = true;
}

bool OAIRepositoryAssociation::is_provider_type_Set() const{
    return m_provider_type_isSet;
}

bool OAIRepositoryAssociation::is_provider_type_Valid() const{
    return m_provider_type_isValid;
}

OAIRepositoryAssociationState OAIRepositoryAssociation::getState() const {
    return m_state;
}
void OAIRepositoryAssociation::setState(const OAIRepositoryAssociationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIRepositoryAssociation::is_state_Set() const{
    return m_state_isSet;
}

bool OAIRepositoryAssociation::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIRepositoryAssociation::getStateReason() const {
    return m_state_reason;
}
void OAIRepositoryAssociation::setStateReason(const QString &state_reason) {
    m_state_reason = state_reason;
    m_state_reason_isSet = true;
}

bool OAIRepositoryAssociation::is_state_reason_Set() const{
    return m_state_reason_isSet;
}

bool OAIRepositoryAssociation::is_state_reason_Valid() const{
    return m_state_reason_isValid;
}

QDateTime OAIRepositoryAssociation::getLastUpdatedTimeStamp() const {
    return m_last_updated_time_stamp;
}
void OAIRepositoryAssociation::setLastUpdatedTimeStamp(const QDateTime &last_updated_time_stamp) {
    m_last_updated_time_stamp = last_updated_time_stamp;
    m_last_updated_time_stamp_isSet = true;
}

bool OAIRepositoryAssociation::is_last_updated_time_stamp_Set() const{
    return m_last_updated_time_stamp_isSet;
}

bool OAIRepositoryAssociation::is_last_updated_time_stamp_Valid() const{
    return m_last_updated_time_stamp_isValid;
}

QDateTime OAIRepositoryAssociation::getCreatedTimeStamp() const {
    return m_created_time_stamp;
}
void OAIRepositoryAssociation::setCreatedTimeStamp(const QDateTime &created_time_stamp) {
    m_created_time_stamp = created_time_stamp;
    m_created_time_stamp_isSet = true;
}

bool OAIRepositoryAssociation::is_created_time_stamp_Set() const{
    return m_created_time_stamp_isSet;
}

bool OAIRepositoryAssociation::is_created_time_stamp_Valid() const{
    return m_created_time_stamp_isValid;
}

OAIAssociateRepositoryRequest_KMSKeyDetails OAIRepositoryAssociation::getKmsKeyDetails() const {
    return m_kms_key_details;
}
void OAIRepositoryAssociation::setKmsKeyDetails(const OAIAssociateRepositoryRequest_KMSKeyDetails &kms_key_details) {
    m_kms_key_details = kms_key_details;
    m_kms_key_details_isSet = true;
}

bool OAIRepositoryAssociation::is_kms_key_details_Set() const{
    return m_kms_key_details_isSet;
}

bool OAIRepositoryAssociation::is_kms_key_details_Valid() const{
    return m_kms_key_details_isValid;
}

OAIS3RepositoryDetails OAIRepositoryAssociation::getS3RepositoryDetails() const {
    return m_s3_repository_details;
}
void OAIRepositoryAssociation::setS3RepositoryDetails(const OAIS3RepositoryDetails &s3_repository_details) {
    m_s3_repository_details = s3_repository_details;
    m_s3_repository_details_isSet = true;
}

bool OAIRepositoryAssociation::is_s3_repository_details_Set() const{
    return m_s3_repository_details_isSet;
}

bool OAIRepositoryAssociation::is_s3_repository_details_Valid() const{
    return m_s3_repository_details_isValid;
}

bool OAIRepositoryAssociation::isSet() const {
...
bool OAIRepositoryAssociation::isValid() const {
