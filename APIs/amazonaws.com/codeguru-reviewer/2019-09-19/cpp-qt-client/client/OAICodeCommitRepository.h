...
#ifndef OAICodeCommitRepository_H
#define OAICodeCommitRepository_H
...
class OAICodeCommitRepository : public OAIObject {
public:
    OAICodeCommitRepository();
    OAICodeCommitRepository(QString json);
    ~OAICodeCommitRepository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeCommitRepository)

#endif // OAICodeCommitRepository_H
