...
class OAIReaction : public OAIEnum {
public:
    OAIReaction();
    ...
    enum class eOAIReaction {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        THUMBSUP, 
        THUMBSDOWN
    };
    OAIReaction::eOAIReaction getValue() const;
    void setValue(const OAIReaction::eOAIReaction& value);
