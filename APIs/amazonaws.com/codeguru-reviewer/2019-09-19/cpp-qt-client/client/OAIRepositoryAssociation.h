...
#ifndef OAIRepositoryAssociation_H
#define OAIRepositoryAssociation_H
...
class OAIRepositoryAssociation : public OAIObject {
public:
    OAIRepositoryAssociation();
    OAIRepositoryAssociation(QString json);
    ~OAIRepositoryAssociation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepositoryAssociation)

#endif // OAIRepositoryAssociation_H
