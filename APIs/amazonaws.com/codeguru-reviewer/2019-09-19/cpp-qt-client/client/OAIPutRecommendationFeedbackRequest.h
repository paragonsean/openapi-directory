...
/*
 * OAIPutRecommendationFeedbackRequest.h
 *
 * 
 */

#ifndef OAIPutRecommendationFeedbackRequest_H
#define OAIPutRecommendationFeedbackRequest_H
...
class OAIPutRecommendationFeedbackRequest : public OAIObject {
public:
    OAIPutRecommendationFeedbackRequest();
    OAIPutRecommendationFeedbackRequest(QString json);
    ~OAIPutRecommendationFeedbackRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRecommendationFeedbackRequest)

#endif // OAIPutRecommendationFeedbackRequest_H
