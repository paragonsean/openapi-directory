...
/*
 * OAICreateCodeReview_request.h
 *
 * 
 */

#ifndef OAICreateCodeReview_request_H
#define OAICreateCodeReview_request_H
...
namespace OpenAPI {
class OAICreateCodeReview_request_Type;

class OAICreateCodeReview_request : public OAIObject {
public:
    OAICreateCodeReview_request();
    OAICreateCodeReview_request(QString json);
    ~OAICreateCodeReview_request() override;
    ...
    QString getRepositoryAssociationArn() const;
    void setRepositoryAssociationArn(const QString &repository_association_arn);
    bool is_repository_association_arn_Set() const;
    bool is_repository_association_arn_Valid() const;

    OAICreateCodeReview_request_Type getType() const;
    void setType(const OAICreateCodeReview_request_Type &type);
...
private:
    ...
    QString m_repository_association_arn;
    bool m_repository_association_arn_isSet;
    bool m_repository_association_arn_isValid;

    OAICreateCodeReview_request_Type m_type;
    bool m_type_isSet;
    bool m_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCodeReview_request)

#endif // OAICreateCodeReview_request_H
