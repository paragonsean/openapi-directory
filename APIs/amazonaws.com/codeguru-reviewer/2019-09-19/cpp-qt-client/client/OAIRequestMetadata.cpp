...
QString OAIRequestMetadata::getRequestId() const {
    return m_request_id;
}
void OAIRequestMetadata::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIRequestMetadata::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIRequestMetadata::is_request_id_Valid() const{
    return m_request_id_isValid;
}

QString OAIRequestMetadata::getRequester() const {
    return m_requester;
}
void OAIRequestMetadata::setRequester(const QString &requester) {
    m_requester = requester;
    m_requester_isSet = true;
}

bool OAIRequestMetadata::is_requester_Set() const{
    return m_requester_isSet;
}

bool OAIRequestMetadata::is_requester_Valid() const{
    return m_requester_isValid;
}

OAIRequestMetadata_EventInfo OAIRequestMetadata::getEventInfo() const {
    return m_event_info;
}
void OAIRequestMetadata::setEventInfo(const OAIRequestMetadata_EventInfo &event_info) {
    m_event_info = event_info;
    m_event_info_isSet = true;
}

bool OAIRequestMetadata::is_event_info_Set() const{
    return m_event_info_isSet;
}

bool OAIRequestMetadata::is_event_info_Valid() const{
    return m_event_info_isValid;
}

OAIVendorName OAIRequestMetadata::getVendorName() const {
    return m_vendor_name;
}
void OAIRequestMetadata::setVendorName(const OAIVendorName &vendor_name) {
    m_vendor_name = vendor_name;
    m_vendor_name_isSet = true;
}

bool OAIRequestMetadata::is_vendor_name_Set() const{
    return m_vendor_name_isSet;
}

bool OAIRequestMetadata::is_vendor_name_Valid() const{
