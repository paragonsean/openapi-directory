...
/*
 * OAIAssociateRepositoryResponse_RepositoryAssociation.h
 *
 * 
 */

#ifndef OAIAssociateRepositoryResponse_RepositoryAssociation_H
#define OAIAssociateRepositoryResponse_RepositoryAssociation_H
...
class OAIS3RepositoryDetails;

class OAIAssociateRepositoryResponse_RepositoryAssociation : public OAIObject {
public:
    OAIAssociateRepositoryResponse_RepositoryAssociation();
    OAIAssociateRepositoryResponse_RepositoryAssociation(QString json);
    ~OAIAssociateRepositoryResponse_RepositoryAssociation() override;
    ...
    OAIS3RepositoryDetails getS3RepositoryDetails() const;
    void setS3RepositoryDetails(const OAIS3RepositoryDetails &s3_repository_details);
    bool is_s3_repository_details_Set() const;
    bool is_s3_repository_details_Valid() const;
...
private:
    ...
    OAIS3RepositoryDetails m_s3_repository_details;
    bool m_s3_repository_details_isSet;
    bool m_s3_repository_details_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAssociateRepositoryResponse_RepositoryAssociation)

#endif // OAIAssociateRepositoryResponse_RepositoryAssociation_H
