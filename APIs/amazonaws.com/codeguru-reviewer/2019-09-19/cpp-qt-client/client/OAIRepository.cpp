...
OAIAssociateRepository_request_Repository_CodeCommit OAIRepository::getCodeCommit() const {
    return m_code_commit;
}
void OAIRepository::setCodeCommit(const OAIAssociateRepository_request_Repository_CodeCommit &code_commit) {
    m_code_commit = code_commit;
    m_code_commit_isSet = true;
}

bool OAIRepository::is_code_commit_Set() const{
    return m_code_commit_isSet;
}

bool OAIRepository::is_code_commit_Valid() const{
    return m_code_commit_isValid;
}

OAIAssociateRepository_request_Repository_Bitbucket OAIRepository::getBitbucket() const {
    return m_bitbucket;
}
void OAIRepository::setBitbucket(const OAIAssociateRepository_request_Repository_Bitbucket &bitbucket) {
    m_bitbucket = bitbucket;
    m_bitbucket_isSet = true;
}

bool OAIRepository::is_bitbucket_Set() const{
    return m_bitbucket_isSet;
}

bool OAIRepository::is_bitbucket_Valid() const{
    return m_bitbucket_isValid;
}

OAIAssociateRepository_request_Repository_GitHubEnterpriseServer OAIRepository::getGitHubEnterpriseServer() const {
    return m_git_hub_enterprise_server;
}
void OAIRepository::setGitHubEnterpriseServer(const OAIAssociateRepository_request_Repository_GitHubEnterpriseServer &git_hub_enterprise_server) {
    m_git_hub_enterprise_server = git_hub_enterprise_server;
    m_git_hub_enterprise_server_isSet = true;
}

bool OAIRepository::is_git_hub_enterprise_server_Set() const{
    return m_git_hub_enterprise_server_isSet;
}

bool OAIRepository::is_git_hub_enterprise_server_Valid() const{
    return m_git_hub_enterprise_server_isValid;
}

OAIS3Repository OAIRepository::getS3Bucket() const {
    return m_s3_bucket;
}
void OAIRepository::setS3Bucket(const OAIS3Repository &s3_bucket) {
    m_s3_bucket = s3_bucket;
    m_s3_bucket_isSet = true;
}

bool OAIRepository::is_s3_bucket_Set() const{
    return m_s3_bucket_isSet;
}

bool OAIRepository::is_s3_bucket_Valid() const{
