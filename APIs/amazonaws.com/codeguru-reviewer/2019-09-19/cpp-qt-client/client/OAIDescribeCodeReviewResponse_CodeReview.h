...
/*
 * OAIDescribeCodeReviewResponse_CodeReview.h
 *
 * 
 */

#ifndef OAIDescribeCodeReviewResponse_CodeReview_H
#define OAIDescribeCodeReviewResponse_CodeReview_H

#include <QJsonObject>

#include "OAICodeReview_Metrics.h"
#include "OAICodeReview_SourceCodeType.h"
#include "OAIConfigFileState.h"
...
namespace OpenAPI {
class OAICodeReview_SourceCodeType;
class OAICodeReview_Metrics;

class OAIDescribeCodeReviewResponse_CodeReview : public OAIObject {
public:
    OAIDescribeCodeReviewResponse_CodeReview();
    OAIDescribeCodeReviewResponse_CodeReview(QString json);
    ~OAIDescribeCodeReviewResponse_CodeReview() override;
    ...
    OAICodeReview_SourceCodeType getSourceCodeType() const;
    void setSourceCodeType(const OAICodeReview_SourceCodeType &source_code_type);
    ...
    OAICodeReview_Metrics getMetrics() const;
    void setMetrics(const OAICodeReview_Metrics &metrics);
    ...
    OAIConfigFileState getConfigFileState() const;
    void setConfigFileState(const OAIConfigFileState &config_file_state);
    bool is_config_file_state_Set() const;
    bool is_config_file_state_Valid() const;
...
private:
    ...
    OAICodeReview_SourceCodeType m_source_code_type;
    ...
    OAICodeReview_Metrics m_metrics;
    ...
    OAIConfigFileState m_config_file_state;
    bool m_config_file_state_isSet;
    bool m_config_file_state_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCodeReviewResponse_CodeReview)

#endif // OAIDescribeCodeReviewResponse_CodeReview_H
