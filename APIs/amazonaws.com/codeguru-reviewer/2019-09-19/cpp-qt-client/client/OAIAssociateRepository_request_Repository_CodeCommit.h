...
/*
 * OAIAssociateRepository_request_Repository_CodeCommit.h
 *
 * 
 */

#ifndef OAIAssociateRepository_request_Repository_CodeCommit_H
#define OAIAssociateRepository_request_Repository_CodeCommit_H
...
class OAIAssociateRepository_request_Repository_CodeCommit : public OAIObject {
public:
    OAIAssociateRepository_request_Repository_CodeCommit();
    OAIAssociateRepository_request_Repository_CodeCommit(QString json);
    ~OAIAssociateRepository_request_Repository_CodeCommit() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateRepository_request_Repository_CodeCommit)

#endif // OAIAssociateRepository_request_Repository_CodeCommit_H
