...
/*
 * OAICreateCodeReviewRequest.h
 *
 * 
 */

#ifndef OAICreateCodeReviewRequest_H
#define OAICreateCodeReviewRequest_H
...
namespace OpenAPI {
class OAICreateCodeReviewRequest_Type;

class OAICreateCodeReviewRequest : public OAIObject {
public:
    OAICreateCodeReviewRequest();
    OAICreateCodeReviewRequest(QString json);
    ~OAICreateCodeReviewRequest() override;
    ...
    OAICreateCodeReviewRequest_Type getType() const;
    void setType(const OAICreateCodeReviewRequest_Type &type);
...
private:
    ...
    OAICreateCodeReviewRequest_Type m_type;
    bool m_type_isSet;
    bool m_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCodeReviewRequest)

#endif // OAICreateCodeReviewRequest_H
