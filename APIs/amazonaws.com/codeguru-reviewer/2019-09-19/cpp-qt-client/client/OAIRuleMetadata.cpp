...
OAIRuleMetadata::OAIRuleMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleMetadata::OAIRuleMetadata() {
    this->initializeModel();
}

OAIRuleMetadata::~OAIRuleMetadata() {}

void OAIRuleMetadata::initializeModel() {
...
void OAIRuleMetadata::fromJson(QString jsonString) {
...
void OAIRuleMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIRuleMetadata::asJson() const {
...
QJsonObject OAIRuleMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_rule_id_isSet) {
...
QString OAIRuleMetadata::getRuleId() const {
    return m_rule_id;
}
void OAIRuleMetadata::setRuleId(const QString &rule_id) {
    m_rule_id = rule_id;
    m_rule_id_isSet = true;
}

bool OAIRuleMetadata::is_rule_id_Set() const{
    return m_rule_id_isSet;
}

bool OAIRuleMetadata::is_rule_id_Valid() const{
    return m_rule_id_isValid;
}

QString OAIRuleMetadata::getRuleName() const {
    return m_rule_name;
}
void OAIRuleMetadata::setRuleName(const QString &rule_name) {
    m_rule_name = rule_name;
    m_rule_name_isSet = true;
}

bool OAIRuleMetadata::is_rule_name_Set() const{
    return m_rule_name_isSet;
}

bool OAIRuleMetadata::is_rule_name_Valid() const{
    return m_rule_name_isValid;
}

QString OAIRuleMetadata::getShortDescription() const {
    return m_short_description;
}
void OAIRuleMetadata::setShortDescription(const QString &short_description) {
    m_short_description = short_description;
    m_short_description_isSet = true;
}

bool OAIRuleMetadata::is_short_description_Set() const{
    return m_short_description_isSet;
}

bool OAIRuleMetadata::is_short_description_Valid() const{
    return m_short_description_isValid;
}

QString OAIRuleMetadata::getLongDescription() const {
    return m_long_description;
}
void OAIRuleMetadata::setLongDescription(const QString &long_description) {
    m_long_description = long_description;
    m_long_description_isSet = true;
}

bool OAIRuleMetadata::is_long_description_Set() const{
    return m_long_description_isSet;
}

bool OAIRuleMetadata::is_long_description_Valid() const{
    return m_long_description_isValid;
}

QList OAIRuleMetadata::getRuleTags() const {
    return m_rule_tags;
}
void OAIRuleMetadata::setRuleTags(const QList &rule_tags) {
    m_rule_tags = rule_tags;
    m_rule_tags_isSet = true;
}

bool OAIRuleMetadata::is_rule_tags_Set() const{
    return m_rule_tags_isSet;
}

bool OAIRuleMetadata::is_rule_tags_Valid() const{
    return m_rule_tags_isValid;
}

bool OAIRuleMetadata::isSet() const {
...
bool OAIRuleMetadata::isValid() const {
