...
/*
 * OAIRepositoryAnalysis_RepositoryHead.h
 *
 * 
 */

#ifndef OAIRepositoryAnalysis_RepositoryHead_H
#define OAIRepositoryAnalysis_RepositoryHead_H
...
class OAIRepositoryAnalysis_RepositoryHead : public OAIObject {
public:
    OAIRepositoryAnalysis_RepositoryHead();
    OAIRepositoryAnalysis_RepositoryHead(QString json);
    ~OAIRepositoryAnalysis_RepositoryHead() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepositoryAnalysis_RepositoryHead)

#endif // OAIRepositoryAnalysis_RepositoryHead_H
