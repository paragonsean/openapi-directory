...
/*
 * OAIRepositoryAssociationState.h
 *
 * 
 */

#ifndef OAIRepositoryAssociationState_H
#define OAIRepositoryAssociationState_H
...
class OAIRepositoryAssociationState : public OAIEnum {
public:
    OAIRepositoryAssociationState();
    OAIRepositoryAssociationState(QString json);
    ~OAIRepositoryAssociationState() override;
    ...
    enum class eOAIRepositoryAssociationState {
    ...
    OAIRepositoryAssociationState::eOAIRepositoryAssociationState getValue() const;
    void setValue(const OAIRepositoryAssociationState::eOAIRepositoryAssociationState& value);
...
private:
    ...
    eOAIRepositoryAssociationState m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepositoryAssociationState)

#endif // OAIRepositoryAssociationState_H
