...
/*
 * OAIThirdPartySourceRepository.h
 *
 * Information about a third-party source repository connected to CodeGuru Reviewer.
 */

#ifndef OAIThirdPartySourceRepository_H
#define OAIThirdPartySourceRepository_H
...
class OAIThirdPartySourceRepository : public OAIObject {
public:
    OAIThirdPartySourceRepository();
    OAIThirdPartySourceRepository(QString json);
    ~OAIThirdPartySourceRepository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThirdPartySourceRepository)

#endif // OAIThirdPartySourceRepository_H
