...
#ifndef OAIEventInfo_H
#define OAIEventInfo_H
...
class OAIEventInfo : public OAIObject {
public:
    OAIEventInfo();
    OAIEventInfo(QString json);
    ~OAIEventInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventInfo)

#endif // OAIEventInfo_H
