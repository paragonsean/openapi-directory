...
#ifndef OAICodeReviewType_H
#define OAICodeReviewType_H
...
class OAICodeReviewType : public OAIObject {
public:
    OAICodeReviewType();
    OAICodeReviewType(QString json);
    ~OAICodeReviewType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeReviewType)

#endif // OAICodeReviewType_H
