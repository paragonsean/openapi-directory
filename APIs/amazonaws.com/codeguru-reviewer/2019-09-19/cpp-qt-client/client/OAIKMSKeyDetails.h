...
#ifndef OAIKMSKeyDetails_H
#define OAIKMSKeyDetails_H
...
class OAIKMSKeyDetails : public OAIObject {
public:
    OAIKMSKeyDetails();
    OAIKMSKeyDetails(QString json);
    ~OAIKMSKeyDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKMSKeyDetails)

#endif // OAIKMSKeyDetails_H
