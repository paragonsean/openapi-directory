...
/*
 * OAIConfigFileState.h
 *
 * 
 */

#ifndef OAIConfigFileState_H
#define OAIConfigFileState_H
...
class OAIConfigFileState : public OAIEnum {
public:
    OAIConfigFileState();
    OAIConfigFileState(QString json);
    ~OAIConfigFileState() override;
    ...
    enum class eOAIConfigFileState {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PRESENT, 
        ABSENT, 
        PRESENTWITHERRORS
    };
    OAIConfigFileState::eOAIConfigFileState getValue() const;
    void setValue(const OAIConfigFileState::eOAIConfigFileState& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigFileState)

#endif // OAIConfigFileState_H
