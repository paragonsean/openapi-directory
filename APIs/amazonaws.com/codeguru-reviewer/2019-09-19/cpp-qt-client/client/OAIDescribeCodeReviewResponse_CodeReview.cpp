...
#include "OAIDescribeCodeReviewResponse_CodeReview.h"
...
OAIDescribeCodeReviewResponse_CodeReview::OAIDescribeCodeReviewResponse_CodeReview(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCodeReviewResponse_CodeReview::OAIDescribeCodeReviewResponse_CodeReview() {
    this->initializeModel();
}

OAIDescribeCodeReviewResponse_CodeReview::~OAIDescribeCodeReviewResponse_CodeReview() {}

void OAIDescribeCodeReviewResponse_CodeReview::initializeModel() {
...
void OAIDescribeCodeReviewResponse_CodeReview::fromJson(QString jsonString) {
...
void OAIDescribeCodeReviewResponse_CodeReview::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeCodeReviewResponse_CodeReview::asJson() const {
...
QJsonObject OAIDescribeCodeReviewResponse_CodeReview::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDescribeCodeReviewResponse_CodeReview::getName() const {
    return m_name;
}
void OAIDescribeCodeReviewResponse_CodeReview::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDescribeCodeReviewResponse_CodeReview::getCodeReviewArn() const {
    return m_code_review_arn;
}
void OAIDescribeCodeReviewResponse_CodeReview::setCodeReviewArn(const QString &code_review_arn) {
    m_code_review_arn = code_review_arn;
    m_code_review_arn_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_code_review_arn_Set() const{
    return m_code_review_arn_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_code_review_arn_Valid() const{
    return m_code_review_arn_isValid;
}

QString OAIDescribeCodeReviewResponse_CodeReview::getRepositoryName() const {
    return m_repository_name;
}
void OAIDescribeCodeReviewResponse_CodeReview::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIDescribeCodeReviewResponse_CodeReview::getOwner() const {
    return m_owner;
}
void OAIDescribeCodeReviewResponse_CodeReview::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_owner_Valid() const{
    return m_owner_isValid;
}

OAIProviderType OAIDescribeCodeReviewResponse_CodeReview::getProviderType() const {
    return m_provider_type;
}
void OAIDescribeCodeReviewResponse_CodeReview::setProviderType(const OAIProviderType &provider_type) {
    m_provider_type = provider_type;
    m_provider_type_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_provider_type_Set() const{
    return m_provider_type_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_provider_type_Valid() const{
    return m_provider_type_isValid;
}

OAIJobState OAIDescribeCodeReviewResponse_CodeReview::getState() const {
    return m_state;
}
void OAIDescribeCodeReviewResponse_CodeReview::setState(const OAIJobState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_state_Set() const{
    return m_state_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIDescribeCodeReviewResponse_CodeReview::getStateReason() const {
    return m_state_reason;
}
void OAIDescribeCodeReviewResponse_CodeReview::setStateReason(const QString &state_reason) {
    m_state_reason = state_reason;
    m_state_reason_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_state_reason_Set() const{
    return m_state_reason_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_state_reason_Valid() const{
    return m_state_reason_isValid;
}

QDateTime OAIDescribeCodeReviewResponse_CodeReview::getCreatedTimeStamp() const {
    return m_created_time_stamp;
}
void OAIDescribeCodeReviewResponse_CodeReview::setCreatedTimeStamp(const QDateTime &created_time_stamp) {
    m_created_time_stamp = created_time_stamp;
    m_created_time_stamp_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_created_time_stamp_Set() const{
    return m_created_time_stamp_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_created_time_stamp_Valid() const{
    return m_created_time_stamp_isValid;
}

QDateTime OAIDescribeCodeReviewResponse_CodeReview::getLastUpdatedTimeStamp() const {
    return m_last_updated_time_stamp;
}
void OAIDescribeCodeReviewResponse_CodeReview::setLastUpdatedTimeStamp(const QDateTime &last_updated_time_stamp) {
    m_last_updated_time_stamp = last_updated_time_stamp;
    m_last_updated_time_stamp_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_last_updated_time_stamp_Set() const{
    return m_last_updated_time_stamp_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_last_updated_time_stamp_Valid() const{
    return m_last_updated_time_stamp_isValid;
}

OAIType OAIDescribeCodeReviewResponse_CodeReview::getType() const {
    return m_type;
}
void OAIDescribeCodeReviewResponse_CodeReview::setType(const OAIType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIDescribeCodeReviewResponse_CodeReview::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIDescribeCodeReviewResponse_CodeReview::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

OAICodeReview_SourceCodeType OAIDescribeCodeReviewResponse_CodeReview::getSourceCodeType() const {
    return m_source_code_type;
}
void OAIDescribeCodeReviewResponse_CodeReview::setSourceCodeType(const OAICodeReview_SourceCodeType &source_code_type) {
    m_source_code_type = source_code_type;
    m_source_code_type_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_source_code_type_Set() const{
    return m_source_code_type_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_source_code_type_Valid() const{
    return m_source_code_type_isValid;
}

QString OAIDescribeCodeReviewResponse_CodeReview::getAssociationArn() const {
    return m_association_arn;
}
void OAIDescribeCodeReviewResponse_CodeReview::setAssociationArn(const QString &association_arn) {
    m_association_arn = association_arn;
    m_association_arn_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_association_arn_Set() const{
    return m_association_arn_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_association_arn_Valid() const{
    return m_association_arn_isValid;
}

OAICodeReview_Metrics OAIDescribeCodeReviewResponse_CodeReview::getMetrics() const {
    return m_metrics;
}
void OAIDescribeCodeReviewResponse_CodeReview::setMetrics(const OAICodeReview_Metrics &metrics) {
    m_metrics = metrics;
    m_metrics_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_metrics_Set() const{
    return m_metrics_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_metrics_Valid() const{
    return m_metrics_isValid;
}

QList OAIDescribeCodeReviewResponse_CodeReview::getAnalysisTypes() const {
    return m_analysis_types;
}
void OAIDescribeCodeReviewResponse_CodeReview::setAnalysisTypes(const QList &analysis_types) {
    m_analysis_types = analysis_types;
    m_analysis_types_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_analysis_types_Set() const{
    return m_analysis_types_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_analysis_types_Valid() const{
    return m_analysis_types_isValid;
}

OAIConfigFileState OAIDescribeCodeReviewResponse_CodeReview::getConfigFileState() const {
    return m_config_file_state;
}
void OAIDescribeCodeReviewResponse_CodeReview::setConfigFileState(const OAIConfigFileState &config_file_state) {
    m_config_file_state = config_file_state;
    m_config_file_state_isSet = true;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_config_file_state_Set() const{
    return m_config_file_state_isSet;
}

bool OAIDescribeCodeReviewResponse_CodeReview::is_config_file_state_Valid() const{
    return m_config_file_state_isValid;
}

bool OAIDescribeCodeReviewResponse_CodeReview::isSet() const {
...
bool OAIDescribeCodeReviewResponse_CodeReview::isValid() const {
