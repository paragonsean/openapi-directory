...
/*
 * OAIS3BucketRepository_Details.h
 *
 * 
 */

#ifndef OAIS3BucketRepository_Details_H
#define OAIS3BucketRepository_Details_H
...
class OAIS3BucketRepository_Details : public OAIObject {
public:
    OAIS3BucketRepository_Details();
    OAIS3BucketRepository_Details(QString json);
    ~OAIS3BucketRepository_Details() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3BucketRepository_Details)

#endif // OAIS3BucketRepository_Details_H
