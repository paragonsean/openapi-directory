...
OAICodeReviewType::OAICodeReviewType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICodeReviewType::OAICodeReviewType() {
    this->initializeModel();
}

OAICodeReviewType::~OAICodeReviewType() {}

void OAICodeReviewType::initializeModel() {
...
void OAICodeReviewType::fromJson(QString jsonString) {
...
void OAICodeReviewType::fromJsonObject(QJsonObject json) {
...
QString OAICodeReviewType::asJson() const {
...
QJsonObject OAICodeReviewType::asJsonObject() const {
    QJsonObject obj;
...
OAICreateCodeReview_request_Type_RepositoryAnalysis OAICodeReviewType::getRepositoryAnalysis() const {
    return m_repository_analysis;
}
void OAICodeReviewType::setRepositoryAnalysis(const OAICreateCodeReview_request_Type_RepositoryAnalysis &repository_analysis) {
    m_repository_analysis = repository_analysis;
    m_repository_analysis_isSet = true;
}

bool OAICodeReviewType::is_repository_analysis_Set() const{
    return m_repository_analysis_isSet;
}

bool OAICodeReviewType::is_repository_analysis_Valid() const{
    return m_repository_analysis_isValid;
}

QList OAICodeReviewType::getAnalysisTypes() const {
    return m_analysis_types;
}
void OAICodeReviewType::setAnalysisTypes(const QList &analysis_types) {
    m_analysis_types = analysis_types;
    m_analysis_types_isSet = true;
}

bool OAICodeReviewType::is_analysis_types_Set() const{
    return m_analysis_types_isSet;
}

bool OAICodeReviewType::is_analysis_types_Valid() const{
    return m_analysis_types_isValid;
}

bool OAICodeReviewType::isSet() const {
...
bool OAICodeReviewType::isValid() const {
