...
/*
 * OAIS3RepositoryDetails_CodeArtifacts.h
 *
 * 
 */

#ifndef OAIS3RepositoryDetails_CodeArtifacts_H
#define OAIS3RepositoryDetails_CodeArtifacts_H
...
class OAIS3RepositoryDetails_CodeArtifacts : public OAIObject {
public:
    OAIS3RepositoryDetails_CodeArtifacts();
    OAIS3RepositoryDetails_CodeArtifacts(QString json);
    ~OAIS3RepositoryDetails_CodeArtifacts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3RepositoryDetails_CodeArtifacts)

#endif // OAIS3RepositoryDetails_CodeArtifacts_H
