...
/*
 * OAICreateCodeReviewResponse.h
 *
 * 
 */

#ifndef OAICreateCodeReviewResponse_H
#define OAICreateCodeReviewResponse_H
...
class OAICreateCodeReviewResponse : public OAIObject {
public:
    OAICreateCodeReviewResponse();
    OAICreateCodeReviewResponse(QString json);
    ~OAICreateCodeReviewResponse() override;
    ...
    OAICodeReview getCodeReview() const;
    void setCodeReview(const OAICodeReview &code_review);
    bool is_code_review_Set() const;
    bool is_code_review_Valid() const;
...
private:
    ...
    OAICodeReview m_code_review;
    bool m_code_review_isSet;
    bool m_code_review_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateCodeReviewResponse)

#endif // OAICreateCodeReviewResponse_H
