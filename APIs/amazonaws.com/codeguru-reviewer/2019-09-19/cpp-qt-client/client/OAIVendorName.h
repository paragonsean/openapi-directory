...
#ifndef OAIVendorName_H
#define OAIVendorName_H
...
class OAIVendorName : public OAIEnum {
public:
    OAIVendorName();
    OAIVendorName(QString json);
    ~OAIVendorName() override;
    ...
    enum class eOAIVendorName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        GITHUB, 
        GITLAB, 
        NATIVES3
    };
    OAIVendorName::eOAIVendorName getValue() const;
    void setValue(const OAIVendorName::eOAIVendorName& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIVendorName)

#endif // OAIVendorName_H
