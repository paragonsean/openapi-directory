...
/*
 * OAIAssociateRepositoryRequest_Repository.h
 *
 * 
 */

#ifndef OAIAssociateRepositoryRequest_Repository_H
#define OAIAssociateRepositoryRequest_Repository_H
...
class OAIAssociateRepositoryRequest_Repository : public OAIObject {
public:
    OAIAssociateRepositoryRequest_Repository();
    OAIAssociateRepositoryRequest_Repository(QString json);
    ~OAIAssociateRepositoryRequest_Repository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateRepositoryRequest_Repository)

#endif // OAIAssociateRepositoryRequest_Repository_H
