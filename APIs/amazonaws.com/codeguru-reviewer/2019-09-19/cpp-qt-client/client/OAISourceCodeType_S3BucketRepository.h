...
/*
 * OAISourceCodeType_S3BucketRepository.h
 *
 * 
 */

#ifndef OAISourceCodeType_S3BucketRepository_H
#define OAISourceCodeType_S3BucketRepository_H
...
class OAISourceCodeType_S3BucketRepository : public OAIObject {
public:
    OAISourceCodeType_S3BucketRepository();
    OAISourceCodeType_S3BucketRepository(QString json);
    ~OAISourceCodeType_S3BucketRepository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceCodeType_S3BucketRepository)

#endif // OAISourceCodeType_S3BucketRepository_H
