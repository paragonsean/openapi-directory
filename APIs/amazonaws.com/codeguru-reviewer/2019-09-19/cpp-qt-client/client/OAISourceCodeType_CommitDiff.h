...
/*
 * OAISourceCodeType_CommitDiff.h
 *
 * 
 */

#ifndef OAISourceCodeType_CommitDiff_H
#define OAISourceCodeType_CommitDiff_H
...
class OAISourceCodeType_CommitDiff : public OAIObject {
public:
    OAISourceCodeType_CommitDiff();
    OAISourceCodeType_CommitDiff(QString json);
    ~OAISourceCodeType_CommitDiff() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceCodeType_CommitDiff)

#endif // OAISourceCodeType_CommitDiff_H
