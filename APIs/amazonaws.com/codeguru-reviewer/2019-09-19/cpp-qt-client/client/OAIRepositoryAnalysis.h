...
#ifndef OAIRepositoryAnalysis_H
#define OAIRepositoryAnalysis_H
...
namespace OpenAPI {
class OAIRepositoryAnalysis_RepositoryHead;
class OAISourceCodeType;

class OAIRepositoryAnalysis : public OAIObject {
public:
    OAIRepositoryAnalysis();
    OAIRepositoryAnalysis(QString json);
    ~OAIRepositoryAnalysis() override;
    ...
    OAIRepositoryAnalysis_RepositoryHead getRepositoryHead() const;
    void setRepositoryHead(const OAIRepositoryAnalysis_RepositoryHead &repository_head);
...
private:
    ...
    OAIRepositoryAnalysis_RepositoryHead m_repository_head;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepositoryAnalysis)

#endif // OAIRepositoryAnalysis_H
