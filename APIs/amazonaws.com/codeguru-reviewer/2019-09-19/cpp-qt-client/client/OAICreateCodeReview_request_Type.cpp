...
#include "OAICreateCodeReview_request_Type.h"
...
OAICreateCodeReview_request_Type::OAICreateCodeReview_request_Type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCodeReview_request_Type::OAICreateCodeReview_request_Type() {
    this->initializeModel();
}

OAICreateCodeReview_request_Type::~OAICreateCodeReview_request_Type() {}

void OAICreateCodeReview_request_Type::initializeModel() {
...
void OAICreateCodeReview_request_Type::fromJson(QString jsonString) {
...
void OAICreateCodeReview_request_Type::fromJsonObject(QJsonObject json) {
...
QString OAICreateCodeReview_request_Type::asJson() const {
...
QJsonObject OAICreateCodeReview_request_Type::asJsonObject() const {
    QJsonObject obj;
...
OAICreateCodeReview_request_Type_RepositoryAnalysis OAICreateCodeReview_request_Type::getRepositoryAnalysis() const {
    return m_repository_analysis;
}
void OAICreateCodeReview_request_Type::setRepositoryAnalysis(const OAICreateCodeReview_request_Type_RepositoryAnalysis &repository_analysis) {
    m_repository_analysis = repository_analysis;
    m_repository_analysis_isSet = true;
}

bool OAICreateCodeReview_request_Type::is_repository_analysis_Set() const{
    return m_repository_analysis_isSet;
}

bool OAICreateCodeReview_request_Type::is_repository_analysis_Valid() const{
    return m_repository_analysis_isValid;
}

QList OAICreateCodeReview_request_Type::getAnalysisTypes() const {
    return m_analysis_types;
}
void OAICreateCodeReview_request_Type::setAnalysisTypes(const QList &analysis_types) {
    m_analysis_types = analysis_types;
    m_analysis_types_isSet = true;
}

bool OAICreateCodeReview_request_Type::is_analysis_types_Set() const{
    return m_analysis_types_isSet;
}

bool OAICreateCodeReview_request_Type::is_analysis_types_Valid() const{
    return m_analysis_types_isValid;
}

bool OAICreateCodeReview_request_Type::isSet() const {
...
bool OAICreateCodeReview_request_Type::isValid() const {
