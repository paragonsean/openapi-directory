...
class SourceCodeType(Model):
    ...
    def __init__(self, commit_diff: SourceCodeTypeCommitDiff=None, repository_head: RepositoryHeadSourceCodeType=None, branch_diff: SourceCodeTypeBranchDiff=None, s3_bucket_repository: SourceCodeTypeS3BucketRepository=None, request_metadata: SourceCodeTypeRequestMetadata=None):
        """SourceCodeType - a model defined in OpenAPI

        :param commit_diff: The commit_diff of this SourceCodeType.
        :param repository_head: The repository_head of this SourceCodeType.
        :param branch_diff: The branch_diff of this SourceCodeType.
        :param s3_bucket_repository: The s3_bucket_repository of this SourceCodeType.
        :param request_metadata: The request_metadata of this SourceCodeType.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SourceCodeType':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SourceCodeType of this SourceCodeType.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def commit_diff(self):
        """Gets the commit_diff of this SourceCodeType.


        :return: The commit_diff of this SourceCodeType.
    ...
    def commit_diff(self, commit_diff):
        """Sets the commit_diff of this SourceCodeType.
    ...
    def repository_head(self):
        """Gets the repository_head of this SourceCodeType.


        :return: The repository_head of this SourceCodeType.
    ...
    def repository_head(self, repository_head):
        """Sets the repository_head of this SourceCodeType.
    ...
    def branch_diff(self):
        """Gets the branch_diff of this SourceCodeType.


        :return: The branch_diff of this SourceCodeType.
    ...
    def branch_diff(self, branch_diff):
        """Sets the branch_diff of this SourceCodeType.
    ...
    def s3_bucket_repository(self):
        """Gets the s3_bucket_repository of this SourceCodeType.


        :return: The s3_bucket_repository of this SourceCodeType.
    ...
    def s3_bucket_repository(self, s3_bucket_repository):
        """Sets the s3_bucket_repository of this SourceCodeType.
    ...
    def request_metadata(self):
        """Gets the request_metadata of this SourceCodeType.


        :return: The request_metadata of this SourceCodeType.
    ...
    def request_metadata(self, request_metadata):
        """Sets the request_metadata of this SourceCodeType.
