...
class CodeReviewMetrics(Model):
    ...
    def __init__(self, metered_lines_of_code_count: int=None, suppressed_lines_of_code_count: int=None, findings_count: int=None):
        """CodeReviewMetrics - a model defined in OpenAPI

        :param metered_lines_of_code_count: The metered_lines_of_code_count of this CodeReviewMetrics.
        :param suppressed_lines_of_code_count: The suppressed_lines_of_code_count of this CodeReviewMetrics.
        :param findings_count: The findings_count of this CodeReviewMetrics.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CodeReviewMetrics':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CodeReview_Metrics of this CodeReviewMetrics.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def metered_lines_of_code_count(self):
        """Gets the metered_lines_of_code_count of this CodeReviewMetrics.


        :return: The metered_lines_of_code_count of this CodeReviewMetrics.
        :rtype: int
        """
    ...
    def metered_lines_of_code_count(self, metered_lines_of_code_count):
        """Sets the metered_lines_of_code_count of this CodeReviewMetrics.
    ...
    def suppressed_lines_of_code_count(self):
        """Gets the suppressed_lines_of_code_count of this CodeReviewMetrics.


        :return: The suppressed_lines_of_code_count of this CodeReviewMetrics.
        :rtype: int
        """
    ...
    def suppressed_lines_of_code_count(self, suppressed_lines_of_code_count):
        """Sets the suppressed_lines_of_code_count of this CodeReviewMetrics.
    ...
    def findings_count(self):
        """Gets the findings_count of this CodeReviewMetrics.


        :return: The findings_count of this CodeReviewMetrics.
        :rtype: int
        """
    ...
    def findings_count(self, findings_count):
        """Sets the findings_count of this CodeReviewMetrics.
