...
/**
 * Model tests for CodeReviewMetrics
 */
public class CodeReviewMetricsTest {
    private final CodeReviewMetrics model = new CodeReviewMetrics();
