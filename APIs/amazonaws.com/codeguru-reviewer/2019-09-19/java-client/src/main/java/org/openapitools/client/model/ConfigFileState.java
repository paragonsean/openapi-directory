...
/**
 * Gets or Sets ConfigFileState
 */
@JsonAdapter(ConfigFileState.Adapter.class)
public enum ConfigFileState {
  ...
  public static ConfigFileState fromValue(String value) {
    for (ConfigFileState b : ConfigFileState.values()) {
  ...
  public static class Adapter extends TypeAdapter<ConfigFileState> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConfigFileState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConfigFileState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConfigFileState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ConfigFileState.fromValue(value);
  }
}
