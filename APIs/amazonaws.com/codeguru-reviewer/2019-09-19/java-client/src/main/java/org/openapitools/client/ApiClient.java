...
public class ApiClient {
    ...
    private String basePath = "http://codeguru-reviewer.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2019-09-19/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://codeguru-reviewer.us-east-1.amazonaws.com
