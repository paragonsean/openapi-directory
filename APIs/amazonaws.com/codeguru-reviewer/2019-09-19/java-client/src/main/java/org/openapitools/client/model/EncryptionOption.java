...
/**
 * Gets or Sets EncryptionOption
 */
@JsonAdapter(EncryptionOption.Adapter.class)
public enum EncryptionOption {
  ...
  public static EncryptionOption fromValue(String value) {
    for (EncryptionOption b : EncryptionOption.values()) {
  ...
  public static class Adapter extends TypeAdapter<EncryptionOption> {
    @Override
    public void write(final JsonWriter jsonWriter, final EncryptionOption enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EncryptionOption read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EncryptionOption.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EncryptionOption.fromValue(value);
  }
}
