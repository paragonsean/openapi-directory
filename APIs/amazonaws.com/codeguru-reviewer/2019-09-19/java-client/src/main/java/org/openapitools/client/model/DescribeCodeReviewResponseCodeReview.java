...
public class DescribeCodeReviewResponseCodeReview {
  ...
  public DescribeCodeReviewResponseCodeReview() {
  }

  public DescribeCodeReviewResponseCodeReview name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DescribeCodeReviewResponseCodeReview codeReviewArn(String codeReviewArn) {
  ...
  public DescribeCodeReviewResponseCodeReview repositoryName(String repositoryName) {
  ...
  public DescribeCodeReviewResponseCodeReview owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public DescribeCodeReviewResponseCodeReview providerType(ProviderType providerType) {
  ...
  public DescribeCodeReviewResponseCodeReview state(JobState state) {
    this.state = state;
    return this;
  }
  ...
  public DescribeCodeReviewResponseCodeReview stateReason(String stateReason) {
  ...
  public DescribeCodeReviewResponseCodeReview createdTimeStamp(OffsetDateTime createdTimeStamp) {
  ...
  public DescribeCodeReviewResponseCodeReview lastUpdatedTimeStamp(OffsetDateTime lastUpdatedTimeStamp) {
  ...
  public DescribeCodeReviewResponseCodeReview type(Type type) {
    this.type = type;
    return this;
  }
  ...
  public DescribeCodeReviewResponseCodeReview pullRequestId(String pullRequestId) {
  ...
  public DescribeCodeReviewResponseCodeReview sourceCodeType(CodeReviewSourceCodeType sourceCodeType) {
  ...
  public DescribeCodeReviewResponseCodeReview associationArn(String associationArn) {
  ...
  public DescribeCodeReviewResponseCodeReview metrics(CodeReviewMetrics metrics) {
  ...
  public DescribeCodeReviewResponseCodeReview analysisTypes(List analysisTypes) {
  ...
  public DescribeCodeReviewResponseCodeReview configFileState(ConfigFileState configFileState) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeCodeReviewResponseCodeReview describeCodeReviewResponseCodeReview = (DescribeCodeReviewResponseCodeReview) o;
    return Objects.equals(this.name, describeCodeReviewResponseCodeReview.name) &&
        Objects.equals(this.codeReviewArn, describeCodeReviewResponseCodeReview.codeReviewArn) &&
        Objects.equals(this.repositoryName, describeCodeReviewResponseCodeReview.repositoryName) &&
        Objects.equals(this.owner, describeCodeReviewResponseCodeReview.owner) &&
        Objects.equals(this.providerType, describeCodeReviewResponseCodeReview.providerType) &&
        Objects.equals(this.state, describeCodeReviewResponseCodeReview.state) &&
        Objects.equals(this.stateReason, describeCodeReviewResponseCodeReview.stateReason) &&
        Objects.equals(this.createdTimeStamp, describeCodeReviewResponseCodeReview.createdTimeStamp) &&
        Objects.equals(this.lastUpdatedTimeStamp, describeCodeReviewResponseCodeReview.lastUpdatedTimeStamp) &&
        Objects.equals(this.type, describeCodeReviewResponseCodeReview.type) &&
        Objects.equals(this.pullRequestId, describeCodeReviewResponseCodeReview.pullRequestId) &&
        Objects.equals(this.sourceCodeType, describeCodeReviewResponseCodeReview.sourceCodeType) &&
        Objects.equals(this.associationArn, describeCodeReviewResponseCodeReview.associationArn) &&
        Objects.equals(this.metrics, describeCodeReviewResponseCodeReview.metrics) &&
        Objects.equals(this.analysisTypes, describeCodeReviewResponseCodeReview.analysisTypes) &&
        Objects.equals(this.configFileState, describeCodeReviewResponseCodeReview.configFileState);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeCodeReviewResponseCodeReview {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCodeReviewResponseCodeReview
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCodeReviewResponseCodeReview.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCodeReviewResponseCodeReview is not found in the empty JSON string", DescribeCodeReviewResponseCodeReview.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCodeReviewResponseCodeReview.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCodeReviewResponseCodeReview` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCodeReviewResponseCodeReview.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCodeReviewResponseCodeReview' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCodeReviewResponseCodeReview> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCodeReviewResponseCodeReview.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCodeReviewResponseCodeReview>() {
           @Override
           public void write(JsonWriter out, DescribeCodeReviewResponseCodeReview value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCodeReviewResponseCodeReview read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCodeReviewResponseCodeReview given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCodeReviewResponseCodeReview
   * @throws IOException if the JSON string is invalid with respect to DescribeCodeReviewResponseCodeReview
   */
  public static DescribeCodeReviewResponseCodeReview fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCodeReviewResponseCodeReview.class);
  }

  /**
   * Convert an instance of DescribeCodeReviewResponseCodeReview to an JSON string
   *
   * @return JSON string
   */
