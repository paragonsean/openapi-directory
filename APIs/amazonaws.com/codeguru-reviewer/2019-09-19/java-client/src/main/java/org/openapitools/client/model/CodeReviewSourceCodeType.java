...
public class CodeReviewSourceCodeType {
  ...
  public CodeReviewSourceCodeType() {
  }

  public CodeReviewSourceCodeType commitDiff(SourceCodeTypeCommitDiff commitDiff) {
  ...
  public CodeReviewSourceCodeType repositoryHead(RepositoryHeadSourceCodeType repositoryHead) {
  ...
  public CodeReviewSourceCodeType branchDiff(SourceCodeTypeBranchDiff branchDiff) {
  ...
  public CodeReviewSourceCodeType s3BucketRepository(SourceCodeTypeS3BucketRepository s3BucketRepository) {
  ...
  public CodeReviewSourceCodeType requestMetadata(SourceCodeTypeRequestMetadata requestMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    CodeReviewSourceCodeType codeReviewSourceCodeType = (CodeReviewSourceCodeType) o;
    return Objects.equals(this.commitDiff, codeReviewSourceCodeType.commitDiff) &&
        Objects.equals(this.repositoryHead, codeReviewSourceCodeType.repositoryHead) &&
        Objects.equals(this.branchDiff, codeReviewSourceCodeType.branchDiff) &&
        Objects.equals(this.s3BucketRepository, codeReviewSourceCodeType.s3BucketRepository) &&
        Objects.equals(this.requestMetadata, codeReviewSourceCodeType.requestMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class CodeReviewSourceCodeType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CodeReviewSourceCodeType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CodeReviewSourceCodeType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodeReviewSourceCodeType is not found in the empty JSON string", CodeReviewSourceCodeType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CodeReviewSourceCodeType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodeReviewSourceCodeType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodeReviewSourceCodeType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodeReviewSourceCodeType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CodeReviewSourceCodeType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CodeReviewSourceCodeType.class));

       return (TypeAdapter<T>) new TypeAdapter<CodeReviewSourceCodeType>() {
           @Override
           public void write(JsonWriter out, CodeReviewSourceCodeType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CodeReviewSourceCodeType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CodeReviewSourceCodeType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CodeReviewSourceCodeType
   * @throws IOException if the JSON string is invalid with respect to CodeReviewSourceCodeType
   */
  public static CodeReviewSourceCodeType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CodeReviewSourceCodeType.class);
  }

  /**
   * Convert an instance of CodeReviewSourceCodeType to an JSON string
   *
   * @return JSON string
   */
