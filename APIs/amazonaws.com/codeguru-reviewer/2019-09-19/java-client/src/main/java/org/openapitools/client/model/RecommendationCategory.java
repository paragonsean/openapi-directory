...
/**
 * Gets or Sets RecommendationCategory
 */
@JsonAdapter(RecommendationCategory.Adapter.class)
public enum RecommendationCategory {
  ...
  public static RecommendationCategory fromValue(String value) {
    for (RecommendationCategory b : RecommendationCategory.values()) {
  ...
  public static class Adapter extends TypeAdapter<RecommendationCategory> {
    @Override
    public void write(final JsonWriter jsonWriter, final RecommendationCategory enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RecommendationCategory read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RecommendationCategory.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RecommendationCategory.fromValue(value);
  }
}
