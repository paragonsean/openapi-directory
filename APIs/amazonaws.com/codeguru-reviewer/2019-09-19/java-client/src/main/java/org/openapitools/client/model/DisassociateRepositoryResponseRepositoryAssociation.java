...
public class DisassociateRepositoryResponseRepositoryAssociation {
  ...
  public DisassociateRepositoryResponseRepositoryAssociation() {
  }

  public DisassociateRepositoryResponseRepositoryAssociation associationId(String associationId) {
  ...
  public DisassociateRepositoryResponseRepositoryAssociation associationArn(String associationArn) {
  ...
  public DisassociateRepositoryResponseRepositoryAssociation connectionArn(String connectionArn) {
  ...
  public DisassociateRepositoryResponseRepositoryAssociation name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DisassociateRepositoryResponseRepositoryAssociation owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public DisassociateRepositoryResponseRepositoryAssociation providerType(ProviderType providerType) {
  ...
  public DisassociateRepositoryResponseRepositoryAssociation state(RepositoryAssociationState state) {
    this.state = state;
    return this;
  }
  ...
  public DisassociateRepositoryResponseRepositoryAssociation stateReason(String stateReason) {
  ...
  public DisassociateRepositoryResponseRepositoryAssociation lastUpdatedTimeStamp(OffsetDateTime lastUpdatedTimeStamp) {
  ...
  public DisassociateRepositoryResponseRepositoryAssociation createdTimeStamp(OffsetDateTime createdTimeStamp) {
  ...
  public DisassociateRepositoryResponseRepositoryAssociation kmSKeyDetails(AssociateRepositoryRequestKMSKeyDetails kmSKeyDetails) {
  ...
  public DisassociateRepositoryResponseRepositoryAssociation s3RepositoryDetails(S3RepositoryDetails s3RepositoryDetails) {
  ...
  public boolean equals(Object o) {
    ...
    DisassociateRepositoryResponseRepositoryAssociation disassociateRepositoryResponseRepositoryAssociation = (DisassociateRepositoryResponseRepositoryAssociation) o;
    return Objects.equals(this.associationId, disassociateRepositoryResponseRepositoryAssociation.associationId) &&
        Objects.equals(this.associationArn, disassociateRepositoryResponseRepositoryAssociation.associationArn) &&
        Objects.equals(this.connectionArn, disassociateRepositoryResponseRepositoryAssociation.connectionArn) &&
        Objects.equals(this.name, disassociateRepositoryResponseRepositoryAssociation.name) &&
        Objects.equals(this.owner, disassociateRepositoryResponseRepositoryAssociation.owner) &&
        Objects.equals(this.providerType, disassociateRepositoryResponseRepositoryAssociation.providerType) &&
        Objects.equals(this.state, disassociateRepositoryResponseRepositoryAssociation.state) &&
        Objects.equals(this.stateReason, disassociateRepositoryResponseRepositoryAssociation.stateReason) &&
        Objects.equals(this.lastUpdatedTimeStamp, disassociateRepositoryResponseRepositoryAssociation.lastUpdatedTimeStamp) &&
        Objects.equals(this.createdTimeStamp, disassociateRepositoryResponseRepositoryAssociation.createdTimeStamp) &&
        Objects.equals(this.kmSKeyDetails, disassociateRepositoryResponseRepositoryAssociation.kmSKeyDetails) &&
        Objects.equals(this.s3RepositoryDetails, disassociateRepositoryResponseRepositoryAssociation.s3RepositoryDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisassociateRepositoryResponseRepositoryAssociation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateRepositoryResponseRepositoryAssociation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateRepositoryResponseRepositoryAssociation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateRepositoryResponseRepositoryAssociation is not found in the empty JSON string", DisassociateRepositoryResponseRepositoryAssociation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateRepositoryResponseRepositoryAssociation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateRepositoryResponseRepositoryAssociation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateRepositoryResponseRepositoryAssociation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateRepositoryResponseRepositoryAssociation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateRepositoryResponseRepositoryAssociation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateRepositoryResponseRepositoryAssociation.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateRepositoryResponseRepositoryAssociation>() {
           @Override
           public void write(JsonWriter out, DisassociateRepositoryResponseRepositoryAssociation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateRepositoryResponseRepositoryAssociation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateRepositoryResponseRepositoryAssociation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateRepositoryResponseRepositoryAssociation
   * @throws IOException if the JSON string is invalid with respect to DisassociateRepositoryResponseRepositoryAssociation
   */
  public static DisassociateRepositoryResponseRepositoryAssociation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateRepositoryResponseRepositoryAssociation.class);
  }

  /**
   * Convert an instance of DisassociateRepositoryResponseRepositoryAssociation to an JSON string
   *
   * @return JSON string
   */
