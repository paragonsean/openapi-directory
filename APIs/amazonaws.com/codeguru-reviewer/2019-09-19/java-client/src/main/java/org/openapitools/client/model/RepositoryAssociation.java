...
public class RepositoryAssociation {
  ...
  public RepositoryAssociation associationId(String associationId) {
  ...
  public RepositoryAssociation associationArn(String associationArn) {
  ...
  public RepositoryAssociation connectionArn(String connectionArn) {
  ...
  public RepositoryAssociation name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RepositoryAssociation owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public RepositoryAssociation providerType(ProviderType providerType) {
  ...
  public RepositoryAssociation state(RepositoryAssociationState state) {
    this.state = state;
    return this;
  }
  ...
  public RepositoryAssociation stateReason(String stateReason) {
  ...
  public RepositoryAssociation lastUpdatedTimeStamp(OffsetDateTime lastUpdatedTimeStamp) {
  ...
  public RepositoryAssociation createdTimeStamp(OffsetDateTime createdTimeStamp) {
  ...
  public RepositoryAssociation kmSKeyDetails(AssociateRepositoryRequestKMSKeyDetails kmSKeyDetails) {
  ...
  public RepositoryAssociation s3RepositoryDetails(S3RepositoryDetails s3RepositoryDetails) {
  ...
  public boolean equals(Object o) {
    ...
    RepositoryAssociation repositoryAssociation = (RepositoryAssociation) o;
    return Objects.equals(this.associationId, repositoryAssociation.associationId) &&
        Objects.equals(this.associationArn, repositoryAssociation.associationArn) &&
        Objects.equals(this.connectionArn, repositoryAssociation.connectionArn) &&
        Objects.equals(this.name, repositoryAssociation.name) &&
        Objects.equals(this.owner, repositoryAssociation.owner) &&
        Objects.equals(this.providerType, repositoryAssociation.providerType) &&
        Objects.equals(this.state, repositoryAssociation.state) &&
        Objects.equals(this.stateReason, repositoryAssociation.stateReason) &&
        Objects.equals(this.lastUpdatedTimeStamp, repositoryAssociation.lastUpdatedTimeStamp) &&
        Objects.equals(this.createdTimeStamp, repositoryAssociation.createdTimeStamp) &&
        Objects.equals(this.kmSKeyDetails, repositoryAssociation.kmSKeyDetails) &&
        Objects.equals(this.s3RepositoryDetails, repositoryAssociation.s3RepositoryDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class RepositoryAssociation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RepositoryAssociation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepositoryAssociation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryAssociation is not found in the empty JSON string", RepositoryAssociation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RepositoryAssociation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepositoryAssociation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryAssociation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryAssociation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryAssociation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryAssociation.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryAssociation>() {
           @Override
           public void write(JsonWriter out, RepositoryAssociation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepositoryAssociation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RepositoryAssociation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RepositoryAssociation
   * @throws IOException if the JSON string is invalid with respect to RepositoryAssociation
   */
  public static RepositoryAssociation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryAssociation.class);
  }

  /**
   * Convert an instance of RepositoryAssociation to an JSON string
   *
   * @return JSON string
   */
