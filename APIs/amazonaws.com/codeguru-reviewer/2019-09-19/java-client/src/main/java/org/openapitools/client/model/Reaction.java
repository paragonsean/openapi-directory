 ...
 */
@JsonAdapter(Reaction.Adapter.class)
public enum Reaction {
  ...
  public static Reaction fromValue(String value) {
    for (Reaction b : Reaction.values()) {
  ...
  public static class Adapter extends TypeAdapter<Reaction> {
    @Override
    public void write(final JsonWriter jsonWriter, final Reaction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public Reaction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return Reaction.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    Reaction.fromValue(value);
  }
}
