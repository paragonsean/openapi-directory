...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.CodeArtifacts();
  });
  ...
  describe('CodeArtifacts', function() {
    it('should create an instance of CodeArtifacts', function() {
      // uncomment below and update the code to test CodeArtifacts
      //var instance = new AmazonCodeGuruReviewer.CodeArtifacts();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.CodeArtifacts);
    });
