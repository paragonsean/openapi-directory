...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonCodeGuruReviewer.TagResourceRequest();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.TagResourceRequest);
    });
