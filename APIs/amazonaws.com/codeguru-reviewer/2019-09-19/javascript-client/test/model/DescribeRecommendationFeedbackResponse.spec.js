...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.DescribeRecommendationFeedbackResponse();
  });
  ...
  describe('DescribeRecommendationFeedbackResponse', function() {
    it('should create an instance of DescribeRecommendationFeedbackResponse', function() {
      // uncomment below and update the code to test DescribeRecommendationFeedbackResponse
      //var instance = new AmazonCodeGuruReviewer.DescribeRecommendationFeedbackResponse();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.DescribeRecommendationFeedbackResponse);
    });

    it('should have the property recommendationFeedback (base name: "RecommendationFeedback")', function() {
      // uncomment below and update the code to test the property recommendationFeedback
      //var instance = new AmazonCodeGuruReviewer.DescribeRecommendationFeedbackResponse();
