...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequestRepositoryBitbucket();
  });
  ...
  describe('AssociateRepositoryRequestRepositoryBitbucket', function() {
    it('should create an instance of AssociateRepositoryRequestRepositoryBitbucket', function() {
      // uncomment below and update the code to test AssociateRepositoryRequestRepositoryBitbucket
      //var instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequestRepositoryBitbucket();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.AssociateRepositoryRequestRepositoryBitbucket);
    });
