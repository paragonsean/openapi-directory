...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.BranchDiffSourceCodeType();
  });
  ...
  describe('BranchDiffSourceCodeType', function() {
    it('should create an instance of BranchDiffSourceCodeType', function() {
      // uncomment below and update the code to test BranchDiffSourceCodeType
      //var instance = new AmazonCodeGuruReviewer.BranchDiffSourceCodeType();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.BranchDiffSourceCodeType);
    });
