...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.DisassociateRepositoryResponse();
  });
  ...
  describe('DisassociateRepositoryResponse', function() {
    it('should create an instance of DisassociateRepositoryResponse', function() {
      // uncomment below and update the code to test DisassociateRepositoryResponse
      //var instance = new AmazonCodeGuruReviewer.DisassociateRepositoryResponse();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.DisassociateRepositoryResponse);
    });
