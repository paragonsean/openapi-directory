...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.RepositoryAnalysis();
  });
  ...
  describe('RepositoryAnalysis', function() {
    it('should create an instance of RepositoryAnalysis', function() {
      // uncomment below and update the code to test RepositoryAnalysis
      //var instance = new AmazonCodeGuruReviewer.RepositoryAnalysis();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.RepositoryAnalysis);
    });
