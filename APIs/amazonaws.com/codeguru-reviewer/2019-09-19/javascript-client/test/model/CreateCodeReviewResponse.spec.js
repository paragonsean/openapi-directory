...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.CreateCodeReviewResponse();
  });
  ...
  describe('CreateCodeReviewResponse', function() {
    it('should create an instance of CreateCodeReviewResponse', function() {
      // uncomment below and update the code to test CreateCodeReviewResponse
      //var instance = new AmazonCodeGuruReviewer.CreateCodeReviewResponse();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.CreateCodeReviewResponse);
    });

    it('should have the property codeReview (base name: "CodeReview")', function() {
      // uncomment below and update the code to test the property codeReview
      //var instance = new AmazonCodeGuruReviewer.CreateCodeReviewResponse();
