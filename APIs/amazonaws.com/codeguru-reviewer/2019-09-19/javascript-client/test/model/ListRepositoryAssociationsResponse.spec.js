...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.ListRepositoryAssociationsResponse();
  });
  ...
  describe('ListRepositoryAssociationsResponse', function() {
    it('should create an instance of ListRepositoryAssociationsResponse', function() {
      // uncomment below and update the code to test ListRepositoryAssociationsResponse
      //var instance = new AmazonCodeGuruReviewer.ListRepositoryAssociationsResponse();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.ListRepositoryAssociationsResponse);
    });

    it('should have the property repositoryAssociationSummaries (base name: "RepositoryAssociationSummaries")', function() {
      // uncomment below and update the code to test the property repositoryAssociationSummaries
      //var instance = new AmazonCodeGuruReviewer.ListRepositoryAssociationsResponse();
