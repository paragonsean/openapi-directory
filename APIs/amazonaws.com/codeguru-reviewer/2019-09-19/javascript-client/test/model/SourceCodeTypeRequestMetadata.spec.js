...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.SourceCodeTypeRequestMetadata();
  });
  ...
  describe('SourceCodeTypeRequestMetadata', function() {
    it('should create an instance of SourceCodeTypeRequestMetadata', function() {
      // uncomment below and update the code to test SourceCodeTypeRequestMetadata
      //var instance = new AmazonCodeGuruReviewer.SourceCodeTypeRequestMetadata();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.SourceCodeTypeRequestMetadata);
    });
    ...
    it('should have the property eventInfo (base name: "EventInfo")', function() {
      // uncomment below and update the code to test the property eventInfo
      //var instance = new AmazonCodeGuruReviewer.SourceCodeTypeRequestMetadata();
      //expect(instance).to.be();
    });
