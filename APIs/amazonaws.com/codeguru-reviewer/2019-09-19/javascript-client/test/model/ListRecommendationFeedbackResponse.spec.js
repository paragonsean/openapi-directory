...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.ListRecommendationFeedbackResponse();
  });
  ...
  describe('ListRecommendationFeedbackResponse', function() {
    it('should create an instance of ListRecommendationFeedbackResponse', function() {
      // uncomment below and update the code to test ListRecommendationFeedbackResponse
      //var instance = new AmazonCodeGuruReviewer.ListRecommendationFeedbackResponse();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.ListRecommendationFeedbackResponse);
    });

    it('should have the property recommendationFeedbackSummaries (base name: "RecommendationFeedbackSummaries")', function() {
      // uncomment below and update the code to test the property recommendationFeedbackSummaries
      //var instance = new AmazonCodeGuruReviewer.ListRecommendationFeedbackResponse();
