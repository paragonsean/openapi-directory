...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.CodeReviewSummary();
  });
  ...
  describe('CodeReviewSummary', function() {
    it('should create an instance of CodeReviewSummary', function() {
      // uncomment below and update the code to test CodeReviewSummary
      //var instance = new AmazonCodeGuruReviewer.CodeReviewSummary();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.CodeReviewSummary);
    });
    ...
    it('should have the property metricsSummary (base name: "MetricsSummary")', function() {
      // uncomment below and update the code to test the property metricsSummary
      //var instance = new AmazonCodeGuruReviewer.CodeReviewSummary();
      //expect(instance).to.be();
    });
