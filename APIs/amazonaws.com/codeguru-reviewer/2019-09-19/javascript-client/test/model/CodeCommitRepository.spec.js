...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.CodeCommitRepository();
  });
  ...
  describe('CodeCommitRepository', function() {
    it('should create an instance of CodeCommitRepository', function() {
      // uncomment below and update the code to test CodeCommitRepository
      //var instance = new AmazonCodeGuruReviewer.CodeCommitRepository();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.CodeCommitRepository);
    });
