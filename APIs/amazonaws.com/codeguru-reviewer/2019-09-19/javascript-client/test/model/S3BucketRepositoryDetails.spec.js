...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.S3BucketRepositoryDetails();
  });
  ...
  describe('S3BucketRepositoryDetails', function() {
    it('should create an instance of S3BucketRepositoryDetails', function() {
      // uncomment below and update the code to test S3BucketRepositoryDetails
      //var instance = new AmazonCodeGuruReviewer.S3BucketRepositoryDetails();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.S3BucketRepositoryDetails);
    });
