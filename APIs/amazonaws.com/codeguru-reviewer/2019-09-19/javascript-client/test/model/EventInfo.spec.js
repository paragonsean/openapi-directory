...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.EventInfo();
  });
  ...
  describe('EventInfo', function() {
    it('should create an instance of EventInfo', function() {
      // uncomment below and update the code to test EventInfo
      //var instance = new AmazonCodeGuruReviewer.EventInfo();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.EventInfo);
    });
