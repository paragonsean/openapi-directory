...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.DisassociateRepositoryResponseRepositoryAssociation();
  });
  ...
  describe('DisassociateRepositoryResponseRepositoryAssociation', function() {
    it('should create an instance of DisassociateRepositoryResponseRepositoryAssociation', function() {
      // uncomment below and update the code to test DisassociateRepositoryResponseRepositoryAssociation
      //var instance = new AmazonCodeGuruReviewer.DisassociateRepositoryResponseRepositoryAssociation();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.DisassociateRepositoryResponseRepositoryAssociation);
    });
