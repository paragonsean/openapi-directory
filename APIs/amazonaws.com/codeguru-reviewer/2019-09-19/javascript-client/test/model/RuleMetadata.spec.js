...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.RuleMetadata();
  });
  ...
  describe('RuleMetadata', function() {
    it('should create an instance of RuleMetadata', function() {
      // uncomment below and update the code to test RuleMetadata
      //var instance = new AmazonCodeGuruReviewer.RuleMetadata();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.RuleMetadata);
    });
