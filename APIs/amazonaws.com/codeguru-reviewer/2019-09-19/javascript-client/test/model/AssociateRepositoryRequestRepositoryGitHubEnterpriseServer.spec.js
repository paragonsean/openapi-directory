...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequestRepositoryGitHubEnterpriseServer();
  });
  ...
  describe('AssociateRepositoryRequestRepositoryGitHubEnterpriseServer', function() {
    it('should create an instance of AssociateRepositoryRequestRepositoryGitHubEnterpriseServer', function() {
      // uncomment below and update the code to test AssociateRepositoryRequestRepositoryGitHubEnterpriseServer
      //var instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequestRepositoryGitHubEnterpriseServer();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.AssociateRepositoryRequestRepositoryGitHubEnterpriseServer);
    });
