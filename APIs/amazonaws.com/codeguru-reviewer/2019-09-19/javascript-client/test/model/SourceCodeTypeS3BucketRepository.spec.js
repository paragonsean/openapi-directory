...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.SourceCodeTypeS3BucketRepository();
  });
  ...
  describe('SourceCodeTypeS3BucketRepository', function() {
    it('should create an instance of SourceCodeTypeS3BucketRepository', function() {
      // uncomment below and update the code to test SourceCodeTypeS3BucketRepository
      //var instance = new AmazonCodeGuruReviewer.SourceCodeTypeS3BucketRepository();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.SourceCodeTypeS3BucketRepository);
    });
