...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.SourceCodeTypeBranchDiff();
  });
  ...
  describe('SourceCodeTypeBranchDiff', function() {
    it('should create an instance of SourceCodeTypeBranchDiff', function() {
      // uncomment below and update the code to test SourceCodeTypeBranchDiff
      //var instance = new AmazonCodeGuruReviewer.SourceCodeTypeBranchDiff();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.SourceCodeTypeBranchDiff);
    });
