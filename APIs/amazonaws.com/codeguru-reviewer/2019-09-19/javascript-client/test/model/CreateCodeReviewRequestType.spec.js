...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.CreateCodeReviewRequestType();
  });
  ...
  describe('CreateCodeReviewRequestType', function() {
    it('should create an instance of CreateCodeReviewRequestType', function() {
      // uncomment below and update the code to test CreateCodeReviewRequestType
      //var instance = new AmazonCodeGuruReviewer.CreateCodeReviewRequestType();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.CreateCodeReviewRequestType);
    });
