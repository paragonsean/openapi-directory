...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.AssociateRepositoryResponseRepositoryAssociation();
  });
  ...
  describe('AssociateRepositoryResponseRepositoryAssociation', function() {
    it('should create an instance of AssociateRepositoryResponseRepositoryAssociation', function() {
      // uncomment below and update the code to test AssociateRepositoryResponseRepositoryAssociation
      //var instance = new AmazonCodeGuruReviewer.AssociateRepositoryResponseRepositoryAssociation();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.AssociateRepositoryResponseRepositoryAssociation);
    });
