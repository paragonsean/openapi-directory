...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.ListRecommendationsResponse();
  });
  ...
  describe('ListRecommendationsResponse', function() {
    it('should create an instance of ListRecommendationsResponse', function() {
      // uncomment below and update the code to test ListRecommendationsResponse
      //var instance = new AmazonCodeGuruReviewer.ListRecommendationsResponse();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.ListRecommendationsResponse);
    });

    it('should have the property recommendationSummaries (base name: "RecommendationSummaries")', function() {
      // uncomment below and update the code to test the property recommendationSummaries
      //var instance = new AmazonCodeGuruReviewer.ListRecommendationsResponse();
