...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequestRepositoryCodeCommit();
  });
  ...
  describe('AssociateRepositoryRequestRepositoryCodeCommit', function() {
    it('should create an instance of AssociateRepositoryRequestRepositoryCodeCommit', function() {
      // uncomment below and update the code to test AssociateRepositoryRequestRepositoryCodeCommit
      //var instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequestRepositoryCodeCommit();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.AssociateRepositoryRequestRepositoryCodeCommit);
    });
