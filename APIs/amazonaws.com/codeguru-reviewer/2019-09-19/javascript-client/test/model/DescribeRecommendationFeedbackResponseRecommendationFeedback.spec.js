...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.DescribeRecommendationFeedbackResponseRecommendationFeedback();
  });
  ...
  describe('DescribeRecommendationFeedbackResponseRecommendationFeedback', function() {
    it('should create an instance of DescribeRecommendationFeedbackResponseRecommendationFeedback', function() {
      // uncomment below and update the code to test DescribeRecommendationFeedbackResponseRecommendationFeedback
      //var instance = new AmazonCodeGuruReviewer.DescribeRecommendationFeedbackResponseRecommendationFeedback();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.DescribeRecommendationFeedbackResponseRecommendationFeedback);
    });
