...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.S3BucketRepository();
  });
  ...
  describe('S3BucketRepository', function() {
    it('should create an instance of S3BucketRepository', function() {
      // uncomment below and update the code to test S3BucketRepository
      //var instance = new AmazonCodeGuruReviewer.S3BucketRepository();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.S3BucketRepository);
    });
