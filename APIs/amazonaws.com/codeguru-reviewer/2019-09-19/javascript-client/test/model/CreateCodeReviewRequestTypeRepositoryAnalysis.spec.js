...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.CreateCodeReviewRequestTypeRepositoryAnalysis();
  });
  ...
  describe('CreateCodeReviewRequestTypeRepositoryAnalysis', function() {
    it('should create an instance of CreateCodeReviewRequestTypeRepositoryAnalysis', function() {
      // uncomment below and update the code to test CreateCodeReviewRequestTypeRepositoryAnalysis
      //var instance = new AmazonCodeGuruReviewer.CreateCodeReviewRequestTypeRepositoryAnalysis();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.CreateCodeReviewRequestTypeRepositoryAnalysis);
    });
