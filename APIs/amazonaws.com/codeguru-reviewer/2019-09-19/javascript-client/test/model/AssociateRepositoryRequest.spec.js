...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequest();
  });
  ...
  describe('AssociateRepositoryRequest', function() {
    it('should create an instance of AssociateRepositoryRequest', function() {
      // uncomment below and update the code to test AssociateRepositoryRequest
      //var instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequest();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.AssociateRepositoryRequest);
    });
    ...
    it('should have the property kMSKeyDetails (base name: "KMSKeyDetails")', function() {
      // uncomment below and update the code to test the property kMSKeyDetails
      //var instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequest();
      //expect(instance).to.be();
    });
