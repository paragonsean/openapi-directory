...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequestKMSKeyDetails();
  });
  ...
  describe('AssociateRepositoryRequestKMSKeyDetails', function() {
    it('should create an instance of AssociateRepositoryRequestKMSKeyDetails', function() {
      // uncomment below and update the code to test AssociateRepositoryRequestKMSKeyDetails
      //var instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequestKMSKeyDetails();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.AssociateRepositoryRequestKMSKeyDetails);
    });
    ...
    it('should have the property encryptionOption (base name: "EncryptionOption")', function() {
      // uncomment below and update the code to test the property encryptionOption
      //var instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequestKMSKeyDetails();
      //expect(instance).to.be();
    });
