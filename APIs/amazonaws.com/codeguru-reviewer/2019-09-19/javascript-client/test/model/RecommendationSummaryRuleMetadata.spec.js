...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.RecommendationSummaryRuleMetadata();
  });
  ...
  describe('RecommendationSummaryRuleMetadata', function() {
    it('should create an instance of RecommendationSummaryRuleMetadata', function() {
      // uncomment below and update the code to test RecommendationSummaryRuleMetadata
      //var instance = new AmazonCodeGuruReviewer.RecommendationSummaryRuleMetadata();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.RecommendationSummaryRuleMetadata);
    });
    ...
    it('should have the property ruleTags (base name: "RuleTags")', function() {
      // uncomment below and update the code to test the property ruleTags
      //var instance = new AmazonCodeGuruReviewer.RecommendationSummaryRuleMetadata();
      //expect(instance).to.be();
    });
