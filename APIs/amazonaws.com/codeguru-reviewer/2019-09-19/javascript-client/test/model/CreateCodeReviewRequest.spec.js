...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.CreateCodeReviewRequest();
  });
  ...
  describe('CreateCodeReviewRequest', function() {
    it('should create an instance of CreateCodeReviewRequest', function() {
      // uncomment below and update the code to test CreateCodeReviewRequest
      //var instance = new AmazonCodeGuruReviewer.CreateCodeReviewRequest();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.CreateCodeReviewRequest);
    });
    ...
    it('should have the property repositoryAssociationArn (base name: "RepositoryAssociationArn")', function() {
      // uncomment below and update the code to test the property repositoryAssociationArn
      //var instance = new AmazonCodeGuruReviewer.CreateCodeReviewRequest();
      //expect(instance).to.be();
    });
