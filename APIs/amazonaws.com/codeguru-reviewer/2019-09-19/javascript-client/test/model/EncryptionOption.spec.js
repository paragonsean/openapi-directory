...
(function(root, factory) {
  ...
  describe('EncryptionOption', function() {
    it('should create an instance of EncryptionOption', function() {
      // uncomment below and update the code to test EncryptionOption
      //var instance = new AmazonCodeGuruReviewer.EncryptionOption();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.EncryptionOption);
    });
