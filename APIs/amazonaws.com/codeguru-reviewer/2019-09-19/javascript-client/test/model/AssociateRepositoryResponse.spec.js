...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.AssociateRepositoryResponse();
  });
  ...
  describe('AssociateRepositoryResponse', function() {
    it('should create an instance of AssociateRepositoryResponse', function() {
      // uncomment below and update the code to test AssociateRepositoryResponse
      //var instance = new AmazonCodeGuruReviewer.AssociateRepositoryResponse();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.AssociateRepositoryResponse);
    });
