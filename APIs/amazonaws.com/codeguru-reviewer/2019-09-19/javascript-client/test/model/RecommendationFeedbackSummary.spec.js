...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.RecommendationFeedbackSummary();
  });
  ...
  describe('RecommendationFeedbackSummary', function() {
    it('should create an instance of RecommendationFeedbackSummary', function() {
      // uncomment below and update the code to test RecommendationFeedbackSummary
      //var instance = new AmazonCodeGuruReviewer.RecommendationFeedbackSummary();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.RecommendationFeedbackSummary);
    });
