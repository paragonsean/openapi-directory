...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.KMSKeyDetails();
  });
  ...
  describe('KMSKeyDetails', function() {
    it('should create an instance of KMSKeyDetails', function() {
      // uncomment below and update the code to test KMSKeyDetails
      //var instance = new AmazonCodeGuruReviewer.KMSKeyDetails();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.KMSKeyDetails);
    });
