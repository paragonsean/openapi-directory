...
(function(root, factory) {
  ...
  describe('VendorName', function() {
    it('should create an instance of VendorName', function() {
      // uncomment below and update the code to test VendorName
      //var instance = new AmazonCodeGuruReviewer.VendorName();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.VendorName);
    });
