...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.RepositoryAssociation();
  });
  ...
  describe('RepositoryAssociation', function() {
    it('should create an instance of RepositoryAssociation', function() {
      // uncomment below and update the code to test RepositoryAssociation
      //var instance = new AmazonCodeGuruReviewer.RepositoryAssociation();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.RepositoryAssociation);
    });
    ...
    it('should have the property s3RepositoryDetails (base name: "S3RepositoryDetails")', function() {
      // uncomment below and update the code to test the property s3RepositoryDetails
      //var instance = new AmazonCodeGuruReviewer.RepositoryAssociation();
      //expect(instance).to.be();
    });
