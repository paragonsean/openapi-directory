...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.ThirdPartySourceRepository();
  });
  ...
  describe('ThirdPartySourceRepository', function() {
    it('should create an instance of ThirdPartySourceRepository', function() {
      // uncomment below and update the code to test ThirdPartySourceRepository
      //var instance = new AmazonCodeGuruReviewer.ThirdPartySourceRepository();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.ThirdPartySourceRepository);
    });
