...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequestRepository();
  });
  ...
  describe('AssociateRepositoryRequestRepository', function() {
    it('should create an instance of AssociateRepositoryRequestRepository', function() {
      // uncomment below and update the code to test AssociateRepositoryRequestRepository
      //var instance = new AmazonCodeGuruReviewer.AssociateRepositoryRequestRepository();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.AssociateRepositoryRequestRepository);
    });
