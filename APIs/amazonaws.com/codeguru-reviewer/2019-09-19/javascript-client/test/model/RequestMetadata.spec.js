...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.RequestMetadata();
  });
  ...
  describe('RequestMetadata', function() {
    it('should create an instance of RequestMetadata', function() {
      ...
      //var instance = new AmazonCodeGuruReviewer.RequestMetadata();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.RequestMetadata);
    });
