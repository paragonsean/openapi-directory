...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.CodeReviewType();
  });
  ...
  describe('CodeReviewType', function() {
    it('should create an instance of CodeReviewType', function() {
      // uncomment below and update the code to test CodeReviewType
      //var instance = new AmazonCodeGuruReviewer.CodeReviewType();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.CodeReviewType);
    });

    it('should have the property repositoryAnalysis (base name: "RepositoryAnalysis")', function() {
      // uncomment below and update the code to test the property repositoryAnalysis
      //var instance = new AmazonCodeGuruReviewer.CodeReviewType();
