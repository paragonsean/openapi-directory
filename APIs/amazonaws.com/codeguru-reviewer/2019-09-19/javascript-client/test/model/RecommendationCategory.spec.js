...
(function(root, factory) {
  ...
  describe('RecommendationCategory', function() {
    it('should create an instance of RecommendationCategory', function() {
      // uncomment below and update the code to test RecommendationCategory
      //var instance = new AmazonCodeGuruReviewer.RecommendationCategory();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.RecommendationCategory);
    });
