...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.RepositoryAnalysisRepositoryHead();
  });
  ...
  describe('RepositoryAnalysisRepositoryHead', function() {
    it('should create an instance of RepositoryAnalysisRepositoryHead', function() {
      // uncomment below and update the code to test RepositoryAnalysisRepositoryHead
      //var instance = new AmazonCodeGuruReviewer.RepositoryAnalysisRepositoryHead();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.RepositoryAnalysisRepositoryHead);
    });
