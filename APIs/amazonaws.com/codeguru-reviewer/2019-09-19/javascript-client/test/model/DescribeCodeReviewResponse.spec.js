...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.DescribeCodeReviewResponse();
  });
  ...
  describe('DescribeCodeReviewResponse', function() {
    it('should create an instance of DescribeCodeReviewResponse', function() {
      // uncomment below and update the code to test DescribeCodeReviewResponse
      //var instance = new AmazonCodeGuruReviewer.DescribeCodeReviewResponse();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.DescribeCodeReviewResponse);
    });
