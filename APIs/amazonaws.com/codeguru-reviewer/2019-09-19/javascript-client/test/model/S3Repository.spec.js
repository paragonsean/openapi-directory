...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.S3Repository();
  });
  ...
  describe('S3Repository', function() {
    it('should create an instance of S3Repository', function() {
      // uncomment below and update the code to test S3Repository
      //var instance = new AmazonCodeGuruReviewer.S3Repository();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.S3Repository);
    });
