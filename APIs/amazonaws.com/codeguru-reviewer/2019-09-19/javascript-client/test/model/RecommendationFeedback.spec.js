...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.RecommendationFeedback();
  });
  ...
  describe('RecommendationFeedback', function() {
    it('should create an instance of RecommendationFeedback', function() {
      // uncomment below and update the code to test RecommendationFeedback
      //var instance = new AmazonCodeGuruReviewer.RecommendationFeedback();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.RecommendationFeedback);
    });
