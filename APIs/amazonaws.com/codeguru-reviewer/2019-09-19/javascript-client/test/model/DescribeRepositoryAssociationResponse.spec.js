...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.DescribeRepositoryAssociationResponse();
  });
  ...
  describe('DescribeRepositoryAssociationResponse', function() {
    it('should create an instance of DescribeRepositoryAssociationResponse', function() {
      // uncomment below and update the code to test DescribeRepositoryAssociationResponse
      //var instance = new AmazonCodeGuruReviewer.DescribeRepositoryAssociationResponse();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.DescribeRepositoryAssociationResponse);
    });

    it('should have the property repositoryAssociation (base name: "RepositoryAssociation")', function() {
      // uncomment below and update the code to test the property repositoryAssociation
      //var instance = new AmazonCodeGuruReviewer.DescribeRepositoryAssociationResponse();
