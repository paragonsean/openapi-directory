...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.ListCodeReviewsResponse();
  });
  ...
  describe('ListCodeReviewsResponse', function() {
    it('should create an instance of ListCodeReviewsResponse', function() {
      // uncomment below and update the code to test ListCodeReviewsResponse
      //var instance = new AmazonCodeGuruReviewer.ListCodeReviewsResponse();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.ListCodeReviewsResponse);
    });

    it('should have the property codeReviewSummaries (base name: "CodeReviewSummaries")', function() {
      // uncomment below and update the code to test the property codeReviewSummaries
      //var instance = new AmazonCodeGuruReviewer.ListCodeReviewsResponse();
