...
(function(root, factory) {
  ...
  describe('RepositoryAssociationState', function() {
    it('should create an instance of RepositoryAssociationState', function() {
      // uncomment below and update the code to test RepositoryAssociationState
      //var instance = new AmazonCodeGuruReviewer.RepositoryAssociationState();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.RepositoryAssociationState);
    });
