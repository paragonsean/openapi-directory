...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.RepositoryHeadSourceCodeType();
  });
  ...
  describe('RepositoryHeadSourceCodeType', function() {
    it('should create an instance of RepositoryHeadSourceCodeType', function() {
      // uncomment below and update the code to test RepositoryHeadSourceCodeType
      //var instance = new AmazonCodeGuruReviewer.RepositoryHeadSourceCodeType();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.RepositoryHeadSourceCodeType);
    });
