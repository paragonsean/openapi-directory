...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.PutRecommendationFeedbackRequest();
  });
  ...
  describe('PutRecommendationFeedbackRequest', function() {
    it('should create an instance of PutRecommendationFeedbackRequest', function() {
      // uncomment below and update the code to test PutRecommendationFeedbackRequest
      //var instance = new AmazonCodeGuruReviewer.PutRecommendationFeedbackRequest();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.PutRecommendationFeedbackRequest);
    });
