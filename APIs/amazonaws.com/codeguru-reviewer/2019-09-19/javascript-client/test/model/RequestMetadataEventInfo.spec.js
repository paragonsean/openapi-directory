...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruReviewer.RequestMetadataEventInfo();
  });
  ...
  describe('RequestMetadataEventInfo', function() {
    it('should create an instance of RequestMetadataEventInfo', function() {
      // uncomment below and update the code to test RequestMetadataEventInfo
      //var instance = new AmazonCodeGuruReviewer.RequestMetadataEventInfo();
      //expect(instance).to.be.a(AmazonCodeGuruReviewer.RequestMetadataEventInfo);
    });
