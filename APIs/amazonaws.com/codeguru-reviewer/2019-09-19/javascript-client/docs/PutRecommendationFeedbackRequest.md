# AmazonCodeGuruReviewer.PutRecommendationFeedbackRequest
...
**reactions** | [**[Reaction]**](Reaction.md) | List for storing reactions. Reactions are utf-8 text code for emojis. If you send an empty list it clears all your feedback. | 
