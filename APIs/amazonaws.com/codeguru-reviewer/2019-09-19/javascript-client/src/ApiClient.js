...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://codeguru-reviewer.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://codeguru-reviewer.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2019-09-19/Javascript'
        };
