...
* @readonly
*/
export default class RepositoryAssociationState {
    ...
    /**
    * Returns a <code>RepositoryAssociationState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RepositoryAssociationState} The enum <code>RepositoryAssociationState</code> value.
    */
