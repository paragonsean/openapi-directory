...
* @readonly
*/
export default class RecommendationCategory {
    
        /**
         * value: "AWSBestPractices"
         * @const
         */
    ...
    /**
    * Returns a <code>RecommendationCategory</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RecommendationCategory} The enum <code>RecommendationCategory</code> value.
    */
