...
/**
 * The RecommendationFeedback model module.
 * @module model/RecommendationFeedback
 * @version 2019-09-19
 */
class RecommendationFeedback {
    /**
     * Constructs a new <code>RecommendationFeedback</code>.
     * Information about the recommendation feedback.
     * @alias module:model/RecommendationFeedback
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>RecommendationFeedback</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RecommendationFeedback} obj Optional instance to populate.
     * @return {module:model/RecommendationFeedback} The populated <code>RecommendationFeedback</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecommendationFeedback();
    ...
    /**
     * Validates the JSON data with respect to <code>RecommendationFeedback</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RecommendationFeedback</code>.
     */
