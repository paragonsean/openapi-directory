...
* @readonly
*/
export default class EncryptionOption {
    ...
    /**
    * Returns a <code>EncryptionOption</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EncryptionOption} The enum <code>EncryptionOption</code> value.
    */
