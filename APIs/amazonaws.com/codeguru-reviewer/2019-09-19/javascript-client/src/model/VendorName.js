...
* @readonly
*/
export default class VendorName {
    ...
    /**
    * Returns a <code>VendorName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VendorName} The enum <code>VendorName</code> value.
    */
