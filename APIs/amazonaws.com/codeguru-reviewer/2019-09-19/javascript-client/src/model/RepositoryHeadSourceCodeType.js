...
/**
 * The RepositoryHeadSourceCodeType model module.
 * @module model/RepositoryHeadSourceCodeType
 * @version 2019-09-19
 */
class RepositoryHeadSourceCodeType {
    /**
     * Constructs a new <code>RepositoryHeadSourceCodeType</code>.
     ...
     * @alias module:model/RepositoryHeadSourceCodeType
    ...
    /**
     * Constructs a <code>RepositoryHeadSourceCodeType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryHeadSourceCodeType} obj Optional instance to populate.
     * @return {module:model/RepositoryHeadSourceCodeType} The populated <code>RepositoryHeadSourceCodeType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryHeadSourceCodeType();
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryHeadSourceCodeType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryHeadSourceCodeType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RepositoryHeadSourceCodeType.RequiredProperties) {
...
RepositoryHeadSourceCodeType.RequiredProperties = ["BranchName"];
...
export default RepositoryHeadSourceCodeType;
