...
* @readonly
*/
export default class ConfigFileState {
    ...
    /**
    * Returns a <code>ConfigFileState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ConfigFileState} The enum <code>ConfigFileState</code> value.
    */
