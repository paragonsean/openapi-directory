...
public class DescribeEffectivePolicyRequest {
  ...
  public DescribeEffectivePolicyRequest() {
  }

  public DescribeEffectivePolicyRequest policyType(EffectivePolicyType policyType) {
  ...
  public DescribeEffectivePolicyRequest targetId(String targetId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeEffectivePolicyRequest describeEffectivePolicyRequest = (DescribeEffectivePolicyRequest) o;
    return Objects.equals(this.policyType, describeEffectivePolicyRequest.policyType) &&
        Objects.equals(this.targetId, describeEffectivePolicyRequest.targetId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyType, targetId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeEffectivePolicyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeEffectivePolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeEffectivePolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeEffectivePolicyRequest is not found in the empty JSON string", DescribeEffectivePolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeEffectivePolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeEffectivePolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeEffectivePolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeEffectivePolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeEffectivePolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeEffectivePolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeEffectivePolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeEffectivePolicyRequest>() {
           @Override
           public void write(JsonWriter out, DescribeEffectivePolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeEffectivePolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeEffectivePolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeEffectivePolicyRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeEffectivePolicyRequest
   */
  public static DescribeEffectivePolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeEffectivePolicyRequest.class);
  }

  /**
   * Convert an instance of DescribeEffectivePolicyRequest to an JSON string
   *
   * @return JSON string
   */
