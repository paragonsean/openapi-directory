...
import org.openapitools.client.model.DisablePolicyTypeResponseRoot;
...
public class EnablePolicyTypeResponse {
  ...
  private DisablePolicyTypeResponseRoot root;

  public EnablePolicyTypeResponse() {
  }

  public EnablePolicyTypeResponse root(DisablePolicyTypeResponseRoot root) {
    this.root = root;
    return this;
  }
  ...
  public DisablePolicyTypeResponseRoot getRoot() {
    return root;
  }

  public void setRoot(DisablePolicyTypeResponseRoot root) {
    this.root = root;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnablePolicyTypeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnablePolicyTypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnablePolicyTypeResponse is not found in the empty JSON string", EnablePolicyTypeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnablePolicyTypeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnablePolicyTypeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Root`
      if (jsonObj.get("Root") != null && !jsonObj.get("Root").isJsonNull()) {
        DisablePolicyTypeResponseRoot.validateJsonElement(jsonObj.get("Root"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnablePolicyTypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnablePolicyTypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnablePolicyTypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnablePolicyTypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EnablePolicyTypeResponse>() {
           @Override
           public void write(JsonWriter out, EnablePolicyTypeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnablePolicyTypeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EnablePolicyTypeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnablePolicyTypeResponse
   * @throws IOException if the JSON string is invalid with respect to EnablePolicyTypeResponse
   */
  public static EnablePolicyTypeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnablePolicyTypeResponse.class);
  }

  /**
   * Convert an instance of EnablePolicyTypeResponse to an JSON string
   *
   * @return JSON string
   */
