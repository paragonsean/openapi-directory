...
public class ListPoliciesForTargetResponse {
  ...
  public ListPoliciesForTargetResponse policies(List policies) {
  ...
  public ListPoliciesForTargetResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.policies, listPoliciesForTargetResponse.policies) &&
        Objects.equals(this.nextToken, listPoliciesForTargetResponse.nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPoliciesForTargetResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPoliciesForTargetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPoliciesForTargetResponse is not found in the empty JSON string", ListPoliciesForTargetResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPoliciesForTargetResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPoliciesForTargetResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPoliciesForTargetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPoliciesForTargetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPoliciesForTargetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPoliciesForTargetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPoliciesForTargetResponse>() {
           @Override
           public void write(JsonWriter out, ListPoliciesForTargetResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPoliciesForTargetResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPoliciesForTargetResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPoliciesForTargetResponse
   * @throws IOException if the JSON string is invalid with respect to ListPoliciesForTargetResponse
   */
  public static ListPoliciesForTargetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPoliciesForTargetResponse.class);
  }

  /**
   * Convert an instance of ListPoliciesForTargetResponse to an JSON string
   *
   * @return JSON string
   */
