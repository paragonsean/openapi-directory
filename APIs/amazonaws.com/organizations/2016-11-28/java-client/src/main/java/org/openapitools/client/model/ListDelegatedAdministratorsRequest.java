...
public class ListDelegatedAdministratorsRequest {
  ...
  public ListDelegatedAdministratorsRequest servicePrincipal(String servicePrincipal) {
  ...
  public ListDelegatedAdministratorsRequest nextToken(String nextToken) {
  ...
  public ListDelegatedAdministratorsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.servicePrincipal, listDelegatedAdministratorsRequest.servicePrincipal) &&
        Objects.equals(this.nextToken, listDelegatedAdministratorsRequest.nextToken) &&
        Objects.equals(this.maxResults, listDelegatedAdministratorsRequest.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(servicePrincipal, nextToken, maxResults);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListDelegatedAdministratorsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDelegatedAdministratorsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListDelegatedAdministratorsRequest is not found in the empty JSON string", ListDelegatedAdministratorsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDelegatedAdministratorsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListDelegatedAdministratorsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDelegatedAdministratorsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDelegatedAdministratorsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDelegatedAdministratorsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDelegatedAdministratorsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDelegatedAdministratorsRequest>() {
           @Override
           public void write(JsonWriter out, ListDelegatedAdministratorsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDelegatedAdministratorsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListDelegatedAdministratorsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListDelegatedAdministratorsRequest
   * @throws IOException if the JSON string is invalid with respect to ListDelegatedAdministratorsRequest
   */
  public static ListDelegatedAdministratorsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDelegatedAdministratorsRequest.class);
  }

  /**
   * Convert an instance of ListDelegatedAdministratorsRequest to an JSON string
   *
   * @return JSON string
   */
