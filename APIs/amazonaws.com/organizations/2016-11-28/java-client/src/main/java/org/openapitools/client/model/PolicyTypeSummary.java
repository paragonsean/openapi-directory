...
import org.openapitools.client.model.PolicyTypeStatus;
...
public class PolicyTypeSummary {
  ...
  public PolicyTypeSummary type(PolicyType type) {
    this.type = type;
    return this;
  }
  ...
  public PolicyTypeSummary status(PolicyTypeStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PolicyTypeSummary policyTypeSummary = (PolicyTypeSummary) o;
    return Objects.equals(this.type, policyTypeSummary.type) &&
        Objects.equals(this.status, policyTypeSummary.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class PolicyTypeSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyTypeSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyTypeSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyTypeSummary is not found in the empty JSON string", PolicyTypeSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyTypeSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyTypeSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Status") != null && !jsonObj.get("Status").isJsonNull()) {
        PolicyTypeStatus.validateJsonElement(jsonObj.get("Status"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyTypeSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyTypeSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyTypeSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyTypeSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyTypeSummary>() {
           @Override
           public void write(JsonWriter out, PolicyTypeSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyTypeSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyTypeSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyTypeSummary
   * @throws IOException if the JSON string is invalid with respect to PolicyTypeSummary
   */
  public static PolicyTypeSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyTypeSummary.class);
  }

  /**
   * Convert an instance of PolicyTypeSummary to an JSON string
   *
   * @return JSON string
   */
