...
/**
 * Gets or Sets HandshakeResourceType
 */
@JsonAdapter(HandshakeResourceType.Adapter.class)
public enum HandshakeResourceType {
  ...
  HandshakeResourceType(String value) {
    this.value = value;
  }
  ...
  public static HandshakeResourceType fromValue(String value) {
    for (HandshakeResourceType b : HandshakeResourceType.values()) {
  ...
  public static class Adapter extends TypeAdapter<HandshakeResourceType> {
    @Override
    public void write(final JsonWriter jsonWriter, final HandshakeResourceType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public HandshakeResourceType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return HandshakeResourceType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    HandshakeResourceType.fromValue(value);
  }
}
