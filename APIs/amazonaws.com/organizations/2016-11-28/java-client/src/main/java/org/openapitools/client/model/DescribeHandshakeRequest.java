...
public class DescribeHandshakeRequest {
  ...
  public DescribeHandshakeRequest() {
  }

  public DescribeHandshakeRequest handshakeId(String handshakeId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeHandshakeRequest describeHandshakeRequest = (DescribeHandshakeRequest) o;
    return Objects.equals(this.handshakeId, describeHandshakeRequest.handshakeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeHandshakeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeHandshakeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeHandshakeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeHandshakeRequest is not found in the empty JSON string", DescribeHandshakeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeHandshakeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeHandshakeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeHandshakeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeHandshakeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeHandshakeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeHandshakeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeHandshakeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeHandshakeRequest>() {
           @Override
           public void write(JsonWriter out, DescribeHandshakeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeHandshakeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeHandshakeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeHandshakeRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeHandshakeRequest
   */
  public static DescribeHandshakeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeHandshakeRequest.class);
  }

  /**
   * Convert an instance of DescribeHandshakeRequest to an JSON string
   *
   * @return JSON string
   */
