...
public class DescribeCreateAccountStatusResponseCreateAccountStatus {
  ...
  public DescribeCreateAccountStatusResponseCreateAccountStatus() {
  }

  public DescribeCreateAccountStatusResponseCreateAccountStatus id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DescribeCreateAccountStatusResponseCreateAccountStatus accountName(String accountName) {
  ...
  public DescribeCreateAccountStatusResponseCreateAccountStatus state(CreateAccountState state) {
    this.state = state;
    return this;
  }
  ...
  public DescribeCreateAccountStatusResponseCreateAccountStatus requestedTimestamp(OffsetDateTime requestedTimestamp) {
  ...
  public DescribeCreateAccountStatusResponseCreateAccountStatus completedTimestamp(OffsetDateTime completedTimestamp) {
  ...
  public DescribeCreateAccountStatusResponseCreateAccountStatus accountId(String accountId) {
  ...
  public DescribeCreateAccountStatusResponseCreateAccountStatus govCloudAccountId(String govCloudAccountId) {
  ...
  public DescribeCreateAccountStatusResponseCreateAccountStatus failureReason(CreateAccountFailureReason failureReason) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeCreateAccountStatusResponseCreateAccountStatus describeCreateAccountStatusResponseCreateAccountStatus = (DescribeCreateAccountStatusResponseCreateAccountStatus) o;
    return Objects.equals(this.id, describeCreateAccountStatusResponseCreateAccountStatus.id) &&
        Objects.equals(this.accountName, describeCreateAccountStatusResponseCreateAccountStatus.accountName) &&
        Objects.equals(this.state, describeCreateAccountStatusResponseCreateAccountStatus.state) &&
        Objects.equals(this.requestedTimestamp, describeCreateAccountStatusResponseCreateAccountStatus.requestedTimestamp) &&
        Objects.equals(this.completedTimestamp, describeCreateAccountStatusResponseCreateAccountStatus.completedTimestamp) &&
        Objects.equals(this.accountId, describeCreateAccountStatusResponseCreateAccountStatus.accountId) &&
        Objects.equals(this.govCloudAccountId, describeCreateAccountStatusResponseCreateAccountStatus.govCloudAccountId) &&
        Objects.equals(this.failureReason, describeCreateAccountStatusResponseCreateAccountStatus.failureReason);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeCreateAccountStatusResponseCreateAccountStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCreateAccountStatusResponseCreateAccountStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCreateAccountStatusResponseCreateAccountStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCreateAccountStatusResponseCreateAccountStatus is not found in the empty JSON string", DescribeCreateAccountStatusResponseCreateAccountStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCreateAccountStatusResponseCreateAccountStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCreateAccountStatusResponseCreateAccountStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCreateAccountStatusResponseCreateAccountStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCreateAccountStatusResponseCreateAccountStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCreateAccountStatusResponseCreateAccountStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCreateAccountStatusResponseCreateAccountStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCreateAccountStatusResponseCreateAccountStatus>() {
           @Override
           public void write(JsonWriter out, DescribeCreateAccountStatusResponseCreateAccountStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCreateAccountStatusResponseCreateAccountStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCreateAccountStatusResponseCreateAccountStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCreateAccountStatusResponseCreateAccountStatus
   * @throws IOException if the JSON string is invalid with respect to DescribeCreateAccountStatusResponseCreateAccountStatus
   */
  public static DescribeCreateAccountStatusResponseCreateAccountStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCreateAccountStatusResponseCreateAccountStatus.class);
  }

  /**
   * Convert an instance of DescribeCreateAccountStatusResponseCreateAccountStatus to an JSON string
   *
   * @return JSON string
   */
