...
public class DelegatedService {
  ...
  public DelegatedService servicePrincipal(String servicePrincipal) {
  ...
  public DelegatedService delegationEnabledDate(OffsetDateTime delegationEnabledDate) {
  ...
  public boolean equals(Object o) {
    ...
    DelegatedService delegatedService = (DelegatedService) o;
    return Objects.equals(this.servicePrincipal, delegatedService.servicePrincipal) &&
        Objects.equals(this.delegationEnabledDate, delegatedService.delegationEnabledDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(servicePrincipal, delegationEnabledDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DelegatedService {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DelegatedService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DelegatedService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DelegatedService is not found in the empty JSON string", DelegatedService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DelegatedService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DelegatedService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DelegatedService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DelegatedService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DelegatedService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DelegatedService.class));

       return (TypeAdapter<T>) new TypeAdapter<DelegatedService>() {
           @Override
           public void write(JsonWriter out, DelegatedService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DelegatedService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DelegatedService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DelegatedService
   * @throws IOException if the JSON string is invalid with respect to DelegatedService
   */
  public static DelegatedService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DelegatedService.class);
  }

  /**
   * Convert an instance of DelegatedService to an JSON string
   *
   * @return JSON string
   */
