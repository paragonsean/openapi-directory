...
public class AttachPolicyRequest {
  ...
  public AttachPolicyRequest policyId(String policyId) {
  ...
  public AttachPolicyRequest targetId(String targetId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.policyId, attachPolicyRequest.policyId) &&
        Objects.equals(this.targetId, attachPolicyRequest.targetId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttachPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttachPolicyRequest is not found in the empty JSON string", AttachPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttachPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttachPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AttachPolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttachPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttachPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttachPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttachPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AttachPolicyRequest>() {
           @Override
           public void write(JsonWriter out, AttachPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttachPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AttachPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AttachPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to AttachPolicyRequest
   */
  public static AttachPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttachPolicyRequest.class);
  }

  /**
   * Convert an instance of AttachPolicyRequest to an JSON string
   *
   * @return JSON string
   */
