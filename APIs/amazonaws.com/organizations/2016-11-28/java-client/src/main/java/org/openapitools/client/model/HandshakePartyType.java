...
/**
 * Gets or Sets HandshakePartyType
 */
@JsonAdapter(HandshakePartyType.Adapter.class)
public enum HandshakePartyType {
  ...
  HandshakePartyType(String value) {
    this.value = value;
  }
  ...
  public static HandshakePartyType fromValue(String value) {
    for (HandshakePartyType b : HandshakePartyType.values()) {
  ...
  public static class Adapter extends TypeAdapter<HandshakePartyType> {
    @Override
    public void write(final JsonWriter jsonWriter, final HandshakePartyType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public HandshakePartyType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return HandshakePartyType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    HandshakePartyType.fromValue(value);
  }
}
