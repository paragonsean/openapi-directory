...
public class PolicyTargetSummary {
  ...
  public PolicyTargetSummary targetId(String targetId) {
  ...
  public PolicyTargetSummary arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public PolicyTargetSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PolicyTargetSummary type(TargetType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PolicyTargetSummary policyTargetSummary = (PolicyTargetSummary) o;
    return Objects.equals(this.targetId, policyTargetSummary.targetId) &&
        Objects.equals(this.arn, policyTargetSummary.arn) &&
        Objects.equals(this.name, policyTargetSummary.name) &&
        Objects.equals(this.type, policyTargetSummary.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(targetId, arn, name, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PolicyTargetSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyTargetSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyTargetSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyTargetSummary is not found in the empty JSON string", PolicyTargetSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyTargetSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyTargetSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyTargetSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyTargetSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyTargetSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyTargetSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyTargetSummary>() {
           @Override
           public void write(JsonWriter out, PolicyTargetSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyTargetSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyTargetSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyTargetSummary
   * @throws IOException if the JSON string is invalid with respect to PolicyTargetSummary
   */
  public static PolicyTargetSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyTargetSummary.class);
  }

  /**
   * Convert an instance of PolicyTargetSummary to an JSON string
   *
   * @return JSON string
   */
