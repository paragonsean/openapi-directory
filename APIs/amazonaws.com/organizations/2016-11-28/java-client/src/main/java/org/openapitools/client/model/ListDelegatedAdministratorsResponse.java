...
public class ListDelegatedAdministratorsResponse {
  public static final String SERIALIZED_NAME_DELEGATED_ADMINISTRATORS = "DelegatedAdministrators";
  @SerializedName(SERIALIZED_NAME_DELEGATED_ADMINISTRATORS)
  ...
  public ListDelegatedAdministratorsResponse delegatedAdministrators(List delegatedAdministrators) {
  ...
  public List getDelegatedAdministrators() {
    return delegatedAdministrators;
  }

  public void setDelegatedAdministrators(List delegatedAdministrators) {
    this.delegatedAdministrators = delegatedAdministrators;
  }


  public ListDelegatedAdministratorsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListDelegatedAdministratorsResponse listDelegatedAdministratorsResponse = (ListDelegatedAdministratorsResponse) o;
    return Objects.equals(this.delegatedAdministrators, listDelegatedAdministratorsResponse.delegatedAdministrators) &&
        Objects.equals(this.nextToken, listDelegatedAdministratorsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(delegatedAdministrators, nextToken);
  }
  ...
  static {
    ...
    openapiFields.add("DelegatedAdministrators");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListDelegatedAdministratorsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDelegatedAdministratorsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListDelegatedAdministratorsResponse is not found in the empty JSON string", ListDelegatedAdministratorsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDelegatedAdministratorsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListDelegatedAdministratorsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `DelegatedAdministrators`
      if (jsonObj.get("DelegatedAdministrators") != null && !jsonObj.get("DelegatedAdministrators").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("DelegatedAdministrators"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDelegatedAdministratorsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDelegatedAdministratorsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDelegatedAdministratorsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDelegatedAdministratorsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDelegatedAdministratorsResponse>() {
           @Override
           public void write(JsonWriter out, ListDelegatedAdministratorsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDelegatedAdministratorsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListDelegatedAdministratorsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListDelegatedAdministratorsResponse
   * @throws IOException if the JSON string is invalid with respect to ListDelegatedAdministratorsResponse
   */
  public static ListDelegatedAdministratorsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDelegatedAdministratorsResponse.class);
  }

  /**
   * Convert an instance of ListDelegatedAdministratorsResponse to an JSON string
   *
   * @return JSON string
   */
