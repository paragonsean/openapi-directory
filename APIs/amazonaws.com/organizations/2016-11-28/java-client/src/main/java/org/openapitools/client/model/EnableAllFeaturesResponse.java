...
import org.openapitools.client.model.EnableAllFeaturesResponseHandshake;
...
public class EnableAllFeaturesResponse {
  ...
  private EnableAllFeaturesResponseHandshake handshake;

  public EnableAllFeaturesResponse() {
  }

  public EnableAllFeaturesResponse handshake(EnableAllFeaturesResponseHandshake handshake) {
  ...
  public EnableAllFeaturesResponseHandshake getHandshake() {
    return handshake;
  }

  public void setHandshake(EnableAllFeaturesResponseHandshake handshake) {
    this.handshake = handshake;
  }
  ...
  public boolean equals(Object o) {
    ...
    EnableAllFeaturesResponse enableAllFeaturesResponse = (EnableAllFeaturesResponse) o;
    return Objects.equals(this.handshake, enableAllFeaturesResponse.handshake);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnableAllFeaturesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnableAllFeaturesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnableAllFeaturesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnableAllFeaturesResponse is not found in the empty JSON string", EnableAllFeaturesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnableAllFeaturesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnableAllFeaturesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Handshake`
      if (jsonObj.get("Handshake") != null && !jsonObj.get("Handshake").isJsonNull()) {
        EnableAllFeaturesResponseHandshake.validateJsonElement(jsonObj.get("Handshake"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnableAllFeaturesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnableAllFeaturesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnableAllFeaturesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnableAllFeaturesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EnableAllFeaturesResponse>() {
           @Override
           public void write(JsonWriter out, EnableAllFeaturesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnableAllFeaturesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EnableAllFeaturesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnableAllFeaturesResponse
   * @throws IOException if the JSON string is invalid with respect to EnableAllFeaturesResponse
   */
  public static EnableAllFeaturesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnableAllFeaturesResponse.class);
  }

  /**
   * Convert an instance of EnableAllFeaturesResponse to an JSON string
   *
   * @return JSON string
   */
