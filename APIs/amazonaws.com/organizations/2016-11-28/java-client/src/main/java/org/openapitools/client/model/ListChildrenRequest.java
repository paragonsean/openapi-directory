...
import org.openapitools.client.model.ChildType;
...
public class ListChildrenRequest {
  ...
  public ListChildrenRequest parentId(String parentId) {
  ...
  public ListChildrenRequest childType(ChildType childType) {
  ...
  public ListChildrenRequest nextToken(String nextToken) {
  ...
  public ListChildrenRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListChildrenRequest listChildrenRequest = (ListChildrenRequest) o;
    return Objects.equals(this.parentId, listChildrenRequest.parentId) &&
        Objects.equals(this.childType, listChildrenRequest.childType) &&
        Objects.equals(this.nextToken, listChildrenRequest.nextToken) &&
        Objects.equals(this.maxResults, listChildrenRequest.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(parentId, childType, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListChildrenRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("ChildType");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListChildrenRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListChildrenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListChildrenRequest is not found in the empty JSON string", ListChildrenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListChildrenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListChildrenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListChildrenRequest.openapiRequiredFields) {
      ...
      // validate the required field `ChildType`
      ChildType.validateJsonElement(jsonObj.get("ChildType"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListChildrenRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListChildrenRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListChildrenRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListChildrenRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListChildrenRequest>() {
           @Override
           public void write(JsonWriter out, ListChildrenRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListChildrenRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListChildrenRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListChildrenRequest
   * @throws IOException if the JSON string is invalid with respect to ListChildrenRequest
   */
  public static ListChildrenRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListChildrenRequest.class);
  }

  /**
   * Convert an instance of ListChildrenRequest to an JSON string
   *
   * @return JSON string
   */
