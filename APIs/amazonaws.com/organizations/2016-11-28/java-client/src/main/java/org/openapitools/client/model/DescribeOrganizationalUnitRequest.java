...
public class DescribeOrganizationalUnitRequest {
  ...
  public DescribeOrganizationalUnitRequest() {
  }

  public DescribeOrganizationalUnitRequest organizationalUnitId(String organizationalUnitId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.organizationalUnitId, describeOrganizationalUnitRequest.organizationalUnitId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeOrganizationalUnitRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeOrganizationalUnitRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeOrganizationalUnitRequest is not found in the empty JSON string", DescribeOrganizationalUnitRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeOrganizationalUnitRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeOrganizationalUnitRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeOrganizationalUnitRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeOrganizationalUnitRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeOrganizationalUnitRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeOrganizationalUnitRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeOrganizationalUnitRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeOrganizationalUnitRequest>() {
           @Override
           public void write(JsonWriter out, DescribeOrganizationalUnitRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeOrganizationalUnitRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeOrganizationalUnitRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeOrganizationalUnitRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeOrganizationalUnitRequest
   */
  public static DescribeOrganizationalUnitRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeOrganizationalUnitRequest.class);
  }

  /**
   * Convert an instance of DescribeOrganizationalUnitRequest to an JSON string
   *
   * @return JSON string
   */
