...
public class AcceptHandshakeRequest {
  ...
  public AcceptHandshakeRequest handshakeId(String handshakeId) {
  ...
  public boolean equals(Object o) {
    ...
    AcceptHandshakeRequest acceptHandshakeRequest = (AcceptHandshakeRequest) o;
    return Objects.equals(this.handshakeId, acceptHandshakeRequest.handshakeId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AcceptHandshakeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AcceptHandshakeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AcceptHandshakeRequest is not found in the empty JSON string", AcceptHandshakeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AcceptHandshakeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AcceptHandshakeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AcceptHandshakeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AcceptHandshakeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AcceptHandshakeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AcceptHandshakeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AcceptHandshakeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AcceptHandshakeRequest>() {
           @Override
           public void write(JsonWriter out, AcceptHandshakeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AcceptHandshakeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AcceptHandshakeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AcceptHandshakeRequest
   * @throws IOException if the JSON string is invalid with respect to AcceptHandshakeRequest
   */
  public static AcceptHandshakeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AcceptHandshakeRequest.class);
  }

  /**
   * Convert an instance of AcceptHandshakeRequest to an JSON string
   *
   * @return JSON string
   */
