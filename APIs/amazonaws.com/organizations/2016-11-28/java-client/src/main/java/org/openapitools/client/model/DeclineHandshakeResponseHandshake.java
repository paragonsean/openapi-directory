...
public class DeclineHandshakeResponseHandshake {
  ...
  public DeclineHandshakeResponseHandshake() {
  }

  public DeclineHandshakeResponseHandshake id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DeclineHandshakeResponseHandshake arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DeclineHandshakeResponseHandshake parties(List parties) {
  ...
  public DeclineHandshakeResponseHandshake state(HandshakeState state) {
    this.state = state;
    return this;
  }
  ...
  public DeclineHandshakeResponseHandshake requestedTimestamp(OffsetDateTime requestedTimestamp) {
  ...
  public DeclineHandshakeResponseHandshake expirationTimestamp(OffsetDateTime expirationTimestamp) {
  ...
  public DeclineHandshakeResponseHandshake action(ActionType action) {
    this.action = action;
    return this;
  }
  ...
  public DeclineHandshakeResponseHandshake resources(List resources) {
  ...
  public boolean equals(Object o) {
    ...
    DeclineHandshakeResponseHandshake declineHandshakeResponseHandshake = (DeclineHandshakeResponseHandshake) o;
    return Objects.equals(this.id, declineHandshakeResponseHandshake.id) &&
        Objects.equals(this.arn, declineHandshakeResponseHandshake.arn) &&
        Objects.equals(this.parties, declineHandshakeResponseHandshake.parties) &&
        Objects.equals(this.state, declineHandshakeResponseHandshake.state) &&
        Objects.equals(this.requestedTimestamp, declineHandshakeResponseHandshake.requestedTimestamp) &&
        Objects.equals(this.expirationTimestamp, declineHandshakeResponseHandshake.expirationTimestamp) &&
        Objects.equals(this.action, declineHandshakeResponseHandshake.action) &&
        Objects.equals(this.resources, declineHandshakeResponseHandshake.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeclineHandshakeResponseHandshake {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeclineHandshakeResponseHandshake
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeclineHandshakeResponseHandshake.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeclineHandshakeResponseHandshake is not found in the empty JSON string", DeclineHandshakeResponseHandshake.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeclineHandshakeResponseHandshake.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeclineHandshakeResponseHandshake` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeclineHandshakeResponseHandshake.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeclineHandshakeResponseHandshake' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeclineHandshakeResponseHandshake> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeclineHandshakeResponseHandshake.class));

       return (TypeAdapter<T>) new TypeAdapter<DeclineHandshakeResponseHandshake>() {
           @Override
           public void write(JsonWriter out, DeclineHandshakeResponseHandshake value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeclineHandshakeResponseHandshake read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeclineHandshakeResponseHandshake given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeclineHandshakeResponseHandshake
   * @throws IOException if the JSON string is invalid with respect to DeclineHandshakeResponseHandshake
   */
  public static DeclineHandshakeResponseHandshake fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeclineHandshakeResponseHandshake.class);
  }

  /**
   * Convert an instance of DeclineHandshakeResponseHandshake to an JSON string
   *
   * @return JSON string
   */
