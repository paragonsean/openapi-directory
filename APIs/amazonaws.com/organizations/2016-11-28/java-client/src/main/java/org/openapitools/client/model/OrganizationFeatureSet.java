...
/**
 * Gets or Sets OrganizationFeatureSet
 */
@JsonAdapter(OrganizationFeatureSet.Adapter.class)
public enum OrganizationFeatureSet {
  ...
  OrganizationFeatureSet(String value) {
    this.value = value;
  }
  ...
  public static OrganizationFeatureSet fromValue(String value) {
    for (OrganizationFeatureSet b : OrganizationFeatureSet.values()) {
  ...
  public static class Adapter extends TypeAdapter<OrganizationFeatureSet> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrganizationFeatureSet enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrganizationFeatureSet read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrganizationFeatureSet.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OrganizationFeatureSet.fromValue(value);
  }
}
