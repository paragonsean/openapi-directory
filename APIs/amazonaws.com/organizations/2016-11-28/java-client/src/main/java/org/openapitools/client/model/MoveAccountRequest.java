...
public class MoveAccountRequest {
  ...
  public static final String SERIALIZED_NAME_SOURCE_PARENT_ID = "SourceParentId";
  @SerializedName(SERIALIZED_NAME_SOURCE_PARENT_ID)
  private String sourceParentId;

  public static final String SERIALIZED_NAME_DESTINATION_PARENT_ID = "DestinationParentId";
  @SerializedName(SERIALIZED_NAME_DESTINATION_PARENT_ID)
  private String destinationParentId;

  public MoveAccountRequest() {
  }

  public MoveAccountRequest accountId(String accountId) {
  ...
  public MoveAccountRequest sourceParentId(String sourceParentId) {
  ...
  public MoveAccountRequest destinationParentId(String destinationParentId) {
  ...
  public boolean equals(Object o) {
    ...
    MoveAccountRequest moveAccountRequest = (MoveAccountRequest) o;
    return Objects.equals(this.accountId, moveAccountRequest.accountId) &&
        Objects.equals(this.sourceParentId, moveAccountRequest.sourceParentId) &&
        Objects.equals(this.destinationParentId, moveAccountRequest.destinationParentId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, sourceParentId, destinationParentId);
  }
  ...
  static {
    ...
    openapiFields.add("SourceParentId");
    openapiFields.add("DestinationParentId");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("AccountId");
    openapiRequiredFields.add("SourceParentId");
    openapiRequiredFields.add("DestinationParentId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MoveAccountRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MoveAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MoveAccountRequest is not found in the empty JSON string", MoveAccountRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MoveAccountRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MoveAccountRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MoveAccountRequest.openapiRequiredFields) {
      ...
      // validate the required field `SourceParentId`
      String.validateJsonElement(jsonObj.get("SourceParentId"));
      // validate the required field `DestinationParentId`
      String.validateJsonElement(jsonObj.get("DestinationParentId"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MoveAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MoveAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MoveAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MoveAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<MoveAccountRequest>() {
           @Override
           public void write(JsonWriter out, MoveAccountRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MoveAccountRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MoveAccountRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MoveAccountRequest
   * @throws IOException if the JSON string is invalid with respect to MoveAccountRequest
   */
  public static MoveAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MoveAccountRequest.class);
  }

  /**
   * Convert an instance of MoveAccountRequest to an JSON string
   *
   * @return JSON string
   */
