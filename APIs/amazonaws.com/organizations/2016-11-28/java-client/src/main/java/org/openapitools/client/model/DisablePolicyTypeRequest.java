...
public class DisablePolicyTypeRequest {
  ...
  public DisablePolicyTypeRequest rootId(String rootId) {
    this.rootId = rootId;
    return this;
  }
  ...
  public DisablePolicyTypeRequest policyType(PolicyType policyType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rootId, disablePolicyTypeRequest.rootId) &&
        Objects.equals(this.policyType, disablePolicyTypeRequest.policyType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rootId, policyType);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("RootId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisablePolicyTypeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisablePolicyTypeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisablePolicyTypeRequest is not found in the empty JSON string", DisablePolicyTypeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisablePolicyTypeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisablePolicyTypeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisablePolicyTypeRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `RootId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisablePolicyTypeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisablePolicyTypeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisablePolicyTypeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisablePolicyTypeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DisablePolicyTypeRequest>() {
           @Override
           public void write(JsonWriter out, DisablePolicyTypeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisablePolicyTypeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisablePolicyTypeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisablePolicyTypeRequest
   * @throws IOException if the JSON string is invalid with respect to DisablePolicyTypeRequest
   */
  public static DisablePolicyTypeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisablePolicyTypeRequest.class);
  }

  /**
   * Convert an instance of DisablePolicyTypeRequest to an JSON string
   *
   * @return JSON string
   */
