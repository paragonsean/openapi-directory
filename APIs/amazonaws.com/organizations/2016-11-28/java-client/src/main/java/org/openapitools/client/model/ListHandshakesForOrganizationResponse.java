...
public class ListHandshakesForOrganizationResponse {
  ...
  public ListHandshakesForOrganizationResponse handshakes(List handshakes) {
  ...
  public ListHandshakesForOrganizationResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListHandshakesForOrganizationResponse listHandshakesForOrganizationResponse = (ListHandshakesForOrganizationResponse) o;
    return Objects.equals(this.handshakes, listHandshakesForOrganizationResponse.handshakes) &&
        Objects.equals(this.nextToken, listHandshakesForOrganizationResponse.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListHandshakesForOrganizationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListHandshakesForOrganizationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListHandshakesForOrganizationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListHandshakesForOrganizationResponse is not found in the empty JSON string", ListHandshakesForOrganizationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListHandshakesForOrganizationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListHandshakesForOrganizationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListHandshakesForOrganizationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListHandshakesForOrganizationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListHandshakesForOrganizationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListHandshakesForOrganizationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListHandshakesForOrganizationResponse>() {
           @Override
           public void write(JsonWriter out, ListHandshakesForOrganizationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListHandshakesForOrganizationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListHandshakesForOrganizationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListHandshakesForOrganizationResponse
   * @throws IOException if the JSON string is invalid with respect to ListHandshakesForOrganizationResponse
   */
  public static ListHandshakesForOrganizationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListHandshakesForOrganizationResponse.class);
  }

  /**
   * Convert an instance of ListHandshakesForOrganizationResponse to an JSON string
   *
   * @return JSON string
   */
