...
public class ListHandshakesForAccountRequest {
  ...
  private ListHandshakesForAccountRequestFilter filter;
  ...
  public ListHandshakesForAccountRequest filter(ListHandshakesForAccountRequestFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ListHandshakesForAccountRequestFilter getFilter() {
    return filter;
  }

  public void setFilter(ListHandshakesForAccountRequestFilter filter) {
    this.filter = filter;
  }


  public ListHandshakesForAccountRequest nextToken(String nextToken) {
  ...
  public ListHandshakesForAccountRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListHandshakesForAccountRequest listHandshakesForAccountRequest = (ListHandshakesForAccountRequest) o;
    return Objects.equals(this.filter, listHandshakesForAccountRequest.filter) &&
        Objects.equals(this.nextToken, listHandshakesForAccountRequest.nextToken) &&
        Objects.equals(this.maxResults, listHandshakesForAccountRequest.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListHandshakesForAccountRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListHandshakesForAccountRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListHandshakesForAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListHandshakesForAccountRequest is not found in the empty JSON string", ListHandshakesForAccountRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListHandshakesForAccountRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListHandshakesForAccountRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Filter`
      if (jsonObj.get("Filter") != null && !jsonObj.get("Filter").isJsonNull()) {
        ListHandshakesForAccountRequestFilter.validateJsonElement(jsonObj.get("Filter"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListHandshakesForAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListHandshakesForAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListHandshakesForAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListHandshakesForAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListHandshakesForAccountRequest>() {
           @Override
           public void write(JsonWriter out, ListHandshakesForAccountRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListHandshakesForAccountRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListHandshakesForAccountRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListHandshakesForAccountRequest
   * @throws IOException if the JSON string is invalid with respect to ListHandshakesForAccountRequest
   */
  public static ListHandshakesForAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListHandshakesForAccountRequest.class);
  }

  /**
   * Convert an instance of ListHandshakesForAccountRequest to an JSON string
   *
   * @return JSON string
   */
