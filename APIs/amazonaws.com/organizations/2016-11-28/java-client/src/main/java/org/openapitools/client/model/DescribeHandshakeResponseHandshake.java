...
public class DescribeHandshakeResponseHandshake {
  ...
  public DescribeHandshakeResponseHandshake() {
  }

  public DescribeHandshakeResponseHandshake id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DescribeHandshakeResponseHandshake arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DescribeHandshakeResponseHandshake parties(List parties) {
  ...
  public DescribeHandshakeResponseHandshake state(HandshakeState state) {
    this.state = state;
    return this;
  }
  ...
  public DescribeHandshakeResponseHandshake requestedTimestamp(OffsetDateTime requestedTimestamp) {
  ...
  public DescribeHandshakeResponseHandshake expirationTimestamp(OffsetDateTime expirationTimestamp) {
  ...
  public DescribeHandshakeResponseHandshake action(ActionType action) {
    this.action = action;
    return this;
  }
  ...
  public DescribeHandshakeResponseHandshake resources(List resources) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeHandshakeResponseHandshake describeHandshakeResponseHandshake = (DescribeHandshakeResponseHandshake) o;
    return Objects.equals(this.id, describeHandshakeResponseHandshake.id) &&
        Objects.equals(this.arn, describeHandshakeResponseHandshake.arn) &&
        Objects.equals(this.parties, describeHandshakeResponseHandshake.parties) &&
        Objects.equals(this.state, describeHandshakeResponseHandshake.state) &&
        Objects.equals(this.requestedTimestamp, describeHandshakeResponseHandshake.requestedTimestamp) &&
        Objects.equals(this.expirationTimestamp, describeHandshakeResponseHandshake.expirationTimestamp) &&
        Objects.equals(this.action, describeHandshakeResponseHandshake.action) &&
        Objects.equals(this.resources, describeHandshakeResponseHandshake.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeHandshakeResponseHandshake {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeHandshakeResponseHandshake
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeHandshakeResponseHandshake.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeHandshakeResponseHandshake is not found in the empty JSON string", DescribeHandshakeResponseHandshake.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeHandshakeResponseHandshake.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeHandshakeResponseHandshake` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeHandshakeResponseHandshake.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeHandshakeResponseHandshake' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeHandshakeResponseHandshake> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeHandshakeResponseHandshake.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeHandshakeResponseHandshake>() {
           @Override
           public void write(JsonWriter out, DescribeHandshakeResponseHandshake value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeHandshakeResponseHandshake read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeHandshakeResponseHandshake given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeHandshakeResponseHandshake
   * @throws IOException if the JSON string is invalid with respect to DescribeHandshakeResponseHandshake
   */
  public static DescribeHandshakeResponseHandshake fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeHandshakeResponseHandshake.class);
  }

  /**
   * Convert an instance of DescribeHandshakeResponseHandshake to an JSON string
   *
   * @return JSON string
   */
