...
import org.openapitools.client.model.UpdateOrganizationalUnitResponseOrganizationalUnit;
...
public class UpdateOrganizationalUnitResponse {
  ...
  private UpdateOrganizationalUnitResponseOrganizationalUnit organizationalUnit;

  public UpdateOrganizationalUnitResponse() {
  }

  public UpdateOrganizationalUnitResponse organizationalUnit(UpdateOrganizationalUnitResponseOrganizationalUnit organizationalUnit) {
  ...
  public UpdateOrganizationalUnitResponseOrganizationalUnit getOrganizationalUnit() {
    return organizationalUnit;
  }

  public void setOrganizationalUnit(UpdateOrganizationalUnitResponseOrganizationalUnit organizationalUnit) {
    this.organizationalUnit = organizationalUnit;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateOrganizationalUnitResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateOrganizationalUnitResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateOrganizationalUnitResponse is not found in the empty JSON string", UpdateOrganizationalUnitResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateOrganizationalUnitResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateOrganizationalUnitResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("OrganizationalUnit") != null && !jsonObj.get("OrganizationalUnit").isJsonNull()) {
        UpdateOrganizationalUnitResponseOrganizationalUnit.validateJsonElement(jsonObj.get("OrganizationalUnit"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateOrganizationalUnitResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateOrganizationalUnitResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateOrganizationalUnitResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateOrganizationalUnitResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateOrganizationalUnitResponse>() {
           @Override
           public void write(JsonWriter out, UpdateOrganizationalUnitResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateOrganizationalUnitResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateOrganizationalUnitResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateOrganizationalUnitResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateOrganizationalUnitResponse
   */
  public static UpdateOrganizationalUnitResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateOrganizationalUnitResponse.class);
  }

  /**
   * Convert an instance of UpdateOrganizationalUnitResponse to an JSON string
   *
   * @return JSON string
   */
