...
public class CreateGovCloudAccountRequest {
  ...
  public CreateGovCloudAccountRequest() {
  }

  public CreateGovCloudAccountRequest email(String email) {
    this.email = email;
    return this;
  }
  ...
  public CreateGovCloudAccountRequest accountName(String accountName) {
  ...
  public CreateGovCloudAccountRequest roleName(String roleName) {
  ...
  public CreateGovCloudAccountRequest iamUserAccessToBilling(IAMUserAccessToBilling iamUserAccessToBilling) {
  ...
  public CreateGovCloudAccountRequest tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateGovCloudAccountRequest createGovCloudAccountRequest = (CreateGovCloudAccountRequest) o;
    return Objects.equals(this.email, createGovCloudAccountRequest.email) &&
        Objects.equals(this.accountName, createGovCloudAccountRequest.accountName) &&
        Objects.equals(this.roleName, createGovCloudAccountRequest.roleName) &&
        Objects.equals(this.iamUserAccessToBilling, createGovCloudAccountRequest.iamUserAccessToBilling) &&
        Objects.equals(this.tags, createGovCloudAccountRequest.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateGovCloudAccountRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGovCloudAccountRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGovCloudAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGovCloudAccountRequest is not found in the empty JSON string", CreateGovCloudAccountRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateGovCloudAccountRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateGovCloudAccountRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateGovCloudAccountRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGovCloudAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGovCloudAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGovCloudAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGovCloudAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGovCloudAccountRequest>() {
           @Override
           public void write(JsonWriter out, CreateGovCloudAccountRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGovCloudAccountRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGovCloudAccountRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGovCloudAccountRequest
   * @throws IOException if the JSON string is invalid with respect to CreateGovCloudAccountRequest
   */
  public static CreateGovCloudAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGovCloudAccountRequest.class);
  }

  /**
   * Convert an instance of CreateGovCloudAccountRequest to an JSON string
   *
   * @return JSON string
   */
