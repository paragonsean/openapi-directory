...
public class RegisterDelegatedAdministratorRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegisterDelegatedAdministratorRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegisterDelegatedAdministratorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegisterDelegatedAdministratorRequest is not found in the empty JSON string", RegisterDelegatedAdministratorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegisterDelegatedAdministratorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegisterDelegatedAdministratorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RegisterDelegatedAdministratorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegisterDelegatedAdministratorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegisterDelegatedAdministratorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegisterDelegatedAdministratorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegisterDelegatedAdministratorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RegisterDelegatedAdministratorRequest>() {
           @Override
           public void write(JsonWriter out, RegisterDelegatedAdministratorRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegisterDelegatedAdministratorRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegisterDelegatedAdministratorRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegisterDelegatedAdministratorRequest
   * @throws IOException if the JSON string is invalid with respect to RegisterDelegatedAdministratorRequest
   */
  public static RegisterDelegatedAdministratorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegisterDelegatedAdministratorRequest.class);
  }

  /**
   * Convert an instance of RegisterDelegatedAdministratorRequest to an JSON string
   *
   * @return JSON string
   */
