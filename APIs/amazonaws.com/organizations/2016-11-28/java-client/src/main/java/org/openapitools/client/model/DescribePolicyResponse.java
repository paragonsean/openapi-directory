...
import org.openapitools.client.model.DescribePolicyResponsePolicy;
...
public class DescribePolicyResponse {
  ...
  private DescribePolicyResponsePolicy policy;

  public DescribePolicyResponse() {
  }

  public DescribePolicyResponse policy(DescribePolicyResponsePolicy policy) {
    this.policy = policy;
    return this;
  }
  ...
  public DescribePolicyResponsePolicy getPolicy() {
    return policy;
  }

  public void setPolicy(DescribePolicyResponsePolicy policy) {
    this.policy = policy;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribePolicyResponse describePolicyResponse = (DescribePolicyResponse) o;
    return Objects.equals(this.policy, describePolicyResponse.policy);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribePolicyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribePolicyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribePolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribePolicyResponse is not found in the empty JSON string", DescribePolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribePolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribePolicyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Policy`
      if (jsonObj.get("Policy") != null && !jsonObj.get("Policy").isJsonNull()) {
        DescribePolicyResponsePolicy.validateJsonElement(jsonObj.get("Policy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribePolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribePolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribePolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribePolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribePolicyResponse>() {
           @Override
           public void write(JsonWriter out, DescribePolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribePolicyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribePolicyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribePolicyResponse
   * @throws IOException if the JSON string is invalid with respect to DescribePolicyResponse
   */
  public static DescribePolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribePolicyResponse.class);
  }

  /**
   * Convert an instance of DescribePolicyResponse to an JSON string
   *
   * @return JSON string
   */
