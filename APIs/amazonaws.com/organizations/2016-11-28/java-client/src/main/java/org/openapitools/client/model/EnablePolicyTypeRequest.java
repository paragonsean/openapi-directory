...
public class EnablePolicyTypeRequest {
  ...
  public EnablePolicyTypeRequest rootId(String rootId) {
    this.rootId = rootId;
    return this;
  }
  ...
  public EnablePolicyTypeRequest policyType(PolicyType policyType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rootId, enablePolicyTypeRequest.rootId) &&
        Objects.equals(this.policyType, enablePolicyTypeRequest.policyType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnablePolicyTypeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnablePolicyTypeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnablePolicyTypeRequest is not found in the empty JSON string", EnablePolicyTypeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnablePolicyTypeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnablePolicyTypeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EnablePolicyTypeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnablePolicyTypeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnablePolicyTypeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnablePolicyTypeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnablePolicyTypeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EnablePolicyTypeRequest>() {
           @Override
           public void write(JsonWriter out, EnablePolicyTypeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnablePolicyTypeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EnablePolicyTypeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnablePolicyTypeRequest
   * @throws IOException if the JSON string is invalid with respect to EnablePolicyTypeRequest
   */
  public static EnablePolicyTypeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnablePolicyTypeRequest.class);
  }

  /**
   * Convert an instance of EnablePolicyTypeRequest to an JSON string
   *
   * @return JSON string
   */
