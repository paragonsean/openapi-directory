...
public class DescribeCreateAccountStatusRequest {
  public static final String SERIALIZED_NAME_CREATE_ACCOUNT_REQUEST_ID = "CreateAccountRequestId";
  @SerializedName(SERIALIZED_NAME_CREATE_ACCOUNT_REQUEST_ID)
  private String createAccountRequestId;

  public DescribeCreateAccountStatusRequest() {
  }

  public DescribeCreateAccountStatusRequest createAccountRequestId(String createAccountRequestId) {
    this.createAccountRequestId = createAccountRequestId;
    return this;
  }

  /**
   * Get createAccountRequestId
  ...
  public boolean equals(Object o) {
    ...
    DescribeCreateAccountStatusRequest describeCreateAccountStatusRequest = (DescribeCreateAccountStatusRequest) o;
    return Objects.equals(this.createAccountRequestId, describeCreateAccountStatusRequest.createAccountRequestId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createAccountRequestId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeCreateAccountStatusRequest {\n");
    sb.append("    createAccountRequestId: ").append(toIndentedString(createAccountRequestId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("CreateAccountRequestId");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("CreateAccountRequestId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCreateAccountStatusRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCreateAccountStatusRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCreateAccountStatusRequest is not found in the empty JSON string", DescribeCreateAccountStatusRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCreateAccountStatusRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCreateAccountStatusRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeCreateAccountStatusRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `CreateAccountRequestId`
      String.validateJsonElement(jsonObj.get("CreateAccountRequestId"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCreateAccountStatusRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCreateAccountStatusRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCreateAccountStatusRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCreateAccountStatusRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCreateAccountStatusRequest>() {
           @Override
           public void write(JsonWriter out, DescribeCreateAccountStatusRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCreateAccountStatusRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCreateAccountStatusRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCreateAccountStatusRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeCreateAccountStatusRequest
   */
  public static DescribeCreateAccountStatusRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCreateAccountStatusRequest.class);
  }

  /**
   * Convert an instance of DescribeCreateAccountStatusRequest to an JSON string
   *
   * @return JSON string
   */
