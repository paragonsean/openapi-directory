...
public class ListCreateAccountStatusRequest {
  ...
  public ListCreateAccountStatusRequest() {
  }

  public ListCreateAccountStatusRequest states(List states) {
    this.states = states;
    return this;
  }
  ...
  public ListCreateAccountStatusRequest nextToken(String nextToken) {
  ...
  public ListCreateAccountStatusRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListCreateAccountStatusRequest listCreateAccountStatusRequest = (ListCreateAccountStatusRequest) o;
    return Objects.equals(this.states, listCreateAccountStatusRequest.states) &&
        Objects.equals(this.nextToken, listCreateAccountStatusRequest.nextToken) &&
        Objects.equals(this.maxResults, listCreateAccountStatusRequest.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(states, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListCreateAccountStatusRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListCreateAccountStatusRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListCreateAccountStatusRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListCreateAccountStatusRequest is not found in the empty JSON string", ListCreateAccountStatusRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListCreateAccountStatusRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListCreateAccountStatusRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListCreateAccountStatusRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListCreateAccountStatusRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListCreateAccountStatusRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListCreateAccountStatusRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListCreateAccountStatusRequest>() {
           @Override
           public void write(JsonWriter out, ListCreateAccountStatusRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListCreateAccountStatusRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListCreateAccountStatusRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListCreateAccountStatusRequest
   * @throws IOException if the JSON string is invalid with respect to ListCreateAccountStatusRequest
   */
  public static ListCreateAccountStatusRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListCreateAccountStatusRequest.class);
  }

  /**
   * Convert an instance of ListCreateAccountStatusRequest to an JSON string
   *
   * @return JSON string
   */
