...
public class EnableAWSServiceAccessRequest {
  ...
  public EnableAWSServiceAccessRequest() {
  }

  public EnableAWSServiceAccessRequest servicePrincipal(String servicePrincipal) {
  ...
  public boolean equals(Object o) {
    ...
    EnableAWSServiceAccessRequest enableAWSServiceAccessRequest = (EnableAWSServiceAccessRequest) o;
    return Objects.equals(this.servicePrincipal, enableAWSServiceAccessRequest.servicePrincipal);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnableAWSServiceAccessRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnableAWSServiceAccessRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnableAWSServiceAccessRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnableAWSServiceAccessRequest is not found in the empty JSON string", EnableAWSServiceAccessRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnableAWSServiceAccessRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnableAWSServiceAccessRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EnableAWSServiceAccessRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnableAWSServiceAccessRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnableAWSServiceAccessRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnableAWSServiceAccessRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnableAWSServiceAccessRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EnableAWSServiceAccessRequest>() {
           @Override
           public void write(JsonWriter out, EnableAWSServiceAccessRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnableAWSServiceAccessRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EnableAWSServiceAccessRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnableAWSServiceAccessRequest
   * @throws IOException if the JSON string is invalid with respect to EnableAWSServiceAccessRequest
   */
  public static EnableAWSServiceAccessRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnableAWSServiceAccessRequest.class);
  }

  /**
   * Convert an instance of EnableAWSServiceAccessRequest to an JSON string
   *
   * @return JSON string
   */
