...
public class AcceptHandshakeResponse {
  ...
  private AcceptHandshakeResponseHandshake handshake;

  public AcceptHandshakeResponse() {
  }

  public AcceptHandshakeResponse handshake(AcceptHandshakeResponseHandshake handshake) {
  ...
  public void setHandshake(AcceptHandshakeResponseHandshake handshake) {
    this.handshake = handshake;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AcceptHandshakeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AcceptHandshakeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AcceptHandshakeResponse is not found in the empty JSON string", AcceptHandshakeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AcceptHandshakeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AcceptHandshakeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Handshake`
      if (jsonObj.get("Handshake") != null && !jsonObj.get("Handshake").isJsonNull()) {
        AcceptHandshakeResponseHandshake.validateJsonElement(jsonObj.get("Handshake"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AcceptHandshakeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AcceptHandshakeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AcceptHandshakeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AcceptHandshakeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AcceptHandshakeResponse>() {
           @Override
           public void write(JsonWriter out, AcceptHandshakeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AcceptHandshakeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AcceptHandshakeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AcceptHandshakeResponse
   * @throws IOException if the JSON string is invalid with respect to AcceptHandshakeResponse
   */
  public static AcceptHandshakeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AcceptHandshakeResponse.class);
  }

  /**
   * Convert an instance of AcceptHandshakeResponse to an JSON string
   *
   * @return JSON string
   */
