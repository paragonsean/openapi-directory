...
public class HandshakeParty {
  ...
  public HandshakeParty id(String id) {
    this.id = id;
    return this;
  }
  ...
  public HandshakeParty type(HandshakePartyType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    HandshakeParty handshakeParty = (HandshakeParty) o;
    return Objects.equals(this.id, handshakeParty.id) &&
        Objects.equals(this.type, handshakeParty.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class HandshakeParty {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HandshakeParty
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HandshakeParty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HandshakeParty is not found in the empty JSON string", HandshakeParty.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HandshakeParty.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HandshakeParty` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HandshakeParty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HandshakeParty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HandshakeParty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HandshakeParty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HandshakeParty.class));

       return (TypeAdapter<T>) new TypeAdapter<HandshakeParty>() {
           @Override
           public void write(JsonWriter out, HandshakeParty value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HandshakeParty read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HandshakeParty given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HandshakeParty
   * @throws IOException if the JSON string is invalid with respect to HandshakeParty
   */
  public static HandshakeParty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HandshakeParty.class);
  }

  /**
   * Convert an instance of HandshakeParty to an JSON string
   *
   * @return JSON string
   */
