...
public class ListParentsResponse {
  ...
  public ListParentsResponse parents(List parents) {
  ...
  public ListParentsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListParentsResponse listParentsResponse = (ListParentsResponse) o;
    return Objects.equals(this.parents, listParentsResponse.parents) &&
        Objects.equals(this.nextToken, listParentsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(parents, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListParentsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListParentsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListParentsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListParentsResponse is not found in the empty JSON string", ListParentsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListParentsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListParentsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListParentsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListParentsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListParentsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListParentsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListParentsResponse>() {
           @Override
           public void write(JsonWriter out, ListParentsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListParentsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListParentsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListParentsResponse
   * @throws IOException if the JSON string is invalid with respect to ListParentsResponse
   */
  public static ListParentsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListParentsResponse.class);
  }

  /**
   * Convert an instance of ListParentsResponse to an JSON string
   *
   * @return JSON string
   */
