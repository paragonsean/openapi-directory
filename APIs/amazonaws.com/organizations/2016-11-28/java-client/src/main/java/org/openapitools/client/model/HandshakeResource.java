...
public class HandshakeResource {
  ...
  private HandshakeResourceType type;
  ...
  public HandshakeResource value(String value) {
    this.value = value;
    return this;
  }
  ...
  public HandshakeResource type(HandshakeResourceType type) {
    this.type = type;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public HandshakeResourceType getType() {
    return type;
  }
  ...
  public HandshakeResource resources(List resources) {
  ...
  public boolean equals(Object o) {
    ...
    HandshakeResource handshakeResource = (HandshakeResource) o;
    return Objects.equals(this.value, handshakeResource.value) &&
        Objects.equals(this.type, handshakeResource.type) &&
        Objects.equals(this.resources, handshakeResource.resources);
  }

  @Override
  public int hashCode() {
    return Objects.hash(value, type, resources);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HandshakeResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HandshakeResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HandshakeResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HandshakeResource is not found in the empty JSON string", HandshakeResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HandshakeResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HandshakeResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Type") != null && !jsonObj.get("Type").isJsonNull()) {
        HandshakeResourceType.validateJsonElement(jsonObj.get("Type"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HandshakeResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HandshakeResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HandshakeResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HandshakeResource.class));

       return (TypeAdapter<T>) new TypeAdapter<HandshakeResource>() {
           @Override
           public void write(JsonWriter out, HandshakeResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HandshakeResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HandshakeResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HandshakeResource
   * @throws IOException if the JSON string is invalid with respect to HandshakeResource
   */
  public static HandshakeResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HandshakeResource.class);
  }

  /**
   * Convert an instance of HandshakeResource to an JSON string
   *
   * @return JSON string
   */
