...
public class UpdateOrganizationalUnitRequest {
  ...
  public UpdateOrganizationalUnitRequest organizationalUnitId(String organizationalUnitId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.organizationalUnitId, updateOrganizationalUnitRequest.organizationalUnitId) &&
        Objects.equals(this.name, updateOrganizationalUnitRequest.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(organizationalUnitId, name);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("OrganizationalUnitId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateOrganizationalUnitRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateOrganizationalUnitRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateOrganizationalUnitRequest is not found in the empty JSON string", UpdateOrganizationalUnitRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateOrganizationalUnitRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateOrganizationalUnitRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateOrganizationalUnitRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `OrganizationalUnitId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateOrganizationalUnitRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateOrganizationalUnitRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateOrganizationalUnitRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateOrganizationalUnitRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateOrganizationalUnitRequest>() {
           @Override
           public void write(JsonWriter out, UpdateOrganizationalUnitRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateOrganizationalUnitRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateOrganizationalUnitRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateOrganizationalUnitRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateOrganizationalUnitRequest
   */
  public static UpdateOrganizationalUnitRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateOrganizationalUnitRequest.class);
  }

  /**
   * Convert an instance of UpdateOrganizationalUnitRequest to an JSON string
   *
   * @return JSON string
   */
