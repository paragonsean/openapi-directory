...
public class HandshakeFilter {
  ...
  public HandshakeFilter actionType(ActionType actionType) {
  ...
  public HandshakeFilter parentHandshakeId(String parentHandshakeId) {
  ...
  public boolean equals(Object o) {
    ...
    HandshakeFilter handshakeFilter = (HandshakeFilter) o;
    return Objects.equals(this.actionType, handshakeFilter.actionType) &&
        Objects.equals(this.parentHandshakeId, handshakeFilter.parentHandshakeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class HandshakeFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HandshakeFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HandshakeFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HandshakeFilter is not found in the empty JSON string", HandshakeFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HandshakeFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HandshakeFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HandshakeFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HandshakeFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HandshakeFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HandshakeFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<HandshakeFilter>() {
           @Override
           public void write(JsonWriter out, HandshakeFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HandshakeFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HandshakeFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HandshakeFilter
   * @throws IOException if the JSON string is invalid with respect to HandshakeFilter
   */
  public static HandshakeFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HandshakeFilter.class);
  }

  /**
   * Convert an instance of HandshakeFilter to an JSON string
   *
   * @return JSON string
   */
