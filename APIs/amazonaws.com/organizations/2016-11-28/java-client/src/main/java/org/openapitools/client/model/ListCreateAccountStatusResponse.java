...
public class ListCreateAccountStatusResponse {
  public static final String SERIALIZED_NAME_CREATE_ACCOUNT_STATUSES = "CreateAccountStatuses";
  @SerializedName(SERIALIZED_NAME_CREATE_ACCOUNT_STATUSES)
  private List createAccountStatuses;
  ...
  public ListCreateAccountStatusResponse createAccountStatuses(List createAccountStatuses) {
    this.createAccountStatuses = createAccountStatuses;
    return this;
  }

  /**
   * Get createAccountStatuses
   * @return createAccountStatuses
   */
  @javax.annotation.Nullable
  public List getCreateAccountStatuses() {
    return createAccountStatuses;
  }

  public void setCreateAccountStatuses(List createAccountStatuses) {
    this.createAccountStatuses = createAccountStatuses;
  }


  public ListCreateAccountStatusResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListCreateAccountStatusResponse listCreateAccountStatusResponse = (ListCreateAccountStatusResponse) o;
    return Objects.equals(this.createAccountStatuses, listCreateAccountStatusResponse.createAccountStatuses) &&
        Objects.equals(this.nextToken, listCreateAccountStatusResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createAccountStatuses, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListCreateAccountStatusResponse {\n");
  ...
  static {
    ...
    openapiFields.add("CreateAccountStatuses");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListCreateAccountStatusResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListCreateAccountStatusResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListCreateAccountStatusResponse is not found in the empty JSON string", ListCreateAccountStatusResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListCreateAccountStatusResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListCreateAccountStatusResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `CreateAccountStatuses`
      if (jsonObj.get("CreateAccountStatuses") != null && !jsonObj.get("CreateAccountStatuses").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("CreateAccountStatuses"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListCreateAccountStatusResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListCreateAccountStatusResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListCreateAccountStatusResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListCreateAccountStatusResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListCreateAccountStatusResponse>() {
           @Override
           public void write(JsonWriter out, ListCreateAccountStatusResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListCreateAccountStatusResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListCreateAccountStatusResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListCreateAccountStatusResponse
   * @throws IOException if the JSON string is invalid with respect to ListCreateAccountStatusResponse
   */
  public static ListCreateAccountStatusResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListCreateAccountStatusResponse.class);
  }

  /**
   * Convert an instance of ListCreateAccountStatusResponse to an JSON string
   *
   * @return JSON string
   */
