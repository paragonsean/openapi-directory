...
public class DescribePolicyResponsePolicy {
  ...
  public DescribePolicyResponsePolicy() {
  }

  public DescribePolicyResponsePolicy policySummary(PolicyPolicySummary policySummary) {
  ...
  public DescribePolicyResponsePolicy content(String content) {
  ...
  public boolean equals(Object o) {
    ...
    DescribePolicyResponsePolicy describePolicyResponsePolicy = (DescribePolicyResponsePolicy) o;
    return Objects.equals(this.policySummary, describePolicyResponsePolicy.policySummary) &&
        Objects.equals(this.content, describePolicyResponsePolicy.content);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribePolicyResponsePolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribePolicyResponsePolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribePolicyResponsePolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribePolicyResponsePolicy is not found in the empty JSON string", DescribePolicyResponsePolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribePolicyResponsePolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribePolicyResponsePolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribePolicyResponsePolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribePolicyResponsePolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribePolicyResponsePolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribePolicyResponsePolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribePolicyResponsePolicy>() {
           @Override
           public void write(JsonWriter out, DescribePolicyResponsePolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribePolicyResponsePolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribePolicyResponsePolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribePolicyResponsePolicy
   * @throws IOException if the JSON string is invalid with respect to DescribePolicyResponsePolicy
   */
  public static DescribePolicyResponsePolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribePolicyResponsePolicy.class);
  }

  /**
   * Convert an instance of DescribePolicyResponsePolicy to an JSON string
   *
   * @return JSON string
   */
