...
public class DisableAWSServiceAccessRequest {
  ...
  public DisableAWSServiceAccessRequest() {
  }

  public DisableAWSServiceAccessRequest servicePrincipal(String servicePrincipal) {
  ...
  public boolean equals(Object o) {
    ...
    DisableAWSServiceAccessRequest disableAWSServiceAccessRequest = (DisableAWSServiceAccessRequest) o;
    return Objects.equals(this.servicePrincipal, disableAWSServiceAccessRequest.servicePrincipal);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisableAWSServiceAccessRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("ServicePrincipal");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisableAWSServiceAccessRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisableAWSServiceAccessRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisableAWSServiceAccessRequest is not found in the empty JSON string", DisableAWSServiceAccessRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisableAWSServiceAccessRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisableAWSServiceAccessRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisableAWSServiceAccessRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `ServicePrincipal`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisableAWSServiceAccessRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisableAWSServiceAccessRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisableAWSServiceAccessRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisableAWSServiceAccessRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DisableAWSServiceAccessRequest>() {
           @Override
           public void write(JsonWriter out, DisableAWSServiceAccessRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisableAWSServiceAccessRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisableAWSServiceAccessRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisableAWSServiceAccessRequest
   * @throws IOException if the JSON string is invalid with respect to DisableAWSServiceAccessRequest
   */
  public static DisableAWSServiceAccessRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisableAWSServiceAccessRequest.class);
  }

  /**
   * Convert an instance of DisableAWSServiceAccessRequest to an JSON string
   *
   * @return JSON string
   */
