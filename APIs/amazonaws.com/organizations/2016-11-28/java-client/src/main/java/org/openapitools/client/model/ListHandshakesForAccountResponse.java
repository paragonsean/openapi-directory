...
public class ListHandshakesForAccountResponse {
  public static final String SERIALIZED_NAME_HANDSHAKES = "Handshakes";
  @SerializedName(SERIALIZED_NAME_HANDSHAKES)
  private List handshakes;

  public static final String SERIALIZED_NAME_NEXT_TOKEN = "NextToken";
  @SerializedName(SERIALIZED_NAME_NEXT_TOKEN)
  private String nextToken;

  public ListHandshakesForAccountResponse() {
  }

  public ListHandshakesForAccountResponse handshakes(List handshakes) {
  ...
  public List getHandshakes() {
    return handshakes;
  }

  public void setHandshakes(List handshakes) {
    this.handshakes = handshakes;
  }


  public ListHandshakesForAccountResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListHandshakesForAccountResponse listHandshakesForAccountResponse = (ListHandshakesForAccountResponse) o;
    return Objects.equals(this.handshakes, listHandshakesForAccountResponse.handshakes) &&
        Objects.equals(this.nextToken, listHandshakesForAccountResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handshakes, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListHandshakesForAccountResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListHandshakesForAccountResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListHandshakesForAccountResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListHandshakesForAccountResponse is not found in the empty JSON string", ListHandshakesForAccountResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListHandshakesForAccountResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListHandshakesForAccountResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Handshakes`
      if (jsonObj.get("Handshakes") != null && !jsonObj.get("Handshakes").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Handshakes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListHandshakesForAccountResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListHandshakesForAccountResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListHandshakesForAccountResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListHandshakesForAccountResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListHandshakesForAccountResponse>() {
           @Override
           public void write(JsonWriter out, ListHandshakesForAccountResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListHandshakesForAccountResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListHandshakesForAccountResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListHandshakesForAccountResponse
   * @throws IOException if the JSON string is invalid with respect to ListHandshakesForAccountResponse
   */
  public static ListHandshakesForAccountResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListHandshakesForAccountResponse.class);
  }

  /**
   * Convert an instance of ListHandshakesForAccountResponse to an JSON string
   *
   * @return JSON string
   */
