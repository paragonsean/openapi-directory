...
public class CreateOrganizationalUnitResponseOrganizationalUnit {
  ...
  public CreateOrganizationalUnitResponseOrganizationalUnit() {
  }

  public CreateOrganizationalUnitResponseOrganizationalUnit id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CreateOrganizationalUnitResponseOrganizationalUnit arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateOrganizationalUnitResponseOrganizationalUnit name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateOrganizationalUnitResponseOrganizationalUnit createOrganizationalUnitResponseOrganizationalUnit = (CreateOrganizationalUnitResponseOrganizationalUnit) o;
    return Objects.equals(this.id, createOrganizationalUnitResponseOrganizationalUnit.id) &&
        Objects.equals(this.arn, createOrganizationalUnitResponseOrganizationalUnit.arn) &&
        Objects.equals(this.name, createOrganizationalUnitResponseOrganizationalUnit.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateOrganizationalUnitResponseOrganizationalUnit {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateOrganizationalUnitResponseOrganizationalUnit
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateOrganizationalUnitResponseOrganizationalUnit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOrganizationalUnitResponseOrganizationalUnit is not found in the empty JSON string", CreateOrganizationalUnitResponseOrganizationalUnit.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOrganizationalUnitResponseOrganizationalUnit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOrganizationalUnitResponseOrganizationalUnit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOrganizationalUnitResponseOrganizationalUnit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOrganizationalUnitResponseOrganizationalUnit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOrganizationalUnitResponseOrganizationalUnit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOrganizationalUnitResponseOrganizationalUnit.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOrganizationalUnitResponseOrganizationalUnit>() {
           @Override
           public void write(JsonWriter out, CreateOrganizationalUnitResponseOrganizationalUnit value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateOrganizationalUnitResponseOrganizationalUnit read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateOrganizationalUnitResponseOrganizationalUnit given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateOrganizationalUnitResponseOrganizationalUnit
   * @throws IOException if the JSON string is invalid with respect to CreateOrganizationalUnitResponseOrganizationalUnit
   */
  public static CreateOrganizationalUnitResponseOrganizationalUnit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOrganizationalUnitResponseOrganizationalUnit.class);
  }

  /**
   * Convert an instance of CreateOrganizationalUnitResponseOrganizationalUnit to an JSON string
   *
   * @return JSON string
   */
