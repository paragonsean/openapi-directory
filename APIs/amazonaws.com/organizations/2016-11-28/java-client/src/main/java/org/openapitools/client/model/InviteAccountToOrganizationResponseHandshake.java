...
public class InviteAccountToOrganizationResponseHandshake {
  ...
  public InviteAccountToOrganizationResponseHandshake() {
  }

  public InviteAccountToOrganizationResponseHandshake id(String id) {
    this.id = id;
    return this;
  }
  ...
  public InviteAccountToOrganizationResponseHandshake arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public InviteAccountToOrganizationResponseHandshake parties(List parties) {
  ...
  public InviteAccountToOrganizationResponseHandshake state(HandshakeState state) {
    this.state = state;
    return this;
  }
  ...
  public InviteAccountToOrganizationResponseHandshake requestedTimestamp(OffsetDateTime requestedTimestamp) {
  ...
  public InviteAccountToOrganizationResponseHandshake expirationTimestamp(OffsetDateTime expirationTimestamp) {
  ...
  public InviteAccountToOrganizationResponseHandshake action(ActionType action) {
    this.action = action;
    return this;
  }
  ...
  public InviteAccountToOrganizationResponseHandshake resources(List resources) {
  ...
  public boolean equals(Object o) {
    ...
    InviteAccountToOrganizationResponseHandshake inviteAccountToOrganizationResponseHandshake = (InviteAccountToOrganizationResponseHandshake) o;
    return Objects.equals(this.id, inviteAccountToOrganizationResponseHandshake.id) &&
        Objects.equals(this.arn, inviteAccountToOrganizationResponseHandshake.arn) &&
        Objects.equals(this.parties, inviteAccountToOrganizationResponseHandshake.parties) &&
        Objects.equals(this.state, inviteAccountToOrganizationResponseHandshake.state) &&
        Objects.equals(this.requestedTimestamp, inviteAccountToOrganizationResponseHandshake.requestedTimestamp) &&
        Objects.equals(this.expirationTimestamp, inviteAccountToOrganizationResponseHandshake.expirationTimestamp) &&
        Objects.equals(this.action, inviteAccountToOrganizationResponseHandshake.action) &&
        Objects.equals(this.resources, inviteAccountToOrganizationResponseHandshake.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class InviteAccountToOrganizationResponseHandshake {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InviteAccountToOrganizationResponseHandshake
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InviteAccountToOrganizationResponseHandshake.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InviteAccountToOrganizationResponseHandshake is not found in the empty JSON string", InviteAccountToOrganizationResponseHandshake.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InviteAccountToOrganizationResponseHandshake.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InviteAccountToOrganizationResponseHandshake` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InviteAccountToOrganizationResponseHandshake.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InviteAccountToOrganizationResponseHandshake' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InviteAccountToOrganizationResponseHandshake> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InviteAccountToOrganizationResponseHandshake.class));

       return (TypeAdapter<T>) new TypeAdapter<InviteAccountToOrganizationResponseHandshake>() {
           @Override
           public void write(JsonWriter out, InviteAccountToOrganizationResponseHandshake value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InviteAccountToOrganizationResponseHandshake read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InviteAccountToOrganizationResponseHandshake given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InviteAccountToOrganizationResponseHandshake
   * @throws IOException if the JSON string is invalid with respect to InviteAccountToOrganizationResponseHandshake
   */
  public static InviteAccountToOrganizationResponseHandshake fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InviteAccountToOrganizationResponseHandshake.class);
  }

  /**
   * Convert an instance of InviteAccountToOrganizationResponseHandshake to an JSON string
   *
   * @return JSON string
   */
