...
public class ListOrganizationalUnitsForParentResponse {
  ...
  public ListOrganizationalUnitsForParentResponse organizationalUnits(List organizationalUnits) {
  ...
  public ListOrganizationalUnitsForParentResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.organizationalUnits, listOrganizationalUnitsForParentResponse.organizationalUnits) &&
        Objects.equals(this.nextToken, listOrganizationalUnitsForParentResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(organizationalUnits, nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListOrganizationalUnitsForParentResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListOrganizationalUnitsForParentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListOrganizationalUnitsForParentResponse is not found in the empty JSON string", ListOrganizationalUnitsForParentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListOrganizationalUnitsForParentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListOrganizationalUnitsForParentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListOrganizationalUnitsForParentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListOrganizationalUnitsForParentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListOrganizationalUnitsForParentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListOrganizationalUnitsForParentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListOrganizationalUnitsForParentResponse>() {
           @Override
           public void write(JsonWriter out, ListOrganizationalUnitsForParentResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListOrganizationalUnitsForParentResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListOrganizationalUnitsForParentResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListOrganizationalUnitsForParentResponse
   * @throws IOException if the JSON string is invalid with respect to ListOrganizationalUnitsForParentResponse
   */
  public static ListOrganizationalUnitsForParentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOrganizationalUnitsForParentResponse.class);
  }

  /**
   * Convert an instance of ListOrganizationalUnitsForParentResponse to an JSON string
   *
   * @return JSON string
   */
