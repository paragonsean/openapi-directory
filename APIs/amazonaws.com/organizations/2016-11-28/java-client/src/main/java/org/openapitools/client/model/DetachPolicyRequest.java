...
public class DetachPolicyRequest {
  ...
  public DetachPolicyRequest policyId(String policyId) {
  ...
  public DetachPolicyRequest targetId(String targetId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.policyId, detachPolicyRequest.policyId) &&
        Objects.equals(this.targetId, detachPolicyRequest.targetId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetachPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetachPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetachPolicyRequest is not found in the empty JSON string", DetachPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetachPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetachPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DetachPolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetachPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetachPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetachPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetachPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DetachPolicyRequest>() {
           @Override
           public void write(JsonWriter out, DetachPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetachPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetachPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetachPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to DetachPolicyRequest
   */
  public static DetachPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetachPolicyRequest.class);
  }

  /**
   * Convert an instance of DetachPolicyRequest to an JSON string
   *
   * @return JSON string
   */
