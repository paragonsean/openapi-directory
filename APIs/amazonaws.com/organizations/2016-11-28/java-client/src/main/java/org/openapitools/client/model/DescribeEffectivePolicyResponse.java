...
import org.openapitools.client.model.DescribeEffectivePolicyResponseEffectivePolicy;
...
public class DescribeEffectivePolicyResponse {
  ...
  private DescribeEffectivePolicyResponseEffectivePolicy effectivePolicy;

  public DescribeEffectivePolicyResponse() {
  }

  public DescribeEffectivePolicyResponse effectivePolicy(DescribeEffectivePolicyResponseEffectivePolicy effectivePolicy) {
  ...
  public DescribeEffectivePolicyResponseEffectivePolicy getEffectivePolicy() {
    return effectivePolicy;
  }

  public void setEffectivePolicy(DescribeEffectivePolicyResponseEffectivePolicy effectivePolicy) {
    this.effectivePolicy = effectivePolicy;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeEffectivePolicyResponse describeEffectivePolicyResponse = (DescribeEffectivePolicyResponse) o;
    return Objects.equals(this.effectivePolicy, describeEffectivePolicyResponse.effectivePolicy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(effectivePolicy);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeEffectivePolicyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeEffectivePolicyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeEffectivePolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeEffectivePolicyResponse is not found in the empty JSON string", DescribeEffectivePolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeEffectivePolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeEffectivePolicyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("EffectivePolicy") != null && !jsonObj.get("EffectivePolicy").isJsonNull()) {
        DescribeEffectivePolicyResponseEffectivePolicy.validateJsonElement(jsonObj.get("EffectivePolicy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeEffectivePolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeEffectivePolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeEffectivePolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeEffectivePolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeEffectivePolicyResponse>() {
           @Override
           public void write(JsonWriter out, DescribeEffectivePolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeEffectivePolicyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeEffectivePolicyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeEffectivePolicyResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeEffectivePolicyResponse
   */
  public static DescribeEffectivePolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeEffectivePolicyResponse.class);
  }

  /**
   * Convert an instance of DescribeEffectivePolicyResponse to an JSON string
   *
   * @return JSON string
   */
