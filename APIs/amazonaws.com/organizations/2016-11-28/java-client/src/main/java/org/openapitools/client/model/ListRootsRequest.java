...
public class ListRootsRequest {
  ...
  public ListRootsRequest nextToken(String nextToken) {
  ...
  public ListRootsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listRootsRequest.nextToken) &&
        Objects.equals(this.maxResults, listRootsRequest.maxResults);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRootsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRootsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRootsRequest is not found in the empty JSON string", ListRootsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRootsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRootsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRootsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRootsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRootsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRootsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRootsRequest>() {
           @Override
           public void write(JsonWriter out, ListRootsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRootsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRootsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRootsRequest
   * @throws IOException if the JSON string is invalid with respect to ListRootsRequest
   */
  public static ListRootsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRootsRequest.class);
  }

  /**
   * Convert an instance of ListRootsRequest to an JSON string
   *
   * @return JSON string
   */
