...
public class ListParentsRequest {
  ...
  public ListParentsRequest childId(String childId) {
  ...
  public ListParentsRequest nextToken(String nextToken) {
  ...
  public ListParentsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListParentsRequest listParentsRequest = (ListParentsRequest) o;
    return Objects.equals(this.childId, listParentsRequest.childId) &&
        Objects.equals(this.nextToken, listParentsRequest.nextToken) &&
        Objects.equals(this.maxResults, listParentsRequest.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(childId, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListParentsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListParentsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListParentsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListParentsRequest is not found in the empty JSON string", ListParentsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListParentsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListParentsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListParentsRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `ChildId`
      String.validateJsonElement(jsonObj.get("ChildId"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListParentsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListParentsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListParentsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListParentsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListParentsRequest>() {
           @Override
           public void write(JsonWriter out, ListParentsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListParentsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListParentsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListParentsRequest
   * @throws IOException if the JSON string is invalid with respect to ListParentsRequest
   */
  public static ListParentsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListParentsRequest.class);
  }

  /**
   * Convert an instance of ListParentsRequest to an JSON string
   *
   * @return JSON string
   */
