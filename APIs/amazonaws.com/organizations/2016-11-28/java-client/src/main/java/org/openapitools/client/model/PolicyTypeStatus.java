...
/**
 * Gets or Sets PolicyTypeStatus
 */
@JsonAdapter(PolicyTypeStatus.Adapter.class)
public enum PolicyTypeStatus {
  ...
  public static PolicyTypeStatus fromValue(String value) {
    for (PolicyTypeStatus b : PolicyTypeStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PolicyTypeStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PolicyTypeStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PolicyTypeStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PolicyTypeStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PolicyTypeStatus.fromValue(value);
  }
}
