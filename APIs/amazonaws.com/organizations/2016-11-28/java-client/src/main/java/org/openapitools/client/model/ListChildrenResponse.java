...
public class ListChildrenResponse {
  ...
  public ListChildrenResponse children(List children) {
  ...
  public ListChildrenResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListChildrenResponse listChildrenResponse = (ListChildrenResponse) o;
    return Objects.equals(this.children, listChildrenResponse.children) &&
        Objects.equals(this.nextToken, listChildrenResponse.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListChildrenResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListChildrenResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListChildrenResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListChildrenResponse is not found in the empty JSON string", ListChildrenResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListChildrenResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListChildrenResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListChildrenResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListChildrenResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListChildrenResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListChildrenResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListChildrenResponse>() {
           @Override
           public void write(JsonWriter out, ListChildrenResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListChildrenResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListChildrenResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListChildrenResponse
   * @throws IOException if the JSON string is invalid with respect to ListChildrenResponse
   */
  public static ListChildrenResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListChildrenResponse.class);
  }

  /**
   * Convert an instance of ListChildrenResponse to an JSON string
   *
   * @return JSON string
   */
