...
public class CreateAccountResponseCreateAccountStatus {
  ...
  public CreateAccountResponseCreateAccountStatus() {
  }

  public CreateAccountResponseCreateAccountStatus id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CreateAccountResponseCreateAccountStatus accountName(String accountName) {
  ...
  public CreateAccountResponseCreateAccountStatus state(CreateAccountState state) {
    this.state = state;
    return this;
  }
  ...
  public CreateAccountResponseCreateAccountStatus requestedTimestamp(OffsetDateTime requestedTimestamp) {
  ...
  public CreateAccountResponseCreateAccountStatus completedTimestamp(OffsetDateTime completedTimestamp) {
  ...
  public CreateAccountResponseCreateAccountStatus accountId(String accountId) {
  ...
  public CreateAccountResponseCreateAccountStatus govCloudAccountId(String govCloudAccountId) {
  ...
  public CreateAccountResponseCreateAccountStatus failureReason(CreateAccountFailureReason failureReason) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAccountResponseCreateAccountStatus createAccountResponseCreateAccountStatus = (CreateAccountResponseCreateAccountStatus) o;
    return Objects.equals(this.id, createAccountResponseCreateAccountStatus.id) &&
        Objects.equals(this.accountName, createAccountResponseCreateAccountStatus.accountName) &&
        Objects.equals(this.state, createAccountResponseCreateAccountStatus.state) &&
        Objects.equals(this.requestedTimestamp, createAccountResponseCreateAccountStatus.requestedTimestamp) &&
        Objects.equals(this.completedTimestamp, createAccountResponseCreateAccountStatus.completedTimestamp) &&
        Objects.equals(this.accountId, createAccountResponseCreateAccountStatus.accountId) &&
        Objects.equals(this.govCloudAccountId, createAccountResponseCreateAccountStatus.govCloudAccountId) &&
        Objects.equals(this.failureReason, createAccountResponseCreateAccountStatus.failureReason);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAccountResponseCreateAccountStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAccountResponseCreateAccountStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAccountResponseCreateAccountStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAccountResponseCreateAccountStatus is not found in the empty JSON string", CreateAccountResponseCreateAccountStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAccountResponseCreateAccountStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAccountResponseCreateAccountStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAccountResponseCreateAccountStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAccountResponseCreateAccountStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAccountResponseCreateAccountStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAccountResponseCreateAccountStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAccountResponseCreateAccountStatus>() {
           @Override
           public void write(JsonWriter out, CreateAccountResponseCreateAccountStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAccountResponseCreateAccountStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAccountResponseCreateAccountStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAccountResponseCreateAccountStatus
   * @throws IOException if the JSON string is invalid with respect to CreateAccountResponseCreateAccountStatus
   */
  public static CreateAccountResponseCreateAccountStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAccountResponseCreateAccountStatus.class);
  }

  /**
   * Convert an instance of CreateAccountResponseCreateAccountStatus to an JSON string
   *
   * @return JSON string
   */
