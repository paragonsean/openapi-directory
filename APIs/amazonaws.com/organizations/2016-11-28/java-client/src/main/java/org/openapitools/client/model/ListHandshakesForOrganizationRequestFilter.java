...
public class ListHandshakesForOrganizationRequestFilter {
  ...
  public ListHandshakesForOrganizationRequestFilter() {
  }

  public ListHandshakesForOrganizationRequestFilter actionType(ActionType actionType) {
  ...
  public ListHandshakesForOrganizationRequestFilter parentHandshakeId(String parentHandshakeId) {
  ...
  public boolean equals(Object o) {
    ...
    ListHandshakesForOrganizationRequestFilter listHandshakesForOrganizationRequestFilter = (ListHandshakesForOrganizationRequestFilter) o;
    return Objects.equals(this.actionType, listHandshakesForOrganizationRequestFilter.actionType) &&
        Objects.equals(this.parentHandshakeId, listHandshakesForOrganizationRequestFilter.parentHandshakeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListHandshakesForOrganizationRequestFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListHandshakesForOrganizationRequestFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListHandshakesForOrganizationRequestFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListHandshakesForOrganizationRequestFilter is not found in the empty JSON string", ListHandshakesForOrganizationRequestFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListHandshakesForOrganizationRequestFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListHandshakesForOrganizationRequestFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListHandshakesForOrganizationRequestFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListHandshakesForOrganizationRequestFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListHandshakesForOrganizationRequestFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListHandshakesForOrganizationRequestFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<ListHandshakesForOrganizationRequestFilter>() {
           @Override
           public void write(JsonWriter out, ListHandshakesForOrganizationRequestFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListHandshakesForOrganizationRequestFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListHandshakesForOrganizationRequestFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListHandshakesForOrganizationRequestFilter
   * @throws IOException if the JSON string is invalid with respect to ListHandshakesForOrganizationRequestFilter
   */
  public static ListHandshakesForOrganizationRequestFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListHandshakesForOrganizationRequestFilter.class);
  }

  /**
   * Convert an instance of ListHandshakesForOrganizationRequestFilter to an JSON string
   *
   * @return JSON string
   */
