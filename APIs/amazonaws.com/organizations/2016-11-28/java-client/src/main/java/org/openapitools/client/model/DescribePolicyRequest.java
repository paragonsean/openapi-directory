...
public class DescribePolicyRequest {
  ...
  public DescribePolicyRequest policyId(String policyId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribePolicyRequest describePolicyRequest = (DescribePolicyRequest) o;
    return Objects.equals(this.policyId, describePolicyRequest.policyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribePolicyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribePolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribePolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribePolicyRequest is not found in the empty JSON string", DescribePolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribePolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribePolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribePolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribePolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribePolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribePolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribePolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribePolicyRequest>() {
           @Override
           public void write(JsonWriter out, DescribePolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribePolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribePolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribePolicyRequest
   * @throws IOException if the JSON string is invalid with respect to DescribePolicyRequest
   */
  public static DescribePolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribePolicyRequest.class);
  }

  /**
   * Convert an instance of DescribePolicyRequest to an JSON string
   *
   * @return JSON string
   */
