...
public class ListAccountsRequest {
  ...
  public ListAccountsRequest nextToken(String nextToken) {
  ...
  public ListAccountsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listAccountsRequest.nextToken) &&
        Objects.equals(this.maxResults, listAccountsRequest.maxResults);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAccountsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAccountsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAccountsRequest is not found in the empty JSON string", ListAccountsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAccountsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAccountsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAccountsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAccountsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAccountsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAccountsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAccountsRequest>() {
           @Override
           public void write(JsonWriter out, ListAccountsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAccountsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAccountsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAccountsRequest
   * @throws IOException if the JSON string is invalid with respect to ListAccountsRequest
   */
  public static ListAccountsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAccountsRequest.class);
  }

  /**
   * Convert an instance of ListAccountsRequest to an JSON string
   *
   * @return JSON string
   */
