...
/**
 * Gets or Sets HandshakeState
 */
@JsonAdapter(HandshakeState.Adapter.class)
public enum HandshakeState {
  ...
  public static HandshakeState fromValue(String value) {
    for (HandshakeState b : HandshakeState.values()) {
  ...
  public static class Adapter extends TypeAdapter<HandshakeState> {
    @Override
    public void write(final JsonWriter jsonWriter, final HandshakeState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public HandshakeState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return HandshakeState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    HandshakeState.fromValue(value);
  }
}
