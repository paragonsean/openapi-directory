...
public class CreateGovCloudAccountResponse {
  ...
  public CreateGovCloudAccountResponse createAccountStatus(CreateAccountStatus createAccountStatus) {
  ...
  public boolean equals(Object o) {
    ...
    CreateGovCloudAccountResponse createGovCloudAccountResponse = (CreateGovCloudAccountResponse) o;
    return Objects.equals(this.createAccountStatus, createGovCloudAccountResponse.createAccountStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateGovCloudAccountResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGovCloudAccountResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGovCloudAccountResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGovCloudAccountResponse is not found in the empty JSON string", CreateGovCloudAccountResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateGovCloudAccountResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateGovCloudAccountResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("CreateAccountStatus") != null && !jsonObj.get("CreateAccountStatus").isJsonNull()) {
        CreateAccountStatus.validateJsonElement(jsonObj.get("CreateAccountStatus"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGovCloudAccountResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGovCloudAccountResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGovCloudAccountResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGovCloudAccountResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGovCloudAccountResponse>() {
           @Override
           public void write(JsonWriter out, CreateGovCloudAccountResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGovCloudAccountResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGovCloudAccountResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGovCloudAccountResponse
   * @throws IOException if the JSON string is invalid with respect to CreateGovCloudAccountResponse
   */
  public static CreateGovCloudAccountResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGovCloudAccountResponse.class);
  }

  /**
   * Convert an instance of CreateGovCloudAccountResponse to an JSON string
   *
   * @return JSON string
   */
