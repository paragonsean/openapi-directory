...
public class ListAWSServiceAccessForOrganizationRequest {
  ...
  public ListAWSServiceAccessForOrganizationRequest nextToken(String nextToken) {
  ...
  public ListAWSServiceAccessForOrganizationRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListAWSServiceAccessForOrganizationRequest listAWSServiceAccessForOrganizationRequest = (ListAWSServiceAccessForOrganizationRequest) o;
    return Objects.equals(this.nextToken, listAWSServiceAccessForOrganizationRequest.nextToken) &&
        Objects.equals(this.maxResults, listAWSServiceAccessForOrganizationRequest.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAWSServiceAccessForOrganizationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAWSServiceAccessForOrganizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAWSServiceAccessForOrganizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAWSServiceAccessForOrganizationRequest is not found in the empty JSON string", ListAWSServiceAccessForOrganizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAWSServiceAccessForOrganizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAWSServiceAccessForOrganizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAWSServiceAccessForOrganizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAWSServiceAccessForOrganizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAWSServiceAccessForOrganizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAWSServiceAccessForOrganizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAWSServiceAccessForOrganizationRequest>() {
           @Override
           public void write(JsonWriter out, ListAWSServiceAccessForOrganizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAWSServiceAccessForOrganizationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAWSServiceAccessForOrganizationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAWSServiceAccessForOrganizationRequest
   * @throws IOException if the JSON string is invalid with respect to ListAWSServiceAccessForOrganizationRequest
   */
  public static ListAWSServiceAccessForOrganizationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAWSServiceAccessForOrganizationRequest.class);
  }

  /**
   * Convert an instance of ListAWSServiceAccessForOrganizationRequest to an JSON string
   *
   * @return JSON string
   */
