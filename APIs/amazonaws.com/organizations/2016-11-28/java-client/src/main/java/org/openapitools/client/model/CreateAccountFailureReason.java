...
/**
 * Gets or Sets CreateAccountFailureReason
 */
@JsonAdapter(CreateAccountFailureReason.Adapter.class)
public enum CreateAccountFailureReason {
  ...
  CreateAccountFailureReason(String value) {
    this.value = value;
  }
  ...
  public static CreateAccountFailureReason fromValue(String value) {
    for (CreateAccountFailureReason b : CreateAccountFailureReason.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreateAccountFailureReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreateAccountFailureReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreateAccountFailureReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreateAccountFailureReason.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CreateAccountFailureReason.fromValue(value);
  }
}
