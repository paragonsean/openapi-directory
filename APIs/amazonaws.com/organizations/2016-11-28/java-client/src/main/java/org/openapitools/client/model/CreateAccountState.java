...
/**
 * Gets or Sets CreateAccountState
 */
@JsonAdapter(CreateAccountState.Adapter.class)
public enum CreateAccountState {
  ...
  CreateAccountState(String value) {
    this.value = value;
  }
  ...
  public static CreateAccountState fromValue(String value) {
    for (CreateAccountState b : CreateAccountState.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreateAccountState> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreateAccountState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreateAccountState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreateAccountState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CreateAccountState.fromValue(value);
  }
}
