...
import org.openapitools.client.model.CreateOrganizationalUnitResponseOrganizationalUnit;
...
public class CreateOrganizationalUnitResponse {
  ...
  private CreateOrganizationalUnitResponseOrganizationalUnit organizationalUnit;

  public CreateOrganizationalUnitResponse() {
  }

  public CreateOrganizationalUnitResponse organizationalUnit(CreateOrganizationalUnitResponseOrganizationalUnit organizationalUnit) {
  ...
  public CreateOrganizationalUnitResponseOrganizationalUnit getOrganizationalUnit() {
    return organizationalUnit;
  }

  public void setOrganizationalUnit(CreateOrganizationalUnitResponseOrganizationalUnit organizationalUnit) {
    this.organizationalUnit = organizationalUnit;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateOrganizationalUnitResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateOrganizationalUnitResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOrganizationalUnitResponse is not found in the empty JSON string", CreateOrganizationalUnitResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOrganizationalUnitResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOrganizationalUnitResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("OrganizationalUnit") != null && !jsonObj.get("OrganizationalUnit").isJsonNull()) {
        CreateOrganizationalUnitResponseOrganizationalUnit.validateJsonElement(jsonObj.get("OrganizationalUnit"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOrganizationalUnitResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOrganizationalUnitResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOrganizationalUnitResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOrganizationalUnitResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOrganizationalUnitResponse>() {
           @Override
           public void write(JsonWriter out, CreateOrganizationalUnitResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateOrganizationalUnitResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateOrganizationalUnitResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateOrganizationalUnitResponse
   * @throws IOException if the JSON string is invalid with respect to CreateOrganizationalUnitResponse
   */
  public static CreateOrganizationalUnitResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOrganizationalUnitResponse.class);
  }

  /**
   * Convert an instance of CreateOrganizationalUnitResponse to an JSON string
   *
   * @return JSON string
   */
