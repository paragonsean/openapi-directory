...
public class InviteAccountToOrganizationRequestTarget {
  ...
  private HandshakePartyType type;

  public InviteAccountToOrganizationRequestTarget() {
  }

  public InviteAccountToOrganizationRequestTarget id(String id) {
    this.id = id;
    return this;
  }
  ...
  public InviteAccountToOrganizationRequestTarget type(HandshakePartyType type) {
    this.type = type;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public HandshakePartyType getType() {
    return type;
  }
  ...
  public boolean equals(Object o) {
    ...
    InviteAccountToOrganizationRequestTarget inviteAccountToOrganizationRequestTarget = (InviteAccountToOrganizationRequestTarget) o;
    return Objects.equals(this.id, inviteAccountToOrganizationRequestTarget.id) &&
        Objects.equals(this.type, inviteAccountToOrganizationRequestTarget.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class InviteAccountToOrganizationRequestTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InviteAccountToOrganizationRequestTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InviteAccountToOrganizationRequestTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InviteAccountToOrganizationRequestTarget is not found in the empty JSON string", InviteAccountToOrganizationRequestTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InviteAccountToOrganizationRequestTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InviteAccountToOrganizationRequestTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InviteAccountToOrganizationRequestTarget.openapiRequiredFields) {
      ...
      HandshakePartyType.validateJsonElement(jsonObj.get("Type"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InviteAccountToOrganizationRequestTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InviteAccountToOrganizationRequestTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InviteAccountToOrganizationRequestTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InviteAccountToOrganizationRequestTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<InviteAccountToOrganizationRequestTarget>() {
           @Override
           public void write(JsonWriter out, InviteAccountToOrganizationRequestTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InviteAccountToOrganizationRequestTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InviteAccountToOrganizationRequestTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InviteAccountToOrganizationRequestTarget
   * @throws IOException if the JSON string is invalid with respect to InviteAccountToOrganizationRequestTarget
   */
  public static InviteAccountToOrganizationRequestTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InviteAccountToOrganizationRequestTarget.class);
  }

  /**
   * Convert an instance of InviteAccountToOrganizationRequestTarget to an JSON string
   *
   * @return JSON string
   */
