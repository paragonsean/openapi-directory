...
public class CancelHandshakeResponse {
  ...
  private CancelHandshakeResponseHandshake handshake;

  public CancelHandshakeResponse() {
  }

  public CancelHandshakeResponse handshake(CancelHandshakeResponseHandshake handshake) {
  ...
  public void setHandshake(CancelHandshakeResponseHandshake handshake) {
    this.handshake = handshake;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelHandshakeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelHandshakeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelHandshakeResponse is not found in the empty JSON string", CancelHandshakeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelHandshakeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelHandshakeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Handshake`
      if (jsonObj.get("Handshake") != null && !jsonObj.get("Handshake").isJsonNull()) {
        CancelHandshakeResponseHandshake.validateJsonElement(jsonObj.get("Handshake"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelHandshakeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelHandshakeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelHandshakeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelHandshakeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelHandshakeResponse>() {
           @Override
           public void write(JsonWriter out, CancelHandshakeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelHandshakeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelHandshakeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelHandshakeResponse
   * @throws IOException if the JSON string is invalid with respect to CancelHandshakeResponse
   */
  public static CancelHandshakeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelHandshakeResponse.class);
  }

  /**
   * Convert an instance of CancelHandshakeResponse to an JSON string
   *
   * @return JSON string
   */
