...
public class ListOrganizationalUnitsForParentRequest {
  ...
  public ListOrganizationalUnitsForParentRequest() {
  }
  ...
  public ListOrganizationalUnitsForParentRequest nextToken(String nextToken) {
  ...
  public ListOrganizationalUnitsForParentRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.parentId, listOrganizationalUnitsForParentRequest.parentId) &&
        Objects.equals(this.nextToken, listOrganizationalUnitsForParentRequest.nextToken) &&
        Objects.equals(this.maxResults, listOrganizationalUnitsForParentRequest.maxResults);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListOrganizationalUnitsForParentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListOrganizationalUnitsForParentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListOrganizationalUnitsForParentRequest is not found in the empty JSON string", ListOrganizationalUnitsForParentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListOrganizationalUnitsForParentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListOrganizationalUnitsForParentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListOrganizationalUnitsForParentRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListOrganizationalUnitsForParentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListOrganizationalUnitsForParentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListOrganizationalUnitsForParentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListOrganizationalUnitsForParentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListOrganizationalUnitsForParentRequest>() {
           @Override
           public void write(JsonWriter out, ListOrganizationalUnitsForParentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListOrganizationalUnitsForParentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListOrganizationalUnitsForParentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListOrganizationalUnitsForParentRequest
   * @throws IOException if the JSON string is invalid with respect to ListOrganizationalUnitsForParentRequest
   */
  public static ListOrganizationalUnitsForParentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOrganizationalUnitsForParentRequest.class);
  }

  /**
   * Convert an instance of ListOrganizationalUnitsForParentRequest to an JSON string
   *
   * @return JSON string
   */
