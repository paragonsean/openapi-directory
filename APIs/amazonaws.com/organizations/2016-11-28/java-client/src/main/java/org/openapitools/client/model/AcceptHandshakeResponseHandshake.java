...
public class AcceptHandshakeResponseHandshake {
  ...
  public AcceptHandshakeResponseHandshake() {
  }

  public AcceptHandshakeResponseHandshake id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AcceptHandshakeResponseHandshake arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public AcceptHandshakeResponseHandshake parties(List parties) {
  ...
  public AcceptHandshakeResponseHandshake state(HandshakeState state) {
    this.state = state;
    return this;
  }
  ...
  public AcceptHandshakeResponseHandshake requestedTimestamp(OffsetDateTime requestedTimestamp) {
  ...
  public AcceptHandshakeResponseHandshake expirationTimestamp(OffsetDateTime expirationTimestamp) {
  ...
  public AcceptHandshakeResponseHandshake action(ActionType action) {
    this.action = action;
    return this;
  }
  ...
  public AcceptHandshakeResponseHandshake resources(List resources) {
  ...
  public boolean equals(Object o) {
    ...
    AcceptHandshakeResponseHandshake acceptHandshakeResponseHandshake = (AcceptHandshakeResponseHandshake) o;
    return Objects.equals(this.id, acceptHandshakeResponseHandshake.id) &&
        Objects.equals(this.arn, acceptHandshakeResponseHandshake.arn) &&
        Objects.equals(this.parties, acceptHandshakeResponseHandshake.parties) &&
        Objects.equals(this.state, acceptHandshakeResponseHandshake.state) &&
        Objects.equals(this.requestedTimestamp, acceptHandshakeResponseHandshake.requestedTimestamp) &&
        Objects.equals(this.expirationTimestamp, acceptHandshakeResponseHandshake.expirationTimestamp) &&
        Objects.equals(this.action, acceptHandshakeResponseHandshake.action) &&
        Objects.equals(this.resources, acceptHandshakeResponseHandshake.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class AcceptHandshakeResponseHandshake {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AcceptHandshakeResponseHandshake
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AcceptHandshakeResponseHandshake.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AcceptHandshakeResponseHandshake is not found in the empty JSON string", AcceptHandshakeResponseHandshake.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AcceptHandshakeResponseHandshake.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AcceptHandshakeResponseHandshake` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AcceptHandshakeResponseHandshake.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AcceptHandshakeResponseHandshake' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AcceptHandshakeResponseHandshake> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AcceptHandshakeResponseHandshake.class));

       return (TypeAdapter<T>) new TypeAdapter<AcceptHandshakeResponseHandshake>() {
           @Override
           public void write(JsonWriter out, AcceptHandshakeResponseHandshake value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AcceptHandshakeResponseHandshake read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AcceptHandshakeResponseHandshake given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AcceptHandshakeResponseHandshake
   * @throws IOException if the JSON string is invalid with respect to AcceptHandshakeResponseHandshake
   */
  public static AcceptHandshakeResponseHandshake fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AcceptHandshakeResponseHandshake.class);
  }

  /**
   * Convert an instance of AcceptHandshakeResponseHandshake to an JSON string
   *
   * @return JSON string
   */
