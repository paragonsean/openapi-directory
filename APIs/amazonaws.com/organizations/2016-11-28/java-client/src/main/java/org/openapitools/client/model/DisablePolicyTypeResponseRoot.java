...
public class DisablePolicyTypeResponseRoot {
  ...
  public DisablePolicyTypeResponseRoot() {
  }

  public DisablePolicyTypeResponseRoot id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DisablePolicyTypeResponseRoot arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DisablePolicyTypeResponseRoot name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DisablePolicyTypeResponseRoot policyTypes(List policyTypes) {
  ...
  public boolean equals(Object o) {
    ...
    DisablePolicyTypeResponseRoot disablePolicyTypeResponseRoot = (DisablePolicyTypeResponseRoot) o;
    return Objects.equals(this.id, disablePolicyTypeResponseRoot.id) &&
        Objects.equals(this.arn, disablePolicyTypeResponseRoot.arn) &&
        Objects.equals(this.name, disablePolicyTypeResponseRoot.name) &&
        Objects.equals(this.policyTypes, disablePolicyTypeResponseRoot.policyTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, arn, name, policyTypes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DisablePolicyTypeResponseRoot {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisablePolicyTypeResponseRoot
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisablePolicyTypeResponseRoot.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisablePolicyTypeResponseRoot is not found in the empty JSON string", DisablePolicyTypeResponseRoot.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisablePolicyTypeResponseRoot.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisablePolicyTypeResponseRoot` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisablePolicyTypeResponseRoot.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisablePolicyTypeResponseRoot' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisablePolicyTypeResponseRoot> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisablePolicyTypeResponseRoot.class));

       return (TypeAdapter<T>) new TypeAdapter<DisablePolicyTypeResponseRoot>() {
           @Override
           public void write(JsonWriter out, DisablePolicyTypeResponseRoot value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisablePolicyTypeResponseRoot read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisablePolicyTypeResponseRoot given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisablePolicyTypeResponseRoot
   * @throws IOException if the JSON string is invalid with respect to DisablePolicyTypeResponseRoot
   */
  public static DisablePolicyTypeResponseRoot fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisablePolicyTypeResponseRoot.class);
  }

  /**
   * Convert an instance of DisablePolicyTypeResponseRoot to an JSON string
   *
   * @return JSON string
   */
