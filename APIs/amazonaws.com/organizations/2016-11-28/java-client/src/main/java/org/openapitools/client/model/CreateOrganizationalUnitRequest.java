...
public class CreateOrganizationalUnitRequest {
  ...
  public CreateOrganizationalUnitRequest tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.parentId, createOrganizationalUnitRequest.parentId) &&
        Objects.equals(this.name, createOrganizationalUnitRequest.name) &&
        Objects.equals(this.tags, createOrganizationalUnitRequest.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(parentId, name, tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateOrganizationalUnitRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateOrganizationalUnitRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOrganizationalUnitRequest is not found in the empty JSON string", CreateOrganizationalUnitRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOrganizationalUnitRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOrganizationalUnitRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateOrganizationalUnitRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOrganizationalUnitRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOrganizationalUnitRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOrganizationalUnitRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOrganizationalUnitRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOrganizationalUnitRequest>() {
           @Override
           public void write(JsonWriter out, CreateOrganizationalUnitRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateOrganizationalUnitRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateOrganizationalUnitRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateOrganizationalUnitRequest
   * @throws IOException if the JSON string is invalid with respect to CreateOrganizationalUnitRequest
   */
  public static CreateOrganizationalUnitRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOrganizationalUnitRequest.class);
  }

  /**
   * Convert an instance of CreateOrganizationalUnitRequest to an JSON string
   *
   * @return JSON string
   */
