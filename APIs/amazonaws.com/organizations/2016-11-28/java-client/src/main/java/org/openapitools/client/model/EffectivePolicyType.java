...
/**
 * Gets or Sets EffectivePolicyType
 */
@JsonAdapter(EffectivePolicyType.Adapter.class)
public enum EffectivePolicyType {
  ...
  EffectivePolicyType(String value) {
    this.value = value;
  }
  ...
  public static EffectivePolicyType fromValue(String value) {
    for (EffectivePolicyType b : EffectivePolicyType.values()) {
  ...
  public static class Adapter extends TypeAdapter<EffectivePolicyType> {
    @Override
    public void write(final JsonWriter jsonWriter, final EffectivePolicyType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EffectivePolicyType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EffectivePolicyType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EffectivePolicyType.fromValue(value);
  }
}
