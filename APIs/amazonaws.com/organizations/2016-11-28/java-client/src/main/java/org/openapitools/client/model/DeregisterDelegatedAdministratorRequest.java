...
public class DeregisterDelegatedAdministratorRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeregisterDelegatedAdministratorRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeregisterDelegatedAdministratorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeregisterDelegatedAdministratorRequest is not found in the empty JSON string", DeregisterDelegatedAdministratorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeregisterDelegatedAdministratorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeregisterDelegatedAdministratorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeregisterDelegatedAdministratorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeregisterDelegatedAdministratorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeregisterDelegatedAdministratorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeregisterDelegatedAdministratorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeregisterDelegatedAdministratorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeregisterDelegatedAdministratorRequest>() {
           @Override
           public void write(JsonWriter out, DeregisterDelegatedAdministratorRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeregisterDelegatedAdministratorRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeregisterDelegatedAdministratorRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeregisterDelegatedAdministratorRequest
   * @throws IOException if the JSON string is invalid with respect to DeregisterDelegatedAdministratorRequest
   */
  public static DeregisterDelegatedAdministratorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeregisterDelegatedAdministratorRequest.class);
  }

  /**
   * Convert an instance of DeregisterDelegatedAdministratorRequest to an JSON string
   *
   * @return JSON string
   */
