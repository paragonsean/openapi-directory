...
import org.openapitools.client.model.DescribeCreateAccountStatusResponseCreateAccountStatus;
...
public class DescribeCreateAccountStatusResponse {
  public static final String SERIALIZED_NAME_CREATE_ACCOUNT_STATUS = "CreateAccountStatus";
  @SerializedName(SERIALIZED_NAME_CREATE_ACCOUNT_STATUS)
  private DescribeCreateAccountStatusResponseCreateAccountStatus createAccountStatus;

  public DescribeCreateAccountStatusResponse() {
  }

  public DescribeCreateAccountStatusResponse createAccountStatus(DescribeCreateAccountStatusResponseCreateAccountStatus createAccountStatus) {
  ...
  public DescribeCreateAccountStatusResponseCreateAccountStatus getCreateAccountStatus() {
    return createAccountStatus;
  }

  public void setCreateAccountStatus(DescribeCreateAccountStatusResponseCreateAccountStatus createAccountStatus) {
    this.createAccountStatus = createAccountStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeCreateAccountStatusResponse describeCreateAccountStatusResponse = (DescribeCreateAccountStatusResponse) o;
    return Objects.equals(this.createAccountStatus, describeCreateAccountStatusResponse.createAccountStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeCreateAccountStatusResponse {\n");
  ...
  static {
    ...
    openapiFields.add("CreateAccountStatus");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCreateAccountStatusResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCreateAccountStatusResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCreateAccountStatusResponse is not found in the empty JSON string", DescribeCreateAccountStatusResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCreateAccountStatusResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCreateAccountStatusResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `CreateAccountStatus`
      if (jsonObj.get("CreateAccountStatus") != null && !jsonObj.get("CreateAccountStatus").isJsonNull()) {
        DescribeCreateAccountStatusResponseCreateAccountStatus.validateJsonElement(jsonObj.get("CreateAccountStatus"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCreateAccountStatusResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCreateAccountStatusResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCreateAccountStatusResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCreateAccountStatusResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCreateAccountStatusResponse>() {
           @Override
           public void write(JsonWriter out, DescribeCreateAccountStatusResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCreateAccountStatusResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCreateAccountStatusResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCreateAccountStatusResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeCreateAccountStatusResponse
   */
  public static DescribeCreateAccountStatusResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCreateAccountStatusResponse.class);
  }

  /**
   * Convert an instance of DescribeCreateAccountStatusResponse to an JSON string
   *
   * @return JSON string
   */
