...
public class PolicyPolicySummary {
  ...
  public PolicyPolicySummary() {
  }

  public PolicyPolicySummary id(String id) {
    this.id = id;
    return this;
  }
  ...
  public PolicyPolicySummary arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public PolicyPolicySummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PolicyPolicySummary description(String description) {
  ...
  public PolicyPolicySummary type(PolicyType type) {
    this.type = type;
    return this;
  }
  ...
  public PolicyPolicySummary awsManaged(Boolean awsManaged) {
  ...
  public boolean equals(Object o) {
    ...
    PolicyPolicySummary policyPolicySummary = (PolicyPolicySummary) o;
    return Objects.equals(this.id, policyPolicySummary.id) &&
        Objects.equals(this.arn, policyPolicySummary.arn) &&
        Objects.equals(this.name, policyPolicySummary.name) &&
        Objects.equals(this.description, policyPolicySummary.description) &&
        Objects.equals(this.type, policyPolicySummary.type) &&
        Objects.equals(this.awsManaged, policyPolicySummary.awsManaged);
  }
  ...
  public String toString() {
    ...
    sb.append("class PolicyPolicySummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyPolicySummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyPolicySummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyPolicySummary is not found in the empty JSON string", PolicyPolicySummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyPolicySummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyPolicySummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyPolicySummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyPolicySummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyPolicySummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyPolicySummary.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyPolicySummary>() {
           @Override
           public void write(JsonWriter out, PolicyPolicySummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyPolicySummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyPolicySummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyPolicySummary
   * @throws IOException if the JSON string is invalid with respect to PolicyPolicySummary
   */
  public static PolicyPolicySummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyPolicySummary.class);
  }

  /**
   * Convert an instance of PolicyPolicySummary to an JSON string
   *
   * @return JSON string
   */
