...
import org.openapitools.client.model.ListHandshakesForOrganizationRequestFilter;
...
public class ListHandshakesForOrganizationRequest {
  ...
  private ListHandshakesForOrganizationRequestFilter filter;
  ...
  public ListHandshakesForOrganizationRequest filter(ListHandshakesForOrganizationRequestFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ListHandshakesForOrganizationRequestFilter getFilter() {
    return filter;
  }

  public void setFilter(ListHandshakesForOrganizationRequestFilter filter) {
    this.filter = filter;
  }


  public ListHandshakesForOrganizationRequest nextToken(String nextToken) {
  ...
  public ListHandshakesForOrganizationRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListHandshakesForOrganizationRequest listHandshakesForOrganizationRequest = (ListHandshakesForOrganizationRequest) o;
    return Objects.equals(this.filter, listHandshakesForOrganizationRequest.filter) &&
        Objects.equals(this.nextToken, listHandshakesForOrganizationRequest.nextToken) &&
        Objects.equals(this.maxResults, listHandshakesForOrganizationRequest.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListHandshakesForOrganizationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListHandshakesForOrganizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListHandshakesForOrganizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListHandshakesForOrganizationRequest is not found in the empty JSON string", ListHandshakesForOrganizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListHandshakesForOrganizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListHandshakesForOrganizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Filter`
      if (jsonObj.get("Filter") != null && !jsonObj.get("Filter").isJsonNull()) {
        ListHandshakesForOrganizationRequestFilter.validateJsonElement(jsonObj.get("Filter"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListHandshakesForOrganizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListHandshakesForOrganizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListHandshakesForOrganizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListHandshakesForOrganizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListHandshakesForOrganizationRequest>() {
           @Override
           public void write(JsonWriter out, ListHandshakesForOrganizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListHandshakesForOrganizationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListHandshakesForOrganizationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListHandshakesForOrganizationRequest
   * @throws IOException if the JSON string is invalid with respect to ListHandshakesForOrganizationRequest
   */
  public static ListHandshakesForOrganizationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListHandshakesForOrganizationRequest.class);
  }

  /**
   * Convert an instance of ListHandshakesForOrganizationRequest to an JSON string
   *
   * @return JSON string
   */
