...
/**
 * Gets or Sets IAMUserAccessToBilling
 */
@JsonAdapter(IAMUserAccessToBilling.Adapter.class)
public enum IAMUserAccessToBilling {
  ...
  IAMUserAccessToBilling(String value) {
    this.value = value;
  }
  ...
  public static IAMUserAccessToBilling fromValue(String value) {
    for (IAMUserAccessToBilling b : IAMUserAccessToBilling.values()) {
  ...
  public static class Adapter extends TypeAdapter<IAMUserAccessToBilling> {
    @Override
    public void write(final JsonWriter jsonWriter, final IAMUserAccessToBilling enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public IAMUserAccessToBilling read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return IAMUserAccessToBilling.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    IAMUserAccessToBilling.fromValue(value);
  }
}
