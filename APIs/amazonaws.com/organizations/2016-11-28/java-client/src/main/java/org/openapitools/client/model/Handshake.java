...
public class Handshake {
  ...
  public Handshake arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public Handshake parties(List parties) {
  ...
  public Handshake state(HandshakeState state) {
    this.state = state;
    return this;
  }
  ...
  public Handshake requestedTimestamp(OffsetDateTime requestedTimestamp) {
  ...
  public Handshake expirationTimestamp(OffsetDateTime expirationTimestamp) {
  ...
  public Handshake action(ActionType action) {
    this.action = action;
    return this;
  }
  ...
  public Handshake resources(List resources) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, handshake.id) &&
        Objects.equals(this.arn, handshake.arn) &&
        Objects.equals(this.parties, handshake.parties) &&
        Objects.equals(this.state, handshake.state) &&
        Objects.equals(this.requestedTimestamp, handshake.requestedTimestamp) &&
        Objects.equals(this.expirationTimestamp, handshake.expirationTimestamp) &&
        Objects.equals(this.action, handshake.action) &&
        Objects.equals(this.resources, handshake.resources);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Handshake
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Handshake.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Handshake is not found in the empty JSON string", Handshake.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Handshake.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Handshake` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Handshake.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Handshake' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Handshake> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Handshake.class));

       return (TypeAdapter<T>) new TypeAdapter<Handshake>() {
           @Override
           public void write(JsonWriter out, Handshake value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Handshake read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Handshake given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Handshake
   * @throws IOException if the JSON string is invalid with respect to Handshake
   */
  public static Handshake fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Handshake.class);
  }

  /**
   * Convert an instance of Handshake to an JSON string
   *
   * @return JSON string
   */
