...
public class ListAccountsForParentResponse {
  ...
  public ListAccountsForParentResponse() {
  }

  public ListAccountsForParentResponse accounts(List accounts) {
  ...
  public ListAccountsForParentResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListAccountsForParentResponse listAccountsForParentResponse = (ListAccountsForParentResponse) o;
    return Objects.equals(this.accounts, listAccountsForParentResponse.accounts) &&
        Objects.equals(this.nextToken, listAccountsForParentResponse.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAccountsForParentResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAccountsForParentResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAccountsForParentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAccountsForParentResponse is not found in the empty JSON string", ListAccountsForParentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAccountsForParentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAccountsForParentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAccountsForParentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAccountsForParentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAccountsForParentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAccountsForParentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAccountsForParentResponse>() {
           @Override
           public void write(JsonWriter out, ListAccountsForParentResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAccountsForParentResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAccountsForParentResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAccountsForParentResponse
   * @throws IOException if the JSON string is invalid with respect to ListAccountsForParentResponse
   */
  public static ListAccountsForParentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAccountsForParentResponse.class);
  }

  /**
   * Convert an instance of ListAccountsForParentResponse to an JSON string
   *
   * @return JSON string
   */
