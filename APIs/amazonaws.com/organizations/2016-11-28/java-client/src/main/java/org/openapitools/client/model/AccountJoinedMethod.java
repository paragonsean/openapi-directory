...
/**
 * Gets or Sets AccountJoinedMethod
 */
@JsonAdapter(AccountJoinedMethod.Adapter.class)
public enum AccountJoinedMethod {
  ...
  AccountJoinedMethod(String value) {
    this.value = value;
  }
  ...
  public static AccountJoinedMethod fromValue(String value) {
    for (AccountJoinedMethod b : AccountJoinedMethod.values()) {
  ...
  public static class Adapter extends TypeAdapter<AccountJoinedMethod> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountJoinedMethod enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountJoinedMethod read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountJoinedMethod.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AccountJoinedMethod.fromValue(value);
  }
}
