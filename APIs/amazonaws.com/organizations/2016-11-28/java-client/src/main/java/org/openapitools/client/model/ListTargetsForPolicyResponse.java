...
public class ListTargetsForPolicyResponse {
  ...
  public ListTargetsForPolicyResponse targets(List targets) {
  ...
  public ListTargetsForPolicyResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.targets, listTargetsForPolicyResponse.targets) &&
        Objects.equals(this.nextToken, listTargetsForPolicyResponse.nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListTargetsForPolicyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListTargetsForPolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListTargetsForPolicyResponse is not found in the empty JSON string", ListTargetsForPolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListTargetsForPolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListTargetsForPolicyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListTargetsForPolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListTargetsForPolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListTargetsForPolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListTargetsForPolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListTargetsForPolicyResponse>() {
           @Override
           public void write(JsonWriter out, ListTargetsForPolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListTargetsForPolicyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListTargetsForPolicyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListTargetsForPolicyResponse
   * @throws IOException if the JSON string is invalid with respect to ListTargetsForPolicyResponse
   */
  public static ListTargetsForPolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTargetsForPolicyResponse.class);
  }

  /**
   * Convert an instance of ListTargetsForPolicyResponse to an JSON string
   *
   * @return JSON string
   */
