...
public class UpdatePolicyResponsePolicy {
  ...
  public UpdatePolicyResponsePolicy() {
  }

  public UpdatePolicyResponsePolicy policySummary(PolicyPolicySummary policySummary) {
  ...
  public UpdatePolicyResponsePolicy content(String content) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePolicyResponsePolicy updatePolicyResponsePolicy = (UpdatePolicyResponsePolicy) o;
    return Objects.equals(this.policySummary, updatePolicyResponsePolicy.policySummary) &&
        Objects.equals(this.content, updatePolicyResponsePolicy.content);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePolicyResponsePolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePolicyResponsePolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePolicyResponsePolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePolicyResponsePolicy is not found in the empty JSON string", UpdatePolicyResponsePolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePolicyResponsePolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePolicyResponsePolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePolicyResponsePolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePolicyResponsePolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePolicyResponsePolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePolicyResponsePolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePolicyResponsePolicy>() {
           @Override
           public void write(JsonWriter out, UpdatePolicyResponsePolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePolicyResponsePolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePolicyResponsePolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePolicyResponsePolicy
   * @throws IOException if the JSON string is invalid with respect to UpdatePolicyResponsePolicy
   */
  public static UpdatePolicyResponsePolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePolicyResponsePolicy.class);
  }

  /**
   * Convert an instance of UpdatePolicyResponsePolicy to an JSON string
   *
   * @return JSON string
   */
