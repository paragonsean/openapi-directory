...
public class ListRootsResponse {
  ...
  public ListRootsResponse roots(List roots) {
    this.roots = roots;
    return this;
  }
  ...
  public ListRootsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.roots, listRootsResponse.roots) &&
        Objects.equals(this.nextToken, listRootsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(roots, nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRootsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRootsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRootsResponse is not found in the empty JSON string", ListRootsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRootsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRootsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Roots`
      if (jsonObj.get("Roots") != null && !jsonObj.get("Roots").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Roots"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRootsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRootsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRootsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRootsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRootsResponse>() {
           @Override
           public void write(JsonWriter out, ListRootsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRootsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRootsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRootsResponse
   * @throws IOException if the JSON string is invalid with respect to ListRootsResponse
   */
  public static ListRootsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRootsResponse.class);
  }

  /**
   * Convert an instance of ListRootsResponse to an JSON string
   *
   * @return JSON string
   */
