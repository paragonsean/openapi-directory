...
public class CancelHandshakeResponseHandshake {
  ...
  public CancelHandshakeResponseHandshake() {
  }

  public CancelHandshakeResponseHandshake id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CancelHandshakeResponseHandshake arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CancelHandshakeResponseHandshake parties(List parties) {
  ...
  public CancelHandshakeResponseHandshake state(HandshakeState state) {
    this.state = state;
    return this;
  }
  ...
  public CancelHandshakeResponseHandshake requestedTimestamp(OffsetDateTime requestedTimestamp) {
  ...
  public CancelHandshakeResponseHandshake expirationTimestamp(OffsetDateTime expirationTimestamp) {
  ...
  public CancelHandshakeResponseHandshake action(ActionType action) {
    this.action = action;
    return this;
  }
  ...
  public CancelHandshakeResponseHandshake resources(List resources) {
  ...
  public boolean equals(Object o) {
    ...
    CancelHandshakeResponseHandshake cancelHandshakeResponseHandshake = (CancelHandshakeResponseHandshake) o;
    return Objects.equals(this.id, cancelHandshakeResponseHandshake.id) &&
        Objects.equals(this.arn, cancelHandshakeResponseHandshake.arn) &&
        Objects.equals(this.parties, cancelHandshakeResponseHandshake.parties) &&
        Objects.equals(this.state, cancelHandshakeResponseHandshake.state) &&
        Objects.equals(this.requestedTimestamp, cancelHandshakeResponseHandshake.requestedTimestamp) &&
        Objects.equals(this.expirationTimestamp, cancelHandshakeResponseHandshake.expirationTimestamp) &&
        Objects.equals(this.action, cancelHandshakeResponseHandshake.action) &&
        Objects.equals(this.resources, cancelHandshakeResponseHandshake.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelHandshakeResponseHandshake {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelHandshakeResponseHandshake
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelHandshakeResponseHandshake.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelHandshakeResponseHandshake is not found in the empty JSON string", CancelHandshakeResponseHandshake.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelHandshakeResponseHandshake.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelHandshakeResponseHandshake` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelHandshakeResponseHandshake.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelHandshakeResponseHandshake' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelHandshakeResponseHandshake> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelHandshakeResponseHandshake.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelHandshakeResponseHandshake>() {
           @Override
           public void write(JsonWriter out, CancelHandshakeResponseHandshake value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelHandshakeResponseHandshake read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelHandshakeResponseHandshake given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelHandshakeResponseHandshake
   * @throws IOException if the JSON string is invalid with respect to CancelHandshakeResponseHandshake
   */
  public static CancelHandshakeResponseHandshake fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelHandshakeResponseHandshake.class);
  }

  /**
   * Convert an instance of CancelHandshakeResponseHandshake to an JSON string
   *
   * @return JSON string
   */
