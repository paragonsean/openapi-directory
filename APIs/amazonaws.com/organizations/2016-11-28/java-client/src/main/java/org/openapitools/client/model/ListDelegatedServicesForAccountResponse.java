...
public class ListDelegatedServicesForAccountResponse {
  public static final String SERIALIZED_NAME_DELEGATED_SERVICES = "DelegatedServices";
  @SerializedName(SERIALIZED_NAME_DELEGATED_SERVICES)
  ...
  public ListDelegatedServicesForAccountResponse delegatedServices(List delegatedServices) {
  ...
  public List getDelegatedServices() {
    return delegatedServices;
  }

  public void setDelegatedServices(List delegatedServices) {
    this.delegatedServices = delegatedServices;
  }


  public ListDelegatedServicesForAccountResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListDelegatedServicesForAccountResponse listDelegatedServicesForAccountResponse = (ListDelegatedServicesForAccountResponse) o;
    return Objects.equals(this.delegatedServices, listDelegatedServicesForAccountResponse.delegatedServices) &&
        Objects.equals(this.nextToken, listDelegatedServicesForAccountResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(delegatedServices, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListDelegatedServicesForAccountResponse {\n");
  ...
  static {
    ...
    openapiFields.add("DelegatedServices");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListDelegatedServicesForAccountResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDelegatedServicesForAccountResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListDelegatedServicesForAccountResponse is not found in the empty JSON string", ListDelegatedServicesForAccountResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDelegatedServicesForAccountResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListDelegatedServicesForAccountResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `DelegatedServices`
      if (jsonObj.get("DelegatedServices") != null && !jsonObj.get("DelegatedServices").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("DelegatedServices"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDelegatedServicesForAccountResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDelegatedServicesForAccountResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDelegatedServicesForAccountResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDelegatedServicesForAccountResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDelegatedServicesForAccountResponse>() {
           @Override
           public void write(JsonWriter out, ListDelegatedServicesForAccountResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDelegatedServicesForAccountResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListDelegatedServicesForAccountResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListDelegatedServicesForAccountResponse
   * @throws IOException if the JSON string is invalid with respect to ListDelegatedServicesForAccountResponse
   */
  public static ListDelegatedServicesForAccountResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDelegatedServicesForAccountResponse.class);
  }

  /**
   * Convert an instance of ListDelegatedServicesForAccountResponse to an JSON string
   *
   * @return JSON string
   */
