...
public class RemoveAccountFromOrganizationRequest {
  ...
  public RemoveAccountFromOrganizationRequest() {
  }

  public RemoveAccountFromOrganizationRequest accountId(String accountId) {
  ...
  public boolean equals(Object o) {
    ...
    RemoveAccountFromOrganizationRequest removeAccountFromOrganizationRequest = (RemoveAccountFromOrganizationRequest) o;
    return Objects.equals(this.accountId, removeAccountFromOrganizationRequest.accountId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoveAccountFromOrganizationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveAccountFromOrganizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveAccountFromOrganizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveAccountFromOrganizationRequest is not found in the empty JSON string", RemoveAccountFromOrganizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveAccountFromOrganizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveAccountFromOrganizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RemoveAccountFromOrganizationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveAccountFromOrganizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveAccountFromOrganizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveAccountFromOrganizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveAccountFromOrganizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveAccountFromOrganizationRequest>() {
           @Override
           public void write(JsonWriter out, RemoveAccountFromOrganizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveAccountFromOrganizationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveAccountFromOrganizationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveAccountFromOrganizationRequest
   * @throws IOException if the JSON string is invalid with respect to RemoveAccountFromOrganizationRequest
   */
  public static RemoveAccountFromOrganizationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveAccountFromOrganizationRequest.class);
  }

  /**
   * Convert an instance of RemoveAccountFromOrganizationRequest to an JSON string
   *
   * @return JSON string
   */
