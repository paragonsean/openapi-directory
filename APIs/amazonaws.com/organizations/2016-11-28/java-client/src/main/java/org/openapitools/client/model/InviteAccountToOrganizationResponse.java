...
import org.openapitools.client.model.InviteAccountToOrganizationResponseHandshake;
...
public class InviteAccountToOrganizationResponse {
  ...
  private InviteAccountToOrganizationResponseHandshake handshake;

  public InviteAccountToOrganizationResponse() {
  }

  public InviteAccountToOrganizationResponse handshake(InviteAccountToOrganizationResponseHandshake handshake) {
  ...
  public InviteAccountToOrganizationResponseHandshake getHandshake() {
    return handshake;
  }

  public void setHandshake(InviteAccountToOrganizationResponseHandshake handshake) {
    this.handshake = handshake;
  }
  ...
  public boolean equals(Object o) {
    ...
    InviteAccountToOrganizationResponse inviteAccountToOrganizationResponse = (InviteAccountToOrganizationResponse) o;
    return Objects.equals(this.handshake, inviteAccountToOrganizationResponse.handshake);
  }
  ...
  public String toString() {
    ...
    sb.append("class InviteAccountToOrganizationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InviteAccountToOrganizationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InviteAccountToOrganizationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InviteAccountToOrganizationResponse is not found in the empty JSON string", InviteAccountToOrganizationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InviteAccountToOrganizationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InviteAccountToOrganizationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Handshake`
      if (jsonObj.get("Handshake") != null && !jsonObj.get("Handshake").isJsonNull()) {
        InviteAccountToOrganizationResponseHandshake.validateJsonElement(jsonObj.get("Handshake"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InviteAccountToOrganizationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InviteAccountToOrganizationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InviteAccountToOrganizationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InviteAccountToOrganizationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<InviteAccountToOrganizationResponse>() {
           @Override
           public void write(JsonWriter out, InviteAccountToOrganizationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InviteAccountToOrganizationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InviteAccountToOrganizationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InviteAccountToOrganizationResponse
   * @throws IOException if the JSON string is invalid with respect to InviteAccountToOrganizationResponse
   */
  public static InviteAccountToOrganizationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InviteAccountToOrganizationResponse.class);
  }

  /**
   * Convert an instance of InviteAccountToOrganizationResponse to an JSON string
   *
   * @return JSON string
   */
