 ...
 */
@JsonAdapter(ChildType.Adapter.class)
public enum ChildType {
  ...
  public static ChildType fromValue(String value) {
    for (ChildType b : ChildType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ChildType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChildType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ChildType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ChildType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ChildType.fromValue(value);
  }
}
