...
public class ListDelegatedServicesForAccountRequest {
  ...
  public ListDelegatedServicesForAccountRequest accountId(String accountId) {
  ...
  public ListDelegatedServicesForAccountRequest nextToken(String nextToken) {
  ...
  public ListDelegatedServicesForAccountRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListDelegatedServicesForAccountRequest listDelegatedServicesForAccountRequest = (ListDelegatedServicesForAccountRequest) o;
    return Objects.equals(this.accountId, listDelegatedServicesForAccountRequest.accountId) &&
        Objects.equals(this.nextToken, listDelegatedServicesForAccountRequest.nextToken) &&
        Objects.equals(this.maxResults, listDelegatedServicesForAccountRequest.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListDelegatedServicesForAccountRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListDelegatedServicesForAccountRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDelegatedServicesForAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListDelegatedServicesForAccountRequest is not found in the empty JSON string", ListDelegatedServicesForAccountRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDelegatedServicesForAccountRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListDelegatedServicesForAccountRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListDelegatedServicesForAccountRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDelegatedServicesForAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDelegatedServicesForAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDelegatedServicesForAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDelegatedServicesForAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDelegatedServicesForAccountRequest>() {
           @Override
           public void write(JsonWriter out, ListDelegatedServicesForAccountRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDelegatedServicesForAccountRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListDelegatedServicesForAccountRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListDelegatedServicesForAccountRequest
   * @throws IOException if the JSON string is invalid with respect to ListDelegatedServicesForAccountRequest
   */
  public static ListDelegatedServicesForAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDelegatedServicesForAccountRequest.class);
  }

  /**
   * Convert an instance of ListDelegatedServicesForAccountRequest to an JSON string
   *
   * @return JSON string
   */
