...
import org.openapitools.client.model.PolicyPolicySummary;
...
public class CreatePolicyResponsePolicy {
  public static final String SERIALIZED_NAME_POLICY_SUMMARY = "PolicySummary";
  @SerializedName(SERIALIZED_NAME_POLICY_SUMMARY)
  private PolicyPolicySummary policySummary;

  public static final String SERIALIZED_NAME_CONTENT = "Content";
  @SerializedName(SERIALIZED_NAME_CONTENT)
  private String content;

  public CreatePolicyResponsePolicy() {
  }

  public CreatePolicyResponsePolicy policySummary(PolicyPolicySummary policySummary) {
  ...
  public PolicyPolicySummary getPolicySummary() {
    return policySummary;
  }

  public void setPolicySummary(PolicyPolicySummary policySummary) {
    this.policySummary = policySummary;
  }


  public CreatePolicyResponsePolicy content(String content) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePolicyResponsePolicy createPolicyResponsePolicy = (CreatePolicyResponsePolicy) o;
    return Objects.equals(this.policySummary, createPolicyResponsePolicy.policySummary) &&
        Objects.equals(this.content, createPolicyResponsePolicy.content);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policySummary, content);
  }
  ...
  static {
    ...
    openapiFields.add("PolicySummary");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePolicyResponsePolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePolicyResponsePolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePolicyResponsePolicy is not found in the empty JSON string", CreatePolicyResponsePolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePolicyResponsePolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePolicyResponsePolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `PolicySummary`
      if (jsonObj.get("PolicySummary") != null && !jsonObj.get("PolicySummary").isJsonNull()) {
        PolicyPolicySummary.validateJsonElement(jsonObj.get("PolicySummary"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePolicyResponsePolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePolicyResponsePolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePolicyResponsePolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePolicyResponsePolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePolicyResponsePolicy>() {
           @Override
           public void write(JsonWriter out, CreatePolicyResponsePolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePolicyResponsePolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePolicyResponsePolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePolicyResponsePolicy
   * @throws IOException if the JSON string is invalid with respect to CreatePolicyResponsePolicy
   */
  public static CreatePolicyResponsePolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePolicyResponsePolicy.class);
  }

  /**
   * Convert an instance of CreatePolicyResponsePolicy to an JSON string
   *
   * @return JSON string
   */
