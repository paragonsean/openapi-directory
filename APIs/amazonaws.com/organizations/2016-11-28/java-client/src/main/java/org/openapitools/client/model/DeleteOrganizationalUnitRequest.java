...
public class DeleteOrganizationalUnitRequest {
  ...
  public DeleteOrganizationalUnitRequest organizationalUnitId(String organizationalUnitId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.organizationalUnitId, deleteOrganizationalUnitRequest.organizationalUnitId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteOrganizationalUnitRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteOrganizationalUnitRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteOrganizationalUnitRequest is not found in the empty JSON string", DeleteOrganizationalUnitRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteOrganizationalUnitRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteOrganizationalUnitRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteOrganizationalUnitRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteOrganizationalUnitRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteOrganizationalUnitRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteOrganizationalUnitRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteOrganizationalUnitRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteOrganizationalUnitRequest>() {
           @Override
           public void write(JsonWriter out, DeleteOrganizationalUnitRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteOrganizationalUnitRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteOrganizationalUnitRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteOrganizationalUnitRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteOrganizationalUnitRequest
   */
  public static DeleteOrganizationalUnitRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteOrganizationalUnitRequest.class);
  }

  /**
   * Convert an instance of DeleteOrganizationalUnitRequest to an JSON string
   *
   * @return JSON string
   */
