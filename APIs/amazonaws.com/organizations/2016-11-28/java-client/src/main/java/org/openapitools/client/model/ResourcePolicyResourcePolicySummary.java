...
public class ResourcePolicyResourcePolicySummary {
  ...
  public ResourcePolicyResourcePolicySummary() {
  }

  public ResourcePolicyResourcePolicySummary id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ResourcePolicyResourcePolicySummary arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResourcePolicyResourcePolicySummary resourcePolicyResourcePolicySummary = (ResourcePolicyResourcePolicySummary) o;
    return Objects.equals(this.id, resourcePolicyResourcePolicySummary.id) &&
        Objects.equals(this.arn, resourcePolicyResourcePolicySummary.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourcePolicyResourcePolicySummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourcePolicyResourcePolicySummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourcePolicyResourcePolicySummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourcePolicyResourcePolicySummary is not found in the empty JSON string", ResourcePolicyResourcePolicySummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourcePolicyResourcePolicySummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourcePolicyResourcePolicySummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourcePolicyResourcePolicySummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourcePolicyResourcePolicySummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourcePolicyResourcePolicySummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourcePolicyResourcePolicySummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourcePolicyResourcePolicySummary>() {
           @Override
           public void write(JsonWriter out, ResourcePolicyResourcePolicySummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourcePolicyResourcePolicySummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourcePolicyResourcePolicySummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourcePolicyResourcePolicySummary
   * @throws IOException if the JSON string is invalid with respect to ResourcePolicyResourcePolicySummary
   */
  public static ResourcePolicyResourcePolicySummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourcePolicyResourcePolicySummary.class);
  }

  /**
   * Convert an instance of ResourcePolicyResourcePolicySummary to an JSON string
   *
   * @return JSON string
   */
