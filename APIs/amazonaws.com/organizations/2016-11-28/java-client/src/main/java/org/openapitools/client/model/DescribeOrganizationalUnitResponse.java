...
public class DescribeOrganizationalUnitResponse {
  ...
  private DescribeOrganizationalUnitResponseOrganizationalUnit organizationalUnit;

  public DescribeOrganizationalUnitResponse() {
  }

  public DescribeOrganizationalUnitResponse organizationalUnit(DescribeOrganizationalUnitResponseOrganizationalUnit organizationalUnit) {
  ...
  public DescribeOrganizationalUnitResponseOrganizationalUnit getOrganizationalUnit() {
    return organizationalUnit;
  }

  public void setOrganizationalUnit(DescribeOrganizationalUnitResponseOrganizationalUnit organizationalUnit) {
    this.organizationalUnit = organizationalUnit;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.organizationalUnit, describeOrganizationalUnitResponse.organizationalUnit);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeOrganizationalUnitResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeOrganizationalUnitResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeOrganizationalUnitResponse is not found in the empty JSON string", DescribeOrganizationalUnitResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeOrganizationalUnitResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeOrganizationalUnitResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("OrganizationalUnit") != null && !jsonObj.get("OrganizationalUnit").isJsonNull()) {
        DescribeOrganizationalUnitResponseOrganizationalUnit.validateJsonElement(jsonObj.get("OrganizationalUnit"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeOrganizationalUnitResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeOrganizationalUnitResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeOrganizationalUnitResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeOrganizationalUnitResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeOrganizationalUnitResponse>() {
           @Override
           public void write(JsonWriter out, DescribeOrganizationalUnitResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeOrganizationalUnitResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeOrganizationalUnitResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeOrganizationalUnitResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeOrganizationalUnitResponse
   */
  public static DescribeOrganizationalUnitResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeOrganizationalUnitResponse.class);
  }

  /**
   * Convert an instance of DescribeOrganizationalUnitResponse to an JSON string
   *
   * @return JSON string
   */
