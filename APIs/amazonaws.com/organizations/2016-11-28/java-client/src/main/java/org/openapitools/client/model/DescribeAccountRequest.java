...
public class DescribeAccountRequest {
  ...
  public DescribeAccountRequest() {
  }

  public DescribeAccountRequest accountId(String accountId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAccountRequest describeAccountRequest = (DescribeAccountRequest) o;
    return Objects.equals(this.accountId, describeAccountRequest.accountId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeAccountRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAccountRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAccountRequest is not found in the empty JSON string", DescribeAccountRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAccountRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAccountRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeAccountRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAccountRequest>() {
           @Override
           public void write(JsonWriter out, DescribeAccountRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAccountRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAccountRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAccountRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeAccountRequest
   */
  public static DescribeAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAccountRequest.class);
  }

  /**
   * Convert an instance of DescribeAccountRequest to an JSON string
   *
   * @return JSON string
   */
