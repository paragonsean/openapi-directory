...
public class UpdateOrganizationalUnitResponseOrganizationalUnit {
  ...
  public UpdateOrganizationalUnitResponseOrganizationalUnit() {
  }

  public UpdateOrganizationalUnitResponseOrganizationalUnit id(String id) {
    this.id = id;
    return this;
  }
  ...
  public UpdateOrganizationalUnitResponseOrganizationalUnit arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateOrganizationalUnitResponseOrganizationalUnit name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateOrganizationalUnitResponseOrganizationalUnit updateOrganizationalUnitResponseOrganizationalUnit = (UpdateOrganizationalUnitResponseOrganizationalUnit) o;
    return Objects.equals(this.id, updateOrganizationalUnitResponseOrganizationalUnit.id) &&
        Objects.equals(this.arn, updateOrganizationalUnitResponseOrganizationalUnit.arn) &&
        Objects.equals(this.name, updateOrganizationalUnitResponseOrganizationalUnit.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateOrganizationalUnitResponseOrganizationalUnit {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateOrganizationalUnitResponseOrganizationalUnit
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateOrganizationalUnitResponseOrganizationalUnit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateOrganizationalUnitResponseOrganizationalUnit is not found in the empty JSON string", UpdateOrganizationalUnitResponseOrganizationalUnit.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateOrganizationalUnitResponseOrganizationalUnit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateOrganizationalUnitResponseOrganizationalUnit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateOrganizationalUnitResponseOrganizationalUnit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateOrganizationalUnitResponseOrganizationalUnit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateOrganizationalUnitResponseOrganizationalUnit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateOrganizationalUnitResponseOrganizationalUnit.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateOrganizationalUnitResponseOrganizationalUnit>() {
           @Override
           public void write(JsonWriter out, UpdateOrganizationalUnitResponseOrganizationalUnit value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateOrganizationalUnitResponseOrganizationalUnit read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateOrganizationalUnitResponseOrganizationalUnit given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateOrganizationalUnitResponseOrganizationalUnit
   * @throws IOException if the JSON string is invalid with respect to UpdateOrganizationalUnitResponseOrganizationalUnit
   */
  public static UpdateOrganizationalUnitResponseOrganizationalUnit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateOrganizationalUnitResponseOrganizationalUnit.class);
  }

  /**
   * Convert an instance of UpdateOrganizationalUnitResponseOrganizationalUnit to an JSON string
   *
   * @return JSON string
   */
