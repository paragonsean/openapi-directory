...
public class OrganizationalUnit {
  ...
  public OrganizationalUnit id(String id) {
    this.id = id;
    return this;
  }
  ...
  public OrganizationalUnit arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, organizationalUnit.id) &&
        Objects.equals(this.arn, organizationalUnit.arn) &&
        Objects.equals(this.name, organizationalUnit.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationalUnit
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationalUnit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationalUnit is not found in the empty JSON string", OrganizationalUnit.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationalUnit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationalUnit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationalUnit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationalUnit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationalUnit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationalUnit.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationalUnit>() {
           @Override
           public void write(JsonWriter out, OrganizationalUnit value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationalUnit read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationalUnit given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationalUnit
   * @throws IOException if the JSON string is invalid with respect to OrganizationalUnit
   */
  public static OrganizationalUnit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationalUnit.class);
  }

  /**
   * Convert an instance of OrganizationalUnit to an JSON string
   *
   * @return JSON string
   */
