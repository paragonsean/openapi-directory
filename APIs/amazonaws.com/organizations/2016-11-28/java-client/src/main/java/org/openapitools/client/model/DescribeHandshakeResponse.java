...
public class DescribeHandshakeResponse {
  ...
  private DescribeHandshakeResponseHandshake handshake;

  public DescribeHandshakeResponse() {
  }

  public DescribeHandshakeResponse handshake(DescribeHandshakeResponseHandshake handshake) {
  ...
  public DescribeHandshakeResponseHandshake getHandshake() {
    return handshake;
  }

  public void setHandshake(DescribeHandshakeResponseHandshake handshake) {
    this.handshake = handshake;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeHandshakeResponse describeHandshakeResponse = (DescribeHandshakeResponse) o;
    return Objects.equals(this.handshake, describeHandshakeResponse.handshake);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeHandshakeResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeHandshakeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeHandshakeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeHandshakeResponse is not found in the empty JSON string", DescribeHandshakeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeHandshakeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeHandshakeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Handshake`
      if (jsonObj.get("Handshake") != null && !jsonObj.get("Handshake").isJsonNull()) {
        DescribeHandshakeResponseHandshake.validateJsonElement(jsonObj.get("Handshake"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeHandshakeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeHandshakeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeHandshakeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeHandshakeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeHandshakeResponse>() {
           @Override
           public void write(JsonWriter out, DescribeHandshakeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeHandshakeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeHandshakeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeHandshakeResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeHandshakeResponse
   */
  public static DescribeHandshakeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeHandshakeResponse.class);
  }

  /**
   * Convert an instance of DescribeHandshakeResponse to an JSON string
   *
   * @return JSON string
   */
