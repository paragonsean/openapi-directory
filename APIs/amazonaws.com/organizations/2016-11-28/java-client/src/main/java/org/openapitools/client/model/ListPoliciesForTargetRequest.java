...
public class ListPoliciesForTargetRequest {
  ...
  public ListPoliciesForTargetRequest filter(PolicyType filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ListPoliciesForTargetRequest nextToken(String nextToken) {
  ...
  public ListPoliciesForTargetRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.targetId, listPoliciesForTargetRequest.targetId) &&
        Objects.equals(this.filter, listPoliciesForTargetRequest.filter) &&
        Objects.equals(this.nextToken, listPoliciesForTargetRequest.nextToken) &&
        Objects.equals(this.maxResults, listPoliciesForTargetRequest.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(targetId, filter, nextToken, maxResults);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPoliciesForTargetRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPoliciesForTargetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPoliciesForTargetRequest is not found in the empty JSON string", ListPoliciesForTargetRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPoliciesForTargetRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPoliciesForTargetRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListPoliciesForTargetRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPoliciesForTargetRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPoliciesForTargetRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPoliciesForTargetRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPoliciesForTargetRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPoliciesForTargetRequest>() {
           @Override
           public void write(JsonWriter out, ListPoliciesForTargetRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPoliciesForTargetRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPoliciesForTargetRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPoliciesForTargetRequest
   * @throws IOException if the JSON string is invalid with respect to ListPoliciesForTargetRequest
   */
  public static ListPoliciesForTargetRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPoliciesForTargetRequest.class);
  }

  /**
   * Convert an instance of ListPoliciesForTargetRequest to an JSON string
   *
   * @return JSON string
   */
