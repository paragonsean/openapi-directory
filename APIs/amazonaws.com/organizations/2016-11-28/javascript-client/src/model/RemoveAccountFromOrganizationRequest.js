...
/**
 * The RemoveAccountFromOrganizationRequest model module.
 * @module model/RemoveAccountFromOrganizationRequest
 * @version 2016-11-28
 */
class RemoveAccountFromOrganizationRequest {
    /**
     * Constructs a new <code>RemoveAccountFromOrganizationRequest</code>.
     * @alias module:model/RemoveAccountFromOrganizationRequest
     * @param accountId {String} 
     */
    constructor(accountId) { 
        
        RemoveAccountFromOrganizationRequest.initialize(this, accountId);
    }
    ...
    /**
     * Constructs a <code>RemoveAccountFromOrganizationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveAccountFromOrganizationRequest} obj Optional instance to populate.
     * @return {module:model/RemoveAccountFromOrganizationRequest} The populated <code>RemoveAccountFromOrganizationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveAccountFromOrganizationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveAccountFromOrganizationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveAccountFromOrganizationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RemoveAccountFromOrganizationRequest.RequiredProperties) {
...
RemoveAccountFromOrganizationRequest.RequiredProperties = ["AccountId"];

/**
 * @member {String} AccountId
 */
RemoveAccountFromOrganizationRequest.prototype['AccountId'] = undefined;
...
export default RemoveAccountFromOrganizationRequest;
