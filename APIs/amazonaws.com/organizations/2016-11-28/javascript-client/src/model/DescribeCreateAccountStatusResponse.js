...
import DescribeCreateAccountStatusResponseCreateAccountStatus from './DescribeCreateAccountStatusResponseCreateAccountStatus';

/**
 * The DescribeCreateAccountStatusResponse model module.
 * @module model/DescribeCreateAccountStatusResponse
 * @version 2016-11-28
 */
class DescribeCreateAccountStatusResponse {
    /**
     * Constructs a new <code>DescribeCreateAccountStatusResponse</code>.
     * @alias module:model/DescribeCreateAccountStatusResponse
     */
    constructor() { 
        
        DescribeCreateAccountStatusResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeCreateAccountStatusResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCreateAccountStatusResponse} obj Optional instance to populate.
     * @return {module:model/DescribeCreateAccountStatusResponse} The populated <code>DescribeCreateAccountStatusResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCreateAccountStatusResponse();

            if (data.hasOwnProperty('CreateAccountStatus')) {
                obj['CreateAccountStatus'] = DescribeCreateAccountStatusResponseCreateAccountStatus.constructFromObject(data['CreateAccountStatus']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCreateAccountStatusResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCreateAccountStatusResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CreateAccountStatus`
        if (data['CreateAccountStatus']) { // data not null
          DescribeCreateAccountStatusResponseCreateAccountStatus.validateJSON(data['CreateAccountStatus']);
        }
...
/**
 * @member {module:model/DescribeCreateAccountStatusResponseCreateAccountStatus} CreateAccountStatus
 */
DescribeCreateAccountStatusResponse.prototype['CreateAccountStatus'] = undefined;
...
export default DescribeCreateAccountStatusResponse;
