...
/**
 * The CreateOrganizationalUnitRequest model module.
 * @module model/CreateOrganizationalUnitRequest
 * @version 2016-11-28
 */
class CreateOrganizationalUnitRequest {
    /**
     * Constructs a new <code>CreateOrganizationalUnitRequest</code>.
     * @alias module:model/CreateOrganizationalUnitRequest
     * @param parentId {String} 
     * @param name {String} 
     */
    constructor(parentId, name) { 
        
        CreateOrganizationalUnitRequest.initialize(this, parentId, name);
    }
     ...
     */
    static initialize(obj, parentId, name) { 
        obj['ParentId'] = parentId;
        obj['Name'] = name;
    }

    /**
     * Constructs a <code>CreateOrganizationalUnitRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateOrganizationalUnitRequest} obj Optional instance to populate.
     * @return {module:model/CreateOrganizationalUnitRequest} The populated <code>CreateOrganizationalUnitRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateOrganizationalUnitRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateOrganizationalUnitRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateOrganizationalUnitRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateOrganizationalUnitRequest.RequiredProperties) {
...
CreateOrganizationalUnitRequest.RequiredProperties = ["ParentId", "Name"];

/**
 * @member {String} ParentId
 */
CreateOrganizationalUnitRequest.prototype['ParentId'] = undefined;

/**
 * @member {String} Name
 */
CreateOrganizationalUnitRequest.prototype['Name'] = undefined;

/**
 * @member {Array} Tags
 */
CreateOrganizationalUnitRequest.prototype['Tags'] = undefined;
...
export default CreateOrganizationalUnitRequest;
