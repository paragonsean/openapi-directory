...
* @readonly
*/
export default class PolicyTypeStatus {
    ...
    /**
    * Returns a <code>PolicyTypeStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PolicyTypeStatus} The enum <code>PolicyTypeStatus</code> value.
    */
