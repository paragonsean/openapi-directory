...
/**
 * The EnableAWSServiceAccessRequest model module.
 * @module model/EnableAWSServiceAccessRequest
 * @version 2016-11-28
 */
class EnableAWSServiceAccessRequest {
    /**
     * Constructs a new <code>EnableAWSServiceAccessRequest</code>.
     * @alias module:model/EnableAWSServiceAccessRequest
     * @param servicePrincipal {String} 
     */
    constructor(servicePrincipal) { 
        
        EnableAWSServiceAccessRequest.initialize(this, servicePrincipal);
    }
    ...
    /**
     * Constructs a <code>EnableAWSServiceAccessRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnableAWSServiceAccessRequest} obj Optional instance to populate.
     * @return {module:model/EnableAWSServiceAccessRequest} The populated <code>EnableAWSServiceAccessRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnableAWSServiceAccessRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>EnableAWSServiceAccessRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnableAWSServiceAccessRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EnableAWSServiceAccessRequest.RequiredProperties) {
...
EnableAWSServiceAccessRequest.RequiredProperties = ["ServicePrincipal"];

/**
 * @member {String} ServicePrincipal
 */
EnableAWSServiceAccessRequest.prototype['ServicePrincipal'] = undefined;
...
export default EnableAWSServiceAccessRequest;
