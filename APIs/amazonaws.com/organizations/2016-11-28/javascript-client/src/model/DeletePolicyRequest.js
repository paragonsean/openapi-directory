...
class DeletePolicyRequest {
    ...
    constructor(policyId) { 
        ...
        DeletePolicyRequest.initialize(this, policyId);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePolicyRequest.RequiredProperties) {
...
DeletePolicyRequest.RequiredProperties = ["PolicyId"];

/**
 * @member {String} PolicyId
 */
DeletePolicyRequest.prototype['PolicyId'] = undefined;
