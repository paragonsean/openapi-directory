...
/**
 * The DeleteOrganizationalUnitRequest model module.
 * @module model/DeleteOrganizationalUnitRequest
 * @version 2016-11-28
 */
class DeleteOrganizationalUnitRequest {
    /**
     * Constructs a new <code>DeleteOrganizationalUnitRequest</code>.
     * @alias module:model/DeleteOrganizationalUnitRequest
     * @param organizationalUnitId {String} 
     */
    constructor(organizationalUnitId) { 
        
        DeleteOrganizationalUnitRequest.initialize(this, organizationalUnitId);
    }
    ...
    /**
     * Constructs a <code>DeleteOrganizationalUnitRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteOrganizationalUnitRequest} obj Optional instance to populate.
     * @return {module:model/DeleteOrganizationalUnitRequest} The populated <code>DeleteOrganizationalUnitRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteOrganizationalUnitRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteOrganizationalUnitRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteOrganizationalUnitRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteOrganizationalUnitRequest.RequiredProperties) {
...
DeleteOrganizationalUnitRequest.RequiredProperties = ["OrganizationalUnitId"];

/**
 * @member {String} OrganizationalUnitId
 */
DeleteOrganizationalUnitRequest.prototype['OrganizationalUnitId'] = undefined;
...
export default DeleteOrganizationalUnitRequest;
