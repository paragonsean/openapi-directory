...
/**
 * The AcceptHandshakeResponseHandshake model module.
 * @module model/AcceptHandshakeResponseHandshake
 * @version 2016-11-28
 */
class AcceptHandshakeResponseHandshake {
    /**
     * Constructs a new <code>AcceptHandshakeResponseHandshake</code>.
     * @alias module:model/AcceptHandshakeResponseHandshake
     * @implements module:model/Handshake
     */
    constructor() { 
        Handshake.initialize(this);
        AcceptHandshakeResponseHandshake.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AcceptHandshakeResponseHandshake</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AcceptHandshakeResponseHandshake} obj Optional instance to populate.
     * @return {module:model/AcceptHandshakeResponseHandshake} The populated <code>AcceptHandshakeResponseHandshake</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AcceptHandshakeResponseHandshake();
    ...
    /**
     * Validates the JSON data with respect to <code>AcceptHandshakeResponseHandshake</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AcceptHandshakeResponseHandshake</code>.
     */
 ...
 * @member {String} Id
 */
AcceptHandshakeResponseHandshake.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
AcceptHandshakeResponseHandshake.prototype['Arn'] = undefined;

/**
 * @member {Array} Parties
 */
AcceptHandshakeResponseHandshake.prototype['Parties'] = undefined;

/**
 * @member {module:model/HandshakeState} State
 */
AcceptHandshakeResponseHandshake.prototype['State'] = undefined;

/**
 * @member {Date} RequestedTimestamp
 */
AcceptHandshakeResponseHandshake.prototype['RequestedTimestamp'] = undefined;

/**
 * @member {Date} ExpirationTimestamp
 */
AcceptHandshakeResponseHandshake.prototype['ExpirationTimestamp'] = undefined;

/**
 * @member {module:model/ActionType} Action
 */
AcceptHandshakeResponseHandshake.prototype['Action'] = undefined;

/**
 * @member {Array} Resources
 */
AcceptHandshakeResponseHandshake.prototype['Resources'] = undefined;
...
export default AcceptHandshakeResponseHandshake;
