...
import HandshakeResourceType from './HandshakeResourceType';

/**
 * The HandshakeResource model module.
 * @module model/HandshakeResource
 * @version 2016-11-28
 */
class HandshakeResource {
    /**
     * Constructs a new <code>HandshakeResource</code>.
     * Contains additional data that is needed to process a handshake.
     * @alias module:model/HandshakeResource
     */
    constructor() { 
        
        HandshakeResource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HandshakeResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HandshakeResource} obj Optional instance to populate.
     * @return {module:model/HandshakeResource} The populated <code>HandshakeResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HandshakeResource();

            if (data.hasOwnProperty('Value')) {
                obj['Value'] = ApiClient.convertToType(data['Value'], 'String');
            }
            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], HandshakeResourceType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>HandshakeResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HandshakeResource</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Type']) { // data not null
          HandshakeResourceType.validateJSON(data['Type']);
        }
 ...
 * @member {String} Value
 */
HandshakeResource.prototype['Value'] = undefined;

/**
 * @member {module:model/HandshakeResourceType} Type
 */
HandshakeResource.prototype['Type'] = undefined;

/**
 * @member {Array} Resources
 */
HandshakeResource.prototype['Resources'] = undefined;
...
export default HandshakeResource;
