...
import CreatePolicyResponsePolicy from './CreatePolicyResponsePolicy';

/**
 * The CreatePolicyResponse model module.
 * @module model/CreatePolicyResponse
 * @version 2016-11-28
 */
class CreatePolicyResponse {
    /**
     * Constructs a new <code>CreatePolicyResponse</code>.
     * @alias module:model/CreatePolicyResponse
     */
    constructor() { 
        
        CreatePolicyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePolicyResponse} obj Optional instance to populate.
     * @return {module:model/CreatePolicyResponse} The populated <code>CreatePolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePolicyResponse();

            if (data.hasOwnProperty('Policy')) {
                obj['Policy'] = CreatePolicyResponsePolicy.constructFromObject(data['Policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePolicyResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Policy`
        if (data['Policy']) { // data not null
          CreatePolicyResponsePolicy.validateJSON(data['Policy']);
        }
...
/**
 * @member {module:model/CreatePolicyResponsePolicy} Policy
 */
CreatePolicyResponse.prototype['Policy'] = undefined;
...
export default CreatePolicyResponse;
