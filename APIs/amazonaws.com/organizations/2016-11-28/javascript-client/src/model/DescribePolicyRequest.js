...
/**
 * The DescribePolicyRequest model module.
 * @module model/DescribePolicyRequest
 * @version 2016-11-28
 */
class DescribePolicyRequest {
    /**
     * Constructs a new <code>DescribePolicyRequest</code>.
     * @alias module:model/DescribePolicyRequest
     * @param policyId {String} 
     */
    constructor(policyId) { 
        
        DescribePolicyRequest.initialize(this, policyId);
    }
    ...
    /**
     * Constructs a <code>DescribePolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePolicyRequest} obj Optional instance to populate.
     * @return {module:model/DescribePolicyRequest} The populated <code>DescribePolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribePolicyRequest.RequiredProperties) {
...
DescribePolicyRequest.RequiredProperties = ["PolicyId"];

/**
 * @member {String} PolicyId
 */
DescribePolicyRequest.prototype['PolicyId'] = undefined;
...
export default DescribePolicyRequest;
