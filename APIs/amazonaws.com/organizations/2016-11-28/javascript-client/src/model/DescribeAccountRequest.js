...
/**
 * The DescribeAccountRequest model module.
 * @module model/DescribeAccountRequest
 * @version 2016-11-28
 */
class DescribeAccountRequest {
    /**
     * Constructs a new <code>DescribeAccountRequest</code>.
     * @alias module:model/DescribeAccountRequest
     * @param accountId {String} 
     */
    constructor(accountId) { 
        
        DescribeAccountRequest.initialize(this, accountId);
    }
    ...
    /**
     * Constructs a <code>DescribeAccountRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAccountRequest} obj Optional instance to populate.
     * @return {module:model/DescribeAccountRequest} The populated <code>DescribeAccountRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAccountRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAccountRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAccountRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeAccountRequest.RequiredProperties) {
...
DescribeAccountRequest.RequiredProperties = ["AccountId"];

/**
 * @member {String} AccountId
 */
DescribeAccountRequest.prototype['AccountId'] = undefined;
...
export default DescribeAccountRequest;
