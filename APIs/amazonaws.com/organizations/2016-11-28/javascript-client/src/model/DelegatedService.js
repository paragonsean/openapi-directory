...
/**
 * The DelegatedService model module.
 * @module model/DelegatedService
 * @version 2016-11-28
 */
class DelegatedService {
    /**
     * Constructs a new <code>DelegatedService</code>.
     * Contains information about the Amazon Web Services service for which the account is a delegated administrator.
     * @alias module:model/DelegatedService
     */
    constructor() { 
        
        DelegatedService.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DelegatedService</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DelegatedService} obj Optional instance to populate.
     * @return {module:model/DelegatedService} The populated <code>DelegatedService</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DelegatedService();

            if (data.hasOwnProperty('ServicePrincipal')) {
                obj['ServicePrincipal'] = ApiClient.convertToType(data['ServicePrincipal'], 'String');
            }
            if (data.hasOwnProperty('DelegationEnabledDate')) {
                obj['DelegationEnabledDate'] = ApiClient.convertToType(data['DelegationEnabledDate'], 'Date');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DelegatedService</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DelegatedService</code>.
     */
    static validateJSON(data) {
        ...
        if (data['DelegationEnabledDate']) { // data not null
          Date.validateJSON(data['DelegationEnabledDate']);
        }
 ...
 */
DelegatedService.prototype['ServicePrincipal'] = undefined;

/**
 * @member {Date} DelegationEnabledDate
 */
DelegatedService.prototype['DelegationEnabledDate'] = undefined;
...
export default DelegatedService;
