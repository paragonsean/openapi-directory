...
/**
 * The ListChildrenResponse model module.
 * @module model/ListChildrenResponse
 * @version 2016-11-28
 */
class ListChildrenResponse {
    /**
     * Constructs a new <code>ListChildrenResponse</code>.
     * @alias module:model/ListChildrenResponse
     */
    constructor() { 
        
        ListChildrenResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListChildrenResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListChildrenResponse} obj Optional instance to populate.
     * @return {module:model/ListChildrenResponse} The populated <code>ListChildrenResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListChildrenResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListChildrenResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListChildrenResponse</code>.
     */
 ...
 */
ListChildrenResponse.prototype['Children'] = undefined;

/**
 * @member {String} NextToken
 */
ListChildrenResponse.prototype['NextToken'] = undefined;
...
export default ListChildrenResponse;
