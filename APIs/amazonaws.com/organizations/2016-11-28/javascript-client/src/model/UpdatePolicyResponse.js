...
import UpdatePolicyResponsePolicy from './UpdatePolicyResponsePolicy';

/**
 * The UpdatePolicyResponse model module.
 * @module model/UpdatePolicyResponse
 * @version 2016-11-28
 */
class UpdatePolicyResponse {
    /**
     * Constructs a new <code>UpdatePolicyResponse</code>.
     * @alias module:model/UpdatePolicyResponse
     */
    constructor() { 
        
        UpdatePolicyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePolicyResponse} obj Optional instance to populate.
     * @return {module:model/UpdatePolicyResponse} The populated <code>UpdatePolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePolicyResponse();

            if (data.hasOwnProperty('Policy')) {
                obj['Policy'] = UpdatePolicyResponsePolicy.constructFromObject(data['Policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePolicyResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Policy`
        if (data['Policy']) { // data not null
          UpdatePolicyResponsePolicy.validateJSON(data['Policy']);
        }
...
/**
 * @member {module:model/UpdatePolicyResponsePolicy} Policy
 */
UpdatePolicyResponse.prototype['Policy'] = undefined;
...
export default UpdatePolicyResponse;
