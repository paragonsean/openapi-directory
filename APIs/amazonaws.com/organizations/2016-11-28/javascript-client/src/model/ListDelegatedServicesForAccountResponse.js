...
/**
 * The ListDelegatedServicesForAccountResponse model module.
 * @module model/ListDelegatedServicesForAccountResponse
 * @version 2016-11-28
 */
class ListDelegatedServicesForAccountResponse {
    /**
     * Constructs a new <code>ListDelegatedServicesForAccountResponse</code>.
     * @alias module:model/ListDelegatedServicesForAccountResponse
     */
    constructor() { 
        
        ListDelegatedServicesForAccountResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListDelegatedServicesForAccountResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDelegatedServicesForAccountResponse} obj Optional instance to populate.
     * @return {module:model/ListDelegatedServicesForAccountResponse} The populated <code>ListDelegatedServicesForAccountResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDelegatedServicesForAccountResponse();

            if (data.hasOwnProperty('DelegatedServices')) {
                obj['DelegatedServices'] = ApiClient.convertToType(data['DelegatedServices'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListDelegatedServicesForAccountResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDelegatedServicesForAccountResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `DelegatedServices`
        if (data['DelegatedServices']) { // data not null
          Array.validateJSON(data['DelegatedServices']);
        }
...
/**
 * @member {Array} DelegatedServices
 */
ListDelegatedServicesForAccountResponse.prototype['DelegatedServices'] = undefined;

/**
 * @member {String} NextToken
 */
ListDelegatedServicesForAccountResponse.prototype['NextToken'] = undefined;
...
export default ListDelegatedServicesForAccountResponse;
