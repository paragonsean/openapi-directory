...
/**
 * The ListDelegatedAdministratorsRequest model module.
 * @module model/ListDelegatedAdministratorsRequest
 * @version 2016-11-28
 */
class ListDelegatedAdministratorsRequest {
    /**
     * Constructs a new <code>ListDelegatedAdministratorsRequest</code>.
     * @alias module:model/ListDelegatedAdministratorsRequest
     */
    constructor() { 
        
        ListDelegatedAdministratorsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListDelegatedAdministratorsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDelegatedAdministratorsRequest} obj Optional instance to populate.
     * @return {module:model/ListDelegatedAdministratorsRequest} The populated <code>ListDelegatedAdministratorsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDelegatedAdministratorsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListDelegatedAdministratorsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDelegatedAdministratorsRequest</code>.
     */
 ...
 */
ListDelegatedAdministratorsRequest.prototype['ServicePrincipal'] = undefined;

/**
 * @member {String} NextToken
 */
ListDelegatedAdministratorsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListDelegatedAdministratorsRequest.prototype['MaxResults'] = undefined;
...
export default ListDelegatedAdministratorsRequest;
