...
/**
 * The DescribeEffectivePolicyRequest model module.
 * @module model/DescribeEffectivePolicyRequest
 * @version 2016-11-28
 */
class DescribeEffectivePolicyRequest {
    /**
     * Constructs a new <code>DescribeEffectivePolicyRequest</code>.
     * @alias module:model/DescribeEffectivePolicyRequest
     * @param policyType {module:model/EffectivePolicyType} 
     */
    constructor(policyType) { 
        
        DescribeEffectivePolicyRequest.initialize(this, policyType);
    }
    ...
    /**
     * Constructs a <code>DescribeEffectivePolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEffectivePolicyRequest} obj Optional instance to populate.
     * @return {module:model/DescribeEffectivePolicyRequest} The populated <code>DescribeEffectivePolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEffectivePolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEffectivePolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEffectivePolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeEffectivePolicyRequest.RequiredProperties) {
...
DescribeEffectivePolicyRequest.RequiredProperties = ["PolicyType"];

/**
 * @member {module:model/EffectivePolicyType} PolicyType
 */
DescribeEffectivePolicyRequest.prototype['PolicyType'] = undefined;

/**
 * @member {String} TargetId
 */
DescribeEffectivePolicyRequest.prototype['TargetId'] = undefined;
...
export default DescribeEffectivePolicyRequest;
