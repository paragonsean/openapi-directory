...
/**
 * The DisablePolicyTypeRequest model module.
 * @module model/DisablePolicyTypeRequest
 * @version 2016-11-28
 */
class DisablePolicyTypeRequest {
    /**
     * Constructs a new <code>DisablePolicyTypeRequest</code>.
     * @alias module:model/DisablePolicyTypeRequest
     * @param rootId {String} 
     * @param policyType {module:model/PolicyType} 
     */
    constructor(rootId, policyType) { 
        
        DisablePolicyTypeRequest.initialize(this, rootId, policyType);
    }
    ...
    /**
     * Constructs a <code>DisablePolicyTypeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisablePolicyTypeRequest} obj Optional instance to populate.
     * @return {module:model/DisablePolicyTypeRequest} The populated <code>DisablePolicyTypeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisablePolicyTypeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisablePolicyTypeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisablePolicyTypeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisablePolicyTypeRequest.RequiredProperties) {
...
DisablePolicyTypeRequest.RequiredProperties = ["RootId", "PolicyType"];

/**
 * @member {String} RootId
 */
DisablePolicyTypeRequest.prototype['RootId'] = undefined;

/**
 * @member {module:model/PolicyType} PolicyType
 */
DisablePolicyTypeRequest.prototype['PolicyType'] = undefined;
...
export default DisablePolicyTypeRequest;
