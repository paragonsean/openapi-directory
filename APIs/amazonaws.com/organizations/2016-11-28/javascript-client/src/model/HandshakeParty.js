...
import HandshakePartyType from './HandshakePartyType';

/**
 * The HandshakeParty model module.
 * @module model/HandshakeParty
 * @version 2016-11-28
 */
class HandshakeParty {
    /**
     * Constructs a new <code>HandshakeParty</code>.
     * Identifies a participant in a handshake.
     * @alias module:model/HandshakeParty
     * @param id {String} 
     * @param type {module:model/HandshakePartyType} 
     */
    constructor(id, type) { 
        
        HandshakeParty.initialize(this, id, type);
    }
    ...
    /**
     * Constructs a <code>HandshakeParty</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HandshakeParty} obj Optional instance to populate.
     * @return {module:model/HandshakeParty} The populated <code>HandshakeParty</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HandshakeParty();

            if (data.hasOwnProperty('Id')) {
                obj['Id'] = ApiClient.convertToType(data['Id'], 'String');
            }
            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], HandshakePartyType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>HandshakeParty</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HandshakeParty</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HandshakeParty.RequiredProperties) {
        ...
        if (data['Type']) { // data not null
          HandshakePartyType.validateJSON(data['Type']);
        }
...
HandshakeParty.RequiredProperties = ["Id", "Type"];

/**
 * @member {String} Id
 */
HandshakeParty.prototype['Id'] = undefined;

/**
 * @member {module:model/HandshakePartyType} Type
 */
HandshakeParty.prototype['Type'] = undefined;
