...
/**
 * The ListHandshakesForOrganizationRequestFilter model module.
 * @module model/ListHandshakesForOrganizationRequestFilter
 * @version 2016-11-28
 */
class ListHandshakesForOrganizationRequestFilter {
    /**
     * Constructs a new <code>ListHandshakesForOrganizationRequestFilter</code>.
     * @alias module:model/ListHandshakesForOrganizationRequestFilter
     * @implements module:model/HandshakeFilter
     */
    constructor() { 
        HandshakeFilter.initialize(this);
        ListHandshakesForOrganizationRequestFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListHandshakesForOrganizationRequestFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListHandshakesForOrganizationRequestFilter} obj Optional instance to populate.
     * @return {module:model/ListHandshakesForOrganizationRequestFilter} The populated <code>ListHandshakesForOrganizationRequestFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListHandshakesForOrganizationRequestFilter();
            HandshakeFilter.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ListHandshakesForOrganizationRequestFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListHandshakesForOrganizationRequestFilter</code>.
     */
 ...
 */
ListHandshakesForOrganizationRequestFilter.prototype['ActionType'] = undefined;

/**
 * @member {String} ParentHandshakeId
 */
ListHandshakesForOrganizationRequestFilter.prototype['ParentHandshakeId'] = undefined;


// Implement HandshakeFilter interface:
/**
 * @member {module:model/ActionType} ActionType
 */
...
export default ListHandshakesForOrganizationRequestFilter;
