...
/**
 * The PolicyTargetSummary model module.
 * @module model/PolicyTargetSummary
 * @version 2016-11-28
 */
class PolicyTargetSummary {
    /**
     * Constructs a new <code>PolicyTargetSummary</code>.
     * Contains information about a root, OU, or account that a policy is attached to.
     * @alias module:model/PolicyTargetSummary
     */
    constructor() { 
        
        PolicyTargetSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyTargetSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyTargetSummary} obj Optional instance to populate.
     * @return {module:model/PolicyTargetSummary} The populated <code>PolicyTargetSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyTargetSummary();
            ...
            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], TargetType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyTargetSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyTargetSummary</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Type']) { // data not null
          TargetType.validateJSON(data['Type']);
        }
 ...
 */
PolicyTargetSummary.prototype['TargetId'] = undefined;

/**
 * @member {String} Arn
 */
PolicyTargetSummary.prototype['Arn'] = undefined;

/**
 * @member {String} Name
 */
PolicyTargetSummary.prototype['Name'] = undefined;

/**
 * @member {module:model/TargetType} Type
 */
PolicyTargetSummary.prototype['Type'] = undefined;
...
export default PolicyTargetSummary;
