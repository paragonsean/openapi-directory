...
* @readonly
*/
export default class CreateAccountState {
    ...
    /**
    * Returns a <code>CreateAccountState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CreateAccountState} The enum <code>CreateAccountState</code> value.
    */
