...
/**
 * The UpdatePolicyRequest model module.
 * @module model/UpdatePolicyRequest
 * @version 2016-11-28
 */
class UpdatePolicyRequest {
    /**
     * Constructs a new <code>UpdatePolicyRequest</code>.
     * @alias module:model/UpdatePolicyRequest
     * @param policyId {String} 
     */
    constructor(policyId) { 
        
        UpdatePolicyRequest.initialize(this, policyId);
    }
    ...
    /**
     * Constructs a <code>UpdatePolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePolicyRequest} obj Optional instance to populate.
     * @return {module:model/UpdatePolicyRequest} The populated <code>UpdatePolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePolicyRequest.RequiredProperties) {
...
UpdatePolicyRequest.RequiredProperties = ["PolicyId"];

/**
 * @member {String} PolicyId
 */
UpdatePolicyRequest.prototype['PolicyId'] = undefined;

/**
 * @member {String} Name
 */
UpdatePolicyRequest.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
UpdatePolicyRequest.prototype['Description'] = undefined;

/**
 * @member {String} Content
 */
UpdatePolicyRequest.prototype['Content'] = undefined;
