...
/**
 * The ListAccountsRequest model module.
 * @module model/ListAccountsRequest
 * @version 2016-11-28
 */
class ListAccountsRequest {
    /**
     * Constructs a new <code>ListAccountsRequest</code>.
     * @alias module:model/ListAccountsRequest
     */
    constructor() { 
        
        ListAccountsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAccountsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAccountsRequest} obj Optional instance to populate.
     * @return {module:model/ListAccountsRequest} The populated <code>ListAccountsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAccountsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAccountsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAccountsRequest</code>.
     */
 ...
 */
ListAccountsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListAccountsRequest.prototype['MaxResults'] = undefined;
...
export default ListAccountsRequest;
