...
import InviteAccountToOrganizationResponseHandshake from './InviteAccountToOrganizationResponseHandshake';

/**
 * The InviteAccountToOrganizationResponse model module.
 * @module model/InviteAccountToOrganizationResponse
 * @version 2016-11-28
 */
class InviteAccountToOrganizationResponse {
    /**
     * Constructs a new <code>InviteAccountToOrganizationResponse</code>.
     * @alias module:model/InviteAccountToOrganizationResponse
     */
    constructor() { 
        
        InviteAccountToOrganizationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InviteAccountToOrganizationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InviteAccountToOrganizationResponse} obj Optional instance to populate.
     * @return {module:model/InviteAccountToOrganizationResponse} The populated <code>InviteAccountToOrganizationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InviteAccountToOrganizationResponse();

            if (data.hasOwnProperty('Handshake')) {
                obj['Handshake'] = InviteAccountToOrganizationResponseHandshake.constructFromObject(data['Handshake']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InviteAccountToOrganizationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InviteAccountToOrganizationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Handshake`
        if (data['Handshake']) { // data not null
          InviteAccountToOrganizationResponseHandshake.validateJSON(data['Handshake']);
        }
...
/**
 * @member {module:model/InviteAccountToOrganizationResponseHandshake} Handshake
 */
InviteAccountToOrganizationResponse.prototype['Handshake'] = undefined;
...
export default InviteAccountToOrganizationResponse;
