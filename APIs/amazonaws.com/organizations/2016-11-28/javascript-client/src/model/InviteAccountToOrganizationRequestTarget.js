...
/**
 * The InviteAccountToOrganizationRequestTarget model module.
 * @module model/InviteAccountToOrganizationRequestTarget
 * @version 2016-11-28
 */
class InviteAccountToOrganizationRequestTarget {
    /**
     * Constructs a new <code>InviteAccountToOrganizationRequestTarget</code>.
     * @alias module:model/InviteAccountToOrganizationRequestTarget
     * @implements module:model/HandshakeParty
     * @param id {String} 
     * @param type {module:model/HandshakePartyType} 
     */
    constructor(id, type) { 
        HandshakeParty.initialize(this, id, type);
        InviteAccountToOrganizationRequestTarget.initialize(this, id, type);
    }
    ...
    /**
     * Constructs a <code>InviteAccountToOrganizationRequestTarget</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InviteAccountToOrganizationRequestTarget} obj Optional instance to populate.
     * @return {module:model/InviteAccountToOrganizationRequestTarget} The populated <code>InviteAccountToOrganizationRequestTarget</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InviteAccountToOrganizationRequestTarget();
            HandshakeParty.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>InviteAccountToOrganizationRequestTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InviteAccountToOrganizationRequestTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InviteAccountToOrganizationRequestTarget.RequiredProperties) {
...
InviteAccountToOrganizationRequestTarget.RequiredProperties = ["Id", "Type"];

/**
 * @member {String} Id
 */
InviteAccountToOrganizationRequestTarget.prototype['Id'] = undefined;

/**
 * @member {module:model/HandshakePartyType} Type
 */
InviteAccountToOrganizationRequestTarget.prototype['Type'] = undefined;


// Implement HandshakeParty interface:
/**
 * @member {String} Id
 */
...
export default InviteAccountToOrganizationRequestTarget;
