...
import DescribeHandshakeResponseHandshake from './DescribeHandshakeResponseHandshake';

/**
 * The DescribeHandshakeResponse model module.
 * @module model/DescribeHandshakeResponse
 * @version 2016-11-28
 */
class DescribeHandshakeResponse {
    /**
     * Constructs a new <code>DescribeHandshakeResponse</code>.
     * @alias module:model/DescribeHandshakeResponse
     */
    constructor() { 
        
        DescribeHandshakeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeHandshakeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeHandshakeResponse} obj Optional instance to populate.
     * @return {module:model/DescribeHandshakeResponse} The populated <code>DescribeHandshakeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeHandshakeResponse();

            if (data.hasOwnProperty('Handshake')) {
                obj['Handshake'] = DescribeHandshakeResponseHandshake.constructFromObject(data['Handshake']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeHandshakeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeHandshakeResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Handshake`
        if (data['Handshake']) { // data not null
          DescribeHandshakeResponseHandshake.validateJSON(data['Handshake']);
        }
...
/**
 * @member {module:model/DescribeHandshakeResponseHandshake} Handshake
 */
DescribeHandshakeResponse.prototype['Handshake'] = undefined;
...
export default DescribeHandshakeResponse;
