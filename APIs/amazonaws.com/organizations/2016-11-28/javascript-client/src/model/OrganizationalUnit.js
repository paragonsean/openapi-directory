...
class OrganizationalUnit {
    ...
    constructor() { 
        ...
        OrganizationalUnit.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationalUnit();
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationalUnit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationalUnit</code>.
     */
 ...
 * @member {String} Id
 */
OrganizationalUnit.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
OrganizationalUnit.prototype['Arn'] = undefined;

/**
 * @member {String} Name
 */
OrganizationalUnit.prototype['Name'] = undefined;
