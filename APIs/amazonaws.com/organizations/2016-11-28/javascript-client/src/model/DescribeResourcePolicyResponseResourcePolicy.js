...
/**
 * The DescribeResourcePolicyResponseResourcePolicy model module.
 * @module model/DescribeResourcePolicyResponseResourcePolicy
 * @version 2016-11-28
 */
class DescribeResourcePolicyResponseResourcePolicy {
    /**
     * Constructs a new <code>DescribeResourcePolicyResponseResourcePolicy</code>.
     * @alias module:model/DescribeResourcePolicyResponseResourcePolicy
     * @implements module:model/ResourcePolicy
     */
    constructor() { 
        ResourcePolicy.initialize(this);
        DescribeResourcePolicyResponseResourcePolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeResourcePolicyResponseResourcePolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeResourcePolicyResponseResourcePolicy} obj Optional instance to populate.
     * @return {module:model/DescribeResourcePolicyResponseResourcePolicy} The populated <code>DescribeResourcePolicyResponseResourcePolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeResourcePolicyResponseResourcePolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeResourcePolicyResponseResourcePolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeResourcePolicyResponseResourcePolicy</code>.
     */
 ...
 */
DescribeResourcePolicyResponseResourcePolicy.prototype['ResourcePolicySummary'] = undefined;

/**
 * @member {String} Content
 */
DescribeResourcePolicyResponseResourcePolicy.prototype['Content'] = undefined;
...
export default DescribeResourcePolicyResponseResourcePolicy;
