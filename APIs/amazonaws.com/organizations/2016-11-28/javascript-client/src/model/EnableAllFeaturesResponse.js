...
import EnableAllFeaturesResponseHandshake from './EnableAllFeaturesResponseHandshake';

/**
 * The EnableAllFeaturesResponse model module.
 * @module model/EnableAllFeaturesResponse
 * @version 2016-11-28
 */
class EnableAllFeaturesResponse {
    /**
     * Constructs a new <code>EnableAllFeaturesResponse</code>.
     * @alias module:model/EnableAllFeaturesResponse
     */
    constructor() { 
        
        EnableAllFeaturesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EnableAllFeaturesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnableAllFeaturesResponse} obj Optional instance to populate.
     * @return {module:model/EnableAllFeaturesResponse} The populated <code>EnableAllFeaturesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnableAllFeaturesResponse();

            if (data.hasOwnProperty('Handshake')) {
                obj['Handshake'] = EnableAllFeaturesResponseHandshake.constructFromObject(data['Handshake']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EnableAllFeaturesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnableAllFeaturesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Handshake`
        if (data['Handshake']) { // data not null
          EnableAllFeaturesResponseHandshake.validateJSON(data['Handshake']);
        }
...
/**
 * @member {module:model/EnableAllFeaturesResponseHandshake} Handshake
 */
EnableAllFeaturesResponse.prototype['Handshake'] = undefined;
...
export default EnableAllFeaturesResponse;
