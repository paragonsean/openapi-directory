...
import OrganizationFeatureSet from './OrganizationFeatureSet';
...
class CreateOrganizationRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('FeatureSet')) {
                obj['FeatureSet'] = ApiClient.convertToType(data['FeatureSet'], OrganizationFeatureSet);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['FeatureSet']) { // data not null
          OrganizationFeatureSet.validateJSON(data['FeatureSet']);
        }
...
/**
 * @member {module:model/OrganizationFeatureSet} FeatureSet
 */
CreateOrganizationRequest.prototype['FeatureSet'] = undefined;
