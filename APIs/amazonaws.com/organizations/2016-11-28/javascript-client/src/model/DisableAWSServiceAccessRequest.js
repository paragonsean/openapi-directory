...
/**
 * The DisableAWSServiceAccessRequest model module.
 * @module model/DisableAWSServiceAccessRequest
 * @version 2016-11-28
 */
class DisableAWSServiceAccessRequest {
    /**
     * Constructs a new <code>DisableAWSServiceAccessRequest</code>.
     * @alias module:model/DisableAWSServiceAccessRequest
     * @param servicePrincipal {String} 
     */
    constructor(servicePrincipal) { 
        
        DisableAWSServiceAccessRequest.initialize(this, servicePrincipal);
    }
    ...
    /**
     * Constructs a <code>DisableAWSServiceAccessRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisableAWSServiceAccessRequest} obj Optional instance to populate.
     * @return {module:model/DisableAWSServiceAccessRequest} The populated <code>DisableAWSServiceAccessRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisableAWSServiceAccessRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisableAWSServiceAccessRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisableAWSServiceAccessRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisableAWSServiceAccessRequest.RequiredProperties) {
...
DisableAWSServiceAccessRequest.RequiredProperties = ["ServicePrincipal"];

/**
 * @member {String} ServicePrincipal
 */
DisableAWSServiceAccessRequest.prototype['ServicePrincipal'] = undefined;
...
export default DisableAWSServiceAccessRequest;
