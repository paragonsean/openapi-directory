...
import DescribePolicyResponsePolicy from './DescribePolicyResponsePolicy';

/**
 * The DescribePolicyResponse model module.
 * @module model/DescribePolicyResponse
 * @version 2016-11-28
 */
class DescribePolicyResponse {
    /**
     * Constructs a new <code>DescribePolicyResponse</code>.
     * @alias module:model/DescribePolicyResponse
     */
    constructor() { 
        
        DescribePolicyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribePolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePolicyResponse} obj Optional instance to populate.
     * @return {module:model/DescribePolicyResponse} The populated <code>DescribePolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePolicyResponse();

            if (data.hasOwnProperty('Policy')) {
                obj['Policy'] = DescribePolicyResponsePolicy.constructFromObject(data['Policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePolicyResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Policy`
        if (data['Policy']) { // data not null
          DescribePolicyResponsePolicy.validateJSON(data['Policy']);
        }
...
/**
 * @member {module:model/DescribePolicyResponsePolicy} Policy
 */
DescribePolicyResponse.prototype['Policy'] = undefined;
...
export default DescribePolicyResponse;
