...
/**
 * The ListPoliciesRequest model module.
 * @module model/ListPoliciesRequest
 * @version 2016-11-28
 */
class ListPoliciesRequest {
    /**
     * Constructs a new <code>ListPoliciesRequest</code>.
     * @alias module:model/ListPoliciesRequest
     * @param filter {module:model/PolicyType} 
     */
    constructor(filter) { 
        
        ListPoliciesRequest.initialize(this, filter);
    }
    ...
    /**
     * Constructs a <code>ListPoliciesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPoliciesRequest} obj Optional instance to populate.
     * @return {module:model/ListPoliciesRequest} The populated <code>ListPoliciesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPoliciesRequest();

            if (data.hasOwnProperty('Filter')) {
                obj['Filter'] = ApiClient.convertToType(data['Filter'], PolicyType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListPoliciesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPoliciesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListPoliciesRequest.RequiredProperties) {
        ...
        if (data['Filter']) { // data not null
          PolicyType.validateJSON(data['Filter']);
        }
...
ListPoliciesRequest.RequiredProperties = ["Filter"];

/**
 * @member {module:model/PolicyType} Filter
 */
ListPoliciesRequest.prototype['Filter'] = undefined;

/**
 * @member {String} NextToken
 */
ListPoliciesRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListPoliciesRequest.prototype['MaxResults'] = undefined;
...
export default ListPoliciesRequest;
