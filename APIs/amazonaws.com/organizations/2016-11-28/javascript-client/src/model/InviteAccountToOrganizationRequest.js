...
import InviteAccountToOrganizationRequestTarget from './InviteAccountToOrganizationRequestTarget';

/**
 * The InviteAccountToOrganizationRequest model module.
 * @module model/InviteAccountToOrganizationRequest
 * @version 2016-11-28
 */
class InviteAccountToOrganizationRequest {
    /**
     * Constructs a new <code>InviteAccountToOrganizationRequest</code>.
     * @alias module:model/InviteAccountToOrganizationRequest
     * @param target {module:model/InviteAccountToOrganizationRequestTarget} 
     */
    constructor(target) { 
        
        InviteAccountToOrganizationRequest.initialize(this, target);
    }
    ...
    /**
     * Constructs a <code>InviteAccountToOrganizationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InviteAccountToOrganizationRequest} obj Optional instance to populate.
     * @return {module:model/InviteAccountToOrganizationRequest} The populated <code>InviteAccountToOrganizationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InviteAccountToOrganizationRequest();

            if (data.hasOwnProperty('Target')) {
                obj['Target'] = InviteAccountToOrganizationRequestTarget.constructFromObject(data['Target']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>InviteAccountToOrganizationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InviteAccountToOrganizationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InviteAccountToOrganizationRequest.RequiredProperties) {
        ...
        if (data['Target']) { // data not null
          InviteAccountToOrganizationRequestTarget.validateJSON(data['Target']);
        }
...
InviteAccountToOrganizationRequest.RequiredProperties = ["Target"];

/**
 * @member {module:model/InviteAccountToOrganizationRequestTarget} Target
 */
InviteAccountToOrganizationRequest.prototype['Target'] = undefined;

/**
 * @member {String} Notes
 */
InviteAccountToOrganizationRequest.prototype['Notes'] = undefined;

/**
 * @member {Array} Tags
 */
InviteAccountToOrganizationRequest.prototype['Tags'] = undefined;
...
export default InviteAccountToOrganizationRequest;
