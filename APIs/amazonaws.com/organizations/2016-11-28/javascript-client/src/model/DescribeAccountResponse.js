...
import DescribeAccountResponseAccount from './DescribeAccountResponseAccount';

/**
 * The DescribeAccountResponse model module.
 * @module model/DescribeAccountResponse
 * @version 2016-11-28
 */
class DescribeAccountResponse {
    /**
     * Constructs a new <code>DescribeAccountResponse</code>.
     * @alias module:model/DescribeAccountResponse
     */
    constructor() { 
        
        DescribeAccountResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAccountResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAccountResponse} obj Optional instance to populate.
     * @return {module:model/DescribeAccountResponse} The populated <code>DescribeAccountResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAccountResponse();

            if (data.hasOwnProperty('Account')) {
                obj['Account'] = DescribeAccountResponseAccount.constructFromObject(data['Account']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAccountResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAccountResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Account`
        if (data['Account']) { // data not null
          DescribeAccountResponseAccount.validateJSON(data['Account']);
        }
...
/**
 * @member {module:model/DescribeAccountResponseAccount} Account
 */
DescribeAccountResponse.prototype['Account'] = undefined;
...
export default DescribeAccountResponse;
