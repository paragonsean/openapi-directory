...
/**
 * The DescribeEffectivePolicyResponseEffectivePolicy model module.
 * @module model/DescribeEffectivePolicyResponseEffectivePolicy
 * @version 2016-11-28
 */
class DescribeEffectivePolicyResponseEffectivePolicy {
    /**
     * Constructs a new <code>DescribeEffectivePolicyResponseEffectivePolicy</code>.
     * @alias module:model/DescribeEffectivePolicyResponseEffectivePolicy
     * @implements module:model/EffectivePolicy
     */
    constructor() { 
        EffectivePolicy.initialize(this);
        DescribeEffectivePolicyResponseEffectivePolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEffectivePolicyResponseEffectivePolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEffectivePolicyResponseEffectivePolicy} obj Optional instance to populate.
     * @return {module:model/DescribeEffectivePolicyResponseEffectivePolicy} The populated <code>DescribeEffectivePolicyResponseEffectivePolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEffectivePolicyResponseEffectivePolicy();
            EffectivePolicy.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEffectivePolicyResponseEffectivePolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEffectivePolicyResponseEffectivePolicy</code>.
     */
 ...
 */
DescribeEffectivePolicyResponseEffectivePolicy.prototype['PolicyContent'] = undefined;

/**
 * @member {Date} LastUpdatedTimestamp
 */
DescribeEffectivePolicyResponseEffectivePolicy.prototype['LastUpdatedTimestamp'] = undefined;

/**
 * @member {String} TargetId
 */
DescribeEffectivePolicyResponseEffectivePolicy.prototype['TargetId'] = undefined;

/**
 * @member {module:model/EffectivePolicyType} PolicyType
 */
DescribeEffectivePolicyResponseEffectivePolicy.prototype['PolicyType'] = undefined;


// Implement EffectivePolicy interface:
/**
 * @member {String} PolicyContent
 */
...
export default DescribeEffectivePolicyResponseEffectivePolicy;
