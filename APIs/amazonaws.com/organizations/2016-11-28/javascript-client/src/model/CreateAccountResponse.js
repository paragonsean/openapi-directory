...
import CreateAccountResponseCreateAccountStatus from './CreateAccountResponseCreateAccountStatus';
...
class CreateAccountResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('CreateAccountStatus')) {
                obj['CreateAccountStatus'] = CreateAccountResponseCreateAccountStatus.constructFromObject(data['CreateAccountStatus']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['CreateAccountStatus']) { // data not null
          CreateAccountResponseCreateAccountStatus.validateJSON(data['CreateAccountStatus']);
        }
...
/**
 * @member {module:model/CreateAccountResponseCreateAccountStatus} CreateAccountStatus
 */
CreateAccountResponse.prototype['CreateAccountStatus'] = undefined;
