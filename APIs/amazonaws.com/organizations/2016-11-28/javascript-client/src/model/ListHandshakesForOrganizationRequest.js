...
import ListHandshakesForOrganizationRequestFilter from './ListHandshakesForOrganizationRequestFilter';

/**
 * The ListHandshakesForOrganizationRequest model module.
 * @module model/ListHandshakesForOrganizationRequest
 * @version 2016-11-28
 */
class ListHandshakesForOrganizationRequest {
    /**
     * Constructs a new <code>ListHandshakesForOrganizationRequest</code>.
     * @alias module:model/ListHandshakesForOrganizationRequest
     */
    constructor() { 
        
        ListHandshakesForOrganizationRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListHandshakesForOrganizationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListHandshakesForOrganizationRequest} obj Optional instance to populate.
     * @return {module:model/ListHandshakesForOrganizationRequest} The populated <code>ListHandshakesForOrganizationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListHandshakesForOrganizationRequest();

            if (data.hasOwnProperty('Filter')) {
                obj['Filter'] = ListHandshakesForOrganizationRequestFilter.constructFromObject(data['Filter']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListHandshakesForOrganizationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListHandshakesForOrganizationRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Filter`
        if (data['Filter']) { // data not null
          ListHandshakesForOrganizationRequestFilter.validateJSON(data['Filter']);
        }
...
/**
 * @member {module:model/ListHandshakesForOrganizationRequestFilter} Filter
 */
ListHandshakesForOrganizationRequest.prototype['Filter'] = undefined;

/**
 * @member {String} NextToken
 */
ListHandshakesForOrganizationRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListHandshakesForOrganizationRequest.prototype['MaxResults'] = undefined;
...
export default ListHandshakesForOrganizationRequest;
