...
/**
 * The DescribeOrganizationalUnitRequest model module.
 * @module model/DescribeOrganizationalUnitRequest
 * @version 2016-11-28
 */
class DescribeOrganizationalUnitRequest {
    /**
     * Constructs a new <code>DescribeOrganizationalUnitRequest</code>.
     * @alias module:model/DescribeOrganizationalUnitRequest
     * @param organizationalUnitId {String} 
     */
    constructor(organizationalUnitId) { 
        
        DescribeOrganizationalUnitRequest.initialize(this, organizationalUnitId);
    }
    ...
    /**
     * Constructs a <code>DescribeOrganizationalUnitRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeOrganizationalUnitRequest} obj Optional instance to populate.
     * @return {module:model/DescribeOrganizationalUnitRequest} The populated <code>DescribeOrganizationalUnitRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeOrganizationalUnitRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeOrganizationalUnitRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeOrganizationalUnitRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeOrganizationalUnitRequest.RequiredProperties) {
...
DescribeOrganizationalUnitRequest.RequiredProperties = ["OrganizationalUnitId"];

/**
 * @member {String} OrganizationalUnitId
 */
DescribeOrganizationalUnitRequest.prototype['OrganizationalUnitId'] = undefined;
...
export default DescribeOrganizationalUnitRequest;
