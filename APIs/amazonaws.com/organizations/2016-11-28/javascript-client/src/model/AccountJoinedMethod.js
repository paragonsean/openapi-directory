...
* @readonly
*/
export default class AccountJoinedMethod {
    ...
    /**
    * Returns a <code>AccountJoinedMethod</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AccountJoinedMethod} The enum <code>AccountJoinedMethod</code> value.
    */
