...
/**
 * The CreateOrganizationalUnitResponseOrganizationalUnit model module.
 * @module model/CreateOrganizationalUnitResponseOrganizationalUnit
 * @version 2016-11-28
 */
class CreateOrganizationalUnitResponseOrganizationalUnit {
    /**
     * Constructs a new <code>CreateOrganizationalUnitResponseOrganizationalUnit</code>.
     * @alias module:model/CreateOrganizationalUnitResponseOrganizationalUnit
     * @implements module:model/OrganizationalUnit
     */
    constructor() { 
        OrganizationalUnit.initialize(this);
        CreateOrganizationalUnitResponseOrganizationalUnit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateOrganizationalUnitResponseOrganizationalUnit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateOrganizationalUnitResponseOrganizationalUnit} obj Optional instance to populate.
     * @return {module:model/CreateOrganizationalUnitResponseOrganizationalUnit} The populated <code>CreateOrganizationalUnitResponseOrganizationalUnit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateOrganizationalUnitResponseOrganizationalUnit();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateOrganizationalUnitResponseOrganizationalUnit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateOrganizationalUnitResponseOrganizationalUnit</code>.
     */
 ...
 * @member {String} Id
 */
CreateOrganizationalUnitResponseOrganizationalUnit.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
CreateOrganizationalUnitResponseOrganizationalUnit.prototype['Arn'] = undefined;

/**
 * @member {String} Name
 */
CreateOrganizationalUnitResponseOrganizationalUnit.prototype['Name'] = undefined;
...
export default CreateOrganizationalUnitResponseOrganizationalUnit;
