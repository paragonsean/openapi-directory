...
/**
 * The ListTargetsForPolicyRequest model module.
 * @module model/ListTargetsForPolicyRequest
 * @version 2016-11-28
 */
class ListTargetsForPolicyRequest {
    /**
     * Constructs a new <code>ListTargetsForPolicyRequest</code>.
     * @alias module:model/ListTargetsForPolicyRequest
     * @param policyId {String} 
     */
    constructor(policyId) { 
        
        ListTargetsForPolicyRequest.initialize(this, policyId);
    }
    ...
    /**
     * Constructs a <code>ListTargetsForPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTargetsForPolicyRequest} obj Optional instance to populate.
     * @return {module:model/ListTargetsForPolicyRequest} The populated <code>ListTargetsForPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTargetsForPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListTargetsForPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTargetsForPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListTargetsForPolicyRequest.RequiredProperties) {
...
ListTargetsForPolicyRequest.RequiredProperties = ["PolicyId"];

/**
 * @member {String} PolicyId
 */
ListTargetsForPolicyRequest.prototype['PolicyId'] = undefined;

/**
 * @member {String} NextToken
 */
ListTargetsForPolicyRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListTargetsForPolicyRequest.prototype['MaxResults'] = undefined;
...
export default ListTargetsForPolicyRequest;
