...
import PolicyTypeStatus from './PolicyTypeStatus';

/**
 * The PolicyTypeSummary model module.
 * @module model/PolicyTypeSummary
 * @version 2016-11-28
 */
class PolicyTypeSummary {
    /**
     * Constructs a new <code>PolicyTypeSummary</code>.
     * Contains information about a policy type and its status in the associated root.
     * @alias module:model/PolicyTypeSummary
     */
    constructor() { 
        
        PolicyTypeSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyTypeSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyTypeSummary} obj Optional instance to populate.
     * @return {module:model/PolicyTypeSummary} The populated <code>PolicyTypeSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyTypeSummary();

            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], PolicyType);
            }
            if (data.hasOwnProperty('Status')) {
                obj['Status'] = ApiClient.convertToType(data['Status'], PolicyTypeStatus);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyTypeSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyTypeSummary</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Status']) { // data not null
          PolicyTypeStatus.validateJSON(data['Status']);
        }
 ...
 */
PolicyTypeSummary.prototype['Type'] = undefined;

/**
 * @member {module:model/PolicyTypeStatus} Status
 */
PolicyTypeSummary.prototype['Status'] = undefined;
...
export default PolicyTypeSummary;
