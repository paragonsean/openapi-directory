...
/**
 * The HandshakeFilter model module.
 * @module model/HandshakeFilter
 * @version 2016-11-28
 */
class HandshakeFilter {
    /**
     * Constructs a new <code>HandshakeFilter</code>.
     * Specifies the criteria that are used to select the handshakes for the operation.
     * @alias module:model/HandshakeFilter
     */
    constructor() { 
        
        HandshakeFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HandshakeFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HandshakeFilter} obj Optional instance to populate.
     * @return {module:model/HandshakeFilter} The populated <code>HandshakeFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HandshakeFilter();

            if (data.hasOwnProperty('ActionType')) {
                obj['ActionType'] = ApiClient.convertToType(data['ActionType'], ActionType);
            }
            if (data.hasOwnProperty('ParentHandshakeId')) {
                obj['ParentHandshakeId'] = ApiClient.convertToType(data['ParentHandshakeId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>HandshakeFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HandshakeFilter</code>.
     */
    static validateJSON(data) {
        ...
        if (data['ParentHandshakeId']) { // data not null
          String.validateJSON(data['ParentHandshakeId']);
        }
 ...
 */
HandshakeFilter.prototype['ActionType'] = undefined;

/**
 * @member {String} ParentHandshakeId
 */
HandshakeFilter.prototype['ParentHandshakeId'] = undefined;
...
export default HandshakeFilter;
