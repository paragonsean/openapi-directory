...
/**
 * The CreateGovCloudAccountResponse model module.
 * @module model/CreateGovCloudAccountResponse
 * @version 2016-11-28
 */
class CreateGovCloudAccountResponse {
    /**
     * Constructs a new <code>CreateGovCloudAccountResponse</code>.
     * @alias module:model/CreateGovCloudAccountResponse
     */
    constructor() { 
        
        CreateGovCloudAccountResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateGovCloudAccountResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGovCloudAccountResponse} obj Optional instance to populate.
     * @return {module:model/CreateGovCloudAccountResponse} The populated <code>CreateGovCloudAccountResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGovCloudAccountResponse();

            if (data.hasOwnProperty('CreateAccountStatus')) {
                obj['CreateAccountStatus'] = CreateAccountStatus.constructFromObject(data['CreateAccountStatus']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGovCloudAccountResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGovCloudAccountResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CreateAccountStatus`
        if (data['CreateAccountStatus']) { // data not null
          CreateAccountStatus.validateJSON(data['CreateAccountStatus']);
        }
...
/**
 * @member {module:model/CreateAccountStatus} CreateAccountStatus
 */
CreateGovCloudAccountResponse.prototype['CreateAccountStatus'] = undefined;
...
export default CreateGovCloudAccountResponse;
