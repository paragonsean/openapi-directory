...
/**
 * The AcceptHandshakeRequest model module.
 * @module model/AcceptHandshakeRequest
 * @version 2016-11-28
 */
class AcceptHandshakeRequest {
    /**
     * Constructs a new <code>AcceptHandshakeRequest</code>.
     * @alias module:model/AcceptHandshakeRequest
     * @param handshakeId {String} 
     */
    constructor(handshakeId) { 
        
        AcceptHandshakeRequest.initialize(this, handshakeId);
    }
    ...
    /**
     * Constructs a <code>AcceptHandshakeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AcceptHandshakeRequest} obj Optional instance to populate.
     * @return {module:model/AcceptHandshakeRequest} The populated <code>AcceptHandshakeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AcceptHandshakeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AcceptHandshakeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AcceptHandshakeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AcceptHandshakeRequest.RequiredProperties) {
...
AcceptHandshakeRequest.RequiredProperties = ["HandshakeId"];

/**
 * @member {String} HandshakeId
 */
AcceptHandshakeRequest.prototype['HandshakeId'] = undefined;
