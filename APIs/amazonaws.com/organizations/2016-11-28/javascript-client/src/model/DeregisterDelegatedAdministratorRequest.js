...
/**
 * The DeregisterDelegatedAdministratorRequest model module.
 * @module model/DeregisterDelegatedAdministratorRequest
 * @version 2016-11-28
 */
class DeregisterDelegatedAdministratorRequest {
    /**
     * Constructs a new <code>DeregisterDelegatedAdministratorRequest</code>.
     * @alias module:model/DeregisterDelegatedAdministratorRequest
     * @param accountId {String} 
     * @param servicePrincipal {String} 
     */
    constructor(accountId, servicePrincipal) { 
        
        DeregisterDelegatedAdministratorRequest.initialize(this, accountId, servicePrincipal);
    }
    ...
    /**
     * Constructs a <code>DeregisterDelegatedAdministratorRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeregisterDelegatedAdministratorRequest} obj Optional instance to populate.
     * @return {module:model/DeregisterDelegatedAdministratorRequest} The populated <code>DeregisterDelegatedAdministratorRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeregisterDelegatedAdministratorRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeregisterDelegatedAdministratorRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeregisterDelegatedAdministratorRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeregisterDelegatedAdministratorRequest.RequiredProperties) {
...
DeregisterDelegatedAdministratorRequest.RequiredProperties = ["AccountId", "ServicePrincipal"];

/**
 * @member {String} AccountId
 */
DeregisterDelegatedAdministratorRequest.prototype['AccountId'] = undefined;

/**
 * @member {String} ServicePrincipal
 */
DeregisterDelegatedAdministratorRequest.prototype['ServicePrincipal'] = undefined;
...
export default DeregisterDelegatedAdministratorRequest;
