...
/**
 * The ResourcePolicyResourcePolicySummary model module.
 * @module model/ResourcePolicyResourcePolicySummary
 * @version 2016-11-28
 */
class ResourcePolicyResourcePolicySummary {
    /**
     * Constructs a new <code>ResourcePolicyResourcePolicySummary</code>.
     * @alias module:model/ResourcePolicyResourcePolicySummary
     * @implements module:model/ResourcePolicySummary
     */
    constructor() { 
        ResourcePolicySummary.initialize(this);
        ResourcePolicyResourcePolicySummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResourcePolicyResourcePolicySummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourcePolicyResourcePolicySummary} obj Optional instance to populate.
     * @return {module:model/ResourcePolicyResourcePolicySummary} The populated <code>ResourcePolicyResourcePolicySummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourcePolicyResourcePolicySummary();
            ResourcePolicySummary.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ResourcePolicyResourcePolicySummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourcePolicyResourcePolicySummary</code>.
     */
 ...
 * @member {String} Id
 */
ResourcePolicyResourcePolicySummary.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
ResourcePolicyResourcePolicySummary.prototype['Arn'] = undefined;


// Implement ResourcePolicySummary interface:
/**
 * @member {String} Id
 */
...
export default ResourcePolicyResourcePolicySummary;
