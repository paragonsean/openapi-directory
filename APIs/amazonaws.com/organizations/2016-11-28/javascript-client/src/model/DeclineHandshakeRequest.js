...
/**
 * The DeclineHandshakeRequest model module.
 * @module model/DeclineHandshakeRequest
 * @version 2016-11-28
 */
class DeclineHandshakeRequest {
    /**
     * Constructs a new <code>DeclineHandshakeRequest</code>.
     * @alias module:model/DeclineHandshakeRequest
     * @param handshakeId {String} 
     */
    constructor(handshakeId) { 
        
        DeclineHandshakeRequest.initialize(this, handshakeId);
    }
     ...
     */
    static initialize(obj, handshakeId) { 
        obj['HandshakeId'] = handshakeId;
    }

    /**
     * Constructs a <code>DeclineHandshakeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeclineHandshakeRequest} obj Optional instance to populate.
     * @return {module:model/DeclineHandshakeRequest} The populated <code>DeclineHandshakeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeclineHandshakeRequest();

            if (data.hasOwnProperty('HandshakeId')) {
                obj['HandshakeId'] = ApiClient.convertToType(data['HandshakeId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeclineHandshakeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeclineHandshakeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeclineHandshakeRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `HandshakeId`
        if (data['HandshakeId']) { // data not null
          String.validateJSON(data['HandshakeId']);
        }
...
DeclineHandshakeRequest.RequiredProperties = ["HandshakeId"];

/**
 * @member {String} HandshakeId
 */
DeclineHandshakeRequest.prototype['HandshakeId'] = undefined;
...
export default DeclineHandshakeRequest;
