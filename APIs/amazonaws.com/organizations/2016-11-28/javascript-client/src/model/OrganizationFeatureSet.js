...
* @readonly
*/
export default class OrganizationFeatureSet {
    ...
    /**
    * Returns a <code>OrganizationFeatureSet</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OrganizationFeatureSet} The enum <code>OrganizationFeatureSet</code> value.
    */
