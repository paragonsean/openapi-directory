...
/**
 * The ListAWSServiceAccessForOrganizationResponse model module.
 * @module model/ListAWSServiceAccessForOrganizationResponse
 * @version 2016-11-28
 */
class ListAWSServiceAccessForOrganizationResponse {
    /**
     * Constructs a new <code>ListAWSServiceAccessForOrganizationResponse</code>.
     * @alias module:model/ListAWSServiceAccessForOrganizationResponse
     */
    constructor() { 
        
        ListAWSServiceAccessForOrganizationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAWSServiceAccessForOrganizationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAWSServiceAccessForOrganizationResponse} obj Optional instance to populate.
     * @return {module:model/ListAWSServiceAccessForOrganizationResponse} The populated <code>ListAWSServiceAccessForOrganizationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAWSServiceAccessForOrganizationResponse();

            if (data.hasOwnProperty('EnabledServicePrincipals')) {
                obj['EnabledServicePrincipals'] = ApiClient.convertToType(data['EnabledServicePrincipals'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListAWSServiceAccessForOrganizationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAWSServiceAccessForOrganizationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `EnabledServicePrincipals`
        if (data['EnabledServicePrincipals']) { // data not null
          Array.validateJSON(data['EnabledServicePrincipals']);
        }
...
/**
 * @member {Array} EnabledServicePrincipals
 */
ListAWSServiceAccessForOrganizationResponse.prototype['EnabledServicePrincipals'] = undefined;

/**
 * @member {String} NextToken
 */
ListAWSServiceAccessForOrganizationResponse.prototype['NextToken'] = undefined;
...
export default ListAWSServiceAccessForOrganizationResponse;
