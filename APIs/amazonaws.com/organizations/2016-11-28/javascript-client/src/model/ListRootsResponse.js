...
/**
 * The ListRootsResponse model module.
 * @module model/ListRootsResponse
 * @version 2016-11-28
 */
class ListRootsResponse {
    /**
     * Constructs a new <code>ListRootsResponse</code>.
     * @alias module:model/ListRootsResponse
     */
    constructor() { 
        
        ListRootsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRootsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRootsResponse} obj Optional instance to populate.
     * @return {module:model/ListRootsResponse} The populated <code>ListRootsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRootsResponse();

            if (data.hasOwnProperty('Roots')) {
                obj['Roots'] = ApiClient.convertToType(data['Roots'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListRootsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRootsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Roots`
        if (data['Roots']) { // data not null
          Array.validateJSON(data['Roots']);
        }
 ...
 * @member {Array} Roots
 */
ListRootsResponse.prototype['Roots'] = undefined;

/**
 * @member {String} NextToken
 */
ListRootsResponse.prototype['NextToken'] = undefined;
...
export default ListRootsResponse;
