...
* @readonly
*/
export default class EffectivePolicyType {
    ...
    /**
    * Returns a <code>EffectivePolicyType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EffectivePolicyType} The enum <code>EffectivePolicyType</code> value.
    */
