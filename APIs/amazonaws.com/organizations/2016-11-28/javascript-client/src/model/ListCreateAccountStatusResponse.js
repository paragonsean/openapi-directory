...
/**
 * The ListCreateAccountStatusResponse model module.
 * @module model/ListCreateAccountStatusResponse
 * @version 2016-11-28
 */
class ListCreateAccountStatusResponse {
    /**
     * Constructs a new <code>ListCreateAccountStatusResponse</code>.
     * @alias module:model/ListCreateAccountStatusResponse
     */
    constructor() { 
        
        ListCreateAccountStatusResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListCreateAccountStatusResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListCreateAccountStatusResponse} obj Optional instance to populate.
     * @return {module:model/ListCreateAccountStatusResponse} The populated <code>ListCreateAccountStatusResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListCreateAccountStatusResponse();

            if (data.hasOwnProperty('CreateAccountStatuses')) {
                obj['CreateAccountStatuses'] = ApiClient.convertToType(data['CreateAccountStatuses'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListCreateAccountStatusResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCreateAccountStatusResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CreateAccountStatuses`
        if (data['CreateAccountStatuses']) { // data not null
          Array.validateJSON(data['CreateAccountStatuses']);
        }
...
/**
 * @member {Array} CreateAccountStatuses
 */
ListCreateAccountStatusResponse.prototype['CreateAccountStatuses'] = undefined;

/**
 * @member {String} NextToken
 */
ListCreateAccountStatusResponse.prototype['NextToken'] = undefined;
...
export default ListCreateAccountStatusResponse;
