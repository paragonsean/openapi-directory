...
/**
 * The ListAWSServiceAccessForOrganizationRequest model module.
 * @module model/ListAWSServiceAccessForOrganizationRequest
 * @version 2016-11-28
 */
class ListAWSServiceAccessForOrganizationRequest {
    /**
     * Constructs a new <code>ListAWSServiceAccessForOrganizationRequest</code>.
     * @alias module:model/ListAWSServiceAccessForOrganizationRequest
     */
    constructor() { 
        
        ListAWSServiceAccessForOrganizationRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAWSServiceAccessForOrganizationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAWSServiceAccessForOrganizationRequest} obj Optional instance to populate.
     * @return {module:model/ListAWSServiceAccessForOrganizationRequest} The populated <code>ListAWSServiceAccessForOrganizationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAWSServiceAccessForOrganizationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAWSServiceAccessForOrganizationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAWSServiceAccessForOrganizationRequest</code>.
     */
 ...
 */
ListAWSServiceAccessForOrganizationRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListAWSServiceAccessForOrganizationRequest.prototype['MaxResults'] = undefined;
...
export default ListAWSServiceAccessForOrganizationRequest;
