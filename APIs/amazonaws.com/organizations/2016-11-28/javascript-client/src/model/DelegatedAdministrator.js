...
/**
 * The DelegatedAdministrator model module.
 * @module model/DelegatedAdministrator
 * @version 2016-11-28
 */
class DelegatedAdministrator {
    /**
     * Constructs a new <code>DelegatedAdministrator</code>.
     * Contains information about the delegated administrator.
     * @alias module:model/DelegatedAdministrator
     */
    constructor() { 
        
        DelegatedAdministrator.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DelegatedAdministrator</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DelegatedAdministrator} obj Optional instance to populate.
     * @return {module:model/DelegatedAdministrator} The populated <code>DelegatedAdministrator</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DelegatedAdministrator();
    ...
    /**
     * Validates the JSON data with respect to <code>DelegatedAdministrator</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DelegatedAdministrator</code>.
     */
 ...
 * @member {String} Id
 */
DelegatedAdministrator.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
DelegatedAdministrator.prototype['Arn'] = undefined;

/**
 * @member {String} Email
 */
DelegatedAdministrator.prototype['Email'] = undefined;

/**
 * @member {String} Name
 */
DelegatedAdministrator.prototype['Name'] = undefined;

/**
 * @member {module:model/AccountStatus} Status
 */
DelegatedAdministrator.prototype['Status'] = undefined;

/**
 * @member {module:model/AccountJoinedMethod} JoinedMethod
 */
DelegatedAdministrator.prototype['JoinedMethod'] = undefined;

/**
 * @member {Date} JoinedTimestamp
 */
DelegatedAdministrator.prototype['JoinedTimestamp'] = undefined;

/**
 * @member {Date} DelegationEnabledDate
 */
DelegatedAdministrator.prototype['DelegationEnabledDate'] = undefined;
...
export default DelegatedAdministrator;
