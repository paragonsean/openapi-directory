...
/**
 * The ListHandshakesForAccountRequestFilter model module.
 * @module model/ListHandshakesForAccountRequestFilter
 * @version 2016-11-28
 */
class ListHandshakesForAccountRequestFilter {
    /**
     * Constructs a new <code>ListHandshakesForAccountRequestFilter</code>.
     * @alias module:model/ListHandshakesForAccountRequestFilter
     * @implements module:model/HandshakeFilter
     */
    constructor() { 
        HandshakeFilter.initialize(this);
        ListHandshakesForAccountRequestFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListHandshakesForAccountRequestFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListHandshakesForAccountRequestFilter} obj Optional instance to populate.
     * @return {module:model/ListHandshakesForAccountRequestFilter} The populated <code>ListHandshakesForAccountRequestFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListHandshakesForAccountRequestFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>ListHandshakesForAccountRequestFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListHandshakesForAccountRequestFilter</code>.
     */
 ...
 */
ListHandshakesForAccountRequestFilter.prototype['ActionType'] = undefined;

/**
 * @member {String} ParentHandshakeId
 */
ListHandshakesForAccountRequestFilter.prototype['ParentHandshakeId'] = undefined;
...
export default ListHandshakesForAccountRequestFilter;
