...
/**
 * The ListAccountsForParentResponse model module.
 * @module model/ListAccountsForParentResponse
 * @version 2016-11-28
 */
class ListAccountsForParentResponse {
    /**
     * Constructs a new <code>ListAccountsForParentResponse</code>.
     * @alias module:model/ListAccountsForParentResponse
     */
    constructor() { 
        
        ListAccountsForParentResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAccountsForParentResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAccountsForParentResponse} obj Optional instance to populate.
     * @return {module:model/ListAccountsForParentResponse} The populated <code>ListAccountsForParentResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAccountsForParentResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAccountsForParentResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAccountsForParentResponse</code>.
     */
 ...
 */
ListAccountsForParentResponse.prototype['Accounts'] = undefined;

/**
 * @member {String} NextToken
 */
ListAccountsForParentResponse.prototype['NextToken'] = undefined;
...
export default ListAccountsForParentResponse;
