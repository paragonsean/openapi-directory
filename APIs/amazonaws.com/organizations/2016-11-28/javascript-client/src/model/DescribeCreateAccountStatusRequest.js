...
/**
 * The DescribeCreateAccountStatusRequest model module.
 * @module model/DescribeCreateAccountStatusRequest
 * @version 2016-11-28
 */
class DescribeCreateAccountStatusRequest {
    /**
     * Constructs a new <code>DescribeCreateAccountStatusRequest</code>.
     * @alias module:model/DescribeCreateAccountStatusRequest
     * @param createAccountRequestId {String} 
     */
    constructor(createAccountRequestId) { 
        
        DescribeCreateAccountStatusRequest.initialize(this, createAccountRequestId);
    }
     ...
     */
    static initialize(obj, createAccountRequestId) { 
        obj['CreateAccountRequestId'] = createAccountRequestId;
    }

    /**
     * Constructs a <code>DescribeCreateAccountStatusRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCreateAccountStatusRequest} obj Optional instance to populate.
     * @return {module:model/DescribeCreateAccountStatusRequest} The populated <code>DescribeCreateAccountStatusRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCreateAccountStatusRequest();

            if (data.hasOwnProperty('CreateAccountRequestId')) {
                obj['CreateAccountRequestId'] = ApiClient.convertToType(data['CreateAccountRequestId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCreateAccountStatusRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCreateAccountStatusRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeCreateAccountStatusRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `CreateAccountRequestId`
        if (data['CreateAccountRequestId']) { // data not null
          String.validateJSON(data['CreateAccountRequestId']);
        }
...
DescribeCreateAccountStatusRequest.RequiredProperties = ["CreateAccountRequestId"];

/**
 * @member {String} CreateAccountRequestId
 */
DescribeCreateAccountStatusRequest.prototype['CreateAccountRequestId'] = undefined;
...
export default DescribeCreateAccountStatusRequest;
