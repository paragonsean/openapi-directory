...
* @readonly
*/
export default class HandshakePartyType {
    ...
    /**
    * Returns a <code>HandshakePartyType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/HandshakePartyType} The enum <code>HandshakePartyType</code> value.
    */
