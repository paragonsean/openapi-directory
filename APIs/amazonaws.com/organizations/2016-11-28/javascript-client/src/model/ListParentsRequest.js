...
/**
 * The ListParentsRequest model module.
 * @module model/ListParentsRequest
 * @version 2016-11-28
 */
class ListParentsRequest {
    /**
     * Constructs a new <code>ListParentsRequest</code>.
     * @alias module:model/ListParentsRequest
     * @param childId {String} 
     */
    constructor(childId) { 
        
        ListParentsRequest.initialize(this, childId);
    }
     ...
     */
    static initialize(obj, childId) { 
        obj['ChildId'] = childId;
    }

    /**
     * Constructs a <code>ListParentsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListParentsRequest} obj Optional instance to populate.
     * @return {module:model/ListParentsRequest} The populated <code>ListParentsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListParentsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListParentsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListParentsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListParentsRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `ChildId`
        if (data['ChildId']) { // data not null
          String.validateJSON(data['ChildId']);
        }
...
ListParentsRequest.RequiredProperties = ["ChildId"];

/**
 * @member {String} ChildId
 */
ListParentsRequest.prototype['ChildId'] = undefined;

/**
 * @member {String} NextToken
 */
ListParentsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListParentsRequest.prototype['MaxResults'] = undefined;
...
export default ListParentsRequest;
