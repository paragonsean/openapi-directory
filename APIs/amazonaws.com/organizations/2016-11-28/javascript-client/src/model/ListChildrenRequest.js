...
/**
 * The ListChildrenRequest model module.
 * @module model/ListChildrenRequest
 * @version 2016-11-28
 */
class ListChildrenRequest {
    /**
     * Constructs a new <code>ListChildrenRequest</code>.
     * @alias module:model/ListChildrenRequest
     * @param parentId {String} 
     * @param childType {module:model/ChildType} 
     */
    constructor(parentId, childType) { 
        
        ListChildrenRequest.initialize(this, parentId, childType);
    }
     ...
     */
    static initialize(obj, parentId, childType) { 
        obj['ParentId'] = parentId;
        obj['ChildType'] = childType;
    }

    /**
     * Constructs a <code>ListChildrenRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListChildrenRequest} obj Optional instance to populate.
     * @return {module:model/ListChildrenRequest} The populated <code>ListChildrenRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListChildrenRequest();

            if (data.hasOwnProperty('ParentId')) {
                obj['ParentId'] = ApiClient.convertToType(data['ParentId'], 'String');
            }
            if (data.hasOwnProperty('ChildType')) {
                obj['ChildType'] = ApiClient.convertToType(data['ChildType'], ChildType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListChildrenRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListChildrenRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListChildrenRequest.RequiredProperties) {
        ...
        if (data['ChildType']) { // data not null
          ChildType.validateJSON(data['ChildType']);
        }
...
ListChildrenRequest.RequiredProperties = ["ParentId", "ChildType"];

/**
 * @member {String} ParentId
 */
ListChildrenRequest.prototype['ParentId'] = undefined;

/**
 * @member {module:model/ChildType} ChildType
 */
ListChildrenRequest.prototype['ChildType'] = undefined;

/**
 * @member {String} NextToken
 */
ListChildrenRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListChildrenRequest.prototype['MaxResults'] = undefined;
...
export default ListChildrenRequest;
