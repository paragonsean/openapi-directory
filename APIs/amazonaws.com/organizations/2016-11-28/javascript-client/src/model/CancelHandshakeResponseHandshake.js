...
/**
 * The CancelHandshakeResponseHandshake model module.
 * @module model/CancelHandshakeResponseHandshake
 * @version 2016-11-28
 */
class CancelHandshakeResponseHandshake {
    /**
     * Constructs a new <code>CancelHandshakeResponseHandshake</code>.
     * @alias module:model/CancelHandshakeResponseHandshake
     * @implements module:model/Handshake
     */
    constructor() { 
        Handshake.initialize(this);
        CancelHandshakeResponseHandshake.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CancelHandshakeResponseHandshake</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelHandshakeResponseHandshake} obj Optional instance to populate.
     * @return {module:model/CancelHandshakeResponseHandshake} The populated <code>CancelHandshakeResponseHandshake</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelHandshakeResponseHandshake();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelHandshakeResponseHandshake</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelHandshakeResponseHandshake</code>.
     */
 ...
 * @member {String} Id
 */
CancelHandshakeResponseHandshake.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
CancelHandshakeResponseHandshake.prototype['Arn'] = undefined;

/**
 * @member {Array} Parties
 */
CancelHandshakeResponseHandshake.prototype['Parties'] = undefined;

/**
 * @member {module:model/HandshakeState} State
 */
CancelHandshakeResponseHandshake.prototype['State'] = undefined;

/**
 * @member {Date} RequestedTimestamp
 */
CancelHandshakeResponseHandshake.prototype['RequestedTimestamp'] = undefined;

/**
 * @member {Date} ExpirationTimestamp
 */
CancelHandshakeResponseHandshake.prototype['ExpirationTimestamp'] = undefined;

/**
 * @member {module:model/ActionType} Action
 */
CancelHandshakeResponseHandshake.prototype['Action'] = undefined;

/**
 * @member {Array} Resources
 */
CancelHandshakeResponseHandshake.prototype['Resources'] = undefined;
...
export default CancelHandshakeResponseHandshake;
