...
/**
 * The ListPoliciesForTargetRequest model module.
 * @module model/ListPoliciesForTargetRequest
 * @version 2016-11-28
 */
class ListPoliciesForTargetRequest {
    /**
     * Constructs a new <code>ListPoliciesForTargetRequest</code>.
     * @alias module:model/ListPoliciesForTargetRequest
     * @param targetId {String} 
     * @param filter {module:model/PolicyType} 
     */
    constructor(targetId, filter) { 
        
        ListPoliciesForTargetRequest.initialize(this, targetId, filter);
    }
     ...
     */
    static initialize(obj, targetId, filter) { 
        obj['TargetId'] = targetId;
        obj['Filter'] = filter;
    }

    /**
     * Constructs a <code>ListPoliciesForTargetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPoliciesForTargetRequest} obj Optional instance to populate.
     * @return {module:model/ListPoliciesForTargetRequest} The populated <code>ListPoliciesForTargetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPoliciesForTargetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPoliciesForTargetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPoliciesForTargetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListPoliciesForTargetRequest.RequiredProperties) {
...
ListPoliciesForTargetRequest.RequiredProperties = ["TargetId", "Filter"];

/**
 * @member {String} TargetId
 */
ListPoliciesForTargetRequest.prototype['TargetId'] = undefined;

/**
 * @member {module:model/PolicyType} Filter
 */
ListPoliciesForTargetRequest.prototype['Filter'] = undefined;

/**
 * @member {String} NextToken
 */
ListPoliciesForTargetRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListPoliciesForTargetRequest.prototype['MaxResults'] = undefined;
...
export default ListPoliciesForTargetRequest;
