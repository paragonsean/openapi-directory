...
import CancelHandshakeResponseHandshake from './CancelHandshakeResponseHandshake';

/**
 * The CancelHandshakeResponse model module.
 * @module model/CancelHandshakeResponse
 * @version 2016-11-28
 */
class CancelHandshakeResponse {
    /**
     * Constructs a new <code>CancelHandshakeResponse</code>.
     * @alias module:model/CancelHandshakeResponse
     */
    constructor() { 
        
        CancelHandshakeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CancelHandshakeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelHandshakeResponse} obj Optional instance to populate.
     * @return {module:model/CancelHandshakeResponse} The populated <code>CancelHandshakeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelHandshakeResponse();

            if (data.hasOwnProperty('Handshake')) {
                obj['Handshake'] = CancelHandshakeResponseHandshake.constructFromObject(data['Handshake']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CancelHandshakeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelHandshakeResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Handshake`
        if (data['Handshake']) { // data not null
          CancelHandshakeResponseHandshake.validateJSON(data['Handshake']);
        }
...
/**
 * @member {module:model/CancelHandshakeResponseHandshake} Handshake
 */
CancelHandshakeResponse.prototype['Handshake'] = undefined;
...
export default CancelHandshakeResponse;
