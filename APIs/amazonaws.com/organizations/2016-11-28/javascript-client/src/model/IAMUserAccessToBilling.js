...
* @readonly
*/
export default class IAMUserAccessToBilling {
    ...
    /**
    * Returns a <code>IAMUserAccessToBilling</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/IAMUserAccessToBilling} The enum <code>IAMUserAccessToBilling</code> value.
    */
