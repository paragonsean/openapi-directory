...
import DescribeOrganizationResponseOrganization from './DescribeOrganizationResponseOrganization';

/**
 * The DescribeOrganizationResponse model module.
 * @module model/DescribeOrganizationResponse
 * @version 2016-11-28
 */
class DescribeOrganizationResponse {
    /**
     * Constructs a new <code>DescribeOrganizationResponse</code>.
     * @alias module:model/DescribeOrganizationResponse
     */
    constructor() { 
        
        DescribeOrganizationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeOrganizationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeOrganizationResponse} obj Optional instance to populate.
     * @return {module:model/DescribeOrganizationResponse} The populated <code>DescribeOrganizationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeOrganizationResponse();

            if (data.hasOwnProperty('Organization')) {
                obj['Organization'] = DescribeOrganizationResponseOrganization.constructFromObject(data['Organization']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeOrganizationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeOrganizationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Organization`
        if (data['Organization']) { // data not null
          DescribeOrganizationResponseOrganization.validateJSON(data['Organization']);
        }
...
/**
 * @member {module:model/DescribeOrganizationResponseOrganization} Organization
 */
DescribeOrganizationResponse.prototype['Organization'] = undefined;
...
export default DescribeOrganizationResponse;
