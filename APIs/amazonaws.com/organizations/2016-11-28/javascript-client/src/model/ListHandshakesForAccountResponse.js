...
/**
 * The ListHandshakesForAccountResponse model module.
 * @module model/ListHandshakesForAccountResponse
 * @version 2016-11-28
 */
class ListHandshakesForAccountResponse {
    /**
     * Constructs a new <code>ListHandshakesForAccountResponse</code>.
     * @alias module:model/ListHandshakesForAccountResponse
     */
    constructor() { 
        
        ListHandshakesForAccountResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListHandshakesForAccountResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListHandshakesForAccountResponse} obj Optional instance to populate.
     * @return {module:model/ListHandshakesForAccountResponse} The populated <code>ListHandshakesForAccountResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListHandshakesForAccountResponse();

            if (data.hasOwnProperty('Handshakes')) {
                obj['Handshakes'] = ApiClient.convertToType(data['Handshakes'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListHandshakesForAccountResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListHandshakesForAccountResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Handshakes`
        if (data['Handshakes']) { // data not null
          Array.validateJSON(data['Handshakes']);
        }
...
/**
 * @member {Array} Handshakes
 */
ListHandshakesForAccountResponse.prototype['Handshakes'] = undefined;

/**
 * @member {String} NextToken
 */
ListHandshakesForAccountResponse.prototype['NextToken'] = undefined;
...
export default ListHandshakesForAccountResponse;
