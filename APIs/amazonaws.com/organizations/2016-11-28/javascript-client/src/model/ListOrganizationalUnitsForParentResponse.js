...
/**
 * The ListOrganizationalUnitsForParentResponse model module.
 * @module model/ListOrganizationalUnitsForParentResponse
 * @version 2016-11-28
 */
class ListOrganizationalUnitsForParentResponse {
    /**
     * Constructs a new <code>ListOrganizationalUnitsForParentResponse</code>.
     * @alias module:model/ListOrganizationalUnitsForParentResponse
     */
    constructor() { 
        
        ListOrganizationalUnitsForParentResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListOrganizationalUnitsForParentResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListOrganizationalUnitsForParentResponse} obj Optional instance to populate.
     * @return {module:model/ListOrganizationalUnitsForParentResponse} The populated <code>ListOrganizationalUnitsForParentResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListOrganizationalUnitsForParentResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListOrganizationalUnitsForParentResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListOrganizationalUnitsForParentResponse</code>.
     */
 ...
 */
ListOrganizationalUnitsForParentResponse.prototype['OrganizationalUnits'] = undefined;

/**
 * @member {String} NextToken
 */
ListOrganizationalUnitsForParentResponse.prototype['NextToken'] = undefined;
...
export default ListOrganizationalUnitsForParentResponse;
