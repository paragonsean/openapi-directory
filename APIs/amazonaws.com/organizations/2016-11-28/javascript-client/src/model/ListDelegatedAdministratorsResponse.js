...
/**
 * The ListDelegatedAdministratorsResponse model module.
 * @module model/ListDelegatedAdministratorsResponse
 * @version 2016-11-28
 */
class ListDelegatedAdministratorsResponse {
    /**
     * Constructs a new <code>ListDelegatedAdministratorsResponse</code>.
     * @alias module:model/ListDelegatedAdministratorsResponse
     */
    constructor() { 
        
        ListDelegatedAdministratorsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListDelegatedAdministratorsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDelegatedAdministratorsResponse} obj Optional instance to populate.
     * @return {module:model/ListDelegatedAdministratorsResponse} The populated <code>ListDelegatedAdministratorsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDelegatedAdministratorsResponse();

            if (data.hasOwnProperty('DelegatedAdministrators')) {
                obj['DelegatedAdministrators'] = ApiClient.convertToType(data['DelegatedAdministrators'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListDelegatedAdministratorsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDelegatedAdministratorsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `DelegatedAdministrators`
        if (data['DelegatedAdministrators']) { // data not null
          Array.validateJSON(data['DelegatedAdministrators']);
        }
...
/**
 * @member {Array} DelegatedAdministrators
 */
ListDelegatedAdministratorsResponse.prototype['DelegatedAdministrators'] = undefined;

/**
 * @member {String} NextToken
 */
ListDelegatedAdministratorsResponse.prototype['NextToken'] = undefined;
...
export default ListDelegatedAdministratorsResponse;
