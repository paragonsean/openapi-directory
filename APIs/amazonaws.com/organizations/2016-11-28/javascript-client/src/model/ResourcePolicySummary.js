...
/**
 * The ResourcePolicySummary model module.
 * @module model/ResourcePolicySummary
 * @version 2016-11-28
 */
class ResourcePolicySummary {
    /**
     * Constructs a new <code>ResourcePolicySummary</code>.
     * A structure that contains resource policy ID and Amazon Resource Name (ARN).
     * @alias module:model/ResourcePolicySummary
     */
    constructor() { 
        
        ResourcePolicySummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResourcePolicySummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourcePolicySummary} obj Optional instance to populate.
     * @return {module:model/ResourcePolicySummary} The populated <code>ResourcePolicySummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourcePolicySummary();
    ...
    /**
     * Validates the JSON data with respect to <code>ResourcePolicySummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourcePolicySummary</code>.
     */
 ...
 * @member {String} Id
 */
ResourcePolicySummary.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
ResourcePolicySummary.prototype['Arn'] = undefined;
