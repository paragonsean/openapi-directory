...
import DescribeResourcePolicyResponseResourcePolicy from './DescribeResourcePolicyResponseResourcePolicy';
...
class DescribeResourcePolicyResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ResourcePolicy')) {
                obj['ResourcePolicy'] = DescribeResourcePolicyResponseResourcePolicy.constructFromObject(data['ResourcePolicy']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['ResourcePolicy']) { // data not null
          DescribeResourcePolicyResponseResourcePolicy.validateJSON(data['ResourcePolicy']);
        }
...
/**
 * @member {module:model/DescribeResourcePolicyResponseResourcePolicy} ResourcePolicy
 */
