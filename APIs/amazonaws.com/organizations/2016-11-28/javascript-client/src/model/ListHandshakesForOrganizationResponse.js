...
/**
 * The ListHandshakesForOrganizationResponse model module.
 * @module model/ListHandshakesForOrganizationResponse
 * @version 2016-11-28
 */
class ListHandshakesForOrganizationResponse {
    /**
     * Constructs a new <code>ListHandshakesForOrganizationResponse</code>.
     * @alias module:model/ListHandshakesForOrganizationResponse
     */
    constructor() { 
        
        ListHandshakesForOrganizationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListHandshakesForOrganizationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListHandshakesForOrganizationResponse} obj Optional instance to populate.
     * @return {module:model/ListHandshakesForOrganizationResponse} The populated <code>ListHandshakesForOrganizationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListHandshakesForOrganizationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListHandshakesForOrganizationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListHandshakesForOrganizationResponse</code>.
     */
 ...
 */
ListHandshakesForOrganizationResponse.prototype['Handshakes'] = undefined;

/**
 * @member {String} NextToken
 */
ListHandshakesForOrganizationResponse.prototype['NextToken'] = undefined;
...
export default ListHandshakesForOrganizationResponse;
