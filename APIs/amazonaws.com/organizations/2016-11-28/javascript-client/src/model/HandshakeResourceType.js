...
* @readonly
*/
export default class HandshakeResourceType {
        ...
        /**
         * value: "ORGANIZATION_FEATURE_SET"
         * @const
         */
    ...
    /**
    * Returns a <code>HandshakeResourceType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/HandshakeResourceType} The enum <code>HandshakeResourceType</code> value.
    */
