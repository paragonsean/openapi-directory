...
/**
 * The ListRootsRequest model module.
 * @module model/ListRootsRequest
 * @version 2016-11-28
 */
class ListRootsRequest {
    /**
     * Constructs a new <code>ListRootsRequest</code>.
     * @alias module:model/ListRootsRequest
     */
    constructor() { 
        
        ListRootsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRootsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRootsRequest} obj Optional instance to populate.
     * @return {module:model/ListRootsRequest} The populated <code>ListRootsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRootsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListRootsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRootsRequest</code>.
     */
 ...
 */
ListRootsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListRootsRequest.prototype['MaxResults'] = undefined;
...
export default ListRootsRequest;
