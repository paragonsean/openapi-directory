...
/**
 * The CreateGovCloudAccountRequest model module.
 * @module model/CreateGovCloudAccountRequest
 * @version 2016-11-28
 */
class CreateGovCloudAccountRequest {
    /**
     * Constructs a new <code>CreateGovCloudAccountRequest</code>.
     * @alias module:model/CreateGovCloudAccountRequest
     * @param email {String} 
     * @param accountName {String} 
     */
    constructor(email, accountName) { 
        
        CreateGovCloudAccountRequest.initialize(this, email, accountName);
    }
    ...
    /**
     * Constructs a <code>CreateGovCloudAccountRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGovCloudAccountRequest} obj Optional instance to populate.
     * @return {module:model/CreateGovCloudAccountRequest} The populated <code>CreateGovCloudAccountRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGovCloudAccountRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGovCloudAccountRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGovCloudAccountRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateGovCloudAccountRequest.RequiredProperties) {
...
CreateGovCloudAccountRequest.RequiredProperties = ["Email", "AccountName"];

/**
 * @member {String} Email
 */
CreateGovCloudAccountRequest.prototype['Email'] = undefined;

/**
 * @member {String} AccountName
 */
CreateGovCloudAccountRequest.prototype['AccountName'] = undefined;

/**
 * @member {String} RoleName
 */
CreateGovCloudAccountRequest.prototype['RoleName'] = undefined;

/**
 * @member {module:model/IAMUserAccessToBilling} IamUserAccessToBilling
 */
CreateGovCloudAccountRequest.prototype['IamUserAccessToBilling'] = undefined;

/**
 * @member {Array} Tags
 */
CreateGovCloudAccountRequest.prototype['Tags'] = undefined;
...
export default CreateGovCloudAccountRequest;
