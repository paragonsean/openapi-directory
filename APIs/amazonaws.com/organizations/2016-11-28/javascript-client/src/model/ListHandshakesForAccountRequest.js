...
import ListHandshakesForAccountRequestFilter from './ListHandshakesForAccountRequestFilter';

/**
 * The ListHandshakesForAccountRequest model module.
 * @module model/ListHandshakesForAccountRequest
 * @version 2016-11-28
 */
class ListHandshakesForAccountRequest {
    /**
     * Constructs a new <code>ListHandshakesForAccountRequest</code>.
     * @alias module:model/ListHandshakesForAccountRequest
     */
    constructor() { 
        
        ListHandshakesForAccountRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListHandshakesForAccountRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListHandshakesForAccountRequest} obj Optional instance to populate.
     * @return {module:model/ListHandshakesForAccountRequest} The populated <code>ListHandshakesForAccountRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListHandshakesForAccountRequest();

            if (data.hasOwnProperty('Filter')) {
                obj['Filter'] = ListHandshakesForAccountRequestFilter.constructFromObject(data['Filter']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListHandshakesForAccountRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListHandshakesForAccountRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Filter`
        if (data['Filter']) { // data not null
          ListHandshakesForAccountRequestFilter.validateJSON(data['Filter']);
        }
...
/**
 * @member {module:model/ListHandshakesForAccountRequestFilter} Filter
 */
ListHandshakesForAccountRequest.prototype['Filter'] = undefined;

/**
 * @member {String} NextToken
 */
ListHandshakesForAccountRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListHandshakesForAccountRequest.prototype['MaxResults'] = undefined;
...
export default ListHandshakesForAccountRequest;
