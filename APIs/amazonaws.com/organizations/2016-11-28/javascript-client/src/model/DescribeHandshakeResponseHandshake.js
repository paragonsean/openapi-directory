...
/**
 * The DescribeHandshakeResponseHandshake model module.
 * @module model/DescribeHandshakeResponseHandshake
 * @version 2016-11-28
 */
class DescribeHandshakeResponseHandshake {
    /**
     * Constructs a new <code>DescribeHandshakeResponseHandshake</code>.
     * @alias module:model/DescribeHandshakeResponseHandshake
     * @implements module:model/Handshake
     */
    constructor() { 
        Handshake.initialize(this);
        DescribeHandshakeResponseHandshake.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeHandshakeResponseHandshake</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeHandshakeResponseHandshake} obj Optional instance to populate.
     * @return {module:model/DescribeHandshakeResponseHandshake} The populated <code>DescribeHandshakeResponseHandshake</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeHandshakeResponseHandshake();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeHandshakeResponseHandshake</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeHandshakeResponseHandshake</code>.
     */
 ...
 * @member {String} Id
 */
DescribeHandshakeResponseHandshake.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
DescribeHandshakeResponseHandshake.prototype['Arn'] = undefined;

/**
 * @member {Array} Parties
 */
DescribeHandshakeResponseHandshake.prototype['Parties'] = undefined;

/**
 * @member {module:model/HandshakeState} State
 */
DescribeHandshakeResponseHandshake.prototype['State'] = undefined;

/**
 * @member {Date} RequestedTimestamp
 */
DescribeHandshakeResponseHandshake.prototype['RequestedTimestamp'] = undefined;

/**
 * @member {Date} ExpirationTimestamp
 */
DescribeHandshakeResponseHandshake.prototype['ExpirationTimestamp'] = undefined;

/**
 * @member {module:model/ActionType} Action
 */
DescribeHandshakeResponseHandshake.prototype['Action'] = undefined;

/**
 * @member {Array} Resources
 */
DescribeHandshakeResponseHandshake.prototype['Resources'] = undefined;
...
export default DescribeHandshakeResponseHandshake;
