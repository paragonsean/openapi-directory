...
/**
 * The ListTargetsForPolicyResponse model module.
 * @module model/ListTargetsForPolicyResponse
 * @version 2016-11-28
 */
class ListTargetsForPolicyResponse {
    /**
     * Constructs a new <code>ListTargetsForPolicyResponse</code>.
     * @alias module:model/ListTargetsForPolicyResponse
     */
    constructor() { 
        
        ListTargetsForPolicyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListTargetsForPolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTargetsForPolicyResponse} obj Optional instance to populate.
     * @return {module:model/ListTargetsForPolicyResponse} The populated <code>ListTargetsForPolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTargetsForPolicyResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListTargetsForPolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTargetsForPolicyResponse</code>.
     */
 ...
 */
ListTargetsForPolicyResponse.prototype['Targets'] = undefined;

/**
 * @member {String} NextToken
 */
ListTargetsForPolicyResponse.prototype['NextToken'] = undefined;
...
export default ListTargetsForPolicyResponse;
