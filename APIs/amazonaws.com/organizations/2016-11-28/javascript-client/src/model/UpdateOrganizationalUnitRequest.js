...
/**
 * The UpdateOrganizationalUnitRequest model module.
 * @module model/UpdateOrganizationalUnitRequest
 * @version 2016-11-28
 */
class UpdateOrganizationalUnitRequest {
    /**
     * Constructs a new <code>UpdateOrganizationalUnitRequest</code>.
     * @alias module:model/UpdateOrganizationalUnitRequest
     * @param organizationalUnitId {String} 
     */
    constructor(organizationalUnitId) { 
        
        UpdateOrganizationalUnitRequest.initialize(this, organizationalUnitId);
    }
     ...
     */
    static initialize(obj, organizationalUnitId) { 
        obj['OrganizationalUnitId'] = organizationalUnitId;
    }

    /**
     * Constructs a <code>UpdateOrganizationalUnitRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateOrganizationalUnitRequest} obj Optional instance to populate.
     * @return {module:model/UpdateOrganizationalUnitRequest} The populated <code>UpdateOrganizationalUnitRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateOrganizationalUnitRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateOrganizationalUnitRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateOrganizationalUnitRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateOrganizationalUnitRequest.RequiredProperties) {
...
UpdateOrganizationalUnitRequest.RequiredProperties = ["OrganizationalUnitId"];

/**
 * @member {String} OrganizationalUnitId
 */
UpdateOrganizationalUnitRequest.prototype['OrganizationalUnitId'] = undefined;

/**
 * @member {String} Name
 */
UpdateOrganizationalUnitRequest.prototype['Name'] = undefined;
...
export default UpdateOrganizationalUnitRequest;
