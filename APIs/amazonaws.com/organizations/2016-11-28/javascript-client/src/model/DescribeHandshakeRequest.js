...
/**
 * The DescribeHandshakeRequest model module.
 * @module model/DescribeHandshakeRequest
 * @version 2016-11-28
 */
class DescribeHandshakeRequest {
    /**
     * Constructs a new <code>DescribeHandshakeRequest</code>.
     * @alias module:model/DescribeHandshakeRequest
     * @param handshakeId {String} 
     */
    constructor(handshakeId) { 
        
        DescribeHandshakeRequest.initialize(this, handshakeId);
    }
    ...
    /**
     * Constructs a <code>DescribeHandshakeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeHandshakeRequest} obj Optional instance to populate.
     * @return {module:model/DescribeHandshakeRequest} The populated <code>DescribeHandshakeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeHandshakeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeHandshakeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeHandshakeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeHandshakeRequest.RequiredProperties) {
...
DescribeHandshakeRequest.RequiredProperties = ["HandshakeId"];

/**
 * @member {String} HandshakeId
 */
DescribeHandshakeRequest.prototype['HandshakeId'] = undefined;
...
export default DescribeHandshakeRequest;
