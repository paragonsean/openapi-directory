...
import UpdateOrganizationalUnitResponseOrganizationalUnit from './UpdateOrganizationalUnitResponseOrganizationalUnit';

/**
 * The UpdateOrganizationalUnitResponse model module.
 * @module model/UpdateOrganizationalUnitResponse
 * @version 2016-11-28
 */
class UpdateOrganizationalUnitResponse {
    /**
     * Constructs a new <code>UpdateOrganizationalUnitResponse</code>.
     * @alias module:model/UpdateOrganizationalUnitResponse
     */
    constructor() { 
        
        UpdateOrganizationalUnitResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateOrganizationalUnitResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateOrganizationalUnitResponse} obj Optional instance to populate.
     * @return {module:model/UpdateOrganizationalUnitResponse} The populated <code>UpdateOrganizationalUnitResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateOrganizationalUnitResponse();

            if (data.hasOwnProperty('OrganizationalUnit')) {
                obj['OrganizationalUnit'] = UpdateOrganizationalUnitResponseOrganizationalUnit.constructFromObject(data['OrganizationalUnit']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateOrganizationalUnitResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateOrganizationalUnitResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `OrganizationalUnit`
        if (data['OrganizationalUnit']) { // data not null
          UpdateOrganizationalUnitResponseOrganizationalUnit.validateJSON(data['OrganizationalUnit']);
        }
...
/**
 * @member {module:model/UpdateOrganizationalUnitResponseOrganizationalUnit} OrganizationalUnit
 */
UpdateOrganizationalUnitResponse.prototype['OrganizationalUnit'] = undefined;
...
export default UpdateOrganizationalUnitResponse;
