...
import DescribeOrganizationalUnitResponseOrganizationalUnit from './DescribeOrganizationalUnitResponseOrganizationalUnit';

/**
 * The DescribeOrganizationalUnitResponse model module.
 * @module model/DescribeOrganizationalUnitResponse
 * @version 2016-11-28
 */
class DescribeOrganizationalUnitResponse {
    /**
     * Constructs a new <code>DescribeOrganizationalUnitResponse</code>.
     * @alias module:model/DescribeOrganizationalUnitResponse
     */
    constructor() { 
        
        DescribeOrganizationalUnitResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeOrganizationalUnitResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeOrganizationalUnitResponse} obj Optional instance to populate.
     * @return {module:model/DescribeOrganizationalUnitResponse} The populated <code>DescribeOrganizationalUnitResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeOrganizationalUnitResponse();

            if (data.hasOwnProperty('OrganizationalUnit')) {
                obj['OrganizationalUnit'] = DescribeOrganizationalUnitResponseOrganizationalUnit.constructFromObject(data['OrganizationalUnit']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeOrganizationalUnitResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeOrganizationalUnitResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `OrganizationalUnit`
        if (data['OrganizationalUnit']) { // data not null
          DescribeOrganizationalUnitResponseOrganizationalUnit.validateJSON(data['OrganizationalUnit']);
        }
...
/**
 * @member {module:model/DescribeOrganizationalUnitResponseOrganizationalUnit} OrganizationalUnit
 */
DescribeOrganizationalUnitResponse.prototype['OrganizationalUnit'] = undefined;
...
export default DescribeOrganizationalUnitResponse;
