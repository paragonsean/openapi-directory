...
/**
 * The EnablePolicyTypeRequest model module.
 * @module model/EnablePolicyTypeRequest
 * @version 2016-11-28
 */
class EnablePolicyTypeRequest {
    /**
     * Constructs a new <code>EnablePolicyTypeRequest</code>.
     * @alias module:model/EnablePolicyTypeRequest
     * @param rootId {String} 
     * @param policyType {module:model/PolicyType} 
     */
    constructor(rootId, policyType) { 
        
        EnablePolicyTypeRequest.initialize(this, rootId, policyType);
    }
     ...
     */
    static initialize(obj, rootId, policyType) { 
        obj['RootId'] = rootId;
        obj['PolicyType'] = policyType;
    }

    /**
     * Constructs a <code>EnablePolicyTypeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnablePolicyTypeRequest} obj Optional instance to populate.
     * @return {module:model/EnablePolicyTypeRequest} The populated <code>EnablePolicyTypeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnablePolicyTypeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>EnablePolicyTypeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnablePolicyTypeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EnablePolicyTypeRequest.RequiredProperties) {
...
EnablePolicyTypeRequest.RequiredProperties = ["RootId", "PolicyType"];

/**
 * @member {String} RootId
 */
EnablePolicyTypeRequest.prototype['RootId'] = undefined;

/**
 * @member {module:model/PolicyType} PolicyType
 */
EnablePolicyTypeRequest.prototype['PolicyType'] = undefined;
...
export default EnablePolicyTypeRequest;
