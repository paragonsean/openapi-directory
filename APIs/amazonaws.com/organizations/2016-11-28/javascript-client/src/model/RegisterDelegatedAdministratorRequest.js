...
/**
 * The RegisterDelegatedAdministratorRequest model module.
 * @module model/RegisterDelegatedAdministratorRequest
 * @version 2016-11-28
 */
class RegisterDelegatedAdministratorRequest {
    /**
     * Constructs a new <code>RegisterDelegatedAdministratorRequest</code>.
     * @alias module:model/RegisterDelegatedAdministratorRequest
     * @param accountId {String} 
     * @param servicePrincipal {String} 
     */
    constructor(accountId, servicePrincipal) { 
        
        RegisterDelegatedAdministratorRequest.initialize(this, accountId, servicePrincipal);
    }
     ...
     */
    static initialize(obj, accountId, servicePrincipal) { 
        obj['AccountId'] = accountId;
        obj['ServicePrincipal'] = servicePrincipal;
    }

    /**
     * Constructs a <code>RegisterDelegatedAdministratorRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisterDelegatedAdministratorRequest} obj Optional instance to populate.
     * @return {module:model/RegisterDelegatedAdministratorRequest} The populated <code>RegisterDelegatedAdministratorRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisterDelegatedAdministratorRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RegisterDelegatedAdministratorRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisterDelegatedAdministratorRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RegisterDelegatedAdministratorRequest.RequiredProperties) {
...
RegisterDelegatedAdministratorRequest.RequiredProperties = ["AccountId", "ServicePrincipal"];

/**
 * @member {String} AccountId
 */
RegisterDelegatedAdministratorRequest.prototype['AccountId'] = undefined;

/**
 * @member {String} ServicePrincipal
 */
RegisterDelegatedAdministratorRequest.prototype['ServicePrincipal'] = undefined;
...
export default RegisterDelegatedAdministratorRequest;
