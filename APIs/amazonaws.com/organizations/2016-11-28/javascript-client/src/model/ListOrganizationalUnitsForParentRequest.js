...
/**
 * The ListOrganizationalUnitsForParentRequest model module.
 * @module model/ListOrganizationalUnitsForParentRequest
 * @version 2016-11-28
 */
class ListOrganizationalUnitsForParentRequest {
    /**
     * Constructs a new <code>ListOrganizationalUnitsForParentRequest</code>.
     * @alias module:model/ListOrganizationalUnitsForParentRequest
     * @param parentId {String} 
     */
    constructor(parentId) { 
        
        ListOrganizationalUnitsForParentRequest.initialize(this, parentId);
    }
    ...
    /**
     * Constructs a <code>ListOrganizationalUnitsForParentRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListOrganizationalUnitsForParentRequest} obj Optional instance to populate.
     * @return {module:model/ListOrganizationalUnitsForParentRequest} The populated <code>ListOrganizationalUnitsForParentRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListOrganizationalUnitsForParentRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListOrganizationalUnitsForParentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListOrganizationalUnitsForParentRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListOrganizationalUnitsForParentRequest.RequiredProperties) {
...
ListOrganizationalUnitsForParentRequest.RequiredProperties = ["ParentId"];

/**
 * @member {String} ParentId
 */
ListOrganizationalUnitsForParentRequest.prototype['ParentId'] = undefined;

/**
 * @member {String} NextToken
 */
ListOrganizationalUnitsForParentRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListOrganizationalUnitsForParentRequest.prototype['MaxResults'] = undefined;
...
export default ListOrganizationalUnitsForParentRequest;
