...
import CreateOrganizationalUnitResponseOrganizationalUnit from './CreateOrganizationalUnitResponseOrganizationalUnit';

/**
 * The CreateOrganizationalUnitResponse model module.
 * @module model/CreateOrganizationalUnitResponse
 * @version 2016-11-28
 */
class CreateOrganizationalUnitResponse {
    /**
     * Constructs a new <code>CreateOrganizationalUnitResponse</code>.
     * @alias module:model/CreateOrganizationalUnitResponse
     */
    constructor() { 
        
        CreateOrganizationalUnitResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateOrganizationalUnitResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateOrganizationalUnitResponse} obj Optional instance to populate.
     * @return {module:model/CreateOrganizationalUnitResponse} The populated <code>CreateOrganizationalUnitResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateOrganizationalUnitResponse();

            if (data.hasOwnProperty('OrganizationalUnit')) {
                obj['OrganizationalUnit'] = CreateOrganizationalUnitResponseOrganizationalUnit.constructFromObject(data['OrganizationalUnit']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateOrganizationalUnitResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateOrganizationalUnitResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `OrganizationalUnit`
        if (data['OrganizationalUnit']) { // data not null
          CreateOrganizationalUnitResponseOrganizationalUnit.validateJSON(data['OrganizationalUnit']);
        }
...
/**
 * @member {module:model/CreateOrganizationalUnitResponseOrganizationalUnit} OrganizationalUnit
 */
CreateOrganizationalUnitResponse.prototype['OrganizationalUnit'] = undefined;
...
export default CreateOrganizationalUnitResponse;
