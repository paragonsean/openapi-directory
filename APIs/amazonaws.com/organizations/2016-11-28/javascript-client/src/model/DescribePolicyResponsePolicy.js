...
/**
 * The DescribePolicyResponsePolicy model module.
 * @module model/DescribePolicyResponsePolicy
 * @version 2016-11-28
 */
class DescribePolicyResponsePolicy {
    /**
     * Constructs a new <code>DescribePolicyResponsePolicy</code>.
     * @alias module:model/DescribePolicyResponsePolicy
     * @implements module:model/Policy
     */
    constructor() { 
        Policy.initialize(this);
        DescribePolicyResponsePolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribePolicyResponsePolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePolicyResponsePolicy} obj Optional instance to populate.
     * @return {module:model/DescribePolicyResponsePolicy} The populated <code>DescribePolicyResponsePolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePolicyResponsePolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePolicyResponsePolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePolicyResponsePolicy</code>.
     */
 ...
 */
DescribePolicyResponsePolicy.prototype['PolicySummary'] = undefined;

/**
 * @member {String} Content
 */
DescribePolicyResponsePolicy.prototype['Content'] = undefined;
...
export default DescribePolicyResponsePolicy;
