...
/**
 * The ListParentsResponse model module.
 * @module model/ListParentsResponse
 * @version 2016-11-28
 */
class ListParentsResponse {
    /**
     * Constructs a new <code>ListParentsResponse</code>.
     * @alias module:model/ListParentsResponse
     */
    constructor() { 
        
        ListParentsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListParentsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListParentsResponse} obj Optional instance to populate.
     * @return {module:model/ListParentsResponse} The populated <code>ListParentsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListParentsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListParentsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListParentsResponse</code>.
     */
 ...
 */
ListParentsResponse.prototype['Parents'] = undefined;

/**
 * @member {String} NextToken
 */
ListParentsResponse.prototype['NextToken'] = undefined;
...
export default ListParentsResponse;
