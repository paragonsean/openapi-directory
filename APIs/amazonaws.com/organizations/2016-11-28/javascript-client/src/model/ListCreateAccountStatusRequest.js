...
/**
 * The ListCreateAccountStatusRequest model module.
 * @module model/ListCreateAccountStatusRequest
 * @version 2016-11-28
 */
class ListCreateAccountStatusRequest {
    /**
     * Constructs a new <code>ListCreateAccountStatusRequest</code>.
     * @alias module:model/ListCreateAccountStatusRequest
     */
    constructor() { 
        
        ListCreateAccountStatusRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListCreateAccountStatusRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListCreateAccountStatusRequest} obj Optional instance to populate.
     * @return {module:model/ListCreateAccountStatusRequest} The populated <code>ListCreateAccountStatusRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListCreateAccountStatusRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListCreateAccountStatusRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCreateAccountStatusRequest</code>.
     */
 ...
 * @member {Array} States
 */
ListCreateAccountStatusRequest.prototype['States'] = undefined;

/**
 * @member {String} NextToken
 */
ListCreateAccountStatusRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListCreateAccountStatusRequest.prototype['MaxResults'] = undefined;
...
export default ListCreateAccountStatusRequest;
