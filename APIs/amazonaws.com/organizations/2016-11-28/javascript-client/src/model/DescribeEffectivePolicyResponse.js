...
import DescribeEffectivePolicyResponseEffectivePolicy from './DescribeEffectivePolicyResponseEffectivePolicy';

/**
 * The DescribeEffectivePolicyResponse model module.
 * @module model/DescribeEffectivePolicyResponse
 * @version 2016-11-28
 */
class DescribeEffectivePolicyResponse {
    /**
     * Constructs a new <code>DescribeEffectivePolicyResponse</code>.
     * @alias module:model/DescribeEffectivePolicyResponse
     */
    constructor() { 
        
        DescribeEffectivePolicyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEffectivePolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEffectivePolicyResponse} obj Optional instance to populate.
     * @return {module:model/DescribeEffectivePolicyResponse} The populated <code>DescribeEffectivePolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEffectivePolicyResponse();

            if (data.hasOwnProperty('EffectivePolicy')) {
                obj['EffectivePolicy'] = DescribeEffectivePolicyResponseEffectivePolicy.constructFromObject(data['EffectivePolicy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEffectivePolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEffectivePolicyResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `EffectivePolicy`
        if (data['EffectivePolicy']) { // data not null
          DescribeEffectivePolicyResponseEffectivePolicy.validateJSON(data['EffectivePolicy']);
        }
...
/**
 * @member {module:model/DescribeEffectivePolicyResponseEffectivePolicy} EffectivePolicy
 */
DescribeEffectivePolicyResponse.prototype['EffectivePolicy'] = undefined;
...
export default DescribeEffectivePolicyResponse;
