...
/**
 * The CreatePolicyRequest model module.
 * @module model/CreatePolicyRequest
 * @version 2016-11-28
 */
class CreatePolicyRequest {
    /**
     * Constructs a new <code>CreatePolicyRequest</code>.
     * @alias module:model/CreatePolicyRequest
     * @param content {String} 
     * @param description {String} 
     * @param name {String} 
     * @param type {module:model/PolicyType} 
     */
    constructor(content, description, name, type) { 
        
        CreatePolicyRequest.initialize(this, content, description, name, type);
    }
     ...
     */
    static initialize(obj, content, description, name, type) { 
        obj['Content'] = content;
    ...
    /**
     * Constructs a <code>CreatePolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePolicyRequest} obj Optional instance to populate.
     * @return {module:model/CreatePolicyRequest} The populated <code>CreatePolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePolicyRequest();
            ...
            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], PolicyType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePolicyRequest.RequiredProperties) {
        ...
        if (data['Type']) { // data not null
          PolicyType.validateJSON(data['Type']);
        }
...
CreatePolicyRequest.RequiredProperties = ["Content", "Description", "Name", "Type"];

/**
 * @member {String} Content
 */
CreatePolicyRequest.prototype['Content'] = undefined;

/**
 * @member {String} Description
 */
CreatePolicyRequest.prototype['Description'] = undefined;

/**
 * @member {String} Name
 */
CreatePolicyRequest.prototype['Name'] = undefined;

/**
 * @member {module:model/PolicyType} Type
 */
CreatePolicyRequest.prototype['Type'] = undefined;

/**
 * @member {Array} Tags
 */
CreatePolicyRequest.prototype['Tags'] = undefined;
