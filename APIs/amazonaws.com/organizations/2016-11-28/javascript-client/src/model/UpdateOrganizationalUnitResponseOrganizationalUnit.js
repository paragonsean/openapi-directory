...
/**
 * The UpdateOrganizationalUnitResponseOrganizationalUnit model module.
 * @module model/UpdateOrganizationalUnitResponseOrganizationalUnit
 * @version 2016-11-28
 */
class UpdateOrganizationalUnitResponseOrganizationalUnit {
    /**
     * Constructs a new <code>UpdateOrganizationalUnitResponseOrganizationalUnit</code>.
     * @alias module:model/UpdateOrganizationalUnitResponseOrganizationalUnit
     * @implements module:model/OrganizationalUnit
     */
    constructor() { 
        OrganizationalUnit.initialize(this);
        UpdateOrganizationalUnitResponseOrganizationalUnit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateOrganizationalUnitResponseOrganizationalUnit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateOrganizationalUnitResponseOrganizationalUnit} obj Optional instance to populate.
     * @return {module:model/UpdateOrganizationalUnitResponseOrganizationalUnit} The populated <code>UpdateOrganizationalUnitResponseOrganizationalUnit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateOrganizationalUnitResponseOrganizationalUnit();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateOrganizationalUnitResponseOrganizationalUnit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateOrganizationalUnitResponseOrganizationalUnit</code>.
     */
 ...
 * @member {String} Id
 */
UpdateOrganizationalUnitResponseOrganizationalUnit.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
UpdateOrganizationalUnitResponseOrganizationalUnit.prototype['Arn'] = undefined;

/**
 * @member {String} Name
 */
UpdateOrganizationalUnitResponseOrganizationalUnit.prototype['Name'] = undefined;
...
export default UpdateOrganizationalUnitResponseOrganizationalUnit;
