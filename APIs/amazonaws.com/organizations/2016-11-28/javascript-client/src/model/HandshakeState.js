...
* @readonly
*/
export default class HandshakeState {
    ...
    /**
    * Returns a <code>HandshakeState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/HandshakeState} The enum <code>HandshakeState</code> value.
    */
