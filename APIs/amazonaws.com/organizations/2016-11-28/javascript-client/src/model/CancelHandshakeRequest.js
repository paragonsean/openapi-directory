...
/**
 * The CancelHandshakeRequest model module.
 * @module model/CancelHandshakeRequest
 * @version 2016-11-28
 */
class CancelHandshakeRequest {
    /**
     * Constructs a new <code>CancelHandshakeRequest</code>.
     * @alias module:model/CancelHandshakeRequest
     * @param handshakeId {String} 
     */
    constructor(handshakeId) { 
        
        CancelHandshakeRequest.initialize(this, handshakeId);
    }
    ...
    /**
     * Constructs a <code>CancelHandshakeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelHandshakeRequest} obj Optional instance to populate.
     * @return {module:model/CancelHandshakeRequest} The populated <code>CancelHandshakeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelHandshakeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelHandshakeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelHandshakeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CancelHandshakeRequest.RequiredProperties) {
...
CancelHandshakeRequest.RequiredProperties = ["HandshakeId"];

/**
 * @member {String} HandshakeId
 */
CancelHandshakeRequest.prototype['HandshakeId'] = undefined;
...
export default CancelHandshakeRequest;
