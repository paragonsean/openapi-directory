...
/**
 * The UpdatePolicyResponsePolicy model module.
 * @module model/UpdatePolicyResponsePolicy
 * @version 2016-11-28
 */
class UpdatePolicyResponsePolicy {
    /**
     * Constructs a new <code>UpdatePolicyResponsePolicy</code>.
     * @alias module:model/UpdatePolicyResponsePolicy
     * @implements module:model/Policy
     */
    constructor() { 
        Policy.initialize(this);
        UpdatePolicyResponsePolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePolicyResponsePolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePolicyResponsePolicy} obj Optional instance to populate.
     * @return {module:model/UpdatePolicyResponsePolicy} The populated <code>UpdatePolicyResponsePolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePolicyResponsePolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePolicyResponsePolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePolicyResponsePolicy</code>.
     */
 ...
 */
UpdatePolicyResponsePolicy.prototype['PolicySummary'] = undefined;

/**
 * @member {String} Content
 */
UpdatePolicyResponsePolicy.prototype['Content'] = undefined;
...
export default UpdatePolicyResponsePolicy;
