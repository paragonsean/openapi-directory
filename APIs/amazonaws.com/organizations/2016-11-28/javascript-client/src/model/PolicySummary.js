...
/**
 * The PolicySummary model module.
 * @module model/PolicySummary
 * @version 2016-11-28
 */
class PolicySummary {
    /**
     * Constructs a new <code>PolicySummary</code>.
     ...
     * @alias module:model/PolicySummary
     */
    constructor() { 
        
        PolicySummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicySummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicySummary} obj Optional instance to populate.
     * @return {module:model/PolicySummary} The populated <code>PolicySummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicySummary();
            ...
            if (data.hasOwnProperty('AwsManaged')) {
                obj['AwsManaged'] = ApiClient.convertToType(data['AwsManaged'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PolicySummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicySummary</code>.
     */
    static validateJSON(data) {
        ...
        if (data['AwsManaged']) { // data not null
          Boolean.validateJSON(data['AwsManaged']);
        }
 ...
 * @member {String} Id
 */
PolicySummary.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
PolicySummary.prototype['Arn'] = undefined;

/**
 * @member {String} Name
 */
PolicySummary.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
PolicySummary.prototype['Description'] = undefined;

/**
 * @member {module:model/PolicyType} Type
 */
PolicySummary.prototype['Type'] = undefined;

/**
 * @member {Boolean} AwsManaged
 */
PolicySummary.prototype['AwsManaged'] = undefined;
