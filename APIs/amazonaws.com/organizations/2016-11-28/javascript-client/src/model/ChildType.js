...
* @readonly
*/
export default class ChildType {
    ...
    /**
    * Returns a <code>ChildType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ChildType} The enum <code>ChildType</code> value.
    */
