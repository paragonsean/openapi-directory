...
/**
 * The EnableAllFeaturesResponseHandshake model module.
 * @module model/EnableAllFeaturesResponseHandshake
 * @version 2016-11-28
 */
class EnableAllFeaturesResponseHandshake {
    /**
     * Constructs a new <code>EnableAllFeaturesResponseHandshake</code>.
     * @alias module:model/EnableAllFeaturesResponseHandshake
     * @implements module:model/Handshake
     */
    constructor() { 
        Handshake.initialize(this);
        EnableAllFeaturesResponseHandshake.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EnableAllFeaturesResponseHandshake</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnableAllFeaturesResponseHandshake} obj Optional instance to populate.
     * @return {module:model/EnableAllFeaturesResponseHandshake} The populated <code>EnableAllFeaturesResponseHandshake</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnableAllFeaturesResponseHandshake();
    ...
    /**
     * Validates the JSON data with respect to <code>EnableAllFeaturesResponseHandshake</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnableAllFeaturesResponseHandshake</code>.
     */
 ...
 * @member {String} Id
 */
EnableAllFeaturesResponseHandshake.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
EnableAllFeaturesResponseHandshake.prototype['Arn'] = undefined;

/**
 * @member {Array} Parties
 */
EnableAllFeaturesResponseHandshake.prototype['Parties'] = undefined;

/**
 * @member {module:model/HandshakeState} State
 */
EnableAllFeaturesResponseHandshake.prototype['State'] = undefined;

/**
 * @member {Date} RequestedTimestamp
 */
EnableAllFeaturesResponseHandshake.prototype['RequestedTimestamp'] = undefined;

/**
 * @member {Date} ExpirationTimestamp
 */
EnableAllFeaturesResponseHandshake.prototype['ExpirationTimestamp'] = undefined;

/**
 * @member {module:model/ActionType} Action
 */
EnableAllFeaturesResponseHandshake.prototype['Action'] = undefined;

/**
 * @member {Array} Resources
 */
EnableAllFeaturesResponseHandshake.prototype['Resources'] = undefined;
...
export default EnableAllFeaturesResponseHandshake;
