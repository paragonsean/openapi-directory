...
/**
 * The DescribeOrganizationalUnitResponseOrganizationalUnit model module.
 * @module model/DescribeOrganizationalUnitResponseOrganizationalUnit
 * @version 2016-11-28
 */
class DescribeOrganizationalUnitResponseOrganizationalUnit {
    /**
     * Constructs a new <code>DescribeOrganizationalUnitResponseOrganizationalUnit</code>.
     * @alias module:model/DescribeOrganizationalUnitResponseOrganizationalUnit
     * @implements module:model/OrganizationalUnit
     */
    constructor() { 
        OrganizationalUnit.initialize(this);
        DescribeOrganizationalUnitResponseOrganizationalUnit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeOrganizationalUnitResponseOrganizationalUnit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeOrganizationalUnitResponseOrganizationalUnit} obj Optional instance to populate.
     * @return {module:model/DescribeOrganizationalUnitResponseOrganizationalUnit} The populated <code>DescribeOrganizationalUnitResponseOrganizationalUnit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeOrganizationalUnitResponseOrganizationalUnit();
            OrganizationalUnit.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeOrganizationalUnitResponseOrganizationalUnit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeOrganizationalUnitResponseOrganizationalUnit</code>.
     */
 ...
 * @member {String} Id
 */
DescribeOrganizationalUnitResponseOrganizationalUnit.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
DescribeOrganizationalUnitResponseOrganizationalUnit.prototype['Arn'] = undefined;

/**
 * @member {String} Name
 */
DescribeOrganizationalUnitResponseOrganizationalUnit.prototype['Name'] = undefined;


// Implement OrganizationalUnit interface:
/**
 * @member {String} Id
 */
...
export default DescribeOrganizationalUnitResponseOrganizationalUnit;
