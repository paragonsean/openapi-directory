...
/**
 * The CreateAccountStatus model module.
 * @module model/CreateAccountStatus
 * @version 2016-11-28
 */
class CreateAccountStatus {
    /**
     * Constructs a new <code>CreateAccountStatus</code>.
     ...
     * @alias module:model/CreateAccountStatus
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CreateAccountStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAccountStatus} obj Optional instance to populate.
     * @return {module:model/CreateAccountStatus} The populated <code>CreateAccountStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAccountStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAccountStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAccountStatus</code>.
     */
