...
import AcceptHandshakeResponseHandshake from './AcceptHandshakeResponseHandshake';

/**
 * The AcceptHandshakeResponse model module.
 * @module model/AcceptHandshakeResponse
 * @version 2016-11-28
 */
class AcceptHandshakeResponse {
    /**
     * Constructs a new <code>AcceptHandshakeResponse</code>.
     * @alias module:model/AcceptHandshakeResponse
     */
    constructor() { 
        
        AcceptHandshakeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AcceptHandshakeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AcceptHandshakeResponse} obj Optional instance to populate.
     * @return {module:model/AcceptHandshakeResponse} The populated <code>AcceptHandshakeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AcceptHandshakeResponse();

            if (data.hasOwnProperty('Handshake')) {
                obj['Handshake'] = AcceptHandshakeResponseHandshake.constructFromObject(data['Handshake']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AcceptHandshakeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AcceptHandshakeResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Handshake`
        if (data['Handshake']) { // data not null
          AcceptHandshakeResponseHandshake.validateJSON(data['Handshake']);
        }
...
/**
 * @member {module:model/AcceptHandshakeResponseHandshake} Handshake
 */
AcceptHandshakeResponse.prototype['Handshake'] = undefined;
...
export default AcceptHandshakeResponse;
