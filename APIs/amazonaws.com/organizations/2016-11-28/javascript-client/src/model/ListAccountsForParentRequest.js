...
/**
 * The ListAccountsForParentRequest model module.
 * @module model/ListAccountsForParentRequest
 * @version 2016-11-28
 */
class ListAccountsForParentRequest {
    /**
     * Constructs a new <code>ListAccountsForParentRequest</code>.
     * @alias module:model/ListAccountsForParentRequest
     * @param parentId {String} 
     */
    constructor(parentId) { 
        
        ListAccountsForParentRequest.initialize(this, parentId);
    }
    ...
    /**
     * Constructs a <code>ListAccountsForParentRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAccountsForParentRequest} obj Optional instance to populate.
     * @return {module:model/ListAccountsForParentRequest} The populated <code>ListAccountsForParentRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAccountsForParentRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAccountsForParentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAccountsForParentRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListAccountsForParentRequest.RequiredProperties) {
...
ListAccountsForParentRequest.RequiredProperties = ["ParentId"];

/**
 * @member {String} ParentId
 */
ListAccountsForParentRequest.prototype['ParentId'] = undefined;

/**
 * @member {String} NextToken
 */
ListAccountsForParentRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListAccountsForParentRequest.prototype['MaxResults'] = undefined;
...
export default ListAccountsForParentRequest;
