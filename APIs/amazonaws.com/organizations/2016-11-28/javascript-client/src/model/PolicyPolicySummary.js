...
/**
 * The PolicyPolicySummary model module.
 * @module model/PolicyPolicySummary
 * @version 2016-11-28
 */
class PolicyPolicySummary {
    /**
     * Constructs a new <code>PolicyPolicySummary</code>.
     * @alias module:model/PolicyPolicySummary
     * @implements module:model/PolicySummary
     */
    constructor() { 
        PolicySummary.initialize(this);
        PolicyPolicySummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyPolicySummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyPolicySummary} obj Optional instance to populate.
     * @return {module:model/PolicyPolicySummary} The populated <code>PolicyPolicySummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyPolicySummary();
            PolicySummary.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyPolicySummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyPolicySummary</code>.
     */
 ...
 * @member {String} Id
 */
PolicyPolicySummary.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
PolicyPolicySummary.prototype['Arn'] = undefined;

/**
 * @member {String} Name
 */
PolicyPolicySummary.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
PolicyPolicySummary.prototype['Description'] = undefined;

/**
 * @member {module:model/PolicyType} Type
 */
PolicyPolicySummary.prototype['Type'] = undefined;

/**
 * @member {Boolean} AwsManaged
 */
PolicyPolicySummary.prototype['AwsManaged'] = undefined;


// Implement PolicySummary interface:
/**
 * @member {String} Id
 */
...
export default PolicyPolicySummary;
