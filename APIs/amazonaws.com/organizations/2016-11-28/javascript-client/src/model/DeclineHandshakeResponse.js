...
import DeclineHandshakeResponseHandshake from './DeclineHandshakeResponseHandshake';

/**
 * The DeclineHandshakeResponse model module.
 * @module model/DeclineHandshakeResponse
 * @version 2016-11-28
 */
class DeclineHandshakeResponse {
    /**
     * Constructs a new <code>DeclineHandshakeResponse</code>.
     * @alias module:model/DeclineHandshakeResponse
     */
    constructor() { 
        
        DeclineHandshakeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeclineHandshakeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeclineHandshakeResponse} obj Optional instance to populate.
     * @return {module:model/DeclineHandshakeResponse} The populated <code>DeclineHandshakeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeclineHandshakeResponse();

            if (data.hasOwnProperty('Handshake')) {
                obj['Handshake'] = DeclineHandshakeResponseHandshake.constructFromObject(data['Handshake']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeclineHandshakeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeclineHandshakeResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Handshake`
        if (data['Handshake']) { // data not null
          DeclineHandshakeResponseHandshake.validateJSON(data['Handshake']);
        }
...
/**
 * @member {module:model/DeclineHandshakeResponseHandshake} Handshake
 */
DeclineHandshakeResponse.prototype['Handshake'] = undefined;
...
export default DeclineHandshakeResponse;
