...
/**
 * The EnablePolicyTypeResponse model module.
 * @module model/EnablePolicyTypeResponse
 * @version 2016-11-28
 */
class EnablePolicyTypeResponse {
    /**
     * Constructs a new <code>EnablePolicyTypeResponse</code>.
     * @alias module:model/EnablePolicyTypeResponse
     */
    constructor() { 
        
        EnablePolicyTypeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EnablePolicyTypeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnablePolicyTypeResponse} obj Optional instance to populate.
     * @return {module:model/EnablePolicyTypeResponse} The populated <code>EnablePolicyTypeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnablePolicyTypeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>EnablePolicyTypeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnablePolicyTypeResponse</code>.
     */
 ...
 */
EnablePolicyTypeResponse.prototype['Root'] = undefined;
...
export default EnablePolicyTypeResponse;
