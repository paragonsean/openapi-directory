...
/**
 * The ListPoliciesForTargetResponse model module.
 * @module model/ListPoliciesForTargetResponse
 * @version 2016-11-28
 */
class ListPoliciesForTargetResponse {
    /**
     * Constructs a new <code>ListPoliciesForTargetResponse</code>.
     * @alias module:model/ListPoliciesForTargetResponse
     */
    constructor() { 
        
        ListPoliciesForTargetResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListPoliciesForTargetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPoliciesForTargetResponse} obj Optional instance to populate.
     * @return {module:model/ListPoliciesForTargetResponse} The populated <code>ListPoliciesForTargetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPoliciesForTargetResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPoliciesForTargetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPoliciesForTargetResponse</code>.
     */
 ...
 */
ListPoliciesForTargetResponse.prototype['Policies'] = undefined;

/**
 * @member {String} NextToken
 */
ListPoliciesForTargetResponse.prototype['NextToken'] = undefined;
...
export default ListPoliciesForTargetResponse;
