...
/**
 * The Handshake model module.
 * @module model/Handshake
 * @version 2016-11-28
 */
class Handshake {
    /**
     * Constructs a new <code>Handshake</code>.
    ...
    /**
     * Constructs a <code>Handshake</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Handshake} obj Optional instance to populate.
     * @return {module:model/Handshake} The populated <code>Handshake</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Handshake();
    ...
    /**
     * Validates the JSON data with respect to <code>Handshake</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Handshake</code>.
     */
