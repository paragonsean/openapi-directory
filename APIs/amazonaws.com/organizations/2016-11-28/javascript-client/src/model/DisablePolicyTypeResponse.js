...
import DisablePolicyTypeResponseRoot from './DisablePolicyTypeResponseRoot';

/**
 * The DisablePolicyTypeResponse model module.
 * @module model/DisablePolicyTypeResponse
 * @version 2016-11-28
 */
class DisablePolicyTypeResponse {
    /**
     * Constructs a new <code>DisablePolicyTypeResponse</code>.
     * @alias module:model/DisablePolicyTypeResponse
     */
    constructor() { 
        
        DisablePolicyTypeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisablePolicyTypeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisablePolicyTypeResponse} obj Optional instance to populate.
     * @return {module:model/DisablePolicyTypeResponse} The populated <code>DisablePolicyTypeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisablePolicyTypeResponse();

            if (data.hasOwnProperty('Root')) {
                obj['Root'] = DisablePolicyTypeResponseRoot.constructFromObject(data['Root']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DisablePolicyTypeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisablePolicyTypeResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Root`
        if (data['Root']) { // data not null
          DisablePolicyTypeResponseRoot.validateJSON(data['Root']);
        }
...
/**
 * @member {module:model/DisablePolicyTypeResponseRoot} Root
 */
DisablePolicyTypeResponse.prototype['Root'] = undefined;
...
export default DisablePolicyTypeResponse;
