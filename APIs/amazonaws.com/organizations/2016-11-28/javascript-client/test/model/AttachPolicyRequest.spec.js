...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.AttachPolicyRequest();
  });
  ...
  describe('AttachPolicyRequest', function() {
    it('should create an instance of AttachPolicyRequest', function() {
      ...
      //var instance = new AwsOrganizations.AttachPolicyRequest();
      //expect(instance).to.be.a(AwsOrganizations.AttachPolicyRequest);
    });
