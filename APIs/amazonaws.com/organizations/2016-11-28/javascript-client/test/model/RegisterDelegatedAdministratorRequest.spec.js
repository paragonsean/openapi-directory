...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.RegisterDelegatedAdministratorRequest();
  });
  ...
  describe('RegisterDelegatedAdministratorRequest', function() {
    it('should create an instance of RegisterDelegatedAdministratorRequest', function() {
      // uncomment below and update the code to test RegisterDelegatedAdministratorRequest
      //var instance = new AwsOrganizations.RegisterDelegatedAdministratorRequest();
      //expect(instance).to.be.a(AwsOrganizations.RegisterDelegatedAdministratorRequest);
    });
