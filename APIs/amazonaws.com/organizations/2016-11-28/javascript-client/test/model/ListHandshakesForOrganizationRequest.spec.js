...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListHandshakesForOrganizationRequest();
  });
  ...
  describe('ListHandshakesForOrganizationRequest', function() {
    it('should create an instance of ListHandshakesForOrganizationRequest', function() {
      // uncomment below and update the code to test ListHandshakesForOrganizationRequest
      //var instance = new AwsOrganizations.ListHandshakesForOrganizationRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListHandshakesForOrganizationRequest);
    });
