...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.PutResourcePolicyResponse();
  });
  ...
  describe('PutResourcePolicyResponse', function() {
    it('should create an instance of PutResourcePolicyResponse', function() {
      ...
      //var instance = new AwsOrganizations.PutResourcePolicyResponse();
      //expect(instance).to.be.a(AwsOrganizations.PutResourcePolicyResponse);
    });
