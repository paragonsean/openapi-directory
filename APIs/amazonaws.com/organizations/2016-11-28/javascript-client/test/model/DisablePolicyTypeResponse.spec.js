...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DisablePolicyTypeResponse();
  });
  ...
  describe('DisablePolicyTypeResponse', function() {
    it('should create an instance of DisablePolicyTypeResponse', function() {
      // uncomment below and update the code to test DisablePolicyTypeResponse
      //var instance = new AwsOrganizations.DisablePolicyTypeResponse();
      //expect(instance).to.be.a(AwsOrganizations.DisablePolicyTypeResponse);
    });
