...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListHandshakesForAccountResponse();
  });
  ...
  describe('ListHandshakesForAccountResponse', function() {
    it('should create an instance of ListHandshakesForAccountResponse', function() {
      // uncomment below and update the code to test ListHandshakesForAccountResponse
      //var instance = new AwsOrganizations.ListHandshakesForAccountResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListHandshakesForAccountResponse);
    });
