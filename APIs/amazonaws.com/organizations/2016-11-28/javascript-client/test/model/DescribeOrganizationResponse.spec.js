...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeOrganizationResponse();
  });
  ...
  describe('DescribeOrganizationResponse', function() {
    it('should create an instance of DescribeOrganizationResponse', function() {
      // uncomment below and update the code to test DescribeOrganizationResponse
      //var instance = new AwsOrganizations.DescribeOrganizationResponse();
      //expect(instance).to.be.a(AwsOrganizations.DescribeOrganizationResponse);
    });
