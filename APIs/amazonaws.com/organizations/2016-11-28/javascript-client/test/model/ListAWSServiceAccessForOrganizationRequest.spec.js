...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListAWSServiceAccessForOrganizationRequest();
  });
  ...
  describe('ListAWSServiceAccessForOrganizationRequest', function() {
    it('should create an instance of ListAWSServiceAccessForOrganizationRequest', function() {
      // uncomment below and update the code to test ListAWSServiceAccessForOrganizationRequest
      //var instance = new AwsOrganizations.ListAWSServiceAccessForOrganizationRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListAWSServiceAccessForOrganizationRequest);
    });
