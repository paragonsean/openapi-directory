...
(function(root, factory) {
  ...
  describe('ChildType', function() {
    it('should create an instance of ChildType', function() {
      // uncomment below and update the code to test ChildType
      //var instance = new AwsOrganizations.ChildType();
      //expect(instance).to.be.a(AwsOrganizations.ChildType);
    });
