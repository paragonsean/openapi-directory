...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreateAccountRequest();
  });
  ...
  describe('CreateAccountRequest', function() {
    it('should create an instance of CreateAccountRequest', function() {
      ...
      //var instance = new AwsOrganizations.CreateAccountRequest();
      //expect(instance).to.be.a(AwsOrganizations.CreateAccountRequest);
    });
