...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreateOrganizationResponseOrganization();
  });
  ...
  describe('CreateOrganizationResponseOrganization', function() {
    it('should create an instance of CreateOrganizationResponseOrganization', function() {
      // uncomment below and update the code to test CreateOrganizationResponseOrganization
      //var instance = new AwsOrganizations.CreateOrganizationResponseOrganization();
      //expect(instance).to.be.a(AwsOrganizations.CreateOrganizationResponseOrganization);
    });
