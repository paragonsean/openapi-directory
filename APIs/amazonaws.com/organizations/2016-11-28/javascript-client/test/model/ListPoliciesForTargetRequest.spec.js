...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListPoliciesForTargetRequest();
  });
  ...
  describe('ListPoliciesForTargetRequest', function() {
    it('should create an instance of ListPoliciesForTargetRequest', function() {
      // uncomment below and update the code to test ListPoliciesForTargetRequest
      //var instance = new AwsOrganizations.ListPoliciesForTargetRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListPoliciesForTargetRequest);
    });
