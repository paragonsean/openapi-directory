...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.PolicyTargetSummary();
  });
  ...
  describe('PolicyTargetSummary', function() {
    it('should create an instance of PolicyTargetSummary', function() {
      // uncomment below and update the code to test PolicyTargetSummary
      //var instance = new AwsOrganizations.PolicyTargetSummary();
      //expect(instance).to.be.a(AwsOrganizations.PolicyTargetSummary);
    });
