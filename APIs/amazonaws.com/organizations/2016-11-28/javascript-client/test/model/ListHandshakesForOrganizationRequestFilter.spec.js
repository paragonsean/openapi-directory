...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListHandshakesForOrganizationRequestFilter();
  });
  ...
  describe('ListHandshakesForOrganizationRequestFilter', function() {
    it('should create an instance of ListHandshakesForOrganizationRequestFilter', function() {
      // uncomment below and update the code to test ListHandshakesForOrganizationRequestFilter
      //var instance = new AwsOrganizations.ListHandshakesForOrganizationRequestFilter();
      //expect(instance).to.be.a(AwsOrganizations.ListHandshakesForOrganizationRequestFilter);
    });
