...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListDelegatedServicesForAccountResponse();
  });
  ...
  describe('ListDelegatedServicesForAccountResponse', function() {
    it('should create an instance of ListDelegatedServicesForAccountResponse', function() {
      // uncomment below and update the code to test ListDelegatedServicesForAccountResponse
      //var instance = new AwsOrganizations.ListDelegatedServicesForAccountResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListDelegatedServicesForAccountResponse);
    });

    it('should have the property delegatedServices (base name: "DelegatedServices")', function() {
      // uncomment below and update the code to test the property delegatedServices
      //var instance = new AwsOrganizations.ListDelegatedServicesForAccountResponse();
