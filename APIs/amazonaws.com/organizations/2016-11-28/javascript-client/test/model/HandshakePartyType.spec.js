...
(function(root, factory) {
  ...
  describe('HandshakePartyType', function() {
    it('should create an instance of HandshakePartyType', function() {
      // uncomment below and update the code to test HandshakePartyType
      //var instance = new AwsOrganizations.HandshakePartyType();
      //expect(instance).to.be.a(AwsOrganizations.HandshakePartyType);
    });
