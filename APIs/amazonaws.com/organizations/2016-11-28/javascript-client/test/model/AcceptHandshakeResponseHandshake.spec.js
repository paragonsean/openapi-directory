...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.AcceptHandshakeResponseHandshake();
  });
  ...
  describe('AcceptHandshakeResponseHandshake', function() {
    it('should create an instance of AcceptHandshakeResponseHandshake', function() {
      // uncomment below and update the code to test AcceptHandshakeResponseHandshake
      //var instance = new AwsOrganizations.AcceptHandshakeResponseHandshake();
      //expect(instance).to.be.a(AwsOrganizations.AcceptHandshakeResponseHandshake);
    });
    ...
    it('should have the property requestedTimestamp (base name: "RequestedTimestamp")', function() {
      // uncomment below and update the code to test the property requestedTimestamp
      //var instance = new AwsOrganizations.AcceptHandshakeResponseHandshake();
      //expect(instance).to.be();
    });
