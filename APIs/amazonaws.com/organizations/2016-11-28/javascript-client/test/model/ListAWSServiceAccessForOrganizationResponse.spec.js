...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListAWSServiceAccessForOrganizationResponse();
  });
  ...
  describe('ListAWSServiceAccessForOrganizationResponse', function() {
    it('should create an instance of ListAWSServiceAccessForOrganizationResponse', function() {
      // uncomment below and update the code to test ListAWSServiceAccessForOrganizationResponse
      //var instance = new AwsOrganizations.ListAWSServiceAccessForOrganizationResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListAWSServiceAccessForOrganizationResponse);
    });

    it('should have the property enabledServicePrincipals (base name: "EnabledServicePrincipals")', function() {
      // uncomment below and update the code to test the property enabledServicePrincipals
      //var instance = new AwsOrganizations.ListAWSServiceAccessForOrganizationResponse();
