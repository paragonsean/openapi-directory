...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreateGovCloudAccountResponse();
  });
  ...
  describe('CreateGovCloudAccountResponse', function() {
    it('should create an instance of CreateGovCloudAccountResponse', function() {
      // uncomment below and update the code to test CreateGovCloudAccountResponse
      //var instance = new AwsOrganizations.CreateGovCloudAccountResponse();
      //expect(instance).to.be.a(AwsOrganizations.CreateGovCloudAccountResponse);
    });
