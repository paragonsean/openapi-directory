...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListAccountsResponse();
  });
  ...
  describe('ListAccountsResponse', function() {
    it('should create an instance of ListAccountsResponse', function() {
      ...
      //var instance = new AwsOrganizations.ListAccountsResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListAccountsResponse);
    });
