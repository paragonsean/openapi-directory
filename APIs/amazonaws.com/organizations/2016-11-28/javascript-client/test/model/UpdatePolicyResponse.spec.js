...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.UpdatePolicyResponse();
  });
  ...
  describe('UpdatePolicyResponse', function() {
    it('should create an instance of UpdatePolicyResponse', function() {
      // uncomment below and update the code to test UpdatePolicyResponse
      //var instance = new AwsOrganizations.UpdatePolicyResponse();
      //expect(instance).to.be.a(AwsOrganizations.UpdatePolicyResponse);
    });
