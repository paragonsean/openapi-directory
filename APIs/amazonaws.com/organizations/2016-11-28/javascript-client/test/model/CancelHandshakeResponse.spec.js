...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CancelHandshakeResponse();
  });
  ...
  describe('CancelHandshakeResponse', function() {
    it('should create an instance of CancelHandshakeResponse', function() {
      // uncomment below and update the code to test CancelHandshakeResponse
      //var instance = new AwsOrganizations.CancelHandshakeResponse();
      //expect(instance).to.be.a(AwsOrganizations.CancelHandshakeResponse);
    });
