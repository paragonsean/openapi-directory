...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListTargetsForPolicyRequest();
  });
  ...
  describe('ListTargetsForPolicyRequest', function() {
    it('should create an instance of ListTargetsForPolicyRequest', function() {
      // uncomment below and update the code to test ListTargetsForPolicyRequest
      //var instance = new AwsOrganizations.ListTargetsForPolicyRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListTargetsForPolicyRequest);
    });
