...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeAccountResponseAccount();
  });
  ...
  describe('DescribeAccountResponseAccount', function() {
    it('should create an instance of DescribeAccountResponseAccount', function() {
      // uncomment below and update the code to test DescribeAccountResponseAccount
      //var instance = new AwsOrganizations.DescribeAccountResponseAccount();
      //expect(instance).to.be.a(AwsOrganizations.DescribeAccountResponseAccount);
    });
