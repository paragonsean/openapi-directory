...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.EnabledServicePrincipal();
  });
  ...
  describe('EnabledServicePrincipal', function() {
    it('should create an instance of EnabledServicePrincipal', function() {
      // uncomment below and update the code to test EnabledServicePrincipal
      //var instance = new AwsOrganizations.EnabledServicePrincipal();
      //expect(instance).to.be.a(AwsOrganizations.EnabledServicePrincipal);
    });
    ...
    it('should have the property dateEnabled (base name: "DateEnabled")', function() {
      // uncomment below and update the code to test the property dateEnabled
      //var instance = new AwsOrganizations.EnabledServicePrincipal();
      //expect(instance).to.be();
    });
