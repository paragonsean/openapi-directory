...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DisablePolicyTypeRequest();
  });
  ...
  describe('DisablePolicyTypeRequest', function() {
    it('should create an instance of DisablePolicyTypeRequest', function() {
      // uncomment below and update the code to test DisablePolicyTypeRequest
      //var instance = new AwsOrganizations.DisablePolicyTypeRequest();
      //expect(instance).to.be.a(AwsOrganizations.DisablePolicyTypeRequest);
    });
