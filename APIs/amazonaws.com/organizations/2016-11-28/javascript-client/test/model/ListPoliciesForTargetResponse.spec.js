...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListPoliciesForTargetResponse();
  });
  ...
  describe('ListPoliciesForTargetResponse', function() {
    it('should create an instance of ListPoliciesForTargetResponse', function() {
      // uncomment below and update the code to test ListPoliciesForTargetResponse
      //var instance = new AwsOrganizations.ListPoliciesForTargetResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListPoliciesForTargetResponse);
    });
