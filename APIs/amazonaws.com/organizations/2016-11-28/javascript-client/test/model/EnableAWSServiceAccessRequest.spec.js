...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.EnableAWSServiceAccessRequest();
  });
  ...
  describe('EnableAWSServiceAccessRequest', function() {
    it('should create an instance of EnableAWSServiceAccessRequest', function() {
      // uncomment below and update the code to test EnableAWSServiceAccessRequest
      //var instance = new AwsOrganizations.EnableAWSServiceAccessRequest();
      //expect(instance).to.be.a(AwsOrganizations.EnableAWSServiceAccessRequest);
    });
