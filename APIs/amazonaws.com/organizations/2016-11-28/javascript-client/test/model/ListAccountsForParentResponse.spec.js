...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListAccountsForParentResponse();
  });
  ...
  describe('ListAccountsForParentResponse', function() {
    it('should create an instance of ListAccountsForParentResponse', function() {
      // uncomment below and update the code to test ListAccountsForParentResponse
      //var instance = new AwsOrganizations.ListAccountsForParentResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListAccountsForParentResponse);
    });
