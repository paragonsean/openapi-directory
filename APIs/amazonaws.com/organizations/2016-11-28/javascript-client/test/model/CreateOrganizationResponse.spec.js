...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreateOrganizationResponse();
  });
  ...
  describe('CreateOrganizationResponse', function() {
    it('should create an instance of CreateOrganizationResponse', function() {
      ...
      //var instance = new AwsOrganizations.CreateOrganizationResponse();
      //expect(instance).to.be.a(AwsOrganizations.CreateOrganizationResponse);
    });
