...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreateAccountResponse();
  });
  ...
  describe('CreateAccountResponse', function() {
    it('should create an instance of CreateAccountResponse', function() {
      ...
      //var instance = new AwsOrganizations.CreateAccountResponse();
      //expect(instance).to.be.a(AwsOrganizations.CreateAccountResponse);
    });
