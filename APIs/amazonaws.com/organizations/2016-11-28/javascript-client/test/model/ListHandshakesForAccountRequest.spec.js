...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListHandshakesForAccountRequest();
  });
  ...
  describe('ListHandshakesForAccountRequest', function() {
    it('should create an instance of ListHandshakesForAccountRequest', function() {
      // uncomment below and update the code to test ListHandshakesForAccountRequest
      //var instance = new AwsOrganizations.ListHandshakesForAccountRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListHandshakesForAccountRequest);
    });
