...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CloseAccountRequest();
  });
  ...
  describe('CloseAccountRequest', function() {
    it('should create an instance of CloseAccountRequest', function() {
      ...
      //var instance = new AwsOrganizations.CloseAccountRequest();
      //expect(instance).to.be.a(AwsOrganizations.CloseAccountRequest);
    });
