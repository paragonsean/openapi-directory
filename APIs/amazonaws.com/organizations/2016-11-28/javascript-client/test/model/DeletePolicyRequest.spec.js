...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DeletePolicyRequest();
  });
  ...
  describe('DeletePolicyRequest', function() {
    it('should create an instance of DeletePolicyRequest', function() {
      // uncomment below and update the code to test DeletePolicyRequest
      //var instance = new AwsOrganizations.DeletePolicyRequest();
      //expect(instance).to.be.a(AwsOrganizations.DeletePolicyRequest);
    });
