...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribePolicyRequest();
  });
  ...
  describe('DescribePolicyRequest', function() {
    it('should create an instance of DescribePolicyRequest', function() {
      // uncomment below and update the code to test DescribePolicyRequest
      //var instance = new AwsOrganizations.DescribePolicyRequest();
      //expect(instance).to.be.a(AwsOrganizations.DescribePolicyRequest);
    });
