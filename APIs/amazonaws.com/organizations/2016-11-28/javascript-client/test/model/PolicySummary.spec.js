...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.PolicySummary();
  });
  ...
  describe('PolicySummary', function() {
    it('should create an instance of PolicySummary', function() {
      // uncomment below and update the code to test PolicySummary
      //var instance = new AwsOrganizations.PolicySummary();
      //expect(instance).to.be.a(AwsOrganizations.PolicySummary);
    });
    ...
    it('should have the property awsManaged (base name: "AwsManaged")', function() {
      // uncomment below and update the code to test the property awsManaged
      //var instance = new AwsOrganizations.PolicySummary();
      //expect(instance).to.be();
    });
