...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreatePolicyResponse();
  });
  ...
  describe('CreatePolicyResponse', function() {
    it('should create an instance of CreatePolicyResponse', function() {
      // uncomment below and update the code to test CreatePolicyResponse
      //var instance = new AwsOrganizations.CreatePolicyResponse();
      //expect(instance).to.be.a(AwsOrganizations.CreatePolicyResponse);
    });
