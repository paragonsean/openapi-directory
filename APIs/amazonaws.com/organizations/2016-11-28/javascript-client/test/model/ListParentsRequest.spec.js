...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListParentsRequest();
  });
  ...
  describe('ListParentsRequest', function() {
    it('should create an instance of ListParentsRequest', function() {
      // uncomment below and update the code to test ListParentsRequest
      //var instance = new AwsOrganizations.ListParentsRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListParentsRequest);
    });
