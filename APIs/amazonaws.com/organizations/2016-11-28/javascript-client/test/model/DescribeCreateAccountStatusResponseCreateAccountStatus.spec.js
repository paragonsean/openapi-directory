...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeCreateAccountStatusResponseCreateAccountStatus();
  });
  ...
  describe('DescribeCreateAccountStatusResponseCreateAccountStatus', function() {
    it('should create an instance of DescribeCreateAccountStatusResponseCreateAccountStatus', function() {
      // uncomment below and update the code to test DescribeCreateAccountStatusResponseCreateAccountStatus
      //var instance = new AwsOrganizations.DescribeCreateAccountStatusResponseCreateAccountStatus();
      //expect(instance).to.be.a(AwsOrganizations.DescribeCreateAccountStatusResponseCreateAccountStatus);
    });
    ...
    it('should have the property govCloudAccountId (base name: "GovCloudAccountId")', function() {
      // uncomment below and update the code to test the property govCloudAccountId
      //var instance = new AwsOrganizations.DescribeCreateAccountStatusResponseCreateAccountStatus();
      //expect(instance).to.be();
    });
