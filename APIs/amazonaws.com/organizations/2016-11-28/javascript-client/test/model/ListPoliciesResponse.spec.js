...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListPoliciesResponse();
  });
  ...
  describe('ListPoliciesResponse', function() {
    it('should create an instance of ListPoliciesResponse', function() {
      ...
      //var instance = new AwsOrganizations.ListPoliciesResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListPoliciesResponse);
    });
