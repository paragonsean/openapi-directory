...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreateOrganizationalUnitRequest();
  });
  ...
  describe('CreateOrganizationalUnitRequest', function() {
    it('should create an instance of CreateOrganizationalUnitRequest', function() {
      // uncomment below and update the code to test CreateOrganizationalUnitRequest
      //var instance = new AwsOrganizations.CreateOrganizationalUnitRequest();
      //expect(instance).to.be.a(AwsOrganizations.CreateOrganizationalUnitRequest);
    });
