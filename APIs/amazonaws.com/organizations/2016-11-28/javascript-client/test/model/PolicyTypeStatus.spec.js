...
(function(root, factory) {
  ...
  describe('PolicyTypeStatus', function() {
    it('should create an instance of PolicyTypeStatus', function() {
      // uncomment below and update the code to test PolicyTypeStatus
      //var instance = new AwsOrganizations.PolicyTypeStatus();
      //expect(instance).to.be.a(AwsOrganizations.PolicyTypeStatus);
    });
