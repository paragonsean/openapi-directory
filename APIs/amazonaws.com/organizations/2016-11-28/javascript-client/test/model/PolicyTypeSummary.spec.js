...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.PolicyTypeSummary();
  });
  ...
  describe('PolicyTypeSummary', function() {
    it('should create an instance of PolicyTypeSummary', function() {
      // uncomment below and update the code to test PolicyTypeSummary
      //var instance = new AwsOrganizations.PolicyTypeSummary();
      //expect(instance).to.be.a(AwsOrganizations.PolicyTypeSummary);
    });
