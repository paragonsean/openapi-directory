...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CancelHandshakeRequest();
  });
  ...
  describe('CancelHandshakeRequest', function() {
    it('should create an instance of CancelHandshakeRequest', function() {
      // uncomment below and update the code to test CancelHandshakeRequest
      //var instance = new AwsOrganizations.CancelHandshakeRequest();
      //expect(instance).to.be.a(AwsOrganizations.CancelHandshakeRequest);
    });
