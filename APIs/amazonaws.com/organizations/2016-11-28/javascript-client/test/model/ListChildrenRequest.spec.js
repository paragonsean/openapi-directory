...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListChildrenRequest();
  });
  ...
  describe('ListChildrenRequest', function() {
    it('should create an instance of ListChildrenRequest', function() {
      // uncomment below and update the code to test ListChildrenRequest
      //var instance = new AwsOrganizations.ListChildrenRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListChildrenRequest);
    });
