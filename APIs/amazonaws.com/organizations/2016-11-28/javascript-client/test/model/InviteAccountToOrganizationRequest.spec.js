...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.InviteAccountToOrganizationRequest();
  });
  ...
  describe('InviteAccountToOrganizationRequest', function() {
    it('should create an instance of InviteAccountToOrganizationRequest', function() {
      // uncomment below and update the code to test InviteAccountToOrganizationRequest
      //var instance = new AwsOrganizations.InviteAccountToOrganizationRequest();
      //expect(instance).to.be.a(AwsOrganizations.InviteAccountToOrganizationRequest);
    });
