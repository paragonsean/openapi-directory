...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListDelegatedAdministratorsRequest();
  });
  ...
  describe('ListDelegatedAdministratorsRequest', function() {
    it('should create an instance of ListDelegatedAdministratorsRequest', function() {
      // uncomment below and update the code to test ListDelegatedAdministratorsRequest
      //var instance = new AwsOrganizations.ListDelegatedAdministratorsRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListDelegatedAdministratorsRequest);
    });
