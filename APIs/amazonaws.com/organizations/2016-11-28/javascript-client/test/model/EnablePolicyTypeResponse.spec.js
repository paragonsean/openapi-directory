...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.EnablePolicyTypeResponse();
  });
  ...
  describe('EnablePolicyTypeResponse', function() {
    it('should create an instance of EnablePolicyTypeResponse', function() {
      // uncomment below and update the code to test EnablePolicyTypeResponse
      //var instance = new AwsOrganizations.EnablePolicyTypeResponse();
      //expect(instance).to.be.a(AwsOrganizations.EnablePolicyTypeResponse);
    });
