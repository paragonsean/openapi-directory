...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListOrganizationalUnitsForParentResponse();
  });
  ...
  describe('ListOrganizationalUnitsForParentResponse', function() {
    it('should create an instance of ListOrganizationalUnitsForParentResponse', function() {
      // uncomment below and update the code to test ListOrganizationalUnitsForParentResponse
      //var instance = new AwsOrganizations.ListOrganizationalUnitsForParentResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListOrganizationalUnitsForParentResponse);
    });
