...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListRootsResponse();
  });
  ...
  describe('ListRootsResponse', function() {
    it('should create an instance of ListRootsResponse', function() {
      // uncomment below and update the code to test ListRootsResponse
      //var instance = new AwsOrganizations.ListRootsResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListRootsResponse);
    });
