...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ResourcePolicyResourcePolicySummary();
  });
  ...
  describe('ResourcePolicyResourcePolicySummary', function() {
    it('should create an instance of ResourcePolicyResourcePolicySummary', function() {
      // uncomment below and update the code to test ResourcePolicyResourcePolicySummary
      //var instance = new AwsOrganizations.ResourcePolicyResourcePolicySummary();
      //expect(instance).to.be.a(AwsOrganizations.ResourcePolicyResourcePolicySummary);
    });
