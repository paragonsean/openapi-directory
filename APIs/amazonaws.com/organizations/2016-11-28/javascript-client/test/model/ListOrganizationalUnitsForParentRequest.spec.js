...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListOrganizationalUnitsForParentRequest();
  });
  ...
  describe('ListOrganizationalUnitsForParentRequest', function() {
    it('should create an instance of ListOrganizationalUnitsForParentRequest', function() {
      // uncomment below and update the code to test ListOrganizationalUnitsForParentRequest
      //var instance = new AwsOrganizations.ListOrganizationalUnitsForParentRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListOrganizationalUnitsForParentRequest);
    });
