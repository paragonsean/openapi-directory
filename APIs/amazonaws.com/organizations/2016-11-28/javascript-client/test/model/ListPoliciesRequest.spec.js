...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListPoliciesRequest();
  });
  ...
  describe('ListPoliciesRequest', function() {
    it('should create an instance of ListPoliciesRequest', function() {
      // uncomment below and update the code to test ListPoliciesRequest
      //var instance = new AwsOrganizations.ListPoliciesRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListPoliciesRequest);
    });
