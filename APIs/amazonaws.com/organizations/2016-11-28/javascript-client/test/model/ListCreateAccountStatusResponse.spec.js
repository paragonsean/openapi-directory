...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListCreateAccountStatusResponse();
  });
  ...
  describe('ListCreateAccountStatusResponse', function() {
    it('should create an instance of ListCreateAccountStatusResponse', function() {
      // uncomment below and update the code to test ListCreateAccountStatusResponse
      //var instance = new AwsOrganizations.ListCreateAccountStatusResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListCreateAccountStatusResponse);
    });

    it('should have the property createAccountStatuses (base name: "CreateAccountStatuses")', function() {
      // uncomment below and update the code to test the property createAccountStatuses
      //var instance = new AwsOrganizations.ListCreateAccountStatusResponse();
