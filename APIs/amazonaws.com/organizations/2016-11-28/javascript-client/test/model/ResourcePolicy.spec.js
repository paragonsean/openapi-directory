...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ResourcePolicy();
  });
  ...
  describe('ResourcePolicy', function() {
    it('should create an instance of ResourcePolicy', function() {
      ...
      //var instance = new AwsOrganizations.ResourcePolicy();
      //expect(instance).to.be.a(AwsOrganizations.ResourcePolicy);
    });

    it('should have the property resourcePolicySummary (base name: "ResourcePolicySummary")', function() {
      // uncomment below and update the code to test the property resourcePolicySummary
      //var instance = new AwsOrganizations.ResourcePolicy();
