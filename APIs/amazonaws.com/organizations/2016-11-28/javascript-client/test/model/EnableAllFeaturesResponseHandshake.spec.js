...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.EnableAllFeaturesResponseHandshake();
  });
  ...
  describe('EnableAllFeaturesResponseHandshake', function() {
    it('should create an instance of EnableAllFeaturesResponseHandshake', function() {
      // uncomment below and update the code to test EnableAllFeaturesResponseHandshake
      //var instance = new AwsOrganizations.EnableAllFeaturesResponseHandshake();
      //expect(instance).to.be.a(AwsOrganizations.EnableAllFeaturesResponseHandshake);
    });
