...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeHandshakeResponseHandshake();
  });
  ...
  describe('DescribeHandshakeResponseHandshake', function() {
    it('should create an instance of DescribeHandshakeResponseHandshake', function() {
      // uncomment below and update the code to test DescribeHandshakeResponseHandshake
      //var instance = new AwsOrganizations.DescribeHandshakeResponseHandshake();
      //expect(instance).to.be.a(AwsOrganizations.DescribeHandshakeResponseHandshake);
    });
