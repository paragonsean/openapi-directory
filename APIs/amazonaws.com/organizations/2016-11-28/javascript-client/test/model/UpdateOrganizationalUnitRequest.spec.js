...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.UpdateOrganizationalUnitRequest();
  });
  ...
  describe('UpdateOrganizationalUnitRequest', function() {
    it('should create an instance of UpdateOrganizationalUnitRequest', function() {
      // uncomment below and update the code to test UpdateOrganizationalUnitRequest
      //var instance = new AwsOrganizations.UpdateOrganizationalUnitRequest();
      //expect(instance).to.be.a(AwsOrganizations.UpdateOrganizationalUnitRequest);
    });
