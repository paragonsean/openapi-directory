...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribePolicyResponse();
  });
  ...
  describe('DescribePolicyResponse', function() {
    it('should create an instance of DescribePolicyResponse', function() {
      // uncomment below and update the code to test DescribePolicyResponse
      //var instance = new AwsOrganizations.DescribePolicyResponse();
      //expect(instance).to.be.a(AwsOrganizations.DescribePolicyResponse);
    });
