...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DeclineHandshakeResponse();
  });
  ...
  describe('DeclineHandshakeResponse', function() {
    it('should create an instance of DeclineHandshakeResponse', function() {
      // uncomment below and update the code to test DeclineHandshakeResponse
      //var instance = new AwsOrganizations.DeclineHandshakeResponse();
      //expect(instance).to.be.a(AwsOrganizations.DeclineHandshakeResponse);
    });
