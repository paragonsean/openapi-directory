...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.UpdateOrganizationalUnitResponse();
  });
  ...
  describe('UpdateOrganizationalUnitResponse', function() {
    it('should create an instance of UpdateOrganizationalUnitResponse', function() {
      // uncomment below and update the code to test UpdateOrganizationalUnitResponse
      //var instance = new AwsOrganizations.UpdateOrganizationalUnitResponse();
      //expect(instance).to.be.a(AwsOrganizations.UpdateOrganizationalUnitResponse);
    });
