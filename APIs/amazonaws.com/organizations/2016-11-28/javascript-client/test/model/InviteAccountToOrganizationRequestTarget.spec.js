...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.InviteAccountToOrganizationRequestTarget();
  });
  ...
  describe('InviteAccountToOrganizationRequestTarget', function() {
    it('should create an instance of InviteAccountToOrganizationRequestTarget', function() {
      // uncomment below and update the code to test InviteAccountToOrganizationRequestTarget
      //var instance = new AwsOrganizations.InviteAccountToOrganizationRequestTarget();
      //expect(instance).to.be.a(AwsOrganizations.InviteAccountToOrganizationRequestTarget);
    });
