...
(function(root, factory) {
  ...
  describe('OrganizationFeatureSet', function() {
    it('should create an instance of OrganizationFeatureSet', function() {
      // uncomment below and update the code to test OrganizationFeatureSet
      //var instance = new AwsOrganizations.OrganizationFeatureSet();
      //expect(instance).to.be.a(AwsOrganizations.OrganizationFeatureSet);
    });
