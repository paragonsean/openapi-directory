...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeCreateAccountStatusRequest();
  });
  ...
  describe('DescribeCreateAccountStatusRequest', function() {
    it('should create an instance of DescribeCreateAccountStatusRequest', function() {
      // uncomment below and update the code to test DescribeCreateAccountStatusRequest
      //var instance = new AwsOrganizations.DescribeCreateAccountStatusRequest();
      //expect(instance).to.be.a(AwsOrganizations.DescribeCreateAccountStatusRequest);
    });

    it('should have the property createAccountRequestId (base name: "CreateAccountRequestId")', function() {
      // uncomment below and update the code to test the property createAccountRequestId
      //var instance = new AwsOrganizations.DescribeCreateAccountStatusRequest();
