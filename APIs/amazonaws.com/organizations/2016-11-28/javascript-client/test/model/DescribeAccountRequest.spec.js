...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeAccountRequest();
  });
  ...
  describe('DescribeAccountRequest', function() {
    it('should create an instance of DescribeAccountRequest', function() {
      // uncomment below and update the code to test DescribeAccountRequest
      //var instance = new AwsOrganizations.DescribeAccountRequest();
      //expect(instance).to.be.a(AwsOrganizations.DescribeAccountRequest);
    });
