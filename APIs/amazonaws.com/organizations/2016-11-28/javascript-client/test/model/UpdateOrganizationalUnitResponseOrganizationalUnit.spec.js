...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.UpdateOrganizationalUnitResponseOrganizationalUnit();
  });
  ...
  describe('UpdateOrganizationalUnitResponseOrganizationalUnit', function() {
    it('should create an instance of UpdateOrganizationalUnitResponseOrganizationalUnit', function() {
      // uncomment below and update the code to test UpdateOrganizationalUnitResponseOrganizationalUnit
      //var instance = new AwsOrganizations.UpdateOrganizationalUnitResponseOrganizationalUnit();
      //expect(instance).to.be.a(AwsOrganizations.UpdateOrganizationalUnitResponseOrganizationalUnit);
    });
