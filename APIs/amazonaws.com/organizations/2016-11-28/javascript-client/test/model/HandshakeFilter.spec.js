...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.HandshakeFilter();
  });
  ...
  describe('HandshakeFilter', function() {
    it('should create an instance of HandshakeFilter', function() {
      // uncomment below and update the code to test HandshakeFilter
      //var instance = new AwsOrganizations.HandshakeFilter();
      //expect(instance).to.be.a(AwsOrganizations.HandshakeFilter);
    });
    ...
    it('should have the property parentHandshakeId (base name: "ParentHandshakeId")', function() {
      // uncomment below and update the code to test the property parentHandshakeId
      //var instance = new AwsOrganizations.HandshakeFilter();
      //expect(instance).to.be();
    });
