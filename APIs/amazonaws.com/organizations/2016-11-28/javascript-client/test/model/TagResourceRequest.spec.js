...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsOrganizations.TagResourceRequest();
      //expect(instance).to.be.a(AwsOrganizations.TagResourceRequest);
    });
