...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AwsOrganizations.UntagResourceRequest();
      //expect(instance).to.be.a(AwsOrganizations.UntagResourceRequest);
    });
