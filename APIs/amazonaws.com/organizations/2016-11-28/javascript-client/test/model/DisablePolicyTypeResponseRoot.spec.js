...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DisablePolicyTypeResponseRoot();
  });
  ...
  describe('DisablePolicyTypeResponseRoot', function() {
    it('should create an instance of DisablePolicyTypeResponseRoot', function() {
      // uncomment below and update the code to test DisablePolicyTypeResponseRoot
      //var instance = new AwsOrganizations.DisablePolicyTypeResponseRoot();
      //expect(instance).to.be.a(AwsOrganizations.DisablePolicyTypeResponseRoot);
    });
