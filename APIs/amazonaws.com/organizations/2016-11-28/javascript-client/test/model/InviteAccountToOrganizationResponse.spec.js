...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.InviteAccountToOrganizationResponse();
  });
  ...
  describe('InviteAccountToOrganizationResponse', function() {
    it('should create an instance of InviteAccountToOrganizationResponse', function() {
      // uncomment below and update the code to test InviteAccountToOrganizationResponse
      //var instance = new AwsOrganizations.InviteAccountToOrganizationResponse();
      //expect(instance).to.be.a(AwsOrganizations.InviteAccountToOrganizationResponse);
    });
