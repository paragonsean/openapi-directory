...
(function(root, factory) {
  ...
  describe('HandshakeResourceType', function() {
    it('should create an instance of HandshakeResourceType', function() {
      // uncomment below and update the code to test HandshakeResourceType
      //var instance = new AwsOrganizations.HandshakeResourceType();
      //expect(instance).to.be.a(AwsOrganizations.HandshakeResourceType);
    });
