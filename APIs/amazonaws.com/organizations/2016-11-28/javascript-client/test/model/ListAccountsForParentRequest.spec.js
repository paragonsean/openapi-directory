...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListAccountsForParentRequest();
  });
  ...
  describe('ListAccountsForParentRequest', function() {
    it('should create an instance of ListAccountsForParentRequest', function() {
      // uncomment below and update the code to test ListAccountsForParentRequest
      //var instance = new AwsOrganizations.ListAccountsForParentRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListAccountsForParentRequest);
    });
