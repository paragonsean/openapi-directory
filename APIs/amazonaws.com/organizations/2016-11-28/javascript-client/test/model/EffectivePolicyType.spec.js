...
(function(root, factory) {
  ...
  describe('EffectivePolicyType', function() {
    it('should create an instance of EffectivePolicyType', function() {
      // uncomment below and update the code to test EffectivePolicyType
      //var instance = new AwsOrganizations.EffectivePolicyType();
      //expect(instance).to.be.a(AwsOrganizations.EffectivePolicyType);
    });
