...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.Handshake();
  });
  ...
  describe('Handshake', function() {
    it('should create an instance of Handshake', function() {
      // uncomment below and update the code to test Handshake
      //var instance = new AwsOrganizations.Handshake();
      //expect(instance).to.be.a(AwsOrganizations.Handshake);
    });
