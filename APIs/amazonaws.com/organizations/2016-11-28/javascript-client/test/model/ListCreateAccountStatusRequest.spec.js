...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListCreateAccountStatusRequest();
  });
  ...
  describe('ListCreateAccountStatusRequest', function() {
    it('should create an instance of ListCreateAccountStatusRequest', function() {
      // uncomment below and update the code to test ListCreateAccountStatusRequest
      //var instance = new AwsOrganizations.ListCreateAccountStatusRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListCreateAccountStatusRequest);
    });
