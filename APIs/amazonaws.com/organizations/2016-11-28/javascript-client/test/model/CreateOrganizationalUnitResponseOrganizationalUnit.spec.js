...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreateOrganizationalUnitResponseOrganizationalUnit();
  });
  ...
  describe('CreateOrganizationalUnitResponseOrganizationalUnit', function() {
    it('should create an instance of CreateOrganizationalUnitResponseOrganizationalUnit', function() {
      // uncomment below and update the code to test CreateOrganizationalUnitResponseOrganizationalUnit
      //var instance = new AwsOrganizations.CreateOrganizationalUnitResponseOrganizationalUnit();
      //expect(instance).to.be.a(AwsOrganizations.CreateOrganizationalUnitResponseOrganizationalUnit);
    });
