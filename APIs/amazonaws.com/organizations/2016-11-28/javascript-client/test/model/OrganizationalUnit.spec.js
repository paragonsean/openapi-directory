...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.OrganizationalUnit();
  });
  ...
  describe('OrganizationalUnit', function() {
    it('should create an instance of OrganizationalUnit', function() {
      // uncomment below and update the code to test OrganizationalUnit
      //var instance = new AwsOrganizations.OrganizationalUnit();
      //expect(instance).to.be.a(AwsOrganizations.OrganizationalUnit);
    });
