...
(function(root, factory) {
  ...
  describe('CreateAccountState', function() {
    it('should create an instance of CreateAccountState', function() {
      // uncomment below and update the code to test CreateAccountState
      //var instance = new AwsOrganizations.CreateAccountState();
      //expect(instance).to.be.a(AwsOrganizations.CreateAccountState);
    });
