...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeOrganizationalUnitResponse();
  });
  ...
  describe('DescribeOrganizationalUnitResponse', function() {
    it('should create an instance of DescribeOrganizationalUnitResponse', function() {
      // uncomment below and update the code to test DescribeOrganizationalUnitResponse
      //var instance = new AwsOrganizations.DescribeOrganizationalUnitResponse();
      //expect(instance).to.be.a(AwsOrganizations.DescribeOrganizationalUnitResponse);
    });
