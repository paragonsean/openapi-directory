...
(function(root, factory) {
  ...
  describe('CreateAccountFailureReason', function() {
    it('should create an instance of CreateAccountFailureReason', function() {
      // uncomment below and update the code to test CreateAccountFailureReason
      //var instance = new AwsOrganizations.CreateAccountFailureReason();
      //expect(instance).to.be.a(AwsOrganizations.CreateAccountFailureReason);
    });
