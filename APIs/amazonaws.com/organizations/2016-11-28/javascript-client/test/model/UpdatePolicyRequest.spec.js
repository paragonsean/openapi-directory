...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.UpdatePolicyRequest();
  });
  ...
  describe('UpdatePolicyRequest', function() {
    it('should create an instance of UpdatePolicyRequest', function() {
      // uncomment below and update the code to test UpdatePolicyRequest
      //var instance = new AwsOrganizations.UpdatePolicyRequest();
      //expect(instance).to.be.a(AwsOrganizations.UpdatePolicyRequest);
    });
