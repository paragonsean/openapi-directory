...
(function(root, factory) {
  ...
  describe('TargetType', function() {
    it('should create an instance of TargetType', function() {
      // uncomment below and update the code to test TargetType
      //var instance = new AwsOrganizations.TargetType();
      //expect(instance).to.be.a(AwsOrganizations.TargetType);
    });
