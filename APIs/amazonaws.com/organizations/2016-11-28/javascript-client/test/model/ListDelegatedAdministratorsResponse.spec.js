...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListDelegatedAdministratorsResponse();
  });
  ...
  describe('ListDelegatedAdministratorsResponse', function() {
    it('should create an instance of ListDelegatedAdministratorsResponse', function() {
      // uncomment below and update the code to test ListDelegatedAdministratorsResponse
      //var instance = new AwsOrganizations.ListDelegatedAdministratorsResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListDelegatedAdministratorsResponse);
    });

    it('should have the property delegatedAdministrators (base name: "DelegatedAdministrators")', function() {
      // uncomment below and update the code to test the property delegatedAdministrators
      //var instance = new AwsOrganizations.ListDelegatedAdministratorsResponse();
