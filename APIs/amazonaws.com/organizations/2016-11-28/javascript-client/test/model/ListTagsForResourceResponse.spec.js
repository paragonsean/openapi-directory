...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AwsOrganizations.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListTagsForResourceResponse);
    });
