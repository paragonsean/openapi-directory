...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribePolicyResponsePolicy();
  });
  ...
  describe('DescribePolicyResponsePolicy', function() {
    it('should create an instance of DescribePolicyResponsePolicy', function() {
      // uncomment below and update the code to test DescribePolicyResponsePolicy
      //var instance = new AwsOrganizations.DescribePolicyResponsePolicy();
      //expect(instance).to.be.a(AwsOrganizations.DescribePolicyResponsePolicy);
    });
