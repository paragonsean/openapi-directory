...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListParentsResponse();
  });
  ...
  describe('ListParentsResponse', function() {
    it('should create an instance of ListParentsResponse', function() {
      // uncomment below and update the code to test ListParentsResponse
      //var instance = new AwsOrganizations.ListParentsResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListParentsResponse);
    });
