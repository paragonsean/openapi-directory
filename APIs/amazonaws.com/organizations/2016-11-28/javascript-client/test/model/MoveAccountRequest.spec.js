...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.MoveAccountRequest();
  });
  ...
  describe('MoveAccountRequest', function() {
    it('should create an instance of MoveAccountRequest', function() {
      // uncomment below and update the code to test MoveAccountRequest
      //var instance = new AwsOrganizations.MoveAccountRequest();
      //expect(instance).to.be.a(AwsOrganizations.MoveAccountRequest);
    });
    ...
    it('should have the property sourceParentId (base name: "SourceParentId")', function() {
      // uncomment below and update the code to test the property sourceParentId
      //var instance = new AwsOrganizations.MoveAccountRequest();
      //expect(instance).to.be();
    });

    it('should have the property destinationParentId (base name: "DestinationParentId")', function() {
      // uncomment below and update the code to test the property destinationParentId
      //var instance = new AwsOrganizations.MoveAccountRequest();
      //expect(instance).to.be();
    });
