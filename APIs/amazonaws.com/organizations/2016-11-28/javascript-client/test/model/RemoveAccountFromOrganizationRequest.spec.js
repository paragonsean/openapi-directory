...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.RemoveAccountFromOrganizationRequest();
  });
  ...
  describe('RemoveAccountFromOrganizationRequest', function() {
    it('should create an instance of RemoveAccountFromOrganizationRequest', function() {
      // uncomment below and update the code to test RemoveAccountFromOrganizationRequest
      //var instance = new AwsOrganizations.RemoveAccountFromOrganizationRequest();
      //expect(instance).to.be.a(AwsOrganizations.RemoveAccountFromOrganizationRequest);
    });
