...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListTargetsForPolicyResponse();
  });
  ...
  describe('ListTargetsForPolicyResponse', function() {
    it('should create an instance of ListTargetsForPolicyResponse', function() {
      // uncomment below and update the code to test ListTargetsForPolicyResponse
      //var instance = new AwsOrganizations.ListTargetsForPolicyResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListTargetsForPolicyResponse);
    });
