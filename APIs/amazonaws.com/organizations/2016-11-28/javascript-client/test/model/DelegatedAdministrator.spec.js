...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DelegatedAdministrator();
  });
  ...
  describe('DelegatedAdministrator', function() {
    it('should create an instance of DelegatedAdministrator', function() {
      // uncomment below and update the code to test DelegatedAdministrator
      //var instance = new AwsOrganizations.DelegatedAdministrator();
      //expect(instance).to.be.a(AwsOrganizations.DelegatedAdministrator);
    });
    ...
    it('should have the property joinedMethod (base name: "JoinedMethod")', function() {
      // uncomment below and update the code to test the property joinedMethod
      //var instance = new AwsOrganizations.DelegatedAdministrator();
      //expect(instance).to.be();
    });

    it('should have the property joinedTimestamp (base name: "JoinedTimestamp")', function() {
      // uncomment below and update the code to test the property joinedTimestamp
      //var instance = new AwsOrganizations.DelegatedAdministrator();
      //expect(instance).to.be();
    });

    it('should have the property delegationEnabledDate (base name: "DelegationEnabledDate")', function() {
      // uncomment below and update the code to test the property delegationEnabledDate
      //var instance = new AwsOrganizations.DelegatedAdministrator();
      //expect(instance).to.be();
    });
