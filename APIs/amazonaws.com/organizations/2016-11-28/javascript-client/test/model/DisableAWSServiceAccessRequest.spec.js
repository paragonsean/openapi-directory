...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DisableAWSServiceAccessRequest();
  });
  ...
  describe('DisableAWSServiceAccessRequest', function() {
    it('should create an instance of DisableAWSServiceAccessRequest', function() {
      // uncomment below and update the code to test DisableAWSServiceAccessRequest
      //var instance = new AwsOrganizations.DisableAWSServiceAccessRequest();
      //expect(instance).to.be.a(AwsOrganizations.DisableAWSServiceAccessRequest);
    });
