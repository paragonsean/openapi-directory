...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreateOrganizationRequest();
  });
  ...
  describe('CreateOrganizationRequest', function() {
    it('should create an instance of CreateOrganizationRequest', function() {
      ...
      //var instance = new AwsOrganizations.CreateOrganizationRequest();
      //expect(instance).to.be.a(AwsOrganizations.CreateOrganizationRequest);
    });
