...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DeclineHandshakeRequest();
  });
  ...
  describe('DeclineHandshakeRequest', function() {
    it('should create an instance of DeclineHandshakeRequest', function() {
      // uncomment below and update the code to test DeclineHandshakeRequest
      //var instance = new AwsOrganizations.DeclineHandshakeRequest();
      //expect(instance).to.be.a(AwsOrganizations.DeclineHandshakeRequest);
    });
