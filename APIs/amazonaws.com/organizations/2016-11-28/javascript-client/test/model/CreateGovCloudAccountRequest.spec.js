...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreateGovCloudAccountRequest();
  });
  ...
  describe('CreateGovCloudAccountRequest', function() {
    it('should create an instance of CreateGovCloudAccountRequest', function() {
      // uncomment below and update the code to test CreateGovCloudAccountRequest
      //var instance = new AwsOrganizations.CreateGovCloudAccountRequest();
      //expect(instance).to.be.a(AwsOrganizations.CreateGovCloudAccountRequest);
    });
    ...
    it('should have the property iamUserAccessToBilling (base name: "IamUserAccessToBilling")', function() {
      // uncomment below and update the code to test the property iamUserAccessToBilling
      //var instance = new AwsOrganizations.CreateGovCloudAccountRequest();
      //expect(instance).to.be();
    });
