...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreateOrganizationalUnitResponse();
  });
  ...
  describe('CreateOrganizationalUnitResponse', function() {
    it('should create an instance of CreateOrganizationalUnitResponse', function() {
      // uncomment below and update the code to test CreateOrganizationalUnitResponse
      //var instance = new AwsOrganizations.CreateOrganizationalUnitResponse();
      //expect(instance).to.be.a(AwsOrganizations.CreateOrganizationalUnitResponse);
    });
