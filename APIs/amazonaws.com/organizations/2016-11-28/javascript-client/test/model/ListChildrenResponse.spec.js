...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListChildrenResponse();
  });
  ...
  describe('ListChildrenResponse', function() {
    it('should create an instance of ListChildrenResponse', function() {
      // uncomment below and update the code to test ListChildrenResponse
      //var instance = new AwsOrganizations.ListChildrenResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListChildrenResponse);
    });
