...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListDelegatedServicesForAccountRequest();
  });
  ...
  describe('ListDelegatedServicesForAccountRequest', function() {
    it('should create an instance of ListDelegatedServicesForAccountRequest', function() {
      // uncomment below and update the code to test ListDelegatedServicesForAccountRequest
      //var instance = new AwsOrganizations.ListDelegatedServicesForAccountRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListDelegatedServicesForAccountRequest);
    });
