...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeHandshakeResponse();
  });
  ...
  describe('DescribeHandshakeResponse', function() {
    it('should create an instance of DescribeHandshakeResponse', function() {
      // uncomment below and update the code to test DescribeHandshakeResponse
      //var instance = new AwsOrganizations.DescribeHandshakeResponse();
      //expect(instance).to.be.a(AwsOrganizations.DescribeHandshakeResponse);
    });
