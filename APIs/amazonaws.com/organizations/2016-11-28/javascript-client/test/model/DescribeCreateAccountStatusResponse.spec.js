...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeCreateAccountStatusResponse();
  });
  ...
  describe('DescribeCreateAccountStatusResponse', function() {
    it('should create an instance of DescribeCreateAccountStatusResponse', function() {
      // uncomment below and update the code to test DescribeCreateAccountStatusResponse
      //var instance = new AwsOrganizations.DescribeCreateAccountStatusResponse();
      //expect(instance).to.be.a(AwsOrganizations.DescribeCreateAccountStatusResponse);
    });

    it('should have the property createAccountStatus (base name: "CreateAccountStatus")', function() {
      // uncomment below and update the code to test the property createAccountStatus
      //var instance = new AwsOrganizations.DescribeCreateAccountStatusResponse();
