...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.UpdatePolicyResponsePolicy();
  });
  ...
  describe('UpdatePolicyResponsePolicy', function() {
    it('should create an instance of UpdatePolicyResponsePolicy', function() {
      // uncomment below and update the code to test UpdatePolicyResponsePolicy
      //var instance = new AwsOrganizations.UpdatePolicyResponsePolicy();
      //expect(instance).to.be.a(AwsOrganizations.UpdatePolicyResponsePolicy);
    });
