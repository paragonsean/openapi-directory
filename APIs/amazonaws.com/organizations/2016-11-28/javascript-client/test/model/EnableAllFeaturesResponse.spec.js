...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.EnableAllFeaturesResponse();
  });
  ...
  describe('EnableAllFeaturesResponse', function() {
    it('should create an instance of EnableAllFeaturesResponse', function() {
      // uncomment below and update the code to test EnableAllFeaturesResponse
      //var instance = new AwsOrganizations.EnableAllFeaturesResponse();
      //expect(instance).to.be.a(AwsOrganizations.EnableAllFeaturesResponse);
    });
