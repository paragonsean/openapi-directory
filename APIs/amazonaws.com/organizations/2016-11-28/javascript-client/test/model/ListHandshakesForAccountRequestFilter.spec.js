...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListHandshakesForAccountRequestFilter();
  });
  ...
  describe('ListHandshakesForAccountRequestFilter', function() {
    it('should create an instance of ListHandshakesForAccountRequestFilter', function() {
      // uncomment below and update the code to test ListHandshakesForAccountRequestFilter
      //var instance = new AwsOrganizations.ListHandshakesForAccountRequestFilter();
      //expect(instance).to.be.a(AwsOrganizations.ListHandshakesForAccountRequestFilter);
    });
