...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListRootsRequest();
  });
  ...
  describe('ListRootsRequest', function() {
    it('should create an instance of ListRootsRequest', function() {
      // uncomment below and update the code to test ListRootsRequest
      //var instance = new AwsOrganizations.ListRootsRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListRootsRequest);
    });
