...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListAccountsRequest();
  });
  ...
  describe('ListAccountsRequest', function() {
    it('should create an instance of ListAccountsRequest', function() {
      // uncomment below and update the code to test ListAccountsRequest
      //var instance = new AwsOrganizations.ListAccountsRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListAccountsRequest);
    });
