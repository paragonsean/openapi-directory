...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.EffectivePolicy();
  });
  ...
  describe('EffectivePolicy', function() {
    it('should create an instance of EffectivePolicy', function() {
      // uncomment below and update the code to test EffectivePolicy
      //var instance = new AwsOrganizations.EffectivePolicy();
      //expect(instance).to.be.a(AwsOrganizations.EffectivePolicy);
    });
