...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreateAccountResponseCreateAccountStatus();
  });
  ...
  describe('CreateAccountResponseCreateAccountStatus', function() {
    it('should create an instance of CreateAccountResponseCreateAccountStatus', function() {
      // uncomment below and update the code to test CreateAccountResponseCreateAccountStatus
      //var instance = new AwsOrganizations.CreateAccountResponseCreateAccountStatus();
      //expect(instance).to.be.a(AwsOrganizations.CreateAccountResponseCreateAccountStatus);
    });
