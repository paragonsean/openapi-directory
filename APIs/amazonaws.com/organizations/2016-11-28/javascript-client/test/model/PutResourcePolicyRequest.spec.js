...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.PutResourcePolicyRequest();
  });
  ...
  describe('PutResourcePolicyRequest', function() {
    it('should create an instance of PutResourcePolicyRequest', function() {
      ...
      //var instance = new AwsOrganizations.PutResourcePolicyRequest();
      //expect(instance).to.be.a(AwsOrganizations.PutResourcePolicyRequest);
    });
