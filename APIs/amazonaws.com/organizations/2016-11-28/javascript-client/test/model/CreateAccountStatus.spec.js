...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreateAccountStatus();
  });
  ...
  describe('CreateAccountStatus', function() {
    it('should create an instance of CreateAccountStatus', function() {
      // uncomment below and update the code to test CreateAccountStatus
      //var instance = new AwsOrganizations.CreateAccountStatus();
      //expect(instance).to.be.a(AwsOrganizations.CreateAccountStatus);
    });
