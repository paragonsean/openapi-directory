...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.AcceptHandshakeRequest();
  });
  ...
  describe('AcceptHandshakeRequest', function() {
    it('should create an instance of AcceptHandshakeRequest', function() {
      // uncomment below and update the code to test AcceptHandshakeRequest
      //var instance = new AwsOrganizations.AcceptHandshakeRequest();
      //expect(instance).to.be.a(AwsOrganizations.AcceptHandshakeRequest);
    });
