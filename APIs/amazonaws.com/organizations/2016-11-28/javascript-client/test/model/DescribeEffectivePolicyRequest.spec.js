...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeEffectivePolicyRequest();
  });
  ...
  describe('DescribeEffectivePolicyRequest', function() {
    it('should create an instance of DescribeEffectivePolicyRequest', function() {
      // uncomment below and update the code to test DescribeEffectivePolicyRequest
      //var instance = new AwsOrganizations.DescribeEffectivePolicyRequest();
      //expect(instance).to.be.a(AwsOrganizations.DescribeEffectivePolicyRequest);
    });
