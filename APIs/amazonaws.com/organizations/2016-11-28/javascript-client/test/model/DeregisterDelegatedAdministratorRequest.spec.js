...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DeregisterDelegatedAdministratorRequest();
  });
  ...
  describe('DeregisterDelegatedAdministratorRequest', function() {
    it('should create an instance of DeregisterDelegatedAdministratorRequest', function() {
      // uncomment below and update the code to test DeregisterDelegatedAdministratorRequest
      //var instance = new AwsOrganizations.DeregisterDelegatedAdministratorRequest();
      //expect(instance).to.be.a(AwsOrganizations.DeregisterDelegatedAdministratorRequest);
    });
    ...
    it('should have the property servicePrincipal (base name: "ServicePrincipal")', function() {
      // uncomment below and update the code to test the property servicePrincipal
      //var instance = new AwsOrganizations.DeregisterDelegatedAdministratorRequest();
      //expect(instance).to.be();
    });
