...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CancelHandshakeResponseHandshake();
  });
  ...
  describe('CancelHandshakeResponseHandshake', function() {
    it('should create an instance of CancelHandshakeResponseHandshake', function() {
      // uncomment below and update the code to test CancelHandshakeResponseHandshake
      //var instance = new AwsOrganizations.CancelHandshakeResponseHandshake();
      //expect(instance).to.be.a(AwsOrganizations.CancelHandshakeResponseHandshake);
    });
