...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.PolicyPolicySummary();
  });
  ...
  describe('PolicyPolicySummary', function() {
    it('should create an instance of PolicyPolicySummary', function() {
      // uncomment below and update the code to test PolicyPolicySummary
      //var instance = new AwsOrganizations.PolicyPolicySummary();
      //expect(instance).to.be.a(AwsOrganizations.PolicyPolicySummary);
    });
