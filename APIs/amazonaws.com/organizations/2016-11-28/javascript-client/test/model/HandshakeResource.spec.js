...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.HandshakeResource();
  });
  ...
  describe('HandshakeResource', function() {
    it('should create an instance of HandshakeResource', function() {
      // uncomment below and update the code to test HandshakeResource
      //var instance = new AwsOrganizations.HandshakeResource();
      //expect(instance).to.be.a(AwsOrganizations.HandshakeResource);
    });
