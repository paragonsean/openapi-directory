...
(function(root, factory) {
  ...
  describe('IAMUserAccessToBilling', function() {
    it('should create an instance of IAMUserAccessToBilling', function() {
      // uncomment below and update the code to test IAMUserAccessToBilling
      //var instance = new AwsOrganizations.IAMUserAccessToBilling();
      //expect(instance).to.be.a(AwsOrganizations.IAMUserAccessToBilling);
    });
