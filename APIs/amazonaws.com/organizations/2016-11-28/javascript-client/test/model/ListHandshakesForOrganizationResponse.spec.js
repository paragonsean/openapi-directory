...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListHandshakesForOrganizationResponse();
  });
  ...
  describe('ListHandshakesForOrganizationResponse', function() {
    it('should create an instance of ListHandshakesForOrganizationResponse', function() {
      // uncomment below and update the code to test ListHandshakesForOrganizationResponse
      //var instance = new AwsOrganizations.ListHandshakesForOrganizationResponse();
      //expect(instance).to.be.a(AwsOrganizations.ListHandshakesForOrganizationResponse);
    });

    it('should have the property handshakes (base name: "Handshakes")', function() {
      // uncomment below and update the code to test the property handshakes
      //var instance = new AwsOrganizations.ListHandshakesForOrganizationResponse();
