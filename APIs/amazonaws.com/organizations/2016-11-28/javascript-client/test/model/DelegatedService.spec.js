...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DelegatedService();
  });
  ...
  describe('DelegatedService', function() {
    it('should create an instance of DelegatedService', function() {
      // uncomment below and update the code to test DelegatedService
      //var instance = new AwsOrganizations.DelegatedService();
      //expect(instance).to.be.a(AwsOrganizations.DelegatedService);
    });
