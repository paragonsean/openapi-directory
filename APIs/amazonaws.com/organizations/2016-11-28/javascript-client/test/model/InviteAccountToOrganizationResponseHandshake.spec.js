...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.InviteAccountToOrganizationResponseHandshake();
  });
  ...
  describe('InviteAccountToOrganizationResponseHandshake', function() {
    it('should create an instance of InviteAccountToOrganizationResponseHandshake', function() {
      // uncomment below and update the code to test InviteAccountToOrganizationResponseHandshake
      //var instance = new AwsOrganizations.InviteAccountToOrganizationResponseHandshake();
      //expect(instance).to.be.a(AwsOrganizations.InviteAccountToOrganizationResponseHandshake);
    });
