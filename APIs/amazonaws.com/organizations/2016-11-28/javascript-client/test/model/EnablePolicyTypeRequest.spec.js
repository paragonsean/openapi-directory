...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.EnablePolicyTypeRequest();
  });
  ...
  describe('EnablePolicyTypeRequest', function() {
    it('should create an instance of EnablePolicyTypeRequest', function() {
      // uncomment below and update the code to test EnablePolicyTypeRequest
      //var instance = new AwsOrganizations.EnablePolicyTypeRequest();
      //expect(instance).to.be.a(AwsOrganizations.EnablePolicyTypeRequest);
    });
