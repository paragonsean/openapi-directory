...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeResourcePolicyResponseResourcePolicy();
  });
  ...
  describe('DescribeResourcePolicyResponseResourcePolicy', function() {
    it('should create an instance of DescribeResourcePolicyResponseResourcePolicy', function() {
      // uncomment below and update the code to test DescribeResourcePolicyResponseResourcePolicy
      //var instance = new AwsOrganizations.DescribeResourcePolicyResponseResourcePolicy();
      //expect(instance).to.be.a(AwsOrganizations.DescribeResourcePolicyResponseResourcePolicy);
    });
