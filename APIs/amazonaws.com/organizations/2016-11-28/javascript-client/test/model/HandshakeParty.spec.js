...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.HandshakeParty();
  });
  ...
  describe('HandshakeParty', function() {
    it('should create an instance of HandshakeParty', function() {
      // uncomment below and update the code to test HandshakeParty
      //var instance = new AwsOrganizations.HandshakeParty();
      //expect(instance).to.be.a(AwsOrganizations.HandshakeParty);
    });
