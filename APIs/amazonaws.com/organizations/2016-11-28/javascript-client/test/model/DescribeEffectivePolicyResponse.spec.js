...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeEffectivePolicyResponse();
  });
  ...
  describe('DescribeEffectivePolicyResponse', function() {
    it('should create an instance of DescribeEffectivePolicyResponse', function() {
      // uncomment below and update the code to test DescribeEffectivePolicyResponse
      //var instance = new AwsOrganizations.DescribeEffectivePolicyResponse();
      //expect(instance).to.be.a(AwsOrganizations.DescribeEffectivePolicyResponse);
    });

    it('should have the property effectivePolicy (base name: "EffectivePolicy")', function() {
      // uncomment below and update the code to test the property effectivePolicy
      //var instance = new AwsOrganizations.DescribeEffectivePolicyResponse();
