...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DeleteOrganizationalUnitRequest();
  });
  ...
  describe('DeleteOrganizationalUnitRequest', function() {
    it('should create an instance of DeleteOrganizationalUnitRequest', function() {
      // uncomment below and update the code to test DeleteOrganizationalUnitRequest
      //var instance = new AwsOrganizations.DeleteOrganizationalUnitRequest();
      //expect(instance).to.be.a(AwsOrganizations.DeleteOrganizationalUnitRequest);
    });
