...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ResourcePolicySummary();
  });
  ...
  describe('ResourcePolicySummary', function() {
    it('should create an instance of ResourcePolicySummary', function() {
      // uncomment below and update the code to test ResourcePolicySummary
      //var instance = new AwsOrganizations.ResourcePolicySummary();
      //expect(instance).to.be.a(AwsOrganizations.ResourcePolicySummary);
    });
