...
(function(root, factory) {
  ...
  describe('HandshakeState', function() {
    it('should create an instance of HandshakeState', function() {
      // uncomment below and update the code to test HandshakeState
      //var instance = new AwsOrganizations.HandshakeState();
      //expect(instance).to.be.a(AwsOrganizations.HandshakeState);
    });
