...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AwsOrganizations.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AwsOrganizations.ListTagsForResourceRequest);
    });
