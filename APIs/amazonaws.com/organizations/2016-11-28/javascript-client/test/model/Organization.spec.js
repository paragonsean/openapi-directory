...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.Organization();
  });
  ...
  describe('Organization', function() {
    it('should create an instance of Organization', function() {
      ...
      //var instance = new AwsOrganizations.Organization();
      //expect(instance).to.be.a(AwsOrganizations.Organization);
    });
    ...
    it('should have the property masterAccountArn (base name: "MasterAccountArn")', function() {
      // uncomment below and update the code to test the property masterAccountArn
      //var instance = new AwsOrganizations.Organization();
      //expect(instance).to.be();
    });
    ...
    it('should have the property masterAccountEmail (base name: "MasterAccountEmail")', function() {
      // uncomment below and update the code to test the property masterAccountEmail
      //var instance = new AwsOrganizations.Organization();
      //expect(instance).to.be();
    });

    it('should have the property availablePolicyTypes (base name: "AvailablePolicyTypes")', function() {
      // uncomment below and update the code to test the property availablePolicyTypes
      //var instance = new AwsOrganizations.Organization();
      //expect(instance).to.be();
    });
