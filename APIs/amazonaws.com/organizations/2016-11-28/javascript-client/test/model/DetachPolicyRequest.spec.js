...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DetachPolicyRequest();
  });
  ...
  describe('DetachPolicyRequest', function() {
    it('should create an instance of DetachPolicyRequest', function() {
      // uncomment below and update the code to test DetachPolicyRequest
      //var instance = new AwsOrganizations.DetachPolicyRequest();
      //expect(instance).to.be.a(AwsOrganizations.DetachPolicyRequest);
    });
