...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.AcceptHandshakeResponse();
  });
  ...
  describe('AcceptHandshakeResponse', function() {
    it('should create an instance of AcceptHandshakeResponse', function() {
      // uncomment below and update the code to test AcceptHandshakeResponse
      //var instance = new AwsOrganizations.AcceptHandshakeResponse();
      //expect(instance).to.be.a(AwsOrganizations.AcceptHandshakeResponse);
    });

    it('should have the property handshake (base name: "Handshake")', function() {
      // uncomment below and update the code to test the property handshake
      //var instance = new AwsOrganizations.AcceptHandshakeResponse();
