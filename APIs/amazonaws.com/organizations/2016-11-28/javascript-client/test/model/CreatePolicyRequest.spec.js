...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreatePolicyRequest();
  });
  ...
  describe('CreatePolicyRequest', function() {
    it('should create an instance of CreatePolicyRequest', function() {
      // uncomment below and update the code to test CreatePolicyRequest
      //var instance = new AwsOrganizations.CreatePolicyRequest();
      //expect(instance).to.be.a(AwsOrganizations.CreatePolicyRequest);
    });
