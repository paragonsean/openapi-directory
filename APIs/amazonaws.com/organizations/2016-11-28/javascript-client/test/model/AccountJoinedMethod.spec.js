...
(function(root, factory) {
  ...
  describe('AccountJoinedMethod', function() {
    it('should create an instance of AccountJoinedMethod', function() {
      // uncomment below and update the code to test AccountJoinedMethod
      //var instance = new AwsOrganizations.AccountJoinedMethod();
      //expect(instance).to.be.a(AwsOrganizations.AccountJoinedMethod);
    });
