...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeAccountResponse();
  });
  ...
  describe('DescribeAccountResponse', function() {
    it('should create an instance of DescribeAccountResponse', function() {
      // uncomment below and update the code to test DescribeAccountResponse
      //var instance = new AwsOrganizations.DescribeAccountResponse();
      //expect(instance).to.be.a(AwsOrganizations.DescribeAccountResponse);
    });
