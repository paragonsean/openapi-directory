...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeEffectivePolicyResponseEffectivePolicy();
  });
  ...
  describe('DescribeEffectivePolicyResponseEffectivePolicy', function() {
    it('should create an instance of DescribeEffectivePolicyResponseEffectivePolicy', function() {
      // uncomment below and update the code to test DescribeEffectivePolicyResponseEffectivePolicy
      //var instance = new AwsOrganizations.DescribeEffectivePolicyResponseEffectivePolicy();
      //expect(instance).to.be.a(AwsOrganizations.DescribeEffectivePolicyResponseEffectivePolicy);
    });
