...
(function(root, factory) {
  ...
  describe('ParentType', function() {
    it('should create an instance of ParentType', function() {
      // uncomment below and update the code to test ParentType
      //var instance = new AwsOrganizations.ParentType();
      //expect(instance).to.be.a(AwsOrganizations.ParentType);
    });
