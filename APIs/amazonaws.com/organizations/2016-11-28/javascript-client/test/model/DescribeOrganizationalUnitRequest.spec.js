...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeOrganizationalUnitRequest();
  });
  ...
  describe('DescribeOrganizationalUnitRequest', function() {
    it('should create an instance of DescribeOrganizationalUnitRequest', function() {
      // uncomment below and update the code to test DescribeOrganizationalUnitRequest
      //var instance = new AwsOrganizations.DescribeOrganizationalUnitRequest();
      //expect(instance).to.be.a(AwsOrganizations.DescribeOrganizationalUnitRequest);
    });
