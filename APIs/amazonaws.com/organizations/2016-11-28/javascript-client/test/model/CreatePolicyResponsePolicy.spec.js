...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.CreatePolicyResponsePolicy();
  });
  ...
  describe('CreatePolicyResponsePolicy', function() {
    it('should create an instance of CreatePolicyResponsePolicy', function() {
      // uncomment below and update the code to test CreatePolicyResponsePolicy
      //var instance = new AwsOrganizations.CreatePolicyResponsePolicy();
      //expect(instance).to.be.a(AwsOrganizations.CreatePolicyResponsePolicy);
    });

    it('should have the property policySummary (base name: "PolicySummary")', function() {
      // uncomment below and update the code to test the property policySummary
      //var instance = new AwsOrganizations.CreatePolicyResponsePolicy();
