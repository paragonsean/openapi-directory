...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOrganizations.DescribeOrganizationalUnitResponseOrganizationalUnit();
  });
  ...
  describe('DescribeOrganizationalUnitResponseOrganizationalUnit', function() {
    it('should create an instance of DescribeOrganizationalUnitResponseOrganizationalUnit', function() {
      // uncomment below and update the code to test DescribeOrganizationalUnitResponseOrganizationalUnit
      //var instance = new AwsOrganizations.DescribeOrganizationalUnitResponseOrganizationalUnit();
      //expect(instance).to.be.a(AwsOrganizations.DescribeOrganizationalUnitResponseOrganizationalUnit);
    });
