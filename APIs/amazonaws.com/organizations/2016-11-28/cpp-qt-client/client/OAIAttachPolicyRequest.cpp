...
QString OAIAttachPolicyRequest::getPolicyId() const {
    return m_policy_id;
}
void OAIAttachPolicyRequest::setPolicyId(const QString &policy_id) {
    m_policy_id = policy_id;
    m_policy_id_isSet = true;
}

bool OAIAttachPolicyRequest::is_policy_id_Set() const{
    return m_policy_id_isSet;
}

bool OAIAttachPolicyRequest::is_policy_id_Valid() const{
    return m_policy_id_isValid;
}

QString OAIAttachPolicyRequest::getTargetId() const {
    return m_target_id;
}
void OAIAttachPolicyRequest::setTargetId(const QString &target_id) {
    m_target_id = target_id;
    m_target_id_isSet = true;
}

bool OAIAttachPolicyRequest::is_target_id_Set() const{
    return m_target_id_isSet;
}

bool OAIAttachPolicyRequest::is_target_id_Valid() const{
