...
/*
 * OAICreateOrganizationResponse.h
 *
 * 
 */

#ifndef OAICreateOrganizationResponse_H
#define OAICreateOrganizationResponse_H
...
namespace OpenAPI {
class OAICreateOrganizationResponse_Organization;

class OAICreateOrganizationResponse : public OAIObject {
public:
    OAICreateOrganizationResponse();
    OAICreateOrganizationResponse(QString json);
    ~OAICreateOrganizationResponse() override;
    ...
    OAICreateOrganizationResponse_Organization getOrganization() const;
    void setOrganization(const OAICreateOrganizationResponse_Organization &organization);
...
private:
    ...
    OAICreateOrganizationResponse_Organization m_organization;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOrganizationResponse)

#endif // OAICreateOrganizationResponse_H
