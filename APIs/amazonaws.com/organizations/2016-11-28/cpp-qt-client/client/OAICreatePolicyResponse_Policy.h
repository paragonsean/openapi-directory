...
/*
 * OAICreatePolicyResponse_Policy.h
 *
 * 
 */

#ifndef OAICreatePolicyResponse_Policy_H
#define OAICreatePolicyResponse_Policy_H
...
namespace OpenAPI {
class OAIPolicy_PolicySummary;

class OAICreatePolicyResponse_Policy : public OAIObject {
public:
    OAICreatePolicyResponse_Policy();
    OAICreatePolicyResponse_Policy(QString json);
    ~OAICreatePolicyResponse_Policy() override;
    ...
    OAIPolicy_PolicySummary getPolicySummary() const;
    void setPolicySummary(const OAIPolicy_PolicySummary &policy_summary);
    bool is_policy_summary_Set() const;
    bool is_policy_summary_Valid() const;
...
private:
    ...
    OAIPolicy_PolicySummary m_policy_summary;
    bool m_policy_summary_isSet;
    bool m_policy_summary_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePolicyResponse_Policy)

#endif // OAICreatePolicyResponse_Policy_H
