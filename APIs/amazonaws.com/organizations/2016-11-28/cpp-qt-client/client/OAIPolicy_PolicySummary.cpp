...
#include "OAIPolicy_PolicySummary.h"
...
OAIPolicy_PolicySummary::OAIPolicy_PolicySummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicy_PolicySummary::OAIPolicy_PolicySummary() {
    this->initializeModel();
}

OAIPolicy_PolicySummary::~OAIPolicy_PolicySummary() {}

void OAIPolicy_PolicySummary::initializeModel() {
...
void OAIPolicy_PolicySummary::fromJson(QString jsonString) {
...
void OAIPolicy_PolicySummary::fromJsonObject(QJsonObject json) {
...
QString OAIPolicy_PolicySummary::asJson() const {
...
QJsonObject OAIPolicy_PolicySummary::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIPolicy_PolicySummary::getId() const {
    return m_id;
}
void OAIPolicy_PolicySummary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPolicy_PolicySummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPolicy_PolicySummary::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPolicy_PolicySummary::getArn() const {
    return m_arn;
}
void OAIPolicy_PolicySummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIPolicy_PolicySummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIPolicy_PolicySummary::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIPolicy_PolicySummary::getName() const {
    return m_name;
}
void OAIPolicy_PolicySummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPolicy_PolicySummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPolicy_PolicySummary::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPolicy_PolicySummary::getDescription() const {
    return m_description;
}
void OAIPolicy_PolicySummary::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPolicy_PolicySummary::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPolicy_PolicySummary::is_description_Valid() const{
    return m_description_isValid;
}

OAIPolicyType OAIPolicy_PolicySummary::getType() const {
    return m_type;
}
void OAIPolicy_PolicySummary::setType(const OAIPolicyType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPolicy_PolicySummary::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPolicy_PolicySummary::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIPolicy_PolicySummary::getAwsManaged() const {
    return m_aws_managed;
}
void OAIPolicy_PolicySummary::setAwsManaged(const bool &aws_managed) {
    m_aws_managed = aws_managed;
    m_aws_managed_isSet = true;
}

bool OAIPolicy_PolicySummary::is_aws_managed_Set() const{
    return m_aws_managed_isSet;
}

bool OAIPolicy_PolicySummary::is_aws_managed_Valid() const{
    return m_aws_managed_isValid;
}

bool OAIPolicy_PolicySummary::isSet() const {
...
bool OAIPolicy_PolicySummary::isValid() const {
