...
OAIEnablePolicyTypeResponse::OAIEnablePolicyTypeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnablePolicyTypeResponse::OAIEnablePolicyTypeResponse() {
    this->initializeModel();
}

OAIEnablePolicyTypeResponse::~OAIEnablePolicyTypeResponse() {}

void OAIEnablePolicyTypeResponse::initializeModel() {

    m_root_isSet = false;
    m_root_isValid = false;
}

void OAIEnablePolicyTypeResponse::fromJson(QString jsonString) {
...
QJsonObject OAIEnablePolicyTypeResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_root.isSet()) {
...
OAIDisablePolicyTypeResponse_Root OAIEnablePolicyTypeResponse::getRoot() const {
    return m_root;
}
void OAIEnablePolicyTypeResponse::setRoot(const OAIDisablePolicyTypeResponse_Root &root) {
    m_root = root;
    m_root_isSet = true;
}

bool OAIEnablePolicyTypeResponse::is_root_Set() const{
    return m_root_isSet;
}

bool OAIEnablePolicyTypeResponse::is_root_Valid() const{
    return m_root_isValid;
}

bool OAIEnablePolicyTypeResponse::isSet() const {
...
bool OAIEnablePolicyTypeResponse::isValid() const {
