...
OAIInviteAccountToOrganizationResponse_Handshake::OAIInviteAccountToOrganizationResponse_Handshake(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInviteAccountToOrganizationResponse_Handshake::OAIInviteAccountToOrganizationResponse_Handshake() {
    this->initializeModel();
}

OAIInviteAccountToOrganizationResponse_Handshake::~OAIInviteAccountToOrganizationResponse_Handshake() {}

void OAIInviteAccountToOrganizationResponse_Handshake::initializeModel() {
...
void OAIInviteAccountToOrganizationResponse_Handshake::fromJson(QString jsonString) {
...
void OAIInviteAccountToOrganizationResponse_Handshake::fromJsonObject(QJsonObject json) {
...
QString OAIInviteAccountToOrganizationResponse_Handshake::asJson() const {
...
QJsonObject OAIInviteAccountToOrganizationResponse_Handshake::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIInviteAccountToOrganizationResponse_Handshake::getId() const {
    return m_id;
}
void OAIInviteAccountToOrganizationResponse_Handshake::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_id_Set() const{
    return m_id_isSet;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIInviteAccountToOrganizationResponse_Handshake::getArn() const {
    return m_arn;
}
void OAIInviteAccountToOrganizationResponse_Handshake::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_arn_Valid() const{
    return m_arn_isValid;
}

QList OAIInviteAccountToOrganizationResponse_Handshake::getParties() const {
    return m_parties;
}
void OAIInviteAccountToOrganizationResponse_Handshake::setParties(const QList &parties) {
    m_parties = parties;
    m_parties_isSet = true;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_parties_Set() const{
    return m_parties_isSet;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_parties_Valid() const{
    return m_parties_isValid;
}

OAIHandshakeState OAIInviteAccountToOrganizationResponse_Handshake::getState() const {
    return m_state;
}
void OAIInviteAccountToOrganizationResponse_Handshake::setState(const OAIHandshakeState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_state_Set() const{
    return m_state_isSet;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_state_Valid() const{
    return m_state_isValid;
}

QDateTime OAIInviteAccountToOrganizationResponse_Handshake::getRequestedTimestamp() const {
    return m_requested_timestamp;
}
void OAIInviteAccountToOrganizationResponse_Handshake::setRequestedTimestamp(const QDateTime &requested_timestamp) {
    m_requested_timestamp = requested_timestamp;
    m_requested_timestamp_isSet = true;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_requested_timestamp_Set() const{
    return m_requested_timestamp_isSet;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_requested_timestamp_Valid() const{
    return m_requested_timestamp_isValid;
}

QDateTime OAIInviteAccountToOrganizationResponse_Handshake::getExpirationTimestamp() const {
    return m_expiration_timestamp;
}
void OAIInviteAccountToOrganizationResponse_Handshake::setExpirationTimestamp(const QDateTime &expiration_timestamp) {
    m_expiration_timestamp = expiration_timestamp;
    m_expiration_timestamp_isSet = true;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_expiration_timestamp_Set() const{
    return m_expiration_timestamp_isSet;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_expiration_timestamp_Valid() const{
    return m_expiration_timestamp_isValid;
}

OAIActionType OAIInviteAccountToOrganizationResponse_Handshake::getAction() const {
    return m_action;
}
void OAIInviteAccountToOrganizationResponse_Handshake::setAction(const OAIActionType &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_action_Set() const{
    return m_action_isSet;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_action_Valid() const{
    return m_action_isValid;
}

QList OAIInviteAccountToOrganizationResponse_Handshake::getResources() const {
    return m_resources;
}
void OAIInviteAccountToOrganizationResponse_Handshake::setResources(const QList &resources) {
    m_resources = resources;
    m_resources_isSet = true;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_resources_Set() const{
    return m_resources_isSet;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::is_resources_Valid() const{
    return m_resources_isValid;
}

bool OAIInviteAccountToOrganizationResponse_Handshake::isSet() const {
...
bool OAIInviteAccountToOrganizationResponse_Handshake::isValid() const {
