...
/*
 * OAIResourcePolicy_ResourcePolicySummary.h
 *
 * 
 */

#ifndef OAIResourcePolicy_ResourcePolicySummary_H
#define OAIResourcePolicy_ResourcePolicySummary_H
...
class OAIResourcePolicy_ResourcePolicySummary : public OAIObject {
public:
    OAIResourcePolicy_ResourcePolicySummary();
    OAIResourcePolicy_ResourcePolicySummary(QString json);
    ~OAIResourcePolicy_ResourcePolicySummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourcePolicy_ResourcePolicySummary)

#endif // OAIResourcePolicy_ResourcePolicySummary_H
