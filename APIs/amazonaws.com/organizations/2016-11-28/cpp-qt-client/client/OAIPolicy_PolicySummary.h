...
/*
 * OAIPolicy_PolicySummary.h
 *
 * 
 */

#ifndef OAIPolicy_PolicySummary_H
#define OAIPolicy_PolicySummary_H
...
class OAIPolicy_PolicySummary : public OAIObject {
public:
    OAIPolicy_PolicySummary();
    OAIPolicy_PolicySummary(QString json);
    ~OAIPolicy_PolicySummary() override;
    ...
    void setAwsManaged(const bool &aws_managed);
    bool is_aws_managed_Set() const;
    bool is_aws_managed_Valid() const;
...
private:
    ...
    bool m_aws_managed;
    bool m_aws_managed_isSet;
    bool m_aws_managed_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPolicy_PolicySummary)

#endif // OAIPolicy_PolicySummary_H
