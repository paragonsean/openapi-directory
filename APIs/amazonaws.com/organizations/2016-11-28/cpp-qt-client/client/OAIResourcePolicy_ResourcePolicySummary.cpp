...
OAIResourcePolicy_ResourcePolicySummary::OAIResourcePolicy_ResourcePolicySummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResourcePolicy_ResourcePolicySummary::OAIResourcePolicy_ResourcePolicySummary() {
    this->initializeModel();
}

OAIResourcePolicy_ResourcePolicySummary::~OAIResourcePolicy_ResourcePolicySummary() {}

void OAIResourcePolicy_ResourcePolicySummary::initializeModel() {
...
void OAIResourcePolicy_ResourcePolicySummary::fromJson(QString jsonString) {
...
void OAIResourcePolicy_ResourcePolicySummary::fromJsonObject(QJsonObject json) {
...
QString OAIResourcePolicy_ResourcePolicySummary::asJson() const {
...
QJsonObject OAIResourcePolicy_ResourcePolicySummary::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIResourcePolicy_ResourcePolicySummary::getId() const {
    return m_id;
}
void OAIResourcePolicy_ResourcePolicySummary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIResourcePolicy_ResourcePolicySummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAIResourcePolicy_ResourcePolicySummary::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIResourcePolicy_ResourcePolicySummary::getArn() const {
    return m_arn;
}
void OAIResourcePolicy_ResourcePolicySummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIResourcePolicy_ResourcePolicySummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIResourcePolicy_ResourcePolicySummary::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIResourcePolicy_ResourcePolicySummary::isSet() const {
...
bool OAIResourcePolicy_ResourcePolicySummary::isValid() const {
