...
#ifndef OAIHandshakeState_H
#define OAIHandshakeState_H
...
class OAIHandshakeState : public OAIEnum {
public:
    OAIHandshakeState();
    OAIHandshakeState(QString json);
    ~OAIHandshakeState() override;
    ...
    OAIHandshakeState::eOAIHandshakeState getValue() const;
    void setValue(const OAIHandshakeState::eOAIHandshakeState& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIHandshakeState)

#endif // OAIHandshakeState_H
