...
/*
 * OAICreateOrganizationRequest.h
 *
 * 
 */

#ifndef OAICreateOrganizationRequest_H
#define OAICreateOrganizationRequest_H
...
class OAICreateOrganizationRequest : public OAIObject {
public:
    OAICreateOrganizationRequest();
    OAICreateOrganizationRequest(QString json);
    ~OAICreateOrganizationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOrganizationRequest)

#endif // OAICreateOrganizationRequest_H
