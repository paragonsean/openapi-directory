...
OAIListOrganizationalUnitsForParentRequest::OAIListOrganizationalUnitsForParentRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListOrganizationalUnitsForParentRequest::OAIListOrganizationalUnitsForParentRequest() {
    this->initializeModel();
}

OAIListOrganizationalUnitsForParentRequest::~OAIListOrganizationalUnitsForParentRequest() {}

void OAIListOrganizationalUnitsForParentRequest::initializeModel() {
...
void OAIListOrganizationalUnitsForParentRequest::fromJson(QString jsonString) {
...
void OAIListOrganizationalUnitsForParentRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListOrganizationalUnitsForParentRequest::asJson() const {
...
QJsonObject OAIListOrganizationalUnitsForParentRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListOrganizationalUnitsForParentRequest::getParentId() const {
    return m_parent_id;
}
void OAIListOrganizationalUnitsForParentRequest::setParentId(const QString &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAIListOrganizationalUnitsForParentRequest::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAIListOrganizationalUnitsForParentRequest::is_parent_id_Valid() const{
    return m_parent_id_isValid;
}

QString OAIListOrganizationalUnitsForParentRequest::getNextToken() const {
    return m_next_token;
}
void OAIListOrganizationalUnitsForParentRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListOrganizationalUnitsForParentRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListOrganizationalUnitsForParentRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListOrganizationalUnitsForParentRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListOrganizationalUnitsForParentRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListOrganizationalUnitsForParentRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListOrganizationalUnitsForParentRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListOrganizationalUnitsForParentRequest::isSet() const {
...
bool OAIListOrganizationalUnitsForParentRequest::isValid() const {
