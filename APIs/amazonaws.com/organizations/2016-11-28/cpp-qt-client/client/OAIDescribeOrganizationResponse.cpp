...
OAIDescribeOrganizationResponse::OAIDescribeOrganizationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeOrganizationResponse::OAIDescribeOrganizationResponse() {
    this->initializeModel();
}

OAIDescribeOrganizationResponse::~OAIDescribeOrganizationResponse() {}

void OAIDescribeOrganizationResponse::initializeModel() {

    m_organization_isSet = false;
    m_organization_isValid = false;
}

void OAIDescribeOrganizationResponse::fromJson(QString jsonString) {
...
void OAIDescribeOrganizationResponse::fromJsonObject(QJsonObject json) {

    m_organization_isValid = ::OpenAPI::fromJsonValue(m_organization, json[QString("Organization")]);
    m_organization_isSet = !json[QString("Organization")].isNull() && m_organization_isValid;
}

QString OAIDescribeOrganizationResponse::asJson() const {
...
QJsonObject OAIDescribeOrganizationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeOrganizationResponse_Organization OAIDescribeOrganizationResponse::getOrganization() const {
    return m_organization;
}
void OAIDescribeOrganizationResponse::setOrganization(const OAIDescribeOrganizationResponse_Organization &organization) {
    m_organization = organization;
    m_organization_isSet = true;
}

bool OAIDescribeOrganizationResponse::is_organization_Set() const{
    return m_organization_isSet;
}

bool OAIDescribeOrganizationResponse::is_organization_Valid() const{
    return m_organization_isValid;
}

bool OAIDescribeOrganizationResponse::isSet() const {
...
bool OAIDescribeOrganizationResponse::isValid() const {
