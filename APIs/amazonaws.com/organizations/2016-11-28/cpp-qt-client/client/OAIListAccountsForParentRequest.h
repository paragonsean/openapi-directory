...
/*
 * OAIListAccountsForParentRequest.h
 *
 * 
 */

#ifndef OAIListAccountsForParentRequest_H
#define OAIListAccountsForParentRequest_H
...
class OAIListAccountsForParentRequest : public OAIObject {
public:
    OAIListAccountsForParentRequest();
    OAIListAccountsForParentRequest(QString json);
    ~OAIListAccountsForParentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAccountsForParentRequest)

#endif // OAIListAccountsForParentRequest_H
