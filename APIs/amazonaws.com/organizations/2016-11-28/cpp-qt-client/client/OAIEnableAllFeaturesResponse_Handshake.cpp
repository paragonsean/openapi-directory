...
OAIEnableAllFeaturesResponse_Handshake::OAIEnableAllFeaturesResponse_Handshake(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnableAllFeaturesResponse_Handshake::OAIEnableAllFeaturesResponse_Handshake() {
    this->initializeModel();
}

OAIEnableAllFeaturesResponse_Handshake::~OAIEnableAllFeaturesResponse_Handshake() {}

void OAIEnableAllFeaturesResponse_Handshake::initializeModel() {
...
void OAIEnableAllFeaturesResponse_Handshake::fromJson(QString jsonString) {
...
void OAIEnableAllFeaturesResponse_Handshake::fromJsonObject(QJsonObject json) {
...
QString OAIEnableAllFeaturesResponse_Handshake::asJson() const {
...
QJsonObject OAIEnableAllFeaturesResponse_Handshake::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIEnableAllFeaturesResponse_Handshake::getId() const {
    return m_id;
}
void OAIEnableAllFeaturesResponse_Handshake::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIEnableAllFeaturesResponse_Handshake::getArn() const {
    return m_arn;
}
void OAIEnableAllFeaturesResponse_Handshake::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_arn_Valid() const{
    return m_arn_isValid;
}

QList OAIEnableAllFeaturesResponse_Handshake::getParties() const {
    return m_parties;
}
void OAIEnableAllFeaturesResponse_Handshake::setParties(const QList &parties) {
    m_parties = parties;
    m_parties_isSet = true;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_parties_Set() const{
    return m_parties_isSet;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_parties_Valid() const{
    return m_parties_isValid;
}

OAIHandshakeState OAIEnableAllFeaturesResponse_Handshake::getState() const {
    return m_state;
}
void OAIEnableAllFeaturesResponse_Handshake::setState(const OAIHandshakeState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_state_Set() const{
    return m_state_isSet;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_state_Valid() const{
    return m_state_isValid;
}

QDateTime OAIEnableAllFeaturesResponse_Handshake::getRequestedTimestamp() const {
    return m_requested_timestamp;
}
void OAIEnableAllFeaturesResponse_Handshake::setRequestedTimestamp(const QDateTime &requested_timestamp) {
    m_requested_timestamp = requested_timestamp;
    m_requested_timestamp_isSet = true;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_requested_timestamp_Set() const{
    return m_requested_timestamp_isSet;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_requested_timestamp_Valid() const{
    return m_requested_timestamp_isValid;
}

QDateTime OAIEnableAllFeaturesResponse_Handshake::getExpirationTimestamp() const {
    return m_expiration_timestamp;
}
void OAIEnableAllFeaturesResponse_Handshake::setExpirationTimestamp(const QDateTime &expiration_timestamp) {
    m_expiration_timestamp = expiration_timestamp;
    m_expiration_timestamp_isSet = true;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_expiration_timestamp_Set() const{
    return m_expiration_timestamp_isSet;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_expiration_timestamp_Valid() const{
    return m_expiration_timestamp_isValid;
}

OAIActionType OAIEnableAllFeaturesResponse_Handshake::getAction() const {
    return m_action;
}
void OAIEnableAllFeaturesResponse_Handshake::setAction(const OAIActionType &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_action_Set() const{
    return m_action_isSet;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_action_Valid() const{
    return m_action_isValid;
}

QList OAIEnableAllFeaturesResponse_Handshake::getResources() const {
    return m_resources;
}
void OAIEnableAllFeaturesResponse_Handshake::setResources(const QList &resources) {
    m_resources = resources;
    m_resources_isSet = true;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_resources_Set() const{
    return m_resources_isSet;
}

bool OAIEnableAllFeaturesResponse_Handshake::is_resources_Valid() const{
    return m_resources_isValid;
}

bool OAIEnableAllFeaturesResponse_Handshake::isSet() const {
...
bool OAIEnableAllFeaturesResponse_Handshake::isValid() const {
