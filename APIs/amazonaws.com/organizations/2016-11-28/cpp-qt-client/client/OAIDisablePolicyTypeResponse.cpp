...
OAIDisablePolicyTypeResponse::OAIDisablePolicyTypeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisablePolicyTypeResponse::OAIDisablePolicyTypeResponse() {
    this->initializeModel();
}

OAIDisablePolicyTypeResponse::~OAIDisablePolicyTypeResponse() {}

void OAIDisablePolicyTypeResponse::initializeModel() {

    m_root_isSet = false;
    m_root_isValid = false;
}

void OAIDisablePolicyTypeResponse::fromJson(QString jsonString) {
...
void OAIDisablePolicyTypeResponse::fromJsonObject(QJsonObject json) {

    m_root_isValid = ::OpenAPI::fromJsonValue(m_root, json[QString("Root")]);
    m_root_isSet = !json[QString("Root")].isNull() && m_root_isValid;
}

QString OAIDisablePolicyTypeResponse::asJson() const {
...
QJsonObject OAIDisablePolicyTypeResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_root.isSet()) {
...
OAIDisablePolicyTypeResponse_Root OAIDisablePolicyTypeResponse::getRoot() const {
    return m_root;
}
void OAIDisablePolicyTypeResponse::setRoot(const OAIDisablePolicyTypeResponse_Root &root) {
    m_root = root;
    m_root_isSet = true;
}

bool OAIDisablePolicyTypeResponse::is_root_Set() const{
    return m_root_isSet;
}

bool OAIDisablePolicyTypeResponse::is_root_Valid() const{
    return m_root_isValid;
}

bool OAIDisablePolicyTypeResponse::isSet() const {
...
bool OAIDisablePolicyTypeResponse::isValid() const {
