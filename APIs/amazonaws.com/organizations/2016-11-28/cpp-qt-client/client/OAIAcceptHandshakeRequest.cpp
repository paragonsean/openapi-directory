...
OAIAcceptHandshakeRequest::OAIAcceptHandshakeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAcceptHandshakeRequest::OAIAcceptHandshakeRequest() {
    this->initializeModel();
}

OAIAcceptHandshakeRequest::~OAIAcceptHandshakeRequest() {}

void OAIAcceptHandshakeRequest::initializeModel() {

    m_handshake_id_isSet = false;
    m_handshake_id_isValid = false;
}

void OAIAcceptHandshakeRequest::fromJson(QString jsonString) {
...
void OAIAcceptHandshakeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAcceptHandshakeRequest::asJson() const {
...
QJsonObject OAIAcceptHandshakeRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAcceptHandshakeRequest::getHandshakeId() const {
    return m_handshake_id;
}
void OAIAcceptHandshakeRequest::setHandshakeId(const QString &handshake_id) {
    m_handshake_id = handshake_id;
    m_handshake_id_isSet = true;
}

bool OAIAcceptHandshakeRequest::is_handshake_id_Set() const{
    return m_handshake_id_isSet;
}

bool OAIAcceptHandshakeRequest::is_handshake_id_Valid() const{
    return m_handshake_id_isValid;
}

bool OAIAcceptHandshakeRequest::isSet() const {
...
bool OAIAcceptHandshakeRequest::isValid() const {
