...
#include "OAIAccountJoinedMethod.h"
...
OAIAccountJoinedMethod::OAIAccountJoinedMethod(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountJoinedMethod::OAIAccountJoinedMethod() {
    this->initializeModel();
}

OAIAccountJoinedMethod::~OAIAccountJoinedMethod() {}

void OAIAccountJoinedMethod::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAccountJoinedMethod::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAccountJoinedMethod::fromJson(QString jsonString) {
    
    if ( jsonString.compare("INVITED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountJoinedMethod::INVITED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CREATED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountJoinedMethod::CREATED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAccountJoinedMethod::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAccountJoinedMethod::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAccountJoinedMethod::INVITED:
            val = "INVITED";
            break;
        case eOAIAccountJoinedMethod::CREATED:
            val = "CREATED";
            break;
        default:
            break;
...
QJsonValue OAIAccountJoinedMethod::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAccountJoinedMethod::eOAIAccountJoinedMethod OAIAccountJoinedMethod::getValue() const {
    return m_value;
}

void OAIAccountJoinedMethod::setValue(const OAIAccountJoinedMethod::eOAIAccountJoinedMethod& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAccountJoinedMethod::isSet() const {
    
    return m_value_isSet;
}

bool OAIAccountJoinedMethod::isValid() const {
