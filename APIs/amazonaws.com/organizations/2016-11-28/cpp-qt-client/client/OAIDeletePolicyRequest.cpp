...
QString OAIDeletePolicyRequest::getPolicyId() const {
    return m_policy_id;
}
void OAIDeletePolicyRequest::setPolicyId(const QString &policy_id) {
    m_policy_id = policy_id;
    m_policy_id_isSet = true;
}

bool OAIDeletePolicyRequest::is_policy_id_Set() const{
    return m_policy_id_isSet;
}

bool OAIDeletePolicyRequest::is_policy_id_Valid() const{
