...
OAIListTargetsForPolicyRequest::OAIListTargetsForPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTargetsForPolicyRequest::OAIListTargetsForPolicyRequest() {
    this->initializeModel();
}

OAIListTargetsForPolicyRequest::~OAIListTargetsForPolicyRequest() {}

void OAIListTargetsForPolicyRequest::initializeModel() {
...
void OAIListTargetsForPolicyRequest::fromJson(QString jsonString) {
...
void OAIListTargetsForPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListTargetsForPolicyRequest::asJson() const {
...
QJsonObject OAIListTargetsForPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListTargetsForPolicyRequest::getPolicyId() const {
    return m_policy_id;
}
void OAIListTargetsForPolicyRequest::setPolicyId(const QString &policy_id) {
    m_policy_id = policy_id;
    m_policy_id_isSet = true;
}

bool OAIListTargetsForPolicyRequest::is_policy_id_Set() const{
    return m_policy_id_isSet;
}

bool OAIListTargetsForPolicyRequest::is_policy_id_Valid() const{
    return m_policy_id_isValid;
}

QString OAIListTargetsForPolicyRequest::getNextToken() const {
    return m_next_token;
}
void OAIListTargetsForPolicyRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListTargetsForPolicyRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListTargetsForPolicyRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListTargetsForPolicyRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListTargetsForPolicyRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListTargetsForPolicyRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListTargetsForPolicyRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListTargetsForPolicyRequest::isSet() const {
...
bool OAIListTargetsForPolicyRequest::isValid() const {
