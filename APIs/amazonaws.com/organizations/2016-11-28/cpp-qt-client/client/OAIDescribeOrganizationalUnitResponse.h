...
/*
 * OAIDescribeOrganizationalUnitResponse.h
 *
 * 
 */

#ifndef OAIDescribeOrganizationalUnitResponse_H
#define OAIDescribeOrganizationalUnitResponse_H

#include <QJsonObject>

#include "OAIDescribeOrganizationalUnitResponse_OrganizationalUnit.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDescribeOrganizationalUnitResponse_OrganizationalUnit;

class OAIDescribeOrganizationalUnitResponse : public OAIObject {
public:
    OAIDescribeOrganizationalUnitResponse();
    OAIDescribeOrganizationalUnitResponse(QString json);
    ~OAIDescribeOrganizationalUnitResponse() override;
    ...
    OAIDescribeOrganizationalUnitResponse_OrganizationalUnit getOrganizationalUnit() const;
    void setOrganizationalUnit(const OAIDescribeOrganizationalUnitResponse_OrganizationalUnit &organizational_unit);
...
private:
    ...
    OAIDescribeOrganizationalUnitResponse_OrganizationalUnit m_organizational_unit;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeOrganizationalUnitResponse)

#endif // OAIDescribeOrganizationalUnitResponse_H
