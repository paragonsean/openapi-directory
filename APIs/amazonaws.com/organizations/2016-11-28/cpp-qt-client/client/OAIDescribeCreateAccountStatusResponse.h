...
/*
 * OAIDescribeCreateAccountStatusResponse.h
 *
 * 
 */

#ifndef OAIDescribeCreateAccountStatusResponse_H
#define OAIDescribeCreateAccountStatusResponse_H
...
namespace OpenAPI {
class OAIDescribeCreateAccountStatusResponse_CreateAccountStatus;

class OAIDescribeCreateAccountStatusResponse : public OAIObject {
public:
    OAIDescribeCreateAccountStatusResponse();
    OAIDescribeCreateAccountStatusResponse(QString json);
    ~OAIDescribeCreateAccountStatusResponse() override;
    ...
    OAIDescribeCreateAccountStatusResponse_CreateAccountStatus getCreateAccountStatus() const;
    void setCreateAccountStatus(const OAIDescribeCreateAccountStatusResponse_CreateAccountStatus &create_account_status);
...
private:
    ...
    OAIDescribeCreateAccountStatusResponse_CreateAccountStatus m_create_account_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCreateAccountStatusResponse)

#endif // OAIDescribeCreateAccountStatusResponse_H
