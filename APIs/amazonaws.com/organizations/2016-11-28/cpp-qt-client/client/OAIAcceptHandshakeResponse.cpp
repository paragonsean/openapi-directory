...
OAIAcceptHandshakeResponse::OAIAcceptHandshakeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAcceptHandshakeResponse::OAIAcceptHandshakeResponse() {
    this->initializeModel();
}

OAIAcceptHandshakeResponse::~OAIAcceptHandshakeResponse() {}

void OAIAcceptHandshakeResponse::initializeModel() {

    m_handshake_isSet = false;
    m_handshake_isValid = false;
}

void OAIAcceptHandshakeResponse::fromJson(QString jsonString) {
...
void OAIAcceptHandshakeResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAcceptHandshakeResponse::asJson() const {
...
QJsonObject OAIAcceptHandshakeResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIAcceptHandshakeResponse_Handshake OAIAcceptHandshakeResponse::getHandshake() const {
    return m_handshake;
}
void OAIAcceptHandshakeResponse::setHandshake(const OAIAcceptHandshakeResponse_Handshake &handshake) {
    m_handshake = handshake;
    m_handshake_isSet = true;
}

bool OAIAcceptHandshakeResponse::is_handshake_Set() const{
    return m_handshake_isSet;
}

bool OAIAcceptHandshakeResponse::is_handshake_Valid() const{
    return m_handshake_isValid;
}

bool OAIAcceptHandshakeResponse::isSet() const {
...
bool OAIAcceptHandshakeResponse::isValid() const {
