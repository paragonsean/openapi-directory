...
/*
 * OAIListTargetsForPolicyResponse.h
 *
 * 
 */

#ifndef OAIListTargetsForPolicyResponse_H
#define OAIListTargetsForPolicyResponse_H
...
class OAIListTargetsForPolicyResponse : public OAIObject {
public:
    OAIListTargetsForPolicyResponse();
    OAIListTargetsForPolicyResponse(QString json);
    ~OAIListTargetsForPolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTargetsForPolicyResponse)

#endif // OAIListTargetsForPolicyResponse_H
