...
/*
 * OAIListAWSServiceAccessForOrganizationResponse.h
 *
 * 
 */

#ifndef OAIListAWSServiceAccessForOrganizationResponse_H
#define OAIListAWSServiceAccessForOrganizationResponse_H
...
class OAIListAWSServiceAccessForOrganizationResponse : public OAIObject {
public:
    OAIListAWSServiceAccessForOrganizationResponse();
    OAIListAWSServiceAccessForOrganizationResponse(QString json);
    ~OAIListAWSServiceAccessForOrganizationResponse() override;
    ...
    QList getEnabledServicePrincipals() const;
    void setEnabledServicePrincipals(const QList &enabled_service_principals);
    bool is_enabled_service_principals_Set() const;
    bool is_enabled_service_principals_Valid() const;
...
private:
    ...
    QList m_enabled_service_principals;
    bool m_enabled_service_principals_isSet;
    bool m_enabled_service_principals_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAWSServiceAccessForOrganizationResponse)

#endif // OAIListAWSServiceAccessForOrganizationResponse_H
