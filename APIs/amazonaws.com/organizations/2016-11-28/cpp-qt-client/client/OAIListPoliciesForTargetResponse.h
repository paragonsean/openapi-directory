...
/*
 * OAIListPoliciesForTargetResponse.h
 *
 * 
 */

#ifndef OAIListPoliciesForTargetResponse_H
#define OAIListPoliciesForTargetResponse_H
...
class OAIListPoliciesForTargetResponse : public OAIObject {
public:
    OAIListPoliciesForTargetResponse();
    OAIListPoliciesForTargetResponse(QString json);
    ~OAIListPoliciesForTargetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPoliciesForTargetResponse)

#endif // OAIListPoliciesForTargetResponse_H
