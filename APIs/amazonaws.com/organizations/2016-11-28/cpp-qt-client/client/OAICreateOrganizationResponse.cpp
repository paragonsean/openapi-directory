...
OAICreateOrganizationResponse::OAICreateOrganizationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateOrganizationResponse::OAICreateOrganizationResponse() {
    this->initializeModel();
}

OAICreateOrganizationResponse::~OAICreateOrganizationResponse() {}

void OAICreateOrganizationResponse::initializeModel() {

    m_organization_isSet = false;
    m_organization_isValid = false;
}

void OAICreateOrganizationResponse::fromJson(QString jsonString) {
...
void OAICreateOrganizationResponse::fromJsonObject(QJsonObject json) {

    m_organization_isValid = ::OpenAPI::fromJsonValue(m_organization, json[QString("Organization")]);
    m_organization_isSet = !json[QString("Organization")].isNull() && m_organization_isValid;
}

QString OAICreateOrganizationResponse::asJson() const {
...
QJsonObject OAICreateOrganizationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateOrganizationResponse_Organization OAICreateOrganizationResponse::getOrganization() const {
    return m_organization;
}
void OAICreateOrganizationResponse::setOrganization(const OAICreateOrganizationResponse_Organization &organization) {
    m_organization = organization;
    m_organization_isSet = true;
}

bool OAICreateOrganizationResponse::is_organization_Set() const{
    return m_organization_isSet;
}

bool OAICreateOrganizationResponse::is_organization_Valid() const{
    return m_organization_isValid;
}

bool OAICreateOrganizationResponse::isSet() const {
...
bool OAICreateOrganizationResponse::isValid() const {
