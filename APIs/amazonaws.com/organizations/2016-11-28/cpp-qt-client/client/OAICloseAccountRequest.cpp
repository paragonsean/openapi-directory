...
QString OAICloseAccountRequest::getAccountId() const {
    return m_account_id;
}
void OAICloseAccountRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAICloseAccountRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAICloseAccountRequest::is_account_id_Valid() const{
