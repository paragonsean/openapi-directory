...
/*
 * OAIDeclineHandshakeRequest.h
 *
 * 
 */

#ifndef OAIDeclineHandshakeRequest_H
#define OAIDeclineHandshakeRequest_H
...
class OAIDeclineHandshakeRequest : public OAIObject {
public:
    OAIDeclineHandshakeRequest();
    OAIDeclineHandshakeRequest(QString json);
    ~OAIDeclineHandshakeRequest() override;
    ...
    QString getHandshakeId() const;
    void setHandshakeId(const QString &handshake_id);
    bool is_handshake_id_Set() const;
    bool is_handshake_id_Valid() const;
...
private:
    ...
    QString m_handshake_id;
    bool m_handshake_id_isSet;
    bool m_handshake_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeclineHandshakeRequest)

#endif // OAIDeclineHandshakeRequest_H
