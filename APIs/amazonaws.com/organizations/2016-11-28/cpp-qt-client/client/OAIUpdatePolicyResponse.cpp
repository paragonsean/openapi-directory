...
OAIUpdatePolicyResponse::OAIUpdatePolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePolicyResponse::OAIUpdatePolicyResponse() {
    this->initializeModel();
}

OAIUpdatePolicyResponse::~OAIUpdatePolicyResponse() {}

void OAIUpdatePolicyResponse::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIUpdatePolicyResponse::fromJson(QString jsonString) {
...
void OAIUpdatePolicyResponse::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAIUpdatePolicyResponse::asJson() const {
...
QJsonObject OAIUpdatePolicyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAIUpdatePolicyResponse_Policy OAIUpdatePolicyResponse::getPolicy() const {
    return m_policy;
}
void OAIUpdatePolicyResponse::setPolicy(const OAIUpdatePolicyResponse_Policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIUpdatePolicyResponse::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIUpdatePolicyResponse::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIUpdatePolicyResponse::isSet() const {
...
bool OAIUpdatePolicyResponse::isValid() const {
