...
/*
 * OAIInviteAccountToOrganizationRequest_Target.h
 *
 * 
 */

#ifndef OAIInviteAccountToOrganizationRequest_Target_H
#define OAIInviteAccountToOrganizationRequest_Target_H

#include <QJsonObject>

#include "OAIHandshakePartyType.h"
#include <QString>
...
class OAIInviteAccountToOrganizationRequest_Target : public OAIObject {
public:
    OAIInviteAccountToOrganizationRequest_Target();
    OAIInviteAccountToOrganizationRequest_Target(QString json);
    ~OAIInviteAccountToOrganizationRequest_Target() override;
    ...
    OAIHandshakePartyType getType() const;
    void setType(const OAIHandshakePartyType &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIInviteAccountToOrganizationRequest_Target)

#endif // OAIInviteAccountToOrganizationRequest_Target_H
