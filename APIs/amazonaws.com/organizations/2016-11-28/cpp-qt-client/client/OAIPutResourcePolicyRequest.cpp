...
QString OAIPutResourcePolicyRequest::getContent() const {
    return m_content;
}
void OAIPutResourcePolicyRequest::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIPutResourcePolicyRequest::is_content_Set() const{
    return m_content_isSet;
}

bool OAIPutResourcePolicyRequest::is_content_Valid() const{
    return m_content_isValid;
}

QList OAIPutResourcePolicyRequest::getTags() const {
    return m_tags;
}
void OAIPutResourcePolicyRequest::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIPutResourcePolicyRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIPutResourcePolicyRequest::is_tags_Valid() const{
