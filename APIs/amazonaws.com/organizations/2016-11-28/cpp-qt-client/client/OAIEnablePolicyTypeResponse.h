...
/*
 * OAIEnablePolicyTypeResponse.h
 *
 * 
 */

#ifndef OAIEnablePolicyTypeResponse_H
#define OAIEnablePolicyTypeResponse_H
...
class OAIEnablePolicyTypeResponse : public OAIObject {
public:
    OAIEnablePolicyTypeResponse();
    OAIEnablePolicyTypeResponse(QString json);
    ~OAIEnablePolicyTypeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnablePolicyTypeResponse)

#endif // OAIEnablePolicyTypeResponse_H
