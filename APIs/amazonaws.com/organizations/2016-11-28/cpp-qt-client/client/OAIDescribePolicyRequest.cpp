...
OAIDescribePolicyRequest::OAIDescribePolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribePolicyRequest::OAIDescribePolicyRequest() {
    this->initializeModel();
}

OAIDescribePolicyRequest::~OAIDescribePolicyRequest() {}

void OAIDescribePolicyRequest::initializeModel() {

    m_policy_id_isSet = false;
    m_policy_id_isValid = false;
}

void OAIDescribePolicyRequest::fromJson(QString jsonString) {
...
void OAIDescribePolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribePolicyRequest::asJson() const {
...
QJsonObject OAIDescribePolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribePolicyRequest::getPolicyId() const {
    return m_policy_id;
}
void OAIDescribePolicyRequest::setPolicyId(const QString &policy_id) {
    m_policy_id = policy_id;
    m_policy_id_isSet = true;
}

bool OAIDescribePolicyRequest::is_policy_id_Set() const{
    return m_policy_id_isSet;
}

bool OAIDescribePolicyRequest::is_policy_id_Valid() const{
    return m_policy_id_isValid;
}

bool OAIDescribePolicyRequest::isSet() const {
...
bool OAIDescribePolicyRequest::isValid() const {
