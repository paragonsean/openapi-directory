...
OAICreateOrganizationalUnitRequest::OAICreateOrganizationalUnitRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateOrganizationalUnitRequest::OAICreateOrganizationalUnitRequest() {
    this->initializeModel();
}

OAICreateOrganizationalUnitRequest::~OAICreateOrganizationalUnitRequest() {}

void OAICreateOrganizationalUnitRequest::initializeModel() {
...
void OAICreateOrganizationalUnitRequest::fromJson(QString jsonString) {
...
void OAICreateOrganizationalUnitRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateOrganizationalUnitRequest::asJson() const {
...
QJsonObject OAICreateOrganizationalUnitRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateOrganizationalUnitRequest::getParentId() const {
    return m_parent_id;
}
void OAICreateOrganizationalUnitRequest::setParentId(const QString &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAICreateOrganizationalUnitRequest::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAICreateOrganizationalUnitRequest::is_parent_id_Valid() const{
    return m_parent_id_isValid;
}

QString OAICreateOrganizationalUnitRequest::getName() const {
    return m_name;
}
void OAICreateOrganizationalUnitRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateOrganizationalUnitRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateOrganizationalUnitRequest::is_name_Valid() const{
    return m_name_isValid;
}

QList OAICreateOrganizationalUnitRequest::getTags() const {
    return m_tags;
}
void OAICreateOrganizationalUnitRequest::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateOrganizationalUnitRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateOrganizationalUnitRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateOrganizationalUnitRequest::isSet() const {
...
bool OAICreateOrganizationalUnitRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_parent_id_isValid && m_name_isValid && true;
}
