...
OAIDescribeOrganizationalUnitResponse::OAIDescribeOrganizationalUnitResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeOrganizationalUnitResponse::OAIDescribeOrganizationalUnitResponse() {
    this->initializeModel();
}

OAIDescribeOrganizationalUnitResponse::~OAIDescribeOrganizationalUnitResponse() {}

void OAIDescribeOrganizationalUnitResponse::initializeModel() {

    m_organizational_unit_isSet = false;
    m_organizational_unit_isValid = false;
}

void OAIDescribeOrganizationalUnitResponse::fromJson(QString jsonString) {
...
void OAIDescribeOrganizationalUnitResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeOrganizationalUnitResponse::asJson() const {
...
QJsonObject OAIDescribeOrganizationalUnitResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeOrganizationalUnitResponse_OrganizationalUnit OAIDescribeOrganizationalUnitResponse::getOrganizationalUnit() const {
    return m_organizational_unit;
}
void OAIDescribeOrganizationalUnitResponse::setOrganizationalUnit(const OAIDescribeOrganizationalUnitResponse_OrganizationalUnit &organizational_unit) {
    m_organizational_unit = organizational_unit;
    m_organizational_unit_isSet = true;
}

bool OAIDescribeOrganizationalUnitResponse::is_organizational_unit_Set() const{
    return m_organizational_unit_isSet;
}

bool OAIDescribeOrganizationalUnitResponse::is_organizational_unit_Valid() const{
    return m_organizational_unit_isValid;
}

bool OAIDescribeOrganizationalUnitResponse::isSet() const {
...
bool OAIDescribeOrganizationalUnitResponse::isValid() const {
