...
/*
 * OAIUpdatePolicyResponse.h
 *
 * 
 */

#ifndef OAIUpdatePolicyResponse_H
#define OAIUpdatePolicyResponse_H
...
namespace OpenAPI {
class OAIUpdatePolicyResponse_Policy;

class OAIUpdatePolicyResponse : public OAIObject {
public:
    OAIUpdatePolicyResponse();
    OAIUpdatePolicyResponse(QString json);
    ~OAIUpdatePolicyResponse() override;
    ...
    OAIUpdatePolicyResponse_Policy getPolicy() const;
    void setPolicy(const OAIUpdatePolicyResponse_Policy &policy);
...
private:
    ...
    OAIUpdatePolicyResponse_Policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePolicyResponse)

#endif // OAIUpdatePolicyResponse_H
