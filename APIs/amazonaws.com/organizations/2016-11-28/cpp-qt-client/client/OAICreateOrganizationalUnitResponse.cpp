...
OAICreateOrganizationalUnitResponse::OAICreateOrganizationalUnitResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateOrganizationalUnitResponse::OAICreateOrganizationalUnitResponse() {
    this->initializeModel();
}

OAICreateOrganizationalUnitResponse::~OAICreateOrganizationalUnitResponse() {}

void OAICreateOrganizationalUnitResponse::initializeModel() {

    m_organizational_unit_isSet = false;
    m_organizational_unit_isValid = false;
}

void OAICreateOrganizationalUnitResponse::fromJson(QString jsonString) {
...
void OAICreateOrganizationalUnitResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateOrganizationalUnitResponse::asJson() const {
...
QJsonObject OAICreateOrganizationalUnitResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_organizational_unit.isSet()) {
        obj.insert(QString("OrganizationalUnit"), ::OpenAPI::toJsonValue(m_organizational_unit));
    }
    return obj;
}

OAICreateOrganizationalUnitResponse_OrganizationalUnit OAICreateOrganizationalUnitResponse::getOrganizationalUnit() const {
    return m_organizational_unit;
}
void OAICreateOrganizationalUnitResponse::setOrganizationalUnit(const OAICreateOrganizationalUnitResponse_OrganizationalUnit &organizational_unit) {
    m_organizational_unit = organizational_unit;
    m_organizational_unit_isSet = true;
}

bool OAICreateOrganizationalUnitResponse::is_organizational_unit_Set() const{
    return m_organizational_unit_isSet;
}

bool OAICreateOrganizationalUnitResponse::is_organizational_unit_Valid() const{
    return m_organizational_unit_isValid;
}

bool OAICreateOrganizationalUnitResponse::isSet() const {
...
bool OAICreateOrganizationalUnitResponse::isValid() const {
