...
#include "OAIDescribePolicyResponse_Policy.h"
...
OAIDescribePolicyResponse_Policy::OAIDescribePolicyResponse_Policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribePolicyResponse_Policy::OAIDescribePolicyResponse_Policy() {
    this->initializeModel();
}

OAIDescribePolicyResponse_Policy::~OAIDescribePolicyResponse_Policy() {}

void OAIDescribePolicyResponse_Policy::initializeModel() {
...
void OAIDescribePolicyResponse_Policy::fromJson(QString jsonString) {
...
void OAIDescribePolicyResponse_Policy::fromJsonObject(QJsonObject json) {
...
QString OAIDescribePolicyResponse_Policy::asJson() const {
...
QJsonObject OAIDescribePolicyResponse_Policy::asJsonObject() const {
    QJsonObject obj;
...
OAIPolicy_PolicySummary OAIDescribePolicyResponse_Policy::getPolicySummary() const {
    return m_policy_summary;
}
void OAIDescribePolicyResponse_Policy::setPolicySummary(const OAIPolicy_PolicySummary &policy_summary) {
    m_policy_summary = policy_summary;
    m_policy_summary_isSet = true;
}

bool OAIDescribePolicyResponse_Policy::is_policy_summary_Set() const{
    return m_policy_summary_isSet;
}

bool OAIDescribePolicyResponse_Policy::is_policy_summary_Valid() const{
    return m_policy_summary_isValid;
}

QString OAIDescribePolicyResponse_Policy::getContent() const {
    return m_content;
}
void OAIDescribePolicyResponse_Policy::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIDescribePolicyResponse_Policy::is_content_Set() const{
    return m_content_isSet;
}

bool OAIDescribePolicyResponse_Policy::is_content_Valid() const{
    return m_content_isValid;
}

bool OAIDescribePolicyResponse_Policy::isSet() const {
...
bool OAIDescribePolicyResponse_Policy::isValid() const {
