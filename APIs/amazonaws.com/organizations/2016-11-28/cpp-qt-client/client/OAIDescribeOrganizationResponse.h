...
/*
 * OAIDescribeOrganizationResponse.h
 *
 * 
 */

#ifndef OAIDescribeOrganizationResponse_H
#define OAIDescribeOrganizationResponse_H

#include <QJsonObject>

#include "OAIDescribeOrganizationResponse_Organization.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDescribeOrganizationResponse_Organization;

class OAIDescribeOrganizationResponse : public OAIObject {
public:
    OAIDescribeOrganizationResponse();
    OAIDescribeOrganizationResponse(QString json);
    ~OAIDescribeOrganizationResponse() override;
    ...
    OAIDescribeOrganizationResponse_Organization getOrganization() const;
    void setOrganization(const OAIDescribeOrganizationResponse_Organization &organization);
...
private:
    ...
    OAIDescribeOrganizationResponse_Organization m_organization;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeOrganizationResponse)

#endif // OAIDescribeOrganizationResponse_H
