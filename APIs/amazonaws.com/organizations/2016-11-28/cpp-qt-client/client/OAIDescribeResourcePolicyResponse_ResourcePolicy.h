...
/*
 * OAIDescribeResourcePolicyResponse_ResourcePolicy.h
 *
 * 
 */

#ifndef OAIDescribeResourcePolicyResponse_ResourcePolicy_H
#define OAIDescribeResourcePolicyResponse_ResourcePolicy_H

#include <QJsonObject>

#include "OAIResourcePolicy_ResourcePolicySummary.h"
#include <QString>
...
namespace OpenAPI {
class OAIResourcePolicy_ResourcePolicySummary;

class OAIDescribeResourcePolicyResponse_ResourcePolicy : public OAIObject {
public:
    OAIDescribeResourcePolicyResponse_ResourcePolicy();
    OAIDescribeResourcePolicyResponse_ResourcePolicy(QString json);
    ~OAIDescribeResourcePolicyResponse_ResourcePolicy() override;
    ...
    OAIResourcePolicy_ResourcePolicySummary getResourcePolicySummary() const;
    void setResourcePolicySummary(const OAIResourcePolicy_ResourcePolicySummary &resource_policy_summary);
    bool is_resource_policy_summary_Set() const;
    bool is_resource_policy_summary_Valid() const;
...
private:
    ...
    OAIResourcePolicy_ResourcePolicySummary m_resource_policy_summary;
    bool m_resource_policy_summary_isSet;
    bool m_resource_policy_summary_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeResourcePolicyResponse_ResourcePolicy)

#endif // OAIDescribeResourcePolicyResponse_ResourcePolicy_H
