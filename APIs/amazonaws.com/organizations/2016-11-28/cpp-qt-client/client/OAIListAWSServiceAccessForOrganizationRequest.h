...
/*
 * OAIListAWSServiceAccessForOrganizationRequest.h
 *
 * 
 */

#ifndef OAIListAWSServiceAccessForOrganizationRequest_H
#define OAIListAWSServiceAccessForOrganizationRequest_H
...
class OAIListAWSServiceAccessForOrganizationRequest : public OAIObject {
public:
    OAIListAWSServiceAccessForOrganizationRequest();
    OAIListAWSServiceAccessForOrganizationRequest(QString json);
    ~OAIListAWSServiceAccessForOrganizationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAWSServiceAccessForOrganizationRequest)

#endif // OAIListAWSServiceAccessForOrganizationRequest_H
