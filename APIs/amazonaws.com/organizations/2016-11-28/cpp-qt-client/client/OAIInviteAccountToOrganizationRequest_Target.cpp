...
#include "OAIInviteAccountToOrganizationRequest_Target.h"
...
OAIInviteAccountToOrganizationRequest_Target::OAIInviteAccountToOrganizationRequest_Target(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInviteAccountToOrganizationRequest_Target::OAIInviteAccountToOrganizationRequest_Target() {
    this->initializeModel();
}

OAIInviteAccountToOrganizationRequest_Target::~OAIInviteAccountToOrganizationRequest_Target() {}

void OAIInviteAccountToOrganizationRequest_Target::initializeModel() {
...
void OAIInviteAccountToOrganizationRequest_Target::fromJson(QString jsonString) {
...
void OAIInviteAccountToOrganizationRequest_Target::fromJsonObject(QJsonObject json) {
...
QString OAIInviteAccountToOrganizationRequest_Target::asJson() const {
...
QJsonObject OAIInviteAccountToOrganizationRequest_Target::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIInviteAccountToOrganizationRequest_Target::getId() const {
    return m_id;
}
void OAIInviteAccountToOrganizationRequest_Target::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIInviteAccountToOrganizationRequest_Target::is_id_Set() const{
    return m_id_isSet;
}

bool OAIInviteAccountToOrganizationRequest_Target::is_id_Valid() const{
    return m_id_isValid;
}

OAIHandshakePartyType OAIInviteAccountToOrganizationRequest_Target::getType() const {
    return m_type;
}
void OAIInviteAccountToOrganizationRequest_Target::setType(const OAIHandshakePartyType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIInviteAccountToOrganizationRequest_Target::is_type_Set() const{
    return m_type_isSet;
}

bool OAIInviteAccountToOrganizationRequest_Target::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIInviteAccountToOrganizationRequest_Target::isSet() const {
...
bool OAIInviteAccountToOrganizationRequest_Target::isValid() const {
