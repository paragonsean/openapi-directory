...
/*
 * OAIUpdateOrganizationalUnitRequest.h
 *
 * 
 */

#ifndef OAIUpdateOrganizationalUnitRequest_H
#define OAIUpdateOrganizationalUnitRequest_H
...
class OAIUpdateOrganizationalUnitRequest : public OAIObject {
public:
    OAIUpdateOrganizationalUnitRequest();
    OAIUpdateOrganizationalUnitRequest(QString json);
    ~OAIUpdateOrganizationalUnitRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOrganizationalUnitRequest)

#endif // OAIUpdateOrganizationalUnitRequest_H
