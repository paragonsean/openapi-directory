...
void OAIActionType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("INVITE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionType::INVITE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ENABLE_ALL_FEATURES", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionType::ENABLE_ALL_FEATURES;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("APPROVE_ALL_FEATURES", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionType::APPROVE_ALL_FEATURES;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ADD_ORGANIZATIONS_SERVICE_LINKED_ROLE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionType::ADD_ORGANIZATIONS_SERVICE_LINKED_ROLE;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIActionType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIActionType::INVITE:
            val = "INVITE";
            break;
        case eOAIActionType::ENABLE_ALL_FEATURES:
            val = "ENABLE_ALL_FEATURES";
            break;
        case eOAIActionType::APPROVE_ALL_FEATURES:
            val = "APPROVE_ALL_FEATURES";
            break;
        case eOAIActionType::ADD_ORGANIZATIONS_SERVICE_LINKED_ROLE:
            val = "ADD_ORGANIZATIONS_SERVICE_LINKED_ROLE";
            break;
        default:
            break;
    }
