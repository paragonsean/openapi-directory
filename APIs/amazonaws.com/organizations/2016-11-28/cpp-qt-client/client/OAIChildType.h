...
#ifndef OAIChildType_H
#define OAIChildType_H
...
class OAIChildType : public OAIEnum {
public:
    OAIChildType();
    OAIChildType(QString json);
    ~OAIChildType() override;
    ...
    enum class eOAIChildType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACCOUNT, 
        ORGANIZATIONAL_UNIT
    };
    OAIChildType::eOAIChildType getValue() const;
    void setValue(const OAIChildType::eOAIChildType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIChildType)

#endif // OAIChildType_H
