...
/*
 * OAIListRootsRequest.h
 *
 * 
 */

#ifndef OAIListRootsRequest_H
#define OAIListRootsRequest_H
...
class OAIListRootsRequest : public OAIObject {
public:
    OAIListRootsRequest();
    OAIListRootsRequest(QString json);
    ~OAIListRootsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRootsRequest)

#endif // OAIListRootsRequest_H
