...
OAIListCreateAccountStatusRequest::OAIListCreateAccountStatusRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListCreateAccountStatusRequest::OAIListCreateAccountStatusRequest() {
    this->initializeModel();
}

OAIListCreateAccountStatusRequest::~OAIListCreateAccountStatusRequest() {}

void OAIListCreateAccountStatusRequest::initializeModel() {
...
void OAIListCreateAccountStatusRequest::fromJson(QString jsonString) {
...
void OAIListCreateAccountStatusRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListCreateAccountStatusRequest::asJson() const {
...
QJsonObject OAIListCreateAccountStatusRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_states.isSet()) {
...
QList OAIListCreateAccountStatusRequest::getStates() const {
    return m_states;
}
void OAIListCreateAccountStatusRequest::setStates(const QList &states) {
    m_states = states;
    m_states_isSet = true;
}

bool OAIListCreateAccountStatusRequest::is_states_Set() const{
    return m_states_isSet;
}

bool OAIListCreateAccountStatusRequest::is_states_Valid() const{
    return m_states_isValid;
}

QString OAIListCreateAccountStatusRequest::getNextToken() const {
    return m_next_token;
}
void OAIListCreateAccountStatusRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListCreateAccountStatusRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListCreateAccountStatusRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListCreateAccountStatusRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListCreateAccountStatusRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListCreateAccountStatusRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListCreateAccountStatusRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListCreateAccountStatusRequest::isSet() const {
...
bool OAIListCreateAccountStatusRequest::isValid() const {
