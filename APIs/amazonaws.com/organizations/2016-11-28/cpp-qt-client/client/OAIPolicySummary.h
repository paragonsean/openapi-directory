...
#ifndef OAIPolicySummary_H
#define OAIPolicySummary_H
...
class OAIPolicySummary : public OAIObject {
public:
    OAIPolicySummary();
    OAIPolicySummary(QString json);
    ~OAIPolicySummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicySummary)

#endif // OAIPolicySummary_H
