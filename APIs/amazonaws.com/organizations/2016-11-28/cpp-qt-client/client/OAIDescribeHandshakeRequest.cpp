...
OAIDescribeHandshakeRequest::OAIDescribeHandshakeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeHandshakeRequest::OAIDescribeHandshakeRequest() {
    this->initializeModel();
}

OAIDescribeHandshakeRequest::~OAIDescribeHandshakeRequest() {}

void OAIDescribeHandshakeRequest::initializeModel() {

    m_handshake_id_isSet = false;
    m_handshake_id_isValid = false;
}

void OAIDescribeHandshakeRequest::fromJson(QString jsonString) {
...
void OAIDescribeHandshakeRequest::fromJsonObject(QJsonObject json) {

    m_handshake_id_isValid = ::OpenAPI::fromJsonValue(m_handshake_id, json[QString("HandshakeId")]);
    m_handshake_id_isSet = !json[QString("HandshakeId")].isNull() && m_handshake_id_isValid;
}

QString OAIDescribeHandshakeRequest::asJson() const {
...
QJsonObject OAIDescribeHandshakeRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_handshake_id_isSet) {
        obj.insert(QString("HandshakeId"), ::OpenAPI::toJsonValue(m_handshake_id));
    }
    return obj;
}

QString OAIDescribeHandshakeRequest::getHandshakeId() const {
    return m_handshake_id;
}
void OAIDescribeHandshakeRequest::setHandshakeId(const QString &handshake_id) {
    m_handshake_id = handshake_id;
    m_handshake_id_isSet = true;
}

bool OAIDescribeHandshakeRequest::is_handshake_id_Set() const{
    return m_handshake_id_isSet;
}

bool OAIDescribeHandshakeRequest::is_handshake_id_Valid() const{
    return m_handshake_id_isValid;
}

bool OAIDescribeHandshakeRequest::isSet() const {
...
bool OAIDescribeHandshakeRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_handshake_id_isValid && true;
}
