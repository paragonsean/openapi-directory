...
OAIDescribeAccountRequest::OAIDescribeAccountRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAccountRequest::OAIDescribeAccountRequest() {
    this->initializeModel();
}

OAIDescribeAccountRequest::~OAIDescribeAccountRequest() {}

void OAIDescribeAccountRequest::initializeModel() {

    m_account_id_isSet = false;
    m_account_id_isValid = false;
}

void OAIDescribeAccountRequest::fromJson(QString jsonString) {
...
void OAIDescribeAccountRequest::fromJsonObject(QJsonObject json) {

    m_account_id_isValid = ::OpenAPI::fromJsonValue(m_account_id, json[QString("AccountId")]);
    m_account_id_isSet = !json[QString("AccountId")].isNull() && m_account_id_isValid;
}

QString OAIDescribeAccountRequest::asJson() const {
...
QJsonObject OAIDescribeAccountRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeAccountRequest::getAccountId() const {
    return m_account_id;
}
void OAIDescribeAccountRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIDescribeAccountRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIDescribeAccountRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

bool OAIDescribeAccountRequest::isSet() const {
...
bool OAIDescribeAccountRequest::isValid() const {
