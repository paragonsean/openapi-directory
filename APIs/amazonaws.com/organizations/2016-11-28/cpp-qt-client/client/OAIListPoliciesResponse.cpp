...
QList OAIListPoliciesResponse::getPolicies() const {
    return m_policies;
}
void OAIListPoliciesResponse::setPolicies(const QList &policies) {
    m_policies = policies;
    m_policies_isSet = true;
}

bool OAIListPoliciesResponse::is_policies_Set() const{
    return m_policies_isSet;
}

bool OAIListPoliciesResponse::is_policies_Valid() const{
    return m_policies_isValid;
}

QString OAIListPoliciesResponse::getNextToken() const {
    return m_next_token;
}
void OAIListPoliciesResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPoliciesResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPoliciesResponse::is_next_token_Valid() const{
