...
OAICancelHandshakeResponse::OAICancelHandshakeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICancelHandshakeResponse::OAICancelHandshakeResponse() {
    this->initializeModel();
}

OAICancelHandshakeResponse::~OAICancelHandshakeResponse() {}

void OAICancelHandshakeResponse::initializeModel() {

    m_handshake_isSet = false;
    m_handshake_isValid = false;
}

void OAICancelHandshakeResponse::fromJson(QString jsonString) {
...
void OAICancelHandshakeResponse::fromJsonObject(QJsonObject json) {
...
QString OAICancelHandshakeResponse::asJson() const {
...
QJsonObject OAICancelHandshakeResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICancelHandshakeResponse_Handshake OAICancelHandshakeResponse::getHandshake() const {
    return m_handshake;
}
void OAICancelHandshakeResponse::setHandshake(const OAICancelHandshakeResponse_Handshake &handshake) {
    m_handshake = handshake;
    m_handshake_isSet = true;
}

bool OAICancelHandshakeResponse::is_handshake_Set() const{
    return m_handshake_isSet;
}

bool OAICancelHandshakeResponse::is_handshake_Valid() const{
    return m_handshake_isValid;
}

bool OAICancelHandshakeResponse::isSet() const {
...
bool OAICancelHandshakeResponse::isValid() const {
