...
/*
 * OAIRemoveAccountFromOrganizationRequest.h
 *
 * 
 */

#ifndef OAIRemoveAccountFromOrganizationRequest_H
#define OAIRemoveAccountFromOrganizationRequest_H
...
class OAIRemoveAccountFromOrganizationRequest : public OAIObject {
public:
    OAIRemoveAccountFromOrganizationRequest();
    OAIRemoveAccountFromOrganizationRequest(QString json);
    ~OAIRemoveAccountFromOrganizationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveAccountFromOrganizationRequest)

#endif // OAIRemoveAccountFromOrganizationRequest_H
