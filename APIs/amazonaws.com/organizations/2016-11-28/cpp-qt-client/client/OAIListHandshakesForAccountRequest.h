...
/*
 * OAIListHandshakesForAccountRequest.h
 *
 * 
 */

#ifndef OAIListHandshakesForAccountRequest_H
#define OAIListHandshakesForAccountRequest_H
...
namespace OpenAPI {
class OAIListHandshakesForAccountRequest_Filter;

class OAIListHandshakesForAccountRequest : public OAIObject {
public:
    OAIListHandshakesForAccountRequest();
    OAIListHandshakesForAccountRequest(QString json);
    ~OAIListHandshakesForAccountRequest() override;
    ...
    OAIListHandshakesForAccountRequest_Filter getFilter() const;
    void setFilter(const OAIListHandshakesForAccountRequest_Filter &filter);
...
private:
    ...
    OAIListHandshakesForAccountRequest_Filter m_filter;
    bool m_filter_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHandshakesForAccountRequest)

#endif // OAIListHandshakesForAccountRequest_H
