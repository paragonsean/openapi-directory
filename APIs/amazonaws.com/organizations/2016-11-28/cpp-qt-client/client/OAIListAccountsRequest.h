...
/*
 * OAIListAccountsRequest.h
 *
 * 
 */

#ifndef OAIListAccountsRequest_H
#define OAIListAccountsRequest_H
...
class OAIListAccountsRequest : public OAIObject {
public:
    OAIListAccountsRequest();
    OAIListAccountsRequest(QString json);
    ~OAIListAccountsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAccountsRequest)

#endif // OAIListAccountsRequest_H
