...
/*
 * OAIAcceptHandshakeRequest.h
 *
 * 
 */

#ifndef OAIAcceptHandshakeRequest_H
#define OAIAcceptHandshakeRequest_H
...
class OAIAcceptHandshakeRequest : public OAIObject {
public:
    OAIAcceptHandshakeRequest();
    OAIAcceptHandshakeRequest(QString json);
    ~OAIAcceptHandshakeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcceptHandshakeRequest)

#endif // OAIAcceptHandshakeRequest_H
