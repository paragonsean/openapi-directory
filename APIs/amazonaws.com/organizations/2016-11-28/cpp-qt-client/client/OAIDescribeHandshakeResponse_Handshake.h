...
/*
 * OAIDescribeHandshakeResponse_Handshake.h
 *
 * 
 */

#ifndef OAIDescribeHandshakeResponse_Handshake_H
#define OAIDescribeHandshakeResponse_Handshake_H

#include <QJsonObject>

#include "OAIActionType.h"
#include "OAIHandshakeState.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIDescribeHandshakeResponse_Handshake : public OAIObject {
public:
    OAIDescribeHandshakeResponse_Handshake();
    OAIDescribeHandshakeResponse_Handshake(QString json);
    ~OAIDescribeHandshakeResponse_Handshake() override;
    ...
    QList getParties() const;
    void setParties(const QList &parties);
    bool is_parties_Set() const;
    bool is_parties_Valid() const;

    OAIHandshakeState getState() const;
    void setState(const OAIHandshakeState &state);
    ...
    QDateTime getExpirationTimestamp() const;
    void setExpirationTimestamp(const QDateTime &expiration_timestamp);
    bool is_expiration_timestamp_Set() const;
    bool is_expiration_timestamp_Valid() const;
...
private:
    ...
    QDateTime m_expiration_timestamp;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeHandshakeResponse_Handshake)

#endif // OAIDescribeHandshakeResponse_Handshake_H
