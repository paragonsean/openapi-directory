...
OAIHandshake::OAIHandshake(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHandshake::OAIHandshake() {
    this->initializeModel();
}

OAIHandshake::~OAIHandshake() {}

void OAIHandshake::initializeModel() {
...
void OAIHandshake::fromJson(QString jsonString) {
...
void OAIHandshake::fromJsonObject(QJsonObject json) {
...
QString OAIHandshake::asJson() const {
...
QJsonObject OAIHandshake::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIHandshake::getId() const {
    return m_id;
}
void OAIHandshake::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIHandshake::is_id_Set() const{
    return m_id_isSet;
}

bool OAIHandshake::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIHandshake::getArn() const {
    return m_arn;
}
void OAIHandshake::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIHandshake::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIHandshake::is_arn_Valid() const{
    return m_arn_isValid;
}

QList OAIHandshake::getParties() const {
    return m_parties;
}
void OAIHandshake::setParties(const QList &parties) {
    m_parties = parties;
    m_parties_isSet = true;
}

bool OAIHandshake::is_parties_Set() const{
    return m_parties_isSet;
}

bool OAIHandshake::is_parties_Valid() const{
    return m_parties_isValid;
}

OAIHandshakeState OAIHandshake::getState() const {
    return m_state;
}
void OAIHandshake::setState(const OAIHandshakeState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIHandshake::is_state_Set() const{
    return m_state_isSet;
}

bool OAIHandshake::is_state_Valid() const{
    return m_state_isValid;
}

QDateTime OAIHandshake::getRequestedTimestamp() const {
    return m_requested_timestamp;
}
void OAIHandshake::setRequestedTimestamp(const QDateTime &requested_timestamp) {
    m_requested_timestamp = requested_timestamp;
    m_requested_timestamp_isSet = true;
}

bool OAIHandshake::is_requested_timestamp_Set() const{
    return m_requested_timestamp_isSet;
}

bool OAIHandshake::is_requested_timestamp_Valid() const{
    return m_requested_timestamp_isValid;
}

QDateTime OAIHandshake::getExpirationTimestamp() const {
    return m_expiration_timestamp;
}
void OAIHandshake::setExpirationTimestamp(const QDateTime &expiration_timestamp) {
    m_expiration_timestamp = expiration_timestamp;
    m_expiration_timestamp_isSet = true;
}

bool OAIHandshake::is_expiration_timestamp_Set() const{
    return m_expiration_timestamp_isSet;
}

bool OAIHandshake::is_expiration_timestamp_Valid() const{
    return m_expiration_timestamp_isValid;
}

OAIActionType OAIHandshake::getAction() const {
    return m_action;
}
void OAIHandshake::setAction(const OAIActionType &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIHandshake::is_action_Set() const{
    return m_action_isSet;
}

bool OAIHandshake::is_action_Valid() const{
    return m_action_isValid;
}

QList OAIHandshake::getResources() const {
    return m_resources;
}
void OAIHandshake::setResources(const QList &resources) {
    m_resources = resources;
    m_resources_isSet = true;
}

bool OAIHandshake::is_resources_Set() const{
    return m_resources_isSet;
}

bool OAIHandshake::is_resources_Valid() const{
    return m_resources_isValid;
}

bool OAIHandshake::isSet() const {
...
bool OAIHandshake::isValid() const {
