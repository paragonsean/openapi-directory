...
/*
 * OAIUpdatePolicyRequest.h
 *
 * 
 */

#ifndef OAIUpdatePolicyRequest_H
#define OAIUpdatePolicyRequest_H
...
class OAIUpdatePolicyRequest : public OAIObject {
public:
    OAIUpdatePolicyRequest();
    OAIUpdatePolicyRequest(QString json);
    ~OAIUpdatePolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePolicyRequest)

#endif // OAIUpdatePolicyRequest_H
