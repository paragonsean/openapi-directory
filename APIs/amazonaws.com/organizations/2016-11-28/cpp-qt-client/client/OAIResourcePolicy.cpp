...
OAIResourcePolicy_ResourcePolicySummary OAIResourcePolicy::getResourcePolicySummary() const {
    return m_resource_policy_summary;
}
void OAIResourcePolicy::setResourcePolicySummary(const OAIResourcePolicy_ResourcePolicySummary &resource_policy_summary) {
    m_resource_policy_summary = resource_policy_summary;
    m_resource_policy_summary_isSet = true;
}

bool OAIResourcePolicy::is_resource_policy_summary_Set() const{
    return m_resource_policy_summary_isSet;
}

bool OAIResourcePolicy::is_resource_policy_summary_Valid() const{
    return m_resource_policy_summary_isValid;
}

QString OAIResourcePolicy::getContent() const {
    return m_content;
}
void OAIResourcePolicy::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIResourcePolicy::is_content_Set() const{
    return m_content_isSet;
}

bool OAIResourcePolicy::is_content_Valid() const{
