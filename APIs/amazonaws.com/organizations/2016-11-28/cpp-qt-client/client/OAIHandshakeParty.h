...
#ifndef OAIHandshakeParty_H
#define OAIHandshakeParty_H
...
class OAIHandshakeParty : public OAIObject {
public:
    OAIHandshakeParty();
    OAIHandshakeParty(QString json);
    ~OAIHandshakeParty() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHandshakeParty)

#endif // OAIHandshakeParty_H
