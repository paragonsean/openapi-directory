...
/*
 * OAIListChildrenResponse.h
 *
 * 
 */

#ifndef OAIListChildrenResponse_H
#define OAIListChildrenResponse_H
...
class OAIListChildrenResponse : public OAIObject {
public:
    OAIListChildrenResponse();
    OAIListChildrenResponse(QString json);
    ~OAIListChildrenResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListChildrenResponse)

#endif // OAIListChildrenResponse_H
