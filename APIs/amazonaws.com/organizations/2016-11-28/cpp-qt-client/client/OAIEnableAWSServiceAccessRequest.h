...
/*
 * OAIEnableAWSServiceAccessRequest.h
 *
 * 
 */

#ifndef OAIEnableAWSServiceAccessRequest_H
#define OAIEnableAWSServiceAccessRequest_H
...
class OAIEnableAWSServiceAccessRequest : public OAIObject {
public:
    OAIEnableAWSServiceAccessRequest();
    OAIEnableAWSServiceAccessRequest(QString json);
    ~OAIEnableAWSServiceAccessRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnableAWSServiceAccessRequest)

#endif // OAIEnableAWSServiceAccessRequest_H
