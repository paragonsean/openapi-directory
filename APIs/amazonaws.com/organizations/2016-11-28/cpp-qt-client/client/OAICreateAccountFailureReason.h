...
/*
 * OAICreateAccountFailureReason.h
 *
 * 
 */

#ifndef OAICreateAccountFailureReason_H
#define OAICreateAccountFailureReason_H
...
class OAICreateAccountFailureReason : public OAIEnum {
public:
    OAICreateAccountFailureReason();
    OAICreateAccountFailureReason(QString json);
    ~OAICreateAccountFailureReason() override;
    ...
    enum class eOAICreateAccountFailureReason {
    ...
    OAICreateAccountFailureReason::eOAICreateAccountFailureReason getValue() const;
    void setValue(const OAICreateAccountFailureReason::eOAICreateAccountFailureReason& value);
...
private:
    ...
    eOAICreateAccountFailureReason m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccountFailureReason)

#endif // OAICreateAccountFailureReason_H
