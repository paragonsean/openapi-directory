...
OAIEnableAllFeaturesResponse::OAIEnableAllFeaturesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnableAllFeaturesResponse::OAIEnableAllFeaturesResponse() {
    this->initializeModel();
}

OAIEnableAllFeaturesResponse::~OAIEnableAllFeaturesResponse() {}

void OAIEnableAllFeaturesResponse::initializeModel() {

    m_handshake_isSet = false;
    m_handshake_isValid = false;
}

void OAIEnableAllFeaturesResponse::fromJson(QString jsonString) {
...
void OAIEnableAllFeaturesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIEnableAllFeaturesResponse::asJson() const {
...
QJsonObject OAIEnableAllFeaturesResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIEnableAllFeaturesResponse_Handshake OAIEnableAllFeaturesResponse::getHandshake() const {
    return m_handshake;
}
void OAIEnableAllFeaturesResponse::setHandshake(const OAIEnableAllFeaturesResponse_Handshake &handshake) {
    m_handshake = handshake;
    m_handshake_isSet = true;
}

bool OAIEnableAllFeaturesResponse::is_handshake_Set() const{
    return m_handshake_isSet;
}

bool OAIEnableAllFeaturesResponse::is_handshake_Valid() const{
    return m_handshake_isValid;
}

bool OAIEnableAllFeaturesResponse::isSet() const {
...
bool OAIEnableAllFeaturesResponse::isValid() const {
