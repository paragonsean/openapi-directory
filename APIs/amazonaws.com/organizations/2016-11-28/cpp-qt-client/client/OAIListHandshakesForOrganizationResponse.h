...
/*
 * OAIListHandshakesForOrganizationResponse.h
 *
 * 
 */

#ifndef OAIListHandshakesForOrganizationResponse_H
#define OAIListHandshakesForOrganizationResponse_H
...
class OAIListHandshakesForOrganizationResponse : public OAIObject {
public:
    OAIListHandshakesForOrganizationResponse();
    OAIListHandshakesForOrganizationResponse(QString json);
    ~OAIListHandshakesForOrganizationResponse() override;
    ...
    QList getHandshakes() const;
    void setHandshakes(const QList &handshakes);
    bool is_handshakes_Set() const;
    bool is_handshakes_Valid() const;
...
private:
    ...
    QList m_handshakes;
    bool m_handshakes_isSet;
    bool m_handshakes_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHandshakesForOrganizationResponse)

#endif // OAIListHandshakesForOrganizationResponse_H
