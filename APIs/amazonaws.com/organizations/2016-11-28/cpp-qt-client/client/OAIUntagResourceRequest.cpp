...
QString OAIUntagResourceRequest::getResourceId() const {
    return m_resource_id;
}
void OAIUntagResourceRequest::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIUntagResourceRequest::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIUntagResourceRequest::is_resource_id_Valid() const{
