...
/*
 * OAIPolicyTargetSummary.h
 *
 * Contains information about a root, OU, or account that a policy is attached to.
 */

#ifndef OAIPolicyTargetSummary_H
#define OAIPolicyTargetSummary_H
...
class OAIPolicyTargetSummary : public OAIObject {
public:
    OAIPolicyTargetSummary();
    OAIPolicyTargetSummary(QString json);
    ~OAIPolicyTargetSummary() override;
    ...
    OAITargetType getType() const;
    void setType(const OAITargetType &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyTargetSummary)

#endif // OAIPolicyTargetSummary_H
