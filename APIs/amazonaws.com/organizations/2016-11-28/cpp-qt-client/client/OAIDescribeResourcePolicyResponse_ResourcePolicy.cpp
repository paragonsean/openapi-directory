...
OAIDescribeResourcePolicyResponse_ResourcePolicy::OAIDescribeResourcePolicyResponse_ResourcePolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeResourcePolicyResponse_ResourcePolicy::OAIDescribeResourcePolicyResponse_ResourcePolicy() {
    this->initializeModel();
}

OAIDescribeResourcePolicyResponse_ResourcePolicy::~OAIDescribeResourcePolicyResponse_ResourcePolicy() {}

void OAIDescribeResourcePolicyResponse_ResourcePolicy::initializeModel() {

    m_resource_policy_summary_isSet = false;
    m_resource_policy_summary_isValid = false;

    m_content_isSet = false;
    m_content_isValid = false;
}

void OAIDescribeResourcePolicyResponse_ResourcePolicy::fromJson(QString jsonString) {
...
void OAIDescribeResourcePolicyResponse_ResourcePolicy::fromJsonObject(QJsonObject json) {

    m_resource_policy_summary_isValid = ::OpenAPI::fromJsonValue(m_resource_policy_summary, json[QString("ResourcePolicySummary")]);
    m_resource_policy_summary_isSet = !json[QString("ResourcePolicySummary")].isNull() && m_resource_policy_summary_isValid;

    m_content_isValid = ::OpenAPI::fromJsonValue(m_content, json[QString("Content")]);
    m_content_isSet = !json[QString("Content")].isNull() && m_content_isValid;
}

QString OAIDescribeResourcePolicyResponse_ResourcePolicy::asJson() const {
...
QJsonObject OAIDescribeResourcePolicyResponse_ResourcePolicy::asJsonObject() const {
    QJsonObject obj;
    if (m_resource_policy_summary.isSet()) {
        obj.insert(QString("ResourcePolicySummary"), ::OpenAPI::toJsonValue(m_resource_policy_summary));
    }
    if (m_content_isSet) {
...
OAIResourcePolicy_ResourcePolicySummary OAIDescribeResourcePolicyResponse_ResourcePolicy::getResourcePolicySummary() const {
    return m_resource_policy_summary;
}
void OAIDescribeResourcePolicyResponse_ResourcePolicy::setResourcePolicySummary(const OAIResourcePolicy_ResourcePolicySummary &resource_policy_summary) {
    m_resource_policy_summary = resource_policy_summary;
    m_resource_policy_summary_isSet = true;
}

bool OAIDescribeResourcePolicyResponse_ResourcePolicy::is_resource_policy_summary_Set() const{
    return m_resource_policy_summary_isSet;
}

bool OAIDescribeResourcePolicyResponse_ResourcePolicy::is_resource_policy_summary_Valid() const{
    return m_resource_policy_summary_isValid;
}

QString OAIDescribeResourcePolicyResponse_ResourcePolicy::getContent() const {
    return m_content;
}
void OAIDescribeResourcePolicyResponse_ResourcePolicy::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIDescribeResourcePolicyResponse_ResourcePolicy::is_content_Set() const{
    return m_content_isSet;
}

bool OAIDescribeResourcePolicyResponse_ResourcePolicy::is_content_Valid() const{
    return m_content_isValid;
}

bool OAIDescribeResourcePolicyResponse_ResourcePolicy::isSet() const {
...
bool OAIDescribeResourcePolicyResponse_ResourcePolicy::isValid() const {
