...
#include "OAICreateAccountResponse_CreateAccountStatus.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateAccountResponse_CreateAccountStatus;
...
public:
    ...
    OAICreateAccountResponse_CreateAccountStatus getCreateAccountStatus() const;
    void setCreateAccountStatus(const OAICreateAccountResponse_CreateAccountStatus &create_account_status);
    bool is_create_account_status_Set() const;
    bool is_create_account_status_Valid() const;
...
private:
    ...
    OAICreateAccountResponse_CreateAccountStatus m_create_account_status;
    bool m_create_account_status_isSet;
    bool m_create_account_status_isValid;
};
