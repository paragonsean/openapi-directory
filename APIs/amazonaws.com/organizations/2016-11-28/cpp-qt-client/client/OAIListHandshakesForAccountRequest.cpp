...
OAIListHandshakesForAccountRequest::OAIListHandshakesForAccountRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListHandshakesForAccountRequest::OAIListHandshakesForAccountRequest() {
    this->initializeModel();
}

OAIListHandshakesForAccountRequest::~OAIListHandshakesForAccountRequest() {}

void OAIListHandshakesForAccountRequest::initializeModel() {
...
void OAIListHandshakesForAccountRequest::fromJson(QString jsonString) {
...
void OAIListHandshakesForAccountRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListHandshakesForAccountRequest::asJson() const {
...
QJsonObject OAIListHandshakesForAccountRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_filter.isSet()) {
...
OAIListHandshakesForAccountRequest_Filter OAIListHandshakesForAccountRequest::getFilter() const {
    return m_filter;
}
void OAIListHandshakesForAccountRequest::setFilter(const OAIListHandshakesForAccountRequest_Filter &filter) {
    m_filter = filter;
    m_filter_isSet = true;
}

bool OAIListHandshakesForAccountRequest::is_filter_Set() const{
    return m_filter_isSet;
}

bool OAIListHandshakesForAccountRequest::is_filter_Valid() const{
    return m_filter_isValid;
}

QString OAIListHandshakesForAccountRequest::getNextToken() const {
    return m_next_token;
}
void OAIListHandshakesForAccountRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListHandshakesForAccountRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListHandshakesForAccountRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListHandshakesForAccountRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListHandshakesForAccountRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListHandshakesForAccountRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListHandshakesForAccountRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListHandshakesForAccountRequest::isSet() const {
...
bool OAIListHandshakesForAccountRequest::isValid() const {
