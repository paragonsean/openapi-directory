...
/*
 * OAIDescribeAccountResponse.h
 *
 * 
 */

#ifndef OAIDescribeAccountResponse_H
#define OAIDescribeAccountResponse_H
...
namespace OpenAPI {
class OAIDescribeAccountResponse_Account;

class OAIDescribeAccountResponse : public OAIObject {
public:
    OAIDescribeAccountResponse();
    OAIDescribeAccountResponse(QString json);
    ~OAIDescribeAccountResponse() override;
    ...
    OAIDescribeAccountResponse_Account getAccount() const;
    void setAccount(const OAIDescribeAccountResponse_Account &account);
...
private:
    ...
    OAIDescribeAccountResponse_Account m_account;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccountResponse)

#endif // OAIDescribeAccountResponse_H
