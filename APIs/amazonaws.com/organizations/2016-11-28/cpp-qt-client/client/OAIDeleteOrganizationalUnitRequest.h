...
/*
 * OAIDeleteOrganizationalUnitRequest.h
 *
 * 
 */

#ifndef OAIDeleteOrganizationalUnitRequest_H
#define OAIDeleteOrganizationalUnitRequest_H
...
class OAIDeleteOrganizationalUnitRequest : public OAIObject {
public:
    OAIDeleteOrganizationalUnitRequest();
    OAIDeleteOrganizationalUnitRequest(QString json);
    ~OAIDeleteOrganizationalUnitRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteOrganizationalUnitRequest)

#endif // OAIDeleteOrganizationalUnitRequest_H
