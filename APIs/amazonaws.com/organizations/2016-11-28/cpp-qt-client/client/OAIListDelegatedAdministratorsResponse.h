...
/*
 * OAIListDelegatedAdministratorsResponse.h
 *
 * 
 */

#ifndef OAIListDelegatedAdministratorsResponse_H
#define OAIListDelegatedAdministratorsResponse_H
...
class OAIListDelegatedAdministratorsResponse : public OAIObject {
public:
    OAIListDelegatedAdministratorsResponse();
    OAIListDelegatedAdministratorsResponse(QString json);
    ~OAIListDelegatedAdministratorsResponse() override;
    ...
    QList getDelegatedAdministrators() const;
    void setDelegatedAdministrators(const QList &delegated_administrators);
    bool is_delegated_administrators_Set() const;
    bool is_delegated_administrators_Valid() const;
...
private:
    ...
    QList m_delegated_administrators;
    bool m_delegated_administrators_isSet;
    bool m_delegated_administrators_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDelegatedAdministratorsResponse)

#endif // OAIListDelegatedAdministratorsResponse_H
