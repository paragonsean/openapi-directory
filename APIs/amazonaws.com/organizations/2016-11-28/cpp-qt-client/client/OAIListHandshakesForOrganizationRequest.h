...
/*
 * OAIListHandshakesForOrganizationRequest.h
 *
 * 
 */

#ifndef OAIListHandshakesForOrganizationRequest_H
#define OAIListHandshakesForOrganizationRequest_H

#include <QJsonObject>

#include "OAIListHandshakesForOrganizationRequest_Filter.h"
#include <QString>
...
namespace OpenAPI {
class OAIListHandshakesForOrganizationRequest_Filter;

class OAIListHandshakesForOrganizationRequest : public OAIObject {
public:
    OAIListHandshakesForOrganizationRequest();
    OAIListHandshakesForOrganizationRequest(QString json);
    ~OAIListHandshakesForOrganizationRequest() override;
    ...
    OAIListHandshakesForOrganizationRequest_Filter getFilter() const;
    void setFilter(const OAIListHandshakesForOrganizationRequest_Filter &filter);
...
private:
    ...
    OAIListHandshakesForOrganizationRequest_Filter m_filter;
    bool m_filter_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHandshakesForOrganizationRequest)

#endif // OAIListHandshakesForOrganizationRequest_H
