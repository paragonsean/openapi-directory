...
OAIHandshakeParty::OAIHandshakeParty(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHandshakeParty::OAIHandshakeParty() {
    this->initializeModel();
}

OAIHandshakeParty::~OAIHandshakeParty() {}

void OAIHandshakeParty::initializeModel() {
...
void OAIHandshakeParty::fromJson(QString jsonString) {
...
void OAIHandshakeParty::fromJsonObject(QJsonObject json) {
...
QString OAIHandshakeParty::asJson() const {
...
QJsonObject OAIHandshakeParty::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIHandshakeParty::getId() const {
    return m_id;
}
void OAIHandshakeParty::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIHandshakeParty::is_id_Set() const{
    return m_id_isSet;
}

bool OAIHandshakeParty::is_id_Valid() const{
    return m_id_isValid;
}

OAIHandshakePartyType OAIHandshakeParty::getType() const {
    return m_type;
}
void OAIHandshakeParty::setType(const OAIHandshakePartyType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIHandshakeParty::is_type_Set() const{
    return m_type_isSet;
}

bool OAIHandshakeParty::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIHandshakeParty::isSet() const {
...
bool OAIHandshakeParty::isValid() const {
