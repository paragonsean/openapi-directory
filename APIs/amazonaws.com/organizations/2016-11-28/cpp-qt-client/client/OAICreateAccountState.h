...
/*
 * OAICreateAccountState.h
 *
 * 
 */

#ifndef OAICreateAccountState_H
#define OAICreateAccountState_H
...
class OAICreateAccountState : public OAIEnum {
public:
    OAICreateAccountState();
    OAICreateAccountState(QString json);
    ~OAICreateAccountState() override;
    ...
    enum class eOAICreateAccountState {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        IN_PROGRESS, 
        SUCCEEDED, 
        FAILED
    };
    OAICreateAccountState::eOAICreateAccountState getValue() const;
    void setValue(const OAICreateAccountState::eOAICreateAccountState& value);
...
private:
    ...
    eOAICreateAccountState m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccountState)

#endif // OAICreateAccountState_H
