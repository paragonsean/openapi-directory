...
/*
 * OAIDeregisterDelegatedAdministratorRequest.h
 *
 * 
 */

#ifndef OAIDeregisterDelegatedAdministratorRequest_H
#define OAIDeregisterDelegatedAdministratorRequest_H
...
class OAIDeregisterDelegatedAdministratorRequest : public OAIObject {
public:
    OAIDeregisterDelegatedAdministratorRequest();
    OAIDeregisterDelegatedAdministratorRequest(QString json);
    ~OAIDeregisterDelegatedAdministratorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeregisterDelegatedAdministratorRequest)

#endif // OAIDeregisterDelegatedAdministratorRequest_H
