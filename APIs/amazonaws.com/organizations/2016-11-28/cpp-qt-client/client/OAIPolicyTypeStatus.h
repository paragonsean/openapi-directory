...
/*
 * OAIPolicyTypeStatus.h
 *
 * 
 */

#ifndef OAIPolicyTypeStatus_H
#define OAIPolicyTypeStatus_H
...
class OAIPolicyTypeStatus : public OAIEnum {
public:
    OAIPolicyTypeStatus();
    OAIPolicyTypeStatus(QString json);
    ~OAIPolicyTypeStatus() override;
    ...
    enum class eOAIPolicyTypeStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ENABLED, 
        PENDING_ENABLE, 
        PENDING_DISABLE
    };
    OAIPolicyTypeStatus::eOAIPolicyTypeStatus getValue() const;
    void setValue(const OAIPolicyTypeStatus::eOAIPolicyTypeStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyTypeStatus)

#endif // OAIPolicyTypeStatus_H
