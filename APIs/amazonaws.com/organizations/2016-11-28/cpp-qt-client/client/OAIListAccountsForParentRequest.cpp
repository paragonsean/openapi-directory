...
OAIListAccountsForParentRequest::OAIListAccountsForParentRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAccountsForParentRequest::OAIListAccountsForParentRequest() {
    this->initializeModel();
}

OAIListAccountsForParentRequest::~OAIListAccountsForParentRequest() {}

void OAIListAccountsForParentRequest::initializeModel() {
...
void OAIListAccountsForParentRequest::fromJson(QString jsonString) {
...
void OAIListAccountsForParentRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListAccountsForParentRequest::asJson() const {
...
QJsonObject OAIListAccountsForParentRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListAccountsForParentRequest::getParentId() const {
    return m_parent_id;
}
void OAIListAccountsForParentRequest::setParentId(const QString &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAIListAccountsForParentRequest::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAIListAccountsForParentRequest::is_parent_id_Valid() const{
    return m_parent_id_isValid;
}

QString OAIListAccountsForParentRequest::getNextToken() const {
    return m_next_token;
}
void OAIListAccountsForParentRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAccountsForParentRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAccountsForParentRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListAccountsForParentRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListAccountsForParentRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListAccountsForParentRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListAccountsForParentRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListAccountsForParentRequest::isSet() const {
...
bool OAIListAccountsForParentRequest::isValid() const {
