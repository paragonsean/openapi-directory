...
/*
 * OAIIAMUserAccessToBilling.h
 *
 * 
 */

#ifndef OAIIAMUserAccessToBilling_H
#define OAIIAMUserAccessToBilling_H
...
class OAIIAMUserAccessToBilling : public OAIEnum {
public:
    OAIIAMUserAccessToBilling();
    OAIIAMUserAccessToBilling(QString json);
    ~OAIIAMUserAccessToBilling() override;
    ...
    enum class eOAIIAMUserAccessToBilling {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ALLOW, 
        DENY
    };
    OAIIAMUserAccessToBilling::eOAIIAMUserAccessToBilling getValue() const;
    void setValue(const OAIIAMUserAccessToBilling::eOAIIAMUserAccessToBilling& value);
...
private:
    ...
    eOAIIAMUserAccessToBilling m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIAMUserAccessToBilling)

#endif // OAIIAMUserAccessToBilling_H
