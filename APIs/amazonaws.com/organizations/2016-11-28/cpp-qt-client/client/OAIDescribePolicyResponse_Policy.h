...
/*
 * OAIDescribePolicyResponse_Policy.h
 *
 * 
 */

#ifndef OAIDescribePolicyResponse_Policy_H
#define OAIDescribePolicyResponse_Policy_H
...
class OAIDescribePolicyResponse_Policy : public OAIObject {
public:
    OAIDescribePolicyResponse_Policy();
    OAIDescribePolicyResponse_Policy(QString json);
    ~OAIDescribePolicyResponse_Policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePolicyResponse_Policy)

#endif // OAIDescribePolicyResponse_Policy_H
