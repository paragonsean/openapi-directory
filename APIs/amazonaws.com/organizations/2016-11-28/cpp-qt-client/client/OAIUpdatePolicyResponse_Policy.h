...
/*
 * OAIUpdatePolicyResponse_Policy.h
 *
 * 
 */

#ifndef OAIUpdatePolicyResponse_Policy_H
#define OAIUpdatePolicyResponse_Policy_H
...
class OAIUpdatePolicyResponse_Policy : public OAIObject {
public:
    OAIUpdatePolicyResponse_Policy();
    OAIUpdatePolicyResponse_Policy(QString json);
    ~OAIUpdatePolicyResponse_Policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePolicyResponse_Policy)

#endif // OAIUpdatePolicyResponse_Policy_H
