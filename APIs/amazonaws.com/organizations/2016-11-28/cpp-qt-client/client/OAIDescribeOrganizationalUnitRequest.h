...
/*
 * OAIDescribeOrganizationalUnitRequest.h
 *
 * 
 */

#ifndef OAIDescribeOrganizationalUnitRequest_H
#define OAIDescribeOrganizationalUnitRequest_H
...
class OAIDescribeOrganizationalUnitRequest : public OAIObject {
public:
    OAIDescribeOrganizationalUnitRequest();
    OAIDescribeOrganizationalUnitRequest(QString json);
    ~OAIDescribeOrganizationalUnitRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeOrganizationalUnitRequest)

#endif // OAIDescribeOrganizationalUnitRequest_H
