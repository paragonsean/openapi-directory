...
OAIListChildrenResponse::OAIListChildrenResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListChildrenResponse::OAIListChildrenResponse() {
    this->initializeModel();
}

OAIListChildrenResponse::~OAIListChildrenResponse() {}

void OAIListChildrenResponse::initializeModel() {
...
void OAIListChildrenResponse::fromJson(QString jsonString) {
...
void OAIListChildrenResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListChildrenResponse::asJson() const {
...
QJsonObject OAIListChildrenResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_children.isSet()) {
...
QList OAIListChildrenResponse::getChildren() const {
    return m_children;
}
void OAIListChildrenResponse::setChildren(const QList &children) {
    m_children = children;
    m_children_isSet = true;
}

bool OAIListChildrenResponse::is_children_Set() const{
    return m_children_isSet;
}

bool OAIListChildrenResponse::is_children_Valid() const{
    return m_children_isValid;
}

QString OAIListChildrenResponse::getNextToken() const {
    return m_next_token;
}
void OAIListChildrenResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListChildrenResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListChildrenResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListChildrenResponse::isSet() const {
...
bool OAIListChildrenResponse::isValid() const {
