...
OAIDisableAWSServiceAccessRequest::OAIDisableAWSServiceAccessRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisableAWSServiceAccessRequest::OAIDisableAWSServiceAccessRequest() {
    this->initializeModel();
}

OAIDisableAWSServiceAccessRequest::~OAIDisableAWSServiceAccessRequest() {}

void OAIDisableAWSServiceAccessRequest::initializeModel() {

    m_service_principal_isSet = false;
    m_service_principal_isValid = false;
}

void OAIDisableAWSServiceAccessRequest::fromJson(QString jsonString) {
...
void OAIDisableAWSServiceAccessRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDisableAWSServiceAccessRequest::asJson() const {
...
QJsonObject OAIDisableAWSServiceAccessRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisableAWSServiceAccessRequest::getServicePrincipal() const {
    return m_service_principal;
}
void OAIDisableAWSServiceAccessRequest::setServicePrincipal(const QString &service_principal) {
    m_service_principal = service_principal;
    m_service_principal_isSet = true;
}

bool OAIDisableAWSServiceAccessRequest::is_service_principal_Set() const{
    return m_service_principal_isSet;
}

bool OAIDisableAWSServiceAccessRequest::is_service_principal_Valid() const{
    return m_service_principal_isValid;
}

bool OAIDisableAWSServiceAccessRequest::isSet() const {
...
bool OAIDisableAWSServiceAccessRequest::isValid() const {
