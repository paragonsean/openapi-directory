...
OAIHandshakeFilter::OAIHandshakeFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHandshakeFilter::OAIHandshakeFilter() {
    this->initializeModel();
}

OAIHandshakeFilter::~OAIHandshakeFilter() {}

void OAIHandshakeFilter::initializeModel() {
...
void OAIHandshakeFilter::fromJson(QString jsonString) {
...
void OAIHandshakeFilter::fromJsonObject(QJsonObject json) {
...
QString OAIHandshakeFilter::asJson() const {
...
QJsonObject OAIHandshakeFilter::asJsonObject() const {
    QJsonObject obj;
...
OAIActionType OAIHandshakeFilter::getActionType() const {
    return m_action_type;
}
void OAIHandshakeFilter::setActionType(const OAIActionType &action_type) {
    m_action_type = action_type;
    m_action_type_isSet = true;
}

bool OAIHandshakeFilter::is_action_type_Set() const{
    return m_action_type_isSet;
}

bool OAIHandshakeFilter::is_action_type_Valid() const{
    return m_action_type_isValid;
}

QString OAIHandshakeFilter::getParentHandshakeId() const {
    return m_parent_handshake_id;
}
void OAIHandshakeFilter::setParentHandshakeId(const QString &parent_handshake_id) {
    m_parent_handshake_id = parent_handshake_id;
    m_parent_handshake_id_isSet = true;
}

bool OAIHandshakeFilter::is_parent_handshake_id_Set() const{
    return m_parent_handshake_id_isSet;
}

bool OAIHandshakeFilter::is_parent_handshake_id_Valid() const{
    return m_parent_handshake_id_isValid;
}

bool OAIHandshakeFilter::isSet() const {
...
bool OAIHandshakeFilter::isValid() const {
