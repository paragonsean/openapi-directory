...
/*
 * OAIDisableAWSServiceAccessRequest.h
 *
 * 
 */

#ifndef OAIDisableAWSServiceAccessRequest_H
#define OAIDisableAWSServiceAccessRequest_H
...
class OAIDisableAWSServiceAccessRequest : public OAIObject {
public:
    OAIDisableAWSServiceAccessRequest();
    OAIDisableAWSServiceAccessRequest(QString json);
    ~OAIDisableAWSServiceAccessRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisableAWSServiceAccessRequest)

#endif // OAIDisableAWSServiceAccessRequest_H
