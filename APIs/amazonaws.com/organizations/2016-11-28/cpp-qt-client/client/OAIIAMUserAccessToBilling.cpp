...
OAIIAMUserAccessToBilling::OAIIAMUserAccessToBilling(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIAMUserAccessToBilling::OAIIAMUserAccessToBilling() {
    this->initializeModel();
}

OAIIAMUserAccessToBilling::~OAIIAMUserAccessToBilling() {}

void OAIIAMUserAccessToBilling::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIIAMUserAccessToBilling::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIIAMUserAccessToBilling::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ALLOW", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIAMUserAccessToBilling::ALLOW;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DENY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIAMUserAccessToBilling::DENY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIIAMUserAccessToBilling::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIIAMUserAccessToBilling::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIIAMUserAccessToBilling::ALLOW:
            val = "ALLOW";
            break;
        case eOAIIAMUserAccessToBilling::DENY:
            val = "DENY";
            break;
        default:
            break;
...
QJsonValue OAIIAMUserAccessToBilling::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIIAMUserAccessToBilling::eOAIIAMUserAccessToBilling OAIIAMUserAccessToBilling::getValue() const {
    return m_value;
}

void OAIIAMUserAccessToBilling::setValue(const OAIIAMUserAccessToBilling::eOAIIAMUserAccessToBilling& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIIAMUserAccessToBilling::isSet() const {
    
    return m_value_isSet;
}

bool OAIIAMUserAccessToBilling::isValid() const {
