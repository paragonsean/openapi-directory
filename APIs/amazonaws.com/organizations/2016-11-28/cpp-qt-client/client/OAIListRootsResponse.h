...
/*
 * OAIListRootsResponse.h
 *
 * 
 */

#ifndef OAIListRootsResponse_H
#define OAIListRootsResponse_H
...
class OAIListRootsResponse : public OAIObject {
public:
    OAIListRootsResponse();
    OAIListRootsResponse(QString json);
    ~OAIListRootsResponse() override;
    ...
    QList getRoots() const;
    void setRoots(const QList &roots);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRootsResponse)

#endif // OAIListRootsResponse_H
