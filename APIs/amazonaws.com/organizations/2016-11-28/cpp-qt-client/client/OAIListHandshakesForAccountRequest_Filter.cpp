...
#include "OAIListHandshakesForAccountRequest_Filter.h"
...
OAIListHandshakesForAccountRequest_Filter::OAIListHandshakesForAccountRequest_Filter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListHandshakesForAccountRequest_Filter::OAIListHandshakesForAccountRequest_Filter() {
    this->initializeModel();
}

OAIListHandshakesForAccountRequest_Filter::~OAIListHandshakesForAccountRequest_Filter() {}

void OAIListHandshakesForAccountRequest_Filter::initializeModel() {

    m_action_type_isSet = false;
    m_action_type_isValid = false;

    m_parent_handshake_id_isSet = false;
    m_parent_handshake_id_isValid = false;
}

void OAIListHandshakesForAccountRequest_Filter::fromJson(QString jsonString) {
...
void OAIListHandshakesForAccountRequest_Filter::fromJsonObject(QJsonObject json) {
    ...
    m_parent_handshake_id_isValid = ::OpenAPI::fromJsonValue(m_parent_handshake_id, json[QString("ParentHandshakeId")]);
    m_parent_handshake_id_isSet = !json[QString("ParentHandshakeId")].isNull() && m_parent_handshake_id_isValid;
}

QString OAIListHandshakesForAccountRequest_Filter::asJson() const {
...
QJsonObject OAIListHandshakesForAccountRequest_Filter::asJsonObject() const {
    QJsonObject obj;
    if (m_action_type.isSet()) {
        obj.insert(QString("ActionType"), ::OpenAPI::toJsonValue(m_action_type));
    }
    if (m_parent_handshake_id_isSet) {
        obj.insert(QString("ParentHandshakeId"), ::OpenAPI::toJsonValue(m_parent_handshake_id));
    }
    return obj;
}

OAIActionType OAIListHandshakesForAccountRequest_Filter::getActionType() const {
    return m_action_type;
}
void OAIListHandshakesForAccountRequest_Filter::setActionType(const OAIActionType &action_type) {
    m_action_type = action_type;
    m_action_type_isSet = true;
}

bool OAIListHandshakesForAccountRequest_Filter::is_action_type_Set() const{
    return m_action_type_isSet;
}

bool OAIListHandshakesForAccountRequest_Filter::is_action_type_Valid() const{
    return m_action_type_isValid;
}

QString OAIListHandshakesForAccountRequest_Filter::getParentHandshakeId() const {
    return m_parent_handshake_id;
}
void OAIListHandshakesForAccountRequest_Filter::setParentHandshakeId(const QString &parent_handshake_id) {
    m_parent_handshake_id = parent_handshake_id;
    m_parent_handshake_id_isSet = true;
}

bool OAIListHandshakesForAccountRequest_Filter::is_parent_handshake_id_Set() const{
    return m_parent_handshake_id_isSet;
}

bool OAIListHandshakesForAccountRequest_Filter::is_parent_handshake_id_Valid() const{
    return m_parent_handshake_id_isValid;
}

bool OAIListHandshakesForAccountRequest_Filter::isSet() const {
...
bool OAIListHandshakesForAccountRequest_Filter::isValid() const {
