...
OAIDeclineHandshakeResponse_Handshake::OAIDeclineHandshakeResponse_Handshake(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeclineHandshakeResponse_Handshake::OAIDeclineHandshakeResponse_Handshake() {
    this->initializeModel();
}

OAIDeclineHandshakeResponse_Handshake::~OAIDeclineHandshakeResponse_Handshake() {}

void OAIDeclineHandshakeResponse_Handshake::initializeModel() {
...
void OAIDeclineHandshakeResponse_Handshake::fromJson(QString jsonString) {
...
void OAIDeclineHandshakeResponse_Handshake::fromJsonObject(QJsonObject json) {
...
QString OAIDeclineHandshakeResponse_Handshake::asJson() const {
...
QJsonObject OAIDeclineHandshakeResponse_Handshake::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIDeclineHandshakeResponse_Handshake::getId() const {
    return m_id;
}
void OAIDeclineHandshakeResponse_Handshake::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDeclineHandshakeResponse_Handshake::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDeclineHandshakeResponse_Handshake::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDeclineHandshakeResponse_Handshake::getArn() const {
    return m_arn;
}
void OAIDeclineHandshakeResponse_Handshake::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeclineHandshakeResponse_Handshake::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeclineHandshakeResponse_Handshake::is_arn_Valid() const{
    return m_arn_isValid;
}

QList OAIDeclineHandshakeResponse_Handshake::getParties() const {
    return m_parties;
}
void OAIDeclineHandshakeResponse_Handshake::setParties(const QList &parties) {
    m_parties = parties;
    m_parties_isSet = true;
}

bool OAIDeclineHandshakeResponse_Handshake::is_parties_Set() const{
    return m_parties_isSet;
}

bool OAIDeclineHandshakeResponse_Handshake::is_parties_Valid() const{
    return m_parties_isValid;
}

OAIHandshakeState OAIDeclineHandshakeResponse_Handshake::getState() const {
    return m_state;
}
void OAIDeclineHandshakeResponse_Handshake::setState(const OAIHandshakeState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIDeclineHandshakeResponse_Handshake::is_state_Set() const{
    return m_state_isSet;
}

bool OAIDeclineHandshakeResponse_Handshake::is_state_Valid() const{
    return m_state_isValid;
}

QDateTime OAIDeclineHandshakeResponse_Handshake::getRequestedTimestamp() const {
    return m_requested_timestamp;
}
void OAIDeclineHandshakeResponse_Handshake::setRequestedTimestamp(const QDateTime &requested_timestamp) {
    m_requested_timestamp = requested_timestamp;
    m_requested_timestamp_isSet = true;
}

bool OAIDeclineHandshakeResponse_Handshake::is_requested_timestamp_Set() const{
    return m_requested_timestamp_isSet;
}

bool OAIDeclineHandshakeResponse_Handshake::is_requested_timestamp_Valid() const{
    return m_requested_timestamp_isValid;
}

QDateTime OAIDeclineHandshakeResponse_Handshake::getExpirationTimestamp() const {
    return m_expiration_timestamp;
}
void OAIDeclineHandshakeResponse_Handshake::setExpirationTimestamp(const QDateTime &expiration_timestamp) {
    m_expiration_timestamp = expiration_timestamp;
    m_expiration_timestamp_isSet = true;
}

bool OAIDeclineHandshakeResponse_Handshake::is_expiration_timestamp_Set() const{
    return m_expiration_timestamp_isSet;
}

bool OAIDeclineHandshakeResponse_Handshake::is_expiration_timestamp_Valid() const{
    return m_expiration_timestamp_isValid;
}

OAIActionType OAIDeclineHandshakeResponse_Handshake::getAction() const {
    return m_action;
}
void OAIDeclineHandshakeResponse_Handshake::setAction(const OAIActionType &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIDeclineHandshakeResponse_Handshake::is_action_Set() const{
    return m_action_isSet;
}

bool OAIDeclineHandshakeResponse_Handshake::is_action_Valid() const{
    return m_action_isValid;
}

QList OAIDeclineHandshakeResponse_Handshake::getResources() const {
    return m_resources;
}
void OAIDeclineHandshakeResponse_Handshake::setResources(const QList &resources) {
    m_resources = resources;
    m_resources_isSet = true;
}

bool OAIDeclineHandshakeResponse_Handshake::is_resources_Set() const{
    return m_resources_isSet;
}

bool OAIDeclineHandshakeResponse_Handshake::is_resources_Valid() const{
    return m_resources_isValid;
}

bool OAIDeclineHandshakeResponse_Handshake::isSet() const {
...
bool OAIDeclineHandshakeResponse_Handshake::isValid() const {
