...
OAIOrganizationFeatureSet::OAIOrganizationFeatureSet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationFeatureSet::OAIOrganizationFeatureSet() {
    this->initializeModel();
}

OAIOrganizationFeatureSet::~OAIOrganizationFeatureSet() {}

void OAIOrganizationFeatureSet::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIOrganizationFeatureSet::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIOrganizationFeatureSet::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ALL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrganizationFeatureSet::ALL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CONSOLIDATED_BILLING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrganizationFeatureSet::CONSOLIDATED_BILLING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIOrganizationFeatureSet::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIOrganizationFeatureSet::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIOrganizationFeatureSet::ALL:
            val = "ALL";
            break;
        case eOAIOrganizationFeatureSet::CONSOLIDATED_BILLING:
            val = "CONSOLIDATED_BILLING";
            break;
        default:
            break;
    }
...
QJsonValue OAIOrganizationFeatureSet::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIOrganizationFeatureSet::eOAIOrganizationFeatureSet OAIOrganizationFeatureSet::getValue() const {
    return m_value;
}

void OAIOrganizationFeatureSet::setValue(const OAIOrganizationFeatureSet::eOAIOrganizationFeatureSet& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIOrganizationFeatureSet::isSet() const {
    
    return m_value_isSet;
}

bool OAIOrganizationFeatureSet::isValid() const {
