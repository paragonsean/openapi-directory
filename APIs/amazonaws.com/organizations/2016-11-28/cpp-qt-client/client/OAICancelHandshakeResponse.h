...
/*
 * OAICancelHandshakeResponse.h
 *
 * 
 */

#ifndef OAICancelHandshakeResponse_H
#define OAICancelHandshakeResponse_H
...
namespace OpenAPI {
class OAICancelHandshakeResponse_Handshake;

class OAICancelHandshakeResponse : public OAIObject {
public:
    OAICancelHandshakeResponse();
    OAICancelHandshakeResponse(QString json);
    ~OAICancelHandshakeResponse() override;
    ...
    OAICancelHandshakeResponse_Handshake getHandshake() const;
    void setHandshake(const OAICancelHandshakeResponse_Handshake &handshake);
...
private:
    ...
    OAICancelHandshakeResponse_Handshake m_handshake;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelHandshakeResponse)

#endif // OAICancelHandshakeResponse_H
