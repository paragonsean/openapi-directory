...
OAIPolicy_PolicySummary OAIPolicy::getPolicySummary() const {
    return m_policy_summary;
}
void OAIPolicy::setPolicySummary(const OAIPolicy_PolicySummary &policy_summary) {
    m_policy_summary = policy_summary;
    m_policy_summary_isSet = true;
}

bool OAIPolicy::is_policy_summary_Set() const{
    return m_policy_summary_isSet;
}

bool OAIPolicy::is_policy_summary_Valid() const{
    return m_policy_summary_isValid;
}

QString OAIPolicy::getContent() const {
    return m_content;
}
void OAIPolicy::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIPolicy::is_content_Set() const{
    return m_content_isSet;
}

bool OAIPolicy::is_content_Valid() const{
