...
/*
 * OAIHandshakeResource.h
 *
 * Contains additional data that is needed to process a handshake.
 */

#ifndef OAIHandshakeResource_H
#define OAIHandshakeResource_H
...
class OAIHandshakeResource : public OAIObject {
public:
    OAIHandshakeResource();
    OAIHandshakeResource(QString json);
    ~OAIHandshakeResource() override;
    ...
    OAIHandshakeResourceType getType() const;
    void setType(const OAIHandshakeResourceType &type);
...
private:
    ...
    OAIHandshakeResourceType m_type;
    bool m_type_isSet;
    bool m_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHandshakeResource)

#endif // OAIHandshakeResource_H
