...
QString OAIRoot::getId() const {
    return m_id;
}
void OAIRoot::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QString OAIRoot::getArn() const {
    return m_arn;
}
void OAIRoot::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIRoot::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIRoot::is_arn_Valid() const{
...
QList OAIRoot::getPolicyTypes() const {
    return m_policy_types;
}
void OAIRoot::setPolicyTypes(const QList &policy_types) {
    m_policy_types = policy_types;
    m_policy_types_isSet = true;
}

bool OAIRoot::is_policy_types_Set() const{
    return m_policy_types_isSet;
}

bool OAIRoot::is_policy_types_Valid() const{
