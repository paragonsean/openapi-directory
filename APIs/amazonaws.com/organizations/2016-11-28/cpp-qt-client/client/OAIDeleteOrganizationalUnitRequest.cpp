...
OAIDeleteOrganizationalUnitRequest::OAIDeleteOrganizationalUnitRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteOrganizationalUnitRequest::OAIDeleteOrganizationalUnitRequest() {
    this->initializeModel();
}

OAIDeleteOrganizationalUnitRequest::~OAIDeleteOrganizationalUnitRequest() {}

void OAIDeleteOrganizationalUnitRequest::initializeModel() {

    m_organizational_unit_id_isSet = false;
    m_organizational_unit_id_isValid = false;
}

void OAIDeleteOrganizationalUnitRequest::fromJson(QString jsonString) {
...
void OAIDeleteOrganizationalUnitRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteOrganizationalUnitRequest::asJson() const {
...
QJsonObject OAIDeleteOrganizationalUnitRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteOrganizationalUnitRequest::getOrganizationalUnitId() const {
    return m_organizational_unit_id;
}
void OAIDeleteOrganizationalUnitRequest::setOrganizationalUnitId(const QString &organizational_unit_id) {
    m_organizational_unit_id = organizational_unit_id;
    m_organizational_unit_id_isSet = true;
}

bool OAIDeleteOrganizationalUnitRequest::is_organizational_unit_id_Set() const{
    return m_organizational_unit_id_isSet;
}

bool OAIDeleteOrganizationalUnitRequest::is_organizational_unit_id_Valid() const{
    return m_organizational_unit_id_isValid;
}

bool OAIDeleteOrganizationalUnitRequest::isSet() const {
...
bool OAIDeleteOrganizationalUnitRequest::isValid() const {
