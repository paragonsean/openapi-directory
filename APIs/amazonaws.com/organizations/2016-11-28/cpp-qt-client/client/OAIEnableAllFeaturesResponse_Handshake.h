...
/*
 * OAIEnableAllFeaturesResponse_Handshake.h
 *
 * 
 */

#ifndef OAIEnableAllFeaturesResponse_Handshake_H
#define OAIEnableAllFeaturesResponse_Handshake_H
...
class OAIEnableAllFeaturesResponse_Handshake : public OAIObject {
public:
    OAIEnableAllFeaturesResponse_Handshake();
    OAIEnableAllFeaturesResponse_Handshake(QString json);
    ~OAIEnableAllFeaturesResponse_Handshake() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnableAllFeaturesResponse_Handshake)

#endif // OAIEnableAllFeaturesResponse_Handshake_H
