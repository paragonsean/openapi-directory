...
OAIListHandshakesForAccountResponse::OAIListHandshakesForAccountResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListHandshakesForAccountResponse::OAIListHandshakesForAccountResponse() {
    this->initializeModel();
}

OAIListHandshakesForAccountResponse::~OAIListHandshakesForAccountResponse() {}

void OAIListHandshakesForAccountResponse::initializeModel() {

    m_handshakes_isSet = false;
    m_handshakes_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListHandshakesForAccountResponse::fromJson(QString jsonString) {
...
void OAIListHandshakesForAccountResponse::fromJsonObject(QJsonObject json) {

    m_handshakes_isValid = ::OpenAPI::fromJsonValue(m_handshakes, json[QString("Handshakes")]);
    m_handshakes_isSet = !json[QString("Handshakes")].isNull() && m_handshakes_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListHandshakesForAccountResponse::asJson() const {
...
QJsonObject OAIListHandshakesForAccountResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_handshakes.isSet()) {
        obj.insert(QString("Handshakes"), ::OpenAPI::toJsonValue(m_handshakes));
    }
...
QList OAIListHandshakesForAccountResponse::getHandshakes() const {
    return m_handshakes;
}
void OAIListHandshakesForAccountResponse::setHandshakes(const QList &handshakes) {
    m_handshakes = handshakes;
    m_handshakes_isSet = true;
}

bool OAIListHandshakesForAccountResponse::is_handshakes_Set() const{
    return m_handshakes_isSet;
}

bool OAIListHandshakesForAccountResponse::is_handshakes_Valid() const{
    return m_handshakes_isValid;
}

QString OAIListHandshakesForAccountResponse::getNextToken() const {
    return m_next_token;
}
void OAIListHandshakesForAccountResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListHandshakesForAccountResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListHandshakesForAccountResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListHandshakesForAccountResponse::isSet() const {
...
bool OAIListHandshakesForAccountResponse::isValid() const {
