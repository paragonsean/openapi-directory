...
/*
 * OAIListOrganizationalUnitsForParentResponse.h
 *
 * 
 */

#ifndef OAIListOrganizationalUnitsForParentResponse_H
#define OAIListOrganizationalUnitsForParentResponse_H
...
class OAIListOrganizationalUnitsForParentResponse : public OAIObject {
public:
    OAIListOrganizationalUnitsForParentResponse();
    OAIListOrganizationalUnitsForParentResponse(QString json);
    ~OAIListOrganizationalUnitsForParentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListOrganizationalUnitsForParentResponse)

#endif // OAIListOrganizationalUnitsForParentResponse_H
