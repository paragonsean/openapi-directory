...
/*
 * OAICreateOrganizationalUnitResponse.h
 *
 * 
 */

#ifndef OAICreateOrganizationalUnitResponse_H
#define OAICreateOrganizationalUnitResponse_H
...
namespace OpenAPI {
class OAICreateOrganizationalUnitResponse_OrganizationalUnit;

class OAICreateOrganizationalUnitResponse : public OAIObject {
public:
    OAICreateOrganizationalUnitResponse();
    OAICreateOrganizationalUnitResponse(QString json);
    ~OAICreateOrganizationalUnitResponse() override;
    ...
    OAICreateOrganizationalUnitResponse_OrganizationalUnit getOrganizationalUnit() const;
    void setOrganizationalUnit(const OAICreateOrganizationalUnitResponse_OrganizationalUnit &organizational_unit);
...
private:
    ...
    OAICreateOrganizationalUnitResponse_OrganizationalUnit m_organizational_unit;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOrganizationalUnitResponse)

#endif // OAICreateOrganizationalUnitResponse_H
