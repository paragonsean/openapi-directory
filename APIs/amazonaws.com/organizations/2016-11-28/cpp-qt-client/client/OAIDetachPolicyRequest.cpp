...
OAIDetachPolicyRequest::OAIDetachPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetachPolicyRequest::OAIDetachPolicyRequest() {
    this->initializeModel();
}

OAIDetachPolicyRequest::~OAIDetachPolicyRequest() {}

void OAIDetachPolicyRequest::initializeModel() {
...
void OAIDetachPolicyRequest::fromJson(QString jsonString) {
...
void OAIDetachPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDetachPolicyRequest::asJson() const {
...
QJsonObject OAIDetachPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDetachPolicyRequest::getPolicyId() const {
    return m_policy_id;
}
void OAIDetachPolicyRequest::setPolicyId(const QString &policy_id) {
    m_policy_id = policy_id;
    m_policy_id_isSet = true;
}

bool OAIDetachPolicyRequest::is_policy_id_Set() const{
    return m_policy_id_isSet;
}

bool OAIDetachPolicyRequest::is_policy_id_Valid() const{
    return m_policy_id_isValid;
}

QString OAIDetachPolicyRequest::getTargetId() const {
    return m_target_id;
}
void OAIDetachPolicyRequest::setTargetId(const QString &target_id) {
    m_target_id = target_id;
    m_target_id_isSet = true;
}

bool OAIDetachPolicyRequest::is_target_id_Set() const{
    return m_target_id_isSet;
}

bool OAIDetachPolicyRequest::is_target_id_Valid() const{
    return m_target_id_isValid;
}

bool OAIDetachPolicyRequest::isSet() const {
...
bool OAIDetachPolicyRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_id_isValid && m_target_id_isValid && true;
}
