...
OAIHandshakePartyType::OAIHandshakePartyType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHandshakePartyType::OAIHandshakePartyType() {
    this->initializeModel();
}

OAIHandshakePartyType::~OAIHandshakePartyType() {}

void OAIHandshakePartyType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIHandshakePartyType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIHandshakePartyType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACCOUNT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHandshakePartyType::ACCOUNT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ORGANIZATION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHandshakePartyType::ORGANIZATION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EMAIL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHandshakePartyType::EMAIL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIHandshakePartyType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIHandshakePartyType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIHandshakePartyType::ACCOUNT:
            val = "ACCOUNT";
            break;
        case eOAIHandshakePartyType::ORGANIZATION:
            val = "ORGANIZATION";
            break;
        case eOAIHandshakePartyType::EMAIL:
            val = "EMAIL";
            break;
        default:
            break;
...
QJsonValue OAIHandshakePartyType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIHandshakePartyType::eOAIHandshakePartyType OAIHandshakePartyType::getValue() const {
    return m_value;
}

void OAIHandshakePartyType::setValue(const OAIHandshakePartyType::eOAIHandshakePartyType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIHandshakePartyType::isSet() const {
    
    return m_value_isSet;
}

bool OAIHandshakePartyType::isValid() const {
