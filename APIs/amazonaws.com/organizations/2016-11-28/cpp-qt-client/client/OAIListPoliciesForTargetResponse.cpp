...
OAIListPoliciesForTargetResponse::OAIListPoliciesForTargetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPoliciesForTargetResponse::OAIListPoliciesForTargetResponse() {
    this->initializeModel();
}

OAIListPoliciesForTargetResponse::~OAIListPoliciesForTargetResponse() {}

void OAIListPoliciesForTargetResponse::initializeModel() {
...
void OAIListPoliciesForTargetResponse::fromJson(QString jsonString) {
...
void OAIListPoliciesForTargetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListPoliciesForTargetResponse::asJson() const {
...
QJsonObject OAIListPoliciesForTargetResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_policies.isSet()) {
...
QList OAIListPoliciesForTargetResponse::getPolicies() const {
    return m_policies;
}
void OAIListPoliciesForTargetResponse::setPolicies(const QList &policies) {
    m_policies = policies;
    m_policies_isSet = true;
}

bool OAIListPoliciesForTargetResponse::is_policies_Set() const{
    return m_policies_isSet;
}

bool OAIListPoliciesForTargetResponse::is_policies_Valid() const{
    return m_policies_isValid;
}

QString OAIListPoliciesForTargetResponse::getNextToken() const {
    return m_next_token;
}
void OAIListPoliciesForTargetResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPoliciesForTargetResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPoliciesForTargetResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListPoliciesForTargetResponse::isSet() const {
...
bool OAIListPoliciesForTargetResponse::isValid() const {
