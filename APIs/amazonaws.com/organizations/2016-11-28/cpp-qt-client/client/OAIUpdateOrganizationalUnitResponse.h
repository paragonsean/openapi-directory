...
/*
 * OAIUpdateOrganizationalUnitResponse.h
 *
 * 
 */

#ifndef OAIUpdateOrganizationalUnitResponse_H
#define OAIUpdateOrganizationalUnitResponse_H
...
namespace OpenAPI {
class OAIUpdateOrganizationalUnitResponse_OrganizationalUnit;

class OAIUpdateOrganizationalUnitResponse : public OAIObject {
public:
    OAIUpdateOrganizationalUnitResponse();
    OAIUpdateOrganizationalUnitResponse(QString json);
    ~OAIUpdateOrganizationalUnitResponse() override;
    ...
    OAIUpdateOrganizationalUnitResponse_OrganizationalUnit getOrganizationalUnit() const;
    void setOrganizationalUnit(const OAIUpdateOrganizationalUnitResponse_OrganizationalUnit &organizational_unit);
...
private:
    ...
    OAIUpdateOrganizationalUnitResponse_OrganizationalUnit m_organizational_unit;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOrganizationalUnitResponse)

#endif // OAIUpdateOrganizationalUnitResponse_H
