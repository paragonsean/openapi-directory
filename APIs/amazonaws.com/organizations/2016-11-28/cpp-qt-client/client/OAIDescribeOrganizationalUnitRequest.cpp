...
OAIDescribeOrganizationalUnitRequest::OAIDescribeOrganizationalUnitRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeOrganizationalUnitRequest::OAIDescribeOrganizationalUnitRequest() {
    this->initializeModel();
}

OAIDescribeOrganizationalUnitRequest::~OAIDescribeOrganizationalUnitRequest() {}

void OAIDescribeOrganizationalUnitRequest::initializeModel() {

    m_organizational_unit_id_isSet = false;
    m_organizational_unit_id_isValid = false;
}

void OAIDescribeOrganizationalUnitRequest::fromJson(QString jsonString) {
...
void OAIDescribeOrganizationalUnitRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeOrganizationalUnitRequest::asJson() const {
...
QJsonObject OAIDescribeOrganizationalUnitRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeOrganizationalUnitRequest::getOrganizationalUnitId() const {
    return m_organizational_unit_id;
}
void OAIDescribeOrganizationalUnitRequest::setOrganizationalUnitId(const QString &organizational_unit_id) {
    m_organizational_unit_id = organizational_unit_id;
    m_organizational_unit_id_isSet = true;
}

bool OAIDescribeOrganizationalUnitRequest::is_organizational_unit_id_Set() const{
    return m_organizational_unit_id_isSet;
}

bool OAIDescribeOrganizationalUnitRequest::is_organizational_unit_id_Valid() const{
    return m_organizational_unit_id_isValid;
}

bool OAIDescribeOrganizationalUnitRequest::isSet() const {
...
bool OAIDescribeOrganizationalUnitRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_organizational_unit_id_isValid && true;
}
