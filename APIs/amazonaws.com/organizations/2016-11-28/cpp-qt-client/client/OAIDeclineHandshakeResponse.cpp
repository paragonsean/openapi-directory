...
OAIDeclineHandshakeResponse::OAIDeclineHandshakeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeclineHandshakeResponse::OAIDeclineHandshakeResponse() {
    this->initializeModel();
}

OAIDeclineHandshakeResponse::~OAIDeclineHandshakeResponse() {}

void OAIDeclineHandshakeResponse::initializeModel() {

    m_handshake_isSet = false;
    m_handshake_isValid = false;
}

void OAIDeclineHandshakeResponse::fromJson(QString jsonString) {
...
void OAIDeclineHandshakeResponse::fromJsonObject(QJsonObject json) {

    m_handshake_isValid = ::OpenAPI::fromJsonValue(m_handshake, json[QString("Handshake")]);
    m_handshake_isSet = !json[QString("Handshake")].isNull() && m_handshake_isValid;
}

QString OAIDeclineHandshakeResponse::asJson() const {
...
QJsonObject OAIDeclineHandshakeResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_handshake.isSet()) {
        obj.insert(QString("Handshake"), ::OpenAPI::toJsonValue(m_handshake));
    }
    return obj;
}

OAIDeclineHandshakeResponse_Handshake OAIDeclineHandshakeResponse::getHandshake() const {
    return m_handshake;
}
void OAIDeclineHandshakeResponse::setHandshake(const OAIDeclineHandshakeResponse_Handshake &handshake) {
    m_handshake = handshake;
    m_handshake_isSet = true;
}

bool OAIDeclineHandshakeResponse::is_handshake_Set() const{
    return m_handshake_isSet;
}

bool OAIDeclineHandshakeResponse::is_handshake_Valid() const{
    return m_handshake_isValid;
}

bool OAIDeclineHandshakeResponse::isSet() const {
...
bool OAIDeclineHandshakeResponse::isValid() const {
