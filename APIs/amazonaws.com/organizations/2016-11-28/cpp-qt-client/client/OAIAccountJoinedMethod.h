...
/*
 * OAIAccountJoinedMethod.h
 *
 * 
 */

#ifndef OAIAccountJoinedMethod_H
#define OAIAccountJoinedMethod_H
...
class OAIAccountJoinedMethod : public OAIEnum {
public:
    OAIAccountJoinedMethod();
    OAIAccountJoinedMethod(QString json);
    ~OAIAccountJoinedMethod() override;
    ...
    enum class eOAIAccountJoinedMethod {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        INVITED, 
        CREATED
    };
    OAIAccountJoinedMethod::eOAIAccountJoinedMethod getValue() const;
    void setValue(const OAIAccountJoinedMethod::eOAIAccountJoinedMethod& value);
...
private:
    ...
    eOAIAccountJoinedMethod m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountJoinedMethod)

#endif // OAIAccountJoinedMethod_H
