...
/*
 * OAIPolicyTypeSummary.h
 *
 * Contains information about a policy type and its status in the associated root.
 */

#ifndef OAIPolicyTypeSummary_H
#define OAIPolicyTypeSummary_H

#include <QJsonObject>

#include "OAIPolicyType.h"
#include "OAIPolicyTypeStatus.h"
...
class OAIPolicyTypeSummary : public OAIObject {
public:
    OAIPolicyTypeSummary();
    OAIPolicyTypeSummary(QString json);
    ~OAIPolicyTypeSummary() override;
    ...
    OAIPolicyType getType() const;
    void setType(const OAIPolicyType &type);
    bool is_type_Set() const;
    bool is_type_Valid() const;

    OAIPolicyTypeStatus getStatus() const;
    void setStatus(const OAIPolicyTypeStatus &status);
...
private:
    ...
    OAIPolicyType m_type;
    bool m_type_isSet;
    bool m_type_isValid;

    OAIPolicyTypeStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyTypeSummary)

#endif // OAIPolicyTypeSummary_H
