...
/*
 * OAIDescribeAccountResponse_Account.h
 *
 * 
 */

#ifndef OAIDescribeAccountResponse_Account_H
#define OAIDescribeAccountResponse_Account_H
...
class OAIDescribeAccountResponse_Account : public OAIObject {
public:
    OAIDescribeAccountResponse_Account();
    OAIDescribeAccountResponse_Account(QString json);
    ~OAIDescribeAccountResponse_Account() override;
    ...
    OAIAccountJoinedMethod getJoinedMethod() const;
    void setJoinedMethod(const OAIAccountJoinedMethod &joined_method);
    bool is_joined_method_Set() const;
    bool is_joined_method_Valid() const;
...
private:
    ...
    OAIAccountJoinedMethod m_joined_method;
    bool m_joined_method_isSet;
    bool m_joined_method_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccountResponse_Account)

#endif // OAIDescribeAccountResponse_Account_H
