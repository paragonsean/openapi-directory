...
/*
 * OAIDescribeAccountRequest.h
 *
 * 
 */

#ifndef OAIDescribeAccountRequest_H
#define OAIDescribeAccountRequest_H
...
class OAIDescribeAccountRequest : public OAIObject {
public:
    OAIDescribeAccountRequest();
    OAIDescribeAccountRequest(QString json);
    ~OAIDescribeAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccountRequest)

#endif // OAIDescribeAccountRequest_H
