...
OAIDisablePolicyTypeResponse_Root::OAIDisablePolicyTypeResponse_Root(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisablePolicyTypeResponse_Root::OAIDisablePolicyTypeResponse_Root() {
    this->initializeModel();
}

OAIDisablePolicyTypeResponse_Root::~OAIDisablePolicyTypeResponse_Root() {}

void OAIDisablePolicyTypeResponse_Root::initializeModel() {
...
void OAIDisablePolicyTypeResponse_Root::fromJson(QString jsonString) {
...
void OAIDisablePolicyTypeResponse_Root::fromJsonObject(QJsonObject json) {
...
QString OAIDisablePolicyTypeResponse_Root::asJson() const {
...
QJsonObject OAIDisablePolicyTypeResponse_Root::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIDisablePolicyTypeResponse_Root::getId() const {
    return m_id;
}
void OAIDisablePolicyTypeResponse_Root::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDisablePolicyTypeResponse_Root::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDisablePolicyTypeResponse_Root::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDisablePolicyTypeResponse_Root::getArn() const {
    return m_arn;
}
void OAIDisablePolicyTypeResponse_Root::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDisablePolicyTypeResponse_Root::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDisablePolicyTypeResponse_Root::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIDisablePolicyTypeResponse_Root::getName() const {
    return m_name;
}
void OAIDisablePolicyTypeResponse_Root::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDisablePolicyTypeResponse_Root::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDisablePolicyTypeResponse_Root::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIDisablePolicyTypeResponse_Root::getPolicyTypes() const {
    return m_policy_types;
}
void OAIDisablePolicyTypeResponse_Root::setPolicyTypes(const QList &policy_types) {
    m_policy_types = policy_types;
    m_policy_types_isSet = true;
}

bool OAIDisablePolicyTypeResponse_Root::is_policy_types_Set() const{
    return m_policy_types_isSet;
}

bool OAIDisablePolicyTypeResponse_Root::is_policy_types_Valid() const{
    return m_policy_types_isValid;
}

bool OAIDisablePolicyTypeResponse_Root::isSet() const {
...
bool OAIDisablePolicyTypeResponse_Root::isValid() const {
