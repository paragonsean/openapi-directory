...
OAIEffectivePolicy::OAIEffectivePolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEffectivePolicy::OAIEffectivePolicy() {
    this->initializeModel();
}

OAIEffectivePolicy::~OAIEffectivePolicy() {}

void OAIEffectivePolicy::initializeModel() {
...
void OAIEffectivePolicy::fromJson(QString jsonString) {
...
void OAIEffectivePolicy::fromJsonObject(QJsonObject json) {
...
QString OAIEffectivePolicy::asJson() const {
...
QJsonObject OAIEffectivePolicy::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEffectivePolicy::getPolicyContent() const {
    return m_policy_content;
}
void OAIEffectivePolicy::setPolicyContent(const QString &policy_content) {
    m_policy_content = policy_content;
    m_policy_content_isSet = true;
}

bool OAIEffectivePolicy::is_policy_content_Set() const{
    return m_policy_content_isSet;
}

bool OAIEffectivePolicy::is_policy_content_Valid() const{
    return m_policy_content_isValid;
}

QDateTime OAIEffectivePolicy::getLastUpdatedTimestamp() const {
    return m_last_updated_timestamp;
}
void OAIEffectivePolicy::setLastUpdatedTimestamp(const QDateTime &last_updated_timestamp) {
    m_last_updated_timestamp = last_updated_timestamp;
    m_last_updated_timestamp_isSet = true;
}

bool OAIEffectivePolicy::is_last_updated_timestamp_Set() const{
    return m_last_updated_timestamp_isSet;
}

bool OAIEffectivePolicy::is_last_updated_timestamp_Valid() const{
    return m_last_updated_timestamp_isValid;
}

QString OAIEffectivePolicy::getTargetId() const {
    return m_target_id;
}
void OAIEffectivePolicy::setTargetId(const QString &target_id) {
    m_target_id = target_id;
    m_target_id_isSet = true;
}

bool OAIEffectivePolicy::is_target_id_Set() const{
    return m_target_id_isSet;
}

bool OAIEffectivePolicy::is_target_id_Valid() const{
    return m_target_id_isValid;
}

OAIEffectivePolicyType OAIEffectivePolicy::getPolicyType() const {
    return m_policy_type;
}
void OAIEffectivePolicy::setPolicyType(const OAIEffectivePolicyType &policy_type) {
    m_policy_type = policy_type;
    m_policy_type_isSet = true;
}

bool OAIEffectivePolicy::is_policy_type_Set() const{
    return m_policy_type_isSet;
}

bool OAIEffectivePolicy::is_policy_type_Valid() const{
    return m_policy_type_isValid;
}

bool OAIEffectivePolicy::isSet() const {
...
bool OAIEffectivePolicy::isValid() const {
