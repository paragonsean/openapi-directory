...
/*
 * OAIHandshakeResourceType.h
 *
 * 
 */

#ifndef OAIHandshakeResourceType_H
#define OAIHandshakeResourceType_H
...
class OAIHandshakeResourceType : public OAIEnum {
public:
    OAIHandshakeResourceType();
    OAIHandshakeResourceType(QString json);
    ~OAIHandshakeResourceType() override;
    ...
    enum class eOAIHandshakeResourceType {
    ...
    OAIHandshakeResourceType::eOAIHandshakeResourceType getValue() const;
    void setValue(const OAIHandshakeResourceType::eOAIHandshakeResourceType& value);
...
private:
    ...
    eOAIHandshakeResourceType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHandshakeResourceType)

#endif // OAIHandshakeResourceType_H
