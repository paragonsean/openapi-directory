...
OAIChildType::OAIChildType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChildType::OAIChildType() {
    this->initializeModel();
}

OAIChildType::~OAIChildType() {}

void OAIChildType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIChildType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIChildType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACCOUNT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChildType::ACCOUNT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ORGANIZATIONAL_UNIT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChildType::ORGANIZATIONAL_UNIT;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIChildType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIChildType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIChildType::ACCOUNT:
            val = "ACCOUNT";
            break;
        case eOAIChildType::ORGANIZATIONAL_UNIT:
...
QJsonValue OAIChildType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIChildType::eOAIChildType OAIChildType::getValue() const {
    return m_value;
}

void OAIChildType::setValue(const OAIChildType::eOAIChildType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIChildType::isSet() const {
    
    return m_value_isSet;
}

bool OAIChildType::isValid() const {
