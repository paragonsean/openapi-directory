...
#include "OAIOrganizationalUnit.h"
...
OAIOrganizationalUnit::OAIOrganizationalUnit(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationalUnit::OAIOrganizationalUnit() {
    this->initializeModel();
}

OAIOrganizationalUnit::~OAIOrganizationalUnit() {}

void OAIOrganizationalUnit::initializeModel() {
...
void OAIOrganizationalUnit::fromJson(QString jsonString) {
...
void OAIOrganizationalUnit::fromJsonObject(QJsonObject json) {
...
QString OAIOrganizationalUnit::asJson() const {
...
QJsonObject OAIOrganizationalUnit::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIOrganizationalUnit::getId() const {
    return m_id;
}
void OAIOrganizationalUnit::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIOrganizationalUnit::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOrganizationalUnit::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIOrganizationalUnit::getArn() const {
    return m_arn;
}
void OAIOrganizationalUnit::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIOrganizationalUnit::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIOrganizationalUnit::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIOrganizationalUnit::getName() const {
    return m_name;
}
void OAIOrganizationalUnit::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIOrganizationalUnit::is_name_Set() const{
    return m_name_isSet;
}

bool OAIOrganizationalUnit::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIOrganizationalUnit::isSet() const {
...
bool OAIOrganizationalUnit::isValid() const {
