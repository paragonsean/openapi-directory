...
OAIHandshakeState::OAIHandshakeState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHandshakeState::OAIHandshakeState() {
    this->initializeModel();
}

OAIHandshakeState::~OAIHandshakeState() {}

void OAIHandshakeState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIHandshakeState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIHandshakeState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("REQUESTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHandshakeState::REQUESTED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("OPEN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHandshakeState::OPEN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CANCELED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHandshakeState::CANCELED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACCEPTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHandshakeState::ACCEPTED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DECLINED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHandshakeState::DECLINED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EXPIRED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHandshakeState::EXPIRED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIHandshakeState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIHandshakeState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIHandshakeState::REQUESTED:
            val = "REQUESTED";
            break;
        case eOAIHandshakeState::OPEN:
            val = "OPEN";
            break;
        case eOAIHandshakeState::CANCELED:
            val = "CANCELED";
            break;
        case eOAIHandshakeState::ACCEPTED:
            val = "ACCEPTED";
            break;
        case eOAIHandshakeState::DECLINED:
            val = "DECLINED";
            break;
        case eOAIHandshakeState::EXPIRED:
            val = "EXPIRED";
            break;
        default:
            break;
...
QJsonValue OAIHandshakeState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIHandshakeState::eOAIHandshakeState OAIHandshakeState::getValue() const {
    return m_value;
}

void OAIHandshakeState::setValue(const OAIHandshakeState::eOAIHandshakeState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIHandshakeState::isSet() const {
    
    return m_value_isSet;
}

bool OAIHandshakeState::isValid() const {
