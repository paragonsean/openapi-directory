...
OAIEnablePolicyTypeRequest::OAIEnablePolicyTypeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnablePolicyTypeRequest::OAIEnablePolicyTypeRequest() {
    this->initializeModel();
}

OAIEnablePolicyTypeRequest::~OAIEnablePolicyTypeRequest() {}

void OAIEnablePolicyTypeRequest::initializeModel() {
...
void OAIEnablePolicyTypeRequest::fromJson(QString jsonString) {
...
void OAIEnablePolicyTypeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIEnablePolicyTypeRequest::asJson() const {
...
QJsonObject OAIEnablePolicyTypeRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_root_id_isSet) {
...
QString OAIEnablePolicyTypeRequest::getRootId() const {
    return m_root_id;
}
void OAIEnablePolicyTypeRequest::setRootId(const QString &root_id) {
    m_root_id = root_id;
    m_root_id_isSet = true;
}

bool OAIEnablePolicyTypeRequest::is_root_id_Set() const{
    return m_root_id_isSet;
}

bool OAIEnablePolicyTypeRequest::is_root_id_Valid() const{
    return m_root_id_isValid;
}

OAIPolicyType OAIEnablePolicyTypeRequest::getPolicyType() const {
    return m_policy_type;
}
void OAIEnablePolicyTypeRequest::setPolicyType(const OAIPolicyType &policy_type) {
    m_policy_type = policy_type;
    m_policy_type_isSet = true;
}

bool OAIEnablePolicyTypeRequest::is_policy_type_Set() const{
    return m_policy_type_isSet;
}

bool OAIEnablePolicyTypeRequest::is_policy_type_Valid() const{
    return m_policy_type_isValid;
}

bool OAIEnablePolicyTypeRequest::isSet() const {
...
bool OAIEnablePolicyTypeRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_root_id_isValid && m_policy_type_isValid && true;
}
