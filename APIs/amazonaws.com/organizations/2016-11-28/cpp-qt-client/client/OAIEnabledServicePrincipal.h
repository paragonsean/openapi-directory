...
#ifndef OAIEnabledServicePrincipal_H
#define OAIEnabledServicePrincipal_H
...
class OAIEnabledServicePrincipal : public OAIObject {
public:
    OAIEnabledServicePrincipal();
    OAIEnabledServicePrincipal(QString json);
    ~OAIEnabledServicePrincipal() override;
    ...
    QDateTime getDateEnabled() const;
    void setDateEnabled(const QDateTime &date_enabled);
    bool is_date_enabled_Set() const;
    bool is_date_enabled_Valid() const;
...
private:
    ...
    QDateTime m_date_enabled;
    bool m_date_enabled_isSet;
    bool m_date_enabled_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEnabledServicePrincipal)

#endif // OAIEnabledServicePrincipal_H
