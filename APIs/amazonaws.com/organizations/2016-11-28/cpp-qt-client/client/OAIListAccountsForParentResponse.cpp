...
OAIListAccountsForParentResponse::OAIListAccountsForParentResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAccountsForParentResponse::OAIListAccountsForParentResponse() {
    this->initializeModel();
}

OAIListAccountsForParentResponse::~OAIListAccountsForParentResponse() {}

void OAIListAccountsForParentResponse::initializeModel() {
...
void OAIListAccountsForParentResponse::fromJson(QString jsonString) {
...
void OAIListAccountsForParentResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListAccountsForParentResponse::asJson() const {
...
QJsonObject OAIListAccountsForParentResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_accounts.isSet()) {
...
QList OAIListAccountsForParentResponse::getAccounts() const {
    return m_accounts;
}
void OAIListAccountsForParentResponse::setAccounts(const QList &accounts) {
    m_accounts = accounts;
    m_accounts_isSet = true;
}

bool OAIListAccountsForParentResponse::is_accounts_Set() const{
    return m_accounts_isSet;
}

bool OAIListAccountsForParentResponse::is_accounts_Valid() const{
    return m_accounts_isValid;
}

QString OAIListAccountsForParentResponse::getNextToken() const {
    return m_next_token;
}
void OAIListAccountsForParentResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAccountsForParentResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAccountsForParentResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListAccountsForParentResponse::isSet() const {
...
bool OAIListAccountsForParentResponse::isValid() const {
