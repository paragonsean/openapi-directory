...
/*
 * OAIListPoliciesRequest.h
 *
 * 
 */

#ifndef OAIListPoliciesRequest_H
#define OAIListPoliciesRequest_H
...
class OAIListPoliciesRequest : public OAIObject {
public:
    OAIListPoliciesRequest();
    OAIListPoliciesRequest(QString json);
    ~OAIListPoliciesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPoliciesRequest)

#endif // OAIListPoliciesRequest_H
