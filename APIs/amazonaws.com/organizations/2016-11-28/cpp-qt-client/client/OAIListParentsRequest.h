...
/*
 * OAIListParentsRequest.h
 *
 * 
 */

#ifndef OAIListParentsRequest_H
#define OAIListParentsRequest_H
...
class OAIListParentsRequest : public OAIObject {
public:
    OAIListParentsRequest();
    OAIListParentsRequest(QString json);
    ~OAIListParentsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListParentsRequest)

#endif // OAIListParentsRequest_H
