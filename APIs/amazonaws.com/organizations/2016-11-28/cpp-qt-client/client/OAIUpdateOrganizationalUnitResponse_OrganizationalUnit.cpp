...
#include "OAIUpdateOrganizationalUnitResponse_OrganizationalUnit.h"
...
OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::OAIUpdateOrganizationalUnitResponse_OrganizationalUnit(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::OAIUpdateOrganizationalUnitResponse_OrganizationalUnit() {
    this->initializeModel();
}

OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::~OAIUpdateOrganizationalUnitResponse_OrganizationalUnit() {}

void OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::initializeModel() {
...
void OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::fromJson(QString jsonString) {
...
void OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::asJson() const {
...
QJsonObject OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::getId() const {
    return m_id;
}
void OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::getArn() const {
    return m_arn;
}
void OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::getName() const {
    return m_name;
}
void OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::isSet() const {
...
bool OAIUpdateOrganizationalUnitResponse_OrganizationalUnit::isValid() const {
