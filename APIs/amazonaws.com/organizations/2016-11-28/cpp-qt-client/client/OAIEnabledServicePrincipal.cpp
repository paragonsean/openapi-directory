...
#include "OAIEnabledServicePrincipal.h"
...
OAIEnabledServicePrincipal::OAIEnabledServicePrincipal(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnabledServicePrincipal::OAIEnabledServicePrincipal() {
    this->initializeModel();
}

OAIEnabledServicePrincipal::~OAIEnabledServicePrincipal() {}

void OAIEnabledServicePrincipal::initializeModel() {

    m_service_principal_isSet = false;
    m_service_principal_isValid = false;

    m_date_enabled_isSet = false;
    m_date_enabled_isValid = false;
}

void OAIEnabledServicePrincipal::fromJson(QString jsonString) {
...
void OAIEnabledServicePrincipal::fromJsonObject(QJsonObject json) {
    ...
    m_date_enabled_isValid = ::OpenAPI::fromJsonValue(m_date_enabled, json[QString("DateEnabled")]);
    m_date_enabled_isSet = !json[QString("DateEnabled")].isNull() && m_date_enabled_isValid;
}

QString OAIEnabledServicePrincipal::asJson() const {
...
QJsonObject OAIEnabledServicePrincipal::asJsonObject() const {
    QJsonObject obj;
    if (m_service_principal_isSet) {
        obj.insert(QString("ServicePrincipal"), ::OpenAPI::toJsonValue(m_service_principal));
    }
    if (m_date_enabled_isSet) {
        obj.insert(QString("DateEnabled"), ::OpenAPI::toJsonValue(m_date_enabled));
    }
    return obj;
}

QString OAIEnabledServicePrincipal::getServicePrincipal() const {
    return m_service_principal;
}
void OAIEnabledServicePrincipal::setServicePrincipal(const QString &service_principal) {
    m_service_principal = service_principal;
    m_service_principal_isSet = true;
}

bool OAIEnabledServicePrincipal::is_service_principal_Set() const{
    return m_service_principal_isSet;
}

bool OAIEnabledServicePrincipal::is_service_principal_Valid() const{
    return m_service_principal_isValid;
}

QDateTime OAIEnabledServicePrincipal::getDateEnabled() const {
    return m_date_enabled;
}
void OAIEnabledServicePrincipal::setDateEnabled(const QDateTime &date_enabled) {
    m_date_enabled = date_enabled;
    m_date_enabled_isSet = true;
}

bool OAIEnabledServicePrincipal::is_date_enabled_Set() const{
    return m_date_enabled_isSet;
}

bool OAIEnabledServicePrincipal::is_date_enabled_Valid() const{
    return m_date_enabled_isValid;
}

bool OAIEnabledServicePrincipal::isSet() const {
...
bool OAIEnabledServicePrincipal::isValid() const {
