...
/*
 * OAICreateGovCloudAccountResponse.h
 *
 * 
 */

#ifndef OAICreateGovCloudAccountResponse_H
#define OAICreateGovCloudAccountResponse_H
...
namespace OpenAPI {
class OAICreateAccountStatus;

class OAICreateGovCloudAccountResponse : public OAIObject {
public:
    OAICreateGovCloudAccountResponse();
    OAICreateGovCloudAccountResponse(QString json);
    ~OAICreateGovCloudAccountResponse() override;
    ...
    OAICreateAccountStatus getCreateAccountStatus() const;
    void setCreateAccountStatus(const OAICreateAccountStatus &create_account_status);
...
private:
    ...
    OAICreateAccountStatus m_create_account_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGovCloudAccountResponse)

#endif // OAICreateGovCloudAccountResponse_H
