...
OAIListCreateAccountStatusResponse::OAIListCreateAccountStatusResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListCreateAccountStatusResponse::OAIListCreateAccountStatusResponse() {
    this->initializeModel();
}

OAIListCreateAccountStatusResponse::~OAIListCreateAccountStatusResponse() {}

void OAIListCreateAccountStatusResponse::initializeModel() {

    m_create_account_statuses_isSet = false;
    m_create_account_statuses_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListCreateAccountStatusResponse::fromJson(QString jsonString) {
...
void OAIListCreateAccountStatusResponse::fromJsonObject(QJsonObject json) {

    m_create_account_statuses_isValid = ::OpenAPI::fromJsonValue(m_create_account_statuses, json[QString("CreateAccountStatuses")]);
    m_create_account_statuses_isSet = !json[QString("CreateAccountStatuses")].isNull() && m_create_account_statuses_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListCreateAccountStatusResponse::asJson() const {
...
QJsonObject OAIListCreateAccountStatusResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_create_account_statuses.isSet()) {
        obj.insert(QString("CreateAccountStatuses"), ::OpenAPI::toJsonValue(m_create_account_statuses));
    }
...
QList OAIListCreateAccountStatusResponse::getCreateAccountStatuses() const {
    return m_create_account_statuses;
}
void OAIListCreateAccountStatusResponse::setCreateAccountStatuses(const QList &create_account_statuses) {
    m_create_account_statuses = create_account_statuses;
    m_create_account_statuses_isSet = true;
}

bool OAIListCreateAccountStatusResponse::is_create_account_statuses_Set() const{
    return m_create_account_statuses_isSet;
}

bool OAIListCreateAccountStatusResponse::is_create_account_statuses_Valid() const{
    return m_create_account_statuses_isValid;
}

QString OAIListCreateAccountStatusResponse::getNextToken() const {
    return m_next_token;
}
void OAIListCreateAccountStatusResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListCreateAccountStatusResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListCreateAccountStatusResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListCreateAccountStatusResponse::isSet() const {
...
bool OAIListCreateAccountStatusResponse::isValid() const {
