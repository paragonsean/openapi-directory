...
OAIInviteAccountToOrganizationResponse::OAIInviteAccountToOrganizationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInviteAccountToOrganizationResponse::OAIInviteAccountToOrganizationResponse() {
    this->initializeModel();
}

OAIInviteAccountToOrganizationResponse::~OAIInviteAccountToOrganizationResponse() {}

void OAIInviteAccountToOrganizationResponse::initializeModel() {

    m_handshake_isSet = false;
    m_handshake_isValid = false;
}

void OAIInviteAccountToOrganizationResponse::fromJson(QString jsonString) {
...
void OAIInviteAccountToOrganizationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIInviteAccountToOrganizationResponse::asJson() const {
...
QJsonObject OAIInviteAccountToOrganizationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIInviteAccountToOrganizationResponse_Handshake OAIInviteAccountToOrganizationResponse::getHandshake() const {
    return m_handshake;
}
void OAIInviteAccountToOrganizationResponse::setHandshake(const OAIInviteAccountToOrganizationResponse_Handshake &handshake) {
    m_handshake = handshake;
    m_handshake_isSet = true;
}

bool OAIInviteAccountToOrganizationResponse::is_handshake_Set() const{
    return m_handshake_isSet;
}

bool OAIInviteAccountToOrganizationResponse::is_handshake_Valid() const{
    return m_handshake_isValid;
}

bool OAIInviteAccountToOrganizationResponse::isSet() const {
...
bool OAIInviteAccountToOrganizationResponse::isValid() const {
