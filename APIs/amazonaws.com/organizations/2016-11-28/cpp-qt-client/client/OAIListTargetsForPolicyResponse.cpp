...
OAIListTargetsForPolicyResponse::OAIListTargetsForPolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTargetsForPolicyResponse::OAIListTargetsForPolicyResponse() {
    this->initializeModel();
}

OAIListTargetsForPolicyResponse::~OAIListTargetsForPolicyResponse() {}

void OAIListTargetsForPolicyResponse::initializeModel() {
...
void OAIListTargetsForPolicyResponse::fromJson(QString jsonString) {
...
void OAIListTargetsForPolicyResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListTargetsForPolicyResponse::asJson() const {
...
QJsonObject OAIListTargetsForPolicyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_targets.isSet()) {
...
QList OAIListTargetsForPolicyResponse::getTargets() const {
    return m_targets;
}
void OAIListTargetsForPolicyResponse::setTargets(const QList &targets) {
    m_targets = targets;
    m_targets_isSet = true;
}

bool OAIListTargetsForPolicyResponse::is_targets_Set() const{
    return m_targets_isSet;
}

bool OAIListTargetsForPolicyResponse::is_targets_Valid() const{
    return m_targets_isValid;
}

QString OAIListTargetsForPolicyResponse::getNextToken() const {
    return m_next_token;
}
void OAIListTargetsForPolicyResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListTargetsForPolicyResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListTargetsForPolicyResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListTargetsForPolicyResponse::isSet() const {
...
bool OAIListTargetsForPolicyResponse::isValid() const {
