...
OAIDescribeEffectivePolicyResponse::OAIDescribeEffectivePolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEffectivePolicyResponse::OAIDescribeEffectivePolicyResponse() {
    this->initializeModel();
}

OAIDescribeEffectivePolicyResponse::~OAIDescribeEffectivePolicyResponse() {}

void OAIDescribeEffectivePolicyResponse::initializeModel() {

    m_effective_policy_isSet = false;
    m_effective_policy_isValid = false;
}

void OAIDescribeEffectivePolicyResponse::fromJson(QString jsonString) {
...
void OAIDescribeEffectivePolicyResponse::fromJsonObject(QJsonObject json) {

    m_effective_policy_isValid = ::OpenAPI::fromJsonValue(m_effective_policy, json[QString("EffectivePolicy")]);
    m_effective_policy_isSet = !json[QString("EffectivePolicy")].isNull() && m_effective_policy_isValid;
}

QString OAIDescribeEffectivePolicyResponse::asJson() const {
...
QJsonObject OAIDescribeEffectivePolicyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_effective_policy.isSet()) {
        obj.insert(QString("EffectivePolicy"), ::OpenAPI::toJsonValue(m_effective_policy));
    }
    return obj;
}

OAIDescribeEffectivePolicyResponse_EffectivePolicy OAIDescribeEffectivePolicyResponse::getEffectivePolicy() const {
    return m_effective_policy;
}
void OAIDescribeEffectivePolicyResponse::setEffectivePolicy(const OAIDescribeEffectivePolicyResponse_EffectivePolicy &effective_policy) {
    m_effective_policy = effective_policy;
    m_effective_policy_isSet = true;
}

bool OAIDescribeEffectivePolicyResponse::is_effective_policy_Set() const{
    return m_effective_policy_isSet;
}

bool OAIDescribeEffectivePolicyResponse::is_effective_policy_Valid() const{
    return m_effective_policy_isValid;
}

bool OAIDescribeEffectivePolicyResponse::isSet() const {
...
bool OAIDescribeEffectivePolicyResponse::isValid() const {
