...
/*
 * OAIListOrganizationalUnitsForParentRequest.h
 *
 * 
 */

#ifndef OAIListOrganizationalUnitsForParentRequest_H
#define OAIListOrganizationalUnitsForParentRequest_H
...
class OAIListOrganizationalUnitsForParentRequest : public OAIObject {
public:
    OAIListOrganizationalUnitsForParentRequest();
    OAIListOrganizationalUnitsForParentRequest(QString json);
    ~OAIListOrganizationalUnitsForParentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListOrganizationalUnitsForParentRequest)

#endif // OAIListOrganizationalUnitsForParentRequest_H
