...
OAIListHandshakesForOrganizationRequest_Filter::OAIListHandshakesForOrganizationRequest_Filter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListHandshakesForOrganizationRequest_Filter::OAIListHandshakesForOrganizationRequest_Filter() {
    this->initializeModel();
}

OAIListHandshakesForOrganizationRequest_Filter::~OAIListHandshakesForOrganizationRequest_Filter() {}

void OAIListHandshakesForOrganizationRequest_Filter::initializeModel() {
...
void OAIListHandshakesForOrganizationRequest_Filter::fromJson(QString jsonString) {
...
void OAIListHandshakesForOrganizationRequest_Filter::fromJsonObject(QJsonObject json) {
...
QString OAIListHandshakesForOrganizationRequest_Filter::asJson() const {
...
QJsonObject OAIListHandshakesForOrganizationRequest_Filter::asJsonObject() const {
    QJsonObject obj;
...
OAIActionType OAIListHandshakesForOrganizationRequest_Filter::getActionType() const {
    return m_action_type;
}
void OAIListHandshakesForOrganizationRequest_Filter::setActionType(const OAIActionType &action_type) {
    m_action_type = action_type;
    m_action_type_isSet = true;
}

bool OAIListHandshakesForOrganizationRequest_Filter::is_action_type_Set() const{
    return m_action_type_isSet;
}

bool OAIListHandshakesForOrganizationRequest_Filter::is_action_type_Valid() const{
    return m_action_type_isValid;
}

QString OAIListHandshakesForOrganizationRequest_Filter::getParentHandshakeId() const {
    return m_parent_handshake_id;
}
void OAIListHandshakesForOrganizationRequest_Filter::setParentHandshakeId(const QString &parent_handshake_id) {
    m_parent_handshake_id = parent_handshake_id;
    m_parent_handshake_id_isSet = true;
}

bool OAIListHandshakesForOrganizationRequest_Filter::is_parent_handshake_id_Set() const{
    return m_parent_handshake_id_isSet;
}

bool OAIListHandshakesForOrganizationRequest_Filter::is_parent_handshake_id_Valid() const{
    return m_parent_handshake_id_isValid;
}

bool OAIListHandshakesForOrganizationRequest_Filter::isSet() const {
...
bool OAIListHandshakesForOrganizationRequest_Filter::isValid() const {
