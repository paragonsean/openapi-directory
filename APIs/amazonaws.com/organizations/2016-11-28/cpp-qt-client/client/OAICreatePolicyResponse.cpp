...
OAICreatePolicyResponse::OAICreatePolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePolicyResponse::OAICreatePolicyResponse() {
    this->initializeModel();
}

OAICreatePolicyResponse::~OAICreatePolicyResponse() {}

void OAICreatePolicyResponse::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAICreatePolicyResponse::fromJson(QString jsonString) {
...
void OAICreatePolicyResponse::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAICreatePolicyResponse::asJson() const {
...
QJsonObject OAICreatePolicyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAICreatePolicyResponse_Policy OAICreatePolicyResponse::getPolicy() const {
    return m_policy;
}
void OAICreatePolicyResponse::setPolicy(const OAICreatePolicyResponse_Policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAICreatePolicyResponse::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAICreatePolicyResponse::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAICreatePolicyResponse::isSet() const {
...
bool OAICreatePolicyResponse::isValid() const {
