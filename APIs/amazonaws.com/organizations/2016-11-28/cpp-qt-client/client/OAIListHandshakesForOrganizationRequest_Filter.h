...
/*
 * OAIListHandshakesForOrganizationRequest_Filter.h
 *
 * 
 */

#ifndef OAIListHandshakesForOrganizationRequest_Filter_H
#define OAIListHandshakesForOrganizationRequest_Filter_H
...
class OAIListHandshakesForOrganizationRequest_Filter : public OAIObject {
public:
    OAIListHandshakesForOrganizationRequest_Filter();
    OAIListHandshakesForOrganizationRequest_Filter(QString json);
    ~OAIListHandshakesForOrganizationRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHandshakesForOrganizationRequest_Filter)

#endif // OAIListHandshakesForOrganizationRequest_Filter_H
