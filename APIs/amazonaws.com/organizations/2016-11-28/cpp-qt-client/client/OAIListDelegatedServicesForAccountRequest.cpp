...
OAIListDelegatedServicesForAccountRequest::OAIListDelegatedServicesForAccountRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDelegatedServicesForAccountRequest::OAIListDelegatedServicesForAccountRequest() {
    this->initializeModel();
}

OAIListDelegatedServicesForAccountRequest::~OAIListDelegatedServicesForAccountRequest() {}

void OAIListDelegatedServicesForAccountRequest::initializeModel() {
...
void OAIListDelegatedServicesForAccountRequest::fromJson(QString jsonString) {
...
void OAIListDelegatedServicesForAccountRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListDelegatedServicesForAccountRequest::asJson() const {
...
QJsonObject OAIListDelegatedServicesForAccountRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListDelegatedServicesForAccountRequest::getAccountId() const {
    return m_account_id;
}
void OAIListDelegatedServicesForAccountRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIListDelegatedServicesForAccountRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIListDelegatedServicesForAccountRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIListDelegatedServicesForAccountRequest::getNextToken() const {
    return m_next_token;
}
void OAIListDelegatedServicesForAccountRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDelegatedServicesForAccountRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDelegatedServicesForAccountRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListDelegatedServicesForAccountRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListDelegatedServicesForAccountRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListDelegatedServicesForAccountRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListDelegatedServicesForAccountRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListDelegatedServicesForAccountRequest::isSet() const {
...
bool OAIListDelegatedServicesForAccountRequest::isValid() const {
