...
OAIDisablePolicyTypeRequest::OAIDisablePolicyTypeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisablePolicyTypeRequest::OAIDisablePolicyTypeRequest() {
    this->initializeModel();
}

OAIDisablePolicyTypeRequest::~OAIDisablePolicyTypeRequest() {}

void OAIDisablePolicyTypeRequest::initializeModel() {
...
void OAIDisablePolicyTypeRequest::fromJson(QString jsonString) {
...
void OAIDisablePolicyTypeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDisablePolicyTypeRequest::asJson() const {
...
QJsonObject OAIDisablePolicyTypeRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_root_id_isSet) {
...
QString OAIDisablePolicyTypeRequest::getRootId() const {
    return m_root_id;
}
void OAIDisablePolicyTypeRequest::setRootId(const QString &root_id) {
    m_root_id = root_id;
    m_root_id_isSet = true;
}

bool OAIDisablePolicyTypeRequest::is_root_id_Set() const{
    return m_root_id_isSet;
}

bool OAIDisablePolicyTypeRequest::is_root_id_Valid() const{
    return m_root_id_isValid;
}

OAIPolicyType OAIDisablePolicyTypeRequest::getPolicyType() const {
    return m_policy_type;
}
void OAIDisablePolicyTypeRequest::setPolicyType(const OAIPolicyType &policy_type) {
    m_policy_type = policy_type;
    m_policy_type_isSet = true;
}

bool OAIDisablePolicyTypeRequest::is_policy_type_Set() const{
    return m_policy_type_isSet;
}

bool OAIDisablePolicyTypeRequest::is_policy_type_Valid() const{
    return m_policy_type_isValid;
}

bool OAIDisablePolicyTypeRequest::isSet() const {
...
bool OAIDisablePolicyTypeRequest::isValid() const {
