...
/*
 * OAIEnablePolicyTypeRequest.h
 *
 * 
 */

#ifndef OAIEnablePolicyTypeRequest_H
#define OAIEnablePolicyTypeRequest_H
...
class OAIEnablePolicyTypeRequest : public OAIObject {
public:
    OAIEnablePolicyTypeRequest();
    OAIEnablePolicyTypeRequest(QString json);
    ~OAIEnablePolicyTypeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnablePolicyTypeRequest)

#endif // OAIEnablePolicyTypeRequest_H
