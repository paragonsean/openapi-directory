...
/*
 * OAIListPoliciesForTargetRequest.h
 *
 * 
 */

#ifndef OAIListPoliciesForTargetRequest_H
#define OAIListPoliciesForTargetRequest_H
...
class OAIListPoliciesForTargetRequest : public OAIObject {
public:
    OAIListPoliciesForTargetRequest();
    OAIListPoliciesForTargetRequest(QString json);
    ~OAIListPoliciesForTargetRequest() override;
    ...
    OAIPolicyType getFilter() const;
    void setFilter(const OAIPolicyType &filter);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPoliciesForTargetRequest)

#endif // OAIListPoliciesForTargetRequest_H
