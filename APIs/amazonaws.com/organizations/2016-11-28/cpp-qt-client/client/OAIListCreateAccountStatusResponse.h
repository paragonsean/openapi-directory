...
/*
 * OAIListCreateAccountStatusResponse.h
 *
 * 
 */

#ifndef OAIListCreateAccountStatusResponse_H
#define OAIListCreateAccountStatusResponse_H
...
class OAIListCreateAccountStatusResponse : public OAIObject {
public:
    OAIListCreateAccountStatusResponse();
    OAIListCreateAccountStatusResponse(QString json);
    ~OAIListCreateAccountStatusResponse() override;
    ...
    QList getCreateAccountStatuses() const;
    void setCreateAccountStatuses(const QList &create_account_statuses);
    bool is_create_account_statuses_Set() const;
    bool is_create_account_statuses_Valid() const;
...
private:
    ...
    QList m_create_account_statuses;
    bool m_create_account_statuses_isSet;
    bool m_create_account_statuses_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCreateAccountStatusResponse)

#endif // OAIListCreateAccountStatusResponse_H
