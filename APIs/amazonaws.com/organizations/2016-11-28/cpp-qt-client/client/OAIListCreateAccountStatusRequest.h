...
/*
 * OAIListCreateAccountStatusRequest.h
 *
 * 
 */

#ifndef OAIListCreateAccountStatusRequest_H
#define OAIListCreateAccountStatusRequest_H
...
class OAIListCreateAccountStatusRequest : public OAIObject {
public:
    OAIListCreateAccountStatusRequest();
    OAIListCreateAccountStatusRequest(QString json);
    ~OAIListCreateAccountStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCreateAccountStatusRequest)

#endif // OAIListCreateAccountStatusRequest_H
