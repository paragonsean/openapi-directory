...
/*
 * OAIListDelegatedServicesForAccountRequest.h
 *
 * 
 */

#ifndef OAIListDelegatedServicesForAccountRequest_H
#define OAIListDelegatedServicesForAccountRequest_H
...
class OAIListDelegatedServicesForAccountRequest : public OAIObject {
public:
    OAIListDelegatedServicesForAccountRequest();
    OAIListDelegatedServicesForAccountRequest(QString json);
    ~OAIListDelegatedServicesForAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDelegatedServicesForAccountRequest)

#endif // OAIListDelegatedServicesForAccountRequest_H
