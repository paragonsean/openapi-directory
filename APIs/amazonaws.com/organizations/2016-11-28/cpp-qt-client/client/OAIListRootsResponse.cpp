...
OAIListRootsResponse::OAIListRootsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRootsResponse::OAIListRootsResponse() {
    this->initializeModel();
}

OAIListRootsResponse::~OAIListRootsResponse() {}

void OAIListRootsResponse::initializeModel() {
...
void OAIListRootsResponse::fromJson(QString jsonString) {
...
void OAIListRootsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListRootsResponse::asJson() const {
...
QJsonObject OAIListRootsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_roots.isSet()) {
...
QList OAIListRootsResponse::getRoots() const {
    return m_roots;
}
void OAIListRootsResponse::setRoots(const QList &roots) {
    m_roots = roots;
    m_roots_isSet = true;
}

bool OAIListRootsResponse::is_roots_Set() const{
    return m_roots_isSet;
}

bool OAIListRootsResponse::is_roots_Valid() const{
    return m_roots_isValid;
}

QString OAIListRootsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListRootsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListRootsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListRootsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListRootsResponse::isSet() const {
...
bool OAIListRootsResponse::isValid() const {
