...
/*
 * OAIDescribePolicyResponse.h
 *
 * 
 */

#ifndef OAIDescribePolicyResponse_H
#define OAIDescribePolicyResponse_H
...
namespace OpenAPI {
class OAIDescribePolicyResponse_Policy;

class OAIDescribePolicyResponse : public OAIObject {
public:
    OAIDescribePolicyResponse();
    OAIDescribePolicyResponse(QString json);
    ~OAIDescribePolicyResponse() override;
    ...
    OAIDescribePolicyResponse_Policy getPolicy() const;
    void setPolicy(const OAIDescribePolicyResponse_Policy &policy);
...
private:
    ...
    OAIDescribePolicyResponse_Policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePolicyResponse)

#endif // OAIDescribePolicyResponse_H
