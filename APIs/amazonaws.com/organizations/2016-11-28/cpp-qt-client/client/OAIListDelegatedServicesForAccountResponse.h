...
/*
 * OAIListDelegatedServicesForAccountResponse.h
 *
 * 
 */

#ifndef OAIListDelegatedServicesForAccountResponse_H
#define OAIListDelegatedServicesForAccountResponse_H
...
class OAIListDelegatedServicesForAccountResponse : public OAIObject {
public:
    OAIListDelegatedServicesForAccountResponse();
    OAIListDelegatedServicesForAccountResponse(QString json);
    ~OAIListDelegatedServicesForAccountResponse() override;
    ...
    QList getDelegatedServices() const;
    void setDelegatedServices(const QList &delegated_services);
    bool is_delegated_services_Set() const;
    bool is_delegated_services_Valid() const;
...
private:
    ...
    QList m_delegated_services;
    bool m_delegated_services_isSet;
    bool m_delegated_services_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDelegatedServicesForAccountResponse)

#endif // OAIListDelegatedServicesForAccountResponse_H
