...
/*
 * OAIRegisterDelegatedAdministratorRequest.h
 *
 * 
 */

#ifndef OAIRegisterDelegatedAdministratorRequest_H
#define OAIRegisterDelegatedAdministratorRequest_H
...
class OAIRegisterDelegatedAdministratorRequest : public OAIObject {
public:
    OAIRegisterDelegatedAdministratorRequest();
    OAIRegisterDelegatedAdministratorRequest(QString json);
    ~OAIRegisterDelegatedAdministratorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterDelegatedAdministratorRequest)

#endif // OAIRegisterDelegatedAdministratorRequest_H
