...
/*
 * OAIDescribePolicyRequest.h
 *
 * 
 */

#ifndef OAIDescribePolicyRequest_H
#define OAIDescribePolicyRequest_H
...
class OAIDescribePolicyRequest : public OAIObject {
public:
    OAIDescribePolicyRequest();
    OAIDescribePolicyRequest(QString json);
    ~OAIDescribePolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePolicyRequest)

#endif // OAIDescribePolicyRequest_H
