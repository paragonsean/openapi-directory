...
/*
 * OAIHandshakePartyType.h
 *
 * 
 */

#ifndef OAIHandshakePartyType_H
#define OAIHandshakePartyType_H
...
class OAIHandshakePartyType : public OAIEnum {
public:
    OAIHandshakePartyType();
    OAIHandshakePartyType(QString json);
    ~OAIHandshakePartyType() override;
    ...
    enum class eOAIHandshakePartyType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACCOUNT, 
        ORGANIZATION, 
        EMAIL
    };
    OAIHandshakePartyType::eOAIHandshakePartyType getValue() const;
    void setValue(const OAIHandshakePartyType::eOAIHandshakePartyType& value);
...
private:
    ...
    eOAIHandshakePartyType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHandshakePartyType)

#endif // OAIHandshakePartyType_H
