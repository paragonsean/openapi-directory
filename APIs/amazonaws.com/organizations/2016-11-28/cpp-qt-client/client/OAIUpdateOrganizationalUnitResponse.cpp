...
OAIUpdateOrganizationalUnitResponse::OAIUpdateOrganizationalUnitResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateOrganizationalUnitResponse::OAIUpdateOrganizationalUnitResponse() {
    this->initializeModel();
}

OAIUpdateOrganizationalUnitResponse::~OAIUpdateOrganizationalUnitResponse() {}

void OAIUpdateOrganizationalUnitResponse::initializeModel() {

    m_organizational_unit_isSet = false;
    m_organizational_unit_isValid = false;
}

void OAIUpdateOrganizationalUnitResponse::fromJson(QString jsonString) {
...
void OAIUpdateOrganizationalUnitResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateOrganizationalUnitResponse::asJson() const {
...
QJsonObject OAIUpdateOrganizationalUnitResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateOrganizationalUnitResponse_OrganizationalUnit OAIUpdateOrganizationalUnitResponse::getOrganizationalUnit() const {
    return m_organizational_unit;
}
void OAIUpdateOrganizationalUnitResponse::setOrganizationalUnit(const OAIUpdateOrganizationalUnitResponse_OrganizationalUnit &organizational_unit) {
    m_organizational_unit = organizational_unit;
    m_organizational_unit_isSet = true;
}

bool OAIUpdateOrganizationalUnitResponse::is_organizational_unit_Set() const{
    return m_organizational_unit_isSet;
}

bool OAIUpdateOrganizationalUnitResponse::is_organizational_unit_Valid() const{
    return m_organizational_unit_isValid;
}

bool OAIUpdateOrganizationalUnitResponse::isSet() const {
...
bool OAIUpdateOrganizationalUnitResponse::isValid() const {
