...
OAIEnableAWSServiceAccessRequest::OAIEnableAWSServiceAccessRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnableAWSServiceAccessRequest::OAIEnableAWSServiceAccessRequest() {
    this->initializeModel();
}

OAIEnableAWSServiceAccessRequest::~OAIEnableAWSServiceAccessRequest() {}

void OAIEnableAWSServiceAccessRequest::initializeModel() {

    m_service_principal_isSet = false;
    m_service_principal_isValid = false;
}

void OAIEnableAWSServiceAccessRequest::fromJson(QString jsonString) {
...
void OAIEnableAWSServiceAccessRequest::fromJsonObject(QJsonObject json) {
...
QString OAIEnableAWSServiceAccessRequest::asJson() const {
...
QJsonObject OAIEnableAWSServiceAccessRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEnableAWSServiceAccessRequest::getServicePrincipal() const {
    return m_service_principal;
}
void OAIEnableAWSServiceAccessRequest::setServicePrincipal(const QString &service_principal) {
    m_service_principal = service_principal;
    m_service_principal_isSet = true;
}

bool OAIEnableAWSServiceAccessRequest::is_service_principal_Set() const{
    return m_service_principal_isSet;
}

bool OAIEnableAWSServiceAccessRequest::is_service_principal_Valid() const{
    return m_service_principal_isValid;
}

bool OAIEnableAWSServiceAccessRequest::isSet() const {
...
bool OAIEnableAWSServiceAccessRequest::isValid() const {
