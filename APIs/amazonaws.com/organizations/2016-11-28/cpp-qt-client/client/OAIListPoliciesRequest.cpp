...
OAIListPoliciesRequest::OAIListPoliciesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPoliciesRequest::OAIListPoliciesRequest() {
    this->initializeModel();
}

OAIListPoliciesRequest::~OAIListPoliciesRequest() {}

void OAIListPoliciesRequest::initializeModel() {
...
void OAIListPoliciesRequest::fromJson(QString jsonString) {
...
void OAIListPoliciesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListPoliciesRequest::asJson() const {
...
QJsonObject OAIListPoliciesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_filter.isSet()) {
...
OAIPolicyType OAIListPoliciesRequest::getFilter() const {
    return m_filter;
}
void OAIListPoliciesRequest::setFilter(const OAIPolicyType &filter) {
    m_filter = filter;
    m_filter_isSet = true;
}

bool OAIListPoliciesRequest::is_filter_Set() const{
    return m_filter_isSet;
}

bool OAIListPoliciesRequest::is_filter_Valid() const{
    return m_filter_isValid;
}

QString OAIListPoliciesRequest::getNextToken() const {
    return m_next_token;
}
void OAIListPoliciesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPoliciesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPoliciesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListPoliciesRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListPoliciesRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListPoliciesRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListPoliciesRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListPoliciesRequest::isSet() const {
...
bool OAIListPoliciesRequest::isValid() const {
