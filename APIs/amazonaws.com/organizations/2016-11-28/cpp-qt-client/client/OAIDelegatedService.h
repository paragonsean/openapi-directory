...
class OAIDelegatedService : public OAIObject {
public:
    OAIDelegatedService();
    OAIDelegatedService(QString json);
    ~OAIDelegatedService() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDelegatedService)

#endif // OAIDelegatedService_H
