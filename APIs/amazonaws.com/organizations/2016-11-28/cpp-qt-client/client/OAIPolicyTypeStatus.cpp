...
OAIPolicyTypeStatus::OAIPolicyTypeStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyTypeStatus::OAIPolicyTypeStatus() {
    this->initializeModel();
}

OAIPolicyTypeStatus::~OAIPolicyTypeStatus() {}

void OAIPolicyTypeStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPolicyTypeStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPolicyTypeStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ENABLED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyTypeStatus::ENABLED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PENDING_ENABLE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyTypeStatus::PENDING_ENABLE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PENDING_DISABLE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyTypeStatus::PENDING_DISABLE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPolicyTypeStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPolicyTypeStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPolicyTypeStatus::ENABLED:
            val = "ENABLED";
            break;
        case eOAIPolicyTypeStatus::PENDING_ENABLE:
            val = "PENDING_ENABLE";
            break;
        case eOAIPolicyTypeStatus::PENDING_DISABLE:
            val = "PENDING_DISABLE";
            break;
        default:
            break;
...
QJsonValue OAIPolicyTypeStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPolicyTypeStatus::eOAIPolicyTypeStatus OAIPolicyTypeStatus::getValue() const {
    return m_value;
}

void OAIPolicyTypeStatus::setValue(const OAIPolicyTypeStatus::eOAIPolicyTypeStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPolicyTypeStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIPolicyTypeStatus::isValid() const {
