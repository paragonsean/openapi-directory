...
OAICancelHandshakeRequest::OAICancelHandshakeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICancelHandshakeRequest::OAICancelHandshakeRequest() {
    this->initializeModel();
}

OAICancelHandshakeRequest::~OAICancelHandshakeRequest() {}

void OAICancelHandshakeRequest::initializeModel() {

    m_handshake_id_isSet = false;
    m_handshake_id_isValid = false;
}

void OAICancelHandshakeRequest::fromJson(QString jsonString) {
...
void OAICancelHandshakeRequest::fromJsonObject(QJsonObject json) {
...
QString OAICancelHandshakeRequest::asJson() const {
...
QJsonObject OAICancelHandshakeRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICancelHandshakeRequest::getHandshakeId() const {
    return m_handshake_id;
}
void OAICancelHandshakeRequest::setHandshakeId(const QString &handshake_id) {
    m_handshake_id = handshake_id;
    m_handshake_id_isSet = true;
}

bool OAICancelHandshakeRequest::is_handshake_id_Set() const{
    return m_handshake_id_isSet;
}

bool OAICancelHandshakeRequest::is_handshake_id_Valid() const{
    return m_handshake_id_isValid;
}

bool OAICancelHandshakeRequest::isSet() const {
...
bool OAICancelHandshakeRequest::isValid() const {
