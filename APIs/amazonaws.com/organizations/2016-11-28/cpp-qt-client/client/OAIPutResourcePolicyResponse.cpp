...
OAIDescribeResourcePolicyResponse_ResourcePolicy OAIPutResourcePolicyResponse::getResourcePolicy() const {
    return m_resource_policy;
}
void OAIPutResourcePolicyResponse::setResourcePolicy(const OAIDescribeResourcePolicyResponse_ResourcePolicy &resource_policy) {
