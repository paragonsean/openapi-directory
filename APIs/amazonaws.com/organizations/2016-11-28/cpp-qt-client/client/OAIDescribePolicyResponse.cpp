...
OAIDescribePolicyResponse::OAIDescribePolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribePolicyResponse::OAIDescribePolicyResponse() {
    this->initializeModel();
}

OAIDescribePolicyResponse::~OAIDescribePolicyResponse() {}

void OAIDescribePolicyResponse::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIDescribePolicyResponse::fromJson(QString jsonString) {
...
void OAIDescribePolicyResponse::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAIDescribePolicyResponse::asJson() const {
...
QJsonObject OAIDescribePolicyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAIDescribePolicyResponse_Policy OAIDescribePolicyResponse::getPolicy() const {
    return m_policy;
}
void OAIDescribePolicyResponse::setPolicy(const OAIDescribePolicyResponse_Policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIDescribePolicyResponse::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIDescribePolicyResponse::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIDescribePolicyResponse::isSet() const {
...
bool OAIDescribePolicyResponse::isValid() const {
