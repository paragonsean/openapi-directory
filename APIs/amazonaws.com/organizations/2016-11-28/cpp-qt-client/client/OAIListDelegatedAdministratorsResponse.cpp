...
OAIListDelegatedAdministratorsResponse::OAIListDelegatedAdministratorsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDelegatedAdministratorsResponse::OAIListDelegatedAdministratorsResponse() {
    this->initializeModel();
}

OAIListDelegatedAdministratorsResponse::~OAIListDelegatedAdministratorsResponse() {}

void OAIListDelegatedAdministratorsResponse::initializeModel() {

    m_delegated_administrators_isSet = false;
    m_delegated_administrators_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListDelegatedAdministratorsResponse::fromJson(QString jsonString) {
...
void OAIListDelegatedAdministratorsResponse::fromJsonObject(QJsonObject json) {

    m_delegated_administrators_isValid = ::OpenAPI::fromJsonValue(m_delegated_administrators, json[QString("DelegatedAdministrators")]);
    m_delegated_administrators_isSet = !json[QString("DelegatedAdministrators")].isNull() && m_delegated_administrators_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListDelegatedAdministratorsResponse::asJson() const {
...
QJsonObject OAIListDelegatedAdministratorsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_delegated_administrators.isSet()) {
        obj.insert(QString("DelegatedAdministrators"), ::OpenAPI::toJsonValue(m_delegated_administrators));
    }
...
QList OAIListDelegatedAdministratorsResponse::getDelegatedAdministrators() const {
    return m_delegated_administrators;
}
void OAIListDelegatedAdministratorsResponse::setDelegatedAdministrators(const QList &delegated_administrators) {
    m_delegated_administrators = delegated_administrators;
    m_delegated_administrators_isSet = true;
}

bool OAIListDelegatedAdministratorsResponse::is_delegated_administrators_Set() const{
    return m_delegated_administrators_isSet;
}

bool OAIListDelegatedAdministratorsResponse::is_delegated_administrators_Valid() const{
    return m_delegated_administrators_isValid;
}

QString OAIListDelegatedAdministratorsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListDelegatedAdministratorsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDelegatedAdministratorsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDelegatedAdministratorsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListDelegatedAdministratorsResponse::isSet() const {
...
bool OAIListDelegatedAdministratorsResponse::isValid() const {
