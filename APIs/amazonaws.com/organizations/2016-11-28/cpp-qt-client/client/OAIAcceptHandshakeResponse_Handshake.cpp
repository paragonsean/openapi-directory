...
OAIAcceptHandshakeResponse_Handshake::OAIAcceptHandshakeResponse_Handshake(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAcceptHandshakeResponse_Handshake::OAIAcceptHandshakeResponse_Handshake() {
    this->initializeModel();
}

OAIAcceptHandshakeResponse_Handshake::~OAIAcceptHandshakeResponse_Handshake() {}

void OAIAcceptHandshakeResponse_Handshake::initializeModel() {
...
void OAIAcceptHandshakeResponse_Handshake::fromJson(QString jsonString) {
...
void OAIAcceptHandshakeResponse_Handshake::fromJsonObject(QJsonObject json) {
...
QString OAIAcceptHandshakeResponse_Handshake::asJson() const {
...
QJsonObject OAIAcceptHandshakeResponse_Handshake::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIAcceptHandshakeResponse_Handshake::getId() const {
    return m_id;
}
void OAIAcceptHandshakeResponse_Handshake::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAcceptHandshakeResponse_Handshake::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAcceptHandshakeResponse_Handshake::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAcceptHandshakeResponse_Handshake::getArn() const {
    return m_arn;
}
void OAIAcceptHandshakeResponse_Handshake::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIAcceptHandshakeResponse_Handshake::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIAcceptHandshakeResponse_Handshake::is_arn_Valid() const{
    return m_arn_isValid;
}

QList OAIAcceptHandshakeResponse_Handshake::getParties() const {
    return m_parties;
}
void OAIAcceptHandshakeResponse_Handshake::setParties(const QList &parties) {
    m_parties = parties;
    m_parties_isSet = true;
}

bool OAIAcceptHandshakeResponse_Handshake::is_parties_Set() const{
    return m_parties_isSet;
}

bool OAIAcceptHandshakeResponse_Handshake::is_parties_Valid() const{
    return m_parties_isValid;
}

OAIHandshakeState OAIAcceptHandshakeResponse_Handshake::getState() const {
    return m_state;
}
void OAIAcceptHandshakeResponse_Handshake::setState(const OAIHandshakeState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIAcceptHandshakeResponse_Handshake::is_state_Set() const{
    return m_state_isSet;
}

bool OAIAcceptHandshakeResponse_Handshake::is_state_Valid() const{
    return m_state_isValid;
}

QDateTime OAIAcceptHandshakeResponse_Handshake::getRequestedTimestamp() const {
    return m_requested_timestamp;
}
void OAIAcceptHandshakeResponse_Handshake::setRequestedTimestamp(const QDateTime &requested_timestamp) {
    m_requested_timestamp = requested_timestamp;
    m_requested_timestamp_isSet = true;
}

bool OAIAcceptHandshakeResponse_Handshake::is_requested_timestamp_Set() const{
    return m_requested_timestamp_isSet;
}

bool OAIAcceptHandshakeResponse_Handshake::is_requested_timestamp_Valid() const{
    return m_requested_timestamp_isValid;
}

QDateTime OAIAcceptHandshakeResponse_Handshake::getExpirationTimestamp() const {
    return m_expiration_timestamp;
}
void OAIAcceptHandshakeResponse_Handshake::setExpirationTimestamp(const QDateTime &expiration_timestamp) {
    m_expiration_timestamp = expiration_timestamp;
    m_expiration_timestamp_isSet = true;
}

bool OAIAcceptHandshakeResponse_Handshake::is_expiration_timestamp_Set() const{
    return m_expiration_timestamp_isSet;
}

bool OAIAcceptHandshakeResponse_Handshake::is_expiration_timestamp_Valid() const{
    return m_expiration_timestamp_isValid;
}

OAIActionType OAIAcceptHandshakeResponse_Handshake::getAction() const {
    return m_action;
}
void OAIAcceptHandshakeResponse_Handshake::setAction(const OAIActionType &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIAcceptHandshakeResponse_Handshake::is_action_Set() const{
    return m_action_isSet;
}

bool OAIAcceptHandshakeResponse_Handshake::is_action_Valid() const{
    return m_action_isValid;
}

QList OAIAcceptHandshakeResponse_Handshake::getResources() const {
    return m_resources;
}
void OAIAcceptHandshakeResponse_Handshake::setResources(const QList &resources) {
    m_resources = resources;
    m_resources_isSet = true;
}

bool OAIAcceptHandshakeResponse_Handshake::is_resources_Set() const{
    return m_resources_isSet;
}

bool OAIAcceptHandshakeResponse_Handshake::is_resources_Valid() const{
    return m_resources_isValid;
}

bool OAIAcceptHandshakeResponse_Handshake::isSet() const {
...
bool OAIAcceptHandshakeResponse_Handshake::isValid() const {
