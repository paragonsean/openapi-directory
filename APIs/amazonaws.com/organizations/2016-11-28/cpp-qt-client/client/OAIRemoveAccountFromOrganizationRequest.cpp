...
OAIRemoveAccountFromOrganizationRequest::OAIRemoveAccountFromOrganizationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemoveAccountFromOrganizationRequest::OAIRemoveAccountFromOrganizationRequest() {
    this->initializeModel();
}

OAIRemoveAccountFromOrganizationRequest::~OAIRemoveAccountFromOrganizationRequest() {}

void OAIRemoveAccountFromOrganizationRequest::initializeModel() {

    m_account_id_isSet = false;
    m_account_id_isValid = false;
}

void OAIRemoveAccountFromOrganizationRequest::fromJson(QString jsonString) {
...
void OAIRemoveAccountFromOrganizationRequest::fromJsonObject(QJsonObject json) {

    m_account_id_isValid = ::OpenAPI::fromJsonValue(m_account_id, json[QString("AccountId")]);
    m_account_id_isSet = !json[QString("AccountId")].isNull() && m_account_id_isValid;
}

QString OAIRemoveAccountFromOrganizationRequest::asJson() const {
...
QJsonObject OAIRemoveAccountFromOrganizationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRemoveAccountFromOrganizationRequest::getAccountId() const {
    return m_account_id;
}
void OAIRemoveAccountFromOrganizationRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIRemoveAccountFromOrganizationRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIRemoveAccountFromOrganizationRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

bool OAIRemoveAccountFromOrganizationRequest::isSet() const {
...
bool OAIRemoveAccountFromOrganizationRequest::isValid() const {
