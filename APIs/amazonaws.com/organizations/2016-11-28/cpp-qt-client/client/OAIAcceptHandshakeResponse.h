...
/*
 * OAIAcceptHandshakeResponse.h
 *
 * 
 */

#ifndef OAIAcceptHandshakeResponse_H
#define OAIAcceptHandshakeResponse_H

#include <QJsonObject>

#include "OAIAcceptHandshakeResponse_Handshake.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIAcceptHandshakeResponse_Handshake;

class OAIAcceptHandshakeResponse : public OAIObject {
public:
    OAIAcceptHandshakeResponse();
    OAIAcceptHandshakeResponse(QString json);
    ~OAIAcceptHandshakeResponse() override;
    ...
    OAIAcceptHandshakeResponse_Handshake getHandshake() const;
    void setHandshake(const OAIAcceptHandshakeResponse_Handshake &handshake);
...
private:
    ...
    OAIAcceptHandshakeResponse_Handshake m_handshake;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcceptHandshakeResponse)

#endif // OAIAcceptHandshakeResponse_H
