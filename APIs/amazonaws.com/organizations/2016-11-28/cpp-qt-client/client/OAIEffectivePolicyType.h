...
/*
 * OAIEffectivePolicyType.h
 *
 * 
 */

#ifndef OAIEffectivePolicyType_H
#define OAIEffectivePolicyType_H
...
class OAIEffectivePolicyType : public OAIEnum {
public:
    OAIEffectivePolicyType();
    OAIEffectivePolicyType(QString json);
    ~OAIEffectivePolicyType() override;
    ...
    enum class eOAIEffectivePolicyType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TAG_POLICY, 
        BACKUP_POLICY, 
        AISERVICES_OPT_OUT_POLICY
    };
    OAIEffectivePolicyType::eOAIEffectivePolicyType getValue() const;
    void setValue(const OAIEffectivePolicyType::eOAIEffectivePolicyType& value);
...
private:
    ...
    eOAIEffectivePolicyType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEffectivePolicyType)

#endif // OAIEffectivePolicyType_H
