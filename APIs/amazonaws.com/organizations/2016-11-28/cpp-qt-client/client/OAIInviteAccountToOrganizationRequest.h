...
/*
 * OAIInviteAccountToOrganizationRequest.h
 *
 * 
 */

#ifndef OAIInviteAccountToOrganizationRequest_H
#define OAIInviteAccountToOrganizationRequest_H
...
namespace OpenAPI {
class OAIInviteAccountToOrganizationRequest_Target;

class OAIInviteAccountToOrganizationRequest : public OAIObject {
public:
    OAIInviteAccountToOrganizationRequest();
    OAIInviteAccountToOrganizationRequest(QString json);
    ~OAIInviteAccountToOrganizationRequest() override;
    ...
    OAIInviteAccountToOrganizationRequest_Target getTarget() const;
    void setTarget(const OAIInviteAccountToOrganizationRequest_Target &target);
...
private:
    ...
    OAIInviteAccountToOrganizationRequest_Target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInviteAccountToOrganizationRequest)

#endif // OAIInviteAccountToOrganizationRequest_H
