...
OAIRegisterDelegatedAdministratorRequest::OAIRegisterDelegatedAdministratorRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegisterDelegatedAdministratorRequest::OAIRegisterDelegatedAdministratorRequest() {
    this->initializeModel();
}

OAIRegisterDelegatedAdministratorRequest::~OAIRegisterDelegatedAdministratorRequest() {}

void OAIRegisterDelegatedAdministratorRequest::initializeModel() {
...
void OAIRegisterDelegatedAdministratorRequest::fromJson(QString jsonString) {
...
void OAIRegisterDelegatedAdministratorRequest::fromJsonObject(QJsonObject json) {
...
QString OAIRegisterDelegatedAdministratorRequest::asJson() const {
...
QJsonObject OAIRegisterDelegatedAdministratorRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRegisterDelegatedAdministratorRequest::getAccountId() const {
    return m_account_id;
}
void OAIRegisterDelegatedAdministratorRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIRegisterDelegatedAdministratorRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIRegisterDelegatedAdministratorRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIRegisterDelegatedAdministratorRequest::getServicePrincipal() const {
    return m_service_principal;
}
void OAIRegisterDelegatedAdministratorRequest::setServicePrincipal(const QString &service_principal) {
    m_service_principal = service_principal;
    m_service_principal_isSet = true;
}

bool OAIRegisterDelegatedAdministratorRequest::is_service_principal_Set() const{
    return m_service_principal_isSet;
}

bool OAIRegisterDelegatedAdministratorRequest::is_service_principal_Valid() const{
    return m_service_principal_isValid;
}

bool OAIRegisterDelegatedAdministratorRequest::isSet() const {
...
bool OAIRegisterDelegatedAdministratorRequest::isValid() const {
