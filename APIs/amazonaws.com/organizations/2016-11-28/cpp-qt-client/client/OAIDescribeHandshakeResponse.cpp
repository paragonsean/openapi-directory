...
OAIDescribeHandshakeResponse::OAIDescribeHandshakeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeHandshakeResponse::OAIDescribeHandshakeResponse() {
    this->initializeModel();
}

OAIDescribeHandshakeResponse::~OAIDescribeHandshakeResponse() {}

void OAIDescribeHandshakeResponse::initializeModel() {

    m_handshake_isSet = false;
    m_handshake_isValid = false;
}

void OAIDescribeHandshakeResponse::fromJson(QString jsonString) {
...
void OAIDescribeHandshakeResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeHandshakeResponse::asJson() const {
...
QJsonObject OAIDescribeHandshakeResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeHandshakeResponse_Handshake OAIDescribeHandshakeResponse::getHandshake() const {
    return m_handshake;
}
void OAIDescribeHandshakeResponse::setHandshake(const OAIDescribeHandshakeResponse_Handshake &handshake) {
    m_handshake = handshake;
    m_handshake_isSet = true;
}

bool OAIDescribeHandshakeResponse::is_handshake_Set() const{
    return m_handshake_isSet;
}

bool OAIDescribeHandshakeResponse::is_handshake_Valid() const{
    return m_handshake_isValid;
}

bool OAIDescribeHandshakeResponse::isSet() const {
...
bool OAIDescribeHandshakeResponse::isValid() const {
