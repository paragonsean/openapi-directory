...
/*
 * OAIMoveAccountRequest.h
 *
 * 
 */

#ifndef OAIMoveAccountRequest_H
#define OAIMoveAccountRequest_H
...
class OAIMoveAccountRequest : public OAIObject {
public:
    OAIMoveAccountRequest();
    OAIMoveAccountRequest(QString json);
    ~OAIMoveAccountRequest() override;
    ...
    QString getSourceParentId() const;
    void setSourceParentId(const QString &source_parent_id);
    bool is_source_parent_id_Set() const;
    bool is_source_parent_id_Valid() const;

    QString getDestinationParentId() const;
    void setDestinationParentId(const QString &destination_parent_id);
    bool is_destination_parent_id_Set() const;
    bool is_destination_parent_id_Valid() const;
...
private:
    ...
    QString m_source_parent_id;
    bool m_source_parent_id_isSet;
    bool m_source_parent_id_isValid;

    QString m_destination_parent_id;
    bool m_destination_parent_id_isSet;
    bool m_destination_parent_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIMoveAccountRequest)

#endif // OAIMoveAccountRequest_H
