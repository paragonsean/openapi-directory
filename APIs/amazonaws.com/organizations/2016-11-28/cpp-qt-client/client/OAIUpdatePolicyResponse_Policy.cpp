...
#include "OAIUpdatePolicyResponse_Policy.h"
...
OAIUpdatePolicyResponse_Policy::OAIUpdatePolicyResponse_Policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePolicyResponse_Policy::OAIUpdatePolicyResponse_Policy() {
    this->initializeModel();
}

OAIUpdatePolicyResponse_Policy::~OAIUpdatePolicyResponse_Policy() {}

void OAIUpdatePolicyResponse_Policy::initializeModel() {
...
void OAIUpdatePolicyResponse_Policy::fromJson(QString jsonString) {
...
void OAIUpdatePolicyResponse_Policy::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePolicyResponse_Policy::asJson() const {
...
QJsonObject OAIUpdatePolicyResponse_Policy::asJsonObject() const {
    QJsonObject obj;
...
OAIPolicy_PolicySummary OAIUpdatePolicyResponse_Policy::getPolicySummary() const {
    return m_policy_summary;
}
void OAIUpdatePolicyResponse_Policy::setPolicySummary(const OAIPolicy_PolicySummary &policy_summary) {
    m_policy_summary = policy_summary;
    m_policy_summary_isSet = true;
}

bool OAIUpdatePolicyResponse_Policy::is_policy_summary_Set() const{
    return m_policy_summary_isSet;
}

bool OAIUpdatePolicyResponse_Policy::is_policy_summary_Valid() const{
    return m_policy_summary_isValid;
}

QString OAIUpdatePolicyResponse_Policy::getContent() const {
    return m_content;
}
void OAIUpdatePolicyResponse_Policy::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIUpdatePolicyResponse_Policy::is_content_Set() const{
    return m_content_isSet;
}

bool OAIUpdatePolicyResponse_Policy::is_content_Valid() const{
    return m_content_isValid;
}

bool OAIUpdatePolicyResponse_Policy::isSet() const {
...
bool OAIUpdatePolicyResponse_Policy::isValid() const {
