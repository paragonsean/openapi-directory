...
#ifndef OAIHandshake_H
#define OAIHandshake_H
...
class OAIHandshake : public OAIObject {
public:
    OAIHandshake();
    OAIHandshake(QString json);
    ~OAIHandshake() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHandshake)

#endif // OAIHandshake_H
