...
QString OAITargetType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAITargetType::ACCOUNT:
            val = "ACCOUNT";
            break;
        case eOAITargetType::ORGANIZATIONAL_UNIT:
            val = "ORGANIZATIONAL_UNIT";
            break;
        case eOAITargetType::ROOT:
            val = "ROOT";
            break;
        default:
            break;
