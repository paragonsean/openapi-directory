...
/*
 * OAIListDelegatedAdministratorsRequest.h
 *
 * 
 */

#ifndef OAIListDelegatedAdministratorsRequest_H
#define OAIListDelegatedAdministratorsRequest_H
...
class OAIListDelegatedAdministratorsRequest : public OAIObject {
public:
    OAIListDelegatedAdministratorsRequest();
    OAIListDelegatedAdministratorsRequest(QString json);
    ~OAIListDelegatedAdministratorsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDelegatedAdministratorsRequest)

#endif // OAIListDelegatedAdministratorsRequest_H
