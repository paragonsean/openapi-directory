...
#include "OAIDescribeHandshakeResponse_Handshake.h"
...
OAIDescribeHandshakeResponse_Handshake::OAIDescribeHandshakeResponse_Handshake(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeHandshakeResponse_Handshake::OAIDescribeHandshakeResponse_Handshake() {
    this->initializeModel();
}

OAIDescribeHandshakeResponse_Handshake::~OAIDescribeHandshakeResponse_Handshake() {}

void OAIDescribeHandshakeResponse_Handshake::initializeModel() {
...
void OAIDescribeHandshakeResponse_Handshake::fromJson(QString jsonString) {
...
void OAIDescribeHandshakeResponse_Handshake::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeHandshakeResponse_Handshake::asJson() const {
...
QJsonObject OAIDescribeHandshakeResponse_Handshake::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIDescribeHandshakeResponse_Handshake::getId() const {
    return m_id;
}
void OAIDescribeHandshakeResponse_Handshake::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDescribeHandshakeResponse_Handshake::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDescribeHandshakeResponse_Handshake::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDescribeHandshakeResponse_Handshake::getArn() const {
    return m_arn;
}
void OAIDescribeHandshakeResponse_Handshake::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDescribeHandshakeResponse_Handshake::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDescribeHandshakeResponse_Handshake::is_arn_Valid() const{
    return m_arn_isValid;
}

QList OAIDescribeHandshakeResponse_Handshake::getParties() const {
    return m_parties;
}
void OAIDescribeHandshakeResponse_Handshake::setParties(const QList &parties) {
    m_parties = parties;
    m_parties_isSet = true;
}

bool OAIDescribeHandshakeResponse_Handshake::is_parties_Set() const{
    return m_parties_isSet;
}

bool OAIDescribeHandshakeResponse_Handshake::is_parties_Valid() const{
    return m_parties_isValid;
}

OAIHandshakeState OAIDescribeHandshakeResponse_Handshake::getState() const {
    return m_state;
}
void OAIDescribeHandshakeResponse_Handshake::setState(const OAIHandshakeState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIDescribeHandshakeResponse_Handshake::is_state_Set() const{
    return m_state_isSet;
}

bool OAIDescribeHandshakeResponse_Handshake::is_state_Valid() const{
    return m_state_isValid;
}

QDateTime OAIDescribeHandshakeResponse_Handshake::getRequestedTimestamp() const {
    return m_requested_timestamp;
}
void OAIDescribeHandshakeResponse_Handshake::setRequestedTimestamp(const QDateTime &requested_timestamp) {
    m_requested_timestamp = requested_timestamp;
    m_requested_timestamp_isSet = true;
}

bool OAIDescribeHandshakeResponse_Handshake::is_requested_timestamp_Set() const{
    return m_requested_timestamp_isSet;
}

bool OAIDescribeHandshakeResponse_Handshake::is_requested_timestamp_Valid() const{
    return m_requested_timestamp_isValid;
}

QDateTime OAIDescribeHandshakeResponse_Handshake::getExpirationTimestamp() const {
    return m_expiration_timestamp;
}
void OAIDescribeHandshakeResponse_Handshake::setExpirationTimestamp(const QDateTime &expiration_timestamp) {
    m_expiration_timestamp = expiration_timestamp;
    m_expiration_timestamp_isSet = true;
}

bool OAIDescribeHandshakeResponse_Handshake::is_expiration_timestamp_Set() const{
    return m_expiration_timestamp_isSet;
}

bool OAIDescribeHandshakeResponse_Handshake::is_expiration_timestamp_Valid() const{
    return m_expiration_timestamp_isValid;
}

OAIActionType OAIDescribeHandshakeResponse_Handshake::getAction() const {
    return m_action;
}
void OAIDescribeHandshakeResponse_Handshake::setAction(const OAIActionType &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIDescribeHandshakeResponse_Handshake::is_action_Set() const{
    return m_action_isSet;
}

bool OAIDescribeHandshakeResponse_Handshake::is_action_Valid() const{
    return m_action_isValid;
}

QList OAIDescribeHandshakeResponse_Handshake::getResources() const {
    return m_resources;
}
void OAIDescribeHandshakeResponse_Handshake::setResources(const QList &resources) {
    m_resources = resources;
    m_resources_isSet = true;
}

bool OAIDescribeHandshakeResponse_Handshake::is_resources_Set() const{
    return m_resources_isSet;
}

bool OAIDescribeHandshakeResponse_Handshake::is_resources_Valid() const{
    return m_resources_isValid;
}

bool OAIDescribeHandshakeResponse_Handshake::isSet() const {
...
bool OAIDescribeHandshakeResponse_Handshake::isValid() const {
