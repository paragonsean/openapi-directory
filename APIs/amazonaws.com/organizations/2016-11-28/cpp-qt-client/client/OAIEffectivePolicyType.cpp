...
#include "OAIEffectivePolicyType.h"
...
OAIEffectivePolicyType::OAIEffectivePolicyType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEffectivePolicyType::OAIEffectivePolicyType() {
    this->initializeModel();
}

OAIEffectivePolicyType::~OAIEffectivePolicyType() {}

void OAIEffectivePolicyType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEffectivePolicyType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEffectivePolicyType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("TAG_POLICY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEffectivePolicyType::TAG_POLICY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("BACKUP_POLICY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEffectivePolicyType::BACKUP_POLICY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AISERVICES_OPT_OUT_POLICY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEffectivePolicyType::AISERVICES_OPT_OUT_POLICY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEffectivePolicyType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEffectivePolicyType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEffectivePolicyType::TAG_POLICY:
            val = "TAG_POLICY";
            break;
        case eOAIEffectivePolicyType::BACKUP_POLICY:
            val = "BACKUP_POLICY";
            break;
        case eOAIEffectivePolicyType::AISERVICES_OPT_OUT_POLICY:
            val = "AISERVICES_OPT_OUT_POLICY";
            break;
        default:
            break;
    }
...
QJsonValue OAIEffectivePolicyType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEffectivePolicyType::eOAIEffectivePolicyType OAIEffectivePolicyType::getValue() const {
    return m_value;
}

void OAIEffectivePolicyType::setValue(const OAIEffectivePolicyType::eOAIEffectivePolicyType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEffectivePolicyType::isSet() const {
    
    return m_value_isSet;
}

bool OAIEffectivePolicyType::isValid() const {
