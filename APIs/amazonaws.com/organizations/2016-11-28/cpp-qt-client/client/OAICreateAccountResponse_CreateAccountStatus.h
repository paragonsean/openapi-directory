...
/*
 * OAICreateAccountResponse_CreateAccountStatus.h
 *
 * 
 */

#ifndef OAICreateAccountResponse_CreateAccountStatus_H
#define OAICreateAccountResponse_CreateAccountStatus_H
...
class OAICreateAccountResponse_CreateAccountStatus : public OAIObject {
public:
    OAICreateAccountResponse_CreateAccountStatus();
    OAICreateAccountResponse_CreateAccountStatus(QString json);
    ~OAICreateAccountResponse_CreateAccountStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccountResponse_CreateAccountStatus)

#endif // OAICreateAccountResponse_CreateAccountStatus_H
