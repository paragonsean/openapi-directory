...
#ifndef OAIOrganizationalUnit_H
#define OAIOrganizationalUnit_H
...
class OAIOrganizationalUnit : public OAIObject {
public:
    OAIOrganizationalUnit();
    OAIOrganizationalUnit(QString json);
    ~OAIOrganizationalUnit() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationalUnit)

#endif // OAIOrganizationalUnit_H
