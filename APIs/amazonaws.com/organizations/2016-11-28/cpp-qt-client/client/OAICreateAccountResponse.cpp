...
OAICreateAccountResponse_CreateAccountStatus OAICreateAccountResponse::getCreateAccountStatus() const {
    return m_create_account_status;
}
void OAICreateAccountResponse::setCreateAccountStatus(const OAICreateAccountResponse_CreateAccountStatus &create_account_status) {
    m_create_account_status = create_account_status;
    m_create_account_status_isSet = true;
}

bool OAICreateAccountResponse::is_create_account_status_Set() const{
    return m_create_account_status_isSet;
}

bool OAICreateAccountResponse::is_create_account_status_Valid() const{
