...
/*
 * OAICreateOrganizationalUnitRequest.h
 *
 * 
 */

#ifndef OAICreateOrganizationalUnitRequest_H
#define OAICreateOrganizationalUnitRequest_H
...
class OAICreateOrganizationalUnitRequest : public OAIObject {
public:
    OAICreateOrganizationalUnitRequest();
    OAICreateOrganizationalUnitRequest(QString json);
    ~OAICreateOrganizationalUnitRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOrganizationalUnitRequest)

#endif // OAICreateOrganizationalUnitRequest_H
