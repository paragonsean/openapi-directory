...
OAIDeclineHandshakeRequest::OAIDeclineHandshakeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeclineHandshakeRequest::OAIDeclineHandshakeRequest() {
    this->initializeModel();
}

OAIDeclineHandshakeRequest::~OAIDeclineHandshakeRequest() {}

void OAIDeclineHandshakeRequest::initializeModel() {

    m_handshake_id_isSet = false;
    m_handshake_id_isValid = false;
}

void OAIDeclineHandshakeRequest::fromJson(QString jsonString) {
...
void OAIDeclineHandshakeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeclineHandshakeRequest::asJson() const {
...
QJsonObject OAIDeclineHandshakeRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeclineHandshakeRequest::getHandshakeId() const {
    return m_handshake_id;
}
void OAIDeclineHandshakeRequest::setHandshakeId(const QString &handshake_id) {
    m_handshake_id = handshake_id;
    m_handshake_id_isSet = true;
}

bool OAIDeclineHandshakeRequest::is_handshake_id_Set() const{
    return m_handshake_id_isSet;
}

bool OAIDeclineHandshakeRequest::is_handshake_id_Valid() const{
    return m_handshake_id_isValid;
}

bool OAIDeclineHandshakeRequest::isSet() const {
...
bool OAIDeclineHandshakeRequest::isValid() const {
