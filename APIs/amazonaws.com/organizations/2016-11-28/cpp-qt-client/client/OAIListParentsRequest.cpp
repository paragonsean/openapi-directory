...
OAIListParentsRequest::OAIListParentsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListParentsRequest::OAIListParentsRequest() {
    this->initializeModel();
}

OAIListParentsRequest::~OAIListParentsRequest() {}

void OAIListParentsRequest::initializeModel() {
...
void OAIListParentsRequest::fromJson(QString jsonString) {
...
void OAIListParentsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListParentsRequest::asJson() const {
...
QJsonObject OAIListParentsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_child_id_isSet) {
...
QString OAIListParentsRequest::getChildId() const {
    return m_child_id;
}
void OAIListParentsRequest::setChildId(const QString &child_id) {
    m_child_id = child_id;
    m_child_id_isSet = true;
}

bool OAIListParentsRequest::is_child_id_Set() const{
    return m_child_id_isSet;
}

bool OAIListParentsRequest::is_child_id_Valid() const{
    return m_child_id_isValid;
}

QString OAIListParentsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListParentsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListParentsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListParentsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListParentsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListParentsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListParentsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListParentsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListParentsRequest::isSet() const {
...
bool OAIListParentsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_child_id_isValid && true;
}
