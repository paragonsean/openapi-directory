...
/*
 * OAIListAccountsForParentResponse.h
 *
 * 
 */

#ifndef OAIListAccountsForParentResponse_H
#define OAIListAccountsForParentResponse_H
...
class OAIListAccountsForParentResponse : public OAIObject {
public:
    OAIListAccountsForParentResponse();
    OAIListAccountsForParentResponse(QString json);
    ~OAIListAccountsForParentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAccountsForParentResponse)

#endif // OAIListAccountsForParentResponse_H
