...
/*
 * OAICancelHandshakeRequest.h
 *
 * 
 */

#ifndef OAICancelHandshakeRequest_H
#define OAICancelHandshakeRequest_H
...
class OAICancelHandshakeRequest : public OAIObject {
public:
    OAICancelHandshakeRequest();
    OAICancelHandshakeRequest(QString json);
    ~OAICancelHandshakeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelHandshakeRequest)

#endif // OAICancelHandshakeRequest_H
