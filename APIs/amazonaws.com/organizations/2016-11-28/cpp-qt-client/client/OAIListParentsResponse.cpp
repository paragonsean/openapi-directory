...
OAIListParentsResponse::OAIListParentsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListParentsResponse::OAIListParentsResponse() {
    this->initializeModel();
}

OAIListParentsResponse::~OAIListParentsResponse() {}

void OAIListParentsResponse::initializeModel() {
...
void OAIListParentsResponse::fromJson(QString jsonString) {
...
void OAIListParentsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListParentsResponse::asJson() const {
...
QJsonObject OAIListParentsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_parents.isSet()) {
...
QList OAIListParentsResponse::getParents() const {
    return m_parents;
}
void OAIListParentsResponse::setParents(const QList &parents) {
    m_parents = parents;
    m_parents_isSet = true;
}

bool OAIListParentsResponse::is_parents_Set() const{
    return m_parents_isSet;
}

bool OAIListParentsResponse::is_parents_Valid() const{
    return m_parents_isValid;
}

QString OAIListParentsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListParentsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListParentsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListParentsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListParentsResponse::isSet() const {
...
bool OAIListParentsResponse::isValid() const {
