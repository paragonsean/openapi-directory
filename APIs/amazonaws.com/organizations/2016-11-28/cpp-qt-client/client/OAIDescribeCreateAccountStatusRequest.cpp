...
OAIDescribeCreateAccountStatusRequest::OAIDescribeCreateAccountStatusRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCreateAccountStatusRequest::OAIDescribeCreateAccountStatusRequest() {
    this->initializeModel();
}

OAIDescribeCreateAccountStatusRequest::~OAIDescribeCreateAccountStatusRequest() {}

void OAIDescribeCreateAccountStatusRequest::initializeModel() {

    m_create_account_request_id_isSet = false;
    m_create_account_request_id_isValid = false;
}

void OAIDescribeCreateAccountStatusRequest::fromJson(QString jsonString) {
...
void OAIDescribeCreateAccountStatusRequest::fromJsonObject(QJsonObject json) {

    m_create_account_request_id_isValid = ::OpenAPI::fromJsonValue(m_create_account_request_id, json[QString("CreateAccountRequestId")]);
    m_create_account_request_id_isSet = !json[QString("CreateAccountRequestId")].isNull() && m_create_account_request_id_isValid;
}

QString OAIDescribeCreateAccountStatusRequest::asJson() const {
...
QJsonObject OAIDescribeCreateAccountStatusRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_create_account_request_id_isSet) {
        obj.insert(QString("CreateAccountRequestId"), ::OpenAPI::toJsonValue(m_create_account_request_id));
    }
    return obj;
}

QString OAIDescribeCreateAccountStatusRequest::getCreateAccountRequestId() const {
    return m_create_account_request_id;
}
void OAIDescribeCreateAccountStatusRequest::setCreateAccountRequestId(const QString &create_account_request_id) {
    m_create_account_request_id = create_account_request_id;
    m_create_account_request_id_isSet = true;
}

bool OAIDescribeCreateAccountStatusRequest::is_create_account_request_id_Set() const{
    return m_create_account_request_id_isSet;
}

bool OAIDescribeCreateAccountStatusRequest::is_create_account_request_id_Valid() const{
    return m_create_account_request_id_isValid;
}

bool OAIDescribeCreateAccountStatusRequest::isSet() const {
...
bool OAIDescribeCreateAccountStatusRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_create_account_request_id_isValid && true;
}
