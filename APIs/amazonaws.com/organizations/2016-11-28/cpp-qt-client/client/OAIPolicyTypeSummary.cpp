...
#include "OAIPolicyTypeSummary.h"
...
OAIPolicyTypeSummary::OAIPolicyTypeSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyTypeSummary::OAIPolicyTypeSummary() {
    this->initializeModel();
}

OAIPolicyTypeSummary::~OAIPolicyTypeSummary() {}

void OAIPolicyTypeSummary::initializeModel() {
...
void OAIPolicyTypeSummary::fromJson(QString jsonString) {
...
void OAIPolicyTypeSummary::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyTypeSummary::asJson() const {
...
QJsonObject OAIPolicyTypeSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIPolicyType OAIPolicyTypeSummary::getType() const {
    return m_type;
}
void OAIPolicyTypeSummary::setType(const OAIPolicyType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPolicyTypeSummary::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPolicyTypeSummary::is_type_Valid() const{
    return m_type_isValid;
}

OAIPolicyTypeStatus OAIPolicyTypeSummary::getStatus() const {
    return m_status;
}
void OAIPolicyTypeSummary::setStatus(const OAIPolicyTypeStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPolicyTypeSummary::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPolicyTypeSummary::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPolicyTypeSummary::isSet() const {
...
bool OAIPolicyTypeSummary::isValid() const {
