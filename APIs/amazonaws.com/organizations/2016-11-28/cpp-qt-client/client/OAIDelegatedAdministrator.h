...
/*
 * OAIDelegatedAdministrator.h
 *
 * Contains information about the delegated administrator.
 */

#ifndef OAIDelegatedAdministrator_H
#define OAIDelegatedAdministrator_H
...
class OAIDelegatedAdministrator : public OAIObject {
public:
    OAIDelegatedAdministrator();
    OAIDelegatedAdministrator(QString json);
    ~OAIDelegatedAdministrator() override;
    ...
    QDateTime getDelegationEnabledDate() const;
    void setDelegationEnabledDate(const QDateTime &delegation_enabled_date);
    bool is_delegation_enabled_date_Set() const;
    bool is_delegation_enabled_date_Valid() const;
...
private:
    ...
    QDateTime m_delegation_enabled_date;
    bool m_delegation_enabled_date_isSet;
    bool m_delegation_enabled_date_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDelegatedAdministrator)

#endif // OAIDelegatedAdministrator_H
