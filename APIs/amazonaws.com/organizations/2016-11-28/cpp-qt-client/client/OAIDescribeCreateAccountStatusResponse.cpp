...
OAIDescribeCreateAccountStatusResponse::OAIDescribeCreateAccountStatusResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCreateAccountStatusResponse::OAIDescribeCreateAccountStatusResponse() {
    this->initializeModel();
}

OAIDescribeCreateAccountStatusResponse::~OAIDescribeCreateAccountStatusResponse() {}

void OAIDescribeCreateAccountStatusResponse::initializeModel() {

    m_create_account_status_isSet = false;
    m_create_account_status_isValid = false;
}

void OAIDescribeCreateAccountStatusResponse::fromJson(QString jsonString) {
...
void OAIDescribeCreateAccountStatusResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeCreateAccountStatusResponse::asJson() const {
...
QJsonObject OAIDescribeCreateAccountStatusResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeCreateAccountStatusResponse_CreateAccountStatus OAIDescribeCreateAccountStatusResponse::getCreateAccountStatus() const {
    return m_create_account_status;
}
void OAIDescribeCreateAccountStatusResponse::setCreateAccountStatus(const OAIDescribeCreateAccountStatusResponse_CreateAccountStatus &create_account_status) {
    m_create_account_status = create_account_status;
    m_create_account_status_isSet = true;
}

bool OAIDescribeCreateAccountStatusResponse::is_create_account_status_Set() const{
    return m_create_account_status_isSet;
}

bool OAIDescribeCreateAccountStatusResponse::is_create_account_status_Valid() const{
    return m_create_account_status_isValid;
}

bool OAIDescribeCreateAccountStatusResponse::isSet() const {
...
bool OAIDescribeCreateAccountStatusResponse::isValid() const {
