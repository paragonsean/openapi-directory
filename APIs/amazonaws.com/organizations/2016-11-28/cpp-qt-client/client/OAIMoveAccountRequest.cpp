...
OAIMoveAccountRequest::OAIMoveAccountRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMoveAccountRequest::OAIMoveAccountRequest() {
    this->initializeModel();
}

OAIMoveAccountRequest::~OAIMoveAccountRequest() {}

void OAIMoveAccountRequest::initializeModel() {

    m_account_id_isSet = false;
    m_account_id_isValid = false;

    m_source_parent_id_isSet = false;
    m_source_parent_id_isValid = false;

    m_destination_parent_id_isSet = false;
    m_destination_parent_id_isValid = false;
}

void OAIMoveAccountRequest::fromJson(QString jsonString) {
...
void OAIMoveAccountRequest::fromJsonObject(QJsonObject json) {

    m_account_id_isValid = ::OpenAPI::fromJsonValue(m_account_id, json[QString("AccountId")]);
    m_account_id_isSet = !json[QString("AccountId")].isNull() && m_account_id_isValid;

    m_source_parent_id_isValid = ::OpenAPI::fromJsonValue(m_source_parent_id, json[QString("SourceParentId")]);
    m_source_parent_id_isSet = !json[QString("SourceParentId")].isNull() && m_source_parent_id_isValid;

    m_destination_parent_id_isValid = ::OpenAPI::fromJsonValue(m_destination_parent_id, json[QString("DestinationParentId")]);
    m_destination_parent_id_isSet = !json[QString("DestinationParentId")].isNull() && m_destination_parent_id_isValid;
}

QString OAIMoveAccountRequest::asJson() const {
...
QJsonObject OAIMoveAccountRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_account_id_isSet) {
        obj.insert(QString("AccountId"), ::OpenAPI::toJsonValue(m_account_id));
    }
    if (m_source_parent_id_isSet) {
        obj.insert(QString("SourceParentId"), ::OpenAPI::toJsonValue(m_source_parent_id));
    }
    if (m_destination_parent_id_isSet) {
        obj.insert(QString("DestinationParentId"), ::OpenAPI::toJsonValue(m_destination_parent_id));
    }
    return obj;
}

QString OAIMoveAccountRequest::getAccountId() const {
    return m_account_id;
}
void OAIMoveAccountRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIMoveAccountRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIMoveAccountRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIMoveAccountRequest::getSourceParentId() const {
    return m_source_parent_id;
}
void OAIMoveAccountRequest::setSourceParentId(const QString &source_parent_id) {
    m_source_parent_id = source_parent_id;
    m_source_parent_id_isSet = true;
}

bool OAIMoveAccountRequest::is_source_parent_id_Set() const{
    return m_source_parent_id_isSet;
}

bool OAIMoveAccountRequest::is_source_parent_id_Valid() const{
    return m_source_parent_id_isValid;
}

QString OAIMoveAccountRequest::getDestinationParentId() const {
    return m_destination_parent_id;
}
void OAIMoveAccountRequest::setDestinationParentId(const QString &destination_parent_id) {
    m_destination_parent_id = destination_parent_id;
    m_destination_parent_id_isSet = true;
}

bool OAIMoveAccountRequest::is_destination_parent_id_Set() const{
    return m_destination_parent_id_isSet;
}

bool OAIMoveAccountRequest::is_destination_parent_id_Valid() const{
    return m_destination_parent_id_isValid;
}

bool OAIMoveAccountRequest::isSet() const {
...
bool OAIMoveAccountRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_account_id_isValid && m_source_parent_id_isValid && m_destination_parent_id_isValid && true;
}
