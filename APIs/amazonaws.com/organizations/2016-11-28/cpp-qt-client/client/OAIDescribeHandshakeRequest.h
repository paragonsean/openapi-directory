...
/*
 * OAIDescribeHandshakeRequest.h
 *
 * 
 */

#ifndef OAIDescribeHandshakeRequest_H
#define OAIDescribeHandshakeRequest_H
...
class OAIDescribeHandshakeRequest : public OAIObject {
public:
    OAIDescribeHandshakeRequest();
    OAIDescribeHandshakeRequest(QString json);
    ~OAIDescribeHandshakeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeHandshakeRequest)

#endif // OAIDescribeHandshakeRequest_H
