...
QString OAIListTagsForResourceRequest::getResourceId() const {
    return m_resource_id;
}
void OAIListTagsForResourceRequest::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIListTagsForResourceRequest::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIListTagsForResourceRequest::is_resource_id_Valid() const{
