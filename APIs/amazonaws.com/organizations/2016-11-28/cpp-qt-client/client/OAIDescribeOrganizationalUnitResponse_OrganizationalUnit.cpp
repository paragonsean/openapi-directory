...
OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::OAIDescribeOrganizationalUnitResponse_OrganizationalUnit(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::OAIDescribeOrganizationalUnitResponse_OrganizationalUnit() {
    this->initializeModel();
}

OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::~OAIDescribeOrganizationalUnitResponse_OrganizationalUnit() {}

void OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::initializeModel() {
...
void OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::fromJson(QString jsonString) {
...
void OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::asJson() const {
...
QJsonObject OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::getId() const {
    return m_id;
}
void OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::getArn() const {
    return m_arn;
}
void OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::getName() const {
    return m_name;
}
void OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::isSet() const {
...
bool OAIDescribeOrganizationalUnitResponse_OrganizationalUnit::isValid() const {
