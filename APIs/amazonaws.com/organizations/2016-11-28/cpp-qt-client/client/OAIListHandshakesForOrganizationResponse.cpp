...
OAIListHandshakesForOrganizationResponse::OAIListHandshakesForOrganizationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListHandshakesForOrganizationResponse::OAIListHandshakesForOrganizationResponse() {
    this->initializeModel();
}

OAIListHandshakesForOrganizationResponse::~OAIListHandshakesForOrganizationResponse() {}

void OAIListHandshakesForOrganizationResponse::initializeModel() {
...
void OAIListHandshakesForOrganizationResponse::fromJson(QString jsonString) {
...
void OAIListHandshakesForOrganizationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListHandshakesForOrganizationResponse::asJson() const {
...
QJsonObject OAIListHandshakesForOrganizationResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListHandshakesForOrganizationResponse::getHandshakes() const {
    return m_handshakes;
}
void OAIListHandshakesForOrganizationResponse::setHandshakes(const QList &handshakes) {
    m_handshakes = handshakes;
    m_handshakes_isSet = true;
}

bool OAIListHandshakesForOrganizationResponse::is_handshakes_Set() const{
    return m_handshakes_isSet;
}

bool OAIListHandshakesForOrganizationResponse::is_handshakes_Valid() const{
    return m_handshakes_isValid;
}

QString OAIListHandshakesForOrganizationResponse::getNextToken() const {
    return m_next_token;
}
void OAIListHandshakesForOrganizationResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListHandshakesForOrganizationResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListHandshakesForOrganizationResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListHandshakesForOrganizationResponse::isSet() const {
...
bool OAIListHandshakesForOrganizationResponse::isValid() const {
