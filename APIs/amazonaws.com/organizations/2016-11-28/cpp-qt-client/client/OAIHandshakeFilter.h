...
/*
 * OAIHandshakeFilter.h
 *
 * Specifies the criteria that are used to select the handshakes for the operation.
 */

#ifndef OAIHandshakeFilter_H
#define OAIHandshakeFilter_H
...
class OAIHandshakeFilter : public OAIObject {
public:
    OAIHandshakeFilter();
    OAIHandshakeFilter(QString json);
    ~OAIHandshakeFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHandshakeFilter)

#endif // OAIHandshakeFilter_H
