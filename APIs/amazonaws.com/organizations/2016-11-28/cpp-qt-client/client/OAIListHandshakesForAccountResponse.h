...
/*
 * OAIListHandshakesForAccountResponse.h
 *
 * 
 */

#ifndef OAIListHandshakesForAccountResponse_H
#define OAIListHandshakesForAccountResponse_H
...
class OAIListHandshakesForAccountResponse : public OAIObject {
public:
    OAIListHandshakesForAccountResponse();
    OAIListHandshakesForAccountResponse(QString json);
    ~OAIListHandshakesForAccountResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHandshakesForAccountResponse)

#endif // OAIListHandshakesForAccountResponse_H
