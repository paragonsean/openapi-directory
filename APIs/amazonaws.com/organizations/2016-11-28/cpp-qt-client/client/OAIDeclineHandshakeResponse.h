...
/*
 * OAIDeclineHandshakeResponse.h
 *
 * 
 */

#ifndef OAIDeclineHandshakeResponse_H
#define OAIDeclineHandshakeResponse_H

#include <QJsonObject>

#include "OAIDeclineHandshakeResponse_Handshake.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDeclineHandshakeResponse_Handshake;

class OAIDeclineHandshakeResponse : public OAIObject {
public:
    OAIDeclineHandshakeResponse();
    OAIDeclineHandshakeResponse(QString json);
    ~OAIDeclineHandshakeResponse() override;
    ...
    OAIDeclineHandshakeResponse_Handshake getHandshake() const;
    void setHandshake(const OAIDeclineHandshakeResponse_Handshake &handshake);
    bool is_handshake_Set() const;
    bool is_handshake_Valid() const;
...
private:
    ...
    OAIDeclineHandshakeResponse_Handshake m_handshake;
    bool m_handshake_isSet;
    bool m_handshake_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeclineHandshakeResponse)

#endif // OAIDeclineHandshakeResponse_H
