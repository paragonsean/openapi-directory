...
OAIListOrganizationalUnitsForParentResponse::OAIListOrganizationalUnitsForParentResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListOrganizationalUnitsForParentResponse::OAIListOrganizationalUnitsForParentResponse() {
    this->initializeModel();
}

OAIListOrganizationalUnitsForParentResponse::~OAIListOrganizationalUnitsForParentResponse() {}

void OAIListOrganizationalUnitsForParentResponse::initializeModel() {
...
void OAIListOrganizationalUnitsForParentResponse::fromJson(QString jsonString) {
...
void OAIListOrganizationalUnitsForParentResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListOrganizationalUnitsForParentResponse::asJson() const {
...
QJsonObject OAIListOrganizationalUnitsForParentResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListOrganizationalUnitsForParentResponse::getOrganizationalUnits() const {
    return m_organizational_units;
}
void OAIListOrganizationalUnitsForParentResponse::setOrganizationalUnits(const QList &organizational_units) {
    m_organizational_units = organizational_units;
    m_organizational_units_isSet = true;
}

bool OAIListOrganizationalUnitsForParentResponse::is_organizational_units_Set() const{
    return m_organizational_units_isSet;
}

bool OAIListOrganizationalUnitsForParentResponse::is_organizational_units_Valid() const{
    return m_organizational_units_isValid;
}

QString OAIListOrganizationalUnitsForParentResponse::getNextToken() const {
    return m_next_token;
}
void OAIListOrganizationalUnitsForParentResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListOrganizationalUnitsForParentResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListOrganizationalUnitsForParentResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListOrganizationalUnitsForParentResponse::isSet() const {
...
bool OAIListOrganizationalUnitsForParentResponse::isValid() const {
