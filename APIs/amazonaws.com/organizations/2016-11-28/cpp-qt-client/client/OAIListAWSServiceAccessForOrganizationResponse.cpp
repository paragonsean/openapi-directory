...
OAIListAWSServiceAccessForOrganizationResponse::OAIListAWSServiceAccessForOrganizationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAWSServiceAccessForOrganizationResponse::OAIListAWSServiceAccessForOrganizationResponse() {
    this->initializeModel();
}

OAIListAWSServiceAccessForOrganizationResponse::~OAIListAWSServiceAccessForOrganizationResponse() {}

void OAIListAWSServiceAccessForOrganizationResponse::initializeModel() {

    m_enabled_service_principals_isSet = false;
    m_enabled_service_principals_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListAWSServiceAccessForOrganizationResponse::fromJson(QString jsonString) {
...
void OAIListAWSServiceAccessForOrganizationResponse::fromJsonObject(QJsonObject json) {

    m_enabled_service_principals_isValid = ::OpenAPI::fromJsonValue(m_enabled_service_principals, json[QString("EnabledServicePrincipals")]);
    m_enabled_service_principals_isSet = !json[QString("EnabledServicePrincipals")].isNull() && m_enabled_service_principals_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListAWSServiceAccessForOrganizationResponse::asJson() const {
...
QJsonObject OAIListAWSServiceAccessForOrganizationResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_service_principals.isSet()) {
        obj.insert(QString("EnabledServicePrincipals"), ::OpenAPI::toJsonValue(m_enabled_service_principals));
    }
...
QList OAIListAWSServiceAccessForOrganizationResponse::getEnabledServicePrincipals() const {
    return m_enabled_service_principals;
}
void OAIListAWSServiceAccessForOrganizationResponse::setEnabledServicePrincipals(const QList &enabled_service_principals) {
    m_enabled_service_principals = enabled_service_principals;
    m_enabled_service_principals_isSet = true;
}

bool OAIListAWSServiceAccessForOrganizationResponse::is_enabled_service_principals_Set() const{
    return m_enabled_service_principals_isSet;
}

bool OAIListAWSServiceAccessForOrganizationResponse::is_enabled_service_principals_Valid() const{
    return m_enabled_service_principals_isValid;
}

QString OAIListAWSServiceAccessForOrganizationResponse::getNextToken() const {
    return m_next_token;
}
void OAIListAWSServiceAccessForOrganizationResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAWSServiceAccessForOrganizationResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAWSServiceAccessForOrganizationResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListAWSServiceAccessForOrganizationResponse::isSet() const {
...
bool OAIListAWSServiceAccessForOrganizationResponse::isValid() const {
