...
/*
 * OAIDisablePolicyTypeRequest.h
 *
 * 
 */

#ifndef OAIDisablePolicyTypeRequest_H
#define OAIDisablePolicyTypeRequest_H
...
class OAIDisablePolicyTypeRequest : public OAIObject {
public:
    OAIDisablePolicyTypeRequest();
    OAIDisablePolicyTypeRequest(QString json);
    ~OAIDisablePolicyTypeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisablePolicyTypeRequest)

#endif // OAIDisablePolicyTypeRequest_H
