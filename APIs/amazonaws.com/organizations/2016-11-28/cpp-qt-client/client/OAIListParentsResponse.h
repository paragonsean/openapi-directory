...
/*
 * OAIListParentsResponse.h
 *
 * 
 */

#ifndef OAIListParentsResponse_H
#define OAIListParentsResponse_H
...
class OAIListParentsResponse : public OAIObject {
public:
    OAIListParentsResponse();
    OAIListParentsResponse(QString json);
    ~OAIListParentsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListParentsResponse)

#endif // OAIListParentsResponse_H
