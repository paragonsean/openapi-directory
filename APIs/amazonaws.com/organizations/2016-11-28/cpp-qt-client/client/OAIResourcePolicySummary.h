...
/*
 * OAIResourcePolicySummary.h
 *
 * A structure that contains resource policy ID and Amazon Resource Name (ARN).
 */

#ifndef OAIResourcePolicySummary_H
#define OAIResourcePolicySummary_H
...
class OAIResourcePolicySummary : public OAIObject {
public:
    OAIResourcePolicySummary();
    OAIResourcePolicySummary(QString json);
    ~OAIResourcePolicySummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourcePolicySummary)

#endif // OAIResourcePolicySummary_H
