...
/*
 * OAIDescribeEffectivePolicyResponse.h
 *
 * 
 */

#ifndef OAIDescribeEffectivePolicyResponse_H
#define OAIDescribeEffectivePolicyResponse_H
...
namespace OpenAPI {
class OAIDescribeEffectivePolicyResponse_EffectivePolicy;

class OAIDescribeEffectivePolicyResponse : public OAIObject {
public:
    OAIDescribeEffectivePolicyResponse();
    OAIDescribeEffectivePolicyResponse(QString json);
    ~OAIDescribeEffectivePolicyResponse() override;
    ...
    OAIDescribeEffectivePolicyResponse_EffectivePolicy getEffectivePolicy() const;
    void setEffectivePolicy(const OAIDescribeEffectivePolicyResponse_EffectivePolicy &effective_policy);
    bool is_effective_policy_Set() const;
    bool is_effective_policy_Valid() const;
...
private:
    ...
    OAIDescribeEffectivePolicyResponse_EffectivePolicy m_effective_policy;
    bool m_effective_policy_isSet;
    bool m_effective_policy_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEffectivePolicyResponse)

#endif // OAIDescribeEffectivePolicyResponse_H
