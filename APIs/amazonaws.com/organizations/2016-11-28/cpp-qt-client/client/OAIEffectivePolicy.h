...
/*
 * OAIEffectivePolicy.h
 *
 * Contains rules to be applied to the affected accounts. The effective policy is the aggregation of any policies the account inherits, plus any policy directly attached to the account.
 */

#ifndef OAIEffectivePolicy_H
#define OAIEffectivePolicy_H
...
class OAIEffectivePolicy : public OAIObject {
public:
    OAIEffectivePolicy();
    OAIEffectivePolicy(QString json);
    ~OAIEffectivePolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEffectivePolicy)

#endif // OAIEffectivePolicy_H
