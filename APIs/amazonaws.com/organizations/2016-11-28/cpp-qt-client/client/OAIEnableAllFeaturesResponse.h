...
/*
 * OAIEnableAllFeaturesResponse.h
 *
 * 
 */

#ifndef OAIEnableAllFeaturesResponse_H
#define OAIEnableAllFeaturesResponse_H

#include <QJsonObject>

#include "OAIEnableAllFeaturesResponse_Handshake.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIEnableAllFeaturesResponse_Handshake;

class OAIEnableAllFeaturesResponse : public OAIObject {
public:
    OAIEnableAllFeaturesResponse();
    OAIEnableAllFeaturesResponse(QString json);
    ~OAIEnableAllFeaturesResponse() override;
    ...
    OAIEnableAllFeaturesResponse_Handshake getHandshake() const;
    void setHandshake(const OAIEnableAllFeaturesResponse_Handshake &handshake);
...
private:
    ...
    OAIEnableAllFeaturesResponse_Handshake m_handshake;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnableAllFeaturesResponse)

#endif // OAIEnableAllFeaturesResponse_H
