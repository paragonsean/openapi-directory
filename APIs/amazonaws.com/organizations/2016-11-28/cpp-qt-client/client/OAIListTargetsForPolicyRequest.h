...
/*
 * OAIListTargetsForPolicyRequest.h
 *
 * 
 */

#ifndef OAIListTargetsForPolicyRequest_H
#define OAIListTargetsForPolicyRequest_H
...
class OAIListTargetsForPolicyRequest : public OAIObject {
public:
    OAIListTargetsForPolicyRequest();
    OAIListTargetsForPolicyRequest(QString json);
    ~OAIListTargetsForPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTargetsForPolicyRequest)

#endif // OAIListTargetsForPolicyRequest_H
