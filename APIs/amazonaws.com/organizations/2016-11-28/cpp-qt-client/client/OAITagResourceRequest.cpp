...
QString OAITagResourceRequest::getResourceId() const {
    return m_resource_id;
}
void OAITagResourceRequest::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAITagResourceRequest::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAITagResourceRequest::is_resource_id_Valid() const{
