...
OAIDescribeResourcePolicyResponse_ResourcePolicy OAIDescribeResourcePolicyResponse::getResourcePolicy() const {
    return m_resource_policy;
}
void OAIDescribeResourcePolicyResponse::setResourcePolicy(const OAIDescribeResourcePolicyResponse_ResourcePolicy &resource_policy) {
