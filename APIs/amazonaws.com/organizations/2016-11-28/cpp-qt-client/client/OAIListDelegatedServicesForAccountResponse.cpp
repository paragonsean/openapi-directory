...
OAIListDelegatedServicesForAccountResponse::OAIListDelegatedServicesForAccountResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDelegatedServicesForAccountResponse::OAIListDelegatedServicesForAccountResponse() {
    this->initializeModel();
}

OAIListDelegatedServicesForAccountResponse::~OAIListDelegatedServicesForAccountResponse() {}

void OAIListDelegatedServicesForAccountResponse::initializeModel() {

    m_delegated_services_isSet = false;
    m_delegated_services_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListDelegatedServicesForAccountResponse::fromJson(QString jsonString) {
...
void OAIListDelegatedServicesForAccountResponse::fromJsonObject(QJsonObject json) {

    m_delegated_services_isValid = ::OpenAPI::fromJsonValue(m_delegated_services, json[QString("DelegatedServices")]);
    m_delegated_services_isSet = !json[QString("DelegatedServices")].isNull() && m_delegated_services_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListDelegatedServicesForAccountResponse::asJson() const {
...
QJsonObject OAIListDelegatedServicesForAccountResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_delegated_services.isSet()) {
        obj.insert(QString("DelegatedServices"), ::OpenAPI::toJsonValue(m_delegated_services));
    }
...
QList OAIListDelegatedServicesForAccountResponse::getDelegatedServices() const {
    return m_delegated_services;
}
void OAIListDelegatedServicesForAccountResponse::setDelegatedServices(const QList &delegated_services) {
    m_delegated_services = delegated_services;
    m_delegated_services_isSet = true;
}

bool OAIListDelegatedServicesForAccountResponse::is_delegated_services_Set() const{
    return m_delegated_services_isSet;
}

bool OAIListDelegatedServicesForAccountResponse::is_delegated_services_Valid() const{
    return m_delegated_services_isValid;
}

QString OAIListDelegatedServicesForAccountResponse::getNextToken() const {
    return m_next_token;
}
void OAIListDelegatedServicesForAccountResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDelegatedServicesForAccountResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDelegatedServicesForAccountResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListDelegatedServicesForAccountResponse::isSet() const {
...
bool OAIListDelegatedServicesForAccountResponse::isValid() const {
