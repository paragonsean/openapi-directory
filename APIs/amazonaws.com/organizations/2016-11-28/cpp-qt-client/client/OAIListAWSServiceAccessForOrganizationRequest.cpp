...
OAIListAWSServiceAccessForOrganizationRequest::OAIListAWSServiceAccessForOrganizationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAWSServiceAccessForOrganizationRequest::OAIListAWSServiceAccessForOrganizationRequest() {
    this->initializeModel();
}

OAIListAWSServiceAccessForOrganizationRequest::~OAIListAWSServiceAccessForOrganizationRequest() {}

void OAIListAWSServiceAccessForOrganizationRequest::initializeModel() {
...
void OAIListAWSServiceAccessForOrganizationRequest::fromJson(QString jsonString) {
...
void OAIListAWSServiceAccessForOrganizationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListAWSServiceAccessForOrganizationRequest::asJson() const {
...
QJsonObject OAIListAWSServiceAccessForOrganizationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListAWSServiceAccessForOrganizationRequest::getNextToken() const {
    return m_next_token;
}
void OAIListAWSServiceAccessForOrganizationRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAWSServiceAccessForOrganizationRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAWSServiceAccessForOrganizationRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListAWSServiceAccessForOrganizationRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListAWSServiceAccessForOrganizationRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListAWSServiceAccessForOrganizationRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListAWSServiceAccessForOrganizationRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListAWSServiceAccessForOrganizationRequest::isSet() const {
...
bool OAIListAWSServiceAccessForOrganizationRequest::isValid() const {
