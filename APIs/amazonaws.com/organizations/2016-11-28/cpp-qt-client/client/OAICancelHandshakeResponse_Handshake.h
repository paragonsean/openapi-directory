...
/*
 * OAICancelHandshakeResponse_Handshake.h
 *
 * 
 */

#ifndef OAICancelHandshakeResponse_Handshake_H
#define OAICancelHandshakeResponse_Handshake_H
...
class OAICancelHandshakeResponse_Handshake : public OAIObject {
public:
    OAICancelHandshakeResponse_Handshake();
    OAICancelHandshakeResponse_Handshake(QString json);
    ~OAICancelHandshakeResponse_Handshake() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelHandshakeResponse_Handshake)

#endif // OAICancelHandshakeResponse_Handshake_H
