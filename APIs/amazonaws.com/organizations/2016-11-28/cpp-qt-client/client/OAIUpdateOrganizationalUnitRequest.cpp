...
OAIUpdateOrganizationalUnitRequest::OAIUpdateOrganizationalUnitRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateOrganizationalUnitRequest::OAIUpdateOrganizationalUnitRequest() {
    this->initializeModel();
}

OAIUpdateOrganizationalUnitRequest::~OAIUpdateOrganizationalUnitRequest() {}

void OAIUpdateOrganizationalUnitRequest::initializeModel() {
...
void OAIUpdateOrganizationalUnitRequest::fromJson(QString jsonString) {
...
void OAIUpdateOrganizationalUnitRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateOrganizationalUnitRequest::asJson() const {
...
QJsonObject OAIUpdateOrganizationalUnitRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateOrganizationalUnitRequest::getOrganizationalUnitId() const {
    return m_organizational_unit_id;
}
void OAIUpdateOrganizationalUnitRequest::setOrganizationalUnitId(const QString &organizational_unit_id) {
    m_organizational_unit_id = organizational_unit_id;
    m_organizational_unit_id_isSet = true;
}

bool OAIUpdateOrganizationalUnitRequest::is_organizational_unit_id_Set() const{
    return m_organizational_unit_id_isSet;
}

bool OAIUpdateOrganizationalUnitRequest::is_organizational_unit_id_Valid() const{
    return m_organizational_unit_id_isValid;
}

QString OAIUpdateOrganizationalUnitRequest::getName() const {
    return m_name;
}
void OAIUpdateOrganizationalUnitRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateOrganizationalUnitRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateOrganizationalUnitRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIUpdateOrganizationalUnitRequest::isSet() const {
...
bool OAIUpdateOrganizationalUnitRequest::isValid() const {
