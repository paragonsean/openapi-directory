...
OAIListAccountsRequest::OAIListAccountsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAccountsRequest::OAIListAccountsRequest() {
    this->initializeModel();
}

OAIListAccountsRequest::~OAIListAccountsRequest() {}

void OAIListAccountsRequest::initializeModel() {
...
void OAIListAccountsRequest::fromJson(QString jsonString) {
...
void OAIListAccountsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListAccountsRequest::asJson() const {
...
QJsonObject OAIListAccountsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListAccountsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListAccountsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAccountsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAccountsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListAccountsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListAccountsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListAccountsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListAccountsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListAccountsRequest::isSet() const {
...
bool OAIListAccountsRequest::isValid() const {
