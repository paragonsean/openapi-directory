...
OAIListRootsRequest::OAIListRootsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRootsRequest::OAIListRootsRequest() {
    this->initializeModel();
}

OAIListRootsRequest::~OAIListRootsRequest() {}

void OAIListRootsRequest::initializeModel() {
...
void OAIListRootsRequest::fromJson(QString jsonString) {
...
void OAIListRootsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListRootsRequest::asJson() const {
...
QJsonObject OAIListRootsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListRootsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListRootsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListRootsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListRootsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListRootsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListRootsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListRootsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListRootsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListRootsRequest::isSet() const {
...
bool OAIListRootsRequest::isValid() const {
