...
/*
 * OAICreatePolicyRequest.h
 *
 * 
 */

#ifndef OAICreatePolicyRequest_H
#define OAICreatePolicyRequest_H
...
class OAICreatePolicyRequest : public OAIObject {
public:
    OAICreatePolicyRequest();
    OAICreatePolicyRequest(QString json);
    ~OAICreatePolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePolicyRequest)

#endif // OAICreatePolicyRequest_H
