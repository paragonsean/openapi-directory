...
/*
 * OAICreateGovCloudAccountRequest.h
 *
 * 
 */

#ifndef OAICreateGovCloudAccountRequest_H
#define OAICreateGovCloudAccountRequest_H
...
class OAICreateGovCloudAccountRequest : public OAIObject {
public:
    OAICreateGovCloudAccountRequest();
    OAICreateGovCloudAccountRequest(QString json);
    ~OAICreateGovCloudAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGovCloudAccountRequest)

#endif // OAICreateGovCloudAccountRequest_H
