...
/*
 * OAIOrganizationFeatureSet.h
 *
 * 
 */

#ifndef OAIOrganizationFeatureSet_H
#define OAIOrganizationFeatureSet_H
...
class OAIOrganizationFeatureSet : public OAIEnum {
public:
    OAIOrganizationFeatureSet();
    OAIOrganizationFeatureSet(QString json);
    ~OAIOrganizationFeatureSet() override;
    ...
    enum class eOAIOrganizationFeatureSet {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ALL, 
        CONSOLIDATED_BILLING
    };
    OAIOrganizationFeatureSet::eOAIOrganizationFeatureSet getValue() const;
    void setValue(const OAIOrganizationFeatureSet::eOAIOrganizationFeatureSet& value);
...
private:
    ...
    eOAIOrganizationFeatureSet m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationFeatureSet)

#endif // OAIOrganizationFeatureSet_H
