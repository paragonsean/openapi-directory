...
/*
 * OAIDescribeHandshakeResponse.h
 *
 * 
 */

#ifndef OAIDescribeHandshakeResponse_H
#define OAIDescribeHandshakeResponse_H
...
namespace OpenAPI {
class OAIDescribeHandshakeResponse_Handshake;

class OAIDescribeHandshakeResponse : public OAIObject {
public:
    OAIDescribeHandshakeResponse();
    OAIDescribeHandshakeResponse(QString json);
    ~OAIDescribeHandshakeResponse() override;
    ...
    OAIDescribeHandshakeResponse_Handshake getHandshake() const;
    void setHandshake(const OAIDescribeHandshakeResponse_Handshake &handshake);
...
private:
    ...
    OAIDescribeHandshakeResponse_Handshake m_handshake;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeHandshakeResponse)

#endif // OAIDescribeHandshakeResponse_H
