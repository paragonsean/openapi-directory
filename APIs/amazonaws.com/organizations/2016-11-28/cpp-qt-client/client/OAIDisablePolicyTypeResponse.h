...
/*
 * OAIDisablePolicyTypeResponse.h
 *
 * 
 */

#ifndef OAIDisablePolicyTypeResponse_H
#define OAIDisablePolicyTypeResponse_H

#include <QJsonObject>

#include "OAIDisablePolicyTypeResponse_Root.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDisablePolicyTypeResponse_Root;

class OAIDisablePolicyTypeResponse : public OAIObject {
public:
    OAIDisablePolicyTypeResponse();
    OAIDisablePolicyTypeResponse(QString json);
    ~OAIDisablePolicyTypeResponse() override;
    ...
    OAIDisablePolicyTypeResponse_Root getRoot() const;
    void setRoot(const OAIDisablePolicyTypeResponse_Root &root);
...
private:
    ...
    OAIDisablePolicyTypeResponse_Root m_root;
    bool m_root_isSet;
    bool m_root_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisablePolicyTypeResponse)

#endif // OAIDisablePolicyTypeResponse_H
