...
/*
 * OAIDescribeCreateAccountStatusRequest.h
 *
 * 
 */

#ifndef OAIDescribeCreateAccountStatusRequest_H
#define OAIDescribeCreateAccountStatusRequest_H
...
class OAIDescribeCreateAccountStatusRequest : public OAIObject {
public:
    OAIDescribeCreateAccountStatusRequest();
    OAIDescribeCreateAccountStatusRequest(QString json);
    ~OAIDescribeCreateAccountStatusRequest() override;
    ...
    QString getCreateAccountRequestId() const;
    void setCreateAccountRequestId(const QString &create_account_request_id);
    bool is_create_account_request_id_Set() const;
    bool is_create_account_request_id_Valid() const;
...
private:
    ...
    QString m_create_account_request_id;
    bool m_create_account_request_id_isSet;
    bool m_create_account_request_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCreateAccountStatusRequest)

#endif // OAIDescribeCreateAccountStatusRequest_H
