...
/*
 * OAICreatePolicyResponse.h
 *
 * 
 */

#ifndef OAICreatePolicyResponse_H
#define OAICreatePolicyResponse_H
...
namespace OpenAPI {
class OAICreatePolicyResponse_Policy;

class OAICreatePolicyResponse : public OAIObject {
public:
    OAICreatePolicyResponse();
    OAICreatePolicyResponse(QString json);
    ~OAICreatePolicyResponse() override;
    ...
    OAICreatePolicyResponse_Policy getPolicy() const;
    void setPolicy(const OAICreatePolicyResponse_Policy &policy);
...
private:
    ...
    OAICreatePolicyResponse_Policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePolicyResponse)

#endif // OAICreatePolicyResponse_H
