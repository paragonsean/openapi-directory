...
/*
 * OAIListChildrenRequest.h
 *
 * 
 */

#ifndef OAIListChildrenRequest_H
#define OAIListChildrenRequest_H

#include <QJsonObject>

#include "OAIChildType.h"
#include <QString>
...
class OAIListChildrenRequest : public OAIObject {
public:
    OAIListChildrenRequest();
    OAIListChildrenRequest(QString json);
    ~OAIListChildrenRequest() override;
    ...
    OAIChildType getChildType() const;
    void setChildType(const OAIChildType &child_type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListChildrenRequest)

#endif // OAIListChildrenRequest_H
