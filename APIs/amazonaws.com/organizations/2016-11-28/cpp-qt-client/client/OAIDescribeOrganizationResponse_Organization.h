...
/*
 * OAIDescribeOrganizationResponse_Organization.h
 *
 * 
 */

#ifndef OAIDescribeOrganizationResponse_Organization_H
#define OAIDescribeOrganizationResponse_Organization_H

#include <QJsonObject>

#include "OAIOrganizationFeatureSet.h"
#include <QList>
#include <QString>
...
class OAIDescribeOrganizationResponse_Organization : public OAIObject {
public:
    OAIDescribeOrganizationResponse_Organization();
    OAIDescribeOrganizationResponse_Organization(QString json);
    ~OAIDescribeOrganizationResponse_Organization() override;
    ...
    OAIOrganizationFeatureSet getFeatureSet() const;
    void setFeatureSet(const OAIOrganizationFeatureSet &feature_set);
    bool is_feature_set_Set() const;
    bool is_feature_set_Valid() const;

    QString getMasterAccountArn() const;
    void setMasterAccountArn(const QString &master_account_arn);
    bool is_master_account_arn_Set() const;
    bool is_master_account_arn_Valid() const;
    ...
    QString getMasterAccountEmail() const;
    void setMasterAccountEmail(const QString &master_account_email);
    bool is_master_account_email_Set() const;
    bool is_master_account_email_Valid() const;

    QList getAvailablePolicyTypes() const;
    void setAvailablePolicyTypes(const QList &available_policy_types);
    bool is_available_policy_types_Set() const;
    bool is_available_policy_types_Valid() const;
...
private:
    ...
    OAIOrganizationFeatureSet m_feature_set;
    bool m_feature_set_isSet;
    bool m_feature_set_isValid;

    QString m_master_account_arn;
    bool m_master_account_arn_isSet;
    bool m_master_account_arn_isValid;

    QString m_master_account_id;
    bool m_master_account_id_isSet;
    bool m_master_account_id_isValid;

    QString m_master_account_email;
    bool m_master_account_email_isSet;
    bool m_master_account_email_isValid;

    QList m_available_policy_types;
    bool m_available_policy_types_isSet;
    bool m_available_policy_types_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeOrganizationResponse_Organization)

#endif // OAIDescribeOrganizationResponse_Organization_H
