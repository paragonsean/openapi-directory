...
OAIListDelegatedAdministratorsRequest::OAIListDelegatedAdministratorsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDelegatedAdministratorsRequest::OAIListDelegatedAdministratorsRequest() {
    this->initializeModel();
}

OAIListDelegatedAdministratorsRequest::~OAIListDelegatedAdministratorsRequest() {}

void OAIListDelegatedAdministratorsRequest::initializeModel() {
...
void OAIListDelegatedAdministratorsRequest::fromJson(QString jsonString) {
...
void OAIListDelegatedAdministratorsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListDelegatedAdministratorsRequest::asJson() const {
...
QJsonObject OAIListDelegatedAdministratorsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListDelegatedAdministratorsRequest::getServicePrincipal() const {
    return m_service_principal;
}
void OAIListDelegatedAdministratorsRequest::setServicePrincipal(const QString &service_principal) {
    m_service_principal = service_principal;
    m_service_principal_isSet = true;
}

bool OAIListDelegatedAdministratorsRequest::is_service_principal_Set() const{
    return m_service_principal_isSet;
}

bool OAIListDelegatedAdministratorsRequest::is_service_principal_Valid() const{
    return m_service_principal_isValid;
}

QString OAIListDelegatedAdministratorsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListDelegatedAdministratorsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDelegatedAdministratorsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDelegatedAdministratorsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListDelegatedAdministratorsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListDelegatedAdministratorsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListDelegatedAdministratorsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListDelegatedAdministratorsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListDelegatedAdministratorsRequest::isSet() const {
...
bool OAIListDelegatedAdministratorsRequest::isValid() const {
