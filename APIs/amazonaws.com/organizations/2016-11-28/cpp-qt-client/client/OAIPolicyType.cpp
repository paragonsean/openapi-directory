...
void OAIPolicyType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("SERVICE_CONTROL_POLICY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyType::SERVICE_CONTROL_POLICY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TAG_POLICY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyType::TAG_POLICY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("BACKUP_POLICY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyType::BACKUP_POLICY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AISERVICES_OPT_OUT_POLICY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyType::AISERVICES_OPT_OUT_POLICY;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIPolicyType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIPolicyType::SERVICE_CONTROL_POLICY:
            val = "SERVICE_CONTROL_POLICY";
            break;
        case eOAIPolicyType::TAG_POLICY:
            val = "TAG_POLICY";
            break;
        case eOAIPolicyType::BACKUP_POLICY:
            val = "BACKUP_POLICY";
            break;
        case eOAIPolicyType::AISERVICES_OPT_OUT_POLICY:
