...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWellArchitectedTool.ListCheckDetailsOutput();
  });
  ...
  describe('ListCheckDetailsOutput', function() {
    it('should create an instance of ListCheckDetailsOutput', function() {
      // uncomment below and update the code to test ListCheckDetailsOutput
      //var instance = new AwsWellArchitectedTool.ListCheckDetailsOutput();
      //expect(instance).to.be.a(AwsWellArchitectedTool.ListCheckDetailsOutput);
    });
