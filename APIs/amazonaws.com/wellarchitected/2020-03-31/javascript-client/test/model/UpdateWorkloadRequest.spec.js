...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWellArchitectedTool.UpdateWorkloadRequest();
  });
  ...
  describe('UpdateWorkloadRequest', function() {
    it('should create an instance of UpdateWorkloadRequest', function() {
      // uncomment below and update the code to test UpdateWorkloadRequest
      //var instance = new AwsWellArchitectedTool.UpdateWorkloadRequest();
      //expect(instance).to.be.a(AwsWellArchitectedTool.UpdateWorkloadRequest);
    });
