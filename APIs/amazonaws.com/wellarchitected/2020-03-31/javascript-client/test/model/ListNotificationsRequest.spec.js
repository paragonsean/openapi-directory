...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWellArchitectedTool.ListNotificationsRequest();
  });
  ...
  describe('ListNotificationsRequest', function() {
    it('should create an instance of ListNotificationsRequest', function() {
      // uncomment below and update the code to test ListNotificationsRequest
      //var instance = new AwsWellArchitectedTool.ListNotificationsRequest();
      //expect(instance).to.be.a(AwsWellArchitectedTool.ListNotificationsRequest);
    });
