...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWellArchitectedTool.WorkloadShareSummary();
  });
  ...
  describe('WorkloadShareSummary', function() {
    it('should create an instance of WorkloadShareSummary', function() {
      // uncomment below and update the code to test WorkloadShareSummary
      //var instance = new AwsWellArchitectedTool.WorkloadShareSummary();
      //expect(instance).to.be.a(AwsWellArchitectedTool.WorkloadShareSummary);
    });
