...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWellArchitectedTool.GetMilestoneOutput();
  });
  ...
  describe('GetMilestoneOutput', function() {
    it('should create an instance of GetMilestoneOutput', function() {
      // uncomment below and update the code to test GetMilestoneOutput
      //var instance = new AwsWellArchitectedTool.GetMilestoneOutput();
      //expect(instance).to.be.a(AwsWellArchitectedTool.GetMilestoneOutput);
    });
