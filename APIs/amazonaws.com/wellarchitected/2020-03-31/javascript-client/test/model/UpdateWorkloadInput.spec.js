...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWellArchitectedTool.UpdateWorkloadInput();
  });
  ...
  describe('UpdateWorkloadInput', function() {
    it('should create an instance of UpdateWorkloadInput', function() {
      // uncomment below and update the code to test UpdateWorkloadInput
      //var instance = new AwsWellArchitectedTool.UpdateWorkloadInput();
      //expect(instance).to.be.a(AwsWellArchitectedTool.UpdateWorkloadInput);
    });
