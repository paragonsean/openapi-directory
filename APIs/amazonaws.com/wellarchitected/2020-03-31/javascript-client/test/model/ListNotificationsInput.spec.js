...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWellArchitectedTool.ListNotificationsInput();
  });
  ...
  describe('ListNotificationsInput', function() {
    it('should create an instance of ListNotificationsInput', function() {
      // uncomment below and update the code to test ListNotificationsInput
      //var instance = new AwsWellArchitectedTool.ListNotificationsInput();
      //expect(instance).to.be.a(AwsWellArchitectedTool.ListNotificationsInput);
    });
