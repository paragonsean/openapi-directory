...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWellArchitectedTool.CreateWorkloadOutput();
  });
  ...
  describe('CreateWorkloadOutput', function() {
    it('should create an instance of CreateWorkloadOutput', function() {
      // uncomment below and update the code to test CreateWorkloadOutput
      //var instance = new AwsWellArchitectedTool.CreateWorkloadOutput();
      //expect(instance).to.be.a(AwsWellArchitectedTool.CreateWorkloadOutput);
    });
