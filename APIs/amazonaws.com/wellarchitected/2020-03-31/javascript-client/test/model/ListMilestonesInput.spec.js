...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWellArchitectedTool.ListMilestonesInput();
  });
  ...
  describe('ListMilestonesInput', function() {
    it('should create an instance of ListMilestonesInput', function() {
      // uncomment below and update the code to test ListMilestonesInput
      //var instance = new AwsWellArchitectedTool.ListMilestonesInput();
      //expect(instance).to.be.a(AwsWellArchitectedTool.ListMilestonesInput);
    });
