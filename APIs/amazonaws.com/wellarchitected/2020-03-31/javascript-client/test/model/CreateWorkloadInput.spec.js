...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWellArchitectedTool.CreateWorkloadInput();
  });
  ...
  describe('CreateWorkloadInput', function() {
    it('should create an instance of CreateWorkloadInput', function() {
      // uncomment below and update the code to test CreateWorkloadInput
      //var instance = new AwsWellArchitectedTool.CreateWorkloadInput();
      //expect(instance).to.be.a(AwsWellArchitectedTool.CreateWorkloadInput);
    });
