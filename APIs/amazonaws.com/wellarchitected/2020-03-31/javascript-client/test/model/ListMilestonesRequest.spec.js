...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWellArchitectedTool.ListMilestonesRequest();
  });
  ...
  describe('ListMilestonesRequest', function() {
    it('should create an instance of ListMilestonesRequest', function() {
      // uncomment below and update the code to test ListMilestonesRequest
      //var instance = new AwsWellArchitectedTool.ListMilestonesRequest();
      //expect(instance).to.be.a(AwsWellArchitectedTool.ListMilestonesRequest);
    });
