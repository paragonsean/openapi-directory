...
/**
 * The ListCheckDetailsRequest model module.
 * @module model/ListCheckDetailsRequest
 * @version 2020-03-31
 */
class ListCheckDetailsRequest {
    /**
     * Constructs a new <code>ListCheckDetailsRequest</code>.
     * @alias module:model/ListCheckDetailsRequest
     * @param lensArn {String} Well-Architected Lens ARN.
    ...
    constructor(lensArn, pillarId, questionId, choiceId) { 
        ...
        ListCheckDetailsRequest.initialize(this, lensArn, pillarId, questionId, choiceId);
    }
    ...
    /**
     * Constructs a <code>ListCheckDetailsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListCheckDetailsRequest} obj Optional instance to populate.
     * @return {module:model/ListCheckDetailsRequest} The populated <code>ListCheckDetailsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListCheckDetailsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListCheckDetailsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCheckDetailsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListCheckDetailsRequest.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['LensArn'] && !(typeof data['LensArn'] === 'string' || data['LensArn'] instanceof String)) {
            throw new Error("Expected the field `LensArn` to be a primitive type in the JSON string but got " + data['LensArn']);
        }
        // ensure the json data is a string
...
ListCheckDetailsRequest.RequiredProperties = ["LensArn", "PillarId", "QuestionId", "ChoiceId"];

/**
 * The token to use to retrieve the next set of results.
 * @member {String} NextToken
 */
ListCheckDetailsRequest.prototype['NextToken'] = undefined;

/**
 * The maximum number of results to return for this request.
 * @member {Number} MaxResults
 */
ListCheckDetailsRequest.prototype['MaxResults'] = undefined;

/**
 * Well-Architected Lens ARN.
 * @member {String} LensArn
 */
ListCheckDetailsRequest.prototype['LensArn'] = undefined;
 ...
 */
ListCheckDetailsRequest.prototype['PillarId'] = undefined;

/**
 * The ID of the question.
 * @member {String} QuestionId
 */
ListCheckDetailsRequest.prototype['QuestionId'] = undefined;

/**
 * The ID of a choice.
 * @member {String} ChoiceId
 */
ListCheckDetailsRequest.prototype['ChoiceId'] = undefined;
...
export default ListCheckDetailsRequest;
