...
/**
 * The LensUpgradeSummary model module.
 * @module model/LensUpgradeSummary
 * @version 2020-03-31
 */
class LensUpgradeSummary {
    /**
     * Constructs a new <code>LensUpgradeSummary</code>.
     * Lens upgrade summary return object.
     * @alias module:model/LensUpgradeSummary
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>LensUpgradeSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LensUpgradeSummary} obj Optional instance to populate.
     * @return {module:model/LensUpgradeSummary} The populated <code>LensUpgradeSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LensUpgradeSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>LensUpgradeSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LensUpgradeSummary</code>.
     */
...
export default LensUpgradeSummary;
