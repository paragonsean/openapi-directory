...
/**
 * The WorkloadShareSummary model module.
 * @module model/WorkloadShareSummary
 * @version 2020-03-31
 */
class WorkloadShareSummary {
    /**
     * Constructs a new <code>WorkloadShareSummary</code>.
     * A workload share summary return object.
     * @alias module:model/WorkloadShareSummary
     */
    constructor() { 
        
        WorkloadShareSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WorkloadShareSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WorkloadShareSummary} obj Optional instance to populate.
     * @return {module:model/WorkloadShareSummary} The populated <code>WorkloadShareSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkloadShareSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>WorkloadShareSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkloadShareSummary</code>.
     */
 ...
 */
WorkloadShareSummary.prototype['ShareId'] = undefined;
 ...
 */
WorkloadShareSummary.prototype['SharedWith'] = undefined;

/**
 * @member {module:model/PermissionType} PermissionType
 */
WorkloadShareSummary.prototype['PermissionType'] = undefined;

/**
 * @member {module:model/ShareStatus} Status
 */
WorkloadShareSummary.prototype['Status'] = undefined;

/**
 * @member {String} StatusMessage
 */
WorkloadShareSummary.prototype['StatusMessage'] = undefined;
...
export default WorkloadShareSummary;
