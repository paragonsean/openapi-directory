...
/**
 * The ShareInvitation model module.
 * @module model/ShareInvitation
 * @version 2020-03-31
 */
class ShareInvitation {
    /**
     * Constructs a new <code>ShareInvitation</code>.
     * The share invitation.
     * @alias module:model/ShareInvitation
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ShareInvitation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShareInvitation} obj Optional instance to populate.
     * @return {module:model/ShareInvitation} The populated <code>ShareInvitation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShareInvitation();
    ...
    /**
     * Validates the JSON data with respect to <code>ShareInvitation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShareInvitation</code>.
     */
