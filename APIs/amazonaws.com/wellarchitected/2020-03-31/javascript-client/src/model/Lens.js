...
/**
 * The Lens model module.
 * @module model/Lens
 * @version 2020-03-31
 */
class Lens {
    /**
     * Constructs a new <code>Lens</code>.
     * A lens return object.
     * @alias module:model/Lens
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Lens</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Lens} obj Optional instance to populate.
     * @return {module:model/Lens} The populated <code>Lens</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Lens</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Lens</code>.
     */
