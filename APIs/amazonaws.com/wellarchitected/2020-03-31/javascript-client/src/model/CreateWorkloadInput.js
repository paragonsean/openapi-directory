...
import CreateWorkloadInputDiscoveryConfig from './CreateWorkloadInputDiscoveryConfig';
import WorkloadEnvironment from './WorkloadEnvironment';

/**
 * The CreateWorkloadInput model module.
 * @module model/CreateWorkloadInput
 * @version 2020-03-31
 */
class CreateWorkloadInput {
    /**
     * Constructs a new <code>CreateWorkloadInput</code>.
     * Input for workload creation.
     * @alias module:model/CreateWorkloadInput
     ...
     * @param environment {module:model/WorkloadEnvironment} 
    ...
    constructor(workloadName, description, environment, lenses, clientRequestToken) { 
        ...
        CreateWorkloadInput.initialize(this, workloadName, description, environment, lenses, clientRequestToken);
    }
    ...
    /**
     * Constructs a <code>CreateWorkloadInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateWorkloadInput} obj Optional instance to populate.
     * @return {module:model/CreateWorkloadInput} The populated <code>CreateWorkloadInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateWorkloadInput();
            ...
            if (data.hasOwnProperty('DiscoveryConfig')) {
                obj['DiscoveryConfig'] = CreateWorkloadInputDiscoveryConfig.constructFromObject(data['DiscoveryConfig']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateWorkloadInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateWorkloadInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateWorkloadInput.RequiredProperties) {
        ...
        if (data['DiscoveryConfig']) { // data not null
          CreateWorkloadInputDiscoveryConfig.validateJSON(data['DiscoveryConfig']);
        }
...
CreateWorkloadInput.RequiredProperties = ["WorkloadName", "Description", "Environment", "Lenses", "ClientRequestToken"];
 ...
 */
CreateWorkloadInput.prototype['WorkloadName'] = undefined;

/**
 * The description for the workload.
 * @member {String} Description
 */
CreateWorkloadInput.prototype['Description'] = undefined;

/**
 * @member {module:model/WorkloadEnvironment} Environment
 */
CreateWorkloadInput.prototype['Environment'] = undefined;

/**
 * The list of Amazon Web Services account IDs associated with the workload.
 * @member {Array.<String>} AccountIds
 */
CreateWorkloadInput.prototype['AccountIds'] = undefined;
 ...
 */
CreateWorkloadInput.prototype['AwsRegions'] = undefined;

/**
 *  The list of non-Amazon Web Services Regions associated with the workload.
 * @member {Array.<String>} NonAwsRegions
 */
CreateWorkloadInput.prototype['NonAwsRegions'] = undefined;
 ...
 */
CreateWorkloadInput.prototype['PillarPriorities'] = undefined;

/**
 * The URL of the architectural design for the workload.
 * @member {String} ArchitecturalDesign
 */
CreateWorkloadInput.prototype['ArchitecturalDesign'] = undefined;

/**
 * The review owner of the workload. The name, email address, or identifier for the primary group or individual that owns the workload review process.
 * @member {String} ReviewOwner
 */
CreateWorkloadInput.prototype['ReviewOwner'] = undefined;
 ...
 */
CreateWorkloadInput.prototype['IndustryType'] = undefined;

/**
 * The industry for the workload.
 * @member {String} Industry
 */
CreateWorkloadInput.prototype['Industry'] = undefined;
 ...
 */
CreateWorkloadInput.prototype['Lenses'] = undefined;

/**
 * The notes associated with the workload.
 * @member {String} Notes
 */
CreateWorkloadInput.prototype['Notes'] = undefined;

/**
 * <p>A unique case-sensitive string used to ensure that this request is idempotent (executes only once).</p> <p>You should not reuse the same token for other requests. If you retry a request with the same client request token and the same parameters after the original request has completed successfully, the result of the original request is returned.</p> <important> <p>This token is listed as required, however, if you do not specify it, the Amazon Web Services SDKs automatically generate one for you. If you are not using the Amazon Web Services SDK or the CLI, you must provide this token or the request will fail.</p> </important>
 * @member {String} ClientRequestToken
 */
CreateWorkloadInput.prototype['ClientRequestToken'] = undefined;

/**
 * @member {Object} Tags
 */
CreateWorkloadInput.prototype['Tags'] = undefined;

/**
 * @member {module:model/CreateWorkloadInputDiscoveryConfig} DiscoveryConfig
 */
CreateWorkloadInput.prototype['DiscoveryConfig'] = undefined;

/**
 * @member {Array} Applications
 */
CreateWorkloadInput.prototype['Applications'] = undefined;

/**
 * @member {Array} ProfileArns
 */
CreateWorkloadInput.prototype['ProfileArns'] = undefined;
...
export default CreateWorkloadInput;
