...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://wellarchitected.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://wellarchitected.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2020-03-31/Javascript'
        };
