# AwsWellArchitectedTool.CreateProfileRequest
...
**profileQuestions** | [**[ProfileQuestionUpdate]**](ProfileQuestionUpdate.md) | The profile questions. | 
...
**tags** | **{String: String}** | The tags assigned to the profile. | [optional] 
