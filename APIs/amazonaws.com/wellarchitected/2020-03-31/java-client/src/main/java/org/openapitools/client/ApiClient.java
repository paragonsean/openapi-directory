...
public class ApiClient {
    ...
    private String basePath = "http://wellarchitected.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2020-03-31/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://wellarchitected.us-east-1.amazonaws.com
