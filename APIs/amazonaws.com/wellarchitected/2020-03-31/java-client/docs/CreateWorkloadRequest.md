...
|**environment** | [**EnvironmentEnum**](#EnvironmentEnum) | The environment for the workload. |  |
...
|**tags** | **Map&lt;String, String&gt;** | The tags to be associated with the workload. |  [optional] |
|**discoveryConfig** | [**CreateWorkloadRequestDiscoveryConfig**](CreateWorkloadRequestDiscoveryConfig.md) |  |  [optional] |
|**applications** | **List&lt;String&gt;** | List of AppRegistry application ARNs associated to the workload. |  [optional] |
|**profileArns** | **List&lt;String&gt;** | The list of profile ARNs associated with the workload. |  [optional] |
