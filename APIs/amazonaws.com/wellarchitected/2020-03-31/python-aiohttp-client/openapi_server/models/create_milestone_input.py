...
class CreateMilestoneInput(Model):
    ...
    def __init__(self, milestone_name: str=None, client_request_token: str=None):
        """CreateMilestoneInput - a model defined in OpenAPI

        :param milestone_name: The milestone_name of this CreateMilestoneInput.
        :param client_request_token: The client_request_token of this CreateMilestoneInput.
        """
        self.openapi_types = {
            'milestone_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateMilestoneInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateMilestoneInput of this CreateMilestoneInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def milestone_name(self):
        """Gets the milestone_name of this CreateMilestoneInput.

        <p>The name of the milestone in a workload.</p> <p>Milestone names must be unique within a workload.</p>

        :return: The milestone_name of this CreateMilestoneInput.
        :rtype: str
        """
    ...
    def milestone_name(self, milestone_name):
        """Sets the milestone_name of this CreateMilestoneInput.
    ...
    def client_request_token(self):
        """Gets the client_request_token of this CreateMilestoneInput.
        ...
        :return: The client_request_token of this CreateMilestoneInput.
        :rtype: str
        """
    ...
    def client_request_token(self, client_request_token):
        """Sets the client_request_token of this CreateMilestoneInput.
