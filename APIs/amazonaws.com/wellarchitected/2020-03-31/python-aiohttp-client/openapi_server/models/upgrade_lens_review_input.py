...
class UpgradeLensReviewInput(Model):
    ...
    def __init__(self, milestone_name: str=None, client_request_token: str=None):
        """UpgradeLensReviewInput - a model defined in OpenAPI

        :param milestone_name: The milestone_name of this UpgradeLensReviewInput.
        :param client_request_token: The client_request_token of this UpgradeLensReviewInput.
        """
        self.openapi_types = {
            'milestone_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpgradeLensReviewInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpgradeLensReviewInput of this UpgradeLensReviewInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def milestone_name(self):
        """Gets the milestone_name of this UpgradeLensReviewInput.

        <p>The name of the milestone in a workload.</p> <p>Milestone names must be unique within a workload.</p>

        :return: The milestone_name of this UpgradeLensReviewInput.
        :rtype: str
        """
    ...
    def milestone_name(self, milestone_name):
        """Sets the milestone_name of this UpgradeLensReviewInput.
    ...
    def client_request_token(self):
        """Gets the client_request_token of this UpgradeLensReviewInput.
        ...
        :return: The client_request_token of this UpgradeLensReviewInput.
        :rtype: str
        """
    ...
    def client_request_token(self, client_request_token):
        """Sets the client_request_token of this UpgradeLensReviewInput.
