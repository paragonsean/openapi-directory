...
class ListCheckDetailsRequest(Model):
    ...
    def __init__(self, next_token: str=None, max_results: int=None, lens_arn: str=None, pillar_id: str=None, question_id: str=None, choice_id: str=None):
        """ListCheckDetailsRequest - a model defined in OpenAPI

        :param next_token: The next_token of this ListCheckDetailsRequest.
        :param max_results: The max_results of this ListCheckDetailsRequest.
        :param lens_arn: The lens_arn of this ListCheckDetailsRequest.
        :param pillar_id: The pillar_id of this ListCheckDetailsRequest.
        :param question_id: The question_id of this ListCheckDetailsRequest.
        :param choice_id: The choice_id of this ListCheckDetailsRequest.
        """
        self.openapi_types = {
            'next_token': str,
            'max_results': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListCheckDetailsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListCheckDetails_request of this ListCheckDetailsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def next_token(self):
        """Gets the next_token of this ListCheckDetailsRequest.

        The token to use to retrieve the next set of results.

        :return: The next_token of this ListCheckDetailsRequest.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this ListCheckDetailsRequest.
    ...
    def max_results(self):
        """Gets the max_results of this ListCheckDetailsRequest.

        The maximum number of results to return for this request.

        :return: The max_results of this ListCheckDetailsRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this ListCheckDetailsRequest.
    ...
    @property
    def lens_arn(self):
        """Gets the lens_arn of this ListCheckDetailsRequest.

        Well-Architected Lens ARN.

        :return: The lens_arn of this ListCheckDetailsRequest.
        :rtype: str
        """
    ...
    def lens_arn(self, lens_arn):
        """Sets the lens_arn of this ListCheckDetailsRequest.
    ...
    @property
    def pillar_id(self):
        """Gets the pillar_id of this ListCheckDetailsRequest.
        ...
        :return: The pillar_id of this ListCheckDetailsRequest.
        :rtype: str
        """
    ...
    def pillar_id(self, pillar_id):
        """Sets the pillar_id of this ListCheckDetailsRequest.
    ...
    def question_id(self):
        """Gets the question_id of this ListCheckDetailsRequest.

        The ID of the question.

        :return: The question_id of this ListCheckDetailsRequest.
        :rtype: str
        """
    ...
    def question_id(self, question_id):
        """Sets the question_id of this ListCheckDetailsRequest.
    ...
    @property
    def choice_id(self):
        """Gets the choice_id of this ListCheckDetailsRequest.

        The ID of a choice.

        :return: The choice_id of this ListCheckDetailsRequest.
        :rtype: str
        """
    ...
    def choice_id(self, choice_id):
        """Sets the choice_id of this ListCheckDetailsRequest.
