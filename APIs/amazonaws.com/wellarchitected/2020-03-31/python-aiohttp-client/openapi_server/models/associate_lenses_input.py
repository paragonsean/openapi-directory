...
class AssociateLensesInput(Model):
    ...
    def __init__(self, lens_aliases: List[str]=None):
        """AssociateLensesInput - a model defined in OpenAPI

        :param lens_aliases: The lens_aliases of this AssociateLensesInput.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AssociateLensesInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AssociateLensesInput of this AssociateLensesInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def lens_aliases(self):
        """Gets the lens_aliases of this AssociateLensesInput.
        ...
        :return: The lens_aliases of this AssociateLensesInput.
        :rtype: List[str]
        """
    ...
    def lens_aliases(self, lens_aliases):
        """Sets the lens_aliases of this AssociateLensesInput.
