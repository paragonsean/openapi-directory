...
class DisassociateLensesInput(Model):
    ...
    def __init__(self, lens_aliases: List[str]=None):
        """DisassociateLensesInput - a model defined in OpenAPI

        :param lens_aliases: The lens_aliases of this DisassociateLensesInput.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DisassociateLensesInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DisassociateLensesInput of this DisassociateLensesInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def lens_aliases(self):
        """Gets the lens_aliases of this DisassociateLensesInput.
        ...
        :return: The lens_aliases of this DisassociateLensesInput.
        :rtype: List[str]
        """
    ...
    def lens_aliases(self, lens_aliases):
        """Sets the lens_aliases of this DisassociateLensesInput.
