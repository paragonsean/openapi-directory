...
class UpgradeProfileVersionRequest(Model):
    ...
    def __init__(self, milestone_name: str=None, client_request_token: str=None):
        """UpgradeProfileVersionRequest - a model defined in OpenAPI

        :param milestone_name: The milestone_name of this UpgradeProfileVersionRequest.
        :param client_request_token: The client_request_token of this UpgradeProfileVersionRequest.
        """
        self.openapi_types = {
            'milestone_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpgradeProfileVersionRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpgradeProfileVersion_request of this UpgradeProfileVersionRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def milestone_name(self):
        """Gets the milestone_name of this UpgradeProfileVersionRequest.

        <p>The name of the milestone in a workload.</p> <p>Milestone names must be unique within a workload.</p>

        :return: The milestone_name of this UpgradeProfileVersionRequest.
        :rtype: str
        """
    ...
    def milestone_name(self, milestone_name):
        """Sets the milestone_name of this UpgradeProfileVersionRequest.
    ...
    def client_request_token(self):
        """Gets the client_request_token of this UpgradeProfileVersionRequest.
        ...
        :return: The client_request_token of this UpgradeProfileVersionRequest.
        :rtype: str
        """
    ...
    def client_request_token(self, client_request_token):
        """Sets the client_request_token of this UpgradeProfileVersionRequest.
