...
/*
 * OAIListCheckDetails_request.h
 *
 * 
 */

#ifndef OAIListCheckDetails_request_H
#define OAIListCheckDetails_request_H
...
class OAIListCheckDetails_request : public OAIObject {
public:
    OAIListCheckDetails_request();
    OAIListCheckDetails_request(QString json);
    ~OAIListCheckDetails_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCheckDetails_request)

#endif // OAIListCheckDetails_request_H
