...
#ifndef OAICheckDetail_H
#define OAICheckDetail_H
...
class OAICheckDetail : public OAIObject {
public:
    OAICheckDetail();
    OAICheckDetail(QString json);
    ~OAICheckDetail() override;
    ...
    qint32 getFlaggedResources() const;
    void setFlaggedResources(const qint32 &flagged_resources);
    bool is_flagged_resources_Set() const;
    bool is_flagged_resources_Valid() const;

    OAICheckFailureReason getReason() const;
    void setReason(const OAICheckFailureReason &reason);
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckDetail)

#endif // OAICheckDetail_H
