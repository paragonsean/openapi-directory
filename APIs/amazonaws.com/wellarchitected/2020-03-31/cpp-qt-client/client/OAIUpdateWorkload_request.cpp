...
OAIUpdateWorkload_request::OAIUpdateWorkload_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateWorkload_request::OAIUpdateWorkload_request() {
    this->initializeModel();
}

OAIUpdateWorkload_request::~OAIUpdateWorkload_request() {}

void OAIUpdateWorkload_request::initializeModel() {
...
void OAIUpdateWorkload_request::fromJson(QString jsonString) {
...
void OAIUpdateWorkload_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateWorkload_request::asJson() const {
...
QJsonObject OAIUpdateWorkload_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateWorkload_request::getWorkloadName() const {
    return m_workload_name;
}
void OAIUpdateWorkload_request::setWorkloadName(const QString &workload_name) {
    m_workload_name = workload_name;
    m_workload_name_isSet = true;
}

bool OAIUpdateWorkload_request::is_workload_name_Set() const{
    return m_workload_name_isSet;
}

bool OAIUpdateWorkload_request::is_workload_name_Valid() const{
    return m_workload_name_isValid;
}

QString OAIUpdateWorkload_request::getDescription() const {
    return m_description;
}
void OAIUpdateWorkload_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateWorkload_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateWorkload_request::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateWorkload_request::getEnvironment() const {
    return m_environment;
}
void OAIUpdateWorkload_request::setEnvironment(const QString &environment) {
    m_environment = environment;
    m_environment_isSet = true;
}

bool OAIUpdateWorkload_request::is_environment_Set() const{
    return m_environment_isSet;
}

bool OAIUpdateWorkload_request::is_environment_Valid() const{
    return m_environment_isValid;
}

QList<QString> OAIUpdateWorkload_request::getAccountIds() const {
    return m_account_ids;
}
void OAIUpdateWorkload_request::setAccountIds(const QList<QString> &account_ids) {
    m_account_ids = account_ids;
    m_account_ids_isSet = true;
}

bool OAIUpdateWorkload_request::is_account_ids_Set() const{
    return m_account_ids_isSet;
}

bool OAIUpdateWorkload_request::is_account_ids_Valid() const{
    return m_account_ids_isValid;
}

QList<QString> OAIUpdateWorkload_request::getAwsRegions() const {
    return m_aws_regions;
}
void OAIUpdateWorkload_request::setAwsRegions(const QList<QString> &aws_regions) {
    m_aws_regions = aws_regions;
    m_aws_regions_isSet = true;
}

bool OAIUpdateWorkload_request::is_aws_regions_Set() const{
    return m_aws_regions_isSet;
}

bool OAIUpdateWorkload_request::is_aws_regions_Valid() const{
    return m_aws_regions_isValid;
}

QList<QString> OAIUpdateWorkload_request::getNonAwsRegions() const {
    return m_non_aws_regions;
}
void OAIUpdateWorkload_request::setNonAwsRegions(const QList<QString> &non_aws_regions) {
    m_non_aws_regions = non_aws_regions;
    m_non_aws_regions_isSet = true;
}

bool OAIUpdateWorkload_request::is_non_aws_regions_Set() const{
    return m_non_aws_regions_isSet;
}

bool OAIUpdateWorkload_request::is_non_aws_regions_Valid() const{
    return m_non_aws_regions_isValid;
}

QList<QString> OAIUpdateWorkload_request::getPillarPriorities() const {
    return m_pillar_priorities;
}
void OAIUpdateWorkload_request::setPillarPriorities(const QList<QString> &pillar_priorities) {
    m_pillar_priorities = pillar_priorities;
    m_pillar_priorities_isSet = true;
}

bool OAIUpdateWorkload_request::is_pillar_priorities_Set() const{
    return m_pillar_priorities_isSet;
}

bool OAIUpdateWorkload_request::is_pillar_priorities_Valid() const{
    return m_pillar_priorities_isValid;
}

QString OAIUpdateWorkload_request::getArchitecturalDesign() const {
    return m_architectural_design;
}
void OAIUpdateWorkload_request::setArchitecturalDesign(const QString &architectural_design) {
    m_architectural_design = architectural_design;
    m_architectural_design_isSet = true;
}

bool OAIUpdateWorkload_request::is_architectural_design_Set() const{
    return m_architectural_design_isSet;
}

bool OAIUpdateWorkload_request::is_architectural_design_Valid() const{
    return m_architectural_design_isValid;
}

QString OAIUpdateWorkload_request::getReviewOwner() const {
    return m_review_owner;
}
void OAIUpdateWorkload_request::setReviewOwner(const QString &review_owner) {
    m_review_owner = review_owner;
    m_review_owner_isSet = true;
}

bool OAIUpdateWorkload_request::is_review_owner_Set() const{
    return m_review_owner_isSet;
}

bool OAIUpdateWorkload_request::is_review_owner_Valid() const{
    return m_review_owner_isValid;
}

bool OAIUpdateWorkload_request::isIsReviewOwnerUpdateAcknowledged() const {
    return m_is_review_owner_update_acknowledged;
}
void OAIUpdateWorkload_request::setIsReviewOwnerUpdateAcknowledged(const bool &is_review_owner_update_acknowledged) {
...
bool OAIUpdateWorkload_request::is_is_review_owner_update_acknowledged_Set() const{
    return m_is_review_owner_update_acknowledged_isSet;
}

bool OAIUpdateWorkload_request::is_is_review_owner_update_acknowledged_Valid() const{
    return m_is_review_owner_update_acknowledged_isValid;
}

QString OAIUpdateWorkload_request::getIndustryType() const {
    return m_industry_type;
}
void OAIUpdateWorkload_request::setIndustryType(const QString &industry_type) {
    m_industry_type = industry_type;
    m_industry_type_isSet = true;
}

bool OAIUpdateWorkload_request::is_industry_type_Set() const{
    return m_industry_type_isSet;
}

bool OAIUpdateWorkload_request::is_industry_type_Valid() const{
    return m_industry_type_isValid;
}

QString OAIUpdateWorkload_request::getIndustry() const {
    return m_industry;
}
void OAIUpdateWorkload_request::setIndustry(const QString &industry) {
    m_industry = industry;
    m_industry_isSet = true;
}

bool OAIUpdateWorkload_request::is_industry_Set() const{
    return m_industry_isSet;
}

bool OAIUpdateWorkload_request::is_industry_Valid() const{
    return m_industry_isValid;
}

QString OAIUpdateWorkload_request::getNotes() const {
    return m_notes;
}
void OAIUpdateWorkload_request::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIUpdateWorkload_request::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIUpdateWorkload_request::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAIUpdateWorkload_request::getImprovementStatus() const {
    return m_improvement_status;
}
void OAIUpdateWorkload_request::setImprovementStatus(const QString &improvement_status) {
    m_improvement_status = improvement_status;
    m_improvement_status_isSet = true;
}

bool OAIUpdateWorkload_request::is_improvement_status_Set() const{
    return m_improvement_status_isSet;
}

bool OAIUpdateWorkload_request::is_improvement_status_Valid() const{
    return m_improvement_status_isValid;
}

OAICreateWorkload_request_DiscoveryConfig OAIUpdateWorkload_request::getDiscoveryConfig() const {
    return m_discovery_config;
}
void OAIUpdateWorkload_request::setDiscoveryConfig(const OAICreateWorkload_request_DiscoveryConfig &discovery_config) {
    m_discovery_config = discovery_config;
    m_discovery_config_isSet = true;
}

bool OAIUpdateWorkload_request::is_discovery_config_Set() const{
    return m_discovery_config_isSet;
}

bool OAIUpdateWorkload_request::is_discovery_config_Valid() const{
    return m_discovery_config_isValid;
}

QList<QString> OAIUpdateWorkload_request::getApplications() const {
    return m_applications;
}
void OAIUpdateWorkload_request::setApplications(const QList<QString> &applications) {
    m_applications = applications;
    m_applications_isSet = true;
}

bool OAIUpdateWorkload_request::is_applications_Set() const{
    return m_applications_isSet;
}

bool OAIUpdateWorkload_request::is_applications_Valid() const{
    return m_applications_isValid;
}

bool OAIUpdateWorkload_request::isSet() const {
...
bool OAIUpdateWorkload_request::isValid() const {
