...
OAIUpdateWorkloadInput_DiscoveryConfig::OAIUpdateWorkloadInput_DiscoveryConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateWorkloadInput_DiscoveryConfig::OAIUpdateWorkloadInput_DiscoveryConfig() {
    this->initializeModel();
}

OAIUpdateWorkloadInput_DiscoveryConfig::~OAIUpdateWorkloadInput_DiscoveryConfig() {}

void OAIUpdateWorkloadInput_DiscoveryConfig::initializeModel() {
...
void OAIUpdateWorkloadInput_DiscoveryConfig::fromJson(QString jsonString) {
...
void OAIUpdateWorkloadInput_DiscoveryConfig::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateWorkloadInput_DiscoveryConfig::asJson() const {
...
QJsonObject OAIUpdateWorkloadInput_DiscoveryConfig::asJsonObject() const {
    QJsonObject obj;
...
OAITrustedAdvisorIntegrationStatus OAIUpdateWorkloadInput_DiscoveryConfig::getTrustedAdvisorIntegrationStatus() const {
    return m_trusted_advisor_integration_status;
}
void OAIUpdateWorkloadInput_DiscoveryConfig::setTrustedAdvisorIntegrationStatus(const OAITrustedAdvisorIntegrationStatus &trusted_advisor_integration_status) {
    m_trusted_advisor_integration_status = trusted_advisor_integration_status;
    m_trusted_advisor_integration_status_isSet = true;
}

bool OAIUpdateWorkloadInput_DiscoveryConfig::is_trusted_advisor_integration_status_Set() const{
    return m_trusted_advisor_integration_status_isSet;
}

bool OAIUpdateWorkloadInput_DiscoveryConfig::is_trusted_advisor_integration_status_Valid() const{
    return m_trusted_advisor_integration_status_isValid;
}

QList OAIUpdateWorkloadInput_DiscoveryConfig::getWorkloadResourceDefinition() const {
    return m_workload_resource_definition;
}
void OAIUpdateWorkloadInput_DiscoveryConfig::setWorkloadResourceDefinition(const QList &workload_resource_definition) {
    m_workload_resource_definition = workload_resource_definition;
    m_workload_resource_definition_isSet = true;
}

bool OAIUpdateWorkloadInput_DiscoveryConfig::is_workload_resource_definition_Set() const{
    return m_workload_resource_definition_isSet;
}

bool OAIUpdateWorkloadInput_DiscoveryConfig::is_workload_resource_definition_Valid() const{
    return m_workload_resource_definition_isValid;
}

bool OAIUpdateWorkloadInput_DiscoveryConfig::isSet() const {
...
bool OAIUpdateWorkloadInput_DiscoveryConfig::isValid() const {
