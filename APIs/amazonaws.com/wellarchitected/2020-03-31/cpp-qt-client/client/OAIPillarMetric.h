...
#ifndef OAIPillarMetric_H
#define OAIPillarMetric_H
...
class OAIPillarMetric : public OAIObject {
public:
    OAIPillarMetric();
    OAIPillarMetric(QString json);
    ~OAIPillarMetric() override;
    ...
    QList getQuestions() const;
    void setQuestions(const QList &questions);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPillarMetric)

#endif // OAIPillarMetric_H
