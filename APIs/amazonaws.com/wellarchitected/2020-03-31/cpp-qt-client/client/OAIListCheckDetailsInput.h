...
/*
 * OAIListCheckDetailsInput.h
 *
 * 
 */

#ifndef OAIListCheckDetailsInput_H
#define OAIListCheckDetailsInput_H
...
class OAIListCheckDetailsInput : public OAIObject {
public:
    OAIListCheckDetailsInput();
    OAIListCheckDetailsInput(QString json);
    ~OAIListCheckDetailsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCheckDetailsInput)

#endif // OAIListCheckDetailsInput_H
