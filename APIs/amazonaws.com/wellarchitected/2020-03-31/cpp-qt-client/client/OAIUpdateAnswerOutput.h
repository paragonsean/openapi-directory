...
/*
 * OAIUpdateAnswerOutput.h
 *
 * Output of a update answer call.
 */

#ifndef OAIUpdateAnswerOutput_H
#define OAIUpdateAnswerOutput_H
...
class OAIUpdateAnswerOutput : public OAIObject {
public:
    OAIUpdateAnswerOutput();
    OAIUpdateAnswerOutput(QString json);
    ~OAIUpdateAnswerOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAnswerOutput)

#endif // OAIUpdateAnswerOutput_H
