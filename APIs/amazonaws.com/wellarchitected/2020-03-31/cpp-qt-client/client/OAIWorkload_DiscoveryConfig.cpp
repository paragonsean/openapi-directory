...
OAIWorkload_DiscoveryConfig::OAIWorkload_DiscoveryConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWorkload_DiscoveryConfig::OAIWorkload_DiscoveryConfig() {
    this->initializeModel();
}

OAIWorkload_DiscoveryConfig::~OAIWorkload_DiscoveryConfig() {}

void OAIWorkload_DiscoveryConfig::initializeModel() {
...
void OAIWorkload_DiscoveryConfig::fromJson(QString jsonString) {
...
void OAIWorkload_DiscoveryConfig::fromJsonObject(QJsonObject json) {
...
QString OAIWorkload_DiscoveryConfig::asJson() const {
...
QJsonObject OAIWorkload_DiscoveryConfig::asJsonObject() const {
    QJsonObject obj;
...
OAITrustedAdvisorIntegrationStatus OAIWorkload_DiscoveryConfig::getTrustedAdvisorIntegrationStatus() const {
    return m_trusted_advisor_integration_status;
}
void OAIWorkload_DiscoveryConfig::setTrustedAdvisorIntegrationStatus(const OAITrustedAdvisorIntegrationStatus &trusted_advisor_integration_status) {
    m_trusted_advisor_integration_status = trusted_advisor_integration_status;
    m_trusted_advisor_integration_status_isSet = true;
}

bool OAIWorkload_DiscoveryConfig::is_trusted_advisor_integration_status_Set() const{
    return m_trusted_advisor_integration_status_isSet;
}

bool OAIWorkload_DiscoveryConfig::is_trusted_advisor_integration_status_Valid() const{
    return m_trusted_advisor_integration_status_isValid;
}

QList OAIWorkload_DiscoveryConfig::getWorkloadResourceDefinition() const {
    return m_workload_resource_definition;
}
void OAIWorkload_DiscoveryConfig::setWorkloadResourceDefinition(const QList &workload_resource_definition) {
    m_workload_resource_definition = workload_resource_definition;
    m_workload_resource_definition_isSet = true;
}

bool OAIWorkload_DiscoveryConfig::is_workload_resource_definition_Set() const{
    return m_workload_resource_definition_isSet;
}

bool OAIWorkload_DiscoveryConfig::is_workload_resource_definition_Valid() const{
    return m_workload_resource_definition_isValid;
}

bool OAIWorkload_DiscoveryConfig::isSet() const {
...
bool OAIWorkload_DiscoveryConfig::isValid() const {
