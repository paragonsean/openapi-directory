...
/*
 * OAICreateWorkloadOutput.h
 *
 * Output of a create workload call.
 */

#ifndef OAICreateWorkloadOutput_H
#define OAICreateWorkloadOutput_H
...
class OAICreateWorkloadOutput : public OAIObject {
public:
    OAICreateWorkloadOutput();
    OAICreateWorkloadOutput(QString json);
    ~OAICreateWorkloadOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWorkloadOutput)

#endif // OAICreateWorkloadOutput_H
