...
/*
 * OAICreateLensVersionOutput.h
 *
 * 
 */

#ifndef OAICreateLensVersionOutput_H
#define OAICreateLensVersionOutput_H
...
class OAICreateLensVersionOutput : public OAIObject {
public:
    OAICreateLensVersionOutput();
    OAICreateLensVersionOutput(QString json);
    ~OAICreateLensVersionOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLensVersionOutput)

#endif // OAICreateLensVersionOutput_H
