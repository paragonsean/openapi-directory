...
OAICreateWorkload_request_DiscoveryConfig::OAICreateWorkload_request_DiscoveryConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateWorkload_request_DiscoveryConfig::OAICreateWorkload_request_DiscoveryConfig() {
    this->initializeModel();
}

OAICreateWorkload_request_DiscoveryConfig::~OAICreateWorkload_request_DiscoveryConfig() {}

void OAICreateWorkload_request_DiscoveryConfig::initializeModel() {
...
void OAICreateWorkload_request_DiscoveryConfig::fromJson(QString jsonString) {
...
void OAICreateWorkload_request_DiscoveryConfig::fromJsonObject(QJsonObject json) {
...
QString OAICreateWorkload_request_DiscoveryConfig::asJson() const {
...
QJsonObject OAICreateWorkload_request_DiscoveryConfig::asJsonObject() const {
    QJsonObject obj;
...
OAITrustedAdvisorIntegrationStatus OAICreateWorkload_request_DiscoveryConfig::getTrustedAdvisorIntegrationStatus() const {
    return m_trusted_advisor_integration_status;
}
void OAICreateWorkload_request_DiscoveryConfig::setTrustedAdvisorIntegrationStatus(const OAITrustedAdvisorIntegrationStatus &trusted_advisor_integration_status) {
    m_trusted_advisor_integration_status = trusted_advisor_integration_status;
    m_trusted_advisor_integration_status_isSet = true;
}

bool OAICreateWorkload_request_DiscoveryConfig::is_trusted_advisor_integration_status_Set() const{
    return m_trusted_advisor_integration_status_isSet;
}

bool OAICreateWorkload_request_DiscoveryConfig::is_trusted_advisor_integration_status_Valid() const{
    return m_trusted_advisor_integration_status_isValid;
}

QList OAICreateWorkload_request_DiscoveryConfig::getWorkloadResourceDefinition() const {
    return m_workload_resource_definition;
}
void OAICreateWorkload_request_DiscoveryConfig::setWorkloadResourceDefinition(const QList &workload_resource_definition) {
    m_workload_resource_definition = workload_resource_definition;
    m_workload_resource_definition_isSet = true;
}

bool OAICreateWorkload_request_DiscoveryConfig::is_workload_resource_definition_Set() const{
    return m_workload_resource_definition_isSet;
}

bool OAICreateWorkload_request_DiscoveryConfig::is_workload_resource_definition_Valid() const{
    return m_workload_resource_definition_isValid;
}

bool OAICreateWorkload_request_DiscoveryConfig::isSet() const {
...
bool OAICreateWorkload_request_DiscoveryConfig::isValid() const {
