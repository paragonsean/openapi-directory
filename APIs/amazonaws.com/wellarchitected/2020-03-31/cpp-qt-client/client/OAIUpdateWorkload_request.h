...
/*
 * OAIUpdateWorkload_request.h
 *
 * 
 */

#ifndef OAIUpdateWorkload_request_H
#define OAIUpdateWorkload_request_H
...
class OAIUpdateWorkload_request : public OAIObject {
public:
    OAIUpdateWorkload_request();
    OAIUpdateWorkload_request(QString json);
    ~OAIUpdateWorkload_request() override;
    ...
    bool isIsReviewOwnerUpdateAcknowledged() const;
    ...
    QString getImprovementStatus() const;
    void setImprovementStatus(const QString &improvement_status);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateWorkload_request)

#endif // OAIUpdateWorkload_request_H
