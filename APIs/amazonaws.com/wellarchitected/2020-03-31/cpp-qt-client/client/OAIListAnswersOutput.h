...
/*
 * OAIListAnswersOutput.h
 *
 * Output of a list answers call.
 */

#ifndef OAIListAnswersOutput_H
#define OAIListAnswersOutput_H
...
namespace OpenAPI {
class OAIAnswerSummary;

class OAIListAnswersOutput : public OAIObject {
public:
    OAIListAnswersOutput();
    OAIListAnswersOutput(QString json);
    ~OAIListAnswersOutput() override;
    ...
    QList<OAIAnswerSummary> getAnswerSummaries() const;
    void setAnswerSummaries(const QList<OAIAnswerSummary> &answer_summaries);
    bool is_answer_summaries_Set() const;
    bool is_answer_summaries_Valid() const;
...
private:
    ...
    QList<OAIAnswerSummary> m_answer_summaries;
    bool m_answer_summaries_isSet;
    bool m_answer_summaries_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAnswersOutput)

#endif // OAIListAnswersOutput_H
