...
/*
 * OAICreateWorkloadInput.h
 *
 * Input for workload creation.
 */

#ifndef OAICreateWorkloadInput_H
#define OAICreateWorkloadInput_H
...
namespace OpenAPI {
class OAICreateWorkloadInput_DiscoveryConfig;

class OAICreateWorkloadInput : public OAIObject {
public:
    OAICreateWorkloadInput();
    OAICreateWorkloadInput(QString json);
    ~OAICreateWorkloadInput() override;
    ...
    OAICreateWorkloadInput_DiscoveryConfig getDiscoveryConfig() const;
    void setDiscoveryConfig(const OAICreateWorkloadInput_DiscoveryConfig &discovery_config);
...
private:
    ...
    OAICreateWorkloadInput_DiscoveryConfig m_discovery_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWorkloadInput)

#endif // OAICreateWorkloadInput_H
