...
/*
 * OAIImportLensInput.h
 *
 * 
 */

#ifndef OAIImportLensInput_H
#define OAIImportLensInput_H
...
class OAIImportLensInput : public OAIObject {
public:
    OAIImportLensInput();
    OAIImportLensInput(QString json);
    ~OAIImportLensInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportLensInput)

#endif // OAIImportLensInput_H
