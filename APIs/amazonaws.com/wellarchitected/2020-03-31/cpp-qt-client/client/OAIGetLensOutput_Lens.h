...
/*
 * OAIGetLensOutput_Lens.h
 *
 * 
 */

#ifndef OAIGetLensOutput_Lens_H
#define OAIGetLensOutput_Lens_H
...
class OAIGetLensOutput_Lens : public OAIObject {
public:
    OAIGetLensOutput_Lens();
    OAIGetLensOutput_Lens(QString json);
    ~OAIGetLensOutput_Lens() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLensOutput_Lens)

#endif // OAIGetLensOutput_Lens_H
