...
public class DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig {
  ...
  public DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig() {
  }

  public DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig strategy(HyperParameterTuningJobStrategyType strategy) {
  ...
  public DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig strategyConfig(HyperParameterTuningJobConfigStrategyConfig strategyConfig) {
  ...
  public DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig hyperParameterTuningJobObjective(HyperParameterTuningJobConfigHyperParameterTuningJobObjective hyperParameterTuningJobObjective) {
  ...
  public DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig resourceLimits(HyperParameterTuningJobConfigResourceLimits resourceLimits) {
  ...
  public DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig parameterRanges(HyperParameterTuningJobConfigParameterRanges parameterRanges) {
  ...
  public DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig trainingJobEarlyStoppingType(TrainingJobEarlyStoppingType trainingJobEarlyStoppingType) {
  ...
  public DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig tuningJobCompletionCriteria(HyperParameterTuningJobConfigTuningJobCompletionCriteria tuningJobCompletionCriteria) {
  ...
  public DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig randomSeed(Integer randomSeed) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig describeHyperParameterTuningJobResponseHyperParameterTuningJobConfig = (DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig) o;
    return Objects.equals(this.strategy, describeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.strategy) &&
        Objects.equals(this.strategyConfig, describeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.strategyConfig) &&
        Objects.equals(this.hyperParameterTuningJobObjective, describeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.hyperParameterTuningJobObjective) &&
        Objects.equals(this.resourceLimits, describeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.resourceLimits) &&
        Objects.equals(this.parameterRanges, describeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.parameterRanges) &&
        Objects.equals(this.trainingJobEarlyStoppingType, describeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.trainingJobEarlyStoppingType) &&
        Objects.equals(this.tuningJobCompletionCriteria, describeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.tuningJobCompletionCriteria) &&
        Objects.equals(this.randomSeed, describeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.randomSeed);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig is not found in the empty JSON string", DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig>() {
           @Override
           public void write(JsonWriter out, DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig
   * @throws IOException if the JSON string is invalid with respect to DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig
   */
  public static DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig.class);
  }

  /**
   * Convert an instance of DescribeHyperParameterTuningJobResponseHyperParameterTuningJobConfig to an JSON string
   *
   * @return JSON string
   */
