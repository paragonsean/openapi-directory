...
public class CreateAlgorithmInputTrainingSpecification {
  ...
  public CreateAlgorithmInputTrainingSpecification() {
  }

  public CreateAlgorithmInputTrainingSpecification trainingImage(String trainingImage) {
  ...
  public CreateAlgorithmInputTrainingSpecification trainingImageDigest(String trainingImageDigest) {
  ...
  public CreateAlgorithmInputTrainingSpecification supportedHyperParameters(List supportedHyperParameters) {
  ...
  public CreateAlgorithmInputTrainingSpecification supportedTrainingInstanceTypes(List supportedTrainingInstanceTypes) {
  ...
  public CreateAlgorithmInputTrainingSpecification supportsDistributedTraining(Boolean supportsDistributedTraining) {
  ...
  public CreateAlgorithmInputTrainingSpecification metricDefinitions(List metricDefinitions) {
  ...
  public CreateAlgorithmInputTrainingSpecification trainingChannels(List trainingChannels) {
  ...
  public CreateAlgorithmInputTrainingSpecification supportedTuningJobObjectiveMetrics(List supportedTuningJobObjectiveMetrics) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAlgorithmInputTrainingSpecification createAlgorithmInputTrainingSpecification = (CreateAlgorithmInputTrainingSpecification) o;
    return Objects.equals(this.trainingImage, createAlgorithmInputTrainingSpecification.trainingImage) &&
        Objects.equals(this.trainingImageDigest, createAlgorithmInputTrainingSpecification.trainingImageDigest) &&
        Objects.equals(this.supportedHyperParameters, createAlgorithmInputTrainingSpecification.supportedHyperParameters) &&
        Objects.equals(this.supportedTrainingInstanceTypes, createAlgorithmInputTrainingSpecification.supportedTrainingInstanceTypes) &&
        Objects.equals(this.supportsDistributedTraining, createAlgorithmInputTrainingSpecification.supportsDistributedTraining) &&
        Objects.equals(this.metricDefinitions, createAlgorithmInputTrainingSpecification.metricDefinitions) &&
        Objects.equals(this.trainingChannels, createAlgorithmInputTrainingSpecification.trainingChannels) &&
        Objects.equals(this.supportedTuningJobObjectiveMetrics, createAlgorithmInputTrainingSpecification.supportedTuningJobObjectiveMetrics);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAlgorithmInputTrainingSpecification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAlgorithmInputTrainingSpecification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAlgorithmInputTrainingSpecification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAlgorithmInputTrainingSpecification is not found in the empty JSON string", CreateAlgorithmInputTrainingSpecification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAlgorithmInputTrainingSpecification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAlgorithmInputTrainingSpecification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAlgorithmInputTrainingSpecification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAlgorithmInputTrainingSpecification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAlgorithmInputTrainingSpecification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAlgorithmInputTrainingSpecification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAlgorithmInputTrainingSpecification.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAlgorithmInputTrainingSpecification>() {
           @Override
           public void write(JsonWriter out, CreateAlgorithmInputTrainingSpecification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAlgorithmInputTrainingSpecification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAlgorithmInputTrainingSpecification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAlgorithmInputTrainingSpecification
   * @throws IOException if the JSON string is invalid with respect to CreateAlgorithmInputTrainingSpecification
   */
  public static CreateAlgorithmInputTrainingSpecification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAlgorithmInputTrainingSpecification.class);
  }

  /**
   * Convert an instance of CreateAlgorithmInputTrainingSpecification to an JSON string
   *
   * @return JSON string
   */
