...
public class ClarifyCheckStepMetadata {
  ...
  public ClarifyCheckStepMetadata checkType(String checkType) {
  ...
  public ClarifyCheckStepMetadata baselineUsedForDriftCheckConstraints(String baselineUsedForDriftCheckConstraints) {
  ...
  public ClarifyCheckStepMetadata calculatedBaselineConstraints(String calculatedBaselineConstraints) {
  ...
  public ClarifyCheckStepMetadata modelPackageGroupName(String modelPackageGroupName) {
  ...
  public ClarifyCheckStepMetadata violationReport(String violationReport) {
  ...
  public ClarifyCheckStepMetadata checkJobArn(String checkJobArn) {
  ...
  public ClarifyCheckStepMetadata skipCheck(Boolean skipCheck) {
  ...
  public ClarifyCheckStepMetadata registerNewBaseline(Boolean registerNewBaseline) {
  ...
  public boolean equals(Object o) {
    ...
    ClarifyCheckStepMetadata clarifyCheckStepMetadata = (ClarifyCheckStepMetadata) o;
    return Objects.equals(this.checkType, clarifyCheckStepMetadata.checkType) &&
        Objects.equals(this.baselineUsedForDriftCheckConstraints, clarifyCheckStepMetadata.baselineUsedForDriftCheckConstraints) &&
        Objects.equals(this.calculatedBaselineConstraints, clarifyCheckStepMetadata.calculatedBaselineConstraints) &&
        Objects.equals(this.modelPackageGroupName, clarifyCheckStepMetadata.modelPackageGroupName) &&
        Objects.equals(this.violationReport, clarifyCheckStepMetadata.violationReport) &&
        Objects.equals(this.checkJobArn, clarifyCheckStepMetadata.checkJobArn) &&
        Objects.equals(this.skipCheck, clarifyCheckStepMetadata.skipCheck) &&
        Objects.equals(this.registerNewBaseline, clarifyCheckStepMetadata.registerNewBaseline);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClarifyCheckStepMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClarifyCheckStepMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClarifyCheckStepMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClarifyCheckStepMetadata is not found in the empty JSON string", ClarifyCheckStepMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClarifyCheckStepMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClarifyCheckStepMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClarifyCheckStepMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClarifyCheckStepMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClarifyCheckStepMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClarifyCheckStepMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ClarifyCheckStepMetadata>() {
           @Override
           public void write(JsonWriter out, ClarifyCheckStepMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClarifyCheckStepMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClarifyCheckStepMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClarifyCheckStepMetadata
   * @throws IOException if the JSON string is invalid with respect to ClarifyCheckStepMetadata
   */
  public static ClarifyCheckStepMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClarifyCheckStepMetadata.class);
  }

  /**
   * Convert an instance of ClarifyCheckStepMetadata to an JSON string
   *
   * @return JSON string
   */
