...
public class ModelQualityAppSpecification {
  ...
  public ModelQualityAppSpecification imageUri(String imageUri) {
  ...
  public ModelQualityAppSpecification containerEntrypoint(List containerEntrypoint) {
  ...
  public ModelQualityAppSpecification containerArguments(List containerArguments) {
  ...
  public ModelQualityAppSpecification recordPreprocessorSourceUri(String recordPreprocessorSourceUri) {
  ...
  public ModelQualityAppSpecification postAnalyticsProcessorSourceUri(String postAnalyticsProcessorSourceUri) {
  ...
  public ModelQualityAppSpecification problemType(MonitoringProblemType problemType) {
  ...
  public ModelQualityAppSpecification environment(Map environment) {
  ...
  public boolean equals(Object o) {
    ...
    ModelQualityAppSpecification modelQualityAppSpecification = (ModelQualityAppSpecification) o;
    return Objects.equals(this.imageUri, modelQualityAppSpecification.imageUri) &&
        Objects.equals(this.containerEntrypoint, modelQualityAppSpecification.containerEntrypoint) &&
        Objects.equals(this.containerArguments, modelQualityAppSpecification.containerArguments) &&
        Objects.equals(this.recordPreprocessorSourceUri, modelQualityAppSpecification.recordPreprocessorSourceUri) &&
        Objects.equals(this.postAnalyticsProcessorSourceUri, modelQualityAppSpecification.postAnalyticsProcessorSourceUri) &&
        Objects.equals(this.problemType, modelQualityAppSpecification.problemType) &&
        Objects.equals(this.environment, modelQualityAppSpecification.environment);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelQualityAppSpecification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModelQualityAppSpecification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelQualityAppSpecification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelQualityAppSpecification is not found in the empty JSON string", ModelQualityAppSpecification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelQualityAppSpecification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelQualityAppSpecification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ModelQualityAppSpecification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelQualityAppSpecification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelQualityAppSpecification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelQualityAppSpecification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelQualityAppSpecification.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelQualityAppSpecification>() {
           @Override
           public void write(JsonWriter out, ModelQualityAppSpecification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelQualityAppSpecification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModelQualityAppSpecification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModelQualityAppSpecification
   * @throws IOException if the JSON string is invalid with respect to ModelQualityAppSpecification
   */
  public static ModelQualityAppSpecification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelQualityAppSpecification.class);
  }

  /**
   * Convert an instance of ModelQualityAppSpecification to an JSON string
   *
   * @return JSON string
   */
