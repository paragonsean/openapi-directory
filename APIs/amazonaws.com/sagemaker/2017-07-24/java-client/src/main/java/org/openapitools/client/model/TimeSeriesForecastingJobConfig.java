...
public class TimeSeriesForecastingJobConfig {
  ...
  public TimeSeriesForecastingJobConfig() {
  }

  public TimeSeriesForecastingJobConfig featureSpecificationS3Uri(String featureSpecificationS3Uri) {
  ...
  public TimeSeriesForecastingJobConfig completionCriteria(AutoMLJobCompletionCriteria completionCriteria) {
  ...
  public TimeSeriesForecastingJobConfig forecastFrequency(String forecastFrequency) {
  ...
  public TimeSeriesForecastingJobConfig forecastHorizon(Integer forecastHorizon) {
  ...
  public TimeSeriesForecastingJobConfig forecastQuantiles(List forecastQuantiles) {
  ...
  public TimeSeriesForecastingJobConfig transformations(TimeSeriesForecastingJobConfigTransformations transformations) {
  ...
  public TimeSeriesForecastingJobConfig timeSeriesConfig(TimeSeriesForecastingJobConfigTimeSeriesConfig timeSeriesConfig) {
  ...
  public boolean equals(Object o) {
    ...
    TimeSeriesForecastingJobConfig timeSeriesForecastingJobConfig = (TimeSeriesForecastingJobConfig) o;
    return Objects.equals(this.featureSpecificationS3Uri, timeSeriesForecastingJobConfig.featureSpecificationS3Uri) &&
        Objects.equals(this.completionCriteria, timeSeriesForecastingJobConfig.completionCriteria) &&
        Objects.equals(this.forecastFrequency, timeSeriesForecastingJobConfig.forecastFrequency) &&
        Objects.equals(this.forecastHorizon, timeSeriesForecastingJobConfig.forecastHorizon) &&
        Objects.equals(this.forecastQuantiles, timeSeriesForecastingJobConfig.forecastQuantiles) &&
        Objects.equals(this.transformations, timeSeriesForecastingJobConfig.transformations) &&
        Objects.equals(this.timeSeriesConfig, timeSeriesForecastingJobConfig.timeSeriesConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeSeriesForecastingJobConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeSeriesForecastingJobConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeSeriesForecastingJobConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeSeriesForecastingJobConfig is not found in the empty JSON string", TimeSeriesForecastingJobConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimeSeriesForecastingJobConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeSeriesForecastingJobConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimeSeriesForecastingJobConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimeSeriesForecastingJobConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeSeriesForecastingJobConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimeSeriesForecastingJobConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeSeriesForecastingJobConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeSeriesForecastingJobConfig>() {
           @Override
           public void write(JsonWriter out, TimeSeriesForecastingJobConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimeSeriesForecastingJobConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimeSeriesForecastingJobConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimeSeriesForecastingJobConfig
   * @throws IOException if the JSON string is invalid with respect to TimeSeriesForecastingJobConfig
   */
  public static TimeSeriesForecastingJobConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimeSeriesForecastingJobConfig.class);
  }

  /**
   * Convert an instance of TimeSeriesForecastingJobConfig to an JSON string
   *
   * @return JSON string
   */
