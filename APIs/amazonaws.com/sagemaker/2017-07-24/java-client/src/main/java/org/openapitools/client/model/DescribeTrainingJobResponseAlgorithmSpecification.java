...
public class DescribeTrainingJobResponseAlgorithmSpecification {
  ...
  public DescribeTrainingJobResponseAlgorithmSpecification() {
  }

  public DescribeTrainingJobResponseAlgorithmSpecification trainingImage(String trainingImage) {
  ...
  public DescribeTrainingJobResponseAlgorithmSpecification algorithmName(String algorithmName) {
  ...
  public DescribeTrainingJobResponseAlgorithmSpecification trainingInputMode(TrainingInputMode trainingInputMode) {
  ...
  public DescribeTrainingJobResponseAlgorithmSpecification metricDefinitions(List metricDefinitions) {
  ...
  public DescribeTrainingJobResponseAlgorithmSpecification enableSageMakerMetricsTimeSeries(Boolean enableSageMakerMetricsTimeSeries) {
  ...
  public DescribeTrainingJobResponseAlgorithmSpecification containerEntrypoint(List containerEntrypoint) {
  ...
  public DescribeTrainingJobResponseAlgorithmSpecification containerArguments(List containerArguments) {
  ...
  public DescribeTrainingJobResponseAlgorithmSpecification trainingImageConfig(AlgorithmSpecificationTrainingImageConfig trainingImageConfig) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeTrainingJobResponseAlgorithmSpecification describeTrainingJobResponseAlgorithmSpecification = (DescribeTrainingJobResponseAlgorithmSpecification) o;
    return Objects.equals(this.trainingImage, describeTrainingJobResponseAlgorithmSpecification.trainingImage) &&
        Objects.equals(this.algorithmName, describeTrainingJobResponseAlgorithmSpecification.algorithmName) &&
        Objects.equals(this.trainingInputMode, describeTrainingJobResponseAlgorithmSpecification.trainingInputMode) &&
        Objects.equals(this.metricDefinitions, describeTrainingJobResponseAlgorithmSpecification.metricDefinitions) &&
        Objects.equals(this.enableSageMakerMetricsTimeSeries, describeTrainingJobResponseAlgorithmSpecification.enableSageMakerMetricsTimeSeries) &&
        Objects.equals(this.containerEntrypoint, describeTrainingJobResponseAlgorithmSpecification.containerEntrypoint) &&
        Objects.equals(this.containerArguments, describeTrainingJobResponseAlgorithmSpecification.containerArguments) &&
        Objects.equals(this.trainingImageConfig, describeTrainingJobResponseAlgorithmSpecification.trainingImageConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTrainingJobResponseAlgorithmSpecification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTrainingJobResponseAlgorithmSpecification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTrainingJobResponseAlgorithmSpecification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTrainingJobResponseAlgorithmSpecification is not found in the empty JSON string", DescribeTrainingJobResponseAlgorithmSpecification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTrainingJobResponseAlgorithmSpecification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTrainingJobResponseAlgorithmSpecification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeTrainingJobResponseAlgorithmSpecification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTrainingJobResponseAlgorithmSpecification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTrainingJobResponseAlgorithmSpecification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTrainingJobResponseAlgorithmSpecification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTrainingJobResponseAlgorithmSpecification.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTrainingJobResponseAlgorithmSpecification>() {
           @Override
           public void write(JsonWriter out, DescribeTrainingJobResponseAlgorithmSpecification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTrainingJobResponseAlgorithmSpecification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTrainingJobResponseAlgorithmSpecification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTrainingJobResponseAlgorithmSpecification
   * @throws IOException if the JSON string is invalid with respect to DescribeTrainingJobResponseAlgorithmSpecification
   */
  public static DescribeTrainingJobResponseAlgorithmSpecification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTrainingJobResponseAlgorithmSpecification.class);
  }

  /**
   * Convert an instance of DescribeTrainingJobResponseAlgorithmSpecification to an JSON string
   *
   * @return JSON string
   */
