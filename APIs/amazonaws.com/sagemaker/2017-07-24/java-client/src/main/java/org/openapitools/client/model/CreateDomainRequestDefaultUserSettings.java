...
public class CreateDomainRequestDefaultUserSettings {
  ...
  public CreateDomainRequestDefaultUserSettings() {
  }

  public CreateDomainRequestDefaultUserSettings executionRole(String executionRole) {
  ...
  public CreateDomainRequestDefaultUserSettings securityGroups(List securityGroups) {
  ...
  public CreateDomainRequestDefaultUserSettings sharingSettings(UserSettingsSharingSettings sharingSettings) {
  ...
  public CreateDomainRequestDefaultUserSettings jupyterServerAppSettings(UserSettingsJupyterServerAppSettings jupyterServerAppSettings) {
  ...
  public CreateDomainRequestDefaultUserSettings kernelGatewayAppSettings(UserSettingsKernelGatewayAppSettings kernelGatewayAppSettings) {
  ...
  public CreateDomainRequestDefaultUserSettings tensorBoardAppSettings(UserSettingsTensorBoardAppSettings tensorBoardAppSettings) {
  ...
  public CreateDomainRequestDefaultUserSettings rstudioServerProAppSettings(UserSettingsRStudioServerProAppSettings rstudioServerProAppSettings) {
  ...
  public CreateDomainRequestDefaultUserSettings rsessionAppSettings(UserSettingsRSessionAppSettings rsessionAppSettings) {
  ...
  public CreateDomainRequestDefaultUserSettings canvasAppSettings(UserSettingsCanvasAppSettings canvasAppSettings) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDomainRequestDefaultUserSettings createDomainRequestDefaultUserSettings = (CreateDomainRequestDefaultUserSettings) o;
    return Objects.equals(this.executionRole, createDomainRequestDefaultUserSettings.executionRole) &&
        Objects.equals(this.securityGroups, createDomainRequestDefaultUserSettings.securityGroups) &&
        Objects.equals(this.sharingSettings, createDomainRequestDefaultUserSettings.sharingSettings) &&
        Objects.equals(this.jupyterServerAppSettings, createDomainRequestDefaultUserSettings.jupyterServerAppSettings) &&
        Objects.equals(this.kernelGatewayAppSettings, createDomainRequestDefaultUserSettings.kernelGatewayAppSettings) &&
        Objects.equals(this.tensorBoardAppSettings, createDomainRequestDefaultUserSettings.tensorBoardAppSettings) &&
        Objects.equals(this.rstudioServerProAppSettings, createDomainRequestDefaultUserSettings.rstudioServerProAppSettings) &&
        Objects.equals(this.rsessionAppSettings, createDomainRequestDefaultUserSettings.rsessionAppSettings) &&
        Objects.equals(this.canvasAppSettings, createDomainRequestDefaultUserSettings.canvasAppSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateDomainRequestDefaultUserSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDomainRequestDefaultUserSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDomainRequestDefaultUserSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDomainRequestDefaultUserSettings is not found in the empty JSON string", CreateDomainRequestDefaultUserSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDomainRequestDefaultUserSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDomainRequestDefaultUserSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDomainRequestDefaultUserSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDomainRequestDefaultUserSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDomainRequestDefaultUserSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDomainRequestDefaultUserSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDomainRequestDefaultUserSettings>() {
           @Override
           public void write(JsonWriter out, CreateDomainRequestDefaultUserSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDomainRequestDefaultUserSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDomainRequestDefaultUserSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDomainRequestDefaultUserSettings
   * @throws IOException if the JSON string is invalid with respect to CreateDomainRequestDefaultUserSettings
   */
  public static CreateDomainRequestDefaultUserSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDomainRequestDefaultUserSettings.class);
  }

  /**
   * Convert an instance of CreateDomainRequestDefaultUserSettings to an JSON string
   *
   * @return JSON string
   */
