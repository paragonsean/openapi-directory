...
public class CreateTrainingJobRequestAlgorithmSpecification {
  ...
  public CreateTrainingJobRequestAlgorithmSpecification() {
  }

  public CreateTrainingJobRequestAlgorithmSpecification trainingImage(String trainingImage) {
  ...
  public CreateTrainingJobRequestAlgorithmSpecification algorithmName(String algorithmName) {
  ...
  public CreateTrainingJobRequestAlgorithmSpecification trainingInputMode(TrainingInputMode trainingInputMode) {
  ...
  public CreateTrainingJobRequestAlgorithmSpecification metricDefinitions(List metricDefinitions) {
  ...
  public CreateTrainingJobRequestAlgorithmSpecification enableSageMakerMetricsTimeSeries(Boolean enableSageMakerMetricsTimeSeries) {
  ...
  public CreateTrainingJobRequestAlgorithmSpecification containerEntrypoint(List containerEntrypoint) {
  ...
  public CreateTrainingJobRequestAlgorithmSpecification containerArguments(List containerArguments) {
  ...
  public CreateTrainingJobRequestAlgorithmSpecification trainingImageConfig(AlgorithmSpecificationTrainingImageConfig trainingImageConfig) {
  ...
  public boolean equals(Object o) {
    ...
    CreateTrainingJobRequestAlgorithmSpecification createTrainingJobRequestAlgorithmSpecification = (CreateTrainingJobRequestAlgorithmSpecification) o;
    return Objects.equals(this.trainingImage, createTrainingJobRequestAlgorithmSpecification.trainingImage) &&
        Objects.equals(this.algorithmName, createTrainingJobRequestAlgorithmSpecification.algorithmName) &&
        Objects.equals(this.trainingInputMode, createTrainingJobRequestAlgorithmSpecification.trainingInputMode) &&
        Objects.equals(this.metricDefinitions, createTrainingJobRequestAlgorithmSpecification.metricDefinitions) &&
        Objects.equals(this.enableSageMakerMetricsTimeSeries, createTrainingJobRequestAlgorithmSpecification.enableSageMakerMetricsTimeSeries) &&
        Objects.equals(this.containerEntrypoint, createTrainingJobRequestAlgorithmSpecification.containerEntrypoint) &&
        Objects.equals(this.containerArguments, createTrainingJobRequestAlgorithmSpecification.containerArguments) &&
        Objects.equals(this.trainingImageConfig, createTrainingJobRequestAlgorithmSpecification.trainingImageConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateTrainingJobRequestAlgorithmSpecification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateTrainingJobRequestAlgorithmSpecification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTrainingJobRequestAlgorithmSpecification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateTrainingJobRequestAlgorithmSpecification is not found in the empty JSON string", CreateTrainingJobRequestAlgorithmSpecification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTrainingJobRequestAlgorithmSpecification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTrainingJobRequestAlgorithmSpecification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateTrainingJobRequestAlgorithmSpecification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTrainingJobRequestAlgorithmSpecification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTrainingJobRequestAlgorithmSpecification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTrainingJobRequestAlgorithmSpecification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTrainingJobRequestAlgorithmSpecification.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTrainingJobRequestAlgorithmSpecification>() {
           @Override
           public void write(JsonWriter out, CreateTrainingJobRequestAlgorithmSpecification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTrainingJobRequestAlgorithmSpecification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateTrainingJobRequestAlgorithmSpecification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateTrainingJobRequestAlgorithmSpecification
   * @throws IOException if the JSON string is invalid with respect to CreateTrainingJobRequestAlgorithmSpecification
   */
  public static CreateTrainingJobRequestAlgorithmSpecification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTrainingJobRequestAlgorithmSpecification.class);
  }

  /**
   * Convert an instance of CreateTrainingJobRequestAlgorithmSpecification to an JSON string
   *
   * @return JSON string
   */
