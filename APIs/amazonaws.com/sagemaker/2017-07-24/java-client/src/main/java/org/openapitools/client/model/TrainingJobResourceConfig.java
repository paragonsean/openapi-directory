...
public class TrainingJobResourceConfig {
  ...
  public TrainingJobResourceConfig() {
  }

  public TrainingJobResourceConfig instanceType(TrainingInstanceType instanceType) {
  ...
  public TrainingJobResourceConfig instanceCount(Integer instanceCount) {
  ...
  public TrainingJobResourceConfig volumeSizeInGB(Integer volumeSizeInGB) {
  ...
  public TrainingJobResourceConfig volumeKmsKeyId(String volumeKmsKeyId) {
  ...
  public TrainingJobResourceConfig instanceGroups(List instanceGroups) {
  ...
  public TrainingJobResourceConfig keepAlivePeriodInSeconds(Integer keepAlivePeriodInSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    TrainingJobResourceConfig trainingJobResourceConfig = (TrainingJobResourceConfig) o;
    return Objects.equals(this.instanceType, trainingJobResourceConfig.instanceType) &&
        Objects.equals(this.instanceCount, trainingJobResourceConfig.instanceCount) &&
        Objects.equals(this.volumeSizeInGB, trainingJobResourceConfig.volumeSizeInGB) &&
        Objects.equals(this.volumeKmsKeyId, trainingJobResourceConfig.volumeKmsKeyId) &&
        Objects.equals(this.instanceGroups, trainingJobResourceConfig.instanceGroups) &&
        Objects.equals(this.keepAlivePeriodInSeconds, trainingJobResourceConfig.keepAlivePeriodInSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrainingJobResourceConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrainingJobResourceConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrainingJobResourceConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrainingJobResourceConfig is not found in the empty JSON string", TrainingJobResourceConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrainingJobResourceConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrainingJobResourceConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrainingJobResourceConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrainingJobResourceConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrainingJobResourceConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrainingJobResourceConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrainingJobResourceConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<TrainingJobResourceConfig>() {
           @Override
           public void write(JsonWriter out, TrainingJobResourceConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrainingJobResourceConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrainingJobResourceConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrainingJobResourceConfig
   * @throws IOException if the JSON string is invalid with respect to TrainingJobResourceConfig
   */
  public static TrainingJobResourceConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrainingJobResourceConfig.class);
  }

  /**
   * Convert an instance of TrainingJobResourceConfig to an JSON string
   *
   * @return JSON string
   */
