...
import org.openapitools.client.model.PendingProductionVariantSummaryDesiredServerlessConfig;
...
public class PendingProductionVariantSummary {
  ...
  private PendingProductionVariantSummaryDesiredServerlessConfig desiredServerlessConfig;

  public PendingProductionVariantSummary() {
  }

  public PendingProductionVariantSummary variantName(String variantName) {
  ...
  public PendingProductionVariantSummary deployedImages(List deployedImages) {
  ...
  public PendingProductionVariantSummary currentWeight(Float currentWeight) {
  ...
  public PendingProductionVariantSummary desiredWeight(Float desiredWeight) {
  ...
  public PendingProductionVariantSummary currentInstanceCount(Integer currentInstanceCount) {
  ...
  public PendingProductionVariantSummary desiredInstanceCount(Integer desiredInstanceCount) {
  ...
  public PendingProductionVariantSummary instanceType(ProductionVariantInstanceType instanceType) {
  ...
  public PendingProductionVariantSummary acceleratorType(ProductionVariantAcceleratorType acceleratorType) {
  ...
  public PendingProductionVariantSummary variantStatus(List variantStatus) {
  ...
  public PendingProductionVariantSummary currentServerlessConfig(PendingProductionVariantSummaryCurrentServerlessConfig currentServerlessConfig) {
  ...
  public PendingProductionVariantSummary desiredServerlessConfig(PendingProductionVariantSummaryDesiredServerlessConfig desiredServerlessConfig) {
   ...
   */
  @javax.annotation.Nullable
  public PendingProductionVariantSummaryDesiredServerlessConfig getDesiredServerlessConfig() {
    return desiredServerlessConfig;
  }

  public void setDesiredServerlessConfig(PendingProductionVariantSummaryDesiredServerlessConfig desiredServerlessConfig) {
    this.desiredServerlessConfig = desiredServerlessConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    PendingProductionVariantSummary pendingProductionVariantSummary = (PendingProductionVariantSummary) o;
    return Objects.equals(this.variantName, pendingProductionVariantSummary.variantName) &&
        Objects.equals(this.deployedImages, pendingProductionVariantSummary.deployedImages) &&
        Objects.equals(this.currentWeight, pendingProductionVariantSummary.currentWeight) &&
        Objects.equals(this.desiredWeight, pendingProductionVariantSummary.desiredWeight) &&
        Objects.equals(this.currentInstanceCount, pendingProductionVariantSummary.currentInstanceCount) &&
        Objects.equals(this.desiredInstanceCount, pendingProductionVariantSummary.desiredInstanceCount) &&
        Objects.equals(this.instanceType, pendingProductionVariantSummary.instanceType) &&
        Objects.equals(this.acceleratorType, pendingProductionVariantSummary.acceleratorType) &&
        Objects.equals(this.variantStatus, pendingProductionVariantSummary.variantStatus) &&
        Objects.equals(this.currentServerlessConfig, pendingProductionVariantSummary.currentServerlessConfig) &&
        Objects.equals(this.desiredServerlessConfig, pendingProductionVariantSummary.desiredServerlessConfig);
  }

  @Override
  public int hashCode() {
    return Objects.hash(variantName, deployedImages, currentWeight, desiredWeight, currentInstanceCount, desiredInstanceCount, instanceType, acceleratorType, variantStatus, currentServerlessConfig, desiredServerlessConfig);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PendingProductionVariantSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PendingProductionVariantSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PendingProductionVariantSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PendingProductionVariantSummary is not found in the empty JSON string", PendingProductionVariantSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PendingProductionVariantSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PendingProductionVariantSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PendingProductionVariantSummary.openapiRequiredFields) {
      ...
      if (jsonObj.get("DesiredServerlessConfig") != null && !jsonObj.get("DesiredServerlessConfig").isJsonNull()) {
        PendingProductionVariantSummaryDesiredServerlessConfig.validateJsonElement(jsonObj.get("DesiredServerlessConfig"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PendingProductionVariantSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PendingProductionVariantSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PendingProductionVariantSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PendingProductionVariantSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<PendingProductionVariantSummary>() {
           @Override
           public void write(JsonWriter out, PendingProductionVariantSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PendingProductionVariantSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PendingProductionVariantSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PendingProductionVariantSummary
   * @throws IOException if the JSON string is invalid with respect to PendingProductionVariantSummary
   */
  public static PendingProductionVariantSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PendingProductionVariantSummary.class);
  }

  /**
   * Convert an instance of PendingProductionVariantSummary to an JSON string
   *
   * @return JSON string
   */
