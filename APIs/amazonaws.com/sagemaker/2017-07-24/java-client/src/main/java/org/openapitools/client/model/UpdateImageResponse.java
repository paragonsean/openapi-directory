...
public class UpdateImageResponse {
  ...
  public UpdateImageResponse imageArn(String imageArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.imageArn, updateImageResponse.imageArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imageArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateImageResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateImageResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateImageResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateImageResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
