...
public class MonitoringScheduleConfig {
  ...
  public MonitoringScheduleConfig scheduleConfig(MonitoringScheduleConfigScheduleConfig scheduleConfig) {
  ...
  public MonitoringScheduleConfig monitoringJobDefinition(MonitoringScheduleConfigMonitoringJobDefinition monitoringJobDefinition) {
  ...
  public MonitoringScheduleConfig monitoringJobDefinitionName(String monitoringJobDefinitionName) {
  ...
  public MonitoringScheduleConfig monitoringType(MonitoringType monitoringType) {
  ...
  public boolean equals(Object o) {
    ...
    MonitoringScheduleConfig monitoringScheduleConfig = (MonitoringScheduleConfig) o;
    return Objects.equals(this.scheduleConfig, monitoringScheduleConfig.scheduleConfig) &&
        Objects.equals(this.monitoringJobDefinition, monitoringScheduleConfig.monitoringJobDefinition) &&
        Objects.equals(this.monitoringJobDefinitionName, monitoringScheduleConfig.monitoringJobDefinitionName) &&
        Objects.equals(this.monitoringType, monitoringScheduleConfig.monitoringType);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitoringScheduleConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitoringScheduleConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitoringScheduleConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitoringScheduleConfig is not found in the empty JSON string", MonitoringScheduleConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitoringScheduleConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitoringScheduleConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitoringScheduleConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitoringScheduleConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitoringScheduleConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitoringScheduleConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitoringScheduleConfig>() {
           @Override
           public void write(JsonWriter out, MonitoringScheduleConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitoringScheduleConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitoringScheduleConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitoringScheduleConfig
   * @throws IOException if the JSON string is invalid with respect to MonitoringScheduleConfig
   */
  public static MonitoringScheduleConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitoringScheduleConfig.class);
  }

  /**
   * Convert an instance of MonitoringScheduleConfig to an JSON string
   *
   * @return JSON string
   */
