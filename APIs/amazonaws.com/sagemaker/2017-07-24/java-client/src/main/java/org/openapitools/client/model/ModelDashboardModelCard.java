...
public class ModelDashboardModelCard {
  ...
  public ModelDashboardModelCard modelCardArn(String modelCardArn) {
  ...
  public ModelDashboardModelCard modelCardName(String modelCardName) {
  ...
  public ModelDashboardModelCard modelCardVersion(Integer modelCardVersion) {
  ...
  public ModelDashboardModelCard modelCardStatus(ModelCardStatus modelCardStatus) {
  ...
  public ModelDashboardModelCard securityConfig(ModelDashboardModelCardSecurityConfig securityConfig) {
  ...
  public ModelDashboardModelCard creationTime(OffsetDateTime creationTime) {
  ...
  public ModelDashboardModelCard createdBy(UserContext createdBy) {
  ...
  public ModelDashboardModelCard lastModifiedTime(OffsetDateTime lastModifiedTime) {
  ...
  public ModelDashboardModelCard lastModifiedBy(UserContext lastModifiedBy) {
  ...
  public ModelDashboardModelCard tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ModelDashboardModelCard modelId(String modelId) {
  ...
  public ModelDashboardModelCard riskRating(String riskRating) {
  ...
  public boolean equals(Object o) {
    ...
    ModelDashboardModelCard modelDashboardModelCard = (ModelDashboardModelCard) o;
    return Objects.equals(this.modelCardArn, modelDashboardModelCard.modelCardArn) &&
        Objects.equals(this.modelCardName, modelDashboardModelCard.modelCardName) &&
        Objects.equals(this.modelCardVersion, modelDashboardModelCard.modelCardVersion) &&
        Objects.equals(this.modelCardStatus, modelDashboardModelCard.modelCardStatus) &&
        Objects.equals(this.securityConfig, modelDashboardModelCard.securityConfig) &&
        Objects.equals(this.creationTime, modelDashboardModelCard.creationTime) &&
        Objects.equals(this.createdBy, modelDashboardModelCard.createdBy) &&
        Objects.equals(this.lastModifiedTime, modelDashboardModelCard.lastModifiedTime) &&
        Objects.equals(this.lastModifiedBy, modelDashboardModelCard.lastModifiedBy) &&
        Objects.equals(this.tags, modelDashboardModelCard.tags) &&
        Objects.equals(this.modelId, modelDashboardModelCard.modelId) &&
        Objects.equals(this.riskRating, modelDashboardModelCard.riskRating);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelDashboardModelCard {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModelDashboardModelCard
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelDashboardModelCard.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelDashboardModelCard is not found in the empty JSON string", ModelDashboardModelCard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelDashboardModelCard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelDashboardModelCard` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelDashboardModelCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelDashboardModelCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelDashboardModelCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelDashboardModelCard.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelDashboardModelCard>() {
           @Override
           public void write(JsonWriter out, ModelDashboardModelCard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelDashboardModelCard read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModelDashboardModelCard given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModelDashboardModelCard
   * @throws IOException if the JSON string is invalid with respect to ModelDashboardModelCard
   */
  public static ModelDashboardModelCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelDashboardModelCard.class);
  }

  /**
   * Convert an instance of ModelDashboardModelCard to an JSON string
   *
   * @return JSON string
   */
