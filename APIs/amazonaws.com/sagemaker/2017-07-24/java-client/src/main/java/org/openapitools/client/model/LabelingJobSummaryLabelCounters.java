...
public class LabelingJobSummaryLabelCounters {
  ...
  public LabelingJobSummaryLabelCounters() {
  }

  public LabelingJobSummaryLabelCounters totalLabeled(Integer totalLabeled) {
  ...
  public LabelingJobSummaryLabelCounters humanLabeled(Integer humanLabeled) {
  ...
  public LabelingJobSummaryLabelCounters machineLabeled(Integer machineLabeled) {
  ...
  public LabelingJobSummaryLabelCounters failedNonRetryableError(Integer failedNonRetryableError) {
  ...
  public LabelingJobSummaryLabelCounters unlabeled(Integer unlabeled) {
  ...
  public boolean equals(Object o) {
    ...
    LabelingJobSummaryLabelCounters labelingJobSummaryLabelCounters = (LabelingJobSummaryLabelCounters) o;
    return Objects.equals(this.totalLabeled, labelingJobSummaryLabelCounters.totalLabeled) &&
        Objects.equals(this.humanLabeled, labelingJobSummaryLabelCounters.humanLabeled) &&
        Objects.equals(this.machineLabeled, labelingJobSummaryLabelCounters.machineLabeled) &&
        Objects.equals(this.failedNonRetryableError, labelingJobSummaryLabelCounters.failedNonRetryableError) &&
        Objects.equals(this.unlabeled, labelingJobSummaryLabelCounters.unlabeled);
  }
  ...
  public String toString() {
    ...
    sb.append("class LabelingJobSummaryLabelCounters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LabelingJobSummaryLabelCounters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LabelingJobSummaryLabelCounters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LabelingJobSummaryLabelCounters is not found in the empty JSON string", LabelingJobSummaryLabelCounters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LabelingJobSummaryLabelCounters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LabelingJobSummaryLabelCounters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LabelingJobSummaryLabelCounters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LabelingJobSummaryLabelCounters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LabelingJobSummaryLabelCounters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LabelingJobSummaryLabelCounters.class));

       return (TypeAdapter<T>) new TypeAdapter<LabelingJobSummaryLabelCounters>() {
           @Override
           public void write(JsonWriter out, LabelingJobSummaryLabelCounters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LabelingJobSummaryLabelCounters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LabelingJobSummaryLabelCounters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LabelingJobSummaryLabelCounters
   * @throws IOException if the JSON string is invalid with respect to LabelingJobSummaryLabelCounters
   */
  public static LabelingJobSummaryLabelCounters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LabelingJobSummaryLabelCounters.class);
  }

  /**
   * Convert an instance of LabelingJobSummaryLabelCounters to an JSON string
   *
   * @return JSON string
   */
