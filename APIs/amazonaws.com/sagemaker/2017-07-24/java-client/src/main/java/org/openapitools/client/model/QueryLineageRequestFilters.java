...
public class QueryLineageRequestFilters {
  ...
  public QueryLineageRequestFilters() {
  }

  public QueryLineageRequestFilters types(List types) {
    this.types = types;
    return this;
  }
  ...
  public QueryLineageRequestFilters lineageTypes(List lineageTypes) {
  ...
  public QueryLineageRequestFilters createdBefore(OffsetDateTime createdBefore) {
  ...
  public QueryLineageRequestFilters createdAfter(OffsetDateTime createdAfter) {
  ...
  public QueryLineageRequestFilters modifiedBefore(OffsetDateTime modifiedBefore) {
  ...
  public QueryLineageRequestFilters modifiedAfter(OffsetDateTime modifiedAfter) {
  ...
  public QueryLineageRequestFilters properties(Map properties) {
  ...
  public boolean equals(Object o) {
    ...
    QueryLineageRequestFilters queryLineageRequestFilters = (QueryLineageRequestFilters) o;
    return Objects.equals(this.types, queryLineageRequestFilters.types) &&
        Objects.equals(this.lineageTypes, queryLineageRequestFilters.lineageTypes) &&
        Objects.equals(this.createdBefore, queryLineageRequestFilters.createdBefore) &&
        Objects.equals(this.createdAfter, queryLineageRequestFilters.createdAfter) &&
        Objects.equals(this.modifiedBefore, queryLineageRequestFilters.modifiedBefore) &&
        Objects.equals(this.modifiedAfter, queryLineageRequestFilters.modifiedAfter) &&
        Objects.equals(this.properties, queryLineageRequestFilters.properties);
  }
  ...
  public String toString() {
    ...
    sb.append("class QueryLineageRequestFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QueryLineageRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QueryLineageRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QueryLineageRequestFilters is not found in the empty JSON string", QueryLineageRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QueryLineageRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QueryLineageRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QueryLineageRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QueryLineageRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QueryLineageRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QueryLineageRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<QueryLineageRequestFilters>() {
           @Override
           public void write(JsonWriter out, QueryLineageRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QueryLineageRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QueryLineageRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QueryLineageRequestFilters
   * @throws IOException if the JSON string is invalid with respect to QueryLineageRequestFilters
   */
  public static QueryLineageRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QueryLineageRequestFilters.class);
  }

  /**
   * Convert an instance of QueryLineageRequestFilters to an JSON string
   *
   * @return JSON string
   */
