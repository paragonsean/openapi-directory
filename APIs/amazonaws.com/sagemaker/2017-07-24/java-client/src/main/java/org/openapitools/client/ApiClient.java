...
public class ApiClient {
    ...
    private String basePath = "http://api.sagemaker.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-07-24/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.sagemaker.us-east-1.amazonaws.com
