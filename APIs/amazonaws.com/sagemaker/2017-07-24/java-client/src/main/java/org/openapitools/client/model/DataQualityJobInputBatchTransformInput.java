...
public class DataQualityJobInputBatchTransformInput {
  ...
  public DataQualityJobInputBatchTransformInput() {
  }

  public DataQualityJobInputBatchTransformInput dataCapturedDestinationS3Uri(String dataCapturedDestinationS3Uri) {
  ...
  public DataQualityJobInputBatchTransformInput datasetFormat(BatchTransformInputDatasetFormat datasetFormat) {
  ...
  public DataQualityJobInputBatchTransformInput localPath(String localPath) {
  ...
  public DataQualityJobInputBatchTransformInput s3InputMode(ProcessingS3InputMode s3InputMode) {
  ...
  public DataQualityJobInputBatchTransformInput s3DataDistributionType(ProcessingS3DataDistributionType s3DataDistributionType) {
  ...
  public DataQualityJobInputBatchTransformInput featuresAttribute(String featuresAttribute) {
  ...
  public DataQualityJobInputBatchTransformInput inferenceAttribute(String inferenceAttribute) {
  ...
  public DataQualityJobInputBatchTransformInput probabilityAttribute(String probabilityAttribute) {
  ...
  public DataQualityJobInputBatchTransformInput probabilityThresholdAttribute(Double probabilityThresholdAttribute) {
  ...
  public DataQualityJobInputBatchTransformInput startTimeOffset(String startTimeOffset) {
  ...
  public DataQualityJobInputBatchTransformInput endTimeOffset(String endTimeOffset) {
  ...
  public boolean equals(Object o) {
    ...
    DataQualityJobInputBatchTransformInput dataQualityJobInputBatchTransformInput = (DataQualityJobInputBatchTransformInput) o;
    return Objects.equals(this.dataCapturedDestinationS3Uri, dataQualityJobInputBatchTransformInput.dataCapturedDestinationS3Uri) &&
        Objects.equals(this.datasetFormat, dataQualityJobInputBatchTransformInput.datasetFormat) &&
        Objects.equals(this.localPath, dataQualityJobInputBatchTransformInput.localPath) &&
        Objects.equals(this.s3InputMode, dataQualityJobInputBatchTransformInput.s3InputMode) &&
        Objects.equals(this.s3DataDistributionType, dataQualityJobInputBatchTransformInput.s3DataDistributionType) &&
        Objects.equals(this.featuresAttribute, dataQualityJobInputBatchTransformInput.featuresAttribute) &&
        Objects.equals(this.inferenceAttribute, dataQualityJobInputBatchTransformInput.inferenceAttribute) &&
        Objects.equals(this.probabilityAttribute, dataQualityJobInputBatchTransformInput.probabilityAttribute) &&
        Objects.equals(this.probabilityThresholdAttribute, dataQualityJobInputBatchTransformInput.probabilityThresholdAttribute) &&
        Objects.equals(this.startTimeOffset, dataQualityJobInputBatchTransformInput.startTimeOffset) &&
        Objects.equals(this.endTimeOffset, dataQualityJobInputBatchTransformInput.endTimeOffset);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataQualityJobInputBatchTransformInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataQualityJobInputBatchTransformInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataQualityJobInputBatchTransformInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataQualityJobInputBatchTransformInput is not found in the empty JSON string", DataQualityJobInputBatchTransformInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataQualityJobInputBatchTransformInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataQualityJobInputBatchTransformInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DataQualityJobInputBatchTransformInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataQualityJobInputBatchTransformInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataQualityJobInputBatchTransformInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataQualityJobInputBatchTransformInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataQualityJobInputBatchTransformInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DataQualityJobInputBatchTransformInput>() {
           @Override
           public void write(JsonWriter out, DataQualityJobInputBatchTransformInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataQualityJobInputBatchTransformInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataQualityJobInputBatchTransformInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataQualityJobInputBatchTransformInput
   * @throws IOException if the JSON string is invalid with respect to DataQualityJobInputBatchTransformInput
   */
  public static DataQualityJobInputBatchTransformInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataQualityJobInputBatchTransformInput.class);
  }

  /**
   * Convert an instance of DataQualityJobInputBatchTransformInput to an JSON string
   *
   * @return JSON string
   */
