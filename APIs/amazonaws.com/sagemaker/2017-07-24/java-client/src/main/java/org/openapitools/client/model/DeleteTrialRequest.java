...
public class DeleteTrialRequest {
  ...
  public DeleteTrialRequest trialName(String trialName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.trialName, deleteTrialRequest.trialName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTrialRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTrialRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTrialRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTrialRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteTrialRequest.openapiRequiredFields) {
