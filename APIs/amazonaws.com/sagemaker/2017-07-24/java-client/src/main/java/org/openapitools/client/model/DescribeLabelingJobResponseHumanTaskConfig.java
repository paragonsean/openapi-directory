...
public class DescribeLabelingJobResponseHumanTaskConfig {
  ...
  public DescribeLabelingJobResponseHumanTaskConfig() {
  }

  public DescribeLabelingJobResponseHumanTaskConfig workteamArn(String workteamArn) {
  ...
  public DescribeLabelingJobResponseHumanTaskConfig uiConfig(HumanTaskConfigUiConfig uiConfig) {
  ...
  public DescribeLabelingJobResponseHumanTaskConfig preHumanTaskLambdaArn(String preHumanTaskLambdaArn) {
  ...
  public DescribeLabelingJobResponseHumanTaskConfig taskKeywords(List taskKeywords) {
  ...
  public DescribeLabelingJobResponseHumanTaskConfig taskTitle(String taskTitle) {
  ...
  public DescribeLabelingJobResponseHumanTaskConfig taskDescription(String taskDescription) {
  ...
  public DescribeLabelingJobResponseHumanTaskConfig numberOfHumanWorkersPerDataObject(Integer numberOfHumanWorkersPerDataObject) {
  ...
  public DescribeLabelingJobResponseHumanTaskConfig taskTimeLimitInSeconds(Integer taskTimeLimitInSeconds) {
  ...
  public DescribeLabelingJobResponseHumanTaskConfig taskAvailabilityLifetimeInSeconds(Integer taskAvailabilityLifetimeInSeconds) {
  ...
  public DescribeLabelingJobResponseHumanTaskConfig maxConcurrentTaskCount(Integer maxConcurrentTaskCount) {
  ...
  public DescribeLabelingJobResponseHumanTaskConfig annotationConsolidationConfig(HumanTaskConfigAnnotationConsolidationConfig annotationConsolidationConfig) {
  ...
  public DescribeLabelingJobResponseHumanTaskConfig publicWorkforceTaskPrice(HumanTaskConfigPublicWorkforceTaskPrice publicWorkforceTaskPrice) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeLabelingJobResponseHumanTaskConfig describeLabelingJobResponseHumanTaskConfig = (DescribeLabelingJobResponseHumanTaskConfig) o;
    return Objects.equals(this.workteamArn, describeLabelingJobResponseHumanTaskConfig.workteamArn) &&
        Objects.equals(this.uiConfig, describeLabelingJobResponseHumanTaskConfig.uiConfig) &&
        Objects.equals(this.preHumanTaskLambdaArn, describeLabelingJobResponseHumanTaskConfig.preHumanTaskLambdaArn) &&
        Objects.equals(this.taskKeywords, describeLabelingJobResponseHumanTaskConfig.taskKeywords) &&
        Objects.equals(this.taskTitle, describeLabelingJobResponseHumanTaskConfig.taskTitle) &&
        Objects.equals(this.taskDescription, describeLabelingJobResponseHumanTaskConfig.taskDescription) &&
        Objects.equals(this.numberOfHumanWorkersPerDataObject, describeLabelingJobResponseHumanTaskConfig.numberOfHumanWorkersPerDataObject) &&
        Objects.equals(this.taskTimeLimitInSeconds, describeLabelingJobResponseHumanTaskConfig.taskTimeLimitInSeconds) &&
        Objects.equals(this.taskAvailabilityLifetimeInSeconds, describeLabelingJobResponseHumanTaskConfig.taskAvailabilityLifetimeInSeconds) &&
        Objects.equals(this.maxConcurrentTaskCount, describeLabelingJobResponseHumanTaskConfig.maxConcurrentTaskCount) &&
        Objects.equals(this.annotationConsolidationConfig, describeLabelingJobResponseHumanTaskConfig.annotationConsolidationConfig) &&
        Objects.equals(this.publicWorkforceTaskPrice, describeLabelingJobResponseHumanTaskConfig.publicWorkforceTaskPrice);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeLabelingJobResponseHumanTaskConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeLabelingJobResponseHumanTaskConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeLabelingJobResponseHumanTaskConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeLabelingJobResponseHumanTaskConfig is not found in the empty JSON string", DescribeLabelingJobResponseHumanTaskConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeLabelingJobResponseHumanTaskConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeLabelingJobResponseHumanTaskConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeLabelingJobResponseHumanTaskConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeLabelingJobResponseHumanTaskConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeLabelingJobResponseHumanTaskConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeLabelingJobResponseHumanTaskConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeLabelingJobResponseHumanTaskConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeLabelingJobResponseHumanTaskConfig>() {
           @Override
           public void write(JsonWriter out, DescribeLabelingJobResponseHumanTaskConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeLabelingJobResponseHumanTaskConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeLabelingJobResponseHumanTaskConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeLabelingJobResponseHumanTaskConfig
   * @throws IOException if the JSON string is invalid with respect to DescribeLabelingJobResponseHumanTaskConfig
   */
  public static DescribeLabelingJobResponseHumanTaskConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeLabelingJobResponseHumanTaskConfig.class);
  }

  /**
   * Convert an instance of DescribeLabelingJobResponseHumanTaskConfig to an JSON string
   *
   * @return JSON string
   */
