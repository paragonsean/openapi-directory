...
public class LabelCounters {
  ...
  public LabelCounters totalLabeled(Integer totalLabeled) {
  ...
  public LabelCounters humanLabeled(Integer humanLabeled) {
  ...
  public LabelCounters machineLabeled(Integer machineLabeled) {
  ...
  public LabelCounters failedNonRetryableError(Integer failedNonRetryableError) {
  ...
  public LabelCounters unlabeled(Integer unlabeled) {
  ...
  public boolean equals(Object o) {
    ...
    LabelCounters labelCounters = (LabelCounters) o;
    return Objects.equals(this.totalLabeled, labelCounters.totalLabeled) &&
        Objects.equals(this.humanLabeled, labelCounters.humanLabeled) &&
        Objects.equals(this.machineLabeled, labelCounters.machineLabeled) &&
        Objects.equals(this.failedNonRetryableError, labelCounters.failedNonRetryableError) &&
        Objects.equals(this.unlabeled, labelCounters.unlabeled);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LabelCounters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LabelCounters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LabelCounters is not found in the empty JSON string", LabelCounters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LabelCounters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LabelCounters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LabelCounters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LabelCounters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LabelCounters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LabelCounters.class));

       return (TypeAdapter<T>) new TypeAdapter<LabelCounters>() {
           @Override
           public void write(JsonWriter out, LabelCounters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LabelCounters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LabelCounters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LabelCounters
   * @throws IOException if the JSON string is invalid with respect to LabelCounters
   */
  public static LabelCounters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LabelCounters.class);
  }

  /**
   * Convert an instance of LabelCounters to an JSON string
   *
   * @return JSON string
   */
