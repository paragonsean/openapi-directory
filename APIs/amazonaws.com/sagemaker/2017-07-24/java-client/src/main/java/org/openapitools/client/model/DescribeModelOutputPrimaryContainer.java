...
public class DescribeModelOutputPrimaryContainer {
  ...
  public DescribeModelOutputPrimaryContainer() {
  }

  public DescribeModelOutputPrimaryContainer containerHostname(String containerHostname) {
  ...
  public DescribeModelOutputPrimaryContainer image(String image) {
    this.image = image;
    return this;
  }
  ...
  public DescribeModelOutputPrimaryContainer imageConfig(ContainerDefinitionImageConfig imageConfig) {
  ...
  public DescribeModelOutputPrimaryContainer mode(ContainerMode mode) {
    this.mode = mode;
    return this;
  }
  ...
  public DescribeModelOutputPrimaryContainer modelDataUrl(String modelDataUrl) {
  ...
  public DescribeModelOutputPrimaryContainer environment(Map environment) {
  ...
  public DescribeModelOutputPrimaryContainer modelPackageName(String modelPackageName) {
  ...
  public DescribeModelOutputPrimaryContainer inferenceSpecificationName(String inferenceSpecificationName) {
  ...
  public DescribeModelOutputPrimaryContainer multiModelConfig(ContainerDefinitionMultiModelConfig multiModelConfig) {
  ...
  public DescribeModelOutputPrimaryContainer modelDataSource(ContainerDefinitionModelDataSource modelDataSource) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeModelOutputPrimaryContainer describeModelOutputPrimaryContainer = (DescribeModelOutputPrimaryContainer) o;
    return Objects.equals(this.containerHostname, describeModelOutputPrimaryContainer.containerHostname) &&
        Objects.equals(this.image, describeModelOutputPrimaryContainer.image) &&
        Objects.equals(this.imageConfig, describeModelOutputPrimaryContainer.imageConfig) &&
        Objects.equals(this.mode, describeModelOutputPrimaryContainer.mode) &&
        Objects.equals(this.modelDataUrl, describeModelOutputPrimaryContainer.modelDataUrl) &&
        Objects.equals(this.environment, describeModelOutputPrimaryContainer.environment) &&
        Objects.equals(this.modelPackageName, describeModelOutputPrimaryContainer.modelPackageName) &&
        Objects.equals(this.inferenceSpecificationName, describeModelOutputPrimaryContainer.inferenceSpecificationName) &&
        Objects.equals(this.multiModelConfig, describeModelOutputPrimaryContainer.multiModelConfig) &&
        Objects.equals(this.modelDataSource, describeModelOutputPrimaryContainer.modelDataSource);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeModelOutputPrimaryContainer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeModelOutputPrimaryContainer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeModelOutputPrimaryContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeModelOutputPrimaryContainer is not found in the empty JSON string", DescribeModelOutputPrimaryContainer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeModelOutputPrimaryContainer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeModelOutputPrimaryContainer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeModelOutputPrimaryContainer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeModelOutputPrimaryContainer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeModelOutputPrimaryContainer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeModelOutputPrimaryContainer.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeModelOutputPrimaryContainer>() {
           @Override
           public void write(JsonWriter out, DescribeModelOutputPrimaryContainer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeModelOutputPrimaryContainer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeModelOutputPrimaryContainer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeModelOutputPrimaryContainer
   * @throws IOException if the JSON string is invalid with respect to DescribeModelOutputPrimaryContainer
   */
  public static DescribeModelOutputPrimaryContainer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeModelOutputPrimaryContainer.class);
  }

  /**
   * Convert an instance of DescribeModelOutputPrimaryContainer to an JSON string
   *
   * @return JSON string
   */
