...
public class TrialComponentSourceDetailProcessingJob {
  ...
  public TrialComponentSourceDetailProcessingJob() {
  }

  public TrialComponentSourceDetailProcessingJob processingInputs(List processingInputs) {
  ...
  public TrialComponentSourceDetailProcessingJob processingOutputConfig(ProcessingOutputConfig processingOutputConfig) {
  ...
  public TrialComponentSourceDetailProcessingJob processingJobName(String processingJobName) {
  ...
  public TrialComponentSourceDetailProcessingJob processingResources(ProcessingResources processingResources) {
  ...
  public TrialComponentSourceDetailProcessingJob stoppingCondition(ProcessingStoppingCondition stoppingCondition) {
  ...
  public TrialComponentSourceDetailProcessingJob appSpecification(AppSpecification appSpecification) {
  ...
  public TrialComponentSourceDetailProcessingJob environment(Map environment) {
  ...
  public TrialComponentSourceDetailProcessingJob networkConfig(NetworkConfig networkConfig) {
  ...
  public TrialComponentSourceDetailProcessingJob roleArn(String roleArn) {
  ...
  public TrialComponentSourceDetailProcessingJob experimentConfig(ExperimentConfig experimentConfig) {
  ...
  public TrialComponentSourceDetailProcessingJob processingJobArn(String processingJobArn) {
  ...
  public TrialComponentSourceDetailProcessingJob processingJobStatus(ProcessingJobStatus processingJobStatus) {
  ...
  public TrialComponentSourceDetailProcessingJob exitMessage(String exitMessage) {
  ...
  public TrialComponentSourceDetailProcessingJob failureReason(String failureReason) {
  ...
  public TrialComponentSourceDetailProcessingJob processingEndTime(OffsetDateTime processingEndTime) {
  ...
  public TrialComponentSourceDetailProcessingJob processingStartTime(OffsetDateTime processingStartTime) {
  ...
  public TrialComponentSourceDetailProcessingJob lastModifiedTime(OffsetDateTime lastModifiedTime) {
  ...
  public TrialComponentSourceDetailProcessingJob creationTime(OffsetDateTime creationTime) {
  ...
  public TrialComponentSourceDetailProcessingJob monitoringScheduleArn(String monitoringScheduleArn) {
  ...
  public TrialComponentSourceDetailProcessingJob autoMLJobArn(String autoMLJobArn) {
  ...
  public TrialComponentSourceDetailProcessingJob trainingJobArn(String trainingJobArn) {
  ...
  public TrialComponentSourceDetailProcessingJob tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrialComponentSourceDetailProcessingJob trialComponentSourceDetailProcessingJob = (TrialComponentSourceDetailProcessingJob) o;
    return Objects.equals(this.processingInputs, trialComponentSourceDetailProcessingJob.processingInputs) &&
        Objects.equals(this.processingOutputConfig, trialComponentSourceDetailProcessingJob.processingOutputConfig) &&
        Objects.equals(this.processingJobName, trialComponentSourceDetailProcessingJob.processingJobName) &&
        Objects.equals(this.processingResources, trialComponentSourceDetailProcessingJob.processingResources) &&
        Objects.equals(this.stoppingCondition, trialComponentSourceDetailProcessingJob.stoppingCondition) &&
        Objects.equals(this.appSpecification, trialComponentSourceDetailProcessingJob.appSpecification) &&
        Objects.equals(this.environment, trialComponentSourceDetailProcessingJob.environment) &&
        Objects.equals(this.networkConfig, trialComponentSourceDetailProcessingJob.networkConfig) &&
        Objects.equals(this.roleArn, trialComponentSourceDetailProcessingJob.roleArn) &&
        Objects.equals(this.experimentConfig, trialComponentSourceDetailProcessingJob.experimentConfig) &&
        Objects.equals(this.processingJobArn, trialComponentSourceDetailProcessingJob.processingJobArn) &&
        Objects.equals(this.processingJobStatus, trialComponentSourceDetailProcessingJob.processingJobStatus) &&
        Objects.equals(this.exitMessage, trialComponentSourceDetailProcessingJob.exitMessage) &&
        Objects.equals(this.failureReason, trialComponentSourceDetailProcessingJob.failureReason) &&
        Objects.equals(this.processingEndTime, trialComponentSourceDetailProcessingJob.processingEndTime) &&
        Objects.equals(this.processingStartTime, trialComponentSourceDetailProcessingJob.processingStartTime) &&
        Objects.equals(this.lastModifiedTime, trialComponentSourceDetailProcessingJob.lastModifiedTime) &&
        Objects.equals(this.creationTime, trialComponentSourceDetailProcessingJob.creationTime) &&
        Objects.equals(this.monitoringScheduleArn, trialComponentSourceDetailProcessingJob.monitoringScheduleArn) &&
        Objects.equals(this.autoMLJobArn, trialComponentSourceDetailProcessingJob.autoMLJobArn) &&
        Objects.equals(this.trainingJobArn, trialComponentSourceDetailProcessingJob.trainingJobArn) &&
        Objects.equals(this.tags, trialComponentSourceDetailProcessingJob.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrialComponentSourceDetailProcessingJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrialComponentSourceDetailProcessingJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrialComponentSourceDetailProcessingJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrialComponentSourceDetailProcessingJob is not found in the empty JSON string", TrialComponentSourceDetailProcessingJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrialComponentSourceDetailProcessingJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrialComponentSourceDetailProcessingJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrialComponentSourceDetailProcessingJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrialComponentSourceDetailProcessingJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrialComponentSourceDetailProcessingJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrialComponentSourceDetailProcessingJob.class));

       return (TypeAdapter<T>) new TypeAdapter<TrialComponentSourceDetailProcessingJob>() {
           @Override
           public void write(JsonWriter out, TrialComponentSourceDetailProcessingJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrialComponentSourceDetailProcessingJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrialComponentSourceDetailProcessingJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrialComponentSourceDetailProcessingJob
   * @throws IOException if the JSON string is invalid with respect to TrialComponentSourceDetailProcessingJob
   */
  public static TrialComponentSourceDetailProcessingJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrialComponentSourceDetailProcessingJob.class);
  }

  /**
   * Convert an instance of TrialComponentSourceDetailProcessingJob to an JSON string
   *
   * @return JSON string
   */
