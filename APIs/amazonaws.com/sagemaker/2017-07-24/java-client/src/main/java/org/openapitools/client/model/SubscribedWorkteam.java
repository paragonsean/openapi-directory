...
public class SubscribedWorkteam {
  ...
  public SubscribedWorkteam() {
  }

  public SubscribedWorkteam workteamArn(String workteamArn) {
  ...
  public SubscribedWorkteam marketplaceTitle(String marketplaceTitle) {
  ...
  public SubscribedWorkteam sellerName(String sellerName) {
  ...
  public SubscribedWorkteam marketplaceDescription(String marketplaceDescription) {
  ...
  public SubscribedWorkteam listingId(String listingId) {
  ...
  public boolean equals(Object o) {
    ...
    SubscribedWorkteam subscribedWorkteam = (SubscribedWorkteam) o;
    return Objects.equals(this.workteamArn, subscribedWorkteam.workteamArn) &&
        Objects.equals(this.marketplaceTitle, subscribedWorkteam.marketplaceTitle) &&
        Objects.equals(this.sellerName, subscribedWorkteam.sellerName) &&
        Objects.equals(this.marketplaceDescription, subscribedWorkteam.marketplaceDescription) &&
        Objects.equals(this.listingId, subscribedWorkteam.listingId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscribedWorkteam {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubscribedWorkteam
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubscribedWorkteam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscribedWorkteam is not found in the empty JSON string", SubscribedWorkteam.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubscribedWorkteam.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubscribedWorkteam` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SubscribedWorkteam.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscribedWorkteam.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscribedWorkteam' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscribedWorkteam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscribedWorkteam.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscribedWorkteam>() {
           @Override
           public void write(JsonWriter out, SubscribedWorkteam value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubscribedWorkteam read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SubscribedWorkteam given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubscribedWorkteam
   * @throws IOException if the JSON string is invalid with respect to SubscribedWorkteam
   */
  public static SubscribedWorkteam fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubscribedWorkteam.class);
  }

  /**
   * Convert an instance of SubscribedWorkteam to an JSON string
   *
   * @return JSON string
   */
