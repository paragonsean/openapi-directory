...
public class ResourceConfig {
  ...
  public ResourceConfig instanceType(TrainingInstanceType instanceType) {
  ...
  public ResourceConfig instanceCount(Integer instanceCount) {
  ...
  public ResourceConfig volumeSizeInGB(Integer volumeSizeInGB) {
  ...
  public ResourceConfig volumeKmsKeyId(String volumeKmsKeyId) {
  ...
  public ResourceConfig instanceGroups(List instanceGroups) {
  ...
  public ResourceConfig keepAlivePeriodInSeconds(Integer keepAlivePeriodInSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instanceType, resourceConfig.instanceType) &&
        Objects.equals(this.instanceCount, resourceConfig.instanceCount) &&
        Objects.equals(this.volumeSizeInGB, resourceConfig.volumeSizeInGB) &&
        Objects.equals(this.volumeKmsKeyId, resourceConfig.volumeKmsKeyId) &&
        Objects.equals(this.instanceGroups, resourceConfig.instanceGroups) &&
        Objects.equals(this.keepAlivePeriodInSeconds, resourceConfig.keepAlivePeriodInSeconds);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceConfig is not found in the empty JSON string", ResourceConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceConfig>() {
           @Override
           public void write(JsonWriter out, ResourceConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceConfig
   * @throws IOException if the JSON string is invalid with respect to ResourceConfig
   */
  public static ResourceConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceConfig.class);
  }

  /**
   * Convert an instance of ResourceConfig to an JSON string
   *
   * @return JSON string
   */
