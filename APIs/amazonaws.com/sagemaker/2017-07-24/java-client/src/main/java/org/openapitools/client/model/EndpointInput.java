...
public class EndpointInput {
  ...
  public EndpointInput endpointName(String endpointName) {
  ...
  public EndpointInput localPath(String localPath) {
  ...
  public EndpointInput s3InputMode(ProcessingS3InputMode s3InputMode) {
  ...
  public EndpointInput s3DataDistributionType(ProcessingS3DataDistributionType s3DataDistributionType) {
  ...
  public EndpointInput featuresAttribute(String featuresAttribute) {
  ...
  public EndpointInput inferenceAttribute(String inferenceAttribute) {
  ...
  public EndpointInput probabilityAttribute(String probabilityAttribute) {
  ...
  public EndpointInput probabilityThresholdAttribute(Double probabilityThresholdAttribute) {
  ...
  public EndpointInput startTimeOffset(String startTimeOffset) {
  ...
  public EndpointInput endTimeOffset(String endTimeOffset) {
  ...
  public boolean equals(Object o) {
    ...
    EndpointInput endpointInput = (EndpointInput) o;
    return Objects.equals(this.endpointName, endpointInput.endpointName) &&
        Objects.equals(this.localPath, endpointInput.localPath) &&
        Objects.equals(this.s3InputMode, endpointInput.s3InputMode) &&
        Objects.equals(this.s3DataDistributionType, endpointInput.s3DataDistributionType) &&
        Objects.equals(this.featuresAttribute, endpointInput.featuresAttribute) &&
        Objects.equals(this.inferenceAttribute, endpointInput.inferenceAttribute) &&
        Objects.equals(this.probabilityAttribute, endpointInput.probabilityAttribute) &&
        Objects.equals(this.probabilityThresholdAttribute, endpointInput.probabilityThresholdAttribute) &&
        Objects.equals(this.startTimeOffset, endpointInput.startTimeOffset) &&
        Objects.equals(this.endTimeOffset, endpointInput.endTimeOffset);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EndpointInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EndpointInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EndpointInput is not found in the empty JSON string", EndpointInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EndpointInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EndpointInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EndpointInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EndpointInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EndpointInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EndpointInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EndpointInput.class));

       return (TypeAdapter<T>) new TypeAdapter<EndpointInput>() {
           @Override
           public void write(JsonWriter out, EndpointInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EndpointInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EndpointInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EndpointInput
   * @throws IOException if the JSON string is invalid with respect to EndpointInput
   */
  public static EndpointInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EndpointInput.class);
  }

  /**
   * Convert an instance of EndpointInput to an JSON string
   *
   * @return JSON string
   */
