...
public class UpdateWorkforceResponseWorkforce {
  ...
  public UpdateWorkforceResponseWorkforce() {
  }

  public UpdateWorkforceResponseWorkforce workforceName(String workforceName) {
  ...
  public UpdateWorkforceResponseWorkforce workforceArn(String workforceArn) {
  ...
  public UpdateWorkforceResponseWorkforce lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public UpdateWorkforceResponseWorkforce sourceIpConfig(WorkforceSourceIpConfig sourceIpConfig) {
  ...
  public UpdateWorkforceResponseWorkforce subDomain(String subDomain) {
  ...
  public UpdateWorkforceResponseWorkforce cognitoConfig(WorkforceCognitoConfig cognitoConfig) {
  ...
  public UpdateWorkforceResponseWorkforce oidcConfig(WorkforceOidcConfig oidcConfig) {
  ...
  public UpdateWorkforceResponseWorkforce createDate(OffsetDateTime createDate) {
  ...
  public UpdateWorkforceResponseWorkforce workforceVpcConfig(WorkforceWorkforceVpcConfig workforceVpcConfig) {
  ...
  public UpdateWorkforceResponseWorkforce status(WorkforceStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateWorkforceResponseWorkforce failureReason(String failureReason) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateWorkforceResponseWorkforce updateWorkforceResponseWorkforce = (UpdateWorkforceResponseWorkforce) o;
    return Objects.equals(this.workforceName, updateWorkforceResponseWorkforce.workforceName) &&
        Objects.equals(this.workforceArn, updateWorkforceResponseWorkforce.workforceArn) &&
        Objects.equals(this.lastUpdatedDate, updateWorkforceResponseWorkforce.lastUpdatedDate) &&
        Objects.equals(this.sourceIpConfig, updateWorkforceResponseWorkforce.sourceIpConfig) &&
        Objects.equals(this.subDomain, updateWorkforceResponseWorkforce.subDomain) &&
        Objects.equals(this.cognitoConfig, updateWorkforceResponseWorkforce.cognitoConfig) &&
        Objects.equals(this.oidcConfig, updateWorkforceResponseWorkforce.oidcConfig) &&
        Objects.equals(this.createDate, updateWorkforceResponseWorkforce.createDate) &&
        Objects.equals(this.workforceVpcConfig, updateWorkforceResponseWorkforce.workforceVpcConfig) &&
        Objects.equals(this.status, updateWorkforceResponseWorkforce.status) &&
        Objects.equals(this.failureReason, updateWorkforceResponseWorkforce.failureReason);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateWorkforceResponseWorkforce {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateWorkforceResponseWorkforce
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateWorkforceResponseWorkforce.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateWorkforceResponseWorkforce is not found in the empty JSON string", UpdateWorkforceResponseWorkforce.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateWorkforceResponseWorkforce.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateWorkforceResponseWorkforce` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateWorkforceResponseWorkforce.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateWorkforceResponseWorkforce.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateWorkforceResponseWorkforce' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateWorkforceResponseWorkforce> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateWorkforceResponseWorkforce.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateWorkforceResponseWorkforce>() {
           @Override
           public void write(JsonWriter out, UpdateWorkforceResponseWorkforce value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateWorkforceResponseWorkforce read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateWorkforceResponseWorkforce given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateWorkforceResponseWorkforce
   * @throws IOException if the JSON string is invalid with respect to UpdateWorkforceResponseWorkforce
   */
  public static UpdateWorkforceResponseWorkforce fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateWorkforceResponseWorkforce.class);
  }

  /**
   * Convert an instance of UpdateWorkforceResponseWorkforce to an JSON string
   *
   * @return JSON string
   */
