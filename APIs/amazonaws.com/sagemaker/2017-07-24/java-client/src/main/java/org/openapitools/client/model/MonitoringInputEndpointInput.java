...
public class MonitoringInputEndpointInput {
  ...
  public MonitoringInputEndpointInput() {
  }

  public MonitoringInputEndpointInput endpointName(String endpointName) {
  ...
  public MonitoringInputEndpointInput localPath(String localPath) {
  ...
  public MonitoringInputEndpointInput s3InputMode(ProcessingS3InputMode s3InputMode) {
  ...
  public MonitoringInputEndpointInput s3DataDistributionType(ProcessingS3DataDistributionType s3DataDistributionType) {
  ...
  public MonitoringInputEndpointInput featuresAttribute(String featuresAttribute) {
  ...
  public MonitoringInputEndpointInput inferenceAttribute(String inferenceAttribute) {
  ...
  public MonitoringInputEndpointInput probabilityAttribute(String probabilityAttribute) {
  ...
  public MonitoringInputEndpointInput probabilityThresholdAttribute(Double probabilityThresholdAttribute) {
  ...
  public MonitoringInputEndpointInput startTimeOffset(String startTimeOffset) {
  ...
  public MonitoringInputEndpointInput endTimeOffset(String endTimeOffset) {
  ...
  public boolean equals(Object o) {
    ...
    MonitoringInputEndpointInput monitoringInputEndpointInput = (MonitoringInputEndpointInput) o;
    return Objects.equals(this.endpointName, monitoringInputEndpointInput.endpointName) &&
        Objects.equals(this.localPath, monitoringInputEndpointInput.localPath) &&
        Objects.equals(this.s3InputMode, monitoringInputEndpointInput.s3InputMode) &&
        Objects.equals(this.s3DataDistributionType, monitoringInputEndpointInput.s3DataDistributionType) &&
        Objects.equals(this.featuresAttribute, monitoringInputEndpointInput.featuresAttribute) &&
        Objects.equals(this.inferenceAttribute, monitoringInputEndpointInput.inferenceAttribute) &&
        Objects.equals(this.probabilityAttribute, monitoringInputEndpointInput.probabilityAttribute) &&
        Objects.equals(this.probabilityThresholdAttribute, monitoringInputEndpointInput.probabilityThresholdAttribute) &&
        Objects.equals(this.startTimeOffset, monitoringInputEndpointInput.startTimeOffset) &&
        Objects.equals(this.endTimeOffset, monitoringInputEndpointInput.endTimeOffset);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endpointName, localPath, s3InputMode, s3DataDistributionType, featuresAttribute, inferenceAttribute, probabilityAttribute, probabilityThresholdAttribute, startTimeOffset, endTimeOffset);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MonitoringInputEndpointInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitoringInputEndpointInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitoringInputEndpointInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitoringInputEndpointInput is not found in the empty JSON string", MonitoringInputEndpointInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitoringInputEndpointInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitoringInputEndpointInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitoringInputEndpointInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitoringInputEndpointInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitoringInputEndpointInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitoringInputEndpointInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitoringInputEndpointInput.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitoringInputEndpointInput>() {
           @Override
           public void write(JsonWriter out, MonitoringInputEndpointInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitoringInputEndpointInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitoringInputEndpointInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitoringInputEndpointInput
   * @throws IOException if the JSON string is invalid with respect to MonitoringInputEndpointInput
   */
  public static MonitoringInputEndpointInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitoringInputEndpointInput.class);
  }

  /**
   * Convert an instance of MonitoringInputEndpointInput to an JSON string
   *
   * @return JSON string
   */
