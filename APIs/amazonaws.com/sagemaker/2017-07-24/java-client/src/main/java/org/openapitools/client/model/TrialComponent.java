...
public class TrialComponent {
  ...
  public TrialComponent trialComponentName(String trialComponentName) {
  ...
  public TrialComponent displayName(String displayName) {
  ...
  public TrialComponent trialComponentArn(String trialComponentArn) {
  ...
  public TrialComponent source(TrialComponentSource source) {
    this.source = source;
    return this;
  }
  ...
  public TrialComponent status(TrialComponentStatus status) {
    this.status = status;
    return this;
  }
  ...
  public TrialComponent startTime(OffsetDateTime startTime) {
  ...
  public TrialComponent endTime(OffsetDateTime endTime) {
  ...
  public TrialComponent creationTime(OffsetDateTime creationTime) {
  ...
  public TrialComponent createdBy(DescribeTrialComponentResponseCreatedBy createdBy) {
  ...
  public TrialComponent lastModifiedTime(OffsetDateTime lastModifiedTime) {
  ...
  public TrialComponent lastModifiedBy(UserContext lastModifiedBy) {
  ...
  public TrialComponent parameters(Map parameters) {
  ...
  public TrialComponent inputArtifacts(Map inputArtifacts) {
  ...
  public TrialComponent outputArtifacts(Map outputArtifacts) {
  ...
  public TrialComponent metrics(List metrics) {
  ...
  public TrialComponent metadataProperties(MetadataProperties metadataProperties) {
  ...
  public TrialComponent sourceDetail(TrialComponentSourceDetail sourceDetail) {
  ...
  public TrialComponent lineageGroupArn(String lineageGroupArn) {
  ...
  public TrialComponent tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public TrialComponent parents(List parents) {
  ...
  public TrialComponent runName(String runName) {
  ...
  public boolean equals(Object o) {
    ...
    TrialComponent trialComponent = (TrialComponent) o;
    return Objects.equals(this.trialComponentName, trialComponent.trialComponentName) &&
        Objects.equals(this.displayName, trialComponent.displayName) &&
        Objects.equals(this.trialComponentArn, trialComponent.trialComponentArn) &&
        Objects.equals(this.source, trialComponent.source) &&
        Objects.equals(this.status, trialComponent.status) &&
        Objects.equals(this.startTime, trialComponent.startTime) &&
        Objects.equals(this.endTime, trialComponent.endTime) &&
        Objects.equals(this.creationTime, trialComponent.creationTime) &&
        Objects.equals(this.createdBy, trialComponent.createdBy) &&
        Objects.equals(this.lastModifiedTime, trialComponent.lastModifiedTime) &&
        Objects.equals(this.lastModifiedBy, trialComponent.lastModifiedBy) &&
        Objects.equals(this.parameters, trialComponent.parameters) &&
        Objects.equals(this.inputArtifacts, trialComponent.inputArtifacts) &&
        Objects.equals(this.outputArtifacts, trialComponent.outputArtifacts) &&
        Objects.equals(this.metrics, trialComponent.metrics) &&
        Objects.equals(this.metadataProperties, trialComponent.metadataProperties) &&
        Objects.equals(this.sourceDetail, trialComponent.sourceDetail) &&
        Objects.equals(this.lineageGroupArn, trialComponent.lineageGroupArn) &&
        Objects.equals(this.tags, trialComponent.tags) &&
        Objects.equals(this.parents, trialComponent.parents) &&
        Objects.equals(this.runName, trialComponent.runName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrialComponent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrialComponent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrialComponent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrialComponent is not found in the empty JSON string", TrialComponent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrialComponent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrialComponent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrialComponent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrialComponent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrialComponent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrialComponent.class));

       return (TypeAdapter<T>) new TypeAdapter<TrialComponent>() {
           @Override
           public void write(JsonWriter out, TrialComponent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrialComponent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrialComponent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrialComponent
   * @throws IOException if the JSON string is invalid with respect to TrialComponent
   */
  public static TrialComponent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrialComponent.class);
  }

  /**
   * Convert an instance of TrialComponent to an JSON string
   *
   * @return JSON string
   */
