...
public class TabularJobConfig {
  ...
  public TabularJobConfig() {
  }

  public TabularJobConfig candidateGenerationConfig(TabularJobConfigCandidateGenerationConfig candidateGenerationConfig) {
  ...
  public TabularJobConfig completionCriteria(AutoMLJobCompletionCriteria completionCriteria) {
  ...
  public TabularJobConfig featureSpecificationS3Uri(String featureSpecificationS3Uri) {
  ...
  public TabularJobConfig mode(AutoMLMode mode) {
    this.mode = mode;
    return this;
  }
  ...
  public TabularJobConfig generateCandidateDefinitionsOnly(Boolean generateCandidateDefinitionsOnly) {
  ...
  public TabularJobConfig problemType(ProblemType problemType) {
  ...
  public TabularJobConfig targetAttributeName(String targetAttributeName) {
  ...
  public TabularJobConfig sampleWeightAttributeName(String sampleWeightAttributeName) {
  ...
  public boolean equals(Object o) {
    ...
    TabularJobConfig tabularJobConfig = (TabularJobConfig) o;
    return Objects.equals(this.candidateGenerationConfig, tabularJobConfig.candidateGenerationConfig) &&
        Objects.equals(this.completionCriteria, tabularJobConfig.completionCriteria) &&
        Objects.equals(this.featureSpecificationS3Uri, tabularJobConfig.featureSpecificationS3Uri) &&
        Objects.equals(this.mode, tabularJobConfig.mode) &&
        Objects.equals(this.generateCandidateDefinitionsOnly, tabularJobConfig.generateCandidateDefinitionsOnly) &&
        Objects.equals(this.problemType, tabularJobConfig.problemType) &&
        Objects.equals(this.targetAttributeName, tabularJobConfig.targetAttributeName) &&
        Objects.equals(this.sampleWeightAttributeName, tabularJobConfig.sampleWeightAttributeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TabularJobConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TabularJobConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TabularJobConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TabularJobConfig is not found in the empty JSON string", TabularJobConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TabularJobConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TabularJobConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TabularJobConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TabularJobConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TabularJobConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TabularJobConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TabularJobConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<TabularJobConfig>() {
           @Override
           public void write(JsonWriter out, TabularJobConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TabularJobConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TabularJobConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TabularJobConfig
   * @throws IOException if the JSON string is invalid with respect to TabularJobConfig
   */
  public static TabularJobConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TabularJobConfig.class);
  }

  /**
   * Convert an instance of TabularJobConfig to an JSON string
   *
   * @return JSON string
   */
