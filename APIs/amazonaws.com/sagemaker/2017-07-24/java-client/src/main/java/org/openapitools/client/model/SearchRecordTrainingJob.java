...
public class SearchRecordTrainingJob {
  ...
  public SearchRecordTrainingJob() {
  }

  public SearchRecordTrainingJob trainingJobName(String trainingJobName) {
  ...
  public SearchRecordTrainingJob trainingJobArn(String trainingJobArn) {
  ...
  public SearchRecordTrainingJob tuningJobArn(String tuningJobArn) {
  ...
  public SearchRecordTrainingJob labelingJobArn(String labelingJobArn) {
  ...
  public SearchRecordTrainingJob autoMLJobArn(String autoMLJobArn) {
  ...
  public SearchRecordTrainingJob modelArtifacts(TrainingJobModelArtifacts modelArtifacts) {
  ...
  public SearchRecordTrainingJob trainingJobStatus(TrainingJobStatus trainingJobStatus) {
  ...
  public SearchRecordTrainingJob secondaryStatus(SecondaryStatus secondaryStatus) {
  ...
  public SearchRecordTrainingJob failureReason(String failureReason) {
  ...
  public SearchRecordTrainingJob hyperParameters(Map hyperParameters) {
  ...
  public SearchRecordTrainingJob algorithmSpecification(TrainingJobAlgorithmSpecification algorithmSpecification) {
  ...
  public SearchRecordTrainingJob roleArn(String roleArn) {
  ...
  public SearchRecordTrainingJob inputDataConfig(List inputDataConfig) {
  ...
  public SearchRecordTrainingJob outputDataConfig(TrainingJobOutputDataConfig outputDataConfig) {
  ...
  public SearchRecordTrainingJob resourceConfig(TrainingJobResourceConfig resourceConfig) {
  ...
  public SearchRecordTrainingJob vpcConfig(DescribeTrainingJobResponseVpcConfig vpcConfig) {
  ...
  public SearchRecordTrainingJob stoppingCondition(CreateTrainingJobRequestStoppingCondition stoppingCondition) {
  ...
  public SearchRecordTrainingJob creationTime(OffsetDateTime creationTime) {
  ...
  public SearchRecordTrainingJob trainingStartTime(OffsetDateTime trainingStartTime) {
  ...
  public SearchRecordTrainingJob trainingEndTime(OffsetDateTime trainingEndTime) {
  ...
  public SearchRecordTrainingJob lastModifiedTime(OffsetDateTime lastModifiedTime) {
  ...
  public SearchRecordTrainingJob secondaryStatusTransitions(List secondaryStatusTransitions) {
  ...
  public SearchRecordTrainingJob finalMetricDataList(List finalMetricDataList) {
  ...
  public SearchRecordTrainingJob enableNetworkIsolation(Boolean enableNetworkIsolation) {
  ...
  public SearchRecordTrainingJob enableInterContainerTrafficEncryption(Boolean enableInterContainerTrafficEncryption) {
  ...
  public SearchRecordTrainingJob enableManagedSpotTraining(Boolean enableManagedSpotTraining) {
  ...
  public SearchRecordTrainingJob checkpointConfig(CheckpointConfig checkpointConfig) {
  ...
  public SearchRecordTrainingJob trainingTimeInSeconds(Integer trainingTimeInSeconds) {
  ...
  public SearchRecordTrainingJob billableTimeInSeconds(Integer billableTimeInSeconds) {
  ...
  public SearchRecordTrainingJob debugHookConfig(DebugHookConfig debugHookConfig) {
  ...
  public SearchRecordTrainingJob experimentConfig(ExperimentConfig experimentConfig) {
  ...
  public SearchRecordTrainingJob debugRuleConfigurations(List debugRuleConfigurations) {
  ...
  public SearchRecordTrainingJob tensorBoardOutputConfig(TensorBoardOutputConfig tensorBoardOutputConfig) {
  ...
  public SearchRecordTrainingJob debugRuleEvaluationStatuses(List debugRuleEvaluationStatuses) {
  ...
  public SearchRecordTrainingJob profilerConfig(ProfilerConfig profilerConfig) {
  ...
  public SearchRecordTrainingJob environment(Map environment) {
  ...
  public SearchRecordTrainingJob retryStrategy(CreateTrainingJobRequestRetryStrategy retryStrategy) {
  ...
  public SearchRecordTrainingJob tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchRecordTrainingJob searchRecordTrainingJob = (SearchRecordTrainingJob) o;
    return Objects.equals(this.trainingJobName, searchRecordTrainingJob.trainingJobName) &&
        Objects.equals(this.trainingJobArn, searchRecordTrainingJob.trainingJobArn) &&
        Objects.equals(this.tuningJobArn, searchRecordTrainingJob.tuningJobArn) &&
        Objects.equals(this.labelingJobArn, searchRecordTrainingJob.labelingJobArn) &&
        Objects.equals(this.autoMLJobArn, searchRecordTrainingJob.autoMLJobArn) &&
        Objects.equals(this.modelArtifacts, searchRecordTrainingJob.modelArtifacts) &&
        Objects.equals(this.trainingJobStatus, searchRecordTrainingJob.trainingJobStatus) &&
        Objects.equals(this.secondaryStatus, searchRecordTrainingJob.secondaryStatus) &&
        Objects.equals(this.failureReason, searchRecordTrainingJob.failureReason) &&
        Objects.equals(this.hyperParameters, searchRecordTrainingJob.hyperParameters) &&
        Objects.equals(this.algorithmSpecification, searchRecordTrainingJob.algorithmSpecification) &&
        Objects.equals(this.roleArn, searchRecordTrainingJob.roleArn) &&
        Objects.equals(this.inputDataConfig, searchRecordTrainingJob.inputDataConfig) &&
        Objects.equals(this.outputDataConfig, searchRecordTrainingJob.outputDataConfig) &&
        Objects.equals(this.resourceConfig, searchRecordTrainingJob.resourceConfig) &&
        Objects.equals(this.vpcConfig, searchRecordTrainingJob.vpcConfig) &&
        Objects.equals(this.stoppingCondition, searchRecordTrainingJob.stoppingCondition) &&
        Objects.equals(this.creationTime, searchRecordTrainingJob.creationTime) &&
        Objects.equals(this.trainingStartTime, searchRecordTrainingJob.trainingStartTime) &&
        Objects.equals(this.trainingEndTime, searchRecordTrainingJob.trainingEndTime) &&
        Objects.equals(this.lastModifiedTime, searchRecordTrainingJob.lastModifiedTime) &&
        Objects.equals(this.secondaryStatusTransitions, searchRecordTrainingJob.secondaryStatusTransitions) &&
        Objects.equals(this.finalMetricDataList, searchRecordTrainingJob.finalMetricDataList) &&
        Objects.equals(this.enableNetworkIsolation, searchRecordTrainingJob.enableNetworkIsolation) &&
        Objects.equals(this.enableInterContainerTrafficEncryption, searchRecordTrainingJob.enableInterContainerTrafficEncryption) &&
        Objects.equals(this.enableManagedSpotTraining, searchRecordTrainingJob.enableManagedSpotTraining) &&
        Objects.equals(this.checkpointConfig, searchRecordTrainingJob.checkpointConfig) &&
        Objects.equals(this.trainingTimeInSeconds, searchRecordTrainingJob.trainingTimeInSeconds) &&
        Objects.equals(this.billableTimeInSeconds, searchRecordTrainingJob.billableTimeInSeconds) &&
        Objects.equals(this.debugHookConfig, searchRecordTrainingJob.debugHookConfig) &&
        Objects.equals(this.experimentConfig, searchRecordTrainingJob.experimentConfig) &&
        Objects.equals(this.debugRuleConfigurations, searchRecordTrainingJob.debugRuleConfigurations) &&
        Objects.equals(this.tensorBoardOutputConfig, searchRecordTrainingJob.tensorBoardOutputConfig) &&
        Objects.equals(this.debugRuleEvaluationStatuses, searchRecordTrainingJob.debugRuleEvaluationStatuses) &&
        Objects.equals(this.profilerConfig, searchRecordTrainingJob.profilerConfig) &&
        Objects.equals(this.environment, searchRecordTrainingJob.environment) &&
        Objects.equals(this.retryStrategy, searchRecordTrainingJob.retryStrategy) &&
        Objects.equals(this.tags, searchRecordTrainingJob.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchRecordTrainingJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchRecordTrainingJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchRecordTrainingJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchRecordTrainingJob is not found in the empty JSON string", SearchRecordTrainingJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchRecordTrainingJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchRecordTrainingJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchRecordTrainingJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchRecordTrainingJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchRecordTrainingJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchRecordTrainingJob.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchRecordTrainingJob>() {
           @Override
           public void write(JsonWriter out, SearchRecordTrainingJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchRecordTrainingJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchRecordTrainingJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchRecordTrainingJob
   * @throws IOException if the JSON string is invalid with respect to SearchRecordTrainingJob
   */
  public static SearchRecordTrainingJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchRecordTrainingJob.class);
  }

  /**
   * Convert an instance of SearchRecordTrainingJob to an JSON string
   *
   * @return JSON string
   */
