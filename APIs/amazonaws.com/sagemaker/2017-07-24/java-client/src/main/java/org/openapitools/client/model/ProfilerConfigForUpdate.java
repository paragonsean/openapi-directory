...
public class ProfilerConfigForUpdate {
  ...
  public ProfilerConfigForUpdate s3OutputPath(String s3OutputPath) {
  ...
  public ProfilerConfigForUpdate profilingIntervalInMilliseconds(Integer profilingIntervalInMilliseconds) {
  ...
  public ProfilerConfigForUpdate profilingParameters(Map profilingParameters) {
  ...
  public ProfilerConfigForUpdate disableProfiler(Boolean disableProfiler) {
  ...
  public boolean equals(Object o) {
    ...
    ProfilerConfigForUpdate profilerConfigForUpdate = (ProfilerConfigForUpdate) o;
    return Objects.equals(this.s3OutputPath, profilerConfigForUpdate.s3OutputPath) &&
        Objects.equals(this.profilingIntervalInMilliseconds, profilerConfigForUpdate.profilingIntervalInMilliseconds) &&
        Objects.equals(this.profilingParameters, profilerConfigForUpdate.profilingParameters) &&
        Objects.equals(this.disableProfiler, profilerConfigForUpdate.disableProfiler);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProfilerConfigForUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProfilerConfigForUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProfilerConfigForUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProfilerConfigForUpdate is not found in the empty JSON string", ProfilerConfigForUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProfilerConfigForUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProfilerConfigForUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProfilerConfigForUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProfilerConfigForUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProfilerConfigForUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProfilerConfigForUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<ProfilerConfigForUpdate>() {
           @Override
           public void write(JsonWriter out, ProfilerConfigForUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProfilerConfigForUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProfilerConfigForUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProfilerConfigForUpdate
   * @throws IOException if the JSON string is invalid with respect to ProfilerConfigForUpdate
   */
  public static ProfilerConfigForUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProfilerConfigForUpdate.class);
  }

  /**
   * Convert an instance of ProfilerConfigForUpdate to an JSON string
   *
   * @return JSON string
   */
