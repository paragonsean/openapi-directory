...
public class MonitoringAppSpecification {
  ...
  public MonitoringAppSpecification() {
  }

  public MonitoringAppSpecification imageUri(String imageUri) {
  ...
  public MonitoringAppSpecification containerEntrypoint(List containerEntrypoint) {
  ...
  public MonitoringAppSpecification containerArguments(List containerArguments) {
  ...
  public MonitoringAppSpecification recordPreprocessorSourceUri(String recordPreprocessorSourceUri) {
  ...
  public MonitoringAppSpecification postAnalyticsProcessorSourceUri(String postAnalyticsProcessorSourceUri) {
  ...
  public boolean equals(Object o) {
    ...
    MonitoringAppSpecification monitoringAppSpecification = (MonitoringAppSpecification) o;
    return Objects.equals(this.imageUri, monitoringAppSpecification.imageUri) &&
        Objects.equals(this.containerEntrypoint, monitoringAppSpecification.containerEntrypoint) &&
        Objects.equals(this.containerArguments, monitoringAppSpecification.containerArguments) &&
        Objects.equals(this.recordPreprocessorSourceUri, monitoringAppSpecification.recordPreprocessorSourceUri) &&
        Objects.equals(this.postAnalyticsProcessorSourceUri, monitoringAppSpecification.postAnalyticsProcessorSourceUri);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitoringAppSpecification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitoringAppSpecification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitoringAppSpecification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitoringAppSpecification is not found in the empty JSON string", MonitoringAppSpecification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitoringAppSpecification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitoringAppSpecification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitoringAppSpecification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitoringAppSpecification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitoringAppSpecification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitoringAppSpecification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitoringAppSpecification.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitoringAppSpecification>() {
           @Override
           public void write(JsonWriter out, MonitoringAppSpecification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitoringAppSpecification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitoringAppSpecification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitoringAppSpecification
   * @throws IOException if the JSON string is invalid with respect to MonitoringAppSpecification
   */
  public static MonitoringAppSpecification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitoringAppSpecification.class);
  }

  /**
   * Convert an instance of MonitoringAppSpecification to an JSON string
   *
   * @return JSON string
   */
