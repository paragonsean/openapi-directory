...
public class TrialComponentSourceDetailTransformJob {
  ...
  public TrialComponentSourceDetailTransformJob() {
  }

  public TrialComponentSourceDetailTransformJob transformJobName(String transformJobName) {
  ...
  public TrialComponentSourceDetailTransformJob transformJobArn(String transformJobArn) {
  ...
  public TrialComponentSourceDetailTransformJob transformJobStatus(TransformJobStatus transformJobStatus) {
  ...
  public TrialComponentSourceDetailTransformJob failureReason(String failureReason) {
  ...
  public TrialComponentSourceDetailTransformJob modelName(String modelName) {
  ...
  public TrialComponentSourceDetailTransformJob maxConcurrentTransforms(Integer maxConcurrentTransforms) {
  ...
  public TrialComponentSourceDetailTransformJob modelClientConfig(ModelClientConfig modelClientConfig) {
  ...
  public TrialComponentSourceDetailTransformJob maxPayloadInMB(Integer maxPayloadInMB) {
  ...
  public TrialComponentSourceDetailTransformJob batchStrategy(BatchStrategy batchStrategy) {
  ...
  public TrialComponentSourceDetailTransformJob environment(Map environment) {
  ...
  public TrialComponentSourceDetailTransformJob transformInput(TransformInput transformInput) {
  ...
  public TrialComponentSourceDetailTransformJob transformOutput(TransformOutput transformOutput) {
  ...
  public TrialComponentSourceDetailTransformJob transformResources(TransformResources transformResources) {
  ...
  public TrialComponentSourceDetailTransformJob creationTime(OffsetDateTime creationTime) {
  ...
  public TrialComponentSourceDetailTransformJob transformStartTime(OffsetDateTime transformStartTime) {
  ...
  public TrialComponentSourceDetailTransformJob transformEndTime(OffsetDateTime transformEndTime) {
  ...
  public TrialComponentSourceDetailTransformJob labelingJobArn(String labelingJobArn) {
  ...
  public TrialComponentSourceDetailTransformJob autoMLJobArn(String autoMLJobArn) {
  ...
  public TrialComponentSourceDetailTransformJob dataProcessing(DataProcessing dataProcessing) {
  ...
  public TrialComponentSourceDetailTransformJob experimentConfig(ExperimentConfig experimentConfig) {
  ...
  public TrialComponentSourceDetailTransformJob tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public TrialComponentSourceDetailTransformJob dataCaptureConfig(BatchDataCaptureConfig dataCaptureConfig) {
  ...
  public boolean equals(Object o) {
    ...
    TrialComponentSourceDetailTransformJob trialComponentSourceDetailTransformJob = (TrialComponentSourceDetailTransformJob) o;
    return Objects.equals(this.transformJobName, trialComponentSourceDetailTransformJob.transformJobName) &&
        Objects.equals(this.transformJobArn, trialComponentSourceDetailTransformJob.transformJobArn) &&
        Objects.equals(this.transformJobStatus, trialComponentSourceDetailTransformJob.transformJobStatus) &&
        Objects.equals(this.failureReason, trialComponentSourceDetailTransformJob.failureReason) &&
        Objects.equals(this.modelName, trialComponentSourceDetailTransformJob.modelName) &&
        Objects.equals(this.maxConcurrentTransforms, trialComponentSourceDetailTransformJob.maxConcurrentTransforms) &&
        Objects.equals(this.modelClientConfig, trialComponentSourceDetailTransformJob.modelClientConfig) &&
        Objects.equals(this.maxPayloadInMB, trialComponentSourceDetailTransformJob.maxPayloadInMB) &&
        Objects.equals(this.batchStrategy, trialComponentSourceDetailTransformJob.batchStrategy) &&
        Objects.equals(this.environment, trialComponentSourceDetailTransformJob.environment) &&
        Objects.equals(this.transformInput, trialComponentSourceDetailTransformJob.transformInput) &&
        Objects.equals(this.transformOutput, trialComponentSourceDetailTransformJob.transformOutput) &&
        Objects.equals(this.transformResources, trialComponentSourceDetailTransformJob.transformResources) &&
        Objects.equals(this.creationTime, trialComponentSourceDetailTransformJob.creationTime) &&
        Objects.equals(this.transformStartTime, trialComponentSourceDetailTransformJob.transformStartTime) &&
        Objects.equals(this.transformEndTime, trialComponentSourceDetailTransformJob.transformEndTime) &&
        Objects.equals(this.labelingJobArn, trialComponentSourceDetailTransformJob.labelingJobArn) &&
        Objects.equals(this.autoMLJobArn, trialComponentSourceDetailTransformJob.autoMLJobArn) &&
        Objects.equals(this.dataProcessing, trialComponentSourceDetailTransformJob.dataProcessing) &&
        Objects.equals(this.experimentConfig, trialComponentSourceDetailTransformJob.experimentConfig) &&
        Objects.equals(this.tags, trialComponentSourceDetailTransformJob.tags) &&
        Objects.equals(this.dataCaptureConfig, trialComponentSourceDetailTransformJob.dataCaptureConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrialComponentSourceDetailTransformJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrialComponentSourceDetailTransformJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrialComponentSourceDetailTransformJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrialComponentSourceDetailTransformJob is not found in the empty JSON string", TrialComponentSourceDetailTransformJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrialComponentSourceDetailTransformJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrialComponentSourceDetailTransformJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrialComponentSourceDetailTransformJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrialComponentSourceDetailTransformJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrialComponentSourceDetailTransformJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrialComponentSourceDetailTransformJob.class));

       return (TypeAdapter<T>) new TypeAdapter<TrialComponentSourceDetailTransformJob>() {
           @Override
           public void write(JsonWriter out, TrialComponentSourceDetailTransformJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrialComponentSourceDetailTransformJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrialComponentSourceDetailTransformJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrialComponentSourceDetailTransformJob
   * @throws IOException if the JSON string is invalid with respect to TrialComponentSourceDetailTransformJob
   */
  public static TrialComponentSourceDetailTransformJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrialComponentSourceDetailTransformJob.class);
  }

  /**
   * Convert an instance of TrialComponentSourceDetailTransformJob to an JSON string
   *
   * @return JSON string
   */
