...
public class TrialComponentSourceDetailTrainingJob {
  ...
  public TrialComponentSourceDetailTrainingJob() {
  }

  public TrialComponentSourceDetailTrainingJob trainingJobName(String trainingJobName) {
  ...
  public TrialComponentSourceDetailTrainingJob trainingJobArn(String trainingJobArn) {
  ...
  public TrialComponentSourceDetailTrainingJob tuningJobArn(String tuningJobArn) {
  ...
  public TrialComponentSourceDetailTrainingJob labelingJobArn(String labelingJobArn) {
  ...
  public TrialComponentSourceDetailTrainingJob autoMLJobArn(String autoMLJobArn) {
  ...
  public TrialComponentSourceDetailTrainingJob modelArtifacts(TrainingJobModelArtifacts modelArtifacts) {
  ...
  public TrialComponentSourceDetailTrainingJob trainingJobStatus(TrainingJobStatus trainingJobStatus) {
  ...
  public TrialComponentSourceDetailTrainingJob secondaryStatus(SecondaryStatus secondaryStatus) {
  ...
  public TrialComponentSourceDetailTrainingJob failureReason(String failureReason) {
  ...
  public TrialComponentSourceDetailTrainingJob hyperParameters(Map hyperParameters) {
  ...
  public TrialComponentSourceDetailTrainingJob algorithmSpecification(TrainingJobAlgorithmSpecification algorithmSpecification) {
  ...
  public TrialComponentSourceDetailTrainingJob roleArn(String roleArn) {
  ...
  public TrialComponentSourceDetailTrainingJob inputDataConfig(List inputDataConfig) {
  ...
  public TrialComponentSourceDetailTrainingJob outputDataConfig(TrainingJobOutputDataConfig outputDataConfig) {
  ...
  public TrialComponentSourceDetailTrainingJob resourceConfig(TrainingJobResourceConfig resourceConfig) {
  ...
  public TrialComponentSourceDetailTrainingJob vpcConfig(DescribeTrainingJobResponseVpcConfig vpcConfig) {
  ...
  public TrialComponentSourceDetailTrainingJob stoppingCondition(CreateTrainingJobRequestStoppingCondition stoppingCondition) {
  ...
  public TrialComponentSourceDetailTrainingJob creationTime(OffsetDateTime creationTime) {
  ...
  public TrialComponentSourceDetailTrainingJob trainingStartTime(OffsetDateTime trainingStartTime) {
  ...
  public TrialComponentSourceDetailTrainingJob trainingEndTime(OffsetDateTime trainingEndTime) {
  ...
  public TrialComponentSourceDetailTrainingJob lastModifiedTime(OffsetDateTime lastModifiedTime) {
  ...
  public TrialComponentSourceDetailTrainingJob secondaryStatusTransitions(List secondaryStatusTransitions) {
  ...
  public TrialComponentSourceDetailTrainingJob finalMetricDataList(List finalMetricDataList) {
  ...
  public TrialComponentSourceDetailTrainingJob enableNetworkIsolation(Boolean enableNetworkIsolation) {
  ...
  public TrialComponentSourceDetailTrainingJob enableInterContainerTrafficEncryption(Boolean enableInterContainerTrafficEncryption) {
  ...
  public TrialComponentSourceDetailTrainingJob enableManagedSpotTraining(Boolean enableManagedSpotTraining) {
  ...
  public TrialComponentSourceDetailTrainingJob checkpointConfig(CheckpointConfig checkpointConfig) {
  ...
  public TrialComponentSourceDetailTrainingJob trainingTimeInSeconds(Integer trainingTimeInSeconds) {
  ...
  public TrialComponentSourceDetailTrainingJob billableTimeInSeconds(Integer billableTimeInSeconds) {
  ...
  public TrialComponentSourceDetailTrainingJob debugHookConfig(DebugHookConfig debugHookConfig) {
  ...
  public TrialComponentSourceDetailTrainingJob experimentConfig(ExperimentConfig experimentConfig) {
  ...
  public TrialComponentSourceDetailTrainingJob debugRuleConfigurations(List debugRuleConfigurations) {
  ...
  public TrialComponentSourceDetailTrainingJob tensorBoardOutputConfig(TensorBoardOutputConfig tensorBoardOutputConfig) {
  ...
  public TrialComponentSourceDetailTrainingJob debugRuleEvaluationStatuses(List debugRuleEvaluationStatuses) {
  ...
  public TrialComponentSourceDetailTrainingJob profilerConfig(ProfilerConfig profilerConfig) {
  ...
  public TrialComponentSourceDetailTrainingJob environment(Map environment) {
  ...
  public TrialComponentSourceDetailTrainingJob retryStrategy(CreateTrainingJobRequestRetryStrategy retryStrategy) {
  ...
  public TrialComponentSourceDetailTrainingJob tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrialComponentSourceDetailTrainingJob trialComponentSourceDetailTrainingJob = (TrialComponentSourceDetailTrainingJob) o;
    return Objects.equals(this.trainingJobName, trialComponentSourceDetailTrainingJob.trainingJobName) &&
        Objects.equals(this.trainingJobArn, trialComponentSourceDetailTrainingJob.trainingJobArn) &&
        Objects.equals(this.tuningJobArn, trialComponentSourceDetailTrainingJob.tuningJobArn) &&
        Objects.equals(this.labelingJobArn, trialComponentSourceDetailTrainingJob.labelingJobArn) &&
        Objects.equals(this.autoMLJobArn, trialComponentSourceDetailTrainingJob.autoMLJobArn) &&
        Objects.equals(this.modelArtifacts, trialComponentSourceDetailTrainingJob.modelArtifacts) &&
        Objects.equals(this.trainingJobStatus, trialComponentSourceDetailTrainingJob.trainingJobStatus) &&
        Objects.equals(this.secondaryStatus, trialComponentSourceDetailTrainingJob.secondaryStatus) &&
        Objects.equals(this.failureReason, trialComponentSourceDetailTrainingJob.failureReason) &&
        Objects.equals(this.hyperParameters, trialComponentSourceDetailTrainingJob.hyperParameters) &&
        Objects.equals(this.algorithmSpecification, trialComponentSourceDetailTrainingJob.algorithmSpecification) &&
        Objects.equals(this.roleArn, trialComponentSourceDetailTrainingJob.roleArn) &&
        Objects.equals(this.inputDataConfig, trialComponentSourceDetailTrainingJob.inputDataConfig) &&
        Objects.equals(this.outputDataConfig, trialComponentSourceDetailTrainingJob.outputDataConfig) &&
        Objects.equals(this.resourceConfig, trialComponentSourceDetailTrainingJob.resourceConfig) &&
        Objects.equals(this.vpcConfig, trialComponentSourceDetailTrainingJob.vpcConfig) &&
        Objects.equals(this.stoppingCondition, trialComponentSourceDetailTrainingJob.stoppingCondition) &&
        Objects.equals(this.creationTime, trialComponentSourceDetailTrainingJob.creationTime) &&
        Objects.equals(this.trainingStartTime, trialComponentSourceDetailTrainingJob.trainingStartTime) &&
        Objects.equals(this.trainingEndTime, trialComponentSourceDetailTrainingJob.trainingEndTime) &&
        Objects.equals(this.lastModifiedTime, trialComponentSourceDetailTrainingJob.lastModifiedTime) &&
        Objects.equals(this.secondaryStatusTransitions, trialComponentSourceDetailTrainingJob.secondaryStatusTransitions) &&
        Objects.equals(this.finalMetricDataList, trialComponentSourceDetailTrainingJob.finalMetricDataList) &&
        Objects.equals(this.enableNetworkIsolation, trialComponentSourceDetailTrainingJob.enableNetworkIsolation) &&
        Objects.equals(this.enableInterContainerTrafficEncryption, trialComponentSourceDetailTrainingJob.enableInterContainerTrafficEncryption) &&
        Objects.equals(this.enableManagedSpotTraining, trialComponentSourceDetailTrainingJob.enableManagedSpotTraining) &&
        Objects.equals(this.checkpointConfig, trialComponentSourceDetailTrainingJob.checkpointConfig) &&
        Objects.equals(this.trainingTimeInSeconds, trialComponentSourceDetailTrainingJob.trainingTimeInSeconds) &&
        Objects.equals(this.billableTimeInSeconds, trialComponentSourceDetailTrainingJob.billableTimeInSeconds) &&
        Objects.equals(this.debugHookConfig, trialComponentSourceDetailTrainingJob.debugHookConfig) &&
        Objects.equals(this.experimentConfig, trialComponentSourceDetailTrainingJob.experimentConfig) &&
        Objects.equals(this.debugRuleConfigurations, trialComponentSourceDetailTrainingJob.debugRuleConfigurations) &&
        Objects.equals(this.tensorBoardOutputConfig, trialComponentSourceDetailTrainingJob.tensorBoardOutputConfig) &&
        Objects.equals(this.debugRuleEvaluationStatuses, trialComponentSourceDetailTrainingJob.debugRuleEvaluationStatuses) &&
        Objects.equals(this.profilerConfig, trialComponentSourceDetailTrainingJob.profilerConfig) &&
        Objects.equals(this.environment, trialComponentSourceDetailTrainingJob.environment) &&
        Objects.equals(this.retryStrategy, trialComponentSourceDetailTrainingJob.retryStrategy) &&
        Objects.equals(this.tags, trialComponentSourceDetailTrainingJob.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrialComponentSourceDetailTrainingJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrialComponentSourceDetailTrainingJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrialComponentSourceDetailTrainingJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrialComponentSourceDetailTrainingJob is not found in the empty JSON string", TrialComponentSourceDetailTrainingJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrialComponentSourceDetailTrainingJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrialComponentSourceDetailTrainingJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrialComponentSourceDetailTrainingJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrialComponentSourceDetailTrainingJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrialComponentSourceDetailTrainingJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrialComponentSourceDetailTrainingJob.class));

       return (TypeAdapter<T>) new TypeAdapter<TrialComponentSourceDetailTrainingJob>() {
           @Override
           public void write(JsonWriter out, TrialComponentSourceDetailTrainingJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrialComponentSourceDetailTrainingJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrialComponentSourceDetailTrainingJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrialComponentSourceDetailTrainingJob
   * @throws IOException if the JSON string is invalid with respect to TrialComponentSourceDetailTrainingJob
   */
  public static TrialComponentSourceDetailTrainingJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrialComponentSourceDetailTrainingJob.class);
  }

  /**
   * Convert an instance of TrialComponentSourceDetailTrainingJob to an JSON string
   *
   * @return JSON string
   */
