...
public class MonitoringScheduleConfigMonitoringJobDefinition {
  ...
  public MonitoringScheduleConfigMonitoringJobDefinition() {
  }

  public MonitoringScheduleConfigMonitoringJobDefinition baselineConfig(MonitoringJobDefinitionBaselineConfig baselineConfig) {
  ...
  public MonitoringScheduleConfigMonitoringJobDefinition monitoringInputs(List monitoringInputs) {
  ...
  public MonitoringScheduleConfigMonitoringJobDefinition monitoringOutputConfig(MonitoringJobDefinitionMonitoringOutputConfig monitoringOutputConfig) {
  ...
  public MonitoringScheduleConfigMonitoringJobDefinition monitoringResources(MonitoringJobDefinitionMonitoringResources monitoringResources) {
  ...
  public MonitoringScheduleConfigMonitoringJobDefinition monitoringAppSpecification(MonitoringJobDefinitionMonitoringAppSpecification monitoringAppSpecification) {
  ...
  public MonitoringScheduleConfigMonitoringJobDefinition stoppingCondition(MonitoringJobDefinitionStoppingCondition stoppingCondition) {
  ...
  public MonitoringScheduleConfigMonitoringJobDefinition environment(Map environment) {
  ...
  public MonitoringScheduleConfigMonitoringJobDefinition networkConfig(MonitoringJobDefinitionNetworkConfig networkConfig) {
  ...
  public MonitoringScheduleConfigMonitoringJobDefinition roleArn(String roleArn) {
  ...
  public boolean equals(Object o) {
    ...
    MonitoringScheduleConfigMonitoringJobDefinition monitoringScheduleConfigMonitoringJobDefinition = (MonitoringScheduleConfigMonitoringJobDefinition) o;
    return Objects.equals(this.baselineConfig, monitoringScheduleConfigMonitoringJobDefinition.baselineConfig) &&
        Objects.equals(this.monitoringInputs, monitoringScheduleConfigMonitoringJobDefinition.monitoringInputs) &&
        Objects.equals(this.monitoringOutputConfig, monitoringScheduleConfigMonitoringJobDefinition.monitoringOutputConfig) &&
        Objects.equals(this.monitoringResources, monitoringScheduleConfigMonitoringJobDefinition.monitoringResources) &&
        Objects.equals(this.monitoringAppSpecification, monitoringScheduleConfigMonitoringJobDefinition.monitoringAppSpecification) &&
        Objects.equals(this.stoppingCondition, monitoringScheduleConfigMonitoringJobDefinition.stoppingCondition) &&
        Objects.equals(this.environment, monitoringScheduleConfigMonitoringJobDefinition.environment) &&
        Objects.equals(this.networkConfig, monitoringScheduleConfigMonitoringJobDefinition.networkConfig) &&
        Objects.equals(this.roleArn, monitoringScheduleConfigMonitoringJobDefinition.roleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitoringScheduleConfigMonitoringJobDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitoringScheduleConfigMonitoringJobDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitoringScheduleConfigMonitoringJobDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitoringScheduleConfigMonitoringJobDefinition is not found in the empty JSON string", MonitoringScheduleConfigMonitoringJobDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitoringScheduleConfigMonitoringJobDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitoringScheduleConfigMonitoringJobDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitoringScheduleConfigMonitoringJobDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitoringScheduleConfigMonitoringJobDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitoringScheduleConfigMonitoringJobDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitoringScheduleConfigMonitoringJobDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitoringScheduleConfigMonitoringJobDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitoringScheduleConfigMonitoringJobDefinition>() {
           @Override
           public void write(JsonWriter out, MonitoringScheduleConfigMonitoringJobDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitoringScheduleConfigMonitoringJobDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitoringScheduleConfigMonitoringJobDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitoringScheduleConfigMonitoringJobDefinition
   * @throws IOException if the JSON string is invalid with respect to MonitoringScheduleConfigMonitoringJobDefinition
   */
  public static MonitoringScheduleConfigMonitoringJobDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitoringScheduleConfigMonitoringJobDefinition.class);
  }

  /**
   * Convert an instance of MonitoringScheduleConfigMonitoringJobDefinition to an JSON string
   *
   * @return JSON string
   */
