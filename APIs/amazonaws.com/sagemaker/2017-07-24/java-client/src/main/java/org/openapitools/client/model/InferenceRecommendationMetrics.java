...
public class InferenceRecommendationMetrics {
  ...
  public InferenceRecommendationMetrics() {
  }

  public InferenceRecommendationMetrics costPerHour(Float costPerHour) {
  ...
  public InferenceRecommendationMetrics costPerInference(Float costPerInference) {
  ...
  public InferenceRecommendationMetrics maxInvocations(Integer maxInvocations) {
  ...
  public InferenceRecommendationMetrics modelLatency(Integer modelLatency) {
  ...
  public InferenceRecommendationMetrics cpuUtilization(Float cpuUtilization) {
  ...
  public InferenceRecommendationMetrics memoryUtilization(Float memoryUtilization) {
  ...
  public InferenceRecommendationMetrics modelSetupTime(Integer modelSetupTime) {
  ...
  public boolean equals(Object o) {
    ...
    InferenceRecommendationMetrics inferenceRecommendationMetrics = (InferenceRecommendationMetrics) o;
    return Objects.equals(this.costPerHour, inferenceRecommendationMetrics.costPerHour) &&
        Objects.equals(this.costPerInference, inferenceRecommendationMetrics.costPerInference) &&
        Objects.equals(this.maxInvocations, inferenceRecommendationMetrics.maxInvocations) &&
        Objects.equals(this.modelLatency, inferenceRecommendationMetrics.modelLatency) &&
        Objects.equals(this.cpuUtilization, inferenceRecommendationMetrics.cpuUtilization) &&
        Objects.equals(this.memoryUtilization, inferenceRecommendationMetrics.memoryUtilization) &&
        Objects.equals(this.modelSetupTime, inferenceRecommendationMetrics.modelSetupTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class InferenceRecommendationMetrics {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InferenceRecommendationMetrics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InferenceRecommendationMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InferenceRecommendationMetrics is not found in the empty JSON string", InferenceRecommendationMetrics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InferenceRecommendationMetrics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InferenceRecommendationMetrics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InferenceRecommendationMetrics.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InferenceRecommendationMetrics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InferenceRecommendationMetrics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InferenceRecommendationMetrics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InferenceRecommendationMetrics.class));

       return (TypeAdapter<T>) new TypeAdapter<InferenceRecommendationMetrics>() {
           @Override
           public void write(JsonWriter out, InferenceRecommendationMetrics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InferenceRecommendationMetrics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InferenceRecommendationMetrics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InferenceRecommendationMetrics
   * @throws IOException if the JSON string is invalid with respect to InferenceRecommendationMetrics
   */
  public static InferenceRecommendationMetrics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InferenceRecommendationMetrics.class);
  }

  /**
   * Convert an instance of InferenceRecommendationMetrics to an JSON string
   *
   * @return JSON string
   */
