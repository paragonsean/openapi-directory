...
public class TrainingJobDefinition {
  ...
  public TrainingJobDefinition() {
  }

  public TrainingJobDefinition trainingInputMode(TrainingInputMode trainingInputMode) {
  ...
  public TrainingJobDefinition hyperParameters(Map hyperParameters) {
  ...
  public TrainingJobDefinition inputDataConfig(List inputDataConfig) {
  ...
  public TrainingJobDefinition outputDataConfig(TrainingJobDefinitionOutputDataConfig outputDataConfig) {
  ...
  public TrainingJobDefinition resourceConfig(TrainingJobDefinitionResourceConfig resourceConfig) {
  ...
  public TrainingJobDefinition stoppingCondition(TrainingJobDefinitionStoppingCondition stoppingCondition) {
  ...
  public boolean equals(Object o) {
    ...
    TrainingJobDefinition trainingJobDefinition = (TrainingJobDefinition) o;
    return Objects.equals(this.trainingInputMode, trainingJobDefinition.trainingInputMode) &&
        Objects.equals(this.hyperParameters, trainingJobDefinition.hyperParameters) &&
        Objects.equals(this.inputDataConfig, trainingJobDefinition.inputDataConfig) &&
        Objects.equals(this.outputDataConfig, trainingJobDefinition.outputDataConfig) &&
        Objects.equals(this.resourceConfig, trainingJobDefinition.resourceConfig) &&
        Objects.equals(this.stoppingCondition, trainingJobDefinition.stoppingCondition);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrainingJobDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrainingJobDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrainingJobDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrainingJobDefinition is not found in the empty JSON string", TrainingJobDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrainingJobDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrainingJobDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrainingJobDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrainingJobDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrainingJobDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrainingJobDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrainingJobDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<TrainingJobDefinition>() {
           @Override
           public void write(JsonWriter out, TrainingJobDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrainingJobDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrainingJobDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrainingJobDefinition
   * @throws IOException if the JSON string is invalid with respect to TrainingJobDefinition
   */
  public static TrainingJobDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrainingJobDefinition.class);
  }

  /**
   * Convert an instance of TrainingJobDefinition to an JSON string
   *
   * @return JSON string
   */
