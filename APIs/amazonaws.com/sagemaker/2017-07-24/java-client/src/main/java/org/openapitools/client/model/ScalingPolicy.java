...
import org.openapitools.client.model.ScalingPolicyTargetTracking;
...
public class ScalingPolicy {
  public static final String SERIALIZED_NAME_TARGET_TRACKING = "TargetTracking";
  @SerializedName(SERIALIZED_NAME_TARGET_TRACKING)
  private ScalingPolicyTargetTracking targetTracking;

  public ScalingPolicy() {
  }

  public ScalingPolicy targetTracking(ScalingPolicyTargetTracking targetTracking) {
  ...
  public ScalingPolicyTargetTracking getTargetTracking() {
    return targetTracking;
  }

  public void setTargetTracking(ScalingPolicyTargetTracking targetTracking) {
    this.targetTracking = targetTracking;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.targetTracking, scalingPolicy.targetTracking);
  }

  @Override
  public int hashCode() {
    return Objects.hash(targetTracking);
  }
  ...
  public String toString() {
    ...
    sb.append("    targetTracking: ").append(toIndentedString(targetTracking)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("TargetTracking");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("TargetTracking") != null && !jsonObj.get("TargetTracking").isJsonNull()) {
        ScalingPolicyTargetTracking.validateJsonElement(jsonObj.get("TargetTracking"));
      }
  }
