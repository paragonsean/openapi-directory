...
public class UpdateWorkteamResponseWorkteam {
  ...
  public UpdateWorkteamResponseWorkteam() {
  }

  public UpdateWorkteamResponseWorkteam workteamName(String workteamName) {
  ...
  public UpdateWorkteamResponseWorkteam memberDefinitions(List memberDefinitions) {
  ...
  public UpdateWorkteamResponseWorkteam workteamArn(String workteamArn) {
  ...
  public UpdateWorkteamResponseWorkteam workforceArn(String workforceArn) {
  ...
  public UpdateWorkteamResponseWorkteam productListingIds(List productListingIds) {
  ...
  public UpdateWorkteamResponseWorkteam description(String description) {
  ...
  public UpdateWorkteamResponseWorkteam subDomain(String subDomain) {
  ...
  public UpdateWorkteamResponseWorkteam createDate(OffsetDateTime createDate) {
  ...
  public UpdateWorkteamResponseWorkteam lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public UpdateWorkteamResponseWorkteam notificationConfiguration(WorkteamNotificationConfiguration notificationConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateWorkteamResponseWorkteam updateWorkteamResponseWorkteam = (UpdateWorkteamResponseWorkteam) o;
    return Objects.equals(this.workteamName, updateWorkteamResponseWorkteam.workteamName) &&
        Objects.equals(this.memberDefinitions, updateWorkteamResponseWorkteam.memberDefinitions) &&
        Objects.equals(this.workteamArn, updateWorkteamResponseWorkteam.workteamArn) &&
        Objects.equals(this.workforceArn, updateWorkteamResponseWorkteam.workforceArn) &&
        Objects.equals(this.productListingIds, updateWorkteamResponseWorkteam.productListingIds) &&
        Objects.equals(this.description, updateWorkteamResponseWorkteam.description) &&
        Objects.equals(this.subDomain, updateWorkteamResponseWorkteam.subDomain) &&
        Objects.equals(this.createDate, updateWorkteamResponseWorkteam.createDate) &&
        Objects.equals(this.lastUpdatedDate, updateWorkteamResponseWorkteam.lastUpdatedDate) &&
        Objects.equals(this.notificationConfiguration, updateWorkteamResponseWorkteam.notificationConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateWorkteamResponseWorkteam {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateWorkteamResponseWorkteam
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateWorkteamResponseWorkteam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateWorkteamResponseWorkteam is not found in the empty JSON string", UpdateWorkteamResponseWorkteam.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateWorkteamResponseWorkteam.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateWorkteamResponseWorkteam` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateWorkteamResponseWorkteam.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateWorkteamResponseWorkteam.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateWorkteamResponseWorkteam' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateWorkteamResponseWorkteam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateWorkteamResponseWorkteam.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateWorkteamResponseWorkteam>() {
           @Override
           public void write(JsonWriter out, UpdateWorkteamResponseWorkteam value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateWorkteamResponseWorkteam read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateWorkteamResponseWorkteam given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateWorkteamResponseWorkteam
   * @throws IOException if the JSON string is invalid with respect to UpdateWorkteamResponseWorkteam
   */
  public static UpdateWorkteamResponseWorkteam fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateWorkteamResponseWorkteam.class);
  }

  /**
   * Convert an instance of UpdateWorkteamResponseWorkteam to an JSON string
   *
   * @return JSON string
   */
