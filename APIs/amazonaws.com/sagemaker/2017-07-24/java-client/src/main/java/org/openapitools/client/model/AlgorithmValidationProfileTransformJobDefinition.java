...
public class AlgorithmValidationProfileTransformJobDefinition {
  ...
  public AlgorithmValidationProfileTransformJobDefinition() {
  }

  public AlgorithmValidationProfileTransformJobDefinition maxConcurrentTransforms(Integer maxConcurrentTransforms) {
  ...
  public AlgorithmValidationProfileTransformJobDefinition maxPayloadInMB(Integer maxPayloadInMB) {
  ...
  public AlgorithmValidationProfileTransformJobDefinition batchStrategy(BatchStrategy batchStrategy) {
  ...
  public AlgorithmValidationProfileTransformJobDefinition environment(Map environment) {
  ...
  public AlgorithmValidationProfileTransformJobDefinition transformInput(TransformJobDefinitionTransformInput transformInput) {
  ...
  public AlgorithmValidationProfileTransformJobDefinition transformOutput(DescribeTransformJobResponseTransformOutput transformOutput) {
  ...
  public AlgorithmValidationProfileTransformJobDefinition transformResources(TransformJobDefinitionTransformResources transformResources) {
  ...
  public boolean equals(Object o) {
    ...
    AlgorithmValidationProfileTransformJobDefinition algorithmValidationProfileTransformJobDefinition = (AlgorithmValidationProfileTransformJobDefinition) o;
    return Objects.equals(this.maxConcurrentTransforms, algorithmValidationProfileTransformJobDefinition.maxConcurrentTransforms) &&
        Objects.equals(this.maxPayloadInMB, algorithmValidationProfileTransformJobDefinition.maxPayloadInMB) &&
        Objects.equals(this.batchStrategy, algorithmValidationProfileTransformJobDefinition.batchStrategy) &&
        Objects.equals(this.environment, algorithmValidationProfileTransformJobDefinition.environment) &&
        Objects.equals(this.transformInput, algorithmValidationProfileTransformJobDefinition.transformInput) &&
        Objects.equals(this.transformOutput, algorithmValidationProfileTransformJobDefinition.transformOutput) &&
        Objects.equals(this.transformResources, algorithmValidationProfileTransformJobDefinition.transformResources);
  }
  ...
  public String toString() {
    ...
    sb.append("class AlgorithmValidationProfileTransformJobDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AlgorithmValidationProfileTransformJobDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlgorithmValidationProfileTransformJobDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlgorithmValidationProfileTransformJobDefinition is not found in the empty JSON string", AlgorithmValidationProfileTransformJobDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlgorithmValidationProfileTransformJobDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AlgorithmValidationProfileTransformJobDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AlgorithmValidationProfileTransformJobDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlgorithmValidationProfileTransformJobDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlgorithmValidationProfileTransformJobDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlgorithmValidationProfileTransformJobDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlgorithmValidationProfileTransformJobDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<AlgorithmValidationProfileTransformJobDefinition>() {
           @Override
           public void write(JsonWriter out, AlgorithmValidationProfileTransformJobDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AlgorithmValidationProfileTransformJobDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AlgorithmValidationProfileTransformJobDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AlgorithmValidationProfileTransformJobDefinition
   * @throws IOException if the JSON string is invalid with respect to AlgorithmValidationProfileTransformJobDefinition
   */
  public static AlgorithmValidationProfileTransformJobDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlgorithmValidationProfileTransformJobDefinition.class);
  }

  /**
   * Convert an instance of AlgorithmValidationProfileTransformJobDefinition to an JSON string
   *
   * @return JSON string
   */
