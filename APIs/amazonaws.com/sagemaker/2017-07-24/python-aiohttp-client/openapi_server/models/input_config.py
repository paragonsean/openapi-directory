...
class InputConfig(Model):
    ...
    def __init__(self, s3_uri: str=None, data_input_config: str=None, framework: Framework=None, framework_version: str=None):
        ...
        :param s3_uri: The s3_uri of this InputConfig.
        :param data_input_config: The data_input_config of this InputConfig.
        :param framework: The framework of this InputConfig.
        :param framework_version: The framework_version of this InputConfig.
        """
        self.openapi_types = {
            's3_uri': str,
    ...
    @property
    def s3_uri(self):
        """Gets the s3_uri of this InputConfig.


        :return: The s3_uri of this InputConfig.
        :rtype: str
        """
        return self._s3_uri
    ...
    def s3_uri(self, s3_uri):
        """Sets the s3_uri of this InputConfig.
    ...
    def data_input_config(self):
        """Gets the data_input_config of this InputConfig.


        :return: The data_input_config of this InputConfig.
        :rtype: str
        """
    ...
    def data_input_config(self, data_input_config):
        """Sets the data_input_config of this InputConfig.
    ...
    @property
    def framework(self):
        """Gets the framework of this InputConfig.


        :return: The framework of this InputConfig.
        :rtype: Framework
        """
    ...
    def framework(self, framework):
        """Sets the framework of this InputConfig.
    ...
    def framework_version(self):
        """Gets the framework_version of this InputConfig.


        :return: The framework_version of this InputConfig.
        :rtype: str
        """
    ...
    def framework_version(self, framework_version):
        """Sets the framework_version of this InputConfig.
