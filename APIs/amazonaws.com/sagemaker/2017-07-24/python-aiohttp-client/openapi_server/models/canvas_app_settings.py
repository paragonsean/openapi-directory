...
class CanvasAppSettings(Model):
    ...
    def __init__(self, time_series_forecasting_settings: CanvasAppSettingsTimeSeriesForecastingSettings=None, model_register_settings: CanvasAppSettingsModelRegisterSettings=None, workspace_settings: CanvasAppSettingsWorkspaceSettings=None):
        """CanvasAppSettings - a model defined in OpenAPI

        :param time_series_forecasting_settings: The time_series_forecasting_settings of this CanvasAppSettings.
        :param model_register_settings: The model_register_settings of this CanvasAppSettings.
        :param workspace_settings: The workspace_settings of this CanvasAppSettings.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CanvasAppSettings':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CanvasAppSettings of this CanvasAppSettings.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def time_series_forecasting_settings(self):
        """Gets the time_series_forecasting_settings of this CanvasAppSettings.


        :return: The time_series_forecasting_settings of this CanvasAppSettings.
    ...
    def time_series_forecasting_settings(self, time_series_forecasting_settings):
        """Sets the time_series_forecasting_settings of this CanvasAppSettings.
    ...
    def model_register_settings(self):
        """Gets the model_register_settings of this CanvasAppSettings.


        :return: The model_register_settings of this CanvasAppSettings.
    ...
    def model_register_settings(self, model_register_settings):
        """Sets the model_register_settings of this CanvasAppSettings.
    ...
    def workspace_settings(self):
        """Gets the workspace_settings of this CanvasAppSettings.


        :return: The workspace_settings of this CanvasAppSettings.
    ...
    def workspace_settings(self, workspace_settings):
        """Sets the workspace_settings of this CanvasAppSettings.
