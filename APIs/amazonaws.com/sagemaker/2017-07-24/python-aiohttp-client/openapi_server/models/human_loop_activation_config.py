...
class HumanLoopActivationConfig(Model):
    ...
    def __init__(self, human_loop_activation_conditions_config: HumanLoopActivationConfigHumanLoopActivationConditionsConfig=None):
        """HumanLoopActivationConfig - a model defined in OpenAPI

        :param human_loop_activation_conditions_config: The human_loop_activation_conditions_config of this HumanLoopActivationConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'HumanLoopActivationConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The HumanLoopActivationConfig of this HumanLoopActivationConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def human_loop_activation_conditions_config(self):
        """Gets the human_loop_activation_conditions_config of this HumanLoopActivationConfig.


        :return: The human_loop_activation_conditions_config of this HumanLoopActivationConfig.
    ...
    def human_loop_activation_conditions_config(self, human_loop_activation_conditions_config):
        """Sets the human_loop_activation_conditions_config of this HumanLoopActivationConfig.
