...
class ModelPackageInferenceSpecification(Model):
    ...
    def __init__(self, containers: List=None, supported_transform_instance_types: List=None, supported_realtime_inference_instance_types: List=None, supported_content_types: List=None, supported_response_mime_types: List=None):
        """ModelPackageInferenceSpecification - a model defined in OpenAPI

        :param containers: The containers of this ModelPackageInferenceSpecification.
        :param supported_transform_instance_types: The supported_transform_instance_types of this ModelPackageInferenceSpecification.
        :param supported_realtime_inference_instance_types: The supported_realtime_inference_instance_types of this ModelPackageInferenceSpecification.
        :param supported_content_types: The supported_content_types of this ModelPackageInferenceSpecification.
        :param supported_response_mime_types: The supported_response_mime_types of this ModelPackageInferenceSpecification.
        """
        self.openapi_types = {
            'containers': List,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ModelPackageInferenceSpecification':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ModelPackage_InferenceSpecification of this ModelPackageInferenceSpecification.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def containers(self):
        """Gets the containers of this ModelPackageInferenceSpecification.


        :return: The containers of this ModelPackageInferenceSpecification.
        :rtype: List
        """
    ...
    def containers(self, containers):
        """Sets the containers of this ModelPackageInferenceSpecification.
    ...
    def supported_transform_instance_types(self):
        """Gets the supported_transform_instance_types of this ModelPackageInferenceSpecification.


        :return: The supported_transform_instance_types of this ModelPackageInferenceSpecification.
        :rtype: List
        """
    ...
    def supported_transform_instance_types(self, supported_transform_instance_types):
        """Sets the supported_transform_instance_types of this ModelPackageInferenceSpecification.
    ...
    def supported_realtime_inference_instance_types(self):
        """Gets the supported_realtime_inference_instance_types of this ModelPackageInferenceSpecification.


        :return: The supported_realtime_inference_instance_types of this ModelPackageInferenceSpecification.
        :rtype: List
        """
    ...
    def supported_realtime_inference_instance_types(self, supported_realtime_inference_instance_types):
        """Sets the supported_realtime_inference_instance_types of this ModelPackageInferenceSpecification.
    ...
    def supported_content_types(self):
        """Gets the supported_content_types of this ModelPackageInferenceSpecification.


        :return: The supported_content_types of this ModelPackageInferenceSpecification.
        :rtype: List
        """
    ...
    def supported_content_types(self, supported_content_types):
        """Sets the supported_content_types of this ModelPackageInferenceSpecification.
    ...
    def supported_response_mime_types(self):
        """Gets the supported_response_mime_types of this ModelPackageInferenceSpecification.


        :return: The supported_response_mime_types of this ModelPackageInferenceSpecification.
        :rtype: List
        """
    ...
    def supported_response_mime_types(self, supported_response_mime_types):
        """Sets the supported_response_mime_types of this ModelPackageInferenceSpecification.
