...
class HyperParameterTuningJobWarmStartConfig(Model):
    ...
    def __init__(self, parent_hyper_parameter_tuning_jobs: List=None, warm_start_type: HyperParameterTuningJobWarmStartType=None):
        """HyperParameterTuningJobWarmStartConfig - a model defined in OpenAPI

        :param parent_hyper_parameter_tuning_jobs: The parent_hyper_parameter_tuning_jobs of this HyperParameterTuningJobWarmStartConfig.
        :param warm_start_type: The warm_start_type of this HyperParameterTuningJobWarmStartConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'HyperParameterTuningJobWarmStartConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The HyperParameterTuningJobWarmStartConfig of this HyperParameterTuningJobWarmStartConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def parent_hyper_parameter_tuning_jobs(self):
        """Gets the parent_hyper_parameter_tuning_jobs of this HyperParameterTuningJobWarmStartConfig.


        :return: The parent_hyper_parameter_tuning_jobs of this HyperParameterTuningJobWarmStartConfig.
        :rtype: List
        """
    ...
    def parent_hyper_parameter_tuning_jobs(self, parent_hyper_parameter_tuning_jobs):
        """Sets the parent_hyper_parameter_tuning_jobs of this HyperParameterTuningJobWarmStartConfig.
    ...
    def warm_start_type(self):
        """Gets the warm_start_type of this HyperParameterTuningJobWarmStartConfig.


        :return: The warm_start_type of this HyperParameterTuningJobWarmStartConfig.
    ...
    def warm_start_type(self, warm_start_type):
        """Sets the warm_start_type of this HyperParameterTuningJobWarmStartConfig.
