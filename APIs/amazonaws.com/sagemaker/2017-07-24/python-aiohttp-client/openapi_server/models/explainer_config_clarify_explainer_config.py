...
class ExplainerConfigClarifyExplainerConfig(Model):
    ...
    def __init__(self, enable_explanations: str=None, inference_config: ClarifyExplainerConfigInferenceConfig=None, shap_config: ClarifyExplainerConfigShapConfig=None):
        """ExplainerConfigClarifyExplainerConfig - a model defined in OpenAPI

        :param enable_explanations: The enable_explanations of this ExplainerConfigClarifyExplainerConfig.
        :param inference_config: The inference_config of this ExplainerConfigClarifyExplainerConfig.
        :param shap_config: The shap_config of this ExplainerConfigClarifyExplainerConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ExplainerConfigClarifyExplainerConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ExplainerConfig_ClarifyExplainerConfig of this ExplainerConfigClarifyExplainerConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def enable_explanations(self):
        """Gets the enable_explanations of this ExplainerConfigClarifyExplainerConfig.


        :return: The enable_explanations of this ExplainerConfigClarifyExplainerConfig.
        :rtype: str
        """
    ...
    def enable_explanations(self, enable_explanations):
        """Sets the enable_explanations of this ExplainerConfigClarifyExplainerConfig.
    ...
    def inference_config(self):
        """Gets the inference_config of this ExplainerConfigClarifyExplainerConfig.


        :return: The inference_config of this ExplainerConfigClarifyExplainerConfig.
    ...
    def inference_config(self, inference_config):
        """Sets the inference_config of this ExplainerConfigClarifyExplainerConfig.
    ...
    def shap_config(self):
        """Gets the shap_config of this ExplainerConfigClarifyExplainerConfig.


        :return: The shap_config of this ExplainerConfigClarifyExplainerConfig.
    ...
    def shap_config(self, shap_config):
        """Sets the shap_config of this ExplainerConfigClarifyExplainerConfig.
