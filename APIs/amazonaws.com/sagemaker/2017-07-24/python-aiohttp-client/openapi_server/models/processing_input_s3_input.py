...
class ProcessingInputS3Input(Model):
    ...
    def __init__(self, s3_uri: str=None, local_path: str=None, s3_data_type: ProcessingS3DataType=None, s3_input_mode: ProcessingS3InputMode=None, s3_data_distribution_type: ProcessingS3DataDistributionType=None, s3_compression_type: ProcessingS3CompressionType=None):
        """ProcessingInputS3Input - a model defined in OpenAPI

        :param s3_uri: The s3_uri of this ProcessingInputS3Input.
        :param local_path: The local_path of this ProcessingInputS3Input.
        :param s3_data_type: The s3_data_type of this ProcessingInputS3Input.
        :param s3_input_mode: The s3_input_mode of this ProcessingInputS3Input.
        :param s3_data_distribution_type: The s3_data_distribution_type of this ProcessingInputS3Input.
        :param s3_compression_type: The s3_compression_type of this ProcessingInputS3Input.
        """
        self.openapi_types = {
            's3_uri': str,
            'local_path': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ProcessingInputS3Input':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ProcessingInput_S3Input of this ProcessingInputS3Input.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def s3_uri(self):
        """Gets the s3_uri of this ProcessingInputS3Input.


        :return: The s3_uri of this ProcessingInputS3Input.
        :rtype: str
        """
        return self._s3_uri
    ...
    def s3_uri(self, s3_uri):
        """Sets the s3_uri of this ProcessingInputS3Input.
    ...
    @property
    def local_path(self):
        """Gets the local_path of this ProcessingInputS3Input.


        :return: The local_path of this ProcessingInputS3Input.
        :rtype: str
        """
    ...
    def local_path(self, local_path):
        """Sets the local_path of this ProcessingInputS3Input.
    ...
    def s3_data_type(self):
        """Gets the s3_data_type of this ProcessingInputS3Input.


        :return: The s3_data_type of this ProcessingInputS3Input.
    ...
    def s3_data_type(self, s3_data_type):
        """Sets the s3_data_type of this ProcessingInputS3Input.
    ...
    def s3_input_mode(self):
        """Gets the s3_input_mode of this ProcessingInputS3Input.


        :return: The s3_input_mode of this ProcessingInputS3Input.
    ...
    def s3_input_mode(self, s3_input_mode):
        """Sets the s3_input_mode of this ProcessingInputS3Input.
    ...
    def s3_data_distribution_type(self):
        """Gets the s3_data_distribution_type of this ProcessingInputS3Input.


        :return: The s3_data_distribution_type of this ProcessingInputS3Input.
    ...
    def s3_data_distribution_type(self, s3_data_distribution_type):
        """Sets the s3_data_distribution_type of this ProcessingInputS3Input.
    ...
    def s3_compression_type(self):
        """Gets the s3_compression_type of this ProcessingInputS3Input.


        :return: The s3_compression_type of this ProcessingInputS3Input.
    ...
    def s3_compression_type(self, s3_compression_type):
        """Sets the s3_compression_type of this ProcessingInputS3Input.
