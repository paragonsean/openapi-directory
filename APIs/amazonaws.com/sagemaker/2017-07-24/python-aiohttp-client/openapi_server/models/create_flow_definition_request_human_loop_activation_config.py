...
class CreateFlowDefinitionRequestHumanLoopActivationConfig(Model):
    ...
    def __init__(self, human_loop_activation_conditions_config: HumanLoopActivationConfigHumanLoopActivationConditionsConfig=None):
        """CreateFlowDefinitionRequestHumanLoopActivationConfig - a model defined in OpenAPI

        :param human_loop_activation_conditions_config: The human_loop_activation_conditions_config of this CreateFlowDefinitionRequestHumanLoopActivationConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateFlowDefinitionRequestHumanLoopActivationConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateFlowDefinitionRequest_HumanLoopActivationConfig of this CreateFlowDefinitionRequestHumanLoopActivationConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def human_loop_activation_conditions_config(self):
        """Gets the human_loop_activation_conditions_config of this CreateFlowDefinitionRequestHumanLoopActivationConfig.


        :return: The human_loop_activation_conditions_config of this CreateFlowDefinitionRequestHumanLoopActivationConfig.
    ...
    def human_loop_activation_conditions_config(self, human_loop_activation_conditions_config):
        """Sets the human_loop_activation_conditions_config of this CreateFlowDefinitionRequestHumanLoopActivationConfig.
