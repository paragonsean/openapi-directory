...
class TransformInputDataSource(Model):
    ...
    def __init__(self, s3_data_source: TransformDataSourceS3DataSource=None):
        """TransformInputDataSource - a model defined in OpenAPI

        :param s3_data_source: The s3_data_source of this TransformInputDataSource.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransformInputDataSource':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransformInput_DataSource of this TransformInputDataSource.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def s3_data_source(self):
        """Gets the s3_data_source of this TransformInputDataSource.


        :return: The s3_data_source of this TransformInputDataSource.
    ...
    def s3_data_source(self, s3_data_source):
        """Sets the s3_data_source of this TransformInputDataSource.
