...
class DeploymentConfigRollingUpdatePolicy(Model):
    ...
    def __init__(self, maximum_batch_size: RollingUpdatePolicyMaximumBatchSize=None, wait_interval_in_seconds: int=None, maximum_execution_timeout_in_seconds: int=None, rollback_maximum_batch_size: RollingUpdatePolicyRollbackMaximumBatchSize=None):
        """DeploymentConfigRollingUpdatePolicy - a model defined in OpenAPI

        :param maximum_batch_size: The maximum_batch_size of this DeploymentConfigRollingUpdatePolicy.
        :param wait_interval_in_seconds: The wait_interval_in_seconds of this DeploymentConfigRollingUpdatePolicy.
        :param maximum_execution_timeout_in_seconds: The maximum_execution_timeout_in_seconds of this DeploymentConfigRollingUpdatePolicy.
        :param rollback_maximum_batch_size: The rollback_maximum_batch_size of this DeploymentConfigRollingUpdatePolicy.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeploymentConfigRollingUpdatePolicy':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeploymentConfig_RollingUpdatePolicy of this DeploymentConfigRollingUpdatePolicy.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def maximum_batch_size(self):
        """Gets the maximum_batch_size of this DeploymentConfigRollingUpdatePolicy.


        :return: The maximum_batch_size of this DeploymentConfigRollingUpdatePolicy.
    ...
    def maximum_batch_size(self, maximum_batch_size):
        """Sets the maximum_batch_size of this DeploymentConfigRollingUpdatePolicy.
    ...
    def wait_interval_in_seconds(self):
        """Gets the wait_interval_in_seconds of this DeploymentConfigRollingUpdatePolicy.


        :return: The wait_interval_in_seconds of this DeploymentConfigRollingUpdatePolicy.
        :rtype: int
        """
    ...
    def wait_interval_in_seconds(self, wait_interval_in_seconds):
        """Sets the wait_interval_in_seconds of this DeploymentConfigRollingUpdatePolicy.
    ...
    def maximum_execution_timeout_in_seconds(self):
        """Gets the maximum_execution_timeout_in_seconds of this DeploymentConfigRollingUpdatePolicy.


        :return: The maximum_execution_timeout_in_seconds of this DeploymentConfigRollingUpdatePolicy.
        :rtype: int
        """
    ...
    def maximum_execution_timeout_in_seconds(self, maximum_execution_timeout_in_seconds):
        """Sets the maximum_execution_timeout_in_seconds of this DeploymentConfigRollingUpdatePolicy.
    ...
    def rollback_maximum_batch_size(self):
        """Gets the rollback_maximum_batch_size of this DeploymentConfigRollingUpdatePolicy.


        :return: The rollback_maximum_batch_size of this DeploymentConfigRollingUpdatePolicy.
    ...
    def rollback_maximum_batch_size(self, rollback_maximum_batch_size):
        """Sets the rollback_maximum_batch_size of this DeploymentConfigRollingUpdatePolicy.
