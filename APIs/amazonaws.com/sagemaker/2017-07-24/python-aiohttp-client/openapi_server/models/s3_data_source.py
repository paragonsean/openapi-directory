...
class S3DataSource(Model):
    ...
    def __init__(self, s3_data_type: S3DataType=None, s3_uri: str=None, s3_data_distribution_type: S3DataDistribution=None, attribute_names: List=None, instance_group_names: List=None):
        ...
        :param s3_data_type: The s3_data_type of this S3DataSource.
        :param s3_uri: The s3_uri of this S3DataSource.
        :param s3_data_distribution_type: The s3_data_distribution_type of this S3DataSource.
        :param attribute_names: The attribute_names of this S3DataSource.
        :param instance_group_names: The instance_group_names of this S3DataSource.
        """
        self.openapi_types = {
    ...
    def s3_data_type(self):
        """Gets the s3_data_type of this S3DataSource.


        :return: The s3_data_type of this S3DataSource.
        :rtype: S3DataType
        """
    ...
    def s3_data_type(self, s3_data_type):
        """Sets the s3_data_type of this S3DataSource.
    ...
    def s3_data_distribution_type(self):
        """Gets the s3_data_distribution_type of this S3DataSource.


        :return: The s3_data_distribution_type of this S3DataSource.
    ...
    def s3_data_distribution_type(self, s3_data_distribution_type):
        """Sets the s3_data_distribution_type of this S3DataSource.
    ...
    def attribute_names(self):
        """Gets the attribute_names of this S3DataSource.


        :return: The attribute_names of this S3DataSource.
        :rtype: List
        """
    ...
    def attribute_names(self, attribute_names):
        """Sets the attribute_names of this S3DataSource.
    ...
    def instance_group_names(self):
        """Gets the instance_group_names of this S3DataSource.


        :return: The instance_group_names of this S3DataSource.
        :rtype: List
        """
    ...
    def instance_group_names(self, instance_group_names):
        """Sets the instance_group_names of this S3DataSource.
