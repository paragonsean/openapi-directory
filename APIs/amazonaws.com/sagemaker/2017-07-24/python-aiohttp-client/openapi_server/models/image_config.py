...
class ImageConfig(Model):
    ...
    def __init__(self, repository_access_mode: RepositoryAccessMode=None, repository_auth_config: ImageConfigRepositoryAuthConfig=None):
        ...
        :param repository_access_mode: The repository_access_mode of this ImageConfig.
        :param repository_auth_config: The repository_auth_config of this ImageConfig.
        """
        self.openapi_types = {
    ...
    def repository_access_mode(self):
        """Gets the repository_access_mode of this ImageConfig.


        :return: The repository_access_mode of this ImageConfig.
    ...
    def repository_access_mode(self, repository_access_mode):
        """Sets the repository_access_mode of this ImageConfig.
    ...
    def repository_auth_config(self):
        """Gets the repository_auth_config of this ImageConfig.


        :return: The repository_auth_config of this ImageConfig.
    ...
    def repository_auth_config(self, repository_auth_config):
        """Sets the repository_auth_config of this ImageConfig.
