...
class ModelVariantConfigInfrastructureConfig(Model):
    ...
    def __init__(self, infrastructure_type: ModelInfrastructureType=None, real_time_inference_config: ModelInfrastructureConfigRealTimeInferenceConfig=None):
        """ModelVariantConfigInfrastructureConfig - a model defined in OpenAPI

        :param infrastructure_type: The infrastructure_type of this ModelVariantConfigInfrastructureConfig.
        :param real_time_inference_config: The real_time_inference_config of this ModelVariantConfigInfrastructureConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ModelVariantConfigInfrastructureConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ModelVariantConfig_InfrastructureConfig of this ModelVariantConfigInfrastructureConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def infrastructure_type(self):
        """Gets the infrastructure_type of this ModelVariantConfigInfrastructureConfig.


        :return: The infrastructure_type of this ModelVariantConfigInfrastructureConfig.
    ...
    def infrastructure_type(self, infrastructure_type):
        """Sets the infrastructure_type of this ModelVariantConfigInfrastructureConfig.
    ...
    def real_time_inference_config(self):
        """Gets the real_time_inference_config of this ModelVariantConfigInfrastructureConfig.


        :return: The real_time_inference_config of this ModelVariantConfigInfrastructureConfig.
    ...
    def real_time_inference_config(self, real_time_inference_config):
        """Sets the real_time_inference_config of this ModelVariantConfigInfrastructureConfig.
