...
/*
 * OAIProcessingInput_S3Input.h
 *
 * 
 */

#ifndef OAIProcessingInput_S3Input_H
#define OAIProcessingInput_S3Input_H
...
class OAIProcessingInput_S3Input : public OAIObject {
public:
    OAIProcessingInput_S3Input();
    OAIProcessingInput_S3Input(QString json);
    ~OAIProcessingInput_S3Input() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProcessingInput_S3Input)

#endif // OAIProcessingInput_S3Input_H
