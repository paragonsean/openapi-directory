...
#ifndef OAIActionSource_H
#define OAIActionSource_H
...
class OAIActionSource : public OAIObject {
public:
    OAIActionSource();
    OAIActionSource(QString json);
    ~OAIActionSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionSource)

#endif // OAIActionSource_H
