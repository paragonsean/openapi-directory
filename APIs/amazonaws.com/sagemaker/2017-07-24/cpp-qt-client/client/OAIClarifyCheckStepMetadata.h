...
#ifndef OAIClarifyCheckStepMetadata_H
#define OAIClarifyCheckStepMetadata_H
...
class OAIClarifyCheckStepMetadata : public OAIObject {
public:
    OAIClarifyCheckStepMetadata();
    OAIClarifyCheckStepMetadata(QString json);
    ~OAIClarifyCheckStepMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClarifyCheckStepMetadata)

#endif // OAIClarifyCheckStepMetadata_H
