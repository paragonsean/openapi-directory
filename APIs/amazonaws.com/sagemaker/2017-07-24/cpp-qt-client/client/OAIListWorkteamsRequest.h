...
/*
 * OAIListWorkteamsRequest.h
 *
 * 
 */

#ifndef OAIListWorkteamsRequest_H
#define OAIListWorkteamsRequest_H
...
class OAIListWorkteamsRequest : public OAIObject {
public:
    OAIListWorkteamsRequest();
    OAIListWorkteamsRequest(QString json);
    ~OAIListWorkteamsRequest() override;
    ...
    OAIListWorkteamsSortByOptions getSortBy() const;
    void setSortBy(const OAIListWorkteamsSortByOptions &sort_by);
...
private:
    ...
    OAIListWorkteamsSortByOptions m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListWorkteamsRequest)

#endif // OAIListWorkteamsRequest_H
