...
/*
 * OAIMonitoringAppSpecification.h
 *
 * Container image configuration object for the monitoring job.
 */

#ifndef OAIMonitoringAppSpecification_H
#define OAIMonitoringAppSpecification_H
...
class OAIMonitoringAppSpecification : public OAIObject {
public:
    OAIMonitoringAppSpecification();
    OAIMonitoringAppSpecification(QString json);
    ~OAIMonitoringAppSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitoringAppSpecification)

#endif // OAIMonitoringAppSpecification_H
