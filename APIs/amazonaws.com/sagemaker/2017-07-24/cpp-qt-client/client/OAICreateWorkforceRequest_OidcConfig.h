...
/*
 * OAICreateWorkforceRequest_OidcConfig.h
 *
 * 
 */

#ifndef OAICreateWorkforceRequest_OidcConfig_H
#define OAICreateWorkforceRequest_OidcConfig_H
...
class OAICreateWorkforceRequest_OidcConfig : public OAIObject {
public:
    OAICreateWorkforceRequest_OidcConfig();
    OAICreateWorkforceRequest_OidcConfig(QString json);
    ~OAICreateWorkforceRequest_OidcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWorkforceRequest_OidcConfig)

#endif // OAICreateWorkforceRequest_OidcConfig_H
