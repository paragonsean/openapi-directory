...
/*
 * OAIListAppImageConfigsRequest.h
 *
 * 
 */

#ifndef OAIListAppImageConfigsRequest_H
#define OAIListAppImageConfigsRequest_H
...
class OAIListAppImageConfigsRequest : public OAIObject {
public:
    OAIListAppImageConfigsRequest();
    OAIListAppImageConfigsRequest(QString json);
    ~OAIListAppImageConfigsRequest() override;
    ...
    QDateTime getModifiedTimeBefore() const;
    void setModifiedTimeBefore(const QDateTime &modified_time_before);
    bool is_modified_time_before_Set() const;
    bool is_modified_time_before_Valid() const;

    QDateTime getModifiedTimeAfter() const;
    void setModifiedTimeAfter(const QDateTime &modified_time_after);
    bool is_modified_time_after_Set() const;
    bool is_modified_time_after_Valid() const;

    OAIAppImageConfigSortKey getSortBy() const;
    void setSortBy(const OAIAppImageConfigSortKey &sort_by);
...
private:
    ...
    QDateTime m_modified_time_before;
    bool m_modified_time_before_isSet;
    bool m_modified_time_before_isValid;

    QDateTime m_modified_time_after;
    bool m_modified_time_after_isSet;
    bool m_modified_time_after_isValid;

    OAIAppImageConfigSortKey m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAppImageConfigsRequest)

#endif // OAIListAppImageConfigsRequest_H
