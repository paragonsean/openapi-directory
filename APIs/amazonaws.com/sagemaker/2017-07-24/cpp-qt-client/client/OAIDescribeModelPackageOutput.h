...
/*
 * OAIDescribeModelPackageOutput.h
 *
 * 
 */

#ifndef OAIDescribeModelPackageOutput_H
#define OAIDescribeModelPackageOutput_H
...
#include "OAIDescribeModelPackageOutput_ValidationSpecification.h"
...
namespace OpenAPI {
class OAIDescribeModelPackageOutput_InferenceSpecification;
class OAICreateModelPackageInput_SourceAlgorithmSpecification;
class OAIDescribeModelPackageOutput_ValidationSpecification;
class OAIDescribeModelPackageOutput_ModelPackageStatusDetails;
...
class OAIDescribeModelPackageOutput : public OAIObject {
public:
    OAIDescribeModelPackageOutput();
    OAIDescribeModelPackageOutput(QString json);
    ~OAIDescribeModelPackageOutput() override;
    ...
    OAIDescribeModelPackageOutput_InferenceSpecification getInferenceSpecification() const;
    void setInferenceSpecification(const OAIDescribeModelPackageOutput_InferenceSpecification &inference_specification);
    ...
    OAIDescribeModelPackageOutput_ValidationSpecification getValidationSpecification() const;
    void setValidationSpecification(const OAIDescribeModelPackageOutput_ValidationSpecification &validation_specification);
    ...
    OAIDescribeModelPackageOutput_ModelPackageStatusDetails getModelPackageStatusDetails() const;
    void setModelPackageStatusDetails(const OAIDescribeModelPackageOutput_ModelPackageStatusDetails &model_package_status_details);
...
private:
    ...
    OAIDescribeModelPackageOutput_InferenceSpecification m_inference_specification;
    ...
    OAIDescribeModelPackageOutput_ValidationSpecification m_validation_specification;
    ...
    OAIDescribeModelPackageOutput_ModelPackageStatusDetails m_model_package_status_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeModelPackageOutput)

#endif // OAIDescribeModelPackageOutput_H
