...
/*
 * OAIAppSpecification.h
 *
 * Configuration to run a processing job in a specified container image.
 */

#ifndef OAIAppSpecification_H
#define OAIAppSpecification_H
...
class OAIAppSpecification : public OAIObject {
public:
    OAIAppSpecification();
    OAIAppSpecification(QString json);
    ~OAIAppSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppSpecification)

#endif // OAIAppSpecification_H
