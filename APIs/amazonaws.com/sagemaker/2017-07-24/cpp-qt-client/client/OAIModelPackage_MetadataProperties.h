...
/*
 * OAIModelPackage_MetadataProperties.h
 *
 * 
 */

#ifndef OAIModelPackage_MetadataProperties_H
#define OAIModelPackage_MetadataProperties_H
...
class OAIModelPackage_MetadataProperties : public OAIObject {
public:
    OAIModelPackage_MetadataProperties();
    OAIModelPackage_MetadataProperties(QString json);
    ~OAIModelPackage_MetadataProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelPackage_MetadataProperties)

#endif // OAIModelPackage_MetadataProperties_H
