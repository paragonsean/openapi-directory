...
OAIListHubContentsRequest::OAIListHubContentsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListHubContentsRequest::OAIListHubContentsRequest() {
    this->initializeModel();
}

OAIListHubContentsRequest::~OAIListHubContentsRequest() {}

void OAIListHubContentsRequest::initializeModel() {
...
void OAIListHubContentsRequest::fromJson(QString jsonString) {
...
void OAIListHubContentsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListHubContentsRequest::asJson() const {
...
QJsonObject OAIListHubContentsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_hub_name_isSet) {
...
QString OAIListHubContentsRequest::getHubName() const {
    return m_hub_name;
}
void OAIListHubContentsRequest::setHubName(const QString &hub_name) {
    m_hub_name = hub_name;
    m_hub_name_isSet = true;
}

bool OAIListHubContentsRequest::is_hub_name_Set() const{
    return m_hub_name_isSet;
}

bool OAIListHubContentsRequest::is_hub_name_Valid() const{
    return m_hub_name_isValid;
}

OAIHubContentType OAIListHubContentsRequest::getHubContentType() const {
    return m_hub_content_type;
}
void OAIListHubContentsRequest::setHubContentType(const OAIHubContentType &hub_content_type) {
    m_hub_content_type = hub_content_type;
    m_hub_content_type_isSet = true;
}

bool OAIListHubContentsRequest::is_hub_content_type_Set() const{
    return m_hub_content_type_isSet;
}

bool OAIListHubContentsRequest::is_hub_content_type_Valid() const{
    return m_hub_content_type_isValid;
}

QString OAIListHubContentsRequest::getNameContains() const {
    return m_name_contains;
}
void OAIListHubContentsRequest::setNameContains(const QString &name_contains) {
    m_name_contains = name_contains;
    m_name_contains_isSet = true;
}

bool OAIListHubContentsRequest::is_name_contains_Set() const{
    return m_name_contains_isSet;
}

bool OAIListHubContentsRequest::is_name_contains_Valid() const{
    return m_name_contains_isValid;
}

QString OAIListHubContentsRequest::getMaxSchemaVersion() const {
    return m_max_schema_version;
}
void OAIListHubContentsRequest::setMaxSchemaVersion(const QString &max_schema_version) {
    m_max_schema_version = max_schema_version;
    m_max_schema_version_isSet = true;
}

bool OAIListHubContentsRequest::is_max_schema_version_Set() const{
    return m_max_schema_version_isSet;
}

bool OAIListHubContentsRequest::is_max_schema_version_Valid() const{
    return m_max_schema_version_isValid;
}

QDateTime OAIListHubContentsRequest::getCreationTimeBefore() const {
    return m_creation_time_before;
}
void OAIListHubContentsRequest::setCreationTimeBefore(const QDateTime &creation_time_before) {
    m_creation_time_before = creation_time_before;
    m_creation_time_before_isSet = true;
}

bool OAIListHubContentsRequest::is_creation_time_before_Set() const{
    return m_creation_time_before_isSet;
}

bool OAIListHubContentsRequest::is_creation_time_before_Valid() const{
    return m_creation_time_before_isValid;
}

QDateTime OAIListHubContentsRequest::getCreationTimeAfter() const {
    return m_creation_time_after;
}
void OAIListHubContentsRequest::setCreationTimeAfter(const QDateTime &creation_time_after) {
    m_creation_time_after = creation_time_after;
    m_creation_time_after_isSet = true;
}

bool OAIListHubContentsRequest::is_creation_time_after_Set() const{
    return m_creation_time_after_isSet;
}

bool OAIListHubContentsRequest::is_creation_time_after_Valid() const{
    return m_creation_time_after_isValid;
}

OAIHubContentSortBy OAIListHubContentsRequest::getSortBy() const {
    return m_sort_by;
}
void OAIListHubContentsRequest::setSortBy(const OAIHubContentSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIListHubContentsRequest::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIListHubContentsRequest::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAISortOrder OAIListHubContentsRequest::getSortOrder() const {
    return m_sort_order;
}
void OAIListHubContentsRequest::setSortOrder(const OAISortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIListHubContentsRequest::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIListHubContentsRequest::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

qint32 OAIListHubContentsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListHubContentsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListHubContentsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListHubContentsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListHubContentsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListHubContentsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListHubContentsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListHubContentsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListHubContentsRequest::isSet() const {
...
bool OAIListHubContentsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_hub_name_isValid && m_hub_content_type_isValid && true;
}
