...
/*
 * OAIRecommendationJobVpcConfig.h
 *
 * Inference Recommender provisions SageMaker endpoints with access to VPC in the inference recommendation job.
 */

#ifndef OAIRecommendationJobVpcConfig_H
#define OAIRecommendationJobVpcConfig_H
...
class OAIRecommendationJobVpcConfig : public OAIObject {
public:
    OAIRecommendationJobVpcConfig();
    OAIRecommendationJobVpcConfig(QString json);
    ~OAIRecommendationJobVpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecommendationJobVpcConfig)

#endif // OAIRecommendationJobVpcConfig_H
