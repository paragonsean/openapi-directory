...
OAIListAutoMLJobsRequest::OAIListAutoMLJobsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAutoMLJobsRequest::OAIListAutoMLJobsRequest() {
    this->initializeModel();
}

OAIListAutoMLJobsRequest::~OAIListAutoMLJobsRequest() {}

void OAIListAutoMLJobsRequest::initializeModel() {
...
void OAIListAutoMLJobsRequest::fromJson(QString jsonString) {
...
void OAIListAutoMLJobsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListAutoMLJobsRequest::asJson() const {
...
QJsonObject OAIListAutoMLJobsRequest::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIListAutoMLJobsRequest::getCreationTimeAfter() const {
    return m_creation_time_after;
}
void OAIListAutoMLJobsRequest::setCreationTimeAfter(const QDateTime &creation_time_after) {
    m_creation_time_after = creation_time_after;
    m_creation_time_after_isSet = true;
}

bool OAIListAutoMLJobsRequest::is_creation_time_after_Set() const{
    return m_creation_time_after_isSet;
}

bool OAIListAutoMLJobsRequest::is_creation_time_after_Valid() const{
    return m_creation_time_after_isValid;
}

QDateTime OAIListAutoMLJobsRequest::getCreationTimeBefore() const {
    return m_creation_time_before;
}
void OAIListAutoMLJobsRequest::setCreationTimeBefore(const QDateTime &creation_time_before) {
    m_creation_time_before = creation_time_before;
    m_creation_time_before_isSet = true;
}

bool OAIListAutoMLJobsRequest::is_creation_time_before_Set() const{
    return m_creation_time_before_isSet;
}

bool OAIListAutoMLJobsRequest::is_creation_time_before_Valid() const{
    return m_creation_time_before_isValid;
}

QDateTime OAIListAutoMLJobsRequest::getLastModifiedTimeAfter() const {
    return m_last_modified_time_after;
}
void OAIListAutoMLJobsRequest::setLastModifiedTimeAfter(const QDateTime &last_modified_time_after) {
    m_last_modified_time_after = last_modified_time_after;
    m_last_modified_time_after_isSet = true;
}

bool OAIListAutoMLJobsRequest::is_last_modified_time_after_Set() const{
    return m_last_modified_time_after_isSet;
}

bool OAIListAutoMLJobsRequest::is_last_modified_time_after_Valid() const{
    return m_last_modified_time_after_isValid;
}

QDateTime OAIListAutoMLJobsRequest::getLastModifiedTimeBefore() const {
    return m_last_modified_time_before;
}
void OAIListAutoMLJobsRequest::setLastModifiedTimeBefore(const QDateTime &last_modified_time_before) {
    m_last_modified_time_before = last_modified_time_before;
    m_last_modified_time_before_isSet = true;
}

bool OAIListAutoMLJobsRequest::is_last_modified_time_before_Set() const{
    return m_last_modified_time_before_isSet;
}

bool OAIListAutoMLJobsRequest::is_last_modified_time_before_Valid() const{
    return m_last_modified_time_before_isValid;
}

QString OAIListAutoMLJobsRequest::getNameContains() const {
    return m_name_contains;
}
void OAIListAutoMLJobsRequest::setNameContains(const QString &name_contains) {
    m_name_contains = name_contains;
    m_name_contains_isSet = true;
}

bool OAIListAutoMLJobsRequest::is_name_contains_Set() const{
    return m_name_contains_isSet;
}

bool OAIListAutoMLJobsRequest::is_name_contains_Valid() const{
    return m_name_contains_isValid;
}

OAIAutoMLJobStatus OAIListAutoMLJobsRequest::getStatusEquals() const {
    return m_status_equals;
}
void OAIListAutoMLJobsRequest::setStatusEquals(const OAIAutoMLJobStatus &status_equals) {
    m_status_equals = status_equals;
    m_status_equals_isSet = true;
}

bool OAIListAutoMLJobsRequest::is_status_equals_Set() const{
    return m_status_equals_isSet;
}

bool OAIListAutoMLJobsRequest::is_status_equals_Valid() const{
    return m_status_equals_isValid;
}

OAIAutoMLSortOrder OAIListAutoMLJobsRequest::getSortOrder() const {
    return m_sort_order;
}
void OAIListAutoMLJobsRequest::setSortOrder(const OAIAutoMLSortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIListAutoMLJobsRequest::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIListAutoMLJobsRequest::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

OAIAutoMLSortBy OAIListAutoMLJobsRequest::getSortBy() const {
    return m_sort_by;
}
void OAIListAutoMLJobsRequest::setSortBy(const OAIAutoMLSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIListAutoMLJobsRequest::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIListAutoMLJobsRequest::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

qint32 OAIListAutoMLJobsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListAutoMLJobsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListAutoMLJobsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListAutoMLJobsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListAutoMLJobsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListAutoMLJobsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAutoMLJobsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAutoMLJobsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListAutoMLJobsRequest::isSet() const {
...
bool OAIListAutoMLJobsRequest::isValid() const {
