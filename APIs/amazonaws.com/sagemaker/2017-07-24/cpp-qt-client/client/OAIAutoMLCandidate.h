...
/*
 * OAIAutoMLCandidate.h
 *
 * Information about a candidate produced by an AutoML training job, including its status, steps, and other properties.
 */

#ifndef OAIAutoMLCandidate_H
#define OAIAutoMLCandidate_H
...
class OAIAutoMLCandidate : public OAIObject {
public:
    OAIAutoMLCandidate();
    OAIAutoMLCandidate(QString json);
    ~OAIAutoMLCandidate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoMLCandidate)

#endif // OAIAutoMLCandidate_H
