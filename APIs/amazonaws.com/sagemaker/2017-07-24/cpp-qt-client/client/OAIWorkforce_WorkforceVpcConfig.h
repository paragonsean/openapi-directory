...
/*
 * OAIWorkforce_WorkforceVpcConfig.h
 *
 * 
 */

#ifndef OAIWorkforce_WorkforceVpcConfig_H
#define OAIWorkforce_WorkforceVpcConfig_H
...
class OAIWorkforce_WorkforceVpcConfig : public OAIObject {
public:
    OAIWorkforce_WorkforceVpcConfig();
    OAIWorkforce_WorkforceVpcConfig(QString json);
    ~OAIWorkforce_WorkforceVpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkforce_WorkforceVpcConfig)

#endif // OAIWorkforce_WorkforceVpcConfig_H
