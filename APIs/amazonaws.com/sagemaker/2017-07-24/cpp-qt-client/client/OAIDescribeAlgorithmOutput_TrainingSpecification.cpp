...
OAIDescribeAlgorithmOutput_TrainingSpecification::OAIDescribeAlgorithmOutput_TrainingSpecification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAlgorithmOutput_TrainingSpecification::OAIDescribeAlgorithmOutput_TrainingSpecification() {
    this->initializeModel();
}

OAIDescribeAlgorithmOutput_TrainingSpecification::~OAIDescribeAlgorithmOutput_TrainingSpecification() {}

void OAIDescribeAlgorithmOutput_TrainingSpecification::initializeModel() {
...
void OAIDescribeAlgorithmOutput_TrainingSpecification::fromJson(QString jsonString) {
...
void OAIDescribeAlgorithmOutput_TrainingSpecification::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeAlgorithmOutput_TrainingSpecification::asJson() const {
...
QJsonObject OAIDescribeAlgorithmOutput_TrainingSpecification::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeAlgorithmOutput_TrainingSpecification::getTrainingImage() const {
    return m_training_image;
}
void OAIDescribeAlgorithmOutput_TrainingSpecification::setTrainingImage(const QString &training_image) {
    m_training_image = training_image;
    m_training_image_isSet = true;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_training_image_Set() const{
    return m_training_image_isSet;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_training_image_Valid() const{
    return m_training_image_isValid;
}

QString OAIDescribeAlgorithmOutput_TrainingSpecification::getTrainingImageDigest() const {
    return m_training_image_digest;
}
void OAIDescribeAlgorithmOutput_TrainingSpecification::setTrainingImageDigest(const QString &training_image_digest) {
    m_training_image_digest = training_image_digest;
    m_training_image_digest_isSet = true;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_training_image_digest_Set() const{
    return m_training_image_digest_isSet;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_training_image_digest_Valid() const{
    return m_training_image_digest_isValid;
}

QList OAIDescribeAlgorithmOutput_TrainingSpecification::getSupportedHyperParameters() const {
    return m_supported_hyper_parameters;
}
void OAIDescribeAlgorithmOutput_TrainingSpecification::setSupportedHyperParameters(const QList &supported_hyper_parameters) {
    m_supported_hyper_parameters = supported_hyper_parameters;
    m_supported_hyper_parameters_isSet = true;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_supported_hyper_parameters_Set() const{
    return m_supported_hyper_parameters_isSet;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_supported_hyper_parameters_Valid() const{
    return m_supported_hyper_parameters_isValid;
}

QList OAIDescribeAlgorithmOutput_TrainingSpecification::getSupportedTrainingInstanceTypes() const {
    return m_supported_training_instance_types;
}
void OAIDescribeAlgorithmOutput_TrainingSpecification::setSupportedTrainingInstanceTypes(const QList &supported_training_instance_types) {
    m_supported_training_instance_types = supported_training_instance_types;
    m_supported_training_instance_types_isSet = true;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_supported_training_instance_types_Set() const{
    return m_supported_training_instance_types_isSet;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_supported_training_instance_types_Valid() const{
    return m_supported_training_instance_types_isValid;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::getSupportsDistributedTraining() const {
    return m_supports_distributed_training;
}
void OAIDescribeAlgorithmOutput_TrainingSpecification::setSupportsDistributedTraining(const bool &supports_distributed_training) {
    m_supports_distributed_training = supports_distributed_training;
    m_supports_distributed_training_isSet = true;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_supports_distributed_training_Set() const{
    return m_supports_distributed_training_isSet;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_supports_distributed_training_Valid() const{
    return m_supports_distributed_training_isValid;
}

QList OAIDescribeAlgorithmOutput_TrainingSpecification::getMetricDefinitions() const {
    return m_metric_definitions;
}
void OAIDescribeAlgorithmOutput_TrainingSpecification::setMetricDefinitions(const QList &metric_definitions) {
    m_metric_definitions = metric_definitions;
    m_metric_definitions_isSet = true;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_metric_definitions_Set() const{
    return m_metric_definitions_isSet;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_metric_definitions_Valid() const{
    return m_metric_definitions_isValid;
}

QList OAIDescribeAlgorithmOutput_TrainingSpecification::getTrainingChannels() const {
    return m_training_channels;
}
void OAIDescribeAlgorithmOutput_TrainingSpecification::setTrainingChannels(const QList &training_channels) {
    m_training_channels = training_channels;
    m_training_channels_isSet = true;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_training_channels_Set() const{
    return m_training_channels_isSet;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_training_channels_Valid() const{
    return m_training_channels_isValid;
}

QList OAIDescribeAlgorithmOutput_TrainingSpecification::getSupportedTuningJobObjectiveMetrics() const {
    return m_supported_tuning_job_objective_metrics;
}
void OAIDescribeAlgorithmOutput_TrainingSpecification::setSupportedTuningJobObjectiveMetrics(const QList &supported_tuning_job_objective_metrics) {
...
bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_supported_tuning_job_objective_metrics_Set() const{
    return m_supported_tuning_job_objective_metrics_isSet;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::is_supported_tuning_job_objective_metrics_Valid() const{
    return m_supported_tuning_job_objective_metrics_isValid;
}

bool OAIDescribeAlgorithmOutput_TrainingSpecification::isSet() const {
...
bool OAIDescribeAlgorithmOutput_TrainingSpecification::isValid() const {
