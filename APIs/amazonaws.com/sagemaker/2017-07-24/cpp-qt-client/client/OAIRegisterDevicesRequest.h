...
/*
 * OAIRegisterDevicesRequest.h
 *
 * 
 */

#ifndef OAIRegisterDevicesRequest_H
#define OAIRegisterDevicesRequest_H
...
class OAIRegisterDevicesRequest : public OAIObject {
public:
    OAIRegisterDevicesRequest();
    OAIRegisterDevicesRequest(QString json);
    ~OAIRegisterDevicesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterDevicesRequest)

#endif // OAIRegisterDevicesRequest_H
