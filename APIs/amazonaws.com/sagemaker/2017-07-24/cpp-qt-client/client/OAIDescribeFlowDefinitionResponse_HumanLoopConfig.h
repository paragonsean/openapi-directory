...
/*
 * OAIDescribeFlowDefinitionResponse_HumanLoopConfig.h
 *
 * 
 */

#ifndef OAIDescribeFlowDefinitionResponse_HumanLoopConfig_H
#define OAIDescribeFlowDefinitionResponse_HumanLoopConfig_H
...
class OAIDescribeFlowDefinitionResponse_HumanLoopConfig : public OAIObject {
public:
    OAIDescribeFlowDefinitionResponse_HumanLoopConfig();
    OAIDescribeFlowDefinitionResponse_HumanLoopConfig(QString json);
    ~OAIDescribeFlowDefinitionResponse_HumanLoopConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFlowDefinitionResponse_HumanLoopConfig)

#endif // OAIDescribeFlowDefinitionResponse_HumanLoopConfig_H
