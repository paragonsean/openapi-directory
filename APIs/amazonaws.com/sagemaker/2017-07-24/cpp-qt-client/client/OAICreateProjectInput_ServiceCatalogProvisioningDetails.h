...
/*
 * OAICreateProjectInput_ServiceCatalogProvisioningDetails.h
 *
 * 
 */

#ifndef OAICreateProjectInput_ServiceCatalogProvisioningDetails_H
#define OAICreateProjectInput_ServiceCatalogProvisioningDetails_H
...
class OAICreateProjectInput_ServiceCatalogProvisioningDetails : public OAIObject {
public:
    OAICreateProjectInput_ServiceCatalogProvisioningDetails();
    OAICreateProjectInput_ServiceCatalogProvisioningDetails(QString json);
    ~OAICreateProjectInput_ServiceCatalogProvisioningDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectInput_ServiceCatalogProvisioningDetails)

#endif // OAICreateProjectInput_ServiceCatalogProvisioningDetails_H
