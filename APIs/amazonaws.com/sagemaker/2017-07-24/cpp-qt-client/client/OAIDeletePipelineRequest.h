...
/*
 * OAIDeletePipelineRequest.h
 *
 * 
 */

#ifndef OAIDeletePipelineRequest_H
#define OAIDeletePipelineRequest_H
...
class OAIDeletePipelineRequest : public OAIObject {
public:
    OAIDeletePipelineRequest();
    OAIDeletePipelineRequest(QString json);
    ~OAIDeletePipelineRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePipelineRequest)

#endif // OAIDeletePipelineRequest_H
