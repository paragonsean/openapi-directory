...
/*
 * OAICandidateProperties_CandidateArtifactLocations.h
 *
 * 
 */

#ifndef OAICandidateProperties_CandidateArtifactLocations_H
#define OAICandidateProperties_CandidateArtifactLocations_H
...
class OAICandidateProperties_CandidateArtifactLocations : public OAIObject {
public:
    OAICandidateProperties_CandidateArtifactLocations();
    OAICandidateProperties_CandidateArtifactLocations(QString json);
    ~OAICandidateProperties_CandidateArtifactLocations() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICandidateProperties_CandidateArtifactLocations)

#endif // OAICandidateProperties_CandidateArtifactLocations_H
