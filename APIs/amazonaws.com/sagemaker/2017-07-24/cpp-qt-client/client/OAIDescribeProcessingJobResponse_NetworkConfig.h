...
/*
 * OAIDescribeProcessingJobResponse_NetworkConfig.h
 *
 * 
 */

#ifndef OAIDescribeProcessingJobResponse_NetworkConfig_H
#define OAIDescribeProcessingJobResponse_NetworkConfig_H
...
class OAIDescribeProcessingJobResponse_NetworkConfig : public OAIObject {
public:
    OAIDescribeProcessingJobResponse_NetworkConfig();
    OAIDescribeProcessingJobResponse_NetworkConfig(QString json);
    ~OAIDescribeProcessingJobResponse_NetworkConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProcessingJobResponse_NetworkConfig)

#endif // OAIDescribeProcessingJobResponse_NetworkConfig_H
