...
/*
 * OAICreateCodeRepositoryInput_GitConfig.h
 *
 * 
 */

#ifndef OAICreateCodeRepositoryInput_GitConfig_H
#define OAICreateCodeRepositoryInput_GitConfig_H
...
class OAICreateCodeRepositoryInput_GitConfig : public OAIObject {
public:
    OAICreateCodeRepositoryInput_GitConfig();
    OAICreateCodeRepositoryInput_GitConfig(QString json);
    ~OAICreateCodeRepositoryInput_GitConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCodeRepositoryInput_GitConfig)

#endif // OAICreateCodeRepositoryInput_GitConfig_H
