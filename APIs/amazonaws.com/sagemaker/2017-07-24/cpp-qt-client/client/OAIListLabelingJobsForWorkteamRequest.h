...
/*
 * OAIListLabelingJobsForWorkteamRequest.h
 *
 * 
 */

#ifndef OAIListLabelingJobsForWorkteamRequest_H
#define OAIListLabelingJobsForWorkteamRequest_H
...
class OAIListLabelingJobsForWorkteamRequest : public OAIObject {
public:
    OAIListLabelingJobsForWorkteamRequest();
    OAIListLabelingJobsForWorkteamRequest(QString json);
    ~OAIListLabelingJobsForWorkteamRequest() override;
    ...
    QString getJobReferenceCodeContains() const;
    void setJobReferenceCodeContains(const QString &job_reference_code_contains);
    bool is_job_reference_code_contains_Set() const;
    bool is_job_reference_code_contains_Valid() const;

    OAIListLabelingJobsForWorkteamSortByOptions getSortBy() const;
    void setSortBy(const OAIListLabelingJobsForWorkteamSortByOptions &sort_by);
...
private:
    ...
    QString m_job_reference_code_contains;
    bool m_job_reference_code_contains_isSet;
    bool m_job_reference_code_contains_isValid;

    OAIListLabelingJobsForWorkteamSortByOptions m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLabelingJobsForWorkteamRequest)

#endif // OAIListLabelingJobsForWorkteamRequest_H
