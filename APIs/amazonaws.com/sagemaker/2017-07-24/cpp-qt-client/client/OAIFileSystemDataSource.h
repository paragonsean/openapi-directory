...
/*
 * OAIFileSystemDataSource.h
 *
 * Specifies a file system data source for a channel.
 */

#ifndef OAIFileSystemDataSource_H
#define OAIFileSystemDataSource_H
...
class OAIFileSystemDataSource : public OAIObject {
public:
    OAIFileSystemDataSource();
    OAIFileSystemDataSource(QString json);
    ~OAIFileSystemDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileSystemDataSource)

#endif // OAIFileSystemDataSource_H
