...
/*
 * OAIModelConfiguration.h
 *
 * Defines the model configuration. Includes the specification name and environment parameters.
 */

#ifndef OAIModelConfiguration_H
#define OAIModelConfiguration_H
...
class OAIModelConfiguration : public OAIObject {
public:
    OAIModelConfiguration();
    OAIModelConfiguration(QString json);
    ~OAIModelConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelConfiguration)

#endif // OAIModelConfiguration_H
