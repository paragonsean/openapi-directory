...
/*
 * OAIMonitoringClusterConfig.h
 *
 * Configuration for the cluster used to run model monitoring jobs.
 */

#ifndef OAIMonitoringClusterConfig_H
#define OAIMonitoringClusterConfig_H
...
class OAIMonitoringClusterConfig : public OAIObject {
public:
    OAIMonitoringClusterConfig();
    OAIMonitoringClusterConfig(QString json);
    ~OAIMonitoringClusterConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitoringClusterConfig)

#endif // OAIMonitoringClusterConfig_H
