...
/*
 * OAIListImageVersionsRequest.h
 *
 * 
 */

#ifndef OAIListImageVersionsRequest_H
#define OAIListImageVersionsRequest_H
...
class OAIListImageVersionsRequest : public OAIObject {
public:
    OAIListImageVersionsRequest();
    OAIListImageVersionsRequest(QString json);
    ~OAIListImageVersionsRequest() override;
    ...
    OAIImageVersionSortBy getSortBy() const;
    void setSortBy(const OAIImageVersionSortBy &sort_by);
    bool is_sort_by_Set() const;
    bool is_sort_by_Valid() const;

    OAIImageVersionSortOrder getSortOrder() const;
    void setSortOrder(const OAIImageVersionSortOrder &sort_order);
...
private:
    ...
    OAIImageVersionSortBy m_sort_by;
    bool m_sort_by_isSet;
    bool m_sort_by_isValid;

    OAIImageVersionSortOrder m_sort_order;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListImageVersionsRequest)

#endif // OAIListImageVersionsRequest_H
