...
/*
 * OAIDescribeLabelingJobResponse_LabelCounters.h
 *
 * 
 */

#ifndef OAIDescribeLabelingJobResponse_LabelCounters_H
#define OAIDescribeLabelingJobResponse_LabelCounters_H
...
class OAIDescribeLabelingJobResponse_LabelCounters : public OAIObject {
public:
    OAIDescribeLabelingJobResponse_LabelCounters();
    OAIDescribeLabelingJobResponse_LabelCounters(QString json);
    ~OAIDescribeLabelingJobResponse_LabelCounters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLabelingJobResponse_LabelCounters)

#endif // OAIDescribeLabelingJobResponse_LabelCounters_H
