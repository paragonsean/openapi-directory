...
/*
 * OAIMonitoringNetworkConfig.h
 *
 * The networking configuration for the monitoring job.
 */

#ifndef OAIMonitoringNetworkConfig_H
#define OAIMonitoringNetworkConfig_H
...
class OAIMonitoringNetworkConfig : public OAIObject {
public:
    OAIMonitoringNetworkConfig();
    OAIMonitoringNetworkConfig(QString json);
    ~OAIMonitoringNetworkConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitoringNetworkConfig)

#endif // OAIMonitoringNetworkConfig_H
