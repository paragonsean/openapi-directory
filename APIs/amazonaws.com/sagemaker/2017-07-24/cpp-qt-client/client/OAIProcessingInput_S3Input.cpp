...
OAIProcessingInput_S3Input::OAIProcessingInput_S3Input(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProcessingInput_S3Input::OAIProcessingInput_S3Input() {
    this->initializeModel();
}

OAIProcessingInput_S3Input::~OAIProcessingInput_S3Input() {}

void OAIProcessingInput_S3Input::initializeModel() {
...
void OAIProcessingInput_S3Input::fromJson(QString jsonString) {
...
void OAIProcessingInput_S3Input::fromJsonObject(QJsonObject json) {
...
QString OAIProcessingInput_S3Input::asJson() const {
...
QJsonObject OAIProcessingInput_S3Input::asJsonObject() const {
    QJsonObject obj;
    if (m_s3_uri_isSet) {
...
QString OAIProcessingInput_S3Input::getS3Uri() const {
    return m_s3_uri;
}
void OAIProcessingInput_S3Input::setS3Uri(const QString &s3_uri) {
    m_s3_uri = s3_uri;
    m_s3_uri_isSet = true;
}

bool OAIProcessingInput_S3Input::is_s3_uri_Set() const{
    return m_s3_uri_isSet;
}

bool OAIProcessingInput_S3Input::is_s3_uri_Valid() const{
    return m_s3_uri_isValid;
}

QString OAIProcessingInput_S3Input::getLocalPath() const {
    return m_local_path;
}
void OAIProcessingInput_S3Input::setLocalPath(const QString &local_path) {
    m_local_path = local_path;
    m_local_path_isSet = true;
}

bool OAIProcessingInput_S3Input::is_local_path_Set() const{
    return m_local_path_isSet;
}

bool OAIProcessingInput_S3Input::is_local_path_Valid() const{
    return m_local_path_isValid;
}

OAIProcessingS3DataType OAIProcessingInput_S3Input::getS3DataType() const {
    return m_s3_data_type;
}
void OAIProcessingInput_S3Input::setS3DataType(const OAIProcessingS3DataType &s3_data_type) {
    m_s3_data_type = s3_data_type;
    m_s3_data_type_isSet = true;
}

bool OAIProcessingInput_S3Input::is_s3_data_type_Set() const{
    return m_s3_data_type_isSet;
}

bool OAIProcessingInput_S3Input::is_s3_data_type_Valid() const{
    return m_s3_data_type_isValid;
}

OAIProcessingS3InputMode OAIProcessingInput_S3Input::getS3InputMode() const {
    return m_s3_input_mode;
}
void OAIProcessingInput_S3Input::setS3InputMode(const OAIProcessingS3InputMode &s3_input_mode) {
    m_s3_input_mode = s3_input_mode;
    m_s3_input_mode_isSet = true;
}

bool OAIProcessingInput_S3Input::is_s3_input_mode_Set() const{
    return m_s3_input_mode_isSet;
}

bool OAIProcessingInput_S3Input::is_s3_input_mode_Valid() const{
    return m_s3_input_mode_isValid;
}

OAIProcessingS3DataDistributionType OAIProcessingInput_S3Input::getS3DataDistributionType() const {
    return m_s3_data_distribution_type;
}
void OAIProcessingInput_S3Input::setS3DataDistributionType(const OAIProcessingS3DataDistributionType &s3_data_distribution_type) {
    m_s3_data_distribution_type = s3_data_distribution_type;
    m_s3_data_distribution_type_isSet = true;
}

bool OAIProcessingInput_S3Input::is_s3_data_distribution_type_Set() const{
    return m_s3_data_distribution_type_isSet;
}

bool OAIProcessingInput_S3Input::is_s3_data_distribution_type_Valid() const{
    return m_s3_data_distribution_type_isValid;
}

OAIProcessingS3CompressionType OAIProcessingInput_S3Input::getS3CompressionType() const {
    return m_s3_compression_type;
}
void OAIProcessingInput_S3Input::setS3CompressionType(const OAIProcessingS3CompressionType &s3_compression_type) {
    m_s3_compression_type = s3_compression_type;
    m_s3_compression_type_isSet = true;
}

bool OAIProcessingInput_S3Input::is_s3_compression_type_Set() const{
    return m_s3_compression_type_isSet;
}

bool OAIProcessingInput_S3Input::is_s3_compression_type_Valid() const{
    return m_s3_compression_type_isValid;
}

bool OAIProcessingInput_S3Input::isSet() const {
...
bool OAIProcessingInput_S3Input::isValid() const {
