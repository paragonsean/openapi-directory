...
#ifndef OAISelectedStep_H
#define OAISelectedStep_H
...
class OAISelectedStep : public OAIObject {
public:
    OAISelectedStep();
    OAISelectedStep(QString json);
    ~OAISelectedStep() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISelectedStep)

#endif // OAISelectedStep_H
