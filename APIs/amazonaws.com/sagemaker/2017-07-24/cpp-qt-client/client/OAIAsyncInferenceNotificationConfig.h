...
/*
 * OAIAsyncInferenceNotificationConfig.h
 *
 * Specifies the configuration for notifications of inference results for asynchronous inference.
 */

#ifndef OAIAsyncInferenceNotificationConfig_H
#define OAIAsyncInferenceNotificationConfig_H
...
class OAIAsyncInferenceNotificationConfig : public OAIObject {
public:
    OAIAsyncInferenceNotificationConfig();
    OAIAsyncInferenceNotificationConfig(QString json);
    ~OAIAsyncInferenceNotificationConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAsyncInferenceNotificationConfig)

#endif // OAIAsyncInferenceNotificationConfig_H
