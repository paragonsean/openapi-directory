...
/*
 * OAIDescribeTrialResponse_Source.h
 *
 * 
 */

#ifndef OAIDescribeTrialResponse_Source_H
#define OAIDescribeTrialResponse_Source_H
...
class OAIDescribeTrialResponse_Source : public OAIObject {
public:
    OAIDescribeTrialResponse_Source();
    OAIDescribeTrialResponse_Source(QString json);
    ~OAIDescribeTrialResponse_Source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTrialResponse_Source)

#endif // OAIDescribeTrialResponse_Source_H
