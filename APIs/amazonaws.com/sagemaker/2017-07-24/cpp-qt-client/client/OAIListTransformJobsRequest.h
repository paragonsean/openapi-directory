...
/*
 * OAIListTransformJobsRequest.h
 *
 * 
 */

#ifndef OAIListTransformJobsRequest_H
#define OAIListTransformJobsRequest_H
...
class OAIListTransformJobsRequest : public OAIObject {
public:
    OAIListTransformJobsRequest();
    OAIListTransformJobsRequest(QString json);
    ~OAIListTransformJobsRequest() override;
    ...
    OAITransformJobStatus getStatusEquals() const;
    void setStatusEquals(const OAITransformJobStatus &status_equals);
...
private:
    ...
    OAITransformJobStatus m_status_equals;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTransformJobsRequest)

#endif // OAIListTransformJobsRequest_H
