...
/*
 * OAIDescribeDataQualityJobDefinitionResponse_NetworkConfig.h
 *
 * 
 */

#ifndef OAIDescribeDataQualityJobDefinitionResponse_NetworkConfig_H
#define OAIDescribeDataQualityJobDefinitionResponse_NetworkConfig_H
...
class OAIDescribeDataQualityJobDefinitionResponse_NetworkConfig : public OAIObject {
public:
    OAIDescribeDataQualityJobDefinitionResponse_NetworkConfig();
    OAIDescribeDataQualityJobDefinitionResponse_NetworkConfig(QString json);
    ~OAIDescribeDataQualityJobDefinitionResponse_NetworkConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDataQualityJobDefinitionResponse_NetworkConfig)

#endif // OAIDescribeDataQualityJobDefinitionResponse_NetworkConfig_H
