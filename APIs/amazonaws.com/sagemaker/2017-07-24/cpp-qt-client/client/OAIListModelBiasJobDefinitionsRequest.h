...
/*
 * OAIListModelBiasJobDefinitionsRequest.h
 *
 * 
 */

#ifndef OAIListModelBiasJobDefinitionsRequest_H
#define OAIListModelBiasJobDefinitionsRequest_H
...
class OAIListModelBiasJobDefinitionsRequest : public OAIObject {
public:
    OAIListModelBiasJobDefinitionsRequest();
    OAIListModelBiasJobDefinitionsRequest(QString json);
    ~OAIListModelBiasJobDefinitionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListModelBiasJobDefinitionsRequest)

#endif // OAIListModelBiasJobDefinitionsRequest_H
