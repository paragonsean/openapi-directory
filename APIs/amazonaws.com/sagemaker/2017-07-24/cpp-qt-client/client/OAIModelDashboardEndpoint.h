...
/*
 * OAIModelDashboardEndpoint.h
 *
 * An endpoint that hosts a model displayed in the Amazon SageMaker Model Dashboard.
 */

#ifndef OAIModelDashboardEndpoint_H
#define OAIModelDashboardEndpoint_H
...
class OAIModelDashboardEndpoint : public OAIObject {
public:
    OAIModelDashboardEndpoint();
    OAIModelDashboardEndpoint(QString json);
    ~OAIModelDashboardEndpoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelDashboardEndpoint)

#endif // OAIModelDashboardEndpoint_H
