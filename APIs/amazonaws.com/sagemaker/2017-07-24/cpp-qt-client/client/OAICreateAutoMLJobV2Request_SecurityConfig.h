...
/*
 * OAICreateAutoMLJobV2Request_SecurityConfig.h
 *
 * 
 */

#ifndef OAICreateAutoMLJobV2Request_SecurityConfig_H
#define OAICreateAutoMLJobV2Request_SecurityConfig_H
...
class OAICreateAutoMLJobV2Request_SecurityConfig : public OAIObject {
public:
    OAICreateAutoMLJobV2Request_SecurityConfig();
    OAICreateAutoMLJobV2Request_SecurityConfig(QString json);
    ~OAICreateAutoMLJobV2Request_SecurityConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAutoMLJobV2Request_SecurityConfig)

#endif // OAICreateAutoMLJobV2Request_SecurityConfig_H
