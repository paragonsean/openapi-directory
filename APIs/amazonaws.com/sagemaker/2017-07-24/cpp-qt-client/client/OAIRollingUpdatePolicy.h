...
/*
 * OAIRollingUpdatePolicy.h
 *
 * Specifies a rolling deployment strategy for updating a SageMaker endpoint.
 */

#ifndef OAIRollingUpdatePolicy_H
#define OAIRollingUpdatePolicy_H
...
class OAIRollingUpdatePolicy : public OAIObject {
public:
    OAIRollingUpdatePolicy();
    OAIRollingUpdatePolicy(QString json);
    ~OAIRollingUpdatePolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRollingUpdatePolicy)

#endif // OAIRollingUpdatePolicy_H
