...
OAIListHyperParameterTuningJobsRequest::OAIListHyperParameterTuningJobsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListHyperParameterTuningJobsRequest::OAIListHyperParameterTuningJobsRequest() {
    this->initializeModel();
}

OAIListHyperParameterTuningJobsRequest::~OAIListHyperParameterTuningJobsRequest() {}

void OAIListHyperParameterTuningJobsRequest::initializeModel() {
...
void OAIListHyperParameterTuningJobsRequest::fromJson(QString jsonString) {
...
void OAIListHyperParameterTuningJobsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListHyperParameterTuningJobsRequest::asJson() const {
...
QJsonObject OAIListHyperParameterTuningJobsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListHyperParameterTuningJobsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListHyperParameterTuningJobsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListHyperParameterTuningJobsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListHyperParameterTuningJobsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListHyperParameterTuningJobsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListHyperParameterTuningJobsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListHyperParameterTuningJobsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListHyperParameterTuningJobsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

OAIHyperParameterTuningJobSortByOptions OAIListHyperParameterTuningJobsRequest::getSortBy() const {
    return m_sort_by;
}
void OAIListHyperParameterTuningJobsRequest::setSortBy(const OAIHyperParameterTuningJobSortByOptions &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIListHyperParameterTuningJobsRequest::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIListHyperParameterTuningJobsRequest::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAISortOrder OAIListHyperParameterTuningJobsRequest::getSortOrder() const {
    return m_sort_order;
}
void OAIListHyperParameterTuningJobsRequest::setSortOrder(const OAISortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIListHyperParameterTuningJobsRequest::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIListHyperParameterTuningJobsRequest::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

QString OAIListHyperParameterTuningJobsRequest::getNameContains() const {
    return m_name_contains;
}
void OAIListHyperParameterTuningJobsRequest::setNameContains(const QString &name_contains) {
    m_name_contains = name_contains;
    m_name_contains_isSet = true;
}

bool OAIListHyperParameterTuningJobsRequest::is_name_contains_Set() const{
    return m_name_contains_isSet;
}

bool OAIListHyperParameterTuningJobsRequest::is_name_contains_Valid() const{
    return m_name_contains_isValid;
}

QDateTime OAIListHyperParameterTuningJobsRequest::getCreationTimeAfter() const {
    return m_creation_time_after;
}
void OAIListHyperParameterTuningJobsRequest::setCreationTimeAfter(const QDateTime &creation_time_after) {
    m_creation_time_after = creation_time_after;
    m_creation_time_after_isSet = true;
}

bool OAIListHyperParameterTuningJobsRequest::is_creation_time_after_Set() const{
    return m_creation_time_after_isSet;
}

bool OAIListHyperParameterTuningJobsRequest::is_creation_time_after_Valid() const{
    return m_creation_time_after_isValid;
}

QDateTime OAIListHyperParameterTuningJobsRequest::getCreationTimeBefore() const {
    return m_creation_time_before;
}
void OAIListHyperParameterTuningJobsRequest::setCreationTimeBefore(const QDateTime &creation_time_before) {
    m_creation_time_before = creation_time_before;
    m_creation_time_before_isSet = true;
}

bool OAIListHyperParameterTuningJobsRequest::is_creation_time_before_Set() const{
    return m_creation_time_before_isSet;
}

bool OAIListHyperParameterTuningJobsRequest::is_creation_time_before_Valid() const{
    return m_creation_time_before_isValid;
}

QDateTime OAIListHyperParameterTuningJobsRequest::getLastModifiedTimeAfter() const {
    return m_last_modified_time_after;
}
void OAIListHyperParameterTuningJobsRequest::setLastModifiedTimeAfter(const QDateTime &last_modified_time_after) {
    m_last_modified_time_after = last_modified_time_after;
    m_last_modified_time_after_isSet = true;
}

bool OAIListHyperParameterTuningJobsRequest::is_last_modified_time_after_Set() const{
    return m_last_modified_time_after_isSet;
}

bool OAIListHyperParameterTuningJobsRequest::is_last_modified_time_after_Valid() const{
    return m_last_modified_time_after_isValid;
}

QDateTime OAIListHyperParameterTuningJobsRequest::getLastModifiedTimeBefore() const {
    return m_last_modified_time_before;
}
void OAIListHyperParameterTuningJobsRequest::setLastModifiedTimeBefore(const QDateTime &last_modified_time_before) {
    m_last_modified_time_before = last_modified_time_before;
    m_last_modified_time_before_isSet = true;
}

bool OAIListHyperParameterTuningJobsRequest::is_last_modified_time_before_Set() const{
    return m_last_modified_time_before_isSet;
}

bool OAIListHyperParameterTuningJobsRequest::is_last_modified_time_before_Valid() const{
    return m_last_modified_time_before_isValid;
}

OAIHyperParameterTuningJobStatus OAIListHyperParameterTuningJobsRequest::getStatusEquals() const {
    return m_status_equals;
}
void OAIListHyperParameterTuningJobsRequest::setStatusEquals(const OAIHyperParameterTuningJobStatus &status_equals) {
    m_status_equals = status_equals;
    m_status_equals_isSet = true;
}

bool OAIListHyperParameterTuningJobsRequest::is_status_equals_Set() const{
    return m_status_equals_isSet;
}

bool OAIListHyperParameterTuningJobsRequest::is_status_equals_Valid() const{
    return m_status_equals_isValid;
}

bool OAIListHyperParameterTuningJobsRequest::isSet() const {
...
bool OAIListHyperParameterTuningJobsRequest::isValid() const {
