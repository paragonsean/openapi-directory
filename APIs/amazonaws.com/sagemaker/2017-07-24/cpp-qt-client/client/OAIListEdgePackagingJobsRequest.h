...
/*
 * OAIListEdgePackagingJobsRequest.h
 *
 * 
 */

#ifndef OAIListEdgePackagingJobsRequest_H
#define OAIListEdgePackagingJobsRequest_H
...
class OAIListEdgePackagingJobsRequest : public OAIObject {
public:
    OAIListEdgePackagingJobsRequest();
    OAIListEdgePackagingJobsRequest(QString json);
    ~OAIListEdgePackagingJobsRequest() override;
    ...
    QString getModelNameContains() const;
    void setModelNameContains(const QString &model_name_contains);
    bool is_model_name_contains_Set() const;
    bool is_model_name_contains_Valid() const;

    OAIEdgePackagingJobStatus getStatusEquals() const;
    void setStatusEquals(const OAIEdgePackagingJobStatus &status_equals);
    bool is_status_equals_Set() const;
    bool is_status_equals_Valid() const;

    OAIListEdgePackagingJobsSortBy getSortBy() const;
    void setSortBy(const OAIListEdgePackagingJobsSortBy &sort_by);
...
private:
    ...
    QString m_model_name_contains;
    bool m_model_name_contains_isSet;
    bool m_model_name_contains_isValid;

    OAIEdgePackagingJobStatus m_status_equals;
    bool m_status_equals_isSet;
    bool m_status_equals_isValid;

    OAIListEdgePackagingJobsSortBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEdgePackagingJobsRequest)

#endif // OAIListEdgePackagingJobsRequest_H
