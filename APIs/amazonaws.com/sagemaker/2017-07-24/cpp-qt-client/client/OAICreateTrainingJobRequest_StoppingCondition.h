...
/*
 * OAICreateTrainingJobRequest_StoppingCondition.h
 *
 * 
 */

#ifndef OAICreateTrainingJobRequest_StoppingCondition_H
#define OAICreateTrainingJobRequest_StoppingCondition_H
...
class OAICreateTrainingJobRequest_StoppingCondition : public OAIObject {
public:
    OAICreateTrainingJobRequest_StoppingCondition();
    OAICreateTrainingJobRequest_StoppingCondition(QString json);
    ~OAICreateTrainingJobRequest_StoppingCondition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTrainingJobRequest_StoppingCondition)

#endif // OAICreateTrainingJobRequest_StoppingCondition_H
