...
#ifndef OAIProfilerConfig_H
#define OAIProfilerConfig_H
...
class OAIProfilerConfig : public OAIObject {
public:
    OAIProfilerConfig();
    OAIProfilerConfig(QString json);
    ~OAIProfilerConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProfilerConfig)

#endif // OAIProfilerConfig_H
