...
#ifndef OAIOidcConfig_H
#define OAIOidcConfig_H
...
class OAIOidcConfig : public OAIObject {
public:
    OAIOidcConfig();
    OAIOidcConfig(QString json);
    ~OAIOidcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOidcConfig)

#endif // OAIOidcConfig_H
