...
/*
 * OAIAutoMLOutputDataConfig.h
 *
 * The output data configuration.
 */

#ifndef OAIAutoMLOutputDataConfig_H
#define OAIAutoMLOutputDataConfig_H
...
class OAIAutoMLOutputDataConfig : public OAIObject {
public:
    OAIAutoMLOutputDataConfig();
    OAIAutoMLOutputDataConfig(QString json);
    ~OAIAutoMLOutputDataConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoMLOutputDataConfig)

#endif // OAIAutoMLOutputDataConfig_H
