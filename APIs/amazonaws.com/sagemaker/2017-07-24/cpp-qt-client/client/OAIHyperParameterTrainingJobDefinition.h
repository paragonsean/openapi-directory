...
/*
 * OAIHyperParameterTrainingJobDefinition.h
 *
 * Defines the training jobs launched by a hyperparameter tuning job.
 */

#ifndef OAIHyperParameterTrainingJobDefinition_H
#define OAIHyperParameterTrainingJobDefinition_H
...
class OAIHyperParameterTrainingJobDefinition : public OAIObject {
public:
    OAIHyperParameterTrainingJobDefinition();
    OAIHyperParameterTrainingJobDefinition(QString json);
    ~OAIHyperParameterTrainingJobDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHyperParameterTrainingJobDefinition)

#endif // OAIHyperParameterTrainingJobDefinition_H
