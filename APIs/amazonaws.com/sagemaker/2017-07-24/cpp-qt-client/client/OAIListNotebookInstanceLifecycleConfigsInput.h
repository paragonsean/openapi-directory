...
/*
 * OAIListNotebookInstanceLifecycleConfigsInput.h
 *
 * 
 */

#ifndef OAIListNotebookInstanceLifecycleConfigsInput_H
#define OAIListNotebookInstanceLifecycleConfigsInput_H
...
class OAIListNotebookInstanceLifecycleConfigsInput : public OAIObject {
public:
    OAIListNotebookInstanceLifecycleConfigsInput();
    OAIListNotebookInstanceLifecycleConfigsInput(QString json);
    ~OAIListNotebookInstanceLifecycleConfigsInput() override;
    ...
    OAINotebookInstanceLifecycleConfigSortKey getSortBy() const;
    void setSortBy(const OAINotebookInstanceLifecycleConfigSortKey &sort_by);
    bool is_sort_by_Set() const;
    bool is_sort_by_Valid() const;

    OAINotebookInstanceLifecycleConfigSortOrder getSortOrder() const;
    void setSortOrder(const OAINotebookInstanceLifecycleConfigSortOrder &sort_order);
...
private:
    ...
    OAINotebookInstanceLifecycleConfigSortKey m_sort_by;
    bool m_sort_by_isSet;
    bool m_sort_by_isValid;

    OAINotebookInstanceLifecycleConfigSortOrder m_sort_order;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListNotebookInstanceLifecycleConfigsInput)

#endif // OAIListNotebookInstanceLifecycleConfigsInput_H
