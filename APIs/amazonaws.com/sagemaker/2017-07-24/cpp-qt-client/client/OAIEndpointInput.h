...
#ifndef OAIEndpointInput_H
#define OAIEndpointInput_H
...
class OAIEndpointInput : public OAIObject {
public:
    OAIEndpointInput();
    OAIEndpointInput(QString json);
    ~OAIEndpointInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointInput)

#endif // OAIEndpointInput_H
