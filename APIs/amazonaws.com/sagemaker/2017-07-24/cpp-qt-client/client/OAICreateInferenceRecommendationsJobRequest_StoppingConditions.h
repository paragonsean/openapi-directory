...
/*
 * OAICreateInferenceRecommendationsJobRequest_StoppingConditions.h
 *
 * 
 */

#ifndef OAICreateInferenceRecommendationsJobRequest_StoppingConditions_H
#define OAICreateInferenceRecommendationsJobRequest_StoppingConditions_H
...
class OAICreateInferenceRecommendationsJobRequest_StoppingConditions : public OAIObject {
public:
    OAICreateInferenceRecommendationsJobRequest_StoppingConditions();
    OAICreateInferenceRecommendationsJobRequest_StoppingConditions(QString json);
    ~OAICreateInferenceRecommendationsJobRequest_StoppingConditions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateInferenceRecommendationsJobRequest_StoppingConditions)

#endif // OAICreateInferenceRecommendationsJobRequest_StoppingConditions_H
