...
OAILabelingJobSummary_LabelCounters::OAILabelingJobSummary_LabelCounters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILabelingJobSummary_LabelCounters::OAILabelingJobSummary_LabelCounters() {
    this->initializeModel();
}

OAILabelingJobSummary_LabelCounters::~OAILabelingJobSummary_LabelCounters() {}

void OAILabelingJobSummary_LabelCounters::initializeModel() {
...
void OAILabelingJobSummary_LabelCounters::fromJson(QString jsonString) {
...
void OAILabelingJobSummary_LabelCounters::fromJsonObject(QJsonObject json) {
...
QString OAILabelingJobSummary_LabelCounters::asJson() const {
...
QJsonObject OAILabelingJobSummary_LabelCounters::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAILabelingJobSummary_LabelCounters::getTotalLabeled() const {
    return m_total_labeled;
}
void OAILabelingJobSummary_LabelCounters::setTotalLabeled(const qint32 &total_labeled) {
    m_total_labeled = total_labeled;
    m_total_labeled_isSet = true;
}

bool OAILabelingJobSummary_LabelCounters::is_total_labeled_Set() const{
    return m_total_labeled_isSet;
}

bool OAILabelingJobSummary_LabelCounters::is_total_labeled_Valid() const{
    return m_total_labeled_isValid;
}

qint32 OAILabelingJobSummary_LabelCounters::getHumanLabeled() const {
    return m_human_labeled;
}
void OAILabelingJobSummary_LabelCounters::setHumanLabeled(const qint32 &human_labeled) {
    m_human_labeled = human_labeled;
    m_human_labeled_isSet = true;
}

bool OAILabelingJobSummary_LabelCounters::is_human_labeled_Set() const{
    return m_human_labeled_isSet;
}

bool OAILabelingJobSummary_LabelCounters::is_human_labeled_Valid() const{
    return m_human_labeled_isValid;
}

qint32 OAILabelingJobSummary_LabelCounters::getMachineLabeled() const {
    return m_machine_labeled;
}
void OAILabelingJobSummary_LabelCounters::setMachineLabeled(const qint32 &machine_labeled) {
    m_machine_labeled = machine_labeled;
    m_machine_labeled_isSet = true;
}

bool OAILabelingJobSummary_LabelCounters::is_machine_labeled_Set() const{
    return m_machine_labeled_isSet;
}

bool OAILabelingJobSummary_LabelCounters::is_machine_labeled_Valid() const{
    return m_machine_labeled_isValid;
}

qint32 OAILabelingJobSummary_LabelCounters::getFailedNonRetryableError() const {
    return m_failed_non_retryable_error;
}
void OAILabelingJobSummary_LabelCounters::setFailedNonRetryableError(const qint32 &failed_non_retryable_error) {
    m_failed_non_retryable_error = failed_non_retryable_error;
    m_failed_non_retryable_error_isSet = true;
}

bool OAILabelingJobSummary_LabelCounters::is_failed_non_retryable_error_Set() const{
    return m_failed_non_retryable_error_isSet;
}

bool OAILabelingJobSummary_LabelCounters::is_failed_non_retryable_error_Valid() const{
    return m_failed_non_retryable_error_isValid;
}

qint32 OAILabelingJobSummary_LabelCounters::getUnlabeled() const {
    return m_unlabeled;
}
void OAILabelingJobSummary_LabelCounters::setUnlabeled(const qint32 &unlabeled) {
    m_unlabeled = unlabeled;
    m_unlabeled_isSet = true;
}

bool OAILabelingJobSummary_LabelCounters::is_unlabeled_Set() const{
    return m_unlabeled_isSet;
}

bool OAILabelingJobSummary_LabelCounters::is_unlabeled_Valid() const{
    return m_unlabeled_isValid;
}

bool OAILabelingJobSummary_LabelCounters::isSet() const {
...
bool OAILabelingJobSummary_LabelCounters::isValid() const {
