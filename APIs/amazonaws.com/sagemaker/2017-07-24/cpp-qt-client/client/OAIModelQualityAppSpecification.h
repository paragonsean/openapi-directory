...
/*
 * OAIModelQualityAppSpecification.h
 *
 * Container image configuration object for the monitoring job.
 */

#ifndef OAIModelQualityAppSpecification_H
#define OAIModelQualityAppSpecification_H
...
class OAIModelQualityAppSpecification : public OAIObject {
public:
    OAIModelQualityAppSpecification();
    OAIModelQualityAppSpecification(QString json);
    ~OAIModelQualityAppSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelQualityAppSpecification)

#endif // OAIModelQualityAppSpecification_H
