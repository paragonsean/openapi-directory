...
QString OAIIntegerParameterRange::getMinValue() const {
    return m_min_value;
}
void OAIIntegerParameterRange::setMinValue(const QString &min_value) {
...
QString OAIIntegerParameterRange::getMaxValue() const {
    return m_max_value;
}
void OAIIntegerParameterRange::setMaxValue(const QString &max_value) {
...
OAIHyperParameterScalingType OAIIntegerParameterRange::getScalingType() const {
    return m_scaling_type;
}
void OAIIntegerParameterRange::setScalingType(const OAIHyperParameterScalingType &scaling_type) {
