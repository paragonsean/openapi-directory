...
/*
 * OAIDeleteEdgeDeploymentStageRequest.h
 *
 * 
 */

#ifndef OAIDeleteEdgeDeploymentStageRequest_H
#define OAIDeleteEdgeDeploymentStageRequest_H
...
class OAIDeleteEdgeDeploymentStageRequest : public OAIObject {
public:
    OAIDeleteEdgeDeploymentStageRequest();
    OAIDeleteEdgeDeploymentStageRequest(QString json);
    ~OAIDeleteEdgeDeploymentStageRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEdgeDeploymentStageRequest)

#endif // OAIDeleteEdgeDeploymentStageRequest_H
