...
/*
 * OAIInferenceMetrics.h
 *
 * The metrics for an existing endpoint compared in an Inference Recommender job.
 */

#ifndef OAIInferenceMetrics_H
#define OAIInferenceMetrics_H
...
class OAIInferenceMetrics : public OAIObject {
public:
    OAIInferenceMetrics();
    OAIInferenceMetrics(QString json);
    ~OAIInferenceMetrics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInferenceMetrics)

#endif // OAIInferenceMetrics_H
