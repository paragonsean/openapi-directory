...
QString OAIHumanLoopConfig::getWorkteamArn() const {
    return m_workteam_arn;
}
void OAIHumanLoopConfig::setWorkteamArn(const QString &workteam_arn) {
    m_workteam_arn = workteam_arn;
    m_workteam_arn_isSet = true;
}

bool OAIHumanLoopConfig::is_workteam_arn_Set() const{
    return m_workteam_arn_isSet;
}

bool OAIHumanLoopConfig::is_workteam_arn_Valid() const{
    return m_workteam_arn_isValid;
}

QString OAIHumanLoopConfig::getHumanTaskUiArn() const {
    return m_human_task_ui_arn;
}
void OAIHumanLoopConfig::setHumanTaskUiArn(const QString &human_task_ui_arn) {
    m_human_task_ui_arn = human_task_ui_arn;
    m_human_task_ui_arn_isSet = true;
}

bool OAIHumanLoopConfig::is_human_task_ui_arn_Set() const{
    return m_human_task_ui_arn_isSet;
}

bool OAIHumanLoopConfig::is_human_task_ui_arn_Valid() const{
    return m_human_task_ui_arn_isValid;
}

QString OAIHumanLoopConfig::getTaskTitle() const {
    return m_task_title;
}
void OAIHumanLoopConfig::setTaskTitle(const QString &task_title) {
    m_task_title = task_title;
    m_task_title_isSet = true;
}

bool OAIHumanLoopConfig::is_task_title_Set() const{
    return m_task_title_isSet;
}

bool OAIHumanLoopConfig::is_task_title_Valid() const{
    return m_task_title_isValid;
}

QString OAIHumanLoopConfig::getTaskDescription() const {
    return m_task_description;
}
void OAIHumanLoopConfig::setTaskDescription(const QString &task_description) {
    m_task_description = task_description;
    m_task_description_isSet = true;
}

bool OAIHumanLoopConfig::is_task_description_Set() const{
    return m_task_description_isSet;
}

bool OAIHumanLoopConfig::is_task_description_Valid() const{
    return m_task_description_isValid;
}

qint32 OAIHumanLoopConfig::getTaskCount() const {
    return m_task_count;
}
void OAIHumanLoopConfig::setTaskCount(const qint32 &task_count) {
    m_task_count = task_count;
    m_task_count_isSet = true;
}

bool OAIHumanLoopConfig::is_task_count_Set() const{
    return m_task_count_isSet;
}

bool OAIHumanLoopConfig::is_task_count_Valid() const{
    return m_task_count_isValid;
}

qint32 OAIHumanLoopConfig::getTaskAvailabilityLifetimeInSeconds() const {
    return m_task_availability_lifetime_in_seconds;
}
void OAIHumanLoopConfig::setTaskAvailabilityLifetimeInSeconds(const qint32 &task_availability_lifetime_in_seconds) {
...
bool OAIHumanLoopConfig::is_task_availability_lifetime_in_seconds_Set() const{
    return m_task_availability_lifetime_in_seconds_isSet;
}

bool OAIHumanLoopConfig::is_task_availability_lifetime_in_seconds_Valid() const{
    return m_task_availability_lifetime_in_seconds_isValid;
}

qint32 OAIHumanLoopConfig::getTaskTimeLimitInSeconds() const {
    return m_task_time_limit_in_seconds;
}
void OAIHumanLoopConfig::setTaskTimeLimitInSeconds(const qint32 &task_time_limit_in_seconds) {
    m_task_time_limit_in_seconds = task_time_limit_in_seconds;
    m_task_time_limit_in_seconds_isSet = true;
}

bool OAIHumanLoopConfig::is_task_time_limit_in_seconds_Set() const{
    return m_task_time_limit_in_seconds_isSet;
}

bool OAIHumanLoopConfig::is_task_time_limit_in_seconds_Valid() const{
    return m_task_time_limit_in_seconds_isValid;
}

QList OAIHumanLoopConfig::getTaskKeywords() const {
    return m_task_keywords;
}
void OAIHumanLoopConfig::setTaskKeywords(const QList &task_keywords) {
    m_task_keywords = task_keywords;
    m_task_keywords_isSet = true;
}

bool OAIHumanLoopConfig::is_task_keywords_Set() const{
    return m_task_keywords_isSet;
}

bool OAIHumanLoopConfig::is_task_keywords_Valid() const{
    return m_task_keywords_isValid;
}

OAIPublicWorkforceTaskPrice OAIHumanLoopConfig::getPublicWorkforceTaskPrice() const {
    return m_public_workforce_task_price;
}
void OAIHumanLoopConfig::setPublicWorkforceTaskPrice(const OAIPublicWorkforceTaskPrice &public_workforce_task_price) {
    m_public_workforce_task_price = public_workforce_task_price;
    m_public_workforce_task_price_isSet = true;
}

bool OAIHumanLoopConfig::is_public_workforce_task_price_Set() const{
    return m_public_workforce_task_price_isSet;
}

bool OAIHumanLoopConfig::is_public_workforce_task_price_Valid() const{
