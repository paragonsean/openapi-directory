...
/*
 * OAIDescribeProcessingJobResponse_AppSpecification.h
 *
 * 
 */

#ifndef OAIDescribeProcessingJobResponse_AppSpecification_H
#define OAIDescribeProcessingJobResponse_AppSpecification_H
...
class OAIDescribeProcessingJobResponse_AppSpecification : public OAIObject {
public:
    OAIDescribeProcessingJobResponse_AppSpecification();
    OAIDescribeProcessingJobResponse_AppSpecification(QString json);
    ~OAIDescribeProcessingJobResponse_AppSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProcessingJobResponse_AppSpecification)

#endif // OAIDescribeProcessingJobResponse_AppSpecification_H
