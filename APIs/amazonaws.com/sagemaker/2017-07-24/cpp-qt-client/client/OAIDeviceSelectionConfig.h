...
/*
 * OAIDeviceSelectionConfig.h
 *
 * Contains information about the configurations of selected devices.
 */

#ifndef OAIDeviceSelectionConfig_H
#define OAIDeviceSelectionConfig_H
...
class OAIDeviceSelectionConfig : public OAIObject {
public:
    OAIDeviceSelectionConfig();
    OAIDeviceSelectionConfig(QString json);
    ~OAIDeviceSelectionConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeviceSelectionConfig)

#endif // OAIDeviceSelectionConfig_H
