...
/*
 * OAIDescribeLabelingJobResponse_StoppingConditions.h
 *
 * 
 */

#ifndef OAIDescribeLabelingJobResponse_StoppingConditions_H
#define OAIDescribeLabelingJobResponse_StoppingConditions_H
...
class OAIDescribeLabelingJobResponse_StoppingConditions : public OAIObject {
public:
    OAIDescribeLabelingJobResponse_StoppingConditions();
    OAIDescribeLabelingJobResponse_StoppingConditions(QString json);
    ~OAIDescribeLabelingJobResponse_StoppingConditions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLabelingJobResponse_StoppingConditions)

#endif // OAIDescribeLabelingJobResponse_StoppingConditions_H
