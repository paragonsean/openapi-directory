...
/*
 * OAIDescribeLabelingJobResponse_OutputConfig.h
 *
 * 
 */

#ifndef OAIDescribeLabelingJobResponse_OutputConfig_H
#define OAIDescribeLabelingJobResponse_OutputConfig_H
...
class OAIDescribeLabelingJobResponse_OutputConfig : public OAIObject {
public:
    OAIDescribeLabelingJobResponse_OutputConfig();
    OAIDescribeLabelingJobResponse_OutputConfig(QString json);
    ~OAIDescribeLabelingJobResponse_OutputConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLabelingJobResponse_OutputConfig)

#endif // OAIDescribeLabelingJobResponse_OutputConfig_H
