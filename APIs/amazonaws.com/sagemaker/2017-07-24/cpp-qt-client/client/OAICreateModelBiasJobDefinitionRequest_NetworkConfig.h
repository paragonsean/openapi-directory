...
/*
 * OAICreateModelBiasJobDefinitionRequest_NetworkConfig.h
 *
 * 
 */

#ifndef OAICreateModelBiasJobDefinitionRequest_NetworkConfig_H
#define OAICreateModelBiasJobDefinitionRequest_NetworkConfig_H
...
class OAICreateModelBiasJobDefinitionRequest_NetworkConfig : public OAIObject {
public:
    OAICreateModelBiasJobDefinitionRequest_NetworkConfig();
    OAICreateModelBiasJobDefinitionRequest_NetworkConfig(QString json);
    ~OAICreateModelBiasJobDefinitionRequest_NetworkConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateModelBiasJobDefinitionRequest_NetworkConfig)

#endif // OAICreateModelBiasJobDefinitionRequest_NetworkConfig_H
