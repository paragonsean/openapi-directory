...
OAIS3DataType OAIDataSource_S3DataSource::getS3DataType() const {
    return m_s3_data_type;
}
void OAIDataSource_S3DataSource::setS3DataType(const OAIS3DataType &s3_data_type) {
    m_s3_data_type = s3_data_type;
    m_s3_data_type_isSet = true;
}

bool OAIDataSource_S3DataSource::is_s3_data_type_Set() const{
    return m_s3_data_type_isSet;
}

bool OAIDataSource_S3DataSource::is_s3_data_type_Valid() const{
...
OAIS3DataDistribution OAIDataSource_S3DataSource::getS3DataDistributionType() const {
    return m_s3_data_distribution_type;
}
void OAIDataSource_S3DataSource::setS3DataDistributionType(const OAIS3DataDistribution &s3_data_distribution_type) {
    m_s3_data_distribution_type = s3_data_distribution_type;
    m_s3_data_distribution_type_isSet = true;
}

bool OAIDataSource_S3DataSource::is_s3_data_distribution_type_Set() const{
    return m_s3_data_distribution_type_isSet;
}

bool OAIDataSource_S3DataSource::is_s3_data_distribution_type_Valid() const{
    return m_s3_data_distribution_type_isValid;
}

QList OAIDataSource_S3DataSource::getAttributeNames() const {
    return m_attribute_names;
}
void OAIDataSource_S3DataSource::setAttributeNames(const QList &attribute_names) {
    m_attribute_names = attribute_names;
    m_attribute_names_isSet = true;
}

bool OAIDataSource_S3DataSource::is_attribute_names_Set() const{
    return m_attribute_names_isSet;
}

bool OAIDataSource_S3DataSource::is_attribute_names_Valid() const{
    return m_attribute_names_isValid;
}

QList OAIDataSource_S3DataSource::getInstanceGroupNames() const {
    return m_instance_group_names;
}
void OAIDataSource_S3DataSource::setInstanceGroupNames(const QList &instance_group_names) {
    m_instance_group_names = instance_group_names;
    m_instance_group_names_isSet = true;
}

bool OAIDataSource_S3DataSource::is_instance_group_names_Set() const{
    return m_instance_group_names_isSet;
}

bool OAIDataSource_S3DataSource::is_instance_group_names_Valid() const{
