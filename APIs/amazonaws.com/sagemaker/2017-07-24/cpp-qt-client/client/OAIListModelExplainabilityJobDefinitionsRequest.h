...
/*
 * OAIListModelExplainabilityJobDefinitionsRequest.h
 *
 * 
 */

#ifndef OAIListModelExplainabilityJobDefinitionsRequest_H
#define OAIListModelExplainabilityJobDefinitionsRequest_H
...
class OAIListModelExplainabilityJobDefinitionsRequest : public OAIObject {
public:
    OAIListModelExplainabilityJobDefinitionsRequest();
    OAIListModelExplainabilityJobDefinitionsRequest(QString json);
    ~OAIListModelExplainabilityJobDefinitionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListModelExplainabilityJobDefinitionsRequest)

#endif // OAIListModelExplainabilityJobDefinitionsRequest_H
