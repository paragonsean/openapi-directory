...
/*
 * OAIMonitoringResources_ClusterConfig.h
 *
 * 
 */

#ifndef OAIMonitoringResources_ClusterConfig_H
#define OAIMonitoringResources_ClusterConfig_H
...
class OAIMonitoringResources_ClusterConfig : public OAIObject {
public:
    OAIMonitoringResources_ClusterConfig();
    OAIMonitoringResources_ClusterConfig(QString json);
    ~OAIMonitoringResources_ClusterConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitoringResources_ClusterConfig)

#endif // OAIMonitoringResources_ClusterConfig_H
