...
/*
 * OAIGetScalingConfigurationRecommendationRequest.h
 *
 * 
 */

#ifndef OAIGetScalingConfigurationRecommendationRequest_H
#define OAIGetScalingConfigurationRecommendationRequest_H
...
namespace OpenAPI {
class OAIGetScalingConfigurationRecommendationRequest_ScalingPolicyObjective;

class OAIGetScalingConfigurationRecommendationRequest : public OAIObject {
public:
    OAIGetScalingConfigurationRecommendationRequest();
    OAIGetScalingConfigurationRecommendationRequest(QString json);
    ~OAIGetScalingConfigurationRecommendationRequest() override;
    ...
    OAIGetScalingConfigurationRecommendationRequest_ScalingPolicyObjective getScalingPolicyObjective() const;
    void setScalingPolicyObjective(const OAIGetScalingConfigurationRecommendationRequest_ScalingPolicyObjective &scaling_policy_objective);
...
private:
    ...
    OAIGetScalingConfigurationRecommendationRequest_ScalingPolicyObjective m_scaling_policy_objective;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetScalingConfigurationRecommendationRequest)

#endif // OAIGetScalingConfigurationRecommendationRequest_H
