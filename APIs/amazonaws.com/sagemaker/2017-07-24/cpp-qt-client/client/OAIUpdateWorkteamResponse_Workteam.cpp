...
#include "OAIUpdateWorkteamResponse_Workteam.h"
...
OAIUpdateWorkteamResponse_Workteam::OAIUpdateWorkteamResponse_Workteam(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateWorkteamResponse_Workteam::OAIUpdateWorkteamResponse_Workteam() {
    this->initializeModel();
}

OAIUpdateWorkteamResponse_Workteam::~OAIUpdateWorkteamResponse_Workteam() {}

void OAIUpdateWorkteamResponse_Workteam::initializeModel() {
...
void OAIUpdateWorkteamResponse_Workteam::fromJson(QString jsonString) {
...
void OAIUpdateWorkteamResponse_Workteam::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateWorkteamResponse_Workteam::asJson() const {
...
QJsonObject OAIUpdateWorkteamResponse_Workteam::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateWorkteamResponse_Workteam::getWorkteamName() const {
    return m_workteam_name;
}
void OAIUpdateWorkteamResponse_Workteam::setWorkteamName(const QString &workteam_name) {
    m_workteam_name = workteam_name;
    m_workteam_name_isSet = true;
}

bool OAIUpdateWorkteamResponse_Workteam::is_workteam_name_Set() const{
    return m_workteam_name_isSet;
}

bool OAIUpdateWorkteamResponse_Workteam::is_workteam_name_Valid() const{
    return m_workteam_name_isValid;
}

QList OAIUpdateWorkteamResponse_Workteam::getMemberDefinitions() const {
    return m_member_definitions;
}
void OAIUpdateWorkteamResponse_Workteam::setMemberDefinitions(const QList &member_definitions) {
    m_member_definitions = member_definitions;
    m_member_definitions_isSet = true;
}

bool OAIUpdateWorkteamResponse_Workteam::is_member_definitions_Set() const{
    return m_member_definitions_isSet;
}

bool OAIUpdateWorkteamResponse_Workteam::is_member_definitions_Valid() const{
    return m_member_definitions_isValid;
}

QString OAIUpdateWorkteamResponse_Workteam::getWorkteamArn() const {
    return m_workteam_arn;
}
void OAIUpdateWorkteamResponse_Workteam::setWorkteamArn(const QString &workteam_arn) {
    m_workteam_arn = workteam_arn;
    m_workteam_arn_isSet = true;
}

bool OAIUpdateWorkteamResponse_Workteam::is_workteam_arn_Set() const{
    return m_workteam_arn_isSet;
}

bool OAIUpdateWorkteamResponse_Workteam::is_workteam_arn_Valid() const{
    return m_workteam_arn_isValid;
}

QString OAIUpdateWorkteamResponse_Workteam::getWorkforceArn() const {
    return m_workforce_arn;
}
void OAIUpdateWorkteamResponse_Workteam::setWorkforceArn(const QString &workforce_arn) {
    m_workforce_arn = workforce_arn;
    m_workforce_arn_isSet = true;
}

bool OAIUpdateWorkteamResponse_Workteam::is_workforce_arn_Set() const{
    return m_workforce_arn_isSet;
}

bool OAIUpdateWorkteamResponse_Workteam::is_workforce_arn_Valid() const{
    return m_workforce_arn_isValid;
}

QList OAIUpdateWorkteamResponse_Workteam::getProductListingIds() const {
    return m_product_listing_ids;
}
void OAIUpdateWorkteamResponse_Workteam::setProductListingIds(const QList &product_listing_ids) {
    m_product_listing_ids = product_listing_ids;
    m_product_listing_ids_isSet = true;
}

bool OAIUpdateWorkteamResponse_Workteam::is_product_listing_ids_Set() const{
    return m_product_listing_ids_isSet;
}

bool OAIUpdateWorkteamResponse_Workteam::is_product_listing_ids_Valid() const{
    return m_product_listing_ids_isValid;
}

QString OAIUpdateWorkteamResponse_Workteam::getDescription() const {
    return m_description;
}
void OAIUpdateWorkteamResponse_Workteam::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateWorkteamResponse_Workteam::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateWorkteamResponse_Workteam::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateWorkteamResponse_Workteam::getSubDomain() const {
    return m_sub_domain;
}
void OAIUpdateWorkteamResponse_Workteam::setSubDomain(const QString &sub_domain) {
    m_sub_domain = sub_domain;
    m_sub_domain_isSet = true;
}

bool OAIUpdateWorkteamResponse_Workteam::is_sub_domain_Set() const{
    return m_sub_domain_isSet;
}

bool OAIUpdateWorkteamResponse_Workteam::is_sub_domain_Valid() const{
    return m_sub_domain_isValid;
}

QDateTime OAIUpdateWorkteamResponse_Workteam::getCreateDate() const {
    return m_create_date;
}
void OAIUpdateWorkteamResponse_Workteam::setCreateDate(const QDateTime &create_date) {
    m_create_date = create_date;
    m_create_date_isSet = true;
}

bool OAIUpdateWorkteamResponse_Workteam::is_create_date_Set() const{
    return m_create_date_isSet;
}

bool OAIUpdateWorkteamResponse_Workteam::is_create_date_Valid() const{
    return m_create_date_isValid;
}

QDateTime OAIUpdateWorkteamResponse_Workteam::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAIUpdateWorkteamResponse_Workteam::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAIUpdateWorkteamResponse_Workteam::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAIUpdateWorkteamResponse_Workteam::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

OAIWorkteam_NotificationConfiguration OAIUpdateWorkteamResponse_Workteam::getNotificationConfiguration() const {
    return m_notification_configuration;
}
void OAIUpdateWorkteamResponse_Workteam::setNotificationConfiguration(const OAIWorkteam_NotificationConfiguration &notification_configuration) {
    m_notification_configuration = notification_configuration;
    m_notification_configuration_isSet = true;
}

bool OAIUpdateWorkteamResponse_Workteam::is_notification_configuration_Set() const{
    return m_notification_configuration_isSet;
}

bool OAIUpdateWorkteamResponse_Workteam::is_notification_configuration_Valid() const{
    return m_notification_configuration_isValid;
}

bool OAIUpdateWorkteamResponse_Workteam::isSet() const {
...
bool OAIUpdateWorkteamResponse_Workteam::isValid() const {
