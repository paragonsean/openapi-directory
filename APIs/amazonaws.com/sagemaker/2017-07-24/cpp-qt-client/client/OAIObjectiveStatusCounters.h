...
/*
 * OAIObjectiveStatusCounters.h
 *
 * Specifies the number of training jobs that this hyperparameter tuning job launched, categorized by the status of their objective metric. The objective metric status shows whether the final objective metric for the training job has been evaluated by the tuning job and used in the hyperparameter tuning process.
 */

#ifndef OAIObjectiveStatusCounters_H
#define OAIObjectiveStatusCounters_H
...
class OAIObjectiveStatusCounters : public OAIObject {
public:
    OAIObjectiveStatusCounters();
    OAIObjectiveStatusCounters(QString json);
    ~OAIObjectiveStatusCounters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObjectiveStatusCounters)

#endif // OAIObjectiveStatusCounters_H
