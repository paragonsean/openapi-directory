...
/*
 * OAIListHubsRequest.h
 *
 * 
 */

#ifndef OAIListHubsRequest_H
#define OAIListHubsRequest_H
...
class OAIListHubsRequest : public OAIObject {
public:
    OAIListHubsRequest();
    OAIListHubsRequest(QString json);
    ~OAIListHubsRequest() override;
    ...
    OAIHubSortBy getSortBy() const;
    void setSortBy(const OAIHubSortBy &sort_by);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHubsRequest)

#endif // OAIListHubsRequest_H
