...
/*
 * OAIFlowDefinitionOutputConfig.h
 *
 * Contains information about where human output will be stored.
 */

#ifndef OAIFlowDefinitionOutputConfig_H
#define OAIFlowDefinitionOutputConfig_H
...
class OAIFlowDefinitionOutputConfig : public OAIObject {
public:
    OAIFlowDefinitionOutputConfig();
    OAIFlowDefinitionOutputConfig(QString json);
    ~OAIFlowDefinitionOutputConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlowDefinitionOutputConfig)

#endif // OAIFlowDefinitionOutputConfig_H
