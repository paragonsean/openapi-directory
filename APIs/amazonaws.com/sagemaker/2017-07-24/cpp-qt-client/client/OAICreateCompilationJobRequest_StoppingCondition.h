...
/*
 * OAICreateCompilationJobRequest_StoppingCondition.h
 *
 * 
 */

#ifndef OAICreateCompilationJobRequest_StoppingCondition_H
#define OAICreateCompilationJobRequest_StoppingCondition_H
...
class OAICreateCompilationJobRequest_StoppingCondition : public OAIObject {
public:
    OAICreateCompilationJobRequest_StoppingCondition();
    OAICreateCompilationJobRequest_StoppingCondition(QString json);
    ~OAICreateCompilationJobRequest_StoppingCondition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCompilationJobRequest_StoppingCondition)

#endif // OAICreateCompilationJobRequest_StoppingCondition_H
