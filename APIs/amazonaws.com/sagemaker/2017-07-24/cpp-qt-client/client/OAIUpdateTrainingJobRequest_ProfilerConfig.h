...
/*
 * OAIUpdateTrainingJobRequest_ProfilerConfig.h
 *
 * 
 */

#ifndef OAIUpdateTrainingJobRequest_ProfilerConfig_H
#define OAIUpdateTrainingJobRequest_ProfilerConfig_H
...
class OAIUpdateTrainingJobRequest_ProfilerConfig : public OAIObject {
public:
    OAIUpdateTrainingJobRequest_ProfilerConfig();
    OAIUpdateTrainingJobRequest_ProfilerConfig(QString json);
    ~OAIUpdateTrainingJobRequest_ProfilerConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTrainingJobRequest_ProfilerConfig)

#endif // OAIUpdateTrainingJobRequest_ProfilerConfig_H
