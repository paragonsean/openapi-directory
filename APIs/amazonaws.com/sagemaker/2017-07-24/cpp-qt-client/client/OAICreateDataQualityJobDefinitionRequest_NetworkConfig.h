...
/*
 * OAICreateDataQualityJobDefinitionRequest_NetworkConfig.h
 *
 * 
 */

#ifndef OAICreateDataQualityJobDefinitionRequest_NetworkConfig_H
#define OAICreateDataQualityJobDefinitionRequest_NetworkConfig_H
...
class OAICreateDataQualityJobDefinitionRequest_NetworkConfig : public OAIObject {
public:
    OAICreateDataQualityJobDefinitionRequest_NetworkConfig();
    OAICreateDataQualityJobDefinitionRequest_NetworkConfig(QString json);
    ~OAICreateDataQualityJobDefinitionRequest_NetworkConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDataQualityJobDefinitionRequest_NetworkConfig)

#endif // OAICreateDataQualityJobDefinitionRequest_NetworkConfig_H
