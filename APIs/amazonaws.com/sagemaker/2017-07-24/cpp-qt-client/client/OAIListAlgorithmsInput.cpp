...
OAIListAlgorithmsInput::OAIListAlgorithmsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAlgorithmsInput::OAIListAlgorithmsInput() {
    this->initializeModel();
}

OAIListAlgorithmsInput::~OAIListAlgorithmsInput() {}

void OAIListAlgorithmsInput::initializeModel() {
...
void OAIListAlgorithmsInput::fromJson(QString jsonString) {
...
void OAIListAlgorithmsInput::fromJsonObject(QJsonObject json) {
...
QString OAIListAlgorithmsInput::asJson() const {
...
QJsonObject OAIListAlgorithmsInput::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIListAlgorithmsInput::getCreationTimeAfter() const {
    return m_creation_time_after;
}
void OAIListAlgorithmsInput::setCreationTimeAfter(const QDateTime &creation_time_after) {
    m_creation_time_after = creation_time_after;
    m_creation_time_after_isSet = true;
}

bool OAIListAlgorithmsInput::is_creation_time_after_Set() const{
    return m_creation_time_after_isSet;
}

bool OAIListAlgorithmsInput::is_creation_time_after_Valid() const{
    return m_creation_time_after_isValid;
}

QDateTime OAIListAlgorithmsInput::getCreationTimeBefore() const {
    return m_creation_time_before;
}
void OAIListAlgorithmsInput::setCreationTimeBefore(const QDateTime &creation_time_before) {
    m_creation_time_before = creation_time_before;
    m_creation_time_before_isSet = true;
}

bool OAIListAlgorithmsInput::is_creation_time_before_Set() const{
    return m_creation_time_before_isSet;
}

bool OAIListAlgorithmsInput::is_creation_time_before_Valid() const{
    return m_creation_time_before_isValid;
}

qint32 OAIListAlgorithmsInput::getMaxResults() const {
    return m_max_results;
}
void OAIListAlgorithmsInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListAlgorithmsInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListAlgorithmsInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListAlgorithmsInput::getNameContains() const {
    return m_name_contains;
}
void OAIListAlgorithmsInput::setNameContains(const QString &name_contains) {
    m_name_contains = name_contains;
    m_name_contains_isSet = true;
}

bool OAIListAlgorithmsInput::is_name_contains_Set() const{
    return m_name_contains_isSet;
}

bool OAIListAlgorithmsInput::is_name_contains_Valid() const{
    return m_name_contains_isValid;
}

QString OAIListAlgorithmsInput::getNextToken() const {
    return m_next_token;
}
void OAIListAlgorithmsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAlgorithmsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAlgorithmsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

OAIAlgorithmSortBy OAIListAlgorithmsInput::getSortBy() const {
    return m_sort_by;
}
void OAIListAlgorithmsInput::setSortBy(const OAIAlgorithmSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIListAlgorithmsInput::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIListAlgorithmsInput::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAISortOrder OAIListAlgorithmsInput::getSortOrder() const {
    return m_sort_order;
}
void OAIListAlgorithmsInput::setSortOrder(const OAISortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIListAlgorithmsInput::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIListAlgorithmsInput::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

bool OAIListAlgorithmsInput::isSet() const {
...
bool OAIListAlgorithmsInput::isValid() const {
