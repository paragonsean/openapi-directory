...
#include "OAIAsyncInferenceNotificationConfig.h"
...
OAIAsyncInferenceNotificationConfig::OAIAsyncInferenceNotificationConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAsyncInferenceNotificationConfig::OAIAsyncInferenceNotificationConfig() {
    this->initializeModel();
}

OAIAsyncInferenceNotificationConfig::~OAIAsyncInferenceNotificationConfig() {}

void OAIAsyncInferenceNotificationConfig::initializeModel() {
...
void OAIAsyncInferenceNotificationConfig::fromJson(QString jsonString) {
...
void OAIAsyncInferenceNotificationConfig::fromJsonObject(QJsonObject json) {
...
QString OAIAsyncInferenceNotificationConfig::asJson() const {
...
QJsonObject OAIAsyncInferenceNotificationConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAsyncInferenceNotificationConfig::getSuccessTopic() const {
    return m_success_topic;
}
void OAIAsyncInferenceNotificationConfig::setSuccessTopic(const QString &success_topic) {
    m_success_topic = success_topic;
    m_success_topic_isSet = true;
}

bool OAIAsyncInferenceNotificationConfig::is_success_topic_Set() const{
    return m_success_topic_isSet;
}

bool OAIAsyncInferenceNotificationConfig::is_success_topic_Valid() const{
    return m_success_topic_isValid;
}

QString OAIAsyncInferenceNotificationConfig::getErrorTopic() const {
    return m_error_topic;
}
void OAIAsyncInferenceNotificationConfig::setErrorTopic(const QString &error_topic) {
    m_error_topic = error_topic;
    m_error_topic_isSet = true;
}

bool OAIAsyncInferenceNotificationConfig::is_error_topic_Set() const{
    return m_error_topic_isSet;
}

bool OAIAsyncInferenceNotificationConfig::is_error_topic_Valid() const{
    return m_error_topic_isValid;
}

QList OAIAsyncInferenceNotificationConfig::getIncludeInferenceResponseIn() const {
    return m_include_inference_response_in;
}
void OAIAsyncInferenceNotificationConfig::setIncludeInferenceResponseIn(const QList &include_inference_response_in) {
    m_include_inference_response_in = include_inference_response_in;
    m_include_inference_response_in_isSet = true;
}

bool OAIAsyncInferenceNotificationConfig::is_include_inference_response_in_Set() const{
    return m_include_inference_response_in_isSet;
}

bool OAIAsyncInferenceNotificationConfig::is_include_inference_response_in_Valid() const{
    return m_include_inference_response_in_isValid;
}

bool OAIAsyncInferenceNotificationConfig::isSet() const {
...
bool OAIAsyncInferenceNotificationConfig::isValid() const {
