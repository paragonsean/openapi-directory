...
/*
 * OAIDeleteHubContentRequest.h
 *
 * 
 */

#ifndef OAIDeleteHubContentRequest_H
#define OAIDeleteHubContentRequest_H
...
class OAIDeleteHubContentRequest : public OAIObject {
public:
    OAIDeleteHubContentRequest();
    OAIDeleteHubContentRequest(QString json);
    ~OAIDeleteHubContentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteHubContentRequest)

#endif // OAIDeleteHubContentRequest_H
