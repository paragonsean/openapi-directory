...
class OAITabularJobConfig : public OAIObject {
public:
    OAITabularJobConfig();
    OAITabularJobConfig(QString json);
    ~OAITabularJobConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITabularJobConfig)

#endif // OAITabularJobConfig_H
