...
/*
 * OAIOidcConfigForResponse.h
 *
 * Your OIDC IdP workforce configuration.
 */

#ifndef OAIOidcConfigForResponse_H
#define OAIOidcConfigForResponse_H
...
class OAIOidcConfigForResponse : public OAIObject {
public:
    OAIOidcConfigForResponse();
    OAIOidcConfigForResponse(QString json);
    ~OAIOidcConfigForResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOidcConfigForResponse)

#endif // OAIOidcConfigForResponse_H
