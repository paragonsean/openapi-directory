...
/*
 * OAITrainingJobStatusCounters.h
 *
 * The numbers of training jobs launched by a hyperparameter tuning job, categorized by status.
 */

#ifndef OAITrainingJobStatusCounters_H
#define OAITrainingJobStatusCounters_H
...
class OAITrainingJobStatusCounters : public OAIObject {
public:
    OAITrainingJobStatusCounters();
    OAITrainingJobStatusCounters(QString json);
    ~OAITrainingJobStatusCounters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingJobStatusCounters)

#endif // OAITrainingJobStatusCounters_H
