...
/*
 * OAITrialComponentSource.h
 *
 * The Amazon Resource Name (ARN) and job type of the source of a trial component.
 */

#ifndef OAITrialComponentSource_H
#define OAITrialComponentSource_H
...
class OAITrialComponentSource : public OAIObject {
public:
    OAITrialComponentSource();
    OAITrialComponentSource(QString json);
    ~OAITrialComponentSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrialComponentSource)

#endif // OAITrialComponentSource_H
