...
/*
 * OAIAddAssociationRequest.h
 *
 * 
 */

#ifndef OAIAddAssociationRequest_H
#define OAIAddAssociationRequest_H
...
class OAIAddAssociationRequest : public OAIObject {
public:
    OAIAddAssociationRequest();
    OAIAddAssociationRequest(QString json);
    ~OAIAddAssociationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddAssociationRequest)

#endif // OAIAddAssociationRequest_H
