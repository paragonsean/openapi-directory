...
/*
 * OAICreateFeatureGroupRequest_OfflineStoreConfig.h
 *
 * 
 */

#ifndef OAICreateFeatureGroupRequest_OfflineStoreConfig_H
#define OAICreateFeatureGroupRequest_OfflineStoreConfig_H
...
class OAICreateFeatureGroupRequest_OfflineStoreConfig : public OAIObject {
public:
    OAICreateFeatureGroupRequest_OfflineStoreConfig();
    OAICreateFeatureGroupRequest_OfflineStoreConfig(QString json);
    ~OAICreateFeatureGroupRequest_OfflineStoreConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFeatureGroupRequest_OfflineStoreConfig)

#endif // OAICreateFeatureGroupRequest_OfflineStoreConfig_H
