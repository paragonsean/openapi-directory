...
/*
 * OAIDescribeAutoMLJobV2Response_SecurityConfig.h
 *
 * 
 */

#ifndef OAIDescribeAutoMLJobV2Response_SecurityConfig_H
#define OAIDescribeAutoMLJobV2Response_SecurityConfig_H
...
class OAIDescribeAutoMLJobV2Response_SecurityConfig : public OAIObject {
public:
    OAIDescribeAutoMLJobV2Response_SecurityConfig();
    OAIDescribeAutoMLJobV2Response_SecurityConfig(QString json);
    ~OAIDescribeAutoMLJobV2Response_SecurityConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAutoMLJobV2Response_SecurityConfig)

#endif // OAIDescribeAutoMLJobV2Response_SecurityConfig_H
