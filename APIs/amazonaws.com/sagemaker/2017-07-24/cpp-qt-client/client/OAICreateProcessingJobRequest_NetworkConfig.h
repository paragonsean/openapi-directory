...
/*
 * OAICreateProcessingJobRequest_NetworkConfig.h
 *
 * 
 */

#ifndef OAICreateProcessingJobRequest_NetworkConfig_H
#define OAICreateProcessingJobRequest_NetworkConfig_H
...
class OAICreateProcessingJobRequest_NetworkConfig : public OAIObject {
public:
    OAICreateProcessingJobRequest_NetworkConfig();
    OAICreateProcessingJobRequest_NetworkConfig(QString json);
    ~OAICreateProcessingJobRequest_NetworkConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProcessingJobRequest_NetworkConfig)

#endif // OAICreateProcessingJobRequest_NetworkConfig_H
