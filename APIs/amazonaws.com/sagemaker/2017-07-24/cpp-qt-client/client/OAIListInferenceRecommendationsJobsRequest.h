...
/*
 * OAIListInferenceRecommendationsJobsRequest.h
 *
 * 
 */

#ifndef OAIListInferenceRecommendationsJobsRequest_H
#define OAIListInferenceRecommendationsJobsRequest_H
...
class OAIListInferenceRecommendationsJobsRequest : public OAIObject {
public:
    OAIListInferenceRecommendationsJobsRequest();
    OAIListInferenceRecommendationsJobsRequest(QString json);
    ~OAIListInferenceRecommendationsJobsRequest() override;
    ...
    OAIRecommendationJobStatus getStatusEquals() const;
    void setStatusEquals(const OAIRecommendationJobStatus &status_equals);
    bool is_status_equals_Set() const;
    bool is_status_equals_Valid() const;

    OAIListInferenceRecommendationsJobsSortBy getSortBy() const;
    void setSortBy(const OAIListInferenceRecommendationsJobsSortBy &sort_by);
    ...
    QString getModelNameEquals() const;
    void setModelNameEquals(const QString &model_name_equals);
    bool is_model_name_equals_Set() const;
    bool is_model_name_equals_Valid() const;

    QString getModelPackageVersionArnEquals() const;
    void setModelPackageVersionArnEquals(const QString &model_package_version_arn_equals);
    bool is_model_package_version_arn_equals_Set() const;
    bool is_model_package_version_arn_equals_Valid() const;
...
private:
    ...
    OAIRecommendationJobStatus m_status_equals;
    bool m_status_equals_isSet;
    bool m_status_equals_isValid;

    OAIListInferenceRecommendationsJobsSortBy m_sort_by;
    ...
    QString m_model_name_equals;
    bool m_model_name_equals_isSet;
    bool m_model_name_equals_isValid;

    QString m_model_package_version_arn_equals;
    bool m_model_package_version_arn_equals_isSet;
    bool m_model_package_version_arn_equals_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListInferenceRecommendationsJobsRequest)

#endif // OAIListInferenceRecommendationsJobsRequest_H
