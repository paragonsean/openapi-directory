...
/*
 * OAIListAlgorithmsInput.h
 *
 * 
 */

#ifndef OAIListAlgorithmsInput_H
#define OAIListAlgorithmsInput_H
...
class OAIListAlgorithmsInput : public OAIObject {
public:
    OAIListAlgorithmsInput();
    OAIListAlgorithmsInput(QString json);
    ~OAIListAlgorithmsInput() override;
    ...
    OAIAlgorithmSortBy getSortBy() const;
    void setSortBy(const OAIAlgorithmSortBy &sort_by);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAlgorithmsInput)

#endif // OAIListAlgorithmsInput_H
