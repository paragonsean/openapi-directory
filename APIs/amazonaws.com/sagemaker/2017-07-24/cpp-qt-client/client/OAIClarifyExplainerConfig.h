...
/*
 * OAIClarifyExplainerConfig.h
 *
 * The configuration parameters for the SageMaker Clarify explainer.
 */

#ifndef OAIClarifyExplainerConfig_H
#define OAIClarifyExplainerConfig_H
...
class OAIClarifyExplainerConfig : public OAIObject {
public:
    OAIClarifyExplainerConfig();
    OAIClarifyExplainerConfig(QString json);
    ~OAIClarifyExplainerConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClarifyExplainerConfig)

#endif // OAIClarifyExplainerConfig_H
