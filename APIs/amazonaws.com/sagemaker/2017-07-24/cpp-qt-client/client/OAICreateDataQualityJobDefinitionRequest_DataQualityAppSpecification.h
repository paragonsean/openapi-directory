...
/*
 * OAICreateDataQualityJobDefinitionRequest_DataQualityAppSpecification.h
 *
 * 
 */

#ifndef OAICreateDataQualityJobDefinitionRequest_DataQualityAppSpecification_H
#define OAICreateDataQualityJobDefinitionRequest_DataQualityAppSpecification_H
...
class OAICreateDataQualityJobDefinitionRequest_DataQualityAppSpecification : public OAIObject {
public:
    OAICreateDataQualityJobDefinitionRequest_DataQualityAppSpecification();
    OAICreateDataQualityJobDefinitionRequest_DataQualityAppSpecification(QString json);
    ~OAICreateDataQualityJobDefinitionRequest_DataQualityAppSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDataQualityJobDefinitionRequest_DataQualityAppSpecification)

#endif // OAICreateDataQualityJobDefinitionRequest_DataQualityAppSpecification_H
