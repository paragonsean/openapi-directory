...
OAIListTransformJobsRequest::OAIListTransformJobsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTransformJobsRequest::OAIListTransformJobsRequest() {
    this->initializeModel();
}

OAIListTransformJobsRequest::~OAIListTransformJobsRequest() {}

void OAIListTransformJobsRequest::initializeModel() {
...
void OAIListTransformJobsRequest::fromJson(QString jsonString) {
...
void OAIListTransformJobsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListTransformJobsRequest::asJson() const {
...
QJsonObject OAIListTransformJobsRequest::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIListTransformJobsRequest::getCreationTimeAfter() const {
    return m_creation_time_after;
}
void OAIListTransformJobsRequest::setCreationTimeAfter(const QDateTime &creation_time_after) {
    m_creation_time_after = creation_time_after;
    m_creation_time_after_isSet = true;
}

bool OAIListTransformJobsRequest::is_creation_time_after_Set() const{
    return m_creation_time_after_isSet;
}

bool OAIListTransformJobsRequest::is_creation_time_after_Valid() const{
    return m_creation_time_after_isValid;
}

QDateTime OAIListTransformJobsRequest::getCreationTimeBefore() const {
    return m_creation_time_before;
}
void OAIListTransformJobsRequest::setCreationTimeBefore(const QDateTime &creation_time_before) {
    m_creation_time_before = creation_time_before;
    m_creation_time_before_isSet = true;
}

bool OAIListTransformJobsRequest::is_creation_time_before_Set() const{
    return m_creation_time_before_isSet;
}

bool OAIListTransformJobsRequest::is_creation_time_before_Valid() const{
    return m_creation_time_before_isValid;
}

QDateTime OAIListTransformJobsRequest::getLastModifiedTimeAfter() const {
    return m_last_modified_time_after;
}
void OAIListTransformJobsRequest::setLastModifiedTimeAfter(const QDateTime &last_modified_time_after) {
    m_last_modified_time_after = last_modified_time_after;
    m_last_modified_time_after_isSet = true;
}

bool OAIListTransformJobsRequest::is_last_modified_time_after_Set() const{
    return m_last_modified_time_after_isSet;
}

bool OAIListTransformJobsRequest::is_last_modified_time_after_Valid() const{
    return m_last_modified_time_after_isValid;
}

QDateTime OAIListTransformJobsRequest::getLastModifiedTimeBefore() const {
    return m_last_modified_time_before;
}
void OAIListTransformJobsRequest::setLastModifiedTimeBefore(const QDateTime &last_modified_time_before) {
    m_last_modified_time_before = last_modified_time_before;
    m_last_modified_time_before_isSet = true;
}

bool OAIListTransformJobsRequest::is_last_modified_time_before_Set() const{
    return m_last_modified_time_before_isSet;
}

bool OAIListTransformJobsRequest::is_last_modified_time_before_Valid() const{
    return m_last_modified_time_before_isValid;
}

QString OAIListTransformJobsRequest::getNameContains() const {
    return m_name_contains;
}
void OAIListTransformJobsRequest::setNameContains(const QString &name_contains) {
    m_name_contains = name_contains;
    m_name_contains_isSet = true;
}

bool OAIListTransformJobsRequest::is_name_contains_Set() const{
    return m_name_contains_isSet;
}

bool OAIListTransformJobsRequest::is_name_contains_Valid() const{
    return m_name_contains_isValid;
}

OAITransformJobStatus OAIListTransformJobsRequest::getStatusEquals() const {
    return m_status_equals;
}
void OAIListTransformJobsRequest::setStatusEquals(const OAITransformJobStatus &status_equals) {
    m_status_equals = status_equals;
    m_status_equals_isSet = true;
}

bool OAIListTransformJobsRequest::is_status_equals_Set() const{
    return m_status_equals_isSet;
}

bool OAIListTransformJobsRequest::is_status_equals_Valid() const{
    return m_status_equals_isValid;
}

OAISortBy OAIListTransformJobsRequest::getSortBy() const {
    return m_sort_by;
}
void OAIListTransformJobsRequest::setSortBy(const OAISortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIListTransformJobsRequest::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIListTransformJobsRequest::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAISortOrder OAIListTransformJobsRequest::getSortOrder() const {
    return m_sort_order;
}
void OAIListTransformJobsRequest::setSortOrder(const OAISortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIListTransformJobsRequest::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIListTransformJobsRequest::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

QString OAIListTransformJobsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListTransformJobsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListTransformJobsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListTransformJobsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListTransformJobsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListTransformJobsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListTransformJobsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListTransformJobsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListTransformJobsRequest::isSet() const {
...
bool OAIListTransformJobsRequest::isValid() const {
