...
/*
 * OAICreateAlgorithmInput_TrainingSpecification.h
 *
 * 
 */

#ifndef OAICreateAlgorithmInput_TrainingSpecification_H
#define OAICreateAlgorithmInput_TrainingSpecification_H
...
class OAICreateAlgorithmInput_TrainingSpecification : public OAIObject {
public:
    OAICreateAlgorithmInput_TrainingSpecification();
    OAICreateAlgorithmInput_TrainingSpecification(QString json);
    ~OAICreateAlgorithmInput_TrainingSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAlgorithmInput_TrainingSpecification)

#endif // OAICreateAlgorithmInput_TrainingSpecification_H
