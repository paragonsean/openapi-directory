...
/*
 * OAIListAutoMLJobsRequest.h
 *
 * 
 */

#ifndef OAIListAutoMLJobsRequest_H
#define OAIListAutoMLJobsRequest_H
...
class OAIListAutoMLJobsRequest : public OAIObject {
public:
    OAIListAutoMLJobsRequest();
    OAIListAutoMLJobsRequest(QString json);
    ~OAIListAutoMLJobsRequest() override;
    ...
    OAIAutoMLJobStatus getStatusEquals() const;
    void setStatusEquals(const OAIAutoMLJobStatus &status_equals);
    ...
    OAIAutoMLSortBy getSortBy() const;
    void setSortBy(const OAIAutoMLSortBy &sort_by);
...
private:
    ...
    OAIAutoMLJobStatus m_status_equals;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAutoMLJobsRequest)

#endif // OAIListAutoMLJobsRequest_H
