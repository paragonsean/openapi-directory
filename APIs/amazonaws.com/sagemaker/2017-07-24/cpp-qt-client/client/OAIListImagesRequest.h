...
/*
 * OAIListImagesRequest.h
 *
 * 
 */

#ifndef OAIListImagesRequest_H
#define OAIListImagesRequest_H
...
class OAIListImagesRequest : public OAIObject {
public:
    OAIListImagesRequest();
    OAIListImagesRequest(QString json);
    ~OAIListImagesRequest() override;
    ...
    OAIImageSortBy getSortBy() const;
    void setSortBy(const OAIImageSortBy &sort_by);
    bool is_sort_by_Set() const;
    bool is_sort_by_Valid() const;

    OAIImageSortOrder getSortOrder() const;
    void setSortOrder(const OAIImageSortOrder &sort_order);
...
private:
    ...
    OAIImageSortBy m_sort_by;
    bool m_sort_by_isSet;
    bool m_sort_by_isValid;

    OAIImageSortOrder m_sort_order;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListImagesRequest)

#endif // OAIListImagesRequest_H
