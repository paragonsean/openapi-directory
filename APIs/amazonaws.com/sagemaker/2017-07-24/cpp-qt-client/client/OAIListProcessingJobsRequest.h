...
/*
 * OAIListProcessingJobsRequest.h
 *
 * 
 */

#ifndef OAIListProcessingJobsRequest_H
#define OAIListProcessingJobsRequest_H
...
class OAIListProcessingJobsRequest : public OAIObject {
public:
    OAIListProcessingJobsRequest();
    OAIListProcessingJobsRequest(QString json);
    ~OAIListProcessingJobsRequest() override;
    ...
    OAIProcessingJobStatus getStatusEquals() const;
    void setStatusEquals(const OAIProcessingJobStatus &status_equals);
...
private:
    ...
    OAIProcessingJobStatus m_status_equals;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListProcessingJobsRequest)

#endif // OAIListProcessingJobsRequest_H
