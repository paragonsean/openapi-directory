...
OAIClarifyExplainerConfig_InferenceConfig::OAIClarifyExplainerConfig_InferenceConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClarifyExplainerConfig_InferenceConfig::OAIClarifyExplainerConfig_InferenceConfig() {
    this->initializeModel();
}

OAIClarifyExplainerConfig_InferenceConfig::~OAIClarifyExplainerConfig_InferenceConfig() {}

void OAIClarifyExplainerConfig_InferenceConfig::initializeModel() {
...
void OAIClarifyExplainerConfig_InferenceConfig::fromJson(QString jsonString) {
...
void OAIClarifyExplainerConfig_InferenceConfig::fromJsonObject(QJsonObject json) {
...
QString OAIClarifyExplainerConfig_InferenceConfig::asJson() const {
...
QJsonObject OAIClarifyExplainerConfig_InferenceConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIClarifyExplainerConfig_InferenceConfig::getFeaturesAttribute() const {
    return m_features_attribute;
}
void OAIClarifyExplainerConfig_InferenceConfig::setFeaturesAttribute(const QString &features_attribute) {
    m_features_attribute = features_attribute;
    m_features_attribute_isSet = true;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_features_attribute_Set() const{
    return m_features_attribute_isSet;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_features_attribute_Valid() const{
    return m_features_attribute_isValid;
}

QString OAIClarifyExplainerConfig_InferenceConfig::getContentTemplate() const {
    return m_content_template;
}
void OAIClarifyExplainerConfig_InferenceConfig::setContentTemplate(const QString &content_template) {
    m_content_template = content_template;
    m_content_template_isSet = true;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_content_template_Set() const{
    return m_content_template_isSet;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_content_template_Valid() const{
    return m_content_template_isValid;
}

qint32 OAIClarifyExplainerConfig_InferenceConfig::getMaxRecordCount() const {
    return m_max_record_count;
}
void OAIClarifyExplainerConfig_InferenceConfig::setMaxRecordCount(const qint32 &max_record_count) {
    m_max_record_count = max_record_count;
    m_max_record_count_isSet = true;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_max_record_count_Set() const{
    return m_max_record_count_isSet;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_max_record_count_Valid() const{
    return m_max_record_count_isValid;
}

qint32 OAIClarifyExplainerConfig_InferenceConfig::getMaxPayloadInMb() const {
    return m_max_payload_in_mb;
}
void OAIClarifyExplainerConfig_InferenceConfig::setMaxPayloadInMb(const qint32 &max_payload_in_mb) {
    m_max_payload_in_mb = max_payload_in_mb;
    m_max_payload_in_mb_isSet = true;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_max_payload_in_mb_Set() const{
    return m_max_payload_in_mb_isSet;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_max_payload_in_mb_Valid() const{
    return m_max_payload_in_mb_isValid;
}

qint32 OAIClarifyExplainerConfig_InferenceConfig::getProbabilityIndex() const {
    return m_probability_index;
}
void OAIClarifyExplainerConfig_InferenceConfig::setProbabilityIndex(const qint32 &probability_index) {
    m_probability_index = probability_index;
    m_probability_index_isSet = true;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_probability_index_Set() const{
    return m_probability_index_isSet;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_probability_index_Valid() const{
    return m_probability_index_isValid;
}

qint32 OAIClarifyExplainerConfig_InferenceConfig::getLabelIndex() const {
    return m_label_index;
}
void OAIClarifyExplainerConfig_InferenceConfig::setLabelIndex(const qint32 &label_index) {
    m_label_index = label_index;
    m_label_index_isSet = true;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_label_index_Set() const{
    return m_label_index_isSet;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_label_index_Valid() const{
    return m_label_index_isValid;
}

QString OAIClarifyExplainerConfig_InferenceConfig::getProbabilityAttribute() const {
    return m_probability_attribute;
}
void OAIClarifyExplainerConfig_InferenceConfig::setProbabilityAttribute(const QString &probability_attribute) {
    m_probability_attribute = probability_attribute;
    m_probability_attribute_isSet = true;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_probability_attribute_Set() const{
    return m_probability_attribute_isSet;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_probability_attribute_Valid() const{
    return m_probability_attribute_isValid;
}

QString OAIClarifyExplainerConfig_InferenceConfig::getLabelAttribute() const {
    return m_label_attribute;
}
void OAIClarifyExplainerConfig_InferenceConfig::setLabelAttribute(const QString &label_attribute) {
    m_label_attribute = label_attribute;
    m_label_attribute_isSet = true;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_label_attribute_Set() const{
    return m_label_attribute_isSet;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_label_attribute_Valid() const{
    return m_label_attribute_isValid;
}

QList OAIClarifyExplainerConfig_InferenceConfig::getLabelHeaders() const {
    return m_label_headers;
}
void OAIClarifyExplainerConfig_InferenceConfig::setLabelHeaders(const QList &label_headers) {
    m_label_headers = label_headers;
    m_label_headers_isSet = true;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_label_headers_Set() const{
    return m_label_headers_isSet;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_label_headers_Valid() const{
    return m_label_headers_isValid;
}

QList OAIClarifyExplainerConfig_InferenceConfig::getFeatureHeaders() const {
    return m_feature_headers;
}
void OAIClarifyExplainerConfig_InferenceConfig::setFeatureHeaders(const QList &feature_headers) {
    m_feature_headers = feature_headers;
    m_feature_headers_isSet = true;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_feature_headers_Set() const{
    return m_feature_headers_isSet;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_feature_headers_Valid() const{
    return m_feature_headers_isValid;
}

QList OAIClarifyExplainerConfig_InferenceConfig::getFeatureTypes() const {
    return m_feature_types;
}
void OAIClarifyExplainerConfig_InferenceConfig::setFeatureTypes(const QList &feature_types) {
    m_feature_types = feature_types;
    m_feature_types_isSet = true;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_feature_types_Set() const{
    return m_feature_types_isSet;
}

bool OAIClarifyExplainerConfig_InferenceConfig::is_feature_types_Valid() const{
    return m_feature_types_isValid;
}

bool OAIClarifyExplainerConfig_InferenceConfig::isSet() const {
...
bool OAIClarifyExplainerConfig_InferenceConfig::isValid() const {
