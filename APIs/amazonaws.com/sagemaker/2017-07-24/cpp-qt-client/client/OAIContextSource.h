...
#ifndef OAIContextSource_H
#define OAIContextSource_H
...
class OAIContextSource : public OAIObject {
public:
    OAIContextSource();
    OAIContextSource(QString json);
    ~OAIContextSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContextSource)

#endif // OAIContextSource_H
