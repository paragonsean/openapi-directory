...
/*
 * OAITrainingJobDefinition_StoppingCondition.h
 *
 * 
 */

#ifndef OAITrainingJobDefinition_StoppingCondition_H
#define OAITrainingJobDefinition_StoppingCondition_H
...
class OAITrainingJobDefinition_StoppingCondition : public OAIObject {
public:
    OAITrainingJobDefinition_StoppingCondition();
    OAITrainingJobDefinition_StoppingCondition(QString json);
    ~OAITrainingJobDefinition_StoppingCondition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingJobDefinition_StoppingCondition)

#endif // OAITrainingJobDefinition_StoppingCondition_H
