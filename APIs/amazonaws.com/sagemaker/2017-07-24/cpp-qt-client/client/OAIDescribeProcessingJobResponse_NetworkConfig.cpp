...
OAIDescribeProcessingJobResponse_NetworkConfig::OAIDescribeProcessingJobResponse_NetworkConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeProcessingJobResponse_NetworkConfig::OAIDescribeProcessingJobResponse_NetworkConfig() {
    this->initializeModel();
}

OAIDescribeProcessingJobResponse_NetworkConfig::~OAIDescribeProcessingJobResponse_NetworkConfig() {}

void OAIDescribeProcessingJobResponse_NetworkConfig::initializeModel() {
...
void OAIDescribeProcessingJobResponse_NetworkConfig::fromJson(QString jsonString) {
...
void OAIDescribeProcessingJobResponse_NetworkConfig::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeProcessingJobResponse_NetworkConfig::asJson() const {
...
QJsonObject OAIDescribeProcessingJobResponse_NetworkConfig::asJsonObject() const {
    QJsonObject obj;
...
bool OAIDescribeProcessingJobResponse_NetworkConfig::getEnableInterContainerTrafficEncryption() const {
    return m_enable_inter_container_traffic_encryption;
}
void OAIDescribeProcessingJobResponse_NetworkConfig::setEnableInterContainerTrafficEncryption(const bool &enable_inter_container_traffic_encryption) {
...
bool OAIDescribeProcessingJobResponse_NetworkConfig::is_enable_inter_container_traffic_encryption_Set() const{
    return m_enable_inter_container_traffic_encryption_isSet;
}

bool OAIDescribeProcessingJobResponse_NetworkConfig::is_enable_inter_container_traffic_encryption_Valid() const{
    return m_enable_inter_container_traffic_encryption_isValid;
}

bool OAIDescribeProcessingJobResponse_NetworkConfig::getEnableNetworkIsolation() const {
    return m_enable_network_isolation;
}
void OAIDescribeProcessingJobResponse_NetworkConfig::setEnableNetworkIsolation(const bool &enable_network_isolation) {
    m_enable_network_isolation = enable_network_isolation;
    m_enable_network_isolation_isSet = true;
}

bool OAIDescribeProcessingJobResponse_NetworkConfig::is_enable_network_isolation_Set() const{
    return m_enable_network_isolation_isSet;
}

bool OAIDescribeProcessingJobResponse_NetworkConfig::is_enable_network_isolation_Valid() const{
    return m_enable_network_isolation_isValid;
}

OAIVpcConfig OAIDescribeProcessingJobResponse_NetworkConfig::getVpcConfig() const {
    return m_vpc_config;
}
void OAIDescribeProcessingJobResponse_NetworkConfig::setVpcConfig(const OAIVpcConfig &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAIDescribeProcessingJobResponse_NetworkConfig::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAIDescribeProcessingJobResponse_NetworkConfig::is_vpc_config_Valid() const{
    return m_vpc_config_isValid;
}

bool OAIDescribeProcessingJobResponse_NetworkConfig::isSet() const {
...
bool OAIDescribeProcessingJobResponse_NetworkConfig::isValid() const {
