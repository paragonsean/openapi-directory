...
/*
 * OAILabelingJobSummary_LabelCounters.h
 *
 * 
 */

#ifndef OAILabelingJobSummary_LabelCounters_H
#define OAILabelingJobSummary_LabelCounters_H
...
class OAILabelingJobSummary_LabelCounters : public OAIObject {
public:
    OAILabelingJobSummary_LabelCounters();
    OAILabelingJobSummary_LabelCounters(QString json);
    ~OAILabelingJobSummary_LabelCounters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILabelingJobSummary_LabelCounters)

#endif // OAILabelingJobSummary_LabelCounters_H
