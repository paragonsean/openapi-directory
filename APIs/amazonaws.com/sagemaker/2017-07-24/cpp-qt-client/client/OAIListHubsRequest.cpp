...
OAIListHubsRequest::OAIListHubsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListHubsRequest::OAIListHubsRequest() {
    this->initializeModel();
}

OAIListHubsRequest::~OAIListHubsRequest() {}

void OAIListHubsRequest::initializeModel() {
...
void OAIListHubsRequest::fromJson(QString jsonString) {
...
void OAIListHubsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListHubsRequest::asJson() const {
...
QJsonObject OAIListHubsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListHubsRequest::getNameContains() const {
    return m_name_contains;
}
void OAIListHubsRequest::setNameContains(const QString &name_contains) {
    m_name_contains = name_contains;
    m_name_contains_isSet = true;
}

bool OAIListHubsRequest::is_name_contains_Set() const{
    return m_name_contains_isSet;
}

bool OAIListHubsRequest::is_name_contains_Valid() const{
    return m_name_contains_isValid;
}

QDateTime OAIListHubsRequest::getCreationTimeBefore() const {
    return m_creation_time_before;
}
void OAIListHubsRequest::setCreationTimeBefore(const QDateTime &creation_time_before) {
    m_creation_time_before = creation_time_before;
    m_creation_time_before_isSet = true;
}

bool OAIListHubsRequest::is_creation_time_before_Set() const{
    return m_creation_time_before_isSet;
}

bool OAIListHubsRequest::is_creation_time_before_Valid() const{
    return m_creation_time_before_isValid;
}

QDateTime OAIListHubsRequest::getCreationTimeAfter() const {
    return m_creation_time_after;
}
void OAIListHubsRequest::setCreationTimeAfter(const QDateTime &creation_time_after) {
    m_creation_time_after = creation_time_after;
    m_creation_time_after_isSet = true;
}

bool OAIListHubsRequest::is_creation_time_after_Set() const{
    return m_creation_time_after_isSet;
}

bool OAIListHubsRequest::is_creation_time_after_Valid() const{
    return m_creation_time_after_isValid;
}

QDateTime OAIListHubsRequest::getLastModifiedTimeBefore() const {
    return m_last_modified_time_before;
}
void OAIListHubsRequest::setLastModifiedTimeBefore(const QDateTime &last_modified_time_before) {
    m_last_modified_time_before = last_modified_time_before;
    m_last_modified_time_before_isSet = true;
}

bool OAIListHubsRequest::is_last_modified_time_before_Set() const{
    return m_last_modified_time_before_isSet;
}

bool OAIListHubsRequest::is_last_modified_time_before_Valid() const{
    return m_last_modified_time_before_isValid;
}

QDateTime OAIListHubsRequest::getLastModifiedTimeAfter() const {
    return m_last_modified_time_after;
}
void OAIListHubsRequest::setLastModifiedTimeAfter(const QDateTime &last_modified_time_after) {
    m_last_modified_time_after = last_modified_time_after;
    m_last_modified_time_after_isSet = true;
}

bool OAIListHubsRequest::is_last_modified_time_after_Set() const{
    return m_last_modified_time_after_isSet;
}

bool OAIListHubsRequest::is_last_modified_time_after_Valid() const{
    return m_last_modified_time_after_isValid;
}

OAIHubSortBy OAIListHubsRequest::getSortBy() const {
    return m_sort_by;
}
void OAIListHubsRequest::setSortBy(const OAIHubSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIListHubsRequest::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIListHubsRequest::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAISortOrder OAIListHubsRequest::getSortOrder() const {
    return m_sort_order;
}
void OAIListHubsRequest::setSortOrder(const OAISortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIListHubsRequest::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIListHubsRequest::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

qint32 OAIListHubsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListHubsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListHubsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListHubsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListHubsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListHubsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListHubsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListHubsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListHubsRequest::isSet() const {
...
bool OAIListHubsRequest::isValid() const {
