...
/*
 * OAIRecommendationJobInferenceBenchmark.h
 *
 * The details for a specific benchmark from an Inference Recommender job.
 */

#ifndef OAIRecommendationJobInferenceBenchmark_H
#define OAIRecommendationJobInferenceBenchmark_H
...
class OAIRecommendationJobInferenceBenchmark : public OAIObject {
public:
    OAIRecommendationJobInferenceBenchmark();
    OAIRecommendationJobInferenceBenchmark(QString json);
    ~OAIRecommendationJobInferenceBenchmark() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecommendationJobInferenceBenchmark)

#endif // OAIRecommendationJobInferenceBenchmark_H
