...
QString OAIUserContext::getUserProfileArn() const {
    return m_user_profile_arn;
}
void OAIUserContext::setUserProfileArn(const QString &user_profile_arn) {
    m_user_profile_arn = user_profile_arn;
    m_user_profile_arn_isSet = true;
}

bool OAIUserContext::is_user_profile_arn_Set() const{
    return m_user_profile_arn_isSet;
}

bool OAIUserContext::is_user_profile_arn_Valid() const{
    return m_user_profile_arn_isValid;
}

QString OAIUserContext::getUserProfileName() const {
    return m_user_profile_name;
}
void OAIUserContext::setUserProfileName(const QString &user_profile_name) {
    m_user_profile_name = user_profile_name;
    m_user_profile_name_isSet = true;
}

bool OAIUserContext::is_user_profile_name_Set() const{
    return m_user_profile_name_isSet;
}

bool OAIUserContext::is_user_profile_name_Valid() const{
    return m_user_profile_name_isValid;
}

QString OAIUserContext::getDomainId() const {
    return m_domain_id;
}
void OAIUserContext::setDomainId(const QString &domain_id) {
    m_domain_id = domain_id;
    m_domain_id_isSet = true;
}

bool OAIUserContext::is_domain_id_Set() const{
    return m_domain_id_isSet;
}

bool OAIUserContext::is_domain_id_Valid() const{
    return m_domain_id_isValid;
}

OAIUserContext_IamIdentity OAIUserContext::getIamIdentity() const {
    return m_iam_identity;
}
void OAIUserContext::setIamIdentity(const OAIUserContext_IamIdentity &iam_identity) {
    m_iam_identity = iam_identity;
    m_iam_identity_isSet = true;
}

bool OAIUserContext::is_iam_identity_Set() const{
    return m_iam_identity_isSet;
}

bool OAIUserContext::is_iam_identity_Valid() const{
