...
/*
 * OAIListHumanTaskUisRequest.h
 *
 * 
 */

#ifndef OAIListHumanTaskUisRequest_H
#define OAIListHumanTaskUisRequest_H
...
class OAIListHumanTaskUisRequest : public OAIObject {
public:
    OAIListHumanTaskUisRequest();
    OAIListHumanTaskUisRequest(QString json);
    ~OAIListHumanTaskUisRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHumanTaskUisRequest)

#endif // OAIListHumanTaskUisRequest_H
