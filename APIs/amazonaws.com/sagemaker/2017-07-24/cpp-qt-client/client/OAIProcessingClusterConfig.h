...
/*
 * OAIProcessingClusterConfig.h
 *
 * Configuration for the cluster used to run a processing job.
 */

#ifndef OAIProcessingClusterConfig_H
#define OAIProcessingClusterConfig_H
...
class OAIProcessingClusterConfig : public OAIObject {
public:
    OAIProcessingClusterConfig();
    OAIProcessingClusterConfig(QString json);
    ~OAIProcessingClusterConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProcessingClusterConfig)

#endif // OAIProcessingClusterConfig_H
