...
/*
 * OAICreateLabelingJobRequest_OutputConfig.h
 *
 * 
 */

#ifndef OAICreateLabelingJobRequest_OutputConfig_H
#define OAICreateLabelingJobRequest_OutputConfig_H
...
class OAICreateLabelingJobRequest_OutputConfig : public OAIObject {
public:
    OAICreateLabelingJobRequest_OutputConfig();
    OAICreateLabelingJobRequest_OutputConfig(QString json);
    ~OAICreateLabelingJobRequest_OutputConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLabelingJobRequest_OutputConfig)

#endif // OAICreateLabelingJobRequest_OutputConfig_H
