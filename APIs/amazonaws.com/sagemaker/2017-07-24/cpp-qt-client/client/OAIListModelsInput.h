...
/*
 * OAIListModelsInput.h
 *
 * 
 */

#ifndef OAIListModelsInput_H
#define OAIListModelsInput_H
...
class OAIListModelsInput : public OAIObject {
public:
    OAIListModelsInput();
    OAIListModelsInput(QString json);
    ~OAIListModelsInput() override;
    ...
    OAIModelSortKey getSortBy() const;
    void setSortBy(const OAIModelSortKey &sort_by);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListModelsInput)

#endif // OAIListModelsInput_H
