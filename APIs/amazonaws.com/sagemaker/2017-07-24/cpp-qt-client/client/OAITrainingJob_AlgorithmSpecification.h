...
/*
 * OAITrainingJob_AlgorithmSpecification.h
 *
 * 
 */

#ifndef OAITrainingJob_AlgorithmSpecification_H
#define OAITrainingJob_AlgorithmSpecification_H
...
class OAITrainingJob_AlgorithmSpecification : public OAIObject {
public:
    OAITrainingJob_AlgorithmSpecification();
    OAITrainingJob_AlgorithmSpecification(QString json);
    ~OAITrainingJob_AlgorithmSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingJob_AlgorithmSpecification)

#endif // OAITrainingJob_AlgorithmSpecification_H
