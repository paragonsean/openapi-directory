...
#ifndef OAIListTagsInput_H
#define OAIListTagsInput_H
...
class OAIListTagsInput : public OAIObject {
public:
    OAIListTagsInput();
    OAIListTagsInput(QString json);
    ~OAIListTagsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTagsInput)

#endif // OAIListTagsInput_H
