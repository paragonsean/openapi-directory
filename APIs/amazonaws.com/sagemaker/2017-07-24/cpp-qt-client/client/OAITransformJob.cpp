...
OAITransformJob::OAITransformJob(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransformJob::OAITransformJob() {
    this->initializeModel();
}

OAITransformJob::~OAITransformJob() {}

void OAITransformJob::initializeModel() {
...
void OAITransformJob::fromJson(QString jsonString) {
...
void OAITransformJob::fromJsonObject(QJsonObject json) {
...
QString OAITransformJob::asJson() const {
...
QJsonObject OAITransformJob::asJsonObject() const {
    QJsonObject obj;
...
QString OAITransformJob::getTransformJobName() const {
    return m_transform_job_name;
}
void OAITransformJob::setTransformJobName(const QString &transform_job_name) {
    m_transform_job_name = transform_job_name;
    m_transform_job_name_isSet = true;
}

bool OAITransformJob::is_transform_job_name_Set() const{
    return m_transform_job_name_isSet;
}

bool OAITransformJob::is_transform_job_name_Valid() const{
    return m_transform_job_name_isValid;
}

QString OAITransformJob::getTransformJobArn() const {
    return m_transform_job_arn;
}
void OAITransformJob::setTransformJobArn(const QString &transform_job_arn) {
    m_transform_job_arn = transform_job_arn;
    m_transform_job_arn_isSet = true;
}

bool OAITransformJob::is_transform_job_arn_Set() const{
    return m_transform_job_arn_isSet;
}

bool OAITransformJob::is_transform_job_arn_Valid() const{
    return m_transform_job_arn_isValid;
}

OAITransformJobStatus OAITransformJob::getTransformJobStatus() const {
    return m_transform_job_status;
}
void OAITransformJob::setTransformJobStatus(const OAITransformJobStatus &transform_job_status) {
    m_transform_job_status = transform_job_status;
    m_transform_job_status_isSet = true;
}

bool OAITransformJob::is_transform_job_status_Set() const{
    return m_transform_job_status_isSet;
}

bool OAITransformJob::is_transform_job_status_Valid() const{
    return m_transform_job_status_isValid;
}

QString OAITransformJob::getFailureReason() const {
    return m_failure_reason;
}
void OAITransformJob::setFailureReason(const QString &failure_reason) {
    m_failure_reason = failure_reason;
    m_failure_reason_isSet = true;
}

bool OAITransformJob::is_failure_reason_Set() const{
    return m_failure_reason_isSet;
}

bool OAITransformJob::is_failure_reason_Valid() const{
    return m_failure_reason_isValid;
}

QString OAITransformJob::getModelName() const {
    return m_model_name;
}
void OAITransformJob::setModelName(const QString &model_name) {
    m_model_name = model_name;
    m_model_name_isSet = true;
}

bool OAITransformJob::is_model_name_Set() const{
    return m_model_name_isSet;
}

bool OAITransformJob::is_model_name_Valid() const{
    return m_model_name_isValid;
}

qint32 OAITransformJob::getMaxConcurrentTransforms() const {
    return m_max_concurrent_transforms;
}
void OAITransformJob::setMaxConcurrentTransforms(const qint32 &max_concurrent_transforms) {
    m_max_concurrent_transforms = max_concurrent_transforms;
    m_max_concurrent_transforms_isSet = true;
}

bool OAITransformJob::is_max_concurrent_transforms_Set() const{
    return m_max_concurrent_transforms_isSet;
}

bool OAITransformJob::is_max_concurrent_transforms_Valid() const{
    return m_max_concurrent_transforms_isValid;
}

OAIModelClientConfig OAITransformJob::getModelClientConfig() const {
    return m_model_client_config;
}
void OAITransformJob::setModelClientConfig(const OAIModelClientConfig &model_client_config) {
    m_model_client_config = model_client_config;
    m_model_client_config_isSet = true;
}

bool OAITransformJob::is_model_client_config_Set() const{
    return m_model_client_config_isSet;
}

bool OAITransformJob::is_model_client_config_Valid() const{
    return m_model_client_config_isValid;
}

qint32 OAITransformJob::getMaxPayloadInMb() const {
    return m_max_payload_in_mb;
}
void OAITransformJob::setMaxPayloadInMb(const qint32 &max_payload_in_mb) {
    m_max_payload_in_mb = max_payload_in_mb;
    m_max_payload_in_mb_isSet = true;
}

bool OAITransformJob::is_max_payload_in_mb_Set() const{
    return m_max_payload_in_mb_isSet;
}

bool OAITransformJob::is_max_payload_in_mb_Valid() const{
    return m_max_payload_in_mb_isValid;
}

OAIBatchStrategy OAITransformJob::getBatchStrategy() const {
    return m_batch_strategy;
}
void OAITransformJob::setBatchStrategy(const OAIBatchStrategy &batch_strategy) {
    m_batch_strategy = batch_strategy;
    m_batch_strategy_isSet = true;
}

bool OAITransformJob::is_batch_strategy_Set() const{
    return m_batch_strategy_isSet;
}

bool OAITransformJob::is_batch_strategy_Valid() const{
    return m_batch_strategy_isValid;
}

QMap OAITransformJob::getEnvironment() const {
    return m_environment;
}
void OAITransformJob::setEnvironment(const QMap &environment) {
    m_environment = environment;
    m_environment_isSet = true;
}

bool OAITransformJob::is_environment_Set() const{
    return m_environment_isSet;
}

bool OAITransformJob::is_environment_Valid() const{
    return m_environment_isValid;
}

OAITransformInput OAITransformJob::getTransformInput() const {
    return m_transform_input;
}
void OAITransformJob::setTransformInput(const OAITransformInput &transform_input) {
    m_transform_input = transform_input;
    m_transform_input_isSet = true;
}

bool OAITransformJob::is_transform_input_Set() const{
    return m_transform_input_isSet;
}

bool OAITransformJob::is_transform_input_Valid() const{
    return m_transform_input_isValid;
}

OAITransformOutput OAITransformJob::getTransformOutput() const {
    return m_transform_output;
}
void OAITransformJob::setTransformOutput(const OAITransformOutput &transform_output) {
    m_transform_output = transform_output;
    m_transform_output_isSet = true;
}

bool OAITransformJob::is_transform_output_Set() const{
    return m_transform_output_isSet;
}

bool OAITransformJob::is_transform_output_Valid() const{
    return m_transform_output_isValid;
}

OAITransformResources OAITransformJob::getTransformResources() const {
    return m_transform_resources;
}
void OAITransformJob::setTransformResources(const OAITransformResources &transform_resources) {
    m_transform_resources = transform_resources;
    m_transform_resources_isSet = true;
}

bool OAITransformJob::is_transform_resources_Set() const{
    return m_transform_resources_isSet;
}

bool OAITransformJob::is_transform_resources_Valid() const{
    return m_transform_resources_isValid;
}

QDateTime OAITransformJob::getCreationTime() const {
    return m_creation_time;
}
void OAITransformJob::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAITransformJob::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAITransformJob::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QDateTime OAITransformJob::getTransformStartTime() const {
    return m_transform_start_time;
}
void OAITransformJob::setTransformStartTime(const QDateTime &transform_start_time) {
    m_transform_start_time = transform_start_time;
    m_transform_start_time_isSet = true;
}

bool OAITransformJob::is_transform_start_time_Set() const{
    return m_transform_start_time_isSet;
}

bool OAITransformJob::is_transform_start_time_Valid() const{
    return m_transform_start_time_isValid;
}

QDateTime OAITransformJob::getTransformEndTime() const {
    return m_transform_end_time;
}
void OAITransformJob::setTransformEndTime(const QDateTime &transform_end_time) {
    m_transform_end_time = transform_end_time;
    m_transform_end_time_isSet = true;
}

bool OAITransformJob::is_transform_end_time_Set() const{
    return m_transform_end_time_isSet;
}

bool OAITransformJob::is_transform_end_time_Valid() const{
    return m_transform_end_time_isValid;
}

QString OAITransformJob::getLabelingJobArn() const {
    return m_labeling_job_arn;
}
void OAITransformJob::setLabelingJobArn(const QString &labeling_job_arn) {
    m_labeling_job_arn = labeling_job_arn;
    m_labeling_job_arn_isSet = true;
}

bool OAITransformJob::is_labeling_job_arn_Set() const{
    return m_labeling_job_arn_isSet;
}

bool OAITransformJob::is_labeling_job_arn_Valid() const{
    return m_labeling_job_arn_isValid;
}

QString OAITransformJob::getAutoMlJobArn() const {
    return m_auto_ml_job_arn;
}
void OAITransformJob::setAutoMlJobArn(const QString &auto_ml_job_arn) {
    m_auto_ml_job_arn = auto_ml_job_arn;
    m_auto_ml_job_arn_isSet = true;
}

bool OAITransformJob::is_auto_ml_job_arn_Set() const{
    return m_auto_ml_job_arn_isSet;
}

bool OAITransformJob::is_auto_ml_job_arn_Valid() const{
    return m_auto_ml_job_arn_isValid;
}

OAIDataProcessing OAITransformJob::getDataProcessing() const {
    return m_data_processing;
}
void OAITransformJob::setDataProcessing(const OAIDataProcessing &data_processing) {
    m_data_processing = data_processing;
    m_data_processing_isSet = true;
}

bool OAITransformJob::is_data_processing_Set() const{
    return m_data_processing_isSet;
}

bool OAITransformJob::is_data_processing_Valid() const{
    return m_data_processing_isValid;
}

OAIExperimentConfig OAITransformJob::getExperimentConfig() const {
    return m_experiment_config;
}
void OAITransformJob::setExperimentConfig(const OAIExperimentConfig &experiment_config) {
    m_experiment_config = experiment_config;
    m_experiment_config_isSet = true;
}

bool OAITransformJob::is_experiment_config_Set() const{
    return m_experiment_config_isSet;
}

bool OAITransformJob::is_experiment_config_Valid() const{
    return m_experiment_config_isValid;
}

QList OAITransformJob::getTags() const {
    return m_tags;
}
void OAITransformJob::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITransformJob::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITransformJob::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIBatchDataCaptureConfig OAITransformJob::getDataCaptureConfig() const {
    return m_data_capture_config;
}
void OAITransformJob::setDataCaptureConfig(const OAIBatchDataCaptureConfig &data_capture_config) {
    m_data_capture_config = data_capture_config;
    m_data_capture_config_isSet = true;
}

bool OAITransformJob::is_data_capture_config_Set() const{
    return m_data_capture_config_isSet;
}

bool OAITransformJob::is_data_capture_config_Valid() const{
    return m_data_capture_config_isValid;
}

bool OAITransformJob::isSet() const {
...
bool OAITransformJob::isValid() const {
