...
/*
 * OAIListLabelingJobsRequest.h
 *
 * 
 */

#ifndef OAIListLabelingJobsRequest_H
#define OAIListLabelingJobsRequest_H
...
class OAIListLabelingJobsRequest : public OAIObject {
public:
    OAIListLabelingJobsRequest();
    OAIListLabelingJobsRequest(QString json);
    ~OAIListLabelingJobsRequest() override;
    ...
    OAILabelingJobStatus getStatusEquals() const;
    void setStatusEquals(const OAILabelingJobStatus &status_equals);
...
private:
    ...
    OAILabelingJobStatus m_status_equals;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLabelingJobsRequest)

#endif // OAIListLabelingJobsRequest_H
