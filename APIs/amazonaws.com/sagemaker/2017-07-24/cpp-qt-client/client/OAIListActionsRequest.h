...
/*
 * OAIListActionsRequest.h
 *
 * 
 */

#ifndef OAIListActionsRequest_H
#define OAIListActionsRequest_H
...
class OAIListActionsRequest : public OAIObject {
public:
    OAIListActionsRequest();
    OAIListActionsRequest(QString json);
    ~OAIListActionsRequest() override;
    ...
    OAISortActionsBy getSortBy() const;
    void setSortBy(const OAISortActionsBy &sort_by);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListActionsRequest)

#endif // OAIListActionsRequest_H
