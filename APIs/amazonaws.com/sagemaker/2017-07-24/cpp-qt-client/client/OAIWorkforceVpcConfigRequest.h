...
/*
 * OAIWorkforceVpcConfigRequest.h
 *
 * The VPC object you use to create or update a workforce.
 */

#ifndef OAIWorkforceVpcConfigRequest_H
#define OAIWorkforceVpcConfigRequest_H
...
class OAIWorkforceVpcConfigRequest : public OAIObject {
public:
    OAIWorkforceVpcConfigRequest();
    OAIWorkforceVpcConfigRequest(QString json);
    ~OAIWorkforceVpcConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkforceVpcConfigRequest)

#endif // OAIWorkforceVpcConfigRequest_H
