...
/*
 * OAIDescribeCompilationJobResponse_OutputConfig.h
 *
 * 
 */

#ifndef OAIDescribeCompilationJobResponse_OutputConfig_H
#define OAIDescribeCompilationJobResponse_OutputConfig_H
...
class OAIDescribeCompilationJobResponse_OutputConfig : public OAIObject {
public:
    OAIDescribeCompilationJobResponse_OutputConfig();
    OAIDescribeCompilationJobResponse_OutputConfig(QString json);
    ~OAIDescribeCompilationJobResponse_OutputConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCompilationJobResponse_OutputConfig)

#endif // OAIDescribeCompilationJobResponse_OutputConfig_H
