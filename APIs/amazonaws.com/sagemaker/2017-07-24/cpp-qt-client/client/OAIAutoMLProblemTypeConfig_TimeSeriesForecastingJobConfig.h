...
/*
 * OAIAutoMLProblemTypeConfig_TimeSeriesForecastingJobConfig.h
 *
 * 
 */

#ifndef OAIAutoMLProblemTypeConfig_TimeSeriesForecastingJobConfig_H
#define OAIAutoMLProblemTypeConfig_TimeSeriesForecastingJobConfig_H
...
class OAIAutoMLProblemTypeConfig_TimeSeriesForecastingJobConfig : public OAIObject {
public:
    OAIAutoMLProblemTypeConfig_TimeSeriesForecastingJobConfig();
    OAIAutoMLProblemTypeConfig_TimeSeriesForecastingJobConfig(QString json);
    ~OAIAutoMLProblemTypeConfig_TimeSeriesForecastingJobConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoMLProblemTypeConfig_TimeSeriesForecastingJobConfig)

#endif // OAIAutoMLProblemTypeConfig_TimeSeriesForecastingJobConfig_H
