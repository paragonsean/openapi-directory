...
#include "OAIProfilerRuleConfiguration.h"
...
OAIProfilerRuleConfiguration::OAIProfilerRuleConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProfilerRuleConfiguration::OAIProfilerRuleConfiguration() {
    this->initializeModel();
}

OAIProfilerRuleConfiguration::~OAIProfilerRuleConfiguration() {}

void OAIProfilerRuleConfiguration::initializeModel() {
...
void OAIProfilerRuleConfiguration::fromJson(QString jsonString) {
...
void OAIProfilerRuleConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIProfilerRuleConfiguration::asJson() const {
...
QJsonObject OAIProfilerRuleConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIProfilerRuleConfiguration::getRuleConfigurationName() const {
    return m_rule_configuration_name;
}
void OAIProfilerRuleConfiguration::setRuleConfigurationName(const QString &rule_configuration_name) {
    m_rule_configuration_name = rule_configuration_name;
    m_rule_configuration_name_isSet = true;
}

bool OAIProfilerRuleConfiguration::is_rule_configuration_name_Set() const{
    return m_rule_configuration_name_isSet;
}

bool OAIProfilerRuleConfiguration::is_rule_configuration_name_Valid() const{
    return m_rule_configuration_name_isValid;
}

QString OAIProfilerRuleConfiguration::getLocalPath() const {
    return m_local_path;
}
void OAIProfilerRuleConfiguration::setLocalPath(const QString &local_path) {
    m_local_path = local_path;
    m_local_path_isSet = true;
}

bool OAIProfilerRuleConfiguration::is_local_path_Set() const{
    return m_local_path_isSet;
}

bool OAIProfilerRuleConfiguration::is_local_path_Valid() const{
    return m_local_path_isValid;
}

QString OAIProfilerRuleConfiguration::getS3OutputPath() const {
    return m_s3_output_path;
}
void OAIProfilerRuleConfiguration::setS3OutputPath(const QString &s3_output_path) {
    m_s3_output_path = s3_output_path;
    m_s3_output_path_isSet = true;
}

bool OAIProfilerRuleConfiguration::is_s3_output_path_Set() const{
    return m_s3_output_path_isSet;
}

bool OAIProfilerRuleConfiguration::is_s3_output_path_Valid() const{
    return m_s3_output_path_isValid;
}

QString OAIProfilerRuleConfiguration::getRuleEvaluatorImage() const {
    return m_rule_evaluator_image;
}
void OAIProfilerRuleConfiguration::setRuleEvaluatorImage(const QString &rule_evaluator_image) {
    m_rule_evaluator_image = rule_evaluator_image;
    m_rule_evaluator_image_isSet = true;
}

bool OAIProfilerRuleConfiguration::is_rule_evaluator_image_Set() const{
    return m_rule_evaluator_image_isSet;
}

bool OAIProfilerRuleConfiguration::is_rule_evaluator_image_Valid() const{
    return m_rule_evaluator_image_isValid;
}

OAIProcessingInstanceType OAIProfilerRuleConfiguration::getInstanceType() const {
    return m_instance_type;
}
void OAIProfilerRuleConfiguration::setInstanceType(const OAIProcessingInstanceType &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIProfilerRuleConfiguration::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIProfilerRuleConfiguration::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

qint32 OAIProfilerRuleConfiguration::getVolumeSizeInGb() const {
    return m_volume_size_in_gb;
}
void OAIProfilerRuleConfiguration::setVolumeSizeInGb(const qint32 &volume_size_in_gb) {
    m_volume_size_in_gb = volume_size_in_gb;
    m_volume_size_in_gb_isSet = true;
}

bool OAIProfilerRuleConfiguration::is_volume_size_in_gb_Set() const{
    return m_volume_size_in_gb_isSet;
}

bool OAIProfilerRuleConfiguration::is_volume_size_in_gb_Valid() const{
    return m_volume_size_in_gb_isValid;
}

QMap OAIProfilerRuleConfiguration::getRuleParameters() const {
    return m_rule_parameters;
}
void OAIProfilerRuleConfiguration::setRuleParameters(const QMap &rule_parameters) {
    m_rule_parameters = rule_parameters;
    m_rule_parameters_isSet = true;
}

bool OAIProfilerRuleConfiguration::is_rule_parameters_Set() const{
    return m_rule_parameters_isSet;
}

bool OAIProfilerRuleConfiguration::is_rule_parameters_Valid() const{
    return m_rule_parameters_isValid;
}

bool OAIProfilerRuleConfiguration::isSet() const {
...
bool OAIProfilerRuleConfiguration::isValid() const {
