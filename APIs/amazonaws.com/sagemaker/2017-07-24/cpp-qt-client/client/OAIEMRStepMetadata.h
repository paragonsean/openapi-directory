...
/*
 * OAIEMRStepMetadata.h
 *
 * The configurations and outcomes of an Amazon EMR step execution.
 */

#ifndef OAIEMRStepMetadata_H
#define OAIEMRStepMetadata_H
...
class OAIEMRStepMetadata : public OAIObject {
public:
    OAIEMRStepMetadata();
    OAIEMRStepMetadata(QString json);
    ~OAIEMRStepMetadata() override;
    ...
    void setLogFilePath(const QString &log_file_path);
    bool is_log_file_path_Set() const;
    bool is_log_file_path_Valid() const;
...
private:
    ...
    bool m_log_file_path_isSet;
    bool m_log_file_path_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEMRStepMetadata)

#endif // OAIEMRStepMetadata_H
