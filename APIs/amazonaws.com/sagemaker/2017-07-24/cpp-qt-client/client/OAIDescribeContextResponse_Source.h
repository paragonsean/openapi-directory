...
/*
 * OAIDescribeContextResponse_Source.h
 *
 * 
 */

#ifndef OAIDescribeContextResponse_Source_H
#define OAIDescribeContextResponse_Source_H
...
class OAIDescribeContextResponse_Source : public OAIObject {
public:
    OAIDescribeContextResponse_Source();
    OAIDescribeContextResponse_Source(QString json);
    ~OAIDescribeContextResponse_Source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeContextResponse_Source)

#endif // OAIDescribeContextResponse_Source_H
