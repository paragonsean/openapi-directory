...
/*
 * OAIPendingDeploymentSummary.h
 *
 * The summary of an in-progress deployment when an endpoint is creating or updating with a new endpoint configuration.
 */

#ifndef OAIPendingDeploymentSummary_H
#define OAIPendingDeploymentSummary_H
...
class OAIPendingDeploymentSummary : public OAIObject {
public:
    OAIPendingDeploymentSummary();
    OAIPendingDeploymentSummary(QString json);
    ~OAIPendingDeploymentSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPendingDeploymentSummary)

#endif // OAIPendingDeploymentSummary_H
