...
/*
 * OAIListDeviceFleetsRequest.h
 *
 * 
 */

#ifndef OAIListDeviceFleetsRequest_H
#define OAIListDeviceFleetsRequest_H
...
class OAIListDeviceFleetsRequest : public OAIObject {
public:
    OAIListDeviceFleetsRequest();
    OAIListDeviceFleetsRequest(QString json);
    ~OAIListDeviceFleetsRequest() override;
    ...
    OAIListDeviceFleetsSortBy getSortBy() const;
    void setSortBy(const OAIListDeviceFleetsSortBy &sort_by);
...
private:
    ...
    OAIListDeviceFleetsSortBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDeviceFleetsRequest)

#endif // OAIListDeviceFleetsRequest_H
