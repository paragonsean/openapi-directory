...
#ifndef OAIResourceConfig_H
#define OAIResourceConfig_H
...
class OAIResourceConfig : public OAIObject {
public:
    OAIResourceConfig();
    OAIResourceConfig(QString json);
    ~OAIResourceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceConfig)

#endif // OAIResourceConfig_H
