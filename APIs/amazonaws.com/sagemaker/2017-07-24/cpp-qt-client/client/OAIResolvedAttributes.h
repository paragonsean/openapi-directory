...
/*
 * OAIResolvedAttributes.h
 *
 * The resolved attributes.
 */

#ifndef OAIResolvedAttributes_H
#define OAIResolvedAttributes_H
...
class OAIResolvedAttributes : public OAIObject {
public:
    OAIResolvedAttributes();
    OAIResolvedAttributes(QString json);
    ~OAIResolvedAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResolvedAttributes)

#endif // OAIResolvedAttributes_H
