...
/*
 * OAIListModelQualityJobDefinitionsRequest.h
 *
 * 
 */

#ifndef OAIListModelQualityJobDefinitionsRequest_H
#define OAIListModelQualityJobDefinitionsRequest_H
...
class OAIListModelQualityJobDefinitionsRequest : public OAIObject {
public:
    OAIListModelQualityJobDefinitionsRequest();
    OAIListModelQualityJobDefinitionsRequest(QString json);
    ~OAIListModelQualityJobDefinitionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListModelQualityJobDefinitionsRequest)

#endif // OAIListModelQualityJobDefinitionsRequest_H
