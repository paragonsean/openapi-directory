...
/*
 * OAITransformResources.h
 *
 * Describes the resources, including ML instance types and ML instance count, to use for transform job.
 */

#ifndef OAITransformResources_H
#define OAITransformResources_H
...
class OAITransformResources : public OAIObject {
public:
    OAITransformResources();
    OAITransformResources(QString json);
    ~OAITransformResources() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransformResources)

#endif // OAITransformResources_H
