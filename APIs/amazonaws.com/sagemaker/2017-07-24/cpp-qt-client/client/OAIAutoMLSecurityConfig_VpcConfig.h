...
/*
 * OAIAutoMLSecurityConfig_VpcConfig.h
 *
 * 
 */

#ifndef OAIAutoMLSecurityConfig_VpcConfig_H
#define OAIAutoMLSecurityConfig_VpcConfig_H
...
class OAIAutoMLSecurityConfig_VpcConfig : public OAIObject {
public:
    OAIAutoMLSecurityConfig_VpcConfig();
    OAIAutoMLSecurityConfig_VpcConfig(QString json);
    ~OAIAutoMLSecurityConfig_VpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoMLSecurityConfig_VpcConfig)

#endif // OAIAutoMLSecurityConfig_VpcConfig_H
