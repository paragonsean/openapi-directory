...
/*
 * OAIListModelPackageGroupsInput.h
 *
 * 
 */

#ifndef OAIListModelPackageGroupsInput_H
#define OAIListModelPackageGroupsInput_H
...
class OAIListModelPackageGroupsInput : public OAIObject {
public:
    OAIListModelPackageGroupsInput();
    OAIListModelPackageGroupsInput(QString json);
    ~OAIListModelPackageGroupsInput() override;
    ...
    OAIModelPackageGroupSortBy getSortBy() const;
    void setSortBy(const OAIModelPackageGroupSortBy &sort_by);
...
private:
    ...
    OAIModelPackageGroupSortBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListModelPackageGroupsInput)

#endif // OAIListModelPackageGroupsInput_H
