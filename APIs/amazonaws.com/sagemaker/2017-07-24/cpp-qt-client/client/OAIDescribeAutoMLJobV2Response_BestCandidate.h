...
/*
 * OAIDescribeAutoMLJobV2Response_BestCandidate.h
 *
 * 
 */

#ifndef OAIDescribeAutoMLJobV2Response_BestCandidate_H
#define OAIDescribeAutoMLJobV2Response_BestCandidate_H
...
class OAIDescribeAutoMLJobV2Response_BestCandidate : public OAIObject {
public:
    OAIDescribeAutoMLJobV2Response_BestCandidate();
    OAIDescribeAutoMLJobV2Response_BestCandidate(QString json);
    ~OAIDescribeAutoMLJobV2Response_BestCandidate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAutoMLJobV2Response_BestCandidate)

#endif // OAIDescribeAutoMLJobV2Response_BestCandidate_H
