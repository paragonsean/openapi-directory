...
/*
 * OAIListWorkforcesRequest.h
 *
 * 
 */

#ifndef OAIListWorkforcesRequest_H
#define OAIListWorkforcesRequest_H

#include <QJsonObject>

#include "OAIListWorkforcesSortByOptions.h"
...
class OAIListWorkforcesRequest : public OAIObject {
public:
    OAIListWorkforcesRequest();
    OAIListWorkforcesRequest(QString json);
    ~OAIListWorkforcesRequest() override;
    ...
    OAIListWorkforcesSortByOptions getSortBy() const;
    void setSortBy(const OAIListWorkforcesSortByOptions &sort_by);
...
private:
    ...
    OAIListWorkforcesSortByOptions m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListWorkforcesRequest)

#endif // OAIListWorkforcesRequest_H
