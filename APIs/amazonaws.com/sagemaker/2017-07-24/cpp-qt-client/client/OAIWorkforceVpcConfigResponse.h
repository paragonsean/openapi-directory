...
/*
 * OAIWorkforceVpcConfigResponse.h
 *
 * A VpcConfig object that specifies the VPC that you want your workforce to connect to.
 */

#ifndef OAIWorkforceVpcConfigResponse_H
#define OAIWorkforceVpcConfigResponse_H
...
class OAIWorkforceVpcConfigResponse : public OAIObject {
public:
    OAIWorkforceVpcConfigResponse();
    OAIWorkforceVpcConfigResponse(QString json);
    ~OAIWorkforceVpcConfigResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkforceVpcConfigResponse)

#endif // OAIWorkforceVpcConfigResponse_H
