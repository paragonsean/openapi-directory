...
/*
 * OAIListCompilationJobsRequest.h
 *
 * 
 */

#ifndef OAIListCompilationJobsRequest_H
#define OAIListCompilationJobsRequest_H

#include <QJsonObject>

#include "OAICompilationJobStatus.h"
#include "OAIListCompilationJobsSortBy.h"
...
class OAIListCompilationJobsRequest : public OAIObject {
public:
    OAIListCompilationJobsRequest();
    OAIListCompilationJobsRequest(QString json);
    ~OAIListCompilationJobsRequest() override;
    ...
    OAICompilationJobStatus getStatusEquals() const;
    void setStatusEquals(const OAICompilationJobStatus &status_equals);
    bool is_status_equals_Set() const;
    bool is_status_equals_Valid() const;

    OAIListCompilationJobsSortBy getSortBy() const;
    void setSortBy(const OAIListCompilationJobsSortBy &sort_by);
...
private:
    ...
    OAICompilationJobStatus m_status_equals;
    bool m_status_equals_isSet;
    bool m_status_equals_isValid;

    OAIListCompilationJobsSortBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCompilationJobsRequest)

#endif // OAIListCompilationJobsRequest_H
