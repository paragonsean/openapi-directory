...
/*
 * OAIListPipelineExecutionStepsRequest.h
 *
 * 
 */

#ifndef OAIListPipelineExecutionStepsRequest_H
#define OAIListPipelineExecutionStepsRequest_H
...
class OAIListPipelineExecutionStepsRequest : public OAIObject {
public:
    OAIListPipelineExecutionStepsRequest();
    OAIListPipelineExecutionStepsRequest(QString json);
    ~OAIListPipelineExecutionStepsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPipelineExecutionStepsRequest)

#endif // OAIListPipelineExecutionStepsRequest_H
