...
/*
 * OAIEndpointMetadata.h
 *
 * The metadata of the endpoint.
 */

#ifndef OAIEndpointMetadata_H
#define OAIEndpointMetadata_H
...
class OAIEndpointMetadata : public OAIObject {
public:
    OAIEndpointMetadata();
    OAIEndpointMetadata(QString json);
    ~OAIEndpointMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointMetadata)

#endif // OAIEndpointMetadata_H
