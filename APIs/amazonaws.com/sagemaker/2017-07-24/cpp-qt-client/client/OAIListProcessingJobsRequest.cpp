...
OAIListProcessingJobsRequest::OAIListProcessingJobsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListProcessingJobsRequest::OAIListProcessingJobsRequest() {
    this->initializeModel();
}

OAIListProcessingJobsRequest::~OAIListProcessingJobsRequest() {}

void OAIListProcessingJobsRequest::initializeModel() {
...
void OAIListProcessingJobsRequest::fromJson(QString jsonString) {
...
void OAIListProcessingJobsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListProcessingJobsRequest::asJson() const {
...
QJsonObject OAIListProcessingJobsRequest::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIListProcessingJobsRequest::getCreationTimeAfter() const {
    return m_creation_time_after;
}
void OAIListProcessingJobsRequest::setCreationTimeAfter(const QDateTime &creation_time_after) {
    m_creation_time_after = creation_time_after;
    m_creation_time_after_isSet = true;
}

bool OAIListProcessingJobsRequest::is_creation_time_after_Set() const{
    return m_creation_time_after_isSet;
}

bool OAIListProcessingJobsRequest::is_creation_time_after_Valid() const{
    return m_creation_time_after_isValid;
}

QDateTime OAIListProcessingJobsRequest::getCreationTimeBefore() const {
    return m_creation_time_before;
}
void OAIListProcessingJobsRequest::setCreationTimeBefore(const QDateTime &creation_time_before) {
    m_creation_time_before = creation_time_before;
    m_creation_time_before_isSet = true;
}

bool OAIListProcessingJobsRequest::is_creation_time_before_Set() const{
    return m_creation_time_before_isSet;
}

bool OAIListProcessingJobsRequest::is_creation_time_before_Valid() const{
    return m_creation_time_before_isValid;
}

QDateTime OAIListProcessingJobsRequest::getLastModifiedTimeAfter() const {
    return m_last_modified_time_after;
}
void OAIListProcessingJobsRequest::setLastModifiedTimeAfter(const QDateTime &last_modified_time_after) {
    m_last_modified_time_after = last_modified_time_after;
    m_last_modified_time_after_isSet = true;
}

bool OAIListProcessingJobsRequest::is_last_modified_time_after_Set() const{
    return m_last_modified_time_after_isSet;
}

bool OAIListProcessingJobsRequest::is_last_modified_time_after_Valid() const{
    return m_last_modified_time_after_isValid;
}

QDateTime OAIListProcessingJobsRequest::getLastModifiedTimeBefore() const {
    return m_last_modified_time_before;
}
void OAIListProcessingJobsRequest::setLastModifiedTimeBefore(const QDateTime &last_modified_time_before) {
    m_last_modified_time_before = last_modified_time_before;
    m_last_modified_time_before_isSet = true;
}

bool OAIListProcessingJobsRequest::is_last_modified_time_before_Set() const{
    return m_last_modified_time_before_isSet;
}

bool OAIListProcessingJobsRequest::is_last_modified_time_before_Valid() const{
    return m_last_modified_time_before_isValid;
}

QString OAIListProcessingJobsRequest::getNameContains() const {
    return m_name_contains;
}
void OAIListProcessingJobsRequest::setNameContains(const QString &name_contains) {
    m_name_contains = name_contains;
    m_name_contains_isSet = true;
}

bool OAIListProcessingJobsRequest::is_name_contains_Set() const{
    return m_name_contains_isSet;
}

bool OAIListProcessingJobsRequest::is_name_contains_Valid() const{
    return m_name_contains_isValid;
}

OAIProcessingJobStatus OAIListProcessingJobsRequest::getStatusEquals() const {
    return m_status_equals;
}
void OAIListProcessingJobsRequest::setStatusEquals(const OAIProcessingJobStatus &status_equals) {
    m_status_equals = status_equals;
    m_status_equals_isSet = true;
}

bool OAIListProcessingJobsRequest::is_status_equals_Set() const{
    return m_status_equals_isSet;
}

bool OAIListProcessingJobsRequest::is_status_equals_Valid() const{
    return m_status_equals_isValid;
}

OAISortBy OAIListProcessingJobsRequest::getSortBy() const {
    return m_sort_by;
}
void OAIListProcessingJobsRequest::setSortBy(const OAISortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIListProcessingJobsRequest::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIListProcessingJobsRequest::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAISortOrder OAIListProcessingJobsRequest::getSortOrder() const {
    return m_sort_order;
}
void OAIListProcessingJobsRequest::setSortOrder(const OAISortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIListProcessingJobsRequest::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIListProcessingJobsRequest::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

QString OAIListProcessingJobsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListProcessingJobsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListProcessingJobsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListProcessingJobsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListProcessingJobsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListProcessingJobsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListProcessingJobsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListProcessingJobsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListProcessingJobsRequest::isSet() const {
...
bool OAIListProcessingJobsRequest::isValid() const {
