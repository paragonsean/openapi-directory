...
/*
 * OAIMonitoringInput_EndpointInput.h
 *
 * 
 */

#ifndef OAIMonitoringInput_EndpointInput_H
#define OAIMonitoringInput_EndpointInput_H
...
class OAIMonitoringInput_EndpointInput : public OAIObject {
public:
    OAIMonitoringInput_EndpointInput();
    OAIMonitoringInput_EndpointInput(QString json);
    ~OAIMonitoringInput_EndpointInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitoringInput_EndpointInput)

#endif // OAIMonitoringInput_EndpointInput_H
