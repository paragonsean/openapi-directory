...
/*
 * OAIDynamicScalingConfiguration.h
 *
 * An object with the recommended values for you to specify when creating an autoscaling policy.
 */

#ifndef OAIDynamicScalingConfiguration_H
#define OAIDynamicScalingConfiguration_H
...
class OAIDynamicScalingConfiguration : public OAIObject {
public:
    OAIDynamicScalingConfiguration();
    OAIDynamicScalingConfiguration(QString json);
    ~OAIDynamicScalingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDynamicScalingConfiguration)

#endif // OAIDynamicScalingConfiguration_H
