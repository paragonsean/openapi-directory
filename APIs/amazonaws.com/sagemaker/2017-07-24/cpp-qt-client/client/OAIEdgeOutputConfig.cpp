...
OAIEdgeOutputConfig::OAIEdgeOutputConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEdgeOutputConfig::OAIEdgeOutputConfig() {
    this->initializeModel();
}

OAIEdgeOutputConfig::~OAIEdgeOutputConfig() {}

void OAIEdgeOutputConfig::initializeModel() {
...
void OAIEdgeOutputConfig::fromJson(QString jsonString) {
...
void OAIEdgeOutputConfig::fromJsonObject(QJsonObject json) {
...
QString OAIEdgeOutputConfig::asJson() const {
...
QJsonObject OAIEdgeOutputConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEdgeOutputConfig::getS3OutputLocation() const {
    return m_s3_output_location;
}
void OAIEdgeOutputConfig::setS3OutputLocation(const QString &s3_output_location) {
    m_s3_output_location = s3_output_location;
    m_s3_output_location_isSet = true;
}

bool OAIEdgeOutputConfig::is_s3_output_location_Set() const{
    return m_s3_output_location_isSet;
}

bool OAIEdgeOutputConfig::is_s3_output_location_Valid() const{
    return m_s3_output_location_isValid;
}

QString OAIEdgeOutputConfig::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIEdgeOutputConfig::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIEdgeOutputConfig::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIEdgeOutputConfig::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

OAIEdgePresetDeploymentType OAIEdgeOutputConfig::getPresetDeploymentType() const {
    return m_preset_deployment_type;
}
void OAIEdgeOutputConfig::setPresetDeploymentType(const OAIEdgePresetDeploymentType &preset_deployment_type) {
    m_preset_deployment_type = preset_deployment_type;
    m_preset_deployment_type_isSet = true;
}

bool OAIEdgeOutputConfig::is_preset_deployment_type_Set() const{
    return m_preset_deployment_type_isSet;
}

bool OAIEdgeOutputConfig::is_preset_deployment_type_Valid() const{
    return m_preset_deployment_type_isValid;
}

QString OAIEdgeOutputConfig::getPresetDeploymentConfig() const {
    return m_preset_deployment_config;
}
void OAIEdgeOutputConfig::setPresetDeploymentConfig(const QString &preset_deployment_config) {
    m_preset_deployment_config = preset_deployment_config;
    m_preset_deployment_config_isSet = true;
}

bool OAIEdgeOutputConfig::is_preset_deployment_config_Set() const{
    return m_preset_deployment_config_isSet;
}

bool OAIEdgeOutputConfig::is_preset_deployment_config_Valid() const{
    return m_preset_deployment_config_isValid;
}

bool OAIEdgeOutputConfig::isSet() const {
...
bool OAIEdgeOutputConfig::isValid() const {
