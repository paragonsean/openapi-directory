...
OAIUpdateWorkforceResponse_Workforce::OAIUpdateWorkforceResponse_Workforce(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateWorkforceResponse_Workforce::OAIUpdateWorkforceResponse_Workforce() {
    this->initializeModel();
}

OAIUpdateWorkforceResponse_Workforce::~OAIUpdateWorkforceResponse_Workforce() {}

void OAIUpdateWorkforceResponse_Workforce::initializeModel() {
...
void OAIUpdateWorkforceResponse_Workforce::fromJson(QString jsonString) {
...
void OAIUpdateWorkforceResponse_Workforce::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateWorkforceResponse_Workforce::asJson() const {
...
QJsonObject OAIUpdateWorkforceResponse_Workforce::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateWorkforceResponse_Workforce::getWorkforceName() const {
    return m_workforce_name;
}
void OAIUpdateWorkforceResponse_Workforce::setWorkforceName(const QString &workforce_name) {
    m_workforce_name = workforce_name;
    m_workforce_name_isSet = true;
}

bool OAIUpdateWorkforceResponse_Workforce::is_workforce_name_Set() const{
    return m_workforce_name_isSet;
}

bool OAIUpdateWorkforceResponse_Workforce::is_workforce_name_Valid() const{
    return m_workforce_name_isValid;
}

QString OAIUpdateWorkforceResponse_Workforce::getWorkforceArn() const {
    return m_workforce_arn;
}
void OAIUpdateWorkforceResponse_Workforce::setWorkforceArn(const QString &workforce_arn) {
    m_workforce_arn = workforce_arn;
    m_workforce_arn_isSet = true;
}

bool OAIUpdateWorkforceResponse_Workforce::is_workforce_arn_Set() const{
    return m_workforce_arn_isSet;
}

bool OAIUpdateWorkforceResponse_Workforce::is_workforce_arn_Valid() const{
    return m_workforce_arn_isValid;
}

QDateTime OAIUpdateWorkforceResponse_Workforce::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAIUpdateWorkforceResponse_Workforce::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAIUpdateWorkforceResponse_Workforce::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAIUpdateWorkforceResponse_Workforce::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

OAIWorkforce_SourceIpConfig OAIUpdateWorkforceResponse_Workforce::getSourceIpConfig() const {
    return m_source_ip_config;
}
void OAIUpdateWorkforceResponse_Workforce::setSourceIpConfig(const OAIWorkforce_SourceIpConfig &source_ip_config) {
    m_source_ip_config = source_ip_config;
    m_source_ip_config_isSet = true;
}

bool OAIUpdateWorkforceResponse_Workforce::is_source_ip_config_Set() const{
    return m_source_ip_config_isSet;
}

bool OAIUpdateWorkforceResponse_Workforce::is_source_ip_config_Valid() const{
    return m_source_ip_config_isValid;
}

QString OAIUpdateWorkforceResponse_Workforce::getSubDomain() const {
    return m_sub_domain;
}
void OAIUpdateWorkforceResponse_Workforce::setSubDomain(const QString &sub_domain) {
    m_sub_domain = sub_domain;
    m_sub_domain_isSet = true;
}

bool OAIUpdateWorkforceResponse_Workforce::is_sub_domain_Set() const{
    return m_sub_domain_isSet;
}

bool OAIUpdateWorkforceResponse_Workforce::is_sub_domain_Valid() const{
    return m_sub_domain_isValid;
}

OAIWorkforce_CognitoConfig OAIUpdateWorkforceResponse_Workforce::getCognitoConfig() const {
    return m_cognito_config;
}
void OAIUpdateWorkforceResponse_Workforce::setCognitoConfig(const OAIWorkforce_CognitoConfig &cognito_config) {
    m_cognito_config = cognito_config;
    m_cognito_config_isSet = true;
}

bool OAIUpdateWorkforceResponse_Workforce::is_cognito_config_Set() const{
    return m_cognito_config_isSet;
}

bool OAIUpdateWorkforceResponse_Workforce::is_cognito_config_Valid() const{
    return m_cognito_config_isValid;
}

OAIWorkforce_OidcConfig OAIUpdateWorkforceResponse_Workforce::getOidcConfig() const {
    return m_oidc_config;
}
void OAIUpdateWorkforceResponse_Workforce::setOidcConfig(const OAIWorkforce_OidcConfig &oidc_config) {
    m_oidc_config = oidc_config;
    m_oidc_config_isSet = true;
}

bool OAIUpdateWorkforceResponse_Workforce::is_oidc_config_Set() const{
    return m_oidc_config_isSet;
}

bool OAIUpdateWorkforceResponse_Workforce::is_oidc_config_Valid() const{
    return m_oidc_config_isValid;
}

QDateTime OAIUpdateWorkforceResponse_Workforce::getCreateDate() const {
    return m_create_date;
}
void OAIUpdateWorkforceResponse_Workforce::setCreateDate(const QDateTime &create_date) {
    m_create_date = create_date;
    m_create_date_isSet = true;
}

bool OAIUpdateWorkforceResponse_Workforce::is_create_date_Set() const{
    return m_create_date_isSet;
}

bool OAIUpdateWorkforceResponse_Workforce::is_create_date_Valid() const{
    return m_create_date_isValid;
}

OAIWorkforce_WorkforceVpcConfig OAIUpdateWorkforceResponse_Workforce::getWorkforceVpcConfig() const {
    return m_workforce_vpc_config;
}
void OAIUpdateWorkforceResponse_Workforce::setWorkforceVpcConfig(const OAIWorkforce_WorkforceVpcConfig &workforce_vpc_config) {
    m_workforce_vpc_config = workforce_vpc_config;
    m_workforce_vpc_config_isSet = true;
}

bool OAIUpdateWorkforceResponse_Workforce::is_workforce_vpc_config_Set() const{
    return m_workforce_vpc_config_isSet;
}

bool OAIUpdateWorkforceResponse_Workforce::is_workforce_vpc_config_Valid() const{
    return m_workforce_vpc_config_isValid;
}

OAIWorkforceStatus OAIUpdateWorkforceResponse_Workforce::getStatus() const {
    return m_status;
}
void OAIUpdateWorkforceResponse_Workforce::setStatus(const OAIWorkforceStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateWorkforceResponse_Workforce::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateWorkforceResponse_Workforce::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIUpdateWorkforceResponse_Workforce::getFailureReason() const {
    return m_failure_reason;
}
void OAIUpdateWorkforceResponse_Workforce::setFailureReason(const QString &failure_reason) {
    m_failure_reason = failure_reason;
    m_failure_reason_isSet = true;
}

bool OAIUpdateWorkforceResponse_Workforce::is_failure_reason_Set() const{
    return m_failure_reason_isSet;
}

bool OAIUpdateWorkforceResponse_Workforce::is_failure_reason_Valid() const{
    return m_failure_reason_isValid;
}

bool OAIUpdateWorkforceResponse_Workforce::isSet() const {
...
bool OAIUpdateWorkforceResponse_Workforce::isValid() const {
