...
/*
 * OAIListTrainingJobsRequest.h
 *
 * 
 */

#ifndef OAIListTrainingJobsRequest_H
#define OAIListTrainingJobsRequest_H
...
class OAIListTrainingJobsRequest : public OAIObject {
public:
    OAIListTrainingJobsRequest();
    OAIListTrainingJobsRequest(QString json);
    ~OAIListTrainingJobsRequest() override;
    ...
    OAITrainingJobStatus getStatusEquals() const;
    void setStatusEquals(const OAITrainingJobStatus &status_equals);
    ...
    OAIWarmPoolResourceStatus getWarmPoolStatusEquals() const;
    void setWarmPoolStatusEquals(const OAIWarmPoolResourceStatus &warm_pool_status_equals);
    bool is_warm_pool_status_equals_Set() const;
    bool is_warm_pool_status_equals_Valid() const;
...
private:
    ...
    OAITrainingJobStatus m_status_equals;
    ...
    OAIWarmPoolResourceStatus m_warm_pool_status_equals;
    bool m_warm_pool_status_equals_isSet;
    bool m_warm_pool_status_equals_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListTrainingJobsRequest)

#endif // OAIListTrainingJobsRequest_H
