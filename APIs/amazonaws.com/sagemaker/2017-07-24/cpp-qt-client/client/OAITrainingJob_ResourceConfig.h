...
/*
 * OAITrainingJob_ResourceConfig.h
 *
 * 
 */

#ifndef OAITrainingJob_ResourceConfig_H
#define OAITrainingJob_ResourceConfig_H
...
class OAITrainingJob_ResourceConfig : public OAIObject {
public:
    OAITrainingJob_ResourceConfig();
    OAITrainingJob_ResourceConfig(QString json);
    ~OAITrainingJob_ResourceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingJob_ResourceConfig)

#endif // OAITrainingJob_ResourceConfig_H
