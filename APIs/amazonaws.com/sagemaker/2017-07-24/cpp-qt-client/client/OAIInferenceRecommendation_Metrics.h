...
/*
 * OAIInferenceRecommendation_Metrics.h
 *
 * 
 */

#ifndef OAIInferenceRecommendation_Metrics_H
#define OAIInferenceRecommendation_Metrics_H
...
class OAIInferenceRecommendation_Metrics : public OAIObject {
public:
    OAIInferenceRecommendation_Metrics();
    OAIInferenceRecommendation_Metrics(QString json);
    ~OAIInferenceRecommendation_Metrics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInferenceRecommendation_Metrics)

#endif // OAIInferenceRecommendation_Metrics_H
