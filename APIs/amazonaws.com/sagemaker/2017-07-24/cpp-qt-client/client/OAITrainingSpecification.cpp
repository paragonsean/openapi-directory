...
#include "OAITrainingSpecification.h"
...
OAITrainingSpecification::OAITrainingSpecification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrainingSpecification::OAITrainingSpecification() {
    this->initializeModel();
}

OAITrainingSpecification::~OAITrainingSpecification() {}

void OAITrainingSpecification::initializeModel() {
...
void OAITrainingSpecification::fromJson(QString jsonString) {
...
void OAITrainingSpecification::fromJsonObject(QJsonObject json) {
...
QString OAITrainingSpecification::asJson() const {
...
QJsonObject OAITrainingSpecification::asJsonObject() const {
    QJsonObject obj;
...
QString OAITrainingSpecification::getTrainingImage() const {
    return m_training_image;
}
void OAITrainingSpecification::setTrainingImage(const QString &training_image) {
    m_training_image = training_image;
    m_training_image_isSet = true;
}

bool OAITrainingSpecification::is_training_image_Set() const{
    return m_training_image_isSet;
}

bool OAITrainingSpecification::is_training_image_Valid() const{
    return m_training_image_isValid;
}

QString OAITrainingSpecification::getTrainingImageDigest() const {
    return m_training_image_digest;
}
void OAITrainingSpecification::setTrainingImageDigest(const QString &training_image_digest) {
    m_training_image_digest = training_image_digest;
    m_training_image_digest_isSet = true;
}

bool OAITrainingSpecification::is_training_image_digest_Set() const{
    return m_training_image_digest_isSet;
}

bool OAITrainingSpecification::is_training_image_digest_Valid() const{
    return m_training_image_digest_isValid;
}

QList OAITrainingSpecification::getSupportedHyperParameters() const {
    return m_supported_hyper_parameters;
}
void OAITrainingSpecification::setSupportedHyperParameters(const QList &supported_hyper_parameters) {
    m_supported_hyper_parameters = supported_hyper_parameters;
    m_supported_hyper_parameters_isSet = true;
}

bool OAITrainingSpecification::is_supported_hyper_parameters_Set() const{
    return m_supported_hyper_parameters_isSet;
}

bool OAITrainingSpecification::is_supported_hyper_parameters_Valid() const{
    return m_supported_hyper_parameters_isValid;
}

QList OAITrainingSpecification::getSupportedTrainingInstanceTypes() const {
    return m_supported_training_instance_types;
}
void OAITrainingSpecification::setSupportedTrainingInstanceTypes(const QList &supported_training_instance_types) {
    m_supported_training_instance_types = supported_training_instance_types;
    m_supported_training_instance_types_isSet = true;
}

bool OAITrainingSpecification::is_supported_training_instance_types_Set() const{
    return m_supported_training_instance_types_isSet;
}

bool OAITrainingSpecification::is_supported_training_instance_types_Valid() const{
    return m_supported_training_instance_types_isValid;
}

bool OAITrainingSpecification::getSupportsDistributedTraining() const {
    return m_supports_distributed_training;
}
void OAITrainingSpecification::setSupportsDistributedTraining(const bool &supports_distributed_training) {
    m_supports_distributed_training = supports_distributed_training;
    m_supports_distributed_training_isSet = true;
}

bool OAITrainingSpecification::is_supports_distributed_training_Set() const{
    return m_supports_distributed_training_isSet;
}

bool OAITrainingSpecification::is_supports_distributed_training_Valid() const{
    return m_supports_distributed_training_isValid;
}

QList OAITrainingSpecification::getMetricDefinitions() const {
    return m_metric_definitions;
}
void OAITrainingSpecification::setMetricDefinitions(const QList &metric_definitions) {
    m_metric_definitions = metric_definitions;
    m_metric_definitions_isSet = true;
}

bool OAITrainingSpecification::is_metric_definitions_Set() const{
    return m_metric_definitions_isSet;
}

bool OAITrainingSpecification::is_metric_definitions_Valid() const{
    return m_metric_definitions_isValid;
}

QList OAITrainingSpecification::getTrainingChannels() const {
    return m_training_channels;
}
void OAITrainingSpecification::setTrainingChannels(const QList &training_channels) {
    m_training_channels = training_channels;
    m_training_channels_isSet = true;
}

bool OAITrainingSpecification::is_training_channels_Set() const{
    return m_training_channels_isSet;
}

bool OAITrainingSpecification::is_training_channels_Valid() const{
    return m_training_channels_isValid;
}

QList OAITrainingSpecification::getSupportedTuningJobObjectiveMetrics() const {
    return m_supported_tuning_job_objective_metrics;
}
void OAITrainingSpecification::setSupportedTuningJobObjectiveMetrics(const QList &supported_tuning_job_objective_metrics) {
...
bool OAITrainingSpecification::is_supported_tuning_job_objective_metrics_Set() const{
    return m_supported_tuning_job_objective_metrics_isSet;
}

bool OAITrainingSpecification::is_supported_tuning_job_objective_metrics_Valid() const{
    return m_supported_tuning_job_objective_metrics_isValid;
}

bool OAITrainingSpecification::isSet() const {
...
bool OAITrainingSpecification::isValid() const {
