...
/*
 * OAIClarifyExplainerConfig_InferenceConfig.h
 *
 * 
 */

#ifndef OAIClarifyExplainerConfig_InferenceConfig_H
#define OAIClarifyExplainerConfig_InferenceConfig_H
...
class OAIClarifyExplainerConfig_InferenceConfig : public OAIObject {
public:
    OAIClarifyExplainerConfig_InferenceConfig();
    OAIClarifyExplainerConfig_InferenceConfig(QString json);
    ~OAIClarifyExplainerConfig_InferenceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClarifyExplainerConfig_InferenceConfig)

#endif // OAIClarifyExplainerConfig_InferenceConfig_H
