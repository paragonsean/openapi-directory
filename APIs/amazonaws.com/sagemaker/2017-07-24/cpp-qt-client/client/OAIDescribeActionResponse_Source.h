...
/*
 * OAIDescribeActionResponse_Source.h
 *
 * 
 */

#ifndef OAIDescribeActionResponse_Source_H
#define OAIDescribeActionResponse_Source_H
...
class OAIDescribeActionResponse_Source : public OAIObject {
public:
    OAIDescribeActionResponse_Source();
    OAIDescribeActionResponse_Source(QString json);
    ~OAIDescribeActionResponse_Source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeActionResponse_Source)

#endif // OAIDescribeActionResponse_Source_H
