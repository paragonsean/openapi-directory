...
/*
 * OAIDescribeDataQualityJobDefinitionResponse_DataQualityAppSpecification.h
 *
 * 
 */

#ifndef OAIDescribeDataQualityJobDefinitionResponse_DataQualityAppSpecification_H
#define OAIDescribeDataQualityJobDefinitionResponse_DataQualityAppSpecification_H
...
class OAIDescribeDataQualityJobDefinitionResponse_DataQualityAppSpecification : public OAIObject {
public:
    OAIDescribeDataQualityJobDefinitionResponse_DataQualityAppSpecification();
    OAIDescribeDataQualityJobDefinitionResponse_DataQualityAppSpecification(QString json);
    ~OAIDescribeDataQualityJobDefinitionResponse_DataQualityAppSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDataQualityJobDefinitionResponse_DataQualityAppSpecification)

#endif // OAIDescribeDataQualityJobDefinitionResponse_DataQualityAppSpecification_H
