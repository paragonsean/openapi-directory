...
/*
 * OAIServiceCatalogProvisioningDetails.h
 *
...
#ifndef OAIServiceCatalogProvisioningDetails_H
#define OAIServiceCatalogProvisioningDetails_H
...
class OAIServiceCatalogProvisioningDetails : public OAIObject {
public:
    OAIServiceCatalogProvisioningDetails();
    OAIServiceCatalogProvisioningDetails(QString json);
    ~OAIServiceCatalogProvisioningDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceCatalogProvisioningDetails)

#endif // OAIServiceCatalogProvisioningDetails_H
