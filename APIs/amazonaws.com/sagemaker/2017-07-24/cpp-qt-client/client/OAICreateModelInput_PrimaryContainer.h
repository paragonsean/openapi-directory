...
/*
 * OAICreateModelInput_PrimaryContainer.h
 *
 * 
 */

#ifndef OAICreateModelInput_PrimaryContainer_H
#define OAICreateModelInput_PrimaryContainer_H
...
class OAICreateModelInput_PrimaryContainer : public OAIObject {
public:
    OAICreateModelInput_PrimaryContainer();
    OAICreateModelInput_PrimaryContainer(QString json);
    ~OAICreateModelInput_PrimaryContainer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateModelInput_PrimaryContainer)

#endif // OAICreateModelInput_PrimaryContainer_H
