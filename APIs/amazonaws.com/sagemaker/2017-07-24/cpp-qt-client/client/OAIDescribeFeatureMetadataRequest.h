...
/*
 * OAIDescribeFeatureMetadataRequest.h
 *
 * 
 */

#ifndef OAIDescribeFeatureMetadataRequest_H
#define OAIDescribeFeatureMetadataRequest_H
...
class OAIDescribeFeatureMetadataRequest : public OAIObject {
public:
    OAIDescribeFeatureMetadataRequest();
    OAIDescribeFeatureMetadataRequest(QString json);
    ~OAIDescribeFeatureMetadataRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFeatureMetadataRequest)

#endif // OAIDescribeFeatureMetadataRequest_H
