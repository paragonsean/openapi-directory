...
#ifndef OAITrialSource_H
#define OAITrialSource_H
...
class OAITrialSource : public OAIObject {
public:
    OAITrialSource();
    OAITrialSource(QString json);
    ~OAITrialSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrialSource)

#endif // OAITrialSource_H
