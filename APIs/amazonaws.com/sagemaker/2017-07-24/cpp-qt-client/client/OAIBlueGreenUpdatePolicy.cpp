...
#include "OAIBlueGreenUpdatePolicy.h"
...
OAIBlueGreenUpdatePolicy::OAIBlueGreenUpdatePolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBlueGreenUpdatePolicy::OAIBlueGreenUpdatePolicy() {
    this->initializeModel();
}

OAIBlueGreenUpdatePolicy::~OAIBlueGreenUpdatePolicy() {}

void OAIBlueGreenUpdatePolicy::initializeModel() {
...
void OAIBlueGreenUpdatePolicy::fromJson(QString jsonString) {
...
void OAIBlueGreenUpdatePolicy::fromJsonObject(QJsonObject json) {
...
QString OAIBlueGreenUpdatePolicy::asJson() const {
...
QJsonObject OAIBlueGreenUpdatePolicy::asJsonObject() const {
    QJsonObject obj;
...
OAIBlueGreenUpdatePolicy_TrafficRoutingConfiguration OAIBlueGreenUpdatePolicy::getTrafficRoutingConfiguration() const {
    return m_traffic_routing_configuration;
}
void OAIBlueGreenUpdatePolicy::setTrafficRoutingConfiguration(const OAIBlueGreenUpdatePolicy_TrafficRoutingConfiguration &traffic_routing_configuration) {
    m_traffic_routing_configuration = traffic_routing_configuration;
    m_traffic_routing_configuration_isSet = true;
}

bool OAIBlueGreenUpdatePolicy::is_traffic_routing_configuration_Set() const{
    return m_traffic_routing_configuration_isSet;
}

bool OAIBlueGreenUpdatePolicy::is_traffic_routing_configuration_Valid() const{
    return m_traffic_routing_configuration_isValid;
}

qint32 OAIBlueGreenUpdatePolicy::getTerminationWaitInSeconds() const {
    return m_termination_wait_in_seconds;
}
void OAIBlueGreenUpdatePolicy::setTerminationWaitInSeconds(const qint32 &termination_wait_in_seconds) {
    m_termination_wait_in_seconds = termination_wait_in_seconds;
    m_termination_wait_in_seconds_isSet = true;
}

bool OAIBlueGreenUpdatePolicy::is_termination_wait_in_seconds_Set() const{
    return m_termination_wait_in_seconds_isSet;
}

bool OAIBlueGreenUpdatePolicy::is_termination_wait_in_seconds_Valid() const{
    return m_termination_wait_in_seconds_isValid;
}

qint32 OAIBlueGreenUpdatePolicy::getMaximumExecutionTimeoutInSeconds() const {
    return m_maximum_execution_timeout_in_seconds;
}
void OAIBlueGreenUpdatePolicy::setMaximumExecutionTimeoutInSeconds(const qint32 &maximum_execution_timeout_in_seconds) {
...
bool OAIBlueGreenUpdatePolicy::is_maximum_execution_timeout_in_seconds_Set() const{
    return m_maximum_execution_timeout_in_seconds_isSet;
}

bool OAIBlueGreenUpdatePolicy::is_maximum_execution_timeout_in_seconds_Valid() const{
    return m_maximum_execution_timeout_in_seconds_isValid;
}

bool OAIBlueGreenUpdatePolicy::isSet() const {
...
bool OAIBlueGreenUpdatePolicy::isValid() const {
