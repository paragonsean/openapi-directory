...
QString OAIProject::getProjectArn() const {
    return m_project_arn;
}
void OAIProject::setProjectArn(const QString &project_arn) {
    m_project_arn = project_arn;
    m_project_arn_isSet = true;
}

bool OAIProject::is_project_arn_Set() const{
    return m_project_arn_isSet;
}

bool OAIProject::is_project_arn_Valid() const{
    return m_project_arn_isValid;
}

QString OAIProject::getProjectName() const {
    return m_project_name;
}
void OAIProject::setProjectName(const QString &project_name) {
    m_project_name = project_name;
    m_project_name_isSet = true;
}

bool OAIProject::is_project_name_Set() const{
    return m_project_name_isSet;
}

bool OAIProject::is_project_name_Valid() const{
...
QString OAIProject::getProjectDescription() const {
    return m_project_description;
}
void OAIProject::setProjectDescription(const QString &project_description) {
    m_project_description = project_description;
    m_project_description_isSet = true;
}

bool OAIProject::is_project_description_Set() const{
    return m_project_description_isSet;
}

bool OAIProject::is_project_description_Valid() const{
    return m_project_description_isValid;
}

OAIServiceCatalogProvisioningDetails OAIProject::getServiceCatalogProvisioningDetails() const {
    return m_service_catalog_provisioning_details;
}
void OAIProject::setServiceCatalogProvisioningDetails(const OAIServiceCatalogProvisioningDetails &service_catalog_provisioning_details) {
...
bool OAIProject::is_service_catalog_provisioning_details_Set() const{
    return m_service_catalog_provisioning_details_isSet;
}

bool OAIProject::is_service_catalog_provisioning_details_Valid() const{
    return m_service_catalog_provisioning_details_isValid;
}

OAIServiceCatalogProvisionedProductDetails OAIProject::getServiceCatalogProvisionedProductDetails() const {
    return m_service_catalog_provisioned_product_details;
}
void OAIProject::setServiceCatalogProvisionedProductDetails(const OAIServiceCatalogProvisionedProductDetails &service_catalog_provisioned_product_details) {
...
bool OAIProject::is_service_catalog_provisioned_product_details_Set() const{
    return m_service_catalog_provisioned_product_details_isSet;
}

bool OAIProject::is_service_catalog_provisioned_product_details_Valid() const{
    return m_service_catalog_provisioned_product_details_isValid;
}

OAIProjectStatus OAIProject::getProjectStatus() const {
    return m_project_status;
}
void OAIProject::setProjectStatus(const OAIProjectStatus &project_status) {
    m_project_status = project_status;
    m_project_status_isSet = true;
}

bool OAIProject::is_project_status_Set() const{
    return m_project_status_isSet;
}

bool OAIProject::is_project_status_Valid() const{
    return m_project_status_isValid;
}

OAIProject_CreatedBy OAIProject::getCreatedBy() const {
    return m_created_by;
}
void OAIProject::setCreatedBy(const OAIProject_CreatedBy &created_by) {
...
QDateTime OAIProject::getCreationTime() const {
    return m_creation_time;
}
void OAIProject::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIProject::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIProject::is_creation_time_Valid() const{
...
QDateTime OAIProject::getLastModifiedTime() const {
    return m_last_modified_time;
}
void OAIProject::setLastModifiedTime(const QDateTime &last_modified_time) {
    m_last_modified_time = last_modified_time;
    m_last_modified_time_isSet = true;
}

bool OAIProject::is_last_modified_time_Set() const{
    return m_last_modified_time_isSet;
}

bool OAIProject::is_last_modified_time_Valid() const{
    return m_last_modified_time_isValid;
}

OAIUserContext OAIProject::getLastModifiedBy() const {
    return m_last_modified_by;
}
void OAIProject::setLastModifiedBy(const OAIUserContext &last_modified_by) {
    m_last_modified_by = last_modified_by;
    m_last_modified_by_isSet = true;
}

bool OAIProject::is_last_modified_by_Set() const{
    return m_last_modified_by_isSet;
}

bool OAIProject::is_last_modified_by_Valid() const{
