...
/*
 * OAICreateModelInput_VpcConfig.h
 *
 * 
 */

#ifndef OAICreateModelInput_VpcConfig_H
#define OAICreateModelInput_VpcConfig_H
...
class OAICreateModelInput_VpcConfig : public OAIObject {
public:
    OAICreateModelInput_VpcConfig();
    OAICreateModelInput_VpcConfig(QString json);
    ~OAICreateModelInput_VpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateModelInput_VpcConfig)

#endif // OAICreateModelInput_VpcConfig_H
