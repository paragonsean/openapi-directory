...
OAIListLabelingJobsRequest::OAIListLabelingJobsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListLabelingJobsRequest::OAIListLabelingJobsRequest() {
    this->initializeModel();
}

OAIListLabelingJobsRequest::~OAIListLabelingJobsRequest() {}

void OAIListLabelingJobsRequest::initializeModel() {
...
void OAIListLabelingJobsRequest::fromJson(QString jsonString) {
...
void OAIListLabelingJobsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListLabelingJobsRequest::asJson() const {
...
QJsonObject OAIListLabelingJobsRequest::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIListLabelingJobsRequest::getCreationTimeAfter() const {
    return m_creation_time_after;
}
void OAIListLabelingJobsRequest::setCreationTimeAfter(const QDateTime &creation_time_after) {
    m_creation_time_after = creation_time_after;
    m_creation_time_after_isSet = true;
}

bool OAIListLabelingJobsRequest::is_creation_time_after_Set() const{
    return m_creation_time_after_isSet;
}

bool OAIListLabelingJobsRequest::is_creation_time_after_Valid() const{
    return m_creation_time_after_isValid;
}

QDateTime OAIListLabelingJobsRequest::getCreationTimeBefore() const {
    return m_creation_time_before;
}
void OAIListLabelingJobsRequest::setCreationTimeBefore(const QDateTime &creation_time_before) {
    m_creation_time_before = creation_time_before;
    m_creation_time_before_isSet = true;
}

bool OAIListLabelingJobsRequest::is_creation_time_before_Set() const{
    return m_creation_time_before_isSet;
}

bool OAIListLabelingJobsRequest::is_creation_time_before_Valid() const{
    return m_creation_time_before_isValid;
}

QDateTime OAIListLabelingJobsRequest::getLastModifiedTimeAfter() const {
    return m_last_modified_time_after;
}
void OAIListLabelingJobsRequest::setLastModifiedTimeAfter(const QDateTime &last_modified_time_after) {
    m_last_modified_time_after = last_modified_time_after;
    m_last_modified_time_after_isSet = true;
}

bool OAIListLabelingJobsRequest::is_last_modified_time_after_Set() const{
    return m_last_modified_time_after_isSet;
}

bool OAIListLabelingJobsRequest::is_last_modified_time_after_Valid() const{
    return m_last_modified_time_after_isValid;
}

QDateTime OAIListLabelingJobsRequest::getLastModifiedTimeBefore() const {
    return m_last_modified_time_before;
}
void OAIListLabelingJobsRequest::setLastModifiedTimeBefore(const QDateTime &last_modified_time_before) {
    m_last_modified_time_before = last_modified_time_before;
    m_last_modified_time_before_isSet = true;
}

bool OAIListLabelingJobsRequest::is_last_modified_time_before_Set() const{
    return m_last_modified_time_before_isSet;
}

bool OAIListLabelingJobsRequest::is_last_modified_time_before_Valid() const{
    return m_last_modified_time_before_isValid;
}

qint32 OAIListLabelingJobsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListLabelingJobsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListLabelingJobsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListLabelingJobsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListLabelingJobsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListLabelingJobsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListLabelingJobsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListLabelingJobsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QString OAIListLabelingJobsRequest::getNameContains() const {
    return m_name_contains;
}
void OAIListLabelingJobsRequest::setNameContains(const QString &name_contains) {
    m_name_contains = name_contains;
    m_name_contains_isSet = true;
}

bool OAIListLabelingJobsRequest::is_name_contains_Set() const{
    return m_name_contains_isSet;
}

bool OAIListLabelingJobsRequest::is_name_contains_Valid() const{
    return m_name_contains_isValid;
}

OAISortBy OAIListLabelingJobsRequest::getSortBy() const {
    return m_sort_by;
}
void OAIListLabelingJobsRequest::setSortBy(const OAISortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIListLabelingJobsRequest::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIListLabelingJobsRequest::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAISortOrder OAIListLabelingJobsRequest::getSortOrder() const {
    return m_sort_order;
}
void OAIListLabelingJobsRequest::setSortOrder(const OAISortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIListLabelingJobsRequest::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIListLabelingJobsRequest::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

OAILabelingJobStatus OAIListLabelingJobsRequest::getStatusEquals() const {
    return m_status_equals;
}
void OAIListLabelingJobsRequest::setStatusEquals(const OAILabelingJobStatus &status_equals) {
    m_status_equals = status_equals;
    m_status_equals_isSet = true;
}

bool OAIListLabelingJobsRequest::is_status_equals_Set() const{
    return m_status_equals_isSet;
}

bool OAIListLabelingJobsRequest::is_status_equals_Valid() const{
    return m_status_equals_isValid;
}

bool OAIListLabelingJobsRequest::isSet() const {
...
bool OAIListLabelingJobsRequest::isValid() const {
