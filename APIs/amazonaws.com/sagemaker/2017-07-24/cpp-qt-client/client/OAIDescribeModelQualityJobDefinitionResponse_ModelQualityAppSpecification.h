...
/*
 * OAIDescribeModelQualityJobDefinitionResponse_ModelQualityAppSpecification.h
 *
 * 
 */

#ifndef OAIDescribeModelQualityJobDefinitionResponse_ModelQualityAppSpecification_H
#define OAIDescribeModelQualityJobDefinitionResponse_ModelQualityAppSpecification_H
...
class OAIDescribeModelQualityJobDefinitionResponse_ModelQualityAppSpecification : public OAIObject {
public:
    OAIDescribeModelQualityJobDefinitionResponse_ModelQualityAppSpecification();
    OAIDescribeModelQualityJobDefinitionResponse_ModelQualityAppSpecification(QString json);
    ~OAIDescribeModelQualityJobDefinitionResponse_ModelQualityAppSpecification() override;
    ...
    OAIMonitoringProblemType getProblemType() const;
    void setProblemType(const OAIMonitoringProblemType &problem_type);
...
private:
    ...
    OAIMonitoringProblemType m_problem_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeModelQualityJobDefinitionResponse_ModelQualityAppSpecification)

#endif // OAIDescribeModelQualityJobDefinitionResponse_ModelQualityAppSpecification_H
