...
/*
 * OAICreateLabelingJobRequest_StoppingConditions.h
 *
 * 
 */

#ifndef OAICreateLabelingJobRequest_StoppingConditions_H
#define OAICreateLabelingJobRequest_StoppingConditions_H
...
class OAICreateLabelingJobRequest_StoppingConditions : public OAIObject {
public:
    OAICreateLabelingJobRequest_StoppingConditions();
    OAICreateLabelingJobRequest_StoppingConditions(QString json);
    ~OAICreateLabelingJobRequest_StoppingConditions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLabelingJobRequest_StoppingConditions)

#endif // OAICreateLabelingJobRequest_StoppingConditions_H
