...
/*
 * OAIListFlowDefinitionsRequest.h
 *
 * 
 */

#ifndef OAIListFlowDefinitionsRequest_H
#define OAIListFlowDefinitionsRequest_H
...
class OAIListFlowDefinitionsRequest : public OAIObject {
public:
    OAIListFlowDefinitionsRequest();
    OAIListFlowDefinitionsRequest(QString json);
    ~OAIListFlowDefinitionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFlowDefinitionsRequest)

#endif // OAIListFlowDefinitionsRequest_H
