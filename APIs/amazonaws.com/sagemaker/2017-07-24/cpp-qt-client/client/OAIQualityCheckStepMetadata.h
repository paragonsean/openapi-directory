...
#ifndef OAIQualityCheckStepMetadata_H
#define OAIQualityCheckStepMetadata_H
...
class OAIQualityCheckStepMetadata : public OAIObject {
public:
    OAIQualityCheckStepMetadata();
    OAIQualityCheckStepMetadata(QString json);
    ~OAIQualityCheckStepMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQualityCheckStepMetadata)

#endif // OAIQualityCheckStepMetadata_H
