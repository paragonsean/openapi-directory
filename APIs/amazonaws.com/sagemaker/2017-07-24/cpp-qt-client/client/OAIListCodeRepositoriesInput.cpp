...
OAIListCodeRepositoriesInput::OAIListCodeRepositoriesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListCodeRepositoriesInput::OAIListCodeRepositoriesInput() {
    this->initializeModel();
}

OAIListCodeRepositoriesInput::~OAIListCodeRepositoriesInput() {}

void OAIListCodeRepositoriesInput::initializeModel() {
...
void OAIListCodeRepositoriesInput::fromJson(QString jsonString) {
...
void OAIListCodeRepositoriesInput::fromJsonObject(QJsonObject json) {
...
QString OAIListCodeRepositoriesInput::asJson() const {
...
QJsonObject OAIListCodeRepositoriesInput::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIListCodeRepositoriesInput::getCreationTimeAfter() const {
    return m_creation_time_after;
}
void OAIListCodeRepositoriesInput::setCreationTimeAfter(const QDateTime &creation_time_after) {
    m_creation_time_after = creation_time_after;
    m_creation_time_after_isSet = true;
}

bool OAIListCodeRepositoriesInput::is_creation_time_after_Set() const{
    return m_creation_time_after_isSet;
}

bool OAIListCodeRepositoriesInput::is_creation_time_after_Valid() const{
    return m_creation_time_after_isValid;
}

QDateTime OAIListCodeRepositoriesInput::getCreationTimeBefore() const {
    return m_creation_time_before;
}
void OAIListCodeRepositoriesInput::setCreationTimeBefore(const QDateTime &creation_time_before) {
    m_creation_time_before = creation_time_before;
    m_creation_time_before_isSet = true;
}

bool OAIListCodeRepositoriesInput::is_creation_time_before_Set() const{
    return m_creation_time_before_isSet;
}

bool OAIListCodeRepositoriesInput::is_creation_time_before_Valid() const{
    return m_creation_time_before_isValid;
}

QDateTime OAIListCodeRepositoriesInput::getLastModifiedTimeAfter() const {
    return m_last_modified_time_after;
}
void OAIListCodeRepositoriesInput::setLastModifiedTimeAfter(const QDateTime &last_modified_time_after) {
    m_last_modified_time_after = last_modified_time_after;
    m_last_modified_time_after_isSet = true;
}

bool OAIListCodeRepositoriesInput::is_last_modified_time_after_Set() const{
    return m_last_modified_time_after_isSet;
}

bool OAIListCodeRepositoriesInput::is_last_modified_time_after_Valid() const{
    return m_last_modified_time_after_isValid;
}

QDateTime OAIListCodeRepositoriesInput::getLastModifiedTimeBefore() const {
    return m_last_modified_time_before;
}
void OAIListCodeRepositoriesInput::setLastModifiedTimeBefore(const QDateTime &last_modified_time_before) {
    m_last_modified_time_before = last_modified_time_before;
    m_last_modified_time_before_isSet = true;
}

bool OAIListCodeRepositoriesInput::is_last_modified_time_before_Set() const{
    return m_last_modified_time_before_isSet;
}

bool OAIListCodeRepositoriesInput::is_last_modified_time_before_Valid() const{
    return m_last_modified_time_before_isValid;
}

qint32 OAIListCodeRepositoriesInput::getMaxResults() const {
    return m_max_results;
}
void OAIListCodeRepositoriesInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListCodeRepositoriesInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListCodeRepositoriesInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListCodeRepositoriesInput::getNameContains() const {
    return m_name_contains;
}
void OAIListCodeRepositoriesInput::setNameContains(const QString &name_contains) {
    m_name_contains = name_contains;
    m_name_contains_isSet = true;
}

bool OAIListCodeRepositoriesInput::is_name_contains_Set() const{
    return m_name_contains_isSet;
}

bool OAIListCodeRepositoriesInput::is_name_contains_Valid() const{
    return m_name_contains_isValid;
}

QString OAIListCodeRepositoriesInput::getNextToken() const {
    return m_next_token;
}
void OAIListCodeRepositoriesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListCodeRepositoriesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListCodeRepositoriesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

OAICodeRepositorySortBy OAIListCodeRepositoriesInput::getSortBy() const {
    return m_sort_by;
}
void OAIListCodeRepositoriesInput::setSortBy(const OAICodeRepositorySortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIListCodeRepositoriesInput::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIListCodeRepositoriesInput::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAICodeRepositorySortOrder OAIListCodeRepositoriesInput::getSortOrder() const {
    return m_sort_order;
}
void OAIListCodeRepositoriesInput::setSortOrder(const OAICodeRepositorySortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIListCodeRepositoriesInput::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIListCodeRepositoriesInput::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

bool OAIListCodeRepositoriesInput::isSet() const {
...
bool OAIListCodeRepositoriesInput::isValid() const {
