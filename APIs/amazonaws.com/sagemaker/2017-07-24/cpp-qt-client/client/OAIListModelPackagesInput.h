...
/*
 * OAIListModelPackagesInput.h
 *
 * 
 */

#ifndef OAIListModelPackagesInput_H
#define OAIListModelPackagesInput_H
...
class OAIListModelPackagesInput : public OAIObject {
public:
    OAIListModelPackagesInput();
    OAIListModelPackagesInput(QString json);
    ~OAIListModelPackagesInput() override;
    ...
    OAIModelPackageType getModelPackageType() const;
    void setModelPackageType(const OAIModelPackageType &model_package_type);
    bool is_model_package_type_Set() const;
    bool is_model_package_type_Valid() const;
    ...
    OAIModelPackageSortBy getSortBy() const;
    void setSortBy(const OAIModelPackageSortBy &sort_by);
...
private:
    ...
    OAIModelPackageType m_model_package_type;
    bool m_model_package_type_isSet;
    bool m_model_package_type_isValid;

    QString m_next_token;
    bool m_next_token_isSet;
    bool m_next_token_isValid;

    OAIModelPackageSortBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListModelPackagesInput)

#endif // OAIListModelPackagesInput_H
