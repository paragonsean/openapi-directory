...
/*
 * OAIProcessingOutputConfig.h
 *
 * Configuration for uploading output from the processing container.
 */

#ifndef OAIProcessingOutputConfig_H
#define OAIProcessingOutputConfig_H
...
class OAIProcessingOutputConfig : public OAIObject {
public:
    OAIProcessingOutputConfig();
    OAIProcessingOutputConfig(QString json);
    ~OAIProcessingOutputConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProcessingOutputConfig)

#endif // OAIProcessingOutputConfig_H
