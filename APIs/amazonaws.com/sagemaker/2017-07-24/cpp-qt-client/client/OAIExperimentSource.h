...
/*
 * OAIExperimentSource.h
 *
 * The source of the experiment.
 */

#ifndef OAIExperimentSource_H
#define OAIExperimentSource_H
...
class OAIExperimentSource : public OAIObject {
public:
    OAIExperimentSource();
    OAIExperimentSource(QString json);
    ~OAIExperimentSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExperimentSource)

#endif // OAIExperimentSource_H
