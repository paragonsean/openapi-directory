...
/*
 * OAIDeleteAssociationRequest.h
 *
 * 
 */

#ifndef OAIDeleteAssociationRequest_H
#define OAIDeleteAssociationRequest_H
...
class OAIDeleteAssociationRequest : public OAIObject {
public:
    OAIDeleteAssociationRequest();
    OAIDeleteAssociationRequest(QString json);
    ~OAIDeleteAssociationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAssociationRequest)

#endif // OAIDeleteAssociationRequest_H
