...
/*
 * OAIDataQualityJobInput_BatchTransformInput.h
 *
 * 
 */

#ifndef OAIDataQualityJobInput_BatchTransformInput_H
#define OAIDataQualityJobInput_BatchTransformInput_H
...
class OAIDataQualityJobInput_BatchTransformInput : public OAIObject {
public:
    OAIDataQualityJobInput_BatchTransformInput();
    OAIDataQualityJobInput_BatchTransformInput(QString json);
    ~OAIDataQualityJobInput_BatchTransformInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataQualityJobInput_BatchTransformInput)

#endif // OAIDataQualityJobInput_BatchTransformInput_H
