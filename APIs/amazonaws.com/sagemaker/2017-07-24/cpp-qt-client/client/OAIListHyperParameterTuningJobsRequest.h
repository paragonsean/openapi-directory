...
/*
 * OAIListHyperParameterTuningJobsRequest.h
 *
 * 
 */

#ifndef OAIListHyperParameterTuningJobsRequest_H
#define OAIListHyperParameterTuningJobsRequest_H
...
class OAIListHyperParameterTuningJobsRequest : public OAIObject {
public:
    OAIListHyperParameterTuningJobsRequest();
    OAIListHyperParameterTuningJobsRequest(QString json);
    ~OAIListHyperParameterTuningJobsRequest() override;
    ...
    OAIHyperParameterTuningJobSortByOptions getSortBy() const;
    void setSortBy(const OAIHyperParameterTuningJobSortByOptions &sort_by);
    ...
    OAIHyperParameterTuningJobStatus getStatusEquals() const;
    void setStatusEquals(const OAIHyperParameterTuningJobStatus &status_equals);
...
private:
    ...
    OAIHyperParameterTuningJobSortByOptions m_sort_by;
    ...
    OAIHyperParameterTuningJobStatus m_status_equals;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHyperParameterTuningJobsRequest)

#endif // OAIListHyperParameterTuningJobsRequest_H
