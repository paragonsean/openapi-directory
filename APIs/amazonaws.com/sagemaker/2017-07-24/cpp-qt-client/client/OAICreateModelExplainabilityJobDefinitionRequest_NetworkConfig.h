...
/*
 * OAICreateModelExplainabilityJobDefinitionRequest_NetworkConfig.h
 *
 * 
 */

#ifndef OAICreateModelExplainabilityJobDefinitionRequest_NetworkConfig_H
#define OAICreateModelExplainabilityJobDefinitionRequest_NetworkConfig_H
...
class OAICreateModelExplainabilityJobDefinitionRequest_NetworkConfig : public OAIObject {
public:
    OAICreateModelExplainabilityJobDefinitionRequest_NetworkConfig();
    OAICreateModelExplainabilityJobDefinitionRequest_NetworkConfig(QString json);
    ~OAICreateModelExplainabilityJobDefinitionRequest_NetworkConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateModelExplainabilityJobDefinitionRequest_NetworkConfig)

#endif // OAICreateModelExplainabilityJobDefinitionRequest_NetworkConfig_H
