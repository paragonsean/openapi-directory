...
OAITrainingJob::OAITrainingJob(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrainingJob::OAITrainingJob() {
    this->initializeModel();
}

OAITrainingJob::~OAITrainingJob() {}

void OAITrainingJob::initializeModel() {
...
void OAITrainingJob::fromJson(QString jsonString) {
...
void OAITrainingJob::fromJsonObject(QJsonObject json) {
...
QString OAITrainingJob::asJson() const {
...
QJsonObject OAITrainingJob::asJsonObject() const {
    QJsonObject obj;
...
QString OAITrainingJob::getTrainingJobName() const {
    return m_training_job_name;
}
void OAITrainingJob::setTrainingJobName(const QString &training_job_name) {
    m_training_job_name = training_job_name;
    m_training_job_name_isSet = true;
}

bool OAITrainingJob::is_training_job_name_Set() const{
    return m_training_job_name_isSet;
}

bool OAITrainingJob::is_training_job_name_Valid() const{
    return m_training_job_name_isValid;
}

QString OAITrainingJob::getTrainingJobArn() const {
    return m_training_job_arn;
}
void OAITrainingJob::setTrainingJobArn(const QString &training_job_arn) {
    m_training_job_arn = training_job_arn;
    m_training_job_arn_isSet = true;
}

bool OAITrainingJob::is_training_job_arn_Set() const{
    return m_training_job_arn_isSet;
}

bool OAITrainingJob::is_training_job_arn_Valid() const{
    return m_training_job_arn_isValid;
}

QString OAITrainingJob::getTuningJobArn() const {
    return m_tuning_job_arn;
}
void OAITrainingJob::setTuningJobArn(const QString &tuning_job_arn) {
    m_tuning_job_arn = tuning_job_arn;
    m_tuning_job_arn_isSet = true;
}

bool OAITrainingJob::is_tuning_job_arn_Set() const{
    return m_tuning_job_arn_isSet;
}

bool OAITrainingJob::is_tuning_job_arn_Valid() const{
    return m_tuning_job_arn_isValid;
}

QString OAITrainingJob::getLabelingJobArn() const {
    return m_labeling_job_arn;
}
void OAITrainingJob::setLabelingJobArn(const QString &labeling_job_arn) {
    m_labeling_job_arn = labeling_job_arn;
    m_labeling_job_arn_isSet = true;
}

bool OAITrainingJob::is_labeling_job_arn_Set() const{
    return m_labeling_job_arn_isSet;
}

bool OAITrainingJob::is_labeling_job_arn_Valid() const{
    return m_labeling_job_arn_isValid;
}

QString OAITrainingJob::getAutoMlJobArn() const {
    return m_auto_ml_job_arn;
}
void OAITrainingJob::setAutoMlJobArn(const QString &auto_ml_job_arn) {
    m_auto_ml_job_arn = auto_ml_job_arn;
    m_auto_ml_job_arn_isSet = true;
}

bool OAITrainingJob::is_auto_ml_job_arn_Set() const{
    return m_auto_ml_job_arn_isSet;
}

bool OAITrainingJob::is_auto_ml_job_arn_Valid() const{
    return m_auto_ml_job_arn_isValid;
}

OAITrainingJob_ModelArtifacts OAITrainingJob::getModelArtifacts() const {
    return m_model_artifacts;
}
void OAITrainingJob::setModelArtifacts(const OAITrainingJob_ModelArtifacts &model_artifacts) {
    m_model_artifacts = model_artifacts;
    m_model_artifacts_isSet = true;
}

bool OAITrainingJob::is_model_artifacts_Set() const{
    return m_model_artifacts_isSet;
}

bool OAITrainingJob::is_model_artifacts_Valid() const{
    return m_model_artifacts_isValid;
}

OAITrainingJobStatus OAITrainingJob::getTrainingJobStatus() const {
    return m_training_job_status;
}
void OAITrainingJob::setTrainingJobStatus(const OAITrainingJobStatus &training_job_status) {
    m_training_job_status = training_job_status;
    m_training_job_status_isSet = true;
}

bool OAITrainingJob::is_training_job_status_Set() const{
    return m_training_job_status_isSet;
}

bool OAITrainingJob::is_training_job_status_Valid() const{
    return m_training_job_status_isValid;
}

OAISecondaryStatus OAITrainingJob::getSecondaryStatus() const {
    return m_secondary_status;
}
void OAITrainingJob::setSecondaryStatus(const OAISecondaryStatus &secondary_status) {
    m_secondary_status = secondary_status;
    m_secondary_status_isSet = true;
}

bool OAITrainingJob::is_secondary_status_Set() const{
    return m_secondary_status_isSet;
}

bool OAITrainingJob::is_secondary_status_Valid() const{
    return m_secondary_status_isValid;
}

QString OAITrainingJob::getFailureReason() const {
    return m_failure_reason;
}
void OAITrainingJob::setFailureReason(const QString &failure_reason) {
    m_failure_reason = failure_reason;
    m_failure_reason_isSet = true;
}

bool OAITrainingJob::is_failure_reason_Set() const{
    return m_failure_reason_isSet;
}

bool OAITrainingJob::is_failure_reason_Valid() const{
    return m_failure_reason_isValid;
}

QMap OAITrainingJob::getHyperParameters() const {
    return m_hyper_parameters;
}
void OAITrainingJob::setHyperParameters(const QMap &hyper_parameters) {
    m_hyper_parameters = hyper_parameters;
    m_hyper_parameters_isSet = true;
}

bool OAITrainingJob::is_hyper_parameters_Set() const{
    return m_hyper_parameters_isSet;
}

bool OAITrainingJob::is_hyper_parameters_Valid() const{
    return m_hyper_parameters_isValid;
}

OAITrainingJob_AlgorithmSpecification OAITrainingJob::getAlgorithmSpecification() const {
    return m_algorithm_specification;
}
void OAITrainingJob::setAlgorithmSpecification(const OAITrainingJob_AlgorithmSpecification &algorithm_specification) {
    m_algorithm_specification = algorithm_specification;
    m_algorithm_specification_isSet = true;
}

bool OAITrainingJob::is_algorithm_specification_Set() const{
    return m_algorithm_specification_isSet;
}

bool OAITrainingJob::is_algorithm_specification_Valid() const{
    return m_algorithm_specification_isValid;
}

QString OAITrainingJob::getRoleArn() const {
    return m_role_arn;
}
void OAITrainingJob::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAITrainingJob::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAITrainingJob::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QList OAITrainingJob::getInputDataConfig() const {
    return m_input_data_config;
}
void OAITrainingJob::setInputDataConfig(const QList &input_data_config) {
    m_input_data_config = input_data_config;
    m_input_data_config_isSet = true;
}

bool OAITrainingJob::is_input_data_config_Set() const{
    return m_input_data_config_isSet;
}

bool OAITrainingJob::is_input_data_config_Valid() const{
    return m_input_data_config_isValid;
}

OAITrainingJob_OutputDataConfig OAITrainingJob::getOutputDataConfig() const {
    return m_output_data_config;
}
void OAITrainingJob::setOutputDataConfig(const OAITrainingJob_OutputDataConfig &output_data_config) {
    m_output_data_config = output_data_config;
    m_output_data_config_isSet = true;
}

bool OAITrainingJob::is_output_data_config_Set() const{
    return m_output_data_config_isSet;
}

bool OAITrainingJob::is_output_data_config_Valid() const{
    return m_output_data_config_isValid;
}

OAITrainingJob_ResourceConfig OAITrainingJob::getResourceConfig() const {
    return m_resource_config;
}
void OAITrainingJob::setResourceConfig(const OAITrainingJob_ResourceConfig &resource_config) {
    m_resource_config = resource_config;
    m_resource_config_isSet = true;
}

bool OAITrainingJob::is_resource_config_Set() const{
    return m_resource_config_isSet;
}

bool OAITrainingJob::is_resource_config_Valid() const{
    return m_resource_config_isValid;
}

OAIDescribeTrainingJobResponse_VpcConfig OAITrainingJob::getVpcConfig() const {
    return m_vpc_config;
}
void OAITrainingJob::setVpcConfig(const OAIDescribeTrainingJobResponse_VpcConfig &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAITrainingJob::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAITrainingJob::is_vpc_config_Valid() const{
    return m_vpc_config_isValid;
}

OAICreateTrainingJobRequest_StoppingCondition OAITrainingJob::getStoppingCondition() const {
    return m_stopping_condition;
}
void OAITrainingJob::setStoppingCondition(const OAICreateTrainingJobRequest_StoppingCondition &stopping_condition) {
    m_stopping_condition = stopping_condition;
    m_stopping_condition_isSet = true;
}

bool OAITrainingJob::is_stopping_condition_Set() const{
    return m_stopping_condition_isSet;
}

bool OAITrainingJob::is_stopping_condition_Valid() const{
    return m_stopping_condition_isValid;
}

QDateTime OAITrainingJob::getCreationTime() const {
    return m_creation_time;
}
void OAITrainingJob::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAITrainingJob::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAITrainingJob::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QDateTime OAITrainingJob::getTrainingStartTime() const {
    return m_training_start_time;
}
void OAITrainingJob::setTrainingStartTime(const QDateTime &training_start_time) {
    m_training_start_time = training_start_time;
    m_training_start_time_isSet = true;
}

bool OAITrainingJob::is_training_start_time_Set() const{
    return m_training_start_time_isSet;
}

bool OAITrainingJob::is_training_start_time_Valid() const{
    return m_training_start_time_isValid;
}

QDateTime OAITrainingJob::getTrainingEndTime() const {
    return m_training_end_time;
}
void OAITrainingJob::setTrainingEndTime(const QDateTime &training_end_time) {
    m_training_end_time = training_end_time;
    m_training_end_time_isSet = true;
}

bool OAITrainingJob::is_training_end_time_Set() const{
    return m_training_end_time_isSet;
}

bool OAITrainingJob::is_training_end_time_Valid() const{
    return m_training_end_time_isValid;
}

QDateTime OAITrainingJob::getLastModifiedTime() const {
    return m_last_modified_time;
}
void OAITrainingJob::setLastModifiedTime(const QDateTime &last_modified_time) {
    m_last_modified_time = last_modified_time;
    m_last_modified_time_isSet = true;
}

bool OAITrainingJob::is_last_modified_time_Set() const{
    return m_last_modified_time_isSet;
}

bool OAITrainingJob::is_last_modified_time_Valid() const{
    return m_last_modified_time_isValid;
}

QList OAITrainingJob::getSecondaryStatusTransitions() const {
    return m_secondary_status_transitions;
}
void OAITrainingJob::setSecondaryStatusTransitions(const QList &secondary_status_transitions) {
    m_secondary_status_transitions = secondary_status_transitions;
    m_secondary_status_transitions_isSet = true;
}

bool OAITrainingJob::is_secondary_status_transitions_Set() const{
    return m_secondary_status_transitions_isSet;
}

bool OAITrainingJob::is_secondary_status_transitions_Valid() const{
    return m_secondary_status_transitions_isValid;
}

QList OAITrainingJob::getFinalMetricDataList() const {
    return m_final_metric_data_list;
}
void OAITrainingJob::setFinalMetricDataList(const QList &final_metric_data_list) {
    m_final_metric_data_list = final_metric_data_list;
    m_final_metric_data_list_isSet = true;
}

bool OAITrainingJob::is_final_metric_data_list_Set() const{
    return m_final_metric_data_list_isSet;
}

bool OAITrainingJob::is_final_metric_data_list_Valid() const{
    return m_final_metric_data_list_isValid;
}

bool OAITrainingJob::getEnableNetworkIsolation() const {
    return m_enable_network_isolation;
}
void OAITrainingJob::setEnableNetworkIsolation(const bool &enable_network_isolation) {
    m_enable_network_isolation = enable_network_isolation;
    m_enable_network_isolation_isSet = true;
}

bool OAITrainingJob::is_enable_network_isolation_Set() const{
    return m_enable_network_isolation_isSet;
}

bool OAITrainingJob::is_enable_network_isolation_Valid() const{
    return m_enable_network_isolation_isValid;
}

bool OAITrainingJob::getEnableInterContainerTrafficEncryption() const {
    return m_enable_inter_container_traffic_encryption;
}
void OAITrainingJob::setEnableInterContainerTrafficEncryption(const bool &enable_inter_container_traffic_encryption) {
...
bool OAITrainingJob::is_enable_inter_container_traffic_encryption_Set() const{
    return m_enable_inter_container_traffic_encryption_isSet;
}

bool OAITrainingJob::is_enable_inter_container_traffic_encryption_Valid() const{
    return m_enable_inter_container_traffic_encryption_isValid;
}

bool OAITrainingJob::getEnableManagedSpotTraining() const {
    return m_enable_managed_spot_training;
}
void OAITrainingJob::setEnableManagedSpotTraining(const bool &enable_managed_spot_training) {
    m_enable_managed_spot_training = enable_managed_spot_training;
    m_enable_managed_spot_training_isSet = true;
}

bool OAITrainingJob::is_enable_managed_spot_training_Set() const{
    return m_enable_managed_spot_training_isSet;
}

bool OAITrainingJob::is_enable_managed_spot_training_Valid() const{
    return m_enable_managed_spot_training_isValid;
}

OAICheckpointConfig OAITrainingJob::getCheckpointConfig() const {
    return m_checkpoint_config;
}
void OAITrainingJob::setCheckpointConfig(const OAICheckpointConfig &checkpoint_config) {
    m_checkpoint_config = checkpoint_config;
    m_checkpoint_config_isSet = true;
}

bool OAITrainingJob::is_checkpoint_config_Set() const{
    return m_checkpoint_config_isSet;
}

bool OAITrainingJob::is_checkpoint_config_Valid() const{
    return m_checkpoint_config_isValid;
}

qint32 OAITrainingJob::getTrainingTimeInSeconds() const {
    return m_training_time_in_seconds;
}
void OAITrainingJob::setTrainingTimeInSeconds(const qint32 &training_time_in_seconds) {
    m_training_time_in_seconds = training_time_in_seconds;
    m_training_time_in_seconds_isSet = true;
}

bool OAITrainingJob::is_training_time_in_seconds_Set() const{
    return m_training_time_in_seconds_isSet;
}

bool OAITrainingJob::is_training_time_in_seconds_Valid() const{
    return m_training_time_in_seconds_isValid;
}

qint32 OAITrainingJob::getBillableTimeInSeconds() const {
    return m_billable_time_in_seconds;
}
void OAITrainingJob::setBillableTimeInSeconds(const qint32 &billable_time_in_seconds) {
    m_billable_time_in_seconds = billable_time_in_seconds;
    m_billable_time_in_seconds_isSet = true;
}

bool OAITrainingJob::is_billable_time_in_seconds_Set() const{
    return m_billable_time_in_seconds_isSet;
}

bool OAITrainingJob::is_billable_time_in_seconds_Valid() const{
    return m_billable_time_in_seconds_isValid;
}

OAIDebugHookConfig OAITrainingJob::getDebugHookConfig() const {
    return m_debug_hook_config;
}
void OAITrainingJob::setDebugHookConfig(const OAIDebugHookConfig &debug_hook_config) {
    m_debug_hook_config = debug_hook_config;
    m_debug_hook_config_isSet = true;
}

bool OAITrainingJob::is_debug_hook_config_Set() const{
    return m_debug_hook_config_isSet;
}

bool OAITrainingJob::is_debug_hook_config_Valid() const{
    return m_debug_hook_config_isValid;
}

OAIExperimentConfig OAITrainingJob::getExperimentConfig() const {
    return m_experiment_config;
}
void OAITrainingJob::setExperimentConfig(const OAIExperimentConfig &experiment_config) {
    m_experiment_config = experiment_config;
    m_experiment_config_isSet = true;
}

bool OAITrainingJob::is_experiment_config_Set() const{
    return m_experiment_config_isSet;
}

bool OAITrainingJob::is_experiment_config_Valid() const{
    return m_experiment_config_isValid;
}

QList OAITrainingJob::getDebugRuleConfigurations() const {
    return m_debug_rule_configurations;
}
void OAITrainingJob::setDebugRuleConfigurations(const QList &debug_rule_configurations) {
    m_debug_rule_configurations = debug_rule_configurations;
    m_debug_rule_configurations_isSet = true;
}

bool OAITrainingJob::is_debug_rule_configurations_Set() const{
    return m_debug_rule_configurations_isSet;
}

bool OAITrainingJob::is_debug_rule_configurations_Valid() const{
    return m_debug_rule_configurations_isValid;
}

OAITensorBoardOutputConfig OAITrainingJob::getTensorBoardOutputConfig() const {
    return m_tensor_board_output_config;
}
void OAITrainingJob::setTensorBoardOutputConfig(const OAITensorBoardOutputConfig &tensor_board_output_config) {
    m_tensor_board_output_config = tensor_board_output_config;
    m_tensor_board_output_config_isSet = true;
}

bool OAITrainingJob::is_tensor_board_output_config_Set() const{
    return m_tensor_board_output_config_isSet;
}

bool OAITrainingJob::is_tensor_board_output_config_Valid() const{
    return m_tensor_board_output_config_isValid;
}

QList OAITrainingJob::getDebugRuleEvaluationStatuses() const {
    return m_debug_rule_evaluation_statuses;
}
void OAITrainingJob::setDebugRuleEvaluationStatuses(const QList &debug_rule_evaluation_statuses) {
    m_debug_rule_evaluation_statuses = debug_rule_evaluation_statuses;
    m_debug_rule_evaluation_statuses_isSet = true;
}

bool OAITrainingJob::is_debug_rule_evaluation_statuses_Set() const{
    return m_debug_rule_evaluation_statuses_isSet;
}

bool OAITrainingJob::is_debug_rule_evaluation_statuses_Valid() const{
    return m_debug_rule_evaluation_statuses_isValid;
}

OAIProfilerConfig OAITrainingJob::getProfilerConfig() const {
    return m_profiler_config;
}
void OAITrainingJob::setProfilerConfig(const OAIProfilerConfig &profiler_config) {
    m_profiler_config = profiler_config;
    m_profiler_config_isSet = true;
}

bool OAITrainingJob::is_profiler_config_Set() const{
    return m_profiler_config_isSet;
}

bool OAITrainingJob::is_profiler_config_Valid() const{
    return m_profiler_config_isValid;
}

QMap OAITrainingJob::getEnvironment() const {
    return m_environment;
}
void OAITrainingJob::setEnvironment(const QMap &environment) {
    m_environment = environment;
    m_environment_isSet = true;
}

bool OAITrainingJob::is_environment_Set() const{
    return m_environment_isSet;
}

bool OAITrainingJob::is_environment_Valid() const{
    return m_environment_isValid;
}

OAICreateTrainingJobRequest_RetryStrategy OAITrainingJob::getRetryStrategy() const {
    return m_retry_strategy;
}
void OAITrainingJob::setRetryStrategy(const OAICreateTrainingJobRequest_RetryStrategy &retry_strategy) {
    m_retry_strategy = retry_strategy;
    m_retry_strategy_isSet = true;
}

bool OAITrainingJob::is_retry_strategy_Set() const{
    return m_retry_strategy_isSet;
}

bool OAITrainingJob::is_retry_strategy_Valid() const{
    return m_retry_strategy_isValid;
}

QList OAITrainingJob::getTags() const {
    return m_tags;
}
void OAITrainingJob::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITrainingJob::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITrainingJob::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITrainingJob::isSet() const {
...
bool OAITrainingJob::isValid() const {
