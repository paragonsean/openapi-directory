...
#include "OAIAutoMLSecurityConfig.h"
...
OAIAutoMLSecurityConfig::OAIAutoMLSecurityConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAutoMLSecurityConfig::OAIAutoMLSecurityConfig() {
    this->initializeModel();
}

OAIAutoMLSecurityConfig::~OAIAutoMLSecurityConfig() {}

void OAIAutoMLSecurityConfig::initializeModel() {
...
void OAIAutoMLSecurityConfig::fromJson(QString jsonString) {
...
void OAIAutoMLSecurityConfig::fromJsonObject(QJsonObject json) {
...
QString OAIAutoMLSecurityConfig::asJson() const {
...
QJsonObject OAIAutoMLSecurityConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAutoMLSecurityConfig::getVolumeKmsKeyId() const {
    return m_volume_kms_key_id;
}
void OAIAutoMLSecurityConfig::setVolumeKmsKeyId(const QString &volume_kms_key_id) {
    m_volume_kms_key_id = volume_kms_key_id;
    m_volume_kms_key_id_isSet = true;
}

bool OAIAutoMLSecurityConfig::is_volume_kms_key_id_Set() const{
    return m_volume_kms_key_id_isSet;
}

bool OAIAutoMLSecurityConfig::is_volume_kms_key_id_Valid() const{
    return m_volume_kms_key_id_isValid;
}

bool OAIAutoMLSecurityConfig::getEnableInterContainerTrafficEncryption() const {
    return m_enable_inter_container_traffic_encryption;
}
void OAIAutoMLSecurityConfig::setEnableInterContainerTrafficEncryption(const bool &enable_inter_container_traffic_encryption) {
...
bool OAIAutoMLSecurityConfig::is_enable_inter_container_traffic_encryption_Set() const{
    return m_enable_inter_container_traffic_encryption_isSet;
}

bool OAIAutoMLSecurityConfig::is_enable_inter_container_traffic_encryption_Valid() const{
    return m_enable_inter_container_traffic_encryption_isValid;
}

OAIAutoMLSecurityConfig_VpcConfig OAIAutoMLSecurityConfig::getVpcConfig() const {
    return m_vpc_config;
}
void OAIAutoMLSecurityConfig::setVpcConfig(const OAIAutoMLSecurityConfig_VpcConfig &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAIAutoMLSecurityConfig::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAIAutoMLSecurityConfig::is_vpc_config_Valid() const{
    return m_vpc_config_isValid;
}

bool OAIAutoMLSecurityConfig::isSet() const {
...
bool OAIAutoMLSecurityConfig::isValid() const {
