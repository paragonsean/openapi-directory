...
/*
 * OAICreateModelQualityJobDefinitionRequest_NetworkConfig.h
 *
 * 
 */

#ifndef OAICreateModelQualityJobDefinitionRequest_NetworkConfig_H
#define OAICreateModelQualityJobDefinitionRequest_NetworkConfig_H
...
class OAICreateModelQualityJobDefinitionRequest_NetworkConfig : public OAIObject {
public:
    OAICreateModelQualityJobDefinitionRequest_NetworkConfig();
    OAICreateModelQualityJobDefinitionRequest_NetworkConfig(QString json);
    ~OAICreateModelQualityJobDefinitionRequest_NetworkConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateModelQualityJobDefinitionRequest_NetworkConfig)

#endif // OAICreateModelQualityJobDefinitionRequest_NetworkConfig_H
