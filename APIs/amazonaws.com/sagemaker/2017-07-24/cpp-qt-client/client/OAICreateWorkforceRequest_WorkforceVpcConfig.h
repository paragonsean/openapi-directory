...
/*
 * OAICreateWorkforceRequest_WorkforceVpcConfig.h
 *
 * 
 */

#ifndef OAICreateWorkforceRequest_WorkforceVpcConfig_H
#define OAICreateWorkforceRequest_WorkforceVpcConfig_H
...
class OAICreateWorkforceRequest_WorkforceVpcConfig : public OAIObject {
public:
    OAICreateWorkforceRequest_WorkforceVpcConfig();
    OAICreateWorkforceRequest_WorkforceVpcConfig(QString json);
    ~OAICreateWorkforceRequest_WorkforceVpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWorkforceRequest_WorkforceVpcConfig)

#endif // OAICreateWorkforceRequest_WorkforceVpcConfig_H
