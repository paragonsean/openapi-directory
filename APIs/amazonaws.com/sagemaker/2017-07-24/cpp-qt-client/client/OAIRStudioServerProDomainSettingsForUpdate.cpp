...
#include "OAIRStudioServerProDomainSettingsForUpdate.h"
...
OAIRStudioServerProDomainSettingsForUpdate::OAIRStudioServerProDomainSettingsForUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRStudioServerProDomainSettingsForUpdate::OAIRStudioServerProDomainSettingsForUpdate() {
    this->initializeModel();
}

OAIRStudioServerProDomainSettingsForUpdate::~OAIRStudioServerProDomainSettingsForUpdate() {}

void OAIRStudioServerProDomainSettingsForUpdate::initializeModel() {
...
void OAIRStudioServerProDomainSettingsForUpdate::fromJson(QString jsonString) {
...
void OAIRStudioServerProDomainSettingsForUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIRStudioServerProDomainSettingsForUpdate::asJson() const {
...
QJsonObject OAIRStudioServerProDomainSettingsForUpdate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRStudioServerProDomainSettingsForUpdate::getDomainExecutionRoleArn() const {
    return m_domain_execution_role_arn;
}
void OAIRStudioServerProDomainSettingsForUpdate::setDomainExecutionRoleArn(const QString &domain_execution_role_arn) {
    m_domain_execution_role_arn = domain_execution_role_arn;
    m_domain_execution_role_arn_isSet = true;
}

bool OAIRStudioServerProDomainSettingsForUpdate::is_domain_execution_role_arn_Set() const{
    return m_domain_execution_role_arn_isSet;
}

bool OAIRStudioServerProDomainSettingsForUpdate::is_domain_execution_role_arn_Valid() const{
    return m_domain_execution_role_arn_isValid;
}

OAIResourceSpec OAIRStudioServerProDomainSettingsForUpdate::getDefaultResourceSpec() const {
    return m_default_resource_spec;
}
void OAIRStudioServerProDomainSettingsForUpdate::setDefaultResourceSpec(const OAIResourceSpec &default_resource_spec) {
    m_default_resource_spec = default_resource_spec;
    m_default_resource_spec_isSet = true;
}

bool OAIRStudioServerProDomainSettingsForUpdate::is_default_resource_spec_Set() const{
    return m_default_resource_spec_isSet;
}

bool OAIRStudioServerProDomainSettingsForUpdate::is_default_resource_spec_Valid() const{
    return m_default_resource_spec_isValid;
}

QString OAIRStudioServerProDomainSettingsForUpdate::getRStudioConnectUrl() const {
    return m_r_studio_connect_url;
}
void OAIRStudioServerProDomainSettingsForUpdate::setRStudioConnectUrl(const QString &r_studio_connect_url) {
    m_r_studio_connect_url = r_studio_connect_url;
    m_r_studio_connect_url_isSet = true;
}

bool OAIRStudioServerProDomainSettingsForUpdate::is_r_studio_connect_url_Set() const{
    return m_r_studio_connect_url_isSet;
}

bool OAIRStudioServerProDomainSettingsForUpdate::is_r_studio_connect_url_Valid() const{
    return m_r_studio_connect_url_isValid;
}

QString OAIRStudioServerProDomainSettingsForUpdate::getRStudioPackageManagerUrl() const {
    return m_r_studio_package_manager_url;
}
void OAIRStudioServerProDomainSettingsForUpdate::setRStudioPackageManagerUrl(const QString &r_studio_package_manager_url) {
    m_r_studio_package_manager_url = r_studio_package_manager_url;
    m_r_studio_package_manager_url_isSet = true;
}

bool OAIRStudioServerProDomainSettingsForUpdate::is_r_studio_package_manager_url_Set() const{
    return m_r_studio_package_manager_url_isSet;
}

bool OAIRStudioServerProDomainSettingsForUpdate::is_r_studio_package_manager_url_Valid() const{
    return m_r_studio_package_manager_url_isValid;
}

bool OAIRStudioServerProDomainSettingsForUpdate::isSet() const {
...
bool OAIRStudioServerProDomainSettingsForUpdate::isValid() const {
