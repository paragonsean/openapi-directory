...
OAIMonitoringJobDefinition_NetworkConfig::OAIMonitoringJobDefinition_NetworkConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMonitoringJobDefinition_NetworkConfig::OAIMonitoringJobDefinition_NetworkConfig() {
    this->initializeModel();
}

OAIMonitoringJobDefinition_NetworkConfig::~OAIMonitoringJobDefinition_NetworkConfig() {}

void OAIMonitoringJobDefinition_NetworkConfig::initializeModel() {
...
void OAIMonitoringJobDefinition_NetworkConfig::fromJson(QString jsonString) {
...
void OAIMonitoringJobDefinition_NetworkConfig::fromJsonObject(QJsonObject json) {
...
QString OAIMonitoringJobDefinition_NetworkConfig::asJson() const {
...
QJsonObject OAIMonitoringJobDefinition_NetworkConfig::asJsonObject() const {
    QJsonObject obj;
...
bool OAIMonitoringJobDefinition_NetworkConfig::getEnableInterContainerTrafficEncryption() const {
    return m_enable_inter_container_traffic_encryption;
}
void OAIMonitoringJobDefinition_NetworkConfig::setEnableInterContainerTrafficEncryption(const bool &enable_inter_container_traffic_encryption) {
...
bool OAIMonitoringJobDefinition_NetworkConfig::is_enable_inter_container_traffic_encryption_Set() const{
    return m_enable_inter_container_traffic_encryption_isSet;
}

bool OAIMonitoringJobDefinition_NetworkConfig::is_enable_inter_container_traffic_encryption_Valid() const{
    return m_enable_inter_container_traffic_encryption_isValid;
}

bool OAIMonitoringJobDefinition_NetworkConfig::getEnableNetworkIsolation() const {
    return m_enable_network_isolation;
}
void OAIMonitoringJobDefinition_NetworkConfig::setEnableNetworkIsolation(const bool &enable_network_isolation) {
    m_enable_network_isolation = enable_network_isolation;
    m_enable_network_isolation_isSet = true;
}

bool OAIMonitoringJobDefinition_NetworkConfig::is_enable_network_isolation_Set() const{
    return m_enable_network_isolation_isSet;
}

bool OAIMonitoringJobDefinition_NetworkConfig::is_enable_network_isolation_Valid() const{
    return m_enable_network_isolation_isValid;
}

OAIVpcConfig OAIMonitoringJobDefinition_NetworkConfig::getVpcConfig() const {
    return m_vpc_config;
}
void OAIMonitoringJobDefinition_NetworkConfig::setVpcConfig(const OAIVpcConfig &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAIMonitoringJobDefinition_NetworkConfig::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAIMonitoringJobDefinition_NetworkConfig::is_vpc_config_Valid() const{
    return m_vpc_config_isValid;
}

bool OAIMonitoringJobDefinition_NetworkConfig::isSet() const {
...
bool OAIMonitoringJobDefinition_NetworkConfig::isValid() const {
