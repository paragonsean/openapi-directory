...
/*
 * OAIDescribeFeatureMetadataResponse.h
 *
 * 
 */

#ifndef OAIDescribeFeatureMetadataResponse_H
#define OAIDescribeFeatureMetadataResponse_H
...
class OAIDescribeFeatureMetadataResponse : public OAIObject {
public:
    OAIDescribeFeatureMetadataResponse();
    OAIDescribeFeatureMetadataResponse(QString json);
    ~OAIDescribeFeatureMetadataResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFeatureMetadataResponse)

#endif // OAIDescribeFeatureMetadataResponse_H
