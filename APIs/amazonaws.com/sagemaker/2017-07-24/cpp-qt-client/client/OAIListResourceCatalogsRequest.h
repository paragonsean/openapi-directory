...
/*
 * OAIListResourceCatalogsRequest.h
 *
 * 
 */

#ifndef OAIListResourceCatalogsRequest_H
#define OAIListResourceCatalogsRequest_H
...
class OAIListResourceCatalogsRequest : public OAIObject {
public:
    OAIListResourceCatalogsRequest();
    OAIListResourceCatalogsRequest(QString json);
    ~OAIListResourceCatalogsRequest() override;
    ...
    OAIResourceCatalogSortOrder getSortOrder() const;
    void setSortOrder(const OAIResourceCatalogSortOrder &sort_order);
    bool is_sort_order_Set() const;
    bool is_sort_order_Valid() const;

    OAIResourceCatalogSortBy getSortBy() const;
    void setSortBy(const OAIResourceCatalogSortBy &sort_by);
...
private:
    ...
    OAIResourceCatalogSortOrder m_sort_order;
    bool m_sort_order_isSet;
    bool m_sort_order_isValid;

    OAIResourceCatalogSortBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResourceCatalogsRequest)

#endif // OAIListResourceCatalogsRequest_H
