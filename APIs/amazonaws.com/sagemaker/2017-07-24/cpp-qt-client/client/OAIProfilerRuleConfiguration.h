...
/*
 * OAIProfilerRuleConfiguration.h
 *
 * Configuration information for profiling rules.
 */

#ifndef OAIProfilerRuleConfiguration_H
#define OAIProfilerRuleConfiguration_H
...
class OAIProfilerRuleConfiguration : public OAIObject {
public:
    OAIProfilerRuleConfiguration();
    OAIProfilerRuleConfiguration(QString json);
    ~OAIProfilerRuleConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProfilerRuleConfiguration)

#endif // OAIProfilerRuleConfiguration_H
