...
bool OAINetworkConfig::getEnableInterContainerTrafficEncryption() const {
    return m_enable_inter_container_traffic_encryption;
}
void OAINetworkConfig::setEnableInterContainerTrafficEncryption(const bool &enable_inter_container_traffic_encryption) {
...
bool OAINetworkConfig::is_enable_inter_container_traffic_encryption_Set() const{
    return m_enable_inter_container_traffic_encryption_isSet;
}

bool OAINetworkConfig::is_enable_inter_container_traffic_encryption_Valid() const{
    return m_enable_inter_container_traffic_encryption_isValid;
}

bool OAINetworkConfig::getEnableNetworkIsolation() const {
    return m_enable_network_isolation;
}
void OAINetworkConfig::setEnableNetworkIsolation(const bool &enable_network_isolation) {
    m_enable_network_isolation = enable_network_isolation;
    m_enable_network_isolation_isSet = true;
}

bool OAINetworkConfig::is_enable_network_isolation_Set() const{
    return m_enable_network_isolation_isSet;
}

bool OAINetworkConfig::is_enable_network_isolation_Valid() const{
    return m_enable_network_isolation_isValid;
}

OAIVpcConfig OAINetworkConfig::getVpcConfig() const {
    return m_vpc_config;
}
void OAINetworkConfig::setVpcConfig(const OAIVpcConfig &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAINetworkConfig::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAINetworkConfig::is_vpc_config_Valid() const{
