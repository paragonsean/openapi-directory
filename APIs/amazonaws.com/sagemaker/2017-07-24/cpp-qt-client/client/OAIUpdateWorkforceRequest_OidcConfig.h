...
/*
 * OAIUpdateWorkforceRequest_OidcConfig.h
 *
 * 
 */

#ifndef OAIUpdateWorkforceRequest_OidcConfig_H
#define OAIUpdateWorkforceRequest_OidcConfig_H
...
class OAIUpdateWorkforceRequest_OidcConfig : public OAIObject {
public:
    OAIUpdateWorkforceRequest_OidcConfig();
    OAIUpdateWorkforceRequest_OidcConfig(QString json);
    ~OAIUpdateWorkforceRequest_OidcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateWorkforceRequest_OidcConfig)

#endif // OAIUpdateWorkforceRequest_OidcConfig_H
