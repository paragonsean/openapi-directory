...
/*
 * OAIListEndpointConfigsInput.h
 *
 * 
 */

#ifndef OAIListEndpointConfigsInput_H
#define OAIListEndpointConfigsInput_H
...
class OAIListEndpointConfigsInput : public OAIObject {
public:
    OAIListEndpointConfigsInput();
    OAIListEndpointConfigsInput(QString json);
    ~OAIListEndpointConfigsInput() override;
    ...
    OAIEndpointConfigSortKey getSortBy() const;
    void setSortBy(const OAIEndpointConfigSortKey &sort_by);
    bool is_sort_by_Set() const;
    bool is_sort_by_Valid() const;

    OAIOrderKey getSortOrder() const;
    void setSortOrder(const OAIOrderKey &sort_order);
...
private:
    ...
    OAIEndpointConfigSortKey m_sort_by;
    bool m_sort_by_isSet;
    bool m_sort_by_isValid;

    OAIOrderKey m_sort_order;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEndpointConfigsInput)

#endif // OAIListEndpointConfigsInput_H
