...
/*
 * OAITrainingJobDefinition_ResourceConfig.h
 *
 * 
 */

#ifndef OAITrainingJobDefinition_ResourceConfig_H
#define OAITrainingJobDefinition_ResourceConfig_H
...
class OAITrainingJobDefinition_ResourceConfig : public OAIObject {
public:
    OAITrainingJobDefinition_ResourceConfig();
    OAITrainingJobDefinition_ResourceConfig(QString json);
    ~OAITrainingJobDefinition_ResourceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingJobDefinition_ResourceConfig)

#endif // OAITrainingJobDefinition_ResourceConfig_H
