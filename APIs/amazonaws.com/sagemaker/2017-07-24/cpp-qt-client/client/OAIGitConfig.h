...
#ifndef OAIGitConfig_H
#define OAIGitConfig_H
...
class OAIGitConfig : public OAIObject {
public:
    OAIGitConfig();
    OAIGitConfig(QString json);
    ~OAIGitConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGitConfig)

#endif // OAIGitConfig_H
