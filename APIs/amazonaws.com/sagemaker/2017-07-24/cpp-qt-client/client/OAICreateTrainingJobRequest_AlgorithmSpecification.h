...
/*
 * OAICreateTrainingJobRequest_AlgorithmSpecification.h
 *
 * 
 */

#ifndef OAICreateTrainingJobRequest_AlgorithmSpecification_H
#define OAICreateTrainingJobRequest_AlgorithmSpecification_H
...
class OAICreateTrainingJobRequest_AlgorithmSpecification : public OAIObject {
public:
    OAICreateTrainingJobRequest_AlgorithmSpecification();
    OAICreateTrainingJobRequest_AlgorithmSpecification(QString json);
    ~OAICreateTrainingJobRequest_AlgorithmSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTrainingJobRequest_AlgorithmSpecification)

#endif // OAICreateTrainingJobRequest_AlgorithmSpecification_H
