...
/*
 * OAITrainingSpecification.h
 *
 * Defines how the algorithm is used for a training job.
 */

#ifndef OAITrainingSpecification_H
#define OAITrainingSpecification_H
...
class OAITrainingSpecification : public OAIObject {
public:
    OAITrainingSpecification();
    OAITrainingSpecification(QString json);
    ~OAITrainingSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingSpecification)

#endif // OAITrainingSpecification_H
