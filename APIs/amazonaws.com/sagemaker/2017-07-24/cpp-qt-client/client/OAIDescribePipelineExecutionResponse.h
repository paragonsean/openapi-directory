...
/*
 * OAIDescribePipelineExecutionResponse.h
 *
 * 
 */

#ifndef OAIDescribePipelineExecutionResponse_H
#define OAIDescribePipelineExecutionResponse_H
...
class OAIDescribePipelineExecutionResponse : public OAIObject {
public:
    OAIDescribePipelineExecutionResponse();
    OAIDescribePipelineExecutionResponse(QString json);
    ~OAIDescribePipelineExecutionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePipelineExecutionResponse)

#endif // OAIDescribePipelineExecutionResponse_H
