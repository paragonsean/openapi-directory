...
/*
 * OAIListDataQualityJobDefinitionsRequest.h
 *
 * 
 */

#ifndef OAIListDataQualityJobDefinitionsRequest_H
#define OAIListDataQualityJobDefinitionsRequest_H
...
class OAIListDataQualityJobDefinitionsRequest : public OAIObject {
public:
    OAIListDataQualityJobDefinitionsRequest();
    OAIListDataQualityJobDefinitionsRequest(QString json);
    ~OAIListDataQualityJobDefinitionsRequest() override;
    ...
    OAIMonitoringJobDefinitionSortKey getSortBy() const;
    void setSortBy(const OAIMonitoringJobDefinitionSortKey &sort_by);
...
private:
    ...
    OAIMonitoringJobDefinitionSortKey m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDataQualityJobDefinitionsRequest)

#endif // OAIListDataQualityJobDefinitionsRequest_H
