...
OAIDescribeModelOutput::OAIDescribeModelOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeModelOutput::OAIDescribeModelOutput() {
    this->initializeModel();
}

OAIDescribeModelOutput::~OAIDescribeModelOutput() {}

void OAIDescribeModelOutput::initializeModel() {
...
void OAIDescribeModelOutput::fromJson(QString jsonString) {
...
void OAIDescribeModelOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeModelOutput::asJson() const {
...
QJsonObject OAIDescribeModelOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeModelOutput::getModelName() const {
    return m_model_name;
}
void OAIDescribeModelOutput::setModelName(const QString &model_name) {
    m_model_name = model_name;
    m_model_name_isSet = true;
}

bool OAIDescribeModelOutput::is_model_name_Set() const{
    return m_model_name_isSet;
}

bool OAIDescribeModelOutput::is_model_name_Valid() const{
    return m_model_name_isValid;
}

OAIDescribeModelOutput_PrimaryContainer OAIDescribeModelOutput::getPrimaryContainer() const {
    return m_primary_container;
}
void OAIDescribeModelOutput::setPrimaryContainer(const OAIDescribeModelOutput_PrimaryContainer &primary_container) {
    m_primary_container = primary_container;
    m_primary_container_isSet = true;
}

bool OAIDescribeModelOutput::is_primary_container_Set() const{
    return m_primary_container_isSet;
}

bool OAIDescribeModelOutput::is_primary_container_Valid() const{
    return m_primary_container_isValid;
}

QList OAIDescribeModelOutput::getContainers() const {
    return m_containers;
}
void OAIDescribeModelOutput::setContainers(const QList &containers) {
    m_containers = containers;
    m_containers_isSet = true;
}

bool OAIDescribeModelOutput::is_containers_Set() const{
    return m_containers_isSet;
}

bool OAIDescribeModelOutput::is_containers_Valid() const{
    return m_containers_isValid;
}

OAICreateModelInput_InferenceExecutionConfig OAIDescribeModelOutput::getInferenceExecutionConfig() const {
    return m_inference_execution_config;
}
void OAIDescribeModelOutput::setInferenceExecutionConfig(const OAICreateModelInput_InferenceExecutionConfig &inference_execution_config) {
    m_inference_execution_config = inference_execution_config;
    m_inference_execution_config_isSet = true;
}

bool OAIDescribeModelOutput::is_inference_execution_config_Set() const{
    return m_inference_execution_config_isSet;
}

bool OAIDescribeModelOutput::is_inference_execution_config_Valid() const{
    return m_inference_execution_config_isValid;
}

QString OAIDescribeModelOutput::getExecutionRoleArn() const {
    return m_execution_role_arn;
}
void OAIDescribeModelOutput::setExecutionRoleArn(const QString &execution_role_arn) {
    m_execution_role_arn = execution_role_arn;
    m_execution_role_arn_isSet = true;
}

bool OAIDescribeModelOutput::is_execution_role_arn_Set() const{
    return m_execution_role_arn_isSet;
}

bool OAIDescribeModelOutput::is_execution_role_arn_Valid() const{
    return m_execution_role_arn_isValid;
}

OAIDescribeModelOutput_VpcConfig OAIDescribeModelOutput::getVpcConfig() const {
    return m_vpc_config;
}
void OAIDescribeModelOutput::setVpcConfig(const OAIDescribeModelOutput_VpcConfig &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAIDescribeModelOutput::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAIDescribeModelOutput::is_vpc_config_Valid() const{
    return m_vpc_config_isValid;
}

QDateTime OAIDescribeModelOutput::getCreationTime() const {
    return m_creation_time;
}
void OAIDescribeModelOutput::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIDescribeModelOutput::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIDescribeModelOutput::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QString OAIDescribeModelOutput::getModelArn() const {
    return m_model_arn;
}
void OAIDescribeModelOutput::setModelArn(const QString &model_arn) {
    m_model_arn = model_arn;
    m_model_arn_isSet = true;
}

bool OAIDescribeModelOutput::is_model_arn_Set() const{
    return m_model_arn_isSet;
}

bool OAIDescribeModelOutput::is_model_arn_Valid() const{
    return m_model_arn_isValid;
}

bool OAIDescribeModelOutput::getEnableNetworkIsolation() const {
    return m_enable_network_isolation;
}
void OAIDescribeModelOutput::setEnableNetworkIsolation(const bool &enable_network_isolation) {
    m_enable_network_isolation = enable_network_isolation;
    m_enable_network_isolation_isSet = true;
}

bool OAIDescribeModelOutput::is_enable_network_isolation_Set() const{
    return m_enable_network_isolation_isSet;
}

bool OAIDescribeModelOutput::is_enable_network_isolation_Valid() const{
    return m_enable_network_isolation_isValid;
}

OAIDescribeModelOutput_DeploymentRecommendation OAIDescribeModelOutput::getDeploymentRecommendation() const {
    return m_deployment_recommendation;
}
void OAIDescribeModelOutput::setDeploymentRecommendation(const OAIDescribeModelOutput_DeploymentRecommendation &deployment_recommendation) {
    m_deployment_recommendation = deployment_recommendation;
    m_deployment_recommendation_isSet = true;
}

bool OAIDescribeModelOutput::is_deployment_recommendation_Set() const{
    return m_deployment_recommendation_isSet;
}

bool OAIDescribeModelOutput::is_deployment_recommendation_Valid() const{
    return m_deployment_recommendation_isValid;
}

bool OAIDescribeModelOutput::isSet() const {
...
bool OAIDescribeModelOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_model_name_isValid && m_execution_role_arn_isValid && m_creation_time_isValid && m_model_arn_isValid && true;
}
