...
QString OAIEdge::getSourceArn() const {
    return m_source_arn;
}
void OAIEdge::setSourceArn(const QString &source_arn) {
    m_source_arn = source_arn;
    m_source_arn_isSet = true;
}

bool OAIEdge::is_source_arn_Set() const{
    return m_source_arn_isSet;
}

bool OAIEdge::is_source_arn_Valid() const{
    return m_source_arn_isValid;
}

QString OAIEdge::getDestinationArn() const {
    return m_destination_arn;
}
void OAIEdge::setDestinationArn(const QString &destination_arn) {
    m_destination_arn = destination_arn;
    m_destination_arn_isSet = true;
}

bool OAIEdge::is_destination_arn_Set() const{
    return m_destination_arn_isSet;
}

bool OAIEdge::is_destination_arn_Valid() const{
    return m_destination_arn_isValid;
}

OAIAssociationEdgeType OAIEdge::getAssociationType() const {
    return m_association_type;
}
void OAIEdge::setAssociationType(const OAIAssociationEdgeType &association_type) {
    m_association_type = association_type;
    m_association_type_isSet = true;
}

bool OAIEdge::is_association_type_Set() const{
    return m_association_type_isSet;
}

bool OAIEdge::is_association_type_Valid() const{
