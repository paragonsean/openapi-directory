...
/*
 * OAICreateContextRequest_Source.h
 *
 * 
 */

#ifndef OAICreateContextRequest_Source_H
#define OAICreateContextRequest_Source_H
...
class OAICreateContextRequest_Source : public OAIObject {
public:
    OAICreateContextRequest_Source();
    OAICreateContextRequest_Source(QString json);
    ~OAICreateContextRequest_Source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateContextRequest_Source)

#endif // OAICreateContextRequest_Source_H
