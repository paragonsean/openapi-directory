...
/*
 * OAIHyperParameterTuningJobSummary_TrainingJobStatusCounters.h
 *
 * 
 */

#ifndef OAIHyperParameterTuningJobSummary_TrainingJobStatusCounters_H
#define OAIHyperParameterTuningJobSummary_TrainingJobStatusCounters_H
...
class OAIHyperParameterTuningJobSummary_TrainingJobStatusCounters : public OAIObject {
public:
    OAIHyperParameterTuningJobSummary_TrainingJobStatusCounters();
    OAIHyperParameterTuningJobSummary_TrainingJobStatusCounters(QString json);
    ~OAIHyperParameterTuningJobSummary_TrainingJobStatusCounters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHyperParameterTuningJobSummary_TrainingJobStatusCounters)

#endif // OAIHyperParameterTuningJobSummary_TrainingJobStatusCounters_H
