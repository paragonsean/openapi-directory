...
/*
 * OAIClarifyShapConfig.h
 *
 * The configuration for SHAP analysis using SageMaker Clarify Explainer.
 */

#ifndef OAIClarifyShapConfig_H
#define OAIClarifyShapConfig_H
...
class OAIClarifyShapConfig : public OAIObject {
public:
    OAIClarifyShapConfig();
    OAIClarifyShapConfig(QString json);
    ~OAIClarifyShapConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClarifyShapConfig)

#endif // OAIClarifyShapConfig_H
