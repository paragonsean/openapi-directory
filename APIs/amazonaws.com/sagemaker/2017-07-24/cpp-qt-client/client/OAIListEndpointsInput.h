...
/*
 * OAIListEndpointsInput.h
 *
 * 
 */

#ifndef OAIListEndpointsInput_H
#define OAIListEndpointsInput_H
...
class OAIListEndpointsInput : public OAIObject {
public:
    OAIListEndpointsInput();
    OAIListEndpointsInput(QString json);
    ~OAIListEndpointsInput() override;
    ...
    OAIEndpointSortKey getSortBy() const;
    void setSortBy(const OAIEndpointSortKey &sort_by);
    ...
    OAIEndpointStatus getStatusEquals() const;
    void setStatusEquals(const OAIEndpointStatus &status_equals);
...
private:
    ...
    OAIEndpointStatus m_status_equals;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEndpointsInput)

#endif // OAIListEndpointsInput_H
