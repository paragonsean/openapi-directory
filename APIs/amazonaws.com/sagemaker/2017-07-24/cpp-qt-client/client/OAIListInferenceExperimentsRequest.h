...
/*
 * OAIListInferenceExperimentsRequest.h
 *
 * 
 */

#ifndef OAIListInferenceExperimentsRequest_H
#define OAIListInferenceExperimentsRequest_H
...
class OAIListInferenceExperimentsRequest : public OAIObject {
public:
    OAIListInferenceExperimentsRequest();
    OAIListInferenceExperimentsRequest(QString json);
    ~OAIListInferenceExperimentsRequest() override;
    ...
    OAIInferenceExperimentStatus getStatusEquals() const;
    void setStatusEquals(const OAIInferenceExperimentStatus &status_equals);
    ...
    OAISortInferenceExperimentsBy getSortBy() const;
    void setSortBy(const OAISortInferenceExperimentsBy &sort_by);
...
private:
    ...
    OAIInferenceExperimentStatus m_status_equals;
    ...
    OAISortInferenceExperimentsBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListInferenceExperimentsRequest)

#endif // OAIListInferenceExperimentsRequest_H
