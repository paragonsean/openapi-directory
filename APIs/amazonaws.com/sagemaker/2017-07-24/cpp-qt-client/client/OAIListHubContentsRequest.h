...
/*
 * OAIListHubContentsRequest.h
 *
 * 
 */

#ifndef OAIListHubContentsRequest_H
#define OAIListHubContentsRequest_H
...
class OAIListHubContentsRequest : public OAIObject {
public:
    OAIListHubContentsRequest();
    OAIListHubContentsRequest(QString json);
    ~OAIListHubContentsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHubContentsRequest)

#endif // OAIListHubContentsRequest_H
