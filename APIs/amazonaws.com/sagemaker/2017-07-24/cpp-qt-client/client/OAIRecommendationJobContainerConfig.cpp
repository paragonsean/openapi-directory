...
#include "OAIRecommendationJobContainerConfig.h"
...
OAIRecommendationJobContainerConfig::OAIRecommendationJobContainerConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecommendationJobContainerConfig::OAIRecommendationJobContainerConfig() {
    this->initializeModel();
}

OAIRecommendationJobContainerConfig::~OAIRecommendationJobContainerConfig() {}

void OAIRecommendationJobContainerConfig::initializeModel() {
...
void OAIRecommendationJobContainerConfig::fromJson(QString jsonString) {
...
void OAIRecommendationJobContainerConfig::fromJsonObject(QJsonObject json) {
...
QString OAIRecommendationJobContainerConfig::asJson() const {
...
QJsonObject OAIRecommendationJobContainerConfig::asJsonObject() const {
    QJsonObject obj;
    if (m_domain_isSet) {
...
QString OAIRecommendationJobContainerConfig::getDomain() const {
    return m_domain;
}
void OAIRecommendationJobContainerConfig::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIRecommendationJobContainerConfig::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIRecommendationJobContainerConfig::is_domain_Valid() const{
    return m_domain_isValid;
}

QString OAIRecommendationJobContainerConfig::getTask() const {
    return m_task;
}
void OAIRecommendationJobContainerConfig::setTask(const QString &task) {
    m_task = task;
    m_task_isSet = true;
}

bool OAIRecommendationJobContainerConfig::is_task_Set() const{
    return m_task_isSet;
}

bool OAIRecommendationJobContainerConfig::is_task_Valid() const{
    return m_task_isValid;
}

QString OAIRecommendationJobContainerConfig::getFramework() const {
    return m_framework;
}
void OAIRecommendationJobContainerConfig::setFramework(const QString &framework) {
    m_framework = framework;
    m_framework_isSet = true;
}

bool OAIRecommendationJobContainerConfig::is_framework_Set() const{
    return m_framework_isSet;
}

bool OAIRecommendationJobContainerConfig::is_framework_Valid() const{
    return m_framework_isValid;
}

QString OAIRecommendationJobContainerConfig::getFrameworkVersion() const {
    return m_framework_version;
}
void OAIRecommendationJobContainerConfig::setFrameworkVersion(const QString &framework_version) {
    m_framework_version = framework_version;
    m_framework_version_isSet = true;
}

bool OAIRecommendationJobContainerConfig::is_framework_version_Set() const{
    return m_framework_version_isSet;
}

bool OAIRecommendationJobContainerConfig::is_framework_version_Valid() const{
    return m_framework_version_isValid;
}

OAIRecommendationJobContainerConfig_PayloadConfig OAIRecommendationJobContainerConfig::getPayloadConfig() const {
    return m_payload_config;
}
void OAIRecommendationJobContainerConfig::setPayloadConfig(const OAIRecommendationJobContainerConfig_PayloadConfig &payload_config) {
    m_payload_config = payload_config;
    m_payload_config_isSet = true;
}

bool OAIRecommendationJobContainerConfig::is_payload_config_Set() const{
    return m_payload_config_isSet;
}

bool OAIRecommendationJobContainerConfig::is_payload_config_Valid() const{
    return m_payload_config_isValid;
}

QString OAIRecommendationJobContainerConfig::getNearestModelName() const {
    return m_nearest_model_name;
}
void OAIRecommendationJobContainerConfig::setNearestModelName(const QString &nearest_model_name) {
    m_nearest_model_name = nearest_model_name;
    m_nearest_model_name_isSet = true;
}

bool OAIRecommendationJobContainerConfig::is_nearest_model_name_Set() const{
    return m_nearest_model_name_isSet;
}

bool OAIRecommendationJobContainerConfig::is_nearest_model_name_Valid() const{
    return m_nearest_model_name_isValid;
}

QList OAIRecommendationJobContainerConfig::getSupportedInstanceTypes() const {
    return m_supported_instance_types;
}
void OAIRecommendationJobContainerConfig::setSupportedInstanceTypes(const QList &supported_instance_types) {
    m_supported_instance_types = supported_instance_types;
    m_supported_instance_types_isSet = true;
}

bool OAIRecommendationJobContainerConfig::is_supported_instance_types_Set() const{
    return m_supported_instance_types_isSet;
}

bool OAIRecommendationJobContainerConfig::is_supported_instance_types_Valid() const{
    return m_supported_instance_types_isValid;
}

QString OAIRecommendationJobContainerConfig::getDataInputConfig() const {
    return m_data_input_config;
}
void OAIRecommendationJobContainerConfig::setDataInputConfig(const QString &data_input_config) {
    m_data_input_config = data_input_config;
    m_data_input_config_isSet = true;
}

bool OAIRecommendationJobContainerConfig::is_data_input_config_Set() const{
    return m_data_input_config_isSet;
}

bool OAIRecommendationJobContainerConfig::is_data_input_config_Valid() const{
    return m_data_input_config_isValid;
}

OAIRecommendationJobSupportedEndpointType OAIRecommendationJobContainerConfig::getSupportedEndpointType() const {
    return m_supported_endpoint_type;
}
void OAIRecommendationJobContainerConfig::setSupportedEndpointType(const OAIRecommendationJobSupportedEndpointType &supported_endpoint_type) {
    m_supported_endpoint_type = supported_endpoint_type;
    m_supported_endpoint_type_isSet = true;
}

bool OAIRecommendationJobContainerConfig::is_supported_endpoint_type_Set() const{
    return m_supported_endpoint_type_isSet;
}

bool OAIRecommendationJobContainerConfig::is_supported_endpoint_type_Valid() const{
    return m_supported_endpoint_type_isValid;
}

bool OAIRecommendationJobContainerConfig::isSet() const {
...
bool OAIRecommendationJobContainerConfig::isValid() const {
