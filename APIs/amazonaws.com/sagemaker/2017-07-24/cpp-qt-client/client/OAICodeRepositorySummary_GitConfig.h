...
/*
 * OAICodeRepositorySummary_GitConfig.h
 *
 * 
 */

#ifndef OAICodeRepositorySummary_GitConfig_H
#define OAICodeRepositorySummary_GitConfig_H
...
class OAICodeRepositorySummary_GitConfig : public OAIObject {
public:
    OAICodeRepositorySummary_GitConfig();
    OAICodeRepositorySummary_GitConfig(QString json);
    ~OAICodeRepositorySummary_GitConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeRepositorySummary_GitConfig)

#endif // OAICodeRepositorySummary_GitConfig_H
