...
OAIOidcConfig::OAIOidcConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOidcConfig::OAIOidcConfig() {
    this->initializeModel();
}

OAIOidcConfig::~OAIOidcConfig() {}

void OAIOidcConfig::initializeModel() {
...
void OAIOidcConfig::fromJson(QString jsonString) {
...
void OAIOidcConfig::fromJsonObject(QJsonObject json) {
...
QString OAIOidcConfig::asJson() const {
...
QJsonObject OAIOidcConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIOidcConfig::getClientId() const {
    return m_client_id;
}
void OAIOidcConfig::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIOidcConfig::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIOidcConfig::is_client_id_Valid() const{
    return m_client_id_isValid;
}

QString OAIOidcConfig::getClientSecret() const {
    return m_client_secret;
}
void OAIOidcConfig::setClientSecret(const QString &client_secret) {
    m_client_secret = client_secret;
    m_client_secret_isSet = true;
}

bool OAIOidcConfig::is_client_secret_Set() const{
    return m_client_secret_isSet;
}

bool OAIOidcConfig::is_client_secret_Valid() const{
    return m_client_secret_isValid;
}

QString OAIOidcConfig::getIssuer() const {
    return m_issuer;
}
void OAIOidcConfig::setIssuer(const QString &issuer) {
    m_issuer = issuer;
    m_issuer_isSet = true;
}

bool OAIOidcConfig::is_issuer_Set() const{
    return m_issuer_isSet;
}

bool OAIOidcConfig::is_issuer_Valid() const{
    return m_issuer_isValid;
}

QString OAIOidcConfig::getAuthorizationEndpoint() const {
    return m_authorization_endpoint;
}
void OAIOidcConfig::setAuthorizationEndpoint(const QString &authorization_endpoint) {
    m_authorization_endpoint = authorization_endpoint;
    m_authorization_endpoint_isSet = true;
}

bool OAIOidcConfig::is_authorization_endpoint_Set() const{
    return m_authorization_endpoint_isSet;
}

bool OAIOidcConfig::is_authorization_endpoint_Valid() const{
    return m_authorization_endpoint_isValid;
}

QString OAIOidcConfig::getTokenEndpoint() const {
    return m_token_endpoint;
}
void OAIOidcConfig::setTokenEndpoint(const QString &token_endpoint) {
    m_token_endpoint = token_endpoint;
    m_token_endpoint_isSet = true;
}

bool OAIOidcConfig::is_token_endpoint_Set() const{
    return m_token_endpoint_isSet;
}

bool OAIOidcConfig::is_token_endpoint_Valid() const{
    return m_token_endpoint_isValid;
}

QString OAIOidcConfig::getUserInfoEndpoint() const {
    return m_user_info_endpoint;
}
void OAIOidcConfig::setUserInfoEndpoint(const QString &user_info_endpoint) {
    m_user_info_endpoint = user_info_endpoint;
    m_user_info_endpoint_isSet = true;
}

bool OAIOidcConfig::is_user_info_endpoint_Set() const{
    return m_user_info_endpoint_isSet;
}

bool OAIOidcConfig::is_user_info_endpoint_Valid() const{
    return m_user_info_endpoint_isValid;
}

QString OAIOidcConfig::getLogoutEndpoint() const {
    return m_logout_endpoint;
}
void OAIOidcConfig::setLogoutEndpoint(const QString &logout_endpoint) {
    m_logout_endpoint = logout_endpoint;
    m_logout_endpoint_isSet = true;
}

bool OAIOidcConfig::is_logout_endpoint_Set() const{
    return m_logout_endpoint_isSet;
}

bool OAIOidcConfig::is_logout_endpoint_Valid() const{
    return m_logout_endpoint_isValid;
}

QString OAIOidcConfig::getJwksUri() const {
    return m_jwks_uri;
}
void OAIOidcConfig::setJwksUri(const QString &jwks_uri) {
    m_jwks_uri = jwks_uri;
    m_jwks_uri_isSet = true;
}

bool OAIOidcConfig::is_jwks_uri_Set() const{
    return m_jwks_uri_isSet;
}

bool OAIOidcConfig::is_jwks_uri_Valid() const{
    return m_jwks_uri_isValid;
}

bool OAIOidcConfig::isSet() const {
...
bool OAIOidcConfig::isValid() const {
