...
/*
 * OAIListEdgeDeploymentPlansRequest.h
 *
 * 
 */

#ifndef OAIListEdgeDeploymentPlansRequest_H
#define OAIListEdgeDeploymentPlansRequest_H
...
class OAIListEdgeDeploymentPlansRequest : public OAIObject {
public:
    OAIListEdgeDeploymentPlansRequest();
    OAIListEdgeDeploymentPlansRequest(QString json);
    ~OAIListEdgeDeploymentPlansRequest() override;
    ...
    QString getDeviceFleetNameContains() const;
    void setDeviceFleetNameContains(const QString &device_fleet_name_contains);
    bool is_device_fleet_name_contains_Set() const;
    bool is_device_fleet_name_contains_Valid() const;

    OAIListEdgeDeploymentPlansSortBy getSortBy() const;
    void setSortBy(const OAIListEdgeDeploymentPlansSortBy &sort_by);
...
private:
    ...
    QString m_device_fleet_name_contains;
    bool m_device_fleet_name_contains_isSet;
    bool m_device_fleet_name_contains_isValid;

    OAIListEdgeDeploymentPlansSortBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEdgeDeploymentPlansRequest)

#endif // OAIListEdgeDeploymentPlansRequest_H
