...
/*
 * OAIPipelineExecutionStepMetadata_QualityCheck.h
 *
 * 
 */

#ifndef OAIPipelineExecutionStepMetadata_QualityCheck_H
#define OAIPipelineExecutionStepMetadata_QualityCheck_H
...
class OAIPipelineExecutionStepMetadata_QualityCheck : public OAIObject {
public:
    OAIPipelineExecutionStepMetadata_QualityCheck();
    OAIPipelineExecutionStepMetadata_QualityCheck(QString json);
    ~OAIPipelineExecutionStepMetadata_QualityCheck() override;
    ...
    QString getBaselineUsedForDriftCheckStatistics() const;
    void setBaselineUsedForDriftCheckStatistics(const QString &baseline_used_for_drift_check_statistics);
    bool is_baseline_used_for_drift_check_statistics_Set() const;
    bool is_baseline_used_for_drift_check_statistics_Valid() const;
    ...
    QString getCalculatedBaselineStatistics() const;
    void setCalculatedBaselineStatistics(const QString &calculated_baseline_statistics);
    bool is_calculated_baseline_statistics_Set() const;
    bool is_calculated_baseline_statistics_Valid() const;
...
private:
    ...
    QString m_baseline_used_for_drift_check_statistics;
    bool m_baseline_used_for_drift_check_statistics_isSet;
    bool m_baseline_used_for_drift_check_statistics_isValid;
    ...
    QString m_calculated_baseline_statistics;
    bool m_calculated_baseline_statistics_isSet;
    bool m_calculated_baseline_statistics_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipelineExecutionStepMetadata_QualityCheck)

#endif // OAIPipelineExecutionStepMetadata_QualityCheck_H
