...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIAddAssociationRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIAddAssociationRequest Example::create(){
    OAIAddAssociationRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::addAssociationSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::addAssociationSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIAddAssociationRequest oai_add_association_request = create(); // OAIAddAssociationRequest | 
      ...
      apiInstance.addAssociation(x_amz_targetoai_add_association_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
