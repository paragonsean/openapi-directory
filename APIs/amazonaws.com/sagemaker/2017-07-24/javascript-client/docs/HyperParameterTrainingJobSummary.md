# AmazonSageMakerService.HyperParameterTrainingJobSummary

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**trainingJobDefinitionName** | **String** |  | [optional] 
**trainingJobName** | **String** |  | 
**trainingJobArn** | **String** |  | 
**tuningJobName** | **String** |  | [optional] 
**creationTime** | **Date** |  | 
**trainingStartTime** | **Date** |  | [optional] 
**trainingEndTime** | **Date** |  | [optional] 
**trainingJobStatus** | [**TrainingJobStatus**](TrainingJobStatus.md) |  | 
**tunedHyperParameters** | **Object** |  | 
