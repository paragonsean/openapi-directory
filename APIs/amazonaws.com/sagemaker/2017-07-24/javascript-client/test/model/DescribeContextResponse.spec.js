...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.DescribeContextResponse();
  });
  ...
  describe('DescribeContextResponse', function() {
    it('should create an instance of DescribeContextResponse', function() {
      // uncomment below and update the code to test DescribeContextResponse
      //var instance = new AmazonSageMakerService.DescribeContextResponse();
      //expect(instance).to.be.a(AmazonSageMakerService.DescribeContextResponse);
    });
