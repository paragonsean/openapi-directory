...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.WorkforceOidcConfig();
  });
  ...
  describe('WorkforceOidcConfig', function() {
    it('should create an instance of WorkforceOidcConfig', function() {
      // uncomment below and update the code to test WorkforceOidcConfig
      //var instance = new AmazonSageMakerService.WorkforceOidcConfig();
      //expect(instance).to.be.a(AmazonSageMakerService.WorkforceOidcConfig);
    });
