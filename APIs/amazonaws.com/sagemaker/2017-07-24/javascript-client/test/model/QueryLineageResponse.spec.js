...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.QueryLineageResponse();
  });
  ...
  describe('QueryLineageResponse', function() {
    it('should create an instance of QueryLineageResponse', function() {
      // uncomment below and update the code to test QueryLineageResponse
      //var instance = new AmazonSageMakerService.QueryLineageResponse();
      //expect(instance).to.be.a(AmazonSageMakerService.QueryLineageResponse);
    });
