...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.DeletePipelineRequest();
  });
  ...
  describe('DeletePipelineRequest', function() {
    it('should create an instance of DeletePipelineRequest', function() {
      // uncomment below and update the code to test DeletePipelineRequest
      //var instance = new AmazonSageMakerService.DeletePipelineRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.DeletePipelineRequest);
    });
