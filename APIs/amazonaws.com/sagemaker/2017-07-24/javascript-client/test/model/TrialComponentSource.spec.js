...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.TrialComponentSource();
  });
  ...
  describe('TrialComponentSource', function() {
    it('should create an instance of TrialComponentSource', function() {
      // uncomment below and update the code to test TrialComponentSource
      //var instance = new AmazonSageMakerService.TrialComponentSource();
      //expect(instance).to.be.a(AmazonSageMakerService.TrialComponentSource);
    });
