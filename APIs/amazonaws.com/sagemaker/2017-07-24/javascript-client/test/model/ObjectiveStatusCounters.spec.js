...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ObjectiveStatusCounters();
  });
  ...
  describe('ObjectiveStatusCounters', function() {
    it('should create an instance of ObjectiveStatusCounters', function() {
      // uncomment below and update the code to test ObjectiveStatusCounters
      //var instance = new AmazonSageMakerService.ObjectiveStatusCounters();
      //expect(instance).to.be.a(AmazonSageMakerService.ObjectiveStatusCounters);
    });
