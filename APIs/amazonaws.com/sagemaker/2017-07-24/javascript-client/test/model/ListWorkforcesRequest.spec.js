...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListWorkforcesRequest();
  });
  ...
  describe('ListWorkforcesRequest', function() {
    it('should create an instance of ListWorkforcesRequest', function() {
      // uncomment below and update the code to test ListWorkforcesRequest
      //var instance = new AmazonSageMakerService.ListWorkforcesRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.ListWorkforcesRequest);
    });
