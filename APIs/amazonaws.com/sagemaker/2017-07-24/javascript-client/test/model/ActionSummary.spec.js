...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ActionSummary();
  });
  ...
  describe('ActionSummary', function() {
    it('should create an instance of ActionSummary', function() {
      ...
      //var instance = new AmazonSageMakerService.ActionSummary();
      //expect(instance).to.be.a(AmazonSageMakerService.ActionSummary);
    });
