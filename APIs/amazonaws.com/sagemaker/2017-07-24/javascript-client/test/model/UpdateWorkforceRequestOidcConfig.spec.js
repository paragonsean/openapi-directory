...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.UpdateWorkforceRequestOidcConfig();
  });
  ...
  describe('UpdateWorkforceRequestOidcConfig', function() {
    it('should create an instance of UpdateWorkforceRequestOidcConfig', function() {
      // uncomment below and update the code to test UpdateWorkforceRequestOidcConfig
      //var instance = new AmazonSageMakerService.UpdateWorkforceRequestOidcConfig();
      //expect(instance).to.be.a(AmazonSageMakerService.UpdateWorkforceRequestOidcConfig);
    });
