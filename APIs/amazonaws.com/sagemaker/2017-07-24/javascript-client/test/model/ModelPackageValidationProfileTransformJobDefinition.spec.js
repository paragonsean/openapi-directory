...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ModelPackageValidationProfileTransformJobDefinition();
  });
  ...
  describe('ModelPackageValidationProfileTransformJobDefinition', function() {
    it('should create an instance of ModelPackageValidationProfileTransformJobDefinition', function() {
      // uncomment below and update the code to test ModelPackageValidationProfileTransformJobDefinition
      //var instance = new AmazonSageMakerService.ModelPackageValidationProfileTransformJobDefinition();
      //expect(instance).to.be.a(AmazonSageMakerService.ModelPackageValidationProfileTransformJobDefinition);
    });
