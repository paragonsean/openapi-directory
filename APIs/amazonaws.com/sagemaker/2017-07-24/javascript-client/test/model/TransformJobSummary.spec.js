...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.TransformJobSummary();
  });
  ...
  describe('TransformJobSummary', function() {
    it('should create an instance of TransformJobSummary', function() {
      // uncomment below and update the code to test TransformJobSummary
      //var instance = new AmazonSageMakerService.TransformJobSummary();
      //expect(instance).to.be.a(AmazonSageMakerService.TransformJobSummary);
    });
