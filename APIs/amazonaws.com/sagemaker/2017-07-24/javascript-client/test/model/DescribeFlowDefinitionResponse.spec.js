...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.DescribeFlowDefinitionResponse();
  });
  ...
  describe('DescribeFlowDefinitionResponse', function() {
    it('should create an instance of DescribeFlowDefinitionResponse', function() {
      // uncomment below and update the code to test DescribeFlowDefinitionResponse
      //var instance = new AmazonSageMakerService.DescribeFlowDefinitionResponse();
      //expect(instance).to.be.a(AmazonSageMakerService.DescribeFlowDefinitionResponse);
    });
    ...
    it('should have the property humanLoopRequestSource (base name: "HumanLoopRequestSource")', function() {
      // uncomment below and update the code to test the property humanLoopRequestSource
      //var instance = new AmazonSageMakerService.DescribeFlowDefinitionResponse();
      //expect(instance).to.be();
    });

    it('should have the property humanLoopActivationConfig (base name: "HumanLoopActivationConfig")', function() {
      // uncomment below and update the code to test the property humanLoopActivationConfig
      //var instance = new AmazonSageMakerService.DescribeFlowDefinitionResponse();
      //expect(instance).to.be();
    });
