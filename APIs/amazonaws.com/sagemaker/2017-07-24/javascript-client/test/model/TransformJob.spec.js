...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.TransformJob();
  });
  ...
  describe('TransformJob', function() {
    it('should create an instance of TransformJob', function() {
      // uncomment below and update the code to test TransformJob
      //var instance = new AmazonSageMakerService.TransformJob();
      //expect(instance).to.be.a(AmazonSageMakerService.TransformJob);
    });
