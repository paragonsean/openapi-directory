...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.AutoMLJobChannel();
  });
  ...
  describe('AutoMLJobChannel', function() {
    it('should create an instance of AutoMLJobChannel', function() {
      // uncomment below and update the code to test AutoMLJobChannel
      //var instance = new AmazonSageMakerService.AutoMLJobChannel();
      //expect(instance).to.be.a(AmazonSageMakerService.AutoMLJobChannel);
    });
