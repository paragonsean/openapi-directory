...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.EdgeModelSummary();
  });
  ...
  describe('EdgeModelSummary', function() {
    it('should create an instance of EdgeModelSummary', function() {
      // uncomment below and update the code to test EdgeModelSummary
      //var instance = new AmazonSageMakerService.EdgeModelSummary();
      //expect(instance).to.be.a(AmazonSageMakerService.EdgeModelSummary);
    });
