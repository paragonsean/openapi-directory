...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ContextSource();
  });
  ...
  describe('ContextSource', function() {
    it('should create an instance of ContextSource', function() {
      // uncomment below and update the code to test ContextSource
      //var instance = new AmazonSageMakerService.ContextSource();
      //expect(instance).to.be.a(AmazonSageMakerService.ContextSource);
    });
