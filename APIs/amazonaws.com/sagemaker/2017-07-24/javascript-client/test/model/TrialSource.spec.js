...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.TrialSource();
  });
  ...
  describe('TrialSource', function() {
    it('should create an instance of TrialSource', function() {
      // uncomment below and update the code to test TrialSource
      //var instance = new AmazonSageMakerService.TrialSource();
      //expect(instance).to.be.a(AmazonSageMakerService.TrialSource);
    });
