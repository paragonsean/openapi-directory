...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListModelsOutput();
  });
  ...
  describe('ListModelsOutput', function() {
    it('should create an instance of ListModelsOutput', function() {
      // uncomment below and update the code to test ListModelsOutput
      //var instance = new AmazonSageMakerService.ListModelsOutput();
      //expect(instance).to.be.a(AmazonSageMakerService.ListModelsOutput);
    });
