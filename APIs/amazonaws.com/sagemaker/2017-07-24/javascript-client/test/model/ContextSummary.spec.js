...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ContextSummary();
  });
  ...
  describe('ContextSummary', function() {
    it('should create an instance of ContextSummary', function() {
      // uncomment below and update the code to test ContextSummary
      //var instance = new AmazonSageMakerService.ContextSummary();
      //expect(instance).to.be.a(AmazonSageMakerService.ContextSummary);
    });
