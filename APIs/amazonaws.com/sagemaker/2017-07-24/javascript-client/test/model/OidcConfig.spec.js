...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.OidcConfig();
  });
  ...
  describe('OidcConfig', function() {
    it('should create an instance of OidcConfig', function() {
      // uncomment below and update the code to test OidcConfig
      //var instance = new AmazonSageMakerService.OidcConfig();
      //expect(instance).to.be.a(AmazonSageMakerService.OidcConfig);
    });
