...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListTagsInput();
  });
  ...
  describe('ListTagsInput', function() {
    it('should create an instance of ListTagsInput', function() {
      // uncomment below and update the code to test ListTagsInput
      //var instance = new AmazonSageMakerService.ListTagsInput();
      //expect(instance).to.be.a(AmazonSageMakerService.ListTagsInput);
    });
