...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.WorkforceVpcConfigResponse();
  });
  ...
  describe('WorkforceVpcConfigResponse', function() {
    it('should create an instance of WorkforceVpcConfigResponse', function() {
      // uncomment below and update the code to test WorkforceVpcConfigResponse
      //var instance = new AmazonSageMakerService.WorkforceVpcConfigResponse();
      //expect(instance).to.be.a(AmazonSageMakerService.WorkforceVpcConfigResponse);
    });
