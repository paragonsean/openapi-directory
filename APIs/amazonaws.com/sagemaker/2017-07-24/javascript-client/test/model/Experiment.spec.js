...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.Experiment();
  });
  ...
  describe('Experiment', function() {
    it('should create an instance of Experiment', function() {
      ...
      //var instance = new AmazonSageMakerService.Experiment();
      //expect(instance).to.be.a(AmazonSageMakerService.Experiment);
    });
