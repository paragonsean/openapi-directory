...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListEndpointsOutput();
  });
  ...
  describe('ListEndpointsOutput', function() {
    it('should create an instance of ListEndpointsOutput', function() {
      // uncomment below and update the code to test ListEndpointsOutput
      //var instance = new AmazonSageMakerService.ListEndpointsOutput();
      //expect(instance).to.be.a(AmazonSageMakerService.ListEndpointsOutput);
    });
