...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.DescribeSpaceRequest();
  });
  ...
  describe('DescribeSpaceRequest', function() {
    it('should create an instance of DescribeSpaceRequest', function() {
      // uncomment below and update the code to test DescribeSpaceRequest
      //var instance = new AmazonSageMakerService.DescribeSpaceRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.DescribeSpaceRequest);
    });
