...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.PipelineDefinitionS3Location();
  });
  ...
  describe('PipelineDefinitionS3Location', function() {
    it('should create an instance of PipelineDefinitionS3Location', function() {
      // uncomment below and update the code to test PipelineDefinitionS3Location
      //var instance = new AmazonSageMakerService.PipelineDefinitionS3Location();
      //expect(instance).to.be.a(AmazonSageMakerService.PipelineDefinitionS3Location);
    });
