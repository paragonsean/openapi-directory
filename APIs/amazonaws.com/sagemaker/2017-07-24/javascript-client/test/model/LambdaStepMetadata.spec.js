...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.LambdaStepMetadata();
  });
  ...
  describe('LambdaStepMetadata', function() {
    it('should create an instance of LambdaStepMetadata', function() {
      // uncomment below and update the code to test LambdaStepMetadata
      //var instance = new AmazonSageMakerService.LambdaStepMetadata();
      //expect(instance).to.be.a(AmazonSageMakerService.LambdaStepMetadata);
    });
