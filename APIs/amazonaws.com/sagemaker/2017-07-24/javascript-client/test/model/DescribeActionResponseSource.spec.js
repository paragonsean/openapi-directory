...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.DescribeActionResponseSource();
  });
  ...
  describe('DescribeActionResponseSource', function() {
    it('should create an instance of DescribeActionResponseSource', function() {
      // uncomment below and update the code to test DescribeActionResponseSource
      //var instance = new AmazonSageMakerService.DescribeActionResponseSource();
      //expect(instance).to.be.a(AmazonSageMakerService.DescribeActionResponseSource);
    });
