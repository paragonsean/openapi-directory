...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.SearchResponse();
  });
  ...
  describe('SearchResponse', function() {
    it('should create an instance of SearchResponse', function() {
      ...
      //var instance = new AmazonSageMakerService.SearchResponse();
      //expect(instance).to.be.a(AmazonSageMakerService.SearchResponse);
    });
