...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListExperimentsRequest();
  });
  ...
  describe('ListExperimentsRequest', function() {
    it('should create an instance of ListExperimentsRequest', function() {
      // uncomment below and update the code to test ListExperimentsRequest
      //var instance = new AmazonSageMakerService.ListExperimentsRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.ListExperimentsRequest);
    });
