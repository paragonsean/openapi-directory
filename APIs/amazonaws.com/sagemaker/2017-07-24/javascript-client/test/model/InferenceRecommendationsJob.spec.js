...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.InferenceRecommendationsJob();
  });
  ...
  describe('InferenceRecommendationsJob', function() {
    it('should create an instance of InferenceRecommendationsJob', function() {
      // uncomment below and update the code to test InferenceRecommendationsJob
      //var instance = new AmazonSageMakerService.InferenceRecommendationsJob();
      //expect(instance).to.be.a(AmazonSageMakerService.InferenceRecommendationsJob);
    });
