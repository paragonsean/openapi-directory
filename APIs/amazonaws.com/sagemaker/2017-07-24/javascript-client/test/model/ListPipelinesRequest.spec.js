...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListPipelinesRequest();
  });
  ...
  describe('ListPipelinesRequest', function() {
    it('should create an instance of ListPipelinesRequest', function() {
      // uncomment below and update the code to test ListPipelinesRequest
      //var instance = new AmazonSageMakerService.ListPipelinesRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.ListPipelinesRequest);
    });

    it('should have the property pipelineNamePrefix (base name: "PipelineNamePrefix")', function() {
      // uncomment below and update the code to test the property pipelineNamePrefix
      //var instance = new AmazonSageMakerService.ListPipelinesRequest();
