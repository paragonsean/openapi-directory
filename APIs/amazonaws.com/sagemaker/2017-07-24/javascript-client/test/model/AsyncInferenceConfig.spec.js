...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.AsyncInferenceConfig();
  });
  ...
  describe('AsyncInferenceConfig', function() {
    it('should create an instance of AsyncInferenceConfig', function() {
      // uncomment below and update the code to test AsyncInferenceConfig
      //var instance = new AmazonSageMakerService.AsyncInferenceConfig();
      //expect(instance).to.be.a(AmazonSageMakerService.AsyncInferenceConfig);
    });
