...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.GitConfig();
  });
  ...
  describe('GitConfig', function() {
    it('should create an instance of GitConfig', function() {
      // uncomment below and update the code to test GitConfig
      //var instance = new AmazonSageMakerService.GitConfig();
      //expect(instance).to.be.a(AmazonSageMakerService.GitConfig);
    });
