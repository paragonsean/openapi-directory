...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.AgentVersion();
  });
  ...
  describe('AgentVersion', function() {
    it('should create an instance of AgentVersion', function() {
      // uncomment below and update the code to test AgentVersion
      //var instance = new AmazonSageMakerService.AgentVersion();
      //expect(instance).to.be.a(AmazonSageMakerService.AgentVersion);
    });
