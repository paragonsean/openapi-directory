...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.WorkforceWorkforceVpcConfig();
  });
  ...
  describe('WorkforceWorkforceVpcConfig', function() {
    it('should create an instance of WorkforceWorkforceVpcConfig', function() {
      // uncomment below and update the code to test WorkforceWorkforceVpcConfig
      //var instance = new AmazonSageMakerService.WorkforceWorkforceVpcConfig();
      //expect(instance).to.be.a(AmazonSageMakerService.WorkforceWorkforceVpcConfig);
    });
