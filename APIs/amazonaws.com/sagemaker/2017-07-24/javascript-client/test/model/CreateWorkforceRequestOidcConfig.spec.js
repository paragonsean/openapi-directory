...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.CreateWorkforceRequestOidcConfig();
  });
  ...
  describe('CreateWorkforceRequestOidcConfig', function() {
    it('should create an instance of CreateWorkforceRequestOidcConfig', function() {
      // uncomment below and update the code to test CreateWorkforceRequestOidcConfig
      //var instance = new AmazonSageMakerService.CreateWorkforceRequestOidcConfig();
      //expect(instance).to.be.a(AmazonSageMakerService.CreateWorkforceRequestOidcConfig);
    });
    ...
    it('should have the property logoutEndpoint (base name: "LogoutEndpoint")', function() {
      // uncomment below and update the code to test the property logoutEndpoint
      //var instance = new AmazonSageMakerService.CreateWorkforceRequestOidcConfig();
      //expect(instance).to.be();
    });
