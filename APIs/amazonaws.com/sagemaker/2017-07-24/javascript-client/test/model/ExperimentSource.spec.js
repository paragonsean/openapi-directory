...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ExperimentSource();
  });
  ...
  describe('ExperimentSource', function() {
    it('should create an instance of ExperimentSource', function() {
      // uncomment below and update the code to test ExperimentSource
      //var instance = new AmazonSageMakerService.ExperimentSource();
      //expect(instance).to.be.a(AmazonSageMakerService.ExperimentSource);
    });
