...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListWorkteamsRequest();
  });
  ...
  describe('ListWorkteamsRequest', function() {
    it('should create an instance of ListWorkteamsRequest', function() {
      // uncomment below and update the code to test ListWorkteamsRequest
      //var instance = new AmazonSageMakerService.ListWorkteamsRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.ListWorkteamsRequest);
    });
