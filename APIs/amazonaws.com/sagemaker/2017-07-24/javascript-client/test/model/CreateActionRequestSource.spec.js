...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.CreateActionRequestSource();
  });
  ...
  describe('CreateActionRequestSource', function() {
    it('should create an instance of CreateActionRequestSource', function() {
      // uncomment below and update the code to test CreateActionRequestSource
      //var instance = new AmazonSageMakerService.CreateActionRequestSource();
      //expect(instance).to.be.a(AmazonSageMakerService.CreateActionRequestSource);
    });
