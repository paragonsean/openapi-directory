...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.SearchRequest();
  });
  ...
  describe('SearchRequest', function() {
    it('should create an instance of SearchRequest', function() {
      ...
      //var instance = new AmazonSageMakerService.SearchRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.SearchRequest);
    });
    ...
    it('should have the property crossAccountFilterOption (base name: "CrossAccountFilterOption")', function() {
      // uncomment below and update the code to test the property crossAccountFilterOption
      //var instance = new AmazonSageMakerService.SearchRequest();
      //expect(instance).to.be();
    });
