...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.CustomizedMetricSpecification();
  });
  ...
  describe('CustomizedMetricSpecification', function() {
    it('should create an instance of CustomizedMetricSpecification', function() {
      ...
      //var instance = new AmazonSageMakerService.CustomizedMetricSpecification();
      //expect(instance).to.be.a(AmazonSageMakerService.CustomizedMetricSpecification);
    });
