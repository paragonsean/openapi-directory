...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.DescribeTransformJobResponse();
  });
  ...
  describe('DescribeTransformJobResponse', function() {
    it('should create an instance of DescribeTransformJobResponse', function() {
      // uncomment below and update the code to test DescribeTransformJobResponse
      //var instance = new AmazonSageMakerService.DescribeTransformJobResponse();
      //expect(instance).to.be.a(AmazonSageMakerService.DescribeTransformJobResponse);
    });
