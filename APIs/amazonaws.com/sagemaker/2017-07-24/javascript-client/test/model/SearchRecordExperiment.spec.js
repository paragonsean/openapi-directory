...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.SearchRecordExperiment();
  });
  ...
  describe('SearchRecordExperiment', function() {
    it('should create an instance of SearchRecordExperiment', function() {
      // uncomment below and update the code to test SearchRecordExperiment
      //var instance = new AmazonSageMakerService.SearchRecordExperiment();
      //expect(instance).to.be.a(AmazonSageMakerService.SearchRecordExperiment);
    });
