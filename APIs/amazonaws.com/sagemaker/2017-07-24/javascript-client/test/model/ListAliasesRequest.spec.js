...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListAliasesRequest();
  });
  ...
  describe('ListAliasesRequest', function() {
    it('should create an instance of ListAliasesRequest', function() {
      // uncomment below and update the code to test ListAliasesRequest
      //var instance = new AmazonSageMakerService.ListAliasesRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.ListAliasesRequest);
    });
