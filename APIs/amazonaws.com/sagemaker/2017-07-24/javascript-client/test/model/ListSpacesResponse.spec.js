...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListSpacesResponse();
  });
  ...
  describe('ListSpacesResponse', function() {
    it('should create an instance of ListSpacesResponse', function() {
      ...
      //var instance = new AmazonSageMakerService.ListSpacesResponse();
      //expect(instance).to.be.a(AmazonSageMakerService.ListSpacesResponse);
    });
