...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.EMRStepMetadata();
  });
  ...
  describe('EMRStepMetadata', function() {
    it('should create an instance of EMRStepMetadata', function() {
      // uncomment below and update the code to test EMRStepMetadata
      //var instance = new AmazonSageMakerService.EMRStepMetadata();
      //expect(instance).to.be.a(AmazonSageMakerService.EMRStepMetadata);
    });
