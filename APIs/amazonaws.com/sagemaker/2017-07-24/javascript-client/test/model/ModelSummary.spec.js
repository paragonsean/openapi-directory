...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ModelSummary();
  });
  ...
  describe('ModelSummary', function() {
    it('should create an instance of ModelSummary', function() {
      ...
      //var instance = new AmazonSageMakerService.ModelSummary();
      //expect(instance).to.be.a(AmazonSageMakerService.ModelSummary);
    });
