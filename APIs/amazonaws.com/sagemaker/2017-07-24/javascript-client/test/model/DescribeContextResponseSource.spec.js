...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.DescribeContextResponseSource();
  });
  ...
  describe('DescribeContextResponseSource', function() {
    it('should create an instance of DescribeContextResponseSource', function() {
      // uncomment below and update the code to test DescribeContextResponseSource
      //var instance = new AmazonSageMakerService.DescribeContextResponseSource();
      //expect(instance).to.be.a(AmazonSageMakerService.DescribeContextResponseSource);
    });
