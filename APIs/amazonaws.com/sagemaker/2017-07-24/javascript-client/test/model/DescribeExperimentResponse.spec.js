...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.DescribeExperimentResponse();
  });
  ...
  describe('DescribeExperimentResponse', function() {
    it('should create an instance of DescribeExperimentResponse', function() {
      // uncomment below and update the code to test DescribeExperimentResponse
      //var instance = new AmazonSageMakerService.DescribeExperimentResponse();
      //expect(instance).to.be.a(AmazonSageMakerService.DescribeExperimentResponse);
    });
