...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.DomainDetails();
  });
  ...
  describe('DomainDetails', function() {
    it('should create an instance of DomainDetails', function() {
      ...
      //var instance = new AmazonSageMakerService.DomainDetails();
      //expect(instance).to.be.a(AmazonSageMakerService.DomainDetails);
    });
