...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.DeleteAppRequest();
  });
  ...
  describe('DeleteAppRequest', function() {
    it('should create an instance of DeleteAppRequest', function() {
      ...
      //var instance = new AmazonSageMakerService.DeleteAppRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.DeleteAppRequest);
    });
