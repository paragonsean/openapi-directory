...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListContextsRequest();
  });
  ...
  describe('ListContextsRequest', function() {
    it('should create an instance of ListContextsRequest', function() {
      // uncomment below and update the code to test ListContextsRequest
      //var instance = new AmazonSageMakerService.ListContextsRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.ListContextsRequest);
    });
