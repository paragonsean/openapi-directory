...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.DescribeAppRequest();
  });
  ...
  describe('DescribeAppRequest', function() {
    it('should create an instance of DescribeAppRequest', function() {
      // uncomment below and update the code to test DescribeAppRequest
      //var instance = new AmazonSageMakerService.DescribeAppRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.DescribeAppRequest);
    });
