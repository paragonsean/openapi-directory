...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.AlgorithmValidationProfileTransformJobDefinition();
  });
  ...
  describe('AlgorithmValidationProfileTransformJobDefinition', function() {
    it('should create an instance of AlgorithmValidationProfileTransformJobDefinition', function() {
      // uncomment below and update the code to test AlgorithmValidationProfileTransformJobDefinition
      //var instance = new AmazonSageMakerService.AlgorithmValidationProfileTransformJobDefinition();
      //expect(instance).to.be.a(AmazonSageMakerService.AlgorithmValidationProfileTransformJobDefinition);
    });
