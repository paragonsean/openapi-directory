...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.CreateTransformJobRequest();
  });
  ...
  describe('CreateTransformJobRequest', function() {
    it('should create an instance of CreateTransformJobRequest', function() {
      // uncomment below and update the code to test CreateTransformJobRequest
      //var instance = new AmazonSageMakerService.CreateTransformJobRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.CreateTransformJobRequest);
    });
