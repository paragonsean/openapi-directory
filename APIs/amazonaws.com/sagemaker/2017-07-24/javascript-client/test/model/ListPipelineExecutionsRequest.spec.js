...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListPipelineExecutionsRequest();
  });
  ...
  describe('ListPipelineExecutionsRequest', function() {
    it('should create an instance of ListPipelineExecutionsRequest', function() {
      // uncomment below and update the code to test ListPipelineExecutionsRequest
      //var instance = new AmazonSageMakerService.ListPipelineExecutionsRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.ListPipelineExecutionsRequest);
    });
