...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListDomainsRequest();
  });
  ...
  describe('ListDomainsRequest', function() {
    it('should create an instance of ListDomainsRequest', function() {
      ...
      //var instance = new AmazonSageMakerService.ListDomainsRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.ListDomainsRequest);
    });
