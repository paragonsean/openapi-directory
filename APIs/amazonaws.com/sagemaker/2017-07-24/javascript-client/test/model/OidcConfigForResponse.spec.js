...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.OidcConfigForResponse();
  });
  ...
  describe('OidcConfigForResponse', function() {
    it('should create an instance of OidcConfigForResponse', function() {
      // uncomment below and update the code to test OidcConfigForResponse
      //var instance = new AmazonSageMakerService.OidcConfigForResponse();
      //expect(instance).to.be.a(AmazonSageMakerService.OidcConfigForResponse);
    });
