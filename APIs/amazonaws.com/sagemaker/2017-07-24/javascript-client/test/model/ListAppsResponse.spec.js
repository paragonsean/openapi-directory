...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListAppsResponse();
  });
  ...
  describe('ListAppsResponse', function() {
    it('should create an instance of ListAppsResponse', function() {
      ...
      //var instance = new AmazonSageMakerService.ListAppsResponse();
      //expect(instance).to.be.a(AmazonSageMakerService.ListAppsResponse);
    });
