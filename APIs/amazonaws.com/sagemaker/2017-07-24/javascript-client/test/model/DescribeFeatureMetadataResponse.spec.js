...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.DescribeFeatureMetadataResponse();
  });
  ...
  describe('DescribeFeatureMetadataResponse', function() {
    it('should create an instance of DescribeFeatureMetadataResponse', function() {
      // uncomment below and update the code to test DescribeFeatureMetadataResponse
      //var instance = new AmazonSageMakerService.DescribeFeatureMetadataResponse();
      //expect(instance).to.be.a(AmazonSageMakerService.DescribeFeatureMetadataResponse);
    });
