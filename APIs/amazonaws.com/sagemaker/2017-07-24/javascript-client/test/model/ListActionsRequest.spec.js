...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListActionsRequest();
  });
  ...
  describe('ListActionsRequest', function() {
    it('should create an instance of ListActionsRequest', function() {
      // uncomment below and update the code to test ListActionsRequest
      //var instance = new AmazonSageMakerService.ListActionsRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.ListActionsRequest);
    });
