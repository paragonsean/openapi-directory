...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.CreateContextRequest();
  });
  ...
  describe('CreateContextRequest', function() {
    it('should create an instance of CreateContextRequest', function() {
      // uncomment below and update the code to test CreateContextRequest
      //var instance = new AmazonSageMakerService.CreateContextRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.CreateContextRequest);
    });
