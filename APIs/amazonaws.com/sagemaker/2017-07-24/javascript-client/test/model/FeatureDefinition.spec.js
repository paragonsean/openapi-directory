...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.FeatureDefinition();
  });
  ...
  describe('FeatureDefinition', function() {
    it('should create an instance of FeatureDefinition', function() {
      // uncomment below and update the code to test FeatureDefinition
      //var instance = new AmazonSageMakerService.FeatureDefinition();
      //expect(instance).to.be.a(AmazonSageMakerService.FeatureDefinition);
    });
