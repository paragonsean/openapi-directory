...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.CreateContextRequestSource();
  });
  ...
  describe('CreateContextRequestSource', function() {
    it('should create an instance of CreateContextRequestSource', function() {
      // uncomment below and update the code to test CreateContextRequestSource
      //var instance = new AmazonSageMakerService.CreateContextRequestSource();
      //expect(instance).to.be.a(AmazonSageMakerService.CreateContextRequestSource);
    });
