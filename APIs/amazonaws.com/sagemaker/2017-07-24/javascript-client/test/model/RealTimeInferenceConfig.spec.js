...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.RealTimeInferenceConfig();
  });
  ...
  describe('RealTimeInferenceConfig', function() {
    it('should create an instance of RealTimeInferenceConfig', function() {
      // uncomment below and update the code to test RealTimeInferenceConfig
      //var instance = new AmazonSageMakerService.RealTimeInferenceConfig();
      //expect(instance).to.be.a(AmazonSageMakerService.RealTimeInferenceConfig);
    });
