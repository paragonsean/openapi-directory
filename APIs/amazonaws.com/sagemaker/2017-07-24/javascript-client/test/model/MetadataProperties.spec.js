...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.MetadataProperties();
  });
  ...
  describe('MetadataProperties', function() {
    it('should create an instance of MetadataProperties', function() {
      // uncomment below and update the code to test MetadataProperties
      //var instance = new AmazonSageMakerService.MetadataProperties();
      //expect(instance).to.be.a(AmazonSageMakerService.MetadataProperties);
    });
