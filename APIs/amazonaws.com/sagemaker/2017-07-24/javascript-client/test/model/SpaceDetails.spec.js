...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.SpaceDetails();
  });
  ...
  describe('SpaceDetails', function() {
    it('should create an instance of SpaceDetails', function() {
      ...
      //var instance = new AmazonSageMakerService.SpaceDetails();
      //expect(instance).to.be.a(AmazonSageMakerService.SpaceDetails);
    });
