...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ActionSource();
  });
  ...
  describe('ActionSource', function() {
    it('should create an instance of ActionSource', function() {
      // uncomment below and update the code to test ActionSource
      //var instance = new AmazonSageMakerService.ActionSource();
      //expect(instance).to.be.a(AmazonSageMakerService.ActionSource);
    });
