...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerService.ListTrialComponentsRequest();
  });
  ...
  describe('ListTrialComponentsRequest', function() {
    it('should create an instance of ListTrialComponentsRequest', function() {
      // uncomment below and update the code to test ListTrialComponentsRequest
      //var instance = new AmazonSageMakerService.ListTrialComponentsRequest();
      //expect(instance).to.be.a(AmazonSageMakerService.ListTrialComponentsRequest);
    });
