...
/**
 * The HumanTaskConfig model module.
 * @module model/HumanTaskConfig
 * @version 2017-07-24
 */
class HumanTaskConfig {
    /**
     * Constructs a new <code>HumanTaskConfig</code>.
     * Information required for human workers to complete a labeling task.
     * @alias module:model/HumanTaskConfig
    ...
    /**
     * Constructs a <code>HumanTaskConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HumanTaskConfig} obj Optional instance to populate.
     * @return {module:model/HumanTaskConfig} The populated <code>HumanTaskConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HumanTaskConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>HumanTaskConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HumanTaskConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HumanTaskConfig.RequiredProperties) {
...
HumanTaskConfig.RequiredProperties = ["WorkteamArn", "UiConfig", "PreHumanTaskLambdaArn", "TaskTitle", "TaskDescription", "NumberOfHumanWorkersPerDataObject", "TaskTimeLimitInSeconds", "AnnotationConsolidationConfig"];
...
export default HumanTaskConfig;
