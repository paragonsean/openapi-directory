...
/**
 * The TransformJobDefinitionTransformInput model module.
 * @module model/TransformJobDefinitionTransformInput
 * @version 2017-07-24
 */
class TransformJobDefinitionTransformInput {
    /**
     * Constructs a new <code>TransformJobDefinitionTransformInput</code>.
     * @alias module:model/TransformJobDefinitionTransformInput
    ...
    constructor(dataSource) { 
        ...
        TransformJobDefinitionTransformInput.initialize(this, dataSource);
    }
    ...
    /**
     * Constructs a <code>TransformJobDefinitionTransformInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransformJobDefinitionTransformInput} obj Optional instance to populate.
     * @return {module:model/TransformJobDefinitionTransformInput} The populated <code>TransformJobDefinitionTransformInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransformJobDefinitionTransformInput();
    ...
    /**
     * Validates the JSON data with respect to <code>TransformJobDefinitionTransformInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransformJobDefinitionTransformInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransformJobDefinitionTransformInput.RequiredProperties) {
...
TransformJobDefinitionTransformInput.RequiredProperties = ["DataSource"];

/**
 * @member {module:model/TransformInputDataSource} DataSource
 */
TransformJobDefinitionTransformInput.prototype['DataSource'] = undefined;

/**
 * @member {String} ContentType
 */
TransformJobDefinitionTransformInput.prototype['ContentType'] = undefined;

/**
 * @member {module:model/CompressionType} CompressionType
 */
TransformJobDefinitionTransformInput.prototype['CompressionType'] = undefined;

/**
 * @member {module:model/SplitType} SplitType
 */
TransformJobDefinitionTransformInput.prototype['SplitType'] = undefined;
...
export default TransformJobDefinitionTransformInput;
