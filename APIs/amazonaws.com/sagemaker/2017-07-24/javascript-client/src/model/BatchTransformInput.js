...
/**
 * The BatchTransformInput model module.
 * @module model/BatchTransformInput
 * @version 2017-07-24
 */
class BatchTransformInput {
    /**
     * Constructs a new <code>BatchTransformInput</code>.
     * Input object for the batch transform job.
     * @alias module:model/BatchTransformInput
    ...
    /**
     * Constructs a <code>BatchTransformInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchTransformInput} obj Optional instance to populate.
     * @return {module:model/BatchTransformInput} The populated <code>BatchTransformInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchTransformInput();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchTransformInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchTransformInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchTransformInput.RequiredProperties) {
...
BatchTransformInput.RequiredProperties = ["DataCapturedDestinationS3Uri", "DatasetFormat", "LocalPath"];
...
export default BatchTransformInput;
