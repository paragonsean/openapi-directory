...
/**
 * The DescribeModelPackageOutputInferenceSpecification model module.
 * @module model/DescribeModelPackageOutputInferenceSpecification
 * @version 2017-07-24
 */
class DescribeModelPackageOutputInferenceSpecification {
    /**
     * Constructs a new <code>DescribeModelPackageOutputInferenceSpecification</code>.
     * @alias module:model/DescribeModelPackageOutputInferenceSpecification
    ...
    constructor(containers, supportedContentTypes, supportedResponseMIMETypes) { 
        ...
        DescribeModelPackageOutputInferenceSpecification.initialize(this, containers, supportedContentTypes, supportedResponseMIMETypes);
    }
    ...
    /**
     * Constructs a <code>DescribeModelPackageOutputInferenceSpecification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeModelPackageOutputInferenceSpecification} obj Optional instance to populate.
     * @return {module:model/DescribeModelPackageOutputInferenceSpecification} The populated <code>DescribeModelPackageOutputInferenceSpecification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeModelPackageOutputInferenceSpecification();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeModelPackageOutputInferenceSpecification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeModelPackageOutputInferenceSpecification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeModelPackageOutputInferenceSpecification.RequiredProperties) {
...
DescribeModelPackageOutputInferenceSpecification.RequiredProperties = ["Containers", "SupportedContentTypes", "SupportedResponseMIMETypes"];

/**
 * @member {Array} Containers
 */
DescribeModelPackageOutputInferenceSpecification.prototype['Containers'] = undefined;

/**
 * @member {Array} SupportedTransformInstanceTypes
 */
DescribeModelPackageOutputInferenceSpecification.prototype['SupportedTransformInstanceTypes'] = undefined;

/**
 * @member {Array} SupportedRealtimeInferenceInstanceTypes
 */
DescribeModelPackageOutputInferenceSpecification.prototype['SupportedRealtimeInferenceInstanceTypes'] = undefined;

/**
 * @member {Array} SupportedContentTypes
 */
DescribeModelPackageOutputInferenceSpecification.prototype['SupportedContentTypes'] = undefined;

/**
 * @member {Array} SupportedResponseMIMETypes
 */
DescribeModelPackageOutputInferenceSpecification.prototype['SupportedResponseMIMETypes'] = undefined;
...
export default DescribeModelPackageOutputInferenceSpecification;
