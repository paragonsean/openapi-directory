...
/**
 * The DescribeAlgorithmOutputInferenceSpecification model module.
 * @module model/DescribeAlgorithmOutputInferenceSpecification
 * @version 2017-07-24
 */
class DescribeAlgorithmOutputInferenceSpecification {
    /**
     * Constructs a new <code>DescribeAlgorithmOutputInferenceSpecification</code>.
     * @alias module:model/DescribeAlgorithmOutputInferenceSpecification
    ...
    constructor(containers, supportedContentTypes, supportedResponseMIMETypes) { 
        ...
        DescribeAlgorithmOutputInferenceSpecification.initialize(this, containers, supportedContentTypes, supportedResponseMIMETypes);
    }
    ...
    /**
     * Constructs a <code>DescribeAlgorithmOutputInferenceSpecification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAlgorithmOutputInferenceSpecification} obj Optional instance to populate.
     * @return {module:model/DescribeAlgorithmOutputInferenceSpecification} The populated <code>DescribeAlgorithmOutputInferenceSpecification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAlgorithmOutputInferenceSpecification();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAlgorithmOutputInferenceSpecification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAlgorithmOutputInferenceSpecification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeAlgorithmOutputInferenceSpecification.RequiredProperties) {
...
DescribeAlgorithmOutputInferenceSpecification.RequiredProperties = ["Containers", "SupportedContentTypes", "SupportedResponseMIMETypes"];

/**
 * @member {Array} Containers
 */
DescribeAlgorithmOutputInferenceSpecification.prototype['Containers'] = undefined;

/**
 * @member {Array} SupportedTransformInstanceTypes
 */
DescribeAlgorithmOutputInferenceSpecification.prototype['SupportedTransformInstanceTypes'] = undefined;

/**
 * @member {Array} SupportedRealtimeInferenceInstanceTypes
 */
DescribeAlgorithmOutputInferenceSpecification.prototype['SupportedRealtimeInferenceInstanceTypes'] = undefined;

/**
 * @member {Array} SupportedContentTypes
 */
DescribeAlgorithmOutputInferenceSpecification.prototype['SupportedContentTypes'] = undefined;

/**
 * @member {Array} SupportedResponseMIMETypes
 */
DescribeAlgorithmOutputInferenceSpecification.prototype['SupportedResponseMIMETypes'] = undefined;
...
export default DescribeAlgorithmOutputInferenceSpecification;
