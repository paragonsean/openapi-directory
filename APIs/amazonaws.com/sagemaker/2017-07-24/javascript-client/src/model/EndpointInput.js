...
/**
 * The EndpointInput model module.
 * @module model/EndpointInput
 * @version 2017-07-24
 */
class EndpointInput {
    /**
     * Constructs a new <code>EndpointInput</code>.
     * Input object for the endpoint
     * @alias module:model/EndpointInput
    ...
    /**
     * Constructs a <code>EndpointInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EndpointInput} obj Optional instance to populate.
     * @return {module:model/EndpointInput} The populated <code>EndpointInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EndpointInput();
    ...
    /**
     * Validates the JSON data with respect to <code>EndpointInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EndpointInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EndpointInput.RequiredProperties) {
...
EndpointInput.RequiredProperties = ["EndpointName", "LocalPath"];
