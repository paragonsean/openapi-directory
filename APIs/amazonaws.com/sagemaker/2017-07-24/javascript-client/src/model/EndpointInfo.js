...
class EndpointInfo {
    ...
    constructor(endpointName) { 
        ...
        EndpointInfo.initialize(this, endpointName);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of EndpointInfo.RequiredProperties) {
...
EndpointInfo.RequiredProperties = ["EndpointName"];

/**
 * @member {String} EndpointName
 */
EndpointInfo.prototype['EndpointName'] = undefined;
