...
/**
 * The CreateModelInputPrimaryContainer model module.
 * @module model/CreateModelInputPrimaryContainer
 * @version 2017-07-24
 */
class CreateModelInputPrimaryContainer {
    /**
     * Constructs a new <code>CreateModelInputPrimaryContainer</code>.
     * @alias module:model/CreateModelInputPrimaryContainer
     * @implements module:model/ContainerDefinition
     */
    constructor() { 
        ContainerDefinition.initialize(this);
        CreateModelInputPrimaryContainer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateModelInputPrimaryContainer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateModelInputPrimaryContainer} obj Optional instance to populate.
     * @return {module:model/CreateModelInputPrimaryContainer} The populated <code>CreateModelInputPrimaryContainer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateModelInputPrimaryContainer();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateModelInputPrimaryContainer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateModelInputPrimaryContainer</code>.
     */
 ...
 */
CreateModelInputPrimaryContainer.prototype['ContainerHostname'] = undefined;

/**
 * @member {String} Image
 */
CreateModelInputPrimaryContainer.prototype['Image'] = undefined;

/**
 * @member {module:model/ContainerDefinitionImageConfig} ImageConfig
 */
CreateModelInputPrimaryContainer.prototype['ImageConfig'] = undefined;

/**
 * @member {module:model/ContainerMode} Mode
 */
CreateModelInputPrimaryContainer.prototype['Mode'] = undefined;

/**
 * @member {String} ModelDataUrl
 */
CreateModelInputPrimaryContainer.prototype['ModelDataUrl'] = undefined;

/**
 * @member {Object} Environment
 */
CreateModelInputPrimaryContainer.prototype['Environment'] = undefined;

/**
 * @member {String} ModelPackageName
 */
CreateModelInputPrimaryContainer.prototype['ModelPackageName'] = undefined;

/**
 * @member {String} InferenceSpecificationName
 */
CreateModelInputPrimaryContainer.prototype['InferenceSpecificationName'] = undefined;

/**
 * @member {module:model/ContainerDefinitionMultiModelConfig} MultiModelConfig
 */
CreateModelInputPrimaryContainer.prototype['MultiModelConfig'] = undefined;

/**
 * @member {module:model/ContainerDefinitionModelDataSource} ModelDataSource
 */
CreateModelInputPrimaryContainer.prototype['ModelDataSource'] = undefined;
...
export default CreateModelInputPrimaryContainer;
