...
/**
 * The DescribeLabelingJobResponseHumanTaskConfig model module.
 * @module model/DescribeLabelingJobResponseHumanTaskConfig
 * @version 2017-07-24
 */
class DescribeLabelingJobResponseHumanTaskConfig {
    /**
     * Constructs a new <code>DescribeLabelingJobResponseHumanTaskConfig</code>.
     * @alias module:model/DescribeLabelingJobResponseHumanTaskConfig
    ...
    constructor(workteamArn, uiConfig, preHumanTaskLambdaArn, taskTitle, taskDescription, numberOfHumanWorkersPerDataObject, taskTimeLimitInSeconds, annotationConsolidationConfig) { 
        ...
        DescribeLabelingJobResponseHumanTaskConfig.initialize(this, workteamArn, uiConfig, preHumanTaskLambdaArn, taskTitle, taskDescription, numberOfHumanWorkersPerDataObject, taskTimeLimitInSeconds, annotationConsolidationConfig);
    }
    ...
    /**
     * Constructs a <code>DescribeLabelingJobResponseHumanTaskConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeLabelingJobResponseHumanTaskConfig} obj Optional instance to populate.
     * @return {module:model/DescribeLabelingJobResponseHumanTaskConfig} The populated <code>DescribeLabelingJobResponseHumanTaskConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeLabelingJobResponseHumanTaskConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeLabelingJobResponseHumanTaskConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeLabelingJobResponseHumanTaskConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeLabelingJobResponseHumanTaskConfig.RequiredProperties) {
...
DescribeLabelingJobResponseHumanTaskConfig.RequiredProperties = ["WorkteamArn", "UiConfig", "PreHumanTaskLambdaArn", "TaskTitle", "TaskDescription", "NumberOfHumanWorkersPerDataObject", "TaskTimeLimitInSeconds", "AnnotationConsolidationConfig"];

/**
 * @member {String} WorkteamArn
 */
DescribeLabelingJobResponseHumanTaskConfig.prototype['WorkteamArn'] = undefined;

/**
 * @member {module:model/HumanTaskConfigUiConfig} UiConfig
 */
DescribeLabelingJobResponseHumanTaskConfig.prototype['UiConfig'] = undefined;

/**
 * @member {String} PreHumanTaskLambdaArn
 */
DescribeLabelingJobResponseHumanTaskConfig.prototype['PreHumanTaskLambdaArn'] = undefined;

/**
 * @member {Array} TaskKeywords
 */
DescribeLabelingJobResponseHumanTaskConfig.prototype['TaskKeywords'] = undefined;

/**
 * @member {String} TaskTitle
 */
DescribeLabelingJobResponseHumanTaskConfig.prototype['TaskTitle'] = undefined;

/**
 * @member {String} TaskDescription
 */
DescribeLabelingJobResponseHumanTaskConfig.prototype['TaskDescription'] = undefined;

/**
 * @member {Number} NumberOfHumanWorkersPerDataObject
 */
DescribeLabelingJobResponseHumanTaskConfig.prototype['NumberOfHumanWorkersPerDataObject'] = undefined;

/**
 * @member {Number} TaskTimeLimitInSeconds
 */
DescribeLabelingJobResponseHumanTaskConfig.prototype['TaskTimeLimitInSeconds'] = undefined;

/**
 * @member {Number} TaskAvailabilityLifetimeInSeconds
 */
DescribeLabelingJobResponseHumanTaskConfig.prototype['TaskAvailabilityLifetimeInSeconds'] = undefined;

/**
 * @member {Number} MaxConcurrentTaskCount
 */
DescribeLabelingJobResponseHumanTaskConfig.prototype['MaxConcurrentTaskCount'] = undefined;

/**
 * @member {module:model/HumanTaskConfigAnnotationConsolidationConfig} AnnotationConsolidationConfig
 */
DescribeLabelingJobResponseHumanTaskConfig.prototype['AnnotationConsolidationConfig'] = undefined;

/**
 * @member {module:model/HumanTaskConfigPublicWorkforceTaskPrice} PublicWorkforceTaskPrice
 */
DescribeLabelingJobResponseHumanTaskConfig.prototype['PublicWorkforceTaskPrice'] = undefined;
...
export default DescribeLabelingJobResponseHumanTaskConfig;
