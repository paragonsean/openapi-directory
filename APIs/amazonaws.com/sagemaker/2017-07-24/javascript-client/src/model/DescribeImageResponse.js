...
/**
 * The DescribeImageResponse model module.
 * @module model/DescribeImageResponse
 * @version 2017-07-24
 */
class DescribeImageResponse {
    /**
     * Constructs a new <code>DescribeImageResponse</code>.
     * @alias module:model/DescribeImageResponse
     */
    constructor() { 
        
        DescribeImageResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeImageResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeImageResponse} obj Optional instance to populate.
     * @return {module:model/DescribeImageResponse} The populated <code>DescribeImageResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeImageResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeImageResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeImageResponse</code>.
     */
 ...
 */
DescribeImageResponse.prototype['CreationTime'] = undefined;

/**
 * @member {String} Description
 */
DescribeImageResponse.prototype['Description'] = undefined;

/**
 * @member {String} DisplayName
 */
DescribeImageResponse.prototype['DisplayName'] = undefined;

/**
 * @member {String} FailureReason
 */
DescribeImageResponse.prototype['FailureReason'] = undefined;

/**
 * @member {String} ImageArn
 */
DescribeImageResponse.prototype['ImageArn'] = undefined;

/**
 * @member {String} ImageName
 */
DescribeImageResponse.prototype['ImageName'] = undefined;

/**
 * @member {module:model/ImageStatus} ImageStatus
 */
DescribeImageResponse.prototype['ImageStatus'] = undefined;

/**
 * @member {Date} LastModifiedTime
 */
DescribeImageResponse.prototype['LastModifiedTime'] = undefined;

/**
 * @member {String} RoleArn
 */
DescribeImageResponse.prototype['RoleArn'] = undefined;
...
export default DescribeImageResponse;
