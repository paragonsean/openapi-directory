...
/**
 * The MonitoringInputEndpointInput model module.
 * @module model/MonitoringInputEndpointInput
 * @version 2017-07-24
 */
class MonitoringInputEndpointInput {
    /**
     * Constructs a new <code>MonitoringInputEndpointInput</code>.
     * @alias module:model/MonitoringInputEndpointInput
     * @implements module:model/EndpointInput
     * @param endpointName {String} 
     * @param localPath {String} 
     */
    constructor(endpointName, localPath) { 
        EndpointInput.initialize(this, endpointName, localPath);
        MonitoringInputEndpointInput.initialize(this, endpointName, localPath);
    }
     ...
     */
    static initialize(obj, endpointName, localPath) { 
        obj['EndpointName'] = endpointName;
        obj['LocalPath'] = localPath;
    }

    /**
     * Constructs a <code>MonitoringInputEndpointInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MonitoringInputEndpointInput} obj Optional instance to populate.
     * @return {module:model/MonitoringInputEndpointInput} The populated <code>MonitoringInputEndpointInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MonitoringInputEndpointInput();
            EndpointInput.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>MonitoringInputEndpointInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MonitoringInputEndpointInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MonitoringInputEndpointInput.RequiredProperties) {
...
MonitoringInputEndpointInput.RequiredProperties = ["EndpointName", "LocalPath"];

/**
 * @member {String} EndpointName
 */
MonitoringInputEndpointInput.prototype['EndpointName'] = undefined;

/**
 * @member {String} LocalPath
 */
MonitoringInputEndpointInput.prototype['LocalPath'] = undefined;

/**
 * @member {module:model/ProcessingS3InputMode} S3InputMode
 */
MonitoringInputEndpointInput.prototype['S3InputMode'] = undefined;

/**
 * @member {module:model/ProcessingS3DataDistributionType} S3DataDistributionType
 */
MonitoringInputEndpointInput.prototype['S3DataDistributionType'] = undefined;

/**
 * @member {String} FeaturesAttribute
 */
MonitoringInputEndpointInput.prototype['FeaturesAttribute'] = undefined;

/**
 * @member {String} InferenceAttribute
 */
MonitoringInputEndpointInput.prototype['InferenceAttribute'] = undefined;

/**
 * @member {String} ProbabilityAttribute
 */
MonitoringInputEndpointInput.prototype['ProbabilityAttribute'] = undefined;

/**
 * @member {Number} ProbabilityThresholdAttribute
 */
MonitoringInputEndpointInput.prototype['ProbabilityThresholdAttribute'] = undefined;

/**
 * @member {String} StartTimeOffset
 */
MonitoringInputEndpointInput.prototype['StartTimeOffset'] = undefined;

/**
 * @member {String} EndTimeOffset
 */
MonitoringInputEndpointInput.prototype['EndTimeOffset'] = undefined;


// Implement EndpointInput interface:
/**
 * @member {String} EndpointName
 */
EndpointInput.prototype['EndpointName'] = undefined;
/**
 * @member {String} LocalPath
 */
EndpointInput.prototype['LocalPath'] = undefined;
/**
 * @member {module:model/ProcessingS3InputMode} S3InputMode
 */
EndpointInput.prototype['S3InputMode'] = undefined;
/**
 * @member {module:model/ProcessingS3DataDistributionType} S3DataDistributionType
 */
EndpointInput.prototype['S3DataDistributionType'] = undefined;
/**
 * @member {String} FeaturesAttribute
 */
EndpointInput.prototype['FeaturesAttribute'] = undefined;
/**
 * @member {String} InferenceAttribute
 */
EndpointInput.prototype['InferenceAttribute'] = undefined;
/**
 * @member {String} ProbabilityAttribute
 */
EndpointInput.prototype['ProbabilityAttribute'] = undefined;
/**
 * @member {Number} ProbabilityThresholdAttribute
 */
EndpointInput.prototype['ProbabilityThresholdAttribute'] = undefined;
/**
 * @member {String} StartTimeOffset
 */
EndpointInput.prototype['StartTimeOffset'] = undefined;
/**
 * @member {String} EndTimeOffset
 */
EndpointInput.prototype['EndTimeOffset'] = undefined;




export default MonitoringInputEndpointInput;
