...
/**
 * The TrialComponentSourceDetailTrainingJob model module.
 * @module model/TrialComponentSourceDetailTrainingJob
 * @version 2017-07-24
 */
class TrialComponentSourceDetailTrainingJob {
    /**
     * Constructs a new <code>TrialComponentSourceDetailTrainingJob</code>.
     * @alias module:model/TrialComponentSourceDetailTrainingJob
     * @implements module:model/TrainingJob
     */
    constructor() { 
        TrainingJob.initialize(this);
        TrialComponentSourceDetailTrainingJob.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TrialComponentSourceDetailTrainingJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrialComponentSourceDetailTrainingJob} obj Optional instance to populate.
     * @return {module:model/TrialComponentSourceDetailTrainingJob} The populated <code>TrialComponentSourceDetailTrainingJob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrialComponentSourceDetailTrainingJob();
    ...
    /**
     * Validates the JSON data with respect to <code>TrialComponentSourceDetailTrainingJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrialComponentSourceDetailTrainingJob</code>.
     */
 ...
 */
TrialComponentSourceDetailTrainingJob.prototype['TrainingJobName'] = undefined;

/**
 * @member {String} TrainingJobArn
 */
TrialComponentSourceDetailTrainingJob.prototype['TrainingJobArn'] = undefined;

/**
 * @member {String} TuningJobArn
 */
TrialComponentSourceDetailTrainingJob.prototype['TuningJobArn'] = undefined;

/**
 * @member {String} LabelingJobArn
 */
TrialComponentSourceDetailTrainingJob.prototype['LabelingJobArn'] = undefined;

/**
 * @member {String} AutoMLJobArn
 */
TrialComponentSourceDetailTrainingJob.prototype['AutoMLJobArn'] = undefined;

/**
 * @member {module:model/TrainingJobModelArtifacts} ModelArtifacts
 */
TrialComponentSourceDetailTrainingJob.prototype['ModelArtifacts'] = undefined;

/**
 * @member {module:model/TrainingJobStatus} TrainingJobStatus
 */
TrialComponentSourceDetailTrainingJob.prototype['TrainingJobStatus'] = undefined;

/**
 * @member {module:model/SecondaryStatus} SecondaryStatus
 */
TrialComponentSourceDetailTrainingJob.prototype['SecondaryStatus'] = undefined;

/**
 * @member {String} FailureReason
 */
TrialComponentSourceDetailTrainingJob.prototype['FailureReason'] = undefined;

/**
 * @member {Object} HyperParameters
 */
TrialComponentSourceDetailTrainingJob.prototype['HyperParameters'] = undefined;

/**
 * @member {module:model/TrainingJobAlgorithmSpecification} AlgorithmSpecification
 */
TrialComponentSourceDetailTrainingJob.prototype['AlgorithmSpecification'] = undefined;

/**
 * @member {String} RoleArn
 */
TrialComponentSourceDetailTrainingJob.prototype['RoleArn'] = undefined;

/**
 * @member {Array} InputDataConfig
 */
TrialComponentSourceDetailTrainingJob.prototype['InputDataConfig'] = undefined;

/**
 * @member {module:model/TrainingJobOutputDataConfig} OutputDataConfig
 */
TrialComponentSourceDetailTrainingJob.prototype['OutputDataConfig'] = undefined;

/**
 * @member {module:model/TrainingJobResourceConfig} ResourceConfig
 */
TrialComponentSourceDetailTrainingJob.prototype['ResourceConfig'] = undefined;

/**
 * @member {module:model/DescribeTrainingJobResponseVpcConfig} VpcConfig
 */
TrialComponentSourceDetailTrainingJob.prototype['VpcConfig'] = undefined;

/**
 * @member {module:model/CreateTrainingJobRequestStoppingCondition} StoppingCondition
 */
TrialComponentSourceDetailTrainingJob.prototype['StoppingCondition'] = undefined;

/**
 * @member {Date} CreationTime
 */
TrialComponentSourceDetailTrainingJob.prototype['CreationTime'] = undefined;

/**
 * @member {Date} TrainingStartTime
 */
TrialComponentSourceDetailTrainingJob.prototype['TrainingStartTime'] = undefined;

/**
 * @member {Date} TrainingEndTime
 */
TrialComponentSourceDetailTrainingJob.prototype['TrainingEndTime'] = undefined;

/**
 * @member {Date} LastModifiedTime
 */
TrialComponentSourceDetailTrainingJob.prototype['LastModifiedTime'] = undefined;

/**
 * @member {Array} SecondaryStatusTransitions
 */
TrialComponentSourceDetailTrainingJob.prototype['SecondaryStatusTransitions'] = undefined;

/**
 * @member {Array} FinalMetricDataList
 */
TrialComponentSourceDetailTrainingJob.prototype['FinalMetricDataList'] = undefined;

/**
 * @member {Boolean} EnableNetworkIsolation
 */
TrialComponentSourceDetailTrainingJob.prototype['EnableNetworkIsolation'] = undefined;

/**
 * @member {Boolean} EnableInterContainerTrafficEncryption
 */
TrialComponentSourceDetailTrainingJob.prototype['EnableInterContainerTrafficEncryption'] = undefined;

/**
 * @member {Boolean} EnableManagedSpotTraining
 */
TrialComponentSourceDetailTrainingJob.prototype['EnableManagedSpotTraining'] = undefined;

/**
 * @member {module:model/CheckpointConfig} CheckpointConfig
 */
TrialComponentSourceDetailTrainingJob.prototype['CheckpointConfig'] = undefined;

/**
 * @member {Number} TrainingTimeInSeconds
 */
TrialComponentSourceDetailTrainingJob.prototype['TrainingTimeInSeconds'] = undefined;

/**
 * @member {Number} BillableTimeInSeconds
 */
TrialComponentSourceDetailTrainingJob.prototype['BillableTimeInSeconds'] = undefined;

/**
 * @member {module:model/DebugHookConfig} DebugHookConfig
 */
TrialComponentSourceDetailTrainingJob.prototype['DebugHookConfig'] = undefined;

/**
 * @member {module:model/ExperimentConfig} ExperimentConfig
 */
TrialComponentSourceDetailTrainingJob.prototype['ExperimentConfig'] = undefined;

/**
 * @member {Array} DebugRuleConfigurations
 */
TrialComponentSourceDetailTrainingJob.prototype['DebugRuleConfigurations'] = undefined;

/**
 * @member {module:model/TensorBoardOutputConfig} TensorBoardOutputConfig
 */
TrialComponentSourceDetailTrainingJob.prototype['TensorBoardOutputConfig'] = undefined;

/**
 * @member {Array} DebugRuleEvaluationStatuses
 */
TrialComponentSourceDetailTrainingJob.prototype['DebugRuleEvaluationStatuses'] = undefined;

/**
 * @member {module:model/ProfilerConfig} ProfilerConfig
 */
TrialComponentSourceDetailTrainingJob.prototype['ProfilerConfig'] = undefined;

/**
 * @member {Object} Environment
 */
TrialComponentSourceDetailTrainingJob.prototype['Environment'] = undefined;

/**
 * @member {module:model/CreateTrainingJobRequestRetryStrategy} RetryStrategy
 */
TrialComponentSourceDetailTrainingJob.prototype['RetryStrategy'] = undefined;

/**
 * @member {Array} Tags
 */
TrialComponentSourceDetailTrainingJob.prototype['Tags'] = undefined;
...
export default TrialComponentSourceDetailTrainingJob;
