...
/**
 * The ModelVariantConfigInfrastructureConfig model module.
 * @module model/ModelVariantConfigInfrastructureConfig
 * @version 2017-07-24
 */
class ModelVariantConfigInfrastructureConfig {
    /**
     * Constructs a new <code>ModelVariantConfigInfrastructureConfig</code>.
     * @alias module:model/ModelVariantConfigInfrastructureConfig
    ...
    constructor(infrastructureType, realTimeInferenceConfig) { 
        ...
        ModelVariantConfigInfrastructureConfig.initialize(this, infrastructureType, realTimeInferenceConfig);
    }
    ...
    /**
     * Constructs a <code>ModelVariantConfigInfrastructureConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelVariantConfigInfrastructureConfig} obj Optional instance to populate.
     * @return {module:model/ModelVariantConfigInfrastructureConfig} The populated <code>ModelVariantConfigInfrastructureConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModelVariantConfigInfrastructureConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>ModelVariantConfigInfrastructureConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModelVariantConfigInfrastructureConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ModelVariantConfigInfrastructureConfig.RequiredProperties) {
...
ModelVariantConfigInfrastructureConfig.RequiredProperties = ["InfrastructureType", "RealTimeInferenceConfig"];

/**
 * @member {module:model/ModelInfrastructureType} InfrastructureType
 */
ModelVariantConfigInfrastructureConfig.prototype['InfrastructureType'] = undefined;

/**
 * @member {module:model/ModelInfrastructureConfigRealTimeInferenceConfig} RealTimeInferenceConfig
 */
ModelVariantConfigInfrastructureConfig.prototype['RealTimeInferenceConfig'] = undefined;
...
export default ModelVariantConfigInfrastructureConfig;
