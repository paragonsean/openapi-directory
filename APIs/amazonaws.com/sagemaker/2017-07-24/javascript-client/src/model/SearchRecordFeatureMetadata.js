...
/**
 * The SearchRecordFeatureMetadata model module.
 * @module model/SearchRecordFeatureMetadata
 * @version 2017-07-24
 */
class SearchRecordFeatureMetadata {
    /**
     * Constructs a new <code>SearchRecordFeatureMetadata</code>.
     * @alias module:model/SearchRecordFeatureMetadata
     * @implements module:model/FeatureMetadata
     */
    constructor() { 
        FeatureMetadata.initialize(this);
        SearchRecordFeatureMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchRecordFeatureMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchRecordFeatureMetadata} obj Optional instance to populate.
     * @return {module:model/SearchRecordFeatureMetadata} The populated <code>SearchRecordFeatureMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchRecordFeatureMetadata();
            FeatureMetadata.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SearchRecordFeatureMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchRecordFeatureMetadata</code>.
     */
 ...
 */
SearchRecordFeatureMetadata.prototype['FeatureGroupArn'] = undefined;

/**
 * @member {String} FeatureGroupName
 */
SearchRecordFeatureMetadata.prototype['FeatureGroupName'] = undefined;

/**
 * @member {String} FeatureName
 */
SearchRecordFeatureMetadata.prototype['FeatureName'] = undefined;

/**
 * @member {module:model/FeatureType} FeatureType
 */
SearchRecordFeatureMetadata.prototype['FeatureType'] = undefined;

/**
 * @member {Date} CreationTime
 */
SearchRecordFeatureMetadata.prototype['CreationTime'] = undefined;

/**
 * @member {Date} LastModifiedTime
 */
SearchRecordFeatureMetadata.prototype['LastModifiedTime'] = undefined;

/**
 * @member {String} Description
 */
SearchRecordFeatureMetadata.prototype['Description'] = undefined;

/**
 * @member {Array} Parameters
 */
SearchRecordFeatureMetadata.prototype['Parameters'] = undefined;


// Implement FeatureMetadata interface:
/**
 * @member {String} FeatureGroupArn
 */
...
export default SearchRecordFeatureMetadata;
