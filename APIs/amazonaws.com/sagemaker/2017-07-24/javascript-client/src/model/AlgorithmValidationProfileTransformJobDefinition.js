...
/**
 * The AlgorithmValidationProfileTransformJobDefinition model module.
 * @module model/AlgorithmValidationProfileTransformJobDefinition
 * @version 2017-07-24
 */
class AlgorithmValidationProfileTransformJobDefinition {
    /**
     * Constructs a new <code>AlgorithmValidationProfileTransformJobDefinition</code>.
     * @alias module:model/AlgorithmValidationProfileTransformJobDefinition
    ...
    constructor(transformInput, transformOutput, transformResources) { 
        ...
        AlgorithmValidationProfileTransformJobDefinition.initialize(this, transformInput, transformOutput, transformResources);
    }
    ...
    /**
     * Constructs a <code>AlgorithmValidationProfileTransformJobDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AlgorithmValidationProfileTransformJobDefinition} obj Optional instance to populate.
     * @return {module:model/AlgorithmValidationProfileTransformJobDefinition} The populated <code>AlgorithmValidationProfileTransformJobDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AlgorithmValidationProfileTransformJobDefinition();
    ...
    /**
     * Validates the JSON data with respect to <code>AlgorithmValidationProfileTransformJobDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AlgorithmValidationProfileTransformJobDefinition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AlgorithmValidationProfileTransformJobDefinition.RequiredProperties) {
...
AlgorithmValidationProfileTransformJobDefinition.RequiredProperties = ["TransformInput", "TransformOutput", "TransformResources"];

/**
 * @member {Number} MaxConcurrentTransforms
 */
AlgorithmValidationProfileTransformJobDefinition.prototype['MaxConcurrentTransforms'] = undefined;

/**
 * @member {Number} MaxPayloadInMB
 */
AlgorithmValidationProfileTransformJobDefinition.prototype['MaxPayloadInMB'] = undefined;

/**
 * @member {module:model/BatchStrategy} BatchStrategy
 */
AlgorithmValidationProfileTransformJobDefinition.prototype['BatchStrategy'] = undefined;

/**
 * @member {Object} Environment
 */
AlgorithmValidationProfileTransformJobDefinition.prototype['Environment'] = undefined;

/**
 * @member {module:model/TransformJobDefinitionTransformInput} TransformInput
 */
AlgorithmValidationProfileTransformJobDefinition.prototype['TransformInput'] = undefined;

/**
 * @member {module:model/DescribeTransformJobResponseTransformOutput} TransformOutput
 */
AlgorithmValidationProfileTransformJobDefinition.prototype['TransformOutput'] = undefined;

/**
 * @member {module:model/TransformJobDefinitionTransformResources} TransformResources
 */
AlgorithmValidationProfileTransformJobDefinition.prototype['TransformResources'] = undefined;
...
export default AlgorithmValidationProfileTransformJobDefinition;
