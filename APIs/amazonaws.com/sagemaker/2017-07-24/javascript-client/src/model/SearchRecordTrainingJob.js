...
/**
 * The SearchRecordTrainingJob model module.
 * @module model/SearchRecordTrainingJob
 * @version 2017-07-24
 */
class SearchRecordTrainingJob {
    /**
     * Constructs a new <code>SearchRecordTrainingJob</code>.
     * @alias module:model/SearchRecordTrainingJob
     * @implements module:model/TrainingJob
     */
    constructor() { 
        TrainingJob.initialize(this);
        SearchRecordTrainingJob.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchRecordTrainingJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchRecordTrainingJob} obj Optional instance to populate.
     * @return {module:model/SearchRecordTrainingJob} The populated <code>SearchRecordTrainingJob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchRecordTrainingJob();
            TrainingJob.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SearchRecordTrainingJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchRecordTrainingJob</code>.
     */
 ...
 */
SearchRecordTrainingJob.prototype['TrainingJobName'] = undefined;

/**
 * @member {String} TrainingJobArn
 */
SearchRecordTrainingJob.prototype['TrainingJobArn'] = undefined;

/**
 * @member {String} TuningJobArn
 */
SearchRecordTrainingJob.prototype['TuningJobArn'] = undefined;

/**
 * @member {String} LabelingJobArn
 */
SearchRecordTrainingJob.prototype['LabelingJobArn'] = undefined;

/**
 * @member {String} AutoMLJobArn
 */
SearchRecordTrainingJob.prototype['AutoMLJobArn'] = undefined;

/**
 * @member {module:model/TrainingJobModelArtifacts} ModelArtifacts
 */
SearchRecordTrainingJob.prototype['ModelArtifacts'] = undefined;

/**
 * @member {module:model/TrainingJobStatus} TrainingJobStatus
 */
SearchRecordTrainingJob.prototype['TrainingJobStatus'] = undefined;

/**
 * @member {module:model/SecondaryStatus} SecondaryStatus
 */
SearchRecordTrainingJob.prototype['SecondaryStatus'] = undefined;

/**
 * @member {String} FailureReason
 */
SearchRecordTrainingJob.prototype['FailureReason'] = undefined;

/**
 * @member {Object} HyperParameters
 */
SearchRecordTrainingJob.prototype['HyperParameters'] = undefined;

/**
 * @member {module:model/TrainingJobAlgorithmSpecification} AlgorithmSpecification
 */
SearchRecordTrainingJob.prototype['AlgorithmSpecification'] = undefined;

/**
 * @member {String} RoleArn
 */
SearchRecordTrainingJob.prototype['RoleArn'] = undefined;

/**
 * @member {Array} InputDataConfig
 */
SearchRecordTrainingJob.prototype['InputDataConfig'] = undefined;

/**
 * @member {module:model/TrainingJobOutputDataConfig} OutputDataConfig
 */
SearchRecordTrainingJob.prototype['OutputDataConfig'] = undefined;

/**
 * @member {module:model/TrainingJobResourceConfig} ResourceConfig
 */
SearchRecordTrainingJob.prototype['ResourceConfig'] = undefined;

/**
 * @member {module:model/DescribeTrainingJobResponseVpcConfig} VpcConfig
 */
SearchRecordTrainingJob.prototype['VpcConfig'] = undefined;

/**
 * @member {module:model/CreateTrainingJobRequestStoppingCondition} StoppingCondition
 */
SearchRecordTrainingJob.prototype['StoppingCondition'] = undefined;

/**
 * @member {Date} CreationTime
 */
SearchRecordTrainingJob.prototype['CreationTime'] = undefined;

/**
 * @member {Date} TrainingStartTime
 */
SearchRecordTrainingJob.prototype['TrainingStartTime'] = undefined;

/**
 * @member {Date} TrainingEndTime
 */
SearchRecordTrainingJob.prototype['TrainingEndTime'] = undefined;

/**
 * @member {Date} LastModifiedTime
 */
SearchRecordTrainingJob.prototype['LastModifiedTime'] = undefined;

/**
 * @member {Array} SecondaryStatusTransitions
 */
SearchRecordTrainingJob.prototype['SecondaryStatusTransitions'] = undefined;

/**
 * @member {Array} FinalMetricDataList
 */
SearchRecordTrainingJob.prototype['FinalMetricDataList'] = undefined;

/**
 * @member {Boolean} EnableNetworkIsolation
 */
SearchRecordTrainingJob.prototype['EnableNetworkIsolation'] = undefined;

/**
 * @member {Boolean} EnableInterContainerTrafficEncryption
 */
SearchRecordTrainingJob.prototype['EnableInterContainerTrafficEncryption'] = undefined;

/**
 * @member {Boolean} EnableManagedSpotTraining
 */
SearchRecordTrainingJob.prototype['EnableManagedSpotTraining'] = undefined;

/**
 * @member {module:model/CheckpointConfig} CheckpointConfig
 */
SearchRecordTrainingJob.prototype['CheckpointConfig'] = undefined;

/**
 * @member {Number} TrainingTimeInSeconds
 */
SearchRecordTrainingJob.prototype['TrainingTimeInSeconds'] = undefined;

/**
 * @member {Number} BillableTimeInSeconds
 */
SearchRecordTrainingJob.prototype['BillableTimeInSeconds'] = undefined;

/**
 * @member {module:model/DebugHookConfig} DebugHookConfig
 */
SearchRecordTrainingJob.prototype['DebugHookConfig'] = undefined;

/**
 * @member {module:model/ExperimentConfig} ExperimentConfig
 */
SearchRecordTrainingJob.prototype['ExperimentConfig'] = undefined;

/**
 * @member {Array} DebugRuleConfigurations
 */
SearchRecordTrainingJob.prototype['DebugRuleConfigurations'] = undefined;

/**
 * @member {module:model/TensorBoardOutputConfig} TensorBoardOutputConfig
 */
SearchRecordTrainingJob.prototype['TensorBoardOutputConfig'] = undefined;

/**
 * @member {Array} DebugRuleEvaluationStatuses
 */
SearchRecordTrainingJob.prototype['DebugRuleEvaluationStatuses'] = undefined;

/**
 * @member {module:model/ProfilerConfig} ProfilerConfig
 */
SearchRecordTrainingJob.prototype['ProfilerConfig'] = undefined;

/**
 * @member {Object} Environment
 */
SearchRecordTrainingJob.prototype['Environment'] = undefined;

/**
 * @member {module:model/CreateTrainingJobRequestRetryStrategy} RetryStrategy
 */
SearchRecordTrainingJob.prototype['RetryStrategy'] = undefined;

/**
 * @member {Array} Tags
 */
SearchRecordTrainingJob.prototype['Tags'] = undefined;


// Implement TrainingJob interface:
/**
 * @member {String} TrainingJobName
 */
...
export default SearchRecordTrainingJob;
