...
/**
 * The TransformJobDefinition model module.
 * @module model/TransformJobDefinition
 * @version 2017-07-24
 */
class TransformJobDefinition {
    /**
     * Constructs a new <code>TransformJobDefinition</code>.
     * Defines the input needed to run a transform job using the inference specification specified in the algorithm.
     * @alias module:model/TransformJobDefinition
    ...
    /**
     * Constructs a <code>TransformJobDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransformJobDefinition} obj Optional instance to populate.
     * @return {module:model/TransformJobDefinition} The populated <code>TransformJobDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransformJobDefinition();
    ...
    /**
     * Validates the JSON data with respect to <code>TransformJobDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransformJobDefinition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransformJobDefinition.RequiredProperties) {
...
TransformJobDefinition.RequiredProperties = ["TransformInput", "TransformOutput", "TransformResources"];
...
export default TransformJobDefinition;
