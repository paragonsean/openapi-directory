...
* @readonly
*/
export default class ProcessingInstanceType {
    ...
    /**
    * Returns a <code>ProcessingInstanceType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ProcessingInstanceType} The enum <code>ProcessingInstanceType</code> value.
    */
