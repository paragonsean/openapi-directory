...
* @readonly
*/
export default class TrainingInstanceType {
         ...
         * @const
         */
        "trn1n.32xlarge" = "ml.trn1n.32xlarge";
         ...
         * @const
         */
        "p5.48xlarge" = "ml.p5.48xlarge";

    

    /**
    * Returns a <code>TrainingInstanceType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TrainingInstanceType} The enum <code>TrainingInstanceType</code> value.
    */
