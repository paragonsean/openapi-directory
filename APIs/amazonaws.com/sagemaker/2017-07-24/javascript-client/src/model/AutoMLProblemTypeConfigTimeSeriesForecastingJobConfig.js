...
import TimeSeriesForecastingJobConfig from './TimeSeriesForecastingJobConfig';
...
/**
 * The AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig model module.
 * @module model/AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig
 * @version 2017-07-24
 */
class AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig {
    /**
     * Constructs a new <code>AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig</code>.
     * @alias module:model/AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig
     * @implements module:model/TimeSeriesForecastingJobConfig
    ...
    constructor(forecastFrequency, forecastHorizon, timeSeriesConfig) { 
        ...
        AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig.initialize(this, forecastFrequency, forecastHorizon, timeSeriesConfig);
    }
    ...
    /**
     * Constructs a <code>AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig} obj Optional instance to populate.
     * @return {module:model/AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig} The populated <code>AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig();
            TimeSeriesForecastingJobConfig.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig.RequiredProperties) {
...
AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig.RequiredProperties = ["ForecastFrequency", "ForecastHorizon", "TimeSeriesConfig"];

/**
 * @member {String} FeatureSpecificationS3Uri
 */
AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig.prototype['FeatureSpecificationS3Uri'] = undefined;

/**
 * @member {module:model/AutoMLJobCompletionCriteria} CompletionCriteria
 */
AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig.prototype['CompletionCriteria'] = undefined;

/**
 * @member {String} ForecastFrequency
 */
AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig.prototype['ForecastFrequency'] = undefined;

/**
 * @member {Number} ForecastHorizon
 */
AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig.prototype['ForecastHorizon'] = undefined;

/**
 * @member {Array} ForecastQuantiles
 */
AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig.prototype['ForecastQuantiles'] = undefined;

/**
 * @member {module:model/TimeSeriesForecastingJobConfigTransformations} Transformations
 */
AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig.prototype['Transformations'] = undefined;

/**
 * @member {module:model/TimeSeriesForecastingJobConfigTimeSeriesConfig} TimeSeriesConfig
 */
AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig.prototype['TimeSeriesConfig'] = undefined;


// Implement TimeSeriesForecastingJobConfig interface:
/**
 * @member {String} FeatureSpecificationS3Uri
 */
...
export default AutoMLProblemTypeConfigTimeSeriesForecastingJobConfig;
