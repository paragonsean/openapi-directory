...
/**
 * The CreateTransformJobRequestTransformInput model module.
 * @module model/CreateTransformJobRequestTransformInput
 * @version 2017-07-24
 */
class CreateTransformJobRequestTransformInput {
    /**
     * Constructs a new <code>CreateTransformJobRequestTransformInput</code>.
     * @alias module:model/CreateTransformJobRequestTransformInput
    ...
    constructor(dataSource) { 
        ...
        CreateTransformJobRequestTransformInput.initialize(this, dataSource);
    }
    ...
    /**
     * Constructs a <code>CreateTransformJobRequestTransformInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTransformJobRequestTransformInput} obj Optional instance to populate.
     * @return {module:model/CreateTransformJobRequestTransformInput} The populated <code>CreateTransformJobRequestTransformInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTransformJobRequestTransformInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTransformJobRequestTransformInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTransformJobRequestTransformInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateTransformJobRequestTransformInput.RequiredProperties) {
...
CreateTransformJobRequestTransformInput.RequiredProperties = ["DataSource"];

/**
 * @member {module:model/TransformInputDataSource} DataSource
 */
CreateTransformJobRequestTransformInput.prototype['DataSource'] = undefined;

/**
 * @member {String} ContentType
 */
CreateTransformJobRequestTransformInput.prototype['ContentType'] = undefined;

/**
 * @member {module:model/CompressionType} CompressionType
 */
CreateTransformJobRequestTransformInput.prototype['CompressionType'] = undefined;

/**
 * @member {module:model/SplitType} SplitType
 */
CreateTransformJobRequestTransformInput.prototype['SplitType'] = undefined;
...
export default CreateTransformJobRequestTransformInput;
