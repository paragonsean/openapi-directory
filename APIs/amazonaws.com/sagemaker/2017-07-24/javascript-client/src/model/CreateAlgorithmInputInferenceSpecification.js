...
/**
 * The CreateAlgorithmInputInferenceSpecification model module.
 * @module model/CreateAlgorithmInputInferenceSpecification
 * @version 2017-07-24
 */
class CreateAlgorithmInputInferenceSpecification {
    /**
     * Constructs a new <code>CreateAlgorithmInputInferenceSpecification</code>.
     * @alias module:model/CreateAlgorithmInputInferenceSpecification
    ...
    constructor(containers, supportedContentTypes, supportedResponseMIMETypes) { 
        ...
        CreateAlgorithmInputInferenceSpecification.initialize(this, containers, supportedContentTypes, supportedResponseMIMETypes);
    }
    ...
    /**
     * Constructs a <code>CreateAlgorithmInputInferenceSpecification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAlgorithmInputInferenceSpecification} obj Optional instance to populate.
     * @return {module:model/CreateAlgorithmInputInferenceSpecification} The populated <code>CreateAlgorithmInputInferenceSpecification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAlgorithmInputInferenceSpecification();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAlgorithmInputInferenceSpecification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAlgorithmInputInferenceSpecification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateAlgorithmInputInferenceSpecification.RequiredProperties) {
...
CreateAlgorithmInputInferenceSpecification.RequiredProperties = ["Containers", "SupportedContentTypes", "SupportedResponseMIMETypes"];

/**
 * @member {Array} Containers
 */
CreateAlgorithmInputInferenceSpecification.prototype['Containers'] = undefined;

/**
 * @member {Array} SupportedTransformInstanceTypes
 */
CreateAlgorithmInputInferenceSpecification.prototype['SupportedTransformInstanceTypes'] = undefined;

/**
 * @member {Array} SupportedRealtimeInferenceInstanceTypes
 */
CreateAlgorithmInputInferenceSpecification.prototype['SupportedRealtimeInferenceInstanceTypes'] = undefined;

/**
 * @member {Array} SupportedContentTypes
 */
CreateAlgorithmInputInferenceSpecification.prototype['SupportedContentTypes'] = undefined;

/**
 * @member {Array} SupportedResponseMIMETypes
 */
CreateAlgorithmInputInferenceSpecification.prototype['SupportedResponseMIMETypes'] = undefined;
...
export default CreateAlgorithmInputInferenceSpecification;
