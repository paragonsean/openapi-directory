...
/**
 * The TransformInput model module.
 * @module model/TransformInput
 * @version 2017-07-24
 */
class TransformInput {
    /**
     * Constructs a new <code>TransformInput</code>.
     * Describes the input source of a transform job and the way the transform job consumes it.
     * @alias module:model/TransformInput
    ...
    /**
     * Constructs a <code>TransformInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransformInput} obj Optional instance to populate.
     * @return {module:model/TransformInput} The populated <code>TransformInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransformInput();
    ...
    /**
     * Validates the JSON data with respect to <code>TransformInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransformInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransformInput.RequiredProperties) {
...
TransformInput.RequiredProperties = ["DataSource"];
