...
/**
 * The HyperParameterAlgorithmSpecification model module.
 * @module model/HyperParameterAlgorithmSpecification
 * @version 2017-07-24
 */
class HyperParameterAlgorithmSpecification {
    /**
     * Constructs a new <code>HyperParameterAlgorithmSpecification</code>.
     * Specifies which training algorithm to use for training jobs that a hyperparameter tuning job launches and the metrics to monitor.
     * @alias module:model/HyperParameterAlgorithmSpecification
    ...
    /**
     * Constructs a <code>HyperParameterAlgorithmSpecification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HyperParameterAlgorithmSpecification} obj Optional instance to populate.
     * @return {module:model/HyperParameterAlgorithmSpecification} The populated <code>HyperParameterAlgorithmSpecification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HyperParameterAlgorithmSpecification();
    ...
    /**
     * Validates the JSON data with respect to <code>HyperParameterAlgorithmSpecification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HyperParameterAlgorithmSpecification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HyperParameterAlgorithmSpecification.RequiredProperties) {
...
HyperParameterAlgorithmSpecification.RequiredProperties = ["TrainingInputMode"];
...
export default HyperParameterAlgorithmSpecification;
