...
public class ApiClient {
    ...
    private String basePath = "http://s3-outposts.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://s3-outposts.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "http://s3-outposts.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://s3-outposts.{region}.amazonaws.com.cn",
      "The Amazon S3 Outposts endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-07-25/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://s3-outposts.us-east-1.amazonaws.com
