...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonS3OnOutposts.ListEndpointsResult();
  });
  ...
  describe('ListEndpointsResult', function() {
    it('should create an instance of ListEndpointsResult', function() {
      // uncomment below and update the code to test ListEndpointsResult
      //var instance = new AmazonS3OnOutposts.ListEndpointsResult();
      //expect(instance).to.be.a(AmazonS3OnOutposts.ListEndpointsResult);
    });
