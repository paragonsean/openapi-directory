...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerFeatureStoreRuntime.BatchGetRecordRequest();
  });
  ...
  describe('BatchGetRecordRequest', function() {
    it('should create an instance of BatchGetRecordRequest', function() {
      // uncomment below and update the code to test BatchGetRecordRequest
      //var instance = new AmazonSageMakerFeatureStoreRuntime.BatchGetRecordRequest();
      //expect(instance).to.be.a(AmazonSageMakerFeatureStoreRuntime.BatchGetRecordRequest);
    });
    ...
    it('should have the property expirationTimeResponse (base name: "ExpirationTimeResponse")', function() {
      // uncomment below and update the code to test the property expirationTimeResponse
      //var instance = new AmazonSageMakerFeatureStoreRuntime.BatchGetRecordRequest();
      //expect(instance).to.be();
    });
