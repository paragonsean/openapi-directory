...
(function(root, factory) {
  ...
  describe('DeletionMode', function() {
    it('should create an instance of DeletionMode', function() {
      // uncomment below and update the code to test DeletionMode
      //var instance = new AmazonSageMakerFeatureStoreRuntime.DeletionMode();
      //expect(instance).to.be.a(AmazonSageMakerFeatureStoreRuntime.DeletionMode);
    });
