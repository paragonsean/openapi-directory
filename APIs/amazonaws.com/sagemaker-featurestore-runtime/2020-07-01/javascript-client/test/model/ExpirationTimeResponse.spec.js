...
(function(root, factory) {
  ...
  describe('ExpirationTimeResponse', function() {
    it('should create an instance of ExpirationTimeResponse', function() {
      // uncomment below and update the code to test ExpirationTimeResponse
      //var instance = new AmazonSageMakerFeatureStoreRuntime.ExpirationTimeResponse();
      //expect(instance).to.be.a(AmazonSageMakerFeatureStoreRuntime.ExpirationTimeResponse);
    });
