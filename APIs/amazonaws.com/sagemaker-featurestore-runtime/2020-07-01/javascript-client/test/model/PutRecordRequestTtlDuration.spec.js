...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerFeatureStoreRuntime.PutRecordRequestTtlDuration();
  });
  ...
  describe('PutRecordRequestTtlDuration', function() {
    it('should create an instance of PutRecordRequestTtlDuration', function() {
      // uncomment below and update the code to test PutRecordRequestTtlDuration
      //var instance = new AmazonSageMakerFeatureStoreRuntime.PutRecordRequestTtlDuration();
      //expect(instance).to.be.a(AmazonSageMakerFeatureStoreRuntime.PutRecordRequestTtlDuration);
    });
