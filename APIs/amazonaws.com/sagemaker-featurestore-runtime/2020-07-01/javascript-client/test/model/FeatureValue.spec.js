...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerFeatureStoreRuntime.FeatureValue();
  });
  ...
  describe('FeatureValue', function() {
    it('should create an instance of FeatureValue', function() {
      ...
      //var instance = new AmazonSageMakerFeatureStoreRuntime.FeatureValue();
      //expect(instance).to.be.a(AmazonSageMakerFeatureStoreRuntime.FeatureValue);
    });
