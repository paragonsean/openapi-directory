...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerFeatureStoreRuntime.GetRecordResponse();
  });
  ...
  describe('GetRecordResponse', function() {
    it('should create an instance of GetRecordResponse', function() {
      // uncomment below and update the code to test GetRecordResponse
      //var instance = new AmazonSageMakerFeatureStoreRuntime.GetRecordResponse();
      //expect(instance).to.be.a(AmazonSageMakerFeatureStoreRuntime.GetRecordResponse);
    });
