...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerFeatureStoreRuntime.BatchGetRecordError();
  });
  ...
  describe('BatchGetRecordError', function() {
    it('should create an instance of BatchGetRecordError', function() {
      // uncomment below and update the code to test BatchGetRecordError
      //var instance = new AmazonSageMakerFeatureStoreRuntime.BatchGetRecordError();
      //expect(instance).to.be.a(AmazonSageMakerFeatureStoreRuntime.BatchGetRecordError);
    });
