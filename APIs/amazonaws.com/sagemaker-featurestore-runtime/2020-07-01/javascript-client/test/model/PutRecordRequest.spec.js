...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerFeatureStoreRuntime.PutRecordRequest();
  });
  ...
  describe('PutRecordRequest', function() {
    it('should create an instance of PutRecordRequest', function() {
      // uncomment below and update the code to test PutRecordRequest
      //var instance = new AmazonSageMakerFeatureStoreRuntime.PutRecordRequest();
      //expect(instance).to.be.a(AmazonSageMakerFeatureStoreRuntime.PutRecordRequest);
    });
    ...
    it('should have the property targetStores (base name: "TargetStores")', function() {
      // uncomment below and update the code to test the property targetStores
      //var instance = new AmazonSageMakerFeatureStoreRuntime.PutRecordRequest();
      //expect(instance).to.be();
    });
