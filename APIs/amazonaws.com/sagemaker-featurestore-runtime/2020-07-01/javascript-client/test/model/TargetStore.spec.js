...
(function(root, factory) {
  ...
  describe('TargetStore', function() {
    it('should create an instance of TargetStore', function() {
      // uncomment below and update the code to test TargetStore
      //var instance = new AmazonSageMakerFeatureStoreRuntime.TargetStore();
      //expect(instance).to.be.a(AmazonSageMakerFeatureStoreRuntime.TargetStore);
    });
