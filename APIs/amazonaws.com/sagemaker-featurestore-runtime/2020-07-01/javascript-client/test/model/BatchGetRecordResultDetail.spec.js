...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerFeatureStoreRuntime.BatchGetRecordResultDetail();
  });
  ...
  describe('BatchGetRecordResultDetail', function() {
    it('should create an instance of BatchGetRecordResultDetail', function() {
      // uncomment below and update the code to test BatchGetRecordResultDetail
      //var instance = new AmazonSageMakerFeatureStoreRuntime.BatchGetRecordResultDetail();
      //expect(instance).to.be.a(AmazonSageMakerFeatureStoreRuntime.BatchGetRecordResultDetail);
    });
    ...
    it('should have the property recordIdentifierValueAsString (base name: "RecordIdentifierValueAsString")', function() {
      // uncomment below and update the code to test the property recordIdentifierValueAsString
      //var instance = new AmazonSageMakerFeatureStoreRuntime.BatchGetRecordResultDetail();
      //expect(instance).to.be();
    });
