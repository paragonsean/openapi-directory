...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSageMakerFeatureStoreRuntime.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('batchGetRecord', function() {
      it('should call batchGetRecord successfully', function(done) {
        //uncomment below and update the code to test batchGetRecord
        //instance.batchGetRecord(function(error) {
