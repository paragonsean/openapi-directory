...
* @readonly
*/
export default class DeletionMode {
    ...
    /**
    * Returns a <code>DeletionMode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DeletionMode} The enum <code>DeletionMode</code> value.
    */
