...
* @readonly
*/
export default class ExpirationTimeResponse {
    ...
    /**
    * Returns a <code>ExpirationTimeResponse</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ExpirationTimeResponse} The enum <code>ExpirationTimeResponse</code> value.
    */
