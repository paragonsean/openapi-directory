...
class Example : public QObject {
    Q_OBJECT
    OAIBatchGetRecord_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAIBatchGetRecord_request Example::create(){
    OAIBatchGetRecord_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::batchGetRecordSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::batchGetRecordSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIBatchGetRecord_request oai_batch_get_record_request = create(); // OAIBatchGetRecord_request | 
      ...
      apiInstance.batchGetRecord(oai_batch_get_record_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
