...
OAIPutRecord_request::OAIPutRecord_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutRecord_request::OAIPutRecord_request() {
    this->initializeModel();
}

OAIPutRecord_request::~OAIPutRecord_request() {}

void OAIPutRecord_request::initializeModel() {
...
void OAIPutRecord_request::fromJson(QString jsonString) {
...
void OAIPutRecord_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutRecord_request::asJson() const {
...
QJsonObject OAIPutRecord_request::asJsonObject() const {
    QJsonObject obj;
    if (m_record.size() > 0) {
        obj.insert(QString("Record"), ::OpenAPI::toJsonValue(m_record));
    }
    if (m_target_stores.size() > 0) {
...
QList<OAIFeatureValue> OAIPutRecord_request::getRecord() const {
    return m_record;
}
void OAIPutRecord_request::setRecord(const QList<OAIFeatureValue> &record) {
    m_record = record;
    m_record_isSet = true;
}

bool OAIPutRecord_request::is_record_Set() const{
    return m_record_isSet;
}

bool OAIPutRecord_request::is_record_Valid() const{
    return m_record_isValid;
}

QList<OAITargetStore> OAIPutRecord_request::getTargetStores() const {
    return m_target_stores;
}
void OAIPutRecord_request::setTargetStores(const QList<OAITargetStore> &target_stores) {
    m_target_stores = target_stores;
    m_target_stores_isSet = true;
}

bool OAIPutRecord_request::is_target_stores_Set() const{
    return m_target_stores_isSet;
}

bool OAIPutRecord_request::is_target_stores_Valid() const{
    return m_target_stores_isValid;
}

OAIPutRecord_request_TtlDuration OAIPutRecord_request::getTtlDuration() const {
    return m_ttl_duration;
}
void OAIPutRecord_request::setTtlDuration(const OAIPutRecord_request_TtlDuration &ttl_duration) {
    m_ttl_duration = ttl_duration;
    m_ttl_duration_isSet = true;
}

bool OAIPutRecord_request::is_ttl_duration_Set() const{
    return m_ttl_duration_isSet;
}

bool OAIPutRecord_request::is_ttl_duration_Valid() const{
    return m_ttl_duration_isValid;
}

bool OAIPutRecord_request::isSet() const {
...
bool OAIPutRecord_request::isValid() const {
