...
/*
 * OAIPutRecordRequest_TtlDuration.h
 *
 * 
 */

#ifndef OAIPutRecordRequest_TtlDuration_H
#define OAIPutRecordRequest_TtlDuration_H
...
class OAIPutRecordRequest_TtlDuration : public OAIObject {
public:
    OAIPutRecordRequest_TtlDuration();
    OAIPutRecordRequest_TtlDuration(QString json);
    ~OAIPutRecordRequest_TtlDuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRecordRequest_TtlDuration)

#endif // OAIPutRecordRequest_TtlDuration_H
