...
/*
 * OAIPutRecord_request_TtlDuration.h
 *
...
#ifndef OAIPutRecord_request_TtlDuration_H
#define OAIPutRecord_request_TtlDuration_H
...
class OAIPutRecord_request_TtlDuration : public OAIObject {
public:
    OAIPutRecord_request_TtlDuration();
    OAIPutRecord_request_TtlDuration(QString json);
    ~OAIPutRecord_request_TtlDuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRecord_request_TtlDuration)

#endif // OAIPutRecord_request_TtlDuration_H
