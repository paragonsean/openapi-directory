...
#ifndef OAIDeletionMode_H
#define OAIDeletionMode_H
...
class OAIDeletionMode : public OAIEnum {
public:
    OAIDeletionMode();
    OAIDeletionMode(QString json);
    ~OAIDeletionMode() override;
    ...
    enum class eOAIDeletionMode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SOFTDELETE, 
        HARDDELETE
    };
    OAIDeletionMode::eOAIDeletionMode getValue() const;
    void setValue(const OAIDeletionMode::eOAIDeletionMode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletionMode)

#endif // OAIDeletionMode_H
