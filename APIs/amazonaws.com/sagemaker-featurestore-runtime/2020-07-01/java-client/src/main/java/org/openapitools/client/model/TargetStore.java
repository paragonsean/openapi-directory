...
/**
 * Gets or Sets TargetStore
 */
@JsonAdapter(TargetStore.Adapter.class)
public enum TargetStore {
  ...
  public static TargetStore fromValue(String value) {
    for (TargetStore b : TargetStore.values()) {
  ...
  public static class Adapter extends TypeAdapter<TargetStore> {
    @Override
    public void write(final JsonWriter jsonWriter, final TargetStore enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TargetStore read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TargetStore.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TargetStore.fromValue(value);
  }
}
