...
/**
 * Gets or Sets ExpirationTimeResponse
 */
@JsonAdapter(ExpirationTimeResponse.Adapter.class)
public enum ExpirationTimeResponse {
  ...
  ExpirationTimeResponse(String value) {
    this.value = value;
  }
  ...
  public static ExpirationTimeResponse fromValue(String value) {
    for (ExpirationTimeResponse b : ExpirationTimeResponse.values()) {
  ...
  public static class Adapter extends TypeAdapter<ExpirationTimeResponse> {
    @Override
    public void write(final JsonWriter jsonWriter, final ExpirationTimeResponse enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ExpirationTimeResponse read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ExpirationTimeResponse.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ExpirationTimeResponse.fromValue(value);
  }
}
