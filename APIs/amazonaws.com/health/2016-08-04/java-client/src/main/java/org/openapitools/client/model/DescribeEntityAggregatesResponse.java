...
public class DescribeEntityAggregatesResponse {
  public static final String SERIALIZED_NAME_ENTITY_AGGREGATES = "entityAggregates";
  @SerializedName(SERIALIZED_NAME_ENTITY_AGGREGATES)
  private List entityAggregates;

  public DescribeEntityAggregatesResponse() {
  }

  public DescribeEntityAggregatesResponse entityAggregates(List entityAggregates) {
    this.entityAggregates = entityAggregates;
    return this;
  }
  ...
  public List getEntityAggregates() {
    return entityAggregates;
  }

  public void setEntityAggregates(List entityAggregates) {
    this.entityAggregates = entityAggregates;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeEntityAggregatesResponse describeEntityAggregatesResponse = (DescribeEntityAggregatesResponse) o;
    return Objects.equals(this.entityAggregates, describeEntityAggregatesResponse.entityAggregates);
  }

  @Override
  public int hashCode() {
    return Objects.hash(entityAggregates);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeEntityAggregatesResponse {\n");
    sb.append("    entityAggregates: ").append(toIndentedString(entityAggregates)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("entityAggregates");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeEntityAggregatesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeEntityAggregatesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeEntityAggregatesResponse is not found in the empty JSON string", DescribeEntityAggregatesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeEntityAggregatesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeEntityAggregatesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `entityAggregates`
      if (jsonObj.get("entityAggregates") != null && !jsonObj.get("entityAggregates").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("entityAggregates"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeEntityAggregatesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeEntityAggregatesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeEntityAggregatesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeEntityAggregatesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeEntityAggregatesResponse>() {
           @Override
           public void write(JsonWriter out, DescribeEntityAggregatesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeEntityAggregatesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeEntityAggregatesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeEntityAggregatesResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeEntityAggregatesResponse
   */
  public static DescribeEntityAggregatesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeEntityAggregatesResponse.class);
  }

  /**
   * Convert an instance of DescribeEntityAggregatesResponse to an JSON string
   *
   * @return JSON string
   */
