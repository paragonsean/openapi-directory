 ...
 */
@JsonAdapter(EntityStatusCode.Adapter.class)
public enum EntityStatusCode {
  ...
  public static EntityStatusCode fromValue(String value) {
    for (EntityStatusCode b : EntityStatusCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<EntityStatusCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final EntityStatusCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EntityStatusCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EntityStatusCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EntityStatusCode.fromValue(value);
  }
}
