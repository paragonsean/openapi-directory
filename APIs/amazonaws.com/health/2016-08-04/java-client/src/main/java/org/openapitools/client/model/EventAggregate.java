...
public class EventAggregate {
  ...
  public EventAggregate aggregateValue(String aggregateValue) {
  ...
  public EventAggregate count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aggregateValue, eventAggregate.aggregateValue) &&
        Objects.equals(this.count, eventAggregate.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aggregateValue, count);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventAggregate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventAggregate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventAggregate is not found in the empty JSON string", EventAggregate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventAggregate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventAggregate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("aggregateValue") != null && !jsonObj.get("aggregateValue").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("aggregateValue"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventAggregate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventAggregate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventAggregate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventAggregate.class));

       return (TypeAdapter<T>) new TypeAdapter<EventAggregate>() {
           @Override
           public void write(JsonWriter out, EventAggregate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventAggregate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventAggregate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventAggregate
   * @throws IOException if the JSON string is invalid with respect to EventAggregate
   */
  public static EventAggregate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventAggregate.class);
  }

  /**
   * Convert an instance of EventAggregate to an JSON string
   *
   * @return JSON string
   */
