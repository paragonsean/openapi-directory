...
public class OrganizationEventDetailsErrorItem {
  ...
  public OrganizationEventDetailsErrorItem() {
  }

  public OrganizationEventDetailsErrorItem awsAccountId(String awsAccountId) {
  ...
  public OrganizationEventDetailsErrorItem eventArn(String eventArn) {
  ...
  public OrganizationEventDetailsErrorItem errorName(String errorName) {
  ...
  public OrganizationEventDetailsErrorItem errorMessage(String errorMessage) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationEventDetailsErrorItem organizationEventDetailsErrorItem = (OrganizationEventDetailsErrorItem) o;
    return Objects.equals(this.awsAccountId, organizationEventDetailsErrorItem.awsAccountId) &&
        Objects.equals(this.eventArn, organizationEventDetailsErrorItem.eventArn) &&
        Objects.equals(this.errorName, organizationEventDetailsErrorItem.errorName) &&
        Objects.equals(this.errorMessage, organizationEventDetailsErrorItem.errorMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationEventDetailsErrorItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationEventDetailsErrorItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationEventDetailsErrorItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationEventDetailsErrorItem is not found in the empty JSON string", OrganizationEventDetailsErrorItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationEventDetailsErrorItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationEventDetailsErrorItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationEventDetailsErrorItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationEventDetailsErrorItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationEventDetailsErrorItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationEventDetailsErrorItem.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationEventDetailsErrorItem>() {
           @Override
           public void write(JsonWriter out, OrganizationEventDetailsErrorItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationEventDetailsErrorItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationEventDetailsErrorItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationEventDetailsErrorItem
   * @throws IOException if the JSON string is invalid with respect to OrganizationEventDetailsErrorItem
   */
  public static OrganizationEventDetailsErrorItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationEventDetailsErrorItem.class);
  }

  /**
   * Convert an instance of OrganizationEventDetailsErrorItem to an JSON string
   *
   * @return JSON string
   */
