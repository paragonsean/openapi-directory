...
public class EventDetailsErrorItem {
  ...
  public EventDetailsErrorItem() {
  }

  public EventDetailsErrorItem eventArn(String eventArn) {
  ...
  public EventDetailsErrorItem errorName(String errorName) {
  ...
  public EventDetailsErrorItem errorMessage(String errorMessage) {
  ...
  public boolean equals(Object o) {
    ...
    EventDetailsErrorItem eventDetailsErrorItem = (EventDetailsErrorItem) o;
    return Objects.equals(this.eventArn, eventDetailsErrorItem.eventArn) &&
        Objects.equals(this.errorName, eventDetailsErrorItem.errorName) &&
        Objects.equals(this.errorMessage, eventDetailsErrorItem.errorMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventArn, errorName, errorMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EventDetailsErrorItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventDetailsErrorItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventDetailsErrorItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventDetailsErrorItem is not found in the empty JSON string", EventDetailsErrorItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventDetailsErrorItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventDetailsErrorItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventDetailsErrorItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventDetailsErrorItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventDetailsErrorItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventDetailsErrorItem.class));

       return (TypeAdapter<T>) new TypeAdapter<EventDetailsErrorItem>() {
           @Override
           public void write(JsonWriter out, EventDetailsErrorItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventDetailsErrorItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventDetailsErrorItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventDetailsErrorItem
   * @throws IOException if the JSON string is invalid with respect to EventDetailsErrorItem
   */
  public static EventDetailsErrorItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventDetailsErrorItem.class);
  }

  /**
   * Convert an instance of EventDetailsErrorItem to an JSON string
   *
   * @return JSON string
   */
