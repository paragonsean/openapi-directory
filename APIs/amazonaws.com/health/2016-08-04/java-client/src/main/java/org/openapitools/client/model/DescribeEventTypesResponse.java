...
public class DescribeEventTypesResponse {
  ...
  public DescribeEventTypesResponse() {
  }

  public DescribeEventTypesResponse eventTypes(List eventTypes) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeEventTypesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeEventTypesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeEventTypesResponse is not found in the empty JSON string", DescribeEventTypesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeEventTypesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeEventTypesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeEventTypesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeEventTypesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeEventTypesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeEventTypesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeEventTypesResponse>() {
           @Override
           public void write(JsonWriter out, DescribeEventTypesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeEventTypesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeEventTypesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeEventTypesResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeEventTypesResponse
   */
  public static DescribeEventTypesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeEventTypesResponse.class);
  }

  /**
   * Convert an instance of DescribeEventTypesResponse to an JSON string
   *
   * @return JSON string
   */
