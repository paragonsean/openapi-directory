...
public class DescribeEventsForOrganizationResponse {
  ...
  public DescribeEventsForOrganizationResponse() {
  }

  public DescribeEventsForOrganizationResponse events(List events) {
    this.events = events;
    return this;
  }
  ...
  public DescribeEventsForOrganizationResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeEventsForOrganizationResponse describeEventsForOrganizationResponse = (DescribeEventsForOrganizationResponse) o;
    return Objects.equals(this.events, describeEventsForOrganizationResponse.events) &&
        Objects.equals(this.nextToken, describeEventsForOrganizationResponse.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeEventsForOrganizationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeEventsForOrganizationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeEventsForOrganizationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeEventsForOrganizationResponse is not found in the empty JSON string", DescribeEventsForOrganizationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeEventsForOrganizationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeEventsForOrganizationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeEventsForOrganizationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeEventsForOrganizationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeEventsForOrganizationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeEventsForOrganizationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeEventsForOrganizationResponse>() {
           @Override
           public void write(JsonWriter out, DescribeEventsForOrganizationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeEventsForOrganizationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeEventsForOrganizationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeEventsForOrganizationResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeEventsForOrganizationResponse
   */
  public static DescribeEventsForOrganizationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeEventsForOrganizationResponse.class);
  }

  /**
   * Convert an instance of DescribeEventsForOrganizationResponse to an JSON string
   *
   * @return JSON string
   */
