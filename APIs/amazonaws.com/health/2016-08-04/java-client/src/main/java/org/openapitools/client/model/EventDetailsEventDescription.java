...
public class EventDetailsEventDescription {
  public static final String SERIALIZED_NAME_LATEST_DESCRIPTION = "latestDescription";
  @SerializedName(SERIALIZED_NAME_LATEST_DESCRIPTION)
  private String latestDescription;

  public EventDetailsEventDescription() {
  }

  public EventDetailsEventDescription latestDescription(String latestDescription) {
  ...
  public boolean equals(Object o) {
    ...
    EventDetailsEventDescription eventDetailsEventDescription = (EventDetailsEventDescription) o;
    return Objects.equals(this.latestDescription, eventDetailsEventDescription.latestDescription);
  }

  @Override
  public int hashCode() {
    return Objects.hash(latestDescription);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EventDetailsEventDescription {\n");
    sb.append("    latestDescription: ").append(toIndentedString(latestDescription)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("latestDescription");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventDetailsEventDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventDetailsEventDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventDetailsEventDescription is not found in the empty JSON string", EventDetailsEventDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventDetailsEventDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventDetailsEventDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `latestDescription`
      if (jsonObj.get("latestDescription") != null && !jsonObj.get("latestDescription").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("latestDescription"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventDetailsEventDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventDetailsEventDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventDetailsEventDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventDetailsEventDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<EventDetailsEventDescription>() {
           @Override
           public void write(JsonWriter out, EventDetailsEventDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventDetailsEventDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventDetailsEventDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventDetailsEventDescription
   * @throws IOException if the JSON string is invalid with respect to EventDetailsEventDescription
   */
  public static EventDetailsEventDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventDetailsEventDescription.class);
  }

  /**
   * Convert an instance of EventDetailsEventDescription to an JSON string
   *
   * @return JSON string
   */
