...
public class EntityAggregate {
  ...
  public EntityAggregate eventArn(String eventArn) {
  ...
  public EntityAggregate count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EntityAggregate entityAggregate = (EntityAggregate) o;
    return Objects.equals(this.eventArn, entityAggregate.eventArn) &&
        Objects.equals(this.count, entityAggregate.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventArn, count);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EntityAggregate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntityAggregate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntityAggregate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntityAggregate is not found in the empty JSON string", EntityAggregate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EntityAggregate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntityAggregate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntityAggregate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntityAggregate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntityAggregate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntityAggregate.class));

       return (TypeAdapter<T>) new TypeAdapter<EntityAggregate>() {
           @Override
           public void write(JsonWriter out, EntityAggregate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EntityAggregate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EntityAggregate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntityAggregate
   * @throws IOException if the JSON string is invalid with respect to EntityAggregate
   */
  public static EntityAggregate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntityAggregate.class);
  }

  /**
   * Convert an instance of EntityAggregate to an JSON string
   *
   * @return JSON string
   */
