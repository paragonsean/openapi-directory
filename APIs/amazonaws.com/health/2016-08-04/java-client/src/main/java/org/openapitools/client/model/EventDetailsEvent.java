...
public class EventDetailsEvent {
  ...
  public EventDetailsEvent() {
  }

  public EventDetailsEvent arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public EventDetailsEvent service(String service) {
  ...
  public EventDetailsEvent eventTypeCode(String eventTypeCode) {
  ...
  public EventDetailsEvent eventTypeCategory(EventTypeCategory eventTypeCategory) {
  ...
  public EventDetailsEvent region(String region) {
    this.region = region;
    return this;
  }
  ...
  public EventDetailsEvent availabilityZone(String availabilityZone) {
  ...
  public EventDetailsEvent startTime(OffsetDateTime startTime) {
  ...
  public EventDetailsEvent endTime(OffsetDateTime endTime) {
  ...
  public EventDetailsEvent lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public EventDetailsEvent statusCode(EventStatusCode statusCode) {
  ...
  public EventDetailsEvent eventScopeCode(EventScopeCode eventScopeCode) {
  ...
  public boolean equals(Object o) {
    ...
    EventDetailsEvent eventDetailsEvent = (EventDetailsEvent) o;
    return Objects.equals(this.arn, eventDetailsEvent.arn) &&
        Objects.equals(this.service, eventDetailsEvent.service) &&
        Objects.equals(this.eventTypeCode, eventDetailsEvent.eventTypeCode) &&
        Objects.equals(this.eventTypeCategory, eventDetailsEvent.eventTypeCategory) &&
        Objects.equals(this.region, eventDetailsEvent.region) &&
        Objects.equals(this.availabilityZone, eventDetailsEvent.availabilityZone) &&
        Objects.equals(this.startTime, eventDetailsEvent.startTime) &&
        Objects.equals(this.endTime, eventDetailsEvent.endTime) &&
        Objects.equals(this.lastUpdatedTime, eventDetailsEvent.lastUpdatedTime) &&
        Objects.equals(this.statusCode, eventDetailsEvent.statusCode) &&
        Objects.equals(this.eventScopeCode, eventDetailsEvent.eventScopeCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventDetailsEvent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventDetailsEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventDetailsEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventDetailsEvent is not found in the empty JSON string", EventDetailsEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventDetailsEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventDetailsEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventDetailsEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventDetailsEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventDetailsEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventDetailsEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<EventDetailsEvent>() {
           @Override
           public void write(JsonWriter out, EventDetailsEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventDetailsEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventDetailsEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventDetailsEvent
   * @throws IOException if the JSON string is invalid with respect to EventDetailsEvent
   */
  public static EventDetailsEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventDetailsEvent.class);
  }

  /**
   * Convert an instance of EventDetailsEvent to an JSON string
   *
   * @return JSON string
   */
