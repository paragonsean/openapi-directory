 ...
 */
@JsonAdapter(EventTypeCategory.Adapter.class)
public enum EventTypeCategory {
  ...
  EventTypeCategory(String value) {
    this.value = value;
  }
  ...
  public static EventTypeCategory fromValue(String value) {
    for (EventTypeCategory b : EventTypeCategory.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventTypeCategory> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventTypeCategory enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventTypeCategory read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventTypeCategory.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EventTypeCategory.fromValue(value);
  }
}
