...
public class ApiClient {
    ...
    private String basePath = "https://health.us-east-1.amazonaws.com";
    ...
    new ServerConfiguration(
      "http://health.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://health.{region}.amazonaws.com.cn",
      "The AWSHealth endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2016-08-04/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://health.us-east-1.amazonaws.com
