...
/**
 * Gets or Sets eventStatusCode
 */
@JsonAdapter(EventStatusCode.Adapter.class)
public enum EventStatusCode {
  ...
  public static EventStatusCode fromValue(String value) {
    for (EventStatusCode b : EventStatusCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventStatusCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventStatusCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventStatusCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventStatusCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EventStatusCode.fromValue(value);
  }
}
