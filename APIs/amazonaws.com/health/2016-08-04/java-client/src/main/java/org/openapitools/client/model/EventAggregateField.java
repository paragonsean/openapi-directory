...
/**
 * Gets or Sets eventAggregateField
 */
@JsonAdapter(EventAggregateField.Adapter.class)
public enum EventAggregateField {
  ...
  EventAggregateField(String value) {
    this.value = value;
  }
  ...
  public static EventAggregateField fromValue(String value) {
    for (EventAggregateField b : EventAggregateField.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventAggregateField> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventAggregateField enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventAggregateField read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventAggregateField.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EventAggregateField.fromValue(value);
  }
}
