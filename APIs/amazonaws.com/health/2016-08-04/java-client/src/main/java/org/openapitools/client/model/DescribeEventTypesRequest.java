...
import org.openapitools.client.model.DescribeEventTypesRequestFilter;
...
public class DescribeEventTypesRequest {
  ...
  private DescribeEventTypesRequestFilter filter;
  ...
  public DescribeEventTypesRequest filter(DescribeEventTypesRequestFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  public DescribeEventTypesRequestFilter getFilter() {
    return filter;
  }

  public void setFilter(DescribeEventTypesRequestFilter filter) {
    this.filter = filter;
  }


  public DescribeEventTypesRequest locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public DescribeEventTypesRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filter, describeEventTypesRequest.filter) &&
        Objects.equals(this.locale, describeEventTypesRequest.locale) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeEventTypesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeEventTypesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeEventTypesRequest is not found in the empty JSON string", DescribeEventTypesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeEventTypesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeEventTypesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filter`
      if (jsonObj.get("filter") != null && !jsonObj.get("filter").isJsonNull()) {
        DescribeEventTypesRequestFilter.validateJsonElement(jsonObj.get("filter"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeEventTypesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeEventTypesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeEventTypesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeEventTypesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeEventTypesRequest>() {
           @Override
           public void write(JsonWriter out, DescribeEventTypesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeEventTypesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeEventTypesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeEventTypesRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeEventTypesRequest
   */
  public static DescribeEventTypesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeEventTypesRequest.class);
  }

  /**
   * Convert an instance of DescribeEventTypesRequest to an JSON string
   *
   * @return JSON string
   */
