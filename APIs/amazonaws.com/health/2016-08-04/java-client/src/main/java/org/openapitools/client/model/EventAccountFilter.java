...
public class EventAccountFilter {
  ...
  public EventAccountFilter() {
  }

  public EventAccountFilter eventArn(String eventArn) {
  ...
  public EventAccountFilter awsAccountId(String awsAccountId) {
  ...
  public boolean equals(Object o) {
    ...
    EventAccountFilter eventAccountFilter = (EventAccountFilter) o;
    return Objects.equals(this.eventArn, eventAccountFilter.eventArn) &&
        Objects.equals(this.awsAccountId, eventAccountFilter.awsAccountId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventArn, awsAccountId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EventAccountFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventAccountFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventAccountFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventAccountFilter is not found in the empty JSON string", EventAccountFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventAccountFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventAccountFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventAccountFilter.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventAccountFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventAccountFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventAccountFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventAccountFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<EventAccountFilter>() {
           @Override
           public void write(JsonWriter out, EventAccountFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventAccountFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventAccountFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventAccountFilter
   * @throws IOException if the JSON string is invalid with respect to EventAccountFilter
   */
  public static EventAccountFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventAccountFilter.class);
  }

  /**
   * Convert an instance of EventAccountFilter to an JSON string
   *
   * @return JSON string
   */
