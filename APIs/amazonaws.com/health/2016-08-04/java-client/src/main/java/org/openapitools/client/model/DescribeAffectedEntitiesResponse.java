...
public class DescribeAffectedEntitiesResponse {
  ...
  public DescribeAffectedEntitiesResponse entities(List entities) {
  ...
  public DescribeAffectedEntitiesResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAffectedEntitiesResponse describeAffectedEntitiesResponse = (DescribeAffectedEntitiesResponse) o;
    return Objects.equals(this.entities, describeAffectedEntitiesResponse.entities) &&
        Objects.equals(this.nextToken, describeAffectedEntitiesResponse.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeAffectedEntitiesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAffectedEntitiesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAffectedEntitiesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAffectedEntitiesResponse is not found in the empty JSON string", DescribeAffectedEntitiesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAffectedEntitiesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAffectedEntitiesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAffectedEntitiesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAffectedEntitiesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAffectedEntitiesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAffectedEntitiesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAffectedEntitiesResponse>() {
           @Override
           public void write(JsonWriter out, DescribeAffectedEntitiesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAffectedEntitiesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAffectedEntitiesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAffectedEntitiesResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeAffectedEntitiesResponse
   */
  public static DescribeAffectedEntitiesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAffectedEntitiesResponse.class);
  }

  /**
   * Convert an instance of DescribeAffectedEntitiesResponse to an JSON string
   *
   * @return JSON string
   */
