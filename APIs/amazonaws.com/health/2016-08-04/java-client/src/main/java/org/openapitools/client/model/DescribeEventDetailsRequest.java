...
public class DescribeEventDetailsRequest {
  ...
  public DescribeEventDetailsRequest() {
  }

  public DescribeEventDetailsRequest eventArns(List eventArns) {
  ...
  public DescribeEventDetailsRequest locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeEventDetailsRequest describeEventDetailsRequest = (DescribeEventDetailsRequest) o;
    return Objects.equals(this.eventArns, describeEventDetailsRequest.eventArns) &&
        Objects.equals(this.locale, describeEventDetailsRequest.locale);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventArns, locale);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeEventDetailsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeEventDetailsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeEventDetailsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeEventDetailsRequest is not found in the empty JSON string", DescribeEventDetailsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeEventDetailsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeEventDetailsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeEventDetailsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeEventDetailsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeEventDetailsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeEventDetailsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeEventDetailsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeEventDetailsRequest>() {
           @Override
           public void write(JsonWriter out, DescribeEventDetailsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeEventDetailsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeEventDetailsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeEventDetailsRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeEventDetailsRequest
   */
  public static DescribeEventDetailsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeEventDetailsRequest.class);
  }

  /**
   * Convert an instance of DescribeEventDetailsRequest to an JSON string
   *
   * @return JSON string
   */
