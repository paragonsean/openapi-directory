...
public class OrganizationAffectedEntitiesErrorItem {
  ...
  public OrganizationAffectedEntitiesErrorItem awsAccountId(String awsAccountId) {
  ...
  public OrganizationAffectedEntitiesErrorItem eventArn(String eventArn) {
  ...
  public OrganizationAffectedEntitiesErrorItem errorName(String errorName) {
  ...
  public OrganizationAffectedEntitiesErrorItem errorMessage(String errorMessage) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationAffectedEntitiesErrorItem organizationAffectedEntitiesErrorItem = (OrganizationAffectedEntitiesErrorItem) o;
    return Objects.equals(this.awsAccountId, organizationAffectedEntitiesErrorItem.awsAccountId) &&
        Objects.equals(this.eventArn, organizationAffectedEntitiesErrorItem.eventArn) &&
        Objects.equals(this.errorName, organizationAffectedEntitiesErrorItem.errorName) &&
        Objects.equals(this.errorMessage, organizationAffectedEntitiesErrorItem.errorMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(awsAccountId, eventArn, errorName, errorMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrganizationAffectedEntitiesErrorItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationAffectedEntitiesErrorItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationAffectedEntitiesErrorItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationAffectedEntitiesErrorItem is not found in the empty JSON string", OrganizationAffectedEntitiesErrorItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationAffectedEntitiesErrorItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationAffectedEntitiesErrorItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationAffectedEntitiesErrorItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationAffectedEntitiesErrorItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationAffectedEntitiesErrorItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationAffectedEntitiesErrorItem.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationAffectedEntitiesErrorItem>() {
           @Override
           public void write(JsonWriter out, OrganizationAffectedEntitiesErrorItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationAffectedEntitiesErrorItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationAffectedEntitiesErrorItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationAffectedEntitiesErrorItem
   * @throws IOException if the JSON string is invalid with respect to OrganizationAffectedEntitiesErrorItem
   */
  public static OrganizationAffectedEntitiesErrorItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationAffectedEntitiesErrorItem.class);
  }

  /**
   * Convert an instance of OrganizationAffectedEntitiesErrorItem to an JSON string
   *
   * @return JSON string
   */
