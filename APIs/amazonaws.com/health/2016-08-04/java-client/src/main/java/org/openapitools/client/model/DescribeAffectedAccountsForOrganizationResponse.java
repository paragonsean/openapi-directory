...
public class DescribeAffectedAccountsForOrganizationResponse {
  public static final String SERIALIZED_NAME_AFFECTED_ACCOUNTS = "affectedAccounts";
  @SerializedName(SERIALIZED_NAME_AFFECTED_ACCOUNTS)
  private List affectedAccounts;
  ...
  public DescribeAffectedAccountsForOrganizationResponse affectedAccounts(List affectedAccounts) {
  ...
  public List getAffectedAccounts() {
    return affectedAccounts;
  }

  public void setAffectedAccounts(List affectedAccounts) {
    this.affectedAccounts = affectedAccounts;
  }


  public DescribeAffectedAccountsForOrganizationResponse eventScopeCode(EventScopeCode eventScopeCode) {
  ...
  public DescribeAffectedAccountsForOrganizationResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAffectedAccountsForOrganizationResponse describeAffectedAccountsForOrganizationResponse = (DescribeAffectedAccountsForOrganizationResponse) o;
    return Objects.equals(this.affectedAccounts, describeAffectedAccountsForOrganizationResponse.affectedAccounts) &&
        Objects.equals(this.eventScopeCode, describeAffectedAccountsForOrganizationResponse.eventScopeCode) &&
        Objects.equals(this.nextToken, describeAffectedAccountsForOrganizationResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(affectedAccounts, eventScopeCode, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeAffectedAccountsForOrganizationResponse {\n");
    sb.append("    affectedAccounts: ").append(toIndentedString(affectedAccounts)).append("\n");
  ...
  static {
    ...
    openapiFields.add("affectedAccounts");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAffectedAccountsForOrganizationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAffectedAccountsForOrganizationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAffectedAccountsForOrganizationResponse is not found in the empty JSON string", DescribeAffectedAccountsForOrganizationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAffectedAccountsForOrganizationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAffectedAccountsForOrganizationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `affectedAccounts`
      if (jsonObj.get("affectedAccounts") != null && !jsonObj.get("affectedAccounts").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("affectedAccounts"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAffectedAccountsForOrganizationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAffectedAccountsForOrganizationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAffectedAccountsForOrganizationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAffectedAccountsForOrganizationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAffectedAccountsForOrganizationResponse>() {
           @Override
           public void write(JsonWriter out, DescribeAffectedAccountsForOrganizationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAffectedAccountsForOrganizationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAffectedAccountsForOrganizationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAffectedAccountsForOrganizationResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeAffectedAccountsForOrganizationResponse
   */
  public static DescribeAffectedAccountsForOrganizationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAffectedAccountsForOrganizationResponse.class);
  }

  /**
   * Convert an instance of DescribeAffectedAccountsForOrganizationResponse to an JSON string
   *
   * @return JSON string
   */
