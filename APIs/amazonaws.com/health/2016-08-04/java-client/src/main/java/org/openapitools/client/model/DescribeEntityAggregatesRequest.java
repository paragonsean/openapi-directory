...
public class DescribeEntityAggregatesRequest {
  ...
  public DescribeEntityAggregatesRequest() {
  }

  public DescribeEntityAggregatesRequest eventArns(List eventArns) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeEntityAggregatesRequest describeEntityAggregatesRequest = (DescribeEntityAggregatesRequest) o;
    return Objects.equals(this.eventArns, describeEntityAggregatesRequest.eventArns);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventArns);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeEntityAggregatesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeEntityAggregatesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeEntityAggregatesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeEntityAggregatesRequest is not found in the empty JSON string", DescribeEntityAggregatesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeEntityAggregatesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeEntityAggregatesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeEntityAggregatesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeEntityAggregatesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeEntityAggregatesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeEntityAggregatesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeEntityAggregatesRequest>() {
           @Override
           public void write(JsonWriter out, DescribeEntityAggregatesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeEntityAggregatesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeEntityAggregatesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeEntityAggregatesRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeEntityAggregatesRequest
   */
  public static DescribeEntityAggregatesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeEntityAggregatesRequest.class);
  }

  /**
   * Convert an instance of DescribeEntityAggregatesRequest to an JSON string
   *
   * @return JSON string
   */
