...
/**
 * Gets or Sets eventScopeCode
 */
@JsonAdapter(EventScopeCode.Adapter.class)
public enum EventScopeCode {
  ...
  public static EventScopeCode fromValue(String value) {
    for (EventScopeCode b : EventScopeCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventScopeCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventScopeCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventScopeCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventScopeCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EventScopeCode.fromValue(value);
  }
}
