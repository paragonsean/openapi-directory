...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.EventDetails();
  });
  ...
  describe('EventDetails', function() {
    it('should create an instance of EventDetails', function() {
      // uncomment below and update the code to test EventDetails
      //var instance = new AwsHealthApisAndNotifications.EventDetails();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EventDetails);
    });
