...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventsResponse();
  });
  ...
  describe('DescribeEventsResponse', function() {
    it('should create an instance of DescribeEventsResponse', function() {
      ...
      //var instance = new AwsHealthApisAndNotifications.DescribeEventsResponse();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventsResponse);
    });
