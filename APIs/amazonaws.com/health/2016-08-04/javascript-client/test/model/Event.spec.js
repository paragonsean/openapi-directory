...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.Event();
  });
  ...
  describe('Event', function() {
    it('should create an instance of Event', function() {
      ...
      //var instance = new AwsHealthApisAndNotifications.Event();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.Event);
    });
