...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventDetailsResponse();
  });
  ...
  describe('DescribeEventDetailsResponse', function() {
    it('should create an instance of DescribeEventDetailsResponse', function() {
      // uncomment below and update the code to test DescribeEventDetailsResponse
      //var instance = new AwsHealthApisAndNotifications.DescribeEventDetailsResponse();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventDetailsResponse);
    });

    it('should have the property successfulSet (base name: "successfulSet")', function() {
      // uncomment below and update the code to test the property successfulSet
      //var instance = new AwsHealthApisAndNotifications.DescribeEventDetailsResponse();
      //expect(instance).to.be();
    });

    it('should have the property failedSet (base name: "failedSet")', function() {
      // uncomment below and update the code to test the property failedSet
      //var instance = new AwsHealthApisAndNotifications.DescribeEventDetailsResponse();
      //expect(instance).to.be();
    });
