...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesResponse();
  });
  ...
  describe('DescribeAffectedEntitiesResponse', function() {
    it('should create an instance of DescribeAffectedEntitiesResponse', function() {
      // uncomment below and update the code to test DescribeAffectedEntitiesResponse
      //var instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesResponse();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeAffectedEntitiesResponse);
    });
