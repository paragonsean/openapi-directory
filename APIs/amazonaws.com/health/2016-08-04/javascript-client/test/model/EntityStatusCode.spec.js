...
(function(root, factory) {
  ...
  describe('EntityStatusCode', function() {
    it('should create an instance of EntityStatusCode', function() {
      // uncomment below and update the code to test EntityStatusCode
      //var instance = new AwsHealthApisAndNotifications.EntityStatusCode();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EntityStatusCode);
    });
