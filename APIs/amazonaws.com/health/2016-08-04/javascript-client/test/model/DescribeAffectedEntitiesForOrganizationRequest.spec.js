...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesForOrganizationRequest();
  });
  ...
  describe('DescribeAffectedEntitiesForOrganizationRequest', function() {
    it('should create an instance of DescribeAffectedEntitiesForOrganizationRequest', function() {
      // uncomment below and update the code to test DescribeAffectedEntitiesForOrganizationRequest
      //var instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesForOrganizationRequest();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeAffectedEntitiesForOrganizationRequest);
    });

    it('should have the property organizationEntityFilters (base name: "organizationEntityFilters")', function() {
      // uncomment below and update the code to test the property organizationEntityFilters
      //var instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesForOrganizationRequest();
