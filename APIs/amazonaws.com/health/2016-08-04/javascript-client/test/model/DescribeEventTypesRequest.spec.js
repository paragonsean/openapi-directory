...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventTypesRequest();
  });
  ...
  describe('DescribeEventTypesRequest', function() {
    it('should create an instance of DescribeEventTypesRequest', function() {
      // uncomment below and update the code to test DescribeEventTypesRequest
      //var instance = new AwsHealthApisAndNotifications.DescribeEventTypesRequest();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventTypesRequest);
    });
