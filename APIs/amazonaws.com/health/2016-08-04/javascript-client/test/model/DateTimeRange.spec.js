...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DateTimeRange();
  });
  ...
  describe('DateTimeRange', function() {
    it('should create an instance of DateTimeRange', function() {
      ...
      //var instance = new AwsHealthApisAndNotifications.DateTimeRange();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DateTimeRange);
    });
