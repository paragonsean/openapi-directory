...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.EventDetailsEvent();
  });
  ...
  describe('EventDetailsEvent', function() {
    it('should create an instance of EventDetailsEvent', function() {
      // uncomment below and update the code to test EventDetailsEvent
      //var instance = new AwsHealthApisAndNotifications.EventDetailsEvent();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EventDetailsEvent);
    });
