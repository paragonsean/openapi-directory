...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventsForOrganizationRequestFilter();
  });
  ...
  describe('DescribeEventsForOrganizationRequestFilter', function() {
    it('should create an instance of DescribeEventsForOrganizationRequestFilter', function() {
      // uncomment below and update the code to test DescribeEventsForOrganizationRequestFilter
      //var instance = new AwsHealthApisAndNotifications.DescribeEventsForOrganizationRequestFilter();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventsForOrganizationRequestFilter);
    });
