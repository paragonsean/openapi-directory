...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventsForOrganizationRequest();
  });
  ...
  describe('DescribeEventsForOrganizationRequest', function() {
    it('should create an instance of DescribeEventsForOrganizationRequest', function() {
      // uncomment below and update the code to test DescribeEventsForOrganizationRequest
      //var instance = new AwsHealthApisAndNotifications.DescribeEventsForOrganizationRequest();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventsForOrganizationRequest);
    });
