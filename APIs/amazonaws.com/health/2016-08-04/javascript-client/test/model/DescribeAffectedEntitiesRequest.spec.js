...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesRequest();
  });
  ...
  describe('DescribeAffectedEntitiesRequest', function() {
    it('should create an instance of DescribeAffectedEntitiesRequest', function() {
      // uncomment below and update the code to test DescribeAffectedEntitiesRequest
      //var instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesRequest();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeAffectedEntitiesRequest);
    });
