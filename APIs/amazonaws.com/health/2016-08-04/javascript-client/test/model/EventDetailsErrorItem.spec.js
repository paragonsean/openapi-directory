...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.EventDetailsErrorItem();
  });
  ...
  describe('EventDetailsErrorItem', function() {
    it('should create an instance of EventDetailsErrorItem', function() {
      // uncomment below and update the code to test EventDetailsErrorItem
      //var instance = new AwsHealthApisAndNotifications.EventDetailsErrorItem();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EventDetailsErrorItem);
    });
