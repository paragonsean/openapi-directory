...
(function(root, factory) {
  ...
  describe('EventScopeCode', function() {
    it('should create an instance of EventScopeCode', function() {
      // uncomment below and update the code to test EventScopeCode
      //var instance = new AwsHealthApisAndNotifications.EventScopeCode();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EventScopeCode);
    });
