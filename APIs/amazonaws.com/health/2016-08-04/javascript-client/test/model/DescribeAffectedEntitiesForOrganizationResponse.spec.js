...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesForOrganizationResponse();
  });
  ...
  describe('DescribeAffectedEntitiesForOrganizationResponse', function() {
    it('should create an instance of DescribeAffectedEntitiesForOrganizationResponse', function() {
      // uncomment below and update the code to test DescribeAffectedEntitiesForOrganizationResponse
      //var instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesForOrganizationResponse();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeAffectedEntitiesForOrganizationResponse);
    });
