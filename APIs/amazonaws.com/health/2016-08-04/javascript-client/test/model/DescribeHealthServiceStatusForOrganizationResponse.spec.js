...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeHealthServiceStatusForOrganizationResponse();
  });
  ...
  describe('DescribeHealthServiceStatusForOrganizationResponse', function() {
    it('should create an instance of DescribeHealthServiceStatusForOrganizationResponse', function() {
      // uncomment below and update the code to test DescribeHealthServiceStatusForOrganizationResponse
      //var instance = new AwsHealthApisAndNotifications.DescribeHealthServiceStatusForOrganizationResponse();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeHealthServiceStatusForOrganizationResponse);
    });

    it('should have the property healthServiceAccessStatusForOrganization (base name: "healthServiceAccessStatusForOrganization")', function() {
      // uncomment below and update the code to test the property healthServiceAccessStatusForOrganization
      //var instance = new AwsHealthApisAndNotifications.DescribeHealthServiceStatusForOrganizationResponse();
