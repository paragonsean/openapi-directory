...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.EventDescription();
  });
  ...
  describe('EventDescription', function() {
    it('should create an instance of EventDescription', function() {
      // uncomment below and update the code to test EventDescription
      //var instance = new AwsHealthApisAndNotifications.EventDescription();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EventDescription);
    });

    it('should have the property latestDescription (base name: "latestDescription")', function() {
      // uncomment below and update the code to test the property latestDescription
      //var instance = new AwsHealthApisAndNotifications.EventDescription();
