...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.EventDetailsEventDescription();
  });
  ...
  describe('EventDetailsEventDescription', function() {
    it('should create an instance of EventDetailsEventDescription', function() {
      // uncomment below and update the code to test EventDetailsEventDescription
      //var instance = new AwsHealthApisAndNotifications.EventDetailsEventDescription();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EventDetailsEventDescription);
    });
