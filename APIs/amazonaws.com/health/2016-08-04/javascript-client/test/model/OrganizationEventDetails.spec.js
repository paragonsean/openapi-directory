...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.OrganizationEventDetails();
  });
  ...
  describe('OrganizationEventDetails', function() {
    it('should create an instance of OrganizationEventDetails', function() {
      // uncomment below and update the code to test OrganizationEventDetails
      //var instance = new AwsHealthApisAndNotifications.OrganizationEventDetails();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.OrganizationEventDetails);
    });
