...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventDetailsForOrganizationResponse();
  });
  ...
  describe('DescribeEventDetailsForOrganizationResponse', function() {
    it('should create an instance of DescribeEventDetailsForOrganizationResponse', function() {
      // uncomment below and update the code to test DescribeEventDetailsForOrganizationResponse
      //var instance = new AwsHealthApisAndNotifications.DescribeEventDetailsForOrganizationResponse();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventDetailsForOrganizationResponse);
    });
