...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.EventAccountFilter();
  });
  ...
  describe('EventAccountFilter', function() {
    it('should create an instance of EventAccountFilter', function() {
      // uncomment below and update the code to test EventAccountFilter
      //var instance = new AwsHealthApisAndNotifications.EventAccountFilter();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EventAccountFilter);
    });
