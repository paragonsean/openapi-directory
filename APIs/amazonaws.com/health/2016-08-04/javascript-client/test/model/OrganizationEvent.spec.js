...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.OrganizationEvent();
  });
  ...
  describe('OrganizationEvent', function() {
    it('should create an instance of OrganizationEvent', function() {
      // uncomment below and update the code to test OrganizationEvent
      //var instance = new AwsHealthApisAndNotifications.OrganizationEvent();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.OrganizationEvent);
    });
    ...
    it('should have the property eventTypeCode (base name: "eventTypeCode")', function() {
      // uncomment below and update the code to test the property eventTypeCode
      //var instance = new AwsHealthApisAndNotifications.OrganizationEvent();
      //expect(instance).to.be();
    });

    it('should have the property eventTypeCategory (base name: "eventTypeCategory")', function() {
      // uncomment below and update the code to test the property eventTypeCategory
      //var instance = new AwsHealthApisAndNotifications.OrganizationEvent();
      //expect(instance).to.be();
    });

    it('should have the property eventScopeCode (base name: "eventScopeCode")', function() {
      // uncomment below and update the code to test the property eventScopeCode
      //var instance = new AwsHealthApisAndNotifications.OrganizationEvent();
      //expect(instance).to.be();
    });
