...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventTypesResponse();
  });
  ...
  describe('DescribeEventTypesResponse', function() {
    it('should create an instance of DescribeEventTypesResponse', function() {
      // uncomment below and update the code to test DescribeEventTypesResponse
      //var instance = new AwsHealthApisAndNotifications.DescribeEventTypesResponse();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventTypesResponse);
    });
