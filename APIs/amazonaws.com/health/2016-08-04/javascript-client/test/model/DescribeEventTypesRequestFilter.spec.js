...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventTypesRequestFilter();
  });
  ...
  describe('DescribeEventTypesRequestFilter', function() {
    it('should create an instance of DescribeEventTypesRequestFilter', function() {
      // uncomment below and update the code to test DescribeEventTypesRequestFilter
      //var instance = new AwsHealthApisAndNotifications.DescribeEventTypesRequestFilter();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventTypesRequestFilter);
    });
