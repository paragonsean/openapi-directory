...
(function(root, factory) {
  ...
  describe('EventStatusCode', function() {
    it('should create an instance of EventStatusCode', function() {
      // uncomment below and update the code to test EventStatusCode
      //var instance = new AwsHealthApisAndNotifications.EventStatusCode();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EventStatusCode);
    });
