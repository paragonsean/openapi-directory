...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventDetailsForOrganizationRequest();
  });
  ...
  describe('DescribeEventDetailsForOrganizationRequest', function() {
    it('should create an instance of DescribeEventDetailsForOrganizationRequest', function() {
      // uncomment below and update the code to test DescribeEventDetailsForOrganizationRequest
      //var instance = new AwsHealthApisAndNotifications.DescribeEventDetailsForOrganizationRequest();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventDetailsForOrganizationRequest);
    });

    it('should have the property organizationEventDetailFilters (base name: "organizationEventDetailFilters")', function() {
      // uncomment below and update the code to test the property organizationEventDetailFilters
      //var instance = new AwsHealthApisAndNotifications.DescribeEventDetailsForOrganizationRequest();
