...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.OrganizationEventDetailsErrorItem();
  });
  ...
  describe('OrganizationEventDetailsErrorItem', function() {
    it('should create an instance of OrganizationEventDetailsErrorItem', function() {
      // uncomment below and update the code to test OrganizationEventDetailsErrorItem
      //var instance = new AwsHealthApisAndNotifications.OrganizationEventDetailsErrorItem();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.OrganizationEventDetailsErrorItem);
    });
