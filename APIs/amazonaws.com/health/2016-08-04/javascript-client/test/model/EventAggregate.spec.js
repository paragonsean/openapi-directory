...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.EventAggregate();
  });
  ...
  describe('EventAggregate', function() {
    it('should create an instance of EventAggregate', function() {
      // uncomment below and update the code to test EventAggregate
      //var instance = new AwsHealthApisAndNotifications.EventAggregate();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EventAggregate);
    });
