...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventsRequest();
  });
  ...
  describe('DescribeEventsRequest', function() {
    it('should create an instance of DescribeEventsRequest', function() {
      ...
      //var instance = new AwsHealthApisAndNotifications.DescribeEventsRequest();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventsRequest);
    });
