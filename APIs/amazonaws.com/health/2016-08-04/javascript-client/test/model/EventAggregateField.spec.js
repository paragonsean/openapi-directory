...
(function(root, factory) {
  ...
  describe('EventAggregateField', function() {
    it('should create an instance of EventAggregateField', function() {
      // uncomment below and update the code to test EventAggregateField
      //var instance = new AwsHealthApisAndNotifications.EventAggregateField();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EventAggregateField);
    });
