...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeAffectedAccountsForOrganizationResponse();
  });
  ...
  describe('DescribeAffectedAccountsForOrganizationResponse', function() {
    it('should create an instance of DescribeAffectedAccountsForOrganizationResponse', function() {
      // uncomment below and update the code to test DescribeAffectedAccountsForOrganizationResponse
      //var instance = new AwsHealthApisAndNotifications.DescribeAffectedAccountsForOrganizationResponse();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeAffectedAccountsForOrganizationResponse);
    });

    it('should have the property affectedAccounts (base name: "affectedAccounts")', function() {
      // uncomment below and update the code to test the property affectedAccounts
      //var instance = new AwsHealthApisAndNotifications.DescribeAffectedAccountsForOrganizationResponse();
