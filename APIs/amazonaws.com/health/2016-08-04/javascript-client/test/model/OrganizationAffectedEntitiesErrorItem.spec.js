...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.OrganizationAffectedEntitiesErrorItem();
  });
  ...
  describe('OrganizationAffectedEntitiesErrorItem', function() {
    it('should create an instance of OrganizationAffectedEntitiesErrorItem', function() {
      // uncomment below and update the code to test OrganizationAffectedEntitiesErrorItem
      //var instance = new AwsHealthApisAndNotifications.OrganizationAffectedEntitiesErrorItem();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.OrganizationAffectedEntitiesErrorItem);
    });
