...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventAggregatesResponse();
  });
  ...
  describe('DescribeEventAggregatesResponse', function() {
    it('should create an instance of DescribeEventAggregatesResponse', function() {
      // uncomment below and update the code to test DescribeEventAggregatesResponse
      //var instance = new AwsHealthApisAndNotifications.DescribeEventAggregatesResponse();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventAggregatesResponse);
    });

    it('should have the property eventAggregates (base name: "eventAggregates")', function() {
      // uncomment below and update the code to test the property eventAggregates
      //var instance = new AwsHealthApisAndNotifications.DescribeEventAggregatesResponse();
