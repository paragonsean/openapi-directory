...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeAffectedAccountsForOrganizationRequest();
  });
  ...
  describe('DescribeAffectedAccountsForOrganizationRequest', function() {
    it('should create an instance of DescribeAffectedAccountsForOrganizationRequest', function() {
      // uncomment below and update the code to test DescribeAffectedAccountsForOrganizationRequest
      //var instance = new AwsHealthApisAndNotifications.DescribeAffectedAccountsForOrganizationRequest();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeAffectedAccountsForOrganizationRequest);
    });
