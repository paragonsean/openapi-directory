...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventAggregatesRequest();
  });
  ...
  describe('DescribeEventAggregatesRequest', function() {
    it('should create an instance of DescribeEventAggregatesRequest', function() {
      // uncomment below and update the code to test DescribeEventAggregatesRequest
      //var instance = new AwsHealthApisAndNotifications.DescribeEventAggregatesRequest();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventAggregatesRequest);
    });
    ...
    it('should have the property aggregateField (base name: "aggregateField")', function() {
      // uncomment below and update the code to test the property aggregateField
      //var instance = new AwsHealthApisAndNotifications.DescribeEventAggregatesRequest();
      //expect(instance).to.be();
    });
