...
(function(root, factory) {
  ...
  describe('EventTypeCategory', function() {
    it('should create an instance of EventTypeCategory', function() {
      // uncomment below and update the code to test EventTypeCategory
      //var instance = new AwsHealthApisAndNotifications.EventTypeCategory();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EventTypeCategory);
    });
