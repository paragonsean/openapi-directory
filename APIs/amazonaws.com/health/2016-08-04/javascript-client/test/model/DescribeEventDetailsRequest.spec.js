...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventDetailsRequest();
  });
  ...
  describe('DescribeEventDetailsRequest', function() {
    it('should create an instance of DescribeEventDetailsRequest', function() {
      // uncomment below and update the code to test DescribeEventDetailsRequest
      //var instance = new AwsHealthApisAndNotifications.DescribeEventDetailsRequest();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventDetailsRequest);
    });
