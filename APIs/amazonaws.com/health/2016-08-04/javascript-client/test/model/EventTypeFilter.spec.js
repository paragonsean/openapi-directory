...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.EventTypeFilter();
  });
  ...
  describe('EventTypeFilter', function() {
    it('should create an instance of EventTypeFilter', function() {
      // uncomment below and update the code to test EventTypeFilter
      //var instance = new AwsHealthApisAndNotifications.EventTypeFilter();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.EventTypeFilter);
    });
