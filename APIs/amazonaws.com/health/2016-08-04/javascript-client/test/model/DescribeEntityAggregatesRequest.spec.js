...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEntityAggregatesRequest();
  });
  ...
  describe('DescribeEntityAggregatesRequest', function() {
    it('should create an instance of DescribeEntityAggregatesRequest', function() {
      // uncomment below and update the code to test DescribeEntityAggregatesRequest
      //var instance = new AwsHealthApisAndNotifications.DescribeEntityAggregatesRequest();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEntityAggregatesRequest);
    });
