...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesRequestFilter();
  });
  ...
  describe('DescribeAffectedEntitiesRequestFilter', function() {
    it('should create an instance of DescribeAffectedEntitiesRequestFilter', function() {
      // uncomment below and update the code to test DescribeAffectedEntitiesRequestFilter
      //var instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesRequestFilter();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeAffectedEntitiesRequestFilter);
    });

    it('should have the property eventArns (base name: "eventArns")', function() {
      // uncomment below and update the code to test the property eventArns
      //var instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesRequestFilter();
    ...
    it('should have the property lastUpdatedTimes (base name: "lastUpdatedTimes")', function() {
      // uncomment below and update the code to test the property lastUpdatedTimes
      //var instance = new AwsHealthApisAndNotifications.DescribeAffectedEntitiesRequestFilter();
      //expect(instance).to.be();
    });
