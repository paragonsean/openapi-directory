...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEventsForOrganizationResponse();
  });
  ...
  describe('DescribeEventsForOrganizationResponse', function() {
    it('should create an instance of DescribeEventsForOrganizationResponse', function() {
      // uncomment below and update the code to test DescribeEventsForOrganizationResponse
      //var instance = new AwsHealthApisAndNotifications.DescribeEventsForOrganizationResponse();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEventsForOrganizationResponse);
    });
