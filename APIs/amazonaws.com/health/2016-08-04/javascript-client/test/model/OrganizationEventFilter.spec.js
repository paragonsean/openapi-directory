...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.OrganizationEventFilter();
  });
  ...
  describe('OrganizationEventFilter', function() {
    it('should create an instance of OrganizationEventFilter', function() {
      // uncomment below and update the code to test OrganizationEventFilter
      //var instance = new AwsHealthApisAndNotifications.OrganizationEventFilter();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.OrganizationEventFilter);
    });

    it('should have the property eventTypeCodes (base name: "eventTypeCodes")', function() {
      // uncomment below and update the code to test the property eventTypeCodes
      //var instance = new AwsHealthApisAndNotifications.OrganizationEventFilter();
    ...
    it('should have the property entityArns (base name: "entityArns")', function() {
      // uncomment below and update the code to test the property entityArns
      //var instance = new AwsHealthApisAndNotifications.OrganizationEventFilter();
      //expect(instance).to.be();
    });
    ...
    it('should have the property eventTypeCategories (base name: "eventTypeCategories")', function() {
      // uncomment below and update the code to test the property eventTypeCategories
      //var instance = new AwsHealthApisAndNotifications.OrganizationEventFilter();
      //expect(instance).to.be();
    });

    it('should have the property eventStatusCodes (base name: "eventStatusCodes")', function() {
      // uncomment below and update the code to test the property eventStatusCodes
      //var instance = new AwsHealthApisAndNotifications.OrganizationEventFilter();
      //expect(instance).to.be();
    });
