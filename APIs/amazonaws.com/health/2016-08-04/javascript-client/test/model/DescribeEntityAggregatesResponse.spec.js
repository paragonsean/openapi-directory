...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.DescribeEntityAggregatesResponse();
  });
  ...
  describe('DescribeEntityAggregatesResponse', function() {
    it('should create an instance of DescribeEntityAggregatesResponse', function() {
      // uncomment below and update the code to test DescribeEntityAggregatesResponse
      //var instance = new AwsHealthApisAndNotifications.DescribeEntityAggregatesResponse();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.DescribeEntityAggregatesResponse);
    });

    it('should have the property entityAggregates (base name: "entityAggregates")', function() {
      // uncomment below and update the code to test the property entityAggregates
      //var instance = new AwsHealthApisAndNotifications.DescribeEntityAggregatesResponse();
