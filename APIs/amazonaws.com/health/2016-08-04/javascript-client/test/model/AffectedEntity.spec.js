...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthApisAndNotifications.AffectedEntity();
  });
  ...
  describe('AffectedEntity', function() {
    it('should create an instance of AffectedEntity', function() {
      // uncomment below and update the code to test AffectedEntity
      //var instance = new AwsHealthApisAndNotifications.AffectedEntity();
      //expect(instance).to.be.a(AwsHealthApisAndNotifications.AffectedEntity);
    });
