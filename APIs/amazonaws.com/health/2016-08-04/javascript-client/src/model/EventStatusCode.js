...
* @readonly
*/
export default class EventStatusCode {
    ...
    /**
    * Returns a <code>EventStatusCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EventStatusCode} The enum <code>EventStatusCode</code> value.
    */
