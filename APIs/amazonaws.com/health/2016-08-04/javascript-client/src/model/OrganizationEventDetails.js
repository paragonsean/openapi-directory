...
/**
 * The OrganizationEventDetails model module.
 * @module model/OrganizationEventDetails
 * @version 2016-08-04
 */
class OrganizationEventDetails {
    /**
     * Constructs a new <code>OrganizationEventDetails</code>.
     ...
     * @alias module:model/OrganizationEventDetails
     */
    constructor() { 
        
        OrganizationEventDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationEventDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationEventDetails} obj Optional instance to populate.
     * @return {module:model/OrganizationEventDetails} The populated <code>OrganizationEventDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationEventDetails();
            ...
            if (data.hasOwnProperty('eventDescription')) {
                obj['eventDescription'] = EventDescription.constructFromObject(data['eventDescription']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationEventDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationEventDetails</code>.
     */
    static validateJSON(data) {
        ...
        if (data['eventDescription']) { // data not null
          EventDescription.validateJSON(data['eventDescription']);
        }
 ...
 */
OrganizationEventDetails.prototype['awsAccountId'] = undefined;

/**
 * @member {module:model/Event} event
 */
OrganizationEventDetails.prototype['event'] = undefined;

/**
 * @member {module:model/EventDescription} eventDescription
 */
OrganizationEventDetails.prototype['eventDescription'] = undefined;

/**
 * @member {Object} eventMetadata
 */
OrganizationEventDetails.prototype['eventMetadata'] = undefined;
