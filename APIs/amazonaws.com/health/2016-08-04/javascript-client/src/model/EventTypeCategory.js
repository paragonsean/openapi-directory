...
* @readonly
*/
export default class EventTypeCategory {
    ...
    /**
    * Returns a <code>EventTypeCategory</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EventTypeCategory} The enum <code>EventTypeCategory</code> value.
    */
