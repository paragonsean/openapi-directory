...
import EventDetailsEvent from './EventDetailsEvent';
import EventDetailsEventDescription from './EventDetailsEventDescription';
...
class EventDetails {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('event')) {
                obj['event'] = EventDetailsEvent.constructFromObject(data['event']);
            }
            if (data.hasOwnProperty('eventDescription')) {
                obj['eventDescription'] = EventDetailsEventDescription.constructFromObject(data['eventDescription']);
            }
            if (data.hasOwnProperty('eventMetadata')) {
                obj['eventMetadata'] = ApiClient.convertToType(data['eventMetadata'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EventDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventDetails</code>.
     */
    static validateJSON(data) {
        // validate the optional field `event`
        if (data['event']) { // data not null
          EventDetailsEvent.validateJSON(data['event']);
        }
        // validate the optional field `eventDescription`
        if (data['eventDescription']) { // data not null
          EventDetailsEventDescription.validateJSON(data['eventDescription']);
        }
        // validate the optional field `eventMetadata`
        if (data['eventMetadata']) { // data not null
          Object.validateJSON(data['eventMetadata']);
        }
...
/**
 * @member {module:model/EventDetailsEvent} event
 */
EventDetails.prototype['event'] = undefined;

/**
 * @member {module:model/EventDetailsEventDescription} eventDescription
 */
EventDetails.prototype['eventDescription'] = undefined;

/**
 * @member {Object} eventMetadata
 */
EventDetails.prototype['eventMetadata'] = undefined;
