...
/**
 * The DescribeHealthServiceStatusForOrganizationResponse model module.
 * @module model/DescribeHealthServiceStatusForOrganizationResponse
 * @version 2016-08-04
 */
class DescribeHealthServiceStatusForOrganizationResponse {
    /**
     * Constructs a new <code>DescribeHealthServiceStatusForOrganizationResponse</code>.
     * @alias module:model/DescribeHealthServiceStatusForOrganizationResponse
     */
    constructor() { 
        
        DescribeHealthServiceStatusForOrganizationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeHealthServiceStatusForOrganizationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeHealthServiceStatusForOrganizationResponse} obj Optional instance to populate.
     * @return {module:model/DescribeHealthServiceStatusForOrganizationResponse} The populated <code>DescribeHealthServiceStatusForOrganizationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeHealthServiceStatusForOrganizationResponse();

            if (data.hasOwnProperty('healthServiceAccessStatusForOrganization')) {
                obj['healthServiceAccessStatusForOrganization'] = ApiClient.convertToType(data['healthServiceAccessStatusForOrganization'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeHealthServiceStatusForOrganizationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeHealthServiceStatusForOrganizationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `healthServiceAccessStatusForOrganization`
        if (data['healthServiceAccessStatusForOrganization']) { // data not null
          String.validateJSON(data['healthServiceAccessStatusForOrganization']);
        }
...
/**
 * @member {String} healthServiceAccessStatusForOrganization
 */
DescribeHealthServiceStatusForOrganizationResponse.prototype['healthServiceAccessStatusForOrganization'] = undefined;
...
export default DescribeHealthServiceStatusForOrganizationResponse;
