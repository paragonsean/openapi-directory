...
/**
 * The DescribeAffectedEntitiesForOrganizationResponse model module.
 * @module model/DescribeAffectedEntitiesForOrganizationResponse
 * @version 2016-08-04
 */
class DescribeAffectedEntitiesForOrganizationResponse {
    /**
     * Constructs a new <code>DescribeAffectedEntitiesForOrganizationResponse</code>.
     * @alias module:model/DescribeAffectedEntitiesForOrganizationResponse
     */
    constructor() { 
        
        DescribeAffectedEntitiesForOrganizationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAffectedEntitiesForOrganizationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAffectedEntitiesForOrganizationResponse} obj Optional instance to populate.
     * @return {module:model/DescribeAffectedEntitiesForOrganizationResponse} The populated <code>DescribeAffectedEntitiesForOrganizationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAffectedEntitiesForOrganizationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAffectedEntitiesForOrganizationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAffectedEntitiesForOrganizationResponse</code>.
     */
 ...
 */
DescribeAffectedEntitiesForOrganizationResponse.prototype['entities'] = undefined;

/**
 * @member {Array} failedSet
 */
DescribeAffectedEntitiesForOrganizationResponse.prototype['failedSet'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeAffectedEntitiesForOrganizationResponse.prototype['nextToken'] = undefined;
...
export default DescribeAffectedEntitiesForOrganizationResponse;
