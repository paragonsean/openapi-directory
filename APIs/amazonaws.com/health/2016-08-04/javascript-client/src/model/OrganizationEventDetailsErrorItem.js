...
/**
 * The OrganizationEventDetailsErrorItem model module.
 * @module model/OrganizationEventDetailsErrorItem
 * @version 2016-08-04
 */
class OrganizationEventDetailsErrorItem {
    /**
     * Constructs a new <code>OrganizationEventDetailsErrorItem</code>.
     ...
     * @alias module:model/OrganizationEventDetailsErrorItem
     */
    constructor() { 
        
        OrganizationEventDetailsErrorItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationEventDetailsErrorItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationEventDetailsErrorItem} obj Optional instance to populate.
     * @return {module:model/OrganizationEventDetailsErrorItem} The populated <code>OrganizationEventDetailsErrorItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationEventDetailsErrorItem();
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationEventDetailsErrorItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationEventDetailsErrorItem</code>.
     */
 ...
 */
OrganizationEventDetailsErrorItem.prototype['awsAccountId'] = undefined;

/**
 * @member {String} eventArn
 */
OrganizationEventDetailsErrorItem.prototype['eventArn'] = undefined;

/**
 * @member {String} errorName
 */
OrganizationEventDetailsErrorItem.prototype['errorName'] = undefined;

/**
 * @member {String} errorMessage
 */
OrganizationEventDetailsErrorItem.prototype['errorMessage'] = undefined;
...
export default OrganizationEventDetailsErrorItem;
