...
import DescribeEventTypesRequestFilter from './DescribeEventTypesRequestFilter';

/**
 * The DescribeEventTypesRequest model module.
 * @module model/DescribeEventTypesRequest
 * @version 2016-08-04
 */
class DescribeEventTypesRequest {
    /**
     * Constructs a new <code>DescribeEventTypesRequest</code>.
     * @alias module:model/DescribeEventTypesRequest
     */
    constructor() { 
        
        DescribeEventTypesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEventTypesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEventTypesRequest} obj Optional instance to populate.
     * @return {module:model/DescribeEventTypesRequest} The populated <code>DescribeEventTypesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEventTypesRequest();

            if (data.hasOwnProperty('filter')) {
                obj['filter'] = DescribeEventTypesRequestFilter.constructFromObject(data['filter']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEventTypesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEventTypesRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `filter`
        if (data['filter']) { // data not null
          DescribeEventTypesRequestFilter.validateJSON(data['filter']);
        }
...
/**
 * @member {module:model/DescribeEventTypesRequestFilter} filter
 */
DescribeEventTypesRequest.prototype['filter'] = undefined;

/**
 * @member {String} locale
 */
DescribeEventTypesRequest.prototype['locale'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeEventTypesRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
DescribeEventTypesRequest.prototype['maxResults'] = undefined;
...
export default DescribeEventTypesRequest;
