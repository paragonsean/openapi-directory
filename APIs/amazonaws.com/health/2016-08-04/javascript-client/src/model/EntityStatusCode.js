...
* @readonly
*/
export default class EntityStatusCode {
    ...
    /**
    * Returns a <code>EntityStatusCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EntityStatusCode} The enum <code>EntityStatusCode</code> value.
    */
