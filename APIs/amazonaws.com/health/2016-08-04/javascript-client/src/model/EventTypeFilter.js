...
/**
 * The EventTypeFilter model module.
 * @module model/EventTypeFilter
 * @version 2016-08-04
 */
class EventTypeFilter {
    /**
     * Constructs a new <code>EventTypeFilter</code>.
     ...
     * @alias module:model/EventTypeFilter
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>EventTypeFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventTypeFilter} obj Optional instance to populate.
     * @return {module:model/EventTypeFilter} The populated <code>EventTypeFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventTypeFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>EventTypeFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventTypeFilter</code>.
     */
