...
* @readonly
*/
export default class EventScopeCode {
    ...
    /**
    * Returns a <code>EventScopeCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EventScopeCode} The enum <code>EventScopeCode</code> value.
    */
