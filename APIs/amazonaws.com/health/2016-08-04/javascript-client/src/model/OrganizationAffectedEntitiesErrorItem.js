...
/**
 * The OrganizationAffectedEntitiesErrorItem model module.
 * @module model/OrganizationAffectedEntitiesErrorItem
 * @version 2016-08-04
 */
class OrganizationAffectedEntitiesErrorItem {
    /**
     * Constructs a new <code>OrganizationAffectedEntitiesErrorItem</code>.
     ...
     * @alias module:model/OrganizationAffectedEntitiesErrorItem
     */
    constructor() { 
        
        OrganizationAffectedEntitiesErrorItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationAffectedEntitiesErrorItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationAffectedEntitiesErrorItem} obj Optional instance to populate.
     * @return {module:model/OrganizationAffectedEntitiesErrorItem} The populated <code>OrganizationAffectedEntitiesErrorItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationAffectedEntitiesErrorItem();

            if (data.hasOwnProperty('awsAccountId')) {
                obj['awsAccountId'] = ApiClient.convertToType(data['awsAccountId'], 'String');
            }
            if (data.hasOwnProperty('eventArn')) {
                obj['eventArn'] = ApiClient.convertToType(data['eventArn'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationAffectedEntitiesErrorItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationAffectedEntitiesErrorItem</code>.
     */
    static validateJSON(data) {
        ...
        if (data['eventArn']) { // data not null
          String.validateJSON(data['eventArn']);
        }
        // validate the optional field `errorName`
        if (data['errorName']) { // data not null
          String.validateJSON(data['errorName']);
        }
 ...
 */
OrganizationAffectedEntitiesErrorItem.prototype['awsAccountId'] = undefined;

/**
 * @member {String} eventArn
 */
OrganizationAffectedEntitiesErrorItem.prototype['eventArn'] = undefined;

/**
 * @member {String} errorName
 */
OrganizationAffectedEntitiesErrorItem.prototype['errorName'] = undefined;

/**
 * @member {String} errorMessage
 */
OrganizationAffectedEntitiesErrorItem.prototype['errorMessage'] = undefined;
...
export default OrganizationAffectedEntitiesErrorItem;
