...
/**
 * The DescribeAffectedEntitiesForOrganizationRequest model module.
 * @module model/DescribeAffectedEntitiesForOrganizationRequest
 * @version 2016-08-04
 */
class DescribeAffectedEntitiesForOrganizationRequest {
    /**
     * Constructs a new <code>DescribeAffectedEntitiesForOrganizationRequest</code>.
     * @alias module:model/DescribeAffectedEntitiesForOrganizationRequest
     * @param organizationEntityFilters {Array} 
     */
    constructor(organizationEntityFilters) { 
        
        DescribeAffectedEntitiesForOrganizationRequest.initialize(this, organizationEntityFilters);
    }
     ...
     */
    static initialize(obj, organizationEntityFilters) { 
        obj['organizationEntityFilters'] = organizationEntityFilters;
    }

    /**
     * Constructs a <code>DescribeAffectedEntitiesForOrganizationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAffectedEntitiesForOrganizationRequest} obj Optional instance to populate.
     * @return {module:model/DescribeAffectedEntitiesForOrganizationRequest} The populated <code>DescribeAffectedEntitiesForOrganizationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAffectedEntitiesForOrganizationRequest();

            if (data.hasOwnProperty('organizationEntityFilters')) {
                obj['organizationEntityFilters'] = ApiClient.convertToType(data['organizationEntityFilters'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAffectedEntitiesForOrganizationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAffectedEntitiesForOrganizationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeAffectedEntitiesForOrganizationRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `organizationEntityFilters`
        if (data['organizationEntityFilters']) { // data not null
          Array.validateJSON(data['organizationEntityFilters']);
        }
...
DescribeAffectedEntitiesForOrganizationRequest.RequiredProperties = ["organizationEntityFilters"];

/**
 * @member {Array} organizationEntityFilters
 */
DescribeAffectedEntitiesForOrganizationRequest.prototype['organizationEntityFilters'] = undefined;

/**
 * @member {String} locale
 */
DescribeAffectedEntitiesForOrganizationRequest.prototype['locale'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeAffectedEntitiesForOrganizationRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
DescribeAffectedEntitiesForOrganizationRequest.prototype['maxResults'] = undefined;
...
export default DescribeAffectedEntitiesForOrganizationRequest;
