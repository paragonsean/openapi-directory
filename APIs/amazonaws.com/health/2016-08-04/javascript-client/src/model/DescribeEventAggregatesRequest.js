...
import DescribeEventAggregatesRequestFilter from './DescribeEventAggregatesRequestFilter';
import EventAggregateField from './EventAggregateField';

/**
 * The DescribeEventAggregatesRequest model module.
 * @module model/DescribeEventAggregatesRequest
 * @version 2016-08-04
 */
class DescribeEventAggregatesRequest {
    /**
     * Constructs a new <code>DescribeEventAggregatesRequest</code>.
     * @alias module:model/DescribeEventAggregatesRequest
     * @param aggregateField {module:model/EventAggregateField} 
     */
    constructor(aggregateField) { 
        
        DescribeEventAggregatesRequest.initialize(this, aggregateField);
    }
     ...
     */
    static initialize(obj, aggregateField) { 
        obj['aggregateField'] = aggregateField;
    }

    /**
     * Constructs a <code>DescribeEventAggregatesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEventAggregatesRequest} obj Optional instance to populate.
     * @return {module:model/DescribeEventAggregatesRequest} The populated <code>DescribeEventAggregatesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEventAggregatesRequest();

            if (data.hasOwnProperty('filter')) {
                obj['filter'] = DescribeEventAggregatesRequestFilter.constructFromObject(data['filter']);
            }
            if (data.hasOwnProperty('aggregateField')) {
                obj['aggregateField'] = ApiClient.convertToType(data['aggregateField'], EventAggregateField);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEventAggregatesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEventAggregatesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeEventAggregatesRequest.RequiredProperties) {
        ...
        if (data['filter']) { // data not null
          DescribeEventAggregatesRequestFilter.validateJSON(data['filter']);
        }
        // validate the optional field `aggregateField`
        if (data['aggregateField']) { // data not null
          EventAggregateField.validateJSON(data['aggregateField']);
        }
...
DescribeEventAggregatesRequest.RequiredProperties = ["aggregateField"];

/**
 * @member {module:model/DescribeEventAggregatesRequestFilter} filter
 */
DescribeEventAggregatesRequest.prototype['filter'] = undefined;

/**
 * @member {module:model/EventAggregateField} aggregateField
 */
DescribeEventAggregatesRequest.prototype['aggregateField'] = undefined;

/**
 * @member {Number} maxResults
 */
DescribeEventAggregatesRequest.prototype['maxResults'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeEventAggregatesRequest.prototype['nextToken'] = undefined;
...
export default DescribeEventAggregatesRequest;
