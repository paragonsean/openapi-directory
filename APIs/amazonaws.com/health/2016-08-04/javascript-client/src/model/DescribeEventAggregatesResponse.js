...
/**
 * The DescribeEventAggregatesResponse model module.
 * @module model/DescribeEventAggregatesResponse
 * @version 2016-08-04
 */
class DescribeEventAggregatesResponse {
    /**
     * Constructs a new <code>DescribeEventAggregatesResponse</code>.
     * @alias module:model/DescribeEventAggregatesResponse
     */
    constructor() { 
        
        DescribeEventAggregatesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEventAggregatesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEventAggregatesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeEventAggregatesResponse} The populated <code>DescribeEventAggregatesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEventAggregatesResponse();

            if (data.hasOwnProperty('eventAggregates')) {
                obj['eventAggregates'] = ApiClient.convertToType(data['eventAggregates'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEventAggregatesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEventAggregatesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `eventAggregates`
        if (data['eventAggregates']) { // data not null
          Array.validateJSON(data['eventAggregates']);
        }
...
/**
 * @member {Array} eventAggregates
 */
DescribeEventAggregatesResponse.prototype['eventAggregates'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeEventAggregatesResponse.prototype['nextToken'] = undefined;
...
export default DescribeEventAggregatesResponse;
