...
* @readonly
*/
export default class EventAggregateField {
    ...
    /**
    * Returns a <code>EventAggregateField</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EventAggregateField} The enum <code>EventAggregateField</code> value.
    */
