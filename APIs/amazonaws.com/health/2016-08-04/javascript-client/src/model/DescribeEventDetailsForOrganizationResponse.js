...
/**
 * The DescribeEventDetailsForOrganizationResponse model module.
 * @module model/DescribeEventDetailsForOrganizationResponse
 * @version 2016-08-04
 */
class DescribeEventDetailsForOrganizationResponse {
    /**
     * Constructs a new <code>DescribeEventDetailsForOrganizationResponse</code>.
     * @alias module:model/DescribeEventDetailsForOrganizationResponse
     */
    constructor() { 
        
        DescribeEventDetailsForOrganizationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEventDetailsForOrganizationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEventDetailsForOrganizationResponse} obj Optional instance to populate.
     * @return {module:model/DescribeEventDetailsForOrganizationResponse} The populated <code>DescribeEventDetailsForOrganizationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEventDetailsForOrganizationResponse();

            if (data.hasOwnProperty('successfulSet')) {
                obj['successfulSet'] = ApiClient.convertToType(data['successfulSet'], Array);
            }
            if (data.hasOwnProperty('failedSet')) {
                obj['failedSet'] = ApiClient.convertToType(data['failedSet'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEventDetailsForOrganizationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEventDetailsForOrganizationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `successfulSet`
        if (data['successfulSet']) { // data not null
          Array.validateJSON(data['successfulSet']);
        }
        // validate the optional field `failedSet`
        if (data['failedSet']) { // data not null
          Array.validateJSON(data['failedSet']);
        }
...
/**
 * @member {Array} successfulSet
 */
DescribeEventDetailsForOrganizationResponse.prototype['successfulSet'] = undefined;

/**
 * @member {Array} failedSet
 */
DescribeEventDetailsForOrganizationResponse.prototype['failedSet'] = undefined;
...
export default DescribeEventDetailsForOrganizationResponse;
