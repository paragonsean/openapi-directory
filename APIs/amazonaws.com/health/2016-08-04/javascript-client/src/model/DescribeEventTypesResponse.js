...
/**
 * The DescribeEventTypesResponse model module.
 * @module model/DescribeEventTypesResponse
 * @version 2016-08-04
 */
class DescribeEventTypesResponse {
    /**
     * Constructs a new <code>DescribeEventTypesResponse</code>.
     * @alias module:model/DescribeEventTypesResponse
     */
    constructor() { 
        
        DescribeEventTypesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEventTypesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEventTypesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeEventTypesResponse} The populated <code>DescribeEventTypesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEventTypesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEventTypesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEventTypesResponse</code>.
     */
 ...
 */
DescribeEventTypesResponse.prototype['eventTypes'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeEventTypesResponse.prototype['nextToken'] = undefined;
...
export default DescribeEventTypesResponse;
