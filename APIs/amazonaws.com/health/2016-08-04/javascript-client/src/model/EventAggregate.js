...
/**
 * The EventAggregate model module.
 * @module model/EventAggregate
 * @version 2016-08-04
 */
class EventAggregate {
    /**
     * Constructs a new <code>EventAggregate</code>.
     ...
     * @alias module:model/EventAggregate
     */
    constructor() { 
        
        EventAggregate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventAggregate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventAggregate} obj Optional instance to populate.
     * @return {module:model/EventAggregate} The populated <code>EventAggregate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventAggregate();
    ...
    /**
     * Validates the JSON data with respect to <code>EventAggregate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventAggregate</code>.
     */
    static validateJSON(data) {
        // validate the optional field `aggregateValue`
        if (data['aggregateValue']) { // data not null
          String.validateJSON(data['aggregateValue']);
        }
 ...
 */
EventAggregate.prototype['aggregateValue'] = undefined;

/**
 * @member {Number} count
 */
EventAggregate.prototype['count'] = undefined;
