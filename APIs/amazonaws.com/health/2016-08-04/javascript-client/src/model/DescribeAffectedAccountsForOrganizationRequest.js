...
/**
 * The DescribeAffectedAccountsForOrganizationRequest model module.
 * @module model/DescribeAffectedAccountsForOrganizationRequest
 * @version 2016-08-04
 */
class DescribeAffectedAccountsForOrganizationRequest {
    /**
     * Constructs a new <code>DescribeAffectedAccountsForOrganizationRequest</code>.
     * @alias module:model/DescribeAffectedAccountsForOrganizationRequest
     * @param eventArn {String} 
     */
    constructor(eventArn) { 
        
        DescribeAffectedAccountsForOrganizationRequest.initialize(this, eventArn);
    }
     ...
     */
    static initialize(obj, eventArn) { 
        obj['eventArn'] = eventArn;
    }

    /**
     * Constructs a <code>DescribeAffectedAccountsForOrganizationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAffectedAccountsForOrganizationRequest} obj Optional instance to populate.
     * @return {module:model/DescribeAffectedAccountsForOrganizationRequest} The populated <code>DescribeAffectedAccountsForOrganizationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAffectedAccountsForOrganizationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAffectedAccountsForOrganizationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAffectedAccountsForOrganizationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeAffectedAccountsForOrganizationRequest.RequiredProperties) {
...
DescribeAffectedAccountsForOrganizationRequest.RequiredProperties = ["eventArn"];

/**
 * @member {String} eventArn
 */
DescribeAffectedAccountsForOrganizationRequest.prototype['eventArn'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeAffectedAccountsForOrganizationRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
DescribeAffectedAccountsForOrganizationRequest.prototype['maxResults'] = undefined;
...
export default DescribeAffectedAccountsForOrganizationRequest;
