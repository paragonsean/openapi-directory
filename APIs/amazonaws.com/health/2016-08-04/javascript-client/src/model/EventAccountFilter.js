...
/**
 * The EventAccountFilter model module.
 * @module model/EventAccountFilter
 * @version 2016-08-04
 */
class EventAccountFilter {
    /**
     * Constructs a new <code>EventAccountFilter</code>.
     ...
     * @alias module:model/EventAccountFilter
     * @param eventArn {String} 
     */
    constructor(eventArn) { 
        
        EventAccountFilter.initialize(this, eventArn);
    }
    ...
    /**
     * Constructs a <code>EventAccountFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventAccountFilter} obj Optional instance to populate.
     * @return {module:model/EventAccountFilter} The populated <code>EventAccountFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventAccountFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>EventAccountFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventAccountFilter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventAccountFilter.RequiredProperties) {
...
EventAccountFilter.RequiredProperties = ["eventArn"];

/**
 * @member {String} eventArn
 */
EventAccountFilter.prototype['eventArn'] = undefined;

/**
 * @member {String} awsAccountId
 */
EventAccountFilter.prototype['awsAccountId'] = undefined;
...
export default EventAccountFilter;
