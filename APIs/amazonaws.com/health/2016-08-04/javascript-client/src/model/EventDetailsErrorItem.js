...
/**
 * The EventDetailsErrorItem model module.
 * @module model/EventDetailsErrorItem
 * @version 2016-08-04
 */
class EventDetailsErrorItem {
    /**
     * Constructs a new <code>EventDetailsErrorItem</code>.
     ...
     * @alias module:model/EventDetailsErrorItem
     */
    constructor() { 
        
        EventDetailsErrorItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventDetailsErrorItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventDetailsErrorItem} obj Optional instance to populate.
     * @return {module:model/EventDetailsErrorItem} The populated <code>EventDetailsErrorItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventDetailsErrorItem();
    ...
    /**
     * Validates the JSON data with respect to <code>EventDetailsErrorItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventDetailsErrorItem</code>.
     */
 ...
 */
EventDetailsErrorItem.prototype['eventArn'] = undefined;

/**
 * @member {String} errorName
 */
EventDetailsErrorItem.prototype['errorName'] = undefined;

/**
 * @member {String} errorMessage
 */
EventDetailsErrorItem.prototype['errorMessage'] = undefined;
...
export default EventDetailsErrorItem;
