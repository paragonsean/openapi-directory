...
import DescribeEventsForOrganizationRequestFilter from './DescribeEventsForOrganizationRequestFilter';

/**
 * The DescribeEventsForOrganizationRequest model module.
 * @module model/DescribeEventsForOrganizationRequest
 * @version 2016-08-04
 */
class DescribeEventsForOrganizationRequest {
    /**
     * Constructs a new <code>DescribeEventsForOrganizationRequest</code>.
     * @alias module:model/DescribeEventsForOrganizationRequest
     */
    constructor() { 
        
        DescribeEventsForOrganizationRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEventsForOrganizationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEventsForOrganizationRequest} obj Optional instance to populate.
     * @return {module:model/DescribeEventsForOrganizationRequest} The populated <code>DescribeEventsForOrganizationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEventsForOrganizationRequest();

            if (data.hasOwnProperty('filter')) {
                obj['filter'] = DescribeEventsForOrganizationRequestFilter.constructFromObject(data['filter']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEventsForOrganizationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEventsForOrganizationRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `filter`
        if (data['filter']) { // data not null
          DescribeEventsForOrganizationRequestFilter.validateJSON(data['filter']);
        }
...
/**
 * @member {module:model/DescribeEventsForOrganizationRequestFilter} filter
 */
DescribeEventsForOrganizationRequest.prototype['filter'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeEventsForOrganizationRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
DescribeEventsForOrganizationRequest.prototype['maxResults'] = undefined;

/**
 * @member {String} locale
 */
DescribeEventsForOrganizationRequest.prototype['locale'] = undefined;
...
export default DescribeEventsForOrganizationRequest;
