...
/**
 * The DescribeEventDetailsResponse model module.
 * @module model/DescribeEventDetailsResponse
 * @version 2016-08-04
 */
class DescribeEventDetailsResponse {
    /**
     * Constructs a new <code>DescribeEventDetailsResponse</code>.
     * @alias module:model/DescribeEventDetailsResponse
     */
    constructor() { 
        
        DescribeEventDetailsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEventDetailsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEventDetailsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeEventDetailsResponse} The populated <code>DescribeEventDetailsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEventDetailsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEventDetailsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEventDetailsResponse</code>.
     */
 ...
 */
DescribeEventDetailsResponse.prototype['successfulSet'] = undefined;

/**
 * @member {Array} failedSet
 */
DescribeEventDetailsResponse.prototype['failedSet'] = undefined;
...
export default DescribeEventDetailsResponse;
