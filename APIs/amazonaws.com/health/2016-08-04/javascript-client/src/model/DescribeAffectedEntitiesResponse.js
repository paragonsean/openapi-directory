...
/**
 * The DescribeAffectedEntitiesResponse model module.
 * @module model/DescribeAffectedEntitiesResponse
 * @version 2016-08-04
 */
class DescribeAffectedEntitiesResponse {
    /**
     * Constructs a new <code>DescribeAffectedEntitiesResponse</code>.
     * @alias module:model/DescribeAffectedEntitiesResponse
     */
    constructor() { 
        
        DescribeAffectedEntitiesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAffectedEntitiesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAffectedEntitiesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeAffectedEntitiesResponse} The populated <code>DescribeAffectedEntitiesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAffectedEntitiesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAffectedEntitiesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAffectedEntitiesResponse</code>.
     */
 ...
 */
DescribeAffectedEntitiesResponse.prototype['entities'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeAffectedEntitiesResponse.prototype['nextToken'] = undefined;
...
export default DescribeAffectedEntitiesResponse;
