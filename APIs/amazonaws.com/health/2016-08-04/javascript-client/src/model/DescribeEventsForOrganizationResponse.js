...
/**
 * The DescribeEventsForOrganizationResponse model module.
 * @module model/DescribeEventsForOrganizationResponse
 * @version 2016-08-04
 */
class DescribeEventsForOrganizationResponse {
    /**
     * Constructs a new <code>DescribeEventsForOrganizationResponse</code>.
     * @alias module:model/DescribeEventsForOrganizationResponse
     */
    constructor() { 
        
        DescribeEventsForOrganizationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEventsForOrganizationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEventsForOrganizationResponse} obj Optional instance to populate.
     * @return {module:model/DescribeEventsForOrganizationResponse} The populated <code>DescribeEventsForOrganizationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEventsForOrganizationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEventsForOrganizationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEventsForOrganizationResponse</code>.
     */
 ...
 * @member {Array} events
 */
DescribeEventsForOrganizationResponse.prototype['events'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeEventsForOrganizationResponse.prototype['nextToken'] = undefined;
...
export default DescribeEventsForOrganizationResponse;
