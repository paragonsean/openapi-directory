...
/**
 * The DescribeEntityAggregatesRequest model module.
 * @module model/DescribeEntityAggregatesRequest
 * @version 2016-08-04
 */
class DescribeEntityAggregatesRequest {
    /**
     * Constructs a new <code>DescribeEntityAggregatesRequest</code>.
     * @alias module:model/DescribeEntityAggregatesRequest
     */
    constructor() { 
        
        DescribeEntityAggregatesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEntityAggregatesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEntityAggregatesRequest} obj Optional instance to populate.
     * @return {module:model/DescribeEntityAggregatesRequest} The populated <code>DescribeEntityAggregatesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEntityAggregatesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEntityAggregatesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEntityAggregatesRequest</code>.
     */
 ...
 */
DescribeEntityAggregatesRequest.prototype['eventArns'] = undefined;
...
export default DescribeEntityAggregatesRequest;
