...
/**
 * The OrganizationEvent model module.
 * @module model/OrganizationEvent
 * @version 2016-08-04
 */
class OrganizationEvent {
    /**
     * Constructs a new <code>OrganizationEvent</code>.
     ...
     * @alias module:model/OrganizationEvent
     */
    constructor() { 
        
        OrganizationEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationEvent} obj Optional instance to populate.
     * @return {module:model/OrganizationEvent} The populated <code>OrganizationEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationEvent</code>.
     */
 ...
 * @member {String} arn
 */
OrganizationEvent.prototype['arn'] = undefined;

/**
 * @member {String} service
 */
OrganizationEvent.prototype['service'] = undefined;

/**
 * @member {String} eventTypeCode
 */
OrganizationEvent.prototype['eventTypeCode'] = undefined;

/**
 * @member {module:model/EventTypeCategory} eventTypeCategory
 */
OrganizationEvent.prototype['eventTypeCategory'] = undefined;

/**
 * @member {module:model/EventScopeCode} eventScopeCode
 */
OrganizationEvent.prototype['eventScopeCode'] = undefined;

/**
 * @member {String} region
 */
OrganizationEvent.prototype['region'] = undefined;

/**
 * @member {Date} startTime
 */
OrganizationEvent.prototype['startTime'] = undefined;

/**
 * @member {Date} endTime
 */
OrganizationEvent.prototype['endTime'] = undefined;

/**
 * @member {Date} lastUpdatedTime
 */
OrganizationEvent.prototype['lastUpdatedTime'] = undefined;

/**
 * @member {module:model/EventStatusCode} statusCode
 */
OrganizationEvent.prototype['statusCode'] = undefined;
