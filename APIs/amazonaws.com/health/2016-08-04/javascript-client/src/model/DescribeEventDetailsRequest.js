...
/**
 * The DescribeEventDetailsRequest model module.
 * @module model/DescribeEventDetailsRequest
 * @version 2016-08-04
 */
class DescribeEventDetailsRequest {
    /**
     * Constructs a new <code>DescribeEventDetailsRequest</code>.
     * @alias module:model/DescribeEventDetailsRequest
     * @param eventArns {Array} 
     */
    constructor(eventArns) { 
        
        DescribeEventDetailsRequest.initialize(this, eventArns);
    }
    ...
    /**
     * Constructs a <code>DescribeEventDetailsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEventDetailsRequest} obj Optional instance to populate.
     * @return {module:model/DescribeEventDetailsRequest} The populated <code>DescribeEventDetailsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEventDetailsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEventDetailsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEventDetailsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeEventDetailsRequest.RequiredProperties) {
...
DescribeEventDetailsRequest.RequiredProperties = ["eventArns"];

/**
 * @member {Array} eventArns
 */
DescribeEventDetailsRequest.prototype['eventArns'] = undefined;

/**
 * @member {String} locale
 */
DescribeEventDetailsRequest.prototype['locale'] = undefined;
...
export default DescribeEventDetailsRequest;
