...
/**
 * The EntityAggregate model module.
 * @module model/EntityAggregate
 * @version 2016-08-04
 */
class EntityAggregate {
    /**
     * Constructs a new <code>EntityAggregate</code>.
     ...
     * @alias module:model/EntityAggregate
     */
    constructor() { 
        
        EntityAggregate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EntityAggregate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EntityAggregate} obj Optional instance to populate.
     * @return {module:model/EntityAggregate} The populated <code>EntityAggregate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EntityAggregate();
    ...
    /**
     * Validates the JSON data with respect to <code>EntityAggregate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EntityAggregate</code>.
     */
 ...
 */
EntityAggregate.prototype['eventArn'] = undefined;

/**
 * @member {Number} count
 */
EntityAggregate.prototype['count'] = undefined;
...
export default EntityAggregate;
