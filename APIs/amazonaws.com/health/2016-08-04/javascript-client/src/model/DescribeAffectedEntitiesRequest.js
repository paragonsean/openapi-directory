...
import DescribeAffectedEntitiesRequestFilter from './DescribeAffectedEntitiesRequestFilter';

/**
 * The DescribeAffectedEntitiesRequest model module.
 * @module model/DescribeAffectedEntitiesRequest
 * @version 2016-08-04
 */
class DescribeAffectedEntitiesRequest {
    /**
     * Constructs a new <code>DescribeAffectedEntitiesRequest</code>.
     * @alias module:model/DescribeAffectedEntitiesRequest
     * @param filter {module:model/DescribeAffectedEntitiesRequestFilter} 
     */
    constructor(filter) { 
        
        DescribeAffectedEntitiesRequest.initialize(this, filter);
    }
    ...
    /**
     * Constructs a <code>DescribeAffectedEntitiesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAffectedEntitiesRequest} obj Optional instance to populate.
     * @return {module:model/DescribeAffectedEntitiesRequest} The populated <code>DescribeAffectedEntitiesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAffectedEntitiesRequest();

            if (data.hasOwnProperty('filter')) {
                obj['filter'] = DescribeAffectedEntitiesRequestFilter.constructFromObject(data['filter']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAffectedEntitiesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAffectedEntitiesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeAffectedEntitiesRequest.RequiredProperties) {
        ...
        if (data['filter']) { // data not null
          DescribeAffectedEntitiesRequestFilter.validateJSON(data['filter']);
        }
...
DescribeAffectedEntitiesRequest.RequiredProperties = ["filter"];

/**
 * @member {module:model/DescribeAffectedEntitiesRequestFilter} filter
 */
DescribeAffectedEntitiesRequest.prototype['filter'] = undefined;

/**
 * @member {String} locale
 */
DescribeAffectedEntitiesRequest.prototype['locale'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeAffectedEntitiesRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
DescribeAffectedEntitiesRequest.prototype['maxResults'] = undefined;
...
export default DescribeAffectedEntitiesRequest;
