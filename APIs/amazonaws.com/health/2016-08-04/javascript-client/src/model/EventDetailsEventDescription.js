...
/**
 * The EventDetailsEventDescription model module.
 * @module model/EventDetailsEventDescription
 * @version 2016-08-04
 */
class EventDetailsEventDescription {
    /**
     * Constructs a new <code>EventDetailsEventDescription</code>.
     * @alias module:model/EventDetailsEventDescription
     * @implements module:model/EventDescription
     */
    constructor() { 
        EventDescription.initialize(this);
        EventDetailsEventDescription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventDetailsEventDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventDetailsEventDescription} obj Optional instance to populate.
     * @return {module:model/EventDetailsEventDescription} The populated <code>EventDetailsEventDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventDetailsEventDescription();
            EventDescription.constructFromObject(data, obj);

            if (data.hasOwnProperty('latestDescription')) {
                obj['latestDescription'] = ApiClient.convertToType(data['latestDescription'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EventDetailsEventDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventDetailsEventDescription</code>.
     */
    static validateJSON(data) {
        // validate the optional field `latestDescription`
        if (data['latestDescription']) { // data not null
          String.validateJSON(data['latestDescription']);
        }
...
/**
 * @member {String} latestDescription
 */
EventDetailsEventDescription.prototype['latestDescription'] = undefined;


// Implement EventDescription interface:
/**
 * @member {String} latestDescription
 */
EventDescription.prototype['latestDescription'] = undefined;




export default EventDetailsEventDescription;
