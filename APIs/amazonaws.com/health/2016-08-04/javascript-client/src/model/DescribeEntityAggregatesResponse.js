...
/**
 * The DescribeEntityAggregatesResponse model module.
 * @module model/DescribeEntityAggregatesResponse
 * @version 2016-08-04
 */
class DescribeEntityAggregatesResponse {
    /**
     * Constructs a new <code>DescribeEntityAggregatesResponse</code>.
     * @alias module:model/DescribeEntityAggregatesResponse
     */
    constructor() { 
        
        DescribeEntityAggregatesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEntityAggregatesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEntityAggregatesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeEntityAggregatesResponse} The populated <code>DescribeEntityAggregatesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEntityAggregatesResponse();

            if (data.hasOwnProperty('entityAggregates')) {
                obj['entityAggregates'] = ApiClient.convertToType(data['entityAggregates'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEntityAggregatesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEntityAggregatesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `entityAggregates`
        if (data['entityAggregates']) { // data not null
          Array.validateJSON(data['entityAggregates']);
        }
...
/**
 * @member {Array} entityAggregates
 */
DescribeEntityAggregatesResponse.prototype['entityAggregates'] = undefined;
...
export default DescribeEntityAggregatesResponse;
