...
/**
 * The DescribeAffectedAccountsForOrganizationResponse model module.
 * @module model/DescribeAffectedAccountsForOrganizationResponse
 * @version 2016-08-04
 */
class DescribeAffectedAccountsForOrganizationResponse {
    /**
     * Constructs a new <code>DescribeAffectedAccountsForOrganizationResponse</code>.
     * @alias module:model/DescribeAffectedAccountsForOrganizationResponse
     */
    constructor() { 
        
        DescribeAffectedAccountsForOrganizationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAffectedAccountsForOrganizationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAffectedAccountsForOrganizationResponse} obj Optional instance to populate.
     * @return {module:model/DescribeAffectedAccountsForOrganizationResponse} The populated <code>DescribeAffectedAccountsForOrganizationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAffectedAccountsForOrganizationResponse();

            if (data.hasOwnProperty('affectedAccounts')) {
                obj['affectedAccounts'] = ApiClient.convertToType(data['affectedAccounts'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAffectedAccountsForOrganizationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAffectedAccountsForOrganizationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `affectedAccounts`
        if (data['affectedAccounts']) { // data not null
          Array.validateJSON(data['affectedAccounts']);
        }
...
/**
 * @member {Array} affectedAccounts
 */
DescribeAffectedAccountsForOrganizationResponse.prototype['affectedAccounts'] = undefined;

/**
 * @member {module:model/EventScopeCode} eventScopeCode
 */
DescribeAffectedAccountsForOrganizationResponse.prototype['eventScopeCode'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeAffectedAccountsForOrganizationResponse.prototype['nextToken'] = undefined;
...
export default DescribeAffectedAccountsForOrganizationResponse;
