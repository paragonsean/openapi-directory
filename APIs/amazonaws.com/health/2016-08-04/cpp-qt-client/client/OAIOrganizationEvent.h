...
#ifndef OAIOrganizationEvent_H
#define OAIOrganizationEvent_H
...
class OAIOrganizationEvent : public OAIObject {
public:
    OAIOrganizationEvent();
    OAIOrganizationEvent(QString json);
    ~OAIOrganizationEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationEvent)

#endif // OAIOrganizationEvent_H
