...
OAIDescribeEventTypesRequest_filter::OAIDescribeEventTypesRequest_filter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEventTypesRequest_filter::OAIDescribeEventTypesRequest_filter() {
    this->initializeModel();
}

OAIDescribeEventTypesRequest_filter::~OAIDescribeEventTypesRequest_filter() {}

void OAIDescribeEventTypesRequest_filter::initializeModel() {
...
void OAIDescribeEventTypesRequest_filter::fromJson(QString jsonString) {
...
void OAIDescribeEventTypesRequest_filter::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeEventTypesRequest_filter::asJson() const {
...
QJsonObject OAIDescribeEventTypesRequest_filter::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeEventTypesRequest_filter::getEventTypeCodes() const {
    return m_event_type_codes;
}
void OAIDescribeEventTypesRequest_filter::setEventTypeCodes(const QList &event_type_codes) {
    m_event_type_codes = event_type_codes;
    m_event_type_codes_isSet = true;
}

bool OAIDescribeEventTypesRequest_filter::is_event_type_codes_Set() const{
    return m_event_type_codes_isSet;
}

bool OAIDescribeEventTypesRequest_filter::is_event_type_codes_Valid() const{
    return m_event_type_codes_isValid;
}

QList OAIDescribeEventTypesRequest_filter::getServices() const {
    return m_services;
}
void OAIDescribeEventTypesRequest_filter::setServices(const QList &services) {
    m_services = services;
    m_services_isSet = true;
}

bool OAIDescribeEventTypesRequest_filter::is_services_Set() const{
    return m_services_isSet;
}

bool OAIDescribeEventTypesRequest_filter::is_services_Valid() const{
    return m_services_isValid;
}

QList OAIDescribeEventTypesRequest_filter::getEventTypeCategories() const {
    return m_event_type_categories;
}
void OAIDescribeEventTypesRequest_filter::setEventTypeCategories(const QList &event_type_categories) {
    m_event_type_categories = event_type_categories;
    m_event_type_categories_isSet = true;
}

bool OAIDescribeEventTypesRequest_filter::is_event_type_categories_Set() const{
    return m_event_type_categories_isSet;
}

bool OAIDescribeEventTypesRequest_filter::is_event_type_categories_Valid() const{
    return m_event_type_categories_isValid;
}

bool OAIDescribeEventTypesRequest_filter::isSet() const {
...
bool OAIDescribeEventTypesRequest_filter::isValid() const {
