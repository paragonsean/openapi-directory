...
#include "OAIOrganizationAffectedEntitiesErrorItem.h"
...
OAIOrganizationAffectedEntitiesErrorItem::OAIOrganizationAffectedEntitiesErrorItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationAffectedEntitiesErrorItem::OAIOrganizationAffectedEntitiesErrorItem() {
    this->initializeModel();
}

OAIOrganizationAffectedEntitiesErrorItem::~OAIOrganizationAffectedEntitiesErrorItem() {}

void OAIOrganizationAffectedEntitiesErrorItem::initializeModel() {
...
void OAIOrganizationAffectedEntitiesErrorItem::fromJson(QString jsonString) {
...
void OAIOrganizationAffectedEntitiesErrorItem::fromJsonObject(QJsonObject json) {
...
QString OAIOrganizationAffectedEntitiesErrorItem::asJson() const {
...
QJsonObject OAIOrganizationAffectedEntitiesErrorItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAIOrganizationAffectedEntitiesErrorItem::getAwsAccountId() const {
    return m_aws_account_id;
}
void OAIOrganizationAffectedEntitiesErrorItem::setAwsAccountId(const QString &aws_account_id) {
    m_aws_account_id = aws_account_id;
    m_aws_account_id_isSet = true;
}

bool OAIOrganizationAffectedEntitiesErrorItem::is_aws_account_id_Set() const{
    return m_aws_account_id_isSet;
}

bool OAIOrganizationAffectedEntitiesErrorItem::is_aws_account_id_Valid() const{
    return m_aws_account_id_isValid;
}

QString OAIOrganizationAffectedEntitiesErrorItem::getEventArn() const {
    return m_event_arn;
}
void OAIOrganizationAffectedEntitiesErrorItem::setEventArn(const QString &event_arn) {
    m_event_arn = event_arn;
    m_event_arn_isSet = true;
}

bool OAIOrganizationAffectedEntitiesErrorItem::is_event_arn_Set() const{
    return m_event_arn_isSet;
}

bool OAIOrganizationAffectedEntitiesErrorItem::is_event_arn_Valid() const{
    return m_event_arn_isValid;
}

QString OAIOrganizationAffectedEntitiesErrorItem::getErrorName() const {
    return m_error_name;
}
void OAIOrganizationAffectedEntitiesErrorItem::setErrorName(const QString &error_name) {
    m_error_name = error_name;
    m_error_name_isSet = true;
}

bool OAIOrganizationAffectedEntitiesErrorItem::is_error_name_Set() const{
    return m_error_name_isSet;
}

bool OAIOrganizationAffectedEntitiesErrorItem::is_error_name_Valid() const{
    return m_error_name_isValid;
}

QString OAIOrganizationAffectedEntitiesErrorItem::getErrorMessage() const {
    return m_error_message;
}
void OAIOrganizationAffectedEntitiesErrorItem::setErrorMessage(const QString &error_message) {
    m_error_message = error_message;
    m_error_message_isSet = true;
}

bool OAIOrganizationAffectedEntitiesErrorItem::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIOrganizationAffectedEntitiesErrorItem::is_error_message_Valid() const{
    return m_error_message_isValid;
}

bool OAIOrganizationAffectedEntitiesErrorItem::isSet() const {
...
bool OAIOrganizationAffectedEntitiesErrorItem::isValid() const {
