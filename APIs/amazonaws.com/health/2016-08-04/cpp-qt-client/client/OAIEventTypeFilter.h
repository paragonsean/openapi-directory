...
#ifndef OAIEventTypeFilter_H
#define OAIEventTypeFilter_H
...
class OAIEventTypeFilter : public OAIObject {
public:
    OAIEventTypeFilter();
    OAIEventTypeFilter(QString json);
    ~OAIEventTypeFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventTypeFilter)

#endif // OAIEventTypeFilter_H
