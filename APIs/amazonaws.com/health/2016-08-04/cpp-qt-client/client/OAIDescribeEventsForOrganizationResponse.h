...
/*
 * OAIDescribeEventsForOrganizationResponse.h
 *
 * 
 */

#ifndef OAIDescribeEventsForOrganizationResponse_H
#define OAIDescribeEventsForOrganizationResponse_H
...
class OAIDescribeEventsForOrganizationResponse : public OAIObject {
public:
    OAIDescribeEventsForOrganizationResponse();
    OAIDescribeEventsForOrganizationResponse(QString json);
    ~OAIDescribeEventsForOrganizationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEventsForOrganizationResponse)

#endif // OAIDescribeEventsForOrganizationResponse_H
