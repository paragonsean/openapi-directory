...
OAIDescribeEventAggregatesRequest_filter OAIDescribeEventsRequest::getFilter() const {
    return m_filter;
}
void OAIDescribeEventsRequest::setFilter(const OAIDescribeEventAggregatesRequest_filter &filter) {
    m_filter = filter;
    m_filter_isSet = true;
}

bool OAIDescribeEventsRequest::is_filter_Set() const{
    return m_filter_isSet;
}

bool OAIDescribeEventsRequest::is_filter_Valid() const{
...
QString OAIDescribeEventsRequest::getLocale() const {
    return m_locale;
}
void OAIDescribeEventsRequest::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIDescribeEventsRequest::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIDescribeEventsRequest::is_locale_Valid() const{
