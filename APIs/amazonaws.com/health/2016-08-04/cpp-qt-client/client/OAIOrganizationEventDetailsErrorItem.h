...
/*
 * OAIOrganizationEventDetailsErrorItem.h
 *
...
#ifndef OAIOrganizationEventDetailsErrorItem_H
#define OAIOrganizationEventDetailsErrorItem_H
...
class OAIOrganizationEventDetailsErrorItem : public OAIObject {
public:
    OAIOrganizationEventDetailsErrorItem();
    OAIOrganizationEventDetailsErrorItem(QString json);
    ~OAIOrganizationEventDetailsErrorItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationEventDetailsErrorItem)

#endif // OAIOrganizationEventDetailsErrorItem_H
