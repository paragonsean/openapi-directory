...
/*
 * OAIDescribeAffectedAccountsForOrganizationRequest.h
 *
 * 
 */

#ifndef OAIDescribeAffectedAccountsForOrganizationRequest_H
#define OAIDescribeAffectedAccountsForOrganizationRequest_H
...
class OAIDescribeAffectedAccountsForOrganizationRequest : public OAIObject {
public:
    OAIDescribeAffectedAccountsForOrganizationRequest();
    OAIDescribeAffectedAccountsForOrganizationRequest(QString json);
    ~OAIDescribeAffectedAccountsForOrganizationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAffectedAccountsForOrganizationRequest)

#endif // OAIDescribeAffectedAccountsForOrganizationRequest_H
