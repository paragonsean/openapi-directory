...
/*
 * OAIDescribeHealthServiceStatusForOrganizationResponse.h
 *
 * 
 */

#ifndef OAIDescribeHealthServiceStatusForOrganizationResponse_H
#define OAIDescribeHealthServiceStatusForOrganizationResponse_H
...
class OAIDescribeHealthServiceStatusForOrganizationResponse : public OAIObject {
public:
    OAIDescribeHealthServiceStatusForOrganizationResponse();
    OAIDescribeHealthServiceStatusForOrganizationResponse(QString json);
    ~OAIDescribeHealthServiceStatusForOrganizationResponse() override;
    ...
    QString getHealthServiceAccessStatusForOrganization() const;
    void setHealthServiceAccessStatusForOrganization(const QString &health_service_access_status_for_organization);
    bool is_health_service_access_status_for_organization_Set() const;
    bool is_health_service_access_status_for_organization_Valid() const;
...
private:
    ...
    QString m_health_service_access_status_for_organization;
    bool m_health_service_access_status_for_organization_isSet;
    bool m_health_service_access_status_for_organization_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeHealthServiceStatusForOrganizationResponse)

#endif // OAIDescribeHealthServiceStatusForOrganizationResponse_H
