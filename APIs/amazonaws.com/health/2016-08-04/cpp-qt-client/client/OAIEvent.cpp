...
QString OAIEvent::getArn() const {
    return m_arn;
}
void OAIEvent::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIEvent::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIEvent::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIEvent::getService() const {
    return m_service;
}
void OAIEvent::setService(const QString &service) {
    m_service = service;
    m_service_isSet = true;
}

bool OAIEvent::is_service_Set() const{
    return m_service_isSet;
}

bool OAIEvent::is_service_Valid() const{
    return m_service_isValid;
}

QString OAIEvent::getEventTypeCode() const {
    return m_event_type_code;
}
void OAIEvent::setEventTypeCode(const QString &event_type_code) {
    m_event_type_code = event_type_code;
    m_event_type_code_isSet = true;
}

bool OAIEvent::is_event_type_code_Set() const{
    return m_event_type_code_isSet;
}

bool OAIEvent::is_event_type_code_Valid() const{
    return m_event_type_code_isValid;
}

OAIEventTypeCategory OAIEvent::getEventTypeCategory() const {
    return m_event_type_category;
}
void OAIEvent::setEventTypeCategory(const OAIEventTypeCategory &event_type_category) {
    m_event_type_category = event_type_category;
    m_event_type_category_isSet = true;
}

bool OAIEvent::is_event_type_category_Set() const{
    return m_event_type_category_isSet;
}

bool OAIEvent::is_event_type_category_Valid() const{
    return m_event_type_category_isValid;
}

QString OAIEvent::getRegion() const {
    return m_region;
}
void OAIEvent::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIEvent::is_region_Set() const{
    return m_region_isSet;
}

bool OAIEvent::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIEvent::getAvailabilityZone() const {
    return m_availability_zone;
}
void OAIEvent::setAvailabilityZone(const QString &availability_zone) {
    m_availability_zone = availability_zone;
    m_availability_zone_isSet = true;
}

bool OAIEvent::is_availability_zone_Set() const{
    return m_availability_zone_isSet;
}

bool OAIEvent::is_availability_zone_Valid() const{
    return m_availability_zone_isValid;
}

QDateTime OAIEvent::getStartTime() const {
    return m_start_time;
}
void OAIEvent::setStartTime(const QDateTime &start_time) {
...
QDateTime OAIEvent::getEndTime() const {
    return m_end_time;
}
void OAIEvent::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
...
QDateTime OAIEvent::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAIEvent::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAIEvent::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAIEvent::is_last_updated_time_Valid() const{
    return m_last_updated_time_isValid;
}

OAIEventStatusCode OAIEvent::getStatusCode() const {
    return m_status_code;
}
void OAIEvent::setStatusCode(const OAIEventStatusCode &status_code) {
    m_status_code = status_code;
    m_status_code_isSet = true;
}

bool OAIEvent::is_status_code_Set() const{
    return m_status_code_isSet;
}

bool OAIEvent::is_status_code_Valid() const{
    return m_status_code_isValid;
}

OAIEventScopeCode OAIEvent::getEventScopeCode() const {
    return m_event_scope_code;
}
void OAIEvent::setEventScopeCode(const OAIEventScopeCode &event_scope_code) {
    m_event_scope_code = event_scope_code;
    m_event_scope_code_isSet = true;
}

bool OAIEvent::is_event_scope_code_Set() const{
    return m_event_scope_code_isSet;
}

bool OAIEvent::is_event_scope_code_Valid() const{
