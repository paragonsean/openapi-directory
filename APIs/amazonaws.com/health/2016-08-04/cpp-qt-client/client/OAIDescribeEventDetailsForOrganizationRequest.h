...
/*
 * OAIDescribeEventDetailsForOrganizationRequest.h
 *
 * 
 */

#ifndef OAIDescribeEventDetailsForOrganizationRequest_H
#define OAIDescribeEventDetailsForOrganizationRequest_H
...
class OAIDescribeEventDetailsForOrganizationRequest : public OAIObject {
public:
    OAIDescribeEventDetailsForOrganizationRequest();
    OAIDescribeEventDetailsForOrganizationRequest(QString json);
    ~OAIDescribeEventDetailsForOrganizationRequest() override;
    ...
    QList getOrganizationEventDetailFilters() const;
    void setOrganizationEventDetailFilters(const QList &organization_event_detail_filters);
    bool is_organization_event_detail_filters_Set() const;
    bool is_organization_event_detail_filters_Valid() const;
...
private:
    ...
    QList m_organization_event_detail_filters;
    bool m_organization_event_detail_filters_isSet;
    bool m_organization_event_detail_filters_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEventDetailsForOrganizationRequest)

#endif // OAIDescribeEventDetailsForOrganizationRequest_H
