...
#include "OAIEventAccountFilter.h"
...
OAIEventAccountFilter::OAIEventAccountFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventAccountFilter::OAIEventAccountFilter() {
    this->initializeModel();
}

OAIEventAccountFilter::~OAIEventAccountFilter() {}

void OAIEventAccountFilter::initializeModel() {
...
void OAIEventAccountFilter::fromJson(QString jsonString) {
...
void OAIEventAccountFilter::fromJsonObject(QJsonObject json) {
...
QString OAIEventAccountFilter::asJson() const {
...
QJsonObject OAIEventAccountFilter::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEventAccountFilter::getEventArn() const {
    return m_event_arn;
}
void OAIEventAccountFilter::setEventArn(const QString &event_arn) {
    m_event_arn = event_arn;
    m_event_arn_isSet = true;
}

bool OAIEventAccountFilter::is_event_arn_Set() const{
    return m_event_arn_isSet;
}

bool OAIEventAccountFilter::is_event_arn_Valid() const{
    return m_event_arn_isValid;
}

QString OAIEventAccountFilter::getAwsAccountId() const {
    return m_aws_account_id;
}
void OAIEventAccountFilter::setAwsAccountId(const QString &aws_account_id) {
    m_aws_account_id = aws_account_id;
    m_aws_account_id_isSet = true;
}

bool OAIEventAccountFilter::is_aws_account_id_Set() const{
    return m_aws_account_id_isSet;
}

bool OAIEventAccountFilter::is_aws_account_id_Valid() const{
    return m_aws_account_id_isValid;
}

bool OAIEventAccountFilter::isSet() const {
...
bool OAIEventAccountFilter::isValid() const {
