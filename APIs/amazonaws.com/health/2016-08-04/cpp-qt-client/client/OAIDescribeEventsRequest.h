...
#include "OAIDescribeEventAggregatesRequest_filter.h"
#include <QString>
...
namespace OpenAPI {
class OAIDescribeEventAggregatesRequest_filter;
...
public:
    ...
    OAIDescribeEventAggregatesRequest_filter getFilter() const;
    void setFilter(const OAIDescribeEventAggregatesRequest_filter &filter);
...
private:
    ...
    OAIDescribeEventAggregatesRequest_filter m_filter;
    bool m_filter_isSet;
