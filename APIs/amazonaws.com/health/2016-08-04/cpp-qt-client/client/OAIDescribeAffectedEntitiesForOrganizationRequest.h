...
/*
 * OAIDescribeAffectedEntitiesForOrganizationRequest.h
 *
 * 
 */

#ifndef OAIDescribeAffectedEntitiesForOrganizationRequest_H
#define OAIDescribeAffectedEntitiesForOrganizationRequest_H
...
class OAIDescribeAffectedEntitiesForOrganizationRequest : public OAIObject {
public:
    OAIDescribeAffectedEntitiesForOrganizationRequest();
    OAIDescribeAffectedEntitiesForOrganizationRequest(QString json);
    ~OAIDescribeAffectedEntitiesForOrganizationRequest() override;
    ...
    QList getOrganizationEntityFilters() const;
    void setOrganizationEntityFilters(const QList &organization_entity_filters);
    bool is_organization_entity_filters_Set() const;
    bool is_organization_entity_filters_Valid() const;
...
private:
    ...
    QList m_organization_entity_filters;
    bool m_organization_entity_filters_isSet;
    bool m_organization_entity_filters_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAffectedEntitiesForOrganizationRequest)

#endif // OAIDescribeAffectedEntitiesForOrganizationRequest_H
