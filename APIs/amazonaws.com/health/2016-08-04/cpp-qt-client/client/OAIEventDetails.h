...
#ifndef OAIEventDetails_H
#define OAIEventDetails_H
...
namespace OpenAPI {
class OAIEventDetails_event;
class OAIEventDetails_eventDescription;

class OAIEventDetails : public OAIObject {
public:
    OAIEventDetails();
    OAIEventDetails(QString json);
    ~OAIEventDetails() override;
    ...
    OAIEventDetails_event getEvent() const;
    void setEvent(const OAIEventDetails_event &event);
    bool is_event_Set() const;
    bool is_event_Valid() const;

    OAIEventDetails_eventDescription getEventDescription() const;
    void setEventDescription(const OAIEventDetails_eventDescription &event_description);
...
private:
    ...
    OAIEventDetails_event m_event;
    bool m_event_isSet;
    bool m_event_isValid;

    OAIEventDetails_eventDescription m_event_description;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventDetails)

#endif // OAIEventDetails_H
