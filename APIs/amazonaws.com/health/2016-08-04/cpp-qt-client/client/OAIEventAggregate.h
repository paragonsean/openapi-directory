...
#ifndef OAIEventAggregate_H
#define OAIEventAggregate_H
...
class OAIEventAggregate : public OAIObject {
public:
    OAIEventAggregate();
    OAIEventAggregate(QString json);
    ~OAIEventAggregate() override;
    ...
    QString getAggregateValue() const;
    void setAggregateValue(const QString &aggregate_value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventAggregate)

#endif // OAIEventAggregate_H
