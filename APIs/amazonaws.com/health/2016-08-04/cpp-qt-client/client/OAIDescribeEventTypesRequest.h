...
/*
 * OAIDescribeEventTypesRequest.h
 *
 * 
 */

#ifndef OAIDescribeEventTypesRequest_H
#define OAIDescribeEventTypesRequest_H

#include <QJsonObject>

#include "OAIDescribeEventTypesRequest_filter.h"
#include <QString>
...
namespace OpenAPI {
class OAIDescribeEventTypesRequest_filter;

class OAIDescribeEventTypesRequest : public OAIObject {
public:
    OAIDescribeEventTypesRequest();
    OAIDescribeEventTypesRequest(QString json);
    ~OAIDescribeEventTypesRequest() override;
    ...
    OAIDescribeEventTypesRequest_filter getFilter() const;
    void setFilter(const OAIDescribeEventTypesRequest_filter &filter);
...
private:
    ...
    OAIDescribeEventTypesRequest_filter m_filter;
    bool m_filter_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEventTypesRequest)

#endif // OAIDescribeEventTypesRequest_H
