...
/*
 * OAIEventDetails_eventDescription.h
 *
 * 
 */

#ifndef OAIEventDetails_eventDescription_H
#define OAIEventDetails_eventDescription_H
...
class OAIEventDetails_eventDescription : public OAIObject {
public:
    OAIEventDetails_eventDescription();
    OAIEventDetails_eventDescription(QString json);
    ~OAIEventDetails_eventDescription() override;
    ...
    QString getLatestDescription() const;
    void setLatestDescription(const QString &latest_description);
    bool is_latest_description_Set() const;
    bool is_latest_description_Valid() const;
...
private:
    ...
    QString m_latest_description;
    bool m_latest_description_isSet;
    bool m_latest_description_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEventDetails_eventDescription)

#endif // OAIEventDetails_eventDescription_H
