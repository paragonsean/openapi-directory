...
#include "OAIEventAggregateField.h"
...
OAIEventAggregateField::OAIEventAggregateField(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventAggregateField::OAIEventAggregateField() {
    this->initializeModel();
}

OAIEventAggregateField::~OAIEventAggregateField() {}

void OAIEventAggregateField::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEventAggregateField::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEventAggregateField::fromJson(QString jsonString) {
    
    if ( jsonString.compare("eventTypeCategory", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventAggregateField::EVENTTYPECATEGORY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEventAggregateField::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEventAggregateField::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEventAggregateField::EVENTTYPECATEGORY:
            val = "eventTypeCategory";
            break;
        default:
            break;
    }
...
QJsonValue OAIEventAggregateField::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEventAggregateField::eOAIEventAggregateField OAIEventAggregateField::getValue() const {
    return m_value;
}

void OAIEventAggregateField::setValue(const OAIEventAggregateField::eOAIEventAggregateField& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEventAggregateField::isSet() const {
    
    return m_value_isSet;
}

bool OAIEventAggregateField::isValid() const {
