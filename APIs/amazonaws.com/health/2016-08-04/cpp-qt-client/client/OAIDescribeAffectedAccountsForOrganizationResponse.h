...
/*
 * OAIDescribeAffectedAccountsForOrganizationResponse.h
 *
 * 
 */

#ifndef OAIDescribeAffectedAccountsForOrganizationResponse_H
#define OAIDescribeAffectedAccountsForOrganizationResponse_H
...
class OAIDescribeAffectedAccountsForOrganizationResponse : public OAIObject {
public:
    OAIDescribeAffectedAccountsForOrganizationResponse();
    OAIDescribeAffectedAccountsForOrganizationResponse(QString json);
    ~OAIDescribeAffectedAccountsForOrganizationResponse() override;
    ...
    QList getAffectedAccounts() const;
    void setAffectedAccounts(const QList &affected_accounts);
    bool is_affected_accounts_Set() const;
    bool is_affected_accounts_Valid() const;
...
private:
    ...
    QList m_affected_accounts;
    bool m_affected_accounts_isSet;
    bool m_affected_accounts_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAffectedAccountsForOrganizationResponse)

#endif // OAIDescribeAffectedAccountsForOrganizationResponse_H
