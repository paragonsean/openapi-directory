...
OAIDescribeEventDetailsRequest::OAIDescribeEventDetailsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEventDetailsRequest::OAIDescribeEventDetailsRequest() {
    this->initializeModel();
}

OAIDescribeEventDetailsRequest::~OAIDescribeEventDetailsRequest() {}

void OAIDescribeEventDetailsRequest::initializeModel() {
...
void OAIDescribeEventDetailsRequest::fromJson(QString jsonString) {
...
void OAIDescribeEventDetailsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeEventDetailsRequest::asJson() const {
...
QJsonObject OAIDescribeEventDetailsRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeEventDetailsRequest::getEventArns() const {
    return m_event_arns;
}
void OAIDescribeEventDetailsRequest::setEventArns(const QList &event_arns) {
    m_event_arns = event_arns;
    m_event_arns_isSet = true;
}

bool OAIDescribeEventDetailsRequest::is_event_arns_Set() const{
    return m_event_arns_isSet;
}

bool OAIDescribeEventDetailsRequest::is_event_arns_Valid() const{
    return m_event_arns_isValid;
}

QString OAIDescribeEventDetailsRequest::getLocale() const {
    return m_locale;
}
void OAIDescribeEventDetailsRequest::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIDescribeEventDetailsRequest::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIDescribeEventDetailsRequest::is_locale_Valid() const{
    return m_locale_isValid;
}

bool OAIDescribeEventDetailsRequest::isSet() const {
...
bool OAIDescribeEventDetailsRequest::isValid() const {
