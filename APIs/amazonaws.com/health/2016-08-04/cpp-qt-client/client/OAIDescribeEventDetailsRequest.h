...
/*
 * OAIDescribeEventDetailsRequest.h
 *
 * 
 */

#ifndef OAIDescribeEventDetailsRequest_H
#define OAIDescribeEventDetailsRequest_H
...
class OAIDescribeEventDetailsRequest : public OAIObject {
public:
    OAIDescribeEventDetailsRequest();
    OAIDescribeEventDetailsRequest(QString json);
    ~OAIDescribeEventDetailsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEventDetailsRequest)

#endif // OAIDescribeEventDetailsRequest_H
