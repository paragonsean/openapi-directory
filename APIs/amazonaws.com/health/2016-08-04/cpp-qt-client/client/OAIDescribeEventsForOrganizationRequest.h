...
/*
 * OAIDescribeEventsForOrganizationRequest.h
 *
 * 
 */

#ifndef OAIDescribeEventsForOrganizationRequest_H
#define OAIDescribeEventsForOrganizationRequest_H
...
namespace OpenAPI {
class OAIDescribeEventsForOrganizationRequest_filter;

class OAIDescribeEventsForOrganizationRequest : public OAIObject {
public:
    OAIDescribeEventsForOrganizationRequest();
    OAIDescribeEventsForOrganizationRequest(QString json);
    ~OAIDescribeEventsForOrganizationRequest() override;
    ...
    OAIDescribeEventsForOrganizationRequest_filter getFilter() const;
    void setFilter(const OAIDescribeEventsForOrganizationRequest_filter &filter);
...
private:
    ...
    OAIDescribeEventsForOrganizationRequest_filter m_filter;
    bool m_filter_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEventsForOrganizationRequest)

#endif // OAIDescribeEventsForOrganizationRequest_H
