...
/*
 * OAIDescribeEventAggregatesRequest.h
 *
 * 
 */

#ifndef OAIDescribeEventAggregatesRequest_H
#define OAIDescribeEventAggregatesRequest_H
...
class OAIDescribeEventAggregatesRequest : public OAIObject {
public:
    OAIDescribeEventAggregatesRequest();
    OAIDescribeEventAggregatesRequest(QString json);
    ~OAIDescribeEventAggregatesRequest() override;
    ...
    OAIEventAggregateField getAggregateField() const;
    void setAggregateField(const OAIEventAggregateField &aggregate_field);
    bool is_aggregate_field_Set() const;
    bool is_aggregate_field_Valid() const;
...
private:
    ...
    OAIEventAggregateField m_aggregate_field;
    bool m_aggregate_field_isSet;
    bool m_aggregate_field_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEventAggregatesRequest)

#endif // OAIDescribeEventAggregatesRequest_H
