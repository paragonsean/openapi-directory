...
QString OAIEventDescription::getLatestDescription() const {
    return m_latest_description;
}
void OAIEventDescription::setLatestDescription(const QString &latest_description) {
    m_latest_description = latest_description;
    m_latest_description_isSet = true;
}

bool OAIEventDescription::is_latest_description_Set() const{
    return m_latest_description_isSet;
}

bool OAIEventDescription::is_latest_description_Valid() const{
