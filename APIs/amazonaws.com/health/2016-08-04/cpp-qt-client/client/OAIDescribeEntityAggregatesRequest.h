...
/*
 * OAIDescribeEntityAggregatesRequest.h
 *
 * 
 */

#ifndef OAIDescribeEntityAggregatesRequest_H
#define OAIDescribeEntityAggregatesRequest_H
...
class OAIDescribeEntityAggregatesRequest : public OAIObject {
public:
    OAIDescribeEntityAggregatesRequest();
    OAIDescribeEntityAggregatesRequest(QString json);
    ~OAIDescribeEntityAggregatesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEntityAggregatesRequest)

#endif // OAIDescribeEntityAggregatesRequest_H
