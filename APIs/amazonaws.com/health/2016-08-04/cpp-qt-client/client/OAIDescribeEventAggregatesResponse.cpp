...
OAIDescribeEventAggregatesResponse::OAIDescribeEventAggregatesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEventAggregatesResponse::OAIDescribeEventAggregatesResponse() {
    this->initializeModel();
}

OAIDescribeEventAggregatesResponse::~OAIDescribeEventAggregatesResponse() {}

void OAIDescribeEventAggregatesResponse::initializeModel() {

    m_event_aggregates_isSet = false;
    m_event_aggregates_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIDescribeEventAggregatesResponse::fromJson(QString jsonString) {
...
void OAIDescribeEventAggregatesResponse::fromJsonObject(QJsonObject json) {

    m_event_aggregates_isValid = ::OpenAPI::fromJsonValue(m_event_aggregates, json[QString("eventAggregates")]);
    m_event_aggregates_isSet = !json[QString("eventAggregates")].isNull() && m_event_aggregates_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIDescribeEventAggregatesResponse::asJson() const {
...
QJsonObject OAIDescribeEventAggregatesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_event_aggregates.isSet()) {
        obj.insert(QString("eventAggregates"), ::OpenAPI::toJsonValue(m_event_aggregates));
    }
...
QList OAIDescribeEventAggregatesResponse::getEventAggregates() const {
    return m_event_aggregates;
}
void OAIDescribeEventAggregatesResponse::setEventAggregates(const QList &event_aggregates) {
    m_event_aggregates = event_aggregates;
    m_event_aggregates_isSet = true;
}

bool OAIDescribeEventAggregatesResponse::is_event_aggregates_Set() const{
    return m_event_aggregates_isSet;
}

bool OAIDescribeEventAggregatesResponse::is_event_aggregates_Valid() const{
    return m_event_aggregates_isValid;
}

QString OAIDescribeEventAggregatesResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeEventAggregatesResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeEventAggregatesResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeEventAggregatesResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeEventAggregatesResponse::isSet() const {
...
bool OAIDescribeEventAggregatesResponse::isValid() const {
