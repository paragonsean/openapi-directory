...
/*
 * OAIDescribeEventTypesResponse.h
 *
 * 
 */

#ifndef OAIDescribeEventTypesResponse_H
#define OAIDescribeEventTypesResponse_H
...
class OAIDescribeEventTypesResponse : public OAIObject {
public:
    OAIDescribeEventTypesResponse();
    OAIDescribeEventTypesResponse(QString json);
    ~OAIDescribeEventTypesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEventTypesResponse)

#endif // OAIDescribeEventTypesResponse_H
