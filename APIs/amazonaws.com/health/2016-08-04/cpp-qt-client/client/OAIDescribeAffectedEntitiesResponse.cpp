...
OAIDescribeAffectedEntitiesResponse::OAIDescribeAffectedEntitiesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAffectedEntitiesResponse::OAIDescribeAffectedEntitiesResponse() {
    this->initializeModel();
}

OAIDescribeAffectedEntitiesResponse::~OAIDescribeAffectedEntitiesResponse() {}

void OAIDescribeAffectedEntitiesResponse::initializeModel() {
...
void OAIDescribeAffectedEntitiesResponse::fromJson(QString jsonString) {
...
void OAIDescribeAffectedEntitiesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeAffectedEntitiesResponse::asJson() const {
...
QJsonObject OAIDescribeAffectedEntitiesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_entities.isSet()) {
...
QList OAIDescribeAffectedEntitiesResponse::getEntities() const {
    return m_entities;
}
void OAIDescribeAffectedEntitiesResponse::setEntities(const QList &entities) {
    m_entities = entities;
    m_entities_isSet = true;
}

bool OAIDescribeAffectedEntitiesResponse::is_entities_Set() const{
    return m_entities_isSet;
}

bool OAIDescribeAffectedEntitiesResponse::is_entities_Valid() const{
    return m_entities_isValid;
}

QString OAIDescribeAffectedEntitiesResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeAffectedEntitiesResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeAffectedEntitiesResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeAffectedEntitiesResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeAffectedEntitiesResponse::isSet() const {
...
bool OAIDescribeAffectedEntitiesResponse::isValid() const {
