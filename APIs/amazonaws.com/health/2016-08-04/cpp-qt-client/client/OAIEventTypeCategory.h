...
/*
 * OAIEventTypeCategory.h
 *
 * 
 */

#ifndef OAIEventTypeCategory_H
#define OAIEventTypeCategory_H
...
class OAIEventTypeCategory : public OAIEnum {
public:
    OAIEventTypeCategory();
    OAIEventTypeCategory(QString json);
    ~OAIEventTypeCategory() override;
    ...
    enum class eOAIEventTypeCategory {
    ...
    OAIEventTypeCategory::eOAIEventTypeCategory getValue() const;
    void setValue(const OAIEventTypeCategory::eOAIEventTypeCategory& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventTypeCategory)

#endif // OAIEventTypeCategory_H
