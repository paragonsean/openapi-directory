...
OAIEventDetails::OAIEventDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventDetails::OAIEventDetails() {
    this->initializeModel();
}

OAIEventDetails::~OAIEventDetails() {}

void OAIEventDetails::initializeModel() {
...
void OAIEventDetails::fromJson(QString jsonString) {
...
void OAIEventDetails::fromJsonObject(QJsonObject json) {
...
QString OAIEventDetails::asJson() const {
...
QJsonObject OAIEventDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_event.isSet()) {
...
OAIEventDetails_event OAIEventDetails::getEvent() const {
    return m_event;
}
void OAIEventDetails::setEvent(const OAIEventDetails_event &event) {
    m_event = event;
    m_event_isSet = true;
}

bool OAIEventDetails::is_event_Set() const{
    return m_event_isSet;
}

bool OAIEventDetails::is_event_Valid() const{
    return m_event_isValid;
}

OAIEventDetails_eventDescription OAIEventDetails::getEventDescription() const {
    return m_event_description;
}
void OAIEventDetails::setEventDescription(const OAIEventDetails_eventDescription &event_description) {
    m_event_description = event_description;
    m_event_description_isSet = true;
}

bool OAIEventDetails::is_event_description_Set() const{
    return m_event_description_isSet;
}

bool OAIEventDetails::is_event_description_Valid() const{
    return m_event_description_isValid;
}

QMap OAIEventDetails::getEventMetadata() const {
    return m_event_metadata;
}
void OAIEventDetails::setEventMetadata(const QMap &event_metadata) {
    m_event_metadata = event_metadata;
    m_event_metadata_isSet = true;
}

bool OAIEventDetails::is_event_metadata_Set() const{
    return m_event_metadata_isSet;
}

bool OAIEventDetails::is_event_metadata_Valid() const{
    return m_event_metadata_isValid;
}

bool OAIEventDetails::isSet() const {
...
bool OAIEventDetails::isValid() const {
