...
OAIDescribeEventTypesRequest::OAIDescribeEventTypesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEventTypesRequest::OAIDescribeEventTypesRequest() {
    this->initializeModel();
}

OAIDescribeEventTypesRequest::~OAIDescribeEventTypesRequest() {}

void OAIDescribeEventTypesRequest::initializeModel() {
...
void OAIDescribeEventTypesRequest::fromJson(QString jsonString) {
...
void OAIDescribeEventTypesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeEventTypesRequest::asJson() const {
...
QJsonObject OAIDescribeEventTypesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_filter.isSet()) {
...
OAIDescribeEventTypesRequest_filter OAIDescribeEventTypesRequest::getFilter() const {
    return m_filter;
}
void OAIDescribeEventTypesRequest::setFilter(const OAIDescribeEventTypesRequest_filter &filter) {
    m_filter = filter;
    m_filter_isSet = true;
}

bool OAIDescribeEventTypesRequest::is_filter_Set() const{
    return m_filter_isSet;
}

bool OAIDescribeEventTypesRequest::is_filter_Valid() const{
    return m_filter_isValid;
}

QString OAIDescribeEventTypesRequest::getLocale() const {
    return m_locale;
}
void OAIDescribeEventTypesRequest::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIDescribeEventTypesRequest::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIDescribeEventTypesRequest::is_locale_Valid() const{
    return m_locale_isValid;
}

QString OAIDescribeEventTypesRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeEventTypesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeEventTypesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeEventTypesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIDescribeEventTypesRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeEventTypesRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeEventTypesRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeEventTypesRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIDescribeEventTypesRequest::isSet() const {
...
bool OAIDescribeEventTypesRequest::isValid() const {
