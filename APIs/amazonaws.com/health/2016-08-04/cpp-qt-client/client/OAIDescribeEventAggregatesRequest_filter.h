...
/*
 * OAIDescribeEventAggregatesRequest_filter.h
 *
 * 
 */

#ifndef OAIDescribeEventAggregatesRequest_filter_H
#define OAIDescribeEventAggregatesRequest_filter_H
...
class OAIDescribeEventAggregatesRequest_filter : public OAIObject {
public:
    OAIDescribeEventAggregatesRequest_filter();
    OAIDescribeEventAggregatesRequest_filter(QString json);
    ~OAIDescribeEventAggregatesRequest_filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEventAggregatesRequest_filter)

#endif // OAIDescribeEventAggregatesRequest_filter_H
