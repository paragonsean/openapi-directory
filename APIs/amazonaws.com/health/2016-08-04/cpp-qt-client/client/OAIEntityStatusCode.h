...
/*
 * OAIEntityStatusCode.h
 *
 * 
 */

#ifndef OAIEntityStatusCode_H
#define OAIEntityStatusCode_H
...
class OAIEntityStatusCode : public OAIEnum {
public:
    OAIEntityStatusCode();
    OAIEntityStatusCode(QString json);
    ~OAIEntityStatusCode() override;
    ...
    enum class eOAIEntityStatusCode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        IMPAIRED, 
        UNIMPAIRED, 
        UNKNOWN
    };
    OAIEntityStatusCode::eOAIEntityStatusCode getValue() const;
    void setValue(const OAIEntityStatusCode::eOAIEntityStatusCode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityStatusCode)

#endif // OAIEntityStatusCode_H
