...
OAIDescribeEventsForOrganizationRequest::OAIDescribeEventsForOrganizationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEventsForOrganizationRequest::OAIDescribeEventsForOrganizationRequest() {
    this->initializeModel();
}

OAIDescribeEventsForOrganizationRequest::~OAIDescribeEventsForOrganizationRequest() {}

void OAIDescribeEventsForOrganizationRequest::initializeModel() {
...
void OAIDescribeEventsForOrganizationRequest::fromJson(QString jsonString) {
...
void OAIDescribeEventsForOrganizationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeEventsForOrganizationRequest::asJson() const {
...
QJsonObject OAIDescribeEventsForOrganizationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_filter.isSet()) {
...
OAIDescribeEventsForOrganizationRequest_filter OAIDescribeEventsForOrganizationRequest::getFilter() const {
    return m_filter;
}
void OAIDescribeEventsForOrganizationRequest::setFilter(const OAIDescribeEventsForOrganizationRequest_filter &filter) {
    m_filter = filter;
    m_filter_isSet = true;
}

bool OAIDescribeEventsForOrganizationRequest::is_filter_Set() const{
    return m_filter_isSet;
}

bool OAIDescribeEventsForOrganizationRequest::is_filter_Valid() const{
    return m_filter_isValid;
}

QString OAIDescribeEventsForOrganizationRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeEventsForOrganizationRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeEventsForOrganizationRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeEventsForOrganizationRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIDescribeEventsForOrganizationRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeEventsForOrganizationRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeEventsForOrganizationRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeEventsForOrganizationRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeEventsForOrganizationRequest::getLocale() const {
    return m_locale;
}
void OAIDescribeEventsForOrganizationRequest::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIDescribeEventsForOrganizationRequest::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIDescribeEventsForOrganizationRequest::is_locale_Valid() const{
    return m_locale_isValid;
}

bool OAIDescribeEventsForOrganizationRequest::isSet() const {
...
bool OAIDescribeEventsForOrganizationRequest::isValid() const {
