...
OAIDescribeEntityAggregatesRequest::OAIDescribeEntityAggregatesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEntityAggregatesRequest::OAIDescribeEntityAggregatesRequest() {
    this->initializeModel();
}

OAIDescribeEntityAggregatesRequest::~OAIDescribeEntityAggregatesRequest() {}

void OAIDescribeEntityAggregatesRequest::initializeModel() {

    m_event_arns_isSet = false;
    m_event_arns_isValid = false;
}

void OAIDescribeEntityAggregatesRequest::fromJson(QString jsonString) {
...
void OAIDescribeEntityAggregatesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeEntityAggregatesRequest::asJson() const {
...
QJsonObject OAIDescribeEntityAggregatesRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeEntityAggregatesRequest::getEventArns() const {
    return m_event_arns;
}
void OAIDescribeEntityAggregatesRequest::setEventArns(const QList &event_arns) {
    m_event_arns = event_arns;
    m_event_arns_isSet = true;
}

bool OAIDescribeEntityAggregatesRequest::is_event_arns_Set() const{
    return m_event_arns_isSet;
}

bool OAIDescribeEntityAggregatesRequest::is_event_arns_Valid() const{
    return m_event_arns_isValid;
}

bool OAIDescribeEntityAggregatesRequest::isSet() const {
...
bool OAIDescribeEntityAggregatesRequest::isValid() const {
