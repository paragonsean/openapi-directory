...
/*
 * OAIEventStatusCode.h
 *
 * 
 */

#ifndef OAIEventStatusCode_H
#define OAIEventStatusCode_H
...
class OAIEventStatusCode : public OAIEnum {
public:
    OAIEventStatusCode();
    OAIEventStatusCode(QString json);
    ~OAIEventStatusCode() override;
    ...
    enum class eOAIEventStatusCode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        OPEN, 
        CLOSED, 
        UPCOMING
    };
    OAIEventStatusCode::eOAIEventStatusCode getValue() const;
    void setValue(const OAIEventStatusCode::eOAIEventStatusCode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventStatusCode)

#endif // OAIEventStatusCode_H
