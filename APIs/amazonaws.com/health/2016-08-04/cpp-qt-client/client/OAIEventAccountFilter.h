...
#ifndef OAIEventAccountFilter_H
#define OAIEventAccountFilter_H
...
class OAIEventAccountFilter : public OAIObject {
public:
    OAIEventAccountFilter();
    OAIEventAccountFilter(QString json);
    ~OAIEventAccountFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventAccountFilter)

#endif // OAIEventAccountFilter_H
