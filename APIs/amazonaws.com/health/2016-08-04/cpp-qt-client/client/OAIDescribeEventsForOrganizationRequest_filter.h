...
/*
 * OAIDescribeEventsForOrganizationRequest_filter.h
 *
 * 
 */

#ifndef OAIDescribeEventsForOrganizationRequest_filter_H
#define OAIDescribeEventsForOrganizationRequest_filter_H
...
class OAIDescribeEventsForOrganizationRequest_filter : public OAIObject {
public:
    OAIDescribeEventsForOrganizationRequest_filter();
    OAIDescribeEventsForOrganizationRequest_filter(QString json);
    ~OAIDescribeEventsForOrganizationRequest_filter() override;
    ...
    QList getAwsAccountIds() const;
    void setAwsAccountIds(const QList &aws_account_ids);
    bool is_aws_account_ids_Set() const;
    bool is_aws_account_ids_Valid() const;
    ...
    OAIDateTimeRange getStartTime() const;
    void setStartTime(const OAIDateTimeRange &start_time);
    bool is_start_time_Set() const;
    bool is_start_time_Valid() const;

    OAIDateTimeRange getEndTime() const;
    void setEndTime(const OAIDateTimeRange &end_time);
    bool is_end_time_Set() const;
    bool is_end_time_Valid() const;

    OAIDateTimeRange getLastUpdatedTime() const;
    void setLastUpdatedTime(const OAIDateTimeRange &last_updated_time);
...
private:
    ...
    QList m_aws_account_ids;
    bool m_aws_account_ids_isSet;
    bool m_aws_account_ids_isValid;
    ...
    OAIDateTimeRange m_start_time;
    bool m_start_time_isSet;
    bool m_start_time_isValid;

    OAIDateTimeRange m_end_time;
    bool m_end_time_isSet;
    bool m_end_time_isValid;

    OAIDateTimeRange m_last_updated_time;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEventsForOrganizationRequest_filter)

#endif // OAIDescribeEventsForOrganizationRequest_filter_H
