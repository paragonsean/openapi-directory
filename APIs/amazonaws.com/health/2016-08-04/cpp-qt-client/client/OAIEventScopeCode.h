...
#ifndef OAIEventScopeCode_H
#define OAIEventScopeCode_H
...
class OAIEventScopeCode : public OAIEnum {
public:
    OAIEventScopeCode();
    OAIEventScopeCode(QString json);
    ~OAIEventScopeCode() override;
    ...
    enum class eOAIEventScopeCode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PUBLIC, 
        ACCOUNT_SPECIFIC, 
        NONE
    };
    OAIEventScopeCode::eOAIEventScopeCode getValue() const;
    void setValue(const OAIEventScopeCode::eOAIEventScopeCode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventScopeCode)

#endif // OAIEventScopeCode_H
