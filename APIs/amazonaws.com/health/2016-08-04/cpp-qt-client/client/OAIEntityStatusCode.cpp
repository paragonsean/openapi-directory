...
OAIEntityStatusCode::OAIEntityStatusCode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntityStatusCode::OAIEntityStatusCode() {
    this->initializeModel();
}

OAIEntityStatusCode::~OAIEntityStatusCode() {}

void OAIEntityStatusCode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEntityStatusCode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEntityStatusCode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("IMPAIRED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEntityStatusCode::IMPAIRED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UNIMPAIRED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEntityStatusCode::UNIMPAIRED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UNKNOWN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEntityStatusCode::UNKNOWN;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEntityStatusCode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEntityStatusCode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEntityStatusCode::IMPAIRED:
            val = "IMPAIRED";
            break;
        case eOAIEntityStatusCode::UNIMPAIRED:
            val = "UNIMPAIRED";
            break;
        case eOAIEntityStatusCode::UNKNOWN:
            val = "UNKNOWN";
            break;
        default:
            break;
...
QJsonValue OAIEntityStatusCode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEntityStatusCode::eOAIEntityStatusCode OAIEntityStatusCode::getValue() const {
    return m_value;
}

void OAIEntityStatusCode::setValue(const OAIEntityStatusCode::eOAIEntityStatusCode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEntityStatusCode::isSet() const {
    
    return m_value_isSet;
}

bool OAIEntityStatusCode::isValid() const {
