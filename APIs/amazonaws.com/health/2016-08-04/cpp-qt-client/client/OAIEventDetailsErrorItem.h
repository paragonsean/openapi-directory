...
#ifndef OAIEventDetailsErrorItem_H
#define OAIEventDetailsErrorItem_H
...
class OAIEventDetailsErrorItem : public OAIObject {
public:
    OAIEventDetailsErrorItem();
    OAIEventDetailsErrorItem(QString json);
    ~OAIEventDetailsErrorItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventDetailsErrorItem)

#endif // OAIEventDetailsErrorItem_H
