...
OAIEventTypeCategory::OAIEventTypeCategory(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventTypeCategory::OAIEventTypeCategory() {
    this->initializeModel();
}

OAIEventTypeCategory::~OAIEventTypeCategory() {}

void OAIEventTypeCategory::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEventTypeCategory::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEventTypeCategory::fromJson(QString jsonString) {
    
    if ( jsonString.compare("issue", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventTypeCategory::ISSUE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("accountNotification", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventTypeCategory::ACCOUNTNOTIFICATION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("scheduledChange", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventTypeCategory::SCHEDULEDCHANGE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("investigation", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventTypeCategory::INVESTIGATION;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEventTypeCategory::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEventTypeCategory::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEventTypeCategory::ISSUE:
            val = "issue";
            break;
        case eOAIEventTypeCategory::ACCOUNTNOTIFICATION:
            val = "accountNotification";
            break;
        case eOAIEventTypeCategory::SCHEDULEDCHANGE:
            val = "scheduledChange";
            break;
        case eOAIEventTypeCategory::INVESTIGATION:
            val = "investigation";
            break;
        default:
            break;
...
QJsonValue OAIEventTypeCategory::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEventTypeCategory::eOAIEventTypeCategory OAIEventTypeCategory::getValue() const {
    return m_value;
}

void OAIEventTypeCategory::setValue(const OAIEventTypeCategory::eOAIEventTypeCategory& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEventTypeCategory::isSet() const {
    
    return m_value_isSet;
}

bool OAIEventTypeCategory::isValid() const {
