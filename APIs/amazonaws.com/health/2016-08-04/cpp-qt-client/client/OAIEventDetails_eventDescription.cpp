...
#include "OAIEventDetails_eventDescription.h"
...
OAIEventDetails_eventDescription::OAIEventDetails_eventDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventDetails_eventDescription::OAIEventDetails_eventDescription() {
    this->initializeModel();
}

OAIEventDetails_eventDescription::~OAIEventDetails_eventDescription() {}

void OAIEventDetails_eventDescription::initializeModel() {

    m_latest_description_isSet = false;
    m_latest_description_isValid = false;
}

void OAIEventDetails_eventDescription::fromJson(QString jsonString) {
...
void OAIEventDetails_eventDescription::fromJsonObject(QJsonObject json) {

    m_latest_description_isValid = ::OpenAPI::fromJsonValue(m_latest_description, json[QString("latestDescription")]);
    m_latest_description_isSet = !json[QString("latestDescription")].isNull() && m_latest_description_isValid;
}

QString OAIEventDetails_eventDescription::asJson() const {
...
QJsonObject OAIEventDetails_eventDescription::asJsonObject() const {
    QJsonObject obj;
    if (m_latest_description_isSet) {
        obj.insert(QString("latestDescription"), ::OpenAPI::toJsonValue(m_latest_description));
    }
    return obj;
}

QString OAIEventDetails_eventDescription::getLatestDescription() const {
    return m_latest_description;
}
void OAIEventDetails_eventDescription::setLatestDescription(const QString &latest_description) {
    m_latest_description = latest_description;
    m_latest_description_isSet = true;
}

bool OAIEventDetails_eventDescription::is_latest_description_Set() const{
    return m_latest_description_isSet;
}

bool OAIEventDetails_eventDescription::is_latest_description_Valid() const{
    return m_latest_description_isValid;
}

bool OAIEventDetails_eventDescription::isSet() const {
...
bool OAIEventDetails_eventDescription::isValid() const {
