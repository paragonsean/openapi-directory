...
OAIDescribeEventDetailsResponse::OAIDescribeEventDetailsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEventDetailsResponse::OAIDescribeEventDetailsResponse() {
    this->initializeModel();
}

OAIDescribeEventDetailsResponse::~OAIDescribeEventDetailsResponse() {}

void OAIDescribeEventDetailsResponse::initializeModel() {
...
void OAIDescribeEventDetailsResponse::fromJson(QString jsonString) {
...
void OAIDescribeEventDetailsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeEventDetailsResponse::asJson() const {
...
QJsonObject OAIDescribeEventDetailsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeEventDetailsResponse::getSuccessfulSet() const {
    return m_successful_set;
}
void OAIDescribeEventDetailsResponse::setSuccessfulSet(const QList &successful_set) {
    m_successful_set = successful_set;
    m_successful_set_isSet = true;
}

bool OAIDescribeEventDetailsResponse::is_successful_set_Set() const{
    return m_successful_set_isSet;
}

bool OAIDescribeEventDetailsResponse::is_successful_set_Valid() const{
    return m_successful_set_isValid;
}

QList OAIDescribeEventDetailsResponse::getFailedSet() const {
    return m_failed_set;
}
void OAIDescribeEventDetailsResponse::setFailedSet(const QList &failed_set) {
    m_failed_set = failed_set;
    m_failed_set_isSet = true;
}

bool OAIDescribeEventDetailsResponse::is_failed_set_Set() const{
    return m_failed_set_isSet;
}

bool OAIDescribeEventDetailsResponse::is_failed_set_Valid() const{
    return m_failed_set_isValid;
}

bool OAIDescribeEventDetailsResponse::isSet() const {
...
bool OAIDescribeEventDetailsResponse::isValid() const {
