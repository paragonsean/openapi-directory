...
/*
 * OAIDescribeAffectedEntitiesRequest.h
 *
 * 
 */

#ifndef OAIDescribeAffectedEntitiesRequest_H
#define OAIDescribeAffectedEntitiesRequest_H
...
namespace OpenAPI {
class OAIDescribeAffectedEntitiesRequest_filter;

class OAIDescribeAffectedEntitiesRequest : public OAIObject {
public:
    OAIDescribeAffectedEntitiesRequest();
    OAIDescribeAffectedEntitiesRequest(QString json);
    ~OAIDescribeAffectedEntitiesRequest() override;
    ...
    OAIDescribeAffectedEntitiesRequest_filter getFilter() const;
    void setFilter(const OAIDescribeAffectedEntitiesRequest_filter &filter);
...
private:
    ...
    OAIDescribeAffectedEntitiesRequest_filter m_filter;
    bool m_filter_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAffectedEntitiesRequest)

#endif // OAIDescribeAffectedEntitiesRequest_H
