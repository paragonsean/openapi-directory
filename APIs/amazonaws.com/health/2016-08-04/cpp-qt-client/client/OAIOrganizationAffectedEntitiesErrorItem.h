...
/*
 * OAIOrganizationAffectedEntitiesErrorItem.h
 *
...
#ifndef OAIOrganizationAffectedEntitiesErrorItem_H
#define OAIOrganizationAffectedEntitiesErrorItem_H
...
class OAIOrganizationAffectedEntitiesErrorItem : public OAIObject {
public:
    OAIOrganizationAffectedEntitiesErrorItem();
    OAIOrganizationAffectedEntitiesErrorItem(QString json);
    ~OAIOrganizationAffectedEntitiesErrorItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationAffectedEntitiesErrorItem)

#endif // OAIOrganizationAffectedEntitiesErrorItem_H
