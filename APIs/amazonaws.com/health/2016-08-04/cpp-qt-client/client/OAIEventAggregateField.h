...
/*
 * OAIEventAggregateField.h
 *
 * 
 */

#ifndef OAIEventAggregateField_H
#define OAIEventAggregateField_H
...
class OAIEventAggregateField : public OAIEnum {
public:
    OAIEventAggregateField();
    OAIEventAggregateField(QString json);
    ~OAIEventAggregateField() override;
    ...
    enum class eOAIEventAggregateField {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        EVENTTYPECATEGORY
    };
    OAIEventAggregateField::eOAIEventAggregateField getValue() const;
    void setValue(const OAIEventAggregateField::eOAIEventAggregateField& value);
...
private:
    ...
    eOAIEventAggregateField m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventAggregateField)

#endif // OAIEventAggregateField_H
