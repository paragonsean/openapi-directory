...
/*
 * OAIDescribeAffectedEntitiesForOrganizationResponse.h
 *
 * 
 */

#ifndef OAIDescribeAffectedEntitiesForOrganizationResponse_H
#define OAIDescribeAffectedEntitiesForOrganizationResponse_H
...
class OAIDescribeAffectedEntitiesForOrganizationResponse : public OAIObject {
public:
    OAIDescribeAffectedEntitiesForOrganizationResponse();
    OAIDescribeAffectedEntitiesForOrganizationResponse(QString json);
    ~OAIDescribeAffectedEntitiesForOrganizationResponse() override;
    ...
    QList getFailedSet() const;
    void setFailedSet(const QList &failed_set);
    bool is_failed_set_Set() const;
    bool is_failed_set_Valid() const;
...
private:
    ...
    QList m_failed_set;
    bool m_failed_set_isSet;
    bool m_failed_set_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAffectedEntitiesForOrganizationResponse)

#endif // OAIDescribeAffectedEntitiesForOrganizationResponse_H
