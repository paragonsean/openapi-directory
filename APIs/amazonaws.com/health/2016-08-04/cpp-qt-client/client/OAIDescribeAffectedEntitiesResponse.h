...
/*
 * OAIDescribeAffectedEntitiesResponse.h
 *
 * 
 */

#ifndef OAIDescribeAffectedEntitiesResponse_H
#define OAIDescribeAffectedEntitiesResponse_H
...
class OAIDescribeAffectedEntitiesResponse : public OAIObject {
public:
    OAIDescribeAffectedEntitiesResponse();
    OAIDescribeAffectedEntitiesResponse(QString json);
    ~OAIDescribeAffectedEntitiesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAffectedEntitiesResponse)

#endif // OAIDescribeAffectedEntitiesResponse_H
