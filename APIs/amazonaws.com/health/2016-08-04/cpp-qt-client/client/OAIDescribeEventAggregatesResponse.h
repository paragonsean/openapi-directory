...
/*
 * OAIDescribeEventAggregatesResponse.h
 *
 * 
 */

#ifndef OAIDescribeEventAggregatesResponse_H
#define OAIDescribeEventAggregatesResponse_H
...
class OAIDescribeEventAggregatesResponse : public OAIObject {
public:
    OAIDescribeEventAggregatesResponse();
    OAIDescribeEventAggregatesResponse(QString json);
    ~OAIDescribeEventAggregatesResponse() override;
    ...
    QList getEventAggregates() const;
    void setEventAggregates(const QList &event_aggregates);
    bool is_event_aggregates_Set() const;
    bool is_event_aggregates_Valid() const;
...
private:
    ...
    QList m_event_aggregates;
    bool m_event_aggregates_isSet;
    bool m_event_aggregates_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEventAggregatesResponse)

#endif // OAIDescribeEventAggregatesResponse_H
