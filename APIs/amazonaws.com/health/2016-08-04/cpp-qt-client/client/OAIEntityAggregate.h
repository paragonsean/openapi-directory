...
#ifndef OAIEntityAggregate_H
#define OAIEntityAggregate_H
...
class OAIEntityAggregate : public OAIObject {
public:
    OAIEntityAggregate();
    OAIEntityAggregate(QString json);
    ~OAIEntityAggregate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityAggregate)

#endif // OAIEntityAggregate_H
