...
OAIEventTypeFilter::OAIEventTypeFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventTypeFilter::OAIEventTypeFilter() {
    this->initializeModel();
}

OAIEventTypeFilter::~OAIEventTypeFilter() {}

void OAIEventTypeFilter::initializeModel() {
...
void OAIEventTypeFilter::fromJson(QString jsonString) {
...
void OAIEventTypeFilter::fromJsonObject(QJsonObject json) {
...
QString OAIEventTypeFilter::asJson() const {
...
QJsonObject OAIEventTypeFilter::asJsonObject() const {
    QJsonObject obj;
...
QList OAIEventTypeFilter::getEventTypeCodes() const {
    return m_event_type_codes;
}
void OAIEventTypeFilter::setEventTypeCodes(const QList &event_type_codes) {
    m_event_type_codes = event_type_codes;
    m_event_type_codes_isSet = true;
}

bool OAIEventTypeFilter::is_event_type_codes_Set() const{
    return m_event_type_codes_isSet;
}

bool OAIEventTypeFilter::is_event_type_codes_Valid() const{
    return m_event_type_codes_isValid;
}

QList OAIEventTypeFilter::getServices() const {
    return m_services;
}
void OAIEventTypeFilter::setServices(const QList &services) {
    m_services = services;
    m_services_isSet = true;
}

bool OAIEventTypeFilter::is_services_Set() const{
    return m_services_isSet;
}

bool OAIEventTypeFilter::is_services_Valid() const{
    return m_services_isValid;
}

QList OAIEventTypeFilter::getEventTypeCategories() const {
    return m_event_type_categories;
}
void OAIEventTypeFilter::setEventTypeCategories(const QList &event_type_categories) {
    m_event_type_categories = event_type_categories;
    m_event_type_categories_isSet = true;
}

bool OAIEventTypeFilter::is_event_type_categories_Set() const{
    return m_event_type_categories_isSet;
}

bool OAIEventTypeFilter::is_event_type_categories_Valid() const{
    return m_event_type_categories_isValid;
}

bool OAIEventTypeFilter::isSet() const {
...
bool OAIEventTypeFilter::isValid() const {
