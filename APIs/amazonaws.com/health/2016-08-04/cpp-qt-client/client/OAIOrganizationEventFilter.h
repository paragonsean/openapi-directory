...
#ifndef OAIOrganizationEventFilter_H
#define OAIOrganizationEventFilter_H
...
class OAIOrganizationEventFilter : public OAIObject {
public:
    OAIOrganizationEventFilter();
    OAIOrganizationEventFilter(QString json);
    ~OAIOrganizationEventFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationEventFilter)

#endif // OAIOrganizationEventFilter_H
