...
/*
 * OAIDescribeEventDetailsResponse.h
 *
 * 
 */

#ifndef OAIDescribeEventDetailsResponse_H
#define OAIDescribeEventDetailsResponse_H
...
class OAIDescribeEventDetailsResponse : public OAIObject {
public:
    OAIDescribeEventDetailsResponse();
    OAIDescribeEventDetailsResponse(QString json);
    ~OAIDescribeEventDetailsResponse() override;
    ...
    QList getSuccessfulSet() const;
    void setSuccessfulSet(const QList &successful_set);
    bool is_successful_set_Set() const;
    bool is_successful_set_Valid() const;
...
private:
    ...
    QList m_successful_set;
    bool m_successful_set_isSet;
    bool m_successful_set_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEventDetailsResponse)

#endif // OAIDescribeEventDetailsResponse_H
