...
OAIEventStatusCode::OAIEventStatusCode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventStatusCode::OAIEventStatusCode() {
    this->initializeModel();
}

OAIEventStatusCode::~OAIEventStatusCode() {}

void OAIEventStatusCode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEventStatusCode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEventStatusCode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("open", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventStatusCode::OPEN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("closed", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventStatusCode::CLOSED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("upcoming", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventStatusCode::UPCOMING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEventStatusCode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEventStatusCode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEventStatusCode::OPEN:
            val = "open";
            break;
        case eOAIEventStatusCode::CLOSED:
            val = "closed";
            break;
        case eOAIEventStatusCode::UPCOMING:
            val = "upcoming";
            break;
        default:
            break;
...
QJsonValue OAIEventStatusCode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEventStatusCode::eOAIEventStatusCode OAIEventStatusCode::getValue() const {
    return m_value;
}

void OAIEventStatusCode::setValue(const OAIEventStatusCode::eOAIEventStatusCode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEventStatusCode::isSet() const {
    
    return m_value_isSet;
}

bool OAIEventStatusCode::isValid() const {
