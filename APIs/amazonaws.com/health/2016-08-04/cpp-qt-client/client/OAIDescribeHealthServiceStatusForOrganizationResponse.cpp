...
OAIDescribeHealthServiceStatusForOrganizationResponse::OAIDescribeHealthServiceStatusForOrganizationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeHealthServiceStatusForOrganizationResponse::OAIDescribeHealthServiceStatusForOrganizationResponse() {
    this->initializeModel();
}

OAIDescribeHealthServiceStatusForOrganizationResponse::~OAIDescribeHealthServiceStatusForOrganizationResponse() {}

void OAIDescribeHealthServiceStatusForOrganizationResponse::initializeModel() {

    m_health_service_access_status_for_organization_isSet = false;
    m_health_service_access_status_for_organization_isValid = false;
}

void OAIDescribeHealthServiceStatusForOrganizationResponse::fromJson(QString jsonString) {
...
void OAIDescribeHealthServiceStatusForOrganizationResponse::fromJsonObject(QJsonObject json) {

    m_health_service_access_status_for_organization_isValid = ::OpenAPI::fromJsonValue(m_health_service_access_status_for_organization, json[QString("healthServiceAccessStatusForOrganization")]);
    m_health_service_access_status_for_organization_isSet = !json[QString("healthServiceAccessStatusForOrganization")].isNull() && m_health_service_access_status_for_organization_isValid;
}

QString OAIDescribeHealthServiceStatusForOrganizationResponse::asJson() const {
...
QJsonObject OAIDescribeHealthServiceStatusForOrganizationResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_health_service_access_status_for_organization_isSet) {
        obj.insert(QString("healthServiceAccessStatusForOrganization"), ::OpenAPI::toJsonValue(m_health_service_access_status_for_organization));
    }
    return obj;
}

QString OAIDescribeHealthServiceStatusForOrganizationResponse::getHealthServiceAccessStatusForOrganization() const {
    return m_health_service_access_status_for_organization;
}
void OAIDescribeHealthServiceStatusForOrganizationResponse::setHealthServiceAccessStatusForOrganization(const QString &health_service_access_status_for_organization) {
    m_health_service_access_status_for_organization = health_service_access_status_for_organization;
    m_health_service_access_status_for_organization_isSet = true;
}

bool OAIDescribeHealthServiceStatusForOrganizationResponse::is_health_service_access_status_for_organization_Set() const{
    return m_health_service_access_status_for_organization_isSet;
}

bool OAIDescribeHealthServiceStatusForOrganizationResponse::is_health_service_access_status_for_organization_Valid() const{
    return m_health_service_access_status_for_organization_isValid;
}

bool OAIDescribeHealthServiceStatusForOrganizationResponse::isSet() const {
...
bool OAIDescribeHealthServiceStatusForOrganizationResponse::isValid() const {
