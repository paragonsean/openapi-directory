...
/*
 * OAIDescribeEventTypesRequest_filter.h
 *
 * 
 */

#ifndef OAIDescribeEventTypesRequest_filter_H
#define OAIDescribeEventTypesRequest_filter_H
...
class OAIDescribeEventTypesRequest_filter : public OAIObject {
public:
    OAIDescribeEventTypesRequest_filter();
    OAIDescribeEventTypesRequest_filter(QString json);
    ~OAIDescribeEventTypesRequest_filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEventTypesRequest_filter)

#endif // OAIDescribeEventTypesRequest_filter_H
