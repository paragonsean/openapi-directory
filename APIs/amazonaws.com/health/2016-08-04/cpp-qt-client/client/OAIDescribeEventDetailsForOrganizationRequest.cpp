...
OAIDescribeEventDetailsForOrganizationRequest::OAIDescribeEventDetailsForOrganizationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEventDetailsForOrganizationRequest::OAIDescribeEventDetailsForOrganizationRequest() {
    this->initializeModel();
}

OAIDescribeEventDetailsForOrganizationRequest::~OAIDescribeEventDetailsForOrganizationRequest() {}

void OAIDescribeEventDetailsForOrganizationRequest::initializeModel() {

    m_organization_event_detail_filters_isSet = false;
    m_organization_event_detail_filters_isValid = false;

    m_locale_isSet = false;
    m_locale_isValid = false;
}

void OAIDescribeEventDetailsForOrganizationRequest::fromJson(QString jsonString) {
...
void OAIDescribeEventDetailsForOrganizationRequest::fromJsonObject(QJsonObject json) {

    m_organization_event_detail_filters_isValid = ::OpenAPI::fromJsonValue(m_organization_event_detail_filters, json[QString("organizationEventDetailFilters")]);
    m_organization_event_detail_filters_isSet = !json[QString("organizationEventDetailFilters")].isNull() && m_organization_event_detail_filters_isValid;

    m_locale_isValid = ::OpenAPI::fromJsonValue(m_locale, json[QString("locale")]);
    m_locale_isSet = !json[QString("locale")].isNull() && m_locale_isValid;
}

QString OAIDescribeEventDetailsForOrganizationRequest::asJson() const {
...
QJsonObject OAIDescribeEventDetailsForOrganizationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_organization_event_detail_filters.isSet()) {
        obj.insert(QString("organizationEventDetailFilters"), ::OpenAPI::toJsonValue(m_organization_event_detail_filters));
    }
    if (m_locale_isSet) {
...
QList OAIDescribeEventDetailsForOrganizationRequest::getOrganizationEventDetailFilters() const {
    return m_organization_event_detail_filters;
}
void OAIDescribeEventDetailsForOrganizationRequest::setOrganizationEventDetailFilters(const QList &organization_event_detail_filters) {
    m_organization_event_detail_filters = organization_event_detail_filters;
    m_organization_event_detail_filters_isSet = true;
}

bool OAIDescribeEventDetailsForOrganizationRequest::is_organization_event_detail_filters_Set() const{
    return m_organization_event_detail_filters_isSet;
}

bool OAIDescribeEventDetailsForOrganizationRequest::is_organization_event_detail_filters_Valid() const{
    return m_organization_event_detail_filters_isValid;
}

QString OAIDescribeEventDetailsForOrganizationRequest::getLocale() const {
    return m_locale;
}
void OAIDescribeEventDetailsForOrganizationRequest::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIDescribeEventDetailsForOrganizationRequest::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIDescribeEventDetailsForOrganizationRequest::is_locale_Valid() const{
    return m_locale_isValid;
}

bool OAIDescribeEventDetailsForOrganizationRequest::isSet() const {
...
bool OAIDescribeEventDetailsForOrganizationRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_organization_event_detail_filters_isValid && true;
}
