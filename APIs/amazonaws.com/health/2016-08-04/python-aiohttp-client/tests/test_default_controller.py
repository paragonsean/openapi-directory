...
async def test_describe_affected_accounts_for_organization(client):
    """Test case for describe_affected_accounts_for_organization

    
    """
    body = {"eventArn":"","nextToken":"","maxResults":""}
...
async def test_describe_affected_entities(client):
    """Test case for describe_affected_entities

    
    """
    body = {"filter":{"statusCodes":"","eventArns":"","lastUpdatedTimes":"","entityArns":"","entityValues":"","tags":""},"nextToken":"","maxResults":"","locale":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_describe_affected_entities_for_organization(client):
    """Test case for describe_affected_entities_for_organization

    
    """
    body = {"organizationEntityFilters":"","nextToken":"","maxResults":"","locale":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_describe_entity_aggregates(client):
    """Test case for describe_entity_aggregates
...
async def test_describe_event_aggregates(client):
    """Test case for describe_event_aggregates

    
    """
    body = {"filter":{"regions":"","eventStatusCodes":"","eventTypeCategories":"","eventArns":"","lastUpdatedTimes":"","availabilityZones":"","services":"","entityArns":"","tags":"","endTimes":"","eventTypeCodes":"","entityValues":"","startTimes":""},"aggregateField":"","maxResults":"","nextToken":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_describe_event_details(client):
    """Test case for describe_event_details

    
    """
    body = {"eventArns":"","locale":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_event_details_for_organization(client):
    """Test case for describe_event_details_for_organization

    
    """
    body = {"organizationEventDetailFilters":"","locale":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_event_types(client):
    """Test case for describe_event_types

    
    """
    body = {"filter":{"eventTypeCodes":"","eventTypeCategories":"","services":""},"nextToken":"","maxResults":"","locale":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_describe_events(client):
    ...
    """
    body = {"filter":{"regions":"","eventStatusCodes":"","eventTypeCategories":"","eventArns":"","lastUpdatedTimes":"","availabilityZones":"","services":"","entityArns":"","tags":"","endTimes":"","eventTypeCodes":"","entityValues":"","startTimes":""},"nextToken":"","maxResults":"","locale":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_describe_events_for_organization(client):
    """Test case for describe_events_for_organization

    
    """
    body = {"filter":{"eventTypeCodes":"","regions":"","eventStatusCodes":"","eventTypeCategories":"","startTime":{"from":"","to":""},"lastUpdatedTime":{"from":"","to":""},"services":"","endTime":{"from":"","to":""},"entityArns":"","awsAccountIds":"","entityValues":""},"nextToken":"","maxResults":"","locale":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_describe_health_service_status_for_organization(client):
    """Test case for describe_health_service_status_for_organization
...
async def test_disable_health_service_access_for_organization(client):
    """Test case for disable_health_service_access_for_organization
...
async def test_enable_health_service_access_for_organization(client):
    """Test case for enable_health_service_access_for_organization
