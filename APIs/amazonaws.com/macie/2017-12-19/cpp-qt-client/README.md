...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIAssociateMemberAccountRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIAssociateMemberAccountRequest Example::create(){
    OAIAssociateMemberAccountRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::associateMemberAccountSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::associateMemberAccountSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIAssociateMemberAccountRequest oai_associate_member_account_request = create(); // OAIAssociateMemberAccountRequest | 
      ...
      apiInstance.associateMemberAccount(x_amz_targetoai_associate_member_account_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
