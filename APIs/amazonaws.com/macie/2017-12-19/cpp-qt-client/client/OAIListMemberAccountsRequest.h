...
/*
 * OAIListMemberAccountsRequest.h
 *
 * 
 */

#ifndef OAIListMemberAccountsRequest_H
#define OAIListMemberAccountsRequest_H
...
class OAIListMemberAccountsRequest : public OAIObject {
public:
    OAIListMemberAccountsRequest();
    OAIListMemberAccountsRequest(QString json);
    ~OAIListMemberAccountsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMemberAccountsRequest)

#endif // OAIListMemberAccountsRequest_H
