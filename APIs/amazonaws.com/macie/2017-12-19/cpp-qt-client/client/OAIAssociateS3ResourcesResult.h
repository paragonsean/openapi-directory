...
/*
 * OAIAssociateS3ResourcesResult.h
 *
 * 
 */

#ifndef OAIAssociateS3ResourcesResult_H
#define OAIAssociateS3ResourcesResult_H
...
class OAIAssociateS3ResourcesResult : public OAIObject {
public:
    OAIAssociateS3ResourcesResult();
    OAIAssociateS3ResourcesResult(QString json);
    ~OAIAssociateS3ResourcesResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateS3ResourcesResult)

#endif // OAIAssociateS3ResourcesResult_H
