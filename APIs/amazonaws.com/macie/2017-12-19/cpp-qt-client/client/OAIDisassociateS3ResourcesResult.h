...
/*
 * OAIDisassociateS3ResourcesResult.h
 *
 * 
 */

#ifndef OAIDisassociateS3ResourcesResult_H
#define OAIDisassociateS3ResourcesResult_H
...
class OAIDisassociateS3ResourcesResult : public OAIObject {
public:
    OAIDisassociateS3ResourcesResult();
    OAIDisassociateS3ResourcesResult(QString json);
    ~OAIDisassociateS3ResourcesResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateS3ResourcesResult)

#endif // OAIDisassociateS3ResourcesResult_H
