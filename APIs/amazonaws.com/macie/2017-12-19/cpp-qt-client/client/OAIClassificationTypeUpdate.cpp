...
#include "OAIClassificationTypeUpdate.h"
...
OAIClassificationTypeUpdate::OAIClassificationTypeUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClassificationTypeUpdate::OAIClassificationTypeUpdate() {
    this->initializeModel();
}

OAIClassificationTypeUpdate::~OAIClassificationTypeUpdate() {}

void OAIClassificationTypeUpdate::initializeModel() {
...
void OAIClassificationTypeUpdate::fromJson(QString jsonString) {
...
void OAIClassificationTypeUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIClassificationTypeUpdate::asJson() const {
...
QJsonObject OAIClassificationTypeUpdate::asJsonObject() const {
    QJsonObject obj;
    if (m_one_time.isSet()) {
...
OAIS3OneTimeClassificationType OAIClassificationTypeUpdate::getOneTime() const {
    return m_one_time;
}
void OAIClassificationTypeUpdate::setOneTime(const OAIS3OneTimeClassificationType &one_time) {
    m_one_time = one_time;
    m_one_time_isSet = true;
}

bool OAIClassificationTypeUpdate::is_one_time_Set() const{
    return m_one_time_isSet;
}

bool OAIClassificationTypeUpdate::is_one_time_Valid() const{
    return m_one_time_isValid;
}

OAIS3ContinuousClassificationType OAIClassificationTypeUpdate::getContinuous() const {
    return m_continuous;
}
void OAIClassificationTypeUpdate::setContinuous(const OAIS3ContinuousClassificationType &continuous) {
    m_continuous = continuous;
    m_continuous_isSet = true;
}

bool OAIClassificationTypeUpdate::is_continuous_Set() const{
    return m_continuous_isSet;
}

bool OAIClassificationTypeUpdate::is_continuous_Valid() const{
    return m_continuous_isValid;
}

bool OAIClassificationTypeUpdate::isSet() const {
...
bool OAIClassificationTypeUpdate::isValid() const {
