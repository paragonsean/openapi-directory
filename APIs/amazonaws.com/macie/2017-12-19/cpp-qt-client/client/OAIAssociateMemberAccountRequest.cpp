...
OAIAssociateMemberAccountRequest::OAIAssociateMemberAccountRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateMemberAccountRequest::OAIAssociateMemberAccountRequest() {
    this->initializeModel();
}

OAIAssociateMemberAccountRequest::~OAIAssociateMemberAccountRequest() {}

void OAIAssociateMemberAccountRequest::initializeModel() {

    m_member_account_id_isSet = false;
    m_member_account_id_isValid = false;
}

void OAIAssociateMemberAccountRequest::fromJson(QString jsonString) {
...
void OAIAssociateMemberAccountRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateMemberAccountRequest::asJson() const {
...
QJsonObject OAIAssociateMemberAccountRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateMemberAccountRequest::getMemberAccountId() const {
    return m_member_account_id;
}
void OAIAssociateMemberAccountRequest::setMemberAccountId(const QString &member_account_id) {
    m_member_account_id = member_account_id;
    m_member_account_id_isSet = true;
}

bool OAIAssociateMemberAccountRequest::is_member_account_id_Set() const{
    return m_member_account_id_isSet;
}

bool OAIAssociateMemberAccountRequest::is_member_account_id_Valid() const{
    return m_member_account_id_isValid;
}

bool OAIAssociateMemberAccountRequest::isSet() const {
...
bool OAIAssociateMemberAccountRequest::isValid() const {
