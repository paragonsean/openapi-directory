...
* @readonly
*/
export default class S3ContinuousClassificationType {
    ...
    /**
    * Returns a <code>S3ContinuousClassificationType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/S3ContinuousClassificationType} The enum <code>S3ContinuousClassificationType</code> value.
    */
