...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.ClassificationType();
  });
  ...
  describe('ClassificationType', function() {
    it('should create an instance of ClassificationType', function() {
      // uncomment below and update the code to test ClassificationType
      //var instance = new AmazonMacie.ClassificationType();
      //expect(instance).to.be.a(AmazonMacie.ClassificationType);
    });
