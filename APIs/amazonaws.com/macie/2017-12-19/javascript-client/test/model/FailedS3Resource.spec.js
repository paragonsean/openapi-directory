...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.FailedS3Resource();
  });
  ...
  describe('FailedS3Resource', function() {
    it('should create an instance of FailedS3Resource', function() {
      // uncomment below and update the code to test FailedS3Resource
      //var instance = new AmazonMacie.FailedS3Resource();
      //expect(instance).to.be.a(AmazonMacie.FailedS3Resource);
    });

    it('should have the property failedItem (base name: "failedItem")', function() {
      // uncomment below and update the code to test the property failedItem
      //var instance = new AmazonMacie.FailedS3Resource();
