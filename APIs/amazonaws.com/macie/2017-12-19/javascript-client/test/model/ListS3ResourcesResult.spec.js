...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.ListS3ResourcesResult();
  });
  ...
  describe('ListS3ResourcesResult', function() {
    it('should create an instance of ListS3ResourcesResult', function() {
      // uncomment below and update the code to test ListS3ResourcesResult
      //var instance = new AmazonMacie.ListS3ResourcesResult();
      //expect(instance).to.be.a(AmazonMacie.ListS3ResourcesResult);
    });
