...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.DisassociateS3ResourcesResult();
  });
  ...
  describe('DisassociateS3ResourcesResult', function() {
    it('should create an instance of DisassociateS3ResourcesResult', function() {
      // uncomment below and update the code to test DisassociateS3ResourcesResult
      //var instance = new AmazonMacie.DisassociateS3ResourcesResult();
      //expect(instance).to.be.a(AmazonMacie.DisassociateS3ResourcesResult);
    });

    it('should have the property failedS3Resources (base name: "failedS3Resources")', function() {
      // uncomment below and update the code to test the property failedS3Resources
      //var instance = new AmazonMacie.DisassociateS3ResourcesResult();
