...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.S3ResourceClassificationClassificationType();
  });
  ...
  describe('S3ResourceClassificationClassificationType', function() {
    it('should create an instance of S3ResourceClassificationClassificationType', function() {
      // uncomment below and update the code to test S3ResourceClassificationClassificationType
      //var instance = new AmazonMacie.S3ResourceClassificationClassificationType();
      //expect(instance).to.be.a(AmazonMacie.S3ResourceClassificationClassificationType);
    });
