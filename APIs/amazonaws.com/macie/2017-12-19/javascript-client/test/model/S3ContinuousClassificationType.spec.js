...
(function(root, factory) {
  ...
  describe('S3ContinuousClassificationType', function() {
    it('should create an instance of S3ContinuousClassificationType', function() {
      // uncomment below and update the code to test S3ContinuousClassificationType
      //var instance = new AmazonMacie.S3ContinuousClassificationType();
      //expect(instance).to.be.a(AmazonMacie.S3ContinuousClassificationType);
    });
