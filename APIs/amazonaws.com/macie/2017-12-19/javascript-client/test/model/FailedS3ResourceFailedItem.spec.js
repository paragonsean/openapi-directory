...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.FailedS3ResourceFailedItem();
  });
  ...
  describe('FailedS3ResourceFailedItem', function() {
    it('should create an instance of FailedS3ResourceFailedItem', function() {
      // uncomment below and update the code to test FailedS3ResourceFailedItem
      //var instance = new AmazonMacie.FailedS3ResourceFailedItem();
      //expect(instance).to.be.a(AmazonMacie.FailedS3ResourceFailedItem);
    });
