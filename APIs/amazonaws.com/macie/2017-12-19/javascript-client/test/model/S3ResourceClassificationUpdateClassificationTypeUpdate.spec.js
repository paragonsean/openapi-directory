...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.S3ResourceClassificationUpdateClassificationTypeUpdate();
  });
  ...
  describe('S3ResourceClassificationUpdateClassificationTypeUpdate', function() {
    it('should create an instance of S3ResourceClassificationUpdateClassificationTypeUpdate', function() {
      // uncomment below and update the code to test S3ResourceClassificationUpdateClassificationTypeUpdate
      //var instance = new AmazonMacie.S3ResourceClassificationUpdateClassificationTypeUpdate();
      //expect(instance).to.be.a(AmazonMacie.S3ResourceClassificationUpdateClassificationTypeUpdate);
    });
