...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.AssociateMemberAccountRequest();
  });
  ...
  describe('AssociateMemberAccountRequest', function() {
    it('should create an instance of AssociateMemberAccountRequest', function() {
      // uncomment below and update the code to test AssociateMemberAccountRequest
      //var instance = new AmazonMacie.AssociateMemberAccountRequest();
      //expect(instance).to.be.a(AmazonMacie.AssociateMemberAccountRequest);
    });
