...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.UpdateS3ResourcesResult();
  });
  ...
  describe('UpdateS3ResourcesResult', function() {
    it('should create an instance of UpdateS3ResourcesResult', function() {
      // uncomment below and update the code to test UpdateS3ResourcesResult
      //var instance = new AmazonMacie.UpdateS3ResourcesResult();
      //expect(instance).to.be.a(AmazonMacie.UpdateS3ResourcesResult);
    });
