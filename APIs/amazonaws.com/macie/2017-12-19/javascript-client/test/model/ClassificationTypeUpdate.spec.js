...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.ClassificationTypeUpdate();
  });
  ...
  describe('ClassificationTypeUpdate', function() {
    it('should create an instance of ClassificationTypeUpdate', function() {
      // uncomment below and update the code to test ClassificationTypeUpdate
      //var instance = new AmazonMacie.ClassificationTypeUpdate();
      //expect(instance).to.be.a(AmazonMacie.ClassificationTypeUpdate);
    });
