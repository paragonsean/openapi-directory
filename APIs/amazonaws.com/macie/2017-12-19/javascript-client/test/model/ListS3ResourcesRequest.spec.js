...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.ListS3ResourcesRequest();
  });
  ...
  describe('ListS3ResourcesRequest', function() {
    it('should create an instance of ListS3ResourcesRequest', function() {
      // uncomment below and update the code to test ListS3ResourcesRequest
      //var instance = new AmazonMacie.ListS3ResourcesRequest();
      //expect(instance).to.be.a(AmazonMacie.ListS3ResourcesRequest);
    });
