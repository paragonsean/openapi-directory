...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.ListMemberAccountsRequest();
  });
  ...
  describe('ListMemberAccountsRequest', function() {
    it('should create an instance of ListMemberAccountsRequest', function() {
      // uncomment below and update the code to test ListMemberAccountsRequest
      //var instance = new AmazonMacie.ListMemberAccountsRequest();
      //expect(instance).to.be.a(AmazonMacie.ListMemberAccountsRequest);
    });
