...
(function(root, factory) {
  ...
  describe('S3OneTimeClassificationType', function() {
    it('should create an instance of S3OneTimeClassificationType', function() {
      // uncomment below and update the code to test S3OneTimeClassificationType
      //var instance = new AmazonMacie.S3OneTimeClassificationType();
      //expect(instance).to.be.a(AmazonMacie.S3OneTimeClassificationType);
    });
