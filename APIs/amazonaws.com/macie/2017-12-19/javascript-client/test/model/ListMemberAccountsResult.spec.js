...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.ListMemberAccountsResult();
  });
  ...
  describe('ListMemberAccountsResult', function() {
    it('should create an instance of ListMemberAccountsResult', function() {
      // uncomment below and update the code to test ListMemberAccountsResult
      //var instance = new AmazonMacie.ListMemberAccountsResult();
      //expect(instance).to.be.a(AmazonMacie.ListMemberAccountsResult);
    });

    it('should have the property memberAccounts (base name: "memberAccounts")', function() {
      // uncomment below and update the code to test the property memberAccounts
      //var instance = new AmazonMacie.ListMemberAccountsResult();
