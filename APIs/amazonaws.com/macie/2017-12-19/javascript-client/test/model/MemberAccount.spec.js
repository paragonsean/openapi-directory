...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.MemberAccount();
  });
  ...
  describe('MemberAccount', function() {
    it('should create an instance of MemberAccount', function() {
      // uncomment below and update the code to test MemberAccount
      //var instance = new AmazonMacie.MemberAccount();
      //expect(instance).to.be.a(AmazonMacie.MemberAccount);
    });
