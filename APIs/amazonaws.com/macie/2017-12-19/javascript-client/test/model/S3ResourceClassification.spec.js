...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.S3ResourceClassification();
  });
  ...
  describe('S3ResourceClassification', function() {
    it('should create an instance of S3ResourceClassification', function() {
      // uncomment below and update the code to test S3ResourceClassification
      //var instance = new AmazonMacie.S3ResourceClassification();
      //expect(instance).to.be.a(AmazonMacie.S3ResourceClassification);
    });
