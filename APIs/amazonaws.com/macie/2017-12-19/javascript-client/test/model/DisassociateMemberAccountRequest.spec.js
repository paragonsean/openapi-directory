...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMacie.DisassociateMemberAccountRequest();
  });
  ...
  describe('DisassociateMemberAccountRequest', function() {
    it('should create an instance of DisassociateMemberAccountRequest', function() {
      // uncomment below and update the code to test DisassociateMemberAccountRequest
      //var instance = new AmazonMacie.DisassociateMemberAccountRequest();
      //expect(instance).to.be.a(AmazonMacie.DisassociateMemberAccountRequest);
    });
