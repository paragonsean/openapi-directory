...
/**
 * Gets or Sets S3OneTimeClassificationType
 */
@JsonAdapter(S3OneTimeClassificationType.Adapter.class)
public enum S3OneTimeClassificationType {
  ...
  S3OneTimeClassificationType(String value) {
    this.value = value;
  }
  ...
  public static S3OneTimeClassificationType fromValue(String value) {
    for (S3OneTimeClassificationType b : S3OneTimeClassificationType.values()) {
  ...
  public static class Adapter extends TypeAdapter<S3OneTimeClassificationType> {
    @Override
    public void write(final JsonWriter jsonWriter, final S3OneTimeClassificationType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public S3OneTimeClassificationType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return S3OneTimeClassificationType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    S3OneTimeClassificationType.fromValue(value);
  }
}
