...
QString OAIDeleteLabelRequest::getName() const {
    return m_name;
}
void OAIDeleteLabelRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteLabelRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteLabelRequest::is_name_Valid() const{
