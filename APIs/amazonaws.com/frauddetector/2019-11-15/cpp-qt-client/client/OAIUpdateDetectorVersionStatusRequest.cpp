...
OAIUpdateDetectorVersionStatusRequest::OAIUpdateDetectorVersionStatusRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDetectorVersionStatusRequest::OAIUpdateDetectorVersionStatusRequest() {
    this->initializeModel();
}

OAIUpdateDetectorVersionStatusRequest::~OAIUpdateDetectorVersionStatusRequest() {}

void OAIUpdateDetectorVersionStatusRequest::initializeModel() {
...
void OAIUpdateDetectorVersionStatusRequest::fromJson(QString jsonString) {
...
void OAIUpdateDetectorVersionStatusRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDetectorVersionStatusRequest::asJson() const {
...
QJsonObject OAIUpdateDetectorVersionStatusRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateDetectorVersionStatusRequest::getDetectorId() const {
    return m_detector_id;
}
void OAIUpdateDetectorVersionStatusRequest::setDetectorId(const QString &detector_id) {
    m_detector_id = detector_id;
    m_detector_id_isSet = true;
}

bool OAIUpdateDetectorVersionStatusRequest::is_detector_id_Set() const{
    return m_detector_id_isSet;
}

bool OAIUpdateDetectorVersionStatusRequest::is_detector_id_Valid() const{
    return m_detector_id_isValid;
}

QString OAIUpdateDetectorVersionStatusRequest::getDetectorVersionId() const {
    return m_detector_version_id;
}
void OAIUpdateDetectorVersionStatusRequest::setDetectorVersionId(const QString &detector_version_id) {
    m_detector_version_id = detector_version_id;
    m_detector_version_id_isSet = true;
}

bool OAIUpdateDetectorVersionStatusRequest::is_detector_version_id_Set() const{
    return m_detector_version_id_isSet;
}

bool OAIUpdateDetectorVersionStatusRequest::is_detector_version_id_Valid() const{
    return m_detector_version_id_isValid;
}

OAIDetectorVersionStatus OAIUpdateDetectorVersionStatusRequest::getStatus() const {
    return m_status;
}
void OAIUpdateDetectorVersionStatusRequest::setStatus(const OAIDetectorVersionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateDetectorVersionStatusRequest::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateDetectorVersionStatusRequest::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIUpdateDetectorVersionStatusRequest::isSet() const {
...
bool OAIUpdateDetectorVersionStatusRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_detector_id_isValid && m_detector_version_id_isValid && m_status_isValid && true;
}
