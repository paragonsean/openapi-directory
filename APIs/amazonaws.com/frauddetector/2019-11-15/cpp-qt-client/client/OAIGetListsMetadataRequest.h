...
/*
 * OAIGetListsMetadataRequest.h
 *
 * 
 */

#ifndef OAIGetListsMetadataRequest_H
#define OAIGetListsMetadataRequest_H
...
class OAIGetListsMetadataRequest : public OAIObject {
public:
    OAIGetListsMetadataRequest();
    OAIGetListsMetadataRequest(QString json);
    ~OAIGetListsMetadataRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetListsMetadataRequest)

#endif // OAIGetListsMetadataRequest_H
