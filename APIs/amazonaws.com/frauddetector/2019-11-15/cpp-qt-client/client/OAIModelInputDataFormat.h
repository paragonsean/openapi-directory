...
/*
 * OAIModelInputDataFormat.h
 *
 * 
 */

#ifndef OAIModelInputDataFormat_H
#define OAIModelInputDataFormat_H
...
class OAIModelInputDataFormat : public OAIEnum {
public:
    OAIModelInputDataFormat();
    OAIModelInputDataFormat(QString json);
    ~OAIModelInputDataFormat() override;
    ...
    enum class eOAIModelInputDataFormat {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TEXT_CSV, 
        APPLICATION_JSON
    };
    OAIModelInputDataFormat::eOAIModelInputDataFormat getValue() const;
    void setValue(const OAIModelInputDataFormat::eOAIModelInputDataFormat& value);
...
private:
    ...
    eOAIModelInputDataFormat m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelInputDataFormat)

#endif // OAIModelInputDataFormat_H
