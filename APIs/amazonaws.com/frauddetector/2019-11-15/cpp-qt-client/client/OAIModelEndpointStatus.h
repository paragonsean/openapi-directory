...
/*
 * OAIModelEndpointStatus.h
 *
 * 
 */

#ifndef OAIModelEndpointStatus_H
#define OAIModelEndpointStatus_H
...
class OAIModelEndpointStatus : public OAIEnum {
public:
    OAIModelEndpointStatus();
    OAIModelEndpointStatus(QString json);
    ~OAIModelEndpointStatus() override;
    ...
    enum class eOAIModelEndpointStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ASSOCIATED, 
        DISSOCIATED
    };
    OAIModelEndpointStatus::eOAIModelEndpointStatus getValue() const;
    void setValue(const OAIModelEndpointStatus::eOAIModelEndpointStatus& value);
...
private:
    ...
    eOAIModelEndpointStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelEndpointStatus)

#endif // OAIModelEndpointStatus_H
