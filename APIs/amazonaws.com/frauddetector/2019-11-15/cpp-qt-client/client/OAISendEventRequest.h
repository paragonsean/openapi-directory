...
public:
    ...
    QString getAssignedLabel() const;
    void setAssignedLabel(const QString &assigned_label);
    bool is_assigned_label_Set() const;
    bool is_assigned_label_Valid() const;
...
private:
    ...
    bool m_assigned_label_isSet;
    bool m_assigned_label_isValid;
