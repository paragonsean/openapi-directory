...
/*
 * OAIEventOrchestration.h
 *
 *  The event orchestration status. 
 */

#ifndef OAIEventOrchestration_H
#define OAIEventOrchestration_H
...
class OAIEventOrchestration : public OAIObject {
public:
    OAIEventOrchestration();
    OAIEventOrchestration(QString json);
    ~OAIEventOrchestration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventOrchestration)

#endif // OAIEventOrchestration_H
