...
#include "OAIEventPredictionSummary.h"
...
OAIEventPredictionSummary::OAIEventPredictionSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventPredictionSummary::OAIEventPredictionSummary() {
    this->initializeModel();
}

OAIEventPredictionSummary::~OAIEventPredictionSummary() {}

void OAIEventPredictionSummary::initializeModel() {
...
void OAIEventPredictionSummary::fromJson(QString jsonString) {
...
void OAIEventPredictionSummary::fromJsonObject(QJsonObject json) {
...
QString OAIEventPredictionSummary::asJson() const {
...
QJsonObject OAIEventPredictionSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_event_id_isSet) {
...
QString OAIEventPredictionSummary::getEventId() const {
    return m_event_id;
}
void OAIEventPredictionSummary::setEventId(const QString &event_id) {
    m_event_id = event_id;
    m_event_id_isSet = true;
}

bool OAIEventPredictionSummary::is_event_id_Set() const{
    return m_event_id_isSet;
}

bool OAIEventPredictionSummary::is_event_id_Valid() const{
    return m_event_id_isValid;
}

QString OAIEventPredictionSummary::getEventTypeName() const {
    return m_event_type_name;
}
void OAIEventPredictionSummary::setEventTypeName(const QString &event_type_name) {
    m_event_type_name = event_type_name;
    m_event_type_name_isSet = true;
}

bool OAIEventPredictionSummary::is_event_type_name_Set() const{
    return m_event_type_name_isSet;
}

bool OAIEventPredictionSummary::is_event_type_name_Valid() const{
    return m_event_type_name_isValid;
}

QString OAIEventPredictionSummary::getEventTimestamp() const {
    return m_event_timestamp;
}
void OAIEventPredictionSummary::setEventTimestamp(const QString &event_timestamp) {
    m_event_timestamp = event_timestamp;
    m_event_timestamp_isSet = true;
}

bool OAIEventPredictionSummary::is_event_timestamp_Set() const{
    return m_event_timestamp_isSet;
}

bool OAIEventPredictionSummary::is_event_timestamp_Valid() const{
    return m_event_timestamp_isValid;
}

QString OAIEventPredictionSummary::getPredictionTimestamp() const {
    return m_prediction_timestamp;
}
void OAIEventPredictionSummary::setPredictionTimestamp(const QString &prediction_timestamp) {
    m_prediction_timestamp = prediction_timestamp;
    m_prediction_timestamp_isSet = true;
}

bool OAIEventPredictionSummary::is_prediction_timestamp_Set() const{
    return m_prediction_timestamp_isSet;
}

bool OAIEventPredictionSummary::is_prediction_timestamp_Valid() const{
    return m_prediction_timestamp_isValid;
}

QString OAIEventPredictionSummary::getDetectorId() const {
    return m_detector_id;
}
void OAIEventPredictionSummary::setDetectorId(const QString &detector_id) {
    m_detector_id = detector_id;
    m_detector_id_isSet = true;
}

bool OAIEventPredictionSummary::is_detector_id_Set() const{
    return m_detector_id_isSet;
}

bool OAIEventPredictionSummary::is_detector_id_Valid() const{
    return m_detector_id_isValid;
}

QString OAIEventPredictionSummary::getDetectorVersionId() const {
    return m_detector_version_id;
}
void OAIEventPredictionSummary::setDetectorVersionId(const QString &detector_version_id) {
    m_detector_version_id = detector_version_id;
    m_detector_version_id_isSet = true;
}

bool OAIEventPredictionSummary::is_detector_version_id_Set() const{
    return m_detector_version_id_isSet;
}

bool OAIEventPredictionSummary::is_detector_version_id_Valid() const{
    return m_detector_version_id_isValid;
}

bool OAIEventPredictionSummary::isSet() const {
...
bool OAIEventPredictionSummary::isValid() const {
