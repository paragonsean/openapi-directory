...
QString OAIGetModelsRequest::getModelId() const {
    return m_model_id;
}
void OAIGetModelsRequest::setModelId(const QString &model_id) {
    m_model_id = model_id;
    m_model_id_isSet = true;
}

bool OAIGetModelsRequest::is_model_id_Set() const{
    return m_model_id_isSet;
}

bool OAIGetModelsRequest::is_model_id_Valid() const{
    return m_model_id_isValid;
}

OAIModelTypeEnum OAIGetModelsRequest::getModelType() const {
    return m_model_type;
}
void OAIGetModelsRequest::setModelType(const OAIModelTypeEnum &model_type) {
    m_model_type = model_type;
    m_model_type_isSet = true;
}

bool OAIGetModelsRequest::is_model_type_Set() const{
    return m_model_type_isSet;
}

bool OAIGetModelsRequest::is_model_type_Valid() const{
    return m_model_type_isValid;
}

QString OAIGetModelsRequest::getNextToken() const {
    return m_next_token;
}
void OAIGetModelsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetModelsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetModelsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIGetModelsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIGetModelsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetModelsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetModelsRequest::is_max_results_Valid() const{
