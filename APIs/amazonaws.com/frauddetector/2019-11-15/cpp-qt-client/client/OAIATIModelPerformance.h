...
/*
 * OAIATIModelPerformance.h
 *
 *  The Account Takeover Insights (ATI) model performance score. 
 */

#ifndef OAIATIModelPerformance_H
#define OAIATIModelPerformance_H
...
class OAIATIModelPerformance : public OAIObject {
public:
    OAIATIModelPerformance();
    OAIATIModelPerformance(QString json);
    ~OAIATIModelPerformance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIATIModelPerformance)

#endif // OAIATIModelPerformance_H
