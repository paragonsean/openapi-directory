...
/*
 * OAIExternalEventsDetail.h
 *
 * Details for the external events data used for model version training.
 */

#ifndef OAIExternalEventsDetail_H
#define OAIExternalEventsDetail_H
...
class OAIExternalEventsDetail : public OAIObject {
public:
    OAIExternalEventsDetail();
    OAIExternalEventsDetail(QString json);
    ~OAIExternalEventsDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExternalEventsDetail)

#endif // OAIExternalEventsDetail_H
