...
/*
 * OAIGetLabelsResult.h
 *
 * 
 */

#ifndef OAIGetLabelsResult_H
#define OAIGetLabelsResult_H
...
class OAIGetLabelsResult : public OAIObject {
public:
    OAIGetLabelsResult();
    OAIGetLabelsResult(QString json);
    ~OAIGetLabelsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLabelsResult)

#endif // OAIGetLabelsResult_H
