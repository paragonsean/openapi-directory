...
/*
 * OAICreateDetectorVersionRequest.h
 *
 * 
 */

#ifndef OAICreateDetectorVersionRequest_H
#define OAICreateDetectorVersionRequest_H
...
class OAICreateDetectorVersionRequest : public OAIObject {
public:
    OAICreateDetectorVersionRequest();
    OAICreateDetectorVersionRequest(QString json);
    ~OAICreateDetectorVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDetectorVersionRequest)

#endif // OAICreateDetectorVersionRequest_H
