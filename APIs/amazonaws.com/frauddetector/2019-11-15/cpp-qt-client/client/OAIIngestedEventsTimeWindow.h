...
/*
 * OAIIngestedEventsTimeWindow.h
 *
 * The start and stop time of the ingested events.
 */

#ifndef OAIIngestedEventsTimeWindow_H
#define OAIIngestedEventsTimeWindow_H
...
class OAIIngestedEventsTimeWindow : public OAIObject {
public:
    OAIIngestedEventsTimeWindow();
    OAIIngestedEventsTimeWindow(QString json);
    ~OAIIngestedEventsTimeWindow() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIngestedEventsTimeWindow)

#endif // OAIIngestedEventsTimeWindow_H
