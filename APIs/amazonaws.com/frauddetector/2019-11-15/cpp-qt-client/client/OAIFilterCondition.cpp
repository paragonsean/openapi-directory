...
QString OAIFilterCondition::getValue() const {
    return m_value;
}
void OAIFilterCondition::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIFilterCondition::is_value_Set() const{
    return m_value_isSet;
}

bool OAIFilterCondition::is_value_Valid() const{
