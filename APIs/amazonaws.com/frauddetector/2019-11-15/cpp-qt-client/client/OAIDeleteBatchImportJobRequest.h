...
/*
 * OAIDeleteBatchImportJobRequest.h
 *
 * 
 */

#ifndef OAIDeleteBatchImportJobRequest_H
#define OAIDeleteBatchImportJobRequest_H
...
class OAIDeleteBatchImportJobRequest : public OAIObject {
public:
    OAIDeleteBatchImportJobRequest();
    OAIDeleteBatchImportJobRequest(QString json);
    ~OAIDeleteBatchImportJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBatchImportJobRequest)

#endif // OAIDeleteBatchImportJobRequest_H
