...
QList OAIRuleResult::getOutcomes() const {
    return m_outcomes;
}
void OAIRuleResult::setOutcomes(const QList &outcomes) {
    m_outcomes = outcomes;
    m_outcomes_isSet = true;
}

bool OAIRuleResult::is_outcomes_Set() const{
    return m_outcomes_isSet;
}

bool OAIRuleResult::is_outcomes_Valid() const{
