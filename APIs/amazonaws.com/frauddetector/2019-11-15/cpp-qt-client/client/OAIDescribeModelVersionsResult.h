...
/*
 * OAIDescribeModelVersionsResult.h
 *
 * 
 */

#ifndef OAIDescribeModelVersionsResult_H
#define OAIDescribeModelVersionsResult_H
...
class OAIDescribeModelVersionsResult : public OAIObject {
public:
    OAIDescribeModelVersionsResult();
    OAIDescribeModelVersionsResult(QString json);
    ~OAIDescribeModelVersionsResult() override;
    ...
    QList getModelVersionDetails() const;
    void setModelVersionDetails(const QList &model_version_details);
    bool is_model_version_details_Set() const;
    bool is_model_version_details_Valid() const;
...
private:
    ...
    QList m_model_version_details;
    bool m_model_version_details_isSet;
    bool m_model_version_details_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeModelVersionsResult)

#endif // OAIDescribeModelVersionsResult_H
