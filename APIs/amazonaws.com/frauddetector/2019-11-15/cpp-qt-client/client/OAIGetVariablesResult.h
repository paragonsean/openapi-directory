...
/*
 * OAIGetVariablesResult.h
 *
 * 
 */

#ifndef OAIGetVariablesResult_H
#define OAIGetVariablesResult_H
...
class OAIGetVariablesResult : public OAIObject {
public:
    OAIGetVariablesResult();
    OAIGetVariablesResult(QString json);
    ~OAIGetVariablesResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVariablesResult)

#endif // OAIGetVariablesResult_H
