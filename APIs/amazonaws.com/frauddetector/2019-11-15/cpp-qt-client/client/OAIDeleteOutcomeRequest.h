...
/*
 * OAIDeleteOutcomeRequest.h
 *
 * 
 */

#ifndef OAIDeleteOutcomeRequest_H
#define OAIDeleteOutcomeRequest_H
...
class OAIDeleteOutcomeRequest : public OAIObject {
public:
    OAIDeleteOutcomeRequest();
    OAIDeleteOutcomeRequest(QString json);
    ~OAIDeleteOutcomeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteOutcomeRequest)

#endif // OAIDeleteOutcomeRequest_H
