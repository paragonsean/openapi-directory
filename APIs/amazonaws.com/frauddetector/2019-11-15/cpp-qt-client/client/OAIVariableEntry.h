...
#ifndef OAIVariableEntry_H
#define OAIVariableEntry_H
...
class OAIVariableEntry : public OAIObject {
public:
    OAIVariableEntry();
    OAIVariableEntry(QString json);
    ~OAIVariableEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVariableEntry)

#endif // OAIVariableEntry_H
