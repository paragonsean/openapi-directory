...
/*
 * OAIGetEntityTypesRequest.h
 *
 * 
 */

#ifndef OAIGetEntityTypesRequest_H
#define OAIGetEntityTypesRequest_H
...
class OAIGetEntityTypesRequest : public OAIObject {
public:
    OAIGetEntityTypesRequest();
    OAIGetEntityTypesRequest(QString json);
    ~OAIGetEntityTypesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEntityTypesRequest)

#endif // OAIGetEntityTypesRequest_H
