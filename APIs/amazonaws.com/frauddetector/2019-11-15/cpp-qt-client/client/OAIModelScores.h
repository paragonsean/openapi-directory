...
#ifndef OAIModelScores_H
#define OAIModelScores_H
...
namespace OpenAPI {
class OAIModelScores_modelVersion;

class OAIModelScores : public OAIObject {
public:
    OAIModelScores();
    OAIModelScores(QString json);
    ~OAIModelScores() override;
    ...
    OAIModelScores_modelVersion getModelVersion() const;
    void setModelVersion(const OAIModelScores_modelVersion &model_version);
...
private:
    ...
    OAIModelScores_modelVersion m_model_version;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelScores)

#endif // OAIModelScores_H
