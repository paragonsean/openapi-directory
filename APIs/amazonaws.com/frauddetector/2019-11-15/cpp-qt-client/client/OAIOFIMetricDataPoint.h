...
/*
 * OAIOFIMetricDataPoint.h
 *
 *  The Online Fraud Insights (OFI) model performance metrics data points. 
 */

#ifndef OAIOFIMetricDataPoint_H
#define OAIOFIMetricDataPoint_H
...
class OAIOFIMetricDataPoint : public OAIObject {
public:
    OAIOFIMetricDataPoint();
    OAIOFIMetricDataPoint(QString json);
    ~OAIOFIMetricDataPoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOFIMetricDataPoint)

#endif // OAIOFIMetricDataPoint_H
