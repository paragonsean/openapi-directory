...
#ifndef OAIUncertaintyRange_H
#define OAIUncertaintyRange_H
...
class OAIUncertaintyRange : public OAIObject {
public:
    OAIUncertaintyRange();
    OAIUncertaintyRange(QString json);
    ~OAIUncertaintyRange() override;
    ...
    float getLowerBoundValue() const;
    void setLowerBoundValue(const float &lower_bound_value);
    bool is_lower_bound_value_Set() const;
    bool is_lower_bound_value_Valid() const;

    float getUpperBoundValue() const;
    void setUpperBoundValue(const float &upper_bound_value);
    bool is_upper_bound_value_Set() const;
    bool is_upper_bound_value_Valid() const;
...
private:
    ...
    float m_lower_bound_value;
    bool m_lower_bound_value_isSet;
    bool m_lower_bound_value_isValid;

    float m_upper_bound_value;
    bool m_upper_bound_value_isSet;
    bool m_upper_bound_value_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUncertaintyRange)

#endif // OAIUncertaintyRange_H
