...
OAIGetListElementsResult::OAIGetListElementsResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetListElementsResult::OAIGetListElementsResult() {
    this->initializeModel();
}

OAIGetListElementsResult::~OAIGetListElementsResult() {}

void OAIGetListElementsResult::initializeModel() {
...
void OAIGetListElementsResult::fromJson(QString jsonString) {
...
void OAIGetListElementsResult::fromJsonObject(QJsonObject json) {
...
QString OAIGetListElementsResult::asJson() const {
...
QJsonObject OAIGetListElementsResult::asJsonObject() const {
    QJsonObject obj;
    if (m_elements.isSet()) {
...
QList OAIGetListElementsResult::getElements() const {
    return m_elements;
}
void OAIGetListElementsResult::setElements(const QList &elements) {
    m_elements = elements;
    m_elements_isSet = true;
}

bool OAIGetListElementsResult::is_elements_Set() const{
    return m_elements_isSet;
}

bool OAIGetListElementsResult::is_elements_Valid() const{
    return m_elements_isValid;
}

QString OAIGetListElementsResult::getNextToken() const {
    return m_next_token;
}
void OAIGetListElementsResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetListElementsResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetListElementsResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetListElementsResult::isSet() const {
...
bool OAIGetListElementsResult::isValid() const {
