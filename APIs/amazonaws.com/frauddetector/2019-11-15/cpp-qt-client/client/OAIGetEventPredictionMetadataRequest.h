...
/*
 * OAIGetEventPredictionMetadataRequest.h
 *
 * 
 */

#ifndef OAIGetEventPredictionMetadataRequest_H
#define OAIGetEventPredictionMetadataRequest_H
...
class OAIGetEventPredictionMetadataRequest : public OAIObject {
public:
    OAIGetEventPredictionMetadataRequest();
    OAIGetEventPredictionMetadataRequest(QString json);
    ~OAIGetEventPredictionMetadataRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEventPredictionMetadataRequest)

#endif // OAIGetEventPredictionMetadataRequest_H
