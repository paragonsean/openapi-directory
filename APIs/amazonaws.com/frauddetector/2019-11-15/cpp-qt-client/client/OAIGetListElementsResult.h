...
/*
 * OAIGetListElementsResult.h
 *
 * 
 */

#ifndef OAIGetListElementsResult_H
#define OAIGetListElementsResult_H
...
class OAIGetListElementsResult : public OAIObject {
public:
    OAIGetListElementsResult();
    OAIGetListElementsResult(QString json);
    ~OAIGetListElementsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetListElementsResult)

#endif // OAIGetListElementsResult_H
