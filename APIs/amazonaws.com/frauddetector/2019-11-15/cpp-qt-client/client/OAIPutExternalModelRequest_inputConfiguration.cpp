...
OAIPutExternalModelRequest_inputConfiguration::OAIPutExternalModelRequest_inputConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutExternalModelRequest_inputConfiguration::OAIPutExternalModelRequest_inputConfiguration() {
    this->initializeModel();
}

OAIPutExternalModelRequest_inputConfiguration::~OAIPutExternalModelRequest_inputConfiguration() {}

void OAIPutExternalModelRequest_inputConfiguration::initializeModel() {
...
void OAIPutExternalModelRequest_inputConfiguration::fromJson(QString jsonString) {
...
void OAIPutExternalModelRequest_inputConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIPutExternalModelRequest_inputConfiguration::asJson() const {
...
QJsonObject OAIPutExternalModelRequest_inputConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutExternalModelRequest_inputConfiguration::getEventTypeName() const {
    return m_event_type_name;
}
void OAIPutExternalModelRequest_inputConfiguration::setEventTypeName(const QString &event_type_name) {
    m_event_type_name = event_type_name;
    m_event_type_name_isSet = true;
}

bool OAIPutExternalModelRequest_inputConfiguration::is_event_type_name_Set() const{
    return m_event_type_name_isSet;
}

bool OAIPutExternalModelRequest_inputConfiguration::is_event_type_name_Valid() const{
    return m_event_type_name_isValid;
}

OAIModelInputDataFormat OAIPutExternalModelRequest_inputConfiguration::getFormat() const {
    return m_format;
}
void OAIPutExternalModelRequest_inputConfiguration::setFormat(const OAIModelInputDataFormat &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIPutExternalModelRequest_inputConfiguration::is_format_Set() const{
    return m_format_isSet;
}

bool OAIPutExternalModelRequest_inputConfiguration::is_format_Valid() const{
    return m_format_isValid;
}

bool OAIPutExternalModelRequest_inputConfiguration::getUseEventVariables() const {
    return m_use_event_variables;
}
void OAIPutExternalModelRequest_inputConfiguration::setUseEventVariables(const bool &use_event_variables) {
    m_use_event_variables = use_event_variables;
    m_use_event_variables_isSet = true;
}

bool OAIPutExternalModelRequest_inputConfiguration::is_use_event_variables_Set() const{
    return m_use_event_variables_isSet;
}

bool OAIPutExternalModelRequest_inputConfiguration::is_use_event_variables_Valid() const{
    return m_use_event_variables_isValid;
}

QString OAIPutExternalModelRequest_inputConfiguration::getJsonInputTemplate() const {
    return m_json_input_template;
}
void OAIPutExternalModelRequest_inputConfiguration::setJsonInputTemplate(const QString &json_input_template) {
    m_json_input_template = json_input_template;
    m_json_input_template_isSet = true;
}

bool OAIPutExternalModelRequest_inputConfiguration::is_json_input_template_Set() const{
    return m_json_input_template_isSet;
}

bool OAIPutExternalModelRequest_inputConfiguration::is_json_input_template_Valid() const{
    return m_json_input_template_isValid;
}

QString OAIPutExternalModelRequest_inputConfiguration::getCsvInputTemplate() const {
    return m_csv_input_template;
}
void OAIPutExternalModelRequest_inputConfiguration::setCsvInputTemplate(const QString &csv_input_template) {
    m_csv_input_template = csv_input_template;
    m_csv_input_template_isSet = true;
}

bool OAIPutExternalModelRequest_inputConfiguration::is_csv_input_template_Set() const{
    return m_csv_input_template_isSet;
}

bool OAIPutExternalModelRequest_inputConfiguration::is_csv_input_template_Valid() const{
    return m_csv_input_template_isValid;
}

bool OAIPutExternalModelRequest_inputConfiguration::isSet() const {
...
bool OAIPutExternalModelRequest_inputConfiguration::isValid() const {
