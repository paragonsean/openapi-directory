...
#ifndef OAIGetEventResult_H
#define OAIGetEventResult_H
...
namespace OpenAPI {
class OAIGetEventResult_event;

class OAIGetEventResult : public OAIObject {
public:
    OAIGetEventResult();
    OAIGetEventResult(QString json);
    ~OAIGetEventResult() override;
    ...
    OAIGetEventResult_event getEvent() const;
    void setEvent(const OAIGetEventResult_event &event);
...
private:
    ...
    OAIGetEventResult_event m_event;
    bool m_event_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEventResult)

#endif // OAIGetEventResult_H
