...
#ifndef OAIListUpdateMode_H
#define OAIListUpdateMode_H
...
class OAIListUpdateMode : public OAIEnum {
public:
    OAIListUpdateMode();
    OAIListUpdateMode(QString json);
    ~OAIListUpdateMode() override;
    ...
    enum class eOAIListUpdateMode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        REPLACE, 
        APPEND, 
        REMOVE
    };
    OAIListUpdateMode::eOAIListUpdateMode getValue() const;
    void setValue(const OAIListUpdateMode::eOAIListUpdateMode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUpdateMode)

#endif // OAIListUpdateMode_H
