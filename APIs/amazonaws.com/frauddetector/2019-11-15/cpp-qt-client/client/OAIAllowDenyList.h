...
#ifndef OAIAllowDenyList_H
#define OAIAllowDenyList_H
...
class OAIAllowDenyList : public OAIObject {
public:
    OAIAllowDenyList();
    OAIAllowDenyList(QString json);
    ~OAIAllowDenyList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAllowDenyList)

#endif // OAIAllowDenyList_H
