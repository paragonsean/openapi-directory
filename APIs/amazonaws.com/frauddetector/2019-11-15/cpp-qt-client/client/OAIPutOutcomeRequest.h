...
/*
 * OAIPutOutcomeRequest.h
 *
 * 
 */

#ifndef OAIPutOutcomeRequest_H
#define OAIPutOutcomeRequest_H
...
class OAIPutOutcomeRequest : public OAIObject {
public:
    OAIPutOutcomeRequest();
    OAIPutOutcomeRequest(QString json);
    ~OAIPutOutcomeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutOutcomeRequest)

#endif // OAIPutOutcomeRequest_H
