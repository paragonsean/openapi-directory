...
/*
 * OAIFileValidationMessage.h
 *
 * The message details.
 */

#ifndef OAIFileValidationMessage_H
#define OAIFileValidationMessage_H
...
class OAIFileValidationMessage : public OAIObject {
public:
    OAIFileValidationMessage();
    OAIFileValidationMessage(QString json);
    ~OAIFileValidationMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileValidationMessage)

#endif // OAIFileValidationMessage_H
