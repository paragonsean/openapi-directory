...
/*
 * OAIDeleteEntityTypeRequest.h
 *
 * 
 */

#ifndef OAIDeleteEntityTypeRequest_H
#define OAIDeleteEntityTypeRequest_H
...
class OAIDeleteEntityTypeRequest : public OAIObject {
public:
    OAIDeleteEntityTypeRequest();
    OAIDeleteEntityTypeRequest(QString json);
    ~OAIDeleteEntityTypeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEntityTypeRequest)

#endif // OAIDeleteEntityTypeRequest_H
