...
/*
 * OAIDeleteBatchPredictionJobRequest.h
 *
 * 
 */

#ifndef OAIDeleteBatchPredictionJobRequest_H
#define OAIDeleteBatchPredictionJobRequest_H
...
class OAIDeleteBatchPredictionJobRequest : public OAIObject {
public:
    OAIDeleteBatchPredictionJobRequest();
    OAIDeleteBatchPredictionJobRequest(QString json);
    ~OAIDeleteBatchPredictionJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBatchPredictionJobRequest)

#endif // OAIDeleteBatchPredictionJobRequest_H
