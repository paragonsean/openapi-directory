...
/*
 * OAIGetListsMetadataResult.h
 *
 * 
 */

#ifndef OAIGetListsMetadataResult_H
#define OAIGetListsMetadataResult_H
...
class OAIGetListsMetadataResult : public OAIObject {
public:
    OAIGetListsMetadataResult();
    OAIGetListsMetadataResult(QString json);
    ~OAIGetListsMetadataResult() override;
    ...
    QList getLists() const;
    void setLists(const QList &lists);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetListsMetadataResult)

#endif // OAIGetListsMetadataResult_H
