...
/*
 * OAIGetModelsResult.h
 *
 * 
 */

#ifndef OAIGetModelsResult_H
#define OAIGetModelsResult_H
...
class OAIGetModelsResult : public OAIObject {
public:
    OAIGetModelsResult();
    OAIGetModelsResult(QString json);
    ~OAIGetModelsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetModelsResult)

#endif // OAIGetModelsResult_H
