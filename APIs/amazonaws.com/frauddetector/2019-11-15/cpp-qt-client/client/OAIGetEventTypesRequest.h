...
/*
 * OAIGetEventTypesRequest.h
 *
 * 
 */

#ifndef OAIGetEventTypesRequest_H
#define OAIGetEventTypesRequest_H
...
class OAIGetEventTypesRequest : public OAIObject {
public:
    OAIGetEventTypesRequest();
    OAIGetEventTypesRequest(QString json);
    ~OAIGetEventTypesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEventTypesRequest)

#endif // OAIGetEventTypesRequest_H
