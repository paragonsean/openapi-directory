...
/*
 * OAIDeleteVariableRequest.h
 *
 * 
 */

#ifndef OAIDeleteVariableRequest_H
#define OAIDeleteVariableRequest_H
...
class OAIDeleteVariableRequest : public OAIObject {
public:
    OAIDeleteVariableRequest();
    OAIDeleteVariableRequest(QString json);
    ~OAIDeleteVariableRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteVariableRequest)

#endif // OAIDeleteVariableRequest_H
