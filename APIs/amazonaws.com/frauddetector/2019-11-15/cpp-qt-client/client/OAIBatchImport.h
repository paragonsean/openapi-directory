...
#ifndef OAIBatchImport_H
#define OAIBatchImport_H
...
class OAIBatchImport : public OAIObject {
public:
    OAIBatchImport();
    OAIBatchImport(QString json);
    ~OAIBatchImport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchImport)

#endif // OAIBatchImport_H
