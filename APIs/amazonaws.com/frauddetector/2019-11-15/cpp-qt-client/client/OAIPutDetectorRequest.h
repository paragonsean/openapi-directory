...
/*
 * OAIPutDetectorRequest.h
 *
 * 
 */

#ifndef OAIPutDetectorRequest_H
#define OAIPutDetectorRequest_H
...
class OAIPutDetectorRequest : public OAIObject {
public:
    OAIPutDetectorRequest();
    OAIPutDetectorRequest(QString json);
    ~OAIPutDetectorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutDetectorRequest)

#endif // OAIPutDetectorRequest_H
