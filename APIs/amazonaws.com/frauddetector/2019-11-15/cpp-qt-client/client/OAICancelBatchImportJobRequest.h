...
/*
 * OAICancelBatchImportJobRequest.h
 *
 * 
 */

#ifndef OAICancelBatchImportJobRequest_H
#define OAICancelBatchImportJobRequest_H
...
class OAICancelBatchImportJobRequest : public OAIObject {
public:
    OAICancelBatchImportJobRequest();
    OAICancelBatchImportJobRequest(QString json);
    ~OAICancelBatchImportJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelBatchImportJobRequest)

#endif // OAICancelBatchImportJobRequest_H
