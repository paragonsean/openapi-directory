...
/*
 * OAIGetVariablesRequest.h
 *
 * 
 */

#ifndef OAIGetVariablesRequest_H
#define OAIGetVariablesRequest_H
...
class OAIGetVariablesRequest : public OAIObject {
public:
    OAIGetVariablesRequest();
    OAIGetVariablesRequest(QString json);
    ~OAIGetVariablesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVariablesRequest)

#endif // OAIGetVariablesRequest_H
