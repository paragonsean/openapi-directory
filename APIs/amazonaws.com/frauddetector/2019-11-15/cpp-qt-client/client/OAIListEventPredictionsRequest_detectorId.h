...
/*
 * OAIListEventPredictionsRequest_detectorId.h
 *
 * 
 */

#ifndef OAIListEventPredictionsRequest_detectorId_H
#define OAIListEventPredictionsRequest_detectorId_H
...
class OAIListEventPredictionsRequest_detectorId : public OAIObject {
public:
    OAIListEventPredictionsRequest_detectorId();
    OAIListEventPredictionsRequest_detectorId(QString json);
    ~OAIListEventPredictionsRequest_detectorId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventPredictionsRequest_detectorId)

#endif // OAIListEventPredictionsRequest_detectorId_H
