...
OAIDeleteListRequest::OAIDeleteListRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteListRequest::OAIDeleteListRequest() {
    this->initializeModel();
}

OAIDeleteListRequest::~OAIDeleteListRequest() {}

void OAIDeleteListRequest::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIDeleteListRequest::fromJson(QString jsonString) {
...
void OAIDeleteListRequest::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIDeleteListRequest::asJson() const {
...
QJsonObject OAIDeleteListRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDeleteListRequest::getName() const {
    return m_name;
}
void OAIDeleteListRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteListRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteListRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIDeleteListRequest::isSet() const {
...
bool OAIDeleteListRequest::isValid() const {
