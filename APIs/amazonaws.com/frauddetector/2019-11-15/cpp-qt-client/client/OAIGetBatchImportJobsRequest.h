...
/*
 * OAIGetBatchImportJobsRequest.h
 *
 * 
 */

#ifndef OAIGetBatchImportJobsRequest_H
#define OAIGetBatchImportJobsRequest_H
...
class OAIGetBatchImportJobsRequest : public OAIObject {
public:
    OAIGetBatchImportJobsRequest();
    OAIGetBatchImportJobsRequest(QString json);
    ~OAIGetBatchImportJobsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBatchImportJobsRequest)

#endif // OAIGetBatchImportJobsRequest_H
