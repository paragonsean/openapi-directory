...
/*
 * OAICreateModelVersionRequest_externalEventsDetail.h
 *
 * 
 */

#ifndef OAICreateModelVersionRequest_externalEventsDetail_H
#define OAICreateModelVersionRequest_externalEventsDetail_H
...
class OAICreateModelVersionRequest_externalEventsDetail : public OAIObject {
public:
    OAICreateModelVersionRequest_externalEventsDetail();
    OAICreateModelVersionRequest_externalEventsDetail(QString json);
    ~OAICreateModelVersionRequest_externalEventsDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateModelVersionRequest_externalEventsDetail)

#endif // OAICreateModelVersionRequest_externalEventsDetail_H
