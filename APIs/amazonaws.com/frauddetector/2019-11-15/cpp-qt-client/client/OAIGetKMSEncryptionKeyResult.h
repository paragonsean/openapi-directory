...
/*
 * OAIGetKMSEncryptionKeyResult.h
 *
 * 
 */

#ifndef OAIGetKMSEncryptionKeyResult_H
#define OAIGetKMSEncryptionKeyResult_H
...
namespace OpenAPI {
class OAIGetKMSEncryptionKeyResult_kmsKey;

class OAIGetKMSEncryptionKeyResult : public OAIObject {
public:
    OAIGetKMSEncryptionKeyResult();
    OAIGetKMSEncryptionKeyResult(QString json);
    ~OAIGetKMSEncryptionKeyResult() override;
    ...
    OAIGetKMSEncryptionKeyResult_kmsKey getKmsKey() const;
    void setKmsKey(const OAIGetKMSEncryptionKeyResult_kmsKey &kms_key);
...
private:
    ...
    OAIGetKMSEncryptionKeyResult_kmsKey m_kms_key;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetKMSEncryptionKeyResult)

#endif // OAIGetKMSEncryptionKeyResult_H
