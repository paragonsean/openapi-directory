...
/*
 * OAIGetListElementsRequest.h
 *
 * 
 */

#ifndef OAIGetListElementsRequest_H
#define OAIGetListElementsRequest_H
...
class OAIGetListElementsRequest : public OAIObject {
public:
    OAIGetListElementsRequest();
    OAIGetListElementsRequest(QString json);
    ~OAIGetListElementsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetListElementsRequest)

#endif // OAIGetListElementsRequest_H
