...
/*
 * OAIDeleteEventRequest.h
 *
 * 
 */

#ifndef OAIDeleteEventRequest_H
#define OAIDeleteEventRequest_H
...
class OAIDeleteEventRequest : public OAIObject {
public:
    OAIDeleteEventRequest();
    OAIDeleteEventRequest(QString json);
    ~OAIDeleteEventRequest() override;
    ...
    void setDeleteAuditHistory(const bool &delete_audit_history);
    bool is_delete_audit_history_Set() const;
    bool is_delete_audit_history_Valid() const;
...
private:
    ...
    bool m_delete_audit_history;
    bool m_delete_audit_history_isSet;
    bool m_delete_audit_history_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEventRequest)

#endif // OAIDeleteEventRequest_H
