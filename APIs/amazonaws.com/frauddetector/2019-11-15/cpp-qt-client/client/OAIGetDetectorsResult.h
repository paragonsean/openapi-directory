...
/*
 * OAIGetDetectorsResult.h
 *
 * 
 */

#ifndef OAIGetDetectorsResult_H
#define OAIGetDetectorsResult_H
...
class OAIGetDetectorsResult : public OAIObject {
public:
    OAIGetDetectorsResult();
    OAIGetDetectorsResult(QString json);
    ~OAIGetDetectorsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDetectorsResult)

#endif // OAIGetDetectorsResult_H
