...
OAIGetModelVersionResult_externalEventsDetail::OAIGetModelVersionResult_externalEventsDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetModelVersionResult_externalEventsDetail::OAIGetModelVersionResult_externalEventsDetail() {
    this->initializeModel();
}

OAIGetModelVersionResult_externalEventsDetail::~OAIGetModelVersionResult_externalEventsDetail() {}

void OAIGetModelVersionResult_externalEventsDetail::initializeModel() {
...
void OAIGetModelVersionResult_externalEventsDetail::fromJson(QString jsonString) {
...
void OAIGetModelVersionResult_externalEventsDetail::fromJsonObject(QJsonObject json) {
...
QString OAIGetModelVersionResult_externalEventsDetail::asJson() const {
...
QJsonObject OAIGetModelVersionResult_externalEventsDetail::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetModelVersionResult_externalEventsDetail::getDataLocation() const {
    return m_data_location;
}
void OAIGetModelVersionResult_externalEventsDetail::setDataLocation(const QString &data_location) {
    m_data_location = data_location;
    m_data_location_isSet = true;
}

bool OAIGetModelVersionResult_externalEventsDetail::is_data_location_Set() const{
    return m_data_location_isSet;
}

bool OAIGetModelVersionResult_externalEventsDetail::is_data_location_Valid() const{
    return m_data_location_isValid;
}

QString OAIGetModelVersionResult_externalEventsDetail::getDataAccessRoleArn() const {
    return m_data_access_role_arn;
}
void OAIGetModelVersionResult_externalEventsDetail::setDataAccessRoleArn(const QString &data_access_role_arn) {
    m_data_access_role_arn = data_access_role_arn;
    m_data_access_role_arn_isSet = true;
}

bool OAIGetModelVersionResult_externalEventsDetail::is_data_access_role_arn_Set() const{
    return m_data_access_role_arn_isSet;
}

bool OAIGetModelVersionResult_externalEventsDetail::is_data_access_role_arn_Valid() const{
    return m_data_access_role_arn_isValid;
}

bool OAIGetModelVersionResult_externalEventsDetail::isSet() const {
...
bool OAIGetModelVersionResult_externalEventsDetail::isValid() const {
