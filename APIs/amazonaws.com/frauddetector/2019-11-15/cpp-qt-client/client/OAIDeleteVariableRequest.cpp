...
OAIDeleteVariableRequest::OAIDeleteVariableRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteVariableRequest::OAIDeleteVariableRequest() {
    this->initializeModel();
}

OAIDeleteVariableRequest::~OAIDeleteVariableRequest() {}

void OAIDeleteVariableRequest::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIDeleteVariableRequest::fromJson(QString jsonString) {
...
void OAIDeleteVariableRequest::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIDeleteVariableRequest::asJson() const {
...
QJsonObject OAIDeleteVariableRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDeleteVariableRequest::getName() const {
    return m_name;
}
void OAIDeleteVariableRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteVariableRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteVariableRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIDeleteVariableRequest::isSet() const {
...
bool OAIDeleteVariableRequest::isValid() const {
