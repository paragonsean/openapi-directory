...
/*
 * OAICancelBatchPredictionJobRequest.h
 *
 * 
 */

#ifndef OAICancelBatchPredictionJobRequest_H
#define OAICancelBatchPredictionJobRequest_H
...
class OAICancelBatchPredictionJobRequest : public OAIObject {
public:
    OAICancelBatchPredictionJobRequest();
    OAICancelBatchPredictionJobRequest(QString json);
    ~OAICancelBatchPredictionJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelBatchPredictionJobRequest)

#endif // OAICancelBatchPredictionJobRequest_H
