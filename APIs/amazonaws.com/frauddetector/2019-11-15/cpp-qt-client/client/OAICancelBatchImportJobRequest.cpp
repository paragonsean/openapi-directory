...
OAICancelBatchImportJobRequest::OAICancelBatchImportJobRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICancelBatchImportJobRequest::OAICancelBatchImportJobRequest() {
    this->initializeModel();
}

OAICancelBatchImportJobRequest::~OAICancelBatchImportJobRequest() {}

void OAICancelBatchImportJobRequest::initializeModel() {

    m_job_id_isSet = false;
    m_job_id_isValid = false;
}

void OAICancelBatchImportJobRequest::fromJson(QString jsonString) {
...
void OAICancelBatchImportJobRequest::fromJsonObject(QJsonObject json) {

    m_job_id_isValid = ::OpenAPI::fromJsonValue(m_job_id, json[QString("jobId")]);
    m_job_id_isSet = !json[QString("jobId")].isNull() && m_job_id_isValid;
}

QString OAICancelBatchImportJobRequest::asJson() const {
...
QJsonObject OAICancelBatchImportJobRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAICancelBatchImportJobRequest::getJobId() const {
    return m_job_id;
}
void OAICancelBatchImportJobRequest::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAICancelBatchImportJobRequest::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAICancelBatchImportJobRequest::is_job_id_Valid() const{
    return m_job_id_isValid;
}

bool OAICancelBatchImportJobRequest::isSet() const {
...
bool OAICancelBatchImportJobRequest::isValid() const {
