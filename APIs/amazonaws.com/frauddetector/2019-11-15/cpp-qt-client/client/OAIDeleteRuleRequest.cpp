...
OAIRule OAIDeleteRuleRequest::getRule() const {
    return m_rule;
}
void OAIDeleteRuleRequest::setRule(const OAIRule &rule) {
    m_rule = rule;
    m_rule_isSet = true;
}

bool OAIDeleteRuleRequest::is_rule_Set() const{
    return m_rule_isSet;
}

bool OAIDeleteRuleRequest::is_rule_Valid() const{
