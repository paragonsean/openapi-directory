...
/*
 * OAIATITrainingMetricsValue_modelPerformance.h
 *
 * 
 */

#ifndef OAIATITrainingMetricsValue_modelPerformance_H
#define OAIATITrainingMetricsValue_modelPerformance_H
...
class OAIATITrainingMetricsValue_modelPerformance : public OAIObject {
public:
    OAIATITrainingMetricsValue_modelPerformance();
    OAIATITrainingMetricsValue_modelPerformance(QString json);
    ~OAIATITrainingMetricsValue_modelPerformance() override;
    ...
    float getAsi() const;
    void setAsi(const float &asi);
    bool is_asi_Set() const;
    bool is_asi_Valid() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAIATITrainingMetricsValue_modelPerformance)

#endif // OAIATITrainingMetricsValue_modelPerformance_H
