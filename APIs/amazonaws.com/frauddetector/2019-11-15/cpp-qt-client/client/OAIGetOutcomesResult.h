...
/*
 * OAIGetOutcomesResult.h
 *
 * 
 */

#ifndef OAIGetOutcomesResult_H
#define OAIGetOutcomesResult_H
...
class OAIGetOutcomesResult : public OAIObject {
public:
    OAIGetOutcomesResult();
    OAIGetOutcomesResult(QString json);
    ~OAIGetOutcomesResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOutcomesResult)

#endif // OAIGetOutcomesResult_H
