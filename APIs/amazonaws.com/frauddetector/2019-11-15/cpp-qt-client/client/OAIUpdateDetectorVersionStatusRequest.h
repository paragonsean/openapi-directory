...
/*
 * OAIUpdateDetectorVersionStatusRequest.h
 *
 * 
 */

#ifndef OAIUpdateDetectorVersionStatusRequest_H
#define OAIUpdateDetectorVersionStatusRequest_H
...
class OAIUpdateDetectorVersionStatusRequest : public OAIObject {
public:
    OAIUpdateDetectorVersionStatusRequest();
    OAIUpdateDetectorVersionStatusRequest(QString json);
    ~OAIUpdateDetectorVersionStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDetectorVersionStatusRequest)

#endif // OAIUpdateDetectorVersionStatusRequest_H
