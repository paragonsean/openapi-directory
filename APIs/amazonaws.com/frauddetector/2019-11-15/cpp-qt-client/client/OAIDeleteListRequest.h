...
/*
 * OAIDeleteListRequest.h
 *
 * 
 */

#ifndef OAIDeleteListRequest_H
#define OAIDeleteListRequest_H
...
class OAIDeleteListRequest : public OAIObject {
public:
    OAIDeleteListRequest();
    OAIDeleteListRequest(QString json);
    ~OAIDeleteListRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteListRequest)

#endif // OAIDeleteListRequest_H
