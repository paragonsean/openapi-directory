...
#ifndef OAIEventIngestion_H
#define OAIEventIngestion_H
...
class OAIEventIngestion : public OAIEnum {
public:
    OAIEventIngestion();
    OAIEventIngestion(QString json);
    ~OAIEventIngestion() override;
    ...
    enum class eOAIEventIngestion {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ENABLED, 
        DISABLED
    };
    OAIEventIngestion::eOAIEventIngestion getValue() const;
    void setValue(const OAIEventIngestion::eOAIEventIngestion& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventIngestion)

#endif // OAIEventIngestion_H
