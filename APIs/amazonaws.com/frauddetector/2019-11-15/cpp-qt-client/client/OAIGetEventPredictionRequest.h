...
/*
 * OAIGetEventPredictionRequest.h
 *
 * 
 */

#ifndef OAIGetEventPredictionRequest_H
#define OAIGetEventPredictionRequest_H
...
class OAIGetEventPredictionRequest : public OAIObject {
public:
    OAIGetEventPredictionRequest();
    OAIGetEventPredictionRequest(QString json);
    ~OAIGetEventPredictionRequest() override;
    ...
    QMap getExternalModelEndpointDataBlobs() const;
    void setExternalModelEndpointDataBlobs(const QMap &external_model_endpoint_data_blobs);
    bool is_external_model_endpoint_data_blobs_Set() const;
    bool is_external_model_endpoint_data_blobs_Valid() const;
...
private:
    ...
    QMap m_external_model_endpoint_data_blobs;
    bool m_external_model_endpoint_data_blobs_isSet;
    bool m_external_model_endpoint_data_blobs_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetEventPredictionRequest)

#endif // OAIGetEventPredictionRequest_H
