...
/*
 * OAIIngestedEventStatistics.h
 *
 * Data about the stored events.
 */

#ifndef OAIIngestedEventStatistics_H
#define OAIIngestedEventStatistics_H
...
class OAIIngestedEventStatistics : public OAIObject {
public:
    OAIIngestedEventStatistics();
    OAIIngestedEventStatistics(QString json);
    ~OAIIngestedEventStatistics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIngestedEventStatistics)

#endif // OAIIngestedEventStatistics_H
