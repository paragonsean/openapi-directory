...
/*
 * OAIListEventPredictionsRequest_predictionTimeRange.h
 *
 * 
 */

#ifndef OAIListEventPredictionsRequest_predictionTimeRange_H
#define OAIListEventPredictionsRequest_predictionTimeRange_H
...
class OAIListEventPredictionsRequest_predictionTimeRange : public OAIObject {
public:
    OAIListEventPredictionsRequest_predictionTimeRange();
    OAIListEventPredictionsRequest_predictionTimeRange(QString json);
    ~OAIListEventPredictionsRequest_predictionTimeRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventPredictionsRequest_predictionTimeRange)

#endif // OAIListEventPredictionsRequest_predictionTimeRange_H
