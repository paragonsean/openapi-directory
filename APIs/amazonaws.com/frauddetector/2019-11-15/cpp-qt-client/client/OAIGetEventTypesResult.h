...
/*
 * OAIGetEventTypesResult.h
 *
 * 
 */

#ifndef OAIGetEventTypesResult_H
#define OAIGetEventTypesResult_H
...
class OAIGetEventTypesResult : public OAIObject {
public:
    OAIGetEventTypesResult();
    OAIGetEventTypesResult(QString json);
    ~OAIGetEventTypesResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEventTypesResult)

#endif // OAIGetEventTypesResult_H
