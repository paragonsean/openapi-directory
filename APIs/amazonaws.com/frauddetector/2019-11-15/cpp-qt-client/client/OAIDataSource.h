...
class OAIDataSource : public OAIEnum {
public:
    OAIDataSource();
    ...
    enum class eOAIDataSource {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        EVENT, 
        MODEL_SCORE, 
        EXTERNAL_MODEL_SCORE
    };
    OAIDataSource::eOAIDataSource getValue() const;
    void setValue(const OAIDataSource::eOAIDataSource& value);
