...
#ifndef OAILogOddsMetric_H
#define OAILogOddsMetric_H
...
class OAILogOddsMetric : public OAIObject {
public:
    OAILogOddsMetric();
    OAILogOddsMetric(QString json);
    ~OAILogOddsMetric() override;
    ...
    float getVariableImportance() const;
    void setVariableImportance(const float &variable_importance);
    bool is_variable_importance_Set() const;
    bool is_variable_importance_Valid() const;
...
private:
    ...
    float m_variable_importance;
    bool m_variable_importance_isSet;
    bool m_variable_importance_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAILogOddsMetric)

#endif // OAILogOddsMetric_H
