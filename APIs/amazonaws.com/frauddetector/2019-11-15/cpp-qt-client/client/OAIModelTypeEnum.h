...
#ifndef OAIModelTypeEnum_H
#define OAIModelTypeEnum_H
...
class OAIModelTypeEnum : public OAIEnum {
public:
    OAIModelTypeEnum();
    OAIModelTypeEnum(QString json);
    ~OAIModelTypeEnum() override;
    ...
    enum class eOAIModelTypeEnum {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ONLINE_FRAUD_INSIGHTS, 
        TRANSACTION_FRAUD_INSIGHTS, 
        ACCOUNT_TAKEOVER_INSIGHTS
    };
    OAIModelTypeEnum::eOAIModelTypeEnum getValue() const;
    void setValue(const OAIModelTypeEnum::eOAIModelTypeEnum& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelTypeEnum)

#endif // OAIModelTypeEnum_H
