...
/*
 * OAIListEventPredictionsRequest_detectorVersionId.h
 *
 * 
 */

#ifndef OAIListEventPredictionsRequest_detectorVersionId_H
#define OAIListEventPredictionsRequest_detectorVersionId_H
...
class OAIListEventPredictionsRequest_detectorVersionId : public OAIObject {
public:
    OAIListEventPredictionsRequest_detectorVersionId();
    OAIListEventPredictionsRequest_detectorVersionId(QString json);
    ~OAIListEventPredictionsRequest_detectorVersionId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventPredictionsRequest_detectorVersionId)

#endif // OAIListEventPredictionsRequest_detectorVersionId_H
