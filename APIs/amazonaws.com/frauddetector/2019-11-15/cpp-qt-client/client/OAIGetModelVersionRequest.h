...
/*
 * OAIGetModelVersionRequest.h
 *
 * 
 */

#ifndef OAIGetModelVersionRequest_H
#define OAIGetModelVersionRequest_H
...
class OAIGetModelVersionRequest : public OAIObject {
public:
    OAIGetModelVersionRequest();
    OAIGetModelVersionRequest(QString json);
    ~OAIGetModelVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetModelVersionRequest)

#endif // OAIGetModelVersionRequest_H
