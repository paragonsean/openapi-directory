...
/*
 * OAIDeleteEventTypeRequest.h
 *
 * 
 */

#ifndef OAIDeleteEventTypeRequest_H
#define OAIDeleteEventTypeRequest_H
...
class OAIDeleteEventTypeRequest : public OAIObject {
public:
    OAIDeleteEventTypeRequest();
    OAIDeleteEventTypeRequest(QString json);
    ~OAIDeleteEventTypeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEventTypeRequest)

#endif // OAIDeleteEventTypeRequest_H
