...
/*
 * OAITrainingMetrics.h
 *
 * The training metric details.
 */

#ifndef OAITrainingMetrics_H
#define OAITrainingMetrics_H
...
class OAITrainingMetrics : public OAIObject {
public:
    OAITrainingMetrics();
    OAITrainingMetrics(QString json);
    ~OAITrainingMetrics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingMetrics)

#endif // OAITrainingMetrics_H
