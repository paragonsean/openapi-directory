...
/*
 * OAIPredictionTimeRange.h
 *
 *  The time period for when the predictions were generated. 
 */

#ifndef OAIPredictionTimeRange_H
#define OAIPredictionTimeRange_H
...
class OAIPredictionTimeRange : public OAIObject {
public:
    OAIPredictionTimeRange();
    OAIPredictionTimeRange(QString json);
    ~OAIPredictionTimeRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPredictionTimeRange)

#endif // OAIPredictionTimeRange_H
