...
/*
 * OAIDescribeDetectorResult.h
 *
 * 
 */

#ifndef OAIDescribeDetectorResult_H
#define OAIDescribeDetectorResult_H
...
class OAIDescribeDetectorResult : public OAIObject {
public:
    OAIDescribeDetectorResult();
    OAIDescribeDetectorResult(QString json);
    ~OAIDescribeDetectorResult() override;
    ...
    QList getDetectorVersionSummaries() const;
    void setDetectorVersionSummaries(const QList &detector_version_summaries);
    bool is_detector_version_summaries_Set() const;
    bool is_detector_version_summaries_Valid() const;
...
private:
    ...
    QList m_detector_version_summaries;
    bool m_detector_version_summaries_isSet;
    bool m_detector_version_summaries_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDetectorResult)

#endif // OAIDescribeDetectorResult_H
