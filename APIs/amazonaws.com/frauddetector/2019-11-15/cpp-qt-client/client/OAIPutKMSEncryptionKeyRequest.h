...
/*
 * OAIPutKMSEncryptionKeyRequest.h
 *
 * 
 */

#ifndef OAIPutKMSEncryptionKeyRequest_H
#define OAIPutKMSEncryptionKeyRequest_H
...
class OAIPutKMSEncryptionKeyRequest : public OAIObject {
public:
    OAIPutKMSEncryptionKeyRequest();
    OAIPutKMSEncryptionKeyRequest(QString json);
    ~OAIPutKMSEncryptionKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutKMSEncryptionKeyRequest)

#endif // OAIPutKMSEncryptionKeyRequest_H
