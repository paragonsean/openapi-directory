...
/*
 * OAIGetExternalModelsResult.h
 *
 * 
 */

#ifndef OAIGetExternalModelsResult_H
#define OAIGetExternalModelsResult_H
...
class OAIGetExternalModelsResult : public OAIObject {
public:
    OAIGetExternalModelsResult();
    OAIGetExternalModelsResult(QString json);
    ~OAIGetExternalModelsResult() override;
    ...
    QList getExternalModels() const;
    void setExternalModels(const QList &external_models);
    bool is_external_models_Set() const;
    bool is_external_models_Valid() const;
...
private:
    ...
    QList m_external_models;
    bool m_external_models_isSet;
    bool m_external_models_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetExternalModelsResult)

#endif // OAIGetExternalModelsResult_H
