...
/*
 * OAIGetDetectorsRequest.h
 *
 * 
 */

#ifndef OAIGetDetectorsRequest_H
#define OAIGetDetectorsRequest_H
...
class OAIGetDetectorsRequest : public OAIObject {
public:
    OAIGetDetectorsRequest();
    OAIGetDetectorsRequest(QString json);
    ~OAIGetDetectorsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDetectorsRequest)

#endif // OAIGetDetectorsRequest_H
