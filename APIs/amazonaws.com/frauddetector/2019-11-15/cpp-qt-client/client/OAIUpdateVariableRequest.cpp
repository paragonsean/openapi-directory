...
OAIUpdateVariableRequest::OAIUpdateVariableRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateVariableRequest::OAIUpdateVariableRequest() {
    this->initializeModel();
}

OAIUpdateVariableRequest::~OAIUpdateVariableRequest() {}

void OAIUpdateVariableRequest::initializeModel() {
...
void OAIUpdateVariableRequest::fromJson(QString jsonString) {
...
void OAIUpdateVariableRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateVariableRequest::asJson() const {
...
QJsonObject OAIUpdateVariableRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIUpdateVariableRequest::getName() const {
    return m_name;
}
void OAIUpdateVariableRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateVariableRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateVariableRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateVariableRequest::getDefaultValue() const {
    return m_default_value;
}
void OAIUpdateVariableRequest::setDefaultValue(const QString &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIUpdateVariableRequest::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIUpdateVariableRequest::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIUpdateVariableRequest::getDescription() const {
    return m_description;
}
void OAIUpdateVariableRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateVariableRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateVariableRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateVariableRequest::getVariableType() const {
    return m_variable_type;
}
void OAIUpdateVariableRequest::setVariableType(const QString &variable_type) {
    m_variable_type = variable_type;
    m_variable_type_isSet = true;
}

bool OAIUpdateVariableRequest::is_variable_type_Set() const{
    return m_variable_type_isSet;
}

bool OAIUpdateVariableRequest::is_variable_type_Valid() const{
    return m_variable_type_isValid;
}

bool OAIUpdateVariableRequest::isSet() const {
...
bool OAIUpdateVariableRequest::isValid() const {
