...
/*
 * OAITrainingDataSourceEnum.h
 *
 * 
 */

#ifndef OAITrainingDataSourceEnum_H
#define OAITrainingDataSourceEnum_H
...
class OAITrainingDataSourceEnum : public OAIEnum {
public:
    OAITrainingDataSourceEnum();
    OAITrainingDataSourceEnum(QString json);
    ~OAITrainingDataSourceEnum() override;
    ...
    enum class eOAITrainingDataSourceEnum {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        EXTERNAL_EVENTS, 
        INGESTED_EVENTS
    };
    OAITrainingDataSourceEnum::eOAITrainingDataSourceEnum getValue() const;
    void setValue(const OAITrainingDataSourceEnum::eOAITrainingDataSourceEnum& value);
...
private:
    ...
    eOAITrainingDataSourceEnum m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingDataSourceEnum)

#endif // OAITrainingDataSourceEnum_H
