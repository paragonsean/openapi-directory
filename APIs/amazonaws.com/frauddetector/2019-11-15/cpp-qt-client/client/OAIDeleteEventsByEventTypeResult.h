...
/*
 * OAIDeleteEventsByEventTypeResult.h
 *
 * 
 */

#ifndef OAIDeleteEventsByEventTypeResult_H
#define OAIDeleteEventsByEventTypeResult_H
...
class OAIDeleteEventsByEventTypeResult : public OAIObject {
public:
    OAIDeleteEventsByEventTypeResult();
    OAIDeleteEventsByEventTypeResult(QString json);
    ~OAIDeleteEventsByEventTypeResult() override;
    ...
    QString getEventsDeletionStatus() const;
    void setEventsDeletionStatus(const QString &events_deletion_status);
    bool is_events_deletion_status_Set() const;
    bool is_events_deletion_status_Valid() const;
...
private:
    ...
    QString m_events_deletion_status;
    bool m_events_deletion_status_isSet;
    bool m_events_deletion_status_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEventsByEventTypeResult)

#endif // OAIDeleteEventsByEventTypeResult_H
