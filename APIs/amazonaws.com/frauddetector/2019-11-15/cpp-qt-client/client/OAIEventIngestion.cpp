...
OAIEventIngestion::OAIEventIngestion(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventIngestion::OAIEventIngestion() {
    this->initializeModel();
}

OAIEventIngestion::~OAIEventIngestion() {}

void OAIEventIngestion::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEventIngestion::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEventIngestion::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ENABLED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventIngestion::ENABLED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DISABLED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventIngestion::DISABLED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEventIngestion::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEventIngestion::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEventIngestion::ENABLED:
            val = "ENABLED";
            break;
        case eOAIEventIngestion::DISABLED:
            val = "DISABLED";
            break;
        default:
            break;
...
QJsonValue OAIEventIngestion::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEventIngestion::eOAIEventIngestion OAIEventIngestion::getValue() const {
    return m_value;
}

void OAIEventIngestion::setValue(const OAIEventIngestion::eOAIEventIngestion& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEventIngestion::isSet() const {
    
    return m_value_isSet;
}

bool OAIEventIngestion::isValid() const {
