...
/*
 * OAIBatchGetVariableRequest.h
 *
 * 
 */

#ifndef OAIBatchGetVariableRequest_H
#define OAIBatchGetVariableRequest_H
...
class OAIBatchGetVariableRequest : public OAIObject {
public:
    OAIBatchGetVariableRequest();
    OAIBatchGetVariableRequest(QString json);
    ~OAIBatchGetVariableRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetVariableRequest)

#endif // OAIBatchGetVariableRequest_H
