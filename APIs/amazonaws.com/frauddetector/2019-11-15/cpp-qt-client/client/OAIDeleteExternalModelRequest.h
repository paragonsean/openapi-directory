...
/*
 * OAIDeleteExternalModelRequest.h
 *
 * 
 */

#ifndef OAIDeleteExternalModelRequest_H
#define OAIDeleteExternalModelRequest_H
...
class OAIDeleteExternalModelRequest : public OAIObject {
public:
    OAIDeleteExternalModelRequest();
    OAIDeleteExternalModelRequest(QString json);
    ~OAIDeleteExternalModelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteExternalModelRequest)

#endif // OAIDeleteExternalModelRequest_H
