...
OAIBatchImport::OAIBatchImport(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchImport::OAIBatchImport() {
    this->initializeModel();
}

OAIBatchImport::~OAIBatchImport() {}

void OAIBatchImport::initializeModel() {
...
void OAIBatchImport::fromJson(QString jsonString) {
...
void OAIBatchImport::fromJsonObject(QJsonObject json) {
...
QString OAIBatchImport::asJson() const {
...
QJsonObject OAIBatchImport::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIBatchImport::getJobId() const {
    return m_job_id;
}
void OAIBatchImport::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIBatchImport::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIBatchImport::is_job_id_Valid() const{
    return m_job_id_isValid;
}

OAIAsyncJobStatus OAIBatchImport::getStatus() const {
    return m_status;
}
void OAIBatchImport::setStatus(const OAIAsyncJobStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBatchImport::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBatchImport::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIBatchImport::getFailureReason() const {
    return m_failure_reason;
}
void OAIBatchImport::setFailureReason(const QString &failure_reason) {
    m_failure_reason = failure_reason;
    m_failure_reason_isSet = true;
}

bool OAIBatchImport::is_failure_reason_Set() const{
    return m_failure_reason_isSet;
}

bool OAIBatchImport::is_failure_reason_Valid() const{
    return m_failure_reason_isValid;
}

QString OAIBatchImport::getStartTime() const {
    return m_start_time;
}
void OAIBatchImport::setStartTime(const QString &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIBatchImport::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIBatchImport::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QString OAIBatchImport::getCompletionTime() const {
    return m_completion_time;
}
void OAIBatchImport::setCompletionTime(const QString &completion_time) {
    m_completion_time = completion_time;
    m_completion_time_isSet = true;
}

bool OAIBatchImport::is_completion_time_Set() const{
    return m_completion_time_isSet;
}

bool OAIBatchImport::is_completion_time_Valid() const{
    return m_completion_time_isValid;
}

QString OAIBatchImport::getInputPath() const {
    return m_input_path;
}
void OAIBatchImport::setInputPath(const QString &input_path) {
    m_input_path = input_path;
    m_input_path_isSet = true;
}

bool OAIBatchImport::is_input_path_Set() const{
    return m_input_path_isSet;
}

bool OAIBatchImport::is_input_path_Valid() const{
    return m_input_path_isValid;
}

QString OAIBatchImport::getOutputPath() const {
    return m_output_path;
}
void OAIBatchImport::setOutputPath(const QString &output_path) {
    m_output_path = output_path;
    m_output_path_isSet = true;
}

bool OAIBatchImport::is_output_path_Set() const{
    return m_output_path_isSet;
}

bool OAIBatchImport::is_output_path_Valid() const{
    return m_output_path_isValid;
}

QString OAIBatchImport::getEventTypeName() const {
    return m_event_type_name;
}
void OAIBatchImport::setEventTypeName(const QString &event_type_name) {
    m_event_type_name = event_type_name;
    m_event_type_name_isSet = true;
}

bool OAIBatchImport::is_event_type_name_Set() const{
    return m_event_type_name_isSet;
}

bool OAIBatchImport::is_event_type_name_Valid() const{
    return m_event_type_name_isValid;
}

QString OAIBatchImport::getIamRoleArn() const {
    return m_iam_role_arn;
}
void OAIBatchImport::setIamRoleArn(const QString &iam_role_arn) {
    m_iam_role_arn = iam_role_arn;
    m_iam_role_arn_isSet = true;
}

bool OAIBatchImport::is_iam_role_arn_Set() const{
    return m_iam_role_arn_isSet;
}

bool OAIBatchImport::is_iam_role_arn_Valid() const{
    return m_iam_role_arn_isValid;
}

QString OAIBatchImport::getArn() const {
    return m_arn;
}
void OAIBatchImport::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIBatchImport::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIBatchImport::is_arn_Valid() const{
    return m_arn_isValid;
}

qint32 OAIBatchImport::getProcessedRecordsCount() const {
    return m_processed_records_count;
}
void OAIBatchImport::setProcessedRecordsCount(const qint32 &processed_records_count) {
    m_processed_records_count = processed_records_count;
    m_processed_records_count_isSet = true;
}

bool OAIBatchImport::is_processed_records_count_Set() const{
    return m_processed_records_count_isSet;
}

bool OAIBatchImport::is_processed_records_count_Valid() const{
    return m_processed_records_count_isValid;
}

qint32 OAIBatchImport::getFailedRecordsCount() const {
    return m_failed_records_count;
}
void OAIBatchImport::setFailedRecordsCount(const qint32 &failed_records_count) {
    m_failed_records_count = failed_records_count;
    m_failed_records_count_isSet = true;
}

bool OAIBatchImport::is_failed_records_count_Set() const{
    return m_failed_records_count_isSet;
}

bool OAIBatchImport::is_failed_records_count_Valid() const{
    return m_failed_records_count_isValid;
}

qint32 OAIBatchImport::getTotalRecordsCount() const {
    return m_total_records_count;
}
void OAIBatchImport::setTotalRecordsCount(const qint32 &total_records_count) {
    m_total_records_count = total_records_count;
    m_total_records_count_isSet = true;
}

bool OAIBatchImport::is_total_records_count_Set() const{
    return m_total_records_count_isSet;
}

bool OAIBatchImport::is_total_records_count_Valid() const{
    return m_total_records_count_isValid;
}

bool OAIBatchImport::isSet() const {
...
bool OAIBatchImport::isValid() const {
