...
QString OAIRule::getDetectorId() const {
    return m_detector_id;
}
void OAIRule::setDetectorId(const QString &detector_id) {
    m_detector_id = detector_id;
    m_detector_id_isSet = true;
}

bool OAIRule::is_detector_id_Set() const{
    return m_detector_id_isSet;
}

bool OAIRule::is_detector_id_Valid() const{
...
QString OAIRule::getRuleVersion() const {
    return m_rule_version;
}
void OAIRule::setRuleVersion(const QString &rule_version) {
    m_rule_version = rule_version;
    m_rule_version_isSet = true;
}

bool OAIRule::is_rule_version_Set() const{
    return m_rule_version_isSet;
}

bool OAIRule::is_rule_version_Valid() const{
