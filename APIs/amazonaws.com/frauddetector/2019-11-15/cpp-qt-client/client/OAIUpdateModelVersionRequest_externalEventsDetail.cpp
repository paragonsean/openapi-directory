...
OAIUpdateModelVersionRequest_externalEventsDetail::OAIUpdateModelVersionRequest_externalEventsDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateModelVersionRequest_externalEventsDetail::OAIUpdateModelVersionRequest_externalEventsDetail() {
    this->initializeModel();
}

OAIUpdateModelVersionRequest_externalEventsDetail::~OAIUpdateModelVersionRequest_externalEventsDetail() {}

void OAIUpdateModelVersionRequest_externalEventsDetail::initializeModel() {
...
void OAIUpdateModelVersionRequest_externalEventsDetail::fromJson(QString jsonString) {
...
void OAIUpdateModelVersionRequest_externalEventsDetail::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateModelVersionRequest_externalEventsDetail::asJson() const {
...
QJsonObject OAIUpdateModelVersionRequest_externalEventsDetail::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateModelVersionRequest_externalEventsDetail::getDataLocation() const {
    return m_data_location;
}
void OAIUpdateModelVersionRequest_externalEventsDetail::setDataLocation(const QString &data_location) {
    m_data_location = data_location;
    m_data_location_isSet = true;
}

bool OAIUpdateModelVersionRequest_externalEventsDetail::is_data_location_Set() const{
    return m_data_location_isSet;
}

bool OAIUpdateModelVersionRequest_externalEventsDetail::is_data_location_Valid() const{
    return m_data_location_isValid;
}

QString OAIUpdateModelVersionRequest_externalEventsDetail::getDataAccessRoleArn() const {
    return m_data_access_role_arn;
}
void OAIUpdateModelVersionRequest_externalEventsDetail::setDataAccessRoleArn(const QString &data_access_role_arn) {
    m_data_access_role_arn = data_access_role_arn;
    m_data_access_role_arn_isSet = true;
}

bool OAIUpdateModelVersionRequest_externalEventsDetail::is_data_access_role_arn_Set() const{
    return m_data_access_role_arn_isSet;
}

bool OAIUpdateModelVersionRequest_externalEventsDetail::is_data_access_role_arn_Valid() const{
    return m_data_access_role_arn_isValid;
}

bool OAIUpdateModelVersionRequest_externalEventsDetail::isSet() const {
...
bool OAIUpdateModelVersionRequest_externalEventsDetail::isValid() const {
