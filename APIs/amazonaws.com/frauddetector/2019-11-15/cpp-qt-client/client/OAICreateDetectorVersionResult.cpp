...
OAICreateDetectorVersionResult::OAICreateDetectorVersionResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateDetectorVersionResult::OAICreateDetectorVersionResult() {
    this->initializeModel();
}

OAICreateDetectorVersionResult::~OAICreateDetectorVersionResult() {}

void OAICreateDetectorVersionResult::initializeModel() {
...
void OAICreateDetectorVersionResult::fromJson(QString jsonString) {
...
void OAICreateDetectorVersionResult::fromJsonObject(QJsonObject json) {
...
QString OAICreateDetectorVersionResult::asJson() const {
...
QJsonObject OAICreateDetectorVersionResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateDetectorVersionResult::getDetectorId() const {
    return m_detector_id;
}
void OAICreateDetectorVersionResult::setDetectorId(const QString &detector_id) {
    m_detector_id = detector_id;
    m_detector_id_isSet = true;
}

bool OAICreateDetectorVersionResult::is_detector_id_Set() const{
    return m_detector_id_isSet;
}

bool OAICreateDetectorVersionResult::is_detector_id_Valid() const{
    return m_detector_id_isValid;
}

QString OAICreateDetectorVersionResult::getDetectorVersionId() const {
    return m_detector_version_id;
}
void OAICreateDetectorVersionResult::setDetectorVersionId(const QString &detector_version_id) {
    m_detector_version_id = detector_version_id;
    m_detector_version_id_isSet = true;
}

bool OAICreateDetectorVersionResult::is_detector_version_id_Set() const{
    return m_detector_version_id_isSet;
}

bool OAICreateDetectorVersionResult::is_detector_version_id_Valid() const{
    return m_detector_version_id_isValid;
}

OAIDetectorVersionStatus OAICreateDetectorVersionResult::getStatus() const {
    return m_status;
}
void OAICreateDetectorVersionResult::setStatus(const OAIDetectorVersionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateDetectorVersionResult::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateDetectorVersionResult::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICreateDetectorVersionResult::isSet() const {
...
bool OAICreateDetectorVersionResult::isValid() const {
