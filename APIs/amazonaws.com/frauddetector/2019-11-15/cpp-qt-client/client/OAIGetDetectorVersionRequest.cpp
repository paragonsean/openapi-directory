...
OAIGetDetectorVersionRequest::OAIGetDetectorVersionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDetectorVersionRequest::OAIGetDetectorVersionRequest() {
    this->initializeModel();
}

OAIGetDetectorVersionRequest::~OAIGetDetectorVersionRequest() {}

void OAIGetDetectorVersionRequest::initializeModel() {
...
void OAIGetDetectorVersionRequest::fromJson(QString jsonString) {
...
void OAIGetDetectorVersionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetDetectorVersionRequest::asJson() const {
...
QJsonObject OAIGetDetectorVersionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetDetectorVersionRequest::getDetectorId() const {
    return m_detector_id;
}
void OAIGetDetectorVersionRequest::setDetectorId(const QString &detector_id) {
    m_detector_id = detector_id;
    m_detector_id_isSet = true;
}

bool OAIGetDetectorVersionRequest::is_detector_id_Set() const{
    return m_detector_id_isSet;
}

bool OAIGetDetectorVersionRequest::is_detector_id_Valid() const{
    return m_detector_id_isValid;
}

QString OAIGetDetectorVersionRequest::getDetectorVersionId() const {
    return m_detector_version_id;
}
void OAIGetDetectorVersionRequest::setDetectorVersionId(const QString &detector_version_id) {
    m_detector_version_id = detector_version_id;
    m_detector_version_id_isSet = true;
}

bool OAIGetDetectorVersionRequest::is_detector_version_id_Set() const{
    return m_detector_version_id_isSet;
}

bool OAIGetDetectorVersionRequest::is_detector_version_id_Valid() const{
    return m_detector_version_id_isValid;
}

bool OAIGetDetectorVersionRequest::isSet() const {
...
bool OAIGetDetectorVersionRequest::isValid() const {
