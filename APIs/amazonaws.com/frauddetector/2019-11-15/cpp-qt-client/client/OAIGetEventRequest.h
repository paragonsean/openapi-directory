...
/*
 * OAIGetEventRequest.h
 *
 * 
 */

#ifndef OAIGetEventRequest_H
#define OAIGetEventRequest_H
...
class OAIGetEventRequest : public OAIObject {
public:
    OAIGetEventRequest();
    OAIGetEventRequest(QString json);
    ~OAIGetEventRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEventRequest)

#endif // OAIGetEventRequest_H
