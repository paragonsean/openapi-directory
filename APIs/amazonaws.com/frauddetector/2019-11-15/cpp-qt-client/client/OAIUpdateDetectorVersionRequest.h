...
/*
 * OAIUpdateDetectorVersionRequest.h
 *
 * 
 */

#ifndef OAIUpdateDetectorVersionRequest_H
#define OAIUpdateDetectorVersionRequest_H
...
class OAIUpdateDetectorVersionRequest : public OAIObject {
public:
    OAIUpdateDetectorVersionRequest();
    OAIUpdateDetectorVersionRequest(QString json);
    ~OAIUpdateDetectorVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDetectorVersionRequest)

#endif // OAIUpdateDetectorVersionRequest_H
