...
/*
 * OAIBatchCreateVariableRequest.h
 *
 * 
 */

#ifndef OAIBatchCreateVariableRequest_H
#define OAIBatchCreateVariableRequest_H
...
class OAIBatchCreateVariableRequest : public OAIObject {
public:
    OAIBatchCreateVariableRequest();
    OAIBatchCreateVariableRequest(QString json);
    ~OAIBatchCreateVariableRequest() override;
    ...
    QList getVariableEntries() const;
    void setVariableEntries(const QList &variable_entries);
    bool is_variable_entries_Set() const;
    bool is_variable_entries_Valid() const;
...
private:
    ...
    QList m_variable_entries;
    bool m_variable_entries_isSet;
    bool m_variable_entries_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchCreateVariableRequest)

#endif // OAIBatchCreateVariableRequest_H
