...
/*
 * OAIModelOutputDataFormat.h
 *
 * 
 */

#ifndef OAIModelOutputDataFormat_H
#define OAIModelOutputDataFormat_H
...
class OAIModelOutputDataFormat : public OAIEnum {
public:
    OAIModelOutputDataFormat();
    OAIModelOutputDataFormat(QString json);
    ~OAIModelOutputDataFormat() override;
    ...
    enum class eOAIModelOutputDataFormat {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TEXT_CSV, 
        APPLICATION_JSONLINES
    };
    OAIModelOutputDataFormat::eOAIModelOutputDataFormat getValue() const;
    void setValue(const OAIModelOutputDataFormat::eOAIModelOutputDataFormat& value);
...
private:
    ...
    eOAIModelOutputDataFormat m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelOutputDataFormat)

#endif // OAIModelOutputDataFormat_H
