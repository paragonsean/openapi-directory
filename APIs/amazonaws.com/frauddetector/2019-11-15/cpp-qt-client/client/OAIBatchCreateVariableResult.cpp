...
OAIBatchCreateVariableResult::OAIBatchCreateVariableResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchCreateVariableResult::OAIBatchCreateVariableResult() {
    this->initializeModel();
}

OAIBatchCreateVariableResult::~OAIBatchCreateVariableResult() {}

void OAIBatchCreateVariableResult::initializeModel() {

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIBatchCreateVariableResult::fromJson(QString jsonString) {
...
void OAIBatchCreateVariableResult::fromJsonObject(QJsonObject json) {

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("errors")]);
    m_errors_isSet = !json[QString("errors")].isNull() && m_errors_isValid;
}

QString OAIBatchCreateVariableResult::asJson() const {
...
QJsonObject OAIBatchCreateVariableResult::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.isSet()) {
...
QList OAIBatchCreateVariableResult::getErrors() const {
    return m_errors;
}
void OAIBatchCreateVariableResult::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIBatchCreateVariableResult::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIBatchCreateVariableResult::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIBatchCreateVariableResult::isSet() const {
...
bool OAIBatchCreateVariableResult::isValid() const {
