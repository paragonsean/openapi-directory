...
QString OAIDeleteDetectorRequest::getDetectorId() const {
    return m_detector_id;
}
void OAIDeleteDetectorRequest::setDetectorId(const QString &detector_id) {
    m_detector_id = detector_id;
    m_detector_id_isSet = true;
}

bool OAIDeleteDetectorRequest::is_detector_id_Set() const{
    return m_detector_id_isSet;
}

bool OAIDeleteDetectorRequest::is_detector_id_Valid() const{
