...
/*
 * OAICreateRuleRequest.h
 *
 * 
 */

#ifndef OAICreateRuleRequest_H
#define OAICreateRuleRequest_H
...
class OAICreateRuleRequest : public OAIObject {
public:
    OAICreateRuleRequest();
    OAICreateRuleRequest(QString json);
    ~OAICreateRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRuleRequest)

#endif // OAICreateRuleRequest_H
