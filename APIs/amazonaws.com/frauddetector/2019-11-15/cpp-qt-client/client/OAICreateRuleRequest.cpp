...
QString OAICreateRuleRequest::getRuleId() const {
    return m_rule_id;
}
void OAICreateRuleRequest::setRuleId(const QString &rule_id) {
    m_rule_id = rule_id;
    m_rule_id_isSet = true;
}

bool OAICreateRuleRequest::is_rule_id_Set() const{
    return m_rule_id_isSet;
}

bool OAICreateRuleRequest::is_rule_id_Valid() const{
    return m_rule_id_isValid;
}

QString OAICreateRuleRequest::getDetectorId() const {
    return m_detector_id;
}
void OAICreateRuleRequest::setDetectorId(const QString &detector_id) {
    m_detector_id = detector_id;
    m_detector_id_isSet = true;
}

bool OAICreateRuleRequest::is_detector_id_Set() const{
    return m_detector_id_isSet;
}

bool OAICreateRuleRequest::is_detector_id_Valid() const{
...
QString OAICreateRuleRequest::getExpression() const {
    return m_expression;
}
void OAICreateRuleRequest::setExpression(const QString &expression) {
    m_expression = expression;
    m_expression_isSet = true;
}

bool OAICreateRuleRequest::is_expression_Set() const{
    return m_expression_isSet;
}

bool OAICreateRuleRequest::is_expression_Valid() const{
    return m_expression_isValid;
}

OAILanguage OAICreateRuleRequest::getLanguage() const {
    return m_language;
}
void OAICreateRuleRequest::setLanguage(const OAILanguage &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAICreateRuleRequest::is_language_Set() const{
    return m_language_isSet;
}

bool OAICreateRuleRequest::is_language_Valid() const{
    return m_language_isValid;
}

QList OAICreateRuleRequest::getOutcomes() const {
    return m_outcomes;
}
void OAICreateRuleRequest::setOutcomes(const QList &outcomes) {
    m_outcomes = outcomes;
    m_outcomes_isSet = true;
}

bool OAICreateRuleRequest::is_outcomes_Set() const{
    return m_outcomes_isSet;
}

bool OAICreateRuleRequest::is_outcomes_Valid() const{
...
bool OAICreateRuleRequest::isValid() const {
    ...
    return m_rule_id_isValid && m_detector_id_isValid && m_expression_isValid && m_language_isValid && m_outcomes_isValid && true;
}
