...
/*
 * OAIUpdateRuleMetadataRequest_rule.h
 *
 * 
 */

#ifndef OAIUpdateRuleMetadataRequest_rule_H
#define OAIUpdateRuleMetadataRequest_rule_H
...
class OAIUpdateRuleMetadataRequest_rule : public OAIObject {
public:
    OAIUpdateRuleMetadataRequest_rule();
    OAIUpdateRuleMetadataRequest_rule(QString json);
    ~OAIUpdateRuleMetadataRequest_rule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRuleMetadataRequest_rule)

#endif // OAIUpdateRuleMetadataRequest_rule_H
