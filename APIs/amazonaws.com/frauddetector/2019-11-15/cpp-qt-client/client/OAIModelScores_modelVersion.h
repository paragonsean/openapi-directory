...
/*
 * OAIModelScores_modelVersion.h
 *
 * 
 */

#ifndef OAIModelScores_modelVersion_H
#define OAIModelScores_modelVersion_H
...
class OAIModelScores_modelVersion : public OAIObject {
public:
    OAIModelScores_modelVersion();
    OAIModelScores_modelVersion(QString json);
    ~OAIModelScores_modelVersion() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelScores_modelVersion)

#endif // OAIModelScores_modelVersion_H
