...
/*
 * OAIGetBatchImportJobsResult.h
 *
 * 
 */

#ifndef OAIGetBatchImportJobsResult_H
#define OAIGetBatchImportJobsResult_H
...
class OAIGetBatchImportJobsResult : public OAIObject {
public:
    OAIGetBatchImportJobsResult();
    OAIGetBatchImportJobsResult(QString json);
    ~OAIGetBatchImportJobsResult() override;
    ...
    QList getBatchImports() const;
    void setBatchImports(const QList &batch_imports);
    bool is_batch_imports_Set() const;
    bool is_batch_imports_Valid() const;
...
private:
    ...
    QList m_batch_imports;
    bool m_batch_imports_isSet;
    bool m_batch_imports_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBatchImportJobsResult)

#endif // OAIGetBatchImportJobsResult_H
