...
/*
 * OAIBatchCreateVariableResult.h
 *
 * 
 */

#ifndef OAIBatchCreateVariableResult_H
#define OAIBatchCreateVariableResult_H
...
class OAIBatchCreateVariableResult : public OAIObject {
public:
    OAIBatchCreateVariableResult();
    OAIBatchCreateVariableResult(QString json);
    ~OAIBatchCreateVariableResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchCreateVariableResult)

#endif // OAIBatchCreateVariableResult_H
