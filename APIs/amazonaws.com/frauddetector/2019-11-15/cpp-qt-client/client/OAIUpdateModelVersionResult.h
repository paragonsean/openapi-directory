...
/*
 * OAIUpdateModelVersionResult.h
 *
 * 
 */

#ifndef OAIUpdateModelVersionResult_H
#define OAIUpdateModelVersionResult_H
...
class OAIUpdateModelVersionResult : public OAIObject {
public:
    OAIUpdateModelVersionResult();
    OAIUpdateModelVersionResult(QString json);
    ~OAIUpdateModelVersionResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateModelVersionResult)

#endif // OAIUpdateModelVersionResult_H
