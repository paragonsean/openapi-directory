...
/*
 * OAIGetDetectorVersionRequest.h
 *
 * 
 */

#ifndef OAIGetDetectorVersionRequest_H
#define OAIGetDetectorVersionRequest_H
...
class OAIGetDetectorVersionRequest : public OAIObject {
public:
    OAIGetDetectorVersionRequest();
    OAIGetDetectorVersionRequest(QString json);
    ~OAIGetDetectorVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDetectorVersionRequest)

#endif // OAIGetDetectorVersionRequest_H
