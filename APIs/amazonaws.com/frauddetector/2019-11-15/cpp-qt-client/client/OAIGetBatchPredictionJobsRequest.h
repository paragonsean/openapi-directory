...
/*
 * OAIGetBatchPredictionJobsRequest.h
 *
 * 
 */

#ifndef OAIGetBatchPredictionJobsRequest_H
#define OAIGetBatchPredictionJobsRequest_H
...
class OAIGetBatchPredictionJobsRequest : public OAIObject {
public:
    OAIGetBatchPredictionJobsRequest();
    OAIGetBatchPredictionJobsRequest(QString json);
    ~OAIGetBatchPredictionJobsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBatchPredictionJobsRequest)

#endif // OAIGetBatchPredictionJobsRequest_H
