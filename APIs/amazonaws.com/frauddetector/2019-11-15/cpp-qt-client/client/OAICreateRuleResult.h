...
/*
 * OAICreateRuleResult.h
 *
 * 
 */

#ifndef OAICreateRuleResult_H
#define OAICreateRuleResult_H
...
namespace OpenAPI {
class OAICreateRuleResult_rule;

class OAICreateRuleResult : public OAIObject {
public:
    OAICreateRuleResult();
    OAICreateRuleResult(QString json);
    ~OAICreateRuleResult() override;
    ...
    OAICreateRuleResult_rule getRule() const;
    void setRule(const OAICreateRuleResult_rule &rule);
...
private:
    ...
    OAICreateRuleResult_rule m_rule;
    bool m_rule_isSet;
    bool m_rule_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRuleResult)

#endif // OAICreateRuleResult_H
