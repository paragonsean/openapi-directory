...
OAIDeleteEntityTypeRequest::OAIDeleteEntityTypeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteEntityTypeRequest::OAIDeleteEntityTypeRequest() {
    this->initializeModel();
}

OAIDeleteEntityTypeRequest::~OAIDeleteEntityTypeRequest() {}

void OAIDeleteEntityTypeRequest::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIDeleteEntityTypeRequest::fromJson(QString jsonString) {
...
void OAIDeleteEntityTypeRequest::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIDeleteEntityTypeRequest::asJson() const {
...
QJsonObject OAIDeleteEntityTypeRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDeleteEntityTypeRequest::getName() const {
    return m_name;
}
void OAIDeleteEntityTypeRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteEntityTypeRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteEntityTypeRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIDeleteEntityTypeRequest::isSet() const {
...
bool OAIDeleteEntityTypeRequest::isValid() const {
