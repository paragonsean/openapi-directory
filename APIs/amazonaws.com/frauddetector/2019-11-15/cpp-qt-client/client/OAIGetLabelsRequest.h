...
/*
 * OAIGetLabelsRequest.h
 *
 * 
 */

#ifndef OAIGetLabelsRequest_H
#define OAIGetLabelsRequest_H
...
class OAIGetLabelsRequest : public OAIObject {
public:
    OAIGetLabelsRequest();
    OAIGetLabelsRequest(QString json);
    ~OAIGetLabelsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLabelsRequest)

#endif // OAIGetLabelsRequest_H
