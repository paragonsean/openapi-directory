...
/*
 * OAITrainingResultV2_trainingMetricsV2.h
 *
 * 
 */

#ifndef OAITrainingResultV2_trainingMetricsV2_H
#define OAITrainingResultV2_trainingMetricsV2_H
...
class OAITrainingResultV2_trainingMetricsV2 : public OAIObject {
public:
    OAITrainingResultV2_trainingMetricsV2();
    OAITrainingResultV2_trainingMetricsV2(QString json);
    ~OAITrainingResultV2_trainingMetricsV2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingResultV2_trainingMetricsV2)

#endif // OAITrainingResultV2_trainingMetricsV2_H
