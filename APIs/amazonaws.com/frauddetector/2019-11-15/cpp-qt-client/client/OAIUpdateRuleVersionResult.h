...
/*
 * OAIUpdateRuleVersionResult.h
 *
 * 
 */

#ifndef OAIUpdateRuleVersionResult_H
#define OAIUpdateRuleVersionResult_H

#include <QJsonObject>

#include "OAIUpdateRuleVersionResult_rule.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateRuleVersionResult_rule;

class OAIUpdateRuleVersionResult : public OAIObject {
public:
    OAIUpdateRuleVersionResult();
    OAIUpdateRuleVersionResult(QString json);
    ~OAIUpdateRuleVersionResult() override;
    ...
    OAIUpdateRuleVersionResult_rule getRule() const;
    void setRule(const OAIUpdateRuleVersionResult_rule &rule);
...
private:
    ...
    OAIUpdateRuleVersionResult_rule m_rule;
    bool m_rule_isSet;
    bool m_rule_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRuleVersionResult)

#endif // OAIUpdateRuleVersionResult_H
