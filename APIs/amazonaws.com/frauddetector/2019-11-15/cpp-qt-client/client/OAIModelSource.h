...
#ifndef OAIModelSource_H
#define OAIModelSource_H
...
class OAIModelSource : public OAIEnum {
public:
    OAIModelSource();
    OAIModelSource(QString json);
    ~OAIModelSource() override;
    ...
    enum class eOAIModelSource {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SAGEMAKER
    };
    OAIModelSource::eOAIModelSource getValue() const;
    void setValue(const OAIModelSource::eOAIModelSource& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelSource)

#endif // OAIModelSource_H
