...
/*
 * OAIUpdateEventLabelRequest.h
 *
 * 
 */

#ifndef OAIUpdateEventLabelRequest_H
#define OAIUpdateEventLabelRequest_H
...
class OAIUpdateEventLabelRequest : public OAIObject {
public:
    OAIUpdateEventLabelRequest();
    OAIUpdateEventLabelRequest(QString json);
    ~OAIUpdateEventLabelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEventLabelRequest)

#endif // OAIUpdateEventLabelRequest_H
