...
OAIDeleteModelVersionRequest::OAIDeleteModelVersionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteModelVersionRequest::OAIDeleteModelVersionRequest() {
    this->initializeModel();
}

OAIDeleteModelVersionRequest::~OAIDeleteModelVersionRequest() {}

void OAIDeleteModelVersionRequest::initializeModel() {
...
void OAIDeleteModelVersionRequest::fromJson(QString jsonString) {
...
void OAIDeleteModelVersionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteModelVersionRequest::asJson() const {
...
QJsonObject OAIDeleteModelVersionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_model_id_isSet) {
...
QString OAIDeleteModelVersionRequest::getModelId() const {
    return m_model_id;
}
void OAIDeleteModelVersionRequest::setModelId(const QString &model_id) {
    m_model_id = model_id;
    m_model_id_isSet = true;
}

bool OAIDeleteModelVersionRequest::is_model_id_Set() const{
    return m_model_id_isSet;
}

bool OAIDeleteModelVersionRequest::is_model_id_Valid() const{
    return m_model_id_isValid;
}

OAIModelTypeEnum OAIDeleteModelVersionRequest::getModelType() const {
    return m_model_type;
}
void OAIDeleteModelVersionRequest::setModelType(const OAIModelTypeEnum &model_type) {
    m_model_type = model_type;
    m_model_type_isSet = true;
}

bool OAIDeleteModelVersionRequest::is_model_type_Set() const{
    return m_model_type_isSet;
}

bool OAIDeleteModelVersionRequest::is_model_type_Valid() const{
    return m_model_type_isValid;
}

QString OAIDeleteModelVersionRequest::getModelVersionNumber() const {
    return m_model_version_number;
}
void OAIDeleteModelVersionRequest::setModelVersionNumber(const QString &model_version_number) {
    m_model_version_number = model_version_number;
    m_model_version_number_isSet = true;
}

bool OAIDeleteModelVersionRequest::is_model_version_number_Set() const{
    return m_model_version_number_isSet;
}

bool OAIDeleteModelVersionRequest::is_model_version_number_Valid() const{
    return m_model_version_number_isValid;
}

bool OAIDeleteModelVersionRequest::isSet() const {
...
bool OAIDeleteModelVersionRequest::isValid() const {
