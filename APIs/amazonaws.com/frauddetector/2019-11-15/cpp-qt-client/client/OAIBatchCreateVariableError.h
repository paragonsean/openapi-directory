...
/*
 * OAIBatchCreateVariableError.h
 *
 * Provides the error of the batch create variable API.
 */

#ifndef OAIBatchCreateVariableError_H
#define OAIBatchCreateVariableError_H
...
class OAIBatchCreateVariableError : public OAIObject {
public:
    OAIBatchCreateVariableError();
    OAIBatchCreateVariableError(QString json);
    ~OAIBatchCreateVariableError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchCreateVariableError)

#endif // OAIBatchCreateVariableError_H
