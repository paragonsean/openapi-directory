...
/*
 * OAITrainingResult_trainingMetrics.h
 *
 * 
 */

#ifndef OAITrainingResult_trainingMetrics_H
#define OAITrainingResult_trainingMetrics_H
...
class OAITrainingResult_trainingMetrics : public OAIObject {
public:
    OAITrainingResult_trainingMetrics();
    OAITrainingResult_trainingMetrics(QString json);
    ~OAITrainingResult_trainingMetrics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingResult_trainingMetrics)

#endif // OAITrainingResult_trainingMetrics_H
