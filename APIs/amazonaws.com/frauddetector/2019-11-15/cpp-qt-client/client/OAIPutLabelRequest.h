...
/*
 * OAIPutLabelRequest.h
 *
 * 
 */

#ifndef OAIPutLabelRequest_H
#define OAIPutLabelRequest_H
...
class OAIPutLabelRequest : public OAIObject {
public:
    OAIPutLabelRequest();
    OAIPutLabelRequest(QString json);
    ~OAIPutLabelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutLabelRequest)

#endif // OAIPutLabelRequest_H
