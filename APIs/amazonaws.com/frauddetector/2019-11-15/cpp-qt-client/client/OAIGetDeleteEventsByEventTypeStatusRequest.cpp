...
OAIGetDeleteEventsByEventTypeStatusRequest::OAIGetDeleteEventsByEventTypeStatusRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDeleteEventsByEventTypeStatusRequest::OAIGetDeleteEventsByEventTypeStatusRequest() {
    this->initializeModel();
}

OAIGetDeleteEventsByEventTypeStatusRequest::~OAIGetDeleteEventsByEventTypeStatusRequest() {}

void OAIGetDeleteEventsByEventTypeStatusRequest::initializeModel() {

    m_event_type_name_isSet = false;
    m_event_type_name_isValid = false;
}

void OAIGetDeleteEventsByEventTypeStatusRequest::fromJson(QString jsonString) {
...
void OAIGetDeleteEventsByEventTypeStatusRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetDeleteEventsByEventTypeStatusRequest::asJson() const {
...
QJsonObject OAIGetDeleteEventsByEventTypeStatusRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetDeleteEventsByEventTypeStatusRequest::getEventTypeName() const {
    return m_event_type_name;
}
void OAIGetDeleteEventsByEventTypeStatusRequest::setEventTypeName(const QString &event_type_name) {
    m_event_type_name = event_type_name;
    m_event_type_name_isSet = true;
}

bool OAIGetDeleteEventsByEventTypeStatusRequest::is_event_type_name_Set() const{
    return m_event_type_name_isSet;
}

bool OAIGetDeleteEventsByEventTypeStatusRequest::is_event_type_name_Valid() const{
    return m_event_type_name_isValid;
}

bool OAIGetDeleteEventsByEventTypeStatusRequest::isSet() const {
...
bool OAIGetDeleteEventsByEventTypeStatusRequest::isValid() const {
