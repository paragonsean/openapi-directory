...
OAIModelVersionDetail_externalEventsDetail::OAIModelVersionDetail_externalEventsDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIModelVersionDetail_externalEventsDetail::OAIModelVersionDetail_externalEventsDetail() {
    this->initializeModel();
}

OAIModelVersionDetail_externalEventsDetail::~OAIModelVersionDetail_externalEventsDetail() {}

void OAIModelVersionDetail_externalEventsDetail::initializeModel() {
...
void OAIModelVersionDetail_externalEventsDetail::fromJson(QString jsonString) {
...
void OAIModelVersionDetail_externalEventsDetail::fromJsonObject(QJsonObject json) {
...
QString OAIModelVersionDetail_externalEventsDetail::asJson() const {
...
QJsonObject OAIModelVersionDetail_externalEventsDetail::asJsonObject() const {
    QJsonObject obj;
...
QString OAIModelVersionDetail_externalEventsDetail::getDataLocation() const {
    return m_data_location;
}
void OAIModelVersionDetail_externalEventsDetail::setDataLocation(const QString &data_location) {
    m_data_location = data_location;
    m_data_location_isSet = true;
}

bool OAIModelVersionDetail_externalEventsDetail::is_data_location_Set() const{
    return m_data_location_isSet;
}

bool OAIModelVersionDetail_externalEventsDetail::is_data_location_Valid() const{
    return m_data_location_isValid;
}

QString OAIModelVersionDetail_externalEventsDetail::getDataAccessRoleArn() const {
    return m_data_access_role_arn;
}
void OAIModelVersionDetail_externalEventsDetail::setDataAccessRoleArn(const QString &data_access_role_arn) {
    m_data_access_role_arn = data_access_role_arn;
    m_data_access_role_arn_isSet = true;
}

bool OAIModelVersionDetail_externalEventsDetail::is_data_access_role_arn_Set() const{
    return m_data_access_role_arn_isSet;
}

bool OAIModelVersionDetail_externalEventsDetail::is_data_access_role_arn_Valid() const{
    return m_data_access_role_arn_isValid;
}

bool OAIModelVersionDetail_externalEventsDetail::isSet() const {
...
bool OAIModelVersionDetail_externalEventsDetail::isValid() const {
