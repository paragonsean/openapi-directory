...
OAIUpdateDetectorVersionMetadataRequest::OAIUpdateDetectorVersionMetadataRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDetectorVersionMetadataRequest::OAIUpdateDetectorVersionMetadataRequest() {
    this->initializeModel();
}

OAIUpdateDetectorVersionMetadataRequest::~OAIUpdateDetectorVersionMetadataRequest() {}

void OAIUpdateDetectorVersionMetadataRequest::initializeModel() {
...
void OAIUpdateDetectorVersionMetadataRequest::fromJson(QString jsonString) {
...
void OAIUpdateDetectorVersionMetadataRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDetectorVersionMetadataRequest::asJson() const {
...
QJsonObject OAIUpdateDetectorVersionMetadataRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateDetectorVersionMetadataRequest::getDetectorId() const {
    return m_detector_id;
}
void OAIUpdateDetectorVersionMetadataRequest::setDetectorId(const QString &detector_id) {
    m_detector_id = detector_id;
    m_detector_id_isSet = true;
}

bool OAIUpdateDetectorVersionMetadataRequest::is_detector_id_Set() const{
    return m_detector_id_isSet;
}

bool OAIUpdateDetectorVersionMetadataRequest::is_detector_id_Valid() const{
    return m_detector_id_isValid;
}

QString OAIUpdateDetectorVersionMetadataRequest::getDetectorVersionId() const {
    return m_detector_version_id;
}
void OAIUpdateDetectorVersionMetadataRequest::setDetectorVersionId(const QString &detector_version_id) {
    m_detector_version_id = detector_version_id;
    m_detector_version_id_isSet = true;
}

bool OAIUpdateDetectorVersionMetadataRequest::is_detector_version_id_Set() const{
    return m_detector_version_id_isSet;
}

bool OAIUpdateDetectorVersionMetadataRequest::is_detector_version_id_Valid() const{
    return m_detector_version_id_isValid;
}

QString OAIUpdateDetectorVersionMetadataRequest::getDescription() const {
    return m_description;
}
void OAIUpdateDetectorVersionMetadataRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateDetectorVersionMetadataRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateDetectorVersionMetadataRequest::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIUpdateDetectorVersionMetadataRequest::isSet() const {
...
bool OAIUpdateDetectorVersionMetadataRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_detector_id_isValid && m_detector_version_id_isValid && m_description_isValid && true;
}
