...
/*
 * OAIGetDeleteEventsByEventTypeStatusResult.h
 *
 * 
 */

#ifndef OAIGetDeleteEventsByEventTypeStatusResult_H
#define OAIGetDeleteEventsByEventTypeStatusResult_H
...
class OAIGetDeleteEventsByEventTypeStatusResult : public OAIObject {
public:
    OAIGetDeleteEventsByEventTypeStatusResult();
    OAIGetDeleteEventsByEventTypeStatusResult(QString json);
    ~OAIGetDeleteEventsByEventTypeStatusResult() override;
    ...
    OAIAsyncJobStatus getEventsDeletionStatus() const;
    void setEventsDeletionStatus(const OAIAsyncJobStatus &events_deletion_status);
...
private:
    ...
    OAIAsyncJobStatus m_events_deletion_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDeleteEventsByEventTypeStatusResult)

#endif // OAIGetDeleteEventsByEventTypeStatusResult_H
