...
/*
 * OAIEventType_eventOrchestration.h
 *
 * 
 */

#ifndef OAIEventType_eventOrchestration_H
#define OAIEventType_eventOrchestration_H
...
class OAIEventType_eventOrchestration : public OAIObject {
public:
    OAIEventType_eventOrchestration();
    OAIEventType_eventOrchestration(QString json);
    ~OAIEventType_eventOrchestration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventType_eventOrchestration)

#endif // OAIEventType_eventOrchestration_H
