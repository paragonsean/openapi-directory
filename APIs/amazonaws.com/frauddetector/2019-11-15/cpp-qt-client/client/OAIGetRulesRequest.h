...
/*
 * OAIGetRulesRequest.h
 *
 * 
 */

#ifndef OAIGetRulesRequest_H
#define OAIGetRulesRequest_H
...
class OAIGetRulesRequest : public OAIObject {
public:
    OAIGetRulesRequest();
    OAIGetRulesRequest(QString json);
    ~OAIGetRulesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRulesRequest)

#endif // OAIGetRulesRequest_H
