...
/*
 * OAIRuleExecutionMode.h
 *
 * 
 */

#ifndef OAIRuleExecutionMode_H
#define OAIRuleExecutionMode_H
...
class OAIRuleExecutionMode : public OAIEnum {
public:
    OAIRuleExecutionMode();
    OAIRuleExecutionMode(QString json);
    ~OAIRuleExecutionMode() override;
    ...
    enum class eOAIRuleExecutionMode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ALL_MATCHED, 
        FIRST_MATCHED
    };
    OAIRuleExecutionMode::eOAIRuleExecutionMode getValue() const;
    void setValue(const OAIRuleExecutionMode::eOAIRuleExecutionMode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleExecutionMode)

#endif // OAIRuleExecutionMode_H
