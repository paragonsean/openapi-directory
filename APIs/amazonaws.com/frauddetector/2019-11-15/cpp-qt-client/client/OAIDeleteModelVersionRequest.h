...
/*
 * OAIDeleteModelVersionRequest.h
 *
 * 
 */

#ifndef OAIDeleteModelVersionRequest_H
#define OAIDeleteModelVersionRequest_H
...
class OAIDeleteModelVersionRequest : public OAIObject {
public:
    OAIDeleteModelVersionRequest();
    OAIDeleteModelVersionRequest(QString json);
    ~OAIDeleteModelVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteModelVersionRequest)

#endif // OAIDeleteModelVersionRequest_H
