...
#ifndef OAIAsyncJobStatus_H
#define OAIAsyncJobStatus_H
...
class OAIAsyncJobStatus : public OAIEnum {
public:
    OAIAsyncJobStatus();
    OAIAsyncJobStatus(QString json);
    ~OAIAsyncJobStatus() override;
    ...
    OAIAsyncJobStatus::eOAIAsyncJobStatus getValue() const;
    void setValue(const OAIAsyncJobStatus::eOAIAsyncJobStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAsyncJobStatus)

#endif // OAIAsyncJobStatus_H
