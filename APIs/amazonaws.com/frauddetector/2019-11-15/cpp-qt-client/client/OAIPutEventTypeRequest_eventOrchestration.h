...
/*
 * OAIPutEventTypeRequest_eventOrchestration.h
 *
 * 
 */

#ifndef OAIPutEventTypeRequest_eventOrchestration_H
#define OAIPutEventTypeRequest_eventOrchestration_H
...
class OAIPutEventTypeRequest_eventOrchestration : public OAIObject {
public:
    OAIPutEventTypeRequest_eventOrchestration();
    OAIPutEventTypeRequest_eventOrchestration(QString json);
    ~OAIPutEventTypeRequest_eventOrchestration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutEventTypeRequest_eventOrchestration)

#endif // OAIPutEventTypeRequest_eventOrchestration_H
