...
QString OAISendEventRequest::getEventId() const {
    return m_event_id;
}
void OAISendEventRequest::setEventId(const QString &event_id) {
    m_event_id = event_id;
    m_event_id_isSet = true;
}

bool OAISendEventRequest::is_event_id_Set() const{
    return m_event_id_isSet;
}

bool OAISendEventRequest::is_event_id_Valid() const{
    return m_event_id_isValid;
}

QString OAISendEventRequest::getEventTypeName() const {
    return m_event_type_name;
}
void OAISendEventRequest::setEventTypeName(const QString &event_type_name) {
    m_event_type_name = event_type_name;
    m_event_type_name_isSet = true;
}

bool OAISendEventRequest::is_event_type_name_Set() const{
    return m_event_type_name_isSet;
}

bool OAISendEventRequest::is_event_type_name_Valid() const{
    return m_event_type_name_isValid;
}

QString OAISendEventRequest::getEventTimestamp() const {
    return m_event_timestamp;
}
void OAISendEventRequest::setEventTimestamp(const QString &event_timestamp) {
    m_event_timestamp = event_timestamp;
    m_event_timestamp_isSet = true;
}

bool OAISendEventRequest::is_event_timestamp_Set() const{
    return m_event_timestamp_isSet;
}

bool OAISendEventRequest::is_event_timestamp_Valid() const{
    return m_event_timestamp_isValid;
}

QMap OAISendEventRequest::getEventVariables() const {
    return m_event_variables;
}
void OAISendEventRequest::setEventVariables(const QMap &event_variables) {
    m_event_variables = event_variables;
    m_event_variables_isSet = true;
}

bool OAISendEventRequest::is_event_variables_Set() const{
    return m_event_variables_isSet;
}

bool OAISendEventRequest::is_event_variables_Valid() const{
    return m_event_variables_isValid;
}

QString OAISendEventRequest::getAssignedLabel() const {
    return m_assigned_label;
}
void OAISendEventRequest::setAssignedLabel(const QString &assigned_label) {
    m_assigned_label = assigned_label;
    m_assigned_label_isSet = true;
}

bool OAISendEventRequest::is_assigned_label_Set() const{
    return m_assigned_label_isSet;
}

bool OAISendEventRequest::is_assigned_label_Valid() const{
    return m_assigned_label_isValid;
}

QString OAISendEventRequest::getLabelTimestamp() const {
    return m_label_timestamp;
}
void OAISendEventRequest::setLabelTimestamp(const QString &label_timestamp) {
    m_label_timestamp = label_timestamp;
    m_label_timestamp_isSet = true;
}

bool OAISendEventRequest::is_label_timestamp_Set() const{
    return m_label_timestamp_isSet;
}

bool OAISendEventRequest::is_label_timestamp_Valid() const{
    return m_label_timestamp_isValid;
}

QList OAISendEventRequest::getEntities() const {
    return m_entities;
}
void OAISendEventRequest::setEntities(const QList &entities) {
    m_entities = entities;
    m_entities_isSet = true;
}

bool OAISendEventRequest::is_entities_Set() const{
    return m_entities_isSet;
}

bool OAISendEventRequest::is_entities_Valid() const{
...
bool OAISendEventRequest::isValid() const {
    ...
    return m_event_id_isValid && m_event_type_name_isValid && m_event_timestamp_isValid && m_event_variables_isValid && m_entities_isValid && true;
}
