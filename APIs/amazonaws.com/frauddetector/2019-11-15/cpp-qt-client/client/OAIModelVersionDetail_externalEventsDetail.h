...
/*
 * OAIModelVersionDetail_externalEventsDetail.h
 *
 * 
 */

#ifndef OAIModelVersionDetail_externalEventsDetail_H
#define OAIModelVersionDetail_externalEventsDetail_H
...
class OAIModelVersionDetail_externalEventsDetail : public OAIObject {
public:
    OAIModelVersionDetail_externalEventsDetail();
    OAIModelVersionDetail_externalEventsDetail(QString json);
    ~OAIModelVersionDetail_externalEventsDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelVersionDetail_externalEventsDetail)

#endif // OAIModelVersionDetail_externalEventsDetail_H
