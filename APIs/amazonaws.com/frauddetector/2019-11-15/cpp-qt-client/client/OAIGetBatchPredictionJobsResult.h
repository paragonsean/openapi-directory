...
/*
 * OAIGetBatchPredictionJobsResult.h
 *
 * 
 */

#ifndef OAIGetBatchPredictionJobsResult_H
#define OAIGetBatchPredictionJobsResult_H
...
class OAIGetBatchPredictionJobsResult : public OAIObject {
public:
    OAIGetBatchPredictionJobsResult();
    OAIGetBatchPredictionJobsResult(QString json);
    ~OAIGetBatchPredictionJobsResult() override;
    ...
    QList getBatchPredictions() const;
    void setBatchPredictions(const QList &batch_predictions);
    bool is_batch_predictions_Set() const;
    bool is_batch_predictions_Valid() const;
...
private:
    ...
    QList m_batch_predictions;
    bool m_batch_predictions_isSet;
    bool m_batch_predictions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBatchPredictionJobsResult)

#endif // OAIGetBatchPredictionJobsResult_H
