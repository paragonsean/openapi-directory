...
/*
 * OAICreateListRequest.h
 *
 * 
 */

#ifndef OAICreateListRequest_H
#define OAICreateListRequest_H
...
class OAICreateListRequest : public OAIObject {
public:
    OAICreateListRequest();
    OAICreateListRequest(QString json);
    ~OAICreateListRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateListRequest)

#endif // OAICreateListRequest_H
