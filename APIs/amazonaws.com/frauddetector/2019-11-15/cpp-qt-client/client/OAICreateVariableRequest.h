...
/*
 * OAICreateVariableRequest.h
 *
 * 
 */

#ifndef OAICreateVariableRequest_H
#define OAICreateVariableRequest_H
...
class OAICreateVariableRequest : public OAIObject {
public:
    OAICreateVariableRequest();
    OAICreateVariableRequest(QString json);
    ~OAICreateVariableRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVariableRequest)

#endif // OAICreateVariableRequest_H
