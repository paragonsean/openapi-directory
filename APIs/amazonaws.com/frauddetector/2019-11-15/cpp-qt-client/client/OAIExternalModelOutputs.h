...
/*
 * OAIExternalModelOutputs.h
 *
 * The fraud prediction scores from Amazon SageMaker model.
 */

#ifndef OAIExternalModelOutputs_H
#define OAIExternalModelOutputs_H

#include <QJsonObject>

#include "OAIExternalModelOutputs_externalModel.h"
#include <QMap>
...
namespace OpenAPI {
class OAIExternalModelOutputs_externalModel;

class OAIExternalModelOutputs : public OAIObject {
public:
    OAIExternalModelOutputs();
    OAIExternalModelOutputs(QString json);
    ~OAIExternalModelOutputs() override;
    ...
    OAIExternalModelOutputs_externalModel getExternalModel() const;
    void setExternalModel(const OAIExternalModelOutputs_externalModel &external_model);
    bool is_external_model_Set() const;
    bool is_external_model_Valid() const;

    QMap getOutputs() const;
    void setOutputs(const QMap &outputs);
...
private:
    ...
    OAIExternalModelOutputs_externalModel m_external_model;
    bool m_external_model_isSet;
    bool m_external_model_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExternalModelOutputs)

#endif // OAIExternalModelOutputs_H
