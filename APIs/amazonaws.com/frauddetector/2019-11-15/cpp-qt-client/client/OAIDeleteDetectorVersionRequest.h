...
/*
 * OAIDeleteDetectorVersionRequest.h
 *
 * 
 */

#ifndef OAIDeleteDetectorVersionRequest_H
#define OAIDeleteDetectorVersionRequest_H
...
class OAIDeleteDetectorVersionRequest : public OAIObject {
public:
    OAIDeleteDetectorVersionRequest();
    OAIDeleteDetectorVersionRequest(QString json);
    ~OAIDeleteDetectorVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDetectorVersionRequest)

#endif // OAIDeleteDetectorVersionRequest_H
