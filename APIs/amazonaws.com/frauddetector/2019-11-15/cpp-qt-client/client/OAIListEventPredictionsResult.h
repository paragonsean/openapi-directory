...
/*
 * OAIListEventPredictionsResult.h
 *
 * 
 */

#ifndef OAIListEventPredictionsResult_H
#define OAIListEventPredictionsResult_H
...
class OAIListEventPredictionsResult : public OAIObject {
public:
    OAIListEventPredictionsResult();
    OAIListEventPredictionsResult(QString json);
    ~OAIListEventPredictionsResult() override;
    ...
    QList getEventPredictionSummaries() const;
    void setEventPredictionSummaries(const QList &event_prediction_summaries);
    bool is_event_prediction_summaries_Set() const;
    bool is_event_prediction_summaries_Valid() const;
...
private:
    ...
    QList m_event_prediction_summaries;
    bool m_event_prediction_summaries_isSet;
    bool m_event_prediction_summaries_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventPredictionsResult)

#endif // OAIListEventPredictionsResult_H
