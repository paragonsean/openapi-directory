...
/*
 * OAIListEventPredictionsRequest_eventType.h
 *
 * 
 */

#ifndef OAIListEventPredictionsRequest_eventType_H
#define OAIListEventPredictionsRequest_eventType_H
...
class OAIListEventPredictionsRequest_eventType : public OAIObject {
public:
    OAIListEventPredictionsRequest_eventType();
    OAIListEventPredictionsRequest_eventType(QString json);
    ~OAIListEventPredictionsRequest_eventType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventPredictionsRequest_eventType)

#endif // OAIListEventPredictionsRequest_eventType_H
