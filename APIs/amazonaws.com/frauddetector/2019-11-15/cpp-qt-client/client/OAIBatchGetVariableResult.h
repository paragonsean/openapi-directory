...
/*
 * OAIBatchGetVariableResult.h
 *
 * 
 */

#ifndef OAIBatchGetVariableResult_H
#define OAIBatchGetVariableResult_H
...
class OAIBatchGetVariableResult : public OAIObject {
public:
    OAIBatchGetVariableResult();
    OAIBatchGetVariableResult(QString json);
    ~OAIBatchGetVariableResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetVariableResult)

#endif // OAIBatchGetVariableResult_H
