...
/*
 * OAICreateBatchImportJobRequest.h
 *
 * 
 */

#ifndef OAICreateBatchImportJobRequest_H
#define OAICreateBatchImportJobRequest_H
...
class OAICreateBatchImportJobRequest : public OAIObject {
public:
    OAICreateBatchImportJobRequest();
    OAICreateBatchImportJobRequest(QString json);
    ~OAICreateBatchImportJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBatchImportJobRequest)

#endif // OAICreateBatchImportJobRequest_H
