...
OAIDeleteEventTypeRequest::OAIDeleteEventTypeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteEventTypeRequest::OAIDeleteEventTypeRequest() {
    this->initializeModel();
}

OAIDeleteEventTypeRequest::~OAIDeleteEventTypeRequest() {}

void OAIDeleteEventTypeRequest::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIDeleteEventTypeRequest::fromJson(QString jsonString) {
...
void OAIDeleteEventTypeRequest::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIDeleteEventTypeRequest::asJson() const {
...
QJsonObject OAIDeleteEventTypeRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDeleteEventTypeRequest::getName() const {
    return m_name;
}
void OAIDeleteEventTypeRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteEventTypeRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteEventTypeRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIDeleteEventTypeRequest::isSet() const {
...
bool OAIDeleteEventTypeRequest::isValid() const {
