...
/*
 * OAICreateRuleResult_rule.h
 *
 * 
 */

#ifndef OAICreateRuleResult_rule_H
#define OAICreateRuleResult_rule_H
...
class OAICreateRuleResult_rule : public OAIObject {
public:
    OAICreateRuleResult_rule();
    OAICreateRuleResult_rule(QString json);
    ~OAICreateRuleResult_rule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRuleResult_rule)

#endif // OAICreateRuleResult_rule_H
