...
/*
 * OAIListEventPredictionsRequest_eventId.h
 *
 * 
 */

#ifndef OAIListEventPredictionsRequest_eventId_H
#define OAIListEventPredictionsRequest_eventId_H
...
class OAIListEventPredictionsRequest_eventId : public OAIObject {
public:
    OAIListEventPredictionsRequest_eventId();
    OAIListEventPredictionsRequest_eventId(QString json);
    ~OAIListEventPredictionsRequest_eventId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventPredictionsRequest_eventId)

#endif // OAIListEventPredictionsRequest_eventId_H
