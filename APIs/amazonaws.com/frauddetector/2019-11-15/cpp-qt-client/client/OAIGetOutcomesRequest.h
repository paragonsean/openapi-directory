...
/*
 * OAIGetOutcomesRequest.h
 *
 * 
 */

#ifndef OAIGetOutcomesRequest_H
#define OAIGetOutcomesRequest_H
...
class OAIGetOutcomesRequest : public OAIObject {
public:
    OAIGetOutcomesRequest();
    OAIGetOutcomesRequest(QString json);
    ~OAIGetOutcomesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOutcomesRequest)

#endif // OAIGetOutcomesRequest_H
