...
/*
 * OAIUpdateListRequest.h
 *
 * 
 */

#ifndef OAIUpdateListRequest_H
#define OAIUpdateListRequest_H
...
class OAIUpdateListRequest : public OAIObject {
public:
    OAIUpdateListRequest();
    OAIUpdateListRequest(QString json);
    ~OAIUpdateListRequest() override;
    ...
    OAIListUpdateMode getUpdateMode() const;
    void setUpdateMode(const OAIListUpdateMode &update_mode);
...
private:
    ...
    OAIListUpdateMode m_update_mode;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateListRequest)

#endif // OAIUpdateListRequest_H
