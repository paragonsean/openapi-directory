...
/*
 * OAIGetExternalModelsRequest.h
 *
 * 
 */

#ifndef OAIGetExternalModelsRequest_H
#define OAIGetExternalModelsRequest_H
...
class OAIGetExternalModelsRequest : public OAIObject {
public:
    OAIGetExternalModelsRequest();
    OAIGetExternalModelsRequest(QString json);
    ~OAIGetExternalModelsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetExternalModelsRequest)

#endif // OAIGetExternalModelsRequest_H
