...
/*
 * OAIUpdateDetectorVersionMetadataRequest.h
 *
 * 
 */

#ifndef OAIUpdateDetectorVersionMetadataRequest_H
#define OAIUpdateDetectorVersionMetadataRequest_H
...
class OAIUpdateDetectorVersionMetadataRequest : public OAIObject {
public:
    OAIUpdateDetectorVersionMetadataRequest();
    OAIUpdateDetectorVersionMetadataRequest(QString json);
    ~OAIUpdateDetectorVersionMetadataRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDetectorVersionMetadataRequest)

#endif // OAIUpdateDetectorVersionMetadataRequest_H
