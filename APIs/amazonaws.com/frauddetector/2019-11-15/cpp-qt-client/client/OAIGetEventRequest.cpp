...
OAIGetEventRequest::OAIGetEventRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetEventRequest::OAIGetEventRequest() {
    this->initializeModel();
}

OAIGetEventRequest::~OAIGetEventRequest() {}

void OAIGetEventRequest::initializeModel() {
...
void OAIGetEventRequest::fromJson(QString jsonString) {
...
void OAIGetEventRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetEventRequest::asJson() const {
...
QJsonObject OAIGetEventRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_event_id_isSet) {
...
QString OAIGetEventRequest::getEventId() const {
    return m_event_id;
}
void OAIGetEventRequest::setEventId(const QString &event_id) {
    m_event_id = event_id;
    m_event_id_isSet = true;
}

bool OAIGetEventRequest::is_event_id_Set() const{
    return m_event_id_isSet;
}

bool OAIGetEventRequest::is_event_id_Valid() const{
    return m_event_id_isValid;
}

QString OAIGetEventRequest::getEventTypeName() const {
    return m_event_type_name;
}
void OAIGetEventRequest::setEventTypeName(const QString &event_type_name) {
    m_event_type_name = event_type_name;
    m_event_type_name_isSet = true;
}

bool OAIGetEventRequest::is_event_type_name_Set() const{
    return m_event_type_name_isSet;
}

bool OAIGetEventRequest::is_event_type_name_Valid() const{
    return m_event_type_name_isValid;
}

bool OAIGetEventRequest::isSet() const {
...
bool OAIGetEventRequest::isValid() const {
