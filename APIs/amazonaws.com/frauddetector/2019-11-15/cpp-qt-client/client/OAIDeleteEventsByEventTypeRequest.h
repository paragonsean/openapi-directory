...
/*
 * OAIDeleteEventsByEventTypeRequest.h
 *
 * 
 */

#ifndef OAIDeleteEventsByEventTypeRequest_H
#define OAIDeleteEventsByEventTypeRequest_H
...
class OAIDeleteEventsByEventTypeRequest : public OAIObject {
public:
    OAIDeleteEventsByEventTypeRequest();
    OAIDeleteEventsByEventTypeRequest(QString json);
    ~OAIDeleteEventsByEventTypeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEventsByEventTypeRequest)

#endif // OAIDeleteEventsByEventTypeRequest_H
