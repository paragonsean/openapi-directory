...
OAIUpdateModelVersionStatusRequest::OAIUpdateModelVersionStatusRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateModelVersionStatusRequest::OAIUpdateModelVersionStatusRequest() {
    this->initializeModel();
}

OAIUpdateModelVersionStatusRequest::~OAIUpdateModelVersionStatusRequest() {}

void OAIUpdateModelVersionStatusRequest::initializeModel() {
...
void OAIUpdateModelVersionStatusRequest::fromJson(QString jsonString) {
...
void OAIUpdateModelVersionStatusRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateModelVersionStatusRequest::asJson() const {
...
QJsonObject OAIUpdateModelVersionStatusRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_model_id_isSet) {
...
QString OAIUpdateModelVersionStatusRequest::getModelId() const {
    return m_model_id;
}
void OAIUpdateModelVersionStatusRequest::setModelId(const QString &model_id) {
    m_model_id = model_id;
    m_model_id_isSet = true;
}

bool OAIUpdateModelVersionStatusRequest::is_model_id_Set() const{
    return m_model_id_isSet;
}

bool OAIUpdateModelVersionStatusRequest::is_model_id_Valid() const{
    return m_model_id_isValid;
}

OAIModelTypeEnum OAIUpdateModelVersionStatusRequest::getModelType() const {
    return m_model_type;
}
void OAIUpdateModelVersionStatusRequest::setModelType(const OAIModelTypeEnum &model_type) {
    m_model_type = model_type;
    m_model_type_isSet = true;
}

bool OAIUpdateModelVersionStatusRequest::is_model_type_Set() const{
    return m_model_type_isSet;
}

bool OAIUpdateModelVersionStatusRequest::is_model_type_Valid() const{
    return m_model_type_isValid;
}

QString OAIUpdateModelVersionStatusRequest::getModelVersionNumber() const {
    return m_model_version_number;
}
void OAIUpdateModelVersionStatusRequest::setModelVersionNumber(const QString &model_version_number) {
    m_model_version_number = model_version_number;
    m_model_version_number_isSet = true;
}

bool OAIUpdateModelVersionStatusRequest::is_model_version_number_Set() const{
    return m_model_version_number_isSet;
}

bool OAIUpdateModelVersionStatusRequest::is_model_version_number_Valid() const{
    return m_model_version_number_isValid;
}

OAIModelVersionStatus OAIUpdateModelVersionStatusRequest::getStatus() const {
    return m_status;
}
void OAIUpdateModelVersionStatusRequest::setStatus(const OAIModelVersionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateModelVersionStatusRequest::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateModelVersionStatusRequest::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIUpdateModelVersionStatusRequest::isSet() const {
...
bool OAIUpdateModelVersionStatusRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_model_id_isValid && m_model_type_isValid && m_model_version_number_isValid && m_status_isValid && true;
}
