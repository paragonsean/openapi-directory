...
OAIModelSource::OAIModelSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIModelSource::OAIModelSource() {
    this->initializeModel();
}

OAIModelSource::~OAIModelSource() {}

void OAIModelSource::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIModelSource::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIModelSource::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SAGEMAKER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIModelSource::SAGEMAKER;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIModelSource::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIModelSource::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIModelSource::SAGEMAKER:
            val = "SAGEMAKER";
            break;
        default:
            break;
...
QJsonValue OAIModelSource::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIModelSource::eOAIModelSource OAIModelSource::getValue() const {
    return m_value;
}

void OAIModelSource::setValue(const OAIModelSource::eOAIModelSource& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIModelSource::isSet() const {
    
    return m_value_isSet;
}

bool OAIModelSource::isValid() const {
