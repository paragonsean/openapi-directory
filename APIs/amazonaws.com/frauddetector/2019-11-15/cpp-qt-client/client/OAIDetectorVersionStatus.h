...
/*
 * OAIDetectorVersionStatus.h
 *
 * 
 */

#ifndef OAIDetectorVersionStatus_H
#define OAIDetectorVersionStatus_H
...
class OAIDetectorVersionStatus : public OAIEnum {
public:
    OAIDetectorVersionStatus();
    OAIDetectorVersionStatus(QString json);
    ~OAIDetectorVersionStatus() override;
    ...
    enum class eOAIDetectorVersionStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DRAFT, 
        ACTIVE, 
        INACTIVE
    };
    OAIDetectorVersionStatus::eOAIDetectorVersionStatus getValue() const;
    void setValue(const OAIDetectorVersionStatus::eOAIDetectorVersionStatus& value);
...
private:
    ...
    eOAIDetectorVersionStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectorVersionStatus)

#endif // OAIDetectorVersionStatus_H
