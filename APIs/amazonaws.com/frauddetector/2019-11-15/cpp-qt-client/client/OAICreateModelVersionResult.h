...
/*
 * OAICreateModelVersionResult.h
 *
 * 
 */

#ifndef OAICreateModelVersionResult_H
#define OAICreateModelVersionResult_H
...
class OAICreateModelVersionResult : public OAIObject {
public:
    OAICreateModelVersionResult();
    OAICreateModelVersionResult(QString json);
    ~OAICreateModelVersionResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateModelVersionResult)

#endif // OAICreateModelVersionResult_H
