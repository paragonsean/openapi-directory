...
/*
 * OAIUpdateRuleVersionRequest.h
 *
 * 
 */

#ifndef OAIUpdateRuleVersionRequest_H
#define OAIUpdateRuleVersionRequest_H
...
class OAIUpdateRuleVersionRequest : public OAIObject {
public:
    OAIUpdateRuleVersionRequest();
    OAIUpdateRuleVersionRequest(QString json);
    ~OAIUpdateRuleVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRuleVersionRequest)

#endif // OAIUpdateRuleVersionRequest_H
