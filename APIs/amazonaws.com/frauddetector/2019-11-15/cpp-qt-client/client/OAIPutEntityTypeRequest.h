...
/*
 * OAIPutEntityTypeRequest.h
 *
 * 
 */

#ifndef OAIPutEntityTypeRequest_H
#define OAIPutEntityTypeRequest_H
...
class OAIPutEntityTypeRequest : public OAIObject {
public:
    OAIPutEntityTypeRequest();
    OAIPutEntityTypeRequest(QString json);
    ~OAIPutEntityTypeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutEntityTypeRequest)

#endif // OAIPutEntityTypeRequest_H
