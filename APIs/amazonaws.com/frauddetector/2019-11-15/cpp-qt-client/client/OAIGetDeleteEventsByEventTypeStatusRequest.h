...
/*
 * OAIGetDeleteEventsByEventTypeStatusRequest.h
 *
 * 
 */

#ifndef OAIGetDeleteEventsByEventTypeStatusRequest_H
#define OAIGetDeleteEventsByEventTypeStatusRequest_H
...
class OAIGetDeleteEventsByEventTypeStatusRequest : public OAIObject {
public:
    OAIGetDeleteEventsByEventTypeStatusRequest();
    OAIGetDeleteEventsByEventTypeStatusRequest(QString json);
    ~OAIGetDeleteEventsByEventTypeStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDeleteEventsByEventTypeStatusRequest)

#endif // OAIGetDeleteEventsByEventTypeStatusRequest_H
