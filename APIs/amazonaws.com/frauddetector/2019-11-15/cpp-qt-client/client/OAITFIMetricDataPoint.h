...
/*
 * OAITFIMetricDataPoint.h
 *
 *  The performance metrics data points for Transaction Fraud Insights (TFI) model. 
 */

#ifndef OAITFIMetricDataPoint_H
#define OAITFIMetricDataPoint_H
...
class OAITFIMetricDataPoint : public OAIObject {
public:
    OAITFIMetricDataPoint();
    OAITFIMetricDataPoint(QString json);
    ~OAITFIMetricDataPoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITFIMetricDataPoint)

#endif // OAITFIMetricDataPoint_H
