...
#ifndef OAIGetRulesResult_H
#define OAIGetRulesResult_H
...
class OAIGetRulesResult : public OAIObject {
public:
    OAIGetRulesResult();
    OAIGetRulesResult(QString json);
    ~OAIGetRulesResult() override;
    ...
    QList getRuleDetails() const;
    void setRuleDetails(const QList &rule_details);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRulesResult)

#endif // OAIGetRulesResult_H
