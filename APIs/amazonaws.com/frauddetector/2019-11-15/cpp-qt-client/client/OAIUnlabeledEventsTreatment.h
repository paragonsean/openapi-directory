...
/*
 * OAIUnlabeledEventsTreatment.h
 *
 * 
 */

#ifndef OAIUnlabeledEventsTreatment_H
#define OAIUnlabeledEventsTreatment_H
...
class OAIUnlabeledEventsTreatment : public OAIEnum {
public:
    OAIUnlabeledEventsTreatment();
    OAIUnlabeledEventsTreatment(QString json);
    ~OAIUnlabeledEventsTreatment() override;
    ...
    enum class eOAIUnlabeledEventsTreatment {
    ...
    OAIUnlabeledEventsTreatment::eOAIUnlabeledEventsTreatment getValue() const;
    void setValue(const OAIUnlabeledEventsTreatment::eOAIUnlabeledEventsTreatment& value);
...
private:
    ...
    eOAIUnlabeledEventsTreatment m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnlabeledEventsTreatment)

#endif // OAIUnlabeledEventsTreatment_H
