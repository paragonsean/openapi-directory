...
OAIVariableEntry::OAIVariableEntry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVariableEntry::OAIVariableEntry() {
    this->initializeModel();
}

OAIVariableEntry::~OAIVariableEntry() {}

void OAIVariableEntry::initializeModel() {
...
void OAIVariableEntry::fromJson(QString jsonString) {
...
void OAIVariableEntry::fromJsonObject(QJsonObject json) {
...
QString OAIVariableEntry::asJson() const {
...
QJsonObject OAIVariableEntry::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIVariableEntry::getName() const {
    return m_name;
}
void OAIVariableEntry::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIVariableEntry::is_name_Set() const{
    return m_name_isSet;
}

bool OAIVariableEntry::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIVariableEntry::getDataType() const {
    return m_data_type;
}
void OAIVariableEntry::setDataType(const QString &data_type) {
    m_data_type = data_type;
    m_data_type_isSet = true;
}

bool OAIVariableEntry::is_data_type_Set() const{
    return m_data_type_isSet;
}

bool OAIVariableEntry::is_data_type_Valid() const{
    return m_data_type_isValid;
}

QString OAIVariableEntry::getDataSource() const {
    return m_data_source;
}
void OAIVariableEntry::setDataSource(const QString &data_source) {
    m_data_source = data_source;
    m_data_source_isSet = true;
}

bool OAIVariableEntry::is_data_source_Set() const{
    return m_data_source_isSet;
}

bool OAIVariableEntry::is_data_source_Valid() const{
    return m_data_source_isValid;
}

QString OAIVariableEntry::getDefaultValue() const {
    return m_default_value;
}
void OAIVariableEntry::setDefaultValue(const QString &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIVariableEntry::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIVariableEntry::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIVariableEntry::getDescription() const {
    return m_description;
}
void OAIVariableEntry::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIVariableEntry::is_description_Set() const{
    return m_description_isSet;
}

bool OAIVariableEntry::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIVariableEntry::getVariableType() const {
    return m_variable_type;
}
void OAIVariableEntry::setVariableType(const QString &variable_type) {
    m_variable_type = variable_type;
    m_variable_type_isSet = true;
}

bool OAIVariableEntry::is_variable_type_Set() const{
    return m_variable_type_isSet;
}

bool OAIVariableEntry::is_variable_type_Valid() const{
    return m_variable_type_isValid;
}

bool OAIVariableEntry::isSet() const {
...
bool OAIVariableEntry::isValid() const {
