...
OAICreateRuleResult::OAICreateRuleResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRuleResult::OAICreateRuleResult() {
    this->initializeModel();
}

OAICreateRuleResult::~OAICreateRuleResult() {}

void OAICreateRuleResult::initializeModel() {

    m_rule_isSet = false;
    m_rule_isValid = false;
}

void OAICreateRuleResult::fromJson(QString jsonString) {
...
QJsonObject OAICreateRuleResult::asJsonObject() const {
    QJsonObject obj;
    if (m_rule.isSet()) {
...
OAICreateRuleResult_rule OAICreateRuleResult::getRule() const {
    return m_rule;
}
void OAICreateRuleResult::setRule(const OAICreateRuleResult_rule &rule) {
    m_rule = rule;
    m_rule_isSet = true;
}

bool OAICreateRuleResult::is_rule_Set() const{
    return m_rule_isSet;
}

bool OAICreateRuleResult::is_rule_Valid() const{
    return m_rule_isValid;
}

bool OAICreateRuleResult::isSet() const {
...
bool OAICreateRuleResult::isValid() const {
