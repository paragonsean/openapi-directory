...
QString OAIUpdateModelRequest::getModelId() const {
    return m_model_id;
}
void OAIUpdateModelRequest::setModelId(const QString &model_id) {
    m_model_id = model_id;
    m_model_id_isSet = true;
}

bool OAIUpdateModelRequest::is_model_id_Set() const{
    return m_model_id_isSet;
}

bool OAIUpdateModelRequest::is_model_id_Valid() const{
    return m_model_id_isValid;
}

OAIModelTypeEnum OAIUpdateModelRequest::getModelType() const {
    return m_model_type;
}
void OAIUpdateModelRequest::setModelType(const OAIModelTypeEnum &model_type) {
    m_model_type = model_type;
    m_model_type_isSet = true;
}

bool OAIUpdateModelRequest::is_model_type_Set() const{
    return m_model_type_isSet;
}

bool OAIUpdateModelRequest::is_model_type_Valid() const{
