...
void OAIOutcome::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIOutcome::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIOutcome::getName() const {
    return m_name;
}
void OAIOutcome::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIOutcome::is_name_Set() const{
    return m_name_isSet;
}

bool OAIOutcome::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIOutcome::getDescription() const {
    return m_description;
}
void OAIOutcome::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIOutcome::is_description_Set() const{
    return m_description_isSet;
}

bool OAIOutcome::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIOutcome::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAIOutcome::setLastUpdatedTime(const QString &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAIOutcome::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAIOutcome::is_last_updated_time_Valid() const{
    return m_last_updated_time_isValid;
}

QString OAIOutcome::getCreatedTime() const {
    return m_created_time;
}
void OAIOutcome::setCreatedTime(const QString &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIOutcome::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIOutcome::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIOutcome::getArn() const {
    return m_arn;
}
void OAIOutcome::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIOutcome::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIOutcome::is_arn_Valid() const{
