...
/*
 * OAIDescribeModelVersionsRequest.h
 *
 * 
 */

#ifndef OAIDescribeModelVersionsRequest_H
#define OAIDescribeModelVersionsRequest_H
...
class OAIDescribeModelVersionsRequest : public OAIObject {
public:
    OAIDescribeModelVersionsRequest();
    OAIDescribeModelVersionsRequest(QString json);
    ~OAIDescribeModelVersionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeModelVersionsRequest)

#endif // OAIDescribeModelVersionsRequest_H
