...
void OAIDataSource::initializeModel() {
    ...
    m_value = eOAIDataSource::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDataSource::fromJson(QString jsonString) {
    
    if ( jsonString.compare("EVENT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataSource::EVENT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MODEL_SCORE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataSource::MODEL_SCORE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EXTERNAL_MODEL_SCORE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataSource::EXTERNAL_MODEL_SCORE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDataSource::fromJsonValue(QJsonValue json) {
...
QString OAIDataSource::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIDataSource::EVENT:
            val = "EVENT";
            break;
        case eOAIDataSource::MODEL_SCORE:
            val = "MODEL_SCORE";
            break;
        case eOAIDataSource::EXTERNAL_MODEL_SCORE:
            val = "EXTERNAL_MODEL_SCORE";
            break;
        default:
            break;
    }
...
QJsonValue OAIDataSource::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDataSource::eOAIDataSource OAIDataSource::getValue() const {
    return m_value;
}

void OAIDataSource::setValue(const OAIDataSource::eOAIDataSource& value){
    m_value = value;
    m_value_isSet = true;
}
