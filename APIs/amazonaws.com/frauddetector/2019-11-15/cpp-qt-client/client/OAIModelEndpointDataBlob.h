...
/*
 * OAIModelEndpointDataBlob.h
 *
 * A pre-formed Amazon SageMaker model input you can include if your detector version includes an imported Amazon SageMaker model endpoint with pass-through input configuration.
 */

#ifndef OAIModelEndpointDataBlob_H
#define OAIModelEndpointDataBlob_H
...
class OAIModelEndpointDataBlob : public OAIObject {
public:
    OAIModelEndpointDataBlob();
    OAIModelEndpointDataBlob(QString json);
    ~OAIModelEndpointDataBlob() override;
    ...
    QString getByteBuffer() const;
    void setByteBuffer(const QString &byte_buffer);
    bool is_byte_buffer_Set() const;
    bool is_byte_buffer_Valid() const;
...
private:
    ...
    QString m_byte_buffer;
    bool m_byte_buffer_isSet;
    bool m_byte_buffer_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelEndpointDataBlob)

#endif // OAIModelEndpointDataBlob_H
