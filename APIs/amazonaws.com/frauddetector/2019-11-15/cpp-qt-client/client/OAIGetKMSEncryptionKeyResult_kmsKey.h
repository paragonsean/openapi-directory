...
/*
 * OAIGetKMSEncryptionKeyResult_kmsKey.h
 *
 * 
 */

#ifndef OAIGetKMSEncryptionKeyResult_kmsKey_H
#define OAIGetKMSEncryptionKeyResult_kmsKey_H
...
class OAIGetKMSEncryptionKeyResult_kmsKey : public OAIObject {
public:
    OAIGetKMSEncryptionKeyResult_kmsKey();
    OAIGetKMSEncryptionKeyResult_kmsKey(QString json);
    ~OAIGetKMSEncryptionKeyResult_kmsKey() override;
    ...
    QString getKmsEncryptionKeyArn() const;
    void setKmsEncryptionKeyArn(const QString &kms_encryption_key_arn);
    bool is_kms_encryption_key_arn_Set() const;
    bool is_kms_encryption_key_arn_Valid() const;
...
private:
    ...
    QString m_kms_encryption_key_arn;
    bool m_kms_encryption_key_arn_isSet;
    bool m_kms_encryption_key_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetKMSEncryptionKeyResult_kmsKey)

#endif // OAIGetKMSEncryptionKeyResult_kmsKey_H
