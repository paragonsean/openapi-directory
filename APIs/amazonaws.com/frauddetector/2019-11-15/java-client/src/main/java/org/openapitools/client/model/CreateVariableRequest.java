...
public class CreateVariableRequest {
  ...
  public CreateVariableRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateVariableRequest dataType(DataType dataType) {
  ...
  public CreateVariableRequest dataSource(DataSource dataSource) {
  ...
  public CreateVariableRequest defaultValue(String defaultValue) {
  ...
  public CreateVariableRequest description(String description) {
  ...
  public CreateVariableRequest variableType(String variableType) {
  ...
  public CreateVariableRequest tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createVariableRequest.name) &&
        Objects.equals(this.dataType, createVariableRequest.dataType) &&
        Objects.equals(this.dataSource, createVariableRequest.dataSource) &&
        Objects.equals(this.defaultValue, createVariableRequest.defaultValue) &&
        Objects.equals(this.description, createVariableRequest.description) &&
        Objects.equals(this.variableType, createVariableRequest.variableType) &&
        Objects.equals(this.tags, createVariableRequest.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, dataType, dataSource, defaultValue, description, variableType, tags);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateVariableRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateVariableRequest is not found in the empty JSON string", CreateVariableRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateVariableRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateVariableRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateVariableRequest>() {
           @Override
           public void write(JsonWriter out, CreateVariableRequest value) throws IOException {
