...
/**
 * Gets or Sets ModelEndpointStatus
 */
@JsonAdapter(ModelEndpointStatus.Adapter.class)
public enum ModelEndpointStatus {
  ...
  ModelEndpointStatus(String value) {
    this.value = value;
  }
  ...
  public static ModelEndpointStatus fromValue(String value) {
    for (ModelEndpointStatus b : ModelEndpointStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ModelEndpointStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ModelEndpointStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ModelEndpointStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ModelEndpointStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ModelEndpointStatus.fromValue(value);
  }
}
