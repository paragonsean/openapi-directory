...
/**
 * Gets or Sets DetectorVersionStatus
 */
@JsonAdapter(DetectorVersionStatus.Adapter.class)
public enum DetectorVersionStatus {
  ...
  public static DetectorVersionStatus fromValue(String value) {
    for (DetectorVersionStatus b : DetectorVersionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<DetectorVersionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final DetectorVersionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DetectorVersionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DetectorVersionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DetectorVersionStatus.fromValue(value);
  }
}
