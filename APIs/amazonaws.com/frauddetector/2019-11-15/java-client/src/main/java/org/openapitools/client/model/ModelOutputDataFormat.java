...
/**
 * Gets or Sets ModelOutputDataFormat
 */
@JsonAdapter(ModelOutputDataFormat.Adapter.class)
public enum ModelOutputDataFormat {
  ...
  ModelOutputDataFormat(String value) {
    this.value = value;
  }
  ...
  public static ModelOutputDataFormat fromValue(String value) {
    for (ModelOutputDataFormat b : ModelOutputDataFormat.values()) {
  ...
  public static class Adapter extends TypeAdapter<ModelOutputDataFormat> {
    @Override
    public void write(final JsonWriter jsonWriter, final ModelOutputDataFormat enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ModelOutputDataFormat read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ModelOutputDataFormat.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ModelOutputDataFormat.fromValue(value);
  }
}
