...
/**
 * Gets or Sets TrainingDataSourceEnum
 */
@JsonAdapter(TrainingDataSourceEnum.Adapter.class)
public enum TrainingDataSourceEnum {
  ...
  TrainingDataSourceEnum(String value) {
    this.value = value;
  }
  ...
  public static TrainingDataSourceEnum fromValue(String value) {
    for (TrainingDataSourceEnum b : TrainingDataSourceEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<TrainingDataSourceEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final TrainingDataSourceEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TrainingDataSourceEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TrainingDataSourceEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TrainingDataSourceEnum.fromValue(value);
  }
}
