...
public class TrainingResultV2 {
  ...
  public TrainingResultV2() {
  }

  public TrainingResultV2 dataValidationMetrics(DataValidationMetrics dataValidationMetrics) {
  ...
  public TrainingResultV2 trainingMetricsV2(TrainingResultV2TrainingMetricsV2 trainingMetricsV2) {
  ...
  public TrainingResultV2 variableImportanceMetrics(VariableImportanceMetrics variableImportanceMetrics) {
  ...
  public TrainingResultV2 aggregatedVariablesImportanceMetrics(TrainingResultV2AggregatedVariablesImportanceMetrics aggregatedVariablesImportanceMetrics) {
  ...
  public boolean equals(Object o) {
    ...
    TrainingResultV2 trainingResultV2 = (TrainingResultV2) o;
    return Objects.equals(this.dataValidationMetrics, trainingResultV2.dataValidationMetrics) &&
        Objects.equals(this.trainingMetricsV2, trainingResultV2.trainingMetricsV2) &&
        Objects.equals(this.variableImportanceMetrics, trainingResultV2.variableImportanceMetrics) &&
        Objects.equals(this.aggregatedVariablesImportanceMetrics, trainingResultV2.aggregatedVariablesImportanceMetrics);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrainingResultV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrainingResultV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrainingResultV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrainingResultV2 is not found in the empty JSON string", TrainingResultV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrainingResultV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrainingResultV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrainingResultV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrainingResultV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrainingResultV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrainingResultV2.class));

       return (TypeAdapter<T>) new TypeAdapter<TrainingResultV2>() {
           @Override
           public void write(JsonWriter out, TrainingResultV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrainingResultV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrainingResultV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrainingResultV2
   * @throws IOException if the JSON string is invalid with respect to TrainingResultV2
   */
  public static TrainingResultV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrainingResultV2.class);
  }

  /**
   * Convert an instance of TrainingResultV2 to an JSON string
   *
   * @return JSON string
   */
