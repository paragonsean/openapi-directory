...
/**
 * Gets or Sets AsyncJobStatus
 */
@JsonAdapter(AsyncJobStatus.Adapter.class)
public enum AsyncJobStatus {
  ...
  public static AsyncJobStatus fromValue(String value) {
    for (AsyncJobStatus b : AsyncJobStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<AsyncJobStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AsyncJobStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AsyncJobStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AsyncJobStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AsyncJobStatus.fromValue(value);
  }
}
