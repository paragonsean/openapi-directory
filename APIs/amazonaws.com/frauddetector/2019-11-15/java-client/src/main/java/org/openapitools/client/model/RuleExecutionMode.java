...
/**
 * Gets or Sets RuleExecutionMode
 */
@JsonAdapter(RuleExecutionMode.Adapter.class)
public enum RuleExecutionMode {
  ...
  RuleExecutionMode(String value) {
    this.value = value;
  }
  ...
  public static RuleExecutionMode fromValue(String value) {
    for (RuleExecutionMode b : RuleExecutionMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<RuleExecutionMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final RuleExecutionMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RuleExecutionMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RuleExecutionMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RuleExecutionMode.fromValue(value);
  }
}
