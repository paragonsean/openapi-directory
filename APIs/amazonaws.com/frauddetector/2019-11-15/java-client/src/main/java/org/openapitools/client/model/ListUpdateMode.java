...
/**
 * Gets or Sets ListUpdateMode
 */
@JsonAdapter(ListUpdateMode.Adapter.class)
public enum ListUpdateMode {
  ...
  public static ListUpdateMode fromValue(String value) {
    for (ListUpdateMode b : ListUpdateMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<ListUpdateMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ListUpdateMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ListUpdateMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ListUpdateMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ListUpdateMode.fromValue(value);
  }
}
