...
/**
 * Gets or Sets EventIngestion
 */
@JsonAdapter(EventIngestion.Adapter.class)
public enum EventIngestion {
  ...
  public static EventIngestion fromValue(String value) {
    for (EventIngestion b : EventIngestion.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventIngestion> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventIngestion enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventIngestion read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventIngestion.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EventIngestion.fromValue(value);
  }
}
