...
/**
 * Gets or Sets ModelInputDataFormat
 */
@JsonAdapter(ModelInputDataFormat.Adapter.class)
public enum ModelInputDataFormat {
  ...
  ModelInputDataFormat(String value) {
    this.value = value;
  }
  ...
  public static ModelInputDataFormat fromValue(String value) {
    for (ModelInputDataFormat b : ModelInputDataFormat.values()) {
  ...
  public static class Adapter extends TypeAdapter<ModelInputDataFormat> {
    @Override
    public void write(final JsonWriter jsonWriter, final ModelInputDataFormat enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ModelInputDataFormat read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ModelInputDataFormat.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ModelInputDataFormat.fromValue(value);
  }
}
