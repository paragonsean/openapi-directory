...
/**
 * Gets or Sets UnlabeledEventsTreatment
 */
@JsonAdapter(UnlabeledEventsTreatment.Adapter.class)
public enum UnlabeledEventsTreatment {
  ...
  UnlabeledEventsTreatment(String value) {
    this.value = value;
  }
  ...
  public static UnlabeledEventsTreatment fromValue(String value) {
    for (UnlabeledEventsTreatment b : UnlabeledEventsTreatment.values()) {
  ...
  public static class Adapter extends TypeAdapter<UnlabeledEventsTreatment> {
    @Override
    public void write(final JsonWriter jsonWriter, final UnlabeledEventsTreatment enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UnlabeledEventsTreatment read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UnlabeledEventsTreatment.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UnlabeledEventsTreatment.fromValue(value);
  }
}
