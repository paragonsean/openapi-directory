...
public class ApiClient {
    ...
    private String basePath = "http://frauddetector.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://frauddetector.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://frauddetector.{region}.amazonaws.com",
      "The Amazon Fraud Detector multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://frauddetector.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://frauddetector.{region}.amazonaws.com.cn",
      "The Amazon Fraud Detector endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2019-11-15/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://frauddetector.us-east-1.amazonaws.com
