...
class DeleteLabelRequest(Model):
    ...
    def __init__(self, name: str=None):
        ...
        :param name: The name of this DeleteLabelRequest.
        """
        self.openapi_types = {
            'name': str
        }
    ...
    @property
    def name(self):
        """Gets the name of this DeleteLabelRequest.


        :return: The name of this DeleteLabelRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DeleteLabelRequest.
