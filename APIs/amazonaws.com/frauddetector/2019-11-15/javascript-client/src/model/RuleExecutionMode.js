...
* @readonly
*/
export default class RuleExecutionMode {
    ...
    /**
    * Returns a <code>RuleExecutionMode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RuleExecutionMode} The enum <code>RuleExecutionMode</code> value.
    */
