...
/**
 * The GetLabelsRequest model module.
 * @module model/GetLabelsRequest
 * @version 2019-11-15
 */
class GetLabelsRequest {
    /**
     * Constructs a new <code>GetLabelsRequest</code>.
     * @alias module:model/GetLabelsRequest
     */
    constructor() { 
        
        GetLabelsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLabelsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLabelsRequest} obj Optional instance to populate.
     * @return {module:model/GetLabelsRequest} The populated <code>GetLabelsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLabelsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetLabelsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLabelsRequest</code>.
     */
 ...
 * @member {String} name
 */
GetLabelsRequest.prototype['name'] = undefined;

/**
 * @member {String} nextToken
 */
GetLabelsRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
GetLabelsRequest.prototype['maxResults'] = undefined;
...
export default GetLabelsRequest;
