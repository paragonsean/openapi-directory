...
/**
 * The GetBatchImportJobsRequest model module.
 * @module model/GetBatchImportJobsRequest
 * @version 2019-11-15
 */
class GetBatchImportJobsRequest {
    /**
     * Constructs a new <code>GetBatchImportJobsRequest</code>.
     * @alias module:model/GetBatchImportJobsRequest
     */
    constructor() { 
        
        GetBatchImportJobsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetBatchImportJobsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBatchImportJobsRequest} obj Optional instance to populate.
     * @return {module:model/GetBatchImportJobsRequest} The populated <code>GetBatchImportJobsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBatchImportJobsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetBatchImportJobsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBatchImportJobsRequest</code>.
     */
 ...
 * @member {String} jobId
 */
GetBatchImportJobsRequest.prototype['jobId'] = undefined;

/**
 * @member {Number} maxResults
 */
GetBatchImportJobsRequest.prototype['maxResults'] = undefined;

/**
 * @member {String} nextToken
 */
GetBatchImportJobsRequest.prototype['nextToken'] = undefined;
...
export default GetBatchImportJobsRequest;
