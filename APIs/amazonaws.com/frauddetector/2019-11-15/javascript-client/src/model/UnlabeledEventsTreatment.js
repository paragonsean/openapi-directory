...
* @readonly
*/
export default class UnlabeledEventsTreatment {
    ...
    /**
    * Returns a <code>UnlabeledEventsTreatment</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UnlabeledEventsTreatment} The enum <code>UnlabeledEventsTreatment</code> value.
    */
