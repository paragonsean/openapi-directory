...
* @readonly
*/
export default class EventIngestion {
    ...
    /**
    * Returns a <code>EventIngestion</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EventIngestion} The enum <code>EventIngestion</code> value.
    */
