...
/**
 * The GetVariablesRequest model module.
 * @module model/GetVariablesRequest
 * @version 2019-11-15
 */
class GetVariablesRequest {
    /**
     * Constructs a new <code>GetVariablesRequest</code>.
     * @alias module:model/GetVariablesRequest
     */
    constructor() { 
        
        GetVariablesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetVariablesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetVariablesRequest} obj Optional instance to populate.
     * @return {module:model/GetVariablesRequest} The populated <code>GetVariablesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetVariablesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetVariablesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetVariablesRequest</code>.
     */
 ...
 * @member {String} name
 */
GetVariablesRequest.prototype['name'] = undefined;

/**
 * @member {String} nextToken
 */
GetVariablesRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
GetVariablesRequest.prototype['maxResults'] = undefined;
...
export default GetVariablesRequest;
