...
* @readonly
*/
export default class ModelEndpointStatus {
    ...
    /**
    * Returns a <code>ModelEndpointStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ModelEndpointStatus} The enum <code>ModelEndpointStatus</code> value.
    */
