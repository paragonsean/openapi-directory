...
/**
 * The GetEntityTypesRequest model module.
 * @module model/GetEntityTypesRequest
 * @version 2019-11-15
 */
class GetEntityTypesRequest {
    /**
     * Constructs a new <code>GetEntityTypesRequest</code>.
     * @alias module:model/GetEntityTypesRequest
     */
    constructor() { 
        
        GetEntityTypesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEntityTypesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetEntityTypesRequest} obj Optional instance to populate.
     * @return {module:model/GetEntityTypesRequest} The populated <code>GetEntityTypesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEntityTypesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetEntityTypesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEntityTypesRequest</code>.
     */
 ...
 * @member {String} name
 */
GetEntityTypesRequest.prototype['name'] = undefined;

/**
 * @member {String} nextToken
 */
GetEntityTypesRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
GetEntityTypesRequest.prototype['maxResults'] = undefined;
...
export default GetEntityTypesRequest;
