...
/**
 * The GetEntityTypesResult model module.
 * @module model/GetEntityTypesResult
 * @version 2019-11-15
 */
class GetEntityTypesResult {
    /**
     * Constructs a new <code>GetEntityTypesResult</code>.
     * @alias module:model/GetEntityTypesResult
     */
    constructor() { 
        
        GetEntityTypesResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEntityTypesResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetEntityTypesResult} obj Optional instance to populate.
     * @return {module:model/GetEntityTypesResult} The populated <code>GetEntityTypesResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEntityTypesResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetEntityTypesResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEntityTypesResult</code>.
     */
 ...
 */
GetEntityTypesResult.prototype['entityTypes'] = undefined;

/**
 * @member {String} nextToken
 */
GetEntityTypesResult.prototype['nextToken'] = undefined;
...
export default GetEntityTypesResult;
