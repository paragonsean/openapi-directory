...
/**
 * The GetRulesRequest model module.
 * @module model/GetRulesRequest
 * @version 2019-11-15
 */
class GetRulesRequest {
    /**
     * Constructs a new <code>GetRulesRequest</code>.
     * @alias module:model/GetRulesRequest
     * @param detectorId {String} 
     */
    constructor(detectorId) { 
        
        GetRulesRequest.initialize(this, detectorId);
    }
    ...
    /**
     * Constructs a <code>GetRulesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRulesRequest} obj Optional instance to populate.
     * @return {module:model/GetRulesRequest} The populated <code>GetRulesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRulesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRulesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRulesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetRulesRequest.RequiredProperties) {
...
GetRulesRequest.RequiredProperties = ["detectorId"];

/**
 * @member {String} ruleId
 */
GetRulesRequest.prototype['ruleId'] = undefined;

/**
 * @member {String} detectorId
 */
GetRulesRequest.prototype['detectorId'] = undefined;

/**
 * @member {String} ruleVersion
 */
GetRulesRequest.prototype['ruleVersion'] = undefined;

/**
 * @member {String} nextToken
 */
GetRulesRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
GetRulesRequest.prototype['maxResults'] = undefined;
...
export default GetRulesRequest;
