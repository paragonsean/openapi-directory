...
/**
 * The ExternalEventsDetail model module.
 * @module model/ExternalEventsDetail
 * @version 2019-11-15
 */
class ExternalEventsDetail {
    /**
     * Constructs a new <code>ExternalEventsDetail</code>.
     * Details for the external events data used for model version training.
     * @alias module:model/ExternalEventsDetail
    ...
    /**
     * Constructs a <code>ExternalEventsDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExternalEventsDetail} obj Optional instance to populate.
     * @return {module:model/ExternalEventsDetail} The populated <code>ExternalEventsDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExternalEventsDetail();
    ...
    /**
     * Validates the JSON data with respect to <code>ExternalEventsDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExternalEventsDetail</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExternalEventsDetail.RequiredProperties) {
...
ExternalEventsDetail.RequiredProperties = ["dataLocation", "dataAccessRoleArn"];
...
export default ExternalEventsDetail;
