...
/**
 * The GetVariablesResult model module.
 * @module model/GetVariablesResult
 * @version 2019-11-15
 */
class GetVariablesResult {
    /**
     * Constructs a new <code>GetVariablesResult</code>.
     * @alias module:model/GetVariablesResult
     */
    constructor() { 
        
        GetVariablesResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetVariablesResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetVariablesResult} obj Optional instance to populate.
     * @return {module:model/GetVariablesResult} The populated <code>GetVariablesResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetVariablesResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetVariablesResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetVariablesResult</code>.
     */
 ...
 */
GetVariablesResult.prototype['variables'] = undefined;

/**
 * @member {String} nextToken
 */
GetVariablesResult.prototype['nextToken'] = undefined;
...
export default GetVariablesResult;
