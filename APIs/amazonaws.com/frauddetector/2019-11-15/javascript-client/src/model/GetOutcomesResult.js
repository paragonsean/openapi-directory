...
/**
 * The GetOutcomesResult model module.
 * @module model/GetOutcomesResult
 * @version 2019-11-15
 */
class GetOutcomesResult {
    /**
     * Constructs a new <code>GetOutcomesResult</code>.
     * @alias module:model/GetOutcomesResult
     */
    constructor() { 
        
        GetOutcomesResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOutcomesResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOutcomesResult} obj Optional instance to populate.
     * @return {module:model/GetOutcomesResult} The populated <code>GetOutcomesResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOutcomesResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetOutcomesResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOutcomesResult</code>.
     */
 ...
 */
GetOutcomesResult.prototype['outcomes'] = undefined;

/**
 * @member {String} nextToken
 */
GetOutcomesResult.prototype['nextToken'] = undefined;
...
export default GetOutcomesResult;
