...
/**
 * The BatchCreateVariableResult model module.
 * @module model/BatchCreateVariableResult
 * @version 2019-11-15
 */
class BatchCreateVariableResult {
    /**
     * Constructs a new <code>BatchCreateVariableResult</code>.
     * @alias module:model/BatchCreateVariableResult
     */
    constructor() { 
        
        BatchCreateVariableResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchCreateVariableResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchCreateVariableResult} obj Optional instance to populate.
     * @return {module:model/BatchCreateVariableResult} The populated <code>BatchCreateVariableResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchCreateVariableResult();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchCreateVariableResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchCreateVariableResult</code>.
     */
 ...
 * @member {Array} errors
 */
BatchCreateVariableResult.prototype['errors'] = undefined;
...
export default BatchCreateVariableResult;
