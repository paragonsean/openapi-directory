...
* @readonly
*/
export default class DetectorVersionStatus {
    ...
    /**
    * Returns a <code>DetectorVersionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DetectorVersionStatus} The enum <code>DetectorVersionStatus</code> value.
    */
