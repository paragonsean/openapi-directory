...
* @readonly
*/
export default class ModelOutputDataFormat {
    ...
    /**
    * Returns a <code>ModelOutputDataFormat</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ModelOutputDataFormat} The enum <code>ModelOutputDataFormat</code> value.
    */
