...
/**
 * The GetListsMetadataResult model module.
 * @module model/GetListsMetadataResult
 * @version 2019-11-15
 */
class GetListsMetadataResult {
    /**
     * Constructs a new <code>GetListsMetadataResult</code>.
     * @alias module:model/GetListsMetadataResult
     */
    constructor() { 
        
        GetListsMetadataResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetListsMetadataResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetListsMetadataResult} obj Optional instance to populate.
     * @return {module:model/GetListsMetadataResult} The populated <code>GetListsMetadataResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetListsMetadataResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetListsMetadataResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetListsMetadataResult</code>.
     */
 ...
 * @member {Array} lists
 */
GetListsMetadataResult.prototype['lists'] = undefined;

/**
 * @member {String} nextToken
 */
GetListsMetadataResult.prototype['nextToken'] = undefined;
...
export default GetListsMetadataResult;
