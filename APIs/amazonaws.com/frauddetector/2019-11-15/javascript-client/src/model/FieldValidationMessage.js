...
/**
 * The FieldValidationMessage model module.
 * @module model/FieldValidationMessage
 * @version 2019-11-15
 */
class FieldValidationMessage {
    /**
     * Constructs a new <code>FieldValidationMessage</code>.
     * The message details.
     * @alias module:model/FieldValidationMessage
     */
    constructor() { 
        
        FieldValidationMessage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FieldValidationMessage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FieldValidationMessage} obj Optional instance to populate.
     * @return {module:model/FieldValidationMessage} The populated <code>FieldValidationMessage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FieldValidationMessage();
    ...
    /**
     * Validates the JSON data with respect to <code>FieldValidationMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FieldValidationMessage</code>.
     */
 ...
 */
FieldValidationMessage.prototype['fieldName'] = undefined;

/**
 * @member {String} identifier
 */
FieldValidationMessage.prototype['identifier'] = undefined;

/**
 * @member {String} title
 */
FieldValidationMessage.prototype['title'] = undefined;

/**
 * @member {String} content
 */
FieldValidationMessage.prototype['content'] = undefined;

/**
 * @member {String} type
 */
FieldValidationMessage.prototype['type'] = undefined;
