...
* @readonly
*/
export default class ModelInputDataFormat {
    ...
    /**
    * Returns a <code>ModelInputDataFormat</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ModelInputDataFormat} The enum <code>ModelInputDataFormat</code> value.
    */
