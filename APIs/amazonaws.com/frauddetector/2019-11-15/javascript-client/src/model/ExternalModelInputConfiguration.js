...
/**
 * The ExternalModelInputConfiguration model module.
 * @module model/ExternalModelInputConfiguration
 * @version 2019-11-15
 */
class ExternalModelInputConfiguration {
    /**
     * Constructs a new <code>ExternalModelInputConfiguration</code>.
     * @alias module:model/ExternalModelInputConfiguration
    ...
    constructor(useEventVariables) { 
        ...
        ExternalModelInputConfiguration.initialize(this, useEventVariables);
    }
    ...
    /**
     * Constructs a <code>ExternalModelInputConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExternalModelInputConfiguration} obj Optional instance to populate.
     * @return {module:model/ExternalModelInputConfiguration} The populated <code>ExternalModelInputConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExternalModelInputConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>ExternalModelInputConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExternalModelInputConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExternalModelInputConfiguration.RequiredProperties) {
...
ExternalModelInputConfiguration.RequiredProperties = ["useEventVariables"];

/**
 * @member {String} eventTypeName
 */
ExternalModelInputConfiguration.prototype['eventTypeName'] = undefined;

/**
 * @member {module:model/ModelInputDataFormat} format
 */
ExternalModelInputConfiguration.prototype['format'] = undefined;

/**
 * @member {Boolean} useEventVariables
 */
ExternalModelInputConfiguration.prototype['useEventVariables'] = undefined;

/**
 * @member {String} jsonInputTemplate
 */
ExternalModelInputConfiguration.prototype['jsonInputTemplate'] = undefined;

/**
 * @member {String} csvInputTemplate
 */
ExternalModelInputConfiguration.prototype['csvInputTemplate'] = undefined;
...
export default ExternalModelInputConfiguration;
