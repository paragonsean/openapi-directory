...
/**
 * The GetOutcomesRequest model module.
 * @module model/GetOutcomesRequest
 * @version 2019-11-15
 */
class GetOutcomesRequest {
    /**
     * Constructs a new <code>GetOutcomesRequest</code>.
     * @alias module:model/GetOutcomesRequest
     */
    constructor() { 
        
        GetOutcomesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOutcomesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOutcomesRequest} obj Optional instance to populate.
     * @return {module:model/GetOutcomesRequest} The populated <code>GetOutcomesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOutcomesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetOutcomesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOutcomesRequest</code>.
     */
 ...
 * @member {String} name
 */
GetOutcomesRequest.prototype['name'] = undefined;

/**
 * @member {String} nextToken
 */
GetOutcomesRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
GetOutcomesRequest.prototype['maxResults'] = undefined;
...
export default GetOutcomesRequest;
