...
* @readonly
*/
export default class TrainingDataSourceEnum {
    ...
    /**
    * Returns a <code>TrainingDataSourceEnum</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TrainingDataSourceEnum} The enum <code>TrainingDataSourceEnum</code> value.
    */
