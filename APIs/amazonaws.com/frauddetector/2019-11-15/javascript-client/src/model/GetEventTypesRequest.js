...
/**
 * The GetEventTypesRequest model module.
 * @module model/GetEventTypesRequest
 * @version 2019-11-15
 */
class GetEventTypesRequest {
    /**
     * Constructs a new <code>GetEventTypesRequest</code>.
     * @alias module:model/GetEventTypesRequest
     */
    constructor() { 
        
        GetEventTypesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEventTypesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetEventTypesRequest} obj Optional instance to populate.
     * @return {module:model/GetEventTypesRequest} The populated <code>GetEventTypesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEventTypesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetEventTypesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEventTypesRequest</code>.
     */
 ...
 * @member {String} name
 */
GetEventTypesRequest.prototype['name'] = undefined;

/**
 * @member {String} nextToken
 */
GetEventTypesRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
GetEventTypesRequest.prototype['maxResults'] = undefined;
...
export default GetEventTypesRequest;
