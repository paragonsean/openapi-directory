...
* @readonly
*/
export default class ModelVersionStatus {
    ...
    /**
    * Returns a <code>ModelVersionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ModelVersionStatus} The enum <code>ModelVersionStatus</code> value.
    */
