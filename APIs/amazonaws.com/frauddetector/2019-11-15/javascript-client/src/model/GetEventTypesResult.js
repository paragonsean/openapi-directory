...
/**
 * The GetEventTypesResult model module.
 * @module model/GetEventTypesResult
 * @version 2019-11-15
 */
class GetEventTypesResult {
    /**
     * Constructs a new <code>GetEventTypesResult</code>.
     * @alias module:model/GetEventTypesResult
     */
    constructor() { 
        
        GetEventTypesResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEventTypesResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetEventTypesResult} obj Optional instance to populate.
     * @return {module:model/GetEventTypesResult} The populated <code>GetEventTypesResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEventTypesResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetEventTypesResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEventTypesResult</code>.
     */
 ...
 */
GetEventTypesResult.prototype['eventTypes'] = undefined;

/**
 * @member {String} nextToken
 */
GetEventTypesResult.prototype['nextToken'] = undefined;
...
export default GetEventTypesResult;
