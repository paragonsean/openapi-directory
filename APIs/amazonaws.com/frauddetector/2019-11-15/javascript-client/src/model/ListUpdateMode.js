...
* @readonly
*/
export default class ListUpdateMode {
    ...
    /**
    * Returns a <code>ListUpdateMode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ListUpdateMode} The enum <code>ListUpdateMode</code> value.
    */
