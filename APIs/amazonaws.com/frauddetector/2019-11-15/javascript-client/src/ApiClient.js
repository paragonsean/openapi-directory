...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://frauddetector.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://frauddetector.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2019-11-15/Javascript'
        };
