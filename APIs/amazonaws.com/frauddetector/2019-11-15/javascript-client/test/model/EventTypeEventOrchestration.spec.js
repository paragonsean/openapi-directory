...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.EventTypeEventOrchestration();
  });
  ...
  describe('EventTypeEventOrchestration', function() {
    it('should create an instance of EventTypeEventOrchestration', function() {
      // uncomment below and update the code to test EventTypeEventOrchestration
      //var instance = new AmazonFraudDetector.EventTypeEventOrchestration();
      //expect(instance).to.be.a(AmazonFraudDetector.EventTypeEventOrchestration);
    });
