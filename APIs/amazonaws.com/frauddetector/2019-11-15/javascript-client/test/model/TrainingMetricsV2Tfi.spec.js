...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TrainingMetricsV2Tfi();
  });
  ...
  describe('TrainingMetricsV2Tfi', function() {
    it('should create an instance of TrainingMetricsV2Tfi', function() {
      // uncomment below and update the code to test TrainingMetricsV2Tfi
      //var instance = new AmazonFraudDetector.TrainingMetricsV2Tfi();
      //expect(instance).to.be.a(AmazonFraudDetector.TrainingMetricsV2Tfi);
    });
