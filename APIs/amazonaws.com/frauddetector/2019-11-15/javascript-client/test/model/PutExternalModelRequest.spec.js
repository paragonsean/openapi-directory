...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.PutExternalModelRequest();
  });
  ...
  describe('PutExternalModelRequest', function() {
    it('should create an instance of PutExternalModelRequest', function() {
      // uncomment below and update the code to test PutExternalModelRequest
      //var instance = new AmazonFraudDetector.PutExternalModelRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.PutExternalModelRequest);
    });
