...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TrainingResultDataValidationMetrics();
  });
  ...
  describe('TrainingResultDataValidationMetrics', function() {
    it('should create an instance of TrainingResultDataValidationMetrics', function() {
      // uncomment below and update the code to test TrainingResultDataValidationMetrics
      //var instance = new AmazonFraudDetector.TrainingResultDataValidationMetrics();
      //expect(instance).to.be.a(AmazonFraudDetector.TrainingResultDataValidationMetrics);
    });
