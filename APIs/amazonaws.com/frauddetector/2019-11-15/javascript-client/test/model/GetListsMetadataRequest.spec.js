...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetListsMetadataRequest();
  });
  ...
  describe('GetListsMetadataRequest', function() {
    it('should create an instance of GetListsMetadataRequest', function() {
      // uncomment below and update the code to test GetListsMetadataRequest
      //var instance = new AmazonFraudDetector.GetListsMetadataRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetListsMetadataRequest);
    });
