...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteEntityTypeRequest();
  });
  ...
  describe('DeleteEntityTypeRequest', function() {
    it('should create an instance of DeleteEntityTypeRequest', function() {
      // uncomment below and update the code to test DeleteEntityTypeRequest
      //var instance = new AmazonFraudDetector.DeleteEntityTypeRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteEntityTypeRequest);
    });
