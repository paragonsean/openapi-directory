...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteDetectorVersionRequest();
  });
  ...
  describe('DeleteDetectorVersionRequest', function() {
    it('should create an instance of DeleteDetectorVersionRequest', function() {
      // uncomment below and update the code to test DeleteDetectorVersionRequest
      //var instance = new AmazonFraudDetector.DeleteDetectorVersionRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteDetectorVersionRequest);
    });
