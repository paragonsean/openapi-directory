...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateModelRequest();
  });
  ...
  describe('UpdateModelRequest', function() {
    it('should create an instance of UpdateModelRequest', function() {
      // uncomment below and update the code to test UpdateModelRequest
      //var instance = new AmazonFraudDetector.UpdateModelRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateModelRequest);
    });
