...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteExternalModelRequest();
  });
  ...
  describe('DeleteExternalModelRequest', function() {
    it('should create an instance of DeleteExternalModelRequest', function() {
      // uncomment below and update the code to test DeleteExternalModelRequest
      //var instance = new AmazonFraudDetector.DeleteExternalModelRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteExternalModelRequest);
    });
