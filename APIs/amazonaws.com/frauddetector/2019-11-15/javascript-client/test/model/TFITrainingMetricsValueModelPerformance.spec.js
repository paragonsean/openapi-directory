...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TFITrainingMetricsValueModelPerformance();
  });
  ...
  describe('TFITrainingMetricsValueModelPerformance', function() {
    it('should create an instance of TFITrainingMetricsValueModelPerformance', function() {
      // uncomment below and update the code to test TFITrainingMetricsValueModelPerformance
      //var instance = new AmazonFraudDetector.TFITrainingMetricsValueModelPerformance();
      //expect(instance).to.be.a(AmazonFraudDetector.TFITrainingMetricsValueModelPerformance);
    });
