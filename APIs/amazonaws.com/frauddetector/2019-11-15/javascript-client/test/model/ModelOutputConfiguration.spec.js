...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ModelOutputConfiguration();
  });
  ...
  describe('ModelOutputConfiguration', function() {
    it('should create an instance of ModelOutputConfiguration', function() {
      // uncomment below and update the code to test ModelOutputConfiguration
      //var instance = new AmazonFraudDetector.ModelOutputConfiguration();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelOutputConfiguration);
    });
