...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.VariableEntry();
  });
  ...
  describe('VariableEntry', function() {
    it('should create an instance of VariableEntry', function() {
      // uncomment below and update the code to test VariableEntry
      //var instance = new AmazonFraudDetector.VariableEntry();
      //expect(instance).to.be.a(AmazonFraudDetector.VariableEntry);
    });
