...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetEventTypesRequest();
  });
  ...
  describe('GetEventTypesRequest', function() {
    it('should create an instance of GetEventTypesRequest', function() {
      // uncomment below and update the code to test GetEventTypesRequest
      //var instance = new AmazonFraudDetector.GetEventTypesRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetEventTypesRequest);
    });
