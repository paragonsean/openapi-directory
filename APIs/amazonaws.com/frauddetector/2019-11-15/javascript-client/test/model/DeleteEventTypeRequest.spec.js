...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteEventTypeRequest();
  });
  ...
  describe('DeleteEventTypeRequest', function() {
    it('should create an instance of DeleteEventTypeRequest', function() {
      // uncomment below and update the code to test DeleteEventTypeRequest
      //var instance = new AmazonFraudDetector.DeleteEventTypeRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteEventTypeRequest);
    });
