...
(function(root, factory) {
  ...
  describe('ModelOutputDataFormat', function() {
    it('should create an instance of ModelOutputDataFormat', function() {
      // uncomment below and update the code to test ModelOutputDataFormat
      //var instance = new AmazonFraudDetector.ModelOutputDataFormat();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelOutputDataFormat);
    });
