...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetKMSEncryptionKeyResult();
  });
  ...
  describe('GetKMSEncryptionKeyResult', function() {
    it('should create an instance of GetKMSEncryptionKeyResult', function() {
      // uncomment below and update the code to test GetKMSEncryptionKeyResult
      //var instance = new AmazonFraudDetector.GetKMSEncryptionKeyResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetKMSEncryptionKeyResult);
    });
