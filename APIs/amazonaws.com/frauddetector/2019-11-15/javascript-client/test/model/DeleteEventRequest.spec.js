...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteEventRequest();
  });
  ...
  describe('DeleteEventRequest', function() {
    it('should create an instance of DeleteEventRequest', function() {
      // uncomment below and update the code to test DeleteEventRequest
      //var instance = new AmazonFraudDetector.DeleteEventRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteEventRequest);
    });
    ...
    it('should have the property deleteAuditHistory (base name: "deleteAuditHistory")', function() {
      // uncomment below and update the code to test the property deleteAuditHistory
      //var instance = new AmazonFraudDetector.DeleteEventRequest();
      //expect(instance).to.be();
    });
