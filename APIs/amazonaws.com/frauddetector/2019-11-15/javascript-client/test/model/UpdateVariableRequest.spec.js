...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateVariableRequest();
  });
  ...
  describe('UpdateVariableRequest', function() {
    it('should create an instance of UpdateVariableRequest', function() {
      // uncomment below and update the code to test UpdateVariableRequest
      //var instance = new AmazonFraudDetector.UpdateVariableRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateVariableRequest);
    });
