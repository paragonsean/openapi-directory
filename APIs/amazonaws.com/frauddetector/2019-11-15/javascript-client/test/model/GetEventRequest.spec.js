...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetEventRequest();
  });
  ...
  describe('GetEventRequest', function() {
    it('should create an instance of GetEventRequest', function() {
      // uncomment below and update the code to test GetEventRequest
      //var instance = new AmazonFraudDetector.GetEventRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetEventRequest);
    });
