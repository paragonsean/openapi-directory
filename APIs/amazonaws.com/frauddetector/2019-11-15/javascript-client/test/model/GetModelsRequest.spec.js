...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetModelsRequest();
  });
  ...
  describe('GetModelsRequest', function() {
    it('should create an instance of GetModelsRequest', function() {
      ...
      //var instance = new AmazonFraudDetector.GetModelsRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetModelsRequest);
    });
