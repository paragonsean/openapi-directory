...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteRuleRequest();
  });
  ...
  describe('DeleteRuleRequest', function() {
    it('should create an instance of DeleteRuleRequest', function() {
      ...
      //var instance = new AmazonFraudDetector.DeleteRuleRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteRuleRequest);
    });
