...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetEventTypesResult();
  });
  ...
  describe('GetEventTypesResult', function() {
    it('should create an instance of GetEventTypesResult', function() {
      // uncomment below and update the code to test GetEventTypesResult
      //var instance = new AmazonFraudDetector.GetEventTypesResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetEventTypesResult);
    });
