...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateModelVersionRequestExternalEventsDetail();
  });
  ...
  describe('UpdateModelVersionRequestExternalEventsDetail', function() {
    it('should create an instance of UpdateModelVersionRequestExternalEventsDetail', function() {
      // uncomment below and update the code to test UpdateModelVersionRequestExternalEventsDetail
      //var instance = new AmazonFraudDetector.UpdateModelVersionRequestExternalEventsDetail();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateModelVersionRequestExternalEventsDetail);
    });
