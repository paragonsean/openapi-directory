...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.BatchCreateVariableRequest();
  });
  ...
  describe('BatchCreateVariableRequest', function() {
    it('should create an instance of BatchCreateVariableRequest', function() {
      // uncomment below and update the code to test BatchCreateVariableRequest
      //var instance = new AmazonFraudDetector.BatchCreateVariableRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.BatchCreateVariableRequest);
    });

    it('should have the property variableEntries (base name: "variableEntries")', function() {
      // uncomment below and update the code to test the property variableEntries
      //var instance = new AmazonFraudDetector.BatchCreateVariableRequest();
