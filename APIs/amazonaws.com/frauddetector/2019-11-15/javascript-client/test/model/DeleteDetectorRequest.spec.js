...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteDetectorRequest();
  });
  ...
  describe('DeleteDetectorRequest', function() {
    it('should create an instance of DeleteDetectorRequest', function() {
      // uncomment below and update the code to test DeleteDetectorRequest
      //var instance = new AmazonFraudDetector.DeleteDetectorRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteDetectorRequest);
    });
