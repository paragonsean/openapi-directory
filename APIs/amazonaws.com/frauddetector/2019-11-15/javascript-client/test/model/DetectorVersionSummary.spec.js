...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DetectorVersionSummary();
  });
  ...
  describe('DetectorVersionSummary', function() {
    it('should create an instance of DetectorVersionSummary', function() {
      // uncomment below and update the code to test DetectorVersionSummary
      //var instance = new AmazonFraudDetector.DetectorVersionSummary();
      //expect(instance).to.be.a(AmazonFraudDetector.DetectorVersionSummary);
    });
