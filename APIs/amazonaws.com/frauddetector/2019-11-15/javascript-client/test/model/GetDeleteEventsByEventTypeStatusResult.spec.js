...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetDeleteEventsByEventTypeStatusResult();
  });
  ...
  describe('GetDeleteEventsByEventTypeStatusResult', function() {
    it('should create an instance of GetDeleteEventsByEventTypeStatusResult', function() {
      // uncomment below and update the code to test GetDeleteEventsByEventTypeStatusResult
      //var instance = new AmazonFraudDetector.GetDeleteEventsByEventTypeStatusResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetDeleteEventsByEventTypeStatusResult);
    });
