...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateListRequest();
  });
  ...
  describe('UpdateListRequest', function() {
    it('should create an instance of UpdateListRequest', function() {
      // uncomment below and update the code to test UpdateListRequest
      //var instance = new AmazonFraudDetector.UpdateListRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateListRequest);
    });
    ...
    it('should have the property updateMode (base name: "updateMode")', function() {
      // uncomment below and update the code to test the property updateMode
      //var instance = new AmazonFraudDetector.UpdateListRequest();
      //expect(instance).to.be();
    });
