...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetModelVersionResult();
  });
  ...
  describe('GetModelVersionResult', function() {
    it('should create an instance of GetModelVersionResult', function() {
      // uncomment below and update the code to test GetModelVersionResult
      //var instance = new AmazonFraudDetector.GetModelVersionResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetModelVersionResult);
    });
