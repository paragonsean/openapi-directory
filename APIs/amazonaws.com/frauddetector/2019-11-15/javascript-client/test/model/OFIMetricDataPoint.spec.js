...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.OFIMetricDataPoint();
  });
  ...
  describe('OFIMetricDataPoint', function() {
    it('should create an instance of OFIMetricDataPoint', function() {
      // uncomment below and update the code to test OFIMetricDataPoint
      //var instance = new AmazonFraudDetector.OFIMetricDataPoint();
      //expect(instance).to.be.a(AmazonFraudDetector.OFIMetricDataPoint);
    });
