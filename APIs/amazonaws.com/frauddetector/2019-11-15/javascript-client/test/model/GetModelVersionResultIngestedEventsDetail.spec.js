...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetModelVersionResultIngestedEventsDetail();
  });
  ...
  describe('GetModelVersionResultIngestedEventsDetail', function() {
    it('should create an instance of GetModelVersionResultIngestedEventsDetail', function() {
      // uncomment below and update the code to test GetModelVersionResultIngestedEventsDetail
      //var instance = new AmazonFraudDetector.GetModelVersionResultIngestedEventsDetail();
      //expect(instance).to.be.a(AmazonFraudDetector.GetModelVersionResultIngestedEventsDetail);
    });
