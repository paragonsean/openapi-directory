...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateRuleMetadataRequest();
  });
  ...
  describe('UpdateRuleMetadataRequest', function() {
    it('should create an instance of UpdateRuleMetadataRequest', function() {
      // uncomment below and update the code to test UpdateRuleMetadataRequest
      //var instance = new AmazonFraudDetector.UpdateRuleMetadataRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateRuleMetadataRequest);
    });
