...
(function(root, factory) {
  ...
  describe('ModelInputDataFormat', function() {
    it('should create an instance of ModelInputDataFormat', function() {
      // uncomment below and update the code to test ModelInputDataFormat
      //var instance = new AmazonFraudDetector.ModelInputDataFormat();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelInputDataFormat);
    });
