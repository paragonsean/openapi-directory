...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetRulesResult();
  });
  ...
  describe('GetRulesResult', function() {
    it('should create an instance of GetRulesResult', function() {
      // uncomment below and update the code to test GetRulesResult
      //var instance = new AmazonFraudDetector.GetRulesResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetRulesResult);
    });

    it('should have the property ruleDetails (base name: "ruleDetails")', function() {
