...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.AggregatedLogOddsMetric();
  });
  ...
  describe('AggregatedLogOddsMetric', function() {
    it('should create an instance of AggregatedLogOddsMetric', function() {
      // uncomment below and update the code to test AggregatedLogOddsMetric
      //var instance = new AmazonFraudDetector.AggregatedLogOddsMetric();
      //expect(instance).to.be.a(AmazonFraudDetector.AggregatedLogOddsMetric);
    });

    it('should have the property variableNames (base name: "variableNames")', function() {
      // uncomment below and update the code to test the property variableNames
      //var instance = new AmazonFraudDetector.AggregatedLogOddsMetric();
      //expect(instance).to.be();
    });

    it('should have the property aggregatedVariablesImportance (base name: "aggregatedVariablesImportance")', function() {
      // uncomment below and update the code to test the property aggregatedVariablesImportance
      //var instance = new AmazonFraudDetector.AggregatedLogOddsMetric();
      //expect(instance).to.be();
    });
