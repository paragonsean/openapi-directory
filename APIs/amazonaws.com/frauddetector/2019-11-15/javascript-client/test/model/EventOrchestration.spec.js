...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.EventOrchestration();
  });
  ...
  describe('EventOrchestration', function() {
    it('should create an instance of EventOrchestration', function() {
      // uncomment below and update the code to test EventOrchestration
      //var instance = new AmazonFraudDetector.EventOrchestration();
      //expect(instance).to.be.a(AmazonFraudDetector.EventOrchestration);
    });
