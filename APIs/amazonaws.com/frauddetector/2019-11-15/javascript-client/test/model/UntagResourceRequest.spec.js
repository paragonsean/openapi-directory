...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AmazonFraudDetector.UntagResourceRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.UntagResourceRequest);
    });
