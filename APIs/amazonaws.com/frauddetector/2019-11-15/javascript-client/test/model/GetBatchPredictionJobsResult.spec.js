...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetBatchPredictionJobsResult();
  });
  ...
  describe('GetBatchPredictionJobsResult', function() {
    it('should create an instance of GetBatchPredictionJobsResult', function() {
      // uncomment below and update the code to test GetBatchPredictionJobsResult
      //var instance = new AmazonFraudDetector.GetBatchPredictionJobsResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetBatchPredictionJobsResult);
    });

    it('should have the property batchPredictions (base name: "batchPredictions")', function() {
      // uncomment below and update the code to test the property batchPredictions
      //var instance = new AmazonFraudDetector.GetBatchPredictionJobsResult();
