...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetDetectorsRequest();
  });
  ...
  describe('GetDetectorsRequest', function() {
    it('should create an instance of GetDetectorsRequest', function() {
      // uncomment below and update the code to test GetDetectorsRequest
      //var instance = new AmazonFraudDetector.GetDetectorsRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetDetectorsRequest);
    });
