...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetRulesRequest();
  });
  ...
  describe('GetRulesRequest', function() {
    it('should create an instance of GetRulesRequest', function() {
      // uncomment below and update the code to test GetRulesRequest
      //var instance = new AmazonFraudDetector.GetRulesRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetRulesRequest);
    });
