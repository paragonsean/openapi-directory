...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.IngestedEventsDetailIngestedEventsTimeWindow();
  });
  ...
  describe('IngestedEventsDetailIngestedEventsTimeWindow', function() {
    it('should create an instance of IngestedEventsDetailIngestedEventsTimeWindow', function() {
      // uncomment below and update the code to test IngestedEventsDetailIngestedEventsTimeWindow
      //var instance = new AmazonFraudDetector.IngestedEventsDetailIngestedEventsTimeWindow();
      //expect(instance).to.be.a(AmazonFraudDetector.IngestedEventsDetailIngestedEventsTimeWindow);
    });
