...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TrainingResultV2AggregatedVariablesImportanceMetrics();
  });
  ...
  describe('TrainingResultV2AggregatedVariablesImportanceMetrics', function() {
    it('should create an instance of TrainingResultV2AggregatedVariablesImportanceMetrics', function() {
      // uncomment below and update the code to test TrainingResultV2AggregatedVariablesImportanceMetrics
      //var instance = new AmazonFraudDetector.TrainingResultV2AggregatedVariablesImportanceMetrics();
      //expect(instance).to.be.a(AmazonFraudDetector.TrainingResultV2AggregatedVariablesImportanceMetrics);
    });
