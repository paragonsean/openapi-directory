...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteModelVersionRequest();
  });
  ...
  describe('DeleteModelVersionRequest', function() {
    it('should create an instance of DeleteModelVersionRequest', function() {
      // uncomment below and update the code to test DeleteModelVersionRequest
      //var instance = new AmazonFraudDetector.DeleteModelVersionRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteModelVersionRequest);
    });
