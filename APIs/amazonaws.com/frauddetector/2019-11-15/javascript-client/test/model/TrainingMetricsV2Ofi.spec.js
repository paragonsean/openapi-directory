...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TrainingMetricsV2Ofi();
  });
  ...
  describe('TrainingMetricsV2Ofi', function() {
    it('should create an instance of TrainingMetricsV2Ofi', function() {
      // uncomment below and update the code to test TrainingMetricsV2Ofi
      //var instance = new AmazonFraudDetector.TrainingMetricsV2Ofi();
      //expect(instance).to.be.a(AmazonFraudDetector.TrainingMetricsV2Ofi);
    });
