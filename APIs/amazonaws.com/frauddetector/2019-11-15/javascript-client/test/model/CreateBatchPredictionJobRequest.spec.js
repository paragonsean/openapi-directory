...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateBatchPredictionJobRequest();
  });
  ...
  describe('CreateBatchPredictionJobRequest', function() {
    it('should create an instance of CreateBatchPredictionJobRequest', function() {
      // uncomment below and update the code to test CreateBatchPredictionJobRequest
      //var instance = new AmazonFraudDetector.CreateBatchPredictionJobRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateBatchPredictionJobRequest);
    });
    ...
    it('should have the property detectorVersion (base name: "detectorVersion")', function() {
      // uncomment below and update the code to test the property detectorVersion
      //var instance = new AmazonFraudDetector.CreateBatchPredictionJobRequest();
      //expect(instance).to.be();
    });
