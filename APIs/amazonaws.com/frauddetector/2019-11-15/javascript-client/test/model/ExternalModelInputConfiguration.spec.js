...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ExternalModelInputConfiguration();
  });
  ...
  describe('ExternalModelInputConfiguration', function() {
    it('should create an instance of ExternalModelInputConfiguration', function() {
      // uncomment below and update the code to test ExternalModelInputConfiguration
      //var instance = new AmazonFraudDetector.ExternalModelInputConfiguration();
      //expect(instance).to.be.a(AmazonFraudDetector.ExternalModelInputConfiguration);
    });
