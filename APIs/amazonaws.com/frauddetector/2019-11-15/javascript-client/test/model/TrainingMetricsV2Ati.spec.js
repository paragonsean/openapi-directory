...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TrainingMetricsV2Ati();
  });
  ...
  describe('TrainingMetricsV2Ati', function() {
    it('should create an instance of TrainingMetricsV2Ati', function() {
      // uncomment below and update the code to test TrainingMetricsV2Ati
      //var instance = new AmazonFraudDetector.TrainingMetricsV2Ati();
      //expect(instance).to.be.a(AmazonFraudDetector.TrainingMetricsV2Ati);
    });
