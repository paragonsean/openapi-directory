...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteModelRequest();
  });
  ...
  describe('DeleteModelRequest', function() {
    it('should create an instance of DeleteModelRequest', function() {
      // uncomment below and update the code to test DeleteModelRequest
      //var instance = new AmazonFraudDetector.DeleteModelRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteModelRequest);
    });
