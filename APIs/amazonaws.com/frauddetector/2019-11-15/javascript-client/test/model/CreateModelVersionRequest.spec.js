...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateModelVersionRequest();
  });
  ...
  describe('CreateModelVersionRequest', function() {
    it('should create an instance of CreateModelVersionRequest', function() {
      // uncomment below and update the code to test CreateModelVersionRequest
      //var instance = new AmazonFraudDetector.CreateModelVersionRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateModelVersionRequest);
    });
