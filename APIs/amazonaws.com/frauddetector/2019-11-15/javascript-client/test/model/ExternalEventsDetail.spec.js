...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ExternalEventsDetail();
  });
  ...
  describe('ExternalEventsDetail', function() {
    it('should create an instance of ExternalEventsDetail', function() {
      // uncomment below and update the code to test ExternalEventsDetail
      //var instance = new AmazonFraudDetector.ExternalEventsDetail();
      //expect(instance).to.be.a(AmazonFraudDetector.ExternalEventsDetail);
    });
