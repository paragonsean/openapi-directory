...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ATITrainingMetricsValueModelPerformance();
  });
  ...
  describe('ATITrainingMetricsValueModelPerformance', function() {
    it('should create an instance of ATITrainingMetricsValueModelPerformance', function() {
      // uncomment below and update the code to test ATITrainingMetricsValueModelPerformance
      //var instance = new AmazonFraudDetector.ATITrainingMetricsValueModelPerformance();
      //expect(instance).to.be.a(AmazonFraudDetector.ATITrainingMetricsValueModelPerformance);
    });

    it('should have the property asi (base name: "asi")', function() {
      // uncomment below and update the code to test the property asi
      //var instance = new AmazonFraudDetector.ATITrainingMetricsValueModelPerformance();
