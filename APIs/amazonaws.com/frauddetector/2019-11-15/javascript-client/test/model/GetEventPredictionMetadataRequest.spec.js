...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetEventPredictionMetadataRequest();
  });
  ...
  describe('GetEventPredictionMetadataRequest', function() {
    it('should create an instance of GetEventPredictionMetadataRequest', function() {
      // uncomment below and update the code to test GetEventPredictionMetadataRequest
      //var instance = new AmazonFraudDetector.GetEventPredictionMetadataRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetEventPredictionMetadataRequest);
    });
