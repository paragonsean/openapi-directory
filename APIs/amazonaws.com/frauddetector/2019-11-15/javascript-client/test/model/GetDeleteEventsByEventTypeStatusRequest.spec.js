...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetDeleteEventsByEventTypeStatusRequest();
  });
  ...
  describe('GetDeleteEventsByEventTypeStatusRequest', function() {
    it('should create an instance of GetDeleteEventsByEventTypeStatusRequest', function() {
      // uncomment below and update the code to test GetDeleteEventsByEventTypeStatusRequest
      //var instance = new AmazonFraudDetector.GetDeleteEventsByEventTypeStatusRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetDeleteEventsByEventTypeStatusRequest);
    });
