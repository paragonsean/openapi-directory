...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ModelInputConfiguration();
  });
  ...
  describe('ModelInputConfiguration', function() {
    it('should create an instance of ModelInputConfiguration', function() {
      // uncomment below and update the code to test ModelInputConfiguration
      //var instance = new AmazonFraudDetector.ModelInputConfiguration();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelInputConfiguration);
    });
    ...
    it('should have the property jsonInputTemplate (base name: "jsonInputTemplate")', function() {
      // uncomment below and update the code to test the property jsonInputTemplate
      //var instance = new AmazonFraudDetector.ModelInputConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property csvInputTemplate (base name: "csvInputTemplate")', function() {
      // uncomment below and update the code to test the property csvInputTemplate
      //var instance = new AmazonFraudDetector.ModelInputConfiguration();
      //expect(instance).to.be();
    });
