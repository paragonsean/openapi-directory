...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.BatchGetVariableRequest();
  });
  ...
  describe('BatchGetVariableRequest', function() {
    it('should create an instance of BatchGetVariableRequest', function() {
      // uncomment below and update the code to test BatchGetVariableRequest
      //var instance = new AmazonFraudDetector.BatchGetVariableRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.BatchGetVariableRequest);
    });
