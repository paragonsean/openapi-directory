...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TFIMetricDataPoint();
  });
  ...
  describe('TFIMetricDataPoint', function() {
    it('should create an instance of TFIMetricDataPoint', function() {
      // uncomment below and update the code to test TFIMetricDataPoint
      //var instance = new AmazonFraudDetector.TFIMetricDataPoint();
      //expect(instance).to.be.a(AmazonFraudDetector.TFIMetricDataPoint);
    });
