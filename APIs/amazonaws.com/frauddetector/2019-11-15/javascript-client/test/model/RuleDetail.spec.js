...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.RuleDetail();
  });
  ...
  describe('RuleDetail', function() {
    it('should create an instance of RuleDetail', function() {
      // uncomment below and update the code to test RuleDetail
      //var instance = new AmazonFraudDetector.RuleDetail();
      //expect(instance).to.be.a(AmazonFraudDetector.RuleDetail);
    });
