...
(function(root, factory) {
  ...
  describe('ModelVersionStatus', function() {
    it('should create an instance of ModelVersionStatus', function() {
      // uncomment below and update the code to test ModelVersionStatus
      //var instance = new AmazonFraudDetector.ModelVersionStatus();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelVersionStatus);
    });
