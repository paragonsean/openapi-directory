...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateEventLabelRequest();
  });
  ...
  describe('UpdateEventLabelRequest', function() {
    it('should create an instance of UpdateEventLabelRequest', function() {
      // uncomment below and update the code to test UpdateEventLabelRequest
      //var instance = new AmazonFraudDetector.UpdateEventLabelRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateEventLabelRequest);
    });
    ...
    it('should have the property assignedLabel (base name: "assignedLabel")', function() {
      // uncomment below and update the code to test the property assignedLabel
      //var instance = new AmazonFraudDetector.UpdateEventLabelRequest();
      //expect(instance).to.be();
    });
