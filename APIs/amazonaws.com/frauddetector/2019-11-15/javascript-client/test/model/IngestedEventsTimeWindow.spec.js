...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.IngestedEventsTimeWindow();
  });
  ...
  describe('IngestedEventsTimeWindow', function() {
    it('should create an instance of IngestedEventsTimeWindow', function() {
      // uncomment below and update the code to test IngestedEventsTimeWindow
      //var instance = new AmazonFraudDetector.IngestedEventsTimeWindow();
      //expect(instance).to.be.a(AmazonFraudDetector.IngestedEventsTimeWindow);
    });
