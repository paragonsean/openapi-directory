...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateModelVersionStatusRequest();
  });
  ...
  describe('UpdateModelVersionStatusRequest', function() {
    it('should create an instance of UpdateModelVersionStatusRequest', function() {
      // uncomment below and update the code to test UpdateModelVersionStatusRequest
      //var instance = new AmazonFraudDetector.UpdateModelVersionStatusRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateModelVersionStatusRequest);
    });
