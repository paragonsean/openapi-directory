...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TFITrainingMetricsValue();
  });
  ...
  describe('TFITrainingMetricsValue', function() {
    it('should create an instance of TFITrainingMetricsValue', function() {
      // uncomment below and update the code to test TFITrainingMetricsValue
      //var instance = new AmazonFraudDetector.TFITrainingMetricsValue();
      //expect(instance).to.be.a(AmazonFraudDetector.TFITrainingMetricsValue);
    });
