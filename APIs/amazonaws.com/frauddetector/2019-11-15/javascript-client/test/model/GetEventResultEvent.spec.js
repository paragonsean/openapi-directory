...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetEventResultEvent();
  });
  ...
  describe('GetEventResultEvent', function() {
    it('should create an instance of GetEventResultEvent', function() {
      // uncomment below and update the code to test GetEventResultEvent
      //var instance = new AmazonFraudDetector.GetEventResultEvent();
      //expect(instance).to.be.a(AmazonFraudDetector.GetEventResultEvent);
    });
    ...
    it('should have the property currentLabel (base name: "currentLabel")', function() {
      // uncomment below and update the code to test the property currentLabel
      //var instance = new AmazonFraudDetector.GetEventResultEvent();
      //expect(instance).to.be();
    });

    it('should have the property labelTimestamp (base name: "labelTimestamp")', function() {
      // uncomment below and update the code to test the property labelTimestamp
      //var instance = new AmazonFraudDetector.GetEventResultEvent();
      //expect(instance).to.be();
    });
