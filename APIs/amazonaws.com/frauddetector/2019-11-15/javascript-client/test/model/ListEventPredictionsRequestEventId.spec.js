...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ListEventPredictionsRequestEventId();
  });
  ...
  describe('ListEventPredictionsRequestEventId', function() {
    it('should create an instance of ListEventPredictionsRequestEventId', function() {
      // uncomment below and update the code to test ListEventPredictionsRequestEventId
      //var instance = new AmazonFraudDetector.ListEventPredictionsRequestEventId();
      //expect(instance).to.be.a(AmazonFraudDetector.ListEventPredictionsRequestEventId);
    });
