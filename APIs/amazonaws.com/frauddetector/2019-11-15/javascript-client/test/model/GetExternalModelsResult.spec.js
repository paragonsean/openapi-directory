...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetExternalModelsResult();
  });
  ...
  describe('GetExternalModelsResult', function() {
    it('should create an instance of GetExternalModelsResult', function() {
      // uncomment below and update the code to test GetExternalModelsResult
      //var instance = new AmazonFraudDetector.GetExternalModelsResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetExternalModelsResult);
    });

    it('should have the property externalModels (base name: "externalModels")', function() {
      // uncomment below and update the code to test the property externalModels
      //var instance = new AmazonFraudDetector.GetExternalModelsResult();
