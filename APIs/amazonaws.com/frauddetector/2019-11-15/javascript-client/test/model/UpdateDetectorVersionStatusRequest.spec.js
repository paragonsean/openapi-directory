...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateDetectorVersionStatusRequest();
  });
  ...
  describe('UpdateDetectorVersionStatusRequest', function() {
    it('should create an instance of UpdateDetectorVersionStatusRequest', function() {
      // uncomment below and update the code to test UpdateDetectorVersionStatusRequest
      //var instance = new AmazonFraudDetector.UpdateDetectorVersionStatusRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateDetectorVersionStatusRequest);
    });
