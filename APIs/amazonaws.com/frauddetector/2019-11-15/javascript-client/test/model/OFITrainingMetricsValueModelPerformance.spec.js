...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.OFITrainingMetricsValueModelPerformance();
  });
  ...
  describe('OFITrainingMetricsValueModelPerformance', function() {
    it('should create an instance of OFITrainingMetricsValueModelPerformance', function() {
      // uncomment below and update the code to test OFITrainingMetricsValueModelPerformance
      //var instance = new AmazonFraudDetector.OFITrainingMetricsValueModelPerformance();
      //expect(instance).to.be.a(AmazonFraudDetector.OFITrainingMetricsValueModelPerformance);
    });
