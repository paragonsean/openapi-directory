...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetBatchImportJobsResult();
  });
  ...
  describe('GetBatchImportJobsResult', function() {
    it('should create an instance of GetBatchImportJobsResult', function() {
      // uncomment below and update the code to test GetBatchImportJobsResult
      //var instance = new AmazonFraudDetector.GetBatchImportJobsResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetBatchImportJobsResult);
    });

    it('should have the property batchImports (base name: "batchImports")', function() {
      // uncomment below and update the code to test the property batchImports
      //var instance = new AmazonFraudDetector.GetBatchImportJobsResult();
