...
(function(root, factory) {
  ...
  describe('ModelSource', function() {
    it('should create an instance of ModelSource', function() {
      // uncomment below and update the code to test ModelSource
      //var instance = new AmazonFraudDetector.ModelSource();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelSource);
    });
