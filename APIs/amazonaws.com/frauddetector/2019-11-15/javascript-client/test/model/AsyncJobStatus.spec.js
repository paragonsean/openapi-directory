...
(function(root, factory) {
  ...
  describe('AsyncJobStatus', function() {
    it('should create an instance of AsyncJobStatus', function() {
      // uncomment below and update the code to test AsyncJobStatus
      //var instance = new AmazonFraudDetector.AsyncJobStatus();
      //expect(instance).to.be.a(AmazonFraudDetector.AsyncJobStatus);
    });
