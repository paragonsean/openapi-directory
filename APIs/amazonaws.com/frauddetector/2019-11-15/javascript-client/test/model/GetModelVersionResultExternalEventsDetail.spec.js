...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetModelVersionResultExternalEventsDetail();
  });
  ...
  describe('GetModelVersionResultExternalEventsDetail', function() {
    it('should create an instance of GetModelVersionResultExternalEventsDetail', function() {
      // uncomment below and update the code to test GetModelVersionResultExternalEventsDetail
      //var instance = new AmazonFraudDetector.GetModelVersionResultExternalEventsDetail();
      //expect(instance).to.be.a(AmazonFraudDetector.GetModelVersionResultExternalEventsDetail);
    });
