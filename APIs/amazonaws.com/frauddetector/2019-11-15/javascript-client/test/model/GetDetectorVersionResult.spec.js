...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetDetectorVersionResult();
  });
  ...
  describe('GetDetectorVersionResult', function() {
    it('should create an instance of GetDetectorVersionResult', function() {
      // uncomment below and update the code to test GetDetectorVersionResult
      //var instance = new AmazonFraudDetector.GetDetectorVersionResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetDetectorVersionResult);
    });
