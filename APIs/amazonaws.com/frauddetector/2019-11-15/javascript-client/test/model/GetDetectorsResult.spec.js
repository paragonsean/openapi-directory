...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetDetectorsResult();
  });
  ...
  describe('GetDetectorsResult', function() {
    it('should create an instance of GetDetectorsResult', function() {
      // uncomment below and update the code to test GetDetectorsResult
      //var instance = new AmazonFraudDetector.GetDetectorsResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetDetectorsResult);
    });
