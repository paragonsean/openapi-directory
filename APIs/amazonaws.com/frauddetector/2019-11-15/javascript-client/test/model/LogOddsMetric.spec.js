...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.LogOddsMetric();
  });
  ...
  describe('LogOddsMetric', function() {
    it('should create an instance of LogOddsMetric', function() {
      // uncomment below and update the code to test LogOddsMetric
      //var instance = new AmazonFraudDetector.LogOddsMetric();
      //expect(instance).to.be.a(AmazonFraudDetector.LogOddsMetric);
    });
    ...
    it('should have the property variableImportance (base name: "variableImportance")', function() {
      // uncomment below and update the code to test the property variableImportance
      //var instance = new AmazonFraudDetector.LogOddsMetric();
      //expect(instance).to.be();
    });
