...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateModelVersionRequestIngestedEventsDetail();
  });
  ...
  describe('CreateModelVersionRequestIngestedEventsDetail', function() {
    it('should create an instance of CreateModelVersionRequestIngestedEventsDetail', function() {
      // uncomment below and update the code to test CreateModelVersionRequestIngestedEventsDetail
      //var instance = new AmazonFraudDetector.CreateModelVersionRequestIngestedEventsDetail();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateModelVersionRequestIngestedEventsDetail);
    });
