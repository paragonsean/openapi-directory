...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateModelVersionRequestTrainingDataSchema();
  });
  ...
  describe('CreateModelVersionRequestTrainingDataSchema', function() {
    it('should create an instance of CreateModelVersionRequestTrainingDataSchema', function() {
      // uncomment below and update the code to test CreateModelVersionRequestTrainingDataSchema
      //var instance = new AmazonFraudDetector.CreateModelVersionRequestTrainingDataSchema();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateModelVersionRequestTrainingDataSchema);
    });
