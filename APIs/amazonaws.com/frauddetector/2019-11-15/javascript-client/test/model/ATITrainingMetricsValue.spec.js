...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ATITrainingMetricsValue();
  });
  ...
  describe('ATITrainingMetricsValue', function() {
    it('should create an instance of ATITrainingMetricsValue', function() {
      // uncomment below and update the code to test ATITrainingMetricsValue
      //var instance = new AmazonFraudDetector.ATITrainingMetricsValue();
      //expect(instance).to.be.a(AmazonFraudDetector.ATITrainingMetricsValue);
    });
    ...
    it('should have the property modelPerformance (base name: "modelPerformance")', function() {
      // uncomment below and update the code to test the property modelPerformance
      //var instance = new AmazonFraudDetector.ATITrainingMetricsValue();
      //expect(instance).to.be();
    });
