...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.Outcome();
  });
  ...
  describe('Outcome', function() {
    it('should create an instance of Outcome', function() {
      // uncomment below and update the code to test Outcome
      //var instance = new AmazonFraudDetector.Outcome();
      //expect(instance).to.be.a(AmazonFraudDetector.Outcome);
    });
