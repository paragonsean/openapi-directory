...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ListEventPredictionsRequestEventType();
  });
  ...
  describe('ListEventPredictionsRequestEventType', function() {
    it('should create an instance of ListEventPredictionsRequestEventType', function() {
      // uncomment below and update the code to test ListEventPredictionsRequestEventType
      //var instance = new AmazonFraudDetector.ListEventPredictionsRequestEventType();
      //expect(instance).to.be.a(AmazonFraudDetector.ListEventPredictionsRequestEventType);
    });
