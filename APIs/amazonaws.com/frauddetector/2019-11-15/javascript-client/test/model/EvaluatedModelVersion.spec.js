...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.EvaluatedModelVersion();
  });
  ...
  describe('EvaluatedModelVersion', function() {
    it('should create an instance of EvaluatedModelVersion', function() {
      // uncomment below and update the code to test EvaluatedModelVersion
      //var instance = new AmazonFraudDetector.EvaluatedModelVersion();
      //expect(instance).to.be.a(AmazonFraudDetector.EvaluatedModelVersion);
    });
