...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateRuleVersionResultRule();
  });
  ...
  describe('UpdateRuleVersionResultRule', function() {
    it('should create an instance of UpdateRuleVersionResultRule', function() {
      // uncomment below and update the code to test UpdateRuleVersionResultRule
      //var instance = new AmazonFraudDetector.UpdateRuleVersionResultRule();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateRuleVersionResultRule);
    });
