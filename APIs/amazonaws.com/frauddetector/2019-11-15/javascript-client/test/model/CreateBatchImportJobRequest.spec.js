...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateBatchImportJobRequest();
  });
  ...
  describe('CreateBatchImportJobRequest', function() {
    it('should create an instance of CreateBatchImportJobRequest', function() {
      // uncomment below and update the code to test CreateBatchImportJobRequest
      //var instance = new AmazonFraudDetector.CreateBatchImportJobRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateBatchImportJobRequest);
    });
