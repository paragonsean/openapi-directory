...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateRuleVersionResult();
  });
  ...
  describe('UpdateRuleVersionResult', function() {
    it('should create an instance of UpdateRuleVersionResult', function() {
      // uncomment below and update the code to test UpdateRuleVersionResult
      //var instance = new AmazonFraudDetector.UpdateRuleVersionResult();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateRuleVersionResult);
    });
