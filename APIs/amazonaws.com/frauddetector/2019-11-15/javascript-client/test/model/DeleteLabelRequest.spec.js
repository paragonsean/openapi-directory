...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteLabelRequest();
  });
  ...
  describe('DeleteLabelRequest', function() {
    it('should create an instance of DeleteLabelRequest', function() {
      ...
      //var instance = new AmazonFraudDetector.DeleteLabelRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteLabelRequest);
    });
