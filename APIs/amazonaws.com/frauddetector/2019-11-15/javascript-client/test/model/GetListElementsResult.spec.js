...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetListElementsResult();
  });
  ...
  describe('GetListElementsResult', function() {
    it('should create an instance of GetListElementsResult', function() {
      // uncomment below and update the code to test GetListElementsResult
      //var instance = new AmazonFraudDetector.GetListElementsResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetListElementsResult);
    });
