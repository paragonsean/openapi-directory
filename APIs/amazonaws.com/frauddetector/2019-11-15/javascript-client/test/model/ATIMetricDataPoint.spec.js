...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ATIMetricDataPoint();
  });
  ...
  describe('ATIMetricDataPoint', function() {
    it('should create an instance of ATIMetricDataPoint', function() {
      // uncomment below and update the code to test ATIMetricDataPoint
      //var instance = new AmazonFraudDetector.ATIMetricDataPoint();
      //expect(instance).to.be.a(AmazonFraudDetector.ATIMetricDataPoint);
    });
    ...
    it('should have the property atodr (base name: "atodr")', function() {
      // uncomment below and update the code to test the property atodr
      //var instance = new AmazonFraudDetector.ATIMetricDataPoint();
      //expect(instance).to.be();
    });
