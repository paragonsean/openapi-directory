...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ModelVersion();
  });
  ...
  describe('ModelVersion', function() {
    it('should create an instance of ModelVersion', function() {
      ...
      //var instance = new AmazonFraudDetector.ModelVersion();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelVersion);
    });
