...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TrainingResultVariableImportanceMetrics();
  });
  ...
  describe('TrainingResultVariableImportanceMetrics', function() {
    it('should create an instance of TrainingResultVariableImportanceMetrics', function() {
      // uncomment below and update the code to test TrainingResultVariableImportanceMetrics
      //var instance = new AmazonFraudDetector.TrainingResultVariableImportanceMetrics();
      //expect(instance).to.be.a(AmazonFraudDetector.TrainingResultVariableImportanceMetrics);
    });
