...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetOutcomesResult();
  });
  ...
  describe('GetOutcomesResult', function() {
    it('should create an instance of GetOutcomesResult', function() {
      // uncomment below and update the code to test GetOutcomesResult
      //var instance = new AmazonFraudDetector.GetOutcomesResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetOutcomesResult);
    });
