...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateModelVersionResult();
  });
  ...
  describe('UpdateModelVersionResult', function() {
    it('should create an instance of UpdateModelVersionResult', function() {
      // uncomment below and update the code to test UpdateModelVersionResult
      //var instance = new AmazonFraudDetector.UpdateModelVersionResult();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateModelVersionResult);
    });
