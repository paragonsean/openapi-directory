...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.EventVariableSummary();
  });
  ...
  describe('EventVariableSummary', function() {
    it('should create an instance of EventVariableSummary', function() {
      // uncomment below and update the code to test EventVariableSummary
      //var instance = new AmazonFraudDetector.EventVariableSummary();
      //expect(instance).to.be.a(AmazonFraudDetector.EventVariableSummary);
    });
