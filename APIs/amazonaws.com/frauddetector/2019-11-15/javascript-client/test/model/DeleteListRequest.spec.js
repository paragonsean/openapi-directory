...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteListRequest();
  });
  ...
  describe('DeleteListRequest', function() {
    it('should create an instance of DeleteListRequest', function() {
      // uncomment below and update the code to test DeleteListRequest
      //var instance = new AmazonFraudDetector.DeleteListRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteListRequest);
    });
