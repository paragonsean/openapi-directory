...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ListEventPredictionsRequestPredictionTimeRange();
  });
  ...
  describe('ListEventPredictionsRequestPredictionTimeRange', function() {
    it('should create an instance of ListEventPredictionsRequestPredictionTimeRange', function() {
      // uncomment below and update the code to test ListEventPredictionsRequestPredictionTimeRange
      //var instance = new AmazonFraudDetector.ListEventPredictionsRequestPredictionTimeRange();
      //expect(instance).to.be.a(AmazonFraudDetector.ListEventPredictionsRequestPredictionTimeRange);
    });
