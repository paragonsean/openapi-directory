...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.PutOutcomeRequest();
  });
  ...
  describe('PutOutcomeRequest', function() {
    it('should create an instance of PutOutcomeRequest', function() {
      // uncomment below and update the code to test PutOutcomeRequest
      //var instance = new AmazonFraudDetector.PutOutcomeRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.PutOutcomeRequest);
    });
