...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ModelEndpointDataBlob();
  });
  ...
  describe('ModelEndpointDataBlob', function() {
    it('should create an instance of ModelEndpointDataBlob', function() {
      // uncomment below and update the code to test ModelEndpointDataBlob
      //var instance = new AmazonFraudDetector.ModelEndpointDataBlob();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelEndpointDataBlob);
    });

    it('should have the property byteBuffer (base name: "byteBuffer")', function() {
      // uncomment below and update the code to test the property byteBuffer
      //var instance = new AmazonFraudDetector.ModelEndpointDataBlob();
