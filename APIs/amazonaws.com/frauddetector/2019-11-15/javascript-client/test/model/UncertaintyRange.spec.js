...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UncertaintyRange();
  });
  ...
  describe('UncertaintyRange', function() {
    it('should create an instance of UncertaintyRange', function() {
      // uncomment below and update the code to test UncertaintyRange
      //var instance = new AmazonFraudDetector.UncertaintyRange();
      //expect(instance).to.be.a(AmazonFraudDetector.UncertaintyRange);
    });
