...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.PutEntityTypeRequest();
  });
  ...
  describe('PutEntityTypeRequest', function() {
    it('should create an instance of PutEntityTypeRequest', function() {
      // uncomment below and update the code to test PutEntityTypeRequest
      //var instance = new AmazonFraudDetector.PutEntityTypeRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.PutEntityTypeRequest);
    });
