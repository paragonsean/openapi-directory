...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.PutEventTypeRequestEventOrchestration();
  });
  ...
  describe('PutEventTypeRequestEventOrchestration', function() {
    it('should create an instance of PutEventTypeRequestEventOrchestration', function() {
      // uncomment below and update the code to test PutEventTypeRequestEventOrchestration
      //var instance = new AmazonFraudDetector.PutEventTypeRequestEventOrchestration();
      //expect(instance).to.be.a(AmazonFraudDetector.PutEventTypeRequestEventOrchestration);
    });
