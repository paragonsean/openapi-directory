...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.PutEventTypeRequest();
  });
  ...
  describe('PutEventTypeRequest', function() {
    it('should create an instance of PutEventTypeRequest', function() {
      // uncomment below and update the code to test PutEventTypeRequest
      //var instance = new AmazonFraudDetector.PutEventTypeRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.PutEventTypeRequest);
    });
    ...
    it('should have the property eventIngestion (base name: "eventIngestion")', function() {
      // uncomment below and update the code to test the property eventIngestion
      //var instance = new AmazonFraudDetector.PutEventTypeRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property eventOrchestration (base name: "eventOrchestration")', function() {
      // uncomment below and update the code to test the property eventOrchestration
      //var instance = new AmazonFraudDetector.PutEventTypeRequest();
      //expect(instance).to.be();
    });
