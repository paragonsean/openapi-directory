...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateDetectorVersionMetadataRequest();
  });
  ...
  describe('UpdateDetectorVersionMetadataRequest', function() {
    it('should create an instance of UpdateDetectorVersionMetadataRequest', function() {
      // uncomment below and update the code to test UpdateDetectorVersionMetadataRequest
      //var instance = new AmazonFraudDetector.UpdateDetectorVersionMetadataRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateDetectorVersionMetadataRequest);
    });
