...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteBatchImportJobRequest();
  });
  ...
  describe('DeleteBatchImportJobRequest', function() {
    it('should create an instance of DeleteBatchImportJobRequest', function() {
      // uncomment below and update the code to test DeleteBatchImportJobRequest
      //var instance = new AmazonFraudDetector.DeleteBatchImportJobRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteBatchImportJobRequest);
    });
