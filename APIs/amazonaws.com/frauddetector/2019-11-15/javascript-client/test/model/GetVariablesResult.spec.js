...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetVariablesResult();
  });
  ...
  describe('GetVariablesResult', function() {
    it('should create an instance of GetVariablesResult', function() {
      // uncomment below and update the code to test GetVariablesResult
      //var instance = new AmazonFraudDetector.GetVariablesResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetVariablesResult);
    });
