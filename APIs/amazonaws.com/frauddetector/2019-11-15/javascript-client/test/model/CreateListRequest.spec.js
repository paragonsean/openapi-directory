...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateListRequest();
  });
  ...
  describe('CreateListRequest', function() {
    it('should create an instance of CreateListRequest', function() {
      ...
      //var instance = new AmazonFraudDetector.CreateListRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateListRequest);
    });
