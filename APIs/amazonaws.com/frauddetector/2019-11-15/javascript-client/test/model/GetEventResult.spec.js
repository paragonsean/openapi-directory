...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetEventResult();
  });
  ...
  describe('GetEventResult', function() {
    it('should create an instance of GetEventResult', function() {
      // uncomment below and update the code to test GetEventResult
      //var instance = new AmazonFraudDetector.GetEventResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetEventResult);
    });
