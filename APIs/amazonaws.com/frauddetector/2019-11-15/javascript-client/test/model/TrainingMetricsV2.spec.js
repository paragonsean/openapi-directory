...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TrainingMetricsV2();
  });
  ...
  describe('TrainingMetricsV2', function() {
    it('should create an instance of TrainingMetricsV2', function() {
      // uncomment below and update the code to test TrainingMetricsV2
      //var instance = new AmazonFraudDetector.TrainingMetricsV2();
      //expect(instance).to.be.a(AmazonFraudDetector.TrainingMetricsV2);
    });

    it('should have the property ofi (base name: "ofi")', function() {
      // uncomment below and update the code to test the property ofi
      //var instance = new AmazonFraudDetector.TrainingMetricsV2();
      //expect(instance).to.be();
    });

    it('should have the property tfi (base name: "tfi")', function() {
      // uncomment below and update the code to test the property tfi
      //var instance = new AmazonFraudDetector.TrainingMetricsV2();
      //expect(instance).to.be();
    });

    it('should have the property ati (base name: "ati")', function() {
      // uncomment below and update the code to test the property ati
      //var instance = new AmazonFraudDetector.TrainingMetricsV2();
      //expect(instance).to.be();
    });
