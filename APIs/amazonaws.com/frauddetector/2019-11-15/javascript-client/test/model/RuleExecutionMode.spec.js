...
(function(root, factory) {
  ...
  describe('RuleExecutionMode', function() {
    it('should create an instance of RuleExecutionMode', function() {
      // uncomment below and update the code to test RuleExecutionMode
      //var instance = new AmazonFraudDetector.RuleExecutionMode();
      //expect(instance).to.be.a(AmazonFraudDetector.RuleExecutionMode);
    });
