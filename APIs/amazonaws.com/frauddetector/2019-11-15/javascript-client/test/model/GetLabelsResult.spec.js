...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetLabelsResult();
  });
  ...
  describe('GetLabelsResult', function() {
    it('should create an instance of GetLabelsResult', function() {
      // uncomment below and update the code to test GetLabelsResult
      //var instance = new AmazonFraudDetector.GetLabelsResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetLabelsResult);
    });
