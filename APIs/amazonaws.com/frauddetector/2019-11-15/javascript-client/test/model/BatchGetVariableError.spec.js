...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.BatchGetVariableError();
  });
  ...
  describe('BatchGetVariableError', function() {
    it('should create an instance of BatchGetVariableError', function() {
      // uncomment below and update the code to test BatchGetVariableError
      //var instance = new AmazonFraudDetector.BatchGetVariableError();
      //expect(instance).to.be.a(AmazonFraudDetector.BatchGetVariableError);
    });
