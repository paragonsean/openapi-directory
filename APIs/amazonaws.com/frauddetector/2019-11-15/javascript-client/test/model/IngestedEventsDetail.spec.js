...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.IngestedEventsDetail();
  });
  ...
  describe('IngestedEventsDetail', function() {
    it('should create an instance of IngestedEventsDetail', function() {
      // uncomment below and update the code to test IngestedEventsDetail
      //var instance = new AmazonFraudDetector.IngestedEventsDetail();
      //expect(instance).to.be.a(AmazonFraudDetector.IngestedEventsDetail);
    });
