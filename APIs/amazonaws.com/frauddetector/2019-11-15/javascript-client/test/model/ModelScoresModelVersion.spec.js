...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ModelScoresModelVersion();
  });
  ...
  describe('ModelScoresModelVersion', function() {
    it('should create an instance of ModelScoresModelVersion', function() {
      // uncomment below and update the code to test ModelScoresModelVersion
      //var instance = new AmazonFraudDetector.ModelScoresModelVersion();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelScoresModelVersion);
    });
