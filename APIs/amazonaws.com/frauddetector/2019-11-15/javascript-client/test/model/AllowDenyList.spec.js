...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.AllowDenyList();
  });
  ...
  describe('AllowDenyList', function() {
    it('should create an instance of AllowDenyList', function() {
      // uncomment below and update the code to test AllowDenyList
      //var instance = new AmazonFraudDetector.AllowDenyList();
      //expect(instance).to.be.a(AmazonFraudDetector.AllowDenyList);
    });
