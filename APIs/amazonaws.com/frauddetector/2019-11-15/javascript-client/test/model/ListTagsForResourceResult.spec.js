...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ListTagsForResourceResult();
  });
  ...
  describe('ListTagsForResourceResult', function() {
    it('should create an instance of ListTagsForResourceResult', function() {
      ...
      //var instance = new AmazonFraudDetector.ListTagsForResourceResult();
      //expect(instance).to.be.a(AmazonFraudDetector.ListTagsForResourceResult);
    });
