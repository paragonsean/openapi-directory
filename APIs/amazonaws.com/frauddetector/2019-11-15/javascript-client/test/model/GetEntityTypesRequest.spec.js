...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetEntityTypesRequest();
  });
  ...
  describe('GetEntityTypesRequest', function() {
    it('should create an instance of GetEntityTypesRequest', function() {
      // uncomment below and update the code to test GetEntityTypesRequest
      //var instance = new AmazonFraudDetector.GetEntityTypesRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetEntityTypesRequest);
    });
