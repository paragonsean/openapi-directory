...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateVariableRequest();
  });
  ...
  describe('CreateVariableRequest', function() {
    it('should create an instance of CreateVariableRequest', function() {
      // uncomment below and update the code to test CreateVariableRequest
      //var instance = new AmazonFraudDetector.CreateVariableRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateVariableRequest);
    });
