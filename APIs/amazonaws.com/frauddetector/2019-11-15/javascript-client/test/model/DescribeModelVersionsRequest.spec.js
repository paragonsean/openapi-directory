...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DescribeModelVersionsRequest();
  });
  ...
  describe('DescribeModelVersionsRequest', function() {
    it('should create an instance of DescribeModelVersionsRequest', function() {
      // uncomment below and update the code to test DescribeModelVersionsRequest
      //var instance = new AmazonFraudDetector.DescribeModelVersionsRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DescribeModelVersionsRequest);
    });
