...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TFIModelPerformance();
  });
  ...
  describe('TFIModelPerformance', function() {
    it('should create an instance of TFIModelPerformance', function() {
      // uncomment below and update the code to test TFIModelPerformance
      //var instance = new AmazonFraudDetector.TFIModelPerformance();
      //expect(instance).to.be.a(AmazonFraudDetector.TFIModelPerformance);
    });
