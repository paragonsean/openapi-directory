...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.BatchCreateVariableResult();
  });
  ...
  describe('BatchCreateVariableResult', function() {
    it('should create an instance of BatchCreateVariableResult', function() {
      // uncomment below and update the code to test BatchCreateVariableResult
      //var instance = new AmazonFraudDetector.BatchCreateVariableResult();
      //expect(instance).to.be.a(AmazonFraudDetector.BatchCreateVariableResult);
    });
