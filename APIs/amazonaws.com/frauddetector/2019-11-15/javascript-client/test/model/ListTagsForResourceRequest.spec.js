...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AmazonFraudDetector.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.ListTagsForResourceRequest);
    });
