...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteEventsByEventTypeRequest();
  });
  ...
  describe('DeleteEventsByEventTypeRequest', function() {
    it('should create an instance of DeleteEventsByEventTypeRequest', function() {
      // uncomment below and update the code to test DeleteEventsByEventTypeRequest
      //var instance = new AmazonFraudDetector.DeleteEventsByEventTypeRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteEventsByEventTypeRequest);
    });
