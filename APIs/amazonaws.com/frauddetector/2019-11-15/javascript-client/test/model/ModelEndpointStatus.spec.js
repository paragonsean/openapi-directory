...
(function(root, factory) {
  ...
  describe('ModelEndpointStatus', function() {
    it('should create an instance of ModelEndpointStatus', function() {
      // uncomment below and update the code to test ModelEndpointStatus
      //var instance = new AmazonFraudDetector.ModelEndpointStatus();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelEndpointStatus);
    });
