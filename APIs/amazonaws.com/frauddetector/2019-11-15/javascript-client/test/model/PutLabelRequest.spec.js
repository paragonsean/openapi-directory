...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.PutLabelRequest();
  });
  ...
  describe('PutLabelRequest', function() {
    it('should create an instance of PutLabelRequest', function() {
      // uncomment below and update the code to test PutLabelRequest
      //var instance = new AmazonFraudDetector.PutLabelRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.PutLabelRequest);
    });
