...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.BatchGetVariableResult();
  });
  ...
  describe('BatchGetVariableResult', function() {
    it('should create an instance of BatchGetVariableResult', function() {
      // uncomment below and update the code to test BatchGetVariableResult
      //var instance = new AmazonFraudDetector.BatchGetVariableResult();
      //expect(instance).to.be.a(AmazonFraudDetector.BatchGetVariableResult);
    });
