...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ModelVersionDetail();
  });
  ...
  describe('ModelVersionDetail', function() {
    it('should create an instance of ModelVersionDetail', function() {
      // uncomment below and update the code to test ModelVersionDetail
      //var instance = new AmazonFraudDetector.ModelVersionDetail();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelVersionDetail);
    });
    ...
    it('should have the property modelVersionNumber (base name: "modelVersionNumber")', function() {
      // uncomment below and update the code to test the property modelVersionNumber
      //var instance = new AmazonFraudDetector.ModelVersionDetail();
      //expect(instance).to.be();
    });
    ...
    it('should have the property trainingDataSource (base name: "trainingDataSource")', function() {
      // uncomment below and update the code to test the property trainingDataSource
      //var instance = new AmazonFraudDetector.ModelVersionDetail();
      //expect(instance).to.be();
    });

    it('should have the property trainingDataSchema (base name: "trainingDataSchema")', function() {
      // uncomment below and update the code to test the property trainingDataSchema
      //var instance = new AmazonFraudDetector.ModelVersionDetail();
      //expect(instance).to.be();
    });

    it('should have the property externalEventsDetail (base name: "externalEventsDetail")', function() {
      // uncomment below and update the code to test the property externalEventsDetail
      //var instance = new AmazonFraudDetector.ModelVersionDetail();
      //expect(instance).to.be();
    });

    it('should have the property ingestedEventsDetail (base name: "ingestedEventsDetail")', function() {
      // uncomment below and update the code to test the property ingestedEventsDetail
      //var instance = new AmazonFraudDetector.ModelVersionDetail();
      //expect(instance).to.be();
    });

    it('should have the property trainingResult (base name: "trainingResult")', function() {
      // uncomment below and update the code to test the property trainingResult
      //var instance = new AmazonFraudDetector.ModelVersionDetail();
      //expect(instance).to.be();
    });
    ...
    it('should have the property trainingResultV2 (base name: "trainingResultV2")', function() {
      // uncomment below and update the code to test the property trainingResultV2
      //var instance = new AmazonFraudDetector.ModelVersionDetail();
      //expect(instance).to.be();
    });
