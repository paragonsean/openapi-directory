...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetListElementsRequest();
  });
  ...
  describe('GetListElementsRequest', function() {
    it('should create an instance of GetListElementsRequest', function() {
      // uncomment below and update the code to test GetListElementsRequest
      //var instance = new AmazonFraudDetector.GetListElementsRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetListElementsRequest);
    });
