...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteOutcomeRequest();
  });
  ...
  describe('DeleteOutcomeRequest', function() {
    it('should create an instance of DeleteOutcomeRequest', function() {
      // uncomment below and update the code to test DeleteOutcomeRequest
      //var instance = new AmazonFraudDetector.DeleteOutcomeRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteOutcomeRequest);
    });
