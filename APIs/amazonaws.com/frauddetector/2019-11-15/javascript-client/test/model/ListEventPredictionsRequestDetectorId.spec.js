...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ListEventPredictionsRequestDetectorId();
  });
  ...
  describe('ListEventPredictionsRequestDetectorId', function() {
    it('should create an instance of ListEventPredictionsRequestDetectorId', function() {
      // uncomment below and update the code to test ListEventPredictionsRequestDetectorId
      //var instance = new AmazonFraudDetector.ListEventPredictionsRequestDetectorId();
      //expect(instance).to.be.a(AmazonFraudDetector.ListEventPredictionsRequestDetectorId);
    });
