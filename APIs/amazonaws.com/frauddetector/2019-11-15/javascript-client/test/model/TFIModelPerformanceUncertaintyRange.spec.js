...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TFIModelPerformanceUncertaintyRange();
  });
  ...
  describe('TFIModelPerformanceUncertaintyRange', function() {
    it('should create an instance of TFIModelPerformanceUncertaintyRange', function() {
      // uncomment below and update the code to test TFIModelPerformanceUncertaintyRange
      //var instance = new AmazonFraudDetector.TFIModelPerformanceUncertaintyRange();
      //expect(instance).to.be.a(AmazonFraudDetector.TFIModelPerformanceUncertaintyRange);
    });
