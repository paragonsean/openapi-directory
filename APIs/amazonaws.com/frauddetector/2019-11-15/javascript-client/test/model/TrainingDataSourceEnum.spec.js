...
(function(root, factory) {
  ...
  describe('TrainingDataSourceEnum', function() {
    it('should create an instance of TrainingDataSourceEnum', function() {
      // uncomment below and update the code to test TrainingDataSourceEnum
      //var instance = new AmazonFraudDetector.TrainingDataSourceEnum();
      //expect(instance).to.be.a(AmazonFraudDetector.TrainingDataSourceEnum);
    });
