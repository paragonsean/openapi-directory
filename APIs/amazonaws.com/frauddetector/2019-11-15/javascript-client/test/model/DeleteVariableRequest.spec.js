...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteVariableRequest();
  });
  ...
  describe('DeleteVariableRequest', function() {
    it('should create an instance of DeleteVariableRequest', function() {
      // uncomment below and update the code to test DeleteVariableRequest
      //var instance = new AmazonFraudDetector.DeleteVariableRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteVariableRequest);
    });
