...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TrainingResult();
  });
  ...
  describe('TrainingResult', function() {
    it('should create an instance of TrainingResult', function() {
      // uncomment below and update the code to test TrainingResult
      //var instance = new AmazonFraudDetector.TrainingResult();
      //expect(instance).to.be.a(AmazonFraudDetector.TrainingResult);
    });
