...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.FileValidationMessage();
  });
  ...
  describe('FileValidationMessage', function() {
    it('should create an instance of FileValidationMessage', function() {
      // uncomment below and update the code to test FileValidationMessage
      //var instance = new AmazonFraudDetector.FileValidationMessage();
      //expect(instance).to.be.a(AmazonFraudDetector.FileValidationMessage);
    });
