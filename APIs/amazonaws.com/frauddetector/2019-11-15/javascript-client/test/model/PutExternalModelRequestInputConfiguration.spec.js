...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.PutExternalModelRequestInputConfiguration();
  });
  ...
  describe('PutExternalModelRequestInputConfiguration', function() {
    it('should create an instance of PutExternalModelRequestInputConfiguration', function() {
      // uncomment below and update the code to test PutExternalModelRequestInputConfiguration
      //var instance = new AmazonFraudDetector.PutExternalModelRequestInputConfiguration();
      //expect(instance).to.be.a(AmazonFraudDetector.PutExternalModelRequestInputConfiguration);
    });
