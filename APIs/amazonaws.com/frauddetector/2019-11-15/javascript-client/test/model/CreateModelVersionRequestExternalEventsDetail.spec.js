...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateModelVersionRequestExternalEventsDetail();
  });
  ...
  describe('CreateModelVersionRequestExternalEventsDetail', function() {
    it('should create an instance of CreateModelVersionRequestExternalEventsDetail', function() {
      // uncomment below and update the code to test CreateModelVersionRequestExternalEventsDetail
      //var instance = new AmazonFraudDetector.CreateModelVersionRequestExternalEventsDetail();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateModelVersionRequestExternalEventsDetail);
    });
