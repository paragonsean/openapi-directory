...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ListEventPredictionsRequest();
  });
  ...
  describe('ListEventPredictionsRequest', function() {
    it('should create an instance of ListEventPredictionsRequest', function() {
      // uncomment below and update the code to test ListEventPredictionsRequest
      //var instance = new AmazonFraudDetector.ListEventPredictionsRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.ListEventPredictionsRequest);
    });
