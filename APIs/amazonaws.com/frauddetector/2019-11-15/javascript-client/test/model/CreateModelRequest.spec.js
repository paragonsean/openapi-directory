...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateModelRequest();
  });
  ...
  describe('CreateModelRequest', function() {
    it('should create an instance of CreateModelRequest', function() {
      ...
      //var instance = new AmazonFraudDetector.CreateModelRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateModelRequest);
    });
