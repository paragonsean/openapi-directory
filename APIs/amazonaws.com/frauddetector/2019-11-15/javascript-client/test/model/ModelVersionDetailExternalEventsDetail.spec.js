...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ModelVersionDetailExternalEventsDetail();
  });
  ...
  describe('ModelVersionDetailExternalEventsDetail', function() {
    it('should create an instance of ModelVersionDetailExternalEventsDetail', function() {
      // uncomment below and update the code to test ModelVersionDetailExternalEventsDetail
      //var instance = new AmazonFraudDetector.ModelVersionDetailExternalEventsDetail();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelVersionDetailExternalEventsDetail);
    });
