...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetEventPredictionMetadataResult();
  });
  ...
  describe('GetEventPredictionMetadataResult', function() {
    it('should create an instance of GetEventPredictionMetadataResult', function() {
      // uncomment below and update the code to test GetEventPredictionMetadataResult
      //var instance = new AmazonFraudDetector.GetEventPredictionMetadataResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetEventPredictionMetadataResult);
    });
    ...
    it('should have the property detectorVersionStatus (base name: "detectorVersionStatus")', function() {
      // uncomment below and update the code to test the property detectorVersionStatus
      //var instance = new AmazonFraudDetector.GetEventPredictionMetadataResult();
      //expect(instance).to.be();
    });
    ...
    it('should have the property evaluatedModelVersions (base name: "evaluatedModelVersions")', function() {
      // uncomment below and update the code to test the property evaluatedModelVersions
      //var instance = new AmazonFraudDetector.GetEventPredictionMetadataResult();
      //expect(instance).to.be();
    });

    it('should have the property evaluatedExternalModels (base name: "evaluatedExternalModels")', function() {
      // uncomment below and update the code to test the property evaluatedExternalModels
      //var instance = new AmazonFraudDetector.GetEventPredictionMetadataResult();
      //expect(instance).to.be();
    });

    it('should have the property predictionTimestamp (base name: "predictionTimestamp")', function() {
      // uncomment below and update the code to test the property predictionTimestamp
      //var instance = new AmazonFraudDetector.GetEventPredictionMetadataResult();
      //expect(instance).to.be();
    });
