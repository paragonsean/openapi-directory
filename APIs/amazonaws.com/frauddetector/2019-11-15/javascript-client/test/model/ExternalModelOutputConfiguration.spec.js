...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ExternalModelOutputConfiguration();
  });
  ...
  describe('ExternalModelOutputConfiguration', function() {
    it('should create an instance of ExternalModelOutputConfiguration', function() {
      // uncomment below and update the code to test ExternalModelOutputConfiguration
      //var instance = new AmazonFraudDetector.ExternalModelOutputConfiguration();
      //expect(instance).to.be.a(AmazonFraudDetector.ExternalModelOutputConfiguration);
    });
    ...
    it('should have the property jsonKeyToVariableMap (base name: "jsonKeyToVariableMap")', function() {
      // uncomment below and update the code to test the property jsonKeyToVariableMap
      //var instance = new AmazonFraudDetector.ExternalModelOutputConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property csvIndexToVariableMap (base name: "csvIndexToVariableMap")', function() {
      // uncomment below and update the code to test the property csvIndexToVariableMap
      //var instance = new AmazonFraudDetector.ExternalModelOutputConfiguration();
      //expect(instance).to.be();
    });
