...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateDetectorVersionRequest();
  });
  ...
  describe('CreateDetectorVersionRequest', function() {
    it('should create an instance of CreateDetectorVersionRequest', function() {
      // uncomment below and update the code to test CreateDetectorVersionRequest
      //var instance = new AmazonFraudDetector.CreateDetectorVersionRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateDetectorVersionRequest);
    });
    ...
    it('should have the property externalModelEndpoints (base name: "externalModelEndpoints")', function() {
      // uncomment below and update the code to test the property externalModelEndpoints
      //var instance = new AmazonFraudDetector.CreateDetectorVersionRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property modelVersions (base name: "modelVersions")', function() {
      // uncomment below and update the code to test the property modelVersions
      //var instance = new AmazonFraudDetector.CreateDetectorVersionRequest();
      //expect(instance).to.be();
    });

    it('should have the property ruleExecutionMode (base name: "ruleExecutionMode")', function() {
      // uncomment below and update the code to test the property ruleExecutionMode
      //var instance = new AmazonFraudDetector.CreateDetectorVersionRequest();
      //expect(instance).to.be();
    });
