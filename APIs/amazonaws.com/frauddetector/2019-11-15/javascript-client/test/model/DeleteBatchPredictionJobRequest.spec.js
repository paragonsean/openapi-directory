...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteBatchPredictionJobRequest();
  });
  ...
  describe('DeleteBatchPredictionJobRequest', function() {
    it('should create an instance of DeleteBatchPredictionJobRequest', function() {
      // uncomment below and update the code to test DeleteBatchPredictionJobRequest
      //var instance = new AmazonFraudDetector.DeleteBatchPredictionJobRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteBatchPredictionJobRequest);
    });
