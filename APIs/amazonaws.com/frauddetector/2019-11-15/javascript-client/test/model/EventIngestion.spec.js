...
(function(root, factory) {
  ...
  describe('EventIngestion', function() {
    it('should create an instance of EventIngestion', function() {
      // uncomment below and update the code to test EventIngestion
      //var instance = new AmazonFraudDetector.EventIngestion();
      //expect(instance).to.be.a(AmazonFraudDetector.EventIngestion);
    });
