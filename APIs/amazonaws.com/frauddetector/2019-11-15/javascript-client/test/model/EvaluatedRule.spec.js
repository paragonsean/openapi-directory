...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.EvaluatedRule();
  });
  ...
  describe('EvaluatedRule', function() {
    it('should create an instance of EvaluatedRule', function() {
      // uncomment below and update the code to test EvaluatedRule
      //var instance = new AmazonFraudDetector.EvaluatedRule();
      //expect(instance).to.be.a(AmazonFraudDetector.EvaluatedRule);
    });
    ...
    it('should have the property expressionWithValues (base name: "expressionWithValues")', function() {
      // uncomment below and update the code to test the property expressionWithValues
      //var instance = new AmazonFraudDetector.EvaluatedRule();
      //expect(instance).to.be();
    });
