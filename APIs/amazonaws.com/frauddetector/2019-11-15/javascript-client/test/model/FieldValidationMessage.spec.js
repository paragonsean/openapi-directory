...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.FieldValidationMessage();
  });
  ...
  describe('FieldValidationMessage', function() {
    it('should create an instance of FieldValidationMessage', function() {
      // uncomment below and update the code to test FieldValidationMessage
      //var instance = new AmazonFraudDetector.FieldValidationMessage();
      //expect(instance).to.be.a(AmazonFraudDetector.FieldValidationMessage);
    });
