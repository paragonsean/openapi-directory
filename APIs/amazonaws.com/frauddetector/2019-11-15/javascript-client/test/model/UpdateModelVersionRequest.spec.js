...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateModelVersionRequest();
  });
  ...
  describe('UpdateModelVersionRequest', function() {
    it('should create an instance of UpdateModelVersionRequest', function() {
      // uncomment below and update the code to test UpdateModelVersionRequest
      //var instance = new AmazonFraudDetector.UpdateModelVersionRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateModelVersionRequest);
    });
    ...
    it('should have the property majorVersionNumber (base name: "majorVersionNumber")', function() {
      // uncomment below and update the code to test the property majorVersionNumber
      //var instance = new AmazonFraudDetector.UpdateModelVersionRequest();
      //expect(instance).to.be();
    });
