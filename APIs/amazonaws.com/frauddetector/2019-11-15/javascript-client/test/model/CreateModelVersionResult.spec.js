...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateModelVersionResult();
  });
  ...
  describe('CreateModelVersionResult', function() {
    it('should create an instance of CreateModelVersionResult', function() {
      // uncomment below and update the code to test CreateModelVersionResult
      //var instance = new AmazonFraudDetector.CreateModelVersionResult();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateModelVersionResult);
    });
