...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TrainingDataSchema();
  });
  ...
  describe('TrainingDataSchema', function() {
    it('should create an instance of TrainingDataSchema', function() {
      // uncomment below and update the code to test TrainingDataSchema
      //var instance = new AmazonFraudDetector.TrainingDataSchema();
      //expect(instance).to.be.a(AmazonFraudDetector.TrainingDataSchema);
    });

    it('should have the property modelVariables (base name: "modelVariables")', function() {
      // uncomment below and update the code to test the property modelVariables
      //var instance = new AmazonFraudDetector.TrainingDataSchema();
      //expect(instance).to.be();
    });

    it('should have the property labelSchema (base name: "labelSchema")', function() {
      // uncomment below and update the code to test the property labelSchema
      //var instance = new AmazonFraudDetector.TrainingDataSchema();
      //expect(instance).to.be();
    });
