...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.EventType();
  });
  ...
  describe('EventType', function() {
    it('should create an instance of EventType', function() {
      ...
      //var instance = new AmazonFraudDetector.EventType();
      //expect(instance).to.be.a(AmazonFraudDetector.EventType);
    });
    ...
    it('should have the property ingestedEventStatistics (base name: "ingestedEventStatistics")', function() {
      // uncomment below and update the code to test the property ingestedEventStatistics
      //var instance = new AmazonFraudDetector.EventType();
      //expect(instance).to.be();
    });
