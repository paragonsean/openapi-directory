...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetDetectorVersionRequest();
  });
  ...
  describe('GetDetectorVersionRequest', function() {
    it('should create an instance of GetDetectorVersionRequest', function() {
      // uncomment below and update the code to test GetDetectorVersionRequest
      //var instance = new AmazonFraudDetector.GetDetectorVersionRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetDetectorVersionRequest);
    });
