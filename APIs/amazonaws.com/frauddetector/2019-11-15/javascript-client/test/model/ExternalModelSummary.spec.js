...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ExternalModelSummary();
  });
  ...
  describe('ExternalModelSummary', function() {
    it('should create an instance of ExternalModelSummary', function() {
      // uncomment below and update the code to test ExternalModelSummary
      //var instance = new AmazonFraudDetector.ExternalModelSummary();
      //expect(instance).to.be.a(AmazonFraudDetector.ExternalModelSummary);
    });
