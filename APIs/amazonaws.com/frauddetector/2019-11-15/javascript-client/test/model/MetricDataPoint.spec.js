...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.MetricDataPoint();
  });
  ...
  describe('MetricDataPoint', function() {
    it('should create an instance of MetricDataPoint', function() {
      // uncomment below and update the code to test MetricDataPoint
      //var instance = new AmazonFraudDetector.MetricDataPoint();
      //expect(instance).to.be.a(AmazonFraudDetector.MetricDataPoint);
    });

    it('should have the property fpr (base name: "fpr")', function() {
      // uncomment below and update the code to test the property fpr
      //var instance = new AmazonFraudDetector.MetricDataPoint();
    ...
    it('should have the property tpr (base name: "tpr")', function() {
      // uncomment below and update the code to test the property tpr
      //var instance = new AmazonFraudDetector.MetricDataPoint();
      //expect(instance).to.be();
    });
