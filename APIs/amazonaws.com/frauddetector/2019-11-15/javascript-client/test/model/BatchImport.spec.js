...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.BatchImport();
  });
  ...
  describe('BatchImport', function() {
    it('should create an instance of BatchImport', function() {
      // uncomment below and update the code to test BatchImport
      //var instance = new AmazonFraudDetector.BatchImport();
      //expect(instance).to.be.a(AmazonFraudDetector.BatchImport);
    });
