...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DescribeDetectorRequest();
  });
  ...
  describe('DescribeDetectorRequest', function() {
    it('should create an instance of DescribeDetectorRequest', function() {
      // uncomment below and update the code to test DescribeDetectorRequest
      //var instance = new AmazonFraudDetector.DescribeDetectorRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.DescribeDetectorRequest);
    });
