...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CancelBatchImportJobRequest();
  });
  ...
  describe('CancelBatchImportJobRequest', function() {
    it('should create an instance of CancelBatchImportJobRequest', function() {
      // uncomment below and update the code to test CancelBatchImportJobRequest
      //var instance = new AmazonFraudDetector.CancelBatchImportJobRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.CancelBatchImportJobRequest);
    });
