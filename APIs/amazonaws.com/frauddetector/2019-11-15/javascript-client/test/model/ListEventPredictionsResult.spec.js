...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ListEventPredictionsResult();
  });
  ...
  describe('ListEventPredictionsResult', function() {
    it('should create an instance of ListEventPredictionsResult', function() {
      // uncomment below and update the code to test ListEventPredictionsResult
      //var instance = new AmazonFraudDetector.ListEventPredictionsResult();
      //expect(instance).to.be.a(AmazonFraudDetector.ListEventPredictionsResult);
    });

    it('should have the property eventPredictionSummaries (base name: "eventPredictionSummaries")', function() {
      // uncomment below and update the code to test the property eventPredictionSummaries
      //var instance = new AmazonFraudDetector.ListEventPredictionsResult();
