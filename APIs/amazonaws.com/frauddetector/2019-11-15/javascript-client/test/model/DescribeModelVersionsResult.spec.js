...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DescribeModelVersionsResult();
  });
  ...
  describe('DescribeModelVersionsResult', function() {
    it('should create an instance of DescribeModelVersionsResult', function() {
      // uncomment below and update the code to test DescribeModelVersionsResult
      //var instance = new AmazonFraudDetector.DescribeModelVersionsResult();
      //expect(instance).to.be.a(AmazonFraudDetector.DescribeModelVersionsResult);
    });

    it('should have the property modelVersionDetails (base name: "modelVersionDetails")', function() {
      // uncomment below and update the code to test the property modelVersionDetails
      //var instance = new AmazonFraudDetector.DescribeModelVersionsResult();
