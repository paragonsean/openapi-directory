...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DataValidationMetrics();
  });
  ...
  describe('DataValidationMetrics', function() {
    it('should create an instance of DataValidationMetrics', function() {
      // uncomment below and update the code to test DataValidationMetrics
      //var instance = new AmazonFraudDetector.DataValidationMetrics();
      //expect(instance).to.be.a(AmazonFraudDetector.DataValidationMetrics);
    });

    it('should have the property fileLevelMessages (base name: "fileLevelMessages")', function() {
      // uncomment below and update the code to test the property fileLevelMessages
      //var instance = new AmazonFraudDetector.DataValidationMetrics();
      //expect(instance).to.be();
    });

    it('should have the property fieldLevelMessages (base name: "fieldLevelMessages")', function() {
      // uncomment below and update the code to test the property fieldLevelMessages
      //var instance = new AmazonFraudDetector.DataValidationMetrics();
      //expect(instance).to.be();
    });
