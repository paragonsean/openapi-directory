...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateRuleVersionRequest();
  });
  ...
  describe('UpdateRuleVersionRequest', function() {
    it('should create an instance of UpdateRuleVersionRequest', function() {
      // uncomment below and update the code to test UpdateRuleVersionRequest
      //var instance = new AmazonFraudDetector.UpdateRuleVersionRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateRuleVersionRequest);
    });
