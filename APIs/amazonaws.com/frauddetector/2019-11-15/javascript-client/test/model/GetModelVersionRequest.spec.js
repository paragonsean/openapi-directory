...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetModelVersionRequest();
  });
  ...
  describe('GetModelVersionRequest', function() {
    it('should create an instance of GetModelVersionRequest', function() {
      // uncomment below and update the code to test GetModelVersionRequest
      //var instance = new AmazonFraudDetector.GetModelVersionRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetModelVersionRequest);
    });
