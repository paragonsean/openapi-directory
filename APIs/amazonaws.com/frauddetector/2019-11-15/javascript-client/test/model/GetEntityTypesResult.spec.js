...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetEntityTypesResult();
  });
  ...
  describe('GetEntityTypesResult', function() {
    it('should create an instance of GetEntityTypesResult', function() {
      // uncomment below and update the code to test GetEntityTypesResult
      //var instance = new AmazonFraudDetector.GetEntityTypesResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetEntityTypesResult);
    });
