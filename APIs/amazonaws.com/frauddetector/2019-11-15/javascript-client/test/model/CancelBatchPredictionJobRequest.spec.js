...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CancelBatchPredictionJobRequest();
  });
  ...
  describe('CancelBatchPredictionJobRequest', function() {
    it('should create an instance of CancelBatchPredictionJobRequest', function() {
      // uncomment below and update the code to test CancelBatchPredictionJobRequest
      //var instance = new AmazonFraudDetector.CancelBatchPredictionJobRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.CancelBatchPredictionJobRequest);
    });
