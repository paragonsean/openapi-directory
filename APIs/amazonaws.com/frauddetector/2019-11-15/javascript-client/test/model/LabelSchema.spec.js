...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.LabelSchema();
  });
  ...
  describe('LabelSchema', function() {
    it('should create an instance of LabelSchema', function() {
      // uncomment below and update the code to test LabelSchema
      //var instance = new AmazonFraudDetector.LabelSchema();
      //expect(instance).to.be.a(AmazonFraudDetector.LabelSchema);
    });

    it('should have the property labelMapper (base name: "labelMapper")', function() {
      // uncomment below and update the code to test the property labelMapper
      //var instance = new AmazonFraudDetector.LabelSchema();
      //expect(instance).to.be();
    });

    it('should have the property unlabeledEventsTreatment (base name: "unlabeledEventsTreatment")', function() {
      // uncomment below and update the code to test the property unlabeledEventsTreatment
      //var instance = new AmazonFraudDetector.LabelSchema();
      //expect(instance).to.be();
    });
