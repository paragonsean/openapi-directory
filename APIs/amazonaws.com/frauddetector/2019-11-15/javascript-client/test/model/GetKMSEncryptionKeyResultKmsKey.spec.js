...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetKMSEncryptionKeyResultKmsKey();
  });
  ...
  describe('GetKMSEncryptionKeyResultKmsKey', function() {
    it('should create an instance of GetKMSEncryptionKeyResultKmsKey', function() {
      // uncomment below and update the code to test GetKMSEncryptionKeyResultKmsKey
      //var instance = new AmazonFraudDetector.GetKMSEncryptionKeyResultKmsKey();
      //expect(instance).to.be.a(AmazonFraudDetector.GetKMSEncryptionKeyResultKmsKey);
    });
