...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetLabelsRequest();
  });
  ...
  describe('GetLabelsRequest', function() {
    it('should create an instance of GetLabelsRequest', function() {
      // uncomment below and update the code to test GetLabelsRequest
      //var instance = new AmazonFraudDetector.GetLabelsRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetLabelsRequest);
    });
