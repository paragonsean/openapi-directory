...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetBatchPredictionJobsRequest();
  });
  ...
  describe('GetBatchPredictionJobsRequest', function() {
    it('should create an instance of GetBatchPredictionJobsRequest', function() {
      // uncomment below and update the code to test GetBatchPredictionJobsRequest
      //var instance = new AmazonFraudDetector.GetBatchPredictionJobsRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetBatchPredictionJobsRequest);
    });
