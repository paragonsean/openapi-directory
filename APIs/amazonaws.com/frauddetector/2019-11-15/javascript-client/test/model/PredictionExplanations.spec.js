...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.PredictionExplanations();
  });
  ...
  describe('PredictionExplanations', function() {
    it('should create an instance of PredictionExplanations', function() {
      // uncomment below and update the code to test PredictionExplanations
      //var instance = new AmazonFraudDetector.PredictionExplanations();
      //expect(instance).to.be.a(AmazonFraudDetector.PredictionExplanations);
    });

    it('should have the property variableImpactExplanations (base name: "variableImpactExplanations")', function() {
      // uncomment below and update the code to test the property variableImpactExplanations
      //var instance = new AmazonFraudDetector.PredictionExplanations();
      //expect(instance).to.be();
    });

    it('should have the property aggregatedVariablesImpactExplanations (base name: "aggregatedVariablesImpactExplanations")', function() {
      // uncomment below and update the code to test the property aggregatedVariablesImpactExplanations
      //var instance = new AmazonFraudDetector.PredictionExplanations();
      //expect(instance).to.be();
    });
