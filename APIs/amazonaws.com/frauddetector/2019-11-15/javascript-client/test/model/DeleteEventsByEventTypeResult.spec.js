...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DeleteEventsByEventTypeResult();
  });
  ...
  describe('DeleteEventsByEventTypeResult', function() {
    it('should create an instance of DeleteEventsByEventTypeResult', function() {
      // uncomment below and update the code to test DeleteEventsByEventTypeResult
      //var instance = new AmazonFraudDetector.DeleteEventsByEventTypeResult();
      //expect(instance).to.be.a(AmazonFraudDetector.DeleteEventsByEventTypeResult);
    });
    ...
    it('should have the property eventsDeletionStatus (base name: "eventsDeletionStatus")', function() {
      // uncomment below and update the code to test the property eventsDeletionStatus
      //var instance = new AmazonFraudDetector.DeleteEventsByEventTypeResult();
      //expect(instance).to.be();
    });
