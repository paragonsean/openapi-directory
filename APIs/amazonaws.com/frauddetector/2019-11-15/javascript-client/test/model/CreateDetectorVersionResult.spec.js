...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateDetectorVersionResult();
  });
  ...
  describe('CreateDetectorVersionResult', function() {
    it('should create an instance of CreateDetectorVersionResult', function() {
      // uncomment below and update the code to test CreateDetectorVersionResult
      //var instance = new AmazonFraudDetector.CreateDetectorVersionResult();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateDetectorVersionResult);
    });
