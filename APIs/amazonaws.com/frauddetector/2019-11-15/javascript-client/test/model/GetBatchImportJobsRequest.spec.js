...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetBatchImportJobsRequest();
  });
  ...
  describe('GetBatchImportJobsRequest', function() {
    it('should create an instance of GetBatchImportJobsRequest', function() {
      // uncomment below and update the code to test GetBatchImportJobsRequest
      //var instance = new AmazonFraudDetector.GetBatchImportJobsRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetBatchImportJobsRequest);
    });
