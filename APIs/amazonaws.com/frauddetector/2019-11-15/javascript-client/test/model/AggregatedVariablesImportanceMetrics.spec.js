...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.AggregatedVariablesImportanceMetrics();
  });
  ...
  describe('AggregatedVariablesImportanceMetrics', function() {
    it('should create an instance of AggregatedVariablesImportanceMetrics', function() {
      // uncomment below and update the code to test AggregatedVariablesImportanceMetrics
      //var instance = new AmazonFraudDetector.AggregatedVariablesImportanceMetrics();
      //expect(instance).to.be.a(AmazonFraudDetector.AggregatedVariablesImportanceMetrics);
    });
