...
(function(root, factory) {
  ...
  describe('DetectorVersionStatus', function() {
    it('should create an instance of DetectorVersionStatus', function() {
      // uncomment below and update the code to test DetectorVersionStatus
      //var instance = new AmazonFraudDetector.DetectorVersionStatus();
      //expect(instance).to.be.a(AmazonFraudDetector.DetectorVersionStatus);
    });
