...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ListEventPredictionsRequestDetectorVersionId();
  });
  ...
  describe('ListEventPredictionsRequestDetectorVersionId', function() {
    it('should create an instance of ListEventPredictionsRequestDetectorVersionId', function() {
      // uncomment below and update the code to test ListEventPredictionsRequestDetectorVersionId
      //var instance = new AmazonFraudDetector.ListEventPredictionsRequestDetectorVersionId();
      //expect(instance).to.be.a(AmazonFraudDetector.ListEventPredictionsRequestDetectorVersionId);
    });
