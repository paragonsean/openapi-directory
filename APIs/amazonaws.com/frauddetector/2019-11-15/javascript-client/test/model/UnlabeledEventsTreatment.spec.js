...
(function(root, factory) {
  ...
  describe('UnlabeledEventsTreatment', function() {
    it('should create an instance of UnlabeledEventsTreatment', function() {
      // uncomment below and update the code to test UnlabeledEventsTreatment
      //var instance = new AmazonFraudDetector.UnlabeledEventsTreatment();
      //expect(instance).to.be.a(AmazonFraudDetector.UnlabeledEventsTreatment);
    });
