...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetModelsResult();
  });
  ...
  describe('GetModelsResult', function() {
    it('should create an instance of GetModelsResult', function() {
      // uncomment below and update the code to test GetModelsResult
      //var instance = new AmazonFraudDetector.GetModelsResult();
      //expect(instance).to.be.a(AmazonFraudDetector.GetModelsResult);
    });
