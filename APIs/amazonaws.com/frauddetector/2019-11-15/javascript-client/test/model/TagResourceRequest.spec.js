...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonFraudDetector.TagResourceRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.TagResourceRequest);
    });
