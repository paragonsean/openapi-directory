...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.BatchCreateVariableError();
  });
  ...
  describe('BatchCreateVariableError', function() {
    it('should create an instance of BatchCreateVariableError', function() {
      // uncomment below and update the code to test BatchCreateVariableError
      //var instance = new AmazonFraudDetector.BatchCreateVariableError();
      //expect(instance).to.be.a(AmazonFraudDetector.BatchCreateVariableError);
    });
