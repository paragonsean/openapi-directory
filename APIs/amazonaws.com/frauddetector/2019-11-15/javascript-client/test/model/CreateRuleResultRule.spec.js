...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateRuleResultRule();
  });
  ...
  describe('CreateRuleResultRule', function() {
    it('should create an instance of CreateRuleResultRule', function() {
      // uncomment below and update the code to test CreateRuleResultRule
      //var instance = new AmazonFraudDetector.CreateRuleResultRule();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateRuleResultRule);
    });
