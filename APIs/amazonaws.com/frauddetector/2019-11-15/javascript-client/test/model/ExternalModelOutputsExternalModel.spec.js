...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ExternalModelOutputsExternalModel();
  });
  ...
  describe('ExternalModelOutputsExternalModel', function() {
    it('should create an instance of ExternalModelOutputsExternalModel', function() {
      // uncomment below and update the code to test ExternalModelOutputsExternalModel
      //var instance = new AmazonFraudDetector.ExternalModelOutputsExternalModel();
      //expect(instance).to.be.a(AmazonFraudDetector.ExternalModelOutputsExternalModel);
    });
    ...
    it('should have the property modelSource (base name: "modelSource")', function() {
