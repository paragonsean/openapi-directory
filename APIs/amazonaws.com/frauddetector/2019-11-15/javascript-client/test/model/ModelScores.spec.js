...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ModelScores();
  });
  ...
  describe('ModelScores', function() {
    it('should create an instance of ModelScores', function() {
      // uncomment below and update the code to test ModelScores
      //var instance = new AmazonFraudDetector.ModelScores();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelScores);
    });
