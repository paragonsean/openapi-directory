...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.PredictionTimeRange();
  });
  ...
  describe('PredictionTimeRange', function() {
    it('should create an instance of PredictionTimeRange', function() {
      ...
      //var instance = new AmazonFraudDetector.PredictionTimeRange();
      //expect(instance).to.be.a(AmazonFraudDetector.PredictionTimeRange);
    });
