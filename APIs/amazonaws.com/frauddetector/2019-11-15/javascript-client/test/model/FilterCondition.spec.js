...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.FilterCondition();
  });
  ...
  describe('FilterCondition', function() {
    it('should create an instance of FilterCondition', function() {
      ...
      //var instance = new AmazonFraudDetector.FilterCondition();
      //expect(instance).to.be.a(AmazonFraudDetector.FilterCondition);
    });
