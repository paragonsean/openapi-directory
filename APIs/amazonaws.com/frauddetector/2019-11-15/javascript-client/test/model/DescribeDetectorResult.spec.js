...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.DescribeDetectorResult();
  });
  ...
  describe('DescribeDetectorResult', function() {
    it('should create an instance of DescribeDetectorResult', function() {
      // uncomment below and update the code to test DescribeDetectorResult
      //var instance = new AmazonFraudDetector.DescribeDetectorResult();
      //expect(instance).to.be.a(AmazonFraudDetector.DescribeDetectorResult);
    });
    ...
    it('should have the property detectorVersionSummaries (base name: "detectorVersionSummaries")', function() {
      // uncomment below and update the code to test the property detectorVersionSummaries
      //var instance = new AmazonFraudDetector.DescribeDetectorResult();
      //expect(instance).to.be();
    });
