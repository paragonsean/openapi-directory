...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ATIModelPerformance();
  });
  ...
  describe('ATIModelPerformance', function() {
    it('should create an instance of ATIModelPerformance', function() {
      // uncomment below and update the code to test ATIModelPerformance
      //var instance = new AmazonFraudDetector.ATIModelPerformance();
      //expect(instance).to.be.a(AmazonFraudDetector.ATIModelPerformance);
    });
