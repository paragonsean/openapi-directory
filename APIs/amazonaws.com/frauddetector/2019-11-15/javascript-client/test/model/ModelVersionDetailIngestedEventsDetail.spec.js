...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ModelVersionDetailIngestedEventsDetail();
  });
  ...
  describe('ModelVersionDetailIngestedEventsDetail', function() {
    it('should create an instance of ModelVersionDetailIngestedEventsDetail', function() {
      // uncomment below and update the code to test ModelVersionDetailIngestedEventsDetail
      //var instance = new AmazonFraudDetector.ModelVersionDetailIngestedEventsDetail();
      //expect(instance).to.be.a(AmazonFraudDetector.ModelVersionDetailIngestedEventsDetail);
    });

    it('should have the property ingestedEventsTimeWindow (base name: "ingestedEventsTimeWindow")', function() {
      // uncomment below and update the code to test the property ingestedEventsTimeWindow
      //var instance = new AmazonFraudDetector.ModelVersionDetailIngestedEventsDetail();
