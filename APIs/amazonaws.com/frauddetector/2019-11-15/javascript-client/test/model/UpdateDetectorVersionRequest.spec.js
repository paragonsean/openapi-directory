...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateDetectorVersionRequest();
  });
  ...
  describe('UpdateDetectorVersionRequest', function() {
    it('should create an instance of UpdateDetectorVersionRequest', function() {
      // uncomment below and update the code to test UpdateDetectorVersionRequest
      //var instance = new AmazonFraudDetector.UpdateDetectorVersionRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateDetectorVersionRequest);
    });
