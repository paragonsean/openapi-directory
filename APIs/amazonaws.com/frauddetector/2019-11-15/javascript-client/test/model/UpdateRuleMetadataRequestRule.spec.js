...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateRuleMetadataRequestRule();
  });
  ...
  describe('UpdateRuleMetadataRequestRule', function() {
    it('should create an instance of UpdateRuleMetadataRequestRule', function() {
      // uncomment below and update the code to test UpdateRuleMetadataRequestRule
      //var instance = new AmazonFraudDetector.UpdateRuleMetadataRequestRule();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateRuleMetadataRequestRule);
    });
