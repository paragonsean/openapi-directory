...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.OFIModelPerformanceUncertaintyRange();
  });
  ...
  describe('OFIModelPerformanceUncertaintyRange', function() {
    it('should create an instance of OFIModelPerformanceUncertaintyRange', function() {
      // uncomment below and update the code to test OFIModelPerformanceUncertaintyRange
      //var instance = new AmazonFraudDetector.OFIModelPerformanceUncertaintyRange();
      //expect(instance).to.be.a(AmazonFraudDetector.OFIModelPerformanceUncertaintyRange);
    });

    it('should have the property lowerBoundValue (base name: "lowerBoundValue")', function() {
      // uncomment below and update the code to test the property lowerBoundValue
      //var instance = new AmazonFraudDetector.OFIModelPerformanceUncertaintyRange();
      //expect(instance).to.be();
    });

    it('should have the property upperBoundValue (base name: "upperBoundValue")', function() {
      // uncomment below and update the code to test the property upperBoundValue
      //var instance = new AmazonFraudDetector.OFIModelPerformanceUncertaintyRange();
      //expect(instance).to.be();
    });
