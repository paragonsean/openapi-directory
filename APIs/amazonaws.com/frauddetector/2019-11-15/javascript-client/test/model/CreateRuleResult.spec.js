...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.CreateRuleResult();
  });
  ...
  describe('CreateRuleResult', function() {
    it('should create an instance of CreateRuleResult', function() {
      // uncomment below and update the code to test CreateRuleResult
      //var instance = new AmazonFraudDetector.CreateRuleResult();
      //expect(instance).to.be.a(AmazonFraudDetector.CreateRuleResult);
    });
