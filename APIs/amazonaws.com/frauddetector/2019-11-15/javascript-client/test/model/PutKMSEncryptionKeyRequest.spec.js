...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.PutKMSEncryptionKeyRequest();
  });
  ...
  describe('PutKMSEncryptionKeyRequest', function() {
    it('should create an instance of PutKMSEncryptionKeyRequest', function() {
      // uncomment below and update the code to test PutKMSEncryptionKeyRequest
      //var instance = new AmazonFraudDetector.PutKMSEncryptionKeyRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.PutKMSEncryptionKeyRequest);
    });
