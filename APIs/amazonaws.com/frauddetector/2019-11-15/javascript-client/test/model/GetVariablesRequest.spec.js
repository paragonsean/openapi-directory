...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetVariablesRequest();
  });
  ...
  describe('GetVariablesRequest', function() {
    it('should create an instance of GetVariablesRequest', function() {
      // uncomment below and update the code to test GetVariablesRequest
      //var instance = new AmazonFraudDetector.GetVariablesRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetVariablesRequest);
    });
