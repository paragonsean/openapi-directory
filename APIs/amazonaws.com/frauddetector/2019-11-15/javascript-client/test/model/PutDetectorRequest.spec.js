...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.PutDetectorRequest();
  });
  ...
  describe('PutDetectorRequest', function() {
    it('should create an instance of PutDetectorRequest', function() {
      // uncomment below and update the code to test PutDetectorRequest
      //var instance = new AmazonFraudDetector.PutDetectorRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.PutDetectorRequest);
    });
