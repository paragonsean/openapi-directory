...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetExternalModelsRequest();
  });
  ...
  describe('GetExternalModelsRequest', function() {
    it('should create an instance of GetExternalModelsRequest', function() {
      // uncomment below and update the code to test GetExternalModelsRequest
      //var instance = new AmazonFraudDetector.GetExternalModelsRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetExternalModelsRequest);
    });
