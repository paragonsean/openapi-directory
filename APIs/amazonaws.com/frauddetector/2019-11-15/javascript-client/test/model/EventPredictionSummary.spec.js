...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.EventPredictionSummary();
  });
  ...
  describe('EventPredictionSummary', function() {
    it('should create an instance of EventPredictionSummary', function() {
      // uncomment below and update the code to test EventPredictionSummary
      //var instance = new AmazonFraudDetector.EventPredictionSummary();
      //expect(instance).to.be.a(AmazonFraudDetector.EventPredictionSummary);
    });
