...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.GetOutcomesRequest();
  });
  ...
  describe('GetOutcomesRequest', function() {
    it('should create an instance of GetOutcomesRequest', function() {
      // uncomment below and update the code to test GetOutcomesRequest
      //var instance = new AmazonFraudDetector.GetOutcomesRequest();
      //expect(instance).to.be.a(AmazonFraudDetector.GetOutcomesRequest);
    });
