...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.OFITrainingMetricsValue();
  });
  ...
  describe('OFITrainingMetricsValue', function() {
    it('should create an instance of OFITrainingMetricsValue', function() {
      // uncomment below and update the code to test OFITrainingMetricsValue
      //var instance = new AmazonFraudDetector.OFITrainingMetricsValue();
      //expect(instance).to.be.a(AmazonFraudDetector.OFITrainingMetricsValue);
    });
