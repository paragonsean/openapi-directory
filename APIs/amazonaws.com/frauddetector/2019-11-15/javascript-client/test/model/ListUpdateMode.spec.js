...
(function(root, factory) {
  ...
  describe('ListUpdateMode', function() {
    it('should create an instance of ListUpdateMode', function() {
      // uncomment below and update the code to test ListUpdateMode
      //var instance = new AmazonFraudDetector.ListUpdateMode();
      //expect(instance).to.be.a(AmazonFraudDetector.ListUpdateMode);
    });
