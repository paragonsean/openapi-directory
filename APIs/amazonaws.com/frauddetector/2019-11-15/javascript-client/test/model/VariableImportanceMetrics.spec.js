...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.VariableImportanceMetrics();
  });
  ...
  describe('VariableImportanceMetrics', function() {
    it('should create an instance of VariableImportanceMetrics', function() {
      // uncomment below and update the code to test VariableImportanceMetrics
      //var instance = new AmazonFraudDetector.VariableImportanceMetrics();
      //expect(instance).to.be.a(AmazonFraudDetector.VariableImportanceMetrics);
    });

    it('should have the property logOddsMetrics (base name: "logOddsMetrics")', function() {
      // uncomment below and update the code to test the property logOddsMetrics
      //var instance = new AmazonFraudDetector.VariableImportanceMetrics();
