...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.KMSKey();
  });
  ...
  describe('KMSKey', function() {
    it('should create an instance of KMSKey', function() {
      // uncomment below and update the code to test KMSKey
      //var instance = new AmazonFraudDetector.KMSKey();
      //expect(instance).to.be.a(AmazonFraudDetector.KMSKey);
    });

    it('should have the property kmsEncryptionKeyArn (base name: "kmsEncryptionKeyArn")', function() {
      // uncomment below and update the code to test the property kmsEncryptionKeyArn
      //var instance = new AmazonFraudDetector.KMSKey();
