...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.UpdateModelVersionRequestIngestedEventsDetail();
  });
  ...
  describe('UpdateModelVersionRequestIngestedEventsDetail', function() {
    it('should create an instance of UpdateModelVersionRequestIngestedEventsDetail', function() {
      // uncomment below and update the code to test UpdateModelVersionRequestIngestedEventsDetail
      //var instance = new AmazonFraudDetector.UpdateModelVersionRequestIngestedEventsDetail();
      //expect(instance).to.be.a(AmazonFraudDetector.UpdateModelVersionRequestIngestedEventsDetail);
    });
