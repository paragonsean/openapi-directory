...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TrainingResultTrainingMetrics();
  });
  ...
  describe('TrainingResultTrainingMetrics', function() {
    it('should create an instance of TrainingResultTrainingMetrics', function() {
      // uncomment below and update the code to test TrainingResultTrainingMetrics
      //var instance = new AmazonFraudDetector.TrainingResultTrainingMetrics();
      //expect(instance).to.be.a(AmazonFraudDetector.TrainingResultTrainingMetrics);
    });
