...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.TrainingMetrics();
  });
  ...
  describe('TrainingMetrics', function() {
    it('should create an instance of TrainingMetrics', function() {
      // uncomment below and update the code to test TrainingMetrics
      //var instance = new AmazonFraudDetector.TrainingMetrics();
      //expect(instance).to.be.a(AmazonFraudDetector.TrainingMetrics);
    });
