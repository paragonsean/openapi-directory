...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ExternalModel();
  });
  ...
  describe('ExternalModel', function() {
    it('should create an instance of ExternalModel', function() {
      // uncomment below and update the code to test ExternalModel
      //var instance = new AmazonFraudDetector.ExternalModel();
      //expect(instance).to.be.a(AmazonFraudDetector.ExternalModel);
    });
    ...
    it('should have the property invokeModelEndpointRoleArn (base name: "invokeModelEndpointRoleArn")', function() {
      // uncomment below and update the code to test the property invokeModelEndpointRoleArn
      //var instance = new AmazonFraudDetector.ExternalModel();
      //expect(instance).to.be();
    });
    ...
    it('should have the property modelEndpointStatus (base name: "modelEndpointStatus")', function() {
      // uncomment below and update the code to test the property modelEndpointStatus
      //var instance = new AmazonFraudDetector.ExternalModel();
      //expect(instance).to.be();
    });
