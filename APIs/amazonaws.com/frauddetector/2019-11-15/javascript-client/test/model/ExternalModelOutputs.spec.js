...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonFraudDetector.ExternalModelOutputs();
  });
  ...
  describe('ExternalModelOutputs', function() {
    it('should create an instance of ExternalModelOutputs', function() {
      // uncomment below and update the code to test ExternalModelOutputs
      //var instance = new AmazonFraudDetector.ExternalModelOutputs();
      //expect(instance).to.be.a(AmazonFraudDetector.ExternalModelOutputs);
    });

    it('should have the property externalModel (base name: "externalModel")', function() {
      // uncomment below and update the code to test the property externalModel
      //var instance = new AmazonFraudDetector.ExternalModelOutputs();
