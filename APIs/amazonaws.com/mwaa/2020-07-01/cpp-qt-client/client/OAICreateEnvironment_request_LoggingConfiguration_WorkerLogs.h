...
/*
 * OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs.h
 *
 * 
 */

#ifndef OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs_H
#define OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs_H
...
class OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs : public OAIObject {
public:
    OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs();
    OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs(QString json);
    ~OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs)

#endif // OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs_H
