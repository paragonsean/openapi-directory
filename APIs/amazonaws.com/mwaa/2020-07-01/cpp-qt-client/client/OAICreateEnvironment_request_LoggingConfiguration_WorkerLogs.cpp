...
OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs() {
    this->initializeModel();
}

OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::~OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs() {}

void OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::initializeModel() {
...
void OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::fromJson(QString jsonString) {
...
void OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::fromJsonObject(QJsonObject json) {
...
QString OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::asJson() const {
...
QJsonObject OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::getEnabled() const {
    return m_enabled;
}
void OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::is_enabled_Valid() const{
    return m_enabled_isValid;
}

OAILoggingLevel OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::getLogLevel() const {
    return m_log_level;
}
void OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::setLogLevel(const OAILoggingLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::is_log_level_Valid() const{
    return m_log_level_isValid;
}

bool OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::isSet() const {
...
bool OAICreateEnvironment_request_LoggingConfiguration_WorkerLogs::isValid() const {
