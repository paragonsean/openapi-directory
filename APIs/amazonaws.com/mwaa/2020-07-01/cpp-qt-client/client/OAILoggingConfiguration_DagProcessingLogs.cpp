...
OAILoggingConfiguration_DagProcessingLogs::OAILoggingConfiguration_DagProcessingLogs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoggingConfiguration_DagProcessingLogs::OAILoggingConfiguration_DagProcessingLogs() {
    this->initializeModel();
}

OAILoggingConfiguration_DagProcessingLogs::~OAILoggingConfiguration_DagProcessingLogs() {}

void OAILoggingConfiguration_DagProcessingLogs::initializeModel() {
...
void OAILoggingConfiguration_DagProcessingLogs::fromJson(QString jsonString) {
...
void OAILoggingConfiguration_DagProcessingLogs::fromJsonObject(QJsonObject json) {
...
QString OAILoggingConfiguration_DagProcessingLogs::asJson() const {
...
QJsonObject OAILoggingConfiguration_DagProcessingLogs::asJsonObject() const {
    QJsonObject obj;
...
QString OAILoggingConfiguration_DagProcessingLogs::getCloudWatchLogGroupArn() const {
    return m_cloud_watch_log_group_arn;
}
void OAILoggingConfiguration_DagProcessingLogs::setCloudWatchLogGroupArn(const QString &cloud_watch_log_group_arn) {
    m_cloud_watch_log_group_arn = cloud_watch_log_group_arn;
    m_cloud_watch_log_group_arn_isSet = true;
}

bool OAILoggingConfiguration_DagProcessingLogs::is_cloud_watch_log_group_arn_Set() const{
    return m_cloud_watch_log_group_arn_isSet;
}

bool OAILoggingConfiguration_DagProcessingLogs::is_cloud_watch_log_group_arn_Valid() const{
    return m_cloud_watch_log_group_arn_isValid;
}

bool OAILoggingConfiguration_DagProcessingLogs::getEnabled() const {
    return m_enabled;
}
void OAILoggingConfiguration_DagProcessingLogs::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAILoggingConfiguration_DagProcessingLogs::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAILoggingConfiguration_DagProcessingLogs::is_enabled_Valid() const{
    return m_enabled_isValid;
}

OAILoggingLevel OAILoggingConfiguration_DagProcessingLogs::getLogLevel() const {
    return m_log_level;
}
void OAILoggingConfiguration_DagProcessingLogs::setLogLevel(const OAILoggingLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAILoggingConfiguration_DagProcessingLogs::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAILoggingConfiguration_DagProcessingLogs::is_log_level_Valid() const{
    return m_log_level_isValid;
}

bool OAILoggingConfiguration_DagProcessingLogs::isSet() const {
...
bool OAILoggingConfiguration_DagProcessingLogs::isValid() const {
