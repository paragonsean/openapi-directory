...
/*
 * OAIListEnvironmentsOutput.h
 *
 * 
 */

#ifndef OAIListEnvironmentsOutput_H
#define OAIListEnvironmentsOutput_H
...
class OAIListEnvironmentsOutput : public OAIObject {
public:
    OAIListEnvironmentsOutput();
    OAIListEnvironmentsOutput(QString json);
    ~OAIListEnvironmentsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEnvironmentsOutput)

#endif // OAIListEnvironmentsOutput_H
