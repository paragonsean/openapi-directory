...
/*
 * OAILoggingConfiguration_DagProcessingLogs.h
 *
 * 
 */

#ifndef OAILoggingConfiguration_DagProcessingLogs_H
#define OAILoggingConfiguration_DagProcessingLogs_H
...
class OAILoggingConfiguration_DagProcessingLogs : public OAIObject {
public:
    OAILoggingConfiguration_DagProcessingLogs();
    OAILoggingConfiguration_DagProcessingLogs(QString json);
    ~OAILoggingConfiguration_DagProcessingLogs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoggingConfiguration_DagProcessingLogs)

#endif // OAILoggingConfiguration_DagProcessingLogs_H
