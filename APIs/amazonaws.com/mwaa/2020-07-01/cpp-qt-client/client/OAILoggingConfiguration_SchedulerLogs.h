...
/*
 * OAILoggingConfiguration_SchedulerLogs.h
 *
 * 
 */

#ifndef OAILoggingConfiguration_SchedulerLogs_H
#define OAILoggingConfiguration_SchedulerLogs_H
...
class OAILoggingConfiguration_SchedulerLogs : public OAIObject {
public:
    OAILoggingConfiguration_SchedulerLogs();
    OAILoggingConfiguration_SchedulerLogs(QString json);
    ~OAILoggingConfiguration_SchedulerLogs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoggingConfiguration_SchedulerLogs)

#endif // OAILoggingConfiguration_SchedulerLogs_H
