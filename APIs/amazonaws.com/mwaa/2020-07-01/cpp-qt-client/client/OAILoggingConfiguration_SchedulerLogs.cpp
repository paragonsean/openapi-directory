...
OAILoggingConfiguration_SchedulerLogs::OAILoggingConfiguration_SchedulerLogs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoggingConfiguration_SchedulerLogs::OAILoggingConfiguration_SchedulerLogs() {
    this->initializeModel();
}

OAILoggingConfiguration_SchedulerLogs::~OAILoggingConfiguration_SchedulerLogs() {}

void OAILoggingConfiguration_SchedulerLogs::initializeModel() {
...
void OAILoggingConfiguration_SchedulerLogs::fromJson(QString jsonString) {
...
void OAILoggingConfiguration_SchedulerLogs::fromJsonObject(QJsonObject json) {
...
QString OAILoggingConfiguration_SchedulerLogs::asJson() const {
...
QJsonObject OAILoggingConfiguration_SchedulerLogs::asJsonObject() const {
    QJsonObject obj;
...
QString OAILoggingConfiguration_SchedulerLogs::getCloudWatchLogGroupArn() const {
    return m_cloud_watch_log_group_arn;
}
void OAILoggingConfiguration_SchedulerLogs::setCloudWatchLogGroupArn(const QString &cloud_watch_log_group_arn) {
    m_cloud_watch_log_group_arn = cloud_watch_log_group_arn;
    m_cloud_watch_log_group_arn_isSet = true;
}

bool OAILoggingConfiguration_SchedulerLogs::is_cloud_watch_log_group_arn_Set() const{
    return m_cloud_watch_log_group_arn_isSet;
}

bool OAILoggingConfiguration_SchedulerLogs::is_cloud_watch_log_group_arn_Valid() const{
    return m_cloud_watch_log_group_arn_isValid;
}

bool OAILoggingConfiguration_SchedulerLogs::getEnabled() const {
    return m_enabled;
}
void OAILoggingConfiguration_SchedulerLogs::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAILoggingConfiguration_SchedulerLogs::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAILoggingConfiguration_SchedulerLogs::is_enabled_Valid() const{
    return m_enabled_isValid;
}

OAILoggingLevel OAILoggingConfiguration_SchedulerLogs::getLogLevel() const {
    return m_log_level;
}
void OAILoggingConfiguration_SchedulerLogs::setLogLevel(const OAILoggingLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAILoggingConfiguration_SchedulerLogs::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAILoggingConfiguration_SchedulerLogs::is_log_level_Valid() const{
    return m_log_level_isValid;
}

bool OAILoggingConfiguration_SchedulerLogs::isSet() const {
...
bool OAILoggingConfiguration_SchedulerLogs::isValid() const {
