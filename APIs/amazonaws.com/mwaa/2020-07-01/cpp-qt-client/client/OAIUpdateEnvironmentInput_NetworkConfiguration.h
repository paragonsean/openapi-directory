...
/*
 * OAIUpdateEnvironmentInput_NetworkConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateEnvironmentInput_NetworkConfiguration_H
#define OAIUpdateEnvironmentInput_NetworkConfiguration_H
...
class OAIUpdateEnvironmentInput_NetworkConfiguration : public OAIObject {
public:
    OAIUpdateEnvironmentInput_NetworkConfiguration();
    OAIUpdateEnvironmentInput_NetworkConfiguration(QString json);
    ~OAIUpdateEnvironmentInput_NetworkConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEnvironmentInput_NetworkConfiguration)

#endif // OAIUpdateEnvironmentInput_NetworkConfiguration_H
