...
/*
 * OAIUpdateNetworkConfigurationInput.h
 *
...
#ifndef OAIUpdateNetworkConfigurationInput_H
#define OAIUpdateNetworkConfigurationInput_H
...
class OAIUpdateNetworkConfigurationInput : public OAIObject {
public:
    OAIUpdateNetworkConfigurationInput();
    OAIUpdateNetworkConfigurationInput(QString json);
    ~OAIUpdateNetworkConfigurationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkConfigurationInput)

#endif // OAIUpdateNetworkConfigurationInput_H
