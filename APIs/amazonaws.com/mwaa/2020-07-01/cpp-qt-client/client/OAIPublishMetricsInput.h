...
/*
 * OAIPublishMetricsInput.h
 *
 * 
 */

#ifndef OAIPublishMetricsInput_H
#define OAIPublishMetricsInput_H
...
class OAIPublishMetricsInput : public OAIObject {
public:
    OAIPublishMetricsInput();
    OAIPublishMetricsInput(QString json);
    ~OAIPublishMetricsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishMetricsInput)

#endif // OAIPublishMetricsInput_H
