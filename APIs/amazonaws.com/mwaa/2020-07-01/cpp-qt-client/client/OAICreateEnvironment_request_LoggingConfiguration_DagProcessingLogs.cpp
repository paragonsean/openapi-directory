...
OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs() {
    this->initializeModel();
}

OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::~OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs() {}

void OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::initializeModel() {
...
void OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::fromJson(QString jsonString) {
...
void OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::fromJsonObject(QJsonObject json) {
...
QString OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::asJson() const {
...
QJsonObject OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::getEnabled() const {
    return m_enabled;
}
void OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::is_enabled_Valid() const{
    return m_enabled_isValid;
}

OAILoggingLevel OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::getLogLevel() const {
    return m_log_level;
}
void OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::setLogLevel(const OAILoggingLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::is_log_level_Valid() const{
    return m_log_level_isValid;
}

bool OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::isSet() const {
...
bool OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs::isValid() const {
