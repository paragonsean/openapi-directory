...
#include "OAIUpdateNetworkConfigurationInput.h"
...
OAIUpdateNetworkConfigurationInput::OAIUpdateNetworkConfigurationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateNetworkConfigurationInput::OAIUpdateNetworkConfigurationInput() {
    this->initializeModel();
}

OAIUpdateNetworkConfigurationInput::~OAIUpdateNetworkConfigurationInput() {}

void OAIUpdateNetworkConfigurationInput::initializeModel() {

    m_security_group_ids_isSet = false;
    m_security_group_ids_isValid = false;
}

void OAIUpdateNetworkConfigurationInput::fromJson(QString jsonString) {
...
void OAIUpdateNetworkConfigurationInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateNetworkConfigurationInput::asJson() const {
...
QJsonObject OAIUpdateNetworkConfigurationInput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateNetworkConfigurationInput::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIUpdateNetworkConfigurationInput::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIUpdateNetworkConfigurationInput::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIUpdateNetworkConfigurationInput::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

bool OAIUpdateNetworkConfigurationInput::isSet() const {
...
bool OAIUpdateNetworkConfigurationInput::isValid() const {
