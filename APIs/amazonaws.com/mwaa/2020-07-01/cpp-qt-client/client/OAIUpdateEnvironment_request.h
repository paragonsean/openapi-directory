...
/*
 * OAIUpdateEnvironment_request.h
 *
 * 
 */

#ifndef OAIUpdateEnvironment_request_H
#define OAIUpdateEnvironment_request_H
...
namespace OpenAPI {
class OAICreateEnvironment_request_LoggingConfiguration;
class OAIUpdateEnvironment_request_NetworkConfiguration;

class OAIUpdateEnvironment_request : public OAIObject {
public:
    OAIUpdateEnvironment_request();
    OAIUpdateEnvironment_request(QString json);
    ~OAIUpdateEnvironment_request() override;
    ...
    QMap<QString, QString> getAirflowConfigurationOptions() const;
    void setAirflowConfigurationOptions(const QMap<QString, QString> &airflow_configuration_options);
    ...
    OAICreateEnvironment_request_LoggingConfiguration getLoggingConfiguration() const;
    void setLoggingConfiguration(const OAICreateEnvironment_request_LoggingConfiguration &logging_configuration);
    ...
    OAIUpdateEnvironment_request_NetworkConfiguration getNetworkConfiguration() const;
    void setNetworkConfiguration(const OAIUpdateEnvironment_request_NetworkConfiguration &network_configuration);
    ...
    QString getWebserverAccessMode() const;
    void setWebserverAccessMode(const QString &webserver_access_mode);
...
private:
    ...
    QMap<QString, QString> m_airflow_configuration_options;
    ...
    OAICreateEnvironment_request_LoggingConfiguration m_logging_configuration;
    ...
    OAIUpdateEnvironment_request_NetworkConfiguration m_network_configuration;
    ...
    QString m_webserver_access_mode;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEnvironment_request)

#endif // OAIUpdateEnvironment_request_H
