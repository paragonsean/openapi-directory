...
#include "OAIModuleLoggingConfiguration.h"
...
OAIModuleLoggingConfiguration::OAIModuleLoggingConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIModuleLoggingConfiguration::OAIModuleLoggingConfiguration() {
    this->initializeModel();
}

OAIModuleLoggingConfiguration::~OAIModuleLoggingConfiguration() {}

void OAIModuleLoggingConfiguration::initializeModel() {
...
void OAIModuleLoggingConfiguration::fromJson(QString jsonString) {
...
void OAIModuleLoggingConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIModuleLoggingConfiguration::asJson() const {
...
QJsonObject OAIModuleLoggingConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIModuleLoggingConfiguration::getCloudWatchLogGroupArn() const {
    return m_cloud_watch_log_group_arn;
}
void OAIModuleLoggingConfiguration::setCloudWatchLogGroupArn(const QString &cloud_watch_log_group_arn) {
    m_cloud_watch_log_group_arn = cloud_watch_log_group_arn;
    m_cloud_watch_log_group_arn_isSet = true;
}

bool OAIModuleLoggingConfiguration::is_cloud_watch_log_group_arn_Set() const{
    return m_cloud_watch_log_group_arn_isSet;
}

bool OAIModuleLoggingConfiguration::is_cloud_watch_log_group_arn_Valid() const{
    return m_cloud_watch_log_group_arn_isValid;
}

bool OAIModuleLoggingConfiguration::getEnabled() const {
    return m_enabled;
}
void OAIModuleLoggingConfiguration::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIModuleLoggingConfiguration::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIModuleLoggingConfiguration::is_enabled_Valid() const{
    return m_enabled_isValid;
}

OAILoggingLevel OAIModuleLoggingConfiguration::getLogLevel() const {
    return m_log_level;
}
void OAIModuleLoggingConfiguration::setLogLevel(const OAILoggingLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAIModuleLoggingConfiguration::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAIModuleLoggingConfiguration::is_log_level_Valid() const{
    return m_log_level_isValid;
}

bool OAIModuleLoggingConfiguration::isSet() const {
...
bool OAIModuleLoggingConfiguration::isValid() const {
