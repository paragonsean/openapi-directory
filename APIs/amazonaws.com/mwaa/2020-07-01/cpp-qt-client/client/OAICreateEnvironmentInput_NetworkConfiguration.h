...
/*
 * OAICreateEnvironmentInput_NetworkConfiguration.h
 *
 * 
 */

#ifndef OAICreateEnvironmentInput_NetworkConfiguration_H
#define OAICreateEnvironmentInput_NetworkConfiguration_H
...
class OAICreateEnvironmentInput_NetworkConfiguration : public OAIObject {
public:
    OAICreateEnvironmentInput_NetworkConfiguration();
    OAICreateEnvironmentInput_NetworkConfiguration(QString json);
    ~OAICreateEnvironmentInput_NetworkConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEnvironmentInput_NetworkConfiguration)

#endif // OAICreateEnvironmentInput_NetworkConfiguration_H
