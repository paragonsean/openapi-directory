...
/*
 * OAIGetEnvironmentOutput.h
 *
 * 
 */

#ifndef OAIGetEnvironmentOutput_H
#define OAIGetEnvironmentOutput_H
...
namespace OpenAPI {
class OAIGetEnvironmentOutput_Environment;

class OAIGetEnvironmentOutput : public OAIObject {
public:
    OAIGetEnvironmentOutput();
    OAIGetEnvironmentOutput(QString json);
    ~OAIGetEnvironmentOutput() override;
    ...
    OAIGetEnvironmentOutput_Environment getEnvironment() const;
    void setEnvironment(const OAIGetEnvironmentOutput_Environment &environment);
...
private:
    ...
    OAIGetEnvironmentOutput_Environment m_environment;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEnvironmentOutput)

#endif // OAIGetEnvironmentOutput_H
