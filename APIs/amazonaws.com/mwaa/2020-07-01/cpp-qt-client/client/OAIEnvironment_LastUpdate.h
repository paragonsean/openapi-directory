...
/*
 * OAIEnvironment_LastUpdate.h
 *
 * 
 */

#ifndef OAIEnvironment_LastUpdate_H
#define OAIEnvironment_LastUpdate_H
...
class OAIEnvironment_LastUpdate : public OAIObject {
public:
    OAIEnvironment_LastUpdate();
    OAIEnvironment_LastUpdate(QString json);
    ~OAIEnvironment_LastUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnvironment_LastUpdate)

#endif // OAIEnvironment_LastUpdate_H
