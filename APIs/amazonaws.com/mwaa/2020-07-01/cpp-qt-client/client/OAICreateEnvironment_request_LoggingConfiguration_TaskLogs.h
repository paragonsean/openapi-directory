...
/*
 * OAICreateEnvironment_request_LoggingConfiguration_TaskLogs.h
 *
 * 
 */

#ifndef OAICreateEnvironment_request_LoggingConfiguration_TaskLogs_H
#define OAICreateEnvironment_request_LoggingConfiguration_TaskLogs_H
...
class OAICreateEnvironment_request_LoggingConfiguration_TaskLogs : public OAIObject {
public:
    OAICreateEnvironment_request_LoggingConfiguration_TaskLogs();
    OAICreateEnvironment_request_LoggingConfiguration_TaskLogs(QString json);
    ~OAICreateEnvironment_request_LoggingConfiguration_TaskLogs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEnvironment_request_LoggingConfiguration_TaskLogs)

#endif // OAICreateEnvironment_request_LoggingConfiguration_TaskLogs_H
