...
/*
 * OAICreateWebLoginTokenResponse.h
 *
 * 
 */

#ifndef OAICreateWebLoginTokenResponse_H
#define OAICreateWebLoginTokenResponse_H
...
class OAICreateWebLoginTokenResponse : public OAIObject {
public:
    OAICreateWebLoginTokenResponse();
    OAICreateWebLoginTokenResponse(QString json);
    ~OAICreateWebLoginTokenResponse() override;
    ...
    void setWebToken(const QString &web_token);
    bool is_web_token_Set() const;
    bool is_web_token_Valid() const;
...
private:
    ...
    QString m_web_token;
    bool m_web_token_isSet;
    bool m_web_token_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateWebLoginTokenResponse)

#endif // OAICreateWebLoginTokenResponse_H
