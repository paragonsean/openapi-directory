...
/*
 * OAICreateCliTokenResponse.h
 *
 * 
 */

#ifndef OAICreateCliTokenResponse_H
#define OAICreateCliTokenResponse_H
...
class OAICreateCliTokenResponse : public OAIObject {
public:
    OAICreateCliTokenResponse();
    OAICreateCliTokenResponse(QString json);
    ~OAICreateCliTokenResponse() override;
    ...
    QString getCliToken() const;
    void setCliToken(const QString &cli_token);
    bool is_cli_token_Set() const;
    bool is_cli_token_Valid() const;

    QString getWebServerHostname() const;
    void setWebServerHostname(const QString &web_server_hostname);
    bool is_web_server_hostname_Set() const;
    bool is_web_server_hostname_Valid() const;
...
private:
    ...
    QString m_cli_token;
    bool m_cli_token_isSet;
    bool m_cli_token_isValid;

    QString m_web_server_hostname;
    bool m_web_server_hostname_isSet;
    bool m_web_server_hostname_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateCliTokenResponse)

#endif // OAICreateCliTokenResponse_H
