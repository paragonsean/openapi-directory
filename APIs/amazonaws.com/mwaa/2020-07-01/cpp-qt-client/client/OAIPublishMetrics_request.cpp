...
OAIPublishMetrics_request::OAIPublishMetrics_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPublishMetrics_request::OAIPublishMetrics_request() {
    this->initializeModel();
}

OAIPublishMetrics_request::~OAIPublishMetrics_request() {}

void OAIPublishMetrics_request::initializeModel() {

    m_metric_data_isSet = false;
    m_metric_data_isValid = false;
}

void OAIPublishMetrics_request::fromJson(QString jsonString) {
...
void OAIPublishMetrics_request::fromJsonObject(QJsonObject json) {
...
QString OAIPublishMetrics_request::asJson() const {
...
QJsonObject OAIPublishMetrics_request::asJsonObject() const {
    QJsonObject obj;
    if (m_metric_data.size() > 0) {
        obj.insert(QString("MetricData"), ::OpenAPI::toJsonValue(m_metric_data));
    }
    return obj;
}

QList<OAIMetricDatum> OAIPublishMetrics_request::getMetricData() const {
    return m_metric_data;
}
void OAIPublishMetrics_request::setMetricData(const QList<OAIMetricDatum> &metric_data) {
    m_metric_data = metric_data;
    m_metric_data_isSet = true;
}

bool OAIPublishMetrics_request::is_metric_data_Set() const{
    return m_metric_data_isSet;
}

bool OAIPublishMetrics_request::is_metric_data_Valid() const{
    return m_metric_data_isValid;
}

bool OAIPublishMetrics_request::isSet() const {
...
bool OAIPublishMetrics_request::isValid() const {
