...
/*
 * OAILoggingConfiguration_WorkerLogs.h
 *
 * 
 */

#ifndef OAILoggingConfiguration_WorkerLogs_H
#define OAILoggingConfiguration_WorkerLogs_H
...
class OAILoggingConfiguration_WorkerLogs : public OAIObject {
public:
    OAILoggingConfiguration_WorkerLogs();
    OAILoggingConfiguration_WorkerLogs(QString json);
    ~OAILoggingConfiguration_WorkerLogs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoggingConfiguration_WorkerLogs)

#endif // OAILoggingConfiguration_WorkerLogs_H
