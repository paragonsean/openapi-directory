...
/*
 * OAILoggingConfiguration_WebserverLogs.h
 *
 * 
 */

#ifndef OAILoggingConfiguration_WebserverLogs_H
#define OAILoggingConfiguration_WebserverLogs_H
...
class OAILoggingConfiguration_WebserverLogs : public OAIObject {
public:
    OAILoggingConfiguration_WebserverLogs();
    OAILoggingConfiguration_WebserverLogs(QString json);
    ~OAILoggingConfiguration_WebserverLogs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoggingConfiguration_WebserverLogs)

#endif // OAILoggingConfiguration_WebserverLogs_H
