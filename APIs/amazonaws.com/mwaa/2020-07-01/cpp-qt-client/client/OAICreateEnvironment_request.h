...
#include "OAICreateEnvironment_request_NetworkConfiguration.h"
#include <QMap>
#include <QString>
...
class OAICreateEnvironment_request_NetworkConfiguration;
...
public:
    ...
    OAICreateEnvironment_request_NetworkConfiguration getNetworkConfiguration() const;
    void setNetworkConfiguration(const OAICreateEnvironment_request_NetworkConfiguration &network_configuration);
...
private:
    ...
    OAICreateEnvironment_request_NetworkConfiguration m_network_configuration;
