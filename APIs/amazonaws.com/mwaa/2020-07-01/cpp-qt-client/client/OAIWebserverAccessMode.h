...
/*
 * OAIWebserverAccessMode.h
 *
 * 
 */

#ifndef OAIWebserverAccessMode_H
#define OAIWebserverAccessMode_H
...
class OAIWebserverAccessMode : public OAIEnum {
public:
    OAIWebserverAccessMode();
    OAIWebserverAccessMode(QString json);
    ~OAIWebserverAccessMode() override;
    ...
    enum class eOAIWebserverAccessMode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PRIVATE_ONLY, 
        PUBLIC_ONLY
    };
    OAIWebserverAccessMode::eOAIWebserverAccessMode getValue() const;
    void setValue(const OAIWebserverAccessMode::eOAIWebserverAccessMode& value);
...
private:
    ...
    eOAIWebserverAccessMode m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebserverAccessMode)

#endif // OAIWebserverAccessMode_H
