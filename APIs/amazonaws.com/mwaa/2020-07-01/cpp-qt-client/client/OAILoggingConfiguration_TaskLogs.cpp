...
OAILoggingConfiguration_TaskLogs::OAILoggingConfiguration_TaskLogs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoggingConfiguration_TaskLogs::OAILoggingConfiguration_TaskLogs() {
    this->initializeModel();
}

OAILoggingConfiguration_TaskLogs::~OAILoggingConfiguration_TaskLogs() {}

void OAILoggingConfiguration_TaskLogs::initializeModel() {
...
void OAILoggingConfiguration_TaskLogs::fromJson(QString jsonString) {
...
void OAILoggingConfiguration_TaskLogs::fromJsonObject(QJsonObject json) {
...
QString OAILoggingConfiguration_TaskLogs::asJson() const {
...
QJsonObject OAILoggingConfiguration_TaskLogs::asJsonObject() const {
    QJsonObject obj;
...
QString OAILoggingConfiguration_TaskLogs::getCloudWatchLogGroupArn() const {
    return m_cloud_watch_log_group_arn;
}
void OAILoggingConfiguration_TaskLogs::setCloudWatchLogGroupArn(const QString &cloud_watch_log_group_arn) {
    m_cloud_watch_log_group_arn = cloud_watch_log_group_arn;
    m_cloud_watch_log_group_arn_isSet = true;
}

bool OAILoggingConfiguration_TaskLogs::is_cloud_watch_log_group_arn_Set() const{
    return m_cloud_watch_log_group_arn_isSet;
}

bool OAILoggingConfiguration_TaskLogs::is_cloud_watch_log_group_arn_Valid() const{
    return m_cloud_watch_log_group_arn_isValid;
}

bool OAILoggingConfiguration_TaskLogs::getEnabled() const {
    return m_enabled;
}
void OAILoggingConfiguration_TaskLogs::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAILoggingConfiguration_TaskLogs::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAILoggingConfiguration_TaskLogs::is_enabled_Valid() const{
    return m_enabled_isValid;
}

OAILoggingLevel OAILoggingConfiguration_TaskLogs::getLogLevel() const {
    return m_log_level;
}
void OAILoggingConfiguration_TaskLogs::setLogLevel(const OAILoggingLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAILoggingConfiguration_TaskLogs::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAILoggingConfiguration_TaskLogs::is_log_level_Valid() const{
    return m_log_level_isValid;
}

bool OAILoggingConfiguration_TaskLogs::isSet() const {
...
bool OAILoggingConfiguration_TaskLogs::isValid() const {
