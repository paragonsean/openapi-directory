...
#include "OAIEnvironment_NetworkConfiguration.h"
...
OAIEnvironment_NetworkConfiguration::OAIEnvironment_NetworkConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnvironment_NetworkConfiguration::OAIEnvironment_NetworkConfiguration() {
    this->initializeModel();
}

OAIEnvironment_NetworkConfiguration::~OAIEnvironment_NetworkConfiguration() {}

void OAIEnvironment_NetworkConfiguration::initializeModel() {
...
void OAIEnvironment_NetworkConfiguration::fromJson(QString jsonString) {
...
void OAIEnvironment_NetworkConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIEnvironment_NetworkConfiguration::asJson() const {
...
QJsonObject OAIEnvironment_NetworkConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIEnvironment_NetworkConfiguration::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIEnvironment_NetworkConfiguration::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIEnvironment_NetworkConfiguration::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIEnvironment_NetworkConfiguration::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

QList OAIEnvironment_NetworkConfiguration::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIEnvironment_NetworkConfiguration::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIEnvironment_NetworkConfiguration::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIEnvironment_NetworkConfiguration::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

bool OAIEnvironment_NetworkConfiguration::isSet() const {
...
bool OAIEnvironment_NetworkConfiguration::isValid() const {
