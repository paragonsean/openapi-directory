...
/*
 * OAIUpdateEnvironmentOutput.h
 *
 * 
 */

#ifndef OAIUpdateEnvironmentOutput_H
#define OAIUpdateEnvironmentOutput_H
...
class OAIUpdateEnvironmentOutput : public OAIObject {
public:
    OAIUpdateEnvironmentOutput();
    OAIUpdateEnvironmentOutput(QString json);
    ~OAIUpdateEnvironmentOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEnvironmentOutput)

#endif // OAIUpdateEnvironmentOutput_H
