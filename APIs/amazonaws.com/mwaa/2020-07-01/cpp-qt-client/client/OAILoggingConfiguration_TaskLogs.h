...
/*
 * OAILoggingConfiguration_TaskLogs.h
 *
 * 
 */

#ifndef OAILoggingConfiguration_TaskLogs_H
#define OAILoggingConfiguration_TaskLogs_H
...
class OAILoggingConfiguration_TaskLogs : public OAIObject {
public:
    OAILoggingConfiguration_TaskLogs();
    OAILoggingConfiguration_TaskLogs(QString json);
    ~OAILoggingConfiguration_TaskLogs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoggingConfiguration_TaskLogs)

#endif // OAILoggingConfiguration_TaskLogs_H
