...
namespace OpenAPI {
class OAICreateEnvironmentInput_LoggingConfiguration;
class OAICreateEnvironmentInput_NetworkConfiguration;
...
public:
    ...
    OAICreateEnvironmentInput_LoggingConfiguration getLoggingConfiguration() const;
    void setLoggingConfiguration(const OAICreateEnvironmentInput_LoggingConfiguration &logging_configuration);
    ...
    OAICreateEnvironmentInput_NetworkConfiguration getNetworkConfiguration() const;
    void setNetworkConfiguration(const OAICreateEnvironmentInput_NetworkConfiguration &network_configuration);
...
private:
    ...
    OAICreateEnvironmentInput_LoggingConfiguration m_logging_configuration;
    ...
    OAICreateEnvironmentInput_NetworkConfiguration m_network_configuration;
