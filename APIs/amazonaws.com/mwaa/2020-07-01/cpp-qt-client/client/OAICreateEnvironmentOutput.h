...
/*
 * OAICreateEnvironmentOutput.h
 *
 * 
 */

#ifndef OAICreateEnvironmentOutput_H
#define OAICreateEnvironmentOutput_H
...
class OAICreateEnvironmentOutput : public OAIObject {
public:
    OAICreateEnvironmentOutput();
    OAICreateEnvironmentOutput(QString json);
    ~OAICreateEnvironmentOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEnvironmentOutput)

#endif // OAICreateEnvironmentOutput_H
