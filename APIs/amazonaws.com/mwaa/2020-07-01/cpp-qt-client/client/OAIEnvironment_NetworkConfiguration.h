...
/*
 * OAIEnvironment_NetworkConfiguration.h
 *
 * 
 */

#ifndef OAIEnvironment_NetworkConfiguration_H
#define OAIEnvironment_NetworkConfiguration_H
...
class OAIEnvironment_NetworkConfiguration : public OAIObject {
public:
    OAIEnvironment_NetworkConfiguration();
    OAIEnvironment_NetworkConfiguration(QString json);
    ~OAIEnvironment_NetworkConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnvironment_NetworkConfiguration)

#endif // OAIEnvironment_NetworkConfiguration_H
