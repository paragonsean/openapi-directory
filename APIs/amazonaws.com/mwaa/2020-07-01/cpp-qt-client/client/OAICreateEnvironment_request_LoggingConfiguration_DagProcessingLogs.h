...
/*
 * OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs.h
 *
 * 
 */

#ifndef OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs_H
#define OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs_H
...
class OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs : public OAIObject {
public:
    OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs();
    OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs(QString json);
    ~OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs)

#endif // OAICreateEnvironment_request_LoggingConfiguration_DagProcessingLogs_H
