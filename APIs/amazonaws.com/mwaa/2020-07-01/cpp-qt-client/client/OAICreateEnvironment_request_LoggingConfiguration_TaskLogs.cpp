...
OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::OAICreateEnvironment_request_LoggingConfiguration_TaskLogs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::OAICreateEnvironment_request_LoggingConfiguration_TaskLogs() {
    this->initializeModel();
}

OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::~OAICreateEnvironment_request_LoggingConfiguration_TaskLogs() {}

void OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::initializeModel() {
...
void OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::fromJson(QString jsonString) {
...
void OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::fromJsonObject(QJsonObject json) {
...
QString OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::asJson() const {
...
QJsonObject OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::getEnabled() const {
    return m_enabled;
}
void OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::is_enabled_Valid() const{
    return m_enabled_isValid;
}

OAILoggingLevel OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::getLogLevel() const {
    return m_log_level;
}
void OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::setLogLevel(const OAILoggingLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::is_log_level_Valid() const{
    return m_log_level_isValid;
}

bool OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::isSet() const {
...
bool OAICreateEnvironment_request_LoggingConfiguration_TaskLogs::isValid() const {
