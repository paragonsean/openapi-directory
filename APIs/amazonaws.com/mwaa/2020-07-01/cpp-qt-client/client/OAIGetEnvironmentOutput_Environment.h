...
namespace OpenAPI {
class OAIEnvironment_LastUpdate;
class OAIEnvironment_LoggingConfiguration;
class OAIEnvironment_NetworkConfiguration;
...
public:
    ...
    OAIEnvironment_LastUpdate getLastUpdate() const;
    void setLastUpdate(const OAIEnvironment_LastUpdate &last_update);
    bool is_last_update_Set() const;
    bool is_last_update_Valid() const;

    OAIEnvironment_LoggingConfiguration getLoggingConfiguration() const;
    void setLoggingConfiguration(const OAIEnvironment_LoggingConfiguration &logging_configuration);
    ...
    OAIEnvironment_NetworkConfiguration getNetworkConfiguration() const;
    void setNetworkConfiguration(const OAIEnvironment_NetworkConfiguration &network_configuration);
    ...
    QString getWebserverUrl() const;
    void setWebserverUrl(const QString &webserver_url);
    bool is_webserver_url_Set() const;
    bool is_webserver_url_Valid() const;
...
private:
    ...
    OAIEnvironment_LastUpdate m_last_update;
    bool m_last_update_isSet;
    bool m_last_update_isValid;

    OAIEnvironment_LoggingConfiguration m_logging_configuration;
    ...
    OAIEnvironment_NetworkConfiguration m_network_configuration;
    ...
    QString m_webserver_url;
    bool m_webserver_url_isSet;
    bool m_webserver_url_isValid;
