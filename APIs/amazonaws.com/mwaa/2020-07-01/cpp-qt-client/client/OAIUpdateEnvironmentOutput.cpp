...
OAIUpdateEnvironmentOutput::OAIUpdateEnvironmentOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateEnvironmentOutput::OAIUpdateEnvironmentOutput() {
    this->initializeModel();
}

OAIUpdateEnvironmentOutput::~OAIUpdateEnvironmentOutput() {}

void OAIUpdateEnvironmentOutput::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIUpdateEnvironmentOutput::fromJson(QString jsonString) {
...
void OAIUpdateEnvironmentOutput::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAIUpdateEnvironmentOutput::asJson() const {
...
QJsonObject OAIUpdateEnvironmentOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIUpdateEnvironmentOutput::getArn() const {
    return m_arn;
}
void OAIUpdateEnvironmentOutput::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateEnvironmentOutput::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateEnvironmentOutput::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIUpdateEnvironmentOutput::isSet() const {
...
bool OAIUpdateEnvironmentOutput::isValid() const {
