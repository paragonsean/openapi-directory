...
OAILoggingConfiguration_WorkerLogs::OAILoggingConfiguration_WorkerLogs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoggingConfiguration_WorkerLogs::OAILoggingConfiguration_WorkerLogs() {
    this->initializeModel();
}

OAILoggingConfiguration_WorkerLogs::~OAILoggingConfiguration_WorkerLogs() {}

void OAILoggingConfiguration_WorkerLogs::initializeModel() {
...
void OAILoggingConfiguration_WorkerLogs::fromJson(QString jsonString) {
...
void OAILoggingConfiguration_WorkerLogs::fromJsonObject(QJsonObject json) {
...
QString OAILoggingConfiguration_WorkerLogs::asJson() const {
...
QJsonObject OAILoggingConfiguration_WorkerLogs::asJsonObject() const {
    QJsonObject obj;
...
QString OAILoggingConfiguration_WorkerLogs::getCloudWatchLogGroupArn() const {
    return m_cloud_watch_log_group_arn;
}
void OAILoggingConfiguration_WorkerLogs::setCloudWatchLogGroupArn(const QString &cloud_watch_log_group_arn) {
    m_cloud_watch_log_group_arn = cloud_watch_log_group_arn;
    m_cloud_watch_log_group_arn_isSet = true;
}

bool OAILoggingConfiguration_WorkerLogs::is_cloud_watch_log_group_arn_Set() const{
    return m_cloud_watch_log_group_arn_isSet;
}

bool OAILoggingConfiguration_WorkerLogs::is_cloud_watch_log_group_arn_Valid() const{
    return m_cloud_watch_log_group_arn_isValid;
}

bool OAILoggingConfiguration_WorkerLogs::getEnabled() const {
    return m_enabled;
}
void OAILoggingConfiguration_WorkerLogs::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAILoggingConfiguration_WorkerLogs::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAILoggingConfiguration_WorkerLogs::is_enabled_Valid() const{
    return m_enabled_isValid;
}

OAILoggingLevel OAILoggingConfiguration_WorkerLogs::getLogLevel() const {
    return m_log_level;
}
void OAILoggingConfiguration_WorkerLogs::setLogLevel(const OAILoggingLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAILoggingConfiguration_WorkerLogs::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAILoggingConfiguration_WorkerLogs::is_log_level_Valid() const{
    return m_log_level_isValid;
}

bool OAILoggingConfiguration_WorkerLogs::isSet() const {
...
bool OAILoggingConfiguration_WorkerLogs::isValid() const {
