...
/*
 * OAICreateEnvironment_request_LoggingConfiguration_WebserverLogs.h
 *
 * 
 */

#ifndef OAICreateEnvironment_request_LoggingConfiguration_WebserverLogs_H
#define OAICreateEnvironment_request_LoggingConfiguration_WebserverLogs_H
...
class OAICreateEnvironment_request_LoggingConfiguration_WebserverLogs : public OAIObject {
public:
    OAICreateEnvironment_request_LoggingConfiguration_WebserverLogs();
    OAICreateEnvironment_request_LoggingConfiguration_WebserverLogs(QString json);
    ~OAICreateEnvironment_request_LoggingConfiguration_WebserverLogs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEnvironment_request_LoggingConfiguration_WebserverLogs)

#endif // OAICreateEnvironment_request_LoggingConfiguration_WebserverLogs_H
