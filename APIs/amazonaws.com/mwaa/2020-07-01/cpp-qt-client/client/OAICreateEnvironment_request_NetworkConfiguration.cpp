...
OAICreateEnvironment_request_NetworkConfiguration::OAICreateEnvironment_request_NetworkConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateEnvironment_request_NetworkConfiguration::OAICreateEnvironment_request_NetworkConfiguration() {
    this->initializeModel();
}

OAICreateEnvironment_request_NetworkConfiguration::~OAICreateEnvironment_request_NetworkConfiguration() {}

void OAICreateEnvironment_request_NetworkConfiguration::initializeModel() {
...
void OAICreateEnvironment_request_NetworkConfiguration::fromJson(QString jsonString) {
...
void OAICreateEnvironment_request_NetworkConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateEnvironment_request_NetworkConfiguration::asJson() const {
...
QJsonObject OAICreateEnvironment_request_NetworkConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAICreateEnvironment_request_NetworkConfiguration::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAICreateEnvironment_request_NetworkConfiguration::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAICreateEnvironment_request_NetworkConfiguration::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAICreateEnvironment_request_NetworkConfiguration::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

QList OAICreateEnvironment_request_NetworkConfiguration::getSubnetIds() const {
    return m_subnet_ids;
}
void OAICreateEnvironment_request_NetworkConfiguration::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAICreateEnvironment_request_NetworkConfiguration::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAICreateEnvironment_request_NetworkConfiguration::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

bool OAICreateEnvironment_request_NetworkConfiguration::isSet() const {
...
bool OAICreateEnvironment_request_NetworkConfiguration::isValid() const {
