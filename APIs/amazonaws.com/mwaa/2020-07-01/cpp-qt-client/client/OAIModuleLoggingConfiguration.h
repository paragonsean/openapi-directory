...
/*
 * OAIModuleLoggingConfiguration.h
 *
 * Describes the Apache Airflow log details for the log type (e.g. &lt;code&gt;DagProcessingLogs&lt;/code&gt;).
 */

#ifndef OAIModuleLoggingConfiguration_H
#define OAIModuleLoggingConfiguration_H
...
class OAIModuleLoggingConfiguration : public OAIObject {
public:
    OAIModuleLoggingConfiguration();
    OAIModuleLoggingConfiguration(QString json);
    ~OAIModuleLoggingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModuleLoggingConfiguration)

#endif // OAIModuleLoggingConfiguration_H
