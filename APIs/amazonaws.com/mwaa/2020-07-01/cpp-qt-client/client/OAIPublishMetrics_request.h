...
/*
 * OAIPublishMetrics_request.h
 *
 * 
 */

#ifndef OAIPublishMetrics_request_H
#define OAIPublishMetrics_request_H
...
namespace OpenAPI {
class OAIMetricDatum;

class OAIPublishMetrics_request : public OAIObject {
public:
    OAIPublishMetrics_request();
    OAIPublishMetrics_request(QString json);
    ~OAIPublishMetrics_request() override;
    ...
    QList<OAIMetricDatum> getMetricData() const;
    void setMetricData(const QList<OAIMetricDatum> &metric_data);
...
private:
    ...
    QList<OAIMetricDatum> m_metric_data;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishMetrics_request)

#endif // OAIPublishMetrics_request_H
