...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createCliTokenSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createCliTokenSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString name = create(); // QString | The name of the Amazon MWAA environment. For example, <code>MyMWAAEnvironment</code>.
      ...
      apiInstance.createCliToken(namex_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
