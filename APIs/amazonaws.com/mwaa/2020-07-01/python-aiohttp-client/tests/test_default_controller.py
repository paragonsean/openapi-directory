...
async def test_create_cli_token(client):
    """Test case for create_cli_token
    ...
    response = await client.request(
        method='POST',
        path='/clitoken/{name}'.format(name='name_example'),
        headers=headers,
        )
...
async def test_create_environment(client):
    ...
    """
    body = openapi_server.CreateEnvironmentRequest()
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='PUT',
        path='/environments/{name}'.format(name='name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_web_login_token(client):
    """Test case for create_web_login_token
    ...
    response = await client.request(
        method='POST',
        path='/webtoken/{name}'.format(name='name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_publish_metrics(client):
    """Test case for publish_metrics

    
    """
    body = openapi_server.PublishMetricsRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/metrics/environments/{environment_name}'.format(environment_name='environment_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_environment(client):
    ...
    """
    body = openapi_server.UpdateEnvironmentRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
