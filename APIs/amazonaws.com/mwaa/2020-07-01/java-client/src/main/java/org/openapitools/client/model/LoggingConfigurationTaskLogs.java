...
public class LoggingConfigurationTaskLogs {
  ...
  public LoggingConfigurationTaskLogs() {
  }

  public LoggingConfigurationTaskLogs cloudWatchLogGroupArn(String cloudWatchLogGroupArn) {
  ...
  public LoggingConfigurationTaskLogs enabled(Boolean enabled) {
  ...
  public LoggingConfigurationTaskLogs logLevel(LoggingLevel logLevel) {
  ...
  public boolean equals(Object o) {
    ...
    LoggingConfigurationTaskLogs loggingConfigurationTaskLogs = (LoggingConfigurationTaskLogs) o;
    return Objects.equals(this.cloudWatchLogGroupArn, loggingConfigurationTaskLogs.cloudWatchLogGroupArn) &&
        Objects.equals(this.enabled, loggingConfigurationTaskLogs.enabled) &&
        Objects.equals(this.logLevel, loggingConfigurationTaskLogs.logLevel);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoggingConfigurationTaskLogs {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoggingConfigurationTaskLogs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoggingConfigurationTaskLogs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoggingConfigurationTaskLogs is not found in the empty JSON string", LoggingConfigurationTaskLogs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoggingConfigurationTaskLogs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoggingConfigurationTaskLogs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoggingConfigurationTaskLogs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoggingConfigurationTaskLogs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoggingConfigurationTaskLogs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoggingConfigurationTaskLogs.class));

       return (TypeAdapter<T>) new TypeAdapter<LoggingConfigurationTaskLogs>() {
           @Override
           public void write(JsonWriter out, LoggingConfigurationTaskLogs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoggingConfigurationTaskLogs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoggingConfigurationTaskLogs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoggingConfigurationTaskLogs
   * @throws IOException if the JSON string is invalid with respect to LoggingConfigurationTaskLogs
   */
  public static LoggingConfigurationTaskLogs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoggingConfigurationTaskLogs.class);
  }

  /**
   * Convert an instance of LoggingConfigurationTaskLogs to an JSON string
   *
   * @return JSON string
   */
