...
public class ModuleLoggingConfiguration {
  ...
  public ModuleLoggingConfiguration cloudWatchLogGroupArn(String cloudWatchLogGroupArn) {
  ...
  public ModuleLoggingConfiguration enabled(Boolean enabled) {
  ...
  public ModuleLoggingConfiguration logLevel(LoggingLevel logLevel) {
  ...
  public boolean equals(Object o) {
    ...
    ModuleLoggingConfiguration moduleLoggingConfiguration = (ModuleLoggingConfiguration) o;
    return Objects.equals(this.cloudWatchLogGroupArn, moduleLoggingConfiguration.cloudWatchLogGroupArn) &&
        Objects.equals(this.enabled, moduleLoggingConfiguration.enabled) &&
        Objects.equals(this.logLevel, moduleLoggingConfiguration.logLevel);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModuleLoggingConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModuleLoggingConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModuleLoggingConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModuleLoggingConfiguration is not found in the empty JSON string", ModuleLoggingConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModuleLoggingConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModuleLoggingConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModuleLoggingConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModuleLoggingConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModuleLoggingConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModuleLoggingConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ModuleLoggingConfiguration>() {
           @Override
           public void write(JsonWriter out, ModuleLoggingConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModuleLoggingConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModuleLoggingConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModuleLoggingConfiguration
   * @throws IOException if the JSON string is invalid with respect to ModuleLoggingConfiguration
   */
  public static ModuleLoggingConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModuleLoggingConfiguration.class);
  }

  /**
   * Convert an instance of ModuleLoggingConfiguration to an JSON string
   *
   * @return JSON string
   */
