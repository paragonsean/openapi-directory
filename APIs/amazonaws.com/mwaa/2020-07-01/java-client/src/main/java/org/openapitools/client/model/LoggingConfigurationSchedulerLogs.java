...
public class LoggingConfigurationSchedulerLogs {
  ...
  public LoggingConfigurationSchedulerLogs() {
  }

  public LoggingConfigurationSchedulerLogs cloudWatchLogGroupArn(String cloudWatchLogGroupArn) {
  ...
  public LoggingConfigurationSchedulerLogs enabled(Boolean enabled) {
  ...
  public LoggingConfigurationSchedulerLogs logLevel(LoggingLevel logLevel) {
  ...
  public boolean equals(Object o) {
    ...
    LoggingConfigurationSchedulerLogs loggingConfigurationSchedulerLogs = (LoggingConfigurationSchedulerLogs) o;
    return Objects.equals(this.cloudWatchLogGroupArn, loggingConfigurationSchedulerLogs.cloudWatchLogGroupArn) &&
        Objects.equals(this.enabled, loggingConfigurationSchedulerLogs.enabled) &&
        Objects.equals(this.logLevel, loggingConfigurationSchedulerLogs.logLevel);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoggingConfigurationSchedulerLogs {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoggingConfigurationSchedulerLogs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoggingConfigurationSchedulerLogs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoggingConfigurationSchedulerLogs is not found in the empty JSON string", LoggingConfigurationSchedulerLogs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoggingConfigurationSchedulerLogs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoggingConfigurationSchedulerLogs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoggingConfigurationSchedulerLogs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoggingConfigurationSchedulerLogs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoggingConfigurationSchedulerLogs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoggingConfigurationSchedulerLogs.class));

       return (TypeAdapter<T>) new TypeAdapter<LoggingConfigurationSchedulerLogs>() {
           @Override
           public void write(JsonWriter out, LoggingConfigurationSchedulerLogs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoggingConfigurationSchedulerLogs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoggingConfigurationSchedulerLogs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoggingConfigurationSchedulerLogs
   * @throws IOException if the JSON string is invalid with respect to LoggingConfigurationSchedulerLogs
   */
  public static LoggingConfigurationSchedulerLogs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoggingConfigurationSchedulerLogs.class);
  }

  /**
   * Convert an instance of LoggingConfigurationSchedulerLogs to an JSON string
   *
   * @return JSON string
   */
