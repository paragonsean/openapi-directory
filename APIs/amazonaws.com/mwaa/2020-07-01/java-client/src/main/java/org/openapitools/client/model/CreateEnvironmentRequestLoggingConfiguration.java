...
public class CreateEnvironmentRequestLoggingConfiguration {
  ...
  public CreateEnvironmentRequestLoggingConfiguration() {
  }

  public CreateEnvironmentRequestLoggingConfiguration dagProcessingLogs(CreateEnvironmentRequestLoggingConfigurationDagProcessingLogs dagProcessingLogs) {
  ...
  public CreateEnvironmentRequestLoggingConfiguration schedulerLogs(CreateEnvironmentRequestLoggingConfigurationSchedulerLogs schedulerLogs) {
  ...
  public CreateEnvironmentRequestLoggingConfiguration taskLogs(CreateEnvironmentRequestLoggingConfigurationTaskLogs taskLogs) {
  ...
  public CreateEnvironmentRequestLoggingConfiguration webserverLogs(CreateEnvironmentRequestLoggingConfigurationWebserverLogs webserverLogs) {
  ...
  public CreateEnvironmentRequestLoggingConfiguration workerLogs(CreateEnvironmentRequestLoggingConfigurationWorkerLogs workerLogs) {
  ...
  public boolean equals(Object o) {
    ...
    CreateEnvironmentRequestLoggingConfiguration createEnvironmentRequestLoggingConfiguration = (CreateEnvironmentRequestLoggingConfiguration) o;
    return Objects.equals(this.dagProcessingLogs, createEnvironmentRequestLoggingConfiguration.dagProcessingLogs) &&
        Objects.equals(this.schedulerLogs, createEnvironmentRequestLoggingConfiguration.schedulerLogs) &&
        Objects.equals(this.taskLogs, createEnvironmentRequestLoggingConfiguration.taskLogs) &&
        Objects.equals(this.webserverLogs, createEnvironmentRequestLoggingConfiguration.webserverLogs) &&
        Objects.equals(this.workerLogs, createEnvironmentRequestLoggingConfiguration.workerLogs);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateEnvironmentRequestLoggingConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateEnvironmentRequestLoggingConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateEnvironmentRequestLoggingConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateEnvironmentRequestLoggingConfiguration is not found in the empty JSON string", CreateEnvironmentRequestLoggingConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateEnvironmentRequestLoggingConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateEnvironmentRequestLoggingConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateEnvironmentRequestLoggingConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateEnvironmentRequestLoggingConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateEnvironmentRequestLoggingConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEnvironmentRequestLoggingConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEnvironmentRequestLoggingConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateEnvironmentRequestLoggingConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateEnvironmentRequestLoggingConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateEnvironmentRequestLoggingConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateEnvironmentRequestLoggingConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateEnvironmentRequestLoggingConfiguration
   */
  public static CreateEnvironmentRequestLoggingConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateEnvironmentRequestLoggingConfiguration.class);
  }

  /**
   * Convert an instance of CreateEnvironmentRequestLoggingConfiguration to an JSON string
   *
   * @return JSON string
   */
