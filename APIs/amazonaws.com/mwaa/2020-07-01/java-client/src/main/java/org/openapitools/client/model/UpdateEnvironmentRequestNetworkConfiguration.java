...
public class UpdateEnvironmentRequestNetworkConfiguration {
  ...
  public UpdateEnvironmentRequestNetworkConfiguration() {
  }

  public UpdateEnvironmentRequestNetworkConfiguration securityGroupIds(List securityGroupIds) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateEnvironmentRequestNetworkConfiguration updateEnvironmentRequestNetworkConfiguration = (UpdateEnvironmentRequestNetworkConfiguration) o;
    return Objects.equals(this.securityGroupIds, updateEnvironmentRequestNetworkConfiguration.securityGroupIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateEnvironmentRequestNetworkConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateEnvironmentRequestNetworkConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEnvironmentRequestNetworkConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateEnvironmentRequestNetworkConfiguration is not found in the empty JSON string", UpdateEnvironmentRequestNetworkConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateEnvironmentRequestNetworkConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateEnvironmentRequestNetworkConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEnvironmentRequestNetworkConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEnvironmentRequestNetworkConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEnvironmentRequestNetworkConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEnvironmentRequestNetworkConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEnvironmentRequestNetworkConfiguration>() {
           @Override
           public void write(JsonWriter out, UpdateEnvironmentRequestNetworkConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateEnvironmentRequestNetworkConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateEnvironmentRequestNetworkConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateEnvironmentRequestNetworkConfiguration
   * @throws IOException if the JSON string is invalid with respect to UpdateEnvironmentRequestNetworkConfiguration
   */
  public static UpdateEnvironmentRequestNetworkConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateEnvironmentRequestNetworkConfiguration.class);
  }

  /**
   * Convert an instance of UpdateEnvironmentRequestNetworkConfiguration to an JSON string
   *
   * @return JSON string
   */
