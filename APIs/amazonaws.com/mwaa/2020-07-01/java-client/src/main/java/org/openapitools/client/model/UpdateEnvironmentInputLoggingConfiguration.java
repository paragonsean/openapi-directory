...
public class UpdateEnvironmentInputLoggingConfiguration {
  ...
  public UpdateEnvironmentInputLoggingConfiguration() {
  }

  public UpdateEnvironmentInputLoggingConfiguration dagProcessingLogs(CreateEnvironmentRequestLoggingConfigurationDagProcessingLogs dagProcessingLogs) {
  ...
  public UpdateEnvironmentInputLoggingConfiguration schedulerLogs(CreateEnvironmentRequestLoggingConfigurationSchedulerLogs schedulerLogs) {
  ...
  public UpdateEnvironmentInputLoggingConfiguration taskLogs(CreateEnvironmentRequestLoggingConfigurationTaskLogs taskLogs) {
  ...
  public UpdateEnvironmentInputLoggingConfiguration webserverLogs(CreateEnvironmentRequestLoggingConfigurationWebserverLogs webserverLogs) {
  ...
  public UpdateEnvironmentInputLoggingConfiguration workerLogs(CreateEnvironmentRequestLoggingConfigurationWorkerLogs workerLogs) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateEnvironmentInputLoggingConfiguration updateEnvironmentInputLoggingConfiguration = (UpdateEnvironmentInputLoggingConfiguration) o;
    return Objects.equals(this.dagProcessingLogs, updateEnvironmentInputLoggingConfiguration.dagProcessingLogs) &&
        Objects.equals(this.schedulerLogs, updateEnvironmentInputLoggingConfiguration.schedulerLogs) &&
        Objects.equals(this.taskLogs, updateEnvironmentInputLoggingConfiguration.taskLogs) &&
        Objects.equals(this.webserverLogs, updateEnvironmentInputLoggingConfiguration.webserverLogs) &&
        Objects.equals(this.workerLogs, updateEnvironmentInputLoggingConfiguration.workerLogs);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateEnvironmentInputLoggingConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateEnvironmentInputLoggingConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEnvironmentInputLoggingConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateEnvironmentInputLoggingConfiguration is not found in the empty JSON string", UpdateEnvironmentInputLoggingConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateEnvironmentInputLoggingConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateEnvironmentInputLoggingConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEnvironmentInputLoggingConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEnvironmentInputLoggingConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEnvironmentInputLoggingConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEnvironmentInputLoggingConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEnvironmentInputLoggingConfiguration>() {
           @Override
           public void write(JsonWriter out, UpdateEnvironmentInputLoggingConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateEnvironmentInputLoggingConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateEnvironmentInputLoggingConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateEnvironmentInputLoggingConfiguration
   * @throws IOException if the JSON string is invalid with respect to UpdateEnvironmentInputLoggingConfiguration
   */
  public static UpdateEnvironmentInputLoggingConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateEnvironmentInputLoggingConfiguration.class);
  }

  /**
   * Convert an instance of UpdateEnvironmentInputLoggingConfiguration to an JSON string
   *
   * @return JSON string
   */
