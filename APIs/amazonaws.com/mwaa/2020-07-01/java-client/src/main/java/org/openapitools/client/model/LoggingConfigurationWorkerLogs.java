...
public class LoggingConfigurationWorkerLogs {
  ...
  public LoggingConfigurationWorkerLogs() {
  }

  public LoggingConfigurationWorkerLogs cloudWatchLogGroupArn(String cloudWatchLogGroupArn) {
  ...
  public LoggingConfigurationWorkerLogs enabled(Boolean enabled) {
  ...
  public LoggingConfigurationWorkerLogs logLevel(LoggingLevel logLevel) {
  ...
  public boolean equals(Object o) {
    ...
    LoggingConfigurationWorkerLogs loggingConfigurationWorkerLogs = (LoggingConfigurationWorkerLogs) o;
    return Objects.equals(this.cloudWatchLogGroupArn, loggingConfigurationWorkerLogs.cloudWatchLogGroupArn) &&
        Objects.equals(this.enabled, loggingConfigurationWorkerLogs.enabled) &&
        Objects.equals(this.logLevel, loggingConfigurationWorkerLogs.logLevel);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cloudWatchLogGroupArn, enabled, logLevel);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LoggingConfigurationWorkerLogs {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoggingConfigurationWorkerLogs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoggingConfigurationWorkerLogs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoggingConfigurationWorkerLogs is not found in the empty JSON string", LoggingConfigurationWorkerLogs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoggingConfigurationWorkerLogs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoggingConfigurationWorkerLogs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoggingConfigurationWorkerLogs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoggingConfigurationWorkerLogs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoggingConfigurationWorkerLogs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoggingConfigurationWorkerLogs.class));

       return (TypeAdapter<T>) new TypeAdapter<LoggingConfigurationWorkerLogs>() {
           @Override
           public void write(JsonWriter out, LoggingConfigurationWorkerLogs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoggingConfigurationWorkerLogs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoggingConfigurationWorkerLogs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoggingConfigurationWorkerLogs
   * @throws IOException if the JSON string is invalid with respect to LoggingConfigurationWorkerLogs
   */
  public static LoggingConfigurationWorkerLogs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoggingConfigurationWorkerLogs.class);
  }

  /**
   * Convert an instance of LoggingConfigurationWorkerLogs to an JSON string
   *
   * @return JSON string
   */
