...
public class LoggingConfigurationInput {
  ...
  public LoggingConfigurationInput() {
  }

  public LoggingConfigurationInput dagProcessingLogs(CreateEnvironmentRequestLoggingConfigurationDagProcessingLogs dagProcessingLogs) {
  ...
  public LoggingConfigurationInput schedulerLogs(CreateEnvironmentRequestLoggingConfigurationSchedulerLogs schedulerLogs) {
  ...
  public LoggingConfigurationInput taskLogs(CreateEnvironmentRequestLoggingConfigurationTaskLogs taskLogs) {
  ...
  public LoggingConfigurationInput webserverLogs(CreateEnvironmentRequestLoggingConfigurationWebserverLogs webserverLogs) {
  ...
  public LoggingConfigurationInput workerLogs(CreateEnvironmentRequestLoggingConfigurationWorkerLogs workerLogs) {
  ...
  public boolean equals(Object o) {
    ...
    LoggingConfigurationInput loggingConfigurationInput = (LoggingConfigurationInput) o;
    return Objects.equals(this.dagProcessingLogs, loggingConfigurationInput.dagProcessingLogs) &&
        Objects.equals(this.schedulerLogs, loggingConfigurationInput.schedulerLogs) &&
        Objects.equals(this.taskLogs, loggingConfigurationInput.taskLogs) &&
        Objects.equals(this.webserverLogs, loggingConfigurationInput.webserverLogs) &&
        Objects.equals(this.workerLogs, loggingConfigurationInput.workerLogs);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoggingConfigurationInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoggingConfigurationInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoggingConfigurationInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoggingConfigurationInput is not found in the empty JSON string", LoggingConfigurationInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoggingConfigurationInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoggingConfigurationInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoggingConfigurationInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoggingConfigurationInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoggingConfigurationInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoggingConfigurationInput.class));

       return (TypeAdapter<T>) new TypeAdapter<LoggingConfigurationInput>() {
           @Override
           public void write(JsonWriter out, LoggingConfigurationInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoggingConfigurationInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoggingConfigurationInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoggingConfigurationInput
   * @throws IOException if the JSON string is invalid with respect to LoggingConfigurationInput
   */
  public static LoggingConfigurationInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoggingConfigurationInput.class);
  }

  /**
   * Convert an instance of LoggingConfigurationInput to an JSON string
   *
   * @return JSON string
   */
