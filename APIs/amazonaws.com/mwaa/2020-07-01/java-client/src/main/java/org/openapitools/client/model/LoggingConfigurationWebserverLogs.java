...
public class LoggingConfigurationWebserverLogs {
  ...
  public LoggingConfigurationWebserverLogs() {
  }

  public LoggingConfigurationWebserverLogs cloudWatchLogGroupArn(String cloudWatchLogGroupArn) {
  ...
  public LoggingConfigurationWebserverLogs enabled(Boolean enabled) {
  ...
  public LoggingConfigurationWebserverLogs logLevel(LoggingLevel logLevel) {
  ...
  public boolean equals(Object o) {
    ...
    LoggingConfigurationWebserverLogs loggingConfigurationWebserverLogs = (LoggingConfigurationWebserverLogs) o;
    return Objects.equals(this.cloudWatchLogGroupArn, loggingConfigurationWebserverLogs.cloudWatchLogGroupArn) &&
        Objects.equals(this.enabled, loggingConfigurationWebserverLogs.enabled) &&
        Objects.equals(this.logLevel, loggingConfigurationWebserverLogs.logLevel);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoggingConfigurationWebserverLogs {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoggingConfigurationWebserverLogs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoggingConfigurationWebserverLogs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoggingConfigurationWebserverLogs is not found in the empty JSON string", LoggingConfigurationWebserverLogs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoggingConfigurationWebserverLogs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoggingConfigurationWebserverLogs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoggingConfigurationWebserverLogs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoggingConfigurationWebserverLogs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoggingConfigurationWebserverLogs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoggingConfigurationWebserverLogs.class));

       return (TypeAdapter<T>) new TypeAdapter<LoggingConfigurationWebserverLogs>() {
           @Override
           public void write(JsonWriter out, LoggingConfigurationWebserverLogs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoggingConfigurationWebserverLogs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoggingConfigurationWebserverLogs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoggingConfigurationWebserverLogs
   * @throws IOException if the JSON string is invalid with respect to LoggingConfigurationWebserverLogs
   */
  public static LoggingConfigurationWebserverLogs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoggingConfigurationWebserverLogs.class);
  }

  /**
   * Convert an instance of LoggingConfigurationWebserverLogs to an JSON string
   *
   * @return JSON string
   */
