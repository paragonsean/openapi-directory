...
public class LoggingConfigurationDagProcessingLogs {
  ...
  public LoggingConfigurationDagProcessingLogs() {
  }

  public LoggingConfigurationDagProcessingLogs cloudWatchLogGroupArn(String cloudWatchLogGroupArn) {
  ...
  public LoggingConfigurationDagProcessingLogs enabled(Boolean enabled) {
  ...
  public LoggingConfigurationDagProcessingLogs logLevel(LoggingLevel logLevel) {
  ...
  public boolean equals(Object o) {
    ...
    LoggingConfigurationDagProcessingLogs loggingConfigurationDagProcessingLogs = (LoggingConfigurationDagProcessingLogs) o;
    return Objects.equals(this.cloudWatchLogGroupArn, loggingConfigurationDagProcessingLogs.cloudWatchLogGroupArn) &&
        Objects.equals(this.enabled, loggingConfigurationDagProcessingLogs.enabled) &&
        Objects.equals(this.logLevel, loggingConfigurationDagProcessingLogs.logLevel);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoggingConfigurationDagProcessingLogs {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoggingConfigurationDagProcessingLogs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoggingConfigurationDagProcessingLogs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoggingConfigurationDagProcessingLogs is not found in the empty JSON string", LoggingConfigurationDagProcessingLogs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoggingConfigurationDagProcessingLogs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoggingConfigurationDagProcessingLogs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoggingConfigurationDagProcessingLogs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoggingConfigurationDagProcessingLogs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoggingConfigurationDagProcessingLogs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoggingConfigurationDagProcessingLogs.class));

       return (TypeAdapter<T>) new TypeAdapter<LoggingConfigurationDagProcessingLogs>() {
           @Override
           public void write(JsonWriter out, LoggingConfigurationDagProcessingLogs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoggingConfigurationDagProcessingLogs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoggingConfigurationDagProcessingLogs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoggingConfigurationDagProcessingLogs
   * @throws IOException if the JSON string is invalid with respect to LoggingConfigurationDagProcessingLogs
   */
  public static LoggingConfigurationDagProcessingLogs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoggingConfigurationDagProcessingLogs.class);
  }

  /**
   * Convert an instance of LoggingConfigurationDagProcessingLogs to an JSON string
   *
   * @return JSON string
   */
