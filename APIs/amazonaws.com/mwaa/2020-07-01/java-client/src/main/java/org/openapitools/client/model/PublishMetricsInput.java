...
public class PublishMetricsInput {
  ...
  public PublishMetricsInput() {
  }

  public PublishMetricsInput metricData(List metricData) {
  ...
  public boolean equals(Object o) {
    ...
    PublishMetricsInput publishMetricsInput = (PublishMetricsInput) o;
    return Objects.equals(this.metricData, publishMetricsInput.metricData);
  }
  ...
  public String toString() {
    ...
    sb.append("class PublishMetricsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PublishMetricsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PublishMetricsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PublishMetricsInput is not found in the empty JSON string", PublishMetricsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PublishMetricsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PublishMetricsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PublishMetricsInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `MetricData`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PublishMetricsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PublishMetricsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PublishMetricsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PublishMetricsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PublishMetricsInput>() {
           @Override
           public void write(JsonWriter out, PublishMetricsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PublishMetricsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PublishMetricsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PublishMetricsInput
   * @throws IOException if the JSON string is invalid with respect to PublishMetricsInput
   */
  public static PublishMetricsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PublishMetricsInput.class);
  }

  /**
   * Convert an instance of PublishMetricsInput to an JSON string
   *
   * @return JSON string
   */
