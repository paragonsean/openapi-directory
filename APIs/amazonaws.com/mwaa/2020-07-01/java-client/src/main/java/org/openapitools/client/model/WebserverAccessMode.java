...
/**
 * Gets or Sets WebserverAccessMode
 */
@JsonAdapter(WebserverAccessMode.Adapter.class)
public enum WebserverAccessMode {
  ...
  WebserverAccessMode(String value) {
    this.value = value;
  }
  ...
  public static WebserverAccessMode fromValue(String value) {
    for (WebserverAccessMode b : WebserverAccessMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<WebserverAccessMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final WebserverAccessMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public WebserverAccessMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return WebserverAccessMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    WebserverAccessMode.fromValue(value);
  }
}
