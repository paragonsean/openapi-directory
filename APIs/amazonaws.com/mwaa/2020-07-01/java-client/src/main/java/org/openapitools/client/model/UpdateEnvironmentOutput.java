...
public class UpdateEnvironmentOutput {
  ...
  public UpdateEnvironmentOutput arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateEnvironmentOutput updateEnvironmentOutput = (UpdateEnvironmentOutput) o;
    return Objects.equals(this.arn, updateEnvironmentOutput.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateEnvironmentOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateEnvironmentOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEnvironmentOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateEnvironmentOutput is not found in the empty JSON string", UpdateEnvironmentOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateEnvironmentOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateEnvironmentOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEnvironmentOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEnvironmentOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEnvironmentOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEnvironmentOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEnvironmentOutput>() {
           @Override
           public void write(JsonWriter out, UpdateEnvironmentOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateEnvironmentOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateEnvironmentOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateEnvironmentOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateEnvironmentOutput
   */
  public static UpdateEnvironmentOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateEnvironmentOutput.class);
  }

  /**
   * Convert an instance of UpdateEnvironmentOutput to an JSON string
   *
   * @return JSON string
   */
