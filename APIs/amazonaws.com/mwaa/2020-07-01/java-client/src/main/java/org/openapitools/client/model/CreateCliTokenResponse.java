...
public class CreateCliTokenResponse {
  public static final String SERIALIZED_NAME_CLI_TOKEN = "CliToken";
  @SerializedName(SERIALIZED_NAME_CLI_TOKEN)
  ...
  public CreateCliTokenResponse cliToken(String cliToken) {
  ...
  public CreateCliTokenResponse webServerHostname(String webServerHostname) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCliTokenResponse createCliTokenResponse = (CreateCliTokenResponse) o;
    return Objects.equals(this.cliToken, createCliTokenResponse.cliToken) &&
        Objects.equals(this.webServerHostname, createCliTokenResponse.webServerHostname);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cliToken, webServerHostname);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateCliTokenResponse {\n");
    sb.append("    cliToken: ").append(toIndentedString(cliToken)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCliTokenResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCliTokenResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCliTokenResponse is not found in the empty JSON string", CreateCliTokenResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCliTokenResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCliTokenResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `CliToken`
      if (jsonObj.get("CliToken") != null && !jsonObj.get("CliToken").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("CliToken"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCliTokenResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCliTokenResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCliTokenResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCliTokenResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCliTokenResponse>() {
           @Override
           public void write(JsonWriter out, CreateCliTokenResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCliTokenResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCliTokenResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCliTokenResponse
   * @throws IOException if the JSON string is invalid with respect to CreateCliTokenResponse
   */
  public static CreateCliTokenResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCliTokenResponse.class);
  }

  /**
   * Convert an instance of CreateCliTokenResponse to an JSON string
   *
   * @return JSON string
   */
