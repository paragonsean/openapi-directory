...
public class CreateEnvironmentInputNetworkConfiguration {
  ...
  public CreateEnvironmentInputNetworkConfiguration() {
  }

  public CreateEnvironmentInputNetworkConfiguration securityGroupIds(List securityGroupIds) {
  ...
  public CreateEnvironmentInputNetworkConfiguration subnetIds(List subnetIds) {
  ...
  public boolean equals(Object o) {
    ...
    CreateEnvironmentInputNetworkConfiguration createEnvironmentInputNetworkConfiguration = (CreateEnvironmentInputNetworkConfiguration) o;
    return Objects.equals(this.securityGroupIds, createEnvironmentInputNetworkConfiguration.securityGroupIds) &&
        Objects.equals(this.subnetIds, createEnvironmentInputNetworkConfiguration.subnetIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateEnvironmentInputNetworkConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateEnvironmentInputNetworkConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateEnvironmentInputNetworkConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateEnvironmentInputNetworkConfiguration is not found in the empty JSON string", CreateEnvironmentInputNetworkConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateEnvironmentInputNetworkConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateEnvironmentInputNetworkConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateEnvironmentInputNetworkConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateEnvironmentInputNetworkConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateEnvironmentInputNetworkConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEnvironmentInputNetworkConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEnvironmentInputNetworkConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateEnvironmentInputNetworkConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateEnvironmentInputNetworkConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateEnvironmentInputNetworkConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateEnvironmentInputNetworkConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateEnvironmentInputNetworkConfiguration
   */
  public static CreateEnvironmentInputNetworkConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateEnvironmentInputNetworkConfiguration.class);
  }

  /**
   * Convert an instance of CreateEnvironmentInputNetworkConfiguration to an JSON string
   *
   * @return JSON string
   */
