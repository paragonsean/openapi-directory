...
public class MetricDatumStatisticValues {
  ...
  public MetricDatumStatisticValues() {
  }

  public MetricDatumStatisticValues maximum(Double maximum) {
  ...
  public MetricDatumStatisticValues minimum(Double minimum) {
  ...
  public MetricDatumStatisticValues sampleCount(Integer sampleCount) {
  ...
  public MetricDatumStatisticValues sum(Double sum) {
    this.sum = sum;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MetricDatumStatisticValues metricDatumStatisticValues = (MetricDatumStatisticValues) o;
    return Objects.equals(this.maximum, metricDatumStatisticValues.maximum) &&
        Objects.equals(this.minimum, metricDatumStatisticValues.minimum) &&
        Objects.equals(this.sampleCount, metricDatumStatisticValues.sampleCount) &&
        Objects.equals(this.sum, metricDatumStatisticValues.sum);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maximum, minimum, sampleCount, sum);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MetricDatumStatisticValues {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetricDatumStatisticValues
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricDatumStatisticValues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetricDatumStatisticValues is not found in the empty JSON string", MetricDatumStatisticValues.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetricDatumStatisticValues.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetricDatumStatisticValues` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("SampleCount") != null && !jsonObj.get("SampleCount").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("SampleCount"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricDatumStatisticValues.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricDatumStatisticValues' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricDatumStatisticValues> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricDatumStatisticValues.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricDatumStatisticValues>() {
           @Override
           public void write(JsonWriter out, MetricDatumStatisticValues value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MetricDatumStatisticValues read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MetricDatumStatisticValues given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MetricDatumStatisticValues
   * @throws IOException if the JSON string is invalid with respect to MetricDatumStatisticValues
   */
  public static MetricDatumStatisticValues fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetricDatumStatisticValues.class);
  }

  /**
   * Convert an instance of MetricDatumStatisticValues to an JSON string
   *
   * @return JSON string
   */
