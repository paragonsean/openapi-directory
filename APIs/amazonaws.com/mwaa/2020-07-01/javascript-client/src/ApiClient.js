...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://airflow.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://airflow.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2020-07-01/Javascript'
        };
