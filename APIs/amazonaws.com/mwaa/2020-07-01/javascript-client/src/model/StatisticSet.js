...
/**
 * The StatisticSet model module.
 * @module model/StatisticSet
 * @version 2020-07-01
 */
class StatisticSet {
    /**
     * Constructs a new <code>StatisticSet</code>.
     ...
     * @alias module:model/StatisticSet
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StatisticSet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatisticSet} obj Optional instance to populate.
     * @return {module:model/StatisticSet} The populated <code>StatisticSet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatisticSet();
    ...
    /**
     * Validates the JSON data with respect to <code>StatisticSet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatisticSet</code>.
     */
