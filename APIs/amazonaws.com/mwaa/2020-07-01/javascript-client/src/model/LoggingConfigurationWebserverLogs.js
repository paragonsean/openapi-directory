...
/**
 * The LoggingConfigurationWebserverLogs model module.
 * @module model/LoggingConfigurationWebserverLogs
 * @version 2020-07-01
 */
class LoggingConfigurationWebserverLogs {
    /**
     * Constructs a new <code>LoggingConfigurationWebserverLogs</code>.
     * @alias module:model/LoggingConfigurationWebserverLogs
     * @implements module:model/ModuleLoggingConfiguration
     */
    constructor() { 
        ModuleLoggingConfiguration.initialize(this);
        LoggingConfigurationWebserverLogs.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoggingConfigurationWebserverLogs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoggingConfigurationWebserverLogs} obj Optional instance to populate.
     * @return {module:model/LoggingConfigurationWebserverLogs} The populated <code>LoggingConfigurationWebserverLogs</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoggingConfigurationWebserverLogs();
    ...
    /**
     * Validates the JSON data with respect to <code>LoggingConfigurationWebserverLogs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoggingConfigurationWebserverLogs</code>.
     */
 ...
 */
LoggingConfigurationWebserverLogs.prototype['CloudWatchLogGroupArn'] = undefined;

/**
 * @member {Boolean} Enabled
 */
LoggingConfigurationWebserverLogs.prototype['Enabled'] = undefined;

/**
 * @member {module:model/LoggingLevel} LogLevel
 */
LoggingConfigurationWebserverLogs.prototype['LogLevel'] = undefined;
...
export default LoggingConfigurationWebserverLogs;
