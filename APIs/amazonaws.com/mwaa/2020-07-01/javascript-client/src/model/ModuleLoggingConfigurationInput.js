...
/**
 * The ModuleLoggingConfigurationInput model module.
 * @module model/ModuleLoggingConfigurationInput
 * @version 2020-07-01
 */
class ModuleLoggingConfigurationInput {
    /**
     * Constructs a new <code>ModuleLoggingConfigurationInput</code>.
     ...
     * @alias module:model/ModuleLoggingConfigurationInput
     * @param enabled {Boolean} 
     * @param logLevel {module:model/LoggingLevel} 
     */
    constructor(enabled, logLevel) { 
        
        ModuleLoggingConfigurationInput.initialize(this, enabled, logLevel);
    }
     ...
     */
    static initialize(obj, enabled, logLevel) { 
        obj['Enabled'] = enabled;
        obj['LogLevel'] = logLevel;
    }

    /**
     * Constructs a <code>ModuleLoggingConfigurationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModuleLoggingConfigurationInput} obj Optional instance to populate.
     * @return {module:model/ModuleLoggingConfigurationInput} The populated <code>ModuleLoggingConfigurationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModuleLoggingConfigurationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ModuleLoggingConfigurationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModuleLoggingConfigurationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ModuleLoggingConfigurationInput.RequiredProperties) {
...
ModuleLoggingConfigurationInput.RequiredProperties = ["Enabled", "LogLevel"];

/**
 * @member {Boolean} Enabled
 */
ModuleLoggingConfigurationInput.prototype['Enabled'] = undefined;

/**
 * @member {module:model/LoggingLevel} LogLevel
 */
ModuleLoggingConfigurationInput.prototype['LogLevel'] = undefined;
...
export default ModuleLoggingConfigurationInput;
