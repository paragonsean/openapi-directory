...
/**
 * The ModuleLoggingConfiguration model module.
 * @module model/ModuleLoggingConfiguration
 * @version 2020-07-01
 */
class ModuleLoggingConfiguration {
    /**
     * Constructs a new <code>ModuleLoggingConfiguration</code>.
     * Describes the Apache Airflow log details for the log type (e.g. &lt;code&gt;DagProcessingLogs&lt;/code&gt;).
     * @alias module:model/ModuleLoggingConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ModuleLoggingConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModuleLoggingConfiguration} obj Optional instance to populate.
     * @return {module:model/ModuleLoggingConfiguration} The populated <code>ModuleLoggingConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModuleLoggingConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>ModuleLoggingConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModuleLoggingConfiguration</code>.
     */
...
export default ModuleLoggingConfiguration;
