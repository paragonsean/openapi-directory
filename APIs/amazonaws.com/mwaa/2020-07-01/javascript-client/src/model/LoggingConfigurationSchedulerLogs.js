...
/**
 * The LoggingConfigurationSchedulerLogs model module.
 * @module model/LoggingConfigurationSchedulerLogs
 * @version 2020-07-01
 */
class LoggingConfigurationSchedulerLogs {
    /**
     * Constructs a new <code>LoggingConfigurationSchedulerLogs</code>.
     * @alias module:model/LoggingConfigurationSchedulerLogs
     * @implements module:model/ModuleLoggingConfiguration
     */
    constructor() { 
        ModuleLoggingConfiguration.initialize(this);
        LoggingConfigurationSchedulerLogs.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoggingConfigurationSchedulerLogs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoggingConfigurationSchedulerLogs} obj Optional instance to populate.
     * @return {module:model/LoggingConfigurationSchedulerLogs} The populated <code>LoggingConfigurationSchedulerLogs</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoggingConfigurationSchedulerLogs();
    ...
    /**
     * Validates the JSON data with respect to <code>LoggingConfigurationSchedulerLogs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoggingConfigurationSchedulerLogs</code>.
     */
 ...
 */
LoggingConfigurationSchedulerLogs.prototype['CloudWatchLogGroupArn'] = undefined;

/**
 * @member {Boolean} Enabled
 */
LoggingConfigurationSchedulerLogs.prototype['Enabled'] = undefined;

/**
 * @member {module:model/LoggingLevel} LogLevel
 */
LoggingConfigurationSchedulerLogs.prototype['LogLevel'] = undefined;
...
export default LoggingConfigurationSchedulerLogs;
