...
/**
 * The CreateEnvironmentInputNetworkConfiguration model module.
 * @module model/CreateEnvironmentInputNetworkConfiguration
 * @version 2020-07-01
 */
class CreateEnvironmentInputNetworkConfiguration {
    /**
     * Constructs a new <code>CreateEnvironmentInputNetworkConfiguration</code>.
     * @alias module:model/CreateEnvironmentInputNetworkConfiguration
     * @implements module:model/NetworkConfiguration
     */
    constructor() { 
        NetworkConfiguration.initialize(this);
        CreateEnvironmentInputNetworkConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateEnvironmentInputNetworkConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateEnvironmentInputNetworkConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateEnvironmentInputNetworkConfiguration} The populated <code>CreateEnvironmentInputNetworkConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateEnvironmentInputNetworkConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateEnvironmentInputNetworkConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateEnvironmentInputNetworkConfiguration</code>.
     */
 ...
 */
CreateEnvironmentInputNetworkConfiguration.prototype['SecurityGroupIds'] = undefined;

/**
 * @member {Array} SubnetIds
 */
CreateEnvironmentInputNetworkConfiguration.prototype['SubnetIds'] = undefined;
...
export default CreateEnvironmentInputNetworkConfiguration;
