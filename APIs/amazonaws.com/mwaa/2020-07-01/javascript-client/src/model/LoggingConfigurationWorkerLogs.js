...
/**
 * The LoggingConfigurationWorkerLogs model module.
 * @module model/LoggingConfigurationWorkerLogs
 * @version 2020-07-01
 */
class LoggingConfigurationWorkerLogs {
    /**
     * Constructs a new <code>LoggingConfigurationWorkerLogs</code>.
     * @alias module:model/LoggingConfigurationWorkerLogs
     * @implements module:model/ModuleLoggingConfiguration
     */
    constructor() { 
        ModuleLoggingConfiguration.initialize(this);
        LoggingConfigurationWorkerLogs.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoggingConfigurationWorkerLogs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoggingConfigurationWorkerLogs} obj Optional instance to populate.
     * @return {module:model/LoggingConfigurationWorkerLogs} The populated <code>LoggingConfigurationWorkerLogs</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoggingConfigurationWorkerLogs();
    ...
    /**
     * Validates the JSON data with respect to <code>LoggingConfigurationWorkerLogs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoggingConfigurationWorkerLogs</code>.
     */
 ...
 */
LoggingConfigurationWorkerLogs.prototype['CloudWatchLogGroupArn'] = undefined;

/**
 * @member {Boolean} Enabled
 */
LoggingConfigurationWorkerLogs.prototype['Enabled'] = undefined;

/**
 * @member {module:model/LoggingLevel} LogLevel
 */
LoggingConfigurationWorkerLogs.prototype['LogLevel'] = undefined;
...
export default LoggingConfigurationWorkerLogs;
