...
/**
 * The LoggingConfigurationTaskLogs model module.
 * @module model/LoggingConfigurationTaskLogs
 * @version 2020-07-01
 */
class LoggingConfigurationTaskLogs {
    /**
     * Constructs a new <code>LoggingConfigurationTaskLogs</code>.
     * @alias module:model/LoggingConfigurationTaskLogs
     * @implements module:model/ModuleLoggingConfiguration
     */
    constructor() { 
        ModuleLoggingConfiguration.initialize(this);
        LoggingConfigurationTaskLogs.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoggingConfigurationTaskLogs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoggingConfigurationTaskLogs} obj Optional instance to populate.
     * @return {module:model/LoggingConfigurationTaskLogs} The populated <code>LoggingConfigurationTaskLogs</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoggingConfigurationTaskLogs();
    ...
    /**
     * Validates the JSON data with respect to <code>LoggingConfigurationTaskLogs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoggingConfigurationTaskLogs</code>.
     */
 ...
 */
LoggingConfigurationTaskLogs.prototype['CloudWatchLogGroupArn'] = undefined;

/**
 * @member {Boolean} Enabled
 */
LoggingConfigurationTaskLogs.prototype['Enabled'] = undefined;

/**
 * @member {module:model/LoggingLevel} LogLevel
 */
LoggingConfigurationTaskLogs.prototype['LogLevel'] = undefined;
...
export default LoggingConfigurationTaskLogs;
