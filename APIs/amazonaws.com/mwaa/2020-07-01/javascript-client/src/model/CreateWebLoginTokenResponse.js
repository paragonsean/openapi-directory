...
/**
 * The CreateWebLoginTokenResponse model module.
 * @module model/CreateWebLoginTokenResponse
 * @version 2020-07-01
 */
class CreateWebLoginTokenResponse {
    /**
     * Constructs a new <code>CreateWebLoginTokenResponse</code>.
     * @alias module:model/CreateWebLoginTokenResponse
     */
    constructor() { 
        
        CreateWebLoginTokenResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateWebLoginTokenResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateWebLoginTokenResponse} obj Optional instance to populate.
     * @return {module:model/CreateWebLoginTokenResponse} The populated <code>CreateWebLoginTokenResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateWebLoginTokenResponse();
            ...
            if (data.hasOwnProperty('WebToken')) {
                obj['WebToken'] = ApiClient.convertToType(data['WebToken'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateWebLoginTokenResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateWebLoginTokenResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['WebToken']) { // data not null
          String.validateJSON(data['WebToken']);
        }
 ...
 */
CreateWebLoginTokenResponse.prototype['WebServerHostname'] = undefined;

/**
 * @member {String} WebToken
 */
CreateWebLoginTokenResponse.prototype['WebToken'] = undefined;
...
export default CreateWebLoginTokenResponse;
