...
/**
 * The LastUpdate model module.
 * @module model/LastUpdate
 * @version 2020-07-01
 */
class LastUpdate {
    /**
     * Constructs a new <code>LastUpdate</code>.
     * Describes the status of the last update on the environment, and any errors that were encountered.
     * @alias module:model/LastUpdate
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>LastUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LastUpdate} obj Optional instance to populate.
     * @return {module:model/LastUpdate} The populated <code>LastUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LastUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>LastUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LastUpdate</code>.
     */
