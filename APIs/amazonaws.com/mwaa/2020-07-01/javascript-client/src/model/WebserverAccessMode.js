...
* @readonly
*/
export default class WebserverAccessMode {
    ...
    /**
    * Returns a <code>WebserverAccessMode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/WebserverAccessMode} The enum <code>WebserverAccessMode</code> value.
    */
