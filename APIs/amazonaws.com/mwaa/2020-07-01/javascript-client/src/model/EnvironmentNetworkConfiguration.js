...
/**
 * The EnvironmentNetworkConfiguration model module.
 * @module model/EnvironmentNetworkConfiguration
 * @version 2020-07-01
 */
class EnvironmentNetworkConfiguration {
    /**
     * Constructs a new <code>EnvironmentNetworkConfiguration</code>.
     * @alias module:model/EnvironmentNetworkConfiguration
     * @implements module:model/NetworkConfiguration
     */
    constructor() { 
        NetworkConfiguration.initialize(this);
        EnvironmentNetworkConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EnvironmentNetworkConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnvironmentNetworkConfiguration} obj Optional instance to populate.
     * @return {module:model/EnvironmentNetworkConfiguration} The populated <code>EnvironmentNetworkConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnvironmentNetworkConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>EnvironmentNetworkConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnvironmentNetworkConfiguration</code>.
     */
 ...
 */
EnvironmentNetworkConfiguration.prototype['SecurityGroupIds'] = undefined;

/**
 * @member {Array} SubnetIds
 */
EnvironmentNetworkConfiguration.prototype['SubnetIds'] = undefined;
...
export default EnvironmentNetworkConfiguration;
