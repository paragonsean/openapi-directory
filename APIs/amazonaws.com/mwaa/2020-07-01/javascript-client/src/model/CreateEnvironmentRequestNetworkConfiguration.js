...
/**
 * The CreateEnvironmentRequestNetworkConfiguration model module.
 * @module model/CreateEnvironmentRequestNetworkConfiguration
 * @version 2020-07-01
 */
class CreateEnvironmentRequestNetworkConfiguration {
    /**
     * Constructs a new <code>CreateEnvironmentRequestNetworkConfiguration</code>.
     ...
     * @alias module:model/CreateEnvironmentRequestNetworkConfiguration
     */
    constructor() { 
        
        CreateEnvironmentRequestNetworkConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateEnvironmentRequestNetworkConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateEnvironmentRequestNetworkConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateEnvironmentRequestNetworkConfiguration} The populated <code>CreateEnvironmentRequestNetworkConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateEnvironmentRequestNetworkConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateEnvironmentRequestNetworkConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateEnvironmentRequestNetworkConfiguration</code>.
     */
 ...
 */
CreateEnvironmentRequestNetworkConfiguration.prototype['SecurityGroupIds'] = undefined;

/**
 * @member {Array} SubnetIds
 */
CreateEnvironmentRequestNetworkConfiguration.prototype['SubnetIds'] = undefined;
...
export default CreateEnvironmentRequestNetworkConfiguration;
