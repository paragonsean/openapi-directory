...
/**
 * The LastUpdateError model module.
 * @module model/LastUpdateError
 * @version 2020-07-01
 */
class LastUpdateError {
    /**
     * Constructs a new <code>LastUpdateError</code>.
     * @alias module:model/LastUpdateError
     * @implements module:model/UpdateError
     */
    constructor() { 
        UpdateError.initialize(this);
        LastUpdateError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LastUpdateError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LastUpdateError} obj Optional instance to populate.
     * @return {module:model/LastUpdateError} The populated <code>LastUpdateError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LastUpdateError();
            UpdateError.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>LastUpdateError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LastUpdateError</code>.
     */
 ...
 */
LastUpdateError.prototype['ErrorCode'] = undefined;

/**
 * @member {String} ErrorMessage
 */
LastUpdateError.prototype['ErrorMessage'] = undefined;


// Implement UpdateError interface:
/**
 * @member {String} ErrorCode
 */
...
export default LastUpdateError;
