...
import UpdateEnvironmentInputLoggingConfiguration from './UpdateEnvironmentInputLoggingConfiguration';
import UpdateEnvironmentInputNetworkConfiguration from './UpdateEnvironmentInputNetworkConfiguration';
...
class UpdateEnvironmentInput {
    ...
    constructor() { 
        ...
        UpdateEnvironmentInput.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('LoggingConfiguration')) {
                obj['LoggingConfiguration'] = UpdateEnvironmentInputLoggingConfiguration.constructFromObject(data['LoggingConfiguration']);
            }
            ...
            if (data.hasOwnProperty('NetworkConfiguration')) {
                obj['NetworkConfiguration'] = UpdateEnvironmentInputNetworkConfiguration.constructFromObject(data['NetworkConfiguration']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['LoggingConfiguration']) { // data not null
          UpdateEnvironmentInputLoggingConfiguration.validateJSON(data['LoggingConfiguration']);
        }
        ...
        if (data['NetworkConfiguration']) { // data not null
          UpdateEnvironmentInputNetworkConfiguration.validateJSON(data['NetworkConfiguration']);
        }
 ...
 */
UpdateEnvironmentInput.prototype['AirflowConfigurationOptions'] = undefined;

/**
 * @member {String} AirflowVersion
 */
UpdateEnvironmentInput.prototype['AirflowVersion'] = undefined;

/**
 * @member {String} DagS3Path
 */
UpdateEnvironmentInput.prototype['DagS3Path'] = undefined;

/**
 * @member {String} EnvironmentClass
 */
UpdateEnvironmentInput.prototype['EnvironmentClass'] = undefined;

/**
 * @member {String} ExecutionRoleArn
 */
UpdateEnvironmentInput.prototype['ExecutionRoleArn'] = undefined;

/**
 * @member {module:model/UpdateEnvironmentInputLoggingConfiguration} LoggingConfiguration
 */
UpdateEnvironmentInput.prototype['LoggingConfiguration'] = undefined;

/**
 * @member {Number} MaxWorkers
 */
UpdateEnvironmentInput.prototype['MaxWorkers'] = undefined;

/**
 * @member {Number} MinWorkers
 */
UpdateEnvironmentInput.prototype['MinWorkers'] = undefined;

/**
 * @member {module:model/UpdateEnvironmentInputNetworkConfiguration} NetworkConfiguration
 */
UpdateEnvironmentInput.prototype['NetworkConfiguration'] = undefined;

/**
 * @member {String} PluginsS3ObjectVersion
 */
UpdateEnvironmentInput.prototype['PluginsS3ObjectVersion'] = undefined;

/**
 * @member {String} PluginsS3Path
 */
UpdateEnvironmentInput.prototype['PluginsS3Path'] = undefined;

/**
 * @member {String} RequirementsS3ObjectVersion
 */
UpdateEnvironmentInput.prototype['RequirementsS3ObjectVersion'] = undefined;

/**
 * @member {String} RequirementsS3Path
 */
UpdateEnvironmentInput.prototype['RequirementsS3Path'] = undefined;

/**
 * @member {Number} Schedulers
 */
UpdateEnvironmentInput.prototype['Schedulers'] = undefined;

/**
 * @member {String} SourceBucketArn
 */
UpdateEnvironmentInput.prototype['SourceBucketArn'] = undefined;

/**
 * @member {String} StartupScriptS3ObjectVersion
 */
UpdateEnvironmentInput.prototype['StartupScriptS3ObjectVersion'] = undefined;

/**
 * @member {String} StartupScriptS3Path
 */
UpdateEnvironmentInput.prototype['StartupScriptS3Path'] = undefined;

/**
 * @member {module:model/WebserverAccessMode} WebserverAccessMode
 */
UpdateEnvironmentInput.prototype['WebserverAccessMode'] = undefined;

/**
 * @member {String} WeeklyMaintenanceWindowStart
 */
UpdateEnvironmentInput.prototype['WeeklyMaintenanceWindowStart'] = undefined;
