...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.UpdateEnvironmentRequestNetworkConfiguration();
  });
  ...
  describe('UpdateEnvironmentRequestNetworkConfiguration', function() {
    it('should create an instance of UpdateEnvironmentRequestNetworkConfiguration', function() {
      // uncomment below and update the code to test UpdateEnvironmentRequestNetworkConfiguration
      //var instance = new AmazonMwaa.UpdateEnvironmentRequestNetworkConfiguration();
      //expect(instance).to.be.a(AmazonMwaa.UpdateEnvironmentRequestNetworkConfiguration);
    });
