...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.EnvironmentLoggingConfiguration();
  });
  ...
  describe('EnvironmentLoggingConfiguration', function() {
    it('should create an instance of EnvironmentLoggingConfiguration', function() {
      // uncomment below and update the code to test EnvironmentLoggingConfiguration
      //var instance = new AmazonMwaa.EnvironmentLoggingConfiguration();
      //expect(instance).to.be.a(AmazonMwaa.EnvironmentLoggingConfiguration);
    });
