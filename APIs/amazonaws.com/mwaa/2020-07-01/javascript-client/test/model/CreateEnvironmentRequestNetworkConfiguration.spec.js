...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateEnvironmentRequestNetworkConfiguration();
  });
  ...
  describe('CreateEnvironmentRequestNetworkConfiguration', function() {
    it('should create an instance of CreateEnvironmentRequestNetworkConfiguration', function() {
      // uncomment below and update the code to test CreateEnvironmentRequestNetworkConfiguration
      //var instance = new AmazonMwaa.CreateEnvironmentRequestNetworkConfiguration();
      //expect(instance).to.be.a(AmazonMwaa.CreateEnvironmentRequestNetworkConfiguration);
    });
