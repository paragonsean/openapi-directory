...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateEnvironmentInputLoggingConfiguration();
  });
  ...
  describe('CreateEnvironmentInputLoggingConfiguration', function() {
    it('should create an instance of CreateEnvironmentInputLoggingConfiguration', function() {
      // uncomment below and update the code to test CreateEnvironmentInputLoggingConfiguration
      //var instance = new AmazonMwaa.CreateEnvironmentInputLoggingConfiguration();
      //expect(instance).to.be.a(AmazonMwaa.CreateEnvironmentInputLoggingConfiguration);
    });
