...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.LoggingConfigurationWebserverLogs();
  });
  ...
  describe('LoggingConfigurationWebserverLogs', function() {
    it('should create an instance of LoggingConfigurationWebserverLogs', function() {
      // uncomment below and update the code to test LoggingConfigurationWebserverLogs
      //var instance = new AmazonMwaa.LoggingConfigurationWebserverLogs();
      //expect(instance).to.be.a(AmazonMwaa.LoggingConfigurationWebserverLogs);
    });
