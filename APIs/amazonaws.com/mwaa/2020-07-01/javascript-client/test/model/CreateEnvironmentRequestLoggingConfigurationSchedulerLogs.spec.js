...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfigurationSchedulerLogs();
  });
  ...
  describe('CreateEnvironmentRequestLoggingConfigurationSchedulerLogs', function() {
    it('should create an instance of CreateEnvironmentRequestLoggingConfigurationSchedulerLogs', function() {
      // uncomment below and update the code to test CreateEnvironmentRequestLoggingConfigurationSchedulerLogs
      //var instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfigurationSchedulerLogs();
      //expect(instance).to.be.a(AmazonMwaa.CreateEnvironmentRequestLoggingConfigurationSchedulerLogs);
    });
