...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.UpdateEnvironmentOutput();
  });
  ...
  describe('UpdateEnvironmentOutput', function() {
    it('should create an instance of UpdateEnvironmentOutput', function() {
      // uncomment below and update the code to test UpdateEnvironmentOutput
      //var instance = new AmazonMwaa.UpdateEnvironmentOutput();
      //expect(instance).to.be.a(AmazonMwaa.UpdateEnvironmentOutput);
    });
