...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.LoggingConfigurationSchedulerLogs();
  });
  ...
  describe('LoggingConfigurationSchedulerLogs', function() {
    it('should create an instance of LoggingConfigurationSchedulerLogs', function() {
      // uncomment below and update the code to test LoggingConfigurationSchedulerLogs
      //var instance = new AmazonMwaa.LoggingConfigurationSchedulerLogs();
      //expect(instance).to.be.a(AmazonMwaa.LoggingConfigurationSchedulerLogs);
    });
