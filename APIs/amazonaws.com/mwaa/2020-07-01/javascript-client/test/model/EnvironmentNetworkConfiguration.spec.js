...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.EnvironmentNetworkConfiguration();
  });
  ...
  describe('EnvironmentNetworkConfiguration', function() {
    it('should create an instance of EnvironmentNetworkConfiguration', function() {
      // uncomment below and update the code to test EnvironmentNetworkConfiguration
      //var instance = new AmazonMwaa.EnvironmentNetworkConfiguration();
      //expect(instance).to.be.a(AmazonMwaa.EnvironmentNetworkConfiguration);
    });
