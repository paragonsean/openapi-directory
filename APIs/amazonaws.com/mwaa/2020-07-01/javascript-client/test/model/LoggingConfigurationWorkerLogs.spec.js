...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.LoggingConfigurationWorkerLogs();
  });
  ...
  describe('LoggingConfigurationWorkerLogs', function() {
    it('should create an instance of LoggingConfigurationWorkerLogs', function() {
      // uncomment below and update the code to test LoggingConfigurationWorkerLogs
      //var instance = new AmazonMwaa.LoggingConfigurationWorkerLogs();
      //expect(instance).to.be.a(AmazonMwaa.LoggingConfigurationWorkerLogs);
    });
