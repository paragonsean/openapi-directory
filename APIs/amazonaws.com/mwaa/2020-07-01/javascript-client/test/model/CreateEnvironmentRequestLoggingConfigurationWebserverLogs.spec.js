...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfigurationWebserverLogs();
  });
  ...
  describe('CreateEnvironmentRequestLoggingConfigurationWebserverLogs', function() {
    it('should create an instance of CreateEnvironmentRequestLoggingConfigurationWebserverLogs', function() {
      // uncomment below and update the code to test CreateEnvironmentRequestLoggingConfigurationWebserverLogs
      //var instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfigurationWebserverLogs();
      //expect(instance).to.be.a(AmazonMwaa.CreateEnvironmentRequestLoggingConfigurationWebserverLogs);
    });
