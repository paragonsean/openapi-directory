...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.GetEnvironmentOutputEnvironment();
  });
  ...
  describe('GetEnvironmentOutputEnvironment', function() {
    it('should create an instance of GetEnvironmentOutputEnvironment', function() {
      // uncomment below and update the code to test GetEnvironmentOutputEnvironment
      //var instance = new AmazonMwaa.GetEnvironmentOutputEnvironment();
      //expect(instance).to.be.a(AmazonMwaa.GetEnvironmentOutputEnvironment);
    });
    ...
    it('should have the property webserverUrl (base name: "WebserverUrl")', function() {
      // uncomment below and update the code to test the property webserverUrl
      //var instance = new AmazonMwaa.GetEnvironmentOutputEnvironment();
      //expect(instance).to.be();
    });
