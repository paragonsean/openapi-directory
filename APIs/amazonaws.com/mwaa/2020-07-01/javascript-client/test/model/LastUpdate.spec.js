...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.LastUpdate();
  });
  ...
  describe('LastUpdate', function() {
    it('should create an instance of LastUpdate', function() {
      // uncomment below and update the code to test LastUpdate
      //var instance = new AmazonMwaa.LastUpdate();
      //expect(instance).to.be.a(AmazonMwaa.LastUpdate);
    });
