...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.UpdateEnvironmentInput();
  });
  ...
  describe('UpdateEnvironmentInput', function() {
    it('should create an instance of UpdateEnvironmentInput', function() {
      ...
      //var instance = new AmazonMwaa.UpdateEnvironmentInput();
      //expect(instance).to.be.a(AmazonMwaa.UpdateEnvironmentInput);
    });
