...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfigurationTaskLogs();
  });
  ...
  describe('CreateEnvironmentRequestLoggingConfigurationTaskLogs', function() {
    it('should create an instance of CreateEnvironmentRequestLoggingConfigurationTaskLogs', function() {
      // uncomment below and update the code to test CreateEnvironmentRequestLoggingConfigurationTaskLogs
      //var instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfigurationTaskLogs();
      //expect(instance).to.be.a(AmazonMwaa.CreateEnvironmentRequestLoggingConfigurationTaskLogs);
    });
