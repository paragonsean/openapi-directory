...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.ListEnvironmentsOutput();
  });
  ...
  describe('ListEnvironmentsOutput', function() {
    it('should create an instance of ListEnvironmentsOutput', function() {
      // uncomment below and update the code to test ListEnvironmentsOutput
      //var instance = new AmazonMwaa.ListEnvironmentsOutput();
      //expect(instance).to.be.a(AmazonMwaa.ListEnvironmentsOutput);
    });
