...
(function(root, factory) {
  ...
  describe('WebserverAccessMode', function() {
    it('should create an instance of WebserverAccessMode', function() {
      // uncomment below and update the code to test WebserverAccessMode
      //var instance = new AmazonMwaa.WebserverAccessMode();
      //expect(instance).to.be.a(AmazonMwaa.WebserverAccessMode);
    });
