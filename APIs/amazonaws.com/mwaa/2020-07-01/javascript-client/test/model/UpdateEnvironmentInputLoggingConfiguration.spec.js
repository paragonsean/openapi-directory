...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.UpdateEnvironmentInputLoggingConfiguration();
  });
  ...
  describe('UpdateEnvironmentInputLoggingConfiguration', function() {
    it('should create an instance of UpdateEnvironmentInputLoggingConfiguration', function() {
      // uncomment below and update the code to test UpdateEnvironmentInputLoggingConfiguration
      //var instance = new AmazonMwaa.UpdateEnvironmentInputLoggingConfiguration();
      //expect(instance).to.be.a(AmazonMwaa.UpdateEnvironmentInputLoggingConfiguration);
    });
