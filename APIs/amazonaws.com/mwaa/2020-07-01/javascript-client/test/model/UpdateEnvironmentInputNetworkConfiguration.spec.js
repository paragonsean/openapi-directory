...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.UpdateEnvironmentInputNetworkConfiguration();
  });
  ...
  describe('UpdateEnvironmentInputNetworkConfiguration', function() {
    it('should create an instance of UpdateEnvironmentInputNetworkConfiguration', function() {
      // uncomment below and update the code to test UpdateEnvironmentInputNetworkConfiguration
      //var instance = new AmazonMwaa.UpdateEnvironmentInputNetworkConfiguration();
      //expect(instance).to.be.a(AmazonMwaa.UpdateEnvironmentInputNetworkConfiguration);
    });
