...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateEnvironmentInput();
  });
  ...
  describe('CreateEnvironmentInput', function() {
    it('should create an instance of CreateEnvironmentInput', function() {
      ...
      //var instance = new AmazonMwaa.CreateEnvironmentInput();
      //expect(instance).to.be.a(AmazonMwaa.CreateEnvironmentInput);
    });
