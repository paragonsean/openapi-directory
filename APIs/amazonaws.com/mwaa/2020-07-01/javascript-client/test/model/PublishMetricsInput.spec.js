...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.PublishMetricsInput();
  });
  ...
  describe('PublishMetricsInput', function() {
    it('should create an instance of PublishMetricsInput', function() {
      // uncomment below and update the code to test PublishMetricsInput
      //var instance = new AmazonMwaa.PublishMetricsInput();
      //expect(instance).to.be.a(AmazonMwaa.PublishMetricsInput);
    });
