...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.ListTagsForResourceOutput();
  });
  ...
  describe('ListTagsForResourceOutput', function() {
    it('should create an instance of ListTagsForResourceOutput', function() {
      ...
      //var instance = new AmazonMwaa.ListTagsForResourceOutput();
      //expect(instance).to.be.a(AmazonMwaa.ListTagsForResourceOutput);
    });
