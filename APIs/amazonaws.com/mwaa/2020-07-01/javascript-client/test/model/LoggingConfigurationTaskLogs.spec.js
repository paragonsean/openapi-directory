...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.LoggingConfigurationTaskLogs();
  });
  ...
  describe('LoggingConfigurationTaskLogs', function() {
    it('should create an instance of LoggingConfigurationTaskLogs', function() {
      // uncomment below and update the code to test LoggingConfigurationTaskLogs
      //var instance = new AmazonMwaa.LoggingConfigurationTaskLogs();
      //expect(instance).to.be.a(AmazonMwaa.LoggingConfigurationTaskLogs);
    });
