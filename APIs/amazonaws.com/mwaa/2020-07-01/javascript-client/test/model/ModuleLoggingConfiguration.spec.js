...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.ModuleLoggingConfiguration();
  });
  ...
  describe('ModuleLoggingConfiguration', function() {
    it('should create an instance of ModuleLoggingConfiguration', function() {
      // uncomment below and update the code to test ModuleLoggingConfiguration
      //var instance = new AmazonMwaa.ModuleLoggingConfiguration();
      //expect(instance).to.be.a(AmazonMwaa.ModuleLoggingConfiguration);
    });
