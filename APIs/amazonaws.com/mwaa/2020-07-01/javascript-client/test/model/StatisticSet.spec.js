...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.StatisticSet();
  });
  ...
  describe('StatisticSet', function() {
    it('should create an instance of StatisticSet', function() {
      // uncomment below and update the code to test StatisticSet
      //var instance = new AmazonMwaa.StatisticSet();
      //expect(instance).to.be.a(AmazonMwaa.StatisticSet);
    });
