...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.UpdateNetworkConfigurationInput();
  });
  ...
  describe('UpdateNetworkConfigurationInput', function() {
    it('should create an instance of UpdateNetworkConfigurationInput', function() {
      // uncomment below and update the code to test UpdateNetworkConfigurationInput
      //var instance = new AmazonMwaa.UpdateNetworkConfigurationInput();
      //expect(instance).to.be.a(AmazonMwaa.UpdateNetworkConfigurationInput);
    });
