...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.MetricDatumStatisticValues();
  });
  ...
  describe('MetricDatumStatisticValues', function() {
    it('should create an instance of MetricDatumStatisticValues', function() {
      // uncomment below and update the code to test MetricDatumStatisticValues
      //var instance = new AmazonMwaa.MetricDatumStatisticValues();
      //expect(instance).to.be.a(AmazonMwaa.MetricDatumStatisticValues);
    });
