...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateCliTokenResponse();
  });
  ...
  describe('CreateCliTokenResponse', function() {
    it('should create an instance of CreateCliTokenResponse', function() {
      // uncomment below and update the code to test CreateCliTokenResponse
      //var instance = new AmazonMwaa.CreateCliTokenResponse();
      //expect(instance).to.be.a(AmazonMwaa.CreateCliTokenResponse);
    });

    it('should have the property cliToken (base name: "CliToken")', function() {
      // uncomment below and update the code to test the property cliToken
      //var instance = new AmazonMwaa.CreateCliTokenResponse();
