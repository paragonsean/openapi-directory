...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.EnvironmentLastUpdate();
  });
  ...
  describe('EnvironmentLastUpdate', function() {
    it('should create an instance of EnvironmentLastUpdate', function() {
      // uncomment below and update the code to test EnvironmentLastUpdate
      //var instance = new AmazonMwaa.EnvironmentLastUpdate();
      //expect(instance).to.be.a(AmazonMwaa.EnvironmentLastUpdate);
    });
