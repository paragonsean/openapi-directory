...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateWebLoginTokenResponse();
  });
  ...
  describe('CreateWebLoginTokenResponse', function() {
    it('should create an instance of CreateWebLoginTokenResponse', function() {
      // uncomment below and update the code to test CreateWebLoginTokenResponse
      //var instance = new AmazonMwaa.CreateWebLoginTokenResponse();
      //expect(instance).to.be.a(AmazonMwaa.CreateWebLoginTokenResponse);
    });

    it('should have the property webServerHostname (base name: "WebServerHostname")', function() {
      // uncomment below and update the code to test the property webServerHostname
      //var instance = new AmazonMwaa.CreateWebLoginTokenResponse();
      //expect(instance).to.be();
    });

    it('should have the property webToken (base name: "WebToken")', function() {
      // uncomment below and update the code to test the property webToken
      //var instance = new AmazonMwaa.CreateWebLoginTokenResponse();
      //expect(instance).to.be();
    });
