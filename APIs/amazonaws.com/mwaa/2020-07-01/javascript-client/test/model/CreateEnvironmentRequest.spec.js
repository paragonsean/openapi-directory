...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateEnvironmentRequest();
  });
  ...
  describe('CreateEnvironmentRequest', function() {
    it('should create an instance of CreateEnvironmentRequest', function() {
      ...
      //var instance = new AmazonMwaa.CreateEnvironmentRequest();
      //expect(instance).to.be.a(AmazonMwaa.CreateEnvironmentRequest);
    });
