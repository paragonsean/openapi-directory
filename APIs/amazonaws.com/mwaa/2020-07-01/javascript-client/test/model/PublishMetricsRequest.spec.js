...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.PublishMetricsRequest();
  });
  ...
  describe('PublishMetricsRequest', function() {
    it('should create an instance of PublishMetricsRequest', function() {
      // uncomment below and update the code to test PublishMetricsRequest
      //var instance = new AmazonMwaa.PublishMetricsRequest();
      //expect(instance).to.be.a(AmazonMwaa.PublishMetricsRequest);
    });

    it('should have the property metricData (base name: "MetricData")', function() {
      // uncomment below and update the code to test the property metricData
      //var instance = new AmazonMwaa.PublishMetricsRequest();
