...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateEnvironmentInputNetworkConfiguration();
  });
  ...
  describe('CreateEnvironmentInputNetworkConfiguration', function() {
    it('should create an instance of CreateEnvironmentInputNetworkConfiguration', function() {
      // uncomment below and update the code to test CreateEnvironmentInputNetworkConfiguration
      //var instance = new AmazonMwaa.CreateEnvironmentInputNetworkConfiguration();
      //expect(instance).to.be.a(AmazonMwaa.CreateEnvironmentInputNetworkConfiguration);
    });
