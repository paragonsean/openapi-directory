...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.LoggingConfigurationInput();
  });
  ...
  describe('LoggingConfigurationInput', function() {
    it('should create an instance of LoggingConfigurationInput', function() {
      // uncomment below and update the code to test LoggingConfigurationInput
      //var instance = new AmazonMwaa.LoggingConfigurationInput();
      //expect(instance).to.be.a(AmazonMwaa.LoggingConfigurationInput);
    });
