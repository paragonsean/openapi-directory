...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfigurationDagProcessingLogs();
  });
  ...
  describe('CreateEnvironmentRequestLoggingConfigurationDagProcessingLogs', function() {
    it('should create an instance of CreateEnvironmentRequestLoggingConfigurationDagProcessingLogs', function() {
      // uncomment below and update the code to test CreateEnvironmentRequestLoggingConfigurationDagProcessingLogs
      //var instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfigurationDagProcessingLogs();
      //expect(instance).to.be.a(AmazonMwaa.CreateEnvironmentRequestLoggingConfigurationDagProcessingLogs);
    });
