...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfiguration();
  });
  ...
  describe('CreateEnvironmentRequestLoggingConfiguration', function() {
    it('should create an instance of CreateEnvironmentRequestLoggingConfiguration', function() {
      // uncomment below and update the code to test CreateEnvironmentRequestLoggingConfiguration
      //var instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfiguration();
      //expect(instance).to.be.a(AmazonMwaa.CreateEnvironmentRequestLoggingConfiguration);
    });

    it('should have the property dagProcessingLogs (base name: "DagProcessingLogs")', function() {
      // uncomment below and update the code to test the property dagProcessingLogs
      //var instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property schedulerLogs (base name: "SchedulerLogs")', function() {
      // uncomment below and update the code to test the property schedulerLogs
      //var instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property taskLogs (base name: "TaskLogs")', function() {
      // uncomment below and update the code to test the property taskLogs
      //var instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property webserverLogs (base name: "WebserverLogs")', function() {
      // uncomment below and update the code to test the property webserverLogs
      //var instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property workerLogs (base name: "WorkerLogs")', function() {
      // uncomment below and update the code to test the property workerLogs
      //var instance = new AmazonMwaa.CreateEnvironmentRequestLoggingConfiguration();
      //expect(instance).to.be();
    });
