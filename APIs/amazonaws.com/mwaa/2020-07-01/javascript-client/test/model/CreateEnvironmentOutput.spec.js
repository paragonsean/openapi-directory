...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.CreateEnvironmentOutput();
  });
  ...
  describe('CreateEnvironmentOutput', function() {
    it('should create an instance of CreateEnvironmentOutput', function() {
      // uncomment below and update the code to test CreateEnvironmentOutput
      //var instance = new AmazonMwaa.CreateEnvironmentOutput();
      //expect(instance).to.be.a(AmazonMwaa.CreateEnvironmentOutput);
    });
