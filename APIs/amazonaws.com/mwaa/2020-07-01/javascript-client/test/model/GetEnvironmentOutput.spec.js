...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.GetEnvironmentOutput();
  });
  ...
  describe('GetEnvironmentOutput', function() {
    it('should create an instance of GetEnvironmentOutput', function() {
      // uncomment below and update the code to test GetEnvironmentOutput
      //var instance = new AmazonMwaa.GetEnvironmentOutput();
      //expect(instance).to.be.a(AmazonMwaa.GetEnvironmentOutput);
    });
