...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.ModuleLoggingConfigurationInput();
  });
  ...
  describe('ModuleLoggingConfigurationInput', function() {
    it('should create an instance of ModuleLoggingConfigurationInput', function() {
      // uncomment below and update the code to test ModuleLoggingConfigurationInput
      //var instance = new AmazonMwaa.ModuleLoggingConfigurationInput();
      //expect(instance).to.be.a(AmazonMwaa.ModuleLoggingConfigurationInput);
    });
