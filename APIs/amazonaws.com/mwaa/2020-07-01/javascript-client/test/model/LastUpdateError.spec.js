...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMwaa.LastUpdateError();
  });
  ...
  describe('LastUpdateError', function() {
    it('should create an instance of LastUpdateError', function() {
      // uncomment below and update the code to test LastUpdateError
      //var instance = new AmazonMwaa.LastUpdateError();
      //expect(instance).to.be.a(AmazonMwaa.LastUpdateError);
    });
