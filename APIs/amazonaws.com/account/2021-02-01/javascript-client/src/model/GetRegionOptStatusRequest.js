...
/**
 * The GetRegionOptStatusRequest model module.
 * @module model/GetRegionOptStatusRequest
 * @version 2021-02-01
 */
class GetRegionOptStatusRequest {
    /**
     * Constructs a new <code>GetRegionOptStatusRequest</code>.
     * @alias module:model/GetRegionOptStatusRequest
     * @param regionName {String} Specifies the Region-code for a given Region name (for example, <code>af-south-1</code>). This function will return the status of whatever Region you pass into this parameter. 
     */
    constructor(regionName) { 
        
        GetRegionOptStatusRequest.initialize(this, regionName);
    }
    ...
    /**
     * Constructs a <code>GetRegionOptStatusRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRegionOptStatusRequest} obj Optional instance to populate.
     * @return {module:model/GetRegionOptStatusRequest} The populated <code>GetRegionOptStatusRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRegionOptStatusRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRegionOptStatusRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRegionOptStatusRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetRegionOptStatusRequest.RequiredProperties) {
...
GetRegionOptStatusRequest.RequiredProperties = ["RegionName"];
 ...
 */
GetRegionOptStatusRequest.prototype['AccountId'] = undefined;
 ...
 */
GetRegionOptStatusRequest.prototype['RegionName'] = undefined;
...
export default GetRegionOptStatusRequest;
