...
/**
 * The EnableRegionRequest model module.
 * @module model/EnableRegionRequest
 * @version 2021-02-01
 */
class EnableRegionRequest {
    /**
     * Constructs a new <code>EnableRegionRequest</code>.
     * @alias module:model/EnableRegionRequest
    ...
    constructor(regionName) { 
        ...
        EnableRegionRequest.initialize(this, regionName);
    }
    ...
    /**
     * Constructs a <code>EnableRegionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnableRegionRequest} obj Optional instance to populate.
     * @return {module:model/EnableRegionRequest} The populated <code>EnableRegionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnableRegionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>EnableRegionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnableRegionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EnableRegionRequest.RequiredProperties) {
...
EnableRegionRequest.RequiredProperties = ["RegionName"];
 ...
 */
EnableRegionRequest.prototype['AccountId'] = undefined;

/**
 * Specifies the Region-code for a given Region name (for example, <code>af-south-1</code>). When you enable a Region, Amazon Web Services performs actions to prepare your account in that Region, such as distributing your IAM resources to the Region. This process takes a few minutes for most accounts, but it can take several hours. You cannot use the Region until this process is complete. Furthermore, you cannot disable the Region until the enabling process is fully completed.
 * @member {String} RegionName
 */
EnableRegionRequest.prototype['RegionName'] = undefined;
...
export default EnableRegionRequest;
