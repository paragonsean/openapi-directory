...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAccount.GetContactInformationResponseContactInformation();
  });
  ...
  describe('GetContactInformationResponseContactInformation', function() {
    it('should create an instance of GetContactInformationResponseContactInformation', function() {
      // uncomment below and update the code to test GetContactInformationResponseContactInformation
      //var instance = new AwsAccount.GetContactInformationResponseContactInformation();
      //expect(instance).to.be.a(AwsAccount.GetContactInformationResponseContactInformation);
    });
