...
class GetAlternateContactRequest(Model):
    ...
    def __init__(self, account_id: str=None, alternate_contact_type: str=None):
        """GetAlternateContactRequest - a model defined in OpenAPI

        :param account_id: The account_id of this GetAlternateContactRequest.
        :param alternate_contact_type: The alternate_contact_type of this GetAlternateContactRequest.
        """
        self.openapi_types = {
            'account_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetAlternateContactRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetAlternateContact_request of this GetAlternateContactRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_id(self):
        """Gets the account_id of this GetAlternateContactRequest.
        ...
        :return: The account_id of this GetAlternateContactRequest.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this GetAlternateContactRequest.
    ...
    def alternate_contact_type(self):
        """Gets the alternate_contact_type of this GetAlternateContactRequest.

        Specifies which alternate contact you want to retrieve.

        :return: The alternate_contact_type of this GetAlternateContactRequest.
        :rtype: str
        """
    ...
    def alternate_contact_type(self, alternate_contact_type):
        """Sets the alternate_contact_type of this GetAlternateContactRequest.
