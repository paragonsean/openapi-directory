...
#ifndef OAIEventBus_H
#define OAIEventBus_H
...
class OAIEventBus : public OAIObject {
public:
    OAIEventBus();
    OAIEventBus(QString json);
    ~OAIEventBus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventBus)
