...
/*
 * OAIPutPartnerEventsResultEntry.h
 *
 * Represents an event that a partner tried to generate, but failed.
 */

#ifndef OAIPutPartnerEventsResultEntry_H
#define OAIPutPartnerEventsResultEntry_H
...
class OAIPutPartnerEventsResultEntry : public OAIObject {
public:
    OAIPutPartnerEventsResultEntry();
    OAIPutPartnerEventsResultEntry(QString json);
    ~OAIPutPartnerEventsResultEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutPartnerEventsResultEntry)

#endif // OAIPutPartnerEventsResultEntry_H
