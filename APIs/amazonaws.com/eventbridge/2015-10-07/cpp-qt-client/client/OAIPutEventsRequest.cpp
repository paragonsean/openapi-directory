...
QList OAIPutEventsRequest::getEntries() const {
    return m_entries;
}
void OAIPutEventsRequest::setEntries(const QList &entries) {
    m_entries = entries;
    m_entries_isSet = true;
}

bool OAIPutEventsRequest::is_entries_Set() const{
    return m_entries_isSet;
}

bool OAIPutEventsRequest::is_entries_Valid() const{
    return m_entries_isValid;
}

QString OAIPutEventsRequest::getEndpointId() const {
    return m_endpoint_id;
}
void OAIPutEventsRequest::setEndpointId(const QString &endpoint_id) {
    m_endpoint_id = endpoint_id;
    m_endpoint_id_isSet = true;
}

bool OAIPutEventsRequest::is_endpoint_id_Set() const{
    return m_endpoint_id_isSet;
}

bool OAIPutEventsRequest::is_endpoint_id_Valid() const{
