...
/*
 * OAICreateApiDestinationRequest.h
 *
 * 
 */

#ifndef OAICreateApiDestinationRequest_H
#define OAICreateApiDestinationRequest_H
...
class OAICreateApiDestinationRequest : public OAIObject {
public:
    OAICreateApiDestinationRequest();
    OAICreateApiDestinationRequest(QString json);
    ~OAICreateApiDestinationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApiDestinationRequest)

#endif // OAICreateApiDestinationRequest_H
