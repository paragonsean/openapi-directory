...
/*
 * OAIListConnectionsRequest.h
 *
 * 
 */

#ifndef OAIListConnectionsRequest_H
#define OAIListConnectionsRequest_H
...
class OAIListConnectionsRequest : public OAIObject {
public:
    OAIListConnectionsRequest();
    OAIListConnectionsRequest(QString json);
    ~OAIListConnectionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListConnectionsRequest)

#endif // OAIListConnectionsRequest_H
