...
/*
 * OAIDescribeApiDestinationResponse.h
 *
 * 
 */

#ifndef OAIDescribeApiDestinationResponse_H
#define OAIDescribeApiDestinationResponse_H
...
class OAIDescribeApiDestinationResponse : public OAIObject {
public:
    OAIDescribeApiDestinationResponse();
    OAIDescribeApiDestinationResponse(QString json);
    ~OAIDescribeApiDestinationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeApiDestinationResponse)

#endif // OAIDescribeApiDestinationResponse_H
