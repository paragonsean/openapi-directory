...
/*
 * OAICreateConnectionResponse.h
 *
 * 
 */

#ifndef OAICreateConnectionResponse_H
#define OAICreateConnectionResponse_H
...
class OAICreateConnectionResponse : public OAIObject {
public:
    OAICreateConnectionResponse();
    OAICreateConnectionResponse(QString json);
    ~OAICreateConnectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateConnectionResponse)

#endif // OAICreateConnectionResponse_H
