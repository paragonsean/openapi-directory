...
/*
 * OAITarget_RetryPolicy.h
 *
 * 
 */

#ifndef OAITarget_RetryPolicy_H
#define OAITarget_RetryPolicy_H
...
class OAITarget_RetryPolicy : public OAIObject {
public:
    OAITarget_RetryPolicy();
    OAITarget_RetryPolicy(QString json);
    ~OAITarget_RetryPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITarget_RetryPolicy)

#endif // OAITarget_RetryPolicy_H
