...
OAIConnectionState OAIConnection::getConnectionState() const {
    return m_connection_state;
}
void OAIConnection::setConnectionState(const OAIConnectionState &connection_state) {
    m_connection_state = connection_state;
    m_connection_state_isSet = true;
}

bool OAIConnection::is_connection_state_Set() const{
    return m_connection_state_isSet;
}

bool OAIConnection::is_connection_state_Valid() const{
    return m_connection_state_isValid;
}

QString OAIConnection::getStateReason() const {
    return m_state_reason;
}
void OAIConnection::setStateReason(const QString &state_reason) {
    m_state_reason = state_reason;
    m_state_reason_isSet = true;
}

bool OAIConnection::is_state_reason_Set() const{
    return m_state_reason_isSet;
}

bool OAIConnection::is_state_reason_Valid() const{
    return m_state_reason_isValid;
}

OAIConnectionAuthorizationType OAIConnection::getAuthorizationType() const {
    return m_authorization_type;
}
void OAIConnection::setAuthorizationType(const OAIConnectionAuthorizationType &authorization_type) {
    m_authorization_type = authorization_type;
    m_authorization_type_isSet = true;
}

bool OAIConnection::is_authorization_type_Set() const{
    return m_authorization_type_isSet;
}

bool OAIConnection::is_authorization_type_Valid() const{
...
QDateTime OAIConnection::getLastModifiedTime() const {
    return m_last_modified_time;
}
void OAIConnection::setLastModifiedTime(const QDateTime &last_modified_time) {
...
QDateTime OAIConnection::getLastAuthorizedTime() const {
    return m_last_authorized_time;
}
void OAIConnection::setLastAuthorizedTime(const QDateTime &last_authorized_time) {
    m_last_authorized_time = last_authorized_time;
    m_last_authorized_time_isSet = true;
}

bool OAIConnection::is_last_authorized_time_Set() const{
    return m_last_authorized_time_isSet;
}

bool OAIConnection::is_last_authorized_time_Valid() const{
