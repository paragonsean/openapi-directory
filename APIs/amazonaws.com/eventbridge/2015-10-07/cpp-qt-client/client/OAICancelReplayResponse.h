...
/*
 * OAICancelReplayResponse.h
 *
 * 
 */

#ifndef OAICancelReplayResponse_H
#define OAICancelReplayResponse_H
...
class OAICancelReplayResponse : public OAIObject {
public:
    OAICancelReplayResponse();
    OAICancelReplayResponse(QString json);
    ~OAICancelReplayResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelReplayResponse)

#endif // OAICancelReplayResponse_H
