...
OAICreateEndpointRequest_RoutingConfig OAICreateEndpointRequest::getRoutingConfig() const {
    return m_routing_config;
}
void OAICreateEndpointRequest::setRoutingConfig(const OAICreateEndpointRequest_RoutingConfig &routing_config) {
    m_routing_config = routing_config;
    m_routing_config_isSet = true;
}

bool OAICreateEndpointRequest::is_routing_config_Set() const{
    return m_routing_config_isSet;
}

bool OAICreateEndpointRequest::is_routing_config_Valid() const{
    return m_routing_config_isValid;
}

OAICreateEndpointRequest_ReplicationConfig OAICreateEndpointRequest::getReplicationConfig() const {
    return m_replication_config;
}
void OAICreateEndpointRequest::setReplicationConfig(const OAICreateEndpointRequest_ReplicationConfig &replication_config) {
    m_replication_config = replication_config;
    m_replication_config_isSet = true;
}

bool OAICreateEndpointRequest::is_replication_config_Set() const{
    return m_replication_config_isSet;
}

bool OAICreateEndpointRequest::is_replication_config_Valid() const{
    return m_replication_config_isValid;
}

QList OAICreateEndpointRequest::getEventBuses() const {
    return m_event_buses;
}
void OAICreateEndpointRequest::setEventBuses(const QList &event_buses) {
    m_event_buses = event_buses;
    m_event_buses_isSet = true;
}

bool OAICreateEndpointRequest::is_event_buses_Set() const{
    return m_event_buses_isSet;
}

bool OAICreateEndpointRequest::is_event_buses_Valid() const{
    return m_event_buses_isValid;
}

QString OAICreateEndpointRequest::getRoleArn() const {
    return m_role_arn;
}
void OAICreateEndpointRequest::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAICreateEndpointRequest::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAICreateEndpointRequest::is_role_arn_Valid() const{
...
bool OAICreateEndpointRequest::isValid() const {
    ...
    return m_name_isValid && m_routing_config_isValid && m_event_buses_isValid && true;
}
