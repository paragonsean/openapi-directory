...
/*
 * OAIStartReplayResponse.h
 *
 * 
 */

#ifndef OAIStartReplayResponse_H
#define OAIStartReplayResponse_H
...
class OAIStartReplayResponse : public OAIObject {
public:
    OAIStartReplayResponse();
    OAIStartReplayResponse(QString json);
    ~OAIStartReplayResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartReplayResponse)

#endif // OAIStartReplayResponse_H
