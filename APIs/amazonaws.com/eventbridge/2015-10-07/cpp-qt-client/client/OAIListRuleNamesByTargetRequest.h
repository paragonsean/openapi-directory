...
/*
 * OAIListRuleNamesByTargetRequest.h
 *
 * 
 */

#ifndef OAIListRuleNamesByTargetRequest_H
#define OAIListRuleNamesByTargetRequest_H
...
class OAIListRuleNamesByTargetRequest : public OAIObject {
public:
    OAIListRuleNamesByTargetRequest();
    OAIListRuleNamesByTargetRequest(QString json);
    ~OAIListRuleNamesByTargetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRuleNamesByTargetRequest)

#endif // OAIListRuleNamesByTargetRequest_H
