...
/*
 * OAIDeauthorizeConnectionResponse.h
 *
 * 
 */

#ifndef OAIDeauthorizeConnectionResponse_H
#define OAIDeauthorizeConnectionResponse_H
...
class OAIDeauthorizeConnectionResponse : public OAIObject {
public:
    OAIDeauthorizeConnectionResponse();
    OAIDeauthorizeConnectionResponse(QString json);
    ~OAIDeauthorizeConnectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeauthorizeConnectionResponse)

#endif // OAIDeauthorizeConnectionResponse_H
