...
/*
 * OAIDeleteConnectionResponse.h
 *
 * 
 */

#ifndef OAIDeleteConnectionResponse_H
#define OAIDeleteConnectionResponse_H
...
class OAIDeleteConnectionResponse : public OAIObject {
public:
    OAIDeleteConnectionResponse();
    OAIDeleteConnectionResponse(QString json);
    ~OAIDeleteConnectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteConnectionResponse)

#endif // OAIDeleteConnectionResponse_H
