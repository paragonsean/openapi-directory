...
/*
 * OAIDescribeRuleResponse.h
 *
 * 
 */

#ifndef OAIDescribeRuleResponse_H
#define OAIDescribeRuleResponse_H
...
class OAIDescribeRuleResponse : public OAIObject {
public:
    OAIDescribeRuleResponse();
    OAIDescribeRuleResponse(QString json);
    ~OAIDescribeRuleResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRuleResponse)

#endif // OAIDescribeRuleResponse_H
