...
OAITarget_RetryPolicy::OAITarget_RetryPolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITarget_RetryPolicy::OAITarget_RetryPolicy() {
    this->initializeModel();
}

OAITarget_RetryPolicy::~OAITarget_RetryPolicy() {}

void OAITarget_RetryPolicy::initializeModel() {
...
void OAITarget_RetryPolicy::fromJson(QString jsonString) {
...
void OAITarget_RetryPolicy::fromJsonObject(QJsonObject json) {
...
QString OAITarget_RetryPolicy::asJson() const {
...
QJsonObject OAITarget_RetryPolicy::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAITarget_RetryPolicy::getMaximumRetryAttempts() const {
    return m_maximum_retry_attempts;
}
void OAITarget_RetryPolicy::setMaximumRetryAttempts(const qint32 &maximum_retry_attempts) {
    m_maximum_retry_attempts = maximum_retry_attempts;
    m_maximum_retry_attempts_isSet = true;
}

bool OAITarget_RetryPolicy::is_maximum_retry_attempts_Set() const{
    return m_maximum_retry_attempts_isSet;
}

bool OAITarget_RetryPolicy::is_maximum_retry_attempts_Valid() const{
    return m_maximum_retry_attempts_isValid;
}

qint32 OAITarget_RetryPolicy::getMaximumEventAgeInSeconds() const {
    return m_maximum_event_age_in_seconds;
}
void OAITarget_RetryPolicy::setMaximumEventAgeInSeconds(const qint32 &maximum_event_age_in_seconds) {
    m_maximum_event_age_in_seconds = maximum_event_age_in_seconds;
    m_maximum_event_age_in_seconds_isSet = true;
}

bool OAITarget_RetryPolicy::is_maximum_event_age_in_seconds_Set() const{
    return m_maximum_event_age_in_seconds_isSet;
}

bool OAITarget_RetryPolicy::is_maximum_event_age_in_seconds_Valid() const{
    return m_maximum_event_age_in_seconds_isValid;
}

bool OAITarget_RetryPolicy::isSet() const {
...
bool OAITarget_RetryPolicy::isValid() const {
