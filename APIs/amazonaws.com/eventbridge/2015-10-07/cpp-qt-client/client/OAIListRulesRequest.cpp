...
QString OAIListRulesRequest::getNamePrefix() const {
    return m_name_prefix;
}
void OAIListRulesRequest::setNamePrefix(const QString &name_prefix) {
    m_name_prefix = name_prefix;
    m_name_prefix_isSet = true;
}

bool OAIListRulesRequest::is_name_prefix_Set() const{
    return m_name_prefix_isSet;
}

bool OAIListRulesRequest::is_name_prefix_Valid() const{
    return m_name_prefix_isValid;
}

QString OAIListRulesRequest::getEventBusName() const {
    return m_event_bus_name;
}
void OAIListRulesRequest::setEventBusName(const QString &event_bus_name) {
    m_event_bus_name = event_bus_name;
    m_event_bus_name_isSet = true;
}

bool OAIListRulesRequest::is_event_bus_name_Set() const{
    return m_event_bus_name_isSet;
}

bool OAIListRulesRequest::is_event_bus_name_Valid() const{
