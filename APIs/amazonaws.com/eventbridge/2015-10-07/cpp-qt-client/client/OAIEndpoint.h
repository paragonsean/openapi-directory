...
namespace OpenAPI {
class OAIEndpoint_RoutingConfig;
class OAIEndpoint_ReplicationConfig;
...
public:
    ...
    OAIEndpoint_RoutingConfig getRoutingConfig() const;
    void setRoutingConfig(const OAIEndpoint_RoutingConfig &routing_config);
    bool is_routing_config_Set() const;
    bool is_routing_config_Valid() const;

    OAIEndpoint_ReplicationConfig getReplicationConfig() const;
    void setReplicationConfig(const OAIEndpoint_ReplicationConfig &replication_config);
...
private:
    ...
    OAIEndpoint_RoutingConfig m_routing_config;
    bool m_routing_config_isSet;
    bool m_routing_config_isValid;

    OAIEndpoint_ReplicationConfig m_replication_config;
