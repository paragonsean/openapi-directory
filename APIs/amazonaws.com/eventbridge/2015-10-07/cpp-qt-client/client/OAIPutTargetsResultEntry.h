...
/*
 * OAIPutTargetsResultEntry.h
 *
 * Represents a target that failed to be added to a rule.
 */

#ifndef OAIPutTargetsResultEntry_H
#define OAIPutTargetsResultEntry_H
...
class OAIPutTargetsResultEntry : public OAIObject {
public:
    OAIPutTargetsResultEntry();
    OAIPutTargetsResultEntry(QString json);
    ~OAIPutTargetsResultEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutTargetsResultEntry)

#endif // OAIPutTargetsResultEntry_H
