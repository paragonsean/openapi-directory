...
/*
 * OAIUpdateArchiveRequest.h
 *
 * 
 */

#ifndef OAIUpdateArchiveRequest_H
#define OAIUpdateArchiveRequest_H
...
class OAIUpdateArchiveRequest : public OAIObject {
public:
    OAIUpdateArchiveRequest();
    OAIUpdateArchiveRequest(QString json);
    ~OAIUpdateArchiveRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateArchiveRequest)

#endif // OAIUpdateArchiveRequest_H
