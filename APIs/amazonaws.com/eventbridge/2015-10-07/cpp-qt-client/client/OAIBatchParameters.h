...
/*
 * OAIBatchParameters.h
 *
 * The custom parameters to be used when the target is an Batch job.
 */

#ifndef OAIBatchParameters_H
#define OAIBatchParameters_H
...
class OAIBatchParameters : public OAIObject {
public:
    OAIBatchParameters();
    OAIBatchParameters(QString json);
    ~OAIBatchParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchParameters)

#endif // OAIBatchParameters_H
