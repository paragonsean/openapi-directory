...
/*
 * OAIDescribeConnectionResponse.h
 *
 * 
 */

#ifndef OAIDescribeConnectionResponse_H
#define OAIDescribeConnectionResponse_H

#include <QJsonObject>

#include "OAIConnectionAuthorizationType.h"
#include "OAIConnectionState.h"
#include "OAIDescribeConnectionResponse_AuthParameters.h"
#include <QDateTime>
#include <QString>
...
namespace OpenAPI {
class OAIDescribeConnectionResponse_AuthParameters;

class OAIDescribeConnectionResponse : public OAIObject {
public:
    OAIDescribeConnectionResponse();
    OAIDescribeConnectionResponse(QString json);
    ~OAIDescribeConnectionResponse() override;
    ...
    OAIDescribeConnectionResponse_AuthParameters getAuthParameters() const;
    void setAuthParameters(const OAIDescribeConnectionResponse_AuthParameters &auth_parameters);
...
private:
    ...
    OAIDescribeConnectionResponse_AuthParameters m_auth_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeConnectionResponse)

#endif // OAIDescribeConnectionResponse_H
