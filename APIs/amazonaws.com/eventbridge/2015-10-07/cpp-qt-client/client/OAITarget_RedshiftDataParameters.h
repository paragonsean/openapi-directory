...
/*
 * OAITarget_RedshiftDataParameters.h
 *
 * 
 */

#ifndef OAITarget_RedshiftDataParameters_H
#define OAITarget_RedshiftDataParameters_H
...
class OAITarget_RedshiftDataParameters : public OAIObject {
public:
    OAITarget_RedshiftDataParameters();
    OAITarget_RedshiftDataParameters(QString json);
    ~OAITarget_RedshiftDataParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITarget_RedshiftDataParameters)

#endif // OAITarget_RedshiftDataParameters_H
