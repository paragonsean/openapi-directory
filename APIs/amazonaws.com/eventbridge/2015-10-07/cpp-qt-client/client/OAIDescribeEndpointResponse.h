...
/*
 * OAIDescribeEndpointResponse.h
 *
 * 
 */

#ifndef OAIDescribeEndpointResponse_H
#define OAIDescribeEndpointResponse_H

#include <QJsonObject>

#include "OAIDescribeEndpointResponse_ReplicationConfig.h"
...
namespace OpenAPI {
class OAIDescribeEndpointResponse_RoutingConfig;
class OAIDescribeEndpointResponse_ReplicationConfig;

class OAIDescribeEndpointResponse : public OAIObject {
public:
    OAIDescribeEndpointResponse();
    OAIDescribeEndpointResponse(QString json);
    ~OAIDescribeEndpointResponse() override;
    ...
    OAIDescribeEndpointResponse_RoutingConfig getRoutingConfig() const;
    void setRoutingConfig(const OAIDescribeEndpointResponse_RoutingConfig &routing_config);
    bool is_routing_config_Set() const;
    bool is_routing_config_Valid() const;

    OAIDescribeEndpointResponse_ReplicationConfig getReplicationConfig() const;
    void setReplicationConfig(const OAIDescribeEndpointResponse_ReplicationConfig &replication_config);
...
private:
    ...
    OAIDescribeEndpointResponse_RoutingConfig m_routing_config;
    bool m_routing_config_isSet;
    bool m_routing_config_isValid;

    OAIDescribeEndpointResponse_ReplicationConfig m_replication_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEndpointResponse)

#endif // OAIDescribeEndpointResponse_H
