...
#ifndef OAIApiDestination_H
#define OAIApiDestination_H
...
class OAIApiDestination : public OAIObject {
public:
    OAIApiDestination();
    OAIApiDestination(QString json);
    ~OAIApiDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApiDestination)

#endif // OAIApiDestination_H
