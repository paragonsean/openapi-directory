...
/*
 * OAIRemoveTargetsRequest.h
 *
 * 
 */

#ifndef OAIRemoveTargetsRequest_H
#define OAIRemoveTargetsRequest_H
...
class OAIRemoveTargetsRequest : public OAIObject {
public:
    OAIRemoveTargetsRequest();
    OAIRemoveTargetsRequest(QString json);
    ~OAIRemoveTargetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveTargetsRequest)

#endif // OAIRemoveTargetsRequest_H
