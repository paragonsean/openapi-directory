...
/*
 * OAITarget_EcsParameters.h
 *
 * 
 */

#ifndef OAITarget_EcsParameters_H
#define OAITarget_EcsParameters_H
...
class OAITarget_EcsParameters : public OAIObject {
public:
    OAITarget_EcsParameters();
    OAITarget_EcsParameters(QString json);
    ~OAITarget_EcsParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITarget_EcsParameters)

#endif // OAITarget_EcsParameters_H
