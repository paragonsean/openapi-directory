...
public class ConnectionAuthResponseParameters {
  ...
  public ConnectionAuthResponseParameters basicAuthParameters(ConnectionAuthResponseParametersBasicAuthParameters basicAuthParameters) {
  ...
  public ConnectionAuthResponseParameters oauthParameters(ConnectionAuthResponseParametersOAuthParameters oauthParameters) {
  ...
  public ConnectionAuthResponseParameters apiKeyAuthParameters(ConnectionAuthResponseParametersApiKeyAuthParameters apiKeyAuthParameters) {
  ...
  public ConnectionAuthResponseParameters invocationHttpParameters(ConnectionAuthResponseParametersInvocationHttpParameters invocationHttpParameters) {
  ...
  public boolean equals(Object o) {
    ...
    ConnectionAuthResponseParameters connectionAuthResponseParameters = (ConnectionAuthResponseParameters) o;
    return Objects.equals(this.basicAuthParameters, connectionAuthResponseParameters.basicAuthParameters) &&
        Objects.equals(this.oauthParameters, connectionAuthResponseParameters.oauthParameters) &&
        Objects.equals(this.apiKeyAuthParameters, connectionAuthResponseParameters.apiKeyAuthParameters) &&
        Objects.equals(this.invocationHttpParameters, connectionAuthResponseParameters.invocationHttpParameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectionAuthResponseParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectionAuthResponseParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectionAuthResponseParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectionAuthResponseParameters is not found in the empty JSON string", ConnectionAuthResponseParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectionAuthResponseParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectionAuthResponseParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectionAuthResponseParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectionAuthResponseParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectionAuthResponseParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectionAuthResponseParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectionAuthResponseParameters>() {
           @Override
           public void write(JsonWriter out, ConnectionAuthResponseParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectionAuthResponseParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectionAuthResponseParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectionAuthResponseParameters
   * @throws IOException if the JSON string is invalid with respect to ConnectionAuthResponseParameters
   */
  public static ConnectionAuthResponseParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectionAuthResponseParameters.class);
  }

  /**
   * Convert an instance of ConnectionAuthResponseParameters to an JSON string
   *
   * @return JSON string
   */
