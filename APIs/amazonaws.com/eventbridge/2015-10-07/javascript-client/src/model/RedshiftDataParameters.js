...
/**
 * The RedshiftDataParameters model module.
 * @module model/RedshiftDataParameters
 * @version 2015-10-07
 */
class RedshiftDataParameters {
    /**
     * Constructs a new <code>RedshiftDataParameters</code>.
     ...
     * @alias module:model/RedshiftDataParameters
    ...
    /**
     * Constructs a <code>RedshiftDataParameters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RedshiftDataParameters} obj Optional instance to populate.
     * @return {module:model/RedshiftDataParameters} The populated <code>RedshiftDataParameters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedshiftDataParameters();
    ...
    /**
     * Validates the JSON data with respect to <code>RedshiftDataParameters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedshiftDataParameters</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RedshiftDataParameters.RequiredProperties) {
...
RedshiftDataParameters.RequiredProperties = ["Database"];
...
export default RedshiftDataParameters;
