...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.ListArchivesResponse();
  });
  ...
  describe('ListArchivesResponse', function() {
    it('should create an instance of ListArchivesResponse', function() {
      // uncomment below and update the code to test ListArchivesResponse
      //var instance = new AmazonEventBridge.ListArchivesResponse();
      //expect(instance).to.be.a(AmazonEventBridge.ListArchivesResponse);
    });
