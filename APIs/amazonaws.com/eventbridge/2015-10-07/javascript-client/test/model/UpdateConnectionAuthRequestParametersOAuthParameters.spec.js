...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.UpdateConnectionAuthRequestParametersOAuthParameters();
  });
  ...
  describe('UpdateConnectionAuthRequestParametersOAuthParameters', function() {
    it('should create an instance of UpdateConnectionAuthRequestParametersOAuthParameters', function() {
      // uncomment below and update the code to test UpdateConnectionAuthRequestParametersOAuthParameters
      //var instance = new AmazonEventBridge.UpdateConnectionAuthRequestParametersOAuthParameters();
      //expect(instance).to.be.a(AmazonEventBridge.UpdateConnectionAuthRequestParametersOAuthParameters);
    });
