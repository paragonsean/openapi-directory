...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.CreateConnectionOAuthRequestParameters();
  });
  ...
  describe('CreateConnectionOAuthRequestParameters', function() {
    it('should create an instance of CreateConnectionOAuthRequestParameters', function() {
      // uncomment below and update the code to test CreateConnectionOAuthRequestParameters
      //var instance = new AmazonEventBridge.CreateConnectionOAuthRequestParameters();
      //expect(instance).to.be.a(AmazonEventBridge.CreateConnectionOAuthRequestParameters);
    });
