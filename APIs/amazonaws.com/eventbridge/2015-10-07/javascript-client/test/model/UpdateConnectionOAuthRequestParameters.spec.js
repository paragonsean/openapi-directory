...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.UpdateConnectionOAuthRequestParameters();
  });
  ...
  describe('UpdateConnectionOAuthRequestParameters', function() {
    it('should create an instance of UpdateConnectionOAuthRequestParameters', function() {
      // uncomment below and update the code to test UpdateConnectionOAuthRequestParameters
      //var instance = new AmazonEventBridge.UpdateConnectionOAuthRequestParameters();
      //expect(instance).to.be.a(AmazonEventBridge.UpdateConnectionOAuthRequestParameters);
    });
