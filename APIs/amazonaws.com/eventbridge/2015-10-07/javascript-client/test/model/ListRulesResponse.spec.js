...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.ListRulesResponse();
  });
  ...
  describe('ListRulesResponse', function() {
    it('should create an instance of ListRulesResponse', function() {
      ...
      //var instance = new AmazonEventBridge.ListRulesResponse();
      //expect(instance).to.be.a(AmazonEventBridge.ListRulesResponse);
    });
