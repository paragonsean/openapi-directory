...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.StartReplayRequest();
  });
  ...
  describe('StartReplayRequest', function() {
    it('should create an instance of StartReplayRequest', function() {
      // uncomment below and update the code to test StartReplayRequest
      //var instance = new AmazonEventBridge.StartReplayRequest();
      //expect(instance).to.be.a(AmazonEventBridge.StartReplayRequest);
    });
