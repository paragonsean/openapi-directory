...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.DescribeEndpointResponse();
  });
  ...
  describe('DescribeEndpointResponse', function() {
    it('should create an instance of DescribeEndpointResponse', function() {
      // uncomment below and update the code to test DescribeEndpointResponse
      //var instance = new AmazonEventBridge.DescribeEndpointResponse();
      //expect(instance).to.be.a(AmazonEventBridge.DescribeEndpointResponse);
    });
