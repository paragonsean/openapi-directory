...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.PutEventsResultEntry();
  });
  ...
  describe('PutEventsResultEntry', function() {
    it('should create an instance of PutEventsResultEntry', function() {
      // uncomment below and update the code to test PutEventsResultEntry
      //var instance = new AmazonEventBridge.PutEventsResultEntry();
      //expect(instance).to.be.a(AmazonEventBridge.PutEventsResultEntry);
    });
