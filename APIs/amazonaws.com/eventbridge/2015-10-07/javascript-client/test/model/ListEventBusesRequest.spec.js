...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.ListEventBusesRequest();
  });
  ...
  describe('ListEventBusesRequest', function() {
    it('should create an instance of ListEventBusesRequest', function() {
      // uncomment below and update the code to test ListEventBusesRequest
      //var instance = new AmazonEventBridge.ListEventBusesRequest();
      //expect(instance).to.be.a(AmazonEventBridge.ListEventBusesRequest);
    });
