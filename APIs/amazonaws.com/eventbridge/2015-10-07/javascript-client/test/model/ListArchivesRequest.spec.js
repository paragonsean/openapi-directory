...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.ListArchivesRequest();
  });
  ...
  describe('ListArchivesRequest', function() {
    it('should create an instance of ListArchivesRequest', function() {
      // uncomment below and update the code to test ListArchivesRequest
      //var instance = new AmazonEventBridge.ListArchivesRequest();
      //expect(instance).to.be.a(AmazonEventBridge.ListArchivesRequest);
    });
