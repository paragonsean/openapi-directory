...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.ListEndpointsRequest();
  });
  ...
  describe('ListEndpointsRequest', function() {
    it('should create an instance of ListEndpointsRequest', function() {
      // uncomment below and update the code to test ListEndpointsRequest
      //var instance = new AmazonEventBridge.ListEndpointsRequest();
      //expect(instance).to.be.a(AmazonEventBridge.ListEndpointsRequest);
    });
