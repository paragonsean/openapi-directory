...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.PutTargetsResultEntry();
  });
  ...
  describe('PutTargetsResultEntry', function() {
    it('should create an instance of PutTargetsResultEntry', function() {
      // uncomment below and update the code to test PutTargetsResultEntry
      //var instance = new AmazonEventBridge.PutTargetsResultEntry();
      //expect(instance).to.be.a(AmazonEventBridge.PutTargetsResultEntry);
    });
