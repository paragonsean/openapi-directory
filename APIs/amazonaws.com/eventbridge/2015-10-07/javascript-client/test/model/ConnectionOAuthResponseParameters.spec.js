...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.ConnectionOAuthResponseParameters();
  });
  ...
  describe('ConnectionOAuthResponseParameters', function() {
    it('should create an instance of ConnectionOAuthResponseParameters', function() {
      // uncomment below and update the code to test ConnectionOAuthResponseParameters
      //var instance = new AmazonEventBridge.ConnectionOAuthResponseParameters();
      //expect(instance).to.be.a(AmazonEventBridge.ConnectionOAuthResponseParameters);
    });
