...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.PutEventsRequest();
  });
  ...
  describe('PutEventsRequest', function() {
    it('should create an instance of PutEventsRequest', function() {
      ...
      //var instance = new AmazonEventBridge.PutEventsRequest();
      //expect(instance).to.be.a(AmazonEventBridge.PutEventsRequest);
    });
