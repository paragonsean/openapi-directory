...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.DescribeEventSourceResponse();
  });
  ...
  describe('DescribeEventSourceResponse', function() {
    it('should create an instance of DescribeEventSourceResponse', function() {
      // uncomment below and update the code to test DescribeEventSourceResponse
      //var instance = new AmazonEventBridge.DescribeEventSourceResponse();
      //expect(instance).to.be.a(AmazonEventBridge.DescribeEventSourceResponse);
    });
