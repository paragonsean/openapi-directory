...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.TargetBatchParameters();
  });
  ...
  describe('TargetBatchParameters', function() {
    it('should create an instance of TargetBatchParameters', function() {
      // uncomment below and update the code to test TargetBatchParameters
      //var instance = new AmazonEventBridge.TargetBatchParameters();
      //expect(instance).to.be.a(AmazonEventBridge.TargetBatchParameters);
    });
