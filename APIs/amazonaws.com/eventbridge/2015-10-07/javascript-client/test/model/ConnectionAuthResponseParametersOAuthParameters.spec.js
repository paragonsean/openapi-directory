...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.ConnectionAuthResponseParametersOAuthParameters();
  });
  ...
  describe('ConnectionAuthResponseParametersOAuthParameters', function() {
    it('should create an instance of ConnectionAuthResponseParametersOAuthParameters', function() {
      // uncomment below and update the code to test ConnectionAuthResponseParametersOAuthParameters
      //var instance = new AmazonEventBridge.ConnectionAuthResponseParametersOAuthParameters();
      //expect(instance).to.be.a(AmazonEventBridge.ConnectionAuthResponseParametersOAuthParameters);
    });
