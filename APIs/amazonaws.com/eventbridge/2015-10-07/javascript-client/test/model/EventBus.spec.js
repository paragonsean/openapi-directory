...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.EventBus();
  });
  ...
  describe('EventBus', function() {
    it('should create an instance of EventBus', function() {
      // uncomment below and update the code to test EventBus
      //var instance = new AmazonEventBridge.EventBus();
      //expect(instance).to.be.a(AmazonEventBridge.EventBus);
    });
