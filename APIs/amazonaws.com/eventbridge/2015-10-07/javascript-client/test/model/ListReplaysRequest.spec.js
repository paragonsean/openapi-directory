...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.ListReplaysRequest();
  });
  ...
  describe('ListReplaysRequest', function() {
    it('should create an instance of ListReplaysRequest', function() {
      // uncomment below and update the code to test ListReplaysRequest
      //var instance = new AmazonEventBridge.ListReplaysRequest();
      //expect(instance).to.be.a(AmazonEventBridge.ListReplaysRequest);
    });
