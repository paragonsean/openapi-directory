...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.BatchParameters();
  });
  ...
  describe('BatchParameters', function() {
    it('should create an instance of BatchParameters', function() {
      // uncomment below and update the code to test BatchParameters
      //var instance = new AmazonEventBridge.BatchParameters();
      //expect(instance).to.be.a(AmazonEventBridge.BatchParameters);
    });
