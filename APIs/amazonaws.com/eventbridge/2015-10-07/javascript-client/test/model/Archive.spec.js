...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.Archive();
  });
  ...
  describe('Archive', function() {
    it('should create an instance of Archive', function() {
      // uncomment below and update the code to test Archive
      //var instance = new AmazonEventBridge.Archive();
      //expect(instance).to.be.a(AmazonEventBridge.Archive);
    });
