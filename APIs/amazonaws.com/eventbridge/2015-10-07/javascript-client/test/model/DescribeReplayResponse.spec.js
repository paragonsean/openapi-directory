...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.DescribeReplayResponse();
  });
  ...
  describe('DescribeReplayResponse', function() {
    it('should create an instance of DescribeReplayResponse', function() {
      // uncomment below and update the code to test DescribeReplayResponse
      //var instance = new AmazonEventBridge.DescribeReplayResponse();
      //expect(instance).to.be.a(AmazonEventBridge.DescribeReplayResponse);
    });
    ...
    it('should have the property replayArn (base name: "ReplayArn")', function() {
      // uncomment below and update the code to test the property replayArn
      //var instance = new AmazonEventBridge.DescribeReplayResponse();
      //expect(instance).to.be();
    });
