...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridge.FailoverConfig();
  });
  ...
  describe('FailoverConfig', function() {
    it('should create an instance of FailoverConfig', function() {
      ...
      //var instance = new AmazonEventBridge.FailoverConfig();
      //expect(instance).to.be.a(AmazonEventBridge.FailoverConfig);
    });
