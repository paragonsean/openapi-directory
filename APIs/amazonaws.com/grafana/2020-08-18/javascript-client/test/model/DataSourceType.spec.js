...
(function(root, factory) {
  ...
  describe('DataSourceType', function() {
    it('should create an instance of DataSourceType', function() {
      // uncomment below and update the code to test DataSourceType
      //var instance = new AmazonManagedGrafana.DataSourceType();
      //expect(instance).to.be.a(AmazonManagedGrafana.DataSourceType);
    });
