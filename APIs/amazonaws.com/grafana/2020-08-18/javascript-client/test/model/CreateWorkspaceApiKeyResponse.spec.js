...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedGrafana.CreateWorkspaceApiKeyResponse();
  });
  ...
  describe('CreateWorkspaceApiKeyResponse', function() {
    it('should create an instance of CreateWorkspaceApiKeyResponse', function() {
      // uncomment below and update the code to test CreateWorkspaceApiKeyResponse
      //var instance = new AmazonManagedGrafana.CreateWorkspaceApiKeyResponse();
      //expect(instance).to.be.a(AmazonManagedGrafana.CreateWorkspaceApiKeyResponse);
    });
