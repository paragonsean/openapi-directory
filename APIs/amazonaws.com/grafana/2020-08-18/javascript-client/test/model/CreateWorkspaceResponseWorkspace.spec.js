...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedGrafana.CreateWorkspaceResponseWorkspace();
  });
  ...
  describe('CreateWorkspaceResponseWorkspace', function() {
    it('should create an instance of CreateWorkspaceResponseWorkspace', function() {
      // uncomment below and update the code to test CreateWorkspaceResponseWorkspace
      //var instance = new AmazonManagedGrafana.CreateWorkspaceResponseWorkspace();
      //expect(instance).to.be.a(AmazonManagedGrafana.CreateWorkspaceResponseWorkspace);
    });
