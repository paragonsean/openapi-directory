...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedGrafana.AssociateLicenseResponseWorkspace();
  });
  ...
  describe('AssociateLicenseResponseWorkspace', function() {
    it('should create an instance of AssociateLicenseResponseWorkspace', function() {
      // uncomment below and update the code to test AssociateLicenseResponseWorkspace
      //var instance = new AmazonManagedGrafana.AssociateLicenseResponseWorkspace();
      //expect(instance).to.be.a(AmazonManagedGrafana.AssociateLicenseResponseWorkspace);
    });
