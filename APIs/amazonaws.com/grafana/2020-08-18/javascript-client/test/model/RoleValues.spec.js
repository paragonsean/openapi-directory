...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedGrafana.RoleValues();
  });
  ...
  describe('RoleValues', function() {
    it('should create an instance of RoleValues', function() {
      // uncomment below and update the code to test RoleValues
      //var instance = new AmazonManagedGrafana.RoleValues();
      //expect(instance).to.be.a(AmazonManagedGrafana.RoleValues);
    });
