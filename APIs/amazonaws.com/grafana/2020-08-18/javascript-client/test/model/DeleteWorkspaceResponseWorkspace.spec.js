...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedGrafana.DeleteWorkspaceResponseWorkspace();
  });
  ...
  describe('DeleteWorkspaceResponseWorkspace', function() {
    it('should create an instance of DeleteWorkspaceResponseWorkspace', function() {
      // uncomment below and update the code to test DeleteWorkspaceResponseWorkspace
      //var instance = new AmazonManagedGrafana.DeleteWorkspaceResponseWorkspace();
      //expect(instance).to.be.a(AmazonManagedGrafana.DeleteWorkspaceResponseWorkspace);
    });
