...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedGrafana.DeleteWorkspaceApiKeyResponse();
  });
  ...
  describe('DeleteWorkspaceApiKeyResponse', function() {
    it('should create an instance of DeleteWorkspaceApiKeyResponse', function() {
      // uncomment below and update the code to test DeleteWorkspaceApiKeyResponse
      //var instance = new AmazonManagedGrafana.DeleteWorkspaceApiKeyResponse();
      //expect(instance).to.be.a(AmazonManagedGrafana.DeleteWorkspaceApiKeyResponse);
    });
