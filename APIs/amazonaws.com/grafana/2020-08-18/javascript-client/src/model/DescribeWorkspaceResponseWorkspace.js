...
/**
 * The DescribeWorkspaceResponseWorkspace model module.
 * @module model/DescribeWorkspaceResponseWorkspace
 * @version 2020-08-18
 */
class DescribeWorkspaceResponseWorkspace {
    /**
     * Constructs a new <code>DescribeWorkspaceResponseWorkspace</code>.
     * @alias module:model/DescribeWorkspaceResponseWorkspace
    ...
    constructor(authentication, created, dataSources, endpoint, grafanaVersion, id, modified, status) { 
        ...
        DescribeWorkspaceResponseWorkspace.initialize(this, authentication, created, dataSources, endpoint, grafanaVersion, id, modified, status);
    }
    ...
    /**
     * Constructs a <code>DescribeWorkspaceResponseWorkspace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeWorkspaceResponseWorkspace} obj Optional instance to populate.
     * @return {module:model/DescribeWorkspaceResponseWorkspace} The populated <code>DescribeWorkspaceResponseWorkspace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeWorkspaceResponseWorkspace();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeWorkspaceResponseWorkspace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeWorkspaceResponseWorkspace</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeWorkspaceResponseWorkspace.RequiredProperties) {
...
DescribeWorkspaceResponseWorkspace.RequiredProperties = ["authentication", "created", "dataSources", "endpoint", "grafanaVersion", "id", "modified", "status"];

/**
 * @member {module:model/AccountAccessType} accountAccessType
 */
DescribeWorkspaceResponseWorkspace.prototype['accountAccessType'] = undefined;

/**
 * @member {module:model/WorkspaceDescriptionAuthentication} authentication
 */
DescribeWorkspaceResponseWorkspace.prototype['authentication'] = undefined;

/**
 * @member {Date} created
 */
DescribeWorkspaceResponseWorkspace.prototype['created'] = undefined;

/**
 * @member {Array} dataSources
 */
DescribeWorkspaceResponseWorkspace.prototype['dataSources'] = undefined;

/**
 * @member {String} description
 */
DescribeWorkspaceResponseWorkspace.prototype['description'] = undefined;

/**
 * @member {String} endpoint
 */
DescribeWorkspaceResponseWorkspace.prototype['endpoint'] = undefined;

/**
 * @member {Boolean} freeTrialConsumed
 */
DescribeWorkspaceResponseWorkspace.prototype['freeTrialConsumed'] = undefined;

/**
 * @member {Date} freeTrialExpiration
 */
DescribeWorkspaceResponseWorkspace.prototype['freeTrialExpiration'] = undefined;

/**
 * @member {String} grafanaVersion
 */
DescribeWorkspaceResponseWorkspace.prototype['grafanaVersion'] = undefined;

/**
 * @member {String} id
 */
DescribeWorkspaceResponseWorkspace.prototype['id'] = undefined;

/**
 * @member {Date} licenseExpiration
 */
DescribeWorkspaceResponseWorkspace.prototype['licenseExpiration'] = undefined;

/**
 * @member {module:model/LicenseType} licenseType
 */
DescribeWorkspaceResponseWorkspace.prototype['licenseType'] = undefined;

/**
 * @member {Date} modified
 */
DescribeWorkspaceResponseWorkspace.prototype['modified'] = undefined;

/**
 * @member {String} name
 */
DescribeWorkspaceResponseWorkspace.prototype['name'] = undefined;

/**
 * @member {module:model/WorkspaceDescriptionNetworkAccessControl} networkAccessControl
 */
DescribeWorkspaceResponseWorkspace.prototype['networkAccessControl'] = undefined;

/**
 * @member {Array} notificationDestinations
 */
DescribeWorkspaceResponseWorkspace.prototype['notificationDestinations'] = undefined;

/**
 * @member {String} organizationRoleName
 */
DescribeWorkspaceResponseWorkspace.prototype['organizationRoleName'] = undefined;

/**
 * @member {Array} organizationalUnits
 */
DescribeWorkspaceResponseWorkspace.prototype['organizationalUnits'] = undefined;

/**
 * @member {module:model/PermissionType} permissionType
 */
DescribeWorkspaceResponseWorkspace.prototype['permissionType'] = undefined;

/**
 * @member {String} stackSetName
 */
DescribeWorkspaceResponseWorkspace.prototype['stackSetName'] = undefined;

/**
 * @member {module:model/WorkspaceStatus} status
 */
DescribeWorkspaceResponseWorkspace.prototype['status'] = undefined;

/**
 * @member {Object} tags
 */
DescribeWorkspaceResponseWorkspace.prototype['tags'] = undefined;

/**
 * @member {module:model/WorkspaceDescriptionVpcConfiguration} vpcConfiguration
 */
DescribeWorkspaceResponseWorkspace.prototype['vpcConfiguration'] = undefined;

/**
 * @member {String} workspaceRoleArn
 */
DescribeWorkspaceResponseWorkspace.prototype['workspaceRoleArn'] = undefined;
...
export default DescribeWorkspaceResponseWorkspace;
