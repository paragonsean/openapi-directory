...
/**
 * The AssociateLicenseResponseWorkspace model module.
 * @module model/AssociateLicenseResponseWorkspace
 * @version 2020-08-18
 */
class AssociateLicenseResponseWorkspace {
    /**
     * Constructs a new <code>AssociateLicenseResponseWorkspace</code>.
     * @alias module:model/AssociateLicenseResponseWorkspace
    ...
    constructor(authentication, created, dataSources, endpoint, grafanaVersion, id, modified, status) { 
        ...
        AssociateLicenseResponseWorkspace.initialize(this, authentication, created, dataSources, endpoint, grafanaVersion, id, modified, status);
    }
    ...
    /**
     * Constructs a <code>AssociateLicenseResponseWorkspace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateLicenseResponseWorkspace} obj Optional instance to populate.
     * @return {module:model/AssociateLicenseResponseWorkspace} The populated <code>AssociateLicenseResponseWorkspace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateLicenseResponseWorkspace();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateLicenseResponseWorkspace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateLicenseResponseWorkspace</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssociateLicenseResponseWorkspace.RequiredProperties) {
...
AssociateLicenseResponseWorkspace.RequiredProperties = ["authentication", "created", "dataSources", "endpoint", "grafanaVersion", "id", "modified", "status"];

/**
 * @member {module:model/AccountAccessType} accountAccessType
 */
AssociateLicenseResponseWorkspace.prototype['accountAccessType'] = undefined;

/**
 * @member {module:model/WorkspaceDescriptionAuthentication} authentication
 */
AssociateLicenseResponseWorkspace.prototype['authentication'] = undefined;

/**
 * @member {Date} created
 */
AssociateLicenseResponseWorkspace.prototype['created'] = undefined;

/**
 * @member {Array} dataSources
 */
AssociateLicenseResponseWorkspace.prototype['dataSources'] = undefined;

/**
 * @member {String} description
 */
AssociateLicenseResponseWorkspace.prototype['description'] = undefined;

/**
 * @member {String} endpoint
 */
AssociateLicenseResponseWorkspace.prototype['endpoint'] = undefined;

/**
 * @member {Boolean} freeTrialConsumed
 */
AssociateLicenseResponseWorkspace.prototype['freeTrialConsumed'] = undefined;

/**
 * @member {Date} freeTrialExpiration
 */
AssociateLicenseResponseWorkspace.prototype['freeTrialExpiration'] = undefined;

/**
 * @member {String} grafanaVersion
 */
AssociateLicenseResponseWorkspace.prototype['grafanaVersion'] = undefined;

/**
 * @member {String} id
 */
AssociateLicenseResponseWorkspace.prototype['id'] = undefined;

/**
 * @member {Date} licenseExpiration
 */
AssociateLicenseResponseWorkspace.prototype['licenseExpiration'] = undefined;

/**
 * @member {module:model/LicenseType} licenseType
 */
AssociateLicenseResponseWorkspace.prototype['licenseType'] = undefined;

/**
 * @member {Date} modified
 */
AssociateLicenseResponseWorkspace.prototype['modified'] = undefined;

/**
 * @member {String} name
 */
AssociateLicenseResponseWorkspace.prototype['name'] = undefined;

/**
 * @member {module:model/WorkspaceDescriptionNetworkAccessControl} networkAccessControl
 */
AssociateLicenseResponseWorkspace.prototype['networkAccessControl'] = undefined;

/**
 * @member {Array} notificationDestinations
 */
AssociateLicenseResponseWorkspace.prototype['notificationDestinations'] = undefined;

/**
 * @member {String} organizationRoleName
 */
AssociateLicenseResponseWorkspace.prototype['organizationRoleName'] = undefined;

/**
 * @member {Array} organizationalUnits
 */
AssociateLicenseResponseWorkspace.prototype['organizationalUnits'] = undefined;

/**
 * @member {module:model/PermissionType} permissionType
 */
AssociateLicenseResponseWorkspace.prototype['permissionType'] = undefined;

/**
 * @member {String} stackSetName
 */
AssociateLicenseResponseWorkspace.prototype['stackSetName'] = undefined;

/**
 * @member {module:model/WorkspaceStatus} status
 */
AssociateLicenseResponseWorkspace.prototype['status'] = undefined;

/**
 * @member {Object} tags
 */
AssociateLicenseResponseWorkspace.prototype['tags'] = undefined;

/**
 * @member {module:model/WorkspaceDescriptionVpcConfiguration} vpcConfiguration
 */
AssociateLicenseResponseWorkspace.prototype['vpcConfiguration'] = undefined;

/**
 * @member {String} workspaceRoleArn
 */
AssociateLicenseResponseWorkspace.prototype['workspaceRoleArn'] = undefined;
...
export default AssociateLicenseResponseWorkspace;
