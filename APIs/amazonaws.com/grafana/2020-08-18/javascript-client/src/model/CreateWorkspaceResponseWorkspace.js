...
/**
 * The CreateWorkspaceResponseWorkspace model module.
 * @module model/CreateWorkspaceResponseWorkspace
 * @version 2020-08-18
 */
class CreateWorkspaceResponseWorkspace {
    /**
     * Constructs a new <code>CreateWorkspaceResponseWorkspace</code>.
     * @alias module:model/CreateWorkspaceResponseWorkspace
    ...
    constructor(authentication, created, dataSources, endpoint, grafanaVersion, id, modified, status) { 
        ...
        CreateWorkspaceResponseWorkspace.initialize(this, authentication, created, dataSources, endpoint, grafanaVersion, id, modified, status);
    }
    ...
    /**
     * Constructs a <code>CreateWorkspaceResponseWorkspace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateWorkspaceResponseWorkspace} obj Optional instance to populate.
     * @return {module:model/CreateWorkspaceResponseWorkspace} The populated <code>CreateWorkspaceResponseWorkspace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateWorkspaceResponseWorkspace();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateWorkspaceResponseWorkspace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateWorkspaceResponseWorkspace</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateWorkspaceResponseWorkspace.RequiredProperties) {
...
CreateWorkspaceResponseWorkspace.RequiredProperties = ["authentication", "created", "dataSources", "endpoint", "grafanaVersion", "id", "modified", "status"];

/**
 * @member {module:model/AccountAccessType} accountAccessType
 */
CreateWorkspaceResponseWorkspace.prototype['accountAccessType'] = undefined;

/**
 * @member {module:model/WorkspaceDescriptionAuthentication} authentication
 */
CreateWorkspaceResponseWorkspace.prototype['authentication'] = undefined;

/**
 * @member {Date} created
 */
CreateWorkspaceResponseWorkspace.prototype['created'] = undefined;

/**
 * @member {Array} dataSources
 */
CreateWorkspaceResponseWorkspace.prototype['dataSources'] = undefined;

/**
 * @member {String} description
 */
CreateWorkspaceResponseWorkspace.prototype['description'] = undefined;

/**
 * @member {String} endpoint
 */
CreateWorkspaceResponseWorkspace.prototype['endpoint'] = undefined;

/**
 * @member {Boolean} freeTrialConsumed
 */
CreateWorkspaceResponseWorkspace.prototype['freeTrialConsumed'] = undefined;

/**
 * @member {Date} freeTrialExpiration
 */
CreateWorkspaceResponseWorkspace.prototype['freeTrialExpiration'] = undefined;

/**
 * @member {String} grafanaVersion
 */
CreateWorkspaceResponseWorkspace.prototype['grafanaVersion'] = undefined;

/**
 * @member {String} id
 */
CreateWorkspaceResponseWorkspace.prototype['id'] = undefined;

/**
 * @member {Date} licenseExpiration
 */
CreateWorkspaceResponseWorkspace.prototype['licenseExpiration'] = undefined;

/**
 * @member {module:model/LicenseType} licenseType
 */
CreateWorkspaceResponseWorkspace.prototype['licenseType'] = undefined;

/**
 * @member {Date} modified
 */
CreateWorkspaceResponseWorkspace.prototype['modified'] = undefined;

/**
 * @member {String} name
 */
CreateWorkspaceResponseWorkspace.prototype['name'] = undefined;

/**
 * @member {module:model/WorkspaceDescriptionNetworkAccessControl} networkAccessControl
 */
CreateWorkspaceResponseWorkspace.prototype['networkAccessControl'] = undefined;

/**
 * @member {Array} notificationDestinations
 */
CreateWorkspaceResponseWorkspace.prototype['notificationDestinations'] = undefined;

/**
 * @member {String} organizationRoleName
 */
CreateWorkspaceResponseWorkspace.prototype['organizationRoleName'] = undefined;

/**
 * @member {Array} organizationalUnits
 */
CreateWorkspaceResponseWorkspace.prototype['organizationalUnits'] = undefined;

/**
 * @member {module:model/PermissionType} permissionType
 */
CreateWorkspaceResponseWorkspace.prototype['permissionType'] = undefined;

/**
 * @member {String} stackSetName
 */
CreateWorkspaceResponseWorkspace.prototype['stackSetName'] = undefined;

/**
 * @member {module:model/WorkspaceStatus} status
 */
CreateWorkspaceResponseWorkspace.prototype['status'] = undefined;

/**
 * @member {Object} tags
 */
CreateWorkspaceResponseWorkspace.prototype['tags'] = undefined;

/**
 * @member {module:model/WorkspaceDescriptionVpcConfiguration} vpcConfiguration
 */
CreateWorkspaceResponseWorkspace.prototype['vpcConfiguration'] = undefined;

/**
 * @member {String} workspaceRoleArn
 */
CreateWorkspaceResponseWorkspace.prototype['workspaceRoleArn'] = undefined;
...
export default CreateWorkspaceResponseWorkspace;
