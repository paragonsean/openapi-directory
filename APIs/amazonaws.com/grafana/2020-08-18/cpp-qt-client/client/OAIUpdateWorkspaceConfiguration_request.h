...
/*
 * OAIUpdateWorkspaceConfiguration_request.h
 *
 * 
 */

#ifndef OAIUpdateWorkspaceConfiguration_request_H
#define OAIUpdateWorkspaceConfiguration_request_H
...
class OAIUpdateWorkspaceConfiguration_request : public OAIObject {
public:
    OAIUpdateWorkspaceConfiguration_request();
    OAIUpdateWorkspaceConfiguration_request(QString json);
    ~OAIUpdateWorkspaceConfiguration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateWorkspaceConfiguration_request)

#endif // OAIUpdateWorkspaceConfiguration_request_H
