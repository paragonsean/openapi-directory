...
/*
 * OAIAssertionAttributes.h
 *
 * A structure that defines which attributes in the IdP assertion are to be used to define information about the users authenticated by the IdP to use the workspace.
 */

#ifndef OAIAssertionAttributes_H
#define OAIAssertionAttributes_H
...
class OAIAssertionAttributes : public OAIObject {
public:
    OAIAssertionAttributes();
    OAIAssertionAttributes(QString json);
    ~OAIAssertionAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssertionAttributes)

#endif // OAIAssertionAttributes_H
