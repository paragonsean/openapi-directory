...
#include "OAICreateWorkspaceRequest_networkAccessControl.h"
...
namespace OpenAPI {
class OAICreateWorkspaceRequest_networkAccessControl;
class OAICreateWorkspaceRequest_vpcConfiguration;
...
public:
    ...
    OAICreateWorkspaceRequest_networkAccessControl getNetworkAccessControl() const;
    void setNetworkAccessControl(const OAICreateWorkspaceRequest_networkAccessControl &network_access_control);
    ...
    OAICreateWorkspaceRequest_vpcConfiguration getVpcConfiguration() const;
    void setVpcConfiguration(const OAICreateWorkspaceRequest_vpcConfiguration &vpc_configuration);
...
private:
    ...
    OAICreateWorkspaceRequest_networkAccessControl m_network_access_control;
    ...
    OAICreateWorkspaceRequest_vpcConfiguration m_vpc_configuration;
