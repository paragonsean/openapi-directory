...
#ifndef OAIRoleValues_H
#define OAIRoleValues_H
...
class OAIRoleValues : public OAIObject {
public:
    OAIRoleValues();
    OAIRoleValues(QString json);
    ~OAIRoleValues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoleValues)

#endif // OAIRoleValues_H
