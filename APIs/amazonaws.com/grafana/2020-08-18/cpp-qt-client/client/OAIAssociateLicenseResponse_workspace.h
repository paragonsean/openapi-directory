...
/*
 * OAIAssociateLicenseResponse_workspace.h
 *
 * 
 */

#ifndef OAIAssociateLicenseResponse_workspace_H
#define OAIAssociateLicenseResponse_workspace_H
...
class OAIAssociateLicenseResponse_workspace : public OAIObject {
public:
    OAIAssociateLicenseResponse_workspace();
    OAIAssociateLicenseResponse_workspace(QString json);
    ~OAIAssociateLicenseResponse_workspace() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateLicenseResponse_workspace)

#endif // OAIAssociateLicenseResponse_workspace_H
