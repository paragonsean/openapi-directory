...
#include "OAISamlConfiguration.h"
...
OAISamlConfiguration::OAISamlConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISamlConfiguration::OAISamlConfiguration() {
    this->initializeModel();
}

OAISamlConfiguration::~OAISamlConfiguration() {}

void OAISamlConfiguration::initializeModel() {
...
void OAISamlConfiguration::fromJson(QString jsonString) {
...
void OAISamlConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAISamlConfiguration::asJson() const {
...
QJsonObject OAISamlConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAISamlConfiguration::getAllowedOrganizations() const {
    return m_allowed_organizations;
}
void OAISamlConfiguration::setAllowedOrganizations(const QList &allowed_organizations) {
    m_allowed_organizations = allowed_organizations;
    m_allowed_organizations_isSet = true;
}

bool OAISamlConfiguration::is_allowed_organizations_Set() const{
    return m_allowed_organizations_isSet;
}

bool OAISamlConfiguration::is_allowed_organizations_Valid() const{
    return m_allowed_organizations_isValid;
}

OAIUpdateWorkspaceAuthentication_request_samlConfiguration_assertionAttributes OAISamlConfiguration::getAssertionAttributes() const {
    return m_assertion_attributes;
}
void OAISamlConfiguration::setAssertionAttributes(const OAIUpdateWorkspaceAuthentication_request_samlConfiguration_assertionAttributes &assertion_attributes) {
    m_assertion_attributes = assertion_attributes;
    m_assertion_attributes_isSet = true;
}

bool OAISamlConfiguration::is_assertion_attributes_Set() const{
    return m_assertion_attributes_isSet;
}

bool OAISamlConfiguration::is_assertion_attributes_Valid() const{
    return m_assertion_attributes_isValid;
}

OAIUpdateWorkspaceAuthentication_request_samlConfiguration_idpMetadata OAISamlConfiguration::getIdpMetadata() const {
    return m_idp_metadata;
}
void OAISamlConfiguration::setIdpMetadata(const OAIUpdateWorkspaceAuthentication_request_samlConfiguration_idpMetadata &idp_metadata) {
    m_idp_metadata = idp_metadata;
    m_idp_metadata_isSet = true;
}

bool OAISamlConfiguration::is_idp_metadata_Set() const{
    return m_idp_metadata_isSet;
}

bool OAISamlConfiguration::is_idp_metadata_Valid() const{
    return m_idp_metadata_isValid;
}

qint32 OAISamlConfiguration::getLoginValidityDuration() const {
    return m_login_validity_duration;
}
void OAISamlConfiguration::setLoginValidityDuration(const qint32 &login_validity_duration) {
    m_login_validity_duration = login_validity_duration;
    m_login_validity_duration_isSet = true;
}

bool OAISamlConfiguration::is_login_validity_duration_Set() const{
    return m_login_validity_duration_isSet;
}

bool OAISamlConfiguration::is_login_validity_duration_Valid() const{
    return m_login_validity_duration_isValid;
}

OAIUpdateWorkspaceAuthentication_request_samlConfiguration_roleValues OAISamlConfiguration::getRoleValues() const {
    return m_role_values;
}
void OAISamlConfiguration::setRoleValues(const OAIUpdateWorkspaceAuthentication_request_samlConfiguration_roleValues &role_values) {
    m_role_values = role_values;
    m_role_values_isSet = true;
}

bool OAISamlConfiguration::is_role_values_Set() const{
    return m_role_values_isSet;
}

bool OAISamlConfiguration::is_role_values_Valid() const{
    return m_role_values_isValid;
}

bool OAISamlConfiguration::isSet() const {
...
bool OAISamlConfiguration::isValid() const {
