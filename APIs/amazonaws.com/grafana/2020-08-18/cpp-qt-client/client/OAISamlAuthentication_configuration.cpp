...
OAISamlAuthentication_configuration::OAISamlAuthentication_configuration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISamlAuthentication_configuration::OAISamlAuthentication_configuration() {
    this->initializeModel();
}

OAISamlAuthentication_configuration::~OAISamlAuthentication_configuration() {}

void OAISamlAuthentication_configuration::initializeModel() {
...
void OAISamlAuthentication_configuration::fromJson(QString jsonString) {
...
void OAISamlAuthentication_configuration::fromJsonObject(QJsonObject json) {
...
QString OAISamlAuthentication_configuration::asJson() const {
...
QJsonObject OAISamlAuthentication_configuration::asJsonObject() const {
    QJsonObject obj;
...
QList OAISamlAuthentication_configuration::getAllowedOrganizations() const {
    return m_allowed_organizations;
}
void OAISamlAuthentication_configuration::setAllowedOrganizations(const QList &allowed_organizations) {
    m_allowed_organizations = allowed_organizations;
    m_allowed_organizations_isSet = true;
}

bool OAISamlAuthentication_configuration::is_allowed_organizations_Set() const{
    return m_allowed_organizations_isSet;
}

bool OAISamlAuthentication_configuration::is_allowed_organizations_Valid() const{
    return m_allowed_organizations_isValid;
}

OAIUpdateWorkspaceAuthentication_request_samlConfiguration_assertionAttributes OAISamlAuthentication_configuration::getAssertionAttributes() const {
    return m_assertion_attributes;
}
void OAISamlAuthentication_configuration::setAssertionAttributes(const OAIUpdateWorkspaceAuthentication_request_samlConfiguration_assertionAttributes &assertion_attributes) {
    m_assertion_attributes = assertion_attributes;
    m_assertion_attributes_isSet = true;
}

bool OAISamlAuthentication_configuration::is_assertion_attributes_Set() const{
    return m_assertion_attributes_isSet;
}

bool OAISamlAuthentication_configuration::is_assertion_attributes_Valid() const{
    return m_assertion_attributes_isValid;
}

OAIUpdateWorkspaceAuthentication_request_samlConfiguration_idpMetadata OAISamlAuthentication_configuration::getIdpMetadata() const {
    return m_idp_metadata;
}
void OAISamlAuthentication_configuration::setIdpMetadata(const OAIUpdateWorkspaceAuthentication_request_samlConfiguration_idpMetadata &idp_metadata) {
    m_idp_metadata = idp_metadata;
    m_idp_metadata_isSet = true;
}

bool OAISamlAuthentication_configuration::is_idp_metadata_Set() const{
    return m_idp_metadata_isSet;
}

bool OAISamlAuthentication_configuration::is_idp_metadata_Valid() const{
    return m_idp_metadata_isValid;
}

qint32 OAISamlAuthentication_configuration::getLoginValidityDuration() const {
    return m_login_validity_duration;
}
void OAISamlAuthentication_configuration::setLoginValidityDuration(const qint32 &login_validity_duration) {
    m_login_validity_duration = login_validity_duration;
    m_login_validity_duration_isSet = true;
}

bool OAISamlAuthentication_configuration::is_login_validity_duration_Set() const{
    return m_login_validity_duration_isSet;
}

bool OAISamlAuthentication_configuration::is_login_validity_duration_Valid() const{
    return m_login_validity_duration_isValid;
}

OAIUpdateWorkspaceAuthentication_request_samlConfiguration_roleValues OAISamlAuthentication_configuration::getRoleValues() const {
    return m_role_values;
}
void OAISamlAuthentication_configuration::setRoleValues(const OAIUpdateWorkspaceAuthentication_request_samlConfiguration_roleValues &role_values) {
    m_role_values = role_values;
    m_role_values_isSet = true;
}

bool OAISamlAuthentication_configuration::is_role_values_Set() const{
    return m_role_values_isSet;
}

bool OAISamlAuthentication_configuration::is_role_values_Valid() const{
    return m_role_values_isValid;
}

bool OAISamlAuthentication_configuration::isSet() const {
...
bool OAISamlAuthentication_configuration::isValid() const {
