...
OAIAccountAccessType OAIWorkspaceDescription::getAccountAccessType() const {
    return m_account_access_type;
}
void OAIWorkspaceDescription::setAccountAccessType(const OAIAccountAccessType &account_access_type) {
    m_account_access_type = account_access_type;
    m_account_access_type_isSet = true;
}

bool OAIWorkspaceDescription::is_account_access_type_Set() const{
    return m_account_access_type_isSet;
}

bool OAIWorkspaceDescription::is_account_access_type_Valid() const{
    return m_account_access_type_isValid;
}

OAIWorkspaceDescription_authentication OAIWorkspaceDescription::getAuthentication() const {
    return m_authentication;
}
void OAIWorkspaceDescription::setAuthentication(const OAIWorkspaceDescription_authentication &authentication) {
    m_authentication = authentication;
    m_authentication_isSet = true;
}

bool OAIWorkspaceDescription::is_authentication_Set() const{
    return m_authentication_isSet;
}

bool OAIWorkspaceDescription::is_authentication_Valid() const{
    return m_authentication_isValid;
}

QDateTime OAIWorkspaceDescription::getCreated() const {
    return m_created;
}
void OAIWorkspaceDescription::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIWorkspaceDescription::is_created_Set() const{
    return m_created_isSet;
}

bool OAIWorkspaceDescription::is_created_Valid() const{
    return m_created_isValid;
}

QList OAIWorkspaceDescription::getDataSources() const {
    return m_data_sources;
}
void OAIWorkspaceDescription::setDataSources(const QList &data_sources) {
    m_data_sources = data_sources;
    m_data_sources_isSet = true;
}

bool OAIWorkspaceDescription::is_data_sources_Set() const{
    return m_data_sources_isSet;
}

bool OAIWorkspaceDescription::is_data_sources_Valid() const{
    return m_data_sources_isValid;
}

QString OAIWorkspaceDescription::getDescription() const {
    return m_description;
}
void OAIWorkspaceDescription::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIWorkspaceDescription::is_description_Set() const{
    return m_description_isSet;
}

bool OAIWorkspaceDescription::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIWorkspaceDescription::getEndpoint() const {
    return m_endpoint;
}
void OAIWorkspaceDescription::setEndpoint(const QString &endpoint) {
    m_endpoint = endpoint;
    m_endpoint_isSet = true;
}

bool OAIWorkspaceDescription::is_endpoint_Set() const{
    return m_endpoint_isSet;
}

bool OAIWorkspaceDescription::is_endpoint_Valid() const{
    return m_endpoint_isValid;
}

bool OAIWorkspaceDescription::getFreeTrialConsumed() const {
    return m_free_trial_consumed;
}
void OAIWorkspaceDescription::setFreeTrialConsumed(const bool &free_trial_consumed) {
    m_free_trial_consumed = free_trial_consumed;
    m_free_trial_consumed_isSet = true;
}

bool OAIWorkspaceDescription::is_free_trial_consumed_Set() const{
    return m_free_trial_consumed_isSet;
}

bool OAIWorkspaceDescription::is_free_trial_consumed_Valid() const{
    return m_free_trial_consumed_isValid;
}

QDateTime OAIWorkspaceDescription::getFreeTrialExpiration() const {
    return m_free_trial_expiration;
}
void OAIWorkspaceDescription::setFreeTrialExpiration(const QDateTime &free_trial_expiration) {
    m_free_trial_expiration = free_trial_expiration;
    m_free_trial_expiration_isSet = true;
}

bool OAIWorkspaceDescription::is_free_trial_expiration_Set() const{
    return m_free_trial_expiration_isSet;
}

bool OAIWorkspaceDescription::is_free_trial_expiration_Valid() const{
    return m_free_trial_expiration_isValid;
}

QString OAIWorkspaceDescription::getGrafanaVersion() const {
    return m_grafana_version;
}
void OAIWorkspaceDescription::setGrafanaVersion(const QString &grafana_version) {
    m_grafana_version = grafana_version;
    m_grafana_version_isSet = true;
}

bool OAIWorkspaceDescription::is_grafana_version_Set() const{
    return m_grafana_version_isSet;
}

bool OAIWorkspaceDescription::is_grafana_version_Valid() const{
    return m_grafana_version_isValid;
}

QString OAIWorkspaceDescription::getId() const {
    return m_id;
}
void OAIWorkspaceDescription::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIWorkspaceDescription::is_id_Set() const{
    return m_id_isSet;
}

bool OAIWorkspaceDescription::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIWorkspaceDescription::getLicenseExpiration() const {
    return m_license_expiration;
}
void OAIWorkspaceDescription::setLicenseExpiration(const QDateTime &license_expiration) {
    m_license_expiration = license_expiration;
    m_license_expiration_isSet = true;
}

bool OAIWorkspaceDescription::is_license_expiration_Set() const{
    return m_license_expiration_isSet;
}

bool OAIWorkspaceDescription::is_license_expiration_Valid() const{
    return m_license_expiration_isValid;
}

OAILicenseType OAIWorkspaceDescription::getLicenseType() const {
    return m_license_type;
}
void OAIWorkspaceDescription::setLicenseType(const OAILicenseType &license_type) {
    m_license_type = license_type;
    m_license_type_isSet = true;
}

bool OAIWorkspaceDescription::is_license_type_Set() const{
    return m_license_type_isSet;
}

bool OAIWorkspaceDescription::is_license_type_Valid() const{
    return m_license_type_isValid;
}

QDateTime OAIWorkspaceDescription::getModified() const {
    return m_modified;
}
void OAIWorkspaceDescription::setModified(const QDateTime &modified) {
    m_modified = modified;
    m_modified_isSet = true;
}

bool OAIWorkspaceDescription::is_modified_Set() const{
    return m_modified_isSet;
}

bool OAIWorkspaceDescription::is_modified_Valid() const{
    return m_modified_isValid;
}

QString OAIWorkspaceDescription::getName() const {
    return m_name;
}
void OAIWorkspaceDescription::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIWorkspaceDescription::is_name_Set() const{
    return m_name_isSet;
}

bool OAIWorkspaceDescription::is_name_Valid() const{
    return m_name_isValid;
}

OAIWorkspaceDescription_networkAccessControl OAIWorkspaceDescription::getNetworkAccessControl() const {
    return m_network_access_control;
}
void OAIWorkspaceDescription::setNetworkAccessControl(const OAIWorkspaceDescription_networkAccessControl &network_access_control) {
    m_network_access_control = network_access_control;
    m_network_access_control_isSet = true;
}

bool OAIWorkspaceDescription::is_network_access_control_Set() const{
    return m_network_access_control_isSet;
}

bool OAIWorkspaceDescription::is_network_access_control_Valid() const{
    return m_network_access_control_isValid;
}

QList OAIWorkspaceDescription::getNotificationDestinations() const {
    return m_notification_destinations;
}
void OAIWorkspaceDescription::setNotificationDestinations(const QList &notification_destinations) {
    m_notification_destinations = notification_destinations;
    m_notification_destinations_isSet = true;
}

bool OAIWorkspaceDescription::is_notification_destinations_Set() const{
    return m_notification_destinations_isSet;
}

bool OAIWorkspaceDescription::is_notification_destinations_Valid() const{
    return m_notification_destinations_isValid;
}

QString OAIWorkspaceDescription::getOrganizationRoleName() const {
    return m_organization_role_name;
}
void OAIWorkspaceDescription::setOrganizationRoleName(const QString &organization_role_name) {
    m_organization_role_name = organization_role_name;
    m_organization_role_name_isSet = true;
}

bool OAIWorkspaceDescription::is_organization_role_name_Set() const{
    return m_organization_role_name_isSet;
}

bool OAIWorkspaceDescription::is_organization_role_name_Valid() const{
    return m_organization_role_name_isValid;
}

QList OAIWorkspaceDescription::getOrganizationalUnits() const {
    return m_organizational_units;
}
void OAIWorkspaceDescription::setOrganizationalUnits(const QList &organizational_units) {
    m_organizational_units = organizational_units;
    m_organizational_units_isSet = true;
}

bool OAIWorkspaceDescription::is_organizational_units_Set() const{
    return m_organizational_units_isSet;
}

bool OAIWorkspaceDescription::is_organizational_units_Valid() const{
    return m_organizational_units_isValid;
}

OAIPermissionType OAIWorkspaceDescription::getPermissionType() const {
    return m_permission_type;
}
void OAIWorkspaceDescription::setPermissionType(const OAIPermissionType &permission_type) {
    m_permission_type = permission_type;
    m_permission_type_isSet = true;
}

bool OAIWorkspaceDescription::is_permission_type_Set() const{
    return m_permission_type_isSet;
}

bool OAIWorkspaceDescription::is_permission_type_Valid() const{
    return m_permission_type_isValid;
}

QString OAIWorkspaceDescription::getStackSetName() const {
    return m_stack_set_name;
}
void OAIWorkspaceDescription::setStackSetName(const QString &stack_set_name) {
    m_stack_set_name = stack_set_name;
    m_stack_set_name_isSet = true;
}

bool OAIWorkspaceDescription::is_stack_set_name_Set() const{
    return m_stack_set_name_isSet;
}

bool OAIWorkspaceDescription::is_stack_set_name_Valid() const{
    return m_stack_set_name_isValid;
}

OAIWorkspaceStatus OAIWorkspaceDescription::getStatus() const {
    return m_status;
}
void OAIWorkspaceDescription::setStatus(const OAIWorkspaceStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
OAIWorkspaceDescription_vpcConfiguration OAIWorkspaceDescription::getVpcConfiguration() const {
    return m_vpc_configuration;
}
void OAIWorkspaceDescription::setVpcConfiguration(const OAIWorkspaceDescription_vpcConfiguration &vpc_configuration) {
    m_vpc_configuration = vpc_configuration;
    m_vpc_configuration_isSet = true;
}

bool OAIWorkspaceDescription::is_vpc_configuration_Set() const{
    return m_vpc_configuration_isSet;
}

bool OAIWorkspaceDescription::is_vpc_configuration_Valid() const{
    return m_vpc_configuration_isValid;
}

QString OAIWorkspaceDescription::getWorkspaceRoleArn() const {
    return m_workspace_role_arn;
}
void OAIWorkspaceDescription::setWorkspaceRoleArn(const QString &workspace_role_arn) {
    m_workspace_role_arn = workspace_role_arn;
    m_workspace_role_arn_isSet = true;
}

bool OAIWorkspaceDescription::is_workspace_role_arn_Set() const{
    return m_workspace_role_arn_isSet;
}

bool OAIWorkspaceDescription::is_workspace_role_arn_Valid() const{
