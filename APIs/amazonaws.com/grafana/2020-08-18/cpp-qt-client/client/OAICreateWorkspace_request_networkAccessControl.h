...
/*
 * OAICreateWorkspace_request_networkAccessControl.h
 *
...
#ifndef OAICreateWorkspace_request_networkAccessControl_H
#define OAICreateWorkspace_request_networkAccessControl_H
...
class OAICreateWorkspace_request_networkAccessControl : public OAIObject {
public:
    OAICreateWorkspace_request_networkAccessControl();
    OAICreateWorkspace_request_networkAccessControl(QString json);
    ~OAICreateWorkspace_request_networkAccessControl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWorkspace_request_networkAccessControl)

#endif // OAICreateWorkspace_request_networkAccessControl_H
