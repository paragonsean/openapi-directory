...
/*
 * OAISamlAuthentication.h
 *
 * A structure containing information about how this workspace works with SAML. 
 */

#ifndef OAISamlAuthentication_H
#define OAISamlAuthentication_H
...
class OAISamlAuthentication : public OAIObject {
public:
    OAISamlAuthentication();
    OAISamlAuthentication(QString json);
    ~OAISamlAuthentication() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISamlAuthentication)

#endif // OAISamlAuthentication_H
