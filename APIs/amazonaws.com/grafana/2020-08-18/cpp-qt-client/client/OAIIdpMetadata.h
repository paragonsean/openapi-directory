...
#ifndef OAIIdpMetadata_H
#define OAIIdpMetadata_H
...
class OAIIdpMetadata : public OAIObject {
public:
    OAIIdpMetadata();
    OAIIdpMetadata(QString json);
    ~OAIIdpMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdpMetadata)

#endif // OAIIdpMetadata_H
