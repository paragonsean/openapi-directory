...
QString OAIUpdateWorkspace_request::getAccountAccessType() const {
    return m_account_access_type;
}
void OAIUpdateWorkspace_request::setAccountAccessType(const QString &account_access_type) {
    m_account_access_type = account_access_type;
    m_account_access_type_isSet = true;
}

bool OAIUpdateWorkspace_request::is_account_access_type_Set() const{
    return m_account_access_type_isSet;
}

bool OAIUpdateWorkspace_request::is_account_access_type_Valid() const{
    return m_account_access_type_isValid;
}

OAICreateWorkspace_request_networkAccessControl OAIUpdateWorkspace_request::getNetworkAccessControl() const {
    return m_network_access_control;
}
void OAIUpdateWorkspace_request::setNetworkAccessControl(const OAICreateWorkspace_request_networkAccessControl &network_access_control) {
    m_network_access_control = network_access_control;
    m_network_access_control_isSet = true;
}

bool OAIUpdateWorkspace_request::is_network_access_control_Set() const{
    return m_network_access_control_isSet;
}

bool OAIUpdateWorkspace_request::is_network_access_control_Valid() const{
    return m_network_access_control_isValid;
}

QString OAIUpdateWorkspace_request::getOrganizationRoleName() const {
    return m_organization_role_name;
}
void OAIUpdateWorkspace_request::setOrganizationRoleName(const QString &organization_role_name) {
    m_organization_role_name = organization_role_name;
    m_organization_role_name_isSet = true;
}

bool OAIUpdateWorkspace_request::is_organization_role_name_Set() const{
    return m_organization_role_name_isSet;
}

bool OAIUpdateWorkspace_request::is_organization_role_name_Valid() const{
    return m_organization_role_name_isValid;
}

QString OAIUpdateWorkspace_request::getPermissionType() const {
    return m_permission_type;
}
void OAIUpdateWorkspace_request::setPermissionType(const QString &permission_type) {
    m_permission_type = permission_type;
    m_permission_type_isSet = true;
}

bool OAIUpdateWorkspace_request::is_permission_type_Set() const{
    return m_permission_type_isSet;
}

bool OAIUpdateWorkspace_request::is_permission_type_Valid() const{
    return m_permission_type_isValid;
}

bool OAIUpdateWorkspace_request::isRemoveNetworkAccessConfiguration() const {
    return m_remove_network_access_configuration;
}
void OAIUpdateWorkspace_request::setRemoveNetworkAccessConfiguration(const bool &remove_network_access_configuration) {
...
bool OAIUpdateWorkspace_request::is_remove_network_access_configuration_Set() const{
    return m_remove_network_access_configuration_isSet;
}

bool OAIUpdateWorkspace_request::is_remove_network_access_configuration_Valid() const{
    return m_remove_network_access_configuration_isValid;
}

bool OAIUpdateWorkspace_request::isRemoveVpcConfiguration() const {
    return m_remove_vpc_configuration;
}
void OAIUpdateWorkspace_request::setRemoveVpcConfiguration(const bool &remove_vpc_configuration) {
    m_remove_vpc_configuration = remove_vpc_configuration;
    m_remove_vpc_configuration_isSet = true;
}

bool OAIUpdateWorkspace_request::is_remove_vpc_configuration_Set() const{
    return m_remove_vpc_configuration_isSet;
}

bool OAIUpdateWorkspace_request::is_remove_vpc_configuration_Valid() const{
    return m_remove_vpc_configuration_isValid;
}

QString OAIUpdateWorkspace_request::getStackSetName() const {
    return m_stack_set_name;
}
void OAIUpdateWorkspace_request::setStackSetName(const QString &stack_set_name) {
    m_stack_set_name = stack_set_name;
    m_stack_set_name_isSet = true;
}

bool OAIUpdateWorkspace_request::is_stack_set_name_Set() const{
    return m_stack_set_name_isSet;
}

bool OAIUpdateWorkspace_request::is_stack_set_name_Valid() const{
    return m_stack_set_name_isValid;
}

OAICreateWorkspace_request_vpcConfiguration OAIUpdateWorkspace_request::getVpcConfiguration() const {
    return m_vpc_configuration;
}
void OAIUpdateWorkspace_request::setVpcConfiguration(const OAICreateWorkspace_request_vpcConfiguration &vpc_configuration) {
    m_vpc_configuration = vpc_configuration;
    m_vpc_configuration_isSet = true;
}

bool OAIUpdateWorkspace_request::is_vpc_configuration_Set() const{
    return m_vpc_configuration_isSet;
}

bool OAIUpdateWorkspace_request::is_vpc_configuration_Valid() const{
    return m_vpc_configuration_isValid;
}

QList<OAIDataSourceType> OAIUpdateWorkspace_request::getWorkspaceDataSources() const {
    return m_workspace_data_sources;
}
void OAIUpdateWorkspace_request::setWorkspaceDataSources(const QList<OAIDataSourceType> &workspace_data_sources) {
    m_workspace_data_sources = workspace_data_sources;
    m_workspace_data_sources_isSet = true;
}

bool OAIUpdateWorkspace_request::is_workspace_data_sources_Set() const{
    return m_workspace_data_sources_isSet;
}

bool OAIUpdateWorkspace_request::is_workspace_data_sources_Valid() const{
    return m_workspace_data_sources_isValid;
}

QString OAIUpdateWorkspace_request::getWorkspaceDescription() const {
    return m_workspace_description;
}
void OAIUpdateWorkspace_request::setWorkspaceDescription(const QString &workspace_description) {
    m_workspace_description = workspace_description;
    m_workspace_description_isSet = true;
}

bool OAIUpdateWorkspace_request::is_workspace_description_Set() const{
    return m_workspace_description_isSet;
}

bool OAIUpdateWorkspace_request::is_workspace_description_Valid() const{
    return m_workspace_description_isValid;
}

QString OAIUpdateWorkspace_request::getWorkspaceName() const {
    return m_workspace_name;
}
void OAIUpdateWorkspace_request::setWorkspaceName(const QString &workspace_name) {
    m_workspace_name = workspace_name;
    m_workspace_name_isSet = true;
}

bool OAIUpdateWorkspace_request::is_workspace_name_Set() const{
    return m_workspace_name_isSet;
}

bool OAIUpdateWorkspace_request::is_workspace_name_Valid() const{
    return m_workspace_name_isValid;
}

QList<OAINotificationDestinationType> OAIUpdateWorkspace_request::getWorkspaceNotificationDestinations() const {
    return m_workspace_notification_destinations;
}
void OAIUpdateWorkspace_request::setWorkspaceNotificationDestinations(const QList<OAINotificationDestinationType> &workspace_notification_destinations) {
...
bool OAIUpdateWorkspace_request::is_workspace_notification_destinations_Set() const{
    return m_workspace_notification_destinations_isSet;
}

bool OAIUpdateWorkspace_request::is_workspace_notification_destinations_Valid() const{
    return m_workspace_notification_destinations_isValid;
}

QList<QString> OAIUpdateWorkspace_request::getWorkspaceOrganizationalUnits() const {
    return m_workspace_organizational_units;
}
void OAIUpdateWorkspace_request::setWorkspaceOrganizationalUnits(const QList<QString> &workspace_organizational_units) {
    m_workspace_organizational_units = workspace_organizational_units;
    m_workspace_organizational_units_isSet = true;
}

bool OAIUpdateWorkspace_request::is_workspace_organizational_units_Set() const{
    return m_workspace_organizational_units_isSet;
}

bool OAIUpdateWorkspace_request::is_workspace_organizational_units_Valid() const{
    return m_workspace_organizational_units_isValid;
}

QString OAIUpdateWorkspace_request::getWorkspaceRoleArn() const {
    return m_workspace_role_arn;
}
void OAIUpdateWorkspace_request::setWorkspaceRoleArn(const QString &workspace_role_arn) {
    m_workspace_role_arn = workspace_role_arn;
    m_workspace_role_arn_isSet = true;
}

bool OAIUpdateWorkspace_request::is_workspace_role_arn_Set() const{
    return m_workspace_role_arn_isSet;
}

bool OAIUpdateWorkspace_request::is_workspace_role_arn_Valid() const{
