...
/*
 * OAIUpdateError_causedBy.h
 *
 * 
 */

#ifndef OAIUpdateError_causedBy_H
#define OAIUpdateError_causedBy_H
...
class OAIUpdateError_causedBy : public OAIObject {
public:
    OAIUpdateError_causedBy();
    OAIUpdateError_causedBy(QString json);
    ~OAIUpdateError_causedBy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateError_causedBy)

#endif // OAIUpdateError_causedBy_H
