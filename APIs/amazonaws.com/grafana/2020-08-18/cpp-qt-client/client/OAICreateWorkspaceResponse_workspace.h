...
/*
 * OAICreateWorkspaceResponse_workspace.h
 *
 * 
 */

#ifndef OAICreateWorkspaceResponse_workspace_H
#define OAICreateWorkspaceResponse_workspace_H
...
class OAICreateWorkspaceResponse_workspace : public OAIObject {
public:
    OAICreateWorkspaceResponse_workspace();
    OAICreateWorkspaceResponse_workspace(QString json);
    ~OAICreateWorkspaceResponse_workspace() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWorkspaceResponse_workspace)

#endif // OAICreateWorkspaceResponse_workspace_H
