...
/*
 * OAIDeleteWorkspaceResponse_workspace.h
 *
 * 
 */

#ifndef OAIDeleteWorkspaceResponse_workspace_H
#define OAIDeleteWorkspaceResponse_workspace_H
...
class OAIDeleteWorkspaceResponse_workspace : public OAIObject {
public:
    OAIDeleteWorkspaceResponse_workspace();
    OAIDeleteWorkspaceResponse_workspace(QString json);
    ~OAIDeleteWorkspaceResponse_workspace() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteWorkspaceResponse_workspace)

#endif // OAIDeleteWorkspaceResponse_workspace_H
