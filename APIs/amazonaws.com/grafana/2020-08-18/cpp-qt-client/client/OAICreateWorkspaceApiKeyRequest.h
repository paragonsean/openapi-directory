...
/*
 * OAICreateWorkspaceApiKeyRequest.h
 *
 * 
 */

#ifndef OAICreateWorkspaceApiKeyRequest_H
#define OAICreateWorkspaceApiKeyRequest_H
...
class OAICreateWorkspaceApiKeyRequest : public OAIObject {
public:
    OAICreateWorkspaceApiKeyRequest();
    OAICreateWorkspaceApiKeyRequest(QString json);
    ~OAICreateWorkspaceApiKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWorkspaceApiKeyRequest)

#endif // OAICreateWorkspaceApiKeyRequest_H
