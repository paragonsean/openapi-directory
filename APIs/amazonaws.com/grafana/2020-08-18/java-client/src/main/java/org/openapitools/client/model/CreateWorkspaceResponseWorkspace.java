...
public class CreateWorkspaceResponseWorkspace {
  ...
  public CreateWorkspaceResponseWorkspace() {
  }

  public CreateWorkspaceResponseWorkspace accountAccessType(AccountAccessType accountAccessType) {
  ...
  public CreateWorkspaceResponseWorkspace authentication(WorkspaceDescriptionAuthentication authentication) {
  ...
  public CreateWorkspaceResponseWorkspace created(OffsetDateTime created) {
  ...
  public CreateWorkspaceResponseWorkspace dataSources(List dataSources) {
  ...
  public CreateWorkspaceResponseWorkspace description(String description) {
  ...
  public CreateWorkspaceResponseWorkspace endpoint(String endpoint) {
  ...
  public CreateWorkspaceResponseWorkspace freeTrialConsumed(Boolean freeTrialConsumed) {
  ...
  public CreateWorkspaceResponseWorkspace freeTrialExpiration(OffsetDateTime freeTrialExpiration) {
  ...
  public CreateWorkspaceResponseWorkspace grafanaVersion(String grafanaVersion) {
  ...
  public CreateWorkspaceResponseWorkspace id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CreateWorkspaceResponseWorkspace licenseExpiration(OffsetDateTime licenseExpiration) {
  ...
  public CreateWorkspaceResponseWorkspace licenseType(LicenseType licenseType) {
  ...
  public CreateWorkspaceResponseWorkspace modified(OffsetDateTime modified) {
  ...
  public CreateWorkspaceResponseWorkspace name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateWorkspaceResponseWorkspace networkAccessControl(WorkspaceDescriptionNetworkAccessControl networkAccessControl) {
  ...
  public CreateWorkspaceResponseWorkspace notificationDestinations(List notificationDestinations) {
  ...
  public CreateWorkspaceResponseWorkspace organizationRoleName(String organizationRoleName) {
  ...
  public CreateWorkspaceResponseWorkspace organizationalUnits(List organizationalUnits) {
  ...
  public CreateWorkspaceResponseWorkspace permissionType(PermissionType permissionType) {
  ...
  public CreateWorkspaceResponseWorkspace stackSetName(String stackSetName) {
  ...
  public CreateWorkspaceResponseWorkspace status(WorkspaceStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreateWorkspaceResponseWorkspace tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateWorkspaceResponseWorkspace vpcConfiguration(WorkspaceDescriptionVpcConfiguration vpcConfiguration) {
  ...
  public CreateWorkspaceResponseWorkspace workspaceRoleArn(String workspaceRoleArn) {
  ...
  public boolean equals(Object o) {
    ...
    CreateWorkspaceResponseWorkspace createWorkspaceResponseWorkspace = (CreateWorkspaceResponseWorkspace) o;
    return Objects.equals(this.accountAccessType, createWorkspaceResponseWorkspace.accountAccessType) &&
        Objects.equals(this.authentication, createWorkspaceResponseWorkspace.authentication) &&
        Objects.equals(this.created, createWorkspaceResponseWorkspace.created) &&
        Objects.equals(this.dataSources, createWorkspaceResponseWorkspace.dataSources) &&
        Objects.equals(this.description, createWorkspaceResponseWorkspace.description) &&
        Objects.equals(this.endpoint, createWorkspaceResponseWorkspace.endpoint) &&
        Objects.equals(this.freeTrialConsumed, createWorkspaceResponseWorkspace.freeTrialConsumed) &&
        Objects.equals(this.freeTrialExpiration, createWorkspaceResponseWorkspace.freeTrialExpiration) &&
        Objects.equals(this.grafanaVersion, createWorkspaceResponseWorkspace.grafanaVersion) &&
        Objects.equals(this.id, createWorkspaceResponseWorkspace.id) &&
        Objects.equals(this.licenseExpiration, createWorkspaceResponseWorkspace.licenseExpiration) &&
        Objects.equals(this.licenseType, createWorkspaceResponseWorkspace.licenseType) &&
        Objects.equals(this.modified, createWorkspaceResponseWorkspace.modified) &&
        Objects.equals(this.name, createWorkspaceResponseWorkspace.name) &&
        Objects.equals(this.networkAccessControl, createWorkspaceResponseWorkspace.networkAccessControl) &&
        Objects.equals(this.notificationDestinations, createWorkspaceResponseWorkspace.notificationDestinations) &&
        Objects.equals(this.organizationRoleName, createWorkspaceResponseWorkspace.organizationRoleName) &&
        Objects.equals(this.organizationalUnits, createWorkspaceResponseWorkspace.organizationalUnits) &&
        Objects.equals(this.permissionType, createWorkspaceResponseWorkspace.permissionType) &&
        Objects.equals(this.stackSetName, createWorkspaceResponseWorkspace.stackSetName) &&
        Objects.equals(this.status, createWorkspaceResponseWorkspace.status) &&
        Objects.equals(this.tags, createWorkspaceResponseWorkspace.tags) &&
        Objects.equals(this.vpcConfiguration, createWorkspaceResponseWorkspace.vpcConfiguration) &&
        Objects.equals(this.workspaceRoleArn, createWorkspaceResponseWorkspace.workspaceRoleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateWorkspaceResponseWorkspace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateWorkspaceResponseWorkspace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateWorkspaceResponseWorkspace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateWorkspaceResponseWorkspace is not found in the empty JSON string", CreateWorkspaceResponseWorkspace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateWorkspaceResponseWorkspace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateWorkspaceResponseWorkspace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateWorkspaceResponseWorkspace.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateWorkspaceResponseWorkspace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateWorkspaceResponseWorkspace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateWorkspaceResponseWorkspace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateWorkspaceResponseWorkspace.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateWorkspaceResponseWorkspace>() {
           @Override
           public void write(JsonWriter out, CreateWorkspaceResponseWorkspace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateWorkspaceResponseWorkspace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateWorkspaceResponseWorkspace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateWorkspaceResponseWorkspace
   * @throws IOException if the JSON string is invalid with respect to CreateWorkspaceResponseWorkspace
   */
  public static CreateWorkspaceResponseWorkspace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateWorkspaceResponseWorkspace.class);
  }

  /**
   * Convert an instance of CreateWorkspaceResponseWorkspace to an JSON string
   *
   * @return JSON string
   */
