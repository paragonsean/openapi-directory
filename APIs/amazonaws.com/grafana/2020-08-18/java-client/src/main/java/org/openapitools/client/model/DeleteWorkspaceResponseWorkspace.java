...
public class DeleteWorkspaceResponseWorkspace {
  ...
  public DeleteWorkspaceResponseWorkspace() {
  }

  public DeleteWorkspaceResponseWorkspace accountAccessType(AccountAccessType accountAccessType) {
  ...
  public DeleteWorkspaceResponseWorkspace authentication(WorkspaceDescriptionAuthentication authentication) {
  ...
  public DeleteWorkspaceResponseWorkspace created(OffsetDateTime created) {
  ...
  public DeleteWorkspaceResponseWorkspace dataSources(List dataSources) {
  ...
  public DeleteWorkspaceResponseWorkspace description(String description) {
  ...
  public DeleteWorkspaceResponseWorkspace endpoint(String endpoint) {
  ...
  public DeleteWorkspaceResponseWorkspace freeTrialConsumed(Boolean freeTrialConsumed) {
  ...
  public DeleteWorkspaceResponseWorkspace freeTrialExpiration(OffsetDateTime freeTrialExpiration) {
  ...
  public DeleteWorkspaceResponseWorkspace grafanaVersion(String grafanaVersion) {
  ...
  public DeleteWorkspaceResponseWorkspace id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DeleteWorkspaceResponseWorkspace licenseExpiration(OffsetDateTime licenseExpiration) {
  ...
  public DeleteWorkspaceResponseWorkspace licenseType(LicenseType licenseType) {
  ...
  public DeleteWorkspaceResponseWorkspace modified(OffsetDateTime modified) {
  ...
  public DeleteWorkspaceResponseWorkspace name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DeleteWorkspaceResponseWorkspace networkAccessControl(WorkspaceDescriptionNetworkAccessControl networkAccessControl) {
  ...
  public DeleteWorkspaceResponseWorkspace notificationDestinations(List notificationDestinations) {
  ...
  public DeleteWorkspaceResponseWorkspace organizationRoleName(String organizationRoleName) {
  ...
  public DeleteWorkspaceResponseWorkspace organizationalUnits(List organizationalUnits) {
  ...
  public DeleteWorkspaceResponseWorkspace permissionType(PermissionType permissionType) {
  ...
  public DeleteWorkspaceResponseWorkspace stackSetName(String stackSetName) {
  ...
  public DeleteWorkspaceResponseWorkspace status(WorkspaceStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DeleteWorkspaceResponseWorkspace tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DeleteWorkspaceResponseWorkspace vpcConfiguration(WorkspaceDescriptionVpcConfiguration vpcConfiguration) {
  ...
  public DeleteWorkspaceResponseWorkspace workspaceRoleArn(String workspaceRoleArn) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteWorkspaceResponseWorkspace deleteWorkspaceResponseWorkspace = (DeleteWorkspaceResponseWorkspace) o;
    return Objects.equals(this.accountAccessType, deleteWorkspaceResponseWorkspace.accountAccessType) &&
        Objects.equals(this.authentication, deleteWorkspaceResponseWorkspace.authentication) &&
        Objects.equals(this.created, deleteWorkspaceResponseWorkspace.created) &&
        Objects.equals(this.dataSources, deleteWorkspaceResponseWorkspace.dataSources) &&
        Objects.equals(this.description, deleteWorkspaceResponseWorkspace.description) &&
        Objects.equals(this.endpoint, deleteWorkspaceResponseWorkspace.endpoint) &&
        Objects.equals(this.freeTrialConsumed, deleteWorkspaceResponseWorkspace.freeTrialConsumed) &&
        Objects.equals(this.freeTrialExpiration, deleteWorkspaceResponseWorkspace.freeTrialExpiration) &&
        Objects.equals(this.grafanaVersion, deleteWorkspaceResponseWorkspace.grafanaVersion) &&
        Objects.equals(this.id, deleteWorkspaceResponseWorkspace.id) &&
        Objects.equals(this.licenseExpiration, deleteWorkspaceResponseWorkspace.licenseExpiration) &&
        Objects.equals(this.licenseType, deleteWorkspaceResponseWorkspace.licenseType) &&
        Objects.equals(this.modified, deleteWorkspaceResponseWorkspace.modified) &&
        Objects.equals(this.name, deleteWorkspaceResponseWorkspace.name) &&
        Objects.equals(this.networkAccessControl, deleteWorkspaceResponseWorkspace.networkAccessControl) &&
        Objects.equals(this.notificationDestinations, deleteWorkspaceResponseWorkspace.notificationDestinations) &&
        Objects.equals(this.organizationRoleName, deleteWorkspaceResponseWorkspace.organizationRoleName) &&
        Objects.equals(this.organizationalUnits, deleteWorkspaceResponseWorkspace.organizationalUnits) &&
        Objects.equals(this.permissionType, deleteWorkspaceResponseWorkspace.permissionType) &&
        Objects.equals(this.stackSetName, deleteWorkspaceResponseWorkspace.stackSetName) &&
        Objects.equals(this.status, deleteWorkspaceResponseWorkspace.status) &&
        Objects.equals(this.tags, deleteWorkspaceResponseWorkspace.tags) &&
        Objects.equals(this.vpcConfiguration, deleteWorkspaceResponseWorkspace.vpcConfiguration) &&
        Objects.equals(this.workspaceRoleArn, deleteWorkspaceResponseWorkspace.workspaceRoleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteWorkspaceResponseWorkspace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteWorkspaceResponseWorkspace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteWorkspaceResponseWorkspace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteWorkspaceResponseWorkspace is not found in the empty JSON string", DeleteWorkspaceResponseWorkspace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteWorkspaceResponseWorkspace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteWorkspaceResponseWorkspace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteWorkspaceResponseWorkspace.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteWorkspaceResponseWorkspace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteWorkspaceResponseWorkspace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteWorkspaceResponseWorkspace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteWorkspaceResponseWorkspace.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteWorkspaceResponseWorkspace>() {
           @Override
           public void write(JsonWriter out, DeleteWorkspaceResponseWorkspace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteWorkspaceResponseWorkspace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteWorkspaceResponseWorkspace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteWorkspaceResponseWorkspace
   * @throws IOException if the JSON string is invalid with respect to DeleteWorkspaceResponseWorkspace
   */
  public static DeleteWorkspaceResponseWorkspace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteWorkspaceResponseWorkspace.class);
  }

  /**
   * Convert an instance of DeleteWorkspaceResponseWorkspace to an JSON string
   *
   * @return JSON string
   */
