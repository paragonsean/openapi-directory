...
public class SamlAuthenticationConfiguration {
  ...
  public SamlAuthenticationConfiguration() {
  }

  public SamlAuthenticationConfiguration allowedOrganizations(List allowedOrganizations) {
  ...
  public SamlAuthenticationConfiguration assertionAttributes(UpdateWorkspaceAuthenticationRequestSamlConfigurationAssertionAttributes assertionAttributes) {
  ...
  public SamlAuthenticationConfiguration idpMetadata(UpdateWorkspaceAuthenticationRequestSamlConfigurationIdpMetadata idpMetadata) {
  ...
  public SamlAuthenticationConfiguration loginValidityDuration(Integer loginValidityDuration) {
  ...
  public SamlAuthenticationConfiguration roleValues(UpdateWorkspaceAuthenticationRequestSamlConfigurationRoleValues roleValues) {
  ...
  public boolean equals(Object o) {
    ...
    SamlAuthenticationConfiguration samlAuthenticationConfiguration = (SamlAuthenticationConfiguration) o;
    return Objects.equals(this.allowedOrganizations, samlAuthenticationConfiguration.allowedOrganizations) &&
        Objects.equals(this.assertionAttributes, samlAuthenticationConfiguration.assertionAttributes) &&
        Objects.equals(this.idpMetadata, samlAuthenticationConfiguration.idpMetadata) &&
        Objects.equals(this.loginValidityDuration, samlAuthenticationConfiguration.loginValidityDuration) &&
        Objects.equals(this.roleValues, samlAuthenticationConfiguration.roleValues);
  }
  ...
  public String toString() {
    ...
    sb.append("class SamlAuthenticationConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SamlAuthenticationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SamlAuthenticationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SamlAuthenticationConfiguration is not found in the empty JSON string", SamlAuthenticationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SamlAuthenticationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SamlAuthenticationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SamlAuthenticationConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SamlAuthenticationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SamlAuthenticationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SamlAuthenticationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SamlAuthenticationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<SamlAuthenticationConfiguration>() {
           @Override
           public void write(JsonWriter out, SamlAuthenticationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SamlAuthenticationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SamlAuthenticationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SamlAuthenticationConfiguration
   * @throws IOException if the JSON string is invalid with respect to SamlAuthenticationConfiguration
   */
  public static SamlAuthenticationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SamlAuthenticationConfiguration.class);
  }

  /**
   * Convert an instance of SamlAuthenticationConfiguration to an JSON string
   *
   * @return JSON string
   */
