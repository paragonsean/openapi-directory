...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSsoOidc.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    ...
    describe('registerClient', function() {
      it('should call registerClient successfully', function(done) {
        //uncomment below and update the code to test registerClient
        //instance.registerClient(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('startDeviceAuthorization', function() {
      it('should call startDeviceAuthorization successfully', function(done) {
        //uncomment below and update the code to test startDeviceAuthorization
        //instance.startDeviceAuthorization(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
