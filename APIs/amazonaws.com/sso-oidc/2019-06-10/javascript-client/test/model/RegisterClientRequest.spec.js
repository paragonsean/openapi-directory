...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSsoOidc.RegisterClientRequest();
  });
  ...
  describe('RegisterClientRequest', function() {
    it('should create an instance of RegisterClientRequest', function() {
      // uncomment below and update the code to test RegisterClientRequest
      //var instance = new AwsSsoOidc.RegisterClientRequest();
      //expect(instance).to.be.a(AwsSsoOidc.RegisterClientRequest);
    });
