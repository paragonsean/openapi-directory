...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSsoOidc.StartDeviceAuthorizationRequest();
  });
  ...
  describe('StartDeviceAuthorizationRequest', function() {
    it('should create an instance of StartDeviceAuthorizationRequest', function() {
      // uncomment below and update the code to test StartDeviceAuthorizationRequest
      //var instance = new AwsSsoOidc.StartDeviceAuthorizationRequest();
      //expect(instance).to.be.a(AwsSsoOidc.StartDeviceAuthorizationRequest);
    });
