...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSsoOidc.StartDeviceAuthorizationResponse();
  });
  ...
  describe('StartDeviceAuthorizationResponse', function() {
    it('should create an instance of StartDeviceAuthorizationResponse', function() {
      // uncomment below and update the code to test StartDeviceAuthorizationResponse
      //var instance = new AwsSsoOidc.StartDeviceAuthorizationResponse();
      //expect(instance).to.be.a(AwsSsoOidc.StartDeviceAuthorizationResponse);
    });
    ...
    it('should have the property userCode (base name: "userCode")', function() {
      // uncomment below and update the code to test the property userCode
      //var instance = new AwsSsoOidc.StartDeviceAuthorizationResponse();
      //expect(instance).to.be();
    });

    it('should have the property verificationUri (base name: "verificationUri")', function() {
      // uncomment below and update the code to test the property verificationUri
      //var instance = new AwsSsoOidc.StartDeviceAuthorizationResponse();
      //expect(instance).to.be();
    });

    it('should have the property verificationUriComplete (base name: "verificationUriComplete")', function() {
