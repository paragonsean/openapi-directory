...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSsoOidc.RegisterClientResponse();
  });
  ...
  describe('RegisterClientResponse', function() {
    it('should create an instance of RegisterClientResponse', function() {
      // uncomment below and update the code to test RegisterClientResponse
      //var instance = new AwsSsoOidc.RegisterClientResponse();
      //expect(instance).to.be.a(AwsSsoOidc.RegisterClientResponse);
    });
