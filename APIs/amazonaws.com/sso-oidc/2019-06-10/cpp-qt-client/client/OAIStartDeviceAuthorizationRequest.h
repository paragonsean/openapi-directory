...
/*
 * OAIStartDeviceAuthorizationRequest.h
 *
 * 
 */

#ifndef OAIStartDeviceAuthorizationRequest_H
#define OAIStartDeviceAuthorizationRequest_H
...
class OAIStartDeviceAuthorizationRequest : public OAIObject {
public:
    OAIStartDeviceAuthorizationRequest();
    OAIStartDeviceAuthorizationRequest(QString json);
    ~OAIStartDeviceAuthorizationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartDeviceAuthorizationRequest)

#endif // OAIStartDeviceAuthorizationRequest_H
