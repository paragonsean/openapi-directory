...
OAIStartDeviceAuthorization_request::OAIStartDeviceAuthorization_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartDeviceAuthorization_request::OAIStartDeviceAuthorization_request() {
    this->initializeModel();
}

OAIStartDeviceAuthorization_request::~OAIStartDeviceAuthorization_request() {}

void OAIStartDeviceAuthorization_request::initializeModel() {
...
void OAIStartDeviceAuthorization_request::fromJson(QString jsonString) {
...
void OAIStartDeviceAuthorization_request::fromJsonObject(QJsonObject json) {
...
QString OAIStartDeviceAuthorization_request::asJson() const {
...
QJsonObject OAIStartDeviceAuthorization_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartDeviceAuthorization_request::getClientId() const {
    return m_client_id;
}
void OAIStartDeviceAuthorization_request::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIStartDeviceAuthorization_request::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIStartDeviceAuthorization_request::is_client_id_Valid() const{
    return m_client_id_isValid;
}

QString OAIStartDeviceAuthorization_request::getClientSecret() const {
    return m_client_secret;
}
void OAIStartDeviceAuthorization_request::setClientSecret(const QString &client_secret) {
    m_client_secret = client_secret;
    m_client_secret_isSet = true;
}

bool OAIStartDeviceAuthorization_request::is_client_secret_Set() const{
    return m_client_secret_isSet;
}

bool OAIStartDeviceAuthorization_request::is_client_secret_Valid() const{
    return m_client_secret_isValid;
}

QString OAIStartDeviceAuthorization_request::getStartUrl() const {
    return m_start_url;
}
void OAIStartDeviceAuthorization_request::setStartUrl(const QString &start_url) {
    m_start_url = start_url;
    m_start_url_isSet = true;
}

bool OAIStartDeviceAuthorization_request::is_start_url_Set() const{
    return m_start_url_isSet;
}

bool OAIStartDeviceAuthorization_request::is_start_url_Valid() const{
    return m_start_url_isValid;
}

bool OAIStartDeviceAuthorization_request::isSet() const {
...
bool OAIStartDeviceAuthorization_request::isValid() const {
