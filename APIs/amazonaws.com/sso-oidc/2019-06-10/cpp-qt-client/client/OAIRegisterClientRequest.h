...
/*
 * OAIRegisterClientRequest.h
 *
 * 
 */

#ifndef OAIRegisterClientRequest_H
#define OAIRegisterClientRequest_H
...
class OAIRegisterClientRequest : public OAIObject {
public:
    OAIRegisterClientRequest();
    OAIRegisterClientRequest(QString json);
    ~OAIRegisterClientRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterClientRequest)

#endif // OAIRegisterClientRequest_H
