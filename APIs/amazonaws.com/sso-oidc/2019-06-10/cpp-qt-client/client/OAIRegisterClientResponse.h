...
/*
 * OAIRegisterClientResponse.h
 *
 * 
 */

#ifndef OAIRegisterClientResponse_H
#define OAIRegisterClientResponse_H
...
class OAIRegisterClientResponse : public OAIObject {
public:
    OAIRegisterClientResponse();
    OAIRegisterClientResponse(QString json);
    ~OAIRegisterClientResponse() override;
    ...
    qint32 getClientIdIssuedAt() const;
    void setClientIdIssuedAt(const qint32 &client_id_issued_at);
    bool is_client_id_issued_at_Set() const;
    bool is_client_id_issued_at_Valid() const;

    qint32 getClientSecretExpiresAt() const;
    void setClientSecretExpiresAt(const qint32 &client_secret_expires_at);
    bool is_client_secret_expires_at_Set() const;
    bool is_client_secret_expires_at_Valid() const;
...
private:
    ...
    qint32 m_client_id_issued_at;
    bool m_client_id_issued_at_isSet;
    bool m_client_id_issued_at_isValid;

    qint32 m_client_secret_expires_at;
    bool m_client_secret_expires_at_isSet;
    bool m_client_secret_expires_at_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterClientResponse)

#endif // OAIRegisterClientResponse_H
