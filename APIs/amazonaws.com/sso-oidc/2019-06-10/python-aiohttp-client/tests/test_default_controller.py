...
async def test_create_token(client):
    ...
    """
    body = {"redirectUri":"","clientId":"","code":"","scope":"","clientSecret":"","deviceCode":"","grantType":"","refreshToken":""}
    headers = { 
...
async def test_register_client(client):
    """Test case for register_client

    
    """
    body = {"clientType":"","clientName":"","scopes":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_start_device_authorization(client):
    """Test case for start_device_authorization

    
    """
    body = {"startUrl":"","clientId":"","clientSecret":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
