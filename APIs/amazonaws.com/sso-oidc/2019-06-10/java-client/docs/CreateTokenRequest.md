...
|**scope** | **List&lt;String&gt;** | The list of scopes that is defined by the client. Upon authorization, this list is used to restrict permissions when granting an access token. |  [optional] |
