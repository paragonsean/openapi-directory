...
OAICreateApp_request Example::create(){
    OAICreateApp_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createAppSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createAppSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateApp_request oai_create_app_request = create(); // OAICreateApp_request | 
      ...
      apiInstance.createApp(oai_create_app_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
