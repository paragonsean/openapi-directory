...
/*
 * OAIPushNotificationTemplateResponse_APNS.h
 *
 * 
 */

#ifndef OAIPushNotificationTemplateResponse_APNS_H
#define OAIPushNotificationTemplateResponse_APNS_H
...
class OAIPushNotificationTemplateResponse_APNS : public OAIObject {
public:
    OAIPushNotificationTemplateResponse_APNS();
    OAIPushNotificationTemplateResponse_APNS(QString json);
    ~OAIPushNotificationTemplateResponse_APNS() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPushNotificationTemplateResponse_APNS)

#endif // OAIPushNotificationTemplateResponse_APNS_H
