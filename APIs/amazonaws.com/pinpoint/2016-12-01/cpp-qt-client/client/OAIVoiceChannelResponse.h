...
/*
 * OAIVoiceChannelResponse.h
 *
 * Provides information about the status and settings of the voice channel for an application.
 */

#ifndef OAIVoiceChannelResponse_H
#define OAIVoiceChannelResponse_H
...
class OAIVoiceChannelResponse : public OAIObject {
public:
    OAIVoiceChannelResponse();
    OAIVoiceChannelResponse(QString json);
    ~OAIVoiceChannelResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVoiceChannelResponse)

#endif // OAIVoiceChannelResponse_H
