...
/*
 * OAIEndpointRequest.h
 *
 * Specifies the channel type and other settings for an endpoint.
 */

#ifndef OAIEndpointRequest_H
#define OAIEndpointRequest_H
...
class OAIEndpointRequest : public OAIObject {
public:
    OAIEndpointRequest();
    OAIEndpointRequest(QString json);
    ~OAIEndpointRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointRequest)

#endif // OAIEndpointRequest_H
