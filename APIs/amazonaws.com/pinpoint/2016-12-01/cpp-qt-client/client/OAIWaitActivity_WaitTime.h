...
/*
 * OAIWaitActivity_WaitTime.h
 *
 * 
 */

#ifndef OAIWaitActivity_WaitTime_H
#define OAIWaitActivity_WaitTime_H
...
class OAIWaitActivity_WaitTime : public OAIObject {
public:
    OAIWaitActivity_WaitTime();
    OAIWaitActivity_WaitTime(QString json);
    ~OAIWaitActivity_WaitTime() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWaitActivity_WaitTime)

#endif // OAIWaitActivity_WaitTime_H
