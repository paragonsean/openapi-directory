...
/*
 * OAIEventsBatch_Endpoint.h
 *
 * 
 */

#ifndef OAIEventsBatch_Endpoint_H
#define OAIEventsBatch_Endpoint_H
...
class OAIEventsBatch_Endpoint : public OAIObject {
public:
    OAIEventsBatch_Endpoint();
    OAIEventsBatch_Endpoint(QString json);
    ~OAIEventsBatch_Endpoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsBatch_Endpoint)

#endif // OAIEventsBatch_Endpoint_H
