...
/*
 * OAIBaiduChannelResponse.h
 *
 * Provides information about the status and settings of the Baidu (Baidu Cloud Push) channel for an application.
 */

#ifndef OAIBaiduChannelResponse_H
#define OAIBaiduChannelResponse_H
...
class OAIBaiduChannelResponse : public OAIObject {
public:
    OAIBaiduChannelResponse();
    OAIBaiduChannelResponse(QString json);
    ~OAIBaiduChannelResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaiduChannelResponse)

#endif // OAIBaiduChannelResponse_H
