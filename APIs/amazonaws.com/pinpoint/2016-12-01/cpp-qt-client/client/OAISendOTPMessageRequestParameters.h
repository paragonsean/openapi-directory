...
/*
 * OAISendOTPMessageRequestParameters.h
 *
 * Send OTP message request parameters.
 */

#ifndef OAISendOTPMessageRequestParameters_H
#define OAISendOTPMessageRequestParameters_H
...
class OAISendOTPMessageRequestParameters : public OAIObject {
public:
    OAISendOTPMessageRequestParameters();
    OAISendOTPMessageRequestParameters(QString json);
    ~OAISendOTPMessageRequestParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendOTPMessageRequestParameters)

#endif // OAISendOTPMessageRequestParameters_H
