...
/*
 * OAIUpdateEndpoint_request_EndpointRequest.h
 *
 * Specifies the channel type and other settings for an endpoint.
 */

#ifndef OAIUpdateEndpoint_request_EndpointRequest_H
#define OAIUpdateEndpoint_request_EndpointRequest_H
...
class OAIUpdateEndpoint_request_EndpointRequest : public OAIObject {
public:
    OAIUpdateEndpoint_request_EndpointRequest();
    OAIUpdateEndpoint_request_EndpointRequest(QString json);
    ~OAIUpdateEndpoint_request_EndpointRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEndpoint_request_EndpointRequest)

#endif // OAIUpdateEndpoint_request_EndpointRequest_H
