...
OAIAPNSChannelRequest::OAIAPNSChannelRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAPNSChannelRequest::OAIAPNSChannelRequest() {
    this->initializeModel();
}

OAIAPNSChannelRequest::~OAIAPNSChannelRequest() {}

void OAIAPNSChannelRequest::initializeModel() {
...
void OAIAPNSChannelRequest::fromJson(QString jsonString) {
...
void OAIAPNSChannelRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAPNSChannelRequest::asJson() const {
...
QJsonObject OAIAPNSChannelRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAPNSChannelRequest::getBundleId() const {
    return m_bundle_id;
}
void OAIAPNSChannelRequest::setBundleId(const QString &bundle_id) {
    m_bundle_id = bundle_id;
    m_bundle_id_isSet = true;
}

bool OAIAPNSChannelRequest::is_bundle_id_Set() const{
    return m_bundle_id_isSet;
}

bool OAIAPNSChannelRequest::is_bundle_id_Valid() const{
    return m_bundle_id_isValid;
}

QString OAIAPNSChannelRequest::getCertificate() const {
    return m_certificate;
}
void OAIAPNSChannelRequest::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAIAPNSChannelRequest::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAIAPNSChannelRequest::is_certificate_Valid() const{
    return m_certificate_isValid;
}

QString OAIAPNSChannelRequest::getDefaultAuthenticationMethod() const {
    return m_default_authentication_method;
}
void OAIAPNSChannelRequest::setDefaultAuthenticationMethod(const QString &default_authentication_method) {
    m_default_authentication_method = default_authentication_method;
    m_default_authentication_method_isSet = true;
}

bool OAIAPNSChannelRequest::is_default_authentication_method_Set() const{
    return m_default_authentication_method_isSet;
}

bool OAIAPNSChannelRequest::is_default_authentication_method_Valid() const{
    return m_default_authentication_method_isValid;
}

bool OAIAPNSChannelRequest::getEnabled() const {
    return m_enabled;
}
void OAIAPNSChannelRequest::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIAPNSChannelRequest::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIAPNSChannelRequest::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAIAPNSChannelRequest::getPrivateKey() const {
    return m_private_key;
}
void OAIAPNSChannelRequest::setPrivateKey(const QString &private_key) {
    m_private_key = private_key;
    m_private_key_isSet = true;
}

bool OAIAPNSChannelRequest::is_private_key_Set() const{
    return m_private_key_isSet;
}

bool OAIAPNSChannelRequest::is_private_key_Valid() const{
    return m_private_key_isValid;
}

QString OAIAPNSChannelRequest::getTeamId() const {
    return m_team_id;
}
void OAIAPNSChannelRequest::setTeamId(const QString &team_id) {
    m_team_id = team_id;
    m_team_id_isSet = true;
}

bool OAIAPNSChannelRequest::is_team_id_Set() const{
    return m_team_id_isSet;
}

bool OAIAPNSChannelRequest::is_team_id_Valid() const{
    return m_team_id_isValid;
}

QString OAIAPNSChannelRequest::getTokenKey() const {
    return m_token_key;
}
void OAIAPNSChannelRequest::setTokenKey(const QString &token_key) {
    m_token_key = token_key;
    m_token_key_isSet = true;
}

bool OAIAPNSChannelRequest::is_token_key_Set() const{
    return m_token_key_isSet;
}

bool OAIAPNSChannelRequest::is_token_key_Valid() const{
    return m_token_key_isValid;
}

QString OAIAPNSChannelRequest::getTokenKeyId() const {
    return m_token_key_id;
}
void OAIAPNSChannelRequest::setTokenKeyId(const QString &token_key_id) {
    m_token_key_id = token_key_id;
    m_token_key_id_isSet = true;
}

bool OAIAPNSChannelRequest::is_token_key_id_Set() const{
    return m_token_key_id_isSet;
}

bool OAIAPNSChannelRequest::is_token_key_id_Valid() const{
    return m_token_key_id_isValid;
}

bool OAIAPNSChannelRequest::isSet() const {
...
bool OAIAPNSChannelRequest::isValid() const {
