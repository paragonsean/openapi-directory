...
/*
 * OAIAPNSSandboxChannelResponse.h
 *
 * Provides information about the status and settings of the APNs (Apple Push Notification service) sandbox channel for an application.
 */

#ifndef OAIAPNSSandboxChannelResponse_H
#define OAIAPNSSandboxChannelResponse_H
...
class OAIAPNSSandboxChannelResponse : public OAIObject {
public:
    OAIAPNSSandboxChannelResponse();
    OAIAPNSSandboxChannelResponse(QString json);
    ~OAIAPNSSandboxChannelResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPNSSandboxChannelResponse)

#endif // OAIAPNSSandboxChannelResponse_H
