...
/*
 * OAITreatmentResource_Schedule.h
 *
 * 
 */

#ifndef OAITreatmentResource_Schedule_H
#define OAITreatmentResource_Schedule_H
...
class OAITreatmentResource_Schedule : public OAIObject {
public:
    OAITreatmentResource_Schedule();
    OAITreatmentResource_Schedule(QString json);
    ~OAITreatmentResource_Schedule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITreatmentResource_Schedule)

#endif // OAITreatmentResource_Schedule_H
