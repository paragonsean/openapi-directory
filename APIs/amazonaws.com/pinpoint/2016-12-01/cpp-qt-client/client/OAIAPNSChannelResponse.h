...
/*
 * OAIAPNSChannelResponse.h
 *
 * Provides information about the status and settings of the APNs (Apple Push Notification service) channel for an application.
 */

#ifndef OAIAPNSChannelResponse_H
#define OAIAPNSChannelResponse_H
...
class OAIAPNSChannelResponse : public OAIObject {
public:
    OAIAPNSChannelResponse();
    OAIAPNSChannelResponse(QString json);
    ~OAIAPNSChannelResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPNSChannelResponse)

#endif // OAIAPNSChannelResponse_H
