...
/*
 * OAIWriteJourneyRequest.h
 *
 * Specifies the configuration and other settings for a journey.
 */

#ifndef OAIWriteJourneyRequest_H
#define OAIWriteJourneyRequest_H
...
class OAIWriteJourneyRequest : public OAIObject {
public:
    OAIWriteJourneyRequest();
    OAIWriteJourneyRequest(QString json);
    ~OAIWriteJourneyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWriteJourneyRequest)

#endif // OAIWriteJourneyRequest_H
