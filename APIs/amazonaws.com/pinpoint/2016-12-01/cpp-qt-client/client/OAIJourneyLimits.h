...
#ifndef OAIJourneyLimits_H
#define OAIJourneyLimits_H
...
class OAIJourneyLimits : public OAIObject {
public:
    OAIJourneyLimits();
    OAIJourneyLimits(QString json);
    ~OAIJourneyLimits() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJourneyLimits)

#endif // OAIJourneyLimits_H
