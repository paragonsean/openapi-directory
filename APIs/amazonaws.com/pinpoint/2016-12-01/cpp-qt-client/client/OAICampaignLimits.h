...
#ifndef OAICampaignLimits_H
#define OAICampaignLimits_H
...
class OAICampaignLimits : public OAIObject {
public:
    OAICampaignLimits();
    OAICampaignLimits(QString json);
    ~OAICampaignLimits() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaignLimits)

#endif // OAICampaignLimits_H
