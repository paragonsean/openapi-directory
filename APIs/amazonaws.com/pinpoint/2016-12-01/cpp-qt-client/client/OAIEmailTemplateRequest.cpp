...
OAIEmailTemplateRequest::OAIEmailTemplateRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmailTemplateRequest::OAIEmailTemplateRequest() {
    this->initializeModel();
}

OAIEmailTemplateRequest::~OAIEmailTemplateRequest() {}

void OAIEmailTemplateRequest::initializeModel() {
...
void OAIEmailTemplateRequest::fromJson(QString jsonString) {
...
void OAIEmailTemplateRequest::fromJsonObject(QJsonObject json) {
...
QString OAIEmailTemplateRequest::asJson() const {
...
QJsonObject OAIEmailTemplateRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEmailTemplateRequest::getDefaultSubstitutions() const {
    return m_default_substitutions;
}
void OAIEmailTemplateRequest::setDefaultSubstitutions(const QString &default_substitutions) {
    m_default_substitutions = default_substitutions;
    m_default_substitutions_isSet = true;
}

bool OAIEmailTemplateRequest::is_default_substitutions_Set() const{
    return m_default_substitutions_isSet;
}

bool OAIEmailTemplateRequest::is_default_substitutions_Valid() const{
    return m_default_substitutions_isValid;
}

QString OAIEmailTemplateRequest::getHtmlPart() const {
    return m_html_part;
}
void OAIEmailTemplateRequest::setHtmlPart(const QString &html_part) {
    m_html_part = html_part;
    m_html_part_isSet = true;
}

bool OAIEmailTemplateRequest::is_html_part_Set() const{
    return m_html_part_isSet;
}

bool OAIEmailTemplateRequest::is_html_part_Valid() const{
    return m_html_part_isValid;
}

QString OAIEmailTemplateRequest::getRecommenderId() const {
    return m_recommender_id;
}
void OAIEmailTemplateRequest::setRecommenderId(const QString &recommender_id) {
    m_recommender_id = recommender_id;
    m_recommender_id_isSet = true;
}

bool OAIEmailTemplateRequest::is_recommender_id_Set() const{
    return m_recommender_id_isSet;
}

bool OAIEmailTemplateRequest::is_recommender_id_Valid() const{
    return m_recommender_id_isValid;
}

QString OAIEmailTemplateRequest::getSubject() const {
    return m_subject;
}
void OAIEmailTemplateRequest::setSubject(const QString &subject) {
    m_subject = subject;
    m_subject_isSet = true;
}

bool OAIEmailTemplateRequest::is_subject_Set() const{
    return m_subject_isSet;
}

bool OAIEmailTemplateRequest::is_subject_Valid() const{
    return m_subject_isValid;
}

QMap OAIEmailTemplateRequest::getTags() const {
    return m_tags;
}
void OAIEmailTemplateRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIEmailTemplateRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIEmailTemplateRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIEmailTemplateRequest::getTemplateDescription() const {
    return m_template_description;
}
void OAIEmailTemplateRequest::setTemplateDescription(const QString &template_description) {
    m_template_description = template_description;
    m_template_description_isSet = true;
}

bool OAIEmailTemplateRequest::is_template_description_Set() const{
    return m_template_description_isSet;
}

bool OAIEmailTemplateRequest::is_template_description_Valid() const{
    return m_template_description_isValid;
}

QString OAIEmailTemplateRequest::getTextPart() const {
    return m_text_part;
}
void OAIEmailTemplateRequest::setTextPart(const QString &text_part) {
    m_text_part = text_part;
    m_text_part_isSet = true;
}

bool OAIEmailTemplateRequest::is_text_part_Set() const{
    return m_text_part_isSet;
}

bool OAIEmailTemplateRequest::is_text_part_Valid() const{
    return m_text_part_isValid;
}

bool OAIEmailTemplateRequest::isSet() const {
...
bool OAIEmailTemplateRequest::isValid() const {
