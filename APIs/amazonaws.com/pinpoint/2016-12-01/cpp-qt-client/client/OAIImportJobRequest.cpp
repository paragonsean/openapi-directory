...
OAIImportJobRequest::OAIImportJobRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportJobRequest::OAIImportJobRequest() {
    this->initializeModel();
}

OAIImportJobRequest::~OAIImportJobRequest() {}

void OAIImportJobRequest::initializeModel() {
...
void OAIImportJobRequest::fromJson(QString jsonString) {
...
void OAIImportJobRequest::fromJsonObject(QJsonObject json) {
...
QString OAIImportJobRequest::asJson() const {
...
QJsonObject OAIImportJobRequest::asJsonObject() const {
    QJsonObject obj;
...
bool OAIImportJobRequest::getDefineSegment() const {
    return m_define_segment;
}
void OAIImportJobRequest::setDefineSegment(const bool &define_segment) {
    m_define_segment = define_segment;
    m_define_segment_isSet = true;
}

bool OAIImportJobRequest::is_define_segment_Set() const{
    return m_define_segment_isSet;
}

bool OAIImportJobRequest::is_define_segment_Valid() const{
    return m_define_segment_isValid;
}

QString OAIImportJobRequest::getExternalId() const {
    return m_external_id;
}
void OAIImportJobRequest::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAIImportJobRequest::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAIImportJobRequest::is_external_id_Valid() const{
    return m_external_id_isValid;
}

OAIFormat OAIImportJobRequest::getFormat() const {
    return m_format;
}
void OAIImportJobRequest::setFormat(const OAIFormat &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIImportJobRequest::is_format_Set() const{
    return m_format_isSet;
}

bool OAIImportJobRequest::is_format_Valid() const{
    return m_format_isValid;
}

bool OAIImportJobRequest::getRegisterEndpoints() const {
    return m_register_endpoints;
}
void OAIImportJobRequest::setRegisterEndpoints(const bool &register_endpoints) {
    m_register_endpoints = register_endpoints;
    m_register_endpoints_isSet = true;
}

bool OAIImportJobRequest::is_register_endpoints_Set() const{
    return m_register_endpoints_isSet;
}

bool OAIImportJobRequest::is_register_endpoints_Valid() const{
    return m_register_endpoints_isValid;
}

QString OAIImportJobRequest::getRoleArn() const {
    return m_role_arn;
}
void OAIImportJobRequest::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIImportJobRequest::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIImportJobRequest::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAIImportJobRequest::getS3Url() const {
    return m_s3_url;
}
void OAIImportJobRequest::setS3Url(const QString &s3_url) {
    m_s3_url = s3_url;
    m_s3_url_isSet = true;
}

bool OAIImportJobRequest::is_s3_url_Set() const{
    return m_s3_url_isSet;
}

bool OAIImportJobRequest::is_s3_url_Valid() const{
    return m_s3_url_isValid;
}

QString OAIImportJobRequest::getSegmentId() const {
    return m_segment_id;
}
void OAIImportJobRequest::setSegmentId(const QString &segment_id) {
    m_segment_id = segment_id;
    m_segment_id_isSet = true;
}

bool OAIImportJobRequest::is_segment_id_Set() const{
    return m_segment_id_isSet;
}

bool OAIImportJobRequest::is_segment_id_Valid() const{
    return m_segment_id_isValid;
}

QString OAIImportJobRequest::getSegmentName() const {
    return m_segment_name;
}
void OAIImportJobRequest::setSegmentName(const QString &segment_name) {
    m_segment_name = segment_name;
    m_segment_name_isSet = true;
}

bool OAIImportJobRequest::is_segment_name_Set() const{
    return m_segment_name_isSet;
}

bool OAIImportJobRequest::is_segment_name_Valid() const{
    return m_segment_name_isValid;
}

bool OAIImportJobRequest::isSet() const {
...
bool OAIImportJobRequest::isValid() const {
