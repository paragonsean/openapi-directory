...
QString OAISchedule::getEndTime() const {
    return m_end_time;
}
void OAISchedule::setEndTime(const QString &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAISchedule::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAISchedule::is_end_time_Valid() const{
    return m_end_time_isValid;
}

OAISchedule_EventFilter OAISchedule::getEventFilter() const {
    return m_event_filter;
}
void OAISchedule::setEventFilter(const OAISchedule_EventFilter &event_filter) {
    m_event_filter = event_filter;
    m_event_filter_isSet = true;
}

bool OAISchedule::is_event_filter_Set() const{
    return m_event_filter_isSet;
}

bool OAISchedule::is_event_filter_Valid() const{
    return m_event_filter_isValid;
}

OAIFrequency OAISchedule::getFrequency() const {
    return m_frequency;
}
void OAISchedule::setFrequency(const OAIFrequency &frequency) {
    m_frequency = frequency;
    m_frequency_isSet = true;
}

bool OAISchedule::is_frequency_Set() const{
    return m_frequency_isSet;
}

bool OAISchedule::is_frequency_Valid() const{
    return m_frequency_isValid;
}

bool OAISchedule::getIsLocalTime() const {
    return m_is_local_time;
}
void OAISchedule::setIsLocalTime(const bool &is_local_time) {
    m_is_local_time = is_local_time;
    m_is_local_time_isSet = true;
}

bool OAISchedule::is_is_local_time_Set() const{
    return m_is_local_time_isSet;
}

bool OAISchedule::is_is_local_time_Valid() const{
    return m_is_local_time_isValid;
}

OAISchedule_QuietTime OAISchedule::getQuietTime() const {
    return m_quiet_time;
}
void OAISchedule::setQuietTime(const OAISchedule_QuietTime &quiet_time) {
    m_quiet_time = quiet_time;
    m_quiet_time_isSet = true;
}

bool OAISchedule::is_quiet_time_Set() const{
    return m_quiet_time_isSet;
}

bool OAISchedule::is_quiet_time_Valid() const{
    return m_quiet_time_isValid;
}

QString OAISchedule::getStartTime() const {
    return m_start_time;
}
void OAISchedule::setStartTime(const QString &start_time) {
...
void OAISchedule::setTimezone(const QString &timezone) {
    m_timezone = timezone;
    m_timezone_isSet = true;
}

bool OAISchedule::is_timezone_Set() const{
    return m_timezone_isSet;
}

bool OAISchedule::is_timezone_Valid() const{
