...
/*
 * OAIUpdateEndpoint_request_EndpointRequest_Demographic.h
 *
 * 
 */

#ifndef OAIUpdateEndpoint_request_EndpointRequest_Demographic_H
#define OAIUpdateEndpoint_request_EndpointRequest_Demographic_H
...
class OAIUpdateEndpoint_request_EndpointRequest_Demographic : public OAIObject {
public:
    OAIUpdateEndpoint_request_EndpointRequest_Demographic();
    OAIUpdateEndpoint_request_EndpointRequest_Demographic(QString json);
    ~OAIUpdateEndpoint_request_EndpointRequest_Demographic() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEndpoint_request_EndpointRequest_Demographic)

#endif // OAIUpdateEndpoint_request_EndpointRequest_Demographic_H
