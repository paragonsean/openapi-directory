...
#ifndef OAIQuietTime_H
#define OAIQuietTime_H
...
class OAIQuietTime : public OAIObject {
public:
    OAIQuietTime();
    OAIQuietTime(QString json);
    ~OAIQuietTime() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuietTime)

#endif // OAIQuietTime_H
