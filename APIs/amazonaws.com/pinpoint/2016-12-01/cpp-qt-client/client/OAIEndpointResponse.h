...
/*
 * OAIEndpointResponse.h
 *
 * Provides information about the channel type and other settings for an endpoint.
 */

#ifndef OAIEndpointResponse_H
#define OAIEndpointResponse_H
...
class OAIEndpointResponse : public OAIObject {
public:
    OAIEndpointResponse();
    OAIEndpointResponse(QString json);
    ~OAIEndpointResponse() override;
    ...
    QString getCohortId() const;
    void setCohortId(const QString &cohort_id);
    bool is_cohort_id_Set() const;
    bool is_cohort_id_Valid() const;
...
private:
    ...
    QString m_cohort_id;
    bool m_cohort_id_isSet;
    bool m_cohort_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointResponse)

#endif // OAIEndpointResponse_H
