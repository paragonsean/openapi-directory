...
/*
 * OAIInAppTemplateRequest.h
 *
 * InApp Template Request.
 */

#ifndef OAIInAppTemplateRequest_H
#define OAIInAppTemplateRequest_H
...
class OAIInAppTemplateRequest : public OAIObject {
public:
    OAIInAppTemplateRequest();
    OAIInAppTemplateRequest(QString json);
    ~OAIInAppTemplateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInAppTemplateRequest)

#endif // OAIInAppTemplateRequest_H
