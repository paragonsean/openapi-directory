...
/*
 * OAIGCMChannelResponse.h
 *
 * Provides information about the status and settings of the GCM channel for an application. The GCM channel enables Amazon Pinpoint to send push notifications through the Firebase Cloud Messaging (FCM), formerly Google Cloud Messaging (GCM), service.
 */

#ifndef OAIGCMChannelResponse_H
#define OAIGCMChannelResponse_H
...
class OAIGCMChannelResponse : public OAIObject {
public:
    OAIGCMChannelResponse();
    OAIGCMChannelResponse(QString json);
    ~OAIGCMChannelResponse() override;
    ...
    void setHasFcmServiceCredentials(const bool &has_fcm_service_credentials);
    bool is_has_fcm_service_credentials_Set() const;
    bool is_has_fcm_service_credentials_Valid() const;
...
private:
    ...
    bool m_has_fcm_service_credentials;
    bool m_has_fcm_service_credentials_isSet;
    bool m_has_fcm_service_credentials_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGCMChannelResponse)

#endif // OAIGCMChannelResponse_H
