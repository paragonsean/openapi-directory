...
#ifndef OAISMSMessage_H
#define OAISMSMessage_H
...
class OAISMSMessage : public OAIObject {
public:
    OAISMSMessage();
    OAISMSMessage(QString json);
    ~OAISMSMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISMSMessage)

#endif // OAISMSMessage_H
