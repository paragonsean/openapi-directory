...
QString OAITemplateResponse::getArn() const {
    return m_arn;
}
void OAITemplateResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAITemplateResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAITemplateResponse::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAITemplateResponse::getCreationDate() const {
    return m_creation_date;
}
void OAITemplateResponse::setCreationDate(const QString &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAITemplateResponse::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAITemplateResponse::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAITemplateResponse::getDefaultSubstitutions() const {
    return m_default_substitutions;
}
void OAITemplateResponse::setDefaultSubstitutions(const QString &default_substitutions) {
    m_default_substitutions = default_substitutions;
    m_default_substitutions_isSet = true;
}

bool OAITemplateResponse::is_default_substitutions_Set() const{
    return m_default_substitutions_isSet;
}

bool OAITemplateResponse::is_default_substitutions_Valid() const{
    return m_default_substitutions_isValid;
}

QString OAITemplateResponse::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAITemplateResponse::setLastModifiedDate(const QString &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAITemplateResponse::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAITemplateResponse::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QMap OAITemplateResponse::getTags() const {
    return m_tags;
}
void OAITemplateResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITemplateResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITemplateResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAITemplateResponse::getTemplateDescription() const {
    return m_template_description;
}
void OAITemplateResponse::setTemplateDescription(const QString &template_description) {
    m_template_description = template_description;
    m_template_description_isSet = true;
}

bool OAITemplateResponse::is_template_description_Set() const{
    return m_template_description_isSet;
}

bool OAITemplateResponse::is_template_description_Valid() const{
    return m_template_description_isValid;
}

QString OAITemplateResponse::getTemplateName() const {
    return m_template_name;
}
void OAITemplateResponse::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAITemplateResponse::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAITemplateResponse::is_template_name_Valid() const{
    return m_template_name_isValid;
}

OAITemplateType OAITemplateResponse::getTemplateType() const {
    return m_template_type;
}
void OAITemplateResponse::setTemplateType(const OAITemplateType &template_type) {
    m_template_type = template_type;
    m_template_type_isSet = true;
}

bool OAITemplateResponse::is_template_type_Set() const{
    return m_template_type_isSet;
}

bool OAITemplateResponse::is_template_type_Valid() const{
    return m_template_type_isValid;
}

QString OAITemplateResponse::getVersion() const {
    return m_version;
}
void OAITemplateResponse::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAITemplateResponse::is_version_Set() const{
    return m_version_isSet;
}

bool OAITemplateResponse::is_version_Valid() const{
