...
/*
 * OAIMessageConfiguration_SMSMessage.h
 *
 * 
 */

#ifndef OAIMessageConfiguration_SMSMessage_H
#define OAIMessageConfiguration_SMSMessage_H
...
class OAIMessageConfiguration_SMSMessage : public OAIObject {
public:
    OAIMessageConfiguration_SMSMessage();
    OAIMessageConfiguration_SMSMessage(QString json);
    ~OAIMessageConfiguration_SMSMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageConfiguration_SMSMessage)

#endif // OAIMessageConfiguration_SMSMessage_H
