...
/*
 * OAIAPNSVoipChannelResponse.h
 *
 * Provides information about the status and settings of the APNs (Apple Push Notification service) VoIP channel for an application.
 */

#ifndef OAIAPNSVoipChannelResponse_H
#define OAIAPNSVoipChannelResponse_H
...
class OAIAPNSVoipChannelResponse : public OAIObject {
public:
    OAIAPNSVoipChannelResponse();
    OAIAPNSVoipChannelResponse(QString json);
    ~OAIAPNSVoipChannelResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPNSVoipChannelResponse)

#endif // OAIAPNSVoipChannelResponse_H
