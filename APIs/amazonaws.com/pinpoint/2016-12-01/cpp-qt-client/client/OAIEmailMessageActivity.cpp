...
#include "OAIEmailMessageActivity.h"
...
OAIEmailMessageActivity::OAIEmailMessageActivity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmailMessageActivity::OAIEmailMessageActivity() {
    this->initializeModel();
}

OAIEmailMessageActivity::~OAIEmailMessageActivity() {}

void OAIEmailMessageActivity::initializeModel() {
...
void OAIEmailMessageActivity::fromJson(QString jsonString) {
...
void OAIEmailMessageActivity::fromJsonObject(QJsonObject json) {
...
QString OAIEmailMessageActivity::asJson() const {
...
QJsonObject OAIEmailMessageActivity::asJsonObject() const {
    QJsonObject obj;
...
OAIEmailMessageActivity_MessageConfig OAIEmailMessageActivity::getMessageConfig() const {
    return m_message_config;
}
void OAIEmailMessageActivity::setMessageConfig(const OAIEmailMessageActivity_MessageConfig &message_config) {
    m_message_config = message_config;
    m_message_config_isSet = true;
}

bool OAIEmailMessageActivity::is_message_config_Set() const{
    return m_message_config_isSet;
}

bool OAIEmailMessageActivity::is_message_config_Valid() const{
    return m_message_config_isValid;
}

QString OAIEmailMessageActivity::getNextActivity() const {
    return m_next_activity;
}
void OAIEmailMessageActivity::setNextActivity(const QString &next_activity) {
    m_next_activity = next_activity;
    m_next_activity_isSet = true;
}

bool OAIEmailMessageActivity::is_next_activity_Set() const{
    return m_next_activity_isSet;
}

bool OAIEmailMessageActivity::is_next_activity_Valid() const{
    return m_next_activity_isValid;
}

QString OAIEmailMessageActivity::getTemplateName() const {
    return m_template_name;
}
void OAIEmailMessageActivity::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIEmailMessageActivity::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIEmailMessageActivity::is_template_name_Valid() const{
    return m_template_name_isValid;
}

QString OAIEmailMessageActivity::getTemplateVersion() const {
    return m_template_version;
}
void OAIEmailMessageActivity::setTemplateVersion(const QString &template_version) {
    m_template_version = template_version;
    m_template_version_isSet = true;
}

bool OAIEmailMessageActivity::is_template_version_Set() const{
    return m_template_version_isSet;
}

bool OAIEmailMessageActivity::is_template_version_Valid() const{
    return m_template_version_isValid;
}

bool OAIEmailMessageActivity::isSet() const {
...
bool OAIEmailMessageActivity::isValid() const {
