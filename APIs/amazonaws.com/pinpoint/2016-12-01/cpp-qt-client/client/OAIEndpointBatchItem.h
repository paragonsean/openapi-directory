...
/*
 * OAIEndpointBatchItem.h
 *
 * Specifies an endpoint to create or update and the settings and attributes to set or change for the endpoint.
 */

#ifndef OAIEndpointBatchItem_H
#define OAIEndpointBatchItem_H
...
class OAIUpdateEndpoint_request_EndpointRequest_User;

class OAIEndpointBatchItem : public OAIObject {
public:
    OAIEndpointBatchItem();
    OAIEndpointBatchItem(QString json);
    ~OAIEndpointBatchItem() override;
    ...
    OAIUpdateEndpoint_request_EndpointRequest_User getUser() const;
    void setUser(const OAIUpdateEndpoint_request_EndpointRequest_User &user);
...
private:
    ...
    OAIUpdateEndpoint_request_EndpointRequest_User m_user;
    bool m_user_isSet;
    bool m_user_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointBatchItem)

#endif // OAIEndpointBatchItem_H
