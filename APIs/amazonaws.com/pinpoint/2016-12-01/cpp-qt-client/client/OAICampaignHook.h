...
#ifndef OAICampaignHook_H
#define OAICampaignHook_H
...
class OAICampaignHook : public OAIObject {
public:
    OAICampaignHook();
    OAICampaignHook(QString json);
    ~OAICampaignHook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaignHook)

#endif // OAICampaignHook_H
