...
/*
 * OAICreateJourney_request_WriteJourneyRequest.h
 *
 * Specifies the configuration and other settings for a journey.
 */

#ifndef OAICreateJourney_request_WriteJourneyRequest_H
#define OAICreateJourney_request_WriteJourneyRequest_H
...
#include "OAICreateJourney_request_WriteJourneyRequest_OpenHours.h"
...
class OAICreateJourney_request_WriteJourneyRequest_OpenHours;
class OAICreateJourney_request_WriteJourneyRequest_ClosedDays;

class OAICreateJourney_request_WriteJourneyRequest : public OAIObject {
public:
    OAICreateJourney_request_WriteJourneyRequest();
    OAICreateJourney_request_WriteJourneyRequest(QString json);
    ~OAICreateJourney_request_WriteJourneyRequest() override;
    ...
    OAICreateJourney_request_WriteJourneyRequest_OpenHours getOpenHours() const;
    void setOpenHours(const OAICreateJourney_request_WriteJourneyRequest_OpenHours &open_hours);
    bool is_open_hours_Set() const;
    bool is_open_hours_Valid() const;

    OAICreateJourney_request_WriteJourneyRequest_ClosedDays getClosedDays() const;
    void setClosedDays(const OAICreateJourney_request_WriteJourneyRequest_ClosedDays &closed_days);
...
private:
    ...
    OAICreateJourney_request_WriteJourneyRequest_OpenHours m_open_hours;
    bool m_open_hours_isSet;
    bool m_open_hours_isValid;

    OAICreateJourney_request_WriteJourneyRequest_ClosedDays m_closed_days;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJourney_request_WriteJourneyRequest)

#endif // OAICreateJourney_request_WriteJourneyRequest_H
