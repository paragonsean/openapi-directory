...
/*
 * OAIADMChannelResponse.h
 *
 * Provides information about the status and settings of the ADM (Amazon Device Messaging) channel for an application.
 */

#ifndef OAIADMChannelResponse_H
#define OAIADMChannelResponse_H
...
class OAIADMChannelResponse : public OAIObject {
public:
    OAIADMChannelResponse();
    OAIADMChannelResponse(QString json);
    ~OAIADMChannelResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIADMChannelResponse)

#endif // OAIADMChannelResponse_H
