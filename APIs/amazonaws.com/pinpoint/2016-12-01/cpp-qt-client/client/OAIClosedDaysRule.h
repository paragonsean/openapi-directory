...
#ifndef OAIClosedDaysRule_H
#define OAIClosedDaysRule_H
...
class OAIClosedDaysRule : public OAIObject {
public:
    OAIClosedDaysRule();
    OAIClosedDaysRule(QString json);
    ~OAIClosedDaysRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClosedDaysRule)

#endif // OAIClosedDaysRule_H
