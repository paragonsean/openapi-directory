...
public class ImportJobResponse {
  ...
  private ImportJobResponseDefinition definition;
  ...
  public ImportJobResponse applicationId(String applicationId) {
  ...
  public ImportJobResponse completedPieces(Integer completedPieces) {
  ...
  public ImportJobResponse completionDate(String completionDate) {
  ...
  public ImportJobResponse creationDate(String creationDate) {
  ...
  public ImportJobResponse definition(ImportJobResponseDefinition definition) {
   ...
   */
  @javax.annotation.Nonnull
  public ImportJobResponseDefinition getDefinition() {
    return definition;
  }

  public void setDefinition(ImportJobResponseDefinition definition) {
    this.definition = definition;
  }


  public ImportJobResponse failedPieces(Integer failedPieces) {
  ...
  public ImportJobResponse failures(List failures) {
  ...
  public ImportJobResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ImportJobResponse jobStatus(JobStatus jobStatus) {
  ...
  public ImportJobResponse totalFailures(Integer totalFailures) {
  ...
  public ImportJobResponse totalPieces(Integer totalPieces) {
  ...
  public ImportJobResponse totalProcessed(Integer totalProcessed) {
  ...
  public ImportJobResponse type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportJobResponse importJobResponse = (ImportJobResponse) o;
    return Objects.equals(this.applicationId, importJobResponse.applicationId) &&
        Objects.equals(this.completedPieces, importJobResponse.completedPieces) &&
        Objects.equals(this.completionDate, importJobResponse.completionDate) &&
        Objects.equals(this.creationDate, importJobResponse.creationDate) &&
        Objects.equals(this.definition, importJobResponse.definition) &&
        Objects.equals(this.failedPieces, importJobResponse.failedPieces) &&
        Objects.equals(this.failures, importJobResponse.failures) &&
        Objects.equals(this.id, importJobResponse.id) &&
        Objects.equals(this.jobStatus, importJobResponse.jobStatus) &&
        Objects.equals(this.totalFailures, importJobResponse.totalFailures) &&
        Objects.equals(this.totalPieces, importJobResponse.totalPieces) &&
        Objects.equals(this.totalProcessed, importJobResponse.totalProcessed) &&
        Objects.equals(this.type, importJobResponse.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportJobResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportJobResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportJobResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportJobResponse is not found in the empty JSON string", ImportJobResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportJobResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportJobResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportJobResponse.openapiRequiredFields) {
      ...
      ImportJobResponseDefinition.validateJsonElement(jsonObj.get("Definition"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportJobResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportJobResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportJobResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportJobResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportJobResponse>() {
           @Override
           public void write(JsonWriter out, ImportJobResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportJobResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportJobResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportJobResponse
   * @throws IOException if the JSON string is invalid with respect to ImportJobResponse
   */
  public static ImportJobResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportJobResponse.class);
  }

  /**
   * Convert an instance of ImportJobResponse to an JSON string
   *
   * @return JSON string
   */
