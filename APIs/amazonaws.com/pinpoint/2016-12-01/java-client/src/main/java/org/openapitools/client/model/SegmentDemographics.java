...
public class SegmentDemographics {
  ...
  public SegmentDemographics appVersion(SegmentDemographicsAppVersion appVersion) {
  ...
  public SegmentDemographics channel(SegmentDemographicsChannel channel) {
  ...
  public SegmentDemographics deviceType(SegmentDemographicsDeviceType deviceType) {
  ...
  public SegmentDemographics make(SegmentDemographicsMake make) {
    this.make = make;
    return this;
  }
  ...
  public SegmentDemographics model(SegmentDemographicsModel model) {
    this.model = model;
    return this;
  }
  ...
  public SegmentDemographics platform(SegmentDemographicsPlatform platform) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentDemographics segmentDemographics = (SegmentDemographics) o;
    return Objects.equals(this.appVersion, segmentDemographics.appVersion) &&
        Objects.equals(this.channel, segmentDemographics.channel) &&
        Objects.equals(this.deviceType, segmentDemographics.deviceType) &&
        Objects.equals(this.make, segmentDemographics.make) &&
        Objects.equals(this.model, segmentDemographics.model) &&
        Objects.equals(this.platform, segmentDemographics.platform);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentDemographics {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SegmentDemographics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SegmentDemographics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentDemographics is not found in the empty JSON string", SegmentDemographics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SegmentDemographics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SegmentDemographics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentDemographics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentDemographics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentDemographics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentDemographics.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentDemographics>() {
           @Override
           public void write(JsonWriter out, SegmentDemographics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SegmentDemographics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SegmentDemographics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SegmentDemographics
   * @throws IOException if the JSON string is invalid with respect to SegmentDemographics
   */
  public static SegmentDemographics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentDemographics.class);
  }

  /**
   * Convert an instance of SegmentDemographics to an JSON string
   *
   * @return JSON string
   */
