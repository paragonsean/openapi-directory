...
public class ActivityConditionalSplit {
  ...
  public ActivityConditionalSplit() {
  }

  public ActivityConditionalSplit condition(ConditionalSplitActivityCondition condition) {
  ...
  public ActivityConditionalSplit evaluationWaitTime(ConditionalSplitActivityEvaluationWaitTime evaluationWaitTime) {
  ...
  public ActivityConditionalSplit falseActivity(String falseActivity) {
  ...
  public ActivityConditionalSplit trueActivity(String trueActivity) {
  ...
  public boolean equals(Object o) {
    ...
    ActivityConditionalSplit activityConditionalSplit = (ActivityConditionalSplit) o;
    return Objects.equals(this.condition, activityConditionalSplit.condition) &&
        Objects.equals(this.evaluationWaitTime, activityConditionalSplit.evaluationWaitTime) &&
        Objects.equals(this.falseActivity, activityConditionalSplit.falseActivity) &&
        Objects.equals(this.trueActivity, activityConditionalSplit.trueActivity);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActivityConditionalSplit {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActivityConditionalSplit
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActivityConditionalSplit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActivityConditionalSplit is not found in the empty JSON string", ActivityConditionalSplit.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActivityConditionalSplit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActivityConditionalSplit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActivityConditionalSplit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActivityConditionalSplit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActivityConditionalSplit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActivityConditionalSplit.class));

       return (TypeAdapter<T>) new TypeAdapter<ActivityConditionalSplit>() {
           @Override
           public void write(JsonWriter out, ActivityConditionalSplit value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActivityConditionalSplit read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActivityConditionalSplit given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActivityConditionalSplit
   * @throws IOException if the JSON string is invalid with respect to ActivityConditionalSplit
   */
  public static ActivityConditionalSplit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActivityConditionalSplit.class);
  }

  /**
   * Convert an instance of ActivityConditionalSplit to an JSON string
   *
   * @return JSON string
   */
