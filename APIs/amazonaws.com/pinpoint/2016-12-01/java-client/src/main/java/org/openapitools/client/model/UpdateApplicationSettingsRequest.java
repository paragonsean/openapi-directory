...
public class UpdateApplicationSettingsRequest {
  public static final String SERIALIZED_NAME_WRITE_APPLICATION_SETTINGS_REQUEST = "WriteApplicationSettingsRequest";
  @SerializedName(SERIALIZED_NAME_WRITE_APPLICATION_SETTINGS_REQUEST)
  private UpdateApplicationSettingsRequestWriteApplicationSettingsRequest writeApplicationSettingsRequest;

  public UpdateApplicationSettingsRequest() {
  }

  public UpdateApplicationSettingsRequest writeApplicationSettingsRequest(UpdateApplicationSettingsRequestWriteApplicationSettingsRequest writeApplicationSettingsRequest) {
    this.writeApplicationSettingsRequest = writeApplicationSettingsRequest;
    return this;
  }

  /**
   * Get writeApplicationSettingsRequest
   * @return writeApplicationSettingsRequest
   */
  @javax.annotation.Nonnull
  public UpdateApplicationSettingsRequestWriteApplicationSettingsRequest getWriteApplicationSettingsRequest() {
    return writeApplicationSettingsRequest;
  }

  public void setWriteApplicationSettingsRequest(UpdateApplicationSettingsRequestWriteApplicationSettingsRequest writeApplicationSettingsRequest) {
    this.writeApplicationSettingsRequest = writeApplicationSettingsRequest;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.writeApplicationSettingsRequest, updateApplicationSettingsRequest.writeApplicationSettingsRequest);
  }

  @Override
  public int hashCode() {
    return Objects.hash(writeApplicationSettingsRequest);
  }
  ...
  public String toString() {
    ...
    sb.append("    writeApplicationSettingsRequest: ").append(toIndentedString(writeApplicationSettingsRequest)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("WriteApplicationSettingsRequest");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("WriteApplicationSettingsRequest");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `WriteApplicationSettingsRequest`
      UpdateApplicationSettingsRequestWriteApplicationSettingsRequest.validateJsonElement(jsonObj.get("WriteApplicationSettingsRequest"));
  }
