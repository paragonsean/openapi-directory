...
public class TreatmentResourceTemplateConfiguration {
  ...
  public TreatmentResourceTemplateConfiguration() {
  }

  public TreatmentResourceTemplateConfiguration emailTemplate(TemplateConfigurationEmailTemplate emailTemplate) {
  ...
  public TreatmentResourceTemplateConfiguration pushTemplate(TemplateConfigurationPushTemplate pushTemplate) {
  ...
  public TreatmentResourceTemplateConfiguration smSTemplate(TemplateConfigurationSMSTemplate smSTemplate) {
  ...
  public TreatmentResourceTemplateConfiguration voiceTemplate(TemplateConfigurationVoiceTemplate voiceTemplate) {
  ...
  public TreatmentResourceTemplateConfiguration inAppTemplate(TemplateConfigurationInAppTemplate inAppTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    TreatmentResourceTemplateConfiguration treatmentResourceTemplateConfiguration = (TreatmentResourceTemplateConfiguration) o;
    return Objects.equals(this.emailTemplate, treatmentResourceTemplateConfiguration.emailTemplate) &&
        Objects.equals(this.pushTemplate, treatmentResourceTemplateConfiguration.pushTemplate) &&
        Objects.equals(this.smSTemplate, treatmentResourceTemplateConfiguration.smSTemplate) &&
        Objects.equals(this.voiceTemplate, treatmentResourceTemplateConfiguration.voiceTemplate) &&
        Objects.equals(this.inAppTemplate, treatmentResourceTemplateConfiguration.inAppTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class TreatmentResourceTemplateConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TreatmentResourceTemplateConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TreatmentResourceTemplateConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TreatmentResourceTemplateConfiguration is not found in the empty JSON string", TreatmentResourceTemplateConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TreatmentResourceTemplateConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TreatmentResourceTemplateConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TreatmentResourceTemplateConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TreatmentResourceTemplateConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TreatmentResourceTemplateConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TreatmentResourceTemplateConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<TreatmentResourceTemplateConfiguration>() {
           @Override
           public void write(JsonWriter out, TreatmentResourceTemplateConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TreatmentResourceTemplateConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TreatmentResourceTemplateConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TreatmentResourceTemplateConfiguration
   * @throws IOException if the JSON string is invalid with respect to TreatmentResourceTemplateConfiguration
   */
  public static TreatmentResourceTemplateConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TreatmentResourceTemplateConfiguration.class);
  }

  /**
   * Convert an instance of TreatmentResourceTemplateConfiguration to an JSON string
   *
   * @return JSON string
   */
