...
public class WriteJourneyRequest {
  ...
  public WriteJourneyRequest() {
  }

  public WriteJourneyRequest activities(Map activities) {
  ...
  public WriteJourneyRequest creationDate(String creationDate) {
  ...
  public WriteJourneyRequest lastModifiedDate(String lastModifiedDate) {
  ...
  public WriteJourneyRequest limits(CreateJourneyRequestWriteJourneyRequestLimits limits) {
    this.limits = limits;
    return this;
  }
  ...
  public WriteJourneyRequest _localTime(Boolean _localTime) {
  ...
  public WriteJourneyRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public WriteJourneyRequest quietTime(CreateJourneyRequestWriteJourneyRequestQuietTime quietTime) {
  ...
  public WriteJourneyRequest refreshFrequency(String refreshFrequency) {
  ...
  public WriteJourneyRequest schedule(CreateJourneyRequestWriteJourneyRequestSchedule schedule) {
  ...
  public WriteJourneyRequest startActivity(String startActivity) {
  ...
  public WriteJourneyRequest startCondition(CreateJourneyRequestWriteJourneyRequestStartCondition startCondition) {
  ...
  public WriteJourneyRequest state(State state) {
    this.state = state;
    return this;
  }
  ...
  public WriteJourneyRequest waitForQuietTime(Boolean waitForQuietTime) {
  ...
  public WriteJourneyRequest refreshOnSegmentUpdate(Boolean refreshOnSegmentUpdate) {
  ...
  public WriteJourneyRequest journeyChannelSettings(CreateJourneyRequestWriteJourneyRequestJourneyChannelSettings journeyChannelSettings) {
  ...
  public WriteJourneyRequest sendingSchedule(Boolean sendingSchedule) {
  ...
  public WriteJourneyRequest openHours(CreateJourneyRequestWriteJourneyRequestOpenHours openHours) {
  ...
  public WriteJourneyRequest closedDays(CreateJourneyRequestWriteJourneyRequestClosedDays closedDays) {
  ...
  public WriteJourneyRequest timezoneEstimationMethods(List timezoneEstimationMethods) {
  ...
  public boolean equals(Object o) {
    ...
    WriteJourneyRequest writeJourneyRequest = (WriteJourneyRequest) o;
    return Objects.equals(this.activities, writeJourneyRequest.activities) &&
        Objects.equals(this.creationDate, writeJourneyRequest.creationDate) &&
        Objects.equals(this.lastModifiedDate, writeJourneyRequest.lastModifiedDate) &&
        Objects.equals(this.limits, writeJourneyRequest.limits) &&
        Objects.equals(this._localTime, writeJourneyRequest._localTime) &&
        Objects.equals(this.name, writeJourneyRequest.name) &&
        Objects.equals(this.quietTime, writeJourneyRequest.quietTime) &&
        Objects.equals(this.refreshFrequency, writeJourneyRequest.refreshFrequency) &&
        Objects.equals(this.schedule, writeJourneyRequest.schedule) &&
        Objects.equals(this.startActivity, writeJourneyRequest.startActivity) &&
        Objects.equals(this.startCondition, writeJourneyRequest.startCondition) &&
        Objects.equals(this.state, writeJourneyRequest.state) &&
        Objects.equals(this.waitForQuietTime, writeJourneyRequest.waitForQuietTime) &&
        Objects.equals(this.refreshOnSegmentUpdate, writeJourneyRequest.refreshOnSegmentUpdate) &&
        Objects.equals(this.journeyChannelSettings, writeJourneyRequest.journeyChannelSettings) &&
        Objects.equals(this.sendingSchedule, writeJourneyRequest.sendingSchedule) &&
        Objects.equals(this.openHours, writeJourneyRequest.openHours) &&
        Objects.equals(this.closedDays, writeJourneyRequest.closedDays) &&
        Objects.equals(this.timezoneEstimationMethods, writeJourneyRequest.timezoneEstimationMethods);
  }
  ...
  public String toString() {
    ...
    sb.append("class WriteJourneyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WriteJourneyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WriteJourneyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WriteJourneyRequest is not found in the empty JSON string", WriteJourneyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WriteJourneyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WriteJourneyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WriteJourneyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WriteJourneyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WriteJourneyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WriteJourneyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WriteJourneyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<WriteJourneyRequest>() {
           @Override
           public void write(JsonWriter out, WriteJourneyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WriteJourneyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WriteJourneyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WriteJourneyRequest
   * @throws IOException if the JSON string is invalid with respect to WriteJourneyRequest
   */
  public static WriteJourneyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WriteJourneyRequest.class);
  }

  /**
   * Convert an instance of WriteJourneyRequest to an JSON string
   *
   * @return JSON string
   */
