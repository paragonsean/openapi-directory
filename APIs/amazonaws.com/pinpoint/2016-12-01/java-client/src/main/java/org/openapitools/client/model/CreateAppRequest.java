...
public class CreateAppRequest {
  public static final String SERIALIZED_NAME_CREATE_APPLICATION_REQUEST = "CreateApplicationRequest";
  @SerializedName(SERIALIZED_NAME_CREATE_APPLICATION_REQUEST)
  private CreateAppRequestCreateApplicationRequest createApplicationRequest;

  public CreateAppRequest() {
  }

  public CreateAppRequest createApplicationRequest(CreateAppRequestCreateApplicationRequest createApplicationRequest) {
    this.createApplicationRequest = createApplicationRequest;
    return this;
  }

  /**
   * Get createApplicationRequest
   * @return createApplicationRequest
   */
  @javax.annotation.Nonnull
  public CreateAppRequestCreateApplicationRequest getCreateApplicationRequest() {
    return createApplicationRequest;
  }

  public void setCreateApplicationRequest(CreateAppRequestCreateApplicationRequest createApplicationRequest) {
    this.createApplicationRequest = createApplicationRequest;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createApplicationRequest, createAppRequest.createApplicationRequest);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createApplicationRequest);
  }
  ...
  public String toString() {
    ...
    sb.append("    createApplicationRequest: ").append(toIndentedString(createApplicationRequest)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("CreateApplicationRequest");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("CreateApplicationRequest");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `CreateApplicationRequest`
      CreateAppRequestCreateApplicationRequest.validateJsonElement(jsonObj.get("CreateApplicationRequest"));
  }
