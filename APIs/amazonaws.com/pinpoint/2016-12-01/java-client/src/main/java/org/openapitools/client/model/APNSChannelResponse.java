...
public class APNSChannelResponse {
  ...
  public APNSChannelResponse() {
  }

  public APNSChannelResponse applicationId(String applicationId) {
  ...
  public APNSChannelResponse creationDate(String creationDate) {
  ...
  public APNSChannelResponse defaultAuthenticationMethod(String defaultAuthenticationMethod) {
  ...
  public APNSChannelResponse enabled(Boolean enabled) {
  ...
  public APNSChannelResponse hasCredential(Boolean hasCredential) {
  ...
  public APNSChannelResponse hasTokenKey(Boolean hasTokenKey) {
  ...
  public APNSChannelResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public APNSChannelResponse isArchived(Boolean isArchived) {
  ...
  public APNSChannelResponse lastModifiedBy(String lastModifiedBy) {
  ...
  public APNSChannelResponse lastModifiedDate(String lastModifiedDate) {
  ...
  public APNSChannelResponse platform(String platform) {
  ...
  public APNSChannelResponse version(Integer version) {
  ...
  public boolean equals(Object o) {
    ...
    APNSChannelResponse apNSChannelResponse = (APNSChannelResponse) o;
    return Objects.equals(this.applicationId, apNSChannelResponse.applicationId) &&
        Objects.equals(this.creationDate, apNSChannelResponse.creationDate) &&
        Objects.equals(this.defaultAuthenticationMethod, apNSChannelResponse.defaultAuthenticationMethod) &&
        Objects.equals(this.enabled, apNSChannelResponse.enabled) &&
        Objects.equals(this.hasCredential, apNSChannelResponse.hasCredential) &&
        Objects.equals(this.hasTokenKey, apNSChannelResponse.hasTokenKey) &&
        Objects.equals(this.id, apNSChannelResponse.id) &&
        Objects.equals(this.isArchived, apNSChannelResponse.isArchived) &&
        Objects.equals(this.lastModifiedBy, apNSChannelResponse.lastModifiedBy) &&
        Objects.equals(this.lastModifiedDate, apNSChannelResponse.lastModifiedDate) &&
        Objects.equals(this.platform, apNSChannelResponse.platform) &&
        Objects.equals(this.version, apNSChannelResponse.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class APNSChannelResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to APNSChannelResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APNSChannelResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APNSChannelResponse is not found in the empty JSON string", APNSChannelResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!APNSChannelResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `APNSChannelResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : APNSChannelResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APNSChannelResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APNSChannelResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APNSChannelResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APNSChannelResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<APNSChannelResponse>() {
           @Override
           public void write(JsonWriter out, APNSChannelResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public APNSChannelResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of APNSChannelResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of APNSChannelResponse
   * @throws IOException if the JSON string is invalid with respect to APNSChannelResponse
   */
  public static APNSChannelResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APNSChannelResponse.class);
  }

  /**
   * Convert an instance of APNSChannelResponse to an JSON string
   *
   * @return JSON string
   */
