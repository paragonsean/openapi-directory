...
public class JourneyLimits {
  ...
  public JourneyLimits dailyCap(Integer dailyCap) {
  ...
  public JourneyLimits endpointReentryCap(Integer endpointReentryCap) {
  ...
  public JourneyLimits messagesPerSecond(Integer messagesPerSecond) {
  ...
  public JourneyLimits endpointReentryInterval(String endpointReentryInterval) {
  ...
  public JourneyLimits timeframeCap(JourneyLimitsTimeframeCap timeframeCap) {
  ...
  public JourneyLimits totalCap(Integer totalCap) {
  ...
  public boolean equals(Object o) {
    ...
    JourneyLimits journeyLimits = (JourneyLimits) o;
    return Objects.equals(this.dailyCap, journeyLimits.dailyCap) &&
        Objects.equals(this.endpointReentryCap, journeyLimits.endpointReentryCap) &&
        Objects.equals(this.messagesPerSecond, journeyLimits.messagesPerSecond) &&
        Objects.equals(this.endpointReentryInterval, journeyLimits.endpointReentryInterval) &&
        Objects.equals(this.timeframeCap, journeyLimits.timeframeCap) &&
        Objects.equals(this.totalCap, journeyLimits.totalCap);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to JourneyLimits
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JourneyLimits.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JourneyLimits is not found in the empty JSON string", JourneyLimits.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JourneyLimits.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JourneyLimits` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JourneyLimits.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JourneyLimits' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JourneyLimits> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JourneyLimits.class));

       return (TypeAdapter<T>) new TypeAdapter<JourneyLimits>() {
           @Override
           public void write(JsonWriter out, JourneyLimits value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JourneyLimits read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JourneyLimits given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JourneyLimits
   * @throws IOException if the JSON string is invalid with respect to JourneyLimits
   */
  public static JourneyLimits fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JourneyLimits.class);
  }

  /**
   * Convert an instance of JourneyLimits to an JSON string
   *
   * @return JSON string
   */
