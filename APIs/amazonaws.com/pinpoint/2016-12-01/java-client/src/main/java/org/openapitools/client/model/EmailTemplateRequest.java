...
public class EmailTemplateRequest {
  ...
  public EmailTemplateRequest defaultSubstitutions(String defaultSubstitutions) {
  ...
  public EmailTemplateRequest htmlPart(String htmlPart) {
  ...
  public EmailTemplateRequest recommenderId(String recommenderId) {
  ...
  public EmailTemplateRequest subject(String subject) {
  ...
  public EmailTemplateRequest tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public EmailTemplateRequest templateDescription(String templateDescription) {
  ...
  public EmailTemplateRequest textPart(String textPart) {
  ...
  public boolean equals(Object o) {
    ...
    EmailTemplateRequest emailTemplateRequest = (EmailTemplateRequest) o;
    return Objects.equals(this.defaultSubstitutions, emailTemplateRequest.defaultSubstitutions) &&
        Objects.equals(this.htmlPart, emailTemplateRequest.htmlPart) &&
        Objects.equals(this.recommenderId, emailTemplateRequest.recommenderId) &&
        Objects.equals(this.subject, emailTemplateRequest.subject) &&
        Objects.equals(this.tags, emailTemplateRequest.tags) &&
        Objects.equals(this.templateDescription, emailTemplateRequest.templateDescription) &&
        Objects.equals(this.textPart, emailTemplateRequest.textPart);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailTemplateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailTemplateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailTemplateRequest is not found in the empty JSON string", EmailTemplateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailTemplateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailTemplateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailTemplateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailTemplateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailTemplateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailTemplateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailTemplateRequest>() {
           @Override
           public void write(JsonWriter out, EmailTemplateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailTemplateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailTemplateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailTemplateRequest
   * @throws IOException if the JSON string is invalid with respect to EmailTemplateRequest
   */
  public static EmailTemplateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailTemplateRequest.class);
  }

  /**
   * Convert an instance of EmailTemplateRequest to an JSON string
   *
   * @return JSON string
   */
