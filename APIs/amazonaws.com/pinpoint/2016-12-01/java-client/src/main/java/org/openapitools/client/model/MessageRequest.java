...
public class MessageRequest {
  ...
  public MessageRequest addresses(Map addresses) {
  ...
  public MessageRequest context(Map context) {
  ...
  public MessageRequest endpoints(Map endpoints) {
  ...
  public MessageRequest messageConfiguration(SendMessagesRequestMessageRequestMessageConfiguration messageConfiguration) {
  ...
  public MessageRequest templateConfiguration(SendMessagesRequestMessageRequestTemplateConfiguration templateConfiguration) {
  ...
  public MessageRequest traceId(String traceId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addresses, messageRequest.addresses) &&
        Objects.equals(this.context, messageRequest.context) &&
        Objects.equals(this.endpoints, messageRequest.endpoints) &&
        Objects.equals(this.messageConfiguration, messageRequest.messageConfiguration) &&
        Objects.equals(this.templateConfiguration, messageRequest.templateConfiguration) &&
        Objects.equals(this.traceId, messageRequest.traceId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addresses, context, endpoints, messageConfiguration, templateConfiguration, traceId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Addresses") != null && !jsonObj.get("Addresses").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("Addresses"));
      }
