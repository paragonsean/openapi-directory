...
public class CampaignResponseTemplateConfiguration {
  ...
  public CampaignResponseTemplateConfiguration() {
  }

  public CampaignResponseTemplateConfiguration emailTemplate(TemplateConfigurationEmailTemplate emailTemplate) {
  ...
  public CampaignResponseTemplateConfiguration pushTemplate(TemplateConfigurationPushTemplate pushTemplate) {
  ...
  public CampaignResponseTemplateConfiguration smSTemplate(TemplateConfigurationSMSTemplate smSTemplate) {
  ...
  public CampaignResponseTemplateConfiguration voiceTemplate(TemplateConfigurationVoiceTemplate voiceTemplate) {
  ...
  public CampaignResponseTemplateConfiguration inAppTemplate(TemplateConfigurationInAppTemplate inAppTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignResponseTemplateConfiguration campaignResponseTemplateConfiguration = (CampaignResponseTemplateConfiguration) o;
    return Objects.equals(this.emailTemplate, campaignResponseTemplateConfiguration.emailTemplate) &&
        Objects.equals(this.pushTemplate, campaignResponseTemplateConfiguration.pushTemplate) &&
        Objects.equals(this.smSTemplate, campaignResponseTemplateConfiguration.smSTemplate) &&
        Objects.equals(this.voiceTemplate, campaignResponseTemplateConfiguration.voiceTemplate) &&
        Objects.equals(this.inAppTemplate, campaignResponseTemplateConfiguration.inAppTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignResponseTemplateConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CampaignResponseTemplateConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignResponseTemplateConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignResponseTemplateConfiguration is not found in the empty JSON string", CampaignResponseTemplateConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignResponseTemplateConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignResponseTemplateConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignResponseTemplateConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignResponseTemplateConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignResponseTemplateConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignResponseTemplateConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignResponseTemplateConfiguration>() {
           @Override
           public void write(JsonWriter out, CampaignResponseTemplateConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignResponseTemplateConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CampaignResponseTemplateConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CampaignResponseTemplateConfiguration
   * @throws IOException if the JSON string is invalid with respect to CampaignResponseTemplateConfiguration
   */
  public static CampaignResponseTemplateConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignResponseTemplateConfiguration.class);
  }

  /**
   * Convert an instance of CampaignResponseTemplateConfiguration to an JSON string
   *
   * @return JSON string
   */
