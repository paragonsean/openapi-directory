...
public class APNSChannelRequest {
  ...
  public APNSChannelRequest() {
  }

  public APNSChannelRequest bundleId(String bundleId) {
  ...
  public APNSChannelRequest certificate(String certificate) {
  ...
  public APNSChannelRequest defaultAuthenticationMethod(String defaultAuthenticationMethod) {
  ...
  public APNSChannelRequest enabled(Boolean enabled) {
  ...
  public APNSChannelRequest privateKey(String privateKey) {
  ...
  public APNSChannelRequest teamId(String teamId) {
    this.teamId = teamId;
    return this;
  }
  ...
  public APNSChannelRequest tokenKey(String tokenKey) {
  ...
  public APNSChannelRequest tokenKeyId(String tokenKeyId) {
  ...
  public boolean equals(Object o) {
    ...
    APNSChannelRequest apNSChannelRequest = (APNSChannelRequest) o;
    return Objects.equals(this.bundleId, apNSChannelRequest.bundleId) &&
        Objects.equals(this.certificate, apNSChannelRequest.certificate) &&
        Objects.equals(this.defaultAuthenticationMethod, apNSChannelRequest.defaultAuthenticationMethod) &&
        Objects.equals(this.enabled, apNSChannelRequest.enabled) &&
        Objects.equals(this.privateKey, apNSChannelRequest.privateKey) &&
        Objects.equals(this.teamId, apNSChannelRequest.teamId) &&
        Objects.equals(this.tokenKey, apNSChannelRequest.tokenKey) &&
        Objects.equals(this.tokenKeyId, apNSChannelRequest.tokenKeyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class APNSChannelRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to APNSChannelRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APNSChannelRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APNSChannelRequest is not found in the empty JSON string", APNSChannelRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!APNSChannelRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `APNSChannelRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APNSChannelRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APNSChannelRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APNSChannelRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APNSChannelRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<APNSChannelRequest>() {
           @Override
           public void write(JsonWriter out, APNSChannelRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public APNSChannelRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of APNSChannelRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of APNSChannelRequest
   * @throws IOException if the JSON string is invalid with respect to APNSChannelRequest
   */
  public static APNSChannelRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APNSChannelRequest.class);
  }

  /**
   * Convert an instance of APNSChannelRequest to an JSON string
   *
   * @return JSON string
   */
