...
public class ImportJobResource {
  ...
  public ImportJobResource defineSegment(Boolean defineSegment) {
  ...
  public ImportJobResource externalId(String externalId) {
  ...
  public ImportJobResource format(Format format) {
    this.format = format;
    return this;
  }
  ...
  public ImportJobResource registerEndpoints(Boolean registerEndpoints) {
  ...
  public ImportJobResource roleArn(String roleArn) {
  ...
  public ImportJobResource s3Url(String s3Url) {
    this.s3Url = s3Url;
    return this;
  }
  ...
  public ImportJobResource segmentId(String segmentId) {
  ...
  public ImportJobResource segmentName(String segmentName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defineSegment, importJobResource.defineSegment) &&
        Objects.equals(this.externalId, importJobResource.externalId) &&
        Objects.equals(this.format, importJobResource.format) &&
        Objects.equals(this.registerEndpoints, importJobResource.registerEndpoints) &&
        Objects.equals(this.roleArn, importJobResource.roleArn) &&
        Objects.equals(this.s3Url, importJobResource.s3Url) &&
        Objects.equals(this.segmentId, importJobResource.segmentId) &&
        Objects.equals(this.segmentName, importJobResource.segmentName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportJobResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportJobResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportJobResource is not found in the empty JSON string", ImportJobResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportJobResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportJobResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportJobResource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportJobResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportJobResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportJobResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportJobResource.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportJobResource>() {
           @Override
           public void write(JsonWriter out, ImportJobResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportJobResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportJobResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportJobResource
   * @throws IOException if the JSON string is invalid with respect to ImportJobResource
   */
  public static ImportJobResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportJobResource.class);
  }

  /**
   * Convert an instance of ImportJobResource to an JSON string
   *
   * @return JSON string
   */
