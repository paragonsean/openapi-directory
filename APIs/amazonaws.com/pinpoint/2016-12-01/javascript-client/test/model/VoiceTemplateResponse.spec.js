...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.VoiceTemplateResponse();
  });
  ...
  describe('VoiceTemplateResponse', function() {
    it('should create an instance of VoiceTemplateResponse', function() {
      // uncomment below and update the code to test VoiceTemplateResponse
      //var instance = new AmazonPinpoint.VoiceTemplateResponse();
      //expect(instance).to.be.a(AmazonPinpoint.VoiceTemplateResponse);
    });
