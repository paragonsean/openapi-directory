...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.MessageResponse();
  });
  ...
  describe('MessageResponse', function() {
    it('should create an instance of MessageResponse', function() {
      ...
      //var instance = new AmazonPinpoint.MessageResponse();
      //expect(instance).to.be.a(AmazonPinpoint.MessageResponse);
    });
    ...
    it('should have the property endpointResult (base name: "EndpointResult")', function() {
      // uncomment below and update the code to test the property endpointResult
      //var instance = new AmazonPinpoint.MessageResponse();
      //expect(instance).to.be();
    });
