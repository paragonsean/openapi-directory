...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.InAppTemplateResponse();
  });
  ...
  describe('InAppTemplateResponse', function() {
    it('should create an instance of InAppTemplateResponse', function() {
      // uncomment below and update the code to test InAppTemplateResponse
      //var instance = new AmazonPinpoint.InAppTemplateResponse();
      //expect(instance).to.be.a(AmazonPinpoint.InAppTemplateResponse);
    });
