...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.GCMChannelResponse();
  });
  ...
  describe('GCMChannelResponse', function() {
    it('should create an instance of GCMChannelResponse', function() {
      // uncomment below and update the code to test GCMChannelResponse
      //var instance = new AmazonPinpoint.GCMChannelResponse();
      //expect(instance).to.be.a(AmazonPinpoint.GCMChannelResponse);
    });
    ...
    it('should have the property hasFcmServiceCredentials (base name: "HasFcmServiceCredentials")', function() {
      // uncomment below and update the code to test the property hasFcmServiceCredentials
      //var instance = new AmazonPinpoint.GCMChannelResponse();
      //expect(instance).to.be();
    });
