...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.EndpointBatchItem();
  });
  ...
  describe('EndpointBatchItem', function() {
    it('should create an instance of EndpointBatchItem', function() {
      // uncomment below and update the code to test EndpointBatchItem
      //var instance = new AmazonPinpoint.EndpointBatchItem();
      //expect(instance).to.be.a(AmazonPinpoint.EndpointBatchItem);
    });
