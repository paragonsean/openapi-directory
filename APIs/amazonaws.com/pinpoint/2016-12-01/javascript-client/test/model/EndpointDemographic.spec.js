...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.EndpointDemographic();
  });
  ...
  describe('EndpointDemographic', function() {
    it('should create an instance of EndpointDemographic', function() {
      // uncomment below and update the code to test EndpointDemographic
      //var instance = new AmazonPinpoint.EndpointDemographic();
      //expect(instance).to.be.a(AmazonPinpoint.EndpointDemographic);
    });
