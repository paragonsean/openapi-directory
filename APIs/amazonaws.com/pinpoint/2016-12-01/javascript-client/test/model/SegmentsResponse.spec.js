...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.SegmentsResponse();
  });
  ...
  describe('SegmentsResponse', function() {
    it('should create an instance of SegmentsResponse', function() {
      // uncomment below and update the code to test SegmentsResponse
      //var instance = new AmazonPinpoint.SegmentsResponse();
      //expect(instance).to.be.a(AmazonPinpoint.SegmentsResponse);
    });
