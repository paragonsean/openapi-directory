...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.EndpointResponse();
  });
  ...
  describe('EndpointResponse', function() {
    it('should create an instance of EndpointResponse', function() {
      // uncomment below and update the code to test EndpointResponse
      //var instance = new AmazonPinpoint.EndpointResponse();
      //expect(instance).to.be.a(AmazonPinpoint.EndpointResponse);
    });
    ...
    it('should have the property cohortId (base name: "CohortId")', function() {
      // uncomment below and update the code to test the property cohortId
      //var instance = new AmazonPinpoint.EndpointResponse();
      //expect(instance).to.be();
    });
