...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.EventsBatchEndpoint();
  });
  ...
  describe('EventsBatchEndpoint', function() {
    it('should create an instance of EventsBatchEndpoint', function() {
      // uncomment below and update the code to test EventsBatchEndpoint
      //var instance = new AmazonPinpoint.EventsBatchEndpoint();
      //expect(instance).to.be.a(AmazonPinpoint.EventsBatchEndpoint);
    });
