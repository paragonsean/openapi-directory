...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.WaitActivityWaitTime();
  });
  ...
  describe('WaitActivityWaitTime', function() {
    it('should create an instance of WaitActivityWaitTime', function() {
      // uncomment below and update the code to test WaitActivityWaitTime
      //var instance = new AmazonPinpoint.WaitActivityWaitTime();
      //expect(instance).to.be.a(AmazonPinpoint.WaitActivityWaitTime);
    });
