...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.InAppMessageContentHeaderConfig();
  });
  ...
  describe('InAppMessageContentHeaderConfig', function() {
    it('should create an instance of InAppMessageContentHeaderConfig', function() {
      // uncomment below and update the code to test InAppMessageContentHeaderConfig
      //var instance = new AmazonPinpoint.InAppMessageContentHeaderConfig();
      //expect(instance).to.be.a(AmazonPinpoint.InAppMessageContentHeaderConfig);
    });
