...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.WaitTime();
  });
  ...
  describe('WaitTime', function() {
    it('should create an instance of WaitTime', function() {
      // uncomment below and update the code to test WaitTime
      //var instance = new AmazonPinpoint.WaitTime();
      //expect(instance).to.be.a(AmazonPinpoint.WaitTime);
    });
