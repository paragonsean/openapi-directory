...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.ImportJobsResponse();
  });
  ...
  describe('ImportJobsResponse', function() {
    it('should create an instance of ImportJobsResponse', function() {
      // uncomment below and update the code to test ImportJobsResponse
      //var instance = new AmazonPinpoint.ImportJobsResponse();
      //expect(instance).to.be.a(AmazonPinpoint.ImportJobsResponse);
    });
