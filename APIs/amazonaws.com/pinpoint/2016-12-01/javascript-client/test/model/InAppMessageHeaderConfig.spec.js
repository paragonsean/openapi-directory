...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.InAppMessageHeaderConfig();
  });
  ...
  describe('InAppMessageHeaderConfig', function() {
    it('should create an instance of InAppMessageHeaderConfig', function() {
      // uncomment below and update the code to test InAppMessageHeaderConfig
      //var instance = new AmazonPinpoint.InAppMessageHeaderConfig();
      //expect(instance).to.be.a(AmazonPinpoint.InAppMessageHeaderConfig);
    });
