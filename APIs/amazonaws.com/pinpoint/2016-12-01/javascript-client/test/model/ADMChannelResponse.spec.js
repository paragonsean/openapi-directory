...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.ADMChannelResponse();
  });
  ...
  describe('ADMChannelResponse', function() {
    it('should create an instance of ADMChannelResponse', function() {
      // uncomment below and update the code to test ADMChannelResponse
      //var instance = new AmazonPinpoint.ADMChannelResponse();
      //expect(instance).to.be.a(AmazonPinpoint.ADMChannelResponse);
    });
