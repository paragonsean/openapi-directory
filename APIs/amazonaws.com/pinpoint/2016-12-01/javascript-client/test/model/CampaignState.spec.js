...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.CampaignState();
  });
  ...
  describe('CampaignState', function() {
    it('should create an instance of CampaignState', function() {
      // uncomment below and update the code to test CampaignState
      //var instance = new AmazonPinpoint.CampaignState();
      //expect(instance).to.be.a(AmazonPinpoint.CampaignState);
    });
