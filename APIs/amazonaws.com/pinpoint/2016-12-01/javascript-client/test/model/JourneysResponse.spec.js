...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.JourneysResponse();
  });
  ...
  describe('JourneysResponse', function() {
    it('should create an instance of JourneysResponse', function() {
      // uncomment below and update the code to test JourneysResponse
      //var instance = new AmazonPinpoint.JourneysResponse();
      //expect(instance).to.be.a(AmazonPinpoint.JourneysResponse);
    });
