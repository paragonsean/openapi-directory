...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.PublicEndpoint();
  });
  ...
  describe('PublicEndpoint', function() {
    it('should create an instance of PublicEndpoint', function() {
      // uncomment below and update the code to test PublicEndpoint
      //var instance = new AmazonPinpoint.PublicEndpoint();
      //expect(instance).to.be.a(AmazonPinpoint.PublicEndpoint);
    });
