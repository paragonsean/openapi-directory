...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.JourneyRunExecutionMetricsResponse();
  });
  ...
  describe('JourneyRunExecutionMetricsResponse', function() {
    it('should create an instance of JourneyRunExecutionMetricsResponse', function() {
      // uncomment below and update the code to test JourneyRunExecutionMetricsResponse
      //var instance = new AmazonPinpoint.JourneyRunExecutionMetricsResponse();
      //expect(instance).to.be.a(AmazonPinpoint.JourneyRunExecutionMetricsResponse);
    });
