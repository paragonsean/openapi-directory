...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.WriteJourneyRequest();
  });
  ...
  describe('WriteJourneyRequest', function() {
    it('should create an instance of WriteJourneyRequest', function() {
      // uncomment below and update the code to test WriteJourneyRequest
      //var instance = new AmazonPinpoint.WriteJourneyRequest();
      //expect(instance).to.be.a(AmazonPinpoint.WriteJourneyRequest);
    });
