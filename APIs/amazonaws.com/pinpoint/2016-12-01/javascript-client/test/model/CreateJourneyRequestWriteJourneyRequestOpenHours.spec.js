...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.CreateJourneyRequestWriteJourneyRequestOpenHours();
  });
  ...
  describe('CreateJourneyRequestWriteJourneyRequestOpenHours', function() {
    it('should create an instance of CreateJourneyRequestWriteJourneyRequestOpenHours', function() {
      // uncomment below and update the code to test CreateJourneyRequestWriteJourneyRequestOpenHours
      //var instance = new AmazonPinpoint.CreateJourneyRequestWriteJourneyRequestOpenHours();
      //expect(instance).to.be.a(AmazonPinpoint.CreateJourneyRequestWriteJourneyRequestOpenHours);
    });
