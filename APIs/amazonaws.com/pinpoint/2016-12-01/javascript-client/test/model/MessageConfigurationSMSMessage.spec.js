...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.MessageConfigurationSMSMessage();
  });
  ...
  describe('MessageConfigurationSMSMessage', function() {
    it('should create an instance of MessageConfigurationSMSMessage', function() {
      // uncomment below and update the code to test MessageConfigurationSMSMessage
      //var instance = new AmazonPinpoint.MessageConfigurationSMSMessage();
      //expect(instance).to.be.a(AmazonPinpoint.MessageConfigurationSMSMessage);
    });
