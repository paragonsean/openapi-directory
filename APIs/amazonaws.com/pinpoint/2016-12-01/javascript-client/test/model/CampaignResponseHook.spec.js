...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.CampaignResponseHook();
  });
  ...
  describe('CampaignResponseHook', function() {
    it('should create an instance of CampaignResponseHook', function() {
      // uncomment below and update the code to test CampaignResponseHook
      //var instance = new AmazonPinpoint.CampaignResponseHook();
      //expect(instance).to.be.a(AmazonPinpoint.CampaignResponseHook);
    });
