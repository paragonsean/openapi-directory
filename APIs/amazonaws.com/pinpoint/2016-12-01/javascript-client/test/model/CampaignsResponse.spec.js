...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.CampaignsResponse();
  });
  ...
  describe('CampaignsResponse', function() {
    it('should create an instance of CampaignsResponse', function() {
      // uncomment below and update the code to test CampaignsResponse
      //var instance = new AmazonPinpoint.CampaignsResponse();
      //expect(instance).to.be.a(AmazonPinpoint.CampaignsResponse);
    });
