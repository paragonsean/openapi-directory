...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.TemplatesResponse();
  });
  ...
  describe('TemplatesResponse', function() {
    it('should create an instance of TemplatesResponse', function() {
      ...
      //var instance = new AmazonPinpoint.TemplatesResponse();
      //expect(instance).to.be.a(AmazonPinpoint.TemplatesResponse);
    });
