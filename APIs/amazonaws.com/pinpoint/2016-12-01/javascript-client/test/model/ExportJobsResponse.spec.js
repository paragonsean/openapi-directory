...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.ExportJobsResponse();
  });
  ...
  describe('ExportJobsResponse', function() {
    it('should create an instance of ExportJobsResponse', function() {
      // uncomment below and update the code to test ExportJobsResponse
      //var instance = new AmazonPinpoint.ExportJobsResponse();
      //expect(instance).to.be.a(AmazonPinpoint.ExportJobsResponse);
    });
