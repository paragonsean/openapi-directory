...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.CreateJourneyRequestWriteJourneyRequestClosedDays();
  });
  ...
  describe('CreateJourneyRequestWriteJourneyRequestClosedDays', function() {
    it('should create an instance of CreateJourneyRequestWriteJourneyRequestClosedDays', function() {
      // uncomment below and update the code to test CreateJourneyRequestWriteJourneyRequestClosedDays
      //var instance = new AmazonPinpoint.CreateJourneyRequestWriteJourneyRequestClosedDays();
      //expect(instance).to.be.a(AmazonPinpoint.CreateJourneyRequestWriteJourneyRequestClosedDays);
    });
