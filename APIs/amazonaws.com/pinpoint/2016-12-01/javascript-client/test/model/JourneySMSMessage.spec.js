...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.JourneySMSMessage();
  });
  ...
  describe('JourneySMSMessage', function() {
    it('should create an instance of JourneySMSMessage', function() {
      // uncomment below and update the code to test JourneySMSMessage
      //var instance = new AmazonPinpoint.JourneySMSMessage();
      //expect(instance).to.be.a(AmazonPinpoint.JourneySMSMessage);
    });
