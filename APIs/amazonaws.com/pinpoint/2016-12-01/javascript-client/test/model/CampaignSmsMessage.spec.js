...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.CampaignSmsMessage();
  });
  ...
  describe('CampaignSmsMessage', function() {
    it('should create an instance of CampaignSmsMessage', function() {
      // uncomment below and update the code to test CampaignSmsMessage
      //var instance = new AmazonPinpoint.CampaignSmsMessage();
      //expect(instance).to.be.a(AmazonPinpoint.CampaignSmsMessage);
    });
