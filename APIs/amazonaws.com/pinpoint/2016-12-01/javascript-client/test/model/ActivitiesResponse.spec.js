...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.ActivitiesResponse();
  });
  ...
  describe('ActivitiesResponse', function() {
    it('should create an instance of ActivitiesResponse', function() {
      ...
      //var instance = new AmazonPinpoint.ActivitiesResponse();
      //expect(instance).to.be.a(AmazonPinpoint.ActivitiesResponse);
    });
