...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.SimpleConditionSegmentDimensions();
  });
  ...
  describe('SimpleConditionSegmentDimensions', function() {
    it('should create an instance of SimpleConditionSegmentDimensions', function() {
      // uncomment below and update the code to test SimpleConditionSegmentDimensions
      //var instance = new AmazonPinpoint.SimpleConditionSegmentDimensions();
      //expect(instance).to.be.a(AmazonPinpoint.SimpleConditionSegmentDimensions);
    });
