...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.InAppMessageBodyConfig();
  });
  ...
  describe('InAppMessageBodyConfig', function() {
    it('should create an instance of InAppMessageBodyConfig', function() {
      // uncomment below and update the code to test InAppMessageBodyConfig
      //var instance = new AmazonPinpoint.InAppMessageBodyConfig();
      //expect(instance).to.be.a(AmazonPinpoint.InAppMessageBodyConfig);
    });
