...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.OpenHours();
  });
  ...
  describe('OpenHours', function() {
    it('should create an instance of OpenHours', function() {
      // uncomment below and update the code to test OpenHours
      //var instance = new AmazonPinpoint.OpenHours();
      //expect(instance).to.be.a(AmazonPinpoint.OpenHours);
    });
