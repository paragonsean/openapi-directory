...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.EventDimensions();
  });
  ...
  describe('EventDimensions', function() {
    it('should create an instance of EventDimensions', function() {
      // uncomment below and update the code to test EventDimensions
      //var instance = new AmazonPinpoint.EventDimensions();
      //expect(instance).to.be.a(AmazonPinpoint.EventDimensions);
    });
