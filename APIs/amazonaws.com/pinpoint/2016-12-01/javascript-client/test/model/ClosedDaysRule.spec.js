...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.ClosedDaysRule();
  });
  ...
  describe('ClosedDaysRule', function() {
    it('should create an instance of ClosedDaysRule', function() {
      // uncomment below and update the code to test ClosedDaysRule
      //var instance = new AmazonPinpoint.ClosedDaysRule();
      //expect(instance).to.be.a(AmazonPinpoint.ClosedDaysRule);
    });
