...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.VoiceChannelResponse();
  });
  ...
  describe('VoiceChannelResponse', function() {
    it('should create an instance of VoiceChannelResponse', function() {
      // uncomment below and update the code to test VoiceChannelResponse
      //var instance = new AmazonPinpoint.VoiceChannelResponse();
      //expect(instance).to.be.a(AmazonPinpoint.VoiceChannelResponse);
    });
