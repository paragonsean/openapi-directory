...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.SegmentResponseDimensions();
  });
  ...
  describe('SegmentResponseDimensions', function() {
    it('should create an instance of SegmentResponseDimensions', function() {
      // uncomment below and update the code to test SegmentResponseDimensions
      //var instance = new AmazonPinpoint.SegmentResponseDimensions();
      //expect(instance).to.be.a(AmazonPinpoint.SegmentResponseDimensions);
    });
