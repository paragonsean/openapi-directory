...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.EventFilterDimensions();
  });
  ...
  describe('EventFilterDimensions', function() {
    it('should create an instance of EventFilterDimensions', function() {
      // uncomment below and update the code to test EventFilterDimensions
      //var instance = new AmazonPinpoint.EventFilterDimensions();
      //expect(instance).to.be.a(AmazonPinpoint.EventFilterDimensions);
    });
