...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.SegmentDemographics();
  });
  ...
  describe('SegmentDemographics', function() {
    it('should create an instance of SegmentDemographics', function() {
      // uncomment below and update the code to test SegmentDemographics
      //var instance = new AmazonPinpoint.SegmentDemographics();
      //expect(instance).to.be.a(AmazonPinpoint.SegmentDemographics);
    });
