...
(function(root, factory) {
  ...
  describe('DimensionType', function() {
    it('should create an instance of DimensionType', function() {
      // uncomment below and update the code to test DimensionType
      //var instance = new AmazonPinpoint.DimensionType();
      //expect(instance).to.be.a(AmazonPinpoint.DimensionType);
    });
