...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.UpdateInAppTemplateRequestInAppTemplateRequest();
  });
  ...
  describe('UpdateInAppTemplateRequestInAppTemplateRequest', function() {
    it('should create an instance of UpdateInAppTemplateRequestInAppTemplateRequest', function() {
      // uncomment below and update the code to test UpdateInAppTemplateRequestInAppTemplateRequest
      //var instance = new AmazonPinpoint.UpdateInAppTemplateRequestInAppTemplateRequest();
      //expect(instance).to.be.a(AmazonPinpoint.UpdateInAppTemplateRequestInAppTemplateRequest);
    });
