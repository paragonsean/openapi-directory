...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.ApplicationsResponse();
  });
  ...
  describe('ApplicationsResponse', function() {
    it('should create an instance of ApplicationsResponse', function() {
      // uncomment below and update the code to test ApplicationsResponse
      //var instance = new AmazonPinpoint.ApplicationsResponse();
      //expect(instance).to.be.a(AmazonPinpoint.ApplicationsResponse);
    });
