...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.UpdateEndpointRequestEndpointRequest();
  });
  ...
  describe('UpdateEndpointRequestEndpointRequest', function() {
    it('should create an instance of UpdateEndpointRequestEndpointRequest', function() {
      // uncomment below and update the code to test UpdateEndpointRequestEndpointRequest
      //var instance = new AmazonPinpoint.UpdateEndpointRequestEndpointRequest();
      //expect(instance).to.be.a(AmazonPinpoint.UpdateEndpointRequestEndpointRequest);
    });
