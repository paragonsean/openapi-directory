...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.InAppMessage();
  });
  ...
  describe('InAppMessage', function() {
    it('should create an instance of InAppMessage', function() {
      // uncomment below and update the code to test InAppMessage
      //var instance = new AmazonPinpoint.InAppMessage();
      //expect(instance).to.be.a(AmazonPinpoint.InAppMessage);
    });
