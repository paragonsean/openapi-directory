...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.SegmentDimensions();
  });
  ...
  describe('SegmentDimensions', function() {
    it('should create an instance of SegmentDimensions', function() {
      // uncomment below and update the code to test SegmentDimensions
      //var instance = new AmazonPinpoint.SegmentDimensions();
      //expect(instance).to.be.a(AmazonPinpoint.SegmentDimensions);
    });
