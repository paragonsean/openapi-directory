...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.TemplateVersionResponse();
  });
  ...
  describe('TemplateVersionResponse', function() {
    it('should create an instance of TemplateVersionResponse', function() {
      // uncomment below and update the code to test TemplateVersionResponse
      //var instance = new AmazonPinpoint.TemplateVersionResponse();
      //expect(instance).to.be.a(AmazonPinpoint.TemplateVersionResponse);
    });
