...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.CreateJourneyRequestWriteJourneyRequest();
  });
  ...
  describe('CreateJourneyRequestWriteJourneyRequest', function() {
    it('should create an instance of CreateJourneyRequestWriteJourneyRequest', function() {
      // uncomment below and update the code to test CreateJourneyRequestWriteJourneyRequest
      //var instance = new AmazonPinpoint.CreateJourneyRequestWriteJourneyRequest();
      //expect(instance).to.be.a(AmazonPinpoint.CreateJourneyRequestWriteJourneyRequest);
    });
