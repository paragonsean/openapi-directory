...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.CampaignInAppMessage();
  });
  ...
  describe('CampaignInAppMessage', function() {
    it('should create an instance of CampaignInAppMessage', function() {
      // uncomment below and update the code to test CampaignInAppMessage
      //var instance = new AmazonPinpoint.CampaignInAppMessage();
      //expect(instance).to.be.a(AmazonPinpoint.CampaignInAppMessage);
    });
