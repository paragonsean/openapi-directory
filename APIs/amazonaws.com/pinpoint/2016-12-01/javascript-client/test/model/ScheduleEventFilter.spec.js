...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.ScheduleEventFilter();
  });
  ...
  describe('ScheduleEventFilter', function() {
    it('should create an instance of ScheduleEventFilter', function() {
      // uncomment below and update the code to test ScheduleEventFilter
      //var instance = new AmazonPinpoint.ScheduleEventFilter();
      //expect(instance).to.be.a(AmazonPinpoint.ScheduleEventFilter);
    });
