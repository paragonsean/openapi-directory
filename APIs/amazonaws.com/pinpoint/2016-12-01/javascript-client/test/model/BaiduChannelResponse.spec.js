...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.BaiduChannelResponse();
  });
  ...
  describe('BaiduChannelResponse', function() {
    it('should create an instance of BaiduChannelResponse', function() {
      // uncomment below and update the code to test BaiduChannelResponse
      //var instance = new AmazonPinpoint.BaiduChannelResponse();
      //expect(instance).to.be.a(AmazonPinpoint.BaiduChannelResponse);
    });
