...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.CreateApplicationRequest();
  });
  ...
  describe('CreateApplicationRequest', function() {
    it('should create an instance of CreateApplicationRequest', function() {
      ...
      //var instance = new AmazonPinpoint.CreateApplicationRequest();
      //expect(instance).to.be.a(AmazonPinpoint.CreateApplicationRequest);
    });
