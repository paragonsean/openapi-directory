...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.CampaignEventFilter();
  });
  ...
  describe('CampaignEventFilter', function() {
    it('should create an instance of CampaignEventFilter', function() {
      // uncomment below and update the code to test CampaignEventFilter
      //var instance = new AmazonPinpoint.CampaignEventFilter();
      //expect(instance).to.be.a(AmazonPinpoint.CampaignEventFilter);
    });
