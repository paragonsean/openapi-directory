...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.SendOTPMessageRequestSendOTPMessageRequestParameters();
  });
  ...
  describe('SendOTPMessageRequestSendOTPMessageRequestParameters', function() {
    it('should create an instance of SendOTPMessageRequestSendOTPMessageRequestParameters', function() {
      // uncomment below and update the code to test SendOTPMessageRequestSendOTPMessageRequestParameters
      //var instance = new AmazonPinpoint.SendOTPMessageRequestSendOTPMessageRequestParameters();
      //expect(instance).to.be.a(AmazonPinpoint.SendOTPMessageRequestSendOTPMessageRequestParameters);
    });
