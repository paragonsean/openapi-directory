...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.ClosedDays();
  });
  ...
  describe('ClosedDays', function() {
    it('should create an instance of ClosedDays', function() {
      // uncomment below and update the code to test ClosedDays
      //var instance = new AmazonPinpoint.ClosedDays();
      //expect(instance).to.be.a(AmazonPinpoint.ClosedDays);
    });
