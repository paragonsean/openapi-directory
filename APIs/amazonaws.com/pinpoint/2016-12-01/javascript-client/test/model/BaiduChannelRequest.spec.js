...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.BaiduChannelRequest();
  });
  ...
  describe('BaiduChannelRequest', function() {
    it('should create an instance of BaiduChannelRequest', function() {
      // uncomment below and update the code to test BaiduChannelRequest
      //var instance = new AmazonPinpoint.BaiduChannelRequest();
      //expect(instance).to.be.a(AmazonPinpoint.BaiduChannelRequest);
    });
