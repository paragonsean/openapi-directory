...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.JourneyRunResponse();
  });
  ...
  describe('JourneyRunResponse', function() {
    it('should create an instance of JourneyRunResponse', function() {
      // uncomment below and update the code to test JourneyRunResponse
      //var instance = new AmazonPinpoint.JourneyRunResponse();
      //expect(instance).to.be.a(AmazonPinpoint.JourneyRunResponse);
    });
