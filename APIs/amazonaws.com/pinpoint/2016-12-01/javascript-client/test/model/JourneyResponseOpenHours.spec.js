...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.JourneyResponseOpenHours();
  });
  ...
  describe('JourneyResponseOpenHours', function() {
    it('should create an instance of JourneyResponseOpenHours', function() {
      // uncomment below and update the code to test JourneyResponseOpenHours
      //var instance = new AmazonPinpoint.JourneyResponseOpenHours();
      //expect(instance).to.be.a(AmazonPinpoint.JourneyResponseOpenHours);
    });
