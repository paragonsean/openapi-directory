...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpoint.CampaignEmailMessage();
  });
  ...
  describe('CampaignEmailMessage', function() {
    it('should create an instance of CampaignEmailMessage', function() {
      // uncomment below and update the code to test CampaignEmailMessage
      //var instance = new AmazonPinpoint.CampaignEmailMessage();
      //expect(instance).to.be.a(AmazonPinpoint.CampaignEmailMessage);
    });
