...
import TagResourceRequestTagsModel from './TagResourceRequestTagsModel';
...
class TagResourceRequest {
     ...
     * @param tagsModel {module:model/TagResourceRequestTagsModel} 
     */
    constructor(tagsModel) { 
        
        TagResourceRequest.initialize(this, tagsModel);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('TagsModel')) {
                obj['TagsModel'] = TagResourceRequestTagsModel.constructFromObject(data['TagsModel']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['TagsModel']) { // data not null
          TagResourceRequestTagsModel.validateJSON(data['TagsModel']);
        }
...
TagResourceRequest.RequiredProperties = ["TagsModel"];

/**
 * @member {module:model/TagResourceRequestTagsModel} TagsModel
 */
TagResourceRequest.prototype['TagsModel'] = undefined;
