...
/**
 * The MessageConfigurationBaiduMessage model module.
 * @module model/MessageConfigurationBaiduMessage
 * @version 2016-12-01
 */
class MessageConfigurationBaiduMessage {
    /**
     * Constructs a new <code>MessageConfigurationBaiduMessage</code>.
     * @alias module:model/MessageConfigurationBaiduMessage
     * @implements module:model/Message
     */
    constructor() { 
        Message.initialize(this);
        MessageConfigurationBaiduMessage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MessageConfigurationBaiduMessage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageConfigurationBaiduMessage} obj Optional instance to populate.
     * @return {module:model/MessageConfigurationBaiduMessage} The populated <code>MessageConfigurationBaiduMessage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageConfigurationBaiduMessage();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageConfigurationBaiduMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageConfigurationBaiduMessage</code>.
     */
 ...
 */
MessageConfigurationBaiduMessage.prototype['Action'] = undefined;

/**
 * @member {String} Body
 */
MessageConfigurationBaiduMessage.prototype['Body'] = undefined;

/**
 * @member {String} ImageIconUrl
 */
MessageConfigurationBaiduMessage.prototype['ImageIconUrl'] = undefined;

/**
 * @member {String} ImageSmallIconUrl
 */
MessageConfigurationBaiduMessage.prototype['ImageSmallIconUrl'] = undefined;

/**
 * @member {String} ImageUrl
 */
MessageConfigurationBaiduMessage.prototype['ImageUrl'] = undefined;

/**
 * @member {String} JsonBody
 */
MessageConfigurationBaiduMessage.prototype['JsonBody'] = undefined;

/**
 * @member {String} MediaUrl
 */
MessageConfigurationBaiduMessage.prototype['MediaUrl'] = undefined;

/**
 * @member {String} RawContent
 */
MessageConfigurationBaiduMessage.prototype['RawContent'] = undefined;

/**
 * @member {Boolean} SilentPush
 */
MessageConfigurationBaiduMessage.prototype['SilentPush'] = undefined;

/**
 * @member {Number} TimeToLive
 */
MessageConfigurationBaiduMessage.prototype['TimeToLive'] = undefined;

/**
 * @member {String} Title
 */
MessageConfigurationBaiduMessage.prototype['Title'] = undefined;

/**
 * @member {String} Url
 */
MessageConfigurationBaiduMessage.prototype['Url'] = undefined;
...
export default MessageConfigurationBaiduMessage;
