...
/**
 * The MessageConfigurationGCMMessage model module.
 * @module model/MessageConfigurationGCMMessage
 * @version 2016-12-01
 */
class MessageConfigurationGCMMessage {
    /**
     * Constructs a new <code>MessageConfigurationGCMMessage</code>.
     * @alias module:model/MessageConfigurationGCMMessage
     * @implements module:model/Message
     */
    constructor() { 
        Message.initialize(this);
        MessageConfigurationGCMMessage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MessageConfigurationGCMMessage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageConfigurationGCMMessage} obj Optional instance to populate.
     * @return {module:model/MessageConfigurationGCMMessage} The populated <code>MessageConfigurationGCMMessage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageConfigurationGCMMessage();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageConfigurationGCMMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageConfigurationGCMMessage</code>.
     */
 ...
 */
MessageConfigurationGCMMessage.prototype['Action'] = undefined;

/**
 * @member {String} Body
 */
MessageConfigurationGCMMessage.prototype['Body'] = undefined;

/**
 * @member {String} ImageIconUrl
 */
MessageConfigurationGCMMessage.prototype['ImageIconUrl'] = undefined;

/**
 * @member {String} ImageSmallIconUrl
 */
MessageConfigurationGCMMessage.prototype['ImageSmallIconUrl'] = undefined;

/**
 * @member {String} ImageUrl
 */
MessageConfigurationGCMMessage.prototype['ImageUrl'] = undefined;

/**
 * @member {String} JsonBody
 */
MessageConfigurationGCMMessage.prototype['JsonBody'] = undefined;

/**
 * @member {String} MediaUrl
 */
MessageConfigurationGCMMessage.prototype['MediaUrl'] = undefined;

/**
 * @member {String} RawContent
 */
MessageConfigurationGCMMessage.prototype['RawContent'] = undefined;

/**
 * @member {Boolean} SilentPush
 */
MessageConfigurationGCMMessage.prototype['SilentPush'] = undefined;

/**
 * @member {Number} TimeToLive
 */
MessageConfigurationGCMMessage.prototype['TimeToLive'] = undefined;

/**
 * @member {String} Title
 */
MessageConfigurationGCMMessage.prototype['Title'] = undefined;

/**
 * @member {String} Url
 */
MessageConfigurationGCMMessage.prototype['Url'] = undefined;
...
export default MessageConfigurationGCMMessage;
