...
/**
 * The MessageConfigurationADMMessage model module.
 * @module model/MessageConfigurationADMMessage
 * @version 2016-12-01
 */
class MessageConfigurationADMMessage {
    /**
     * Constructs a new <code>MessageConfigurationADMMessage</code>.
     * @alias module:model/MessageConfigurationADMMessage
     * @implements module:model/Message
     */
    constructor() { 
        Message.initialize(this);
        MessageConfigurationADMMessage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MessageConfigurationADMMessage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageConfigurationADMMessage} obj Optional instance to populate.
     * @return {module:model/MessageConfigurationADMMessage} The populated <code>MessageConfigurationADMMessage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageConfigurationADMMessage();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageConfigurationADMMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageConfigurationADMMessage</code>.
     */
 ...
 */
MessageConfigurationADMMessage.prototype['Action'] = undefined;

/**
 * @member {String} Body
 */
MessageConfigurationADMMessage.prototype['Body'] = undefined;

/**
 * @member {String} ImageIconUrl
 */
MessageConfigurationADMMessage.prototype['ImageIconUrl'] = undefined;

/**
 * @member {String} ImageSmallIconUrl
 */
MessageConfigurationADMMessage.prototype['ImageSmallIconUrl'] = undefined;

/**
 * @member {String} ImageUrl
 */
MessageConfigurationADMMessage.prototype['ImageUrl'] = undefined;

/**
 * @member {String} JsonBody
 */
MessageConfigurationADMMessage.prototype['JsonBody'] = undefined;

/**
 * @member {String} MediaUrl
 */
MessageConfigurationADMMessage.prototype['MediaUrl'] = undefined;

/**
 * @member {String} RawContent
 */
MessageConfigurationADMMessage.prototype['RawContent'] = undefined;

/**
 * @member {Boolean} SilentPush
 */
MessageConfigurationADMMessage.prototype['SilentPush'] = undefined;

/**
 * @member {Number} TimeToLive
 */
MessageConfigurationADMMessage.prototype['TimeToLive'] = undefined;

/**
 * @member {String} Title
 */
MessageConfigurationADMMessage.prototype['Title'] = undefined;

/**
 * @member {String} Url
 */
MessageConfigurationADMMessage.prototype['Url'] = undefined;
...
export default MessageConfigurationADMMessage;
