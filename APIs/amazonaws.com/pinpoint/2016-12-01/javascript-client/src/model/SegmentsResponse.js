...
class SegmentsResponse {
    ...
    constructor(item) { 
        ...
        SegmentsResponse.initialize(this, item);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SegmentsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SegmentsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SegmentsResponse.RequiredProperties) {
...
SegmentsResponse.RequiredProperties = ["Item"];

/**
 * @member {Array} Item
 */
SegmentsResponse.prototype['Item'] = undefined;

/**
 * @member {String} NextToken
 */
SegmentsResponse.prototype['NextToken'] = undefined;
