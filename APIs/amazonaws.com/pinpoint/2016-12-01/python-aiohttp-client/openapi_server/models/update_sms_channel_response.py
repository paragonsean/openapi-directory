...
class UpdateSmsChannelResponse(Model):
    ...
    def __init__(self, sms_channel_response: SMSChannelResponse=None):
        """UpdateSmsChannelResponse - a model defined in OpenAPI

        :param sms_channel_response: The sms_channel_response of this UpdateSmsChannelResponse.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateSmsChannelResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateSmsChannelResponse of this UpdateSmsChannelResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def sms_channel_response(self):
        """Gets the sms_channel_response of this UpdateSmsChannelResponse.


        :return: The sms_channel_response of this UpdateSmsChannelResponse.
    ...
    def sms_channel_response(self, sms_channel_response):
        """Sets the sms_channel_response of this UpdateSmsChannelResponse.
