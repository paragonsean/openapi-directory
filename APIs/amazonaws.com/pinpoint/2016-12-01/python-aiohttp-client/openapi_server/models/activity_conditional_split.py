...
class ActivityConditionalSplit(Model):
    ...
    def __init__(self, condition: ConditionalSplitActivityCondition=None, evaluation_wait_time: ConditionalSplitActivityEvaluationWaitTime=None, false_activity: str=None, true_activity: str=None):
        """ActivityConditionalSplit - a model defined in OpenAPI

        :param condition: The condition of this ActivityConditionalSplit.
        :param evaluation_wait_time: The evaluation_wait_time of this ActivityConditionalSplit.
        :param false_activity: The false_activity of this ActivityConditionalSplit.
        :param true_activity: The true_activity of this ActivityConditionalSplit.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ActivityConditionalSplit':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Activity_ConditionalSplit of this ActivityConditionalSplit.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def condition(self):
        """Gets the condition of this ActivityConditionalSplit.


        :return: The condition of this ActivityConditionalSplit.
    ...
    def condition(self, condition):
        """Sets the condition of this ActivityConditionalSplit.
    ...
    def evaluation_wait_time(self):
        """Gets the evaluation_wait_time of this ActivityConditionalSplit.


        :return: The evaluation_wait_time of this ActivityConditionalSplit.
    ...
    def evaluation_wait_time(self, evaluation_wait_time):
        """Sets the evaluation_wait_time of this ActivityConditionalSplit.
    ...
    def false_activity(self):
        """Gets the false_activity of this ActivityConditionalSplit.


        :return: The false_activity of this ActivityConditionalSplit.
        :rtype: str
        """
    ...
    def false_activity(self, false_activity):
        """Sets the false_activity of this ActivityConditionalSplit.
    ...
    def true_activity(self):
        """Gets the true_activity of this ActivityConditionalSplit.


        :return: The true_activity of this ActivityConditionalSplit.
        :rtype: str
        """
    ...
    def true_activity(self, true_activity):
        """Sets the true_activity of this ActivityConditionalSplit.
