...
class GetAdmChannelResponse(Model):
    ...
    def __init__(self, adm_channel_response: ADMChannelResponse=None):
        """GetAdmChannelResponse - a model defined in OpenAPI

        :param adm_channel_response: The adm_channel_response of this GetAdmChannelResponse.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetAdmChannelResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetAdmChannelResponse of this GetAdmChannelResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def adm_channel_response(self):
        """Gets the adm_channel_response of this GetAdmChannelResponse.


        :return: The adm_channel_response of this GetAdmChannelResponse.
    ...
    def adm_channel_response(self, adm_channel_response):
        """Sets the adm_channel_response of this GetAdmChannelResponse.
