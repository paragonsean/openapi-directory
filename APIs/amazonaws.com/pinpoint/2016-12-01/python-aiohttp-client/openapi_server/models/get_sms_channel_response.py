...
class GetSmsChannelResponse(Model):
    ...
    def __init__(self, sms_channel_response: SMSChannelResponse=None):
        """GetSmsChannelResponse - a model defined in OpenAPI

        :param sms_channel_response: The sms_channel_response of this GetSmsChannelResponse.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetSmsChannelResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetSmsChannelResponse of this GetSmsChannelResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def sms_channel_response(self):
        """Gets the sms_channel_response of this GetSmsChannelResponse.


        :return: The sms_channel_response of this GetSmsChannelResponse.
    ...
    def sms_channel_response(self, sms_channel_response):
        """Sets the sms_channel_response of this GetSmsChannelResponse.
