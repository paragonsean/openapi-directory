...
class DeleteSegmentResponse(Model):
    ...
    def __init__(self, segment_response: SegmentResponse=None):
        ...
        :param segment_response: The segment_response of this DeleteSegmentResponse.
        """
        self.openapi_types = {
    ...
    def segment_response(self):
        """Gets the segment_response of this DeleteSegmentResponse.


        :return: The segment_response of this DeleteSegmentResponse.
    ...
    def segment_response(self, segment_response):
        """Sets the segment_response of this DeleteSegmentResponse.
