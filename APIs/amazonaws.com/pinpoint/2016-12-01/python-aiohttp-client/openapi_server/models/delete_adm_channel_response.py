...
class DeleteAdmChannelResponse(Model):
    ...
    def __init__(self, adm_channel_response: ADMChannelResponse=None):
        """DeleteAdmChannelResponse - a model defined in OpenAPI

        :param adm_channel_response: The adm_channel_response of this DeleteAdmChannelResponse.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteAdmChannelResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteAdmChannelResponse of this DeleteAdmChannelResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def adm_channel_response(self):
        """Gets the adm_channel_response of this DeleteAdmChannelResponse.


        :return: The adm_channel_response of this DeleteAdmChannelResponse.
    ...
    def adm_channel_response(self, adm_channel_response):
        """Sets the adm_channel_response of this DeleteAdmChannelResponse.
