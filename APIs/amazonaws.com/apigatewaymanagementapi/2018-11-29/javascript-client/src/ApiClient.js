...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://execute-api.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://execute-api.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2018-11-29/Javascript'
        };
