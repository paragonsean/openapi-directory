...
OAIPollForThirdPartyJobsOutput::OAIPollForThirdPartyJobsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPollForThirdPartyJobsOutput::OAIPollForThirdPartyJobsOutput() {
    this->initializeModel();
}

OAIPollForThirdPartyJobsOutput::~OAIPollForThirdPartyJobsOutput() {}

void OAIPollForThirdPartyJobsOutput::initializeModel() {

    m_jobs_isSet = false;
    m_jobs_isValid = false;
}

void OAIPollForThirdPartyJobsOutput::fromJson(QString jsonString) {
...
void OAIPollForThirdPartyJobsOutput::fromJsonObject(QJsonObject json) {

    m_jobs_isValid = ::OpenAPI::fromJsonValue(m_jobs, json[QString("jobs")]);
    m_jobs_isSet = !json[QString("jobs")].isNull() && m_jobs_isValid;
}

QString OAIPollForThirdPartyJobsOutput::asJson() const {
...
QJsonObject OAIPollForThirdPartyJobsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_jobs.isSet()) {
...
QList OAIPollForThirdPartyJobsOutput::getJobs() const {
    return m_jobs;
}
void OAIPollForThirdPartyJobsOutput::setJobs(const QList &jobs) {
    m_jobs = jobs;
    m_jobs_isSet = true;
}

bool OAIPollForThirdPartyJobsOutput::is_jobs_Set() const{
    return m_jobs_isSet;
}

bool OAIPollForThirdPartyJobsOutput::is_jobs_Valid() const{
    return m_jobs_isValid;
}

bool OAIPollForThirdPartyJobsOutput::isSet() const {
...
bool OAIPollForThirdPartyJobsOutput::isValid() const {
