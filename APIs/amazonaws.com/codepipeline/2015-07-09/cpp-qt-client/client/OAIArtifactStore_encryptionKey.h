...
/*
 * OAIArtifactStore_encryptionKey.h
 *
 * 
 */

#ifndef OAIArtifactStore_encryptionKey_H
#define OAIArtifactStore_encryptionKey_H
...
class OAIArtifactStore_encryptionKey : public OAIObject {
public:
    OAIArtifactStore_encryptionKey();
    OAIArtifactStore_encryptionKey(QString json);
    ~OAIArtifactStore_encryptionKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactStore_encryptionKey)

#endif // OAIArtifactStore_encryptionKey_H
