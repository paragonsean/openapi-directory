...
OAIListActionExecutionsOutput::OAIListActionExecutionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListActionExecutionsOutput::OAIListActionExecutionsOutput() {
    this->initializeModel();
}

OAIListActionExecutionsOutput::~OAIListActionExecutionsOutput() {}

void OAIListActionExecutionsOutput::initializeModel() {

    m_action_execution_details_isSet = false;
    m_action_execution_details_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListActionExecutionsOutput::fromJson(QString jsonString) {
...
void OAIListActionExecutionsOutput::fromJsonObject(QJsonObject json) {

    m_action_execution_details_isValid = ::OpenAPI::fromJsonValue(m_action_execution_details, json[QString("actionExecutionDetails")]);
    m_action_execution_details_isSet = !json[QString("actionExecutionDetails")].isNull() && m_action_execution_details_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIListActionExecutionsOutput::asJson() const {
...
QJsonObject OAIListActionExecutionsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_action_execution_details.isSet()) {
        obj.insert(QString("actionExecutionDetails"), ::OpenAPI::toJsonValue(m_action_execution_details));
    }
...
QList OAIListActionExecutionsOutput::getActionExecutionDetails() const {
    return m_action_execution_details;
}
void OAIListActionExecutionsOutput::setActionExecutionDetails(const QList &action_execution_details) {
    m_action_execution_details = action_execution_details;
    m_action_execution_details_isSet = true;
}

bool OAIListActionExecutionsOutput::is_action_execution_details_Set() const{
    return m_action_execution_details_isSet;
}

bool OAIListActionExecutionsOutput::is_action_execution_details_Valid() const{
    return m_action_execution_details_isValid;
}

QString OAIListActionExecutionsOutput::getNextToken() const {
    return m_next_token;
}
void OAIListActionExecutionsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListActionExecutionsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListActionExecutionsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListActionExecutionsOutput::isSet() const {
...
bool OAIListActionExecutionsOutput::isValid() const {
