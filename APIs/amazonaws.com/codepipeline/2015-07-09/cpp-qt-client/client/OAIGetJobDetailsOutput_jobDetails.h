...
/*
 * OAIGetJobDetailsOutput_jobDetails.h
 *
 * 
 */

#ifndef OAIGetJobDetailsOutput_jobDetails_H
#define OAIGetJobDetailsOutput_jobDetails_H
...
namespace OpenAPI {
class OAIJobDetails_data;

class OAIGetJobDetailsOutput_jobDetails : public OAIObject {
public:
    OAIGetJobDetailsOutput_jobDetails();
    OAIGetJobDetailsOutput_jobDetails(QString json);
    ~OAIGetJobDetailsOutput_jobDetails() override;
    ...
    OAIJobDetails_data getData() const;
    void setData(const OAIJobDetails_data &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetJobDetailsOutput_jobDetails)

#endif // OAIGetJobDetailsOutput_jobDetails_H
