...
#include "OAIThirdPartyJobData.h"
...
OAIThirdPartyJobData::OAIThirdPartyJobData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIThirdPartyJobData::OAIThirdPartyJobData() {
    this->initializeModel();
}

OAIThirdPartyJobData::~OAIThirdPartyJobData() {}

void OAIThirdPartyJobData::initializeModel() {
...
void OAIThirdPartyJobData::fromJson(QString jsonString) {
...
void OAIThirdPartyJobData::fromJsonObject(QJsonObject json) {
...
QString OAIThirdPartyJobData::asJson() const {
...
QJsonObject OAIThirdPartyJobData::asJsonObject() const {
    QJsonObject obj;
...
OAIPollForJobsInput_actionTypeId OAIThirdPartyJobData::getActionTypeId() const {
    return m_action_type_id;
}
void OAIThirdPartyJobData::setActionTypeId(const OAIPollForJobsInput_actionTypeId &action_type_id) {
    m_action_type_id = action_type_id;
    m_action_type_id_isSet = true;
}

bool OAIThirdPartyJobData::is_action_type_id_Set() const{
    return m_action_type_id_isSet;
}

bool OAIThirdPartyJobData::is_action_type_id_Valid() const{
    return m_action_type_id_isValid;
}

OAIJobData_actionConfiguration OAIThirdPartyJobData::getActionConfiguration() const {
    return m_action_configuration;
}
void OAIThirdPartyJobData::setActionConfiguration(const OAIJobData_actionConfiguration &action_configuration) {
    m_action_configuration = action_configuration;
    m_action_configuration_isSet = true;
}

bool OAIThirdPartyJobData::is_action_configuration_Set() const{
    return m_action_configuration_isSet;
}

bool OAIThirdPartyJobData::is_action_configuration_Valid() const{
    return m_action_configuration_isValid;
}

OAIThirdPartyJobData_pipelineContext OAIThirdPartyJobData::getPipelineContext() const {
    return m_pipeline_context;
}
void OAIThirdPartyJobData::setPipelineContext(const OAIThirdPartyJobData_pipelineContext &pipeline_context) {
    m_pipeline_context = pipeline_context;
    m_pipeline_context_isSet = true;
}

bool OAIThirdPartyJobData::is_pipeline_context_Set() const{
    return m_pipeline_context_isSet;
}

bool OAIThirdPartyJobData::is_pipeline_context_Valid() const{
    return m_pipeline_context_isValid;
}

QList OAIThirdPartyJobData::getInputArtifacts() const {
    return m_input_artifacts;
}
void OAIThirdPartyJobData::setInputArtifacts(const QList &input_artifacts) {
    m_input_artifacts = input_artifacts;
    m_input_artifacts_isSet = true;
}

bool OAIThirdPartyJobData::is_input_artifacts_Set() const{
    return m_input_artifacts_isSet;
}

bool OAIThirdPartyJobData::is_input_artifacts_Valid() const{
    return m_input_artifacts_isValid;
}

QList OAIThirdPartyJobData::getOutputArtifacts() const {
    return m_output_artifacts;
}
void OAIThirdPartyJobData::setOutputArtifacts(const QList &output_artifacts) {
    m_output_artifacts = output_artifacts;
    m_output_artifacts_isSet = true;
}

bool OAIThirdPartyJobData::is_output_artifacts_Set() const{
    return m_output_artifacts_isSet;
}

bool OAIThirdPartyJobData::is_output_artifacts_Valid() const{
    return m_output_artifacts_isValid;
}

OAIThirdPartyJobData_artifactCredentials OAIThirdPartyJobData::getArtifactCredentials() const {
    return m_artifact_credentials;
}
void OAIThirdPartyJobData::setArtifactCredentials(const OAIThirdPartyJobData_artifactCredentials &artifact_credentials) {
    m_artifact_credentials = artifact_credentials;
    m_artifact_credentials_isSet = true;
}

bool OAIThirdPartyJobData::is_artifact_credentials_Set() const{
    return m_artifact_credentials_isSet;
}

bool OAIThirdPartyJobData::is_artifact_credentials_Valid() const{
    return m_artifact_credentials_isValid;
}

QString OAIThirdPartyJobData::getContinuationToken() const {
    return m_continuation_token;
}
void OAIThirdPartyJobData::setContinuationToken(const QString &continuation_token) {
    m_continuation_token = continuation_token;
    m_continuation_token_isSet = true;
}

bool OAIThirdPartyJobData::is_continuation_token_Set() const{
    return m_continuation_token_isSet;
}

bool OAIThirdPartyJobData::is_continuation_token_Valid() const{
    return m_continuation_token_isValid;
}

OAIThirdPartyJobData_encryptionKey OAIThirdPartyJobData::getEncryptionKey() const {
    return m_encryption_key;
}
void OAIThirdPartyJobData::setEncryptionKey(const OAIThirdPartyJobData_encryptionKey &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAIThirdPartyJobData::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAIThirdPartyJobData::is_encryption_key_Valid() const{
    return m_encryption_key_isValid;
}

bool OAIThirdPartyJobData::isSet() const {
...
bool OAIThirdPartyJobData::isValid() const {
