...
/*
 * OAIAcknowledgeJobOutput.h
 *
 * Represents the output of an AcknowledgeJob action.
 */

#ifndef OAIAcknowledgeJobOutput_H
#define OAIAcknowledgeJobOutput_H
...
class OAIAcknowledgeJobOutput : public OAIObject {
public:
    OAIAcknowledgeJobOutput();
    OAIAcknowledgeJobOutput(QString json);
    ~OAIAcknowledgeJobOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcknowledgeJobOutput)

#endif // OAIAcknowledgeJobOutput_H
