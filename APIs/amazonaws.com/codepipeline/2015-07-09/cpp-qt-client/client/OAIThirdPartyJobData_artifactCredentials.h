...
/*
 * OAIThirdPartyJobData_artifactCredentials.h
 *
 * 
 */

#ifndef OAIThirdPartyJobData_artifactCredentials_H
#define OAIThirdPartyJobData_artifactCredentials_H
...
class OAIThirdPartyJobData_artifactCredentials : public OAIObject {
public:
    OAIThirdPartyJobData_artifactCredentials();
    OAIThirdPartyJobData_artifactCredentials(QString json);
    ~OAIThirdPartyJobData_artifactCredentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThirdPartyJobData_artifactCredentials)

#endif // OAIThirdPartyJobData_artifactCredentials_H
