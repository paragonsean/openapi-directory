...
/*
 * OAIActionState_latestExecution.h
 *
 * 
 */

#ifndef OAIActionState_latestExecution_H
#define OAIActionState_latestExecution_H
...
class OAIActionState_latestExecution : public OAIObject {
public:
    OAIActionState_latestExecution();
    OAIActionState_latestExecution(QString json);
    ~OAIActionState_latestExecution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionState_latestExecution)

#endif // OAIActionState_latestExecution_H
