...
/*
 * OAIActionDeclaration_actionTypeId.h
 *
 * 
 */

#ifndef OAIActionDeclaration_actionTypeId_H
#define OAIActionDeclaration_actionTypeId_H
...
class OAIActionDeclaration_actionTypeId : public OAIObject {
public:
    OAIActionDeclaration_actionTypeId();
    OAIActionDeclaration_actionTypeId(QString json);
    ~OAIActionDeclaration_actionTypeId() override;
    ...
    OAIActionOwner getOwner() const;
    void setOwner(const OAIActionOwner &owner);
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionDeclaration_actionTypeId)

#endif // OAIActionDeclaration_actionTypeId_H
