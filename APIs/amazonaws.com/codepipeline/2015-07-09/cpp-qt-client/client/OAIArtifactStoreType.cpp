...
#include "OAIArtifactStoreType.h"
...
OAIArtifactStoreType::OAIArtifactStoreType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArtifactStoreType::OAIArtifactStoreType() {
    this->initializeModel();
}

OAIArtifactStoreType::~OAIArtifactStoreType() {}

void OAIArtifactStoreType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIArtifactStoreType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIArtifactStoreType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("S3", Qt::CaseInsensitive) == 0) {
        m_value = eOAIArtifactStoreType::S3;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIArtifactStoreType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIArtifactStoreType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIArtifactStoreType::S3:
            val = "S3";
            break;
        default:
            break;
...
QJsonValue OAIArtifactStoreType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIArtifactStoreType::eOAIArtifactStoreType OAIArtifactStoreType::getValue() const {
    return m_value;
}

void OAIArtifactStoreType::setValue(const OAIArtifactStoreType::eOAIArtifactStoreType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIArtifactStoreType::isSet() const {
    
    return m_value_isSet;
}

bool OAIArtifactStoreType::isValid() const {
