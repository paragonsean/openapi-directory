...
OAIGetJobDetailsOutput_jobDetails::OAIGetJobDetailsOutput_jobDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetJobDetailsOutput_jobDetails::OAIGetJobDetailsOutput_jobDetails() {
    this->initializeModel();
}

OAIGetJobDetailsOutput_jobDetails::~OAIGetJobDetailsOutput_jobDetails() {}

void OAIGetJobDetailsOutput_jobDetails::initializeModel() {
...
void OAIGetJobDetailsOutput_jobDetails::fromJson(QString jsonString) {
...
void OAIGetJobDetailsOutput_jobDetails::fromJsonObject(QJsonObject json) {
...
QString OAIGetJobDetailsOutput_jobDetails::asJson() const {
...
QJsonObject OAIGetJobDetailsOutput_jobDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIGetJobDetailsOutput_jobDetails::getId() const {
    return m_id;
}
void OAIGetJobDetailsOutput_jobDetails::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetJobDetailsOutput_jobDetails::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetJobDetailsOutput_jobDetails::is_id_Valid() const{
    return m_id_isValid;
}

OAIJobDetails_data OAIGetJobDetailsOutput_jobDetails::getData() const {
    return m_data;
}
void OAIGetJobDetailsOutput_jobDetails::setData(const OAIJobDetails_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetJobDetailsOutput_jobDetails::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetJobDetailsOutput_jobDetails::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIGetJobDetailsOutput_jobDetails::getAccountId() const {
    return m_account_id;
}
void OAIGetJobDetailsOutput_jobDetails::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIGetJobDetailsOutput_jobDetails::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIGetJobDetailsOutput_jobDetails::is_account_id_Valid() const{
    return m_account_id_isValid;
}

bool OAIGetJobDetailsOutput_jobDetails::isSet() const {
...
bool OAIGetJobDetailsOutput_jobDetails::isValid() const {
