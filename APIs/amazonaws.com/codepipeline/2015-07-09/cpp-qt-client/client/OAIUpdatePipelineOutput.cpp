...
OAIUpdatePipelineOutput::OAIUpdatePipelineOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePipelineOutput::OAIUpdatePipelineOutput() {
    this->initializeModel();
}

OAIUpdatePipelineOutput::~OAIUpdatePipelineOutput() {}

void OAIUpdatePipelineOutput::initializeModel() {

    m_pipeline_isSet = false;
    m_pipeline_isValid = false;
}

void OAIUpdatePipelineOutput::fromJson(QString jsonString) {
...
void OAIUpdatePipelineOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePipelineOutput::asJson() const {
...
QJsonObject OAIUpdatePipelineOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_pipeline.isSet()) {
...
OAIUpdatePipelineOutput_pipeline OAIUpdatePipelineOutput::getPipeline() const {
    return m_pipeline;
}
void OAIUpdatePipelineOutput::setPipeline(const OAIUpdatePipelineOutput_pipeline &pipeline) {
    m_pipeline = pipeline;
    m_pipeline_isSet = true;
}

bool OAIUpdatePipelineOutput::is_pipeline_Set() const{
    return m_pipeline_isSet;
}

bool OAIUpdatePipelineOutput::is_pipeline_Valid() const{
    return m_pipeline_isValid;
}

bool OAIUpdatePipelineOutput::isSet() const {
...
bool OAIUpdatePipelineOutput::isValid() const {
