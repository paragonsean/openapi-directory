...
/*
 * OAIAcknowledgeThirdPartyJobOutput.h
 *
 * Represents the output of an AcknowledgeThirdPartyJob action.
 */

#ifndef OAIAcknowledgeThirdPartyJobOutput_H
#define OAIAcknowledgeThirdPartyJobOutput_H
...
class OAIAcknowledgeThirdPartyJobOutput : public OAIObject {
public:
    OAIAcknowledgeThirdPartyJobOutput();
    OAIAcknowledgeThirdPartyJobOutput(QString json);
    ~OAIAcknowledgeThirdPartyJobOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcknowledgeThirdPartyJobOutput)

#endif // OAIAcknowledgeThirdPartyJobOutput_H
