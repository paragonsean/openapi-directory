...
/*
 * OAIPutJobFailureResultInput.h
 *
 * Represents the input of a &lt;code&gt;PutJobFailureResult&lt;/code&gt; action.
 */

#ifndef OAIPutJobFailureResultInput_H
#define OAIPutJobFailureResultInput_H
...
namespace OpenAPI {
class OAIPutJobFailureResultInput_failureDetails;

class OAIPutJobFailureResultInput : public OAIObject {
public:
    OAIPutJobFailureResultInput();
    OAIPutJobFailureResultInput(QString json);
    ~OAIPutJobFailureResultInput() override;
    ...
    OAIPutJobFailureResultInput_failureDetails getFailureDetails() const;
    void setFailureDetails(const OAIPutJobFailureResultInput_failureDetails &failure_details);
...
private:
    ...
    OAIPutJobFailureResultInput_failureDetails m_failure_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutJobFailureResultInput)

#endif // OAIPutJobFailureResultInput_H
