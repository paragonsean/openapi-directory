...
/*
 * OAIGetActionTypeOutput.h
 *
 * 
 */

#ifndef OAIGetActionTypeOutput_H
#define OAIGetActionTypeOutput_H
...
namespace OpenAPI {
class OAIGetActionTypeOutput_actionType;

class OAIGetActionTypeOutput : public OAIObject {
public:
    OAIGetActionTypeOutput();
    OAIGetActionTypeOutput(QString json);
    ~OAIGetActionTypeOutput() override;
    ...
    OAIGetActionTypeOutput_actionType getActionType() const;
    void setActionType(const OAIGetActionTypeOutput_actionType &action_type);
...
private:
    ...
    OAIGetActionTypeOutput_actionType m_action_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetActionTypeOutput)

#endif // OAIGetActionTypeOutput_H
