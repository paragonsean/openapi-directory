...
/*
 * OAIThirdPartyJobData_pipelineContext.h
 *
 * 
 */

#ifndef OAIThirdPartyJobData_pipelineContext_H
#define OAIThirdPartyJobData_pipelineContext_H
...
class OAIThirdPartyJobData_pipelineContext : public OAIObject {
public:
    OAIThirdPartyJobData_pipelineContext();
    OAIThirdPartyJobData_pipelineContext(QString json);
    ~OAIThirdPartyJobData_pipelineContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThirdPartyJobData_pipelineContext)

#endif // OAIThirdPartyJobData_pipelineContext_H
