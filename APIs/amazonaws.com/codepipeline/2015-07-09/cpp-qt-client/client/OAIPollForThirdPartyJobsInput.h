...
/*
 * OAIPollForThirdPartyJobsInput.h
 *
 * Represents the input of a &lt;code&gt;PollForThirdPartyJobs&lt;/code&gt; action.
 */

#ifndef OAIPollForThirdPartyJobsInput_H
#define OAIPollForThirdPartyJobsInput_H
...
class OAIPollForThirdPartyJobsInput : public OAIObject {
public:
    OAIPollForThirdPartyJobsInput();
    OAIPollForThirdPartyJobsInput(QString json);
    ~OAIPollForThirdPartyJobsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPollForThirdPartyJobsInput)

#endif // OAIPollForThirdPartyJobsInput_H
