...
/*
 * OAIAcknowledgeJobInput.h
 *
 * Represents the input of an AcknowledgeJob action.
 */

#ifndef OAIAcknowledgeJobInput_H
#define OAIAcknowledgeJobInput_H
...
class OAIAcknowledgeJobInput : public OAIObject {
public:
    OAIAcknowledgeJobInput();
    OAIAcknowledgeJobInput(QString json);
    ~OAIAcknowledgeJobInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcknowledgeJobInput)

#endif // OAIAcknowledgeJobInput_H
