...
/*
 * OAIDisableStageTransitionInput.h
 *
 * Represents the input of a &lt;code&gt;DisableStageTransition&lt;/code&gt; action.
 */

#ifndef OAIDisableStageTransitionInput_H
#define OAIDisableStageTransitionInput_H

#include <QJsonObject>

#include "OAIStageTransitionType.h"
#include <QString>
...
class OAIDisableStageTransitionInput : public OAIObject {
public:
    OAIDisableStageTransitionInput();
    OAIDisableStageTransitionInput(QString json);
    ~OAIDisableStageTransitionInput() override;
    ...
    OAIStageTransitionType getTransitionType() const;
    void setTransitionType(const OAIStageTransitionType &transition_type);
...
private:
    ...
    OAIStageTransitionType m_transition_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisableStageTransitionInput)

#endif // OAIDisableStageTransitionInput_H
