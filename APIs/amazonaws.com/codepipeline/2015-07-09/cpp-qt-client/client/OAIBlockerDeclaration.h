...
/*
 * OAIBlockerDeclaration.h
 *
 * Reserved for future use.
 */

#ifndef OAIBlockerDeclaration_H
#define OAIBlockerDeclaration_H

#include <QJsonObject>

#include "OAIBlockerType.h"
#include <QString>
...
class OAIBlockerDeclaration : public OAIObject {
public:
    OAIBlockerDeclaration();
    OAIBlockerDeclaration(QString json);
    ~OAIBlockerDeclaration() override;
    ...
    OAIBlockerType getType() const;
    void setType(const OAIBlockerType &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlockerDeclaration)

#endif // OAIBlockerDeclaration_H
