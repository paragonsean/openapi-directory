...
/*
 * OAIPutThirdPartyJobFailureResultInput.h
 *
 * Represents the input of a &lt;code&gt;PutThirdPartyJobFailureResult&lt;/code&gt; action.
 */

#ifndef OAIPutThirdPartyJobFailureResultInput_H
#define OAIPutThirdPartyJobFailureResultInput_H
...
namespace OpenAPI {
class OAIPutThirdPartyJobFailureResultInput_failureDetails;

class OAIPutThirdPartyJobFailureResultInput : public OAIObject {
public:
    OAIPutThirdPartyJobFailureResultInput();
    OAIPutThirdPartyJobFailureResultInput(QString json);
    ~OAIPutThirdPartyJobFailureResultInput() override;
    ...
    OAIPutThirdPartyJobFailureResultInput_failureDetails getFailureDetails() const;
    void setFailureDetails(const OAIPutThirdPartyJobFailureResultInput_failureDetails &failure_details);
...
private:
    ...
    OAIPutThirdPartyJobFailureResultInput_failureDetails m_failure_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutThirdPartyJobFailureResultInput)

#endif // OAIPutThirdPartyJobFailureResultInput_H
