...
QString OAIExecutionDetails::getSummary() const {
    return m_summary;
}
void OAIExecutionDetails::setSummary(const QString &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAIExecutionDetails::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAIExecutionDetails::is_summary_Valid() const{
    return m_summary_isValid;
}

QString OAIExecutionDetails::getExternalExecutionId() const {
    return m_external_execution_id;
}
void OAIExecutionDetails::setExternalExecutionId(const QString &external_execution_id) {
    m_external_execution_id = external_execution_id;
    m_external_execution_id_isSet = true;
}

bool OAIExecutionDetails::is_external_execution_id_Set() const{
    return m_external_execution_id_isSet;
}

bool OAIExecutionDetails::is_external_execution_id_Valid() const{
    return m_external_execution_id_isValid;
}

qint32 OAIExecutionDetails::getPercentComplete() const {
    return m_percent_complete;
}
void OAIExecutionDetails::setPercentComplete(const qint32 &percent_complete) {
    m_percent_complete = percent_complete;
    m_percent_complete_isSet = true;
}

bool OAIExecutionDetails::is_percent_complete_Set() const{
    return m_percent_complete_isSet;
}

bool OAIExecutionDetails::is_percent_complete_Valid() const{
