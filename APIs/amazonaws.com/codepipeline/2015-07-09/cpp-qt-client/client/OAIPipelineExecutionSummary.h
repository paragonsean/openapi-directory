...
namespace OpenAPI {
class OAIPipelineExecutionSummary_trigger;
class OAIPipelineExecutionSummary_stopTrigger;
...
public:
    ...
    QList getSourceRevisions() const;
    void setSourceRevisions(const QList &source_revisions);
    bool is_source_revisions_Set() const;
    bool is_source_revisions_Valid() const;

    OAIPipelineExecutionSummary_trigger getTrigger() const;
    void setTrigger(const OAIPipelineExecutionSummary_trigger &trigger);
    bool is_trigger_Set() const;
    bool is_trigger_Valid() const;

    OAIPipelineExecutionSummary_stopTrigger getStopTrigger() const;
    void setStopTrigger(const OAIPipelineExecutionSummary_stopTrigger &stop_trigger);
    bool is_stop_trigger_Set() const;
    bool is_stop_trigger_Valid() const;
...
private:
    ...
    QList m_source_revisions;
    bool m_source_revisions_isSet;
    bool m_source_revisions_isValid;

    OAIPipelineExecutionSummary_trigger m_trigger;
    bool m_trigger_isSet;
    bool m_trigger_isValid;

    OAIPipelineExecutionSummary_stopTrigger m_stop_trigger;
    bool m_stop_trigger_isSet;
    bool m_stop_trigger_isValid;
};
