...
/*
 * OAIStageTransitionType.h
 *
 * 
 */

#ifndef OAIStageTransitionType_H
#define OAIStageTransitionType_H
...
class OAIStageTransitionType : public OAIEnum {
public:
    OAIStageTransitionType();
    OAIStageTransitionType(QString json);
    ~OAIStageTransitionType() override;
    ...
    enum class eOAIStageTransitionType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        INBOUND, 
        OUTBOUND
    };
    OAIStageTransitionType::eOAIStageTransitionType getValue() const;
    void setValue(const OAIStageTransitionType::eOAIStageTransitionType& value);
...
private:
    ...
    eOAIStageTransitionType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStageTransitionType)

#endif // OAIStageTransitionType_H
