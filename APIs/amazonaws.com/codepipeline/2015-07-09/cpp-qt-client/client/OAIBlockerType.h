...
#ifndef OAIBlockerType_H
#define OAIBlockerType_H
...
class OAIBlockerType : public OAIEnum {
public:
    OAIBlockerType();
    OAIBlockerType(QString json);
    ~OAIBlockerType() override;
    ...
    enum class eOAIBlockerType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SCHEDULE
    };
    OAIBlockerType::eOAIBlockerType getValue() const;
    void setValue(const OAIBlockerType::eOAIBlockerType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlockerType)

#endif // OAIBlockerType_H
