...
void OAIFailureType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("JobFailed", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFailureType::JOBFAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ConfigurationError", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFailureType::CONFIGURATIONERROR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PermissionError", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFailureType::PERMISSIONERROR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RevisionOutOfSync", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFailureType::REVISIONOUTOFSYNC;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RevisionUnavailable", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFailureType::REVISIONUNAVAILABLE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SystemUnavailable", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFailureType::SYSTEMUNAVAILABLE;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIFailureType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIFailureType::JOBFAILED:
            val = "JobFailed";
            break;
        case eOAIFailureType::CONFIGURATIONERROR:
            val = "ConfigurationError";
            break;
        case eOAIFailureType::PERMISSIONERROR:
            val = "PermissionError";
            break;
        case eOAIFailureType::REVISIONOUTOFSYNC:
            val = "RevisionOutOfSync";
            break;
        case eOAIFailureType::REVISIONUNAVAILABLE:
            val = "RevisionUnavailable";
            break;
        case eOAIFailureType::SYSTEMUNAVAILABLE:
            val = "SystemUnavailable";
            break;
        default:
            break;
    }
