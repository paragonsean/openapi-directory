...
/*
 * OAIGetPipelineOutput.h
 *
 * Represents the output of a &lt;code&gt;GetPipeline&lt;/code&gt; action.
 */

#ifndef OAIGetPipelineOutput_H
#define OAIGetPipelineOutput_H
...
namespace OpenAPI {
class OAICreatePipelineOutput_pipeline;
class OAIGetPipelineOutput_metadata;

class OAIGetPipelineOutput : public OAIObject {
public:
    OAIGetPipelineOutput();
    OAIGetPipelineOutput(QString json);
    ~OAIGetPipelineOutput() override;
    ...
    OAICreatePipelineOutput_pipeline getPipeline() const;
    void setPipeline(const OAICreatePipelineOutput_pipeline &pipeline);
    bool is_pipeline_Set() const;
    bool is_pipeline_Valid() const;

    OAIGetPipelineOutput_metadata getMetadata() const;
    void setMetadata(const OAIGetPipelineOutput_metadata &metadata);
...
private:
    ...
    OAICreatePipelineOutput_pipeline m_pipeline;
    bool m_pipeline_isSet;
    bool m_pipeline_isValid;

    OAIGetPipelineOutput_metadata m_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPipelineOutput)

#endif // OAIGetPipelineOutput_H
