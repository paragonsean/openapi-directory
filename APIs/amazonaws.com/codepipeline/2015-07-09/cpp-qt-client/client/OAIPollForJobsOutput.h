...
/*
 * OAIPollForJobsOutput.h
 *
 * Represents the output of a &lt;code&gt;PollForJobs&lt;/code&gt; action.
 */

#ifndef OAIPollForJobsOutput_H
#define OAIPollForJobsOutput_H
...
class OAIPollForJobsOutput : public OAIObject {
public:
    OAIPollForJobsOutput();
    OAIPollForJobsOutput(QString json);
    ~OAIPollForJobsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPollForJobsOutput)

#endif // OAIPollForJobsOutput_H
