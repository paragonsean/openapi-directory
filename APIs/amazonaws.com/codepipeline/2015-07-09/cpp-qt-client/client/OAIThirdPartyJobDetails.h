...
/*
 * OAIThirdPartyJobDetails.h
 *
 * The details of a job sent in response to a &lt;code&gt;GetThirdPartyJobDetails&lt;/code&gt; request.
 */

#ifndef OAIThirdPartyJobDetails_H
#define OAIThirdPartyJobDetails_H
...
class OAIThirdPartyJobDetails : public OAIObject {
public:
    OAIThirdPartyJobDetails();
    OAIThirdPartyJobDetails(QString json);
    ~OAIThirdPartyJobDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThirdPartyJobDetails)

#endif // OAIThirdPartyJobDetails_H
