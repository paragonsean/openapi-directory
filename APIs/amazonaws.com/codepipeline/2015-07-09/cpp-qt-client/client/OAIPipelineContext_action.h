...
/*
 * OAIPipelineContext_action.h
 *
 * 
 */

#ifndef OAIPipelineContext_action_H
#define OAIPipelineContext_action_H
...
class OAIPipelineContext_action : public OAIObject {
public:
    OAIPipelineContext_action();
    OAIPipelineContext_action(QString json);
    ~OAIPipelineContext_action() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipelineContext_action)

#endif // OAIPipelineContext_action_H
