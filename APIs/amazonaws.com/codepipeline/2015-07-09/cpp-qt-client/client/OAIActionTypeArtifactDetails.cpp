...
#include "OAIActionTypeArtifactDetails.h"
...
OAIActionTypeArtifactDetails::OAIActionTypeArtifactDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionTypeArtifactDetails::OAIActionTypeArtifactDetails() {
    this->initializeModel();
}

OAIActionTypeArtifactDetails::~OAIActionTypeArtifactDetails() {}

void OAIActionTypeArtifactDetails::initializeModel() {
...
void OAIActionTypeArtifactDetails::fromJson(QString jsonString) {
...
void OAIActionTypeArtifactDetails::fromJsonObject(QJsonObject json) {
...
QString OAIActionTypeArtifactDetails::asJson() const {
...
QJsonObject OAIActionTypeArtifactDetails::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIActionTypeArtifactDetails::getMinimumCount() const {
    return m_minimum_count;
}
void OAIActionTypeArtifactDetails::setMinimumCount(const qint32 &minimum_count) {
    m_minimum_count = minimum_count;
    m_minimum_count_isSet = true;
}

bool OAIActionTypeArtifactDetails::is_minimum_count_Set() const{
    return m_minimum_count_isSet;
}

bool OAIActionTypeArtifactDetails::is_minimum_count_Valid() const{
    return m_minimum_count_isValid;
}

qint32 OAIActionTypeArtifactDetails::getMaximumCount() const {
    return m_maximum_count;
}
void OAIActionTypeArtifactDetails::setMaximumCount(const qint32 &maximum_count) {
    m_maximum_count = maximum_count;
    m_maximum_count_isSet = true;
}

bool OAIActionTypeArtifactDetails::is_maximum_count_Set() const{
    return m_maximum_count_isSet;
}

bool OAIActionTypeArtifactDetails::is_maximum_count_Valid() const{
    return m_maximum_count_isValid;
}

bool OAIActionTypeArtifactDetails::isSet() const {
...
bool OAIActionTypeArtifactDetails::isValid() const {
