...
/*
 * OAIPipelineContext_stage.h
 *
 * 
 */

#ifndef OAIPipelineContext_stage_H
#define OAIPipelineContext_stage_H
...
class OAIPipelineContext_stage : public OAIObject {
public:
    OAIPipelineContext_stage();
    OAIPipelineContext_stage(QString json);
    ~OAIPipelineContext_stage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipelineContext_stage)

#endif // OAIPipelineContext_stage_H
