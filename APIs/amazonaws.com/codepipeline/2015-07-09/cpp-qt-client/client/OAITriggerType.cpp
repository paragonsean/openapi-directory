...
void OAITriggerType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("CreatePipeline", Qt::CaseInsensitive) == 0) {
        m_value = eOAITriggerType::CREATEPIPELINE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("StartPipelineExecution", Qt::CaseInsensitive) == 0) {
        m_value = eOAITriggerType::STARTPIPELINEEXECUTION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PollForSourceChanges", Qt::CaseInsensitive) == 0) {
        m_value = eOAITriggerType::POLLFORSOURCECHANGES;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Webhook", Qt::CaseInsensitive) == 0) {
        m_value = eOAITriggerType::WEBHOOK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CloudWatchEvent", Qt::CaseInsensitive) == 0) {
        m_value = eOAITriggerType::CLOUDWATCHEVENT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PutActionRevision", Qt::CaseInsensitive) == 0) {
        m_value = eOAITriggerType::PUTACTIONREVISION;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAITriggerType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAITriggerType::CREATEPIPELINE:
            val = "CreatePipeline";
            break;
        case eOAITriggerType::STARTPIPELINEEXECUTION:
            val = "StartPipelineExecution";
            break;
        case eOAITriggerType::POLLFORSOURCECHANGES:
            val = "PollForSourceChanges";
            break;
        case eOAITriggerType::WEBHOOK:
            val = "Webhook";
            break;
        case eOAITriggerType::CLOUDWATCHEVENT:
            val = "CloudWatchEvent";
            break;
        case eOAITriggerType::PUTACTIONREVISION:
            val = "PutActionRevision";
            break;
        default:
            break;
    }
