...
#include "OAIS3ArtifactLocation.h"
...
OAIS3ArtifactLocation::OAIS3ArtifactLocation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3ArtifactLocation::OAIS3ArtifactLocation() {
    this->initializeModel();
}

OAIS3ArtifactLocation::~OAIS3ArtifactLocation() {}

void OAIS3ArtifactLocation::initializeModel() {
...
void OAIS3ArtifactLocation::fromJson(QString jsonString) {
...
void OAIS3ArtifactLocation::fromJsonObject(QJsonObject json) {
...
QString OAIS3ArtifactLocation::asJson() const {
...
QJsonObject OAIS3ArtifactLocation::asJsonObject() const {
    QJsonObject obj;
...
QString OAIS3ArtifactLocation::getBucketName() const {
    return m_bucket_name;
}
void OAIS3ArtifactLocation::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAIS3ArtifactLocation::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAIS3ArtifactLocation::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

QString OAIS3ArtifactLocation::getObjectKey() const {
    return m_object_key;
}
void OAIS3ArtifactLocation::setObjectKey(const QString &object_key) {
    m_object_key = object_key;
    m_object_key_isSet = true;
}

bool OAIS3ArtifactLocation::is_object_key_Set() const{
    return m_object_key_isSet;
}

bool OAIS3ArtifactLocation::is_object_key_Valid() const{
    return m_object_key_isValid;
}

bool OAIS3ArtifactLocation::isSet() const {
...
bool OAIS3ArtifactLocation::isValid() const {
