...
/*
 * OAIArtifactStoreType.h
 *
 * 
 */

#ifndef OAIArtifactStoreType_H
#define OAIArtifactStoreType_H
...
class OAIArtifactStoreType : public OAIEnum {
public:
    OAIArtifactStoreType();
    OAIArtifactStoreType(QString json);
    ~OAIArtifactStoreType() override;
    ...
    enum class eOAIArtifactStoreType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        S3
    };
    OAIArtifactStoreType::eOAIArtifactStoreType getValue() const;
    void setValue(const OAIArtifactStoreType::eOAIArtifactStoreType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactStoreType)

#endif // OAIArtifactStoreType_H
