...
OAIGetPipelineExecutionOutput::OAIGetPipelineExecutionOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPipelineExecutionOutput::OAIGetPipelineExecutionOutput() {
    this->initializeModel();
}

OAIGetPipelineExecutionOutput::~OAIGetPipelineExecutionOutput() {}

void OAIGetPipelineExecutionOutput::initializeModel() {

    m_pipeline_execution_isSet = false;
    m_pipeline_execution_isValid = false;
}

void OAIGetPipelineExecutionOutput::fromJson(QString jsonString) {
...
void OAIGetPipelineExecutionOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPipelineExecutionOutput::asJson() const {
...
QJsonObject OAIGetPipelineExecutionOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIGetPipelineExecutionOutput_pipelineExecution OAIGetPipelineExecutionOutput::getPipelineExecution() const {
    return m_pipeline_execution;
}
void OAIGetPipelineExecutionOutput::setPipelineExecution(const OAIGetPipelineExecutionOutput_pipelineExecution &pipeline_execution) {
    m_pipeline_execution = pipeline_execution;
    m_pipeline_execution_isSet = true;
}

bool OAIGetPipelineExecutionOutput::is_pipeline_execution_Set() const{
    return m_pipeline_execution_isSet;
}

bool OAIGetPipelineExecutionOutput::is_pipeline_execution_Valid() const{
    return m_pipeline_execution_isValid;
}

bool OAIGetPipelineExecutionOutput::isSet() const {
...
bool OAIGetPipelineExecutionOutput::isValid() const {
