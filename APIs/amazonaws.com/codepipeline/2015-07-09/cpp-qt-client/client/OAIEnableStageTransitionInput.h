...
/*
 * OAIEnableStageTransitionInput.h
 *
 * Represents the input of an &lt;code&gt;EnableStageTransition&lt;/code&gt; action.
 */

#ifndef OAIEnableStageTransitionInput_H
#define OAIEnableStageTransitionInput_H
...
class OAIEnableStageTransitionInput : public OAIObject {
public:
    OAIEnableStageTransitionInput();
    OAIEnableStageTransitionInput(QString json);
    ~OAIEnableStageTransitionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnableStageTransitionInput)

#endif // OAIEnableStageTransitionInput_H
