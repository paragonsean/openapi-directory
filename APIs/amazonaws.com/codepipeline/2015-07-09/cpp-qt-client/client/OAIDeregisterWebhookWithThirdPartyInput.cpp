...
OAIDeregisterWebhookWithThirdPartyInput::OAIDeregisterWebhookWithThirdPartyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeregisterWebhookWithThirdPartyInput::OAIDeregisterWebhookWithThirdPartyInput() {
    this->initializeModel();
}

OAIDeregisterWebhookWithThirdPartyInput::~OAIDeregisterWebhookWithThirdPartyInput() {}

void OAIDeregisterWebhookWithThirdPartyInput::initializeModel() {

    m_webhook_name_isSet = false;
    m_webhook_name_isValid = false;
}

void OAIDeregisterWebhookWithThirdPartyInput::fromJson(QString jsonString) {
...
void OAIDeregisterWebhookWithThirdPartyInput::fromJsonObject(QJsonObject json) {

    m_webhook_name_isValid = ::OpenAPI::fromJsonValue(m_webhook_name, json[QString("webhookName")]);
    m_webhook_name_isSet = !json[QString("webhookName")].isNull() && m_webhook_name_isValid;
}

QString OAIDeregisterWebhookWithThirdPartyInput::asJson() const {
...
QJsonObject OAIDeregisterWebhookWithThirdPartyInput::asJsonObject() const {
    QJsonObject obj;
    if (m_webhook_name_isSet) {
        obj.insert(QString("webhookName"), ::OpenAPI::toJsonValue(m_webhook_name));
    }
    return obj;
}

QString OAIDeregisterWebhookWithThirdPartyInput::getWebhookName() const {
    return m_webhook_name;
}
void OAIDeregisterWebhookWithThirdPartyInput::setWebhookName(const QString &webhook_name) {
    m_webhook_name = webhook_name;
    m_webhook_name_isSet = true;
}

bool OAIDeregisterWebhookWithThirdPartyInput::is_webhook_name_Set() const{
    return m_webhook_name_isSet;
}

bool OAIDeregisterWebhookWithThirdPartyInput::is_webhook_name_Valid() const{
    return m_webhook_name_isValid;
}

bool OAIDeregisterWebhookWithThirdPartyInput::isSet() const {
...
bool OAIDeregisterWebhookWithThirdPartyInput::isValid() const {
