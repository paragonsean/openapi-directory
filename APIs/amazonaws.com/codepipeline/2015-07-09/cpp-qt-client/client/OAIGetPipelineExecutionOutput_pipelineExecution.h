...
/*
 * OAIGetPipelineExecutionOutput_pipelineExecution.h
 *
 * 
 */

#ifndef OAIGetPipelineExecutionOutput_pipelineExecution_H
#define OAIGetPipelineExecutionOutput_pipelineExecution_H
...
class OAIGetPipelineExecutionOutput_pipelineExecution : public OAIObject {
public:
    OAIGetPipelineExecutionOutput_pipelineExecution();
    OAIGetPipelineExecutionOutput_pipelineExecution(QString json);
    ~OAIGetPipelineExecutionOutput_pipelineExecution() override;
    ...
    OAIPipelineExecutionStatus getStatus() const;
    void setStatus(const OAIPipelineExecutionStatus &status);
    bool is_status_Set() const;
    bool is_status_Valid() const;

    QString getStatusSummary() const;
    void setStatusSummary(const QString &status_summary);
    bool is_status_summary_Set() const;
    bool is_status_summary_Valid() const;

    QList getArtifactRevisions() const;
    void setArtifactRevisions(const QList &artifact_revisions);
    bool is_artifact_revisions_Set() const;
    bool is_artifact_revisions_Valid() const;
...
private:
    ...
    OAIPipelineExecutionStatus m_status;
    bool m_status_isSet;
    bool m_status_isValid;

    QString m_status_summary;
    bool m_status_summary_isSet;
    bool m_status_summary_isValid;

    QList m_artifact_revisions;
    bool m_artifact_revisions_isSet;
    bool m_artifact_revisions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetPipelineExecutionOutput_pipelineExecution)

#endif // OAIGetPipelineExecutionOutput_pipelineExecution_H
