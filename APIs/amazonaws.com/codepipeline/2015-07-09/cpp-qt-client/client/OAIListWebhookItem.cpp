...
OAIListWebhookItem::OAIListWebhookItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListWebhookItem::OAIListWebhookItem() {
    this->initializeModel();
}

OAIListWebhookItem::~OAIListWebhookItem() {}

void OAIListWebhookItem::initializeModel() {
...
void OAIListWebhookItem::fromJson(QString jsonString) {
...
void OAIListWebhookItem::fromJsonObject(QJsonObject json) {
...
QString OAIListWebhookItem::asJson() const {
...
QJsonObject OAIListWebhookItem::asJsonObject() const {
    QJsonObject obj;
...
OAIListWebhookItem_definition OAIListWebhookItem::getDefinition() const {
    return m_definition;
}
void OAIListWebhookItem::setDefinition(const OAIListWebhookItem_definition &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAIListWebhookItem::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAIListWebhookItem::is_definition_Valid() const{
    return m_definition_isValid;
}

QString OAIListWebhookItem::getUrl() const {
    return m_url;
}
void OAIListWebhookItem::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIListWebhookItem::is_url_Set() const{
    return m_url_isSet;
}

bool OAIListWebhookItem::is_url_Valid() const{
    return m_url_isValid;
}

QString OAIListWebhookItem::getErrorMessage() const {
    return m_error_message;
}
void OAIListWebhookItem::setErrorMessage(const QString &error_message) {
    m_error_message = error_message;
    m_error_message_isSet = true;
}

bool OAIListWebhookItem::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIListWebhookItem::is_error_message_Valid() const{
    return m_error_message_isValid;
}

QString OAIListWebhookItem::getErrorCode() const {
    return m_error_code;
}
void OAIListWebhookItem::setErrorCode(const QString &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIListWebhookItem::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIListWebhookItem::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QDateTime OAIListWebhookItem::getLastTriggered() const {
    return m_last_triggered;
}
void OAIListWebhookItem::setLastTriggered(const QDateTime &last_triggered) {
    m_last_triggered = last_triggered;
    m_last_triggered_isSet = true;
}

bool OAIListWebhookItem::is_last_triggered_Set() const{
    return m_last_triggered_isSet;
}

bool OAIListWebhookItem::is_last_triggered_Valid() const{
    return m_last_triggered_isValid;
}

QString OAIListWebhookItem::getArn() const {
    return m_arn;
}
void OAIListWebhookItem::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIListWebhookItem::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIListWebhookItem::is_arn_Valid() const{
    return m_arn_isValid;
}

QList OAIListWebhookItem::getTags() const {
    return m_tags;
}
void OAIListWebhookItem::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIListWebhookItem::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIListWebhookItem::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIListWebhookItem::isSet() const {
...
bool OAIListWebhookItem::isValid() const {
