...
#ifndef OAIActionRevision_H
#define OAIActionRevision_H
...
class OAIActionRevision : public OAIObject {
public:
    OAIActionRevision();
    OAIActionRevision(QString json);
    ~OAIActionRevision() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionRevision)

#endif // OAIActionRevision_H
