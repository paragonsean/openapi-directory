...
/*
 * OAIThirdPartyJobData.h
 *
 * Represents information about the job data for a partner action.
 */

#ifndef OAIThirdPartyJobData_H
#define OAIThirdPartyJobData_H
...
class OAIThirdPartyJobData : public OAIObject {
public:
    OAIThirdPartyJobData();
    OAIThirdPartyJobData(QString json);
    ~OAIThirdPartyJobData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThirdPartyJobData)

#endif // OAIThirdPartyJobData_H
