...
/*
 * OAIPutActionRevisionInput_actionRevision.h
 *
 * 
 */

#ifndef OAIPutActionRevisionInput_actionRevision_H
#define OAIPutActionRevisionInput_actionRevision_H
...
class OAIPutActionRevisionInput_actionRevision : public OAIObject {
public:
    OAIPutActionRevisionInput_actionRevision();
    OAIPutActionRevisionInput_actionRevision(QString json);
    ~OAIPutActionRevisionInput_actionRevision() override;
    ...
    QString getRevisionChangeId() const;
    void setRevisionChangeId(const QString &revision_change_id);
    bool is_revision_change_id_Set() const;
    bool is_revision_change_id_Valid() const;
...
private:
    ...
    QString m_revision_change_id;
    bool m_revision_change_id_isSet;
    bool m_revision_change_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutActionRevisionInput_actionRevision)

#endif // OAIPutActionRevisionInput_actionRevision_H
