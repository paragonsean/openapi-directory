...
/*
 * OAIPutJobSuccessResultInput.h
 *
 * Represents the input of a &lt;code&gt;PutJobSuccessResult&lt;/code&gt; action.
 */

#ifndef OAIPutJobSuccessResultInput_H
#define OAIPutJobSuccessResultInput_H

#include <QJsonObject>

#include "OAIPutJobSuccessResultInput_currentRevision.h"
#include "OAIPutJobSuccessResultInput_executionDetails.h"
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIPutJobSuccessResultInput_currentRevision;
class OAIPutJobSuccessResultInput_executionDetails;

class OAIPutJobSuccessResultInput : public OAIObject {
public:
    OAIPutJobSuccessResultInput();
    OAIPutJobSuccessResultInput(QString json);
    ~OAIPutJobSuccessResultInput() override;
    ...
    OAIPutJobSuccessResultInput_currentRevision getCurrentRevision() const;
    void setCurrentRevision(const OAIPutJobSuccessResultInput_currentRevision &current_revision);
    bool is_current_revision_Set() const;
    bool is_current_revision_Valid() const;
    ...
    OAIPutJobSuccessResultInput_executionDetails getExecutionDetails() const;
    void setExecutionDetails(const OAIPutJobSuccessResultInput_executionDetails &execution_details);
    bool is_execution_details_Set() const;
    bool is_execution_details_Valid() const;

    QMap getOutputVariables() const;
    void setOutputVariables(const QMap &output_variables);
    bool is_output_variables_Set() const;
    bool is_output_variables_Valid() const;
...
private:
    ...
    OAIPutJobSuccessResultInput_currentRevision m_current_revision;
    bool m_current_revision_isSet;
    bool m_current_revision_isValid;

    QString m_continuation_token;
    bool m_continuation_token_isSet;
    bool m_continuation_token_isValid;

    OAIPutJobSuccessResultInput_executionDetails m_execution_details;
    bool m_execution_details_isSet;
    bool m_execution_details_isValid;

    QMap m_output_variables;
    bool m_output_variables_isSet;
    bool m_output_variables_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutJobSuccessResultInput)

#endif // OAIPutJobSuccessResultInput_H
