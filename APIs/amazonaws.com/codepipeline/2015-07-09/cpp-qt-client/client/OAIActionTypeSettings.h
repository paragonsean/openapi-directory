...
/*
 * OAIActionTypeSettings.h
 *
 * Returns information about the settings for an action type.
 */

#ifndef OAIActionTypeSettings_H
#define OAIActionTypeSettings_H
...
class OAIActionTypeSettings : public OAIObject {
public:
    OAIActionTypeSettings();
    OAIActionTypeSettings(QString json);
    ~OAIActionTypeSettings() override;
    ...
    QString getThirdPartyConfigurationUrl() const;
    void setThirdPartyConfigurationUrl(const QString &third_party_configuration_url);
    bool is_third_party_configuration_url_Set() const;
    bool is_third_party_configuration_url_Valid() const;

    QString getEntityUrlTemplate() const;
    void setEntityUrlTemplate(const QString &entity_url_template);
    bool is_entity_url_template_Set() const;
    bool is_entity_url_template_Valid() const;

    QString getExecutionUrlTemplate() const;
    void setExecutionUrlTemplate(const QString &execution_url_template);
    bool is_execution_url_template_Set() const;
    bool is_execution_url_template_Valid() const;

    QString getRevisionUrlTemplate() const;
    void setRevisionUrlTemplate(const QString &revision_url_template);
    bool is_revision_url_template_Set() const;
    bool is_revision_url_template_Valid() const;
...
private:
    ...
    QString m_third_party_configuration_url;
    bool m_third_party_configuration_url_isSet;
    bool m_third_party_configuration_url_isValid;

    QString m_entity_url_template;
    bool m_entity_url_template_isSet;
    bool m_entity_url_template_isValid;

    QString m_execution_url_template;
    bool m_execution_url_template_isSet;
    bool m_execution_url_template_isValid;

    QString m_revision_url_template;
    bool m_revision_url_template_isSet;
    bool m_revision_url_template_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeSettings)

#endif // OAIActionTypeSettings_H
