...
void OAIJobStatus::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("Dispatched", Qt::CaseInsensitive) == 0) {
        m_value = eOAIJobStatus::DISPATCHED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("InProgress", Qt::CaseInsensitive) == 0) {
        m_value = eOAIJobStatus::INPROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TimedOut", Qt::CaseInsensitive) == 0) {
        m_value = eOAIJobStatus::TIMEDOUT;
        m_value_isSet = m_value_isValid = true;
    }
...
QString OAIJobStatus::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIJobStatus::QUEUED:
            val = "Queued";
            break;
        case eOAIJobStatus::DISPATCHED:
            val = "Dispatched";
            break;
        case eOAIJobStatus::INPROGRESS:
            val = "InProgress";
            break;
        case eOAIJobStatus::TIMEDOUT:
            val = "TimedOut";
            break;
