...
#ifndef OAIActionOwner_H
#define OAIActionOwner_H
...
class OAIActionOwner : public OAIEnum {
public:
    OAIActionOwner();
    OAIActionOwner(QString json);
    ~OAIActionOwner() override;
    ...
    enum class eOAIActionOwner {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AWS, 
        THIRDPARTY, 
        CUSTOM
    };
    OAIActionOwner::eOAIActionOwner getValue() const;
    void setValue(const OAIActionOwner::eOAIActionOwner& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionOwner)

#endif // OAIActionOwner_H
