...
OAIDisableStageTransitionInput::OAIDisableStageTransitionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisableStageTransitionInput::OAIDisableStageTransitionInput() {
    this->initializeModel();
}

OAIDisableStageTransitionInput::~OAIDisableStageTransitionInput() {}

void OAIDisableStageTransitionInput::initializeModel() {
...
void OAIDisableStageTransitionInput::fromJson(QString jsonString) {
...
void OAIDisableStageTransitionInput::fromJsonObject(QJsonObject json) {
...
QString OAIDisableStageTransitionInput::asJson() const {
...
QJsonObject OAIDisableStageTransitionInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisableStageTransitionInput::getPipelineName() const {
    return m_pipeline_name;
}
void OAIDisableStageTransitionInput::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIDisableStageTransitionInput::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIDisableStageTransitionInput::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

QString OAIDisableStageTransitionInput::getStageName() const {
    return m_stage_name;
}
void OAIDisableStageTransitionInput::setStageName(const QString &stage_name) {
    m_stage_name = stage_name;
    m_stage_name_isSet = true;
}

bool OAIDisableStageTransitionInput::is_stage_name_Set() const{
    return m_stage_name_isSet;
}

bool OAIDisableStageTransitionInput::is_stage_name_Valid() const{
    return m_stage_name_isValid;
}

OAIStageTransitionType OAIDisableStageTransitionInput::getTransitionType() const {
    return m_transition_type;
}
void OAIDisableStageTransitionInput::setTransitionType(const OAIStageTransitionType &transition_type) {
    m_transition_type = transition_type;
    m_transition_type_isSet = true;
}

bool OAIDisableStageTransitionInput::is_transition_type_Set() const{
    return m_transition_type_isSet;
}

bool OAIDisableStageTransitionInput::is_transition_type_Valid() const{
    return m_transition_type_isValid;
}

QString OAIDisableStageTransitionInput::getReason() const {
    return m_reason;
}
void OAIDisableStageTransitionInput::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIDisableStageTransitionInput::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIDisableStageTransitionInput::is_reason_Valid() const{
    return m_reason_isValid;
}

bool OAIDisableStageTransitionInput::isSet() const {
...
bool OAIDisableStageTransitionInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pipeline_name_isValid && m_stage_name_isValid && m_transition_type_isValid && m_reason_isValid && true;
}
