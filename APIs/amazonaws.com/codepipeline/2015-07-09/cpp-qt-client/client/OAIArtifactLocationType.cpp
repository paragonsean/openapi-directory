...
#include "OAIArtifactLocationType.h"
...
OAIArtifactLocationType::OAIArtifactLocationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArtifactLocationType::OAIArtifactLocationType() {
    this->initializeModel();
}

OAIArtifactLocationType::~OAIArtifactLocationType() {}

void OAIArtifactLocationType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIArtifactLocationType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIArtifactLocationType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("S3", Qt::CaseInsensitive) == 0) {
        m_value = eOAIArtifactLocationType::S3;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIArtifactLocationType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIArtifactLocationType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIArtifactLocationType::S3:
            val = "S3";
            break;
        default:
            break;
...
QJsonValue OAIArtifactLocationType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIArtifactLocationType::eOAIArtifactLocationType OAIArtifactLocationType::getValue() const {
    return m_value;
}

void OAIArtifactLocationType::setValue(const OAIArtifactLocationType::eOAIArtifactLocationType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIArtifactLocationType::isSet() const {
    
    return m_value_isSet;
}

bool OAIArtifactLocationType::isValid() const {
