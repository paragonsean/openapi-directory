...
/*
 * OAIPipelineExecutionSummary_trigger.h
 *
 * 
 */

#ifndef OAIPipelineExecutionSummary_trigger_H
#define OAIPipelineExecutionSummary_trigger_H
...
class OAIPipelineExecutionSummary_trigger : public OAIObject {
public:
    OAIPipelineExecutionSummary_trigger();
    OAIPipelineExecutionSummary_trigger(QString json);
    ~OAIPipelineExecutionSummary_trigger() override;
    ...
    QString getTriggerDetail() const;
    void setTriggerDetail(const QString &trigger_detail);
    bool is_trigger_detail_Set() const;
    bool is_trigger_detail_Valid() const;
...
private:
    ...
    QString m_trigger_detail;
    bool m_trigger_detail_isSet;
    bool m_trigger_detail_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPipelineExecutionSummary_trigger)

#endif // OAIPipelineExecutionSummary_trigger_H
