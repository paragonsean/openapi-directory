...
OAIGetJobDetailsOutput::OAIGetJobDetailsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetJobDetailsOutput::OAIGetJobDetailsOutput() {
    this->initializeModel();
}

OAIGetJobDetailsOutput::~OAIGetJobDetailsOutput() {}

void OAIGetJobDetailsOutput::initializeModel() {

    m_job_details_isSet = false;
    m_job_details_isValid = false;
}

void OAIGetJobDetailsOutput::fromJson(QString jsonString) {
...
void OAIGetJobDetailsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetJobDetailsOutput::asJson() const {
...
QJsonObject OAIGetJobDetailsOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIGetJobDetailsOutput_jobDetails OAIGetJobDetailsOutput::getJobDetails() const {
    return m_job_details;
}
void OAIGetJobDetailsOutput::setJobDetails(const OAIGetJobDetailsOutput_jobDetails &job_details) {
    m_job_details = job_details;
    m_job_details_isSet = true;
}

bool OAIGetJobDetailsOutput::is_job_details_Set() const{
    return m_job_details_isSet;
}

bool OAIGetJobDetailsOutput::is_job_details_Valid() const{
    return m_job_details_isValid;
}

bool OAIGetJobDetailsOutput::isSet() const {
...
bool OAIGetJobDetailsOutput::isValid() const {
