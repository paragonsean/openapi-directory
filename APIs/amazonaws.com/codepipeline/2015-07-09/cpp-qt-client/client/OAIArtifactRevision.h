...
/*
 * OAIArtifactRevision.h
 *
 * Represents revision details of an artifact. 
 */

#ifndef OAIArtifactRevision_H
#define OAIArtifactRevision_H
...
class OAIArtifactRevision : public OAIObject {
public:
    OAIArtifactRevision();
    OAIArtifactRevision(QString json);
    ~OAIArtifactRevision() override;
    ...
    QString getRevisionChangeIdentifier() const;
    void setRevisionChangeIdentifier(const QString &revision_change_identifier);
    bool is_revision_change_identifier_Set() const;
    bool is_revision_change_identifier_Valid() const;
...
private:
    ...
    QString m_revision_change_identifier;
    bool m_revision_change_identifier_isSet;
    bool m_revision_change_identifier_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactRevision)

#endif // OAIArtifactRevision_H
