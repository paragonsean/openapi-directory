...
/*
 * OAICreateCustomActionTypeInput_inputArtifactDetails.h
 *
 * 
 */

#ifndef OAICreateCustomActionTypeInput_inputArtifactDetails_H
#define OAICreateCustomActionTypeInput_inputArtifactDetails_H
...
class OAICreateCustomActionTypeInput_inputArtifactDetails : public OAIObject {
public:
    OAICreateCustomActionTypeInput_inputArtifactDetails();
    OAICreateCustomActionTypeInput_inputArtifactDetails(QString json);
    ~OAICreateCustomActionTypeInput_inputArtifactDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomActionTypeInput_inputArtifactDetails)

#endif // OAICreateCustomActionTypeInput_inputArtifactDetails_H
