...
OAIGetPipelineOutput::OAIGetPipelineOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPipelineOutput::OAIGetPipelineOutput() {
    this->initializeModel();
}

OAIGetPipelineOutput::~OAIGetPipelineOutput() {}

void OAIGetPipelineOutput::initializeModel() {
...
void OAIGetPipelineOutput::fromJson(QString jsonString) {
...
void OAIGetPipelineOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPipelineOutput::asJson() const {
...
QJsonObject OAIGetPipelineOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_pipeline.isSet()) {
...
OAICreatePipelineOutput_pipeline OAIGetPipelineOutput::getPipeline() const {
    return m_pipeline;
}
void OAIGetPipelineOutput::setPipeline(const OAICreatePipelineOutput_pipeline &pipeline) {
    m_pipeline = pipeline;
    m_pipeline_isSet = true;
}

bool OAIGetPipelineOutput::is_pipeline_Set() const{
    return m_pipeline_isSet;
}

bool OAIGetPipelineOutput::is_pipeline_Valid() const{
    return m_pipeline_isValid;
}

OAIGetPipelineOutput_metadata OAIGetPipelineOutput::getMetadata() const {
    return m_metadata;
}
void OAIGetPipelineOutput::setMetadata(const OAIGetPipelineOutput_metadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIGetPipelineOutput::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIGetPipelineOutput::is_metadata_Valid() const{
    return m_metadata_isValid;
}

bool OAIGetPipelineOutput::isSet() const {
...
bool OAIGetPipelineOutput::isValid() const {
