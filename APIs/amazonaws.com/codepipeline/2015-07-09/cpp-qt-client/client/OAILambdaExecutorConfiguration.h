...
/*
 * OAILambdaExecutorConfiguration.h
 *
 * Details about the configuration for the &lt;code&gt;Lambda&lt;/code&gt; action engine, or executor.
 */

#ifndef OAILambdaExecutorConfiguration_H
#define OAILambdaExecutorConfiguration_H
...
class OAILambdaExecutorConfiguration : public OAIObject {
public:
    OAILambdaExecutorConfiguration();
    OAILambdaExecutorConfiguration(QString json);
    ~OAILambdaExecutorConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaExecutorConfiguration)

#endif // OAILambdaExecutorConfiguration_H
