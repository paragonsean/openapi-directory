...
OAIStageState_latestExecution::OAIStageState_latestExecution(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStageState_latestExecution::OAIStageState_latestExecution() {
    this->initializeModel();
}

OAIStageState_latestExecution::~OAIStageState_latestExecution() {}

void OAIStageState_latestExecution::initializeModel() {
...
void OAIStageState_latestExecution::fromJson(QString jsonString) {
...
void OAIStageState_latestExecution::fromJsonObject(QJsonObject json) {
...
QString OAIStageState_latestExecution::asJson() const {
...
QJsonObject OAIStageState_latestExecution::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStageState_latestExecution::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIStageState_latestExecution::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIStageState_latestExecution::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIStageState_latestExecution::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

OAIStageExecutionStatus OAIStageState_latestExecution::getStatus() const {
    return m_status;
}
void OAIStageState_latestExecution::setStatus(const OAIStageExecutionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIStageState_latestExecution::is_status_Set() const{
    return m_status_isSet;
}

bool OAIStageState_latestExecution::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIStageState_latestExecution::isSet() const {
...
bool OAIStageState_latestExecution::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pipeline_execution_id_isValid && m_status_isValid && true;
}
