...
OAIPollForJobsOutput::OAIPollForJobsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPollForJobsOutput::OAIPollForJobsOutput() {
    this->initializeModel();
}

OAIPollForJobsOutput::~OAIPollForJobsOutput() {}

void OAIPollForJobsOutput::initializeModel() {

    m_jobs_isSet = false;
    m_jobs_isValid = false;
}

void OAIPollForJobsOutput::fromJson(QString jsonString) {
...
QJsonObject OAIPollForJobsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_jobs.isSet()) {
...
QList OAIPollForJobsOutput::getJobs() const {
    return m_jobs;
}
void OAIPollForJobsOutput::setJobs(const QList &jobs) {
    m_jobs = jobs;
    m_jobs_isSet = true;
}

bool OAIPollForJobsOutput::is_jobs_Set() const{
    return m_jobs_isSet;
}

bool OAIPollForJobsOutput::is_jobs_Valid() const{
    return m_jobs_isValid;
}

bool OAIPollForJobsOutput::isSet() const {
...
bool OAIPollForJobsOutput::isValid() const {
