...
/*
 * OAIPutThirdPartyJobSuccessResultInput_currentRevision.h
 *
 * 
 */

#ifndef OAIPutThirdPartyJobSuccessResultInput_currentRevision_H
#define OAIPutThirdPartyJobSuccessResultInput_currentRevision_H
...
class OAIPutThirdPartyJobSuccessResultInput_currentRevision : public OAIObject {
public:
    OAIPutThirdPartyJobSuccessResultInput_currentRevision();
    OAIPutThirdPartyJobSuccessResultInput_currentRevision(QString json);
    ~OAIPutThirdPartyJobSuccessResultInput_currentRevision() override;
    ...
    QString getChangeIdentifier() const;
    void setChangeIdentifier(const QString &change_identifier);
    bool is_change_identifier_Set() const;
    bool is_change_identifier_Valid() const;
    ...
    QString getRevisionSummary() const;
    void setRevisionSummary(const QString &revision_summary);
    bool is_revision_summary_Set() const;
    bool is_revision_summary_Valid() const;
...
private:
    ...
    QString m_change_identifier;
    bool m_change_identifier_isSet;
    bool m_change_identifier_isValid;

    QDateTime m_created;
    bool m_created_isSet;
    bool m_created_isValid;

    QString m_revision_summary;
    bool m_revision_summary_isSet;
    bool m_revision_summary_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutThirdPartyJobSuccessResultInput_currentRevision)

#endif // OAIPutThirdPartyJobSuccessResultInput_currentRevision_H
