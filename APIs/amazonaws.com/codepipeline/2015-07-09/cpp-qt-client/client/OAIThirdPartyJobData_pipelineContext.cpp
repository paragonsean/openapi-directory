...
#include "OAIThirdPartyJobData_pipelineContext.h"
...
OAIThirdPartyJobData_pipelineContext::OAIThirdPartyJobData_pipelineContext(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIThirdPartyJobData_pipelineContext::OAIThirdPartyJobData_pipelineContext() {
    this->initializeModel();
}

OAIThirdPartyJobData_pipelineContext::~OAIThirdPartyJobData_pipelineContext() {}

void OAIThirdPartyJobData_pipelineContext::initializeModel() {
...
void OAIThirdPartyJobData_pipelineContext::fromJson(QString jsonString) {
...
void OAIThirdPartyJobData_pipelineContext::fromJsonObject(QJsonObject json) {
...
QString OAIThirdPartyJobData_pipelineContext::asJson() const {
...
QJsonObject OAIThirdPartyJobData_pipelineContext::asJsonObject() const {
    QJsonObject obj;
...
QString OAIThirdPartyJobData_pipelineContext::getPipelineName() const {
    return m_pipeline_name;
}
void OAIThirdPartyJobData_pipelineContext::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIThirdPartyJobData_pipelineContext::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIThirdPartyJobData_pipelineContext::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

OAIPipelineContext_stage OAIThirdPartyJobData_pipelineContext::getStage() const {
    return m_stage;
}
void OAIThirdPartyJobData_pipelineContext::setStage(const OAIPipelineContext_stage &stage) {
    m_stage = stage;
    m_stage_isSet = true;
}

bool OAIThirdPartyJobData_pipelineContext::is_stage_Set() const{
    return m_stage_isSet;
}

bool OAIThirdPartyJobData_pipelineContext::is_stage_Valid() const{
    return m_stage_isValid;
}

OAIPipelineContext_action OAIThirdPartyJobData_pipelineContext::getAction() const {
    return m_action;
}
void OAIThirdPartyJobData_pipelineContext::setAction(const OAIPipelineContext_action &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIThirdPartyJobData_pipelineContext::is_action_Set() const{
    return m_action_isSet;
}

bool OAIThirdPartyJobData_pipelineContext::is_action_Valid() const{
    return m_action_isValid;
}

QString OAIThirdPartyJobData_pipelineContext::getPipelineArn() const {
    return m_pipeline_arn;
}
void OAIThirdPartyJobData_pipelineContext::setPipelineArn(const QString &pipeline_arn) {
    m_pipeline_arn = pipeline_arn;
    m_pipeline_arn_isSet = true;
}

bool OAIThirdPartyJobData_pipelineContext::is_pipeline_arn_Set() const{
    return m_pipeline_arn_isSet;
}

bool OAIThirdPartyJobData_pipelineContext::is_pipeline_arn_Valid() const{
    return m_pipeline_arn_isValid;
}

QString OAIThirdPartyJobData_pipelineContext::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIThirdPartyJobData_pipelineContext::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIThirdPartyJobData_pipelineContext::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIThirdPartyJobData_pipelineContext::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

bool OAIThirdPartyJobData_pipelineContext::isSet() const {
...
bool OAIThirdPartyJobData_pipelineContext::isValid() const {
