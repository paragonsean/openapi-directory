...
OAIJob_data::OAIJob_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJob_data::OAIJob_data() {
    this->initializeModel();
}

OAIJob_data::~OAIJob_data() {}

void OAIJob_data::initializeModel() {
...
void OAIJob_data::fromJson(QString jsonString) {
...
void OAIJob_data::fromJsonObject(QJsonObject json) {
...
QString OAIJob_data::asJson() const {
...
QJsonObject OAIJob_data::asJsonObject() const {
    QJsonObject obj;
...
OAIPollForJobsInput_actionTypeId OAIJob_data::getActionTypeId() const {
    return m_action_type_id;
}
void OAIJob_data::setActionTypeId(const OAIPollForJobsInput_actionTypeId &action_type_id) {
    m_action_type_id = action_type_id;
    m_action_type_id_isSet = true;
}

bool OAIJob_data::is_action_type_id_Set() const{
    return m_action_type_id_isSet;
}

bool OAIJob_data::is_action_type_id_Valid() const{
    return m_action_type_id_isValid;
}

OAIJobData_actionConfiguration OAIJob_data::getActionConfiguration() const {
    return m_action_configuration;
}
void OAIJob_data::setActionConfiguration(const OAIJobData_actionConfiguration &action_configuration) {
    m_action_configuration = action_configuration;
    m_action_configuration_isSet = true;
}

bool OAIJob_data::is_action_configuration_Set() const{
    return m_action_configuration_isSet;
}

bool OAIJob_data::is_action_configuration_Valid() const{
    return m_action_configuration_isValid;
}

OAIJobData_pipelineContext OAIJob_data::getPipelineContext() const {
    return m_pipeline_context;
}
void OAIJob_data::setPipelineContext(const OAIJobData_pipelineContext &pipeline_context) {
    m_pipeline_context = pipeline_context;
    m_pipeline_context_isSet = true;
}

bool OAIJob_data::is_pipeline_context_Set() const{
    return m_pipeline_context_isSet;
}

bool OAIJob_data::is_pipeline_context_Valid() const{
    return m_pipeline_context_isValid;
}

QList OAIJob_data::getInputArtifacts() const {
    return m_input_artifacts;
}
void OAIJob_data::setInputArtifacts(const QList &input_artifacts) {
    m_input_artifacts = input_artifacts;
    m_input_artifacts_isSet = true;
}

bool OAIJob_data::is_input_artifacts_Set() const{
    return m_input_artifacts_isSet;
}

bool OAIJob_data::is_input_artifacts_Valid() const{
    return m_input_artifacts_isValid;
}

QList OAIJob_data::getOutputArtifacts() const {
    return m_output_artifacts;
}
void OAIJob_data::setOutputArtifacts(const QList &output_artifacts) {
    m_output_artifacts = output_artifacts;
    m_output_artifacts_isSet = true;
}

bool OAIJob_data::is_output_artifacts_Set() const{
    return m_output_artifacts_isSet;
}

bool OAIJob_data::is_output_artifacts_Valid() const{
    return m_output_artifacts_isValid;
}

OAIJobData_artifactCredentials OAIJob_data::getArtifactCredentials() const {
    return m_artifact_credentials;
}
void OAIJob_data::setArtifactCredentials(const OAIJobData_artifactCredentials &artifact_credentials) {
    m_artifact_credentials = artifact_credentials;
    m_artifact_credentials_isSet = true;
}

bool OAIJob_data::is_artifact_credentials_Set() const{
    return m_artifact_credentials_isSet;
}

bool OAIJob_data::is_artifact_credentials_Valid() const{
    return m_artifact_credentials_isValid;
}

QString OAIJob_data::getContinuationToken() const {
    return m_continuation_token;
}
void OAIJob_data::setContinuationToken(const QString &continuation_token) {
    m_continuation_token = continuation_token;
    m_continuation_token_isSet = true;
}

bool OAIJob_data::is_continuation_token_Set() const{
    return m_continuation_token_isSet;
}

bool OAIJob_data::is_continuation_token_Valid() const{
    return m_continuation_token_isValid;
}

OAIJobData_encryptionKey OAIJob_data::getEncryptionKey() const {
    return m_encryption_key;
}
void OAIJob_data::setEncryptionKey(const OAIJobData_encryptionKey &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAIJob_data::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAIJob_data::is_encryption_key_Valid() const{
    return m_encryption_key_isValid;
}

bool OAIJob_data::isSet() const {
...
bool OAIJob_data::isValid() const {
