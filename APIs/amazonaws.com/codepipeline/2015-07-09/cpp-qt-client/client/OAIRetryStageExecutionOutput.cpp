...
OAIRetryStageExecutionOutput::OAIRetryStageExecutionOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRetryStageExecutionOutput::OAIRetryStageExecutionOutput() {
    this->initializeModel();
}

OAIRetryStageExecutionOutput::~OAIRetryStageExecutionOutput() {}

void OAIRetryStageExecutionOutput::initializeModel() {

    m_pipeline_execution_id_isSet = false;
    m_pipeline_execution_id_isValid = false;
}

void OAIRetryStageExecutionOutput::fromJson(QString jsonString) {
...
void OAIRetryStageExecutionOutput::fromJsonObject(QJsonObject json) {
...
QString OAIRetryStageExecutionOutput::asJson() const {
...
QJsonObject OAIRetryStageExecutionOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRetryStageExecutionOutput::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIRetryStageExecutionOutput::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIRetryStageExecutionOutput::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIRetryStageExecutionOutput::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

bool OAIRetryStageExecutionOutput::isSet() const {
...
bool OAIRetryStageExecutionOutput::isValid() const {
