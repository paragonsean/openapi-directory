...
/*
 * OAIRegisterWebhookWithThirdPartyInput.h
 *
 * 
 */

#ifndef OAIRegisterWebhookWithThirdPartyInput_H
#define OAIRegisterWebhookWithThirdPartyInput_H
...
class OAIRegisterWebhookWithThirdPartyInput : public OAIObject {
public:
    OAIRegisterWebhookWithThirdPartyInput();
    OAIRegisterWebhookWithThirdPartyInput(QString json);
    ~OAIRegisterWebhookWithThirdPartyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterWebhookWithThirdPartyInput)

#endif // OAIRegisterWebhookWithThirdPartyInput_H
