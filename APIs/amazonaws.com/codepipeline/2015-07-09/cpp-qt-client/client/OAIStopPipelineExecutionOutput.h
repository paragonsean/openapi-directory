...
/*
 * OAIStopPipelineExecutionOutput.h
 *
 * 
 */

#ifndef OAIStopPipelineExecutionOutput_H
#define OAIStopPipelineExecutionOutput_H
...
class OAIStopPipelineExecutionOutput : public OAIObject {
public:
    OAIStopPipelineExecutionOutput();
    OAIStopPipelineExecutionOutput(QString json);
    ~OAIStopPipelineExecutionOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopPipelineExecutionOutput)

#endif // OAIStopPipelineExecutionOutput_H
