...
#include "OAIPutWebhookInput_webhook.h"
...
OAIPutWebhookInput_webhook::OAIPutWebhookInput_webhook(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutWebhookInput_webhook::OAIPutWebhookInput_webhook() {
    this->initializeModel();
}

OAIPutWebhookInput_webhook::~OAIPutWebhookInput_webhook() {}

void OAIPutWebhookInput_webhook::initializeModel() {
...
void OAIPutWebhookInput_webhook::fromJson(QString jsonString) {
...
void OAIPutWebhookInput_webhook::fromJsonObject(QJsonObject json) {
...
QString OAIPutWebhookInput_webhook::asJson() const {
...
QJsonObject OAIPutWebhookInput_webhook::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIPutWebhookInput_webhook::getName() const {
    return m_name;
}
void OAIPutWebhookInput_webhook::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPutWebhookInput_webhook::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPutWebhookInput_webhook::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPutWebhookInput_webhook::getTargetPipeline() const {
    return m_target_pipeline;
}
void OAIPutWebhookInput_webhook::setTargetPipeline(const QString &target_pipeline) {
    m_target_pipeline = target_pipeline;
    m_target_pipeline_isSet = true;
}

bool OAIPutWebhookInput_webhook::is_target_pipeline_Set() const{
    return m_target_pipeline_isSet;
}

bool OAIPutWebhookInput_webhook::is_target_pipeline_Valid() const{
    return m_target_pipeline_isValid;
}

QString OAIPutWebhookInput_webhook::getTargetAction() const {
    return m_target_action;
}
void OAIPutWebhookInput_webhook::setTargetAction(const QString &target_action) {
    m_target_action = target_action;
    m_target_action_isSet = true;
}

bool OAIPutWebhookInput_webhook::is_target_action_Set() const{
    return m_target_action_isSet;
}

bool OAIPutWebhookInput_webhook::is_target_action_Valid() const{
    return m_target_action_isValid;
}

QList OAIPutWebhookInput_webhook::getFilters() const {
    return m_filters;
}
void OAIPutWebhookInput_webhook::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIPutWebhookInput_webhook::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIPutWebhookInput_webhook::is_filters_Valid() const{
    return m_filters_isValid;
}

OAIWebhookAuthenticationType OAIPutWebhookInput_webhook::getAuthentication() const {
    return m_authentication;
}
void OAIPutWebhookInput_webhook::setAuthentication(const OAIWebhookAuthenticationType &authentication) {
    m_authentication = authentication;
    m_authentication_isSet = true;
}

bool OAIPutWebhookInput_webhook::is_authentication_Set() const{
    return m_authentication_isSet;
}

bool OAIPutWebhookInput_webhook::is_authentication_Valid() const{
    return m_authentication_isValid;
}

OAIWebhookDefinition_authenticationConfiguration OAIPutWebhookInput_webhook::getAuthenticationConfiguration() const {
    return m_authentication_configuration;
}
void OAIPutWebhookInput_webhook::setAuthenticationConfiguration(const OAIWebhookDefinition_authenticationConfiguration &authentication_configuration) {
    m_authentication_configuration = authentication_configuration;
    m_authentication_configuration_isSet = true;
}

bool OAIPutWebhookInput_webhook::is_authentication_configuration_Set() const{
    return m_authentication_configuration_isSet;
}

bool OAIPutWebhookInput_webhook::is_authentication_configuration_Valid() const{
    return m_authentication_configuration_isValid;
}

bool OAIPutWebhookInput_webhook::isSet() const {
...
bool OAIPutWebhookInput_webhook::isValid() const {
