...
/*
 * OAIGetActionTypeInput.h
 *
 * 
 */

#ifndef OAIGetActionTypeInput_H
#define OAIGetActionTypeInput_H
...
class OAIGetActionTypeInput : public OAIObject {
public:
    OAIGetActionTypeInput();
    OAIGetActionTypeInput(QString json);
    ~OAIGetActionTypeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetActionTypeInput)

#endif // OAIGetActionTypeInput_H
