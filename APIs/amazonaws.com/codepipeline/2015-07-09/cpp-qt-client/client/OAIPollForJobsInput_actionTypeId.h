...
/*
 * OAIPollForJobsInput_actionTypeId.h
 *
 * 
 */

#ifndef OAIPollForJobsInput_actionTypeId_H
#define OAIPollForJobsInput_actionTypeId_H
...
class OAIPollForJobsInput_actionTypeId : public OAIObject {
public:
    OAIPollForJobsInput_actionTypeId();
    OAIPollForJobsInput_actionTypeId(QString json);
    ~OAIPollForJobsInput_actionTypeId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPollForJobsInput_actionTypeId)

#endif // OAIPollForJobsInput_actionTypeId_H
