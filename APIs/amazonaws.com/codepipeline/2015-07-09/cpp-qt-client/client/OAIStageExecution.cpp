...
OAIStageExecution::OAIStageExecution(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStageExecution::OAIStageExecution() {
    this->initializeModel();
}

OAIStageExecution::~OAIStageExecution() {}

void OAIStageExecution::initializeModel() {
...
void OAIStageExecution::fromJson(QString jsonString) {
...
void OAIStageExecution::fromJsonObject(QJsonObject json) {
...
QString OAIStageExecution::asJson() const {
...
QJsonObject OAIStageExecution::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStageExecution::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIStageExecution::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIStageExecution::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIStageExecution::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

OAIStageExecutionStatus OAIStageExecution::getStatus() const {
    return m_status;
}
void OAIStageExecution::setStatus(const OAIStageExecutionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIStageExecution::is_status_Set() const{
    return m_status_isSet;
}

bool OAIStageExecution::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIStageExecution::isSet() const {
...
bool OAIStageExecution::isValid() const {
