...
/*
 * OAICreateCustomActionTypeInput_settings.h
 *
 * 
 */

#ifndef OAICreateCustomActionTypeInput_settings_H
#define OAICreateCustomActionTypeInput_settings_H
...
class OAICreateCustomActionTypeInput_settings : public OAIObject {
public:
    OAICreateCustomActionTypeInput_settings();
    OAICreateCustomActionTypeInput_settings(QString json);
    ~OAICreateCustomActionTypeInput_settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomActionTypeInput_settings)

#endif // OAICreateCustomActionTypeInput_settings_H
