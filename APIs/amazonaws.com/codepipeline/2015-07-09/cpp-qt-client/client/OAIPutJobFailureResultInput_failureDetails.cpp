...
#include "OAIPutJobFailureResultInput_failureDetails.h"
...
OAIPutJobFailureResultInput_failureDetails::OAIPutJobFailureResultInput_failureDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutJobFailureResultInput_failureDetails::OAIPutJobFailureResultInput_failureDetails() {
    this->initializeModel();
}

OAIPutJobFailureResultInput_failureDetails::~OAIPutJobFailureResultInput_failureDetails() {}

void OAIPutJobFailureResultInput_failureDetails::initializeModel() {
...
void OAIPutJobFailureResultInput_failureDetails::fromJson(QString jsonString) {
...
void OAIPutJobFailureResultInput_failureDetails::fromJsonObject(QJsonObject json) {
...
QString OAIPutJobFailureResultInput_failureDetails::asJson() const {
...
QJsonObject OAIPutJobFailureResultInput_failureDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIFailureType OAIPutJobFailureResultInput_failureDetails::getType() const {
    return m_type;
}
void OAIPutJobFailureResultInput_failureDetails::setType(const OAIFailureType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPutJobFailureResultInput_failureDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPutJobFailureResultInput_failureDetails::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIPutJobFailureResultInput_failureDetails::getMessage() const {
    return m_message;
}
void OAIPutJobFailureResultInput_failureDetails::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIPutJobFailureResultInput_failureDetails::is_message_Set() const{
    return m_message_isSet;
}

bool OAIPutJobFailureResultInput_failureDetails::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIPutJobFailureResultInput_failureDetails::getExternalExecutionId() const {
    return m_external_execution_id;
}
void OAIPutJobFailureResultInput_failureDetails::setExternalExecutionId(const QString &external_execution_id) {
    m_external_execution_id = external_execution_id;
    m_external_execution_id_isSet = true;
}

bool OAIPutJobFailureResultInput_failureDetails::is_external_execution_id_Set() const{
    return m_external_execution_id_isSet;
}

bool OAIPutJobFailureResultInput_failureDetails::is_external_execution_id_Valid() const{
    return m_external_execution_id_isValid;
}

bool OAIPutJobFailureResultInput_failureDetails::isSet() const {
...
bool OAIPutJobFailureResultInput_failureDetails::isValid() const {
