...
OAIGetPipelineInput::OAIGetPipelineInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPipelineInput::OAIGetPipelineInput() {
    this->initializeModel();
}

OAIGetPipelineInput::~OAIGetPipelineInput() {}

void OAIGetPipelineInput::initializeModel() {
...
void OAIGetPipelineInput::fromJson(QString jsonString) {
...
void OAIGetPipelineInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPipelineInput::asJson() const {
...
QJsonObject OAIGetPipelineInput::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIGetPipelineInput::getName() const {
    return m_name;
}
void OAIGetPipelineInput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetPipelineInput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetPipelineInput::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIGetPipelineInput::getVersion() const {
    return m_version;
}
void OAIGetPipelineInput::setVersion(const qint32 &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIGetPipelineInput::is_version_Set() const{
    return m_version_isSet;
}

bool OAIGetPipelineInput::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIGetPipelineInput::isSet() const {
...
bool OAIGetPipelineInput::isValid() const {
