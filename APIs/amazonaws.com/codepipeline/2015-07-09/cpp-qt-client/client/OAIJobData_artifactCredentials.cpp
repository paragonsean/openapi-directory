...
OAIJobData_artifactCredentials::OAIJobData_artifactCredentials(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJobData_artifactCredentials::OAIJobData_artifactCredentials() {
    this->initializeModel();
}

OAIJobData_artifactCredentials::~OAIJobData_artifactCredentials() {}

void OAIJobData_artifactCredentials::initializeModel() {
...
void OAIJobData_artifactCredentials::fromJson(QString jsonString) {
...
void OAIJobData_artifactCredentials::fromJsonObject(QJsonObject json) {
...
QString OAIJobData_artifactCredentials::asJson() const {
...
QJsonObject OAIJobData_artifactCredentials::asJsonObject() const {
    QJsonObject obj;
...
QString OAIJobData_artifactCredentials::getAccessKeyId() const {
    return m_access_key_id;
}
void OAIJobData_artifactCredentials::setAccessKeyId(const QString &access_key_id) {
    m_access_key_id = access_key_id;
    m_access_key_id_isSet = true;
}

bool OAIJobData_artifactCredentials::is_access_key_id_Set() const{
    return m_access_key_id_isSet;
}

bool OAIJobData_artifactCredentials::is_access_key_id_Valid() const{
    return m_access_key_id_isValid;
}

QString OAIJobData_artifactCredentials::getSecretAccessKey() const {
    return m_secret_access_key;
}
void OAIJobData_artifactCredentials::setSecretAccessKey(const QString &secret_access_key) {
    m_secret_access_key = secret_access_key;
    m_secret_access_key_isSet = true;
}

bool OAIJobData_artifactCredentials::is_secret_access_key_Set() const{
    return m_secret_access_key_isSet;
}

bool OAIJobData_artifactCredentials::is_secret_access_key_Valid() const{
    return m_secret_access_key_isValid;
}

QString OAIJobData_artifactCredentials::getSessionToken() const {
    return m_session_token;
}
void OAIJobData_artifactCredentials::setSessionToken(const QString &session_token) {
    m_session_token = session_token;
    m_session_token_isSet = true;
}

bool OAIJobData_artifactCredentials::is_session_token_Set() const{
    return m_session_token_isSet;
}

bool OAIJobData_artifactCredentials::is_session_token_Valid() const{
    return m_session_token_isValid;
}

bool OAIJobData_artifactCredentials::isSet() const {
...
bool OAIJobData_artifactCredentials::isValid() const {
