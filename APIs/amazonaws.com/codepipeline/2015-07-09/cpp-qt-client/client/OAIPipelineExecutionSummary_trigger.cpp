...
#include "OAIPipelineExecutionSummary_trigger.h"
...
OAIPipelineExecutionSummary_trigger::OAIPipelineExecutionSummary_trigger(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPipelineExecutionSummary_trigger::OAIPipelineExecutionSummary_trigger() {
    this->initializeModel();
}

OAIPipelineExecutionSummary_trigger::~OAIPipelineExecutionSummary_trigger() {}

void OAIPipelineExecutionSummary_trigger::initializeModel() {

    m_trigger_type_isSet = false;
    m_trigger_type_isValid = false;

    m_trigger_detail_isSet = false;
    m_trigger_detail_isValid = false;
}

void OAIPipelineExecutionSummary_trigger::fromJson(QString jsonString) {
...
void OAIPipelineExecutionSummary_trigger::fromJsonObject(QJsonObject json) {
    ...
    m_trigger_detail_isValid = ::OpenAPI::fromJsonValue(m_trigger_detail, json[QString("triggerDetail")]);
    m_trigger_detail_isSet = !json[QString("triggerDetail")].isNull() && m_trigger_detail_isValid;
}

QString OAIPipelineExecutionSummary_trigger::asJson() const {
...
QJsonObject OAIPipelineExecutionSummary_trigger::asJsonObject() const {
    QJsonObject obj;
    if (m_trigger_type.isSet()) {
        obj.insert(QString("triggerType"), ::OpenAPI::toJsonValue(m_trigger_type));
    }
    if (m_trigger_detail_isSet) {
        obj.insert(QString("triggerDetail"), ::OpenAPI::toJsonValue(m_trigger_detail));
    }
    return obj;
}

OAITriggerType OAIPipelineExecutionSummary_trigger::getTriggerType() const {
    return m_trigger_type;
}
void OAIPipelineExecutionSummary_trigger::setTriggerType(const OAITriggerType &trigger_type) {
    m_trigger_type = trigger_type;
    m_trigger_type_isSet = true;
}

bool OAIPipelineExecutionSummary_trigger::is_trigger_type_Set() const{
    return m_trigger_type_isSet;
}

bool OAIPipelineExecutionSummary_trigger::is_trigger_type_Valid() const{
    return m_trigger_type_isValid;
}

QString OAIPipelineExecutionSummary_trigger::getTriggerDetail() const {
    return m_trigger_detail;
}
void OAIPipelineExecutionSummary_trigger::setTriggerDetail(const QString &trigger_detail) {
    m_trigger_detail = trigger_detail;
    m_trigger_detail_isSet = true;
}

bool OAIPipelineExecutionSummary_trigger::is_trigger_detail_Set() const{
    return m_trigger_detail_isSet;
}

bool OAIPipelineExecutionSummary_trigger::is_trigger_detail_Valid() const{
    return m_trigger_detail_isValid;
}

bool OAIPipelineExecutionSummary_trigger::isSet() const {
...
bool OAIPipelineExecutionSummary_trigger::isValid() const {
