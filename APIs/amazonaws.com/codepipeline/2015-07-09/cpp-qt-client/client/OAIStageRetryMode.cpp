...
OAIStageRetryMode::OAIStageRetryMode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStageRetryMode::OAIStageRetryMode() {
    this->initializeModel();
}

OAIStageRetryMode::~OAIStageRetryMode() {}

void OAIStageRetryMode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIStageRetryMode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIStageRetryMode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FAILED_ACTIONS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStageRetryMode::FAILED_ACTIONS;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIStageRetryMode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIStageRetryMode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIStageRetryMode::FAILED_ACTIONS:
            val = "FAILED_ACTIONS";
            break;
        default:
            break;
...
QJsonValue OAIStageRetryMode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIStageRetryMode::eOAIStageRetryMode OAIStageRetryMode::getValue() const {
    return m_value;
}

void OAIStageRetryMode::setValue(const OAIStageRetryMode::eOAIStageRetryMode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIStageRetryMode::isSet() const {
    
    return m_value_isSet;
}

bool OAIStageRetryMode::isValid() const {
