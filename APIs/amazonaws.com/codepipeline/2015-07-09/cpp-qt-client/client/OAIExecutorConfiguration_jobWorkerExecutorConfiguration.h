...
/*
 * OAIExecutorConfiguration_jobWorkerExecutorConfiguration.h
 *
 * 
 */

#ifndef OAIExecutorConfiguration_jobWorkerExecutorConfiguration_H
#define OAIExecutorConfiguration_jobWorkerExecutorConfiguration_H
...
class OAIExecutorConfiguration_jobWorkerExecutorConfiguration : public OAIObject {
public:
    OAIExecutorConfiguration_jobWorkerExecutorConfiguration();
    OAIExecutorConfiguration_jobWorkerExecutorConfiguration(QString json);
    ~OAIExecutorConfiguration_jobWorkerExecutorConfiguration() override;
    ...
    QList getPollingAccounts() const;
    void setPollingAccounts(const QList &polling_accounts);
    bool is_polling_accounts_Set() const;
    bool is_polling_accounts_Valid() const;

    QList getPollingServicePrincipals() const;
    void setPollingServicePrincipals(const QList &polling_service_principals);
    bool is_polling_service_principals_Set() const;
    bool is_polling_service_principals_Valid() const;
...
private:
    ...
    QList m_polling_accounts;
    bool m_polling_accounts_isSet;
    bool m_polling_accounts_isValid;

    QList m_polling_service_principals;
    bool m_polling_service_principals_isSet;
    bool m_polling_service_principals_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIExecutorConfiguration_jobWorkerExecutorConfiguration)

#endif // OAIExecutorConfiguration_jobWorkerExecutorConfiguration_H
