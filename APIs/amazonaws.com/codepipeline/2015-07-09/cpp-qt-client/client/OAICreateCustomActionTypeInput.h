...
/*
 * OAICreateCustomActionTypeInput.h
 *
 * Represents the input of a CreateCustomActionType operation.
 */

#ifndef OAICreateCustomActionTypeInput_H
#define OAICreateCustomActionTypeInput_H
...
namespace OpenAPI {
class OAICreateCustomActionTypeInput_settings;
class OAICreateCustomActionTypeInput_inputArtifactDetails;
class OAICreateCustomActionTypeInput_outputArtifactDetails;

class OAICreateCustomActionTypeInput : public OAIObject {
public:
    OAICreateCustomActionTypeInput();
    OAICreateCustomActionTypeInput(QString json);
    ~OAICreateCustomActionTypeInput() override;
    ...
    OAICreateCustomActionTypeInput_settings getSettings() const;
    void setSettings(const OAICreateCustomActionTypeInput_settings &settings);
...
private:
    ...
    OAICreateCustomActionTypeInput_settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomActionTypeInput)

#endif // OAICreateCustomActionTypeInput_H
