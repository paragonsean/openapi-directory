...
/*
 * OAIJobWorkerExecutorConfiguration.h
 *
 * Details about the polling configuration for the &lt;code&gt;JobWorker&lt;/code&gt; action engine, or executor.
 */

#ifndef OAIJobWorkerExecutorConfiguration_H
#define OAIJobWorkerExecutorConfiguration_H
...
class OAIJobWorkerExecutorConfiguration : public OAIObject {
public:
    OAIJobWorkerExecutorConfiguration();
    OAIJobWorkerExecutorConfiguration(QString json);
    ~OAIJobWorkerExecutorConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobWorkerExecutorConfiguration)

#endif // OAIJobWorkerExecutorConfiguration_H
