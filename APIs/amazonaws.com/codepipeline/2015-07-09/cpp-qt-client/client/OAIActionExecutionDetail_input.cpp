...
OAIActionExecutionDetail_input::OAIActionExecutionDetail_input(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionExecutionDetail_input::OAIActionExecutionDetail_input() {
    this->initializeModel();
}

OAIActionExecutionDetail_input::~OAIActionExecutionDetail_input() {}

void OAIActionExecutionDetail_input::initializeModel() {
...
void OAIActionExecutionDetail_input::fromJson(QString jsonString) {
...
void OAIActionExecutionDetail_input::fromJsonObject(QJsonObject json) {
...
QString OAIActionExecutionDetail_input::asJson() const {
...
QJsonObject OAIActionExecutionDetail_input::asJsonObject() const {
    QJsonObject obj;
...
OAIActionTypeId OAIActionExecutionDetail_input::getActionTypeId() const {
    return m_action_type_id;
}
void OAIActionExecutionDetail_input::setActionTypeId(const OAIActionTypeId &action_type_id) {
    m_action_type_id = action_type_id;
    m_action_type_id_isSet = true;
}

bool OAIActionExecutionDetail_input::is_action_type_id_Set() const{
    return m_action_type_id_isSet;
}

bool OAIActionExecutionDetail_input::is_action_type_id_Valid() const{
    return m_action_type_id_isValid;
}

QMap OAIActionExecutionDetail_input::getConfiguration() const {
    return m_configuration;
}
void OAIActionExecutionDetail_input::setConfiguration(const QMap &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAIActionExecutionDetail_input::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAIActionExecutionDetail_input::is_configuration_Valid() const{
    return m_configuration_isValid;
}

QMap OAIActionExecutionDetail_input::getResolvedConfiguration() const {
    return m_resolved_configuration;
}
void OAIActionExecutionDetail_input::setResolvedConfiguration(const QMap &resolved_configuration) {
    m_resolved_configuration = resolved_configuration;
    m_resolved_configuration_isSet = true;
}

bool OAIActionExecutionDetail_input::is_resolved_configuration_Set() const{
    return m_resolved_configuration_isSet;
}

bool OAIActionExecutionDetail_input::is_resolved_configuration_Valid() const{
    return m_resolved_configuration_isValid;
}

QString OAIActionExecutionDetail_input::getRoleArn() const {
    return m_role_arn;
}
void OAIActionExecutionDetail_input::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIActionExecutionDetail_input::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIActionExecutionDetail_input::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAIActionExecutionDetail_input::getRegion() const {
    return m_region;
}
void OAIActionExecutionDetail_input::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIActionExecutionDetail_input::is_region_Set() const{
    return m_region_isSet;
}

bool OAIActionExecutionDetail_input::is_region_Valid() const{
    return m_region_isValid;
}

QList OAIActionExecutionDetail_input::getInputArtifacts() const {
    return m_input_artifacts;
}
void OAIActionExecutionDetail_input::setInputArtifacts(const QList &input_artifacts) {
    m_input_artifacts = input_artifacts;
    m_input_artifacts_isSet = true;
}

bool OAIActionExecutionDetail_input::is_input_artifacts_Set() const{
    return m_input_artifacts_isSet;
}

bool OAIActionExecutionDetail_input::is_input_artifacts_Valid() const{
    return m_input_artifacts_isValid;
}

QString OAIActionExecutionDetail_input::getRNamespace() const {
    return m_r_namespace;
}
void OAIActionExecutionDetail_input::setRNamespace(const QString &r_namespace) {
    m_r_namespace = r_namespace;
    m_r_namespace_isSet = true;
}

bool OAIActionExecutionDetail_input::is_r_namespace_Set() const{
    return m_r_namespace_isSet;
}

bool OAIActionExecutionDetail_input::is_r_namespace_Valid() const{
    return m_r_namespace_isValid;
}

bool OAIActionExecutionDetail_input::isSet() const {
...
bool OAIActionExecutionDetail_input::isValid() const {
