...
/*
 * OAIListActionExecutionsOutput.h
 *
 * 
 */

#ifndef OAIListActionExecutionsOutput_H
#define OAIListActionExecutionsOutput_H
...
class OAIListActionExecutionsOutput : public OAIObject {
public:
    OAIListActionExecutionsOutput();
    OAIListActionExecutionsOutput(QString json);
    ~OAIListActionExecutionsOutput() override;
    ...
    QList getActionExecutionDetails() const;
    void setActionExecutionDetails(const QList &action_execution_details);
    bool is_action_execution_details_Set() const;
    bool is_action_execution_details_Valid() const;
...
private:
    ...
    QList m_action_execution_details;
    bool m_action_execution_details_isSet;
    bool m_action_execution_details_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListActionExecutionsOutput)

#endif // OAIListActionExecutionsOutput_H
