...
/*
 * OAIActionTypeArtifactDetails.h
 *
 * Information about parameters for artifacts associated with the action type, such as the minimum and maximum artifacts allowed.
 */

#ifndef OAIActionTypeArtifactDetails_H
#define OAIActionTypeArtifactDetails_H
...
class OAIActionTypeArtifactDetails : public OAIObject {
public:
    OAIActionTypeArtifactDetails();
    OAIActionTypeArtifactDetails(QString json);
    ~OAIActionTypeArtifactDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeArtifactDetails)

#endif // OAIActionTypeArtifactDetails_H
