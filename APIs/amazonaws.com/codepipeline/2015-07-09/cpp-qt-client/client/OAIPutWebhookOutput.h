...
/*
 * OAIPutWebhookOutput.h
 *
 * 
 */

#ifndef OAIPutWebhookOutput_H
#define OAIPutWebhookOutput_H
...
namespace OpenAPI {
class OAIPutWebhookOutput_webhook;

class OAIPutWebhookOutput : public OAIObject {
public:
    OAIPutWebhookOutput();
    OAIPutWebhookOutput(QString json);
    ~OAIPutWebhookOutput() override;
    ...
    OAIPutWebhookOutput_webhook getWebhook() const;
    void setWebhook(const OAIPutWebhookOutput_webhook &webhook);
...
private:
    ...
    OAIPutWebhookOutput_webhook m_webhook;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutWebhookOutput)

#endif // OAIPutWebhookOutput_H
