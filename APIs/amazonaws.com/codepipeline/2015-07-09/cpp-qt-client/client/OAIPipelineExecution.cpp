...
QString OAIPipelineExecution::getPipelineName() const {
    return m_pipeline_name;
}
void OAIPipelineExecution::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIPipelineExecution::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIPipelineExecution::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

qint32 OAIPipelineExecution::getPipelineVersion() const {
    return m_pipeline_version;
}
void OAIPipelineExecution::setPipelineVersion(const qint32 &pipeline_version) {
    m_pipeline_version = pipeline_version;
    m_pipeline_version_isSet = true;
}

bool OAIPipelineExecution::is_pipeline_version_Set() const{
    return m_pipeline_version_isSet;
}

bool OAIPipelineExecution::is_pipeline_version_Valid() const{
    return m_pipeline_version_isValid;
}

QString OAIPipelineExecution::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIPipelineExecution::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIPipelineExecution::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIPipelineExecution::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

OAIPipelineExecutionStatus OAIPipelineExecution::getStatus() const {
    return m_status;
}
void OAIPipelineExecution::setStatus(const OAIPipelineExecutionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPipelineExecution::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPipelineExecution::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIPipelineExecution::getStatusSummary() const {
    return m_status_summary;
}
void OAIPipelineExecution::setStatusSummary(const QString &status_summary) {
    m_status_summary = status_summary;
    m_status_summary_isSet = true;
}

bool OAIPipelineExecution::is_status_summary_Set() const{
    return m_status_summary_isSet;
}

bool OAIPipelineExecution::is_status_summary_Valid() const{
    return m_status_summary_isValid;
}

QList OAIPipelineExecution::getArtifactRevisions() const {
    return m_artifact_revisions;
}
void OAIPipelineExecution::setArtifactRevisions(const QList &artifact_revisions) {
    m_artifact_revisions = artifact_revisions;
    m_artifact_revisions_isSet = true;
}

bool OAIPipelineExecution::is_artifact_revisions_Set() const{
    return m_artifact_revisions_isSet;
}

bool OAIPipelineExecution::is_artifact_revisions_Valid() const{
