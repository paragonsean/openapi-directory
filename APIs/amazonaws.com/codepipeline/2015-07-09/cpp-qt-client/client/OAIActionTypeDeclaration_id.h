...
/*
 * OAIActionTypeDeclaration_id.h
 *
 * 
 */

#ifndef OAIActionTypeDeclaration_id_H
#define OAIActionTypeDeclaration_id_H
...
class OAIActionTypeDeclaration_id : public OAIObject {
public:
    OAIActionTypeDeclaration_id();
    OAIActionTypeDeclaration_id(QString json);
    ~OAIActionTypeDeclaration_id() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeDeclaration_id)

#endif // OAIActionTypeDeclaration_id_H
