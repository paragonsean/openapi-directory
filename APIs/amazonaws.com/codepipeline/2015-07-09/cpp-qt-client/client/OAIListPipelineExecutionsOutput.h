...
/*
 * OAIListPipelineExecutionsOutput.h
 *
 * Represents the output of a &lt;code&gt;ListPipelineExecutions&lt;/code&gt; action.
 */

#ifndef OAIListPipelineExecutionsOutput_H
#define OAIListPipelineExecutionsOutput_H
...
class OAIListPipelineExecutionsOutput : public OAIObject {
public:
    OAIListPipelineExecutionsOutput();
    OAIListPipelineExecutionsOutput(QString json);
    ~OAIListPipelineExecutionsOutput() override;
    ...
    QList getPipelineExecutionSummaries() const;
    void setPipelineExecutionSummaries(const QList &pipeline_execution_summaries);
    bool is_pipeline_execution_summaries_Set() const;
    bool is_pipeline_execution_summaries_Valid() const;
...
private:
    ...
    QList m_pipeline_execution_summaries;
    bool m_pipeline_execution_summaries_isSet;
    bool m_pipeline_execution_summaries_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPipelineExecutionsOutput)

#endif // OAIListPipelineExecutionsOutput_H
