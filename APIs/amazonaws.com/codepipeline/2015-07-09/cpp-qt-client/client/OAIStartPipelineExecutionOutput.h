...
/*
 * OAIStartPipelineExecutionOutput.h
 *
 * Represents the output of a &lt;code&gt;StartPipelineExecution&lt;/code&gt; action.
 */

#ifndef OAIStartPipelineExecutionOutput_H
#define OAIStartPipelineExecutionOutput_H
...
class OAIStartPipelineExecutionOutput : public OAIObject {
public:
    OAIStartPipelineExecutionOutput();
    OAIStartPipelineExecutionOutput(QString json);
    ~OAIStartPipelineExecutionOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartPipelineExecutionOutput)

#endif // OAIStartPipelineExecutionOutput_H
