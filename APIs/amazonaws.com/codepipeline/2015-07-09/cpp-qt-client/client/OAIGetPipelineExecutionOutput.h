...
/*
 * OAIGetPipelineExecutionOutput.h
 *
 * Represents the output of a &lt;code&gt;GetPipelineExecution&lt;/code&gt; action.
 */

#ifndef OAIGetPipelineExecutionOutput_H
#define OAIGetPipelineExecutionOutput_H
...
namespace OpenAPI {
class OAIGetPipelineExecutionOutput_pipelineExecution;

class OAIGetPipelineExecutionOutput : public OAIObject {
public:
    OAIGetPipelineExecutionOutput();
    OAIGetPipelineExecutionOutput(QString json);
    ~OAIGetPipelineExecutionOutput() override;
    ...
    OAIGetPipelineExecutionOutput_pipelineExecution getPipelineExecution() const;
    void setPipelineExecution(const OAIGetPipelineExecutionOutput_pipelineExecution &pipeline_execution);
...
private:
    ...
    OAIGetPipelineExecutionOutput_pipelineExecution m_pipeline_execution;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPipelineExecutionOutput)

#endif // OAIGetPipelineExecutionOutput_H
