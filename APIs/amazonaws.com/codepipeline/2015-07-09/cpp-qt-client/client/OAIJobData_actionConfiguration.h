...
/*
 * OAIJobData_actionConfiguration.h
 *
 * 
 */

#ifndef OAIJobData_actionConfiguration_H
#define OAIJobData_actionConfiguration_H
...
class OAIJobData_actionConfiguration : public OAIObject {
public:
    OAIJobData_actionConfiguration();
    OAIJobData_actionConfiguration(QString json);
    ~OAIJobData_actionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobData_actionConfiguration)

#endif // OAIJobData_actionConfiguration_H
