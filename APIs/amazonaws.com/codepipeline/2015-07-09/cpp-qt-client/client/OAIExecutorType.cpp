...
OAIExecutorType::OAIExecutorType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExecutorType::OAIExecutorType() {
    this->initializeModel();
}

OAIExecutorType::~OAIExecutorType() {}

void OAIExecutorType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIExecutorType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIExecutorType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("JobWorker", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExecutorType::JOBWORKER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Lambda", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExecutorType::LAMBDA;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIExecutorType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIExecutorType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIExecutorType::JOBWORKER:
            val = "JobWorker";
            break;
        case eOAIExecutorType::LAMBDA:
            val = "Lambda";
            break;
        default:
            break;
...
QJsonValue OAIExecutorType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIExecutorType::eOAIExecutorType OAIExecutorType::getValue() const {
    return m_value;
}

void OAIExecutorType::setValue(const OAIExecutorType::eOAIExecutorType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIExecutorType::isSet() const {
    
    return m_value_isSet;
}

bool OAIExecutorType::isValid() const {
