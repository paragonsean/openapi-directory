...
OAIEnableStageTransitionInput::OAIEnableStageTransitionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnableStageTransitionInput::OAIEnableStageTransitionInput() {
    this->initializeModel();
}

OAIEnableStageTransitionInput::~OAIEnableStageTransitionInput() {}

void OAIEnableStageTransitionInput::initializeModel() {
...
void OAIEnableStageTransitionInput::fromJson(QString jsonString) {
...
void OAIEnableStageTransitionInput::fromJsonObject(QJsonObject json) {
...
QString OAIEnableStageTransitionInput::asJson() const {
...
QJsonObject OAIEnableStageTransitionInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEnableStageTransitionInput::getPipelineName() const {
    return m_pipeline_name;
}
void OAIEnableStageTransitionInput::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIEnableStageTransitionInput::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIEnableStageTransitionInput::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

QString OAIEnableStageTransitionInput::getStageName() const {
    return m_stage_name;
}
void OAIEnableStageTransitionInput::setStageName(const QString &stage_name) {
    m_stage_name = stage_name;
    m_stage_name_isSet = true;
}

bool OAIEnableStageTransitionInput::is_stage_name_Set() const{
    return m_stage_name_isSet;
}

bool OAIEnableStageTransitionInput::is_stage_name_Valid() const{
    return m_stage_name_isValid;
}

OAIStageTransitionType OAIEnableStageTransitionInput::getTransitionType() const {
    return m_transition_type;
}
void OAIEnableStageTransitionInput::setTransitionType(const OAIStageTransitionType &transition_type) {
    m_transition_type = transition_type;
    m_transition_type_isSet = true;
}

bool OAIEnableStageTransitionInput::is_transition_type_Set() const{
    return m_transition_type_isSet;
}

bool OAIEnableStageTransitionInput::is_transition_type_Valid() const{
    return m_transition_type_isValid;
}

bool OAIEnableStageTransitionInput::isSet() const {
...
bool OAIEnableStageTransitionInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pipeline_name_isValid && m_stage_name_isValid && m_transition_type_isValid && true;
}
