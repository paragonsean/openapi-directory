...
/*
 * OAIGetPipelineExecutionInput.h
 *
 * Represents the input of a &lt;code&gt;GetPipelineExecution&lt;/code&gt; action.
 */

#ifndef OAIGetPipelineExecutionInput_H
#define OAIGetPipelineExecutionInput_H
...
class OAIGetPipelineExecutionInput : public OAIObject {
public:
    OAIGetPipelineExecutionInput();
    OAIGetPipelineExecutionInput(QString json);
    ~OAIGetPipelineExecutionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPipelineExecutionInput)

#endif // OAIGetPipelineExecutionInput_H
