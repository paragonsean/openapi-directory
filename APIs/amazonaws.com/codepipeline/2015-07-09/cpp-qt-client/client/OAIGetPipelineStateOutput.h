...
/*
 * OAIGetPipelineStateOutput.h
 *
 * Represents the output of a &lt;code&gt;GetPipelineState&lt;/code&gt; action.
 */

#ifndef OAIGetPipelineStateOutput_H
#define OAIGetPipelineStateOutput_H
...
class OAIGetPipelineStateOutput : public OAIObject {
public:
    OAIGetPipelineStateOutput();
    OAIGetPipelineStateOutput(QString json);
    ~OAIGetPipelineStateOutput() override;
    ...
    QList getStageStates() const;
    void setStageStates(const QList &stage_states);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPipelineStateOutput)

#endif // OAIGetPipelineStateOutput_H
