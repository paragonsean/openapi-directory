...
/*
 * OAIListWebhooksOutput.h
 *
 * 
 */

#ifndef OAIListWebhooksOutput_H
#define OAIListWebhooksOutput_H
...
class OAIListWebhooksOutput : public OAIObject {
public:
    OAIListWebhooksOutput();
    OAIListWebhooksOutput(QString json);
    ~OAIListWebhooksOutput() override;
    ...
    QList getWebhooks() const;
    void setWebhooks(const QList &webhooks);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListWebhooksOutput)

#endif // OAIListWebhooksOutput_H
