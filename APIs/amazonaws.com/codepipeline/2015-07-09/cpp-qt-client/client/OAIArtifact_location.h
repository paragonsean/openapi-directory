...
/*
 * OAIArtifact_location.h
 *
 * 
 */

#ifndef OAIArtifact_location_H
#define OAIArtifact_location_H

#include <QJsonObject>

#include "OAIArtifactLocationType.h"
#include "OAIArtifactLocation_s3Location.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIArtifactLocation_s3Location;

class OAIArtifact_location : public OAIObject {
public:
    OAIArtifact_location();
    OAIArtifact_location(QString json);
    ~OAIArtifact_location() override;
    ...
    OAIArtifactLocationType getType() const;
    void setType(const OAIArtifactLocationType &type);
    bool is_type_Set() const;
    bool is_type_Valid() const;

    OAIArtifactLocation_s3Location getS3Location() const;
    void setS3Location(const OAIArtifactLocation_s3Location &s3_location);
...
private:
    ...
    OAIArtifactLocationType m_type;
    bool m_type_isSet;
    bool m_type_isValid;

    OAIArtifactLocation_s3Location m_s3_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifact_location)

#endif // OAIArtifact_location_H
