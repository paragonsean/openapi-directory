...
/*
 * OAIStartPipelineExecutionInput.h
 *
 * Represents the input of a &lt;code&gt;StartPipelineExecution&lt;/code&gt; action.
 */

#ifndef OAIStartPipelineExecutionInput_H
#define OAIStartPipelineExecutionInput_H
...
class OAIStartPipelineExecutionInput : public OAIObject {
public:
    OAIStartPipelineExecutionInput();
    OAIStartPipelineExecutionInput(QString json);
    ~OAIStartPipelineExecutionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartPipelineExecutionInput)

#endif // OAIStartPipelineExecutionInput_H
