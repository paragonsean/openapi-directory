...
OAIArtifactLocation_s3Location::OAIArtifactLocation_s3Location(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArtifactLocation_s3Location::OAIArtifactLocation_s3Location() {
    this->initializeModel();
}

OAIArtifactLocation_s3Location::~OAIArtifactLocation_s3Location() {}

void OAIArtifactLocation_s3Location::initializeModel() {
...
void OAIArtifactLocation_s3Location::fromJson(QString jsonString) {
...
void OAIArtifactLocation_s3Location::fromJsonObject(QJsonObject json) {
...
QString OAIArtifactLocation_s3Location::asJson() const {
...
QJsonObject OAIArtifactLocation_s3Location::asJsonObject() const {
    QJsonObject obj;
...
QString OAIArtifactLocation_s3Location::getBucketName() const {
    return m_bucket_name;
}
void OAIArtifactLocation_s3Location::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAIArtifactLocation_s3Location::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAIArtifactLocation_s3Location::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

QString OAIArtifactLocation_s3Location::getObjectKey() const {
    return m_object_key;
}
void OAIArtifactLocation_s3Location::setObjectKey(const QString &object_key) {
    m_object_key = object_key;
    m_object_key_isSet = true;
}

bool OAIArtifactLocation_s3Location::is_object_key_Set() const{
    return m_object_key_isSet;
}

bool OAIArtifactLocation_s3Location::is_object_key_Valid() const{
    return m_object_key_isValid;
}

bool OAIArtifactLocation_s3Location::isSet() const {
...
bool OAIArtifactLocation_s3Location::isValid() const {
