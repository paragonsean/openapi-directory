...
OAIThirdPartyJob::OAIThirdPartyJob(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIThirdPartyJob::OAIThirdPartyJob() {
    this->initializeModel();
}

OAIThirdPartyJob::~OAIThirdPartyJob() {}

void OAIThirdPartyJob::initializeModel() {
...
void OAIThirdPartyJob::fromJson(QString jsonString) {
...
void OAIThirdPartyJob::fromJsonObject(QJsonObject json) {
...
QString OAIThirdPartyJob::asJson() const {
...
QJsonObject OAIThirdPartyJob::asJsonObject() const {
    QJsonObject obj;
...
QString OAIThirdPartyJob::getClientId() const {
    return m_client_id;
}
void OAIThirdPartyJob::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIThirdPartyJob::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIThirdPartyJob::is_client_id_Valid() const{
    return m_client_id_isValid;
}

QString OAIThirdPartyJob::getJobId() const {
    return m_job_id;
}
void OAIThirdPartyJob::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIThirdPartyJob::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIThirdPartyJob::is_job_id_Valid() const{
    return m_job_id_isValid;
}

bool OAIThirdPartyJob::isSet() const {
...
bool OAIThirdPartyJob::isValid() const {
