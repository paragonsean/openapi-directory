...
OAIListActionTypesOutput::OAIListActionTypesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListActionTypesOutput::OAIListActionTypesOutput() {
    this->initializeModel();
}

OAIListActionTypesOutput::~OAIListActionTypesOutput() {}

void OAIListActionTypesOutput::initializeModel() {

    m_action_types_isSet = false;
    m_action_types_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListActionTypesOutput::fromJson(QString jsonString) {
...
void OAIListActionTypesOutput::fromJsonObject(QJsonObject json) {

    m_action_types_isValid = ::OpenAPI::fromJsonValue(m_action_types, json[QString("actionTypes")]);
    m_action_types_isSet = !json[QString("actionTypes")].isNull() && m_action_types_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIListActionTypesOutput::asJson() const {
...
QJsonObject OAIListActionTypesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_action_types.isSet()) {
        obj.insert(QString("actionTypes"), ::OpenAPI::toJsonValue(m_action_types));
    }
...
QList OAIListActionTypesOutput::getActionTypes() const {
    return m_action_types;
}
void OAIListActionTypesOutput::setActionTypes(const QList &action_types) {
    m_action_types = action_types;
    m_action_types_isSet = true;
}

bool OAIListActionTypesOutput::is_action_types_Set() const{
    return m_action_types_isSet;
}

bool OAIListActionTypesOutput::is_action_types_Valid() const{
    return m_action_types_isValid;
}

QString OAIListActionTypesOutput::getNextToken() const {
    return m_next_token;
}
void OAIListActionTypesOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListActionTypesOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListActionTypesOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListActionTypesOutput::isSet() const {
...
bool OAIListActionTypesOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_action_types_isValid && true;
}
