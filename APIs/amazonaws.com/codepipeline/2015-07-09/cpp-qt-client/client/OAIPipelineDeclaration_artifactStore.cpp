...
#include "OAIPipelineDeclaration_artifactStore.h"
...
OAIPipelineDeclaration_artifactStore::OAIPipelineDeclaration_artifactStore(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPipelineDeclaration_artifactStore::OAIPipelineDeclaration_artifactStore() {
    this->initializeModel();
}

OAIPipelineDeclaration_artifactStore::~OAIPipelineDeclaration_artifactStore() {}

void OAIPipelineDeclaration_artifactStore::initializeModel() {
...
void OAIPipelineDeclaration_artifactStore::fromJson(QString jsonString) {
...
void OAIPipelineDeclaration_artifactStore::fromJsonObject(QJsonObject json) {
...
QString OAIPipelineDeclaration_artifactStore::asJson() const {
...
QJsonObject OAIPipelineDeclaration_artifactStore::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIArtifactStoreType OAIPipelineDeclaration_artifactStore::getType() const {
    return m_type;
}
void OAIPipelineDeclaration_artifactStore::setType(const OAIArtifactStoreType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPipelineDeclaration_artifactStore::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPipelineDeclaration_artifactStore::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIPipelineDeclaration_artifactStore::getLocation() const {
    return m_location;
}
void OAIPipelineDeclaration_artifactStore::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIPipelineDeclaration_artifactStore::is_location_Set() const{
    return m_location_isSet;
}

bool OAIPipelineDeclaration_artifactStore::is_location_Valid() const{
    return m_location_isValid;
}

OAIArtifactStore_encryptionKey OAIPipelineDeclaration_artifactStore::getEncryptionKey() const {
    return m_encryption_key;
}
void OAIPipelineDeclaration_artifactStore::setEncryptionKey(const OAIArtifactStore_encryptionKey &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAIPipelineDeclaration_artifactStore::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAIPipelineDeclaration_artifactStore::is_encryption_key_Valid() const{
    return m_encryption_key_isValid;
}

bool OAIPipelineDeclaration_artifactStore::isSet() const {
...
bool OAIPipelineDeclaration_artifactStore::isValid() const {
