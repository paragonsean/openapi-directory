...
OAIGetPipelineStateOutput::OAIGetPipelineStateOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPipelineStateOutput::OAIGetPipelineStateOutput() {
    this->initializeModel();
}

OAIGetPipelineStateOutput::~OAIGetPipelineStateOutput() {}

void OAIGetPipelineStateOutput::initializeModel() {
...
void OAIGetPipelineStateOutput::fromJson(QString jsonString) {
...
void OAIGetPipelineStateOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPipelineStateOutput::asJson() const {
...
QJsonObject OAIGetPipelineStateOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPipelineStateOutput::getPipelineName() const {
    return m_pipeline_name;
}
void OAIGetPipelineStateOutput::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIGetPipelineStateOutput::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIGetPipelineStateOutput::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

qint32 OAIGetPipelineStateOutput::getPipelineVersion() const {
    return m_pipeline_version;
}
void OAIGetPipelineStateOutput::setPipelineVersion(const qint32 &pipeline_version) {
    m_pipeline_version = pipeline_version;
    m_pipeline_version_isSet = true;
}

bool OAIGetPipelineStateOutput::is_pipeline_version_Set() const{
    return m_pipeline_version_isSet;
}

bool OAIGetPipelineStateOutput::is_pipeline_version_Valid() const{
    return m_pipeline_version_isValid;
}

QList OAIGetPipelineStateOutput::getStageStates() const {
    return m_stage_states;
}
void OAIGetPipelineStateOutput::setStageStates(const QList &stage_states) {
    m_stage_states = stage_states;
    m_stage_states_isSet = true;
}

bool OAIGetPipelineStateOutput::is_stage_states_Set() const{
    return m_stage_states_isSet;
}

bool OAIGetPipelineStateOutput::is_stage_states_Valid() const{
    return m_stage_states_isValid;
}

QDateTime OAIGetPipelineStateOutput::getCreated() const {
    return m_created;
}
void OAIGetPipelineStateOutput::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIGetPipelineStateOutput::is_created_Set() const{
    return m_created_isSet;
}

bool OAIGetPipelineStateOutput::is_created_Valid() const{
    return m_created_isValid;
}

QDateTime OAIGetPipelineStateOutput::getUpdated() const {
    return m_updated;
}
void OAIGetPipelineStateOutput::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIGetPipelineStateOutput::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIGetPipelineStateOutput::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAIGetPipelineStateOutput::isSet() const {
...
bool OAIGetPipelineStateOutput::isValid() const {
