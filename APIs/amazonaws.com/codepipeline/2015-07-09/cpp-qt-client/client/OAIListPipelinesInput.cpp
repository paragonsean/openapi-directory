...
QString OAIListPipelinesInput::getNextToken() const {
    return m_next_token;
}
void OAIListPipelinesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPipelinesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPipelinesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListPipelinesInput::getMaxResults() const {
    return m_max_results;
}
void OAIListPipelinesInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListPipelinesInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListPipelinesInput::is_max_results_Valid() const{
