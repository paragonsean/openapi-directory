...
#include "OAIActionTypeDeclaration.h"
...
OAIActionTypeDeclaration::OAIActionTypeDeclaration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionTypeDeclaration::OAIActionTypeDeclaration() {
    this->initializeModel();
}

OAIActionTypeDeclaration::~OAIActionTypeDeclaration() {}

void OAIActionTypeDeclaration::initializeModel() {
...
void OAIActionTypeDeclaration::fromJson(QString jsonString) {
...
void OAIActionTypeDeclaration::fromJsonObject(QJsonObject json) {
...
QString OAIActionTypeDeclaration::asJson() const {
...
QJsonObject OAIActionTypeDeclaration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIActionTypeDeclaration::getDescription() const {
    return m_description;
}
void OAIActionTypeDeclaration::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIActionTypeDeclaration::is_description_Set() const{
    return m_description_isSet;
}

bool OAIActionTypeDeclaration::is_description_Valid() const{
    return m_description_isValid;
}

OAIActionTypeDeclaration_executor OAIActionTypeDeclaration::getExecutor() const {
    return m_executor;
}
void OAIActionTypeDeclaration::setExecutor(const OAIActionTypeDeclaration_executor &executor) {
    m_executor = executor;
    m_executor_isSet = true;
}

bool OAIActionTypeDeclaration::is_executor_Set() const{
    return m_executor_isSet;
}

bool OAIActionTypeDeclaration::is_executor_Valid() const{
    return m_executor_isValid;
}

OAIActionTypeDeclaration_id OAIActionTypeDeclaration::getId() const {
    return m_id;
}
void OAIActionTypeDeclaration::setId(const OAIActionTypeDeclaration_id &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIActionTypeDeclaration::is_id_Set() const{
    return m_id_isSet;
}

bool OAIActionTypeDeclaration::is_id_Valid() const{
    return m_id_isValid;
}

OAIActionTypeDeclaration_inputArtifactDetails OAIActionTypeDeclaration::getInputArtifactDetails() const {
    return m_input_artifact_details;
}
void OAIActionTypeDeclaration::setInputArtifactDetails(const OAIActionTypeDeclaration_inputArtifactDetails &input_artifact_details) {
    m_input_artifact_details = input_artifact_details;
    m_input_artifact_details_isSet = true;
}

bool OAIActionTypeDeclaration::is_input_artifact_details_Set() const{
    return m_input_artifact_details_isSet;
}

bool OAIActionTypeDeclaration::is_input_artifact_details_Valid() const{
    return m_input_artifact_details_isValid;
}

OAIActionTypeDeclaration_outputArtifactDetails OAIActionTypeDeclaration::getOutputArtifactDetails() const {
    return m_output_artifact_details;
}
void OAIActionTypeDeclaration::setOutputArtifactDetails(const OAIActionTypeDeclaration_outputArtifactDetails &output_artifact_details) {
    m_output_artifact_details = output_artifact_details;
    m_output_artifact_details_isSet = true;
}

bool OAIActionTypeDeclaration::is_output_artifact_details_Set() const{
    return m_output_artifact_details_isSet;
}

bool OAIActionTypeDeclaration::is_output_artifact_details_Valid() const{
    return m_output_artifact_details_isValid;
}

OAIActionTypeDeclaration_permissions OAIActionTypeDeclaration::getPermissions() const {
    return m_permissions;
}
void OAIActionTypeDeclaration::setPermissions(const OAIActionTypeDeclaration_permissions &permissions) {
    m_permissions = permissions;
    m_permissions_isSet = true;
}

bool OAIActionTypeDeclaration::is_permissions_Set() const{
    return m_permissions_isSet;
}

bool OAIActionTypeDeclaration::is_permissions_Valid() const{
    return m_permissions_isValid;
}

QJsonValue OAIActionTypeDeclaration::getProperties() const {
    return m_properties;
}
void OAIActionTypeDeclaration::setProperties(const QJsonValue &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIActionTypeDeclaration::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIActionTypeDeclaration::is_properties_Valid() const{
    return m_properties_isValid;
}

OAIActionTypeDeclaration_urls OAIActionTypeDeclaration::getUrls() const {
    return m_urls;
}
void OAIActionTypeDeclaration::setUrls(const OAIActionTypeDeclaration_urls &urls) {
    m_urls = urls;
    m_urls_isSet = true;
}

bool OAIActionTypeDeclaration::is_urls_Set() const{
    return m_urls_isSet;
}

bool OAIActionTypeDeclaration::is_urls_Valid() const{
    return m_urls_isValid;
}

bool OAIActionTypeDeclaration::isSet() const {
...
bool OAIActionTypeDeclaration::isValid() const {
