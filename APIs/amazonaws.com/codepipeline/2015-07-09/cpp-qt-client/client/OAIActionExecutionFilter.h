...
/*
 * OAIActionExecutionFilter.h
 *
 * Filter values for the action execution.
 */

#ifndef OAIActionExecutionFilter_H
#define OAIActionExecutionFilter_H
...
class OAIActionExecutionFilter : public OAIObject {
public:
    OAIActionExecutionFilter();
    OAIActionExecutionFilter(QString json);
    ~OAIActionExecutionFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionExecutionFilter)

#endif // OAIActionExecutionFilter_H
