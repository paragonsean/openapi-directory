...
#include "OAIJobData_actionConfiguration.h"
#include "OAIJobData_artifactCredentials.h"
#include "OAIJobData_encryptionKey.h"
#include "OAIJobData_pipelineContext.h"
#include "OAIPollForJobsInput_actionTypeId.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIPollForJobsInput_actionTypeId;
class OAIJobData_actionConfiguration;
class OAIJobData_pipelineContext;
class OAIJobData_artifactCredentials;
class OAIJobData_encryptionKey;
...
public:
    ...
    OAIPollForJobsInput_actionTypeId getActionTypeId() const;
    void setActionTypeId(const OAIPollForJobsInput_actionTypeId &action_type_id);
    bool is_action_type_id_Set() const;
    bool is_action_type_id_Valid() const;

    OAIJobData_actionConfiguration getActionConfiguration() const;
    void setActionConfiguration(const OAIJobData_actionConfiguration &action_configuration);
    bool is_action_configuration_Set() const;
    bool is_action_configuration_Valid() const;

    OAIJobData_pipelineContext getPipelineContext() const;
    void setPipelineContext(const OAIJobData_pipelineContext &pipeline_context);
    bool is_pipeline_context_Set() const;
    bool is_pipeline_context_Valid() const;

    QList getInputArtifacts() const;
    void setInputArtifacts(const QList &input_artifacts);
    bool is_input_artifacts_Set() const;
    bool is_input_artifacts_Valid() const;

    QList getOutputArtifacts() const;
    void setOutputArtifacts(const QList &output_artifacts);
    bool is_output_artifacts_Set() const;
    bool is_output_artifacts_Valid() const;

    OAIJobData_artifactCredentials getArtifactCredentials() const;
    void setArtifactCredentials(const OAIJobData_artifactCredentials &artifact_credentials);
    bool is_artifact_credentials_Set() const;
    bool is_artifact_credentials_Valid() const;
    ...
    OAIJobData_encryptionKey getEncryptionKey() const;
    void setEncryptionKey(const OAIJobData_encryptionKey &encryption_key);
...
private:
    ...
    OAIPollForJobsInput_actionTypeId m_action_type_id;
    bool m_action_type_id_isSet;
    bool m_action_type_id_isValid;

    OAIJobData_actionConfiguration m_action_configuration;
    bool m_action_configuration_isSet;
    bool m_action_configuration_isValid;

    OAIJobData_pipelineContext m_pipeline_context;
    bool m_pipeline_context_isSet;
    bool m_pipeline_context_isValid;

    QList m_input_artifacts;
    bool m_input_artifacts_isSet;
    bool m_input_artifacts_isValid;

    QList m_output_artifacts;
    bool m_output_artifacts_isSet;
    bool m_output_artifacts_isValid;

    OAIJobData_artifactCredentials m_artifact_credentials;
    bool m_artifact_credentials_isSet;
    bool m_artifact_credentials_isValid;

    QString m_continuation_token;
    bool m_continuation_token_isSet;
    bool m_continuation_token_isValid;

    OAIJobData_encryptionKey m_encryption_key;
