...
#ifndef OAIThirdPartyJob_H
#define OAIThirdPartyJob_H
...
class OAIThirdPartyJob : public OAIObject {
public:
    OAIThirdPartyJob();
    OAIThirdPartyJob(QString json);
    ~OAIThirdPartyJob() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThirdPartyJob)

#endif // OAIThirdPartyJob_H
