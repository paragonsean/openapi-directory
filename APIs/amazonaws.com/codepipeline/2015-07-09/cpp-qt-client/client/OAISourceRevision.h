...
#ifndef OAISourceRevision_H
#define OAISourceRevision_H
...
class OAISourceRevision : public OAIObject {
public:
    OAISourceRevision();
    OAISourceRevision(QString json);
    ~OAISourceRevision() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceRevision)

#endif // OAISourceRevision_H
