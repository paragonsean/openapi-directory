...
#ifndef OAIOutputArtifact_H
#define OAIOutputArtifact_H
...
class OAIOutputArtifact : public OAIObject {
public:
    OAIOutputArtifact();
    OAIOutputArtifact(QString json);
    ~OAIOutputArtifact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutputArtifact)

#endif // OAIOutputArtifact_H
