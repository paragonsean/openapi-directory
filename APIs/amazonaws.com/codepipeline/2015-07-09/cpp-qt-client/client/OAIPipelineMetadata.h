...
/*
 * OAIPipelineMetadata.h
 *
 * Information about a pipeline.
 */

#ifndef OAIPipelineMetadata_H
#define OAIPipelineMetadata_H
...
class OAIPipelineMetadata : public OAIObject {
public:
    OAIPipelineMetadata();
    OAIPipelineMetadata(QString json);
    ~OAIPipelineMetadata() override;
    ...
    QDateTime getPollingDisabledAt() const;
    void setPollingDisabledAt(const QDateTime &polling_disabled_at);
    bool is_polling_disabled_at_Set() const;
    bool is_polling_disabled_at_Valid() const;
...
private:
    ...
    QDateTime m_polling_disabled_at;
    bool m_polling_disabled_at_isSet;
    bool m_polling_disabled_at_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPipelineMetadata)

#endif // OAIPipelineMetadata_H
