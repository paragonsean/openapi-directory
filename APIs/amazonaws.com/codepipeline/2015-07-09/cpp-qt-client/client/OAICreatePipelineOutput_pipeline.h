...
/*
 * OAICreatePipelineOutput_pipeline.h
 *
 * 
 */

#ifndef OAICreatePipelineOutput_pipeline_H
#define OAICreatePipelineOutput_pipeline_H
...
class OAICreatePipelineOutput_pipeline : public OAIObject {
public:
    OAICreatePipelineOutput_pipeline();
    OAICreatePipelineOutput_pipeline(QString json);
    ~OAICreatePipelineOutput_pipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePipelineOutput_pipeline)

#endif // OAICreatePipelineOutput_pipeline_H
