...
/*
 * OAIGetThirdPartyJobDetailsOutput.h
 *
 * Represents the output of a &lt;code&gt;GetThirdPartyJobDetails&lt;/code&gt; action.
 */

#ifndef OAIGetThirdPartyJobDetailsOutput_H
#define OAIGetThirdPartyJobDetailsOutput_H
...
namespace OpenAPI {
class OAIGetThirdPartyJobDetailsOutput_jobDetails;

class OAIGetThirdPartyJobDetailsOutput : public OAIObject {
public:
    OAIGetThirdPartyJobDetailsOutput();
    OAIGetThirdPartyJobDetailsOutput(QString json);
    ~OAIGetThirdPartyJobDetailsOutput() override;
    ...
    OAIGetThirdPartyJobDetailsOutput_jobDetails getJobDetails() const;
    void setJobDetails(const OAIGetThirdPartyJobDetailsOutput_jobDetails &job_details);
...
private:
    ...
    OAIGetThirdPartyJobDetailsOutput_jobDetails m_job_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetThirdPartyJobDetailsOutput)

#endif // OAIGetThirdPartyJobDetailsOutput_H
