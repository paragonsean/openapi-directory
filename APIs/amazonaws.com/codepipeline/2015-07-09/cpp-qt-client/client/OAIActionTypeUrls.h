...
#ifndef OAIActionTypeUrls_H
#define OAIActionTypeUrls_H
...
class OAIActionTypeUrls : public OAIObject {
public:
    OAIActionTypeUrls();
    OAIActionTypeUrls(QString json);
    ~OAIActionTypeUrls() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeUrls)

#endif // OAIActionTypeUrls_H
