...
OAISourceRevision::OAISourceRevision(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISourceRevision::OAISourceRevision() {
    this->initializeModel();
}

OAISourceRevision::~OAISourceRevision() {}

void OAISourceRevision::initializeModel() {
...
void OAISourceRevision::fromJson(QString jsonString) {
...
void OAISourceRevision::fromJsonObject(QJsonObject json) {
...
QString OAISourceRevision::asJson() const {
...
QJsonObject OAISourceRevision::asJsonObject() const {
    QJsonObject obj;
...
QString OAISourceRevision::getActionName() const {
    return m_action_name;
}
void OAISourceRevision::setActionName(const QString &action_name) {
    m_action_name = action_name;
    m_action_name_isSet = true;
}

bool OAISourceRevision::is_action_name_Set() const{
    return m_action_name_isSet;
}

bool OAISourceRevision::is_action_name_Valid() const{
    return m_action_name_isValid;
}

QString OAISourceRevision::getRevisionId() const {
    return m_revision_id;
}
void OAISourceRevision::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAISourceRevision::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAISourceRevision::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

QString OAISourceRevision::getRevisionSummary() const {
    return m_revision_summary;
}
void OAISourceRevision::setRevisionSummary(const QString &revision_summary) {
    m_revision_summary = revision_summary;
    m_revision_summary_isSet = true;
}

bool OAISourceRevision::is_revision_summary_Set() const{
    return m_revision_summary_isSet;
}

bool OAISourceRevision::is_revision_summary_Valid() const{
    return m_revision_summary_isValid;
}

QString OAISourceRevision::getRevisionUrl() const {
    return m_revision_url;
}
void OAISourceRevision::setRevisionUrl(const QString &revision_url) {
    m_revision_url = revision_url;
    m_revision_url_isSet = true;
}

bool OAISourceRevision::is_revision_url_Set() const{
    return m_revision_url_isSet;
}

bool OAISourceRevision::is_revision_url_Valid() const{
    return m_revision_url_isValid;
}

bool OAISourceRevision::isSet() const {
...
bool OAISourceRevision::isValid() const {
