...
/*
 * OAIUpdatePipelineInput_pipeline.h
 *
 * 
 */

#ifndef OAIUpdatePipelineInput_pipeline_H
#define OAIUpdatePipelineInput_pipeline_H
...
class OAIUpdatePipelineInput_pipeline : public OAIObject {
public:
    OAIUpdatePipelineInput_pipeline();
    OAIUpdatePipelineInput_pipeline(QString json);
    ~OAIUpdatePipelineInput_pipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipelineInput_pipeline)

#endif // OAIUpdatePipelineInput_pipeline_H
