...
/*
 * OAIArtifactLocation_s3Location.h
 *
 * 
 */

#ifndef OAIArtifactLocation_s3Location_H
#define OAIArtifactLocation_s3Location_H
...
class OAIArtifactLocation_s3Location : public OAIObject {
public:
    OAIArtifactLocation_s3Location();
    OAIArtifactLocation_s3Location(QString json);
    ~OAIArtifactLocation_s3Location() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactLocation_s3Location)

#endif // OAIArtifactLocation_s3Location_H
