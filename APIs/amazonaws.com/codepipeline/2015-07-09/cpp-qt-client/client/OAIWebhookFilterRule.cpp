...
#include "OAIWebhookFilterRule.h"
...
OAIWebhookFilterRule::OAIWebhookFilterRule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWebhookFilterRule::OAIWebhookFilterRule() {
    this->initializeModel();
}

OAIWebhookFilterRule::~OAIWebhookFilterRule() {}

void OAIWebhookFilterRule::initializeModel() {

    m_json_path_isSet = false;
    m_json_path_isValid = false;

    m_match_equals_isSet = false;
    m_match_equals_isValid = false;
}

void OAIWebhookFilterRule::fromJson(QString jsonString) {
...
void OAIWebhookFilterRule::fromJsonObject(QJsonObject json) {
    ...
    m_match_equals_isValid = ::OpenAPI::fromJsonValue(m_match_equals, json[QString("matchEquals")]);
    m_match_equals_isSet = !json[QString("matchEquals")].isNull() && m_match_equals_isValid;
}

QString OAIWebhookFilterRule::asJson() const {
...
QJsonObject OAIWebhookFilterRule::asJsonObject() const {
    QJsonObject obj;
    if (m_json_path_isSet) {
        obj.insert(QString("jsonPath"), ::OpenAPI::toJsonValue(m_json_path));
    }
    if (m_match_equals_isSet) {
        obj.insert(QString("matchEquals"), ::OpenAPI::toJsonValue(m_match_equals));
    }
    return obj;
}

QString OAIWebhookFilterRule::getJsonPath() const {
    return m_json_path;
}
void OAIWebhookFilterRule::setJsonPath(const QString &json_path) {
    m_json_path = json_path;
    m_json_path_isSet = true;
}

bool OAIWebhookFilterRule::is_json_path_Set() const{
    return m_json_path_isSet;
}

bool OAIWebhookFilterRule::is_json_path_Valid() const{
    return m_json_path_isValid;
}

QString OAIWebhookFilterRule::getMatchEquals() const {
    return m_match_equals;
}
void OAIWebhookFilterRule::setMatchEquals(const QString &match_equals) {
    m_match_equals = match_equals;
    m_match_equals_isSet = true;
}

bool OAIWebhookFilterRule::is_match_equals_Set() const{
    return m_match_equals_isSet;
}

bool OAIWebhookFilterRule::is_match_equals_Valid() const{
    return m_match_equals_isValid;
}

bool OAIWebhookFilterRule::isSet() const {
...
bool OAIWebhookFilterRule::isValid() const {
