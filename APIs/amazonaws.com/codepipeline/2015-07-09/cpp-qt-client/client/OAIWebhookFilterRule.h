...
/*
 * OAIWebhookFilterRule.h
 *
 * The event criteria that specify when a webhook notification is sent to your URL.
 */

#ifndef OAIWebhookFilterRule_H
#define OAIWebhookFilterRule_H
...
class OAIWebhookFilterRule : public OAIObject {
public:
    OAIWebhookFilterRule();
    OAIWebhookFilterRule(QString json);
    ~OAIWebhookFilterRule() override;
    ...
    QString getMatchEquals() const;
    void setMatchEquals(const QString &match_equals);
    bool is_match_equals_Set() const;
    bool is_match_equals_Valid() const;
...
private:
    ...
    QString m_match_equals;
    bool m_match_equals_isSet;
    bool m_match_equals_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIWebhookFilterRule)

#endif // OAIWebhookFilterRule_H
