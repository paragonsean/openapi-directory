...
#include "OAIWebhookDefinition.h"
...
OAIWebhookDefinition::OAIWebhookDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWebhookDefinition::OAIWebhookDefinition() {
    this->initializeModel();
}

OAIWebhookDefinition::~OAIWebhookDefinition() {}

void OAIWebhookDefinition::initializeModel() {
...
void OAIWebhookDefinition::fromJson(QString jsonString) {
...
void OAIWebhookDefinition::fromJsonObject(QJsonObject json) {
...
QString OAIWebhookDefinition::asJson() const {
...
QJsonObject OAIWebhookDefinition::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIWebhookDefinition::getName() const {
    return m_name;
}
void OAIWebhookDefinition::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIWebhookDefinition::is_name_Set() const{
    return m_name_isSet;
}

bool OAIWebhookDefinition::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIWebhookDefinition::getTargetPipeline() const {
    return m_target_pipeline;
}
void OAIWebhookDefinition::setTargetPipeline(const QString &target_pipeline) {
    m_target_pipeline = target_pipeline;
    m_target_pipeline_isSet = true;
}

bool OAIWebhookDefinition::is_target_pipeline_Set() const{
    return m_target_pipeline_isSet;
}

bool OAIWebhookDefinition::is_target_pipeline_Valid() const{
    return m_target_pipeline_isValid;
}

QString OAIWebhookDefinition::getTargetAction() const {
    return m_target_action;
}
void OAIWebhookDefinition::setTargetAction(const QString &target_action) {
    m_target_action = target_action;
    m_target_action_isSet = true;
}

bool OAIWebhookDefinition::is_target_action_Set() const{
    return m_target_action_isSet;
}

bool OAIWebhookDefinition::is_target_action_Valid() const{
    return m_target_action_isValid;
}

QList OAIWebhookDefinition::getFilters() const {
    return m_filters;
}
void OAIWebhookDefinition::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIWebhookDefinition::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIWebhookDefinition::is_filters_Valid() const{
    return m_filters_isValid;
}

OAIWebhookAuthenticationType OAIWebhookDefinition::getAuthentication() const {
    return m_authentication;
}
void OAIWebhookDefinition::setAuthentication(const OAIWebhookAuthenticationType &authentication) {
    m_authentication = authentication;
    m_authentication_isSet = true;
}

bool OAIWebhookDefinition::is_authentication_Set() const{
    return m_authentication_isSet;
}

bool OAIWebhookDefinition::is_authentication_Valid() const{
    return m_authentication_isValid;
}

OAIWebhookDefinition_authenticationConfiguration OAIWebhookDefinition::getAuthenticationConfiguration() const {
    return m_authentication_configuration;
}
void OAIWebhookDefinition::setAuthenticationConfiguration(const OAIWebhookDefinition_authenticationConfiguration &authentication_configuration) {
    m_authentication_configuration = authentication_configuration;
    m_authentication_configuration_isSet = true;
}

bool OAIWebhookDefinition::is_authentication_configuration_Set() const{
    return m_authentication_configuration_isSet;
}

bool OAIWebhookDefinition::is_authentication_configuration_Valid() const{
    return m_authentication_configuration_isValid;
}

bool OAIWebhookDefinition::isSet() const {
...
bool OAIWebhookDefinition::isValid() const {
