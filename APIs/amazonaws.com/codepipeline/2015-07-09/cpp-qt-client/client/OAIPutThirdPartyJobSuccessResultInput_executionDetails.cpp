...
#include "OAIPutThirdPartyJobSuccessResultInput_executionDetails.h"
...
OAIPutThirdPartyJobSuccessResultInput_executionDetails::OAIPutThirdPartyJobSuccessResultInput_executionDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutThirdPartyJobSuccessResultInput_executionDetails::OAIPutThirdPartyJobSuccessResultInput_executionDetails() {
    this->initializeModel();
}

OAIPutThirdPartyJobSuccessResultInput_executionDetails::~OAIPutThirdPartyJobSuccessResultInput_executionDetails() {}

void OAIPutThirdPartyJobSuccessResultInput_executionDetails::initializeModel() {
...
void OAIPutThirdPartyJobSuccessResultInput_executionDetails::fromJson(QString jsonString) {
...
void OAIPutThirdPartyJobSuccessResultInput_executionDetails::fromJsonObject(QJsonObject json) {
...
QString OAIPutThirdPartyJobSuccessResultInput_executionDetails::asJson() const {
...
QJsonObject OAIPutThirdPartyJobSuccessResultInput_executionDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_summary_isSet) {
...
QString OAIPutThirdPartyJobSuccessResultInput_executionDetails::getSummary() const {
    return m_summary;
}
void OAIPutThirdPartyJobSuccessResultInput_executionDetails::setSummary(const QString &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAIPutThirdPartyJobSuccessResultInput_executionDetails::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAIPutThirdPartyJobSuccessResultInput_executionDetails::is_summary_Valid() const{
    return m_summary_isValid;
}

QString OAIPutThirdPartyJobSuccessResultInput_executionDetails::getExternalExecutionId() const {
    return m_external_execution_id;
}
void OAIPutThirdPartyJobSuccessResultInput_executionDetails::setExternalExecutionId(const QString &external_execution_id) {
    m_external_execution_id = external_execution_id;
    m_external_execution_id_isSet = true;
}

bool OAIPutThirdPartyJobSuccessResultInput_executionDetails::is_external_execution_id_Set() const{
    return m_external_execution_id_isSet;
}

bool OAIPutThirdPartyJobSuccessResultInput_executionDetails::is_external_execution_id_Valid() const{
    return m_external_execution_id_isValid;
}

qint32 OAIPutThirdPartyJobSuccessResultInput_executionDetails::getPercentComplete() const {
    return m_percent_complete;
}
void OAIPutThirdPartyJobSuccessResultInput_executionDetails::setPercentComplete(const qint32 &percent_complete) {
    m_percent_complete = percent_complete;
    m_percent_complete_isSet = true;
}

bool OAIPutThirdPartyJobSuccessResultInput_executionDetails::is_percent_complete_Set() const{
    return m_percent_complete_isSet;
}

bool OAIPutThirdPartyJobSuccessResultInput_executionDetails::is_percent_complete_Valid() const{
    return m_percent_complete_isValid;
}

bool OAIPutThirdPartyJobSuccessResultInput_executionDetails::isSet() const {
...
bool OAIPutThirdPartyJobSuccessResultInput_executionDetails::isValid() const {
