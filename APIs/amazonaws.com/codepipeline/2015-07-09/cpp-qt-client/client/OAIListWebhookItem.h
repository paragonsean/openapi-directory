...
/*
 * OAIListWebhookItem.h
 *
 * The detail returned for each webhook after listing webhooks, such as the webhook URL, the webhook name, and the webhook ARN.
 */

#ifndef OAIListWebhookItem_H
#define OAIListWebhookItem_H
...
namespace OpenAPI {
class OAIListWebhookItem_definition;

class OAIListWebhookItem : public OAIObject {
public:
    OAIListWebhookItem();
    OAIListWebhookItem(QString json);
    ~OAIListWebhookItem() override;
    ...
    OAIListWebhookItem_definition getDefinition() const;
    void setDefinition(const OAIListWebhookItem_definition &definition);
    ...
    void setLastTriggered(const QDateTime &last_triggered);
    bool is_last_triggered_Set() const;
    bool is_last_triggered_Valid() const;
...
private:
    ...
    OAIListWebhookItem_definition m_definition;
    ...
    QDateTime m_last_triggered;
    bool m_last_triggered_isSet;
    bool m_last_triggered_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListWebhookItem)

#endif // OAIListWebhookItem_H
