...
/*
 * OAIPollForJobsInput.h
 *
 * Represents the input of a &lt;code&gt;PollForJobs&lt;/code&gt; action.
 */

#ifndef OAIPollForJobsInput_H
#define OAIPollForJobsInput_H
...
class OAIPollForJobsInput : public OAIObject {
public:
    OAIPollForJobsInput();
    OAIPollForJobsInput(QString json);
    ~OAIPollForJobsInput() override;
    ...
    qint32 getMaxBatchSize() const;
    void setMaxBatchSize(const qint32 &max_batch_size);
    bool is_max_batch_size_Set() const;
    bool is_max_batch_size_Valid() const;

    QMap getQueryParam() const;
    void setQueryParam(const QMap &query_param);
    bool is_query_param_Set() const;
    bool is_query_param_Valid() const;
...
private:
    ...
    qint32 m_max_batch_size;
    bool m_max_batch_size_isSet;
    bool m_max_batch_size_isValid;

    QMap m_query_param;
    bool m_query_param_isSet;
    bool m_query_param_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPollForJobsInput)

#endif // OAIPollForJobsInput_H
