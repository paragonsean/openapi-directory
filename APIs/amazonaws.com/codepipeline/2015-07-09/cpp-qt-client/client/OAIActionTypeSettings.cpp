...
#include "OAIActionTypeSettings.h"
...
OAIActionTypeSettings::OAIActionTypeSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionTypeSettings::OAIActionTypeSettings() {
    this->initializeModel();
}

OAIActionTypeSettings::~OAIActionTypeSettings() {}

void OAIActionTypeSettings::initializeModel() {

    m_third_party_configuration_url_isSet = false;
    m_third_party_configuration_url_isValid = false;
...
void OAIActionTypeSettings::fromJson(QString jsonString) {
...
void OAIActionTypeSettings::fromJsonObject(QJsonObject json) {

    m_third_party_configuration_url_isValid = ::OpenAPI::fromJsonValue(m_third_party_configuration_url, json[QString("thirdPartyConfigurationUrl")]);
    m_third_party_configuration_url_isSet = !json[QString("thirdPartyConfigurationUrl")].isNull() && m_third_party_configuration_url_isValid;
...
QString OAIActionTypeSettings::asJson() const {
...
QJsonObject OAIActionTypeSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_third_party_configuration_url_isSet) {
        obj.insert(QString("thirdPartyConfigurationUrl"), ::OpenAPI::toJsonValue(m_third_party_configuration_url));
    }
...
QString OAIActionTypeSettings::getThirdPartyConfigurationUrl() const {
    return m_third_party_configuration_url;
}
void OAIActionTypeSettings::setThirdPartyConfigurationUrl(const QString &third_party_configuration_url) {
    m_third_party_configuration_url = third_party_configuration_url;
    m_third_party_configuration_url_isSet = true;
}

bool OAIActionTypeSettings::is_third_party_configuration_url_Set() const{
    return m_third_party_configuration_url_isSet;
}

bool OAIActionTypeSettings::is_third_party_configuration_url_Valid() const{
    return m_third_party_configuration_url_isValid;
}

QString OAIActionTypeSettings::getEntityUrlTemplate() const {
    return m_entity_url_template;
}
void OAIActionTypeSettings::setEntityUrlTemplate(const QString &entity_url_template) {
    m_entity_url_template = entity_url_template;
    m_entity_url_template_isSet = true;
}

bool OAIActionTypeSettings::is_entity_url_template_Set() const{
    return m_entity_url_template_isSet;
}

bool OAIActionTypeSettings::is_entity_url_template_Valid() const{
    return m_entity_url_template_isValid;
}

QString OAIActionTypeSettings::getExecutionUrlTemplate() const {
    return m_execution_url_template;
}
void OAIActionTypeSettings::setExecutionUrlTemplate(const QString &execution_url_template) {
    m_execution_url_template = execution_url_template;
    m_execution_url_template_isSet = true;
}

bool OAIActionTypeSettings::is_execution_url_template_Set() const{
    return m_execution_url_template_isSet;
}

bool OAIActionTypeSettings::is_execution_url_template_Valid() const{
    return m_execution_url_template_isValid;
}

QString OAIActionTypeSettings::getRevisionUrlTemplate() const {
    return m_revision_url_template;
}
void OAIActionTypeSettings::setRevisionUrlTemplate(const QString &revision_url_template) {
    m_revision_url_template = revision_url_template;
    m_revision_url_template_isSet = true;
}

bool OAIActionTypeSettings::is_revision_url_template_Set() const{
    return m_revision_url_template_isSet;
}

bool OAIActionTypeSettings::is_revision_url_template_Valid() const{
    return m_revision_url_template_isValid;
}

bool OAIActionTypeSettings::isSet() const {
...
bool OAIActionTypeSettings::isValid() const {
