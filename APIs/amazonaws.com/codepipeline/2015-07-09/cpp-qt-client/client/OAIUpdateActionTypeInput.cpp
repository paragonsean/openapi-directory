...
OAIUpdateActionTypeInput::OAIUpdateActionTypeInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateActionTypeInput::OAIUpdateActionTypeInput() {
    this->initializeModel();
}

OAIUpdateActionTypeInput::~OAIUpdateActionTypeInput() {}

void OAIUpdateActionTypeInput::initializeModel() {

    m_action_type_isSet = false;
    m_action_type_isValid = false;
}

void OAIUpdateActionTypeInput::fromJson(QString jsonString) {
...
void OAIUpdateActionTypeInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateActionTypeInput::asJson() const {
...
QJsonObject OAIUpdateActionTypeInput::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateActionTypeInput_actionType OAIUpdateActionTypeInput::getActionType() const {
    return m_action_type;
}
void OAIUpdateActionTypeInput::setActionType(const OAIUpdateActionTypeInput_actionType &action_type) {
    m_action_type = action_type;
    m_action_type_isSet = true;
}

bool OAIUpdateActionTypeInput::is_action_type_Set() const{
    return m_action_type_isSet;
}

bool OAIUpdateActionTypeInput::is_action_type_Valid() const{
    return m_action_type_isValid;
}

bool OAIUpdateActionTypeInput::isSet() const {
...
bool OAIUpdateActionTypeInput::isValid() const {
