...
OAIInputArtifact::OAIInputArtifact(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInputArtifact::OAIInputArtifact() {
    this->initializeModel();
}

OAIInputArtifact::~OAIInputArtifact() {}

void OAIInputArtifact::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIInputArtifact::fromJson(QString jsonString) {
...
void OAIInputArtifact::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIInputArtifact::asJson() const {
...
QJsonObject OAIInputArtifact::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIInputArtifact::getName() const {
    return m_name;
}
void OAIInputArtifact::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIInputArtifact::is_name_Set() const{
    return m_name_isSet;
}

bool OAIInputArtifact::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIInputArtifact::isSet() const {
...
bool OAIInputArtifact::isValid() const {
