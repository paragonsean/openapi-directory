...
#ifndef OAIActionTypeExecutor_H
#define OAIActionTypeExecutor_H

#include <QJsonObject>

#include "OAIActionTypeExecutor_configuration.h"
#include "OAIExecutorType.h"
#include <QString>
...
namespace OpenAPI {
class OAIActionTypeExecutor_configuration;

class OAIActionTypeExecutor : public OAIObject {
public:
    OAIActionTypeExecutor();
    OAIActionTypeExecutor(QString json);
    ~OAIActionTypeExecutor() override;
    ...
    OAIActionTypeExecutor_configuration getConfiguration() const;
    void setConfiguration(const OAIActionTypeExecutor_configuration &configuration);
    bool is_configuration_Set() const;
    bool is_configuration_Valid() const;

    OAIExecutorType getType() const;
    void setType(const OAIExecutorType &type);
    bool is_type_Set() const;
    bool is_type_Valid() const;

    QString getPolicyStatementsTemplate() const;
    void setPolicyStatementsTemplate(const QString &policy_statements_template);
    bool is_policy_statements_template_Set() const;
    bool is_policy_statements_template_Valid() const;

    qint32 getJobTimeout() const;
    void setJobTimeout(const qint32 &job_timeout);
    bool is_job_timeout_Set() const;
    bool is_job_timeout_Valid() const;
...
private:
    ...
    OAIActionTypeExecutor_configuration m_configuration;
    bool m_configuration_isSet;
    bool m_configuration_isValid;

    OAIExecutorType m_type;
    bool m_type_isSet;
    bool m_type_isValid;

    QString m_policy_statements_template;
    bool m_policy_statements_template_isSet;
    bool m_policy_statements_template_isValid;

    qint32 m_job_timeout;
    bool m_job_timeout_isSet;
    bool m_job_timeout_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeExecutor)

#endif // OAIActionTypeExecutor_H
