...
OAIStageContext::OAIStageContext(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStageContext::OAIStageContext() {
    this->initializeModel();
}

OAIStageContext::~OAIStageContext() {}

void OAIStageContext::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIStageContext::fromJson(QString jsonString) {
...
void OAIStageContext::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIStageContext::asJson() const {
...
QJsonObject OAIStageContext::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIStageContext::getName() const {
    return m_name;
}
void OAIStageContext::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStageContext::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStageContext::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIStageContext::isSet() const {
...
bool OAIStageContext::isValid() const {
