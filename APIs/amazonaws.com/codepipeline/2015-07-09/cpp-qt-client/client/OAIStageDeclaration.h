...
/*
 * OAIStageDeclaration.h
 *
 * Represents information about a stage and its definition.
 */

#ifndef OAIStageDeclaration_H
#define OAIStageDeclaration_H
...
class OAIStageDeclaration : public OAIObject {
public:
    OAIStageDeclaration();
    OAIStageDeclaration(QString json);
    ~OAIStageDeclaration() override;
    ...
    QList getBlockers() const;
    void setBlockers(const QList &blockers);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStageDeclaration)

#endif // OAIStageDeclaration_H
