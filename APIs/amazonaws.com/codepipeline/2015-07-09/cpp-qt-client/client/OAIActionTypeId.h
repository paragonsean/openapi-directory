...
#ifndef OAIActionTypeId_H
#define OAIActionTypeId_H
...
class OAIActionTypeId : public OAIObject {
public:
    OAIActionTypeId();
    OAIActionTypeId(QString json);
    ~OAIActionTypeId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeId)

#endif // OAIActionTypeId_H
