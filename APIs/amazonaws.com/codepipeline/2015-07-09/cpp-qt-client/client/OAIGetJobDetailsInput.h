...
/*
 * OAIGetJobDetailsInput.h
 *
 * Represents the input of a &lt;code&gt;GetJobDetails&lt;/code&gt; action.
 */

#ifndef OAIGetJobDetailsInput_H
#define OAIGetJobDetailsInput_H
...
class OAIGetJobDetailsInput : public OAIObject {
public:
    OAIGetJobDetailsInput();
    OAIGetJobDetailsInput(QString json);
    ~OAIGetJobDetailsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetJobDetailsInput)

#endif // OAIGetJobDetailsInput_H
