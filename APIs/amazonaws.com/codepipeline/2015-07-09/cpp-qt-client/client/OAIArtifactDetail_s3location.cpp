...
#include "OAIArtifactDetail_s3location.h"
...
OAIArtifactDetail_s3location::OAIArtifactDetail_s3location(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArtifactDetail_s3location::OAIArtifactDetail_s3location() {
    this->initializeModel();
}

OAIArtifactDetail_s3location::~OAIArtifactDetail_s3location() {}

void OAIArtifactDetail_s3location::initializeModel() {
...
void OAIArtifactDetail_s3location::fromJson(QString jsonString) {
...
void OAIArtifactDetail_s3location::fromJsonObject(QJsonObject json) {
...
QString OAIArtifactDetail_s3location::asJson() const {
...
QJsonObject OAIArtifactDetail_s3location::asJsonObject() const {
    QJsonObject obj;
    if (m_bucket_isSet) {
...
QString OAIArtifactDetail_s3location::getBucket() const {
    return m_bucket;
}
void OAIArtifactDetail_s3location::setBucket(const QString &bucket) {
    m_bucket = bucket;
    m_bucket_isSet = true;
}

bool OAIArtifactDetail_s3location::is_bucket_Set() const{
    return m_bucket_isSet;
}

bool OAIArtifactDetail_s3location::is_bucket_Valid() const{
    return m_bucket_isValid;
}

QString OAIArtifactDetail_s3location::getKey() const {
    return m_key;
}
void OAIArtifactDetail_s3location::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAIArtifactDetail_s3location::is_key_Set() const{
    return m_key_isSet;
}

bool OAIArtifactDetail_s3location::is_key_Valid() const{
    return m_key_isValid;
}

bool OAIArtifactDetail_s3location::isSet() const {
...
bool OAIArtifactDetail_s3location::isValid() const {
