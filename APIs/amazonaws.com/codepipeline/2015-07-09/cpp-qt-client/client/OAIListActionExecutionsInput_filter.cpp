...
OAIListActionExecutionsInput_filter::OAIListActionExecutionsInput_filter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListActionExecutionsInput_filter::OAIListActionExecutionsInput_filter() {
    this->initializeModel();
}

OAIListActionExecutionsInput_filter::~OAIListActionExecutionsInput_filter() {}

void OAIListActionExecutionsInput_filter::initializeModel() {

    m_pipeline_execution_id_isSet = false;
    m_pipeline_execution_id_isValid = false;
}

void OAIListActionExecutionsInput_filter::fromJson(QString jsonString) {
...
void OAIListActionExecutionsInput_filter::fromJsonObject(QJsonObject json) {
...
QString OAIListActionExecutionsInput_filter::asJson() const {
...
QJsonObject OAIListActionExecutionsInput_filter::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListActionExecutionsInput_filter::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIListActionExecutionsInput_filter::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIListActionExecutionsInput_filter::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIListActionExecutionsInput_filter::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

bool OAIListActionExecutionsInput_filter::isSet() const {
...
bool OAIListActionExecutionsInput_filter::isValid() const {
