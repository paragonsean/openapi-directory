...
/*
 * OAIActionExecutionDetail.h
 *
 * Returns information about an execution of an action, including the action execution ID, and the name, version, and timing of the action. 
 */

#ifndef OAIActionExecutionDetail_H
#define OAIActionExecutionDetail_H

#include <QJsonObject>

#include "OAIActionExecutionDetail_input.h"
#include "OAIActionExecutionDetail_output.h"
#include "OAIActionExecutionStatus.h"
#include <QDateTime>
#include <QString>
...
namespace OpenAPI {
class OAIActionExecutionDetail_input;
class OAIActionExecutionDetail_output;

class OAIActionExecutionDetail : public OAIObject {
public:
    OAIActionExecutionDetail();
    OAIActionExecutionDetail(QString json);
    ~OAIActionExecutionDetail() override;
    ...
    QString getPipelineExecutionId() const;
    void setPipelineExecutionId(const QString &pipeline_execution_id);
    bool is_pipeline_execution_id_Set() const;
    bool is_pipeline_execution_id_Valid() const;

    QString getActionExecutionId() const;
    void setActionExecutionId(const QString &action_execution_id);
    bool is_action_execution_id_Set() const;
    bool is_action_execution_id_Valid() const;

    qint32 getPipelineVersion() const;
    void setPipelineVersion(const qint32 &pipeline_version);
    bool is_pipeline_version_Set() const;
    bool is_pipeline_version_Valid() const;
    ...
    OAIActionExecutionStatus getStatus() const;
    void setStatus(const OAIActionExecutionStatus &status);
    bool is_status_Set() const;
    bool is_status_Valid() const;

    OAIActionExecutionDetail_input getInput() const;
    void setInput(const OAIActionExecutionDetail_input &input);
    bool is_input_Set() const;
    bool is_input_Valid() const;

    OAIActionExecutionDetail_output getOutput() const;
    void setOutput(const OAIActionExecutionDetail_output &output);
...
private:
    ...
    QString m_pipeline_execution_id;
    bool m_pipeline_execution_id_isSet;
    bool m_pipeline_execution_id_isValid;

    QString m_action_execution_id;
    bool m_action_execution_id_isSet;
    bool m_action_execution_id_isValid;

    qint32 m_pipeline_version;
    bool m_pipeline_version_isSet;
    bool m_pipeline_version_isValid;
    ...
    OAIActionExecutionStatus m_status;
    bool m_status_isSet;
    bool m_status_isValid;

    OAIActionExecutionDetail_input m_input;
    bool m_input_isSet;
    bool m_input_isValid;

    OAIActionExecutionDetail_output m_output;
    bool m_output_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionExecutionDetail)

#endif // OAIActionExecutionDetail_H
