...
/*
 * OAIPutJobFailureResultInput_failureDetails.h
 *
 * 
 */

#ifndef OAIPutJobFailureResultInput_failureDetails_H
#define OAIPutJobFailureResultInput_failureDetails_H
...
class OAIPutJobFailureResultInput_failureDetails : public OAIObject {
public:
    OAIPutJobFailureResultInput_failureDetails();
    OAIPutJobFailureResultInput_failureDetails(QString json);
    ~OAIPutJobFailureResultInput_failureDetails() override;
    ...
    OAIFailureType getType() const;
    void setType(const OAIFailureType &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutJobFailureResultInput_failureDetails)

#endif // OAIPutJobFailureResultInput_failureDetails_H
