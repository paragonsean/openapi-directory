...
/*
 * OAIActionTypeDeclaration_executor.h
 *
 * 
 */

#ifndef OAIActionTypeDeclaration_executor_H
#define OAIActionTypeDeclaration_executor_H
...
class OAIActionTypeDeclaration_executor : public OAIObject {
public:
    OAIActionTypeDeclaration_executor();
    OAIActionTypeDeclaration_executor(QString json);
    ~OAIActionTypeDeclaration_executor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeDeclaration_executor)

#endif // OAIActionTypeDeclaration_executor_H
