...
/*
 * OAIPutWebhookInput.h
 *
 * 
 */

#ifndef OAIPutWebhookInput_H
#define OAIPutWebhookInput_H
...
namespace OpenAPI {
class OAIPutWebhookInput_webhook;

class OAIPutWebhookInput : public OAIObject {
public:
    OAIPutWebhookInput();
    OAIPutWebhookInput(QString json);
    ~OAIPutWebhookInput() override;
    ...
    OAIPutWebhookInput_webhook getWebhook() const;
    void setWebhook(const OAIPutWebhookInput_webhook &webhook);
...
private:
    ...
    OAIPutWebhookInput_webhook m_webhook;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutWebhookInput)

#endif // OAIPutWebhookInput_H
