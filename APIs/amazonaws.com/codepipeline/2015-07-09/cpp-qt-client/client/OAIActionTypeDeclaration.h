...
/*
 * OAIActionTypeDeclaration.h
 *
 * The parameters for the action type definition that are provided when the action type is created or updated.
 */

#ifndef OAIActionTypeDeclaration_H
#define OAIActionTypeDeclaration_H
...
class OAIActionTypeDeclaration : public OAIObject {
public:
    OAIActionTypeDeclaration();
    OAIActionTypeDeclaration(QString json);
    ~OAIActionTypeDeclaration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeDeclaration)

#endif // OAIActionTypeDeclaration_H
