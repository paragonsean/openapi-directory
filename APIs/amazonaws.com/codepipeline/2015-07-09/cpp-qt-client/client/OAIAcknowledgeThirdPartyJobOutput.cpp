...
OAIAcknowledgeThirdPartyJobOutput::OAIAcknowledgeThirdPartyJobOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAcknowledgeThirdPartyJobOutput::OAIAcknowledgeThirdPartyJobOutput() {
    this->initializeModel();
}

OAIAcknowledgeThirdPartyJobOutput::~OAIAcknowledgeThirdPartyJobOutput() {}

void OAIAcknowledgeThirdPartyJobOutput::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIAcknowledgeThirdPartyJobOutput::fromJson(QString jsonString) {
...
void OAIAcknowledgeThirdPartyJobOutput::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIAcknowledgeThirdPartyJobOutput::asJson() const {
...
QJsonObject OAIAcknowledgeThirdPartyJobOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIJobStatus OAIAcknowledgeThirdPartyJobOutput::getStatus() const {
    return m_status;
}
void OAIAcknowledgeThirdPartyJobOutput::setStatus(const OAIJobStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIAcknowledgeThirdPartyJobOutput::is_status_Set() const{
    return m_status_isSet;
}

bool OAIAcknowledgeThirdPartyJobOutput::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIAcknowledgeThirdPartyJobOutput::isSet() const {
...
bool OAIAcknowledgeThirdPartyJobOutput::isValid() const {
