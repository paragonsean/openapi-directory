...
OAIStartPipelineExecutionOutput::OAIStartPipelineExecutionOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartPipelineExecutionOutput::OAIStartPipelineExecutionOutput() {
    this->initializeModel();
}

OAIStartPipelineExecutionOutput::~OAIStartPipelineExecutionOutput() {}

void OAIStartPipelineExecutionOutput::initializeModel() {

    m_pipeline_execution_id_isSet = false;
    m_pipeline_execution_id_isValid = false;
}

void OAIStartPipelineExecutionOutput::fromJson(QString jsonString) {
...
void OAIStartPipelineExecutionOutput::fromJsonObject(QJsonObject json) {
...
QString OAIStartPipelineExecutionOutput::asJson() const {
...
QJsonObject OAIStartPipelineExecutionOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartPipelineExecutionOutput::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIStartPipelineExecutionOutput::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIStartPipelineExecutionOutput::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIStartPipelineExecutionOutput::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

bool OAIStartPipelineExecutionOutput::isSet() const {
...
bool OAIStartPipelineExecutionOutput::isValid() const {
