...
OAIWebhookAuthenticationType::OAIWebhookAuthenticationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWebhookAuthenticationType::OAIWebhookAuthenticationType() {
    this->initializeModel();
}

OAIWebhookAuthenticationType::~OAIWebhookAuthenticationType() {}

void OAIWebhookAuthenticationType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIWebhookAuthenticationType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIWebhookAuthenticationType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("GITHUB_HMAC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIWebhookAuthenticationType::GITHUB_HMAC;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IP", Qt::CaseInsensitive) == 0) {
        m_value = eOAIWebhookAuthenticationType::IP;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UNAUTHENTICATED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIWebhookAuthenticationType::UNAUTHENTICATED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIWebhookAuthenticationType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIWebhookAuthenticationType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIWebhookAuthenticationType::GITHUB_HMAC:
            val = "GITHUB_HMAC";
            break;
        case eOAIWebhookAuthenticationType::IP:
            val = "IP";
            break;
        case eOAIWebhookAuthenticationType::UNAUTHENTICATED:
            val = "UNAUTHENTICATED";
            break;
        default:
            break;
...
QJsonValue OAIWebhookAuthenticationType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIWebhookAuthenticationType::eOAIWebhookAuthenticationType OAIWebhookAuthenticationType::getValue() const {
    return m_value;
}

void OAIWebhookAuthenticationType::setValue(const OAIWebhookAuthenticationType::eOAIWebhookAuthenticationType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIWebhookAuthenticationType::isSet() const {
    
    return m_value_isSet;
}

bool OAIWebhookAuthenticationType::isValid() const {
