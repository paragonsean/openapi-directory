...
/*
 * OAIJobDetails_data.h
 *
 * 
 */

#ifndef OAIJobDetails_data_H
#define OAIJobDetails_data_H
...
class OAIJobDetails_data : public OAIObject {
public:
    OAIJobDetails_data();
    OAIJobDetails_data(QString json);
    ~OAIJobDetails_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobDetails_data)

#endif // OAIJobDetails_data_H
