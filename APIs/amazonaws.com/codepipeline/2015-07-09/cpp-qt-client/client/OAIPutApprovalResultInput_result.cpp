...
#include "OAIPutApprovalResultInput_result.h"
...
OAIPutApprovalResultInput_result::OAIPutApprovalResultInput_result(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutApprovalResultInput_result::OAIPutApprovalResultInput_result() {
    this->initializeModel();
}

OAIPutApprovalResultInput_result::~OAIPutApprovalResultInput_result() {}

void OAIPutApprovalResultInput_result::initializeModel() {
...
void OAIPutApprovalResultInput_result::fromJson(QString jsonString) {
...
void OAIPutApprovalResultInput_result::fromJsonObject(QJsonObject json) {
...
QString OAIPutApprovalResultInput_result::asJson() const {
...
QJsonObject OAIPutApprovalResultInput_result::asJsonObject() const {
    QJsonObject obj;
    if (m_summary_isSet) {
...
QString OAIPutApprovalResultInput_result::getSummary() const {
    return m_summary;
}
void OAIPutApprovalResultInput_result::setSummary(const QString &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAIPutApprovalResultInput_result::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAIPutApprovalResultInput_result::is_summary_Valid() const{
    return m_summary_isValid;
}

OAIApprovalStatus OAIPutApprovalResultInput_result::getStatus() const {
    return m_status;
}
void OAIPutApprovalResultInput_result::setStatus(const OAIApprovalStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPutApprovalResultInput_result::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPutApprovalResultInput_result::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPutApprovalResultInput_result::isSet() const {
...
bool OAIPutApprovalResultInput_result::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_summary_isValid && m_status_isValid && true;
}
