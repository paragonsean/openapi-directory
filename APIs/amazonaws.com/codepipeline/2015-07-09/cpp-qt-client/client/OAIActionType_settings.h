...
/*
 * OAIActionType_settings.h
 *
 * 
 */

#ifndef OAIActionType_settings_H
#define OAIActionType_settings_H
...
class OAIActionType_settings : public OAIObject {
public:
    OAIActionType_settings();
    OAIActionType_settings(QString json);
    ~OAIActionType_settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionType_settings)

#endif // OAIActionType_settings_H
