...
/*
 * OAIS3ArtifactLocation.h
 *
 * The location of the S3 bucket that contains a revision.
 */

#ifndef OAIS3ArtifactLocation_H
#define OAIS3ArtifactLocation_H
...
class OAIS3ArtifactLocation : public OAIObject {
public:
    OAIS3ArtifactLocation();
    OAIS3ArtifactLocation(QString json);
    ~OAIS3ArtifactLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3ArtifactLocation)

#endif // OAIS3ArtifactLocation_H
