...
OAITransitionState::OAITransitionState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransitionState::OAITransitionState() {
    this->initializeModel();
}

OAITransitionState::~OAITransitionState() {}

void OAITransitionState::initializeModel() {
...
void OAITransitionState::fromJson(QString jsonString) {
...
void OAITransitionState::fromJsonObject(QJsonObject json) {
...
QString OAITransitionState::asJson() const {
...
QJsonObject OAITransitionState::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAITransitionState::getEnabled() const {
    return m_enabled;
}
void OAITransitionState::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAITransitionState::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAITransitionState::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAITransitionState::getLastChangedBy() const {
    return m_last_changed_by;
}
void OAITransitionState::setLastChangedBy(const QString &last_changed_by) {
    m_last_changed_by = last_changed_by;
    m_last_changed_by_isSet = true;
}

bool OAITransitionState::is_last_changed_by_Set() const{
    return m_last_changed_by_isSet;
}

bool OAITransitionState::is_last_changed_by_Valid() const{
    return m_last_changed_by_isValid;
}

QDateTime OAITransitionState::getLastChangedAt() const {
    return m_last_changed_at;
}
void OAITransitionState::setLastChangedAt(const QDateTime &last_changed_at) {
    m_last_changed_at = last_changed_at;
    m_last_changed_at_isSet = true;
}

bool OAITransitionState::is_last_changed_at_Set() const{
    return m_last_changed_at_isSet;
}

bool OAITransitionState::is_last_changed_at_Valid() const{
    return m_last_changed_at_isValid;
}

QString OAITransitionState::getDisabledReason() const {
    return m_disabled_reason;
}
void OAITransitionState::setDisabledReason(const QString &disabled_reason) {
    m_disabled_reason = disabled_reason;
    m_disabled_reason_isSet = true;
}

bool OAITransitionState::is_disabled_reason_Set() const{
    return m_disabled_reason_isSet;
}

bool OAITransitionState::is_disabled_reason_Valid() const{
    return m_disabled_reason_isValid;
}

bool OAITransitionState::isSet() const {
...
bool OAITransitionState::isValid() const {
