...
QString OAIDeleteWebhookInput::getName() const {
    return m_name;
}
void OAIDeleteWebhookInput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteWebhookInput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteWebhookInput::is_name_Valid() const{
