...
OAICreatePipelineOutput_pipeline OAICreatePipelineOutput::getPipeline() const {
    return m_pipeline;
}
void OAICreatePipelineOutput::setPipeline(const OAICreatePipelineOutput_pipeline &pipeline) {
    m_pipeline = pipeline;
    m_pipeline_isSet = true;
}

bool OAICreatePipelineOutput::is_pipeline_Set() const{
    return m_pipeline_isSet;
}

bool OAICreatePipelineOutput::is_pipeline_Valid() const{
    return m_pipeline_isValid;
}

QList OAICreatePipelineOutput::getTags() const {
    return m_tags;
}
void OAICreatePipelineOutput::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreatePipelineOutput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreatePipelineOutput::is_tags_Valid() const{
