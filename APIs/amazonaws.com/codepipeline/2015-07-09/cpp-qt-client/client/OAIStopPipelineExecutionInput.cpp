...
OAIStopPipelineExecutionInput::OAIStopPipelineExecutionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopPipelineExecutionInput::OAIStopPipelineExecutionInput() {
    this->initializeModel();
}

OAIStopPipelineExecutionInput::~OAIStopPipelineExecutionInput() {}

void OAIStopPipelineExecutionInput::initializeModel() {
    ...
    m_abandon_isSet = false;
    m_abandon_isValid = false;

    m_reason_isSet = false;
    m_reason_isValid = false;
}

void OAIStopPipelineExecutionInput::fromJson(QString jsonString) {
...
void OAIStopPipelineExecutionInput::fromJsonObject(QJsonObject json) {
    ...
    m_abandon_isValid = ::OpenAPI::fromJsonValue(m_abandon, json[QString("abandon")]);
    m_abandon_isSet = !json[QString("abandon")].isNull() && m_abandon_isValid;

    m_reason_isValid = ::OpenAPI::fromJsonValue(m_reason, json[QString("reason")]);
    m_reason_isSet = !json[QString("reason")].isNull() && m_reason_isValid;
}

QString OAIStopPipelineExecutionInput::asJson() const {
...
QJsonObject OAIStopPipelineExecutionInput::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_abandon_isSet) {
        obj.insert(QString("abandon"), ::OpenAPI::toJsonValue(m_abandon));
    }
    if (m_reason_isSet) {
...
QString OAIStopPipelineExecutionInput::getPipelineName() const {
    return m_pipeline_name;
}
void OAIStopPipelineExecutionInput::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIStopPipelineExecutionInput::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIStopPipelineExecutionInput::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

QString OAIStopPipelineExecutionInput::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIStopPipelineExecutionInput::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIStopPipelineExecutionInput::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIStopPipelineExecutionInput::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

bool OAIStopPipelineExecutionInput::getAbandon() const {
    return m_abandon;
}
void OAIStopPipelineExecutionInput::setAbandon(const bool &abandon) {
    m_abandon = abandon;
    m_abandon_isSet = true;
}

bool OAIStopPipelineExecutionInput::is_abandon_Set() const{
    return m_abandon_isSet;
}

bool OAIStopPipelineExecutionInput::is_abandon_Valid() const{
    return m_abandon_isValid;
}

QString OAIStopPipelineExecutionInput::getReason() const {
    return m_reason;
}
void OAIStopPipelineExecutionInput::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIStopPipelineExecutionInput::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIStopPipelineExecutionInput::is_reason_Valid() const{
    return m_reason_isValid;
}

bool OAIStopPipelineExecutionInput::isSet() const {
...
bool OAIStopPipelineExecutionInput::isValid() const {
