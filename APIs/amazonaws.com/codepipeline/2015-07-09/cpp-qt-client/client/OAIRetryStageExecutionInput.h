...
/*
 * OAIRetryStageExecutionInput.h
 *
 * Represents the input of a &lt;code&gt;RetryStageExecution&lt;/code&gt; action.
 */

#ifndef OAIRetryStageExecutionInput_H
#define OAIRetryStageExecutionInput_H

#include <QJsonObject>

#include "OAIStageRetryMode.h"
#include <QString>
...
class OAIRetryStageExecutionInput : public OAIObject {
public:
    OAIRetryStageExecutionInput();
    OAIRetryStageExecutionInput(QString json);
    ~OAIRetryStageExecutionInput() override;
    ...
    OAIStageRetryMode getRetryMode() const;
    void setRetryMode(const OAIStageRetryMode &retry_mode);
    bool is_retry_mode_Set() const;
    bool is_retry_mode_Valid() const;
...
private:
    ...
    OAIStageRetryMode m_retry_mode;
    bool m_retry_mode_isSet;
    bool m_retry_mode_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRetryStageExecutionInput)

#endif // OAIRetryStageExecutionInput_H
