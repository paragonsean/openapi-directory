...
OAIListWebhooksInput::OAIListWebhooksInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListWebhooksInput::OAIListWebhooksInput() {
    this->initializeModel();
}

OAIListWebhooksInput::~OAIListWebhooksInput() {}

void OAIListWebhooksInput::initializeModel() {
...
void OAIListWebhooksInput::fromJson(QString jsonString) {
...
void OAIListWebhooksInput::fromJsonObject(QJsonObject json) {
...
QString OAIListWebhooksInput::asJson() const {
...
QJsonObject OAIListWebhooksInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListWebhooksInput::getNextToken() const {
    return m_next_token;
}
void OAIListWebhooksInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListWebhooksInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListWebhooksInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListWebhooksInput::getMaxResults() const {
    return m_max_results;
}
void OAIListWebhooksInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListWebhooksInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListWebhooksInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListWebhooksInput::isSet() const {
...
bool OAIListWebhooksInput::isValid() const {
