...
#ifndef OAIPipelineContext_H
#define OAIPipelineContext_H
...
class OAIPipelineContext : public OAIObject {
public:
    OAIPipelineContext();
    OAIPipelineContext(QString json);
    ~OAIPipelineContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipelineContext)

#endif // OAIPipelineContext_H
