...
OAIListWebhooksOutput::OAIListWebhooksOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListWebhooksOutput::OAIListWebhooksOutput() {
    this->initializeModel();
}

OAIListWebhooksOutput::~OAIListWebhooksOutput() {}

void OAIListWebhooksOutput::initializeModel() {
...
void OAIListWebhooksOutput::fromJson(QString jsonString) {
...
void OAIListWebhooksOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListWebhooksOutput::asJson() const {
...
QJsonObject OAIListWebhooksOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_webhooks.isSet()) {
...
QList OAIListWebhooksOutput::getWebhooks() const {
    return m_webhooks;
}
void OAIListWebhooksOutput::setWebhooks(const QList &webhooks) {
    m_webhooks = webhooks;
    m_webhooks_isSet = true;
}

bool OAIListWebhooksOutput::is_webhooks_Set() const{
    return m_webhooks_isSet;
}

bool OAIListWebhooksOutput::is_webhooks_Valid() const{
    return m_webhooks_isValid;
}

QString OAIListWebhooksOutput::getNextToken() const {
    return m_next_token;
}
void OAIListWebhooksOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListWebhooksOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListWebhooksOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListWebhooksOutput::isSet() const {
...
bool OAIListWebhooksOutput::isValid() const {
