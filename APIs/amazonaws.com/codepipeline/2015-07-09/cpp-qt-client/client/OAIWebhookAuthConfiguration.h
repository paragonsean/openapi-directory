...
/*
 * OAIWebhookAuthConfiguration.h
 *
 * The authentication applied to incoming webhook trigger requests.
 */

#ifndef OAIWebhookAuthConfiguration_H
#define OAIWebhookAuthConfiguration_H
...
class OAIWebhookAuthConfiguration : public OAIObject {
public:
    OAIWebhookAuthConfiguration();
    OAIWebhookAuthConfiguration(QString json);
    ~OAIWebhookAuthConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookAuthConfiguration)

#endif // OAIWebhookAuthConfiguration_H
