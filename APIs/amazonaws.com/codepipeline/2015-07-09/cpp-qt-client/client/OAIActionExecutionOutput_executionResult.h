...
/*
 * OAIActionExecutionOutput_executionResult.h
 *
 * 
 */

#ifndef OAIActionExecutionOutput_executionResult_H
#define OAIActionExecutionOutput_executionResult_H
...
class OAIActionExecutionOutput_executionResult : public OAIObject {
public:
    OAIActionExecutionOutput_executionResult();
    OAIActionExecutionOutput_executionResult(QString json);
    ~OAIActionExecutionOutput_executionResult() override;
    ...
    QString getExternalExecutionId() const;
    void setExternalExecutionId(const QString &external_execution_id);
    bool is_external_execution_id_Set() const;
    bool is_external_execution_id_Valid() const;

    QString getExternalExecutionSummary() const;
    void setExternalExecutionSummary(const QString &external_execution_summary);
    bool is_external_execution_summary_Set() const;
    bool is_external_execution_summary_Valid() const;

    QString getExternalExecutionUrl() const;
    void setExternalExecutionUrl(const QString &external_execution_url);
    bool is_external_execution_url_Set() const;
    bool is_external_execution_url_Valid() const;
...
private:
    ...
    QString m_external_execution_id;
    bool m_external_execution_id_isSet;
    bool m_external_execution_id_isValid;

    QString m_external_execution_summary;
    bool m_external_execution_summary_isSet;
    bool m_external_execution_summary_isValid;

    QString m_external_execution_url;
    bool m_external_execution_url_isSet;
    bool m_external_execution_url_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIActionExecutionOutput_executionResult)

#endif // OAIActionExecutionOutput_executionResult_H
