...
OAIActionTypeDeclaration_permissions::OAIActionTypeDeclaration_permissions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionTypeDeclaration_permissions::OAIActionTypeDeclaration_permissions() {
    this->initializeModel();
}

OAIActionTypeDeclaration_permissions::~OAIActionTypeDeclaration_permissions() {}

void OAIActionTypeDeclaration_permissions::initializeModel() {

    m_allowed_accounts_isSet = false;
    m_allowed_accounts_isValid = false;
}

void OAIActionTypeDeclaration_permissions::fromJson(QString jsonString) {
...
void OAIActionTypeDeclaration_permissions::fromJsonObject(QJsonObject json) {
...
QString OAIActionTypeDeclaration_permissions::asJson() const {
...
QJsonObject OAIActionTypeDeclaration_permissions::asJsonObject() const {
    QJsonObject obj;
...
QList OAIActionTypeDeclaration_permissions::getAllowedAccounts() const {
    return m_allowed_accounts;
}
void OAIActionTypeDeclaration_permissions::setAllowedAccounts(const QList &allowed_accounts) {
    m_allowed_accounts = allowed_accounts;
    m_allowed_accounts_isSet = true;
}

bool OAIActionTypeDeclaration_permissions::is_allowed_accounts_Set() const{
    return m_allowed_accounts_isSet;
}

bool OAIActionTypeDeclaration_permissions::is_allowed_accounts_Valid() const{
    return m_allowed_accounts_isValid;
}

bool OAIActionTypeDeclaration_permissions::isSet() const {
...
bool OAIActionTypeDeclaration_permissions::isValid() const {
