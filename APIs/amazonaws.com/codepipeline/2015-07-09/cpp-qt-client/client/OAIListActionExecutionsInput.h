...
/*
 * OAIListActionExecutionsInput.h
 *
 * 
 */

#ifndef OAIListActionExecutionsInput_H
#define OAIListActionExecutionsInput_H

#include <QJsonObject>

#include "OAIListActionExecutionsInput_filter.h"
#include <QString>
...
namespace OpenAPI {
class OAIListActionExecutionsInput_filter;

class OAIListActionExecutionsInput : public OAIObject {
public:
    OAIListActionExecutionsInput();
    OAIListActionExecutionsInput(QString json);
    ~OAIListActionExecutionsInput() override;
    ...
    OAIListActionExecutionsInput_filter getFilter() const;
    void setFilter(const OAIListActionExecutionsInput_filter &filter);
...
private:
    ...
    OAIListActionExecutionsInput_filter m_filter;
    bool m_filter_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListActionExecutionsInput)

#endif // OAIListActionExecutionsInput_H
