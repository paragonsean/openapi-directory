...
OAIActionRevision::OAIActionRevision(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionRevision::OAIActionRevision() {
    this->initializeModel();
}

OAIActionRevision::~OAIActionRevision() {}

void OAIActionRevision::initializeModel() {

    m_revision_id_isSet = false;
    m_revision_id_isValid = false;

    m_revision_change_id_isSet = false;
    m_revision_change_id_isValid = false;

    m_created_isSet = false;
    m_created_isValid = false;
}

void OAIActionRevision::fromJson(QString jsonString) {
...
void OAIActionRevision::fromJsonObject(QJsonObject json) {
    ...
    m_revision_change_id_isValid = ::OpenAPI::fromJsonValue(m_revision_change_id, json[QString("revisionChangeId")]);
    m_revision_change_id_isSet = !json[QString("revisionChangeId")].isNull() && m_revision_change_id_isValid;

    m_created_isValid = ::OpenAPI::fromJsonValue(m_created, json[QString("created")]);
    m_created_isSet = !json[QString("created")].isNull() && m_created_isValid;
}

QString OAIActionRevision::asJson() const {
...
QJsonObject OAIActionRevision::asJsonObject() const {
    QJsonObject obj;
    if (m_revision_id_isSet) {
        obj.insert(QString("revisionId"), ::OpenAPI::toJsonValue(m_revision_id));
    }
    if (m_revision_change_id_isSet) {
        obj.insert(QString("revisionChangeId"), ::OpenAPI::toJsonValue(m_revision_change_id));
    }
    if (m_created_isSet) {
...
QString OAIActionRevision::getRevisionId() const {
    return m_revision_id;
}
void OAIActionRevision::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIActionRevision::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIActionRevision::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

QString OAIActionRevision::getRevisionChangeId() const {
    return m_revision_change_id;
}
void OAIActionRevision::setRevisionChangeId(const QString &revision_change_id) {
    m_revision_change_id = revision_change_id;
    m_revision_change_id_isSet = true;
}

bool OAIActionRevision::is_revision_change_id_Set() const{
    return m_revision_change_id_isSet;
}

bool OAIActionRevision::is_revision_change_id_Valid() const{
    return m_revision_change_id_isValid;
}

QDateTime OAIActionRevision::getCreated() const {
    return m_created;
}
void OAIActionRevision::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIActionRevision::is_created_Set() const{
    return m_created_isSet;
}

bool OAIActionRevision::is_created_Valid() const{
    return m_created_isValid;
}

bool OAIActionRevision::isSet() const {
...
bool OAIActionRevision::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_revision_id_isValid && m_revision_change_id_isValid && m_created_isValid && true;
}
