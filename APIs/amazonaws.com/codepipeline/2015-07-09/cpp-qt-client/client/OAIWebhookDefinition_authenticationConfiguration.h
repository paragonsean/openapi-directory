...
/*
 * OAIWebhookDefinition_authenticationConfiguration.h
 *
 * 
 */

#ifndef OAIWebhookDefinition_authenticationConfiguration_H
#define OAIWebhookDefinition_authenticationConfiguration_H
...
class OAIWebhookDefinition_authenticationConfiguration : public OAIObject {
public:
    OAIWebhookDefinition_authenticationConfiguration();
    OAIWebhookDefinition_authenticationConfiguration(QString json);
    ~OAIWebhookDefinition_authenticationConfiguration() override;
    ...
    QString getAllowedIpRange() const;
    void setAllowedIpRange(const QString &allowed_ip_range);
    bool is_allowed_ip_range_Set() const;
    bool is_allowed_ip_range_Valid() const;
...
private:
    ...
    QString m_allowed_ip_range;
    bool m_allowed_ip_range_isSet;
    bool m_allowed_ip_range_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookDefinition_authenticationConfiguration)

#endif // OAIWebhookDefinition_authenticationConfiguration_H
