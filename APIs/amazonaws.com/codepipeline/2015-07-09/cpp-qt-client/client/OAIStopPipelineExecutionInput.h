...
/*
 * OAIStopPipelineExecutionInput.h
 *
 * 
 */

#ifndef OAIStopPipelineExecutionInput_H
#define OAIStopPipelineExecutionInput_H
...
class OAIStopPipelineExecutionInput : public OAIObject {
public:
    OAIStopPipelineExecutionInput();
    OAIStopPipelineExecutionInput(QString json);
    ~OAIStopPipelineExecutionInput() override;
    ...
    void setAbandon(const bool &abandon);
    bool is_abandon_Set() const;
    bool is_abandon_Valid() const;
...
private:
    ...
    bool m_abandon;
    bool m_abandon_isSet;
    bool m_abandon_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopPipelineExecutionInput)

#endif // OAIStopPipelineExecutionInput_H
