...
/*
 * OAIAcknowledgeThirdPartyJobInput.h
 *
 * Represents the input of an AcknowledgeThirdPartyJob action.
 */

#ifndef OAIAcknowledgeThirdPartyJobInput_H
#define OAIAcknowledgeThirdPartyJobInput_H
...
class OAIAcknowledgeThirdPartyJobInput : public OAIObject {
public:
    OAIAcknowledgeThirdPartyJobInput();
    OAIAcknowledgeThirdPartyJobInput(QString json);
    ~OAIAcknowledgeThirdPartyJobInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcknowledgeThirdPartyJobInput)

#endif // OAIAcknowledgeThirdPartyJobInput_H
