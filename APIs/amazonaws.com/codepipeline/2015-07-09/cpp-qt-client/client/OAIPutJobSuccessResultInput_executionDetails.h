...
/*
 * OAIPutJobSuccessResultInput_executionDetails.h
 *
 * 
 */

#ifndef OAIPutJobSuccessResultInput_executionDetails_H
#define OAIPutJobSuccessResultInput_executionDetails_H
...
class OAIPutJobSuccessResultInput_executionDetails : public OAIObject {
public:
    OAIPutJobSuccessResultInput_executionDetails();
    OAIPutJobSuccessResultInput_executionDetails(QString json);
    ~OAIPutJobSuccessResultInput_executionDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutJobSuccessResultInput_executionDetails)

#endif // OAIPutJobSuccessResultInput_executionDetails_H
