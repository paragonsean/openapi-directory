...
/*
 * OAIActionTypeIdentifier.h
 *
 * Specifies the category, owner, provider, and version of the action type.
 */

#ifndef OAIActionTypeIdentifier_H
#define OAIActionTypeIdentifier_H
...
class OAIActionTypeIdentifier : public OAIObject {
public:
    OAIActionTypeIdentifier();
    OAIActionTypeIdentifier(QString json);
    ~OAIActionTypeIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeIdentifier)

#endif // OAIActionTypeIdentifier_H
