...
/*
 * OAIPipelineDeclaration.h
 *
 * Represents the structure of actions and stages to be performed in the pipeline.
 */

#ifndef OAIPipelineDeclaration_H
#define OAIPipelineDeclaration_H
...
class OAIPipelineDeclaration : public OAIObject {
public:
    OAIPipelineDeclaration();
    OAIPipelineDeclaration(QString json);
    ~OAIPipelineDeclaration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipelineDeclaration)

#endif // OAIPipelineDeclaration_H
