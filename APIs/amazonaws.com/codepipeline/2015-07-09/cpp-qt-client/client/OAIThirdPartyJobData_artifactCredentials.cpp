...
#include "OAIThirdPartyJobData_artifactCredentials.h"
...
OAIThirdPartyJobData_artifactCredentials::OAIThirdPartyJobData_artifactCredentials(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIThirdPartyJobData_artifactCredentials::OAIThirdPartyJobData_artifactCredentials() {
    this->initializeModel();
}

OAIThirdPartyJobData_artifactCredentials::~OAIThirdPartyJobData_artifactCredentials() {}

void OAIThirdPartyJobData_artifactCredentials::initializeModel() {
...
void OAIThirdPartyJobData_artifactCredentials::fromJson(QString jsonString) {
...
void OAIThirdPartyJobData_artifactCredentials::fromJsonObject(QJsonObject json) {
...
QString OAIThirdPartyJobData_artifactCredentials::asJson() const {
...
QJsonObject OAIThirdPartyJobData_artifactCredentials::asJsonObject() const {
    QJsonObject obj;
...
QString OAIThirdPartyJobData_artifactCredentials::getAccessKeyId() const {
    return m_access_key_id;
}
void OAIThirdPartyJobData_artifactCredentials::setAccessKeyId(const QString &access_key_id) {
    m_access_key_id = access_key_id;
    m_access_key_id_isSet = true;
}

bool OAIThirdPartyJobData_artifactCredentials::is_access_key_id_Set() const{
    return m_access_key_id_isSet;
}

bool OAIThirdPartyJobData_artifactCredentials::is_access_key_id_Valid() const{
    return m_access_key_id_isValid;
}

QString OAIThirdPartyJobData_artifactCredentials::getSecretAccessKey() const {
    return m_secret_access_key;
}
void OAIThirdPartyJobData_artifactCredentials::setSecretAccessKey(const QString &secret_access_key) {
    m_secret_access_key = secret_access_key;
    m_secret_access_key_isSet = true;
}

bool OAIThirdPartyJobData_artifactCredentials::is_secret_access_key_Set() const{
    return m_secret_access_key_isSet;
}

bool OAIThirdPartyJobData_artifactCredentials::is_secret_access_key_Valid() const{
    return m_secret_access_key_isValid;
}

QString OAIThirdPartyJobData_artifactCredentials::getSessionToken() const {
    return m_session_token;
}
void OAIThirdPartyJobData_artifactCredentials::setSessionToken(const QString &session_token) {
    m_session_token = session_token;
    m_session_token_isSet = true;
}

bool OAIThirdPartyJobData_artifactCredentials::is_session_token_Set() const{
    return m_session_token_isSet;
}

bool OAIThirdPartyJobData_artifactCredentials::is_session_token_Valid() const{
    return m_session_token_isValid;
}

bool OAIThirdPartyJobData_artifactCredentials::isSet() const {
...
bool OAIThirdPartyJobData_artifactCredentials::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_access_key_id_isValid && m_secret_access_key_isValid && m_session_token_isValid && true;
}
