...
/*
 * OAIExecutorConfiguration_lambdaExecutorConfiguration.h
 *
 * 
 */

#ifndef OAIExecutorConfiguration_lambdaExecutorConfiguration_H
#define OAIExecutorConfiguration_lambdaExecutorConfiguration_H
...
class OAIExecutorConfiguration_lambdaExecutorConfiguration : public OAIObject {
public:
    OAIExecutorConfiguration_lambdaExecutorConfiguration();
    OAIExecutorConfiguration_lambdaExecutorConfiguration(QString json);
    ~OAIExecutorConfiguration_lambdaExecutorConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecutorConfiguration_lambdaExecutorConfiguration)

#endif // OAIExecutorConfiguration_lambdaExecutorConfiguration_H
