...
OAIPollForJobsInput_actionTypeId::OAIPollForJobsInput_actionTypeId(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPollForJobsInput_actionTypeId::OAIPollForJobsInput_actionTypeId() {
    this->initializeModel();
}

OAIPollForJobsInput_actionTypeId::~OAIPollForJobsInput_actionTypeId() {}

void OAIPollForJobsInput_actionTypeId::initializeModel() {
...
void OAIPollForJobsInput_actionTypeId::fromJson(QString jsonString) {
...
void OAIPollForJobsInput_actionTypeId::fromJsonObject(QJsonObject json) {
...
QString OAIPollForJobsInput_actionTypeId::asJson() const {
...
QJsonObject OAIPollForJobsInput_actionTypeId::asJsonObject() const {
    QJsonObject obj;
    if (m_category.isSet()) {
...
OAIActionCategory OAIPollForJobsInput_actionTypeId::getCategory() const {
    return m_category;
}
void OAIPollForJobsInput_actionTypeId::setCategory(const OAIActionCategory &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIPollForJobsInput_actionTypeId::is_category_Set() const{
    return m_category_isSet;
}

bool OAIPollForJobsInput_actionTypeId::is_category_Valid() const{
    return m_category_isValid;
}

OAIActionOwner OAIPollForJobsInput_actionTypeId::getOwner() const {
    return m_owner;
}
void OAIPollForJobsInput_actionTypeId::setOwner(const OAIActionOwner &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAIPollForJobsInput_actionTypeId::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAIPollForJobsInput_actionTypeId::is_owner_Valid() const{
    return m_owner_isValid;
}

QString OAIPollForJobsInput_actionTypeId::getProvider() const {
    return m_provider;
}
void OAIPollForJobsInput_actionTypeId::setProvider(const QString &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAIPollForJobsInput_actionTypeId::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAIPollForJobsInput_actionTypeId::is_provider_Valid() const{
    return m_provider_isValid;
}

QString OAIPollForJobsInput_actionTypeId::getVersion() const {
    return m_version;
}
void OAIPollForJobsInput_actionTypeId::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIPollForJobsInput_actionTypeId::is_version_Set() const{
    return m_version_isSet;
}

bool OAIPollForJobsInput_actionTypeId::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIPollForJobsInput_actionTypeId::isSet() const {
...
bool OAIPollForJobsInput_actionTypeId::isValid() const {
