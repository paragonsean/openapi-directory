...
OAIGetActionTypeInput::OAIGetActionTypeInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetActionTypeInput::OAIGetActionTypeInput() {
    this->initializeModel();
}

OAIGetActionTypeInput::~OAIGetActionTypeInput() {}

void OAIGetActionTypeInput::initializeModel() {
...
void OAIGetActionTypeInput::fromJson(QString jsonString) {
...
void OAIGetActionTypeInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetActionTypeInput::asJson() const {
...
QJsonObject OAIGetActionTypeInput::asJsonObject() const {
    QJsonObject obj;
    if (m_category.isSet()) {
...
OAIActionCategory OAIGetActionTypeInput::getCategory() const {
    return m_category;
}
void OAIGetActionTypeInput::setCategory(const OAIActionCategory &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIGetActionTypeInput::is_category_Set() const{
    return m_category_isSet;
}

bool OAIGetActionTypeInput::is_category_Valid() const{
    return m_category_isValid;
}

QString OAIGetActionTypeInput::getOwner() const {
    return m_owner;
}
void OAIGetActionTypeInput::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAIGetActionTypeInput::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAIGetActionTypeInput::is_owner_Valid() const{
    return m_owner_isValid;
}

QString OAIGetActionTypeInput::getProvider() const {
    return m_provider;
}
void OAIGetActionTypeInput::setProvider(const QString &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAIGetActionTypeInput::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAIGetActionTypeInput::is_provider_Valid() const{
    return m_provider_isValid;
}

QString OAIGetActionTypeInput::getVersion() const {
    return m_version;
}
void OAIGetActionTypeInput::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIGetActionTypeInput::is_version_Set() const{
    return m_version_isSet;
}

bool OAIGetActionTypeInput::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIGetActionTypeInput::isSet() const {
...
bool OAIGetActionTypeInput::isValid() const {
