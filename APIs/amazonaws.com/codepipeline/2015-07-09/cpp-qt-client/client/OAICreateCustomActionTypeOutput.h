...
/*
 * OAICreateCustomActionTypeOutput.h
 *
 * Represents the output of a &lt;code&gt;CreateCustomActionType&lt;/code&gt; operation.
 */

#ifndef OAICreateCustomActionTypeOutput_H
#define OAICreateCustomActionTypeOutput_H

#include <QJsonObject>

#include "OAICreateCustomActionTypeOutput_actionType.h"
#include <QList>
...
namespace OpenAPI {
class OAICreateCustomActionTypeOutput_actionType;

class OAICreateCustomActionTypeOutput : public OAIObject {
public:
    OAICreateCustomActionTypeOutput();
    OAICreateCustomActionTypeOutput(QString json);
    ~OAICreateCustomActionTypeOutput() override;
    ...
    OAICreateCustomActionTypeOutput_actionType getActionType() const;
    void setActionType(const OAICreateCustomActionTypeOutput_actionType &action_type);
...
private:
    ...
    OAICreateCustomActionTypeOutput_actionType m_action_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomActionTypeOutput)

#endif // OAICreateCustomActionTypeOutput_H
