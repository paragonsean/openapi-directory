...
OAIPipelineMetadata::OAIPipelineMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPipelineMetadata::OAIPipelineMetadata() {
    this->initializeModel();
}

OAIPipelineMetadata::~OAIPipelineMetadata() {}

void OAIPipelineMetadata::initializeModel() {
...
void OAIPipelineMetadata::fromJson(QString jsonString) {
...
void OAIPipelineMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIPipelineMetadata::asJson() const {
...
QJsonObject OAIPipelineMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPipelineMetadata::getPipelineArn() const {
    return m_pipeline_arn;
}
void OAIPipelineMetadata::setPipelineArn(const QString &pipeline_arn) {
    m_pipeline_arn = pipeline_arn;
    m_pipeline_arn_isSet = true;
}

bool OAIPipelineMetadata::is_pipeline_arn_Set() const{
    return m_pipeline_arn_isSet;
}

bool OAIPipelineMetadata::is_pipeline_arn_Valid() const{
    return m_pipeline_arn_isValid;
}

QDateTime OAIPipelineMetadata::getCreated() const {
    return m_created;
}
void OAIPipelineMetadata::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIPipelineMetadata::is_created_Set() const{
    return m_created_isSet;
}

bool OAIPipelineMetadata::is_created_Valid() const{
    return m_created_isValid;
}

QDateTime OAIPipelineMetadata::getUpdated() const {
    return m_updated;
}
void OAIPipelineMetadata::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIPipelineMetadata::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIPipelineMetadata::is_updated_Valid() const{
    return m_updated_isValid;
}

QDateTime OAIPipelineMetadata::getPollingDisabledAt() const {
    return m_polling_disabled_at;
}
void OAIPipelineMetadata::setPollingDisabledAt(const QDateTime &polling_disabled_at) {
    m_polling_disabled_at = polling_disabled_at;
    m_polling_disabled_at_isSet = true;
}

bool OAIPipelineMetadata::is_polling_disabled_at_Set() const{
    return m_polling_disabled_at_isSet;
}

bool OAIPipelineMetadata::is_polling_disabled_at_Valid() const{
    return m_polling_disabled_at_isValid;
}

bool OAIPipelineMetadata::isSet() const {
...
bool OAIPipelineMetadata::isValid() const {
