...
#include "OAIBlockerDeclaration.h"
...
OAIBlockerDeclaration::OAIBlockerDeclaration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBlockerDeclaration::OAIBlockerDeclaration() {
    this->initializeModel();
}

OAIBlockerDeclaration::~OAIBlockerDeclaration() {}

void OAIBlockerDeclaration::initializeModel() {
...
void OAIBlockerDeclaration::fromJson(QString jsonString) {
...
void OAIBlockerDeclaration::fromJsonObject(QJsonObject json) {
...
QString OAIBlockerDeclaration::asJson() const {
...
QJsonObject OAIBlockerDeclaration::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIBlockerDeclaration::getName() const {
    return m_name;
}
void OAIBlockerDeclaration::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIBlockerDeclaration::is_name_Set() const{
    return m_name_isSet;
}

bool OAIBlockerDeclaration::is_name_Valid() const{
    return m_name_isValid;
}

OAIBlockerType OAIBlockerDeclaration::getType() const {
    return m_type;
}
void OAIBlockerDeclaration::setType(const OAIBlockerType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIBlockerDeclaration::is_type_Set() const{
    return m_type_isSet;
}

bool OAIBlockerDeclaration::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIBlockerDeclaration::isSet() const {
...
bool OAIBlockerDeclaration::isValid() const {
