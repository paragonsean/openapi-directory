...
/*
 * OAIActionExecutionStatus.h
 *
 * 
 */

#ifndef OAIActionExecutionStatus_H
#define OAIActionExecutionStatus_H
...
class OAIActionExecutionStatus : public OAIEnum {
public:
    OAIActionExecutionStatus();
    OAIActionExecutionStatus(QString json);
    ~OAIActionExecutionStatus() override;
    ...
    enum class eOAIActionExecutionStatus {
    ...
    OAIActionExecutionStatus::eOAIActionExecutionStatus getValue() const;
    void setValue(const OAIActionExecutionStatus::eOAIActionExecutionStatus& value);
...
private:
    ...
    eOAIActionExecutionStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionExecutionStatus)

#endif // OAIActionExecutionStatus_H
