...
/*
 * OAIGetPipelineOutput_metadata.h
 *
 * 
 */

#ifndef OAIGetPipelineOutput_metadata_H
#define OAIGetPipelineOutput_metadata_H
...
class OAIGetPipelineOutput_metadata : public OAIObject {
public:
    OAIGetPipelineOutput_metadata();
    OAIGetPipelineOutput_metadata(QString json);
    ~OAIGetPipelineOutput_metadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPipelineOutput_metadata)

#endif // OAIGetPipelineOutput_metadata_H
