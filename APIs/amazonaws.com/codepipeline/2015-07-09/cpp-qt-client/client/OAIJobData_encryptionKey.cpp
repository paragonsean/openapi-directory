...
OAIJobData_encryptionKey::OAIJobData_encryptionKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJobData_encryptionKey::OAIJobData_encryptionKey() {
    this->initializeModel();
}

OAIJobData_encryptionKey::~OAIJobData_encryptionKey() {}

void OAIJobData_encryptionKey::initializeModel() {
...
void OAIJobData_encryptionKey::fromJson(QString jsonString) {
...
void OAIJobData_encryptionKey::fromJsonObject(QJsonObject json) {
...
QString OAIJobData_encryptionKey::asJson() const {
...
QJsonObject OAIJobData_encryptionKey::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIJobData_encryptionKey::getId() const {
    return m_id;
}
void OAIJobData_encryptionKey::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIJobData_encryptionKey::is_id_Set() const{
    return m_id_isSet;
}

bool OAIJobData_encryptionKey::is_id_Valid() const{
    return m_id_isValid;
}

OAIEncryptionKeyType OAIJobData_encryptionKey::getType() const {
    return m_type;
}
void OAIJobData_encryptionKey::setType(const OAIEncryptionKeyType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIJobData_encryptionKey::is_type_Set() const{
    return m_type_isSet;
}

bool OAIJobData_encryptionKey::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIJobData_encryptionKey::isSet() const {
...
bool OAIJobData_encryptionKey::isValid() const {
