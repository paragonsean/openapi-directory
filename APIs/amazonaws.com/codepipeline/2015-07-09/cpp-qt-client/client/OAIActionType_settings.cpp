...
OAIActionType_settings::OAIActionType_settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionType_settings::OAIActionType_settings() {
    this->initializeModel();
}

OAIActionType_settings::~OAIActionType_settings() {}

void OAIActionType_settings::initializeModel() {
...
void OAIActionType_settings::fromJson(QString jsonString) {
...
void OAIActionType_settings::fromJsonObject(QJsonObject json) {
...
QString OAIActionType_settings::asJson() const {
...
QJsonObject OAIActionType_settings::asJsonObject() const {
    QJsonObject obj;
...
QString OAIActionType_settings::getThirdPartyConfigurationUrl() const {
    return m_third_party_configuration_url;
}
void OAIActionType_settings::setThirdPartyConfigurationUrl(const QString &third_party_configuration_url) {
    m_third_party_configuration_url = third_party_configuration_url;
    m_third_party_configuration_url_isSet = true;
}

bool OAIActionType_settings::is_third_party_configuration_url_Set() const{
    return m_third_party_configuration_url_isSet;
}

bool OAIActionType_settings::is_third_party_configuration_url_Valid() const{
    return m_third_party_configuration_url_isValid;
}

QString OAIActionType_settings::getEntityUrlTemplate() const {
    return m_entity_url_template;
}
void OAIActionType_settings::setEntityUrlTemplate(const QString &entity_url_template) {
    m_entity_url_template = entity_url_template;
    m_entity_url_template_isSet = true;
}

bool OAIActionType_settings::is_entity_url_template_Set() const{
    return m_entity_url_template_isSet;
}

bool OAIActionType_settings::is_entity_url_template_Valid() const{
    return m_entity_url_template_isValid;
}

QString OAIActionType_settings::getExecutionUrlTemplate() const {
    return m_execution_url_template;
}
void OAIActionType_settings::setExecutionUrlTemplate(const QString &execution_url_template) {
    m_execution_url_template = execution_url_template;
    m_execution_url_template_isSet = true;
}

bool OAIActionType_settings::is_execution_url_template_Set() const{
    return m_execution_url_template_isSet;
}

bool OAIActionType_settings::is_execution_url_template_Valid() const{
    return m_execution_url_template_isValid;
}

QString OAIActionType_settings::getRevisionUrlTemplate() const {
    return m_revision_url_template;
}
void OAIActionType_settings::setRevisionUrlTemplate(const QString &revision_url_template) {
    m_revision_url_template = revision_url_template;
    m_revision_url_template_isSet = true;
}

bool OAIActionType_settings::is_revision_url_template_Set() const{
    return m_revision_url_template_isSet;
}

bool OAIActionType_settings::is_revision_url_template_Valid() const{
    return m_revision_url_template_isValid;
}

bool OAIActionType_settings::isSet() const {
...
bool OAIActionType_settings::isValid() const {
