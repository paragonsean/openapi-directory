...
OAIThirdPartyJobDetails_data::OAIThirdPartyJobDetails_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIThirdPartyJobDetails_data::OAIThirdPartyJobDetails_data() {
    this->initializeModel();
}

OAIThirdPartyJobDetails_data::~OAIThirdPartyJobDetails_data() {}

void OAIThirdPartyJobDetails_data::initializeModel() {
...
void OAIThirdPartyJobDetails_data::fromJson(QString jsonString) {
...
void OAIThirdPartyJobDetails_data::fromJsonObject(QJsonObject json) {
...
QString OAIThirdPartyJobDetails_data::asJson() const {
...
QJsonObject OAIThirdPartyJobDetails_data::asJsonObject() const {
    QJsonObject obj;
...
OAIPollForJobsInput_actionTypeId OAIThirdPartyJobDetails_data::getActionTypeId() const {
    return m_action_type_id;
}
void OAIThirdPartyJobDetails_data::setActionTypeId(const OAIPollForJobsInput_actionTypeId &action_type_id) {
    m_action_type_id = action_type_id;
    m_action_type_id_isSet = true;
}

bool OAIThirdPartyJobDetails_data::is_action_type_id_Set() const{
    return m_action_type_id_isSet;
}

bool OAIThirdPartyJobDetails_data::is_action_type_id_Valid() const{
    return m_action_type_id_isValid;
}

OAIJobData_actionConfiguration OAIThirdPartyJobDetails_data::getActionConfiguration() const {
    return m_action_configuration;
}
void OAIThirdPartyJobDetails_data::setActionConfiguration(const OAIJobData_actionConfiguration &action_configuration) {
    m_action_configuration = action_configuration;
    m_action_configuration_isSet = true;
}

bool OAIThirdPartyJobDetails_data::is_action_configuration_Set() const{
    return m_action_configuration_isSet;
}

bool OAIThirdPartyJobDetails_data::is_action_configuration_Valid() const{
    return m_action_configuration_isValid;
}

OAIThirdPartyJobData_pipelineContext OAIThirdPartyJobDetails_data::getPipelineContext() const {
    return m_pipeline_context;
}
void OAIThirdPartyJobDetails_data::setPipelineContext(const OAIThirdPartyJobData_pipelineContext &pipeline_context) {
    m_pipeline_context = pipeline_context;
    m_pipeline_context_isSet = true;
}

bool OAIThirdPartyJobDetails_data::is_pipeline_context_Set() const{
    return m_pipeline_context_isSet;
}

bool OAIThirdPartyJobDetails_data::is_pipeline_context_Valid() const{
    return m_pipeline_context_isValid;
}

QList OAIThirdPartyJobDetails_data::getInputArtifacts() const {
    return m_input_artifacts;
}
void OAIThirdPartyJobDetails_data::setInputArtifacts(const QList &input_artifacts) {
    m_input_artifacts = input_artifacts;
    m_input_artifacts_isSet = true;
}

bool OAIThirdPartyJobDetails_data::is_input_artifacts_Set() const{
    return m_input_artifacts_isSet;
}

bool OAIThirdPartyJobDetails_data::is_input_artifacts_Valid() const{
    return m_input_artifacts_isValid;
}

QList OAIThirdPartyJobDetails_data::getOutputArtifacts() const {
    return m_output_artifacts;
}
void OAIThirdPartyJobDetails_data::setOutputArtifacts(const QList &output_artifacts) {
    m_output_artifacts = output_artifacts;
    m_output_artifacts_isSet = true;
}

bool OAIThirdPartyJobDetails_data::is_output_artifacts_Set() const{
    return m_output_artifacts_isSet;
}

bool OAIThirdPartyJobDetails_data::is_output_artifacts_Valid() const{
    return m_output_artifacts_isValid;
}

OAIThirdPartyJobData_artifactCredentials OAIThirdPartyJobDetails_data::getArtifactCredentials() const {
    return m_artifact_credentials;
}
void OAIThirdPartyJobDetails_data::setArtifactCredentials(const OAIThirdPartyJobData_artifactCredentials &artifact_credentials) {
    m_artifact_credentials = artifact_credentials;
    m_artifact_credentials_isSet = true;
}

bool OAIThirdPartyJobDetails_data::is_artifact_credentials_Set() const{
    return m_artifact_credentials_isSet;
}

bool OAIThirdPartyJobDetails_data::is_artifact_credentials_Valid() const{
    return m_artifact_credentials_isValid;
}

QString OAIThirdPartyJobDetails_data::getContinuationToken() const {
    return m_continuation_token;
}
void OAIThirdPartyJobDetails_data::setContinuationToken(const QString &continuation_token) {
    m_continuation_token = continuation_token;
    m_continuation_token_isSet = true;
}

bool OAIThirdPartyJobDetails_data::is_continuation_token_Set() const{
    return m_continuation_token_isSet;
}

bool OAIThirdPartyJobDetails_data::is_continuation_token_Valid() const{
    return m_continuation_token_isValid;
}

OAIThirdPartyJobData_encryptionKey OAIThirdPartyJobDetails_data::getEncryptionKey() const {
    return m_encryption_key;
}
void OAIThirdPartyJobDetails_data::setEncryptionKey(const OAIThirdPartyJobData_encryptionKey &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAIThirdPartyJobDetails_data::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAIThirdPartyJobDetails_data::is_encryption_key_Valid() const{
    return m_encryption_key_isValid;
}

bool OAIThirdPartyJobDetails_data::isSet() const {
...
bool OAIThirdPartyJobDetails_data::isValid() const {
