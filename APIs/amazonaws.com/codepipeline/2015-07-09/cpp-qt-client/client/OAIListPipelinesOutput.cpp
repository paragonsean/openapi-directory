...
QList OAIListPipelinesOutput::getPipelines() const {
    return m_pipelines;
}
void OAIListPipelinesOutput::setPipelines(const QList &pipelines) {
    m_pipelines = pipelines;
    m_pipelines_isSet = true;
}

bool OAIListPipelinesOutput::is_pipelines_Set() const{
    return m_pipelines_isSet;
}

bool OAIListPipelinesOutput::is_pipelines_Valid() const{
    return m_pipelines_isValid;
}

QString OAIListPipelinesOutput::getNextToken() const {
    return m_next_token;
}
void OAIListPipelinesOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPipelinesOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPipelinesOutput::is_next_token_Valid() const{
