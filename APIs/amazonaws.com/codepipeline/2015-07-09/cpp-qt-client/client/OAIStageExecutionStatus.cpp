...
#include "OAIStageExecutionStatus.h"
...
OAIStageExecutionStatus::OAIStageExecutionStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStageExecutionStatus::OAIStageExecutionStatus() {
    this->initializeModel();
}

OAIStageExecutionStatus::~OAIStageExecutionStatus() {}

void OAIStageExecutionStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIStageExecutionStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIStageExecutionStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Cancelled", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStageExecutionStatus::CANCELLED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("InProgress", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStageExecutionStatus::INPROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Failed", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStageExecutionStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Stopped", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStageExecutionStatus::STOPPED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Stopping", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStageExecutionStatus::STOPPING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Succeeded", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStageExecutionStatus::SUCCEEDED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIStageExecutionStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIStageExecutionStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIStageExecutionStatus::CANCELLED:
            val = "Cancelled";
            break;
        case eOAIStageExecutionStatus::INPROGRESS:
            val = "InProgress";
            break;
        case eOAIStageExecutionStatus::FAILED:
            val = "Failed";
            break;
        case eOAIStageExecutionStatus::STOPPED:
            val = "Stopped";
            break;
        case eOAIStageExecutionStatus::STOPPING:
            val = "Stopping";
            break;
        case eOAIStageExecutionStatus::SUCCEEDED:
            val = "Succeeded";
            break;
        default:
            break;
...
QJsonValue OAIStageExecutionStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIStageExecutionStatus::eOAIStageExecutionStatus OAIStageExecutionStatus::getValue() const {
    return m_value;
}

void OAIStageExecutionStatus::setValue(const OAIStageExecutionStatus::eOAIStageExecutionStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIStageExecutionStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIStageExecutionStatus::isValid() const {
