...
OAIPollForJobsInput::OAIPollForJobsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPollForJobsInput::OAIPollForJobsInput() {
    this->initializeModel();
}

OAIPollForJobsInput::~OAIPollForJobsInput() {}

void OAIPollForJobsInput::initializeModel() {

    m_action_type_id_isSet = false;
    m_action_type_id_isValid = false;

    m_max_batch_size_isSet = false;
    m_max_batch_size_isValid = false;

    m_query_param_isSet = false;
    m_query_param_isValid = false;
}

void OAIPollForJobsInput::fromJson(QString jsonString) {
...
void OAIPollForJobsInput::fromJsonObject(QJsonObject json) {
    ...
    m_max_batch_size_isValid = ::OpenAPI::fromJsonValue(m_max_batch_size, json[QString("maxBatchSize")]);
    m_max_batch_size_isSet = !json[QString("maxBatchSize")].isNull() && m_max_batch_size_isValid;

    m_query_param_isValid = ::OpenAPI::fromJsonValue(m_query_param, json[QString("queryParam")]);
    m_query_param_isSet = !json[QString("queryParam")].isNull() && m_query_param_isValid;
}

QString OAIPollForJobsInput::asJson() const {
...
QJsonObject OAIPollForJobsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_action_type_id.isSet()) {
        obj.insert(QString("actionTypeId"), ::OpenAPI::toJsonValue(m_action_type_id));
    }
    if (m_max_batch_size_isSet) {
        obj.insert(QString("maxBatchSize"), ::OpenAPI::toJsonValue(m_max_batch_size));
    }
    if (m_query_param.isSet()) {
        obj.insert(QString("queryParam"), ::OpenAPI::toJsonValue(m_query_param));
    }
    return obj;
}

OAIPollForJobsInput_actionTypeId OAIPollForJobsInput::getActionTypeId() const {
    return m_action_type_id;
}
void OAIPollForJobsInput::setActionTypeId(const OAIPollForJobsInput_actionTypeId &action_type_id) {
    m_action_type_id = action_type_id;
    m_action_type_id_isSet = true;
}

bool OAIPollForJobsInput::is_action_type_id_Set() const{
    return m_action_type_id_isSet;
}

bool OAIPollForJobsInput::is_action_type_id_Valid() const{
    return m_action_type_id_isValid;
}

qint32 OAIPollForJobsInput::getMaxBatchSize() const {
    return m_max_batch_size;
}
void OAIPollForJobsInput::setMaxBatchSize(const qint32 &max_batch_size) {
    m_max_batch_size = max_batch_size;
    m_max_batch_size_isSet = true;
}

bool OAIPollForJobsInput::is_max_batch_size_Set() const{
    return m_max_batch_size_isSet;
}

bool OAIPollForJobsInput::is_max_batch_size_Valid() const{
    return m_max_batch_size_isValid;
}

QMap OAIPollForJobsInput::getQueryParam() const {
    return m_query_param;
}
void OAIPollForJobsInput::setQueryParam(const QMap &query_param) {
    m_query_param = query_param;
    m_query_param_isSet = true;
}

bool OAIPollForJobsInput::is_query_param_Set() const{
    return m_query_param_isSet;
}

bool OAIPollForJobsInput::is_query_param_Valid() const{
    return m_query_param_isValid;
}

bool OAIPollForJobsInput::isSet() const {
...
bool OAIPollForJobsInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_action_type_id_isValid && true;
}
