...
OAIPutWebhookOutput::OAIPutWebhookOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutWebhookOutput::OAIPutWebhookOutput() {
    this->initializeModel();
}

OAIPutWebhookOutput::~OAIPutWebhookOutput() {}

void OAIPutWebhookOutput::initializeModel() {

    m_webhook_isSet = false;
    m_webhook_isValid = false;
}

void OAIPutWebhookOutput::fromJson(QString jsonString) {
...
void OAIPutWebhookOutput::fromJsonObject(QJsonObject json) {
...
QString OAIPutWebhookOutput::asJson() const {
...
QJsonObject OAIPutWebhookOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_webhook.isSet()) {
...
OAIPutWebhookOutput_webhook OAIPutWebhookOutput::getWebhook() const {
    return m_webhook;
}
void OAIPutWebhookOutput::setWebhook(const OAIPutWebhookOutput_webhook &webhook) {
    m_webhook = webhook;
    m_webhook_isSet = true;
}

bool OAIPutWebhookOutput::is_webhook_Set() const{
    return m_webhook_isSet;
}

bool OAIPutWebhookOutput::is_webhook_Valid() const{
    return m_webhook_isValid;
}

bool OAIPutWebhookOutput::isSet() const {
...
bool OAIPutWebhookOutput::isValid() const {
