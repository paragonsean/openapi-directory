...
OAIArtifactLocation::OAIArtifactLocation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArtifactLocation::OAIArtifactLocation() {
    this->initializeModel();
}

OAIArtifactLocation::~OAIArtifactLocation() {}

void OAIArtifactLocation::initializeModel() {
...
void OAIArtifactLocation::fromJson(QString jsonString) {
...
void OAIArtifactLocation::fromJsonObject(QJsonObject json) {
...
QString OAIArtifactLocation::asJson() const {
...
QJsonObject OAIArtifactLocation::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIArtifactLocationType OAIArtifactLocation::getType() const {
    return m_type;
}
void OAIArtifactLocation::setType(const OAIArtifactLocationType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIArtifactLocation::is_type_Set() const{
    return m_type_isSet;
}

bool OAIArtifactLocation::is_type_Valid() const{
    return m_type_isValid;
}

OAIArtifactLocation_s3Location OAIArtifactLocation::getS3Location() const {
    return m_s3_location;
}
void OAIArtifactLocation::setS3Location(const OAIArtifactLocation_s3Location &s3_location) {
    m_s3_location = s3_location;
    m_s3_location_isSet = true;
}

bool OAIArtifactLocation::is_s3_location_Set() const{
    return m_s3_location_isSet;
}

bool OAIArtifactLocation::is_s3_location_Valid() const{
    return m_s3_location_isValid;
}

bool OAIArtifactLocation::isSet() const {
...
bool OAIArtifactLocation::isValid() const {
