...
OAIRetryStageExecutionInput::OAIRetryStageExecutionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRetryStageExecutionInput::OAIRetryStageExecutionInput() {
    this->initializeModel();
}

OAIRetryStageExecutionInput::~OAIRetryStageExecutionInput() {}

void OAIRetryStageExecutionInput::initializeModel() {
    ...
    m_retry_mode_isSet = false;
    m_retry_mode_isValid = false;
}

void OAIRetryStageExecutionInput::fromJson(QString jsonString) {
...
void OAIRetryStageExecutionInput::fromJsonObject(QJsonObject json) {
    ...
    m_retry_mode_isValid = ::OpenAPI::fromJsonValue(m_retry_mode, json[QString("retryMode")]);
    m_retry_mode_isSet = !json[QString("retryMode")].isNull() && m_retry_mode_isValid;
}

QString OAIRetryStageExecutionInput::asJson() const {
...
QJsonObject OAIRetryStageExecutionInput::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_retry_mode.isSet()) {
        obj.insert(QString("retryMode"), ::OpenAPI::toJsonValue(m_retry_mode));
    }
    return obj;
}

QString OAIRetryStageExecutionInput::getPipelineName() const {
    return m_pipeline_name;
}
void OAIRetryStageExecutionInput::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIRetryStageExecutionInput::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIRetryStageExecutionInput::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

QString OAIRetryStageExecutionInput::getStageName() const {
    return m_stage_name;
}
void OAIRetryStageExecutionInput::setStageName(const QString &stage_name) {
    m_stage_name = stage_name;
    m_stage_name_isSet = true;
}

bool OAIRetryStageExecutionInput::is_stage_name_Set() const{
    return m_stage_name_isSet;
}

bool OAIRetryStageExecutionInput::is_stage_name_Valid() const{
    return m_stage_name_isValid;
}

QString OAIRetryStageExecutionInput::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIRetryStageExecutionInput::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIRetryStageExecutionInput::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIRetryStageExecutionInput::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

OAIStageRetryMode OAIRetryStageExecutionInput::getRetryMode() const {
    return m_retry_mode;
}
void OAIRetryStageExecutionInput::setRetryMode(const OAIStageRetryMode &retry_mode) {
    m_retry_mode = retry_mode;
    m_retry_mode_isSet = true;
}

bool OAIRetryStageExecutionInput::is_retry_mode_Set() const{
    return m_retry_mode_isSet;
}

bool OAIRetryStageExecutionInput::is_retry_mode_Valid() const{
    return m_retry_mode_isValid;
}

bool OAIRetryStageExecutionInput::isSet() const {
...
bool OAIRetryStageExecutionInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pipeline_name_isValid && m_stage_name_isValid && m_pipeline_execution_id_isValid && m_retry_mode_isValid && true;
}
