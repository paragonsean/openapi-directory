...
#include "OAIWebhookAuthConfiguration.h"
...
OAIWebhookAuthConfiguration::OAIWebhookAuthConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWebhookAuthConfiguration::OAIWebhookAuthConfiguration() {
    this->initializeModel();
}

OAIWebhookAuthConfiguration::~OAIWebhookAuthConfiguration() {}

void OAIWebhookAuthConfiguration::initializeModel() {
...
void OAIWebhookAuthConfiguration::fromJson(QString jsonString) {
...
void OAIWebhookAuthConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIWebhookAuthConfiguration::asJson() const {
...
QJsonObject OAIWebhookAuthConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIWebhookAuthConfiguration::getAllowedIpRange() const {
    return m_allowed_ip_range;
}
void OAIWebhookAuthConfiguration::setAllowedIpRange(const QString &allowed_ip_range) {
    m_allowed_ip_range = allowed_ip_range;
    m_allowed_ip_range_isSet = true;
}

bool OAIWebhookAuthConfiguration::is_allowed_ip_range_Set() const{
    return m_allowed_ip_range_isSet;
}

bool OAIWebhookAuthConfiguration::is_allowed_ip_range_Valid() const{
    return m_allowed_ip_range_isValid;
}

QString OAIWebhookAuthConfiguration::getSecretToken() const {
    return m_secret_token;
}
void OAIWebhookAuthConfiguration::setSecretToken(const QString &secret_token) {
    m_secret_token = secret_token;
    m_secret_token_isSet = true;
}

bool OAIWebhookAuthConfiguration::is_secret_token_Set() const{
    return m_secret_token_isSet;
}

bool OAIWebhookAuthConfiguration::is_secret_token_Valid() const{
    return m_secret_token_isValid;
}

bool OAIWebhookAuthConfiguration::isSet() const {
...
bool OAIWebhookAuthConfiguration::isValid() const {
