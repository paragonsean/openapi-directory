...
/*
 * OAIPutThirdPartyJobSuccessResultInput_executionDetails.h
 *
 * 
 */

#ifndef OAIPutThirdPartyJobSuccessResultInput_executionDetails_H
#define OAIPutThirdPartyJobSuccessResultInput_executionDetails_H
...
class OAIPutThirdPartyJobSuccessResultInput_executionDetails : public OAIObject {
public:
    OAIPutThirdPartyJobSuccessResultInput_executionDetails();
    OAIPutThirdPartyJobSuccessResultInput_executionDetails(QString json);
    ~OAIPutThirdPartyJobSuccessResultInput_executionDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutThirdPartyJobSuccessResultInput_executionDetails)

#endif // OAIPutThirdPartyJobSuccessResultInput_executionDetails_H
