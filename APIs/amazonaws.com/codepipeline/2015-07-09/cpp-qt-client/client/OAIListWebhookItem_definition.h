...
/*
 * OAIListWebhookItem_definition.h
 *
 * 
 */

#ifndef OAIListWebhookItem_definition_H
#define OAIListWebhookItem_definition_H

#include <QJsonObject>

#include "OAIWebhookAuthenticationType.h"
...
namespace OpenAPI {
class OAIWebhookDefinition_authenticationConfiguration;

class OAIListWebhookItem_definition : public OAIObject {
public:
    OAIListWebhookItem_definition();
    OAIListWebhookItem_definition(QString json);
    ~OAIListWebhookItem_definition() override;
    ...
    QString getTargetPipeline() const;
    void setTargetPipeline(const QString &target_pipeline);
    bool is_target_pipeline_Set() const;
    bool is_target_pipeline_Valid() const;

    QString getTargetAction() const;
    void setTargetAction(const QString &target_action);
    ...
    OAIWebhookAuthenticationType getAuthentication() const;
    void setAuthentication(const OAIWebhookAuthenticationType &authentication);
    bool is_authentication_Set() const;
    bool is_authentication_Valid() const;

    OAIWebhookDefinition_authenticationConfiguration getAuthenticationConfiguration() const;
    void setAuthenticationConfiguration(const OAIWebhookDefinition_authenticationConfiguration &authentication_configuration);
...
private:
    ...
    QString m_target_pipeline;
    bool m_target_pipeline_isSet;
    bool m_target_pipeline_isValid;

    QString m_target_action;
    ...
    OAIWebhookAuthenticationType m_authentication;
    bool m_authentication_isSet;
    bool m_authentication_isValid;

    OAIWebhookDefinition_authenticationConfiguration m_authentication_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListWebhookItem_definition)

#endif // OAIListWebhookItem_definition_H
