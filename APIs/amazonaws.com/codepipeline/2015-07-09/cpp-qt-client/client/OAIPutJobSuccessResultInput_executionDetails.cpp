...
OAIPutJobSuccessResultInput_executionDetails::OAIPutJobSuccessResultInput_executionDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutJobSuccessResultInput_executionDetails::OAIPutJobSuccessResultInput_executionDetails() {
    this->initializeModel();
}

OAIPutJobSuccessResultInput_executionDetails::~OAIPutJobSuccessResultInput_executionDetails() {}

void OAIPutJobSuccessResultInput_executionDetails::initializeModel() {
...
void OAIPutJobSuccessResultInput_executionDetails::fromJson(QString jsonString) {
...
void OAIPutJobSuccessResultInput_executionDetails::fromJsonObject(QJsonObject json) {
...
QString OAIPutJobSuccessResultInput_executionDetails::asJson() const {
...
QJsonObject OAIPutJobSuccessResultInput_executionDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_summary_isSet) {
...
QString OAIPutJobSuccessResultInput_executionDetails::getSummary() const {
    return m_summary;
}
void OAIPutJobSuccessResultInput_executionDetails::setSummary(const QString &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAIPutJobSuccessResultInput_executionDetails::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAIPutJobSuccessResultInput_executionDetails::is_summary_Valid() const{
    return m_summary_isValid;
}

QString OAIPutJobSuccessResultInput_executionDetails::getExternalExecutionId() const {
    return m_external_execution_id;
}
void OAIPutJobSuccessResultInput_executionDetails::setExternalExecutionId(const QString &external_execution_id) {
    m_external_execution_id = external_execution_id;
    m_external_execution_id_isSet = true;
}

bool OAIPutJobSuccessResultInput_executionDetails::is_external_execution_id_Set() const{
    return m_external_execution_id_isSet;
}

bool OAIPutJobSuccessResultInput_executionDetails::is_external_execution_id_Valid() const{
    return m_external_execution_id_isValid;
}

qint32 OAIPutJobSuccessResultInput_executionDetails::getPercentComplete() const {
    return m_percent_complete;
}
void OAIPutJobSuccessResultInput_executionDetails::setPercentComplete(const qint32 &percent_complete) {
    m_percent_complete = percent_complete;
    m_percent_complete_isSet = true;
}

bool OAIPutJobSuccessResultInput_executionDetails::is_percent_complete_Set() const{
    return m_percent_complete_isSet;
}

bool OAIPutJobSuccessResultInput_executionDetails::is_percent_complete_Valid() const{
    return m_percent_complete_isValid;
}

bool OAIPutJobSuccessResultInput_executionDetails::isSet() const {
...
bool OAIPutJobSuccessResultInput_executionDetails::isValid() const {
