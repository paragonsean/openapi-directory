...
/*
 * OAIActionConfigurationProperty.h
 *
 * Represents information about an action configuration property.
 */

#ifndef OAIActionConfigurationProperty_H
#define OAIActionConfigurationProperty_H
...
class OAIActionConfigurationProperty : public OAIObject {
public:
    OAIActionConfigurationProperty();
    OAIActionConfigurationProperty(QString json);
    ~OAIActionConfigurationProperty() override;
    ...
    OAIActionConfigurationPropertyType getType() const;
    void setType(const OAIActionConfigurationPropertyType &type);
...
private:
    ...
    OAIActionConfigurationPropertyType m_type;
    bool m_type_isSet;
    bool m_type_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionConfigurationProperty)

#endif // OAIActionConfigurationProperty_H
