...
/*
 * OAIPipelineDeclaration_artifactStore.h
 *
 * 
 */

#ifndef OAIPipelineDeclaration_artifactStore_H
#define OAIPipelineDeclaration_artifactStore_H
...
namespace OpenAPI {
class OAIArtifactStore_encryptionKey;

class OAIPipelineDeclaration_artifactStore : public OAIObject {
public:
    OAIPipelineDeclaration_artifactStore();
    OAIPipelineDeclaration_artifactStore(QString json);
    ~OAIPipelineDeclaration_artifactStore() override;
    ...
    OAIArtifactStoreType getType() const;
    void setType(const OAIArtifactStoreType &type);
    ...
    OAIArtifactStore_encryptionKey getEncryptionKey() const;
    void setEncryptionKey(const OAIArtifactStore_encryptionKey &encryption_key);
...
private:
    ...
    OAIArtifactStore_encryptionKey m_encryption_key;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipelineDeclaration_artifactStore)

#endif // OAIPipelineDeclaration_artifactStore_H
