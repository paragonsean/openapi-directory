...
/*
 * OAIListPipelinesOutput.h
 *
 * Represents the output of a &lt;code&gt;ListPipelines&lt;/code&gt; action.
 */

#ifndef OAIListPipelinesOutput_H
#define OAIListPipelinesOutput_H
...
class OAIListPipelinesOutput : public OAIObject {
public:
    OAIListPipelinesOutput();
    OAIListPipelinesOutput(QString json);
    ~OAIListPipelinesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPipelinesOutput)

#endif // OAIListPipelinesOutput_H
