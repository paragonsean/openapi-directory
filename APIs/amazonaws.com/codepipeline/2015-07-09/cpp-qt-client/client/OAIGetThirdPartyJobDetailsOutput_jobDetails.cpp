...
#include "OAIGetThirdPartyJobDetailsOutput_jobDetails.h"
...
OAIGetThirdPartyJobDetailsOutput_jobDetails::OAIGetThirdPartyJobDetailsOutput_jobDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetThirdPartyJobDetailsOutput_jobDetails::OAIGetThirdPartyJobDetailsOutput_jobDetails() {
    this->initializeModel();
}

OAIGetThirdPartyJobDetailsOutput_jobDetails::~OAIGetThirdPartyJobDetailsOutput_jobDetails() {}

void OAIGetThirdPartyJobDetailsOutput_jobDetails::initializeModel() {
...
void OAIGetThirdPartyJobDetailsOutput_jobDetails::fromJson(QString jsonString) {
...
void OAIGetThirdPartyJobDetailsOutput_jobDetails::fromJsonObject(QJsonObject json) {
...
QString OAIGetThirdPartyJobDetailsOutput_jobDetails::asJson() const {
...
QJsonObject OAIGetThirdPartyJobDetailsOutput_jobDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIGetThirdPartyJobDetailsOutput_jobDetails::getId() const {
    return m_id;
}
void OAIGetThirdPartyJobDetailsOutput_jobDetails::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetThirdPartyJobDetailsOutput_jobDetails::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetThirdPartyJobDetailsOutput_jobDetails::is_id_Valid() const{
    return m_id_isValid;
}

OAIThirdPartyJobDetails_data OAIGetThirdPartyJobDetailsOutput_jobDetails::getData() const {
    return m_data;
}
void OAIGetThirdPartyJobDetailsOutput_jobDetails::setData(const OAIThirdPartyJobDetails_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetThirdPartyJobDetailsOutput_jobDetails::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetThirdPartyJobDetailsOutput_jobDetails::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIGetThirdPartyJobDetailsOutput_jobDetails::getNonce() const {
    return m_nonce;
}
void OAIGetThirdPartyJobDetailsOutput_jobDetails::setNonce(const QString &nonce) {
    m_nonce = nonce;
    m_nonce_isSet = true;
}

bool OAIGetThirdPartyJobDetailsOutput_jobDetails::is_nonce_Set() const{
    return m_nonce_isSet;
}

bool OAIGetThirdPartyJobDetailsOutput_jobDetails::is_nonce_Valid() const{
    return m_nonce_isValid;
}

bool OAIGetThirdPartyJobDetailsOutput_jobDetails::isSet() const {
...
bool OAIGetThirdPartyJobDetailsOutput_jobDetails::isValid() const {
