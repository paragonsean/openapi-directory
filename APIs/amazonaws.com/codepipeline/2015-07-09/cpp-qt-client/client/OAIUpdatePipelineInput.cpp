...
OAIUpdatePipelineInput::OAIUpdatePipelineInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePipelineInput::OAIUpdatePipelineInput() {
    this->initializeModel();
}

OAIUpdatePipelineInput::~OAIUpdatePipelineInput() {}

void OAIUpdatePipelineInput::initializeModel() {

    m_pipeline_isSet = false;
    m_pipeline_isValid = false;
}

void OAIUpdatePipelineInput::fromJson(QString jsonString) {
...
void OAIUpdatePipelineInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePipelineInput::asJson() const {
...
QJsonObject OAIUpdatePipelineInput::asJsonObject() const {
    QJsonObject obj;
    if (m_pipeline.isSet()) {
...
OAIUpdatePipelineInput_pipeline OAIUpdatePipelineInput::getPipeline() const {
    return m_pipeline;
}
void OAIUpdatePipelineInput::setPipeline(const OAIUpdatePipelineInput_pipeline &pipeline) {
    m_pipeline = pipeline;
    m_pipeline_isSet = true;
}

bool OAIUpdatePipelineInput::is_pipeline_Set() const{
    return m_pipeline_isSet;
}

bool OAIUpdatePipelineInput::is_pipeline_Valid() const{
    return m_pipeline_isValid;
}

bool OAIUpdatePipelineInput::isSet() const {
...
bool OAIUpdatePipelineInput::isValid() const {
