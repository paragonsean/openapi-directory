...
/*
 * OAIActionExecutionDetail_input.h
 *
 * 
 */

#ifndef OAIActionExecutionDetail_input_H
#define OAIActionExecutionDetail_input_H

#include <QJsonObject>

#include "OAIActionTypeId.h"
#include <QList>
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIActionTypeId;

class OAIActionExecutionDetail_input : public OAIObject {
public:
    OAIActionExecutionDetail_input();
    OAIActionExecutionDetail_input(QString json);
    ~OAIActionExecutionDetail_input() override;
    ...
    OAIActionTypeId getActionTypeId() const;
    void setActionTypeId(const OAIActionTypeId &action_type_id);
    ...
    QMap getResolvedConfiguration() const;
    void setResolvedConfiguration(const QMap &resolved_configuration);
    bool is_resolved_configuration_Set() const;
    bool is_resolved_configuration_Valid() const;
...
private:
    ...
    OAIActionTypeId m_action_type_id;
    ...
    QMap m_resolved_configuration;
    bool m_resolved_configuration_isSet;
    bool m_resolved_configuration_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionExecutionDetail_input)

#endif // OAIActionExecutionDetail_input_H
