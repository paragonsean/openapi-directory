...
OAIJobData_actionConfiguration::OAIJobData_actionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJobData_actionConfiguration::OAIJobData_actionConfiguration() {
    this->initializeModel();
}

OAIJobData_actionConfiguration::~OAIJobData_actionConfiguration() {}

void OAIJobData_actionConfiguration::initializeModel() {

    m_configuration_isSet = false;
    m_configuration_isValid = false;
}

void OAIJobData_actionConfiguration::fromJson(QString jsonString) {
...
void OAIJobData_actionConfiguration::fromJsonObject(QJsonObject json) {

    m_configuration_isValid = ::OpenAPI::fromJsonValue(m_configuration, json[QString("configuration")]);
    m_configuration_isSet = !json[QString("configuration")].isNull() && m_configuration_isValid;
}

QString OAIJobData_actionConfiguration::asJson() const {
...
QJsonObject OAIJobData_actionConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIJobData_actionConfiguration::getConfiguration() const {
    return m_configuration;
}
void OAIJobData_actionConfiguration::setConfiguration(const QMap &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAIJobData_actionConfiguration::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAIJobData_actionConfiguration::is_configuration_Valid() const{
    return m_configuration_isValid;
}

bool OAIJobData_actionConfiguration::isSet() const {
...
bool OAIJobData_actionConfiguration::isValid() const {
