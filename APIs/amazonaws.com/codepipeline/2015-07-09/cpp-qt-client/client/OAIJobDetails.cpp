...
QString OAIJobDetails::getId() const {
    return m_id;
}
void OAIJobDetails::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIJobDetails::is_id_Set() const{
    return m_id_isSet;
}

bool OAIJobDetails::is_id_Valid() const{
    return m_id_isValid;
}

OAIJobDetails_data OAIJobDetails::getData() const {
    return m_data;
}
void OAIJobDetails::setData(const OAIJobDetails_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIJobDetails::is_data_Set() const{
    return m_data_isSet;
}

bool OAIJobDetails::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIJobDetails::getAccountId() const {
    return m_account_id;
}
void OAIJobDetails::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIJobDetails::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIJobDetails::is_account_id_Valid() const{
