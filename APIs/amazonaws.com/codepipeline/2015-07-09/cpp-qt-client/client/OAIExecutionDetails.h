...
/*
 * OAIExecutionDetails.h
 *
 * The details of the actions taken and results produced on an artifact as it passes through stages in the pipeline.
 */

#ifndef OAIExecutionDetails_H
#define OAIExecutionDetails_H
...
class OAIExecutionDetails : public OAIObject {
public:
    OAIExecutionDetails();
    OAIExecutionDetails(QString json);
    ~OAIExecutionDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecutionDetails)

#endif // OAIExecutionDetails_H
