...
OAIPipelineContext::OAIPipelineContext(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPipelineContext::OAIPipelineContext() {
    this->initializeModel();
}

OAIPipelineContext::~OAIPipelineContext() {}

void OAIPipelineContext::initializeModel() {
...
void OAIPipelineContext::fromJson(QString jsonString) {
...
void OAIPipelineContext::fromJsonObject(QJsonObject json) {
...
QString OAIPipelineContext::asJson() const {
...
QJsonObject OAIPipelineContext::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPipelineContext::getPipelineName() const {
    return m_pipeline_name;
}
void OAIPipelineContext::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIPipelineContext::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIPipelineContext::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

OAIPipelineContext_stage OAIPipelineContext::getStage() const {
    return m_stage;
}
void OAIPipelineContext::setStage(const OAIPipelineContext_stage &stage) {
    m_stage = stage;
    m_stage_isSet = true;
}

bool OAIPipelineContext::is_stage_Set() const{
    return m_stage_isSet;
}

bool OAIPipelineContext::is_stage_Valid() const{
    return m_stage_isValid;
}

OAIPipelineContext_action OAIPipelineContext::getAction() const {
    return m_action;
}
void OAIPipelineContext::setAction(const OAIPipelineContext_action &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIPipelineContext::is_action_Set() const{
    return m_action_isSet;
}

bool OAIPipelineContext::is_action_Valid() const{
    return m_action_isValid;
}

QString OAIPipelineContext::getPipelineArn() const {
    return m_pipeline_arn;
}
void OAIPipelineContext::setPipelineArn(const QString &pipeline_arn) {
    m_pipeline_arn = pipeline_arn;
    m_pipeline_arn_isSet = true;
}

bool OAIPipelineContext::is_pipeline_arn_Set() const{
    return m_pipeline_arn_isSet;
}

bool OAIPipelineContext::is_pipeline_arn_Valid() const{
    return m_pipeline_arn_isValid;
}

QString OAIPipelineContext::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIPipelineContext::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIPipelineContext::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIPipelineContext::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

bool OAIPipelineContext::isSet() const {
...
bool OAIPipelineContext::isValid() const {
