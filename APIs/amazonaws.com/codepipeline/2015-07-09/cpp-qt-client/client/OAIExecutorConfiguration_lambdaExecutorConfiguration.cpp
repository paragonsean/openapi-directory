...
OAIExecutorConfiguration_lambdaExecutorConfiguration::OAIExecutorConfiguration_lambdaExecutorConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExecutorConfiguration_lambdaExecutorConfiguration::OAIExecutorConfiguration_lambdaExecutorConfiguration() {
    this->initializeModel();
}

OAIExecutorConfiguration_lambdaExecutorConfiguration::~OAIExecutorConfiguration_lambdaExecutorConfiguration() {}

void OAIExecutorConfiguration_lambdaExecutorConfiguration::initializeModel() {

    m_lambda_function_arn_isSet = false;
    m_lambda_function_arn_isValid = false;
}

void OAIExecutorConfiguration_lambdaExecutorConfiguration::fromJson(QString jsonString) {
...
void OAIExecutorConfiguration_lambdaExecutorConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIExecutorConfiguration_lambdaExecutorConfiguration::asJson() const {
...
QJsonObject OAIExecutorConfiguration_lambdaExecutorConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIExecutorConfiguration_lambdaExecutorConfiguration::getLambdaFunctionArn() const {
    return m_lambda_function_arn;
}
void OAIExecutorConfiguration_lambdaExecutorConfiguration::setLambdaFunctionArn(const QString &lambda_function_arn) {
    m_lambda_function_arn = lambda_function_arn;
    m_lambda_function_arn_isSet = true;
}

bool OAIExecutorConfiguration_lambdaExecutorConfiguration::is_lambda_function_arn_Set() const{
    return m_lambda_function_arn_isSet;
}

bool OAIExecutorConfiguration_lambdaExecutorConfiguration::is_lambda_function_arn_Valid() const{
    return m_lambda_function_arn_isValid;
}

bool OAIExecutorConfiguration_lambdaExecutorConfiguration::isSet() const {
...
bool OAIExecutorConfiguration_lambdaExecutorConfiguration::isValid() const {
