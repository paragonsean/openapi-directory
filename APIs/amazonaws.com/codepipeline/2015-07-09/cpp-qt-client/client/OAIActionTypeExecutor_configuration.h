...
/*
 * OAIActionTypeExecutor_configuration.h
 *
 * 
 */

#ifndef OAIActionTypeExecutor_configuration_H
#define OAIActionTypeExecutor_configuration_H

#include <QJsonObject>

#include "OAIExecutorConfiguration_jobWorkerExecutorConfiguration.h"
#include "OAIExecutorConfiguration_lambdaExecutorConfiguration.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIExecutorConfiguration_lambdaExecutorConfiguration;
class OAIExecutorConfiguration_jobWorkerExecutorConfiguration;

class OAIActionTypeExecutor_configuration : public OAIObject {
public:
    OAIActionTypeExecutor_configuration();
    OAIActionTypeExecutor_configuration(QString json);
    ~OAIActionTypeExecutor_configuration() override;
    ...
    OAIExecutorConfiguration_lambdaExecutorConfiguration getLambdaExecutorConfiguration() const;
    void setLambdaExecutorConfiguration(const OAIExecutorConfiguration_lambdaExecutorConfiguration &lambda_executor_configuration);
    bool is_lambda_executor_configuration_Set() const;
    bool is_lambda_executor_configuration_Valid() const;

    OAIExecutorConfiguration_jobWorkerExecutorConfiguration getJobWorkerExecutorConfiguration() const;
    void setJobWorkerExecutorConfiguration(const OAIExecutorConfiguration_jobWorkerExecutorConfiguration &job_worker_executor_configuration);
    bool is_job_worker_executor_configuration_Set() const;
    bool is_job_worker_executor_configuration_Valid() const;
...
private:
    ...
    OAIExecutorConfiguration_lambdaExecutorConfiguration m_lambda_executor_configuration;
    bool m_lambda_executor_configuration_isSet;
    bool m_lambda_executor_configuration_isValid;

    OAIExecutorConfiguration_jobWorkerExecutorConfiguration m_job_worker_executor_configuration;
    bool m_job_worker_executor_configuration_isSet;
    bool m_job_worker_executor_configuration_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeExecutor_configuration)

#endif // OAIActionTypeExecutor_configuration_H
