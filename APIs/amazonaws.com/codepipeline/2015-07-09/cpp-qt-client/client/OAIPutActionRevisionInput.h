...
/*
 * OAIPutActionRevisionInput.h
 *
 * Represents the input of a &lt;code&gt;PutActionRevision&lt;/code&gt; action.
 */

#ifndef OAIPutActionRevisionInput_H
#define OAIPutActionRevisionInput_H
...
class OAIPutActionRevisionInput : public OAIObject {
public:
    OAIPutActionRevisionInput();
    OAIPutActionRevisionInput(QString json);
    ~OAIPutActionRevisionInput() override;
    ...
    OAIPutActionRevisionInput_actionRevision getActionRevision() const;
    void setActionRevision(const OAIPutActionRevisionInput_actionRevision &action_revision);
    bool is_action_revision_Set() const;
    bool is_action_revision_Valid() const;
...
private:
    ...
    OAIPutActionRevisionInput_actionRevision m_action_revision;
    bool m_action_revision_isSet;
    bool m_action_revision_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutActionRevisionInput)

#endif // OAIPutActionRevisionInput_H
