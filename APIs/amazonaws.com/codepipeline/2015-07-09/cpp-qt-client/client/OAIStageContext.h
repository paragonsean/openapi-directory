...
#ifndef OAIStageContext_H
#define OAIStageContext_H
...
class OAIStageContext : public OAIObject {
public:
    OAIStageContext();
    OAIStageContext(QString json);
    ~OAIStageContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStageContext)

#endif // OAIStageContext_H
