...
/*
 * OAIPutThirdPartyJobSuccessResultInput.h
 *
 * Represents the input of a &lt;code&gt;PutThirdPartyJobSuccessResult&lt;/code&gt; action.
 */

#ifndef OAIPutThirdPartyJobSuccessResultInput_H
#define OAIPutThirdPartyJobSuccessResultInput_H
...
namespace OpenAPI {
class OAIPutThirdPartyJobSuccessResultInput_currentRevision;
class OAIPutThirdPartyJobSuccessResultInput_executionDetails;

class OAIPutThirdPartyJobSuccessResultInput : public OAIObject {
public:
    OAIPutThirdPartyJobSuccessResultInput();
    OAIPutThirdPartyJobSuccessResultInput(QString json);
    ~OAIPutThirdPartyJobSuccessResultInput() override;
    ...
    OAIPutThirdPartyJobSuccessResultInput_currentRevision getCurrentRevision() const;
    void setCurrentRevision(const OAIPutThirdPartyJobSuccessResultInput_currentRevision &current_revision);
    ...
    OAIPutThirdPartyJobSuccessResultInput_executionDetails getExecutionDetails() const;
    void setExecutionDetails(const OAIPutThirdPartyJobSuccessResultInput_executionDetails &execution_details);
...
private:
    ...
    OAIPutThirdPartyJobSuccessResultInput_currentRevision m_current_revision;
    ...
    OAIPutThirdPartyJobSuccessResultInput_executionDetails m_execution_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutThirdPartyJobSuccessResultInput)

#endif // OAIPutThirdPartyJobSuccessResultInput_H
