...
#ifndef OAIStageExecution_H
#define OAIStageExecution_H
...
class OAIStageExecution : public OAIObject {
public:
    OAIStageExecution();
    OAIStageExecution(QString json);
    ~OAIStageExecution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStageExecution)

#endif // OAIStageExecution_H
