...
OAIActionTypeUrls::OAIActionTypeUrls(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionTypeUrls::OAIActionTypeUrls() {
    this->initializeModel();
}

OAIActionTypeUrls::~OAIActionTypeUrls() {}

void OAIActionTypeUrls::initializeModel() {
...
void OAIActionTypeUrls::fromJson(QString jsonString) {
...
void OAIActionTypeUrls::fromJsonObject(QJsonObject json) {
...
QString OAIActionTypeUrls::asJson() const {
...
QJsonObject OAIActionTypeUrls::asJsonObject() const {
    QJsonObject obj;
...
QString OAIActionTypeUrls::getConfigurationUrl() const {
    return m_configuration_url;
}
void OAIActionTypeUrls::setConfigurationUrl(const QString &configuration_url) {
    m_configuration_url = configuration_url;
    m_configuration_url_isSet = true;
}

bool OAIActionTypeUrls::is_configuration_url_Set() const{
    return m_configuration_url_isSet;
}

bool OAIActionTypeUrls::is_configuration_url_Valid() const{
    return m_configuration_url_isValid;
}

QString OAIActionTypeUrls::getEntityUrlTemplate() const {
    return m_entity_url_template;
}
void OAIActionTypeUrls::setEntityUrlTemplate(const QString &entity_url_template) {
    m_entity_url_template = entity_url_template;
    m_entity_url_template_isSet = true;
}

bool OAIActionTypeUrls::is_entity_url_template_Set() const{
    return m_entity_url_template_isSet;
}

bool OAIActionTypeUrls::is_entity_url_template_Valid() const{
    return m_entity_url_template_isValid;
}

QString OAIActionTypeUrls::getExecutionUrlTemplate() const {
    return m_execution_url_template;
}
void OAIActionTypeUrls::setExecutionUrlTemplate(const QString &execution_url_template) {
    m_execution_url_template = execution_url_template;
    m_execution_url_template_isSet = true;
}

bool OAIActionTypeUrls::is_execution_url_template_Set() const{
    return m_execution_url_template_isSet;
}

bool OAIActionTypeUrls::is_execution_url_template_Valid() const{
    return m_execution_url_template_isValid;
}

QString OAIActionTypeUrls::getRevisionUrlTemplate() const {
    return m_revision_url_template;
}
void OAIActionTypeUrls::setRevisionUrlTemplate(const QString &revision_url_template) {
    m_revision_url_template = revision_url_template;
    m_revision_url_template_isSet = true;
}

bool OAIActionTypeUrls::is_revision_url_template_Set() const{
    return m_revision_url_template_isSet;
}

bool OAIActionTypeUrls::is_revision_url_template_Valid() const{
    return m_revision_url_template_isValid;
}

bool OAIActionTypeUrls::isSet() const {
...
bool OAIActionTypeUrls::isValid() const {
