...
/*
 * OAIActionTypeDeclaration_permissions.h
 *
 * 
 */

#ifndef OAIActionTypeDeclaration_permissions_H
#define OAIActionTypeDeclaration_permissions_H
...
class OAIActionTypeDeclaration_permissions : public OAIObject {
public:
    OAIActionTypeDeclaration_permissions();
    OAIActionTypeDeclaration_permissions(QString json);
    ~OAIActionTypeDeclaration_permissions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeDeclaration_permissions)

#endif // OAIActionTypeDeclaration_permissions_H
