...
#ifndef OAIInputArtifact_H
#define OAIInputArtifact_H
...
class OAIInputArtifact : public OAIObject {
public:
    OAIInputArtifact();
    OAIInputArtifact(QString json);
    ~OAIInputArtifact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputArtifact)

#endif // OAIInputArtifact_H
