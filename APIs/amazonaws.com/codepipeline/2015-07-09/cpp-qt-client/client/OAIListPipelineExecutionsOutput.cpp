...
OAIListPipelineExecutionsOutput::OAIListPipelineExecutionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPipelineExecutionsOutput::OAIListPipelineExecutionsOutput() {
    this->initializeModel();
}

OAIListPipelineExecutionsOutput::~OAIListPipelineExecutionsOutput() {}

void OAIListPipelineExecutionsOutput::initializeModel() {
...
void OAIListPipelineExecutionsOutput::fromJson(QString jsonString) {
...
void OAIListPipelineExecutionsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListPipelineExecutionsOutput::asJson() const {
...
QJsonObject OAIListPipelineExecutionsOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListPipelineExecutionsOutput::getPipelineExecutionSummaries() const {
    return m_pipeline_execution_summaries;
}
void OAIListPipelineExecutionsOutput::setPipelineExecutionSummaries(const QList &pipeline_execution_summaries) {
    m_pipeline_execution_summaries = pipeline_execution_summaries;
    m_pipeline_execution_summaries_isSet = true;
}

bool OAIListPipelineExecutionsOutput::is_pipeline_execution_summaries_Set() const{
    return m_pipeline_execution_summaries_isSet;
}

bool OAIListPipelineExecutionsOutput::is_pipeline_execution_summaries_Valid() const{
    return m_pipeline_execution_summaries_isValid;
}

QString OAIListPipelineExecutionsOutput::getNextToken() const {
    return m_next_token;
}
void OAIListPipelineExecutionsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPipelineExecutionsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPipelineExecutionsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListPipelineExecutionsOutput::isSet() const {
...
bool OAIListPipelineExecutionsOutput::isValid() const {
