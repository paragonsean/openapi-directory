...
/*
 * OAIExecutionTrigger.h
 *
 * The interaction or event that started a pipeline execution.
 */

#ifndef OAIExecutionTrigger_H
#define OAIExecutionTrigger_H
...
class OAIExecutionTrigger : public OAIObject {
public:
    OAIExecutionTrigger();
    OAIExecutionTrigger(QString json);
    ~OAIExecutionTrigger() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecutionTrigger)

#endif // OAIExecutionTrigger_H
