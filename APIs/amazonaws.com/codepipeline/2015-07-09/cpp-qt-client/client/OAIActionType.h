...
#include "OAIActionType_settings.h"
#include "OAICreateCustomActionTypeInput_inputArtifactDetails.h"
#include "OAICreateCustomActionTypeInput_outputArtifactDetails.h"
...
class OAIActionType_settings;
class OAICreateCustomActionTypeInput_inputArtifactDetails;
class OAICreateCustomActionTypeInput_outputArtifactDetails;

class OAIActionType : public OAIObject {
public:
    OAIActionType();
    ...
    OAIPollForJobsInput_actionTypeId getId() const;
    void setId(const OAIPollForJobsInput_actionTypeId &id);
    bool is_id_Set() const;
    bool is_id_Valid() const;

    OAIActionType_settings getSettings() const;
    void setSettings(const OAIActionType_settings &settings);
    bool is_settings_Set() const;
    bool is_settings_Valid() const;

    QList getActionConfigurationProperties() const;
    void setActionConfigurationProperties(const QList &action_configuration_properties);
    bool is_action_configuration_properties_Set() const;
    bool is_action_configuration_properties_Valid() const;

    OAICreateCustomActionTypeInput_inputArtifactDetails getInputArtifactDetails() const;
    void setInputArtifactDetails(const OAICreateCustomActionTypeInput_inputArtifactDetails &input_artifact_details);
    bool is_input_artifact_details_Set() const;
    bool is_input_artifact_details_Valid() const;

    OAICreateCustomActionTypeInput_outputArtifactDetails getOutputArtifactDetails() const;
    void setOutputArtifactDetails(const OAICreateCustomActionTypeInput_outputArtifactDetails &output_artifact_details);
    bool is_output_artifact_details_Set() const;
    bool is_output_artifact_details_Valid() const;
...
private:
    ...
    OAIPollForJobsInput_actionTypeId m_id;
    bool m_id_isSet;
    bool m_id_isValid;

    OAIActionType_settings m_settings;
    bool m_settings_isSet;
    bool m_settings_isValid;

    QList m_action_configuration_properties;
    bool m_action_configuration_properties_isSet;
    bool m_action_configuration_properties_isValid;

    OAICreateCustomActionTypeInput_inputArtifactDetails m_input_artifact_details;
    bool m_input_artifact_details_isSet;
    bool m_input_artifact_details_isValid;

    OAICreateCustomActionTypeInput_outputArtifactDetails m_output_artifact_details;
    bool m_output_artifact_details_isSet;
    bool m_output_artifact_details_isValid;
};
