...
OAIArtifactDetail::OAIArtifactDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArtifactDetail::OAIArtifactDetail() {
    this->initializeModel();
}

OAIArtifactDetail::~OAIArtifactDetail() {}

void OAIArtifactDetail::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;

    m_s3location_isSet = false;
    m_s3location_isValid = false;
}

void OAIArtifactDetail::fromJson(QString jsonString) {
...
void OAIArtifactDetail::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;

    m_s3location_isValid = ::OpenAPI::fromJsonValue(m_s3location, json[QString("s3location")]);
    m_s3location_isSet = !json[QString("s3location")].isNull() && m_s3location_isValid;
}

QString OAIArtifactDetail::asJson() const {
...
QJsonObject OAIArtifactDetail::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
        obj.insert(QString("name"), ::OpenAPI::toJsonValue(m_name));
    }
    if (m_s3location.isSet()) {
        obj.insert(QString("s3location"), ::OpenAPI::toJsonValue(m_s3location));
    }
    return obj;
}

QString OAIArtifactDetail::getName() const {
    return m_name;
}
void OAIArtifactDetail::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIArtifactDetail::is_name_Set() const{
    return m_name_isSet;
}

bool OAIArtifactDetail::is_name_Valid() const{
    return m_name_isValid;
}

OAIArtifactDetail_s3location OAIArtifactDetail::getS3location() const {
    return m_s3location;
}
void OAIArtifactDetail::setS3location(const OAIArtifactDetail_s3location &s3location) {
    m_s3location = s3location;
    m_s3location_isSet = true;
}

bool OAIArtifactDetail::is_s3location_Set() const{
    return m_s3location_isSet;
}

bool OAIArtifactDetail::is_s3location_Valid() const{
    return m_s3location_isValid;
}

bool OAIArtifactDetail::isSet() const {
...
bool OAIArtifactDetail::isValid() const {
