...
OAIActionOwner::OAIActionOwner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionOwner::OAIActionOwner() {
    this->initializeModel();
}

OAIActionOwner::~OAIActionOwner() {}

void OAIActionOwner::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIActionOwner::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIActionOwner::fromJson(QString jsonString) {
    
    if ( jsonString.compare("AWS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionOwner::AWS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ThirdParty", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionOwner::THIRDPARTY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Custom", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionOwner::CUSTOM;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIActionOwner::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIActionOwner::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIActionOwner::AWS:
            val = "AWS";
            break;
        case eOAIActionOwner::THIRDPARTY:
            val = "ThirdParty";
            break;
        case eOAIActionOwner::CUSTOM:
            val = "Custom";
            break;
        default:
            break;
...
QJsonValue OAIActionOwner::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIActionOwner::eOAIActionOwner OAIActionOwner::getValue() const {
    return m_value;
}

void OAIActionOwner::setValue(const OAIActionOwner::eOAIActionOwner& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIActionOwner::isSet() const {
    
    return m_value_isSet;
}

bool OAIActionOwner::isValid() const {
