...
/*
 * OAIRetryStageExecutionOutput.h
 *
 * Represents the output of a &lt;code&gt;RetryStageExecution&lt;/code&gt; action.
 */

#ifndef OAIRetryStageExecutionOutput_H
#define OAIRetryStageExecutionOutput_H
...
class OAIRetryStageExecutionOutput : public OAIObject {
public:
    OAIRetryStageExecutionOutput();
    OAIRetryStageExecutionOutput(QString json);
    ~OAIRetryStageExecutionOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetryStageExecutionOutput)

#endif // OAIRetryStageExecutionOutput_H
