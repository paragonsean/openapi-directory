...
#include "OAIGetPipelineOutput_metadata.h"
...
OAIGetPipelineOutput_metadata::OAIGetPipelineOutput_metadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPipelineOutput_metadata::OAIGetPipelineOutput_metadata() {
    this->initializeModel();
}

OAIGetPipelineOutput_metadata::~OAIGetPipelineOutput_metadata() {}

void OAIGetPipelineOutput_metadata::initializeModel() {
    ...
    m_polling_disabled_at_isSet = false;
    m_polling_disabled_at_isValid = false;
}

void OAIGetPipelineOutput_metadata::fromJson(QString jsonString) {
...
void OAIGetPipelineOutput_metadata::fromJsonObject(QJsonObject json) {
    ...
    m_polling_disabled_at_isValid = ::OpenAPI::fromJsonValue(m_polling_disabled_at, json[QString("pollingDisabledAt")]);
    m_polling_disabled_at_isSet = !json[QString("pollingDisabledAt")].isNull() && m_polling_disabled_at_isValid;
}

QString OAIGetPipelineOutput_metadata::asJson() const {
...
QJsonObject OAIGetPipelineOutput_metadata::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_polling_disabled_at_isSet) {
        obj.insert(QString("pollingDisabledAt"), ::OpenAPI::toJsonValue(m_polling_disabled_at));
    }
    return obj;
}

QString OAIGetPipelineOutput_metadata::getPipelineArn() const {
    return m_pipeline_arn;
}
void OAIGetPipelineOutput_metadata::setPipelineArn(const QString &pipeline_arn) {
    m_pipeline_arn = pipeline_arn;
    m_pipeline_arn_isSet = true;
}

bool OAIGetPipelineOutput_metadata::is_pipeline_arn_Set() const{
    return m_pipeline_arn_isSet;
}

bool OAIGetPipelineOutput_metadata::is_pipeline_arn_Valid() const{
    return m_pipeline_arn_isValid;
}

QDateTime OAIGetPipelineOutput_metadata::getCreated() const {
    return m_created;
}
void OAIGetPipelineOutput_metadata::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIGetPipelineOutput_metadata::is_created_Set() const{
    return m_created_isSet;
}

bool OAIGetPipelineOutput_metadata::is_created_Valid() const{
    return m_created_isValid;
}

QDateTime OAIGetPipelineOutput_metadata::getUpdated() const {
    return m_updated;
}
void OAIGetPipelineOutput_metadata::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIGetPipelineOutput_metadata::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIGetPipelineOutput_metadata::is_updated_Valid() const{
    return m_updated_isValid;
}

QDateTime OAIGetPipelineOutput_metadata::getPollingDisabledAt() const {
    return m_polling_disabled_at;
}
void OAIGetPipelineOutput_metadata::setPollingDisabledAt(const QDateTime &polling_disabled_at) {
    m_polling_disabled_at = polling_disabled_at;
    m_polling_disabled_at_isSet = true;
}

bool OAIGetPipelineOutput_metadata::is_polling_disabled_at_Set() const{
    return m_polling_disabled_at_isSet;
}

bool OAIGetPipelineOutput_metadata::is_polling_disabled_at_Valid() const{
    return m_polling_disabled_at_isValid;
}

bool OAIGetPipelineOutput_metadata::isSet() const {
...
bool OAIGetPipelineOutput_metadata::isValid() const {
