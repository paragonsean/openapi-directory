...
/*
 * OAIActionDeclaration.h
 *
 * Represents information about an action declaration.
 */

#ifndef OAIActionDeclaration_H
#define OAIActionDeclaration_H
...
namespace OpenAPI {
class OAIActionDeclaration_actionTypeId;

class OAIActionDeclaration : public OAIObject {
public:
    OAIActionDeclaration();
    OAIActionDeclaration(QString json);
    ~OAIActionDeclaration() override;
    ...
    OAIActionDeclaration_actionTypeId getActionTypeId() const;
    void setActionTypeId(const OAIActionDeclaration_actionTypeId &action_type_id);
...
private:
    ...
    OAIActionDeclaration_actionTypeId m_action_type_id;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionDeclaration)

#endif // OAIActionDeclaration_H
