...
/*
 * OAIArtifactLocationType.h
 *
 * 
 */

#ifndef OAIArtifactLocationType_H
#define OAIArtifactLocationType_H
...
class OAIArtifactLocationType : public OAIEnum {
public:
    OAIArtifactLocationType();
    OAIArtifactLocationType(QString json);
    ~OAIArtifactLocationType() override;
    ...
    enum class eOAIArtifactLocationType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        S3
    };
    OAIArtifactLocationType::eOAIArtifactLocationType getValue() const;
    void setValue(const OAIArtifactLocationType::eOAIArtifactLocationType& value);
...
private:
    ...
    eOAIArtifactLocationType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactLocationType)

#endif // OAIArtifactLocationType_H
