...
/*
 * OAIGetPipelineStateInput.h
 *
 * Represents the input of a &lt;code&gt;GetPipelineState&lt;/code&gt; action.
 */

#ifndef OAIGetPipelineStateInput_H
#define OAIGetPipelineStateInput_H
...
class OAIGetPipelineStateInput : public OAIObject {
public:
    OAIGetPipelineStateInput();
    OAIGetPipelineStateInput(QString json);
    ~OAIGetPipelineStateInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPipelineStateInput)

#endif // OAIGetPipelineStateInput_H
