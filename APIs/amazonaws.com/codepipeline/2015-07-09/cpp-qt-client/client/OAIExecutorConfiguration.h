...
#ifndef OAIExecutorConfiguration_H
#define OAIExecutorConfiguration_H
...
class OAIExecutorConfiguration : public OAIObject {
public:
    OAIExecutorConfiguration();
    OAIExecutorConfiguration(QString json);
    ~OAIExecutorConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecutorConfiguration)

#endif // OAIExecutorConfiguration_H
