...
#include "OAILambdaExecutorConfiguration.h"
...
OAILambdaExecutorConfiguration::OAILambdaExecutorConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILambdaExecutorConfiguration::OAILambdaExecutorConfiguration() {
    this->initializeModel();
}

OAILambdaExecutorConfiguration::~OAILambdaExecutorConfiguration() {}

void OAILambdaExecutorConfiguration::initializeModel() {

    m_lambda_function_arn_isSet = false;
    m_lambda_function_arn_isValid = false;
}

void OAILambdaExecutorConfiguration::fromJson(QString jsonString) {
...
void OAILambdaExecutorConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAILambdaExecutorConfiguration::asJson() const {
...
QJsonObject OAILambdaExecutorConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAILambdaExecutorConfiguration::getLambdaFunctionArn() const {
    return m_lambda_function_arn;
}
void OAILambdaExecutorConfiguration::setLambdaFunctionArn(const QString &lambda_function_arn) {
    m_lambda_function_arn = lambda_function_arn;
    m_lambda_function_arn_isSet = true;
}

bool OAILambdaExecutorConfiguration::is_lambda_function_arn_Set() const{
    return m_lambda_function_arn_isSet;
}

bool OAILambdaExecutorConfiguration::is_lambda_function_arn_Valid() const{
    return m_lambda_function_arn_isValid;
}

bool OAILambdaExecutorConfiguration::isSet() const {
...
bool OAILambdaExecutorConfiguration::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_lambda_function_arn_isValid && true;
}
