...
#include "OAIPutActionRevisionInput_actionRevision.h"
#include <QString>
...
namespace OpenAPI {
class OAIPutActionRevisionInput_actionRevision;
class OAIActionState_latestExecution;

class OAIActionState : public OAIObject {
public:
    OAIActionState();
    ...
    OAIPutActionRevisionInput_actionRevision getCurrentRevision() const;
    void setCurrentRevision(const OAIPutActionRevisionInput_actionRevision &current_revision);
    bool is_current_revision_Set() const;
    bool is_current_revision_Valid() const;

    OAIActionState_latestExecution getLatestExecution() const;
    void setLatestExecution(const OAIActionState_latestExecution &latest_execution);
    bool is_latest_execution_Set() const;
    bool is_latest_execution_Valid() const;
    ...
    QString getRevisionUrl() const;
    void setRevisionUrl(const QString &revision_url);
    bool is_revision_url_Set() const;
    bool is_revision_url_Valid() const;
...
private:
    ...
    OAIPutActionRevisionInput_actionRevision m_current_revision;
    bool m_current_revision_isSet;
    bool m_current_revision_isValid;

    OAIActionState_latestExecution m_latest_execution;
    bool m_latest_execution_isSet;
    bool m_latest_execution_isValid;

    QString m_entity_url;
    bool m_entity_url_isSet;
    bool m_entity_url_isValid;

    QString m_revision_url;
    bool m_revision_url_isSet;
    bool m_revision_url_isValid;
};
