...
/*
 * OAIArtifactLocation.h
 *
 * Represents information about the location of an artifact.
 */

#ifndef OAIArtifactLocation_H
#define OAIArtifactLocation_H
...
class OAIArtifactLocation : public OAIObject {
public:
    OAIArtifactLocation();
    OAIArtifactLocation(QString json);
    ~OAIArtifactLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactLocation)

#endif // OAIArtifactLocation_H
