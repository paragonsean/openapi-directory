...
OAICreateCustomActionTypeInput::OAICreateCustomActionTypeInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCustomActionTypeInput::OAICreateCustomActionTypeInput() {
    this->initializeModel();
}

OAICreateCustomActionTypeInput::~OAICreateCustomActionTypeInput() {}

void OAICreateCustomActionTypeInput::initializeModel() {
...
void OAICreateCustomActionTypeInput::fromJson(QString jsonString) {
...
void OAICreateCustomActionTypeInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateCustomActionTypeInput::asJson() const {
...
QJsonObject OAICreateCustomActionTypeInput::asJsonObject() const {
    QJsonObject obj;
    if (m_category.isSet()) {
...
OAIActionCategory OAICreateCustomActionTypeInput::getCategory() const {
    return m_category;
}
void OAICreateCustomActionTypeInput::setCategory(const OAIActionCategory &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAICreateCustomActionTypeInput::is_category_Set() const{
    return m_category_isSet;
}

bool OAICreateCustomActionTypeInput::is_category_Valid() const{
    return m_category_isValid;
}

QString OAICreateCustomActionTypeInput::getProvider() const {
    return m_provider;
}
void OAICreateCustomActionTypeInput::setProvider(const QString &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAICreateCustomActionTypeInput::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAICreateCustomActionTypeInput::is_provider_Valid() const{
    return m_provider_isValid;
}

QString OAICreateCustomActionTypeInput::getVersion() const {
    return m_version;
}
void OAICreateCustomActionTypeInput::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAICreateCustomActionTypeInput::is_version_Set() const{
    return m_version_isSet;
}

bool OAICreateCustomActionTypeInput::is_version_Valid() const{
    return m_version_isValid;
}

OAICreateCustomActionTypeInput_settings OAICreateCustomActionTypeInput::getSettings() const {
    return m_settings;
}
void OAICreateCustomActionTypeInput::setSettings(const OAICreateCustomActionTypeInput_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAICreateCustomActionTypeInput::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAICreateCustomActionTypeInput::is_settings_Valid() const{
    return m_settings_isValid;
}

QList OAICreateCustomActionTypeInput::getConfigurationProperties() const {
    return m_configuration_properties;
}
void OAICreateCustomActionTypeInput::setConfigurationProperties(const QList &configuration_properties) {
    m_configuration_properties = configuration_properties;
    m_configuration_properties_isSet = true;
}

bool OAICreateCustomActionTypeInput::is_configuration_properties_Set() const{
    return m_configuration_properties_isSet;
}

bool OAICreateCustomActionTypeInput::is_configuration_properties_Valid() const{
    return m_configuration_properties_isValid;
}

OAICreateCustomActionTypeInput_inputArtifactDetails OAICreateCustomActionTypeInput::getInputArtifactDetails() const {
    return m_input_artifact_details;
}
void OAICreateCustomActionTypeInput::setInputArtifactDetails(const OAICreateCustomActionTypeInput_inputArtifactDetails &input_artifact_details) {
    m_input_artifact_details = input_artifact_details;
    m_input_artifact_details_isSet = true;
}

bool OAICreateCustomActionTypeInput::is_input_artifact_details_Set() const{
    return m_input_artifact_details_isSet;
}

bool OAICreateCustomActionTypeInput::is_input_artifact_details_Valid() const{
    return m_input_artifact_details_isValid;
}

OAICreateCustomActionTypeInput_outputArtifactDetails OAICreateCustomActionTypeInput::getOutputArtifactDetails() const {
    return m_output_artifact_details;
}
void OAICreateCustomActionTypeInput::setOutputArtifactDetails(const OAICreateCustomActionTypeInput_outputArtifactDetails &output_artifact_details) {
    m_output_artifact_details = output_artifact_details;
    m_output_artifact_details_isSet = true;
}

bool OAICreateCustomActionTypeInput::is_output_artifact_details_Set() const{
    return m_output_artifact_details_isSet;
}

bool OAICreateCustomActionTypeInput::is_output_artifact_details_Valid() const{
    return m_output_artifact_details_isValid;
}

QList OAICreateCustomActionTypeInput::getTags() const {
    return m_tags;
}
void OAICreateCustomActionTypeInput::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateCustomActionTypeInput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateCustomActionTypeInput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateCustomActionTypeInput::isSet() const {
...
bool OAICreateCustomActionTypeInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_category_isValid && m_provider_isValid && m_version_isValid && m_input_artifact_details_isValid && m_output_artifact_details_isValid && true;
}
