...
OAIJob_data OAIJob::getData() const {
    return m_data;
}
void OAIJob::setData(const OAIJob_data &data) {
    m_data = data;
    m_data_isSet = true;
}
...
QString OAIJob::getNonce() const {
    return m_nonce;
}
void OAIJob::setNonce(const QString &nonce) {
    m_nonce = nonce;
    m_nonce_isSet = true;
}

bool OAIJob::is_nonce_Set() const{
    return m_nonce_isSet;
}

bool OAIJob::is_nonce_Valid() const{
    return m_nonce_isValid;
}

QString OAIJob::getAccountId() const {
    return m_account_id;
}
void OAIJob::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIJob::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIJob::is_account_id_Valid() const{
