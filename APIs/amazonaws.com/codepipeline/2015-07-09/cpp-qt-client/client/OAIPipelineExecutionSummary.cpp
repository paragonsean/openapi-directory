...
void OAIPipelineExecutionSummary::initializeModel() {
    ...
    m_source_revisions_isSet = false;
    m_source_revisions_isValid = false;

    m_trigger_isSet = false;
    m_trigger_isValid = false;

    m_stop_trigger_isSet = false;
    m_stop_trigger_isValid = false;
}
...
void OAIPipelineExecutionSummary::fromJsonObject(QJsonObject json) {
    ...
    m_source_revisions_isValid = ::OpenAPI::fromJsonValue(m_source_revisions, json[QString("sourceRevisions")]);
    m_source_revisions_isSet = !json[QString("sourceRevisions")].isNull() && m_source_revisions_isValid;
    ...
    m_stop_trigger_isValid = ::OpenAPI::fromJsonValue(m_stop_trigger, json[QString("stopTrigger")]);
    m_stop_trigger_isSet = !json[QString("stopTrigger")].isNull() && m_stop_trigger_isValid;
}
...
QJsonObject OAIPipelineExecutionSummary::asJsonObject() const {
    ...
    if (m_source_revisions.isSet()) {
        obj.insert(QString("sourceRevisions"), ::OpenAPI::toJsonValue(m_source_revisions));
    }
    if (m_trigger.isSet()) {
        obj.insert(QString("trigger"), ::OpenAPI::toJsonValue(m_trigger));
    }
    if (m_stop_trigger.isSet()) {
        obj.insert(QString("stopTrigger"), ::OpenAPI::toJsonValue(m_stop_trigger));
    }
    return obj;
}

QString OAIPipelineExecutionSummary::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIPipelineExecutionSummary::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIPipelineExecutionSummary::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIPipelineExecutionSummary::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

OAIPipelineExecutionStatus OAIPipelineExecutionSummary::getStatus() const {
    return m_status;
}
void OAIPipelineExecutionSummary::setStatus(const OAIPipelineExecutionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPipelineExecutionSummary::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPipelineExecutionSummary::is_status_Valid() const{
...
QDateTime OAIPipelineExecutionSummary::getLastUpdateTime() const {
    return m_last_update_time;
}
void OAIPipelineExecutionSummary::setLastUpdateTime(const QDateTime &last_update_time) {
    m_last_update_time = last_update_time;
    m_last_update_time_isSet = true;
}

bool OAIPipelineExecutionSummary::is_last_update_time_Set() const{
    return m_last_update_time_isSet;
}

bool OAIPipelineExecutionSummary::is_last_update_time_Valid() const{
    return m_last_update_time_isValid;
}

QList OAIPipelineExecutionSummary::getSourceRevisions() const {
    return m_source_revisions;
}
void OAIPipelineExecutionSummary::setSourceRevisions(const QList &source_revisions) {
    m_source_revisions = source_revisions;
    m_source_revisions_isSet = true;
}

bool OAIPipelineExecutionSummary::is_source_revisions_Set() const{
    return m_source_revisions_isSet;
}

bool OAIPipelineExecutionSummary::is_source_revisions_Valid() const{
    return m_source_revisions_isValid;
}

OAIPipelineExecutionSummary_trigger OAIPipelineExecutionSummary::getTrigger() const {
    return m_trigger;
}
void OAIPipelineExecutionSummary::setTrigger(const OAIPipelineExecutionSummary_trigger &trigger) {
    m_trigger = trigger;
    m_trigger_isSet = true;
}

bool OAIPipelineExecutionSummary::is_trigger_Set() const{
    return m_trigger_isSet;
}

bool OAIPipelineExecutionSummary::is_trigger_Valid() const{
    return m_trigger_isValid;
}

OAIPipelineExecutionSummary_stopTrigger OAIPipelineExecutionSummary::getStopTrigger() const {
    return m_stop_trigger;
}
void OAIPipelineExecutionSummary::setStopTrigger(const OAIPipelineExecutionSummary_stopTrigger &stop_trigger) {
    m_stop_trigger = stop_trigger;
    m_stop_trigger_isSet = true;
}

bool OAIPipelineExecutionSummary::is_stop_trigger_Set() const{
    return m_stop_trigger_isSet;
}

bool OAIPipelineExecutionSummary::is_stop_trigger_Valid() const{
    return m_stop_trigger_isValid;
}
