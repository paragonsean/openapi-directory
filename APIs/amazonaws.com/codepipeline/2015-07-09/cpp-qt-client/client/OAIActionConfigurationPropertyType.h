...
/*
 * OAIActionConfigurationPropertyType.h
 *
 * 
 */

#ifndef OAIActionConfigurationPropertyType_H
#define OAIActionConfigurationPropertyType_H
...
class OAIActionConfigurationPropertyType : public OAIEnum {
public:
    OAIActionConfigurationPropertyType();
    OAIActionConfigurationPropertyType(QString json);
    ~OAIActionConfigurationPropertyType() override;
    ...
    enum class eOAIActionConfigurationPropertyType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        STRING, 
        NUMBER, 
        BOOLEAN
    };
    OAIActionConfigurationPropertyType::eOAIActionConfigurationPropertyType getValue() const;
    void setValue(const OAIActionConfigurationPropertyType::eOAIActionConfigurationPropertyType& value);
...
private:
    ...
    eOAIActionConfigurationPropertyType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionConfigurationPropertyType)

#endif // OAIActionConfigurationPropertyType_H
