...
/*
 * OAIGetThirdPartyJobDetailsOutput_jobDetails.h
 *
 * 
 */

#ifndef OAIGetThirdPartyJobDetailsOutput_jobDetails_H
#define OAIGetThirdPartyJobDetailsOutput_jobDetails_H

#include <QJsonObject>

#include "OAIThirdPartyJobDetails_data.h"
#include <QString>
...
namespace OpenAPI {
class OAIThirdPartyJobDetails_data;

class OAIGetThirdPartyJobDetailsOutput_jobDetails : public OAIObject {
public:
    OAIGetThirdPartyJobDetailsOutput_jobDetails();
    OAIGetThirdPartyJobDetailsOutput_jobDetails(QString json);
    ~OAIGetThirdPartyJobDetailsOutput_jobDetails() override;
    ...
    OAIThirdPartyJobDetails_data getData() const;
    void setData(const OAIThirdPartyJobDetails_data &data);
...
private:
    ...
    OAIThirdPartyJobDetails_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetThirdPartyJobDetailsOutput_jobDetails)

#endif // OAIGetThirdPartyJobDetailsOutput_jobDetails_H
