...
#ifndef OAIExecutorType_H
#define OAIExecutorType_H
...
class OAIExecutorType : public OAIEnum {
public:
    OAIExecutorType();
    OAIExecutorType(QString json);
    ~OAIExecutorType() override;
    ...
    enum class eOAIExecutorType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        JOBWORKER, 
        LAMBDA
    };
    OAIExecutorType::eOAIExecutorType getValue() const;
    void setValue(const OAIExecutorType::eOAIExecutorType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecutorType)

#endif // OAIExecutorType_H
