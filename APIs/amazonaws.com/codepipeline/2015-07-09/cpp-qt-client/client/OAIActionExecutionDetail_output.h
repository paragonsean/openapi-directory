...
/*
 * OAIActionExecutionDetail_output.h
 *
 * 
 */

#ifndef OAIActionExecutionDetail_output_H
#define OAIActionExecutionDetail_output_H
...
class OAIActionExecutionDetail_output : public OAIObject {
public:
    OAIActionExecutionDetail_output();
    OAIActionExecutionDetail_output(QString json);
    ~OAIActionExecutionDetail_output() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionExecutionDetail_output)

#endif // OAIActionExecutionDetail_output_H
