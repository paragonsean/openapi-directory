...
/*
 * OAIPipelineExecutionSummary_stopTrigger.h
 *
 * 
 */

#ifndef OAIPipelineExecutionSummary_stopTrigger_H
#define OAIPipelineExecutionSummary_stopTrigger_H
...
class OAIPipelineExecutionSummary_stopTrigger : public OAIObject {
public:
    OAIPipelineExecutionSummary_stopTrigger();
    OAIPipelineExecutionSummary_stopTrigger(QString json);
    ~OAIPipelineExecutionSummary_stopTrigger() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipelineExecutionSummary_stopTrigger)

#endif // OAIPipelineExecutionSummary_stopTrigger_H
