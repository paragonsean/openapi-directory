...
OAIStopPipelineExecutionOutput::OAIStopPipelineExecutionOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopPipelineExecutionOutput::OAIStopPipelineExecutionOutput() {
    this->initializeModel();
}

OAIStopPipelineExecutionOutput::~OAIStopPipelineExecutionOutput() {}

void OAIStopPipelineExecutionOutput::initializeModel() {

    m_pipeline_execution_id_isSet = false;
    m_pipeline_execution_id_isValid = false;
}

void OAIStopPipelineExecutionOutput::fromJson(QString jsonString) {
...
void OAIStopPipelineExecutionOutput::fromJsonObject(QJsonObject json) {
...
QString OAIStopPipelineExecutionOutput::asJson() const {
...
QJsonObject OAIStopPipelineExecutionOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStopPipelineExecutionOutput::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIStopPipelineExecutionOutput::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIStopPipelineExecutionOutput::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIStopPipelineExecutionOutput::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

bool OAIStopPipelineExecutionOutput::isSet() const {
...
bool OAIStopPipelineExecutionOutput::isValid() const {
