...
OAIPollForThirdPartyJobsInput::OAIPollForThirdPartyJobsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPollForThirdPartyJobsInput::OAIPollForThirdPartyJobsInput() {
    this->initializeModel();
}

OAIPollForThirdPartyJobsInput::~OAIPollForThirdPartyJobsInput() {}

void OAIPollForThirdPartyJobsInput::initializeModel() {
...
void OAIPollForThirdPartyJobsInput::fromJson(QString jsonString) {
...
void OAIPollForThirdPartyJobsInput::fromJsonObject(QJsonObject json) {
...
QString OAIPollForThirdPartyJobsInput::asJson() const {
...
QJsonObject OAIPollForThirdPartyJobsInput::asJsonObject() const {
    QJsonObject obj;
...
OAIPollForJobsInput_actionTypeId OAIPollForThirdPartyJobsInput::getActionTypeId() const {
    return m_action_type_id;
}
void OAIPollForThirdPartyJobsInput::setActionTypeId(const OAIPollForJobsInput_actionTypeId &action_type_id) {
    m_action_type_id = action_type_id;
    m_action_type_id_isSet = true;
}

bool OAIPollForThirdPartyJobsInput::is_action_type_id_Set() const{
    return m_action_type_id_isSet;
}

bool OAIPollForThirdPartyJobsInput::is_action_type_id_Valid() const{
    return m_action_type_id_isValid;
}

qint32 OAIPollForThirdPartyJobsInput::getMaxBatchSize() const {
    return m_max_batch_size;
}
void OAIPollForThirdPartyJobsInput::setMaxBatchSize(const qint32 &max_batch_size) {
    m_max_batch_size = max_batch_size;
    m_max_batch_size_isSet = true;
}

bool OAIPollForThirdPartyJobsInput::is_max_batch_size_Set() const{
    return m_max_batch_size_isSet;
}

bool OAIPollForThirdPartyJobsInput::is_max_batch_size_Valid() const{
    return m_max_batch_size_isValid;
}

bool OAIPollForThirdPartyJobsInput::isSet() const {
...
bool OAIPollForThirdPartyJobsInput::isValid() const {
