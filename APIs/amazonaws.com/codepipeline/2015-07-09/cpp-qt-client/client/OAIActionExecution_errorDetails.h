...
/*
 * OAIActionExecution_errorDetails.h
 *
 * 
 */

#ifndef OAIActionExecution_errorDetails_H
#define OAIActionExecution_errorDetails_H
...
class OAIActionExecution_errorDetails : public OAIObject {
public:
    OAIActionExecution_errorDetails();
    OAIActionExecution_errorDetails(QString json);
    ~OAIActionExecution_errorDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionExecution_errorDetails)

#endif // OAIActionExecution_errorDetails_H
