...
/*
 * OAIActionTypeDeclaration_inputArtifactDetails.h
 *
 * 
 */

#ifndef OAIActionTypeDeclaration_inputArtifactDetails_H
#define OAIActionTypeDeclaration_inputArtifactDetails_H
...
class OAIActionTypeDeclaration_inputArtifactDetails : public OAIObject {
public:
    OAIActionTypeDeclaration_inputArtifactDetails();
    OAIActionTypeDeclaration_inputArtifactDetails(QString json);
    ~OAIActionTypeDeclaration_inputArtifactDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeDeclaration_inputArtifactDetails)

#endif // OAIActionTypeDeclaration_inputArtifactDetails_H
