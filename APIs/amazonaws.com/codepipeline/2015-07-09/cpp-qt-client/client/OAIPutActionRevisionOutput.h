...
/*
 * OAIPutActionRevisionOutput.h
 *
 * Represents the output of a &lt;code&gt;PutActionRevision&lt;/code&gt; action.
 */

#ifndef OAIPutActionRevisionOutput_H
#define OAIPutActionRevisionOutput_H
...
class OAIPutActionRevisionOutput : public OAIObject {
public:
    OAIPutActionRevisionOutput();
    OAIPutActionRevisionOutput(QString json);
    ~OAIPutActionRevisionOutput() override;
    ...
    bool getNewRevision() const;
    void setNewRevision(const bool &new_revision);
    bool is_new_revision_Set() const;
    bool is_new_revision_Valid() const;
...
private:
    ...
    bool m_new_revision;
    bool m_new_revision_isSet;
    bool m_new_revision_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutActionRevisionOutput)

#endif // OAIPutActionRevisionOutput_H
