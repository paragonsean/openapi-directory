...
OAIStageTransitionType::OAIStageTransitionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStageTransitionType::OAIStageTransitionType() {
    this->initializeModel();
}

OAIStageTransitionType::~OAIStageTransitionType() {}

void OAIStageTransitionType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIStageTransitionType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIStageTransitionType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Inbound", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStageTransitionType::INBOUND;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Outbound", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStageTransitionType::OUTBOUND;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIStageTransitionType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIStageTransitionType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIStageTransitionType::INBOUND:
            val = "Inbound";
            break;
        case eOAIStageTransitionType::OUTBOUND:
            val = "Outbound";
            break;
        default:
            break;
...
QJsonValue OAIStageTransitionType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIStageTransitionType::eOAIStageTransitionType OAIStageTransitionType::getValue() const {
    return m_value;
}

void OAIStageTransitionType::setValue(const OAIStageTransitionType::eOAIStageTransitionType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIStageTransitionType::isSet() const {
    
    return m_value_isSet;
}

bool OAIStageTransitionType::isValid() const {
