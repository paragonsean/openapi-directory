...
#include "OAIActionExecutionFilter.h"
...
OAIActionExecutionFilter::OAIActionExecutionFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionExecutionFilter::OAIActionExecutionFilter() {
    this->initializeModel();
}

OAIActionExecutionFilter::~OAIActionExecutionFilter() {}

void OAIActionExecutionFilter::initializeModel() {

    m_pipeline_execution_id_isSet = false;
    m_pipeline_execution_id_isValid = false;
}

void OAIActionExecutionFilter::fromJson(QString jsonString) {
...
void OAIActionExecutionFilter::fromJsonObject(QJsonObject json) {
...
QString OAIActionExecutionFilter::asJson() const {
...
QJsonObject OAIActionExecutionFilter::asJsonObject() const {
    QJsonObject obj;
...
QString OAIActionExecutionFilter::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIActionExecutionFilter::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIActionExecutionFilter::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIActionExecutionFilter::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

bool OAIActionExecutionFilter::isSet() const {
...
bool OAIActionExecutionFilter::isValid() const {
