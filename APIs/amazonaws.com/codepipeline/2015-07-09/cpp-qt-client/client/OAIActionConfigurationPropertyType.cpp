...
#include "OAIActionConfigurationPropertyType.h"
...
OAIActionConfigurationPropertyType::OAIActionConfigurationPropertyType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionConfigurationPropertyType::OAIActionConfigurationPropertyType() {
    this->initializeModel();
}

OAIActionConfigurationPropertyType::~OAIActionConfigurationPropertyType() {}

void OAIActionConfigurationPropertyType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIActionConfigurationPropertyType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIActionConfigurationPropertyType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("String", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionConfigurationPropertyType::STRING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Number", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionConfigurationPropertyType::NUMBER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Boolean", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionConfigurationPropertyType::BOOLEAN;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIActionConfigurationPropertyType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIActionConfigurationPropertyType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIActionConfigurationPropertyType::STRING:
            val = "String";
            break;
        case eOAIActionConfigurationPropertyType::NUMBER:
            val = "Number";
            break;
        case eOAIActionConfigurationPropertyType::BOOLEAN:
            val = "Boolean";
            break;
        default:
            break;
...
QJsonValue OAIActionConfigurationPropertyType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIActionConfigurationPropertyType::eOAIActionConfigurationPropertyType OAIActionConfigurationPropertyType::getValue() const {
    return m_value;
}

void OAIActionConfigurationPropertyType::setValue(const OAIActionConfigurationPropertyType::eOAIActionConfigurationPropertyType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIActionConfigurationPropertyType::isSet() const {
    
    return m_value_isSet;
}

bool OAIActionConfigurationPropertyType::isValid() const {
