...
/*
 * OAIStageState_inboundTransitionState.h
 *
 * 
 */

#ifndef OAIStageState_inboundTransitionState_H
#define OAIStageState_inboundTransitionState_H
...
class OAIStageState_inboundTransitionState : public OAIObject {
public:
    OAIStageState_inboundTransitionState();
    OAIStageState_inboundTransitionState(QString json);
    ~OAIStageState_inboundTransitionState() override;
    ...
    QString getLastChangedBy() const;
    void setLastChangedBy(const QString &last_changed_by);
    bool is_last_changed_by_Set() const;
    bool is_last_changed_by_Valid() const;

    QDateTime getLastChangedAt() const;
    void setLastChangedAt(const QDateTime &last_changed_at);
    bool is_last_changed_at_Set() const;
    bool is_last_changed_at_Valid() const;
...
private:
    ...
    QString m_last_changed_by;
    bool m_last_changed_by_isSet;
    bool m_last_changed_by_isValid;

    QDateTime m_last_changed_at;
    bool m_last_changed_at_isSet;
    bool m_last_changed_at_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStageState_inboundTransitionState)

#endif // OAIStageState_inboundTransitionState_H
