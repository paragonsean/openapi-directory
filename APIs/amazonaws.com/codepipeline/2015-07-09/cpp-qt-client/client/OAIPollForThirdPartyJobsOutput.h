...
/*
 * OAIPollForThirdPartyJobsOutput.h
 *
 * Represents the output of a &lt;code&gt;PollForThirdPartyJobs&lt;/code&gt; action.
 */

#ifndef OAIPollForThirdPartyJobsOutput_H
#define OAIPollForThirdPartyJobsOutput_H
...
class OAIPollForThirdPartyJobsOutput : public OAIObject {
public:
    OAIPollForThirdPartyJobsOutput();
    OAIPollForThirdPartyJobsOutput(QString json);
    ~OAIPollForThirdPartyJobsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPollForThirdPartyJobsOutput)

#endif // OAIPollForThirdPartyJobsOutput_H
