...
/*
 * OAIStageExecutionStatus.h
 *
 * 
 */

#ifndef OAIStageExecutionStatus_H
#define OAIStageExecutionStatus_H
...
class OAIStageExecutionStatus : public OAIEnum {
public:
    OAIStageExecutionStatus();
    OAIStageExecutionStatus(QString json);
    ~OAIStageExecutionStatus() override;
    ...
    enum class eOAIStageExecutionStatus {
    ...
    OAIStageExecutionStatus::eOAIStageExecutionStatus getValue() const;
    void setValue(const OAIStageExecutionStatus::eOAIStageExecutionStatus& value);
...
private:
    ...
    eOAIStageExecutionStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStageExecutionStatus)

#endif // OAIStageExecutionStatus_H
