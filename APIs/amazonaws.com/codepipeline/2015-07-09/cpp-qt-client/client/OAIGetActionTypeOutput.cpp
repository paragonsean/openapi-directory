...
OAIGetActionTypeOutput::OAIGetActionTypeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetActionTypeOutput::OAIGetActionTypeOutput() {
    this->initializeModel();
}

OAIGetActionTypeOutput::~OAIGetActionTypeOutput() {}

void OAIGetActionTypeOutput::initializeModel() {

    m_action_type_isSet = false;
    m_action_type_isValid = false;
}

void OAIGetActionTypeOutput::fromJson(QString jsonString) {
...
void OAIGetActionTypeOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetActionTypeOutput::asJson() const {
...
QJsonObject OAIGetActionTypeOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIGetActionTypeOutput_actionType OAIGetActionTypeOutput::getActionType() const {
    return m_action_type;
}
void OAIGetActionTypeOutput::setActionType(const OAIGetActionTypeOutput_actionType &action_type) {
    m_action_type = action_type;
    m_action_type_isSet = true;
}

bool OAIGetActionTypeOutput::is_action_type_Set() const{
    return m_action_type_isSet;
}

bool OAIGetActionTypeOutput::is_action_type_Valid() const{
    return m_action_type_isValid;
}

bool OAIGetActionTypeOutput::isSet() const {
...
bool OAIGetActionTypeOutput::isValid() const {
