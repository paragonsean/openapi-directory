...
/*
 * OAIUpdatePipelineOutput_pipeline.h
 *
 * 
 */

#ifndef OAIUpdatePipelineOutput_pipeline_H
#define OAIUpdatePipelineOutput_pipeline_H
...
namespace OpenAPI {
class OAIPipelineDeclaration_artifactStore;

class OAIUpdatePipelineOutput_pipeline : public OAIObject {
public:
    OAIUpdatePipelineOutput_pipeline();
    OAIUpdatePipelineOutput_pipeline(QString json);
    ~OAIUpdatePipelineOutput_pipeline() override;
    ...
    OAIPipelineDeclaration_artifactStore getArtifactStore() const;
    void setArtifactStore(const OAIPipelineDeclaration_artifactStore &artifact_store);
    bool is_artifact_store_Set() const;
    bool is_artifact_store_Valid() const;

    QMap getArtifactStores() const;
    void setArtifactStores(const QMap &artifact_stores);
    bool is_artifact_stores_Set() const;
    bool is_artifact_stores_Valid() const;
...
private:
    ...
    OAIPipelineDeclaration_artifactStore m_artifact_store;
    bool m_artifact_store_isSet;
    bool m_artifact_store_isValid;

    QMap m_artifact_stores;
    bool m_artifact_stores_isSet;
    bool m_artifact_stores_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipelineOutput_pipeline)

#endif // OAIUpdatePipelineOutput_pipeline_H
