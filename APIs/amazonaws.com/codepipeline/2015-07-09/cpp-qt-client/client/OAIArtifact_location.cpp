...
#include "OAIArtifact_location.h"
...
OAIArtifact_location::OAIArtifact_location(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArtifact_location::OAIArtifact_location() {
    this->initializeModel();
}

OAIArtifact_location::~OAIArtifact_location() {}

void OAIArtifact_location::initializeModel() {
...
void OAIArtifact_location::fromJson(QString jsonString) {
...
void OAIArtifact_location::fromJsonObject(QJsonObject json) {
...
QString OAIArtifact_location::asJson() const {
...
QJsonObject OAIArtifact_location::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIArtifactLocationType OAIArtifact_location::getType() const {
    return m_type;
}
void OAIArtifact_location::setType(const OAIArtifactLocationType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIArtifact_location::is_type_Set() const{
    return m_type_isSet;
}

bool OAIArtifact_location::is_type_Valid() const{
    return m_type_isValid;
}

OAIArtifactLocation_s3Location OAIArtifact_location::getS3Location() const {
    return m_s3_location;
}
void OAIArtifact_location::setS3Location(const OAIArtifactLocation_s3Location &s3_location) {
    m_s3_location = s3_location;
    m_s3_location_isSet = true;
}

bool OAIArtifact_location::is_s3_location_Set() const{
    return m_s3_location_isSet;
}

bool OAIArtifact_location::is_s3_location_Valid() const{
    return m_s3_location_isValid;
}

bool OAIArtifact_location::isSet() const {
...
bool OAIArtifact_location::isValid() const {
