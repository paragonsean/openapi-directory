...
/*
 * OAIListPipelineExecutionsInput.h
 *
 * Represents the input of a &lt;code&gt;ListPipelineExecutions&lt;/code&gt; action.
 */

#ifndef OAIListPipelineExecutionsInput_H
#define OAIListPipelineExecutionsInput_H
...
class OAIListPipelineExecutionsInput : public OAIObject {
public:
    OAIListPipelineExecutionsInput();
    OAIListPipelineExecutionsInput(QString json);
    ~OAIListPipelineExecutionsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPipelineExecutionsInput)

#endif // OAIListPipelineExecutionsInput_H
