...
OAIActionTypeDeclaration_outputArtifactDetails::OAIActionTypeDeclaration_outputArtifactDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionTypeDeclaration_outputArtifactDetails::OAIActionTypeDeclaration_outputArtifactDetails() {
    this->initializeModel();
}

OAIActionTypeDeclaration_outputArtifactDetails::~OAIActionTypeDeclaration_outputArtifactDetails() {}

void OAIActionTypeDeclaration_outputArtifactDetails::initializeModel() {
...
void OAIActionTypeDeclaration_outputArtifactDetails::fromJson(QString jsonString) {
...
void OAIActionTypeDeclaration_outputArtifactDetails::fromJsonObject(QJsonObject json) {
...
QString OAIActionTypeDeclaration_outputArtifactDetails::asJson() const {
...
QJsonObject OAIActionTypeDeclaration_outputArtifactDetails::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIActionTypeDeclaration_outputArtifactDetails::getMinimumCount() const {
    return m_minimum_count;
}
void OAIActionTypeDeclaration_outputArtifactDetails::setMinimumCount(const qint32 &minimum_count) {
    m_minimum_count = minimum_count;
    m_minimum_count_isSet = true;
}

bool OAIActionTypeDeclaration_outputArtifactDetails::is_minimum_count_Set() const{
    return m_minimum_count_isSet;
}

bool OAIActionTypeDeclaration_outputArtifactDetails::is_minimum_count_Valid() const{
    return m_minimum_count_isValid;
}

qint32 OAIActionTypeDeclaration_outputArtifactDetails::getMaximumCount() const {
    return m_maximum_count;
}
void OAIActionTypeDeclaration_outputArtifactDetails::setMaximumCount(const qint32 &maximum_count) {
    m_maximum_count = maximum_count;
    m_maximum_count_isSet = true;
}

bool OAIActionTypeDeclaration_outputArtifactDetails::is_maximum_count_Set() const{
    return m_maximum_count_isSet;
}

bool OAIActionTypeDeclaration_outputArtifactDetails::is_maximum_count_Valid() const{
    return m_maximum_count_isValid;
}

bool OAIActionTypeDeclaration_outputArtifactDetails::isSet() const {
...
bool OAIActionTypeDeclaration_outputArtifactDetails::isValid() const {
