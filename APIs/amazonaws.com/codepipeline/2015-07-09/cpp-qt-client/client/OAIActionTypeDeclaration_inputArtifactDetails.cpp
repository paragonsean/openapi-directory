...
#include "OAIActionTypeDeclaration_inputArtifactDetails.h"
...
OAIActionTypeDeclaration_inputArtifactDetails::OAIActionTypeDeclaration_inputArtifactDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionTypeDeclaration_inputArtifactDetails::OAIActionTypeDeclaration_inputArtifactDetails() {
    this->initializeModel();
}

OAIActionTypeDeclaration_inputArtifactDetails::~OAIActionTypeDeclaration_inputArtifactDetails() {}

void OAIActionTypeDeclaration_inputArtifactDetails::initializeModel() {
...
void OAIActionTypeDeclaration_inputArtifactDetails::fromJson(QString jsonString) {
...
void OAIActionTypeDeclaration_inputArtifactDetails::fromJsonObject(QJsonObject json) {
...
QString OAIActionTypeDeclaration_inputArtifactDetails::asJson() const {
...
QJsonObject OAIActionTypeDeclaration_inputArtifactDetails::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIActionTypeDeclaration_inputArtifactDetails::getMinimumCount() const {
    return m_minimum_count;
}
void OAIActionTypeDeclaration_inputArtifactDetails::setMinimumCount(const qint32 &minimum_count) {
    m_minimum_count = minimum_count;
    m_minimum_count_isSet = true;
}

bool OAIActionTypeDeclaration_inputArtifactDetails::is_minimum_count_Set() const{
    return m_minimum_count_isSet;
}

bool OAIActionTypeDeclaration_inputArtifactDetails::is_minimum_count_Valid() const{
    return m_minimum_count_isValid;
}

qint32 OAIActionTypeDeclaration_inputArtifactDetails::getMaximumCount() const {
    return m_maximum_count;
}
void OAIActionTypeDeclaration_inputArtifactDetails::setMaximumCount(const qint32 &maximum_count) {
    m_maximum_count = maximum_count;
    m_maximum_count_isSet = true;
}

bool OAIActionTypeDeclaration_inputArtifactDetails::is_maximum_count_Set() const{
    return m_maximum_count_isSet;
}

bool OAIActionTypeDeclaration_inputArtifactDetails::is_maximum_count_Valid() const{
    return m_maximum_count_isValid;
}

bool OAIActionTypeDeclaration_inputArtifactDetails::isSet() const {
...
bool OAIActionTypeDeclaration_inputArtifactDetails::isValid() const {
