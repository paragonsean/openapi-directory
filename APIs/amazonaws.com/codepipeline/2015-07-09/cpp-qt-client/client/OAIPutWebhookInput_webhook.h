...
/*
 * OAIPutWebhookInput_webhook.h
 *
 * 
 */

#ifndef OAIPutWebhookInput_webhook_H
#define OAIPutWebhookInput_webhook_H
...
class OAIPutWebhookInput_webhook : public OAIObject {
public:
    OAIPutWebhookInput_webhook();
    OAIPutWebhookInput_webhook(QString json);
    ~OAIPutWebhookInput_webhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutWebhookInput_webhook)

#endif // OAIPutWebhookInput_webhook_H
