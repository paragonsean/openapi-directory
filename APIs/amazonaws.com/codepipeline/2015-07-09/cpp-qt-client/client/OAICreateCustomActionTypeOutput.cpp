...
OAICreateCustomActionTypeOutput::OAICreateCustomActionTypeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCustomActionTypeOutput::OAICreateCustomActionTypeOutput() {
    this->initializeModel();
}

OAICreateCustomActionTypeOutput::~OAICreateCustomActionTypeOutput() {}

void OAICreateCustomActionTypeOutput::initializeModel() {
...
void OAICreateCustomActionTypeOutput::fromJson(QString jsonString) {
...
void OAICreateCustomActionTypeOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateCustomActionTypeOutput::asJson() const {
...
QJsonObject OAICreateCustomActionTypeOutput::asJsonObject() const {
    QJsonObject obj;
...
OAICreateCustomActionTypeOutput_actionType OAICreateCustomActionTypeOutput::getActionType() const {
    return m_action_type;
}
void OAICreateCustomActionTypeOutput::setActionType(const OAICreateCustomActionTypeOutput_actionType &action_type) {
    m_action_type = action_type;
    m_action_type_isSet = true;
}

bool OAICreateCustomActionTypeOutput::is_action_type_Set() const{
    return m_action_type_isSet;
}

bool OAICreateCustomActionTypeOutput::is_action_type_Valid() const{
    return m_action_type_isValid;
}

QList OAICreateCustomActionTypeOutput::getTags() const {
    return m_tags;
}
void OAICreateCustomActionTypeOutput::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateCustomActionTypeOutput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateCustomActionTypeOutput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateCustomActionTypeOutput::isSet() const {
...
bool OAICreateCustomActionTypeOutput::isValid() const {
