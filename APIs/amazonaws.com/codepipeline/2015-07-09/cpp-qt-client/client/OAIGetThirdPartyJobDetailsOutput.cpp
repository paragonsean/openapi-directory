...
OAIGetThirdPartyJobDetailsOutput::OAIGetThirdPartyJobDetailsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetThirdPartyJobDetailsOutput::OAIGetThirdPartyJobDetailsOutput() {
    this->initializeModel();
}

OAIGetThirdPartyJobDetailsOutput::~OAIGetThirdPartyJobDetailsOutput() {}

void OAIGetThirdPartyJobDetailsOutput::initializeModel() {

    m_job_details_isSet = false;
    m_job_details_isValid = false;
}

void OAIGetThirdPartyJobDetailsOutput::fromJson(QString jsonString) {
...
void OAIGetThirdPartyJobDetailsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetThirdPartyJobDetailsOutput::asJson() const {
...
QJsonObject OAIGetThirdPartyJobDetailsOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIGetThirdPartyJobDetailsOutput_jobDetails OAIGetThirdPartyJobDetailsOutput::getJobDetails() const {
    return m_job_details;
}
void OAIGetThirdPartyJobDetailsOutput::setJobDetails(const OAIGetThirdPartyJobDetailsOutput_jobDetails &job_details) {
    m_job_details = job_details;
    m_job_details_isSet = true;
}

bool OAIGetThirdPartyJobDetailsOutput::is_job_details_Set() const{
    return m_job_details_isSet;
}

bool OAIGetThirdPartyJobDetailsOutput::is_job_details_Valid() const{
    return m_job_details_isValid;
}

bool OAIGetThirdPartyJobDetailsOutput::isSet() const {
...
bool OAIGetThirdPartyJobDetailsOutput::isValid() const {
