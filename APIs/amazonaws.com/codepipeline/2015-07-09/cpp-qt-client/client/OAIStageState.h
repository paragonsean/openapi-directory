...
#include "OAIStageExecution.h"
#include "OAIStageState_inboundTransitionState.h"
#include "OAIStageState_latestExecution.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIStageExecution;
class OAIStageState_inboundTransitionState;
class OAIStageState_latestExecution;

class OAIStageState : public OAIObject {
public:
    OAIStageState();
    ...
    OAIStageExecution getInboundExecution() const;
    void setInboundExecution(const OAIStageExecution &inbound_execution);
    bool is_inbound_execution_Set() const;
    bool is_inbound_execution_Valid() const;

    OAIStageState_inboundTransitionState getInboundTransitionState() const;
    void setInboundTransitionState(const OAIStageState_inboundTransitionState &inbound_transition_state);
    bool is_inbound_transition_state_Set() const;
    bool is_inbound_transition_state_Valid() const;

    QList getActionStates() const;
    void setActionStates(const QList &action_states);
    bool is_action_states_Set() const;
    bool is_action_states_Valid() const;

    OAIStageState_latestExecution getLatestExecution() const;
    void setLatestExecution(const OAIStageState_latestExecution &latest_execution);
...
private:
    ...
    OAIStageExecution m_inbound_execution;
    bool m_inbound_execution_isSet;
    bool m_inbound_execution_isValid;

    OAIStageState_inboundTransitionState m_inbound_transition_state;
    bool m_inbound_transition_state_isSet;
    bool m_inbound_transition_state_isValid;

    QList m_action_states;
    bool m_action_states_isSet;
    bool m_action_states_isValid;

    OAIStageState_latestExecution m_latest_execution;
