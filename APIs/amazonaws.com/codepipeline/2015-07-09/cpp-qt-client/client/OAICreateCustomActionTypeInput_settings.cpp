...
#include "OAICreateCustomActionTypeInput_settings.h"
...
OAICreateCustomActionTypeInput_settings::OAICreateCustomActionTypeInput_settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCustomActionTypeInput_settings::OAICreateCustomActionTypeInput_settings() {
    this->initializeModel();
}

OAICreateCustomActionTypeInput_settings::~OAICreateCustomActionTypeInput_settings() {}

void OAICreateCustomActionTypeInput_settings::initializeModel() {
...
void OAICreateCustomActionTypeInput_settings::fromJson(QString jsonString) {
...
void OAICreateCustomActionTypeInput_settings::fromJsonObject(QJsonObject json) {
...
QString OAICreateCustomActionTypeInput_settings::asJson() const {
...
QJsonObject OAICreateCustomActionTypeInput_settings::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateCustomActionTypeInput_settings::getThirdPartyConfigurationUrl() const {
    return m_third_party_configuration_url;
}
void OAICreateCustomActionTypeInput_settings::setThirdPartyConfigurationUrl(const QString &third_party_configuration_url) {
    m_third_party_configuration_url = third_party_configuration_url;
    m_third_party_configuration_url_isSet = true;
}

bool OAICreateCustomActionTypeInput_settings::is_third_party_configuration_url_Set() const{
    return m_third_party_configuration_url_isSet;
}

bool OAICreateCustomActionTypeInput_settings::is_third_party_configuration_url_Valid() const{
    return m_third_party_configuration_url_isValid;
}

QString OAICreateCustomActionTypeInput_settings::getEntityUrlTemplate() const {
    return m_entity_url_template;
}
void OAICreateCustomActionTypeInput_settings::setEntityUrlTemplate(const QString &entity_url_template) {
    m_entity_url_template = entity_url_template;
    m_entity_url_template_isSet = true;
}

bool OAICreateCustomActionTypeInput_settings::is_entity_url_template_Set() const{
    return m_entity_url_template_isSet;
}

bool OAICreateCustomActionTypeInput_settings::is_entity_url_template_Valid() const{
    return m_entity_url_template_isValid;
}

QString OAICreateCustomActionTypeInput_settings::getExecutionUrlTemplate() const {
    return m_execution_url_template;
}
void OAICreateCustomActionTypeInput_settings::setExecutionUrlTemplate(const QString &execution_url_template) {
    m_execution_url_template = execution_url_template;
    m_execution_url_template_isSet = true;
}

bool OAICreateCustomActionTypeInput_settings::is_execution_url_template_Set() const{
    return m_execution_url_template_isSet;
}

bool OAICreateCustomActionTypeInput_settings::is_execution_url_template_Valid() const{
    return m_execution_url_template_isValid;
}

QString OAICreateCustomActionTypeInput_settings::getRevisionUrlTemplate() const {
    return m_revision_url_template;
}
void OAICreateCustomActionTypeInput_settings::setRevisionUrlTemplate(const QString &revision_url_template) {
    m_revision_url_template = revision_url_template;
    m_revision_url_template_isSet = true;
}

bool OAICreateCustomActionTypeInput_settings::is_revision_url_template_Set() const{
    return m_revision_url_template_isSet;
}

bool OAICreateCustomActionTypeInput_settings::is_revision_url_template_Valid() const{
    return m_revision_url_template_isValid;
}

bool OAICreateCustomActionTypeInput_settings::isSet() const {
...
bool OAICreateCustomActionTypeInput_settings::isValid() const {
