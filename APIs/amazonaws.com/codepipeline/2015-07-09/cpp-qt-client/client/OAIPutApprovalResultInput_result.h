...
/*
 * OAIPutApprovalResultInput_result.h
 *
 * 
 */

#ifndef OAIPutApprovalResultInput_result_H
#define OAIPutApprovalResultInput_result_H
...
class OAIPutApprovalResultInput_result : public OAIObject {
public:
    OAIPutApprovalResultInput_result();
    OAIPutApprovalResultInput_result(QString json);
    ~OAIPutApprovalResultInput_result() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutApprovalResultInput_result)

#endif // OAIPutApprovalResultInput_result_H
