...
/*
 * OAIPutApprovalResultInput.h
 *
 * Represents the input of a &lt;code&gt;PutApprovalResult&lt;/code&gt; action.
 */

#ifndef OAIPutApprovalResultInput_H
#define OAIPutApprovalResultInput_H
...
namespace OpenAPI {
class OAIPutApprovalResultInput_result;

class OAIPutApprovalResultInput : public OAIObject {
public:
    OAIPutApprovalResultInput();
    OAIPutApprovalResultInput(QString json);
    ~OAIPutApprovalResultInput() override;
    ...
    OAIPutApprovalResultInput_result getResult() const;
    void setResult(const OAIPutApprovalResultInput_result &result);
...
private:
    ...
    OAIPutApprovalResultInput_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutApprovalResultInput)

#endif // OAIPutApprovalResultInput_H
