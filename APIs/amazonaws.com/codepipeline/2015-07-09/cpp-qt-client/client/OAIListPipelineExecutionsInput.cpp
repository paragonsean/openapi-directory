...
OAIListPipelineExecutionsInput::OAIListPipelineExecutionsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPipelineExecutionsInput::OAIListPipelineExecutionsInput() {
    this->initializeModel();
}

OAIListPipelineExecutionsInput::~OAIListPipelineExecutionsInput() {}

void OAIListPipelineExecutionsInput::initializeModel() {
...
void OAIListPipelineExecutionsInput::fromJson(QString jsonString) {
...
void OAIListPipelineExecutionsInput::fromJsonObject(QJsonObject json) {
...
QString OAIListPipelineExecutionsInput::asJson() const {
...
QJsonObject OAIListPipelineExecutionsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListPipelineExecutionsInput::getPipelineName() const {
    return m_pipeline_name;
}
void OAIListPipelineExecutionsInput::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIListPipelineExecutionsInput::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIListPipelineExecutionsInput::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

qint32 OAIListPipelineExecutionsInput::getMaxResults() const {
    return m_max_results;
}
void OAIListPipelineExecutionsInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListPipelineExecutionsInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListPipelineExecutionsInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListPipelineExecutionsInput::getNextToken() const {
    return m_next_token;
}
void OAIListPipelineExecutionsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPipelineExecutionsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPipelineExecutionsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListPipelineExecutionsInput::isSet() const {
...
bool OAIListPipelineExecutionsInput::isValid() const {
