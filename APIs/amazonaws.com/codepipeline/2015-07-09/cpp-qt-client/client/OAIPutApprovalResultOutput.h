...
/*
 * OAIPutApprovalResultOutput.h
 *
 * Represents the output of a &lt;code&gt;PutApprovalResult&lt;/code&gt; action.
 */

#ifndef OAIPutApprovalResultOutput_H
#define OAIPutApprovalResultOutput_H
...
class OAIPutApprovalResultOutput : public OAIObject {
public:
    OAIPutApprovalResultOutput();
    OAIPutApprovalResultOutput(QString json);
    ~OAIPutApprovalResultOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutApprovalResultOutput)

#endif // OAIPutApprovalResultOutput_H
