...
#ifndef OAIApprovalResult_H
#define OAIApprovalResult_H

#include <QJsonObject>

#include "OAIApprovalStatus.h"
#include <QString>
...
class OAIApprovalResult : public OAIObject {
public:
    OAIApprovalResult();
    OAIApprovalResult(QString json);
    ~OAIApprovalResult() override;
    ...
    OAIApprovalStatus getStatus() const;
    void setStatus(const OAIApprovalStatus &status);
...
Q_DECLARE_METATYPE(OpenAPI::OAIApprovalResult)

#endif // OAIApprovalResult_H
