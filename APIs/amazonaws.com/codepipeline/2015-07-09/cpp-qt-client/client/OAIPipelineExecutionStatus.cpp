...
void OAIPipelineExecutionStatus::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("Cancelled", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPipelineExecutionStatus::CANCELLED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("InProgress", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPipelineExecutionStatus::INPROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
        ...
        m_value = eOAIPipelineExecutionStatus::SUPERSEDED;
        m_value_isSet = m_value_isValid = true;
    }
...
QString OAIPipelineExecutionStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIPipelineExecutionStatus::CANCELLED:
            val = "Cancelled";
            break;
        case eOAIPipelineExecutionStatus::INPROGRESS:
            val = "InProgress";
            break;
        ...
        case eOAIPipelineExecutionStatus::SUCCEEDED:
            val = "Succeeded";
            break;
        case eOAIPipelineExecutionStatus::SUPERSEDED:
            val = "Superseded";
            break;
