...
OAIPutActionRevisionInput_actionRevision::OAIPutActionRevisionInput_actionRevision(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutActionRevisionInput_actionRevision::OAIPutActionRevisionInput_actionRevision() {
    this->initializeModel();
}

OAIPutActionRevisionInput_actionRevision::~OAIPutActionRevisionInput_actionRevision() {}

void OAIPutActionRevisionInput_actionRevision::initializeModel() {
...
void OAIPutActionRevisionInput_actionRevision::fromJson(QString jsonString) {
...
void OAIPutActionRevisionInput_actionRevision::fromJsonObject(QJsonObject json) {
...
QString OAIPutActionRevisionInput_actionRevision::asJson() const {
...
QJsonObject OAIPutActionRevisionInput_actionRevision::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutActionRevisionInput_actionRevision::getRevisionId() const {
    return m_revision_id;
}
void OAIPutActionRevisionInput_actionRevision::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIPutActionRevisionInput_actionRevision::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIPutActionRevisionInput_actionRevision::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

QString OAIPutActionRevisionInput_actionRevision::getRevisionChangeId() const {
    return m_revision_change_id;
}
void OAIPutActionRevisionInput_actionRevision::setRevisionChangeId(const QString &revision_change_id) {
    m_revision_change_id = revision_change_id;
    m_revision_change_id_isSet = true;
}

bool OAIPutActionRevisionInput_actionRevision::is_revision_change_id_Set() const{
    return m_revision_change_id_isSet;
}

bool OAIPutActionRevisionInput_actionRevision::is_revision_change_id_Valid() const{
    return m_revision_change_id_isValid;
}

QDateTime OAIPutActionRevisionInput_actionRevision::getCreated() const {
    return m_created;
}
void OAIPutActionRevisionInput_actionRevision::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIPutActionRevisionInput_actionRevision::is_created_Set() const{
    return m_created_isSet;
}

bool OAIPutActionRevisionInput_actionRevision::is_created_Valid() const{
    return m_created_isValid;
}

bool OAIPutActionRevisionInput_actionRevision::isSet() const {
...
bool OAIPutActionRevisionInput_actionRevision::isValid() const {
