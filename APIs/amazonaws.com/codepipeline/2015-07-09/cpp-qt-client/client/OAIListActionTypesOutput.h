...
/*
 * OAIListActionTypesOutput.h
 *
 * Represents the output of a &lt;code&gt;ListActionTypes&lt;/code&gt; action.
 */

#ifndef OAIListActionTypesOutput_H
#define OAIListActionTypesOutput_H
...
class OAIListActionTypesOutput : public OAIObject {
public:
    OAIListActionTypesOutput();
    OAIListActionTypesOutput(QString json);
    ~OAIListActionTypesOutput() override;
    ...
    QList getActionTypes() const;
    void setActionTypes(const QList &action_types);
    bool is_action_types_Set() const;
    bool is_action_types_Valid() const;
...
private:
    ...
    QList m_action_types;
    bool m_action_types_isSet;
    bool m_action_types_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListActionTypesOutput)

#endif // OAIListActionTypesOutput_H
