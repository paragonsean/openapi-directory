...
/*
 * OAIUpdateActionTypeInput.h
 *
 * 
 */

#ifndef OAIUpdateActionTypeInput_H
#define OAIUpdateActionTypeInput_H

#include <QJsonObject>

#include "OAIUpdateActionTypeInput_actionType.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateActionTypeInput_actionType;

class OAIUpdateActionTypeInput : public OAIObject {
public:
    OAIUpdateActionTypeInput();
    OAIUpdateActionTypeInput(QString json);
    ~OAIUpdateActionTypeInput() override;
    ...
    OAIUpdateActionTypeInput_actionType getActionType() const;
    void setActionType(const OAIUpdateActionTypeInput_actionType &action_type);
...
private:
    ...
    OAIUpdateActionTypeInput_actionType m_action_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateActionTypeInput)

#endif // OAIUpdateActionTypeInput_H
