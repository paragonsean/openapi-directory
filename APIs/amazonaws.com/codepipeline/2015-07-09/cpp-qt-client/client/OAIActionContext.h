...
#ifndef OAIActionContext_H
#define OAIActionContext_H
...
class OAIActionContext : public OAIObject {
public:
    OAIActionContext();
    OAIActionContext(QString json);
    ~OAIActionContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionContext)

#endif // OAIActionContext_H
