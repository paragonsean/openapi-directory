...
qint32 OAIArtifactDetails::getMinimumCount() const {
    return m_minimum_count;
}
void OAIArtifactDetails::setMinimumCount(const qint32 &minimum_count) {
    m_minimum_count = minimum_count;
    m_minimum_count_isSet = true;
}

bool OAIArtifactDetails::is_minimum_count_Set() const{
    return m_minimum_count_isSet;
}

bool OAIArtifactDetails::is_minimum_count_Valid() const{
    return m_minimum_count_isValid;
}

qint32 OAIArtifactDetails::getMaximumCount() const {
    return m_maximum_count;
}
void OAIArtifactDetails::setMaximumCount(const qint32 &maximum_count) {
    m_maximum_count = maximum_count;
    m_maximum_count_isSet = true;
}

bool OAIArtifactDetails::is_maximum_count_Set() const{
    return m_maximum_count_isSet;
}

bool OAIArtifactDetails::is_maximum_count_Valid() const{
