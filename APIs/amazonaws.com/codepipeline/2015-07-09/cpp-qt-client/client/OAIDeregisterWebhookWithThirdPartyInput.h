...
/*
 * OAIDeregisterWebhookWithThirdPartyInput.h
 *
 * 
 */

#ifndef OAIDeregisterWebhookWithThirdPartyInput_H
#define OAIDeregisterWebhookWithThirdPartyInput_H
...
class OAIDeregisterWebhookWithThirdPartyInput : public OAIObject {
public:
    OAIDeregisterWebhookWithThirdPartyInput();
    OAIDeregisterWebhookWithThirdPartyInput(QString json);
    ~OAIDeregisterWebhookWithThirdPartyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeregisterWebhookWithThirdPartyInput)

#endif // OAIDeregisterWebhookWithThirdPartyInput_H
