...
OAIPollForJobsInput_actionTypeId OAIJobData::getActionTypeId() const {
    return m_action_type_id;
}
void OAIJobData::setActionTypeId(const OAIPollForJobsInput_actionTypeId &action_type_id) {
    m_action_type_id = action_type_id;
    m_action_type_id_isSet = true;
}

bool OAIJobData::is_action_type_id_Set() const{
    return m_action_type_id_isSet;
}

bool OAIJobData::is_action_type_id_Valid() const{
    return m_action_type_id_isValid;
}

OAIJobData_actionConfiguration OAIJobData::getActionConfiguration() const {
    return m_action_configuration;
}
void OAIJobData::setActionConfiguration(const OAIJobData_actionConfiguration &action_configuration) {
    m_action_configuration = action_configuration;
    m_action_configuration_isSet = true;
}

bool OAIJobData::is_action_configuration_Set() const{
    return m_action_configuration_isSet;
}

bool OAIJobData::is_action_configuration_Valid() const{
    return m_action_configuration_isValid;
}

OAIJobData_pipelineContext OAIJobData::getPipelineContext() const {
    return m_pipeline_context;
}
void OAIJobData::setPipelineContext(const OAIJobData_pipelineContext &pipeline_context) {
    m_pipeline_context = pipeline_context;
    m_pipeline_context_isSet = true;
}

bool OAIJobData::is_pipeline_context_Set() const{
    return m_pipeline_context_isSet;
}

bool OAIJobData::is_pipeline_context_Valid() const{
    return m_pipeline_context_isValid;
}

QList OAIJobData::getInputArtifacts() const {
    return m_input_artifacts;
}
void OAIJobData::setInputArtifacts(const QList &input_artifacts) {
    m_input_artifacts = input_artifacts;
    m_input_artifacts_isSet = true;
}

bool OAIJobData::is_input_artifacts_Set() const{
    return m_input_artifacts_isSet;
}

bool OAIJobData::is_input_artifacts_Valid() const{
    return m_input_artifacts_isValid;
}

QList OAIJobData::getOutputArtifacts() const {
    return m_output_artifacts;
}
void OAIJobData::setOutputArtifacts(const QList &output_artifacts) {
    m_output_artifacts = output_artifacts;
    m_output_artifacts_isSet = true;
}

bool OAIJobData::is_output_artifacts_Set() const{
    return m_output_artifacts_isSet;
}

bool OAIJobData::is_output_artifacts_Valid() const{
    return m_output_artifacts_isValid;
}

OAIJobData_artifactCredentials OAIJobData::getArtifactCredentials() const {
    return m_artifact_credentials;
}
void OAIJobData::setArtifactCredentials(const OAIJobData_artifactCredentials &artifact_credentials) {
    m_artifact_credentials = artifact_credentials;
    m_artifact_credentials_isSet = true;
}

bool OAIJobData::is_artifact_credentials_Set() const{
    return m_artifact_credentials_isSet;
}

bool OAIJobData::is_artifact_credentials_Valid() const{
    return m_artifact_credentials_isValid;
}

QString OAIJobData::getContinuationToken() const {
    return m_continuation_token;
}
void OAIJobData::setContinuationToken(const QString &continuation_token) {
    m_continuation_token = continuation_token;
    m_continuation_token_isSet = true;
}

bool OAIJobData::is_continuation_token_Set() const{
    return m_continuation_token_isSet;
}

bool OAIJobData::is_continuation_token_Valid() const{
    return m_continuation_token_isValid;
}

OAIJobData_encryptionKey OAIJobData::getEncryptionKey() const {
    return m_encryption_key;
}
void OAIJobData::setEncryptionKey(const OAIJobData_encryptionKey &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAIJobData::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAIJobData::is_encryption_key_Valid() const{
