...
OAIRegisterWebhookWithThirdPartyInput::OAIRegisterWebhookWithThirdPartyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegisterWebhookWithThirdPartyInput::OAIRegisterWebhookWithThirdPartyInput() {
    this->initializeModel();
}

OAIRegisterWebhookWithThirdPartyInput::~OAIRegisterWebhookWithThirdPartyInput() {}

void OAIRegisterWebhookWithThirdPartyInput::initializeModel() {

    m_webhook_name_isSet = false;
    m_webhook_name_isValid = false;
}

void OAIRegisterWebhookWithThirdPartyInput::fromJson(QString jsonString) {
...
void OAIRegisterWebhookWithThirdPartyInput::fromJsonObject(QJsonObject json) {
...
QString OAIRegisterWebhookWithThirdPartyInput::asJson() const {
...
QJsonObject OAIRegisterWebhookWithThirdPartyInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRegisterWebhookWithThirdPartyInput::getWebhookName() const {
    return m_webhook_name;
}
void OAIRegisterWebhookWithThirdPartyInput::setWebhookName(const QString &webhook_name) {
    m_webhook_name = webhook_name;
    m_webhook_name_isSet = true;
}

bool OAIRegisterWebhookWithThirdPartyInput::is_webhook_name_Set() const{
    return m_webhook_name_isSet;
}

bool OAIRegisterWebhookWithThirdPartyInput::is_webhook_name_Valid() const{
    return m_webhook_name_isValid;
}

bool OAIRegisterWebhookWithThirdPartyInput::isSet() const {
...
bool OAIRegisterWebhookWithThirdPartyInput::isValid() const {
