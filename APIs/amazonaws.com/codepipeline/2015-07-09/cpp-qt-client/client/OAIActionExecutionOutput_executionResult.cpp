...
OAIActionExecutionOutput_executionResult::OAIActionExecutionOutput_executionResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionExecutionOutput_executionResult::OAIActionExecutionOutput_executionResult() {
    this->initializeModel();
}

OAIActionExecutionOutput_executionResult::~OAIActionExecutionOutput_executionResult() {}

void OAIActionExecutionOutput_executionResult::initializeModel() {

    m_external_execution_id_isSet = false;
    m_external_execution_id_isValid = false;

    m_external_execution_summary_isSet = false;
    m_external_execution_summary_isValid = false;

    m_external_execution_url_isSet = false;
    m_external_execution_url_isValid = false;
}

void OAIActionExecutionOutput_executionResult::fromJson(QString jsonString) {
...
void OAIActionExecutionOutput_executionResult::fromJsonObject(QJsonObject json) {
    ...
    m_external_execution_summary_isValid = ::OpenAPI::fromJsonValue(m_external_execution_summary, json[QString("externalExecutionSummary")]);
    m_external_execution_summary_isSet = !json[QString("externalExecutionSummary")].isNull() && m_external_execution_summary_isValid;
...
QString OAIActionExecutionOutput_executionResult::asJson() const {
...
QJsonObject OAIActionExecutionOutput_executionResult::asJsonObject() const {
    QJsonObject obj;
    if (m_external_execution_id_isSet) {
        obj.insert(QString("externalExecutionId"), ::OpenAPI::toJsonValue(m_external_execution_id));
    }
    if (m_external_execution_summary_isSet) {
        obj.insert(QString("externalExecutionSummary"), ::OpenAPI::toJsonValue(m_external_execution_summary));
    }
...
QString OAIActionExecutionOutput_executionResult::getExternalExecutionId() const {
    return m_external_execution_id;
}
void OAIActionExecutionOutput_executionResult::setExternalExecutionId(const QString &external_execution_id) {
    m_external_execution_id = external_execution_id;
    m_external_execution_id_isSet = true;
}

bool OAIActionExecutionOutput_executionResult::is_external_execution_id_Set() const{
    return m_external_execution_id_isSet;
}

bool OAIActionExecutionOutput_executionResult::is_external_execution_id_Valid() const{
    return m_external_execution_id_isValid;
}

QString OAIActionExecutionOutput_executionResult::getExternalExecutionSummary() const {
    return m_external_execution_summary;
}
void OAIActionExecutionOutput_executionResult::setExternalExecutionSummary(const QString &external_execution_summary) {
    m_external_execution_summary = external_execution_summary;
    m_external_execution_summary_isSet = true;
}

bool OAIActionExecutionOutput_executionResult::is_external_execution_summary_Set() const{
    return m_external_execution_summary_isSet;
}

bool OAIActionExecutionOutput_executionResult::is_external_execution_summary_Valid() const{
    return m_external_execution_summary_isValid;
}

QString OAIActionExecutionOutput_executionResult::getExternalExecutionUrl() const {
    return m_external_execution_url;
}
void OAIActionExecutionOutput_executionResult::setExternalExecutionUrl(const QString &external_execution_url) {
    m_external_execution_url = external_execution_url;
    m_external_execution_url_isSet = true;
}

bool OAIActionExecutionOutput_executionResult::is_external_execution_url_Set() const{
    return m_external_execution_url_isSet;
}

bool OAIActionExecutionOutput_executionResult::is_external_execution_url_Valid() const{
    return m_external_execution_url_isValid;
}

bool OAIActionExecutionOutput_executionResult::isSet() const {
...
bool OAIActionExecutionOutput_executionResult::isValid() const {
