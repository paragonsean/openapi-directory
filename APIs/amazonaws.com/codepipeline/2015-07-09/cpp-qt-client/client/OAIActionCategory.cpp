...
void OAIActionCategory::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("Source", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionCategory::SOURCE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Build", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionCategory::BUILD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Deploy", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionCategory::DEPLOY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Test", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionCategory::TEST;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Invoke", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionCategory::INVOKE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Approval", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionCategory::APPROVAL;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIActionCategory::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIActionCategory::SOURCE:
            val = "Source";
            break;
        case eOAIActionCategory::BUILD:
            val = "Build";
            break;
        case eOAIActionCategory::DEPLOY:
            val = "Deploy";
            break;
        case eOAIActionCategory::TEST:
            val = "Test";
            break;
        case eOAIActionCategory::INVOKE:
            val = "Invoke";
            break;
        case eOAIActionCategory::APPROVAL:
            val = "Approval";
            break;
        default:
            break;
