...
/*
 * OAIActionExecutionInput.h
 *
 * Input information used for an action execution.
 */

#ifndef OAIActionExecutionInput_H
#define OAIActionExecutionInput_H
...
class OAIActionExecutionInput : public OAIObject {
public:
    OAIActionExecutionInput();
    OAIActionExecutionInput(QString json);
    ~OAIActionExecutionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionExecutionInput)

#endif // OAIActionExecutionInput_H
