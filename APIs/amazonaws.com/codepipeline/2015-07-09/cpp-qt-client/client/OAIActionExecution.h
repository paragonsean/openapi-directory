...
/*
 * OAIActionExecution.h
 *
 * Represents information about the run of an action.
 */

#ifndef OAIActionExecution_H
#define OAIActionExecution_H

#include <QJsonObject>

#include "OAIActionExecutionStatus.h"
#include "OAIActionExecution_errorDetails.h"
#include <QDateTime>
#include <QString>
...
namespace OpenAPI {
class OAIActionExecution_errorDetails;

class OAIActionExecution : public OAIObject {
public:
    OAIActionExecution();
    OAIActionExecution(QString json);
    ~OAIActionExecution() override;
    ...
    OAIActionExecution_errorDetails getErrorDetails() const;
    void setErrorDetails(const OAIActionExecution_errorDetails &error_details);
...
private:
    ...
    OAIActionExecution_errorDetails m_error_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionExecution)

#endif // OAIActionExecution_H
