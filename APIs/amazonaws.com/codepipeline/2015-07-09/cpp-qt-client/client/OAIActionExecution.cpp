...
OAIActionExecution::OAIActionExecution(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionExecution::OAIActionExecution() {
    this->initializeModel();
}

OAIActionExecution::~OAIActionExecution() {}

void OAIActionExecution::initializeModel() {
...
void OAIActionExecution::fromJson(QString jsonString) {
...
void OAIActionExecution::fromJsonObject(QJsonObject json) {
...
QString OAIActionExecution::asJson() const {
...
QJsonObject OAIActionExecution::asJsonObject() const {
    QJsonObject obj;
...
QString OAIActionExecution::getActionExecutionId() const {
    return m_action_execution_id;
}
void OAIActionExecution::setActionExecutionId(const QString &action_execution_id) {
    m_action_execution_id = action_execution_id;
    m_action_execution_id_isSet = true;
}

bool OAIActionExecution::is_action_execution_id_Set() const{
    return m_action_execution_id_isSet;
}

bool OAIActionExecution::is_action_execution_id_Valid() const{
    return m_action_execution_id_isValid;
}

OAIActionExecutionStatus OAIActionExecution::getStatus() const {
    return m_status;
}
void OAIActionExecution::setStatus(const OAIActionExecutionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIActionExecution::is_status_Set() const{
    return m_status_isSet;
}

bool OAIActionExecution::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIActionExecution::getSummary() const {
    return m_summary;
}
void OAIActionExecution::setSummary(const QString &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAIActionExecution::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAIActionExecution::is_summary_Valid() const{
    return m_summary_isValid;
}

QDateTime OAIActionExecution::getLastStatusChange() const {
    return m_last_status_change;
}
void OAIActionExecution::setLastStatusChange(const QDateTime &last_status_change) {
    m_last_status_change = last_status_change;
    m_last_status_change_isSet = true;
}

bool OAIActionExecution::is_last_status_change_Set() const{
    return m_last_status_change_isSet;
}

bool OAIActionExecution::is_last_status_change_Valid() const{
    return m_last_status_change_isValid;
}

QString OAIActionExecution::getToken() const {
    return m_token;
}
void OAIActionExecution::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIActionExecution::is_token_Set() const{
    return m_token_isSet;
}

bool OAIActionExecution::is_token_Valid() const{
    return m_token_isValid;
}

QString OAIActionExecution::getLastUpdatedBy() const {
    return m_last_updated_by;
}
void OAIActionExecution::setLastUpdatedBy(const QString &last_updated_by) {
    m_last_updated_by = last_updated_by;
    m_last_updated_by_isSet = true;
}

bool OAIActionExecution::is_last_updated_by_Set() const{
    return m_last_updated_by_isSet;
}

bool OAIActionExecution::is_last_updated_by_Valid() const{
    return m_last_updated_by_isValid;
}

QString OAIActionExecution::getExternalExecutionId() const {
    return m_external_execution_id;
}
void OAIActionExecution::setExternalExecutionId(const QString &external_execution_id) {
    m_external_execution_id = external_execution_id;
    m_external_execution_id_isSet = true;
}

bool OAIActionExecution::is_external_execution_id_Set() const{
    return m_external_execution_id_isSet;
}

bool OAIActionExecution::is_external_execution_id_Valid() const{
    return m_external_execution_id_isValid;
}

QString OAIActionExecution::getExternalExecutionUrl() const {
    return m_external_execution_url;
}
void OAIActionExecution::setExternalExecutionUrl(const QString &external_execution_url) {
    m_external_execution_url = external_execution_url;
    m_external_execution_url_isSet = true;
}

bool OAIActionExecution::is_external_execution_url_Set() const{
    return m_external_execution_url_isSet;
}

bool OAIActionExecution::is_external_execution_url_Valid() const{
    return m_external_execution_url_isValid;
}

qint32 OAIActionExecution::getPercentComplete() const {
    return m_percent_complete;
}
void OAIActionExecution::setPercentComplete(const qint32 &percent_complete) {
    m_percent_complete = percent_complete;
    m_percent_complete_isSet = true;
}

bool OAIActionExecution::is_percent_complete_Set() const{
    return m_percent_complete_isSet;
}

bool OAIActionExecution::is_percent_complete_Valid() const{
    return m_percent_complete_isValid;
}

OAIActionExecution_errorDetails OAIActionExecution::getErrorDetails() const {
    return m_error_details;
}
void OAIActionExecution::setErrorDetails(const OAIActionExecution_errorDetails &error_details) {
    m_error_details = error_details;
    m_error_details_isSet = true;
}

bool OAIActionExecution::is_error_details_Set() const{
    return m_error_details_isSet;
}

bool OAIActionExecution::is_error_details_Valid() const{
    return m_error_details_isValid;
}

bool OAIActionExecution::isSet() const {
...
bool OAIActionExecution::isValid() const {
