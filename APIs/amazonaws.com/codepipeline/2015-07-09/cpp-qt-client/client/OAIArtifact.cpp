...
QString OAIArtifact::getRevision() const {
    return m_revision;
}
void OAIArtifact::setRevision(const QString &revision) {
    m_revision = revision;
    m_revision_isSet = true;
}

bool OAIArtifact::is_revision_Set() const{
    return m_revision_isSet;
}

bool OAIArtifact::is_revision_Valid() const{
    return m_revision_isValid;
}

OAIArtifact_location OAIArtifact::getLocation() const {
    return m_location;
}
void OAIArtifact::setLocation(const OAIArtifact_location &location) {
    m_location = location;
