...
/*
 * OAIGetPipelineInput.h
 *
 * Represents the input of a &lt;code&gt;GetPipeline&lt;/code&gt; action.
 */

#ifndef OAIGetPipelineInput_H
#define OAIGetPipelineInput_H
...
class OAIGetPipelineInput : public OAIObject {
public:
    OAIGetPipelineInput();
    OAIGetPipelineInput(QString json);
    ~OAIGetPipelineInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPipelineInput)

#endif // OAIGetPipelineInput_H
