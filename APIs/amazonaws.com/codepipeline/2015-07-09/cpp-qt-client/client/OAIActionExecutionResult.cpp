...
#include "OAIActionExecutionResult.h"
...
OAIActionExecutionResult::OAIActionExecutionResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionExecutionResult::OAIActionExecutionResult() {
    this->initializeModel();
}

OAIActionExecutionResult::~OAIActionExecutionResult() {}

void OAIActionExecutionResult::initializeModel() {
...
void OAIActionExecutionResult::fromJson(QString jsonString) {
...
void OAIActionExecutionResult::fromJsonObject(QJsonObject json) {
...
QString OAIActionExecutionResult::asJson() const {
...
QJsonObject OAIActionExecutionResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAIActionExecutionResult::getExternalExecutionId() const {
    return m_external_execution_id;
}
void OAIActionExecutionResult::setExternalExecutionId(const QString &external_execution_id) {
    m_external_execution_id = external_execution_id;
    m_external_execution_id_isSet = true;
}

bool OAIActionExecutionResult::is_external_execution_id_Set() const{
    return m_external_execution_id_isSet;
}

bool OAIActionExecutionResult::is_external_execution_id_Valid() const{
    return m_external_execution_id_isValid;
}

QString OAIActionExecutionResult::getExternalExecutionSummary() const {
    return m_external_execution_summary;
}
void OAIActionExecutionResult::setExternalExecutionSummary(const QString &external_execution_summary) {
    m_external_execution_summary = external_execution_summary;
    m_external_execution_summary_isSet = true;
}

bool OAIActionExecutionResult::is_external_execution_summary_Set() const{
    return m_external_execution_summary_isSet;
}

bool OAIActionExecutionResult::is_external_execution_summary_Valid() const{
    return m_external_execution_summary_isValid;
}

QString OAIActionExecutionResult::getExternalExecutionUrl() const {
    return m_external_execution_url;
}
void OAIActionExecutionResult::setExternalExecutionUrl(const QString &external_execution_url) {
    m_external_execution_url = external_execution_url;
    m_external_execution_url_isSet = true;
}

bool OAIActionExecutionResult::is_external_execution_url_Set() const{
    return m_external_execution_url_isSet;
}

bool OAIActionExecutionResult::is_external_execution_url_Valid() const{
    return m_external_execution_url_isValid;
}

bool OAIActionExecutionResult::isSet() const {
...
bool OAIActionExecutionResult::isValid() const {
