...
/*
 * OAIActionExecutionResult.h
 *
 * Execution result information, such as the external execution ID.
 */

#ifndef OAIActionExecutionResult_H
#define OAIActionExecutionResult_H
...
class OAIActionExecutionResult : public OAIObject {
public:
    OAIActionExecutionResult();
    OAIActionExecutionResult(QString json);
    ~OAIActionExecutionResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionExecutionResult)

#endif // OAIActionExecutionResult_H
