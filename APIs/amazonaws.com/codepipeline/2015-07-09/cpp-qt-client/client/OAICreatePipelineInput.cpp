...
OAICreatePipelineOutput_pipeline OAICreatePipelineInput::getPipeline() const {
    return m_pipeline;
}
void OAICreatePipelineInput::setPipeline(const OAICreatePipelineOutput_pipeline &pipeline) {
    m_pipeline = pipeline;
    m_pipeline_isSet = true;
}

bool OAICreatePipelineInput::is_pipeline_Set() const{
    return m_pipeline_isSet;
}

bool OAICreatePipelineInput::is_pipeline_Valid() const{
