...
#include "OAIThirdPartyJobDetails.h"
...
OAIThirdPartyJobDetails::OAIThirdPartyJobDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIThirdPartyJobDetails::OAIThirdPartyJobDetails() {
    this->initializeModel();
}

OAIThirdPartyJobDetails::~OAIThirdPartyJobDetails() {}

void OAIThirdPartyJobDetails::initializeModel() {
...
void OAIThirdPartyJobDetails::fromJson(QString jsonString) {
...
void OAIThirdPartyJobDetails::fromJsonObject(QJsonObject json) {
...
QString OAIThirdPartyJobDetails::asJson() const {
...
QJsonObject OAIThirdPartyJobDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIThirdPartyJobDetails::getId() const {
    return m_id;
}
void OAIThirdPartyJobDetails::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIThirdPartyJobDetails::is_id_Set() const{
    return m_id_isSet;
}

bool OAIThirdPartyJobDetails::is_id_Valid() const{
    return m_id_isValid;
}

OAIThirdPartyJobDetails_data OAIThirdPartyJobDetails::getData() const {
    return m_data;
}
void OAIThirdPartyJobDetails::setData(const OAIThirdPartyJobDetails_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIThirdPartyJobDetails::is_data_Set() const{
    return m_data_isSet;
}

bool OAIThirdPartyJobDetails::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIThirdPartyJobDetails::getNonce() const {
    return m_nonce;
}
void OAIThirdPartyJobDetails::setNonce(const QString &nonce) {
    m_nonce = nonce;
    m_nonce_isSet = true;
}

bool OAIThirdPartyJobDetails::is_nonce_Set() const{
    return m_nonce_isSet;
}

bool OAIThirdPartyJobDetails::is_nonce_Valid() const{
    return m_nonce_isValid;
}

bool OAIThirdPartyJobDetails::isSet() const {
...
bool OAIThirdPartyJobDetails::isValid() const {
