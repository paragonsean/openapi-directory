...
#ifndef OAIArtifactStore_H
#define OAIArtifactStore_H
...
class OAIArtifactStore : public OAIObject {
public:
    OAIArtifactStore();
    OAIArtifactStore(QString json);
    ~OAIArtifactStore() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactStore)

#endif // OAIArtifactStore_H
