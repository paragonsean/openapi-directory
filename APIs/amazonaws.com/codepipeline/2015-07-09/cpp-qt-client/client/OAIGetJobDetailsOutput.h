...
/*
 * OAIGetJobDetailsOutput.h
 *
 * Represents the output of a &lt;code&gt;GetJobDetails&lt;/code&gt; action.
 */

#ifndef OAIGetJobDetailsOutput_H
#define OAIGetJobDetailsOutput_H

#include <QJsonObject>

#include "OAIGetJobDetailsOutput_jobDetails.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetJobDetailsOutput_jobDetails;

class OAIGetJobDetailsOutput : public OAIObject {
public:
    OAIGetJobDetailsOutput();
    OAIGetJobDetailsOutput(QString json);
    ~OAIGetJobDetailsOutput() override;
    ...
    OAIGetJobDetailsOutput_jobDetails getJobDetails() const;
    void setJobDetails(const OAIGetJobDetailsOutput_jobDetails &job_details);
...
private:
    ...
    OAIGetJobDetailsOutput_jobDetails m_job_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetJobDetailsOutput)

#endif // OAIGetJobDetailsOutput_H
