...
/*
 * OAIListActionExecutionsInput_filter.h
 *
 * 
 */

#ifndef OAIListActionExecutionsInput_filter_H
#define OAIListActionExecutionsInput_filter_H
...
class OAIListActionExecutionsInput_filter : public OAIObject {
public:
    OAIListActionExecutionsInput_filter();
    OAIListActionExecutionsInput_filter(QString json);
    ~OAIListActionExecutionsInput_filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListActionExecutionsInput_filter)

#endif // OAIListActionExecutionsInput_filter_H
