...
/*
 * OAIStopExecutionTrigger.h
 *
 * The interaction that stopped a pipeline execution.
 */

#ifndef OAIStopExecutionTrigger_H
#define OAIStopExecutionTrigger_H
...
class OAIStopExecutionTrigger : public OAIObject {
public:
    OAIStopExecutionTrigger();
    OAIStopExecutionTrigger(QString json);
    ~OAIStopExecutionTrigger() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopExecutionTrigger)

#endif // OAIStopExecutionTrigger_H
