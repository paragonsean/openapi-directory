...
/*
 * OAIUpdatePipelineInput.h
 *
 * Represents the input of an &lt;code&gt;UpdatePipeline&lt;/code&gt; action.
 */

#ifndef OAIUpdatePipelineInput_H
#define OAIUpdatePipelineInput_H
...
namespace OpenAPI {
class OAIUpdatePipelineInput_pipeline;

class OAIUpdatePipelineInput : public OAIObject {
public:
    OAIUpdatePipelineInput();
    OAIUpdatePipelineInput(QString json);
    ~OAIUpdatePipelineInput() override;
    ...
    OAIUpdatePipelineInput_pipeline getPipeline() const;
    void setPipeline(const OAIUpdatePipelineInput_pipeline &pipeline);
...
private:
    ...
    OAIUpdatePipelineInput_pipeline m_pipeline;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipelineInput)

#endif // OAIUpdatePipelineInput_H
