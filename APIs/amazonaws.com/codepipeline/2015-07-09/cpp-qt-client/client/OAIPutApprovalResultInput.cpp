...
OAIPutApprovalResultInput::OAIPutApprovalResultInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutApprovalResultInput::OAIPutApprovalResultInput() {
    this->initializeModel();
}

OAIPutApprovalResultInput::~OAIPutApprovalResultInput() {}

void OAIPutApprovalResultInput::initializeModel() {
...
void OAIPutApprovalResultInput::fromJson(QString jsonString) {
...
void OAIPutApprovalResultInput::fromJsonObject(QJsonObject json) {
...
QString OAIPutApprovalResultInput::asJson() const {
...
QJsonObject OAIPutApprovalResultInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutApprovalResultInput::getPipelineName() const {
    return m_pipeline_name;
}
void OAIPutApprovalResultInput::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIPutApprovalResultInput::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIPutApprovalResultInput::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

QString OAIPutApprovalResultInput::getStageName() const {
    return m_stage_name;
}
void OAIPutApprovalResultInput::setStageName(const QString &stage_name) {
    m_stage_name = stage_name;
    m_stage_name_isSet = true;
}

bool OAIPutApprovalResultInput::is_stage_name_Set() const{
    return m_stage_name_isSet;
}

bool OAIPutApprovalResultInput::is_stage_name_Valid() const{
    return m_stage_name_isValid;
}

QString OAIPutApprovalResultInput::getActionName() const {
    return m_action_name;
}
void OAIPutApprovalResultInput::setActionName(const QString &action_name) {
    m_action_name = action_name;
    m_action_name_isSet = true;
}

bool OAIPutApprovalResultInput::is_action_name_Set() const{
    return m_action_name_isSet;
}

bool OAIPutApprovalResultInput::is_action_name_Valid() const{
    return m_action_name_isValid;
}

OAIPutApprovalResultInput_result OAIPutApprovalResultInput::getResult() const {
    return m_result;
}
void OAIPutApprovalResultInput::setResult(const OAIPutApprovalResultInput_result &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIPutApprovalResultInput::is_result_Set() const{
    return m_result_isSet;
}

bool OAIPutApprovalResultInput::is_result_Valid() const{
    return m_result_isValid;
}

QString OAIPutApprovalResultInput::getToken() const {
    return m_token;
}
void OAIPutApprovalResultInput::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPutApprovalResultInput::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPutApprovalResultInput::is_token_Valid() const{
    return m_token_isValid;
}

bool OAIPutApprovalResultInput::isSet() const {
...
bool OAIPutApprovalResultInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pipeline_name_isValid && m_stage_name_isValid && m_action_name_isValid && m_result_isValid && m_token_isValid && true;
}
