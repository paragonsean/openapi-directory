...
/*
 * OAIUpdatePipelineOutput.h
 *
 * Represents the output of an &lt;code&gt;UpdatePipeline&lt;/code&gt; action.
 */

#ifndef OAIUpdatePipelineOutput_H
#define OAIUpdatePipelineOutput_H

#include <QJsonObject>

#include "OAIUpdatePipelineOutput_pipeline.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdatePipelineOutput_pipeline;

class OAIUpdatePipelineOutput : public OAIObject {
public:
    OAIUpdatePipelineOutput();
    OAIUpdatePipelineOutput(QString json);
    ~OAIUpdatePipelineOutput() override;
    ...
    OAIUpdatePipelineOutput_pipeline getPipeline() const;
    void setPipeline(const OAIUpdatePipelineOutput_pipeline &pipeline);
...
private:
    ...
    OAIUpdatePipelineOutput_pipeline m_pipeline;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipelineOutput)

#endif // OAIUpdatePipelineOutput_H
