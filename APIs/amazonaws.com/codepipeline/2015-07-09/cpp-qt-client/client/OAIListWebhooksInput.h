...
/*
 * OAIListWebhooksInput.h
 *
 * 
 */

#ifndef OAIListWebhooksInput_H
#define OAIListWebhooksInput_H
...
class OAIListWebhooksInput : public OAIObject {
public:
    OAIListWebhooksInput();
    OAIListWebhooksInput(QString json);
    ~OAIListWebhooksInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListWebhooksInput)

#endif // OAIListWebhooksInput_H
