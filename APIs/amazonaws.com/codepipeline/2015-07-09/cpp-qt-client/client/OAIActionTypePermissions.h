...
/*
 * OAIActionTypePermissions.h
 *
 * Details identifying the users with permissions to use the action type.
 */

#ifndef OAIActionTypePermissions_H
#define OAIActionTypePermissions_H
...
class OAIActionTypePermissions : public OAIObject {
public:
    OAIActionTypePermissions();
    OAIActionTypePermissions(QString json);
    ~OAIActionTypePermissions() override;
    ...
    QList getAllowedAccounts() const;
    void setAllowedAccounts(const QList &allowed_accounts);
    bool is_allowed_accounts_Set() const;
    bool is_allowed_accounts_Valid() const;
...
private:
    ...
    QList m_allowed_accounts;
    bool m_allowed_accounts_isSet;
    bool m_allowed_accounts_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIActionTypePermissions)

#endif // OAIActionTypePermissions_H
