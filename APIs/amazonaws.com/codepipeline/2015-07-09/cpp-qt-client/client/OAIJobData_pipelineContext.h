...
/*
 * OAIJobData_pipelineContext.h
 *
 * 
 */

#ifndef OAIJobData_pipelineContext_H
#define OAIJobData_pipelineContext_H

#include <QJsonObject>

#include "OAIPipelineContext_action.h"
#include "OAIPipelineContext_stage.h"
#include <QString>
...
namespace OpenAPI {
class OAIPipelineContext_stage;
class OAIPipelineContext_action;

class OAIJobData_pipelineContext : public OAIObject {
public:
    OAIJobData_pipelineContext();
    OAIJobData_pipelineContext(QString json);
    ~OAIJobData_pipelineContext() override;
    ...
    OAIPipelineContext_stage getStage() const;
    void setStage(const OAIPipelineContext_stage &stage);
    bool is_stage_Set() const;
    bool is_stage_Valid() const;

    OAIPipelineContext_action getAction() const;
    void setAction(const OAIPipelineContext_action &action);
...
private:
    ...
    OAIPipelineContext_stage m_stage;
    bool m_stage_isSet;
    bool m_stage_isValid;

    OAIPipelineContext_action m_action;
    bool m_action_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobData_pipelineContext)

#endif // OAIJobData_pipelineContext_H
