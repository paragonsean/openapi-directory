...
OAIPutJobFailureResultInput::OAIPutJobFailureResultInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutJobFailureResultInput::OAIPutJobFailureResultInput() {
    this->initializeModel();
}

OAIPutJobFailureResultInput::~OAIPutJobFailureResultInput() {}

void OAIPutJobFailureResultInput::initializeModel() {
...
void OAIPutJobFailureResultInput::fromJson(QString jsonString) {
...
void OAIPutJobFailureResultInput::fromJsonObject(QJsonObject json) {
...
QString OAIPutJobFailureResultInput::asJson() const {
...
QJsonObject OAIPutJobFailureResultInput::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIPutJobFailureResultInput::getJobId() const {
    return m_job_id;
}
void OAIPutJobFailureResultInput::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIPutJobFailureResultInput::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIPutJobFailureResultInput::is_job_id_Valid() const{
    return m_job_id_isValid;
}

OAIPutJobFailureResultInput_failureDetails OAIPutJobFailureResultInput::getFailureDetails() const {
    return m_failure_details;
}
void OAIPutJobFailureResultInput::setFailureDetails(const OAIPutJobFailureResultInput_failureDetails &failure_details) {
    m_failure_details = failure_details;
    m_failure_details_isSet = true;
}

bool OAIPutJobFailureResultInput::is_failure_details_Set() const{
    return m_failure_details_isSet;
}

bool OAIPutJobFailureResultInput::is_failure_details_Valid() const{
    return m_failure_details_isValid;
}

bool OAIPutJobFailureResultInput::isSet() const {
...
bool OAIPutJobFailureResultInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_job_id_isValid && m_failure_details_isValid && true;
}
