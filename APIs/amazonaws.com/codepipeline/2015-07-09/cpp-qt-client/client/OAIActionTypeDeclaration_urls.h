...
/*
 * OAIActionTypeDeclaration_urls.h
 *
 * 
 */

#ifndef OAIActionTypeDeclaration_urls_H
#define OAIActionTypeDeclaration_urls_H
...
class OAIActionTypeDeclaration_urls : public OAIObject {
public:
    OAIActionTypeDeclaration_urls();
    OAIActionTypeDeclaration_urls(QString json);
    ~OAIActionTypeDeclaration_urls() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeDeclaration_urls)

#endif // OAIActionTypeDeclaration_urls_H
