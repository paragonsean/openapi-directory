...
#ifndef OAIApprovalStatus_H
#define OAIApprovalStatus_H
...
class OAIApprovalStatus : public OAIEnum {
public:
    OAIApprovalStatus();
    OAIApprovalStatus(QString json);
    ~OAIApprovalStatus() override;
    ...
    enum class eOAIApprovalStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        APPROVED, 
        REJECTED
    };
    OAIApprovalStatus::eOAIApprovalStatus getValue() const;
    void setValue(const OAIApprovalStatus::eOAIApprovalStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIApprovalStatus)

#endif // OAIApprovalStatus_H
