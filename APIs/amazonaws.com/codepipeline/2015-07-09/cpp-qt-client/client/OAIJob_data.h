...
#ifndef OAIJob_data_H
#define OAIJob_data_H
...
class OAIJob_data : public OAIObject {
public:
    OAIJob_data();
    OAIJob_data(QString json);
    ~OAIJob_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJob_data)
