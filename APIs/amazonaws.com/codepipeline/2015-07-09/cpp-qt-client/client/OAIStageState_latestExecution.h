...
/*
 * OAIStageState_latestExecution.h
 *
 * 
 */

#ifndef OAIStageState_latestExecution_H
#define OAIStageState_latestExecution_H
...
class OAIStageState_latestExecution : public OAIObject {
public:
    OAIStageState_latestExecution();
    OAIStageState_latestExecution(QString json);
    ~OAIStageState_latestExecution() override;
    ...
    OAIStageExecutionStatus getStatus() const;
    void setStatus(const OAIStageExecutionStatus &status);
...
private:
    ...
    OAIStageExecutionStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStageState_latestExecution)

#endif // OAIStageState_latestExecution_H
