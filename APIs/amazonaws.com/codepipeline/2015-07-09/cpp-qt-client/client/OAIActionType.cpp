...
void OAIActionType::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIActionType::asJsonObject() const {
    QJsonObject obj;
    if (m_id.isSet()) {
...
OAIPollForJobsInput_actionTypeId OAIActionType::getId() const {
    return m_id;
}
void OAIActionType::setId(const OAIPollForJobsInput_actionTypeId &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIActionType::is_id_Set() const{
    return m_id_isSet;
}

bool OAIActionType::is_id_Valid() const{
    return m_id_isValid;
}

OAIActionType_settings OAIActionType::getSettings() const {
    return m_settings;
}
void OAIActionType::setSettings(const OAIActionType_settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIActionType::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIActionType::is_settings_Valid() const{
    return m_settings_isValid;
}

QList OAIActionType::getActionConfigurationProperties() const {
    return m_action_configuration_properties;
}
void OAIActionType::setActionConfigurationProperties(const QList &action_configuration_properties) {
    m_action_configuration_properties = action_configuration_properties;
    m_action_configuration_properties_isSet = true;
}

bool OAIActionType::is_action_configuration_properties_Set() const{
    return m_action_configuration_properties_isSet;
}

bool OAIActionType::is_action_configuration_properties_Valid() const{
    return m_action_configuration_properties_isValid;
}

OAICreateCustomActionTypeInput_inputArtifactDetails OAIActionType::getInputArtifactDetails() const {
    return m_input_artifact_details;
}
void OAIActionType::setInputArtifactDetails(const OAICreateCustomActionTypeInput_inputArtifactDetails &input_artifact_details) {
    m_input_artifact_details = input_artifact_details;
    m_input_artifact_details_isSet = true;
}

bool OAIActionType::is_input_artifact_details_Set() const{
    return m_input_artifact_details_isSet;
}

bool OAIActionType::is_input_artifact_details_Valid() const{
    return m_input_artifact_details_isValid;
}

OAICreateCustomActionTypeInput_outputArtifactDetails OAIActionType::getOutputArtifactDetails() const {
    return m_output_artifact_details;
}
void OAIActionType::setOutputArtifactDetails(const OAICreateCustomActionTypeInput_outputArtifactDetails &output_artifact_details) {
    m_output_artifact_details = output_artifact_details;
    m_output_artifact_details_isSet = true;
}

bool OAIActionType::is_output_artifact_details_Set() const{
    return m_output_artifact_details_isSet;
}

bool OAIActionType::is_output_artifact_details_Valid() const{
