...
#include "OAIArtifactStore_encryptionKey.h"
...
OAIArtifactStore_encryptionKey::OAIArtifactStore_encryptionKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArtifactStore_encryptionKey::OAIArtifactStore_encryptionKey() {
    this->initializeModel();
}

OAIArtifactStore_encryptionKey::~OAIArtifactStore_encryptionKey() {}

void OAIArtifactStore_encryptionKey::initializeModel() {
...
void OAIArtifactStore_encryptionKey::fromJson(QString jsonString) {
...
void OAIArtifactStore_encryptionKey::fromJsonObject(QJsonObject json) {
...
QString OAIArtifactStore_encryptionKey::asJson() const {
...
QJsonObject OAIArtifactStore_encryptionKey::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIArtifactStore_encryptionKey::getId() const {
    return m_id;
}
void OAIArtifactStore_encryptionKey::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIArtifactStore_encryptionKey::is_id_Set() const{
    return m_id_isSet;
}

bool OAIArtifactStore_encryptionKey::is_id_Valid() const{
    return m_id_isValid;
}

OAIEncryptionKeyType OAIArtifactStore_encryptionKey::getType() const {
    return m_type;
}
void OAIArtifactStore_encryptionKey::setType(const OAIEncryptionKeyType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIArtifactStore_encryptionKey::is_type_Set() const{
    return m_type_isSet;
}

bool OAIArtifactStore_encryptionKey::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIArtifactStore_encryptionKey::isSet() const {
...
bool OAIArtifactStore_encryptionKey::isValid() const {
