...
OAIApprovalStatus::OAIApprovalStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApprovalStatus::OAIApprovalStatus() {
    this->initializeModel();
}

OAIApprovalStatus::~OAIApprovalStatus() {}

void OAIApprovalStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIApprovalStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIApprovalStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Approved", Qt::CaseInsensitive) == 0) {
        m_value = eOAIApprovalStatus::APPROVED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Rejected", Qt::CaseInsensitive) == 0) {
        m_value = eOAIApprovalStatus::REJECTED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIApprovalStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIApprovalStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIApprovalStatus::APPROVED:
            val = "Approved";
            break;
        case eOAIApprovalStatus::REJECTED:
            val = "Rejected";
            break;
        default:
            break;
...
QJsonValue OAIApprovalStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIApprovalStatus::eOAIApprovalStatus OAIApprovalStatus::getValue() const {
    return m_value;
}

void OAIApprovalStatus::setValue(const OAIApprovalStatus::eOAIApprovalStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIApprovalStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIApprovalStatus::isValid() const {
