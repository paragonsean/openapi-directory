...
OAIActionExecutionStatus::OAIActionExecutionStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionExecutionStatus::OAIActionExecutionStatus() {
    this->initializeModel();
}

OAIActionExecutionStatus::~OAIActionExecutionStatus() {}

void OAIActionExecutionStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIActionExecutionStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIActionExecutionStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("InProgress", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionExecutionStatus::INPROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Abandoned", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionExecutionStatus::ABANDONED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Succeeded", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionExecutionStatus::SUCCEEDED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Failed", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionExecutionStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIActionExecutionStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIActionExecutionStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIActionExecutionStatus::INPROGRESS:
            val = "InProgress";
            break;
        case eOAIActionExecutionStatus::ABANDONED:
            val = "Abandoned";
            break;
        case eOAIActionExecutionStatus::SUCCEEDED:
            val = "Succeeded";
            break;
        case eOAIActionExecutionStatus::FAILED:
            val = "Failed";
            break;
        default:
            break;
...
QJsonValue OAIActionExecutionStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIActionExecutionStatus::eOAIActionExecutionStatus OAIActionExecutionStatus::getValue() const {
    return m_value;
}

void OAIActionExecutionStatus::setValue(const OAIActionExecutionStatus::eOAIActionExecutionStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIActionExecutionStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIActionExecutionStatus::isValid() const {
