...
/*
 * OAIWebhookAuthenticationType.h
 *
 * 
 */

#ifndef OAIWebhookAuthenticationType_H
#define OAIWebhookAuthenticationType_H
...
class OAIWebhookAuthenticationType : public OAIEnum {
public:
    OAIWebhookAuthenticationType();
    OAIWebhookAuthenticationType(QString json);
    ~OAIWebhookAuthenticationType() override;
    ...
    enum class eOAIWebhookAuthenticationType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        GITHUB_HMAC, 
        IP, 
        UNAUTHENTICATED
    };
    OAIWebhookAuthenticationType::eOAIWebhookAuthenticationType getValue() const;
    void setValue(const OAIWebhookAuthenticationType::eOAIWebhookAuthenticationType& value);
...
private:
    ...
    eOAIWebhookAuthenticationType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookAuthenticationType)

#endif // OAIWebhookAuthenticationType_H
