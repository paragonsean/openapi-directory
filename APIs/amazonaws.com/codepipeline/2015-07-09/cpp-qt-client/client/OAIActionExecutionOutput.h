...
/*
 * OAIActionExecutionOutput.h
 *
 * Output details listed for an action execution, such as the action execution result.
 */

#ifndef OAIActionExecutionOutput_H
#define OAIActionExecutionOutput_H

#include <QJsonObject>

#include "OAIActionExecutionOutput_executionResult.h"
#include <QList>
#include <QMap>
...
namespace OpenAPI {
class OAIActionExecutionOutput_executionResult;

class OAIActionExecutionOutput : public OAIObject {
public:
    OAIActionExecutionOutput();
    OAIActionExecutionOutput(QString json);
    ~OAIActionExecutionOutput() override;
    ...
    OAIActionExecutionOutput_executionResult getExecutionResult() const;
    void setExecutionResult(const OAIActionExecutionOutput_executionResult &execution_result);
...
private:
    ...
    OAIActionExecutionOutput_executionResult m_execution_result;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionExecutionOutput)

#endif // OAIActionExecutionOutput_H
