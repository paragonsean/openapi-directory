...
/*
 * OAIThirdPartyJobData_encryptionKey.h
 *
 * 
 */

#ifndef OAIThirdPartyJobData_encryptionKey_H
#define OAIThirdPartyJobData_encryptionKey_H
...
class OAIThirdPartyJobData_encryptionKey : public OAIObject {
public:
    OAIThirdPartyJobData_encryptionKey();
    OAIThirdPartyJobData_encryptionKey(QString json);
    ~OAIThirdPartyJobData_encryptionKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThirdPartyJobData_encryptionKey)

#endif // OAIThirdPartyJobData_encryptionKey_H
