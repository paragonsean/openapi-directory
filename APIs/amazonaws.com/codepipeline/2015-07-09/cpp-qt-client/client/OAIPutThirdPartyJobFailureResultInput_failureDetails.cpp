...
#include "OAIPutThirdPartyJobFailureResultInput_failureDetails.h"
...
OAIPutThirdPartyJobFailureResultInput_failureDetails::OAIPutThirdPartyJobFailureResultInput_failureDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutThirdPartyJobFailureResultInput_failureDetails::OAIPutThirdPartyJobFailureResultInput_failureDetails() {
    this->initializeModel();
}

OAIPutThirdPartyJobFailureResultInput_failureDetails::~OAIPutThirdPartyJobFailureResultInput_failureDetails() {}

void OAIPutThirdPartyJobFailureResultInput_failureDetails::initializeModel() {
...
void OAIPutThirdPartyJobFailureResultInput_failureDetails::fromJson(QString jsonString) {
...
void OAIPutThirdPartyJobFailureResultInput_failureDetails::fromJsonObject(QJsonObject json) {
...
QString OAIPutThirdPartyJobFailureResultInput_failureDetails::asJson() const {
...
QJsonObject OAIPutThirdPartyJobFailureResultInput_failureDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIFailureType OAIPutThirdPartyJobFailureResultInput_failureDetails::getType() const {
    return m_type;
}
void OAIPutThirdPartyJobFailureResultInput_failureDetails::setType(const OAIFailureType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPutThirdPartyJobFailureResultInput_failureDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPutThirdPartyJobFailureResultInput_failureDetails::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIPutThirdPartyJobFailureResultInput_failureDetails::getMessage() const {
    return m_message;
}
void OAIPutThirdPartyJobFailureResultInput_failureDetails::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIPutThirdPartyJobFailureResultInput_failureDetails::is_message_Set() const{
    return m_message_isSet;
}

bool OAIPutThirdPartyJobFailureResultInput_failureDetails::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIPutThirdPartyJobFailureResultInput_failureDetails::getExternalExecutionId() const {
    return m_external_execution_id;
}
void OAIPutThirdPartyJobFailureResultInput_failureDetails::setExternalExecutionId(const QString &external_execution_id) {
    m_external_execution_id = external_execution_id;
    m_external_execution_id_isSet = true;
}

bool OAIPutThirdPartyJobFailureResultInput_failureDetails::is_external_execution_id_Set() const{
    return m_external_execution_id_isSet;
}

bool OAIPutThirdPartyJobFailureResultInput_failureDetails::is_external_execution_id_Valid() const{
    return m_external_execution_id_isValid;
}

bool OAIPutThirdPartyJobFailureResultInput_failureDetails::isSet() const {
...
bool OAIPutThirdPartyJobFailureResultInput_failureDetails::isValid() const {
