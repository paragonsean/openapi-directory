...
OAIDeleteCustomActionTypeInput::OAIDeleteCustomActionTypeInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteCustomActionTypeInput::OAIDeleteCustomActionTypeInput() {
    this->initializeModel();
}

OAIDeleteCustomActionTypeInput::~OAIDeleteCustomActionTypeInput() {}

void OAIDeleteCustomActionTypeInput::initializeModel() {
...
void OAIDeleteCustomActionTypeInput::fromJson(QString jsonString) {
...
void OAIDeleteCustomActionTypeInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteCustomActionTypeInput::asJson() const {
...
QJsonObject OAIDeleteCustomActionTypeInput::asJsonObject() const {
    QJsonObject obj;
    if (m_category.isSet()) {
...
OAIActionCategory OAIDeleteCustomActionTypeInput::getCategory() const {
    return m_category;
}
void OAIDeleteCustomActionTypeInput::setCategory(const OAIActionCategory &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIDeleteCustomActionTypeInput::is_category_Set() const{
    return m_category_isSet;
}

bool OAIDeleteCustomActionTypeInput::is_category_Valid() const{
    return m_category_isValid;
}

QString OAIDeleteCustomActionTypeInput::getProvider() const {
    return m_provider;
}
void OAIDeleteCustomActionTypeInput::setProvider(const QString &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAIDeleteCustomActionTypeInput::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAIDeleteCustomActionTypeInput::is_provider_Valid() const{
    return m_provider_isValid;
}

QString OAIDeleteCustomActionTypeInput::getVersion() const {
    return m_version;
}
void OAIDeleteCustomActionTypeInput::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIDeleteCustomActionTypeInput::is_version_Set() const{
    return m_version_isSet;
}

bool OAIDeleteCustomActionTypeInput::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIDeleteCustomActionTypeInput::isSet() const {
...
bool OAIDeleteCustomActionTypeInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_category_isValid && m_provider_isValid && m_version_isValid && true;
}
