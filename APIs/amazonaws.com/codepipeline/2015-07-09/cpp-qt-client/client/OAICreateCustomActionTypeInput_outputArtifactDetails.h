...
/*
 * OAICreateCustomActionTypeInput_outputArtifactDetails.h
 *
 * 
 */

#ifndef OAICreateCustomActionTypeInput_outputArtifactDetails_H
#define OAICreateCustomActionTypeInput_outputArtifactDetails_H
...
class OAICreateCustomActionTypeInput_outputArtifactDetails : public OAIObject {
public:
    OAICreateCustomActionTypeInput_outputArtifactDetails();
    OAICreateCustomActionTypeInput_outputArtifactDetails(QString json);
    ~OAICreateCustomActionTypeInput_outputArtifactDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomActionTypeInput_outputArtifactDetails)

#endif // OAICreateCustomActionTypeInput_outputArtifactDetails_H
