...
#ifndef OAIStageRetryMode_H
#define OAIStageRetryMode_H
...
class OAIStageRetryMode : public OAIEnum {
public:
    OAIStageRetryMode();
    OAIStageRetryMode(QString json);
    ~OAIStageRetryMode() override;
    ...
    enum class eOAIStageRetryMode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        FAILED_ACTIONS
    };
    OAIStageRetryMode::eOAIStageRetryMode getValue() const;
    void setValue(const OAIStageRetryMode::eOAIStageRetryMode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStageRetryMode)

#endif // OAIStageRetryMode_H
