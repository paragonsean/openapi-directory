...
QString OAIPipelineSummary::getName() const {
    return m_name;
}
void OAIPipelineSummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPipelineSummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPipelineSummary::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIPipelineSummary::getVersion() const {
    return m_version;
}
void OAIPipelineSummary::setVersion(const qint32 &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIPipelineSummary::is_version_Set() const{
    return m_version_isSet;
}

bool OAIPipelineSummary::is_version_Valid() const{
    return m_version_isValid;
}

QDateTime OAIPipelineSummary::getCreated() const {
    return m_created;
}
void OAIPipelineSummary::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIPipelineSummary::is_created_Set() const{
    return m_created_isSet;
}

bool OAIPipelineSummary::is_created_Valid() const{
    return m_created_isValid;
}

QDateTime OAIPipelineSummary::getUpdated() const {
    return m_updated;
}
void OAIPipelineSummary::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIPipelineSummary::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIPipelineSummary::is_updated_Valid() const{
