...
/*
 * OAIListActionTypesInput.h
 *
 * Represents the input of a &lt;code&gt;ListActionTypes&lt;/code&gt; action.
 */

#ifndef OAIListActionTypesInput_H
#define OAIListActionTypesInput_H
...
class OAIListActionTypesInput : public OAIObject {
public:
    OAIListActionTypesInput();
    OAIListActionTypesInput(QString json);
    ~OAIListActionTypesInput() override;
    ...
    OAIActionOwner getActionOwnerFilter() const;
    void setActionOwnerFilter(const OAIActionOwner &action_owner_filter);
    bool is_action_owner_filter_Set() const;
    bool is_action_owner_filter_Valid() const;
    ...
    QString getRegionFilter() const;
    void setRegionFilter(const QString &region_filter);
    bool is_region_filter_Set() const;
    bool is_region_filter_Valid() const;
...
private:
    ...
    OAIActionOwner m_action_owner_filter;
    bool m_action_owner_filter_isSet;
    bool m_action_owner_filter_isValid;

    QString m_next_token;
    bool m_next_token_isSet;
    bool m_next_token_isValid;

    QString m_region_filter;
    bool m_region_filter_isSet;
    bool m_region_filter_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListActionTypesInput)

#endif // OAIListActionTypesInput_H
