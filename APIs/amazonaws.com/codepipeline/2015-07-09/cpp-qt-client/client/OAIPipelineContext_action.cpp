...
#include "OAIPipelineContext_action.h"
...
OAIPipelineContext_action::OAIPipelineContext_action(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPipelineContext_action::OAIPipelineContext_action() {
    this->initializeModel();
}

OAIPipelineContext_action::~OAIPipelineContext_action() {}

void OAIPipelineContext_action::initializeModel() {
...
void OAIPipelineContext_action::fromJson(QString jsonString) {
...
void OAIPipelineContext_action::fromJsonObject(QJsonObject json) {
...
QString OAIPipelineContext_action::asJson() const {
...
QJsonObject OAIPipelineContext_action::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIPipelineContext_action::getName() const {
    return m_name;
}
void OAIPipelineContext_action::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPipelineContext_action::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPipelineContext_action::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPipelineContext_action::getActionExecutionId() const {
    return m_action_execution_id;
}
void OAIPipelineContext_action::setActionExecutionId(const QString &action_execution_id) {
    m_action_execution_id = action_execution_id;
    m_action_execution_id_isSet = true;
}

bool OAIPipelineContext_action::is_action_execution_id_Set() const{
    return m_action_execution_id_isSet;
}

bool OAIPipelineContext_action::is_action_execution_id_Valid() const{
    return m_action_execution_id_isValid;
}

bool OAIPipelineContext_action::isSet() const {
...
bool OAIPipelineContext_action::isValid() const {
