...
OAICreateCustomActionTypeInput_outputArtifactDetails::OAICreateCustomActionTypeInput_outputArtifactDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCustomActionTypeInput_outputArtifactDetails::OAICreateCustomActionTypeInput_outputArtifactDetails() {
    this->initializeModel();
}

OAICreateCustomActionTypeInput_outputArtifactDetails::~OAICreateCustomActionTypeInput_outputArtifactDetails() {}

void OAICreateCustomActionTypeInput_outputArtifactDetails::initializeModel() {
...
void OAICreateCustomActionTypeInput_outputArtifactDetails::fromJson(QString jsonString) {
...
void OAICreateCustomActionTypeInput_outputArtifactDetails::fromJsonObject(QJsonObject json) {
...
QString OAICreateCustomActionTypeInput_outputArtifactDetails::asJson() const {
...
QJsonObject OAICreateCustomActionTypeInput_outputArtifactDetails::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateCustomActionTypeInput_outputArtifactDetails::getMinimumCount() const {
    return m_minimum_count;
}
void OAICreateCustomActionTypeInput_outputArtifactDetails::setMinimumCount(const qint32 &minimum_count) {
    m_minimum_count = minimum_count;
    m_minimum_count_isSet = true;
}

bool OAICreateCustomActionTypeInput_outputArtifactDetails::is_minimum_count_Set() const{
    return m_minimum_count_isSet;
}

bool OAICreateCustomActionTypeInput_outputArtifactDetails::is_minimum_count_Valid() const{
    return m_minimum_count_isValid;
}

qint32 OAICreateCustomActionTypeInput_outputArtifactDetails::getMaximumCount() const {
    return m_maximum_count;
}
void OAICreateCustomActionTypeInput_outputArtifactDetails::setMaximumCount(const qint32 &maximum_count) {
    m_maximum_count = maximum_count;
    m_maximum_count_isSet = true;
}

bool OAICreateCustomActionTypeInput_outputArtifactDetails::is_maximum_count_Set() const{
    return m_maximum_count_isSet;
}

bool OAICreateCustomActionTypeInput_outputArtifactDetails::is_maximum_count_Valid() const{
    return m_maximum_count_isValid;
}

bool OAICreateCustomActionTypeInput_outputArtifactDetails::isSet() const {
...
bool OAICreateCustomActionTypeInput_outputArtifactDetails::isValid() const {
