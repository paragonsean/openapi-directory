...
#include "OAIActionTypeIdentifier.h"
...
OAIActionTypeIdentifier::OAIActionTypeIdentifier(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionTypeIdentifier::OAIActionTypeIdentifier() {
    this->initializeModel();
}

OAIActionTypeIdentifier::~OAIActionTypeIdentifier() {}

void OAIActionTypeIdentifier::initializeModel() {
...
void OAIActionTypeIdentifier::fromJson(QString jsonString) {
...
void OAIActionTypeIdentifier::fromJsonObject(QJsonObject json) {
...
QString OAIActionTypeIdentifier::asJson() const {
...
QJsonObject OAIActionTypeIdentifier::asJsonObject() const {
    QJsonObject obj;
    if (m_category.isSet()) {
...
OAIActionCategory OAIActionTypeIdentifier::getCategory() const {
    return m_category;
}
void OAIActionTypeIdentifier::setCategory(const OAIActionCategory &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIActionTypeIdentifier::is_category_Set() const{
    return m_category_isSet;
}

bool OAIActionTypeIdentifier::is_category_Valid() const{
    return m_category_isValid;
}

QString OAIActionTypeIdentifier::getOwner() const {
    return m_owner;
}
void OAIActionTypeIdentifier::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAIActionTypeIdentifier::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAIActionTypeIdentifier::is_owner_Valid() const{
    return m_owner_isValid;
}

QString OAIActionTypeIdentifier::getProvider() const {
    return m_provider;
}
void OAIActionTypeIdentifier::setProvider(const QString &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAIActionTypeIdentifier::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAIActionTypeIdentifier::is_provider_Valid() const{
    return m_provider_isValid;
}

QString OAIActionTypeIdentifier::getVersion() const {
    return m_version;
}
void OAIActionTypeIdentifier::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIActionTypeIdentifier::is_version_Set() const{
    return m_version_isSet;
}

bool OAIActionTypeIdentifier::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIActionTypeIdentifier::isSet() const {
...
bool OAIActionTypeIdentifier::isValid() const {
