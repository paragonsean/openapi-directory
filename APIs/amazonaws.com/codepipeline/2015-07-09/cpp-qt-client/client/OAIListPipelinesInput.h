...
/*
 * OAIListPipelinesInput.h
 *
 * Represents the input of a &lt;code&gt;ListPipelines&lt;/code&gt; action.
 */

#ifndef OAIListPipelinesInput_H
#define OAIListPipelinesInput_H
...
class OAIListPipelinesInput : public OAIObject {
public:
    OAIListPipelinesInput();
    OAIListPipelinesInput(QString json);
    ~OAIListPipelinesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPipelinesInput)

#endif // OAIListPipelinesInput_H
