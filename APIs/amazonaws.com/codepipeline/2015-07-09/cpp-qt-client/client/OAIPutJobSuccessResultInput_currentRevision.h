...
/*
 * OAIPutJobSuccessResultInput_currentRevision.h
 *
 * 
 */

#ifndef OAIPutJobSuccessResultInput_currentRevision_H
#define OAIPutJobSuccessResultInput_currentRevision_H
...
class OAIPutJobSuccessResultInput_currentRevision : public OAIObject {
public:
    OAIPutJobSuccessResultInput_currentRevision();
    OAIPutJobSuccessResultInput_currentRevision(QString json);
    ~OAIPutJobSuccessResultInput_currentRevision() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutJobSuccessResultInput_currentRevision)

#endif // OAIPutJobSuccessResultInput_currentRevision_H
