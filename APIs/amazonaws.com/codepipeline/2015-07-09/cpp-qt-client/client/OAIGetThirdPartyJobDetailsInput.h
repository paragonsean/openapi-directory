...
/*
 * OAIGetThirdPartyJobDetailsInput.h
 *
 * Represents the input of a &lt;code&gt;GetThirdPartyJobDetails&lt;/code&gt; action.
 */

#ifndef OAIGetThirdPartyJobDetailsInput_H
#define OAIGetThirdPartyJobDetailsInput_H
...
class OAIGetThirdPartyJobDetailsInput : public OAIObject {
public:
    OAIGetThirdPartyJobDetailsInput();
    OAIGetThirdPartyJobDetailsInput(QString json);
    ~OAIGetThirdPartyJobDetailsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetThirdPartyJobDetailsInput)

#endif // OAIGetThirdPartyJobDetailsInput_H
