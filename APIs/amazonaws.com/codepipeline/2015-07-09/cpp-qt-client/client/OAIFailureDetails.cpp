...
OAIFailureType OAIFailureDetails::getType() const {
    return m_type;
}
void OAIFailureDetails::setType(const OAIFailureType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFailureDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFailureDetails::is_type_Valid() const{
...
QString OAIFailureDetails::getExternalExecutionId() const {
    return m_external_execution_id;
}
void OAIFailureDetails::setExternalExecutionId(const QString &external_execution_id) {
    m_external_execution_id = external_execution_id;
    m_external_execution_id_isSet = true;
}

bool OAIFailureDetails::is_external_execution_id_Set() const{
    return m_external_execution_id_isSet;
}

bool OAIFailureDetails::is_external_execution_id_Valid() const{
