...
OAIPutActionRevisionInput::OAIPutActionRevisionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutActionRevisionInput::OAIPutActionRevisionInput() {
    this->initializeModel();
}

OAIPutActionRevisionInput::~OAIPutActionRevisionInput() {}

void OAIPutActionRevisionInput::initializeModel() {
    ...
    m_action_revision_isSet = false;
    m_action_revision_isValid = false;
}

void OAIPutActionRevisionInput::fromJson(QString jsonString) {
...
void OAIPutActionRevisionInput::fromJsonObject(QJsonObject json) {
    ...
    m_action_revision_isValid = ::OpenAPI::fromJsonValue(m_action_revision, json[QString("actionRevision")]);
    m_action_revision_isSet = !json[QString("actionRevision")].isNull() && m_action_revision_isValid;
}

QString OAIPutActionRevisionInput::asJson() const {
...
QJsonObject OAIPutActionRevisionInput::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_action_revision.isSet()) {
        obj.insert(QString("actionRevision"), ::OpenAPI::toJsonValue(m_action_revision));
    }
    return obj;
}

QString OAIPutActionRevisionInput::getPipelineName() const {
    return m_pipeline_name;
}
void OAIPutActionRevisionInput::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIPutActionRevisionInput::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIPutActionRevisionInput::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

QString OAIPutActionRevisionInput::getStageName() const {
    return m_stage_name;
}
void OAIPutActionRevisionInput::setStageName(const QString &stage_name) {
    m_stage_name = stage_name;
    m_stage_name_isSet = true;
}

bool OAIPutActionRevisionInput::is_stage_name_Set() const{
    return m_stage_name_isSet;
}

bool OAIPutActionRevisionInput::is_stage_name_Valid() const{
    return m_stage_name_isValid;
}

QString OAIPutActionRevisionInput::getActionName() const {
    return m_action_name;
}
void OAIPutActionRevisionInput::setActionName(const QString &action_name) {
    m_action_name = action_name;
    m_action_name_isSet = true;
}

bool OAIPutActionRevisionInput::is_action_name_Set() const{
    return m_action_name_isSet;
}

bool OAIPutActionRevisionInput::is_action_name_Valid() const{
    return m_action_name_isValid;
}

OAIPutActionRevisionInput_actionRevision OAIPutActionRevisionInput::getActionRevision() const {
    return m_action_revision;
}
void OAIPutActionRevisionInput::setActionRevision(const OAIPutActionRevisionInput_actionRevision &action_revision) {
    m_action_revision = action_revision;
    m_action_revision_isSet = true;
}

bool OAIPutActionRevisionInput::is_action_revision_Set() const{
    return m_action_revision_isSet;
}

bool OAIPutActionRevisionInput::is_action_revision_Valid() const{
    return m_action_revision_isValid;
}

bool OAIPutActionRevisionInput::isSet() const {
...
bool OAIPutActionRevisionInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pipeline_name_isValid && m_stage_name_isValid && m_action_name_isValid && m_action_revision_isValid && true;
}
