...
OAIPutActionRevisionOutput::OAIPutActionRevisionOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutActionRevisionOutput::OAIPutActionRevisionOutput() {
    this->initializeModel();
}

OAIPutActionRevisionOutput::~OAIPutActionRevisionOutput() {}

void OAIPutActionRevisionOutput::initializeModel() {

    m_new_revision_isSet = false;
    m_new_revision_isValid = false;

    m_pipeline_execution_id_isSet = false;
    m_pipeline_execution_id_isValid = false;
}

void OAIPutActionRevisionOutput::fromJson(QString jsonString) {
...
void OAIPutActionRevisionOutput::fromJsonObject(QJsonObject json) {

    m_new_revision_isValid = ::OpenAPI::fromJsonValue(m_new_revision, json[QString("newRevision")]);
    m_new_revision_isSet = !json[QString("newRevision")].isNull() && m_new_revision_isValid;
...
QString OAIPutActionRevisionOutput::asJson() const {
...
QJsonObject OAIPutActionRevisionOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_new_revision_isSet) {
        obj.insert(QString("newRevision"), ::OpenAPI::toJsonValue(m_new_revision));
    }
...
bool OAIPutActionRevisionOutput::getNewRevision() const {
    return m_new_revision;
}
void OAIPutActionRevisionOutput::setNewRevision(const bool &new_revision) {
    m_new_revision = new_revision;
    m_new_revision_isSet = true;
}

bool OAIPutActionRevisionOutput::is_new_revision_Set() const{
    return m_new_revision_isSet;
}

bool OAIPutActionRevisionOutput::is_new_revision_Valid() const{
    return m_new_revision_isValid;
}

QString OAIPutActionRevisionOutput::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIPutActionRevisionOutput::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIPutActionRevisionOutput::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIPutActionRevisionOutput::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

bool OAIPutActionRevisionOutput::isSet() const {
...
bool OAIPutActionRevisionOutput::isValid() const {
