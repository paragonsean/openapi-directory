...
/*
 * OAIPutWebhookOutput_webhook.h
 *
 * 
 */

#ifndef OAIPutWebhookOutput_webhook_H
#define OAIPutWebhookOutput_webhook_H
...
class OAIPutWebhookOutput_webhook : public OAIObject {
public:
    OAIPutWebhookOutput_webhook();
    OAIPutWebhookOutput_webhook(QString json);
    ~OAIPutWebhookOutput_webhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutWebhookOutput_webhook)

#endif // OAIPutWebhookOutput_webhook_H
