...
/*
 * OAIWebhookDefinition.h
 *
 * Represents information about a webhook and its definition.
 */

#ifndef OAIWebhookDefinition_H
#define OAIWebhookDefinition_H
...
class OAIWebhookDefinition : public OAIObject {
public:
    OAIWebhookDefinition();
    OAIWebhookDefinition(QString json);
    ~OAIWebhookDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookDefinition)

#endif // OAIWebhookDefinition_H
