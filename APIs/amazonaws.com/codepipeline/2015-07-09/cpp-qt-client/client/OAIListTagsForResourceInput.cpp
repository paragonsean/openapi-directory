...
qint32 OAIListTagsForResourceInput::getMaxResults() const {
    return m_max_results;
}
void OAIListTagsForResourceInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListTagsForResourceInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListTagsForResourceInput::is_max_results_Valid() const{
