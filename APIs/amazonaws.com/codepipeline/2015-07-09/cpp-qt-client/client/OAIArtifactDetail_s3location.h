...
/*
 * OAIArtifactDetail_s3location.h
 *
 * 
 */

#ifndef OAIArtifactDetail_s3location_H
#define OAIArtifactDetail_s3location_H
...
class OAIArtifactDetail_s3location : public OAIObject {
public:
    OAIArtifactDetail_s3location();
    OAIArtifactDetail_s3location(QString json);
    ~OAIArtifactDetail_s3location() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactDetail_s3location)

#endif // OAIArtifactDetail_s3location_H
