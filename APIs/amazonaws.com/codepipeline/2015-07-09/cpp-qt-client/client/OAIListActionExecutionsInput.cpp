...
OAIListActionExecutionsInput::OAIListActionExecutionsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListActionExecutionsInput::OAIListActionExecutionsInput() {
    this->initializeModel();
}

OAIListActionExecutionsInput::~OAIListActionExecutionsInput() {}

void OAIListActionExecutionsInput::initializeModel() {
...
void OAIListActionExecutionsInput::fromJson(QString jsonString) {
...
void OAIListActionExecutionsInput::fromJsonObject(QJsonObject json) {
...
QString OAIListActionExecutionsInput::asJson() const {
...
QJsonObject OAIListActionExecutionsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListActionExecutionsInput::getPipelineName() const {
    return m_pipeline_name;
}
void OAIListActionExecutionsInput::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIListActionExecutionsInput::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIListActionExecutionsInput::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

OAIListActionExecutionsInput_filter OAIListActionExecutionsInput::getFilter() const {
    return m_filter;
}
void OAIListActionExecutionsInput::setFilter(const OAIListActionExecutionsInput_filter &filter) {
    m_filter = filter;
    m_filter_isSet = true;
}

bool OAIListActionExecutionsInput::is_filter_Set() const{
    return m_filter_isSet;
}

bool OAIListActionExecutionsInput::is_filter_Valid() const{
    return m_filter_isValid;
}

qint32 OAIListActionExecutionsInput::getMaxResults() const {
    return m_max_results;
}
void OAIListActionExecutionsInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListActionExecutionsInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListActionExecutionsInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListActionExecutionsInput::getNextToken() const {
    return m_next_token;
}
void OAIListActionExecutionsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListActionExecutionsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListActionExecutionsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListActionExecutionsInput::isSet() const {
...
bool OAIListActionExecutionsInput::isValid() const {
