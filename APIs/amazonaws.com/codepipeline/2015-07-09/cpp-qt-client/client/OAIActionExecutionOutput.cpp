...
#include "OAIActionExecutionOutput.h"
...
OAIActionExecutionOutput::OAIActionExecutionOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionExecutionOutput::OAIActionExecutionOutput() {
    this->initializeModel();
}

OAIActionExecutionOutput::~OAIActionExecutionOutput() {}

void OAIActionExecutionOutput::initializeModel() {
...
void OAIActionExecutionOutput::fromJson(QString jsonString) {
...
void OAIActionExecutionOutput::fromJsonObject(QJsonObject json) {
...
QString OAIActionExecutionOutput::asJson() const {
...
QJsonObject OAIActionExecutionOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIActionExecutionOutput::getOutputArtifacts() const {
    return m_output_artifacts;
}
void OAIActionExecutionOutput::setOutputArtifacts(const QList &output_artifacts) {
    m_output_artifacts = output_artifacts;
    m_output_artifacts_isSet = true;
}

bool OAIActionExecutionOutput::is_output_artifacts_Set() const{
    return m_output_artifacts_isSet;
}

bool OAIActionExecutionOutput::is_output_artifacts_Valid() const{
    return m_output_artifacts_isValid;
}

OAIActionExecutionOutput_executionResult OAIActionExecutionOutput::getExecutionResult() const {
    return m_execution_result;
}
void OAIActionExecutionOutput::setExecutionResult(const OAIActionExecutionOutput_executionResult &execution_result) {
    m_execution_result = execution_result;
    m_execution_result_isSet = true;
}

bool OAIActionExecutionOutput::is_execution_result_Set() const{
    return m_execution_result_isSet;
}

bool OAIActionExecutionOutput::is_execution_result_Valid() const{
    return m_execution_result_isValid;
}

QMap OAIActionExecutionOutput::getOutputVariables() const {
    return m_output_variables;
}
void OAIActionExecutionOutput::setOutputVariables(const QMap &output_variables) {
    m_output_variables = output_variables;
    m_output_variables_isSet = true;
}

bool OAIActionExecutionOutput::is_output_variables_Set() const{
    return m_output_variables_isSet;
}

bool OAIActionExecutionOutput::is_output_variables_Valid() const{
    return m_output_variables_isValid;
}

bool OAIActionExecutionOutput::isSet() const {
...
bool OAIActionExecutionOutput::isValid() const {
