...
#include "OAIActionTypeProperty.h"
...
OAIActionTypeProperty::OAIActionTypeProperty(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionTypeProperty::OAIActionTypeProperty() {
    this->initializeModel();
}

OAIActionTypeProperty::~OAIActionTypeProperty() {}

void OAIActionTypeProperty::initializeModel() {
...
void OAIActionTypeProperty::fromJson(QString jsonString) {
...
void OAIActionTypeProperty::fromJsonObject(QJsonObject json) {
...
QString OAIActionTypeProperty::asJson() const {
...
QJsonObject OAIActionTypeProperty::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIActionTypeProperty::getName() const {
    return m_name;
}
void OAIActionTypeProperty::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIActionTypeProperty::is_name_Set() const{
    return m_name_isSet;
}

bool OAIActionTypeProperty::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIActionTypeProperty::getOptional() const {
    return m_optional;
}
void OAIActionTypeProperty::setOptional(const bool &optional) {
    m_optional = optional;
    m_optional_isSet = true;
}

bool OAIActionTypeProperty::is_optional_Set() const{
    return m_optional_isSet;
}

bool OAIActionTypeProperty::is_optional_Valid() const{
    return m_optional_isValid;
}

bool OAIActionTypeProperty::getKey() const {
    return m_key;
}
void OAIActionTypeProperty::setKey(const bool &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAIActionTypeProperty::is_key_Set() const{
    return m_key_isSet;
}

bool OAIActionTypeProperty::is_key_Valid() const{
    return m_key_isValid;
}

bool OAIActionTypeProperty::getNoEcho() const {
    return m_no_echo;
}
void OAIActionTypeProperty::setNoEcho(const bool &no_echo) {
    m_no_echo = no_echo;
    m_no_echo_isSet = true;
}

bool OAIActionTypeProperty::is_no_echo_Set() const{
    return m_no_echo_isSet;
}

bool OAIActionTypeProperty::is_no_echo_Valid() const{
    return m_no_echo_isValid;
}

bool OAIActionTypeProperty::getQueryable() const {
    return m_queryable;
}
void OAIActionTypeProperty::setQueryable(const bool &queryable) {
    m_queryable = queryable;
    m_queryable_isSet = true;
}

bool OAIActionTypeProperty::is_queryable_Set() const{
    return m_queryable_isSet;
}

bool OAIActionTypeProperty::is_queryable_Valid() const{
    return m_queryable_isValid;
}

QString OAIActionTypeProperty::getDescription() const {
    return m_description;
}
void OAIActionTypeProperty::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIActionTypeProperty::is_description_Set() const{
    return m_description_isSet;
}

bool OAIActionTypeProperty::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIActionTypeProperty::isSet() const {
...
bool OAIActionTypeProperty::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_name_isValid && m_optional_isValid && m_key_isValid && m_no_echo_isValid && true;
}
