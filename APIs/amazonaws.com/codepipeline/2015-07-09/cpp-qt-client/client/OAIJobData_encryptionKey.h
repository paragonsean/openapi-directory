...
/*
 * OAIJobData_encryptionKey.h
 *
 * 
 */

#ifndef OAIJobData_encryptionKey_H
#define OAIJobData_encryptionKey_H
...
class OAIJobData_encryptionKey : public OAIObject {
public:
    OAIJobData_encryptionKey();
    OAIJobData_encryptionKey(QString json);
    ~OAIJobData_encryptionKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobData_encryptionKey)

#endif // OAIJobData_encryptionKey_H
