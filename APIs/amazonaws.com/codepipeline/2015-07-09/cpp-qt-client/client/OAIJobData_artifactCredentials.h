...
/*
 * OAIJobData_artifactCredentials.h
 *
 * 
 */

#ifndef OAIJobData_artifactCredentials_H
#define OAIJobData_artifactCredentials_H
...
class OAIJobData_artifactCredentials : public OAIObject {
public:
    OAIJobData_artifactCredentials();
    OAIJobData_artifactCredentials(QString json);
    ~OAIJobData_artifactCredentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobData_artifactCredentials)

#endif // OAIJobData_artifactCredentials_H
