...
OAIGetPipelineExecutionInput::OAIGetPipelineExecutionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPipelineExecutionInput::OAIGetPipelineExecutionInput() {
    this->initializeModel();
}

OAIGetPipelineExecutionInput::~OAIGetPipelineExecutionInput() {}

void OAIGetPipelineExecutionInput::initializeModel() {
...
void OAIGetPipelineExecutionInput::fromJson(QString jsonString) {
...
void OAIGetPipelineExecutionInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPipelineExecutionInput::asJson() const {
...
QJsonObject OAIGetPipelineExecutionInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPipelineExecutionInput::getPipelineName() const {
    return m_pipeline_name;
}
void OAIGetPipelineExecutionInput::setPipelineName(const QString &pipeline_name) {
    m_pipeline_name = pipeline_name;
    m_pipeline_name_isSet = true;
}

bool OAIGetPipelineExecutionInput::is_pipeline_name_Set() const{
    return m_pipeline_name_isSet;
}

bool OAIGetPipelineExecutionInput::is_pipeline_name_Valid() const{
    return m_pipeline_name_isValid;
}

QString OAIGetPipelineExecutionInput::getPipelineExecutionId() const {
    return m_pipeline_execution_id;
}
void OAIGetPipelineExecutionInput::setPipelineExecutionId(const QString &pipeline_execution_id) {
    m_pipeline_execution_id = pipeline_execution_id;
    m_pipeline_execution_id_isSet = true;
}

bool OAIGetPipelineExecutionInput::is_pipeline_execution_id_Set() const{
    return m_pipeline_execution_id_isSet;
}

bool OAIGetPipelineExecutionInput::is_pipeline_execution_id_Valid() const{
    return m_pipeline_execution_id_isValid;
}

bool OAIGetPipelineExecutionInput::isSet() const {
...
bool OAIGetPipelineExecutionInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pipeline_name_isValid && m_pipeline_execution_id_isValid && true;
}
