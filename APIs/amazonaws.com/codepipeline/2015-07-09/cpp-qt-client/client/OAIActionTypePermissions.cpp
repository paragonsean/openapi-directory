...
#include "OAIActionTypePermissions.h"
...
OAIActionTypePermissions::OAIActionTypePermissions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionTypePermissions::OAIActionTypePermissions() {
    this->initializeModel();
}

OAIActionTypePermissions::~OAIActionTypePermissions() {}

void OAIActionTypePermissions::initializeModel() {

    m_allowed_accounts_isSet = false;
    m_allowed_accounts_isValid = false;
}

void OAIActionTypePermissions::fromJson(QString jsonString) {
...
void OAIActionTypePermissions::fromJsonObject(QJsonObject json) {

    m_allowed_accounts_isValid = ::OpenAPI::fromJsonValue(m_allowed_accounts, json[QString("allowedAccounts")]);
    m_allowed_accounts_isSet = !json[QString("allowedAccounts")].isNull() && m_allowed_accounts_isValid;
}

QString OAIActionTypePermissions::asJson() const {
...
QJsonObject OAIActionTypePermissions::asJsonObject() const {
    QJsonObject obj;
    if (m_allowed_accounts.isSet()) {
        obj.insert(QString("allowedAccounts"), ::OpenAPI::toJsonValue(m_allowed_accounts));
    }
    return obj;
}

QList OAIActionTypePermissions::getAllowedAccounts() const {
    return m_allowed_accounts;
}
void OAIActionTypePermissions::setAllowedAccounts(const QList &allowed_accounts) {
    m_allowed_accounts = allowed_accounts;
    m_allowed_accounts_isSet = true;
}

bool OAIActionTypePermissions::is_allowed_accounts_Set() const{
    return m_allowed_accounts_isSet;
}

bool OAIActionTypePermissions::is_allowed_accounts_Valid() const{
    return m_allowed_accounts_isValid;
}

bool OAIActionTypePermissions::isSet() const {
...
bool OAIActionTypePermissions::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_allowed_accounts_isValid && true;
}
