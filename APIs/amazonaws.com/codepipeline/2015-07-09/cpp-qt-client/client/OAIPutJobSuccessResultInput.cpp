...
OAIPutJobSuccessResultInput::OAIPutJobSuccessResultInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutJobSuccessResultInput::OAIPutJobSuccessResultInput() {
    this->initializeModel();
}

OAIPutJobSuccessResultInput::~OAIPutJobSuccessResultInput() {}

void OAIPutJobSuccessResultInput::initializeModel() {
...
void OAIPutJobSuccessResultInput::fromJson(QString jsonString) {
...
void OAIPutJobSuccessResultInput::fromJsonObject(QJsonObject json) {
...
QString OAIPutJobSuccessResultInput::asJson() const {
...
QJsonObject OAIPutJobSuccessResultInput::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIPutJobSuccessResultInput::getJobId() const {
    return m_job_id;
}
void OAIPutJobSuccessResultInput::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIPutJobSuccessResultInput::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIPutJobSuccessResultInput::is_job_id_Valid() const{
    return m_job_id_isValid;
}

OAIPutJobSuccessResultInput_currentRevision OAIPutJobSuccessResultInput::getCurrentRevision() const {
    return m_current_revision;
}
void OAIPutJobSuccessResultInput::setCurrentRevision(const OAIPutJobSuccessResultInput_currentRevision &current_revision) {
    m_current_revision = current_revision;
    m_current_revision_isSet = true;
}

bool OAIPutJobSuccessResultInput::is_current_revision_Set() const{
    return m_current_revision_isSet;
}

bool OAIPutJobSuccessResultInput::is_current_revision_Valid() const{
    return m_current_revision_isValid;
}

QString OAIPutJobSuccessResultInput::getContinuationToken() const {
    return m_continuation_token;
}
void OAIPutJobSuccessResultInput::setContinuationToken(const QString &continuation_token) {
    m_continuation_token = continuation_token;
    m_continuation_token_isSet = true;
}

bool OAIPutJobSuccessResultInput::is_continuation_token_Set() const{
    return m_continuation_token_isSet;
}

bool OAIPutJobSuccessResultInput::is_continuation_token_Valid() const{
    return m_continuation_token_isValid;
}

OAIPutJobSuccessResultInput_executionDetails OAIPutJobSuccessResultInput::getExecutionDetails() const {
    return m_execution_details;
}
void OAIPutJobSuccessResultInput::setExecutionDetails(const OAIPutJobSuccessResultInput_executionDetails &execution_details) {
    m_execution_details = execution_details;
    m_execution_details_isSet = true;
}

bool OAIPutJobSuccessResultInput::is_execution_details_Set() const{
    return m_execution_details_isSet;
}

bool OAIPutJobSuccessResultInput::is_execution_details_Valid() const{
    return m_execution_details_isValid;
}

QMap OAIPutJobSuccessResultInput::getOutputVariables() const {
    return m_output_variables;
}
void OAIPutJobSuccessResultInput::setOutputVariables(const QMap &output_variables) {
    m_output_variables = output_variables;
    m_output_variables_isSet = true;
}

bool OAIPutJobSuccessResultInput::is_output_variables_Set() const{
    return m_output_variables_isSet;
}

bool OAIPutJobSuccessResultInput::is_output_variables_Valid() const{
    return m_output_variables_isValid;
}

bool OAIPutJobSuccessResultInput::isSet() const {
...
bool OAIPutJobSuccessResultInput::isValid() const {
