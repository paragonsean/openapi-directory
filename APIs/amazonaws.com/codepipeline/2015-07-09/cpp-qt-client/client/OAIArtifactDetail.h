...
#ifndef OAIArtifactDetail_H
#define OAIArtifactDetail_H
...
namespace OpenAPI {
class OAIArtifactDetail_s3location;

class OAIArtifactDetail : public OAIObject {
public:
    OAIArtifactDetail();
    OAIArtifactDetail(QString json);
    ~OAIArtifactDetail() override;
    ...
    OAIArtifactDetail_s3location getS3location() const;
    void setS3location(const OAIArtifactDetail_s3location &s3location);
    bool is_s3location_Set() const;
    bool is_s3location_Valid() const;
...
private:
    ...
    OAIArtifactDetail_s3location m_s3location;
    bool m_s3location_isSet;
    bool m_s3location_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIArtifactDetail)

#endif // OAIArtifactDetail_H
