...
/*
 * OAIActionConfiguration.h
 *
 * Represents information about an action configuration.
 */

#ifndef OAIActionConfiguration_H
#define OAIActionConfiguration_H
...
class OAIActionConfiguration : public OAIObject {
public:
    OAIActionConfiguration();
    OAIActionConfiguration(QString json);
    ~OAIActionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionConfiguration)

#endif // OAIActionConfiguration_H
