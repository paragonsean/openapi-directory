...
class OAIDeleteCustomActionTypeInput : public OAIObject {
public:
    OAIDeleteCustomActionTypeInput();
    OAIDeleteCustomActionTypeInput(QString json);
    ~OAIDeleteCustomActionTypeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCustomActionTypeInput)

#endif // OAIDeleteCustomActionTypeInput_H
