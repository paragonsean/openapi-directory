...
/*
 * OAICurrentRevision.h
 *
 * Represents information about a current revision.
 */

#ifndef OAICurrentRevision_H
#define OAICurrentRevision_H
...
class OAICurrentRevision : public OAIObject {
public:
    OAICurrentRevision();
    OAICurrentRevision(QString json);
    ~OAICurrentRevision() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrentRevision)

#endif // OAICurrentRevision_H
