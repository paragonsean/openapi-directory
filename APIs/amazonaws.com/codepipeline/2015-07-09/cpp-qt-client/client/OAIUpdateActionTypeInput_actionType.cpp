...
OAIUpdateActionTypeInput_actionType::OAIUpdateActionTypeInput_actionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateActionTypeInput_actionType::OAIUpdateActionTypeInput_actionType() {
    this->initializeModel();
}

OAIUpdateActionTypeInput_actionType::~OAIUpdateActionTypeInput_actionType() {}

void OAIUpdateActionTypeInput_actionType::initializeModel() {
...
void OAIUpdateActionTypeInput_actionType::fromJson(QString jsonString) {
...
void OAIUpdateActionTypeInput_actionType::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateActionTypeInput_actionType::asJson() const {
...
QJsonObject OAIUpdateActionTypeInput_actionType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateActionTypeInput_actionType::getDescription() const {
    return m_description;
}
void OAIUpdateActionTypeInput_actionType::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateActionTypeInput_actionType::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateActionTypeInput_actionType::is_description_Valid() const{
    return m_description_isValid;
}

OAIActionTypeDeclaration_executor OAIUpdateActionTypeInput_actionType::getExecutor() const {
    return m_executor;
}
void OAIUpdateActionTypeInput_actionType::setExecutor(const OAIActionTypeDeclaration_executor &executor) {
    m_executor = executor;
    m_executor_isSet = true;
}

bool OAIUpdateActionTypeInput_actionType::is_executor_Set() const{
    return m_executor_isSet;
}

bool OAIUpdateActionTypeInput_actionType::is_executor_Valid() const{
    return m_executor_isValid;
}

OAIActionTypeDeclaration_id OAIUpdateActionTypeInput_actionType::getId() const {
    return m_id;
}
void OAIUpdateActionTypeInput_actionType::setId(const OAIActionTypeDeclaration_id &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUpdateActionTypeInput_actionType::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUpdateActionTypeInput_actionType::is_id_Valid() const{
    return m_id_isValid;
}

OAIActionTypeDeclaration_inputArtifactDetails OAIUpdateActionTypeInput_actionType::getInputArtifactDetails() const {
    return m_input_artifact_details;
}
void OAIUpdateActionTypeInput_actionType::setInputArtifactDetails(const OAIActionTypeDeclaration_inputArtifactDetails &input_artifact_details) {
    m_input_artifact_details = input_artifact_details;
    m_input_artifact_details_isSet = true;
}

bool OAIUpdateActionTypeInput_actionType::is_input_artifact_details_Set() const{
    return m_input_artifact_details_isSet;
}

bool OAIUpdateActionTypeInput_actionType::is_input_artifact_details_Valid() const{
    return m_input_artifact_details_isValid;
}

OAIActionTypeDeclaration_outputArtifactDetails OAIUpdateActionTypeInput_actionType::getOutputArtifactDetails() const {
    return m_output_artifact_details;
}
void OAIUpdateActionTypeInput_actionType::setOutputArtifactDetails(const OAIActionTypeDeclaration_outputArtifactDetails &output_artifact_details) {
    m_output_artifact_details = output_artifact_details;
    m_output_artifact_details_isSet = true;
}

bool OAIUpdateActionTypeInput_actionType::is_output_artifact_details_Set() const{
    return m_output_artifact_details_isSet;
}

bool OAIUpdateActionTypeInput_actionType::is_output_artifact_details_Valid() const{
    return m_output_artifact_details_isValid;
}

OAIActionTypeDeclaration_permissions OAIUpdateActionTypeInput_actionType::getPermissions() const {
    return m_permissions;
}
void OAIUpdateActionTypeInput_actionType::setPermissions(const OAIActionTypeDeclaration_permissions &permissions) {
    m_permissions = permissions;
    m_permissions_isSet = true;
}

bool OAIUpdateActionTypeInput_actionType::is_permissions_Set() const{
    return m_permissions_isSet;
}

bool OAIUpdateActionTypeInput_actionType::is_permissions_Valid() const{
    return m_permissions_isValid;
}

QJsonValue OAIUpdateActionTypeInput_actionType::getProperties() const {
    return m_properties;
}
void OAIUpdateActionTypeInput_actionType::setProperties(const QJsonValue &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIUpdateActionTypeInput_actionType::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIUpdateActionTypeInput_actionType::is_properties_Valid() const{
    return m_properties_isValid;
}

OAIActionTypeDeclaration_urls OAIUpdateActionTypeInput_actionType::getUrls() const {
    return m_urls;
}
void OAIUpdateActionTypeInput_actionType::setUrls(const OAIActionTypeDeclaration_urls &urls) {
    m_urls = urls;
    m_urls_isSet = true;
}

bool OAIUpdateActionTypeInput_actionType::is_urls_Set() const{
    return m_urls_isSet;
}

bool OAIUpdateActionTypeInput_actionType::is_urls_Valid() const{
    return m_urls_isValid;
}

bool OAIUpdateActionTypeInput_actionType::isSet() const {
...
bool OAIUpdateActionTypeInput_actionType::isValid() const {
