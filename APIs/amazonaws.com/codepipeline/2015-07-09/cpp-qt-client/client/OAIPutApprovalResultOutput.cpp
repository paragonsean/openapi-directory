...
OAIPutApprovalResultOutput::OAIPutApprovalResultOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutApprovalResultOutput::OAIPutApprovalResultOutput() {
    this->initializeModel();
}

OAIPutApprovalResultOutput::~OAIPutApprovalResultOutput() {}

void OAIPutApprovalResultOutput::initializeModel() {

    m_approved_at_isSet = false;
    m_approved_at_isValid = false;
}

void OAIPutApprovalResultOutput::fromJson(QString jsonString) {
...
void OAIPutApprovalResultOutput::fromJsonObject(QJsonObject json) {
...
QString OAIPutApprovalResultOutput::asJson() const {
...
QJsonObject OAIPutApprovalResultOutput::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIPutApprovalResultOutput::getApprovedAt() const {
    return m_approved_at;
}
void OAIPutApprovalResultOutput::setApprovedAt(const QDateTime &approved_at) {
    m_approved_at = approved_at;
    m_approved_at_isSet = true;
}

bool OAIPutApprovalResultOutput::is_approved_at_Set() const{
    return m_approved_at_isSet;
}

bool OAIPutApprovalResultOutput::is_approved_at_Valid() const{
    return m_approved_at_isValid;
}

bool OAIPutApprovalResultOutput::isSet() const {
...
bool OAIPutApprovalResultOutput::isValid() const {
