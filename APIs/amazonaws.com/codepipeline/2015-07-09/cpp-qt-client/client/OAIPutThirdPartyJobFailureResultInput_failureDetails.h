...
/*
 * OAIPutThirdPartyJobFailureResultInput_failureDetails.h
 *
 * 
 */

#ifndef OAIPutThirdPartyJobFailureResultInput_failureDetails_H
#define OAIPutThirdPartyJobFailureResultInput_failureDetails_H
...
class OAIPutThirdPartyJobFailureResultInput_failureDetails : public OAIObject {
public:
    OAIPutThirdPartyJobFailureResultInput_failureDetails();
    OAIPutThirdPartyJobFailureResultInput_failureDetails(QString json);
    ~OAIPutThirdPartyJobFailureResultInput_failureDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutThirdPartyJobFailureResultInput_failureDetails)

#endif // OAIPutThirdPartyJobFailureResultInput_failureDetails_H
