...
OAIActionContext::OAIActionContext(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionContext::OAIActionContext() {
    this->initializeModel();
}

OAIActionContext::~OAIActionContext() {}

void OAIActionContext::initializeModel() {
...
void OAIActionContext::fromJson(QString jsonString) {
...
void OAIActionContext::fromJsonObject(QJsonObject json) {
...
QString OAIActionContext::asJson() const {
...
QJsonObject OAIActionContext::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIActionContext::getName() const {
    return m_name;
}
void OAIActionContext::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIActionContext::is_name_Set() const{
    return m_name_isSet;
}

bool OAIActionContext::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIActionContext::getActionExecutionId() const {
    return m_action_execution_id;
}
void OAIActionContext::setActionExecutionId(const QString &action_execution_id) {
    m_action_execution_id = action_execution_id;
    m_action_execution_id_isSet = true;
}

bool OAIActionContext::is_action_execution_id_Set() const{
    return m_action_execution_id_isSet;
}

bool OAIActionContext::is_action_execution_id_Valid() const{
    return m_action_execution_id_isValid;
}

bool OAIActionContext::isSet() const {
...
bool OAIActionContext::isValid() const {
