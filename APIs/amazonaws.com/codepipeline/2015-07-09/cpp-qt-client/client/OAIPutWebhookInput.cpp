...
OAIPutWebhookInput::OAIPutWebhookInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutWebhookInput::OAIPutWebhookInput() {
    this->initializeModel();
}

OAIPutWebhookInput::~OAIPutWebhookInput() {}

void OAIPutWebhookInput::initializeModel() {
...
void OAIPutWebhookInput::fromJson(QString jsonString) {
...
void OAIPutWebhookInput::fromJsonObject(QJsonObject json) {
...
QString OAIPutWebhookInput::asJson() const {
...
QJsonObject OAIPutWebhookInput::asJsonObject() const {
    QJsonObject obj;
    if (m_webhook.isSet()) {
...
OAIPutWebhookInput_webhook OAIPutWebhookInput::getWebhook() const {
    return m_webhook;
}
void OAIPutWebhookInput::setWebhook(const OAIPutWebhookInput_webhook &webhook) {
    m_webhook = webhook;
    m_webhook_isSet = true;
}

bool OAIPutWebhookInput::is_webhook_Set() const{
    return m_webhook_isSet;
}

bool OAIPutWebhookInput::is_webhook_Valid() const{
    return m_webhook_isValid;
}

QList OAIPutWebhookInput::getTags() const {
    return m_tags;
}
void OAIPutWebhookInput::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIPutWebhookInput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIPutWebhookInput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIPutWebhookInput::isSet() const {
...
bool OAIPutWebhookInput::isValid() const {
