...
#include "OAIPipelineExecutionSummary_stopTrigger.h"
...
OAIPipelineExecutionSummary_stopTrigger::OAIPipelineExecutionSummary_stopTrigger(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPipelineExecutionSummary_stopTrigger::OAIPipelineExecutionSummary_stopTrigger() {
    this->initializeModel();
}

OAIPipelineExecutionSummary_stopTrigger::~OAIPipelineExecutionSummary_stopTrigger() {}

void OAIPipelineExecutionSummary_stopTrigger::initializeModel() {

    m_reason_isSet = false;
    m_reason_isValid = false;
}

void OAIPipelineExecutionSummary_stopTrigger::fromJson(QString jsonString) {
...
void OAIPipelineExecutionSummary_stopTrigger::fromJsonObject(QJsonObject json) {

    m_reason_isValid = ::OpenAPI::fromJsonValue(m_reason, json[QString("reason")]);
    m_reason_isSet = !json[QString("reason")].isNull() && m_reason_isValid;
}

QString OAIPipelineExecutionSummary_stopTrigger::asJson() const {
...
QJsonObject OAIPipelineExecutionSummary_stopTrigger::asJsonObject() const {
    QJsonObject obj;
    if (m_reason_isSet) {
...
QString OAIPipelineExecutionSummary_stopTrigger::getReason() const {
    return m_reason;
}
void OAIPipelineExecutionSummary_stopTrigger::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIPipelineExecutionSummary_stopTrigger::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIPipelineExecutionSummary_stopTrigger::is_reason_Valid() const{
    return m_reason_isValid;
}

bool OAIPipelineExecutionSummary_stopTrigger::isSet() const {
...
bool OAIPipelineExecutionSummary_stopTrigger::isValid() const {
