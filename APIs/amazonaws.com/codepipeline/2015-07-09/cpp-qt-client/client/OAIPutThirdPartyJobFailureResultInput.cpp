...
OAIPutThirdPartyJobFailureResultInput::OAIPutThirdPartyJobFailureResultInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutThirdPartyJobFailureResultInput::OAIPutThirdPartyJobFailureResultInput() {
    this->initializeModel();
}

OAIPutThirdPartyJobFailureResultInput::~OAIPutThirdPartyJobFailureResultInput() {}

void OAIPutThirdPartyJobFailureResultInput::initializeModel() {
...
void OAIPutThirdPartyJobFailureResultInput::fromJson(QString jsonString) {
...
void OAIPutThirdPartyJobFailureResultInput::fromJsonObject(QJsonObject json) {
...
QString OAIPutThirdPartyJobFailureResultInput::asJson() const {
...
QJsonObject OAIPutThirdPartyJobFailureResultInput::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIPutThirdPartyJobFailureResultInput::getJobId() const {
    return m_job_id;
}
void OAIPutThirdPartyJobFailureResultInput::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIPutThirdPartyJobFailureResultInput::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIPutThirdPartyJobFailureResultInput::is_job_id_Valid() const{
    return m_job_id_isValid;
}

QString OAIPutThirdPartyJobFailureResultInput::getClientToken() const {
    return m_client_token;
}
void OAIPutThirdPartyJobFailureResultInput::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAIPutThirdPartyJobFailureResultInput::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAIPutThirdPartyJobFailureResultInput::is_client_token_Valid() const{
    return m_client_token_isValid;
}

OAIPutThirdPartyJobFailureResultInput_failureDetails OAIPutThirdPartyJobFailureResultInput::getFailureDetails() const {
    return m_failure_details;
}
void OAIPutThirdPartyJobFailureResultInput::setFailureDetails(const OAIPutThirdPartyJobFailureResultInput_failureDetails &failure_details) {
    m_failure_details = failure_details;
    m_failure_details_isSet = true;
}

bool OAIPutThirdPartyJobFailureResultInput::is_failure_details_Set() const{
    return m_failure_details_isSet;
}

bool OAIPutThirdPartyJobFailureResultInput::is_failure_details_Valid() const{
    return m_failure_details_isValid;
}

bool OAIPutThirdPartyJobFailureResultInput::isSet() const {
...
bool OAIPutThirdPartyJobFailureResultInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_job_id_isValid && m_client_token_isValid && m_failure_details_isValid && true;
}
