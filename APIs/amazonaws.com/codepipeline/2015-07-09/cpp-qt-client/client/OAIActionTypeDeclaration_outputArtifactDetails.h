...
/*
 * OAIActionTypeDeclaration_outputArtifactDetails.h
 *
 * 
 */

#ifndef OAIActionTypeDeclaration_outputArtifactDetails_H
#define OAIActionTypeDeclaration_outputArtifactDetails_H
...
class OAIActionTypeDeclaration_outputArtifactDetails : public OAIObject {
public:
    OAIActionTypeDeclaration_outputArtifactDetails();
    OAIActionTypeDeclaration_outputArtifactDetails(QString json);
    ~OAIActionTypeDeclaration_outputArtifactDetails() override;
    ...
    qint32 getMinimumCount() const;
    void setMinimumCount(const qint32 &minimum_count);
    bool is_minimum_count_Set() const;
    bool is_minimum_count_Valid() const;

    qint32 getMaximumCount() const;
    void setMaximumCount(const qint32 &maximum_count);
    bool is_maximum_count_Set() const;
    bool is_maximum_count_Valid() const;
...
private:
    ...
    qint32 m_minimum_count;
    bool m_minimum_count_isSet;
    bool m_minimum_count_isValid;

    qint32 m_maximum_count;
    bool m_maximum_count_isSet;
    bool m_maximum_count_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIActionTypeDeclaration_outputArtifactDetails)

#endif // OAIActionTypeDeclaration_outputArtifactDetails_H
