...
#ifndef OAIAWSSessionCredentials_H
#define OAIAWSSessionCredentials_H
...
class OAIAWSSessionCredentials : public OAIObject {
public:
    OAIAWSSessionCredentials();
    OAIAWSSessionCredentials(QString json);
    ~OAIAWSSessionCredentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAWSSessionCredentials)

#endif // OAIAWSSessionCredentials_H
