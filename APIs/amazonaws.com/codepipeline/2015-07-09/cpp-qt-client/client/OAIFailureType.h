...
#ifndef OAIFailureType_H
#define OAIFailureType_H
...
class OAIFailureType : public OAIEnum {
public:
    OAIFailureType();
    OAIFailureType(QString json);
    ~OAIFailureType() override;
    ...
    OAIFailureType::eOAIFailureType getValue() const;
    void setValue(const OAIFailureType::eOAIFailureType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFailureType)

#endif // OAIFailureType_H
