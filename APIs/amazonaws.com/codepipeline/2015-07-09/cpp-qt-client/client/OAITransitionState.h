...
/*
 * OAITransitionState.h
 *
 * Represents information about the state of transitions between one stage and another stage.
 */

#ifndef OAITransitionState_H
#define OAITransitionState_H
...
class OAITransitionState : public OAIObject {
public:
    OAITransitionState();
    OAITransitionState(QString json);
    ~OAITransitionState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransitionState)

#endif // OAITransitionState_H
