...
OAIExecutionTrigger::OAIExecutionTrigger(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExecutionTrigger::OAIExecutionTrigger() {
    this->initializeModel();
}

OAIExecutionTrigger::~OAIExecutionTrigger() {}

void OAIExecutionTrigger::initializeModel() {
...
void OAIExecutionTrigger::fromJson(QString jsonString) {
...
void OAIExecutionTrigger::fromJsonObject(QJsonObject json) {
...
QString OAIExecutionTrigger::asJson() const {
...
QJsonObject OAIExecutionTrigger::asJsonObject() const {
    QJsonObject obj;
...
OAITriggerType OAIExecutionTrigger::getTriggerType() const {
    return m_trigger_type;
}
void OAIExecutionTrigger::setTriggerType(const OAITriggerType &trigger_type) {
    m_trigger_type = trigger_type;
    m_trigger_type_isSet = true;
}

bool OAIExecutionTrigger::is_trigger_type_Set() const{
    return m_trigger_type_isSet;
}

bool OAIExecutionTrigger::is_trigger_type_Valid() const{
    return m_trigger_type_isValid;
}

QString OAIExecutionTrigger::getTriggerDetail() const {
    return m_trigger_detail;
}
void OAIExecutionTrigger::setTriggerDetail(const QString &trigger_detail) {
    m_trigger_detail = trigger_detail;
    m_trigger_detail_isSet = true;
}

bool OAIExecutionTrigger::is_trigger_detail_Set() const{
    return m_trigger_detail_isSet;
}

bool OAIExecutionTrigger::is_trigger_detail_Valid() const{
    return m_trigger_detail_isValid;
}

bool OAIExecutionTrigger::isSet() const {
...
bool OAIExecutionTrigger::isValid() const {
