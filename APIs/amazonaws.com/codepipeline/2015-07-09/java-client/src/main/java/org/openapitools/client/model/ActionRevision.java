...
public class ActionRevision {
  ...
  public ActionRevision revisionId(String revisionId) {
  ...
  public ActionRevision revisionChangeId(String revisionChangeId) {
  ...
  public ActionRevision created(OffsetDateTime created) {
  ...
  public boolean equals(Object o) {
    ...
    ActionRevision actionRevision = (ActionRevision) o;
    return Objects.equals(this.revisionId, actionRevision.revisionId) &&
        Objects.equals(this.revisionChangeId, actionRevision.revisionChangeId) &&
        Objects.equals(this.created, actionRevision.created);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionRevision
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionRevision.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionRevision is not found in the empty JSON string", ActionRevision.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionRevision.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionRevision` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionRevision.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionRevision.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionRevision' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionRevision> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionRevision.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionRevision>() {
           @Override
           public void write(JsonWriter out, ActionRevision value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionRevision read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionRevision given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionRevision
   * @throws IOException if the JSON string is invalid with respect to ActionRevision
   */
  public static ActionRevision fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionRevision.class);
  }

  /**
   * Convert an instance of ActionRevision to an JSON string
   *
   * @return JSON string
   */
