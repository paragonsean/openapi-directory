...
public class GetPipelineInput {
  ...
  public GetPipelineInput() {
  }

  public GetPipelineInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetPipelineInput version(Integer version) {
  ...
  public boolean equals(Object o) {
    ...
    GetPipelineInput getPipelineInput = (GetPipelineInput) o;
    return Objects.equals(this.name, getPipelineInput.name) &&
        Objects.equals(this.version, getPipelineInput.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPipelineInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPipelineInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPipelineInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPipelineInput is not found in the empty JSON string", GetPipelineInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPipelineInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPipelineInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPipelineInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPipelineInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPipelineInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPipelineInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPipelineInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPipelineInput>() {
           @Override
           public void write(JsonWriter out, GetPipelineInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPipelineInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPipelineInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPipelineInput
   * @throws IOException if the JSON string is invalid with respect to GetPipelineInput
   */
  public static GetPipelineInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPipelineInput.class);
  }

  /**
   * Convert an instance of GetPipelineInput to an JSON string
   *
   * @return JSON string
   */
