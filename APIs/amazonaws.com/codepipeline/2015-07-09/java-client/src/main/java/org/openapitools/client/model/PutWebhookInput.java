...
import org.openapitools.client.model.PutWebhookInputWebhook;
...
public class PutWebhookInput {
  ...
  private PutWebhookInputWebhook webhook;

  public static final String SERIALIZED_NAME_TAGS = "tags";
  @SerializedName(SERIALIZED_NAME_TAGS)
  private List tags;

  public PutWebhookInput() {
  }

  public PutWebhookInput webhook(PutWebhookInputWebhook webhook) {
  ...
  public PutWebhookInputWebhook getWebhook() {
    return webhook;
  }

  public void setWebhook(PutWebhookInputWebhook webhook) {
    this.webhook = webhook;
  }


  public PutWebhookInput tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutWebhookInput putWebhookInput = (PutWebhookInput) o;
    return Objects.equals(this.webhook, putWebhookInput.webhook) &&
        Objects.equals(this.tags, putWebhookInput.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(webhook, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutWebhookInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutWebhookInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutWebhookInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutWebhookInput is not found in the empty JSON string", PutWebhookInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutWebhookInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutWebhookInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutWebhookInput.openapiRequiredFields) {
      ...
      PutWebhookInputWebhook.validateJsonElement(jsonObj.get("webhook"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutWebhookInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutWebhookInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutWebhookInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutWebhookInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutWebhookInput>() {
           @Override
           public void write(JsonWriter out, PutWebhookInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutWebhookInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutWebhookInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutWebhookInput
   * @throws IOException if the JSON string is invalid with respect to PutWebhookInput
   */
  public static PutWebhookInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutWebhookInput.class);
  }

  /**
   * Convert an instance of PutWebhookInput to an JSON string
   *
   * @return JSON string
   */
