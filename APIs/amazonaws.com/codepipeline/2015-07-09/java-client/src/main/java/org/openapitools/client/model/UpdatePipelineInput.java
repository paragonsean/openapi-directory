...
public class UpdatePipelineInput {
  ...
  private UpdatePipelineInputPipeline pipeline;

  public UpdatePipelineInput() {
  }

  public UpdatePipelineInput pipeline(UpdatePipelineInputPipeline pipeline) {
  ...
  public UpdatePipelineInputPipeline getPipeline() {
    return pipeline;
  }

  public void setPipeline(UpdatePipelineInputPipeline pipeline) {
    this.pipeline = pipeline;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePipelineInput updatePipelineInput = (UpdatePipelineInput) o;
    return Objects.equals(this.pipeline, updatePipelineInput.pipeline);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePipelineInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePipelineInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePipelineInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePipelineInput is not found in the empty JSON string", UpdatePipelineInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePipelineInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePipelineInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePipelineInput.openapiRequiredFields) {
      ...
      UpdatePipelineInputPipeline.validateJsonElement(jsonObj.get("pipeline"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePipelineInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePipelineInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePipelineInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePipelineInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePipelineInput>() {
           @Override
           public void write(JsonWriter out, UpdatePipelineInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePipelineInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePipelineInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePipelineInput
   * @throws IOException if the JSON string is invalid with respect to UpdatePipelineInput
   */
  public static UpdatePipelineInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePipelineInput.class);
  }

  /**
   * Convert an instance of UpdatePipelineInput to an JSON string
   *
   * @return JSON string
   */
