...
/**
 * Gets or Sets ActionExecutionStatus
 */
@JsonAdapter(ActionExecutionStatus.Adapter.class)
public enum ActionExecutionStatus {
  ...
  ActionExecutionStatus(String value) {
    this.value = value;
  }
  ...
  public static ActionExecutionStatus fromValue(String value) {
    for (ActionExecutionStatus b : ActionExecutionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ActionExecutionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ActionExecutionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ActionExecutionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ActionExecutionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ActionExecutionStatus.fromValue(value);
  }
}
