...
public class PollForThirdPartyJobsInput {
  ...
  public PollForThirdPartyJobsInput() {
  }

  public PollForThirdPartyJobsInput actionTypeId(PollForJobsInputActionTypeId actionTypeId) {
  ...
  public PollForThirdPartyJobsInput maxBatchSize(Integer maxBatchSize) {
  ...
  public boolean equals(Object o) {
    ...
    PollForThirdPartyJobsInput pollForThirdPartyJobsInput = (PollForThirdPartyJobsInput) o;
    return Objects.equals(this.actionTypeId, pollForThirdPartyJobsInput.actionTypeId) &&
        Objects.equals(this.maxBatchSize, pollForThirdPartyJobsInput.maxBatchSize);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actionTypeId, maxBatchSize);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PollForThirdPartyJobsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PollForThirdPartyJobsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PollForThirdPartyJobsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PollForThirdPartyJobsInput is not found in the empty JSON string", PollForThirdPartyJobsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PollForThirdPartyJobsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PollForThirdPartyJobsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PollForThirdPartyJobsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PollForThirdPartyJobsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PollForThirdPartyJobsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PollForThirdPartyJobsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PollForThirdPartyJobsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PollForThirdPartyJobsInput>() {
           @Override
           public void write(JsonWriter out, PollForThirdPartyJobsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PollForThirdPartyJobsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PollForThirdPartyJobsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PollForThirdPartyJobsInput
   * @throws IOException if the JSON string is invalid with respect to PollForThirdPartyJobsInput
   */
  public static PollForThirdPartyJobsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PollForThirdPartyJobsInput.class);
  }

  /**
   * Convert an instance of PollForThirdPartyJobsInput to an JSON string
   *
   * @return JSON string
   */
