...
public class JobDetailsData {
  ...
  public JobDetailsData actionTypeId(PollForJobsInputActionTypeId actionTypeId) {
  ...
  public JobDetailsData actionConfiguration(JobDataActionConfiguration actionConfiguration) {
  ...
  public JobDetailsData pipelineContext(JobDataPipelineContext pipelineContext) {
  ...
  public JobDetailsData inputArtifacts(List inputArtifacts) {
  ...
  public JobDetailsData outputArtifacts(List outputArtifacts) {
  ...
  public JobDetailsData artifactCredentials(JobDataArtifactCredentials artifactCredentials) {
  ...
  public JobDetailsData continuationToken(String continuationToken) {
  ...
  public JobDetailsData encryptionKey(JobDataEncryptionKey encryptionKey) {
  ...
  public boolean equals(Object o) {
    ...
    JobDetailsData jobDetailsData = (JobDetailsData) o;
    return Objects.equals(this.actionTypeId, jobDetailsData.actionTypeId) &&
        Objects.equals(this.actionConfiguration, jobDetailsData.actionConfiguration) &&
        Objects.equals(this.pipelineContext, jobDetailsData.pipelineContext) &&
        Objects.equals(this.inputArtifacts, jobDetailsData.inputArtifacts) &&
        Objects.equals(this.outputArtifacts, jobDetailsData.outputArtifacts) &&
        Objects.equals(this.artifactCredentials, jobDetailsData.artifactCredentials) &&
        Objects.equals(this.continuationToken, jobDetailsData.continuationToken) &&
        Objects.equals(this.encryptionKey, jobDetailsData.encryptionKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobDetailsData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobDetailsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobDetailsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobDetailsData is not found in the empty JSON string", JobDetailsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobDetailsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobDetailsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobDetailsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobDetailsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobDetailsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobDetailsData.class));

       return (TypeAdapter<T>) new TypeAdapter<JobDetailsData>() {
           @Override
           public void write(JsonWriter out, JobDetailsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobDetailsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobDetailsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobDetailsData
   * @throws IOException if the JSON string is invalid with respect to JobDetailsData
   */
  public static JobDetailsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobDetailsData.class);
  }

  /**
   * Convert an instance of JobDetailsData to an JSON string
   *
   * @return JSON string
   */
