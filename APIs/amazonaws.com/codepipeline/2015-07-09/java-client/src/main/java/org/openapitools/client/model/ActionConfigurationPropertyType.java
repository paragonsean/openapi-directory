...
/**
 * Gets or Sets ActionConfigurationPropertyType
 */
@JsonAdapter(ActionConfigurationPropertyType.Adapter.class)
public enum ActionConfigurationPropertyType {
  ...
  ActionConfigurationPropertyType(String value) {
    this.value = value;
  }
  ...
  public static ActionConfigurationPropertyType fromValue(String value) {
    for (ActionConfigurationPropertyType b : ActionConfigurationPropertyType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ActionConfigurationPropertyType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ActionConfigurationPropertyType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ActionConfigurationPropertyType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ActionConfigurationPropertyType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ActionConfigurationPropertyType.fromValue(value);
  }
}
