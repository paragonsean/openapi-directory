...
/**
 * Gets or Sets WebhookAuthenticationType
 */
@JsonAdapter(WebhookAuthenticationType.Adapter.class)
public enum WebhookAuthenticationType {
  ...
  WebhookAuthenticationType(String value) {
    this.value = value;
  }
  ...
  public static WebhookAuthenticationType fromValue(String value) {
    for (WebhookAuthenticationType b : WebhookAuthenticationType.values()) {
  ...
  public static class Adapter extends TypeAdapter<WebhookAuthenticationType> {
    @Override
    public void write(final JsonWriter jsonWriter, final WebhookAuthenticationType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public WebhookAuthenticationType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return WebhookAuthenticationType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    WebhookAuthenticationType.fromValue(value);
  }
}
