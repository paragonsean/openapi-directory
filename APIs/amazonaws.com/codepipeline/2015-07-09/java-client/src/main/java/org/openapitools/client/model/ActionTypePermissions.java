...
public class ActionTypePermissions {
  ...
  public ActionTypePermissions() {
  }

  public ActionTypePermissions allowedAccounts(List allowedAccounts) {
  ...
  public List getAllowedAccounts() {
    return allowedAccounts;
  }

  public void setAllowedAccounts(List allowedAccounts) {
    this.allowedAccounts = allowedAccounts;
  }
  ...
  public boolean equals(Object o) {
    ...
    ActionTypePermissions actionTypePermissions = (ActionTypePermissions) o;
    return Objects.equals(this.allowedAccounts, actionTypePermissions.allowedAccounts);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowedAccounts);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ActionTypePermissions {\n");
  ...
  static {
    ...
    openapiFields.add("allowedAccounts");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("allowedAccounts");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionTypePermissions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionTypePermissions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionTypePermissions is not found in the empty JSON string", ActionTypePermissions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionTypePermissions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionTypePermissions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionTypePermissions.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `allowedAccounts`
      List.validateJsonElement(jsonObj.get("allowedAccounts"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionTypePermissions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionTypePermissions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionTypePermissions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionTypePermissions.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionTypePermissions>() {
           @Override
           public void write(JsonWriter out, ActionTypePermissions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionTypePermissions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionTypePermissions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionTypePermissions
   * @throws IOException if the JSON string is invalid with respect to ActionTypePermissions
   */
  public static ActionTypePermissions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionTypePermissions.class);
  }

  /**
   * Convert an instance of ActionTypePermissions to an JSON string
   *
   * @return JSON string
   */
