...
public class ActionContext {
  ...
  public ActionContext name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ActionContext actionExecutionId(String actionExecutionId) {
  ...
  public boolean equals(Object o) {
    ...
    ActionContext actionContext = (ActionContext) o;
    return Objects.equals(this.name, actionContext.name) &&
        Objects.equals(this.actionExecutionId, actionContext.actionExecutionId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionContext
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionContext.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionContext is not found in the empty JSON string", ActionContext.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionContext.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionContext` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionContext.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionContext' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionContext> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionContext.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionContext>() {
           @Override
           public void write(JsonWriter out, ActionContext value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionContext read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionContext given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionContext
   * @throws IOException if the JSON string is invalid with respect to ActionContext
   */
  public static ActionContext fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionContext.class);
  }

  /**
   * Convert an instance of ActionContext to an JSON string
   *
   * @return JSON string
   */
