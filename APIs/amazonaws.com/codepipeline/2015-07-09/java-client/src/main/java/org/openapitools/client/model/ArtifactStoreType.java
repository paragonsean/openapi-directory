...
/**
 * Gets or Sets ArtifactStoreType
 */
@JsonAdapter(ArtifactStoreType.Adapter.class)
public enum ArtifactStoreType {
  ...
  ArtifactStoreType(String value) {
    this.value = value;
  }
  ...
  public static ArtifactStoreType fromValue(String value) {
    for (ArtifactStoreType b : ArtifactStoreType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ArtifactStoreType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ArtifactStoreType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ArtifactStoreType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ArtifactStoreType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ArtifactStoreType.fromValue(value);
  }
}
