...
public class ActionTypeDeclarationExecutor {
  ...
  public ActionTypeDeclarationExecutor() {
  }

  public ActionTypeDeclarationExecutor _configuration(ActionTypeExecutorConfiguration _configuration) {
  ...
  public ActionTypeDeclarationExecutor type(ExecutorType type) {
    this.type = type;
    return this;
  }
  ...
  public ActionTypeDeclarationExecutor policyStatementsTemplate(String policyStatementsTemplate) {
  ...
  public ActionTypeDeclarationExecutor jobTimeout(Integer jobTimeout) {
  ...
  public boolean equals(Object o) {
    ...
    ActionTypeDeclarationExecutor actionTypeDeclarationExecutor = (ActionTypeDeclarationExecutor) o;
    return Objects.equals(this._configuration, actionTypeDeclarationExecutor._configuration) &&
        Objects.equals(this.type, actionTypeDeclarationExecutor.type) &&
        Objects.equals(this.policyStatementsTemplate, actionTypeDeclarationExecutor.policyStatementsTemplate) &&
        Objects.equals(this.jobTimeout, actionTypeDeclarationExecutor.jobTimeout);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionTypeDeclarationExecutor {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionTypeDeclarationExecutor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionTypeDeclarationExecutor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionTypeDeclarationExecutor is not found in the empty JSON string", ActionTypeDeclarationExecutor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionTypeDeclarationExecutor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionTypeDeclarationExecutor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionTypeDeclarationExecutor.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionTypeDeclarationExecutor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionTypeDeclarationExecutor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionTypeDeclarationExecutor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionTypeDeclarationExecutor.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionTypeDeclarationExecutor>() {
           @Override
           public void write(JsonWriter out, ActionTypeDeclarationExecutor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionTypeDeclarationExecutor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionTypeDeclarationExecutor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionTypeDeclarationExecutor
   * @throws IOException if the JSON string is invalid with respect to ActionTypeDeclarationExecutor
   */
  public static ActionTypeDeclarationExecutor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionTypeDeclarationExecutor.class);
  }

  /**
   * Convert an instance of ActionTypeDeclarationExecutor to an JSON string
   *
   * @return JSON string
   */
