...
public class Artifact {
  ...
  public Artifact revision(String revision) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, artifact.name) &&
        Objects.equals(this.revision, artifact.revision) &&
        Objects.equals(this.location, artifact.location);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, revision, location);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("location") != null && !jsonObj.get("location").isJsonNull()) {
        ArtifactLocation.validateJsonElement(jsonObj.get("location"));
      }
  }
