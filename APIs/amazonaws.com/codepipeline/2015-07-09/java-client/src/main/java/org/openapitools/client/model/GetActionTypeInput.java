...
public class GetActionTypeInput {
  ...
  public GetActionTypeInput() {
  }

  public GetActionTypeInput category(ActionCategory category) {
  ...
  public GetActionTypeInput owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public GetActionTypeInput provider(String provider) {
  ...
  public GetActionTypeInput version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    GetActionTypeInput getActionTypeInput = (GetActionTypeInput) o;
    return Objects.equals(this.category, getActionTypeInput.category) &&
        Objects.equals(this.owner, getActionTypeInput.owner) &&
        Objects.equals(this.provider, getActionTypeInput.provider) &&
        Objects.equals(this.version, getActionTypeInput.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetActionTypeInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetActionTypeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetActionTypeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetActionTypeInput is not found in the empty JSON string", GetActionTypeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetActionTypeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetActionTypeInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetActionTypeInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetActionTypeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetActionTypeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetActionTypeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetActionTypeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetActionTypeInput>() {
           @Override
           public void write(JsonWriter out, GetActionTypeInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetActionTypeInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetActionTypeInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetActionTypeInput
   * @throws IOException if the JSON string is invalid with respect to GetActionTypeInput
   */
  public static GetActionTypeInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetActionTypeInput.class);
  }

  /**
   * Convert an instance of GetActionTypeInput to an JSON string
   *
   * @return JSON string
   */
