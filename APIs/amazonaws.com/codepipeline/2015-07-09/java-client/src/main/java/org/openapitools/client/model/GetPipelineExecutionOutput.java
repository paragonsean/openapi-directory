...
import org.openapitools.client.model.GetPipelineExecutionOutputPipelineExecution;
...
public class GetPipelineExecutionOutput {
  ...
  private GetPipelineExecutionOutputPipelineExecution pipelineExecution;

  public GetPipelineExecutionOutput() {
  }

  public GetPipelineExecutionOutput pipelineExecution(GetPipelineExecutionOutputPipelineExecution pipelineExecution) {
  ...
  public GetPipelineExecutionOutputPipelineExecution getPipelineExecution() {
    return pipelineExecution;
  }

  public void setPipelineExecution(GetPipelineExecutionOutputPipelineExecution pipelineExecution) {
    this.pipelineExecution = pipelineExecution;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPipelineExecutionOutput getPipelineExecutionOutput = (GetPipelineExecutionOutput) o;
    return Objects.equals(this.pipelineExecution, getPipelineExecutionOutput.pipelineExecution);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineExecution);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPipelineExecutionOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPipelineExecutionOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPipelineExecutionOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPipelineExecutionOutput is not found in the empty JSON string", GetPipelineExecutionOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPipelineExecutionOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPipelineExecutionOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("pipelineExecution") != null && !jsonObj.get("pipelineExecution").isJsonNull()) {
        GetPipelineExecutionOutputPipelineExecution.validateJsonElement(jsonObj.get("pipelineExecution"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPipelineExecutionOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPipelineExecutionOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPipelineExecutionOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPipelineExecutionOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPipelineExecutionOutput>() {
           @Override
           public void write(JsonWriter out, GetPipelineExecutionOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPipelineExecutionOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPipelineExecutionOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPipelineExecutionOutput
   * @throws IOException if the JSON string is invalid with respect to GetPipelineExecutionOutput
   */
  public static GetPipelineExecutionOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPipelineExecutionOutput.class);
  }

  /**
   * Convert an instance of GetPipelineExecutionOutput to an JSON string
   *
   * @return JSON string
   */
