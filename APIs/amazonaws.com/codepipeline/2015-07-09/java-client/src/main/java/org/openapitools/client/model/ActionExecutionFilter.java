...
public class ActionExecutionFilter {
  ...
  public ActionExecutionFilter pipelineExecutionId(String pipelineExecutionId) {
  ...
  public boolean equals(Object o) {
    ...
    ActionExecutionFilter actionExecutionFilter = (ActionExecutionFilter) o;
    return Objects.equals(this.pipelineExecutionId, actionExecutionFilter.pipelineExecutionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionExecutionFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionExecutionFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionExecutionFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionExecutionFilter is not found in the empty JSON string", ActionExecutionFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionExecutionFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionExecutionFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionExecutionFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionExecutionFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionExecutionFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionExecutionFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionExecutionFilter>() {
           @Override
           public void write(JsonWriter out, ActionExecutionFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionExecutionFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionExecutionFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionExecutionFilter
   * @throws IOException if the JSON string is invalid with respect to ActionExecutionFilter
   */
  public static ActionExecutionFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionExecutionFilter.class);
  }

  /**
   * Convert an instance of ActionExecutionFilter to an JSON string
   *
   * @return JSON string
   */
