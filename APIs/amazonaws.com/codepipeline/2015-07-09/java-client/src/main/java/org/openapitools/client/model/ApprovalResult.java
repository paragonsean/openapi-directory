...
public class ApprovalResult {
  ...
  public ApprovalResult summary(String summary) {
  ...
  public ApprovalResult status(ApprovalStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApprovalResult approvalResult = (ApprovalResult) o;
    return Objects.equals(this.summary, approvalResult.summary) &&
        Objects.equals(this.status, approvalResult.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApprovalResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApprovalResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApprovalResult is not found in the empty JSON string", ApprovalResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApprovalResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApprovalResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApprovalResult.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApprovalResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApprovalResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApprovalResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApprovalResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ApprovalResult>() {
           @Override
           public void write(JsonWriter out, ApprovalResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApprovalResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApprovalResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApprovalResult
   * @throws IOException if the JSON string is invalid with respect to ApprovalResult
   */
  public static ApprovalResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApprovalResult.class);
  }

  /**
   * Convert an instance of ApprovalResult to an JSON string
   *
   * @return JSON string
   */
