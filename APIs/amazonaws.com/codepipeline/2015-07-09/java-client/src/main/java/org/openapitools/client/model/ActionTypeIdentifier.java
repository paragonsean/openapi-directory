...
public class ActionTypeIdentifier {
  ...
  public ActionTypeIdentifier() {
  }

  public ActionTypeIdentifier category(ActionCategory category) {
  ...
  public ActionTypeIdentifier owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public ActionTypeIdentifier provider(String provider) {
  ...
  public ActionTypeIdentifier version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    ActionTypeIdentifier actionTypeIdentifier = (ActionTypeIdentifier) o;
    return Objects.equals(this.category, actionTypeIdentifier.category) &&
        Objects.equals(this.owner, actionTypeIdentifier.owner) &&
        Objects.equals(this.provider, actionTypeIdentifier.provider) &&
        Objects.equals(this.version, actionTypeIdentifier.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionTypeIdentifier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionTypeIdentifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionTypeIdentifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionTypeIdentifier is not found in the empty JSON string", ActionTypeIdentifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionTypeIdentifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionTypeIdentifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionTypeIdentifier.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionTypeIdentifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionTypeIdentifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionTypeIdentifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionTypeIdentifier.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionTypeIdentifier>() {
           @Override
           public void write(JsonWriter out, ActionTypeIdentifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionTypeIdentifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionTypeIdentifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionTypeIdentifier
   * @throws IOException if the JSON string is invalid with respect to ActionTypeIdentifier
   */
  public static ActionTypeIdentifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionTypeIdentifier.class);
  }

  /**
   * Convert an instance of ActionTypeIdentifier to an JSON string
   *
   * @return JSON string
   */
