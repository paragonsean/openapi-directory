...
public class AWSSessionCredentials {
  ...
  public AWSSessionCredentials accessKeyId(String accessKeyId) {
  ...
  public AWSSessionCredentials secretAccessKey(String secretAccessKey) {
  ...
  public AWSSessionCredentials sessionToken(String sessionToken) {
  ...
  public boolean equals(Object o) {
    ...
    AWSSessionCredentials awSSessionCredentials = (AWSSessionCredentials) o;
    return Objects.equals(this.accessKeyId, awSSessionCredentials.accessKeyId) &&
        Objects.equals(this.secretAccessKey, awSSessionCredentials.secretAccessKey) &&
        Objects.equals(this.sessionToken, awSSessionCredentials.sessionToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class AWSSessionCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AWSSessionCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AWSSessionCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AWSSessionCredentials is not found in the empty JSON string", AWSSessionCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AWSSessionCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AWSSessionCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AWSSessionCredentials.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AWSSessionCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AWSSessionCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AWSSessionCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AWSSessionCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<AWSSessionCredentials>() {
           @Override
           public void write(JsonWriter out, AWSSessionCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AWSSessionCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AWSSessionCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AWSSessionCredentials
   * @throws IOException if the JSON string is invalid with respect to AWSSessionCredentials
   */
  public static AWSSessionCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AWSSessionCredentials.class);
  }

  /**
   * Convert an instance of AWSSessionCredentials to an JSON string
   *
   * @return JSON string
   */
