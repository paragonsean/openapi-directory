...
public class GetThirdPartyJobDetailsInput {
  ...
  public GetThirdPartyJobDetailsInput() {
  }

  public GetThirdPartyJobDetailsInput jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetThirdPartyJobDetailsInput clientToken(String clientToken) {
  ...
  public boolean equals(Object o) {
    ...
    GetThirdPartyJobDetailsInput getThirdPartyJobDetailsInput = (GetThirdPartyJobDetailsInput) o;
    return Objects.equals(this.jobId, getThirdPartyJobDetailsInput.jobId) &&
        Objects.equals(this.clientToken, getThirdPartyJobDetailsInput.clientToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobId, clientToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetThirdPartyJobDetailsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetThirdPartyJobDetailsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetThirdPartyJobDetailsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetThirdPartyJobDetailsInput is not found in the empty JSON string", GetThirdPartyJobDetailsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetThirdPartyJobDetailsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetThirdPartyJobDetailsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetThirdPartyJobDetailsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetThirdPartyJobDetailsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetThirdPartyJobDetailsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetThirdPartyJobDetailsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetThirdPartyJobDetailsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetThirdPartyJobDetailsInput>() {
           @Override
           public void write(JsonWriter out, GetThirdPartyJobDetailsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetThirdPartyJobDetailsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetThirdPartyJobDetailsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetThirdPartyJobDetailsInput
   * @throws IOException if the JSON string is invalid with respect to GetThirdPartyJobDetailsInput
   */
  public static GetThirdPartyJobDetailsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetThirdPartyJobDetailsInput.class);
  }

  /**
   * Convert an instance of GetThirdPartyJobDetailsInput to an JSON string
   *
   * @return JSON string
   */
