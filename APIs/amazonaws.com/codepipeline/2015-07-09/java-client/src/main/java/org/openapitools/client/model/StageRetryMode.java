...
/**
 * Gets or Sets StageRetryMode
 */
@JsonAdapter(StageRetryMode.Adapter.class)
public enum StageRetryMode {
  ...
  public static StageRetryMode fromValue(String value) {
    for (StageRetryMode b : StageRetryMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<StageRetryMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final StageRetryMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StageRetryMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StageRetryMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StageRetryMode.fromValue(value);
  }
}
