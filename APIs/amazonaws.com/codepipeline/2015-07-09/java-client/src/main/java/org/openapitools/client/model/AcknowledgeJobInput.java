...
public class AcknowledgeJobInput {
  ...
  public AcknowledgeJobInput() {
  }

  public AcknowledgeJobInput jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public AcknowledgeJobInput nonce(String nonce) {
    this.nonce = nonce;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AcknowledgeJobInput acknowledgeJobInput = (AcknowledgeJobInput) o;
    return Objects.equals(this.jobId, acknowledgeJobInput.jobId) &&
        Objects.equals(this.nonce, acknowledgeJobInput.nonce);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobId, nonce);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AcknowledgeJobInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AcknowledgeJobInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AcknowledgeJobInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AcknowledgeJobInput is not found in the empty JSON string", AcknowledgeJobInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AcknowledgeJobInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AcknowledgeJobInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AcknowledgeJobInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AcknowledgeJobInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AcknowledgeJobInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AcknowledgeJobInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AcknowledgeJobInput.class));

       return (TypeAdapter<T>) new TypeAdapter<AcknowledgeJobInput>() {
           @Override
           public void write(JsonWriter out, AcknowledgeJobInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AcknowledgeJobInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AcknowledgeJobInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AcknowledgeJobInput
   * @throws IOException if the JSON string is invalid with respect to AcknowledgeJobInput
   */
  public static AcknowledgeJobInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AcknowledgeJobInput.class);
  }

  /**
   * Convert an instance of AcknowledgeJobInput to an JSON string
   *
   * @return JSON string
   */
