...
public class ListWebhookItem {
  ...
  public ListWebhookItem() {
  }

  public ListWebhookItem definition(ListWebhookItemDefinition definition) {
  ...
  public ListWebhookItem url(String url) {
    this.url = url;
    return this;
  }
  ...
  public ListWebhookItem errorMessage(String errorMessage) {
  ...
  public ListWebhookItem errorCode(String errorCode) {
  ...
  public ListWebhookItem lastTriggered(OffsetDateTime lastTriggered) {
  ...
  public ListWebhookItem arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public ListWebhookItem tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListWebhookItem listWebhookItem = (ListWebhookItem) o;
    return Objects.equals(this.definition, listWebhookItem.definition) &&
        Objects.equals(this.url, listWebhookItem.url) &&
        Objects.equals(this.errorMessage, listWebhookItem.errorMessage) &&
        Objects.equals(this.errorCode, listWebhookItem.errorCode) &&
        Objects.equals(this.lastTriggered, listWebhookItem.lastTriggered) &&
        Objects.equals(this.arn, listWebhookItem.arn) &&
        Objects.equals(this.tags, listWebhookItem.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListWebhookItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListWebhookItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListWebhookItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListWebhookItem is not found in the empty JSON string", ListWebhookItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListWebhookItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListWebhookItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListWebhookItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListWebhookItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListWebhookItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListWebhookItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListWebhookItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ListWebhookItem>() {
           @Override
           public void write(JsonWriter out, ListWebhookItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListWebhookItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListWebhookItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListWebhookItem
   * @throws IOException if the JSON string is invalid with respect to ListWebhookItem
   */
  public static ListWebhookItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListWebhookItem.class);
  }

  /**
   * Convert an instance of ListWebhookItem to an JSON string
   *
   * @return JSON string
   */
