...
public class ListActionExecutionsInputFilter {
  ...
  public ListActionExecutionsInputFilter() {
  }

  public ListActionExecutionsInputFilter pipelineExecutionId(String pipelineExecutionId) {
  ...
  public boolean equals(Object o) {
    ...
    ListActionExecutionsInputFilter listActionExecutionsInputFilter = (ListActionExecutionsInputFilter) o;
    return Objects.equals(this.pipelineExecutionId, listActionExecutionsInputFilter.pipelineExecutionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListActionExecutionsInputFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListActionExecutionsInputFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListActionExecutionsInputFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListActionExecutionsInputFilter is not found in the empty JSON string", ListActionExecutionsInputFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListActionExecutionsInputFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListActionExecutionsInputFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListActionExecutionsInputFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListActionExecutionsInputFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListActionExecutionsInputFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListActionExecutionsInputFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<ListActionExecutionsInputFilter>() {
           @Override
           public void write(JsonWriter out, ListActionExecutionsInputFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListActionExecutionsInputFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListActionExecutionsInputFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListActionExecutionsInputFilter
   * @throws IOException if the JSON string is invalid with respect to ListActionExecutionsInputFilter
   */
  public static ListActionExecutionsInputFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListActionExecutionsInputFilter.class);
  }

  /**
   * Convert an instance of ListActionExecutionsInputFilter to an JSON string
   *
   * @return JSON string
   */
