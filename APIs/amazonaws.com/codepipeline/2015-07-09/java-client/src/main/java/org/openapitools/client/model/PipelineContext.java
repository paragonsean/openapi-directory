...
public class PipelineContext {
  ...
  public PipelineContext pipelineName(String pipelineName) {
  ...
  public PipelineContext stage(PipelineContextStage stage) {
    this.stage = stage;
    return this;
  }
  ...
  public PipelineContext action(PipelineContextAction action) {
    this.action = action;
    return this;
  }
  ...
  public PipelineContext pipelineArn(String pipelineArn) {
  ...
  public PipelineContext pipelineExecutionId(String pipelineExecutionId) {
  ...
  public boolean equals(Object o) {
    ...
    PipelineContext pipelineContext = (PipelineContext) o;
    return Objects.equals(this.pipelineName, pipelineContext.pipelineName) &&
        Objects.equals(this.stage, pipelineContext.stage) &&
        Objects.equals(this.action, pipelineContext.action) &&
        Objects.equals(this.pipelineArn, pipelineContext.pipelineArn) &&
        Objects.equals(this.pipelineExecutionId, pipelineContext.pipelineExecutionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PipelineContext {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PipelineContext
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipelineContext.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipelineContext is not found in the empty JSON string", PipelineContext.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipelineContext.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PipelineContext` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipelineContext.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipelineContext' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipelineContext> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipelineContext.class));

       return (TypeAdapter<T>) new TypeAdapter<PipelineContext>() {
           @Override
           public void write(JsonWriter out, PipelineContext value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PipelineContext read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PipelineContext given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PipelineContext
   * @throws IOException if the JSON string is invalid with respect to PipelineContext
   */
  public static PipelineContext fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipelineContext.class);
  }

  /**
   * Convert an instance of PipelineContext to an JSON string
   *
   * @return JSON string
   */
