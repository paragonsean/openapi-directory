...
public class WebhookAuthConfiguration {
  ...
  public WebhookAuthConfiguration allowedIPRange(String allowedIPRange) {
  ...
  public WebhookAuthConfiguration secretToken(String secretToken) {
  ...
  public boolean equals(Object o) {
    ...
    WebhookAuthConfiguration webhookAuthConfiguration = (WebhookAuthConfiguration) o;
    return Objects.equals(this.allowedIPRange, webhookAuthConfiguration.allowedIPRange) &&
        Objects.equals(this.secretToken, webhookAuthConfiguration.secretToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookAuthConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookAuthConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookAuthConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookAuthConfiguration is not found in the empty JSON string", WebhookAuthConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookAuthConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookAuthConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookAuthConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookAuthConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookAuthConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookAuthConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookAuthConfiguration>() {
           @Override
           public void write(JsonWriter out, WebhookAuthConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookAuthConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebhookAuthConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebhookAuthConfiguration
   * @throws IOException if the JSON string is invalid with respect to WebhookAuthConfiguration
   */
  public static WebhookAuthConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookAuthConfiguration.class);
  }

  /**
   * Convert an instance of WebhookAuthConfiguration to an JSON string
   *
   * @return JSON string
   */
