...
public class ActionTypeSettings {
  ...
  public ActionTypeSettings thirdPartyConfigurationUrl(String thirdPartyConfigurationUrl) {
  ...
  public ActionTypeSettings entityUrlTemplate(String entityUrlTemplate) {
  ...
  public ActionTypeSettings executionUrlTemplate(String executionUrlTemplate) {
  ...
  public ActionTypeSettings revisionUrlTemplate(String revisionUrlTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    ActionTypeSettings actionTypeSettings = (ActionTypeSettings) o;
    return Objects.equals(this.thirdPartyConfigurationUrl, actionTypeSettings.thirdPartyConfigurationUrl) &&
        Objects.equals(this.entityUrlTemplate, actionTypeSettings.entityUrlTemplate) &&
        Objects.equals(this.executionUrlTemplate, actionTypeSettings.executionUrlTemplate) &&
        Objects.equals(this.revisionUrlTemplate, actionTypeSettings.revisionUrlTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionTypeSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionTypeSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionTypeSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionTypeSettings is not found in the empty JSON string", ActionTypeSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionTypeSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionTypeSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionTypeSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionTypeSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionTypeSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionTypeSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionTypeSettings>() {
           @Override
           public void write(JsonWriter out, ActionTypeSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionTypeSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionTypeSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionTypeSettings
   * @throws IOException if the JSON string is invalid with respect to ActionTypeSettings
   */
  public static ActionTypeSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionTypeSettings.class);
  }

  /**
   * Convert an instance of ActionTypeSettings to an JSON string
   *
   * @return JSON string
   */
