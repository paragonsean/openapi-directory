...
import org.openapitools.client.model.GetJobDetailsOutputJobDetails;
...
public class GetJobDetailsOutput {
  ...
  private GetJobDetailsOutputJobDetails jobDetails;

  public GetJobDetailsOutput() {
  }

  public GetJobDetailsOutput jobDetails(GetJobDetailsOutputJobDetails jobDetails) {
  ...
  public GetJobDetailsOutputJobDetails getJobDetails() {
    return jobDetails;
  }

  public void setJobDetails(GetJobDetailsOutputJobDetails jobDetails) {
    this.jobDetails = jobDetails;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetJobDetailsOutput getJobDetailsOutput = (GetJobDetailsOutput) o;
    return Objects.equals(this.jobDetails, getJobDetailsOutput.jobDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetJobDetailsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetJobDetailsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetJobDetailsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetJobDetailsOutput is not found in the empty JSON string", GetJobDetailsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetJobDetailsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetJobDetailsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `jobDetails`
      if (jsonObj.get("jobDetails") != null && !jsonObj.get("jobDetails").isJsonNull()) {
        GetJobDetailsOutputJobDetails.validateJsonElement(jsonObj.get("jobDetails"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetJobDetailsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetJobDetailsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetJobDetailsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetJobDetailsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetJobDetailsOutput>() {
           @Override
           public void write(JsonWriter out, GetJobDetailsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetJobDetailsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetJobDetailsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetJobDetailsOutput
   * @throws IOException if the JSON string is invalid with respect to GetJobDetailsOutput
   */
  public static GetJobDetailsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetJobDetailsOutput.class);
  }

  /**
   * Convert an instance of GetJobDetailsOutput to an JSON string
   *
   * @return JSON string
   */
