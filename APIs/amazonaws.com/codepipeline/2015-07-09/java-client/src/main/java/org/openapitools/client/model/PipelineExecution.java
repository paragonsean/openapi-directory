...
public class PipelineExecution {
  ...
  public static final String SERIALIZED_NAME_ARTIFACT_REVISIONS = "artifactRevisions";
  @SerializedName(SERIALIZED_NAME_ARTIFACT_REVISIONS)
  private List artifactRevisions;

  public PipelineExecution() {
  }

  public PipelineExecution pipelineName(String pipelineName) {
  ...
  public PipelineExecution pipelineVersion(Integer pipelineVersion) {
  ...
  public PipelineExecution pipelineExecutionId(String pipelineExecutionId) {
  ...
  public PipelineExecution status(PipelineExecutionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public PipelineExecution statusSummary(String statusSummary) {
  ...
  public PipelineExecution artifactRevisions(List artifactRevisions) {
    this.artifactRevisions = artifactRevisions;
    return this;
  }

  /**
   * Get artifactRevisions
   * @return artifactRevisions
   */
  @javax.annotation.Nullable
  public List getArtifactRevisions() {
    return artifactRevisions;
  }

  public void setArtifactRevisions(List artifactRevisions) {
    this.artifactRevisions = artifactRevisions;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pipelineName, pipelineExecution.pipelineName) &&
        Objects.equals(this.pipelineVersion, pipelineExecution.pipelineVersion) &&
        Objects.equals(this.pipelineExecutionId, pipelineExecution.pipelineExecutionId) &&
        Objects.equals(this.status, pipelineExecution.status) &&
        Objects.equals(this.statusSummary, pipelineExecution.statusSummary) &&
        Objects.equals(this.artifactRevisions, pipelineExecution.artifactRevisions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineName, pipelineVersion, pipelineExecutionId, status, statusSummary, artifactRevisions);
  }
  ...
  public String toString() {
    ...
    sb.append("    artifactRevisions: ").append(toIndentedString(artifactRevisions)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("artifactRevisions");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("statusSummary") != null && !jsonObj.get("statusSummary").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("statusSummary"));
      }
      // validate the optional field `artifactRevisions`
      if (jsonObj.get("artifactRevisions") != null && !jsonObj.get("artifactRevisions").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("artifactRevisions"));
      }
  }
