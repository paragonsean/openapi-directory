...
import org.openapitools.client.model.PutApprovalResultInputResult;
...
public class PutApprovalResultInput {
  ...
  private PutApprovalResultInputResult result;

  public static final String SERIALIZED_NAME_TOKEN = "token";
  @SerializedName(SERIALIZED_NAME_TOKEN)
  private String token;

  public PutApprovalResultInput() {
  }

  public PutApprovalResultInput pipelineName(String pipelineName) {
  ...
  public PutApprovalResultInput stageName(String stageName) {
  ...
  public PutApprovalResultInput actionName(String actionName) {
  ...
  public PutApprovalResultInput result(PutApprovalResultInputResult result) {
    this.result = result;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public PutApprovalResultInputResult getResult() {
    return result;
  }

  public void setResult(PutApprovalResultInputResult result) {
    this.result = result;
  }


  public PutApprovalResultInput token(String token) {
    this.token = token;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutApprovalResultInput putApprovalResultInput = (PutApprovalResultInput) o;
    return Objects.equals(this.pipelineName, putApprovalResultInput.pipelineName) &&
        Objects.equals(this.stageName, putApprovalResultInput.stageName) &&
        Objects.equals(this.actionName, putApprovalResultInput.actionName) &&
        Objects.equals(this.result, putApprovalResultInput.result) &&
        Objects.equals(this.token, putApprovalResultInput.token);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineName, stageName, actionName, result, token);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutApprovalResultInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutApprovalResultInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutApprovalResultInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutApprovalResultInput is not found in the empty JSON string", PutApprovalResultInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutApprovalResultInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutApprovalResultInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutApprovalResultInput.openapiRequiredFields) {
      ...
      PutApprovalResultInputResult.validateJsonElement(jsonObj.get("result"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutApprovalResultInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutApprovalResultInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutApprovalResultInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutApprovalResultInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutApprovalResultInput>() {
           @Override
           public void write(JsonWriter out, PutApprovalResultInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutApprovalResultInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutApprovalResultInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutApprovalResultInput
   * @throws IOException if the JSON string is invalid with respect to PutApprovalResultInput
   */
  public static PutApprovalResultInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutApprovalResultInput.class);
  }

  /**
   * Convert an instance of PutApprovalResultInput to an JSON string
   *
   * @return JSON string
   */
