...
public class PollForJobsOutput {
  ...
  public PollForJobsOutput jobs(List jobs) {
    this.jobs = jobs;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PollForJobsOutput pollForJobsOutput = (PollForJobsOutput) o;
    return Objects.equals(this.jobs, pollForJobsOutput.jobs);
  }
  ...
  public String toString() {
    ...
    sb.append("class PollForJobsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PollForJobsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PollForJobsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PollForJobsOutput is not found in the empty JSON string", PollForJobsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PollForJobsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PollForJobsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PollForJobsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PollForJobsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PollForJobsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PollForJobsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<PollForJobsOutput>() {
           @Override
           public void write(JsonWriter out, PollForJobsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PollForJobsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PollForJobsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PollForJobsOutput
   * @throws IOException if the JSON string is invalid with respect to PollForJobsOutput
   */
  public static PollForJobsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PollForJobsOutput.class);
  }

  /**
   * Convert an instance of PollForJobsOutput to an JSON string
   *
   * @return JSON string
   */
