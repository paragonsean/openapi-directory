...
public class StageContext {
  ...
  public StageContext name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, stageContext.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StageContext
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StageContext.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StageContext is not found in the empty JSON string", StageContext.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StageContext.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StageContext` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StageContext.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StageContext' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StageContext> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StageContext.class));

       return (TypeAdapter<T>) new TypeAdapter<StageContext>() {
           @Override
           public void write(JsonWriter out, StageContext value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StageContext read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StageContext given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StageContext
   * @throws IOException if the JSON string is invalid with respect to StageContext
   */
  public static StageContext fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StageContext.class);
  }

  /**
   * Convert an instance of StageContext to an JSON string
   *
   * @return JSON string
   */
