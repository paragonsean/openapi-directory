...
public class StageExecution {
  ...
  public StageExecution pipelineExecutionId(String pipelineExecutionId) {
  ...
  public StageExecution status(StageExecutionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StageExecution stageExecution = (StageExecution) o;
    return Objects.equals(this.pipelineExecutionId, stageExecution.pipelineExecutionId) &&
        Objects.equals(this.status, stageExecution.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class StageExecution {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StageExecution
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StageExecution.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StageExecution is not found in the empty JSON string", StageExecution.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StageExecution.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StageExecution` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StageExecution.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StageExecution.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StageExecution' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StageExecution> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StageExecution.class));

       return (TypeAdapter<T>) new TypeAdapter<StageExecution>() {
           @Override
           public void write(JsonWriter out, StageExecution value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StageExecution read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StageExecution given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StageExecution
   * @throws IOException if the JSON string is invalid with respect to StageExecution
   */
  public static StageExecution fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StageExecution.class);
  }

  /**
   * Convert an instance of StageExecution to an JSON string
   *
   * @return JSON string
   */
