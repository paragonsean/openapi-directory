...
public class PipelineDeclarationArtifactStore {
  ...
  public PipelineDeclarationArtifactStore() {
  }

  public PipelineDeclarationArtifactStore type(ArtifactStoreType type) {
    this.type = type;
    return this;
  }
  ...
  public PipelineDeclarationArtifactStore location(String location) {
  ...
  public PipelineDeclarationArtifactStore encryptionKey(ArtifactStoreEncryptionKey encryptionKey) {
  ...
  public boolean equals(Object o) {
    ...
    PipelineDeclarationArtifactStore pipelineDeclarationArtifactStore = (PipelineDeclarationArtifactStore) o;
    return Objects.equals(this.type, pipelineDeclarationArtifactStore.type) &&
        Objects.equals(this.location, pipelineDeclarationArtifactStore.location) &&
        Objects.equals(this.encryptionKey, pipelineDeclarationArtifactStore.encryptionKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class PipelineDeclarationArtifactStore {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PipelineDeclarationArtifactStore
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipelineDeclarationArtifactStore.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipelineDeclarationArtifactStore is not found in the empty JSON string", PipelineDeclarationArtifactStore.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipelineDeclarationArtifactStore.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PipelineDeclarationArtifactStore` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PipelineDeclarationArtifactStore.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipelineDeclarationArtifactStore.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipelineDeclarationArtifactStore' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipelineDeclarationArtifactStore> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipelineDeclarationArtifactStore.class));

       return (TypeAdapter<T>) new TypeAdapter<PipelineDeclarationArtifactStore>() {
           @Override
           public void write(JsonWriter out, PipelineDeclarationArtifactStore value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PipelineDeclarationArtifactStore read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PipelineDeclarationArtifactStore given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PipelineDeclarationArtifactStore
   * @throws IOException if the JSON string is invalid with respect to PipelineDeclarationArtifactStore
   */
  public static PipelineDeclarationArtifactStore fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipelineDeclarationArtifactStore.class);
  }

  /**
   * Convert an instance of PipelineDeclarationArtifactStore to an JSON string
   *
   * @return JSON string
   */
