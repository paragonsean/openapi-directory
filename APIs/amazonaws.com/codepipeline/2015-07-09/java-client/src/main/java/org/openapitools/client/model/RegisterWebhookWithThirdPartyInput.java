...
public class RegisterWebhookWithThirdPartyInput {
  ...
  public RegisterWebhookWithThirdPartyInput webhookName(String webhookName) {
  ...
  public boolean equals(Object o) {
    ...
    RegisterWebhookWithThirdPartyInput registerWebhookWithThirdPartyInput = (RegisterWebhookWithThirdPartyInput) o;
    return Objects.equals(this.webhookName, registerWebhookWithThirdPartyInput.webhookName);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegisterWebhookWithThirdPartyInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegisterWebhookWithThirdPartyInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegisterWebhookWithThirdPartyInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegisterWebhookWithThirdPartyInput is not found in the empty JSON string", RegisterWebhookWithThirdPartyInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegisterWebhookWithThirdPartyInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegisterWebhookWithThirdPartyInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegisterWebhookWithThirdPartyInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegisterWebhookWithThirdPartyInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegisterWebhookWithThirdPartyInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegisterWebhookWithThirdPartyInput.class));

       return (TypeAdapter<T>) new TypeAdapter<RegisterWebhookWithThirdPartyInput>() {
           @Override
           public void write(JsonWriter out, RegisterWebhookWithThirdPartyInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegisterWebhookWithThirdPartyInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegisterWebhookWithThirdPartyInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegisterWebhookWithThirdPartyInput
   * @throws IOException if the JSON string is invalid with respect to RegisterWebhookWithThirdPartyInput
   */
  public static RegisterWebhookWithThirdPartyInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegisterWebhookWithThirdPartyInput.class);
  }

  /**
   * Convert an instance of RegisterWebhookWithThirdPartyInput to an JSON string
   *
   * @return JSON string
   */
