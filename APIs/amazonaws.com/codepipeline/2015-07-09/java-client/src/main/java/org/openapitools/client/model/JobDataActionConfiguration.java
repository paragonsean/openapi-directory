...
public class JobDataActionConfiguration {
  public static final String SERIALIZED_NAME_CONFIGURATION = "configuration";
  @SerializedName(SERIALIZED_NAME_CONFIGURATION)
  private Map _configuration;

  public JobDataActionConfiguration() {
  }

  public JobDataActionConfiguration _configuration(Map _configuration) {
  ...
  public boolean equals(Object o) {
    ...
    JobDataActionConfiguration jobDataActionConfiguration = (JobDataActionConfiguration) o;
    return Objects.equals(this._configuration, jobDataActionConfiguration._configuration);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobDataActionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobDataActionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobDataActionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobDataActionConfiguration is not found in the empty JSON string", JobDataActionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobDataActionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobDataActionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobDataActionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobDataActionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobDataActionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobDataActionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<JobDataActionConfiguration>() {
           @Override
           public void write(JsonWriter out, JobDataActionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobDataActionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobDataActionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobDataActionConfiguration
   * @throws IOException if the JSON string is invalid with respect to JobDataActionConfiguration
   */
  public static JobDataActionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobDataActionConfiguration.class);
  }

  /**
   * Convert an instance of JobDataActionConfiguration to an JSON string
   *
   * @return JSON string
   */
