...
public class ActionTypeArtifactDetails {
  ...
  public ActionTypeArtifactDetails() {
  }

  public ActionTypeArtifactDetails minimumCount(Integer minimumCount) {
  ...
  public ActionTypeArtifactDetails maximumCount(Integer maximumCount) {
  ...
  public boolean equals(Object o) {
    ...
    ActionTypeArtifactDetails actionTypeArtifactDetails = (ActionTypeArtifactDetails) o;
    return Objects.equals(this.minimumCount, actionTypeArtifactDetails.minimumCount) &&
        Objects.equals(this.maximumCount, actionTypeArtifactDetails.maximumCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionTypeArtifactDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionTypeArtifactDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionTypeArtifactDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionTypeArtifactDetails is not found in the empty JSON string", ActionTypeArtifactDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionTypeArtifactDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionTypeArtifactDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionTypeArtifactDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionTypeArtifactDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionTypeArtifactDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionTypeArtifactDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionTypeArtifactDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionTypeArtifactDetails>() {
           @Override
           public void write(JsonWriter out, ActionTypeArtifactDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionTypeArtifactDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionTypeArtifactDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionTypeArtifactDetails
   * @throws IOException if the JSON string is invalid with respect to ActionTypeArtifactDetails
   */
  public static ActionTypeArtifactDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionTypeArtifactDetails.class);
  }

  /**
   * Convert an instance of ActionTypeArtifactDetails to an JSON string
   *
   * @return JSON string
   */
