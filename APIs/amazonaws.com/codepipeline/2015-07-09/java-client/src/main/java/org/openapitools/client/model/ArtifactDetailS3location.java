...
public class ArtifactDetailS3location {
  ...
  public ArtifactDetailS3location() {
  }

  public ArtifactDetailS3location bucket(String bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public ArtifactDetailS3location key(String key) {
    this.key = key;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ArtifactDetailS3location artifactDetailS3location = (ArtifactDetailS3location) o;
    return Objects.equals(this.bucket, artifactDetailS3location.bucket) &&
        Objects.equals(this.key, artifactDetailS3location.key);
  }
  ...
  public String toString() {
    ...
    sb.append("class ArtifactDetailS3location {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ArtifactDetailS3location
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ArtifactDetailS3location.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ArtifactDetailS3location is not found in the empty JSON string", ArtifactDetailS3location.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ArtifactDetailS3location.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ArtifactDetailS3location` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ArtifactDetailS3location.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ArtifactDetailS3location' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ArtifactDetailS3location> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ArtifactDetailS3location.class));

       return (TypeAdapter<T>) new TypeAdapter<ArtifactDetailS3location>() {
           @Override
           public void write(JsonWriter out, ArtifactDetailS3location value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ArtifactDetailS3location read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ArtifactDetailS3location given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ArtifactDetailS3location
   * @throws IOException if the JSON string is invalid with respect to ArtifactDetailS3location
   */
  public static ArtifactDetailS3location fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ArtifactDetailS3location.class);
  }

  /**
   * Convert an instance of ArtifactDetailS3location to an JSON string
   *
   * @return JSON string
   */
