...
public class ListActionTypesOutput {
  ...
  public ListActionTypesOutput() {
  }

  public ListActionTypesOutput actionTypes(List actionTypes) {
  ...
  public void setActionTypes(List actionTypes) {
    this.actionTypes = actionTypes;
  }


  public ListActionTypesOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListActionTypesOutput listActionTypesOutput = (ListActionTypesOutput) o;
    return Objects.equals(this.actionTypes, listActionTypesOutput.actionTypes) &&
        Objects.equals(this.nextToken, listActionTypesOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actionTypes, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListActionTypesOutput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("actionTypes");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListActionTypesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListActionTypesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListActionTypesOutput is not found in the empty JSON string", ListActionTypesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListActionTypesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListActionTypesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListActionTypesOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `actionTypes`
      List.validateJsonElement(jsonObj.get("actionTypes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListActionTypesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListActionTypesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListActionTypesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListActionTypesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListActionTypesOutput>() {
           @Override
           public void write(JsonWriter out, ListActionTypesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListActionTypesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListActionTypesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListActionTypesOutput
   * @throws IOException if the JSON string is invalid with respect to ListActionTypesOutput
   */
  public static ListActionTypesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListActionTypesOutput.class);
  }

  /**
   * Convert an instance of ListActionTypesOutput to an JSON string
   *
   * @return JSON string
   */
