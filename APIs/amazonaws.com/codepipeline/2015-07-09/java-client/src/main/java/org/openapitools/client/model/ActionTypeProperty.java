...
public class ActionTypeProperty {
  ...
  public ActionTypeProperty() {
  }

  public ActionTypeProperty name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ActionTypeProperty optional(Boolean optional) {
  ...
  public ActionTypeProperty key(Boolean key) {
    this.key = key;
    return this;
  }
  ...
  public ActionTypeProperty noEcho(Boolean noEcho) {
    this.noEcho = noEcho;
    return this;
  }
  ...
  public ActionTypeProperty queryable(Boolean queryable) {
  ...
  public ActionTypeProperty description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    ActionTypeProperty actionTypeProperty = (ActionTypeProperty) o;
    return Objects.equals(this.name, actionTypeProperty.name) &&
        Objects.equals(this.optional, actionTypeProperty.optional) &&
        Objects.equals(this.key, actionTypeProperty.key) &&
        Objects.equals(this.noEcho, actionTypeProperty.noEcho) &&
        Objects.equals(this.queryable, actionTypeProperty.queryable) &&
        Objects.equals(this.description, actionTypeProperty.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, optional, key, noEcho, queryable, description);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ActionTypeProperty {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("noEcho");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionTypeProperty
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionTypeProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionTypeProperty is not found in the empty JSON string", ActionTypeProperty.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionTypeProperty.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionTypeProperty` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionTypeProperty.openapiRequiredFields) {
      ...
      // validate the required field `optional`
      ...
      // validate the required field `noEcho`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionTypeProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionTypeProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionTypeProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionTypeProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionTypeProperty>() {
           @Override
           public void write(JsonWriter out, ActionTypeProperty value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionTypeProperty read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionTypeProperty given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionTypeProperty
   * @throws IOException if the JSON string is invalid with respect to ActionTypeProperty
   */
  public static ActionTypeProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionTypeProperty.class);
  }

  /**
   * Convert an instance of ActionTypeProperty to an JSON string
   *
   * @return JSON string
   */
