...
public class UpdateActionTypeInputActionType {
  ...
  public UpdateActionTypeInputActionType() {
  }

  public UpdateActionTypeInputActionType description(String description) {
  ...
  public UpdateActionTypeInputActionType executor(ActionTypeDeclarationExecutor executor) {
  ...
  public UpdateActionTypeInputActionType id(ActionTypeDeclarationId id) {
    this.id = id;
    return this;
  }
  ...
  public UpdateActionTypeInputActionType inputArtifactDetails(ActionTypeDeclarationInputArtifactDetails inputArtifactDetails) {
  ...
  public UpdateActionTypeInputActionType outputArtifactDetails(ActionTypeDeclarationOutputArtifactDetails outputArtifactDetails) {
  ...
  public UpdateActionTypeInputActionType permissions(ActionTypeDeclarationPermissions permissions) {
  ...
  public UpdateActionTypeInputActionType properties(Object properties) {
  ...
  public UpdateActionTypeInputActionType urls(ActionTypeDeclarationUrls urls) {
    this.urls = urls;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateActionTypeInputActionType updateActionTypeInputActionType = (UpdateActionTypeInputActionType) o;
    return Objects.equals(this.description, updateActionTypeInputActionType.description) &&
        Objects.equals(this.executor, updateActionTypeInputActionType.executor) &&
        Objects.equals(this.id, updateActionTypeInputActionType.id) &&
        Objects.equals(this.inputArtifactDetails, updateActionTypeInputActionType.inputArtifactDetails) &&
        Objects.equals(this.outputArtifactDetails, updateActionTypeInputActionType.outputArtifactDetails) &&
        Objects.equals(this.permissions, updateActionTypeInputActionType.permissions) &&
        Objects.equals(this.properties, updateActionTypeInputActionType.properties) &&
        Objects.equals(this.urls, updateActionTypeInputActionType.urls);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateActionTypeInputActionType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateActionTypeInputActionType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateActionTypeInputActionType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateActionTypeInputActionType is not found in the empty JSON string", UpdateActionTypeInputActionType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateActionTypeInputActionType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateActionTypeInputActionType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateActionTypeInputActionType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateActionTypeInputActionType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateActionTypeInputActionType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateActionTypeInputActionType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateActionTypeInputActionType.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateActionTypeInputActionType>() {
           @Override
           public void write(JsonWriter out, UpdateActionTypeInputActionType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateActionTypeInputActionType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateActionTypeInputActionType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateActionTypeInputActionType
   * @throws IOException if the JSON string is invalid with respect to UpdateActionTypeInputActionType
   */
  public static UpdateActionTypeInputActionType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateActionTypeInputActionType.class);
  }

  /**
   * Convert an instance of UpdateActionTypeInputActionType to an JSON string
   *
   * @return JSON string
   */
