...
public class ActionTypeDeclarationUrls {
  ...
  public ActionTypeDeclarationUrls() {
  }

  public ActionTypeDeclarationUrls configurationUrl(String configurationUrl) {
  ...
  public ActionTypeDeclarationUrls entityUrlTemplate(String entityUrlTemplate) {
  ...
  public ActionTypeDeclarationUrls executionUrlTemplate(String executionUrlTemplate) {
  ...
  public ActionTypeDeclarationUrls revisionUrlTemplate(String revisionUrlTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    ActionTypeDeclarationUrls actionTypeDeclarationUrls = (ActionTypeDeclarationUrls) o;
    return Objects.equals(this.configurationUrl, actionTypeDeclarationUrls.configurationUrl) &&
        Objects.equals(this.entityUrlTemplate, actionTypeDeclarationUrls.entityUrlTemplate) &&
        Objects.equals(this.executionUrlTemplate, actionTypeDeclarationUrls.executionUrlTemplate) &&
        Objects.equals(this.revisionUrlTemplate, actionTypeDeclarationUrls.revisionUrlTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionTypeDeclarationUrls {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionTypeDeclarationUrls
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionTypeDeclarationUrls.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionTypeDeclarationUrls is not found in the empty JSON string", ActionTypeDeclarationUrls.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionTypeDeclarationUrls.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionTypeDeclarationUrls` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionTypeDeclarationUrls.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionTypeDeclarationUrls' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionTypeDeclarationUrls> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionTypeDeclarationUrls.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionTypeDeclarationUrls>() {
           @Override
           public void write(JsonWriter out, ActionTypeDeclarationUrls value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionTypeDeclarationUrls read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionTypeDeclarationUrls given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionTypeDeclarationUrls
   * @throws IOException if the JSON string is invalid with respect to ActionTypeDeclarationUrls
   */
  public static ActionTypeDeclarationUrls fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionTypeDeclarationUrls.class);
  }

  /**
   * Convert an instance of ActionTypeDeclarationUrls to an JSON string
   *
   * @return JSON string
   */
