...
public class AcknowledgeThirdPartyJobOutput {
  ...
  public AcknowledgeThirdPartyJobOutput status(JobStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AcknowledgeThirdPartyJobOutput acknowledgeThirdPartyJobOutput = (AcknowledgeThirdPartyJobOutput) o;
    return Objects.equals(this.status, acknowledgeThirdPartyJobOutput.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class AcknowledgeThirdPartyJobOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AcknowledgeThirdPartyJobOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AcknowledgeThirdPartyJobOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AcknowledgeThirdPartyJobOutput is not found in the empty JSON string", AcknowledgeThirdPartyJobOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AcknowledgeThirdPartyJobOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AcknowledgeThirdPartyJobOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AcknowledgeThirdPartyJobOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AcknowledgeThirdPartyJobOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AcknowledgeThirdPartyJobOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AcknowledgeThirdPartyJobOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<AcknowledgeThirdPartyJobOutput>() {
           @Override
           public void write(JsonWriter out, AcknowledgeThirdPartyJobOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AcknowledgeThirdPartyJobOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AcknowledgeThirdPartyJobOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AcknowledgeThirdPartyJobOutput
   * @throws IOException if the JSON string is invalid with respect to AcknowledgeThirdPartyJobOutput
   */
  public static AcknowledgeThirdPartyJobOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AcknowledgeThirdPartyJobOutput.class);
  }

  /**
   * Convert an instance of AcknowledgeThirdPartyJobOutput to an JSON string
   *
   * @return JSON string
   */
