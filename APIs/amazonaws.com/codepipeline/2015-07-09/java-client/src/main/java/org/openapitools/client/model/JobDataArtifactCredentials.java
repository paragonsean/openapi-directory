...
public class JobDataArtifactCredentials {
  ...
  public JobDataArtifactCredentials() {
  }

  public JobDataArtifactCredentials accessKeyId(String accessKeyId) {
  ...
  public JobDataArtifactCredentials secretAccessKey(String secretAccessKey) {
  ...
  public JobDataArtifactCredentials sessionToken(String sessionToken) {
  ...
  public boolean equals(Object o) {
    ...
    JobDataArtifactCredentials jobDataArtifactCredentials = (JobDataArtifactCredentials) o;
    return Objects.equals(this.accessKeyId, jobDataArtifactCredentials.accessKeyId) &&
        Objects.equals(this.secretAccessKey, jobDataArtifactCredentials.secretAccessKey) &&
        Objects.equals(this.sessionToken, jobDataArtifactCredentials.sessionToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobDataArtifactCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobDataArtifactCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobDataArtifactCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobDataArtifactCredentials is not found in the empty JSON string", JobDataArtifactCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobDataArtifactCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobDataArtifactCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JobDataArtifactCredentials.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobDataArtifactCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobDataArtifactCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobDataArtifactCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobDataArtifactCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<JobDataArtifactCredentials>() {
           @Override
           public void write(JsonWriter out, JobDataArtifactCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobDataArtifactCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobDataArtifactCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobDataArtifactCredentials
   * @throws IOException if the JSON string is invalid with respect to JobDataArtifactCredentials
   */
  public static JobDataArtifactCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobDataArtifactCredentials.class);
  }

  /**
   * Convert an instance of JobDataArtifactCredentials to an JSON string
   *
   * @return JSON string
   */
