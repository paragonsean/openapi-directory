...
public class ThirdPartyJobDataArtifactCredentials {
  ...
  public ThirdPartyJobDataArtifactCredentials() {
  }

  public ThirdPartyJobDataArtifactCredentials accessKeyId(String accessKeyId) {
  ...
  public ThirdPartyJobDataArtifactCredentials secretAccessKey(String secretAccessKey) {
  ...
  public ThirdPartyJobDataArtifactCredentials sessionToken(String sessionToken) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyJobDataArtifactCredentials thirdPartyJobDataArtifactCredentials = (ThirdPartyJobDataArtifactCredentials) o;
    return Objects.equals(this.accessKeyId, thirdPartyJobDataArtifactCredentials.accessKeyId) &&
        Objects.equals(this.secretAccessKey, thirdPartyJobDataArtifactCredentials.secretAccessKey) &&
        Objects.equals(this.sessionToken, thirdPartyJobDataArtifactCredentials.sessionToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ThirdPartyJobDataArtifactCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ThirdPartyJobDataArtifactCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ThirdPartyJobDataArtifactCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyJobDataArtifactCredentials is not found in the empty JSON string", ThirdPartyJobDataArtifactCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ThirdPartyJobDataArtifactCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ThirdPartyJobDataArtifactCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyJobDataArtifactCredentials.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyJobDataArtifactCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyJobDataArtifactCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyJobDataArtifactCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyJobDataArtifactCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyJobDataArtifactCredentials>() {
           @Override
           public void write(JsonWriter out, ThirdPartyJobDataArtifactCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ThirdPartyJobDataArtifactCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ThirdPartyJobDataArtifactCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ThirdPartyJobDataArtifactCredentials
   * @throws IOException if the JSON string is invalid with respect to ThirdPartyJobDataArtifactCredentials
   */
  public static ThirdPartyJobDataArtifactCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyJobDataArtifactCredentials.class);
  }

  /**
   * Convert an instance of ThirdPartyJobDataArtifactCredentials to an JSON string
   *
   * @return JSON string
   */
