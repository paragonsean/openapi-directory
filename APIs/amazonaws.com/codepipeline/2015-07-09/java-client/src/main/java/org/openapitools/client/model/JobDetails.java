...
public class JobDetails {
  ...
  public JobDetails data(JobDetailsData data) {
    this.data = data;
    return this;
  }
  ...
  public JobDetails accountId(String accountId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, jobDetails.id) &&
        Objects.equals(this.data, jobDetails.data) &&
        Objects.equals(this.accountId, jobDetails.accountId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, data, accountId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        JobDetailsData.validateJsonElement(jsonObj.get("data"));
      }
