...
public class GetActionTypeOutput {
  ...
  private GetActionTypeOutputActionType actionType;

  public GetActionTypeOutput() {
  }

  public GetActionTypeOutput actionType(GetActionTypeOutputActionType actionType) {
  ...
  public GetActionTypeOutputActionType getActionType() {
    return actionType;
  }

  public void setActionType(GetActionTypeOutputActionType actionType) {
    this.actionType = actionType;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetActionTypeOutput getActionTypeOutput = (GetActionTypeOutput) o;
    return Objects.equals(this.actionType, getActionTypeOutput.actionType);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetActionTypeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetActionTypeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetActionTypeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetActionTypeOutput is not found in the empty JSON string", GetActionTypeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetActionTypeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetActionTypeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `actionType`
      if (jsonObj.get("actionType") != null && !jsonObj.get("actionType").isJsonNull()) {
        GetActionTypeOutputActionType.validateJsonElement(jsonObj.get("actionType"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetActionTypeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetActionTypeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetActionTypeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetActionTypeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetActionTypeOutput>() {
           @Override
           public void write(JsonWriter out, GetActionTypeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetActionTypeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetActionTypeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetActionTypeOutput
   * @throws IOException if the JSON string is invalid with respect to GetActionTypeOutput
   */
  public static GetActionTypeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetActionTypeOutput.class);
  }

  /**
   * Convert an instance of GetActionTypeOutput to an JSON string
   *
   * @return JSON string
   */
