...
public class OutputArtifact {
  ...
  public OutputArtifact name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OutputArtifact outputArtifact = (OutputArtifact) o;
    return Objects.equals(this.name, outputArtifact.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class OutputArtifact {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OutputArtifact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OutputArtifact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OutputArtifact is not found in the empty JSON string", OutputArtifact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OutputArtifact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OutputArtifact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OutputArtifact.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OutputArtifact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OutputArtifact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OutputArtifact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OutputArtifact.class));

       return (TypeAdapter<T>) new TypeAdapter<OutputArtifact>() {
           @Override
           public void write(JsonWriter out, OutputArtifact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OutputArtifact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OutputArtifact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OutputArtifact
   * @throws IOException if the JSON string is invalid with respect to OutputArtifact
   */
  public static OutputArtifact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OutputArtifact.class);
  }

  /**
   * Convert an instance of OutputArtifact to an JSON string
   *
   * @return JSON string
   */
