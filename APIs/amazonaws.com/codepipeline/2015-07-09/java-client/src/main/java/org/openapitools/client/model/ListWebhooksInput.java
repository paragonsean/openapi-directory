...
public class ListWebhooksInput {
  ...
  public ListWebhooksInput nextToken(String nextToken) {
  ...
  public ListWebhooksInput maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListWebhooksInput listWebhooksInput = (ListWebhooksInput) o;
    return Objects.equals(this.nextToken, listWebhooksInput.nextToken) &&
        Objects.equals(this.maxResults, listWebhooksInput.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListWebhooksInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListWebhooksInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListWebhooksInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListWebhooksInput is not found in the empty JSON string", ListWebhooksInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListWebhooksInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListWebhooksInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListWebhooksInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListWebhooksInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListWebhooksInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListWebhooksInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListWebhooksInput>() {
           @Override
           public void write(JsonWriter out, ListWebhooksInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListWebhooksInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListWebhooksInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListWebhooksInput
   * @throws IOException if the JSON string is invalid with respect to ListWebhooksInput
   */
  public static ListWebhooksInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListWebhooksInput.class);
  }

  /**
   * Convert an instance of ListWebhooksInput to an JSON string
   *
   * @return JSON string
   */
