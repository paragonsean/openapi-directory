...
public class ListPipelinesOutput {
  ...
  public ListPipelinesOutput pipelines(List pipelines) {
  ...
  public ListPipelinesOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListPipelinesOutput listPipelinesOutput = (ListPipelinesOutput) o;
    return Objects.equals(this.pipelines, listPipelinesOutput.pipelines) &&
        Objects.equals(this.nextToken, listPipelinesOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelines, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListPipelinesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPipelinesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPipelinesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPipelinesOutput is not found in the empty JSON string", ListPipelinesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPipelinesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPipelinesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPipelinesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPipelinesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPipelinesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPipelinesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPipelinesOutput>() {
           @Override
           public void write(JsonWriter out, ListPipelinesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPipelinesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPipelinesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPipelinesOutput
   * @throws IOException if the JSON string is invalid with respect to ListPipelinesOutput
   */
  public static ListPipelinesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPipelinesOutput.class);
  }

  /**
   * Convert an instance of ListPipelinesOutput to an JSON string
   *
   * @return JSON string
   */
