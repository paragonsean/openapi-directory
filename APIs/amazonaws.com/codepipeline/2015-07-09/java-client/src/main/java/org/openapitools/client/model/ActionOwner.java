...
/**
 * Gets or Sets ActionOwner
 */
@JsonAdapter(ActionOwner.Adapter.class)
public enum ActionOwner {
  ...
  public static ActionOwner fromValue(String value) {
    for (ActionOwner b : ActionOwner.values()) {
  ...
  public static class Adapter extends TypeAdapter<ActionOwner> {
    @Override
    public void write(final JsonWriter jsonWriter, final ActionOwner enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ActionOwner read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ActionOwner.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ActionOwner.fromValue(value);
  }
}
