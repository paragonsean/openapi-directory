...
public class DeletePipelineInput {
  ...
  public DeletePipelineInput() {
  }

  public DeletePipelineInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeletePipelineInput deletePipelineInput = (DeletePipelineInput) o;
    return Objects.equals(this.name, deletePipelineInput.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeletePipelineInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePipelineInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePipelineInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePipelineInput is not found in the empty JSON string", DeletePipelineInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePipelineInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePipelineInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeletePipelineInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePipelineInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePipelineInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePipelineInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePipelineInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePipelineInput>() {
           @Override
           public void write(JsonWriter out, DeletePipelineInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePipelineInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePipelineInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePipelineInput
   * @throws IOException if the JSON string is invalid with respect to DeletePipelineInput
   */
  public static DeletePipelineInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePipelineInput.class);
  }

  /**
   * Convert an instance of DeletePipelineInput to an JSON string
   *
   * @return JSON string
   */
