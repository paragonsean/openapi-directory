...
public class SourceRevision {
  ...
  public SourceRevision actionName(String actionName) {
  ...
  public SourceRevision revisionId(String revisionId) {
  ...
  public SourceRevision revisionSummary(String revisionSummary) {
  ...
  public SourceRevision revisionUrl(String revisionUrl) {
  ...
  public boolean equals(Object o) {
    ...
    SourceRevision sourceRevision = (SourceRevision) o;
    return Objects.equals(this.actionName, sourceRevision.actionName) &&
        Objects.equals(this.revisionId, sourceRevision.revisionId) &&
        Objects.equals(this.revisionSummary, sourceRevision.revisionSummary) &&
        Objects.equals(this.revisionUrl, sourceRevision.revisionUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actionName, revisionId, revisionSummary, revisionUrl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SourceRevision {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SourceRevision
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SourceRevision.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SourceRevision is not found in the empty JSON string", SourceRevision.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SourceRevision.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SourceRevision` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SourceRevision.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SourceRevision.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SourceRevision' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SourceRevision> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SourceRevision.class));

       return (TypeAdapter<T>) new TypeAdapter<SourceRevision>() {
           @Override
           public void write(JsonWriter out, SourceRevision value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SourceRevision read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SourceRevision given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SourceRevision
   * @throws IOException if the JSON string is invalid with respect to SourceRevision
   */
  public static SourceRevision fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SourceRevision.class);
  }

  /**
   * Convert an instance of SourceRevision to an JSON string
   *
   * @return JSON string
   */
