...
/**
 * Gets or Sets StageExecutionStatus
 */
@JsonAdapter(StageExecutionStatus.Adapter.class)
public enum StageExecutionStatus {
  ...
  StageExecutionStatus(String value) {
    this.value = value;
  }
  ...
  public static StageExecutionStatus fromValue(String value) {
    for (StageExecutionStatus b : StageExecutionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<StageExecutionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final StageExecutionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StageExecutionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StageExecutionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StageExecutionStatus.fromValue(value);
  }
}
