...
public class StopPipelineExecutionOutput {
  ...
  public StopPipelineExecutionOutput pipelineExecutionId(String pipelineExecutionId) {
  ...
  public boolean equals(Object o) {
    ...
    StopPipelineExecutionOutput stopPipelineExecutionOutput = (StopPipelineExecutionOutput) o;
    return Objects.equals(this.pipelineExecutionId, stopPipelineExecutionOutput.pipelineExecutionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineExecutionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StopPipelineExecutionOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopPipelineExecutionOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopPipelineExecutionOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopPipelineExecutionOutput is not found in the empty JSON string", StopPipelineExecutionOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopPipelineExecutionOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopPipelineExecutionOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopPipelineExecutionOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopPipelineExecutionOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopPipelineExecutionOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopPipelineExecutionOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<StopPipelineExecutionOutput>() {
           @Override
           public void write(JsonWriter out, StopPipelineExecutionOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopPipelineExecutionOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopPipelineExecutionOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopPipelineExecutionOutput
   * @throws IOException if the JSON string is invalid with respect to StopPipelineExecutionOutput
   */
  public static StopPipelineExecutionOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopPipelineExecutionOutput.class);
  }

  /**
   * Convert an instance of StopPipelineExecutionOutput to an JSON string
   *
   * @return JSON string
   */
