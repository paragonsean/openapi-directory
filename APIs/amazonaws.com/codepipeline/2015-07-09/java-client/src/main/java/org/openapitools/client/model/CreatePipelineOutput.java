...
public class CreatePipelineOutput {
  ...
  public CreatePipelineOutput pipeline(CreatePipelineOutputPipeline pipeline) {
  ...
  public CreatePipelineOutput tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreatePipelineOutput createPipelineOutput = (CreatePipelineOutput) o;
    return Objects.equals(this.pipeline, createPipelineOutput.pipeline) &&
        Objects.equals(this.tags, createPipelineOutput.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePipelineOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePipelineOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePipelineOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePipelineOutput is not found in the empty JSON string", CreatePipelineOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePipelineOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePipelineOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePipelineOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePipelineOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePipelineOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePipelineOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePipelineOutput>() {
           @Override
           public void write(JsonWriter out, CreatePipelineOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePipelineOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePipelineOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePipelineOutput
   * @throws IOException if the JSON string is invalid with respect to CreatePipelineOutput
   */
  public static CreatePipelineOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePipelineOutput.class);
  }

  /**
   * Convert an instance of CreatePipelineOutput to an JSON string
   *
   * @return JSON string
   */
