...
import org.openapitools.client.model.ActionExecutionOutputExecutionResult;
...
public class ActionExecutionDetailOutput {
  ...
  private ActionExecutionOutputExecutionResult executionResult;
  ...
  public ActionExecutionDetailOutput() {
  }

  public ActionExecutionDetailOutput outputArtifacts(List outputArtifacts) {
  ...
  public ActionExecutionDetailOutput executionResult(ActionExecutionOutputExecutionResult executionResult) {
   ...
   */
  @javax.annotation.Nullable
  public ActionExecutionOutputExecutionResult getExecutionResult() {
    return executionResult;
  }

  public void setExecutionResult(ActionExecutionOutputExecutionResult executionResult) {
    this.executionResult = executionResult;
  }


  public ActionExecutionDetailOutput outputVariables(Map outputVariables) {
  ...
  public boolean equals(Object o) {
    ...
    ActionExecutionDetailOutput actionExecutionDetailOutput = (ActionExecutionDetailOutput) o;
    return Objects.equals(this.outputArtifacts, actionExecutionDetailOutput.outputArtifacts) &&
        Objects.equals(this.executionResult, actionExecutionDetailOutput.executionResult) &&
        Objects.equals(this.outputVariables, actionExecutionDetailOutput.outputVariables);
  }

  @Override
  public int hashCode() {
    return Objects.hash(outputArtifacts, executionResult, outputVariables);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ActionExecutionDetailOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionExecutionDetailOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionExecutionDetailOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionExecutionDetailOutput is not found in the empty JSON string", ActionExecutionDetailOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionExecutionDetailOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionExecutionDetailOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("executionResult") != null && !jsonObj.get("executionResult").isJsonNull()) {
        ActionExecutionOutputExecutionResult.validateJsonElement(jsonObj.get("executionResult"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionExecutionDetailOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionExecutionDetailOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionExecutionDetailOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionExecutionDetailOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionExecutionDetailOutput>() {
           @Override
           public void write(JsonWriter out, ActionExecutionDetailOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionExecutionDetailOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionExecutionDetailOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionExecutionDetailOutput
   * @throws IOException if the JSON string is invalid with respect to ActionExecutionDetailOutput
   */
  public static ActionExecutionDetailOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionExecutionDetailOutput.class);
  }

  /**
   * Convert an instance of ActionExecutionDetailOutput to an JSON string
   *
   * @return JSON string
   */
