...
public class ActionConfiguration {
  ...
  public ActionConfiguration _configuration(Map _configuration) {
  ...
  public boolean equals(Object o) {
    ...
    ActionConfiguration actionConfiguration = (ActionConfiguration) o;
    return Objects.equals(this._configuration, actionConfiguration._configuration);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionConfiguration is not found in the empty JSON string", ActionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionConfiguration>() {
           @Override
           public void write(JsonWriter out, ActionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionConfiguration
   * @throws IOException if the JSON string is invalid with respect to ActionConfiguration
   */
  public static ActionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionConfiguration.class);
  }

  /**
   * Convert an instance of ActionConfiguration to an JSON string
   *
   * @return JSON string
   */
