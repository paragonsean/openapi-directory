...
public class PutWebhookOutput {
  ...
  private PutWebhookOutputWebhook webhook;

  public PutWebhookOutput() {
  }

  public PutWebhookOutput webhook(PutWebhookOutputWebhook webhook) {
  ...
  public PutWebhookOutputWebhook getWebhook() {
    return webhook;
  }

  public void setWebhook(PutWebhookOutputWebhook webhook) {
    this.webhook = webhook;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutWebhookOutput putWebhookOutput = (PutWebhookOutput) o;
    return Objects.equals(this.webhook, putWebhookOutput.webhook);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutWebhookOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutWebhookOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutWebhookOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutWebhookOutput is not found in the empty JSON string", PutWebhookOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutWebhookOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutWebhookOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `webhook`
      if (jsonObj.get("webhook") != null && !jsonObj.get("webhook").isJsonNull()) {
        PutWebhookOutputWebhook.validateJsonElement(jsonObj.get("webhook"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutWebhookOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutWebhookOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutWebhookOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutWebhookOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutWebhookOutput>() {
           @Override
           public void write(JsonWriter out, PutWebhookOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutWebhookOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutWebhookOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutWebhookOutput
   * @throws IOException if the JSON string is invalid with respect to PutWebhookOutput
   */
  public static PutWebhookOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutWebhookOutput.class);
  }

  /**
   * Convert an instance of PutWebhookOutput to an JSON string
   *
   * @return JSON string
   */
