...
public class CreateCustomActionTypeInputInputArtifactDetails {
  ...
  public CreateCustomActionTypeInputInputArtifactDetails() {
  }

  public CreateCustomActionTypeInputInputArtifactDetails minimumCount(Integer minimumCount) {
  ...
  public CreateCustomActionTypeInputInputArtifactDetails maximumCount(Integer maximumCount) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCustomActionTypeInputInputArtifactDetails createCustomActionTypeInputInputArtifactDetails = (CreateCustomActionTypeInputInputArtifactDetails) o;
    return Objects.equals(this.minimumCount, createCustomActionTypeInputInputArtifactDetails.minimumCount) &&
        Objects.equals(this.maximumCount, createCustomActionTypeInputInputArtifactDetails.maximumCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateCustomActionTypeInputInputArtifactDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCustomActionTypeInputInputArtifactDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCustomActionTypeInputInputArtifactDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCustomActionTypeInputInputArtifactDetails is not found in the empty JSON string", CreateCustomActionTypeInputInputArtifactDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCustomActionTypeInputInputArtifactDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCustomActionTypeInputInputArtifactDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCustomActionTypeInputInputArtifactDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCustomActionTypeInputInputArtifactDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCustomActionTypeInputInputArtifactDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCustomActionTypeInputInputArtifactDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCustomActionTypeInputInputArtifactDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCustomActionTypeInputInputArtifactDetails>() {
           @Override
           public void write(JsonWriter out, CreateCustomActionTypeInputInputArtifactDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCustomActionTypeInputInputArtifactDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCustomActionTypeInputInputArtifactDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCustomActionTypeInputInputArtifactDetails
   * @throws IOException if the JSON string is invalid with respect to CreateCustomActionTypeInputInputArtifactDetails
   */
  public static CreateCustomActionTypeInputInputArtifactDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCustomActionTypeInputInputArtifactDetails.class);
  }

  /**
   * Convert an instance of CreateCustomActionTypeInputInputArtifactDetails to an JSON string
   *
   * @return JSON string
   */
