...
public class PipelineContextAction {
  ...
  public PipelineContextAction() {
  }

  public PipelineContextAction name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PipelineContextAction actionExecutionId(String actionExecutionId) {
  ...
  public boolean equals(Object o) {
    ...
    PipelineContextAction pipelineContextAction = (PipelineContextAction) o;
    return Objects.equals(this.name, pipelineContextAction.name) &&
        Objects.equals(this.actionExecutionId, pipelineContextAction.actionExecutionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, actionExecutionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PipelineContextAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PipelineContextAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipelineContextAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipelineContextAction is not found in the empty JSON string", PipelineContextAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipelineContextAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PipelineContextAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipelineContextAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipelineContextAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipelineContextAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipelineContextAction.class));

       return (TypeAdapter<T>) new TypeAdapter<PipelineContextAction>() {
           @Override
           public void write(JsonWriter out, PipelineContextAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PipelineContextAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PipelineContextAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PipelineContextAction
   * @throws IOException if the JSON string is invalid with respect to PipelineContextAction
   */
  public static PipelineContextAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipelineContextAction.class);
  }

  /**
   * Convert an instance of PipelineContextAction to an JSON string
   *
   * @return JSON string
   */
