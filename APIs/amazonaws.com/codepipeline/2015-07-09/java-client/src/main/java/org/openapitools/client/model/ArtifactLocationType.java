...
/**
 * Gets or Sets ArtifactLocationType
 */
@JsonAdapter(ArtifactLocationType.Adapter.class)
public enum ArtifactLocationType {
  ...
  ArtifactLocationType(String value) {
    this.value = value;
  }
  ...
  public static ArtifactLocationType fromValue(String value) {
    for (ArtifactLocationType b : ArtifactLocationType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ArtifactLocationType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ArtifactLocationType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ArtifactLocationType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ArtifactLocationType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ArtifactLocationType.fromValue(value);
  }
}
