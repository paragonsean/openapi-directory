...
import org.openapitools.client.model.UpdatePipelineOutputPipeline;
...
public class UpdatePipelineOutput {
  ...
  private UpdatePipelineOutputPipeline pipeline;

  public UpdatePipelineOutput() {
  }

  public UpdatePipelineOutput pipeline(UpdatePipelineOutputPipeline pipeline) {
  ...
  public UpdatePipelineOutputPipeline getPipeline() {
    return pipeline;
  }

  public void setPipeline(UpdatePipelineOutputPipeline pipeline) {
    this.pipeline = pipeline;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePipelineOutput updatePipelineOutput = (UpdatePipelineOutput) o;
    return Objects.equals(this.pipeline, updatePipelineOutput.pipeline);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePipelineOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePipelineOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePipelineOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePipelineOutput is not found in the empty JSON string", UpdatePipelineOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePipelineOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePipelineOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `pipeline`
      if (jsonObj.get("pipeline") != null && !jsonObj.get("pipeline").isJsonNull()) {
        UpdatePipelineOutputPipeline.validateJsonElement(jsonObj.get("pipeline"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePipelineOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePipelineOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePipelineOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePipelineOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePipelineOutput>() {
           @Override
           public void write(JsonWriter out, UpdatePipelineOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePipelineOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePipelineOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePipelineOutput
   * @throws IOException if the JSON string is invalid with respect to UpdatePipelineOutput
   */
  public static UpdatePipelineOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePipelineOutput.class);
  }

  /**
   * Convert an instance of UpdatePipelineOutput to an JSON string
   *
   * @return JSON string
   */
