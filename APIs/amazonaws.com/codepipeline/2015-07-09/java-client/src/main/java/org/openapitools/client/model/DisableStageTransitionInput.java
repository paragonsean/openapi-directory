...
import org.openapitools.client.model.StageTransitionType;
...
public class DisableStageTransitionInput {
  ...
  public DisableStageTransitionInput() {
  }

  public DisableStageTransitionInput pipelineName(String pipelineName) {
  ...
  public DisableStageTransitionInput stageName(String stageName) {
  ...
  public DisableStageTransitionInput transitionType(StageTransitionType transitionType) {
   ...
   */
  @javax.annotation.Nonnull
  public StageTransitionType getTransitionType() {
    return transitionType;
  }
  ...
  public DisableStageTransitionInput reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DisableStageTransitionInput disableStageTransitionInput = (DisableStageTransitionInput) o;
    return Objects.equals(this.pipelineName, disableStageTransitionInput.pipelineName) &&
        Objects.equals(this.stageName, disableStageTransitionInput.stageName) &&
        Objects.equals(this.transitionType, disableStageTransitionInput.transitionType) &&
        Objects.equals(this.reason, disableStageTransitionInput.reason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineName, stageName, transitionType, reason);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DisableStageTransitionInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisableStageTransitionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisableStageTransitionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisableStageTransitionInput is not found in the empty JSON string", DisableStageTransitionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisableStageTransitionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisableStageTransitionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisableStageTransitionInput.openapiRequiredFields) {
      ...
      StageTransitionType.validateJsonElement(jsonObj.get("transitionType"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisableStageTransitionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisableStageTransitionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisableStageTransitionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisableStageTransitionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DisableStageTransitionInput>() {
           @Override
           public void write(JsonWriter out, DisableStageTransitionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisableStageTransitionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisableStageTransitionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisableStageTransitionInput
   * @throws IOException if the JSON string is invalid with respect to DisableStageTransitionInput
   */
  public static DisableStageTransitionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisableStageTransitionInput.class);
  }

  /**
   * Convert an instance of DisableStageTransitionInput to an JSON string
   *
   * @return JSON string
   */
