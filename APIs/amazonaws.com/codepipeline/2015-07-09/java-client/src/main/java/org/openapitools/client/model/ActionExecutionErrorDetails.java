...
public class ActionExecutionErrorDetails {
  ...
  public ActionExecutionErrorDetails() {
  }

  public ActionExecutionErrorDetails code(String code) {
    this.code = code;
    return this;
  }
  ...
  public ActionExecutionErrorDetails message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    ActionExecutionErrorDetails actionExecutionErrorDetails = (ActionExecutionErrorDetails) o;
    return Objects.equals(this.code, actionExecutionErrorDetails.code) &&
        Objects.equals(this.message, actionExecutionErrorDetails.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionExecutionErrorDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionExecutionErrorDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionExecutionErrorDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionExecutionErrorDetails is not found in the empty JSON string", ActionExecutionErrorDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionExecutionErrorDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionExecutionErrorDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionExecutionErrorDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionExecutionErrorDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionExecutionErrorDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionExecutionErrorDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionExecutionErrorDetails>() {
           @Override
           public void write(JsonWriter out, ActionExecutionErrorDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionExecutionErrorDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionExecutionErrorDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionExecutionErrorDetails
   * @throws IOException if the JSON string is invalid with respect to ActionExecutionErrorDetails
   */
  public static ActionExecutionErrorDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionExecutionErrorDetails.class);
  }

  /**
   * Convert an instance of ActionExecutionErrorDetails to an JSON string
   *
   * @return JSON string
   */
