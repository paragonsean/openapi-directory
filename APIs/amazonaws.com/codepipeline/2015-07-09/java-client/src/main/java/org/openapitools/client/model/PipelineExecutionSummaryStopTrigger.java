...
public class PipelineExecutionSummaryStopTrigger {
  public static final String SERIALIZED_NAME_REASON = "reason";
  @SerializedName(SERIALIZED_NAME_REASON)
  private String reason;

  public PipelineExecutionSummaryStopTrigger() {
  }

  public PipelineExecutionSummaryStopTrigger reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PipelineExecutionSummaryStopTrigger pipelineExecutionSummaryStopTrigger = (PipelineExecutionSummaryStopTrigger) o;
    return Objects.equals(this.reason, pipelineExecutionSummaryStopTrigger.reason);
  }
  ...
  public String toString() {
    ...
    sb.append("class PipelineExecutionSummaryStopTrigger {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PipelineExecutionSummaryStopTrigger
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipelineExecutionSummaryStopTrigger.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipelineExecutionSummaryStopTrigger is not found in the empty JSON string", PipelineExecutionSummaryStopTrigger.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipelineExecutionSummaryStopTrigger.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PipelineExecutionSummaryStopTrigger` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipelineExecutionSummaryStopTrigger.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipelineExecutionSummaryStopTrigger' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipelineExecutionSummaryStopTrigger> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipelineExecutionSummaryStopTrigger.class));

       return (TypeAdapter<T>) new TypeAdapter<PipelineExecutionSummaryStopTrigger>() {
           @Override
           public void write(JsonWriter out, PipelineExecutionSummaryStopTrigger value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PipelineExecutionSummaryStopTrigger read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PipelineExecutionSummaryStopTrigger given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PipelineExecutionSummaryStopTrigger
   * @throws IOException if the JSON string is invalid with respect to PipelineExecutionSummaryStopTrigger
   */
  public static PipelineExecutionSummaryStopTrigger fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipelineExecutionSummaryStopTrigger.class);
  }

  /**
   * Convert an instance of PipelineExecutionSummaryStopTrigger to an JSON string
   *
   * @return JSON string
   */
