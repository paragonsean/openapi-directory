...
public class ActionTypeDeclarationOutputArtifactDetails {
  ...
  public ActionTypeDeclarationOutputArtifactDetails() {
  }

  public ActionTypeDeclarationOutputArtifactDetails minimumCount(Integer minimumCount) {
  ...
  public ActionTypeDeclarationOutputArtifactDetails maximumCount(Integer maximumCount) {
  ...
  public boolean equals(Object o) {
    ...
    ActionTypeDeclarationOutputArtifactDetails actionTypeDeclarationOutputArtifactDetails = (ActionTypeDeclarationOutputArtifactDetails) o;
    return Objects.equals(this.minimumCount, actionTypeDeclarationOutputArtifactDetails.minimumCount) &&
        Objects.equals(this.maximumCount, actionTypeDeclarationOutputArtifactDetails.maximumCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionTypeDeclarationOutputArtifactDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionTypeDeclarationOutputArtifactDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionTypeDeclarationOutputArtifactDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionTypeDeclarationOutputArtifactDetails is not found in the empty JSON string", ActionTypeDeclarationOutputArtifactDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionTypeDeclarationOutputArtifactDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionTypeDeclarationOutputArtifactDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionTypeDeclarationOutputArtifactDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionTypeDeclarationOutputArtifactDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionTypeDeclarationOutputArtifactDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionTypeDeclarationOutputArtifactDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionTypeDeclarationOutputArtifactDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionTypeDeclarationOutputArtifactDetails>() {
           @Override
           public void write(JsonWriter out, ActionTypeDeclarationOutputArtifactDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionTypeDeclarationOutputArtifactDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionTypeDeclarationOutputArtifactDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionTypeDeclarationOutputArtifactDetails
   * @throws IOException if the JSON string is invalid with respect to ActionTypeDeclarationOutputArtifactDetails
   */
  public static ActionTypeDeclarationOutputArtifactDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionTypeDeclarationOutputArtifactDetails.class);
  }

  /**
   * Convert an instance of ActionTypeDeclarationOutputArtifactDetails to an JSON string
   *
   * @return JSON string
   */
