...
public class ActionTypeUrls {
  public static final String SERIALIZED_NAME_CONFIGURATION_URL = "configurationUrl";
  ...
  public ActionTypeUrls configurationUrl(String configurationUrl) {
  ...
  public ActionTypeUrls entityUrlTemplate(String entityUrlTemplate) {
  ...
  public ActionTypeUrls executionUrlTemplate(String executionUrlTemplate) {
  ...
  public ActionTypeUrls revisionUrlTemplate(String revisionUrlTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    ActionTypeUrls actionTypeUrls = (ActionTypeUrls) o;
    return Objects.equals(this.configurationUrl, actionTypeUrls.configurationUrl) &&
        Objects.equals(this.entityUrlTemplate, actionTypeUrls.entityUrlTemplate) &&
        Objects.equals(this.executionUrlTemplate, actionTypeUrls.executionUrlTemplate) &&
        Objects.equals(this.revisionUrlTemplate, actionTypeUrls.revisionUrlTemplate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configurationUrl, entityUrlTemplate, executionUrlTemplate, revisionUrlTemplate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ActionTypeUrls {\n");
  ...
  static {
    ...
    openapiFields.add("configurationUrl");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionTypeUrls
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionTypeUrls.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionTypeUrls is not found in the empty JSON string", ActionTypeUrls.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionTypeUrls.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionTypeUrls` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `configurationUrl`
      if (jsonObj.get("configurationUrl") != null && !jsonObj.get("configurationUrl").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("configurationUrl"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionTypeUrls.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionTypeUrls' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionTypeUrls> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionTypeUrls.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionTypeUrls>() {
           @Override
           public void write(JsonWriter out, ActionTypeUrls value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionTypeUrls read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionTypeUrls given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionTypeUrls
   * @throws IOException if the JSON string is invalid with respect to ActionTypeUrls
   */
  public static ActionTypeUrls fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionTypeUrls.class);
  }

  /**
   * Convert an instance of ActionTypeUrls to an JSON string
   *
   * @return JSON string
   */
