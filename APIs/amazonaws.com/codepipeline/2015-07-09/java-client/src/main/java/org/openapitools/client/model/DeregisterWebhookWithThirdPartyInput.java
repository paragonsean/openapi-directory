...
public class DeregisterWebhookWithThirdPartyInput {
  ...
  public DeregisterWebhookWithThirdPartyInput webhookName(String webhookName) {
  ...
  public boolean equals(Object o) {
    ...
    DeregisterWebhookWithThirdPartyInput deregisterWebhookWithThirdPartyInput = (DeregisterWebhookWithThirdPartyInput) o;
    return Objects.equals(this.webhookName, deregisterWebhookWithThirdPartyInput.webhookName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(webhookName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeregisterWebhookWithThirdPartyInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeregisterWebhookWithThirdPartyInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeregisterWebhookWithThirdPartyInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeregisterWebhookWithThirdPartyInput is not found in the empty JSON string", DeregisterWebhookWithThirdPartyInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeregisterWebhookWithThirdPartyInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeregisterWebhookWithThirdPartyInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `webhookName`
      if (jsonObj.get("webhookName") != null && !jsonObj.get("webhookName").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("webhookName"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeregisterWebhookWithThirdPartyInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeregisterWebhookWithThirdPartyInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeregisterWebhookWithThirdPartyInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeregisterWebhookWithThirdPartyInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeregisterWebhookWithThirdPartyInput>() {
           @Override
           public void write(JsonWriter out, DeregisterWebhookWithThirdPartyInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeregisterWebhookWithThirdPartyInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeregisterWebhookWithThirdPartyInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeregisterWebhookWithThirdPartyInput
   * @throws IOException if the JSON string is invalid with respect to DeregisterWebhookWithThirdPartyInput
   */
  public static DeregisterWebhookWithThirdPartyInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeregisterWebhookWithThirdPartyInput.class);
  }

  /**
   * Convert an instance of DeregisterWebhookWithThirdPartyInput to an JSON string
   *
   * @return JSON string
   */
