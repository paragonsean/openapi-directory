...
public class StartPipelineExecutionInput {
  ...
  public StartPipelineExecutionInput() {
  }

  public StartPipelineExecutionInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StartPipelineExecutionInput clientRequestToken(String clientRequestToken) {
  ...
  public boolean equals(Object o) {
    ...
    StartPipelineExecutionInput startPipelineExecutionInput = (StartPipelineExecutionInput) o;
    return Objects.equals(this.name, startPipelineExecutionInput.name) &&
        Objects.equals(this.clientRequestToken, startPipelineExecutionInput.clientRequestToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartPipelineExecutionInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartPipelineExecutionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartPipelineExecutionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartPipelineExecutionInput is not found in the empty JSON string", StartPipelineExecutionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartPipelineExecutionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartPipelineExecutionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartPipelineExecutionInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartPipelineExecutionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartPipelineExecutionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartPipelineExecutionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartPipelineExecutionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<StartPipelineExecutionInput>() {
           @Override
           public void write(JsonWriter out, StartPipelineExecutionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartPipelineExecutionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartPipelineExecutionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartPipelineExecutionInput
   * @throws IOException if the JSON string is invalid with respect to StartPipelineExecutionInput
   */
  public static StartPipelineExecutionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartPipelineExecutionInput.class);
  }

  /**
   * Convert an instance of StartPipelineExecutionInput to an JSON string
   *
   * @return JSON string
   */
