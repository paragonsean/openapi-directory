...
public class ActionExecutionOutput {
  ...
  public ActionExecutionOutput outputArtifacts(List outputArtifacts) {
  ...
  public ActionExecutionOutput executionResult(ActionExecutionOutputExecutionResult executionResult) {
  ...
  public ActionExecutionOutput outputVariables(Map outputVariables) {
  ...
  public boolean equals(Object o) {
    ...
    ActionExecutionOutput actionExecutionOutput = (ActionExecutionOutput) o;
    return Objects.equals(this.outputArtifacts, actionExecutionOutput.outputArtifacts) &&
        Objects.equals(this.executionResult, actionExecutionOutput.executionResult) &&
        Objects.equals(this.outputVariables, actionExecutionOutput.outputVariables);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionExecutionOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionExecutionOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionExecutionOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionExecutionOutput is not found in the empty JSON string", ActionExecutionOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionExecutionOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionExecutionOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionExecutionOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionExecutionOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionExecutionOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionExecutionOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionExecutionOutput>() {
           @Override
           public void write(JsonWriter out, ActionExecutionOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionExecutionOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionExecutionOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionExecutionOutput
   * @throws IOException if the JSON string is invalid with respect to ActionExecutionOutput
   */
  public static ActionExecutionOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionExecutionOutput.class);
  }

  /**
   * Convert an instance of ActionExecutionOutput to an JSON string
   *
   * @return JSON string
   */
