...
public class StageStateInboundTransitionState {
  ...
  public StageStateInboundTransitionState() {
  }

  public StageStateInboundTransitionState enabled(Boolean enabled) {
  ...
  public StageStateInboundTransitionState lastChangedBy(String lastChangedBy) {
  ...
  public StageStateInboundTransitionState lastChangedAt(OffsetDateTime lastChangedAt) {
  ...
  public StageStateInboundTransitionState disabledReason(String disabledReason) {
  ...
  public boolean equals(Object o) {
    ...
    StageStateInboundTransitionState stageStateInboundTransitionState = (StageStateInboundTransitionState) o;
    return Objects.equals(this.enabled, stageStateInboundTransitionState.enabled) &&
        Objects.equals(this.lastChangedBy, stageStateInboundTransitionState.lastChangedBy) &&
        Objects.equals(this.lastChangedAt, stageStateInboundTransitionState.lastChangedAt) &&
        Objects.equals(this.disabledReason, stageStateInboundTransitionState.disabledReason);
  }
  ...
  public String toString() {
    ...
    sb.append("class StageStateInboundTransitionState {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StageStateInboundTransitionState
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StageStateInboundTransitionState.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StageStateInboundTransitionState is not found in the empty JSON string", StageStateInboundTransitionState.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StageStateInboundTransitionState.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StageStateInboundTransitionState` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StageStateInboundTransitionState.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StageStateInboundTransitionState' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StageStateInboundTransitionState> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StageStateInboundTransitionState.class));

       return (TypeAdapter<T>) new TypeAdapter<StageStateInboundTransitionState>() {
           @Override
           public void write(JsonWriter out, StageStateInboundTransitionState value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StageStateInboundTransitionState read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StageStateInboundTransitionState given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StageStateInboundTransitionState
   * @throws IOException if the JSON string is invalid with respect to StageStateInboundTransitionState
   */
  public static StageStateInboundTransitionState fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StageStateInboundTransitionState.class);
  }

  /**
   * Convert an instance of StageStateInboundTransitionState to an JSON string
   *
   * @return JSON string
   */
