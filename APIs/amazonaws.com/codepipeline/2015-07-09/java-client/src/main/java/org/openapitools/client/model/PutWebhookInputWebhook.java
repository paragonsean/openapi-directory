...
public class PutWebhookInputWebhook {
  ...
  public PutWebhookInputWebhook() {
  }

  public PutWebhookInputWebhook name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PutWebhookInputWebhook targetPipeline(String targetPipeline) {
  ...
  public PutWebhookInputWebhook targetAction(String targetAction) {
  ...
  public PutWebhookInputWebhook filters(List filters) {
  ...
  public PutWebhookInputWebhook authentication(WebhookAuthenticationType authentication) {
  ...
  public PutWebhookInputWebhook authenticationConfiguration(WebhookDefinitionAuthenticationConfiguration authenticationConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    PutWebhookInputWebhook putWebhookInputWebhook = (PutWebhookInputWebhook) o;
    return Objects.equals(this.name, putWebhookInputWebhook.name) &&
        Objects.equals(this.targetPipeline, putWebhookInputWebhook.targetPipeline) &&
        Objects.equals(this.targetAction, putWebhookInputWebhook.targetAction) &&
        Objects.equals(this.filters, putWebhookInputWebhook.filters) &&
        Objects.equals(this.authentication, putWebhookInputWebhook.authentication) &&
        Objects.equals(this.authenticationConfiguration, putWebhookInputWebhook.authenticationConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutWebhookInputWebhook {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutWebhookInputWebhook
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutWebhookInputWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutWebhookInputWebhook is not found in the empty JSON string", PutWebhookInputWebhook.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutWebhookInputWebhook.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutWebhookInputWebhook` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutWebhookInputWebhook.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutWebhookInputWebhook.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutWebhookInputWebhook' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutWebhookInputWebhook> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutWebhookInputWebhook.class));

       return (TypeAdapter<T>) new TypeAdapter<PutWebhookInputWebhook>() {
           @Override
           public void write(JsonWriter out, PutWebhookInputWebhook value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutWebhookInputWebhook read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutWebhookInputWebhook given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutWebhookInputWebhook
   * @throws IOException if the JSON string is invalid with respect to PutWebhookInputWebhook
   */
  public static PutWebhookInputWebhook fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutWebhookInputWebhook.class);
  }

  /**
   * Convert an instance of PutWebhookInputWebhook to an JSON string
   *
   * @return JSON string
   */
