...
public class GetPipelineExecutionInput {
  ...
  public GetPipelineExecutionInput() {
  }

  public GetPipelineExecutionInput pipelineName(String pipelineName) {
  ...
  public GetPipelineExecutionInput pipelineExecutionId(String pipelineExecutionId) {
  ...
  public boolean equals(Object o) {
    ...
    GetPipelineExecutionInput getPipelineExecutionInput = (GetPipelineExecutionInput) o;
    return Objects.equals(this.pipelineName, getPipelineExecutionInput.pipelineName) &&
        Objects.equals(this.pipelineExecutionId, getPipelineExecutionInput.pipelineExecutionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineName, pipelineExecutionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPipelineExecutionInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("pipelineExecutionId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPipelineExecutionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPipelineExecutionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPipelineExecutionInput is not found in the empty JSON string", GetPipelineExecutionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPipelineExecutionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPipelineExecutionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPipelineExecutionInput.openapiRequiredFields) {
      ...
      // validate the required field `pipelineExecutionId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPipelineExecutionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPipelineExecutionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPipelineExecutionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPipelineExecutionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPipelineExecutionInput>() {
           @Override
           public void write(JsonWriter out, GetPipelineExecutionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPipelineExecutionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPipelineExecutionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPipelineExecutionInput
   * @throws IOException if the JSON string is invalid with respect to GetPipelineExecutionInput
   */
  public static GetPipelineExecutionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPipelineExecutionInput.class);
  }

  /**
   * Convert an instance of GetPipelineExecutionInput to an JSON string
   *
   * @return JSON string
   */
