...
public class ExecutionTrigger {
  ...
  public static final String SERIALIZED_NAME_TRIGGER_DETAIL = "triggerDetail";
  @SerializedName(SERIALIZED_NAME_TRIGGER_DETAIL)
  private String triggerDetail;

  public ExecutionTrigger() {
  }

  public ExecutionTrigger triggerType(TriggerType triggerType) {
  ...
  public ExecutionTrigger triggerDetail(String triggerDetail) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.triggerType, executionTrigger.triggerType) &&
        Objects.equals(this.triggerDetail, executionTrigger.triggerDetail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(triggerType, triggerDetail);
  }
  ...
  public String toString() {
    ...
    sb.append("    triggerDetail: ").append(toIndentedString(triggerDetail)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("triggerDetail");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExecutionTrigger
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExecutionTrigger.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExecutionTrigger is not found in the empty JSON string", ExecutionTrigger.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExecutionTrigger.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExecutionTrigger` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `triggerDetail`
      if (jsonObj.get("triggerDetail") != null && !jsonObj.get("triggerDetail").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("triggerDetail"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExecutionTrigger.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExecutionTrigger' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExecutionTrigger> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExecutionTrigger.class));

       return (TypeAdapter<T>) new TypeAdapter<ExecutionTrigger>() {
           @Override
           public void write(JsonWriter out, ExecutionTrigger value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExecutionTrigger read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExecutionTrigger given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExecutionTrigger
   * @throws IOException if the JSON string is invalid with respect to ExecutionTrigger
   */
  public static ExecutionTrigger fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExecutionTrigger.class);
  }

  /**
   * Convert an instance of ExecutionTrigger to an JSON string
   *
   * @return JSON string
   */
