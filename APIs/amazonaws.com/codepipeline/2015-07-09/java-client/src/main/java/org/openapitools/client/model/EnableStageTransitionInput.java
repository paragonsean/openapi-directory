...
public class EnableStageTransitionInput {
  ...
  public EnableStageTransitionInput() {
  }

  public EnableStageTransitionInput pipelineName(String pipelineName) {
  ...
  public EnableStageTransitionInput stageName(String stageName) {
  ...
  public EnableStageTransitionInput transitionType(StageTransitionType transitionType) {
  ...
  public boolean equals(Object o) {
    ...
    EnableStageTransitionInput enableStageTransitionInput = (EnableStageTransitionInput) o;
    return Objects.equals(this.pipelineName, enableStageTransitionInput.pipelineName) &&
        Objects.equals(this.stageName, enableStageTransitionInput.stageName) &&
        Objects.equals(this.transitionType, enableStageTransitionInput.transitionType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineName, stageName, transitionType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EnableStageTransitionInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnableStageTransitionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnableStageTransitionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnableStageTransitionInput is not found in the empty JSON string", EnableStageTransitionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnableStageTransitionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnableStageTransitionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EnableStageTransitionInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnableStageTransitionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnableStageTransitionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnableStageTransitionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnableStageTransitionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<EnableStageTransitionInput>() {
           @Override
           public void write(JsonWriter out, EnableStageTransitionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnableStageTransitionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EnableStageTransitionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnableStageTransitionInput
   * @throws IOException if the JSON string is invalid with respect to EnableStageTransitionInput
   */
  public static EnableStageTransitionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnableStageTransitionInput.class);
  }

  /**
   * Convert an instance of EnableStageTransitionInput to an JSON string
   *
   * @return JSON string
   */
