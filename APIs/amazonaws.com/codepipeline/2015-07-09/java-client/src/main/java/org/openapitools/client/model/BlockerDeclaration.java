...
public class BlockerDeclaration {
  ...
  public BlockerDeclaration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public BlockerDeclaration type(BlockerType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BlockerDeclaration blockerDeclaration = (BlockerDeclaration) o;
    return Objects.equals(this.name, blockerDeclaration.name) &&
        Objects.equals(this.type, blockerDeclaration.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class BlockerDeclaration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BlockerDeclaration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BlockerDeclaration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BlockerDeclaration is not found in the empty JSON string", BlockerDeclaration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BlockerDeclaration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BlockerDeclaration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BlockerDeclaration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BlockerDeclaration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BlockerDeclaration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BlockerDeclaration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BlockerDeclaration.class));

       return (TypeAdapter<T>) new TypeAdapter<BlockerDeclaration>() {
           @Override
           public void write(JsonWriter out, BlockerDeclaration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BlockerDeclaration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BlockerDeclaration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BlockerDeclaration
   * @throws IOException if the JSON string is invalid with respect to BlockerDeclaration
   */
  public static BlockerDeclaration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BlockerDeclaration.class);
  }

  /**
   * Convert an instance of BlockerDeclaration to an JSON string
   *
   * @return JSON string
   */
