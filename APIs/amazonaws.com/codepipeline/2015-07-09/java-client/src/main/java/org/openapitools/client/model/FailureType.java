 ...
 */
@JsonAdapter(FailureType.Adapter.class)
public enum FailureType {
  ...
  public static FailureType fromValue(String value) {
    for (FailureType b : FailureType.values()) {
  ...
  public static class Adapter extends TypeAdapter<FailureType> {
    @Override
    public void write(final JsonWriter jsonWriter, final FailureType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FailureType read(final JsonReader jsonReader) throws IOException {
