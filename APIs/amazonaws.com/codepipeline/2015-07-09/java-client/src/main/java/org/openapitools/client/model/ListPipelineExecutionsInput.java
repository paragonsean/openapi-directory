...
public class ListPipelineExecutionsInput {
  ...
  public ListPipelineExecutionsInput() {
  }

  public ListPipelineExecutionsInput pipelineName(String pipelineName) {
  ...
  public ListPipelineExecutionsInput maxResults(Integer maxResults) {
  ...
  public ListPipelineExecutionsInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListPipelineExecutionsInput listPipelineExecutionsInput = (ListPipelineExecutionsInput) o;
    return Objects.equals(this.pipelineName, listPipelineExecutionsInput.pipelineName) &&
        Objects.equals(this.maxResults, listPipelineExecutionsInput.maxResults) &&
        Objects.equals(this.nextToken, listPipelineExecutionsInput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineName, maxResults, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListPipelineExecutionsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPipelineExecutionsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPipelineExecutionsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPipelineExecutionsInput is not found in the empty JSON string", ListPipelineExecutionsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPipelineExecutionsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPipelineExecutionsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListPipelineExecutionsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPipelineExecutionsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPipelineExecutionsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPipelineExecutionsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPipelineExecutionsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPipelineExecutionsInput>() {
           @Override
           public void write(JsonWriter out, ListPipelineExecutionsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPipelineExecutionsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPipelineExecutionsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPipelineExecutionsInput
   * @throws IOException if the JSON string is invalid with respect to ListPipelineExecutionsInput
   */
  public static ListPipelineExecutionsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPipelineExecutionsInput.class);
  }

  /**
   * Convert an instance of ListPipelineExecutionsInput to an JSON string
   *
   * @return JSON string
   */
