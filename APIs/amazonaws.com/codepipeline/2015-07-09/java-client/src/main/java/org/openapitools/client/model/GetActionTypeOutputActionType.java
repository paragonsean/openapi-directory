...
public class GetActionTypeOutputActionType {
  ...
  public GetActionTypeOutputActionType() {
  }

  public GetActionTypeOutputActionType description(String description) {
  ...
  public GetActionTypeOutputActionType executor(ActionTypeDeclarationExecutor executor) {
  ...
  public GetActionTypeOutputActionType id(ActionTypeDeclarationId id) {
    this.id = id;
    return this;
  }
  ...
  public GetActionTypeOutputActionType inputArtifactDetails(ActionTypeDeclarationInputArtifactDetails inputArtifactDetails) {
  ...
  public GetActionTypeOutputActionType outputArtifactDetails(ActionTypeDeclarationOutputArtifactDetails outputArtifactDetails) {
  ...
  public GetActionTypeOutputActionType permissions(ActionTypeDeclarationPermissions permissions) {
  ...
  public GetActionTypeOutputActionType properties(Object properties) {
  ...
  public GetActionTypeOutputActionType urls(ActionTypeDeclarationUrls urls) {
    this.urls = urls;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetActionTypeOutputActionType getActionTypeOutputActionType = (GetActionTypeOutputActionType) o;
    return Objects.equals(this.description, getActionTypeOutputActionType.description) &&
        Objects.equals(this.executor, getActionTypeOutputActionType.executor) &&
        Objects.equals(this.id, getActionTypeOutputActionType.id) &&
        Objects.equals(this.inputArtifactDetails, getActionTypeOutputActionType.inputArtifactDetails) &&
        Objects.equals(this.outputArtifactDetails, getActionTypeOutputActionType.outputArtifactDetails) &&
        Objects.equals(this.permissions, getActionTypeOutputActionType.permissions) &&
        Objects.equals(this.properties, getActionTypeOutputActionType.properties) &&
        Objects.equals(this.urls, getActionTypeOutputActionType.urls);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetActionTypeOutputActionType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetActionTypeOutputActionType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetActionTypeOutputActionType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetActionTypeOutputActionType is not found in the empty JSON string", GetActionTypeOutputActionType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetActionTypeOutputActionType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetActionTypeOutputActionType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetActionTypeOutputActionType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetActionTypeOutputActionType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetActionTypeOutputActionType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetActionTypeOutputActionType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetActionTypeOutputActionType.class));

       return (TypeAdapter<T>) new TypeAdapter<GetActionTypeOutputActionType>() {
           @Override
           public void write(JsonWriter out, GetActionTypeOutputActionType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetActionTypeOutputActionType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetActionTypeOutputActionType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetActionTypeOutputActionType
   * @throws IOException if the JSON string is invalid with respect to GetActionTypeOutputActionType
   */
  public static GetActionTypeOutputActionType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetActionTypeOutputActionType.class);
  }

  /**
   * Convert an instance of GetActionTypeOutputActionType to an JSON string
   *
   * @return JSON string
   */
