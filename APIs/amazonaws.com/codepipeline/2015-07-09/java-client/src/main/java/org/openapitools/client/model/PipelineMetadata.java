...
public class PipelineMetadata {
  ...
  public static final String SERIALIZED_NAME_POLLING_DISABLED_AT = "pollingDisabledAt";
  @SerializedName(SERIALIZED_NAME_POLLING_DISABLED_AT)
  private OffsetDateTime pollingDisabledAt;

  public PipelineMetadata() {
  }

  public PipelineMetadata pipelineArn(String pipelineArn) {
  ...
  public PipelineMetadata created(OffsetDateTime created) {
  ...
  public PipelineMetadata updated(OffsetDateTime updated) {
  ...
  public PipelineMetadata pollingDisabledAt(OffsetDateTime pollingDisabledAt) {
    this.pollingDisabledAt = pollingDisabledAt;
    return this;
  }

  /**
   * Get pollingDisabledAt
   * @return pollingDisabledAt
   */
  @javax.annotation.Nullable
  public OffsetDateTime getPollingDisabledAt() {
    return pollingDisabledAt;
  }

  public void setPollingDisabledAt(OffsetDateTime pollingDisabledAt) {
    this.pollingDisabledAt = pollingDisabledAt;
  }
  ...
  public boolean equals(Object o) {
    ...
    PipelineMetadata pipelineMetadata = (PipelineMetadata) o;
    return Objects.equals(this.pipelineArn, pipelineMetadata.pipelineArn) &&
        Objects.equals(this.created, pipelineMetadata.created) &&
        Objects.equals(this.updated, pipelineMetadata.updated) &&
        Objects.equals(this.pollingDisabledAt, pipelineMetadata.pollingDisabledAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineArn, created, updated, pollingDisabledAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PipelineMetadata {\n");
    sb.append("    pipelineArn: ").append(toIndentedString(pipelineArn)).append("\n");
    sb.append("    created: ").append(toIndentedString(created)).append("\n");
    sb.append("    updated: ").append(toIndentedString(updated)).append("\n");
    sb.append("    pollingDisabledAt: ").append(toIndentedString(pollingDisabledAt)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("pollingDisabledAt");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PipelineMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipelineMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipelineMetadata is not found in the empty JSON string", PipelineMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipelineMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PipelineMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `pollingDisabledAt`
      if (jsonObj.get("pollingDisabledAt") != null && !jsonObj.get("pollingDisabledAt").isJsonNull()) {
        OffsetDateTime.validateJsonElement(jsonObj.get("pollingDisabledAt"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipelineMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipelineMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipelineMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipelineMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PipelineMetadata>() {
           @Override
           public void write(JsonWriter out, PipelineMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PipelineMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PipelineMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PipelineMetadata
   * @throws IOException if the JSON string is invalid with respect to PipelineMetadata
   */
  public static PipelineMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipelineMetadata.class);
  }

  /**
   * Convert an instance of PipelineMetadata to an JSON string
   *
   * @return JSON string
   */
