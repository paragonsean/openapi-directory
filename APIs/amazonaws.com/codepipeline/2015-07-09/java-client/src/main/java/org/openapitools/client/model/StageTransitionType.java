...
/**
 * Gets or Sets StageTransitionType
 */
@JsonAdapter(StageTransitionType.Adapter.class)
public enum StageTransitionType {
  ...
  StageTransitionType(String value) {
    this.value = value;
  }
  ...
  public static StageTransitionType fromValue(String value) {
    for (StageTransitionType b : StageTransitionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<StageTransitionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final StageTransitionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StageTransitionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StageTransitionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StageTransitionType.fromValue(value);
  }
}
