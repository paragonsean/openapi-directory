...
public class ActionExecutionResult {
  ...
  public ActionExecutionResult externalExecutionId(String externalExecutionId) {
  ...
  public ActionExecutionResult externalExecutionSummary(String externalExecutionSummary) {
  ...
  public ActionExecutionResult externalExecutionUrl(String externalExecutionUrl) {
  ...
  public boolean equals(Object o) {
    ...
    ActionExecutionResult actionExecutionResult = (ActionExecutionResult) o;
    return Objects.equals(this.externalExecutionId, actionExecutionResult.externalExecutionId) &&
        Objects.equals(this.externalExecutionSummary, actionExecutionResult.externalExecutionSummary) &&
        Objects.equals(this.externalExecutionUrl, actionExecutionResult.externalExecutionUrl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionExecutionResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionExecutionResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionExecutionResult is not found in the empty JSON string", ActionExecutionResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionExecutionResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionExecutionResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionExecutionResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionExecutionResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionExecutionResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionExecutionResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionExecutionResult>() {
           @Override
           public void write(JsonWriter out, ActionExecutionResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionExecutionResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionExecutionResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionExecutionResult
   * @throws IOException if the JSON string is invalid with respect to ActionExecutionResult
   */
  public static ActionExecutionResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionExecutionResult.class);
  }

  /**
   * Convert an instance of ActionExecutionResult to an JSON string
   *
   * @return JSON string
   */
