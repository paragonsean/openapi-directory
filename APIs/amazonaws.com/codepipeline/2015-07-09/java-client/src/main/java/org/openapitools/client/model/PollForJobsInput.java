...
public class PollForJobsInput {
  ...
  public PollForJobsInput() {
  }

  public PollForJobsInput actionTypeId(PollForJobsInputActionTypeId actionTypeId) {
  ...
  public PollForJobsInput maxBatchSize(Integer maxBatchSize) {
  ...
  public PollForJobsInput queryParam(Map queryParam) {
  ...
  public boolean equals(Object o) {
    ...
    PollForJobsInput pollForJobsInput = (PollForJobsInput) o;
    return Objects.equals(this.actionTypeId, pollForJobsInput.actionTypeId) &&
        Objects.equals(this.maxBatchSize, pollForJobsInput.maxBatchSize) &&
        Objects.equals(this.queryParam, pollForJobsInput.queryParam);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actionTypeId, maxBatchSize, queryParam);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PollForJobsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PollForJobsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PollForJobsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PollForJobsInput is not found in the empty JSON string", PollForJobsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PollForJobsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PollForJobsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PollForJobsInput.openapiRequiredFields) {
      ...
      // validate the optional field `queryParam`
      if (jsonObj.get("queryParam") != null && !jsonObj.get("queryParam").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("queryParam"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PollForJobsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PollForJobsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PollForJobsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PollForJobsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PollForJobsInput>() {
           @Override
           public void write(JsonWriter out, PollForJobsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PollForJobsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PollForJobsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PollForJobsInput
   * @throws IOException if the JSON string is invalid with respect to PollForJobsInput
   */
  public static PollForJobsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PollForJobsInput.class);
  }

  /**
   * Convert an instance of PollForJobsInput to an JSON string
   *
   * @return JSON string
   */
