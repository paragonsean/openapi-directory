 ...
 */
@JsonAdapter(ExecutorType.Adapter.class)
public enum ExecutorType {
  ...
  public static class Adapter extends TypeAdapter<ExecutorType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ExecutorType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ExecutorType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ExecutorType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ExecutorType.fromValue(value);
  }
}
