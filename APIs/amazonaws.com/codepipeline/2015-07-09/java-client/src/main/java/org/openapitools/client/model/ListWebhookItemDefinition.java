...
public class ListWebhookItemDefinition {
  ...
  public ListWebhookItemDefinition() {
  }

  public ListWebhookItemDefinition name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ListWebhookItemDefinition targetPipeline(String targetPipeline) {
  ...
  public ListWebhookItemDefinition targetAction(String targetAction) {
  ...
  public ListWebhookItemDefinition filters(List filters) {
  ...
  public ListWebhookItemDefinition authentication(WebhookAuthenticationType authentication) {
  ...
  public ListWebhookItemDefinition authenticationConfiguration(WebhookDefinitionAuthenticationConfiguration authenticationConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    ListWebhookItemDefinition listWebhookItemDefinition = (ListWebhookItemDefinition) o;
    return Objects.equals(this.name, listWebhookItemDefinition.name) &&
        Objects.equals(this.targetPipeline, listWebhookItemDefinition.targetPipeline) &&
        Objects.equals(this.targetAction, listWebhookItemDefinition.targetAction) &&
        Objects.equals(this.filters, listWebhookItemDefinition.filters) &&
        Objects.equals(this.authentication, listWebhookItemDefinition.authentication) &&
        Objects.equals(this.authenticationConfiguration, listWebhookItemDefinition.authenticationConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListWebhookItemDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListWebhookItemDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListWebhookItemDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListWebhookItemDefinition is not found in the empty JSON string", ListWebhookItemDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListWebhookItemDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListWebhookItemDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListWebhookItemDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListWebhookItemDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListWebhookItemDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListWebhookItemDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListWebhookItemDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<ListWebhookItemDefinition>() {
           @Override
           public void write(JsonWriter out, ListWebhookItemDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListWebhookItemDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListWebhookItemDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListWebhookItemDefinition
   * @throws IOException if the JSON string is invalid with respect to ListWebhookItemDefinition
   */
  public static ListWebhookItemDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListWebhookItemDefinition.class);
  }

  /**
   * Convert an instance of ListWebhookItemDefinition to an JSON string
   *
   * @return JSON string
   */
