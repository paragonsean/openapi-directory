...
import org.openapitools.client.model.JobData;
...
public class Job {
  ...
  public Job accountId(String accountId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, job.id) &&
        ...
        Objects.equals(this.nonce, job.nonce) &&
        Objects.equals(this.accountId, job.accountId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, data, nonce, accountId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        JobData.validateJsonElement(jsonObj.get("data"));
      }
