...
public class ActionTypeId {
  ...
  public ActionTypeId category(ActionCategory category) {
  ...
  public ActionTypeId owner(ActionOwner owner) {
    this.owner = owner;
    return this;
  }
  ...
  public ActionTypeId version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    ActionTypeId actionTypeId = (ActionTypeId) o;
    return Objects.equals(this.category, actionTypeId.category) &&
        Objects.equals(this.owner, actionTypeId.owner) &&
        Objects.equals(this.provider, actionTypeId.provider) &&
        Objects.equals(this.version, actionTypeId.version);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionTypeId
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionTypeId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionTypeId is not found in the empty JSON string", ActionTypeId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionTypeId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionTypeId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionTypeId.openapiRequiredFields) {
      ...
      ActionOwner.validateJsonElement(jsonObj.get("owner"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionTypeId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionTypeId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionTypeId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionTypeId.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionTypeId>() {
           @Override
           public void write(JsonWriter out, ActionTypeId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionTypeId read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionTypeId given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionTypeId
   * @throws IOException if the JSON string is invalid with respect to ActionTypeId
   */
  public static ActionTypeId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionTypeId.class);
  }

  /**
   * Convert an instance of ActionTypeId to an JSON string
   *
   * @return JSON string
   */
