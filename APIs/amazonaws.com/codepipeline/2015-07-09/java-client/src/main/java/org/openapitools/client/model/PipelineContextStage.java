...
public class PipelineContextStage {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;

  public PipelineContextStage() {
  }

  public PipelineContextStage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PipelineContextStage pipelineContextStage = (PipelineContextStage) o;
    return Objects.equals(this.name, pipelineContextStage.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class PipelineContextStage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PipelineContextStage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipelineContextStage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipelineContextStage is not found in the empty JSON string", PipelineContextStage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipelineContextStage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PipelineContextStage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipelineContextStage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipelineContextStage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipelineContextStage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipelineContextStage.class));

       return (TypeAdapter<T>) new TypeAdapter<PipelineContextStage>() {
           @Override
           public void write(JsonWriter out, PipelineContextStage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PipelineContextStage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PipelineContextStage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PipelineContextStage
   * @throws IOException if the JSON string is invalid with respect to PipelineContextStage
   */
  public static PipelineContextStage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipelineContextStage.class);
  }

  /**
   * Convert an instance of PipelineContextStage to an JSON string
   *
   * @return JSON string
   */
