...
public class ArtifactDetail {
  ...
  public static final String SERIALIZED_NAME_S3LOCATION = "s3location";
  @SerializedName(SERIALIZED_NAME_S3LOCATION)
  private ArtifactDetailS3location s3location;

  public ArtifactDetail() {
  }

  public ArtifactDetail name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ArtifactDetail s3location(ArtifactDetailS3location s3location) {
   ...
   */
  @javax.annotation.Nullable
  public ArtifactDetailS3location getS3location() {
    return s3location;
  }

  public void setS3location(ArtifactDetailS3location s3location) {
    this.s3location = s3location;
  }
  ...
  public boolean equals(Object o) {
    ...
    ArtifactDetail artifactDetail = (ArtifactDetail) o;
    return Objects.equals(this.name, artifactDetail.name) &&
        Objects.equals(this.s3location, artifactDetail.s3location);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, s3location);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ArtifactDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ArtifactDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ArtifactDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ArtifactDetail is not found in the empty JSON string", ArtifactDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ArtifactDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ArtifactDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("s3location") != null && !jsonObj.get("s3location").isJsonNull()) {
        ArtifactDetailS3location.validateJsonElement(jsonObj.get("s3location"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ArtifactDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ArtifactDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ArtifactDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ArtifactDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<ArtifactDetail>() {
           @Override
           public void write(JsonWriter out, ArtifactDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ArtifactDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ArtifactDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ArtifactDetail
   * @throws IOException if the JSON string is invalid with respect to ArtifactDetail
   */
  public static ArtifactDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ArtifactDetail.class);
  }

  /**
   * Convert an instance of ArtifactDetail to an JSON string
   *
   * @return JSON string
   */
