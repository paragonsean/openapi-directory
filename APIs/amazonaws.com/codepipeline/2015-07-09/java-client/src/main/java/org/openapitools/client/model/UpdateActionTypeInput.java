...
import org.openapitools.client.model.UpdateActionTypeInputActionType;
...
public class UpdateActionTypeInput {
  ...
  private UpdateActionTypeInputActionType actionType;

  public UpdateActionTypeInput() {
  }

  public UpdateActionTypeInput actionType(UpdateActionTypeInputActionType actionType) {
  ...
  public UpdateActionTypeInputActionType getActionType() {
    return actionType;
  }

  public void setActionType(UpdateActionTypeInputActionType actionType) {
    this.actionType = actionType;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateActionTypeInput updateActionTypeInput = (UpdateActionTypeInput) o;
    return Objects.equals(this.actionType, updateActionTypeInput.actionType);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateActionTypeInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateActionTypeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateActionTypeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateActionTypeInput is not found in the empty JSON string", UpdateActionTypeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateActionTypeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateActionTypeInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateActionTypeInput.openapiRequiredFields) {
      ...
      UpdateActionTypeInputActionType.validateJsonElement(jsonObj.get("actionType"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateActionTypeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateActionTypeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateActionTypeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateActionTypeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateActionTypeInput>() {
           @Override
           public void write(JsonWriter out, UpdateActionTypeInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateActionTypeInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateActionTypeInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateActionTypeInput
   * @throws IOException if the JSON string is invalid with respect to UpdateActionTypeInput
   */
  public static UpdateActionTypeInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateActionTypeInput.class);
  }

  /**
   * Convert an instance of UpdateActionTypeInput to an JSON string
   *
   * @return JSON string
   */
