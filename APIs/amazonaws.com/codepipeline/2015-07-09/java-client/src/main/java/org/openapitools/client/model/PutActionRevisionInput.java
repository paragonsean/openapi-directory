...
public class PutActionRevisionInput {
  ...
  public static final String SERIALIZED_NAME_ACTION_REVISION = "actionRevision";
  @SerializedName(SERIALIZED_NAME_ACTION_REVISION)
  private PutActionRevisionInputActionRevision actionRevision;

  public PutActionRevisionInput() {
  }

  public PutActionRevisionInput pipelineName(String pipelineName) {
  ...
  public PutActionRevisionInput stageName(String stageName) {
  ...
  public PutActionRevisionInput actionName(String actionName) {
  ...
  public PutActionRevisionInput actionRevision(PutActionRevisionInputActionRevision actionRevision) {
   ...
   */
  @javax.annotation.Nonnull
  public PutActionRevisionInputActionRevision getActionRevision() {
    return actionRevision;
  }

  public void setActionRevision(PutActionRevisionInputActionRevision actionRevision) {
    this.actionRevision = actionRevision;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutActionRevisionInput putActionRevisionInput = (PutActionRevisionInput) o;
    return Objects.equals(this.pipelineName, putActionRevisionInput.pipelineName) &&
        Objects.equals(this.stageName, putActionRevisionInput.stageName) &&
        Objects.equals(this.actionName, putActionRevisionInput.actionName) &&
        Objects.equals(this.actionRevision, putActionRevisionInput.actionRevision);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineName, stageName, actionName, actionRevision);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutActionRevisionInput {\n");
    sb.append("    pipelineName: ").append(toIndentedString(pipelineName)).append("\n");
    sb.append("    stageName: ").append(toIndentedString(stageName)).append("\n");
    sb.append("    actionName: ").append(toIndentedString(actionName)).append("\n");
    sb.append("    actionRevision: ").append(toIndentedString(actionRevision)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("actionRevision");
    ...
    openapiRequiredFields.add("actionRevision");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutActionRevisionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutActionRevisionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutActionRevisionInput is not found in the empty JSON string", PutActionRevisionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutActionRevisionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutActionRevisionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutActionRevisionInput.openapiRequiredFields) {
      ...
      // validate the required field `actionRevision`
      PutActionRevisionInputActionRevision.validateJsonElement(jsonObj.get("actionRevision"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutActionRevisionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutActionRevisionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutActionRevisionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutActionRevisionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutActionRevisionInput>() {
           @Override
           public void write(JsonWriter out, PutActionRevisionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutActionRevisionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutActionRevisionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutActionRevisionInput
   * @throws IOException if the JSON string is invalid with respect to PutActionRevisionInput
   */
  public static PutActionRevisionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutActionRevisionInput.class);
  }

  /**
   * Convert an instance of PutActionRevisionInput to an JSON string
   *
   * @return JSON string
   */
