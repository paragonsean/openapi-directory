...
public class JobDataEncryptionKey {
  ...
  public JobDataEncryptionKey() {
  }

  public JobDataEncryptionKey id(String id) {
    this.id = id;
    return this;
  }
  ...
  public JobDataEncryptionKey type(EncryptionKeyType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    JobDataEncryptionKey jobDataEncryptionKey = (JobDataEncryptionKey) o;
    return Objects.equals(this.id, jobDataEncryptionKey.id) &&
        Objects.equals(this.type, jobDataEncryptionKey.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobDataEncryptionKey {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobDataEncryptionKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobDataEncryptionKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobDataEncryptionKey is not found in the empty JSON string", JobDataEncryptionKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobDataEncryptionKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobDataEncryptionKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JobDataEncryptionKey.openapiRequiredFields) {
      ...
      EncryptionKeyType.validateJsonElement(jsonObj.get("type"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobDataEncryptionKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobDataEncryptionKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobDataEncryptionKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobDataEncryptionKey.class));

       return (TypeAdapter<T>) new TypeAdapter<JobDataEncryptionKey>() {
           @Override
           public void write(JsonWriter out, JobDataEncryptionKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobDataEncryptionKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobDataEncryptionKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobDataEncryptionKey
   * @throws IOException if the JSON string is invalid with respect to JobDataEncryptionKey
   */
  public static JobDataEncryptionKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobDataEncryptionKey.class);
  }

  /**
   * Convert an instance of JobDataEncryptionKey to an JSON string
   *
   * @return JSON string
   */
