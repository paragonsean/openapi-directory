...
public class ActionExecutionOutputExecutionResult {
  ...
  public static final String SERIALIZED_NAME_EXTERNAL_EXECUTION_SUMMARY = "externalExecutionSummary";
  @SerializedName(SERIALIZED_NAME_EXTERNAL_EXECUTION_SUMMARY)
  ...
  public ActionExecutionOutputExecutionResult() {
  }

  public ActionExecutionOutputExecutionResult externalExecutionId(String externalExecutionId) {
  ...
  public ActionExecutionOutputExecutionResult externalExecutionSummary(String externalExecutionSummary) {
    this.externalExecutionSummary = externalExecutionSummary;
    return this;
  }

  /**
   * Get externalExecutionSummary
  ...
  public ActionExecutionOutputExecutionResult externalExecutionUrl(String externalExecutionUrl) {
  ...
  public boolean equals(Object o) {
    ...
    ActionExecutionOutputExecutionResult actionExecutionOutputExecutionResult = (ActionExecutionOutputExecutionResult) o;
    return Objects.equals(this.externalExecutionId, actionExecutionOutputExecutionResult.externalExecutionId) &&
        Objects.equals(this.externalExecutionSummary, actionExecutionOutputExecutionResult.externalExecutionSummary) &&
        Objects.equals(this.externalExecutionUrl, actionExecutionOutputExecutionResult.externalExecutionUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(externalExecutionId, externalExecutionSummary, externalExecutionUrl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ActionExecutionOutputExecutionResult {\n");
    sb.append("    externalExecutionId: ").append(toIndentedString(externalExecutionId)).append("\n");
    sb.append("    externalExecutionSummary: ").append(toIndentedString(externalExecutionSummary)).append("\n");
  ...
  static {
    ...
    openapiFields.add("externalExecutionSummary");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionExecutionOutputExecutionResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionExecutionOutputExecutionResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionExecutionOutputExecutionResult is not found in the empty JSON string", ActionExecutionOutputExecutionResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionExecutionOutputExecutionResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionExecutionOutputExecutionResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("externalExecutionSummary") != null && !jsonObj.get("externalExecutionSummary").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("externalExecutionSummary"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionExecutionOutputExecutionResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionExecutionOutputExecutionResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionExecutionOutputExecutionResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionExecutionOutputExecutionResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionExecutionOutputExecutionResult>() {
           @Override
           public void write(JsonWriter out, ActionExecutionOutputExecutionResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionExecutionOutputExecutionResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionExecutionOutputExecutionResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionExecutionOutputExecutionResult
   * @throws IOException if the JSON string is invalid with respect to ActionExecutionOutputExecutionResult
   */
  public static ActionExecutionOutputExecutionResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionExecutionOutputExecutionResult.class);
  }

  /**
   * Convert an instance of ActionExecutionOutputExecutionResult to an JSON string
   *
   * @return JSON string
   */
