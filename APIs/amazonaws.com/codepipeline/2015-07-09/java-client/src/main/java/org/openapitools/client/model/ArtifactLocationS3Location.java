...
public class ArtifactLocationS3Location {
  ...
  public ArtifactLocationS3Location() {
  }

  public ArtifactLocationS3Location bucketName(String bucketName) {
  ...
  public ArtifactLocationS3Location objectKey(String objectKey) {
  ...
  public boolean equals(Object o) {
    ...
    ArtifactLocationS3Location artifactLocationS3Location = (ArtifactLocationS3Location) o;
    return Objects.equals(this.bucketName, artifactLocationS3Location.bucketName) &&
        Objects.equals(this.objectKey, artifactLocationS3Location.objectKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class ArtifactLocationS3Location {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ArtifactLocationS3Location
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ArtifactLocationS3Location.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ArtifactLocationS3Location is not found in the empty JSON string", ArtifactLocationS3Location.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ArtifactLocationS3Location.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ArtifactLocationS3Location` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ArtifactLocationS3Location.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ArtifactLocationS3Location.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ArtifactLocationS3Location' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ArtifactLocationS3Location> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ArtifactLocationS3Location.class));

       return (TypeAdapter<T>) new TypeAdapter<ArtifactLocationS3Location>() {
           @Override
           public void write(JsonWriter out, ArtifactLocationS3Location value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ArtifactLocationS3Location read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ArtifactLocationS3Location given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ArtifactLocationS3Location
   * @throws IOException if the JSON string is invalid with respect to ArtifactLocationS3Location
   */
  public static ArtifactLocationS3Location fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ArtifactLocationS3Location.class);
  }

  /**
   * Convert an instance of ArtifactLocationS3Location to an JSON string
   *
   * @return JSON string
   */
