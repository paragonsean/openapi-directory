...
public class ListWebhooksOutput {
  ...
  public ListWebhooksOutput() {
  }

  public ListWebhooksOutput webhooks(List webhooks) {
  ...
  public ListWebhooksOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListWebhooksOutput listWebhooksOutput = (ListWebhooksOutput) o;
    return Objects.equals(this.webhooks, listWebhooksOutput.webhooks) &&
        Objects.equals(this.nextToken, listWebhooksOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(webhooks, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListWebhooksOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListWebhooksOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListWebhooksOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListWebhooksOutput is not found in the empty JSON string", ListWebhooksOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListWebhooksOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListWebhooksOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `webhooks`
      if (jsonObj.get("webhooks") != null && !jsonObj.get("webhooks").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("webhooks"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListWebhooksOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListWebhooksOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListWebhooksOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListWebhooksOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListWebhooksOutput>() {
           @Override
           public void write(JsonWriter out, ListWebhooksOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListWebhooksOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListWebhooksOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListWebhooksOutput
   * @throws IOException if the JSON string is invalid with respect to ListWebhooksOutput
   */
  public static ListWebhooksOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListWebhooksOutput.class);
  }

  /**
   * Convert an instance of ListWebhooksOutput to an JSON string
   *
   * @return JSON string
   */
