...
public class TransitionState {
  ...
  public static final String SERIALIZED_NAME_LAST_CHANGED_BY = "lastChangedBy";
  ...
  public TransitionState enabled(Boolean enabled) {
  ...
  public TransitionState lastChangedBy(String lastChangedBy) {
  ...
  public TransitionState lastChangedAt(OffsetDateTime lastChangedAt) {
  ...
  public TransitionState disabledReason(String disabledReason) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, transitionState.enabled) &&
        Objects.equals(this.lastChangedBy, transitionState.lastChangedBy) &&
        Objects.equals(this.lastChangedAt, transitionState.lastChangedAt) &&
        Objects.equals(this.disabledReason, transitionState.disabledReason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, lastChangedBy, lastChangedAt, disabledReason);
  }
  ...
  static {
    ...
    openapiFields.add("lastChangedBy");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransitionState.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransitionState is not found in the empty JSON string", TransitionState.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransitionState.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransitionState` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `lastChangedBy`
      if (jsonObj.get("lastChangedBy") != null && !jsonObj.get("lastChangedBy").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("lastChangedBy"));
      }
      // validate the optional field `lastChangedAt`
      if (jsonObj.get("lastChangedAt") != null && !jsonObj.get("lastChangedAt").isJsonNull()) {
        OffsetDateTime.validateJsonElement(jsonObj.get("lastChangedAt"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<TransitionState> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransitionState.class));

       return (TypeAdapter<T>) new TypeAdapter<TransitionState>() {
           @Override
           public void write(JsonWriter out, TransitionState value) throws IOException {
