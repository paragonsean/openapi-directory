...
public class PutApprovalResultOutput {
  ...
  public PutApprovalResultOutput approvedAt(OffsetDateTime approvedAt) {
  ...
  public boolean equals(Object o) {
    ...
    PutApprovalResultOutput putApprovalResultOutput = (PutApprovalResultOutput) o;
    return Objects.equals(this.approvedAt, putApprovalResultOutput.approvedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutApprovalResultOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutApprovalResultOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutApprovalResultOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutApprovalResultOutput is not found in the empty JSON string", PutApprovalResultOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutApprovalResultOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutApprovalResultOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `approvedAt`
      if (jsonObj.get("approvedAt") != null && !jsonObj.get("approvedAt").isJsonNull()) {
        OffsetDateTime.validateJsonElement(jsonObj.get("approvedAt"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutApprovalResultOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutApprovalResultOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutApprovalResultOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutApprovalResultOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutApprovalResultOutput>() {
           @Override
           public void write(JsonWriter out, PutApprovalResultOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutApprovalResultOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutApprovalResultOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutApprovalResultOutput
   * @throws IOException if the JSON string is invalid with respect to PutApprovalResultOutput
   */
  public static PutApprovalResultOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutApprovalResultOutput.class);
  }

  /**
   * Convert an instance of PutApprovalResultOutput to an JSON string
   *
   * @return JSON string
   */
