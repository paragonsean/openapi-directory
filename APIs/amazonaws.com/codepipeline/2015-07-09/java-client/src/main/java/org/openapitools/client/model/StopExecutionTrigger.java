...
public class StopExecutionTrigger {
  ...
  public StopExecutionTrigger reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StopExecutionTrigger stopExecutionTrigger = (StopExecutionTrigger) o;
    return Objects.equals(this.reason, stopExecutionTrigger.reason);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopExecutionTrigger {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopExecutionTrigger
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopExecutionTrigger.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopExecutionTrigger is not found in the empty JSON string", StopExecutionTrigger.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopExecutionTrigger.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopExecutionTrigger` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopExecutionTrigger.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopExecutionTrigger' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopExecutionTrigger> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopExecutionTrigger.class));

       return (TypeAdapter<T>) new TypeAdapter<StopExecutionTrigger>() {
           @Override
           public void write(JsonWriter out, StopExecutionTrigger value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopExecutionTrigger read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopExecutionTrigger given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopExecutionTrigger
   * @throws IOException if the JSON string is invalid with respect to StopExecutionTrigger
   */
  public static StopExecutionTrigger fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopExecutionTrigger.class);
  }

  /**
   * Convert an instance of StopExecutionTrigger to an JSON string
   *
   * @return JSON string
   */
