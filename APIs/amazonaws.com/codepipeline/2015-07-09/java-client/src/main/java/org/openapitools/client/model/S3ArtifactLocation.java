...
public class S3ArtifactLocation {
  ...
  public S3ArtifactLocation bucketName(String bucketName) {
  ...
  public S3ArtifactLocation objectKey(String objectKey) {
  ...
  public boolean equals(Object o) {
    ...
    S3ArtifactLocation s3ArtifactLocation = (S3ArtifactLocation) o;
    return Objects.equals(this.bucketName, s3ArtifactLocation.bucketName) &&
        Objects.equals(this.objectKey, s3ArtifactLocation.objectKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class S3ArtifactLocation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3ArtifactLocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3ArtifactLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3ArtifactLocation is not found in the empty JSON string", S3ArtifactLocation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3ArtifactLocation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3ArtifactLocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : S3ArtifactLocation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3ArtifactLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3ArtifactLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3ArtifactLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3ArtifactLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<S3ArtifactLocation>() {
           @Override
           public void write(JsonWriter out, S3ArtifactLocation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3ArtifactLocation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3ArtifactLocation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3ArtifactLocation
   * @throws IOException if the JSON string is invalid with respect to S3ArtifactLocation
   */
  public static S3ArtifactLocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3ArtifactLocation.class);
  }

  /**
   * Convert an instance of S3ArtifactLocation to an JSON string
   *
   * @return JSON string
   */
