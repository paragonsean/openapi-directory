...
public class FailureDetails {
  ...
  public FailureDetails type(FailureType type) {
    this.type = type;
    return this;
  }
  ...
  public FailureDetails message(String message) {
  ...
  public FailureDetails externalExecutionId(String externalExecutionId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, failureDetails.type) &&
        Objects.equals(this.message, failureDetails.message) &&
        Objects.equals(this.externalExecutionId, failureDetails.externalExecutionId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : FailureDetails.openapiRequiredFields) {
