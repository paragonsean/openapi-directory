...
public class RetryStageExecutionOutput {
  ...
  public RetryStageExecutionOutput pipelineExecutionId(String pipelineExecutionId) {
  ...
  public boolean equals(Object o) {
    ...
    RetryStageExecutionOutput retryStageExecutionOutput = (RetryStageExecutionOutput) o;
    return Objects.equals(this.pipelineExecutionId, retryStageExecutionOutput.pipelineExecutionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetryStageExecutionOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetryStageExecutionOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetryStageExecutionOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetryStageExecutionOutput is not found in the empty JSON string", RetryStageExecutionOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetryStageExecutionOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetryStageExecutionOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetryStageExecutionOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetryStageExecutionOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetryStageExecutionOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetryStageExecutionOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<RetryStageExecutionOutput>() {
           @Override
           public void write(JsonWriter out, RetryStageExecutionOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetryStageExecutionOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetryStageExecutionOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetryStageExecutionOutput
   * @throws IOException if the JSON string is invalid with respect to RetryStageExecutionOutput
   */
  public static RetryStageExecutionOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetryStageExecutionOutput.class);
  }

  /**
   * Convert an instance of RetryStageExecutionOutput to an JSON string
   *
   * @return JSON string
   */
