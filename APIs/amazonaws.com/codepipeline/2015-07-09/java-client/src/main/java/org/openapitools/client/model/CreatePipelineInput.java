...
import org.openapitools.client.model.CreatePipelineOutputPipeline;
...
public class CreatePipelineInput {
  ...
  private CreatePipelineOutputPipeline pipeline;
  ...
  public CreatePipelineInput pipeline(CreatePipelineOutputPipeline pipeline) {
  ...
  public CreatePipelineOutputPipeline getPipeline() {
    return pipeline;
  }

  public void setPipeline(CreatePipelineOutputPipeline pipeline) {
    this.pipeline = pipeline;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pipeline, createPipelineInput.pipeline) &&
        Objects.equals(this.tags, createPipelineInput.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipeline, tags);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      CreatePipelineOutputPipeline.validateJsonElement(jsonObj.get("pipeline"));
