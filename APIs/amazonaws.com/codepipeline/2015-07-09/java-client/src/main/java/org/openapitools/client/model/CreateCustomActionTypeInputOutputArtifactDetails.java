...
public class CreateCustomActionTypeInputOutputArtifactDetails {
  ...
  public CreateCustomActionTypeInputOutputArtifactDetails() {
  }

  public CreateCustomActionTypeInputOutputArtifactDetails minimumCount(Integer minimumCount) {
  ...
  public CreateCustomActionTypeInputOutputArtifactDetails maximumCount(Integer maximumCount) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCustomActionTypeInputOutputArtifactDetails createCustomActionTypeInputOutputArtifactDetails = (CreateCustomActionTypeInputOutputArtifactDetails) o;
    return Objects.equals(this.minimumCount, createCustomActionTypeInputOutputArtifactDetails.minimumCount) &&
        Objects.equals(this.maximumCount, createCustomActionTypeInputOutputArtifactDetails.maximumCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateCustomActionTypeInputOutputArtifactDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCustomActionTypeInputOutputArtifactDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCustomActionTypeInputOutputArtifactDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCustomActionTypeInputOutputArtifactDetails is not found in the empty JSON string", CreateCustomActionTypeInputOutputArtifactDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCustomActionTypeInputOutputArtifactDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCustomActionTypeInputOutputArtifactDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCustomActionTypeInputOutputArtifactDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCustomActionTypeInputOutputArtifactDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCustomActionTypeInputOutputArtifactDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCustomActionTypeInputOutputArtifactDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCustomActionTypeInputOutputArtifactDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCustomActionTypeInputOutputArtifactDetails>() {
           @Override
           public void write(JsonWriter out, CreateCustomActionTypeInputOutputArtifactDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCustomActionTypeInputOutputArtifactDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCustomActionTypeInputOutputArtifactDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCustomActionTypeInputOutputArtifactDetails
   * @throws IOException if the JSON string is invalid with respect to CreateCustomActionTypeInputOutputArtifactDetails
   */
  public static CreateCustomActionTypeInputOutputArtifactDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCustomActionTypeInputOutputArtifactDetails.class);
  }

  /**
   * Convert an instance of CreateCustomActionTypeInputOutputArtifactDetails to an JSON string
   *
   * @return JSON string
   */
