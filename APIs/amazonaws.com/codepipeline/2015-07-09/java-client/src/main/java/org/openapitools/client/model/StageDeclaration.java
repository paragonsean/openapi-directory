...
public class StageDeclaration {
  ...
  public StageDeclaration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StageDeclaration blockers(List blockers) {
  ...
  public List getBlockers() {
    return blockers;
  }

  public void setBlockers(List blockers) {
    this.blockers = blockers;
  }


  public StageDeclaration actions(List actions) {
  ...
  public boolean equals(Object o) {
    ...
    StageDeclaration stageDeclaration = (StageDeclaration) o;
    return Objects.equals(this.name, stageDeclaration.name) &&
        Objects.equals(this.blockers, stageDeclaration.blockers) &&
        Objects.equals(this.actions, stageDeclaration.actions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, blockers, actions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StageDeclaration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StageDeclaration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StageDeclaration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StageDeclaration is not found in the empty JSON string", StageDeclaration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StageDeclaration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StageDeclaration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StageDeclaration.openapiRequiredFields) {
      ...
      // validate the optional field `blockers`
      if (jsonObj.get("blockers") != null && !jsonObj.get("blockers").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("blockers"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StageDeclaration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StageDeclaration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StageDeclaration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StageDeclaration.class));

       return (TypeAdapter<T>) new TypeAdapter<StageDeclaration>() {
           @Override
           public void write(JsonWriter out, StageDeclaration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StageDeclaration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StageDeclaration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StageDeclaration
   * @throws IOException if the JSON string is invalid with respect to StageDeclaration
   */
  public static StageDeclaration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StageDeclaration.class);
  }

  /**
   * Convert an instance of StageDeclaration to an JSON string
   *
   * @return JSON string
   */
