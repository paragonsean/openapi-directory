...
public class ArtifactStoreEncryptionKey {
  ...
  public ArtifactStoreEncryptionKey() {
  }

  public ArtifactStoreEncryptionKey id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ArtifactStoreEncryptionKey type(EncryptionKeyType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ArtifactStoreEncryptionKey artifactStoreEncryptionKey = (ArtifactStoreEncryptionKey) o;
    return Objects.equals(this.id, artifactStoreEncryptionKey.id) &&
        Objects.equals(this.type, artifactStoreEncryptionKey.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ArtifactStoreEncryptionKey {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ArtifactStoreEncryptionKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ArtifactStoreEncryptionKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ArtifactStoreEncryptionKey is not found in the empty JSON string", ArtifactStoreEncryptionKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ArtifactStoreEncryptionKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ArtifactStoreEncryptionKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ArtifactStoreEncryptionKey.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ArtifactStoreEncryptionKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ArtifactStoreEncryptionKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ArtifactStoreEncryptionKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ArtifactStoreEncryptionKey.class));

       return (TypeAdapter<T>) new TypeAdapter<ArtifactStoreEncryptionKey>() {
           @Override
           public void write(JsonWriter out, ArtifactStoreEncryptionKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ArtifactStoreEncryptionKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ArtifactStoreEncryptionKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ArtifactStoreEncryptionKey
   * @throws IOException if the JSON string is invalid with respect to ArtifactStoreEncryptionKey
   */
  public static ArtifactStoreEncryptionKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ArtifactStoreEncryptionKey.class);
  }

  /**
   * Convert an instance of ArtifactStoreEncryptionKey to an JSON string
   *
   * @return JSON string
   */
