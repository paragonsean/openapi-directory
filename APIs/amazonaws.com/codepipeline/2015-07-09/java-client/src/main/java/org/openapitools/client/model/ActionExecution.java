...
public class ActionExecution {
  ...
  public ActionExecution actionExecutionId(String actionExecutionId) {
  ...
  public ActionExecution status(ActionExecutionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ActionExecution summary(String summary) {
  ...
  public ActionExecution lastStatusChange(OffsetDateTime lastStatusChange) {
  ...
  public ActionExecution token(String token) {
    this.token = token;
    return this;
  }
  ...
  public ActionExecution lastUpdatedBy(String lastUpdatedBy) {
  ...
  public ActionExecution externalExecutionId(String externalExecutionId) {
  ...
  public ActionExecution externalExecutionUrl(String externalExecutionUrl) {
  ...
  public ActionExecution percentComplete(Integer percentComplete) {
  ...
  public ActionExecution errorDetails(ActionExecutionErrorDetails errorDetails) {
  ...
  public boolean equals(Object o) {
    ...
    ActionExecution actionExecution = (ActionExecution) o;
    return Objects.equals(this.actionExecutionId, actionExecution.actionExecutionId) &&
        Objects.equals(this.status, actionExecution.status) &&
        Objects.equals(this.summary, actionExecution.summary) &&
        Objects.equals(this.lastStatusChange, actionExecution.lastStatusChange) &&
        Objects.equals(this.token, actionExecution.token) &&
        Objects.equals(this.lastUpdatedBy, actionExecution.lastUpdatedBy) &&
        Objects.equals(this.externalExecutionId, actionExecution.externalExecutionId) &&
        Objects.equals(this.externalExecutionUrl, actionExecution.externalExecutionUrl) &&
        Objects.equals(this.percentComplete, actionExecution.percentComplete) &&
        Objects.equals(this.errorDetails, actionExecution.errorDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionExecution {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionExecution
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionExecution.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionExecution is not found in the empty JSON string", ActionExecution.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionExecution.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionExecution` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionExecution.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionExecution' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionExecution> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionExecution.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionExecution>() {
           @Override
           public void write(JsonWriter out, ActionExecution value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionExecution read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionExecution given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionExecution
   * @throws IOException if the JSON string is invalid with respect to ActionExecution
   */
  public static ActionExecution fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionExecution.class);
  }

  /**
   * Convert an instance of ActionExecution to an JSON string
   *
   * @return JSON string
   */
