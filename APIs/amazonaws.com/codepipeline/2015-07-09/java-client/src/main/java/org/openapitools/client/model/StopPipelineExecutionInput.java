...
public class StopPipelineExecutionInput {
  ...
  public static final String SERIALIZED_NAME_ABANDON = "abandon";
  @SerializedName(SERIALIZED_NAME_ABANDON)
  ...
  public StopPipelineExecutionInput() {
  }

  public StopPipelineExecutionInput pipelineName(String pipelineName) {
  ...
  public StopPipelineExecutionInput pipelineExecutionId(String pipelineExecutionId) {
  ...
  public StopPipelineExecutionInput abandon(Boolean abandon) {
  ...
  public StopPipelineExecutionInput reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StopPipelineExecutionInput stopPipelineExecutionInput = (StopPipelineExecutionInput) o;
    return Objects.equals(this.pipelineName, stopPipelineExecutionInput.pipelineName) &&
        Objects.equals(this.pipelineExecutionId, stopPipelineExecutionInput.pipelineExecutionId) &&
        Objects.equals(this.abandon, stopPipelineExecutionInput.abandon) &&
        Objects.equals(this.reason, stopPipelineExecutionInput.reason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineName, pipelineExecutionId, abandon, reason);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StopPipelineExecutionInput {\n");
    sb.append("    pipelineName: ").append(toIndentedString(pipelineName)).append("\n");
    sb.append("    pipelineExecutionId: ").append(toIndentedString(pipelineExecutionId)).append("\n");
    sb.append("    abandon: ").append(toIndentedString(abandon)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopPipelineExecutionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopPipelineExecutionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopPipelineExecutionInput is not found in the empty JSON string", StopPipelineExecutionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopPipelineExecutionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopPipelineExecutionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StopPipelineExecutionInput.openapiRequiredFields) {
      ...
      // validate the optional field `abandon`
      if (jsonObj.get("abandon") != null && !jsonObj.get("abandon").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("abandon"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopPipelineExecutionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopPipelineExecutionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopPipelineExecutionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopPipelineExecutionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<StopPipelineExecutionInput>() {
           @Override
           public void write(JsonWriter out, StopPipelineExecutionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopPipelineExecutionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopPipelineExecutionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopPipelineExecutionInput
   * @throws IOException if the JSON string is invalid with respect to StopPipelineExecutionInput
   */
  public static StopPipelineExecutionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopPipelineExecutionInput.class);
  }

  /**
   * Convert an instance of StopPipelineExecutionInput to an JSON string
   *
   * @return JSON string
   */
