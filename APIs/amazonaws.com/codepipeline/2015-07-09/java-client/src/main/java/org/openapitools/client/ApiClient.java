...
public class ApiClient {
    ...
    private String basePath = "http://codepipeline.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2015-07-09/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://codepipeline.us-east-1.amazonaws.com
