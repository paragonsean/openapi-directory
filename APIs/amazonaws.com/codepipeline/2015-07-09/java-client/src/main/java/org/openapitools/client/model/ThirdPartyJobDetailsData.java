...
import org.openapitools.client.model.ThirdPartyJobDataArtifactCredentials;
import org.openapitools.client.model.ThirdPartyJobDataEncryptionKey;
import org.openapitools.client.model.ThirdPartyJobDataPipelineContext;
...
public class ThirdPartyJobDetailsData {
  ...
  private ThirdPartyJobDataPipelineContext pipelineContext;
  ...
  private ThirdPartyJobDataArtifactCredentials artifactCredentials;
  ...
  private ThirdPartyJobDataEncryptionKey encryptionKey;

  public ThirdPartyJobDetailsData() {
  }

  public ThirdPartyJobDetailsData actionTypeId(PollForJobsInputActionTypeId actionTypeId) {
  ...
  public ThirdPartyJobDetailsData actionConfiguration(JobDataActionConfiguration actionConfiguration) {
  ...
  public ThirdPartyJobDetailsData pipelineContext(ThirdPartyJobDataPipelineContext pipelineContext) {
   ...
   */
  @javax.annotation.Nullable
  public ThirdPartyJobDataPipelineContext getPipelineContext() {
    return pipelineContext;
  }

  public void setPipelineContext(ThirdPartyJobDataPipelineContext pipelineContext) {
    this.pipelineContext = pipelineContext;
  }


  public ThirdPartyJobDetailsData inputArtifacts(List inputArtifacts) {
  ...
  public ThirdPartyJobDetailsData outputArtifacts(List outputArtifacts) {
  ...
  public ThirdPartyJobDetailsData artifactCredentials(ThirdPartyJobDataArtifactCredentials artifactCredentials) {
   ...
   */
  @javax.annotation.Nullable
  public ThirdPartyJobDataArtifactCredentials getArtifactCredentials() {
    return artifactCredentials;
  }

  public void setArtifactCredentials(ThirdPartyJobDataArtifactCredentials artifactCredentials) {
    this.artifactCredentials = artifactCredentials;
  }


  public ThirdPartyJobDetailsData continuationToken(String continuationToken) {
  ...
  public ThirdPartyJobDetailsData encryptionKey(ThirdPartyJobDataEncryptionKey encryptionKey) {
   ...
   */
  @javax.annotation.Nullable
  public ThirdPartyJobDataEncryptionKey getEncryptionKey() {
    return encryptionKey;
  }

  public void setEncryptionKey(ThirdPartyJobDataEncryptionKey encryptionKey) {
    this.encryptionKey = encryptionKey;
  }
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyJobDetailsData thirdPartyJobDetailsData = (ThirdPartyJobDetailsData) o;
    return Objects.equals(this.actionTypeId, thirdPartyJobDetailsData.actionTypeId) &&
        Objects.equals(this.actionConfiguration, thirdPartyJobDetailsData.actionConfiguration) &&
        Objects.equals(this.pipelineContext, thirdPartyJobDetailsData.pipelineContext) &&
        Objects.equals(this.inputArtifacts, thirdPartyJobDetailsData.inputArtifacts) &&
        Objects.equals(this.outputArtifacts, thirdPartyJobDetailsData.outputArtifacts) &&
        Objects.equals(this.artifactCredentials, thirdPartyJobDetailsData.artifactCredentials) &&
        Objects.equals(this.continuationToken, thirdPartyJobDetailsData.continuationToken) &&
        Objects.equals(this.encryptionKey, thirdPartyJobDetailsData.encryptionKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class ThirdPartyJobDetailsData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ThirdPartyJobDetailsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ThirdPartyJobDetailsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyJobDetailsData is not found in the empty JSON string", ThirdPartyJobDetailsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ThirdPartyJobDetailsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ThirdPartyJobDetailsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("pipelineContext") != null && !jsonObj.get("pipelineContext").isJsonNull()) {
        ThirdPartyJobDataPipelineContext.validateJsonElement(jsonObj.get("pipelineContext"));
      }
      ...
      if (jsonObj.get("artifactCredentials") != null && !jsonObj.get("artifactCredentials").isJsonNull()) {
        ThirdPartyJobDataArtifactCredentials.validateJsonElement(jsonObj.get("artifactCredentials"));
      }
      ...
      if (jsonObj.get("encryptionKey") != null && !jsonObj.get("encryptionKey").isJsonNull()) {
        ThirdPartyJobDataEncryptionKey.validateJsonElement(jsonObj.get("encryptionKey"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyJobDetailsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyJobDetailsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyJobDetailsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyJobDetailsData.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyJobDetailsData>() {
           @Override
           public void write(JsonWriter out, ThirdPartyJobDetailsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ThirdPartyJobDetailsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ThirdPartyJobDetailsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ThirdPartyJobDetailsData
   * @throws IOException if the JSON string is invalid with respect to ThirdPartyJobDetailsData
   */
  public static ThirdPartyJobDetailsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyJobDetailsData.class);
  }

  /**
   * Convert an instance of ThirdPartyJobDetailsData to an JSON string
   *
   * @return JSON string
   */
