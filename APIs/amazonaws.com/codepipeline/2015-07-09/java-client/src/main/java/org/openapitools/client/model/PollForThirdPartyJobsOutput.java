...
public class PollForThirdPartyJobsOutput {
  ...
  public PollForThirdPartyJobsOutput jobs(List jobs) {
    this.jobs = jobs;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PollForThirdPartyJobsOutput pollForThirdPartyJobsOutput = (PollForThirdPartyJobsOutput) o;
    return Objects.equals(this.jobs, pollForThirdPartyJobsOutput.jobs);
  }
  ...
  public String toString() {
    ...
    sb.append("class PollForThirdPartyJobsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PollForThirdPartyJobsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PollForThirdPartyJobsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PollForThirdPartyJobsOutput is not found in the empty JSON string", PollForThirdPartyJobsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PollForThirdPartyJobsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PollForThirdPartyJobsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PollForThirdPartyJobsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PollForThirdPartyJobsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PollForThirdPartyJobsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PollForThirdPartyJobsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<PollForThirdPartyJobsOutput>() {
           @Override
           public void write(JsonWriter out, PollForThirdPartyJobsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PollForThirdPartyJobsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PollForThirdPartyJobsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PollForThirdPartyJobsOutput
   * @throws IOException if the JSON string is invalid with respect to PollForThirdPartyJobsOutput
   */
  public static PollForThirdPartyJobsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PollForThirdPartyJobsOutput.class);
  }

  /**
   * Convert an instance of PollForThirdPartyJobsOutput to an JSON string
   *
   * @return JSON string
   */
