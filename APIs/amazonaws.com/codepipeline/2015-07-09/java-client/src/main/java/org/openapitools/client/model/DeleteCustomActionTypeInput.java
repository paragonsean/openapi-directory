...
public class DeleteCustomActionTypeInput {
  ...
  public DeleteCustomActionTypeInput() {
  }

  public DeleteCustomActionTypeInput category(ActionCategory category) {
  ...
  public DeleteCustomActionTypeInput provider(String provider) {
  ...
  public DeleteCustomActionTypeInput version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteCustomActionTypeInput deleteCustomActionTypeInput = (DeleteCustomActionTypeInput) o;
    return Objects.equals(this.category, deleteCustomActionTypeInput.category) &&
        Objects.equals(this.provider, deleteCustomActionTypeInput.provider) &&
        Objects.equals(this.version, deleteCustomActionTypeInput.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(category, provider, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteCustomActionTypeInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteCustomActionTypeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteCustomActionTypeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteCustomActionTypeInput is not found in the empty JSON string", DeleteCustomActionTypeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteCustomActionTypeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteCustomActionTypeInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteCustomActionTypeInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteCustomActionTypeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteCustomActionTypeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteCustomActionTypeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteCustomActionTypeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteCustomActionTypeInput>() {
           @Override
           public void write(JsonWriter out, DeleteCustomActionTypeInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteCustomActionTypeInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteCustomActionTypeInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteCustomActionTypeInput
   * @throws IOException if the JSON string is invalid with respect to DeleteCustomActionTypeInput
   */
  public static DeleteCustomActionTypeInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteCustomActionTypeInput.class);
  }

  /**
   * Convert an instance of DeleteCustomActionTypeInput to an JSON string
   *
   * @return JSON string
   */
