...
public class GetPipelineOutput {
  ...
  private GetPipelineOutputMetadata metadata;

  public GetPipelineOutput() {
  }

  public GetPipelineOutput pipeline(CreatePipelineOutputPipeline pipeline) {
  ...
  public GetPipelineOutput metadata(GetPipelineOutputMetadata metadata) {
   ...
   */
  @javax.annotation.Nullable
  public GetPipelineOutputMetadata getMetadata() {
    return metadata;
  }

  public void setMetadata(GetPipelineOutputMetadata metadata) {
    this.metadata = metadata;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPipelineOutput getPipelineOutput = (GetPipelineOutput) o;
    return Objects.equals(this.pipeline, getPipelineOutput.pipeline) &&
        Objects.equals(this.metadata, getPipelineOutput.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipeline, metadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPipelineOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPipelineOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPipelineOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPipelineOutput is not found in the empty JSON string", GetPipelineOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPipelineOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPipelineOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("metadata") != null && !jsonObj.get("metadata").isJsonNull()) {
        GetPipelineOutputMetadata.validateJsonElement(jsonObj.get("metadata"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPipelineOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPipelineOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPipelineOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPipelineOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPipelineOutput>() {
           @Override
           public void write(JsonWriter out, GetPipelineOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPipelineOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPipelineOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPipelineOutput
   * @throws IOException if the JSON string is invalid with respect to GetPipelineOutput
   */
  public static GetPipelineOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPipelineOutput.class);
  }

  /**
   * Convert an instance of GetPipelineOutput to an JSON string
   *
   * @return JSON string
   */
