...
public class StartPipelineExecutionOutput {
  ...
  public StartPipelineExecutionOutput pipelineExecutionId(String pipelineExecutionId) {
  ...
  public boolean equals(Object o) {
    ...
    StartPipelineExecutionOutput startPipelineExecutionOutput = (StartPipelineExecutionOutput) o;
    return Objects.equals(this.pipelineExecutionId, startPipelineExecutionOutput.pipelineExecutionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartPipelineExecutionOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartPipelineExecutionOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartPipelineExecutionOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartPipelineExecutionOutput is not found in the empty JSON string", StartPipelineExecutionOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartPipelineExecutionOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartPipelineExecutionOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartPipelineExecutionOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartPipelineExecutionOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartPipelineExecutionOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartPipelineExecutionOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<StartPipelineExecutionOutput>() {
           @Override
           public void write(JsonWriter out, StartPipelineExecutionOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartPipelineExecutionOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartPipelineExecutionOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartPipelineExecutionOutput
   * @throws IOException if the JSON string is invalid with respect to StartPipelineExecutionOutput
   */
  public static StartPipelineExecutionOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartPipelineExecutionOutput.class);
  }

  /**
   * Convert an instance of StartPipelineExecutionOutput to an JSON string
   *
   * @return JSON string
   */
