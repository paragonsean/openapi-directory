...
public class GetJobDetailsInput {
  ...
  public GetJobDetailsInput() {
  }

  public GetJobDetailsInput jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetJobDetailsInput getJobDetailsInput = (GetJobDetailsInput) o;
    return Objects.equals(this.jobId, getJobDetailsInput.jobId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetJobDetailsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetJobDetailsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetJobDetailsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetJobDetailsInput is not found in the empty JSON string", GetJobDetailsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetJobDetailsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetJobDetailsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetJobDetailsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetJobDetailsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetJobDetailsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetJobDetailsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetJobDetailsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetJobDetailsInput>() {
           @Override
           public void write(JsonWriter out, GetJobDetailsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetJobDetailsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetJobDetailsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetJobDetailsInput
   * @throws IOException if the JSON string is invalid with respect to GetJobDetailsInput
   */
  public static GetJobDetailsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetJobDetailsInput.class);
  }

  /**
   * Convert an instance of GetJobDetailsInput to an JSON string
   *
   * @return JSON string
   */
