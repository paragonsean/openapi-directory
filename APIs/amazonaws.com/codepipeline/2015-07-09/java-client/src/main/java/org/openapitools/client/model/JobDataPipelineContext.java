...
public class JobDataPipelineContext {
  ...
  public JobDataPipelineContext() {
  }

  public JobDataPipelineContext pipelineName(String pipelineName) {
  ...
  public JobDataPipelineContext stage(PipelineContextStage stage) {
    this.stage = stage;
    return this;
  }
  ...
  public JobDataPipelineContext action(PipelineContextAction action) {
    this.action = action;
    return this;
  }
  ...
  public JobDataPipelineContext pipelineArn(String pipelineArn) {
  ...
  public JobDataPipelineContext pipelineExecutionId(String pipelineExecutionId) {
  ...
  public boolean equals(Object o) {
    ...
    JobDataPipelineContext jobDataPipelineContext = (JobDataPipelineContext) o;
    return Objects.equals(this.pipelineName, jobDataPipelineContext.pipelineName) &&
        Objects.equals(this.stage, jobDataPipelineContext.stage) &&
        Objects.equals(this.action, jobDataPipelineContext.action) &&
        Objects.equals(this.pipelineArn, jobDataPipelineContext.pipelineArn) &&
        Objects.equals(this.pipelineExecutionId, jobDataPipelineContext.pipelineExecutionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobDataPipelineContext {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobDataPipelineContext
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobDataPipelineContext.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobDataPipelineContext is not found in the empty JSON string", JobDataPipelineContext.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobDataPipelineContext.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobDataPipelineContext` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobDataPipelineContext.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobDataPipelineContext' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobDataPipelineContext> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobDataPipelineContext.class));

       return (TypeAdapter<T>) new TypeAdapter<JobDataPipelineContext>() {
           @Override
           public void write(JsonWriter out, JobDataPipelineContext value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobDataPipelineContext read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobDataPipelineContext given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobDataPipelineContext
   * @throws IOException if the JSON string is invalid with respect to JobDataPipelineContext
   */
  public static JobDataPipelineContext fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobDataPipelineContext.class);
  }

  /**
   * Convert an instance of JobDataPipelineContext to an JSON string
   *
   * @return JSON string
   */
