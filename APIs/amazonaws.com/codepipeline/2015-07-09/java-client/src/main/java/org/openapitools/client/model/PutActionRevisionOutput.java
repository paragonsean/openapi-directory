...
public class PutActionRevisionOutput {
  public static final String SERIALIZED_NAME_NEW_REVISION = "newRevision";
  @SerializedName(SERIALIZED_NAME_NEW_REVISION)
  ...
  public PutActionRevisionOutput newRevision(Boolean newRevision) {
  ...
  public PutActionRevisionOutput pipelineExecutionId(String pipelineExecutionId) {
  ...
  public boolean equals(Object o) {
    ...
    PutActionRevisionOutput putActionRevisionOutput = (PutActionRevisionOutput) o;
    return Objects.equals(this.newRevision, putActionRevisionOutput.newRevision) &&
        Objects.equals(this.pipelineExecutionId, putActionRevisionOutput.pipelineExecutionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(newRevision, pipelineExecutionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutActionRevisionOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutActionRevisionOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutActionRevisionOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutActionRevisionOutput is not found in the empty JSON string", PutActionRevisionOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutActionRevisionOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutActionRevisionOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `newRevision`
      if (jsonObj.get("newRevision") != null && !jsonObj.get("newRevision").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("newRevision"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutActionRevisionOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutActionRevisionOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutActionRevisionOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutActionRevisionOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutActionRevisionOutput>() {
           @Override
           public void write(JsonWriter out, PutActionRevisionOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutActionRevisionOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutActionRevisionOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutActionRevisionOutput
   * @throws IOException if the JSON string is invalid with respect to PutActionRevisionOutput
   */
  public static PutActionRevisionOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutActionRevisionOutput.class);
  }

  /**
   * Convert an instance of PutActionRevisionOutput to an JSON string
   *
   * @return JSON string
   */
