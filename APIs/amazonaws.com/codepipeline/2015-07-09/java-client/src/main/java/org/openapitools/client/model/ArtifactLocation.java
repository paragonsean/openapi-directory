...
import org.openapitools.client.model.ArtifactLocationS3Location;
import org.openapitools.client.model.ArtifactLocationType;
...
public class ArtifactLocation {
  ...
  private ArtifactLocationType type;

  public static final String SERIALIZED_NAME_S3_LOCATION = "s3Location";
  @SerializedName(SERIALIZED_NAME_S3_LOCATION)
  private ArtifactLocationS3Location s3Location;

  public ArtifactLocation() {
  }

  public ArtifactLocation type(ArtifactLocationType type) {
    this.type = type;
    return this;
  }
  ...
  public ArtifactLocationType getType() {
    return type;
  }
  ...
  public ArtifactLocation s3Location(ArtifactLocationS3Location s3Location) {
   ...
   */
  @javax.annotation.Nullable
  public ArtifactLocationS3Location getS3Location() {
    return s3Location;
  }

  public void setS3Location(ArtifactLocationS3Location s3Location) {
    this.s3Location = s3Location;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, artifactLocation.type) &&
        Objects.equals(this.s3Location, artifactLocation.s3Location);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, s3Location);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ArtifactLocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ArtifactLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ArtifactLocation is not found in the empty JSON string", ArtifactLocation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ArtifactLocation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ArtifactLocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `type`
      if (jsonObj.get("type") != null && !jsonObj.get("type").isJsonNull()) {
        ArtifactLocationType.validateJsonElement(jsonObj.get("type"));
      }
      // validate the optional field `s3Location`
      if (jsonObj.get("s3Location") != null && !jsonObj.get("s3Location").isJsonNull()) {
        ArtifactLocationS3Location.validateJsonElement(jsonObj.get("s3Location"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ArtifactLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ArtifactLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ArtifactLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ArtifactLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<ArtifactLocation>() {
           @Override
           public void write(JsonWriter out, ArtifactLocation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ArtifactLocation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ArtifactLocation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ArtifactLocation
   * @throws IOException if the JSON string is invalid with respect to ArtifactLocation
   */
  public static ArtifactLocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ArtifactLocation.class);
  }

  /**
   * Convert an instance of ArtifactLocation to an JSON string
   *
   * @return JSON string
   */
