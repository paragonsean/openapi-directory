...
public class AcknowledgeJobOutput {
  ...
  public AcknowledgeJobOutput status(JobStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AcknowledgeJobOutput acknowledgeJobOutput = (AcknowledgeJobOutput) o;
    return Objects.equals(this.status, acknowledgeJobOutput.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class AcknowledgeJobOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AcknowledgeJobOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AcknowledgeJobOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AcknowledgeJobOutput is not found in the empty JSON string", AcknowledgeJobOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AcknowledgeJobOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AcknowledgeJobOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AcknowledgeJobOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AcknowledgeJobOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AcknowledgeJobOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AcknowledgeJobOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<AcknowledgeJobOutput>() {
           @Override
           public void write(JsonWriter out, AcknowledgeJobOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AcknowledgeJobOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AcknowledgeJobOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AcknowledgeJobOutput
   * @throws IOException if the JSON string is invalid with respect to AcknowledgeJobOutput
   */
  public static AcknowledgeJobOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AcknowledgeJobOutput.class);
  }

  /**
   * Convert an instance of AcknowledgeJobOutput to an JSON string
   *
   * @return JSON string
   */
