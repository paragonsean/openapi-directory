...
public class ActionTypeDeclarationId {
  ...
  public ActionTypeDeclarationId() {
  }

  public ActionTypeDeclarationId category(ActionCategory category) {
  ...
  public ActionTypeDeclarationId owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public ActionTypeDeclarationId provider(String provider) {
  ...
  public ActionTypeDeclarationId version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    ActionTypeDeclarationId actionTypeDeclarationId = (ActionTypeDeclarationId) o;
    return Objects.equals(this.category, actionTypeDeclarationId.category) &&
        Objects.equals(this.owner, actionTypeDeclarationId.owner) &&
        Objects.equals(this.provider, actionTypeDeclarationId.provider) &&
        Objects.equals(this.version, actionTypeDeclarationId.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(category, owner, provider, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ActionTypeDeclarationId {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionTypeDeclarationId
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionTypeDeclarationId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionTypeDeclarationId is not found in the empty JSON string", ActionTypeDeclarationId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionTypeDeclarationId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionTypeDeclarationId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionTypeDeclarationId.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionTypeDeclarationId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionTypeDeclarationId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionTypeDeclarationId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionTypeDeclarationId.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionTypeDeclarationId>() {
           @Override
           public void write(JsonWriter out, ActionTypeDeclarationId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionTypeDeclarationId read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionTypeDeclarationId given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionTypeDeclarationId
   * @throws IOException if the JSON string is invalid with respect to ActionTypeDeclarationId
   */
  public static ActionTypeDeclarationId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionTypeDeclarationId.class);
  }

  /**
   * Convert an instance of ActionTypeDeclarationId to an JSON string
   *
   * @return JSON string
   */
