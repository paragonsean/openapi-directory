...
public class PutJobSuccessResultInputExecutionDetails {
  ...
  public PutJobSuccessResultInputExecutionDetails() {
  }

  public PutJobSuccessResultInputExecutionDetails summary(String summary) {
  ...
  public PutJobSuccessResultInputExecutionDetails externalExecutionId(String externalExecutionId) {
  ...
  public PutJobSuccessResultInputExecutionDetails percentComplete(Integer percentComplete) {
  ...
  public boolean equals(Object o) {
    ...
    PutJobSuccessResultInputExecutionDetails putJobSuccessResultInputExecutionDetails = (PutJobSuccessResultInputExecutionDetails) o;
    return Objects.equals(this.summary, putJobSuccessResultInputExecutionDetails.summary) &&
        Objects.equals(this.externalExecutionId, putJobSuccessResultInputExecutionDetails.externalExecutionId) &&
        Objects.equals(this.percentComplete, putJobSuccessResultInputExecutionDetails.percentComplete);
  }

  @Override
  public int hashCode() {
    return Objects.hash(summary, externalExecutionId, percentComplete);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutJobSuccessResultInputExecutionDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutJobSuccessResultInputExecutionDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutJobSuccessResultInputExecutionDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutJobSuccessResultInputExecutionDetails is not found in the empty JSON string", PutJobSuccessResultInputExecutionDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutJobSuccessResultInputExecutionDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutJobSuccessResultInputExecutionDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutJobSuccessResultInputExecutionDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutJobSuccessResultInputExecutionDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutJobSuccessResultInputExecutionDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutJobSuccessResultInputExecutionDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<PutJobSuccessResultInputExecutionDetails>() {
           @Override
           public void write(JsonWriter out, PutJobSuccessResultInputExecutionDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutJobSuccessResultInputExecutionDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutJobSuccessResultInputExecutionDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutJobSuccessResultInputExecutionDetails
   * @throws IOException if the JSON string is invalid with respect to PutJobSuccessResultInputExecutionDetails
   */
  public static PutJobSuccessResultInputExecutionDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutJobSuccessResultInputExecutionDetails.class);
  }

  /**
   * Convert an instance of PutJobSuccessResultInputExecutionDetails to an JSON string
   *
   * @return JSON string
   */
