...
/**
 * Gets or Sets EncryptionKeyType
 */
@JsonAdapter(EncryptionKeyType.Adapter.class)
public enum EncryptionKeyType {
  ...
  public static EncryptionKeyType fromValue(String value) {
    for (EncryptionKeyType b : EncryptionKeyType.values()) {
  ...
  public static class Adapter extends TypeAdapter<EncryptionKeyType> {
    @Override
    public void write(final JsonWriter jsonWriter, final EncryptionKeyType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EncryptionKeyType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EncryptionKeyType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EncryptionKeyType.fromValue(value);
  }
}
