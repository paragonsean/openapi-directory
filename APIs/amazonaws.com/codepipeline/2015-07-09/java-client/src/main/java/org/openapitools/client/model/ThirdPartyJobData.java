...
public class ThirdPartyJobData {
  ...
  public ThirdPartyJobData actionTypeId(PollForJobsInputActionTypeId actionTypeId) {
  ...
  public ThirdPartyJobData actionConfiguration(JobDataActionConfiguration actionConfiguration) {
  ...
  public ThirdPartyJobData pipelineContext(ThirdPartyJobDataPipelineContext pipelineContext) {
  ...
  public ThirdPartyJobData inputArtifacts(List inputArtifacts) {
  ...
  public ThirdPartyJobData outputArtifacts(List outputArtifacts) {
  ...
  public ThirdPartyJobData artifactCredentials(ThirdPartyJobDataArtifactCredentials artifactCredentials) {
  ...
  public ThirdPartyJobData continuationToken(String continuationToken) {
  ...
  public ThirdPartyJobData encryptionKey(ThirdPartyJobDataEncryptionKey encryptionKey) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyJobData thirdPartyJobData = (ThirdPartyJobData) o;
    return Objects.equals(this.actionTypeId, thirdPartyJobData.actionTypeId) &&
        Objects.equals(this.actionConfiguration, thirdPartyJobData.actionConfiguration) &&
        Objects.equals(this.pipelineContext, thirdPartyJobData.pipelineContext) &&
        Objects.equals(this.inputArtifacts, thirdPartyJobData.inputArtifacts) &&
        Objects.equals(this.outputArtifacts, thirdPartyJobData.outputArtifacts) &&
        Objects.equals(this.artifactCredentials, thirdPartyJobData.artifactCredentials) &&
        Objects.equals(this.continuationToken, thirdPartyJobData.continuationToken) &&
        Objects.equals(this.encryptionKey, thirdPartyJobData.encryptionKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class ThirdPartyJobData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ThirdPartyJobData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ThirdPartyJobData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyJobData is not found in the empty JSON string", ThirdPartyJobData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ThirdPartyJobData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ThirdPartyJobData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyJobData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyJobData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyJobData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyJobData.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyJobData>() {
           @Override
           public void write(JsonWriter out, ThirdPartyJobData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ThirdPartyJobData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ThirdPartyJobData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ThirdPartyJobData
   * @throws IOException if the JSON string is invalid with respect to ThirdPartyJobData
   */
  public static ThirdPartyJobData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyJobData.class);
  }

  /**
   * Convert an instance of ThirdPartyJobData to an JSON string
   *
   * @return JSON string
   */
