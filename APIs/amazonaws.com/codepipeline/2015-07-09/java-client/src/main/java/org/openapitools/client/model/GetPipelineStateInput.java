...
public class GetPipelineStateInput {
  ...
  public GetPipelineStateInput() {
  }

  public GetPipelineStateInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPipelineStateInput getPipelineStateInput = (GetPipelineStateInput) o;
    return Objects.equals(this.name, getPipelineStateInput.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPipelineStateInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPipelineStateInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPipelineStateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPipelineStateInput is not found in the empty JSON string", GetPipelineStateInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPipelineStateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPipelineStateInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPipelineStateInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPipelineStateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPipelineStateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPipelineStateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPipelineStateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPipelineStateInput>() {
           @Override
           public void write(JsonWriter out, GetPipelineStateInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPipelineStateInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPipelineStateInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPipelineStateInput
   * @throws IOException if the JSON string is invalid with respect to GetPipelineStateInput
   */
  public static GetPipelineStateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPipelineStateInput.class);
  }

  /**
   * Convert an instance of GetPipelineStateInput to an JSON string
   *
   * @return JSON string
   */
