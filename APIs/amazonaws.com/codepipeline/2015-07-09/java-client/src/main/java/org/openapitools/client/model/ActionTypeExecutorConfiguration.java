...
public class ActionTypeExecutorConfiguration {
  ...
  public ActionTypeExecutorConfiguration() {
  }

  public ActionTypeExecutorConfiguration lambdaExecutorConfiguration(ExecutorConfigurationLambdaExecutorConfiguration lambdaExecutorConfiguration) {
  ...
  public ActionTypeExecutorConfiguration jobWorkerExecutorConfiguration(ExecutorConfigurationJobWorkerExecutorConfiguration jobWorkerExecutorConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    ActionTypeExecutorConfiguration actionTypeExecutorConfiguration = (ActionTypeExecutorConfiguration) o;
    return Objects.equals(this.lambdaExecutorConfiguration, actionTypeExecutorConfiguration.lambdaExecutorConfiguration) &&
        Objects.equals(this.jobWorkerExecutorConfiguration, actionTypeExecutorConfiguration.jobWorkerExecutorConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionTypeExecutorConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionTypeExecutorConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionTypeExecutorConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionTypeExecutorConfiguration is not found in the empty JSON string", ActionTypeExecutorConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionTypeExecutorConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionTypeExecutorConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionTypeExecutorConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionTypeExecutorConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionTypeExecutorConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionTypeExecutorConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionTypeExecutorConfiguration>() {
           @Override
           public void write(JsonWriter out, ActionTypeExecutorConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionTypeExecutorConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionTypeExecutorConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionTypeExecutorConfiguration
   * @throws IOException if the JSON string is invalid with respect to ActionTypeExecutorConfiguration
   */
  public static ActionTypeExecutorConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionTypeExecutorConfiguration.class);
  }

  /**
   * Convert an instance of ActionTypeExecutorConfiguration to an JSON string
   *
   * @return JSON string
   */
