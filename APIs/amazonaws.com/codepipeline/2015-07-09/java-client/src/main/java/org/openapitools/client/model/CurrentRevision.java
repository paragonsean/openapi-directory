...
public class CurrentRevision {
  ...
  public static final String SERIALIZED_NAME_CHANGE_IDENTIFIER = "changeIdentifier";
  @SerializedName(SERIALIZED_NAME_CHANGE_IDENTIFIER)
  ...
  public CurrentRevision revision(String revision) {
  ...
  public CurrentRevision changeIdentifier(String changeIdentifier) {
  ...
  public CurrentRevision created(OffsetDateTime created) {
  ...
  public CurrentRevision revisionSummary(String revisionSummary) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.revision, currentRevision.revision) &&
        Objects.equals(this.changeIdentifier, currentRevision.changeIdentifier) &&
        Objects.equals(this.created, currentRevision.created) &&
        Objects.equals(this.revisionSummary, currentRevision.revisionSummary);
  }

  @Override
  public int hashCode() {
    return Objects.hash(revision, changeIdentifier, created, revisionSummary);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CurrentRevision {\n");
    sb.append("    revision: ").append(toIndentedString(revision)).append("\n");
    sb.append("    changeIdentifier: ").append(toIndentedString(changeIdentifier)).append("\n");
  ...
  static {
    ...
    openapiFields.add("changeIdentifier");
    ...
    openapiRequiredFields.add("changeIdentifier");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrentRevision
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrentRevision.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrentRevision is not found in the empty JSON string", CurrentRevision.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrentRevision.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrentRevision` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CurrentRevision.openapiRequiredFields) {
      ...
      // validate the required field `changeIdentifier`
      String.validateJsonElement(jsonObj.get("changeIdentifier"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrentRevision.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrentRevision' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrentRevision> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrentRevision.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrentRevision>() {
           @Override
           public void write(JsonWriter out, CurrentRevision value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrentRevision read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrentRevision given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrentRevision
   * @throws IOException if the JSON string is invalid with respect to CurrentRevision
   */
  public static CurrentRevision fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrentRevision.class);
  }

  /**
   * Convert an instance of CurrentRevision to an JSON string
   *
   * @return JSON string
   */
