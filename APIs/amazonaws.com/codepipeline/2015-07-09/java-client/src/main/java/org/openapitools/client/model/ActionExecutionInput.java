...
public class ActionExecutionInput {
  ...
  public static final String SERIALIZED_NAME_RESOLVED_CONFIGURATION = "resolvedConfiguration";
  @SerializedName(SERIALIZED_NAME_RESOLVED_CONFIGURATION)
  private Map resolvedConfiguration;
  ...
  public ActionExecutionInput actionTypeId(ActionTypeId actionTypeId) {
  ...
  public ActionExecutionInput _configuration(Map _configuration) {
  ...
  public ActionExecutionInput resolvedConfiguration(Map resolvedConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public Map getResolvedConfiguration() {
    return resolvedConfiguration;
  }

  public void setResolvedConfiguration(Map resolvedConfiguration) {
    this.resolvedConfiguration = resolvedConfiguration;
  }


  public ActionExecutionInput roleArn(String roleArn) {
  ...
  public ActionExecutionInput region(String region) {
    this.region = region;
    return this;
  }
  ...
  public ActionExecutionInput inputArtifacts(List inputArtifacts) {
  ...
  public ActionExecutionInput namespace(String namespace) {
  ...
  public boolean equals(Object o) {
    ...
    ActionExecutionInput actionExecutionInput = (ActionExecutionInput) o;
    return Objects.equals(this.actionTypeId, actionExecutionInput.actionTypeId) &&
        Objects.equals(this._configuration, actionExecutionInput._configuration) &&
        Objects.equals(this.resolvedConfiguration, actionExecutionInput.resolvedConfiguration) &&
        Objects.equals(this.roleArn, actionExecutionInput.roleArn) &&
        Objects.equals(this.region, actionExecutionInput.region) &&
        Objects.equals(this.inputArtifacts, actionExecutionInput.inputArtifacts) &&
        Objects.equals(this.namespace, actionExecutionInput.namespace);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actionTypeId, _configuration, resolvedConfiguration, roleArn, region, inputArtifacts, namespace);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ActionExecutionInput {\n");
    sb.append("    actionTypeId: ").append(toIndentedString(actionTypeId)).append("\n");
    sb.append("    _configuration: ").append(toIndentedString(_configuration)).append("\n");
    sb.append("    resolvedConfiguration: ").append(toIndentedString(resolvedConfiguration)).append("\n");
  ...
  static {
    ...
    openapiFields.add("resolvedConfiguration");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionExecutionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionExecutionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionExecutionInput is not found in the empty JSON string", ActionExecutionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionExecutionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionExecutionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `actionTypeId`
      if (jsonObj.get("actionTypeId") != null && !jsonObj.get("actionTypeId").isJsonNull()) {
        ActionTypeId.validateJsonElement(jsonObj.get("actionTypeId"));
      }
      // validate the optional field `configuration`
      if (jsonObj.get("configuration") != null && !jsonObj.get("configuration").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("configuration"));
      }
      // validate the optional field `resolvedConfiguration`
      if (jsonObj.get("resolvedConfiguration") != null && !jsonObj.get("resolvedConfiguration").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("resolvedConfiguration"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionExecutionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionExecutionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionExecutionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionExecutionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionExecutionInput>() {
           @Override
           public void write(JsonWriter out, ActionExecutionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionExecutionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionExecutionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionExecutionInput
   * @throws IOException if the JSON string is invalid with respect to ActionExecutionInput
   */
  public static ActionExecutionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionExecutionInput.class);
  }

  /**
   * Convert an instance of ActionExecutionInput to an JSON string
   *
   * @return JSON string
   */
