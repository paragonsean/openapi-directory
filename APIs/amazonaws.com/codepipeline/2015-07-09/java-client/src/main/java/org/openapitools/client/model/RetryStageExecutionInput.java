...
import org.openapitools.client.model.StageRetryMode;
...
public class RetryStageExecutionInput {
  ...
  public static final String SERIALIZED_NAME_RETRY_MODE = "retryMode";
  @SerializedName(SERIALIZED_NAME_RETRY_MODE)
  private StageRetryMode retryMode;

  public RetryStageExecutionInput() {
  }

  public RetryStageExecutionInput pipelineName(String pipelineName) {
  ...
  public RetryStageExecutionInput stageName(String stageName) {
  ...
  public RetryStageExecutionInput pipelineExecutionId(String pipelineExecutionId) {
  ...
  public RetryStageExecutionInput retryMode(StageRetryMode retryMode) {
   ...
   */
  @javax.annotation.Nonnull
  public StageRetryMode getRetryMode() {
    return retryMode;
  }
  ...
  public boolean equals(Object o) {
    ...
    RetryStageExecutionInput retryStageExecutionInput = (RetryStageExecutionInput) o;
    return Objects.equals(this.pipelineName, retryStageExecutionInput.pipelineName) &&
        Objects.equals(this.stageName, retryStageExecutionInput.stageName) &&
        Objects.equals(this.pipelineExecutionId, retryStageExecutionInput.pipelineExecutionId) &&
        Objects.equals(this.retryMode, retryStageExecutionInput.retryMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineName, stageName, pipelineExecutionId, retryMode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RetryStageExecutionInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("retryMode");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetryStageExecutionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetryStageExecutionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetryStageExecutionInput is not found in the empty JSON string", RetryStageExecutionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetryStageExecutionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetryStageExecutionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RetryStageExecutionInput.openapiRequiredFields) {
      ...
      // validate the required field `retryMode`
      StageRetryMode.validateJsonElement(jsonObj.get("retryMode"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetryStageExecutionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetryStageExecutionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetryStageExecutionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetryStageExecutionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<RetryStageExecutionInput>() {
           @Override
           public void write(JsonWriter out, RetryStageExecutionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetryStageExecutionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetryStageExecutionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetryStageExecutionInput
   * @throws IOException if the JSON string is invalid with respect to RetryStageExecutionInput
   */
  public static RetryStageExecutionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetryStageExecutionInput.class);
  }

  /**
   * Convert an instance of RetryStageExecutionInput to an JSON string
   *
   * @return JSON string
   */
