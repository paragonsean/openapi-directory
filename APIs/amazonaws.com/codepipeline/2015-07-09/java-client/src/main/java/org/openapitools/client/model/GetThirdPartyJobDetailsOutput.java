...
public class GetThirdPartyJobDetailsOutput {
  ...
  private GetThirdPartyJobDetailsOutputJobDetails jobDetails;

  public GetThirdPartyJobDetailsOutput() {
  }

  public GetThirdPartyJobDetailsOutput jobDetails(GetThirdPartyJobDetailsOutputJobDetails jobDetails) {
  ...
  public GetThirdPartyJobDetailsOutputJobDetails getJobDetails() {
    return jobDetails;
  }

  public void setJobDetails(GetThirdPartyJobDetailsOutputJobDetails jobDetails) {
    this.jobDetails = jobDetails;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetThirdPartyJobDetailsOutput getThirdPartyJobDetailsOutput = (GetThirdPartyJobDetailsOutput) o;
    return Objects.equals(this.jobDetails, getThirdPartyJobDetailsOutput.jobDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetThirdPartyJobDetailsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetThirdPartyJobDetailsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetThirdPartyJobDetailsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetThirdPartyJobDetailsOutput is not found in the empty JSON string", GetThirdPartyJobDetailsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetThirdPartyJobDetailsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetThirdPartyJobDetailsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `jobDetails`
      if (jsonObj.get("jobDetails") != null && !jsonObj.get("jobDetails").isJsonNull()) {
        GetThirdPartyJobDetailsOutputJobDetails.validateJsonElement(jsonObj.get("jobDetails"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetThirdPartyJobDetailsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetThirdPartyJobDetailsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetThirdPartyJobDetailsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetThirdPartyJobDetailsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetThirdPartyJobDetailsOutput>() {
           @Override
           public void write(JsonWriter out, GetThirdPartyJobDetailsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetThirdPartyJobDetailsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetThirdPartyJobDetailsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetThirdPartyJobDetailsOutput
   * @throws IOException if the JSON string is invalid with respect to GetThirdPartyJobDetailsOutput
   */
  public static GetThirdPartyJobDetailsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetThirdPartyJobDetailsOutput.class);
  }

  /**
   * Convert an instance of GetThirdPartyJobDetailsOutput to an JSON string
   *
   * @return JSON string
   */
