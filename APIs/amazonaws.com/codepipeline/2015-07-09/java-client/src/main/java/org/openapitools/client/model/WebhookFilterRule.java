...
public class WebhookFilterRule {
  ...
  public static final String SERIALIZED_NAME_MATCH_EQUALS = "matchEquals";
  @SerializedName(SERIALIZED_NAME_MATCH_EQUALS)
  private String matchEquals;

  public WebhookFilterRule() {
  }

  public WebhookFilterRule jsonPath(String jsonPath) {
  ...
  public WebhookFilterRule matchEquals(String matchEquals) {
  ...
  public boolean equals(Object o) {
    ...
    WebhookFilterRule webhookFilterRule = (WebhookFilterRule) o;
    return Objects.equals(this.jsonPath, webhookFilterRule.jsonPath) &&
        Objects.equals(this.matchEquals, webhookFilterRule.matchEquals);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jsonPath, matchEquals);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhookFilterRule {\n");
    sb.append("    jsonPath: ").append(toIndentedString(jsonPath)).append("\n");
    sb.append("    matchEquals: ").append(toIndentedString(matchEquals)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookFilterRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookFilterRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookFilterRule is not found in the empty JSON string", WebhookFilterRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookFilterRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookFilterRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookFilterRule.openapiRequiredFields) {
      ...
      if (jsonObj.get("matchEquals") != null && !jsonObj.get("matchEquals").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("matchEquals"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookFilterRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookFilterRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookFilterRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookFilterRule.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookFilterRule>() {
           @Override
           public void write(JsonWriter out, WebhookFilterRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookFilterRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebhookFilterRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebhookFilterRule
   * @throws IOException if the JSON string is invalid with respect to WebhookFilterRule
   */
  public static WebhookFilterRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookFilterRule.class);
  }

  /**
   * Convert an instance of WebhookFilterRule to an JSON string
   *
   * @return JSON string
   */
