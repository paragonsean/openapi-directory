...
public class StageStateLatestExecution {
  ...
  public StageStateLatestExecution() {
  }

  public StageStateLatestExecution pipelineExecutionId(String pipelineExecutionId) {
  ...
  public StageStateLatestExecution status(StageExecutionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StageStateLatestExecution stageStateLatestExecution = (StageStateLatestExecution) o;
    return Objects.equals(this.pipelineExecutionId, stageStateLatestExecution.pipelineExecutionId) &&
        Objects.equals(this.status, stageStateLatestExecution.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pipelineExecutionId, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StageStateLatestExecution {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StageStateLatestExecution
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StageStateLatestExecution.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StageStateLatestExecution is not found in the empty JSON string", StageStateLatestExecution.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StageStateLatestExecution.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StageStateLatestExecution` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StageStateLatestExecution.openapiRequiredFields) {
      ...
      StageExecutionStatus.validateJsonElement(jsonObj.get("status"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StageStateLatestExecution.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StageStateLatestExecution' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StageStateLatestExecution> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StageStateLatestExecution.class));

       return (TypeAdapter<T>) new TypeAdapter<StageStateLatestExecution>() {
           @Override
           public void write(JsonWriter out, StageStateLatestExecution value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StageStateLatestExecution read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StageStateLatestExecution given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StageStateLatestExecution
   * @throws IOException if the JSON string is invalid with respect to StageStateLatestExecution
   */
  public static StageStateLatestExecution fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StageStateLatestExecution.class);
  }

  /**
   * Convert an instance of StageStateLatestExecution to an JSON string
   *
   * @return JSON string
   */
