...
public class ThirdPartyJob {
  ...
  public ThirdPartyJob clientId(String clientId) {
  ...
  public ThirdPartyJob jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyJob thirdPartyJob = (ThirdPartyJob) o;
    return Objects.equals(this.clientId, thirdPartyJob.clientId) &&
        Objects.equals(this.jobId, thirdPartyJob.jobId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ThirdPartyJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ThirdPartyJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyJob is not found in the empty JSON string", ThirdPartyJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ThirdPartyJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ThirdPartyJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyJob.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyJob>() {
           @Override
           public void write(JsonWriter out, ThirdPartyJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ThirdPartyJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ThirdPartyJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ThirdPartyJob
   * @throws IOException if the JSON string is invalid with respect to ThirdPartyJob
   */
  public static ThirdPartyJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyJob.class);
  }

  /**
   * Convert an instance of ThirdPartyJob to an JSON string
   *
   * @return JSON string
   */
