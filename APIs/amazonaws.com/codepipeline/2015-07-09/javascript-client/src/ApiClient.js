...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://codepipeline.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://codepipeline.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2015-07-09/Javascript'
        };
