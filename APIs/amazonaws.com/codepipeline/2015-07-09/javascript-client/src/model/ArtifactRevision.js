...
class ArtifactRevision {
    ...
    constructor() { 
        ...
        ArtifactRevision.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('revisionChangeIdentifier')) {
                obj['revisionChangeIdentifier'] = ApiClient.convertToType(data['revisionChangeIdentifier'], 'String');
            }
            ...
            if (data.hasOwnProperty('revisionUrl')) {
                obj['revisionUrl'] = ApiClient.convertToType(data['revisionUrl'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ArtifactRevision</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ArtifactRevision</code>.
     */
    static validateJSON(data) {
        ...
        if (data['revisionChangeIdentifier']) { // data not null
          String.validateJSON(data['revisionChangeIdentifier']);
        }
        ...
        if (data['revisionUrl']) { // data not null
          String.validateJSON(data['revisionUrl']);
        }
 ...
 * @member {String} name
 */
ArtifactRevision.prototype['name'] = undefined;

/**
 * @member {String} revisionId
 */
ArtifactRevision.prototype['revisionId'] = undefined;

/**
 * @member {String} revisionChangeIdentifier
 */
ArtifactRevision.prototype['revisionChangeIdentifier'] = undefined;

/**
 * @member {String} revisionSummary
 */
ArtifactRevision.prototype['revisionSummary'] = undefined;

/**
 * @member {Date} created
 */
ArtifactRevision.prototype['created'] = undefined;

/**
 * @member {String} revisionUrl
 */
ArtifactRevision.prototype['revisionUrl'] = undefined;
...
export default ArtifactRevision;
