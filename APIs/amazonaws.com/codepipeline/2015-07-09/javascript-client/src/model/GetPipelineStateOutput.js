...
/**
 * The GetPipelineStateOutput model module.
 * @module model/GetPipelineStateOutput
 * @version 2015-07-09
 */
class GetPipelineStateOutput {
    /**
     * Constructs a new <code>GetPipelineStateOutput</code>.
     * Represents the output of a &lt;code&gt;GetPipelineState&lt;/code&gt; action.
     * @alias module:model/GetPipelineStateOutput
     */
    constructor() { 
        
        GetPipelineStateOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPipelineStateOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPipelineStateOutput} obj Optional instance to populate.
     * @return {module:model/GetPipelineStateOutput} The populated <code>GetPipelineStateOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPipelineStateOutput();
            ...
            if (data.hasOwnProperty('stageStates')) {
                obj['stageStates'] = ApiClient.convertToType(data['stageStates'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPipelineStateOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPipelineStateOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['stageStates']) { // data not null
          Array.validateJSON(data['stageStates']);
        }
 ...
 */
GetPipelineStateOutput.prototype['pipelineName'] = undefined;

/**
 * @member {Number} pipelineVersion
 */
GetPipelineStateOutput.prototype['pipelineVersion'] = undefined;

/**
 * @member {Array} stageStates
 */
GetPipelineStateOutput.prototype['stageStates'] = undefined;

/**
 * @member {Date} created
 */
GetPipelineStateOutput.prototype['created'] = undefined;

/**
 * @member {Date} updated
 */
GetPipelineStateOutput.prototype['updated'] = undefined;
...
export default GetPipelineStateOutput;
