...
/**
 * The ListWebhooksInput model module.
 * @module model/ListWebhooksInput
 * @version 2015-07-09
 */
class ListWebhooksInput {
    /**
     * Constructs a new <code>ListWebhooksInput</code>.
     * @alias module:model/ListWebhooksInput
     */
    constructor() { 
        
        ListWebhooksInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListWebhooksInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListWebhooksInput} obj Optional instance to populate.
     * @return {module:model/ListWebhooksInput} The populated <code>ListWebhooksInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListWebhooksInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListWebhooksInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListWebhooksInput</code>.
     */
 ...
 */
ListWebhooksInput.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListWebhooksInput.prototype['MaxResults'] = undefined;
...
export default ListWebhooksInput;
