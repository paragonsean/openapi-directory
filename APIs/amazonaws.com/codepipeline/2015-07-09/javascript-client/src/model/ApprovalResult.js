...
/**
 * The ApprovalResult model module.
 * @module model/ApprovalResult
 * @version 2015-07-09
 */
class ApprovalResult {
    /**
     * Constructs a new <code>ApprovalResult</code>.
     * Represents information about the result of an approval request.
     * @alias module:model/ApprovalResult
    ...
    /**
     * Constructs a <code>ApprovalResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApprovalResult} obj Optional instance to populate.
     * @return {module:model/ApprovalResult} The populated <code>ApprovalResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApprovalResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ApprovalResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApprovalResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApprovalResult.RequiredProperties) {
...
ApprovalResult.RequiredProperties = ["summary", "status"];
