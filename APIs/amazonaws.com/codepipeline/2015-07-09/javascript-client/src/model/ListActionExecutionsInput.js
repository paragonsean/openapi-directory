...
import ListActionExecutionsInputFilter from './ListActionExecutionsInputFilter';

/**
 * The ListActionExecutionsInput model module.
 * @module model/ListActionExecutionsInput
 * @version 2015-07-09
 */
class ListActionExecutionsInput {
    /**
     * Constructs a new <code>ListActionExecutionsInput</code>.
     * @alias module:model/ListActionExecutionsInput
     * @param pipelineName {String} 
     */
    constructor(pipelineName) { 
        
        ListActionExecutionsInput.initialize(this, pipelineName);
    }
    ...
    /**
     * Constructs a <code>ListActionExecutionsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListActionExecutionsInput} obj Optional instance to populate.
     * @return {module:model/ListActionExecutionsInput} The populated <code>ListActionExecutionsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListActionExecutionsInput();

            if (data.hasOwnProperty('pipelineName')) {
                obj['pipelineName'] = ApiClient.convertToType(data['pipelineName'], 'String');
            }
            if (data.hasOwnProperty('filter')) {
                obj['filter'] = ListActionExecutionsInputFilter.constructFromObject(data['filter']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListActionExecutionsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListActionExecutionsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListActionExecutionsInput.RequiredProperties) {
        ...
        if (data['filter']) { // data not null
          ListActionExecutionsInputFilter.validateJSON(data['filter']);
        }
...
ListActionExecutionsInput.RequiredProperties = ["pipelineName"];

/**
 * @member {String} pipelineName
 */
ListActionExecutionsInput.prototype['pipelineName'] = undefined;

/**
 * @member {module:model/ListActionExecutionsInputFilter} filter
 */
ListActionExecutionsInput.prototype['filter'] = undefined;

/**
 * @member {Number} maxResults
 */
ListActionExecutionsInput.prototype['maxResults'] = undefined;

/**
 * @member {String} nextToken
 */
ListActionExecutionsInput.prototype['nextToken'] = undefined;
...
export default ListActionExecutionsInput;
