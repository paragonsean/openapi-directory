...
import ListWebhookItemDefinition from './ListWebhookItemDefinition';

/**
 * The PutWebhookOutputWebhook model module.
 * @module model/PutWebhookOutputWebhook
 * @version 2015-07-09
 */
class PutWebhookOutputWebhook {
    /**
     * Constructs a new <code>PutWebhookOutputWebhook</code>.
     * @alias module:model/PutWebhookOutputWebhook
     * @implements module:model/ListWebhookItem
     * @param definition {module:model/ListWebhookItemDefinition} 
     * @param url {String} 
     */
    constructor(definition, url) { 
        ListWebhookItem.initialize(this, definition, url);
        PutWebhookOutputWebhook.initialize(this, definition, url);
    }
     ...
     */
    static initialize(obj, definition, url) { 
        obj['definition'] = definition;
        obj['url'] = url;
    }

    /**
     * Constructs a <code>PutWebhookOutputWebhook</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutWebhookOutputWebhook} obj Optional instance to populate.
     * @return {module:model/PutWebhookOutputWebhook} The populated <code>PutWebhookOutputWebhook</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutWebhookOutputWebhook();
            ListWebhookItem.constructFromObject(data, obj);

            if (data.hasOwnProperty('definition')) {
                obj['definition'] = ListWebhookItemDefinition.constructFromObject(data['definition']);
            }
            ...
            if (data.hasOwnProperty('lastTriggered')) {
                obj['lastTriggered'] = ApiClient.convertToType(data['lastTriggered'], 'Date');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PutWebhookOutputWebhook</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutWebhookOutputWebhook</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutWebhookOutputWebhook.RequiredProperties) {
        ...
        if (data['definition']) { // data not null
          ListWebhookItemDefinition.validateJSON(data['definition']);
        }
        ...
        if (data['lastTriggered']) { // data not null
          Date.validateJSON(data['lastTriggered']);
        }
...
PutWebhookOutputWebhook.RequiredProperties = ["definition", "url"];

/**
 * @member {module:model/ListWebhookItemDefinition} definition
 */
PutWebhookOutputWebhook.prototype['definition'] = undefined;

/**
 * @member {String} url
 */
PutWebhookOutputWebhook.prototype['url'] = undefined;

/**
 * @member {String} errorMessage
 */
PutWebhookOutputWebhook.prototype['errorMessage'] = undefined;

/**
 * @member {String} errorCode
 */
PutWebhookOutputWebhook.prototype['errorCode'] = undefined;

/**
 * @member {Date} lastTriggered
 */
PutWebhookOutputWebhook.prototype['lastTriggered'] = undefined;

/**
 * @member {String} arn
 */
PutWebhookOutputWebhook.prototype['arn'] = undefined;

/**
 * @member {Array} tags
 */
PutWebhookOutputWebhook.prototype['tags'] = undefined;


// Implement ListWebhookItem interface:
/**
 * @member {module:model/ListWebhookItemDefinition} definition
 */
ListWebhookItem.prototype['definition'] = undefined;
/**
 * @member {String} url
 */
ListWebhookItem.prototype['url'] = undefined;
/**
 * @member {String} errorMessage
 */
ListWebhookItem.prototype['errorMessage'] = undefined;
/**
 * @member {String} errorCode
 */
ListWebhookItem.prototype['errorCode'] = undefined;
/**
 * @member {Date} lastTriggered
 */
ListWebhookItem.prototype['lastTriggered'] = undefined;
/**
 * @member {String} arn
 */
ListWebhookItem.prototype['arn'] = undefined;
/**
 * @member {Array} tags
 */
ListWebhookItem.prototype['tags'] = undefined;




export default PutWebhookOutputWebhook;
