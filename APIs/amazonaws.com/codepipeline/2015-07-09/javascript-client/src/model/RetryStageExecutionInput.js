...
import StageRetryMode from './StageRetryMode';

/**
 * The RetryStageExecutionInput model module.
 * @module model/RetryStageExecutionInput
 * @version 2015-07-09
 */
class RetryStageExecutionInput {
    /**
     * Constructs a new <code>RetryStageExecutionInput</code>.
     * Represents the input of a &lt;code&gt;RetryStageExecution&lt;/code&gt; action.
     * @alias module:model/RetryStageExecutionInput
     * @param pipelineName {String} 
     * @param stageName {String} 
     * @param pipelineExecutionId {String} 
     * @param retryMode {module:model/StageRetryMode} 
     */
    constructor(pipelineName, stageName, pipelineExecutionId, retryMode) { 
        
        RetryStageExecutionInput.initialize(this, pipelineName, stageName, pipelineExecutionId, retryMode);
    }
     ...
     */
    static initialize(obj, pipelineName, stageName, pipelineExecutionId, retryMode) { 
        obj['pipelineName'] = pipelineName;
        obj['stageName'] = stageName;
        obj['pipelineExecutionId'] = pipelineExecutionId;
        obj['retryMode'] = retryMode;
    }

    /**
     * Constructs a <code>RetryStageExecutionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RetryStageExecutionInput} obj Optional instance to populate.
     * @return {module:model/RetryStageExecutionInput} The populated <code>RetryStageExecutionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RetryStageExecutionInput();
            ...
            if (data.hasOwnProperty('retryMode')) {
                obj['retryMode'] = ApiClient.convertToType(data['retryMode'], StageRetryMode);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RetryStageExecutionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RetryStageExecutionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RetryStageExecutionInput.RequiredProperties) {
        ...
        // validate the optional field `retryMode`
        if (data['retryMode']) { // data not null
          StageRetryMode.validateJSON(data['retryMode']);
        }
...
RetryStageExecutionInput.RequiredProperties = ["pipelineName", "stageName", "pipelineExecutionId", "retryMode"];

/**
 * @member {String} pipelineName
 */
RetryStageExecutionInput.prototype['pipelineName'] = undefined;

/**
 * @member {String} stageName
 */
RetryStageExecutionInput.prototype['stageName'] = undefined;

/**
 * @member {String} pipelineExecutionId
 */
RetryStageExecutionInput.prototype['pipelineExecutionId'] = undefined;

/**
 * @member {module:model/StageRetryMode} retryMode
 */
RetryStageExecutionInput.prototype['retryMode'] = undefined;
...
export default RetryStageExecutionInput;
