...
/**
 * The ActionExecutionFilter model module.
 * @module model/ActionExecutionFilter
 * @version 2015-07-09
 */
class ActionExecutionFilter {
    /**
     * Constructs a new <code>ActionExecutionFilter</code>.
     * Filter values for the action execution.
     * @alias module:model/ActionExecutionFilter
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ActionExecutionFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionExecutionFilter} obj Optional instance to populate.
     * @return {module:model/ActionExecutionFilter} The populated <code>ActionExecutionFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionExecutionFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionExecutionFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionExecutionFilter</code>.
     */
...
export default ActionExecutionFilter;
