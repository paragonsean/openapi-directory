...
/**
 * The ActionTypeId model module.
 * @module model/ActionTypeId
 * @version 2015-07-09
 */
class ActionTypeId {
    /**
     * Constructs a new <code>ActionTypeId</code>.
     * Represents information about an action type.
     * @alias module:model/ActionTypeId
    ...
    /**
     * Constructs a <code>ActionTypeId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionTypeId} obj Optional instance to populate.
     * @return {module:model/ActionTypeId} The populated <code>ActionTypeId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionTypeId();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionTypeId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionTypeId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionTypeId.RequiredProperties) {
...
ActionTypeId.RequiredProperties = ["category", "owner", "provider", "version"];
