...
/**
 * The StopPipelineExecutionOutput model module.
 * @module model/StopPipelineExecutionOutput
 * @version 2015-07-09
 */
class StopPipelineExecutionOutput {
    /**
     * Constructs a new <code>StopPipelineExecutionOutput</code>.
     * @alias module:model/StopPipelineExecutionOutput
     */
    constructor() { 
        
        StopPipelineExecutionOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StopPipelineExecutionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopPipelineExecutionOutput} obj Optional instance to populate.
     * @return {module:model/StopPipelineExecutionOutput} The populated <code>StopPipelineExecutionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopPipelineExecutionOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>StopPipelineExecutionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopPipelineExecutionOutput</code>.
     */
 ...
 */
StopPipelineExecutionOutput.prototype['pipelineExecutionId'] = undefined;
...
export default StopPipelineExecutionOutput;
