...
import ArtifactDetailS3location from './ArtifactDetailS3location';

/**
 * The ArtifactDetail model module.
 * @module model/ArtifactDetail
 * @version 2015-07-09
 */
class ArtifactDetail {
    /**
     * Constructs a new <code>ArtifactDetail</code>.
     * Artifact details for the action execution, such as the artifact location.
     * @alias module:model/ArtifactDetail
     */
    constructor() { 
        
        ArtifactDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ArtifactDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ArtifactDetail} obj Optional instance to populate.
     * @return {module:model/ArtifactDetail} The populated <code>ArtifactDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArtifactDetail();

            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('s3location')) {
                obj['s3location'] = ArtifactDetailS3location.constructFromObject(data['s3location']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ArtifactDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ArtifactDetail</code>.
     */
    static validateJSON(data) {
        ...
        if (data['s3location']) { // data not null
          ArtifactDetailS3location.validateJSON(data['s3location']);
        }
 ...
 * @member {String} name
 */
ArtifactDetail.prototype['name'] = undefined;

/**
 * @member {module:model/ArtifactDetailS3location} s3location
 */
ArtifactDetail.prototype['s3location'] = undefined;
