...
/**
 * The StartPipelineExecutionOutput model module.
 * @module model/StartPipelineExecutionOutput
 * @version 2015-07-09
 */
class StartPipelineExecutionOutput {
    /**
     * Constructs a new <code>StartPipelineExecutionOutput</code>.
     * Represents the output of a &lt;code&gt;StartPipelineExecution&lt;/code&gt; action.
     * @alias module:model/StartPipelineExecutionOutput
     */
    constructor() { 
        
        StartPipelineExecutionOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartPipelineExecutionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartPipelineExecutionOutput} obj Optional instance to populate.
     * @return {module:model/StartPipelineExecutionOutput} The populated <code>StartPipelineExecutionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartPipelineExecutionOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>StartPipelineExecutionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartPipelineExecutionOutput</code>.
     */
 ...
 */
StartPipelineExecutionOutput.prototype['pipelineExecutionId'] = undefined;
...
export default StartPipelineExecutionOutput;
