...
/**
 * The PipelineMetadata model module.
 * @module model/PipelineMetadata
 * @version 2015-07-09
 */
class PipelineMetadata {
    /**
     * Constructs a new <code>PipelineMetadata</code>.
     * Information about a pipeline.
     * @alias module:model/PipelineMetadata
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>PipelineMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PipelineMetadata} obj Optional instance to populate.
     * @return {module:model/PipelineMetadata} The populated <code>PipelineMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PipelineMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>PipelineMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PipelineMetadata</code>.
     */
