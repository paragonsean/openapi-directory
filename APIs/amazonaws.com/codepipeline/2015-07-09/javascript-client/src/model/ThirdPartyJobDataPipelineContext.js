...
/**
 * The ThirdPartyJobDataPipelineContext model module.
 * @module model/ThirdPartyJobDataPipelineContext
 * @version 2015-07-09
 */
class ThirdPartyJobDataPipelineContext {
    /**
     * Constructs a new <code>ThirdPartyJobDataPipelineContext</code>.
     * @alias module:model/ThirdPartyJobDataPipelineContext
     * @implements module:model/PipelineContext
     */
    constructor() { 
        PipelineContext.initialize(this);
        ThirdPartyJobDataPipelineContext.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ThirdPartyJobDataPipelineContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ThirdPartyJobDataPipelineContext} obj Optional instance to populate.
     * @return {module:model/ThirdPartyJobDataPipelineContext} The populated <code>ThirdPartyJobDataPipelineContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ThirdPartyJobDataPipelineContext();
    ...
    /**
     * Validates the JSON data with respect to <code>ThirdPartyJobDataPipelineContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ThirdPartyJobDataPipelineContext</code>.
     */
 ...
 */
ThirdPartyJobDataPipelineContext.prototype['pipelineName'] = undefined;

/**
 * @member {module:model/PipelineContextStage} stage
 */
ThirdPartyJobDataPipelineContext.prototype['stage'] = undefined;

/**
 * @member {module:model/PipelineContextAction} action
 */
ThirdPartyJobDataPipelineContext.prototype['action'] = undefined;

/**
 * @member {String} pipelineArn
 */
ThirdPartyJobDataPipelineContext.prototype['pipelineArn'] = undefined;

/**
 * @member {String} pipelineExecutionId
 */
ThirdPartyJobDataPipelineContext.prototype['pipelineExecutionId'] = undefined;
...
export default ThirdPartyJobDataPipelineContext;
