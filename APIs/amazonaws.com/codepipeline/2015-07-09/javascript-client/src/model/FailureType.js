...
* @readonly
*/
export default class FailureType {
    ...
    /**
    * Returns a <code>FailureType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FailureType} The enum <code>FailureType</code> value.
    */
