...
/**
 * The GetPipelineOutputMetadata model module.
 * @module model/GetPipelineOutputMetadata
 * @version 2015-07-09
 */
class GetPipelineOutputMetadata {
    /**
     * Constructs a new <code>GetPipelineOutputMetadata</code>.
     * @alias module:model/GetPipelineOutputMetadata
     * @implements module:model/PipelineMetadata
     */
    constructor() { 
        PipelineMetadata.initialize(this);
        GetPipelineOutputMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPipelineOutputMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPipelineOutputMetadata} obj Optional instance to populate.
     * @return {module:model/GetPipelineOutputMetadata} The populated <code>GetPipelineOutputMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPipelineOutputMetadata();
            PipelineMetadata.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('pollingDisabledAt')) {
                obj['pollingDisabledAt'] = ApiClient.convertToType(data['pollingDisabledAt'], 'Date');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPipelineOutputMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPipelineOutputMetadata</code>.
     */
    static validateJSON(data) {
        ...
        if (data['pollingDisabledAt']) { // data not null
          Date.validateJSON(data['pollingDisabledAt']);
        }
 ...
 */
GetPipelineOutputMetadata.prototype['pipelineArn'] = undefined;

/**
 * @member {Date} created
 */
GetPipelineOutputMetadata.prototype['created'] = undefined;

/**
 * @member {Date} updated
 */
GetPipelineOutputMetadata.prototype['updated'] = undefined;

/**
 * @member {Date} pollingDisabledAt
 */
GetPipelineOutputMetadata.prototype['pollingDisabledAt'] = undefined;


// Implement PipelineMetadata interface:
/**
 * @member {String} pipelineArn
 */
PipelineMetadata.prototype['pipelineArn'] = undefined;
/**
 * @member {Date} created
 */
PipelineMetadata.prototype['created'] = undefined;
/**
 * @member {Date} updated
 */
PipelineMetadata.prototype['updated'] = undefined;
/**
 * @member {Date} pollingDisabledAt
 */
PipelineMetadata.prototype['pollingDisabledAt'] = undefined;




export default GetPipelineOutputMetadata;
