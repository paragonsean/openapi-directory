...
/**
 * The PollForThirdPartyJobsInput model module.
 * @module model/PollForThirdPartyJobsInput
 * @version 2015-07-09
 */
class PollForThirdPartyJobsInput {
    /**
     * Constructs a new <code>PollForThirdPartyJobsInput</code>.
     * Represents the input of a &lt;code&gt;PollForThirdPartyJobs&lt;/code&gt; action.
     * @alias module:model/PollForThirdPartyJobsInput
     * @param actionTypeId {module:model/PollForJobsInputActionTypeId} 
     */
    constructor(actionTypeId) { 
        
        PollForThirdPartyJobsInput.initialize(this, actionTypeId);
    }
     ...
     */
    static initialize(obj, actionTypeId) { 
        obj['actionTypeId'] = actionTypeId;
    }

    /**
     * Constructs a <code>PollForThirdPartyJobsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PollForThirdPartyJobsInput} obj Optional instance to populate.
     * @return {module:model/PollForThirdPartyJobsInput} The populated <code>PollForThirdPartyJobsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PollForThirdPartyJobsInput();

            if (data.hasOwnProperty('actionTypeId')) {
                obj['actionTypeId'] = PollForJobsInputActionTypeId.constructFromObject(data['actionTypeId']);
            }
            if (data.hasOwnProperty('maxBatchSize')) {
                obj['maxBatchSize'] = ApiClient.convertToType(data['maxBatchSize'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PollForThirdPartyJobsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PollForThirdPartyJobsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PollForThirdPartyJobsInput.RequiredProperties) {
        ...
        if (data['maxBatchSize']) { // data not null
          Number.validateJSON(data['maxBatchSize']);
        }
...
PollForThirdPartyJobsInput.RequiredProperties = ["actionTypeId"];

/**
 * @member {module:model/PollForJobsInputActionTypeId} actionTypeId
 */
PollForThirdPartyJobsInput.prototype['actionTypeId'] = undefined;

/**
 * @member {Number} maxBatchSize
 */
PollForThirdPartyJobsInput.prototype['maxBatchSize'] = undefined;
...
export default PollForThirdPartyJobsInput;
