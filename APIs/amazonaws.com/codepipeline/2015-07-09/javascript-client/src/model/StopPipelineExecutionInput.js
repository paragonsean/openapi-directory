...
/**
 * The StopPipelineExecutionInput model module.
 * @module model/StopPipelineExecutionInput
 * @version 2015-07-09
 */
class StopPipelineExecutionInput {
    /**
     * Constructs a new <code>StopPipelineExecutionInput</code>.
     * @alias module:model/StopPipelineExecutionInput
     * @param pipelineName {String} 
     * @param pipelineExecutionId {String} 
     */
    constructor(pipelineName, pipelineExecutionId) { 
        
        StopPipelineExecutionInput.initialize(this, pipelineName, pipelineExecutionId);
    }
     ...
     */
    static initialize(obj, pipelineName, pipelineExecutionId) { 
        obj['pipelineName'] = pipelineName;
        obj['pipelineExecutionId'] = pipelineExecutionId;
    }

    /**
     * Constructs a <code>StopPipelineExecutionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopPipelineExecutionInput} obj Optional instance to populate.
     * @return {module:model/StopPipelineExecutionInput} The populated <code>StopPipelineExecutionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopPipelineExecutionInput();
            ...
            if (data.hasOwnProperty('abandon')) {
                obj['abandon'] = ApiClient.convertToType(data['abandon'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StopPipelineExecutionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopPipelineExecutionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StopPipelineExecutionInput.RequiredProperties) {
        ...
        if (data['abandon']) { // data not null
          Boolean.validateJSON(data['abandon']);
        }
...
StopPipelineExecutionInput.RequiredProperties = ["pipelineName", "pipelineExecutionId"];

/**
 * @member {String} pipelineName
 */
StopPipelineExecutionInput.prototype['pipelineName'] = undefined;

/**
 * @member {String} pipelineExecutionId
 */
StopPipelineExecutionInput.prototype['pipelineExecutionId'] = undefined;

/**
 * @member {Boolean} abandon
 */
StopPipelineExecutionInput.prototype['abandon'] = undefined;

/**
 * @member {String} reason
 */
StopPipelineExecutionInput.prototype['reason'] = undefined;
...
export default StopPipelineExecutionInput;
