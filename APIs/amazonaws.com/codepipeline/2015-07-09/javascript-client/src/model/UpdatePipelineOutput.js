...
import UpdatePipelineOutputPipeline from './UpdatePipelineOutputPipeline';

/**
 * The UpdatePipelineOutput model module.
 * @module model/UpdatePipelineOutput
 * @version 2015-07-09
 */
class UpdatePipelineOutput {
    /**
     * Constructs a new <code>UpdatePipelineOutput</code>.
     * Represents the output of an &lt;code&gt;UpdatePipeline&lt;/code&gt; action.
     * @alias module:model/UpdatePipelineOutput
     */
    constructor() { 
        
        UpdatePipelineOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePipelineOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePipelineOutput} obj Optional instance to populate.
     * @return {module:model/UpdatePipelineOutput} The populated <code>UpdatePipelineOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePipelineOutput();

            if (data.hasOwnProperty('pipeline')) {
                obj['pipeline'] = UpdatePipelineOutputPipeline.constructFromObject(data['pipeline']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePipelineOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePipelineOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `pipeline`
        if (data['pipeline']) { // data not null
          UpdatePipelineOutputPipeline.validateJSON(data['pipeline']);
        }
...
/**
 * @member {module:model/UpdatePipelineOutputPipeline} pipeline
 */
UpdatePipelineOutput.prototype['pipeline'] = undefined;
...
export default UpdatePipelineOutput;
