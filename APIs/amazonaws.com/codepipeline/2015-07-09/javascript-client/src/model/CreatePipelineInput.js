...
import CreatePipelineOutputPipeline from './CreatePipelineOutputPipeline';

/**
 * The CreatePipelineInput model module.
 * @module model/CreatePipelineInput
 * @version 2015-07-09
 */
class CreatePipelineInput {
    /**
     * Constructs a new <code>CreatePipelineInput</code>.
     * Represents the input of a &lt;code&gt;CreatePipeline&lt;/code&gt; action.
     * @alias module:model/CreatePipelineInput
     * @param pipeline {module:model/CreatePipelineOutputPipeline} 
     */
    constructor(pipeline) { 
        
        CreatePipelineInput.initialize(this, pipeline);
    }
     ...
     */
    static initialize(obj, pipeline) { 
        obj['pipeline'] = pipeline;
    }

    /**
     * Constructs a <code>CreatePipelineInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePipelineInput} obj Optional instance to populate.
     * @return {module:model/CreatePipelineInput} The populated <code>CreatePipelineInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePipelineInput();

            if (data.hasOwnProperty('pipeline')) {
                obj['pipeline'] = CreatePipelineOutputPipeline.constructFromObject(data['pipeline']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePipelineInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePipelineInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePipelineInput.RequiredProperties) {
        ...
        if (data['pipeline']) { // data not null
          CreatePipelineOutputPipeline.validateJSON(data['pipeline']);
        }
...
CreatePipelineInput.RequiredProperties = ["pipeline"];

/**
 * @member {module:model/CreatePipelineOutputPipeline} pipeline
 */
CreatePipelineInput.prototype['pipeline'] = undefined;

/**
 * @member {Array} tags
 */
CreatePipelineInput.prototype['tags'] = undefined;
...
export default CreatePipelineInput;
