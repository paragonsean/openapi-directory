...
/**
 * The ActionExecutionResult model module.
 * @module model/ActionExecutionResult
 * @version 2015-07-09
 */
class ActionExecutionResult {
    /**
     * Constructs a new <code>ActionExecutionResult</code>.
     * Execution result information, such as the external execution ID.
     * @alias module:model/ActionExecutionResult
     */
    constructor() { 
        
        ActionExecutionResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActionExecutionResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionExecutionResult} obj Optional instance to populate.
     * @return {module:model/ActionExecutionResult} The populated <code>ActionExecutionResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionExecutionResult();
            ...
            if (data.hasOwnProperty('externalExecutionSummary')) {
                obj['externalExecutionSummary'] = ApiClient.convertToType(data['externalExecutionSummary'], 'String');
            }
            if (data.hasOwnProperty('externalExecutionUrl')) {
                obj['externalExecutionUrl'] = ApiClient.convertToType(data['externalExecutionUrl'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ActionExecutionResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionExecutionResult</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `externalExecutionSummary`
        if (data['externalExecutionSummary']) { // data not null
          String.validateJSON(data['externalExecutionSummary']);
        }
        // validate the optional field `externalExecutionUrl`
        if (data['externalExecutionUrl']) { // data not null
          String.validateJSON(data['externalExecutionUrl']);
        }
 ...
 */
ActionExecutionResult.prototype['externalExecutionId'] = undefined;

/**
 * @member {String} externalExecutionSummary
 */
ActionExecutionResult.prototype['externalExecutionSummary'] = undefined;

/**
 * @member {String} externalExecutionUrl
 */
ActionExecutionResult.prototype['externalExecutionUrl'] = undefined;
