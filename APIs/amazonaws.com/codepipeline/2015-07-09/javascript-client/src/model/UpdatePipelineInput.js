...
import UpdatePipelineInputPipeline from './UpdatePipelineInputPipeline';

/**
 * The UpdatePipelineInput model module.
 * @module model/UpdatePipelineInput
 * @version 2015-07-09
 */
class UpdatePipelineInput {
    /**
     * Constructs a new <code>UpdatePipelineInput</code>.
     * Represents the input of an &lt;code&gt;UpdatePipeline&lt;/code&gt; action.
     * @alias module:model/UpdatePipelineInput
     * @param pipeline {module:model/UpdatePipelineInputPipeline} 
     */
    constructor(pipeline) { 
        
        UpdatePipelineInput.initialize(this, pipeline);
    }
    ...
    /**
     * Constructs a <code>UpdatePipelineInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePipelineInput} obj Optional instance to populate.
     * @return {module:model/UpdatePipelineInput} The populated <code>UpdatePipelineInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePipelineInput();

            if (data.hasOwnProperty('pipeline')) {
                obj['pipeline'] = UpdatePipelineInputPipeline.constructFromObject(data['pipeline']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePipelineInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePipelineInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePipelineInput.RequiredProperties) {
        ...
        if (data['pipeline']) { // data not null
          UpdatePipelineInputPipeline.validateJSON(data['pipeline']);
        }
...
UpdatePipelineInput.RequiredProperties = ["pipeline"];

/**
 * @member {module:model/UpdatePipelineInputPipeline} pipeline
 */
UpdatePipelineInput.prototype['pipeline'] = undefined;
...
export default UpdatePipelineInput;
