...
import ActionConfigurationPropertyType from './ActionConfigurationPropertyType';

/**
 * The ActionConfigurationProperty model module.
 * @module model/ActionConfigurationProperty
 * @version 2015-07-09
 */
class ActionConfigurationProperty {
    /**
     * Constructs a new <code>ActionConfigurationProperty</code>.
     * Represents information about an action configuration property.
     * @alias module:model/ActionConfigurationProperty
     * @param name {String} 
     * @param required {Boolean} 
     * @param key {Boolean} 
     * @param secret {Boolean} 
     */
    constructor(name, required, key, secret) { 
        
        ActionConfigurationProperty.initialize(this, name, required, key, secret);
    }
     ...
     */
    static initialize(obj, name, required, key, secret) { 
        obj['name'] = name;
    ...
    /**
     * Constructs a <code>ActionConfigurationProperty</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionConfigurationProperty} obj Optional instance to populate.
     * @return {module:model/ActionConfigurationProperty} The populated <code>ActionConfigurationProperty</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionConfigurationProperty();
            ...
            if (data.hasOwnProperty('type')) {
                obj['type'] = ApiClient.convertToType(data['type'], ActionConfigurationPropertyType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ActionConfigurationProperty</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionConfigurationProperty</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionConfigurationProperty.RequiredProperties) {
        ...
        if (data['secret']) { // data not null
          Boolean.validateJSON(data['secret']);
        }
        ...
        if (data['type']) { // data not null
          ActionConfigurationPropertyType.validateJSON(data['type']);
        }
...
ActionConfigurationProperty.RequiredProperties = ["name", "required", "key", "secret"];

/**
 * @member {String} name
 */
ActionConfigurationProperty.prototype['name'] = undefined;

/**
 * @member {Boolean} required
 */
ActionConfigurationProperty.prototype['required'] = undefined;

/**
 * @member {Boolean} key
 */
ActionConfigurationProperty.prototype['key'] = undefined;

/**
 * @member {Boolean} secret
 */
ActionConfigurationProperty.prototype['secret'] = undefined;

/**
 * @member {Boolean} queryable
 */
ActionConfigurationProperty.prototype['queryable'] = undefined;

/**
 * @member {String} description
 */
ActionConfigurationProperty.prototype['description'] = undefined;

/**
 * @member {module:model/ActionConfigurationPropertyType} type
 */
ActionConfigurationProperty.prototype['type'] = undefined;
...
export default ActionConfigurationProperty;
