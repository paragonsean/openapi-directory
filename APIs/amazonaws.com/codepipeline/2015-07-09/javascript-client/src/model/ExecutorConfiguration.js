...
/**
 * The ExecutorConfiguration model module.
 * @module model/ExecutorConfiguration
 * @version 2015-07-09
 */
class ExecutorConfiguration {
    /**
     * Constructs a new <code>ExecutorConfiguration</code>.
     ...
     * @alias module:model/ExecutorConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ExecutorConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExecutorConfiguration} obj Optional instance to populate.
     * @return {module:model/ExecutorConfiguration} The populated <code>ExecutorConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExecutorConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>ExecutorConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExecutorConfiguration</code>.
     */
...
export default ExecutorConfiguration;
