...
/**
 * The InputArtifact model module.
 * @module model/InputArtifact
 * @version 2015-07-09
 */
class InputArtifact {
    /**
     * Constructs a new <code>InputArtifact</code>.
     * Represents information about an artifact to be worked on, such as a test or build artifact.
     * @alias module:model/InputArtifact
     * @param name {String} 
     */
    constructor(name) { 
        
        InputArtifact.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>InputArtifact</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InputArtifact} obj Optional instance to populate.
     * @return {module:model/InputArtifact} The populated <code>InputArtifact</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InputArtifact();
    ...
    /**
     * Validates the JSON data with respect to <code>InputArtifact</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InputArtifact</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InputArtifact.RequiredProperties) {
...
InputArtifact.RequiredProperties = ["name"];

/**
 * @member {String} name
 */
InputArtifact.prototype['name'] = undefined;
