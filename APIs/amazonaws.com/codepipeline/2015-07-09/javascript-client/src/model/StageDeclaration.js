...
/**
 * The StageDeclaration model module.
 * @module model/StageDeclaration
 * @version 2015-07-09
 */
class StageDeclaration {
    /**
     * Constructs a new <code>StageDeclaration</code>.
     * Represents information about a stage and its definition.
     * @alias module:model/StageDeclaration
     * @param name {String} 
     * @param actions {Array} 
     */
    constructor(name, actions) { 
        
        StageDeclaration.initialize(this, name, actions);
    }
    ...
    /**
     * Constructs a <code>StageDeclaration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StageDeclaration} obj Optional instance to populate.
     * @return {module:model/StageDeclaration} The populated <code>StageDeclaration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StageDeclaration();

            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('blockers')) {
                obj['blockers'] = ApiClient.convertToType(data['blockers'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StageDeclaration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StageDeclaration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StageDeclaration.RequiredProperties) {
        ...
        if (data['blockers']) { // data not null
          Array.validateJSON(data['blockers']);
        }
...
StageDeclaration.RequiredProperties = ["name", "actions"];

/**
 * @member {String} name
 */
StageDeclaration.prototype['name'] = undefined;

/**
 * @member {Array} blockers
 */
StageDeclaration.prototype['blockers'] = undefined;

/**
 * @member {Array} actions
 */
StageDeclaration.prototype['actions'] = undefined;
...
export default StageDeclaration;
