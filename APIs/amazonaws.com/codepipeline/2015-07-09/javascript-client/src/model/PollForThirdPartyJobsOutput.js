...
/**
 * The PollForThirdPartyJobsOutput model module.
 * @module model/PollForThirdPartyJobsOutput
 * @version 2015-07-09
 */
class PollForThirdPartyJobsOutput {
    /**
     * Constructs a new <code>PollForThirdPartyJobsOutput</code>.
     * Represents the output of a &lt;code&gt;PollForThirdPartyJobs&lt;/code&gt; action.
     * @alias module:model/PollForThirdPartyJobsOutput
     */
    constructor() { 
        
        PollForThirdPartyJobsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PollForThirdPartyJobsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PollForThirdPartyJobsOutput} obj Optional instance to populate.
     * @return {module:model/PollForThirdPartyJobsOutput} The populated <code>PollForThirdPartyJobsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PollForThirdPartyJobsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>PollForThirdPartyJobsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PollForThirdPartyJobsOutput</code>.
     */
 ...
 * @member {Array} jobs
 */
PollForThirdPartyJobsOutput.prototype['jobs'] = undefined;
...
export default PollForThirdPartyJobsOutput;
