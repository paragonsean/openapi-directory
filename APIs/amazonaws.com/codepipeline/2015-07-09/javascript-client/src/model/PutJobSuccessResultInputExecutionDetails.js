...
/**
 * The PutJobSuccessResultInputExecutionDetails model module.
 * @module model/PutJobSuccessResultInputExecutionDetails
 * @version 2015-07-09
 */
class PutJobSuccessResultInputExecutionDetails {
    /**
     * Constructs a new <code>PutJobSuccessResultInputExecutionDetails</code>.
     * @alias module:model/PutJobSuccessResultInputExecutionDetails
     * @implements module:model/ExecutionDetails
     */
    constructor() { 
        ExecutionDetails.initialize(this);
        PutJobSuccessResultInputExecutionDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutJobSuccessResultInputExecutionDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutJobSuccessResultInputExecutionDetails} obj Optional instance to populate.
     * @return {module:model/PutJobSuccessResultInputExecutionDetails} The populated <code>PutJobSuccessResultInputExecutionDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutJobSuccessResultInputExecutionDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>PutJobSuccessResultInputExecutionDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutJobSuccessResultInputExecutionDetails</code>.
     */
 ...
 */
PutJobSuccessResultInputExecutionDetails.prototype['summary'] = undefined;

/**
 * @member {String} externalExecutionId
 */
PutJobSuccessResultInputExecutionDetails.prototype['externalExecutionId'] = undefined;

/**
 * @member {Number} percentComplete
 */
PutJobSuccessResultInputExecutionDetails.prototype['percentComplete'] = undefined;
...
export default PutJobSuccessResultInputExecutionDetails;
