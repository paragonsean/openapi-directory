...
/**
 * The GetPipelineExecutionInput model module.
 * @module model/GetPipelineExecutionInput
 * @version 2015-07-09
 */
class GetPipelineExecutionInput {
    /**
     * Constructs a new <code>GetPipelineExecutionInput</code>.
     * Represents the input of a &lt;code&gt;GetPipelineExecution&lt;/code&gt; action.
     * @alias module:model/GetPipelineExecutionInput
     * @param pipelineName {String} 
     * @param pipelineExecutionId {String} 
     */
    constructor(pipelineName, pipelineExecutionId) { 
        
        GetPipelineExecutionInput.initialize(this, pipelineName, pipelineExecutionId);
    }
    ...
    /**
     * Constructs a <code>GetPipelineExecutionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPipelineExecutionInput} obj Optional instance to populate.
     * @return {module:model/GetPipelineExecutionInput} The populated <code>GetPipelineExecutionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPipelineExecutionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPipelineExecutionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPipelineExecutionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPipelineExecutionInput.RequiredProperties) {
...
GetPipelineExecutionInput.RequiredProperties = ["pipelineName", "pipelineExecutionId"];

/**
 * @member {String} pipelineName
 */
GetPipelineExecutionInput.prototype['pipelineName'] = undefined;

/**
 * @member {String} pipelineExecutionId
 */
GetPipelineExecutionInput.prototype['pipelineExecutionId'] = undefined;
...
export default GetPipelineExecutionInput;
