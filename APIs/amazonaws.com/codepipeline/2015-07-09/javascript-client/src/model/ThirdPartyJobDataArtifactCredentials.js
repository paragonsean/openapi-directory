...
/**
 * The ThirdPartyJobDataArtifactCredentials model module.
 * @module model/ThirdPartyJobDataArtifactCredentials
 * @version 2015-07-09
 */
class ThirdPartyJobDataArtifactCredentials {
    /**
     * Constructs a new <code>ThirdPartyJobDataArtifactCredentials</code>.
     * @alias module:model/ThirdPartyJobDataArtifactCredentials
     * @implements module:model/AWSSessionCredentials
    ...
    constructor(accessKeyId, secretAccessKey, sessionToken) { 
        ...
        ThirdPartyJobDataArtifactCredentials.initialize(this, accessKeyId, secretAccessKey, sessionToken);
    }
    ...
    /**
     * Constructs a <code>ThirdPartyJobDataArtifactCredentials</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ThirdPartyJobDataArtifactCredentials} obj Optional instance to populate.
     * @return {module:model/ThirdPartyJobDataArtifactCredentials} The populated <code>ThirdPartyJobDataArtifactCredentials</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ThirdPartyJobDataArtifactCredentials();
            AWSSessionCredentials.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ThirdPartyJobDataArtifactCredentials</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ThirdPartyJobDataArtifactCredentials</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ThirdPartyJobDataArtifactCredentials.RequiredProperties) {
...
ThirdPartyJobDataArtifactCredentials.RequiredProperties = ["accessKeyId", "secretAccessKey", "sessionToken"];

/**
 * @member {String} accessKeyId
 */
ThirdPartyJobDataArtifactCredentials.prototype['accessKeyId'] = undefined;

/**
 * @member {String} secretAccessKey
 */
ThirdPartyJobDataArtifactCredentials.prototype['secretAccessKey'] = undefined;

/**
 * @member {String} sessionToken
 */
ThirdPartyJobDataArtifactCredentials.prototype['sessionToken'] = undefined;


// Implement AWSSessionCredentials interface:
/**
 * @member {String} accessKeyId
 */
...
export default ThirdPartyJobDataArtifactCredentials;
