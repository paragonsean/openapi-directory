...
/**
 * The CreatePipelineOutput model module.
 * @module model/CreatePipelineOutput
 * @version 2015-07-09
 */
class CreatePipelineOutput {
    /**
     * Constructs a new <code>CreatePipelineOutput</code>.
     * Represents the output of a &lt;code&gt;CreatePipeline&lt;/code&gt; action.
     * @alias module:model/CreatePipelineOutput
     */
    constructor() { 
        
        CreatePipelineOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePipelineOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePipelineOutput} obj Optional instance to populate.
     * @return {module:model/CreatePipelineOutput} The populated <code>CreatePipelineOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePipelineOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePipelineOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePipelineOutput</code>.
     */
 ...
 */
CreatePipelineOutput.prototype['pipeline'] = undefined;

/**
 * @member {Array} tags
 */
CreatePipelineOutput.prototype['tags'] = undefined;
...
export default CreatePipelineOutput;
