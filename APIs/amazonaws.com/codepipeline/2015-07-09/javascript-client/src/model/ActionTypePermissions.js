...
/**
 * The ActionTypePermissions model module.
 * @module model/ActionTypePermissions
 * @version 2015-07-09
 */
class ActionTypePermissions {
    /**
     * Constructs a new <code>ActionTypePermissions</code>.
     * Details identifying the users with permissions to use the action type.
     * @alias module:model/ActionTypePermissions
    ...
    /**
     * Constructs a <code>ActionTypePermissions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionTypePermissions} obj Optional instance to populate.
     * @return {module:model/ActionTypePermissions} The populated <code>ActionTypePermissions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionTypePermissions();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionTypePermissions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionTypePermissions</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionTypePermissions.RequiredProperties) {
...
ActionTypePermissions.RequiredProperties = ["allowedAccounts"];
...
export default ActionTypePermissions;
