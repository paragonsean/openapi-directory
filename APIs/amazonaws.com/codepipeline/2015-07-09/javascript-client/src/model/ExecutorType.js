...
* @readonly
*/
export default class ExecutorType {
    ...
    /**
    * Returns a <code>ExecutorType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ExecutorType} The enum <code>ExecutorType</code> value.
    */
