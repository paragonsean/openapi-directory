...
import PutWebhookInputWebhook from './PutWebhookInputWebhook';

/**
 * The PutWebhookInput model module.
 * @module model/PutWebhookInput
 * @version 2015-07-09
 */
class PutWebhookInput {
    /**
     * Constructs a new <code>PutWebhookInput</code>.
     * @alias module:model/PutWebhookInput
     * @param webhook {module:model/PutWebhookInputWebhook} 
     */
    constructor(webhook) { 
        
        PutWebhookInput.initialize(this, webhook);
    }
    ...
    /**
     * Constructs a <code>PutWebhookInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutWebhookInput} obj Optional instance to populate.
     * @return {module:model/PutWebhookInput} The populated <code>PutWebhookInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutWebhookInput();

            if (data.hasOwnProperty('webhook')) {
                obj['webhook'] = PutWebhookInputWebhook.constructFromObject(data['webhook']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PutWebhookInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutWebhookInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutWebhookInput.RequiredProperties) {
        ...
        if (data['webhook']) { // data not null
          PutWebhookInputWebhook.validateJSON(data['webhook']);
        }
...
PutWebhookInput.RequiredProperties = ["webhook"];

/**
 * @member {module:model/PutWebhookInputWebhook} webhook
 */
PutWebhookInput.prototype['webhook'] = undefined;

/**
 * @member {Array} tags
 */
PutWebhookInput.prototype['tags'] = undefined;
...
export default PutWebhookInput;
