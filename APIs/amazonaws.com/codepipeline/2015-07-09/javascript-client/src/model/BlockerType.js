...
* @readonly
*/
export default class BlockerType {
    ...
    /**
    * Returns a <code>BlockerType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/BlockerType} The enum <code>BlockerType</code> value.
    */
