...
/**
 * The CurrentRevision model module.
 * @module model/CurrentRevision
 * @version 2015-07-09
 */
class CurrentRevision {
    /**
     * Constructs a new <code>CurrentRevision</code>.
     * Represents information about a current revision.
     * @alias module:model/CurrentRevision
     * @param revision {String} 
     * @param changeIdentifier {String} 
     */
    constructor(revision, changeIdentifier) { 
        
        CurrentRevision.initialize(this, revision, changeIdentifier);
    }
     ...
     */
    static initialize(obj, revision, changeIdentifier) { 
        obj['revision'] = revision;
        obj['changeIdentifier'] = changeIdentifier;
    }

    /**
     * Constructs a <code>CurrentRevision</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrentRevision} obj Optional instance to populate.
     * @return {module:model/CurrentRevision} The populated <code>CurrentRevision</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrentRevision();

            if (data.hasOwnProperty('revision')) {
                obj['revision'] = ApiClient.convertToType(data['revision'], 'String');
            }
            if (data.hasOwnProperty('changeIdentifier')) {
                obj['changeIdentifier'] = ApiClient.convertToType(data['changeIdentifier'], 'String');
            }
            if (data.hasOwnProperty('created')) {
                obj['created'] = ApiClient.convertToType(data['created'], 'Date');
            }
            if (data.hasOwnProperty('revisionSummary')) {
                obj['revisionSummary'] = ApiClient.convertToType(data['revisionSummary'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CurrentRevision</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrentRevision</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CurrentRevision.RequiredProperties) {
        ...
        // validate the optional field `changeIdentifier`
        if (data['changeIdentifier']) { // data not null
          String.validateJSON(data['changeIdentifier']);
        }
        ...
        if (data['revisionSummary']) { // data not null
          String.validateJSON(data['revisionSummary']);
        }
...
CurrentRevision.RequiredProperties = ["revision", "changeIdentifier"];

/**
 * @member {String} revision
 */
CurrentRevision.prototype['revision'] = undefined;

/**
 * @member {String} changeIdentifier
 */
CurrentRevision.prototype['changeIdentifier'] = undefined;

/**
 * @member {Date} created
 */
CurrentRevision.prototype['created'] = undefined;

/**
 * @member {String} revisionSummary
 */
CurrentRevision.prototype['revisionSummary'] = undefined;
