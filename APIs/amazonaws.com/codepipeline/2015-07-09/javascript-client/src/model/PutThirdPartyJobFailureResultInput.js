...
import PutThirdPartyJobFailureResultInputFailureDetails from './PutThirdPartyJobFailureResultInputFailureDetails';

/**
 * The PutThirdPartyJobFailureResultInput model module.
 * @module model/PutThirdPartyJobFailureResultInput
 * @version 2015-07-09
 */
class PutThirdPartyJobFailureResultInput {
    /**
     * Constructs a new <code>PutThirdPartyJobFailureResultInput</code>.
     * Represents the input of a &lt;code&gt;PutThirdPartyJobFailureResult&lt;/code&gt; action.
     * @alias module:model/PutThirdPartyJobFailureResultInput
     * @param jobId {String} 
     * @param clientToken {String} 
     * @param failureDetails {module:model/PutThirdPartyJobFailureResultInputFailureDetails} 
     */
    constructor(jobId, clientToken, failureDetails) { 
        
        PutThirdPartyJobFailureResultInput.initialize(this, jobId, clientToken, failureDetails);
    }
     ...
     */
    static initialize(obj, jobId, clientToken, failureDetails) { 
        obj['jobId'] = jobId;
    ...
    /**
     * Constructs a <code>PutThirdPartyJobFailureResultInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutThirdPartyJobFailureResultInput} obj Optional instance to populate.
     * @return {module:model/PutThirdPartyJobFailureResultInput} The populated <code>PutThirdPartyJobFailureResultInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutThirdPartyJobFailureResultInput();
            ...
            if (data.hasOwnProperty('failureDetails')) {
                obj['failureDetails'] = PutThirdPartyJobFailureResultInputFailureDetails.constructFromObject(data['failureDetails']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutThirdPartyJobFailureResultInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutThirdPartyJobFailureResultInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutThirdPartyJobFailureResultInput.RequiredProperties) {
        ...
        if (data['failureDetails']) { // data not null
          PutThirdPartyJobFailureResultInputFailureDetails.validateJSON(data['failureDetails']);
        }
...
PutThirdPartyJobFailureResultInput.RequiredProperties = ["jobId", "clientToken", "failureDetails"];

/**
 * @member {String} jobId
 */
PutThirdPartyJobFailureResultInput.prototype['jobId'] = undefined;

/**
 * @member {String} clientToken
 */
PutThirdPartyJobFailureResultInput.prototype['clientToken'] = undefined;

/**
 * @member {module:model/PutThirdPartyJobFailureResultInputFailureDetails} failureDetails
 */
PutThirdPartyJobFailureResultInput.prototype['failureDetails'] = undefined;
...
export default PutThirdPartyJobFailureResultInput;
