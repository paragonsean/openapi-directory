...
/**
 * The StageStateInboundTransitionState model module.
 * @module model/StageStateInboundTransitionState
 * @version 2015-07-09
 */
class StageStateInboundTransitionState {
    /**
     * Constructs a new <code>StageStateInboundTransitionState</code>.
     * @alias module:model/StageStateInboundTransitionState
     * @implements module:model/TransitionState
     */
    constructor() { 
        TransitionState.initialize(this);
        StageStateInboundTransitionState.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StageStateInboundTransitionState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StageStateInboundTransitionState} obj Optional instance to populate.
     * @return {module:model/StageStateInboundTransitionState} The populated <code>StageStateInboundTransitionState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StageStateInboundTransitionState();
            TransitionState.constructFromObject(data, obj);

            if (data.hasOwnProperty('enabled')) {
                obj['enabled'] = ApiClient.convertToType(data['enabled'], 'Boolean');
            }
            if (data.hasOwnProperty('lastChangedBy')) {
                obj['lastChangedBy'] = ApiClient.convertToType(data['lastChangedBy'], 'String');
            }
            if (data.hasOwnProperty('lastChangedAt')) {
                obj['lastChangedAt'] = ApiClient.convertToType(data['lastChangedAt'], 'Date');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StageStateInboundTransitionState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StageStateInboundTransitionState</code>.
     */
    static validateJSON(data) {
        ...
        if (data['lastChangedBy']) { // data not null
          String.validateJSON(data['lastChangedBy']);
        }
        // validate the optional field `lastChangedAt`
        if (data['lastChangedAt']) { // data not null
          Date.validateJSON(data['lastChangedAt']);
        }
        // validate the optional field `disabledReason`
        if (data['disabledReason']) { // data not null
          String.validateJSON(data['disabledReason']);
        }
 ...
 */
StageStateInboundTransitionState.prototype['enabled'] = undefined;

/**
 * @member {String} lastChangedBy
 */
StageStateInboundTransitionState.prototype['lastChangedBy'] = undefined;

/**
 * @member {Date} lastChangedAt
 */
StageStateInboundTransitionState.prototype['lastChangedAt'] = undefined;

/**
 * @member {String} disabledReason
 */
StageStateInboundTransitionState.prototype['disabledReason'] = undefined;


// Implement TransitionState interface:
/**
 * @member {Boolean} enabled
 */
TransitionState.prototype['enabled'] = undefined;
/**
 * @member {String} lastChangedBy
 */
TransitionState.prototype['lastChangedBy'] = undefined;
/**
 * @member {Date} lastChangedAt
 */
TransitionState.prototype['lastChangedAt'] = undefined;
/**
 * @member {String} disabledReason
 */
TransitionState.prototype['disabledReason'] = undefined;




export default StageStateInboundTransitionState;
