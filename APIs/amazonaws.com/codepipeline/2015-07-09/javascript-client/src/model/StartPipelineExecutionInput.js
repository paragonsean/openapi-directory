...
/**
 * The StartPipelineExecutionInput model module.
 * @module model/StartPipelineExecutionInput
 * @version 2015-07-09
 */
class StartPipelineExecutionInput {
    /**
     * Constructs a new <code>StartPipelineExecutionInput</code>.
     * Represents the input of a &lt;code&gt;StartPipelineExecution&lt;/code&gt; action.
     * @alias module:model/StartPipelineExecutionInput
     * @param name {String} 
     */
    constructor(name) { 
        
        StartPipelineExecutionInput.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>StartPipelineExecutionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartPipelineExecutionInput} obj Optional instance to populate.
     * @return {module:model/StartPipelineExecutionInput} The populated <code>StartPipelineExecutionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartPipelineExecutionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>StartPipelineExecutionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartPipelineExecutionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartPipelineExecutionInput.RequiredProperties) {
...
StartPipelineExecutionInput.RequiredProperties = ["name"];

/**
 * @member {String} name
 */
StartPipelineExecutionInput.prototype['name'] = undefined;

/**
 * @member {String} clientRequestToken
 */
StartPipelineExecutionInput.prototype['clientRequestToken'] = undefined;
...
export default StartPipelineExecutionInput;
