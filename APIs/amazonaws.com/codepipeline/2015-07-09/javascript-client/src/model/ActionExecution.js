...
import ActionExecutionErrorDetails from './ActionExecutionErrorDetails';
import ActionExecutionStatus from './ActionExecutionStatus';

/**
 * The ActionExecution model module.
 * @module model/ActionExecution
 * @version 2015-07-09
 */
class ActionExecution {
    /**
     * Constructs a new <code>ActionExecution</code>.
     * Represents information about the run of an action.
     * @alias module:model/ActionExecution
     */
    constructor() { 
        
        ActionExecution.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActionExecution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionExecution} obj Optional instance to populate.
     * @return {module:model/ActionExecution} The populated <code>ActionExecution</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionExecution();
            ...
            if (data.hasOwnProperty('errorDetails')) {
                obj['errorDetails'] = ActionExecutionErrorDetails.constructFromObject(data['errorDetails']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ActionExecution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionExecution</code>.
     */
    static validateJSON(data) {
        ...
        if (data['errorDetails']) { // data not null
          ActionExecutionErrorDetails.validateJSON(data['errorDetails']);
        }
 ...
 */
ActionExecution.prototype['actionExecutionId'] = undefined;

/**
 * @member {module:model/ActionExecutionStatus} status
 */
ActionExecution.prototype['status'] = undefined;

/**
 * @member {String} summary
 */
ActionExecution.prototype['summary'] = undefined;

/**
 * @member {Date} lastStatusChange
 */
ActionExecution.prototype['lastStatusChange'] = undefined;

/**
 * @member {String} token
 */
ActionExecution.prototype['token'] = undefined;

/**
 * @member {String} lastUpdatedBy
 */
ActionExecution.prototype['lastUpdatedBy'] = undefined;

/**
 * @member {String} externalExecutionId
 */
ActionExecution.prototype['externalExecutionId'] = undefined;

/**
 * @member {String} externalExecutionUrl
 */
ActionExecution.prototype['externalExecutionUrl'] = undefined;

/**
 * @member {Number} percentComplete
 */
ActionExecution.prototype['percentComplete'] = undefined;

/**
 * @member {module:model/ActionExecutionErrorDetails} errorDetails
 */
ActionExecution.prototype['errorDetails'] = undefined;
