...
/**
 * The ActionTypeDeclarationId model module.
 * @module model/ActionTypeDeclarationId
 * @version 2015-07-09
 */
class ActionTypeDeclarationId {
    /**
     * Constructs a new <code>ActionTypeDeclarationId</code>.
     * @alias module:model/ActionTypeDeclarationId
     * @implements module:model/ActionTypeIdentifier
    ...
    constructor(category, owner, provider, version) { 
        ActionTypeIdentifier.initialize(this, category, owner, provider, version);
        ActionTypeDeclarationId.initialize(this, category, owner, provider, version);
    }
    ...
    /**
     * Constructs a <code>ActionTypeDeclarationId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionTypeDeclarationId} obj Optional instance to populate.
     * @return {module:model/ActionTypeDeclarationId} The populated <code>ActionTypeDeclarationId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionTypeDeclarationId();
            ActionTypeIdentifier.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ActionTypeDeclarationId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionTypeDeclarationId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionTypeDeclarationId.RequiredProperties) {
...
ActionTypeDeclarationId.RequiredProperties = ["category", "owner", "provider", "version"];

/**
 * @member {module:model/ActionCategory} category
 */
ActionTypeDeclarationId.prototype['category'] = undefined;

/**
 * @member {String} owner
 */
ActionTypeDeclarationId.prototype['owner'] = undefined;

/**
 * @member {String} provider
 */
ActionTypeDeclarationId.prototype['provider'] = undefined;

/**
 * @member {String} version
 */
ActionTypeDeclarationId.prototype['version'] = undefined;


// Implement ActionTypeIdentifier interface:
/**
 * @member {module:model/ActionCategory} category
 */
ActionTypeIdentifier.prototype['category'] = undefined;
/**
 * @member {String} owner
 */
ActionTypeIdentifier.prototype['owner'] = undefined;
/**
 * @member {String} provider
 */
ActionTypeIdentifier.prototype['provider'] = undefined;
/**
 * @member {String} version
 */
ActionTypeIdentifier.prototype['version'] = undefined;




export default ActionTypeDeclarationId;
