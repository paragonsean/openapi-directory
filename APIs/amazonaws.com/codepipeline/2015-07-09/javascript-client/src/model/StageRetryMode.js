...
* @readonly
*/
export default class StageRetryMode {
    ...
    /**
    * Returns a <code>StageRetryMode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StageRetryMode} The enum <code>StageRetryMode</code> value.
    */
