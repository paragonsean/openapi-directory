...
/**
 * The ArtifactStore model module.
 * @module model/ArtifactStore
 * @version 2015-07-09
 */
class ArtifactStore {
    /**
     * Constructs a new <code>ArtifactStore</code>.
     ...
     * @alias module:model/ArtifactStore
    ...
    /**
     * Constructs a <code>ArtifactStore</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ArtifactStore} obj Optional instance to populate.
     * @return {module:model/ArtifactStore} The populated <code>ArtifactStore</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArtifactStore();
    ...
    /**
     * Validates the JSON data with respect to <code>ArtifactStore</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ArtifactStore</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ArtifactStore.RequiredProperties) {
...
ArtifactStore.RequiredProperties = ["type", "location"];
