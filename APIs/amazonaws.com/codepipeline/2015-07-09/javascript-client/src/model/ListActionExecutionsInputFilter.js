...
/**
 * The ListActionExecutionsInputFilter model module.
 * @module model/ListActionExecutionsInputFilter
 * @version 2015-07-09
 */
class ListActionExecutionsInputFilter {
    /**
     * Constructs a new <code>ListActionExecutionsInputFilter</code>.
     * @alias module:model/ListActionExecutionsInputFilter
     * @implements module:model/ActionExecutionFilter
     */
    constructor() { 
        ActionExecutionFilter.initialize(this);
        ListActionExecutionsInputFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListActionExecutionsInputFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListActionExecutionsInputFilter} obj Optional instance to populate.
     * @return {module:model/ListActionExecutionsInputFilter} The populated <code>ListActionExecutionsInputFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListActionExecutionsInputFilter();
            ActionExecutionFilter.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ListActionExecutionsInputFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListActionExecutionsInputFilter</code>.
     */
 ...
 */
ListActionExecutionsInputFilter.prototype['pipelineExecutionId'] = undefined;


// Implement ActionExecutionFilter interface:
/**
 * @member {String} pipelineExecutionId
 */
ActionExecutionFilter.prototype['pipelineExecutionId'] = undefined;




export default ListActionExecutionsInputFilter;
