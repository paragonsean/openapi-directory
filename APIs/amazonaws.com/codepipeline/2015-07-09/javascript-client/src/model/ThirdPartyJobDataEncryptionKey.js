...
/**
 * The ThirdPartyJobDataEncryptionKey model module.
 * @module model/ThirdPartyJobDataEncryptionKey
 * @version 2015-07-09
 */
class ThirdPartyJobDataEncryptionKey {
    /**
     * Constructs a new <code>ThirdPartyJobDataEncryptionKey</code>.
     * @alias module:model/ThirdPartyJobDataEncryptionKey
     * @implements module:model/EncryptionKey
     * @param id {String} 
     * @param type {module:model/EncryptionKeyType} 
     */
    constructor(id, type) { 
        EncryptionKey.initialize(this, id, type);
        ThirdPartyJobDataEncryptionKey.initialize(this, id, type);
    }
    ...
    /**
     * Constructs a <code>ThirdPartyJobDataEncryptionKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ThirdPartyJobDataEncryptionKey} obj Optional instance to populate.
     * @return {module:model/ThirdPartyJobDataEncryptionKey} The populated <code>ThirdPartyJobDataEncryptionKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ThirdPartyJobDataEncryptionKey();
    ...
    /**
     * Validates the JSON data with respect to <code>ThirdPartyJobDataEncryptionKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ThirdPartyJobDataEncryptionKey</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ThirdPartyJobDataEncryptionKey.RequiredProperties) {
...
ThirdPartyJobDataEncryptionKey.RequiredProperties = ["id", "type"];

/**
 * @member {String} id
 */
ThirdPartyJobDataEncryptionKey.prototype['id'] = undefined;

/**
 * @member {module:model/EncryptionKeyType} type
 */
ThirdPartyJobDataEncryptionKey.prototype['type'] = undefined;
...
export default ThirdPartyJobDataEncryptionKey;
