...
/**
 * The StageStateLatestExecution model module.
 * @module model/StageStateLatestExecution
 * @version 2015-07-09
 */
class StageStateLatestExecution {
    /**
     * Constructs a new <code>StageStateLatestExecution</code>.
     * @alias module:model/StageStateLatestExecution
     * @implements module:model/StageExecution
    ...
    constructor(pipelineExecutionId, status) { 
        ...
        StageStateLatestExecution.initialize(this, pipelineExecutionId, status);
    }
    ...
    /**
     * Constructs a <code>StageStateLatestExecution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StageStateLatestExecution} obj Optional instance to populate.
     * @return {module:model/StageStateLatestExecution} The populated <code>StageStateLatestExecution</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StageStateLatestExecution();
            StageExecution.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>StageStateLatestExecution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StageStateLatestExecution</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StageStateLatestExecution.RequiredProperties) {
...
StageStateLatestExecution.RequiredProperties = ["pipelineExecutionId", "status"];

/**
 * @member {String} pipelineExecutionId
 */
StageStateLatestExecution.prototype['pipelineExecutionId'] = undefined;

/**
 * @member {module:model/StageExecutionStatus} status
 */
StageStateLatestExecution.prototype['status'] = undefined;


// Implement StageExecution interface:
/**
 * @member {String} pipelineExecutionId
 */
...
export default StageStateLatestExecution;
