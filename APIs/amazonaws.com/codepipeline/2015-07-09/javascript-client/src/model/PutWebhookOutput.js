...
import PutWebhookOutputWebhook from './PutWebhookOutputWebhook';

/**
 * The PutWebhookOutput model module.
 * @module model/PutWebhookOutput
 * @version 2015-07-09
 */
class PutWebhookOutput {
    /**
     * Constructs a new <code>PutWebhookOutput</code>.
     * @alias module:model/PutWebhookOutput
     */
    constructor() { 
        
        PutWebhookOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutWebhookOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutWebhookOutput} obj Optional instance to populate.
     * @return {module:model/PutWebhookOutput} The populated <code>PutWebhookOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutWebhookOutput();

            if (data.hasOwnProperty('webhook')) {
                obj['webhook'] = PutWebhookOutputWebhook.constructFromObject(data['webhook']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutWebhookOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutWebhookOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `webhook`
        if (data['webhook']) { // data not null
          PutWebhookOutputWebhook.validateJSON(data['webhook']);
        }
...
/**
 * @member {module:model/PutWebhookOutputWebhook} webhook
 */
PutWebhookOutput.prototype['webhook'] = undefined;
...
export default PutWebhookOutput;
