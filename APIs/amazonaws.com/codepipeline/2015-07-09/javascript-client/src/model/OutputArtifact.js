...
/**
 * The OutputArtifact model module.
 * @module model/OutputArtifact
 * @version 2015-07-09
 */
class OutputArtifact {
    /**
     * Constructs a new <code>OutputArtifact</code>.
     * Represents information about the output of an action.
     * @alias module:model/OutputArtifact
     * @param name {String} 
     */
    constructor(name) { 
        
        OutputArtifact.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>OutputArtifact</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OutputArtifact} obj Optional instance to populate.
     * @return {module:model/OutputArtifact} The populated <code>OutputArtifact</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OutputArtifact();
    ...
    /**
     * Validates the JSON data with respect to <code>OutputArtifact</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OutputArtifact</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OutputArtifact.RequiredProperties) {
...
OutputArtifact.RequiredProperties = ["name"];

/**
 * @member {String} name
 */
OutputArtifact.prototype['name'] = undefined;
