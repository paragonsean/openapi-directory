...
import ThirdPartyJobDetailsData from './ThirdPartyJobDetailsData';

/**
 * The ThirdPartyJobDetails model module.
 * @module model/ThirdPartyJobDetails
 * @version 2015-07-09
 */
class ThirdPartyJobDetails {
    /**
     * Constructs a new <code>ThirdPartyJobDetails</code>.
     * The details of a job sent in response to a &lt;code&gt;GetThirdPartyJobDetails&lt;/code&gt; request.
     * @alias module:model/ThirdPartyJobDetails
     */
    constructor() { 
        
        ThirdPartyJobDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ThirdPartyJobDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ThirdPartyJobDetails} obj Optional instance to populate.
     * @return {module:model/ThirdPartyJobDetails} The populated <code>ThirdPartyJobDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ThirdPartyJobDetails();

            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('data')) {
                obj['data'] = ThirdPartyJobDetailsData.constructFromObject(data['data']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ThirdPartyJobDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ThirdPartyJobDetails</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          ThirdPartyJobDetailsData.validateJSON(data['data']);
        }
 ...
 * @member {String} id
 */
ThirdPartyJobDetails.prototype['id'] = undefined;

/**
 * @member {module:model/ThirdPartyJobDetailsData} data
 */
ThirdPartyJobDetails.prototype['data'] = undefined;

/**
 * @member {String} nonce
 */
ThirdPartyJobDetails.prototype['nonce'] = undefined;
...
export default ThirdPartyJobDetails;
