...
* @readonly
*/
export default class WebhookAuthenticationType {
    ...
    /**
    * Returns a <code>WebhookAuthenticationType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/WebhookAuthenticationType} The enum <code>WebhookAuthenticationType</code> value.
    */
