...
/**
 * The RetryStageExecutionOutput model module.
 * @module model/RetryStageExecutionOutput
 * @version 2015-07-09
 */
class RetryStageExecutionOutput {
    /**
     * Constructs a new <code>RetryStageExecutionOutput</code>.
     * Represents the output of a &lt;code&gt;RetryStageExecution&lt;/code&gt; action.
     * @alias module:model/RetryStageExecutionOutput
     */
    constructor() { 
        
        RetryStageExecutionOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RetryStageExecutionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RetryStageExecutionOutput} obj Optional instance to populate.
     * @return {module:model/RetryStageExecutionOutput} The populated <code>RetryStageExecutionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RetryStageExecutionOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>RetryStageExecutionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RetryStageExecutionOutput</code>.
     */
 ...
 */
RetryStageExecutionOutput.prototype['pipelineExecutionId'] = undefined;
...
export default RetryStageExecutionOutput;
