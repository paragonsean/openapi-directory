...
/**
 * The GetPipelineInput model module.
 * @module model/GetPipelineInput
 * @version 2015-07-09
 */
class GetPipelineInput {
    /**
     * Constructs a new <code>GetPipelineInput</code>.
     * Represents the input of a &lt;code&gt;GetPipeline&lt;/code&gt; action.
     * @alias module:model/GetPipelineInput
     * @param name {String} 
     */
    constructor(name) { 
        
        GetPipelineInput.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>GetPipelineInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPipelineInput} obj Optional instance to populate.
     * @return {module:model/GetPipelineInput} The populated <code>GetPipelineInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPipelineInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPipelineInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPipelineInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPipelineInput.RequiredProperties) {
...
GetPipelineInput.RequiredProperties = ["name"];

/**
 * @member {String} name
 */
GetPipelineInput.prototype['name'] = undefined;

/**
 * @member {Number} version
 */
GetPipelineInput.prototype['version'] = undefined;
...
export default GetPipelineInput;
