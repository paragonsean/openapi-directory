...
import PipelineExecutionSummaryStopTrigger from './PipelineExecutionSummaryStopTrigger';
import PipelineExecutionSummaryTrigger from './PipelineExecutionSummaryTrigger';
...
class PipelineExecutionSummary {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('sourceRevisions')) {
                obj['sourceRevisions'] = ApiClient.convertToType(data['sourceRevisions'], Array);
            }
            if (data.hasOwnProperty('trigger')) {
                obj['trigger'] = PipelineExecutionSummaryTrigger.constructFromObject(data['trigger']);
            }
            if (data.hasOwnProperty('stopTrigger')) {
                obj['stopTrigger'] = PipelineExecutionSummaryStopTrigger.constructFromObject(data['stopTrigger']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['sourceRevisions']) { // data not null
          Array.validateJSON(data['sourceRevisions']);
        }
        // validate the optional field `trigger`
        if (data['trigger']) { // data not null
          PipelineExecutionSummaryTrigger.validateJSON(data['trigger']);
        }
        // validate the optional field `stopTrigger`
        if (data['stopTrigger']) { // data not null
          PipelineExecutionSummaryStopTrigger.validateJSON(data['stopTrigger']);
        }
 ...
 */
PipelineExecutionSummary.prototype['pipelineExecutionId'] = undefined;

/**
 * @member {module:model/PipelineExecutionStatus} status
 */
PipelineExecutionSummary.prototype['status'] = undefined;
 ...
 */
PipelineExecutionSummary.prototype['lastUpdateTime'] = undefined;

/**
 * @member {Array} sourceRevisions
 */
PipelineExecutionSummary.prototype['sourceRevisions'] = undefined;

/**
 * @member {module:model/PipelineExecutionSummaryTrigger} trigger
 */
PipelineExecutionSummary.prototype['trigger'] = undefined;

/**
 * @member {module:model/PipelineExecutionSummaryStopTrigger} stopTrigger
 */
PipelineExecutionSummary.prototype['stopTrigger'] = undefined;
