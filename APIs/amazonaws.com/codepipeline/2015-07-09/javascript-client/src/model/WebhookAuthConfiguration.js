...
/**
 * The WebhookAuthConfiguration model module.
 * @module model/WebhookAuthConfiguration
 * @version 2015-07-09
 */
class WebhookAuthConfiguration {
    /**
     * Constructs a new <code>WebhookAuthConfiguration</code>.
     * The authentication applied to incoming webhook trigger requests.
     * @alias module:model/WebhookAuthConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>WebhookAuthConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookAuthConfiguration} obj Optional instance to populate.
     * @return {module:model/WebhookAuthConfiguration} The populated <code>WebhookAuthConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookAuthConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookAuthConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookAuthConfiguration</code>.
     */
...
export default WebhookAuthConfiguration;
