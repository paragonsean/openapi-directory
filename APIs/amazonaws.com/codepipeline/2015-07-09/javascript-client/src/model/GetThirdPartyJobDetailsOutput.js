...
import GetThirdPartyJobDetailsOutputJobDetails from './GetThirdPartyJobDetailsOutputJobDetails';

/**
 * The GetThirdPartyJobDetailsOutput model module.
 * @module model/GetThirdPartyJobDetailsOutput
 * @version 2015-07-09
 */
class GetThirdPartyJobDetailsOutput {
    /**
     * Constructs a new <code>GetThirdPartyJobDetailsOutput</code>.
     * Represents the output of a &lt;code&gt;GetThirdPartyJobDetails&lt;/code&gt; action.
     * @alias module:model/GetThirdPartyJobDetailsOutput
     */
    constructor() { 
        
        GetThirdPartyJobDetailsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetThirdPartyJobDetailsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetThirdPartyJobDetailsOutput} obj Optional instance to populate.
     * @return {module:model/GetThirdPartyJobDetailsOutput} The populated <code>GetThirdPartyJobDetailsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetThirdPartyJobDetailsOutput();

            if (data.hasOwnProperty('jobDetails')) {
                obj['jobDetails'] = GetThirdPartyJobDetailsOutputJobDetails.constructFromObject(data['jobDetails']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetThirdPartyJobDetailsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetThirdPartyJobDetailsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `jobDetails`
        if (data['jobDetails']) { // data not null
          GetThirdPartyJobDetailsOutputJobDetails.validateJSON(data['jobDetails']);
        }
...
/**
 * @member {module:model/GetThirdPartyJobDetailsOutputJobDetails} jobDetails
 */
GetThirdPartyJobDetailsOutput.prototype['jobDetails'] = undefined;
...
export default GetThirdPartyJobDetailsOutput;
