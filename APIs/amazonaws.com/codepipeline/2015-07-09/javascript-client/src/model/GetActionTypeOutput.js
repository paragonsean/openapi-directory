...
import GetActionTypeOutputActionType from './GetActionTypeOutputActionType';

/**
 * The GetActionTypeOutput model module.
 * @module model/GetActionTypeOutput
 * @version 2015-07-09
 */
class GetActionTypeOutput {
    /**
     * Constructs a new <code>GetActionTypeOutput</code>.
     * @alias module:model/GetActionTypeOutput
     */
    constructor() { 
        
        GetActionTypeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetActionTypeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetActionTypeOutput} obj Optional instance to populate.
     * @return {module:model/GetActionTypeOutput} The populated <code>GetActionTypeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetActionTypeOutput();

            if (data.hasOwnProperty('actionType')) {
                obj['actionType'] = GetActionTypeOutputActionType.constructFromObject(data['actionType']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetActionTypeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetActionTypeOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `actionType`
        if (data['actionType']) { // data not null
          GetActionTypeOutputActionType.validateJSON(data['actionType']);
        }
...
/**
 * @member {module:model/GetActionTypeOutputActionType} actionType
 */
GetActionTypeOutput.prototype['actionType'] = undefined;
...
export default GetActionTypeOutput;
