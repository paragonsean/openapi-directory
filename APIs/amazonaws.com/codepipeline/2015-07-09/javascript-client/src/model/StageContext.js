...
/**
 * The StageContext model module.
 * @module model/StageContext
 * @version 2015-07-09
 */
class StageContext {
    /**
     * Constructs a new <code>StageContext</code>.
     * Represents information about a stage to a job worker.
     * @alias module:model/StageContext
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StageContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StageContext} obj Optional instance to populate.
     * @return {module:model/StageContext} The populated <code>StageContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StageContext();
    ...
    /**
     * Validates the JSON data with respect to <code>StageContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StageContext</code>.
     */
