...
/**
 * The ActionTypeArtifactDetails model module.
 * @module model/ActionTypeArtifactDetails
 * @version 2015-07-09
 */
class ActionTypeArtifactDetails {
    /**
     * Constructs a new <code>ActionTypeArtifactDetails</code>.
     * Information about parameters for artifacts associated with the action type, such as the minimum and maximum artifacts allowed.
     * @alias module:model/ActionTypeArtifactDetails
    ...
    /**
     * Constructs a <code>ActionTypeArtifactDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionTypeArtifactDetails} obj Optional instance to populate.
     * @return {module:model/ActionTypeArtifactDetails} The populated <code>ActionTypeArtifactDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionTypeArtifactDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionTypeArtifactDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionTypeArtifactDetails</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionTypeArtifactDetails.RequiredProperties) {
...
ActionTypeArtifactDetails.RequiredProperties = ["minimumCount", "maximumCount"];
...
export default ActionTypeArtifactDetails;
