...
/**
 * The ActionRevision model module.
 * @module model/ActionRevision
 * @version 2015-07-09
 */
class ActionRevision {
    /**
     * Constructs a new <code>ActionRevision</code>.
     * Represents information about the version (or revision) of an action.
     * @alias module:model/ActionRevision
     * @param revisionId {String} 
     * @param revisionChangeId {String} 
     * @param created {Date} 
     */
    constructor(revisionId, revisionChangeId, created) { 
        
        ActionRevision.initialize(this, revisionId, revisionChangeId, created);
    }
     ...
     */
    static initialize(obj, revisionId, revisionChangeId, created) { 
        obj['revisionId'] = revisionId;
        obj['revisionChangeId'] = revisionChangeId;
        obj['created'] = created;
    }

    /**
     * Constructs a <code>ActionRevision</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionRevision} obj Optional instance to populate.
     * @return {module:model/ActionRevision} The populated <code>ActionRevision</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionRevision();

            if (data.hasOwnProperty('revisionId')) {
                obj['revisionId'] = ApiClient.convertToType(data['revisionId'], 'String');
            }
            if (data.hasOwnProperty('revisionChangeId')) {
                obj['revisionChangeId'] = ApiClient.convertToType(data['revisionChangeId'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ActionRevision</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionRevision</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionRevision.RequiredProperties) {
        ...
        // validate the optional field `revisionChangeId`
        if (data['revisionChangeId']) { // data not null
          String.validateJSON(data['revisionChangeId']);
        }
...
ActionRevision.RequiredProperties = ["revisionId", "revisionChangeId", "created"];

/**
 * @member {String} revisionId
 */
ActionRevision.prototype['revisionId'] = undefined;

/**
 * @member {String} revisionChangeId
 */
ActionRevision.prototype['revisionChangeId'] = undefined;

/**
 * @member {Date} created
 */
ActionRevision.prototype['created'] = undefined;
