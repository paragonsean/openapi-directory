...
* @readonly
*/
export default class ActionExecutionStatus {
    ...
    /**
    * Returns a <code>ActionExecutionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ActionExecutionStatus} The enum <code>ActionExecutionStatus</code> value.
    */
