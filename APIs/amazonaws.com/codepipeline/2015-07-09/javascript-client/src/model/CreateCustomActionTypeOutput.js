...
import CreateCustomActionTypeOutputActionType from './CreateCustomActionTypeOutputActionType';

/**
 * The CreateCustomActionTypeOutput model module.
 * @module model/CreateCustomActionTypeOutput
 * @version 2015-07-09
 */
class CreateCustomActionTypeOutput {
    /**
     * Constructs a new <code>CreateCustomActionTypeOutput</code>.
     * Represents the output of a &lt;code&gt;CreateCustomActionType&lt;/code&gt; operation.
     * @alias module:model/CreateCustomActionTypeOutput
     * @param actionType {module:model/CreateCustomActionTypeOutputActionType} 
     */
    constructor(actionType) { 
        
        CreateCustomActionTypeOutput.initialize(this, actionType);
    }
    ...
    /**
     * Constructs a <code>CreateCustomActionTypeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCustomActionTypeOutput} obj Optional instance to populate.
     * @return {module:model/CreateCustomActionTypeOutput} The populated <code>CreateCustomActionTypeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCustomActionTypeOutput();

            if (data.hasOwnProperty('actionType')) {
                obj['actionType'] = CreateCustomActionTypeOutputActionType.constructFromObject(data['actionType']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCustomActionTypeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCustomActionTypeOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCustomActionTypeOutput.RequiredProperties) {
        ...
        if (data['actionType']) { // data not null
          CreateCustomActionTypeOutputActionType.validateJSON(data['actionType']);
        }
...
CreateCustomActionTypeOutput.RequiredProperties = ["actionType"];

/**
 * @member {module:model/CreateCustomActionTypeOutputActionType} actionType
 */
CreateCustomActionTypeOutput.prototype['actionType'] = undefined;

/**
 * @member {Array} tags
 */
CreateCustomActionTypeOutput.prototype['tags'] = undefined;
...
export default CreateCustomActionTypeOutput;
