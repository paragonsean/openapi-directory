...
/**
 * The ActionDeclarationActionTypeId model module.
 * @module model/ActionDeclarationActionTypeId
 * @version 2015-07-09
 */
class ActionDeclarationActionTypeId {
    /**
     * Constructs a new <code>ActionDeclarationActionTypeId</code>.
     * @alias module:model/ActionDeclarationActionTypeId
    ...
    constructor(category, owner, provider, version) { 
        ...
        ActionDeclarationActionTypeId.initialize(this, category, owner, provider, version);
    }
    ...
    /**
     * Constructs a <code>ActionDeclarationActionTypeId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionDeclarationActionTypeId} obj Optional instance to populate.
     * @return {module:model/ActionDeclarationActionTypeId} The populated <code>ActionDeclarationActionTypeId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionDeclarationActionTypeId();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionDeclarationActionTypeId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionDeclarationActionTypeId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionDeclarationActionTypeId.RequiredProperties) {
...
ActionDeclarationActionTypeId.RequiredProperties = ["category", "owner", "provider", "version"];

/**
 * @member {module:model/ActionCategory} category
 */
ActionDeclarationActionTypeId.prototype['category'] = undefined;

/**
 * @member {module:model/ActionOwner} owner
 */
ActionDeclarationActionTypeId.prototype['owner'] = undefined;

/**
 * @member {String} provider
 */
ActionDeclarationActionTypeId.prototype['provider'] = undefined;

/**
 * @member {String} version
 */
ActionDeclarationActionTypeId.prototype['version'] = undefined;
...
export default ActionDeclarationActionTypeId;
