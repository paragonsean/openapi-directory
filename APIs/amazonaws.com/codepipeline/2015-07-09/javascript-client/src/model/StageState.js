...
import StageStateInboundTransitionState from './StageStateInboundTransitionState';
import StageStateLatestExecution from './StageStateLatestExecution';

/**
 * The StageState model module.
 * @module model/StageState
 * @version 2015-07-09
 */
class StageState {
    /**
     * Constructs a new <code>StageState</code>.
     * Represents information about the state of the stage.
     * @alias module:model/StageState
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StageState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StageState} obj Optional instance to populate.
     * @return {module:model/StageState} The populated <code>StageState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StageState();

            if (data.hasOwnProperty('stageName')) {
                obj['stageName'] = ApiClient.convertToType(data['stageName'], 'String');
            }
            if (data.hasOwnProperty('inboundExecution')) {
                obj['inboundExecution'] = StageExecution.constructFromObject(data['inboundExecution']);
            }
            if (data.hasOwnProperty('inboundTransitionState')) {
                obj['inboundTransitionState'] = StageStateInboundTransitionState.constructFromObject(data['inboundTransitionState']);
            }
            if (data.hasOwnProperty('actionStates')) {
                obj['actionStates'] = ApiClient.convertToType(data['actionStates'], Array);
            }
            if (data.hasOwnProperty('latestExecution')) {
                obj['latestExecution'] = StageStateLatestExecution.constructFromObject(data['latestExecution']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StageState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StageState</code>.
     */
    static validateJSON(data) {
        ...
        if (data['inboundExecution']) { // data not null
          StageExecution.validateJSON(data['inboundExecution']);
        }
        // validate the optional field `inboundTransitionState`
        if (data['inboundTransitionState']) { // data not null
          StageStateInboundTransitionState.validateJSON(data['inboundTransitionState']);
        }
        // validate the optional field `actionStates`
        if (data['actionStates']) { // data not null
          Array.validateJSON(data['actionStates']);
        }
        // validate the optional field `latestExecution`
        if (data['latestExecution']) { // data not null
          StageStateLatestExecution.validateJSON(data['latestExecution']);
        }
 ...
 */
StageState.prototype['stageName'] = undefined;

/**
 * @member {module:model/StageExecution} inboundExecution
 */
StageState.prototype['inboundExecution'] = undefined;

/**
 * @member {module:model/StageStateInboundTransitionState} inboundTransitionState
 */
StageState.prototype['inboundTransitionState'] = undefined;

/**
 * @member {Array} actionStates
 */
StageState.prototype['actionStates'] = undefined;

/**
 * @member {module:model/StageStateLatestExecution} latestExecution
 */
StageState.prototype['latestExecution'] = undefined;
