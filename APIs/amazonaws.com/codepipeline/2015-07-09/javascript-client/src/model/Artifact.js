...
class Artifact {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('location')) {
                obj['location'] = ArtifactLocation.constructFromObject(data['location']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['location']) { // data not null
          ArtifactLocation.validateJSON(data['location']);
        }
 ...
 */
Artifact.prototype['revision'] = undefined;

/**
 * @member {module:model/ArtifactLocation} location
 */
