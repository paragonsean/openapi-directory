...
/**
 * The ListPipelineExecutionsOutput model module.
 * @module model/ListPipelineExecutionsOutput
 * @version 2015-07-09
 */
class ListPipelineExecutionsOutput {
    /**
     * Constructs a new <code>ListPipelineExecutionsOutput</code>.
     * Represents the output of a &lt;code&gt;ListPipelineExecutions&lt;/code&gt; action.
     * @alias module:model/ListPipelineExecutionsOutput
     */
    constructor() { 
        
        ListPipelineExecutionsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListPipelineExecutionsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPipelineExecutionsOutput} obj Optional instance to populate.
     * @return {module:model/ListPipelineExecutionsOutput} The populated <code>ListPipelineExecutionsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPipelineExecutionsOutput();

            if (data.hasOwnProperty('pipelineExecutionSummaries')) {
                obj['pipelineExecutionSummaries'] = ApiClient.convertToType(data['pipelineExecutionSummaries'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListPipelineExecutionsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPipelineExecutionsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `pipelineExecutionSummaries`
        if (data['pipelineExecutionSummaries']) { // data not null
          Array.validateJSON(data['pipelineExecutionSummaries']);
        }
...
/**
 * @member {Array} pipelineExecutionSummaries
 */
ListPipelineExecutionsOutput.prototype['pipelineExecutionSummaries'] = undefined;

/**
 * @member {String} nextToken
 */
ListPipelineExecutionsOutput.prototype['nextToken'] = undefined;
...
export default ListPipelineExecutionsOutput;
