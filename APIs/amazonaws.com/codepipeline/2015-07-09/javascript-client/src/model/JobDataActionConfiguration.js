...
/**
 * The JobDataActionConfiguration model module.
 * @module model/JobDataActionConfiguration
 * @version 2015-07-09
 */
class JobDataActionConfiguration {
    /**
     * Constructs a new <code>JobDataActionConfiguration</code>.
     * @alias module:model/JobDataActionConfiguration
     * @implements module:model/ActionConfiguration
     */
    constructor() { 
        ActionConfiguration.initialize(this);
        JobDataActionConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JobDataActionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JobDataActionConfiguration} obj Optional instance to populate.
     * @return {module:model/JobDataActionConfiguration} The populated <code>JobDataActionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JobDataActionConfiguration();
            ActionConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>JobDataActionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JobDataActionConfiguration</code>.
     */
 ...
 */
JobDataActionConfiguration.prototype['configuration'] = undefined;


// Implement ActionConfiguration interface:
/**
 * @member {Object} configuration
 */
ActionConfiguration.prototype['configuration'] = undefined;




export default JobDataActionConfiguration;
