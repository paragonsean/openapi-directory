...
import ActionTypeExecutorConfiguration from './ActionTypeExecutorConfiguration';
import ExecutorType from './ExecutorType';

/**
 * The ActionTypeExecutor model module.
 * @module model/ActionTypeExecutor
 * @version 2015-07-09
 */
class ActionTypeExecutor {
    /**
     * Constructs a new <code>ActionTypeExecutor</code>.
     ...
     * @alias module:model/ActionTypeExecutor
     * @param configuration {module:model/ActionTypeExecutorConfiguration} 
     * @param type {module:model/ExecutorType} 
     */
    constructor(configuration, type) { 
        
        ActionTypeExecutor.initialize(this, configuration, type);
    }
     ...
     */
    static initialize(obj, configuration, type) { 
        obj['configuration'] = configuration;
        obj['type'] = type;
    }

    /**
     * Constructs a <code>ActionTypeExecutor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionTypeExecutor} obj Optional instance to populate.
     * @return {module:model/ActionTypeExecutor} The populated <code>ActionTypeExecutor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionTypeExecutor();

            if (data.hasOwnProperty('configuration')) {
                obj['configuration'] = ActionTypeExecutorConfiguration.constructFromObject(data['configuration']);
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = ApiClient.convertToType(data['type'], ExecutorType);
            }
            if (data.hasOwnProperty('policyStatementsTemplate')) {
                obj['policyStatementsTemplate'] = ApiClient.convertToType(data['policyStatementsTemplate'], 'String');
            }
            if (data.hasOwnProperty('jobTimeout')) {
                obj['jobTimeout'] = ApiClient.convertToType(data['jobTimeout'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ActionTypeExecutor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionTypeExecutor</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionTypeExecutor.RequiredProperties) {
        ...
        if (data['configuration']) { // data not null
          ActionTypeExecutorConfiguration.validateJSON(data['configuration']);
        }
        // validate the optional field `type`
        if (data['type']) { // data not null
          ExecutorType.validateJSON(data['type']);
        }
        // validate the optional field `policyStatementsTemplate`
        if (data['policyStatementsTemplate']) { // data not null
          String.validateJSON(data['policyStatementsTemplate']);
        }
        // validate the optional field `jobTimeout`
        if (data['jobTimeout']) { // data not null
          Number.validateJSON(data['jobTimeout']);
        }
...
ActionTypeExecutor.RequiredProperties = ["configuration", "type"];

/**
 * @member {module:model/ActionTypeExecutorConfiguration} configuration
 */
ActionTypeExecutor.prototype['configuration'] = undefined;

/**
 * @member {module:model/ExecutorType} type
 */
ActionTypeExecutor.prototype['type'] = undefined;

/**
 * @member {String} policyStatementsTemplate
 */
ActionTypeExecutor.prototype['policyStatementsTemplate'] = undefined;

/**
 * @member {Number} jobTimeout
 */
ActionTypeExecutor.prototype['jobTimeout'] = undefined;
...
export default ActionTypeExecutor;
