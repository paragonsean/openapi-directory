...
/**
 * The AcknowledgeThirdPartyJobInput model module.
 * @module model/AcknowledgeThirdPartyJobInput
 * @version 2015-07-09
 */
class AcknowledgeThirdPartyJobInput {
    /**
     * Constructs a new <code>AcknowledgeThirdPartyJobInput</code>.
     * Represents the input of an AcknowledgeThirdPartyJob action.
     * @alias module:model/AcknowledgeThirdPartyJobInput
     * @param jobId {String} 
     * @param nonce {String} 
     * @param clientToken {String} 
     */
    constructor(jobId, nonce, clientToken) { 
        
        AcknowledgeThirdPartyJobInput.initialize(this, jobId, nonce, clientToken);
    }
     ...
     */
    static initialize(obj, jobId, nonce, clientToken) { 
        obj['jobId'] = jobId;
        obj['nonce'] = nonce;
    ...
    /**
     * Constructs a <code>AcknowledgeThirdPartyJobInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AcknowledgeThirdPartyJobInput} obj Optional instance to populate.
     * @return {module:model/AcknowledgeThirdPartyJobInput} The populated <code>AcknowledgeThirdPartyJobInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AcknowledgeThirdPartyJobInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AcknowledgeThirdPartyJobInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AcknowledgeThirdPartyJobInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AcknowledgeThirdPartyJobInput.RequiredProperties) {
...
AcknowledgeThirdPartyJobInput.RequiredProperties = ["jobId", "nonce", "clientToken"];

/**
 * @member {String} jobId
 */
AcknowledgeThirdPartyJobInput.prototype['jobId'] = undefined;

/**
 * @member {String} nonce
 */
AcknowledgeThirdPartyJobInput.prototype['nonce'] = undefined;

/**
 * @member {String} clientToken
 */
AcknowledgeThirdPartyJobInput.prototype['clientToken'] = undefined;
...
export default AcknowledgeThirdPartyJobInput;
