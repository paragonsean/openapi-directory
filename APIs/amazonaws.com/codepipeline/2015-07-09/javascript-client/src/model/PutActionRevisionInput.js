...
import PutActionRevisionInputActionRevision from './PutActionRevisionInputActionRevision';

/**
 * The PutActionRevisionInput model module.
 * @module model/PutActionRevisionInput
 * @version 2015-07-09
 */
class PutActionRevisionInput {
    /**
     * Constructs a new <code>PutActionRevisionInput</code>.
     * Represents the input of a &lt;code&gt;PutActionRevision&lt;/code&gt; action.
     * @alias module:model/PutActionRevisionInput
     * @param pipelineName {String} 
     * @param stageName {String} 
     * @param actionName {String} 
     * @param actionRevision {module:model/PutActionRevisionInputActionRevision} 
     */
    constructor(pipelineName, stageName, actionName, actionRevision) { 
        
        PutActionRevisionInput.initialize(this, pipelineName, stageName, actionName, actionRevision);
    }
     ...
     */
    static initialize(obj, pipelineName, stageName, actionName, actionRevision) { 
        obj['pipelineName'] = pipelineName;
        obj['stageName'] = stageName;
        obj['actionName'] = actionName;
        obj['actionRevision'] = actionRevision;
    }

    /**
     * Constructs a <code>PutActionRevisionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutActionRevisionInput} obj Optional instance to populate.
     * @return {module:model/PutActionRevisionInput} The populated <code>PutActionRevisionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutActionRevisionInput();
            ...
            if (data.hasOwnProperty('actionRevision')) {
                obj['actionRevision'] = PutActionRevisionInputActionRevision.constructFromObject(data['actionRevision']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutActionRevisionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutActionRevisionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutActionRevisionInput.RequiredProperties) {
        ...
        // validate the optional field `actionRevision`
        if (data['actionRevision']) { // data not null
          PutActionRevisionInputActionRevision.validateJSON(data['actionRevision']);
        }
...
PutActionRevisionInput.RequiredProperties = ["pipelineName", "stageName", "actionName", "actionRevision"];

/**
 * @member {String} pipelineName
 */
PutActionRevisionInput.prototype['pipelineName'] = undefined;

/**
 * @member {String} stageName
 */
PutActionRevisionInput.prototype['stageName'] = undefined;

/**
 * @member {String} actionName
 */
PutActionRevisionInput.prototype['actionName'] = undefined;

/**
 * @member {module:model/PutActionRevisionInputActionRevision} actionRevision
 */
PutActionRevisionInput.prototype['actionRevision'] = undefined;
...
export default PutActionRevisionInput;
