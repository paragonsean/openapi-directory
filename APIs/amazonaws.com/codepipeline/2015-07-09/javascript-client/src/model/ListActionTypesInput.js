...
/**
 * The ListActionTypesInput model module.
 * @module model/ListActionTypesInput
 * @version 2015-07-09
 */
class ListActionTypesInput {
    /**
     * Constructs a new <code>ListActionTypesInput</code>.
     * Represents the input of a &lt;code&gt;ListActionTypes&lt;/code&gt; action.
     * @alias module:model/ListActionTypesInput
     */
    constructor() { 
        
        ListActionTypesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListActionTypesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListActionTypesInput} obj Optional instance to populate.
     * @return {module:model/ListActionTypesInput} The populated <code>ListActionTypesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListActionTypesInput();

            if (data.hasOwnProperty('actionOwnerFilter')) {
                obj['actionOwnerFilter'] = ApiClient.convertToType(data['actionOwnerFilter'], ActionOwner);
            }
            if (data.hasOwnProperty('nextToken')) {
                obj['nextToken'] = ApiClient.convertToType(data['nextToken'], 'String');
            }
            if (data.hasOwnProperty('regionFilter')) {
                obj['regionFilter'] = ApiClient.convertToType(data['regionFilter'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListActionTypesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListActionTypesInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `actionOwnerFilter`
        if (data['actionOwnerFilter']) { // data not null
          ActionOwner.validateJSON(data['actionOwnerFilter']);
        }
        ...
        if (data['regionFilter']) { // data not null
          String.validateJSON(data['regionFilter']);
        }
...
/**
 * @member {module:model/ActionOwner} actionOwnerFilter
 */
ListActionTypesInput.prototype['actionOwnerFilter'] = undefined;

/**
 * @member {String} nextToken
 */
ListActionTypesInput.prototype['nextToken'] = undefined;

/**
 * @member {String} regionFilter
 */
ListActionTypesInput.prototype['regionFilter'] = undefined;
...
export default ListActionTypesInput;
