...
/**
 * The ActionExecutionOutput model module.
 * @module model/ActionExecutionOutput
 * @version 2015-07-09
 */
class ActionExecutionOutput {
    /**
     * Constructs a new <code>ActionExecutionOutput</code>.
     * Output details listed for an action execution, such as the action execution result.
     * @alias module:model/ActionExecutionOutput
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ActionExecutionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionExecutionOutput} obj Optional instance to populate.
     * @return {module:model/ActionExecutionOutput} The populated <code>ActionExecutionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionExecutionOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionExecutionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionExecutionOutput</code>.
     */
...
export default ActionExecutionOutput;
