...
/**
 * The PipelineContext model module.
 * @module model/PipelineContext
 * @version 2015-07-09
 */
class PipelineContext {
    /**
     * Constructs a new <code>PipelineContext</code>.
     ...
     * @alias module:model/PipelineContext
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>PipelineContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PipelineContext} obj Optional instance to populate.
     * @return {module:model/PipelineContext} The populated <code>PipelineContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PipelineContext();
    ...
    /**
     * Validates the JSON data with respect to <code>PipelineContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PipelineContext</code>.
     */
