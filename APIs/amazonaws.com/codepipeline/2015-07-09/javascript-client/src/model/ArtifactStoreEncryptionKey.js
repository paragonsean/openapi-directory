...
/**
 * The ArtifactStoreEncryptionKey model module.
 * @module model/ArtifactStoreEncryptionKey
 * @version 2015-07-09
 */
class ArtifactStoreEncryptionKey {
    /**
     * Constructs a new <code>ArtifactStoreEncryptionKey</code>.
     * @alias module:model/ArtifactStoreEncryptionKey
    ...
    constructor(id, type) { 
        ...
        ArtifactStoreEncryptionKey.initialize(this, id, type);
    }
    ...
    /**
     * Constructs a <code>ArtifactStoreEncryptionKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ArtifactStoreEncryptionKey} obj Optional instance to populate.
     * @return {module:model/ArtifactStoreEncryptionKey} The populated <code>ArtifactStoreEncryptionKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArtifactStoreEncryptionKey();
    ...
    /**
     * Validates the JSON data with respect to <code>ArtifactStoreEncryptionKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ArtifactStoreEncryptionKey</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ArtifactStoreEncryptionKey.RequiredProperties) {
...
ArtifactStoreEncryptionKey.RequiredProperties = ["id", "type"];

/**
 * @member {String} id
 */
ArtifactStoreEncryptionKey.prototype['id'] = undefined;

/**
 * @member {module:model/EncryptionKeyType} type
 */
ArtifactStoreEncryptionKey.prototype['type'] = undefined;
...
export default ArtifactStoreEncryptionKey;
