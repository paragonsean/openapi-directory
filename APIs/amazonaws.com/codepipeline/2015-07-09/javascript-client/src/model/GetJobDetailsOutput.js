...
import GetJobDetailsOutputJobDetails from './GetJobDetailsOutputJobDetails';

/**
 * The GetJobDetailsOutput model module.
 * @module model/GetJobDetailsOutput
 * @version 2015-07-09
 */
class GetJobDetailsOutput {
    /**
     * Constructs a new <code>GetJobDetailsOutput</code>.
     * Represents the output of a &lt;code&gt;GetJobDetails&lt;/code&gt; action.
     * @alias module:model/GetJobDetailsOutput
     */
    constructor() { 
        
        GetJobDetailsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetJobDetailsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetJobDetailsOutput} obj Optional instance to populate.
     * @return {module:model/GetJobDetailsOutput} The populated <code>GetJobDetailsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetJobDetailsOutput();

            if (data.hasOwnProperty('jobDetails')) {
                obj['jobDetails'] = GetJobDetailsOutputJobDetails.constructFromObject(data['jobDetails']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetJobDetailsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetJobDetailsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `jobDetails`
        if (data['jobDetails']) { // data not null
          GetJobDetailsOutputJobDetails.validateJSON(data['jobDetails']);
        }
...
/**
 * @member {module:model/GetJobDetailsOutputJobDetails} jobDetails
 */
GetJobDetailsOutput.prototype['jobDetails'] = undefined;
...
export default GetJobDetailsOutput;
