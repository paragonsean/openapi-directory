...
/**
 * The AWSSessionCredentials model module.
 * @module model/AWSSessionCredentials
 * @version 2015-07-09
 */
class AWSSessionCredentials {
    /**
     * Constructs a new <code>AWSSessionCredentials</code>.
     ...
     * @alias module:model/AWSSessionCredentials
    ...
    constructor(accessKeyId, secretAccessKey, sessionToken) { 
        ...
        AWSSessionCredentials.initialize(this, accessKeyId, secretAccessKey, sessionToken);
    }
     ...
     */
    static initialize(obj, accessKeyId, secretAccessKey, sessionToken) { 
    ...
    /**
     * Constructs a <code>AWSSessionCredentials</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AWSSessionCredentials} obj Optional instance to populate.
     * @return {module:model/AWSSessionCredentials} The populated <code>AWSSessionCredentials</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AWSSessionCredentials();
    ...
    /**
     * Validates the JSON data with respect to <code>AWSSessionCredentials</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AWSSessionCredentials</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AWSSessionCredentials.RequiredProperties) {
...
AWSSessionCredentials.RequiredProperties = ["accessKeyId", "secretAccessKey", "sessionToken"];

/**
 * @member {String} accessKeyId
 */
AWSSessionCredentials.prototype['accessKeyId'] = undefined;

/**
 * @member {String} secretAccessKey
 */
AWSSessionCredentials.prototype['secretAccessKey'] = undefined;

/**
 * @member {String} sessionToken
 */
AWSSessionCredentials.prototype['sessionToken'] = undefined;
...
export default AWSSessionCredentials;
