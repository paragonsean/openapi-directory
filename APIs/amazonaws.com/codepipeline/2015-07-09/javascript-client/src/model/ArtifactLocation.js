...
import ArtifactLocationS3Location from './ArtifactLocationS3Location';
import ArtifactLocationType from './ArtifactLocationType';

/**
 * The ArtifactLocation model module.
 * @module model/ArtifactLocation
 * @version 2015-07-09
 */
class ArtifactLocation {
    /**
     * Constructs a new <code>ArtifactLocation</code>.
     * @alias module:model/ArtifactLocation
     * @implements module:model/ArtifactLocation
     */
    constructor() { 
        ArtifactLocation.initialize(this);
        ArtifactLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ArtifactLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ArtifactLocation} obj Optional instance to populate.
     * @return {module:model/ArtifactLocation} The populated <code>ArtifactLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArtifactLocation();
            ArtifactLocation.constructFromObject(data, obj);

            if (data.hasOwnProperty('type')) {
                obj['type'] = ApiClient.convertToType(data['type'], ArtifactLocationType);
            }
            if (data.hasOwnProperty('s3Location')) {
                obj['s3Location'] = ArtifactLocationS3Location.constructFromObject(data['s3Location']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ArtifactLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ArtifactLocation</code>.
     */
    static validateJSON(data) {
        // validate the optional field `type`
        if (data['type']) { // data not null
          ArtifactLocationType.validateJSON(data['type']);
        }
        // validate the optional field `s3Location`
        if (data['s3Location']) { // data not null
          ArtifactLocationS3Location.validateJSON(data['s3Location']);
        }
...
/**
 * @member {module:model/ArtifactLocationType} type
 */
ArtifactLocation.prototype['type'] = undefined;

/**
 * @member {module:model/ArtifactLocationS3Location} s3Location
 */
ArtifactLocation.prototype['s3Location'] = undefined;


// Implement ArtifactLocation interface:
/**
 * @member {module:model/ArtifactLocationType} type
 */
ArtifactLocation.prototype['type'] = undefined;
...
export default ArtifactLocation;
