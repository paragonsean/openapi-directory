...
/**
 * The GetPipelineExecutionOutputPipelineExecution model module.
 * @module model/GetPipelineExecutionOutputPipelineExecution
 * @version 2015-07-09
 */
class GetPipelineExecutionOutputPipelineExecution {
    /**
     * Constructs a new <code>GetPipelineExecutionOutputPipelineExecution</code>.
     * @alias module:model/GetPipelineExecutionOutputPipelineExecution
     * @implements module:model/PipelineExecution
     */
    constructor() { 
        PipelineExecution.initialize(this);
        GetPipelineExecutionOutputPipelineExecution.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPipelineExecutionOutputPipelineExecution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPipelineExecutionOutputPipelineExecution} obj Optional instance to populate.
     * @return {module:model/GetPipelineExecutionOutputPipelineExecution} The populated <code>GetPipelineExecutionOutputPipelineExecution</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPipelineExecutionOutputPipelineExecution();
            PipelineExecution.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], PipelineExecutionStatus);
            }
            if (data.hasOwnProperty('statusSummary')) {
                obj['statusSummary'] = ApiClient.convertToType(data['statusSummary'], 'String');
            }
            if (data.hasOwnProperty('artifactRevisions')) {
                obj['artifactRevisions'] = ApiClient.convertToType(data['artifactRevisions'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPipelineExecutionOutputPipelineExecution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPipelineExecutionOutputPipelineExecution</code>.
     */
    static validateJSON(data) {
        ...
        if (data['status']) { // data not null
          PipelineExecutionStatus.validateJSON(data['status']);
        }
        // validate the optional field `statusSummary`
        if (data['statusSummary']) { // data not null
          String.validateJSON(data['statusSummary']);
        }
        // validate the optional field `artifactRevisions`
        if (data['artifactRevisions']) { // data not null
          Array.validateJSON(data['artifactRevisions']);
        }
 ...
 */
GetPipelineExecutionOutputPipelineExecution.prototype['pipelineName'] = undefined;

/**
 * @member {Number} pipelineVersion
 */
GetPipelineExecutionOutputPipelineExecution.prototype['pipelineVersion'] = undefined;

/**
 * @member {String} pipelineExecutionId
 */
GetPipelineExecutionOutputPipelineExecution.prototype['pipelineExecutionId'] = undefined;

/**
 * @member {module:model/PipelineExecutionStatus} status
 */
GetPipelineExecutionOutputPipelineExecution.prototype['status'] = undefined;

/**
 * @member {String} statusSummary
 */
GetPipelineExecutionOutputPipelineExecution.prototype['statusSummary'] = undefined;

/**
 * @member {Array} artifactRevisions
 */
GetPipelineExecutionOutputPipelineExecution.prototype['artifactRevisions'] = undefined;


// Implement PipelineExecution interface:
/**
 * @member {String} pipelineName
 */
PipelineExecution.prototype['pipelineName'] = undefined;
/**
 * @member {Number} pipelineVersion
 */
PipelineExecution.prototype['pipelineVersion'] = undefined;
/**
 * @member {String} pipelineExecutionId
 */
PipelineExecution.prototype['pipelineExecutionId'] = undefined;
/**
 * @member {module:model/PipelineExecutionStatus} status
 */
 ...
 * @member {String} statusSummary
 */
PipelineExecution.prototype['statusSummary'] = undefined;
/**
 * @member {Array} artifactRevisions
 */
PipelineExecution.prototype['artifactRevisions'] = undefined;




export default GetPipelineExecutionOutputPipelineExecution;
