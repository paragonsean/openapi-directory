...
/**
 * The JobDataArtifactCredentials model module.
 * @module model/JobDataArtifactCredentials
 * @version 2015-07-09
 */
class JobDataArtifactCredentials {
    /**
     * Constructs a new <code>JobDataArtifactCredentials</code>.
     * @alias module:model/JobDataArtifactCredentials
    ...
    constructor(accessKeyId, secretAccessKey, sessionToken) { 
        ...
        JobDataArtifactCredentials.initialize(this, accessKeyId, secretAccessKey, sessionToken);
    }
    ...
    /**
     * Constructs a <code>JobDataArtifactCredentials</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JobDataArtifactCredentials} obj Optional instance to populate.
     * @return {module:model/JobDataArtifactCredentials} The populated <code>JobDataArtifactCredentials</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JobDataArtifactCredentials();
    ...
    /**
     * Validates the JSON data with respect to <code>JobDataArtifactCredentials</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JobDataArtifactCredentials</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of JobDataArtifactCredentials.RequiredProperties) {
...
JobDataArtifactCredentials.RequiredProperties = ["accessKeyId", "secretAccessKey", "sessionToken"];

/**
 * @member {String} accessKeyId
 */
JobDataArtifactCredentials.prototype['accessKeyId'] = undefined;

/**
 * @member {String} secretAccessKey
 */
JobDataArtifactCredentials.prototype['secretAccessKey'] = undefined;

/**
 * @member {String} sessionToken
 */
JobDataArtifactCredentials.prototype['sessionToken'] = undefined;
...
export default JobDataArtifactCredentials;
