...
/**
 * The PollForJobsInputActionTypeId model module.
 * @module model/PollForJobsInputActionTypeId
 * @version 2015-07-09
 */
class PollForJobsInputActionTypeId {
    /**
     * Constructs a new <code>PollForJobsInputActionTypeId</code>.
     * @alias module:model/PollForJobsInputActionTypeId
     * @implements module:model/ActionTypeId
     * @param category {module:model/ActionCategory} 
     * @param owner {module:model/ActionOwner} 
     * @param provider {String} 
     * @param version {String} 
     */
    constructor(category, owner, provider, version) { 
        ActionTypeId.initialize(this, category, owner, provider, version);
        PollForJobsInputActionTypeId.initialize(this, category, owner, provider, version);
    }
     ...
     */
    static initialize(obj, category, owner, provider, version) { 
    ...
    /**
     * Constructs a <code>PollForJobsInputActionTypeId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PollForJobsInputActionTypeId} obj Optional instance to populate.
     * @return {module:model/PollForJobsInputActionTypeId} The populated <code>PollForJobsInputActionTypeId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PollForJobsInputActionTypeId();
            ActionTypeId.constructFromObject(data, obj);

            if (data.hasOwnProperty('category')) {
                obj['category'] = ApiClient.convertToType(data['category'], ActionCategory);
            }
            if (data.hasOwnProperty('owner')) {
                obj['owner'] = ApiClient.convertToType(data['owner'], ActionOwner);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PollForJobsInputActionTypeId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PollForJobsInputActionTypeId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PollForJobsInputActionTypeId.RequiredProperties) {
        ...
        if (data['owner']) { // data not null
          ActionOwner.validateJSON(data['owner']);
        }
...
PollForJobsInputActionTypeId.RequiredProperties = ["category", "owner", "provider", "version"];

/**
 * @member {module:model/ActionCategory} category
 */
PollForJobsInputActionTypeId.prototype['category'] = undefined;

/**
 * @member {module:model/ActionOwner} owner
 */
PollForJobsInputActionTypeId.prototype['owner'] = undefined;

/**
 * @member {String} provider
 */
PollForJobsInputActionTypeId.prototype['provider'] = undefined;

/**
 * @member {String} version
 */
PollForJobsInputActionTypeId.prototype['version'] = undefined;


// Implement ActionTypeId interface:
/**
 * @member {module:model/ActionCategory} category
 */
ActionTypeId.prototype['category'] = undefined;
/**
 * @member {module:model/ActionOwner} owner
 */
ActionTypeId.prototype['owner'] = undefined;
/**
 * @member {String} provider
 */
ActionTypeId.prototype['provider'] = undefined;
/**
 * @member {String} version
 */
ActionTypeId.prototype['version'] = undefined;




export default PollForJobsInputActionTypeId;
