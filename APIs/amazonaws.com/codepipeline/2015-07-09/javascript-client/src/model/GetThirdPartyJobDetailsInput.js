...
/**
 * The GetThirdPartyJobDetailsInput model module.
 * @module model/GetThirdPartyJobDetailsInput
 * @version 2015-07-09
 */
class GetThirdPartyJobDetailsInput {
    /**
     * Constructs a new <code>GetThirdPartyJobDetailsInput</code>.
     * Represents the input of a &lt;code&gt;GetThirdPartyJobDetails&lt;/code&gt; action.
     * @alias module:model/GetThirdPartyJobDetailsInput
     * @param jobId {String} 
     * @param clientToken {String} 
     */
    constructor(jobId, clientToken) { 
        
        GetThirdPartyJobDetailsInput.initialize(this, jobId, clientToken);
    }
     ...
     */
    static initialize(obj, jobId, clientToken) { 
        obj['jobId'] = jobId;
        obj['clientToken'] = clientToken;
    }

    /**
     * Constructs a <code>GetThirdPartyJobDetailsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetThirdPartyJobDetailsInput} obj Optional instance to populate.
     * @return {module:model/GetThirdPartyJobDetailsInput} The populated <code>GetThirdPartyJobDetailsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetThirdPartyJobDetailsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetThirdPartyJobDetailsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetThirdPartyJobDetailsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetThirdPartyJobDetailsInput.RequiredProperties) {
...
GetThirdPartyJobDetailsInput.RequiredProperties = ["jobId", "clientToken"];

/**
 * @member {String} jobId
 */
GetThirdPartyJobDetailsInput.prototype['jobId'] = undefined;

/**
 * @member {String} clientToken
 */
GetThirdPartyJobDetailsInput.prototype['clientToken'] = undefined;
...
export default GetThirdPartyJobDetailsInput;
