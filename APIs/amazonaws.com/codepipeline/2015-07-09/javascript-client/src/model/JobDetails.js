...
class JobDetails {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = JobDetailsData.constructFromObject(data['data']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          JobDetailsData.validateJSON(data['data']);
        }
 ...
 * @member {String} id
 */
JobDetails.prototype['id'] = undefined;

/**
 * @member {module:model/JobDetailsData} data
 */
JobDetails.prototype['data'] = undefined;

/**
 * @member {String} accountId
 */
JobDetails.prototype['accountId'] = undefined;
