...
/**
 * The StopExecutionTrigger model module.
 * @module model/StopExecutionTrigger
 * @version 2015-07-09
 */
class StopExecutionTrigger {
    /**
     * Constructs a new <code>StopExecutionTrigger</code>.
     * The interaction that stopped a pipeline execution.
     * @alias module:model/StopExecutionTrigger
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StopExecutionTrigger</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopExecutionTrigger} obj Optional instance to populate.
     * @return {module:model/StopExecutionTrigger} The populated <code>StopExecutionTrigger</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopExecutionTrigger();
    ...
    /**
     * Validates the JSON data with respect to <code>StopExecutionTrigger</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopExecutionTrigger</code>.
     */
...
export default StopExecutionTrigger;
