...
/**
 * The PutThirdPartyJobSuccessResultInputExecutionDetails model module.
 * @module model/PutThirdPartyJobSuccessResultInputExecutionDetails
 * @version 2015-07-09
 */
class PutThirdPartyJobSuccessResultInputExecutionDetails {
    /**
     * Constructs a new <code>PutThirdPartyJobSuccessResultInputExecutionDetails</code>.
     * @alias module:model/PutThirdPartyJobSuccessResultInputExecutionDetails
     * @implements module:model/ExecutionDetails
     */
    constructor() { 
        ExecutionDetails.initialize(this);
        PutThirdPartyJobSuccessResultInputExecutionDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutThirdPartyJobSuccessResultInputExecutionDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutThirdPartyJobSuccessResultInputExecutionDetails} obj Optional instance to populate.
     * @return {module:model/PutThirdPartyJobSuccessResultInputExecutionDetails} The populated <code>PutThirdPartyJobSuccessResultInputExecutionDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutThirdPartyJobSuccessResultInputExecutionDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>PutThirdPartyJobSuccessResultInputExecutionDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutThirdPartyJobSuccessResultInputExecutionDetails</code>.
     */
 ...
 */
PutThirdPartyJobSuccessResultInputExecutionDetails.prototype['summary'] = undefined;

/**
 * @member {String} externalExecutionId
 */
PutThirdPartyJobSuccessResultInputExecutionDetails.prototype['externalExecutionId'] = undefined;

/**
 * @member {Number} percentComplete
 */
PutThirdPartyJobSuccessResultInputExecutionDetails.prototype['percentComplete'] = undefined;
 ...
 * @member {String} summary
 */
ExecutionDetails.prototype['summary'] = undefined;
/**
 * @member {String} externalExecutionId
 */
ExecutionDetails.prototype['externalExecutionId'] = undefined;
/**
 * @member {Number} percentComplete
 */
ExecutionDetails.prototype['percentComplete'] = undefined;




export default PutThirdPartyJobSuccessResultInputExecutionDetails;
