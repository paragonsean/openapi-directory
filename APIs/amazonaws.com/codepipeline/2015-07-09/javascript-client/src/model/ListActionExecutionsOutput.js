...
/**
 * The ListActionExecutionsOutput model module.
 * @module model/ListActionExecutionsOutput
 * @version 2015-07-09
 */
class ListActionExecutionsOutput {
    /**
     * Constructs a new <code>ListActionExecutionsOutput</code>.
     * @alias module:model/ListActionExecutionsOutput
     */
    constructor() { 
        
        ListActionExecutionsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListActionExecutionsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListActionExecutionsOutput} obj Optional instance to populate.
     * @return {module:model/ListActionExecutionsOutput} The populated <code>ListActionExecutionsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListActionExecutionsOutput();

            if (data.hasOwnProperty('actionExecutionDetails')) {
                obj['actionExecutionDetails'] = ApiClient.convertToType(data['actionExecutionDetails'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListActionExecutionsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListActionExecutionsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `actionExecutionDetails`
        if (data['actionExecutionDetails']) { // data not null
          Array.validateJSON(data['actionExecutionDetails']);
        }
...
/**
 * @member {Array} actionExecutionDetails
 */
ListActionExecutionsOutput.prototype['actionExecutionDetails'] = undefined;

/**
 * @member {String} nextToken
 */
ListActionExecutionsOutput.prototype['nextToken'] = undefined;
...
export default ListActionExecutionsOutput;
