...
/**
 * The ListWebhooksOutput model module.
 * @module model/ListWebhooksOutput
 * @version 2015-07-09
 */
class ListWebhooksOutput {
    /**
     * Constructs a new <code>ListWebhooksOutput</code>.
     * @alias module:model/ListWebhooksOutput
     */
    constructor() { 
        
        ListWebhooksOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListWebhooksOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListWebhooksOutput} obj Optional instance to populate.
     * @return {module:model/ListWebhooksOutput} The populated <code>ListWebhooksOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListWebhooksOutput();

            if (data.hasOwnProperty('webhooks')) {
                obj['webhooks'] = ApiClient.convertToType(data['webhooks'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListWebhooksOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListWebhooksOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `webhooks`
        if (data['webhooks']) { // data not null
          Array.validateJSON(data['webhooks']);
        }
...
/**
 * @member {Array} webhooks
 */
ListWebhooksOutput.prototype['webhooks'] = undefined;

/**
 * @member {String} NextToken
 */
ListWebhooksOutput.prototype['NextToken'] = undefined;
...
export default ListWebhooksOutput;
