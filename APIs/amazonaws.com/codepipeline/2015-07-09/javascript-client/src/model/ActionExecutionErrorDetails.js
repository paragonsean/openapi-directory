...
/**
 * The ActionExecutionErrorDetails model module.
 * @module model/ActionExecutionErrorDetails
 * @version 2015-07-09
 */
class ActionExecutionErrorDetails {
    /**
     * Constructs a new <code>ActionExecutionErrorDetails</code>.
     * @alias module:model/ActionExecutionErrorDetails
     * @implements module:model/ErrorDetails
     */
    constructor() { 
        ErrorDetails.initialize(this);
        ActionExecutionErrorDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActionExecutionErrorDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionExecutionErrorDetails} obj Optional instance to populate.
     * @return {module:model/ActionExecutionErrorDetails} The populated <code>ActionExecutionErrorDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionExecutionErrorDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionExecutionErrorDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionExecutionErrorDetails</code>.
     */
 ...
 * @member {String} code
 */
ActionExecutionErrorDetails.prototype['code'] = undefined;

/**
 * @member {String} message
 */
ActionExecutionErrorDetails.prototype['message'] = undefined;
...
export default ActionExecutionErrorDetails;
