...
import PipelineContextAction from './PipelineContextAction';
import PipelineContextStage from './PipelineContextStage';

/**
 * The JobDataPipelineContext model module.
 * @module model/JobDataPipelineContext
 * @version 2015-07-09
 */
class JobDataPipelineContext {
    /**
     * Constructs a new <code>JobDataPipelineContext</code>.
     * @alias module:model/JobDataPipelineContext
     * @implements module:model/PipelineContext
     */
    constructor() { 
        PipelineContext.initialize(this);
        JobDataPipelineContext.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JobDataPipelineContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JobDataPipelineContext} obj Optional instance to populate.
     * @return {module:model/JobDataPipelineContext} The populated <code>JobDataPipelineContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JobDataPipelineContext();
            PipelineContext.constructFromObject(data, obj);

            if (data.hasOwnProperty('pipelineName')) {
                obj['pipelineName'] = ApiClient.convertToType(data['pipelineName'], 'String');
            }
            if (data.hasOwnProperty('stage')) {
                obj['stage'] = PipelineContextStage.constructFromObject(data['stage']);
            }
            if (data.hasOwnProperty('action')) {
                obj['action'] = PipelineContextAction.constructFromObject(data['action']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>JobDataPipelineContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JobDataPipelineContext</code>.
     */
    static validateJSON(data) {
        ...
        if (data['stage']) { // data not null
          PipelineContextStage.validateJSON(data['stage']);
        }
        // validate the optional field `action`
        if (data['action']) { // data not null
          PipelineContextAction.validateJSON(data['action']);
        }
 ...
 */
JobDataPipelineContext.prototype['pipelineName'] = undefined;

/**
 * @member {module:model/PipelineContextStage} stage
 */
JobDataPipelineContext.prototype['stage'] = undefined;

/**
 * @member {module:model/PipelineContextAction} action
 */
JobDataPipelineContext.prototype['action'] = undefined;

/**
 * @member {String} pipelineArn
 */
JobDataPipelineContext.prototype['pipelineArn'] = undefined;

/**
 * @member {String} pipelineExecutionId
 */
JobDataPipelineContext.prototype['pipelineExecutionId'] = undefined;


// Implement PipelineContext interface:
/**
 * @member {String} pipelineName
 */
PipelineContext.prototype['pipelineName'] = undefined;
/**
 * @member {module:model/PipelineContextStage} stage
 */
PipelineContext.prototype['stage'] = undefined;
/**
 * @member {module:model/PipelineContextAction} action
 */
PipelineContext.prototype['action'] = undefined;
/**
 * @member {String} pipelineArn
 */
PipelineContext.prototype['pipelineArn'] = undefined;
/**
 * @member {String} pipelineExecutionId
 */
PipelineContext.prototype['pipelineExecutionId'] = undefined;




export default JobDataPipelineContext;
