...
/**
 * The PutActionRevisionInputActionRevision model module.
 * @module model/PutActionRevisionInputActionRevision
 * @version 2015-07-09
 */
class PutActionRevisionInputActionRevision {
    /**
     * Constructs a new <code>PutActionRevisionInputActionRevision</code>.
     * @alias module:model/PutActionRevisionInputActionRevision
     * @implements module:model/ActionRevision
    ...
    constructor(revisionId, revisionChangeId, created) { 
        ...
        PutActionRevisionInputActionRevision.initialize(this, revisionId, revisionChangeId, created);
    }
    ...
    /**
     * Constructs a <code>PutActionRevisionInputActionRevision</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutActionRevisionInputActionRevision} obj Optional instance to populate.
     * @return {module:model/PutActionRevisionInputActionRevision} The populated <code>PutActionRevisionInputActionRevision</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutActionRevisionInputActionRevision();
            ActionRevision.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PutActionRevisionInputActionRevision</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutActionRevisionInputActionRevision</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutActionRevisionInputActionRevision.RequiredProperties) {
...
PutActionRevisionInputActionRevision.RequiredProperties = ["revisionId", "revisionChangeId", "created"];

/**
 * @member {String} revisionId
 */
PutActionRevisionInputActionRevision.prototype['revisionId'] = undefined;

/**
 * @member {String} revisionChangeId
 */
PutActionRevisionInputActionRevision.prototype['revisionChangeId'] = undefined;

/**
 * @member {Date} created
 */
PutActionRevisionInputActionRevision.prototype['created'] = undefined;


// Implement ActionRevision interface:
/**
 * @member {String} revisionId
 */
...
export default PutActionRevisionInputActionRevision;
