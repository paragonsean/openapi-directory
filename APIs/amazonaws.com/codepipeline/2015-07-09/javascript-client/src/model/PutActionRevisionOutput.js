...
/**
 * The PutActionRevisionOutput model module.
 * @module model/PutActionRevisionOutput
 * @version 2015-07-09
 */
class PutActionRevisionOutput {
    /**
     * Constructs a new <code>PutActionRevisionOutput</code>.
     * Represents the output of a &lt;code&gt;PutActionRevision&lt;/code&gt; action.
     * @alias module:model/PutActionRevisionOutput
     */
    constructor() { 
        
        PutActionRevisionOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutActionRevisionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutActionRevisionOutput} obj Optional instance to populate.
     * @return {module:model/PutActionRevisionOutput} The populated <code>PutActionRevisionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutActionRevisionOutput();

            if (data.hasOwnProperty('newRevision')) {
                obj['newRevision'] = ApiClient.convertToType(data['newRevision'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PutActionRevisionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutActionRevisionOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `newRevision`
        if (data['newRevision']) { // data not null
          Boolean.validateJSON(data['newRevision']);
        }
...
/**
 * @member {Boolean} newRevision
 */
PutActionRevisionOutput.prototype['newRevision'] = undefined;

/**
 * @member {String} pipelineExecutionId
 */
PutActionRevisionOutput.prototype['pipelineExecutionId'] = undefined;
...
export default PutActionRevisionOutput;
