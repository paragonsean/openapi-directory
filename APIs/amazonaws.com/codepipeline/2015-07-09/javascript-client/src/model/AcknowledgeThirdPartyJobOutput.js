...
/**
 * The AcknowledgeThirdPartyJobOutput model module.
 * @module model/AcknowledgeThirdPartyJobOutput
 * @version 2015-07-09
 */
class AcknowledgeThirdPartyJobOutput {
    /**
     * Constructs a new <code>AcknowledgeThirdPartyJobOutput</code>.
     * Represents the output of an AcknowledgeThirdPartyJob action.
     * @alias module:model/AcknowledgeThirdPartyJobOutput
     */
    constructor() { 
        
        AcknowledgeThirdPartyJobOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AcknowledgeThirdPartyJobOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AcknowledgeThirdPartyJobOutput} obj Optional instance to populate.
     * @return {module:model/AcknowledgeThirdPartyJobOutput} The populated <code>AcknowledgeThirdPartyJobOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AcknowledgeThirdPartyJobOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>AcknowledgeThirdPartyJobOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AcknowledgeThirdPartyJobOutput</code>.
     */
 ...
 */
AcknowledgeThirdPartyJobOutput.prototype['status'] = undefined;
...
export default AcknowledgeThirdPartyJobOutput;
