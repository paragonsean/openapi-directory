...
* @readonly
*/
export default class StageExecutionStatus {
    ...
    /**
    * Returns a <code>StageExecutionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StageExecutionStatus} The enum <code>StageExecutionStatus</code> value.
    */
