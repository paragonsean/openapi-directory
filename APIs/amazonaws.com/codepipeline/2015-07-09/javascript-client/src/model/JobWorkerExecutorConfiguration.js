...
/**
 * The JobWorkerExecutorConfiguration model module.
 * @module model/JobWorkerExecutorConfiguration
 * @version 2015-07-09
 */
class JobWorkerExecutorConfiguration {
    /**
     * Constructs a new <code>JobWorkerExecutorConfiguration</code>.
     * Details about the polling configuration for the &lt;code&gt;JobWorker&lt;/code&gt; action engine, or executor.
     * @alias module:model/JobWorkerExecutorConfiguration
     */
    constructor() { 
        
        JobWorkerExecutorConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JobWorkerExecutorConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JobWorkerExecutorConfiguration} obj Optional instance to populate.
     * @return {module:model/JobWorkerExecutorConfiguration} The populated <code>JobWorkerExecutorConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JobWorkerExecutorConfiguration();

            if (data.hasOwnProperty('pollingAccounts')) {
                obj['pollingAccounts'] = ApiClient.convertToType(data['pollingAccounts'], Array);
            }
            if (data.hasOwnProperty('pollingServicePrincipals')) {
                obj['pollingServicePrincipals'] = ApiClient.convertToType(data['pollingServicePrincipals'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>JobWorkerExecutorConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JobWorkerExecutorConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `pollingAccounts`
        if (data['pollingAccounts']) { // data not null
          Array.validateJSON(data['pollingAccounts']);
        }
        // validate the optional field `pollingServicePrincipals`
        if (data['pollingServicePrincipals']) { // data not null
          Array.validateJSON(data['pollingServicePrincipals']);
        }
...
/**
 * @member {Array} pollingAccounts
 */
JobWorkerExecutorConfiguration.prototype['pollingAccounts'] = undefined;

/**
 * @member {Array} pollingServicePrincipals
 */
JobWorkerExecutorConfiguration.prototype['pollingServicePrincipals'] = undefined;
...
export default JobWorkerExecutorConfiguration;
