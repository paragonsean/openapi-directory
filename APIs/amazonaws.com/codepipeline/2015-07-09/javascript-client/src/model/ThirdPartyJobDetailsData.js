...
/**
 * The ThirdPartyJobDetailsData model module.
 * @module model/ThirdPartyJobDetailsData
 * @version 2015-07-09
 */
class ThirdPartyJobDetailsData {
    /**
     * Constructs a new <code>ThirdPartyJobDetailsData</code>.
     * @alias module:model/ThirdPartyJobDetailsData
     * @implements module:model/ThirdPartyJobData
     */
    constructor() { 
        ThirdPartyJobData.initialize(this);
        ThirdPartyJobDetailsData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ThirdPartyJobDetailsData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ThirdPartyJobDetailsData} obj Optional instance to populate.
     * @return {module:model/ThirdPartyJobDetailsData} The populated <code>ThirdPartyJobDetailsData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ThirdPartyJobDetailsData();
            ThirdPartyJobData.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ThirdPartyJobDetailsData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ThirdPartyJobDetailsData</code>.
     */
 ...
 */
ThirdPartyJobDetailsData.prototype['actionTypeId'] = undefined;

/**
 * @member {module:model/JobDataActionConfiguration} actionConfiguration
 */
ThirdPartyJobDetailsData.prototype['actionConfiguration'] = undefined;

/**
 * @member {module:model/ThirdPartyJobDataPipelineContext} pipelineContext
 */
ThirdPartyJobDetailsData.prototype['pipelineContext'] = undefined;

/**
 * @member {Array} inputArtifacts
 */
ThirdPartyJobDetailsData.prototype['inputArtifacts'] = undefined;

/**
 * @member {Array} outputArtifacts
 */
ThirdPartyJobDetailsData.prototype['outputArtifacts'] = undefined;

/**
 * @member {module:model/ThirdPartyJobDataArtifactCredentials} artifactCredentials
 */
ThirdPartyJobDetailsData.prototype['artifactCredentials'] = undefined;

/**
 * @member {String} continuationToken
 */
ThirdPartyJobDetailsData.prototype['continuationToken'] = undefined;

/**
 * @member {module:model/ThirdPartyJobDataEncryptionKey} encryptionKey
 */
ThirdPartyJobDetailsData.prototype['encryptionKey'] = undefined;


// Implement ThirdPartyJobData interface:
/**
 * @member {module:model/PollForJobsInputActionTypeId} actionTypeId
 */
...
export default ThirdPartyJobDetailsData;
