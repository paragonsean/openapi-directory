...
/**
 * The DeletePipelineInput model module.
 * @module model/DeletePipelineInput
 * @version 2015-07-09
 */
class DeletePipelineInput {
    /**
     * Constructs a new <code>DeletePipelineInput</code>.
     * Represents the input of a &lt;code&gt;DeletePipeline&lt;/code&gt; action.
     * @alias module:model/DeletePipelineInput
     * @param name {String} 
     */
    constructor(name) { 
        
        DeletePipelineInput.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DeletePipelineInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePipelineInput} obj Optional instance to populate.
     * @return {module:model/DeletePipelineInput} The populated <code>DeletePipelineInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePipelineInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePipelineInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePipelineInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePipelineInput.RequiredProperties) {
...
DeletePipelineInput.RequiredProperties = ["name"];

/**
 * @member {String} name
 */
DeletePipelineInput.prototype['name'] = undefined;
...
export default DeletePipelineInput;
