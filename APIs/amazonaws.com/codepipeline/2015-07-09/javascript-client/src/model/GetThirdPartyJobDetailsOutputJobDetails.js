...
/**
 * The GetThirdPartyJobDetailsOutputJobDetails model module.
 * @module model/GetThirdPartyJobDetailsOutputJobDetails
 * @version 2015-07-09
 */
class GetThirdPartyJobDetailsOutputJobDetails {
    /**
     * Constructs a new <code>GetThirdPartyJobDetailsOutputJobDetails</code>.
     * @alias module:model/GetThirdPartyJobDetailsOutputJobDetails
     * @implements module:model/ThirdPartyJobDetails
     */
    constructor() { 
        ThirdPartyJobDetails.initialize(this);
        GetThirdPartyJobDetailsOutputJobDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetThirdPartyJobDetailsOutputJobDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetThirdPartyJobDetailsOutputJobDetails} obj Optional instance to populate.
     * @return {module:model/GetThirdPartyJobDetailsOutputJobDetails} The populated <code>GetThirdPartyJobDetailsOutputJobDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetThirdPartyJobDetailsOutputJobDetails();
            ThirdPartyJobDetails.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetThirdPartyJobDetailsOutputJobDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetThirdPartyJobDetailsOutputJobDetails</code>.
     */
 ...
 * @member {String} id
 */
GetThirdPartyJobDetailsOutputJobDetails.prototype['id'] = undefined;

/**
 * @member {module:model/ThirdPartyJobDetailsData} data
 */
GetThirdPartyJobDetailsOutputJobDetails.prototype['data'] = undefined;

/**
 * @member {String} nonce
 */
GetThirdPartyJobDetailsOutputJobDetails.prototype['nonce'] = undefined;


// Implement ThirdPartyJobDetails interface:
/**
 * @member {String} id
 */
...
export default GetThirdPartyJobDetailsOutputJobDetails;
