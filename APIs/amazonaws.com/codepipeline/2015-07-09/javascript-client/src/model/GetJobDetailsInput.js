...
/**
 * The GetJobDetailsInput model module.
 * @module model/GetJobDetailsInput
 * @version 2015-07-09
 */
class GetJobDetailsInput {
    /**
     * Constructs a new <code>GetJobDetailsInput</code>.
     * Represents the input of a &lt;code&gt;GetJobDetails&lt;/code&gt; action.
     * @alias module:model/GetJobDetailsInput
     * @param jobId {String} 
     */
    constructor(jobId) { 
        
        GetJobDetailsInput.initialize(this, jobId);
    }
    ...
    /**
     * Constructs a <code>GetJobDetailsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetJobDetailsInput} obj Optional instance to populate.
     * @return {module:model/GetJobDetailsInput} The populated <code>GetJobDetailsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetJobDetailsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetJobDetailsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetJobDetailsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetJobDetailsInput.RequiredProperties) {
...
GetJobDetailsInput.RequiredProperties = ["jobId"];

/**
 * @member {String} jobId
 */
GetJobDetailsInput.prototype['jobId'] = undefined;
...
export default GetJobDetailsInput;
