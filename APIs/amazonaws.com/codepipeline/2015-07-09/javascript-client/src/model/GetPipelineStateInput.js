...
/**
 * The GetPipelineStateInput model module.
 * @module model/GetPipelineStateInput
 * @version 2015-07-09
 */
class GetPipelineStateInput {
    /**
     * Constructs a new <code>GetPipelineStateInput</code>.
     * Represents the input of a &lt;code&gt;GetPipelineState&lt;/code&gt; action.
     * @alias module:model/GetPipelineStateInput
     * @param name {String} 
     */
    constructor(name) { 
        
        GetPipelineStateInput.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>GetPipelineStateInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPipelineStateInput} obj Optional instance to populate.
     * @return {module:model/GetPipelineStateInput} The populated <code>GetPipelineStateInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPipelineStateInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPipelineStateInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPipelineStateInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPipelineStateInput.RequiredProperties) {
...
GetPipelineStateInput.RequiredProperties = ["name"];

/**
 * @member {String} name
 */
GetPipelineStateInput.prototype['name'] = undefined;
...
export default GetPipelineStateInput;
