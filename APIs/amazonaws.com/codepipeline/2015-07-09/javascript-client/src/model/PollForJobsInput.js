...
/**
 * The PollForJobsInput model module.
 * @module model/PollForJobsInput
 * @version 2015-07-09
 */
class PollForJobsInput {
    /**
     * Constructs a new <code>PollForJobsInput</code>.
     * Represents the input of a &lt;code&gt;PollForJobs&lt;/code&gt; action.
     * @alias module:model/PollForJobsInput
     * @param actionTypeId {module:model/PollForJobsInputActionTypeId} 
     */
    constructor(actionTypeId) { 
        
        PollForJobsInput.initialize(this, actionTypeId);
    }
    ...
    /**
     * Constructs a <code>PollForJobsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PollForJobsInput} obj Optional instance to populate.
     * @return {module:model/PollForJobsInput} The populated <code>PollForJobsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PollForJobsInput();
            ...
            if (data.hasOwnProperty('queryParam')) {
                obj['queryParam'] = ApiClient.convertToType(data['queryParam'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PollForJobsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PollForJobsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PollForJobsInput.RequiredProperties) {
        ...
        if (data['queryParam']) { // data not null
          Object.validateJSON(data['queryParam']);
        }
...
PollForJobsInput.RequiredProperties = ["actionTypeId"];

/**
 * @member {module:model/PollForJobsInputActionTypeId} actionTypeId
 */
PollForJobsInput.prototype['actionTypeId'] = undefined;

/**
 * @member {Number} maxBatchSize
 */
PollForJobsInput.prototype['maxBatchSize'] = undefined;

/**
 * @member {Object} queryParam
 */
PollForJobsInput.prototype['queryParam'] = undefined;
...
export default PollForJobsInput;
