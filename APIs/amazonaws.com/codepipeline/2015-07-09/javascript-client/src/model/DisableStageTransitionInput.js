...
import StageTransitionType from './StageTransitionType';

/**
 * The DisableStageTransitionInput model module.
 * @module model/DisableStageTransitionInput
 * @version 2015-07-09
 */
class DisableStageTransitionInput {
    /**
     * Constructs a new <code>DisableStageTransitionInput</code>.
     * Represents the input of a &lt;code&gt;DisableStageTransition&lt;/code&gt; action.
     * @alias module:model/DisableStageTransitionInput
     * @param pipelineName {String} 
     * @param stageName {String} 
     * @param transitionType {module:model/StageTransitionType} 
     * @param reason {String} 
     */
    constructor(pipelineName, stageName, transitionType, reason) { 
        
        DisableStageTransitionInput.initialize(this, pipelineName, stageName, transitionType, reason);
    }
     ...
     */
    static initialize(obj, pipelineName, stageName, transitionType, reason) { 
    ...
    /**
     * Constructs a <code>DisableStageTransitionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisableStageTransitionInput} obj Optional instance to populate.
     * @return {module:model/DisableStageTransitionInput} The populated <code>DisableStageTransitionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisableStageTransitionInput();
            ...
            if (data.hasOwnProperty('transitionType')) {
                obj['transitionType'] = ApiClient.convertToType(data['transitionType'], StageTransitionType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DisableStageTransitionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisableStageTransitionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisableStageTransitionInput.RequiredProperties) {
        ...
        // validate the optional field `transitionType`
        if (data['transitionType']) { // data not null
          StageTransitionType.validateJSON(data['transitionType']);
        }
...
DisableStageTransitionInput.RequiredProperties = ["pipelineName", "stageName", "transitionType", "reason"];

/**
 * @member {String} pipelineName
 */
DisableStageTransitionInput.prototype['pipelineName'] = undefined;

/**
 * @member {String} stageName
 */
DisableStageTransitionInput.prototype['stageName'] = undefined;

/**
 * @member {module:model/StageTransitionType} transitionType
 */
DisableStageTransitionInput.prototype['transitionType'] = undefined;

/**
 * @member {String} reason
 */
DisableStageTransitionInput.prototype['reason'] = undefined;
...
export default DisableStageTransitionInput;
