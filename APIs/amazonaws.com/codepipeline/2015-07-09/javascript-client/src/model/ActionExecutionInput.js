...
/**
 * The ActionExecutionInput model module.
 * @module model/ActionExecutionInput
 * @version 2015-07-09
 */
class ActionExecutionInput {
    /**
     * Constructs a new <code>ActionExecutionInput</code>.
     * Input information used for an action execution.
     * @alias module:model/ActionExecutionInput
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ActionExecutionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionExecutionInput} obj Optional instance to populate.
     * @return {module:model/ActionExecutionInput} The populated <code>ActionExecutionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionExecutionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionExecutionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionExecutionInput</code>.
     */
...
export default ActionExecutionInput;
