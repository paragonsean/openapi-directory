...
/**
 * The PutApprovalResultInputResult model module.
 * @module model/PutApprovalResultInputResult
 * @version 2015-07-09
 */
class PutApprovalResultInputResult {
    /**
     * Constructs a new <code>PutApprovalResultInputResult</code>.
     * @alias module:model/PutApprovalResultInputResult
     * @implements module:model/ApprovalResult
     * @param summary {String} 
     * @param status {module:model/ApprovalStatus} 
     */
    constructor(summary, status) { 
        ApprovalResult.initialize(this, summary, status);
        PutApprovalResultInputResult.initialize(this, summary, status);
    }
     ...
     */
    static initialize(obj, summary, status) { 
        obj['summary'] = summary;
        obj['status'] = status;
    }

    /**
     * Constructs a <code>PutApprovalResultInputResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutApprovalResultInputResult} obj Optional instance to populate.
     * @return {module:model/PutApprovalResultInputResult} The populated <code>PutApprovalResultInputResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutApprovalResultInputResult();
            ApprovalResult.constructFromObject(data, obj);

            if (data.hasOwnProperty('summary')) {
                obj['summary'] = ApiClient.convertToType(data['summary'], 'String');
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], ApprovalStatus);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutApprovalResultInputResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutApprovalResultInputResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutApprovalResultInputResult.RequiredProperties) {
        ...
        if (data['status']) { // data not null
          ApprovalStatus.validateJSON(data['status']);
        }
...
PutApprovalResultInputResult.RequiredProperties = ["summary", "status"];

/**
 * @member {String} summary
 */
PutApprovalResultInputResult.prototype['summary'] = undefined;

/**
 * @member {module:model/ApprovalStatus} status
 */
PutApprovalResultInputResult.prototype['status'] = undefined;


// Implement ApprovalResult interface:
/**
 * @member {String} summary
 */
ApprovalResult.prototype['summary'] = undefined;
/**
 * @member {module:model/ApprovalStatus} status
 */
ApprovalResult.prototype['status'] = undefined;




export default PutApprovalResultInputResult;
