...
import ActionStateLatestExecution from './ActionStateLatestExecution';
import PutActionRevisionInputActionRevision from './PutActionRevisionInputActionRevision';

/**
 * The ActionState model module.
 * @module model/ActionState
 * @version 2015-07-09
 */
class ActionState {
    /**
     ...
     * @alias module:model/ActionState
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ActionState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionState} obj Optional instance to populate.
     * @return {module:model/ActionState} The populated <code>ActionState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionState();
            ...
            if (data.hasOwnProperty('currentRevision')) {
                obj['currentRevision'] = PutActionRevisionInputActionRevision.constructFromObject(data['currentRevision']);
            }
            if (data.hasOwnProperty('latestExecution')) {
                obj['latestExecution'] = ActionStateLatestExecution.constructFromObject(data['latestExecution']);
            }
            if (data.hasOwnProperty('entityUrl')) {
                obj['entityUrl'] = ApiClient.convertToType(data['entityUrl'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ActionState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionState</code>.
     */
    static validateJSON(data) {
        ...
        if (data['currentRevision']) { // data not null
          PutActionRevisionInputActionRevision.validateJSON(data['currentRevision']);
        }
        // validate the optional field `latestExecution`
        if (data['latestExecution']) { // data not null
          ActionStateLatestExecution.validateJSON(data['latestExecution']);
        }
        // validate the optional field `entityUrl`
        if (data['entityUrl']) { // data not null
          String.validateJSON(data['entityUrl']);
        }
 ...
 */
ActionState.prototype['actionName'] = undefined;

/**
 * @member {module:model/PutActionRevisionInputActionRevision} currentRevision
 */
ActionState.prototype['currentRevision'] = undefined;

/**
 * @member {module:model/ActionStateLatestExecution} latestExecution
 */
ActionState.prototype['latestExecution'] = undefined;

/**
 * @member {String} entityUrl
 */
ActionState.prototype['entityUrl'] = undefined;

/**
 * @member {String} revisionUrl
 */
ActionState.prototype['revisionUrl'] = undefined;
