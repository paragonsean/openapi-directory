...
/**
 * The ListPipelineExecutionsInput model module.
 * @module model/ListPipelineExecutionsInput
 * @version 2015-07-09
 */
class ListPipelineExecutionsInput {
    /**
     * Constructs a new <code>ListPipelineExecutionsInput</code>.
     * Represents the input of a &lt;code&gt;ListPipelineExecutions&lt;/code&gt; action.
     * @alias module:model/ListPipelineExecutionsInput
     * @param pipelineName {String} 
     */
    constructor(pipelineName) { 
        
        ListPipelineExecutionsInput.initialize(this, pipelineName);
    }
    ...
    /**
     * Constructs a <code>ListPipelineExecutionsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPipelineExecutionsInput} obj Optional instance to populate.
     * @return {module:model/ListPipelineExecutionsInput} The populated <code>ListPipelineExecutionsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPipelineExecutionsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPipelineExecutionsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPipelineExecutionsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListPipelineExecutionsInput.RequiredProperties) {
...
ListPipelineExecutionsInput.RequiredProperties = ["pipelineName"];

/**
 * @member {String} pipelineName
 */
ListPipelineExecutionsInput.prototype['pipelineName'] = undefined;

/**
 * @member {Number} maxResults
 */
ListPipelineExecutionsInput.prototype['maxResults'] = undefined;

/**
 * @member {String} nextToken
 */
ListPipelineExecutionsInput.prototype['nextToken'] = undefined;
...
export default ListPipelineExecutionsInput;
