...
class JobDetailsData {
    ...
    constructor() { 
        ...
        JobDetailsData.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>JobDetailsData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JobDetailsData</code>.
     */
 ...
 */
JobDetailsData.prototype['actionTypeId'] = undefined;

/**
 * @member {module:model/JobDataActionConfiguration} actionConfiguration
 */
JobDetailsData.prototype['actionConfiguration'] = undefined;

/**
 * @member {module:model/JobDataPipelineContext} pipelineContext
 */
JobDetailsData.prototype['pipelineContext'] = undefined;

/**
 * @member {Array} inputArtifacts
 */
JobDetailsData.prototype['inputArtifacts'] = undefined;

/**
 * @member {Array} outputArtifacts
 */
JobDetailsData.prototype['outputArtifacts'] = undefined;

/**
 * @member {module:model/JobDataArtifactCredentials} artifactCredentials
 */
JobDetailsData.prototype['artifactCredentials'] = undefined;

/**
 * @member {String} continuationToken
 */
JobDetailsData.prototype['continuationToken'] = undefined;

/**
 * @member {module:model/JobDataEncryptionKey} encryptionKey
 */
JobDetailsData.prototype['encryptionKey'] = undefined;
