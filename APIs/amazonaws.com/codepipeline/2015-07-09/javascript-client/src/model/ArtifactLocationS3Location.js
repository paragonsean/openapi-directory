...
/**
 * The ArtifactLocationS3Location model module.
 * @module model/ArtifactLocationS3Location
 * @version 2015-07-09
 */
class ArtifactLocationS3Location {
    /**
     * Constructs a new <code>ArtifactLocationS3Location</code>.
     * @alias module:model/ArtifactLocationS3Location
     * @implements module:model/S3ArtifactLocation
     * @param bucketName {String} 
     * @param objectKey {String} 
     */
    constructor(bucketName, objectKey) { 
        S3ArtifactLocation.initialize(this, bucketName, objectKey);
        ArtifactLocationS3Location.initialize(this, bucketName, objectKey);
    }
    ...
    /**
     * Constructs a <code>ArtifactLocationS3Location</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ArtifactLocationS3Location} obj Optional instance to populate.
     * @return {module:model/ArtifactLocationS3Location} The populated <code>ArtifactLocationS3Location</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArtifactLocationS3Location();
            S3ArtifactLocation.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ArtifactLocationS3Location</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ArtifactLocationS3Location</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ArtifactLocationS3Location.RequiredProperties) {
...
ArtifactLocationS3Location.RequiredProperties = ["bucketName", "objectKey"];

/**
 * @member {String} bucketName
 */
ArtifactLocationS3Location.prototype['bucketName'] = undefined;

/**
 * @member {String} objectKey
 */
ArtifactLocationS3Location.prototype['objectKey'] = undefined;


// Implement S3ArtifactLocation interface:
/**
 * @member {String} bucketName
 */
S3ArtifactLocation.prototype['bucketName'] = undefined;
/**
 * @member {String} objectKey
 */
S3ArtifactLocation.prototype['objectKey'] = undefined;




export default ArtifactLocationS3Location;
