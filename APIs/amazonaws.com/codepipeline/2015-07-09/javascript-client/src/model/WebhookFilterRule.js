...
/**
 * The WebhookFilterRule model module.
 * @module model/WebhookFilterRule
 * @version 2015-07-09
 */
class WebhookFilterRule {
    /**
     * Constructs a new <code>WebhookFilterRule</code>.
     * The event criteria that specify when a webhook notification is sent to your URL.
     * @alias module:model/WebhookFilterRule
     * @param jsonPath {String} 
     */
    constructor(jsonPath) { 
        
        WebhookFilterRule.initialize(this, jsonPath);
    }
    ...
    /**
     * Constructs a <code>WebhookFilterRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookFilterRule} obj Optional instance to populate.
     * @return {module:model/WebhookFilterRule} The populated <code>WebhookFilterRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookFilterRule();

            if (data.hasOwnProperty('jsonPath')) {
                obj['jsonPath'] = ApiClient.convertToType(data['jsonPath'], 'String');
            }
            if (data.hasOwnProperty('matchEquals')) {
                obj['matchEquals'] = ApiClient.convertToType(data['matchEquals'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookFilterRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookFilterRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookFilterRule.RequiredProperties) {
        ...
        // validate the optional field `matchEquals`
        if (data['matchEquals']) { // data not null
          String.validateJSON(data['matchEquals']);
        }
...
WebhookFilterRule.RequiredProperties = ["jsonPath"];

/**
 * @member {String} jsonPath
 */
WebhookFilterRule.prototype['jsonPath'] = undefined;

/**
 * @member {String} matchEquals
 */
WebhookFilterRule.prototype['matchEquals'] = undefined;
...
export default WebhookFilterRule;
