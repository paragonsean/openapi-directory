...
/**
 * The PutApprovalResultOutput model module.
 * @module model/PutApprovalResultOutput
 * @version 2015-07-09
 */
class PutApprovalResultOutput {
    /**
     * Constructs a new <code>PutApprovalResultOutput</code>.
     * Represents the output of a &lt;code&gt;PutApprovalResult&lt;/code&gt; action.
     * @alias module:model/PutApprovalResultOutput
     */
    constructor() { 
        
        PutApprovalResultOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutApprovalResultOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutApprovalResultOutput} obj Optional instance to populate.
     * @return {module:model/PutApprovalResultOutput} The populated <code>PutApprovalResultOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutApprovalResultOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>PutApprovalResultOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutApprovalResultOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `approvedAt`
        if (data['approvedAt']) { // data not null
          Date.validateJSON(data['approvedAt']);
        }
 ...
 */
PutApprovalResultOutput.prototype['approvedAt'] = undefined;
...
export default PutApprovalResultOutput;
