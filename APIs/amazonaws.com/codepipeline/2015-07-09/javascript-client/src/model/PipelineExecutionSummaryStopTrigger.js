...
/**
 * The PipelineExecutionSummaryStopTrigger model module.
 * @module model/PipelineExecutionSummaryStopTrigger
 * @version 2015-07-09
 */
class PipelineExecutionSummaryStopTrigger {
    /**
     * Constructs a new <code>PipelineExecutionSummaryStopTrigger</code>.
     * @alias module:model/PipelineExecutionSummaryStopTrigger
     * @implements module:model/StopExecutionTrigger
     */
    constructor() { 
        StopExecutionTrigger.initialize(this);
        PipelineExecutionSummaryStopTrigger.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PipelineExecutionSummaryStopTrigger</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PipelineExecutionSummaryStopTrigger} obj Optional instance to populate.
     * @return {module:model/PipelineExecutionSummaryStopTrigger} The populated <code>PipelineExecutionSummaryStopTrigger</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PipelineExecutionSummaryStopTrigger();
            StopExecutionTrigger.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PipelineExecutionSummaryStopTrigger</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PipelineExecutionSummaryStopTrigger</code>.
     */
 ...
 */
PipelineExecutionSummaryStopTrigger.prototype['reason'] = undefined;


// Implement StopExecutionTrigger interface:
/**
 * @member {String} reason
 */
StopExecutionTrigger.prototype['reason'] = undefined;




export default PipelineExecutionSummaryStopTrigger;
