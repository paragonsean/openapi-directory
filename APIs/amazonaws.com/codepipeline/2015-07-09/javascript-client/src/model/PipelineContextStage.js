...
/**
 * The PipelineContextStage model module.
 * @module model/PipelineContextStage
 * @version 2015-07-09
 */
class PipelineContextStage {
    /**
     * Constructs a new <code>PipelineContextStage</code>.
     * @alias module:model/PipelineContextStage
     * @implements module:model/StageContext
     */
    constructor() { 
        StageContext.initialize(this);
        PipelineContextStage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PipelineContextStage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PipelineContextStage} obj Optional instance to populate.
     * @return {module:model/PipelineContextStage} The populated <code>PipelineContextStage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PipelineContextStage();
            StageContext.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PipelineContextStage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PipelineContextStage</code>.
     */
 ...
 * @member {String} name
 */
PipelineContextStage.prototype['name'] = undefined;


// Implement StageContext interface:
/**
 * @member {String} name
 */
StageContext.prototype['name'] = undefined;




export default PipelineContextStage;
