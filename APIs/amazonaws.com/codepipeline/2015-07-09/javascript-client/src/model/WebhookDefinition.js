...
import WebhookAuthenticationType from './WebhookAuthenticationType';
import WebhookDefinitionAuthenticationConfiguration from './WebhookDefinitionAuthenticationConfiguration';
...
class WebhookDefinition {
     ...
     * @param name {String} 
     * @param targetPipeline {String} 
     * @param targetAction {String} 
     * @param filters {Array} 
     * @param authentication {module:model/WebhookAuthenticationType} 
     * @param authenticationConfiguration {module:model/WebhookDefinitionAuthenticationConfiguration} 
     */
    constructor(name, targetPipeline, targetAction, filters, authentication, authenticationConfiguration) { 
        
        WebhookDefinition.initialize(this, name, targetPipeline, targetAction, filters, authentication, authenticationConfiguration);
    }
     ...
     */
    static initialize(obj, name, targetPipeline, targetAction, filters, authentication, authenticationConfiguration) { 
        obj['name'] = name;
        obj['targetPipeline'] = targetPipeline;
        obj['targetAction'] = targetAction;
        obj['filters'] = filters;
        obj['authentication'] = authentication;
        obj['authenticationConfiguration'] = authenticationConfiguration;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('targetPipeline')) {
                obj['targetPipeline'] = ApiClient.convertToType(data['targetPipeline'], 'String');
            }
            ...
            if (data.hasOwnProperty('authentication')) {
                obj['authentication'] = ApiClient.convertToType(data['authentication'], WebhookAuthenticationType);
            }
            if (data.hasOwnProperty('authenticationConfiguration')) {
                obj['authenticationConfiguration'] = WebhookDefinitionAuthenticationConfiguration.constructFromObject(data['authenticationConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDefinition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDefinition.RequiredProperties) {
        ...
        // validate the optional field `targetPipeline`
        if (data['targetPipeline']) { // data not null
          String.validateJSON(data['targetPipeline']);
        }
        // validate the optional field `targetAction`
        if (data['targetAction']) { // data not null
          String.validateJSON(data['targetAction']);
        }
        ...
        if (data['authentication']) { // data not null
          WebhookAuthenticationType.validateJSON(data['authentication']);
        }
        // validate the optional field `authenticationConfiguration`
        if (data['authenticationConfiguration']) { // data not null
          WebhookDefinitionAuthenticationConfiguration.validateJSON(data['authenticationConfiguration']);
        }
...
WebhookDefinition.RequiredProperties = ["name", "targetPipeline", "targetAction", "filters", "authentication", "authenticationConfiguration"];

/**
 * @member {String} name
 */
WebhookDefinition.prototype['name'] = undefined;

/**
 * @member {String} targetPipeline
 */
WebhookDefinition.prototype['targetPipeline'] = undefined;

/**
 * @member {String} targetAction
 */
WebhookDefinition.prototype['targetAction'] = undefined;

/**
 * @member {Array} filters
 */
WebhookDefinition.prototype['filters'] = undefined;

/**
 * @member {module:model/WebhookAuthenticationType} authentication
 */
WebhookDefinition.prototype['authentication'] = undefined;

/**
 * @member {module:model/WebhookDefinitionAuthenticationConfiguration} authenticationConfiguration
 */
WebhookDefinition.prototype['authenticationConfiguration'] = undefined;
