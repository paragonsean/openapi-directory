...
import ActionExecutionOutputExecutionResult from './ActionExecutionOutputExecutionResult';

/**
 * The ActionExecutionDetailOutput model module.
 * @module model/ActionExecutionDetailOutput
 * @version 2015-07-09
 */
class ActionExecutionDetailOutput {
    /**
     * Constructs a new <code>ActionExecutionDetailOutput</code>.
     * @alias module:model/ActionExecutionDetailOutput
     * @implements module:model/ActionExecutionOutput
     */
    constructor() { 
        ActionExecutionOutput.initialize(this);
        ActionExecutionDetailOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActionExecutionDetailOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionExecutionDetailOutput} obj Optional instance to populate.
     * @return {module:model/ActionExecutionDetailOutput} The populated <code>ActionExecutionDetailOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionExecutionDetailOutput();
            ActionExecutionOutput.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('executionResult')) {
                obj['executionResult'] = ActionExecutionOutputExecutionResult.constructFromObject(data['executionResult']);
            }
            if (data.hasOwnProperty('outputVariables')) {
                obj['outputVariables'] = ApiClient.convertToType(data['outputVariables'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ActionExecutionDetailOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionExecutionDetailOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['executionResult']) { // data not null
          ActionExecutionOutputExecutionResult.validateJSON(data['executionResult']);
        }
        // validate the optional field `outputVariables`
        if (data['outputVariables']) { // data not null
          Object.validateJSON(data['outputVariables']);
        }
 ...
 */
ActionExecutionDetailOutput.prototype['outputArtifacts'] = undefined;

/**
 * @member {module:model/ActionExecutionOutputExecutionResult} executionResult
 */
ActionExecutionDetailOutput.prototype['executionResult'] = undefined;

/**
 * @member {Object} outputVariables
 */
ActionExecutionDetailOutput.prototype['outputVariables'] = undefined;


// Implement ActionExecutionOutput interface:
/**
 * @member {Array} outputArtifacts
 */
ActionExecutionOutput.prototype['outputArtifacts'] = undefined;
/**
 * @member {module:model/ActionExecutionOutputExecutionResult} executionResult
 */
ActionExecutionOutput.prototype['executionResult'] = undefined;
/**
 * @member {Object} outputVariables
 */
ActionExecutionOutput.prototype['outputVariables'] = undefined;




export default ActionExecutionDetailOutput;
