...
/**
 * The LambdaExecutorConfiguration model module.
 * @module model/LambdaExecutorConfiguration
 * @version 2015-07-09
 */
class LambdaExecutorConfiguration {
    /**
     * Constructs a new <code>LambdaExecutorConfiguration</code>.
     * Details about the configuration for the &lt;code&gt;Lambda&lt;/code&gt; action engine, or executor.
     * @alias module:model/LambdaExecutorConfiguration
     * @param lambdaFunctionArn {String} 
     */
    constructor(lambdaFunctionArn) { 
        
        LambdaExecutorConfiguration.initialize(this, lambdaFunctionArn);
    }
     ...
     */
    static initialize(obj, lambdaFunctionArn) { 
        obj['lambdaFunctionArn'] = lambdaFunctionArn;
    }

    /**
     * Constructs a <code>LambdaExecutorConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LambdaExecutorConfiguration} obj Optional instance to populate.
     * @return {module:model/LambdaExecutorConfiguration} The populated <code>LambdaExecutorConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LambdaExecutorConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>LambdaExecutorConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LambdaExecutorConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LambdaExecutorConfiguration.RequiredProperties) {
...
LambdaExecutorConfiguration.RequiredProperties = ["lambdaFunctionArn"];

/**
 * @member {String} lambdaFunctionArn
 */
LambdaExecutorConfiguration.prototype['lambdaFunctionArn'] = undefined;
...
export default LambdaExecutorConfiguration;
