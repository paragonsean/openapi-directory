...
/**
 * The ActionTypeProperty model module.
 * @module model/ActionTypeProperty
 * @version 2015-07-09
 */
class ActionTypeProperty {
    /**
     * Constructs a new <code>ActionTypeProperty</code>.
     * Represents information about each property specified in the action configuration, such as the description and key name that display for the customer using the action type.
     * @alias module:model/ActionTypeProperty
     * @param name {String} 
     * @param optional {Boolean} 
     * @param key {Boolean} 
     * @param noEcho {Boolean} 
     */
    constructor(name, optional, key, noEcho) { 
        
        ActionTypeProperty.initialize(this, name, optional, key, noEcho);
    }
     ...
     */
    static initialize(obj, name, optional, key, noEcho) { 
        obj['name'] = name;
    ...
    /**
     * Constructs a <code>ActionTypeProperty</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionTypeProperty} obj Optional instance to populate.
     * @return {module:model/ActionTypeProperty} The populated <code>ActionTypeProperty</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionTypeProperty();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionTypeProperty</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionTypeProperty</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionTypeProperty.RequiredProperties) {
        ...
        if (data['queryable']) { // data not null
          Boolean.validateJSON(data['queryable']);
        }
...
ActionTypeProperty.RequiredProperties = ["name", "optional", "key", "noEcho"];

/**
 * @member {String} name
 */
ActionTypeProperty.prototype['name'] = undefined;

/**
 * @member {Boolean} optional
 */
ActionTypeProperty.prototype['optional'] = undefined;

/**
 * @member {Boolean} key
 */
ActionTypeProperty.prototype['key'] = undefined;

/**
 * @member {Boolean} noEcho
 */
ActionTypeProperty.prototype['noEcho'] = undefined;

/**
 * @member {Boolean} queryable
 */
ActionTypeProperty.prototype['queryable'] = undefined;

/**
 * @member {String} description
 */
ActionTypeProperty.prototype['description'] = undefined;
