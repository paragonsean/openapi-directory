...
* @readonly
*/
export default class ArtifactLocationType {
    ...
    /**
    * Returns a <code>ArtifactLocationType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ArtifactLocationType} The enum <code>ArtifactLocationType</code> value.
    */
