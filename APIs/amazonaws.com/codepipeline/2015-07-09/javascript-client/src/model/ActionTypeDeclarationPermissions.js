...
/**
 * The ActionTypeDeclarationPermissions model module.
 * @module model/ActionTypeDeclarationPermissions
 * @version 2015-07-09
 */
class ActionTypeDeclarationPermissions {
    /**
     * Constructs a new <code>ActionTypeDeclarationPermissions</code>.
     * @alias module:model/ActionTypeDeclarationPermissions
     * @implements module:model/ActionTypePermissions
     * @param allowedAccounts {Array} 
     */
    constructor(allowedAccounts) { 
        ActionTypePermissions.initialize(this, allowedAccounts);
        ActionTypeDeclarationPermissions.initialize(this, allowedAccounts);
    }
     ...
     */
    static initialize(obj, allowedAccounts) { 
        obj['allowedAccounts'] = allowedAccounts;
    }

    /**
     * Constructs a <code>ActionTypeDeclarationPermissions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionTypeDeclarationPermissions} obj Optional instance to populate.
     * @return {module:model/ActionTypeDeclarationPermissions} The populated <code>ActionTypeDeclarationPermissions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionTypeDeclarationPermissions();
            ActionTypePermissions.constructFromObject(data, obj);

            if (data.hasOwnProperty('allowedAccounts')) {
                obj['allowedAccounts'] = ApiClient.convertToType(data['allowedAccounts'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ActionTypeDeclarationPermissions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionTypeDeclarationPermissions</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionTypeDeclarationPermissions.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `allowedAccounts`
        if (data['allowedAccounts']) { // data not null
          Array.validateJSON(data['allowedAccounts']);
        }
...
ActionTypeDeclarationPermissions.RequiredProperties = ["allowedAccounts"];

/**
 * @member {Array} allowedAccounts
 */
ActionTypeDeclarationPermissions.prototype['allowedAccounts'] = undefined;


// Implement ActionTypePermissions interface:
/**
 * @member {Array} allowedAccounts
 */
ActionTypePermissions.prototype['allowedAccounts'] = undefined;




export default ActionTypeDeclarationPermissions;
