...
/**
 * The DeregisterWebhookWithThirdPartyInput model module.
 * @module model/DeregisterWebhookWithThirdPartyInput
 * @version 2015-07-09
 */
class DeregisterWebhookWithThirdPartyInput {
    /**
     * Constructs a new <code>DeregisterWebhookWithThirdPartyInput</code>.
     * @alias module:model/DeregisterWebhookWithThirdPartyInput
     */
    constructor() { 
        
        DeregisterWebhookWithThirdPartyInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeregisterWebhookWithThirdPartyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeregisterWebhookWithThirdPartyInput} obj Optional instance to populate.
     * @return {module:model/DeregisterWebhookWithThirdPartyInput} The populated <code>DeregisterWebhookWithThirdPartyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeregisterWebhookWithThirdPartyInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeregisterWebhookWithThirdPartyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeregisterWebhookWithThirdPartyInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `webhookName`
        if (data['webhookName']) { // data not null
          String.validateJSON(data['webhookName']);
        }
 ...
 */
DeregisterWebhookWithThirdPartyInput.prototype['webhookName'] = undefined;
...
export default DeregisterWebhookWithThirdPartyInput;
