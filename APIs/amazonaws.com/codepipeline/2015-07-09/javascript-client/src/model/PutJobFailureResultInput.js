...
import PutJobFailureResultInputFailureDetails from './PutJobFailureResultInputFailureDetails';

/**
 * The PutJobFailureResultInput model module.
 * @module model/PutJobFailureResultInput
 * @version 2015-07-09
 */
class PutJobFailureResultInput {
    /**
     * Constructs a new <code>PutJobFailureResultInput</code>.
     * Represents the input of a &lt;code&gt;PutJobFailureResult&lt;/code&gt; action.
     * @alias module:model/PutJobFailureResultInput
     * @param jobId {String} 
     * @param failureDetails {module:model/PutJobFailureResultInputFailureDetails} 
     */
    constructor(jobId, failureDetails) { 
        
        PutJobFailureResultInput.initialize(this, jobId, failureDetails);
    }
     ...
     */
    static initialize(obj, jobId, failureDetails) { 
        obj['jobId'] = jobId;
        obj['failureDetails'] = failureDetails;
    }

    /**
     * Constructs a <code>PutJobFailureResultInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutJobFailureResultInput} obj Optional instance to populate.
     * @return {module:model/PutJobFailureResultInput} The populated <code>PutJobFailureResultInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutJobFailureResultInput();

            if (data.hasOwnProperty('jobId')) {
                obj['jobId'] = ApiClient.convertToType(data['jobId'], 'String');
            }
            if (data.hasOwnProperty('failureDetails')) {
                obj['failureDetails'] = PutJobFailureResultInputFailureDetails.constructFromObject(data['failureDetails']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutJobFailureResultInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutJobFailureResultInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutJobFailureResultInput.RequiredProperties) {
        ...
        if (data['failureDetails']) { // data not null
          PutJobFailureResultInputFailureDetails.validateJSON(data['failureDetails']);
        }
...
PutJobFailureResultInput.RequiredProperties = ["jobId", "failureDetails"];

/**
 * @member {String} jobId
 */
PutJobFailureResultInput.prototype['jobId'] = undefined;

/**
 * @member {module:model/PutJobFailureResultInputFailureDetails} failureDetails
 */
PutJobFailureResultInput.prototype['failureDetails'] = undefined;
...
export default PutJobFailureResultInput;
