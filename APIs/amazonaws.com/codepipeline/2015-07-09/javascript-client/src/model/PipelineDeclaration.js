...
/**
 * The PipelineDeclaration model module.
 * @module model/PipelineDeclaration
 * @version 2015-07-09
 */
class PipelineDeclaration {
    /**
     * Constructs a new <code>PipelineDeclaration</code>.
     * Represents the structure of actions and stages to be performed in the pipeline.
     * @alias module:model/PipelineDeclaration
     * @param name {String} 
    ...
    /**
     * Constructs a <code>PipelineDeclaration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PipelineDeclaration} obj Optional instance to populate.
     * @return {module:model/PipelineDeclaration} The populated <code>PipelineDeclaration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PipelineDeclaration();
    ...
    /**
     * Validates the JSON data with respect to <code>PipelineDeclaration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PipelineDeclaration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PipelineDeclaration.RequiredProperties) {
...
PipelineDeclaration.RequiredProperties = ["name", "roleArn", "stages"];
...
export default PipelineDeclaration;
