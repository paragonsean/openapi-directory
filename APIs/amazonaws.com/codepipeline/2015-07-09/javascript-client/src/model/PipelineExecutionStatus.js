...
* @readonly
*/
export default class PipelineExecutionStatus {
    ...
    /**
    * Returns a <code>PipelineExecutionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PipelineExecutionStatus} The enum <code>PipelineExecutionStatus</code> value.
    */
