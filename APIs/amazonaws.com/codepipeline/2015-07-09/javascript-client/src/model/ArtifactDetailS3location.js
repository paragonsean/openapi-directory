...
/**
 * The ArtifactDetailS3location model module.
 * @module model/ArtifactDetailS3location
 * @version 2015-07-09
 */
class ArtifactDetailS3location {
    /**
     * Constructs a new <code>ArtifactDetailS3location</code>.
     * @alias module:model/ArtifactDetailS3location
     * @implements module:model/S3Location
     */
    constructor() { 
        S3Location.initialize(this);
        ArtifactDetailS3location.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ArtifactDetailS3location</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ArtifactDetailS3location} obj Optional instance to populate.
     * @return {module:model/ArtifactDetailS3location} The populated <code>ArtifactDetailS3location</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArtifactDetailS3location();
    ...
    /**
     * Validates the JSON data with respect to <code>ArtifactDetailS3location</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ArtifactDetailS3location</code>.
     */
 ...
 */
ArtifactDetailS3location.prototype['bucket'] = undefined;

/**
 * @member {String} key
 */
ArtifactDetailS3location.prototype['key'] = undefined;
...
export default ArtifactDetailS3location;
