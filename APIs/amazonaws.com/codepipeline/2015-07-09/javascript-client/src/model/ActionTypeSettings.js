...
/**
 * The ActionTypeSettings model module.
 * @module model/ActionTypeSettings
 * @version 2015-07-09
 */
class ActionTypeSettings {
    /**
     * Constructs a new <code>ActionTypeSettings</code>.
     * @alias module:model/ActionTypeSettings
    ...
    /**
     * Constructs a <code>ActionTypeSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionTypeSettings} obj Optional instance to populate.
     * @return {module:model/ActionTypeSettings} The populated <code>ActionTypeSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionTypeSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionTypeSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionTypeSettings</code>.
     */
...
export default ActionTypeSettings;
