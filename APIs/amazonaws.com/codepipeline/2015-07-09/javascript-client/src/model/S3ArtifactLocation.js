...
/**
 * The S3ArtifactLocation model module.
 * @module model/S3ArtifactLocation
 * @version 2015-07-09
 */
class S3ArtifactLocation {
    /**
     * Constructs a new <code>S3ArtifactLocation</code>.
     * The location of the S3 bucket that contains a revision.
     * @alias module:model/S3ArtifactLocation
    ...
    /**
     * Constructs a <code>S3ArtifactLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/S3ArtifactLocation} obj Optional instance to populate.
     * @return {module:model/S3ArtifactLocation} The populated <code>S3ArtifactLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new S3ArtifactLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>S3ArtifactLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>S3ArtifactLocation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of S3ArtifactLocation.RequiredProperties) {
...
S3ArtifactLocation.RequiredProperties = ["bucketName", "objectKey"];
...
export default S3ArtifactLocation;
