...
* @readonly
*/
export default class StageTransitionType {
    ...
    /**
    * Returns a <code>StageTransitionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StageTransitionType} The enum <code>StageTransitionType</code> value.
    */
