...
* @readonly
*/
export default class ArtifactStoreType {
    ...
    /**
    * Returns a <code>ArtifactStoreType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ArtifactStoreType} The enum <code>ArtifactStoreType</code> value.
    */
