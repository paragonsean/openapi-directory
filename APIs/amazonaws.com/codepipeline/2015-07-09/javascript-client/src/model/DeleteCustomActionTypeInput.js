...
/**
 * The DeleteCustomActionTypeInput model module.
 * @module model/DeleteCustomActionTypeInput
 * @version 2015-07-09
 */
class DeleteCustomActionTypeInput {
    /**
     * Constructs a new <code>DeleteCustomActionTypeInput</code>.
     * Represents the input of a &lt;code&gt;DeleteCustomActionType&lt;/code&gt; operation. The custom action will be marked as deleted.
     * @alias module:model/DeleteCustomActionTypeInput
     * @param category {module:model/ActionCategory} 
     * @param provider {String} 
     * @param version {String} 
     */
    constructor(category, provider, version) { 
        
        DeleteCustomActionTypeInput.initialize(this, category, provider, version);
    }
     ...
     */
    static initialize(obj, category, provider, version) { 
    ...
    /**
     * Constructs a <code>DeleteCustomActionTypeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteCustomActionTypeInput} obj Optional instance to populate.
     * @return {module:model/DeleteCustomActionTypeInput} The populated <code>DeleteCustomActionTypeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteCustomActionTypeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteCustomActionTypeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteCustomActionTypeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteCustomActionTypeInput.RequiredProperties) {
...
DeleteCustomActionTypeInput.RequiredProperties = ["category", "provider", "version"];

/**
 * @member {module:model/ActionCategory} category
 */
DeleteCustomActionTypeInput.prototype['category'] = undefined;

/**
 * @member {String} provider
 */
DeleteCustomActionTypeInput.prototype['provider'] = undefined;

/**
 * @member {String} version
 */
DeleteCustomActionTypeInput.prototype['version'] = undefined;
...
export default DeleteCustomActionTypeInput;
