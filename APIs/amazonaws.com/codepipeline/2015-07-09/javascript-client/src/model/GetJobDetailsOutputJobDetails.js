...
/**
 * The GetJobDetailsOutputJobDetails model module.
 * @module model/GetJobDetailsOutputJobDetails
 * @version 2015-07-09
 */
class GetJobDetailsOutputJobDetails {
    /**
     * Constructs a new <code>GetJobDetailsOutputJobDetails</code>.
     * @alias module:model/GetJobDetailsOutputJobDetails
     * @implements module:model/JobDetails
     */
    constructor() { 
        JobDetails.initialize(this);
        GetJobDetailsOutputJobDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetJobDetailsOutputJobDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetJobDetailsOutputJobDetails} obj Optional instance to populate.
     * @return {module:model/GetJobDetailsOutputJobDetails} The populated <code>GetJobDetailsOutputJobDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetJobDetailsOutputJobDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>GetJobDetailsOutputJobDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetJobDetailsOutputJobDetails</code>.
     */
 ...
 * @member {String} id
 */
GetJobDetailsOutputJobDetails.prototype['id'] = undefined;

/**
 * @member {module:model/JobDetailsData} data
 */
GetJobDetailsOutputJobDetails.prototype['data'] = undefined;

/**
 * @member {String} accountId
 */
GetJobDetailsOutputJobDetails.prototype['accountId'] = undefined;
...
export default GetJobDetailsOutputJobDetails;
