...
/**
 * The ActionTypeUrls model module.
 * @module model/ActionTypeUrls
 * @version 2015-07-09
 */
class ActionTypeUrls {
    /**
     * Constructs a new <code>ActionTypeUrls</code>.
     ...
     * @alias module:model/ActionTypeUrls
     */
    constructor() { 
        
        ActionTypeUrls.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActionTypeUrls</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionTypeUrls} obj Optional instance to populate.
     * @return {module:model/ActionTypeUrls} The populated <code>ActionTypeUrls</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionTypeUrls();

            if (data.hasOwnProperty('configurationUrl')) {
                obj['configurationUrl'] = ApiClient.convertToType(data['configurationUrl'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ActionTypeUrls</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionTypeUrls</code>.
     */
    static validateJSON(data) {
        // validate the optional field `configurationUrl`
        if (data['configurationUrl']) { // data not null
          String.validateJSON(data['configurationUrl']);
        }
...
/**
 * @member {String} configurationUrl
 */
ActionTypeUrls.prototype['configurationUrl'] = undefined;

/**
 * @member {String} entityUrlTemplate
 */
ActionTypeUrls.prototype['entityUrlTemplate'] = undefined;

/**
 * @member {String} executionUrlTemplate
 */
ActionTypeUrls.prototype['executionUrlTemplate'] = undefined;

/**
 * @member {String} revisionUrlTemplate
 */
ActionTypeUrls.prototype['revisionUrlTemplate'] = undefined;
