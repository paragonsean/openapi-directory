...
import PutJobSuccessResultInputCurrentRevision from './PutJobSuccessResultInputCurrentRevision';
import PutJobSuccessResultInputExecutionDetails from './PutJobSuccessResultInputExecutionDetails';

/**
 * The PutJobSuccessResultInput model module.
 * @module model/PutJobSuccessResultInput
 * @version 2015-07-09
 */
class PutJobSuccessResultInput {
    /**
     * Constructs a new <code>PutJobSuccessResultInput</code>.
     * Represents the input of a &lt;code&gt;PutJobSuccessResult&lt;/code&gt; action.
     * @alias module:model/PutJobSuccessResultInput
     * @param jobId {String} 
     */
    constructor(jobId) { 
        
        PutJobSuccessResultInput.initialize(this, jobId);
    }
    ...
    /**
     * Constructs a <code>PutJobSuccessResultInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutJobSuccessResultInput} obj Optional instance to populate.
     * @return {module:model/PutJobSuccessResultInput} The populated <code>PutJobSuccessResultInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutJobSuccessResultInput();

            if (data.hasOwnProperty('jobId')) {
                obj['jobId'] = ApiClient.convertToType(data['jobId'], 'String');
            }
            if (data.hasOwnProperty('currentRevision')) {
                obj['currentRevision'] = PutJobSuccessResultInputCurrentRevision.constructFromObject(data['currentRevision']);
            }
            if (data.hasOwnProperty('continuationToken')) {
                obj['continuationToken'] = ApiClient.convertToType(data['continuationToken'], 'String');
            }
            if (data.hasOwnProperty('executionDetails')) {
                obj['executionDetails'] = PutJobSuccessResultInputExecutionDetails.constructFromObject(data['executionDetails']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PutJobSuccessResultInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutJobSuccessResultInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutJobSuccessResultInput.RequiredProperties) {
        ...
        if (data['currentRevision']) { // data not null
          PutJobSuccessResultInputCurrentRevision.validateJSON(data['currentRevision']);
        }
        ...
        if (data['executionDetails']) { // data not null
          PutJobSuccessResultInputExecutionDetails.validateJSON(data['executionDetails']);
        }
...
PutJobSuccessResultInput.RequiredProperties = ["jobId"];

/**
 * @member {String} jobId
 */
PutJobSuccessResultInput.prototype['jobId'] = undefined;

/**
 * @member {module:model/PutJobSuccessResultInputCurrentRevision} currentRevision
 */
PutJobSuccessResultInput.prototype['currentRevision'] = undefined;

/**
 * @member {String} continuationToken
 */
PutJobSuccessResultInput.prototype['continuationToken'] = undefined;

/**
 * @member {module:model/PutJobSuccessResultInputExecutionDetails} executionDetails
 */
PutJobSuccessResultInput.prototype['executionDetails'] = undefined;

/**
 * @member {Object} outputVariables
 */
PutJobSuccessResultInput.prototype['outputVariables'] = undefined;
...
export default PutJobSuccessResultInput;
