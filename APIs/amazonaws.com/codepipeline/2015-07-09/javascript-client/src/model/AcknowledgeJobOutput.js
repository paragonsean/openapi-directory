...
/**
 * The AcknowledgeJobOutput model module.
 * @module model/AcknowledgeJobOutput
 * @version 2015-07-09
 */
class AcknowledgeJobOutput {
    /**
     * Constructs a new <code>AcknowledgeJobOutput</code>.
     * Represents the output of an AcknowledgeJob action.
     * @alias module:model/AcknowledgeJobOutput
     */
    constructor() { 
        
        AcknowledgeJobOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AcknowledgeJobOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AcknowledgeJobOutput} obj Optional instance to populate.
     * @return {module:model/AcknowledgeJobOutput} The populated <code>AcknowledgeJobOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AcknowledgeJobOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>AcknowledgeJobOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AcknowledgeJobOutput</code>.
     */
 ...
 */
AcknowledgeJobOutput.prototype['status'] = undefined;
...
export default AcknowledgeJobOutput;
