...
/**
 * The ListWebhookItem model module.
 * @module model/ListWebhookItem
 * @version 2015-07-09
 */
class ListWebhookItem {
    /**
     * Constructs a new <code>ListWebhookItem</code>.
     * The detail returned for each webhook after listing webhooks, such as the webhook URL, the webhook name, and the webhook ARN.
     * @alias module:model/ListWebhookItem
    ...
    /**
     * Constructs a <code>ListWebhookItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListWebhookItem} obj Optional instance to populate.
     * @return {module:model/ListWebhookItem} The populated <code>ListWebhookItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListWebhookItem();
    ...
    /**
     * Validates the JSON data with respect to <code>ListWebhookItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListWebhookItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListWebhookItem.RequiredProperties) {
...
ListWebhookItem.RequiredProperties = ["definition", "url"];
...
export default ListWebhookItem;
