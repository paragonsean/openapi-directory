...
/**
 * The JobDataEncryptionKey model module.
 * @module model/JobDataEncryptionKey
 * @version 2015-07-09
 */
class JobDataEncryptionKey {
    /**
     * Constructs a new <code>JobDataEncryptionKey</code>.
     * @alias module:model/JobDataEncryptionKey
    ...
    constructor(id, type) { 
        ...
        JobDataEncryptionKey.initialize(this, id, type);
    }
    ...
    /**
     * Constructs a <code>JobDataEncryptionKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JobDataEncryptionKey} obj Optional instance to populate.
     * @return {module:model/JobDataEncryptionKey} The populated <code>JobDataEncryptionKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JobDataEncryptionKey();
    ...
    /**
     * Validates the JSON data with respect to <code>JobDataEncryptionKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JobDataEncryptionKey</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of JobDataEncryptionKey.RequiredProperties) {
...
JobDataEncryptionKey.RequiredProperties = ["id", "type"];

/**
 * @member {String} id
 */
JobDataEncryptionKey.prototype['id'] = undefined;

/**
 * @member {module:model/EncryptionKeyType} type
 */
JobDataEncryptionKey.prototype['type'] = undefined;
...
export default JobDataEncryptionKey;
