...
/**
 * The SourceRevision model module.
 * @module model/SourceRevision
 * @version 2015-07-09
 */
class SourceRevision {
    /**
     * Constructs a new <code>SourceRevision</code>.
     * Information about the version (or revision) of a source artifact that initiated a pipeline execution.
     * @alias module:model/SourceRevision
     * @param actionName {String} 
     */
    constructor(actionName) { 
        
        SourceRevision.initialize(this, actionName);
    }
    ...
    /**
     * Constructs a <code>SourceRevision</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SourceRevision} obj Optional instance to populate.
     * @return {module:model/SourceRevision} The populated <code>SourceRevision</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SourceRevision();
    ...
    /**
     * Validates the JSON data with respect to <code>SourceRevision</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SourceRevision</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SourceRevision.RequiredProperties) {
...
SourceRevision.RequiredProperties = ["actionName"];

/**
 * @member {String} actionName
 */
SourceRevision.prototype['actionName'] = undefined;

/**
 * @member {String} revisionId
 */
SourceRevision.prototype['revisionId'] = undefined;

/**
 * @member {String} revisionSummary
 */
SourceRevision.prototype['revisionSummary'] = undefined;

/**
 * @member {String} revisionUrl
 */
SourceRevision.prototype['revisionUrl'] = undefined;
