...
/**
 * The ActionExecutionDetailInput model module.
 * @module model/ActionExecutionDetailInput
 * @version 2015-07-09
 */
class ActionExecutionDetailInput {
    /**
     * Constructs a new <code>ActionExecutionDetailInput</code>.
     * @alias module:model/ActionExecutionDetailInput
     * @implements module:model/ActionExecutionInput
     */
    constructor() { 
        ActionExecutionInput.initialize(this);
        ActionExecutionDetailInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActionExecutionDetailInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionExecutionDetailInput} obj Optional instance to populate.
     * @return {module:model/ActionExecutionDetailInput} The populated <code>ActionExecutionDetailInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionExecutionDetailInput();
            ActionExecutionInput.constructFromObject(data, obj);

            if (data.hasOwnProperty('actionTypeId')) {
                obj['actionTypeId'] = ActionTypeId.constructFromObject(data['actionTypeId']);
            }
            if (data.hasOwnProperty('configuration')) {
                obj['configuration'] = ApiClient.convertToType(data['configuration'], Object);
            }
            if (data.hasOwnProperty('resolvedConfiguration')) {
                obj['resolvedConfiguration'] = ApiClient.convertToType(data['resolvedConfiguration'], Object);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ActionExecutionDetailInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionExecutionDetailInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `actionTypeId`
        if (data['actionTypeId']) { // data not null
          ActionTypeId.validateJSON(data['actionTypeId']);
        }
        ...
        if (data['resolvedConfiguration']) { // data not null
          Object.validateJSON(data['resolvedConfiguration']);
        }
...
/**
 * @member {module:model/ActionTypeId} actionTypeId
 */
ActionExecutionDetailInput.prototype['actionTypeId'] = undefined;

/**
 * @member {Object} configuration
 */
ActionExecutionDetailInput.prototype['configuration'] = undefined;

/**
 * @member {Object} resolvedConfiguration
 */
ActionExecutionDetailInput.prototype['resolvedConfiguration'] = undefined;

/**
 * @member {String} roleArn
 */
ActionExecutionDetailInput.prototype['roleArn'] = undefined;

/**
 * @member {String} region
 */
ActionExecutionDetailInput.prototype['region'] = undefined;

/**
 * @member {Array} inputArtifacts
 */
ActionExecutionDetailInput.prototype['inputArtifacts'] = undefined;

/**
 * @member {String} namespace
 */
ActionExecutionDetailInput.prototype['namespace'] = undefined;


// Implement ActionExecutionInput interface:
/**
 * @member {module:model/ActionTypeId} actionTypeId
 */
ActionExecutionInput.prototype['actionTypeId'] = undefined;
/**
 * @member {Object} configuration
 */
ActionExecutionInput.prototype['configuration'] = undefined;
/**
 * @member {Object} resolvedConfiguration
 */
ActionExecutionInput.prototype['resolvedConfiguration'] = undefined;
/**
 * @member {String} roleArn
 */
ActionExecutionInput.prototype['roleArn'] = undefined;
/**
 * @member {String} region
 */
ActionExecutionInput.prototype['region'] = undefined;
/**
 * @member {Array} inputArtifacts
 */
ActionExecutionInput.prototype['inputArtifacts'] = undefined;
/**
 * @member {String} namespace
 */
ActionExecutionInput.prototype['namespace'] = undefined;




export default ActionExecutionDetailInput;
