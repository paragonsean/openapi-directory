...
import UpdateActionTypeInputActionType from './UpdateActionTypeInputActionType';

/**
 * The UpdateActionTypeInput model module.
 * @module model/UpdateActionTypeInput
 * @version 2015-07-09
 */
class UpdateActionTypeInput {
    /**
     * Constructs a new <code>UpdateActionTypeInput</code>.
     * @alias module:model/UpdateActionTypeInput
     * @param actionType {module:model/UpdateActionTypeInputActionType} 
     */
    constructor(actionType) { 
        
        UpdateActionTypeInput.initialize(this, actionType);
    }
    ...
    /**
     * Constructs a <code>UpdateActionTypeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateActionTypeInput} obj Optional instance to populate.
     * @return {module:model/UpdateActionTypeInput} The populated <code>UpdateActionTypeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateActionTypeInput();

            if (data.hasOwnProperty('actionType')) {
                obj['actionType'] = UpdateActionTypeInputActionType.constructFromObject(data['actionType']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateActionTypeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateActionTypeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateActionTypeInput.RequiredProperties) {
        ...
        if (data['actionType']) { // data not null
          UpdateActionTypeInputActionType.validateJSON(data['actionType']);
        }
...
UpdateActionTypeInput.RequiredProperties = ["actionType"];

/**
 * @member {module:model/UpdateActionTypeInputActionType} actionType
 */
UpdateActionTypeInput.prototype['actionType'] = undefined;
...
export default UpdateActionTypeInput;
