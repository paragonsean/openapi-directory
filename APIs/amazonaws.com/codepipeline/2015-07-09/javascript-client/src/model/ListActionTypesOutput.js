...
/**
 * The ListActionTypesOutput model module.
 * @module model/ListActionTypesOutput
 * @version 2015-07-09
 */
class ListActionTypesOutput {
    /**
     * Constructs a new <code>ListActionTypesOutput</code>.
     * Represents the output of a &lt;code&gt;ListActionTypes&lt;/code&gt; action.
     * @alias module:model/ListActionTypesOutput
     * @param actionTypes {Array} 
     */
    constructor(actionTypes) { 
        
        ListActionTypesOutput.initialize(this, actionTypes);
    }
     ...
     */
    static initialize(obj, actionTypes) { 
        obj['actionTypes'] = actionTypes;
    }

    /**
     * Constructs a <code>ListActionTypesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListActionTypesOutput} obj Optional instance to populate.
     * @return {module:model/ListActionTypesOutput} The populated <code>ListActionTypesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListActionTypesOutput();

            if (data.hasOwnProperty('actionTypes')) {
                obj['actionTypes'] = ApiClient.convertToType(data['actionTypes'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListActionTypesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListActionTypesOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListActionTypesOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `actionTypes`
        if (data['actionTypes']) { // data not null
          Array.validateJSON(data['actionTypes']);
        }
...
ListActionTypesOutput.RequiredProperties = ["actionTypes"];

/**
 * @member {Array} actionTypes
 */
ListActionTypesOutput.prototype['actionTypes'] = undefined;

/**
 * @member {String} nextToken
 */
ListActionTypesOutput.prototype['nextToken'] = undefined;
...
export default ListActionTypesOutput;
