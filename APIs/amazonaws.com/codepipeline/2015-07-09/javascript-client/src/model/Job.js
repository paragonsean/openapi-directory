...
class Job {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = JobData.constructFromObject(data['data']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          JobData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/JobData} data
 */
 ...
 * @member {String} nonce
 */
Job.prototype['nonce'] = undefined;

/**
 * @member {String} accountId
 */
Job.prototype['accountId'] = undefined;
