...
import JobDataArtifactCredentials from './JobDataArtifactCredentials';
import JobDataEncryptionKey from './JobDataEncryptionKey';
import JobDataPipelineContext from './JobDataPipelineContext';
...
class JobData {
     ...
     * @implements module:model/JobData
     */
    constructor() { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JobData();
            JobData.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('pipelineContext')) {
                obj['pipelineContext'] = JobDataPipelineContext.constructFromObject(data['pipelineContext']);
            }
            ...
            if (data.hasOwnProperty('artifactCredentials')) {
                obj['artifactCredentials'] = JobDataArtifactCredentials.constructFromObject(data['artifactCredentials']);
            }
            ...
            if (data.hasOwnProperty('encryptionKey')) {
                obj['encryptionKey'] = JobDataEncryptionKey.constructFromObject(data['encryptionKey']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['pipelineContext']) { // data not null
          JobDataPipelineContext.validateJSON(data['pipelineContext']);
        }
        ...
        if (data['artifactCredentials']) { // data not null
          JobDataArtifactCredentials.validateJSON(data['artifactCredentials']);
        }
        ...
        if (data['encryptionKey']) { // data not null
          JobDataEncryptionKey.validateJSON(data['encryptionKey']);
        }
 ...
 */
JobData.prototype['actionTypeId'] = undefined;

/**
 * @member {module:model/JobDataActionConfiguration} actionConfiguration
 */
JobData.prototype['actionConfiguration'] = undefined;

/**
 * @member {module:model/JobDataPipelineContext} pipelineContext
 */
JobData.prototype['pipelineContext'] = undefined;

/**
 * @member {Array} inputArtifacts
 */
JobData.prototype['inputArtifacts'] = undefined;

/**
 * @member {Array} outputArtifacts
 */
JobData.prototype['outputArtifacts'] = undefined;

/**
 * @member {module:model/JobDataArtifactCredentials} artifactCredentials
 */
JobData.prototype['artifactCredentials'] = undefined;

/**
 * @member {String} continuationToken
 */
JobData.prototype['continuationToken'] = undefined;

/**
 * @member {module:model/JobDataEncryptionKey} encryptionKey
 */
JobData.prototype['encryptionKey'] = undefined;


// Implement JobData interface:
/**
 * @member {module:model/PollForJobsInputActionTypeId} actionTypeId
 */
JobData.prototype['actionTypeId'] = undefined;
