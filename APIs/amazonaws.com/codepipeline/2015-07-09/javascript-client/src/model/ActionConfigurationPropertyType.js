...
* @readonly
*/
export default class ActionConfigurationPropertyType {
    ...
    /**
    * Returns a <code>ActionConfigurationPropertyType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ActionConfigurationPropertyType} The enum <code>ActionConfigurationPropertyType</code> value.
    */
