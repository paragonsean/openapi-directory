...
/**
 * The StageExecution model module.
 * @module model/StageExecution
 * @version 2015-07-09
 */
class StageExecution {
    /**
     * Constructs a new <code>StageExecution</code>.
     * Represents information about the run of a stage.
     * @alias module:model/StageExecution
     * @param pipelineExecutionId {String} 
     * @param status {module:model/StageExecutionStatus} 
     */
    constructor(pipelineExecutionId, status) { 
        
        StageExecution.initialize(this, pipelineExecutionId, status);
    }
     ...
     */
    static initialize(obj, pipelineExecutionId, status) { 
        obj['pipelineExecutionId'] = pipelineExecutionId;
        obj['status'] = status;
    }

    /**
     * Constructs a <code>StageExecution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StageExecution} obj Optional instance to populate.
     * @return {module:model/StageExecution} The populated <code>StageExecution</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StageExecution();
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], StageExecutionStatus);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StageExecution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StageExecution</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StageExecution.RequiredProperties) {
        ...
        if (data['status']) { // data not null
          StageExecutionStatus.validateJSON(data['status']);
        }
...
StageExecution.RequiredProperties = ["pipelineExecutionId", "status"];

/**
 * @member {String} pipelineExecutionId
 */
StageExecution.prototype['pipelineExecutionId'] = undefined;

/**
 * @member {module:model/StageExecutionStatus} status
 */
StageExecution.prototype['status'] = undefined;
