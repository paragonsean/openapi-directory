...
/**
 * The PipelineExecutionSummaryTrigger model module.
 * @module model/PipelineExecutionSummaryTrigger
 * @version 2015-07-09
 */
class PipelineExecutionSummaryTrigger {
    /**
     * Constructs a new <code>PipelineExecutionSummaryTrigger</code>.
     * @alias module:model/PipelineExecutionSummaryTrigger
     * @implements module:model/ExecutionTrigger
     */
    constructor() { 
        ExecutionTrigger.initialize(this);
        PipelineExecutionSummaryTrigger.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PipelineExecutionSummaryTrigger</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PipelineExecutionSummaryTrigger} obj Optional instance to populate.
     * @return {module:model/PipelineExecutionSummaryTrigger} The populated <code>PipelineExecutionSummaryTrigger</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PipelineExecutionSummaryTrigger();
            ExecutionTrigger.constructFromObject(data, obj);

            if (data.hasOwnProperty('triggerType')) {
                obj['triggerType'] = ApiClient.convertToType(data['triggerType'], TriggerType);
            }
            if (data.hasOwnProperty('triggerDetail')) {
                obj['triggerDetail'] = ApiClient.convertToType(data['triggerDetail'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PipelineExecutionSummaryTrigger</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PipelineExecutionSummaryTrigger</code>.
     */
    static validateJSON(data) {
        ...
        if (data['triggerDetail']) { // data not null
          String.validateJSON(data['triggerDetail']);
        }
 ...
 */
PipelineExecutionSummaryTrigger.prototype['triggerType'] = undefined;

/**
 * @member {String} triggerDetail
 */
PipelineExecutionSummaryTrigger.prototype['triggerDetail'] = undefined;


// Implement ExecutionTrigger interface:
/**
 * @member {module:model/TriggerType} triggerType
 */
ExecutionTrigger.prototype['triggerType'] = undefined;
/**
 * @member {String} triggerDetail
 */
ExecutionTrigger.prototype['triggerDetail'] = undefined;




export default PipelineExecutionSummaryTrigger;
