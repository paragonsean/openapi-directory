...
/**
 * The ActionStateLatestExecution model module.
 * @module model/ActionStateLatestExecution
 * @version 2015-07-09
 */
class ActionStateLatestExecution {
    /**
     * Constructs a new <code>ActionStateLatestExecution</code>.
     * @alias module:model/ActionStateLatestExecution
     * @implements module:model/ActionExecution
     */
    constructor() { 
        ActionExecution.initialize(this);
        ActionStateLatestExecution.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActionStateLatestExecution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionStateLatestExecution} obj Optional instance to populate.
     * @return {module:model/ActionStateLatestExecution} The populated <code>ActionStateLatestExecution</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionStateLatestExecution();
            ActionExecution.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ActionStateLatestExecution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionStateLatestExecution</code>.
     */
 ...
 */
ActionStateLatestExecution.prototype['actionExecutionId'] = undefined;

/**
 * @member {module:model/ActionExecutionStatus} status
 */
ActionStateLatestExecution.prototype['status'] = undefined;

/**
 * @member {String} summary
 */
ActionStateLatestExecution.prototype['summary'] = undefined;

/**
 * @member {Date} lastStatusChange
 */
ActionStateLatestExecution.prototype['lastStatusChange'] = undefined;

/**
 * @member {String} token
 */
ActionStateLatestExecution.prototype['token'] = undefined;

/**
 * @member {String} lastUpdatedBy
 */
ActionStateLatestExecution.prototype['lastUpdatedBy'] = undefined;

/**
 * @member {String} externalExecutionId
 */
ActionStateLatestExecution.prototype['externalExecutionId'] = undefined;

/**
 * @member {String} externalExecutionUrl
 */
ActionStateLatestExecution.prototype['externalExecutionUrl'] = undefined;

/**
 * @member {Number} percentComplete
 */
ActionStateLatestExecution.prototype['percentComplete'] = undefined;

/**
 * @member {module:model/ActionExecutionErrorDetails} errorDetails
 */
ActionStateLatestExecution.prototype['errorDetails'] = undefined;


// Implement ActionExecution interface:
/**
 * @member {String} actionExecutionId
 */
...
export default ActionStateLatestExecution;
