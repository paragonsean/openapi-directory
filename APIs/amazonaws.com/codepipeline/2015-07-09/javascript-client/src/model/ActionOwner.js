...
* @readonly
*/
export default class ActionOwner {
    ...
    /**
    * Returns a <code>ActionOwner</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ActionOwner} The enum <code>ActionOwner</code> value.
    */
