...
/**
 * The PollForJobsOutput model module.
 * @module model/PollForJobsOutput
 * @version 2015-07-09
 */
class PollForJobsOutput {
    /**
     * Constructs a new <code>PollForJobsOutput</code>.
     * Represents the output of a &lt;code&gt;PollForJobs&lt;/code&gt; action.
     * @alias module:model/PollForJobsOutput
     */
    constructor() { 
        
        PollForJobsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PollForJobsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PollForJobsOutput} obj Optional instance to populate.
     * @return {module:model/PollForJobsOutput} The populated <code>PollForJobsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PollForJobsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>PollForJobsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PollForJobsOutput</code>.
     */
 ...
 * @member {Array} jobs
 */
PollForJobsOutput.prototype['jobs'] = undefined;
...
export default PollForJobsOutput;
