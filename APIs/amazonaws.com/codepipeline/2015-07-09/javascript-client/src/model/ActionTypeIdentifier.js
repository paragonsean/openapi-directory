...
/**
 * The ActionTypeIdentifier model module.
 * @module model/ActionTypeIdentifier
 * @version 2015-07-09
 */
class ActionTypeIdentifier {
    /**
     * Constructs a new <code>ActionTypeIdentifier</code>.
     * Specifies the category, owner, provider, and version of the action type.
     * @alias module:model/ActionTypeIdentifier
    ...
    /**
     * Constructs a <code>ActionTypeIdentifier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionTypeIdentifier} obj Optional instance to populate.
     * @return {module:model/ActionTypeIdentifier} The populated <code>ActionTypeIdentifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionTypeIdentifier();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionTypeIdentifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionTypeIdentifier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionTypeIdentifier.RequiredProperties) {
...
ActionTypeIdentifier.RequiredProperties = ["category", "owner", "provider", "version"];
...
export default ActionTypeIdentifier;
