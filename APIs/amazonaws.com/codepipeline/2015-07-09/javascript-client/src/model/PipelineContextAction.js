...
/**
 * The PipelineContextAction model module.
 * @module model/PipelineContextAction
 * @version 2015-07-09
 */
class PipelineContextAction {
    /**
     * Constructs a new <code>PipelineContextAction</code>.
     * @alias module:model/PipelineContextAction
     * @implements module:model/ActionContext
     */
    constructor() { 
        ActionContext.initialize(this);
        PipelineContextAction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PipelineContextAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PipelineContextAction} obj Optional instance to populate.
     * @return {module:model/PipelineContextAction} The populated <code>PipelineContextAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PipelineContextAction();
            ActionContext.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PipelineContextAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PipelineContextAction</code>.
     */
 ...
 * @member {String} name
 */
PipelineContextAction.prototype['name'] = undefined;

/**
 * @member {String} actionExecutionId
 */
PipelineContextAction.prototype['actionExecutionId'] = undefined;


// Implement ActionContext interface:
/**
 * @member {String} name
 */
ActionContext.prototype['name'] = undefined;
/**
 * @member {String} actionExecutionId
 */
ActionContext.prototype['actionExecutionId'] = undefined;




export default PipelineContextAction;
