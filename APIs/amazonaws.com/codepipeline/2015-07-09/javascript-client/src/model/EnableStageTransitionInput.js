...
/**
 * The EnableStageTransitionInput model module.
 * @module model/EnableStageTransitionInput
 * @version 2015-07-09
 */
class EnableStageTransitionInput {
    /**
     * Constructs a new <code>EnableStageTransitionInput</code>.
     * Represents the input of an &lt;code&gt;EnableStageTransition&lt;/code&gt; action.
     * @alias module:model/EnableStageTransitionInput
     * @param pipelineName {String} 
     * @param stageName {String} 
     * @param transitionType {module:model/StageTransitionType} 
     */
    constructor(pipelineName, stageName, transitionType) { 
        
        EnableStageTransitionInput.initialize(this, pipelineName, stageName, transitionType);
    }
     ...
     */
    static initialize(obj, pipelineName, stageName, transitionType) { 
    ...
    /**
     * Constructs a <code>EnableStageTransitionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnableStageTransitionInput} obj Optional instance to populate.
     * @return {module:model/EnableStageTransitionInput} The populated <code>EnableStageTransitionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnableStageTransitionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>EnableStageTransitionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnableStageTransitionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EnableStageTransitionInput.RequiredProperties) {
...
EnableStageTransitionInput.RequiredProperties = ["pipelineName", "stageName", "transitionType"];

/**
 * @member {String} pipelineName
 */
EnableStageTransitionInput.prototype['pipelineName'] = undefined;

/**
 * @member {String} stageName
 */
EnableStageTransitionInput.prototype['stageName'] = undefined;

/**
 * @member {module:model/StageTransitionType} transitionType
 */
EnableStageTransitionInput.prototype['transitionType'] = undefined;
...
export default EnableStageTransitionInput;
