...
/**
 * The AcknowledgeJobInput model module.
 * @module model/AcknowledgeJobInput
 * @version 2015-07-09
 */
class AcknowledgeJobInput {
    /**
     * Constructs a new <code>AcknowledgeJobInput</code>.
     * Represents the input of an AcknowledgeJob action.
     * @alias module:model/AcknowledgeJobInput
     * @param jobId {String} 
     * @param nonce {String} 
     */
    constructor(jobId, nonce) { 
        
        AcknowledgeJobInput.initialize(this, jobId, nonce);
    }
     ...
     */
    static initialize(obj, jobId, nonce) { 
        obj['jobId'] = jobId;
        obj['nonce'] = nonce;
    }

    /**
     * Constructs a <code>AcknowledgeJobInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AcknowledgeJobInput} obj Optional instance to populate.
     * @return {module:model/AcknowledgeJobInput} The populated <code>AcknowledgeJobInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AcknowledgeJobInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AcknowledgeJobInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AcknowledgeJobInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AcknowledgeJobInput.RequiredProperties) {
...
AcknowledgeJobInput.RequiredProperties = ["jobId", "nonce"];

/**
 * @member {String} jobId
 */
AcknowledgeJobInput.prototype['jobId'] = undefined;

/**
 * @member {String} nonce
 */
AcknowledgeJobInput.prototype['nonce'] = undefined;
...
export default AcknowledgeJobInput;
