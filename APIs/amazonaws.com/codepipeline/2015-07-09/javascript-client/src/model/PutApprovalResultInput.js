...
import PutApprovalResultInputResult from './PutApprovalResultInputResult';

/**
 * The PutApprovalResultInput model module.
 * @module model/PutApprovalResultInput
 * @version 2015-07-09
 */
class PutApprovalResultInput {
    /**
     * Constructs a new <code>PutApprovalResultInput</code>.
     * Represents the input of a &lt;code&gt;PutApprovalResult&lt;/code&gt; action.
     * @alias module:model/PutApprovalResultInput
     * @param pipelineName {String} 
     * @param stageName {String} 
     * @param actionName {String} 
     * @param result {module:model/PutApprovalResultInputResult} 
     * @param token {String} 
     */
    constructor(pipelineName, stageName, actionName, result, token) { 
        
        PutApprovalResultInput.initialize(this, pipelineName, stageName, actionName, result, token);
    }
     ...
     */
    static initialize(obj, pipelineName, stageName, actionName, result, token) { 
    ...
    /**
     * Constructs a <code>PutApprovalResultInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutApprovalResultInput} obj Optional instance to populate.
     * @return {module:model/PutApprovalResultInput} The populated <code>PutApprovalResultInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutApprovalResultInput();
            ...
            if (data.hasOwnProperty('result')) {
                obj['result'] = PutApprovalResultInputResult.constructFromObject(data['result']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PutApprovalResultInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutApprovalResultInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutApprovalResultInput.RequiredProperties) {
        ...
        if (data['result']) { // data not null
          PutApprovalResultInputResult.validateJSON(data['result']);
        }
...
PutApprovalResultInput.RequiredProperties = ["pipelineName", "stageName", "actionName", "result", "token"];

/**
 * @member {String} pipelineName
 */
PutApprovalResultInput.prototype['pipelineName'] = undefined;

/**
 * @member {String} stageName
 */
PutApprovalResultInput.prototype['stageName'] = undefined;

/**
 * @member {String} actionName
 */
PutApprovalResultInput.prototype['actionName'] = undefined;

/**
 * @member {module:model/PutApprovalResultInputResult} result
 */
PutApprovalResultInput.prototype['result'] = undefined;

/**
 * @member {String} token
 */
PutApprovalResultInput.prototype['token'] = undefined;
...
export default PutApprovalResultInput;
