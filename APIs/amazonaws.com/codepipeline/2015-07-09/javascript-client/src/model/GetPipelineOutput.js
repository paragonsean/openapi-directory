...
import GetPipelineOutputMetadata from './GetPipelineOutputMetadata';

/**
 * The GetPipelineOutput model module.
 * @module model/GetPipelineOutput
 * @version 2015-07-09
 */
class GetPipelineOutput {
    /**
     * Constructs a new <code>GetPipelineOutput</code>.
     * Represents the output of a &lt;code&gt;GetPipeline&lt;/code&gt; action.
     * @alias module:model/GetPipelineOutput
     */
    constructor() { 
        
        GetPipelineOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPipelineOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPipelineOutput} obj Optional instance to populate.
     * @return {module:model/GetPipelineOutput} The populated <code>GetPipelineOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPipelineOutput();

            if (data.hasOwnProperty('pipeline')) {
                obj['pipeline'] = CreatePipelineOutputPipeline.constructFromObject(data['pipeline']);
            }
            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = GetPipelineOutputMetadata.constructFromObject(data['metadata']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPipelineOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPipelineOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['metadata']) { // data not null
          GetPipelineOutputMetadata.validateJSON(data['metadata']);
        }
 ...
 */
GetPipelineOutput.prototype['pipeline'] = undefined;

/**
 * @member {module:model/GetPipelineOutputMetadata} metadata
 */
GetPipelineOutput.prototype['metadata'] = undefined;
...
export default GetPipelineOutput;
