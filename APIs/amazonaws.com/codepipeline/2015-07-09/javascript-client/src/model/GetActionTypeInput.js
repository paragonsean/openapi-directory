...
/**
 * The GetActionTypeInput model module.
 * @module model/GetActionTypeInput
 * @version 2015-07-09
 */
class GetActionTypeInput {
    /**
     * Constructs a new <code>GetActionTypeInput</code>.
     * @alias module:model/GetActionTypeInput
    ...
    constructor(category, owner, provider, version) { 
        ...
        GetActionTypeInput.initialize(this, category, owner, provider, version);
    }
    ...
    /**
     * Constructs a <code>GetActionTypeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetActionTypeInput} obj Optional instance to populate.
     * @return {module:model/GetActionTypeInput} The populated <code>GetActionTypeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetActionTypeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetActionTypeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetActionTypeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetActionTypeInput.RequiredProperties) {
...
GetActionTypeInput.RequiredProperties = ["category", "owner", "provider", "version"];

/**
 * @member {module:model/ActionCategory} category
 */
GetActionTypeInput.prototype['category'] = undefined;

/**
 * @member {String} owner
 */
GetActionTypeInput.prototype['owner'] = undefined;

/**
 * @member {String} provider
 */
GetActionTypeInput.prototype['provider'] = undefined;

/**
 * @member {String} version
 */
GetActionTypeInput.prototype['version'] = undefined;
...
export default GetActionTypeInput;
