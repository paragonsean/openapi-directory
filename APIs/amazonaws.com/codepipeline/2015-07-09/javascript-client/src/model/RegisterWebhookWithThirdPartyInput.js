...
/**
 * The RegisterWebhookWithThirdPartyInput model module.
 * @module model/RegisterWebhookWithThirdPartyInput
 * @version 2015-07-09
 */
class RegisterWebhookWithThirdPartyInput {
    /**
     * Constructs a new <code>RegisterWebhookWithThirdPartyInput</code>.
     * @alias module:model/RegisterWebhookWithThirdPartyInput
     */
    constructor() { 
        
        RegisterWebhookWithThirdPartyInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RegisterWebhookWithThirdPartyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisterWebhookWithThirdPartyInput} obj Optional instance to populate.
     * @return {module:model/RegisterWebhookWithThirdPartyInput} The populated <code>RegisterWebhookWithThirdPartyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisterWebhookWithThirdPartyInput();
    ...
    /**
     * Validates the JSON data with respect to <code>RegisterWebhookWithThirdPartyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisterWebhookWithThirdPartyInput</code>.
     */
 ...
 */
RegisterWebhookWithThirdPartyInput.prototype['webhookName'] = undefined;
...
export default RegisterWebhookWithThirdPartyInput;
