...
import PutThirdPartyJobSuccessResultInputCurrentRevision from './PutThirdPartyJobSuccessResultInputCurrentRevision';
import PutThirdPartyJobSuccessResultInputExecutionDetails from './PutThirdPartyJobSuccessResultInputExecutionDetails';

/**
 * The PutThirdPartyJobSuccessResultInput model module.
 * @module model/PutThirdPartyJobSuccessResultInput
 * @version 2015-07-09
 */
class PutThirdPartyJobSuccessResultInput {
    /**
     * Constructs a new <code>PutThirdPartyJobSuccessResultInput</code>.
     * Represents the input of a &lt;code&gt;PutThirdPartyJobSuccessResult&lt;/code&gt; action.
     * @alias module:model/PutThirdPartyJobSuccessResultInput
     * @param jobId {String} 
     * @param clientToken {String} 
     */
    constructor(jobId, clientToken) { 
        
        PutThirdPartyJobSuccessResultInput.initialize(this, jobId, clientToken);
    }
    ...
    /**
     * Constructs a <code>PutThirdPartyJobSuccessResultInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutThirdPartyJobSuccessResultInput} obj Optional instance to populate.
     * @return {module:model/PutThirdPartyJobSuccessResultInput} The populated <code>PutThirdPartyJobSuccessResultInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutThirdPartyJobSuccessResultInput();
            ...
            if (data.hasOwnProperty('currentRevision')) {
                obj['currentRevision'] = PutThirdPartyJobSuccessResultInputCurrentRevision.constructFromObject(data['currentRevision']);
            }
            ...
            if (data.hasOwnProperty('executionDetails')) {
                obj['executionDetails'] = PutThirdPartyJobSuccessResultInputExecutionDetails.constructFromObject(data['executionDetails']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutThirdPartyJobSuccessResultInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutThirdPartyJobSuccessResultInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutThirdPartyJobSuccessResultInput.RequiredProperties) {
        ...
        if (data['currentRevision']) { // data not null
          PutThirdPartyJobSuccessResultInputCurrentRevision.validateJSON(data['currentRevision']);
        }
        ...
        if (data['executionDetails']) { // data not null
          PutThirdPartyJobSuccessResultInputExecutionDetails.validateJSON(data['executionDetails']);
        }
...
PutThirdPartyJobSuccessResultInput.RequiredProperties = ["jobId", "clientToken"];

/**
 * @member {String} jobId
 */
PutThirdPartyJobSuccessResultInput.prototype['jobId'] = undefined;

/**
 * @member {String} clientToken
 */
PutThirdPartyJobSuccessResultInput.prototype['clientToken'] = undefined;

/**
 * @member {module:model/PutThirdPartyJobSuccessResultInputCurrentRevision} currentRevision
 */
PutThirdPartyJobSuccessResultInput.prototype['currentRevision'] = undefined;

/**
 * @member {String} continuationToken
 */
PutThirdPartyJobSuccessResultInput.prototype['continuationToken'] = undefined;

/**
 * @member {module:model/PutThirdPartyJobSuccessResultInputExecutionDetails} executionDetails
 */
PutThirdPartyJobSuccessResultInput.prototype['executionDetails'] = undefined;
...
export default PutThirdPartyJobSuccessResultInput;
