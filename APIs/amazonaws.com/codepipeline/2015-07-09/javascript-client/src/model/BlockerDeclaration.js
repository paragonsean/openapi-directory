...
/**
 * The BlockerDeclaration model module.
 * @module model/BlockerDeclaration
 * @version 2015-07-09
 */
class BlockerDeclaration {
    /**
     * Constructs a new <code>BlockerDeclaration</code>.
     * Reserved for future use.
     * @alias module:model/BlockerDeclaration
     * @param name {String} 
     * @param type {module:model/BlockerType} 
     */
    constructor(name, type) { 
        
        BlockerDeclaration.initialize(this, name, type);
    }
    ...
    /**
     * Constructs a <code>BlockerDeclaration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BlockerDeclaration} obj Optional instance to populate.
     * @return {module:model/BlockerDeclaration} The populated <code>BlockerDeclaration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BlockerDeclaration();
    ...
    /**
     * Validates the JSON data with respect to <code>BlockerDeclaration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlockerDeclaration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BlockerDeclaration.RequiredProperties) {
...
BlockerDeclaration.RequiredProperties = ["name", "type"];

/**
 * @member {String} name
 */
BlockerDeclaration.prototype['name'] = undefined;

/**
 * @member {module:model/BlockerType} type
 */
BlockerDeclaration.prototype['type'] = undefined;
...
export default BlockerDeclaration;
