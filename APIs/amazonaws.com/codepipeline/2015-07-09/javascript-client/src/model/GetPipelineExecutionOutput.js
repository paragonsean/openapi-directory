...
import GetPipelineExecutionOutputPipelineExecution from './GetPipelineExecutionOutputPipelineExecution';

/**
 * The GetPipelineExecutionOutput model module.
 * @module model/GetPipelineExecutionOutput
 * @version 2015-07-09
 */
class GetPipelineExecutionOutput {
    /**
     * Constructs a new <code>GetPipelineExecutionOutput</code>.
     * Represents the output of a &lt;code&gt;GetPipelineExecution&lt;/code&gt; action.
     * @alias module:model/GetPipelineExecutionOutput
     */
    constructor() { 
        
        GetPipelineExecutionOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPipelineExecutionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPipelineExecutionOutput} obj Optional instance to populate.
     * @return {module:model/GetPipelineExecutionOutput} The populated <code>GetPipelineExecutionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPipelineExecutionOutput();

            if (data.hasOwnProperty('pipelineExecution')) {
                obj['pipelineExecution'] = GetPipelineExecutionOutputPipelineExecution.constructFromObject(data['pipelineExecution']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPipelineExecutionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPipelineExecutionOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `pipelineExecution`
        if (data['pipelineExecution']) { // data not null
          GetPipelineExecutionOutputPipelineExecution.validateJSON(data['pipelineExecution']);
        }
...
/**
 * @member {module:model/GetPipelineExecutionOutputPipelineExecution} pipelineExecution
 */
GetPipelineExecutionOutput.prototype['pipelineExecution'] = undefined;
...
export default GetPipelineExecutionOutput;
