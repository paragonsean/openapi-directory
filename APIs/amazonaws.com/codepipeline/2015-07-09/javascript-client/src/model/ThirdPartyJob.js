...
/**
 * The ThirdPartyJob model module.
 * @module model/ThirdPartyJob
 * @version 2015-07-09
 */
class ThirdPartyJob {
    /**
     * Constructs a new <code>ThirdPartyJob</code>.
     ...
     * @alias module:model/ThirdPartyJob
     */
    constructor() { 
        
        ThirdPartyJob.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ThirdPartyJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ThirdPartyJob} obj Optional instance to populate.
     * @return {module:model/ThirdPartyJob} The populated <code>ThirdPartyJob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ThirdPartyJob();
    ...
    /**
     * Validates the JSON data with respect to <code>ThirdPartyJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ThirdPartyJob</code>.
     */
 ...
 */
ThirdPartyJob.prototype['clientId'] = undefined;

/**
 * @member {String} jobId
 */
ThirdPartyJob.prototype['jobId'] = undefined;
