...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeDeclarationOutputArtifactDetails();
  });
  ...
  describe('ActionTypeDeclarationOutputArtifactDetails', function() {
    it('should create an instance of ActionTypeDeclarationOutputArtifactDetails', function() {
      // uncomment below and update the code to test ActionTypeDeclarationOutputArtifactDetails
      //var instance = new AwsCodePipeline.ActionTypeDeclarationOutputArtifactDetails();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeDeclarationOutputArtifactDetails);
    });
