...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetThirdPartyJobDetailsInput();
  });
  ...
  describe('GetThirdPartyJobDetailsInput', function() {
    it('should create an instance of GetThirdPartyJobDetailsInput', function() {
      // uncomment below and update the code to test GetThirdPartyJobDetailsInput
      //var instance = new AwsCodePipeline.GetThirdPartyJobDetailsInput();
      //expect(instance).to.be.a(AwsCodePipeline.GetThirdPartyJobDetailsInput);
    });
