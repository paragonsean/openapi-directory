...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutWebhookOutputWebhook();
  });
  ...
  describe('PutWebhookOutputWebhook', function() {
    it('should create an instance of PutWebhookOutputWebhook', function() {
      // uncomment below and update the code to test PutWebhookOutputWebhook
      //var instance = new AwsCodePipeline.PutWebhookOutputWebhook();
      //expect(instance).to.be.a(AwsCodePipeline.PutWebhookOutputWebhook);
    });
