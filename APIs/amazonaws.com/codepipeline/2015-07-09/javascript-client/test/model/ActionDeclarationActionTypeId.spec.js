...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionDeclarationActionTypeId();
  });
  ...
  describe('ActionDeclarationActionTypeId', function() {
    it('should create an instance of ActionDeclarationActionTypeId', function() {
      // uncomment below and update the code to test ActionDeclarationActionTypeId
      //var instance = new AwsCodePipeline.ActionDeclarationActionTypeId();
      //expect(instance).to.be.a(AwsCodePipeline.ActionDeclarationActionTypeId);
    });
