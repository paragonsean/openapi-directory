...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListPipelinesInput();
  });
  ...
  describe('ListPipelinesInput', function() {
    it('should create an instance of ListPipelinesInput', function() {
      ...
      //var instance = new AwsCodePipeline.ListPipelinesInput();
      //expect(instance).to.be.a(AwsCodePipeline.ListPipelinesInput);
    });
