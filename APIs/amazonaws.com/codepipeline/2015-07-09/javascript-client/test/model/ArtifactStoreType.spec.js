...
(function(root, factory) {
  ...
  describe('ArtifactStoreType', function() {
    it('should create an instance of ArtifactStoreType', function() {
      // uncomment below and update the code to test ArtifactStoreType
      //var instance = new AwsCodePipeline.ArtifactStoreType();
      //expect(instance).to.be.a(AwsCodePipeline.ArtifactStoreType);
    });
