...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.StageStateLatestExecution();
  });
  ...
  describe('StageStateLatestExecution', function() {
    it('should create an instance of StageStateLatestExecution', function() {
      // uncomment below and update the code to test StageStateLatestExecution
      //var instance = new AwsCodePipeline.StageStateLatestExecution();
      //expect(instance).to.be.a(AwsCodePipeline.StageStateLatestExecution);
    });
