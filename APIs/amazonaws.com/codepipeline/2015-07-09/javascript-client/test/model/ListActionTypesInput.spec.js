...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListActionTypesInput();
  });
  ...
  describe('ListActionTypesInput', function() {
    it('should create an instance of ListActionTypesInput', function() {
      // uncomment below and update the code to test ListActionTypesInput
      //var instance = new AwsCodePipeline.ListActionTypesInput();
      //expect(instance).to.be.a(AwsCodePipeline.ListActionTypesInput);
    });

    it('should have the property actionOwnerFilter (base name: "actionOwnerFilter")', function() {
      // uncomment below and update the code to test the property actionOwnerFilter
      //var instance = new AwsCodePipeline.ListActionTypesInput();
    ...
    it('should have the property regionFilter (base name: "regionFilter")', function() {
      // uncomment below and update the code to test the property regionFilter
      //var instance = new AwsCodePipeline.ListActionTypesInput();
      //expect(instance).to.be();
    });
