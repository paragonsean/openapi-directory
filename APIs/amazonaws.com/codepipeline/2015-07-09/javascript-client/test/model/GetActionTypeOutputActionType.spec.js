...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetActionTypeOutputActionType();
  });
  ...
  describe('GetActionTypeOutputActionType', function() {
    it('should create an instance of GetActionTypeOutputActionType', function() {
      // uncomment below and update the code to test GetActionTypeOutputActionType
      //var instance = new AwsCodePipeline.GetActionTypeOutputActionType();
      //expect(instance).to.be.a(AwsCodePipeline.GetActionTypeOutputActionType);
    });
