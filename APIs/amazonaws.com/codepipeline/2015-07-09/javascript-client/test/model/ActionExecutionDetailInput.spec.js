...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionExecutionDetailInput();
  });
  ...
  describe('ActionExecutionDetailInput', function() {
    it('should create an instance of ActionExecutionDetailInput', function() {
      // uncomment below and update the code to test ActionExecutionDetailInput
      //var instance = new AwsCodePipeline.ActionExecutionDetailInput();
      //expect(instance).to.be.a(AwsCodePipeline.ActionExecutionDetailInput);
    });
