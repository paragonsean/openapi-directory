...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutThirdPartyJobFailureResultInput();
  });
  ...
  describe('PutThirdPartyJobFailureResultInput', function() {
    it('should create an instance of PutThirdPartyJobFailureResultInput', function() {
      // uncomment below and update the code to test PutThirdPartyJobFailureResultInput
      //var instance = new AwsCodePipeline.PutThirdPartyJobFailureResultInput();
      //expect(instance).to.be.a(AwsCodePipeline.PutThirdPartyJobFailureResultInput);
    });
