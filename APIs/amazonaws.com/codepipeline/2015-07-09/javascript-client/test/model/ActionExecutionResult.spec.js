...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionExecutionResult();
  });
  ...
  describe('ActionExecutionResult', function() {
    it('should create an instance of ActionExecutionResult', function() {
      // uncomment below and update the code to test ActionExecutionResult
      //var instance = new AwsCodePipeline.ActionExecutionResult();
      //expect(instance).to.be.a(AwsCodePipeline.ActionExecutionResult);
    });
