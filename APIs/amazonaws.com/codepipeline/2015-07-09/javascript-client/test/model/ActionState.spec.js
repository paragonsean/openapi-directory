...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionState();
  });
  ...
  describe('ActionState', function() {
    it('should create an instance of ActionState', function() {
      // uncomment below and update the code to test ActionState
      //var instance = new AwsCodePipeline.ActionState();
      //expect(instance).to.be.a(AwsCodePipeline.ActionState);
    });
    ...
    it('should have the property entityUrl (base name: "entityUrl")', function() {
      // uncomment below and update the code to test the property entityUrl
      //var instance = new AwsCodePipeline.ActionState();
      //expect(instance).to.be();
    });

    it('should have the property revisionUrl (base name: "revisionUrl")', function() {
      // uncomment below and update the code to test the property revisionUrl
      //var instance = new AwsCodePipeline.ActionState();
      //expect(instance).to.be();
    });
