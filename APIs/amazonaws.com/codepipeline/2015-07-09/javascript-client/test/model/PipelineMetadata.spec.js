...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PipelineMetadata();
  });
  ...
  describe('PipelineMetadata', function() {
    it('should create an instance of PipelineMetadata', function() {
      // uncomment below and update the code to test PipelineMetadata
      //var instance = new AwsCodePipeline.PipelineMetadata();
      //expect(instance).to.be.a(AwsCodePipeline.PipelineMetadata);
    });
    ...
    it('should have the property pollingDisabledAt (base name: "pollingDisabledAt")', function() {
      // uncomment below and update the code to test the property pollingDisabledAt
      //var instance = new AwsCodePipeline.PipelineMetadata();
      //expect(instance).to.be();
    });
