...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionRevision();
  });
  ...
  describe('ActionRevision', function() {
    it('should create an instance of ActionRevision', function() {
      // uncomment below and update the code to test ActionRevision
      //var instance = new AwsCodePipeline.ActionRevision();
      //expect(instance).to.be.a(AwsCodePipeline.ActionRevision);
    });
