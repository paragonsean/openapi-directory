...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ArtifactLocation();
  });
  ...
  describe('ArtifactLocation', function() {
    it('should create an instance of ArtifactLocation', function() {
      // uncomment below and update the code to test ArtifactLocation
      //var instance = new AwsCodePipeline.ArtifactLocation();
      //expect(instance).to.be.a(AwsCodePipeline.ArtifactLocation);
    });
