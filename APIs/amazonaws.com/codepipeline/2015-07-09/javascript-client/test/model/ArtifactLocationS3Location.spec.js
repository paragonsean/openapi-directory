...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ArtifactLocationS3Location();
  });
  ...
  describe('ArtifactLocationS3Location', function() {
    it('should create an instance of ArtifactLocationS3Location', function() {
      // uncomment below and update the code to test ArtifactLocationS3Location
      //var instance = new AwsCodePipeline.ArtifactLocationS3Location();
      //expect(instance).to.be.a(AwsCodePipeline.ArtifactLocationS3Location);
    });
