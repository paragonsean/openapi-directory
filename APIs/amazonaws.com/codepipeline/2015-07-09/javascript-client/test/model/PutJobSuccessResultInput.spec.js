...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutJobSuccessResultInput();
  });
  ...
  describe('PutJobSuccessResultInput', function() {
    it('should create an instance of PutJobSuccessResultInput', function() {
      // uncomment below and update the code to test PutJobSuccessResultInput
      //var instance = new AwsCodePipeline.PutJobSuccessResultInput();
      //expect(instance).to.be.a(AwsCodePipeline.PutJobSuccessResultInput);
    });
