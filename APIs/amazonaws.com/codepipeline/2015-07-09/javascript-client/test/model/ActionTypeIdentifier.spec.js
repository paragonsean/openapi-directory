...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeIdentifier();
  });
  ...
  describe('ActionTypeIdentifier', function() {
    it('should create an instance of ActionTypeIdentifier', function() {
      // uncomment below and update the code to test ActionTypeIdentifier
      //var instance = new AwsCodePipeline.ActionTypeIdentifier();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeIdentifier);
    });
