...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListWebhookItem();
  });
  ...
  describe('ListWebhookItem', function() {
    it('should create an instance of ListWebhookItem', function() {
      // uncomment below and update the code to test ListWebhookItem
      //var instance = new AwsCodePipeline.ListWebhookItem();
      //expect(instance).to.be.a(AwsCodePipeline.ListWebhookItem);
    });
