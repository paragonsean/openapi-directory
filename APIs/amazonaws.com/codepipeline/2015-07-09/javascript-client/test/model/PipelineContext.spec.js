...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PipelineContext();
  });
  ...
  describe('PipelineContext', function() {
    it('should create an instance of PipelineContext', function() {
      // uncomment below and update the code to test PipelineContext
      //var instance = new AwsCodePipeline.PipelineContext();
      //expect(instance).to.be.a(AwsCodePipeline.PipelineContext);
    });
