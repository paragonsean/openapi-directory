...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutApprovalResultInputResult();
  });
  ...
  describe('PutApprovalResultInputResult', function() {
    it('should create an instance of PutApprovalResultInputResult', function() {
      // uncomment below and update the code to test PutApprovalResultInputResult
      //var instance = new AwsCodePipeline.PutApprovalResultInputResult();
      //expect(instance).to.be.a(AwsCodePipeline.PutApprovalResultInputResult);
    });
