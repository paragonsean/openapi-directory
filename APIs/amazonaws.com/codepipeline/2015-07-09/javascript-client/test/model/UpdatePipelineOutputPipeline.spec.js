...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.UpdatePipelineOutputPipeline();
  });
  ...
  describe('UpdatePipelineOutputPipeline', function() {
    it('should create an instance of UpdatePipelineOutputPipeline', function() {
      // uncomment below and update the code to test UpdatePipelineOutputPipeline
      //var instance = new AwsCodePipeline.UpdatePipelineOutputPipeline();
      //expect(instance).to.be.a(AwsCodePipeline.UpdatePipelineOutputPipeline);
    });
    ...
    it('should have the property artifactStore (base name: "artifactStore")', function() {
      // uncomment below and update the code to test the property artifactStore
      //var instance = new AwsCodePipeline.UpdatePipelineOutputPipeline();
      //expect(instance).to.be();
    });

    it('should have the property artifactStores (base name: "artifactStores")', function() {
      // uncomment below and update the code to test the property artifactStores
      //var instance = new AwsCodePipeline.UpdatePipelineOutputPipeline();
      //expect(instance).to.be();
    });
