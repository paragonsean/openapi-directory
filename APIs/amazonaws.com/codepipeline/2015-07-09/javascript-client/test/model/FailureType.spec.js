...
(function(root, factory) {
  ...
  describe('FailureType', function() {
    it('should create an instance of FailureType', function() {
      // uncomment below and update the code to test FailureType
      //var instance = new AwsCodePipeline.FailureType();
      //expect(instance).to.be.a(AwsCodePipeline.FailureType);
    });
