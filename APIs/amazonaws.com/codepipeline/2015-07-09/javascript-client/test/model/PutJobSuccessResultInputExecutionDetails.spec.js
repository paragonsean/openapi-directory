...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutJobSuccessResultInputExecutionDetails();
  });
  ...
  describe('PutJobSuccessResultInputExecutionDetails', function() {
    it('should create an instance of PutJobSuccessResultInputExecutionDetails', function() {
      // uncomment below and update the code to test PutJobSuccessResultInputExecutionDetails
      //var instance = new AwsCodePipeline.PutJobSuccessResultInputExecutionDetails();
      //expect(instance).to.be.a(AwsCodePipeline.PutJobSuccessResultInputExecutionDetails);
    });
