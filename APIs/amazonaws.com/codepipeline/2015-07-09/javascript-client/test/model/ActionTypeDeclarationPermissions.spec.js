...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeDeclarationPermissions();
  });
  ...
  describe('ActionTypeDeclarationPermissions', function() {
    it('should create an instance of ActionTypeDeclarationPermissions', function() {
      // uncomment below and update the code to test ActionTypeDeclarationPermissions
      //var instance = new AwsCodePipeline.ActionTypeDeclarationPermissions();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeDeclarationPermissions);
    });
