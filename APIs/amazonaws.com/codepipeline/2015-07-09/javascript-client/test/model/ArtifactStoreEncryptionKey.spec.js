...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ArtifactStoreEncryptionKey();
  });
  ...
  describe('ArtifactStoreEncryptionKey', function() {
    it('should create an instance of ArtifactStoreEncryptionKey', function() {
      // uncomment below and update the code to test ArtifactStoreEncryptionKey
      //var instance = new AwsCodePipeline.ArtifactStoreEncryptionKey();
      //expect(instance).to.be.a(AwsCodePipeline.ArtifactStoreEncryptionKey);
    });
