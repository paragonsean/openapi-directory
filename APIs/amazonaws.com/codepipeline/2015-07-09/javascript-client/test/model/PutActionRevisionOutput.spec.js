...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutActionRevisionOutput();
  });
  ...
  describe('PutActionRevisionOutput', function() {
    it('should create an instance of PutActionRevisionOutput', function() {
      // uncomment below and update the code to test PutActionRevisionOutput
      //var instance = new AwsCodePipeline.PutActionRevisionOutput();
      //expect(instance).to.be.a(AwsCodePipeline.PutActionRevisionOutput);
    });

    it('should have the property newRevision (base name: "newRevision")', function() {
      // uncomment below and update the code to test the property newRevision
      //var instance = new AwsCodePipeline.PutActionRevisionOutput();
