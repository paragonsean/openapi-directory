...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetJobDetailsInput();
  });
  ...
  describe('GetJobDetailsInput', function() {
    it('should create an instance of GetJobDetailsInput', function() {
      // uncomment below and update the code to test GetJobDetailsInput
      //var instance = new AwsCodePipeline.GetJobDetailsInput();
      //expect(instance).to.be.a(AwsCodePipeline.GetJobDetailsInput);
    });
