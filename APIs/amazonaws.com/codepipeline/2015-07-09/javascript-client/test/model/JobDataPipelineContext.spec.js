...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.JobDataPipelineContext();
  });
  ...
  describe('JobDataPipelineContext', function() {
    it('should create an instance of JobDataPipelineContext', function() {
      // uncomment below and update the code to test JobDataPipelineContext
      //var instance = new AwsCodePipeline.JobDataPipelineContext();
      //expect(instance).to.be.a(AwsCodePipeline.JobDataPipelineContext);
    });
