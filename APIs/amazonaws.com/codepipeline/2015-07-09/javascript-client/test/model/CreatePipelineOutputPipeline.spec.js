...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.CreatePipelineOutputPipeline();
  });
  ...
  describe('CreatePipelineOutputPipeline', function() {
    it('should create an instance of CreatePipelineOutputPipeline', function() {
      // uncomment below and update the code to test CreatePipelineOutputPipeline
      //var instance = new AwsCodePipeline.CreatePipelineOutputPipeline();
      //expect(instance).to.be.a(AwsCodePipeline.CreatePipelineOutputPipeline);
    });
