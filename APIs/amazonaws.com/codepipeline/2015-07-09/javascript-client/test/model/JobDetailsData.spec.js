...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.JobDetailsData();
  });
  ...
  describe('JobDetailsData', function() {
    it('should create an instance of JobDetailsData', function() {
      // uncomment below and update the code to test JobDetailsData
      //var instance = new AwsCodePipeline.JobDetailsData();
      //expect(instance).to.be.a(AwsCodePipeline.JobDetailsData);
    });
