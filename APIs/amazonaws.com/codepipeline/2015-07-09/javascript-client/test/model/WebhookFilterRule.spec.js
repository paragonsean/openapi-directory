...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.WebhookFilterRule();
  });
  ...
  describe('WebhookFilterRule', function() {
    it('should create an instance of WebhookFilterRule', function() {
      // uncomment below and update the code to test WebhookFilterRule
      //var instance = new AwsCodePipeline.WebhookFilterRule();
      //expect(instance).to.be.a(AwsCodePipeline.WebhookFilterRule);
    });
    ...
    it('should have the property matchEquals (base name: "matchEquals")', function() {
      // uncomment below and update the code to test the property matchEquals
      //var instance = new AwsCodePipeline.WebhookFilterRule();
      //expect(instance).to.be();
    });
