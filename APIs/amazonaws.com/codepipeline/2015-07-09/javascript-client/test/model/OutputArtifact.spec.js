...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.OutputArtifact();
  });
  ...
  describe('OutputArtifact', function() {
    it('should create an instance of OutputArtifact', function() {
      // uncomment below and update the code to test OutputArtifact
      //var instance = new AwsCodePipeline.OutputArtifact();
      //expect(instance).to.be.a(AwsCodePipeline.OutputArtifact);
    });
