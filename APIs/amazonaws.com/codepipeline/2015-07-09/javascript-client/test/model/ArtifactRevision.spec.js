...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ArtifactRevision();
  });
  ...
  describe('ArtifactRevision', function() {
    it('should create an instance of ArtifactRevision', function() {
      // uncomment below and update the code to test ArtifactRevision
      //var instance = new AwsCodePipeline.ArtifactRevision();
      //expect(instance).to.be.a(AwsCodePipeline.ArtifactRevision);
    });
    ...
    it('should have the property revisionChangeIdentifier (base name: "revisionChangeIdentifier")', function() {
      // uncomment below and update the code to test the property revisionChangeIdentifier
      //var instance = new AwsCodePipeline.ArtifactRevision();
      //expect(instance).to.be();
    });
