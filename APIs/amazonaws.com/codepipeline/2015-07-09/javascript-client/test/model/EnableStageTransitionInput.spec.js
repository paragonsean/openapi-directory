...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.EnableStageTransitionInput();
  });
  ...
  describe('EnableStageTransitionInput', function() {
    it('should create an instance of EnableStageTransitionInput', function() {
      // uncomment below and update the code to test EnableStageTransitionInput
      //var instance = new AwsCodePipeline.EnableStageTransitionInput();
      //expect(instance).to.be.a(AwsCodePipeline.EnableStageTransitionInput);
    });
