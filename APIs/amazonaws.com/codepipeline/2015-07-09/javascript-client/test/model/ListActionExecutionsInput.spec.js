...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListActionExecutionsInput();
  });
  ...
  describe('ListActionExecutionsInput', function() {
    it('should create an instance of ListActionExecutionsInput', function() {
      // uncomment below and update the code to test ListActionExecutionsInput
      //var instance = new AwsCodePipeline.ListActionExecutionsInput();
      //expect(instance).to.be.a(AwsCodePipeline.ListActionExecutionsInput);
    });
