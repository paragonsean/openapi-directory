...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypePermissions();
  });
  ...
  describe('ActionTypePermissions', function() {
    it('should create an instance of ActionTypePermissions', function() {
      // uncomment below and update the code to test ActionTypePermissions
      //var instance = new AwsCodePipeline.ActionTypePermissions();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypePermissions);
    });
