...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutThirdPartyJobFailureResultInputFailureDetails();
  });
  ...
  describe('PutThirdPartyJobFailureResultInputFailureDetails', function() {
    it('should create an instance of PutThirdPartyJobFailureResultInputFailureDetails', function() {
      // uncomment below and update the code to test PutThirdPartyJobFailureResultInputFailureDetails
      //var instance = new AwsCodePipeline.PutThirdPartyJobFailureResultInputFailureDetails();
      //expect(instance).to.be.a(AwsCodePipeline.PutThirdPartyJobFailureResultInputFailureDetails);
    });
