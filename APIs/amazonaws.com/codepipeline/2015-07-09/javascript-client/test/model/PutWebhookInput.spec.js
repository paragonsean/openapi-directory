...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutWebhookInput();
  });
  ...
  describe('PutWebhookInput', function() {
    it('should create an instance of PutWebhookInput', function() {
      // uncomment below and update the code to test PutWebhookInput
      //var instance = new AwsCodePipeline.PutWebhookInput();
      //expect(instance).to.be.a(AwsCodePipeline.PutWebhookInput);
    });
