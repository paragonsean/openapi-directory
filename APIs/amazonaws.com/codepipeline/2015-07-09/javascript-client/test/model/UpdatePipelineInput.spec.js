...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.UpdatePipelineInput();
  });
  ...
  describe('UpdatePipelineInput', function() {
    it('should create an instance of UpdatePipelineInput', function() {
      // uncomment below and update the code to test UpdatePipelineInput
      //var instance = new AwsCodePipeline.UpdatePipelineInput();
      //expect(instance).to.be.a(AwsCodePipeline.UpdatePipelineInput);
    });
