...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutActionRevisionInput();
  });
  ...
  describe('PutActionRevisionInput', function() {
    it('should create an instance of PutActionRevisionInput', function() {
      // uncomment below and update the code to test PutActionRevisionInput
      //var instance = new AwsCodePipeline.PutActionRevisionInput();
      //expect(instance).to.be.a(AwsCodePipeline.PutActionRevisionInput);
    });
    ...
    it('should have the property actionRevision (base name: "actionRevision")', function() {
      // uncomment below and update the code to test the property actionRevision
      //var instance = new AwsCodePipeline.PutActionRevisionInput();
      //expect(instance).to.be();
    });
