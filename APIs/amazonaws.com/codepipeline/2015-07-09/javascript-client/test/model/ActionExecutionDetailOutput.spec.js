...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionExecutionDetailOutput();
  });
  ...
  describe('ActionExecutionDetailOutput', function() {
    it('should create an instance of ActionExecutionDetailOutput', function() {
      // uncomment below and update the code to test ActionExecutionDetailOutput
      //var instance = new AwsCodePipeline.ActionExecutionDetailOutput();
      //expect(instance).to.be.a(AwsCodePipeline.ActionExecutionDetailOutput);
    });
    ...
    it('should have the property executionResult (base name: "executionResult")', function() {
      // uncomment below and update the code to test the property executionResult
      //var instance = new AwsCodePipeline.ActionExecutionDetailOutput();
      //expect(instance).to.be();
    });
