...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.UntagResourceInput();
  });
  ...
  describe('UntagResourceInput', function() {
    it('should create an instance of UntagResourceInput', function() {
      ...
      //var instance = new AwsCodePipeline.UntagResourceInput();
      //expect(instance).to.be.a(AwsCodePipeline.UntagResourceInput);
    });
