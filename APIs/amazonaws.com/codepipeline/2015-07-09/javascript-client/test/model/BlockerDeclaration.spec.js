...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.BlockerDeclaration();
  });
  ...
  describe('BlockerDeclaration', function() {
    it('should create an instance of BlockerDeclaration', function() {
      // uncomment below and update the code to test BlockerDeclaration
      //var instance = new AwsCodePipeline.BlockerDeclaration();
      //expect(instance).to.be.a(AwsCodePipeline.BlockerDeclaration);
    });
