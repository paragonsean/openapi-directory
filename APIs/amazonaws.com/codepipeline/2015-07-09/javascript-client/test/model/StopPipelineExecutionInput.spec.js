...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.StopPipelineExecutionInput();
  });
  ...
  describe('StopPipelineExecutionInput', function() {
    it('should create an instance of StopPipelineExecutionInput', function() {
      // uncomment below and update the code to test StopPipelineExecutionInput
      //var instance = new AwsCodePipeline.StopPipelineExecutionInput();
      //expect(instance).to.be.a(AwsCodePipeline.StopPipelineExecutionInput);
    });
    ...
    it('should have the property pipelineExecutionId (base name: "pipelineExecutionId")', function() {
      // uncomment below and update the code to test the property pipelineExecutionId
      //var instance = new AwsCodePipeline.StopPipelineExecutionInput();
      //expect(instance).to.be();
    });

    it('should have the property abandon (base name: "abandon")', function() {
      // uncomment below and update the code to test the property abandon
      //var instance = new AwsCodePipeline.StopPipelineExecutionInput();
      //expect(instance).to.be();
    });
