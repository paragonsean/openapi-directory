...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetJobDetailsOutputJobDetails();
  });
  ...
  describe('GetJobDetailsOutputJobDetails', function() {
    it('should create an instance of GetJobDetailsOutputJobDetails', function() {
      // uncomment below and update the code to test GetJobDetailsOutputJobDetails
      //var instance = new AwsCodePipeline.GetJobDetailsOutputJobDetails();
      //expect(instance).to.be.a(AwsCodePipeline.GetJobDetailsOutputJobDetails);
    });
