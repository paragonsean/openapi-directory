...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.UpdateActionTypeInputActionType();
  });
  ...
  describe('UpdateActionTypeInputActionType', function() {
    it('should create an instance of UpdateActionTypeInputActionType', function() {
      // uncomment below and update the code to test UpdateActionTypeInputActionType
      //var instance = new AwsCodePipeline.UpdateActionTypeInputActionType();
      //expect(instance).to.be.a(AwsCodePipeline.UpdateActionTypeInputActionType);
    });
    ...
    it('should have the property inputArtifactDetails (base name: "inputArtifactDetails")', function() {
      // uncomment below and update the code to test the property inputArtifactDetails
      //var instance = new AwsCodePipeline.UpdateActionTypeInputActionType();
      //expect(instance).to.be();
    });

    it('should have the property outputArtifactDetails (base name: "outputArtifactDetails")', function() {
      // uncomment below and update the code to test the property outputArtifactDetails
      //var instance = new AwsCodePipeline.UpdateActionTypeInputActionType();
      //expect(instance).to.be();
    });
