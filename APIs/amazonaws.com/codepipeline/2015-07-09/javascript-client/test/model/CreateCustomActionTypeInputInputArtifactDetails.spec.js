...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.CreateCustomActionTypeInputInputArtifactDetails();
  });
  ...
  describe('CreateCustomActionTypeInputInputArtifactDetails', function() {
    it('should create an instance of CreateCustomActionTypeInputInputArtifactDetails', function() {
      // uncomment below and update the code to test CreateCustomActionTypeInputInputArtifactDetails
      //var instance = new AwsCodePipeline.CreateCustomActionTypeInputInputArtifactDetails();
      //expect(instance).to.be.a(AwsCodePipeline.CreateCustomActionTypeInputInputArtifactDetails);
    });
