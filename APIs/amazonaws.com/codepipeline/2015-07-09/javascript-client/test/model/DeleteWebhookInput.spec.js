...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.DeleteWebhookInput();
  });
  ...
  describe('DeleteWebhookInput', function() {
    it('should create an instance of DeleteWebhookInput', function() {
      // uncomment below and update the code to test DeleteWebhookInput
      //var instance = new AwsCodePipeline.DeleteWebhookInput();
      //expect(instance).to.be.a(AwsCodePipeline.DeleteWebhookInput);
    });
