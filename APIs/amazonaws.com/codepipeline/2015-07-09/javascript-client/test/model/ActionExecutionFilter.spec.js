...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionExecutionFilter();
  });
  ...
  describe('ActionExecutionFilter', function() {
    it('should create an instance of ActionExecutionFilter', function() {
      // uncomment below and update the code to test ActionExecutionFilter
      //var instance = new AwsCodePipeline.ActionExecutionFilter();
      //expect(instance).to.be.a(AwsCodePipeline.ActionExecutionFilter);
    });
