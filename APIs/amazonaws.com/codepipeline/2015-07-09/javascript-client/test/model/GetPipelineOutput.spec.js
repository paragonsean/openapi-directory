...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetPipelineOutput();
  });
  ...
  describe('GetPipelineOutput', function() {
    it('should create an instance of GetPipelineOutput', function() {
      // uncomment below and update the code to test GetPipelineOutput
      //var instance = new AwsCodePipeline.GetPipelineOutput();
      //expect(instance).to.be.a(AwsCodePipeline.GetPipelineOutput);
    });
