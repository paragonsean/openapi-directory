...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PollForThirdPartyJobsInput();
  });
  ...
  describe('PollForThirdPartyJobsInput', function() {
    it('should create an instance of PollForThirdPartyJobsInput', function() {
      // uncomment below and update the code to test PollForThirdPartyJobsInput
      //var instance = new AwsCodePipeline.PollForThirdPartyJobsInput();
      //expect(instance).to.be.a(AwsCodePipeline.PollForThirdPartyJobsInput);
    });
