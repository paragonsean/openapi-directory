...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ExecutionDetails();
  });
  ...
  describe('ExecutionDetails', function() {
    it('should create an instance of ExecutionDetails', function() {
      ...
      //var instance = new AwsCodePipeline.ExecutionDetails();
      //expect(instance).to.be.a(AwsCodePipeline.ExecutionDetails);
    });
