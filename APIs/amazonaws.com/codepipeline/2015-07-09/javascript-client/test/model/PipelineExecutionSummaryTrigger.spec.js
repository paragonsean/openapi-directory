...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PipelineExecutionSummaryTrigger();
  });
  ...
  describe('PipelineExecutionSummaryTrigger', function() {
    it('should create an instance of PipelineExecutionSummaryTrigger', function() {
      // uncomment below and update the code to test PipelineExecutionSummaryTrigger
      //var instance = new AwsCodePipeline.PipelineExecutionSummaryTrigger();
      //expect(instance).to.be.a(AwsCodePipeline.PipelineExecutionSummaryTrigger);
    });
    ...
    it('should have the property triggerDetail (base name: "triggerDetail")', function() {
      // uncomment below and update the code to test the property triggerDetail
      //var instance = new AwsCodePipeline.PipelineExecutionSummaryTrigger();
      //expect(instance).to.be();
    });
