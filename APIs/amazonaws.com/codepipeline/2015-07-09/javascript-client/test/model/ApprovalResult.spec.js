...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ApprovalResult();
  });
  ...
  describe('ApprovalResult', function() {
    it('should create an instance of ApprovalResult', function() {
      // uncomment below and update the code to test ApprovalResult
      //var instance = new AwsCodePipeline.ApprovalResult();
      //expect(instance).to.be.a(AwsCodePipeline.ApprovalResult);
    });
