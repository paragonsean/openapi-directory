...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListActionTypesOutput();
  });
  ...
  describe('ListActionTypesOutput', function() {
    it('should create an instance of ListActionTypesOutput', function() {
      // uncomment below and update the code to test ListActionTypesOutput
      //var instance = new AwsCodePipeline.ListActionTypesOutput();
      //expect(instance).to.be.a(AwsCodePipeline.ListActionTypesOutput);
    });

    it('should have the property actionTypes (base name: "actionTypes")', function() {
      // uncomment below and update the code to test the property actionTypes
      //var instance = new AwsCodePipeline.ListActionTypesOutput();
