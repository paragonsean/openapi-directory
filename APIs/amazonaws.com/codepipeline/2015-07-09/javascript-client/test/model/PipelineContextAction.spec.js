...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PipelineContextAction();
  });
  ...
  describe('PipelineContextAction', function() {
    it('should create an instance of PipelineContextAction', function() {
      // uncomment below and update the code to test PipelineContextAction
      //var instance = new AwsCodePipeline.PipelineContextAction();
      //expect(instance).to.be.a(AwsCodePipeline.PipelineContextAction);
    });
