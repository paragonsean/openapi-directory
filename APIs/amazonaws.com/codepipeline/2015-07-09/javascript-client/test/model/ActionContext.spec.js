...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionContext();
  });
  ...
  describe('ActionContext', function() {
    it('should create an instance of ActionContext', function() {
      // uncomment below and update the code to test ActionContext
      //var instance = new AwsCodePipeline.ActionContext();
      //expect(instance).to.be.a(AwsCodePipeline.ActionContext);
    });
    ...
    it('should have the property actionExecutionId (base name: "actionExecutionId")', function() {
      // uncomment below and update the code to test the property actionExecutionId
      //var instance = new AwsCodePipeline.ActionContext();
      //expect(instance).to.be();
    });
