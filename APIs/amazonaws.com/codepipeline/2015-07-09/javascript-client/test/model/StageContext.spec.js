...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.StageContext();
  });
  ...
  describe('StageContext', function() {
    it('should create an instance of StageContext', function() {
      // uncomment below and update the code to test StageContext
      //var instance = new AwsCodePipeline.StageContext();
      //expect(instance).to.be.a(AwsCodePipeline.StageContext);
    });
