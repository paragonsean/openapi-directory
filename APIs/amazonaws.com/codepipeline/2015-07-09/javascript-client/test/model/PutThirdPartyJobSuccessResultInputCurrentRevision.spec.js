...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutThirdPartyJobSuccessResultInputCurrentRevision();
  });
  ...
  describe('PutThirdPartyJobSuccessResultInputCurrentRevision', function() {
    it('should create an instance of PutThirdPartyJobSuccessResultInputCurrentRevision', function() {
      // uncomment below and update the code to test PutThirdPartyJobSuccessResultInputCurrentRevision
      //var instance = new AwsCodePipeline.PutThirdPartyJobSuccessResultInputCurrentRevision();
      //expect(instance).to.be.a(AwsCodePipeline.PutThirdPartyJobSuccessResultInputCurrentRevision);
    });
    ...
    it('should have the property changeIdentifier (base name: "changeIdentifier")', function() {
      // uncomment below and update the code to test the property changeIdentifier
      //var instance = new AwsCodePipeline.PutThirdPartyJobSuccessResultInputCurrentRevision();
      //expect(instance).to.be();
    });
