...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ArtifactStore();
  });
  ...
  describe('ArtifactStore', function() {
    it('should create an instance of ArtifactStore', function() {
      // uncomment below and update the code to test ArtifactStore
      //var instance = new AwsCodePipeline.ArtifactStore();
      //expect(instance).to.be.a(AwsCodePipeline.ArtifactStore);
    });
