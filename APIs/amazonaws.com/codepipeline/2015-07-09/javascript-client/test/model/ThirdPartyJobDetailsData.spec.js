...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ThirdPartyJobDetailsData();
  });
  ...
  describe('ThirdPartyJobDetailsData', function() {
    it('should create an instance of ThirdPartyJobDetailsData', function() {
      // uncomment below and update the code to test ThirdPartyJobDetailsData
      //var instance = new AwsCodePipeline.ThirdPartyJobDetailsData();
      //expect(instance).to.be.a(AwsCodePipeline.ThirdPartyJobDetailsData);
    });
    ...
    it('should have the property actionConfiguration (base name: "actionConfiguration")', function() {
      // uncomment below and update the code to test the property actionConfiguration
      //var instance = new AwsCodePipeline.ThirdPartyJobDetailsData();
      //expect(instance).to.be();
    });

    it('should have the property pipelineContext (base name: "pipelineContext")', function() {
      // uncomment below and update the code to test the property pipelineContext
      //var instance = new AwsCodePipeline.ThirdPartyJobDetailsData();
      //expect(instance).to.be();
    });
    ...
    it('should have the property artifactCredentials (base name: "artifactCredentials")', function() {
      // uncomment below and update the code to test the property artifactCredentials
      //var instance = new AwsCodePipeline.ThirdPartyJobDetailsData();
      //expect(instance).to.be();
    });
