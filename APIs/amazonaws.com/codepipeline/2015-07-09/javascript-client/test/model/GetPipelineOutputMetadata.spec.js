...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetPipelineOutputMetadata();
  });
  ...
  describe('GetPipelineOutputMetadata', function() {
    it('should create an instance of GetPipelineOutputMetadata', function() {
      // uncomment below and update the code to test GetPipelineOutputMetadata
      //var instance = new AwsCodePipeline.GetPipelineOutputMetadata();
      //expect(instance).to.be.a(AwsCodePipeline.GetPipelineOutputMetadata);
    });
