...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.RetryStageExecutionInput();
  });
  ...
  describe('RetryStageExecutionInput', function() {
    it('should create an instance of RetryStageExecutionInput', function() {
      // uncomment below and update the code to test RetryStageExecutionInput
      //var instance = new AwsCodePipeline.RetryStageExecutionInput();
      //expect(instance).to.be.a(AwsCodePipeline.RetryStageExecutionInput);
    });
    ...
    it('should have the property retryMode (base name: "retryMode")', function() {
      // uncomment below and update the code to test the property retryMode
      //var instance = new AwsCodePipeline.RetryStageExecutionInput();
      //expect(instance).to.be();
    });
