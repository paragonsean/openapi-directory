...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.CurrentRevision();
  });
  ...
  describe('CurrentRevision', function() {
    it('should create an instance of CurrentRevision', function() {
      // uncomment below and update the code to test CurrentRevision
      //var instance = new AwsCodePipeline.CurrentRevision();
      //expect(instance).to.be.a(AwsCodePipeline.CurrentRevision);
    });
