...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PipelineDeclarationArtifactStore();
  });
  ...
  describe('PipelineDeclarationArtifactStore', function() {
    it('should create an instance of PipelineDeclarationArtifactStore', function() {
      // uncomment below and update the code to test PipelineDeclarationArtifactStore
      //var instance = new AwsCodePipeline.PipelineDeclarationArtifactStore();
      //expect(instance).to.be.a(AwsCodePipeline.PipelineDeclarationArtifactStore);
    });
