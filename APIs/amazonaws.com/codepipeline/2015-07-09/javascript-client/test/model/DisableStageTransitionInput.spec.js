...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.DisableStageTransitionInput();
  });
  ...
  describe('DisableStageTransitionInput', function() {
    it('should create an instance of DisableStageTransitionInput', function() {
      // uncomment below and update the code to test DisableStageTransitionInput
      //var instance = new AwsCodePipeline.DisableStageTransitionInput();
      //expect(instance).to.be.a(AwsCodePipeline.DisableStageTransitionInput);
    });
