...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.LambdaExecutorConfiguration();
  });
  ...
  describe('LambdaExecutorConfiguration', function() {
    it('should create an instance of LambdaExecutorConfiguration', function() {
      // uncomment below and update the code to test LambdaExecutorConfiguration
      //var instance = new AwsCodePipeline.LambdaExecutorConfiguration();
      //expect(instance).to.be.a(AwsCodePipeline.LambdaExecutorConfiguration);
    });
