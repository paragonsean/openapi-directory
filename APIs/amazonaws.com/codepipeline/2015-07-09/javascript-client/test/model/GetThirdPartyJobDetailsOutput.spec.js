...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetThirdPartyJobDetailsOutput();
  });
  ...
  describe('GetThirdPartyJobDetailsOutput', function() {
    it('should create an instance of GetThirdPartyJobDetailsOutput', function() {
      // uncomment below and update the code to test GetThirdPartyJobDetailsOutput
      //var instance = new AwsCodePipeline.GetThirdPartyJobDetailsOutput();
      //expect(instance).to.be.a(AwsCodePipeline.GetThirdPartyJobDetailsOutput);
    });
