...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.CreateCustomActionTypeInputSettings();
  });
  ...
  describe('CreateCustomActionTypeInputSettings', function() {
    it('should create an instance of CreateCustomActionTypeInputSettings', function() {
      // uncomment below and update the code to test CreateCustomActionTypeInputSettings
      //var instance = new AwsCodePipeline.CreateCustomActionTypeInputSettings();
      //expect(instance).to.be.a(AwsCodePipeline.CreateCustomActionTypeInputSettings);
    });
