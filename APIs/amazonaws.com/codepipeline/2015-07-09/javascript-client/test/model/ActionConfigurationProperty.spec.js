...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionConfigurationProperty();
  });
  ...
  describe('ActionConfigurationProperty', function() {
    it('should create an instance of ActionConfigurationProperty', function() {
      // uncomment below and update the code to test ActionConfigurationProperty
      //var instance = new AwsCodePipeline.ActionConfigurationProperty();
      //expect(instance).to.be.a(AwsCodePipeline.ActionConfigurationProperty);
    });
