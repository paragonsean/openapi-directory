...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutJobFailureResultInput();
  });
  ...
  describe('PutJobFailureResultInput', function() {
    it('should create an instance of PutJobFailureResultInput', function() {
      // uncomment below and update the code to test PutJobFailureResultInput
      //var instance = new AwsCodePipeline.PutJobFailureResultInput();
      //expect(instance).to.be.a(AwsCodePipeline.PutJobFailureResultInput);
    });
