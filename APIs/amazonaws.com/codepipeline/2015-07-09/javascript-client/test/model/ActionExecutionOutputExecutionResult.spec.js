...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionExecutionOutputExecutionResult();
  });
  ...
  describe('ActionExecutionOutputExecutionResult', function() {
    it('should create an instance of ActionExecutionOutputExecutionResult', function() {
      // uncomment below and update the code to test ActionExecutionOutputExecutionResult
      //var instance = new AwsCodePipeline.ActionExecutionOutputExecutionResult();
      //expect(instance).to.be.a(AwsCodePipeline.ActionExecutionOutputExecutionResult);
    });

    it('should have the property externalExecutionId (base name: "externalExecutionId")', function() {
      // uncomment below and update the code to test the property externalExecutionId
      //var instance = new AwsCodePipeline.ActionExecutionOutputExecutionResult();
      //expect(instance).to.be();
    });

    it('should have the property externalExecutionSummary (base name: "externalExecutionSummary")', function() {
      // uncomment below and update the code to test the property externalExecutionSummary
      //var instance = new AwsCodePipeline.ActionExecutionOutputExecutionResult();
      //expect(instance).to.be();
    });

    it('should have the property externalExecutionUrl (base name: "externalExecutionUrl")', function() {
      // uncomment below and update the code to test the property externalExecutionUrl
      //var instance = new AwsCodePipeline.ActionExecutionOutputExecutionResult();
      //expect(instance).to.be();
    });
