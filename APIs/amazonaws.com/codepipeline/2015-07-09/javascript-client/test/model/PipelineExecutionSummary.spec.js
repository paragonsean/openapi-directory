...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PipelineExecutionSummary();
  });
  ...
  describe('PipelineExecutionSummary', function() {
    it('should create an instance of PipelineExecutionSummary', function() {
      // uncomment below and update the code to test PipelineExecutionSummary
      //var instance = new AwsCodePipeline.PipelineExecutionSummary();
      //expect(instance).to.be.a(AwsCodePipeline.PipelineExecutionSummary);
    });
    ...
    it('should have the property sourceRevisions (base name: "sourceRevisions")', function() {
      // uncomment below and update the code to test the property sourceRevisions
      //var instance = new AwsCodePipeline.PipelineExecutionSummary();
      //expect(instance).to.be();
    });
    ...
    it('should have the property stopTrigger (base name: "stopTrigger")', function() {
      // uncomment below and update the code to test the property stopTrigger
      //var instance = new AwsCodePipeline.PipelineExecutionSummary();
      //expect(instance).to.be();
    });
