...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionStateLatestExecution();
  });
  ...
  describe('ActionStateLatestExecution', function() {
    it('should create an instance of ActionStateLatestExecution', function() {
      // uncomment below and update the code to test ActionStateLatestExecution
      //var instance = new AwsCodePipeline.ActionStateLatestExecution();
      //expect(instance).to.be.a(AwsCodePipeline.ActionStateLatestExecution);
    });
