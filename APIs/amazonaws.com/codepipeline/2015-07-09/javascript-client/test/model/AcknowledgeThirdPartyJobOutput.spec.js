...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.AcknowledgeThirdPartyJobOutput();
  });
  ...
  describe('AcknowledgeThirdPartyJobOutput', function() {
    it('should create an instance of AcknowledgeThirdPartyJobOutput', function() {
      // uncomment below and update the code to test AcknowledgeThirdPartyJobOutput
      //var instance = new AwsCodePipeline.AcknowledgeThirdPartyJobOutput();
      //expect(instance).to.be.a(AwsCodePipeline.AcknowledgeThirdPartyJobOutput);
    });
