...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutJobSuccessResultInputCurrentRevision();
  });
  ...
  describe('PutJobSuccessResultInputCurrentRevision', function() {
    it('should create an instance of PutJobSuccessResultInputCurrentRevision', function() {
      // uncomment below and update the code to test PutJobSuccessResultInputCurrentRevision
      //var instance = new AwsCodePipeline.PutJobSuccessResultInputCurrentRevision();
      //expect(instance).to.be.a(AwsCodePipeline.PutJobSuccessResultInputCurrentRevision);
    });
