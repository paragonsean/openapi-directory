...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PollForJobsOutput();
  });
  ...
  describe('PollForJobsOutput', function() {
    it('should create an instance of PollForJobsOutput', function() {
      // uncomment below and update the code to test PollForJobsOutput
      //var instance = new AwsCodePipeline.PollForJobsOutput();
      //expect(instance).to.be.a(AwsCodePipeline.PollForJobsOutput);
    });
