...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ExecutorConfigurationLambdaExecutorConfiguration();
  });
  ...
  describe('ExecutorConfigurationLambdaExecutorConfiguration', function() {
    it('should create an instance of ExecutorConfigurationLambdaExecutorConfiguration', function() {
      // uncomment below and update the code to test ExecutorConfigurationLambdaExecutorConfiguration
      //var instance = new AwsCodePipeline.ExecutorConfigurationLambdaExecutorConfiguration();
      //expect(instance).to.be.a(AwsCodePipeline.ExecutorConfigurationLambdaExecutorConfiguration);
    });
