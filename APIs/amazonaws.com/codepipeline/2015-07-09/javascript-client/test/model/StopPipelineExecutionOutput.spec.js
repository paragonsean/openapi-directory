...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.StopPipelineExecutionOutput();
  });
  ...
  describe('StopPipelineExecutionOutput', function() {
    it('should create an instance of StopPipelineExecutionOutput', function() {
      // uncomment below and update the code to test StopPipelineExecutionOutput
      //var instance = new AwsCodePipeline.StopPipelineExecutionOutput();
      //expect(instance).to.be.a(AwsCodePipeline.StopPipelineExecutionOutput);
    });
