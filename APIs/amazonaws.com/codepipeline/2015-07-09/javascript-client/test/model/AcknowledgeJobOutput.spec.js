...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.AcknowledgeJobOutput();
  });
  ...
  describe('AcknowledgeJobOutput', function() {
    it('should create an instance of AcknowledgeJobOutput', function() {
      // uncomment below and update the code to test AcknowledgeJobOutput
      //var instance = new AwsCodePipeline.AcknowledgeJobOutput();
      //expect(instance).to.be.a(AwsCodePipeline.AcknowledgeJobOutput);
    });
