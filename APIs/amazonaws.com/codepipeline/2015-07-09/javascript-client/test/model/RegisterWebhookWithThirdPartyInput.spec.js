...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.RegisterWebhookWithThirdPartyInput();
  });
  ...
  describe('RegisterWebhookWithThirdPartyInput', function() {
    it('should create an instance of RegisterWebhookWithThirdPartyInput', function() {
      // uncomment below and update the code to test RegisterWebhookWithThirdPartyInput
      //var instance = new AwsCodePipeline.RegisterWebhookWithThirdPartyInput();
      //expect(instance).to.be.a(AwsCodePipeline.RegisterWebhookWithThirdPartyInput);
    });
