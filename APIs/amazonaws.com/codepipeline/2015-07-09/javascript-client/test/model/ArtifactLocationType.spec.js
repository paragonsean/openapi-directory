...
(function(root, factory) {
  ...
  describe('ArtifactLocationType', function() {
    it('should create an instance of ArtifactLocationType', function() {
      // uncomment below and update the code to test ArtifactLocationType
      //var instance = new AwsCodePipeline.ArtifactLocationType();
      //expect(instance).to.be.a(AwsCodePipeline.ArtifactLocationType);
    });
