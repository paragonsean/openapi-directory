...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.JobDataArtifactCredentials();
  });
  ...
  describe('JobDataArtifactCredentials', function() {
    it('should create an instance of JobDataArtifactCredentials', function() {
      // uncomment below and update the code to test JobDataArtifactCredentials
      //var instance = new AwsCodePipeline.JobDataArtifactCredentials();
      //expect(instance).to.be.a(AwsCodePipeline.JobDataArtifactCredentials);
    });
