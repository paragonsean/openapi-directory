...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.JobWorkerExecutorConfiguration();
  });
  ...
  describe('JobWorkerExecutorConfiguration', function() {
    it('should create an instance of JobWorkerExecutorConfiguration', function() {
      // uncomment below and update the code to test JobWorkerExecutorConfiguration
      //var instance = new AwsCodePipeline.JobWorkerExecutorConfiguration();
      //expect(instance).to.be.a(AwsCodePipeline.JobWorkerExecutorConfiguration);
    });

    it('should have the property pollingAccounts (base name: "pollingAccounts")', function() {
      // uncomment below and update the code to test the property pollingAccounts
      //var instance = new AwsCodePipeline.JobWorkerExecutorConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property pollingServicePrincipals (base name: "pollingServicePrincipals")', function() {
      // uncomment below and update the code to test the property pollingServicePrincipals
      //var instance = new AwsCodePipeline.JobWorkerExecutorConfiguration();
      //expect(instance).to.be();
    });
