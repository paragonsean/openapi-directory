...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.UpdatePipelineOutput();
  });
  ...
  describe('UpdatePipelineOutput', function() {
    it('should create an instance of UpdatePipelineOutput', function() {
      // uncomment below and update the code to test UpdatePipelineOutput
      //var instance = new AwsCodePipeline.UpdatePipelineOutput();
      //expect(instance).to.be.a(AwsCodePipeline.UpdatePipelineOutput);
    });
