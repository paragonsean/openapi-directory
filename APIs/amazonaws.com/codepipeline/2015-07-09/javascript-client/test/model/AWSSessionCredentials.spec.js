...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.AWSSessionCredentials();
  });
  ...
  describe('AWSSessionCredentials', function() {
    it('should create an instance of AWSSessionCredentials', function() {
      // uncomment below and update the code to test AWSSessionCredentials
      //var instance = new AwsCodePipeline.AWSSessionCredentials();
      //expect(instance).to.be.a(AwsCodePipeline.AWSSessionCredentials);
    });
