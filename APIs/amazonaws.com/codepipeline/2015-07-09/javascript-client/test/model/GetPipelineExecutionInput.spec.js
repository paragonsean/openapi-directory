...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetPipelineExecutionInput();
  });
  ...
  describe('GetPipelineExecutionInput', function() {
    it('should create an instance of GetPipelineExecutionInput', function() {
      // uncomment below and update the code to test GetPipelineExecutionInput
      //var instance = new AwsCodePipeline.GetPipelineExecutionInput();
      //expect(instance).to.be.a(AwsCodePipeline.GetPipelineExecutionInput);
    });
