...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.DeleteCustomActionTypeInput();
  });
  ...
  describe('DeleteCustomActionTypeInput', function() {
    it('should create an instance of DeleteCustomActionTypeInput', function() {
      // uncomment below and update the code to test DeleteCustomActionTypeInput
      //var instance = new AwsCodePipeline.DeleteCustomActionTypeInput();
      //expect(instance).to.be.a(AwsCodePipeline.DeleteCustomActionTypeInput);
    });
