...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutWebhookOutput();
  });
  ...
  describe('PutWebhookOutput', function() {
    it('should create an instance of PutWebhookOutput', function() {
      // uncomment below and update the code to test PutWebhookOutput
      //var instance = new AwsCodePipeline.PutWebhookOutput();
      //expect(instance).to.be.a(AwsCodePipeline.PutWebhookOutput);
    });
