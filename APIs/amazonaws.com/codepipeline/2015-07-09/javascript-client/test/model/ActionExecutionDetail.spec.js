...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionExecutionDetail();
  });
  ...
  describe('ActionExecutionDetail', function() {
    it('should create an instance of ActionExecutionDetail', function() {
      // uncomment below and update the code to test ActionExecutionDetail
      //var instance = new AwsCodePipeline.ActionExecutionDetail();
      //expect(instance).to.be.a(AwsCodePipeline.ActionExecutionDetail);
    });
