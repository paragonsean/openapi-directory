...
(function(root, factory) {
  ...
  describe('ActionExecutionStatus', function() {
    it('should create an instance of ActionExecutionStatus', function() {
      // uncomment below and update the code to test ActionExecutionStatus
      //var instance = new AwsCodePipeline.ActionExecutionStatus();
      //expect(instance).to.be.a(AwsCodePipeline.ActionExecutionStatus);
    });
