...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.S3ArtifactLocation();
  });
  ...
  describe('S3ArtifactLocation', function() {
    it('should create an instance of S3ArtifactLocation', function() {
      // uncomment below and update the code to test S3ArtifactLocation
      //var instance = new AwsCodePipeline.S3ArtifactLocation();
      //expect(instance).to.be.a(AwsCodePipeline.S3ArtifactLocation);
    });
