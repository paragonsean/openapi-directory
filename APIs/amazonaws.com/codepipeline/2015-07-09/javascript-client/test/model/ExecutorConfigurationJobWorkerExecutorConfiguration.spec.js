...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ExecutorConfigurationJobWorkerExecutorConfiguration();
  });
  ...
  describe('ExecutorConfigurationJobWorkerExecutorConfiguration', function() {
    it('should create an instance of ExecutorConfigurationJobWorkerExecutorConfiguration', function() {
      // uncomment below and update the code to test ExecutorConfigurationJobWorkerExecutorConfiguration
      //var instance = new AwsCodePipeline.ExecutorConfigurationJobWorkerExecutorConfiguration();
      //expect(instance).to.be.a(AwsCodePipeline.ExecutorConfigurationJobWorkerExecutorConfiguration);
    });
