...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutWebhookInputWebhook();
  });
  ...
  describe('PutWebhookInputWebhook', function() {
    it('should create an instance of PutWebhookInputWebhook', function() {
      // uncomment below and update the code to test PutWebhookInputWebhook
      //var instance = new AwsCodePipeline.PutWebhookInputWebhook();
      //expect(instance).to.be.a(AwsCodePipeline.PutWebhookInputWebhook);
    });
