...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeDeclarationExecutor();
  });
  ...
  describe('ActionTypeDeclarationExecutor', function() {
    it('should create an instance of ActionTypeDeclarationExecutor', function() {
      // uncomment below and update the code to test ActionTypeDeclarationExecutor
      //var instance = new AwsCodePipeline.ActionTypeDeclarationExecutor();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeDeclarationExecutor);
    });
    ...
    it('should have the property policyStatementsTemplate (base name: "policyStatementsTemplate")', function() {
      // uncomment below and update the code to test the property policyStatementsTemplate
      //var instance = new AwsCodePipeline.ActionTypeDeclarationExecutor();
      //expect(instance).to.be();
    });

    it('should have the property jobTimeout (base name: "jobTimeout")', function() {
      // uncomment below and update the code to test the property jobTimeout
      //var instance = new AwsCodePipeline.ActionTypeDeclarationExecutor();
      //expect(instance).to.be();
    });
