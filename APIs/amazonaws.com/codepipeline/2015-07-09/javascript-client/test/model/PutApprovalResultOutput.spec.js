...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutApprovalResultOutput();
  });
  ...
  describe('PutApprovalResultOutput', function() {
    it('should create an instance of PutApprovalResultOutput', function() {
      // uncomment below and update the code to test PutApprovalResultOutput
      //var instance = new AwsCodePipeline.PutApprovalResultOutput();
      //expect(instance).to.be.a(AwsCodePipeline.PutApprovalResultOutput);
    });
