...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.WebhookDefinition();
  });
  ...
  describe('WebhookDefinition', function() {
    it('should create an instance of WebhookDefinition', function() {
      ...
      //var instance = new AwsCodePipeline.WebhookDefinition();
      //expect(instance).to.be.a(AwsCodePipeline.WebhookDefinition);
    });
