...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.AcknowledgeThirdPartyJobInput();
  });
  ...
  describe('AcknowledgeThirdPartyJobInput', function() {
    it('should create an instance of AcknowledgeThirdPartyJobInput', function() {
      // uncomment below and update the code to test AcknowledgeThirdPartyJobInput
      //var instance = new AwsCodePipeline.AcknowledgeThirdPartyJobInput();
      //expect(instance).to.be.a(AwsCodePipeline.AcknowledgeThirdPartyJobInput);
    });
