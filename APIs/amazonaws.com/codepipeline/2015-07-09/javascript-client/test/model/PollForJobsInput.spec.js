...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PollForJobsInput();
  });
  ...
  describe('PollForJobsInput', function() {
    it('should create an instance of PollForJobsInput', function() {
      // uncomment below and update the code to test PollForJobsInput
      //var instance = new AwsCodePipeline.PollForJobsInput();
      //expect(instance).to.be.a(AwsCodePipeline.PollForJobsInput);
    });
    ...
    it('should have the property maxBatchSize (base name: "maxBatchSize")', function() {
      // uncomment below and update the code to test the property maxBatchSize
      //var instance = new AwsCodePipeline.PollForJobsInput();
      //expect(instance).to.be();
    });

    it('should have the property queryParam (base name: "queryParam")', function() {
      // uncomment below and update the code to test the property queryParam
      //var instance = new AwsCodePipeline.PollForJobsInput();
      //expect(instance).to.be();
    });
