...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ArtifactDetail();
  });
  ...
  describe('ArtifactDetail', function() {
    it('should create an instance of ArtifactDetail', function() {
      // uncomment below and update the code to test ArtifactDetail
      //var instance = new AwsCodePipeline.ArtifactDetail();
      //expect(instance).to.be.a(AwsCodePipeline.ArtifactDetail);
    });
