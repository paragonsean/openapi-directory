...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.AcknowledgeJobInput();
  });
  ...
  describe('AcknowledgeJobInput', function() {
    it('should create an instance of AcknowledgeJobInput', function() {
      // uncomment below and update the code to test AcknowledgeJobInput
      //var instance = new AwsCodePipeline.AcknowledgeJobInput();
      //expect(instance).to.be.a(AwsCodePipeline.AcknowledgeJobInput);
    });
