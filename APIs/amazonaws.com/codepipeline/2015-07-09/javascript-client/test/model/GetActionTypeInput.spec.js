...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetActionTypeInput();
  });
  ...
  describe('GetActionTypeInput', function() {
    it('should create an instance of GetActionTypeInput', function() {
      // uncomment below and update the code to test GetActionTypeInput
      //var instance = new AwsCodePipeline.GetActionTypeInput();
      //expect(instance).to.be.a(AwsCodePipeline.GetActionTypeInput);
    });
