...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.StageDeclaration();
  });
  ...
  describe('StageDeclaration', function() {
    it('should create an instance of StageDeclaration', function() {
      // uncomment below and update the code to test StageDeclaration
      //var instance = new AwsCodePipeline.StageDeclaration();
      //expect(instance).to.be.a(AwsCodePipeline.StageDeclaration);
    });
    ...
    it('should have the property blockers (base name: "blockers")', function() {
      // uncomment below and update the code to test the property blockers
      //var instance = new AwsCodePipeline.StageDeclaration();
      //expect(instance).to.be();
    });
