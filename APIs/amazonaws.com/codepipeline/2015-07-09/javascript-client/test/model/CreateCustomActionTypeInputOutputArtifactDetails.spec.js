...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.CreateCustomActionTypeInputOutputArtifactDetails();
  });
  ...
  describe('CreateCustomActionTypeInputOutputArtifactDetails', function() {
    it('should create an instance of CreateCustomActionTypeInputOutputArtifactDetails', function() {
      // uncomment below and update the code to test CreateCustomActionTypeInputOutputArtifactDetails
      //var instance = new AwsCodePipeline.CreateCustomActionTypeInputOutputArtifactDetails();
      //expect(instance).to.be.a(AwsCodePipeline.CreateCustomActionTypeInputOutputArtifactDetails);
    });

    it('should have the property minimumCount (base name: "minimumCount")', function() {
      // uncomment below and update the code to test the property minimumCount
      //var instance = new AwsCodePipeline.CreateCustomActionTypeInputOutputArtifactDetails();
      //expect(instance).to.be();
    });

    it('should have the property maximumCount (base name: "maximumCount")', function() {
      // uncomment below and update the code to test the property maximumCount
      //var instance = new AwsCodePipeline.CreateCustomActionTypeInputOutputArtifactDetails();
      //expect(instance).to.be();
    });
