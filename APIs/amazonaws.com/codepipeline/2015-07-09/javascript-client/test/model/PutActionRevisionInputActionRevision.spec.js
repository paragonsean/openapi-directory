...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutActionRevisionInputActionRevision();
  });
  ...
  describe('PutActionRevisionInputActionRevision', function() {
    it('should create an instance of PutActionRevisionInputActionRevision', function() {
      // uncomment below and update the code to test PutActionRevisionInputActionRevision
      //var instance = new AwsCodePipeline.PutActionRevisionInputActionRevision();
      //expect(instance).to.be.a(AwsCodePipeline.PutActionRevisionInputActionRevision);
    });
    ...
    it('should have the property revisionChangeId (base name: "revisionChangeId")', function() {
      // uncomment below and update the code to test the property revisionChangeId
      //var instance = new AwsCodePipeline.PutActionRevisionInputActionRevision();
      //expect(instance).to.be();
    });
