...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeExecutor();
  });
  ...
  describe('ActionTypeExecutor', function() {
    it('should create an instance of ActionTypeExecutor', function() {
      // uncomment below and update the code to test ActionTypeExecutor
      //var instance = new AwsCodePipeline.ActionTypeExecutor();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeExecutor);
    });
