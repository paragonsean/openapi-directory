...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.DeletePipelineInput();
  });
  ...
  describe('DeletePipelineInput', function() {
    it('should create an instance of DeletePipelineInput', function() {
      // uncomment below and update the code to test DeletePipelineInput
      //var instance = new AwsCodePipeline.DeletePipelineInput();
      //expect(instance).to.be.a(AwsCodePipeline.DeletePipelineInput);
    });
