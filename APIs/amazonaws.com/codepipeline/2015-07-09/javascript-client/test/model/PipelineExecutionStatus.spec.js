...
(function(root, factory) {
  ...
  describe('PipelineExecutionStatus', function() {
    it('should create an instance of PipelineExecutionStatus', function() {
      // uncomment below and update the code to test PipelineExecutionStatus
      //var instance = new AwsCodePipeline.PipelineExecutionStatus();
      //expect(instance).to.be.a(AwsCodePipeline.PipelineExecutionStatus);
    });
