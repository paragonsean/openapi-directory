...
(function(root, factory) {
  ...
  describe('StageExecutionStatus', function() {
    it('should create an instance of StageExecutionStatus', function() {
      // uncomment below and update the code to test StageExecutionStatus
      //var instance = new AwsCodePipeline.StageExecutionStatus();
      //expect(instance).to.be.a(AwsCodePipeline.StageExecutionStatus);
    });
