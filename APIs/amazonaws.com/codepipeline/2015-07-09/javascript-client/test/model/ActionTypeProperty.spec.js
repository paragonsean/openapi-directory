...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeProperty();
  });
  ...
  describe('ActionTypeProperty', function() {
    it('should create an instance of ActionTypeProperty', function() {
      // uncomment below and update the code to test ActionTypeProperty
      //var instance = new AwsCodePipeline.ActionTypeProperty();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeProperty);
    });
