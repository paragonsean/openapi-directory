...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.DeregisterWebhookWithThirdPartyInput();
  });
  ...
  describe('DeregisterWebhookWithThirdPartyInput', function() {
    it('should create an instance of DeregisterWebhookWithThirdPartyInput', function() {
      // uncomment below and update the code to test DeregisterWebhookWithThirdPartyInput
      //var instance = new AwsCodePipeline.DeregisterWebhookWithThirdPartyInput();
      //expect(instance).to.be.a(AwsCodePipeline.DeregisterWebhookWithThirdPartyInput);
    });
