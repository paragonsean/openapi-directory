...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.InputArtifact();
  });
  ...
  describe('InputArtifact', function() {
    it('should create an instance of InputArtifact', function() {
      // uncomment below and update the code to test InputArtifact
      //var instance = new AwsCodePipeline.InputArtifact();
      //expect(instance).to.be.a(AwsCodePipeline.InputArtifact);
    });
