...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ArtifactDetailS3location();
  });
  ...
  describe('ArtifactDetailS3location', function() {
    it('should create an instance of ArtifactDetailS3location', function() {
      // uncomment below and update the code to test ArtifactDetailS3location
      //var instance = new AwsCodePipeline.ArtifactDetailS3location();
      //expect(instance).to.be.a(AwsCodePipeline.ArtifactDetailS3location);
    });
