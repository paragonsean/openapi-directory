...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.TagResourceInput();
  });
  ...
  describe('TagResourceInput', function() {
    it('should create an instance of TagResourceInput', function() {
      ...
      //var instance = new AwsCodePipeline.TagResourceInput();
      //expect(instance).to.be.a(AwsCodePipeline.TagResourceInput);
    });
