...
(function(root, factory) {
  ...
  describe('ExecutorType', function() {
    it('should create an instance of ExecutorType', function() {
      // uncomment below and update the code to test ExecutorType
      //var instance = new AwsCodePipeline.ExecutorType();
      //expect(instance).to.be.a(AwsCodePipeline.ExecutorType);
    });
