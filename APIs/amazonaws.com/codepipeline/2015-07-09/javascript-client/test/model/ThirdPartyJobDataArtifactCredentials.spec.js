...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ThirdPartyJobDataArtifactCredentials();
  });
  ...
  describe('ThirdPartyJobDataArtifactCredentials', function() {
    it('should create an instance of ThirdPartyJobDataArtifactCredentials', function() {
      // uncomment below and update the code to test ThirdPartyJobDataArtifactCredentials
      //var instance = new AwsCodePipeline.ThirdPartyJobDataArtifactCredentials();
      //expect(instance).to.be.a(AwsCodePipeline.ThirdPartyJobDataArtifactCredentials);
    });
