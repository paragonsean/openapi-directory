...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PollForThirdPartyJobsOutput();
  });
  ...
  describe('PollForThirdPartyJobsOutput', function() {
    it('should create an instance of PollForThirdPartyJobsOutput', function() {
      // uncomment below and update the code to test PollForThirdPartyJobsOutput
      //var instance = new AwsCodePipeline.PollForThirdPartyJobsOutput();
      //expect(instance).to.be.a(AwsCodePipeline.PollForThirdPartyJobsOutput);
    });
