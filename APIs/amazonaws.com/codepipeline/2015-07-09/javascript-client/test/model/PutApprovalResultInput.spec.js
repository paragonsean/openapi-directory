...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutApprovalResultInput();
  });
  ...
  describe('PutApprovalResultInput', function() {
    it('should create an instance of PutApprovalResultInput', function() {
      // uncomment below and update the code to test PutApprovalResultInput
      //var instance = new AwsCodePipeline.PutApprovalResultInput();
      //expect(instance).to.be.a(AwsCodePipeline.PutApprovalResultInput);
    });
