...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.JobDataEncryptionKey();
  });
  ...
  describe('JobDataEncryptionKey', function() {
    it('should create an instance of JobDataEncryptionKey', function() {
      // uncomment below and update the code to test JobDataEncryptionKey
      //var instance = new AwsCodePipeline.JobDataEncryptionKey();
      //expect(instance).to.be.a(AwsCodePipeline.JobDataEncryptionKey);
    });
