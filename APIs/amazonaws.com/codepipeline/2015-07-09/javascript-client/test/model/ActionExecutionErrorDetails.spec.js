...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionExecutionErrorDetails();
  });
  ...
  describe('ActionExecutionErrorDetails', function() {
    it('should create an instance of ActionExecutionErrorDetails', function() {
      // uncomment below and update the code to test ActionExecutionErrorDetails
      //var instance = new AwsCodePipeline.ActionExecutionErrorDetails();
      //expect(instance).to.be.a(AwsCodePipeline.ActionExecutionErrorDetails);
    });
