...
(function(root, factory) {
  ...
  describe('StageTransitionType', function() {
    it('should create an instance of StageTransitionType', function() {
      // uncomment below and update the code to test StageTransitionType
      //var instance = new AwsCodePipeline.StageTransitionType();
      //expect(instance).to.be.a(AwsCodePipeline.StageTransitionType);
    });
