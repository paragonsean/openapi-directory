...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetPipelineStateOutput();
  });
  ...
  describe('GetPipelineStateOutput', function() {
    it('should create an instance of GetPipelineStateOutput', function() {
      // uncomment below and update the code to test GetPipelineStateOutput
      //var instance = new AwsCodePipeline.GetPipelineStateOutput();
      //expect(instance).to.be.a(AwsCodePipeline.GetPipelineStateOutput);
    });
