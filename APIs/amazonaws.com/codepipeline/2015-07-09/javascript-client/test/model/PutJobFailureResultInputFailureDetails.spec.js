...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutJobFailureResultInputFailureDetails();
  });
  ...
  describe('PutJobFailureResultInputFailureDetails', function() {
    it('should create an instance of PutJobFailureResultInputFailureDetails', function() {
      // uncomment below and update the code to test PutJobFailureResultInputFailureDetails
      //var instance = new AwsCodePipeline.PutJobFailureResultInputFailureDetails();
      //expect(instance).to.be.a(AwsCodePipeline.PutJobFailureResultInputFailureDetails);
    });
