...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.SourceRevision();
  });
  ...
  describe('SourceRevision', function() {
    it('should create an instance of SourceRevision', function() {
      // uncomment below and update the code to test SourceRevision
      //var instance = new AwsCodePipeline.SourceRevision();
      //expect(instance).to.be.a(AwsCodePipeline.SourceRevision);
    });
    ...
    it('should have the property revisionSummary (base name: "revisionSummary")', function() {
      // uncomment below and update the code to test the property revisionSummary
      //var instance = new AwsCodePipeline.SourceRevision();
      //expect(instance).to.be();
    });
