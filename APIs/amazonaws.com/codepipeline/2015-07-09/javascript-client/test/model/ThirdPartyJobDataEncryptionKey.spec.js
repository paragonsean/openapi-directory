...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ThirdPartyJobDataEncryptionKey();
  });
  ...
  describe('ThirdPartyJobDataEncryptionKey', function() {
    it('should create an instance of ThirdPartyJobDataEncryptionKey', function() {
      // uncomment below and update the code to test ThirdPartyJobDataEncryptionKey
      //var instance = new AwsCodePipeline.ThirdPartyJobDataEncryptionKey();
      //expect(instance).to.be.a(AwsCodePipeline.ThirdPartyJobDataEncryptionKey);
    });
