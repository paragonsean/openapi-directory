...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.UpdateActionTypeInput();
  });
  ...
  describe('UpdateActionTypeInput', function() {
    it('should create an instance of UpdateActionTypeInput', function() {
      // uncomment below and update the code to test UpdateActionTypeInput
      //var instance = new AwsCodePipeline.UpdateActionTypeInput();
      //expect(instance).to.be.a(AwsCodePipeline.UpdateActionTypeInput);
    });
