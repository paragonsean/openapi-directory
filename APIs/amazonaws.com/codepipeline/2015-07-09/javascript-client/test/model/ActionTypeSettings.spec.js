...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeSettings();
  });
  ...
  describe('ActionTypeSettings', function() {
    it('should create an instance of ActionTypeSettings', function() {
      // uncomment below and update the code to test ActionTypeSettings
      //var instance = new AwsCodePipeline.ActionTypeSettings();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeSettings);
    });

    it('should have the property thirdPartyConfigurationUrl (base name: "thirdPartyConfigurationUrl")', function() {
      // uncomment below and update the code to test the property thirdPartyConfigurationUrl
      //var instance = new AwsCodePipeline.ActionTypeSettings();
