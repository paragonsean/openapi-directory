...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.CreatePipelineOutput();
  });
  ...
  describe('CreatePipelineOutput', function() {
    it('should create an instance of CreatePipelineOutput', function() {
      // uncomment below and update the code to test CreatePipelineOutput
      //var instance = new AwsCodePipeline.CreatePipelineOutput();
      //expect(instance).to.be.a(AwsCodePipeline.CreatePipelineOutput);
    });
