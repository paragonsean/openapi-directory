...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.RetryStageExecutionOutput();
  });
  ...
  describe('RetryStageExecutionOutput', function() {
    it('should create an instance of RetryStageExecutionOutput', function() {
      // uncomment below and update the code to test RetryStageExecutionOutput
      //var instance = new AwsCodePipeline.RetryStageExecutionOutput();
      //expect(instance).to.be.a(AwsCodePipeline.RetryStageExecutionOutput);
    });
