...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.CreateCustomActionTypeOutput();
  });
  ...
  describe('CreateCustomActionTypeOutput', function() {
    it('should create an instance of CreateCustomActionTypeOutput', function() {
      // uncomment below and update the code to test CreateCustomActionTypeOutput
      //var instance = new AwsCodePipeline.CreateCustomActionTypeOutput();
      //expect(instance).to.be.a(AwsCodePipeline.CreateCustomActionTypeOutput);
    });
