...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.StopExecutionTrigger();
  });
  ...
  describe('StopExecutionTrigger', function() {
    it('should create an instance of StopExecutionTrigger', function() {
      // uncomment below and update the code to test StopExecutionTrigger
      //var instance = new AwsCodePipeline.StopExecutionTrigger();
      //expect(instance).to.be.a(AwsCodePipeline.StopExecutionTrigger);
    });
