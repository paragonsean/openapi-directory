...
(function(root, factory) {
  ...
  describe('ActionConfigurationPropertyType', function() {
    it('should create an instance of ActionConfigurationPropertyType', function() {
      // uncomment below and update the code to test ActionConfigurationPropertyType
      //var instance = new AwsCodePipeline.ActionConfigurationPropertyType();
      //expect(instance).to.be.a(AwsCodePipeline.ActionConfigurationPropertyType);
    });
