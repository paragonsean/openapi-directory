...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetThirdPartyJobDetailsOutputJobDetails();
  });
  ...
  describe('GetThirdPartyJobDetailsOutputJobDetails', function() {
    it('should create an instance of GetThirdPartyJobDetailsOutputJobDetails', function() {
      // uncomment below and update the code to test GetThirdPartyJobDetailsOutputJobDetails
      //var instance = new AwsCodePipeline.GetThirdPartyJobDetailsOutputJobDetails();
      //expect(instance).to.be.a(AwsCodePipeline.GetThirdPartyJobDetailsOutputJobDetails);
    });
