...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetPipelineExecutionOutputPipelineExecution();
  });
  ...
  describe('GetPipelineExecutionOutputPipelineExecution', function() {
    it('should create an instance of GetPipelineExecutionOutputPipelineExecution', function() {
      // uncomment below and update the code to test GetPipelineExecutionOutputPipelineExecution
      //var instance = new AwsCodePipeline.GetPipelineExecutionOutputPipelineExecution();
      //expect(instance).to.be.a(AwsCodePipeline.GetPipelineExecutionOutputPipelineExecution);
    });
    ...
    it('should have the property pipelineVersion (base name: "pipelineVersion")', function() {
      // uncomment below and update the code to test the property pipelineVersion
      //var instance = new AwsCodePipeline.GetPipelineExecutionOutputPipelineExecution();
      //expect(instance).to.be();
    });
    ...
    it('should have the property artifactRevisions (base name: "artifactRevisions")', function() {
      // uncomment below and update the code to test the property artifactRevisions
      //var instance = new AwsCodePipeline.GetPipelineExecutionOutputPipelineExecution();
      //expect(instance).to.be();
    });
