...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListTagsForResourceOutput();
  });
  ...
  describe('ListTagsForResourceOutput', function() {
    it('should create an instance of ListTagsForResourceOutput', function() {
      ...
      //var instance = new AwsCodePipeline.ListTagsForResourceOutput();
      //expect(instance).to.be.a(AwsCodePipeline.ListTagsForResourceOutput);
    });
