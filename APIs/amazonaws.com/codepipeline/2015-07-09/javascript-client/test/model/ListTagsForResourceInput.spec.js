...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListTagsForResourceInput();
  });
  ...
  describe('ListTagsForResourceInput', function() {
    it('should create an instance of ListTagsForResourceInput', function() {
      // uncomment below and update the code to test ListTagsForResourceInput
      //var instance = new AwsCodePipeline.ListTagsForResourceInput();
      //expect(instance).to.be.a(AwsCodePipeline.ListTagsForResourceInput);
    });
