...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.CreatePipelineInput();
  });
  ...
  describe('CreatePipelineInput', function() {
    it('should create an instance of CreatePipelineInput', function() {
      // uncomment below and update the code to test CreatePipelineInput
      //var instance = new AwsCodePipeline.CreatePipelineInput();
      //expect(instance).to.be.a(AwsCodePipeline.CreatePipelineInput);
    });
