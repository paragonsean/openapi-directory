...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListActionExecutionsInputFilter();
  });
  ...
  describe('ListActionExecutionsInputFilter', function() {
    it('should create an instance of ListActionExecutionsInputFilter', function() {
      // uncomment below and update the code to test ListActionExecutionsInputFilter
      //var instance = new AwsCodePipeline.ListActionExecutionsInputFilter();
      //expect(instance).to.be.a(AwsCodePipeline.ListActionExecutionsInputFilter);
    });
