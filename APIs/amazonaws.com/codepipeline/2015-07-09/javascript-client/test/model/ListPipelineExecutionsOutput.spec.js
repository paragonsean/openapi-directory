...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListPipelineExecutionsOutput();
  });
  ...
  describe('ListPipelineExecutionsOutput', function() {
    it('should create an instance of ListPipelineExecutionsOutput', function() {
      // uncomment below and update the code to test ListPipelineExecutionsOutput
      //var instance = new AwsCodePipeline.ListPipelineExecutionsOutput();
      //expect(instance).to.be.a(AwsCodePipeline.ListPipelineExecutionsOutput);
    });
