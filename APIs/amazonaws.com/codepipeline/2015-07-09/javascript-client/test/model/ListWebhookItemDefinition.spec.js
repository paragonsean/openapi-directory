...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListWebhookItemDefinition();
  });
  ...
  describe('ListWebhookItemDefinition', function() {
    it('should create an instance of ListWebhookItemDefinition', function() {
      // uncomment below and update the code to test ListWebhookItemDefinition
      //var instance = new AwsCodePipeline.ListWebhookItemDefinition();
      //expect(instance).to.be.a(AwsCodePipeline.ListWebhookItemDefinition);
    });
    ...
    it('should have the property targetPipeline (base name: "targetPipeline")', function() {
      // uncomment below and update the code to test the property targetPipeline
      //var instance = new AwsCodePipeline.ListWebhookItemDefinition();
      //expect(instance).to.be();
    });
