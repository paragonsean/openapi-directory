...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.JobDataActionConfiguration();
  });
  ...
  describe('JobDataActionConfiguration', function() {
    it('should create an instance of JobDataActionConfiguration', function() {
      // uncomment below and update the code to test JobDataActionConfiguration
      //var instance = new AwsCodePipeline.JobDataActionConfiguration();
      //expect(instance).to.be.a(AwsCodePipeline.JobDataActionConfiguration);
    });
