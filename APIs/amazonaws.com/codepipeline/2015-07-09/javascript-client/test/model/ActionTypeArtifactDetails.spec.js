...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeArtifactDetails();
  });
  ...
  describe('ActionTypeArtifactDetails', function() {
    it('should create an instance of ActionTypeArtifactDetails', function() {
      // uncomment below and update the code to test ActionTypeArtifactDetails
      //var instance = new AwsCodePipeline.ActionTypeArtifactDetails();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeArtifactDetails);
    });
