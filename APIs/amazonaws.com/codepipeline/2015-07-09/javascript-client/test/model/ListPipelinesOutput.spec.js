...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListPipelinesOutput();
  });
  ...
  describe('ListPipelinesOutput', function() {
    it('should create an instance of ListPipelinesOutput', function() {
      // uncomment below and update the code to test ListPipelinesOutput
      //var instance = new AwsCodePipeline.ListPipelinesOutput();
      //expect(instance).to.be.a(AwsCodePipeline.ListPipelinesOutput);
    });
