...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionDeclaration();
  });
  ...
  describe('ActionDeclaration', function() {
    it('should create an instance of ActionDeclaration', function() {
      // uncomment below and update the code to test ActionDeclaration
      //var instance = new AwsCodePipeline.ActionDeclaration();
      //expect(instance).to.be.a(AwsCodePipeline.ActionDeclaration);
    });
