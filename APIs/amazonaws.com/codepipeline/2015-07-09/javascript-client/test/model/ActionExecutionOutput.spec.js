...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionExecutionOutput();
  });
  ...
  describe('ActionExecutionOutput', function() {
    it('should create an instance of ActionExecutionOutput', function() {
      // uncomment below and update the code to test ActionExecutionOutput
      //var instance = new AwsCodePipeline.ActionExecutionOutput();
      //expect(instance).to.be.a(AwsCodePipeline.ActionExecutionOutput);
    });
