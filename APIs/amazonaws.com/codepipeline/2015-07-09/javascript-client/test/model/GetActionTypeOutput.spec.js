...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetActionTypeOutput();
  });
  ...
  describe('GetActionTypeOutput', function() {
    it('should create an instance of GetActionTypeOutput', function() {
      // uncomment below and update the code to test GetActionTypeOutput
      //var instance = new AwsCodePipeline.GetActionTypeOutput();
      //expect(instance).to.be.a(AwsCodePipeline.GetActionTypeOutput);
    });
