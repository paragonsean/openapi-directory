...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.UpdatePipelineInputPipeline();
  });
  ...
  describe('UpdatePipelineInputPipeline', function() {
    it('should create an instance of UpdatePipelineInputPipeline', function() {
      // uncomment below and update the code to test UpdatePipelineInputPipeline
      //var instance = new AwsCodePipeline.UpdatePipelineInputPipeline();
      //expect(instance).to.be.a(AwsCodePipeline.UpdatePipelineInputPipeline);
    });
