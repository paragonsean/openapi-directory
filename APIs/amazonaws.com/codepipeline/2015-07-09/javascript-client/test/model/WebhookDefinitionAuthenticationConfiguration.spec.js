...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.WebhookDefinitionAuthenticationConfiguration();
  });
  ...
  describe('WebhookDefinitionAuthenticationConfiguration', function() {
    it('should create an instance of WebhookDefinitionAuthenticationConfiguration', function() {
      // uncomment below and update the code to test WebhookDefinitionAuthenticationConfiguration
      //var instance = new AwsCodePipeline.WebhookDefinitionAuthenticationConfiguration();
      //expect(instance).to.be.a(AwsCodePipeline.WebhookDefinitionAuthenticationConfiguration);
    });

    it('should have the property allowedIPRange (base name: "AllowedIPRange")', function() {
      // uncomment below and update the code to test the property allowedIPRange
      //var instance = new AwsCodePipeline.WebhookDefinitionAuthenticationConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property secretToken (base name: "SecretToken")', function() {
      // uncomment below and update the code to test the property secretToken
      //var instance = new AwsCodePipeline.WebhookDefinitionAuthenticationConfiguration();
      //expect(instance).to.be();
    });
