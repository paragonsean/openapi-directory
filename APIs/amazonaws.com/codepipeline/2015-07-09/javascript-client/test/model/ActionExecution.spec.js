...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionExecution();
  });
  ...
  describe('ActionExecution', function() {
    it('should create an instance of ActionExecution', function() {
      // uncomment below and update the code to test ActionExecution
      //var instance = new AwsCodePipeline.ActionExecution();
      //expect(instance).to.be.a(AwsCodePipeline.ActionExecution);
    });
