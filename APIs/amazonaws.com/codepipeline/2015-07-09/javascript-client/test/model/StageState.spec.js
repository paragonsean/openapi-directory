...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.StageState();
  });
  ...
  describe('StageState', function() {
    it('should create an instance of StageState', function() {
      // uncomment below and update the code to test StageState
      //var instance = new AwsCodePipeline.StageState();
      //expect(instance).to.be.a(AwsCodePipeline.StageState);
    });
    ...
    it('should have the property inboundExecution (base name: "inboundExecution")', function() {
      // uncomment below and update the code to test the property inboundExecution
      //var instance = new AwsCodePipeline.StageState();
      //expect(instance).to.be();
    });

    it('should have the property inboundTransitionState (base name: "inboundTransitionState")', function() {
      // uncomment below and update the code to test the property inboundTransitionState
      //var instance = new AwsCodePipeline.StageState();
      //expect(instance).to.be();
    });

    it('should have the property actionStates (base name: "actionStates")', function() {
      // uncomment below and update the code to test the property actionStates
      //var instance = new AwsCodePipeline.StageState();
      //expect(instance).to.be();
    });

    it('should have the property latestExecution (base name: "latestExecution")', function() {
      // uncomment below and update the code to test the property latestExecution
      //var instance = new AwsCodePipeline.StageState();
      //expect(instance).to.be();
    });
