...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListWebhooksInput();
  });
  ...
  describe('ListWebhooksInput', function() {
    it('should create an instance of ListWebhooksInput', function() {
      // uncomment below and update the code to test ListWebhooksInput
      //var instance = new AwsCodePipeline.ListWebhooksInput();
      //expect(instance).to.be.a(AwsCodePipeline.ListWebhooksInput);
    });
