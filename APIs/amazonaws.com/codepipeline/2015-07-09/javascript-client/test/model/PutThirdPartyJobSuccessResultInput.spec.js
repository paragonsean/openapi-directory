...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutThirdPartyJobSuccessResultInput();
  });
  ...
  describe('PutThirdPartyJobSuccessResultInput', function() {
    it('should create an instance of PutThirdPartyJobSuccessResultInput', function() {
      // uncomment below and update the code to test PutThirdPartyJobSuccessResultInput
      //var instance = new AwsCodePipeline.PutThirdPartyJobSuccessResultInput();
      //expect(instance).to.be.a(AwsCodePipeline.PutThirdPartyJobSuccessResultInput);
    });
    ...
    it('should have the property executionDetails (base name: "executionDetails")', function() {
      // uncomment below and update the code to test the property executionDetails
      //var instance = new AwsCodePipeline.PutThirdPartyJobSuccessResultInput();
      //expect(instance).to.be();
    });
