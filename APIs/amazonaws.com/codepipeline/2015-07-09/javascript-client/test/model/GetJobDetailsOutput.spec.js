...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetJobDetailsOutput();
  });
  ...
  describe('GetJobDetailsOutput', function() {
    it('should create an instance of GetJobDetailsOutput', function() {
      // uncomment below and update the code to test GetJobDetailsOutput
      //var instance = new AwsCodePipeline.GetJobDetailsOutput();
      //expect(instance).to.be.a(AwsCodePipeline.GetJobDetailsOutput);
    });
