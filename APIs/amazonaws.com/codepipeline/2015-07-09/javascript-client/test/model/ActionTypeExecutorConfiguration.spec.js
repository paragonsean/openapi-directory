...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeExecutorConfiguration();
  });
  ...
  describe('ActionTypeExecutorConfiguration', function() {
    it('should create an instance of ActionTypeExecutorConfiguration', function() {
      // uncomment below and update the code to test ActionTypeExecutorConfiguration
      //var instance = new AwsCodePipeline.ActionTypeExecutorConfiguration();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeExecutorConfiguration);
    });

    it('should have the property lambdaExecutorConfiguration (base name: "lambdaExecutorConfiguration")', function() {
      // uncomment below and update the code to test the property lambdaExecutorConfiguration
      //var instance = new AwsCodePipeline.ActionTypeExecutorConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property jobWorkerExecutorConfiguration (base name: "jobWorkerExecutorConfiguration")', function() {
      // uncomment below and update the code to test the property jobWorkerExecutorConfiguration
      //var instance = new AwsCodePipeline.ActionTypeExecutorConfiguration();
      //expect(instance).to.be();
    });
