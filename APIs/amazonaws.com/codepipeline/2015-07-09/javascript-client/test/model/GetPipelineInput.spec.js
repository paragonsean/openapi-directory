...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetPipelineInput();
  });
  ...
  describe('GetPipelineInput', function() {
    it('should create an instance of GetPipelineInput', function() {
      // uncomment below and update the code to test GetPipelineInput
      //var instance = new AwsCodePipeline.GetPipelineInput();
      //expect(instance).to.be.a(AwsCodePipeline.GetPipelineInput);
    });
