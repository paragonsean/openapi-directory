...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeDeclarationUrls();
  });
  ...
  describe('ActionTypeDeclarationUrls', function() {
    it('should create an instance of ActionTypeDeclarationUrls', function() {
      // uncomment below and update the code to test ActionTypeDeclarationUrls
      //var instance = new AwsCodePipeline.ActionTypeDeclarationUrls();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeDeclarationUrls);
    });

    it('should have the property configurationUrl (base name: "configurationUrl")', function() {
      // uncomment below and update the code to test the property configurationUrl
      //var instance = new AwsCodePipeline.ActionTypeDeclarationUrls();
      //expect(instance).to.be();
    });

    it('should have the property entityUrlTemplate (base name: "entityUrlTemplate")', function() {
      // uncomment below and update the code to test the property entityUrlTemplate
      //var instance = new AwsCodePipeline.ActionTypeDeclarationUrls();
      //expect(instance).to.be();
    });

    it('should have the property executionUrlTemplate (base name: "executionUrlTemplate")', function() {
      // uncomment below and update the code to test the property executionUrlTemplate
      //var instance = new AwsCodePipeline.ActionTypeDeclarationUrls();
      //expect(instance).to.be();
    });

    it('should have the property revisionUrlTemplate (base name: "revisionUrlTemplate")', function() {
      // uncomment below and update the code to test the property revisionUrlTemplate
      //var instance = new AwsCodePipeline.ActionTypeDeclarationUrls();
      //expect(instance).to.be();
    });
