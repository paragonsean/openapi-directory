...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.StageStateInboundTransitionState();
  });
  ...
  describe('StageStateInboundTransitionState', function() {
    it('should create an instance of StageStateInboundTransitionState', function() {
      // uncomment below and update the code to test StageStateInboundTransitionState
      //var instance = new AwsCodePipeline.StageStateInboundTransitionState();
      //expect(instance).to.be.a(AwsCodePipeline.StageStateInboundTransitionState);
    });
