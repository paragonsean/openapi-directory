...
(function(root, factory) {
  ...
  describe('ActionOwner', function() {
    it('should create an instance of ActionOwner', function() {
      // uncomment below and update the code to test ActionOwner
      //var instance = new AwsCodePipeline.ActionOwner();
      //expect(instance).to.be.a(AwsCodePipeline.ActionOwner);
    });
