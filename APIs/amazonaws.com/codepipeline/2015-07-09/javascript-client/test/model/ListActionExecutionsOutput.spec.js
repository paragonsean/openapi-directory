...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListActionExecutionsOutput();
  });
  ...
  describe('ListActionExecutionsOutput', function() {
    it('should create an instance of ListActionExecutionsOutput', function() {
      // uncomment below and update the code to test ListActionExecutionsOutput
      //var instance = new AwsCodePipeline.ListActionExecutionsOutput();
      //expect(instance).to.be.a(AwsCodePipeline.ListActionExecutionsOutput);
    });

    it('should have the property actionExecutionDetails (base name: "actionExecutionDetails")', function() {
      // uncomment below and update the code to test the property actionExecutionDetails
      //var instance = new AwsCodePipeline.ListActionExecutionsOutput();
