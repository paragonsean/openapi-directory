...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.TransitionState();
  });
  ...
  describe('TransitionState', function() {
    it('should create an instance of TransitionState', function() {
      ...
      //var instance = new AwsCodePipeline.TransitionState();
      //expect(instance).to.be.a(AwsCodePipeline.TransitionState);
    });
    ...
    it('should have the property lastChangedBy (base name: "lastChangedBy")', function() {
      // uncomment below and update the code to test the property lastChangedBy
      //var instance = new AwsCodePipeline.TransitionState();
      //expect(instance).to.be();
    });

    it('should have the property lastChangedAt (base name: "lastChangedAt")', function() {
