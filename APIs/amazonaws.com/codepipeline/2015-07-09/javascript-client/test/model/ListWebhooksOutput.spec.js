...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListWebhooksOutput();
  });
  ...
  describe('ListWebhooksOutput', function() {
    it('should create an instance of ListWebhooksOutput', function() {
      // uncomment below and update the code to test ListWebhooksOutput
      //var instance = new AwsCodePipeline.ListWebhooksOutput();
      //expect(instance).to.be.a(AwsCodePipeline.ListWebhooksOutput);
    });
