...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PipelineExecutionSummaryStopTrigger();
  });
  ...
  describe('PipelineExecutionSummaryStopTrigger', function() {
    it('should create an instance of PipelineExecutionSummaryStopTrigger', function() {
      // uncomment below and update the code to test PipelineExecutionSummaryStopTrigger
      //var instance = new AwsCodePipeline.PipelineExecutionSummaryStopTrigger();
      //expect(instance).to.be.a(AwsCodePipeline.PipelineExecutionSummaryStopTrigger);
    });
