...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.WebhookAuthConfiguration();
  });
  ...
  describe('WebhookAuthConfiguration', function() {
    it('should create an instance of WebhookAuthConfiguration', function() {
      // uncomment below and update the code to test WebhookAuthConfiguration
      //var instance = new AwsCodePipeline.WebhookAuthConfiguration();
      //expect(instance).to.be.a(AwsCodePipeline.WebhookAuthConfiguration);
    });
