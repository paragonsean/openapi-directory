...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PipelineDeclaration();
  });
  ...
  describe('PipelineDeclaration', function() {
    it('should create an instance of PipelineDeclaration', function() {
      // uncomment below and update the code to test PipelineDeclaration
      //var instance = new AwsCodePipeline.PipelineDeclaration();
      //expect(instance).to.be.a(AwsCodePipeline.PipelineDeclaration);
    });
