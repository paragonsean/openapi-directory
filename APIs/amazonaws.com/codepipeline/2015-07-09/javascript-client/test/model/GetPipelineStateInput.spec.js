...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetPipelineStateInput();
  });
  ...
  describe('GetPipelineStateInput', function() {
    it('should create an instance of GetPipelineStateInput', function() {
      // uncomment below and update the code to test GetPipelineStateInput
      //var instance = new AwsCodePipeline.GetPipelineStateInput();
      //expect(instance).to.be.a(AwsCodePipeline.GetPipelineStateInput);
    });
