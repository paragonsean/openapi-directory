...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ThirdPartyJob();
  });
  ...
  describe('ThirdPartyJob', function() {
    it('should create an instance of ThirdPartyJob', function() {
      // uncomment below and update the code to test ThirdPartyJob
      //var instance = new AwsCodePipeline.ThirdPartyJob();
      //expect(instance).to.be.a(AwsCodePipeline.ThirdPartyJob);
    });
