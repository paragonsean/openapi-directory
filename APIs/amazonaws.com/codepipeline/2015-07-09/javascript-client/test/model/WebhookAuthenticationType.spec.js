...
(function(root, factory) {
  ...
  describe('WebhookAuthenticationType', function() {
    it('should create an instance of WebhookAuthenticationType', function() {
      // uncomment below and update the code to test WebhookAuthenticationType
      //var instance = new AwsCodePipeline.WebhookAuthenticationType();
      //expect(instance).to.be.a(AwsCodePipeline.WebhookAuthenticationType);
    });
