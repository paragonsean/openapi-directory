...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ExecutorConfiguration();
  });
  ...
  describe('ExecutorConfiguration', function() {
    it('should create an instance of ExecutorConfiguration', function() {
      // uncomment below and update the code to test ExecutorConfiguration
      //var instance = new AwsCodePipeline.ExecutorConfiguration();
      //expect(instance).to.be.a(AwsCodePipeline.ExecutorConfiguration);
    });
