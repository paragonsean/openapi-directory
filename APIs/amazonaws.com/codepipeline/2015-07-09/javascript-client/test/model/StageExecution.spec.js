...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.StageExecution();
  });
  ...
  describe('StageExecution', function() {
    it('should create an instance of StageExecution', function() {
      // uncomment below and update the code to test StageExecution
      //var instance = new AwsCodePipeline.StageExecution();
      //expect(instance).to.be.a(AwsCodePipeline.StageExecution);
    });
