...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PipelineContextStage();
  });
  ...
  describe('PipelineContextStage', function() {
    it('should create an instance of PipelineContextStage', function() {
      // uncomment below and update the code to test PipelineContextStage
      //var instance = new AwsCodePipeline.PipelineContextStage();
      //expect(instance).to.be.a(AwsCodePipeline.PipelineContextStage);
    });
