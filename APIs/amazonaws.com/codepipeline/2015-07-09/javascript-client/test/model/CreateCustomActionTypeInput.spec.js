...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.CreateCustomActionTypeInput();
  });
  ...
  describe('CreateCustomActionTypeInput', function() {
    it('should create an instance of CreateCustomActionTypeInput', function() {
      // uncomment below and update the code to test CreateCustomActionTypeInput
      //var instance = new AwsCodePipeline.CreateCustomActionTypeInput();
      //expect(instance).to.be.a(AwsCodePipeline.CreateCustomActionTypeInput);
    });
