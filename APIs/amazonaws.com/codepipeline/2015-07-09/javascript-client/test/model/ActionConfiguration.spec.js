...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionConfiguration();
  });
  ...
  describe('ActionConfiguration', function() {
    it('should create an instance of ActionConfiguration', function() {
      ...
      //var instance = new AwsCodePipeline.ActionConfiguration();
      //expect(instance).to.be.a(AwsCodePipeline.ActionConfiguration);
    });
