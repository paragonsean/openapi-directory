...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeDeclarationId();
  });
  ...
  describe('ActionTypeDeclarationId', function() {
    it('should create an instance of ActionTypeDeclarationId', function() {
      // uncomment below and update the code to test ActionTypeDeclarationId
      //var instance = new AwsCodePipeline.ActionTypeDeclarationId();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeDeclarationId);
    });
