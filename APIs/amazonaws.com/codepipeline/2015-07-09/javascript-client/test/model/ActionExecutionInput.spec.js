...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionExecutionInput();
  });
  ...
  describe('ActionExecutionInput', function() {
    it('should create an instance of ActionExecutionInput', function() {
      // uncomment below and update the code to test ActionExecutionInput
      //var instance = new AwsCodePipeline.ActionExecutionInput();
      //expect(instance).to.be.a(AwsCodePipeline.ActionExecutionInput);
    });
    ...
    it('should have the property resolvedConfiguration (base name: "resolvedConfiguration")', function() {
      // uncomment below and update the code to test the property resolvedConfiguration
      //var instance = new AwsCodePipeline.ActionExecutionInput();
      //expect(instance).to.be();
    });
