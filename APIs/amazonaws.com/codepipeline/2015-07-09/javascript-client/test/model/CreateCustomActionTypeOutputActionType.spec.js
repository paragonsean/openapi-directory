...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.CreateCustomActionTypeOutputActionType();
  });
  ...
  describe('CreateCustomActionTypeOutputActionType', function() {
    it('should create an instance of CreateCustomActionTypeOutputActionType', function() {
      // uncomment below and update the code to test CreateCustomActionTypeOutputActionType
      //var instance = new AwsCodePipeline.CreateCustomActionTypeOutputActionType();
      //expect(instance).to.be.a(AwsCodePipeline.CreateCustomActionTypeOutputActionType);
    });
