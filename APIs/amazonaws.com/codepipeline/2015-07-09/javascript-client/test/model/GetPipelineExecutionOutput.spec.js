...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.GetPipelineExecutionOutput();
  });
  ...
  describe('GetPipelineExecutionOutput', function() {
    it('should create an instance of GetPipelineExecutionOutput', function() {
      // uncomment below and update the code to test GetPipelineExecutionOutput
      //var instance = new AwsCodePipeline.GetPipelineExecutionOutput();
      //expect(instance).to.be.a(AwsCodePipeline.GetPipelineExecutionOutput);
    });
