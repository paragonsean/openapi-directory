...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ExecutionTrigger();
  });
  ...
  describe('ExecutionTrigger', function() {
    it('should create an instance of ExecutionTrigger', function() {
      // uncomment below and update the code to test ExecutionTrigger
      //var instance = new AwsCodePipeline.ExecutionTrigger();
      //expect(instance).to.be.a(AwsCodePipeline.ExecutionTrigger);
    });
