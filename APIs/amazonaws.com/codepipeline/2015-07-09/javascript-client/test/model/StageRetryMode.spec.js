...
(function(root, factory) {
  ...
  describe('StageRetryMode', function() {
    it('should create an instance of StageRetryMode', function() {
      // uncomment below and update the code to test StageRetryMode
      //var instance = new AwsCodePipeline.StageRetryMode();
      //expect(instance).to.be.a(AwsCodePipeline.StageRetryMode);
    });
