...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PollForJobsInputActionTypeId();
  });
  ...
  describe('PollForJobsInputActionTypeId', function() {
    it('should create an instance of PollForJobsInputActionTypeId', function() {
      // uncomment below and update the code to test PollForJobsInputActionTypeId
      //var instance = new AwsCodePipeline.PollForJobsInputActionTypeId();
      //expect(instance).to.be.a(AwsCodePipeline.PollForJobsInputActionTypeId);
    });
