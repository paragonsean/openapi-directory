...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ThirdPartyJobDetails();
  });
  ...
  describe('ThirdPartyJobDetails', function() {
    it('should create an instance of ThirdPartyJobDetails', function() {
      // uncomment below and update the code to test ThirdPartyJobDetails
      //var instance = new AwsCodePipeline.ThirdPartyJobDetails();
      //expect(instance).to.be.a(AwsCodePipeline.ThirdPartyJobDetails);
    });
