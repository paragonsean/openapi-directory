...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ThirdPartyJobData();
  });
  ...
  describe('ThirdPartyJobData', function() {
    it('should create an instance of ThirdPartyJobData', function() {
      // uncomment below and update the code to test ThirdPartyJobData
      //var instance = new AwsCodePipeline.ThirdPartyJobData();
      //expect(instance).to.be.a(AwsCodePipeline.ThirdPartyJobData);
    });
