...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.StartPipelineExecutionInput();
  });
  ...
  describe('StartPipelineExecutionInput', function() {
    it('should create an instance of StartPipelineExecutionInput', function() {
      // uncomment below and update the code to test StartPipelineExecutionInput
      //var instance = new AwsCodePipeline.StartPipelineExecutionInput();
      //expect(instance).to.be.a(AwsCodePipeline.StartPipelineExecutionInput);
    });
