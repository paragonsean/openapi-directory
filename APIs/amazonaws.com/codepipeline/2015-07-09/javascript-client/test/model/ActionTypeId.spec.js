...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeId();
  });
  ...
  describe('ActionTypeId', function() {
    it('should create an instance of ActionTypeId', function() {
      // uncomment below and update the code to test ActionTypeId
      //var instance = new AwsCodePipeline.ActionTypeId();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeId);
    });
