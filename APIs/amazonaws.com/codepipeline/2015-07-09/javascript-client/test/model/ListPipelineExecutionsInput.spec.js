...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ListPipelineExecutionsInput();
  });
  ...
  describe('ListPipelineExecutionsInput', function() {
    it('should create an instance of ListPipelineExecutionsInput', function() {
      // uncomment below and update the code to test ListPipelineExecutionsInput
      //var instance = new AwsCodePipeline.ListPipelineExecutionsInput();
      //expect(instance).to.be.a(AwsCodePipeline.ListPipelineExecutionsInput);
    });
