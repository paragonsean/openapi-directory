...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ThirdPartyJobDataPipelineContext();
  });
  ...
  describe('ThirdPartyJobDataPipelineContext', function() {
    it('should create an instance of ThirdPartyJobDataPipelineContext', function() {
      // uncomment below and update the code to test ThirdPartyJobDataPipelineContext
      //var instance = new AwsCodePipeline.ThirdPartyJobDataPipelineContext();
      //expect(instance).to.be.a(AwsCodePipeline.ThirdPartyJobDataPipelineContext);
    });
