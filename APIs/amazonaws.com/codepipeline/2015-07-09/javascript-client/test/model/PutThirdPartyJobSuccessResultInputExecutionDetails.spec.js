...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.PutThirdPartyJobSuccessResultInputExecutionDetails();
  });
  ...
  describe('PutThirdPartyJobSuccessResultInputExecutionDetails', function() {
    it('should create an instance of PutThirdPartyJobSuccessResultInputExecutionDetails', function() {
      // uncomment below and update the code to test PutThirdPartyJobSuccessResultInputExecutionDetails
      //var instance = new AwsCodePipeline.PutThirdPartyJobSuccessResultInputExecutionDetails();
      //expect(instance).to.be.a(AwsCodePipeline.PutThirdPartyJobSuccessResultInputExecutionDetails);
    });
