...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.StartPipelineExecutionOutput();
  });
  ...
  describe('StartPipelineExecutionOutput', function() {
    it('should create an instance of StartPipelineExecutionOutput', function() {
      // uncomment below and update the code to test StartPipelineExecutionOutput
      //var instance = new AwsCodePipeline.StartPipelineExecutionOutput();
      //expect(instance).to.be.a(AwsCodePipeline.StartPipelineExecutionOutput);
    });
