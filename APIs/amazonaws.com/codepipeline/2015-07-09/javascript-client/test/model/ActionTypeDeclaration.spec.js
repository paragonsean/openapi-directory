...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeDeclaration();
  });
  ...
  describe('ActionTypeDeclaration', function() {
    it('should create an instance of ActionTypeDeclaration', function() {
      // uncomment below and update the code to test ActionTypeDeclaration
      //var instance = new AwsCodePipeline.ActionTypeDeclaration();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeDeclaration);
    });
