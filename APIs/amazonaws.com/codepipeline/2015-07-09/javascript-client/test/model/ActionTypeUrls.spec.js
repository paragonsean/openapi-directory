...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodePipeline.ActionTypeUrls();
  });
  ...
  describe('ActionTypeUrls', function() {
    it('should create an instance of ActionTypeUrls', function() {
      // uncomment below and update the code to test ActionTypeUrls
      //var instance = new AwsCodePipeline.ActionTypeUrls();
      //expect(instance).to.be.a(AwsCodePipeline.ActionTypeUrls);
    });
