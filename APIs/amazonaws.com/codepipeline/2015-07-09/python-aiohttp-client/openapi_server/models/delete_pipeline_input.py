...
class DeletePipelineInput(Model):
    ...
    def __init__(self, name: str=None):
        ...
        :param name: The name of this DeletePipelineInput.
        """
        self.openapi_types = {
            'name': str
        }
    ...
    @property
    def name(self):
        """Gets the name of this DeletePipelineInput.


        :return: The name of this DeletePipelineInput.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DeletePipelineInput.
