...
class ExecutorConfiguration(Model):
    ...
    def __init__(self, lambda_executor_configuration: ExecutorConfigurationLambdaExecutorConfiguration=None, job_worker_executor_configuration: ExecutorConfigurationJobWorkerExecutorConfiguration=None):
        """ExecutorConfiguration - a model defined in OpenAPI

        :param lambda_executor_configuration: The lambda_executor_configuration of this ExecutorConfiguration.
        :param job_worker_executor_configuration: The job_worker_executor_configuration of this ExecutorConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ExecutorConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ExecutorConfiguration of this ExecutorConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def lambda_executor_configuration(self):
        """Gets the lambda_executor_configuration of this ExecutorConfiguration.


        :return: The lambda_executor_configuration of this ExecutorConfiguration.
    ...
    def lambda_executor_configuration(self, lambda_executor_configuration):
        """Sets the lambda_executor_configuration of this ExecutorConfiguration.
    ...
    def job_worker_executor_configuration(self):
        """Gets the job_worker_executor_configuration of this ExecutorConfiguration.


        :return: The job_worker_executor_configuration of this ExecutorConfiguration.
    ...
    def job_worker_executor_configuration(self, job_worker_executor_configuration):
        """Sets the job_worker_executor_configuration of this ExecutorConfiguration.
