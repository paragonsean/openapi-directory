...
/*
 * OAIDescribeTrustedAdvisorCheckSummariesResponse.h
 *
 * The summaries of the Trusted Advisor checks returned by the &lt;a&gt;DescribeTrustedAdvisorCheckSummaries&lt;/a&gt; operation.
 */

#ifndef OAIDescribeTrustedAdvisorCheckSummariesResponse_H
#define OAIDescribeTrustedAdvisorCheckSummariesResponse_H
...
class OAIDescribeTrustedAdvisorCheckSummariesResponse : public OAIObject {
public:
    OAIDescribeTrustedAdvisorCheckSummariesResponse();
    OAIDescribeTrustedAdvisorCheckSummariesResponse(QString json);
    ~OAIDescribeTrustedAdvisorCheckSummariesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTrustedAdvisorCheckSummariesResponse)

#endif // OAIDescribeTrustedAdvisorCheckSummariesResponse_H
