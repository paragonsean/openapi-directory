...
/*
 * OAIRecentCaseCommunications.h
 *
 * The five most recent communications associated with the case.
 */

#ifndef OAIRecentCaseCommunications_H
#define OAIRecentCaseCommunications_H
...
class OAIRecentCaseCommunications : public OAIObject {
public:
    OAIRecentCaseCommunications();
    OAIRecentCaseCommunications(QString json);
    ~OAIRecentCaseCommunications() override;
    ...
    QList getCommunications() const;
    void setCommunications(const QList &communications);
    bool is_communications_Set() const;
    bool is_communications_Valid() const;
...
private:
    ...
    QList m_communications;
    bool m_communications_isSet;
    bool m_communications_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecentCaseCommunications)

#endif // OAIRecentCaseCommunications_H
