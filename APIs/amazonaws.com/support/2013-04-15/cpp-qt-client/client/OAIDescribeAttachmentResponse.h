...
/*
 * OAIDescribeAttachmentResponse.h
 *
 * The content and file name of the attachment returned by the &lt;a&gt;DescribeAttachment&lt;/a&gt; operation.
 */

#ifndef OAIDescribeAttachmentResponse_H
#define OAIDescribeAttachmentResponse_H
...
namespace OpenAPI {
class OAIDescribeAttachmentResponse_attachment;

class OAIDescribeAttachmentResponse : public OAIObject {
public:
    OAIDescribeAttachmentResponse();
    OAIDescribeAttachmentResponse(QString json);
    ~OAIDescribeAttachmentResponse() override;
    ...
    OAIDescribeAttachmentResponse_attachment getAttachment() const;
    void setAttachment(const OAIDescribeAttachmentResponse_attachment &attachment);
...
private:
    ...
    OAIDescribeAttachmentResponse_attachment m_attachment;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAttachmentResponse)

#endif // OAIDescribeAttachmentResponse_H
