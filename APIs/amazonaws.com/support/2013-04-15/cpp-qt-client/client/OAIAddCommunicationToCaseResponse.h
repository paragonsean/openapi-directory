...
/*
 * OAIAddCommunicationToCaseResponse.h
 *
 * The result of the &lt;a&gt;AddCommunicationToCase&lt;/a&gt; operation.
 */

#ifndef OAIAddCommunicationToCaseResponse_H
#define OAIAddCommunicationToCaseResponse_H
...
class OAIAddCommunicationToCaseResponse : public OAIObject {
public:
    OAIAddCommunicationToCaseResponse();
    OAIAddCommunicationToCaseResponse(QString json);
    ~OAIAddCommunicationToCaseResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddCommunicationToCaseResponse)

#endif // OAIAddCommunicationToCaseResponse_H
