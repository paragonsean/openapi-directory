...
/*
 * OAIDescribeTrustedAdvisorCheckRefreshStatusesRequest.h
 *
 * 
 */

#ifndef OAIDescribeTrustedAdvisorCheckRefreshStatusesRequest_H
#define OAIDescribeTrustedAdvisorCheckRefreshStatusesRequest_H
...
class OAIDescribeTrustedAdvisorCheckRefreshStatusesRequest : public OAIObject {
public:
    OAIDescribeTrustedAdvisorCheckRefreshStatusesRequest();
    OAIDescribeTrustedAdvisorCheckRefreshStatusesRequest(QString json);
    ~OAIDescribeTrustedAdvisorCheckRefreshStatusesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTrustedAdvisorCheckRefreshStatusesRequest)

#endif // OAIDescribeTrustedAdvisorCheckRefreshStatusesRequest_H
