...
class OAICreateCaseResponse : public OAIObject {
public:
    OAICreateCaseResponse();
    OAICreateCaseResponse(QString json);
    ~OAICreateCaseResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCaseResponse)

#endif // OAICreateCaseResponse_H
