...
/*
 * OAICreateCaseRequest.h
 *
 * 
 */

#ifndef OAICreateCaseRequest_H
#define OAICreateCaseRequest_H
...
class OAICreateCaseRequest : public OAIObject {
public:
    OAICreateCaseRequest();
    OAICreateCaseRequest(QString json);
    ~OAICreateCaseRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCaseRequest)

#endif // OAICreateCaseRequest_H
