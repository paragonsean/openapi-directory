...
#ifndef OAICommunication_H
#define OAICommunication_H
...
class OAICommunication : public OAIObject {
public:
    OAICommunication();
    OAICommunication(QString json);
    ~OAICommunication() override;
    ...
    QList getAttachmentSet() const;
    void setAttachmentSet(const QList &attachment_set);
    bool is_attachment_set_Set() const;
    bool is_attachment_set_Valid() const;
...
private:
    ...
    QList m_attachment_set;
    bool m_attachment_set_isSet;
    bool m_attachment_set_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICommunication)

#endif // OAICommunication_H
