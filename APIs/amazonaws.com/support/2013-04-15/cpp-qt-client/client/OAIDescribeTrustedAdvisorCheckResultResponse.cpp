...
OAIDescribeTrustedAdvisorCheckResultResponse::OAIDescribeTrustedAdvisorCheckResultResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTrustedAdvisorCheckResultResponse::OAIDescribeTrustedAdvisorCheckResultResponse() {
    this->initializeModel();
}

OAIDescribeTrustedAdvisorCheckResultResponse::~OAIDescribeTrustedAdvisorCheckResultResponse() {}

void OAIDescribeTrustedAdvisorCheckResultResponse::initializeModel() {

    m_result_isSet = false;
    m_result_isValid = false;
}

void OAIDescribeTrustedAdvisorCheckResultResponse::fromJson(QString jsonString) {
...
void OAIDescribeTrustedAdvisorCheckResultResponse::fromJsonObject(QJsonObject json) {

    m_result_isValid = ::OpenAPI::fromJsonValue(m_result, json[QString("result")]);
    m_result_isSet = !json[QString("result")].isNull() && m_result_isValid;
}

QString OAIDescribeTrustedAdvisorCheckResultResponse::asJson() const {
...
QJsonObject OAIDescribeTrustedAdvisorCheckResultResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_result.isSet()) {
...
OAIDescribeTrustedAdvisorCheckResultResponse_result OAIDescribeTrustedAdvisorCheckResultResponse::getResult() const {
    return m_result;
}
void OAIDescribeTrustedAdvisorCheckResultResponse::setResult(const OAIDescribeTrustedAdvisorCheckResultResponse_result &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIDescribeTrustedAdvisorCheckResultResponse::is_result_Set() const{
    return m_result_isSet;
}

bool OAIDescribeTrustedAdvisorCheckResultResponse::is_result_Valid() const{
    return m_result_isValid;
}

bool OAIDescribeTrustedAdvisorCheckResultResponse::isSet() const {
...
bool OAIDescribeTrustedAdvisorCheckResultResponse::isValid() const {
