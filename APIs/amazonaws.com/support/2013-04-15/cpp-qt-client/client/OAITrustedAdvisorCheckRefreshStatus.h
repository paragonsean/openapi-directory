...
/*
 * OAITrustedAdvisorCheckRefreshStatus.h
 *
 * The refresh status of a Trusted Advisor check.
 */

#ifndef OAITrustedAdvisorCheckRefreshStatus_H
#define OAITrustedAdvisorCheckRefreshStatus_H
...
class OAITrustedAdvisorCheckRefreshStatus : public OAIObject {
public:
    OAITrustedAdvisorCheckRefreshStatus();
    OAITrustedAdvisorCheckRefreshStatus(QString json);
    ~OAITrustedAdvisorCheckRefreshStatus() override;
    ...
    qint32 getMillisUntilNextRefreshable() const;
    void setMillisUntilNextRefreshable(const qint32 &millis_until_next_refreshable);
    bool is_millis_until_next_refreshable_Set() const;
    bool is_millis_until_next_refreshable_Valid() const;
...
private:
    ...
    qint32 m_millis_until_next_refreshable;
    bool m_millis_until_next_refreshable_isSet;
    bool m_millis_until_next_refreshable_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITrustedAdvisorCheckRefreshStatus)

#endif // OAITrustedAdvisorCheckRefreshStatus_H
