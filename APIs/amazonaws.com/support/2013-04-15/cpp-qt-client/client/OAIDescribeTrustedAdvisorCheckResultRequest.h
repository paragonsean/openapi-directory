...
/*
 * OAIDescribeTrustedAdvisorCheckResultRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeTrustedAdvisorCheckResultRequest_H
#define OAIDescribeTrustedAdvisorCheckResultRequest_H
...
class OAIDescribeTrustedAdvisorCheckResultRequest : public OAIObject {
public:
    OAIDescribeTrustedAdvisorCheckResultRequest();
    OAIDescribeTrustedAdvisorCheckResultRequest(QString json);
    ~OAIDescribeTrustedAdvisorCheckResultRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTrustedAdvisorCheckResultRequest)

#endif // OAIDescribeTrustedAdvisorCheckResultRequest_H
