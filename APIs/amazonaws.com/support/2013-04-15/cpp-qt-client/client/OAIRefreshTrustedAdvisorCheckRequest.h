...
/*
 * OAIRefreshTrustedAdvisorCheckRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIRefreshTrustedAdvisorCheckRequest_H
#define OAIRefreshTrustedAdvisorCheckRequest_H
...
class OAIRefreshTrustedAdvisorCheckRequest : public OAIObject {
public:
    OAIRefreshTrustedAdvisorCheckRequest();
    OAIRefreshTrustedAdvisorCheckRequest(QString json);
    ~OAIRefreshTrustedAdvisorCheckRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefreshTrustedAdvisorCheckRequest)

#endif // OAIRefreshTrustedAdvisorCheckRequest_H
