...
/*
 * OAIAddCommunicationToCaseRequest.h
 *
 * 
 */

#ifndef OAIAddCommunicationToCaseRequest_H
#define OAIAddCommunicationToCaseRequest_H
...
class OAIAddCommunicationToCaseRequest : public OAIObject {
public:
    OAIAddCommunicationToCaseRequest();
    OAIAddCommunicationToCaseRequest(QString json);
    ~OAIAddCommunicationToCaseRequest() override;
    ...
    QString getCommunicationBody() const;
    void setCommunicationBody(const QString &communication_body);
    bool is_communication_body_Set() const;
    bool is_communication_body_Valid() const;
    ...
    QString getAttachmentSetId() const;
    void setAttachmentSetId(const QString &attachment_set_id);
    bool is_attachment_set_id_Set() const;
    bool is_attachment_set_id_Valid() const;
...
private:
    ...
    QString m_communication_body;
    bool m_communication_body_isSet;
    bool m_communication_body_isValid;

    QList m_cc_email_addresses;
    bool m_cc_email_addresses_isSet;
    bool m_cc_email_addresses_isValid;

    QString m_attachment_set_id;
    bool m_attachment_set_id_isSet;
    bool m_attachment_set_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAddCommunicationToCaseRequest)

#endif // OAIAddCommunicationToCaseRequest_H
