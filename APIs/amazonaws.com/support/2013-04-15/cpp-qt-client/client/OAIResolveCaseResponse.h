...
/*
 * OAIResolveCaseResponse.h
 *
 * The status of the case returned by the &lt;a&gt;ResolveCase&lt;/a&gt; operation.
 */

#ifndef OAIResolveCaseResponse_H
#define OAIResolveCaseResponse_H
...
class OAIResolveCaseResponse : public OAIObject {
public:
    OAIResolveCaseResponse();
    OAIResolveCaseResponse(QString json);
    ~OAIResolveCaseResponse() override;
    ...
    QString getInitialCaseStatus() const;
    void setInitialCaseStatus(const QString &initial_case_status);
    bool is_initial_case_status_Set() const;
    bool is_initial_case_status_Valid() const;

    QString getFinalCaseStatus() const;
    void setFinalCaseStatus(const QString &final_case_status);
    bool is_final_case_status_Set() const;
    bool is_final_case_status_Valid() const;
...
private:
    ...
    QString m_initial_case_status;
    bool m_initial_case_status_isSet;
    bool m_initial_case_status_isValid;

    QString m_final_case_status;
    bool m_final_case_status_isSet;
    bool m_final_case_status_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIResolveCaseResponse)

#endif // OAIResolveCaseResponse_H
