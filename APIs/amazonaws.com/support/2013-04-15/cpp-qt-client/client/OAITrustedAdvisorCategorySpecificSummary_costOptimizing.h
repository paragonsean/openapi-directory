...
/*
 * OAITrustedAdvisorCategorySpecificSummary_costOptimizing.h
 *
 * 
 */

#ifndef OAITrustedAdvisorCategorySpecificSummary_costOptimizing_H
#define OAITrustedAdvisorCategorySpecificSummary_costOptimizing_H
...
class OAITrustedAdvisorCategorySpecificSummary_costOptimizing : public OAIObject {
public:
    OAITrustedAdvisorCategorySpecificSummary_costOptimizing();
    OAITrustedAdvisorCategorySpecificSummary_costOptimizing(QString json);
    ~OAITrustedAdvisorCategorySpecificSummary_costOptimizing() override;
    ...
    void setEstimatedMonthlySavings(const double &estimated_monthly_savings);
    bool is_estimated_monthly_savings_Set() const;
    bool is_estimated_monthly_savings_Valid() const;

    double getEstimatedPercentMonthlySavings() const;
    void setEstimatedPercentMonthlySavings(const double &estimated_percent_monthly_savings);
    bool is_estimated_percent_monthly_savings_Set() const;
    bool is_estimated_percent_monthly_savings_Valid() const;
...
private:
    ...
    double m_estimated_monthly_savings;
    bool m_estimated_monthly_savings_isSet;
    bool m_estimated_monthly_savings_isValid;

    double m_estimated_percent_monthly_savings;
    bool m_estimated_percent_monthly_savings_isSet;
    bool m_estimated_percent_monthly_savings_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITrustedAdvisorCategorySpecificSummary_costOptimizing)

#endif // OAITrustedAdvisorCategorySpecificSummary_costOptimizing_H
