...
OAICreateCaseResponse::OAICreateCaseResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCaseResponse::OAICreateCaseResponse() {
    this->initializeModel();
}

OAICreateCaseResponse::~OAICreateCaseResponse() {}

void OAICreateCaseResponse::initializeModel() {

    m_case_id_isSet = false;
    m_case_id_isValid = false;
}

void OAICreateCaseResponse::fromJson(QString jsonString) {
...
void OAICreateCaseResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateCaseResponse::asJson() const {
...
QJsonObject OAICreateCaseResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_case_id_isSet) {
...
QString OAICreateCaseResponse::getCaseId() const {
    return m_case_id;
}
void OAICreateCaseResponse::setCaseId(const QString &case_id) {
    m_case_id = case_id;
    m_case_id_isSet = true;
}

bool OAICreateCaseResponse::is_case_id_Set() const{
    return m_case_id_isSet;
}

bool OAICreateCaseResponse::is_case_id_Valid() const{
    return m_case_id_isValid;
}

bool OAICreateCaseResponse::isSet() const {
...
bool OAICreateCaseResponse::isValid() const {
