...
/*
 * OAIDescribeCommunicationsRequest.h
 *
 * 
 */

#ifndef OAIDescribeCommunicationsRequest_H
#define OAIDescribeCommunicationsRequest_H
...
class OAIDescribeCommunicationsRequest : public OAIObject {
public:
    OAIDescribeCommunicationsRequest();
    OAIDescribeCommunicationsRequest(QString json);
    ~OAIDescribeCommunicationsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCommunicationsRequest)

#endif // OAIDescribeCommunicationsRequest_H
