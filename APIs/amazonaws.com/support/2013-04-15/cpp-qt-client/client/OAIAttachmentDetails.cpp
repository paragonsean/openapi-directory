...
#include "OAIAttachmentDetails.h"
...
OAIAttachmentDetails::OAIAttachmentDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAttachmentDetails::OAIAttachmentDetails() {
    this->initializeModel();
}

OAIAttachmentDetails::~OAIAttachmentDetails() {}

void OAIAttachmentDetails::initializeModel() {
...
void OAIAttachmentDetails::fromJson(QString jsonString) {
...
void OAIAttachmentDetails::fromJsonObject(QJsonObject json) {
...
QString OAIAttachmentDetails::asJson() const {
...
QJsonObject OAIAttachmentDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAttachmentDetails::getAttachmentId() const {
    return m_attachment_id;
}
void OAIAttachmentDetails::setAttachmentId(const QString &attachment_id) {
    m_attachment_id = attachment_id;
    m_attachment_id_isSet = true;
}

bool OAIAttachmentDetails::is_attachment_id_Set() const{
    return m_attachment_id_isSet;
}

bool OAIAttachmentDetails::is_attachment_id_Valid() const{
    return m_attachment_id_isValid;
}

QString OAIAttachmentDetails::getFileName() const {
    return m_file_name;
}
void OAIAttachmentDetails::setFileName(const QString &file_name) {
    m_file_name = file_name;
    m_file_name_isSet = true;
}

bool OAIAttachmentDetails::is_file_name_Set() const{
    return m_file_name_isSet;
}

bool OAIAttachmentDetails::is_file_name_Valid() const{
    return m_file_name_isValid;
}

bool OAIAttachmentDetails::isSet() const {
...
bool OAIAttachmentDetails::isValid() const {
