...
OAITrustedAdvisorCheckResult_categorySpecificSummary::OAITrustedAdvisorCheckResult_categorySpecificSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrustedAdvisorCheckResult_categorySpecificSummary::OAITrustedAdvisorCheckResult_categorySpecificSummary() {
    this->initializeModel();
}

OAITrustedAdvisorCheckResult_categorySpecificSummary::~OAITrustedAdvisorCheckResult_categorySpecificSummary() {}

void OAITrustedAdvisorCheckResult_categorySpecificSummary::initializeModel() {

    m_cost_optimizing_isSet = false;
    m_cost_optimizing_isValid = false;
}

void OAITrustedAdvisorCheckResult_categorySpecificSummary::fromJson(QString jsonString) {
...
void OAITrustedAdvisorCheckResult_categorySpecificSummary::fromJsonObject(QJsonObject json) {

    m_cost_optimizing_isValid = ::OpenAPI::fromJsonValue(m_cost_optimizing, json[QString("costOptimizing")]);
    m_cost_optimizing_isSet = !json[QString("costOptimizing")].isNull() && m_cost_optimizing_isValid;
}

QString OAITrustedAdvisorCheckResult_categorySpecificSummary::asJson() const {
...
QJsonObject OAITrustedAdvisorCheckResult_categorySpecificSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_cost_optimizing.isSet()) {
        obj.insert(QString("costOptimizing"), ::OpenAPI::toJsonValue(m_cost_optimizing));
    }
    return obj;
}

OAITrustedAdvisorCategorySpecificSummary_costOptimizing OAITrustedAdvisorCheckResult_categorySpecificSummary::getCostOptimizing() const {
    return m_cost_optimizing;
}
void OAITrustedAdvisorCheckResult_categorySpecificSummary::setCostOptimizing(const OAITrustedAdvisorCategorySpecificSummary_costOptimizing &cost_optimizing) {
    m_cost_optimizing = cost_optimizing;
    m_cost_optimizing_isSet = true;
}

bool OAITrustedAdvisorCheckResult_categorySpecificSummary::is_cost_optimizing_Set() const{
    return m_cost_optimizing_isSet;
}

bool OAITrustedAdvisorCheckResult_categorySpecificSummary::is_cost_optimizing_Valid() const{
    return m_cost_optimizing_isValid;
}

bool OAITrustedAdvisorCheckResult_categorySpecificSummary::isSet() const {
...
bool OAITrustedAdvisorCheckResult_categorySpecificSummary::isValid() const {
