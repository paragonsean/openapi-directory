...
OAIDescribeTrustedAdvisorChecksRequest::OAIDescribeTrustedAdvisorChecksRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTrustedAdvisorChecksRequest::OAIDescribeTrustedAdvisorChecksRequest() {
    this->initializeModel();
}

OAIDescribeTrustedAdvisorChecksRequest::~OAIDescribeTrustedAdvisorChecksRequest() {}

void OAIDescribeTrustedAdvisorChecksRequest::initializeModel() {

    m_language_isSet = false;
    m_language_isValid = false;
}

void OAIDescribeTrustedAdvisorChecksRequest::fromJson(QString jsonString) {
...
void OAIDescribeTrustedAdvisorChecksRequest::fromJsonObject(QJsonObject json) {

    m_language_isValid = ::OpenAPI::fromJsonValue(m_language, json[QString("language")]);
    m_language_isSet = !json[QString("language")].isNull() && m_language_isValid;
}

QString OAIDescribeTrustedAdvisorChecksRequest::asJson() const {
...
QJsonObject OAIDescribeTrustedAdvisorChecksRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_language_isSet) {
...
QString OAIDescribeTrustedAdvisorChecksRequest::getLanguage() const {
    return m_language;
}
void OAIDescribeTrustedAdvisorChecksRequest::setLanguage(const QString &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAIDescribeTrustedAdvisorChecksRequest::is_language_Set() const{
    return m_language_isSet;
}

bool OAIDescribeTrustedAdvisorChecksRequest::is_language_Valid() const{
    return m_language_isValid;
}

bool OAIDescribeTrustedAdvisorChecksRequest::isSet() const {
...
bool OAIDescribeTrustedAdvisorChecksRequest::isValid() const {
