...
/*
 * OAITrustedAdvisorCategorySpecificSummary.h
 *
 * The container for summary information that relates to the category of the Trusted Advisor check.
 */

#ifndef OAITrustedAdvisorCategorySpecificSummary_H
#define OAITrustedAdvisorCategorySpecificSummary_H
...
namespace OpenAPI {
class OAITrustedAdvisorCategorySpecificSummary_costOptimizing;

class OAITrustedAdvisorCategorySpecificSummary : public OAIObject {
public:
    OAITrustedAdvisorCategorySpecificSummary();
    OAITrustedAdvisorCategorySpecificSummary(QString json);
    ~OAITrustedAdvisorCategorySpecificSummary() override;
    ...
    OAITrustedAdvisorCategorySpecificSummary_costOptimizing getCostOptimizing() const;
    void setCostOptimizing(const OAITrustedAdvisorCategorySpecificSummary_costOptimizing &cost_optimizing);
    bool is_cost_optimizing_Set() const;
    bool is_cost_optimizing_Valid() const;
...
private:
    ...
    OAITrustedAdvisorCategorySpecificSummary_costOptimizing m_cost_optimizing;
    bool m_cost_optimizing_isSet;
    bool m_cost_optimizing_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITrustedAdvisorCategorySpecificSummary)

#endif // OAITrustedAdvisorCategorySpecificSummary_H
