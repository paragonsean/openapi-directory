...
/*
 * OAIDescribeTrustedAdvisorChecksResponse.h
 *
 * Information about the Trusted Advisor checks returned by the &lt;a&gt;DescribeTrustedAdvisorChecks&lt;/a&gt; operation.
 */

#ifndef OAIDescribeTrustedAdvisorChecksResponse_H
#define OAIDescribeTrustedAdvisorChecksResponse_H
...
class OAIDescribeTrustedAdvisorChecksResponse : public OAIObject {
public:
    OAIDescribeTrustedAdvisorChecksResponse();
    OAIDescribeTrustedAdvisorChecksResponse(QString json);
    ~OAIDescribeTrustedAdvisorChecksResponse() override;
    ...
    QList getChecks() const;
    void setChecks(const QList &checks);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTrustedAdvisorChecksResponse)

#endif // OAIDescribeTrustedAdvisorChecksResponse_H
