...
/*
 * OAICaseDetails_recentCommunications.h
 *
 * 
 */

#ifndef OAICaseDetails_recentCommunications_H
#define OAICaseDetails_recentCommunications_H
...
class OAICaseDetails_recentCommunications : public OAIObject {
public:
    OAICaseDetails_recentCommunications();
    OAICaseDetails_recentCommunications(QString json);
    ~OAICaseDetails_recentCommunications() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICaseDetails_recentCommunications)

#endif // OAICaseDetails_recentCommunications_H
