...
/*
 * OAIAddAttachmentsToSetResponse.h
 *
 * The ID and expiry time of the attachment set returned by the &lt;a&gt;AddAttachmentsToSet&lt;/a&gt; operation.
 */

#ifndef OAIAddAttachmentsToSetResponse_H
#define OAIAddAttachmentsToSetResponse_H
...
class OAIAddAttachmentsToSetResponse : public OAIObject {
public:
    OAIAddAttachmentsToSetResponse();
    OAIAddAttachmentsToSetResponse(QString json);
    ~OAIAddAttachmentsToSetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddAttachmentsToSetResponse)

#endif // OAIAddAttachmentsToSetResponse_H
