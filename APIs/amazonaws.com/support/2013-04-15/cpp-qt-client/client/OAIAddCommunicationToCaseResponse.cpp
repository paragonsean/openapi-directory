...
OAIAddCommunicationToCaseResponse::OAIAddCommunicationToCaseResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddCommunicationToCaseResponse::OAIAddCommunicationToCaseResponse() {
    this->initializeModel();
}

OAIAddCommunicationToCaseResponse::~OAIAddCommunicationToCaseResponse() {}

void OAIAddCommunicationToCaseResponse::initializeModel() {

    m_result_isSet = false;
    m_result_isValid = false;
}

void OAIAddCommunicationToCaseResponse::fromJson(QString jsonString) {
...
void OAIAddCommunicationToCaseResponse::fromJsonObject(QJsonObject json) {

    m_result_isValid = ::OpenAPI::fromJsonValue(m_result, json[QString("result")]);
    m_result_isSet = !json[QString("result")].isNull() && m_result_isValid;
}

QString OAIAddCommunicationToCaseResponse::asJson() const {
...
QJsonObject OAIAddCommunicationToCaseResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_result_isSet) {
...
bool OAIAddCommunicationToCaseResponse::getResult() const {
    return m_result;
}
void OAIAddCommunicationToCaseResponse::setResult(const bool &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIAddCommunicationToCaseResponse::is_result_Set() const{
    return m_result_isSet;
}

bool OAIAddCommunicationToCaseResponse::is_result_Valid() const{
    return m_result_isValid;
}

bool OAIAddCommunicationToCaseResponse::isSet() const {
...
bool OAIAddCommunicationToCaseResponse::isValid() const {
