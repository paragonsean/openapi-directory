...
OAIAddAttachmentsToSetResponse::OAIAddAttachmentsToSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddAttachmentsToSetResponse::OAIAddAttachmentsToSetResponse() {
    this->initializeModel();
}

OAIAddAttachmentsToSetResponse::~OAIAddAttachmentsToSetResponse() {}

void OAIAddAttachmentsToSetResponse::initializeModel() {
...
void OAIAddAttachmentsToSetResponse::fromJson(QString jsonString) {
...
void OAIAddAttachmentsToSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAddAttachmentsToSetResponse::asJson() const {
...
QJsonObject OAIAddAttachmentsToSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddAttachmentsToSetResponse::getAttachmentSetId() const {
    return m_attachment_set_id;
}
void OAIAddAttachmentsToSetResponse::setAttachmentSetId(const QString &attachment_set_id) {
    m_attachment_set_id = attachment_set_id;
    m_attachment_set_id_isSet = true;
}

bool OAIAddAttachmentsToSetResponse::is_attachment_set_id_Set() const{
    return m_attachment_set_id_isSet;
}

bool OAIAddAttachmentsToSetResponse::is_attachment_set_id_Valid() const{
    return m_attachment_set_id_isValid;
}

QString OAIAddAttachmentsToSetResponse::getExpiryTime() const {
    return m_expiry_time;
}
void OAIAddAttachmentsToSetResponse::setExpiryTime(const QString &expiry_time) {
    m_expiry_time = expiry_time;
    m_expiry_time_isSet = true;
}

bool OAIAddAttachmentsToSetResponse::is_expiry_time_Set() const{
    return m_expiry_time_isSet;
}

bool OAIAddAttachmentsToSetResponse::is_expiry_time_Valid() const{
    return m_expiry_time_isValid;
}

bool OAIAddAttachmentsToSetResponse::isSet() const {
...
bool OAIAddAttachmentsToSetResponse::isValid() const {
