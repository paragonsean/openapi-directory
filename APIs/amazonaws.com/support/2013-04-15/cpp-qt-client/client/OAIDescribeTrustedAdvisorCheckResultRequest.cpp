...
OAIDescribeTrustedAdvisorCheckResultRequest::OAIDescribeTrustedAdvisorCheckResultRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTrustedAdvisorCheckResultRequest::OAIDescribeTrustedAdvisorCheckResultRequest() {
    this->initializeModel();
}

OAIDescribeTrustedAdvisorCheckResultRequest::~OAIDescribeTrustedAdvisorCheckResultRequest() {}

void OAIDescribeTrustedAdvisorCheckResultRequest::initializeModel() {
...
void OAIDescribeTrustedAdvisorCheckResultRequest::fromJson(QString jsonString) {
...
void OAIDescribeTrustedAdvisorCheckResultRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeTrustedAdvisorCheckResultRequest::asJson() const {
...
QJsonObject OAIDescribeTrustedAdvisorCheckResultRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_check_id_isSet) {
...
QString OAIDescribeTrustedAdvisorCheckResultRequest::getCheckId() const {
    return m_check_id;
}
void OAIDescribeTrustedAdvisorCheckResultRequest::setCheckId(const QString &check_id) {
    m_check_id = check_id;
    m_check_id_isSet = true;
}

bool OAIDescribeTrustedAdvisorCheckResultRequest::is_check_id_Set() const{
    return m_check_id_isSet;
}

bool OAIDescribeTrustedAdvisorCheckResultRequest::is_check_id_Valid() const{
    return m_check_id_isValid;
}

QString OAIDescribeTrustedAdvisorCheckResultRequest::getLanguage() const {
    return m_language;
}
void OAIDescribeTrustedAdvisorCheckResultRequest::setLanguage(const QString &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAIDescribeTrustedAdvisorCheckResultRequest::is_language_Set() const{
    return m_language_isSet;
}

bool OAIDescribeTrustedAdvisorCheckResultRequest::is_language_Valid() const{
    return m_language_isValid;
}

bool OAIDescribeTrustedAdvisorCheckResultRequest::isSet() const {
...
bool OAIDescribeTrustedAdvisorCheckResultRequest::isValid() const {
