...
#ifndef OAIDateInterval_H
#define OAIDateInterval_H
...
class OAIDateInterval : public OAIObject {
public:
    OAIDateInterval();
    OAIDateInterval(QString json);
    ~OAIDateInterval() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDateInterval)

#endif // OAIDateInterval_H
