...
/*
 * OAIDescribeCreateCaseOptionsRequest.h
 *
 * 
 */

#ifndef OAIDescribeCreateCaseOptionsRequest_H
#define OAIDescribeCreateCaseOptionsRequest_H
...
class OAIDescribeCreateCaseOptionsRequest : public OAIObject {
public:
    OAIDescribeCreateCaseOptionsRequest();
    OAIDescribeCreateCaseOptionsRequest(QString json);
    ~OAIDescribeCreateCaseOptionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCreateCaseOptionsRequest)

#endif // OAIDescribeCreateCaseOptionsRequest_H
