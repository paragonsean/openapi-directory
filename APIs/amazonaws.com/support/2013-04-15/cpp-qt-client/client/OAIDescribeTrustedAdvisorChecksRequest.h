...
/*
 * OAIDescribeTrustedAdvisorChecksRequest.h
 *
 * 
 */

#ifndef OAIDescribeTrustedAdvisorChecksRequest_H
#define OAIDescribeTrustedAdvisorChecksRequest_H
...
class OAIDescribeTrustedAdvisorChecksRequest : public OAIObject {
public:
    OAIDescribeTrustedAdvisorChecksRequest();
    OAIDescribeTrustedAdvisorChecksRequest(QString json);
    ~OAIDescribeTrustedAdvisorChecksRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTrustedAdvisorChecksRequest)

#endif // OAIDescribeTrustedAdvisorChecksRequest_H
