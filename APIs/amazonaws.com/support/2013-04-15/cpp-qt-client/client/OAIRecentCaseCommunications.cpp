...
#include "OAIRecentCaseCommunications.h"
...
OAIRecentCaseCommunications::OAIRecentCaseCommunications(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecentCaseCommunications::OAIRecentCaseCommunications() {
    this->initializeModel();
}

OAIRecentCaseCommunications::~OAIRecentCaseCommunications() {}

void OAIRecentCaseCommunications::initializeModel() {
...
void OAIRecentCaseCommunications::fromJson(QString jsonString) {
...
void OAIRecentCaseCommunications::fromJsonObject(QJsonObject json) {
...
QString OAIRecentCaseCommunications::asJson() const {
...
QJsonObject OAIRecentCaseCommunications::asJsonObject() const {
    QJsonObject obj;
...
QList OAIRecentCaseCommunications::getCommunications() const {
    return m_communications;
}
void OAIRecentCaseCommunications::setCommunications(const QList &communications) {
    m_communications = communications;
    m_communications_isSet = true;
}

bool OAIRecentCaseCommunications::is_communications_Set() const{
    return m_communications_isSet;
}

bool OAIRecentCaseCommunications::is_communications_Valid() const{
    return m_communications_isValid;
}

QString OAIRecentCaseCommunications::getNextToken() const {
    return m_next_token;
}
void OAIRecentCaseCommunications::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIRecentCaseCommunications::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIRecentCaseCommunications::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIRecentCaseCommunications::isSet() const {
...
bool OAIRecentCaseCommunications::isValid() const {
