...
#include "OAITrustedAdvisorCategorySpecificSummary.h"
...
OAITrustedAdvisorCategorySpecificSummary::OAITrustedAdvisorCategorySpecificSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrustedAdvisorCategorySpecificSummary::OAITrustedAdvisorCategorySpecificSummary() {
    this->initializeModel();
}

OAITrustedAdvisorCategorySpecificSummary::~OAITrustedAdvisorCategorySpecificSummary() {}

void OAITrustedAdvisorCategorySpecificSummary::initializeModel() {

    m_cost_optimizing_isSet = false;
    m_cost_optimizing_isValid = false;
}

void OAITrustedAdvisorCategorySpecificSummary::fromJson(QString jsonString) {
...
void OAITrustedAdvisorCategorySpecificSummary::fromJsonObject(QJsonObject json) {
...
QString OAITrustedAdvisorCategorySpecificSummary::asJson() const {
...
QJsonObject OAITrustedAdvisorCategorySpecificSummary::asJsonObject() const {
    QJsonObject obj;
...
OAITrustedAdvisorCategorySpecificSummary_costOptimizing OAITrustedAdvisorCategorySpecificSummary::getCostOptimizing() const {
    return m_cost_optimizing;
}
void OAITrustedAdvisorCategorySpecificSummary::setCostOptimizing(const OAITrustedAdvisorCategorySpecificSummary_costOptimizing &cost_optimizing) {
    m_cost_optimizing = cost_optimizing;
    m_cost_optimizing_isSet = true;
}

bool OAITrustedAdvisorCategorySpecificSummary::is_cost_optimizing_Set() const{
    return m_cost_optimizing_isSet;
}

bool OAITrustedAdvisorCategorySpecificSummary::is_cost_optimizing_Valid() const{
    return m_cost_optimizing_isValid;
}

bool OAITrustedAdvisorCategorySpecificSummary::isSet() const {
...
bool OAITrustedAdvisorCategorySpecificSummary::isValid() const {
