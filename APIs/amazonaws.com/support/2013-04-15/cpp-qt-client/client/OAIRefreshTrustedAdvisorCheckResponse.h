...
/*
 * OAIRefreshTrustedAdvisorCheckResponse.h
 *
 * The current refresh status of a Trusted Advisor check.
 */

#ifndef OAIRefreshTrustedAdvisorCheckResponse_H
#define OAIRefreshTrustedAdvisorCheckResponse_H
...
namespace OpenAPI {
class OAIRefreshTrustedAdvisorCheckResponse_status;

class OAIRefreshTrustedAdvisorCheckResponse : public OAIObject {
public:
    OAIRefreshTrustedAdvisorCheckResponse();
    OAIRefreshTrustedAdvisorCheckResponse(QString json);
    ~OAIRefreshTrustedAdvisorCheckResponse() override;
    ...
    OAIRefreshTrustedAdvisorCheckResponse_status getStatus() const;
    void setStatus(const OAIRefreshTrustedAdvisorCheckResponse_status &status);
...
private:
    ...
    OAIRefreshTrustedAdvisorCheckResponse_status m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefreshTrustedAdvisorCheckResponse)

#endif // OAIRefreshTrustedAdvisorCheckResponse_H
