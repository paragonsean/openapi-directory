...
OAIDescribeAttachmentRequest::OAIDescribeAttachmentRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAttachmentRequest::OAIDescribeAttachmentRequest() {
    this->initializeModel();
}

OAIDescribeAttachmentRequest::~OAIDescribeAttachmentRequest() {}

void OAIDescribeAttachmentRequest::initializeModel() {

    m_attachment_id_isSet = false;
    m_attachment_id_isValid = false;
}

void OAIDescribeAttachmentRequest::fromJson(QString jsonString) {
...
void OAIDescribeAttachmentRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeAttachmentRequest::asJson() const {
...
QJsonObject OAIDescribeAttachmentRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeAttachmentRequest::getAttachmentId() const {
    return m_attachment_id;
}
void OAIDescribeAttachmentRequest::setAttachmentId(const QString &attachment_id) {
    m_attachment_id = attachment_id;
    m_attachment_id_isSet = true;
}

bool OAIDescribeAttachmentRequest::is_attachment_id_Set() const{
    return m_attachment_id_isSet;
}

bool OAIDescribeAttachmentRequest::is_attachment_id_Valid() const{
    return m_attachment_id_isValid;
}

bool OAIDescribeAttachmentRequest::isSet() const {
...
bool OAIDescribeAttachmentRequest::isValid() const {
