...
OAICaseDetails_recentCommunications::OAICaseDetails_recentCommunications(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICaseDetails_recentCommunications::OAICaseDetails_recentCommunications() {
    this->initializeModel();
}

OAICaseDetails_recentCommunications::~OAICaseDetails_recentCommunications() {}

void OAICaseDetails_recentCommunications::initializeModel() {

    m_communications_isSet = false;
    m_communications_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAICaseDetails_recentCommunications::fromJson(QString jsonString) {
...
void OAICaseDetails_recentCommunications::fromJsonObject(QJsonObject json) {

    m_communications_isValid = ::OpenAPI::fromJsonValue(m_communications, json[QString("communications")]);
    m_communications_isSet = !json[QString("communications")].isNull() && m_communications_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAICaseDetails_recentCommunications::asJson() const {
...
QJsonObject OAICaseDetails_recentCommunications::asJsonObject() const {
    QJsonObject obj;
    if (m_communications.isSet()) {
        obj.insert(QString("communications"), ::OpenAPI::toJsonValue(m_communications));
    }
...
QList OAICaseDetails_recentCommunications::getCommunications() const {
    return m_communications;
}
void OAICaseDetails_recentCommunications::setCommunications(const QList &communications) {
    m_communications = communications;
    m_communications_isSet = true;
}

bool OAICaseDetails_recentCommunications::is_communications_Set() const{
    return m_communications_isSet;
}

bool OAICaseDetails_recentCommunications::is_communications_Valid() const{
    return m_communications_isValid;
}

QString OAICaseDetails_recentCommunications::getNextToken() const {
    return m_next_token;
}
void OAICaseDetails_recentCommunications::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAICaseDetails_recentCommunications::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAICaseDetails_recentCommunications::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAICaseDetails_recentCommunications::isSet() const {
...
bool OAICaseDetails_recentCommunications::isValid() const {
