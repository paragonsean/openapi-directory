...
#include "OAITrustedAdvisorCheckRefreshStatus.h"
...
OAITrustedAdvisorCheckRefreshStatus::OAITrustedAdvisorCheckRefreshStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrustedAdvisorCheckRefreshStatus::OAITrustedAdvisorCheckRefreshStatus() {
    this->initializeModel();
}

OAITrustedAdvisorCheckRefreshStatus::~OAITrustedAdvisorCheckRefreshStatus() {}

void OAITrustedAdvisorCheckRefreshStatus::initializeModel() {
...
void OAITrustedAdvisorCheckRefreshStatus::fromJson(QString jsonString) {
...
void OAITrustedAdvisorCheckRefreshStatus::fromJsonObject(QJsonObject json) {
...
QString OAITrustedAdvisorCheckRefreshStatus::asJson() const {
...
QJsonObject OAITrustedAdvisorCheckRefreshStatus::asJsonObject() const {
    QJsonObject obj;
    if (m_check_id_isSet) {
...
QString OAITrustedAdvisorCheckRefreshStatus::getCheckId() const {
    return m_check_id;
}
void OAITrustedAdvisorCheckRefreshStatus::setCheckId(const QString &check_id) {
    m_check_id = check_id;
    m_check_id_isSet = true;
}

bool OAITrustedAdvisorCheckRefreshStatus::is_check_id_Set() const{
    return m_check_id_isSet;
}

bool OAITrustedAdvisorCheckRefreshStatus::is_check_id_Valid() const{
    return m_check_id_isValid;
}

QString OAITrustedAdvisorCheckRefreshStatus::getStatus() const {
    return m_status;
}
void OAITrustedAdvisorCheckRefreshStatus::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAITrustedAdvisorCheckRefreshStatus::is_status_Set() const{
    return m_status_isSet;
}

bool OAITrustedAdvisorCheckRefreshStatus::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAITrustedAdvisorCheckRefreshStatus::getMillisUntilNextRefreshable() const {
    return m_millis_until_next_refreshable;
}
void OAITrustedAdvisorCheckRefreshStatus::setMillisUntilNextRefreshable(const qint32 &millis_until_next_refreshable) {
    m_millis_until_next_refreshable = millis_until_next_refreshable;
    m_millis_until_next_refreshable_isSet = true;
}

bool OAITrustedAdvisorCheckRefreshStatus::is_millis_until_next_refreshable_Set() const{
    return m_millis_until_next_refreshable_isSet;
}

bool OAITrustedAdvisorCheckRefreshStatus::is_millis_until_next_refreshable_Valid() const{
    return m_millis_until_next_refreshable_isValid;
}

bool OAITrustedAdvisorCheckRefreshStatus::isSet() const {
...
bool OAITrustedAdvisorCheckRefreshStatus::isValid() const {
