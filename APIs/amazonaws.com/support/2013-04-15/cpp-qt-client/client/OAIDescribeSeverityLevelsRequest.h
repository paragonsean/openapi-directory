...
/*
 * OAIDescribeSeverityLevelsRequest.h
 *
 * 
 */

#ifndef OAIDescribeSeverityLevelsRequest_H
#define OAIDescribeSeverityLevelsRequest_H
...
class OAIDescribeSeverityLevelsRequest : public OAIObject {
public:
    OAIDescribeSeverityLevelsRequest();
    OAIDescribeSeverityLevelsRequest(QString json);
    ~OAIDescribeSeverityLevelsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSeverityLevelsRequest)

#endif // OAIDescribeSeverityLevelsRequest_H
