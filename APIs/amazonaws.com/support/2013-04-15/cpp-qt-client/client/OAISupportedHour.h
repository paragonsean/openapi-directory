...
#ifndef OAISupportedHour_H
#define OAISupportedHour_H
...
class OAISupportedHour : public OAIObject {
public:
    OAISupportedHour();
    OAISupportedHour(QString json);
    ~OAISupportedHour() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupportedHour)

#endif // OAISupportedHour_H
