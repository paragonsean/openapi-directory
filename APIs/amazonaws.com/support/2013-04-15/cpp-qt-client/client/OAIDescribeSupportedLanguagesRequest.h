...
/*
 * OAIDescribeSupportedLanguagesRequest.h
 *
 * 
 */

#ifndef OAIDescribeSupportedLanguagesRequest_H
#define OAIDescribeSupportedLanguagesRequest_H
...
class OAIDescribeSupportedLanguagesRequest : public OAIObject {
public:
    OAIDescribeSupportedLanguagesRequest();
    OAIDescribeSupportedLanguagesRequest(QString json);
    ~OAIDescribeSupportedLanguagesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSupportedLanguagesRequest)

#endif // OAIDescribeSupportedLanguagesRequest_H
