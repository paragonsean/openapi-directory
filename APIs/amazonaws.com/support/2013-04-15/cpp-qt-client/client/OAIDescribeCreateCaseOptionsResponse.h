...
/*
 * OAIDescribeCreateCaseOptionsResponse.h
 *
 * 
 */

#ifndef OAIDescribeCreateCaseOptionsResponse_H
#define OAIDescribeCreateCaseOptionsResponse_H
...
class OAIDescribeCreateCaseOptionsResponse : public OAIObject {
public:
    OAIDescribeCreateCaseOptionsResponse();
    OAIDescribeCreateCaseOptionsResponse(QString json);
    ~OAIDescribeCreateCaseOptionsResponse() override;
    ...
    QString getLanguageAvailability() const;
    void setLanguageAvailability(const QString &language_availability);
    bool is_language_availability_Set() const;
    bool is_language_availability_Valid() const;

    QList getCommunicationTypes() const;
    void setCommunicationTypes(const QList &communication_types);
    bool is_communication_types_Set() const;
    bool is_communication_types_Valid() const;
...
private:
    ...
    QString m_language_availability;
    bool m_language_availability_isSet;
    bool m_language_availability_isValid;

    QList m_communication_types;
    bool m_communication_types_isSet;
    bool m_communication_types_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCreateCaseOptionsResponse)

#endif // OAIDescribeCreateCaseOptionsResponse_H
