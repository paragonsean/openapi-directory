...
/*
 * OAITrustedAdvisorCheckResult.h
 *
 * The results of a Trusted Advisor check returned by &lt;a&gt;DescribeTrustedAdvisorCheckResult&lt;/a&gt;.
 */

#ifndef OAITrustedAdvisorCheckResult_H
#define OAITrustedAdvisorCheckResult_H
...
class OAITrustedAdvisorCheckResult : public OAIObject {
public:
    OAITrustedAdvisorCheckResult();
    OAITrustedAdvisorCheckResult(QString json);
    ~OAITrustedAdvisorCheckResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrustedAdvisorCheckResult)

#endif // OAITrustedAdvisorCheckResult_H
