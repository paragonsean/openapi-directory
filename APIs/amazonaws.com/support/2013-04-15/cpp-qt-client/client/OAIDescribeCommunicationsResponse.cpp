...
OAIDescribeCommunicationsResponse::OAIDescribeCommunicationsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCommunicationsResponse::OAIDescribeCommunicationsResponse() {
    this->initializeModel();
}

OAIDescribeCommunicationsResponse::~OAIDescribeCommunicationsResponse() {}

void OAIDescribeCommunicationsResponse::initializeModel() {
...
void OAIDescribeCommunicationsResponse::fromJson(QString jsonString) {
...
void OAIDescribeCommunicationsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeCommunicationsResponse::asJson() const {
...
QJsonObject OAIDescribeCommunicationsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeCommunicationsResponse::getCommunications() const {
    return m_communications;
}
void OAIDescribeCommunicationsResponse::setCommunications(const QList &communications) {
    m_communications = communications;
    m_communications_isSet = true;
}

bool OAIDescribeCommunicationsResponse::is_communications_Set() const{
    return m_communications_isSet;
}

bool OAIDescribeCommunicationsResponse::is_communications_Valid() const{
    return m_communications_isValid;
}

QString OAIDescribeCommunicationsResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeCommunicationsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeCommunicationsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeCommunicationsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeCommunicationsResponse::isSet() const {
...
bool OAIDescribeCommunicationsResponse::isValid() const {
