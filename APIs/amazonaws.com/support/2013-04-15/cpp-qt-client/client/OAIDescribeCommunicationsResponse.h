...
/*
 * OAIDescribeCommunicationsResponse.h
 *
 * The communications returned by the &lt;a&gt;DescribeCommunications&lt;/a&gt; operation.
 */

#ifndef OAIDescribeCommunicationsResponse_H
#define OAIDescribeCommunicationsResponse_H
...
class OAIDescribeCommunicationsResponse : public OAIObject {
public:
    OAIDescribeCommunicationsResponse();
    OAIDescribeCommunicationsResponse(QString json);
    ~OAIDescribeCommunicationsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCommunicationsResponse)

#endif // OAIDescribeCommunicationsResponse_H
