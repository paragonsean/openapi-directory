...
/*
 * OAITrustedAdvisorCheckDescription.h
 *
 * The description and metadata for a Trusted Advisor check.
 */

#ifndef OAITrustedAdvisorCheckDescription_H
#define OAITrustedAdvisorCheckDescription_H
...
class OAITrustedAdvisorCheckDescription : public OAIObject {
public:
    OAITrustedAdvisorCheckDescription();
    OAITrustedAdvisorCheckDescription(QString json);
    ~OAITrustedAdvisorCheckDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrustedAdvisorCheckDescription)

#endif // OAITrustedAdvisorCheckDescription_H
