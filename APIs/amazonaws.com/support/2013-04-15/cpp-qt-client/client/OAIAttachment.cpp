...
QString OAIAttachment::getData() const {
    return m_data;
}
void OAIAttachment::setData(const QString &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIAttachment::is_data_Set() const{
    return m_data_isSet;
}

bool OAIAttachment::is_data_Valid() const{
