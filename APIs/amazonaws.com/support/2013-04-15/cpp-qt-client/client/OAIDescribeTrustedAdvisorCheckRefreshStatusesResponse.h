...
/*
 * OAIDescribeTrustedAdvisorCheckRefreshStatusesResponse.h
 *
 * The statuses of the Trusted Advisor checks returned by the &lt;a&gt;DescribeTrustedAdvisorCheckRefreshStatuses&lt;/a&gt; operation.
 */

#ifndef OAIDescribeTrustedAdvisorCheckRefreshStatusesResponse_H
#define OAIDescribeTrustedAdvisorCheckRefreshStatusesResponse_H
...
class OAIDescribeTrustedAdvisorCheckRefreshStatusesResponse : public OAIObject {
public:
    OAIDescribeTrustedAdvisorCheckRefreshStatusesResponse();
    OAIDescribeTrustedAdvisorCheckRefreshStatusesResponse(QString json);
    ~OAIDescribeTrustedAdvisorCheckRefreshStatusesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTrustedAdvisorCheckRefreshStatusesResponse)

#endif // OAIDescribeTrustedAdvisorCheckRefreshStatusesResponse_H
