...
OAIDescribeAttachmentResponse::OAIDescribeAttachmentResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAttachmentResponse::OAIDescribeAttachmentResponse() {
    this->initializeModel();
}

OAIDescribeAttachmentResponse::~OAIDescribeAttachmentResponse() {}

void OAIDescribeAttachmentResponse::initializeModel() {

    m_attachment_isSet = false;
    m_attachment_isValid = false;
}

void OAIDescribeAttachmentResponse::fromJson(QString jsonString) {
...
void OAIDescribeAttachmentResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeAttachmentResponse::asJson() const {
...
QJsonObject OAIDescribeAttachmentResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeAttachmentResponse_attachment OAIDescribeAttachmentResponse::getAttachment() const {
    return m_attachment;
}
void OAIDescribeAttachmentResponse::setAttachment(const OAIDescribeAttachmentResponse_attachment &attachment) {
    m_attachment = attachment;
    m_attachment_isSet = true;
}

bool OAIDescribeAttachmentResponse::is_attachment_Set() const{
    return m_attachment_isSet;
}

bool OAIDescribeAttachmentResponse::is_attachment_Valid() const{
    return m_attachment_isValid;
}

bool OAIDescribeAttachmentResponse::isSet() const {
...
bool OAIDescribeAttachmentResponse::isValid() const {
