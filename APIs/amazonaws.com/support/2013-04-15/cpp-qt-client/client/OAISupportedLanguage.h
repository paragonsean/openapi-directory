...
#ifndef OAISupportedLanguage_H
#define OAISupportedLanguage_H
...
class OAISupportedLanguage : public OAIObject {
public:
    OAISupportedLanguage();
    OAISupportedLanguage(QString json);
    ~OAISupportedLanguage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupportedLanguage)

#endif // OAISupportedLanguage_H
