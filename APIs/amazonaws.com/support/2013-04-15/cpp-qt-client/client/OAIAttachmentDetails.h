...
#ifndef OAIAttachmentDetails_H
#define OAIAttachmentDetails_H
...
class OAIAttachmentDetails : public OAIObject {
public:
    OAIAttachmentDetails();
    OAIAttachmentDetails(QString json);
    ~OAIAttachmentDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachmentDetails)

#endif // OAIAttachmentDetails_H
