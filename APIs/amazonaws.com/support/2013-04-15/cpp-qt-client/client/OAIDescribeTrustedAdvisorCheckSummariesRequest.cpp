...
OAIDescribeTrustedAdvisorCheckSummariesRequest::OAIDescribeTrustedAdvisorCheckSummariesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTrustedAdvisorCheckSummariesRequest::OAIDescribeTrustedAdvisorCheckSummariesRequest() {
    this->initializeModel();
}

OAIDescribeTrustedAdvisorCheckSummariesRequest::~OAIDescribeTrustedAdvisorCheckSummariesRequest() {}

void OAIDescribeTrustedAdvisorCheckSummariesRequest::initializeModel() {

    m_check_ids_isSet = false;
    m_check_ids_isValid = false;
}

void OAIDescribeTrustedAdvisorCheckSummariesRequest::fromJson(QString jsonString) {
...
void OAIDescribeTrustedAdvisorCheckSummariesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeTrustedAdvisorCheckSummariesRequest::asJson() const {
...
QJsonObject OAIDescribeTrustedAdvisorCheckSummariesRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeTrustedAdvisorCheckSummariesRequest::getCheckIds() const {
    return m_check_ids;
}
void OAIDescribeTrustedAdvisorCheckSummariesRequest::setCheckIds(const QList &check_ids) {
    m_check_ids = check_ids;
    m_check_ids_isSet = true;
}

bool OAIDescribeTrustedAdvisorCheckSummariesRequest::is_check_ids_Set() const{
    return m_check_ids_isSet;
}

bool OAIDescribeTrustedAdvisorCheckSummariesRequest::is_check_ids_Valid() const{
    return m_check_ids_isValid;
}

bool OAIDescribeTrustedAdvisorCheckSummariesRequest::isSet() const {
...
bool OAIDescribeTrustedAdvisorCheckSummariesRequest::isValid() const {
