...
/*
 * OAIRefreshTrustedAdvisorCheckResponse_status.h
 *
 * 
 */

#ifndef OAIRefreshTrustedAdvisorCheckResponse_status_H
#define OAIRefreshTrustedAdvisorCheckResponse_status_H
...
class OAIRefreshTrustedAdvisorCheckResponse_status : public OAIObject {
public:
    OAIRefreshTrustedAdvisorCheckResponse_status();
    OAIRefreshTrustedAdvisorCheckResponse_status(QString json);
    ~OAIRefreshTrustedAdvisorCheckResponse_status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefreshTrustedAdvisorCheckResponse_status)

#endif // OAIRefreshTrustedAdvisorCheckResponse_status_H
