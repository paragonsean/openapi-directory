...
OAIDescribeTrustedAdvisorCheckSummariesResponse::OAIDescribeTrustedAdvisorCheckSummariesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTrustedAdvisorCheckSummariesResponse::OAIDescribeTrustedAdvisorCheckSummariesResponse() {
    this->initializeModel();
}

OAIDescribeTrustedAdvisorCheckSummariesResponse::~OAIDescribeTrustedAdvisorCheckSummariesResponse() {}

void OAIDescribeTrustedAdvisorCheckSummariesResponse::initializeModel() {

    m_summaries_isSet = false;
    m_summaries_isValid = false;
}

void OAIDescribeTrustedAdvisorCheckSummariesResponse::fromJson(QString jsonString) {
...
void OAIDescribeTrustedAdvisorCheckSummariesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeTrustedAdvisorCheckSummariesResponse::asJson() const {
...
QJsonObject OAIDescribeTrustedAdvisorCheckSummariesResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeTrustedAdvisorCheckSummariesResponse::getSummaries() const {
    return m_summaries;
}
void OAIDescribeTrustedAdvisorCheckSummariesResponse::setSummaries(const QList &summaries) {
    m_summaries = summaries;
    m_summaries_isSet = true;
}

bool OAIDescribeTrustedAdvisorCheckSummariesResponse::is_summaries_Set() const{
    return m_summaries_isSet;
}

bool OAIDescribeTrustedAdvisorCheckSummariesResponse::is_summaries_Valid() const{
    return m_summaries_isValid;
}

bool OAIDescribeTrustedAdvisorCheckSummariesResponse::isSet() const {
...
bool OAIDescribeTrustedAdvisorCheckSummariesResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_summaries_isValid && true;
}
