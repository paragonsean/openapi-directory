...
/*
 * OAIDescribeAttachmentRequest.h
 *
 * 
 */

#ifndef OAIDescribeAttachmentRequest_H
#define OAIDescribeAttachmentRequest_H
...
class OAIDescribeAttachmentRequest : public OAIObject {
public:
    OAIDescribeAttachmentRequest();
    OAIDescribeAttachmentRequest(QString json);
    ~OAIDescribeAttachmentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAttachmentRequest)

#endif // OAIDescribeAttachmentRequest_H
