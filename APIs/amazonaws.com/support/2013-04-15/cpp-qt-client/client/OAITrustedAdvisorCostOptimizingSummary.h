...
/*
 * OAITrustedAdvisorCostOptimizingSummary.h
 *
 * The estimated cost savings that might be realized if the recommended operations are taken.
 */

#ifndef OAITrustedAdvisorCostOptimizingSummary_H
#define OAITrustedAdvisorCostOptimizingSummary_H
...
class OAITrustedAdvisorCostOptimizingSummary : public OAIObject {
public:
    OAITrustedAdvisorCostOptimizingSummary();
    OAITrustedAdvisorCostOptimizingSummary(QString json);
    ~OAITrustedAdvisorCostOptimizingSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrustedAdvisorCostOptimizingSummary)

#endif // OAITrustedAdvisorCostOptimizingSummary_H
