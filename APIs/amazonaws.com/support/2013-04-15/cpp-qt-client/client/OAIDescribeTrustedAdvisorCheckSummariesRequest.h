...
/*
 * OAIDescribeTrustedAdvisorCheckSummariesRequest.h
 *
 * 
 */

#ifndef OAIDescribeTrustedAdvisorCheckSummariesRequest_H
#define OAIDescribeTrustedAdvisorCheckSummariesRequest_H
...
class OAIDescribeTrustedAdvisorCheckSummariesRequest : public OAIObject {
public:
    OAIDescribeTrustedAdvisorCheckSummariesRequest();
    OAIDescribeTrustedAdvisorCheckSummariesRequest(QString json);
    ~OAIDescribeTrustedAdvisorCheckSummariesRequest() override;
    ...
    QList getCheckIds() const;
    void setCheckIds(const QList &check_ids);
    bool is_check_ids_Set() const;
    bool is_check_ids_Valid() const;
...
private:
    ...
    QList m_check_ids;
    bool m_check_ids_isSet;
    bool m_check_ids_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTrustedAdvisorCheckSummariesRequest)

#endif // OAIDescribeTrustedAdvisorCheckSummariesRequest_H
