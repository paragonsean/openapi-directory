...
/*
 * OAIAddAttachmentsToSetRequest.h
 *
 * 
 */

#ifndef OAIAddAttachmentsToSetRequest_H
#define OAIAddAttachmentsToSetRequest_H
...
class OAIAddAttachmentsToSetRequest : public OAIObject {
public:
    OAIAddAttachmentsToSetRequest();
    OAIAddAttachmentsToSetRequest(QString json);
    ~OAIAddAttachmentsToSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddAttachmentsToSetRequest)

#endif // OAIAddAttachmentsToSetRequest_H
