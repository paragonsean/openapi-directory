...
/*
 * OAIResolveCaseRequest.h
 *
 * 
 */

#ifndef OAIResolveCaseRequest_H
#define OAIResolveCaseRequest_H
...
class OAIResolveCaseRequest : public OAIObject {
public:
    OAIResolveCaseRequest();
    OAIResolveCaseRequest(QString json);
    ~OAIResolveCaseRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResolveCaseRequest)

#endif // OAIResolveCaseRequest_H
