...
OAIDescribeSeverityLevelsResponse::OAIDescribeSeverityLevelsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeSeverityLevelsResponse::OAIDescribeSeverityLevelsResponse() {
    this->initializeModel();
}

OAIDescribeSeverityLevelsResponse::~OAIDescribeSeverityLevelsResponse() {}

void OAIDescribeSeverityLevelsResponse::initializeModel() {

    m_severity_levels_isSet = false;
    m_severity_levels_isValid = false;
}

void OAIDescribeSeverityLevelsResponse::fromJson(QString jsonString) {
...
void OAIDescribeSeverityLevelsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeSeverityLevelsResponse::asJson() const {
...
QJsonObject OAIDescribeSeverityLevelsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeSeverityLevelsResponse::getSeverityLevels() const {
    return m_severity_levels;
}
void OAIDescribeSeverityLevelsResponse::setSeverityLevels(const QList &severity_levels) {
    m_severity_levels = severity_levels;
    m_severity_levels_isSet = true;
}

bool OAIDescribeSeverityLevelsResponse::is_severity_levels_Set() const{
    return m_severity_levels_isSet;
}

bool OAIDescribeSeverityLevelsResponse::is_severity_levels_Valid() const{
    return m_severity_levels_isValid;
}

bool OAIDescribeSeverityLevelsResponse::isSet() const {
...
bool OAIDescribeSeverityLevelsResponse::isValid() const {
