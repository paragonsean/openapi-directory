...
/*
 * OAIDescribeSupportedLanguagesResponse.h
 *
 * 
 */

#ifndef OAIDescribeSupportedLanguagesResponse_H
#define OAIDescribeSupportedLanguagesResponse_H
...
class OAIDescribeSupportedLanguagesResponse : public OAIObject {
public:
    OAIDescribeSupportedLanguagesResponse();
    OAIDescribeSupportedLanguagesResponse(QString json);
    ~OAIDescribeSupportedLanguagesResponse() override;
    ...
    QList getSupportedLanguages() const;
    void setSupportedLanguages(const QList &supported_languages);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSupportedLanguagesResponse)

#endif // OAIDescribeSupportedLanguagesResponse_H
