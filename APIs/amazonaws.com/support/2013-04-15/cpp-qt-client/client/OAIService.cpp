...
QList OAIService::getCategories() const {
    return m_categories;
}
void OAIService::setCategories(const QList &categories) {
    m_categories = categories;
    m_categories_isSet = true;
}

bool OAIService::is_categories_Set() const{
    return m_categories_isSet;
}

bool OAIService::is_categories_Valid() const{
