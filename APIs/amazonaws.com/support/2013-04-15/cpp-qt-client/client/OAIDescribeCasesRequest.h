...
/*
 * OAIDescribeCasesRequest.h
 *
 * 
 */

#ifndef OAIDescribeCasesRequest_H
#define OAIDescribeCasesRequest_H
...
class OAIDescribeCasesRequest : public OAIObject {
public:
    OAIDescribeCasesRequest();
    OAIDescribeCasesRequest(QString json);
    ~OAIDescribeCasesRequest() override;
    ...
    QList getCaseIdList() const;
    void setCaseIdList(const QList &case_id_list);
    bool is_case_id_list_Set() const;
    bool is_case_id_list_Valid() const;
    ...
    QString getAfterTime() const;
    void setAfterTime(const QString &after_time);
    bool is_after_time_Set() const;
    bool is_after_time_Valid() const;

    QString getBeforeTime() const;
    void setBeforeTime(const QString &before_time);
    bool is_before_time_Set() const;
    bool is_before_time_Valid() const;

    bool getIncludeResolvedCases() const;
    void setIncludeResolvedCases(const bool &include_resolved_cases);
    bool is_include_resolved_cases_Set() const;
    bool is_include_resolved_cases_Valid() const;
    ...
    void setIncludeCommunications(const bool &include_communications);
    bool is_include_communications_Set() const;
    bool is_include_communications_Valid() const;
...
private:
    ...
    QList m_case_id_list;
    bool m_case_id_list_isSet;
    bool m_case_id_list_isValid;

    QString m_display_id;
    bool m_display_id_isSet;
    bool m_display_id_isValid;

    QString m_after_time;
    bool m_after_time_isSet;
    bool m_after_time_isValid;

    QString m_before_time;
    bool m_before_time_isSet;
    bool m_before_time_isValid;

    bool m_include_resolved_cases;
    bool m_include_resolved_cases_isSet;
    bool m_include_resolved_cases_isValid;
    ...
    bool m_include_communications;
    bool m_include_communications_isSet;
    bool m_include_communications_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCasesRequest)

#endif // OAIDescribeCasesRequest_H
