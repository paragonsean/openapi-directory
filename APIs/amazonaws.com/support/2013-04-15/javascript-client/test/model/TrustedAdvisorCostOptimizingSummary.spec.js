...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.TrustedAdvisorCostOptimizingSummary();
  });
  ...
  describe('TrustedAdvisorCostOptimizingSummary', function() {
    it('should create an instance of TrustedAdvisorCostOptimizingSummary', function() {
      // uncomment below and update the code to test TrustedAdvisorCostOptimizingSummary
      //var instance = new AwsSupport.TrustedAdvisorCostOptimizingSummary();
      //expect(instance).to.be.a(AwsSupport.TrustedAdvisorCostOptimizingSummary);
    });
