...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeTrustedAdvisorCheckSummariesRequest();
  });
  ...
  describe('DescribeTrustedAdvisorCheckSummariesRequest', function() {
    it('should create an instance of DescribeTrustedAdvisorCheckSummariesRequest', function() {
      // uncomment below and update the code to test DescribeTrustedAdvisorCheckSummariesRequest
      //var instance = new AwsSupport.DescribeTrustedAdvisorCheckSummariesRequest();
      //expect(instance).to.be.a(AwsSupport.DescribeTrustedAdvisorCheckSummariesRequest);
    });
