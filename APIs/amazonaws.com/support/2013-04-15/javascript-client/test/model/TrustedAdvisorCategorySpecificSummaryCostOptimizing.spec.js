...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.TrustedAdvisorCategorySpecificSummaryCostOptimizing();
  });
  ...
  describe('TrustedAdvisorCategorySpecificSummaryCostOptimizing', function() {
    it('should create an instance of TrustedAdvisorCategorySpecificSummaryCostOptimizing', function() {
      // uncomment below and update the code to test TrustedAdvisorCategorySpecificSummaryCostOptimizing
      //var instance = new AwsSupport.TrustedAdvisorCategorySpecificSummaryCostOptimizing();
      //expect(instance).to.be.a(AwsSupport.TrustedAdvisorCategorySpecificSummaryCostOptimizing);
    });
    ...
    it('should have the property estimatedPercentMonthlySavings (base name: "estimatedPercentMonthlySavings")', function() {
      // uncomment below and update the code to test the property estimatedPercentMonthlySavings
      //var instance = new AwsSupport.TrustedAdvisorCategorySpecificSummaryCostOptimizing();
      //expect(instance).to.be();
    });
