...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeTrustedAdvisorCheckSummariesResponse();
  });
  ...
  describe('DescribeTrustedAdvisorCheckSummariesResponse', function() {
    it('should create an instance of DescribeTrustedAdvisorCheckSummariesResponse', function() {
      // uncomment below and update the code to test DescribeTrustedAdvisorCheckSummariesResponse
      //var instance = new AwsSupport.DescribeTrustedAdvisorCheckSummariesResponse();
      //expect(instance).to.be.a(AwsSupport.DescribeTrustedAdvisorCheckSummariesResponse);
    });
