...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeAttachmentResponse();
  });
  ...
  describe('DescribeAttachmentResponse', function() {
    it('should create an instance of DescribeAttachmentResponse', function() {
      // uncomment below and update the code to test DescribeAttachmentResponse
      //var instance = new AwsSupport.DescribeAttachmentResponse();
      //expect(instance).to.be.a(AwsSupport.DescribeAttachmentResponse);
    });
