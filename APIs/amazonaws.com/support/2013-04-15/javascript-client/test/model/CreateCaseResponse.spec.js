...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.CreateCaseResponse();
  });
  ...
  describe('CreateCaseResponse', function() {
    it('should create an instance of CreateCaseResponse', function() {
      // uncomment below and update the code to test CreateCaseResponse
      //var instance = new AwsSupport.CreateCaseResponse();
      //expect(instance).to.be.a(AwsSupport.CreateCaseResponse);
    });
