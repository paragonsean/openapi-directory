...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.SupportedHour();
  });
  ...
  describe('SupportedHour', function() {
    it('should create an instance of SupportedHour', function() {
      // uncomment below and update the code to test SupportedHour
      //var instance = new AwsSupport.SupportedHour();
      //expect(instance).to.be.a(AwsSupport.SupportedHour);
    });
