...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.AttachmentDetails();
  });
  ...
  describe('AttachmentDetails', function() {
    it('should create an instance of AttachmentDetails', function() {
      // uncomment below and update the code to test AttachmentDetails
      //var instance = new AwsSupport.AttachmentDetails();
      //expect(instance).to.be.a(AwsSupport.AttachmentDetails);
    });
