...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeTrustedAdvisorCheckResultResponseResult();
  });
  ...
  describe('DescribeTrustedAdvisorCheckResultResponseResult', function() {
    it('should create an instance of DescribeTrustedAdvisorCheckResultResponseResult', function() {
      // uncomment below and update the code to test DescribeTrustedAdvisorCheckResultResponseResult
      //var instance = new AwsSupport.DescribeTrustedAdvisorCheckResultResponseResult();
      //expect(instance).to.be.a(AwsSupport.DescribeTrustedAdvisorCheckResultResponseResult);
    });
