...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.ResolveCaseRequest();
  });
  ...
  describe('ResolveCaseRequest', function() {
    it('should create an instance of ResolveCaseRequest', function() {
      // uncomment below and update the code to test ResolveCaseRequest
      //var instance = new AwsSupport.ResolveCaseRequest();
      //expect(instance).to.be.a(AwsSupport.ResolveCaseRequest);
    });
