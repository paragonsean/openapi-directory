...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.TrustedAdvisorCheckRefreshStatus();
  });
  ...
  describe('TrustedAdvisorCheckRefreshStatus', function() {
    it('should create an instance of TrustedAdvisorCheckRefreshStatus', function() {
      // uncomment below and update the code to test TrustedAdvisorCheckRefreshStatus
      //var instance = new AwsSupport.TrustedAdvisorCheckRefreshStatus();
      //expect(instance).to.be.a(AwsSupport.TrustedAdvisorCheckRefreshStatus);
    });
    ...
    it('should have the property millisUntilNextRefreshable (base name: "millisUntilNextRefreshable")', function() {
      // uncomment below and update the code to test the property millisUntilNextRefreshable
      //var instance = new AwsSupport.TrustedAdvisorCheckRefreshStatus();
      //expect(instance).to.be();
    });
