...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeSupportedLanguagesResponse();
  });
  ...
  describe('DescribeSupportedLanguagesResponse', function() {
    it('should create an instance of DescribeSupportedLanguagesResponse', function() {
      // uncomment below and update the code to test DescribeSupportedLanguagesResponse
      //var instance = new AwsSupport.DescribeSupportedLanguagesResponse();
      //expect(instance).to.be.a(AwsSupport.DescribeSupportedLanguagesResponse);
    });
