...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeCommunicationsResponse();
  });
  ...
  describe('DescribeCommunicationsResponse', function() {
    it('should create an instance of DescribeCommunicationsResponse', function() {
      // uncomment below and update the code to test DescribeCommunicationsResponse
      //var instance = new AwsSupport.DescribeCommunicationsResponse();
      //expect(instance).to.be.a(AwsSupport.DescribeCommunicationsResponse);
    });
