...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.TrustedAdvisorResourcesSummary();
  });
  ...
  describe('TrustedAdvisorResourcesSummary', function() {
    it('should create an instance of TrustedAdvisorResourcesSummary', function() {
      // uncomment below and update the code to test TrustedAdvisorResourcesSummary
      //var instance = new AwsSupport.TrustedAdvisorResourcesSummary();
      //expect(instance).to.be.a(AwsSupport.TrustedAdvisorResourcesSummary);
    });

    it('should have the property resourcesProcessed (base name: "resourcesProcessed")', function() {
      // uncomment below and update the code to test the property resourcesProcessed
      //var instance = new AwsSupport.TrustedAdvisorResourcesSummary();
      //expect(instance).to.be();
    });

    it('should have the property resourcesFlagged (base name: "resourcesFlagged")', function() {
      // uncomment below and update the code to test the property resourcesFlagged
      //var instance = new AwsSupport.TrustedAdvisorResourcesSummary();
      //expect(instance).to.be();
    });

    it('should have the property resourcesIgnored (base name: "resourcesIgnored")', function() {
      // uncomment below and update the code to test the property resourcesIgnored
      //var instance = new AwsSupport.TrustedAdvisorResourcesSummary();
      //expect(instance).to.be();
    });

    it('should have the property resourcesSuppressed (base name: "resourcesSuppressed")', function() {
      // uncomment below and update the code to test the property resourcesSuppressed
      //var instance = new AwsSupport.TrustedAdvisorResourcesSummary();
      //expect(instance).to.be();
    });
