...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeTrustedAdvisorCheckResultResponse();
  });
  ...
  describe('DescribeTrustedAdvisorCheckResultResponse', function() {
    it('should create an instance of DescribeTrustedAdvisorCheckResultResponse', function() {
      // uncomment below and update the code to test DescribeTrustedAdvisorCheckResultResponse
      //var instance = new AwsSupport.DescribeTrustedAdvisorCheckResultResponse();
      //expect(instance).to.be.a(AwsSupport.DescribeTrustedAdvisorCheckResultResponse);
    });
