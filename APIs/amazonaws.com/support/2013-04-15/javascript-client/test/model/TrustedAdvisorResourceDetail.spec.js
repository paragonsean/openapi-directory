...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.TrustedAdvisorResourceDetail();
  });
  ...
  describe('TrustedAdvisorResourceDetail', function() {
    it('should create an instance of TrustedAdvisorResourceDetail', function() {
      // uncomment below and update the code to test TrustedAdvisorResourceDetail
      //var instance = new AwsSupport.TrustedAdvisorResourceDetail();
      //expect(instance).to.be.a(AwsSupport.TrustedAdvisorResourceDetail);
    });
    ...
    it('should have the property isSuppressed (base name: "isSuppressed")', function() {
      // uncomment below and update the code to test the property isSuppressed
      //var instance = new AwsSupport.TrustedAdvisorResourceDetail();
      //expect(instance).to.be();
    });
