...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.TrustedAdvisorCheckSummary();
  });
  ...
  describe('TrustedAdvisorCheckSummary', function() {
    it('should create an instance of TrustedAdvisorCheckSummary', function() {
      // uncomment below and update the code to test TrustedAdvisorCheckSummary
      //var instance = new AwsSupport.TrustedAdvisorCheckSummary();
      //expect(instance).to.be.a(AwsSupport.TrustedAdvisorCheckSummary);
    });
    ...
    it('should have the property hasFlaggedResources (base name: "hasFlaggedResources")', function() {
      // uncomment below and update the code to test the property hasFlaggedResources
      //var instance = new AwsSupport.TrustedAdvisorCheckSummary();
      //expect(instance).to.be();
    });
