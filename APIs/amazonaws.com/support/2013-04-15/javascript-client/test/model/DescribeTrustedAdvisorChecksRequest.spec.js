...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeTrustedAdvisorChecksRequest();
  });
  ...
  describe('DescribeTrustedAdvisorChecksRequest', function() {
    it('should create an instance of DescribeTrustedAdvisorChecksRequest', function() {
      // uncomment below and update the code to test DescribeTrustedAdvisorChecksRequest
      //var instance = new AwsSupport.DescribeTrustedAdvisorChecksRequest();
      //expect(instance).to.be.a(AwsSupport.DescribeTrustedAdvisorChecksRequest);
    });
