...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.CaseDetails();
  });
  ...
  describe('CaseDetails', function() {
    it('should create an instance of CaseDetails', function() {
      // uncomment below and update the code to test CaseDetails
      //var instance = new AwsSupport.CaseDetails();
      //expect(instance).to.be.a(AwsSupport.CaseDetails);
    });
    ...
    it('should have the property displayId (base name: "displayId")', function() {
    ...
    it('should have the property severityCode (base name: "severityCode")', function() {
      // uncomment below and update the code to test the property severityCode
      //var instance = new AwsSupport.CaseDetails();
      //expect(instance).to.be();
    });
    ...
    it('should have the property recentCommunications (base name: "recentCommunications")', function() {
      // uncomment below and update the code to test the property recentCommunications
      //var instance = new AwsSupport.CaseDetails();
      //expect(instance).to.be();
    });
