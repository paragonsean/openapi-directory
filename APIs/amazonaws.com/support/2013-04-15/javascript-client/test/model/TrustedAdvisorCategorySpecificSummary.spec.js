...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.TrustedAdvisorCategorySpecificSummary();
  });
  ...
  describe('TrustedAdvisorCategorySpecificSummary', function() {
    it('should create an instance of TrustedAdvisorCategorySpecificSummary', function() {
      // uncomment below and update the code to test TrustedAdvisorCategorySpecificSummary
      //var instance = new AwsSupport.TrustedAdvisorCategorySpecificSummary();
      //expect(instance).to.be.a(AwsSupport.TrustedAdvisorCategorySpecificSummary);
    });
