...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.CaseDetailsRecentCommunications();
  });
  ...
  describe('CaseDetailsRecentCommunications', function() {
    it('should create an instance of CaseDetailsRecentCommunications', function() {
      // uncomment below and update the code to test CaseDetailsRecentCommunications
      //var instance = new AwsSupport.CaseDetailsRecentCommunications();
      //expect(instance).to.be.a(AwsSupport.CaseDetailsRecentCommunications);
    });

    it('should have the property communications (base name: "communications")', function() {
      // uncomment below and update the code to test the property communications
      //var instance = new AwsSupport.CaseDetailsRecentCommunications();
