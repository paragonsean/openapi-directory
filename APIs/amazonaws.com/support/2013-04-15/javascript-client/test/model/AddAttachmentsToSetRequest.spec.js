...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.AddAttachmentsToSetRequest();
  });
  ...
  describe('AddAttachmentsToSetRequest', function() {
    it('should create an instance of AddAttachmentsToSetRequest', function() {
      // uncomment below and update the code to test AddAttachmentsToSetRequest
      //var instance = new AwsSupport.AddAttachmentsToSetRequest();
      //expect(instance).to.be.a(AwsSupport.AddAttachmentsToSetRequest);
    });
