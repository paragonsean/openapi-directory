...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.RefreshTrustedAdvisorCheckRequest();
  });
  ...
  describe('RefreshTrustedAdvisorCheckRequest', function() {
    it('should create an instance of RefreshTrustedAdvisorCheckRequest', function() {
      // uncomment below and update the code to test RefreshTrustedAdvisorCheckRequest
      //var instance = new AwsSupport.RefreshTrustedAdvisorCheckRequest();
      //expect(instance).to.be.a(AwsSupport.RefreshTrustedAdvisorCheckRequest);
    });
