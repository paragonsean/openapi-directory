...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.Communication();
  });
  ...
  describe('Communication', function() {
    it('should create an instance of Communication', function() {
      ...
      //var instance = new AwsSupport.Communication();
      //expect(instance).to.be.a(AwsSupport.Communication);
    });
    ...
    it('should have the property attachmentSet (base name: "attachmentSet")', function() {
      // uncomment below and update the code to test the property attachmentSet
      //var instance = new AwsSupport.Communication();
      //expect(instance).to.be();
    });
