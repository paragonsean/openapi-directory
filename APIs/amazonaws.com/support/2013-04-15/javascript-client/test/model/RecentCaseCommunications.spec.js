...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.RecentCaseCommunications();
  });
  ...
  describe('RecentCaseCommunications', function() {
    it('should create an instance of RecentCaseCommunications', function() {
      // uncomment below and update the code to test RecentCaseCommunications
      //var instance = new AwsSupport.RecentCaseCommunications();
      //expect(instance).to.be.a(AwsSupport.RecentCaseCommunications);
    });
