...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeCommunicationsRequest();
  });
  ...
  describe('DescribeCommunicationsRequest', function() {
    it('should create an instance of DescribeCommunicationsRequest', function() {
      // uncomment below and update the code to test DescribeCommunicationsRequest
      //var instance = new AwsSupport.DescribeCommunicationsRequest();
      //expect(instance).to.be.a(AwsSupport.DescribeCommunicationsRequest);
    });
