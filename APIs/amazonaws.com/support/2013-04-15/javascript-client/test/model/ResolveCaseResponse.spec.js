...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.ResolveCaseResponse();
  });
  ...
  describe('ResolveCaseResponse', function() {
    it('should create an instance of ResolveCaseResponse', function() {
      // uncomment below and update the code to test ResolveCaseResponse
      //var instance = new AwsSupport.ResolveCaseResponse();
      //expect(instance).to.be.a(AwsSupport.ResolveCaseResponse);
    });

    it('should have the property initialCaseStatus (base name: "initialCaseStatus")', function() {
      // uncomment below and update the code to test the property initialCaseStatus
      //var instance = new AwsSupport.ResolveCaseResponse();
      //expect(instance).to.be();
    });

    it('should have the property finalCaseStatus (base name: "finalCaseStatus")', function() {
      // uncomment below and update the code to test the property finalCaseStatus
      //var instance = new AwsSupport.ResolveCaseResponse();
      //expect(instance).to.be();
    });
