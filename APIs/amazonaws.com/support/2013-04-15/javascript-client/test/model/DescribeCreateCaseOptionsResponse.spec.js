...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeCreateCaseOptionsResponse();
  });
  ...
  describe('DescribeCreateCaseOptionsResponse', function() {
    it('should create an instance of DescribeCreateCaseOptionsResponse', function() {
      // uncomment below and update the code to test DescribeCreateCaseOptionsResponse
      //var instance = new AwsSupport.DescribeCreateCaseOptionsResponse();
      //expect(instance).to.be.a(AwsSupport.DescribeCreateCaseOptionsResponse);
    });

    it('should have the property languageAvailability (base name: "languageAvailability")', function() {
      // uncomment below and update the code to test the property languageAvailability
      //var instance = new AwsSupport.DescribeCreateCaseOptionsResponse();
      //expect(instance).to.be();
    });

    it('should have the property communicationTypes (base name: "communicationTypes")', function() {
      // uncomment below and update the code to test the property communicationTypes
      //var instance = new AwsSupport.DescribeCreateCaseOptionsResponse();
      //expect(instance).to.be();
    });
