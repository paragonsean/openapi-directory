...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeServicesRequest();
  });
  ...
  describe('DescribeServicesRequest', function() {
    it('should create an instance of DescribeServicesRequest', function() {
      // uncomment below and update the code to test DescribeServicesRequest
      //var instance = new AwsSupport.DescribeServicesRequest();
      //expect(instance).to.be.a(AwsSupport.DescribeServicesRequest);
    });

    it('should have the property serviceCodeList (base name: "serviceCodeList")', function() {
      // uncomment below and update the code to test the property serviceCodeList
      //var instance = new AwsSupport.DescribeServicesRequest();
