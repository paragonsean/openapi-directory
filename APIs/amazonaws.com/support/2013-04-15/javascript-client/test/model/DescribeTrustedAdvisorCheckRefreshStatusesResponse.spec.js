...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeTrustedAdvisorCheckRefreshStatusesResponse();
  });
  ...
  describe('DescribeTrustedAdvisorCheckRefreshStatusesResponse', function() {
    it('should create an instance of DescribeTrustedAdvisorCheckRefreshStatusesResponse', function() {
      // uncomment below and update the code to test DescribeTrustedAdvisorCheckRefreshStatusesResponse
      //var instance = new AwsSupport.DescribeTrustedAdvisorCheckRefreshStatusesResponse();
      //expect(instance).to.be.a(AwsSupport.DescribeTrustedAdvisorCheckRefreshStatusesResponse);
    });
