...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.AddCommunicationToCaseResponse();
  });
  ...
  describe('AddCommunicationToCaseResponse', function() {
    it('should create an instance of AddCommunicationToCaseResponse', function() {
      // uncomment below and update the code to test AddCommunicationToCaseResponse
      //var instance = new AwsSupport.AddCommunicationToCaseResponse();
      //expect(instance).to.be.a(AwsSupport.AddCommunicationToCaseResponse);
    });
