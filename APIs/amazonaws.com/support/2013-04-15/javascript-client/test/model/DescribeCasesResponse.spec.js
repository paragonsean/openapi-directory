...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeCasesResponse();
  });
  ...
  describe('DescribeCasesResponse', function() {
    it('should create an instance of DescribeCasesResponse', function() {
      // uncomment below and update the code to test DescribeCasesResponse
      //var instance = new AwsSupport.DescribeCasesResponse();
      //expect(instance).to.be.a(AwsSupport.DescribeCasesResponse);
    });
