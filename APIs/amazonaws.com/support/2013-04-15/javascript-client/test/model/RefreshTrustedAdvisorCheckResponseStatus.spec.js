...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.RefreshTrustedAdvisorCheckResponseStatus();
  });
  ...
  describe('RefreshTrustedAdvisorCheckResponseStatus', function() {
    it('should create an instance of RefreshTrustedAdvisorCheckResponseStatus', function() {
      // uncomment below and update the code to test RefreshTrustedAdvisorCheckResponseStatus
      //var instance = new AwsSupport.RefreshTrustedAdvisorCheckResponseStatus();
      //expect(instance).to.be.a(AwsSupport.RefreshTrustedAdvisorCheckResponseStatus);
    });
