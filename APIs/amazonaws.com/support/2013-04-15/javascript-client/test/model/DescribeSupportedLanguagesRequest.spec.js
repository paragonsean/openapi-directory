...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeSupportedLanguagesRequest();
  });
  ...
  describe('DescribeSupportedLanguagesRequest', function() {
    it('should create an instance of DescribeSupportedLanguagesRequest', function() {
      // uncomment below and update the code to test DescribeSupportedLanguagesRequest
      //var instance = new AwsSupport.DescribeSupportedLanguagesRequest();
      //expect(instance).to.be.a(AwsSupport.DescribeSupportedLanguagesRequest);
    });
