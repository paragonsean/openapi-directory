...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.TrustedAdvisorCheckResult();
  });
  ...
  describe('TrustedAdvisorCheckResult', function() {
    it('should create an instance of TrustedAdvisorCheckResult', function() {
      // uncomment below and update the code to test TrustedAdvisorCheckResult
      //var instance = new AwsSupport.TrustedAdvisorCheckResult();
      //expect(instance).to.be.a(AwsSupport.TrustedAdvisorCheckResult);
    });
    ...
    it('should have the property resourcesSummary (base name: "resourcesSummary")', function() {
      // uncomment below and update the code to test the property resourcesSummary
      //var instance = new AwsSupport.TrustedAdvisorCheckResult();
      //expect(instance).to.be();
    });

    it('should have the property categorySpecificSummary (base name: "categorySpecificSummary")', function() {
      // uncomment below and update the code to test the property categorySpecificSummary
      //var instance = new AwsSupport.TrustedAdvisorCheckResult();
      //expect(instance).to.be();
    });
