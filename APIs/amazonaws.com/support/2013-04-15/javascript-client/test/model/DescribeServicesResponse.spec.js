...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeServicesResponse();
  });
  ...
  describe('DescribeServicesResponse', function() {
    it('should create an instance of DescribeServicesResponse', function() {
      ...
      //var instance = new AwsSupport.DescribeServicesResponse();
      //expect(instance).to.be.a(AwsSupport.DescribeServicesResponse);
    });
