...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.TrustedAdvisorCheckDescription();
  });
  ...
  describe('TrustedAdvisorCheckDescription', function() {
    it('should create an instance of TrustedAdvisorCheckDescription', function() {
      // uncomment below and update the code to test TrustedAdvisorCheckDescription
      //var instance = new AwsSupport.TrustedAdvisorCheckDescription();
      //expect(instance).to.be.a(AwsSupport.TrustedAdvisorCheckDescription);
    });
