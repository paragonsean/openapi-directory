...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.TrustedAdvisorCheckResultCategorySpecificSummary();
  });
  ...
  describe('TrustedAdvisorCheckResultCategorySpecificSummary', function() {
    it('should create an instance of TrustedAdvisorCheckResultCategorySpecificSummary', function() {
      // uncomment below and update the code to test TrustedAdvisorCheckResultCategorySpecificSummary
      //var instance = new AwsSupport.TrustedAdvisorCheckResultCategorySpecificSummary();
      //expect(instance).to.be.a(AwsSupport.TrustedAdvisorCheckResultCategorySpecificSummary);
    });

    it('should have the property costOptimizing (base name: "costOptimizing")', function() {
      // uncomment below and update the code to test the property costOptimizing
      //var instance = new AwsSupport.TrustedAdvisorCheckResultCategorySpecificSummary();
