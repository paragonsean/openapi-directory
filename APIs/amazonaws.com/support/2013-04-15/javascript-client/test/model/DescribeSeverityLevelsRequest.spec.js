...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeSeverityLevelsRequest();
  });
  ...
  describe('DescribeSeverityLevelsRequest', function() {
    it('should create an instance of DescribeSeverityLevelsRequest', function() {
      // uncomment below and update the code to test DescribeSeverityLevelsRequest
      //var instance = new AwsSupport.DescribeSeverityLevelsRequest();
      //expect(instance).to.be.a(AwsSupport.DescribeSeverityLevelsRequest);
    });
