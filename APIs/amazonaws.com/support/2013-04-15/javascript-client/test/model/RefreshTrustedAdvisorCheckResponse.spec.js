...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.RefreshTrustedAdvisorCheckResponse();
  });
  ...
  describe('RefreshTrustedAdvisorCheckResponse', function() {
    it('should create an instance of RefreshTrustedAdvisorCheckResponse', function() {
      // uncomment below and update the code to test RefreshTrustedAdvisorCheckResponse
      //var instance = new AwsSupport.RefreshTrustedAdvisorCheckResponse();
      //expect(instance).to.be.a(AwsSupport.RefreshTrustedAdvisorCheckResponse);
    });
