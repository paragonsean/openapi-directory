...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeCreateCaseOptionsRequest();
  });
  ...
  describe('DescribeCreateCaseOptionsRequest', function() {
    it('should create an instance of DescribeCreateCaseOptionsRequest', function() {
      // uncomment below and update the code to test DescribeCreateCaseOptionsRequest
      //var instance = new AwsSupport.DescribeCreateCaseOptionsRequest();
      //expect(instance).to.be.a(AwsSupport.DescribeCreateCaseOptionsRequest);
    });
