...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeTrustedAdvisorChecksResponse();
  });
  ...
  describe('DescribeTrustedAdvisorChecksResponse', function() {
    it('should create an instance of DescribeTrustedAdvisorChecksResponse', function() {
      // uncomment below and update the code to test DescribeTrustedAdvisorChecksResponse
      //var instance = new AwsSupport.DescribeTrustedAdvisorChecksResponse();
      //expect(instance).to.be.a(AwsSupport.DescribeTrustedAdvisorChecksResponse);
    });
