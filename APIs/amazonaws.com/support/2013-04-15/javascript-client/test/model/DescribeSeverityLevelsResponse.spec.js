...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeSeverityLevelsResponse();
  });
  ...
  describe('DescribeSeverityLevelsResponse', function() {
    it('should create an instance of DescribeSeverityLevelsResponse', function() {
      // uncomment below and update the code to test DescribeSeverityLevelsResponse
      //var instance = new AwsSupport.DescribeSeverityLevelsResponse();
      //expect(instance).to.be.a(AwsSupport.DescribeSeverityLevelsResponse);
    });
