...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeTrustedAdvisorCheckResultRequest();
  });
  ...
  describe('DescribeTrustedAdvisorCheckResultRequest', function() {
    it('should create an instance of DescribeTrustedAdvisorCheckResultRequest', function() {
      // uncomment below and update the code to test DescribeTrustedAdvisorCheckResultRequest
      //var instance = new AwsSupport.DescribeTrustedAdvisorCheckResultRequest();
      //expect(instance).to.be.a(AwsSupport.DescribeTrustedAdvisorCheckResultRequest);
    });
