...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeAttachmentRequest();
  });
  ...
  describe('DescribeAttachmentRequest', function() {
    it('should create an instance of DescribeAttachmentRequest', function() {
      // uncomment below and update the code to test DescribeAttachmentRequest
      //var instance = new AwsSupport.DescribeAttachmentRequest();
      //expect(instance).to.be.a(AwsSupport.DescribeAttachmentRequest);
    });
