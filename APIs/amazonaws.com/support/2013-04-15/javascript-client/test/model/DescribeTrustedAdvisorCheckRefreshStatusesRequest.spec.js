...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeTrustedAdvisorCheckRefreshStatusesRequest();
  });
  ...
  describe('DescribeTrustedAdvisorCheckRefreshStatusesRequest', function() {
    it('should create an instance of DescribeTrustedAdvisorCheckRefreshStatusesRequest', function() {
      // uncomment below and update the code to test DescribeTrustedAdvisorCheckRefreshStatusesRequest
      //var instance = new AwsSupport.DescribeTrustedAdvisorCheckRefreshStatusesRequest();
      //expect(instance).to.be.a(AwsSupport.DescribeTrustedAdvisorCheckRefreshStatusesRequest);
    });

    it('should have the property checkIds (base name: "checkIds")', function() {
      // uncomment below and update the code to test the property checkIds
      //var instance = new AwsSupport.DescribeTrustedAdvisorCheckRefreshStatusesRequest();
