...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeAttachmentResponseAttachment();
  });
  ...
  describe('DescribeAttachmentResponseAttachment', function() {
    it('should create an instance of DescribeAttachmentResponseAttachment', function() {
      // uncomment below and update the code to test DescribeAttachmentResponseAttachment
      //var instance = new AwsSupport.DescribeAttachmentResponseAttachment();
      //expect(instance).to.be.a(AwsSupport.DescribeAttachmentResponseAttachment);
    });
