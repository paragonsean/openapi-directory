...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.DescribeCasesRequest();
  });
  ...
  describe('DescribeCasesRequest', function() {
    it('should create an instance of DescribeCasesRequest', function() {
      // uncomment below and update the code to test DescribeCasesRequest
      //var instance = new AwsSupport.DescribeCasesRequest();
      //expect(instance).to.be.a(AwsSupport.DescribeCasesRequest);
    });

    it('should have the property caseIdList (base name: "caseIdList")', function() {
      // uncomment below and update the code to test the property caseIdList
      //var instance = new AwsSupport.DescribeCasesRequest();
    ...
    it('should have the property afterTime (base name: "afterTime")', function() {
      // uncomment below and update the code to test the property afterTime
      //var instance = new AwsSupport.DescribeCasesRequest();
      //expect(instance).to.be();
    });

    it('should have the property beforeTime (base name: "beforeTime")', function() {
      // uncomment below and update the code to test the property beforeTime
      //var instance = new AwsSupport.DescribeCasesRequest();
      //expect(instance).to.be();
    });

    it('should have the property includeResolvedCases (base name: "includeResolvedCases")', function() {
      // uncomment below and update the code to test the property includeResolvedCases
      //var instance = new AwsSupport.DescribeCasesRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property includeCommunications (base name: "includeCommunications")', function() {
      // uncomment below and update the code to test the property includeCommunications
      //var instance = new AwsSupport.DescribeCasesRequest();
      //expect(instance).to.be();
    });
