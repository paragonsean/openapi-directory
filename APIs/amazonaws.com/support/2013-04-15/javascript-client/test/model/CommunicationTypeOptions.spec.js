...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.CommunicationTypeOptions();
  });
  ...
  describe('CommunicationTypeOptions', function() {
    it('should create an instance of CommunicationTypeOptions', function() {
      // uncomment below and update the code to test CommunicationTypeOptions
      //var instance = new AwsSupport.CommunicationTypeOptions();
      //expect(instance).to.be.a(AwsSupport.CommunicationTypeOptions);
    });
    ...
    it('should have the property supportedHours (base name: "supportedHours")', function() {
      // uncomment below and update the code to test the property supportedHours
      //var instance = new AwsSupport.CommunicationTypeOptions();
      //expect(instance).to.be();
    });

    it('should have the property datesWithoutSupport (base name: "datesWithoutSupport")', function() {
      // uncomment below and update the code to test the property datesWithoutSupport
      //var instance = new AwsSupport.CommunicationTypeOptions();
      //expect(instance).to.be();
    });
