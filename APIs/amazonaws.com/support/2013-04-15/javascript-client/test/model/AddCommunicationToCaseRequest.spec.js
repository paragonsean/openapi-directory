...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSupport.AddCommunicationToCaseRequest();
  });
  ...
  describe('AddCommunicationToCaseRequest', function() {
    it('should create an instance of AddCommunicationToCaseRequest', function() {
      // uncomment below and update the code to test AddCommunicationToCaseRequest
      //var instance = new AwsSupport.AddCommunicationToCaseRequest();
      //expect(instance).to.be.a(AwsSupport.AddCommunicationToCaseRequest);
    });
    ...
    it('should have the property communicationBody (base name: "communicationBody")', function() {
      // uncomment below and update the code to test the property communicationBody
      //var instance = new AwsSupport.AddCommunicationToCaseRequest();
      //expect(instance).to.be();
    });
