...
/**
 * The TrustedAdvisorCostOptimizingSummary model module.
 * @module model/TrustedAdvisorCostOptimizingSummary
 * @version 2013-04-15
 */
class TrustedAdvisorCostOptimizingSummary {
    /**
     * Constructs a new <code>TrustedAdvisorCostOptimizingSummary</code>.
     * The estimated cost savings that might be realized if the recommended operations are taken.
     * @alias module:model/TrustedAdvisorCostOptimizingSummary
    ...
    /**
     * Constructs a <code>TrustedAdvisorCostOptimizingSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrustedAdvisorCostOptimizingSummary} obj Optional instance to populate.
     * @return {module:model/TrustedAdvisorCostOptimizingSummary} The populated <code>TrustedAdvisorCostOptimizingSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrustedAdvisorCostOptimizingSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>TrustedAdvisorCostOptimizingSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrustedAdvisorCostOptimizingSummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TrustedAdvisorCostOptimizingSummary.RequiredProperties) {
...
TrustedAdvisorCostOptimizingSummary.RequiredProperties = ["estimatedMonthlySavings", "estimatedPercentMonthlySavings"];
...
export default TrustedAdvisorCostOptimizingSummary;
