...
class Communication {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attachmentSet')) {
                obj['attachmentSet'] = ApiClient.convertToType(data['attachmentSet'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Communication</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Communication</code>.
     */
    static validateJSON(data) {
        ...
        if (data['attachmentSet']) { // data not null
          Array.validateJSON(data['attachmentSet']);
        }
 ...
 */
Communication.prototype['caseId'] = undefined;

/**
 * @member {String} body
 */
Communication.prototype['body'] = undefined;

/**
 * @member {String} submittedBy
 */
Communication.prototype['submittedBy'] = undefined;

/**
 * @member {String} timeCreated
 */
Communication.prototype['timeCreated'] = undefined;

/**
 * @member {Array} attachmentSet
 */
Communication.prototype['attachmentSet'] = undefined;
