...
/**
 * The AddCommunicationToCaseResponse model module.
 * @module model/AddCommunicationToCaseResponse
 * @version 2013-04-15
 */
class AddCommunicationToCaseResponse {
    /**
     * Constructs a new <code>AddCommunicationToCaseResponse</code>.
     * The result of the &lt;a&gt;AddCommunicationToCase&lt;/a&gt; operation.
     * @alias module:model/AddCommunicationToCaseResponse
     */
    constructor() { 
        
        AddCommunicationToCaseResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddCommunicationToCaseResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddCommunicationToCaseResponse} obj Optional instance to populate.
     * @return {module:model/AddCommunicationToCaseResponse} The populated <code>AddCommunicationToCaseResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddCommunicationToCaseResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AddCommunicationToCaseResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddCommunicationToCaseResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `result`
        if (data['result']) { // data not null
          Boolean.validateJSON(data['result']);
        }
 ...
 */
AddCommunicationToCaseResponse.prototype['result'] = undefined;
...
export default AddCommunicationToCaseResponse;
