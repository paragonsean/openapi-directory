...
/**
 * The DescribeCreateCaseOptionsResponse model module.
 * @module model/DescribeCreateCaseOptionsResponse
 * @version 2013-04-15
 */
class DescribeCreateCaseOptionsResponse {
    /**
     * Constructs a new <code>DescribeCreateCaseOptionsResponse</code>.
     * @alias module:model/DescribeCreateCaseOptionsResponse
     */
    constructor() { 
        
        DescribeCreateCaseOptionsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeCreateCaseOptionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCreateCaseOptionsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeCreateCaseOptionsResponse} The populated <code>DescribeCreateCaseOptionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCreateCaseOptionsResponse();

            if (data.hasOwnProperty('languageAvailability')) {
                obj['languageAvailability'] = ApiClient.convertToType(data['languageAvailability'], 'String');
            }
            if (data.hasOwnProperty('communicationTypes')) {
                obj['communicationTypes'] = ApiClient.convertToType(data['communicationTypes'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCreateCaseOptionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCreateCaseOptionsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `languageAvailability`
        if (data['languageAvailability']) { // data not null
          String.validateJSON(data['languageAvailability']);
        }
        // validate the optional field `communicationTypes`
        if (data['communicationTypes']) { // data not null
          Array.validateJSON(data['communicationTypes']);
        }
...
/**
 * @member {String} languageAvailability
 */
DescribeCreateCaseOptionsResponse.prototype['languageAvailability'] = undefined;

/**
 * @member {Array} communicationTypes
 */
DescribeCreateCaseOptionsResponse.prototype['communicationTypes'] = undefined;
...
export default DescribeCreateCaseOptionsResponse;
