...
/**
 * The DescribeServicesResponse model module.
 * @module model/DescribeServicesResponse
 * @version 2013-04-15
 */
class DescribeServicesResponse {
    /**
     * Constructs a new <code>DescribeServicesResponse</code>.
     * The list of Amazon Web Services services returned by the &lt;a&gt;DescribeServices&lt;/a&gt; operation.
     * @alias module:model/DescribeServicesResponse
     */
    constructor() { 
        
        DescribeServicesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeServicesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeServicesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeServicesResponse} The populated <code>DescribeServicesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeServicesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeServicesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeServicesResponse</code>.
     */
 ...
 */
DescribeServicesResponse.prototype['services'] = undefined;
...
export default DescribeServicesResponse;
