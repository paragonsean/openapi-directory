...
/**
 * The CommunicationTypeOptions model module.
 * @module model/CommunicationTypeOptions
 * @version 2013-04-15
 */
class CommunicationTypeOptions {
    /**
     * Constructs a new <code>CommunicationTypeOptions</code>.
     ...
     * @alias module:model/CommunicationTypeOptions
     */
    constructor() { 
        
        CommunicationTypeOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CommunicationTypeOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommunicationTypeOptions} obj Optional instance to populate.
     * @return {module:model/CommunicationTypeOptions} The populated <code>CommunicationTypeOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommunicationTypeOptions();

            if (data.hasOwnProperty('type')) {
                obj['type'] = ApiClient.convertToType(data['type'], 'String');
            }
            if (data.hasOwnProperty('supportedHours')) {
                obj['supportedHours'] = ApiClient.convertToType(data['supportedHours'], Array);
            }
            if (data.hasOwnProperty('datesWithoutSupport')) {
                obj['datesWithoutSupport'] = ApiClient.convertToType(data['datesWithoutSupport'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CommunicationTypeOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommunicationTypeOptions</code>.
     */
    static validateJSON(data) {
        ...
        if (data['supportedHours']) { // data not null
          Array.validateJSON(data['supportedHours']);
        }
        // validate the optional field `datesWithoutSupport`
        if (data['datesWithoutSupport']) { // data not null
          Array.validateJSON(data['datesWithoutSupport']);
        }
 ...
 * @member {String} type
 */
CommunicationTypeOptions.prototype['type'] = undefined;

/**
 * @member {Array} supportedHours
 */
CommunicationTypeOptions.prototype['supportedHours'] = undefined;

/**
 * @member {Array} datesWithoutSupport
 */
CommunicationTypeOptions.prototype['datesWithoutSupport'] = undefined;
...
export default CommunicationTypeOptions;
