...
/**
 * The ResolveCaseRequest model module.
 * @module model/ResolveCaseRequest
 * @version 2013-04-15
 */
class ResolveCaseRequest {
    /**
     * Constructs a new <code>ResolveCaseRequest</code>.
     * @alias module:model/ResolveCaseRequest
     */
    constructor() { 
        
        ResolveCaseRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResolveCaseRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResolveCaseRequest} obj Optional instance to populate.
     * @return {module:model/ResolveCaseRequest} The populated <code>ResolveCaseRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResolveCaseRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ResolveCaseRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResolveCaseRequest</code>.
     */
 ...
 */
ResolveCaseRequest.prototype['caseId'] = undefined;
...
export default ResolveCaseRequest;
