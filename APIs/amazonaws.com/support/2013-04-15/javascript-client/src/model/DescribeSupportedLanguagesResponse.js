...
/**
 * The DescribeSupportedLanguagesResponse model module.
 * @module model/DescribeSupportedLanguagesResponse
 * @version 2013-04-15
 */
class DescribeSupportedLanguagesResponse {
    /**
     * Constructs a new <code>DescribeSupportedLanguagesResponse</code>.
     * @alias module:model/DescribeSupportedLanguagesResponse
     */
    constructor() { 
        
        DescribeSupportedLanguagesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeSupportedLanguagesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeSupportedLanguagesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeSupportedLanguagesResponse} The populated <code>DescribeSupportedLanguagesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeSupportedLanguagesResponse();

            if (data.hasOwnProperty('supportedLanguages')) {
                obj['supportedLanguages'] = ApiClient.convertToType(data['supportedLanguages'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeSupportedLanguagesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeSupportedLanguagesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `supportedLanguages`
        if (data['supportedLanguages']) { // data not null
          Array.validateJSON(data['supportedLanguages']);
        }
...
/**
 * @member {Array} supportedLanguages
 */
DescribeSupportedLanguagesResponse.prototype['supportedLanguages'] = undefined;
...
export default DescribeSupportedLanguagesResponse;
