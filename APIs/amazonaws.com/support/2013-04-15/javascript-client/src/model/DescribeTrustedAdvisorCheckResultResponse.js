...
import DescribeTrustedAdvisorCheckResultResponseResult from './DescribeTrustedAdvisorCheckResultResponseResult';

/**
 * The DescribeTrustedAdvisorCheckResultResponse model module.
 * @module model/DescribeTrustedAdvisorCheckResultResponse
 * @version 2013-04-15
 */
class DescribeTrustedAdvisorCheckResultResponse {
    /**
     * Constructs a new <code>DescribeTrustedAdvisorCheckResultResponse</code>.
     * The result of the Trusted Advisor check returned by the &lt;a&gt;DescribeTrustedAdvisorCheckResult&lt;/a&gt; operation.
     * @alias module:model/DescribeTrustedAdvisorCheckResultResponse
     */
    constructor() { 
        
        DescribeTrustedAdvisorCheckResultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeTrustedAdvisorCheckResultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTrustedAdvisorCheckResultResponse} obj Optional instance to populate.
     * @return {module:model/DescribeTrustedAdvisorCheckResultResponse} The populated <code>DescribeTrustedAdvisorCheckResultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTrustedAdvisorCheckResultResponse();

            if (data.hasOwnProperty('result')) {
                obj['result'] = DescribeTrustedAdvisorCheckResultResponseResult.constructFromObject(data['result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTrustedAdvisorCheckResultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTrustedAdvisorCheckResultResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `result`
        if (data['result']) { // data not null
          DescribeTrustedAdvisorCheckResultResponseResult.validateJSON(data['result']);
        }
...
/**
 * @member {module:model/DescribeTrustedAdvisorCheckResultResponseResult} result
 */
DescribeTrustedAdvisorCheckResultResponse.prototype['result'] = undefined;
...
export default DescribeTrustedAdvisorCheckResultResponse;
