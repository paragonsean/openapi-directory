...
/**
 * The DescribeCommunicationsResponse model module.
 * @module model/DescribeCommunicationsResponse
 * @version 2013-04-15
 */
class DescribeCommunicationsResponse {
    /**
     * Constructs a new <code>DescribeCommunicationsResponse</code>.
     * The communications returned by the &lt;a&gt;DescribeCommunications&lt;/a&gt; operation.
     * @alias module:model/DescribeCommunicationsResponse
     */
    constructor() { 
        
        DescribeCommunicationsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeCommunicationsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCommunicationsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeCommunicationsResponse} The populated <code>DescribeCommunicationsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCommunicationsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCommunicationsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCommunicationsResponse</code>.
     */
 ...
 */
DescribeCommunicationsResponse.prototype['communications'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeCommunicationsResponse.prototype['nextToken'] = undefined;
...
export default DescribeCommunicationsResponse;
