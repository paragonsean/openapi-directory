...
/**
 * The DescribeSupportedLanguagesRequest model module.
 * @module model/DescribeSupportedLanguagesRequest
 * @version 2013-04-15
 */
class DescribeSupportedLanguagesRequest {
    /**
     * Constructs a new <code>DescribeSupportedLanguagesRequest</code>.
     * @alias module:model/DescribeSupportedLanguagesRequest
     * @param issueType {String} 
     * @param serviceCode {String} 
     * @param categoryCode {String} 
     */
    constructor(issueType, serviceCode, categoryCode) { 
        
        DescribeSupportedLanguagesRequest.initialize(this, issueType, serviceCode, categoryCode);
    }
     ...
     */
    static initialize(obj, issueType, serviceCode, categoryCode) { 
    ...
    /**
     * Constructs a <code>DescribeSupportedLanguagesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeSupportedLanguagesRequest} obj Optional instance to populate.
     * @return {module:model/DescribeSupportedLanguagesRequest} The populated <code>DescribeSupportedLanguagesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeSupportedLanguagesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeSupportedLanguagesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeSupportedLanguagesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeSupportedLanguagesRequest.RequiredProperties) {
...
DescribeSupportedLanguagesRequest.RequiredProperties = ["issueType", "serviceCode", "categoryCode"];

/**
 * @member {String} issueType
 */
DescribeSupportedLanguagesRequest.prototype['issueType'] = undefined;

/**
 * @member {String} serviceCode
 */
DescribeSupportedLanguagesRequest.prototype['serviceCode'] = undefined;

/**
 * @member {String} categoryCode
 */
DescribeSupportedLanguagesRequest.prototype['categoryCode'] = undefined;
...
export default DescribeSupportedLanguagesRequest;
