...
/**
 * The DescribeTrustedAdvisorChecksRequest model module.
 * @module model/DescribeTrustedAdvisorChecksRequest
 * @version 2013-04-15
 */
class DescribeTrustedAdvisorChecksRequest {
    /**
     * Constructs a new <code>DescribeTrustedAdvisorChecksRequest</code>.
     * @alias module:model/DescribeTrustedAdvisorChecksRequest
     * @param language {String} 
     */
    constructor(language) { 
        
        DescribeTrustedAdvisorChecksRequest.initialize(this, language);
    }
    ...
    /**
     * Constructs a <code>DescribeTrustedAdvisorChecksRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTrustedAdvisorChecksRequest} obj Optional instance to populate.
     * @return {module:model/DescribeTrustedAdvisorChecksRequest} The populated <code>DescribeTrustedAdvisorChecksRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTrustedAdvisorChecksRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTrustedAdvisorChecksRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTrustedAdvisorChecksRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeTrustedAdvisorChecksRequest.RequiredProperties) {
...
DescribeTrustedAdvisorChecksRequest.RequiredProperties = ["language"];

/**
 * @member {String} language
 */
DescribeTrustedAdvisorChecksRequest.prototype['language'] = undefined;
...
export default DescribeTrustedAdvisorChecksRequest;
