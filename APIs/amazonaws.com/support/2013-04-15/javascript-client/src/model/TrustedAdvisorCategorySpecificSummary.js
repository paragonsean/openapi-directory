...
/**
 * The TrustedAdvisorCategorySpecificSummary model module.
 * @module model/TrustedAdvisorCategorySpecificSummary
 * @version 2013-04-15
 */
class TrustedAdvisorCategorySpecificSummary {
    /**
     * Constructs a new <code>TrustedAdvisorCategorySpecificSummary</code>.
     * The container for summary information that relates to the category of the Trusted Advisor check.
     * @alias module:model/TrustedAdvisorCategorySpecificSummary
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>TrustedAdvisorCategorySpecificSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrustedAdvisorCategorySpecificSummary} obj Optional instance to populate.
     * @return {module:model/TrustedAdvisorCategorySpecificSummary} The populated <code>TrustedAdvisorCategorySpecificSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrustedAdvisorCategorySpecificSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>TrustedAdvisorCategorySpecificSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrustedAdvisorCategorySpecificSummary</code>.
     */
...
export default TrustedAdvisorCategorySpecificSummary;
