...
/**
 * The AddCommunicationToCaseRequest model module.
 * @module model/AddCommunicationToCaseRequest
 * @version 2013-04-15
 */
class AddCommunicationToCaseRequest {
    /**
     * Constructs a new <code>AddCommunicationToCaseRequest</code>.
     * @alias module:model/AddCommunicationToCaseRequest
     * @param communicationBody {String} 
     */
    constructor(communicationBody) { 
        
        AddCommunicationToCaseRequest.initialize(this, communicationBody);
    }
     ...
     */
    static initialize(obj, communicationBody) { 
        obj['communicationBody'] = communicationBody;
    }

    /**
     * Constructs a <code>AddCommunicationToCaseRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddCommunicationToCaseRequest} obj Optional instance to populate.
     * @return {module:model/AddCommunicationToCaseRequest} The populated <code>AddCommunicationToCaseRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddCommunicationToCaseRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AddCommunicationToCaseRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddCommunicationToCaseRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddCommunicationToCaseRequest.RequiredProperties) {
...
AddCommunicationToCaseRequest.RequiredProperties = ["communicationBody"];

/**
 * @member {String} caseId
 */
AddCommunicationToCaseRequest.prototype['caseId'] = undefined;

/**
 * @member {String} communicationBody
 */
AddCommunicationToCaseRequest.prototype['communicationBody'] = undefined;

/**
 * @member {Array} ccEmailAddresses
 */
AddCommunicationToCaseRequest.prototype['ccEmailAddresses'] = undefined;

/**
 * @member {String} attachmentSetId
 */
AddCommunicationToCaseRequest.prototype['attachmentSetId'] = undefined;
...
export default AddCommunicationToCaseRequest;
