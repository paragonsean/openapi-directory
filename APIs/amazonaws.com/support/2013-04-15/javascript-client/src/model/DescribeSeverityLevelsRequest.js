...
/**
 * The DescribeSeverityLevelsRequest model module.
 * @module model/DescribeSeverityLevelsRequest
 * @version 2013-04-15
 */
class DescribeSeverityLevelsRequest {
    /**
     * Constructs a new <code>DescribeSeverityLevelsRequest</code>.
     * @alias module:model/DescribeSeverityLevelsRequest
     */
    constructor() { 
        
        DescribeSeverityLevelsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeSeverityLevelsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeSeverityLevelsRequest} obj Optional instance to populate.
     * @return {module:model/DescribeSeverityLevelsRequest} The populated <code>DescribeSeverityLevelsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeSeverityLevelsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeSeverityLevelsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeSeverityLevelsRequest</code>.
     */
 ...
 */
DescribeSeverityLevelsRequest.prototype['language'] = undefined;
...
export default DescribeSeverityLevelsRequest;
