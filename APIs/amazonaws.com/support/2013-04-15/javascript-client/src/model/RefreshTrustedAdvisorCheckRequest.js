...
/**
 * The RefreshTrustedAdvisorCheckRequest model module.
 * @module model/RefreshTrustedAdvisorCheckRequest
 * @version 2013-04-15
 */
class RefreshTrustedAdvisorCheckRequest {
    /**
     * Constructs a new <code>RefreshTrustedAdvisorCheckRequest</code>.
     * &lt;p/&gt;
     * @alias module:model/RefreshTrustedAdvisorCheckRequest
     * @param checkId {String} 
     */
    constructor(checkId) { 
        
        RefreshTrustedAdvisorCheckRequest.initialize(this, checkId);
    }
    ...
    /**
     * Constructs a <code>RefreshTrustedAdvisorCheckRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RefreshTrustedAdvisorCheckRequest} obj Optional instance to populate.
     * @return {module:model/RefreshTrustedAdvisorCheckRequest} The populated <code>RefreshTrustedAdvisorCheckRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RefreshTrustedAdvisorCheckRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RefreshTrustedAdvisorCheckRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RefreshTrustedAdvisorCheckRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RefreshTrustedAdvisorCheckRequest.RequiredProperties) {
...
RefreshTrustedAdvisorCheckRequest.RequiredProperties = ["checkId"];

/**
 * @member {String} checkId
 */
RefreshTrustedAdvisorCheckRequest.prototype['checkId'] = undefined;
...
export default RefreshTrustedAdvisorCheckRequest;
