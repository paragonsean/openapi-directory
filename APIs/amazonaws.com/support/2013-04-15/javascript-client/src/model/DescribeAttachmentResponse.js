...
import DescribeAttachmentResponseAttachment from './DescribeAttachmentResponseAttachment';

/**
 * The DescribeAttachmentResponse model module.
 * @module model/DescribeAttachmentResponse
 * @version 2013-04-15
 */
class DescribeAttachmentResponse {
    /**
     * Constructs a new <code>DescribeAttachmentResponse</code>.
     * The content and file name of the attachment returned by the &lt;a&gt;DescribeAttachment&lt;/a&gt; operation.
     * @alias module:model/DescribeAttachmentResponse
     */
    constructor() { 
        
        DescribeAttachmentResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAttachmentResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAttachmentResponse} obj Optional instance to populate.
     * @return {module:model/DescribeAttachmentResponse} The populated <code>DescribeAttachmentResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAttachmentResponse();

            if (data.hasOwnProperty('attachment')) {
                obj['attachment'] = DescribeAttachmentResponseAttachment.constructFromObject(data['attachment']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAttachmentResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAttachmentResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attachment`
        if (data['attachment']) { // data not null
          DescribeAttachmentResponseAttachment.validateJSON(data['attachment']);
        }
...
/**
 * @member {module:model/DescribeAttachmentResponseAttachment} attachment
 */
DescribeAttachmentResponse.prototype['attachment'] = undefined;
...
export default DescribeAttachmentResponse;
