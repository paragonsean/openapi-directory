...
/**
 * The DescribeTrustedAdvisorChecksResponse model module.
 * @module model/DescribeTrustedAdvisorChecksResponse
 * @version 2013-04-15
 */
class DescribeTrustedAdvisorChecksResponse {
    /**
     * Constructs a new <code>DescribeTrustedAdvisorChecksResponse</code>.
     * Information about the Trusted Advisor checks returned by the &lt;a&gt;DescribeTrustedAdvisorChecks&lt;/a&gt; operation.
     * @alias module:model/DescribeTrustedAdvisorChecksResponse
     * @param checks {Array} 
     */
    constructor(checks) { 
        
        DescribeTrustedAdvisorChecksResponse.initialize(this, checks);
    }
     ...
     */
    static initialize(obj, checks) { 
        obj['checks'] = checks;
    }

    /**
     * Constructs a <code>DescribeTrustedAdvisorChecksResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTrustedAdvisorChecksResponse} obj Optional instance to populate.
     * @return {module:model/DescribeTrustedAdvisorChecksResponse} The populated <code>DescribeTrustedAdvisorChecksResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTrustedAdvisorChecksResponse();

            if (data.hasOwnProperty('checks')) {
                obj['checks'] = ApiClient.convertToType(data['checks'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTrustedAdvisorChecksResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTrustedAdvisorChecksResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeTrustedAdvisorChecksResponse.RequiredProperties) {
        ...
        if (data['checks']) { // data not null
          Array.validateJSON(data['checks']);
        }
...
DescribeTrustedAdvisorChecksResponse.RequiredProperties = ["checks"];

/**
 * @member {Array} checks
 */
DescribeTrustedAdvisorChecksResponse.prototype['checks'] = undefined;
...
export default DescribeTrustedAdvisorChecksResponse;
