...
/**
 * The CaseDetailsRecentCommunications model module.
 * @module model/CaseDetailsRecentCommunications
 * @version 2013-04-15
 */
class CaseDetailsRecentCommunications {
    /**
     * Constructs a new <code>CaseDetailsRecentCommunications</code>.
     * @alias module:model/CaseDetailsRecentCommunications
     * @implements module:model/RecentCaseCommunications
     */
    constructor() { 
        RecentCaseCommunications.initialize(this);
        CaseDetailsRecentCommunications.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CaseDetailsRecentCommunications</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CaseDetailsRecentCommunications} obj Optional instance to populate.
     * @return {module:model/CaseDetailsRecentCommunications} The populated <code>CaseDetailsRecentCommunications</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CaseDetailsRecentCommunications();
            RecentCaseCommunications.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CaseDetailsRecentCommunications</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CaseDetailsRecentCommunications</code>.
     */
 ...
 */
CaseDetailsRecentCommunications.prototype['communications'] = undefined;

/**
 * @member {String} nextToken
 */
CaseDetailsRecentCommunications.prototype['nextToken'] = undefined;


// Implement RecentCaseCommunications interface:
/**
 * @member {Array} communications
 */
...
export default CaseDetailsRecentCommunications;
