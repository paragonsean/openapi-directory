...
/**
 * The AddAttachmentsToSetRequest model module.
 * @module model/AddAttachmentsToSetRequest
 * @version 2013-04-15
 */
class AddAttachmentsToSetRequest {
    /**
     * Constructs a new <code>AddAttachmentsToSetRequest</code>.
     * @alias module:model/AddAttachmentsToSetRequest
     * @param attachments {Array} 
     */
    constructor(attachments) { 
        
        AddAttachmentsToSetRequest.initialize(this, attachments);
    }
    ...
    /**
     * Constructs a <code>AddAttachmentsToSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddAttachmentsToSetRequest} obj Optional instance to populate.
     * @return {module:model/AddAttachmentsToSetRequest} The populated <code>AddAttachmentsToSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddAttachmentsToSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AddAttachmentsToSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddAttachmentsToSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddAttachmentsToSetRequest.RequiredProperties) {
...
AddAttachmentsToSetRequest.RequiredProperties = ["attachments"];

/**
 * @member {String} attachmentSetId
 */
AddAttachmentsToSetRequest.prototype['attachmentSetId'] = undefined;

/**
 * @member {Array} attachments
 */
AddAttachmentsToSetRequest.prototype['attachments'] = undefined;
...
export default AddAttachmentsToSetRequest;
