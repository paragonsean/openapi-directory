...
/**
 * The DescribeCommunicationsRequest model module.
 * @module model/DescribeCommunicationsRequest
 * @version 2013-04-15
 */
class DescribeCommunicationsRequest {
    /**
     * Constructs a new <code>DescribeCommunicationsRequest</code>.
     * @alias module:model/DescribeCommunicationsRequest
     * @param caseId {String} 
     */
    constructor(caseId) { 
        
        DescribeCommunicationsRequest.initialize(this, caseId);
    }
    ...
    /**
     * Constructs a <code>DescribeCommunicationsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCommunicationsRequest} obj Optional instance to populate.
     * @return {module:model/DescribeCommunicationsRequest} The populated <code>DescribeCommunicationsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCommunicationsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCommunicationsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCommunicationsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeCommunicationsRequest.RequiredProperties) {
...
DescribeCommunicationsRequest.RequiredProperties = ["caseId"];

/**
 * @member {String} caseId
 */
DescribeCommunicationsRequest.prototype['caseId'] = undefined;

/**
 * @member {String} beforeTime
 */
DescribeCommunicationsRequest.prototype['beforeTime'] = undefined;

/**
 * @member {String} afterTime
 */
DescribeCommunicationsRequest.prototype['afterTime'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeCommunicationsRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
DescribeCommunicationsRequest.prototype['maxResults'] = undefined;
...
export default DescribeCommunicationsRequest;
