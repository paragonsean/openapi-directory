...
/**
 * The DescribeCreateCaseOptionsRequest model module.
 * @module model/DescribeCreateCaseOptionsRequest
 * @version 2013-04-15
 */
class DescribeCreateCaseOptionsRequest {
    /**
     * Constructs a new <code>DescribeCreateCaseOptionsRequest</code>.
     * @alias module:model/DescribeCreateCaseOptionsRequest
     * @param issueType {String} 
     * @param serviceCode {String} 
     * @param language {String} 
     * @param categoryCode {String} 
     */
    constructor(issueType, serviceCode, language, categoryCode) { 
        
        DescribeCreateCaseOptionsRequest.initialize(this, issueType, serviceCode, language, categoryCode);
    }
     ...
     */
    static initialize(obj, issueType, serviceCode, language, categoryCode) { 
    ...
    /**
     * Constructs a <code>DescribeCreateCaseOptionsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCreateCaseOptionsRequest} obj Optional instance to populate.
     * @return {module:model/DescribeCreateCaseOptionsRequest} The populated <code>DescribeCreateCaseOptionsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCreateCaseOptionsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCreateCaseOptionsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCreateCaseOptionsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeCreateCaseOptionsRequest.RequiredProperties) {
...
DescribeCreateCaseOptionsRequest.RequiredProperties = ["issueType", "serviceCode", "language", "categoryCode"];

/**
 * @member {String} issueType
 */
DescribeCreateCaseOptionsRequest.prototype['issueType'] = undefined;

/**
 * @member {String} serviceCode
 */
DescribeCreateCaseOptionsRequest.prototype['serviceCode'] = undefined;

/**
 * @member {String} language
 */
DescribeCreateCaseOptionsRequest.prototype['language'] = undefined;

/**
 * @member {String} categoryCode
 */
DescribeCreateCaseOptionsRequest.prototype['categoryCode'] = undefined;
...
export default DescribeCreateCaseOptionsRequest;
