...
/**
 * The AttachmentDetails model module.
 * @module model/AttachmentDetails
 * @version 2013-04-15
 */
class AttachmentDetails {
    /**
     * Constructs a new <code>AttachmentDetails</code>.
     ...
     * @alias module:model/AttachmentDetails
     */
    constructor() { 
        
        AttachmentDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AttachmentDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttachmentDetails} obj Optional instance to populate.
     * @return {module:model/AttachmentDetails} The populated <code>AttachmentDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttachmentDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>AttachmentDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttachmentDetails</code>.
     */
 ...
 */
AttachmentDetails.prototype['attachmentId'] = undefined;

/**
 * @member {String} fileName
 */
AttachmentDetails.prototype['fileName'] = undefined;
