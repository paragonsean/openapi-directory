...
/**
 * The DateInterval model module.
 * @module model/DateInterval
 * @version 2013-04-15
 */
class DateInterval {
    /**
     * Constructs a new <code>DateInterval</code>.
     * Date and time (UTC) format in RFC 3339 : &#39;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZZ&#39;.
     * @alias module:model/DateInterval
     */
    constructor() { 
        
        DateInterval.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DateInterval</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DateInterval} obj Optional instance to populate.
     * @return {module:model/DateInterval} The populated <code>DateInterval</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DateInterval();
    ...
    /**
     * Validates the JSON data with respect to <code>DateInterval</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DateInterval</code>.
     */
 ...
 */
DateInterval.prototype['startDateTime'] = undefined;

/**
 * @member {String} endDateTime
 */
DateInterval.prototype['endDateTime'] = undefined;
