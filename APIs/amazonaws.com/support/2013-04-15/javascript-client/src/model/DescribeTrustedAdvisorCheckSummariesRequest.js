...
/**
 * The DescribeTrustedAdvisorCheckSummariesRequest model module.
 * @module model/DescribeTrustedAdvisorCheckSummariesRequest
 * @version 2013-04-15
 */
class DescribeTrustedAdvisorCheckSummariesRequest {
    /**
     * Constructs a new <code>DescribeTrustedAdvisorCheckSummariesRequest</code>.
     * @alias module:model/DescribeTrustedAdvisorCheckSummariesRequest
     * @param checkIds {Array} 
     */
    constructor(checkIds) { 
        
        DescribeTrustedAdvisorCheckSummariesRequest.initialize(this, checkIds);
    }
    ...
    /**
     * Constructs a <code>DescribeTrustedAdvisorCheckSummariesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTrustedAdvisorCheckSummariesRequest} obj Optional instance to populate.
     * @return {module:model/DescribeTrustedAdvisorCheckSummariesRequest} The populated <code>DescribeTrustedAdvisorCheckSummariesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTrustedAdvisorCheckSummariesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTrustedAdvisorCheckSummariesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTrustedAdvisorCheckSummariesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeTrustedAdvisorCheckSummariesRequest.RequiredProperties) {
...
DescribeTrustedAdvisorCheckSummariesRequest.RequiredProperties = ["checkIds"];

/**
 * @member {Array} checkIds
 */
DescribeTrustedAdvisorCheckSummariesRequest.prototype['checkIds'] = undefined;
...
export default DescribeTrustedAdvisorCheckSummariesRequest;
