...
/**
 * The DescribeCasesResponse model module.
 * @module model/DescribeCasesResponse
 * @version 2013-04-15
 */
class DescribeCasesResponse {
    /**
     * Constructs a new <code>DescribeCasesResponse</code>.
     ...
     * @alias module:model/DescribeCasesResponse
     */
    constructor() { 
        
        DescribeCasesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeCasesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCasesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeCasesResponse} The populated <code>DescribeCasesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCasesResponse();

            if (data.hasOwnProperty('cases')) {
                obj['cases'] = ApiClient.convertToType(data['cases'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCasesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCasesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `cases`
        if (data['cases']) { // data not null
          Array.validateJSON(data['cases']);
        }
 ...
 * @member {Array} cases
 */
DescribeCasesResponse.prototype['cases'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeCasesResponse.prototype['nextToken'] = undefined;
...
export default DescribeCasesResponse;
