...
import TrustedAdvisorCategorySpecificSummaryCostOptimizing from './TrustedAdvisorCategorySpecificSummaryCostOptimizing';

/**
 * The TrustedAdvisorCheckResultCategorySpecificSummary model module.
 * @module model/TrustedAdvisorCheckResultCategorySpecificSummary
 * @version 2013-04-15
 */
class TrustedAdvisorCheckResultCategorySpecificSummary {
    /**
     * Constructs a new <code>TrustedAdvisorCheckResultCategorySpecificSummary</code>.
     * @alias module:model/TrustedAdvisorCheckResultCategorySpecificSummary
     * @implements module:model/TrustedAdvisorCategorySpecificSummary
     */
    constructor() { 
        TrustedAdvisorCategorySpecificSummary.initialize(this);
        TrustedAdvisorCheckResultCategorySpecificSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TrustedAdvisorCheckResultCategorySpecificSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrustedAdvisorCheckResultCategorySpecificSummary} obj Optional instance to populate.
     * @return {module:model/TrustedAdvisorCheckResultCategorySpecificSummary} The populated <code>TrustedAdvisorCheckResultCategorySpecificSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrustedAdvisorCheckResultCategorySpecificSummary();
            TrustedAdvisorCategorySpecificSummary.constructFromObject(data, obj);

            if (data.hasOwnProperty('costOptimizing')) {
                obj['costOptimizing'] = TrustedAdvisorCategorySpecificSummaryCostOptimizing.constructFromObject(data['costOptimizing']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TrustedAdvisorCheckResultCategorySpecificSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrustedAdvisorCheckResultCategorySpecificSummary</code>.
     */
    static validateJSON(data) {
        // validate the optional field `costOptimizing`
        if (data['costOptimizing']) { // data not null
          TrustedAdvisorCategorySpecificSummaryCostOptimizing.validateJSON(data['costOptimizing']);
        }
...
/**
 * @member {module:model/TrustedAdvisorCategorySpecificSummaryCostOptimizing} costOptimizing
 */
TrustedAdvisorCheckResultCategorySpecificSummary.prototype['costOptimizing'] = undefined;


// Implement TrustedAdvisorCategorySpecificSummary interface:
/**
 * @member {module:model/TrustedAdvisorCategorySpecificSummaryCostOptimizing} costOptimizing
 */
TrustedAdvisorCategorySpecificSummary.prototype['costOptimizing'] = undefined;




export default TrustedAdvisorCheckResultCategorySpecificSummary;
