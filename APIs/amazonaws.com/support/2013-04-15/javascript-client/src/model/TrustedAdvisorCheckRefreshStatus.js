...
/**
 * The TrustedAdvisorCheckRefreshStatus model module.
 * @module model/TrustedAdvisorCheckRefreshStatus
 * @version 2013-04-15
 */
class TrustedAdvisorCheckRefreshStatus {
    /**
     * Constructs a new <code>TrustedAdvisorCheckRefreshStatus</code>.
     * The refresh status of a Trusted Advisor check.
     * @alias module:model/TrustedAdvisorCheckRefreshStatus
    ...
    /**
     * Constructs a <code>TrustedAdvisorCheckRefreshStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrustedAdvisorCheckRefreshStatus} obj Optional instance to populate.
     * @return {module:model/TrustedAdvisorCheckRefreshStatus} The populated <code>TrustedAdvisorCheckRefreshStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrustedAdvisorCheckRefreshStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>TrustedAdvisorCheckRefreshStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrustedAdvisorCheckRefreshStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TrustedAdvisorCheckRefreshStatus.RequiredProperties) {
...
TrustedAdvisorCheckRefreshStatus.RequiredProperties = ["checkId", "status", "millisUntilNextRefreshable"];
...
export default TrustedAdvisorCheckRefreshStatus;
