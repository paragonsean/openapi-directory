...
/**
 * The DescribeTrustedAdvisorCheckRefreshStatusesResponse model module.
 * @module model/DescribeTrustedAdvisorCheckRefreshStatusesResponse
 * @version 2013-04-15
 */
class DescribeTrustedAdvisorCheckRefreshStatusesResponse {
    /**
     * Constructs a new <code>DescribeTrustedAdvisorCheckRefreshStatusesResponse</code>.
     * The statuses of the Trusted Advisor checks returned by the &lt;a&gt;DescribeTrustedAdvisorCheckRefreshStatuses&lt;/a&gt; operation.
     * @alias module:model/DescribeTrustedAdvisorCheckRefreshStatusesResponse
     * @param statuses {Array} 
     */
    constructor(statuses) { 
        
        DescribeTrustedAdvisorCheckRefreshStatusesResponse.initialize(this, statuses);
    }
    ...
    /**
     * Constructs a <code>DescribeTrustedAdvisorCheckRefreshStatusesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTrustedAdvisorCheckRefreshStatusesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeTrustedAdvisorCheckRefreshStatusesResponse} The populated <code>DescribeTrustedAdvisorCheckRefreshStatusesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTrustedAdvisorCheckRefreshStatusesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTrustedAdvisorCheckRefreshStatusesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTrustedAdvisorCheckRefreshStatusesResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeTrustedAdvisorCheckRefreshStatusesResponse.RequiredProperties) {
...
DescribeTrustedAdvisorCheckRefreshStatusesResponse.RequiredProperties = ["statuses"];

/**
 * @member {Array} statuses
 */
DescribeTrustedAdvisorCheckRefreshStatusesResponse.prototype['statuses'] = undefined;
...
export default DescribeTrustedAdvisorCheckRefreshStatusesResponse;
