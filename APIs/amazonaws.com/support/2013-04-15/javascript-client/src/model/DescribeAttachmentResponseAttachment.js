...
/**
 * The DescribeAttachmentResponseAttachment model module.
 * @module model/DescribeAttachmentResponseAttachment
 * @version 2013-04-15
 */
class DescribeAttachmentResponseAttachment {
    /**
     * Constructs a new <code>DescribeAttachmentResponseAttachment</code>.
     * @alias module:model/DescribeAttachmentResponseAttachment
     * @implements module:model/Attachment
     */
    constructor() { 
        Attachment.initialize(this);
        DescribeAttachmentResponseAttachment.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAttachmentResponseAttachment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAttachmentResponseAttachment} obj Optional instance to populate.
     * @return {module:model/DescribeAttachmentResponseAttachment} The populated <code>DescribeAttachmentResponseAttachment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAttachmentResponseAttachment();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAttachmentResponseAttachment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAttachmentResponseAttachment</code>.
     */
 ...
 */
DescribeAttachmentResponseAttachment.prototype['fileName'] = undefined;

/**
 * @member {String} data
 */
DescribeAttachmentResponseAttachment.prototype['data'] = undefined;
 ...
 * @member {String} data
 */
Attachment.prototype['data'] = undefined;




export default DescribeAttachmentResponseAttachment;
