...
/**
 * The DescribeAttachmentRequest model module.
 * @module model/DescribeAttachmentRequest
 * @version 2013-04-15
 */
class DescribeAttachmentRequest {
    /**
     * Constructs a new <code>DescribeAttachmentRequest</code>.
     * @alias module:model/DescribeAttachmentRequest
     * @param attachmentId {String} 
     */
    constructor(attachmentId) { 
        
        DescribeAttachmentRequest.initialize(this, attachmentId);
    }
    ...
    /**
     * Constructs a <code>DescribeAttachmentRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAttachmentRequest} obj Optional instance to populate.
     * @return {module:model/DescribeAttachmentRequest} The populated <code>DescribeAttachmentRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAttachmentRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAttachmentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAttachmentRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeAttachmentRequest.RequiredProperties) {
...
DescribeAttachmentRequest.RequiredProperties = ["attachmentId"];

/**
 * @member {String} attachmentId
 */
DescribeAttachmentRequest.prototype['attachmentId'] = undefined;
...
export default DescribeAttachmentRequest;
