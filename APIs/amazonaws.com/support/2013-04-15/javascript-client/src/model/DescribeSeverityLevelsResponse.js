...
/**
 * The DescribeSeverityLevelsResponse model module.
 * @module model/DescribeSeverityLevelsResponse
 * @version 2013-04-15
 */
class DescribeSeverityLevelsResponse {
    /**
     * Constructs a new <code>DescribeSeverityLevelsResponse</code>.
     * The list of severity levels returned by the &lt;a&gt;DescribeSeverityLevels&lt;/a&gt; operation.
     * @alias module:model/DescribeSeverityLevelsResponse
     */
    constructor() { 
        
        DescribeSeverityLevelsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeSeverityLevelsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeSeverityLevelsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeSeverityLevelsResponse} The populated <code>DescribeSeverityLevelsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeSeverityLevelsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeSeverityLevelsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeSeverityLevelsResponse</code>.
     */
 ...
 */
DescribeSeverityLevelsResponse.prototype['severityLevels'] = undefined;
...
export default DescribeSeverityLevelsResponse;
