...
/**
 * The CreateCaseResponse model module.
 * @module model/CreateCaseResponse
 * @version 2013-04-15
 */
class CreateCaseResponse {
    /**
     * Constructs a new <code>CreateCaseResponse</code>.
     * The support case ID returned by a successful completion of the &lt;a&gt;CreateCase&lt;/a&gt; operation.
     * @alias module:model/CreateCaseResponse
     */
    constructor() { 
        
        CreateCaseResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateCaseResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCaseResponse} obj Optional instance to populate.
     * @return {module:model/CreateCaseResponse} The populated <code>CreateCaseResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCaseResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCaseResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCaseResponse</code>.
     */
 ...
 */
CreateCaseResponse.prototype['caseId'] = undefined;
...
export default CreateCaseResponse;
