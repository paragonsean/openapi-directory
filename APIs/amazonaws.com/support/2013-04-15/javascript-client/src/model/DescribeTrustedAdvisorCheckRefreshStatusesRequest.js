...
/**
 * The DescribeTrustedAdvisorCheckRefreshStatusesRequest model module.
 * @module model/DescribeTrustedAdvisorCheckRefreshStatusesRequest
 * @version 2013-04-15
 */
class DescribeTrustedAdvisorCheckRefreshStatusesRequest {
    /**
     * Constructs a new <code>DescribeTrustedAdvisorCheckRefreshStatusesRequest</code>.
     * @alias module:model/DescribeTrustedAdvisorCheckRefreshStatusesRequest
     * @param checkIds {Array} 
     */
    constructor(checkIds) { 
        
        DescribeTrustedAdvisorCheckRefreshStatusesRequest.initialize(this, checkIds);
    }
     ...
     */
    static initialize(obj, checkIds) { 
        obj['checkIds'] = checkIds;
    }

    /**
     * Constructs a <code>DescribeTrustedAdvisorCheckRefreshStatusesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTrustedAdvisorCheckRefreshStatusesRequest} obj Optional instance to populate.
     * @return {module:model/DescribeTrustedAdvisorCheckRefreshStatusesRequest} The populated <code>DescribeTrustedAdvisorCheckRefreshStatusesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTrustedAdvisorCheckRefreshStatusesRequest();

            if (data.hasOwnProperty('checkIds')) {
                obj['checkIds'] = ApiClient.convertToType(data['checkIds'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTrustedAdvisorCheckRefreshStatusesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTrustedAdvisorCheckRefreshStatusesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeTrustedAdvisorCheckRefreshStatusesRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `checkIds`
        if (data['checkIds']) { // data not null
          Array.validateJSON(data['checkIds']);
        }
...
DescribeTrustedAdvisorCheckRefreshStatusesRequest.RequiredProperties = ["checkIds"];

/**
 * @member {Array} checkIds
 */
DescribeTrustedAdvisorCheckRefreshStatusesRequest.prototype['checkIds'] = undefined;
...
export default DescribeTrustedAdvisorCheckRefreshStatusesRequest;
