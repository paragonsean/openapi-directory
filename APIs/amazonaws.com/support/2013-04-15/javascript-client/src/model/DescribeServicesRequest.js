...
/**
 * The DescribeServicesRequest model module.
 * @module model/DescribeServicesRequest
 * @version 2013-04-15
 */
class DescribeServicesRequest {
    /**
     * Constructs a new <code>DescribeServicesRequest</code>.
     * @alias module:model/DescribeServicesRequest
     */
    constructor() { 
        
        DescribeServicesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeServicesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeServicesRequest} obj Optional instance to populate.
     * @return {module:model/DescribeServicesRequest} The populated <code>DescribeServicesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeServicesRequest();

            if (data.hasOwnProperty('serviceCodeList')) {
                obj['serviceCodeList'] = ApiClient.convertToType(data['serviceCodeList'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeServicesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeServicesRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `serviceCodeList`
        if (data['serviceCodeList']) { // data not null
          Array.validateJSON(data['serviceCodeList']);
        }
...
/**
 * @member {Array} serviceCodeList
 */
DescribeServicesRequest.prototype['serviceCodeList'] = undefined;

/**
 * @member {String} language
 */
DescribeServicesRequest.prototype['language'] = undefined;
...
export default DescribeServicesRequest;
