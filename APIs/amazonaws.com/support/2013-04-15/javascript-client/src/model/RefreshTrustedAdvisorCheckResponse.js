...
import RefreshTrustedAdvisorCheckResponseStatus from './RefreshTrustedAdvisorCheckResponseStatus';

/**
 * The RefreshTrustedAdvisorCheckResponse model module.
 * @module model/RefreshTrustedAdvisorCheckResponse
 * @version 2013-04-15
 */
class RefreshTrustedAdvisorCheckResponse {
    /**
     * Constructs a new <code>RefreshTrustedAdvisorCheckResponse</code>.
     * The current refresh status of a Trusted Advisor check.
     * @alias module:model/RefreshTrustedAdvisorCheckResponse
     * @param status {module:model/RefreshTrustedAdvisorCheckResponseStatus} 
     */
    constructor(status) { 
        
        RefreshTrustedAdvisorCheckResponse.initialize(this, status);
    }
    ...
    /**
     * Constructs a <code>RefreshTrustedAdvisorCheckResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RefreshTrustedAdvisorCheckResponse} obj Optional instance to populate.
     * @return {module:model/RefreshTrustedAdvisorCheckResponse} The populated <code>RefreshTrustedAdvisorCheckResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RefreshTrustedAdvisorCheckResponse();

            if (data.hasOwnProperty('status')) {
                obj['status'] = RefreshTrustedAdvisorCheckResponseStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RefreshTrustedAdvisorCheckResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RefreshTrustedAdvisorCheckResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RefreshTrustedAdvisorCheckResponse.RequiredProperties) {
        ...
        if (data['status']) { // data not null
          RefreshTrustedAdvisorCheckResponseStatus.validateJSON(data['status']);
        }
...
RefreshTrustedAdvisorCheckResponse.RequiredProperties = ["status"];

/**
 * @member {module:model/RefreshTrustedAdvisorCheckResponseStatus} status
 */
RefreshTrustedAdvisorCheckResponse.prototype['status'] = undefined;
...
export default RefreshTrustedAdvisorCheckResponse;
