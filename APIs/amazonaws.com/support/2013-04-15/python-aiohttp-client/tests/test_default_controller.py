...
async def test_add_attachments_to_set(client):
    """Test case for add_attachments_to_set

    
    """
    body = {"attachments":"","attachmentSetId":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.AddAttachmentsToSet',
        headers=headers,
        json=body,
        )
...
async def test_add_communication_to_case(client):
    """Test case for add_communication_to_case

    
    """
    body = {"caseId":"","ccEmailAddresses":"","attachmentSetId":"","communicationBody":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.AddCommunicationToCase',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_case(client):
    ...
    """
    body = {"issueType":"","serviceCode":"","subject":"","ccEmailAddresses":"","attachmentSetId":"","communicationBody":"","language":"","severityCode":"","categoryCode":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.CreateCase',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_attachment(client):
    """Test case for describe_attachment
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.DescribeAttachment',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_cases(client):
    """Test case for describe_cases

    
    """
    body = {"caseIdList":"","beforeTime":"","nextToken":"","maxResults":"","afterTime":"","language":"","displayId":"","includeResolvedCases":"","includeCommunications":""}
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.DescribeCases',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_communications(client):
    """Test case for describe_communications

    
    """
    body = {"beforeTime":"","nextToken":"","maxResults":"","caseId":"","afterTime":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.DescribeCommunications',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_create_case_options(client):
    """Test case for describe_create_case_options

    
    """
    body = {"issueType":"","serviceCode":"","language":"","categoryCode":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.DescribeCreateCaseOptions',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_services(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.DescribeServices',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_severity_levels(client):
    """Test case for describe_severity_levels
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.DescribeSeverityLevels',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_supported_languages(client):
    """Test case for describe_supported_languages

    
    """
    body = {"issueType":"","serviceCode":"","categoryCode":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.DescribeSupportedLanguages',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_trusted_advisor_check_refresh_statuses(client):
    """Test case for describe_trusted_advisor_check_refresh_statuses
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.DescribeTrustedAdvisorCheckRefreshStatuses',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_trusted_advisor_check_result(client):
    """Test case for describe_trusted_advisor_check_result

    
    """
    body = {"language":"","checkId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.DescribeTrustedAdvisorCheckResult',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_trusted_advisor_check_summaries(client):
    """Test case for describe_trusted_advisor_check_summaries
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.DescribeTrustedAdvisorCheckSummaries',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_trusted_advisor_checks(client):
    """Test case for describe_trusted_advisor_checks
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.DescribeTrustedAdvisorChecks',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_refresh_trusted_advisor_check(client):
    """Test case for refresh_trusted_advisor_check
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.RefreshTrustedAdvisorCheck',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_resolve_case(client):
    """Test case for resolve_case
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSSupport_20130415.ResolveCase',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
