...
public class ResolveCaseRequest {
  ...
  public ResolveCaseRequest caseId(String caseId) {
    this.caseId = caseId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResolveCaseRequest resolveCaseRequest = (ResolveCaseRequest) o;
    return Objects.equals(this.caseId, resolveCaseRequest.caseId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResolveCaseRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResolveCaseRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResolveCaseRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResolveCaseRequest is not found in the empty JSON string", ResolveCaseRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResolveCaseRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResolveCaseRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResolveCaseRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResolveCaseRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResolveCaseRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResolveCaseRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ResolveCaseRequest>() {
           @Override
           public void write(JsonWriter out, ResolveCaseRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResolveCaseRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResolveCaseRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResolveCaseRequest
   * @throws IOException if the JSON string is invalid with respect to ResolveCaseRequest
   */
  public static ResolveCaseRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResolveCaseRequest.class);
  }

  /**
   * Convert an instance of ResolveCaseRequest to an JSON string
   *
   * @return JSON string
   */
