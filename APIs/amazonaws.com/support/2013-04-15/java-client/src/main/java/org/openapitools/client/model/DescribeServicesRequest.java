...
public class DescribeServicesRequest {
  public static final String SERIALIZED_NAME_SERVICE_CODE_LIST = "serviceCodeList";
  ...
  public DescribeServicesRequest serviceCodeList(List serviceCodeList) {
  ...
  public DescribeServicesRequest language(String language) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeServicesRequest describeServicesRequest = (DescribeServicesRequest) o;
    return Objects.equals(this.serviceCodeList, describeServicesRequest.serviceCodeList) &&
        Objects.equals(this.language, describeServicesRequest.language);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serviceCodeList, language);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeServicesRequest {\n");
  ...
  static {
    ...
    openapiFields.add("serviceCodeList");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeServicesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeServicesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeServicesRequest is not found in the empty JSON string", DescribeServicesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeServicesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeServicesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `serviceCodeList`
      if (jsonObj.get("serviceCodeList") != null && !jsonObj.get("serviceCodeList").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("serviceCodeList"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeServicesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeServicesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeServicesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeServicesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeServicesRequest>() {
           @Override
           public void write(JsonWriter out, DescribeServicesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeServicesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeServicesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeServicesRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeServicesRequest
   */
  public static DescribeServicesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeServicesRequest.class);
  }

  /**
   * Convert an instance of DescribeServicesRequest to an JSON string
   *
   * @return JSON string
   */
