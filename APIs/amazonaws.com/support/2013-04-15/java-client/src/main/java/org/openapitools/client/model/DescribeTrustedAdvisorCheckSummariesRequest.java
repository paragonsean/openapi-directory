...
public class DescribeTrustedAdvisorCheckSummariesRequest {
  public static final String SERIALIZED_NAME_CHECK_IDS = "checkIds";
  @SerializedName(SERIALIZED_NAME_CHECK_IDS)
  private List checkIds;

  public DescribeTrustedAdvisorCheckSummariesRequest() {
  }

  public DescribeTrustedAdvisorCheckSummariesRequest checkIds(List checkIds) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeTrustedAdvisorCheckSummariesRequest describeTrustedAdvisorCheckSummariesRequest = (DescribeTrustedAdvisorCheckSummariesRequest) o;
    return Objects.equals(this.checkIds, describeTrustedAdvisorCheckSummariesRequest.checkIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(checkIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeTrustedAdvisorCheckSummariesRequest {\n");
  ...
  static {
    ...
    openapiFields.add("checkIds");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("checkIds");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTrustedAdvisorCheckSummariesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTrustedAdvisorCheckSummariesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTrustedAdvisorCheckSummariesRequest is not found in the empty JSON string", DescribeTrustedAdvisorCheckSummariesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTrustedAdvisorCheckSummariesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTrustedAdvisorCheckSummariesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeTrustedAdvisorCheckSummariesRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `checkIds`
      List.validateJsonElement(jsonObj.get("checkIds"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTrustedAdvisorCheckSummariesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTrustedAdvisorCheckSummariesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTrustedAdvisorCheckSummariesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTrustedAdvisorCheckSummariesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTrustedAdvisorCheckSummariesRequest>() {
           @Override
           public void write(JsonWriter out, DescribeTrustedAdvisorCheckSummariesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTrustedAdvisorCheckSummariesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTrustedAdvisorCheckSummariesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTrustedAdvisorCheckSummariesRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeTrustedAdvisorCheckSummariesRequest
   */
  public static DescribeTrustedAdvisorCheckSummariesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTrustedAdvisorCheckSummariesRequest.class);
  }

  /**
   * Convert an instance of DescribeTrustedAdvisorCheckSummariesRequest to an JSON string
   *
   * @return JSON string
   */
