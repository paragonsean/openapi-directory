...
public class DescribeCommunicationsRequest {
  ...
  public DescribeCommunicationsRequest caseId(String caseId) {
    this.caseId = caseId;
    return this;
  }
  ...
  public DescribeCommunicationsRequest beforeTime(String beforeTime) {
  ...
  public DescribeCommunicationsRequest afterTime(String afterTime) {
  ...
  public DescribeCommunicationsRequest nextToken(String nextToken) {
  ...
  public DescribeCommunicationsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeCommunicationsRequest describeCommunicationsRequest = (DescribeCommunicationsRequest) o;
    return Objects.equals(this.caseId, describeCommunicationsRequest.caseId) &&
        Objects.equals(this.beforeTime, describeCommunicationsRequest.beforeTime) &&
        Objects.equals(this.afterTime, describeCommunicationsRequest.afterTime) &&
        Objects.equals(this.nextToken, describeCommunicationsRequest.nextToken) &&
        Objects.equals(this.maxResults, describeCommunicationsRequest.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(caseId, beforeTime, afterTime, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeCommunicationsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCommunicationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCommunicationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCommunicationsRequest is not found in the empty JSON string", DescribeCommunicationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCommunicationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCommunicationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeCommunicationsRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `caseId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCommunicationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCommunicationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCommunicationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCommunicationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCommunicationsRequest>() {
           @Override
           public void write(JsonWriter out, DescribeCommunicationsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCommunicationsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCommunicationsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCommunicationsRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeCommunicationsRequest
   */
  public static DescribeCommunicationsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCommunicationsRequest.class);
  }

  /**
   * Convert an instance of DescribeCommunicationsRequest to an JSON string
   *
   * @return JSON string
   */
