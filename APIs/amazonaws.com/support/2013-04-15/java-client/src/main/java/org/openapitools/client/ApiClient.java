...
public class ApiClient {
    ...
    private String basePath = "https://support.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2013-04-15/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://support.us-east-1.amazonaws.com
