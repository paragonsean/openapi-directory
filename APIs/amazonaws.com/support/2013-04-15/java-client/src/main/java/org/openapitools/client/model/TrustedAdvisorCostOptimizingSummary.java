...
public class TrustedAdvisorCostOptimizingSummary {
  ...
  public TrustedAdvisorCostOptimizingSummary estimatedMonthlySavings(Double estimatedMonthlySavings) {
  ...
  public TrustedAdvisorCostOptimizingSummary estimatedPercentMonthlySavings(Double estimatedPercentMonthlySavings) {
  ...
  public boolean equals(Object o) {
    ...
    TrustedAdvisorCostOptimizingSummary trustedAdvisorCostOptimizingSummary = (TrustedAdvisorCostOptimizingSummary) o;
    return Objects.equals(this.estimatedMonthlySavings, trustedAdvisorCostOptimizingSummary.estimatedMonthlySavings) &&
        Objects.equals(this.estimatedPercentMonthlySavings, trustedAdvisorCostOptimizingSummary.estimatedPercentMonthlySavings);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrustedAdvisorCostOptimizingSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrustedAdvisorCostOptimizingSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrustedAdvisorCostOptimizingSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrustedAdvisorCostOptimizingSummary is not found in the empty JSON string", TrustedAdvisorCostOptimizingSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrustedAdvisorCostOptimizingSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrustedAdvisorCostOptimizingSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrustedAdvisorCostOptimizingSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrustedAdvisorCostOptimizingSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrustedAdvisorCostOptimizingSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrustedAdvisorCostOptimizingSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrustedAdvisorCostOptimizingSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<TrustedAdvisorCostOptimizingSummary>() {
           @Override
           public void write(JsonWriter out, TrustedAdvisorCostOptimizingSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrustedAdvisorCostOptimizingSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrustedAdvisorCostOptimizingSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrustedAdvisorCostOptimizingSummary
   * @throws IOException if the JSON string is invalid with respect to TrustedAdvisorCostOptimizingSummary
   */
  public static TrustedAdvisorCostOptimizingSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrustedAdvisorCostOptimizingSummary.class);
  }

  /**
   * Convert an instance of TrustedAdvisorCostOptimizingSummary to an JSON string
   *
   * @return JSON string
   */
