...
import org.openapitools.client.model.RefreshTrustedAdvisorCheckResponseStatus;
...
public class RefreshTrustedAdvisorCheckResponse {
  ...
  private RefreshTrustedAdvisorCheckResponseStatus status;

  public RefreshTrustedAdvisorCheckResponse() {
  }

  public RefreshTrustedAdvisorCheckResponse status(RefreshTrustedAdvisorCheckResponseStatus status) {
    this.status = status;
    return this;
  }
  ...
  public RefreshTrustedAdvisorCheckResponseStatus getStatus() {
    return status;
  }

  public void setStatus(RefreshTrustedAdvisorCheckResponseStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    RefreshTrustedAdvisorCheckResponse refreshTrustedAdvisorCheckResponse = (RefreshTrustedAdvisorCheckResponse) o;
    return Objects.equals(this.status, refreshTrustedAdvisorCheckResponse.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class RefreshTrustedAdvisorCheckResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RefreshTrustedAdvisorCheckResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RefreshTrustedAdvisorCheckResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RefreshTrustedAdvisorCheckResponse is not found in the empty JSON string", RefreshTrustedAdvisorCheckResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RefreshTrustedAdvisorCheckResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RefreshTrustedAdvisorCheckResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RefreshTrustedAdvisorCheckResponse.openapiRequiredFields) {
      ...
      RefreshTrustedAdvisorCheckResponseStatus.validateJsonElement(jsonObj.get("status"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RefreshTrustedAdvisorCheckResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RefreshTrustedAdvisorCheckResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RefreshTrustedAdvisorCheckResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RefreshTrustedAdvisorCheckResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RefreshTrustedAdvisorCheckResponse>() {
           @Override
           public void write(JsonWriter out, RefreshTrustedAdvisorCheckResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RefreshTrustedAdvisorCheckResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RefreshTrustedAdvisorCheckResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RefreshTrustedAdvisorCheckResponse
   * @throws IOException if the JSON string is invalid with respect to RefreshTrustedAdvisorCheckResponse
   */
  public static RefreshTrustedAdvisorCheckResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RefreshTrustedAdvisorCheckResponse.class);
  }

  /**
   * Convert an instance of RefreshTrustedAdvisorCheckResponse to an JSON string
   *
   * @return JSON string
   */
