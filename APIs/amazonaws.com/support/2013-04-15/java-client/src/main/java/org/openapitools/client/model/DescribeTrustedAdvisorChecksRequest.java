...
public class DescribeTrustedAdvisorChecksRequest {
  ...
  public DescribeTrustedAdvisorChecksRequest language(String language) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeTrustedAdvisorChecksRequest describeTrustedAdvisorChecksRequest = (DescribeTrustedAdvisorChecksRequest) o;
    return Objects.equals(this.language, describeTrustedAdvisorChecksRequest.language);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTrustedAdvisorChecksRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTrustedAdvisorChecksRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTrustedAdvisorChecksRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTrustedAdvisorChecksRequest is not found in the empty JSON string", DescribeTrustedAdvisorChecksRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTrustedAdvisorChecksRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTrustedAdvisorChecksRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeTrustedAdvisorChecksRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTrustedAdvisorChecksRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTrustedAdvisorChecksRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTrustedAdvisorChecksRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTrustedAdvisorChecksRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTrustedAdvisorChecksRequest>() {
           @Override
           public void write(JsonWriter out, DescribeTrustedAdvisorChecksRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTrustedAdvisorChecksRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTrustedAdvisorChecksRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTrustedAdvisorChecksRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeTrustedAdvisorChecksRequest
   */
  public static DescribeTrustedAdvisorChecksRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTrustedAdvisorChecksRequest.class);
  }

  /**
   * Convert an instance of DescribeTrustedAdvisorChecksRequest to an JSON string
   *
   * @return JSON string
   */
