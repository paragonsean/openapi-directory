...
public class DescribeTrustedAdvisorCheckSummariesResponse {
  ...
  public DescribeTrustedAdvisorCheckSummariesResponse summaries(List summaries) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeTrustedAdvisorCheckSummariesResponse describeTrustedAdvisorCheckSummariesResponse = (DescribeTrustedAdvisorCheckSummariesResponse) o;
    return Objects.equals(this.summaries, describeTrustedAdvisorCheckSummariesResponse.summaries);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTrustedAdvisorCheckSummariesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTrustedAdvisorCheckSummariesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTrustedAdvisorCheckSummariesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTrustedAdvisorCheckSummariesResponse is not found in the empty JSON string", DescribeTrustedAdvisorCheckSummariesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTrustedAdvisorCheckSummariesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTrustedAdvisorCheckSummariesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeTrustedAdvisorCheckSummariesResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `summaries`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTrustedAdvisorCheckSummariesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTrustedAdvisorCheckSummariesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTrustedAdvisorCheckSummariesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTrustedAdvisorCheckSummariesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTrustedAdvisorCheckSummariesResponse>() {
           @Override
           public void write(JsonWriter out, DescribeTrustedAdvisorCheckSummariesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTrustedAdvisorCheckSummariesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTrustedAdvisorCheckSummariesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTrustedAdvisorCheckSummariesResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeTrustedAdvisorCheckSummariesResponse
   */
  public static DescribeTrustedAdvisorCheckSummariesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTrustedAdvisorCheckSummariesResponse.class);
  }

  /**
   * Convert an instance of DescribeTrustedAdvisorCheckSummariesResponse to an JSON string
   *
   * @return JSON string
   */
