...
public class CaseDetailsRecentCommunications {
  ...
  public CaseDetailsRecentCommunications() {
  }

  public CaseDetailsRecentCommunications communications(List communications) {
  ...
  public CaseDetailsRecentCommunications nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    CaseDetailsRecentCommunications caseDetailsRecentCommunications = (CaseDetailsRecentCommunications) o;
    return Objects.equals(this.communications, caseDetailsRecentCommunications.communications) &&
        Objects.equals(this.nextToken, caseDetailsRecentCommunications.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class CaseDetailsRecentCommunications {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CaseDetailsRecentCommunications
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CaseDetailsRecentCommunications.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CaseDetailsRecentCommunications is not found in the empty JSON string", CaseDetailsRecentCommunications.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CaseDetailsRecentCommunications.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CaseDetailsRecentCommunications` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CaseDetailsRecentCommunications.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CaseDetailsRecentCommunications' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CaseDetailsRecentCommunications> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CaseDetailsRecentCommunications.class));

       return (TypeAdapter<T>) new TypeAdapter<CaseDetailsRecentCommunications>() {
           @Override
           public void write(JsonWriter out, CaseDetailsRecentCommunications value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CaseDetailsRecentCommunications read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CaseDetailsRecentCommunications given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CaseDetailsRecentCommunications
   * @throws IOException if the JSON string is invalid with respect to CaseDetailsRecentCommunications
   */
  public static CaseDetailsRecentCommunications fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CaseDetailsRecentCommunications.class);
  }

  /**
   * Convert an instance of CaseDetailsRecentCommunications to an JSON string
   *
   * @return JSON string
   */
