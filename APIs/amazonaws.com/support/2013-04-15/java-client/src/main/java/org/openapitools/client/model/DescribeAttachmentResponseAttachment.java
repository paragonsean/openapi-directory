...
public class DescribeAttachmentResponseAttachment {
  ...
  public DescribeAttachmentResponseAttachment() {
  }

  public DescribeAttachmentResponseAttachment fileName(String fileName) {
  ...
  public DescribeAttachmentResponseAttachment data(String data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeAttachmentResponseAttachment describeAttachmentResponseAttachment = (DescribeAttachmentResponseAttachment) o;
    return Objects.equals(this.fileName, describeAttachmentResponseAttachment.fileName) &&
        Objects.equals(this.data, describeAttachmentResponseAttachment.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeAttachmentResponseAttachment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAttachmentResponseAttachment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAttachmentResponseAttachment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAttachmentResponseAttachment is not found in the empty JSON string", DescribeAttachmentResponseAttachment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAttachmentResponseAttachment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAttachmentResponseAttachment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAttachmentResponseAttachment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAttachmentResponseAttachment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAttachmentResponseAttachment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAttachmentResponseAttachment.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAttachmentResponseAttachment>() {
           @Override
           public void write(JsonWriter out, DescribeAttachmentResponseAttachment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAttachmentResponseAttachment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAttachmentResponseAttachment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAttachmentResponseAttachment
   * @throws IOException if the JSON string is invalid with respect to DescribeAttachmentResponseAttachment
   */
  public static DescribeAttachmentResponseAttachment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAttachmentResponseAttachment.class);
  }

  /**
   * Convert an instance of DescribeAttachmentResponseAttachment to an JSON string
   *
   * @return JSON string
   */
