...
public class DescribeTrustedAdvisorCheckResultRequest {
  ...
  public DescribeTrustedAdvisorCheckResultRequest checkId(String checkId) {
  ...
  public DescribeTrustedAdvisorCheckResultRequest language(String language) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeTrustedAdvisorCheckResultRequest describeTrustedAdvisorCheckResultRequest = (DescribeTrustedAdvisorCheckResultRequest) o;
    return Objects.equals(this.checkId, describeTrustedAdvisorCheckResultRequest.checkId) &&
        Objects.equals(this.language, describeTrustedAdvisorCheckResultRequest.language);
  }

  @Override
  public int hashCode() {
    return Objects.hash(checkId, language);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeTrustedAdvisorCheckResultRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTrustedAdvisorCheckResultRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTrustedAdvisorCheckResultRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTrustedAdvisorCheckResultRequest is not found in the empty JSON string", DescribeTrustedAdvisorCheckResultRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTrustedAdvisorCheckResultRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTrustedAdvisorCheckResultRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeTrustedAdvisorCheckResultRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTrustedAdvisorCheckResultRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTrustedAdvisorCheckResultRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTrustedAdvisorCheckResultRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTrustedAdvisorCheckResultRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTrustedAdvisorCheckResultRequest>() {
           @Override
           public void write(JsonWriter out, DescribeTrustedAdvisorCheckResultRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTrustedAdvisorCheckResultRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTrustedAdvisorCheckResultRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTrustedAdvisorCheckResultRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeTrustedAdvisorCheckResultRequest
   */
  public static DescribeTrustedAdvisorCheckResultRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTrustedAdvisorCheckResultRequest.class);
  }

  /**
   * Convert an instance of DescribeTrustedAdvisorCheckResultRequest to an JSON string
   *
   * @return JSON string
   */
