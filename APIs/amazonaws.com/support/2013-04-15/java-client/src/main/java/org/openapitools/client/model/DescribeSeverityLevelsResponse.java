...
public class DescribeSeverityLevelsResponse {
  ...
  public DescribeSeverityLevelsResponse severityLevels(List severityLevels) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeSeverityLevelsResponse describeSeverityLevelsResponse = (DescribeSeverityLevelsResponse) o;
    return Objects.equals(this.severityLevels, describeSeverityLevelsResponse.severityLevels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(severityLevels);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeSeverityLevelsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeSeverityLevelsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeSeverityLevelsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeSeverityLevelsResponse is not found in the empty JSON string", DescribeSeverityLevelsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeSeverityLevelsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeSeverityLevelsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeSeverityLevelsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeSeverityLevelsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeSeverityLevelsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeSeverityLevelsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeSeverityLevelsResponse>() {
           @Override
           public void write(JsonWriter out, DescribeSeverityLevelsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeSeverityLevelsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeSeverityLevelsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeSeverityLevelsResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeSeverityLevelsResponse
   */
  public static DescribeSeverityLevelsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeSeverityLevelsResponse.class);
  }

  /**
   * Convert an instance of DescribeSeverityLevelsResponse to an JSON string
   *
   * @return JSON string
   */
