...
public class RefreshTrustedAdvisorCheckRequest {
  ...
  public RefreshTrustedAdvisorCheckRequest checkId(String checkId) {
  ...
  public boolean equals(Object o) {
    ...
    RefreshTrustedAdvisorCheckRequest refreshTrustedAdvisorCheckRequest = (RefreshTrustedAdvisorCheckRequest) o;
    return Objects.equals(this.checkId, refreshTrustedAdvisorCheckRequest.checkId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RefreshTrustedAdvisorCheckRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RefreshTrustedAdvisorCheckRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RefreshTrustedAdvisorCheckRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RefreshTrustedAdvisorCheckRequest is not found in the empty JSON string", RefreshTrustedAdvisorCheckRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RefreshTrustedAdvisorCheckRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RefreshTrustedAdvisorCheckRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RefreshTrustedAdvisorCheckRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RefreshTrustedAdvisorCheckRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RefreshTrustedAdvisorCheckRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RefreshTrustedAdvisorCheckRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RefreshTrustedAdvisorCheckRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RefreshTrustedAdvisorCheckRequest>() {
           @Override
           public void write(JsonWriter out, RefreshTrustedAdvisorCheckRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RefreshTrustedAdvisorCheckRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RefreshTrustedAdvisorCheckRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RefreshTrustedAdvisorCheckRequest
   * @throws IOException if the JSON string is invalid with respect to RefreshTrustedAdvisorCheckRequest
   */
  public static RefreshTrustedAdvisorCheckRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RefreshTrustedAdvisorCheckRequest.class);
  }

  /**
   * Convert an instance of RefreshTrustedAdvisorCheckRequest to an JSON string
   *
   * @return JSON string
   */
