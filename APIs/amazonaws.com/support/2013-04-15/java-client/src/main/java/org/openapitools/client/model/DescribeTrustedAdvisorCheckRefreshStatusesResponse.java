...
public class DescribeTrustedAdvisorCheckRefreshStatusesResponse {
  ...
  public DescribeTrustedAdvisorCheckRefreshStatusesResponse() {
  }

  public DescribeTrustedAdvisorCheckRefreshStatusesResponse statuses(List statuses) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeTrustedAdvisorCheckRefreshStatusesResponse describeTrustedAdvisorCheckRefreshStatusesResponse = (DescribeTrustedAdvisorCheckRefreshStatusesResponse) o;
    return Objects.equals(this.statuses, describeTrustedAdvisorCheckRefreshStatusesResponse.statuses);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTrustedAdvisorCheckRefreshStatusesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTrustedAdvisorCheckRefreshStatusesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTrustedAdvisorCheckRefreshStatusesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTrustedAdvisorCheckRefreshStatusesResponse is not found in the empty JSON string", DescribeTrustedAdvisorCheckRefreshStatusesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTrustedAdvisorCheckRefreshStatusesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTrustedAdvisorCheckRefreshStatusesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeTrustedAdvisorCheckRefreshStatusesResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTrustedAdvisorCheckRefreshStatusesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTrustedAdvisorCheckRefreshStatusesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTrustedAdvisorCheckRefreshStatusesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTrustedAdvisorCheckRefreshStatusesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTrustedAdvisorCheckRefreshStatusesResponse>() {
           @Override
           public void write(JsonWriter out, DescribeTrustedAdvisorCheckRefreshStatusesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTrustedAdvisorCheckRefreshStatusesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTrustedAdvisorCheckRefreshStatusesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTrustedAdvisorCheckRefreshStatusesResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeTrustedAdvisorCheckRefreshStatusesResponse
   */
  public static DescribeTrustedAdvisorCheckRefreshStatusesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTrustedAdvisorCheckRefreshStatusesResponse.class);
  }

  /**
   * Convert an instance of DescribeTrustedAdvisorCheckRefreshStatusesResponse to an JSON string
   *
   * @return JSON string
   */
