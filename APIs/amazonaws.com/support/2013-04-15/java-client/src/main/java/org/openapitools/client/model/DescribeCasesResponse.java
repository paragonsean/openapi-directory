...
public class DescribeCasesResponse {
  ...
  public DescribeCasesResponse() {
  }

  public DescribeCasesResponse cases(List cases) {
    this.cases = cases;
    return this;
  }
  ...
  public DescribeCasesResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeCasesResponse describeCasesResponse = (DescribeCasesResponse) o;
    return Objects.equals(this.cases, describeCasesResponse.cases) &&
        Objects.equals(this.nextToken, describeCasesResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cases, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeCasesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCasesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCasesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCasesResponse is not found in the empty JSON string", DescribeCasesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCasesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCasesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `cases`
      if (jsonObj.get("cases") != null && !jsonObj.get("cases").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("cases"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCasesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCasesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCasesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCasesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCasesResponse>() {
           @Override
           public void write(JsonWriter out, DescribeCasesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCasesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCasesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCasesResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeCasesResponse
   */
  public static DescribeCasesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCasesResponse.class);
  }

  /**
   * Convert an instance of DescribeCasesResponse to an JSON string
   *
   * @return JSON string
   */
