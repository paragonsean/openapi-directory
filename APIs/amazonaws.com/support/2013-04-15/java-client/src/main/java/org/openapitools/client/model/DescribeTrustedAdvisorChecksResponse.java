...
public class DescribeTrustedAdvisorChecksResponse {
  ...
  public DescribeTrustedAdvisorChecksResponse() {
  }

  public DescribeTrustedAdvisorChecksResponse checks(List checks) {
    this.checks = checks;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeTrustedAdvisorChecksResponse describeTrustedAdvisorChecksResponse = (DescribeTrustedAdvisorChecksResponse) o;
    return Objects.equals(this.checks, describeTrustedAdvisorChecksResponse.checks);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTrustedAdvisorChecksResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTrustedAdvisorChecksResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTrustedAdvisorChecksResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTrustedAdvisorChecksResponse is not found in the empty JSON string", DescribeTrustedAdvisorChecksResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTrustedAdvisorChecksResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTrustedAdvisorChecksResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeTrustedAdvisorChecksResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `checks`
      List.validateJsonElement(jsonObj.get("checks"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTrustedAdvisorChecksResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTrustedAdvisorChecksResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTrustedAdvisorChecksResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTrustedAdvisorChecksResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTrustedAdvisorChecksResponse>() {
           @Override
           public void write(JsonWriter out, DescribeTrustedAdvisorChecksResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTrustedAdvisorChecksResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTrustedAdvisorChecksResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTrustedAdvisorChecksResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeTrustedAdvisorChecksResponse
   */
  public static DescribeTrustedAdvisorChecksResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTrustedAdvisorChecksResponse.class);
  }

  /**
   * Convert an instance of DescribeTrustedAdvisorChecksResponse to an JSON string
   *
   * @return JSON string
   */
