...
public class DescribeServicesResponse {
  ...
  public DescribeServicesResponse services(List services) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeServicesResponse describeServicesResponse = (DescribeServicesResponse) o;
    return Objects.equals(this.services, describeServicesResponse.services);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeServicesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeServicesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeServicesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeServicesResponse is not found in the empty JSON string", DescribeServicesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeServicesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeServicesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeServicesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeServicesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeServicesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeServicesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeServicesResponse>() {
           @Override
           public void write(JsonWriter out, DescribeServicesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeServicesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeServicesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeServicesResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeServicesResponse
   */
  public static DescribeServicesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeServicesResponse.class);
  }

  /**
   * Convert an instance of DescribeServicesResponse to an JSON string
   *
   * @return JSON string
   */
