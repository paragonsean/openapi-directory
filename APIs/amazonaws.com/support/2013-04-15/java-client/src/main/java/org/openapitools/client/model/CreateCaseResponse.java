...
public class CreateCaseResponse {
  ...
  public CreateCaseResponse caseId(String caseId) {
    this.caseId = caseId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.caseId, createCaseResponse.caseId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCaseResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCaseResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCaseResponse is not found in the empty JSON string", CreateCaseResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCaseResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCaseResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCaseResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCaseResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCaseResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCaseResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCaseResponse>() {
           @Override
           public void write(JsonWriter out, CreateCaseResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCaseResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCaseResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCaseResponse
   * @throws IOException if the JSON string is invalid with respect to CreateCaseResponse
   */
  public static CreateCaseResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCaseResponse.class);
  }

  /**
   * Convert an instance of CreateCaseResponse to an JSON string
   *
   * @return JSON string
   */
