...
public class DateInterval {
  ...
  public DateInterval startDateTime(String startDateTime) {
  ...
  public DateInterval endDateTime(String endDateTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.startDateTime, dateInterval.startDateTime) &&
        Objects.equals(this.endDateTime, dateInterval.endDateTime);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DateInterval
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DateInterval.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DateInterval is not found in the empty JSON string", DateInterval.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DateInterval.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DateInterval` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DateInterval.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DateInterval' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DateInterval> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DateInterval.class));

       return (TypeAdapter<T>) new TypeAdapter<DateInterval>() {
           @Override
  ...
  /**
   * Create an instance of DateInterval given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DateInterval
   * @throws IOException if the JSON string is invalid with respect to DateInterval
   */
  public static DateInterval fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DateInterval.class);
  }

  /**
   * Convert an instance of DateInterval to an JSON string
   *
   * @return JSON string
   */
