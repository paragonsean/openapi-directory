...
public class RecentCaseCommunications {
  ...
  public RecentCaseCommunications communications(List communications) {
  ...
  public RecentCaseCommunications nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    RecentCaseCommunications recentCaseCommunications = (RecentCaseCommunications) o;
    return Objects.equals(this.communications, recentCaseCommunications.communications) &&
        Objects.equals(this.nextToken, recentCaseCommunications.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecentCaseCommunications {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RecentCaseCommunications
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecentCaseCommunications.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecentCaseCommunications is not found in the empty JSON string", RecentCaseCommunications.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecentCaseCommunications.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecentCaseCommunications` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecentCaseCommunications.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecentCaseCommunications' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecentCaseCommunications> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecentCaseCommunications.class));

       return (TypeAdapter<T>) new TypeAdapter<RecentCaseCommunications>() {
           @Override
           public void write(JsonWriter out, RecentCaseCommunications value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RecentCaseCommunications read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RecentCaseCommunications given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RecentCaseCommunications
   * @throws IOException if the JSON string is invalid with respect to RecentCaseCommunications
   */
  public static RecentCaseCommunications fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecentCaseCommunications.class);
  }

  /**
   * Convert an instance of RecentCaseCommunications to an JSON string
   *
   * @return JSON string
   */
