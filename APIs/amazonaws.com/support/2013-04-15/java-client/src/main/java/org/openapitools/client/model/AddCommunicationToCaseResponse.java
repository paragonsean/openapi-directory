...
public class AddCommunicationToCaseResponse {
  ...
  public AddCommunicationToCaseResponse result(Boolean result) {
    this.result = result;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddCommunicationToCaseResponse addCommunicationToCaseResponse = (AddCommunicationToCaseResponse) o;
    return Objects.equals(this.result, addCommunicationToCaseResponse.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddCommunicationToCaseResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddCommunicationToCaseResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddCommunicationToCaseResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCommunicationToCaseResponse is not found in the empty JSON string", AddCommunicationToCaseResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddCommunicationToCaseResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddCommunicationToCaseResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCommunicationToCaseResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCommunicationToCaseResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCommunicationToCaseResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCommunicationToCaseResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCommunicationToCaseResponse>() {
           @Override
           public void write(JsonWriter out, AddCommunicationToCaseResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddCommunicationToCaseResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddCommunicationToCaseResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddCommunicationToCaseResponse
   * @throws IOException if the JSON string is invalid with respect to AddCommunicationToCaseResponse
   */
  public static AddCommunicationToCaseResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCommunicationToCaseResponse.class);
  }

  /**
   * Convert an instance of AddCommunicationToCaseResponse to an JSON string
   *
   * @return JSON string
   */
