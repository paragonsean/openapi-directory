...
public class DescribeSeverityLevelsRequest {
  ...
  public DescribeSeverityLevelsRequest language(String language) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeSeverityLevelsRequest describeSeverityLevelsRequest = (DescribeSeverityLevelsRequest) o;
    return Objects.equals(this.language, describeSeverityLevelsRequest.language);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeSeverityLevelsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeSeverityLevelsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeSeverityLevelsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeSeverityLevelsRequest is not found in the empty JSON string", DescribeSeverityLevelsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeSeverityLevelsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeSeverityLevelsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeSeverityLevelsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeSeverityLevelsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeSeverityLevelsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeSeverityLevelsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeSeverityLevelsRequest>() {
           @Override
           public void write(JsonWriter out, DescribeSeverityLevelsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeSeverityLevelsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeSeverityLevelsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeSeverityLevelsRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeSeverityLevelsRequest
   */
  public static DescribeSeverityLevelsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeSeverityLevelsRequest.class);
  }

  /**
   * Convert an instance of DescribeSeverityLevelsRequest to an JSON string
   *
   * @return JSON string
   */
