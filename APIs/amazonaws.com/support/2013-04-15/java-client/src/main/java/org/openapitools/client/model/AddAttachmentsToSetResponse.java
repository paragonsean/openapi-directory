...
public class AddAttachmentsToSetResponse {
  ...
  public AddAttachmentsToSetResponse attachmentSetId(String attachmentSetId) {
  ...
  public AddAttachmentsToSetResponse expiryTime(String expiryTime) {
  ...
  public boolean equals(Object o) {
    ...
    AddAttachmentsToSetResponse addAttachmentsToSetResponse = (AddAttachmentsToSetResponse) o;
    return Objects.equals(this.attachmentSetId, addAttachmentsToSetResponse.attachmentSetId) &&
        Objects.equals(this.expiryTime, addAttachmentsToSetResponse.expiryTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attachmentSetId, expiryTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddAttachmentsToSetResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddAttachmentsToSetResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddAttachmentsToSetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddAttachmentsToSetResponse is not found in the empty JSON string", AddAttachmentsToSetResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddAttachmentsToSetResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddAttachmentsToSetResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("expiryTime") != null && !jsonObj.get("expiryTime").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("expiryTime"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddAttachmentsToSetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddAttachmentsToSetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddAttachmentsToSetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddAttachmentsToSetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AddAttachmentsToSetResponse>() {
           @Override
           public void write(JsonWriter out, AddAttachmentsToSetResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddAttachmentsToSetResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddAttachmentsToSetResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddAttachmentsToSetResponse
   * @throws IOException if the JSON string is invalid with respect to AddAttachmentsToSetResponse
   */
  public static AddAttachmentsToSetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddAttachmentsToSetResponse.class);
  }

  /**
   * Convert an instance of AddAttachmentsToSetResponse to an JSON string
   *
   * @return JSON string
   */
