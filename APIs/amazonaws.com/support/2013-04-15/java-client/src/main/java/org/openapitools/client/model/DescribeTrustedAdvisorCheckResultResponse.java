...
public class DescribeTrustedAdvisorCheckResultResponse {
  ...
  private DescribeTrustedAdvisorCheckResultResponseResult result;

  public DescribeTrustedAdvisorCheckResultResponse() {
  }

  public DescribeTrustedAdvisorCheckResultResponse result(DescribeTrustedAdvisorCheckResultResponseResult result) {
    this.result = result;
    return this;
  }
  ...
  public DescribeTrustedAdvisorCheckResultResponseResult getResult() {
    return result;
  }

  public void setResult(DescribeTrustedAdvisorCheckResultResponseResult result) {
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeTrustedAdvisorCheckResultResponse describeTrustedAdvisorCheckResultResponse = (DescribeTrustedAdvisorCheckResultResponse) o;
    return Objects.equals(this.result, describeTrustedAdvisorCheckResultResponse.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTrustedAdvisorCheckResultResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTrustedAdvisorCheckResultResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTrustedAdvisorCheckResultResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTrustedAdvisorCheckResultResponse is not found in the empty JSON string", DescribeTrustedAdvisorCheckResultResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTrustedAdvisorCheckResultResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTrustedAdvisorCheckResultResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `result`
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        DescribeTrustedAdvisorCheckResultResponseResult.validateJsonElement(jsonObj.get("result"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTrustedAdvisorCheckResultResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTrustedAdvisorCheckResultResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTrustedAdvisorCheckResultResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTrustedAdvisorCheckResultResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTrustedAdvisorCheckResultResponse>() {
           @Override
           public void write(JsonWriter out, DescribeTrustedAdvisorCheckResultResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTrustedAdvisorCheckResultResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTrustedAdvisorCheckResultResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTrustedAdvisorCheckResultResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeTrustedAdvisorCheckResultResponse
   */
  public static DescribeTrustedAdvisorCheckResultResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTrustedAdvisorCheckResultResponse.class);
  }

  /**
   * Convert an instance of DescribeTrustedAdvisorCheckResultResponse to an JSON string
   *
   * @return JSON string
   */
