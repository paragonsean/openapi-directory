...
import org.openapitools.client.model.DescribeAttachmentResponseAttachment;
...
public class DescribeAttachmentResponse {
  ...
  private DescribeAttachmentResponseAttachment attachment;

  public DescribeAttachmentResponse() {
  }

  public DescribeAttachmentResponse attachment(DescribeAttachmentResponseAttachment attachment) {
  ...
  public DescribeAttachmentResponseAttachment getAttachment() {
    return attachment;
  }

  public void setAttachment(DescribeAttachmentResponseAttachment attachment) {
    this.attachment = attachment;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeAttachmentResponse describeAttachmentResponse = (DescribeAttachmentResponse) o;
    return Objects.equals(this.attachment, describeAttachmentResponse.attachment);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeAttachmentResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAttachmentResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAttachmentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAttachmentResponse is not found in the empty JSON string", DescribeAttachmentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAttachmentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAttachmentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attachment`
      if (jsonObj.get("attachment") != null && !jsonObj.get("attachment").isJsonNull()) {
        DescribeAttachmentResponseAttachment.validateJsonElement(jsonObj.get("attachment"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAttachmentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAttachmentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAttachmentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAttachmentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAttachmentResponse>() {
           @Override
           public void write(JsonWriter out, DescribeAttachmentResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAttachmentResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAttachmentResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAttachmentResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeAttachmentResponse
   */
  public static DescribeAttachmentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAttachmentResponse.class);
  }

  /**
   * Convert an instance of DescribeAttachmentResponse to an JSON string
   *
   * @return JSON string
   */
