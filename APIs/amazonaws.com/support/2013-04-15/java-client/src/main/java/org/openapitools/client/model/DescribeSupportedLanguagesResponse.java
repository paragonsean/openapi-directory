...
public class DescribeSupportedLanguagesResponse {
  ...
  public DescribeSupportedLanguagesResponse() {
  }

  public DescribeSupportedLanguagesResponse supportedLanguages(List supportedLanguages) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeSupportedLanguagesResponse describeSupportedLanguagesResponse = (DescribeSupportedLanguagesResponse) o;
    return Objects.equals(this.supportedLanguages, describeSupportedLanguagesResponse.supportedLanguages);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeSupportedLanguagesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeSupportedLanguagesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeSupportedLanguagesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeSupportedLanguagesResponse is not found in the empty JSON string", DescribeSupportedLanguagesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeSupportedLanguagesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeSupportedLanguagesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `supportedLanguages`
      if (jsonObj.get("supportedLanguages") != null && !jsonObj.get("supportedLanguages").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("supportedLanguages"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeSupportedLanguagesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeSupportedLanguagesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeSupportedLanguagesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeSupportedLanguagesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeSupportedLanguagesResponse>() {
           @Override
           public void write(JsonWriter out, DescribeSupportedLanguagesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeSupportedLanguagesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeSupportedLanguagesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeSupportedLanguagesResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeSupportedLanguagesResponse
   */
  public static DescribeSupportedLanguagesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeSupportedLanguagesResponse.class);
  }

  /**
   * Convert an instance of DescribeSupportedLanguagesResponse to an JSON string
   *
   * @return JSON string
   */
