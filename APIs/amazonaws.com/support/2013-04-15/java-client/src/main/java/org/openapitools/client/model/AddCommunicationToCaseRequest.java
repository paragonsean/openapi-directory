...
public class AddCommunicationToCaseRequest {
  ...
  public AddCommunicationToCaseRequest caseId(String caseId) {
    this.caseId = caseId;
    return this;
  }
  ...
  public AddCommunicationToCaseRequest communicationBody(String communicationBody) {
  ...
  public AddCommunicationToCaseRequest ccEmailAddresses(List ccEmailAddresses) {
  ...
  public AddCommunicationToCaseRequest attachmentSetId(String attachmentSetId) {
  ...
  public boolean equals(Object o) {
    ...
    AddCommunicationToCaseRequest addCommunicationToCaseRequest = (AddCommunicationToCaseRequest) o;
    return Objects.equals(this.caseId, addCommunicationToCaseRequest.caseId) &&
        Objects.equals(this.communicationBody, addCommunicationToCaseRequest.communicationBody) &&
        Objects.equals(this.ccEmailAddresses, addCommunicationToCaseRequest.ccEmailAddresses) &&
        Objects.equals(this.attachmentSetId, addCommunicationToCaseRequest.attachmentSetId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(caseId, communicationBody, ccEmailAddresses, attachmentSetId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddCommunicationToCaseRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddCommunicationToCaseRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddCommunicationToCaseRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCommunicationToCaseRequest is not found in the empty JSON string", AddCommunicationToCaseRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddCommunicationToCaseRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddCommunicationToCaseRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddCommunicationToCaseRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCommunicationToCaseRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCommunicationToCaseRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCommunicationToCaseRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCommunicationToCaseRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCommunicationToCaseRequest>() {
           @Override
           public void write(JsonWriter out, AddCommunicationToCaseRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddCommunicationToCaseRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddCommunicationToCaseRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddCommunicationToCaseRequest
   * @throws IOException if the JSON string is invalid with respect to AddCommunicationToCaseRequest
   */
  public static AddCommunicationToCaseRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCommunicationToCaseRequest.class);
  }

  /**
   * Convert an instance of AddCommunicationToCaseRequest to an JSON string
   *
   * @return JSON string
   */
