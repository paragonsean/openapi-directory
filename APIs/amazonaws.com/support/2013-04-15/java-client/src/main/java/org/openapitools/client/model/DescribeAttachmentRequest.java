...
public class DescribeAttachmentRequest {
  ...
  public DescribeAttachmentRequest() {
  }

  public DescribeAttachmentRequest attachmentId(String attachmentId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAttachmentRequest describeAttachmentRequest = (DescribeAttachmentRequest) o;
    return Objects.equals(this.attachmentId, describeAttachmentRequest.attachmentId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeAttachmentRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAttachmentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAttachmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAttachmentRequest is not found in the empty JSON string", DescribeAttachmentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAttachmentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAttachmentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeAttachmentRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `attachmentId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAttachmentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAttachmentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAttachmentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAttachmentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAttachmentRequest>() {
           @Override
           public void write(JsonWriter out, DescribeAttachmentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAttachmentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAttachmentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAttachmentRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeAttachmentRequest
   */
  public static DescribeAttachmentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAttachmentRequest.class);
  }

  /**
   * Convert an instance of DescribeAttachmentRequest to an JSON string
   *
   * @return JSON string
   */
