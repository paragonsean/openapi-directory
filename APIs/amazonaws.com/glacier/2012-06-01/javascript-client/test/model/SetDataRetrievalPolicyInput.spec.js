...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SetDataRetrievalPolicyInput();
  });
  ...
  describe('SetDataRetrievalPolicyInput', function() {
    it('should create an instance of SetDataRetrievalPolicyInput', function() {
      // uncomment below and update the code to test SetDataRetrievalPolicyInput
      //var instance = new AmazonGlacier.SetDataRetrievalPolicyInput();
      //expect(instance).to.be.a(AmazonGlacier.SetDataRetrievalPolicyInput);
    });
