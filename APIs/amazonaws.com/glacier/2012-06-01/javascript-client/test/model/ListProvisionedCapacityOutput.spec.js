...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.ListProvisionedCapacityOutput();
  });
  ...
  describe('ListProvisionedCapacityOutput', function() {
    it('should create an instance of ListProvisionedCapacityOutput', function() {
      // uncomment below and update the code to test ListProvisionedCapacityOutput
      //var instance = new AmazonGlacier.ListProvisionedCapacityOutput();
      //expect(instance).to.be.a(AmazonGlacier.ListProvisionedCapacityOutput);
    });

    it('should have the property provisionedCapacityList (base name: "ProvisionedCapacityList")', function() {
      // uncomment below and update the code to test the property provisionedCapacityList
      //var instance = new AmazonGlacier.ListProvisionedCapacityOutput();
