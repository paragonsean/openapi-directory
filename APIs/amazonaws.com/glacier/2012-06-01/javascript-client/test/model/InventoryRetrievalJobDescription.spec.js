...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InventoryRetrievalJobDescription();
  });
  ...
  describe('InventoryRetrievalJobDescription', function() {
    it('should create an instance of InventoryRetrievalJobDescription', function() {
      // uncomment below and update the code to test InventoryRetrievalJobDescription
      //var instance = new AmazonGlacier.InventoryRetrievalJobDescription();
      //expect(instance).to.be.a(AmazonGlacier.InventoryRetrievalJobDescription);
    });
