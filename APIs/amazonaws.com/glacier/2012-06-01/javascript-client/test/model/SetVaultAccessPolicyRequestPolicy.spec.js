...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SetVaultAccessPolicyRequestPolicy();
  });
  ...
  describe('SetVaultAccessPolicyRequestPolicy', function() {
    it('should create an instance of SetVaultAccessPolicyRequestPolicy', function() {
      // uncomment below and update the code to test SetVaultAccessPolicyRequestPolicy
      //var instance = new AmazonGlacier.SetVaultAccessPolicyRequestPolicy();
      //expect(instance).to.be.a(AmazonGlacier.SetVaultAccessPolicyRequestPolicy);
    });
