...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.UploadMultipartPartRequest();
  });
  ...
  describe('UploadMultipartPartRequest', function() {
    it('should create an instance of UploadMultipartPartRequest', function() {
      // uncomment below and update the code to test UploadMultipartPartRequest
      //var instance = new AmazonGlacier.UploadMultipartPartRequest();
      //expect(instance).to.be.a(AmazonGlacier.UploadMultipartPartRequest);
    });
