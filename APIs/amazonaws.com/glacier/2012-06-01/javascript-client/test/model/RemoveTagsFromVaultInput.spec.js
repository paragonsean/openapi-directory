...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.RemoveTagsFromVaultInput();
  });
  ...
  describe('RemoveTagsFromVaultInput', function() {
    it('should create an instance of RemoveTagsFromVaultInput', function() {
      // uncomment below and update the code to test RemoveTagsFromVaultInput
      //var instance = new AmazonGlacier.RemoveTagsFromVaultInput();
      //expect(instance).to.be.a(AmazonGlacier.RemoveTagsFromVaultInput);
    });
