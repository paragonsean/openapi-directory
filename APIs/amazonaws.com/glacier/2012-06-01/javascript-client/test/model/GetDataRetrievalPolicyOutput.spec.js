...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.GetDataRetrievalPolicyOutput();
  });
  ...
  describe('GetDataRetrievalPolicyOutput', function() {
    it('should create an instance of GetDataRetrievalPolicyOutput', function() {
      // uncomment below and update the code to test GetDataRetrievalPolicyOutput
      //var instance = new AmazonGlacier.GetDataRetrievalPolicyOutput();
      //expect(instance).to.be.a(AmazonGlacier.GetDataRetrievalPolicyOutput);
    });
