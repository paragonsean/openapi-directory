...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.GetVaultAccessPolicyOutput();
  });
  ...
  describe('GetVaultAccessPolicyOutput', function() {
    it('should create an instance of GetVaultAccessPolicyOutput', function() {
      // uncomment below and update the code to test GetVaultAccessPolicyOutput
      //var instance = new AmazonGlacier.GetVaultAccessPolicyOutput();
      //expect(instance).to.be.a(AmazonGlacier.GetVaultAccessPolicyOutput);
    });
