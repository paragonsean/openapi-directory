...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.ListPartsOutput();
  });
  ...
  describe('ListPartsOutput', function() {
    it('should create an instance of ListPartsOutput', function() {
      // uncomment below and update the code to test ListPartsOutput
      //var instance = new AmazonGlacier.ListPartsOutput();
      //expect(instance).to.be.a(AmazonGlacier.ListPartsOutput);
    });
