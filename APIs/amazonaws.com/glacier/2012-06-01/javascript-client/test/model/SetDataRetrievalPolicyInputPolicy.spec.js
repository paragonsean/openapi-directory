...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SetDataRetrievalPolicyInputPolicy();
  });
  ...
  describe('SetDataRetrievalPolicyInputPolicy', function() {
    it('should create an instance of SetDataRetrievalPolicyInputPolicy', function() {
      // uncomment below and update the code to test SetDataRetrievalPolicyInputPolicy
      //var instance = new AmazonGlacier.SetDataRetrievalPolicyInputPolicy();
      //expect(instance).to.be.a(AmazonGlacier.SetDataRetrievalPolicyInputPolicy);
    });
