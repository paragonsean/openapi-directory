...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SetVaultNotificationsRequestVaultNotificationConfig();
  });
  ...
  describe('SetVaultNotificationsRequestVaultNotificationConfig', function() {
    it('should create an instance of SetVaultNotificationsRequestVaultNotificationConfig', function() {
      // uncomment below and update the code to test SetVaultNotificationsRequestVaultNotificationConfig
      //var instance = new AmazonGlacier.SetVaultNotificationsRequestVaultNotificationConfig();
      //expect(instance).to.be.a(AmazonGlacier.SetVaultNotificationsRequestVaultNotificationConfig);
    });
