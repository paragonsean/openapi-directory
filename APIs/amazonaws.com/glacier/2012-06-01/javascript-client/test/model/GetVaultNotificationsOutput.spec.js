...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.GetVaultNotificationsOutput();
  });
  ...
  describe('GetVaultNotificationsOutput', function() {
    it('should create an instance of GetVaultNotificationsOutput', function() {
      // uncomment below and update the code to test GetVaultNotificationsOutput
      //var instance = new AmazonGlacier.GetVaultNotificationsOutput();
      //expect(instance).to.be.a(AmazonGlacier.GetVaultNotificationsOutput);
    });
