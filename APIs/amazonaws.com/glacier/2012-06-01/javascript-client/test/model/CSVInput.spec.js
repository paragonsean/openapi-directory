...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.CSVInput();
  });
  ...
  describe('CSVInput', function() {
    it('should create an instance of CSVInput', function() {
      // uncomment below and update the code to test CSVInput
      //var instance = new AmazonGlacier.CSVInput();
      //expect(instance).to.be.a(AmazonGlacier.CSVInput);
    });
