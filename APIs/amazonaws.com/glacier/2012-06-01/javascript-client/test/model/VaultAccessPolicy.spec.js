...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.VaultAccessPolicy();
  });
  ...
  describe('VaultAccessPolicy', function() {
    it('should create an instance of VaultAccessPolicy', function() {
      // uncomment below and update the code to test VaultAccessPolicy
      //var instance = new AmazonGlacier.VaultAccessPolicy();
      //expect(instance).to.be.a(AmazonGlacier.VaultAccessPolicy);
    });
