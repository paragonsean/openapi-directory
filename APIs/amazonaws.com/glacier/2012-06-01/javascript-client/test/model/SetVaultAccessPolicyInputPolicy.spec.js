...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SetVaultAccessPolicyInputPolicy();
  });
  ...
  describe('SetVaultAccessPolicyInputPolicy', function() {
    it('should create an instance of SetVaultAccessPolicyInputPolicy', function() {
      // uncomment below and update the code to test SetVaultAccessPolicyInputPolicy
      //var instance = new AmazonGlacier.SetVaultAccessPolicyInputPolicy();
      //expect(instance).to.be.a(AmazonGlacier.SetVaultAccessPolicyInputPolicy);
    });
