...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InitiateJobRequest();
  });
  ...
  describe('InitiateJobRequest', function() {
    it('should create an instance of InitiateJobRequest', function() {
      // uncomment below and update the code to test InitiateJobRequest
      //var instance = new AmazonGlacier.InitiateJobRequest();
      //expect(instance).to.be.a(AmazonGlacier.InitiateJobRequest);
    });

    it('should have the property jobParameters (base name: "jobParameters")', function() {
      // uncomment below and update the code to test the property jobParameters
      //var instance = new AmazonGlacier.InitiateJobRequest();
