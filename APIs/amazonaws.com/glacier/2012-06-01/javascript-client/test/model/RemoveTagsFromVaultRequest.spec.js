...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.RemoveTagsFromVaultRequest();
  });
  ...
  describe('RemoveTagsFromVaultRequest', function() {
    it('should create an instance of RemoveTagsFromVaultRequest', function() {
      // uncomment below and update the code to test RemoveTagsFromVaultRequest
      //var instance = new AmazonGlacier.RemoveTagsFromVaultRequest();
      //expect(instance).to.be.a(AmazonGlacier.RemoveTagsFromVaultRequest);
    });
