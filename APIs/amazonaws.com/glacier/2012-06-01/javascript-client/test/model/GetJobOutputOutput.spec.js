...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.GetJobOutputOutput();
  });
  ...
  describe('GetJobOutputOutput', function() {
    it('should create an instance of GetJobOutputOutput', function() {
      // uncomment below and update the code to test GetJobOutputOutput
      //var instance = new AmazonGlacier.GetJobOutputOutput();
      //expect(instance).to.be.a(AmazonGlacier.GetJobOutputOutput);
    });
