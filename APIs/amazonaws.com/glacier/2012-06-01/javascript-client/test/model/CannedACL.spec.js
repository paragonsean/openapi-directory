...
(function(root, factory) {
  ...
  describe('CannedACL', function() {
    it('should create an instance of CannedACL', function() {
      // uncomment below and update the code to test CannedACL
      //var instance = new AmazonGlacier.CannedACL();
      //expect(instance).to.be.a(AmazonGlacier.CannedACL);
    });
