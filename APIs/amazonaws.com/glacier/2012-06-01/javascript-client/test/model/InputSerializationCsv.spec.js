...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InputSerializationCsv();
  });
  ...
  describe('InputSerializationCsv', function() {
    it('should create an instance of InputSerializationCsv', function() {
      // uncomment below and update the code to test InputSerializationCsv
      //var instance = new AmazonGlacier.InputSerializationCsv();
      //expect(instance).to.be.a(AmazonGlacier.InputSerializationCsv);
    });

    it('should have the property fileHeaderInfo (base name: "FileHeaderInfo")', function() {
      // uncomment below and update the code to test the property fileHeaderInfo
      //var instance = new AmazonGlacier.InputSerializationCsv();
    ...
    it('should have the property recordDelimiter (base name: "RecordDelimiter")', function() {
      // uncomment below and update the code to test the property recordDelimiter
      //var instance = new AmazonGlacier.InputSerializationCsv();
      //expect(instance).to.be();
    });
