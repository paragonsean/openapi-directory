...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InventoryRetrievalJobInput();
  });
  ...
  describe('InventoryRetrievalJobInput', function() {
    it('should create an instance of InventoryRetrievalJobInput', function() {
      // uncomment below and update the code to test InventoryRetrievalJobInput
      //var instance = new AmazonGlacier.InventoryRetrievalJobInput();
      //expect(instance).to.be.a(AmazonGlacier.InventoryRetrievalJobInput);
    });
