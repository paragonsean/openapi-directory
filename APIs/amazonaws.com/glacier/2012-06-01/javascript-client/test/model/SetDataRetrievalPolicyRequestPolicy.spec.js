...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SetDataRetrievalPolicyRequestPolicy();
  });
  ...
  describe('SetDataRetrievalPolicyRequestPolicy', function() {
    it('should create an instance of SetDataRetrievalPolicyRequestPolicy', function() {
      // uncomment below and update the code to test SetDataRetrievalPolicyRequestPolicy
      //var instance = new AmazonGlacier.SetDataRetrievalPolicyRequestPolicy();
      //expect(instance).to.be.a(AmazonGlacier.SetDataRetrievalPolicyRequestPolicy);
    });
