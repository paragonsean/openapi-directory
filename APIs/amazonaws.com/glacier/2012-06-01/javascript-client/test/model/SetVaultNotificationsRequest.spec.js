...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SetVaultNotificationsRequest();
  });
  ...
  describe('SetVaultNotificationsRequest', function() {
    it('should create an instance of SetVaultNotificationsRequest', function() {
      // uncomment below and update the code to test SetVaultNotificationsRequest
      //var instance = new AmazonGlacier.SetVaultNotificationsRequest();
      //expect(instance).to.be.a(AmazonGlacier.SetVaultNotificationsRequest);
    });

    it('should have the property vaultNotificationConfig (base name: "vaultNotificationConfig")', function() {
      // uncomment below and update the code to test the property vaultNotificationConfig
      //var instance = new AmazonGlacier.SetVaultNotificationsRequest();
