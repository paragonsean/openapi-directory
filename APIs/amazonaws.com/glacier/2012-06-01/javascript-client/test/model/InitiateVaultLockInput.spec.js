...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InitiateVaultLockInput();
  });
  ...
  describe('InitiateVaultLockInput', function() {
    it('should create an instance of InitiateVaultLockInput', function() {
      // uncomment below and update the code to test InitiateVaultLockInput
      //var instance = new AmazonGlacier.InitiateVaultLockInput();
      //expect(instance).to.be.a(AmazonGlacier.InitiateVaultLockInput);
    });
