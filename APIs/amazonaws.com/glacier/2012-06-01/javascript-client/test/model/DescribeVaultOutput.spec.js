...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.DescribeVaultOutput();
  });
  ...
  describe('DescribeVaultOutput', function() {
    it('should create an instance of DescribeVaultOutput', function() {
      // uncomment below and update the code to test DescribeVaultOutput
      //var instance = new AmazonGlacier.DescribeVaultOutput();
      //expect(instance).to.be.a(AmazonGlacier.DescribeVaultOutput);
    });
    ...
    it('should have the property lastInventoryDate (base name: "LastInventoryDate")', function() {
      // uncomment below and update the code to test the property lastInventoryDate
      //var instance = new AmazonGlacier.DescribeVaultOutput();
      //expect(instance).to.be();
    });

    it('should have the property numberOfArchives (base name: "NumberOfArchives")', function() {
      // uncomment below and update the code to test the property numberOfArchives
      //var instance = new AmazonGlacier.DescribeVaultOutput();
      //expect(instance).to.be();
    });
