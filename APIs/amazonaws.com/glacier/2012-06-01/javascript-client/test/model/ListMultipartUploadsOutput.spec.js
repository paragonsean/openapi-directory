...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.ListMultipartUploadsOutput();
  });
  ...
  describe('ListMultipartUploadsOutput', function() {
    it('should create an instance of ListMultipartUploadsOutput', function() {
      // uncomment below and update the code to test ListMultipartUploadsOutput
      //var instance = new AmazonGlacier.ListMultipartUploadsOutput();
      //expect(instance).to.be.a(AmazonGlacier.ListMultipartUploadsOutput);
    });

    it('should have the property uploadsList (base name: "UploadsList")', function() {
      // uncomment below and update the code to test the property uploadsList
      //var instance = new AmazonGlacier.ListMultipartUploadsOutput();
