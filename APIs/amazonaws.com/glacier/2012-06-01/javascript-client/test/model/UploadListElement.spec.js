...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.UploadListElement();
  });
  ...
  describe('UploadListElement', function() {
    it('should create an instance of UploadListElement', function() {
      // uncomment below and update the code to test UploadListElement
      //var instance = new AmazonGlacier.UploadListElement();
      //expect(instance).to.be.a(AmazonGlacier.UploadListElement);
    });

    it('should have the property multipartUploadId (base name: "MultipartUploadId")', function() {
      // uncomment below and update the code to test the property multipartUploadId
      //var instance = new AmazonGlacier.UploadListElement();
    ...
    it('should have the property archiveDescription (base name: "ArchiveDescription")', function() {
      // uncomment below and update the code to test the property archiveDescription
      //var instance = new AmazonGlacier.UploadListElement();
      //expect(instance).to.be();
    });

    it('should have the property partSizeInBytes (base name: "PartSizeInBytes")', function() {
      // uncomment below and update the code to test the property partSizeInBytes
      //var instance = new AmazonGlacier.UploadListElement();
      //expect(instance).to.be();
    });
