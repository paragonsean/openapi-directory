...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InitiateJobRequestJobParametersInventoryRetrievalParameters();
  });
  ...
  describe('InitiateJobRequestJobParametersInventoryRetrievalParameters', function() {
    it('should create an instance of InitiateJobRequestJobParametersInventoryRetrievalParameters', function() {
      // uncomment below and update the code to test InitiateJobRequestJobParametersInventoryRetrievalParameters
      //var instance = new AmazonGlacier.InitiateJobRequestJobParametersInventoryRetrievalParameters();
      //expect(instance).to.be.a(AmazonGlacier.InitiateJobRequestJobParametersInventoryRetrievalParameters);
    });
