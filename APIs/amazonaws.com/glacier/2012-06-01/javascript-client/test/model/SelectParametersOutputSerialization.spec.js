...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SelectParametersOutputSerialization();
  });
  ...
  describe('SelectParametersOutputSerialization', function() {
    it('should create an instance of SelectParametersOutputSerialization', function() {
      // uncomment below and update the code to test SelectParametersOutputSerialization
      //var instance = new AmazonGlacier.SelectParametersOutputSerialization();
      //expect(instance).to.be.a(AmazonGlacier.SelectParametersOutputSerialization);
    });
