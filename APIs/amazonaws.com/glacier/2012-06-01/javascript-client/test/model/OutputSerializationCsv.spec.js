...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.OutputSerializationCsv();
  });
  ...
  describe('OutputSerializationCsv', function() {
    it('should create an instance of OutputSerializationCsv', function() {
      // uncomment below and update the code to test OutputSerializationCsv
      //var instance = new AmazonGlacier.OutputSerializationCsv();
      //expect(instance).to.be.a(AmazonGlacier.OutputSerializationCsv);
    });
