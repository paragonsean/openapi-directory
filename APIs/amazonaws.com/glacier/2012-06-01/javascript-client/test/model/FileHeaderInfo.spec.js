...
(function(root, factory) {
  ...
  describe('FileHeaderInfo', function() {
    it('should create an instance of FileHeaderInfo', function() {
      // uncomment below and update the code to test FileHeaderInfo
      //var instance = new AmazonGlacier.FileHeaderInfo();
      //expect(instance).to.be.a(AmazonGlacier.FileHeaderInfo);
    });
