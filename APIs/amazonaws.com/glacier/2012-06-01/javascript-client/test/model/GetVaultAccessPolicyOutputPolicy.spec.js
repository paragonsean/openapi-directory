...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.GetVaultAccessPolicyOutputPolicy();
  });
  ...
  describe('GetVaultAccessPolicyOutputPolicy', function() {
    it('should create an instance of GetVaultAccessPolicyOutputPolicy', function() {
      // uncomment below and update the code to test GetVaultAccessPolicyOutputPolicy
      //var instance = new AmazonGlacier.GetVaultAccessPolicyOutputPolicy();
      //expect(instance).to.be.a(AmazonGlacier.GetVaultAccessPolicyOutputPolicy);
    });
