...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.OutputLocationS3();
  });
  ...
  describe('OutputLocationS3', function() {
    it('should create an instance of OutputLocationS3', function() {
      // uncomment below and update the code to test OutputLocationS3
      //var instance = new AmazonGlacier.OutputLocationS3();
      //expect(instance).to.be.a(AmazonGlacier.OutputLocationS3);
    });
