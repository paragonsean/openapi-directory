...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SelectParameters();
  });
  ...
  describe('SelectParameters', function() {
    it('should create an instance of SelectParameters', function() {
      // uncomment below and update the code to test SelectParameters
      //var instance = new AmazonGlacier.SelectParameters();
      //expect(instance).to.be.a(AmazonGlacier.SelectParameters);
    });

    it('should have the property inputSerialization (base name: "InputSerialization")', function() {
      // uncomment below and update the code to test the property inputSerialization
      //var instance = new AmazonGlacier.SelectParameters();
    ...
    it('should have the property outputSerialization (base name: "OutputSerialization")', function() {
      // uncomment below and update the code to test the property outputSerialization
      //var instance = new AmazonGlacier.SelectParameters();
      //expect(instance).to.be();
    });
