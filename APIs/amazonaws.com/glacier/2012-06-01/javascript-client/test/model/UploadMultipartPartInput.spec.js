...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.UploadMultipartPartInput();
  });
  ...
  describe('UploadMultipartPartInput', function() {
    it('should create an instance of UploadMultipartPartInput', function() {
      // uncomment below and update the code to test UploadMultipartPartInput
      //var instance = new AmazonGlacier.UploadMultipartPartInput();
      //expect(instance).to.be.a(AmazonGlacier.UploadMultipartPartInput);
    });
