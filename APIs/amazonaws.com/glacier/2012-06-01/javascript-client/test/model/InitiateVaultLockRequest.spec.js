...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InitiateVaultLockRequest();
  });
  ...
  describe('InitiateVaultLockRequest', function() {
    it('should create an instance of InitiateVaultLockRequest', function() {
      // uncomment below and update the code to test InitiateVaultLockRequest
      //var instance = new AmazonGlacier.InitiateVaultLockRequest();
      //expect(instance).to.be.a(AmazonGlacier.InitiateVaultLockRequest);
    });
