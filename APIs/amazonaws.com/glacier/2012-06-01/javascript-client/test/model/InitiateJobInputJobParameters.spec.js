...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InitiateJobInputJobParameters();
  });
  ...
  describe('InitiateJobInputJobParameters', function() {
    it('should create an instance of InitiateJobInputJobParameters', function() {
      // uncomment below and update the code to test InitiateJobInputJobParameters
      //var instance = new AmazonGlacier.InitiateJobInputJobParameters();
      //expect(instance).to.be.a(AmazonGlacier.InitiateJobInputJobParameters);
    });
