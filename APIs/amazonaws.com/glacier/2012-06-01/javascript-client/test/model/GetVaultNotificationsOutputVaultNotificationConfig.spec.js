...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.GetVaultNotificationsOutputVaultNotificationConfig();
  });
  ...
  describe('GetVaultNotificationsOutputVaultNotificationConfig', function() {
    it('should create an instance of GetVaultNotificationsOutputVaultNotificationConfig', function() {
      // uncomment below and update the code to test GetVaultNotificationsOutputVaultNotificationConfig
      //var instance = new AmazonGlacier.GetVaultNotificationsOutputVaultNotificationConfig();
      //expect(instance).to.be.a(AmazonGlacier.GetVaultNotificationsOutputVaultNotificationConfig);
    });
