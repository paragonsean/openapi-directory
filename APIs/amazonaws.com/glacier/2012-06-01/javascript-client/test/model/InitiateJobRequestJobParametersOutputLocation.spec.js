...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InitiateJobRequestJobParametersOutputLocation();
  });
  ...
  describe('InitiateJobRequestJobParametersOutputLocation', function() {
    it('should create an instance of InitiateJobRequestJobParametersOutputLocation', function() {
      // uncomment below and update the code to test InitiateJobRequestJobParametersOutputLocation
      //var instance = new AmazonGlacier.InitiateJobRequestJobParametersOutputLocation();
      //expect(instance).to.be.a(AmazonGlacier.InitiateJobRequestJobParametersOutputLocation);
    });
