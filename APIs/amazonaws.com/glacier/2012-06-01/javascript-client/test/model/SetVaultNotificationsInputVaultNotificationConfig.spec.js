...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SetVaultNotificationsInputVaultNotificationConfig();
  });
  ...
  describe('SetVaultNotificationsInputVaultNotificationConfig', function() {
    it('should create an instance of SetVaultNotificationsInputVaultNotificationConfig', function() {
      // uncomment below and update the code to test SetVaultNotificationsInputVaultNotificationConfig
      //var instance = new AmazonGlacier.SetVaultNotificationsInputVaultNotificationConfig();
      //expect(instance).to.be.a(AmazonGlacier.SetVaultNotificationsInputVaultNotificationConfig);
    });
