...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SetVaultAccessPolicyInput();
  });
  ...
  describe('SetVaultAccessPolicyInput', function() {
    it('should create an instance of SetVaultAccessPolicyInput', function() {
      // uncomment below and update the code to test SetVaultAccessPolicyInput
      //var instance = new AmazonGlacier.SetVaultAccessPolicyInput();
      //expect(instance).to.be.a(AmazonGlacier.SetVaultAccessPolicyInput);
    });
