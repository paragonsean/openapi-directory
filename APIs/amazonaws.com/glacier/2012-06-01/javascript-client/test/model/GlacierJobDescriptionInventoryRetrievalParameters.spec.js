...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.GlacierJobDescriptionInventoryRetrievalParameters();
  });
  ...
  describe('GlacierJobDescriptionInventoryRetrievalParameters', function() {
    it('should create an instance of GlacierJobDescriptionInventoryRetrievalParameters', function() {
      // uncomment below and update the code to test GlacierJobDescriptionInventoryRetrievalParameters
      //var instance = new AmazonGlacier.GlacierJobDescriptionInventoryRetrievalParameters();
      //expect(instance).to.be.a(AmazonGlacier.GlacierJobDescriptionInventoryRetrievalParameters);
    });
