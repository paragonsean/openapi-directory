...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InitiateVaultLockInputPolicy();
  });
  ...
  describe('InitiateVaultLockInputPolicy', function() {
    it('should create an instance of InitiateVaultLockInputPolicy', function() {
      // uncomment below and update the code to test InitiateVaultLockInputPolicy
      //var instance = new AmazonGlacier.InitiateVaultLockInputPolicy();
      //expect(instance).to.be.a(AmazonGlacier.InitiateVaultLockInputPolicy);
    });
