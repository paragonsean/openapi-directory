...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.DataRetrievalRule();
  });
  ...
  describe('DataRetrievalRule', function() {
    it('should create an instance of DataRetrievalRule', function() {
      // uncomment below and update the code to test DataRetrievalRule
      //var instance = new AmazonGlacier.DataRetrievalRule();
      //expect(instance).to.be.a(AmazonGlacier.DataRetrievalRule);
    });
    ...
    it('should have the property bytesPerHour (base name: "BytesPerHour")', function() {
      // uncomment below and update the code to test the property bytesPerHour
      //var instance = new AmazonGlacier.DataRetrievalRule();
      //expect(instance).to.be();
    });
