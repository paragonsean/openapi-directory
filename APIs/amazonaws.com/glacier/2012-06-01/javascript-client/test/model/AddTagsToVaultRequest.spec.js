...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.AddTagsToVaultRequest();
  });
  ...
  describe('AddTagsToVaultRequest', function() {
    it('should create an instance of AddTagsToVaultRequest', function() {
      // uncomment below and update the code to test AddTagsToVaultRequest
      //var instance = new AmazonGlacier.AddTagsToVaultRequest();
      //expect(instance).to.be.a(AmazonGlacier.AddTagsToVaultRequest);
    });
