...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SelectParametersInputSerialization();
  });
  ...
  describe('SelectParametersInputSerialization', function() {
    it('should create an instance of SelectParametersInputSerialization', function() {
      // uncomment below and update the code to test SelectParametersInputSerialization
      //var instance = new AmazonGlacier.SelectParametersInputSerialization();
      //expect(instance).to.be.a(AmazonGlacier.SelectParametersInputSerialization);
    });
