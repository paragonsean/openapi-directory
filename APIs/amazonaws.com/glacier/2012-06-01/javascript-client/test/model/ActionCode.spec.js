...
(function(root, factory) {
  ...
  describe('ActionCode', function() {
    it('should create an instance of ActionCode', function() {
      // uncomment below and update the code to test ActionCode
      //var instance = new AmazonGlacier.ActionCode();
      //expect(instance).to.be.a(AmazonGlacier.ActionCode);
    });
