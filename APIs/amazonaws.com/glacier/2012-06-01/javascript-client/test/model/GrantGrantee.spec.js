...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.GrantGrantee();
  });
  ...
  describe('GrantGrantee', function() {
    it('should create an instance of GrantGrantee', function() {
      // uncomment below and update the code to test GrantGrantee
      //var instance = new AmazonGlacier.GrantGrantee();
      //expect(instance).to.be.a(AmazonGlacier.GrantGrantee);
    });
