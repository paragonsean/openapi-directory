...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.PartListElement();
  });
  ...
  describe('PartListElement', function() {
    it('should create an instance of PartListElement', function() {
      // uncomment below and update the code to test PartListElement
      //var instance = new AmazonGlacier.PartListElement();
      //expect(instance).to.be.a(AmazonGlacier.PartListElement);
    });

    it('should have the property rangeInBytes (base name: "RangeInBytes")', function() {
      // uncomment below and update the code to test the property rangeInBytes
      //var instance = new AmazonGlacier.PartListElement();
