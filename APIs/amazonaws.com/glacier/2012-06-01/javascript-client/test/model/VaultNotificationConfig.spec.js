...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.VaultNotificationConfig();
  });
  ...
  describe('VaultNotificationConfig', function() {
    it('should create an instance of VaultNotificationConfig', function() {
      // uncomment below and update the code to test VaultNotificationConfig
      //var instance = new AmazonGlacier.VaultNotificationConfig();
      //expect(instance).to.be.a(AmazonGlacier.VaultNotificationConfig);
    });
