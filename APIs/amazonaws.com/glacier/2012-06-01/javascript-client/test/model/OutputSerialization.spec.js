...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.OutputSerialization();
  });
  ...
  describe('OutputSerialization', function() {
    it('should create an instance of OutputSerialization', function() {
      // uncomment below and update the code to test OutputSerialization
      //var instance = new AmazonGlacier.OutputSerialization();
      //expect(instance).to.be.a(AmazonGlacier.OutputSerialization);
    });
