...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.OutputLocation();
  });
  ...
  describe('OutputLocation', function() {
    it('should create an instance of OutputLocation', function() {
      // uncomment below and update the code to test OutputLocation
      //var instance = new AmazonGlacier.OutputLocation();
      //expect(instance).to.be.a(AmazonGlacier.OutputLocation);
    });
