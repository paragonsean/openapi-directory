...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.ListTagsForVaultOutput();
  });
  ...
  describe('ListTagsForVaultOutput', function() {
    it('should create an instance of ListTagsForVaultOutput', function() {
      // uncomment below and update the code to test ListTagsForVaultOutput
      //var instance = new AmazonGlacier.ListTagsForVaultOutput();
      //expect(instance).to.be.a(AmazonGlacier.ListTagsForVaultOutput);
    });
