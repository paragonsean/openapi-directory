...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.Grantee();
  });
  ...
  describe('Grantee', function() {
    it('should create an instance of Grantee', function() {
      // uncomment below and update the code to test Grantee
      //var instance = new AmazonGlacier.Grantee();
      //expect(instance).to.be.a(AmazonGlacier.Grantee);
    });
