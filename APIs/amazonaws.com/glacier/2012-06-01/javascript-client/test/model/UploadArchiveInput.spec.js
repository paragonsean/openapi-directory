...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.UploadArchiveInput();
  });
  ...
  describe('UploadArchiveInput', function() {
    it('should create an instance of UploadArchiveInput', function() {
      // uncomment below and update the code to test UploadArchiveInput
      //var instance = new AmazonGlacier.UploadArchiveInput();
      //expect(instance).to.be.a(AmazonGlacier.UploadArchiveInput);
    });
