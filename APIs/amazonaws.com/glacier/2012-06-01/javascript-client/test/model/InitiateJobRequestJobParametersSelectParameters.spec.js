...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InitiateJobRequestJobParametersSelectParameters();
  });
  ...
  describe('InitiateJobRequestJobParametersSelectParameters', function() {
    it('should create an instance of InitiateJobRequestJobParametersSelectParameters', function() {
      // uncomment below and update the code to test InitiateJobRequestJobParametersSelectParameters
      //var instance = new AmazonGlacier.InitiateJobRequestJobParametersSelectParameters();
      //expect(instance).to.be.a(AmazonGlacier.InitiateJobRequestJobParametersSelectParameters);
    });
