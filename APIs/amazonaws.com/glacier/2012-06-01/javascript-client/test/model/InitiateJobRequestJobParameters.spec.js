...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InitiateJobRequestJobParameters();
  });
  ...
  describe('InitiateJobRequestJobParameters', function() {
    it('should create an instance of InitiateJobRequestJobParameters', function() {
      // uncomment below and update the code to test InitiateJobRequestJobParameters
      //var instance = new AmazonGlacier.InitiateJobRequestJobParameters();
      //expect(instance).to.be.a(AmazonGlacier.InitiateJobRequestJobParameters);
    });
