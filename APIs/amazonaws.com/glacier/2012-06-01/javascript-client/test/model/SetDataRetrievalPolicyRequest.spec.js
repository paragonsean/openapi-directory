...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SetDataRetrievalPolicyRequest();
  });
  ...
  describe('SetDataRetrievalPolicyRequest', function() {
    it('should create an instance of SetDataRetrievalPolicyRequest', function() {
      // uncomment below and update the code to test SetDataRetrievalPolicyRequest
      //var instance = new AmazonGlacier.SetDataRetrievalPolicyRequest();
      //expect(instance).to.be.a(AmazonGlacier.SetDataRetrievalPolicyRequest);
    });
