...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InitiateVaultLockRequestPolicy();
  });
  ...
  describe('InitiateVaultLockRequestPolicy', function() {
    it('should create an instance of InitiateVaultLockRequestPolicy', function() {
      // uncomment below and update the code to test InitiateVaultLockRequestPolicy
      //var instance = new AmazonGlacier.InitiateVaultLockRequestPolicy();
      //expect(instance).to.be.a(AmazonGlacier.InitiateVaultLockRequestPolicy);
    });
