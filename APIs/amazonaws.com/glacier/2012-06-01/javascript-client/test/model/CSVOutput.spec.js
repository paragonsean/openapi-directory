...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.CSVOutput();
  });
  ...
  describe('CSVOutput', function() {
    it('should create an instance of CSVOutput', function() {
      // uncomment below and update the code to test CSVOutput
      //var instance = new AmazonGlacier.CSVOutput();
      //expect(instance).to.be.a(AmazonGlacier.CSVOutput);
    });

    it('should have the property quoteFields (base name: "QuoteFields")', function() {
      // uncomment below and update the code to test the property quoteFields
      //var instance = new AmazonGlacier.CSVOutput();
