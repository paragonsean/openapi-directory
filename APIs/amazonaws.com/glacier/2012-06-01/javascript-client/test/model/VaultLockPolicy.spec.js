...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.VaultLockPolicy();
  });
  ...
  describe('VaultLockPolicy', function() {
    it('should create an instance of VaultLockPolicy', function() {
      // uncomment below and update the code to test VaultLockPolicy
      //var instance = new AmazonGlacier.VaultLockPolicy();
      //expect(instance).to.be.a(AmazonGlacier.VaultLockPolicy);
    });
