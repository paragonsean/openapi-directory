...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.ListVaultsOutput();
  });
  ...
  describe('ListVaultsOutput', function() {
    it('should create an instance of ListVaultsOutput', function() {
      // uncomment below and update the code to test ListVaultsOutput
      //var instance = new AmazonGlacier.ListVaultsOutput();
      //expect(instance).to.be.a(AmazonGlacier.ListVaultsOutput);
    });

    it('should have the property vaultList (base name: "VaultList")', function() {
      // uncomment below and update the code to test the property vaultList
      //var instance = new AmazonGlacier.ListVaultsOutput();
