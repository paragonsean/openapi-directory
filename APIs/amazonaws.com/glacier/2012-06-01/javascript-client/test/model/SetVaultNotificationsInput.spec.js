...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SetVaultNotificationsInput();
  });
  ...
  describe('SetVaultNotificationsInput', function() {
    it('should create an instance of SetVaultNotificationsInput', function() {
      // uncomment below and update the code to test SetVaultNotificationsInput
      //var instance = new AmazonGlacier.SetVaultNotificationsInput();
      //expect(instance).to.be.a(AmazonGlacier.SetVaultNotificationsInput);
    });
