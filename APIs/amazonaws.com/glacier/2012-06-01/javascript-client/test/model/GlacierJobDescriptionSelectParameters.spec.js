...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.GlacierJobDescriptionSelectParameters();
  });
  ...
  describe('GlacierJobDescriptionSelectParameters', function() {
    it('should create an instance of GlacierJobDescriptionSelectParameters', function() {
      // uncomment below and update the code to test GlacierJobDescriptionSelectParameters
      //var instance = new AmazonGlacier.GlacierJobDescriptionSelectParameters();
      //expect(instance).to.be.a(AmazonGlacier.GlacierJobDescriptionSelectParameters);
    });
