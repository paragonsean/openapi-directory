...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InputSerialization();
  });
  ...
  describe('InputSerialization', function() {
    it('should create an instance of InputSerialization', function() {
      // uncomment below and update the code to test InputSerialization
      //var instance = new AmazonGlacier.InputSerialization();
      //expect(instance).to.be.a(AmazonGlacier.InputSerialization);
    });
