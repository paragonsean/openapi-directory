...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.DataRetrievalPolicy();
  });
  ...
  describe('DataRetrievalPolicy', function() {
    it('should create an instance of DataRetrievalPolicy', function() {
      // uncomment below and update the code to test DataRetrievalPolicy
      //var instance = new AmazonGlacier.DataRetrievalPolicy();
      //expect(instance).to.be.a(AmazonGlacier.DataRetrievalPolicy);
    });
