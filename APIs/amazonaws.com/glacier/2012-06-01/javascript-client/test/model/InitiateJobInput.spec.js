...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.InitiateJobInput();
  });
  ...
  describe('InitiateJobInput', function() {
    it('should create an instance of InitiateJobInput', function() {
      // uncomment below and update the code to test InitiateJobInput
      //var instance = new AmazonGlacier.InitiateJobInput();
      //expect(instance).to.be.a(AmazonGlacier.InitiateJobInput);
    });
