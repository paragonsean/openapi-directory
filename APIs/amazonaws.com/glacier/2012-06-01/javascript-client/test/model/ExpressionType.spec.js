...
(function(root, factory) {
  ...
  describe('ExpressionType', function() {
    it('should create an instance of ExpressionType', function() {
      // uncomment below and update the code to test ExpressionType
      //var instance = new AmazonGlacier.ExpressionType();
      //expect(instance).to.be.a(AmazonGlacier.ExpressionType);
    });
