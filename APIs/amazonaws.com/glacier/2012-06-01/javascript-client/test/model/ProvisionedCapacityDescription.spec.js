...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.ProvisionedCapacityDescription();
  });
  ...
  describe('ProvisionedCapacityDescription', function() {
    it('should create an instance of ProvisionedCapacityDescription', function() {
      // uncomment below and update the code to test ProvisionedCapacityDescription
      //var instance = new AmazonGlacier.ProvisionedCapacityDescription();
      //expect(instance).to.be.a(AmazonGlacier.ProvisionedCapacityDescription);
    });

    it('should have the property capacityId (base name: "CapacityId")', function() {
      // uncomment below and update the code to test the property capacityId
      //var instance = new AmazonGlacier.ProvisionedCapacityDescription();
