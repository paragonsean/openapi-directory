...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.S3LocationEncryption();
  });
  ...
  describe('S3LocationEncryption', function() {
    it('should create an instance of S3LocationEncryption', function() {
      // uncomment below and update the code to test S3LocationEncryption
      //var instance = new AmazonGlacier.S3LocationEncryption();
      //expect(instance).to.be.a(AmazonGlacier.S3LocationEncryption);
    });
