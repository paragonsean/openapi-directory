...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.GetDataRetrievalPolicyOutputPolicy();
  });
  ...
  describe('GetDataRetrievalPolicyOutputPolicy', function() {
    it('should create an instance of GetDataRetrievalPolicyOutputPolicy', function() {
      // uncomment below and update the code to test GetDataRetrievalPolicyOutputPolicy
      //var instance = new AmazonGlacier.GetDataRetrievalPolicyOutputPolicy();
      //expect(instance).to.be.a(AmazonGlacier.GetDataRetrievalPolicyOutputPolicy);
    });
