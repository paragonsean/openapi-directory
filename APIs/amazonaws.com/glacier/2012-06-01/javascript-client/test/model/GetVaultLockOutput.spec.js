...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.GetVaultLockOutput();
  });
  ...
  describe('GetVaultLockOutput', function() {
    it('should create an instance of GetVaultLockOutput', function() {
      // uncomment below and update the code to test GetVaultLockOutput
      //var instance = new AmazonGlacier.GetVaultLockOutput();
      //expect(instance).to.be.a(AmazonGlacier.GetVaultLockOutput);
    });
