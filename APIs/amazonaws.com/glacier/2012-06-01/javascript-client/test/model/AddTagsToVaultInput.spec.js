...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.AddTagsToVaultInput();
  });
  ...
  describe('AddTagsToVaultInput', function() {
    it('should create an instance of AddTagsToVaultInput', function() {
      // uncomment below and update the code to test AddTagsToVaultInput
      //var instance = new AmazonGlacier.AddTagsToVaultInput();
      //expect(instance).to.be.a(AmazonGlacier.AddTagsToVaultInput);
    });
