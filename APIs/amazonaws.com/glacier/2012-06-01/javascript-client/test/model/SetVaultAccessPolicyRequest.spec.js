...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.SetVaultAccessPolicyRequest();
  });
  ...
  describe('SetVaultAccessPolicyRequest', function() {
    it('should create an instance of SetVaultAccessPolicyRequest', function() {
      // uncomment below and update the code to test SetVaultAccessPolicyRequest
      //var instance = new AmazonGlacier.SetVaultAccessPolicyRequest();
      //expect(instance).to.be.a(AmazonGlacier.SetVaultAccessPolicyRequest);
    });
