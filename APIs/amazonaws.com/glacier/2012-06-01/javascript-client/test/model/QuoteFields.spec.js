...
(function(root, factory) {
  ...
  describe('QuoteFields', function() {
    it('should create an instance of QuoteFields', function() {
      // uncomment below and update the code to test QuoteFields
      //var instance = new AmazonGlacier.QuoteFields();
      //expect(instance).to.be.a(AmazonGlacier.QuoteFields);
    });
