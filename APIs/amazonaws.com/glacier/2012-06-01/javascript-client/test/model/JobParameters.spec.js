...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGlacier.JobParameters();
  });
  ...
  describe('JobParameters', function() {
    it('should create an instance of JobParameters', function() {
      // uncomment below and update the code to test JobParameters
      //var instance = new AmazonGlacier.JobParameters();
      //expect(instance).to.be.a(AmazonGlacier.JobParameters);
    });
