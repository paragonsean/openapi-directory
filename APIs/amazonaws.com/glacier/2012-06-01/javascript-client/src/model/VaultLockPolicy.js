...
/**
 * The VaultLockPolicy model module.
 * @module model/VaultLockPolicy
 * @version 2012-06-01
 */
class VaultLockPolicy {
    /**
     * Constructs a new <code>VaultLockPolicy</code>.
     * Contains the vault lock policy.
     * @alias module:model/VaultLockPolicy
     */
    constructor() { 
        
        VaultLockPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VaultLockPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VaultLockPolicy} obj Optional instance to populate.
     * @return {module:model/VaultLockPolicy} The populated <code>VaultLockPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VaultLockPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>VaultLockPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VaultLockPolicy</code>.
     */
 ...
 */
VaultLockPolicy.prototype['Policy'] = undefined;
...
export default VaultLockPolicy;
