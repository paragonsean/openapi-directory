...
/**
 * The ListTagsForVaultOutput model module.
 * @module model/ListTagsForVaultOutput
 * @version 2012-06-01
 */
class ListTagsForVaultOutput {
    /**
     * Constructs a new <code>ListTagsForVaultOutput</code>.
     * Contains the Amazon S3 Glacier response to your request.
     * @alias module:model/ListTagsForVaultOutput
     */
    constructor() { 
        
        ListTagsForVaultOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListTagsForVaultOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTagsForVaultOutput} obj Optional instance to populate.
     * @return {module:model/ListTagsForVaultOutput} The populated <code>ListTagsForVaultOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTagsForVaultOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListTagsForVaultOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTagsForVaultOutput</code>.
     */
 ...
 * @member {Object} Tags
 */
ListTagsForVaultOutput.prototype['Tags'] = undefined;
...
export default ListTagsForVaultOutput;
