...
/**
 * The SetDataRetrievalPolicyRequestPolicy model module.
 * @module model/SetDataRetrievalPolicyRequestPolicy
 * @version 2012-06-01
 */
class SetDataRetrievalPolicyRequestPolicy {
    /**
     * Constructs a new <code>SetDataRetrievalPolicyRequestPolicy</code>.
     * Data retrieval policy.
     * @alias module:model/SetDataRetrievalPolicyRequestPolicy
     */
    constructor() { 
        
        SetDataRetrievalPolicyRequestPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetDataRetrievalPolicyRequestPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetDataRetrievalPolicyRequestPolicy} obj Optional instance to populate.
     * @return {module:model/SetDataRetrievalPolicyRequestPolicy} The populated <code>SetDataRetrievalPolicyRequestPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetDataRetrievalPolicyRequestPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>SetDataRetrievalPolicyRequestPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetDataRetrievalPolicyRequestPolicy</code>.
     */
 ...
 * @member {Array} Rules
 */
SetDataRetrievalPolicyRequestPolicy.prototype['Rules'] = undefined;
...
export default SetDataRetrievalPolicyRequestPolicy;
