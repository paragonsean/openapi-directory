...
/**
 * The ListProvisionedCapacityOutput model module.
 * @module model/ListProvisionedCapacityOutput
 * @version 2012-06-01
 */
class ListProvisionedCapacityOutput {
    /**
     * Constructs a new <code>ListProvisionedCapacityOutput</code>.
     * @alias module:model/ListProvisionedCapacityOutput
     */
    constructor() { 
        
        ListProvisionedCapacityOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListProvisionedCapacityOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListProvisionedCapacityOutput} obj Optional instance to populate.
     * @return {module:model/ListProvisionedCapacityOutput} The populated <code>ListProvisionedCapacityOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListProvisionedCapacityOutput();

            if (data.hasOwnProperty('ProvisionedCapacityList')) {
                obj['ProvisionedCapacityList'] = ApiClient.convertToType(data['ProvisionedCapacityList'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListProvisionedCapacityOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListProvisionedCapacityOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ProvisionedCapacityList`
        if (data['ProvisionedCapacityList']) { // data not null
          Array.validateJSON(data['ProvisionedCapacityList']);
        }
...
/**
 * @member {Array} ProvisionedCapacityList
 */
ListProvisionedCapacityOutput.prototype['ProvisionedCapacityList'] = undefined;
...
export default ListProvisionedCapacityOutput;
