...
import InitiateVaultLockRequestPolicy from './InitiateVaultLockRequestPolicy';

/**
 * The InitiateVaultLockRequest model module.
 * @module model/InitiateVaultLockRequest
 * @version 2012-06-01
 */
class InitiateVaultLockRequest {
    /**
     * Constructs a new <code>InitiateVaultLockRequest</code>.
     * @alias module:model/InitiateVaultLockRequest
     */
    constructor() { 
        
        InitiateVaultLockRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InitiateVaultLockRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InitiateVaultLockRequest} obj Optional instance to populate.
     * @return {module:model/InitiateVaultLockRequest} The populated <code>InitiateVaultLockRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InitiateVaultLockRequest();

            if (data.hasOwnProperty('policy')) {
                obj['policy'] = InitiateVaultLockRequestPolicy.constructFromObject(data['policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InitiateVaultLockRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InitiateVaultLockRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `policy`
        if (data['policy']) { // data not null
          InitiateVaultLockRequestPolicy.validateJSON(data['policy']);
        }
...
/**
 * @member {module:model/InitiateVaultLockRequestPolicy} policy
 */
InitiateVaultLockRequest.prototype['policy'] = undefined;
...
export default InitiateVaultLockRequest;
