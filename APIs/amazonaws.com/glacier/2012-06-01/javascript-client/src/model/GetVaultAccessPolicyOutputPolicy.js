...
/**
 * The GetVaultAccessPolicyOutputPolicy model module.
 * @module model/GetVaultAccessPolicyOutputPolicy
 * @version 2012-06-01
 */
class GetVaultAccessPolicyOutputPolicy {
    /**
     * Constructs a new <code>GetVaultAccessPolicyOutputPolicy</code>.
     * @alias module:model/GetVaultAccessPolicyOutputPolicy
     * @implements module:model/VaultAccessPolicy
     */
    constructor() { 
        VaultAccessPolicy.initialize(this);
        GetVaultAccessPolicyOutputPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetVaultAccessPolicyOutputPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetVaultAccessPolicyOutputPolicy} obj Optional instance to populate.
     * @return {module:model/GetVaultAccessPolicyOutputPolicy} The populated <code>GetVaultAccessPolicyOutputPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetVaultAccessPolicyOutputPolicy();
            VaultAccessPolicy.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetVaultAccessPolicyOutputPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetVaultAccessPolicyOutputPolicy</code>.
     */
 ...
 */
GetVaultAccessPolicyOutputPolicy.prototype['Policy'] = undefined;


// Implement VaultAccessPolicy interface:
/**
 * @member {String} Policy
 */
VaultAccessPolicy.prototype['Policy'] = undefined;




export default GetVaultAccessPolicyOutputPolicy;
