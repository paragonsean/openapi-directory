...
import SetVaultAccessPolicyInputPolicy from './SetVaultAccessPolicyInputPolicy';

/**
 * The SetVaultAccessPolicyInput model module.
 * @module model/SetVaultAccessPolicyInput
 * @version 2012-06-01
 */
class SetVaultAccessPolicyInput {
    /**
     * Constructs a new <code>SetVaultAccessPolicyInput</code>.
     * SetVaultAccessPolicy input.
     * @alias module:model/SetVaultAccessPolicyInput
     */
    constructor() { 
        
        SetVaultAccessPolicyInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetVaultAccessPolicyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetVaultAccessPolicyInput} obj Optional instance to populate.
     * @return {module:model/SetVaultAccessPolicyInput} The populated <code>SetVaultAccessPolicyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetVaultAccessPolicyInput();

            if (data.hasOwnProperty('policy')) {
                obj['policy'] = SetVaultAccessPolicyInputPolicy.constructFromObject(data['policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SetVaultAccessPolicyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetVaultAccessPolicyInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `policy`
        if (data['policy']) { // data not null
          SetVaultAccessPolicyInputPolicy.validateJSON(data['policy']);
        }
...
/**
 * @member {module:model/SetVaultAccessPolicyInputPolicy} policy
 */
SetVaultAccessPolicyInput.prototype['policy'] = undefined;
...
export default SetVaultAccessPolicyInput;
