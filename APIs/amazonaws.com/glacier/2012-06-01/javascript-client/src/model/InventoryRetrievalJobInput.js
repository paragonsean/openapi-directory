...
/**
 * The InventoryRetrievalJobInput model module.
 * @module model/InventoryRetrievalJobInput
 * @version 2012-06-01
 */
class InventoryRetrievalJobInput {
    /**
     * Constructs a new <code>InventoryRetrievalJobInput</code>.
     * Provides options for specifying a range inventory retrieval job.
     * @alias module:model/InventoryRetrievalJobInput
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>InventoryRetrievalJobInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InventoryRetrievalJobInput} obj Optional instance to populate.
     * @return {module:model/InventoryRetrievalJobInput} The populated <code>InventoryRetrievalJobInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InventoryRetrievalJobInput();
    ...
    /**
     * Validates the JSON data with respect to <code>InventoryRetrievalJobInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InventoryRetrievalJobInput</code>.
     */
...
export default InventoryRetrievalJobInput;
