...
/**
 * The InitiateVaultLockRequestPolicy model module.
 * @module model/InitiateVaultLockRequestPolicy
 * @version 2012-06-01
 */
class InitiateVaultLockRequestPolicy {
    /**
     * Constructs a new <code>InitiateVaultLockRequestPolicy</code>.
     * Contains the vault lock policy.
     * @alias module:model/InitiateVaultLockRequestPolicy
     */
    constructor() { 
        
        InitiateVaultLockRequestPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InitiateVaultLockRequestPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InitiateVaultLockRequestPolicy} obj Optional instance to populate.
     * @return {module:model/InitiateVaultLockRequestPolicy} The populated <code>InitiateVaultLockRequestPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InitiateVaultLockRequestPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>InitiateVaultLockRequestPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InitiateVaultLockRequestPolicy</code>.
     */
 ...
 */
InitiateVaultLockRequestPolicy.prototype['Policy'] = undefined;
...
export default InitiateVaultLockRequestPolicy;
