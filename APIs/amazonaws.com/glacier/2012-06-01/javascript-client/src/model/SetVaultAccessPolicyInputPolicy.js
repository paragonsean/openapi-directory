...
/**
 * The SetVaultAccessPolicyInputPolicy model module.
 * @module model/SetVaultAccessPolicyInputPolicy
 * @version 2012-06-01
 */
class SetVaultAccessPolicyInputPolicy {
    /**
     * Constructs a new <code>SetVaultAccessPolicyInputPolicy</code>.
     * @alias module:model/SetVaultAccessPolicyInputPolicy
     * @implements module:model/VaultAccessPolicy
     */
    constructor() { 
        VaultAccessPolicy.initialize(this);
        SetVaultAccessPolicyInputPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetVaultAccessPolicyInputPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetVaultAccessPolicyInputPolicy} obj Optional instance to populate.
     * @return {module:model/SetVaultAccessPolicyInputPolicy} The populated <code>SetVaultAccessPolicyInputPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetVaultAccessPolicyInputPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>SetVaultAccessPolicyInputPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetVaultAccessPolicyInputPolicy</code>.
     */
 ...
 */
SetVaultAccessPolicyInputPolicy.prototype['Policy'] = undefined;
...
export default SetVaultAccessPolicyInputPolicy;
