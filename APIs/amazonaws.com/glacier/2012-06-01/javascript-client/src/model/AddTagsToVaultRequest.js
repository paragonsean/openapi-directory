...
/**
 * The AddTagsToVaultRequest model module.
 * @module model/AddTagsToVaultRequest
 * @version 2012-06-01
 */
class AddTagsToVaultRequest {
    /**
     * Constructs a new <code>AddTagsToVaultRequest</code>.
     * @alias module:model/AddTagsToVaultRequest
     */
    constructor() { 
        
        AddTagsToVaultRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddTagsToVaultRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddTagsToVaultRequest} obj Optional instance to populate.
     * @return {module:model/AddTagsToVaultRequest} The populated <code>AddTagsToVaultRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddTagsToVaultRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AddTagsToVaultRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddTagsToVaultRequest</code>.
     */
 ...
 */
AddTagsToVaultRequest.prototype['Tags'] = undefined;
...
export default AddTagsToVaultRequest;
