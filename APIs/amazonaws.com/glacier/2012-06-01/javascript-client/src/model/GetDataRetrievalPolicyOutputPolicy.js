...
/**
 * The GetDataRetrievalPolicyOutputPolicy model module.
 * @module model/GetDataRetrievalPolicyOutputPolicy
 * @version 2012-06-01
 */
class GetDataRetrievalPolicyOutputPolicy {
    /**
     * Constructs a new <code>GetDataRetrievalPolicyOutputPolicy</code>.
     * @alias module:model/GetDataRetrievalPolicyOutputPolicy
     * @implements module:model/DataRetrievalPolicy
     */
    constructor() { 
        DataRetrievalPolicy.initialize(this);
        GetDataRetrievalPolicyOutputPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDataRetrievalPolicyOutputPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDataRetrievalPolicyOutputPolicy} obj Optional instance to populate.
     * @return {module:model/GetDataRetrievalPolicyOutputPolicy} The populated <code>GetDataRetrievalPolicyOutputPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDataRetrievalPolicyOutputPolicy();
            DataRetrievalPolicy.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetDataRetrievalPolicyOutputPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDataRetrievalPolicyOutputPolicy</code>.
     */
 ...
 * @member {Array} Rules
 */
GetDataRetrievalPolicyOutputPolicy.prototype['Rules'] = undefined;


// Implement DataRetrievalPolicy interface:
/**
 * @member {Array} Rules
 */
...
export default GetDataRetrievalPolicyOutputPolicy;
