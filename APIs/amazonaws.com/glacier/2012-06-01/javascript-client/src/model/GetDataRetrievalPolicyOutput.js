...
import GetDataRetrievalPolicyOutputPolicy from './GetDataRetrievalPolicyOutputPolicy';

/**
 * The GetDataRetrievalPolicyOutput model module.
 * @module model/GetDataRetrievalPolicyOutput
 * @version 2012-06-01
 */
class GetDataRetrievalPolicyOutput {
    /**
     * Constructs a new <code>GetDataRetrievalPolicyOutput</code>.
     * Contains the Amazon S3 Glacier response to the &lt;code&gt;GetDataRetrievalPolicy&lt;/code&gt; request.
     * @alias module:model/GetDataRetrievalPolicyOutput
     */
    constructor() { 
        
        GetDataRetrievalPolicyOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDataRetrievalPolicyOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDataRetrievalPolicyOutput} obj Optional instance to populate.
     * @return {module:model/GetDataRetrievalPolicyOutput} The populated <code>GetDataRetrievalPolicyOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDataRetrievalPolicyOutput();

            if (data.hasOwnProperty('Policy')) {
                obj['Policy'] = GetDataRetrievalPolicyOutputPolicy.constructFromObject(data['Policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDataRetrievalPolicyOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDataRetrievalPolicyOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Policy`
        if (data['Policy']) { // data not null
          GetDataRetrievalPolicyOutputPolicy.validateJSON(data['Policy']);
        }
...
/**
 * @member {module:model/GetDataRetrievalPolicyOutputPolicy} Policy
 */
GetDataRetrievalPolicyOutput.prototype['Policy'] = undefined;
...
export default GetDataRetrievalPolicyOutput;
