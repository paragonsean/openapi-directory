...
/**
 * The SetDataRetrievalPolicyInputPolicy model module.
 * @module model/SetDataRetrievalPolicyInputPolicy
 * @version 2012-06-01
 */
class SetDataRetrievalPolicyInputPolicy {
    /**
     * Constructs a new <code>SetDataRetrievalPolicyInputPolicy</code>.
     * @alias module:model/SetDataRetrievalPolicyInputPolicy
     * @implements module:model/DataRetrievalPolicy
     */
    constructor() { 
        DataRetrievalPolicy.initialize(this);
        SetDataRetrievalPolicyInputPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetDataRetrievalPolicyInputPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetDataRetrievalPolicyInputPolicy} obj Optional instance to populate.
     * @return {module:model/SetDataRetrievalPolicyInputPolicy} The populated <code>SetDataRetrievalPolicyInputPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetDataRetrievalPolicyInputPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>SetDataRetrievalPolicyInputPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetDataRetrievalPolicyInputPolicy</code>.
     */
 ...
 * @member {Array} Rules
 */
SetDataRetrievalPolicyInputPolicy.prototype['Rules'] = undefined;
...
export default SetDataRetrievalPolicyInputPolicy;
