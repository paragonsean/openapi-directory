...
/**
 * The ListMultipartUploadsOutput model module.
 * @module model/ListMultipartUploadsOutput
 * @version 2012-06-01
 */
class ListMultipartUploadsOutput {
    /**
     * Constructs a new <code>ListMultipartUploadsOutput</code>.
     * Contains the Amazon S3 Glacier response to your request.
     * @alias module:model/ListMultipartUploadsOutput
     */
    constructor() { 
        
        ListMultipartUploadsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListMultipartUploadsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListMultipartUploadsOutput} obj Optional instance to populate.
     * @return {module:model/ListMultipartUploadsOutput} The populated <code>ListMultipartUploadsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListMultipartUploadsOutput();

            if (data.hasOwnProperty('UploadsList')) {
                obj['UploadsList'] = ApiClient.convertToType(data['UploadsList'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListMultipartUploadsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListMultipartUploadsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UploadsList`
        if (data['UploadsList']) { // data not null
          Array.validateJSON(data['UploadsList']);
        }
...
/**
 * @member {Array} UploadsList
 */
ListMultipartUploadsOutput.prototype['UploadsList'] = undefined;

/**
 * @member {String} Marker
 */
ListMultipartUploadsOutput.prototype['Marker'] = undefined;
...
export default ListMultipartUploadsOutput;
