...
/**
 * The InputSerialization model module.
 * @module model/InputSerialization
 * @version 2012-06-01
 */
class InputSerialization {
    /**
     * Constructs a new <code>InputSerialization</code>.
     * Describes how the archive is serialized.
     * @alias module:model/InputSerialization
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>InputSerialization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InputSerialization} obj Optional instance to populate.
     * @return {module:model/InputSerialization} The populated <code>InputSerialization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InputSerialization();
    ...
    /**
     * Validates the JSON data with respect to <code>InputSerialization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InputSerialization</code>.
     */
...
export default InputSerialization;
