...
* @readonly
*/
export default class FileHeaderInfo {
    ...
    /**
    * Returns a <code>FileHeaderInfo</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FileHeaderInfo} The enum <code>FileHeaderInfo</code> value.
    */
