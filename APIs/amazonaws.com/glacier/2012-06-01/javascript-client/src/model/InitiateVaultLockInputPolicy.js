...
import VaultLockPolicy from './VaultLockPolicy';

/**
 * The InitiateVaultLockInputPolicy model module.
 * @module model/InitiateVaultLockInputPolicy
 * @version 2012-06-01
 */
class InitiateVaultLockInputPolicy {
    /**
     * Constructs a new <code>InitiateVaultLockInputPolicy</code>.
     * @alias module:model/InitiateVaultLockInputPolicy
     * @implements module:model/VaultLockPolicy
     */
    constructor() { 
        VaultLockPolicy.initialize(this);
        InitiateVaultLockInputPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InitiateVaultLockInputPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InitiateVaultLockInputPolicy} obj Optional instance to populate.
     * @return {module:model/InitiateVaultLockInputPolicy} The populated <code>InitiateVaultLockInputPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InitiateVaultLockInputPolicy();
            VaultLockPolicy.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>InitiateVaultLockInputPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InitiateVaultLockInputPolicy</code>.
     */
 ...
 */
InitiateVaultLockInputPolicy.prototype['Policy'] = undefined;


// Implement VaultLockPolicy interface:
/**
 * @member {String} Policy
 */
...
export default InitiateVaultLockInputPolicy;
