...
/**
 * The UploadMultipartPartRequest model module.
 * @module model/UploadMultipartPartRequest
 * @version 2012-06-01
 */
class UploadMultipartPartRequest {
    /**
     * Constructs a new <code>UploadMultipartPartRequest</code>.
     * @alias module:model/UploadMultipartPartRequest
     */
    constructor() { 
        
        UploadMultipartPartRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UploadMultipartPartRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UploadMultipartPartRequest} obj Optional instance to populate.
     * @return {module:model/UploadMultipartPartRequest} The populated <code>UploadMultipartPartRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UploadMultipartPartRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UploadMultipartPartRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UploadMultipartPartRequest</code>.
     */
 ...
 * @member {String} body
 */
UploadMultipartPartRequest.prototype['body'] = undefined;
...
export default UploadMultipartPartRequest;
