...
class ListJobsOutput {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('JobList')) {
                obj['JobList'] = ApiClient.convertToType(data['JobList'], Array);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['JobList']) { // data not null
          Array.validateJSON(data['JobList']);
        }
...
/**
 * @member {Array} JobList
 */
ListJobsOutput.prototype['JobList'] = undefined;

/**
 * @member {String} Marker
 */
ListJobsOutput.prototype['Marker'] = undefined;
