...
/**
 * The AddTagsToVaultInput model module.
 * @module model/AddTagsToVaultInput
 * @version 2012-06-01
 */
class AddTagsToVaultInput {
    /**
     * Constructs a new <code>AddTagsToVaultInput</code>.
     * The input values for &lt;code&gt;AddTagsToVault&lt;/code&gt;.
     * @alias module:model/AddTagsToVaultInput
     */
    constructor() { 
        
        AddTagsToVaultInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddTagsToVaultInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddTagsToVaultInput} obj Optional instance to populate.
     * @return {module:model/AddTagsToVaultInput} The populated <code>AddTagsToVaultInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddTagsToVaultInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AddTagsToVaultInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddTagsToVaultInput</code>.
     */
 ...
 * @member {Object} Tags
 */
AddTagsToVaultInput.prototype['Tags'] = undefined;
...
export default AddTagsToVaultInput;
