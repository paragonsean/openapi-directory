...
import GetVaultAccessPolicyOutputPolicy from './GetVaultAccessPolicyOutputPolicy';

/**
 * The GetVaultAccessPolicyOutput model module.
 * @module model/GetVaultAccessPolicyOutput
 * @version 2012-06-01
 */
class GetVaultAccessPolicyOutput {
    /**
     * Constructs a new <code>GetVaultAccessPolicyOutput</code>.
     * Output for GetVaultAccessPolicy.
     * @alias module:model/GetVaultAccessPolicyOutput
     */
    constructor() { 
        
        GetVaultAccessPolicyOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetVaultAccessPolicyOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetVaultAccessPolicyOutput} obj Optional instance to populate.
     * @return {module:model/GetVaultAccessPolicyOutput} The populated <code>GetVaultAccessPolicyOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetVaultAccessPolicyOutput();

            if (data.hasOwnProperty('policy')) {
                obj['policy'] = GetVaultAccessPolicyOutputPolicy.constructFromObject(data['policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetVaultAccessPolicyOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetVaultAccessPolicyOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `policy`
        if (data['policy']) { // data not null
          GetVaultAccessPolicyOutputPolicy.validateJSON(data['policy']);
        }
...
/**
 * @member {module:model/GetVaultAccessPolicyOutputPolicy} policy
 */
GetVaultAccessPolicyOutput.prototype['policy'] = undefined;
...
export default GetVaultAccessPolicyOutput;
