...
import SetVaultAccessPolicyRequestPolicy from './SetVaultAccessPolicyRequestPolicy';

/**
 * The SetVaultAccessPolicyRequest model module.
 * @module model/SetVaultAccessPolicyRequest
 * @version 2012-06-01
 */
class SetVaultAccessPolicyRequest {
    /**
     * Constructs a new <code>SetVaultAccessPolicyRequest</code>.
     * @alias module:model/SetVaultAccessPolicyRequest
     */
    constructor() { 
        
        SetVaultAccessPolicyRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetVaultAccessPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetVaultAccessPolicyRequest} obj Optional instance to populate.
     * @return {module:model/SetVaultAccessPolicyRequest} The populated <code>SetVaultAccessPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetVaultAccessPolicyRequest();

            if (data.hasOwnProperty('policy')) {
                obj['policy'] = SetVaultAccessPolicyRequestPolicy.constructFromObject(data['policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SetVaultAccessPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetVaultAccessPolicyRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `policy`
        if (data['policy']) { // data not null
          SetVaultAccessPolicyRequestPolicy.validateJSON(data['policy']);
        }
...
/**
 * @member {module:model/SetVaultAccessPolicyRequestPolicy} policy
 */
SetVaultAccessPolicyRequest.prototype['policy'] = undefined;
...
export default SetVaultAccessPolicyRequest;
