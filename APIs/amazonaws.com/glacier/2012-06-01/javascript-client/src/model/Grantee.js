...
/**
 * The Grantee model module.
 * @module model/Grantee
 * @version 2012-06-01
 */
class Grantee {
    /**
     * Constructs a new <code>Grantee</code>.
     * Contains information about the grantee.
     * @alias module:model/Grantee
    ...
    /**
     * Constructs a <code>Grantee</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Grantee} obj Optional instance to populate.
     * @return {module:model/Grantee} The populated <code>Grantee</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Grantee</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Grantee</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Grantee.RequiredProperties) {
...
Grantee.RequiredProperties = ["Type"];
