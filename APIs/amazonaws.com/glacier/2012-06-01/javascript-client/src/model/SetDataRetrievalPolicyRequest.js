...
import SetDataRetrievalPolicyRequestPolicy from './SetDataRetrievalPolicyRequestPolicy';

/**
 * The SetDataRetrievalPolicyRequest model module.
 * @module model/SetDataRetrievalPolicyRequest
 * @version 2012-06-01
 */
class SetDataRetrievalPolicyRequest {
    /**
     * Constructs a new <code>SetDataRetrievalPolicyRequest</code>.
     * @alias module:model/SetDataRetrievalPolicyRequest
     */
    constructor() { 
        
        SetDataRetrievalPolicyRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetDataRetrievalPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetDataRetrievalPolicyRequest} obj Optional instance to populate.
     * @return {module:model/SetDataRetrievalPolicyRequest} The populated <code>SetDataRetrievalPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetDataRetrievalPolicyRequest();

            if (data.hasOwnProperty('Policy')) {
                obj['Policy'] = SetDataRetrievalPolicyRequestPolicy.constructFromObject(data['Policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SetDataRetrievalPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetDataRetrievalPolicyRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Policy`
        if (data['Policy']) { // data not null
          SetDataRetrievalPolicyRequestPolicy.validateJSON(data['Policy']);
        }
...
/**
 * @member {module:model/SetDataRetrievalPolicyRequestPolicy} Policy
 */
SetDataRetrievalPolicyRequest.prototype['Policy'] = undefined;
...
export default SetDataRetrievalPolicyRequest;
