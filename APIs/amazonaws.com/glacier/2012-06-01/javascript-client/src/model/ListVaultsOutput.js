...
/**
 * The ListVaultsOutput model module.
 * @module model/ListVaultsOutput
 * @version 2012-06-01
 */
class ListVaultsOutput {
    /**
     * Constructs a new <code>ListVaultsOutput</code>.
     * Contains the Amazon S3 Glacier response to your request.
     * @alias module:model/ListVaultsOutput
     */
    constructor() { 
        
        ListVaultsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListVaultsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListVaultsOutput} obj Optional instance to populate.
     * @return {module:model/ListVaultsOutput} The populated <code>ListVaultsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListVaultsOutput();

            if (data.hasOwnProperty('VaultList')) {
                obj['VaultList'] = ApiClient.convertToType(data['VaultList'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListVaultsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListVaultsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `VaultList`
        if (data['VaultList']) { // data not null
          Array.validateJSON(data['VaultList']);
        }
...
/**
 * @member {Array} VaultList
 */
ListVaultsOutput.prototype['VaultList'] = undefined;

/**
 * @member {String} Marker
 */
ListVaultsOutput.prototype['Marker'] = undefined;
...
export default ListVaultsOutput;
