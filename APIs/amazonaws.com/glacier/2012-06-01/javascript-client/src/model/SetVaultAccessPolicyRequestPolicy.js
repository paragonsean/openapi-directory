...
/**
 * The SetVaultAccessPolicyRequestPolicy model module.
 * @module model/SetVaultAccessPolicyRequestPolicy
 * @version 2012-06-01
 */
class SetVaultAccessPolicyRequestPolicy {
    /**
     * Constructs a new <code>SetVaultAccessPolicyRequestPolicy</code>.
     * Contains the vault access policy.
     * @alias module:model/SetVaultAccessPolicyRequestPolicy
     */
    constructor() { 
        
        SetVaultAccessPolicyRequestPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetVaultAccessPolicyRequestPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetVaultAccessPolicyRequestPolicy} obj Optional instance to populate.
     * @return {module:model/SetVaultAccessPolicyRequestPolicy} The populated <code>SetVaultAccessPolicyRequestPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetVaultAccessPolicyRequestPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>SetVaultAccessPolicyRequestPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetVaultAccessPolicyRequestPolicy</code>.
     */
 ...
 */
SetVaultAccessPolicyRequestPolicy.prototype['Policy'] = undefined;
...
export default SetVaultAccessPolicyRequestPolicy;
