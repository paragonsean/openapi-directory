...
* @readonly
*/
export default class QuoteFields {
    ...
    /**
    * Returns a <code>QuoteFields</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/QuoteFields} The enum <code>QuoteFields</code> value.
    */
