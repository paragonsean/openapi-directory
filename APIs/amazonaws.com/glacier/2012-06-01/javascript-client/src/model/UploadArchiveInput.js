...
/**
 * The UploadArchiveInput model module.
 * @module model/UploadArchiveInput
 * @version 2012-06-01
 */
class UploadArchiveInput {
    /**
     * Constructs a new <code>UploadArchiveInput</code>.
     * Provides options to add an archive to a vault.
     * @alias module:model/UploadArchiveInput
     */
    constructor() { 
        
        UploadArchiveInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UploadArchiveInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UploadArchiveInput} obj Optional instance to populate.
     * @return {module:model/UploadArchiveInput} The populated <code>UploadArchiveInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UploadArchiveInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UploadArchiveInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UploadArchiveInput</code>.
     */
 ...
 * @member {String} body
 */
UploadArchiveInput.prototype['body'] = undefined;
...
export default UploadArchiveInput;
