...
import InitiateJobInputJobParameters from './InitiateJobInputJobParameters';

/**
 * The InitiateJobInput model module.
 * @module model/InitiateJobInput
 * @version 2012-06-01
 */
class InitiateJobInput {
    /**
     * Constructs a new <code>InitiateJobInput</code>.
     * Provides options for initiating an Amazon S3 Glacier job.
     * @alias module:model/InitiateJobInput
     */
    constructor() { 
        
        InitiateJobInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InitiateJobInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InitiateJobInput} obj Optional instance to populate.
     * @return {module:model/InitiateJobInput} The populated <code>InitiateJobInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InitiateJobInput();

            if (data.hasOwnProperty('jobParameters')) {
                obj['jobParameters'] = InitiateJobInputJobParameters.constructFromObject(data['jobParameters']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InitiateJobInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InitiateJobInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `jobParameters`
        if (data['jobParameters']) { // data not null
          InitiateJobInputJobParameters.validateJSON(data['jobParameters']);
        }
...
/**
 * @member {module:model/InitiateJobInputJobParameters} jobParameters
 */
InitiateJobInput.prototype['jobParameters'] = undefined;
...
export default InitiateJobInput;
