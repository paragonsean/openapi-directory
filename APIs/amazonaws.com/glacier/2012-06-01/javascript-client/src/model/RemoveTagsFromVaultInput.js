...
/**
 * The RemoveTagsFromVaultInput model module.
 * @module model/RemoveTagsFromVaultInput
 * @version 2012-06-01
 */
class RemoveTagsFromVaultInput {
    /**
     * Constructs a new <code>RemoveTagsFromVaultInput</code>.
     * The input value for &lt;code&gt;RemoveTagsFromVaultInput&lt;/code&gt;.
     * @alias module:model/RemoveTagsFromVaultInput
     */
    constructor() { 
        
        RemoveTagsFromVaultInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemoveTagsFromVaultInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveTagsFromVaultInput} obj Optional instance to populate.
     * @return {module:model/RemoveTagsFromVaultInput} The populated <code>RemoveTagsFromVaultInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveTagsFromVaultInput();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveTagsFromVaultInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveTagsFromVaultInput</code>.
     */
 ...
 */
RemoveTagsFromVaultInput.prototype['TagKeys'] = undefined;
...
export default RemoveTagsFromVaultInput;
