...
import SetDataRetrievalPolicyInputPolicy from './SetDataRetrievalPolicyInputPolicy';

/**
 * The SetDataRetrievalPolicyInput model module.
 * @module model/SetDataRetrievalPolicyInput
 * @version 2012-06-01
 */
class SetDataRetrievalPolicyInput {
    /**
     * Constructs a new <code>SetDataRetrievalPolicyInput</code>.
     * SetDataRetrievalPolicy input.
     * @alias module:model/SetDataRetrievalPolicyInput
     */
    constructor() { 
        
        SetDataRetrievalPolicyInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetDataRetrievalPolicyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetDataRetrievalPolicyInput} obj Optional instance to populate.
     * @return {module:model/SetDataRetrievalPolicyInput} The populated <code>SetDataRetrievalPolicyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetDataRetrievalPolicyInput();

            if (data.hasOwnProperty('Policy')) {
                obj['Policy'] = SetDataRetrievalPolicyInputPolicy.constructFromObject(data['Policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SetDataRetrievalPolicyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetDataRetrievalPolicyInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Policy`
        if (data['Policy']) { // data not null
          SetDataRetrievalPolicyInputPolicy.validateJSON(data['Policy']);
        }
...
/**
 * @member {module:model/SetDataRetrievalPolicyInputPolicy} Policy
 */
SetDataRetrievalPolicyInput.prototype['Policy'] = undefined;
...
export default SetDataRetrievalPolicyInput;
