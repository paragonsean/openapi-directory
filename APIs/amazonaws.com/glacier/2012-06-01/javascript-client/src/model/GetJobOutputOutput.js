...
/**
 * The GetJobOutputOutput model module.
 * @module model/GetJobOutputOutput
 * @version 2012-06-01
 */
class GetJobOutputOutput {
    /**
     * Constructs a new <code>GetJobOutputOutput</code>.
     * Contains the Amazon S3 Glacier response to your request.
     * @alias module:model/GetJobOutputOutput
     */
    constructor() { 
        
        GetJobOutputOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetJobOutputOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetJobOutputOutput} obj Optional instance to populate.
     * @return {module:model/GetJobOutputOutput} The populated <code>GetJobOutputOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetJobOutputOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetJobOutputOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetJobOutputOutput</code>.
     */
 ...
 * @member {String} body
 */
GetJobOutputOutput.prototype['body'] = undefined;

/**
 * @member {Number} status
 */
GetJobOutputOutput.prototype['status'] = undefined;
...
export default GetJobOutputOutput;
