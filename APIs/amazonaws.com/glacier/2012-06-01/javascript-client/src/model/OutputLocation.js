...
import OutputLocationS3 from './OutputLocationS3';

/**
 * The OutputLocation model module.
 * @module model/OutputLocation
 * @version 2012-06-01
 */
class OutputLocation {
    /**
     * Constructs a new <code>OutputLocation</code>.
     * Contains information about the location where the select job results are stored.
     * @alias module:model/OutputLocation
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>OutputLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OutputLocation} obj Optional instance to populate.
     * @return {module:model/OutputLocation} The populated <code>OutputLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OutputLocation();

            if (data.hasOwnProperty('S3')) {
                obj['S3'] = OutputLocationS3.constructFromObject(data['S3']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OutputLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OutputLocation</code>.
     */
    static validateJSON(data) {
        // validate the optional field `S3`
        if (data['S3']) { // data not null
          OutputLocationS3.validateJSON(data['S3']);
        }
...
/**
 * @member {module:model/OutputLocationS3} S3
 */
OutputLocation.prototype['S3'] = undefined;
