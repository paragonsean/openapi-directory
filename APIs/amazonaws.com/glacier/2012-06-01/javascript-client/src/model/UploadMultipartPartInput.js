...
/**
 * The UploadMultipartPartInput model module.
 * @module model/UploadMultipartPartInput
 * @version 2012-06-01
 */
class UploadMultipartPartInput {
    /**
     * Constructs a new <code>UploadMultipartPartInput</code>.
     * Provides options to upload a part of an archive in a multipart upload operation.
     * @alias module:model/UploadMultipartPartInput
     */
    constructor() { 
        
        UploadMultipartPartInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UploadMultipartPartInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UploadMultipartPartInput} obj Optional instance to populate.
     * @return {module:model/UploadMultipartPartInput} The populated <code>UploadMultipartPartInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UploadMultipartPartInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UploadMultipartPartInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UploadMultipartPartInput</code>.
     */
 ...
 * @member {String} body
 */
UploadMultipartPartInput.prototype['body'] = undefined;
...
export default UploadMultipartPartInput;
