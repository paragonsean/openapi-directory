...
/**
 * The DataRetrievalPolicy model module.
 * @module model/DataRetrievalPolicy
 * @version 2012-06-01
 */
class DataRetrievalPolicy {
    /**
     * Constructs a new <code>DataRetrievalPolicy</code>.
     * Data retrieval policy.
     * @alias module:model/DataRetrievalPolicy
     */
    constructor() { 
        
        DataRetrievalPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DataRetrievalPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataRetrievalPolicy} obj Optional instance to populate.
     * @return {module:model/DataRetrievalPolicy} The populated <code>DataRetrievalPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataRetrievalPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>DataRetrievalPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataRetrievalPolicy</code>.
     */
 ...
 * @member {Array} Rules
 */
DataRetrievalPolicy.prototype['Rules'] = undefined;
...
export default DataRetrievalPolicy;
