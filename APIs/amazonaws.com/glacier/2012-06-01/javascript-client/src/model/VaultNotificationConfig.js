...
/**
 * The VaultNotificationConfig model module.
 * @module model/VaultNotificationConfig
 * @version 2012-06-01
 */
class VaultNotificationConfig {
    /**
     * Constructs a new <code>VaultNotificationConfig</code>.
     * Represents a vault&#39;s notification configuration.
     * @alias module:model/VaultNotificationConfig
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>VaultNotificationConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VaultNotificationConfig} obj Optional instance to populate.
     * @return {module:model/VaultNotificationConfig} The populated <code>VaultNotificationConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VaultNotificationConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>VaultNotificationConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VaultNotificationConfig</code>.
     */
...
export default VaultNotificationConfig;
