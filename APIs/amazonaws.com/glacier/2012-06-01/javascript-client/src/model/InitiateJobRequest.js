...
import InitiateJobRequestJobParameters from './InitiateJobRequestJobParameters';

/**
 * The InitiateJobRequest model module.
 * @module model/InitiateJobRequest
 * @version 2012-06-01
 */
class InitiateJobRequest {
    /**
     * Constructs a new <code>InitiateJobRequest</code>.
     * @alias module:model/InitiateJobRequest
     */
    constructor() { 
        
        InitiateJobRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InitiateJobRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InitiateJobRequest} obj Optional instance to populate.
     * @return {module:model/InitiateJobRequest} The populated <code>InitiateJobRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InitiateJobRequest();

            if (data.hasOwnProperty('jobParameters')) {
                obj['jobParameters'] = InitiateJobRequestJobParameters.constructFromObject(data['jobParameters']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InitiateJobRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InitiateJobRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `jobParameters`
        if (data['jobParameters']) { // data not null
          InitiateJobRequestJobParameters.validateJSON(data['jobParameters']);
        }
...
/**
 * @member {module:model/InitiateJobRequestJobParameters} jobParameters
 */
InitiateJobRequest.prototype['jobParameters'] = undefined;
...
export default InitiateJobRequest;
