...
/**
 * The OutputSerialization model module.
 * @module model/OutputSerialization
 * @version 2012-06-01
 */
class OutputSerialization {
    /**
     * Constructs a new <code>OutputSerialization</code>.
     * Describes how the select output is serialized.
     * @alias module:model/OutputSerialization
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>OutputSerialization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OutputSerialization} obj Optional instance to populate.
     * @return {module:model/OutputSerialization} The populated <code>OutputSerialization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OutputSerialization();
    ...
    /**
     * Validates the JSON data with respect to <code>OutputSerialization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OutputSerialization</code>.
     */
...
export default OutputSerialization;
