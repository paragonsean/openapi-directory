...
* @readonly
*/
export default class CannedACL {
    ...
    /**
    * Returns a <code>CannedACL</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CannedACL} The enum <code>CannedACL</code> value.
    */
