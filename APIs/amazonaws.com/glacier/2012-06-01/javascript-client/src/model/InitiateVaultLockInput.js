...
import InitiateVaultLockInputPolicy from './InitiateVaultLockInputPolicy';

/**
 * The InitiateVaultLockInput model module.
 * @module model/InitiateVaultLockInput
 * @version 2012-06-01
 */
class InitiateVaultLockInput {
    /**
     * Constructs a new <code>InitiateVaultLockInput</code>.
     * The input values for &lt;code&gt;InitiateVaultLock&lt;/code&gt;.
     * @alias module:model/InitiateVaultLockInput
     */
    constructor() { 
        
        InitiateVaultLockInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InitiateVaultLockInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InitiateVaultLockInput} obj Optional instance to populate.
     * @return {module:model/InitiateVaultLockInput} The populated <code>InitiateVaultLockInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InitiateVaultLockInput();

            if (data.hasOwnProperty('policy')) {
                obj['policy'] = InitiateVaultLockInputPolicy.constructFromObject(data['policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InitiateVaultLockInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InitiateVaultLockInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `policy`
        if (data['policy']) { // data not null
          InitiateVaultLockInputPolicy.validateJSON(data['policy']);
        }
...
/**
 * @member {module:model/InitiateVaultLockInputPolicy} policy
 */
InitiateVaultLockInput.prototype['policy'] = undefined;
...
export default InitiateVaultLockInput;
