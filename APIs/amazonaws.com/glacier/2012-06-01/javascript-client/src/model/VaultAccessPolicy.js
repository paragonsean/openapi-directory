...
/**
 * The VaultAccessPolicy model module.
 * @module model/VaultAccessPolicy
 * @version 2012-06-01
 */
class VaultAccessPolicy {
    /**
     * Constructs a new <code>VaultAccessPolicy</code>.
     * Contains the vault access policy.
     * @alias module:model/VaultAccessPolicy
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>VaultAccessPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VaultAccessPolicy} obj Optional instance to populate.
     * @return {module:model/VaultAccessPolicy} The populated <code>VaultAccessPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VaultAccessPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>VaultAccessPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VaultAccessPolicy</code>.
     */
...
export default VaultAccessPolicy;
