...
public class Grantee {
  ...
  public Grantee displayName(String displayName) {
  ...
  public Grantee emailAddress(String emailAddress) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, grantee.type) &&
        Objects.equals(this.displayName, grantee.displayName) &&
        Objects.equals(this.URI, grantee.URI) &&
        Objects.equals(this.ID, grantee.ID) &&
        Objects.equals(this.emailAddress, grantee.emailAddress);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Grantee
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Grantee.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Grantee is not found in the empty JSON string", Grantee.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Grantee.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Grantee` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Grantee.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Grantee.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Grantee' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Grantee> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Grantee.class));

       return (TypeAdapter<T>) new TypeAdapter<Grantee>() {
           @Override
           public void write(JsonWriter out, Grantee value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Grantee read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Grantee given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Grantee
   * @throws IOException if the JSON string is invalid with respect to Grantee
   */
  public static Grantee fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Grantee.class);
  }

  /**
   * Convert an instance of Grantee to an JSON string
   *
   * @return JSON string
   */
