...
public class JobParameters {
  ...
  public JobParameters format(String format) {
    this.format = format;
    return this;
  }
  ...
  public JobParameters type(String type) {
    this.type = type;
    return this;
  }
  ...
  public JobParameters archiveId(String archiveId) {
  ...
  public JobParameters description(String description) {
  ...
  public JobParameters snSTopic(String snSTopic) {
  ...
  public JobParameters retrievalByteRange(String retrievalByteRange) {
  ...
  public JobParameters tier(String tier) {
    this.tier = tier;
    return this;
  }
  ...
  public JobParameters inventoryRetrievalParameters(InitiateJobRequestJobParametersInventoryRetrievalParameters inventoryRetrievalParameters) {
  ...
  public JobParameters selectParameters(InitiateJobRequestJobParametersSelectParameters selectParameters) {
  ...
  public JobParameters outputLocation(InitiateJobRequestJobParametersOutputLocation outputLocation) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.format, jobParameters.format) &&
        Objects.equals(this.type, jobParameters.type) &&
        Objects.equals(this.archiveId, jobParameters.archiveId) &&
        Objects.equals(this.description, jobParameters.description) &&
        Objects.equals(this.snSTopic, jobParameters.snSTopic) &&
        Objects.equals(this.retrievalByteRange, jobParameters.retrievalByteRange) &&
        Objects.equals(this.tier, jobParameters.tier) &&
        Objects.equals(this.inventoryRetrievalParameters, jobParameters.inventoryRetrievalParameters) &&
        Objects.equals(this.selectParameters, jobParameters.selectParameters) &&
        Objects.equals(this.outputLocation, jobParameters.outputLocation);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobParameters is not found in the empty JSON string", JobParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<JobParameters>() {
           @Override
           public void write(JsonWriter out, JobParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobParameters
   * @throws IOException if the JSON string is invalid with respect to JobParameters
   */
  public static JobParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobParameters.class);
  }

  /**
   * Convert an instance of JobParameters to an JSON string
   *
   * @return JSON string
   */
