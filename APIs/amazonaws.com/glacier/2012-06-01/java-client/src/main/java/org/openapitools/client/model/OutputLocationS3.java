...
public class OutputLocationS3 {
  ...
  public OutputLocationS3() {
  }

  public OutputLocationS3 bucketName(String bucketName) {
  ...
  public OutputLocationS3 prefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public OutputLocationS3 encryption(S3LocationEncryption encryption) {
  ...
  public OutputLocationS3 cannedACL(CannedACL cannedACL) {
  ...
  public OutputLocationS3 accessControlList(List accessControlList) {
  ...
  public OutputLocationS3 tagging(Map tagging) {
  ...
  public OutputLocationS3 userMetadata(Map userMetadata) {
  ...
  public OutputLocationS3 storageClass(StorageClass storageClass) {
  ...
  public boolean equals(Object o) {
    ...
    OutputLocationS3 outputLocationS3 = (OutputLocationS3) o;
    return Objects.equals(this.bucketName, outputLocationS3.bucketName) &&
        Objects.equals(this.prefix, outputLocationS3.prefix) &&
        Objects.equals(this.encryption, outputLocationS3.encryption) &&
        Objects.equals(this.cannedACL, outputLocationS3.cannedACL) &&
        Objects.equals(this.accessControlList, outputLocationS3.accessControlList) &&
        Objects.equals(this.tagging, outputLocationS3.tagging) &&
        Objects.equals(this.userMetadata, outputLocationS3.userMetadata) &&
        Objects.equals(this.storageClass, outputLocationS3.storageClass);
  }
  ...
  public String toString() {
    ...
    sb.append("class OutputLocationS3 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OutputLocationS3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OutputLocationS3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OutputLocationS3 is not found in the empty JSON string", OutputLocationS3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OutputLocationS3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OutputLocationS3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OutputLocationS3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OutputLocationS3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OutputLocationS3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OutputLocationS3.class));

       return (TypeAdapter<T>) new TypeAdapter<OutputLocationS3>() {
           @Override
           public void write(JsonWriter out, OutputLocationS3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OutputLocationS3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OutputLocationS3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OutputLocationS3
   * @throws IOException if the JSON string is invalid with respect to OutputLocationS3
   */
  public static OutputLocationS3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OutputLocationS3.class);
  }

  /**
   * Convert an instance of OutputLocationS3 to an JSON string
   *
   * @return JSON string
   */
