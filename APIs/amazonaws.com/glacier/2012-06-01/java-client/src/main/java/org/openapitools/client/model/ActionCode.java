 ...
 */
@JsonAdapter(ActionCode.Adapter.class)
public enum ActionCode {
  ...
  public static ActionCode fromValue(String value) {
    for (ActionCode b : ActionCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<ActionCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ActionCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ActionCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ActionCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ActionCode.fromValue(value);
  }
}
