...
public class CSVOutput {
  ...
  public CSVOutput quoteFields(QuoteFields quoteFields) {
  ...
  public CSVOutput quoteEscapeCharacter(String quoteEscapeCharacter) {
  ...
  public CSVOutput recordDelimiter(String recordDelimiter) {
  ...
  public CSVOutput fieldDelimiter(String fieldDelimiter) {
  ...
  public CSVOutput quoteCharacter(String quoteCharacter) {
  ...
  public boolean equals(Object o) {
    ...
    CSVOutput csVOutput = (CSVOutput) o;
    return Objects.equals(this.quoteFields, csVOutput.quoteFields) &&
        Objects.equals(this.quoteEscapeCharacter, csVOutput.quoteEscapeCharacter) &&
        Objects.equals(this.recordDelimiter, csVOutput.recordDelimiter) &&
        Objects.equals(this.fieldDelimiter, csVOutput.fieldDelimiter) &&
        Objects.equals(this.quoteCharacter, csVOutput.quoteCharacter);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CSVOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CSVOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CSVOutput is not found in the empty JSON string", CSVOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CSVOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CSVOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CSVOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CSVOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CSVOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CSVOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CSVOutput>() {
           @Override
           public void write(JsonWriter out, CSVOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CSVOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CSVOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CSVOutput
   * @throws IOException if the JSON string is invalid with respect to CSVOutput
   */
  public static CSVOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CSVOutput.class);
  }

  /**
   * Convert an instance of CSVOutput to an JSON string
   *
   * @return JSON string
   */
