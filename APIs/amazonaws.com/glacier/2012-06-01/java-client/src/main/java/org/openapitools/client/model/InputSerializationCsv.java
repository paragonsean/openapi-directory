...
public class InputSerializationCsv {
  ...
  public InputSerializationCsv() {
  }

  public InputSerializationCsv fileHeaderInfo(FileHeaderInfo fileHeaderInfo) {
  ...
  public InputSerializationCsv comments(String comments) {
  ...
  public InputSerializationCsv quoteEscapeCharacter(String quoteEscapeCharacter) {
  ...
  public InputSerializationCsv recordDelimiter(String recordDelimiter) {
  ...
  public InputSerializationCsv fieldDelimiter(String fieldDelimiter) {
  ...
  public InputSerializationCsv quoteCharacter(String quoteCharacter) {
  ...
  public boolean equals(Object o) {
    ...
    InputSerializationCsv inputSerializationCsv = (InputSerializationCsv) o;
    return Objects.equals(this.fileHeaderInfo, inputSerializationCsv.fileHeaderInfo) &&
        Objects.equals(this.comments, inputSerializationCsv.comments) &&
        Objects.equals(this.quoteEscapeCharacter, inputSerializationCsv.quoteEscapeCharacter) &&
        Objects.equals(this.recordDelimiter, inputSerializationCsv.recordDelimiter) &&
        Objects.equals(this.fieldDelimiter, inputSerializationCsv.fieldDelimiter) &&
        Objects.equals(this.quoteCharacter, inputSerializationCsv.quoteCharacter);
  }
  ...
  public String toString() {
    ...
    sb.append("class InputSerializationCsv {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InputSerializationCsv
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InputSerializationCsv.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InputSerializationCsv is not found in the empty JSON string", InputSerializationCsv.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InputSerializationCsv.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InputSerializationCsv` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InputSerializationCsv.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InputSerializationCsv' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InputSerializationCsv> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InputSerializationCsv.class));

       return (TypeAdapter<T>) new TypeAdapter<InputSerializationCsv>() {
           @Override
           public void write(JsonWriter out, InputSerializationCsv value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InputSerializationCsv read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InputSerializationCsv given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InputSerializationCsv
   * @throws IOException if the JSON string is invalid with respect to InputSerializationCsv
   */
  public static InputSerializationCsv fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InputSerializationCsv.class);
  }

  /**
   * Convert an instance of InputSerializationCsv to an JSON string
   *
   * @return JSON string
   */
