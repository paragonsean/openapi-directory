...
/**
 * Gets or Sets CannedACL
 */
@JsonAdapter(CannedACL.Adapter.class)
public enum CannedACL {
  ...
  public static CannedACL fromValue(String value) {
    for (CannedACL b : CannedACL.values()) {
  ...
  public static class Adapter extends TypeAdapter<CannedACL> {
    @Override
    public void write(final JsonWriter jsonWriter, final CannedACL enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CannedACL read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CannedACL.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CannedACL.fromValue(value);
  }
}
