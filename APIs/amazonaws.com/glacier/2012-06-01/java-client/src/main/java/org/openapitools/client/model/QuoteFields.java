...
/**
 * Gets or Sets QuoteFields
 */
@JsonAdapter(QuoteFields.Adapter.class)
public enum QuoteFields {
  ...
  public static QuoteFields fromValue(String value) {
    for (QuoteFields b : QuoteFields.values()) {
  ...
  public static class Adapter extends TypeAdapter<QuoteFields> {
    @Override
    public void write(final JsonWriter jsonWriter, final QuoteFields enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public QuoteFields read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return QuoteFields.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    QuoteFields.fromValue(value);
  }
}
