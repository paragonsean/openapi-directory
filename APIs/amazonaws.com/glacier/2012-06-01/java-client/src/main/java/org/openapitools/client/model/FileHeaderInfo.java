...
/**
 * Gets or Sets FileHeaderInfo
 */
@JsonAdapter(FileHeaderInfo.Adapter.class)
public enum FileHeaderInfo {
  ...
  public static FileHeaderInfo fromValue(String value) {
    for (FileHeaderInfo b : FileHeaderInfo.values()) {
  ...
  public static class Adapter extends TypeAdapter<FileHeaderInfo> {
    @Override
    public void write(final JsonWriter jsonWriter, final FileHeaderInfo enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FileHeaderInfo read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FileHeaderInfo.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FileHeaderInfo.fromValue(value);
  }
}
