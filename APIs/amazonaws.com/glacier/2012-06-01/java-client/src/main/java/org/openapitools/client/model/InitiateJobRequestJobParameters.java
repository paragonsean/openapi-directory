...
public class InitiateJobRequestJobParameters {
  ...
  public InitiateJobRequestJobParameters() {
  }

  public InitiateJobRequestJobParameters format(String format) {
    this.format = format;
    return this;
  }
  ...
  public InitiateJobRequestJobParameters type(String type) {
    this.type = type;
    return this;
  }
  ...
  public InitiateJobRequestJobParameters archiveId(String archiveId) {
  ...
  public InitiateJobRequestJobParameters description(String description) {
  ...
  public InitiateJobRequestJobParameters snSTopic(String snSTopic) {
  ...
  public InitiateJobRequestJobParameters retrievalByteRange(String retrievalByteRange) {
  ...
  public InitiateJobRequestJobParameters tier(String tier) {
    this.tier = tier;
    return this;
  }
  ...
  public InitiateJobRequestJobParameters inventoryRetrievalParameters(InitiateJobRequestJobParametersInventoryRetrievalParameters inventoryRetrievalParameters) {
  ...
  public InitiateJobRequestJobParameters selectParameters(InitiateJobRequestJobParametersSelectParameters selectParameters) {
  ...
  public InitiateJobRequestJobParameters outputLocation(InitiateJobRequestJobParametersOutputLocation outputLocation) {
  ...
  public boolean equals(Object o) {
    ...
    InitiateJobRequestJobParameters initiateJobRequestJobParameters = (InitiateJobRequestJobParameters) o;
    return Objects.equals(this.format, initiateJobRequestJobParameters.format) &&
        Objects.equals(this.type, initiateJobRequestJobParameters.type) &&
        Objects.equals(this.archiveId, initiateJobRequestJobParameters.archiveId) &&
        Objects.equals(this.description, initiateJobRequestJobParameters.description) &&
        Objects.equals(this.snSTopic, initiateJobRequestJobParameters.snSTopic) &&
        Objects.equals(this.retrievalByteRange, initiateJobRequestJobParameters.retrievalByteRange) &&
        Objects.equals(this.tier, initiateJobRequestJobParameters.tier) &&
        Objects.equals(this.inventoryRetrievalParameters, initiateJobRequestJobParameters.inventoryRetrievalParameters) &&
        Objects.equals(this.selectParameters, initiateJobRequestJobParameters.selectParameters) &&
        Objects.equals(this.outputLocation, initiateJobRequestJobParameters.outputLocation);
  }
  ...
  public String toString() {
    ...
    sb.append("class InitiateJobRequestJobParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InitiateJobRequestJobParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InitiateJobRequestJobParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InitiateJobRequestJobParameters is not found in the empty JSON string", InitiateJobRequestJobParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InitiateJobRequestJobParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InitiateJobRequestJobParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitiateJobRequestJobParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitiateJobRequestJobParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitiateJobRequestJobParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitiateJobRequestJobParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<InitiateJobRequestJobParameters>() {
           @Override
           public void write(JsonWriter out, InitiateJobRequestJobParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InitiateJobRequestJobParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InitiateJobRequestJobParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InitiateJobRequestJobParameters
   * @throws IOException if the JSON string is invalid with respect to InitiateJobRequestJobParameters
   */
  public static InitiateJobRequestJobParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitiateJobRequestJobParameters.class);
  }

  /**
   * Convert an instance of InitiateJobRequestJobParameters to an JSON string
   *
   * @return JSON string
   */
