...
/*
 * OAIAddTagsToVault_request.h
 *
 * 
 */

#ifndef OAIAddTagsToVault_request_H
#define OAIAddTagsToVault_request_H
...
class OAIAddTagsToVault_request : public OAIObject {
public:
    OAIAddTagsToVault_request();
    OAIAddTagsToVault_request(QString json);
    ~OAIAddTagsToVault_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddTagsToVault_request)

#endif // OAIAddTagsToVault_request_H
