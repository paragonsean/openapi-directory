...
/*
 * OAISetVaultNotificationsInput_vaultNotificationConfig.h
 *
 * 
 */

#ifndef OAISetVaultNotificationsInput_vaultNotificationConfig_H
#define OAISetVaultNotificationsInput_vaultNotificationConfig_H
...
class OAISetVaultNotificationsInput_vaultNotificationConfig : public OAIObject {
public:
    OAISetVaultNotificationsInput_vaultNotificationConfig();
    OAISetVaultNotificationsInput_vaultNotificationConfig(QString json);
    ~OAISetVaultNotificationsInput_vaultNotificationConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetVaultNotificationsInput_vaultNotificationConfig)

#endif // OAISetVaultNotificationsInput_vaultNotificationConfig_H
