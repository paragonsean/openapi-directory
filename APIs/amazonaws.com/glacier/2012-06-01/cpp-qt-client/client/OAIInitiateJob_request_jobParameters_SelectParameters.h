...
/*
 * OAIInitiateJob_request_jobParameters_SelectParameters.h
 *
 * 
 */

#ifndef OAIInitiateJob_request_jobParameters_SelectParameters_H
#define OAIInitiateJob_request_jobParameters_SelectParameters_H
...
class OAIInitiateJob_request_jobParameters_SelectParameters : public OAIObject {
public:
    OAIInitiateJob_request_jobParameters_SelectParameters();
    OAIInitiateJob_request_jobParameters_SelectParameters(QString json);
    ~OAIInitiateJob_request_jobParameters_SelectParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitiateJob_request_jobParameters_SelectParameters)

#endif // OAIInitiateJob_request_jobParameters_SelectParameters_H
