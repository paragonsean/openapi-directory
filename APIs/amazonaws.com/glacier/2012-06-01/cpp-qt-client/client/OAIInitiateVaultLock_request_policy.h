...
/*
 * OAIInitiateVaultLock_request_policy.h
 *
 * Contains the vault lock policy.
 */

#ifndef OAIInitiateVaultLock_request_policy_H
#define OAIInitiateVaultLock_request_policy_H
...
class OAIInitiateVaultLock_request_policy : public OAIObject {
public:
    OAIInitiateVaultLock_request_policy();
    OAIInitiateVaultLock_request_policy(QString json);
    ~OAIInitiateVaultLock_request_policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitiateVaultLock_request_policy)

#endif // OAIInitiateVaultLock_request_policy_H
