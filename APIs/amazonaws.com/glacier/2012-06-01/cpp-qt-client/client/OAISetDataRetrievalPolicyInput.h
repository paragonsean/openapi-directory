...
/*
 * OAISetDataRetrievalPolicyInput.h
 *
 * SetDataRetrievalPolicy input.
 */

#ifndef OAISetDataRetrievalPolicyInput_H
#define OAISetDataRetrievalPolicyInput_H
...
namespace OpenAPI {
class OAISetDataRetrievalPolicyInput_Policy;

class OAISetDataRetrievalPolicyInput : public OAIObject {
public:
    OAISetDataRetrievalPolicyInput();
    OAISetDataRetrievalPolicyInput(QString json);
    ~OAISetDataRetrievalPolicyInput() override;
    ...
    OAISetDataRetrievalPolicyInput_Policy getPolicy() const;
    void setPolicy(const OAISetDataRetrievalPolicyInput_Policy &policy);
...
private:
    ...
    OAISetDataRetrievalPolicyInput_Policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetDataRetrievalPolicyInput)

#endif // OAISetDataRetrievalPolicyInput_H
