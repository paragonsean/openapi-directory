...
OAIQuoteFields::OAIQuoteFields(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIQuoteFields::OAIQuoteFields() {
    this->initializeModel();
}

OAIQuoteFields::~OAIQuoteFields() {}

void OAIQuoteFields::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIQuoteFields::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIQuoteFields::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ALWAYS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIQuoteFields::ALWAYS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ASNEEDED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIQuoteFields::ASNEEDED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIQuoteFields::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIQuoteFields::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIQuoteFields::ALWAYS:
            val = "ALWAYS";
            break;
        case eOAIQuoteFields::ASNEEDED:
            val = "ASNEEDED";
            break;
        default:
            break;
...
QJsonValue OAIQuoteFields::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIQuoteFields::eOAIQuoteFields OAIQuoteFields::getValue() const {
    return m_value;
}

void OAIQuoteFields::setValue(const OAIQuoteFields::eOAIQuoteFields& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIQuoteFields::isSet() const {
    
    return m_value_isSet;
}

bool OAIQuoteFields::isValid() const {
