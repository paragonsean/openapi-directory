...
#ifndef OAICannedACL_H
#define OAICannedACL_H
...
class OAICannedACL : public OAIEnum {
public:
    OAICannedACL();
    OAICannedACL(QString json);
    ~OAICannedACL() override;
    ...
    OAICannedACL::eOAICannedACL getValue() const;
    void setValue(const OAICannedACL::eOAICannedACL& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAICannedACL)

#endif // OAICannedACL_H
