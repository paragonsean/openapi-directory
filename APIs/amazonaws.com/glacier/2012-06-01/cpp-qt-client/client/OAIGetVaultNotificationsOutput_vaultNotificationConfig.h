...
/*
 * OAIGetVaultNotificationsOutput_vaultNotificationConfig.h
 *
 * 
 */

#ifndef OAIGetVaultNotificationsOutput_vaultNotificationConfig_H
#define OAIGetVaultNotificationsOutput_vaultNotificationConfig_H
...
class OAIGetVaultNotificationsOutput_vaultNotificationConfig : public OAIObject {
public:
    OAIGetVaultNotificationsOutput_vaultNotificationConfig();
    OAIGetVaultNotificationsOutput_vaultNotificationConfig(QString json);
    ~OAIGetVaultNotificationsOutput_vaultNotificationConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVaultNotificationsOutput_vaultNotificationConfig)

#endif // OAIGetVaultNotificationsOutput_vaultNotificationConfig_H
