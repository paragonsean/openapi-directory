...
/*
 * OAISetVaultAccessPolicyInput_policy.h
 *
 * 
 */

#ifndef OAISetVaultAccessPolicyInput_policy_H
#define OAISetVaultAccessPolicyInput_policy_H
...
class OAISetVaultAccessPolicyInput_policy : public OAIObject {
public:
    OAISetVaultAccessPolicyInput_policy();
    OAISetVaultAccessPolicyInput_policy(QString json);
    ~OAISetVaultAccessPolicyInput_policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetVaultAccessPolicyInput_policy)

#endif // OAISetVaultAccessPolicyInput_policy_H
