...
#include "OAISetDataRetrievalPolicy_request_Policy.h"
...
OAISetDataRetrievalPolicy_request_Policy::OAISetDataRetrievalPolicy_request_Policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetDataRetrievalPolicy_request_Policy::OAISetDataRetrievalPolicy_request_Policy() {
    this->initializeModel();
}

OAISetDataRetrievalPolicy_request_Policy::~OAISetDataRetrievalPolicy_request_Policy() {}

void OAISetDataRetrievalPolicy_request_Policy::initializeModel() {

    m_rules_isSet = false;
    m_rules_isValid = false;
}

void OAISetDataRetrievalPolicy_request_Policy::fromJson(QString jsonString) {
...
void OAISetDataRetrievalPolicy_request_Policy::fromJsonObject(QJsonObject json) {

    m_rules_isValid = ::OpenAPI::fromJsonValue(m_rules, json[QString("Rules")]);
    m_rules_isSet = !json[QString("Rules")].isNull() && m_rules_isValid;
}

QString OAISetDataRetrievalPolicy_request_Policy::asJson() const {
...
QJsonObject OAISetDataRetrievalPolicy_request_Policy::asJsonObject() const {
    QJsonObject obj;
    if (m_rules.isSet()) {
...
QList OAISetDataRetrievalPolicy_request_Policy::getRules() const {
    return m_rules;
}
void OAISetDataRetrievalPolicy_request_Policy::setRules(const QList &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}

bool OAISetDataRetrievalPolicy_request_Policy::is_rules_Set() const{
    return m_rules_isSet;
}

bool OAISetDataRetrievalPolicy_request_Policy::is_rules_Valid() const{
    return m_rules_isValid;
}

bool OAISetDataRetrievalPolicy_request_Policy::isSet() const {
...
bool OAISetDataRetrievalPolicy_request_Policy::isValid() const {
