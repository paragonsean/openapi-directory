...
#include "OAIVaultNotificationConfig.h"
...
OAIVaultNotificationConfig::OAIVaultNotificationConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVaultNotificationConfig::OAIVaultNotificationConfig() {
    this->initializeModel();
}

OAIVaultNotificationConfig::~OAIVaultNotificationConfig() {}

void OAIVaultNotificationConfig::initializeModel() {
...
void OAIVaultNotificationConfig::fromJson(QString jsonString) {
...
void OAIVaultNotificationConfig::fromJsonObject(QJsonObject json) {
...
QString OAIVaultNotificationConfig::asJson() const {
...
QJsonObject OAIVaultNotificationConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVaultNotificationConfig::getSnsTopic() const {
    return m_sns_topic;
}
void OAIVaultNotificationConfig::setSnsTopic(const QString &sns_topic) {
    m_sns_topic = sns_topic;
    m_sns_topic_isSet = true;
}

bool OAIVaultNotificationConfig::is_sns_topic_Set() const{
    return m_sns_topic_isSet;
}

bool OAIVaultNotificationConfig::is_sns_topic_Valid() const{
    return m_sns_topic_isValid;
}

QList OAIVaultNotificationConfig::getEvents() const {
    return m_events;
}
void OAIVaultNotificationConfig::setEvents(const QList &events) {
    m_events = events;
    m_events_isSet = true;
}

bool OAIVaultNotificationConfig::is_events_Set() const{
    return m_events_isSet;
}

bool OAIVaultNotificationConfig::is_events_Valid() const{
    return m_events_isValid;
}

bool OAIVaultNotificationConfig::isSet() const {
...
bool OAIVaultNotificationConfig::isValid() const {
