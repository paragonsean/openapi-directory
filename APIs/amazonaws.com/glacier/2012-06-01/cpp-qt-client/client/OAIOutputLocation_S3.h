...
/*
 * OAIOutputLocation_S3.h
 *
 * 
 */

#ifndef OAIOutputLocation_S3_H
#define OAIOutputLocation_S3_H
...
class OAIOutputLocation_S3 : public OAIObject {
public:
    OAIOutputLocation_S3();
    OAIOutputLocation_S3(QString json);
    ~OAIOutputLocation_S3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutputLocation_S3)

#endif // OAIOutputLocation_S3_H
