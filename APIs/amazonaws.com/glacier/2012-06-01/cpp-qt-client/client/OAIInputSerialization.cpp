...
#include "OAIInputSerialization.h"
...
OAIInputSerialization::OAIInputSerialization(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInputSerialization::OAIInputSerialization() {
    this->initializeModel();
}

OAIInputSerialization::~OAIInputSerialization() {}

void OAIInputSerialization::initializeModel() {

    m_csv_isSet = false;
    m_csv_isValid = false;
}

void OAIInputSerialization::fromJson(QString jsonString) {
...
QJsonObject OAIInputSerialization::asJsonObject() const {
    QJsonObject obj;
    if (m_csv.isSet()) {
...
OAIInputSerialization_csv OAIInputSerialization::getCsv() const {
    return m_csv;
}
void OAIInputSerialization::setCsv(const OAIInputSerialization_csv &csv) {
    m_csv = csv;
    m_csv_isSet = true;
}

bool OAIInputSerialization::is_csv_Set() const{
    return m_csv_isSet;
}

bool OAIInputSerialization::is_csv_Valid() const{
    return m_csv_isValid;
}

bool OAIInputSerialization::isSet() const {
...
bool OAIInputSerialization::isValid() const {
