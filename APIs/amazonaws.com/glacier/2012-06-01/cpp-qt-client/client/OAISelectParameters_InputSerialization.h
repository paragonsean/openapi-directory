...
/*
 * OAISelectParameters_InputSerialization.h
 *
 * 
 */

#ifndef OAISelectParameters_InputSerialization_H
#define OAISelectParameters_InputSerialization_H
...
namespace OpenAPI {
class OAIInputSerialization_csv;

class OAISelectParameters_InputSerialization : public OAIObject {
public:
    OAISelectParameters_InputSerialization();
    OAISelectParameters_InputSerialization(QString json);
    ~OAISelectParameters_InputSerialization() override;
    ...
    OAIInputSerialization_csv getCsv() const;
    void setCsv(const OAIInputSerialization_csv &csv);
...
private:
    ...
    OAIInputSerialization_csv m_csv;
    bool m_csv_isSet;
    bool m_csv_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAISelectParameters_InputSerialization)

#endif // OAISelectParameters_InputSerialization_H
