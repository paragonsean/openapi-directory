...
/*
 * OAIInputSerialization.h
 *
 * Describes how the archive is serialized.
 */

#ifndef OAIInputSerialization_H
#define OAIInputSerialization_H
...
class OAIInputSerialization : public OAIObject {
public:
    OAIInputSerialization();
    OAIInputSerialization(QString json);
    ~OAIInputSerialization() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputSerialization)

#endif // OAIInputSerialization_H
