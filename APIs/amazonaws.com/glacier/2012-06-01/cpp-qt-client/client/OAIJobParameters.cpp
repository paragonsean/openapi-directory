...
OAIJobParameters::OAIJobParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJobParameters::OAIJobParameters() {
    this->initializeModel();
}

OAIJobParameters::~OAIJobParameters() {}

void OAIJobParameters::initializeModel() {
...
void OAIJobParameters::fromJson(QString jsonString) {
...
void OAIJobParameters::fromJsonObject(QJsonObject json) {
...
QString OAIJobParameters::asJson() const {
...
QJsonObject OAIJobParameters::asJsonObject() const {
    QJsonObject obj;
    if (m_format_isSet) {
...
QString OAIJobParameters::getFormat() const {
    return m_format;
}
void OAIJobParameters::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIJobParameters::is_format_Set() const{
    return m_format_isSet;
}

bool OAIJobParameters::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIJobParameters::getType() const {
    return m_type;
}
void OAIJobParameters::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIJobParameters::is_type_Set() const{
    return m_type_isSet;
}

bool OAIJobParameters::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIJobParameters::getArchiveId() const {
    return m_archive_id;
}
void OAIJobParameters::setArchiveId(const QString &archive_id) {
    m_archive_id = archive_id;
    m_archive_id_isSet = true;
}

bool OAIJobParameters::is_archive_id_Set() const{
    return m_archive_id_isSet;
}

bool OAIJobParameters::is_archive_id_Valid() const{
    return m_archive_id_isValid;
}

QString OAIJobParameters::getDescription() const {
    return m_description;
}
void OAIJobParameters::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIJobParameters::is_description_Set() const{
    return m_description_isSet;
}

bool OAIJobParameters::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIJobParameters::getSnsTopic() const {
    return m_sns_topic;
}
void OAIJobParameters::setSnsTopic(const QString &sns_topic) {
    m_sns_topic = sns_topic;
    m_sns_topic_isSet = true;
}

bool OAIJobParameters::is_sns_topic_Set() const{
    return m_sns_topic_isSet;
}

bool OAIJobParameters::is_sns_topic_Valid() const{
    return m_sns_topic_isValid;
}

QString OAIJobParameters::getRetrievalByteRange() const {
    return m_retrieval_byte_range;
}
void OAIJobParameters::setRetrievalByteRange(const QString &retrieval_byte_range) {
    m_retrieval_byte_range = retrieval_byte_range;
    m_retrieval_byte_range_isSet = true;
}

bool OAIJobParameters::is_retrieval_byte_range_Set() const{
    return m_retrieval_byte_range_isSet;
}

bool OAIJobParameters::is_retrieval_byte_range_Valid() const{
    return m_retrieval_byte_range_isValid;
}

QString OAIJobParameters::getTier() const {
    return m_tier;
}
void OAIJobParameters::setTier(const QString &tier) {
    m_tier = tier;
    m_tier_isSet = true;
}

bool OAIJobParameters::is_tier_Set() const{
    return m_tier_isSet;
}

bool OAIJobParameters::is_tier_Valid() const{
    return m_tier_isValid;
}

OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters OAIJobParameters::getInventoryRetrievalParameters() const {
    return m_inventory_retrieval_parameters;
}
void OAIJobParameters::setInventoryRetrievalParameters(const OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters &inventory_retrieval_parameters) {
    m_inventory_retrieval_parameters = inventory_retrieval_parameters;
    m_inventory_retrieval_parameters_isSet = true;
}

bool OAIJobParameters::is_inventory_retrieval_parameters_Set() const{
    return m_inventory_retrieval_parameters_isSet;
}

bool OAIJobParameters::is_inventory_retrieval_parameters_Valid() const{
    return m_inventory_retrieval_parameters_isValid;
}

OAIInitiateJob_request_jobParameters_SelectParameters OAIJobParameters::getSelectParameters() const {
    return m_select_parameters;
}
void OAIJobParameters::setSelectParameters(const OAIInitiateJob_request_jobParameters_SelectParameters &select_parameters) {
    m_select_parameters = select_parameters;
    m_select_parameters_isSet = true;
}

bool OAIJobParameters::is_select_parameters_Set() const{
    return m_select_parameters_isSet;
}

bool OAIJobParameters::is_select_parameters_Valid() const{
    return m_select_parameters_isValid;
}

OAIInitiateJob_request_jobParameters_OutputLocation OAIJobParameters::getOutputLocation() const {
    return m_output_location;
}
void OAIJobParameters::setOutputLocation(const OAIInitiateJob_request_jobParameters_OutputLocation &output_location) {
    m_output_location = output_location;
    m_output_location_isSet = true;
}

bool OAIJobParameters::is_output_location_Set() const{
    return m_output_location_isSet;
}

bool OAIJobParameters::is_output_location_Valid() const{
    return m_output_location_isValid;
}

bool OAIJobParameters::isSet() const {
...
bool OAIJobParameters::isValid() const {
