...
#include "OAIGetVaultAccessPolicyOutput_policy.h"
...
OAIGetVaultAccessPolicyOutput_policy::OAIGetVaultAccessPolicyOutput_policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetVaultAccessPolicyOutput_policy::OAIGetVaultAccessPolicyOutput_policy() {
    this->initializeModel();
}

OAIGetVaultAccessPolicyOutput_policy::~OAIGetVaultAccessPolicyOutput_policy() {}

void OAIGetVaultAccessPolicyOutput_policy::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIGetVaultAccessPolicyOutput_policy::fromJson(QString jsonString) {
...
void OAIGetVaultAccessPolicyOutput_policy::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAIGetVaultAccessPolicyOutput_policy::asJson() const {
...
QJsonObject OAIGetVaultAccessPolicyOutput_policy::asJsonObject() const {
    QJsonObject obj;
    if (m_policy_isSet) {
...
QString OAIGetVaultAccessPolicyOutput_policy::getPolicy() const {
    return m_policy;
}
void OAIGetVaultAccessPolicyOutput_policy::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIGetVaultAccessPolicyOutput_policy::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIGetVaultAccessPolicyOutput_policy::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIGetVaultAccessPolicyOutput_policy::isSet() const {
...
bool OAIGetVaultAccessPolicyOutput_policy::isValid() const {
