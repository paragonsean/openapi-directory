...
/*
 * OAIUploadArchiveInput.h
 *
 * Provides options to add an archive to a vault.
 */

#ifndef OAIUploadArchiveInput_H
#define OAIUploadArchiveInput_H
...
class OAIUploadArchiveInput : public OAIObject {
public:
    OAIUploadArchiveInput();
    OAIUploadArchiveInput(QString json);
    ~OAIUploadArchiveInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUploadArchiveInput)

#endif // OAIUploadArchiveInput_H
