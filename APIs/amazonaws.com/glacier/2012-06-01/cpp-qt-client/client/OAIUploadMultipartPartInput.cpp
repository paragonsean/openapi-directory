...
#include "OAIUploadMultipartPartInput.h"
...
OAIUploadMultipartPartInput::OAIUploadMultipartPartInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUploadMultipartPartInput::OAIUploadMultipartPartInput() {
    this->initializeModel();
}

OAIUploadMultipartPartInput::~OAIUploadMultipartPartInput() {}

void OAIUploadMultipartPartInput::initializeModel() {

    m_body_isSet = false;
    m_body_isValid = false;
}

void OAIUploadMultipartPartInput::fromJson(QString jsonString) {
...
void OAIUploadMultipartPartInput::fromJsonObject(QJsonObject json) {

    m_body_isValid = ::OpenAPI::fromJsonValue(m_body, json[QString("body")]);
    m_body_isSet = !json[QString("body")].isNull() && m_body_isValid;
}

QString OAIUploadMultipartPartInput::asJson() const {
...
QJsonObject OAIUploadMultipartPartInput::asJsonObject() const {
    QJsonObject obj;
    if (m_body_isSet) {
...
QString OAIUploadMultipartPartInput::getBody() const {
    return m_body;
}
void OAIUploadMultipartPartInput::setBody(const QString &body) {
    m_body = body;
    m_body_isSet = true;
}

bool OAIUploadMultipartPartInput::is_body_Set() const{
    return m_body_isSet;
}

bool OAIUploadMultipartPartInput::is_body_Valid() const{
    return m_body_isValid;
}

bool OAIUploadMultipartPartInput::isSet() const {
...
bool OAIUploadMultipartPartInput::isValid() const {
