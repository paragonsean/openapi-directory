...
#include "OAISetDataRetrievalPolicyInput.h"
...
OAISetDataRetrievalPolicyInput::OAISetDataRetrievalPolicyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetDataRetrievalPolicyInput::OAISetDataRetrievalPolicyInput() {
    this->initializeModel();
}

OAISetDataRetrievalPolicyInput::~OAISetDataRetrievalPolicyInput() {}

void OAISetDataRetrievalPolicyInput::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAISetDataRetrievalPolicyInput::fromJson(QString jsonString) {
...
void OAISetDataRetrievalPolicyInput::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAISetDataRetrievalPolicyInput::asJson() const {
...
QJsonObject OAISetDataRetrievalPolicyInput::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAISetDataRetrievalPolicyInput_Policy OAISetDataRetrievalPolicyInput::getPolicy() const {
    return m_policy;
}
void OAISetDataRetrievalPolicyInput::setPolicy(const OAISetDataRetrievalPolicyInput_Policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAISetDataRetrievalPolicyInput::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAISetDataRetrievalPolicyInput::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAISetDataRetrievalPolicyInput::isSet() const {
...
bool OAISetDataRetrievalPolicyInput::isValid() const {
