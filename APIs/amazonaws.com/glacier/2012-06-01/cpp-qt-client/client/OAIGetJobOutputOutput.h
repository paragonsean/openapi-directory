...
/*
 * OAIGetJobOutputOutput.h
 *
 * Contains the Amazon S3 Glacier response to your request.
 */

#ifndef OAIGetJobOutputOutput_H
#define OAIGetJobOutputOutput_H
...
class OAIGetJobOutputOutput : public OAIObject {
public:
    OAIGetJobOutputOutput();
    OAIGetJobOutputOutput(QString json);
    ~OAIGetJobOutputOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetJobOutputOutput)

#endif // OAIGetJobOutputOutput_H
