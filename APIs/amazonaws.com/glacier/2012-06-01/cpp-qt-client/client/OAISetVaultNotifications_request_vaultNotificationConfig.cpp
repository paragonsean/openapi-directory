...
#include "OAISetVaultNotifications_request_vaultNotificationConfig.h"
...
OAISetVaultNotifications_request_vaultNotificationConfig::OAISetVaultNotifications_request_vaultNotificationConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetVaultNotifications_request_vaultNotificationConfig::OAISetVaultNotifications_request_vaultNotificationConfig() {
    this->initializeModel();
}

OAISetVaultNotifications_request_vaultNotificationConfig::~OAISetVaultNotifications_request_vaultNotificationConfig() {}

void OAISetVaultNotifications_request_vaultNotificationConfig::initializeModel() {
...
void OAISetVaultNotifications_request_vaultNotificationConfig::fromJson(QString jsonString) {
...
void OAISetVaultNotifications_request_vaultNotificationConfig::fromJsonObject(QJsonObject json) {
...
QString OAISetVaultNotifications_request_vaultNotificationConfig::asJson() const {
...
QJsonObject OAISetVaultNotifications_request_vaultNotificationConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAISetVaultNotifications_request_vaultNotificationConfig::getSnsTopic() const {
    return m_sns_topic;
}
void OAISetVaultNotifications_request_vaultNotificationConfig::setSnsTopic(const QString &sns_topic) {
    m_sns_topic = sns_topic;
    m_sns_topic_isSet = true;
}

bool OAISetVaultNotifications_request_vaultNotificationConfig::is_sns_topic_Set() const{
    return m_sns_topic_isSet;
}

bool OAISetVaultNotifications_request_vaultNotificationConfig::is_sns_topic_Valid() const{
    return m_sns_topic_isValid;
}

QList OAISetVaultNotifications_request_vaultNotificationConfig::getEvents() const {
    return m_events;
}
void OAISetVaultNotifications_request_vaultNotificationConfig::setEvents(const QList &events) {
    m_events = events;
    m_events_isSet = true;
}

bool OAISetVaultNotifications_request_vaultNotificationConfig::is_events_Set() const{
    return m_events_isSet;
}

bool OAISetVaultNotifications_request_vaultNotificationConfig::is_events_Valid() const{
    return m_events_isValid;
}

bool OAISetVaultNotifications_request_vaultNotificationConfig::isSet() const {
...
bool OAISetVaultNotifications_request_vaultNotificationConfig::isValid() const {
