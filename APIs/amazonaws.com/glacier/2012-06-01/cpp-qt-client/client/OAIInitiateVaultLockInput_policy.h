...
/*
 * OAIInitiateVaultLockInput_policy.h
 *
 * 
 */

#ifndef OAIInitiateVaultLockInput_policy_H
#define OAIInitiateVaultLockInput_policy_H
...
class OAIInitiateVaultLockInput_policy : public OAIObject {
public:
    OAIInitiateVaultLockInput_policy();
    OAIInitiateVaultLockInput_policy(QString json);
    ~OAIInitiateVaultLockInput_policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitiateVaultLockInput_policy)

#endif // OAIInitiateVaultLockInput_policy_H
