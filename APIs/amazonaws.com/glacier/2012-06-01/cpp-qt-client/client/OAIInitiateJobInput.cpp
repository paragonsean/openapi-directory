...
OAIInitiateJobInput::OAIInitiateJobInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInitiateJobInput::OAIInitiateJobInput() {
    this->initializeModel();
}

OAIInitiateJobInput::~OAIInitiateJobInput() {}

void OAIInitiateJobInput::initializeModel() {

    m_job_parameters_isSet = false;
    m_job_parameters_isValid = false;
}

void OAIInitiateJobInput::fromJson(QString jsonString) {
...
void OAIInitiateJobInput::fromJsonObject(QJsonObject json) {

    m_job_parameters_isValid = ::OpenAPI::fromJsonValue(m_job_parameters, json[QString("jobParameters")]);
    m_job_parameters_isSet = !json[QString("jobParameters")].isNull() && m_job_parameters_isValid;
}

QString OAIInitiateJobInput::asJson() const {
...
QJsonObject OAIInitiateJobInput::asJsonObject() const {
    QJsonObject obj;
    if (m_job_parameters.isSet()) {
        obj.insert(QString("jobParameters"), ::OpenAPI::toJsonValue(m_job_parameters));
    }
    return obj;
}

OAIInitiateJobInput_jobParameters OAIInitiateJobInput::getJobParameters() const {
    return m_job_parameters;
}
void OAIInitiateJobInput::setJobParameters(const OAIInitiateJobInput_jobParameters &job_parameters) {
    m_job_parameters = job_parameters;
    m_job_parameters_isSet = true;
}

bool OAIInitiateJobInput::is_job_parameters_Set() const{
    return m_job_parameters_isSet;
}

bool OAIInitiateJobInput::is_job_parameters_Valid() const{
    return m_job_parameters_isValid;
}

bool OAIInitiateJobInput::isSet() const {
...
bool OAIInitiateJobInput::isValid() const {
