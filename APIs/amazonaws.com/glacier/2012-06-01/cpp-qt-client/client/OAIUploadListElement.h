...
/*
 * OAIUploadListElement.h
 *
 * A list of in-progress multipart uploads for a vault.
 */

#ifndef OAIUploadListElement_H
#define OAIUploadListElement_H
...
class OAIUploadListElement : public OAIObject {
public:
    OAIUploadListElement();
    OAIUploadListElement(QString json);
    ~OAIUploadListElement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUploadListElement)

#endif // OAIUploadListElement_H
