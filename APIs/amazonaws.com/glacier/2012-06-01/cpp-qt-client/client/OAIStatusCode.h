...
#ifndef OAIStatusCode_H
#define OAIStatusCode_H
...
class OAIStatusCode : public OAIEnum {
public:
    OAIStatusCode();
    OAIStatusCode(QString json);
    ~OAIStatusCode() override;
    ...
    enum class eOAIStatusCode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        INPROGRESS, 
        SUCCEEDED, 
        FAILED
    };
    OAIStatusCode::eOAIStatusCode getValue() const;
    void setValue(const OAIStatusCode::eOAIStatusCode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatusCode)

#endif // OAIStatusCode_H
