...
/*
 * OAISetVaultNotifications_request.h
 *
 * 
 */

#ifndef OAISetVaultNotifications_request_H
#define OAISetVaultNotifications_request_H
...
namespace OpenAPI {
class OAISetVaultNotifications_request_vaultNotificationConfig;

class OAISetVaultNotifications_request : public OAIObject {
public:
    OAISetVaultNotifications_request();
    OAISetVaultNotifications_request(QString json);
    ~OAISetVaultNotifications_request() override;
    ...
    OAISetVaultNotifications_request_vaultNotificationConfig getVaultNotificationConfig() const;
    void setVaultNotificationConfig(const OAISetVaultNotifications_request_vaultNotificationConfig &vault_notification_config);
...
private:
    ...
    OAISetVaultNotifications_request_vaultNotificationConfig m_vault_notification_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetVaultNotifications_request)

#endif // OAISetVaultNotifications_request_H
