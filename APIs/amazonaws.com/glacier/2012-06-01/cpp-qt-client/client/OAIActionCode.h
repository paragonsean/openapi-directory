...
#ifndef OAIActionCode_H
#define OAIActionCode_H
...
class OAIActionCode : public OAIEnum {
public:
    OAIActionCode();
    OAIActionCode(QString json);
    ~OAIActionCode() override;
    ...
    enum class eOAIActionCode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ARCHIVERETRIEVAL, 
        INVENTORYRETRIEVAL, 
        SELECT
    };
    OAIActionCode::eOAIActionCode getValue() const;
    void setValue(const OAIActionCode::eOAIActionCode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionCode)

#endif // OAIActionCode_H
