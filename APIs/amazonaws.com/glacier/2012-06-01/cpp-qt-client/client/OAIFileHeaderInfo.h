...
#ifndef OAIFileHeaderInfo_H
#define OAIFileHeaderInfo_H
...
class OAIFileHeaderInfo : public OAIEnum {
public:
    OAIFileHeaderInfo();
    OAIFileHeaderInfo(QString json);
    ~OAIFileHeaderInfo() override;
    ...
    enum class eOAIFileHeaderInfo {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        USE, 
        IGNORE, 
        NONE
    };
    OAIFileHeaderInfo::eOAIFileHeaderInfo getValue() const;
    void setValue(const OAIFileHeaderInfo::eOAIFileHeaderInfo& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileHeaderInfo)

#endif // OAIFileHeaderInfo_H
