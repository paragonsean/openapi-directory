...
OAISetDataRetrievalPolicy_request::OAISetDataRetrievalPolicy_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetDataRetrievalPolicy_request::OAISetDataRetrievalPolicy_request() {
    this->initializeModel();
}

OAISetDataRetrievalPolicy_request::~OAISetDataRetrievalPolicy_request() {}

void OAISetDataRetrievalPolicy_request::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAISetDataRetrievalPolicy_request::fromJson(QString jsonString) {
...
void OAISetDataRetrievalPolicy_request::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAISetDataRetrievalPolicy_request::asJson() const {
...
QJsonObject OAISetDataRetrievalPolicy_request::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAISetDataRetrievalPolicy_request_Policy OAISetDataRetrievalPolicy_request::getPolicy() const {
    return m_policy;
}
void OAISetDataRetrievalPolicy_request::setPolicy(const OAISetDataRetrievalPolicy_request_Policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAISetDataRetrievalPolicy_request::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAISetDataRetrievalPolicy_request::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAISetDataRetrievalPolicy_request::isSet() const {
...
bool OAISetDataRetrievalPolicy_request::isValid() const {
