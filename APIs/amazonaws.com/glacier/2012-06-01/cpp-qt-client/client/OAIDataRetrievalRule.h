...
/*
 * OAIDataRetrievalRule.h
 *
 * Data retrieval policy rule.
 */

#ifndef OAIDataRetrievalRule_H
#define OAIDataRetrievalRule_H
...
class OAIDataRetrievalRule : public OAIObject {
public:
    OAIDataRetrievalRule();
    OAIDataRetrievalRule(QString json);
    ~OAIDataRetrievalRule() override;
    ...
    qint32 getBytesPerHour() const;
    void setBytesPerHour(const qint32 &bytes_per_hour);
    bool is_bytes_per_hour_Set() const;
    bool is_bytes_per_hour_Valid() const;
...
private:
    ...
    qint32 m_bytes_per_hour;
    bool m_bytes_per_hour_isSet;
    bool m_bytes_per_hour_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDataRetrievalRule)

#endif // OAIDataRetrievalRule_H
