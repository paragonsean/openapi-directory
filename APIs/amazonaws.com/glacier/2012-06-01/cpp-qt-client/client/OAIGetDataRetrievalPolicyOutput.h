...
/*
 * OAIGetDataRetrievalPolicyOutput.h
 *
 * Contains the Amazon S3 Glacier response to the &lt;code&gt;GetDataRetrievalPolicy&lt;/code&gt; request.
 */

#ifndef OAIGetDataRetrievalPolicyOutput_H
#define OAIGetDataRetrievalPolicyOutput_H

#include <QJsonObject>

#include "OAIGetDataRetrievalPolicyOutput_Policy.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetDataRetrievalPolicyOutput_Policy;

class OAIGetDataRetrievalPolicyOutput : public OAIObject {
public:
    OAIGetDataRetrievalPolicyOutput();
    OAIGetDataRetrievalPolicyOutput(QString json);
    ~OAIGetDataRetrievalPolicyOutput() override;
    ...
    OAIGetDataRetrievalPolicyOutput_Policy getPolicy() const;
    void setPolicy(const OAIGetDataRetrievalPolicyOutput_Policy &policy);
...
private:
    ...
    OAIGetDataRetrievalPolicyOutput_Policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDataRetrievalPolicyOutput)

#endif // OAIGetDataRetrievalPolicyOutput_H
