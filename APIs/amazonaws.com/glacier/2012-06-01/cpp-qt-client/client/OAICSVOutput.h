...
#ifndef OAICSVOutput_H
#define OAICSVOutput_H
...
class OAICSVOutput : public OAIObject {
public:
    OAICSVOutput();
    OAICSVOutput(QString json);
    ~OAICSVOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICSVOutput)

#endif // OAICSVOutput_H
