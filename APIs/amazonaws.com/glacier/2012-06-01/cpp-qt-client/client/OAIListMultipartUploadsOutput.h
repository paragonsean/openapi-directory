...
/*
 * OAIListMultipartUploadsOutput.h
 *
 * Contains the Amazon S3 Glacier response to your request.
 */

#ifndef OAIListMultipartUploadsOutput_H
#define OAIListMultipartUploadsOutput_H
...
class OAIListMultipartUploadsOutput : public OAIObject {
public:
    OAIListMultipartUploadsOutput();
    OAIListMultipartUploadsOutput(QString json);
    ~OAIListMultipartUploadsOutput() override;
    ...
    QList getUploadsList() const;
    void setUploadsList(const QList &uploads_list);
    bool is_uploads_list_Set() const;
    bool is_uploads_list_Valid() const;
...
private:
    ...
    QList m_uploads_list;
    bool m_uploads_list_isSet;
    bool m_uploads_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMultipartUploadsOutput)

#endif // OAIListMultipartUploadsOutput_H
