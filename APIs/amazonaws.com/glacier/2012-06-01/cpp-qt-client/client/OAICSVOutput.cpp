...
OAICSVOutput::OAICSVOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICSVOutput::OAICSVOutput() {
    this->initializeModel();
}

OAICSVOutput::~OAICSVOutput() {}

void OAICSVOutput::initializeModel() {
...
void OAICSVOutput::fromJson(QString jsonString) {
...
void OAICSVOutput::fromJsonObject(QJsonObject json) {
...
QString OAICSVOutput::asJson() const {
...
QJsonObject OAICSVOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIQuoteFields OAICSVOutput::getQuoteFields() const {
    return m_quote_fields;
}
void OAICSVOutput::setQuoteFields(const OAIQuoteFields &quote_fields) {
    m_quote_fields = quote_fields;
    m_quote_fields_isSet = true;
}

bool OAICSVOutput::is_quote_fields_Set() const{
    return m_quote_fields_isSet;
}

bool OAICSVOutput::is_quote_fields_Valid() const{
    return m_quote_fields_isValid;
}

QString OAICSVOutput::getQuoteEscapeCharacter() const {
    return m_quote_escape_character;
}
void OAICSVOutput::setQuoteEscapeCharacter(const QString &quote_escape_character) {
    m_quote_escape_character = quote_escape_character;
    m_quote_escape_character_isSet = true;
}

bool OAICSVOutput::is_quote_escape_character_Set() const{
    return m_quote_escape_character_isSet;
}

bool OAICSVOutput::is_quote_escape_character_Valid() const{
    return m_quote_escape_character_isValid;
}

QString OAICSVOutput::getRecordDelimiter() const {
    return m_record_delimiter;
}
void OAICSVOutput::setRecordDelimiter(const QString &record_delimiter) {
    m_record_delimiter = record_delimiter;
    m_record_delimiter_isSet = true;
}

bool OAICSVOutput::is_record_delimiter_Set() const{
    return m_record_delimiter_isSet;
}

bool OAICSVOutput::is_record_delimiter_Valid() const{
    return m_record_delimiter_isValid;
}

QString OAICSVOutput::getFieldDelimiter() const {
    return m_field_delimiter;
}
void OAICSVOutput::setFieldDelimiter(const QString &field_delimiter) {
    m_field_delimiter = field_delimiter;
    m_field_delimiter_isSet = true;
}

bool OAICSVOutput::is_field_delimiter_Set() const{
    return m_field_delimiter_isSet;
}

bool OAICSVOutput::is_field_delimiter_Valid() const{
    return m_field_delimiter_isValid;
}

QString OAICSVOutput::getQuoteCharacter() const {
    return m_quote_character;
}
void OAICSVOutput::setQuoteCharacter(const QString &quote_character) {
    m_quote_character = quote_character;
    m_quote_character_isSet = true;
}

bool OAICSVOutput::is_quote_character_Set() const{
    return m_quote_character_isSet;
}

bool OAICSVOutput::is_quote_character_Valid() const{
    return m_quote_character_isValid;
}

bool OAICSVOutput::isSet() const {
...
bool OAICSVOutput::isValid() const {
