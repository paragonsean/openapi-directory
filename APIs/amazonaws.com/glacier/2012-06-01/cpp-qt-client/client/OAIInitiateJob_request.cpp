...
OAIInitiateJob_request::OAIInitiateJob_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInitiateJob_request::OAIInitiateJob_request() {
    this->initializeModel();
}

OAIInitiateJob_request::~OAIInitiateJob_request() {}

void OAIInitiateJob_request::initializeModel() {

    m_job_parameters_isSet = false;
    m_job_parameters_isValid = false;
}

void OAIInitiateJob_request::fromJson(QString jsonString) {
...
void OAIInitiateJob_request::fromJsonObject(QJsonObject json) {
...
QString OAIInitiateJob_request::asJson() const {
...
QJsonObject OAIInitiateJob_request::asJsonObject() const {
    QJsonObject obj;
...
OAIInitiateJob_request_jobParameters OAIInitiateJob_request::getJobParameters() const {
    return m_job_parameters;
}
void OAIInitiateJob_request::setJobParameters(const OAIInitiateJob_request_jobParameters &job_parameters) {
    m_job_parameters = job_parameters;
    m_job_parameters_isSet = true;
}

bool OAIInitiateJob_request::is_job_parameters_Set() const{
    return m_job_parameters_isSet;
}

bool OAIInitiateJob_request::is_job_parameters_Valid() const{
    return m_job_parameters_isValid;
}

bool OAIInitiateJob_request::isSet() const {
...
bool OAIInitiateJob_request::isValid() const {
