...
/*
 * OAIInitiateJob_request_jobParameters.h
 *
 * Provides options for defining a job.
 */

#ifndef OAIInitiateJob_request_jobParameters_H
#define OAIInitiateJob_request_jobParameters_H
...
class OAIInitiateJob_request_jobParameters : public OAIObject {
public:
    OAIInitiateJob_request_jobParameters();
    OAIInitiateJob_request_jobParameters(QString json);
    ~OAIInitiateJob_request_jobParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitiateJob_request_jobParameters)

#endif // OAIInitiateJob_request_jobParameters_H
