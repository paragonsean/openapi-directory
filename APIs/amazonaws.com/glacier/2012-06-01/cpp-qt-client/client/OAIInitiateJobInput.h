...
/*
 * OAIInitiateJobInput.h
 *
 * Provides options for initiating an Amazon S3 Glacier job.
 */

#ifndef OAIInitiateJobInput_H
#define OAIInitiateJobInput_H

#include <QJsonObject>

#include "OAIInitiateJobInput_jobParameters.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIInitiateJobInput_jobParameters;

class OAIInitiateJobInput : public OAIObject {
public:
    OAIInitiateJobInput();
    OAIInitiateJobInput(QString json);
    ~OAIInitiateJobInput() override;
    ...
    OAIInitiateJobInput_jobParameters getJobParameters() const;
    void setJobParameters(const OAIInitiateJobInput_jobParameters &job_parameters);
...
private:
    ...
    OAIInitiateJobInput_jobParameters m_job_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitiateJobInput)

#endif // OAIInitiateJobInput_H
