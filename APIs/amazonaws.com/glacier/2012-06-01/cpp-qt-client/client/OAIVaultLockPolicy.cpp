...
OAIVaultLockPolicy::OAIVaultLockPolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVaultLockPolicy::OAIVaultLockPolicy() {
    this->initializeModel();
}

OAIVaultLockPolicy::~OAIVaultLockPolicy() {}

void OAIVaultLockPolicy::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIVaultLockPolicy::fromJson(QString jsonString) {
...
void OAIVaultLockPolicy::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAIVaultLockPolicy::asJson() const {
...
QJsonObject OAIVaultLockPolicy::asJsonObject() const {
    QJsonObject obj;
    if (m_policy_isSet) {
...
QString OAIVaultLockPolicy::getPolicy() const {
    return m_policy;
}
void OAIVaultLockPolicy::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIVaultLockPolicy::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIVaultLockPolicy::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIVaultLockPolicy::isSet() const {
...
bool OAIVaultLockPolicy::isValid() const {
