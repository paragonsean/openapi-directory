...
#ifndef OAIGrant_Grantee_H
#define OAIGrant_Grantee_H
...
class OAIGrant_Grantee : public OAIObject {
public:
    OAIGrant_Grantee();
    OAIGrant_Grantee(QString json);
    ~OAIGrant_Grantee() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGrant_Grantee)

#endif // OAIGrant_Grantee_H
