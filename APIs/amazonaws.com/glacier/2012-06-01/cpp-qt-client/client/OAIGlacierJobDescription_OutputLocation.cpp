...
OAIGlacierJobDescription_OutputLocation::OAIGlacierJobDescription_OutputLocation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGlacierJobDescription_OutputLocation::OAIGlacierJobDescription_OutputLocation() {
    this->initializeModel();
}

OAIGlacierJobDescription_OutputLocation::~OAIGlacierJobDescription_OutputLocation() {}

void OAIGlacierJobDescription_OutputLocation::initializeModel() {

    m_s3_isSet = false;
    m_s3_isValid = false;
}

void OAIGlacierJobDescription_OutputLocation::fromJson(QString jsonString) {
...
void OAIGlacierJobDescription_OutputLocation::fromJsonObject(QJsonObject json) {

    m_s3_isValid = ::OpenAPI::fromJsonValue(m_s3, json[QString("S3")]);
    m_s3_isSet = !json[QString("S3")].isNull() && m_s3_isValid;
}

QString OAIGlacierJobDescription_OutputLocation::asJson() const {
...
QJsonObject OAIGlacierJobDescription_OutputLocation::asJsonObject() const {
    QJsonObject obj;
    if (m_s3.isSet()) {
...
OAIOutputLocation_S3 OAIGlacierJobDescription_OutputLocation::getS3() const {
    return m_s3;
}
void OAIGlacierJobDescription_OutputLocation::setS3(const OAIOutputLocation_S3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAIGlacierJobDescription_OutputLocation::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAIGlacierJobDescription_OutputLocation::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAIGlacierJobDescription_OutputLocation::isSet() const {
...
bool OAIGlacierJobDescription_OutputLocation::isValid() const {
