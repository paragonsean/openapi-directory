...
OAIGetJobOutputOutput::OAIGetJobOutputOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetJobOutputOutput::OAIGetJobOutputOutput() {
    this->initializeModel();
}

OAIGetJobOutputOutput::~OAIGetJobOutputOutput() {}

void OAIGetJobOutputOutput::initializeModel() {
...
void OAIGetJobOutputOutput::fromJson(QString jsonString) {
...
void OAIGetJobOutputOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetJobOutputOutput::asJson() const {
...
QJsonObject OAIGetJobOutputOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_body_isSet) {
...
QString OAIGetJobOutputOutput::getBody() const {
    return m_body;
}
void OAIGetJobOutputOutput::setBody(const QString &body) {
    m_body = body;
    m_body_isSet = true;
}

bool OAIGetJobOutputOutput::is_body_Set() const{
    return m_body_isSet;
}

bool OAIGetJobOutputOutput::is_body_Valid() const{
    return m_body_isValid;
}

qint32 OAIGetJobOutputOutput::getStatus() const {
    return m_status;
}
void OAIGetJobOutputOutput::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetJobOutputOutput::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetJobOutputOutput::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGetJobOutputOutput::isSet() const {
...
bool OAIGetJobOutputOutput::isValid() const {
