...
/*
 * OAIUploadMultipartPart_request.h
 *
 * 
 */

#ifndef OAIUploadMultipartPart_request_H
#define OAIUploadMultipartPart_request_H
...
class OAIUploadMultipartPart_request : public OAIObject {
public:
    OAIUploadMultipartPart_request();
    OAIUploadMultipartPart_request(QString json);
    ~OAIUploadMultipartPart_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUploadMultipartPart_request)

#endif // OAIUploadMultipartPart_request_H
