...
#include "OAIOutputSerialization.h"
...
OAIOutputSerialization::OAIOutputSerialization(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOutputSerialization::OAIOutputSerialization() {
    this->initializeModel();
}

OAIOutputSerialization::~OAIOutputSerialization() {}

void OAIOutputSerialization::initializeModel() {

    m_csv_isSet = false;
    m_csv_isValid = false;
}

void OAIOutputSerialization::fromJson(QString jsonString) {
...
QJsonObject OAIOutputSerialization::asJsonObject() const {
    QJsonObject obj;
    if (m_csv.isSet()) {
...
OAIOutputSerialization_csv OAIOutputSerialization::getCsv() const {
    return m_csv;
}
void OAIOutputSerialization::setCsv(const OAIOutputSerialization_csv &csv) {
    m_csv = csv;
    m_csv_isSet = true;
}

bool OAIOutputSerialization::is_csv_Set() const{
    return m_csv_isSet;
}

bool OAIOutputSerialization::is_csv_Valid() const{
    return m_csv_isValid;
}

bool OAIOutputSerialization::isSet() const {
...
bool OAIOutputSerialization::isValid() const {
