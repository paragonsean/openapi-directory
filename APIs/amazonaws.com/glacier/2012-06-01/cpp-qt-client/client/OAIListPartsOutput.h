...
/*
 * OAIListPartsOutput.h
 *
 * Contains the Amazon S3 Glacier response to your request.
 */

#ifndef OAIListPartsOutput_H
#define OAIListPartsOutput_H
...
class OAIListPartsOutput : public OAIObject {
public:
    OAIListPartsOutput();
    OAIListPartsOutput(QString json);
    ~OAIListPartsOutput() override;
    ...
    QString getMultipartUploadId() const;
    void setMultipartUploadId(const QString &multipart_upload_id);
    bool is_multipart_upload_id_Set() const;
    bool is_multipart_upload_id_Valid() const;
    ...
    QString getArchiveDescription() const;
    void setArchiveDescription(const QString &archive_description);
    bool is_archive_description_Set() const;
    bool is_archive_description_Valid() const;

    qint32 getPartSizeInBytes() const;
    void setPartSizeInBytes(const qint32 &part_size_in_bytes);
    bool is_part_size_in_bytes_Set() const;
    bool is_part_size_in_bytes_Valid() const;
...
private:
    ...
    QString m_multipart_upload_id;
    bool m_multipart_upload_id_isSet;
    bool m_multipart_upload_id_isValid;

    QString m_vault_arn;
    bool m_vault_arn_isSet;
    bool m_vault_arn_isValid;

    QString m_archive_description;
    bool m_archive_description_isSet;
    bool m_archive_description_isValid;

    qint32 m_part_size_in_bytes;
    bool m_part_size_in_bytes_isSet;
    bool m_part_size_in_bytes_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPartsOutput)

#endif // OAIListPartsOutput_H
