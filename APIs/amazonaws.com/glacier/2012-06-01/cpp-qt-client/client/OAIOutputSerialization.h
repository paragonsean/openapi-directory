...
/*
 * OAIOutputSerialization.h
 *
 * Describes how the select output is serialized.
 */

#ifndef OAIOutputSerialization_H
#define OAIOutputSerialization_H
...
class OAIOutputSerialization : public OAIObject {
public:
    OAIOutputSerialization();
    OAIOutputSerialization(QString json);
    ~OAIOutputSerialization() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutputSerialization)

#endif // OAIOutputSerialization_H
