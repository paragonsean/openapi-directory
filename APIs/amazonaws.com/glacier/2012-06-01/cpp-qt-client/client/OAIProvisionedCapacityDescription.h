...
/*
 * OAIProvisionedCapacityDescription.h
 *
 * The definition for a provisioned capacity unit.
 */

#ifndef OAIProvisionedCapacityDescription_H
#define OAIProvisionedCapacityDescription_H
...
class OAIProvisionedCapacityDescription : public OAIObject {
public:
    OAIProvisionedCapacityDescription();
    OAIProvisionedCapacityDescription(QString json);
    ~OAIProvisionedCapacityDescription() override;
    ...
    QString getCapacityId() const;
    void setCapacityId(const QString &capacity_id);
    bool is_capacity_id_Set() const;
    bool is_capacity_id_Valid() const;
...
private:
    ...
    QString m_capacity_id;
    bool m_capacity_id_isSet;
    bool m_capacity_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvisionedCapacityDescription)

#endif // OAIProvisionedCapacityDescription_H
