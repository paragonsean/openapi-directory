...
/*
 * OAISetDataRetrievalPolicyInput_Policy.h
 *
 * 
 */

#ifndef OAISetDataRetrievalPolicyInput_Policy_H
#define OAISetDataRetrievalPolicyInput_Policy_H
...
class OAISetDataRetrievalPolicyInput_Policy : public OAIObject {
public:
    OAISetDataRetrievalPolicyInput_Policy();
    OAISetDataRetrievalPolicyInput_Policy(QString json);
    ~OAISetDataRetrievalPolicyInput_Policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetDataRetrievalPolicyInput_Policy)

#endif // OAISetDataRetrievalPolicyInput_Policy_H
