...
/*
 * OAIGlacierJobDescription_OutputLocation.h
 *
 * 
 */

#ifndef OAIGlacierJobDescription_OutputLocation_H
#define OAIGlacierJobDescription_OutputLocation_H
...
class OAIGlacierJobDescription_OutputLocation : public OAIObject {
public:
    OAIGlacierJobDescription_OutputLocation();
    OAIGlacierJobDescription_OutputLocation(QString json);
    ~OAIGlacierJobDescription_OutputLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGlacierJobDescription_OutputLocation)

#endif // OAIGlacierJobDescription_OutputLocation_H
