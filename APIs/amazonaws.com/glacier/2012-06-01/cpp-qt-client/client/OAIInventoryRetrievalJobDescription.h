...
/*
 * OAIInventoryRetrievalJobDescription.h
 *
 * Describes the options for a range inventory retrieval job.
 */

#ifndef OAIInventoryRetrievalJobDescription_H
#define OAIInventoryRetrievalJobDescription_H
...
class OAIInventoryRetrievalJobDescription : public OAIObject {
public:
    OAIInventoryRetrievalJobDescription();
    OAIInventoryRetrievalJobDescription(QString json);
    ~OAIInventoryRetrievalJobDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryRetrievalJobDescription)

#endif // OAIInventoryRetrievalJobDescription_H
