...
#include "OAISetVaultAccessPolicyInput_policy.h"
...
OAISetVaultAccessPolicyInput_policy::OAISetVaultAccessPolicyInput_policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetVaultAccessPolicyInput_policy::OAISetVaultAccessPolicyInput_policy() {
    this->initializeModel();
}

OAISetVaultAccessPolicyInput_policy::~OAISetVaultAccessPolicyInput_policy() {}

void OAISetVaultAccessPolicyInput_policy::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAISetVaultAccessPolicyInput_policy::fromJson(QString jsonString) {
...
void OAISetVaultAccessPolicyInput_policy::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAISetVaultAccessPolicyInput_policy::asJson() const {
...
QJsonObject OAISetVaultAccessPolicyInput_policy::asJsonObject() const {
    QJsonObject obj;
    if (m_policy_isSet) {
...
QString OAISetVaultAccessPolicyInput_policy::getPolicy() const {
    return m_policy;
}
void OAISetVaultAccessPolicyInput_policy::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAISetVaultAccessPolicyInput_policy::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAISetVaultAccessPolicyInput_policy::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAISetVaultAccessPolicyInput_policy::isSet() const {
...
bool OAISetVaultAccessPolicyInput_policy::isValid() const {
