...
/*
 * OAIListVaultsOutput.h
 *
 * Contains the Amazon S3 Glacier response to your request.
 */

#ifndef OAIListVaultsOutput_H
#define OAIListVaultsOutput_H
...
class OAIListVaultsOutput : public OAIObject {
public:
    OAIListVaultsOutput();
    OAIListVaultsOutput(QString json);
    ~OAIListVaultsOutput() override;
    ...
    QList getVaultList() const;
    void setVaultList(const QList &vault_list);
    bool is_vault_list_Set() const;
    bool is_vault_list_Valid() const;
...
private:
    ...
    QList m_vault_list;
    bool m_vault_list_isSet;
    bool m_vault_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListVaultsOutput)

#endif // OAIListVaultsOutput_H
