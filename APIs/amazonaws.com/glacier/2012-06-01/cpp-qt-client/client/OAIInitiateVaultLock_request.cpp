...
OAIInitiateVaultLock_request::OAIInitiateVaultLock_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInitiateVaultLock_request::OAIInitiateVaultLock_request() {
    this->initializeModel();
}

OAIInitiateVaultLock_request::~OAIInitiateVaultLock_request() {}

void OAIInitiateVaultLock_request::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIInitiateVaultLock_request::fromJson(QString jsonString) {
...
void OAIInitiateVaultLock_request::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("policy")]);
    m_policy_isSet = !json[QString("policy")].isNull() && m_policy_isValid;
}

QString OAIInitiateVaultLock_request::asJson() const {
...
QJsonObject OAIInitiateVaultLock_request::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAIInitiateVaultLock_request_policy OAIInitiateVaultLock_request::getPolicy() const {
    return m_policy;
}
void OAIInitiateVaultLock_request::setPolicy(const OAIInitiateVaultLock_request_policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIInitiateVaultLock_request::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIInitiateVaultLock_request::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIInitiateVaultLock_request::isSet() const {
...
bool OAIInitiateVaultLock_request::isValid() const {
