...
/*
 * OAIInitiateJob_request.h
 *
 * 
 */

#ifndef OAIInitiateJob_request_H
#define OAIInitiateJob_request_H
...
namespace OpenAPI {
class OAIInitiateJob_request_jobParameters;

class OAIInitiateJob_request : public OAIObject {
public:
    OAIInitiateJob_request();
    OAIInitiateJob_request(QString json);
    ~OAIInitiateJob_request() override;
    ...
    OAIInitiateJob_request_jobParameters getJobParameters() const;
    void setJobParameters(const OAIInitiateJob_request_jobParameters &job_parameters);
    bool is_job_parameters_Set() const;
    bool is_job_parameters_Valid() const;
...
private:
    ...
    OAIInitiateJob_request_jobParameters m_job_parameters;
    bool m_job_parameters_isSet;
    bool m_job_parameters_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIInitiateJob_request)

#endif // OAIInitiateJob_request_H
