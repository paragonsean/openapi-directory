...
/*
 * OAIGetVaultAccessPolicyOutput_policy.h
 *
 * 
 */

#ifndef OAIGetVaultAccessPolicyOutput_policy_H
#define OAIGetVaultAccessPolicyOutput_policy_H
...
class OAIGetVaultAccessPolicyOutput_policy : public OAIObject {
public:
    OAIGetVaultAccessPolicyOutput_policy();
    OAIGetVaultAccessPolicyOutput_policy(QString json);
    ~OAIGetVaultAccessPolicyOutput_policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVaultAccessPolicyOutput_policy)

#endif // OAIGetVaultAccessPolicyOutput_policy_H
