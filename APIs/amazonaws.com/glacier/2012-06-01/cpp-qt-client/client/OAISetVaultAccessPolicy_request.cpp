...
OAISetVaultAccessPolicy_request::OAISetVaultAccessPolicy_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetVaultAccessPolicy_request::OAISetVaultAccessPolicy_request() {
    this->initializeModel();
}

OAISetVaultAccessPolicy_request::~OAISetVaultAccessPolicy_request() {}

void OAISetVaultAccessPolicy_request::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAISetVaultAccessPolicy_request::fromJson(QString jsonString) {
...
void OAISetVaultAccessPolicy_request::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("policy")]);
    m_policy_isSet = !json[QString("policy")].isNull() && m_policy_isValid;
}

QString OAISetVaultAccessPolicy_request::asJson() const {
...
QJsonObject OAISetVaultAccessPolicy_request::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAISetVaultAccessPolicy_request_policy OAISetVaultAccessPolicy_request::getPolicy() const {
    return m_policy;
}
void OAISetVaultAccessPolicy_request::setPolicy(const OAISetVaultAccessPolicy_request_policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAISetVaultAccessPolicy_request::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAISetVaultAccessPolicy_request::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAISetVaultAccessPolicy_request::isSet() const {
...
bool OAISetVaultAccessPolicy_request::isValid() const {
