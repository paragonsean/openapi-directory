...
#include "OAISetVaultAccessPolicyInput.h"
...
OAISetVaultAccessPolicyInput::OAISetVaultAccessPolicyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetVaultAccessPolicyInput::OAISetVaultAccessPolicyInput() {
    this->initializeModel();
}

OAISetVaultAccessPolicyInput::~OAISetVaultAccessPolicyInput() {}

void OAISetVaultAccessPolicyInput::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAISetVaultAccessPolicyInput::fromJson(QString jsonString) {
...
void OAISetVaultAccessPolicyInput::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("policy")]);
    m_policy_isSet = !json[QString("policy")].isNull() && m_policy_isValid;
}

QString OAISetVaultAccessPolicyInput::asJson() const {
...
QJsonObject OAISetVaultAccessPolicyInput::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAISetVaultAccessPolicyInput_policy OAISetVaultAccessPolicyInput::getPolicy() const {
    return m_policy;
}
void OAISetVaultAccessPolicyInput::setPolicy(const OAISetVaultAccessPolicyInput_policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAISetVaultAccessPolicyInput::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAISetVaultAccessPolicyInput::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAISetVaultAccessPolicyInput::isSet() const {
...
bool OAISetVaultAccessPolicyInput::isValid() const {
