...
/*
 * OAISetDataRetrievalPolicy_request.h
 *
 * 
 */

#ifndef OAISetDataRetrievalPolicy_request_H
#define OAISetDataRetrievalPolicy_request_H
...
namespace OpenAPI {
class OAISetDataRetrievalPolicy_request_Policy;

class OAISetDataRetrievalPolicy_request : public OAIObject {
public:
    OAISetDataRetrievalPolicy_request();
    OAISetDataRetrievalPolicy_request(QString json);
    ~OAISetDataRetrievalPolicy_request() override;
    ...
    OAISetDataRetrievalPolicy_request_Policy getPolicy() const;
    void setPolicy(const OAISetDataRetrievalPolicy_request_Policy &policy);
...
private:
    ...
    OAISetDataRetrievalPolicy_request_Policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetDataRetrievalPolicy_request)

#endif // OAISetDataRetrievalPolicy_request_H
