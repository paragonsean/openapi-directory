...
/*
 * OAIRemoveTagsFromVaultInput.h
 *
 * The input value for &lt;code&gt;RemoveTagsFromVaultInput&lt;/code&gt;.
 */

#ifndef OAIRemoveTagsFromVaultInput_H
#define OAIRemoveTagsFromVaultInput_H
...
class OAIRemoveTagsFromVaultInput : public OAIObject {
public:
    OAIRemoveTagsFromVaultInput();
    OAIRemoveTagsFromVaultInput(QString json);
    ~OAIRemoveTagsFromVaultInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveTagsFromVaultInput)

#endif // OAIRemoveTagsFromVaultInput_H
