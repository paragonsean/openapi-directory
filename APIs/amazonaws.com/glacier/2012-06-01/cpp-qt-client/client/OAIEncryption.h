...
public:
    ...
    QString getKmsContext() const;
    void setKmsContext(const QString &kms_context);
    bool is_kms_context_Set() const;
    bool is_kms_context_Valid() const;
...
private:
    ...
    QString m_kms_context;
    bool m_kms_context_isSet;
    bool m_kms_context_isValid;
};
