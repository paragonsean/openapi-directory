...
/*
 * OAIInitiateJobInput_jobParameters.h
 *
 * 
 */

#ifndef OAIInitiateJobInput_jobParameters_H
#define OAIInitiateJobInput_jobParameters_H
...
class OAIInitiateJobInput_jobParameters : public OAIObject {
public:
    OAIInitiateJobInput_jobParameters();
    OAIInitiateJobInput_jobParameters(QString json);
    ~OAIInitiateJobInput_jobParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitiateJobInput_jobParameters)

#endif // OAIInitiateJobInput_jobParameters_H
