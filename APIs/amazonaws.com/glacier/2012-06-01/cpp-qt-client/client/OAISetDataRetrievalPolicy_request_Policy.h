...
/*
 * OAISetDataRetrievalPolicy_request_Policy.h
 *
 * Data retrieval policy.
 */

#ifndef OAISetDataRetrievalPolicy_request_Policy_H
#define OAISetDataRetrievalPolicy_request_Policy_H
...
class OAISetDataRetrievalPolicy_request_Policy : public OAIObject {
public:
    OAISetDataRetrievalPolicy_request_Policy();
    OAISetDataRetrievalPolicy_request_Policy(QString json);
    ~OAISetDataRetrievalPolicy_request_Policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetDataRetrievalPolicy_request_Policy)

#endif // OAISetDataRetrievalPolicy_request_Policy_H
