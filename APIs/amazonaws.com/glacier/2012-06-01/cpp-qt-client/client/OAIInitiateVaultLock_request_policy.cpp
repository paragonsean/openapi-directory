...
OAIInitiateVaultLock_request_policy::OAIInitiateVaultLock_request_policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInitiateVaultLock_request_policy::OAIInitiateVaultLock_request_policy() {
    this->initializeModel();
}

OAIInitiateVaultLock_request_policy::~OAIInitiateVaultLock_request_policy() {}

void OAIInitiateVaultLock_request_policy::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIInitiateVaultLock_request_policy::fromJson(QString jsonString) {
...
void OAIInitiateVaultLock_request_policy::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAIInitiateVaultLock_request_policy::asJson() const {
...
QJsonObject OAIInitiateVaultLock_request_policy::asJsonObject() const {
    QJsonObject obj;
    if (m_policy_isSet) {
...
QString OAIInitiateVaultLock_request_policy::getPolicy() const {
    return m_policy;
}
void OAIInitiateVaultLock_request_policy::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIInitiateVaultLock_request_policy::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIInitiateVaultLock_request_policy::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIInitiateVaultLock_request_policy::isSet() const {
...
bool OAIInitiateVaultLock_request_policy::isValid() const {
