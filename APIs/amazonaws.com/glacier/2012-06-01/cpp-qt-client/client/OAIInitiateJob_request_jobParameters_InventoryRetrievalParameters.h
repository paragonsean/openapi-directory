...
/*
 * OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters.h
 *
 * 
 */

#ifndef OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters_H
#define OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters_H
...
class OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters : public OAIObject {
public:
    OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters();
    OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters(QString json);
    ~OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters)

#endif // OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters_H
