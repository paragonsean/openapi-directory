...
/*
 * OAIUploadMultipartPartInput.h
 *
 * Provides options to upload a part of an archive in a multipart upload operation.
 */

#ifndef OAIUploadMultipartPartInput_H
#define OAIUploadMultipartPartInput_H
...
class OAIUploadMultipartPartInput : public OAIObject {
public:
    OAIUploadMultipartPartInput();
    OAIUploadMultipartPartInput(QString json);
    ~OAIUploadMultipartPartInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUploadMultipartPartInput)

#endif // OAIUploadMultipartPartInput_H
