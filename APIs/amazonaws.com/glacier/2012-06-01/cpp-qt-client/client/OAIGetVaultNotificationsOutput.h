...
/*
 * OAIGetVaultNotificationsOutput.h
 *
 * Contains the Amazon S3 Glacier response to your request.
 */

#ifndef OAIGetVaultNotificationsOutput_H
#define OAIGetVaultNotificationsOutput_H
...
namespace OpenAPI {
class OAIGetVaultNotificationsOutput_vaultNotificationConfig;

class OAIGetVaultNotificationsOutput : public OAIObject {
public:
    OAIGetVaultNotificationsOutput();
    OAIGetVaultNotificationsOutput(QString json);
    ~OAIGetVaultNotificationsOutput() override;
    ...
    OAIGetVaultNotificationsOutput_vaultNotificationConfig getVaultNotificationConfig() const;
    void setVaultNotificationConfig(const OAIGetVaultNotificationsOutput_vaultNotificationConfig &vault_notification_config);
...
private:
    ...
    OAIGetVaultNotificationsOutput_vaultNotificationConfig m_vault_notification_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVaultNotificationsOutput)

#endif // OAIGetVaultNotificationsOutput_H
