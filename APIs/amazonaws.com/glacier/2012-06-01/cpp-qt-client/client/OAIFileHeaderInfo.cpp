...
OAIFileHeaderInfo::OAIFileHeaderInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFileHeaderInfo::OAIFileHeaderInfo() {
    this->initializeModel();
}

OAIFileHeaderInfo::~OAIFileHeaderInfo() {}

void OAIFileHeaderInfo::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFileHeaderInfo::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFileHeaderInfo::fromJson(QString jsonString) {
    
    if ( jsonString.compare("USE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFileHeaderInfo::USE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IGNORE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFileHeaderInfo::IGNORE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NONE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFileHeaderInfo::NONE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFileHeaderInfo::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFileHeaderInfo::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFileHeaderInfo::USE:
            val = "USE";
            break;
        case eOAIFileHeaderInfo::IGNORE:
            val = "IGNORE";
            break;
        case eOAIFileHeaderInfo::NONE:
            val = "NONE";
            break;
        default:
            break;
...
QJsonValue OAIFileHeaderInfo::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFileHeaderInfo::eOAIFileHeaderInfo OAIFileHeaderInfo::getValue() const {
    return m_value;
}

void OAIFileHeaderInfo::setValue(const OAIFileHeaderInfo::eOAIFileHeaderInfo& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFileHeaderInfo::isSet() const {
    
    return m_value_isSet;
}

bool OAIFileHeaderInfo::isValid() const {
