...
/*
 * OAISetVaultAccessPolicyInput.h
 *
 * SetVaultAccessPolicy input.
 */

#ifndef OAISetVaultAccessPolicyInput_H
#define OAISetVaultAccessPolicyInput_H
...
namespace OpenAPI {
class OAISetVaultAccessPolicyInput_policy;

class OAISetVaultAccessPolicyInput : public OAIObject {
public:
    OAISetVaultAccessPolicyInput();
    OAISetVaultAccessPolicyInput(QString json);
    ~OAISetVaultAccessPolicyInput() override;
    ...
    OAISetVaultAccessPolicyInput_policy getPolicy() const;
    void setPolicy(const OAISetVaultAccessPolicyInput_policy &policy);
...
private:
    ...
    OAISetVaultAccessPolicyInput_policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetVaultAccessPolicyInput)

#endif // OAISetVaultAccessPolicyInput_H
