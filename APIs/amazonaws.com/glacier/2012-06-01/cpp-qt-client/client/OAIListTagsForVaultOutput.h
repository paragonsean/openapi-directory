...
/*
 * OAIListTagsForVaultOutput.h
 *
 * Contains the Amazon S3 Glacier response to your request.
 */

#ifndef OAIListTagsForVaultOutput_H
#define OAIListTagsForVaultOutput_H
...
class OAIListTagsForVaultOutput : public OAIObject {
public:
    OAIListTagsForVaultOutput();
    OAIListTagsForVaultOutput(QString json);
    ~OAIListTagsForVaultOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTagsForVaultOutput)

#endif // OAIListTagsForVaultOutput_H
