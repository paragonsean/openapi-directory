...
/*
 * OAIListProvisionedCapacityOutput.h
 *
 * 
 */

#ifndef OAIListProvisionedCapacityOutput_H
#define OAIListProvisionedCapacityOutput_H
...
class OAIListProvisionedCapacityOutput : public OAIObject {
public:
    OAIListProvisionedCapacityOutput();
    OAIListProvisionedCapacityOutput(QString json);
    ~OAIListProvisionedCapacityOutput() override;
    ...
    QList getProvisionedCapacityList() const;
    void setProvisionedCapacityList(const QList &provisioned_capacity_list);
    bool is_provisioned_capacity_list_Set() const;
    bool is_provisioned_capacity_list_Valid() const;
...
private:
    ...
    QList m_provisioned_capacity_list;
    bool m_provisioned_capacity_list_isSet;
    bool m_provisioned_capacity_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListProvisionedCapacityOutput)

#endif // OAIListProvisionedCapacityOutput_H
