...
/*
 * OAIInventoryRetrievalJobInput.h
 *
 * Provides options for specifying a range inventory retrieval job.
 */

#ifndef OAIInventoryRetrievalJobInput_H
#define OAIInventoryRetrievalJobInput_H
...
class OAIInventoryRetrievalJobInput : public OAIObject {
public:
    OAIInventoryRetrievalJobInput();
    OAIInventoryRetrievalJobInput(QString json);
    ~OAIInventoryRetrievalJobInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryRetrievalJobInput)

#endif // OAIInventoryRetrievalJobInput_H
