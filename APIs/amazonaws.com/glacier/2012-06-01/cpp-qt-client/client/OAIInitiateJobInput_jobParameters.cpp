...
OAIInitiateJobInput_jobParameters::OAIInitiateJobInput_jobParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInitiateJobInput_jobParameters::OAIInitiateJobInput_jobParameters() {
    this->initializeModel();
}

OAIInitiateJobInput_jobParameters::~OAIInitiateJobInput_jobParameters() {}

void OAIInitiateJobInput_jobParameters::initializeModel() {
...
void OAIInitiateJobInput_jobParameters::fromJson(QString jsonString) {
...
void OAIInitiateJobInput_jobParameters::fromJsonObject(QJsonObject json) {
...
QString OAIInitiateJobInput_jobParameters::asJson() const {
...
QJsonObject OAIInitiateJobInput_jobParameters::asJsonObject() const {
    QJsonObject obj;
    if (m_format_isSet) {
...
QString OAIInitiateJobInput_jobParameters::getFormat() const {
    return m_format;
}
void OAIInitiateJobInput_jobParameters::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIInitiateJobInput_jobParameters::is_format_Set() const{
    return m_format_isSet;
}

bool OAIInitiateJobInput_jobParameters::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIInitiateJobInput_jobParameters::getType() const {
    return m_type;
}
void OAIInitiateJobInput_jobParameters::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIInitiateJobInput_jobParameters::is_type_Set() const{
    return m_type_isSet;
}

bool OAIInitiateJobInput_jobParameters::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIInitiateJobInput_jobParameters::getArchiveId() const {
    return m_archive_id;
}
void OAIInitiateJobInput_jobParameters::setArchiveId(const QString &archive_id) {
    m_archive_id = archive_id;
    m_archive_id_isSet = true;
}

bool OAIInitiateJobInput_jobParameters::is_archive_id_Set() const{
    return m_archive_id_isSet;
}

bool OAIInitiateJobInput_jobParameters::is_archive_id_Valid() const{
    return m_archive_id_isValid;
}

QString OAIInitiateJobInput_jobParameters::getDescription() const {
    return m_description;
}
void OAIInitiateJobInput_jobParameters::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIInitiateJobInput_jobParameters::is_description_Set() const{
    return m_description_isSet;
}

bool OAIInitiateJobInput_jobParameters::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIInitiateJobInput_jobParameters::getSnsTopic() const {
    return m_sns_topic;
}
void OAIInitiateJobInput_jobParameters::setSnsTopic(const QString &sns_topic) {
    m_sns_topic = sns_topic;
    m_sns_topic_isSet = true;
}

bool OAIInitiateJobInput_jobParameters::is_sns_topic_Set() const{
    return m_sns_topic_isSet;
}

bool OAIInitiateJobInput_jobParameters::is_sns_topic_Valid() const{
    return m_sns_topic_isValid;
}

QString OAIInitiateJobInput_jobParameters::getRetrievalByteRange() const {
    return m_retrieval_byte_range;
}
void OAIInitiateJobInput_jobParameters::setRetrievalByteRange(const QString &retrieval_byte_range) {
    m_retrieval_byte_range = retrieval_byte_range;
    m_retrieval_byte_range_isSet = true;
}

bool OAIInitiateJobInput_jobParameters::is_retrieval_byte_range_Set() const{
    return m_retrieval_byte_range_isSet;
}

bool OAIInitiateJobInput_jobParameters::is_retrieval_byte_range_Valid() const{
    return m_retrieval_byte_range_isValid;
}

QString OAIInitiateJobInput_jobParameters::getTier() const {
    return m_tier;
}
void OAIInitiateJobInput_jobParameters::setTier(const QString &tier) {
    m_tier = tier;
    m_tier_isSet = true;
}

bool OAIInitiateJobInput_jobParameters::is_tier_Set() const{
    return m_tier_isSet;
}

bool OAIInitiateJobInput_jobParameters::is_tier_Valid() const{
    return m_tier_isValid;
}

OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters OAIInitiateJobInput_jobParameters::getInventoryRetrievalParameters() const {
    return m_inventory_retrieval_parameters;
}
void OAIInitiateJobInput_jobParameters::setInventoryRetrievalParameters(const OAIInitiateJob_request_jobParameters_InventoryRetrievalParameters &inventory_retrieval_parameters) {
    m_inventory_retrieval_parameters = inventory_retrieval_parameters;
    m_inventory_retrieval_parameters_isSet = true;
}

bool OAIInitiateJobInput_jobParameters::is_inventory_retrieval_parameters_Set() const{
    return m_inventory_retrieval_parameters_isSet;
}

bool OAIInitiateJobInput_jobParameters::is_inventory_retrieval_parameters_Valid() const{
    return m_inventory_retrieval_parameters_isValid;
}

OAIInitiateJob_request_jobParameters_SelectParameters OAIInitiateJobInput_jobParameters::getSelectParameters() const {
    return m_select_parameters;
}
void OAIInitiateJobInput_jobParameters::setSelectParameters(const OAIInitiateJob_request_jobParameters_SelectParameters &select_parameters) {
    m_select_parameters = select_parameters;
    m_select_parameters_isSet = true;
}

bool OAIInitiateJobInput_jobParameters::is_select_parameters_Set() const{
    return m_select_parameters_isSet;
}

bool OAIInitiateJobInput_jobParameters::is_select_parameters_Valid() const{
    return m_select_parameters_isValid;
}

OAIInitiateJob_request_jobParameters_OutputLocation OAIInitiateJobInput_jobParameters::getOutputLocation() const {
    return m_output_location;
}
void OAIInitiateJobInput_jobParameters::setOutputLocation(const OAIInitiateJob_request_jobParameters_OutputLocation &output_location) {
    m_output_location = output_location;
    m_output_location_isSet = true;
}

bool OAIInitiateJobInput_jobParameters::is_output_location_Set() const{
    return m_output_location_isSet;
}

bool OAIInitiateJobInput_jobParameters::is_output_location_Valid() const{
    return m_output_location_isValid;
}

bool OAIInitiateJobInput_jobParameters::isSet() const {
...
bool OAIInitiateJobInput_jobParameters::isValid() const {
