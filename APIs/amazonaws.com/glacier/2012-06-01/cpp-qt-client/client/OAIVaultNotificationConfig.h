...
/*
 * OAIVaultNotificationConfig.h
 *
 * Represents a vault&#39;s notification configuration.
 */

#ifndef OAIVaultNotificationConfig_H
#define OAIVaultNotificationConfig_H
...
class OAIVaultNotificationConfig : public OAIObject {
public:
    OAIVaultNotificationConfig();
    OAIVaultNotificationConfig(QString json);
    ~OAIVaultNotificationConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVaultNotificationConfig)

#endif // OAIVaultNotificationConfig_H
