...
OAIGetVaultAccessPolicyOutput::OAIGetVaultAccessPolicyOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetVaultAccessPolicyOutput::OAIGetVaultAccessPolicyOutput() {
    this->initializeModel();
}

OAIGetVaultAccessPolicyOutput::~OAIGetVaultAccessPolicyOutput() {}

void OAIGetVaultAccessPolicyOutput::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIGetVaultAccessPolicyOutput::fromJson(QString jsonString) {
...
void OAIGetVaultAccessPolicyOutput::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("policy")]);
    m_policy_isSet = !json[QString("policy")].isNull() && m_policy_isValid;
}

QString OAIGetVaultAccessPolicyOutput::asJson() const {
...
QJsonObject OAIGetVaultAccessPolicyOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAIGetVaultAccessPolicyOutput_policy OAIGetVaultAccessPolicyOutput::getPolicy() const {
    return m_policy;
}
void OAIGetVaultAccessPolicyOutput::setPolicy(const OAIGetVaultAccessPolicyOutput_policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIGetVaultAccessPolicyOutput::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIGetVaultAccessPolicyOutput::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIGetVaultAccessPolicyOutput::isSet() const {
...
bool OAIGetVaultAccessPolicyOutput::isValid() const {
