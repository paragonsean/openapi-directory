...
/*
 * OAIGetDataRetrievalPolicyOutput_Policy.h
 *
 * 
 */

#ifndef OAIGetDataRetrievalPolicyOutput_Policy_H
#define OAIGetDataRetrievalPolicyOutput_Policy_H
...
class OAIGetDataRetrievalPolicyOutput_Policy : public OAIObject {
public:
    OAIGetDataRetrievalPolicyOutput_Policy();
    OAIGetDataRetrievalPolicyOutput_Policy(QString json);
    ~OAIGetDataRetrievalPolicyOutput_Policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDataRetrievalPolicyOutput_Policy)

#endif // OAIGetDataRetrievalPolicyOutput_Policy_H
