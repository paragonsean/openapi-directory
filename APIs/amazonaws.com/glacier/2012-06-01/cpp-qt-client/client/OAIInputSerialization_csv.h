...
/*
 * OAIInputSerialization_csv.h
 *
 * 
 */

#ifndef OAIInputSerialization_csv_H
#define OAIInputSerialization_csv_H
...
class OAIInputSerialization_csv : public OAIObject {
public:
    OAIInputSerialization_csv();
    OAIInputSerialization_csv(QString json);
    ~OAIInputSerialization_csv() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputSerialization_csv)

#endif // OAIInputSerialization_csv_H
