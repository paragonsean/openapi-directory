...
/*
 * OAISetVaultAccessPolicy_request.h
 *
 * 
 */

#ifndef OAISetVaultAccessPolicy_request_H
#define OAISetVaultAccessPolicy_request_H
...
namespace OpenAPI {
class OAISetVaultAccessPolicy_request_policy;

class OAISetVaultAccessPolicy_request : public OAIObject {
public:
    OAISetVaultAccessPolicy_request();
    OAISetVaultAccessPolicy_request(QString json);
    ~OAISetVaultAccessPolicy_request() override;
    ...
    OAISetVaultAccessPolicy_request_policy getPolicy() const;
    void setPolicy(const OAISetVaultAccessPolicy_request_policy &policy);
...
private:
    ...
    OAISetVaultAccessPolicy_request_policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetVaultAccessPolicy_request)

#endif // OAISetVaultAccessPolicy_request_H
