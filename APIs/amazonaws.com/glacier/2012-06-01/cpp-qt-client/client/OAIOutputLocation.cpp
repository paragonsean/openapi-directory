...
OAIOutputLocation_S3 OAIOutputLocation::getS3() const {
    return m_s3;
}
void OAIOutputLocation::setS3(const OAIOutputLocation_S3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAIOutputLocation::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAIOutputLocation::is_s3_Valid() const{
    return m_s3_isValid;
}
