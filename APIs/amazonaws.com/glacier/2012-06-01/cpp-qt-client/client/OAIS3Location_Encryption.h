...
/*
 * OAIS3Location_Encryption.h
 *
 * 
 */

#ifndef OAIS3Location_Encryption_H
#define OAIS3Location_Encryption_H
...
class OAIS3Location_Encryption : public OAIObject {
public:
    OAIS3Location_Encryption();
    OAIS3Location_Encryption(QString json);
    ~OAIS3Location_Encryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3Location_Encryption)

#endif // OAIS3Location_Encryption_H
