...
/*
 * OAIVaultLockPolicy.h
 *
 * Contains the vault lock policy.
 */

#ifndef OAIVaultLockPolicy_H
#define OAIVaultLockPolicy_H
...
class OAIVaultLockPolicy : public OAIObject {
public:
    OAIVaultLockPolicy();
    OAIVaultLockPolicy(QString json);
    ~OAIVaultLockPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVaultLockPolicy)

#endif // OAIVaultLockPolicy_H
