...
#include "OAIInitiateVaultLockInput_policy.h"
...
OAIInitiateVaultLockInput_policy::OAIInitiateVaultLockInput_policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInitiateVaultLockInput_policy::OAIInitiateVaultLockInput_policy() {
    this->initializeModel();
}

OAIInitiateVaultLockInput_policy::~OAIInitiateVaultLockInput_policy() {}

void OAIInitiateVaultLockInput_policy::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIInitiateVaultLockInput_policy::fromJson(QString jsonString) {
...
void OAIInitiateVaultLockInput_policy::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAIInitiateVaultLockInput_policy::asJson() const {
...
QJsonObject OAIInitiateVaultLockInput_policy::asJsonObject() const {
    QJsonObject obj;
    if (m_policy_isSet) {
...
QString OAIInitiateVaultLockInput_policy::getPolicy() const {
    return m_policy;
}
void OAIInitiateVaultLockInput_policy::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIInitiateVaultLockInput_policy::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIInitiateVaultLockInput_policy::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIInitiateVaultLockInput_policy::isSet() const {
...
bool OAIInitiateVaultLockInput_policy::isValid() const {
