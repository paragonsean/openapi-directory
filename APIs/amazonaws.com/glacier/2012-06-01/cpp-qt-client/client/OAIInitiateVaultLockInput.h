...
/*
 * OAIInitiateVaultLockInput.h
 *
 * The input values for &lt;code&gt;InitiateVaultLock&lt;/code&gt;.
 */

#ifndef OAIInitiateVaultLockInput_H
#define OAIInitiateVaultLockInput_H
...
namespace OpenAPI {
class OAIInitiateVaultLockInput_policy;

class OAIInitiateVaultLockInput : public OAIObject {
public:
    OAIInitiateVaultLockInput();
    OAIInitiateVaultLockInput(QString json);
    ~OAIInitiateVaultLockInput() override;
    ...
    OAIInitiateVaultLockInput_policy getPolicy() const;
    void setPolicy(const OAIInitiateVaultLockInput_policy &policy);
...
private:
    ...
    OAIInitiateVaultLockInput_policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitiateVaultLockInput)

#endif // OAIInitiateVaultLockInput_H
