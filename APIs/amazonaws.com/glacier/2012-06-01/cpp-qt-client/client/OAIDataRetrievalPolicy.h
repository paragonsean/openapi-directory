...
/*
 * OAIDataRetrievalPolicy.h
 *
 * Data retrieval policy.
 */

#ifndef OAIDataRetrievalPolicy_H
#define OAIDataRetrievalPolicy_H
...
class OAIDataRetrievalPolicy : public OAIObject {
public:
    OAIDataRetrievalPolicy();
    OAIDataRetrievalPolicy(QString json);
    ~OAIDataRetrievalPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataRetrievalPolicy)

#endif // OAIDataRetrievalPolicy_H
