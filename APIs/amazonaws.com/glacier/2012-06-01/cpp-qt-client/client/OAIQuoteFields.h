...
#ifndef OAIQuoteFields_H
#define OAIQuoteFields_H
...
class OAIQuoteFields : public OAIEnum {
public:
    OAIQuoteFields();
    OAIQuoteFields(QString json);
    ~OAIQuoteFields() override;
    ...
    enum class eOAIQuoteFields {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ALWAYS, 
        ASNEEDED
    };
    OAIQuoteFields::eOAIQuoteFields getValue() const;
    void setValue(const OAIQuoteFields::eOAIQuoteFields& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuoteFields)

#endif // OAIQuoteFields_H
