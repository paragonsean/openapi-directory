...
/*
 * OAIVaultAccessPolicy.h
 *
 * Contains the vault access policy.
 */

#ifndef OAIVaultAccessPolicy_H
#define OAIVaultAccessPolicy_H
...
class OAIVaultAccessPolicy : public OAIObject {
public:
    OAIVaultAccessPolicy();
    OAIVaultAccessPolicy(QString json);
    ~OAIVaultAccessPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVaultAccessPolicy)

#endif // OAIVaultAccessPolicy_H
