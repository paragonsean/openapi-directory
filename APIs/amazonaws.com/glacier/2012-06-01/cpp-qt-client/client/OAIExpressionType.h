...
#ifndef OAIExpressionType_H
#define OAIExpressionType_H
...
class OAIExpressionType : public OAIEnum {
public:
    OAIExpressionType();
    OAIExpressionType(QString json);
    ~OAIExpressionType() override;
    ...
    enum class eOAIExpressionType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SQL
    };
    OAIExpressionType::eOAIExpressionType getValue() const;
    void setValue(const OAIExpressionType::eOAIExpressionType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIExpressionType)

#endif // OAIExpressionType_H
