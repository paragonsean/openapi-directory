...
OAIGetDataRetrievalPolicyOutput_Policy::OAIGetDataRetrievalPolicyOutput_Policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDataRetrievalPolicyOutput_Policy::OAIGetDataRetrievalPolicyOutput_Policy() {
    this->initializeModel();
}

OAIGetDataRetrievalPolicyOutput_Policy::~OAIGetDataRetrievalPolicyOutput_Policy() {}

void OAIGetDataRetrievalPolicyOutput_Policy::initializeModel() {

    m_rules_isSet = false;
    m_rules_isValid = false;
}

void OAIGetDataRetrievalPolicyOutput_Policy::fromJson(QString jsonString) {
...
void OAIGetDataRetrievalPolicyOutput_Policy::fromJsonObject(QJsonObject json) {

    m_rules_isValid = ::OpenAPI::fromJsonValue(m_rules, json[QString("Rules")]);
    m_rules_isSet = !json[QString("Rules")].isNull() && m_rules_isValid;
}

QString OAIGetDataRetrievalPolicyOutput_Policy::asJson() const {
...
QJsonObject OAIGetDataRetrievalPolicyOutput_Policy::asJsonObject() const {
    QJsonObject obj;
    if (m_rules.isSet()) {
...
QList OAIGetDataRetrievalPolicyOutput_Policy::getRules() const {
    return m_rules;
}
void OAIGetDataRetrievalPolicyOutput_Policy::setRules(const QList &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}

bool OAIGetDataRetrievalPolicyOutput_Policy::is_rules_Set() const{
    return m_rules_isSet;
}

bool OAIGetDataRetrievalPolicyOutput_Policy::is_rules_Valid() const{
    return m_rules_isValid;
}

bool OAIGetDataRetrievalPolicyOutput_Policy::isSet() const {
...
bool OAIGetDataRetrievalPolicyOutput_Policy::isValid() const {
