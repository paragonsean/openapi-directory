...
/*
 * OAIInitiateVaultLock_request.h
 *
 * 
 */

#ifndef OAIInitiateVaultLock_request_H
#define OAIInitiateVaultLock_request_H

#include <QJsonObject>

#include "OAIInitiateVaultLock_request_policy.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIInitiateVaultLock_request_policy;

class OAIInitiateVaultLock_request : public OAIObject {
public:
    OAIInitiateVaultLock_request();
    OAIInitiateVaultLock_request(QString json);
    ~OAIInitiateVaultLock_request() override;
    ...
    OAIInitiateVaultLock_request_policy getPolicy() const;
    void setPolicy(const OAIInitiateVaultLock_request_policy &policy);
...
private:
    ...
    OAIInitiateVaultLock_request_policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitiateVaultLock_request)

#endif // OAIInitiateVaultLock_request_H
