...
#include "OAIVaultAccessPolicy.h"
...
OAIVaultAccessPolicy::OAIVaultAccessPolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVaultAccessPolicy::OAIVaultAccessPolicy() {
    this->initializeModel();
}

OAIVaultAccessPolicy::~OAIVaultAccessPolicy() {}

void OAIVaultAccessPolicy::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIVaultAccessPolicy::fromJson(QString jsonString) {
...
void OAIVaultAccessPolicy::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAIVaultAccessPolicy::asJson() const {
...
QJsonObject OAIVaultAccessPolicy::asJsonObject() const {
    QJsonObject obj;
    if (m_policy_isSet) {
...
QString OAIVaultAccessPolicy::getPolicy() const {
    return m_policy;
}
void OAIVaultAccessPolicy::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIVaultAccessPolicy::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIVaultAccessPolicy::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIVaultAccessPolicy::isSet() const {
...
bool OAIVaultAccessPolicy::isValid() const {
