...
#include "OAIDataRetrievalPolicy.h"
...
OAIDataRetrievalPolicy::OAIDataRetrievalPolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataRetrievalPolicy::OAIDataRetrievalPolicy() {
    this->initializeModel();
}

OAIDataRetrievalPolicy::~OAIDataRetrievalPolicy() {}

void OAIDataRetrievalPolicy::initializeModel() {

    m_rules_isSet = false;
    m_rules_isValid = false;
}

void OAIDataRetrievalPolicy::fromJson(QString jsonString) {
...
QJsonObject OAIDataRetrievalPolicy::asJsonObject() const {
    QJsonObject obj;
    if (m_rules.isSet()) {
...
QList OAIDataRetrievalPolicy::getRules() const {
    return m_rules;
}
void OAIDataRetrievalPolicy::setRules(const QList &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}

bool OAIDataRetrievalPolicy::is_rules_Set() const{
    return m_rules_isSet;
}

bool OAIDataRetrievalPolicy::is_rules_Valid() const{
    return m_rules_isValid;
}

bool OAIDataRetrievalPolicy::isSet() const {
...
bool OAIDataRetrievalPolicy::isValid() const {
