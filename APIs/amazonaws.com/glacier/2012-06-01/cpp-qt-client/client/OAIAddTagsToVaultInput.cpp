...
#include "OAIAddTagsToVaultInput.h"
...
OAIAddTagsToVaultInput::OAIAddTagsToVaultInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddTagsToVaultInput::OAIAddTagsToVaultInput() {
    this->initializeModel();
}

OAIAddTagsToVaultInput::~OAIAddTagsToVaultInput() {}

void OAIAddTagsToVaultInput::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAIAddTagsToVaultInput::fromJson(QString jsonString) {
...
void OAIAddTagsToVaultInput::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAIAddTagsToVaultInput::asJson() const {
...
QJsonObject OAIAddTagsToVaultInput::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.isSet()) {
...
QMap OAIAddTagsToVaultInput::getTags() const {
    return m_tags;
}
void OAIAddTagsToVaultInput::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIAddTagsToVaultInput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIAddTagsToVaultInput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIAddTagsToVaultInput::isSet() const {
...
bool OAIAddTagsToVaultInput::isValid() const {
