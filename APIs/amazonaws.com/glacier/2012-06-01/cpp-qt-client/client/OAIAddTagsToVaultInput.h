...
/*
 * OAIAddTagsToVaultInput.h
 *
 * The input values for &lt;code&gt;AddTagsToVault&lt;/code&gt;.
 */

#ifndef OAIAddTagsToVaultInput_H
#define OAIAddTagsToVaultInput_H
...
class OAIAddTagsToVaultInput : public OAIObject {
public:
    OAIAddTagsToVaultInput();
    OAIAddTagsToVaultInput(QString json);
    ~OAIAddTagsToVaultInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddTagsToVaultInput)

#endif // OAIAddTagsToVaultInput_H
