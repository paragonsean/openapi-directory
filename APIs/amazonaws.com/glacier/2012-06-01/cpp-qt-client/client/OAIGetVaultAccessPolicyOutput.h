...
/*
 * OAIGetVaultAccessPolicyOutput.h
 *
 * Output for GetVaultAccessPolicy.
 */

#ifndef OAIGetVaultAccessPolicyOutput_H
#define OAIGetVaultAccessPolicyOutput_H
...
namespace OpenAPI {
class OAIGetVaultAccessPolicyOutput_policy;

class OAIGetVaultAccessPolicyOutput : public OAIObject {
public:
    OAIGetVaultAccessPolicyOutput();
    OAIGetVaultAccessPolicyOutput(QString json);
    ~OAIGetVaultAccessPolicyOutput() override;
    ...
    OAIGetVaultAccessPolicyOutput_policy getPolicy() const;
    void setPolicy(const OAIGetVaultAccessPolicyOutput_policy &policy);
...
private:
    ...
    OAIGetVaultAccessPolicyOutput_policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVaultAccessPolicyOutput)

#endif // OAIGetVaultAccessPolicyOutput_H
