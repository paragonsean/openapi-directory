...
OAISelectParameters_InputSerialization::OAISelectParameters_InputSerialization(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISelectParameters_InputSerialization::OAISelectParameters_InputSerialization() {
    this->initializeModel();
}

OAISelectParameters_InputSerialization::~OAISelectParameters_InputSerialization() {}

void OAISelectParameters_InputSerialization::initializeModel() {

    m_csv_isSet = false;
    m_csv_isValid = false;
}

void OAISelectParameters_InputSerialization::fromJson(QString jsonString) {
...
void OAISelectParameters_InputSerialization::fromJsonObject(QJsonObject json) {

    m_csv_isValid = ::OpenAPI::fromJsonValue(m_csv, json[QString("csv")]);
    m_csv_isSet = !json[QString("csv")].isNull() && m_csv_isValid;
}

QString OAISelectParameters_InputSerialization::asJson() const {
...
QJsonObject OAISelectParameters_InputSerialization::asJsonObject() const {
    QJsonObject obj;
    if (m_csv.isSet()) {
...
OAIInputSerialization_csv OAISelectParameters_InputSerialization::getCsv() const {
    return m_csv;
}
void OAISelectParameters_InputSerialization::setCsv(const OAIInputSerialization_csv &csv) {
    m_csv = csv;
    m_csv_isSet = true;
}

bool OAISelectParameters_InputSerialization::is_csv_Set() const{
    return m_csv_isSet;
}

bool OAISelectParameters_InputSerialization::is_csv_Valid() const{
    return m_csv_isValid;
}

bool OAISelectParameters_InputSerialization::isSet() const {
...
bool OAISelectParameters_InputSerialization::isValid() const {
