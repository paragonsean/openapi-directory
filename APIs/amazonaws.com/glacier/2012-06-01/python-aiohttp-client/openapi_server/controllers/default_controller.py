...
async def abort_multipart_upload(request: web.Request, account_id, vault_name, upload_id, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    ...
    :param account_id: The &lt;code&gt;AccountId&lt;/code&gt; value is the AWS account ID of the account that owns the vault. You can either specify an AWS account ID or optionally a single &#39;&lt;code&gt;-&lt;/code&gt;&#39; (hyphen), in which case Amazon S3 Glacier uses the AWS account ID associated with the credentials used to sign the request. If you use an account ID, do not include any hyphens (&#39;-&#39;) in the ID.
    :type account_id: str
...
async def abort_vault_lock(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """abort_vault_lock
    ...
    :param account_id: The &lt;code&gt;AccountId&lt;/code&gt; value is the AWS account ID. This value must match the AWS account ID associated with the credentials used to sign the request. You can either specify an AWS account ID or optionally a single &#39;&lt;code&gt;-&lt;/code&gt;&#39; (hyphen), in which case Amazon Glacier uses the AWS account ID associated with the credentials used to sign the request. If you specify your account ID, do not include any hyphens (&#39;-&#39;) in the ID.
    :type account_id: str
    :param vault_name: The name of the vault.
    :type vault_name: str
    :param x_amz_content_sha256: 
...
async def add_tags_to_vault(request: web.Request, account_id, vault_name, operation, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """add_tags_to_vault
    ...
    """
    body = AddTagsToVaultRequest.from_dict(body)
    return web.Response(status=200)


async def complete_multipart_upload(request: web.Request, account_id, vault_name, upload_id, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, x_amz_archive_size=None, x_amz_sha256_tree_hash=None) -> web.Response:
    ...
    :param x_amz_signed_headers: 
    :type x_amz_signed_headers: str
    :param x_amz_archive_size: The total size, in bytes, of the entire archive. This value should be the sum of all the sizes of the individual parts that you uploaded.
    :type x_amz_archive_size: str
    :param x_amz_sha256_tree_hash: The SHA256 tree hash of the entire archive. It is the tree hash of SHA256 tree hash of the individual parts. If the value you specify in the request does not match the SHA256 tree hash of the final assembled archive as computed by Amazon S3 Glacier (Glacier), Glacier returns an error and the request fails.
    :type x_amz_sha256_tree_hash: str

    """
    return web.Response(status=200)


async def complete_vault_lock(request: web.Request, account_id, vault_name, lock_id, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """complete_vault_lock
    ...
    :param vault_name: The name of the vault.
    :type vault_name: str
    :param lock_id: The &lt;code&gt;lockId&lt;/code&gt; value is the lock ID obtained from a &lt;a&gt;InitiateVaultLock&lt;/a&gt; request.
    :type lock_id: str
    :param x_amz_content_sha256: 
    :type x_amz_content_sha256: str
    :param x_amz_date: 
...
async def create_vault(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """create_vault
...
async def delete_archive(request: web.Request, account_id, vault_name, archive_id, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """delete_archive
...
async def delete_vault(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """delete_vault
...
async def delete_vault_access_policy(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
...
async def delete_vault_notifications(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
...
async def describe_job(request: web.Request, account_id, vault_name, job_id, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """describe_job
...
async def describe_vault(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """describe_vault
...
async def get_data_retrieval_policy(request: web.Request, account_id, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
...
async def get_job_output(request: web.Request, account_id, vault_name, job_id, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, range=None) -> web.Response:
    """get_job_output
...
async def get_vault_access_policy(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
...
async def get_vault_lock(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """get_vault_lock
...
async def get_vault_notifications(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
...
async def initiate_job(request: web.Request, account_id, vault_name, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """initiate_job
    ...
    """
    body = InitiateJobRequest.from_dict(body)
    return web.Response(status=200)


async def initiate_multipart_upload(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, x_amz_archive_description=None, x_amz_part_size=None) -> web.Response:
    ...
    :param x_amz_signed_headers: 
    :type x_amz_signed_headers: str
    :param x_amz_archive_description: &lt;p&gt;The archive description that you are uploading in parts.&lt;/p&gt; &lt;p&gt;The part size must be a megabyte (1024 KB) multiplied by a power of 2, for example 1048576 (1 MB), 2097152 (2 MB), 4194304 (4 MB), 8388608 (8 MB), and so on. The minimum allowable part size is 1 MB, and the maximum is 4 GB (4096 MB).&lt;/p&gt;
    :type x_amz_archive_description: str
    :param x_amz_part_size: The size of each part except the last, in bytes. The last part can be smaller than this part size.
    :type x_amz_part_size: str

    """
    return web.Response(status=200)


async def initiate_vault_lock(request: web.Request, account_id, vault_name, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """initiate_vault_lock
    ...
    """
    body = InitiateVaultLockRequest.from_dict(body)
    return web.Response(status=200)


async def list_jobs(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, limit=None, marker=None, statuscode=None, completed=None) -> web.Response:
    """list_jobs
    ...
    :type marker: str
    :param statuscode: The type of job status to return. You can specify the following values: &lt;code&gt;InProgress&lt;/code&gt;, &lt;code&gt;Succeeded&lt;/code&gt;, or &lt;code&gt;Failed&lt;/code&gt;.
    :type statuscode: str
    :param completed: The state of the jobs to return. You can specify &lt;code&gt;true&lt;/code&gt; or &lt;code&gt;false&lt;/code&gt;.
    :type completed: str
...
async def list_multipart_uploads(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, marker=None, limit=None) -> web.Response:
...
async def list_parts(request: web.Request, account_id, vault_name, upload_id, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, marker=None, limit=None) -> web.Response:
    """list_parts
...
async def list_provisioned_capacity(request: web.Request, account_id, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """list_provisioned_capacity

    This operation lists the provisioned capacity units for the specified AWS account.

    :param account_id: The AWS account ID of the account that owns the vault. You can either specify an AWS account ID or optionally a single &#39;-&#39; (hyphen), in which case Amazon S3 Glacier uses the AWS account ID associated with the credentials used to sign the request. If you use an account ID, don&#39;t include any hyphens (&#39;-&#39;) in the ID. 
    :type account_id: str
    :param x_amz_content_sha256: 
    :type x_amz_content_sha256: str
    :param x_amz_date: 
...
async def list_tags_for_vault(request: web.Request, account_id, vault_name, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """list_tags_for_vault
...
async def list_vaults(request: web.Request, account_id, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, marker=None, limit=None) -> web.Response:
    """list_vaults
...
async def purchase_provisioned_capacity(request: web.Request, account_id, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
...
async def remove_tags_from_vault(request: web.Request, account_id, vault_name, operation, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    ...
    """
    body = RemoveTagsFromVaultRequest.from_dict(body)
    return web.Response(status=200)


async def set_data_retrieval_policy(request: web.Request, account_id, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    ...
    """
    body = SetDataRetrievalPolicyRequest.from_dict(body)
    return web.Response(status=200)


async def set_vault_access_policy(request: web.Request, account_id, vault_name, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    ...
    """
    body = SetVaultAccessPolicyRequest.from_dict(body)
    return web.Response(status=200)


async def set_vault_notifications(request: web.Request, account_id, vault_name, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    ...
    """
    body = SetVaultNotificationsRequest.from_dict(body)
    return web.Response(status=200)


async def upload_archive(request: web.Request, vault_name, account_id, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, x_amz_archive_description=None, x_amz_sha256_tree_hash=None) -> web.Response:
    """upload_archive
    ...
    :param x_amz_signed_headers: 
    :type x_amz_signed_headers: str
    :param x_amz_archive_description: The optional description of the archive you are uploading.
    :type x_amz_archive_description: str
    :param x_amz_sha256_tree_hash: The SHA256 tree hash of the data being uploaded.
    :type x_amz_sha256_tree_hash: str

    """
    body = UploadMultipartPartRequest.from_dict(body)
    return web.Response(status=200)


async def upload_multipart_part(request: web.Request, account_id, vault_name, upload_id, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, x_amz_sha256_tree_hash=None, content_range=None) -> web.Response:
    """upload_multipart_part
    ...
    :param x_amz_sha256_tree_hash: The SHA256 tree hash of the data being uploaded.
    :type x_amz_sha256_tree_hash: str
    :param content_range: Identifies the range of bytes in the assembled archive that will be uploaded in this part. Amazon S3 Glacier uses this information to assemble the archive in the proper sequence. The format of this header follows RFC 2616. An example header is Content-Range:bytes 0-4194303/*.
