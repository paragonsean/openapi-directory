...
public class ContextDataType {
  ...
  public ContextDataType ipAddress(String ipAddress) {
  ...
  public ContextDataType serverName(String serverName) {
  ...
  public ContextDataType serverPath(String serverPath) {
  ...
  public ContextDataType httpHeaders(List httpHeaders) {
  ...
  public ContextDataType encodedData(String encodedData) {
  ...
  public boolean equals(Object o) {
    ...
    ContextDataType contextDataType = (ContextDataType) o;
    return Objects.equals(this.ipAddress, contextDataType.ipAddress) &&
        Objects.equals(this.serverName, contextDataType.serverName) &&
        Objects.equals(this.serverPath, contextDataType.serverPath) &&
        Objects.equals(this.httpHeaders, contextDataType.httpHeaders) &&
        Objects.equals(this.encodedData, contextDataType.encodedData);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContextDataType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContextDataType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextDataType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContextDataType is not found in the empty JSON string", ContextDataType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextDataType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextDataType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContextDataType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContextDataType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContextDataType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContextDataType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContextDataType.class));

       return (TypeAdapter<T>) new TypeAdapter<ContextDataType>() {
           @Override
           public void write(JsonWriter out, ContextDataType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContextDataType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContextDataType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContextDataType
   * @throws IOException if the JSON string is invalid with respect to ContextDataType
   */
  public static ContextDataType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContextDataType.class);
  }

  /**
   * Convert an instance of ContextDataType to an JSON string
   *
   * @return JSON string
   */
