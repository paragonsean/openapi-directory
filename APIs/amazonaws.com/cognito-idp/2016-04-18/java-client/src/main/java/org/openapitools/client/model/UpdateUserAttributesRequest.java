...
public class UpdateUserAttributesRequest {
  ...
  public UpdateUserAttributesRequest userAttributes(List userAttributes) {
  ...
  public UpdateUserAttributesRequest accessToken(String accessToken) {
  ...
  public UpdateUserAttributesRequest clientMetadata(Map clientMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateUserAttributesRequest updateUserAttributesRequest = (UpdateUserAttributesRequest) o;
    return Objects.equals(this.userAttributes, updateUserAttributesRequest.userAttributes) &&
        Objects.equals(this.accessToken, updateUserAttributesRequest.accessToken) &&
        Objects.equals(this.clientMetadata, updateUserAttributesRequest.clientMetadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userAttributes, accessToken, clientMetadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateUserAttributesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserAttributesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserAttributesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserAttributesRequest is not found in the empty JSON string", UpdateUserAttributesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserAttributesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserAttributesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateUserAttributesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserAttributesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserAttributesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserAttributesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserAttributesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserAttributesRequest>() {
           @Override
           public void write(JsonWriter out, UpdateUserAttributesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserAttributesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserAttributesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserAttributesRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateUserAttributesRequest
   */
  public static UpdateUserAttributesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserAttributesRequest.class);
  }

  /**
   * Convert an instance of UpdateUserAttributesRequest to an JSON string
   *
   * @return JSON string
   */
