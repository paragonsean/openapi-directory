...
public class UserPoolTypeUsernameConfiguration {
  ...
  public UserPoolTypeUsernameConfiguration() {
  }

  public UserPoolTypeUsernameConfiguration caseSensitive(Boolean caseSensitive) {
  ...
  public boolean equals(Object o) {
    ...
    UserPoolTypeUsernameConfiguration userPoolTypeUsernameConfiguration = (UserPoolTypeUsernameConfiguration) o;
    return Objects.equals(this.caseSensitive, userPoolTypeUsernameConfiguration.caseSensitive);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserPoolTypeUsernameConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserPoolTypeUsernameConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPoolTypeUsernameConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserPoolTypeUsernameConfiguration is not found in the empty JSON string", UserPoolTypeUsernameConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserPoolTypeUsernameConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserPoolTypeUsernameConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserPoolTypeUsernameConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserPoolTypeUsernameConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserPoolTypeUsernameConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserPoolTypeUsernameConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserPoolTypeUsernameConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UserPoolTypeUsernameConfiguration>() {
           @Override
           public void write(JsonWriter out, UserPoolTypeUsernameConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserPoolTypeUsernameConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserPoolTypeUsernameConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserPoolTypeUsernameConfiguration
   * @throws IOException if the JSON string is invalid with respect to UserPoolTypeUsernameConfiguration
   */
  public static UserPoolTypeUsernameConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserPoolTypeUsernameConfiguration.class);
  }

  /**
   * Convert an instance of UserPoolTypeUsernameConfiguration to an JSON string
   *
   * @return JSON string
   */
