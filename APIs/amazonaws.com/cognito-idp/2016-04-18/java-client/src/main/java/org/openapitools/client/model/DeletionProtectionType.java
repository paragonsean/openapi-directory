...
/**
 * Gets or Sets DeletionProtectionType
 */
@JsonAdapter(DeletionProtectionType.Adapter.class)
public enum DeletionProtectionType {
  ...
  DeletionProtectionType(String value) {
    this.value = value;
  }
  ...
  public static DeletionProtectionType fromValue(String value) {
    for (DeletionProtectionType b : DeletionProtectionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<DeletionProtectionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final DeletionProtectionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DeletionProtectionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DeletionProtectionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DeletionProtectionType.fromValue(value);
  }
}
