...
public class AnalyticsMetadataType {
  ...
  public AnalyticsMetadataType analyticsEndpointId(String analyticsEndpointId) {
  ...
  public boolean equals(Object o) {
    ...
    AnalyticsMetadataType analyticsMetadataType = (AnalyticsMetadataType) o;
    return Objects.equals(this.analyticsEndpointId, analyticsMetadataType.analyticsEndpointId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnalyticsMetadataType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnalyticsMetadataType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnalyticsMetadataType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnalyticsMetadataType is not found in the empty JSON string", AnalyticsMetadataType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AnalyticsMetadataType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnalyticsMetadataType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnalyticsMetadataType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnalyticsMetadataType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnalyticsMetadataType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnalyticsMetadataType.class));

       return (TypeAdapter<T>) new TypeAdapter<AnalyticsMetadataType>() {
           @Override
           public void write(JsonWriter out, AnalyticsMetadataType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnalyticsMetadataType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AnalyticsMetadataType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnalyticsMetadataType
   * @throws IOException if the JSON string is invalid with respect to AnalyticsMetadataType
   */
  public static AnalyticsMetadataType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnalyticsMetadataType.class);
  }

  /**
   * Convert an instance of AnalyticsMetadataType to an JSON string
   *
   * @return JSON string
   */
