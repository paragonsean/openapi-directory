...
public class DomainDescriptionTypeCustomDomainConfig {
  ...
  public DomainDescriptionTypeCustomDomainConfig() {
  }

  public DomainDescriptionTypeCustomDomainConfig certificateArn(String certificateArn) {
  ...
  public boolean equals(Object o) {
    ...
    DomainDescriptionTypeCustomDomainConfig domainDescriptionTypeCustomDomainConfig = (DomainDescriptionTypeCustomDomainConfig) o;
    return Objects.equals(this.certificateArn, domainDescriptionTypeCustomDomainConfig.certificateArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainDescriptionTypeCustomDomainConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainDescriptionTypeCustomDomainConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainDescriptionTypeCustomDomainConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainDescriptionTypeCustomDomainConfig is not found in the empty JSON string", DomainDescriptionTypeCustomDomainConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainDescriptionTypeCustomDomainConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainDescriptionTypeCustomDomainConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DomainDescriptionTypeCustomDomainConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainDescriptionTypeCustomDomainConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainDescriptionTypeCustomDomainConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainDescriptionTypeCustomDomainConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainDescriptionTypeCustomDomainConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainDescriptionTypeCustomDomainConfig>() {
           @Override
           public void write(JsonWriter out, DomainDescriptionTypeCustomDomainConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainDescriptionTypeCustomDomainConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainDescriptionTypeCustomDomainConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainDescriptionTypeCustomDomainConfig
   * @throws IOException if the JSON string is invalid with respect to DomainDescriptionTypeCustomDomainConfig
   */
  public static DomainDescriptionTypeCustomDomainConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainDescriptionTypeCustomDomainConfig.class);
  }

  /**
   * Convert an instance of DomainDescriptionTypeCustomDomainConfig to an JSON string
   *
   * @return JSON string
   */
