...
public class ConfirmSignUpRequestAnalyticsMetadata {
  ...
  public ConfirmSignUpRequestAnalyticsMetadata() {
  }

  public ConfirmSignUpRequestAnalyticsMetadata analyticsEndpointId(String analyticsEndpointId) {
  ...
  public boolean equals(Object o) {
    ...
    ConfirmSignUpRequestAnalyticsMetadata confirmSignUpRequestAnalyticsMetadata = (ConfirmSignUpRequestAnalyticsMetadata) o;
    return Objects.equals(this.analyticsEndpointId, confirmSignUpRequestAnalyticsMetadata.analyticsEndpointId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfirmSignUpRequestAnalyticsMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfirmSignUpRequestAnalyticsMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfirmSignUpRequestAnalyticsMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfirmSignUpRequestAnalyticsMetadata is not found in the empty JSON string", ConfirmSignUpRequestAnalyticsMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfirmSignUpRequestAnalyticsMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfirmSignUpRequestAnalyticsMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfirmSignUpRequestAnalyticsMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfirmSignUpRequestAnalyticsMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfirmSignUpRequestAnalyticsMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfirmSignUpRequestAnalyticsMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfirmSignUpRequestAnalyticsMetadata>() {
           @Override
           public void write(JsonWriter out, ConfirmSignUpRequestAnalyticsMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfirmSignUpRequestAnalyticsMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfirmSignUpRequestAnalyticsMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfirmSignUpRequestAnalyticsMetadata
   * @throws IOException if the JSON string is invalid with respect to ConfirmSignUpRequestAnalyticsMetadata
   */
  public static ConfirmSignUpRequestAnalyticsMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfirmSignUpRequestAnalyticsMetadata.class);
  }

  /**
   * Convert an instance of ConfirmSignUpRequestAnalyticsMetadata to an JSON string
   *
   * @return JSON string
   */
