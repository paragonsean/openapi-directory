...
public class GlobalSignOutRequest {
  ...
  public GlobalSignOutRequest accessToken(String accessToken) {
  ...
  public boolean equals(Object o) {
    ...
    GlobalSignOutRequest globalSignOutRequest = (GlobalSignOutRequest) o;
    return Objects.equals(this.accessToken, globalSignOutRequest.accessToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class GlobalSignOutRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GlobalSignOutRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GlobalSignOutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GlobalSignOutRequest is not found in the empty JSON string", GlobalSignOutRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GlobalSignOutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GlobalSignOutRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GlobalSignOutRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GlobalSignOutRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GlobalSignOutRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GlobalSignOutRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GlobalSignOutRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GlobalSignOutRequest>() {
           @Override
           public void write(JsonWriter out, GlobalSignOutRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GlobalSignOutRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GlobalSignOutRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GlobalSignOutRequest
   * @throws IOException if the JSON string is invalid with respect to GlobalSignOutRequest
   */
  public static GlobalSignOutRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GlobalSignOutRequest.class);
  }

  /**
   * Convert an instance of GlobalSignOutRequest to an JSON string
   *
   * @return JSON string
   */
