...
public class AuthEventTypeEventRisk {
  ...
  public AuthEventTypeEventRisk() {
  }

  public AuthEventTypeEventRisk riskDecision(RiskDecisionType riskDecision) {
  ...
  public AuthEventTypeEventRisk riskLevel(RiskLevelType riskLevel) {
  ...
  public AuthEventTypeEventRisk compromisedCredentialsDetected(Boolean compromisedCredentialsDetected) {
  ...
  public boolean equals(Object o) {
    ...
    AuthEventTypeEventRisk authEventTypeEventRisk = (AuthEventTypeEventRisk) o;
    return Objects.equals(this.riskDecision, authEventTypeEventRisk.riskDecision) &&
        Objects.equals(this.riskLevel, authEventTypeEventRisk.riskLevel) &&
        Objects.equals(this.compromisedCredentialsDetected, authEventTypeEventRisk.compromisedCredentialsDetected);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthEventTypeEventRisk {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthEventTypeEventRisk
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthEventTypeEventRisk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthEventTypeEventRisk is not found in the empty JSON string", AuthEventTypeEventRisk.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthEventTypeEventRisk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthEventTypeEventRisk` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthEventTypeEventRisk.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthEventTypeEventRisk' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthEventTypeEventRisk> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthEventTypeEventRisk.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthEventTypeEventRisk>() {
           @Override
           public void write(JsonWriter out, AuthEventTypeEventRisk value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthEventTypeEventRisk read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthEventTypeEventRisk given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthEventTypeEventRisk
   * @throws IOException if the JSON string is invalid with respect to AuthEventTypeEventRisk
   */
  public static AuthEventTypeEventRisk fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthEventTypeEventRisk.class);
  }

  /**
   * Convert an instance of AuthEventTypeEventRisk to an JSON string
   *
   * @return JSON string
   */
