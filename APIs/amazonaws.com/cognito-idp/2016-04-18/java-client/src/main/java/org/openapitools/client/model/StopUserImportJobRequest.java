...
public class StopUserImportJobRequest {
  ...
  public StopUserImportJobRequest userPoolId(String userPoolId) {
  ...
  public StopUserImportJobRequest jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StopUserImportJobRequest stopUserImportJobRequest = (StopUserImportJobRequest) o;
    return Objects.equals(this.userPoolId, stopUserImportJobRequest.userPoolId) &&
        Objects.equals(this.jobId, stopUserImportJobRequest.jobId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopUserImportJobRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopUserImportJobRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopUserImportJobRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopUserImportJobRequest is not found in the empty JSON string", StopUserImportJobRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopUserImportJobRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopUserImportJobRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StopUserImportJobRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopUserImportJobRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopUserImportJobRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopUserImportJobRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopUserImportJobRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StopUserImportJobRequest>() {
           @Override
           public void write(JsonWriter out, StopUserImportJobRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopUserImportJobRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopUserImportJobRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopUserImportJobRequest
   * @throws IOException if the JSON string is invalid with respect to StopUserImportJobRequest
   */
  public static StopUserImportJobRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopUserImportJobRequest.class);
  }

  /**
   * Convert an instance of StopUserImportJobRequest to an JSON string
   *
   * @return JSON string
   */
