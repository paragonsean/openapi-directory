...
public class ConfirmDeviceResponse {
  public static final String SERIALIZED_NAME_USER_CONFIRMATION_NECESSARY = "UserConfirmationNecessary";
  ...
  public ConfirmDeviceResponse userConfirmationNecessary(Boolean userConfirmationNecessary) {
  ...
  public boolean equals(Object o) {
    ...
    ConfirmDeviceResponse confirmDeviceResponse = (ConfirmDeviceResponse) o;
    return Objects.equals(this.userConfirmationNecessary, confirmDeviceResponse.userConfirmationNecessary);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userConfirmationNecessary);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConfirmDeviceResponse {\n");
    sb.append("    userConfirmationNecessary: ").append(toIndentedString(userConfirmationNecessary)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("UserConfirmationNecessary");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfirmDeviceResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfirmDeviceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfirmDeviceResponse is not found in the empty JSON string", ConfirmDeviceResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfirmDeviceResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfirmDeviceResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `UserConfirmationNecessary`
      if (jsonObj.get("UserConfirmationNecessary") != null && !jsonObj.get("UserConfirmationNecessary").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("UserConfirmationNecessary"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfirmDeviceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfirmDeviceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfirmDeviceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfirmDeviceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfirmDeviceResponse>() {
           @Override
           public void write(JsonWriter out, ConfirmDeviceResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfirmDeviceResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfirmDeviceResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfirmDeviceResponse
   * @throws IOException if the JSON string is invalid with respect to ConfirmDeviceResponse
   */
  public static ConfirmDeviceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfirmDeviceResponse.class);
  }

  /**
   * Convert an instance of ConfirmDeviceResponse to an JSON string
   *
   * @return JSON string
   */
