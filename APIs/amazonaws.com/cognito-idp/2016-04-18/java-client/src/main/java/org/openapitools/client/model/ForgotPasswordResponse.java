...
import org.openapitools.client.model.ForgotPasswordResponseCodeDeliveryDetails;
...
public class ForgotPasswordResponse {
  ...
  private ForgotPasswordResponseCodeDeliveryDetails codeDeliveryDetails;

  public ForgotPasswordResponse() {
  }

  public ForgotPasswordResponse codeDeliveryDetails(ForgotPasswordResponseCodeDeliveryDetails codeDeliveryDetails) {
  ...
  public ForgotPasswordResponseCodeDeliveryDetails getCodeDeliveryDetails() {
    return codeDeliveryDetails;
  }

  public void setCodeDeliveryDetails(ForgotPasswordResponseCodeDeliveryDetails codeDeliveryDetails) {
    this.codeDeliveryDetails = codeDeliveryDetails;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.codeDeliveryDetails, forgotPasswordResponse.codeDeliveryDetails);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ForgotPasswordResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForgotPasswordResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ForgotPasswordResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ForgotPasswordResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("CodeDeliveryDetails") != null && !jsonObj.get("CodeDeliveryDetails").isJsonNull()) {
        ForgotPasswordResponseCodeDeliveryDetails.validateJsonElement(jsonObj.get("CodeDeliveryDetails"));
      }
  }
