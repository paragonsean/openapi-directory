...
import org.openapitools.client.model.DescribeUserPoolResponseUserPool;
...
public class DescribeUserPoolResponse {
  ...
  private DescribeUserPoolResponseUserPool userPool;

  public DescribeUserPoolResponse() {
  }

  public DescribeUserPoolResponse userPool(DescribeUserPoolResponseUserPool userPool) {
  ...
  public DescribeUserPoolResponseUserPool getUserPool() {
    return userPool;
  }

  public void setUserPool(DescribeUserPoolResponseUserPool userPool) {
    this.userPool = userPool;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeUserPoolResponse describeUserPoolResponse = (DescribeUserPoolResponse) o;
    return Objects.equals(this.userPool, describeUserPoolResponse.userPool);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPool);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeUserPoolResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUserPoolResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUserPoolResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUserPoolResponse is not found in the empty JSON string", DescribeUserPoolResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUserPoolResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUserPoolResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `UserPool`
      if (jsonObj.get("UserPool") != null && !jsonObj.get("UserPool").isJsonNull()) {
        DescribeUserPoolResponseUserPool.validateJsonElement(jsonObj.get("UserPool"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUserPoolResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUserPoolResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUserPoolResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUserPoolResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUserPoolResponse>() {
           @Override
           public void write(JsonWriter out, DescribeUserPoolResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUserPoolResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUserPoolResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUserPoolResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeUserPoolResponse
   */
  public static DescribeUserPoolResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUserPoolResponse.class);
  }

  /**
   * Convert an instance of DescribeUserPoolResponse to an JSON string
   *
   * @return JSON string
   */
