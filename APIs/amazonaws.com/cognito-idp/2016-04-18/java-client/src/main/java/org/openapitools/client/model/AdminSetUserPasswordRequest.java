...
public class AdminSetUserPasswordRequest {
  ...
  public AdminSetUserPasswordRequest userPoolId(String userPoolId) {
  ...
  public AdminSetUserPasswordRequest username(String username) {
  ...
  public AdminSetUserPasswordRequest password(String password) {
  ...
  public AdminSetUserPasswordRequest permanent(Boolean permanent) {
  ...
  public boolean equals(Object o) {
    ...
    AdminSetUserPasswordRequest adminSetUserPasswordRequest = (AdminSetUserPasswordRequest) o;
    return Objects.equals(this.userPoolId, adminSetUserPasswordRequest.userPoolId) &&
        Objects.equals(this.username, adminSetUserPasswordRequest.username) &&
        Objects.equals(this.password, adminSetUserPasswordRequest.password) &&
        Objects.equals(this.permanent, adminSetUserPasswordRequest.permanent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username, password, permanent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminSetUserPasswordRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminSetUserPasswordRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminSetUserPasswordRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminSetUserPasswordRequest is not found in the empty JSON string", AdminSetUserPasswordRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminSetUserPasswordRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminSetUserPasswordRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminSetUserPasswordRequest.openapiRequiredFields) {
      ...
      // validate the optional field `Permanent`
      if (jsonObj.get("Permanent") != null && !jsonObj.get("Permanent").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("Permanent"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminSetUserPasswordRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminSetUserPasswordRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminSetUserPasswordRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminSetUserPasswordRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminSetUserPasswordRequest>() {
           @Override
           public void write(JsonWriter out, AdminSetUserPasswordRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminSetUserPasswordRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminSetUserPasswordRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminSetUserPasswordRequest
   * @throws IOException if the JSON string is invalid with respect to AdminSetUserPasswordRequest
   */
  public static AdminSetUserPasswordRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminSetUserPasswordRequest.class);
  }

  /**
   * Convert an instance of AdminSetUserPasswordRequest to an JSON string
   *
   * @return JSON string
   */
