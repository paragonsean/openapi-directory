...
public class AdminResetUserPasswordRequest {
  ...
  public AdminResetUserPasswordRequest userPoolId(String userPoolId) {
  ...
  public AdminResetUserPasswordRequest username(String username) {
  ...
  public AdminResetUserPasswordRequest clientMetadata(Map clientMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    AdminResetUserPasswordRequest adminResetUserPasswordRequest = (AdminResetUserPasswordRequest) o;
    return Objects.equals(this.userPoolId, adminResetUserPasswordRequest.userPoolId) &&
        Objects.equals(this.username, adminResetUserPasswordRequest.username) &&
        Objects.equals(this.clientMetadata, adminResetUserPasswordRequest.clientMetadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username, clientMetadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminResetUserPasswordRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminResetUserPasswordRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminResetUserPasswordRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminResetUserPasswordRequest is not found in the empty JSON string", AdminResetUserPasswordRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminResetUserPasswordRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminResetUserPasswordRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminResetUserPasswordRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminResetUserPasswordRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminResetUserPasswordRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminResetUserPasswordRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminResetUserPasswordRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminResetUserPasswordRequest>() {
           @Override
           public void write(JsonWriter out, AdminResetUserPasswordRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminResetUserPasswordRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminResetUserPasswordRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminResetUserPasswordRequest
   * @throws IOException if the JSON string is invalid with respect to AdminResetUserPasswordRequest
   */
  public static AdminResetUserPasswordRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminResetUserPasswordRequest.class);
  }

  /**
   * Convert an instance of AdminResetUserPasswordRequest to an JSON string
   *
   * @return JSON string
   */
