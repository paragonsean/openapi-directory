...
public class DeleteUserPoolDomainRequest {
  ...
  public DeleteUserPoolDomainRequest domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public DeleteUserPoolDomainRequest userPoolId(String userPoolId) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteUserPoolDomainRequest deleteUserPoolDomainRequest = (DeleteUserPoolDomainRequest) o;
    return Objects.equals(this.domain, deleteUserPoolDomainRequest.domain) &&
        Objects.equals(this.userPoolId, deleteUserPoolDomainRequest.userPoolId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, userPoolId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteUserPoolDomainRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteUserPoolDomainRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteUserPoolDomainRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteUserPoolDomainRequest is not found in the empty JSON string", DeleteUserPoolDomainRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteUserPoolDomainRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteUserPoolDomainRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteUserPoolDomainRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteUserPoolDomainRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteUserPoolDomainRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteUserPoolDomainRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteUserPoolDomainRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteUserPoolDomainRequest>() {
           @Override
           public void write(JsonWriter out, DeleteUserPoolDomainRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteUserPoolDomainRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteUserPoolDomainRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteUserPoolDomainRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteUserPoolDomainRequest
   */
  public static DeleteUserPoolDomainRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteUserPoolDomainRequest.class);
  }

  /**
   * Convert an instance of DeleteUserPoolDomainRequest to an JSON string
   *
   * @return JSON string
   */
