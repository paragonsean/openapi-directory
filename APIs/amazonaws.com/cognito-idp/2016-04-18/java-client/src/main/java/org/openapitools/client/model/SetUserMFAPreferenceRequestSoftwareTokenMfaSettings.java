...
public class SetUserMFAPreferenceRequestSoftwareTokenMfaSettings {
  ...
  public SetUserMFAPreferenceRequestSoftwareTokenMfaSettings() {
  }

  public SetUserMFAPreferenceRequestSoftwareTokenMfaSettings enabled(Boolean enabled) {
  ...
  public SetUserMFAPreferenceRequestSoftwareTokenMfaSettings preferredMfa(Boolean preferredMfa) {
  ...
  public boolean equals(Object o) {
    ...
    SetUserMFAPreferenceRequestSoftwareTokenMfaSettings setUserMFAPreferenceRequestSoftwareTokenMfaSettings = (SetUserMFAPreferenceRequestSoftwareTokenMfaSettings) o;
    return Objects.equals(this.enabled, setUserMFAPreferenceRequestSoftwareTokenMfaSettings.enabled) &&
        Objects.equals(this.preferredMfa, setUserMFAPreferenceRequestSoftwareTokenMfaSettings.preferredMfa);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetUserMFAPreferenceRequestSoftwareTokenMfaSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetUserMFAPreferenceRequestSoftwareTokenMfaSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetUserMFAPreferenceRequestSoftwareTokenMfaSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetUserMFAPreferenceRequestSoftwareTokenMfaSettings is not found in the empty JSON string", SetUserMFAPreferenceRequestSoftwareTokenMfaSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetUserMFAPreferenceRequestSoftwareTokenMfaSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetUserMFAPreferenceRequestSoftwareTokenMfaSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetUserMFAPreferenceRequestSoftwareTokenMfaSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetUserMFAPreferenceRequestSoftwareTokenMfaSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetUserMFAPreferenceRequestSoftwareTokenMfaSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetUserMFAPreferenceRequestSoftwareTokenMfaSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<SetUserMFAPreferenceRequestSoftwareTokenMfaSettings>() {
           @Override
           public void write(JsonWriter out, SetUserMFAPreferenceRequestSoftwareTokenMfaSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetUserMFAPreferenceRequestSoftwareTokenMfaSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetUserMFAPreferenceRequestSoftwareTokenMfaSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetUserMFAPreferenceRequestSoftwareTokenMfaSettings
   * @throws IOException if the JSON string is invalid with respect to SetUserMFAPreferenceRequestSoftwareTokenMfaSettings
   */
  public static SetUserMFAPreferenceRequestSoftwareTokenMfaSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetUserMFAPreferenceRequestSoftwareTokenMfaSettings.class);
  }

  /**
   * Convert an instance of SetUserMFAPreferenceRequestSoftwareTokenMfaSettings to an JSON string
   *
   * @return JSON string
   */
