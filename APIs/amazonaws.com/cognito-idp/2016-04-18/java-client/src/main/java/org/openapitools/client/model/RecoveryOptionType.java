...
import org.openapitools.client.model.RecoveryOptionNameType;
...
public class RecoveryOptionType {
  ...
  private RecoveryOptionNameType name;

  public RecoveryOptionType() {
  }

  public RecoveryOptionType priority(Integer priority) {
  ...
  public RecoveryOptionType name(RecoveryOptionNameType name) {
    this.name = name;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RecoveryOptionNameType getName() {
    return name;
  }
  ...
  public boolean equals(Object o) {
    ...
    RecoveryOptionType recoveryOptionType = (RecoveryOptionType) o;
    return Objects.equals(this.priority, recoveryOptionType.priority) &&
        Objects.equals(this.name, recoveryOptionType.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecoveryOptionType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RecoveryOptionType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecoveryOptionType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecoveryOptionType is not found in the empty JSON string", RecoveryOptionType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecoveryOptionType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecoveryOptionType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecoveryOptionType.openapiRequiredFields) {
      ...
      RecoveryOptionNameType.validateJsonElement(jsonObj.get("Name"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecoveryOptionType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecoveryOptionType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecoveryOptionType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecoveryOptionType.class));

       return (TypeAdapter<T>) new TypeAdapter<RecoveryOptionType>() {
           @Override
           public void write(JsonWriter out, RecoveryOptionType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RecoveryOptionType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RecoveryOptionType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RecoveryOptionType
   * @throws IOException if the JSON string is invalid with respect to RecoveryOptionType
   */
  public static RecoveryOptionType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecoveryOptionType.class);
  }

  /**
   * Convert an instance of RecoveryOptionType to an JSON string
   *
   * @return JSON string
   */
