...
/**
 * Gets or Sets VerifySoftwareTokenResponseType
 */
@JsonAdapter(VerifySoftwareTokenResponseType.Adapter.class)
public enum VerifySoftwareTokenResponseType {
  ...
  VerifySoftwareTokenResponseType(String value) {
    this.value = value;
  }
  ...
  public static VerifySoftwareTokenResponseType fromValue(String value) {
    for (VerifySoftwareTokenResponseType b : VerifySoftwareTokenResponseType.values()) {
  ...
  public static class Adapter extends TypeAdapter<VerifySoftwareTokenResponseType> {
    @Override
    public void write(final JsonWriter jsonWriter, final VerifySoftwareTokenResponseType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VerifySoftwareTokenResponseType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return VerifySoftwareTokenResponseType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    VerifySoftwareTokenResponseType.fromValue(value);
  }
}
