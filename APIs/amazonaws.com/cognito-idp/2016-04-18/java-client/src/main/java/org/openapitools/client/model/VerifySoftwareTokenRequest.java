...
public class VerifySoftwareTokenRequest {
  ...
  public static final String SERIALIZED_NAME_FRIENDLY_DEVICE_NAME = "FriendlyDeviceName";
  @SerializedName(SERIALIZED_NAME_FRIENDLY_DEVICE_NAME)
  private String friendlyDeviceName;

  public VerifySoftwareTokenRequest() {
  }

  public VerifySoftwareTokenRequest accessToken(String accessToken) {
  ...
  public VerifySoftwareTokenRequest session(String session) {
  ...
  public VerifySoftwareTokenRequest userCode(String userCode) {
  ...
  public VerifySoftwareTokenRequest friendlyDeviceName(String friendlyDeviceName) {
  ...
  public boolean equals(Object o) {
    ...
    VerifySoftwareTokenRequest verifySoftwareTokenRequest = (VerifySoftwareTokenRequest) o;
    return Objects.equals(this.accessToken, verifySoftwareTokenRequest.accessToken) &&
        Objects.equals(this.session, verifySoftwareTokenRequest.session) &&
        Objects.equals(this.userCode, verifySoftwareTokenRequest.userCode) &&
        Objects.equals(this.friendlyDeviceName, verifySoftwareTokenRequest.friendlyDeviceName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, session, userCode, friendlyDeviceName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VerifySoftwareTokenRequest {\n");
    sb.append("    accessToken: ").append(toIndentedString(accessToken)).append("\n");
    sb.append("    session: ").append(toIndentedString(session)).append("\n");
    sb.append("    userCode: ").append(toIndentedString(userCode)).append("\n");
    sb.append("    friendlyDeviceName: ").append(toIndentedString(friendlyDeviceName)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("FriendlyDeviceName");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VerifySoftwareTokenRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerifySoftwareTokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VerifySoftwareTokenRequest is not found in the empty JSON string", VerifySoftwareTokenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerifySoftwareTokenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VerifySoftwareTokenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VerifySoftwareTokenRequest.openapiRequiredFields) {
      ...
      // validate the optional field `FriendlyDeviceName`
      if (jsonObj.get("FriendlyDeviceName") != null && !jsonObj.get("FriendlyDeviceName").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("FriendlyDeviceName"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerifySoftwareTokenRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerifySoftwareTokenRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerifySoftwareTokenRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerifySoftwareTokenRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VerifySoftwareTokenRequest>() {
           @Override
           public void write(JsonWriter out, VerifySoftwareTokenRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VerifySoftwareTokenRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VerifySoftwareTokenRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VerifySoftwareTokenRequest
   * @throws IOException if the JSON string is invalid with respect to VerifySoftwareTokenRequest
   */
  public static VerifySoftwareTokenRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerifySoftwareTokenRequest.class);
  }

  /**
   * Convert an instance of VerifySoftwareTokenRequest to an JSON string
   *
   * @return JSON string
   */
