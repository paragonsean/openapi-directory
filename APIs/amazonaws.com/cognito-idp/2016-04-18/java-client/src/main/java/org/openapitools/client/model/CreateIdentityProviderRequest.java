...
public class CreateIdentityProviderRequest {
  ...
  public CreateIdentityProviderRequest userPoolId(String userPoolId) {
  ...
  public CreateIdentityProviderRequest providerName(String providerName) {
  ...
  public CreateIdentityProviderRequest providerType(IdentityProviderTypeType providerType) {
  ...
  public CreateIdentityProviderRequest providerDetails(Map providerDetails) {
  ...
  public CreateIdentityProviderRequest attributeMapping(Map attributeMapping) {
  ...
  public CreateIdentityProviderRequest idpIdentifiers(List idpIdentifiers) {
  ...
  public boolean equals(Object o) {
    ...
    CreateIdentityProviderRequest createIdentityProviderRequest = (CreateIdentityProviderRequest) o;
    return Objects.equals(this.userPoolId, createIdentityProviderRequest.userPoolId) &&
        Objects.equals(this.providerName, createIdentityProviderRequest.providerName) &&
        Objects.equals(this.providerType, createIdentityProviderRequest.providerType) &&
        Objects.equals(this.providerDetails, createIdentityProviderRequest.providerDetails) &&
        Objects.equals(this.attributeMapping, createIdentityProviderRequest.attributeMapping) &&
        Objects.equals(this.idpIdentifiers, createIdentityProviderRequest.idpIdentifiers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, providerName, providerType, providerDetails, attributeMapping, idpIdentifiers);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateIdentityProviderRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("ProviderDetails");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateIdentityProviderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateIdentityProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateIdentityProviderRequest is not found in the empty JSON string", CreateIdentityProviderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateIdentityProviderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateIdentityProviderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateIdentityProviderRequest.openapiRequiredFields) {
      ...
      // validate the required field `ProviderDetails`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateIdentityProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateIdentityProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateIdentityProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateIdentityProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateIdentityProviderRequest>() {
           @Override
           public void write(JsonWriter out, CreateIdentityProviderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateIdentityProviderRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateIdentityProviderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateIdentityProviderRequest
   * @throws IOException if the JSON string is invalid with respect to CreateIdentityProviderRequest
   */
  public static CreateIdentityProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateIdentityProviderRequest.class);
  }

  /**
   * Convert an instance of CreateIdentityProviderRequest to an JSON string
   *
   * @return JSON string
   */
