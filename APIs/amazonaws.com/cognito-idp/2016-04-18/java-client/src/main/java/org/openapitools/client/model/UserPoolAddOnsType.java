...
public class UserPoolAddOnsType {
  ...
  public UserPoolAddOnsType advancedSecurityMode(AdvancedSecurityModeType advancedSecurityMode) {
  ...
  public boolean equals(Object o) {
    ...
    UserPoolAddOnsType userPoolAddOnsType = (UserPoolAddOnsType) o;
    return Objects.equals(this.advancedSecurityMode, userPoolAddOnsType.advancedSecurityMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserPoolAddOnsType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserPoolAddOnsType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPoolAddOnsType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserPoolAddOnsType is not found in the empty JSON string", UserPoolAddOnsType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserPoolAddOnsType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserPoolAddOnsType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserPoolAddOnsType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserPoolAddOnsType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserPoolAddOnsType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserPoolAddOnsType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserPoolAddOnsType.class));

       return (TypeAdapter<T>) new TypeAdapter<UserPoolAddOnsType>() {
           @Override
           public void write(JsonWriter out, UserPoolAddOnsType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserPoolAddOnsType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserPoolAddOnsType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserPoolAddOnsType
   * @throws IOException if the JSON string is invalid with respect to UserPoolAddOnsType
   */
  public static UserPoolAddOnsType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserPoolAddOnsType.class);
  }

  /**
   * Convert an instance of UserPoolAddOnsType to an JSON string
   *
   * @return JSON string
   */
