...
public class AccountTakeoverActionsTypeMediumAction {
  ...
  public AccountTakeoverActionsTypeMediumAction() {
  }

  public AccountTakeoverActionsTypeMediumAction notify(Boolean notify) {
    this.notify = notify;
    return this;
  }
  ...
  public AccountTakeoverActionsTypeMediumAction eventAction(AccountTakeoverEventActionType eventAction) {
  ...
  public boolean equals(Object o) {
    ...
    AccountTakeoverActionsTypeMediumAction accountTakeoverActionsTypeMediumAction = (AccountTakeoverActionsTypeMediumAction) o;
    return Objects.equals(this.notify, accountTakeoverActionsTypeMediumAction.notify) &&
        Objects.equals(this.eventAction, accountTakeoverActionsTypeMediumAction.eventAction);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountTakeoverActionsTypeMediumAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountTakeoverActionsTypeMediumAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountTakeoverActionsTypeMediumAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountTakeoverActionsTypeMediumAction is not found in the empty JSON string", AccountTakeoverActionsTypeMediumAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountTakeoverActionsTypeMediumAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountTakeoverActionsTypeMediumAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountTakeoverActionsTypeMediumAction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountTakeoverActionsTypeMediumAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountTakeoverActionsTypeMediumAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountTakeoverActionsTypeMediumAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountTakeoverActionsTypeMediumAction.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountTakeoverActionsTypeMediumAction>() {
           @Override
           public void write(JsonWriter out, AccountTakeoverActionsTypeMediumAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountTakeoverActionsTypeMediumAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountTakeoverActionsTypeMediumAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountTakeoverActionsTypeMediumAction
   * @throws IOException if the JSON string is invalid with respect to AccountTakeoverActionsTypeMediumAction
   */
  public static AccountTakeoverActionsTypeMediumAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountTakeoverActionsTypeMediumAction.class);
  }

  /**
   * Convert an instance of AccountTakeoverActionsTypeMediumAction to an JSON string
   *
   * @return JSON string
   */
