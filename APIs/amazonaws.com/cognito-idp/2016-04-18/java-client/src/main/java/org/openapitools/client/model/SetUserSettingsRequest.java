...
public class SetUserSettingsRequest {
  ...
  public SetUserSettingsRequest accessToken(String accessToken) {
  ...
  public SetUserSettingsRequest mfAOptions(List mfAOptions) {
  ...
  public boolean equals(Object o) {
    ...
    SetUserSettingsRequest setUserSettingsRequest = (SetUserSettingsRequest) o;
    return Objects.equals(this.accessToken, setUserSettingsRequest.accessToken) &&
        Objects.equals(this.mfAOptions, setUserSettingsRequest.mfAOptions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, mfAOptions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetUserSettingsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetUserSettingsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetUserSettingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetUserSettingsRequest is not found in the empty JSON string", SetUserSettingsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetUserSettingsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetUserSettingsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetUserSettingsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetUserSettingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetUserSettingsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetUserSettingsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetUserSettingsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SetUserSettingsRequest>() {
           @Override
           public void write(JsonWriter out, SetUserSettingsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetUserSettingsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetUserSettingsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetUserSettingsRequest
   * @throws IOException if the JSON string is invalid with respect to SetUserSettingsRequest
   */
  public static SetUserSettingsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetUserSettingsRequest.class);
  }

  /**
   * Convert an instance of SetUserSettingsRequest to an JSON string
   *
   * @return JSON string
   */
