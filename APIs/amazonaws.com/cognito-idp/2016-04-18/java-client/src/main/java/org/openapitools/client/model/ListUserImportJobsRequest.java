...
public class ListUserImportJobsRequest {
  ...
  public ListUserImportJobsRequest userPoolId(String userPoolId) {
  ...
  public ListUserImportJobsRequest maxResults(Integer maxResults) {
  ...
  public ListUserImportJobsRequest paginationToken(String paginationToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListUserImportJobsRequest listUserImportJobsRequest = (ListUserImportJobsRequest) o;
    return Objects.equals(this.userPoolId, listUserImportJobsRequest.userPoolId) &&
        Objects.equals(this.maxResults, listUserImportJobsRequest.maxResults) &&
        Objects.equals(this.paginationToken, listUserImportJobsRequest.paginationToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, maxResults, paginationToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListUserImportJobsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListUserImportJobsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListUserImportJobsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListUserImportJobsRequest is not found in the empty JSON string", ListUserImportJobsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListUserImportJobsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListUserImportJobsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListUserImportJobsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListUserImportJobsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListUserImportJobsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListUserImportJobsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListUserImportJobsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListUserImportJobsRequest>() {
           @Override
           public void write(JsonWriter out, ListUserImportJobsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListUserImportJobsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListUserImportJobsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListUserImportJobsRequest
   * @throws IOException if the JSON string is invalid with respect to ListUserImportJobsRequest
   */
  public static ListUserImportJobsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUserImportJobsRequest.class);
  }

  /**
   * Convert an instance of ListUserImportJobsRequest to an JSON string
   *
   * @return JSON string
   */
