...
public class ListUserPoolClientsRequest {
  ...
  public ListUserPoolClientsRequest userPoolId(String userPoolId) {
  ...
  public ListUserPoolClientsRequest maxResults(Integer maxResults) {
  ...
  public ListUserPoolClientsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolId, listUserPoolClientsRequest.userPoolId) &&
        Objects.equals(this.maxResults, listUserPoolClientsRequest.maxResults) &&
        Objects.equals(this.nextToken, listUserPoolClientsRequest.nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListUserPoolClientsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListUserPoolClientsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListUserPoolClientsRequest is not found in the empty JSON string", ListUserPoolClientsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListUserPoolClientsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListUserPoolClientsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListUserPoolClientsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListUserPoolClientsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListUserPoolClientsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListUserPoolClientsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListUserPoolClientsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListUserPoolClientsRequest>() {
           @Override
           public void write(JsonWriter out, ListUserPoolClientsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListUserPoolClientsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListUserPoolClientsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListUserPoolClientsRequest
   * @throws IOException if the JSON string is invalid with respect to ListUserPoolClientsRequest
   */
  public static ListUserPoolClientsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUserPoolClientsRequest.class);
  }

  /**
   * Convert an instance of ListUserPoolClientsRequest to an JSON string
   *
   * @return JSON string
   */
