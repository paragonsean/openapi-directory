...
public class CreateUserPoolRequestPolicies {
  ...
  public CreateUserPoolRequestPolicies() {
  }

  public CreateUserPoolRequestPolicies passwordPolicy(UserPoolPolicyTypePasswordPolicy passwordPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUserPoolRequestPolicies createUserPoolRequestPolicies = (CreateUserPoolRequestPolicies) o;
    return Objects.equals(this.passwordPolicy, createUserPoolRequestPolicies.passwordPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUserPoolRequestPolicies {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolRequestPolicies
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolRequestPolicies.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolRequestPolicies is not found in the empty JSON string", CreateUserPoolRequestPolicies.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolRequestPolicies.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolRequestPolicies` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolRequestPolicies.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolRequestPolicies' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolRequestPolicies> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolRequestPolicies.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolRequestPolicies>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolRequestPolicies value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolRequestPolicies read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolRequestPolicies given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolRequestPolicies
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolRequestPolicies
   */
  public static CreateUserPoolRequestPolicies fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolRequestPolicies.class);
  }

  /**
   * Convert an instance of CreateUserPoolRequestPolicies to an JSON string
   *
   * @return JSON string
   */
