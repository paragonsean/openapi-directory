...
public class GetSigningCertificateRequest {
  ...
  public GetSigningCertificateRequest userPoolId(String userPoolId) {
  ...
  public boolean equals(Object o) {
    ...
    GetSigningCertificateRequest getSigningCertificateRequest = (GetSigningCertificateRequest) o;
    return Objects.equals(this.userPoolId, getSigningCertificateRequest.userPoolId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSigningCertificateRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSigningCertificateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSigningCertificateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSigningCertificateRequest is not found in the empty JSON string", GetSigningCertificateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSigningCertificateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSigningCertificateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetSigningCertificateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSigningCertificateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSigningCertificateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSigningCertificateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSigningCertificateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSigningCertificateRequest>() {
           @Override
           public void write(JsonWriter out, GetSigningCertificateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSigningCertificateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSigningCertificateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSigningCertificateRequest
   * @throws IOException if the JSON string is invalid with respect to GetSigningCertificateRequest
   */
  public static GetSigningCertificateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSigningCertificateRequest.class);
  }

  /**
   * Convert an instance of GetSigningCertificateRequest to an JSON string
   *
   * @return JSON string
   */
