...
public class CompromisedCredentialsActionsType {
  ...
  public CompromisedCredentialsActionsType eventAction(CompromisedCredentialsEventActionType eventAction) {
  ...
  public boolean equals(Object o) {
    ...
    CompromisedCredentialsActionsType compromisedCredentialsActionsType = (CompromisedCredentialsActionsType) o;
    return Objects.equals(this.eventAction, compromisedCredentialsActionsType.eventAction);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompromisedCredentialsActionsType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompromisedCredentialsActionsType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompromisedCredentialsActionsType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompromisedCredentialsActionsType is not found in the empty JSON string", CompromisedCredentialsActionsType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompromisedCredentialsActionsType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompromisedCredentialsActionsType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompromisedCredentialsActionsType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompromisedCredentialsActionsType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompromisedCredentialsActionsType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompromisedCredentialsActionsType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompromisedCredentialsActionsType.class));

       return (TypeAdapter<T>) new TypeAdapter<CompromisedCredentialsActionsType>() {
           @Override
           public void write(JsonWriter out, CompromisedCredentialsActionsType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompromisedCredentialsActionsType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompromisedCredentialsActionsType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompromisedCredentialsActionsType
   * @throws IOException if the JSON string is invalid with respect to CompromisedCredentialsActionsType
   */
  public static CompromisedCredentialsActionsType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompromisedCredentialsActionsType.class);
  }

  /**
   * Convert an instance of CompromisedCredentialsActionsType to an JSON string
   *
   * @return JSON string
   */
