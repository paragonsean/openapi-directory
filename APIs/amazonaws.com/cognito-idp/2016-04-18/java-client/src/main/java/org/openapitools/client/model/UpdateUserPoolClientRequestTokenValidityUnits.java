...
public class UpdateUserPoolClientRequestTokenValidityUnits {
  ...
  public UpdateUserPoolClientRequestTokenValidityUnits() {
  }

  public UpdateUserPoolClientRequestTokenValidityUnits accessToken(TimeUnitsType accessToken) {
  ...
  public UpdateUserPoolClientRequestTokenValidityUnits idToken(TimeUnitsType idToken) {
  ...
  public UpdateUserPoolClientRequestTokenValidityUnits refreshToken(TimeUnitsType refreshToken) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateUserPoolClientRequestTokenValidityUnits updateUserPoolClientRequestTokenValidityUnits = (UpdateUserPoolClientRequestTokenValidityUnits) o;
    return Objects.equals(this.accessToken, updateUserPoolClientRequestTokenValidityUnits.accessToken) &&
        Objects.equals(this.idToken, updateUserPoolClientRequestTokenValidityUnits.idToken) &&
        Objects.equals(this.refreshToken, updateUserPoolClientRequestTokenValidityUnits.refreshToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateUserPoolClientRequestTokenValidityUnits {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserPoolClientRequestTokenValidityUnits
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserPoolClientRequestTokenValidityUnits.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserPoolClientRequestTokenValidityUnits is not found in the empty JSON string", UpdateUserPoolClientRequestTokenValidityUnits.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserPoolClientRequestTokenValidityUnits.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserPoolClientRequestTokenValidityUnits` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserPoolClientRequestTokenValidityUnits.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserPoolClientRequestTokenValidityUnits' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserPoolClientRequestTokenValidityUnits> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserPoolClientRequestTokenValidityUnits.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserPoolClientRequestTokenValidityUnits>() {
           @Override
           public void write(JsonWriter out, UpdateUserPoolClientRequestTokenValidityUnits value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserPoolClientRequestTokenValidityUnits read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserPoolClientRequestTokenValidityUnits given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserPoolClientRequestTokenValidityUnits
   * @throws IOException if the JSON string is invalid with respect to UpdateUserPoolClientRequestTokenValidityUnits
   */
  public static UpdateUserPoolClientRequestTokenValidityUnits fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserPoolClientRequestTokenValidityUnits.class);
  }

  /**
   * Convert an instance of UpdateUserPoolClientRequestTokenValidityUnits to an JSON string
   *
   * @return JSON string
   */
