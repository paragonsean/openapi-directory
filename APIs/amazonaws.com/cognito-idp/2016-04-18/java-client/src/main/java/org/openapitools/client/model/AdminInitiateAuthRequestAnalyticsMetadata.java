...
public class AdminInitiateAuthRequestAnalyticsMetadata {
  ...
  public AdminInitiateAuthRequestAnalyticsMetadata() {
  }

  public AdminInitiateAuthRequestAnalyticsMetadata analyticsEndpointId(String analyticsEndpointId) {
  ...
  public boolean equals(Object o) {
    ...
    AdminInitiateAuthRequestAnalyticsMetadata adminInitiateAuthRequestAnalyticsMetadata = (AdminInitiateAuthRequestAnalyticsMetadata) o;
    return Objects.equals(this.analyticsEndpointId, adminInitiateAuthRequestAnalyticsMetadata.analyticsEndpointId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdminInitiateAuthRequestAnalyticsMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminInitiateAuthRequestAnalyticsMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminInitiateAuthRequestAnalyticsMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminInitiateAuthRequestAnalyticsMetadata is not found in the empty JSON string", AdminInitiateAuthRequestAnalyticsMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminInitiateAuthRequestAnalyticsMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminInitiateAuthRequestAnalyticsMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminInitiateAuthRequestAnalyticsMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminInitiateAuthRequestAnalyticsMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminInitiateAuthRequestAnalyticsMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminInitiateAuthRequestAnalyticsMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminInitiateAuthRequestAnalyticsMetadata>() {
           @Override
           public void write(JsonWriter out, AdminInitiateAuthRequestAnalyticsMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminInitiateAuthRequestAnalyticsMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminInitiateAuthRequestAnalyticsMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminInitiateAuthRequestAnalyticsMetadata
   * @throws IOException if the JSON string is invalid with respect to AdminInitiateAuthRequestAnalyticsMetadata
   */
  public static AdminInitiateAuthRequestAnalyticsMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminInitiateAuthRequestAnalyticsMetadata.class);
  }

  /**
   * Convert an instance of AdminInitiateAuthRequestAnalyticsMetadata to an JSON string
   *
   * @return JSON string
   */
