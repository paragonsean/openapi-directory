...
public class ForgotPasswordRequestAnalyticsMetadata {
  ...
  public ForgotPasswordRequestAnalyticsMetadata() {
  }

  public ForgotPasswordRequestAnalyticsMetadata analyticsEndpointId(String analyticsEndpointId) {
  ...
  public boolean equals(Object o) {
    ...
    ForgotPasswordRequestAnalyticsMetadata forgotPasswordRequestAnalyticsMetadata = (ForgotPasswordRequestAnalyticsMetadata) o;
    return Objects.equals(this.analyticsEndpointId, forgotPasswordRequestAnalyticsMetadata.analyticsEndpointId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForgotPasswordRequestAnalyticsMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ForgotPasswordRequestAnalyticsMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForgotPasswordRequestAnalyticsMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ForgotPasswordRequestAnalyticsMetadata is not found in the empty JSON string", ForgotPasswordRequestAnalyticsMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ForgotPasswordRequestAnalyticsMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ForgotPasswordRequestAnalyticsMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ForgotPasswordRequestAnalyticsMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ForgotPasswordRequestAnalyticsMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ForgotPasswordRequestAnalyticsMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ForgotPasswordRequestAnalyticsMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ForgotPasswordRequestAnalyticsMetadata>() {
           @Override
           public void write(JsonWriter out, ForgotPasswordRequestAnalyticsMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ForgotPasswordRequestAnalyticsMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ForgotPasswordRequestAnalyticsMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ForgotPasswordRequestAnalyticsMetadata
   * @throws IOException if the JSON string is invalid with respect to ForgotPasswordRequestAnalyticsMetadata
   */
  public static ForgotPasswordRequestAnalyticsMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ForgotPasswordRequestAnalyticsMetadata.class);
  }

  /**
   * Convert an instance of ForgotPasswordRequestAnalyticsMetadata to an JSON string
   *
   * @return JSON string
   */
