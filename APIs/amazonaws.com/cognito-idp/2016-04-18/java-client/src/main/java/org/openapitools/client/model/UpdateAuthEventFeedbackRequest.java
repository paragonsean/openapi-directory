...
public class UpdateAuthEventFeedbackRequest {
  ...
  public UpdateAuthEventFeedbackRequest userPoolId(String userPoolId) {
  ...
  public UpdateAuthEventFeedbackRequest username(String username) {
  ...
  public UpdateAuthEventFeedbackRequest eventId(String eventId) {
  ...
  public UpdateAuthEventFeedbackRequest feedbackToken(String feedbackToken) {
  ...
  public UpdateAuthEventFeedbackRequest feedbackValue(FeedbackValueType feedbackValue) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateAuthEventFeedbackRequest updateAuthEventFeedbackRequest = (UpdateAuthEventFeedbackRequest) o;
    return Objects.equals(this.userPoolId, updateAuthEventFeedbackRequest.userPoolId) &&
        Objects.equals(this.username, updateAuthEventFeedbackRequest.username) &&
        Objects.equals(this.eventId, updateAuthEventFeedbackRequest.eventId) &&
        Objects.equals(this.feedbackToken, updateAuthEventFeedbackRequest.feedbackToken) &&
        Objects.equals(this.feedbackValue, updateAuthEventFeedbackRequest.feedbackValue);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username, eventId, feedbackToken, feedbackValue);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateAuthEventFeedbackRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("FeedbackToken");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAuthEventFeedbackRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAuthEventFeedbackRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAuthEventFeedbackRequest is not found in the empty JSON string", UpdateAuthEventFeedbackRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAuthEventFeedbackRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAuthEventFeedbackRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateAuthEventFeedbackRequest.openapiRequiredFields) {
      ...
      // validate the required field `FeedbackToken`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAuthEventFeedbackRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAuthEventFeedbackRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAuthEventFeedbackRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAuthEventFeedbackRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAuthEventFeedbackRequest>() {
           @Override
           public void write(JsonWriter out, UpdateAuthEventFeedbackRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAuthEventFeedbackRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAuthEventFeedbackRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAuthEventFeedbackRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateAuthEventFeedbackRequest
   */
  public static UpdateAuthEventFeedbackRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAuthEventFeedbackRequest.class);
  }

  /**
   * Convert an instance of UpdateAuthEventFeedbackRequest to an JSON string
   *
   * @return JSON string
   */
