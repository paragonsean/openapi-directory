...
/**
 * Gets or Sets OAuthFlowType
 */
@JsonAdapter(OAuthFlowType.Adapter.class)
public enum OAuthFlowType {
  ...
  public static class Adapter extends TypeAdapter<OAuthFlowType> {
    @Override
    public void write(final JsonWriter jsonWriter, final OAuthFlowType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OAuthFlowType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OAuthFlowType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OAuthFlowType.fromValue(value);
  }
}
