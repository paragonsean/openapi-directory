...
public class UpdateUserPoolClientResponse {
  ...
  private UpdateUserPoolClientResponseUserPoolClient userPoolClient;

  public UpdateUserPoolClientResponse() {
  }

  public UpdateUserPoolClientResponse userPoolClient(UpdateUserPoolClientResponseUserPoolClient userPoolClient) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient getUserPoolClient() {
    return userPoolClient;
  }

  public void setUserPoolClient(UpdateUserPoolClientResponseUserPoolClient userPoolClient) {
    this.userPoolClient = userPoolClient;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolClient, updateUserPoolClientResponse.userPoolClient);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserPoolClientResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserPoolClientResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserPoolClientResponse is not found in the empty JSON string", UpdateUserPoolClientResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserPoolClientResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserPoolClientResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("UserPoolClient") != null && !jsonObj.get("UserPoolClient").isJsonNull()) {
        UpdateUserPoolClientResponseUserPoolClient.validateJsonElement(jsonObj.get("UserPoolClient"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserPoolClientResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserPoolClientResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserPoolClientResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserPoolClientResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserPoolClientResponse>() {
           @Override
           public void write(JsonWriter out, UpdateUserPoolClientResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserPoolClientResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserPoolClientResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserPoolClientResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateUserPoolClientResponse
   */
  public static UpdateUserPoolClientResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserPoolClientResponse.class);
  }

  /**
   * Convert an instance of UpdateUserPoolClientResponse to an JSON string
   *
   * @return JSON string
   */
