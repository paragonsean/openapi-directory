...
/**
 * Gets or Sets RiskDecisionType
 */
@JsonAdapter(RiskDecisionType.Adapter.class)
public enum RiskDecisionType {
  ...
  public static RiskDecisionType fromValue(String value) {
    for (RiskDecisionType b : RiskDecisionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<RiskDecisionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final RiskDecisionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RiskDecisionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RiskDecisionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RiskDecisionType.fromValue(value);
  }
}
