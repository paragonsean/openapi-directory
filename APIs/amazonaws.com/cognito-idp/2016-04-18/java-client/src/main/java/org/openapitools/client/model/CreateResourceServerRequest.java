...
public class CreateResourceServerRequest {
  ...
  public CreateResourceServerRequest userPoolId(String userPoolId) {
  ...
  public CreateResourceServerRequest identifier(String identifier) {
  ...
  public CreateResourceServerRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateResourceServerRequest scopes(List scopes) {
    this.scopes = scopes;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateResourceServerRequest createResourceServerRequest = (CreateResourceServerRequest) o;
    return Objects.equals(this.userPoolId, createResourceServerRequest.userPoolId) &&
        Objects.equals(this.identifier, createResourceServerRequest.identifier) &&
        Objects.equals(this.name, createResourceServerRequest.name) &&
        Objects.equals(this.scopes, createResourceServerRequest.scopes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateResourceServerRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateResourceServerRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateResourceServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateResourceServerRequest is not found in the empty JSON string", CreateResourceServerRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateResourceServerRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateResourceServerRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateResourceServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateResourceServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateResourceServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateResourceServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateResourceServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateResourceServerRequest>() {
           @Override
           public void write(JsonWriter out, CreateResourceServerRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateResourceServerRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateResourceServerRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateResourceServerRequest
   * @throws IOException if the JSON string is invalid with respect to CreateResourceServerRequest
   */
  public static CreateResourceServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateResourceServerRequest.class);
  }

  /**
   * Convert an instance of CreateResourceServerRequest to an JSON string
   *
   * @return JSON string
   */
