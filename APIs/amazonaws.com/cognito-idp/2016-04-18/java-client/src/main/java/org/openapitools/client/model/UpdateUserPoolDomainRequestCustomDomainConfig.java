...
public class UpdateUserPoolDomainRequestCustomDomainConfig {
  ...
  public UpdateUserPoolDomainRequestCustomDomainConfig() {
  }

  public UpdateUserPoolDomainRequestCustomDomainConfig certificateArn(String certificateArn) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateUserPoolDomainRequestCustomDomainConfig updateUserPoolDomainRequestCustomDomainConfig = (UpdateUserPoolDomainRequestCustomDomainConfig) o;
    return Objects.equals(this.certificateArn, updateUserPoolDomainRequestCustomDomainConfig.certificateArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateUserPoolDomainRequestCustomDomainConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserPoolDomainRequestCustomDomainConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserPoolDomainRequestCustomDomainConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserPoolDomainRequestCustomDomainConfig is not found in the empty JSON string", UpdateUserPoolDomainRequestCustomDomainConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserPoolDomainRequestCustomDomainConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserPoolDomainRequestCustomDomainConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateUserPoolDomainRequestCustomDomainConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserPoolDomainRequestCustomDomainConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserPoolDomainRequestCustomDomainConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserPoolDomainRequestCustomDomainConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserPoolDomainRequestCustomDomainConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserPoolDomainRequestCustomDomainConfig>() {
           @Override
           public void write(JsonWriter out, UpdateUserPoolDomainRequestCustomDomainConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserPoolDomainRequestCustomDomainConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserPoolDomainRequestCustomDomainConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserPoolDomainRequestCustomDomainConfig
   * @throws IOException if the JSON string is invalid with respect to UpdateUserPoolDomainRequestCustomDomainConfig
   */
  public static UpdateUserPoolDomainRequestCustomDomainConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserPoolDomainRequestCustomDomainConfig.class);
  }

  /**
   * Convert an instance of UpdateUserPoolDomainRequestCustomDomainConfig to an JSON string
   *
   * @return JSON string
   */
