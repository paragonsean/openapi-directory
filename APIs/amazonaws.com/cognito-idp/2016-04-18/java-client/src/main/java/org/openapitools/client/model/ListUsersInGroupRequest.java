...
public class ListUsersInGroupRequest {
  ...
  public ListUsersInGroupRequest userPoolId(String userPoolId) {
  ...
  public ListUsersInGroupRequest groupName(String groupName) {
  ...
  public ListUsersInGroupRequest limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolId, listUsersInGroupRequest.userPoolId) &&
        Objects.equals(this.groupName, listUsersInGroupRequest.groupName) &&
        Objects.equals(this.limit, listUsersInGroupRequest.limit) &&
        Objects.equals(this.nextToken, listUsersInGroupRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, groupName, limit, nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListUsersInGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListUsersInGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListUsersInGroupRequest is not found in the empty JSON string", ListUsersInGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListUsersInGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListUsersInGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListUsersInGroupRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListUsersInGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListUsersInGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListUsersInGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListUsersInGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListUsersInGroupRequest>() {
           @Override
           public void write(JsonWriter out, ListUsersInGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListUsersInGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListUsersInGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListUsersInGroupRequest
   * @throws IOException if the JSON string is invalid with respect to ListUsersInGroupRequest
   */
  public static ListUsersInGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUsersInGroupRequest.class);
  }

  /**
   * Convert an instance of ListUsersInGroupRequest to an JSON string
   *
   * @return JSON string
   */
