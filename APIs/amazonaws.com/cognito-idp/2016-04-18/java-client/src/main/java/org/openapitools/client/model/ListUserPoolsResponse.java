...
public class ListUserPoolsResponse {
  public static final String SERIALIZED_NAME_USER_POOLS = "UserPools";
  @SerializedName(SERIALIZED_NAME_USER_POOLS)
  ...
  public ListUserPoolsResponse userPools(List userPools) {
  ...
  public void setUserPools(List userPools) {
    this.userPools = userPools;
  }


  public ListUserPoolsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPools, listUserPoolsResponse.userPools) &&
        Objects.equals(this.nextToken, listUserPoolsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPools, nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("    userPools: ").append(toIndentedString(userPools)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListUserPoolsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListUserPoolsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListUserPoolsResponse is not found in the empty JSON string", ListUserPoolsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListUserPoolsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListUserPoolsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `UserPools`
      if (jsonObj.get("UserPools") != null && !jsonObj.get("UserPools").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("UserPools"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListUserPoolsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListUserPoolsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListUserPoolsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListUserPoolsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListUserPoolsResponse>() {
           @Override
           public void write(JsonWriter out, ListUserPoolsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListUserPoolsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListUserPoolsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListUserPoolsResponse
   * @throws IOException if the JSON string is invalid with respect to ListUserPoolsResponse
   */
  public static ListUserPoolsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUserPoolsResponse.class);
  }

  /**
   * Convert an instance of ListUserPoolsResponse to an JSON string
   *
   * @return JSON string
   */
