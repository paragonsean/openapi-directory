...
public class AnalyticsConfigurationType {
  ...
  public AnalyticsConfigurationType applicationId(String applicationId) {
  ...
  public AnalyticsConfigurationType applicationArn(String applicationArn) {
  ...
  public AnalyticsConfigurationType roleArn(String roleArn) {
  ...
  public AnalyticsConfigurationType externalId(String externalId) {
  ...
  public AnalyticsConfigurationType userDataShared(Boolean userDataShared) {
  ...
  public boolean equals(Object o) {
    ...
    AnalyticsConfigurationType analyticsConfigurationType = (AnalyticsConfigurationType) o;
    return Objects.equals(this.applicationId, analyticsConfigurationType.applicationId) &&
        Objects.equals(this.applicationArn, analyticsConfigurationType.applicationArn) &&
        Objects.equals(this.roleArn, analyticsConfigurationType.roleArn) &&
        Objects.equals(this.externalId, analyticsConfigurationType.externalId) &&
        Objects.equals(this.userDataShared, analyticsConfigurationType.userDataShared);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnalyticsConfigurationType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnalyticsConfigurationType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnalyticsConfigurationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnalyticsConfigurationType is not found in the empty JSON string", AnalyticsConfigurationType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AnalyticsConfigurationType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnalyticsConfigurationType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnalyticsConfigurationType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnalyticsConfigurationType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnalyticsConfigurationType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnalyticsConfigurationType.class));

       return (TypeAdapter<T>) new TypeAdapter<AnalyticsConfigurationType>() {
           @Override
           public void write(JsonWriter out, AnalyticsConfigurationType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnalyticsConfigurationType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AnalyticsConfigurationType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnalyticsConfigurationType
   * @throws IOException if the JSON string is invalid with respect to AnalyticsConfigurationType
   */
  public static AnalyticsConfigurationType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnalyticsConfigurationType.class);
  }

  /**
   * Convert an instance of AnalyticsConfigurationType to an JSON string
   *
   * @return JSON string
   */
