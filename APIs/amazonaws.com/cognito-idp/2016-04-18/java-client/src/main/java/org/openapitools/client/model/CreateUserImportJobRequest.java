...
public class CreateUserImportJobRequest {
  ...
  public CreateUserImportJobRequest jobName(String jobName) {
  ...
  public CreateUserImportJobRequest userPoolId(String userPoolId) {
  ...
  public CreateUserImportJobRequest cloudWatchLogsRoleArn(String cloudWatchLogsRoleArn) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUserImportJobRequest createUserImportJobRequest = (CreateUserImportJobRequest) o;
    return Objects.equals(this.jobName, createUserImportJobRequest.jobName) &&
        Objects.equals(this.userPoolId, createUserImportJobRequest.userPoolId) &&
        Objects.equals(this.cloudWatchLogsRoleArn, createUserImportJobRequest.cloudWatchLogsRoleArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobName, userPoolId, cloudWatchLogsRoleArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateUserImportJobRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserImportJobRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserImportJobRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserImportJobRequest is not found in the empty JSON string", CreateUserImportJobRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserImportJobRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserImportJobRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateUserImportJobRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserImportJobRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserImportJobRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserImportJobRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserImportJobRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserImportJobRequest>() {
           @Override
           public void write(JsonWriter out, CreateUserImportJobRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserImportJobRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserImportJobRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserImportJobRequest
   * @throws IOException if the JSON string is invalid with respect to CreateUserImportJobRequest
   */
  public static CreateUserImportJobRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserImportJobRequest.class);
  }

  /**
   * Convert an instance of CreateUserImportJobRequest to an JSON string
   *
   * @return JSON string
   */
