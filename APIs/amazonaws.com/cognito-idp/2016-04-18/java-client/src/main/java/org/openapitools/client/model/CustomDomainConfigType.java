...
public class CustomDomainConfigType {
  ...
  public CustomDomainConfigType certificateArn(String certificateArn) {
  ...
  public boolean equals(Object o) {
    ...
    CustomDomainConfigType customDomainConfigType = (CustomDomainConfigType) o;
    return Objects.equals(this.certificateArn, customDomainConfigType.certificateArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomDomainConfigType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomDomainConfigType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomDomainConfigType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomDomainConfigType is not found in the empty JSON string", CustomDomainConfigType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomDomainConfigType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomDomainConfigType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustomDomainConfigType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomDomainConfigType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomDomainConfigType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomDomainConfigType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomDomainConfigType.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomDomainConfigType>() {
           @Override
           public void write(JsonWriter out, CustomDomainConfigType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomDomainConfigType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomDomainConfigType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomDomainConfigType
   * @throws IOException if the JSON string is invalid with respect to CustomDomainConfigType
   */
  public static CustomDomainConfigType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomDomainConfigType.class);
  }

  /**
   * Convert an instance of CustomDomainConfigType to an JSON string
   *
   * @return JSON string
   */
