...
import org.openapitools.client.model.CustomSMSSenderLambdaVersionType;
...
public class LambdaConfigTypeCustomSMSSender {
  public static final String SERIALIZED_NAME_LAMBDA_VERSION = "LambdaVersion";
  @SerializedName(SERIALIZED_NAME_LAMBDA_VERSION)
  private CustomSMSSenderLambdaVersionType lambdaVersion;

  public static final String SERIALIZED_NAME_LAMBDA_ARN = "LambdaArn";
  @SerializedName(SERIALIZED_NAME_LAMBDA_ARN)
  private String lambdaArn;

  public LambdaConfigTypeCustomSMSSender() {
  }

  public LambdaConfigTypeCustomSMSSender lambdaVersion(CustomSMSSenderLambdaVersionType lambdaVersion) {
  ...
  public CustomSMSSenderLambdaVersionType getLambdaVersion() {
    return lambdaVersion;
  }
  ...
  public LambdaConfigTypeCustomSMSSender lambdaArn(String lambdaArn) {
  ...
  public boolean equals(Object o) {
    ...
    LambdaConfigTypeCustomSMSSender lambdaConfigTypeCustomSMSSender = (LambdaConfigTypeCustomSMSSender) o;
    return Objects.equals(this.lambdaVersion, lambdaConfigTypeCustomSMSSender.lambdaVersion) &&
        Objects.equals(this.lambdaArn, lambdaConfigTypeCustomSMSSender.lambdaArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lambdaVersion, lambdaArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LambdaConfigTypeCustomSMSSender {\n");
    sb.append("    lambdaVersion: ").append(toIndentedString(lambdaVersion)).append("\n");
  ...
  static {
    ...
    openapiFields.add("LambdaVersion");
    openapiFields.add("LambdaArn");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("LambdaVersion");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LambdaConfigTypeCustomSMSSender
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LambdaConfigTypeCustomSMSSender.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LambdaConfigTypeCustomSMSSender is not found in the empty JSON string", LambdaConfigTypeCustomSMSSender.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LambdaConfigTypeCustomSMSSender.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LambdaConfigTypeCustomSMSSender` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LambdaConfigTypeCustomSMSSender.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `LambdaVersion`
      CustomSMSSenderLambdaVersionType.validateJsonElement(jsonObj.get("LambdaVersion"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LambdaConfigTypeCustomSMSSender.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LambdaConfigTypeCustomSMSSender' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LambdaConfigTypeCustomSMSSender> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LambdaConfigTypeCustomSMSSender.class));

       return (TypeAdapter<T>) new TypeAdapter<LambdaConfigTypeCustomSMSSender>() {
           @Override
           public void write(JsonWriter out, LambdaConfigTypeCustomSMSSender value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LambdaConfigTypeCustomSMSSender read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LambdaConfigTypeCustomSMSSender given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LambdaConfigTypeCustomSMSSender
   * @throws IOException if the JSON string is invalid with respect to LambdaConfigTypeCustomSMSSender
   */
  public static LambdaConfigTypeCustomSMSSender fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LambdaConfigTypeCustomSMSSender.class);
  }

  /**
   * Convert an instance of LambdaConfigTypeCustomSMSSender to an JSON string
   *
   * @return JSON string
   */
