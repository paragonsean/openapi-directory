...
public class AdminDeleteUserAttributesRequest {
  ...
  public AdminDeleteUserAttributesRequest userPoolId(String userPoolId) {
  ...
  public AdminDeleteUserAttributesRequest username(String username) {
  ...
  public AdminDeleteUserAttributesRequest userAttributeNames(List userAttributeNames) {
  ...
  public boolean equals(Object o) {
    ...
    AdminDeleteUserAttributesRequest adminDeleteUserAttributesRequest = (AdminDeleteUserAttributesRequest) o;
    return Objects.equals(this.userPoolId, adminDeleteUserAttributesRequest.userPoolId) &&
        Objects.equals(this.username, adminDeleteUserAttributesRequest.username) &&
        Objects.equals(this.userAttributeNames, adminDeleteUserAttributesRequest.userAttributeNames);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username, userAttributeNames);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminDeleteUserAttributesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminDeleteUserAttributesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminDeleteUserAttributesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminDeleteUserAttributesRequest is not found in the empty JSON string", AdminDeleteUserAttributesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminDeleteUserAttributesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminDeleteUserAttributesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminDeleteUserAttributesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminDeleteUserAttributesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminDeleteUserAttributesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminDeleteUserAttributesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminDeleteUserAttributesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminDeleteUserAttributesRequest>() {
           @Override
           public void write(JsonWriter out, AdminDeleteUserAttributesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminDeleteUserAttributesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminDeleteUserAttributesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminDeleteUserAttributesRequest
   * @throws IOException if the JSON string is invalid with respect to AdminDeleteUserAttributesRequest
   */
  public static AdminDeleteUserAttributesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminDeleteUserAttributesRequest.class);
  }

  /**
   * Convert an instance of AdminDeleteUserAttributesRequest to an JSON string
   *
   * @return JSON string
   */
