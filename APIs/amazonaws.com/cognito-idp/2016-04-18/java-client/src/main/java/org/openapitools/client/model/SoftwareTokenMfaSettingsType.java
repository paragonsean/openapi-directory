...
public class SoftwareTokenMfaSettingsType {
  ...
  public SoftwareTokenMfaSettingsType enabled(Boolean enabled) {
  ...
  public SoftwareTokenMfaSettingsType preferredMfa(Boolean preferredMfa) {
  ...
  public boolean equals(Object o) {
    ...
    SoftwareTokenMfaSettingsType softwareTokenMfaSettingsType = (SoftwareTokenMfaSettingsType) o;
    return Objects.equals(this.enabled, softwareTokenMfaSettingsType.enabled) &&
        Objects.equals(this.preferredMfa, softwareTokenMfaSettingsType.preferredMfa);
  }
  ...
  public String toString() {
    ...
    sb.append("class SoftwareTokenMfaSettingsType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SoftwareTokenMfaSettingsType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SoftwareTokenMfaSettingsType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SoftwareTokenMfaSettingsType is not found in the empty JSON string", SoftwareTokenMfaSettingsType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SoftwareTokenMfaSettingsType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SoftwareTokenMfaSettingsType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SoftwareTokenMfaSettingsType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SoftwareTokenMfaSettingsType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SoftwareTokenMfaSettingsType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SoftwareTokenMfaSettingsType.class));

       return (TypeAdapter<T>) new TypeAdapter<SoftwareTokenMfaSettingsType>() {
           @Override
           public void write(JsonWriter out, SoftwareTokenMfaSettingsType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SoftwareTokenMfaSettingsType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SoftwareTokenMfaSettingsType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SoftwareTokenMfaSettingsType
   * @throws IOException if the JSON string is invalid with respect to SoftwareTokenMfaSettingsType
   */
  public static SoftwareTokenMfaSettingsType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SoftwareTokenMfaSettingsType.class);
  }

  /**
   * Convert an instance of SoftwareTokenMfaSettingsType to an JSON string
   *
   * @return JSON string
   */
