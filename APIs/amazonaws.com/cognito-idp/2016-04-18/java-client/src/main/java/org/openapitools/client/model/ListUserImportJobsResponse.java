...
public class ListUserImportJobsResponse {
  public static final String SERIALIZED_NAME_USER_IMPORT_JOBS = "UserImportJobs";
  @SerializedName(SERIALIZED_NAME_USER_IMPORT_JOBS)
  ...
  public ListUserImportJobsResponse userImportJobs(List userImportJobs) {
  ...
  public void setUserImportJobs(List userImportJobs) {
    this.userImportJobs = userImportJobs;
  }


  public ListUserImportJobsResponse paginationToken(String paginationToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListUserImportJobsResponse listUserImportJobsResponse = (ListUserImportJobsResponse) o;
    return Objects.equals(this.userImportJobs, listUserImportJobsResponse.userImportJobs) &&
        Objects.equals(this.paginationToken, listUserImportJobsResponse.paginationToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userImportJobs, paginationToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListUserImportJobsResponse {\n");
    sb.append("    userImportJobs: ").append(toIndentedString(userImportJobs)).append("\n");
  ...
  static {
    ...
    openapiFields.add("UserImportJobs");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListUserImportJobsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListUserImportJobsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListUserImportJobsResponse is not found in the empty JSON string", ListUserImportJobsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListUserImportJobsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListUserImportJobsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `UserImportJobs`
      if (jsonObj.get("UserImportJobs") != null && !jsonObj.get("UserImportJobs").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("UserImportJobs"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListUserImportJobsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListUserImportJobsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListUserImportJobsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListUserImportJobsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListUserImportJobsResponse>() {
           @Override
           public void write(JsonWriter out, ListUserImportJobsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListUserImportJobsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListUserImportJobsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListUserImportJobsResponse
   * @throws IOException if the JSON string is invalid with respect to ListUserImportJobsResponse
   */
  public static ListUserImportJobsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUserImportJobsResponse.class);
  }

  /**
   * Convert an instance of ListUserImportJobsResponse to an JSON string
   *
   * @return JSON string
   */
