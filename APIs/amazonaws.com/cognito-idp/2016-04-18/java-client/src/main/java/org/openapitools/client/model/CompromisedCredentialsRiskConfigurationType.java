...
public class CompromisedCredentialsRiskConfigurationType {
  ...
  public CompromisedCredentialsRiskConfigurationType eventFilter(List eventFilter) {
  ...
  public CompromisedCredentialsRiskConfigurationType actions(CompromisedCredentialsRiskConfigurationTypeActions actions) {
  ...
  public boolean equals(Object o) {
    ...
    CompromisedCredentialsRiskConfigurationType compromisedCredentialsRiskConfigurationType = (CompromisedCredentialsRiskConfigurationType) o;
    return Objects.equals(this.eventFilter, compromisedCredentialsRiskConfigurationType.eventFilter) &&
        Objects.equals(this.actions, compromisedCredentialsRiskConfigurationType.actions);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompromisedCredentialsRiskConfigurationType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompromisedCredentialsRiskConfigurationType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompromisedCredentialsRiskConfigurationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompromisedCredentialsRiskConfigurationType is not found in the empty JSON string", CompromisedCredentialsRiskConfigurationType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompromisedCredentialsRiskConfigurationType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompromisedCredentialsRiskConfigurationType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompromisedCredentialsRiskConfigurationType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompromisedCredentialsRiskConfigurationType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompromisedCredentialsRiskConfigurationType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompromisedCredentialsRiskConfigurationType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompromisedCredentialsRiskConfigurationType.class));

       return (TypeAdapter<T>) new TypeAdapter<CompromisedCredentialsRiskConfigurationType>() {
           @Override
           public void write(JsonWriter out, CompromisedCredentialsRiskConfigurationType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompromisedCredentialsRiskConfigurationType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompromisedCredentialsRiskConfigurationType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompromisedCredentialsRiskConfigurationType
   * @throws IOException if the JSON string is invalid with respect to CompromisedCredentialsRiskConfigurationType
   */
  public static CompromisedCredentialsRiskConfigurationType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompromisedCredentialsRiskConfigurationType.class);
  }

  /**
   * Convert an instance of CompromisedCredentialsRiskConfigurationType to an JSON string
   *
   * @return JSON string
   */
