...
public class ResendConfirmationCodeResponseCodeDeliveryDetails {
  ...
  public ResendConfirmationCodeResponseCodeDeliveryDetails() {
  }

  public ResendConfirmationCodeResponseCodeDeliveryDetails destination(String destination) {
  ...
  public ResendConfirmationCodeResponseCodeDeliveryDetails deliveryMedium(DeliveryMediumType deliveryMedium) {
  ...
  public ResendConfirmationCodeResponseCodeDeliveryDetails attributeName(String attributeName) {
  ...
  public boolean equals(Object o) {
    ...
    ResendConfirmationCodeResponseCodeDeliveryDetails resendConfirmationCodeResponseCodeDeliveryDetails = (ResendConfirmationCodeResponseCodeDeliveryDetails) o;
    return Objects.equals(this.destination, resendConfirmationCodeResponseCodeDeliveryDetails.destination) &&
        Objects.equals(this.deliveryMedium, resendConfirmationCodeResponseCodeDeliveryDetails.deliveryMedium) &&
        Objects.equals(this.attributeName, resendConfirmationCodeResponseCodeDeliveryDetails.attributeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResendConfirmationCodeResponseCodeDeliveryDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResendConfirmationCodeResponseCodeDeliveryDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResendConfirmationCodeResponseCodeDeliveryDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResendConfirmationCodeResponseCodeDeliveryDetails is not found in the empty JSON string", ResendConfirmationCodeResponseCodeDeliveryDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResendConfirmationCodeResponseCodeDeliveryDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResendConfirmationCodeResponseCodeDeliveryDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResendConfirmationCodeResponseCodeDeliveryDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResendConfirmationCodeResponseCodeDeliveryDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResendConfirmationCodeResponseCodeDeliveryDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResendConfirmationCodeResponseCodeDeliveryDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ResendConfirmationCodeResponseCodeDeliveryDetails>() {
           @Override
           public void write(JsonWriter out, ResendConfirmationCodeResponseCodeDeliveryDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResendConfirmationCodeResponseCodeDeliveryDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResendConfirmationCodeResponseCodeDeliveryDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResendConfirmationCodeResponseCodeDeliveryDetails
   * @throws IOException if the JSON string is invalid with respect to ResendConfirmationCodeResponseCodeDeliveryDetails
   */
  public static ResendConfirmationCodeResponseCodeDeliveryDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResendConfirmationCodeResponseCodeDeliveryDetails.class);
  }

  /**
   * Convert an instance of ResendConfirmationCodeResponseCodeDeliveryDetails to an JSON string
   *
   * @return JSON string
   */
