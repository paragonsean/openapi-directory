...
public class ListUsersInGroupResponse {
  ...
  public ListUsersInGroupResponse() {
  }

  public ListUsersInGroupResponse users(List users) {
    this.users = users;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.users, listUsersInGroupResponse.users) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListUsersInGroupResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListUsersInGroupResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListUsersInGroupResponse is not found in the empty JSON string", ListUsersInGroupResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListUsersInGroupResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListUsersInGroupResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListUsersInGroupResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListUsersInGroupResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListUsersInGroupResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListUsersInGroupResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListUsersInGroupResponse>() {
           @Override
           public void write(JsonWriter out, ListUsersInGroupResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListUsersInGroupResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListUsersInGroupResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListUsersInGroupResponse
   * @throws IOException if the JSON string is invalid with respect to ListUsersInGroupResponse
   */
  public static ListUsersInGroupResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUsersInGroupResponse.class);
  }

  /**
   * Convert an instance of ListUsersInGroupResponse to an JSON string
   *
   * @return JSON string
   */
