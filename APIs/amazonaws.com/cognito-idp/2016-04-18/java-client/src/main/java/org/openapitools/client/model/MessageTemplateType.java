...
public class MessageTemplateType {
  ...
  public MessageTemplateType smSMessage(String smSMessage) {
  ...
  public MessageTemplateType emailMessage(String emailMessage) {
  ...
  public MessageTemplateType emailSubject(String emailSubject) {
  ...
  public boolean equals(Object o) {
    ...
    MessageTemplateType messageTemplateType = (MessageTemplateType) o;
    return Objects.equals(this.smSMessage, messageTemplateType.smSMessage) &&
        Objects.equals(this.emailMessage, messageTemplateType.emailMessage) &&
        Objects.equals(this.emailSubject, messageTemplateType.emailSubject);
  }
  ...
  public String toString() {
    ...
    sb.append("class MessageTemplateType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessageTemplateType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageTemplateType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessageTemplateType is not found in the empty JSON string", MessageTemplateType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageTemplateType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessageTemplateType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageTemplateType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageTemplateType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageTemplateType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageTemplateType.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageTemplateType>() {
           @Override
           public void write(JsonWriter out, MessageTemplateType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessageTemplateType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessageTemplateType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessageTemplateType
   * @throws IOException if the JSON string is invalid with respect to MessageTemplateType
   */
  public static MessageTemplateType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageTemplateType.class);
  }

  /**
   * Convert an instance of MessageTemplateType to an JSON string
   *
   * @return JSON string
   */
