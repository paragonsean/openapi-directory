...
public class GetCSVHeaderRequest {
  ...
  public GetCSVHeaderRequest userPoolId(String userPoolId) {
  ...
  public boolean equals(Object o) {
    ...
    GetCSVHeaderRequest getCSVHeaderRequest = (GetCSVHeaderRequest) o;
    return Objects.equals(this.userPoolId, getCSVHeaderRequest.userPoolId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCSVHeaderRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCSVHeaderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCSVHeaderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCSVHeaderRequest is not found in the empty JSON string", GetCSVHeaderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCSVHeaderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCSVHeaderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCSVHeaderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCSVHeaderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCSVHeaderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCSVHeaderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCSVHeaderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCSVHeaderRequest>() {
           @Override
           public void write(JsonWriter out, GetCSVHeaderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCSVHeaderRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCSVHeaderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCSVHeaderRequest
   * @throws IOException if the JSON string is invalid with respect to GetCSVHeaderRequest
   */
  public static GetCSVHeaderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCSVHeaderRequest.class);
  }

  /**
   * Convert an instance of GetCSVHeaderRequest to an JSON string
   *
   * @return JSON string
   */
