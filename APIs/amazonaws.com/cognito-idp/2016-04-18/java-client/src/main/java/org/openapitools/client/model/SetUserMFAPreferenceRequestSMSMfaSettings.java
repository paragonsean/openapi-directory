...
public class SetUserMFAPreferenceRequestSMSMfaSettings {
  ...
  public SetUserMFAPreferenceRequestSMSMfaSettings() {
  }

  public SetUserMFAPreferenceRequestSMSMfaSettings enabled(Boolean enabled) {
  ...
  public SetUserMFAPreferenceRequestSMSMfaSettings preferredMfa(Boolean preferredMfa) {
  ...
  public boolean equals(Object o) {
    ...
    SetUserMFAPreferenceRequestSMSMfaSettings setUserMFAPreferenceRequestSMSMfaSettings = (SetUserMFAPreferenceRequestSMSMfaSettings) o;
    return Objects.equals(this.enabled, setUserMFAPreferenceRequestSMSMfaSettings.enabled) &&
        Objects.equals(this.preferredMfa, setUserMFAPreferenceRequestSMSMfaSettings.preferredMfa);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetUserMFAPreferenceRequestSMSMfaSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetUserMFAPreferenceRequestSMSMfaSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetUserMFAPreferenceRequestSMSMfaSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetUserMFAPreferenceRequestSMSMfaSettings is not found in the empty JSON string", SetUserMFAPreferenceRequestSMSMfaSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetUserMFAPreferenceRequestSMSMfaSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetUserMFAPreferenceRequestSMSMfaSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetUserMFAPreferenceRequestSMSMfaSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetUserMFAPreferenceRequestSMSMfaSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetUserMFAPreferenceRequestSMSMfaSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetUserMFAPreferenceRequestSMSMfaSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<SetUserMFAPreferenceRequestSMSMfaSettings>() {
           @Override
           public void write(JsonWriter out, SetUserMFAPreferenceRequestSMSMfaSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetUserMFAPreferenceRequestSMSMfaSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetUserMFAPreferenceRequestSMSMfaSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetUserMFAPreferenceRequestSMSMfaSettings
   * @throws IOException if the JSON string is invalid with respect to SetUserMFAPreferenceRequestSMSMfaSettings
   */
  public static SetUserMFAPreferenceRequestSMSMfaSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetUserMFAPreferenceRequestSMSMfaSettings.class);
  }

  /**
   * Convert an instance of SetUserMFAPreferenceRequestSMSMfaSettings to an JSON string
   *
   * @return JSON string
   */
