...
public class ListResourceServersResponse {
  public static final String SERIALIZED_NAME_RESOURCE_SERVERS = "ResourceServers";
  @SerializedName(SERIALIZED_NAME_RESOURCE_SERVERS)
  ...
  public ListResourceServersResponse() {
  }

  public ListResourceServersResponse resourceServers(List resourceServers) {
  ...
  public void setResourceServers(List resourceServers) {
    this.resourceServers = resourceServers;
  }


  public ListResourceServersResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListResourceServersResponse listResourceServersResponse = (ListResourceServersResponse) o;
    return Objects.equals(this.resourceServers, listResourceServersResponse.resourceServers) &&
        Objects.equals(this.nextToken, listResourceServersResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceServers, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListResourceServersResponse {\n");
    sb.append("    resourceServers: ").append(toIndentedString(resourceServers)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ResourceServers");
    openapiFields.add("NextToken");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("ResourceServers");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListResourceServersResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListResourceServersResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListResourceServersResponse is not found in the empty JSON string", ListResourceServersResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListResourceServersResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListResourceServersResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListResourceServersResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `ResourceServers`
      List.validateJsonElement(jsonObj.get("ResourceServers"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListResourceServersResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListResourceServersResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListResourceServersResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListResourceServersResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListResourceServersResponse>() {
           @Override
           public void write(JsonWriter out, ListResourceServersResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListResourceServersResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListResourceServersResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListResourceServersResponse
   * @throws IOException if the JSON string is invalid with respect to ListResourceServersResponse
   */
  public static ListResourceServersResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListResourceServersResponse.class);
  }

  /**
   * Convert an instance of ListResourceServersResponse to an JSON string
   *
   * @return JSON string
   */
