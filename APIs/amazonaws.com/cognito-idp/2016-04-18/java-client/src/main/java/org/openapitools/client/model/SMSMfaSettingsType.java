...
public class SMSMfaSettingsType {
  ...
  public SMSMfaSettingsType enabled(Boolean enabled) {
  ...
  public SMSMfaSettingsType preferredMfa(Boolean preferredMfa) {
  ...
  public boolean equals(Object o) {
    ...
    SMSMfaSettingsType smSMfaSettingsType = (SMSMfaSettingsType) o;
    return Objects.equals(this.enabled, smSMfaSettingsType.enabled) &&
        Objects.equals(this.preferredMfa, smSMfaSettingsType.preferredMfa);
  }
  ...
  public String toString() {
    ...
    sb.append("class SMSMfaSettingsType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SMSMfaSettingsType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SMSMfaSettingsType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SMSMfaSettingsType is not found in the empty JSON string", SMSMfaSettingsType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SMSMfaSettingsType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SMSMfaSettingsType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SMSMfaSettingsType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SMSMfaSettingsType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SMSMfaSettingsType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SMSMfaSettingsType.class));

       return (TypeAdapter<T>) new TypeAdapter<SMSMfaSettingsType>() {
           @Override
           public void write(JsonWriter out, SMSMfaSettingsType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SMSMfaSettingsType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SMSMfaSettingsType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SMSMfaSettingsType
   * @throws IOException if the JSON string is invalid with respect to SMSMfaSettingsType
   */
  public static SMSMfaSettingsType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SMSMfaSettingsType.class);
  }

  /**
   * Convert an instance of SMSMfaSettingsType to an JSON string
   *
   * @return JSON string
   */
