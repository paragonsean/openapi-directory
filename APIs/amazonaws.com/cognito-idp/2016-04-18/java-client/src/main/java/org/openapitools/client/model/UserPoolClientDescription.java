...
public class UserPoolClientDescription {
  ...
  public UserPoolClientDescription clientId(String clientId) {
  ...
  public UserPoolClientDescription userPoolId(String userPoolId) {
  ...
  public UserPoolClientDescription clientName(String clientName) {
  ...
  public boolean equals(Object o) {
    ...
    UserPoolClientDescription userPoolClientDescription = (UserPoolClientDescription) o;
    return Objects.equals(this.clientId, userPoolClientDescription.clientId) &&
        Objects.equals(this.userPoolId, userPoolClientDescription.userPoolId) &&
        Objects.equals(this.clientName, userPoolClientDescription.clientName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, userPoolId, clientName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserPoolClientDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserPoolClientDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPoolClientDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserPoolClientDescription is not found in the empty JSON string", UserPoolClientDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserPoolClientDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserPoolClientDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserPoolClientDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserPoolClientDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserPoolClientDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserPoolClientDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<UserPoolClientDescription>() {
           @Override
           public void write(JsonWriter out, UserPoolClientDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserPoolClientDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserPoolClientDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserPoolClientDescription
   * @throws IOException if the JSON string is invalid with respect to UserPoolClientDescription
   */
  public static UserPoolClientDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserPoolClientDescription.class);
  }

  /**
   * Convert an instance of UserPoolClientDescription to an JSON string
   *
   * @return JSON string
   */
