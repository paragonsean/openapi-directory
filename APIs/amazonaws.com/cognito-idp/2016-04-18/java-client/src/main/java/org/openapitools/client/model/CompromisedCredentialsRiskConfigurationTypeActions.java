...
public class CompromisedCredentialsRiskConfigurationTypeActions {
  public static final String SERIALIZED_NAME_EVENT_ACTION = "EventAction";
  @SerializedName(SERIALIZED_NAME_EVENT_ACTION)
  private CompromisedCredentialsEventActionType eventAction;

  public CompromisedCredentialsRiskConfigurationTypeActions() {
  }

  public CompromisedCredentialsRiskConfigurationTypeActions eventAction(CompromisedCredentialsEventActionType eventAction) {
  ...
  public CompromisedCredentialsEventActionType getEventAction() {
    return eventAction;
  }
  ...
  public boolean equals(Object o) {
    ...
    CompromisedCredentialsRiskConfigurationTypeActions compromisedCredentialsRiskConfigurationTypeActions = (CompromisedCredentialsRiskConfigurationTypeActions) o;
    return Objects.equals(this.eventAction, compromisedCredentialsRiskConfigurationTypeActions.eventAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CompromisedCredentialsRiskConfigurationTypeActions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompromisedCredentialsRiskConfigurationTypeActions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompromisedCredentialsRiskConfigurationTypeActions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompromisedCredentialsRiskConfigurationTypeActions is not found in the empty JSON string", CompromisedCredentialsRiskConfigurationTypeActions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompromisedCredentialsRiskConfigurationTypeActions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompromisedCredentialsRiskConfigurationTypeActions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompromisedCredentialsRiskConfigurationTypeActions.openapiRequiredFields) {
      ...
      CompromisedCredentialsEventActionType.validateJsonElement(jsonObj.get("EventAction"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompromisedCredentialsRiskConfigurationTypeActions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompromisedCredentialsRiskConfigurationTypeActions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompromisedCredentialsRiskConfigurationTypeActions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompromisedCredentialsRiskConfigurationTypeActions.class));

       return (TypeAdapter<T>) new TypeAdapter<CompromisedCredentialsRiskConfigurationTypeActions>() {
           @Override
           public void write(JsonWriter out, CompromisedCredentialsRiskConfigurationTypeActions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompromisedCredentialsRiskConfigurationTypeActions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompromisedCredentialsRiskConfigurationTypeActions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompromisedCredentialsRiskConfigurationTypeActions
   * @throws IOException if the JSON string is invalid with respect to CompromisedCredentialsRiskConfigurationTypeActions
   */
  public static CompromisedCredentialsRiskConfigurationTypeActions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompromisedCredentialsRiskConfigurationTypeActions.class);
  }

  /**
   * Convert an instance of CompromisedCredentialsRiskConfigurationTypeActions to an JSON string
   *
   * @return JSON string
   */
