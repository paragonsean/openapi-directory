...
public class GetIdentityProviderByIdentifierRequest {
  ...
  public GetIdentityProviderByIdentifierRequest userPoolId(String userPoolId) {
  ...
  public GetIdentityProviderByIdentifierRequest idpIdentifier(String idpIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    GetIdentityProviderByIdentifierRequest getIdentityProviderByIdentifierRequest = (GetIdentityProviderByIdentifierRequest) o;
    return Objects.equals(this.userPoolId, getIdentityProviderByIdentifierRequest.userPoolId) &&
        Objects.equals(this.idpIdentifier, getIdentityProviderByIdentifierRequest.idpIdentifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, idpIdentifier);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetIdentityProviderByIdentifierRequest {\n");
  ...
  static {
    ...
    openapiFields.add("IdpIdentifier");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("UserPoolId");
    openapiRequiredFields.add("IdpIdentifier");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIdentityProviderByIdentifierRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIdentityProviderByIdentifierRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIdentityProviderByIdentifierRequest is not found in the empty JSON string", GetIdentityProviderByIdentifierRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIdentityProviderByIdentifierRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIdentityProviderByIdentifierRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetIdentityProviderByIdentifierRequest.openapiRequiredFields) {
      ...
      // validate the required field `IdpIdentifier`
      String.validateJsonElement(jsonObj.get("IdpIdentifier"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIdentityProviderByIdentifierRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIdentityProviderByIdentifierRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIdentityProviderByIdentifierRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIdentityProviderByIdentifierRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIdentityProviderByIdentifierRequest>() {
           @Override
           public void write(JsonWriter out, GetIdentityProviderByIdentifierRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIdentityProviderByIdentifierRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIdentityProviderByIdentifierRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIdentityProviderByIdentifierRequest
   * @throws IOException if the JSON string is invalid with respect to GetIdentityProviderByIdentifierRequest
   */
  public static GetIdentityProviderByIdentifierRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIdentityProviderByIdentifierRequest.class);
  }

  /**
   * Convert an instance of GetIdentityProviderByIdentifierRequest to an JSON string
   *
   * @return JSON string
   */
