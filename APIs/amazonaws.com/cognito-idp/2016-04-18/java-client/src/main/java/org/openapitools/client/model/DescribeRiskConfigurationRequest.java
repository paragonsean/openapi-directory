...
public class DescribeRiskConfigurationRequest {
  ...
  public DescribeRiskConfigurationRequest() {
  }

  public DescribeRiskConfigurationRequest userPoolId(String userPoolId) {
  ...
  public DescribeRiskConfigurationRequest clientId(String clientId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeRiskConfigurationRequest describeRiskConfigurationRequest = (DescribeRiskConfigurationRequest) o;
    return Objects.equals(this.userPoolId, describeRiskConfigurationRequest.userPoolId) &&
        Objects.equals(this.clientId, describeRiskConfigurationRequest.clientId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, clientId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeRiskConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeRiskConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeRiskConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeRiskConfigurationRequest is not found in the empty JSON string", DescribeRiskConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeRiskConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeRiskConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeRiskConfigurationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeRiskConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeRiskConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeRiskConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeRiskConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeRiskConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, DescribeRiskConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeRiskConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeRiskConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeRiskConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeRiskConfigurationRequest
   */
  public static DescribeRiskConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeRiskConfigurationRequest.class);
  }

  /**
   * Convert an instance of DescribeRiskConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
