...
import org.openapitools.client.model.GetLogDeliveryConfigurationResponseLogDeliveryConfiguration;
...
public class GetLogDeliveryConfigurationResponse {
  public static final String SERIALIZED_NAME_LOG_DELIVERY_CONFIGURATION = "LogDeliveryConfiguration";
  @SerializedName(SERIALIZED_NAME_LOG_DELIVERY_CONFIGURATION)
  private GetLogDeliveryConfigurationResponseLogDeliveryConfiguration logDeliveryConfiguration;

  public GetLogDeliveryConfigurationResponse() {
  }

  public GetLogDeliveryConfigurationResponse logDeliveryConfiguration(GetLogDeliveryConfigurationResponseLogDeliveryConfiguration logDeliveryConfiguration) {
  ...
  public GetLogDeliveryConfigurationResponseLogDeliveryConfiguration getLogDeliveryConfiguration() {
    return logDeliveryConfiguration;
  }

  public void setLogDeliveryConfiguration(GetLogDeliveryConfigurationResponseLogDeliveryConfiguration logDeliveryConfiguration) {
    this.logDeliveryConfiguration = logDeliveryConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLogDeliveryConfigurationResponse getLogDeliveryConfigurationResponse = (GetLogDeliveryConfigurationResponse) o;
    return Objects.equals(this.logDeliveryConfiguration, getLogDeliveryConfigurationResponse.logDeliveryConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLogDeliveryConfigurationResponse {\n");
  ...
  static {
    ...
    openapiFields.add("LogDeliveryConfiguration");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLogDeliveryConfigurationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLogDeliveryConfigurationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLogDeliveryConfigurationResponse is not found in the empty JSON string", GetLogDeliveryConfigurationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLogDeliveryConfigurationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLogDeliveryConfigurationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `LogDeliveryConfiguration`
      if (jsonObj.get("LogDeliveryConfiguration") != null && !jsonObj.get("LogDeliveryConfiguration").isJsonNull()) {
        GetLogDeliveryConfigurationResponseLogDeliveryConfiguration.validateJsonElement(jsonObj.get("LogDeliveryConfiguration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLogDeliveryConfigurationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLogDeliveryConfigurationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLogDeliveryConfigurationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLogDeliveryConfigurationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLogDeliveryConfigurationResponse>() {
           @Override
           public void write(JsonWriter out, GetLogDeliveryConfigurationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLogDeliveryConfigurationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLogDeliveryConfigurationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLogDeliveryConfigurationResponse
   * @throws IOException if the JSON string is invalid with respect to GetLogDeliveryConfigurationResponse
   */
  public static GetLogDeliveryConfigurationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLogDeliveryConfigurationResponse.class);
  }

  /**
   * Convert an instance of GetLogDeliveryConfigurationResponse to an JSON string
   *
   * @return JSON string
   */
