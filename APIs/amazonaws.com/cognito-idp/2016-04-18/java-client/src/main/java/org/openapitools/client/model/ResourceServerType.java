...
public class ResourceServerType {
  ...
  public ResourceServerType userPoolId(String userPoolId) {
  ...
  public ResourceServerType identifier(String identifier) {
  ...
  public ResourceServerType name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ResourceServerType scopes(List scopes) {
    this.scopes = scopes;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResourceServerType resourceServerType = (ResourceServerType) o;
    return Objects.equals(this.userPoolId, resourceServerType.userPoolId) &&
        Objects.equals(this.identifier, resourceServerType.identifier) &&
        Objects.equals(this.name, resourceServerType.name) &&
        Objects.equals(this.scopes, resourceServerType.scopes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceServerType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceServerType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceServerType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceServerType is not found in the empty JSON string", ResourceServerType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceServerType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceServerType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceServerType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceServerType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceServerType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceServerType.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceServerType>() {
           @Override
           public void write(JsonWriter out, ResourceServerType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceServerType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceServerType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceServerType
   * @throws IOException if the JSON string is invalid with respect to ResourceServerType
   */
  public static ResourceServerType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceServerType.class);
  }

  /**
   * Convert an instance of ResourceServerType to an JSON string
   *
   * @return JSON string
   */
