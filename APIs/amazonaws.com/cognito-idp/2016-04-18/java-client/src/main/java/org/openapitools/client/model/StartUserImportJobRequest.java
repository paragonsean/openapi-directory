...
public class StartUserImportJobRequest {
  ...
  public StartUserImportJobRequest() {
  }

  public StartUserImportJobRequest userPoolId(String userPoolId) {
  ...
  public StartUserImportJobRequest jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartUserImportJobRequest startUserImportJobRequest = (StartUserImportJobRequest) o;
    return Objects.equals(this.userPoolId, startUserImportJobRequest.userPoolId) &&
        Objects.equals(this.jobId, startUserImportJobRequest.jobId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, jobId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartUserImportJobRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartUserImportJobRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartUserImportJobRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartUserImportJobRequest is not found in the empty JSON string", StartUserImportJobRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartUserImportJobRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartUserImportJobRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartUserImportJobRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartUserImportJobRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartUserImportJobRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartUserImportJobRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartUserImportJobRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartUserImportJobRequest>() {
           @Override
           public void write(JsonWriter out, StartUserImportJobRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartUserImportJobRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartUserImportJobRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartUserImportJobRequest
   * @throws IOException if the JSON string is invalid with respect to StartUserImportJobRequest
   */
  public static StartUserImportJobRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartUserImportJobRequest.class);
  }

  /**
   * Convert an instance of StartUserImportJobRequest to an JSON string
   *
   * @return JSON string
   */
