...
public class DescribeUserPoolClientResponseUserPoolClient {
  ...
  public DescribeUserPoolClientResponseUserPoolClient() {
  }

  public DescribeUserPoolClientResponseUserPoolClient userPoolId(String userPoolId) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient clientName(String clientName) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient clientId(String clientId) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient clientSecret(String clientSecret) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient creationDate(OffsetDateTime creationDate) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient refreshTokenValidity(Integer refreshTokenValidity) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient accessTokenValidity(Integer accessTokenValidity) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient idTokenValidity(Integer idTokenValidity) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient tokenValidityUnits(UserPoolClientTypeTokenValidityUnits tokenValidityUnits) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient readAttributes(List readAttributes) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient writeAttributes(List writeAttributes) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient explicitAuthFlows(List explicitAuthFlows) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient supportedIdentityProviders(List supportedIdentityProviders) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient callbackURLs(List callbackURLs) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient logoutURLs(List logoutURLs) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient defaultRedirectURI(String defaultRedirectURI) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient allowedOAuthFlows(List allowedOAuthFlows) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient allowedOAuthScopes(List allowedOAuthScopes) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient allowedOAuthFlowsUserPoolClient(Boolean allowedOAuthFlowsUserPoolClient) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient analyticsConfiguration(UserPoolClientTypeAnalyticsConfiguration analyticsConfiguration) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient preventUserExistenceErrors(PreventUserExistenceErrorTypes preventUserExistenceErrors) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient enableTokenRevocation(Boolean enableTokenRevocation) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient enablePropagateAdditionalUserContextData(Boolean enablePropagateAdditionalUserContextData) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient authSessionValidity(Integer authSessionValidity) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeUserPoolClientResponseUserPoolClient describeUserPoolClientResponseUserPoolClient = (DescribeUserPoolClientResponseUserPoolClient) o;
    return Objects.equals(this.userPoolId, describeUserPoolClientResponseUserPoolClient.userPoolId) &&
        Objects.equals(this.clientName, describeUserPoolClientResponseUserPoolClient.clientName) &&
        Objects.equals(this.clientId, describeUserPoolClientResponseUserPoolClient.clientId) &&
        Objects.equals(this.clientSecret, describeUserPoolClientResponseUserPoolClient.clientSecret) &&
        Objects.equals(this.lastModifiedDate, describeUserPoolClientResponseUserPoolClient.lastModifiedDate) &&
        Objects.equals(this.creationDate, describeUserPoolClientResponseUserPoolClient.creationDate) &&
        Objects.equals(this.refreshTokenValidity, describeUserPoolClientResponseUserPoolClient.refreshTokenValidity) &&
        Objects.equals(this.accessTokenValidity, describeUserPoolClientResponseUserPoolClient.accessTokenValidity) &&
        Objects.equals(this.idTokenValidity, describeUserPoolClientResponseUserPoolClient.idTokenValidity) &&
        Objects.equals(this.tokenValidityUnits, describeUserPoolClientResponseUserPoolClient.tokenValidityUnits) &&
        Objects.equals(this.readAttributes, describeUserPoolClientResponseUserPoolClient.readAttributes) &&
        Objects.equals(this.writeAttributes, describeUserPoolClientResponseUserPoolClient.writeAttributes) &&
        Objects.equals(this.explicitAuthFlows, describeUserPoolClientResponseUserPoolClient.explicitAuthFlows) &&
        Objects.equals(this.supportedIdentityProviders, describeUserPoolClientResponseUserPoolClient.supportedIdentityProviders) &&
        Objects.equals(this.callbackURLs, describeUserPoolClientResponseUserPoolClient.callbackURLs) &&
        Objects.equals(this.logoutURLs, describeUserPoolClientResponseUserPoolClient.logoutURLs) &&
        Objects.equals(this.defaultRedirectURI, describeUserPoolClientResponseUserPoolClient.defaultRedirectURI) &&
        Objects.equals(this.allowedOAuthFlows, describeUserPoolClientResponseUserPoolClient.allowedOAuthFlows) &&
        Objects.equals(this.allowedOAuthScopes, describeUserPoolClientResponseUserPoolClient.allowedOAuthScopes) &&
        Objects.equals(this.allowedOAuthFlowsUserPoolClient, describeUserPoolClientResponseUserPoolClient.allowedOAuthFlowsUserPoolClient) &&
        Objects.equals(this.analyticsConfiguration, describeUserPoolClientResponseUserPoolClient.analyticsConfiguration) &&
        Objects.equals(this.preventUserExistenceErrors, describeUserPoolClientResponseUserPoolClient.preventUserExistenceErrors) &&
        Objects.equals(this.enableTokenRevocation, describeUserPoolClientResponseUserPoolClient.enableTokenRevocation) &&
        Objects.equals(this.enablePropagateAdditionalUserContextData, describeUserPoolClientResponseUserPoolClient.enablePropagateAdditionalUserContextData) &&
        Objects.equals(this.authSessionValidity, describeUserPoolClientResponseUserPoolClient.authSessionValidity);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeUserPoolClientResponseUserPoolClient {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUserPoolClientResponseUserPoolClient
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUserPoolClientResponseUserPoolClient.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUserPoolClientResponseUserPoolClient is not found in the empty JSON string", DescribeUserPoolClientResponseUserPoolClient.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUserPoolClientResponseUserPoolClient.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUserPoolClientResponseUserPoolClient` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUserPoolClientResponseUserPoolClient.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUserPoolClientResponseUserPoolClient' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUserPoolClientResponseUserPoolClient> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUserPoolClientResponseUserPoolClient.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUserPoolClientResponseUserPoolClient>() {
           @Override
           public void write(JsonWriter out, DescribeUserPoolClientResponseUserPoolClient value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUserPoolClientResponseUserPoolClient read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUserPoolClientResponseUserPoolClient given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUserPoolClientResponseUserPoolClient
   * @throws IOException if the JSON string is invalid with respect to DescribeUserPoolClientResponseUserPoolClient
   */
  public static DescribeUserPoolClientResponseUserPoolClient fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUserPoolClientResponseUserPoolClient.class);
  }

  /**
   * Convert an instance of DescribeUserPoolClientResponseUserPoolClient to an JSON string
   *
   * @return JSON string
   */
