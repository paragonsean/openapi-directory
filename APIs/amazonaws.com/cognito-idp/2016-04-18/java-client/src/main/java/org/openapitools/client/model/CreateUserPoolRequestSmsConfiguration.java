...
public class CreateUserPoolRequestSmsConfiguration {
  ...
  public CreateUserPoolRequestSmsConfiguration() {
  }

  public CreateUserPoolRequestSmsConfiguration snsCallerArn(String snsCallerArn) {
  ...
  public CreateUserPoolRequestSmsConfiguration externalId(String externalId) {
  ...
  public CreateUserPoolRequestSmsConfiguration snsRegion(String snsRegion) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUserPoolRequestSmsConfiguration createUserPoolRequestSmsConfiguration = (CreateUserPoolRequestSmsConfiguration) o;
    return Objects.equals(this.snsCallerArn, createUserPoolRequestSmsConfiguration.snsCallerArn) &&
        Objects.equals(this.externalId, createUserPoolRequestSmsConfiguration.externalId) &&
        Objects.equals(this.snsRegion, createUserPoolRequestSmsConfiguration.snsRegion);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUserPoolRequestSmsConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolRequestSmsConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolRequestSmsConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolRequestSmsConfiguration is not found in the empty JSON string", CreateUserPoolRequestSmsConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolRequestSmsConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolRequestSmsConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateUserPoolRequestSmsConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolRequestSmsConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolRequestSmsConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolRequestSmsConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolRequestSmsConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolRequestSmsConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolRequestSmsConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolRequestSmsConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolRequestSmsConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolRequestSmsConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolRequestSmsConfiguration
   */
  public static CreateUserPoolRequestSmsConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolRequestSmsConfiguration.class);
  }

  /**
   * Convert an instance of CreateUserPoolRequestSmsConfiguration to an JSON string
   *
   * @return JSON string
   */
