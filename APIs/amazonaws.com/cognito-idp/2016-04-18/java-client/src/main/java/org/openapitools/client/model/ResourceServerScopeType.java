...
public class ResourceServerScopeType {
  ...
  public static final String SERIALIZED_NAME_SCOPE_DESCRIPTION = "ScopeDescription";
  @SerializedName(SERIALIZED_NAME_SCOPE_DESCRIPTION)
  private String scopeDescription;

  public ResourceServerScopeType() {
  }

  public ResourceServerScopeType scopeName(String scopeName) {
  ...
  public ResourceServerScopeType scopeDescription(String scopeDescription) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceServerScopeType resourceServerScopeType = (ResourceServerScopeType) o;
    return Objects.equals(this.scopeName, resourceServerScopeType.scopeName) &&
        Objects.equals(this.scopeDescription, resourceServerScopeType.scopeDescription);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scopeName, scopeDescription);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ResourceServerScopeType {\n");
    sb.append("    scopeName: ").append(toIndentedString(scopeName)).append("\n");
    sb.append("    scopeDescription: ").append(toIndentedString(scopeDescription)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("ScopeDescription");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("ScopeName");
    openapiRequiredFields.add("ScopeDescription");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceServerScopeType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceServerScopeType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceServerScopeType is not found in the empty JSON string", ResourceServerScopeType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceServerScopeType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceServerScopeType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceServerScopeType.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `ScopeName`
      String.validateJsonElement(jsonObj.get("ScopeName"));
      // validate the required field `ScopeDescription`
      String.validateJsonElement(jsonObj.get("ScopeDescription"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceServerScopeType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceServerScopeType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceServerScopeType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceServerScopeType.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceServerScopeType>() {
           @Override
           public void write(JsonWriter out, ResourceServerScopeType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceServerScopeType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceServerScopeType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceServerScopeType
   * @throws IOException if the JSON string is invalid with respect to ResourceServerScopeType
   */
  public static ResourceServerScopeType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceServerScopeType.class);
  }

  /**
   * Convert an instance of ResourceServerScopeType to an JSON string
   *
   * @return JSON string
   */
