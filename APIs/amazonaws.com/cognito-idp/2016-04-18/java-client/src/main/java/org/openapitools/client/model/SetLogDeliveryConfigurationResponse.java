...
public class SetLogDeliveryConfigurationResponse {
  ...
  private SetLogDeliveryConfigurationResponseLogDeliveryConfiguration logDeliveryConfiguration;

  public SetLogDeliveryConfigurationResponse() {
  }

  public SetLogDeliveryConfigurationResponse logDeliveryConfiguration(SetLogDeliveryConfigurationResponseLogDeliveryConfiguration logDeliveryConfiguration) {
  ...
  public SetLogDeliveryConfigurationResponseLogDeliveryConfiguration getLogDeliveryConfiguration() {
    return logDeliveryConfiguration;
  }

  public void setLogDeliveryConfiguration(SetLogDeliveryConfigurationResponseLogDeliveryConfiguration logDeliveryConfiguration) {
    this.logDeliveryConfiguration = logDeliveryConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    SetLogDeliveryConfigurationResponse setLogDeliveryConfigurationResponse = (SetLogDeliveryConfigurationResponse) o;
    return Objects.equals(this.logDeliveryConfiguration, setLogDeliveryConfigurationResponse.logDeliveryConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetLogDeliveryConfigurationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetLogDeliveryConfigurationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetLogDeliveryConfigurationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetLogDeliveryConfigurationResponse is not found in the empty JSON string", SetLogDeliveryConfigurationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetLogDeliveryConfigurationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetLogDeliveryConfigurationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("LogDeliveryConfiguration") != null && !jsonObj.get("LogDeliveryConfiguration").isJsonNull()) {
        SetLogDeliveryConfigurationResponseLogDeliveryConfiguration.validateJsonElement(jsonObj.get("LogDeliveryConfiguration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetLogDeliveryConfigurationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetLogDeliveryConfigurationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetLogDeliveryConfigurationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetLogDeliveryConfigurationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SetLogDeliveryConfigurationResponse>() {
           @Override
           public void write(JsonWriter out, SetLogDeliveryConfigurationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetLogDeliveryConfigurationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetLogDeliveryConfigurationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetLogDeliveryConfigurationResponse
   * @throws IOException if the JSON string is invalid with respect to SetLogDeliveryConfigurationResponse
   */
  public static SetLogDeliveryConfigurationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetLogDeliveryConfigurationResponse.class);
  }

  /**
   * Convert an instance of SetLogDeliveryConfigurationResponse to an JSON string
   *
   * @return JSON string
   */
