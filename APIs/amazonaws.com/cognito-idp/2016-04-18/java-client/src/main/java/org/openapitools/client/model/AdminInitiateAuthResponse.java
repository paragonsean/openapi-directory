...
import org.openapitools.client.model.AdminInitiateAuthResponseAuthenticationResult;
...
public class AdminInitiateAuthResponse {
  ...
  private AdminInitiateAuthResponseAuthenticationResult authenticationResult;

  public AdminInitiateAuthResponse() {
  }

  public AdminInitiateAuthResponse challengeName(ChallengeNameType challengeName) {
  ...
  public AdminInitiateAuthResponse session(String session) {
  ...
  public AdminInitiateAuthResponse challengeParameters(Map challengeParameters) {
  ...
  public AdminInitiateAuthResponse authenticationResult(AdminInitiateAuthResponseAuthenticationResult authenticationResult) {
   ...
   */
  @javax.annotation.Nullable
  public AdminInitiateAuthResponseAuthenticationResult getAuthenticationResult() {
    return authenticationResult;
  }

  public void setAuthenticationResult(AdminInitiateAuthResponseAuthenticationResult authenticationResult) {
    this.authenticationResult = authenticationResult;
  }
  ...
  public boolean equals(Object o) {
    ...
    AdminInitiateAuthResponse adminInitiateAuthResponse = (AdminInitiateAuthResponse) o;
    return Objects.equals(this.challengeName, adminInitiateAuthResponse.challengeName) &&
        Objects.equals(this.session, adminInitiateAuthResponse.session) &&
        Objects.equals(this.challengeParameters, adminInitiateAuthResponse.challengeParameters) &&
        Objects.equals(this.authenticationResult, adminInitiateAuthResponse.authenticationResult);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdminInitiateAuthResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminInitiateAuthResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminInitiateAuthResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminInitiateAuthResponse is not found in the empty JSON string", AdminInitiateAuthResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminInitiateAuthResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminInitiateAuthResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("AuthenticationResult") != null && !jsonObj.get("AuthenticationResult").isJsonNull()) {
        AdminInitiateAuthResponseAuthenticationResult.validateJsonElement(jsonObj.get("AuthenticationResult"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminInitiateAuthResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminInitiateAuthResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminInitiateAuthResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminInitiateAuthResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminInitiateAuthResponse>() {
           @Override
           public void write(JsonWriter out, AdminInitiateAuthResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminInitiateAuthResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminInitiateAuthResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminInitiateAuthResponse
   * @throws IOException if the JSON string is invalid with respect to AdminInitiateAuthResponse
   */
  public static AdminInitiateAuthResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminInitiateAuthResponse.class);
  }

  /**
   * Convert an instance of AdminInitiateAuthResponse to an JSON string
   *
   * @return JSON string
   */
