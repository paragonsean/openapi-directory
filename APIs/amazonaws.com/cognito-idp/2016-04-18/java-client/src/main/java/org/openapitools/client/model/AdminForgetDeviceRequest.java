...
public class AdminForgetDeviceRequest {
  ...
  public AdminForgetDeviceRequest userPoolId(String userPoolId) {
  ...
  public AdminForgetDeviceRequest username(String username) {
  ...
  public AdminForgetDeviceRequest deviceKey(String deviceKey) {
  ...
  public boolean equals(Object o) {
    ...
    AdminForgetDeviceRequest adminForgetDeviceRequest = (AdminForgetDeviceRequest) o;
    return Objects.equals(this.userPoolId, adminForgetDeviceRequest.userPoolId) &&
        Objects.equals(this.username, adminForgetDeviceRequest.username) &&
        Objects.equals(this.deviceKey, adminForgetDeviceRequest.deviceKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username, deviceKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminForgetDeviceRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("DeviceKey");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminForgetDeviceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminForgetDeviceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminForgetDeviceRequest is not found in the empty JSON string", AdminForgetDeviceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminForgetDeviceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminForgetDeviceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminForgetDeviceRequest.openapiRequiredFields) {
      ...
      // validate the required field `DeviceKey`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminForgetDeviceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminForgetDeviceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminForgetDeviceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminForgetDeviceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminForgetDeviceRequest>() {
           @Override
           public void write(JsonWriter out, AdminForgetDeviceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminForgetDeviceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminForgetDeviceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminForgetDeviceRequest
   * @throws IOException if the JSON string is invalid with respect to AdminForgetDeviceRequest
   */
  public static AdminForgetDeviceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminForgetDeviceRequest.class);
  }

  /**
   * Convert an instance of AdminForgetDeviceRequest to an JSON string
   *
   * @return JSON string
   */
