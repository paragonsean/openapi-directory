...
/**
 * Gets or Sets ChallengeNameType
 */
@JsonAdapter(ChallengeNameType.Adapter.class)
public enum ChallengeNameType {
  ...
  ChallengeNameType(String value) {
    this.value = value;
  }
  ...
  public static ChallengeNameType fromValue(String value) {
    for (ChallengeNameType b : ChallengeNameType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ChallengeNameType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChallengeNameType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ChallengeNameType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ChallengeNameType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ChallengeNameType.fromValue(value);
  }
}
