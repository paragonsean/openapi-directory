...
public class AdminEnableUserRequest {
  ...
  public AdminEnableUserRequest userPoolId(String userPoolId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolId, adminEnableUserRequest.userPoolId) &&
        Objects.equals(this.username, adminEnableUserRequest.username);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminEnableUserRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminEnableUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminEnableUserRequest is not found in the empty JSON string", AdminEnableUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminEnableUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminEnableUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminEnableUserRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminEnableUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminEnableUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminEnableUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminEnableUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminEnableUserRequest>() {
           @Override
           public void write(JsonWriter out, AdminEnableUserRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminEnableUserRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminEnableUserRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminEnableUserRequest
   * @throws IOException if the JSON string is invalid with respect to AdminEnableUserRequest
   */
  public static AdminEnableUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminEnableUserRequest.class);
  }

  /**
   * Convert an instance of AdminEnableUserRequest to an JSON string
   *
   * @return JSON string
   */
