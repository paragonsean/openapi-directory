...
public class ListResourceServersRequest {
  ...
  public ListResourceServersRequest userPoolId(String userPoolId) {
  ...
  public ListResourceServersRequest maxResults(Integer maxResults) {
  ...
  public ListResourceServersRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListResourceServersRequest listResourceServersRequest = (ListResourceServersRequest) o;
    return Objects.equals(this.userPoolId, listResourceServersRequest.userPoolId) &&
        Objects.equals(this.maxResults, listResourceServersRequest.maxResults) &&
        Objects.equals(this.nextToken, listResourceServersRequest.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListResourceServersRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListResourceServersRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListResourceServersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListResourceServersRequest is not found in the empty JSON string", ListResourceServersRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListResourceServersRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListResourceServersRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListResourceServersRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListResourceServersRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListResourceServersRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListResourceServersRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListResourceServersRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListResourceServersRequest>() {
           @Override
           public void write(JsonWriter out, ListResourceServersRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListResourceServersRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListResourceServersRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListResourceServersRequest
   * @throws IOException if the JSON string is invalid with respect to ListResourceServersRequest
   */
  public static ListResourceServersRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListResourceServersRequest.class);
  }

  /**
   * Convert an instance of ListResourceServersRequest to an JSON string
   *
   * @return JSON string
   */
