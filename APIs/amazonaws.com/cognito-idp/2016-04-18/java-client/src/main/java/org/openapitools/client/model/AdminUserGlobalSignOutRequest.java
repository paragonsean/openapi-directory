...
public class AdminUserGlobalSignOutRequest {
  ...
  public AdminUserGlobalSignOutRequest userPoolId(String userPoolId) {
  ...
  public AdminUserGlobalSignOutRequest username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    AdminUserGlobalSignOutRequest adminUserGlobalSignOutRequest = (AdminUserGlobalSignOutRequest) o;
    return Objects.equals(this.userPoolId, adminUserGlobalSignOutRequest.userPoolId) &&
        Objects.equals(this.username, adminUserGlobalSignOutRequest.username);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminUserGlobalSignOutRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminUserGlobalSignOutRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminUserGlobalSignOutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminUserGlobalSignOutRequest is not found in the empty JSON string", AdminUserGlobalSignOutRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminUserGlobalSignOutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminUserGlobalSignOutRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminUserGlobalSignOutRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminUserGlobalSignOutRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminUserGlobalSignOutRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminUserGlobalSignOutRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminUserGlobalSignOutRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminUserGlobalSignOutRequest>() {
           @Override
           public void write(JsonWriter out, AdminUserGlobalSignOutRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminUserGlobalSignOutRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminUserGlobalSignOutRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminUserGlobalSignOutRequest
   * @throws IOException if the JSON string is invalid with respect to AdminUserGlobalSignOutRequest
   */
  public static AdminUserGlobalSignOutRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminUserGlobalSignOutRequest.class);
  }

  /**
   * Convert an instance of AdminUserGlobalSignOutRequest to an JSON string
   *
   * @return JSON string
   */
