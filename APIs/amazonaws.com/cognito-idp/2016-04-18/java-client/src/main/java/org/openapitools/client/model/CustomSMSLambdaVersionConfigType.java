...
public class CustomSMSLambdaVersionConfigType {
  ...
  public CustomSMSLambdaVersionConfigType() {
  }

  public CustomSMSLambdaVersionConfigType lambdaVersion(CustomSMSSenderLambdaVersionType lambdaVersion) {
  ...
  public CustomSMSLambdaVersionConfigType lambdaArn(String lambdaArn) {
  ...
  public boolean equals(Object o) {
    ...
    CustomSMSLambdaVersionConfigType customSMSLambdaVersionConfigType = (CustomSMSLambdaVersionConfigType) o;
    return Objects.equals(this.lambdaVersion, customSMSLambdaVersionConfigType.lambdaVersion) &&
        Objects.equals(this.lambdaArn, customSMSLambdaVersionConfigType.lambdaArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomSMSLambdaVersionConfigType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomSMSLambdaVersionConfigType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomSMSLambdaVersionConfigType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomSMSLambdaVersionConfigType is not found in the empty JSON string", CustomSMSLambdaVersionConfigType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomSMSLambdaVersionConfigType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomSMSLambdaVersionConfigType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustomSMSLambdaVersionConfigType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomSMSLambdaVersionConfigType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomSMSLambdaVersionConfigType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomSMSLambdaVersionConfigType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomSMSLambdaVersionConfigType.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomSMSLambdaVersionConfigType>() {
           @Override
           public void write(JsonWriter out, CustomSMSLambdaVersionConfigType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomSMSLambdaVersionConfigType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomSMSLambdaVersionConfigType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomSMSLambdaVersionConfigType
   * @throws IOException if the JSON string is invalid with respect to CustomSMSLambdaVersionConfigType
   */
  public static CustomSMSLambdaVersionConfigType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomSMSLambdaVersionConfigType.class);
  }

  /**
   * Convert an instance of CustomSMSLambdaVersionConfigType to an JSON string
   *
   * @return JSON string
   */
