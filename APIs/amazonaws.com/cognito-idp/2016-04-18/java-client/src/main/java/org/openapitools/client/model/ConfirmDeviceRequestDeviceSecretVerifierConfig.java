...
public class ConfirmDeviceRequestDeviceSecretVerifierConfig {
  public static final String SERIALIZED_NAME_PASSWORD_VERIFIER = "PasswordVerifier";
  ...
  public ConfirmDeviceRequestDeviceSecretVerifierConfig() {
  }

  public ConfirmDeviceRequestDeviceSecretVerifierConfig passwordVerifier(String passwordVerifier) {
    this.passwordVerifier = passwordVerifier;
    return this;
  }

  /**
   * Get passwordVerifier
  ...
  public ConfirmDeviceRequestDeviceSecretVerifierConfig salt(String salt) {
    this.salt = salt;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConfirmDeviceRequestDeviceSecretVerifierConfig confirmDeviceRequestDeviceSecretVerifierConfig = (ConfirmDeviceRequestDeviceSecretVerifierConfig) o;
    return Objects.equals(this.passwordVerifier, confirmDeviceRequestDeviceSecretVerifierConfig.passwordVerifier) &&
        Objects.equals(this.salt, confirmDeviceRequestDeviceSecretVerifierConfig.salt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(passwordVerifier, salt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConfirmDeviceRequestDeviceSecretVerifierConfig {\n");
    sb.append("    passwordVerifier: ").append(toIndentedString(passwordVerifier)).append("\n");
  ...
  static {
    ...
    openapiFields.add("PasswordVerifier");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfirmDeviceRequestDeviceSecretVerifierConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfirmDeviceRequestDeviceSecretVerifierConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfirmDeviceRequestDeviceSecretVerifierConfig is not found in the empty JSON string", ConfirmDeviceRequestDeviceSecretVerifierConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfirmDeviceRequestDeviceSecretVerifierConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfirmDeviceRequestDeviceSecretVerifierConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `PasswordVerifier`
      if (jsonObj.get("PasswordVerifier") != null && !jsonObj.get("PasswordVerifier").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("PasswordVerifier"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfirmDeviceRequestDeviceSecretVerifierConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfirmDeviceRequestDeviceSecretVerifierConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfirmDeviceRequestDeviceSecretVerifierConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfirmDeviceRequestDeviceSecretVerifierConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfirmDeviceRequestDeviceSecretVerifierConfig>() {
           @Override
           public void write(JsonWriter out, ConfirmDeviceRequestDeviceSecretVerifierConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfirmDeviceRequestDeviceSecretVerifierConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfirmDeviceRequestDeviceSecretVerifierConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfirmDeviceRequestDeviceSecretVerifierConfig
   * @throws IOException if the JSON string is invalid with respect to ConfirmDeviceRequestDeviceSecretVerifierConfig
   */
  public static ConfirmDeviceRequestDeviceSecretVerifierConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfirmDeviceRequestDeviceSecretVerifierConfig.class);
  }

  /**
   * Convert an instance of ConfirmDeviceRequestDeviceSecretVerifierConfig to an JSON string
   *
   * @return JSON string
   */
