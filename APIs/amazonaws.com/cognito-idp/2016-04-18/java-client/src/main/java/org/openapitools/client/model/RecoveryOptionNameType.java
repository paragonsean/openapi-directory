...
/**
 * Gets or Sets RecoveryOptionNameType
 */
@JsonAdapter(RecoveryOptionNameType.Adapter.class)
public enum RecoveryOptionNameType {
  ...
  RecoveryOptionNameType(String value) {
    this.value = value;
  }
  ...
  public static RecoveryOptionNameType fromValue(String value) {
    for (RecoveryOptionNameType b : RecoveryOptionNameType.values()) {
  ...
  public static class Adapter extends TypeAdapter<RecoveryOptionNameType> {
    @Override
    public void write(final JsonWriter jsonWriter, final RecoveryOptionNameType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RecoveryOptionNameType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RecoveryOptionNameType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RecoveryOptionNameType.fromValue(value);
  }
}
