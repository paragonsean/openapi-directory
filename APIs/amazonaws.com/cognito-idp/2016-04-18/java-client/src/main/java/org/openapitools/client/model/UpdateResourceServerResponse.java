...
import org.openapitools.client.model.DescribeResourceServerResponseResourceServer;
...
public class UpdateResourceServerResponse {
  public static final String SERIALIZED_NAME_RESOURCE_SERVER = "ResourceServer";
  @SerializedName(SERIALIZED_NAME_RESOURCE_SERVER)
  private DescribeResourceServerResponseResourceServer resourceServer;

  public UpdateResourceServerResponse() {
  }

  public UpdateResourceServerResponse resourceServer(DescribeResourceServerResponseResourceServer resourceServer) {
  ...
  public DescribeResourceServerResponseResourceServer getResourceServer() {
    return resourceServer;
  }

  public void setResourceServer(DescribeResourceServerResponseResourceServer resourceServer) {
    this.resourceServer = resourceServer;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateResourceServerResponse updateResourceServerResponse = (UpdateResourceServerResponse) o;
    return Objects.equals(this.resourceServer, updateResourceServerResponse.resourceServer);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceServer);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateResourceServerResponse {\n");
  ...
  static {
    ...
    openapiFields.add("ResourceServer");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("ResourceServer");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateResourceServerResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateResourceServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateResourceServerResponse is not found in the empty JSON string", UpdateResourceServerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateResourceServerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateResourceServerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateResourceServerResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `ResourceServer`
      DescribeResourceServerResponseResourceServer.validateJsonElement(jsonObj.get("ResourceServer"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateResourceServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateResourceServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateResourceServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateResourceServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateResourceServerResponse>() {
           @Override
           public void write(JsonWriter out, UpdateResourceServerResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateResourceServerResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateResourceServerResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateResourceServerResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateResourceServerResponse
   */
  public static UpdateResourceServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateResourceServerResponse.class);
  }

  /**
   * Convert an instance of UpdateResourceServerResponse to an JSON string
   *
   * @return JSON string
   */
