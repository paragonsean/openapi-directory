...
public class SchemaAttributeTypeNumberAttributeConstraints {
  ...
  public SchemaAttributeTypeNumberAttributeConstraints() {
  }

  public SchemaAttributeTypeNumberAttributeConstraints minValue(String minValue) {
  ...
  public SchemaAttributeTypeNumberAttributeConstraints maxValue(String maxValue) {
  ...
  public boolean equals(Object o) {
    ...
    SchemaAttributeTypeNumberAttributeConstraints schemaAttributeTypeNumberAttributeConstraints = (SchemaAttributeTypeNumberAttributeConstraints) o;
    return Objects.equals(this.minValue, schemaAttributeTypeNumberAttributeConstraints.minValue) &&
        Objects.equals(this.maxValue, schemaAttributeTypeNumberAttributeConstraints.maxValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class SchemaAttributeTypeNumberAttributeConstraints {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SchemaAttributeTypeNumberAttributeConstraints
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SchemaAttributeTypeNumberAttributeConstraints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SchemaAttributeTypeNumberAttributeConstraints is not found in the empty JSON string", SchemaAttributeTypeNumberAttributeConstraints.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SchemaAttributeTypeNumberAttributeConstraints.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SchemaAttributeTypeNumberAttributeConstraints` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SchemaAttributeTypeNumberAttributeConstraints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SchemaAttributeTypeNumberAttributeConstraints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SchemaAttributeTypeNumberAttributeConstraints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SchemaAttributeTypeNumberAttributeConstraints.class));

       return (TypeAdapter<T>) new TypeAdapter<SchemaAttributeTypeNumberAttributeConstraints>() {
           @Override
           public void write(JsonWriter out, SchemaAttributeTypeNumberAttributeConstraints value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SchemaAttributeTypeNumberAttributeConstraints read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SchemaAttributeTypeNumberAttributeConstraints given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SchemaAttributeTypeNumberAttributeConstraints
   * @throws IOException if the JSON string is invalid with respect to SchemaAttributeTypeNumberAttributeConstraints
   */
  public static SchemaAttributeTypeNumberAttributeConstraints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SchemaAttributeTypeNumberAttributeConstraints.class);
  }

  /**
   * Convert an instance of SchemaAttributeTypeNumberAttributeConstraints to an JSON string
   *
   * @return JSON string
   */
