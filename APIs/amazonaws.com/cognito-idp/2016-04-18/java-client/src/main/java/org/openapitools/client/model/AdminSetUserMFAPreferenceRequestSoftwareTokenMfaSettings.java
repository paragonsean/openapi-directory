...
public class AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings {
  public static final String SERIALIZED_NAME_ENABLED = "Enabled";
  @SerializedName(SERIALIZED_NAME_ENABLED)
  private Boolean enabled;

  public static final String SERIALIZED_NAME_PREFERRED_MFA = "PreferredMfa";
  @SerializedName(SERIALIZED_NAME_PREFERRED_MFA)
  private Boolean preferredMfa;

  public AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings() {
  }

  public AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings enabled(Boolean enabled) {
  ...
  public AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings preferredMfa(Boolean preferredMfa) {
  ...
  public boolean equals(Object o) {
    ...
    AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings adminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings = (AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings) o;
    return Objects.equals(this.enabled, adminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.enabled) &&
        Objects.equals(this.preferredMfa, adminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.preferredMfa);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, preferredMfa);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings is not found in the empty JSON string", AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `PreferredMfa`
      if (jsonObj.get("PreferredMfa") != null && !jsonObj.get("PreferredMfa").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("PreferredMfa"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings>() {
           @Override
           public void write(JsonWriter out, AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings
   * @throws IOException if the JSON string is invalid with respect to AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings
   */
  public static AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.class);
  }

  /**
   * Convert an instance of AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings to an JSON string
   *
   * @return JSON string
   */
