...
public class AdminListGroupsForUserRequest {
  ...
  public AdminListGroupsForUserRequest username(String username) {
  ...
  public AdminListGroupsForUserRequest userPoolId(String userPoolId) {
  ...
  public AdminListGroupsForUserRequest limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public AdminListGroupsForUserRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    AdminListGroupsForUserRequest adminListGroupsForUserRequest = (AdminListGroupsForUserRequest) o;
    return Objects.equals(this.username, adminListGroupsForUserRequest.username) &&
        Objects.equals(this.userPoolId, adminListGroupsForUserRequest.userPoolId) &&
        Objects.equals(this.limit, adminListGroupsForUserRequest.limit) &&
        Objects.equals(this.nextToken, adminListGroupsForUserRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(username, userPoolId, limit, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminListGroupsForUserRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminListGroupsForUserRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminListGroupsForUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminListGroupsForUserRequest is not found in the empty JSON string", AdminListGroupsForUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminListGroupsForUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminListGroupsForUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminListGroupsForUserRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminListGroupsForUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminListGroupsForUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminListGroupsForUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminListGroupsForUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminListGroupsForUserRequest>() {
           @Override
           public void write(JsonWriter out, AdminListGroupsForUserRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminListGroupsForUserRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminListGroupsForUserRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminListGroupsForUserRequest
   * @throws IOException if the JSON string is invalid with respect to AdminListGroupsForUserRequest
   */
  public static AdminListGroupsForUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminListGroupsForUserRequest.class);
  }

  /**
   * Convert an instance of AdminListGroupsForUserRequest to an JSON string
   *
   * @return JSON string
   */
