...
public class GetSigningCertificateResponse {
  ...
  public GetSigningCertificateResponse certificate(String certificate) {
  ...
  public boolean equals(Object o) {
    ...
    GetSigningCertificateResponse getSigningCertificateResponse = (GetSigningCertificateResponse) o;
    return Objects.equals(this.certificate, getSigningCertificateResponse.certificate);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSigningCertificateResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSigningCertificateResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSigningCertificateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSigningCertificateResponse is not found in the empty JSON string", GetSigningCertificateResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSigningCertificateResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSigningCertificateResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSigningCertificateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSigningCertificateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSigningCertificateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSigningCertificateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSigningCertificateResponse>() {
           @Override
           public void write(JsonWriter out, GetSigningCertificateResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSigningCertificateResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSigningCertificateResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSigningCertificateResponse
   * @throws IOException if the JSON string is invalid with respect to GetSigningCertificateResponse
   */
  public static GetSigningCertificateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSigningCertificateResponse.class);
  }

  /**
   * Convert an instance of GetSigningCertificateResponse to an JSON string
   *
   * @return JSON string
   */
