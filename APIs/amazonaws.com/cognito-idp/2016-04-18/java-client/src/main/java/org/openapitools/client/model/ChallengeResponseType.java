...
import org.openapitools.client.model.ChallengeName;
import org.openapitools.client.model.ChallengeResponse;
...
public class ChallengeResponseType {
  ...
  public ChallengeResponseType challengeName(ChallengeName challengeName) {
  ...
  public ChallengeResponseType challengeResponse(ChallengeResponse challengeResponse) {
  ...
  public boolean equals(Object o) {
    ...
    ChallengeResponseType challengeResponseType = (ChallengeResponseType) o;
    return Objects.equals(this.challengeName, challengeResponseType.challengeName) &&
        Objects.equals(this.challengeResponse, challengeResponseType.challengeResponse);
  }

  @Override
  public int hashCode() {
    return Objects.hash(challengeName, challengeResponse);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ChallengeResponseType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChallengeResponseType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChallengeResponseType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChallengeResponseType is not found in the empty JSON string", ChallengeResponseType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChallengeResponseType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChallengeResponseType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ChallengeName`
      if (jsonObj.get("ChallengeName") != null && !jsonObj.get("ChallengeName").isJsonNull()) {
        ChallengeName.validateJsonElement(jsonObj.get("ChallengeName"));
      }
      ...
      if (jsonObj.get("ChallengeResponse") != null && !jsonObj.get("ChallengeResponse").isJsonNull()) {
        ChallengeResponse.validateJsonElement(jsonObj.get("ChallengeResponse"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChallengeResponseType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChallengeResponseType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChallengeResponseType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChallengeResponseType.class));

       return (TypeAdapter<T>) new TypeAdapter<ChallengeResponseType>() {
           @Override
           public void write(JsonWriter out, ChallengeResponseType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChallengeResponseType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChallengeResponseType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChallengeResponseType
   * @throws IOException if the JSON string is invalid with respect to ChallengeResponseType
   */
  public static ChallengeResponseType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChallengeResponseType.class);
  }

  /**
   * Convert an instance of ChallengeResponseType to an JSON string
   *
   * @return JSON string
   */
