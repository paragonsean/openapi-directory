...
public class UICustomizationType {
  ...
  public UICustomizationType userPoolId(String userPoolId) {
  ...
  public UICustomizationType clientId(String clientId) {
  ...
  public UICustomizationType imageUrl(String imageUrl) {
  ...
  public UICustomizationType CSS(String CSS) {
    this.CSS = CSS;
    return this;
  }
  ...
  public UICustomizationType csSVersion(String csSVersion) {
  ...
  public UICustomizationType lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public UICustomizationType creationDate(OffsetDateTime creationDate) {
  ...
  public boolean equals(Object o) {
    ...
    UICustomizationType uiCustomizationType = (UICustomizationType) o;
    return Objects.equals(this.userPoolId, uiCustomizationType.userPoolId) &&
        Objects.equals(this.clientId, uiCustomizationType.clientId) &&
        Objects.equals(this.imageUrl, uiCustomizationType.imageUrl) &&
        Objects.equals(this.CSS, uiCustomizationType.CSS) &&
        Objects.equals(this.csSVersion, uiCustomizationType.csSVersion) &&
        Objects.equals(this.lastModifiedDate, uiCustomizationType.lastModifiedDate) &&
        Objects.equals(this.creationDate, uiCustomizationType.creationDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class UICustomizationType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UICustomizationType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UICustomizationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UICustomizationType is not found in the empty JSON string", UICustomizationType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UICustomizationType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UICustomizationType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UICustomizationType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UICustomizationType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UICustomizationType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UICustomizationType.class));

       return (TypeAdapter<T>) new TypeAdapter<UICustomizationType>() {
           @Override
           public void write(JsonWriter out, UICustomizationType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UICustomizationType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UICustomizationType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UICustomizationType
   * @throws IOException if the JSON string is invalid with respect to UICustomizationType
   */
  public static UICustomizationType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UICustomizationType.class);
  }

  /**
   * Convert an instance of UICustomizationType to an JSON string
   *
   * @return JSON string
   */
