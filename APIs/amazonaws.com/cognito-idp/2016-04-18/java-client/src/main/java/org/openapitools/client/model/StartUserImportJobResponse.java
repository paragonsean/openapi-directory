...
import org.openapitools.client.model.CreateUserImportJobResponseUserImportJob;
...
public class StartUserImportJobResponse {
  public static final String SERIALIZED_NAME_USER_IMPORT_JOB = "UserImportJob";
  @SerializedName(SERIALIZED_NAME_USER_IMPORT_JOB)
  private CreateUserImportJobResponseUserImportJob userImportJob;

  public StartUserImportJobResponse() {
  }

  public StartUserImportJobResponse userImportJob(CreateUserImportJobResponseUserImportJob userImportJob) {
  ...
  public CreateUserImportJobResponseUserImportJob getUserImportJob() {
    return userImportJob;
  }

  public void setUserImportJob(CreateUserImportJobResponseUserImportJob userImportJob) {
    this.userImportJob = userImportJob;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartUserImportJobResponse startUserImportJobResponse = (StartUserImportJobResponse) o;
    return Objects.equals(this.userImportJob, startUserImportJobResponse.userImportJob);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userImportJob);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartUserImportJobResponse {\n");
    sb.append("    userImportJob: ").append(toIndentedString(userImportJob)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("UserImportJob");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartUserImportJobResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartUserImportJobResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartUserImportJobResponse is not found in the empty JSON string", StartUserImportJobResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartUserImportJobResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartUserImportJobResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `UserImportJob`
      if (jsonObj.get("UserImportJob") != null && !jsonObj.get("UserImportJob").isJsonNull()) {
        CreateUserImportJobResponseUserImportJob.validateJsonElement(jsonObj.get("UserImportJob"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartUserImportJobResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartUserImportJobResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartUserImportJobResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartUserImportJobResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartUserImportJobResponse>() {
           @Override
           public void write(JsonWriter out, StartUserImportJobResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartUserImportJobResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartUserImportJobResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartUserImportJobResponse
   * @throws IOException if the JSON string is invalid with respect to StartUserImportJobResponse
   */
  public static StartUserImportJobResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartUserImportJobResponse.class);
  }

  /**
   * Convert an instance of StartUserImportJobResponse to an JSON string
   *
   * @return JSON string
   */
