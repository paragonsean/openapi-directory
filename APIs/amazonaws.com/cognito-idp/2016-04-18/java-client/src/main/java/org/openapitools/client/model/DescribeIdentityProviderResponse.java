...
public class DescribeIdentityProviderResponse {
  ...
  public DescribeIdentityProviderResponse() {
  }

  public DescribeIdentityProviderResponse identityProvider(DescribeIdentityProviderResponseIdentityProvider identityProvider) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeIdentityProviderResponse describeIdentityProviderResponse = (DescribeIdentityProviderResponse) o;
    return Objects.equals(this.identityProvider, describeIdentityProviderResponse.identityProvider);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeIdentityProviderResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeIdentityProviderResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeIdentityProviderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeIdentityProviderResponse is not found in the empty JSON string", DescribeIdentityProviderResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeIdentityProviderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeIdentityProviderResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeIdentityProviderResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeIdentityProviderResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeIdentityProviderResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeIdentityProviderResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeIdentityProviderResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeIdentityProviderResponse>() {
           @Override
           public void write(JsonWriter out, DescribeIdentityProviderResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeIdentityProviderResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeIdentityProviderResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeIdentityProviderResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeIdentityProviderResponse
   */
  public static DescribeIdentityProviderResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeIdentityProviderResponse.class);
  }

  /**
   * Convert an instance of DescribeIdentityProviderResponse to an JSON string
   *
   * @return JSON string
   */
