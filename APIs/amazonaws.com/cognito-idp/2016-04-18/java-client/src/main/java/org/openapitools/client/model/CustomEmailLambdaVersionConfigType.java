...
public class CustomEmailLambdaVersionConfigType {
  ...
  private CustomEmailSenderLambdaVersionType lambdaVersion;

  public static final String SERIALIZED_NAME_LAMBDA_ARN = "LambdaArn";
  @SerializedName(SERIALIZED_NAME_LAMBDA_ARN)
  private String lambdaArn;

  public CustomEmailLambdaVersionConfigType() {
  }

  public CustomEmailLambdaVersionConfigType lambdaVersion(CustomEmailSenderLambdaVersionType lambdaVersion) {
  ...
  public CustomEmailSenderLambdaVersionType getLambdaVersion() {
    return lambdaVersion;
  }
  ...
  public CustomEmailLambdaVersionConfigType lambdaArn(String lambdaArn) {
  ...
  public boolean equals(Object o) {
    ...
    CustomEmailLambdaVersionConfigType customEmailLambdaVersionConfigType = (CustomEmailLambdaVersionConfigType) o;
    return Objects.equals(this.lambdaVersion, customEmailLambdaVersionConfigType.lambdaVersion) &&
        Objects.equals(this.lambdaArn, customEmailLambdaVersionConfigType.lambdaArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomEmailLambdaVersionConfigType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomEmailLambdaVersionConfigType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomEmailLambdaVersionConfigType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomEmailLambdaVersionConfigType is not found in the empty JSON string", CustomEmailLambdaVersionConfigType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomEmailLambdaVersionConfigType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomEmailLambdaVersionConfigType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustomEmailLambdaVersionConfigType.openapiRequiredFields) {
      ...
      CustomEmailSenderLambdaVersionType.validateJsonElement(jsonObj.get("LambdaVersion"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomEmailLambdaVersionConfigType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomEmailLambdaVersionConfigType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomEmailLambdaVersionConfigType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomEmailLambdaVersionConfigType.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomEmailLambdaVersionConfigType>() {
           @Override
           public void write(JsonWriter out, CustomEmailLambdaVersionConfigType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomEmailLambdaVersionConfigType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomEmailLambdaVersionConfigType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomEmailLambdaVersionConfigType
   * @throws IOException if the JSON string is invalid with respect to CustomEmailLambdaVersionConfigType
   */
  public static CustomEmailLambdaVersionConfigType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomEmailLambdaVersionConfigType.class);
  }

  /**
   * Convert an instance of CustomEmailLambdaVersionConfigType to an JSON string
   *
   * @return JSON string
   */
