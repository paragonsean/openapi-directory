...
/**
 * Gets or Sets ExplicitAuthFlowsType
 */
@JsonAdapter(ExplicitAuthFlowsType.Adapter.class)
public enum ExplicitAuthFlowsType {
  ...
  ExplicitAuthFlowsType(String value) {
    this.value = value;
  }
  ...
  public static ExplicitAuthFlowsType fromValue(String value) {
    for (ExplicitAuthFlowsType b : ExplicitAuthFlowsType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ExplicitAuthFlowsType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ExplicitAuthFlowsType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ExplicitAuthFlowsType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ExplicitAuthFlowsType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ExplicitAuthFlowsType.fromValue(value);
  }
}
