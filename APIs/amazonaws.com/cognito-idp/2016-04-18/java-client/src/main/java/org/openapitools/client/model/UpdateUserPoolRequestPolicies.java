...
public class UpdateUserPoolRequestPolicies {
  public static final String SERIALIZED_NAME_PASSWORD_POLICY = "PasswordPolicy";
  @SerializedName(SERIALIZED_NAME_PASSWORD_POLICY)
  private UserPoolPolicyTypePasswordPolicy passwordPolicy;

  public UpdateUserPoolRequestPolicies() {
  }

  public UpdateUserPoolRequestPolicies passwordPolicy(UserPoolPolicyTypePasswordPolicy passwordPolicy) {
  ...
  public UserPoolPolicyTypePasswordPolicy getPasswordPolicy() {
    return passwordPolicy;
  }

  public void setPasswordPolicy(UserPoolPolicyTypePasswordPolicy passwordPolicy) {
    this.passwordPolicy = passwordPolicy;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateUserPoolRequestPolicies updateUserPoolRequestPolicies = (UpdateUserPoolRequestPolicies) o;
    return Objects.equals(this.passwordPolicy, updateUserPoolRequestPolicies.passwordPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateUserPoolRequestPolicies {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserPoolRequestPolicies
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserPoolRequestPolicies.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserPoolRequestPolicies is not found in the empty JSON string", UpdateUserPoolRequestPolicies.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserPoolRequestPolicies.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserPoolRequestPolicies` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("PasswordPolicy") != null && !jsonObj.get("PasswordPolicy").isJsonNull()) {
        UserPoolPolicyTypePasswordPolicy.validateJsonElement(jsonObj.get("PasswordPolicy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserPoolRequestPolicies.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserPoolRequestPolicies' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserPoolRequestPolicies> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserPoolRequestPolicies.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserPoolRequestPolicies>() {
           @Override
           public void write(JsonWriter out, UpdateUserPoolRequestPolicies value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserPoolRequestPolicies read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserPoolRequestPolicies given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserPoolRequestPolicies
   * @throws IOException if the JSON string is invalid with respect to UpdateUserPoolRequestPolicies
   */
  public static UpdateUserPoolRequestPolicies fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserPoolRequestPolicies.class);
  }

  /**
   * Convert an instance of UpdateUserPoolRequestPolicies to an JSON string
   *
   * @return JSON string
   */
