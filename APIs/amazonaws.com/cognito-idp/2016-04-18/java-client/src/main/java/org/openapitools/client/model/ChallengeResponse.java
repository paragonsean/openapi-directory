...
/**
 * Gets or Sets ChallengeResponse
 */
@JsonAdapter(ChallengeResponse.Adapter.class)
public enum ChallengeResponse {
  ...
  ChallengeResponse(String value) {
    this.value = value;
  }
  ...
  public static ChallengeResponse fromValue(String value) {
    for (ChallengeResponse b : ChallengeResponse.values()) {
  ...
  public static class Adapter extends TypeAdapter<ChallengeResponse> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChallengeResponse enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ChallengeResponse read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ChallengeResponse.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ChallengeResponse.fromValue(value);
  }
}
