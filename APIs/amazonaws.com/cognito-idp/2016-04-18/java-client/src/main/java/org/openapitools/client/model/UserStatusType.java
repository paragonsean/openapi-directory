...
/**
 * Gets or Sets UserStatusType
 */
@JsonAdapter(UserStatusType.Adapter.class)
public enum UserStatusType {
  ...
  public static class Adapter extends TypeAdapter<UserStatusType> {
    @Override
    public void write(final JsonWriter jsonWriter, final UserStatusType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UserStatusType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UserStatusType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UserStatusType.fromValue(value);
  }
}
