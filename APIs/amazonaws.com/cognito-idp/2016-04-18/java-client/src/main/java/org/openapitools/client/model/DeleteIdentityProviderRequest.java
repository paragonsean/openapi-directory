...
public class DeleteIdentityProviderRequest {
  ...
  public DeleteIdentityProviderRequest userPoolId(String userPoolId) {
  ...
  public DeleteIdentityProviderRequest providerName(String providerName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolId, deleteIdentityProviderRequest.userPoolId) &&
        Objects.equals(this.providerName, deleteIdentityProviderRequest.providerName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, providerName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteIdentityProviderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteIdentityProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteIdentityProviderRequest is not found in the empty JSON string", DeleteIdentityProviderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteIdentityProviderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteIdentityProviderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteIdentityProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteIdentityProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteIdentityProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteIdentityProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteIdentityProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteIdentityProviderRequest>() {
           @Override
           public void write(JsonWriter out, DeleteIdentityProviderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteIdentityProviderRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteIdentityProviderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteIdentityProviderRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteIdentityProviderRequest
   */
  public static DeleteIdentityProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteIdentityProviderRequest.class);
  }

  /**
   * Convert an instance of DeleteIdentityProviderRequest to an JSON string
   *
   * @return JSON string
   */
