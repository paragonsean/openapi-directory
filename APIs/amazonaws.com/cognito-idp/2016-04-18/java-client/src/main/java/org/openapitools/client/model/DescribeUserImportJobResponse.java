...
public class DescribeUserImportJobResponse {
  ...
  public DescribeUserImportJobResponse userImportJob(CreateUserImportJobResponseUserImportJob userImportJob) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeUserImportJobResponse describeUserImportJobResponse = (DescribeUserImportJobResponse) o;
    return Objects.equals(this.userImportJob, describeUserImportJobResponse.userImportJob);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeUserImportJobResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUserImportJobResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUserImportJobResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUserImportJobResponse is not found in the empty JSON string", DescribeUserImportJobResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUserImportJobResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUserImportJobResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUserImportJobResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUserImportJobResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUserImportJobResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUserImportJobResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUserImportJobResponse>() {
           @Override
           public void write(JsonWriter out, DescribeUserImportJobResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUserImportJobResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUserImportJobResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUserImportJobResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeUserImportJobResponse
   */
  public static DescribeUserImportJobResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUserImportJobResponse.class);
  }

  /**
   * Convert an instance of DescribeUserImportJobResponse to an JSON string
   *
   * @return JSON string
   */
