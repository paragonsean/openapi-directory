...
/**
 * Gets or Sets DomainStatusType
 */
@JsonAdapter(DomainStatusType.Adapter.class)
public enum DomainStatusType {
  ...
  public static DomainStatusType fromValue(String value) {
    for (DomainStatusType b : DomainStatusType.values()) {
  ...
  public static class Adapter extends TypeAdapter<DomainStatusType> {
    @Override
    public void write(final JsonWriter jsonWriter, final DomainStatusType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DomainStatusType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DomainStatusType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DomainStatusType.fromValue(value);
  }
}
