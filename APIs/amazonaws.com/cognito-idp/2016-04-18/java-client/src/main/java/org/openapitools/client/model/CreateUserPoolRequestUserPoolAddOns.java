...
import org.openapitools.client.model.AdvancedSecurityModeType;
...
public class CreateUserPoolRequestUserPoolAddOns {
  public static final String SERIALIZED_NAME_ADVANCED_SECURITY_MODE = "AdvancedSecurityMode";
  @SerializedName(SERIALIZED_NAME_ADVANCED_SECURITY_MODE)
  private AdvancedSecurityModeType advancedSecurityMode;

  public CreateUserPoolRequestUserPoolAddOns() {
  }

  public CreateUserPoolRequestUserPoolAddOns advancedSecurityMode(AdvancedSecurityModeType advancedSecurityMode) {
  ...
  public AdvancedSecurityModeType getAdvancedSecurityMode() {
    return advancedSecurityMode;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateUserPoolRequestUserPoolAddOns createUserPoolRequestUserPoolAddOns = (CreateUserPoolRequestUserPoolAddOns) o;
    return Objects.equals(this.advancedSecurityMode, createUserPoolRequestUserPoolAddOns.advancedSecurityMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(advancedSecurityMode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateUserPoolRequestUserPoolAddOns {\n");
    sb.append("    advancedSecurityMode: ").append(toIndentedString(advancedSecurityMode)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("AdvancedSecurityMode");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("AdvancedSecurityMode");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolRequestUserPoolAddOns
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolRequestUserPoolAddOns.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolRequestUserPoolAddOns is not found in the empty JSON string", CreateUserPoolRequestUserPoolAddOns.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolRequestUserPoolAddOns.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolRequestUserPoolAddOns` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateUserPoolRequestUserPoolAddOns.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `AdvancedSecurityMode`
      AdvancedSecurityModeType.validateJsonElement(jsonObj.get("AdvancedSecurityMode"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolRequestUserPoolAddOns.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolRequestUserPoolAddOns' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolRequestUserPoolAddOns> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolRequestUserPoolAddOns.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolRequestUserPoolAddOns>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolRequestUserPoolAddOns value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolRequestUserPoolAddOns read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolRequestUserPoolAddOns given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolRequestUserPoolAddOns
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolRequestUserPoolAddOns
   */
  public static CreateUserPoolRequestUserPoolAddOns fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolRequestUserPoolAddOns.class);
  }

  /**
   * Convert an instance of CreateUserPoolRequestUserPoolAddOns to an JSON string
   *
   * @return JSON string
   */
