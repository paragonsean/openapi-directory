...
public class GetUICustomizationResponseUICustomization {
  ...
  public static final String SERIALIZED_NAME_CS_S_VERSION = "CSSVersion";
  @SerializedName(SERIALIZED_NAME_CS_S_VERSION)
  ...
  public GetUICustomizationResponseUICustomization() {
  }

  public GetUICustomizationResponseUICustomization userPoolId(String userPoolId) {
  ...
  public GetUICustomizationResponseUICustomization clientId(String clientId) {
  ...
  public GetUICustomizationResponseUICustomization imageUrl(String imageUrl) {
  ...
  public GetUICustomizationResponseUICustomization CSS(String CSS) {
    this.CSS = CSS;
    return this;
  }
  ...
  public GetUICustomizationResponseUICustomization csSVersion(String csSVersion) {
  ...
  public GetUICustomizationResponseUICustomization lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public GetUICustomizationResponseUICustomization creationDate(OffsetDateTime creationDate) {
  ...
  public boolean equals(Object o) {
    ...
    GetUICustomizationResponseUICustomization getUICustomizationResponseUICustomization = (GetUICustomizationResponseUICustomization) o;
    return Objects.equals(this.userPoolId, getUICustomizationResponseUICustomization.userPoolId) &&
        Objects.equals(this.clientId, getUICustomizationResponseUICustomization.clientId) &&
        Objects.equals(this.imageUrl, getUICustomizationResponseUICustomization.imageUrl) &&
        Objects.equals(this.CSS, getUICustomizationResponseUICustomization.CSS) &&
        Objects.equals(this.csSVersion, getUICustomizationResponseUICustomization.csSVersion) &&
        Objects.equals(this.lastModifiedDate, getUICustomizationResponseUICustomization.lastModifiedDate) &&
        Objects.equals(this.creationDate, getUICustomizationResponseUICustomization.creationDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, clientId, imageUrl, CSS, csSVersion, lastModifiedDate, creationDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetUICustomizationResponseUICustomization {\n");
    ...
    sb.append("    csSVersion: ").append(toIndentedString(csSVersion)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUICustomizationResponseUICustomization
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUICustomizationResponseUICustomization.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUICustomizationResponseUICustomization is not found in the empty JSON string", GetUICustomizationResponseUICustomization.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUICustomizationResponseUICustomization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUICustomizationResponseUICustomization` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("CSS") != null && !jsonObj.get("CSS").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("CSS"));
      }
      // validate the optional field `CSSVersion`
      if (jsonObj.get("CSSVersion") != null && !jsonObj.get("CSSVersion").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("CSSVersion"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUICustomizationResponseUICustomization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUICustomizationResponseUICustomization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUICustomizationResponseUICustomization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUICustomizationResponseUICustomization.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUICustomizationResponseUICustomization>() {
           @Override
           public void write(JsonWriter out, GetUICustomizationResponseUICustomization value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUICustomizationResponseUICustomization read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUICustomizationResponseUICustomization given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUICustomizationResponseUICustomization
   * @throws IOException if the JSON string is invalid with respect to GetUICustomizationResponseUICustomization
   */
  public static GetUICustomizationResponseUICustomization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUICustomizationResponseUICustomization.class);
  }

  /**
   * Convert an instance of GetUICustomizationResponseUICustomization to an JSON string
   *
   * @return JSON string
   */
