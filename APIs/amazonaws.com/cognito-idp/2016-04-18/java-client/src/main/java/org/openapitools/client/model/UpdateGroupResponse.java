...
public class UpdateGroupResponse {
  ...
  public UpdateGroupResponse group(CreateGroupResponseGroup group) {
    this.group = group;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.group, updateGroupResponse.group);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGroupResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGroupResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGroupResponse is not found in the empty JSON string", UpdateGroupResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGroupResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGroupResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Group`
      if (jsonObj.get("Group") != null && !jsonObj.get("Group").isJsonNull()) {
        CreateGroupResponseGroup.validateJsonElement(jsonObj.get("Group"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGroupResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGroupResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGroupResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGroupResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGroupResponse>() {
           @Override
           public void write(JsonWriter out, UpdateGroupResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGroupResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGroupResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGroupResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateGroupResponse
   */
  public static UpdateGroupResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGroupResponse.class);
  }

  /**
   * Convert an instance of UpdateGroupResponse to an JSON string
   *
   * @return JSON string
   */
