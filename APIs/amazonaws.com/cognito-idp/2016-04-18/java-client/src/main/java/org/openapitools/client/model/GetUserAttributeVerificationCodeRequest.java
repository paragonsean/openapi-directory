...
public class GetUserAttributeVerificationCodeRequest {
  ...
  public GetUserAttributeVerificationCodeRequest accessToken(String accessToken) {
  ...
  public GetUserAttributeVerificationCodeRequest attributeName(String attributeName) {
  ...
  public GetUserAttributeVerificationCodeRequest clientMetadata(Map clientMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    GetUserAttributeVerificationCodeRequest getUserAttributeVerificationCodeRequest = (GetUserAttributeVerificationCodeRequest) o;
    return Objects.equals(this.accessToken, getUserAttributeVerificationCodeRequest.accessToken) &&
        Objects.equals(this.attributeName, getUserAttributeVerificationCodeRequest.attributeName) &&
        Objects.equals(this.clientMetadata, getUserAttributeVerificationCodeRequest.clientMetadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, attributeName, clientMetadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetUserAttributeVerificationCodeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUserAttributeVerificationCodeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUserAttributeVerificationCodeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUserAttributeVerificationCodeRequest is not found in the empty JSON string", GetUserAttributeVerificationCodeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUserAttributeVerificationCodeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUserAttributeVerificationCodeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetUserAttributeVerificationCodeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUserAttributeVerificationCodeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUserAttributeVerificationCodeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUserAttributeVerificationCodeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUserAttributeVerificationCodeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUserAttributeVerificationCodeRequest>() {
           @Override
           public void write(JsonWriter out, GetUserAttributeVerificationCodeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUserAttributeVerificationCodeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUserAttributeVerificationCodeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUserAttributeVerificationCodeRequest
   * @throws IOException if the JSON string is invalid with respect to GetUserAttributeVerificationCodeRequest
   */
  public static GetUserAttributeVerificationCodeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUserAttributeVerificationCodeRequest.class);
  }

  /**
   * Convert an instance of GetUserAttributeVerificationCodeRequest to an JSON string
   *
   * @return JSON string
   */
