...
public class CreateUserPoolRequestAccountRecoverySetting {
  public static final String SERIALIZED_NAME_RECOVERY_MECHANISMS = "RecoveryMechanisms";
  @SerializedName(SERIALIZED_NAME_RECOVERY_MECHANISMS)
  private List recoveryMechanisms;

  public CreateUserPoolRequestAccountRecoverySetting() {
  }

  public CreateUserPoolRequestAccountRecoverySetting recoveryMechanisms(List recoveryMechanisms) {
    this.recoveryMechanisms = recoveryMechanisms;
    return this;
  }

  /**
   * Get recoveryMechanisms
  ...
  public void setRecoveryMechanisms(List recoveryMechanisms) {
    this.recoveryMechanisms = recoveryMechanisms;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateUserPoolRequestAccountRecoverySetting createUserPoolRequestAccountRecoverySetting = (CreateUserPoolRequestAccountRecoverySetting) o;
    return Objects.equals(this.recoveryMechanisms, createUserPoolRequestAccountRecoverySetting.recoveryMechanisms);
  }

  @Override
  public int hashCode() {
    return Objects.hash(recoveryMechanisms);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateUserPoolRequestAccountRecoverySetting {\n");
    sb.append("    recoveryMechanisms: ").append(toIndentedString(recoveryMechanisms)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("RecoveryMechanisms");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolRequestAccountRecoverySetting
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolRequestAccountRecoverySetting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolRequestAccountRecoverySetting is not found in the empty JSON string", CreateUserPoolRequestAccountRecoverySetting.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolRequestAccountRecoverySetting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolRequestAccountRecoverySetting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `RecoveryMechanisms`
      if (jsonObj.get("RecoveryMechanisms") != null && !jsonObj.get("RecoveryMechanisms").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("RecoveryMechanisms"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolRequestAccountRecoverySetting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolRequestAccountRecoverySetting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolRequestAccountRecoverySetting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolRequestAccountRecoverySetting.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolRequestAccountRecoverySetting>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolRequestAccountRecoverySetting value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolRequestAccountRecoverySetting read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolRequestAccountRecoverySetting given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolRequestAccountRecoverySetting
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolRequestAccountRecoverySetting
   */
  public static CreateUserPoolRequestAccountRecoverySetting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolRequestAccountRecoverySetting.class);
  }

  /**
   * Convert an instance of CreateUserPoolRequestAccountRecoverySetting to an JSON string
   *
   * @return JSON string
   */
