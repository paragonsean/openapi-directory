...
public class ProviderDescription {
  ...
  public ProviderDescription providerName(String providerName) {
  ...
  public ProviderDescription providerType(IdentityProviderTypeType providerType) {
  ...
  public ProviderDescription lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public ProviderDescription creationDate(OffsetDateTime creationDate) {
  ...
  public boolean equals(Object o) {
    ...
    ProviderDescription providerDescription = (ProviderDescription) o;
    return Objects.equals(this.providerName, providerDescription.providerName) &&
        Objects.equals(this.providerType, providerDescription.providerType) &&
        Objects.equals(this.lastModifiedDate, providerDescription.lastModifiedDate) &&
        Objects.equals(this.creationDate, providerDescription.creationDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(providerName, providerType, lastModifiedDate, creationDate);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProviderDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProviderDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProviderDescription is not found in the empty JSON string", ProviderDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProviderDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProviderDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProviderDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProviderDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProviderDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProviderDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<ProviderDescription>() {
           @Override
           public void write(JsonWriter out, ProviderDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProviderDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProviderDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProviderDescription
   * @throws IOException if the JSON string is invalid with respect to ProviderDescription
   */
  public static ProviderDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProviderDescription.class);
  }

  /**
   * Convert an instance of ProviderDescription to an JSON string
   *
   * @return JSON string
   */
