...
/**
 * Gets or Sets UserImportJobStatusType
 */
@JsonAdapter(UserImportJobStatusType.Adapter.class)
public enum UserImportJobStatusType {
  ...
  UserImportJobStatusType(String value) {
    this.value = value;
  }
  ...
  public static UserImportJobStatusType fromValue(String value) {
    for (UserImportJobStatusType b : UserImportJobStatusType.values()) {
  ...
  public static class Adapter extends TypeAdapter<UserImportJobStatusType> {
    @Override
    public void write(final JsonWriter jsonWriter, final UserImportJobStatusType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UserImportJobStatusType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UserImportJobStatusType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UserImportJobStatusType.fromValue(value);
  }
}
