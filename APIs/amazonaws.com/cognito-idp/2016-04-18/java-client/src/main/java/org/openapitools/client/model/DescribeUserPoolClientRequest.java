...
public class DescribeUserPoolClientRequest {
  ...
  public DescribeUserPoolClientRequest() {
  }

  public DescribeUserPoolClientRequest userPoolId(String userPoolId) {
  ...
  public DescribeUserPoolClientRequest clientId(String clientId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeUserPoolClientRequest describeUserPoolClientRequest = (DescribeUserPoolClientRequest) o;
    return Objects.equals(this.userPoolId, describeUserPoolClientRequest.userPoolId) &&
        Objects.equals(this.clientId, describeUserPoolClientRequest.clientId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeUserPoolClientRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUserPoolClientRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUserPoolClientRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUserPoolClientRequest is not found in the empty JSON string", DescribeUserPoolClientRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUserPoolClientRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUserPoolClientRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeUserPoolClientRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUserPoolClientRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUserPoolClientRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUserPoolClientRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUserPoolClientRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUserPoolClientRequest>() {
           @Override
           public void write(JsonWriter out, DescribeUserPoolClientRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUserPoolClientRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUserPoolClientRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUserPoolClientRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeUserPoolClientRequest
   */
  public static DescribeUserPoolClientRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUserPoolClientRequest.class);
  }

  /**
   * Convert an instance of DescribeUserPoolClientRequest to an JSON string
   *
   * @return JSON string
   */
