...
public class AdminConfirmSignUpRequest {
  ...
  public AdminConfirmSignUpRequest userPoolId(String userPoolId) {
  ...
  public AdminConfirmSignUpRequest username(String username) {
  ...
  public AdminConfirmSignUpRequest clientMetadata(Map clientMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    AdminConfirmSignUpRequest adminConfirmSignUpRequest = (AdminConfirmSignUpRequest) o;
    return Objects.equals(this.userPoolId, adminConfirmSignUpRequest.userPoolId) &&
        Objects.equals(this.username, adminConfirmSignUpRequest.username) &&
        Objects.equals(this.clientMetadata, adminConfirmSignUpRequest.clientMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdminConfirmSignUpRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminConfirmSignUpRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminConfirmSignUpRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminConfirmSignUpRequest is not found in the empty JSON string", AdminConfirmSignUpRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminConfirmSignUpRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminConfirmSignUpRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminConfirmSignUpRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminConfirmSignUpRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminConfirmSignUpRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminConfirmSignUpRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminConfirmSignUpRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminConfirmSignUpRequest>() {
           @Override
           public void write(JsonWriter out, AdminConfirmSignUpRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminConfirmSignUpRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminConfirmSignUpRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminConfirmSignUpRequest
   * @throws IOException if the JSON string is invalid with respect to AdminConfirmSignUpRequest
   */
  public static AdminConfirmSignUpRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminConfirmSignUpRequest.class);
  }

  /**
   * Convert an instance of AdminConfirmSignUpRequest to an JSON string
   *
   * @return JSON string
   */
