...
public class DescribeResourceServerResponse {
  ...
  public DescribeResourceServerResponse() {
  }

  public DescribeResourceServerResponse resourceServer(DescribeResourceServerResponseResourceServer resourceServer) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeResourceServerResponse describeResourceServerResponse = (DescribeResourceServerResponse) o;
    return Objects.equals(this.resourceServer, describeResourceServerResponse.resourceServer);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeResourceServerResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeResourceServerResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeResourceServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeResourceServerResponse is not found in the empty JSON string", DescribeResourceServerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeResourceServerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeResourceServerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeResourceServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeResourceServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeResourceServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeResourceServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeResourceServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeResourceServerResponse>() {
           @Override
           public void write(JsonWriter out, DescribeResourceServerResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeResourceServerResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeResourceServerResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeResourceServerResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeResourceServerResponse
   */
  public static DescribeResourceServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeResourceServerResponse.class);
  }

  /**
   * Convert an instance of DescribeResourceServerResponse to an JSON string
   *
   * @return JSON string
   */
