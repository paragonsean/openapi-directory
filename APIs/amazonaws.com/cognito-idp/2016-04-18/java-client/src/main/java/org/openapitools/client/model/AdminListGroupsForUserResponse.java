...
public class AdminListGroupsForUserResponse {
  ...
  public AdminListGroupsForUserResponse groups(List groups) {
    this.groups = groups;
    return this;
  }
  ...
  public AdminListGroupsForUserResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    AdminListGroupsForUserResponse adminListGroupsForUserResponse = (AdminListGroupsForUserResponse) o;
    return Objects.equals(this.groups, adminListGroupsForUserResponse.groups) &&
        Objects.equals(this.nextToken, adminListGroupsForUserResponse.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdminListGroupsForUserResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminListGroupsForUserResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminListGroupsForUserResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminListGroupsForUserResponse is not found in the empty JSON string", AdminListGroupsForUserResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminListGroupsForUserResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminListGroupsForUserResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminListGroupsForUserResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminListGroupsForUserResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminListGroupsForUserResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminListGroupsForUserResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminListGroupsForUserResponse>() {
           @Override
           public void write(JsonWriter out, AdminListGroupsForUserResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminListGroupsForUserResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminListGroupsForUserResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminListGroupsForUserResponse
   * @throws IOException if the JSON string is invalid with respect to AdminListGroupsForUserResponse
   */
  public static AdminListGroupsForUserResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminListGroupsForUserResponse.class);
  }

  /**
   * Convert an instance of AdminListGroupsForUserResponse to an JSON string
   *
   * @return JSON string
   */
