...
public class IdentityProviderType {
  ...
  public IdentityProviderType userPoolId(String userPoolId) {
  ...
  public IdentityProviderType providerName(String providerName) {
  ...
  public IdentityProviderType providerType(IdentityProviderTypeType providerType) {
  ...
  public IdentityProviderType providerDetails(Map providerDetails) {
  ...
  public IdentityProviderType attributeMapping(Map attributeMapping) {
  ...
  public IdentityProviderType idpIdentifiers(List idpIdentifiers) {
  ...
  public IdentityProviderType lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public IdentityProviderType creationDate(OffsetDateTime creationDate) {
  ...
  public boolean equals(Object o) {
    ...
    IdentityProviderType identityProviderType = (IdentityProviderType) o;
    return Objects.equals(this.userPoolId, identityProviderType.userPoolId) &&
        Objects.equals(this.providerName, identityProviderType.providerName) &&
        Objects.equals(this.providerType, identityProviderType.providerType) &&
        Objects.equals(this.providerDetails, identityProviderType.providerDetails) &&
        Objects.equals(this.attributeMapping, identityProviderType.attributeMapping) &&
        Objects.equals(this.idpIdentifiers, identityProviderType.idpIdentifiers) &&
        Objects.equals(this.lastModifiedDate, identityProviderType.lastModifiedDate) &&
        Objects.equals(this.creationDate, identityProviderType.creationDate);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IdentityProviderType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IdentityProviderType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IdentityProviderType is not found in the empty JSON string", IdentityProviderType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IdentityProviderType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IdentityProviderType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IdentityProviderType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IdentityProviderType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IdentityProviderType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IdentityProviderType.class));

       return (TypeAdapter<T>) new TypeAdapter<IdentityProviderType>() {
           @Override
           public void write(JsonWriter out, IdentityProviderType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IdentityProviderType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IdentityProviderType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IdentityProviderType
   * @throws IOException if the JSON string is invalid with respect to IdentityProviderType
   */
  public static IdentityProviderType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IdentityProviderType.class);
  }

  /**
   * Convert an instance of IdentityProviderType to an JSON string
   *
   * @return JSON string
   */
