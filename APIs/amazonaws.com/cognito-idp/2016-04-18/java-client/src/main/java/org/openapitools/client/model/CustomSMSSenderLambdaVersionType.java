...
/**
 * Gets or Sets CustomSMSSenderLambdaVersionType
 */
@JsonAdapter(CustomSMSSenderLambdaVersionType.Adapter.class)
public enum CustomSMSSenderLambdaVersionType {
  ...
  CustomSMSSenderLambdaVersionType(String value) {
    this.value = value;
  }
  ...
  public static CustomSMSSenderLambdaVersionType fromValue(String value) {
    for (CustomSMSSenderLambdaVersionType b : CustomSMSSenderLambdaVersionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<CustomSMSSenderLambdaVersionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CustomSMSSenderLambdaVersionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CustomSMSSenderLambdaVersionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CustomSMSSenderLambdaVersionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CustomSMSSenderLambdaVersionType.fromValue(value);
  }
}
