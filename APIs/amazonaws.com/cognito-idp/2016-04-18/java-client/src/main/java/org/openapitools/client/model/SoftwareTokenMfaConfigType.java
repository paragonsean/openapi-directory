...
public class SoftwareTokenMfaConfigType {
  ...
  public SoftwareTokenMfaConfigType enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    SoftwareTokenMfaConfigType softwareTokenMfaConfigType = (SoftwareTokenMfaConfigType) o;
    return Objects.equals(this.enabled, softwareTokenMfaConfigType.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class SoftwareTokenMfaConfigType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SoftwareTokenMfaConfigType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SoftwareTokenMfaConfigType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SoftwareTokenMfaConfigType is not found in the empty JSON string", SoftwareTokenMfaConfigType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SoftwareTokenMfaConfigType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SoftwareTokenMfaConfigType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SoftwareTokenMfaConfigType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SoftwareTokenMfaConfigType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SoftwareTokenMfaConfigType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SoftwareTokenMfaConfigType.class));

       return (TypeAdapter<T>) new TypeAdapter<SoftwareTokenMfaConfigType>() {
           @Override
           public void write(JsonWriter out, SoftwareTokenMfaConfigType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SoftwareTokenMfaConfigType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SoftwareTokenMfaConfigType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SoftwareTokenMfaConfigType
   * @throws IOException if the JSON string is invalid with respect to SoftwareTokenMfaConfigType
   */
  public static SoftwareTokenMfaConfigType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SoftwareTokenMfaConfigType.class);
  }

  /**
   * Convert an instance of SoftwareTokenMfaConfigType to an JSON string
   *
   * @return JSON string
   */
