...
public class AdminSetUserMFAPreferenceRequestSMSMfaSettings {
  ...
  public AdminSetUserMFAPreferenceRequestSMSMfaSettings() {
  }

  public AdminSetUserMFAPreferenceRequestSMSMfaSettings enabled(Boolean enabled) {
  ...
  public AdminSetUserMFAPreferenceRequestSMSMfaSettings preferredMfa(Boolean preferredMfa) {
  ...
  public boolean equals(Object o) {
    ...
    AdminSetUserMFAPreferenceRequestSMSMfaSettings adminSetUserMFAPreferenceRequestSMSMfaSettings = (AdminSetUserMFAPreferenceRequestSMSMfaSettings) o;
    return Objects.equals(this.enabled, adminSetUserMFAPreferenceRequestSMSMfaSettings.enabled) &&
        Objects.equals(this.preferredMfa, adminSetUserMFAPreferenceRequestSMSMfaSettings.preferredMfa);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdminSetUserMFAPreferenceRequestSMSMfaSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminSetUserMFAPreferenceRequestSMSMfaSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminSetUserMFAPreferenceRequestSMSMfaSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminSetUserMFAPreferenceRequestSMSMfaSettings is not found in the empty JSON string", AdminSetUserMFAPreferenceRequestSMSMfaSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminSetUserMFAPreferenceRequestSMSMfaSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminSetUserMFAPreferenceRequestSMSMfaSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminSetUserMFAPreferenceRequestSMSMfaSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminSetUserMFAPreferenceRequestSMSMfaSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminSetUserMFAPreferenceRequestSMSMfaSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminSetUserMFAPreferenceRequestSMSMfaSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminSetUserMFAPreferenceRequestSMSMfaSettings>() {
           @Override
           public void write(JsonWriter out, AdminSetUserMFAPreferenceRequestSMSMfaSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminSetUserMFAPreferenceRequestSMSMfaSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminSetUserMFAPreferenceRequestSMSMfaSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminSetUserMFAPreferenceRequestSMSMfaSettings
   * @throws IOException if the JSON string is invalid with respect to AdminSetUserMFAPreferenceRequestSMSMfaSettings
   */
  public static AdminSetUserMFAPreferenceRequestSMSMfaSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminSetUserMFAPreferenceRequestSMSMfaSettings.class);
  }

  /**
   * Convert an instance of AdminSetUserMFAPreferenceRequestSMSMfaSettings to an JSON string
   *
   * @return JSON string
   */
