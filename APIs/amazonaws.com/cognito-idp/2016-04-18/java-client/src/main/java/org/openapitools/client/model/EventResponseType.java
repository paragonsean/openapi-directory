...
/**
 * Gets or Sets EventResponseType
 */
@JsonAdapter(EventResponseType.Adapter.class)
public enum EventResponseType {
  ...
  EventResponseType(String value) {
    this.value = value;
  }
  ...
  public static EventResponseType fromValue(String value) {
    for (EventResponseType b : EventResponseType.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventResponseType> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventResponseType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventResponseType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventResponseType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EventResponseType.fromValue(value);
  }
}
