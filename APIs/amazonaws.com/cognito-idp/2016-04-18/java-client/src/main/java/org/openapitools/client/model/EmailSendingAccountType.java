...
/**
 * Gets or Sets EmailSendingAccountType
 */
@JsonAdapter(EmailSendingAccountType.Adapter.class)
public enum EmailSendingAccountType {
  ...
  EmailSendingAccountType(String value) {
    this.value = value;
  }
  ...
  public static EmailSendingAccountType fromValue(String value) {
    for (EmailSendingAccountType b : EmailSendingAccountType.values()) {
  ...
  public static class Adapter extends TypeAdapter<EmailSendingAccountType> {
    @Override
    public void write(final JsonWriter jsonWriter, final EmailSendingAccountType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EmailSendingAccountType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EmailSendingAccountType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EmailSendingAccountType.fromValue(value);
  }
}
