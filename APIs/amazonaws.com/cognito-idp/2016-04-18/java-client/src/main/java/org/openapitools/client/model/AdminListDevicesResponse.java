...
public class AdminListDevicesResponse {
  ...
  public AdminListDevicesResponse() {
  }

  public AdminListDevicesResponse devices(List devices) {
  ...
  public AdminListDevicesResponse paginationToken(String paginationToken) {
  ...
  public boolean equals(Object o) {
    ...
    AdminListDevicesResponse adminListDevicesResponse = (AdminListDevicesResponse) o;
    return Objects.equals(this.devices, adminListDevicesResponse.devices) &&
        Objects.equals(this.paginationToken, adminListDevicesResponse.paginationToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdminListDevicesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminListDevicesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminListDevicesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminListDevicesResponse is not found in the empty JSON string", AdminListDevicesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminListDevicesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminListDevicesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminListDevicesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminListDevicesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminListDevicesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminListDevicesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminListDevicesResponse>() {
           @Override
           public void write(JsonWriter out, AdminListDevicesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminListDevicesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminListDevicesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminListDevicesResponse
   * @throws IOException if the JSON string is invalid with respect to AdminListDevicesResponse
   */
  public static AdminListDevicesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminListDevicesResponse.class);
  }

  /**
   * Convert an instance of AdminListDevicesResponse to an JSON string
   *
   * @return JSON string
   */
