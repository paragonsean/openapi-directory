...
public class UserPoolPolicyType {
  ...
  public UserPoolPolicyType passwordPolicy(UserPoolPolicyTypePasswordPolicy passwordPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    UserPoolPolicyType userPoolPolicyType = (UserPoolPolicyType) o;
    return Objects.equals(this.passwordPolicy, userPoolPolicyType.passwordPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserPoolPolicyType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserPoolPolicyType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPoolPolicyType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserPoolPolicyType is not found in the empty JSON string", UserPoolPolicyType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserPoolPolicyType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserPoolPolicyType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserPoolPolicyType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserPoolPolicyType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserPoolPolicyType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserPoolPolicyType.class));

       return (TypeAdapter<T>) new TypeAdapter<UserPoolPolicyType>() {
           @Override
           public void write(JsonWriter out, UserPoolPolicyType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserPoolPolicyType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserPoolPolicyType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserPoolPolicyType
   * @throws IOException if the JSON string is invalid with respect to UserPoolPolicyType
   */
  public static UserPoolPolicyType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserPoolPolicyType.class);
  }

  /**
   * Convert an instance of UserPoolPolicyType to an JSON string
   *
   * @return JSON string
   */
