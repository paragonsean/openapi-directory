...
public class CreateUserImportJobResponse {
  ...
  public CreateUserImportJobResponse userImportJob(CreateUserImportJobResponseUserImportJob userImportJob) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUserImportJobResponse createUserImportJobResponse = (CreateUserImportJobResponse) o;
    return Objects.equals(this.userImportJob, createUserImportJobResponse.userImportJob);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUserImportJobResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserImportJobResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserImportJobResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserImportJobResponse is not found in the empty JSON string", CreateUserImportJobResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserImportJobResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserImportJobResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserImportJobResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserImportJobResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserImportJobResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserImportJobResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserImportJobResponse>() {
           @Override
           public void write(JsonWriter out, CreateUserImportJobResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserImportJobResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserImportJobResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserImportJobResponse
   * @throws IOException if the JSON string is invalid with respect to CreateUserImportJobResponse
   */
  public static CreateUserImportJobResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserImportJobResponse.class);
  }

  /**
   * Convert an instance of CreateUserImportJobResponse to an JSON string
   *
   * @return JSON string
   */
