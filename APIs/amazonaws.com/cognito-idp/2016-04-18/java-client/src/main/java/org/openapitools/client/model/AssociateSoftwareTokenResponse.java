...
public class AssociateSoftwareTokenResponse {
  ...
  public AssociateSoftwareTokenResponse secretCode(String secretCode) {
  ...
  public AssociateSoftwareTokenResponse session(String session) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateSoftwareTokenResponse associateSoftwareTokenResponse = (AssociateSoftwareTokenResponse) o;
    return Objects.equals(this.secretCode, associateSoftwareTokenResponse.secretCode) &&
        Objects.equals(this.session, associateSoftwareTokenResponse.session);
  }

  @Override
  public int hashCode() {
    return Objects.hash(secretCode, session);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssociateSoftwareTokenResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateSoftwareTokenResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateSoftwareTokenResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateSoftwareTokenResponse is not found in the empty JSON string", AssociateSoftwareTokenResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateSoftwareTokenResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateSoftwareTokenResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `SecretCode`
      if (jsonObj.get("SecretCode") != null && !jsonObj.get("SecretCode").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("SecretCode"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateSoftwareTokenResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateSoftwareTokenResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateSoftwareTokenResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateSoftwareTokenResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateSoftwareTokenResponse>() {
           @Override
           public void write(JsonWriter out, AssociateSoftwareTokenResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateSoftwareTokenResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateSoftwareTokenResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateSoftwareTokenResponse
   * @throws IOException if the JSON string is invalid with respect to AssociateSoftwareTokenResponse
   */
  public static AssociateSoftwareTokenResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateSoftwareTokenResponse.class);
  }

  /**
   * Convert an instance of AssociateSoftwareTokenResponse to an JSON string
   *
   * @return JSON string
   */
