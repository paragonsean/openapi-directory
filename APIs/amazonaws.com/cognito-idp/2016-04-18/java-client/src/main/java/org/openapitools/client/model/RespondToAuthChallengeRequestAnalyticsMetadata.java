...
public class RespondToAuthChallengeRequestAnalyticsMetadata {
  ...
  public RespondToAuthChallengeRequestAnalyticsMetadata() {
  }

  public RespondToAuthChallengeRequestAnalyticsMetadata analyticsEndpointId(String analyticsEndpointId) {
  ...
  public boolean equals(Object o) {
    ...
    RespondToAuthChallengeRequestAnalyticsMetadata respondToAuthChallengeRequestAnalyticsMetadata = (RespondToAuthChallengeRequestAnalyticsMetadata) o;
    return Objects.equals(this.analyticsEndpointId, respondToAuthChallengeRequestAnalyticsMetadata.analyticsEndpointId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RespondToAuthChallengeRequestAnalyticsMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RespondToAuthChallengeRequestAnalyticsMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RespondToAuthChallengeRequestAnalyticsMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RespondToAuthChallengeRequestAnalyticsMetadata is not found in the empty JSON string", RespondToAuthChallengeRequestAnalyticsMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RespondToAuthChallengeRequestAnalyticsMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RespondToAuthChallengeRequestAnalyticsMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RespondToAuthChallengeRequestAnalyticsMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RespondToAuthChallengeRequestAnalyticsMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RespondToAuthChallengeRequestAnalyticsMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RespondToAuthChallengeRequestAnalyticsMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<RespondToAuthChallengeRequestAnalyticsMetadata>() {
           @Override
           public void write(JsonWriter out, RespondToAuthChallengeRequestAnalyticsMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RespondToAuthChallengeRequestAnalyticsMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RespondToAuthChallengeRequestAnalyticsMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RespondToAuthChallengeRequestAnalyticsMetadata
   * @throws IOException if the JSON string is invalid with respect to RespondToAuthChallengeRequestAnalyticsMetadata
   */
  public static RespondToAuthChallengeRequestAnalyticsMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RespondToAuthChallengeRequestAnalyticsMetadata.class);
  }

  /**
   * Convert an instance of RespondToAuthChallengeRequestAnalyticsMetadata to an JSON string
   *
   * @return JSON string
   */
