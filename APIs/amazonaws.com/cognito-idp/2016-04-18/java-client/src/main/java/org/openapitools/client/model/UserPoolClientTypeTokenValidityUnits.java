...
public class UserPoolClientTypeTokenValidityUnits {
  ...
  public UserPoolClientTypeTokenValidityUnits() {
  }

  public UserPoolClientTypeTokenValidityUnits accessToken(TimeUnitsType accessToken) {
  ...
  public UserPoolClientTypeTokenValidityUnits idToken(TimeUnitsType idToken) {
  ...
  public UserPoolClientTypeTokenValidityUnits refreshToken(TimeUnitsType refreshToken) {
  ...
  public boolean equals(Object o) {
    ...
    UserPoolClientTypeTokenValidityUnits userPoolClientTypeTokenValidityUnits = (UserPoolClientTypeTokenValidityUnits) o;
    return Objects.equals(this.accessToken, userPoolClientTypeTokenValidityUnits.accessToken) &&
        Objects.equals(this.idToken, userPoolClientTypeTokenValidityUnits.idToken) &&
        Objects.equals(this.refreshToken, userPoolClientTypeTokenValidityUnits.refreshToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserPoolClientTypeTokenValidityUnits {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserPoolClientTypeTokenValidityUnits
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPoolClientTypeTokenValidityUnits.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserPoolClientTypeTokenValidityUnits is not found in the empty JSON string", UserPoolClientTypeTokenValidityUnits.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserPoolClientTypeTokenValidityUnits.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserPoolClientTypeTokenValidityUnits` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserPoolClientTypeTokenValidityUnits.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserPoolClientTypeTokenValidityUnits' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserPoolClientTypeTokenValidityUnits> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserPoolClientTypeTokenValidityUnits.class));

       return (TypeAdapter<T>) new TypeAdapter<UserPoolClientTypeTokenValidityUnits>() {
           @Override
           public void write(JsonWriter out, UserPoolClientTypeTokenValidityUnits value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserPoolClientTypeTokenValidityUnits read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserPoolClientTypeTokenValidityUnits given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserPoolClientTypeTokenValidityUnits
   * @throws IOException if the JSON string is invalid with respect to UserPoolClientTypeTokenValidityUnits
   */
  public static UserPoolClientTypeTokenValidityUnits fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserPoolClientTypeTokenValidityUnits.class);
  }

  /**
   * Convert an instance of UserPoolClientTypeTokenValidityUnits to an JSON string
   *
   * @return JSON string
   */
