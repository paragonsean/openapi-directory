...
/**
 * Gets or Sets UserPoolMfaType
 */
@JsonAdapter(UserPoolMfaType.Adapter.class)
public enum UserPoolMfaType {
  ...
  public static UserPoolMfaType fromValue(String value) {
    for (UserPoolMfaType b : UserPoolMfaType.values()) {
  ...
  public static class Adapter extends TypeAdapter<UserPoolMfaType> {
    @Override
    public void write(final JsonWriter jsonWriter, final UserPoolMfaType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UserPoolMfaType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UserPoolMfaType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UserPoolMfaType.fromValue(value);
  }
}
