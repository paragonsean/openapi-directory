...
public class ListUserPoolClientsResponse {
  public static final String SERIALIZED_NAME_USER_POOL_CLIENTS = "UserPoolClients";
  @SerializedName(SERIALIZED_NAME_USER_POOL_CLIENTS)
  ...
  public ListUserPoolClientsResponse userPoolClients(List userPoolClients) {
  ...
  public void setUserPoolClients(List userPoolClients) {
    this.userPoolClients = userPoolClients;
  }


  public ListUserPoolClientsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolClients, listUserPoolClientsResponse.userPoolClients) &&
        Objects.equals(this.nextToken, listUserPoolClientsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolClients, nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("    userPoolClients: ").append(toIndentedString(userPoolClients)).append("\n");
  ...
  static {
    ...
    openapiFields.add("UserPoolClients");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListUserPoolClientsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListUserPoolClientsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListUserPoolClientsResponse is not found in the empty JSON string", ListUserPoolClientsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListUserPoolClientsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListUserPoolClientsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `UserPoolClients`
      if (jsonObj.get("UserPoolClients") != null && !jsonObj.get("UserPoolClients").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("UserPoolClients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListUserPoolClientsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListUserPoolClientsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListUserPoolClientsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListUserPoolClientsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListUserPoolClientsResponse>() {
           @Override
           public void write(JsonWriter out, ListUserPoolClientsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListUserPoolClientsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListUserPoolClientsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListUserPoolClientsResponse
   * @throws IOException if the JSON string is invalid with respect to ListUserPoolClientsResponse
   */
  public static ListUserPoolClientsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUserPoolClientsResponse.class);
  }

  /**
   * Convert an instance of ListUserPoolClientsResponse to an JSON string
   *
   * @return JSON string
   */
