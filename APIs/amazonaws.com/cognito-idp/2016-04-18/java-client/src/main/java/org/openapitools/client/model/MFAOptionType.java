...
public class MFAOptionType {
  ...
  public MFAOptionType deliveryMedium(DeliveryMediumType deliveryMedium) {
  ...
  public MFAOptionType attributeName(String attributeName) {
  ...
  public boolean equals(Object o) {
    ...
    MFAOptionType mfAOptionType = (MFAOptionType) o;
    return Objects.equals(this.deliveryMedium, mfAOptionType.deliveryMedium) &&
        Objects.equals(this.attributeName, mfAOptionType.attributeName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deliveryMedium, attributeName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MFAOptionType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MFAOptionType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MFAOptionType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MFAOptionType is not found in the empty JSON string", MFAOptionType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MFAOptionType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MFAOptionType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MFAOptionType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MFAOptionType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MFAOptionType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MFAOptionType.class));

       return (TypeAdapter<T>) new TypeAdapter<MFAOptionType>() {
           @Override
           public void write(JsonWriter out, MFAOptionType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MFAOptionType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MFAOptionType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MFAOptionType
   * @throws IOException if the JSON string is invalid with respect to MFAOptionType
   */
  public static MFAOptionType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MFAOptionType.class);
  }

  /**
   * Convert an instance of MFAOptionType to an JSON string
   *
   * @return JSON string
   */
