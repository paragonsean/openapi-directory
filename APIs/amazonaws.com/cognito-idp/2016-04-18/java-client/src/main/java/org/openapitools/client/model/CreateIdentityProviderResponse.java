...
public class CreateIdentityProviderResponse {
  ...
  private CreateIdentityProviderResponseIdentityProvider identityProvider;

  public CreateIdentityProviderResponse() {
  }

  public CreateIdentityProviderResponse identityProvider(CreateIdentityProviderResponseIdentityProvider identityProvider) {
  ...
  public CreateIdentityProviderResponseIdentityProvider getIdentityProvider() {
    return identityProvider;
  }

  public void setIdentityProvider(CreateIdentityProviderResponseIdentityProvider identityProvider) {
    this.identityProvider = identityProvider;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateIdentityProviderResponse createIdentityProviderResponse = (CreateIdentityProviderResponse) o;
    return Objects.equals(this.identityProvider, createIdentityProviderResponse.identityProvider);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateIdentityProviderResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateIdentityProviderResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateIdentityProviderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateIdentityProviderResponse is not found in the empty JSON string", CreateIdentityProviderResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateIdentityProviderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateIdentityProviderResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateIdentityProviderResponse.openapiRequiredFields) {
      ...
      CreateIdentityProviderResponseIdentityProvider.validateJsonElement(jsonObj.get("IdentityProvider"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateIdentityProviderResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateIdentityProviderResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateIdentityProviderResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateIdentityProviderResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateIdentityProviderResponse>() {
           @Override
           public void write(JsonWriter out, CreateIdentityProviderResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateIdentityProviderResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateIdentityProviderResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateIdentityProviderResponse
   * @throws IOException if the JSON string is invalid with respect to CreateIdentityProviderResponse
   */
  public static CreateIdentityProviderResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateIdentityProviderResponse.class);
  }

  /**
   * Convert an instance of CreateIdentityProviderResponse to an JSON string
   *
   * @return JSON string
   */
