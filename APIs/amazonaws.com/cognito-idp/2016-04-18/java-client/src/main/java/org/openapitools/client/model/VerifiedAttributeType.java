...
/**
 * Gets or Sets VerifiedAttributeType
 */
@JsonAdapter(VerifiedAttributeType.Adapter.class)
public enum VerifiedAttributeType {
  ...
  VerifiedAttributeType(String value) {
    this.value = value;
  }
  ...
  public static VerifiedAttributeType fromValue(String value) {
    for (VerifiedAttributeType b : VerifiedAttributeType.values()) {
  ...
  public static class Adapter extends TypeAdapter<VerifiedAttributeType> {
    @Override
    public void write(final JsonWriter jsonWriter, final VerifiedAttributeType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VerifiedAttributeType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return VerifiedAttributeType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    VerifiedAttributeType.fromValue(value);
  }
}
