...
/**
 * Gets or Sets MessageActionType
 */
@JsonAdapter(MessageActionType.Adapter.class)
public enum MessageActionType {
  ...
  public static MessageActionType fromValue(String value) {
    for (MessageActionType b : MessageActionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<MessageActionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final MessageActionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MessageActionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MessageActionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    MessageActionType.fromValue(value);
  }
}
