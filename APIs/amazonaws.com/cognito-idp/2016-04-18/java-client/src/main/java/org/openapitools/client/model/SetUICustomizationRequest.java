...
public class SetUICustomizationRequest {
  ...
  public static final String SERIALIZED_NAME_IMAGE_FILE = "ImageFile";
  ...
  public SetUICustomizationRequest userPoolId(String userPoolId) {
  ...
  public SetUICustomizationRequest clientId(String clientId) {
  ...
  public SetUICustomizationRequest CSS(String CSS) {
    this.CSS = CSS;
    return this;
  }
  ...
  public SetUICustomizationRequest imageFile(String imageFile) {
  ...
  public boolean equals(Object o) {
    ...
    SetUICustomizationRequest setUICustomizationRequest = (SetUICustomizationRequest) o;
    return Objects.equals(this.userPoolId, setUICustomizationRequest.userPoolId) &&
        Objects.equals(this.clientId, setUICustomizationRequest.clientId) &&
        Objects.equals(this.CSS, setUICustomizationRequest.CSS) &&
        Objects.equals(this.imageFile, setUICustomizationRequest.imageFile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, clientId, CSS, imageFile);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetUICustomizationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetUICustomizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetUICustomizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetUICustomizationRequest is not found in the empty JSON string", SetUICustomizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetUICustomizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetUICustomizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetUICustomizationRequest.openapiRequiredFields) {
      ...
      // validate the optional field `ImageFile`
      if (jsonObj.get("ImageFile") != null && !jsonObj.get("ImageFile").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("ImageFile"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetUICustomizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetUICustomizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetUICustomizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetUICustomizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SetUICustomizationRequest>() {
           @Override
           public void write(JsonWriter out, SetUICustomizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetUICustomizationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetUICustomizationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetUICustomizationRequest
   * @throws IOException if the JSON string is invalid with respect to SetUICustomizationRequest
   */
  public static SetUICustomizationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetUICustomizationRequest.class);
  }

  /**
   * Convert an instance of SetUICustomizationRequest to an JSON string
   *
   * @return JSON string
   */
