...
public class AuthenticationResultTypeNewDeviceMetadata {
  ...
  public AuthenticationResultTypeNewDeviceMetadata() {
  }

  public AuthenticationResultTypeNewDeviceMetadata deviceKey(String deviceKey) {
  ...
  public AuthenticationResultTypeNewDeviceMetadata deviceGroupKey(String deviceGroupKey) {
  ...
  public boolean equals(Object o) {
    ...
    AuthenticationResultTypeNewDeviceMetadata authenticationResultTypeNewDeviceMetadata = (AuthenticationResultTypeNewDeviceMetadata) o;
    return Objects.equals(this.deviceKey, authenticationResultTypeNewDeviceMetadata.deviceKey) &&
        Objects.equals(this.deviceGroupKey, authenticationResultTypeNewDeviceMetadata.deviceGroupKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthenticationResultTypeNewDeviceMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthenticationResultTypeNewDeviceMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthenticationResultTypeNewDeviceMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthenticationResultTypeNewDeviceMetadata is not found in the empty JSON string", AuthenticationResultTypeNewDeviceMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthenticationResultTypeNewDeviceMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthenticationResultTypeNewDeviceMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthenticationResultTypeNewDeviceMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthenticationResultTypeNewDeviceMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthenticationResultTypeNewDeviceMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthenticationResultTypeNewDeviceMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthenticationResultTypeNewDeviceMetadata>() {
           @Override
           public void write(JsonWriter out, AuthenticationResultTypeNewDeviceMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthenticationResultTypeNewDeviceMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthenticationResultTypeNewDeviceMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthenticationResultTypeNewDeviceMetadata
   * @throws IOException if the JSON string is invalid with respect to AuthenticationResultTypeNewDeviceMetadata
   */
  public static AuthenticationResultTypeNewDeviceMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthenticationResultTypeNewDeviceMetadata.class);
  }

  /**
   * Convert an instance of AuthenticationResultTypeNewDeviceMetadata to an JSON string
   *
   * @return JSON string
   */
