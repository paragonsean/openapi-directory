...
public class AccountTakeoverActionsTypeLowAction {
  ...
  public AccountTakeoverActionsTypeLowAction() {
  }

  public AccountTakeoverActionsTypeLowAction notify(Boolean notify) {
    this.notify = notify;
    return this;
  }
  ...
  public AccountTakeoverActionsTypeLowAction eventAction(AccountTakeoverEventActionType eventAction) {
  ...
  public boolean equals(Object o) {
    ...
    AccountTakeoverActionsTypeLowAction accountTakeoverActionsTypeLowAction = (AccountTakeoverActionsTypeLowAction) o;
    return Objects.equals(this.notify, accountTakeoverActionsTypeLowAction.notify) &&
        Objects.equals(this.eventAction, accountTakeoverActionsTypeLowAction.eventAction);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountTakeoverActionsTypeLowAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountTakeoverActionsTypeLowAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountTakeoverActionsTypeLowAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountTakeoverActionsTypeLowAction is not found in the empty JSON string", AccountTakeoverActionsTypeLowAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountTakeoverActionsTypeLowAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountTakeoverActionsTypeLowAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountTakeoverActionsTypeLowAction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountTakeoverActionsTypeLowAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountTakeoverActionsTypeLowAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountTakeoverActionsTypeLowAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountTakeoverActionsTypeLowAction.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountTakeoverActionsTypeLowAction>() {
           @Override
           public void write(JsonWriter out, AccountTakeoverActionsTypeLowAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountTakeoverActionsTypeLowAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountTakeoverActionsTypeLowAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountTakeoverActionsTypeLowAction
   * @throws IOException if the JSON string is invalid with respect to AccountTakeoverActionsTypeLowAction
   */
  public static AccountTakeoverActionsTypeLowAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountTakeoverActionsTypeLowAction.class);
  }

  /**
   * Convert an instance of AccountTakeoverActionsTypeLowAction to an JSON string
   *
   * @return JSON string
   */
