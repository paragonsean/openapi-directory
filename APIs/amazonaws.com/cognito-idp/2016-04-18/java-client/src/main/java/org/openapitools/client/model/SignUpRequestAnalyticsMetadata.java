...
public class SignUpRequestAnalyticsMetadata {
  ...
  public SignUpRequestAnalyticsMetadata() {
  }

  public SignUpRequestAnalyticsMetadata analyticsEndpointId(String analyticsEndpointId) {
  ...
  public boolean equals(Object o) {
    ...
    SignUpRequestAnalyticsMetadata signUpRequestAnalyticsMetadata = (SignUpRequestAnalyticsMetadata) o;
    return Objects.equals(this.analyticsEndpointId, signUpRequestAnalyticsMetadata.analyticsEndpointId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SignUpRequestAnalyticsMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SignUpRequestAnalyticsMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SignUpRequestAnalyticsMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SignUpRequestAnalyticsMetadata is not found in the empty JSON string", SignUpRequestAnalyticsMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SignUpRequestAnalyticsMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SignUpRequestAnalyticsMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SignUpRequestAnalyticsMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SignUpRequestAnalyticsMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SignUpRequestAnalyticsMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SignUpRequestAnalyticsMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<SignUpRequestAnalyticsMetadata>() {
           @Override
           public void write(JsonWriter out, SignUpRequestAnalyticsMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SignUpRequestAnalyticsMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SignUpRequestAnalyticsMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SignUpRequestAnalyticsMetadata
   * @throws IOException if the JSON string is invalid with respect to SignUpRequestAnalyticsMetadata
   */
  public static SignUpRequestAnalyticsMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SignUpRequestAnalyticsMetadata.class);
  }

  /**
   * Convert an instance of SignUpRequestAnalyticsMetadata to an JSON string
   *
   * @return JSON string
   */
