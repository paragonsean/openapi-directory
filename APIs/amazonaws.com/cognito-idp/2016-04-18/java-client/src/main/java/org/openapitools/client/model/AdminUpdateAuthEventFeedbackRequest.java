...
public class AdminUpdateAuthEventFeedbackRequest {
  ...
  public AdminUpdateAuthEventFeedbackRequest userPoolId(String userPoolId) {
  ...
  public AdminUpdateAuthEventFeedbackRequest username(String username) {
  ...
  public AdminUpdateAuthEventFeedbackRequest eventId(String eventId) {
  ...
  public AdminUpdateAuthEventFeedbackRequest feedbackValue(FeedbackValueType feedbackValue) {
  ...
  public boolean equals(Object o) {
    ...
    AdminUpdateAuthEventFeedbackRequest adminUpdateAuthEventFeedbackRequest = (AdminUpdateAuthEventFeedbackRequest) o;
    return Objects.equals(this.userPoolId, adminUpdateAuthEventFeedbackRequest.userPoolId) &&
        Objects.equals(this.username, adminUpdateAuthEventFeedbackRequest.username) &&
        Objects.equals(this.eventId, adminUpdateAuthEventFeedbackRequest.eventId) &&
        Objects.equals(this.feedbackValue, adminUpdateAuthEventFeedbackRequest.feedbackValue);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username, eventId, feedbackValue);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminUpdateAuthEventFeedbackRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminUpdateAuthEventFeedbackRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminUpdateAuthEventFeedbackRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminUpdateAuthEventFeedbackRequest is not found in the empty JSON string", AdminUpdateAuthEventFeedbackRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminUpdateAuthEventFeedbackRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminUpdateAuthEventFeedbackRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminUpdateAuthEventFeedbackRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminUpdateAuthEventFeedbackRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminUpdateAuthEventFeedbackRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminUpdateAuthEventFeedbackRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminUpdateAuthEventFeedbackRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminUpdateAuthEventFeedbackRequest>() {
           @Override
           public void write(JsonWriter out, AdminUpdateAuthEventFeedbackRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminUpdateAuthEventFeedbackRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminUpdateAuthEventFeedbackRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminUpdateAuthEventFeedbackRequest
   * @throws IOException if the JSON string is invalid with respect to AdminUpdateAuthEventFeedbackRequest
   */
  public static AdminUpdateAuthEventFeedbackRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminUpdateAuthEventFeedbackRequest.class);
  }

  /**
   * Convert an instance of AdminUpdateAuthEventFeedbackRequest to an JSON string
   *
   * @return JSON string
   */
