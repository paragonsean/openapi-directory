...
public class StopUserImportJobResponse {
  ...
  public StopUserImportJobResponse userImportJob(CreateUserImportJobResponseUserImportJob userImportJob) {
  ...
  public boolean equals(Object o) {
    ...
    StopUserImportJobResponse stopUserImportJobResponse = (StopUserImportJobResponse) o;
    return Objects.equals(this.userImportJob, stopUserImportJobResponse.userImportJob);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopUserImportJobResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopUserImportJobResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopUserImportJobResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopUserImportJobResponse is not found in the empty JSON string", StopUserImportJobResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopUserImportJobResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopUserImportJobResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopUserImportJobResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopUserImportJobResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopUserImportJobResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopUserImportJobResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StopUserImportJobResponse>() {
           @Override
           public void write(JsonWriter out, StopUserImportJobResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopUserImportJobResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopUserImportJobResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopUserImportJobResponse
   * @throws IOException if the JSON string is invalid with respect to StopUserImportJobResponse
   */
  public static StopUserImportJobResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopUserImportJobResponse.class);
  }

  /**
   * Convert an instance of StopUserImportJobResponse to an JSON string
   *
   * @return JSON string
   */
