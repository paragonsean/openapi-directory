...
public class AdminAddUserToGroupRequest {
  ...
  public AdminAddUserToGroupRequest userPoolId(String userPoolId) {
  ...
  public AdminAddUserToGroupRequest username(String username) {
  ...
  public AdminAddUserToGroupRequest groupName(String groupName) {
  ...
  public boolean equals(Object o) {
    ...
    AdminAddUserToGroupRequest adminAddUserToGroupRequest = (AdminAddUserToGroupRequest) o;
    return Objects.equals(this.userPoolId, adminAddUserToGroupRequest.userPoolId) &&
        Objects.equals(this.username, adminAddUserToGroupRequest.username) &&
        Objects.equals(this.groupName, adminAddUserToGroupRequest.groupName);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdminAddUserToGroupRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminAddUserToGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminAddUserToGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminAddUserToGroupRequest is not found in the empty JSON string", AdminAddUserToGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminAddUserToGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminAddUserToGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminAddUserToGroupRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminAddUserToGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminAddUserToGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminAddUserToGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminAddUserToGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminAddUserToGroupRequest>() {
           @Override
           public void write(JsonWriter out, AdminAddUserToGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminAddUserToGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminAddUserToGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminAddUserToGroupRequest
   * @throws IOException if the JSON string is invalid with respect to AdminAddUserToGroupRequest
   */
  public static AdminAddUserToGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminAddUserToGroupRequest.class);
  }

  /**
   * Convert an instance of AdminAddUserToGroupRequest to an JSON string
   *
   * @return JSON string
   */
