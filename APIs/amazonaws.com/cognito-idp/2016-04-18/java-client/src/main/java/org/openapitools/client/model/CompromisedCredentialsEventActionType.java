...
/**
 * Gets or Sets CompromisedCredentialsEventActionType
 */
@JsonAdapter(CompromisedCredentialsEventActionType.Adapter.class)
public enum CompromisedCredentialsEventActionType {
  ...
  CompromisedCredentialsEventActionType(String value) {
    this.value = value;
  }
  ...
  public static CompromisedCredentialsEventActionType fromValue(String value) {
    for (CompromisedCredentialsEventActionType b : CompromisedCredentialsEventActionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<CompromisedCredentialsEventActionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CompromisedCredentialsEventActionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CompromisedCredentialsEventActionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CompromisedCredentialsEventActionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CompromisedCredentialsEventActionType.fromValue(value);
  }
}
