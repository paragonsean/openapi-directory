...
public class AdminGetUserRequest {
  ...
  public AdminGetUserRequest userPoolId(String userPoolId) {
  ...
  public AdminGetUserRequest username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    AdminGetUserRequest adminGetUserRequest = (AdminGetUserRequest) o;
    return Objects.equals(this.userPoolId, adminGetUserRequest.userPoolId) &&
        Objects.equals(this.username, adminGetUserRequest.username);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdminGetUserRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminGetUserRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminGetUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminGetUserRequest is not found in the empty JSON string", AdminGetUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminGetUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminGetUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminGetUserRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminGetUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminGetUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminGetUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminGetUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminGetUserRequest>() {
           @Override
           public void write(JsonWriter out, AdminGetUserRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminGetUserRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminGetUserRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminGetUserRequest
   * @throws IOException if the JSON string is invalid with respect to AdminGetUserRequest
   */
  public static AdminGetUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminGetUserRequest.class);
  }

  /**
   * Convert an instance of AdminGetUserRequest to an JSON string
   *
   * @return JSON string
   */
