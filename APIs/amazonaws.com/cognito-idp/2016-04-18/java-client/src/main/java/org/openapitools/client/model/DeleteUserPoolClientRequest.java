...
public class DeleteUserPoolClientRequest {
  ...
  public DeleteUserPoolClientRequest() {
  }

  public DeleteUserPoolClientRequest userPoolId(String userPoolId) {
  ...
  public DeleteUserPoolClientRequest clientId(String clientId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolId, deleteUserPoolClientRequest.userPoolId) &&
        Objects.equals(this.clientId, deleteUserPoolClientRequest.clientId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteUserPoolClientRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteUserPoolClientRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteUserPoolClientRequest is not found in the empty JSON string", DeleteUserPoolClientRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteUserPoolClientRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteUserPoolClientRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteUserPoolClientRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteUserPoolClientRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteUserPoolClientRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteUserPoolClientRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteUserPoolClientRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteUserPoolClientRequest>() {
           @Override
           public void write(JsonWriter out, DeleteUserPoolClientRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteUserPoolClientRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteUserPoolClientRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteUserPoolClientRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteUserPoolClientRequest
   */
  public static DeleteUserPoolClientRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteUserPoolClientRequest.class);
  }

  /**
   * Convert an instance of DeleteUserPoolClientRequest to an JSON string
   *
   * @return JSON string
   */
