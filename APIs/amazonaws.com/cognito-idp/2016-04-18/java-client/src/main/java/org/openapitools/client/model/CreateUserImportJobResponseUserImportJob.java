...
public class CreateUserImportJobResponseUserImportJob {
  ...
  public CreateUserImportJobResponseUserImportJob() {
  }

  public CreateUserImportJobResponseUserImportJob jobName(String jobName) {
  ...
  public CreateUserImportJobResponseUserImportJob jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public CreateUserImportJobResponseUserImportJob userPoolId(String userPoolId) {
  ...
  public CreateUserImportJobResponseUserImportJob preSignedUrl(String preSignedUrl) {
  ...
  public CreateUserImportJobResponseUserImportJob creationDate(OffsetDateTime creationDate) {
  ...
  public CreateUserImportJobResponseUserImportJob startDate(OffsetDateTime startDate) {
  ...
  public CreateUserImportJobResponseUserImportJob completionDate(OffsetDateTime completionDate) {
  ...
  public CreateUserImportJobResponseUserImportJob status(UserImportJobStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public CreateUserImportJobResponseUserImportJob cloudWatchLogsRoleArn(String cloudWatchLogsRoleArn) {
  ...
  public CreateUserImportJobResponseUserImportJob importedUsers(Integer importedUsers) {
  ...
  public CreateUserImportJobResponseUserImportJob skippedUsers(Integer skippedUsers) {
  ...
  public CreateUserImportJobResponseUserImportJob failedUsers(Integer failedUsers) {
  ...
  public CreateUserImportJobResponseUserImportJob completionMessage(String completionMessage) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUserImportJobResponseUserImportJob createUserImportJobResponseUserImportJob = (CreateUserImportJobResponseUserImportJob) o;
    return Objects.equals(this.jobName, createUserImportJobResponseUserImportJob.jobName) &&
        Objects.equals(this.jobId, createUserImportJobResponseUserImportJob.jobId) &&
        Objects.equals(this.userPoolId, createUserImportJobResponseUserImportJob.userPoolId) &&
        Objects.equals(this.preSignedUrl, createUserImportJobResponseUserImportJob.preSignedUrl) &&
        Objects.equals(this.creationDate, createUserImportJobResponseUserImportJob.creationDate) &&
        Objects.equals(this.startDate, createUserImportJobResponseUserImportJob.startDate) &&
        Objects.equals(this.completionDate, createUserImportJobResponseUserImportJob.completionDate) &&
        Objects.equals(this.status, createUserImportJobResponseUserImportJob.status) &&
        Objects.equals(this.cloudWatchLogsRoleArn, createUserImportJobResponseUserImportJob.cloudWatchLogsRoleArn) &&
        Objects.equals(this.importedUsers, createUserImportJobResponseUserImportJob.importedUsers) &&
        Objects.equals(this.skippedUsers, createUserImportJobResponseUserImportJob.skippedUsers) &&
        Objects.equals(this.failedUsers, createUserImportJobResponseUserImportJob.failedUsers) &&
        Objects.equals(this.completionMessage, createUserImportJobResponseUserImportJob.completionMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUserImportJobResponseUserImportJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserImportJobResponseUserImportJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserImportJobResponseUserImportJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserImportJobResponseUserImportJob is not found in the empty JSON string", CreateUserImportJobResponseUserImportJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserImportJobResponseUserImportJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserImportJobResponseUserImportJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserImportJobResponseUserImportJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserImportJobResponseUserImportJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserImportJobResponseUserImportJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserImportJobResponseUserImportJob.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserImportJobResponseUserImportJob>() {
           @Override
           public void write(JsonWriter out, CreateUserImportJobResponseUserImportJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserImportJobResponseUserImportJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserImportJobResponseUserImportJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserImportJobResponseUserImportJob
   * @throws IOException if the JSON string is invalid with respect to CreateUserImportJobResponseUserImportJob
   */
  public static CreateUserImportJobResponseUserImportJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserImportJobResponseUserImportJob.class);
  }

  /**
   * Convert an instance of CreateUserImportJobResponseUserImportJob to an JSON string
   *
   * @return JSON string
   */
