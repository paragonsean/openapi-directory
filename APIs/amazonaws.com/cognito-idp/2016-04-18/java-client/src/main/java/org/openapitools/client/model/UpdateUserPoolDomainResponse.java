...
public class UpdateUserPoolDomainResponse {
  public static final String SERIALIZED_NAME_CLOUD_FRONT_DOMAIN = "CloudFrontDomain";
  @SerializedName(SERIALIZED_NAME_CLOUD_FRONT_DOMAIN)
  private String cloudFrontDomain;

  public UpdateUserPoolDomainResponse() {
  }

  public UpdateUserPoolDomainResponse cloudFrontDomain(String cloudFrontDomain) {
    this.cloudFrontDomain = cloudFrontDomain;
    return this;
  }

  /**
   * Get cloudFrontDomain
  ...
  public boolean equals(Object o) {
    ...
    UpdateUserPoolDomainResponse updateUserPoolDomainResponse = (UpdateUserPoolDomainResponse) o;
    return Objects.equals(this.cloudFrontDomain, updateUserPoolDomainResponse.cloudFrontDomain);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cloudFrontDomain);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateUserPoolDomainResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserPoolDomainResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserPoolDomainResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserPoolDomainResponse is not found in the empty JSON string", UpdateUserPoolDomainResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserPoolDomainResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserPoolDomainResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `CloudFrontDomain`
      if (jsonObj.get("CloudFrontDomain") != null && !jsonObj.get("CloudFrontDomain").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("CloudFrontDomain"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserPoolDomainResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserPoolDomainResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserPoolDomainResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserPoolDomainResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserPoolDomainResponse>() {
           @Override
           public void write(JsonWriter out, UpdateUserPoolDomainResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserPoolDomainResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserPoolDomainResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserPoolDomainResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateUserPoolDomainResponse
   */
  public static UpdateUserPoolDomainResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserPoolDomainResponse.class);
  }

  /**
   * Convert an instance of UpdateUserPoolDomainResponse to an JSON string
   *
   * @return JSON string
   */
