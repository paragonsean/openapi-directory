...
public class UserAttributeUpdateSettingsType {
  public static final String SERIALIZED_NAME_ATTRIBUTES_REQUIRE_VERIFICATION_BEFORE_UPDATE = "AttributesRequireVerificationBeforeUpdate";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES_REQUIRE_VERIFICATION_BEFORE_UPDATE)
  private List attributesRequireVerificationBeforeUpdate;

  public UserAttributeUpdateSettingsType() {
  }

  public UserAttributeUpdateSettingsType attributesRequireVerificationBeforeUpdate(List attributesRequireVerificationBeforeUpdate) {
  ...
  public void setAttributesRequireVerificationBeforeUpdate(List attributesRequireVerificationBeforeUpdate) {
    this.attributesRequireVerificationBeforeUpdate = attributesRequireVerificationBeforeUpdate;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserAttributeUpdateSettingsType userAttributeUpdateSettingsType = (UserAttributeUpdateSettingsType) o;
    return Objects.equals(this.attributesRequireVerificationBeforeUpdate, userAttributeUpdateSettingsType.attributesRequireVerificationBeforeUpdate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributesRequireVerificationBeforeUpdate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserAttributeUpdateSettingsType {\n");
    sb.append("    attributesRequireVerificationBeforeUpdate: ").append(toIndentedString(attributesRequireVerificationBeforeUpdate)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("AttributesRequireVerificationBeforeUpdate");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserAttributeUpdateSettingsType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserAttributeUpdateSettingsType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserAttributeUpdateSettingsType is not found in the empty JSON string", UserAttributeUpdateSettingsType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserAttributeUpdateSettingsType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserAttributeUpdateSettingsType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `AttributesRequireVerificationBeforeUpdate`
      if (jsonObj.get("AttributesRequireVerificationBeforeUpdate") != null && !jsonObj.get("AttributesRequireVerificationBeforeUpdate").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("AttributesRequireVerificationBeforeUpdate"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserAttributeUpdateSettingsType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserAttributeUpdateSettingsType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserAttributeUpdateSettingsType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserAttributeUpdateSettingsType.class));

       return (TypeAdapter<T>) new TypeAdapter<UserAttributeUpdateSettingsType>() {
           @Override
           public void write(JsonWriter out, UserAttributeUpdateSettingsType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserAttributeUpdateSettingsType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserAttributeUpdateSettingsType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserAttributeUpdateSettingsType
   * @throws IOException if the JSON string is invalid with respect to UserAttributeUpdateSettingsType
   */
  public static UserAttributeUpdateSettingsType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserAttributeUpdateSettingsType.class);
  }

  /**
   * Convert an instance of UserAttributeUpdateSettingsType to an JSON string
   *
   * @return JSON string
   */
