...
public class ResendConfirmationCodeResponse {
  ...
  private ResendConfirmationCodeResponseCodeDeliveryDetails codeDeliveryDetails;

  public ResendConfirmationCodeResponse() {
  }

  public ResendConfirmationCodeResponse codeDeliveryDetails(ResendConfirmationCodeResponseCodeDeliveryDetails codeDeliveryDetails) {
  ...
  public ResendConfirmationCodeResponseCodeDeliveryDetails getCodeDeliveryDetails() {
    return codeDeliveryDetails;
  }

  public void setCodeDeliveryDetails(ResendConfirmationCodeResponseCodeDeliveryDetails codeDeliveryDetails) {
    this.codeDeliveryDetails = codeDeliveryDetails;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.codeDeliveryDetails, resendConfirmationCodeResponse.codeDeliveryDetails);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResendConfirmationCodeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResendConfirmationCodeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResendConfirmationCodeResponse is not found in the empty JSON string", ResendConfirmationCodeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResendConfirmationCodeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResendConfirmationCodeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("CodeDeliveryDetails") != null && !jsonObj.get("CodeDeliveryDetails").isJsonNull()) {
        ResendConfirmationCodeResponseCodeDeliveryDetails.validateJsonElement(jsonObj.get("CodeDeliveryDetails"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResendConfirmationCodeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResendConfirmationCodeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResendConfirmationCodeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResendConfirmationCodeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ResendConfirmationCodeResponse>() {
           @Override
           public void write(JsonWriter out, ResendConfirmationCodeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResendConfirmationCodeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResendConfirmationCodeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResendConfirmationCodeResponse
   * @throws IOException if the JSON string is invalid with respect to ResendConfirmationCodeResponse
   */
  public static ResendConfirmationCodeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResendConfirmationCodeResponse.class);
  }

  /**
   * Convert an instance of ResendConfirmationCodeResponse to an JSON string
   *
   * @return JSON string
   */
