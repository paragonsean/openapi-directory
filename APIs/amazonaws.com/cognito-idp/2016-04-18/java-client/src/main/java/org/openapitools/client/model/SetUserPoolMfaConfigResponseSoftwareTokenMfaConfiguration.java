...
public class SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration {
  public static final String SERIALIZED_NAME_ENABLED = "Enabled";
  @SerializedName(SERIALIZED_NAME_ENABLED)
  private Boolean enabled;

  public SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration() {
  }

  public SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration setUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration = (SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration) o;
    return Objects.equals(this.enabled, setUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration is not found in the empty JSON string", SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration>() {
           @Override
           public void write(JsonWriter out, SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration
   * @throws IOException if the JSON string is invalid with respect to SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration
   */
  public static SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.class);
  }

  /**
   * Convert an instance of SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration to an JSON string
   *
   * @return JSON string
   */
