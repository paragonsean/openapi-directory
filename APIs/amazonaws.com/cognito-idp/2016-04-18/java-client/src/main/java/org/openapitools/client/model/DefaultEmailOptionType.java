...
/**
 * Gets or Sets DefaultEmailOptionType
 */
@JsonAdapter(DefaultEmailOptionType.Adapter.class)
public enum DefaultEmailOptionType {
  ...
  DefaultEmailOptionType(String value) {
    this.value = value;
  }
  ...
  public static DefaultEmailOptionType fromValue(String value) {
    for (DefaultEmailOptionType b : DefaultEmailOptionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<DefaultEmailOptionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final DefaultEmailOptionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DefaultEmailOptionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DefaultEmailOptionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DefaultEmailOptionType.fromValue(value);
  }
}
