...
public class LogConfigurationTypeCloudWatchLogsConfiguration {
  public static final String SERIALIZED_NAME_LOG_GROUP_ARN = "LogGroupArn";
  @SerializedName(SERIALIZED_NAME_LOG_GROUP_ARN)
  private String logGroupArn;

  public LogConfigurationTypeCloudWatchLogsConfiguration() {
  }

  public LogConfigurationTypeCloudWatchLogsConfiguration logGroupArn(String logGroupArn) {
  ...
  public boolean equals(Object o) {
    ...
    LogConfigurationTypeCloudWatchLogsConfiguration logConfigurationTypeCloudWatchLogsConfiguration = (LogConfigurationTypeCloudWatchLogsConfiguration) o;
    return Objects.equals(this.logGroupArn, logConfigurationTypeCloudWatchLogsConfiguration.logGroupArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogConfigurationTypeCloudWatchLogsConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogConfigurationTypeCloudWatchLogsConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogConfigurationTypeCloudWatchLogsConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LogConfigurationTypeCloudWatchLogsConfiguration is not found in the empty JSON string", LogConfigurationTypeCloudWatchLogsConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogConfigurationTypeCloudWatchLogsConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LogConfigurationTypeCloudWatchLogsConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogConfigurationTypeCloudWatchLogsConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogConfigurationTypeCloudWatchLogsConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogConfigurationTypeCloudWatchLogsConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogConfigurationTypeCloudWatchLogsConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<LogConfigurationTypeCloudWatchLogsConfiguration>() {
           @Override
           public void write(JsonWriter out, LogConfigurationTypeCloudWatchLogsConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogConfigurationTypeCloudWatchLogsConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogConfigurationTypeCloudWatchLogsConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogConfigurationTypeCloudWatchLogsConfiguration
   * @throws IOException if the JSON string is invalid with respect to LogConfigurationTypeCloudWatchLogsConfiguration
   */
  public static LogConfigurationTypeCloudWatchLogsConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogConfigurationTypeCloudWatchLogsConfiguration.class);
  }

  /**
   * Convert an instance of LogConfigurationTypeCloudWatchLogsConfiguration to an JSON string
   *
   * @return JSON string
   */
