...
public class NewDeviceMetadataType {
  ...
  public static final String SERIALIZED_NAME_DEVICE_GROUP_KEY = "DeviceGroupKey";
  @SerializedName(SERIALIZED_NAME_DEVICE_GROUP_KEY)
  private String deviceGroupKey;

  public NewDeviceMetadataType() {
  }

  public NewDeviceMetadataType deviceKey(String deviceKey) {
  ...
  public NewDeviceMetadataType deviceGroupKey(String deviceGroupKey) {
  ...
  public boolean equals(Object o) {
    ...
    NewDeviceMetadataType newDeviceMetadataType = (NewDeviceMetadataType) o;
    return Objects.equals(this.deviceKey, newDeviceMetadataType.deviceKey) &&
        Objects.equals(this.deviceGroupKey, newDeviceMetadataType.deviceGroupKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deviceKey, deviceGroupKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NewDeviceMetadataType {\n");
    sb.append("    deviceKey: ").append(toIndentedString(deviceKey)).append("\n");
    sb.append("    deviceGroupKey: ").append(toIndentedString(deviceGroupKey)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("DeviceGroupKey");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewDeviceMetadataType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewDeviceMetadataType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewDeviceMetadataType is not found in the empty JSON string", NewDeviceMetadataType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewDeviceMetadataType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewDeviceMetadataType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `DeviceGroupKey`
      if (jsonObj.get("DeviceGroupKey") != null && !jsonObj.get("DeviceGroupKey").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("DeviceGroupKey"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewDeviceMetadataType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewDeviceMetadataType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewDeviceMetadataType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewDeviceMetadataType.class));

       return (TypeAdapter<T>) new TypeAdapter<NewDeviceMetadataType>() {
           @Override
           public void write(JsonWriter out, NewDeviceMetadataType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewDeviceMetadataType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewDeviceMetadataType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewDeviceMetadataType
   * @throws IOException if the JSON string is invalid with respect to NewDeviceMetadataType
   */
  public static NewDeviceMetadataType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewDeviceMetadataType.class);
  }

  /**
   * Convert an instance of NewDeviceMetadataType to an JSON string
   *
   * @return JSON string
   */
