...
public class GetIdentityProviderByIdentifierResponse {
  ...
  public GetIdentityProviderByIdentifierResponse() {
  }

  public GetIdentityProviderByIdentifierResponse identityProvider(DescribeIdentityProviderResponseIdentityProvider identityProvider) {
  ...
  public boolean equals(Object o) {
    ...
    GetIdentityProviderByIdentifierResponse getIdentityProviderByIdentifierResponse = (GetIdentityProviderByIdentifierResponse) o;
    return Objects.equals(this.identityProvider, getIdentityProviderByIdentifierResponse.identityProvider);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIdentityProviderByIdentifierResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIdentityProviderByIdentifierResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIdentityProviderByIdentifierResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIdentityProviderByIdentifierResponse is not found in the empty JSON string", GetIdentityProviderByIdentifierResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIdentityProviderByIdentifierResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIdentityProviderByIdentifierResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetIdentityProviderByIdentifierResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIdentityProviderByIdentifierResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIdentityProviderByIdentifierResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIdentityProviderByIdentifierResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIdentityProviderByIdentifierResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIdentityProviderByIdentifierResponse>() {
           @Override
           public void write(JsonWriter out, GetIdentityProviderByIdentifierResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIdentityProviderByIdentifierResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIdentityProviderByIdentifierResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIdentityProviderByIdentifierResponse
   * @throws IOException if the JSON string is invalid with respect to GetIdentityProviderByIdentifierResponse
   */
  public static GetIdentityProviderByIdentifierResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIdentityProviderByIdentifierResponse.class);
  }

  /**
   * Convert an instance of GetIdentityProviderByIdentifierResponse to an JSON string
   *
   * @return JSON string
   */
