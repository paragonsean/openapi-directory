...
public class DeleteUserPoolRequest {
  ...
  public DeleteUserPoolRequest userPoolId(String userPoolId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolId, deleteUserPoolRequest.userPoolId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteUserPoolRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteUserPoolRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteUserPoolRequest is not found in the empty JSON string", DeleteUserPoolRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteUserPoolRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteUserPoolRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteUserPoolRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteUserPoolRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteUserPoolRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteUserPoolRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteUserPoolRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteUserPoolRequest>() {
           @Override
           public void write(JsonWriter out, DeleteUserPoolRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteUserPoolRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteUserPoolRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteUserPoolRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteUserPoolRequest
   */
  public static DeleteUserPoolRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteUserPoolRequest.class);
  }

  /**
   * Convert an instance of DeleteUserPoolRequest to an JSON string
   *
   * @return JSON string
   */
