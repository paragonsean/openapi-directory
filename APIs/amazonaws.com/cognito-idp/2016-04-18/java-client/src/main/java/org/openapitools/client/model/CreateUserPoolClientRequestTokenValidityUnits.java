...
public class CreateUserPoolClientRequestTokenValidityUnits {
  public static final String SERIALIZED_NAME_ACCESS_TOKEN = "AccessToken";
  @SerializedName(SERIALIZED_NAME_ACCESS_TOKEN)
  private TimeUnitsType accessToken;

  public static final String SERIALIZED_NAME_ID_TOKEN = "IdToken";
  @SerializedName(SERIALIZED_NAME_ID_TOKEN)
  private TimeUnitsType idToken;

  public static final String SERIALIZED_NAME_REFRESH_TOKEN = "RefreshToken";
  @SerializedName(SERIALIZED_NAME_REFRESH_TOKEN)
  private TimeUnitsType refreshToken;

  public CreateUserPoolClientRequestTokenValidityUnits() {
  }

  public CreateUserPoolClientRequestTokenValidityUnits accessToken(TimeUnitsType accessToken) {
  ...
  public TimeUnitsType getAccessToken() {
    return accessToken;
  }
  ...
  public CreateUserPoolClientRequestTokenValidityUnits idToken(TimeUnitsType idToken) {
   ...
   */
  @javax.annotation.Nullable
  public TimeUnitsType getIdToken() {
    return idToken;
  }
  ...
  public CreateUserPoolClientRequestTokenValidityUnits refreshToken(TimeUnitsType refreshToken) {
   ...
   */
  @javax.annotation.Nullable
  public TimeUnitsType getRefreshToken() {
    return refreshToken;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateUserPoolClientRequestTokenValidityUnits createUserPoolClientRequestTokenValidityUnits = (CreateUserPoolClientRequestTokenValidityUnits) o;
    return Objects.equals(this.accessToken, createUserPoolClientRequestTokenValidityUnits.accessToken) &&
        Objects.equals(this.idToken, createUserPoolClientRequestTokenValidityUnits.idToken) &&
        Objects.equals(this.refreshToken, createUserPoolClientRequestTokenValidityUnits.refreshToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUserPoolClientRequestTokenValidityUnits {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolClientRequestTokenValidityUnits
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolClientRequestTokenValidityUnits.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolClientRequestTokenValidityUnits is not found in the empty JSON string", CreateUserPoolClientRequestTokenValidityUnits.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolClientRequestTokenValidityUnits.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolClientRequestTokenValidityUnits` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `AccessToken`
      if (jsonObj.get("AccessToken") != null && !jsonObj.get("AccessToken").isJsonNull()) {
        TimeUnitsType.validateJsonElement(jsonObj.get("AccessToken"));
      }
      // validate the optional field `IdToken`
      if (jsonObj.get("IdToken") != null && !jsonObj.get("IdToken").isJsonNull()) {
        TimeUnitsType.validateJsonElement(jsonObj.get("IdToken"));
      }
      // validate the optional field `RefreshToken`
      if (jsonObj.get("RefreshToken") != null && !jsonObj.get("RefreshToken").isJsonNull()) {
        TimeUnitsType.validateJsonElement(jsonObj.get("RefreshToken"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolClientRequestTokenValidityUnits.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolClientRequestTokenValidityUnits' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolClientRequestTokenValidityUnits> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolClientRequestTokenValidityUnits.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolClientRequestTokenValidityUnits>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolClientRequestTokenValidityUnits value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolClientRequestTokenValidityUnits read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolClientRequestTokenValidityUnits given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolClientRequestTokenValidityUnits
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolClientRequestTokenValidityUnits
   */
  public static CreateUserPoolClientRequestTokenValidityUnits fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolClientRequestTokenValidityUnits.class);
  }

  /**
   * Convert an instance of CreateUserPoolClientRequestTokenValidityUnits to an JSON string
   *
   * @return JSON string
   */
