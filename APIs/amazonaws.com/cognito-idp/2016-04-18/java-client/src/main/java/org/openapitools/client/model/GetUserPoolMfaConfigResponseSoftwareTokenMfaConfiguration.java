...
public class GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration {
  public static final String SERIALIZED_NAME_ENABLED = "Enabled";
  @SerializedName(SERIALIZED_NAME_ENABLED)
  private Boolean enabled;

  public GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration() {
  }

  public GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration getUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration = (GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration) o;
    return Objects.equals(this.enabled, getUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration is not found in the empty JSON string", GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration>() {
           @Override
           public void write(JsonWriter out, GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration
   * @throws IOException if the JSON string is invalid with respect to GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration
   */
  public static GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.class);
  }

  /**
   * Convert an instance of GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration to an JSON string
   *
   * @return JSON string
   */
