...
import org.openapitools.client.model.ConfirmDeviceRequestDeviceSecretVerifierConfig;
...
public class ConfirmDeviceRequest {
  ...
  public static final String SERIALIZED_NAME_DEVICE_SECRET_VERIFIER_CONFIG = "DeviceSecretVerifierConfig";
  @SerializedName(SERIALIZED_NAME_DEVICE_SECRET_VERIFIER_CONFIG)
  private ConfirmDeviceRequestDeviceSecretVerifierConfig deviceSecretVerifierConfig;
  ...
  public ConfirmDeviceRequest accessToken(String accessToken) {
  ...
  public ConfirmDeviceRequest deviceKey(String deviceKey) {
  ...
  public ConfirmDeviceRequest deviceSecretVerifierConfig(ConfirmDeviceRequestDeviceSecretVerifierConfig deviceSecretVerifierConfig) {
  ...
  public ConfirmDeviceRequestDeviceSecretVerifierConfig getDeviceSecretVerifierConfig() {
    return deviceSecretVerifierConfig;
  }

  public void setDeviceSecretVerifierConfig(ConfirmDeviceRequestDeviceSecretVerifierConfig deviceSecretVerifierConfig) {
    this.deviceSecretVerifierConfig = deviceSecretVerifierConfig;
  }


  public ConfirmDeviceRequest deviceName(String deviceName) {
  ...
  public boolean equals(Object o) {
    ...
    ConfirmDeviceRequest confirmDeviceRequest = (ConfirmDeviceRequest) o;
    return Objects.equals(this.accessToken, confirmDeviceRequest.accessToken) &&
        Objects.equals(this.deviceKey, confirmDeviceRequest.deviceKey) &&
        Objects.equals(this.deviceSecretVerifierConfig, confirmDeviceRequest.deviceSecretVerifierConfig) &&
        Objects.equals(this.deviceName, confirmDeviceRequest.deviceName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, deviceKey, deviceSecretVerifierConfig, deviceName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConfirmDeviceRequest {\n");
    sb.append("    accessToken: ").append(toIndentedString(accessToken)).append("\n");
    sb.append("    deviceKey: ").append(toIndentedString(deviceKey)).append("\n");
    sb.append("    deviceSecretVerifierConfig: ").append(toIndentedString(deviceSecretVerifierConfig)).append("\n");
  ...
  static {
    ...
    openapiFields.add("DeviceSecretVerifierConfig");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfirmDeviceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfirmDeviceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfirmDeviceRequest is not found in the empty JSON string", ConfirmDeviceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfirmDeviceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfirmDeviceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConfirmDeviceRequest.openapiRequiredFields) {
      ...
      // validate the optional field `DeviceSecretVerifierConfig`
      if (jsonObj.get("DeviceSecretVerifierConfig") != null && !jsonObj.get("DeviceSecretVerifierConfig").isJsonNull()) {
        ConfirmDeviceRequestDeviceSecretVerifierConfig.validateJsonElement(jsonObj.get("DeviceSecretVerifierConfig"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfirmDeviceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfirmDeviceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfirmDeviceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfirmDeviceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfirmDeviceRequest>() {
           @Override
           public void write(JsonWriter out, ConfirmDeviceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfirmDeviceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfirmDeviceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfirmDeviceRequest
   * @throws IOException if the JSON string is invalid with respect to ConfirmDeviceRequest
   */
  public static ConfirmDeviceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfirmDeviceRequest.class);
  }

  /**
   * Convert an instance of ConfirmDeviceRequest to an JSON string
   *
   * @return JSON string
   */
