...
public class ListIdentityProvidersRequest {
  ...
  public ListIdentityProvidersRequest userPoolId(String userPoolId) {
  ...
  public ListIdentityProvidersRequest maxResults(Integer maxResults) {
  ...
  public ListIdentityProvidersRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolId, listIdentityProvidersRequest.userPoolId) &&
        Objects.equals(this.maxResults, listIdentityProvidersRequest.maxResults) &&
        Objects.equals(this.nextToken, listIdentityProvidersRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, maxResults, nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListIdentityProvidersRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListIdentityProvidersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListIdentityProvidersRequest is not found in the empty JSON string", ListIdentityProvidersRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListIdentityProvidersRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListIdentityProvidersRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListIdentityProvidersRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListIdentityProvidersRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListIdentityProvidersRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListIdentityProvidersRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListIdentityProvidersRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListIdentityProvidersRequest>() {
           @Override
           public void write(JsonWriter out, ListIdentityProvidersRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListIdentityProvidersRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListIdentityProvidersRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListIdentityProvidersRequest
   * @throws IOException if the JSON string is invalid with respect to ListIdentityProvidersRequest
   */
  public static ListIdentityProvidersRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListIdentityProvidersRequest.class);
  }

  /**
   * Convert an instance of ListIdentityProvidersRequest to an JSON string
   *
   * @return JSON string
   */
