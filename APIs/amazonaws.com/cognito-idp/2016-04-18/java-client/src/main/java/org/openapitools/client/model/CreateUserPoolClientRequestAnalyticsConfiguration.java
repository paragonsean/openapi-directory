...
public class CreateUserPoolClientRequestAnalyticsConfiguration {
  ...
  public static final String SERIALIZED_NAME_USER_DATA_SHARED = "UserDataShared";
  @SerializedName(SERIALIZED_NAME_USER_DATA_SHARED)
  private Boolean userDataShared;

  public CreateUserPoolClientRequestAnalyticsConfiguration() {
  }

  public CreateUserPoolClientRequestAnalyticsConfiguration applicationId(String applicationId) {
  ...
  public CreateUserPoolClientRequestAnalyticsConfiguration applicationArn(String applicationArn) {
  ...
  public CreateUserPoolClientRequestAnalyticsConfiguration roleArn(String roleArn) {
  ...
  public CreateUserPoolClientRequestAnalyticsConfiguration externalId(String externalId) {
  ...
  public CreateUserPoolClientRequestAnalyticsConfiguration userDataShared(Boolean userDataShared) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUserPoolClientRequestAnalyticsConfiguration createUserPoolClientRequestAnalyticsConfiguration = (CreateUserPoolClientRequestAnalyticsConfiguration) o;
    return Objects.equals(this.applicationId, createUserPoolClientRequestAnalyticsConfiguration.applicationId) &&
        Objects.equals(this.applicationArn, createUserPoolClientRequestAnalyticsConfiguration.applicationArn) &&
        Objects.equals(this.roleArn, createUserPoolClientRequestAnalyticsConfiguration.roleArn) &&
        Objects.equals(this.externalId, createUserPoolClientRequestAnalyticsConfiguration.externalId) &&
        Objects.equals(this.userDataShared, createUserPoolClientRequestAnalyticsConfiguration.userDataShared);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicationId, applicationArn, roleArn, externalId, userDataShared);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateUserPoolClientRequestAnalyticsConfiguration {\n");
    sb.append("    applicationId: ").append(toIndentedString(applicationId)).append("\n");
    sb.append("    applicationArn: ").append(toIndentedString(applicationArn)).append("\n");
    sb.append("    roleArn: ").append(toIndentedString(roleArn)).append("\n");
    sb.append("    externalId: ").append(toIndentedString(externalId)).append("\n");
    sb.append("    userDataShared: ").append(toIndentedString(userDataShared)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("UserDataShared");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolClientRequestAnalyticsConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolClientRequestAnalyticsConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolClientRequestAnalyticsConfiguration is not found in the empty JSON string", CreateUserPoolClientRequestAnalyticsConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolClientRequestAnalyticsConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolClientRequestAnalyticsConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("UserDataShared") != null && !jsonObj.get("UserDataShared").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("UserDataShared"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolClientRequestAnalyticsConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolClientRequestAnalyticsConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolClientRequestAnalyticsConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolClientRequestAnalyticsConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolClientRequestAnalyticsConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolClientRequestAnalyticsConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolClientRequestAnalyticsConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolClientRequestAnalyticsConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolClientRequestAnalyticsConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolClientRequestAnalyticsConfiguration
   */
  public static CreateUserPoolClientRequestAnalyticsConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolClientRequestAnalyticsConfiguration.class);
  }

  /**
   * Convert an instance of CreateUserPoolClientRequestAnalyticsConfiguration to an JSON string
   *
   * @return JSON string
   */
