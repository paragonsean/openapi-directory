...
public class DeviceSecretVerifierConfigType {
  ...
  public DeviceSecretVerifierConfigType passwordVerifier(String passwordVerifier) {
  ...
  public DeviceSecretVerifierConfigType salt(String salt) {
    this.salt = salt;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceSecretVerifierConfigType deviceSecretVerifierConfigType = (DeviceSecretVerifierConfigType) o;
    return Objects.equals(this.passwordVerifier, deviceSecretVerifierConfigType.passwordVerifier) &&
        Objects.equals(this.salt, deviceSecretVerifierConfigType.salt);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceSecretVerifierConfigType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeviceSecretVerifierConfigType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceSecretVerifierConfigType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeviceSecretVerifierConfigType is not found in the empty JSON string", DeviceSecretVerifierConfigType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeviceSecretVerifierConfigType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeviceSecretVerifierConfigType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeviceSecretVerifierConfigType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeviceSecretVerifierConfigType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeviceSecretVerifierConfigType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeviceSecretVerifierConfigType.class));

       return (TypeAdapter<T>) new TypeAdapter<DeviceSecretVerifierConfigType>() {
           @Override
           public void write(JsonWriter out, DeviceSecretVerifierConfigType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeviceSecretVerifierConfigType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeviceSecretVerifierConfigType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeviceSecretVerifierConfigType
   * @throws IOException if the JSON string is invalid with respect to DeviceSecretVerifierConfigType
   */
  public static DeviceSecretVerifierConfigType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeviceSecretVerifierConfigType.class);
  }

  /**
   * Convert an instance of DeviceSecretVerifierConfigType to an JSON string
   *
   * @return JSON string
   */
