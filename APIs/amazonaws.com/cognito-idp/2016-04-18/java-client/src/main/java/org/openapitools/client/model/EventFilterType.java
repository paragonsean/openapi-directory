...
/**
 * Gets or Sets EventFilterType
 */
@JsonAdapter(EventFilterType.Adapter.class)
public enum EventFilterType {
  ...
  public static EventFilterType fromValue(String value) {
    for (EventFilterType b : EventFilterType.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventFilterType> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventFilterType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventFilterType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventFilterType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EventFilterType.fromValue(value);
  }
}
