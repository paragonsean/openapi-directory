...
public class GetUserPoolMfaConfigResponseSmsMfaConfiguration {
  ...
  public GetUserPoolMfaConfigResponseSmsMfaConfiguration() {
  }

  public GetUserPoolMfaConfigResponseSmsMfaConfiguration smsAuthenticationMessage(String smsAuthenticationMessage) {
  ...
  public GetUserPoolMfaConfigResponseSmsMfaConfiguration smsConfiguration(SmsMfaConfigTypeSmsConfiguration smsConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    GetUserPoolMfaConfigResponseSmsMfaConfiguration getUserPoolMfaConfigResponseSmsMfaConfiguration = (GetUserPoolMfaConfigResponseSmsMfaConfiguration) o;
    return Objects.equals(this.smsAuthenticationMessage, getUserPoolMfaConfigResponseSmsMfaConfiguration.smsAuthenticationMessage) &&
        Objects.equals(this.smsConfiguration, getUserPoolMfaConfigResponseSmsMfaConfiguration.smsConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetUserPoolMfaConfigResponseSmsMfaConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUserPoolMfaConfigResponseSmsMfaConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUserPoolMfaConfigResponseSmsMfaConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUserPoolMfaConfigResponseSmsMfaConfiguration is not found in the empty JSON string", GetUserPoolMfaConfigResponseSmsMfaConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUserPoolMfaConfigResponseSmsMfaConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUserPoolMfaConfigResponseSmsMfaConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUserPoolMfaConfigResponseSmsMfaConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUserPoolMfaConfigResponseSmsMfaConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUserPoolMfaConfigResponseSmsMfaConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUserPoolMfaConfigResponseSmsMfaConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUserPoolMfaConfigResponseSmsMfaConfiguration>() {
           @Override
           public void write(JsonWriter out, GetUserPoolMfaConfigResponseSmsMfaConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUserPoolMfaConfigResponseSmsMfaConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUserPoolMfaConfigResponseSmsMfaConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUserPoolMfaConfigResponseSmsMfaConfiguration
   * @throws IOException if the JSON string is invalid with respect to GetUserPoolMfaConfigResponseSmsMfaConfiguration
   */
  public static GetUserPoolMfaConfigResponseSmsMfaConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUserPoolMfaConfigResponseSmsMfaConfiguration.class);
  }

  /**
   * Convert an instance of GetUserPoolMfaConfigResponseSmsMfaConfiguration to an JSON string
   *
   * @return JSON string
   */
