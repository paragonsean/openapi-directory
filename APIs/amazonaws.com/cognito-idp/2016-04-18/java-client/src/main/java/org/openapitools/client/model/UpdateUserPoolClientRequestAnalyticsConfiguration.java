...
public class UpdateUserPoolClientRequestAnalyticsConfiguration {
  ...
  public UpdateUserPoolClientRequestAnalyticsConfiguration() {
  }

  public UpdateUserPoolClientRequestAnalyticsConfiguration applicationId(String applicationId) {
  ...
  public UpdateUserPoolClientRequestAnalyticsConfiguration applicationArn(String applicationArn) {
  ...
  public UpdateUserPoolClientRequestAnalyticsConfiguration roleArn(String roleArn) {
  ...
  public UpdateUserPoolClientRequestAnalyticsConfiguration externalId(String externalId) {
  ...
  public UpdateUserPoolClientRequestAnalyticsConfiguration userDataShared(Boolean userDataShared) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateUserPoolClientRequestAnalyticsConfiguration updateUserPoolClientRequestAnalyticsConfiguration = (UpdateUserPoolClientRequestAnalyticsConfiguration) o;
    return Objects.equals(this.applicationId, updateUserPoolClientRequestAnalyticsConfiguration.applicationId) &&
        Objects.equals(this.applicationArn, updateUserPoolClientRequestAnalyticsConfiguration.applicationArn) &&
        Objects.equals(this.roleArn, updateUserPoolClientRequestAnalyticsConfiguration.roleArn) &&
        Objects.equals(this.externalId, updateUserPoolClientRequestAnalyticsConfiguration.externalId) &&
        Objects.equals(this.userDataShared, updateUserPoolClientRequestAnalyticsConfiguration.userDataShared);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateUserPoolClientRequestAnalyticsConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserPoolClientRequestAnalyticsConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserPoolClientRequestAnalyticsConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserPoolClientRequestAnalyticsConfiguration is not found in the empty JSON string", UpdateUserPoolClientRequestAnalyticsConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserPoolClientRequestAnalyticsConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserPoolClientRequestAnalyticsConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserPoolClientRequestAnalyticsConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserPoolClientRequestAnalyticsConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserPoolClientRequestAnalyticsConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserPoolClientRequestAnalyticsConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserPoolClientRequestAnalyticsConfiguration>() {
           @Override
           public void write(JsonWriter out, UpdateUserPoolClientRequestAnalyticsConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserPoolClientRequestAnalyticsConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserPoolClientRequestAnalyticsConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserPoolClientRequestAnalyticsConfiguration
   * @throws IOException if the JSON string is invalid with respect to UpdateUserPoolClientRequestAnalyticsConfiguration
   */
  public static UpdateUserPoolClientRequestAnalyticsConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserPoolClientRequestAnalyticsConfiguration.class);
  }

  /**
   * Convert an instance of UpdateUserPoolClientRequestAnalyticsConfiguration to an JSON string
   *
   * @return JSON string
   */
