...
/**
 * Gets or Sets TimeUnitsType
 */
@JsonAdapter(TimeUnitsType.Adapter.class)
public enum TimeUnitsType {
  ...
  public static TimeUnitsType fromValue(String value) {
    for (TimeUnitsType b : TimeUnitsType.values()) {
  ...
  public static class Adapter extends TypeAdapter<TimeUnitsType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TimeUnitsType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TimeUnitsType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TimeUnitsType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TimeUnitsType.fromValue(value);
  }
}
