...
public class StringAttributeConstraintsType {
  ...
  public StringAttributeConstraintsType minLength(String minLength) {
  ...
  public StringAttributeConstraintsType maxLength(String maxLength) {
  ...
  public boolean equals(Object o) {
    ...
    StringAttributeConstraintsType stringAttributeConstraintsType = (StringAttributeConstraintsType) o;
    return Objects.equals(this.minLength, stringAttributeConstraintsType.minLength) &&
        Objects.equals(this.maxLength, stringAttributeConstraintsType.maxLength);
  }
  ...
  public String toString() {
    ...
    sb.append("class StringAttributeConstraintsType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StringAttributeConstraintsType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StringAttributeConstraintsType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StringAttributeConstraintsType is not found in the empty JSON string", StringAttributeConstraintsType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StringAttributeConstraintsType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StringAttributeConstraintsType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StringAttributeConstraintsType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StringAttributeConstraintsType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StringAttributeConstraintsType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StringAttributeConstraintsType.class));

       return (TypeAdapter<T>) new TypeAdapter<StringAttributeConstraintsType>() {
           @Override
           public void write(JsonWriter out, StringAttributeConstraintsType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StringAttributeConstraintsType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StringAttributeConstraintsType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StringAttributeConstraintsType
   * @throws IOException if the JSON string is invalid with respect to StringAttributeConstraintsType
   */
  public static StringAttributeConstraintsType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StringAttributeConstraintsType.class);
  }

  /**
   * Convert an instance of StringAttributeConstraintsType to an JSON string
   *
   * @return JSON string
   */
