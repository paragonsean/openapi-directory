...
public class UserPoolClientTypeAnalyticsConfiguration {
  ...
  public UserPoolClientTypeAnalyticsConfiguration() {
  }

  public UserPoolClientTypeAnalyticsConfiguration applicationId(String applicationId) {
  ...
  public UserPoolClientTypeAnalyticsConfiguration applicationArn(String applicationArn) {
  ...
  public UserPoolClientTypeAnalyticsConfiguration roleArn(String roleArn) {
  ...
  public UserPoolClientTypeAnalyticsConfiguration externalId(String externalId) {
  ...
  public UserPoolClientTypeAnalyticsConfiguration userDataShared(Boolean userDataShared) {
  ...
  public boolean equals(Object o) {
    ...
    UserPoolClientTypeAnalyticsConfiguration userPoolClientTypeAnalyticsConfiguration = (UserPoolClientTypeAnalyticsConfiguration) o;
    return Objects.equals(this.applicationId, userPoolClientTypeAnalyticsConfiguration.applicationId) &&
        Objects.equals(this.applicationArn, userPoolClientTypeAnalyticsConfiguration.applicationArn) &&
        Objects.equals(this.roleArn, userPoolClientTypeAnalyticsConfiguration.roleArn) &&
        Objects.equals(this.externalId, userPoolClientTypeAnalyticsConfiguration.externalId) &&
        Objects.equals(this.userDataShared, userPoolClientTypeAnalyticsConfiguration.userDataShared);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserPoolClientTypeAnalyticsConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserPoolClientTypeAnalyticsConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPoolClientTypeAnalyticsConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserPoolClientTypeAnalyticsConfiguration is not found in the empty JSON string", UserPoolClientTypeAnalyticsConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserPoolClientTypeAnalyticsConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserPoolClientTypeAnalyticsConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserPoolClientTypeAnalyticsConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserPoolClientTypeAnalyticsConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserPoolClientTypeAnalyticsConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserPoolClientTypeAnalyticsConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UserPoolClientTypeAnalyticsConfiguration>() {
           @Override
           public void write(JsonWriter out, UserPoolClientTypeAnalyticsConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserPoolClientTypeAnalyticsConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserPoolClientTypeAnalyticsConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserPoolClientTypeAnalyticsConfiguration
   * @throws IOException if the JSON string is invalid with respect to UserPoolClientTypeAnalyticsConfiguration
   */
  public static UserPoolClientTypeAnalyticsConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserPoolClientTypeAnalyticsConfiguration.class);
  }

  /**
   * Convert an instance of UserPoolClientTypeAnalyticsConfiguration to an JSON string
   *
   * @return JSON string
   */
