...
public class NumberAttributeConstraintsType {
  ...
  public NumberAttributeConstraintsType minValue(String minValue) {
  ...
  public NumberAttributeConstraintsType maxValue(String maxValue) {
  ...
  public boolean equals(Object o) {
    ...
    NumberAttributeConstraintsType numberAttributeConstraintsType = (NumberAttributeConstraintsType) o;
    return Objects.equals(this.minValue, numberAttributeConstraintsType.minValue) &&
        Objects.equals(this.maxValue, numberAttributeConstraintsType.maxValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class NumberAttributeConstraintsType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NumberAttributeConstraintsType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NumberAttributeConstraintsType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NumberAttributeConstraintsType is not found in the empty JSON string", NumberAttributeConstraintsType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NumberAttributeConstraintsType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NumberAttributeConstraintsType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NumberAttributeConstraintsType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NumberAttributeConstraintsType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NumberAttributeConstraintsType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NumberAttributeConstraintsType.class));

       return (TypeAdapter<T>) new TypeAdapter<NumberAttributeConstraintsType>() {
           @Override
           public void write(JsonWriter out, NumberAttributeConstraintsType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NumberAttributeConstraintsType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NumberAttributeConstraintsType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NumberAttributeConstraintsType
   * @throws IOException if the JSON string is invalid with respect to NumberAttributeConstraintsType
   */
  public static NumberAttributeConstraintsType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NumberAttributeConstraintsType.class);
  }

  /**
   * Convert an instance of NumberAttributeConstraintsType to an JSON string
   *
   * @return JSON string
   */
