...
import org.openapitools.client.model.UpdateUserPoolDomainRequestCustomDomainConfig;
...
public class UpdateUserPoolDomainRequest {
  ...
  private UpdateUserPoolDomainRequestCustomDomainConfig customDomainConfig;

  public UpdateUserPoolDomainRequest() {
  }

  public UpdateUserPoolDomainRequest domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public UpdateUserPoolDomainRequest userPoolId(String userPoolId) {
  ...
  public UpdateUserPoolDomainRequest customDomainConfig(UpdateUserPoolDomainRequestCustomDomainConfig customDomainConfig) {
   ...
   */
  @javax.annotation.Nonnull
  public UpdateUserPoolDomainRequestCustomDomainConfig getCustomDomainConfig() {
    return customDomainConfig;
  }

  public void setCustomDomainConfig(UpdateUserPoolDomainRequestCustomDomainConfig customDomainConfig) {
    this.customDomainConfig = customDomainConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateUserPoolDomainRequest updateUserPoolDomainRequest = (UpdateUserPoolDomainRequest) o;
    return Objects.equals(this.domain, updateUserPoolDomainRequest.domain) &&
        Objects.equals(this.userPoolId, updateUserPoolDomainRequest.userPoolId) &&
        Objects.equals(this.customDomainConfig, updateUserPoolDomainRequest.customDomainConfig);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, userPoolId, customDomainConfig);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateUserPoolDomainRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("CustomDomainConfig");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserPoolDomainRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserPoolDomainRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserPoolDomainRequest is not found in the empty JSON string", UpdateUserPoolDomainRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserPoolDomainRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserPoolDomainRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateUserPoolDomainRequest.openapiRequiredFields) {
      ...
      // validate the required field `CustomDomainConfig`
      UpdateUserPoolDomainRequestCustomDomainConfig.validateJsonElement(jsonObj.get("CustomDomainConfig"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserPoolDomainRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserPoolDomainRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserPoolDomainRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserPoolDomainRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserPoolDomainRequest>() {
           @Override
           public void write(JsonWriter out, UpdateUserPoolDomainRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserPoolDomainRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserPoolDomainRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserPoolDomainRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateUserPoolDomainRequest
   */
  public static UpdateUserPoolDomainRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserPoolDomainRequest.class);
  }

  /**
   * Convert an instance of UpdateUserPoolDomainRequest to an JSON string
   *
   * @return JSON string
   */
