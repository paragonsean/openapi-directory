...
public class UserContextDataType {
  ...
  public UserContextDataType ipAddress(String ipAddress) {
  ...
  public UserContextDataType encodedData(String encodedData) {
  ...
  public boolean equals(Object o) {
    ...
    UserContextDataType userContextDataType = (UserContextDataType) o;
    return Objects.equals(this.ipAddress, userContextDataType.ipAddress) &&
        Objects.equals(this.encodedData, userContextDataType.encodedData);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserContextDataType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserContextDataType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserContextDataType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserContextDataType is not found in the empty JSON string", UserContextDataType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserContextDataType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserContextDataType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserContextDataType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserContextDataType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserContextDataType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserContextDataType.class));

       return (TypeAdapter<T>) new TypeAdapter<UserContextDataType>() {
           @Override
           public void write(JsonWriter out, UserContextDataType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserContextDataType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserContextDataType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserContextDataType
   * @throws IOException if the JSON string is invalid with respect to UserContextDataType
   */
  public static UserContextDataType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserContextDataType.class);
  }

  /**
   * Convert an instance of UserContextDataType to an JSON string
   *
   * @return JSON string
   */
