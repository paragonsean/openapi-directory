...
import org.openapitools.client.model.MessageActionType;
...
public class AdminCreateUserRequest {
  ...
  public static final String SERIALIZED_NAME_FORCE_ALIAS_CREATION = "ForceAliasCreation";
  @SerializedName(SERIALIZED_NAME_FORCE_ALIAS_CREATION)
  ...
  public static final String SERIALIZED_NAME_DESIRED_DELIVERY_MEDIUMS = "DesiredDeliveryMediums";
  @SerializedName(SERIALIZED_NAME_DESIRED_DELIVERY_MEDIUMS)
  ...
  public AdminCreateUserRequest userPoolId(String userPoolId) {
  ...
  public AdminCreateUserRequest username(String username) {
  ...
  public AdminCreateUserRequest userAttributes(List userAttributes) {
  ...
  public AdminCreateUserRequest validationData(List validationData) {
  ...
  public AdminCreateUserRequest temporaryPassword(String temporaryPassword) {
  ...
  public AdminCreateUserRequest forceAliasCreation(Boolean forceAliasCreation) {
    this.forceAliasCreation = forceAliasCreation;
    return this;
  }

  /**
   * Get forceAliasCreation
  ...
  public AdminCreateUserRequest messageAction(MessageActionType messageAction) {
  ...
  public AdminCreateUserRequest desiredDeliveryMediums(List desiredDeliveryMediums) {
    this.desiredDeliveryMediums = desiredDeliveryMediums;
    return this;
  }

  /**
   * Get desiredDeliveryMediums
  ...
  public void setDesiredDeliveryMediums(List desiredDeliveryMediums) {
    this.desiredDeliveryMediums = desiredDeliveryMediums;
  }


  public AdminCreateUserRequest clientMetadata(Map clientMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolId, adminCreateUserRequest.userPoolId) &&
        Objects.equals(this.username, adminCreateUserRequest.username) &&
        Objects.equals(this.userAttributes, adminCreateUserRequest.userAttributes) &&
        Objects.equals(this.validationData, adminCreateUserRequest.validationData) &&
        Objects.equals(this.temporaryPassword, adminCreateUserRequest.temporaryPassword) &&
        Objects.equals(this.forceAliasCreation, adminCreateUserRequest.forceAliasCreation) &&
        Objects.equals(this.messageAction, adminCreateUserRequest.messageAction) &&
        Objects.equals(this.desiredDeliveryMediums, adminCreateUserRequest.desiredDeliveryMediums) &&
        Objects.equals(this.clientMetadata, adminCreateUserRequest.clientMetadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username, userAttributes, validationData, temporaryPassword, forceAliasCreation, messageAction, desiredDeliveryMediums, clientMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("    forceAliasCreation: ").append(toIndentedString(forceAliasCreation)).append("\n");
    sb.append("    messageAction: ").append(toIndentedString(messageAction)).append("\n");
    sb.append("    desiredDeliveryMediums: ").append(toIndentedString(desiredDeliveryMediums)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ForceAliasCreation");
    openapiFields.add("MessageAction");
    openapiFields.add("DesiredDeliveryMediums");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminCreateUserRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminCreateUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminCreateUserRequest is not found in the empty JSON string", AdminCreateUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminCreateUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminCreateUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminCreateUserRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("ForceAliasCreation") != null && !jsonObj.get("ForceAliasCreation").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("ForceAliasCreation"));
      }
      // validate the optional field `MessageAction`
      if (jsonObj.get("MessageAction") != null && !jsonObj.get("MessageAction").isJsonNull()) {
        MessageActionType.validateJsonElement(jsonObj.get("MessageAction"));
      }
      // validate the optional field `DesiredDeliveryMediums`
      if (jsonObj.get("DesiredDeliveryMediums") != null && !jsonObj.get("DesiredDeliveryMediums").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("DesiredDeliveryMediums"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminCreateUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminCreateUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminCreateUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminCreateUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminCreateUserRequest>() {
           @Override
           public void write(JsonWriter out, AdminCreateUserRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminCreateUserRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminCreateUserRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminCreateUserRequest
   * @throws IOException if the JSON string is invalid with respect to AdminCreateUserRequest
   */
  public static AdminCreateUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminCreateUserRequest.class);
  }

  /**
   * Convert an instance of AdminCreateUserRequest to an JSON string
   *
   * @return JSON string
   */
