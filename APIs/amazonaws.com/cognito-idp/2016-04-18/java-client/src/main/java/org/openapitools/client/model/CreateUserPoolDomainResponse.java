...
public class CreateUserPoolDomainResponse {
  ...
  public CreateUserPoolDomainResponse cloudFrontDomain(String cloudFrontDomain) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cloudFrontDomain, createUserPoolDomainResponse.cloudFrontDomain);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolDomainResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolDomainResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolDomainResponse is not found in the empty JSON string", CreateUserPoolDomainResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolDomainResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolDomainResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolDomainResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolDomainResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolDomainResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolDomainResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolDomainResponse>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolDomainResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolDomainResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolDomainResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolDomainResponse
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolDomainResponse
   */
  public static CreateUserPoolDomainResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolDomainResponse.class);
  }

  /**
   * Convert an instance of CreateUserPoolDomainResponse to an JSON string
   *
   * @return JSON string
   */
