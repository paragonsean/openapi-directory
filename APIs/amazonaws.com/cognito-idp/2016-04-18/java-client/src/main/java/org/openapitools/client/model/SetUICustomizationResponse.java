...
import org.openapitools.client.model.GetUICustomizationResponseUICustomization;
...
public class SetUICustomizationResponse {
  public static final String SERIALIZED_NAME_UI_CUSTOMIZATION = "UICustomization";
  @SerializedName(SERIALIZED_NAME_UI_CUSTOMIZATION)
  private GetUICustomizationResponseUICustomization uiCustomization;

  public SetUICustomizationResponse() {
  }

  public SetUICustomizationResponse uiCustomization(GetUICustomizationResponseUICustomization uiCustomization) {
  ...
  public GetUICustomizationResponseUICustomization getUiCustomization() {
    return uiCustomization;
  }

  public void setUiCustomization(GetUICustomizationResponseUICustomization uiCustomization) {
    this.uiCustomization = uiCustomization;
  }
  ...
  public boolean equals(Object o) {
    ...
    SetUICustomizationResponse setUICustomizationResponse = (SetUICustomizationResponse) o;
    return Objects.equals(this.uiCustomization, setUICustomizationResponse.uiCustomization);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uiCustomization);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetUICustomizationResponse {\n");
  ...
  static {
    ...
    openapiFields.add("UICustomization");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("UICustomization");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetUICustomizationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetUICustomizationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetUICustomizationResponse is not found in the empty JSON string", SetUICustomizationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetUICustomizationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetUICustomizationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetUICustomizationResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `UICustomization`
      GetUICustomizationResponseUICustomization.validateJsonElement(jsonObj.get("UICustomization"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetUICustomizationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetUICustomizationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetUICustomizationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetUICustomizationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SetUICustomizationResponse>() {
           @Override
           public void write(JsonWriter out, SetUICustomizationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetUICustomizationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetUICustomizationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetUICustomizationResponse
   * @throws IOException if the JSON string is invalid with respect to SetUICustomizationResponse
   */
  public static SetUICustomizationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetUICustomizationResponse.class);
  }

  /**
   * Convert an instance of SetUICustomizationResponse to an JSON string
   *
   * @return JSON string
   */
