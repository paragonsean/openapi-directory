...
public class AdminGetDeviceResponse {
  ...
  public AdminGetDeviceResponse() {
  }

  public AdminGetDeviceResponse device(AdminGetDeviceResponseDevice device) {
    this.device = device;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AdminGetDeviceResponse adminGetDeviceResponse = (AdminGetDeviceResponse) o;
    return Objects.equals(this.device, adminGetDeviceResponse.device);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdminGetDeviceResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminGetDeviceResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminGetDeviceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminGetDeviceResponse is not found in the empty JSON string", AdminGetDeviceResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminGetDeviceResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminGetDeviceResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminGetDeviceResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminGetDeviceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminGetDeviceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminGetDeviceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminGetDeviceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminGetDeviceResponse>() {
           @Override
           public void write(JsonWriter out, AdminGetDeviceResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminGetDeviceResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminGetDeviceResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminGetDeviceResponse
   * @throws IOException if the JSON string is invalid with respect to AdminGetDeviceResponse
   */
  public static AdminGetDeviceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminGetDeviceResponse.class);
  }

  /**
   * Convert an instance of AdminGetDeviceResponse to an JSON string
   *
   * @return JSON string
   */
