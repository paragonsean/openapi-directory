...
/**
 * Gets or Sets AliasAttributeType
 */
@JsonAdapter(AliasAttributeType.Adapter.class)
public enum AliasAttributeType {
  ...
  AliasAttributeType(String value) {
    this.value = value;
  }
  ...
  public static AliasAttributeType fromValue(String value) {
    for (AliasAttributeType b : AliasAttributeType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AliasAttributeType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AliasAttributeType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AliasAttributeType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AliasAttributeType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AliasAttributeType.fromValue(value);
  }
}
