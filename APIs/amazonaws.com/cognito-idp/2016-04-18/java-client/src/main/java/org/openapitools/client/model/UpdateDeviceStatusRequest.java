...
public class UpdateDeviceStatusRequest {
  ...
  public UpdateDeviceStatusRequest accessToken(String accessToken) {
  ...
  public UpdateDeviceStatusRequest deviceKey(String deviceKey) {
  ...
  public UpdateDeviceStatusRequest deviceRememberedStatus(DeviceRememberedStatusType deviceRememberedStatus) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessToken, updateDeviceStatusRequest.accessToken) &&
        Objects.equals(this.deviceKey, updateDeviceStatusRequest.deviceKey) &&
        Objects.equals(this.deviceRememberedStatus, updateDeviceStatusRequest.deviceRememberedStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, deviceKey, deviceRememberedStatus);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDeviceStatusRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDeviceStatusRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDeviceStatusRequest is not found in the empty JSON string", UpdateDeviceStatusRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDeviceStatusRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDeviceStatusRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateDeviceStatusRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDeviceStatusRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDeviceStatusRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDeviceStatusRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDeviceStatusRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDeviceStatusRequest>() {
           @Override
           public void write(JsonWriter out, UpdateDeviceStatusRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDeviceStatusRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDeviceStatusRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDeviceStatusRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateDeviceStatusRequest
   */
  public static UpdateDeviceStatusRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDeviceStatusRequest.class);
  }

  /**
   * Convert an instance of UpdateDeviceStatusRequest to an JSON string
   *
   * @return JSON string
   */
