...
import org.openapitools.client.model.CreateUserPoolResponseUserPool;
...
public class CreateUserPoolResponse {
  ...
  private CreateUserPoolResponseUserPool userPool;

  public CreateUserPoolResponse() {
  }

  public CreateUserPoolResponse userPool(CreateUserPoolResponseUserPool userPool) {
  ...
  public CreateUserPoolResponseUserPool getUserPool() {
    return userPool;
  }

  public void setUserPool(CreateUserPoolResponseUserPool userPool) {
    this.userPool = userPool;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPool, createUserPoolResponse.userPool);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolResponse is not found in the empty JSON string", CreateUserPoolResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `UserPool`
      if (jsonObj.get("UserPool") != null && !jsonObj.get("UserPool").isJsonNull()) {
        CreateUserPoolResponseUserPool.validateJsonElement(jsonObj.get("UserPool"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolResponse>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolResponse
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolResponse
   */
  public static CreateUserPoolResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolResponse.class);
  }

  /**
   * Convert an instance of CreateUserPoolResponse to an JSON string
   *
   * @return JSON string
   */
