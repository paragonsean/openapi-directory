...
public class ConfirmForgotPasswordRequestUserContextData {
  ...
  public ConfirmForgotPasswordRequestUserContextData() {
  }

  public ConfirmForgotPasswordRequestUserContextData ipAddress(String ipAddress) {
  ...
  public ConfirmForgotPasswordRequestUserContextData encodedData(String encodedData) {
  ...
  public boolean equals(Object o) {
    ...
    ConfirmForgotPasswordRequestUserContextData confirmForgotPasswordRequestUserContextData = (ConfirmForgotPasswordRequestUserContextData) o;
    return Objects.equals(this.ipAddress, confirmForgotPasswordRequestUserContextData.ipAddress) &&
        Objects.equals(this.encodedData, confirmForgotPasswordRequestUserContextData.encodedData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ipAddress, encodedData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConfirmForgotPasswordRequestUserContextData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfirmForgotPasswordRequestUserContextData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfirmForgotPasswordRequestUserContextData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfirmForgotPasswordRequestUserContextData is not found in the empty JSON string", ConfirmForgotPasswordRequestUserContextData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfirmForgotPasswordRequestUserContextData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfirmForgotPasswordRequestUserContextData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `EncodedData`
      if (jsonObj.get("EncodedData") != null && !jsonObj.get("EncodedData").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("EncodedData"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfirmForgotPasswordRequestUserContextData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfirmForgotPasswordRequestUserContextData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfirmForgotPasswordRequestUserContextData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfirmForgotPasswordRequestUserContextData.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfirmForgotPasswordRequestUserContextData>() {
           @Override
           public void write(JsonWriter out, ConfirmForgotPasswordRequestUserContextData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfirmForgotPasswordRequestUserContextData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfirmForgotPasswordRequestUserContextData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfirmForgotPasswordRequestUserContextData
   * @throws IOException if the JSON string is invalid with respect to ConfirmForgotPasswordRequestUserContextData
   */
  public static ConfirmForgotPasswordRequestUserContextData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfirmForgotPasswordRequestUserContextData.class);
  }

  /**
   * Convert an instance of ConfirmForgotPasswordRequestUserContextData to an JSON string
   *
   * @return JSON string
   */
