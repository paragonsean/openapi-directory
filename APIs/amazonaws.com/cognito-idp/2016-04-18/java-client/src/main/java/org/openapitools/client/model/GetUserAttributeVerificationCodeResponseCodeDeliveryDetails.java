...
public class GetUserAttributeVerificationCodeResponseCodeDeliveryDetails {
  ...
  public GetUserAttributeVerificationCodeResponseCodeDeliveryDetails() {
  }

  public GetUserAttributeVerificationCodeResponseCodeDeliveryDetails destination(String destination) {
  ...
  public GetUserAttributeVerificationCodeResponseCodeDeliveryDetails deliveryMedium(DeliveryMediumType deliveryMedium) {
  ...
  public GetUserAttributeVerificationCodeResponseCodeDeliveryDetails attributeName(String attributeName) {
  ...
  public boolean equals(Object o) {
    ...
    GetUserAttributeVerificationCodeResponseCodeDeliveryDetails getUserAttributeVerificationCodeResponseCodeDeliveryDetails = (GetUserAttributeVerificationCodeResponseCodeDeliveryDetails) o;
    return Objects.equals(this.destination, getUserAttributeVerificationCodeResponseCodeDeliveryDetails.destination) &&
        Objects.equals(this.deliveryMedium, getUserAttributeVerificationCodeResponseCodeDeliveryDetails.deliveryMedium) &&
        Objects.equals(this.attributeName, getUserAttributeVerificationCodeResponseCodeDeliveryDetails.attributeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetUserAttributeVerificationCodeResponseCodeDeliveryDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUserAttributeVerificationCodeResponseCodeDeliveryDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUserAttributeVerificationCodeResponseCodeDeliveryDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUserAttributeVerificationCodeResponseCodeDeliveryDetails is not found in the empty JSON string", GetUserAttributeVerificationCodeResponseCodeDeliveryDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUserAttributeVerificationCodeResponseCodeDeliveryDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUserAttributeVerificationCodeResponseCodeDeliveryDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUserAttributeVerificationCodeResponseCodeDeliveryDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUserAttributeVerificationCodeResponseCodeDeliveryDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUserAttributeVerificationCodeResponseCodeDeliveryDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUserAttributeVerificationCodeResponseCodeDeliveryDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUserAttributeVerificationCodeResponseCodeDeliveryDetails>() {
           @Override
           public void write(JsonWriter out, GetUserAttributeVerificationCodeResponseCodeDeliveryDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUserAttributeVerificationCodeResponseCodeDeliveryDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUserAttributeVerificationCodeResponseCodeDeliveryDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUserAttributeVerificationCodeResponseCodeDeliveryDetails
   * @throws IOException if the JSON string is invalid with respect to GetUserAttributeVerificationCodeResponseCodeDeliveryDetails
   */
  public static GetUserAttributeVerificationCodeResponseCodeDeliveryDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUserAttributeVerificationCodeResponseCodeDeliveryDetails.class);
  }

  /**
   * Convert an instance of GetUserAttributeVerificationCodeResponseCodeDeliveryDetails to an JSON string
   *
   * @return JSON string
   */
