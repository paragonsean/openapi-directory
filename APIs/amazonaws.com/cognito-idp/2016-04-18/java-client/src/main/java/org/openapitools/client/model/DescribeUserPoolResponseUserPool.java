...
public class DescribeUserPoolResponseUserPool {
  ...
  public DescribeUserPoolResponseUserPool() {
  }

  public DescribeUserPoolResponseUserPool id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DescribeUserPoolResponseUserPool name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DescribeUserPoolResponseUserPool policies(UserPoolTypePolicies policies) {
  ...
  public DescribeUserPoolResponseUserPool deletionProtection(DeletionProtectionType deletionProtection) {
  ...
  public DescribeUserPoolResponseUserPool lambdaConfig(UserPoolTypeLambdaConfig lambdaConfig) {
  ...
  public DescribeUserPoolResponseUserPool status(StatusType status) {
    this.status = status;
    return this;
  }
  ...
  public DescribeUserPoolResponseUserPool lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public DescribeUserPoolResponseUserPool creationDate(OffsetDateTime creationDate) {
  ...
  public DescribeUserPoolResponseUserPool schemaAttributes(List schemaAttributes) {
  ...
  public DescribeUserPoolResponseUserPool autoVerifiedAttributes(List autoVerifiedAttributes) {
  ...
  public DescribeUserPoolResponseUserPool aliasAttributes(List aliasAttributes) {
  ...
  public DescribeUserPoolResponseUserPool usernameAttributes(List usernameAttributes) {
  ...
  public DescribeUserPoolResponseUserPool smsVerificationMessage(String smsVerificationMessage) {
  ...
  public DescribeUserPoolResponseUserPool emailVerificationMessage(String emailVerificationMessage) {
  ...
  public DescribeUserPoolResponseUserPool emailVerificationSubject(String emailVerificationSubject) {
  ...
  public DescribeUserPoolResponseUserPool verificationMessageTemplate(UpdateUserPoolRequestVerificationMessageTemplate verificationMessageTemplate) {
  ...
  public DescribeUserPoolResponseUserPool smsAuthenticationMessage(String smsAuthenticationMessage) {
  ...
  public DescribeUserPoolResponseUserPool userAttributeUpdateSettings(CreateUserPoolRequestUserAttributeUpdateSettings userAttributeUpdateSettings) {
  ...
  public DescribeUserPoolResponseUserPool mfaConfiguration(UserPoolMfaType mfaConfiguration) {
  ...
  public DescribeUserPoolResponseUserPool deviceConfiguration(CreateUserPoolRequestDeviceConfiguration deviceConfiguration) {
  ...
  public DescribeUserPoolResponseUserPool estimatedNumberOfUsers(Integer estimatedNumberOfUsers) {
  ...
  public DescribeUserPoolResponseUserPool emailConfiguration(CreateUserPoolRequestEmailConfiguration emailConfiguration) {
  ...
  public DescribeUserPoolResponseUserPool smsConfiguration(CreateUserPoolRequestSmsConfiguration smsConfiguration) {
  ...
  public DescribeUserPoolResponseUserPool userPoolTags(Map userPoolTags) {
  ...
  public DescribeUserPoolResponseUserPool smsConfigurationFailure(String smsConfigurationFailure) {
  ...
  public DescribeUserPoolResponseUserPool emailConfigurationFailure(String emailConfigurationFailure) {
  ...
  public DescribeUserPoolResponseUserPool domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public DescribeUserPoolResponseUserPool customDomain(String customDomain) {
  ...
  public DescribeUserPoolResponseUserPool adminCreateUserConfig(CreateUserPoolRequestAdminCreateUserConfig adminCreateUserConfig) {
  ...
  public DescribeUserPoolResponseUserPool userPoolAddOns(CreateUserPoolRequestUserPoolAddOns userPoolAddOns) {
  ...
  public DescribeUserPoolResponseUserPool usernameConfiguration(UserPoolTypeUsernameConfiguration usernameConfiguration) {
  ...
  public DescribeUserPoolResponseUserPool arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DescribeUserPoolResponseUserPool accountRecoverySetting(CreateUserPoolRequestAccountRecoverySetting accountRecoverySetting) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeUserPoolResponseUserPool describeUserPoolResponseUserPool = (DescribeUserPoolResponseUserPool) o;
    return Objects.equals(this.id, describeUserPoolResponseUserPool.id) &&
        Objects.equals(this.name, describeUserPoolResponseUserPool.name) &&
        Objects.equals(this.policies, describeUserPoolResponseUserPool.policies) &&
        Objects.equals(this.deletionProtection, describeUserPoolResponseUserPool.deletionProtection) &&
        Objects.equals(this.lambdaConfig, describeUserPoolResponseUserPool.lambdaConfig) &&
        Objects.equals(this.status, describeUserPoolResponseUserPool.status) &&
        Objects.equals(this.lastModifiedDate, describeUserPoolResponseUserPool.lastModifiedDate) &&
        Objects.equals(this.creationDate, describeUserPoolResponseUserPool.creationDate) &&
        Objects.equals(this.schemaAttributes, describeUserPoolResponseUserPool.schemaAttributes) &&
        Objects.equals(this.autoVerifiedAttributes, describeUserPoolResponseUserPool.autoVerifiedAttributes) &&
        Objects.equals(this.aliasAttributes, describeUserPoolResponseUserPool.aliasAttributes) &&
        Objects.equals(this.usernameAttributes, describeUserPoolResponseUserPool.usernameAttributes) &&
        Objects.equals(this.smsVerificationMessage, describeUserPoolResponseUserPool.smsVerificationMessage) &&
        Objects.equals(this.emailVerificationMessage, describeUserPoolResponseUserPool.emailVerificationMessage) &&
        Objects.equals(this.emailVerificationSubject, describeUserPoolResponseUserPool.emailVerificationSubject) &&
        Objects.equals(this.verificationMessageTemplate, describeUserPoolResponseUserPool.verificationMessageTemplate) &&
        Objects.equals(this.smsAuthenticationMessage, describeUserPoolResponseUserPool.smsAuthenticationMessage) &&
        Objects.equals(this.userAttributeUpdateSettings, describeUserPoolResponseUserPool.userAttributeUpdateSettings) &&
        Objects.equals(this.mfaConfiguration, describeUserPoolResponseUserPool.mfaConfiguration) &&
        Objects.equals(this.deviceConfiguration, describeUserPoolResponseUserPool.deviceConfiguration) &&
        Objects.equals(this.estimatedNumberOfUsers, describeUserPoolResponseUserPool.estimatedNumberOfUsers) &&
        Objects.equals(this.emailConfiguration, describeUserPoolResponseUserPool.emailConfiguration) &&
        Objects.equals(this.smsConfiguration, describeUserPoolResponseUserPool.smsConfiguration) &&
        Objects.equals(this.userPoolTags, describeUserPoolResponseUserPool.userPoolTags) &&
        Objects.equals(this.smsConfigurationFailure, describeUserPoolResponseUserPool.smsConfigurationFailure) &&
        Objects.equals(this.emailConfigurationFailure, describeUserPoolResponseUserPool.emailConfigurationFailure) &&
        Objects.equals(this.domain, describeUserPoolResponseUserPool.domain) &&
        Objects.equals(this.customDomain, describeUserPoolResponseUserPool.customDomain) &&
        Objects.equals(this.adminCreateUserConfig, describeUserPoolResponseUserPool.adminCreateUserConfig) &&
        Objects.equals(this.userPoolAddOns, describeUserPoolResponseUserPool.userPoolAddOns) &&
        Objects.equals(this.usernameConfiguration, describeUserPoolResponseUserPool.usernameConfiguration) &&
        Objects.equals(this.arn, describeUserPoolResponseUserPool.arn) &&
        Objects.equals(this.accountRecoverySetting, describeUserPoolResponseUserPool.accountRecoverySetting);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeUserPoolResponseUserPool {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUserPoolResponseUserPool
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUserPoolResponseUserPool.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUserPoolResponseUserPool is not found in the empty JSON string", DescribeUserPoolResponseUserPool.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUserPoolResponseUserPool.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUserPoolResponseUserPool` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUserPoolResponseUserPool.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUserPoolResponseUserPool' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUserPoolResponseUserPool> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUserPoolResponseUserPool.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUserPoolResponseUserPool>() {
           @Override
           public void write(JsonWriter out, DescribeUserPoolResponseUserPool value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUserPoolResponseUserPool read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUserPoolResponseUserPool given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUserPoolResponseUserPool
   * @throws IOException if the JSON string is invalid with respect to DescribeUserPoolResponseUserPool
   */
  public static DescribeUserPoolResponseUserPool fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUserPoolResponseUserPool.class);
  }

  /**
   * Convert an instance of DescribeUserPoolResponseUserPool to an JSON string
   *
   * @return JSON string
   */
