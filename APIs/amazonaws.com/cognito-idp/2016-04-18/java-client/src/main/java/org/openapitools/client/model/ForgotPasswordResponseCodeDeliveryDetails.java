...
public class ForgotPasswordResponseCodeDeliveryDetails {
  ...
  public ForgotPasswordResponseCodeDeliveryDetails() {
  }

  public ForgotPasswordResponseCodeDeliveryDetails destination(String destination) {
  ...
  public ForgotPasswordResponseCodeDeliveryDetails deliveryMedium(DeliveryMediumType deliveryMedium) {
  ...
  public ForgotPasswordResponseCodeDeliveryDetails attributeName(String attributeName) {
  ...
  public boolean equals(Object o) {
    ...
    ForgotPasswordResponseCodeDeliveryDetails forgotPasswordResponseCodeDeliveryDetails = (ForgotPasswordResponseCodeDeliveryDetails) o;
    return Objects.equals(this.destination, forgotPasswordResponseCodeDeliveryDetails.destination) &&
        Objects.equals(this.deliveryMedium, forgotPasswordResponseCodeDeliveryDetails.deliveryMedium) &&
        Objects.equals(this.attributeName, forgotPasswordResponseCodeDeliveryDetails.attributeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForgotPasswordResponseCodeDeliveryDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ForgotPasswordResponseCodeDeliveryDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForgotPasswordResponseCodeDeliveryDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ForgotPasswordResponseCodeDeliveryDetails is not found in the empty JSON string", ForgotPasswordResponseCodeDeliveryDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ForgotPasswordResponseCodeDeliveryDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ForgotPasswordResponseCodeDeliveryDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ForgotPasswordResponseCodeDeliveryDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ForgotPasswordResponseCodeDeliveryDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ForgotPasswordResponseCodeDeliveryDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ForgotPasswordResponseCodeDeliveryDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ForgotPasswordResponseCodeDeliveryDetails>() {
           @Override
           public void write(JsonWriter out, ForgotPasswordResponseCodeDeliveryDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ForgotPasswordResponseCodeDeliveryDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ForgotPasswordResponseCodeDeliveryDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ForgotPasswordResponseCodeDeliveryDetails
   * @throws IOException if the JSON string is invalid with respect to ForgotPasswordResponseCodeDeliveryDetails
   */
  public static ForgotPasswordResponseCodeDeliveryDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ForgotPasswordResponseCodeDeliveryDetails.class);
  }

  /**
   * Convert an instance of ForgotPasswordResponseCodeDeliveryDetails to an JSON string
   *
   * @return JSON string
   */
