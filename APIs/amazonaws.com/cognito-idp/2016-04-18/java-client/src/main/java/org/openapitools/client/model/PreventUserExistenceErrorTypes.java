...
/**
 * Gets or Sets PreventUserExistenceErrorTypes
 */
@JsonAdapter(PreventUserExistenceErrorTypes.Adapter.class)
public enum PreventUserExistenceErrorTypes {
  ...
  PreventUserExistenceErrorTypes(String value) {
    this.value = value;
  }
  ...
  public static PreventUserExistenceErrorTypes fromValue(String value) {
    for (PreventUserExistenceErrorTypes b : PreventUserExistenceErrorTypes.values()) {
  ...
  public static class Adapter extends TypeAdapter<PreventUserExistenceErrorTypes> {
    @Override
    public void write(final JsonWriter jsonWriter, final PreventUserExistenceErrorTypes enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PreventUserExistenceErrorTypes read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PreventUserExistenceErrorTypes.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PreventUserExistenceErrorTypes.fromValue(value);
  }
}
