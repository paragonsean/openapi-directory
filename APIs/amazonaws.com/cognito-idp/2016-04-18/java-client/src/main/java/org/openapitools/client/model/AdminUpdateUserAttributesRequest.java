...
public class AdminUpdateUserAttributesRequest {
  ...
  public AdminUpdateUserAttributesRequest userPoolId(String userPoolId) {
  ...
  public AdminUpdateUserAttributesRequest username(String username) {
  ...
  public AdminUpdateUserAttributesRequest userAttributes(List userAttributes) {
  ...
  public AdminUpdateUserAttributesRequest clientMetadata(Map clientMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    AdminUpdateUserAttributesRequest adminUpdateUserAttributesRequest = (AdminUpdateUserAttributesRequest) o;
    return Objects.equals(this.userPoolId, adminUpdateUserAttributesRequest.userPoolId) &&
        Objects.equals(this.username, adminUpdateUserAttributesRequest.username) &&
        Objects.equals(this.userAttributes, adminUpdateUserAttributesRequest.userAttributes) &&
        Objects.equals(this.clientMetadata, adminUpdateUserAttributesRequest.clientMetadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username, userAttributes, clientMetadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminUpdateUserAttributesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminUpdateUserAttributesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminUpdateUserAttributesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminUpdateUserAttributesRequest is not found in the empty JSON string", AdminUpdateUserAttributesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminUpdateUserAttributesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminUpdateUserAttributesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminUpdateUserAttributesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminUpdateUserAttributesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminUpdateUserAttributesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminUpdateUserAttributesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminUpdateUserAttributesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminUpdateUserAttributesRequest>() {
           @Override
           public void write(JsonWriter out, AdminUpdateUserAttributesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminUpdateUserAttributesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminUpdateUserAttributesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminUpdateUserAttributesRequest
   * @throws IOException if the JSON string is invalid with respect to AdminUpdateUserAttributesRequest
   */
  public static AdminUpdateUserAttributesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminUpdateUserAttributesRequest.class);
  }

  /**
   * Convert an instance of AdminUpdateUserAttributesRequest to an JSON string
   *
   * @return JSON string
   */
