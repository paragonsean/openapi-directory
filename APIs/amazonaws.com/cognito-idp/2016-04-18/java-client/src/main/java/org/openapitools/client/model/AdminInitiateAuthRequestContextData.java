...
public class AdminInitiateAuthRequestContextData {
  ...
  public static final String SERIALIZED_NAME_SERVER_PATH = "ServerPath";
  @SerializedName(SERIALIZED_NAME_SERVER_PATH)
  ...
  public AdminInitiateAuthRequestContextData() {
  }

  public AdminInitiateAuthRequestContextData ipAddress(String ipAddress) {
  ...
  public AdminInitiateAuthRequestContextData serverName(String serverName) {
  ...
  public AdminInitiateAuthRequestContextData serverPath(String serverPath) {
  ...
  public AdminInitiateAuthRequestContextData httpHeaders(List httpHeaders) {
  ...
  public AdminInitiateAuthRequestContextData encodedData(String encodedData) {
  ...
  public boolean equals(Object o) {
    ...
    AdminInitiateAuthRequestContextData adminInitiateAuthRequestContextData = (AdminInitiateAuthRequestContextData) o;
    return Objects.equals(this.ipAddress, adminInitiateAuthRequestContextData.ipAddress) &&
        Objects.equals(this.serverName, adminInitiateAuthRequestContextData.serverName) &&
        Objects.equals(this.serverPath, adminInitiateAuthRequestContextData.serverPath) &&
        Objects.equals(this.httpHeaders, adminInitiateAuthRequestContextData.httpHeaders) &&
        Objects.equals(this.encodedData, adminInitiateAuthRequestContextData.encodedData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ipAddress, serverName, serverPath, httpHeaders, encodedData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminInitiateAuthRequestContextData {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("ServerPath");
    openapiRequiredFields.add("HttpHeaders");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminInitiateAuthRequestContextData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminInitiateAuthRequestContextData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminInitiateAuthRequestContextData is not found in the empty JSON string", AdminInitiateAuthRequestContextData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminInitiateAuthRequestContextData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminInitiateAuthRequestContextData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminInitiateAuthRequestContextData.openapiRequiredFields) {
      ...
      // validate the required field `ServerPath`
      String.validateJsonElement(jsonObj.get("ServerPath"));
      // validate the required field `HttpHeaders`
      List.validateJsonElement(jsonObj.get("HttpHeaders"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminInitiateAuthRequestContextData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminInitiateAuthRequestContextData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminInitiateAuthRequestContextData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminInitiateAuthRequestContextData.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminInitiateAuthRequestContextData>() {
           @Override
           public void write(JsonWriter out, AdminInitiateAuthRequestContextData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminInitiateAuthRequestContextData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminInitiateAuthRequestContextData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminInitiateAuthRequestContextData
   * @throws IOException if the JSON string is invalid with respect to AdminInitiateAuthRequestContextData
   */
  public static AdminInitiateAuthRequestContextData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminInitiateAuthRequestContextData.class);
  }

  /**
   * Convert an instance of AdminInitiateAuthRequestContextData to an JSON string
   *
   * @return JSON string
   */
