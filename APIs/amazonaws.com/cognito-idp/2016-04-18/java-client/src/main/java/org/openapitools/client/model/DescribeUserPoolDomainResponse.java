...
public class DescribeUserPoolDomainResponse {
  public static final String SERIALIZED_NAME_DOMAIN_DESCRIPTION = "DomainDescription";
  @SerializedName(SERIALIZED_NAME_DOMAIN_DESCRIPTION)
  private DescribeUserPoolDomainResponseDomainDescription domainDescription;

  public DescribeUserPoolDomainResponse() {
  }

  public DescribeUserPoolDomainResponse domainDescription(DescribeUserPoolDomainResponseDomainDescription domainDescription) {
  ...
  public DescribeUserPoolDomainResponseDomainDescription getDomainDescription() {
    return domainDescription;
  }

  public void setDomainDescription(DescribeUserPoolDomainResponseDomainDescription domainDescription) {
    this.domainDescription = domainDescription;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeUserPoolDomainResponse describeUserPoolDomainResponse = (DescribeUserPoolDomainResponse) o;
    return Objects.equals(this.domainDescription, describeUserPoolDomainResponse.domainDescription);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domainDescription);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeUserPoolDomainResponse {\n");
    sb.append("    domainDescription: ").append(toIndentedString(domainDescription)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("DomainDescription");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUserPoolDomainResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUserPoolDomainResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUserPoolDomainResponse is not found in the empty JSON string", DescribeUserPoolDomainResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUserPoolDomainResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUserPoolDomainResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `DomainDescription`
      if (jsonObj.get("DomainDescription") != null && !jsonObj.get("DomainDescription").isJsonNull()) {
        DescribeUserPoolDomainResponseDomainDescription.validateJsonElement(jsonObj.get("DomainDescription"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUserPoolDomainResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUserPoolDomainResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUserPoolDomainResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUserPoolDomainResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUserPoolDomainResponse>() {
           @Override
           public void write(JsonWriter out, DescribeUserPoolDomainResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUserPoolDomainResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUserPoolDomainResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUserPoolDomainResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeUserPoolDomainResponse
   */
  public static DescribeUserPoolDomainResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUserPoolDomainResponse.class);
  }

  /**
   * Convert an instance of DescribeUserPoolDomainResponse to an JSON string
   *
   * @return JSON string
   */
