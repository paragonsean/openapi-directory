...
public class CodeDeliveryDetailsType {
  ...
  public CodeDeliveryDetailsType destination(String destination) {
  ...
  public CodeDeliveryDetailsType deliveryMedium(DeliveryMediumType deliveryMedium) {
  ...
  public CodeDeliveryDetailsType attributeName(String attributeName) {
  ...
  public boolean equals(Object o) {
    ...
    CodeDeliveryDetailsType codeDeliveryDetailsType = (CodeDeliveryDetailsType) o;
    return Objects.equals(this.destination, codeDeliveryDetailsType.destination) &&
        Objects.equals(this.deliveryMedium, codeDeliveryDetailsType.deliveryMedium) &&
        Objects.equals(this.attributeName, codeDeliveryDetailsType.attributeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CodeDeliveryDetailsType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CodeDeliveryDetailsType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CodeDeliveryDetailsType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodeDeliveryDetailsType is not found in the empty JSON string", CodeDeliveryDetailsType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CodeDeliveryDetailsType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodeDeliveryDetailsType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodeDeliveryDetailsType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodeDeliveryDetailsType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CodeDeliveryDetailsType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CodeDeliveryDetailsType.class));

       return (TypeAdapter<T>) new TypeAdapter<CodeDeliveryDetailsType>() {
           @Override
           public void write(JsonWriter out, CodeDeliveryDetailsType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CodeDeliveryDetailsType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CodeDeliveryDetailsType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CodeDeliveryDetailsType
   * @throws IOException if the JSON string is invalid with respect to CodeDeliveryDetailsType
   */
  public static CodeDeliveryDetailsType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CodeDeliveryDetailsType.class);
  }

  /**
   * Convert an instance of CodeDeliveryDetailsType to an JSON string
   *
   * @return JSON string
   */
