 ...
 */
@JsonAdapter(EventSourceName.Adapter.class)
public enum EventSourceName {
  ...
  public static EventSourceName fromValue(String value) {
    for (EventSourceName b : EventSourceName.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventSourceName> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventSourceName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventSourceName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventSourceName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EventSourceName.fromValue(value);
  }
}
