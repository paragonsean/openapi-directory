...
/**
 * Gets or Sets DeliveryMediumType
 */
@JsonAdapter(DeliveryMediumType.Adapter.class)
public enum DeliveryMediumType {
  ...
  DeliveryMediumType(String value) {
    this.value = value;
  }
  ...
  public static DeliveryMediumType fromValue(String value) {
    for (DeliveryMediumType b : DeliveryMediumType.values()) {
  ...
  public static class Adapter extends TypeAdapter<DeliveryMediumType> {
    @Override
    public void write(final JsonWriter jsonWriter, final DeliveryMediumType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DeliveryMediumType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DeliveryMediumType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DeliveryMediumType.fromValue(value);
  }
}
