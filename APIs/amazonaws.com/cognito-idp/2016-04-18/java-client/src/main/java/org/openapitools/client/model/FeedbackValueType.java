...
/**
 * Gets or Sets FeedbackValueType
 */
@JsonAdapter(FeedbackValueType.Adapter.class)
public enum FeedbackValueType {
  ...
  FeedbackValueType(String value) {
    this.value = value;
  }
  ...
  public static FeedbackValueType fromValue(String value) {
    for (FeedbackValueType b : FeedbackValueType.values()) {
  ...
  public static class Adapter extends TypeAdapter<FeedbackValueType> {
    @Override
    public void write(final JsonWriter jsonWriter, final FeedbackValueType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FeedbackValueType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FeedbackValueType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FeedbackValueType.fromValue(value);
  }
}
