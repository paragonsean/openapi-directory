...
public class DeleteResourceServerRequest {
  ...
  public DeleteResourceServerRequest() {
  }

  public DeleteResourceServerRequest userPoolId(String userPoolId) {
  ...
  public DeleteResourceServerRequest identifier(String identifier) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteResourceServerRequest deleteResourceServerRequest = (DeleteResourceServerRequest) o;
    return Objects.equals(this.userPoolId, deleteResourceServerRequest.userPoolId) &&
        Objects.equals(this.identifier, deleteResourceServerRequest.identifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteResourceServerRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteResourceServerRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteResourceServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteResourceServerRequest is not found in the empty JSON string", DeleteResourceServerRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteResourceServerRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteResourceServerRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteResourceServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteResourceServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteResourceServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteResourceServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteResourceServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteResourceServerRequest>() {
           @Override
           public void write(JsonWriter out, DeleteResourceServerRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteResourceServerRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteResourceServerRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteResourceServerRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteResourceServerRequest
   */
  public static DeleteResourceServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteResourceServerRequest.class);
  }

  /**
   * Convert an instance of DeleteResourceServerRequest to an JSON string
   *
   * @return JSON string
   */
