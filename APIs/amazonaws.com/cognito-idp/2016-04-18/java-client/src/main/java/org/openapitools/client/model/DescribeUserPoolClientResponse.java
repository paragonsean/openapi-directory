...
import org.openapitools.client.model.DescribeUserPoolClientResponseUserPoolClient;
...
public class DescribeUserPoolClientResponse {
  public static final String SERIALIZED_NAME_USER_POOL_CLIENT = "UserPoolClient";
  @SerializedName(SERIALIZED_NAME_USER_POOL_CLIENT)
  private DescribeUserPoolClientResponseUserPoolClient userPoolClient;

  public DescribeUserPoolClientResponse() {
  }

  public DescribeUserPoolClientResponse userPoolClient(DescribeUserPoolClientResponseUserPoolClient userPoolClient) {
  ...
  public DescribeUserPoolClientResponseUserPoolClient getUserPoolClient() {
    return userPoolClient;
  }

  public void setUserPoolClient(DescribeUserPoolClientResponseUserPoolClient userPoolClient) {
    this.userPoolClient = userPoolClient;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeUserPoolClientResponse describeUserPoolClientResponse = (DescribeUserPoolClientResponse) o;
    return Objects.equals(this.userPoolClient, describeUserPoolClientResponse.userPoolClient);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolClient);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeUserPoolClientResponse {\n");
    sb.append("    userPoolClient: ").append(toIndentedString(userPoolClient)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("UserPoolClient");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUserPoolClientResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUserPoolClientResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUserPoolClientResponse is not found in the empty JSON string", DescribeUserPoolClientResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUserPoolClientResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUserPoolClientResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `UserPoolClient`
      if (jsonObj.get("UserPoolClient") != null && !jsonObj.get("UserPoolClient").isJsonNull()) {
        DescribeUserPoolClientResponseUserPoolClient.validateJsonElement(jsonObj.get("UserPoolClient"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUserPoolClientResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUserPoolClientResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUserPoolClientResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUserPoolClientResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUserPoolClientResponse>() {
           @Override
           public void write(JsonWriter out, DescribeUserPoolClientResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUserPoolClientResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUserPoolClientResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUserPoolClientResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeUserPoolClientResponse
   */
  public static DescribeUserPoolClientResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUserPoolClientResponse.class);
  }

  /**
   * Convert an instance of DescribeUserPoolClientResponse to an JSON string
   *
   * @return JSON string
   */
