...
public class ResendConfirmationCodeRequestAnalyticsMetadata {
  ...
  public ResendConfirmationCodeRequestAnalyticsMetadata() {
  }

  public ResendConfirmationCodeRequestAnalyticsMetadata analyticsEndpointId(String analyticsEndpointId) {
  ...
  public boolean equals(Object o) {
    ...
    ResendConfirmationCodeRequestAnalyticsMetadata resendConfirmationCodeRequestAnalyticsMetadata = (ResendConfirmationCodeRequestAnalyticsMetadata) o;
    return Objects.equals(this.analyticsEndpointId, resendConfirmationCodeRequestAnalyticsMetadata.analyticsEndpointId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResendConfirmationCodeRequestAnalyticsMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResendConfirmationCodeRequestAnalyticsMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResendConfirmationCodeRequestAnalyticsMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResendConfirmationCodeRequestAnalyticsMetadata is not found in the empty JSON string", ResendConfirmationCodeRequestAnalyticsMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResendConfirmationCodeRequestAnalyticsMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResendConfirmationCodeRequestAnalyticsMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResendConfirmationCodeRequestAnalyticsMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResendConfirmationCodeRequestAnalyticsMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResendConfirmationCodeRequestAnalyticsMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResendConfirmationCodeRequestAnalyticsMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ResendConfirmationCodeRequestAnalyticsMetadata>() {
           @Override
           public void write(JsonWriter out, ResendConfirmationCodeRequestAnalyticsMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResendConfirmationCodeRequestAnalyticsMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResendConfirmationCodeRequestAnalyticsMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResendConfirmationCodeRequestAnalyticsMetadata
   * @throws IOException if the JSON string is invalid with respect to ResendConfirmationCodeRequestAnalyticsMetadata
   */
  public static ResendConfirmationCodeRequestAnalyticsMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResendConfirmationCodeRequestAnalyticsMetadata.class);
  }

  /**
   * Convert an instance of ResendConfirmationCodeRequestAnalyticsMetadata to an JSON string
   *
   * @return JSON string
   */
