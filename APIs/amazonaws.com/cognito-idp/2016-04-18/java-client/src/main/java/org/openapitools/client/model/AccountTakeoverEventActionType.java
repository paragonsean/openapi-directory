...
/**
 * Gets or Sets AccountTakeoverEventActionType
 */
@JsonAdapter(AccountTakeoverEventActionType.Adapter.class)
public enum AccountTakeoverEventActionType {
  ...
  AccountTakeoverEventActionType(String value) {
    this.value = value;
  }
  ...
  public static AccountTakeoverEventActionType fromValue(String value) {
    for (AccountTakeoverEventActionType b : AccountTakeoverEventActionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AccountTakeoverEventActionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountTakeoverEventActionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountTakeoverEventActionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountTakeoverEventActionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AccountTakeoverEventActionType.fromValue(value);
  }
}
