...
public class CreateUserPoolRequestUsernameConfiguration {
  ...
  public CreateUserPoolRequestUsernameConfiguration() {
  }

  public CreateUserPoolRequestUsernameConfiguration caseSensitive(Boolean caseSensitive) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUserPoolRequestUsernameConfiguration createUserPoolRequestUsernameConfiguration = (CreateUserPoolRequestUsernameConfiguration) o;
    return Objects.equals(this.caseSensitive, createUserPoolRequestUsernameConfiguration.caseSensitive);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUserPoolRequestUsernameConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolRequestUsernameConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolRequestUsernameConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolRequestUsernameConfiguration is not found in the empty JSON string", CreateUserPoolRequestUsernameConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolRequestUsernameConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolRequestUsernameConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateUserPoolRequestUsernameConfiguration.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `CaseSensitive`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolRequestUsernameConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolRequestUsernameConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolRequestUsernameConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolRequestUsernameConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolRequestUsernameConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolRequestUsernameConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolRequestUsernameConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolRequestUsernameConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolRequestUsernameConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolRequestUsernameConfiguration
   */
  public static CreateUserPoolRequestUsernameConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolRequestUsernameConfiguration.class);
  }

  /**
   * Convert an instance of CreateUserPoolRequestUsernameConfiguration to an JSON string
   *
   * @return JSON string
   */
