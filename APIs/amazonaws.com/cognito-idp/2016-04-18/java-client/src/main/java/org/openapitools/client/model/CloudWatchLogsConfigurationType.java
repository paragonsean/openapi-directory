...
public class CloudWatchLogsConfigurationType {
  ...
  public CloudWatchLogsConfigurationType() {
  }

  public CloudWatchLogsConfigurationType logGroupArn(String logGroupArn) {
  ...
  public boolean equals(Object o) {
    ...
    CloudWatchLogsConfigurationType cloudWatchLogsConfigurationType = (CloudWatchLogsConfigurationType) o;
    return Objects.equals(this.logGroupArn, cloudWatchLogsConfigurationType.logGroupArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudWatchLogsConfigurationType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudWatchLogsConfigurationType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudWatchLogsConfigurationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudWatchLogsConfigurationType is not found in the empty JSON string", CloudWatchLogsConfigurationType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudWatchLogsConfigurationType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudWatchLogsConfigurationType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudWatchLogsConfigurationType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudWatchLogsConfigurationType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudWatchLogsConfigurationType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudWatchLogsConfigurationType.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudWatchLogsConfigurationType>() {
           @Override
           public void write(JsonWriter out, CloudWatchLogsConfigurationType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudWatchLogsConfigurationType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudWatchLogsConfigurationType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudWatchLogsConfigurationType
   * @throws IOException if the JSON string is invalid with respect to CloudWatchLogsConfigurationType
   */
  public static CloudWatchLogsConfigurationType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudWatchLogsConfigurationType.class);
  }

  /**
   * Convert an instance of CloudWatchLogsConfigurationType to an JSON string
   *
   * @return JSON string
   */
