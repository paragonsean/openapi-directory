...
public class CreateUserPoolClientResponseUserPoolClient {
  ...
  public CreateUserPoolClientResponseUserPoolClient() {
  }

  public CreateUserPoolClientResponseUserPoolClient userPoolId(String userPoolId) {
  ...
  public CreateUserPoolClientResponseUserPoolClient clientName(String clientName) {
  ...
  public CreateUserPoolClientResponseUserPoolClient clientId(String clientId) {
  ...
  public CreateUserPoolClientResponseUserPoolClient clientSecret(String clientSecret) {
  ...
  public CreateUserPoolClientResponseUserPoolClient lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public CreateUserPoolClientResponseUserPoolClient creationDate(OffsetDateTime creationDate) {
  ...
  public CreateUserPoolClientResponseUserPoolClient refreshTokenValidity(Integer refreshTokenValidity) {
  ...
  public CreateUserPoolClientResponseUserPoolClient accessTokenValidity(Integer accessTokenValidity) {
  ...
  public CreateUserPoolClientResponseUserPoolClient idTokenValidity(Integer idTokenValidity) {
  ...
  public CreateUserPoolClientResponseUserPoolClient tokenValidityUnits(UserPoolClientTypeTokenValidityUnits tokenValidityUnits) {
  ...
  public CreateUserPoolClientResponseUserPoolClient readAttributes(List readAttributes) {
  ...
  public CreateUserPoolClientResponseUserPoolClient writeAttributes(List writeAttributes) {
  ...
  public CreateUserPoolClientResponseUserPoolClient explicitAuthFlows(List explicitAuthFlows) {
  ...
  public CreateUserPoolClientResponseUserPoolClient supportedIdentityProviders(List supportedIdentityProviders) {
  ...
  public CreateUserPoolClientResponseUserPoolClient callbackURLs(List callbackURLs) {
  ...
  public CreateUserPoolClientResponseUserPoolClient logoutURLs(List logoutURLs) {
  ...
  public CreateUserPoolClientResponseUserPoolClient defaultRedirectURI(String defaultRedirectURI) {
  ...
  public CreateUserPoolClientResponseUserPoolClient allowedOAuthFlows(List allowedOAuthFlows) {
  ...
  public CreateUserPoolClientResponseUserPoolClient allowedOAuthScopes(List allowedOAuthScopes) {
  ...
  public CreateUserPoolClientResponseUserPoolClient allowedOAuthFlowsUserPoolClient(Boolean allowedOAuthFlowsUserPoolClient) {
  ...
  public CreateUserPoolClientResponseUserPoolClient analyticsConfiguration(UserPoolClientTypeAnalyticsConfiguration analyticsConfiguration) {
  ...
  public CreateUserPoolClientResponseUserPoolClient preventUserExistenceErrors(PreventUserExistenceErrorTypes preventUserExistenceErrors) {
  ...
  public CreateUserPoolClientResponseUserPoolClient enableTokenRevocation(Boolean enableTokenRevocation) {
  ...
  public CreateUserPoolClientResponseUserPoolClient enablePropagateAdditionalUserContextData(Boolean enablePropagateAdditionalUserContextData) {
  ...
  public CreateUserPoolClientResponseUserPoolClient authSessionValidity(Integer authSessionValidity) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUserPoolClientResponseUserPoolClient createUserPoolClientResponseUserPoolClient = (CreateUserPoolClientResponseUserPoolClient) o;
    return Objects.equals(this.userPoolId, createUserPoolClientResponseUserPoolClient.userPoolId) &&
        Objects.equals(this.clientName, createUserPoolClientResponseUserPoolClient.clientName) &&
        Objects.equals(this.clientId, createUserPoolClientResponseUserPoolClient.clientId) &&
        Objects.equals(this.clientSecret, createUserPoolClientResponseUserPoolClient.clientSecret) &&
        Objects.equals(this.lastModifiedDate, createUserPoolClientResponseUserPoolClient.lastModifiedDate) &&
        Objects.equals(this.creationDate, createUserPoolClientResponseUserPoolClient.creationDate) &&
        Objects.equals(this.refreshTokenValidity, createUserPoolClientResponseUserPoolClient.refreshTokenValidity) &&
        Objects.equals(this.accessTokenValidity, createUserPoolClientResponseUserPoolClient.accessTokenValidity) &&
        Objects.equals(this.idTokenValidity, createUserPoolClientResponseUserPoolClient.idTokenValidity) &&
        Objects.equals(this.tokenValidityUnits, createUserPoolClientResponseUserPoolClient.tokenValidityUnits) &&
        Objects.equals(this.readAttributes, createUserPoolClientResponseUserPoolClient.readAttributes) &&
        Objects.equals(this.writeAttributes, createUserPoolClientResponseUserPoolClient.writeAttributes) &&
        Objects.equals(this.explicitAuthFlows, createUserPoolClientResponseUserPoolClient.explicitAuthFlows) &&
        Objects.equals(this.supportedIdentityProviders, createUserPoolClientResponseUserPoolClient.supportedIdentityProviders) &&
        Objects.equals(this.callbackURLs, createUserPoolClientResponseUserPoolClient.callbackURLs) &&
        Objects.equals(this.logoutURLs, createUserPoolClientResponseUserPoolClient.logoutURLs) &&
        Objects.equals(this.defaultRedirectURI, createUserPoolClientResponseUserPoolClient.defaultRedirectURI) &&
        Objects.equals(this.allowedOAuthFlows, createUserPoolClientResponseUserPoolClient.allowedOAuthFlows) &&
        Objects.equals(this.allowedOAuthScopes, createUserPoolClientResponseUserPoolClient.allowedOAuthScopes) &&
        Objects.equals(this.allowedOAuthFlowsUserPoolClient, createUserPoolClientResponseUserPoolClient.allowedOAuthFlowsUserPoolClient) &&
        Objects.equals(this.analyticsConfiguration, createUserPoolClientResponseUserPoolClient.analyticsConfiguration) &&
        Objects.equals(this.preventUserExistenceErrors, createUserPoolClientResponseUserPoolClient.preventUserExistenceErrors) &&
        Objects.equals(this.enableTokenRevocation, createUserPoolClientResponseUserPoolClient.enableTokenRevocation) &&
        Objects.equals(this.enablePropagateAdditionalUserContextData, createUserPoolClientResponseUserPoolClient.enablePropagateAdditionalUserContextData) &&
        Objects.equals(this.authSessionValidity, createUserPoolClientResponseUserPoolClient.authSessionValidity);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUserPoolClientResponseUserPoolClient {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolClientResponseUserPoolClient
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolClientResponseUserPoolClient.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolClientResponseUserPoolClient is not found in the empty JSON string", CreateUserPoolClientResponseUserPoolClient.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolClientResponseUserPoolClient.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolClientResponseUserPoolClient` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolClientResponseUserPoolClient.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolClientResponseUserPoolClient' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolClientResponseUserPoolClient> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolClientResponseUserPoolClient.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolClientResponseUserPoolClient>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolClientResponseUserPoolClient value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolClientResponseUserPoolClient read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolClientResponseUserPoolClient given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolClientResponseUserPoolClient
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolClientResponseUserPoolClient
   */
  public static CreateUserPoolClientResponseUserPoolClient fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolClientResponseUserPoolClient.class);
  }

  /**
   * Convert an instance of CreateUserPoolClientResponseUserPoolClient to an JSON string
   *
   * @return JSON string
   */
