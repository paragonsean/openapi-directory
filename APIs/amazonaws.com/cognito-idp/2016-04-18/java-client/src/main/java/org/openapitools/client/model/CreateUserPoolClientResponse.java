...
import org.openapitools.client.model.CreateUserPoolClientResponseUserPoolClient;
...
public class CreateUserPoolClientResponse {
  ...
  private CreateUserPoolClientResponseUserPoolClient userPoolClient;

  public CreateUserPoolClientResponse() {
  }

  public CreateUserPoolClientResponse userPoolClient(CreateUserPoolClientResponseUserPoolClient userPoolClient) {
  ...
  public CreateUserPoolClientResponseUserPoolClient getUserPoolClient() {
    return userPoolClient;
  }

  public void setUserPoolClient(CreateUserPoolClientResponseUserPoolClient userPoolClient) {
    this.userPoolClient = userPoolClient;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolClient, createUserPoolClientResponse.userPoolClient);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolClientResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolClientResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolClientResponse is not found in the empty JSON string", CreateUserPoolClientResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolClientResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolClientResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("UserPoolClient") != null && !jsonObj.get("UserPoolClient").isJsonNull()) {
        CreateUserPoolClientResponseUserPoolClient.validateJsonElement(jsonObj.get("UserPoolClient"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolClientResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolClientResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolClientResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolClientResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolClientResponse>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolClientResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolClientResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolClientResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolClientResponse
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolClientResponse
   */
  public static CreateUserPoolClientResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolClientResponse.class);
  }

  /**
   * Convert an instance of CreateUserPoolClientResponse to an JSON string
   *
   * @return JSON string
   */
