...
public class AuthEventTypeEventContextData {
  ...
  public AuthEventTypeEventContextData() {
  }

  public AuthEventTypeEventContextData ipAddress(String ipAddress) {
  ...
  public AuthEventTypeEventContextData deviceName(String deviceName) {
  ...
  public AuthEventTypeEventContextData timezone(String timezone) {
  ...
  public AuthEventTypeEventContextData city(String city) {
    this.city = city;
    return this;
  }
  ...
  public AuthEventTypeEventContextData country(String country) {
  ...
  public boolean equals(Object o) {
    ...
    AuthEventTypeEventContextData authEventTypeEventContextData = (AuthEventTypeEventContextData) o;
    return Objects.equals(this.ipAddress, authEventTypeEventContextData.ipAddress) &&
        Objects.equals(this.deviceName, authEventTypeEventContextData.deviceName) &&
        Objects.equals(this.timezone, authEventTypeEventContextData.timezone) &&
        Objects.equals(this.city, authEventTypeEventContextData.city) &&
        Objects.equals(this.country, authEventTypeEventContextData.country);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthEventTypeEventContextData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthEventTypeEventContextData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthEventTypeEventContextData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthEventTypeEventContextData is not found in the empty JSON string", AuthEventTypeEventContextData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthEventTypeEventContextData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthEventTypeEventContextData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthEventTypeEventContextData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthEventTypeEventContextData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthEventTypeEventContextData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthEventTypeEventContextData.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthEventTypeEventContextData>() {
           @Override
           public void write(JsonWriter out, AuthEventTypeEventContextData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthEventTypeEventContextData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthEventTypeEventContextData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthEventTypeEventContextData
   * @throws IOException if the JSON string is invalid with respect to AuthEventTypeEventContextData
   */
  public static AuthEventTypeEventContextData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthEventTypeEventContextData.class);
  }

  /**
   * Convert an instance of AuthEventTypeEventContextData to an JSON string
   *
   * @return JSON string
   */
