...
public class GetLogDeliveryConfigurationRequest {
  ...
  public GetLogDeliveryConfigurationRequest() {
  }

  public GetLogDeliveryConfigurationRequest userPoolId(String userPoolId) {
  ...
  public boolean equals(Object o) {
    ...
    GetLogDeliveryConfigurationRequest getLogDeliveryConfigurationRequest = (GetLogDeliveryConfigurationRequest) o;
    return Objects.equals(this.userPoolId, getLogDeliveryConfigurationRequest.userPoolId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetLogDeliveryConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLogDeliveryConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLogDeliveryConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLogDeliveryConfigurationRequest is not found in the empty JSON string", GetLogDeliveryConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLogDeliveryConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLogDeliveryConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetLogDeliveryConfigurationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLogDeliveryConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLogDeliveryConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLogDeliveryConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLogDeliveryConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLogDeliveryConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, GetLogDeliveryConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLogDeliveryConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLogDeliveryConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLogDeliveryConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to GetLogDeliveryConfigurationRequest
   */
  public static GetLogDeliveryConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLogDeliveryConfigurationRequest.class);
  }

  /**
   * Convert an instance of GetLogDeliveryConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
