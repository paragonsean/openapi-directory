...
public class TokenValidityUnitsType {
  ...
  public TokenValidityUnitsType accessToken(TimeUnitsType accessToken) {
  ...
  public TokenValidityUnitsType idToken(TimeUnitsType idToken) {
  ...
  public TokenValidityUnitsType refreshToken(TimeUnitsType refreshToken) {
  ...
  public boolean equals(Object o) {
    ...
    TokenValidityUnitsType tokenValidityUnitsType = (TokenValidityUnitsType) o;
    return Objects.equals(this.accessToken, tokenValidityUnitsType.accessToken) &&
        Objects.equals(this.idToken, tokenValidityUnitsType.idToken) &&
        Objects.equals(this.refreshToken, tokenValidityUnitsType.refreshToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class TokenValidityUnitsType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TokenValidityUnitsType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TokenValidityUnitsType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TokenValidityUnitsType is not found in the empty JSON string", TokenValidityUnitsType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TokenValidityUnitsType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TokenValidityUnitsType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TokenValidityUnitsType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TokenValidityUnitsType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TokenValidityUnitsType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TokenValidityUnitsType.class));

       return (TypeAdapter<T>) new TypeAdapter<TokenValidityUnitsType>() {
           @Override
           public void write(JsonWriter out, TokenValidityUnitsType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TokenValidityUnitsType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TokenValidityUnitsType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TokenValidityUnitsType
   * @throws IOException if the JSON string is invalid with respect to TokenValidityUnitsType
   */
  public static TokenValidityUnitsType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TokenValidityUnitsType.class);
  }

  /**
   * Convert an instance of TokenValidityUnitsType to an JSON string
   *
   * @return JSON string
   */
