...
public class CreateUserPoolDomainRequest {
  ...
  private CreateUserPoolDomainRequestCustomDomainConfig customDomainConfig;

  public CreateUserPoolDomainRequest() {
  }

  public CreateUserPoolDomainRequest domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CreateUserPoolDomainRequest userPoolId(String userPoolId) {
  ...
  public CreateUserPoolDomainRequest customDomainConfig(CreateUserPoolDomainRequestCustomDomainConfig customDomainConfig) {
  ...
  public CreateUserPoolDomainRequestCustomDomainConfig getCustomDomainConfig() {
    return customDomainConfig;
  }

  public void setCustomDomainConfig(CreateUserPoolDomainRequestCustomDomainConfig customDomainConfig) {
    this.customDomainConfig = customDomainConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateUserPoolDomainRequest createUserPoolDomainRequest = (CreateUserPoolDomainRequest) o;
    return Objects.equals(this.domain, createUserPoolDomainRequest.domain) &&
        Objects.equals(this.userPoolId, createUserPoolDomainRequest.userPoolId) &&
        Objects.equals(this.customDomainConfig, createUserPoolDomainRequest.customDomainConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUserPoolDomainRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolDomainRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolDomainRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolDomainRequest is not found in the empty JSON string", CreateUserPoolDomainRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolDomainRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolDomainRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateUserPoolDomainRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("CustomDomainConfig") != null && !jsonObj.get("CustomDomainConfig").isJsonNull()) {
        CreateUserPoolDomainRequestCustomDomainConfig.validateJsonElement(jsonObj.get("CustomDomainConfig"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolDomainRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolDomainRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolDomainRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolDomainRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolDomainRequest>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolDomainRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolDomainRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolDomainRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolDomainRequest
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolDomainRequest
   */
  public static CreateUserPoolDomainRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolDomainRequest.class);
  }

  /**
   * Convert an instance of CreateUserPoolDomainRequest to an JSON string
   *
   * @return JSON string
   */
