...
/**
 * Gets or Sets UsernameAttributeType
 */
@JsonAdapter(UsernameAttributeType.Adapter.class)
public enum UsernameAttributeType {
  ...
  UsernameAttributeType(String value) {
    this.value = value;
  }
  ...
  public static UsernameAttributeType fromValue(String value) {
    for (UsernameAttributeType b : UsernameAttributeType.values()) {
  ...
  public static class Adapter extends TypeAdapter<UsernameAttributeType> {
    @Override
    public void write(final JsonWriter jsonWriter, final UsernameAttributeType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UsernameAttributeType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UsernameAttributeType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UsernameAttributeType.fromValue(value);
  }
}
