...
public class AdminGetDeviceRequest {
  ...
  public AdminGetDeviceRequest deviceKey(String deviceKey) {
  ...
  public AdminGetDeviceRequest userPoolId(String userPoolId) {
  ...
  public AdminGetDeviceRequest username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    AdminGetDeviceRequest adminGetDeviceRequest = (AdminGetDeviceRequest) o;
    return Objects.equals(this.deviceKey, adminGetDeviceRequest.deviceKey) &&
        Objects.equals(this.userPoolId, adminGetDeviceRequest.userPoolId) &&
        Objects.equals(this.username, adminGetDeviceRequest.username);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deviceKey, userPoolId, username);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminGetDeviceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminGetDeviceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminGetDeviceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminGetDeviceRequest is not found in the empty JSON string", AdminGetDeviceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminGetDeviceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminGetDeviceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminGetDeviceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminGetDeviceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminGetDeviceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminGetDeviceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminGetDeviceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminGetDeviceRequest>() {
           @Override
           public void write(JsonWriter out, AdminGetDeviceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminGetDeviceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminGetDeviceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminGetDeviceRequest
   * @throws IOException if the JSON string is invalid with respect to AdminGetDeviceRequest
   */
  public static AdminGetDeviceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminGetDeviceRequest.class);
  }

  /**
   * Convert an instance of AdminGetDeviceRequest to an JSON string
   *
   * @return JSON string
   */
