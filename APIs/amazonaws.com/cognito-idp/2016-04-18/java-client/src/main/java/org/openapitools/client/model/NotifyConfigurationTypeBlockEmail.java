...
public class NotifyConfigurationTypeBlockEmail {
  ...
  public NotifyConfigurationTypeBlockEmail() {
  }

  public NotifyConfigurationTypeBlockEmail subject(String subject) {
  ...
  public NotifyConfigurationTypeBlockEmail htmlBody(String htmlBody) {
  ...
  public NotifyConfigurationTypeBlockEmail textBody(String textBody) {
  ...
  public boolean equals(Object o) {
    ...
    NotifyConfigurationTypeBlockEmail notifyConfigurationTypeBlockEmail = (NotifyConfigurationTypeBlockEmail) o;
    return Objects.equals(this.subject, notifyConfigurationTypeBlockEmail.subject) &&
        Objects.equals(this.htmlBody, notifyConfigurationTypeBlockEmail.htmlBody) &&
        Objects.equals(this.textBody, notifyConfigurationTypeBlockEmail.textBody);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotifyConfigurationTypeBlockEmail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NotifyConfigurationTypeBlockEmail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotifyConfigurationTypeBlockEmail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotifyConfigurationTypeBlockEmail is not found in the empty JSON string", NotifyConfigurationTypeBlockEmail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotifyConfigurationTypeBlockEmail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotifyConfigurationTypeBlockEmail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NotifyConfigurationTypeBlockEmail.openapiRequiredFields) {
      ...
      if (jsonObj.get("TextBody") != null && !jsonObj.get("TextBody").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("TextBody"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotifyConfigurationTypeBlockEmail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotifyConfigurationTypeBlockEmail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotifyConfigurationTypeBlockEmail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotifyConfigurationTypeBlockEmail.class));

       return (TypeAdapter<T>) new TypeAdapter<NotifyConfigurationTypeBlockEmail>() {
           @Override
           public void write(JsonWriter out, NotifyConfigurationTypeBlockEmail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NotifyConfigurationTypeBlockEmail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NotifyConfigurationTypeBlockEmail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NotifyConfigurationTypeBlockEmail
   * @throws IOException if the JSON string is invalid with respect to NotifyConfigurationTypeBlockEmail
   */
  public static NotifyConfigurationTypeBlockEmail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NotifyConfigurationTypeBlockEmail.class);
  }

  /**
   * Convert an instance of NotifyConfigurationTypeBlockEmail to an JSON string
   *
   * @return JSON string
   */
