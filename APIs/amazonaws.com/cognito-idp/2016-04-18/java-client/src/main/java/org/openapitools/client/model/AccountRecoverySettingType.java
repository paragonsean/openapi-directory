...
public class AccountRecoverySettingType {
  ...
  public AccountRecoverySettingType recoveryMechanisms(List recoveryMechanisms) {
  ...
  public boolean equals(Object o) {
    ...
    AccountRecoverySettingType accountRecoverySettingType = (AccountRecoverySettingType) o;
    return Objects.equals(this.recoveryMechanisms, accountRecoverySettingType.recoveryMechanisms);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountRecoverySettingType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountRecoverySettingType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountRecoverySettingType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountRecoverySettingType is not found in the empty JSON string", AccountRecoverySettingType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountRecoverySettingType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountRecoverySettingType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountRecoverySettingType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountRecoverySettingType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountRecoverySettingType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountRecoverySettingType.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountRecoverySettingType>() {
           @Override
           public void write(JsonWriter out, AccountRecoverySettingType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountRecoverySettingType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountRecoverySettingType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountRecoverySettingType
   * @throws IOException if the JSON string is invalid with respect to AccountRecoverySettingType
   */
  public static AccountRecoverySettingType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountRecoverySettingType.class);
  }

  /**
   * Convert an instance of AccountRecoverySettingType to an JSON string
   *
   * @return JSON string
   */
