...
import org.openapitools.client.model.CreateUserPoolClientRequestAnalyticsConfiguration;
import org.openapitools.client.model.CreateUserPoolClientRequestTokenValidityUnits;
...
public class CreateUserPoolClientRequest {
  ...
  private CreateUserPoolClientRequestTokenValidityUnits tokenValidityUnits;
  ...
  private CreateUserPoolClientRequestAnalyticsConfiguration analyticsConfiguration;
  ...
  public CreateUserPoolClientRequest() {
  }

  public CreateUserPoolClientRequest userPoolId(String userPoolId) {
  ...
  public CreateUserPoolClientRequest clientName(String clientName) {
  ...
  public CreateUserPoolClientRequest generateSecret(Boolean generateSecret) {
  ...
  public CreateUserPoolClientRequest refreshTokenValidity(Integer refreshTokenValidity) {
  ...
  public CreateUserPoolClientRequest accessTokenValidity(Integer accessTokenValidity) {
  ...
  public CreateUserPoolClientRequest idTokenValidity(Integer idTokenValidity) {
  ...
  public CreateUserPoolClientRequest tokenValidityUnits(CreateUserPoolClientRequestTokenValidityUnits tokenValidityUnits) {
   ...
   */
  @javax.annotation.Nullable
  public CreateUserPoolClientRequestTokenValidityUnits getTokenValidityUnits() {
    return tokenValidityUnits;
  }

  public void setTokenValidityUnits(CreateUserPoolClientRequestTokenValidityUnits tokenValidityUnits) {
    this.tokenValidityUnits = tokenValidityUnits;
  }


  public CreateUserPoolClientRequest readAttributes(List readAttributes) {
  ...
  public CreateUserPoolClientRequest writeAttributes(List writeAttributes) {
  ...
  public CreateUserPoolClientRequest explicitAuthFlows(List explicitAuthFlows) {
  ...
  public CreateUserPoolClientRequest supportedIdentityProviders(List supportedIdentityProviders) {
  ...
  public CreateUserPoolClientRequest callbackURLs(List callbackURLs) {
  ...
  public CreateUserPoolClientRequest logoutURLs(List logoutURLs) {
  ...
  public CreateUserPoolClientRequest defaultRedirectURI(String defaultRedirectURI) {
  ...
  public CreateUserPoolClientRequest allowedOAuthFlows(List allowedOAuthFlows) {
  ...
  public CreateUserPoolClientRequest allowedOAuthScopes(List allowedOAuthScopes) {
  ...
  public CreateUserPoolClientRequest allowedOAuthFlowsUserPoolClient(Boolean allowedOAuthFlowsUserPoolClient) {
  ...
  public CreateUserPoolClientRequest analyticsConfiguration(CreateUserPoolClientRequestAnalyticsConfiguration analyticsConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public CreateUserPoolClientRequestAnalyticsConfiguration getAnalyticsConfiguration() {
    return analyticsConfiguration;
  }

  public void setAnalyticsConfiguration(CreateUserPoolClientRequestAnalyticsConfiguration analyticsConfiguration) {
    this.analyticsConfiguration = analyticsConfiguration;
  }


  public CreateUserPoolClientRequest preventUserExistenceErrors(PreventUserExistenceErrorTypes preventUserExistenceErrors) {
  ...
  public CreateUserPoolClientRequest enableTokenRevocation(Boolean enableTokenRevocation) {
  ...
  public CreateUserPoolClientRequest enablePropagateAdditionalUserContextData(Boolean enablePropagateAdditionalUserContextData) {
  ...
  public CreateUserPoolClientRequest authSessionValidity(Integer authSessionValidity) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolId, createUserPoolClientRequest.userPoolId) &&
        Objects.equals(this.clientName, createUserPoolClientRequest.clientName) &&
        Objects.equals(this.generateSecret, createUserPoolClientRequest.generateSecret) &&
        Objects.equals(this.refreshTokenValidity, createUserPoolClientRequest.refreshTokenValidity) &&
        Objects.equals(this.accessTokenValidity, createUserPoolClientRequest.accessTokenValidity) &&
        Objects.equals(this.idTokenValidity, createUserPoolClientRequest.idTokenValidity) &&
        Objects.equals(this.tokenValidityUnits, createUserPoolClientRequest.tokenValidityUnits) &&
        Objects.equals(this.readAttributes, createUserPoolClientRequest.readAttributes) &&
        Objects.equals(this.writeAttributes, createUserPoolClientRequest.writeAttributes) &&
        Objects.equals(this.explicitAuthFlows, createUserPoolClientRequest.explicitAuthFlows) &&
        Objects.equals(this.supportedIdentityProviders, createUserPoolClientRequest.supportedIdentityProviders) &&
        Objects.equals(this.callbackURLs, createUserPoolClientRequest.callbackURLs) &&
        Objects.equals(this.logoutURLs, createUserPoolClientRequest.logoutURLs) &&
        Objects.equals(this.defaultRedirectURI, createUserPoolClientRequest.defaultRedirectURI) &&
        Objects.equals(this.allowedOAuthFlows, createUserPoolClientRequest.allowedOAuthFlows) &&
        Objects.equals(this.allowedOAuthScopes, createUserPoolClientRequest.allowedOAuthScopes) &&
        Objects.equals(this.allowedOAuthFlowsUserPoolClient, createUserPoolClientRequest.allowedOAuthFlowsUserPoolClient) &&
        Objects.equals(this.analyticsConfiguration, createUserPoolClientRequest.analyticsConfiguration) &&
        Objects.equals(this.preventUserExistenceErrors, createUserPoolClientRequest.preventUserExistenceErrors) &&
        Objects.equals(this.enableTokenRevocation, createUserPoolClientRequest.enableTokenRevocation) &&
        Objects.equals(this.enablePropagateAdditionalUserContextData, createUserPoolClientRequest.enablePropagateAdditionalUserContextData) &&
        Objects.equals(this.authSessionValidity, createUserPoolClientRequest.authSessionValidity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, clientName, generateSecret, refreshTokenValidity, accessTokenValidity, idTokenValidity, tokenValidityUnits, readAttributes, writeAttributes, explicitAuthFlows, supportedIdentityProviders, callbackURLs, logoutURLs, defaultRedirectURI, allowedOAuthFlows, allowedOAuthScopes, allowedOAuthFlowsUserPoolClient, analyticsConfiguration, preventUserExistenceErrors, enableTokenRevocation, enablePropagateAdditionalUserContextData, authSessionValidity);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUserPoolClientRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserPoolClientRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUserPoolClientRequest is not found in the empty JSON string", CreateUserPoolClientRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUserPoolClientRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUserPoolClientRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateUserPoolClientRequest.openapiRequiredFields) {
      ...
      // validate the required field `ClientName`
      String.validateJsonElement(jsonObj.get("ClientName"));
      // validate the optional field `GenerateSecret`
      if (jsonObj.get("GenerateSecret") != null && !jsonObj.get("GenerateSecret").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("GenerateSecret"));
      }
      ...
      if (jsonObj.get("TokenValidityUnits") != null && !jsonObj.get("TokenValidityUnits").isJsonNull()) {
        CreateUserPoolClientRequestTokenValidityUnits.validateJsonElement(jsonObj.get("TokenValidityUnits"));
      }
      ...
      if (jsonObj.get("AnalyticsConfiguration") != null && !jsonObj.get("AnalyticsConfiguration").isJsonNull()) {
        CreateUserPoolClientRequestAnalyticsConfiguration.validateJsonElement(jsonObj.get("AnalyticsConfiguration"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUserPoolClientRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUserPoolClientRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUserPoolClientRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUserPoolClientRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUserPoolClientRequest>() {
           @Override
           public void write(JsonWriter out, CreateUserPoolClientRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUserPoolClientRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUserPoolClientRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUserPoolClientRequest
   * @throws IOException if the JSON string is invalid with respect to CreateUserPoolClientRequest
   */
  public static CreateUserPoolClientRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUserPoolClientRequest.class);
  }

  /**
   * Convert an instance of CreateUserPoolClientRequest to an JSON string
   *
   * @return JSON string
   */
