...
public class InitiateAuthRequestAnalyticsMetadata {
  ...
  public InitiateAuthRequestAnalyticsMetadata() {
  }

  public InitiateAuthRequestAnalyticsMetadata analyticsEndpointId(String analyticsEndpointId) {
  ...
  public boolean equals(Object o) {
    ...
    InitiateAuthRequestAnalyticsMetadata initiateAuthRequestAnalyticsMetadata = (InitiateAuthRequestAnalyticsMetadata) o;
    return Objects.equals(this.analyticsEndpointId, initiateAuthRequestAnalyticsMetadata.analyticsEndpointId);
  }
  ...
  public String toString() {
    ...
    sb.append("class InitiateAuthRequestAnalyticsMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InitiateAuthRequestAnalyticsMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InitiateAuthRequestAnalyticsMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InitiateAuthRequestAnalyticsMetadata is not found in the empty JSON string", InitiateAuthRequestAnalyticsMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InitiateAuthRequestAnalyticsMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InitiateAuthRequestAnalyticsMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitiateAuthRequestAnalyticsMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitiateAuthRequestAnalyticsMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitiateAuthRequestAnalyticsMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitiateAuthRequestAnalyticsMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<InitiateAuthRequestAnalyticsMetadata>() {
           @Override
           public void write(JsonWriter out, InitiateAuthRequestAnalyticsMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InitiateAuthRequestAnalyticsMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InitiateAuthRequestAnalyticsMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InitiateAuthRequestAnalyticsMetadata
   * @throws IOException if the JSON string is invalid with respect to InitiateAuthRequestAnalyticsMetadata
   */
  public static InitiateAuthRequestAnalyticsMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitiateAuthRequestAnalyticsMetadata.class);
  }

  /**
   * Convert an instance of InitiateAuthRequestAnalyticsMetadata to an JSON string
   *
   * @return JSON string
   */
