...
public class NotifyConfigurationTypeMfaEmail {
  ...
  public NotifyConfigurationTypeMfaEmail() {
  }

  public NotifyConfigurationTypeMfaEmail subject(String subject) {
  ...
  public NotifyConfigurationTypeMfaEmail htmlBody(String htmlBody) {
  ...
  public NotifyConfigurationTypeMfaEmail textBody(String textBody) {
  ...
  public boolean equals(Object o) {
    ...
    NotifyConfigurationTypeMfaEmail notifyConfigurationTypeMfaEmail = (NotifyConfigurationTypeMfaEmail) o;
    return Objects.equals(this.subject, notifyConfigurationTypeMfaEmail.subject) &&
        Objects.equals(this.htmlBody, notifyConfigurationTypeMfaEmail.htmlBody) &&
        Objects.equals(this.textBody, notifyConfigurationTypeMfaEmail.textBody);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotifyConfigurationTypeMfaEmail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NotifyConfigurationTypeMfaEmail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotifyConfigurationTypeMfaEmail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotifyConfigurationTypeMfaEmail is not found in the empty JSON string", NotifyConfigurationTypeMfaEmail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotifyConfigurationTypeMfaEmail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotifyConfigurationTypeMfaEmail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NotifyConfigurationTypeMfaEmail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotifyConfigurationTypeMfaEmail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotifyConfigurationTypeMfaEmail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotifyConfigurationTypeMfaEmail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotifyConfigurationTypeMfaEmail.class));

       return (TypeAdapter<T>) new TypeAdapter<NotifyConfigurationTypeMfaEmail>() {
           @Override
           public void write(JsonWriter out, NotifyConfigurationTypeMfaEmail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NotifyConfigurationTypeMfaEmail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NotifyConfigurationTypeMfaEmail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NotifyConfigurationTypeMfaEmail
   * @throws IOException if the JSON string is invalid with respect to NotifyConfigurationTypeMfaEmail
   */
  public static NotifyConfigurationTypeMfaEmail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NotifyConfigurationTypeMfaEmail.class);
  }

  /**
   * Convert an instance of NotifyConfigurationTypeMfaEmail to an JSON string
   *
   * @return JSON string
   */
