...
public class DescribeIdentityProviderRequest {
  ...
  public DescribeIdentityProviderRequest userPoolId(String userPoolId) {
  ...
  public DescribeIdentityProviderRequest providerName(String providerName) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeIdentityProviderRequest describeIdentityProviderRequest = (DescribeIdentityProviderRequest) o;
    return Objects.equals(this.userPoolId, describeIdentityProviderRequest.userPoolId) &&
        Objects.equals(this.providerName, describeIdentityProviderRequest.providerName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeIdentityProviderRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeIdentityProviderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeIdentityProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeIdentityProviderRequest is not found in the empty JSON string", DescribeIdentityProviderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeIdentityProviderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeIdentityProviderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeIdentityProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeIdentityProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeIdentityProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeIdentityProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeIdentityProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeIdentityProviderRequest>() {
           @Override
           public void write(JsonWriter out, DescribeIdentityProviderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeIdentityProviderRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeIdentityProviderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeIdentityProviderRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeIdentityProviderRequest
   */
  public static DescribeIdentityProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeIdentityProviderRequest.class);
  }

  /**
   * Convert an instance of DescribeIdentityProviderRequest to an JSON string
   *
   * @return JSON string
   */
