...
/**
 * Gets or Sets AdvancedSecurityModeType
 */
@JsonAdapter(AdvancedSecurityModeType.Adapter.class)
public enum AdvancedSecurityModeType {
  ...
  AdvancedSecurityModeType(String value) {
    this.value = value;
  }
  ...
  public static AdvancedSecurityModeType fromValue(String value) {
    for (AdvancedSecurityModeType b : AdvancedSecurityModeType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdvancedSecurityModeType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdvancedSecurityModeType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdvancedSecurityModeType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdvancedSecurityModeType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AdvancedSecurityModeType.fromValue(value);
  }
}
