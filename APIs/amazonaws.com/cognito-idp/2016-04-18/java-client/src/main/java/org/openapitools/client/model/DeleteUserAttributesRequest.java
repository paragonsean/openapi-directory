...
public class DeleteUserAttributesRequest {
  public static final String SERIALIZED_NAME_USER_ATTRIBUTE_NAMES = "UserAttributeNames";
  @SerializedName(SERIALIZED_NAME_USER_ATTRIBUTE_NAMES)
  ...
  public DeleteUserAttributesRequest userAttributeNames(List userAttributeNames) {
  ...
  public DeleteUserAttributesRequest accessToken(String accessToken) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteUserAttributesRequest deleteUserAttributesRequest = (DeleteUserAttributesRequest) o;
    return Objects.equals(this.userAttributeNames, deleteUserAttributesRequest.userAttributeNames) &&
        Objects.equals(this.accessToken, deleteUserAttributesRequest.accessToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userAttributeNames, accessToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteUserAttributesRequest {\n");
    sb.append("    userAttributeNames: ").append(toIndentedString(userAttributeNames)).append("\n");
  ...
  static {
    ...
    openapiFields.add("UserAttributeNames");
    openapiFields.add("AccessToken");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("UserAttributeNames");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteUserAttributesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteUserAttributesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteUserAttributesRequest is not found in the empty JSON string", DeleteUserAttributesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteUserAttributesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteUserAttributesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteUserAttributesRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `UserAttributeNames`
      List.validateJsonElement(jsonObj.get("UserAttributeNames"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteUserAttributesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteUserAttributesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteUserAttributesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteUserAttributesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteUserAttributesRequest>() {
           @Override
           public void write(JsonWriter out, DeleteUserAttributesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteUserAttributesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteUserAttributesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteUserAttributesRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteUserAttributesRequest
   */
  public static DeleteUserAttributesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteUserAttributesRequest.class);
  }

  /**
   * Convert an instance of DeleteUserAttributesRequest to an JSON string
   *
   * @return JSON string
   */
