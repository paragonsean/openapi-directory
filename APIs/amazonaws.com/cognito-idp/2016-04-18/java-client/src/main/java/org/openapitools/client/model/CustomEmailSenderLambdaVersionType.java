...
/**
 * Gets or Sets CustomEmailSenderLambdaVersionType
 */
@JsonAdapter(CustomEmailSenderLambdaVersionType.Adapter.class)
public enum CustomEmailSenderLambdaVersionType {
  ...
  CustomEmailSenderLambdaVersionType(String value) {
    this.value = value;
  }
  ...
  public static CustomEmailSenderLambdaVersionType fromValue(String value) {
    for (CustomEmailSenderLambdaVersionType b : CustomEmailSenderLambdaVersionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<CustomEmailSenderLambdaVersionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CustomEmailSenderLambdaVersionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CustomEmailSenderLambdaVersionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CustomEmailSenderLambdaVersionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CustomEmailSenderLambdaVersionType.fromValue(value);
  }
}
