...
public class EmailConfigurationType {
  ...
  public EmailConfigurationType sourceArn(String sourceArn) {
  ...
  public EmailConfigurationType replyToEmailAddress(String replyToEmailAddress) {
  ...
  public EmailConfigurationType emailSendingAccount(EmailSendingAccountType emailSendingAccount) {
  ...
  public EmailConfigurationType from(String from) {
    this.from = from;
    return this;
  }
  ...
  public EmailConfigurationType configurationSet(String configurationSet) {
  ...
  public boolean equals(Object o) {
    ...
    EmailConfigurationType emailConfigurationType = (EmailConfigurationType) o;
    return Objects.equals(this.sourceArn, emailConfigurationType.sourceArn) &&
        Objects.equals(this.replyToEmailAddress, emailConfigurationType.replyToEmailAddress) &&
        Objects.equals(this.emailSendingAccount, emailConfigurationType.emailSendingAccount) &&
        Objects.equals(this.from, emailConfigurationType.from) &&
        Objects.equals(this.configurationSet, emailConfigurationType.configurationSet);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailConfigurationType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailConfigurationType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailConfigurationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailConfigurationType is not found in the empty JSON string", EmailConfigurationType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailConfigurationType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailConfigurationType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailConfigurationType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailConfigurationType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailConfigurationType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailConfigurationType.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailConfigurationType>() {
           @Override
           public void write(JsonWriter out, EmailConfigurationType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailConfigurationType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailConfigurationType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailConfigurationType
   * @throws IOException if the JSON string is invalid with respect to EmailConfigurationType
   */
  public static EmailConfigurationType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailConfigurationType.class);
  }

  /**
   * Convert an instance of EmailConfigurationType to an JSON string
   *
   * @return JSON string
   */
