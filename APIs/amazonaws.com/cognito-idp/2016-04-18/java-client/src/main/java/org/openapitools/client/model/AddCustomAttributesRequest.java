...
public class AddCustomAttributesRequest {
  ...
  public AddCustomAttributesRequest userPoolId(String userPoolId) {
  ...
  public AddCustomAttributesRequest customAttributes(List customAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    AddCustomAttributesRequest addCustomAttributesRequest = (AddCustomAttributesRequest) o;
    return Objects.equals(this.userPoolId, addCustomAttributesRequest.userPoolId) &&
        Objects.equals(this.customAttributes, addCustomAttributesRequest.customAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, customAttributes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddCustomAttributesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddCustomAttributesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddCustomAttributesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCustomAttributesRequest is not found in the empty JSON string", AddCustomAttributesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddCustomAttributesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddCustomAttributesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddCustomAttributesRequest.openapiRequiredFields) {
      ...
      // validate the required field `CustomAttributes`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCustomAttributesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCustomAttributesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCustomAttributesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCustomAttributesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCustomAttributesRequest>() {
           @Override
           public void write(JsonWriter out, AddCustomAttributesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddCustomAttributesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddCustomAttributesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddCustomAttributesRequest
   * @throws IOException if the JSON string is invalid with respect to AddCustomAttributesRequest
   */
  public static AddCustomAttributesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCustomAttributesRequest.class);
  }

  /**
   * Convert an instance of AddCustomAttributesRequest to an JSON string
   *
   * @return JSON string
   */
