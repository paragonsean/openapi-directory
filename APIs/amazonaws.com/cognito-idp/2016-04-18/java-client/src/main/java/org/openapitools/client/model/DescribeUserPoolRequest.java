...
public class DescribeUserPoolRequest {
  ...
  public DescribeUserPoolRequest userPoolId(String userPoolId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeUserPoolRequest describeUserPoolRequest = (DescribeUserPoolRequest) o;
    return Objects.equals(this.userPoolId, describeUserPoolRequest.userPoolId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeUserPoolRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUserPoolRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUserPoolRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUserPoolRequest is not found in the empty JSON string", DescribeUserPoolRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUserPoolRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUserPoolRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeUserPoolRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUserPoolRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUserPoolRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUserPoolRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUserPoolRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUserPoolRequest>() {
           @Override
           public void write(JsonWriter out, DescribeUserPoolRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUserPoolRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUserPoolRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUserPoolRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeUserPoolRequest
   */
  public static DescribeUserPoolRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUserPoolRequest.class);
  }

  /**
   * Convert an instance of DescribeUserPoolRequest to an JSON string
   *
   * @return JSON string
   */
