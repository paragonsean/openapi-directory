...
public class AdminDeleteUserRequest {
  ...
  public AdminDeleteUserRequest userPoolId(String userPoolId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolId, adminDeleteUserRequest.userPoolId) &&
        Objects.equals(this.username, adminDeleteUserRequest.username);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminDeleteUserRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminDeleteUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminDeleteUserRequest is not found in the empty JSON string", AdminDeleteUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminDeleteUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminDeleteUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminDeleteUserRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminDeleteUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminDeleteUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminDeleteUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminDeleteUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminDeleteUserRequest>() {
           @Override
           public void write(JsonWriter out, AdminDeleteUserRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminDeleteUserRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminDeleteUserRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminDeleteUserRequest
   * @throws IOException if the JSON string is invalid with respect to AdminDeleteUserRequest
   */
  public static AdminDeleteUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminDeleteUserRequest.class);
  }

  /**
   * Convert an instance of AdminDeleteUserRequest to an JSON string
   *
   * @return JSON string
   */
