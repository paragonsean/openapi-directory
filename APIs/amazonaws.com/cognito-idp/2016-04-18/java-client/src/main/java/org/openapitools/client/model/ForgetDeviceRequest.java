...
public class ForgetDeviceRequest {
  ...
  public ForgetDeviceRequest accessToken(String accessToken) {
  ...
  public ForgetDeviceRequest deviceKey(String deviceKey) {
  ...
  public boolean equals(Object o) {
    ...
    ForgetDeviceRequest forgetDeviceRequest = (ForgetDeviceRequest) o;
    return Objects.equals(this.accessToken, forgetDeviceRequest.accessToken) &&
        Objects.equals(this.deviceKey, forgetDeviceRequest.deviceKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, deviceKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ForgetDeviceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ForgetDeviceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForgetDeviceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ForgetDeviceRequest is not found in the empty JSON string", ForgetDeviceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ForgetDeviceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ForgetDeviceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ForgetDeviceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ForgetDeviceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ForgetDeviceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ForgetDeviceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ForgetDeviceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ForgetDeviceRequest>() {
           @Override
           public void write(JsonWriter out, ForgetDeviceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ForgetDeviceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ForgetDeviceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ForgetDeviceRequest
   * @throws IOException if the JSON string is invalid with respect to ForgetDeviceRequest
   */
  public static ForgetDeviceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ForgetDeviceRequest.class);
  }

  /**
   * Convert an instance of ForgetDeviceRequest to an JSON string
   *
   * @return JSON string
   */
