...
public class InitiateAuthResponseAuthenticationResult {
  ...
  public InitiateAuthResponseAuthenticationResult() {
  }

  public InitiateAuthResponseAuthenticationResult accessToken(String accessToken) {
  ...
  public InitiateAuthResponseAuthenticationResult expiresIn(Integer expiresIn) {
  ...
  public InitiateAuthResponseAuthenticationResult tokenType(String tokenType) {
  ...
  public InitiateAuthResponseAuthenticationResult refreshToken(String refreshToken) {
  ...
  public InitiateAuthResponseAuthenticationResult idToken(String idToken) {
  ...
  public InitiateAuthResponseAuthenticationResult newDeviceMetadata(AuthenticationResultTypeNewDeviceMetadata newDeviceMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    InitiateAuthResponseAuthenticationResult initiateAuthResponseAuthenticationResult = (InitiateAuthResponseAuthenticationResult) o;
    return Objects.equals(this.accessToken, initiateAuthResponseAuthenticationResult.accessToken) &&
        Objects.equals(this.expiresIn, initiateAuthResponseAuthenticationResult.expiresIn) &&
        Objects.equals(this.tokenType, initiateAuthResponseAuthenticationResult.tokenType) &&
        Objects.equals(this.refreshToken, initiateAuthResponseAuthenticationResult.refreshToken) &&
        Objects.equals(this.idToken, initiateAuthResponseAuthenticationResult.idToken) &&
        Objects.equals(this.newDeviceMetadata, initiateAuthResponseAuthenticationResult.newDeviceMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class InitiateAuthResponseAuthenticationResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InitiateAuthResponseAuthenticationResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InitiateAuthResponseAuthenticationResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InitiateAuthResponseAuthenticationResult is not found in the empty JSON string", InitiateAuthResponseAuthenticationResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InitiateAuthResponseAuthenticationResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InitiateAuthResponseAuthenticationResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitiateAuthResponseAuthenticationResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitiateAuthResponseAuthenticationResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitiateAuthResponseAuthenticationResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitiateAuthResponseAuthenticationResult.class));

       return (TypeAdapter<T>) new TypeAdapter<InitiateAuthResponseAuthenticationResult>() {
           @Override
           public void write(JsonWriter out, InitiateAuthResponseAuthenticationResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InitiateAuthResponseAuthenticationResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InitiateAuthResponseAuthenticationResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InitiateAuthResponseAuthenticationResult
   * @throws IOException if the JSON string is invalid with respect to InitiateAuthResponseAuthenticationResult
   */
  public static InitiateAuthResponseAuthenticationResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitiateAuthResponseAuthenticationResult.class);
  }

  /**
   * Convert an instance of InitiateAuthResponseAuthenticationResult to an JSON string
   *
   * @return JSON string
   */
