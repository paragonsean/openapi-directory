...
public class RevokeTokenRequest {
  ...
  public RevokeTokenRequest clientSecret(String clientSecret) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.token, revokeTokenRequest.token) &&
        ...
        Objects.equals(this.clientSecret, revokeTokenRequest.clientSecret);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, clientId, clientSecret);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : RevokeTokenRequest.openapiRequiredFields) {
