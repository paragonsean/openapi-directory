...
public class LambdaConfigTypeCustomEmailSender {
  ...
  public LambdaConfigTypeCustomEmailSender() {
  }

  public LambdaConfigTypeCustomEmailSender lambdaVersion(CustomEmailSenderLambdaVersionType lambdaVersion) {
  ...
  public LambdaConfigTypeCustomEmailSender lambdaArn(String lambdaArn) {
  ...
  public boolean equals(Object o) {
    ...
    LambdaConfigTypeCustomEmailSender lambdaConfigTypeCustomEmailSender = (LambdaConfigTypeCustomEmailSender) o;
    return Objects.equals(this.lambdaVersion, lambdaConfigTypeCustomEmailSender.lambdaVersion) &&
        Objects.equals(this.lambdaArn, lambdaConfigTypeCustomEmailSender.lambdaArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class LambdaConfigTypeCustomEmailSender {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LambdaConfigTypeCustomEmailSender
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LambdaConfigTypeCustomEmailSender.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LambdaConfigTypeCustomEmailSender is not found in the empty JSON string", LambdaConfigTypeCustomEmailSender.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LambdaConfigTypeCustomEmailSender.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LambdaConfigTypeCustomEmailSender` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LambdaConfigTypeCustomEmailSender.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LambdaConfigTypeCustomEmailSender.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LambdaConfigTypeCustomEmailSender' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LambdaConfigTypeCustomEmailSender> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LambdaConfigTypeCustomEmailSender.class));

       return (TypeAdapter<T>) new TypeAdapter<LambdaConfigTypeCustomEmailSender>() {
           @Override
           public void write(JsonWriter out, LambdaConfigTypeCustomEmailSender value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LambdaConfigTypeCustomEmailSender read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LambdaConfigTypeCustomEmailSender given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LambdaConfigTypeCustomEmailSender
   * @throws IOException if the JSON string is invalid with respect to LambdaConfigTypeCustomEmailSender
   */
  public static LambdaConfigTypeCustomEmailSender fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LambdaConfigTypeCustomEmailSender.class);
  }

  /**
   * Convert an instance of LambdaConfigTypeCustomEmailSender to an JSON string
   *
   * @return JSON string
   */
