...
public class UpdateResourceServerRequest {
  ...
  public UpdateResourceServerRequest() {
  }

  public UpdateResourceServerRequest userPoolId(String userPoolId) {
  ...
  public UpdateResourceServerRequest identifier(String identifier) {
  ...
  public UpdateResourceServerRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateResourceServerRequest scopes(List scopes) {
    this.scopes = scopes;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateResourceServerRequest updateResourceServerRequest = (UpdateResourceServerRequest) o;
    return Objects.equals(this.userPoolId, updateResourceServerRequest.userPoolId) &&
        Objects.equals(this.identifier, updateResourceServerRequest.identifier) &&
        Objects.equals(this.name, updateResourceServerRequest.name) &&
        Objects.equals(this.scopes, updateResourceServerRequest.scopes);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateResourceServerRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateResourceServerRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateResourceServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateResourceServerRequest is not found in the empty JSON string", UpdateResourceServerRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateResourceServerRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateResourceServerRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateResourceServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateResourceServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateResourceServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateResourceServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateResourceServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateResourceServerRequest>() {
           @Override
           public void write(JsonWriter out, UpdateResourceServerRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateResourceServerRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateResourceServerRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateResourceServerRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateResourceServerRequest
   */
  public static UpdateResourceServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateResourceServerRequest.class);
  }

  /**
   * Convert an instance of UpdateResourceServerRequest to an JSON string
   *
   * @return JSON string
   */
