...
import org.openapitools.client.model.AdminDisableProviderForUserRequestUser;
...
public class AdminDisableProviderForUserRequest {
  ...
  private AdminDisableProviderForUserRequestUser user;

  public AdminDisableProviderForUserRequest() {
  }

  public AdminDisableProviderForUserRequest userPoolId(String userPoolId) {
  ...
  public AdminDisableProviderForUserRequest user(AdminDisableProviderForUserRequestUser user) {
    this.user = user;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AdminDisableProviderForUserRequestUser getUser() {
    return user;
  }

  public void setUser(AdminDisableProviderForUserRequestUser user) {
    this.user = user;
  }
  ...
  public boolean equals(Object o) {
    ...
    AdminDisableProviderForUserRequest adminDisableProviderForUserRequest = (AdminDisableProviderForUserRequest) o;
    return Objects.equals(this.userPoolId, adminDisableProviderForUserRequest.userPoolId) &&
        Objects.equals(this.user, adminDisableProviderForUserRequest.user);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, user);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminDisableProviderForUserRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminDisableProviderForUserRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminDisableProviderForUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminDisableProviderForUserRequest is not found in the empty JSON string", AdminDisableProviderForUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminDisableProviderForUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminDisableProviderForUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminDisableProviderForUserRequest.openapiRequiredFields) {
      ...
      AdminDisableProviderForUserRequestUser.validateJsonElement(jsonObj.get("User"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminDisableProviderForUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminDisableProviderForUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminDisableProviderForUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminDisableProviderForUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminDisableProviderForUserRequest>() {
           @Override
           public void write(JsonWriter out, AdminDisableProviderForUserRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminDisableProviderForUserRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminDisableProviderForUserRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminDisableProviderForUserRequest
   * @throws IOException if the JSON string is invalid with respect to AdminDisableProviderForUserRequest
   */
  public static AdminDisableProviderForUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminDisableProviderForUserRequest.class);
  }

  /**
   * Convert an instance of AdminDisableProviderForUserRequest to an JSON string
   *
   * @return JSON string
   */
