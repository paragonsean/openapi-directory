...
public class LogConfigurationType {
  ...
  private EventSourceName eventSource;
  ...
  private LogConfigurationTypeCloudWatchLogsConfiguration cloudWatchLogsConfiguration;

  public LogConfigurationType() {
  }

  public LogConfigurationType logLevel(LogLevel logLevel) {
  ...
  public LogConfigurationType eventSource(EventSourceName eventSource) {
   ...
   */
  @javax.annotation.Nonnull
  public EventSourceName getEventSource() {
    return eventSource;
  }
  ...
  public LogConfigurationType cloudWatchLogsConfiguration(LogConfigurationTypeCloudWatchLogsConfiguration cloudWatchLogsConfiguration) {
  ...
  public LogConfigurationTypeCloudWatchLogsConfiguration getCloudWatchLogsConfiguration() {
    return cloudWatchLogsConfiguration;
  }

  public void setCloudWatchLogsConfiguration(LogConfigurationTypeCloudWatchLogsConfiguration cloudWatchLogsConfiguration) {
    this.cloudWatchLogsConfiguration = cloudWatchLogsConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    LogConfigurationType logConfigurationType = (LogConfigurationType) o;
    return Objects.equals(this.logLevel, logConfigurationType.logLevel) &&
        Objects.equals(this.eventSource, logConfigurationType.eventSource) &&
        Objects.equals(this.cloudWatchLogsConfiguration, logConfigurationType.cloudWatchLogsConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(logLevel, eventSource, cloudWatchLogsConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LogConfigurationType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogConfigurationType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogConfigurationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LogConfigurationType is not found in the empty JSON string", LogConfigurationType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogConfigurationType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LogConfigurationType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LogConfigurationType.openapiRequiredFields) {
      ...
      // validate the required field `EventSource`
      EventSourceName.validateJsonElement(jsonObj.get("EventSource"));
      ...
      if (jsonObj.get("CloudWatchLogsConfiguration") != null && !jsonObj.get("CloudWatchLogsConfiguration").isJsonNull()) {
        LogConfigurationTypeCloudWatchLogsConfiguration.validateJsonElement(jsonObj.get("CloudWatchLogsConfiguration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogConfigurationType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogConfigurationType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogConfigurationType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogConfigurationType.class));

       return (TypeAdapter<T>) new TypeAdapter<LogConfigurationType>() {
           @Override
           public void write(JsonWriter out, LogConfigurationType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogConfigurationType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogConfigurationType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogConfigurationType
   * @throws IOException if the JSON string is invalid with respect to LogConfigurationType
   */
  public static LogConfigurationType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogConfigurationType.class);
  }

  /**
   * Convert an instance of LogConfigurationType to an JSON string
   *
   * @return JSON string
   */
