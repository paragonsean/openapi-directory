...
public class DescribeResourceServerRequest {
  ...
  public DescribeResourceServerRequest userPoolId(String userPoolId) {
  ...
  public DescribeResourceServerRequest identifier(String identifier) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeResourceServerRequest describeResourceServerRequest = (DescribeResourceServerRequest) o;
    return Objects.equals(this.userPoolId, describeResourceServerRequest.userPoolId) &&
        Objects.equals(this.identifier, describeResourceServerRequest.identifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, identifier);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeResourceServerRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeResourceServerRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeResourceServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeResourceServerRequest is not found in the empty JSON string", DescribeResourceServerRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeResourceServerRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeResourceServerRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeResourceServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeResourceServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeResourceServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeResourceServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeResourceServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeResourceServerRequest>() {
           @Override
           public void write(JsonWriter out, DescribeResourceServerRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeResourceServerRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeResourceServerRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeResourceServerRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeResourceServerRequest
   */
  public static DescribeResourceServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeResourceServerRequest.class);
  }

  /**
   * Convert an instance of DescribeResourceServerRequest to an JSON string
   *
   * @return JSON string
   */
