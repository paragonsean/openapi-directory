...
public class SetUserPoolMfaConfigResponseSmsMfaConfiguration {
  ...
  public SetUserPoolMfaConfigResponseSmsMfaConfiguration() {
  }

  public SetUserPoolMfaConfigResponseSmsMfaConfiguration smsAuthenticationMessage(String smsAuthenticationMessage) {
  ...
  public SetUserPoolMfaConfigResponseSmsMfaConfiguration smsConfiguration(SmsMfaConfigTypeSmsConfiguration smsConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    SetUserPoolMfaConfigResponseSmsMfaConfiguration setUserPoolMfaConfigResponseSmsMfaConfiguration = (SetUserPoolMfaConfigResponseSmsMfaConfiguration) o;
    return Objects.equals(this.smsAuthenticationMessage, setUserPoolMfaConfigResponseSmsMfaConfiguration.smsAuthenticationMessage) &&
        Objects.equals(this.smsConfiguration, setUserPoolMfaConfigResponseSmsMfaConfiguration.smsConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetUserPoolMfaConfigResponseSmsMfaConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetUserPoolMfaConfigResponseSmsMfaConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetUserPoolMfaConfigResponseSmsMfaConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetUserPoolMfaConfigResponseSmsMfaConfiguration is not found in the empty JSON string", SetUserPoolMfaConfigResponseSmsMfaConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetUserPoolMfaConfigResponseSmsMfaConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetUserPoolMfaConfigResponseSmsMfaConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetUserPoolMfaConfigResponseSmsMfaConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetUserPoolMfaConfigResponseSmsMfaConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetUserPoolMfaConfigResponseSmsMfaConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetUserPoolMfaConfigResponseSmsMfaConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<SetUserPoolMfaConfigResponseSmsMfaConfiguration>() {
           @Override
           public void write(JsonWriter out, SetUserPoolMfaConfigResponseSmsMfaConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetUserPoolMfaConfigResponseSmsMfaConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetUserPoolMfaConfigResponseSmsMfaConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetUserPoolMfaConfigResponseSmsMfaConfiguration
   * @throws IOException if the JSON string is invalid with respect to SetUserPoolMfaConfigResponseSmsMfaConfiguration
   */
  public static SetUserPoolMfaConfigResponseSmsMfaConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetUserPoolMfaConfigResponseSmsMfaConfiguration.class);
  }

  /**
   * Convert an instance of SetUserPoolMfaConfigResponseSmsMfaConfiguration to an JSON string
   *
   * @return JSON string
   */
