...
public class AssociateSoftwareTokenRequest {
  ...
  public AssociateSoftwareTokenRequest accessToken(String accessToken) {
  ...
  public AssociateSoftwareTokenRequest session(String session) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateSoftwareTokenRequest associateSoftwareTokenRequest = (AssociateSoftwareTokenRequest) o;
    return Objects.equals(this.accessToken, associateSoftwareTokenRequest.accessToken) &&
        Objects.equals(this.session, associateSoftwareTokenRequest.session);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, session);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssociateSoftwareTokenRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateSoftwareTokenRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateSoftwareTokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateSoftwareTokenRequest is not found in the empty JSON string", AssociateSoftwareTokenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateSoftwareTokenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateSoftwareTokenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateSoftwareTokenRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateSoftwareTokenRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateSoftwareTokenRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateSoftwareTokenRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateSoftwareTokenRequest>() {
           @Override
           public void write(JsonWriter out, AssociateSoftwareTokenRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateSoftwareTokenRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateSoftwareTokenRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateSoftwareTokenRequest
   * @throws IOException if the JSON string is invalid with respect to AssociateSoftwareTokenRequest
   */
  public static AssociateSoftwareTokenRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateSoftwareTokenRequest.class);
  }

  /**
   * Convert an instance of AssociateSoftwareTokenRequest to an JSON string
   *
   * @return JSON string
   */
