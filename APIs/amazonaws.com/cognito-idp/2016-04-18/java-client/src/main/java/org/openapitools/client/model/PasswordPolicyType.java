...
public class PasswordPolicyType {
  ...
  public PasswordPolicyType minimumLength(Integer minimumLength) {
  ...
  public PasswordPolicyType requireUppercase(Boolean requireUppercase) {
  ...
  public PasswordPolicyType requireLowercase(Boolean requireLowercase) {
  ...
  public PasswordPolicyType requireNumbers(Boolean requireNumbers) {
  ...
  public PasswordPolicyType requireSymbols(Boolean requireSymbols) {
  ...
  public PasswordPolicyType temporaryPasswordValidityDays(Integer temporaryPasswordValidityDays) {
  ...
  public boolean equals(Object o) {
    ...
    PasswordPolicyType passwordPolicyType = (PasswordPolicyType) o;
    return Objects.equals(this.minimumLength, passwordPolicyType.minimumLength) &&
        Objects.equals(this.requireUppercase, passwordPolicyType.requireUppercase) &&
        Objects.equals(this.requireLowercase, passwordPolicyType.requireLowercase) &&
        Objects.equals(this.requireNumbers, passwordPolicyType.requireNumbers) &&
        Objects.equals(this.requireSymbols, passwordPolicyType.requireSymbols) &&
        Objects.equals(this.temporaryPasswordValidityDays, passwordPolicyType.temporaryPasswordValidityDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class PasswordPolicyType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PasswordPolicyType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PasswordPolicyType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PasswordPolicyType is not found in the empty JSON string", PasswordPolicyType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PasswordPolicyType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PasswordPolicyType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PasswordPolicyType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PasswordPolicyType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PasswordPolicyType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PasswordPolicyType.class));

       return (TypeAdapter<T>) new TypeAdapter<PasswordPolicyType>() {
           @Override
           public void write(JsonWriter out, PasswordPolicyType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PasswordPolicyType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PasswordPolicyType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PasswordPolicyType
   * @throws IOException if the JSON string is invalid with respect to PasswordPolicyType
   */
  public static PasswordPolicyType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PasswordPolicyType.class);
  }

  /**
   * Convert an instance of PasswordPolicyType to an JSON string
   *
   * @return JSON string
   */
