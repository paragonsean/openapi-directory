...
public class SetRiskConfigurationResponse {
  ...
  public SetRiskConfigurationResponse() {
  }

  public SetRiskConfigurationResponse riskConfiguration(DescribeRiskConfigurationResponseRiskConfiguration riskConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    SetRiskConfigurationResponse setRiskConfigurationResponse = (SetRiskConfigurationResponse) o;
    return Objects.equals(this.riskConfiguration, setRiskConfigurationResponse.riskConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetRiskConfigurationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetRiskConfigurationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetRiskConfigurationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetRiskConfigurationResponse is not found in the empty JSON string", SetRiskConfigurationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetRiskConfigurationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetRiskConfigurationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetRiskConfigurationResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetRiskConfigurationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetRiskConfigurationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetRiskConfigurationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetRiskConfigurationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SetRiskConfigurationResponse>() {
           @Override
           public void write(JsonWriter out, SetRiskConfigurationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetRiskConfigurationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetRiskConfigurationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetRiskConfigurationResponse
   * @throws IOException if the JSON string is invalid with respect to SetRiskConfigurationResponse
   */
  public static SetRiskConfigurationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetRiskConfigurationResponse.class);
  }

  /**
   * Convert an instance of SetRiskConfigurationResponse to an JSON string
   *
   * @return JSON string
   */
