...
public class SetLogDeliveryConfigurationRequest {
  ...
  public SetLogDeliveryConfigurationRequest() {
  }

  public SetLogDeliveryConfigurationRequest userPoolId(String userPoolId) {
  ...
  public SetLogDeliveryConfigurationRequest logConfigurations(List logConfigurations) {
  ...
  public boolean equals(Object o) {
    ...
    SetLogDeliveryConfigurationRequest setLogDeliveryConfigurationRequest = (SetLogDeliveryConfigurationRequest) o;
    return Objects.equals(this.userPoolId, setLogDeliveryConfigurationRequest.userPoolId) &&
        Objects.equals(this.logConfigurations, setLogDeliveryConfigurationRequest.logConfigurations);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetLogDeliveryConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetLogDeliveryConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetLogDeliveryConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetLogDeliveryConfigurationRequest is not found in the empty JSON string", SetLogDeliveryConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetLogDeliveryConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetLogDeliveryConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetLogDeliveryConfigurationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetLogDeliveryConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetLogDeliveryConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetLogDeliveryConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetLogDeliveryConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SetLogDeliveryConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, SetLogDeliveryConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetLogDeliveryConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetLogDeliveryConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetLogDeliveryConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to SetLogDeliveryConfigurationRequest
   */
  public static SetLogDeliveryConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetLogDeliveryConfigurationRequest.class);
  }

  /**
   * Convert an instance of SetLogDeliveryConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
