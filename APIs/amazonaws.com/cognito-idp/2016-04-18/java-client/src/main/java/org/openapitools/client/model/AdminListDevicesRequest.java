...
public class AdminListDevicesRequest {
  ...
  public AdminListDevicesRequest() {
  }

  public AdminListDevicesRequest userPoolId(String userPoolId) {
  ...
  public AdminListDevicesRequest username(String username) {
  ...
  public AdminListDevicesRequest limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public AdminListDevicesRequest paginationToken(String paginationToken) {
  ...
  public boolean equals(Object o) {
    ...
    AdminListDevicesRequest adminListDevicesRequest = (AdminListDevicesRequest) o;
    return Objects.equals(this.userPoolId, adminListDevicesRequest.userPoolId) &&
        Objects.equals(this.username, adminListDevicesRequest.username) &&
        Objects.equals(this.limit, adminListDevicesRequest.limit) &&
        Objects.equals(this.paginationToken, adminListDevicesRequest.paginationToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username, limit, paginationToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminListDevicesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminListDevicesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminListDevicesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminListDevicesRequest is not found in the empty JSON string", AdminListDevicesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminListDevicesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminListDevicesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminListDevicesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminListDevicesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminListDevicesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminListDevicesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminListDevicesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminListDevicesRequest>() {
           @Override
           public void write(JsonWriter out, AdminListDevicesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminListDevicesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminListDevicesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminListDevicesRequest
   * @throws IOException if the JSON string is invalid with respect to AdminListDevicesRequest
   */
  public static AdminListDevicesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminListDevicesRequest.class);
  }

  /**
   * Convert an instance of AdminListDevicesRequest to an JSON string
   *
   * @return JSON string
   */
