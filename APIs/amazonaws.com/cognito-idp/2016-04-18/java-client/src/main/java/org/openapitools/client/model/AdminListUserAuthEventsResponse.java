...
public class AdminListUserAuthEventsResponse {
  public static final String SERIALIZED_NAME_AUTH_EVENTS = "AuthEvents";
  @SerializedName(SERIALIZED_NAME_AUTH_EVENTS)
  ...
  public AdminListUserAuthEventsResponse authEvents(List authEvents) {
  ...
  public void setAuthEvents(List authEvents) {
    this.authEvents = authEvents;
  }


  public AdminListUserAuthEventsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    AdminListUserAuthEventsResponse adminListUserAuthEventsResponse = (AdminListUserAuthEventsResponse) o;
    return Objects.equals(this.authEvents, adminListUserAuthEventsResponse.authEvents) &&
        Objects.equals(this.nextToken, adminListUserAuthEventsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authEvents, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminListUserAuthEventsResponse {\n");
    sb.append("    authEvents: ").append(toIndentedString(authEvents)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminListUserAuthEventsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminListUserAuthEventsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminListUserAuthEventsResponse is not found in the empty JSON string", AdminListUserAuthEventsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminListUserAuthEventsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminListUserAuthEventsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `AuthEvents`
      if (jsonObj.get("AuthEvents") != null && !jsonObj.get("AuthEvents").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("AuthEvents"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminListUserAuthEventsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminListUserAuthEventsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminListUserAuthEventsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminListUserAuthEventsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminListUserAuthEventsResponse>() {
           @Override
           public void write(JsonWriter out, AdminListUserAuthEventsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminListUserAuthEventsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminListUserAuthEventsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminListUserAuthEventsResponse
   * @throws IOException if the JSON string is invalid with respect to AdminListUserAuthEventsResponse
   */
  public static AdminListUserAuthEventsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminListUserAuthEventsResponse.class);
  }

  /**
   * Convert an instance of AdminListUserAuthEventsResponse to an JSON string
   *
   * @return JSON string
   */
