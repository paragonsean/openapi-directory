...
import org.openapitools.client.model.CreateResourceServerResponseResourceServer;
...
public class CreateResourceServerResponse {
  ...
  private CreateResourceServerResponseResourceServer resourceServer;

  public CreateResourceServerResponse() {
  }

  public CreateResourceServerResponse resourceServer(CreateResourceServerResponseResourceServer resourceServer) {
  ...
  public CreateResourceServerResponseResourceServer getResourceServer() {
    return resourceServer;
  }

  public void setResourceServer(CreateResourceServerResponseResourceServer resourceServer) {
    this.resourceServer = resourceServer;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateResourceServerResponse createResourceServerResponse = (CreateResourceServerResponse) o;
    return Objects.equals(this.resourceServer, createResourceServerResponse.resourceServer);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateResourceServerResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateResourceServerResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateResourceServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateResourceServerResponse is not found in the empty JSON string", CreateResourceServerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateResourceServerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateResourceServerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateResourceServerResponse.openapiRequiredFields) {
      ...
      CreateResourceServerResponseResourceServer.validateJsonElement(jsonObj.get("ResourceServer"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateResourceServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateResourceServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateResourceServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateResourceServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateResourceServerResponse>() {
           @Override
           public void write(JsonWriter out, CreateResourceServerResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateResourceServerResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateResourceServerResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateResourceServerResponse
   * @throws IOException if the JSON string is invalid with respect to CreateResourceServerResponse
   */
  public static CreateResourceServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateResourceServerResponse.class);
  }

  /**
   * Convert an instance of CreateResourceServerResponse to an JSON string
   *
   * @return JSON string
   */
