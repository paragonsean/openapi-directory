 ...
 */
@JsonAdapter(AuthFlowType.Adapter.class)
public enum AuthFlowType {
  ...
  public static AuthFlowType fromValue(String value) {
    for (AuthFlowType b : AuthFlowType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AuthFlowType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuthFlowType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuthFlowType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuthFlowType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AuthFlowType.fromValue(value);
  }
}
