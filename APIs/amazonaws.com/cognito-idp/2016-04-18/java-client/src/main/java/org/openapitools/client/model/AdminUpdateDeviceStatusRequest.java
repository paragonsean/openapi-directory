...
import org.openapitools.client.model.DeviceRememberedStatusType;
...
public class AdminUpdateDeviceStatusRequest {
  ...
  public static final String SERIALIZED_NAME_DEVICE_REMEMBERED_STATUS = "DeviceRememberedStatus";
  @SerializedName(SERIALIZED_NAME_DEVICE_REMEMBERED_STATUS)
  private DeviceRememberedStatusType deviceRememberedStatus;

  public AdminUpdateDeviceStatusRequest() {
  }

  public AdminUpdateDeviceStatusRequest userPoolId(String userPoolId) {
  ...
  public AdminUpdateDeviceStatusRequest username(String username) {
  ...
  public AdminUpdateDeviceStatusRequest deviceKey(String deviceKey) {
  ...
  public AdminUpdateDeviceStatusRequest deviceRememberedStatus(DeviceRememberedStatusType deviceRememberedStatus) {
    this.deviceRememberedStatus = deviceRememberedStatus;
    return this;
  }

  /**
   * Get deviceRememberedStatus
   * @return deviceRememberedStatus
   */
  @javax.annotation.Nullable
  public DeviceRememberedStatusType getDeviceRememberedStatus() {
    return deviceRememberedStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    AdminUpdateDeviceStatusRequest adminUpdateDeviceStatusRequest = (AdminUpdateDeviceStatusRequest) o;
    return Objects.equals(this.userPoolId, adminUpdateDeviceStatusRequest.userPoolId) &&
        Objects.equals(this.username, adminUpdateDeviceStatusRequest.username) &&
        Objects.equals(this.deviceKey, adminUpdateDeviceStatusRequest.deviceKey) &&
        Objects.equals(this.deviceRememberedStatus, adminUpdateDeviceStatusRequest.deviceRememberedStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username, deviceKey, deviceRememberedStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminUpdateDeviceStatusRequest {\n");
    ...
    sb.append("    deviceRememberedStatus: ").append(toIndentedString(deviceRememberedStatus)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("DeviceRememberedStatus");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminUpdateDeviceStatusRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminUpdateDeviceStatusRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminUpdateDeviceStatusRequest is not found in the empty JSON string", AdminUpdateDeviceStatusRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminUpdateDeviceStatusRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminUpdateDeviceStatusRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminUpdateDeviceStatusRequest.openapiRequiredFields) {
      ...
      // validate the optional field `DeviceRememberedStatus`
      if (jsonObj.get("DeviceRememberedStatus") != null && !jsonObj.get("DeviceRememberedStatus").isJsonNull()) {
        DeviceRememberedStatusType.validateJsonElement(jsonObj.get("DeviceRememberedStatus"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminUpdateDeviceStatusRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminUpdateDeviceStatusRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminUpdateDeviceStatusRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminUpdateDeviceStatusRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminUpdateDeviceStatusRequest>() {
           @Override
           public void write(JsonWriter out, AdminUpdateDeviceStatusRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminUpdateDeviceStatusRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminUpdateDeviceStatusRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminUpdateDeviceStatusRequest
   * @throws IOException if the JSON string is invalid with respect to AdminUpdateDeviceStatusRequest
   */
  public static AdminUpdateDeviceStatusRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminUpdateDeviceStatusRequest.class);
  }

  /**
   * Convert an instance of AdminUpdateDeviceStatusRequest to an JSON string
   *
   * @return JSON string
   */
