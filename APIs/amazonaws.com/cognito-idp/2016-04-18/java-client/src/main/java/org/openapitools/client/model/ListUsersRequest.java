...
public class ListUsersRequest {
  ...
  public ListUsersRequest userPoolId(String userPoolId) {
  ...
  public ListUsersRequest attributesToGet(List attributesToGet) {
  ...
  public ListUsersRequest paginationToken(String paginationToken) {
  ...
  public ListUsersRequest filter(String filter) {
    this.filter = filter;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolId, listUsersRequest.userPoolId) &&
        Objects.equals(this.attributesToGet, listUsersRequest.attributesToGet) &&
        Objects.equals(this.limit, listUsersRequest.limit) &&
        Objects.equals(this.paginationToken, listUsersRequest.paginationToken) &&
        Objects.equals(this.filter, listUsersRequest.filter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, attributesToGet, limit, paginationToken, filter);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListUsersRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListUsersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListUsersRequest is not found in the empty JSON string", ListUsersRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListUsersRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListUsersRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListUsersRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListUsersRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListUsersRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListUsersRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListUsersRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListUsersRequest>() {
           @Override
           public void write(JsonWriter out, ListUsersRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListUsersRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListUsersRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListUsersRequest
   * @throws IOException if the JSON string is invalid with respect to ListUsersRequest
   */
  public static ListUsersRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUsersRequest.class);
  }

  /**
   * Convert an instance of ListUsersRequest to an JSON string
   *
   * @return JSON string
   */
