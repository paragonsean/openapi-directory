...
/**
 * Gets or Sets DeviceRememberedStatusType
 */
@JsonAdapter(DeviceRememberedStatusType.Adapter.class)
public enum DeviceRememberedStatusType {
  ...
  DeviceRememberedStatusType(String value) {
    this.value = value;
  }
  ...
  public static DeviceRememberedStatusType fromValue(String value) {
    for (DeviceRememberedStatusType b : DeviceRememberedStatusType.values()) {
  ...
  public static class Adapter extends TypeAdapter<DeviceRememberedStatusType> {
    @Override
    public void write(final JsonWriter jsonWriter, final DeviceRememberedStatusType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DeviceRememberedStatusType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DeviceRememberedStatusType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DeviceRememberedStatusType.fromValue(value);
  }
}
