...
public class GetUICustomizationResponse {
  ...
  public GetUICustomizationResponse uiCustomization(GetUICustomizationResponseUICustomization uiCustomization) {
  ...
  public boolean equals(Object o) {
    ...
    GetUICustomizationResponse getUICustomizationResponse = (GetUICustomizationResponse) o;
    return Objects.equals(this.uiCustomization, getUICustomizationResponse.uiCustomization);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetUICustomizationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUICustomizationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUICustomizationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUICustomizationResponse is not found in the empty JSON string", GetUICustomizationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUICustomizationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUICustomizationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetUICustomizationResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUICustomizationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUICustomizationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUICustomizationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUICustomizationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUICustomizationResponse>() {
           @Override
           public void write(JsonWriter out, GetUICustomizationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUICustomizationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUICustomizationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUICustomizationResponse
   * @throws IOException if the JSON string is invalid with respect to GetUICustomizationResponse
   */
  public static GetUICustomizationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUICustomizationResponse.class);
  }

  /**
   * Convert an instance of GetUICustomizationResponse to an JSON string
   *
   * @return JSON string
   */
