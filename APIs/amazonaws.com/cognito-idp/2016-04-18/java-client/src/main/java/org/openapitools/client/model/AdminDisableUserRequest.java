...
public class AdminDisableUserRequest {
  ...
  public AdminDisableUserRequest userPoolId(String userPoolId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userPoolId, adminDisableUserRequest.userPoolId) &&
        Objects.equals(this.username, adminDisableUserRequest.username);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminDisableUserRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminDisableUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminDisableUserRequest is not found in the empty JSON string", AdminDisableUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminDisableUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminDisableUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminDisableUserRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminDisableUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminDisableUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminDisableUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminDisableUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminDisableUserRequest>() {
           @Override
           public void write(JsonWriter out, AdminDisableUserRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminDisableUserRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminDisableUserRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminDisableUserRequest
   * @throws IOException if the JSON string is invalid with respect to AdminDisableUserRequest
   */
  public static AdminDisableUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminDisableUserRequest.class);
  }

  /**
   * Convert an instance of AdminDisableUserRequest to an JSON string
   *
   * @return JSON string
   */
