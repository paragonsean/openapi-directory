...
public class ListUserPoolsRequest {
  ...
  public ListUserPoolsRequest nextToken(String nextToken) {
  ...
  public ListUserPoolsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listUserPoolsRequest.nextToken) &&
        Objects.equals(this.maxResults, listUserPoolsRequest.maxResults);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListUserPoolsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListUserPoolsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListUserPoolsRequest is not found in the empty JSON string", ListUserPoolsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListUserPoolsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListUserPoolsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListUserPoolsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListUserPoolsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListUserPoolsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListUserPoolsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListUserPoolsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListUserPoolsRequest>() {
           @Override
           public void write(JsonWriter out, ListUserPoolsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListUserPoolsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListUserPoolsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListUserPoolsRequest
   * @throws IOException if the JSON string is invalid with respect to ListUserPoolsRequest
   */
  public static ListUserPoolsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUserPoolsRequest.class);
  }

  /**
   * Convert an instance of ListUserPoolsRequest to an JSON string
   *
   * @return JSON string
   */
