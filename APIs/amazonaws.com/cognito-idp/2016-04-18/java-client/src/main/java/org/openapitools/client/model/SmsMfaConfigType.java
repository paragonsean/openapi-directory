...
import org.openapitools.client.model.SmsMfaConfigTypeSmsConfiguration;
...
public class SmsMfaConfigType {
  ...
  private SmsMfaConfigTypeSmsConfiguration smsConfiguration;

  public SmsMfaConfigType() {
  }

  public SmsMfaConfigType smsAuthenticationMessage(String smsAuthenticationMessage) {
  ...
  public SmsMfaConfigType smsConfiguration(SmsMfaConfigTypeSmsConfiguration smsConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public SmsMfaConfigTypeSmsConfiguration getSmsConfiguration() {
    return smsConfiguration;
  }

  public void setSmsConfiguration(SmsMfaConfigTypeSmsConfiguration smsConfiguration) {
    this.smsConfiguration = smsConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    SmsMfaConfigType smsMfaConfigType = (SmsMfaConfigType) o;
    return Objects.equals(this.smsAuthenticationMessage, smsMfaConfigType.smsAuthenticationMessage) &&
        Objects.equals(this.smsConfiguration, smsMfaConfigType.smsConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(smsAuthenticationMessage, smsConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SmsMfaConfigType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SmsMfaConfigType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SmsMfaConfigType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmsMfaConfigType is not found in the empty JSON string", SmsMfaConfigType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SmsMfaConfigType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SmsMfaConfigType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("SmsConfiguration") != null && !jsonObj.get("SmsConfiguration").isJsonNull()) {
        SmsMfaConfigTypeSmsConfiguration.validateJsonElement(jsonObj.get("SmsConfiguration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmsMfaConfigType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmsMfaConfigType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmsMfaConfigType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmsMfaConfigType.class));

       return (TypeAdapter<T>) new TypeAdapter<SmsMfaConfigType>() {
           @Override
           public void write(JsonWriter out, SmsMfaConfigType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SmsMfaConfigType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SmsMfaConfigType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SmsMfaConfigType
   * @throws IOException if the JSON string is invalid with respect to SmsMfaConfigType
   */
  public static SmsMfaConfigType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmsMfaConfigType.class);
  }

  /**
   * Convert an instance of SmsMfaConfigType to an JSON string
   *
   * @return JSON string
   */
