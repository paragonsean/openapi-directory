...
public class DescribeUserPoolDomainRequest {
  ...
  public DescribeUserPoolDomainRequest domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeUserPoolDomainRequest describeUserPoolDomainRequest = (DescribeUserPoolDomainRequest) o;
    return Objects.equals(this.domain, describeUserPoolDomainRequest.domain);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeUserPoolDomainRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUserPoolDomainRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUserPoolDomainRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUserPoolDomainRequest is not found in the empty JSON string", DescribeUserPoolDomainRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUserPoolDomainRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUserPoolDomainRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeUserPoolDomainRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUserPoolDomainRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUserPoolDomainRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUserPoolDomainRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUserPoolDomainRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUserPoolDomainRequest>() {
           @Override
           public void write(JsonWriter out, DescribeUserPoolDomainRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUserPoolDomainRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUserPoolDomainRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUserPoolDomainRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeUserPoolDomainRequest
   */
  public static DescribeUserPoolDomainRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUserPoolDomainRequest.class);
  }

  /**
   * Convert an instance of DescribeUserPoolDomainRequest to an JSON string
   *
   * @return JSON string
   */
