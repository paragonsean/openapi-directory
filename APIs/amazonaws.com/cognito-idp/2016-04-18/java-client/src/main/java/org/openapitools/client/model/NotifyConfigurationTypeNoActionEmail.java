...
public class NotifyConfigurationTypeNoActionEmail {
  ...
  public NotifyConfigurationTypeNoActionEmail() {
  }

  public NotifyConfigurationTypeNoActionEmail subject(String subject) {
  ...
  public NotifyConfigurationTypeNoActionEmail htmlBody(String htmlBody) {
  ...
  public NotifyConfigurationTypeNoActionEmail textBody(String textBody) {
  ...
  public boolean equals(Object o) {
    ...
    NotifyConfigurationTypeNoActionEmail notifyConfigurationTypeNoActionEmail = (NotifyConfigurationTypeNoActionEmail) o;
    return Objects.equals(this.subject, notifyConfigurationTypeNoActionEmail.subject) &&
        Objects.equals(this.htmlBody, notifyConfigurationTypeNoActionEmail.htmlBody) &&
        Objects.equals(this.textBody, notifyConfigurationTypeNoActionEmail.textBody);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotifyConfigurationTypeNoActionEmail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NotifyConfigurationTypeNoActionEmail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotifyConfigurationTypeNoActionEmail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotifyConfigurationTypeNoActionEmail is not found in the empty JSON string", NotifyConfigurationTypeNoActionEmail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotifyConfigurationTypeNoActionEmail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotifyConfigurationTypeNoActionEmail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NotifyConfigurationTypeNoActionEmail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotifyConfigurationTypeNoActionEmail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotifyConfigurationTypeNoActionEmail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotifyConfigurationTypeNoActionEmail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotifyConfigurationTypeNoActionEmail.class));

       return (TypeAdapter<T>) new TypeAdapter<NotifyConfigurationTypeNoActionEmail>() {
           @Override
           public void write(JsonWriter out, NotifyConfigurationTypeNoActionEmail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NotifyConfigurationTypeNoActionEmail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NotifyConfigurationTypeNoActionEmail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NotifyConfigurationTypeNoActionEmail
   * @throws IOException if the JSON string is invalid with respect to NotifyConfigurationTypeNoActionEmail
   */
  public static NotifyConfigurationTypeNoActionEmail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NotifyConfigurationTypeNoActionEmail.class);
  }

  /**
   * Convert an instance of NotifyConfigurationTypeNoActionEmail to an JSON string
   *
   * @return JSON string
   */
