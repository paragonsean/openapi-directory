...
public class UsernameConfigurationType {
  ...
  public UsernameConfigurationType caseSensitive(Boolean caseSensitive) {
  ...
  public boolean equals(Object o) {
    ...
    UsernameConfigurationType usernameConfigurationType = (UsernameConfigurationType) o;
    return Objects.equals(this.caseSensitive, usernameConfigurationType.caseSensitive);
  }
  ...
  public String toString() {
    ...
    sb.append("class UsernameConfigurationType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UsernameConfigurationType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsernameConfigurationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsernameConfigurationType is not found in the empty JSON string", UsernameConfigurationType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UsernameConfigurationType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UsernameConfigurationType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UsernameConfigurationType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsernameConfigurationType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsernameConfigurationType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsernameConfigurationType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsernameConfigurationType.class));

       return (TypeAdapter<T>) new TypeAdapter<UsernameConfigurationType>() {
           @Override
           public void write(JsonWriter out, UsernameConfigurationType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UsernameConfigurationType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UsernameConfigurationType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UsernameConfigurationType
   * @throws IOException if the JSON string is invalid with respect to UsernameConfigurationType
   */
  public static UsernameConfigurationType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsernameConfigurationType.class);
  }

  /**
   * Convert an instance of UsernameConfigurationType to an JSON string
   *
   * @return JSON string
   */
