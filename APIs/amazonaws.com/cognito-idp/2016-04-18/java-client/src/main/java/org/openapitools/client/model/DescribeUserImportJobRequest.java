...
public class DescribeUserImportJobRequest {
  ...
  public DescribeUserImportJobRequest() {
  }

  public DescribeUserImportJobRequest userPoolId(String userPoolId) {
  ...
  public DescribeUserImportJobRequest jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeUserImportJobRequest describeUserImportJobRequest = (DescribeUserImportJobRequest) o;
    return Objects.equals(this.userPoolId, describeUserImportJobRequest.userPoolId) &&
        Objects.equals(this.jobId, describeUserImportJobRequest.jobId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeUserImportJobRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUserImportJobRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUserImportJobRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUserImportJobRequest is not found in the empty JSON string", DescribeUserImportJobRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUserImportJobRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUserImportJobRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeUserImportJobRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUserImportJobRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUserImportJobRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUserImportJobRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUserImportJobRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUserImportJobRequest>() {
           @Override
           public void write(JsonWriter out, DescribeUserImportJobRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUserImportJobRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUserImportJobRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUserImportJobRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeUserImportJobRequest
   */
  public static DescribeUserImportJobRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUserImportJobRequest.class);
  }

  /**
   * Convert an instance of DescribeUserImportJobRequest to an JSON string
   *
   * @return JSON string
   */
